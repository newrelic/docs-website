...
<img
  ...
  src="/images/style-guide_screenshot-full_data-source-heading-example.webp"
/>
...
<img
  ...
  src="/images/style-guide_screenshot-full_repeat-stage-label-in-body.webp"
/>
...
* Blue-circled numbered lists (created in YAML by `steps:`)
  <img title="Screenshot showing the blue-circled steps" alt="Screenshot showing the blue-circled steps" src="/images/style-guide_screenshot-full_blue-circled-steps.webp"/>
...
* Repeat the stage name as the title in the main body.
  <img title="Screenshot showing the label format and positioning" alt="Screenshot showing the label format and positioning" src="/images/style-guide_screenshot-crop_demonstrate-label-name.webp"/>
