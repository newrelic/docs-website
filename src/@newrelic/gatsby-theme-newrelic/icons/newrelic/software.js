...
const SoftwareIcon = (props) => (
  <SVG
    ...
    `}
  >
    <path d="M12.1712 7.5L14.8635 14.0385L16.2097 11.5385H19.6712V13.4615H17.3635L14.8635 18.6538L11.7866 11.7308L9.6712 15.3846H6.20966V13.4615H8.51735L12.1712 7.5Z" />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
