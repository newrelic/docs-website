...
<Callout variant="important">
  To ensure the consistency and [security of any data presented in Docs site images](https://nerdlife.datanerd.us/new-relic/docs-site-security-guidelines-for-images), only the Docs team is authorized to add or update screenshots and other images on the Docs site.
</Callout>

The goal of this document it to give you some tips about creating images, but if you need help embedding them on our site, see [Embed images](/docs/new-relic-only/tech-writer-style-guide/processes-procedures/embed-images).

## Guidelines for image types [#types]

Review the [Tech Docs team's five questions](/docs/new-relic-only/basic-style-guide/writing-guidelines/five-questions-help-write-docs#how) to decide how to write excellent docs and to convey information visually. Depending on the type of image, follow these guidelines.
...
<CollapserGroup>
  <Collapser
    ...
    title="Icons"
  >
    Use the [Font Awesome library](http://fortawesome.github.io/Font-Awesome/icons/) to [embed generic icons](/docs/new-relic-only/style-guide/processes-procedures/embedding-images#icons).
  </Collapser>
  ...
  <Collapser
    ...
    title="Inline images"
  >
    Use [inline images](/docs/new-relic-only/style-guide/processes-procedures/embedding-images#inline-images) for buttons, icons, or other graphic elements in New Relic's user interface that Font Awesome icons cannot effectively represent.
  </Collapser>
  ...
  <Collapser
    ...
    title="Screenshots"
  >
    Follow the [New Relic Security guidelines to capture screenshots or other images](https://nerdlife.datanerd.us/new-relic/docs-site-security-guidelines-for-images) when the Docs team cannot access the product or feature and the other alternatives are not sufficient. In addition:
...
* Only insert [navigation paths](/docs/new-relic-only/basic-style-guide/style-guide-quick-reference/usage-dictionary#ui-path) in captions if navigation is a key part of the message.
...
* Use our [New Relic SnagIt theme](https://github.com/newrelic/newrelic-doc-tools) to keep your annotations consistent. To import the New Relic theme:
  1. Open SnagIt.
