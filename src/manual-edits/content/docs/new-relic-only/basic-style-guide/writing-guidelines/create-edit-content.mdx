...
The time needed to publish is based on [our SLAs](https://newrelic.jiveon.com/docs/DOC-6286#jive_content_id_When_should_you_contact_us). (Internal New Relic link)
