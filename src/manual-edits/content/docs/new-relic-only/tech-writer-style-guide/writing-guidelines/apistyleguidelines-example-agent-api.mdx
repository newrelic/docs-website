...
* Edit the URL to remove the agent name.
...
<Callout variant="important">
  The Python and iOS agents use their own syntax guidelines. For those guidelines, see the existing methods in those languages.
</Callout>
...
You will need to create a 'View all methods' doc that links to all the available methods. 
