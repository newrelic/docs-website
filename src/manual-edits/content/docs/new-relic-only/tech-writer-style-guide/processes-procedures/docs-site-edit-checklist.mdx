    ...
    <tr>
      ...
      <td>
        ...
        * Cropped images clearly show their relevance, with or without captions.
        ...
        In addition, for hero edits, make sure that screenshots and images follow the [Docs site's security guidelines](https://nerdlife.datanerd.us/new-relic/docs-site-security-guidelines-for-images).
      </td>
    </tr>
