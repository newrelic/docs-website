...
The request guid is included in all Log events written to NRDB from the import job. These events are written in real time as the import job runs. To view the status and output of an import as it runs, use this NRQL query (replacing 4740e3c8-dbc4-46e6-a4b2-a7fb6f918d20 with the uuid returned from your HTTP POST):

```
FROM Log SELECT * WHERE source = 'GitHub Dependabot' AND requestId = '4740e3c8-dbc4-46e6-a4b2-a7fb6f918d20'
```
