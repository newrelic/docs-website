...
1. Add the following lines to your MySQL configuration file (e.g., `/etc/my.cnf.d/mysql-server.cnf` or `/etc/my.cnf` for <DNT>**RHEL/CentOS/Amazon Linux/Oracle Linux**</DNT>):
   ```ini
   [mysqld]
