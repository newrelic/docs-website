...
1. To enable Performance Schema by creating or modifying a DB Parameter Group and associating it with your MySQL RDS DB instance:
    ...
    5. Reboot your MySQL RDS DB instance for the changes to take effect. For more information, Refer to the [Working with DB Parameter Groups documentation](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_WorkingWithParamGroups.html).
