...
<CollapserGroup>
  ...
  <Collapser
    id="extended-backup-metrics"
    title="Extended backup metrics"
  >
    Additional metrics captured when `EXTENDED_BACKUP_METRICS` is enabled, that is, set to `true` in the [configuration file](#examples). These metrics track active backup operations.

    <Callout variant="tip">
      **Minimum supported versions:** MySQL 5.7 or higher (MySQL 8.0+ recommended), MariaDB 10.x or higher (MariaDB 10.5+ recommended for full functionality)
    </Callout>
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            Total backups currently running.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Logical backups (mysqldump) currently running.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Physical backups (FLUSH TABLES WITH READ LOCK) currently running.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Table locks related to backup operations currently active.
          </td>
        </tr>
      </tbody>
    </table>
  ...
  <Collapser
    id="extended-backup-history-metrics"
    title="Extended backup history metrics"
  >
    Additional metrics captured when `EXTENDED_BACKUP_HISTORY_METRICS` is enabled, that is, set to `true` in the [configuration file](#examples). These metrics provide historical information about backup operations.
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            Total backup operations in history buffer.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Number of logical backups in history.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Average duration of logical backups in seconds.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Maximum duration of logical backups in seconds.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Number of physical backups in history.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Average duration of physical backups in seconds.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Maximum duration of physical backups in seconds.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Number of table lock operations in history.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Average duration of table lock operations in seconds.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Maximum duration of table lock operations in seconds.
          </td>
        </tr>
      </tbody>
    </table>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Average CPU time in milliseconds spent executing this slow query. The `avg_cpu_time_ms` event attribute stores the average CPU time. For the AWS Aurora integration, the `avg_cpu_time_ms` metric is not exposed. As a result, its value is always `0`. MariaDB doesn't support the `avg_cpu_time_ms` attribute. 
          </td>
        </tr>
        <tr>
          <td>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Estimated cost of the query. The `query_cost` event attribute stores the estimated cost. MariaDB doesn't support the `query_cost` attribute. 
          </td>
        </tr>
        <tr>
          <td>
        ...
        <tr>
          ...
          <td>
            Number of rows produced per join. The `rows_produced_per_join` event attribute stores the number of rows produced. MariaDB doesn't support the `rows_produced_per_join` attribute. 
          </td>
        </tr>
        <tr>
          <td>
        ...
        <tr>
          ...
          <td>
            Estimated cost of reading data. The `read_cost` event attribute stores the estimated read cost. MariaDB doesn't support the `read_cost` attribute. 
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            Estimated cost of evaluating conditions. The `eval_cost` event attribute stores the estimated evaluation cost. MariaDB doesn't support the `eval_cost` attribute. 
          </td>
        </tr>
        <tr>
          <td>
        ...
        <tr>
         ...
         <tr>
          ...
          <td>
            Cost of running query before this step. The `prefix_cost` event attribute indicates running cost. MariaDB doesn't support the `prefix_cost` attribute. 
          </td>
        </tr>
         <tr>
          <td>
          ...
          <td>
            Data read per join. The `data_read_per_join` event attribute indicates data read per join. MariaDB doesn't support the `data_read_per_join` attribute. 
          </td>
        </tr>
        <tr>
          <td>
