...
## Check the compatibility and requirements [#compability-requirements]
...
This page is interactive, which means you'll have to select options related to your environment so we can give you specific steps to install the Kafka integration. 

After you make your selections, you'll get customized steps for your environment. If you change your mind after making some selections, click **Reset the form** to start again:
