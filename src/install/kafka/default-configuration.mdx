...
The config file will require fine-tuning based on your specific Kafka instance. For example, you may want to use SSL or TLS to authenticate. You can find all the config options at the bottom of this doc alongside more complex config examples.
