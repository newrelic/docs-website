...
<CollapserGroup>
    ...
    >
        ...
        ```java
        newrelic.config.ai_monitoring.enabled = true
        newrelic.config.span_events.max_samples_stored = 10000
        newrelic.config.custom_insights_events.max_samples_stored = 100000
        ```
