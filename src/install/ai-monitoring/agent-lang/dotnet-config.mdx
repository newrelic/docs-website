...
<CollapserGroup>
    <Collapser
        id="config-file"
        title="Configure through `newrelic.ini`"
    >
	...
	<spanEvents enabled="true" maximumSamplesStored="2000"></spanEvents>
        ```
...
To learn about more AI monitoring configurations, see our Customize the agent for [AI monitoring doc](/docs/ai-monitoring/customize-agent-ai-monitoring).