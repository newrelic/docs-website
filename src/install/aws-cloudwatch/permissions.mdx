...
Before you access the integration, you need to set certain permissions so New Relic can access your AWS data. At minimum, you need to create a `ReadOnlyAccess` policy and apply these minimum permissions to the AWS roles associated with New Relic:
