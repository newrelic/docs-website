...
import infrastructureMongoDashboardCropped from 'images/infrastructure_screenshot-crop_Redis-dashboard-cropped.webp'

Gain deep insights into Redis performance with seamless data integration into New Relic. Monitor key metrics like throughput, collection size, connections, and indexes effortlessly, all within our powerful platform. Create alerts to stay ahead of spikes, build custom dashboards for tailored views, and proactively optimize your database monitoring.

<img
  title="Redis quickstart dashboard"
  alt="Image of the dashboard available through the Redis quickstart"
...
The guided install is a single CLI command you can run to monitor your Redis instance. It's a good option for small organizations, or for anyone who wants to test out New Relic.
