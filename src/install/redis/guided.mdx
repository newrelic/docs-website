...
Guided install is a single CLI command you can run on your system to monitor your Redis instance. The CLI installs the infrastructure agent and Redis integration.
