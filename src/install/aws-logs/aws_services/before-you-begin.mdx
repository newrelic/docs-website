...
If you are already using Lambda for S3 or CloudWatch, refer the [Guidelines for uprading to the new Lambda](/docs/logs/forward-logs/guidelines-to-upgrade-to-new-lambda).
</Callout>