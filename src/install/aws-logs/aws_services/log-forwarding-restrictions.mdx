...
headingText: AWS Log forwarding restrictions
---

## AWS Log forwarding restrictions [#aws-log-forwarding-restrictions]

Following are the restrictions New Relic has with AWS integration for log forwarding when you ingest logs via S3 or Firehose:
