...
Using a single CloudFormation template, you can easily set up your AWS integration and forward New Relic AWS services [metrics](/docs/infrastructure/amazon-integrations/aws-integration-for-metrics/via-cloudformation-cwms/), logs, or both.
