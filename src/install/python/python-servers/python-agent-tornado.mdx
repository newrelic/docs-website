...
You can use the recommended admin script integration method, provided you start your app with `python app.py` and use the Tornado async interface. The admin script was included when you installed the Python agent.
