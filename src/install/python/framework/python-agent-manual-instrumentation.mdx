...
headingText: Review the steps for manual initialization
---

It sounds like either you're not using a framework, or you're using an unsupported framework, such as mod_wsgi or WebFaction. Either way, you're in the right place!
