...
headingText: Review start-up steps using Uvicorn
---
...
If you start your app with `python app.py` and use our Python agent **version 5.20.0.149** or higher, you can use the admin script integration method. The admin script was included when you installed the Python agent.
