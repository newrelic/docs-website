...
This page is interactive, which means we'll ask you some questions about your environment and then give you some specific steps to install the Python agent.