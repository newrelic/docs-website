...
<SideBySide>
  <Side>
    ...
    We have some interactive installation instructions below to make it easy for you to get started. We'll ask you some questions about your environment and then give you some specific steps to initialize the agent with your application.
  </Side>
  <Side>
    <img
