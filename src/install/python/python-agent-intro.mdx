...
This page is interactive, which means we'll ask you some questions about your environment, and then we'll give you some specific steps to install the Python agent. If you change your mind after making some selections, click **Reset the form** to start again:
