...
<img
  ...
  src="/images/apm-python-agent_screenshot-crop_web-transaction-chart.webp"
/>
...
<Callout variant="tip">
  Is your application running in a Kubernetes cluster? Try out our installation method using the [Kubernetes APM auto-attach](/docs/kubernetes-pixie/kubernetes-integration/installation/k8s-agent-operator/).
</Callout>
