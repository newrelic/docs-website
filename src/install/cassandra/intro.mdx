...
<img
  ...
  alt="An image of the I/O Cassandra dashboard"
  src="/images/infrastructure_screenshot-crop_cassandra-dashboard.webp"
/>

<figcaption>
  Dashboard installed through the [New Relic Cassandra Monitor quickstart](https://newrelic.com/instant-observability/cassandra)
</figcaption>
...
<ButtonGroup>
  ...
  <ButtonLink
    role="button"
    to="https://one.jp.newrelic.com/marketplace/install-data-source?state=d99cab2c-ca6c-4e1c-de98-26786c2665b6"
    variant="primary"
  >
    Guided install, JP region
  </ButtonLink>
</ButtonGroup>
