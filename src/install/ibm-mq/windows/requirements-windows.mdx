...
* Add the libraries path in the `LD_LIBRARY_PATH` environment variable. Follow [these steps](https://www.ibm.com/docs/en/ibm-mq/9.1?topic=windows-testing-communication-between-client-server).
