...
You can view this [metric data](#metrics) in pre-built <InlinePopover type="dashboards" />, create <InlinePopover type="alerts" /> policies, and create custom queries and charts.
...
Okay, let's get started installing your IBM MQ integration.
