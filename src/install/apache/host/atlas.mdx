...
Alternatively, you can use the  Atlas UI to create your user and assign the same specific privileges. For more, information check the [ Atlas documentation](https://www..com/docs/atlas/security-add--users/#add-database-users).
