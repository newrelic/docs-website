...
To use the Apache integration, you need our infrastructure agent on the same host. The infrastructure agent monitors the host itself, while the Apache integration you'll install extends monitoring to your Apache instance.
