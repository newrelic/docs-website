...
3. Edit the `nri-apache-config.yml` file. Point `STATUS_URL` to your exposed [`mod_status` URL](https://httpd.apache.org/docs/current/mod/mod_status.html). This example config file collects all metrics:
