---
headingText: Forward logs with the Amazon Security Lake integration
...
2. Select <DoNotTranslate>**Subscribers**</DoNotTranslate>, and select <DoNotTranslate>**Create Subscriber**</DoNotTranslate>.
...
6. Select <DoNotTranslate>**Create**</DoNotTranslate>.
7. From the <DoNotTranslate>**Subscriber details**</DoNotTranslate> page, copy your <DoNotTranslate>**AWS role ID**</DoNotTranslate> and <DoNotTranslate>**Subscription endpoint**</DoNotTranslate> ARN's. You will need them for the next step.
...
2. Search for `newrelic` and check <DoNotTranslate>**Show apps that create custom IAM roles or resource policies**</DoNotTranslate> to find the `newrelic-securitylake-s3-processor-LogForwarder`.
3. Click the `newrelic-securitylake-s3-processor-LogForwarder` details, and click <DoNotTranslate>**Deploy**</DoNotTranslate>.
...
8. Acknowledge and select <DoNotTranslate>**Deploy**</DoNotTranslate>.
...
To find your logs on New Relic, go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Logs**</DoNotTranslate> and set <DoNotTranslate>**Attributes**</DoNotTranslate> to `product.name`, and then choose the log source you want.
