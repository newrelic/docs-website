...
<Callout variant="important">
    If you are a first time user and want to add the streaming agent to a new application, see [Install video agent for a new browser application](?task=EU).
</Callout>
...
<Tabs>
    ...
    <TabsPages>
        ...
        8. Deploy your updated code & see your data.
        </TabsPageItem>
    </TabsPages>
</Tabs>