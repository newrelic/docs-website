            ...
            <Tabs>
                ...
                <TabsPages>
                    ...
                    <TabsPageItem id="kotlin-kotlin">
                        ...
                        4. In the **Build and run your application** page, click **Continue**.
                        5. Once you've finished all the steps, you can test the connection to make sure everything is working properly and view your data.
                        6. Now that you’ve installed New Relic in your app, within minutes you will see data in your New Relic account.
                    </TabsPageItem>
                </TabsPages>
            </Tabs>
        </TabsPageItem>
