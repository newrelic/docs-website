...
---
    ...
    1. First, [install the Android agent](/docs/mobile-monitoring/new-relic-mobile-android/get-started/introduction-new-relic-mobile-android) on an application you're not monitoring with New Relic.
