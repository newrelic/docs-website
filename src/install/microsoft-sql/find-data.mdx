...
1. Go to **[one.newrelic.com](https://one.newrelic.com) > Integrations & Agents** and type **MSSQL On-Host Integration**.
...
6. Click **View dashboard** to see your Microsoft SQL server data in New Relic.
