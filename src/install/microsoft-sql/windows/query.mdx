...
<CollapserGroup>
    ...
    3. Enable Query Store on your databases.
    ...
    4.     To confirm Query Store is active for a specific database, run the following SQL command:
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td>Enable query-level monitoring. The default value is set to `false`.</td>
                </tr>
                <tr>
