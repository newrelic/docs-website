...
descriptionText: This text corresponds with the "Beyork" image from the first step.
---
...
This video only appears when you select the "Beyork" image from step 1. If you don't select any image from step 1, then the YAML file will automatically show the default file, surfing cat.
