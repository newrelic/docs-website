...
descriptionText: This text corresponds with the "Two friends" image from the first step.
---

Here's a set I listened to while trying to understand the logic of the branching doc. 

<iframe width="560" height="315" src="https://www.youtube.com/embed/vlwKp7Odn-I" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

This video only appears when you select the "Two Friends" image from step 1. If you don't select any image from step 1, then the YAML file will automatically show the default file, surfing cat.
