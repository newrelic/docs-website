...
---
    ...
    1. [Install the iOS agent](/docs/mobile-monitoring/new-relic-mobile-ios/get-started/introduction-new-relic-mobile-ios) first on an application you're not monitoring with New Relic yet.
    ...
    3. Once the iOS agent is installed, you will be redirected to the <DNT>**Install media streaming agent**</DNT> page.
...
<Tabs>
    ...
    <TabsPages>
        <TabsPageItem id="automatically-cocoapods">
            ...
            6. Click <DNT>**See your data**</DNT> to deploy your updated code & see the data.
        </TabsPageItem>
