...
<Callout variant="important">
    If you are a first time user and want to add the streaming agent to a new application, see [Install video agent for a new browser application](/install/media-ios/?task=EU).
</Callout>
