...
headingText: Create Oracle database users
---

You now need to create an Oracle database user with assigned privileges. Follow the instructions below. Be sure to replace values like 'USERNAME' with your information.
