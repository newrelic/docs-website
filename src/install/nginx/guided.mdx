...
<Callout variant="tip">
  **Use guided install to quickly see your data in the UI**
  ...
  Guided install is a single CLI command you can run on your system to monitor your NGINX server instance. The CLI installs the infrastructure agent and NGINX server integration.
