...
headingText: Install the Kubernetes integration using Helm
---

Before you get started with a manual installation using Helm, take a look at the compatibility and requirements below.
...
### Avialable Helm charts for the installation [#install-k8-helm]
