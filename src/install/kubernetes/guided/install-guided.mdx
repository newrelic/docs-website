...
Go to the "Configure the Kubernetes integration" installation step and enable **Windows Nodes Monitoring** in the "Windows monitoring" section. The installation command will automatically update to include Windows configuration.
