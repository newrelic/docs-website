...
To enable the Windows nodes monitoring, turn on the toggle for <DNT>**Enable monitoring of your windows containers**</DNT> in the <DNT>Windows node monitoring</DNT> section of the guided install. This will automatically add the necessary configuration to your installation command to enable Windows nodes monitoring in your cluster.

<img
    width="60%;"
    title="Guided install from the UI"
    alt="Guided install from the UI"
    src="/images/k8s_windows_guided.webp"
/>
