...
To enable monitoring for Windows nodes in hybrid clusters, your Helm command should include the following:
...
For comprehensive Windows monitoring configuration, see [Monitor Windows nodes in Kubernetes](/docs/kubernetes-pixie/kubernetes-integration/advanced-configuration/windows).
