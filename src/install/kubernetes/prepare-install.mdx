...
<CollapserGroup>
  ...
  >
    You will be able to select `Enable monitoring of your Windows nodes` during the each of the instrumentation method processes (Guided Install, Helm, or Manifest).

    For more helpful information about installing the New Relic Kubernetes integration on Windows nodes, see [Installation on Windows](/docs/kubernetes-pixie/kubernetes-integration/installation/kubernetes-windows).
  </Collapser>
</CollapserGroup>
