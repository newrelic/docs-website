...
<CollapserGroup>
  ...
  <Collapser
    className="freq-link"
    id="windows"
    title={<><img src="/images/os_icon_windows.webp" alt="Windows" style={{ verticalAlign: 'middle' }}/>Windows</>}
  >
    Go to the [Installation on Windows](/docs/kubernetes-pixie/kubernetes-integration/installation/kubernetes-windows) page for more information.
  </Collapser>
</CollapserGroup>
