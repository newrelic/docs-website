...
<CollapserGroup>
    ...
    <Collapser
        ...
        title={<><img src={kubernetesEks} alt="EKS" style={{ verticalAlign: 'middle' }}/>Amazon AWS EKS/ AWS EKS Anywhere</>}
    >
    ...
    <Collapser
        className="freq-link"
        id="aws-eks-fargate"
        title={<><img src={kubernetesEks} alt="EKS" style={{ verticalAlign: 'middle' }}/>Amazon EKS - AWS Fargate</>}
    >
    ...
    <Collapser
        ...
        title={<><img src={kubernetesCke} alt="CKE" style={{ verticalAlign: 'middle' }}/>Google Kubernetes Engine</>}
    >
    ...
    <Collapser
        ...
        title={<><img src={kubernetesOpenshift} alt="OpenShift" style={{ verticalAlign: 'middle' }}/>Red Hat OpenShift</>}
    >
    ...
    <Collapser
        className="freq-link"
        id="windows"
        title={<><img src={osWindows} alt="Windows" style={{ verticalAlign: 'middle' }}/>Windows</>}
    >
