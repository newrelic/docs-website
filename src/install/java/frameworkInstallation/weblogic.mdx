...
<Tabs>
  <TabsBar>
    <TabsBarItem id="weblogic-nix">
      Admin servers on Linux or macOS
    </TabsBarItem>

    <TabsBarItem id="weblogic-windows">
      Admin servers on Windows
    </TabsBarItem>

    <TabsBarItem id="weblogic-managed-server">
