...
descriptionText: Select how your app is deployed and your framework. The page updates with the instructions you need for your exact Java setup, so you can start [monitoring your app's performance](/docs/apm/agents/net-agent/azure-installation/install-net-agent-azure-web-apps).
---
