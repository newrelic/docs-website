...
Guided install is a single CLI command you can run on your system to start monitoring your Java app. This doesn't install the actual Java APM agent, but a utility attached via our [infrastructure agent](/docs/infrastructure/install-infrastructure-agent/get-started/install-infrastructure-agent). This is a good way to try out sending your Java data to New Relic. For a more permanent solution, we recommend the manual installation process.
