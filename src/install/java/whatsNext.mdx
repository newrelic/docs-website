...
<SideBySide>
  <Side>
    <WhatsNextTile title="What's next?">
      Now that you've installed the Java agent, [learn how to solve performance issues](/docs/journey-app-slow/root-causes/) with our tutorial series.
  ...
  <Side>
    <WhatsNextTile alignment="center">
      ...
      <ButtonLink
        variant="primary"
        to="https://one.newrelic.com/diagnostics"
      >
