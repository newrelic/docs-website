...
## Download and install via Gradle [#gradle-install]

Here's how to configure Gradle to download and unzip the `newrelic-java.zip` file, which contains all of the New Relic Java agent components:
