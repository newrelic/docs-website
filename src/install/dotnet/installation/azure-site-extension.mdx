...
headingText: Install using Azure site extension
descriptionText: ""  
---
...
4. In the Azure portal, add New Relic [app settings](#web-app-agent-settings) to your Azure App Service. This installs the latest .NET agent version.
