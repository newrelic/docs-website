...
* Your New Relic license key, which determines which account data is reported to
* Your app's name in New Relic. It's important to choose an optimal app name, especially if you have multiple apps you'll be monitoring. For more on this, see [App names](/docs/apm/agents/net-agent/configuration/name-your-net-application).
