...
Next, you'll enable the agent, which involves setting some required environment variables and your license key. If you have an ASP.NET Core app targeting .NET Core, use the environment variable method.

The two main config options you'll be setting are: 
