...
The two main configuration options you'll be setting are: 

* Your New Relic [license key](/docs/apis/intro-apis/new-relic-api-keys/#overview-keys), which determines which account data is reported to.
* Your app's name in New Relic. It's important to choose an optimal app name, especially if you'll be monitoring multiple apps. For some guidance on that, see [App names](/docs/apm/agents/net-agent/configuration/name-your-net-application).
