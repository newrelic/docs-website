...
ASP.NET Core apps are automatically instrumented, but other application frameworks will require you to set up custom instrumentation of your app. For how to do that, see [Custom instrumentation](/docs/agents/net-agent/custom-instrumentation/introduction-net-custom-instrumentation).
