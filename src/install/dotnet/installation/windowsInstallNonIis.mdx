...
ASP.NET Core apps are automatically instrumented, but other .NET Core frameworks will require you to custom instrument your app. For how to do that, see [Custom instrumentation](/docs/agents/net-agent/custom-instrumentation/introduction-net-custom-instrumentation).
