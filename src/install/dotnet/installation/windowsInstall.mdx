...
Here are instructions for installing the agent. For instructions on manually installing the agent, or to see more details on install options, see the command line instructions after this procedure.
