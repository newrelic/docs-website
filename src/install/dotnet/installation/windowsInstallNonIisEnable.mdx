...
For details on setting environment variables per process instead of system-wide, see [this Explorers Hub forum post on setting variables](https://discuss.newrelic.com/t/setting-net-core-agent-environment-variables-per-process/157750).
