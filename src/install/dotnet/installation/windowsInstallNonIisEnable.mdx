...
<Tabs>
  ...
  <TabsPages>
    ...
    <TabsPageItem id="enable-core">
      ...
      For details on setting environment variables per process instead of system-wide, see [this Support Forum forum post on setting variables](https://knowledge.newrelic.com/s/article/Setting-dot-NET-Core-agent-environment-variables-per-process).
