...
This is an option available for: 

* Windows .NET apps on IIS
* .NET Core applications on Linux

Our **guided install** is a single CLI command you can run to monitor your .NET apps and your infrastructure. It's a good option for small organizations, or for anyone who wants to test out New Relic. 
...
For a more permanent and scalable solution, we recommend the standard manual install of the agent, explained below. 
