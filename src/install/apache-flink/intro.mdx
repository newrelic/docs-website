...
Our Apache Flink integration reports data from your Apache Flink web server to the New Relic platform. You can view dashboards of your Apache Flink metric data, create alert policies, and create your own custom queries and charts.
