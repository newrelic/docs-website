    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            The Process ID of blocked query.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            The SQL statement executed in the blocked process.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            The name of the database at which blocking occurs.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            The time at which blocking query is executed.
          </td>
        </tr>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            The average CPU time used by the query, in milliseconds.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            The query identifier for the execution plan.
          </td>
        </tr>
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            The type of operation performed at a node in the execution plan.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            The name of the index used in the execution plan, if applicable.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            The name of the table or relation involved in the execution.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            The number of rows eliminated from this node by filters.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            The unique identifier for the particular query execution.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            The identifier for this specific execution plan.
          </td>
        </tr>
