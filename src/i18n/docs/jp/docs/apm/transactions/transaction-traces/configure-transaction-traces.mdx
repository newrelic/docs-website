...
topics:
  ...
  - Transaction traces
japaneseVersion: >-
  https://docs.newrelic.co.jp/docs/apm/transactions/transaction-traces/configure-transaction-traces
---
...
* [Java](https://docs.newrelic.co.jp/docs/agents/java-agent/configuration/java-agent-configuration-config-file#h2-transaction-tracer)
