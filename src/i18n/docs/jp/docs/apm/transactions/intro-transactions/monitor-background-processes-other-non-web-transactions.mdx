...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="Node.js"
  >
    [`startBackgroundTransaction()`](https://docs.newrelic.co.jp/docs/agents/nodejs-agent/supported-features/nodejs-custom-instrumentation#background-txn)を使用します。
  </Collapser>
  ...
  <Collapser
    ...
    title="PHP"
  >
    トランザクションを非ウェブに指定するには：[`newrelic_background_job`](https://docs.newrelic.co.jp/docs/agents/php-agent/php-agent-api/newrelic_background_job)を使用して、フラグを`true`に設定します。
