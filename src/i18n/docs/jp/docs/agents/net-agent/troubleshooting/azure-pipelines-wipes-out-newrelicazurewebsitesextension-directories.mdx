...
topics:
  ...
  - Troubleshooting
japaneseVersion: >-
  https://docs.newrelic.co.jp/docs/agents/net-agent/troubleshooting/azure-pipelines-wipes-out-newrelicazurewebsitesextension-directories
---
...
# Azure Pipelines wipes out NewRelic.Azure.WebSites.Extension directories [#page-title]
