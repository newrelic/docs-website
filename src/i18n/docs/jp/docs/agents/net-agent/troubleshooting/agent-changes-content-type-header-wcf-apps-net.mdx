...
topics:
  ...
  - Troubleshooting
japaneseVersion: >-
  https://docs.newrelic.co.jp/docs/agents/net-agent/troubleshooting/agent-changes-content-type-header-wcf-apps-net
---
...
# Agent changes Content-Type header for WCF apps (.NET) [#page-title]
