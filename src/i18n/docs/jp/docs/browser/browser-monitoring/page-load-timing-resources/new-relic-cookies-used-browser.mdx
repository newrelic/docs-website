  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        * [`countryCode`](https://docs.newrelic.co.jp/attribute-dictionary/pageview/countrycode)
        * [`regionCode`](https://docs.newrelic.co.jp/attribute-dictionary/pageview/regioncode)
        * [`city`](https://docs.newrelic.co.jp/attribute-dictionary/pageview/city)
        * `asn (Autonomous System Number)`
        * `asnOrganization (ISP/Business/Institution)`
        * [`asnLatitude`](https://docs.newrelic.co.jp/attribute-dictionary/pageview/asnlatitude)
        * [`asnLongitude`](https://docs.newrelic.co.jp/attribute-dictionary/pageview/asnlongitude)
