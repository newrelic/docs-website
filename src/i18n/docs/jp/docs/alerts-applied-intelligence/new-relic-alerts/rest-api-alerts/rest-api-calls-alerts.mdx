...
以下に示すいずれかの例で[パーソナル APIキー](#personal-api-key)を使用するには、'X-Api-Key： &#x7B;api_key} ' を 'Api-Key： &#x7B;personal_api_key} ' に置き換えます。
    ...
    <Table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ポリシーの`name`（名前）は必須です。変更しないままにすると、string（文字列）というポリシーが作成されます。
          </td>
        </tr>
      </tbody>
    </Table>
    ...
    <Table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            **必須**：名前を変更しない場合は、stringというポリシーにデフォルト設定されます。
