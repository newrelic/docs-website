...
<Steps>
  ...
  <Step>
    ...
    * La mayoría de los usuarios en EE. UU., Canadá y EMEA experimentan 2 segundos o más en el tiempo desde la primera entrada, mientras que los usuarios en Malasia e Indonesia experimentan 4 segundos. Agrupar sus segmentos por ubicación geográfica le brindará esta información valiosa.
    ...
    <CollapserGroup>
      ...
      >
        ...
        * Agrupar por `appName` y luego por faceta: utilice este enfoque cuando busque varias aplicaciones en browser que admita un producto.
        ...
        <DoNotTranslate>**Advanced:**</DoNotTranslate> Agregue ofertas de productos como atributo personalizado a las páginas del navegador utilizando [el atributo personalizado](/docs/telemetry-data-platform/custom-data/custom-events/report-browser-monitoring-custom-events-attributes).
      </Collapser>
  ...
  <Step>
    ### Importar el dashboardde base de calidad [#import-dashboard]
