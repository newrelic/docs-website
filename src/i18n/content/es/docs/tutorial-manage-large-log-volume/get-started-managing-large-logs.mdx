...
La filosofía de New Relic cuando se trata de <InlinePopover type="logs"/>se centra en tres cosas: queremos que nuestra solución de registro sea <DoNotTranslate>**flexible, transparent, and usage-based**</DoNotTranslate>. Hablemos rápidamente de lo que significan:
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        * Agregue metadatos a su registro, lo que le brinda contexto para iniciar sesión (capacidad de ver datos de registro en varios lugares relevantes de nuestra plataforma)
