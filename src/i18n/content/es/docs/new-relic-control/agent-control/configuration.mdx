...
<Callout variant="tip">
  Para la región de la UE, utilice `https://opamp.service.eu.newrelic.com/v1/opamp` como el endpoint y `https://system-identity-oauth.service.eu.newrelic.com/oauth2/token` como el `token_url`.
</Callout>
