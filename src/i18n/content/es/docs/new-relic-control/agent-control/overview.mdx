...
* **Credentials:** Agent Control can pull sensitive credentials from external value providers like Vault, injecting them into the agent&apos;s configuration at runtime. This enhances security by keeping credentials out of the configuration itself.
...
* **Security posture:** Standardize how credentials are sourced from value providers to centralize handling, automate rotations, and reduce exposure.
