---
title: Compatibilidad con funciones NRQL en reglas de canalización
metaDescription: Learn about the support for NRQL functions in pipeline rules and how to use them effectively.
freshnessValidatedDate: never
translationType: machine
---

Este documento describe las funciones NRQL admitidas por el portal de control de pipelines. Esta mejora proporciona formas de gestionar sus datos dentro de New Relic.
...
## Ejemplos de funciones NRQL en reglas de canalización
