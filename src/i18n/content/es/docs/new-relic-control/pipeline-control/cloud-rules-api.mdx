...
Puede modificar las reglas cloud existentes para ajustar sus criterios de filtrado, tipos de datos o alcance de implementación.
...
* **Verifique la respuesta de la API:** el objeto de entidad en la respuesta reflejará el nombre, la descripción y el NRQL actualizados.
