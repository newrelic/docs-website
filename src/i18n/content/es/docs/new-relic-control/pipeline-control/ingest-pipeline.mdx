...
* **Fuentes:**
  ...
  * Muestra los cuatro tipos de telemetría (métricas, eventos, logs, trazas) que los agentes y recolectores envían a New Relic. Cada fuente muestra el volumen de datos que fluye a través del pipeline. Esto representa los puntos de entrada de sus datos de observabilidad.
...
* **Nube:**
  ...
  * Indica las reglas cloud que se ejecutan en la infraestructura de New Relic. Muestra el número de reglas activas (por ejemplo, &quot;0 reglas&quot; cuando no hay reglas de cloud configuradas). Esto representa el filtrado adicional aplicado después de que los datos llegan a los extremos de New Relic.