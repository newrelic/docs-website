...
* [Métricas dimensionales](/docs/data-apis/understand-data/new-relic-data-types/#dimensional-metrics). Algunas advertencias:
...
* Si la regla fue desactivada por New Relic (por ejemplo, política de EOL): la solicitud fallará a menos que el usuario posea los permisos internos necesarios para anular la política.
...
* Explore el [foro de soporte](https://support.newrelic.com/s/hubtopic/Topic__c/Default?c__categories=%5B%7B%22icon%22%3A%22standard%3Adefault%22%2C%22id%22%3A%22a6c8W000000EesuQAC%22%2C%22sObjectType%22%3A%22Category__c%22%2C%22title%22%3A%22Dashboards%22%2C%22titleFormatted%22%3A%22Dashboards%22%7D%5D) para ver discusiones de la comunidad sobre las reglas de cloud.
