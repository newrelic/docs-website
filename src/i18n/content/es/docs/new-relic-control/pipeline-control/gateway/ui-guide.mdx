...
La IU del gateway de Pipeline Control proporciona una interfaz basada en formularios para crear y administrar reglas de gateway sin escribir YAML directamente. La interfaz de usuario organiza la lógica de procesamiento en tres categorías de reglas: tasa de muestreo, filtro y transformación. Cada categoría es configurable mediante cuadros de diálogo modales guiados.
...
Cree reglas de filtrado basadas en OTTL para filtrar condicionalmente registros de telemetría completos o atributos específicos. Admite:
...
### Crear una regla de transformación
...
2. **Configurar la información básica**:
   ...
   * <DNT>**Rule name**</DNT>: Ingrese un nombre descriptivo (por ejemplo, &quot;`parse-nginx-logs`&quot;)
...
8. Haz clic en **Save draft** para guardar tu versión de configuración recién creada.
...
2. En la nueva página de despliegue, revise la información precargada:

   * Se proporcionan un nombre y una descripción predeterminados. Puedes editarlos para ayudar a realizar un seguimiento de tus cambios.
   * El despliegue incluye automáticamente los agentes asociados a su flota actual.
   * El sistema usa por defecto tu versión de configuración. Si lo deseas, puedes cambiar estos detalles.

3. Haga clic en <DNT>**Start deployment**</DNT> para aplicar la configuración.

4. Debe confirmar nuevamente que desea iniciar el despliegue. Haga clic en <DNT>**Start deployment**</DNT> de nuevo para confirmar.

El despliegue tarda un par de minutos en completarse.
