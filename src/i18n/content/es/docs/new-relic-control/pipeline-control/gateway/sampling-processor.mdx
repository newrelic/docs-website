...
* `conditionalSamplingRules`: Arreglo de reglas condicionales (evaluadas en orden) - **solo admitido para logs y eventos**
...
Para las trazas, solo puede configurar el porcentaje de muestreo global. Este porcentaje se aplica a **todas las trazas uniformemente**, incluidas las trazas de error y las trazas lentas:
