...
A continuación, aprenderá sobre la [configuración de DNS y certificados de seguridad](/docs/new-relic-control/pipeline-control/gateway/dns-certificate) para el ALB de AWS.