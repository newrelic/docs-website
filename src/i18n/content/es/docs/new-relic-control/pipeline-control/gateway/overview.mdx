...
* Declaración de versión: versión: `2.0.1` especifica el esquema de configuración
...
2. Usted despliega a través de la UI (cargar YAML) en su flota de gateways.
3. Gateway aplica la configuración a todos los clústeres de gateway en la flota.
4. Todos los clústeres de la flota procesan datos de forma idéntica usando las mismas reglas.

**Gestión de versiones:**

* Cada cambio de configuración crea una nueva versión (por flota)
* Ver el historial de versiones y revertir si es necesario.
* La insignia &quot;Necesita despliegue&quot; muestra cambios pendientes.
* Diferentes flotas pueden mantener diferentes configuraciones y versiones.

## Próximos pasos

**Primeros pasos con la instalación del gateway:**

* [Instalar con Flux](/docs/new-relic-control/pipeline-control/gateway/set-up-and-deploy-pipeline-control) - Gestión completa del ciclo de vida del gateway a través de la UI (instalar, actualizar, escalar)
* [Instalar sin Flux](/docs/new-relic-control/pipeline-control/gateway/install-gateway-without-flux) - modo de solo configuración para permisos reducidos

**Configure su pipeline:**
...
**Explorar tipos de procesadores:**
