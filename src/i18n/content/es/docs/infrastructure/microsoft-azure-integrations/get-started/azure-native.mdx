...
Si su equipo despliega software y servicios en la nube a través de Azure, nuestro [Azure Native New Relic Service](https://marketplace.microsoft.com/en-us/product/newrelicinc1635200720692.newrelic_liftr_payg_2025) le permite administrar la integración de Azure-New Relic, y administrar e instalar nuestro agente de infraestructura y nuestros <InlinePopover type="apm" />agentes de .NET y Java, todo directamente desde Azure Portal.
...
* Este servicio viene con nuestra opción Data Plus, pero no todas las características de Data Plus están disponibles. Por ejemplo, los datos que cumplen con FedRAMP aún no están disponibles. Para obtener más detalles, consulte los [detalles del servicio Azure Native New Relic](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/data-ingest-billing/#azure-native-data-plus).
