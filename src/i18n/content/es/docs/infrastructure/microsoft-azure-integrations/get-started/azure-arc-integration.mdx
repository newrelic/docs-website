...
<CollapserGroup>
  ...
  >
    Azure arc amplía la plataforma Azure para ayudarle a crear aplicaciones y servicios con la flexibilidad de ejecutarse en centros de datos y en entornos multinube. Azure Arc lo ayuda a desarrollar una aplicación nativa de la nube con un modelo de desarrollo, operaciones y seguridad consistente.
  </Collapser>
</CollapserGroup>
