...
* Puede encontrar una estimación de la llamada API que realizamos a los servicios de Azure en [dashboardestado de su cuenta](/docs/infrastructure/infrastructure-integrations/cloud-integrations/cloud-integrations-account-status-dashboard).
...
3. Colocará la información requerida en la UI

   <DoNotTranslate>**Integrations**</DoNotTranslate>

   .

Para utilizar estas instrucciones de activación de integración directamente desde nuestra UI de infraestructura, vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Azure > Add an Azure account**</DoNotTranslate>.
...
1. Inicie sesión en Azure Portal y vaya a
...
4. En
   ...
   seleccione `Web`y agregue `https://www.newrelic.com` como URI de inicio de sesión.

5. Cree la aplicación haciendo clic en
...
6. Desde el
   ...
   de tu aplicación, copia el

   <DoNotTranslate>**Application (client) ID**</DoNotTranslate>

   y guárdalo para usarlo más adelante.
...
1. En Azure, en la aplicación que acaba de crear, seleccione
...
2. En
   ...
   . Elija la fecha de vencimiento secreta que puede ser de hasta 2 años. Una vez que el secreto caduque, siga los pasos para [actualizar los detalles de la aplicación](#update-app).
...
1. En la sección Azure

   <DoNotTranslate>**Subscriptions**</DoNotTranslate>

   , seleccione la suscripción que desea New Relic monitor.
...
1. Vaya a
   ...
   y seleccione el servicio de Azure que desea agregar.

2. Siga los pasos en la UI para activar la integración en New Relic.

3. Si ya completó los pasos de la cuenta de Azure, vaya al final de los pasos para completar el formulario. (Para `Azure account name`, ingrese el nombre que desea usar para identificar la cuenta en su dashboard

   <DoNotTranslate>**Integrations**</DoNotTranslate>

   .)

Después de activar una integración de Azure, comenzaremos a monitorear sus datos de Azure a [intervalos regulares de sondeo](/docs/infrastructure/microsoft-azure-integrations/azure-integrations-list/azure-polling-intervals-infrastructure-integrations). Para [buscar y utilizar tus datos](/docs/infrastructure/integrations/find-use-infrastructure-integration-data), utiliza [métrica y evento](/docs/query-your-data/explore-query-data/data-explorer/introduction-data-explorer) o ve a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Azure**</DoNotTranslate>.
...
1. Vaya a
   ...
   en la cuenta de Azure que desea editar.
...
3. Edite el campo
   ...
   con el nuevo valor y confirme con
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        4. Inicie sesión en [Azure](https://portal.azure.com/) y acceda a
        ...
        5. Busque la aplicación registrada (el nombre recomendado es `NewRelic-Integrations`). Para ver la lista completa de aplicaciones disponibles, seleccione el menú desplegable junto al campo de búsqueda y seleccione

           <DoNotTranslate>**All apps**</DoNotTranslate>

           .

        6. Seleccione la aplicación y, en el panel que se abre, seleccione
