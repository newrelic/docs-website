...
Para encontrar sus datos de integración, vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Azure**</DoNotTranslate> y seleccione la integración <DoNotTranslate>**Data Factory**</DoNotTranslate> .
