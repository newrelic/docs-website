...
1. Vaya a <DoNotTranslate>**Azure Portal**</DoNotTranslate> y abra un shell seleccionando la terminal <Icon name="fe-terminal"/> icono.
...
3. Desde <DoNotTranslate>**Services > Subscriptions**</DoNotTranslate>, seleccione la suscripción, vaya a <DoNotTranslate>**Access control (IAM)**</DoNotTranslate> y luego seleccione <Icon name="fe-plus"/> <DoNotTranslate>**Add**</DoNotTranslate>.

4. En el cuadro de búsqueda <DoNotTranslate>**Role**</DoNotTranslate> , agregue el nombre de la definición de función recién creada (por ejemplo, `NewRelic Integrations`).

5. En el cuadro de búsqueda <DoNotTranslate>**Select**</DoNotTranslate> , agregue el nombre de la aplicación de integración de New Relic y selecciónela.

6. Asegúrese de que la aplicación se agregue a la lista <DoNotTranslate>**Selected members**</DoNotTranslate> y luego <DoNotTranslate>**Save**</DoNotTranslate>.
...
Para ver sus datos de integración, vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Azure**</DoNotTranslate> y seleccione la integración de Cosmos DB.
