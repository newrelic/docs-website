...
[La integración de New Relic](/docs/infrastructure/introduction-infra-monitoring) incluye una integración para informar sus datos [Microsoft Azure Cost Management](https://docs.microsoft.com/en-us/azure/cost-management/) a New Relic. Aquí explicamos cómo activar la integración y qué datos recopila.
...
1. En la sección <DNT>**Subscriptions**</DNT> de Azure Portal, seleccione la suscripción que desea New Relic monitor.
2. Seleccione <DNT>**Access control (IAM) &gt; Add**</DNT>.
3. En el menú desplegable <DNT>**Role**</DNT> , seleccione <DNT>**Billing Reader**</DNT>.
...
<Callout title="Nota">
  Los datos de Azure Cost Management se recopilan únicamente a través de nuestra integración tradicional (sondeo) de Azure. Esta integración **no** está disponible a través de la [integración de monitoreo de Azure](/docs/infrastructure/microsoft-azure-integrations/azure-integrations-list/azure-monitor/). Los datos de costos se basan en eventos y abarcan múltiples recursos y servicios, por lo que no se asignan a un único tipo de recurso de Azure de la forma en que lo requiere la integración de monitoreo de Azure.

  Si está migrando de la integración tradicional de Azure a la integración de monitoreo de Azure, mantenga habilitada la integración tradicional de Azure para continuar recopilando datos de Azure Cost Management.
</Callout>