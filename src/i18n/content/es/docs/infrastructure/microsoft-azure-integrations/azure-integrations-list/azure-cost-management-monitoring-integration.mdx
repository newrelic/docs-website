...
1. En la sección
   ...
   <DoNotTranslate>**Subscriptions**</DoNotTranslate>

   de Azure Portal, seleccione la suscripción que desea New Relic monitor.

2. Seleccione

   <DoNotTranslate>**Access control (IAM) > Add**</DoNotTranslate>
...
3. En el menú desplegable
   ...
   <DoNotTranslate>**Billing Reader**</DoNotTranslate>
...
5. Desde
   ...
   <DoNotTranslate>**Selected members**</DoNotTranslate>
