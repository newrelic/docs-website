...
<CollapserGroup>
  ...
  >
    Dado que la nueva integración permite ingestar todas las métricas de todos los servicios, <DoNotTranslate>**the amount of API calls to Azure will depend on the number of resources that are monitored by New Relic**</DoNotTranslate>. La configuración del parámetro intervalo de sondeo de la integración puede ayudar a controlar la cantidad de estas llamadas API.
...
1. Vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Azure**</DoNotTranslate> y luego haga clic en <DoNotTranslate>**Manage Services**</DoNotTranslate>.
2. Habilite la nueva integración <DoNotTranslate>**Azure Monitor metrics**</DoNotTranslate> y haga clic en <DoNotTranslate>**Save Changes**</DoNotTranslate>.<img title="Shows where to enable the Azure monitor" alt="Shows where to enable the Azure monitor" src={infrastructureAzureMonitorMetricsIntegration}/>
3. La integración <DoNotTranslate>**Azure Monitor metrics**</DoNotTranslate> estará disponible.<img title="Shows where azure monitor metrics integration" alt="Shows where azure monitor metrics integration" src={infrastructureAzureMonitorMetricsConfigure}/>
4. Habilite y configure la nueva integración.<img title="Shows where azure monitor enable toggle button" alt="Shows where azure monitor enable toggle button" src={infrastructureAzureMonitorEnableToggle}/>
5. Una vez realizada la configuración, puede desactivar la integración de sondeo anterior en la configuración <DoNotTranslate>**Manage services**</DoNotTranslate> .
