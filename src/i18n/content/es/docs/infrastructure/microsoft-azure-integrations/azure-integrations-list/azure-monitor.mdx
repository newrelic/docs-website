...
2. Habilite la nueva integración <DNT>**Azure Monitor metrics**</DNT> y haga clic en <DNT>**Save Changes**</DNT>.<img
   ...
   />
3. La integración <DNT>**Azure Monitor metrics**</DNT> estará disponible.<img
   ...
   />
4. Habilite y configure la nueva integración.<img
