  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * <DoNotTranslate>**Debian**</DoNotTranslate> o <DoNotTranslate>**Ubuntu**</DoNotTranslate>:
...
* <img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="Kubernetes" alt="Kubernetes" src={osk8}>[Actualizar la integración en el host en Kubernetes](/docs/integrations/kubernetes-integration/link-apps-services/monitor-services-running-kubernetes)</img>
* <img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="ECS" alt="ECS" src={osEcs}>[Actualización de integración en el host en Amazon ECS](/docs/integrations/host-integrations/host-integrations-list/monitor-services-running-amazon-ecs) (tipo de lanzamiento EC2)</img>
...
<CollapserGroup>
  <Collapser
    id="windows"
    title={<>Actualizar usando archivos MSI (<img src={osWindows} title="Windows Server" alt="Windows Server" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}>Servidor de windows)</img></>}
  >
  ...
  <Collapser
    id="apt"
    title={<>Actualizar con apto (<img src={osDebian} title="Debian icon" alt="Debian.webp" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}>debian,<img src={osUbuntu} title="ubuntu icon" alt="ubuntu icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>ubuntu)</img></>}
  >
    <DoNotTranslate>**Recommendation:**</DoNotTranslate> [Actualice](/docs/infrastructure/new-relic-infrastructure/installation/update-infrastructure-agent) el agente de infraestructura ([versión 1.0.703 o superior](/docs/release-notes/infrastructure-release-notes/infrastructure-agent-release-notes)).
  ...
  <Collapser
    id="yum"
    title={<>Actualizar con yum (<img src={osAmazonLinux} title="amazon linux.webp" alt="amazon linux.webp" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}>amazon linux,<img src={osCentos} title="centos icon" alt="centos icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>CentOS,<img src={osRedhat} title="redhat icon" alt="redhat icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>RHEL)</img></>}
  >
    <DoNotTranslate>**Recommendation:**</DoNotTranslate> [Actualice](/docs/infrastructure/new-relic-infrastructure/installation/update-infrastructure-agent) el agente de infraestructura ([versión 1.0.703 o superior](/docs/release-notes/infrastructure-release-notes/infrastructure-agent-release-notes)).
  ...
  <Collapser
    id="zypper"
    title={<>Actualizar con zypper (<img src={osSuse} title="suse icon" alt="suse icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}>SLES)</img></>}
  >
    <DoNotTranslate>**Recommendation:**</DoNotTranslate> [Actualice](/docs/infrastructure/new-relic-infrastructure/installation/update-infrastructure-agent) el agente de infraestructura ([versión 1.0.703 o superior](/docs/release-notes/infrastructure-release-notes/infrastructure-agent-release-notes)).
  ...
  <Collapser
    id="tarball"
    title={<>Actualización desde tarball (<img src={osLinux} title="Linux" alt="Linux icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}>Otras distribuciones)</img></>}
  >
    <Callout variant="tip">
