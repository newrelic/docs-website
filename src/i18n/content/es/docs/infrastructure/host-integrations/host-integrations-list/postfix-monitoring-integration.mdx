...
<Steps>
  ...
  <Step>
    ...
    Su dashboard de Postfix es un panel personalizado. Accede a él desde la UI <DoNotTranslate>**Dashboards**</DoNotTranslate>. Para obtener documentos sobre el uso y edición del panel, consulte [nuestros documentos dashboard ](/docs/query-your-data/explore-query-data/dashboards/introduction-dashboards).
