...
2. Haga clic en <DoNotTranslate>**Import a Product**</DoNotTranslate> e importe el mosaico New Relic Service Broker para VMware Tanzu.
...
3. Haga clic en el botón <DoNotTranslate>**+**</DoNotTranslate> a la derecha del "New Relic Service Broker" que cargó.
...
16. Vuelva a preparar la aplicación. Puede seleccionar el enlace en la parte superior de la página <DoNotTranslate>**Bind**</DoNotTranslate> , o en una ventana de terminal, y ejecutar `cf restage` para realizar los cambios.
