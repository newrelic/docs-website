...
La integración Cassandra recopila información métrica (<DoNotTranslate>**M**</DoNotTranslate>) e inventario (<DoNotTranslate>**I**</DoNotTranslate>). En la tabla, utilice la columna <DoNotTranslate>**Applies To**</DoNotTranslate> para las configuraciones disponibles para cada colección:
...
Los datos de esta integración se pueden encontrar en: <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > Third-party services > Cassandra**</DoNotTranslate>.
