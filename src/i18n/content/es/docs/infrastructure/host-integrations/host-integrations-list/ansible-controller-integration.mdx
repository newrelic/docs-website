...
<CollapserGroup>
  ...
  >
    Una vez que inicie sesión en la plataforma Ansible Automation, navegue hasta la sección <DoNotTranslate>**Users**</DoNotTranslate>, seleccione <DoNotTranslate>**admin**</DoNotTranslate> y luego agregue un <DoNotTranslate>**token**</DoNotTranslate> al usuario. Copie el token y guárdelo en la ruta deseada.
