...
<Steps>
  <Step>
    ...
    Para utilizar la integración de Ray, primero debe [instalar el agente de infraestructura](/docs/infrastructure/install-infrastructure-agent/get-started/install-infrastructure-agent-new-relic/) en el mismo host. El agente de infraestructura monitorea el propio host, mientras que la integración Ray extiende su monitoreo con datos específicos del clúster Ray.  
  ...
  <Step>
    ## Configurar `nri-prometheus` para Ray [#configure]
  ...
  <Step>
    ...
    Para instrumentar el inicio rápido de Apache Druid y ver métricas y alertas, también puede seguir nuestra [página de inicio rápido de Ray](https://newrelic.com/instant-observability/ray) haciendo clic en el botón `Install now` .
