...
Para encontrar sus datos de integración, vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Third-party services**</DoNotTranslate> y seleccione uno de los enlaces de integración de Microsoft SQL Server.
