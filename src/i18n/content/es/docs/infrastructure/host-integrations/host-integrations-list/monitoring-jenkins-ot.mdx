...
7. Llegué a
   ...
   <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & services > Services - OpenTelemetry > jenkins**</DNT>
...
9. Haga clic en
   ...
   para ver el log de su consola Jenkins. Si no hay ningún log, verifique que la variable de entorno `OTEL_LOGS_EXPORTER="otlp"` esté configurada.
