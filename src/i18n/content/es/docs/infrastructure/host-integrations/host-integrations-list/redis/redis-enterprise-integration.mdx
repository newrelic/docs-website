...
3. Agregue una nueva cuenta de usuario con
   ...
   <DNT>**Cluster View Permissions**</DNT>
...
2. Haga clic en la pestaña <DNT>**Dashboards**</DNT> y, en el campo de búsqueda, escriba <DNT>**Redis Enterprise**</DNT>.<img title="Redis Enterprise dashboards" alt="A screenshot of the Redis Enterprise dashboards." src={infrastructureRedisEnterpriseDashboard}/>
