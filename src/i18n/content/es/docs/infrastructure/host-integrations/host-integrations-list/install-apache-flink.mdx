...
3. En el cuadro de búsqueda, busque
   ...
   <DoNotTranslate>**Apache Flink**</DoNotTranslate>
...
Para instrumentar el inicio rápido de Apache Flink y ver métricas y alertas, también puede seguir nuestra [página de inicio rápido de Apache Flink](https://newrelic.com/instant-observability/apache-flink) haciendo clic en el botón <DoNotTranslate>**Install now**</DoNotTranslate> .
