...
<CollapserGroup>
  ...
  >
    ...
    Los eventos están disponibles en la página <DoNotTranslate>**Events**</DoNotTranslate> y se pueden consultar a través de [NRQL](/docs/query-data/nrql-new-relic-query-language/getting-started/introduction-nrql) como `InfrastructureEvent` en `vSphereEvent`. A continuación se muestra un ejemplo de datos de eventos de vSphere:
  ...
  >
    El rendimiento métrico proporciona una mejor comprensión del estado actual de los recursos de VMware y se puede recopilar <DoNotTranslate>**in addition**</DoNotTranslate> en la métrica recopilada de forma predeterminada; e incluirse en las muestras; descritas en la parte inferior de la página.
