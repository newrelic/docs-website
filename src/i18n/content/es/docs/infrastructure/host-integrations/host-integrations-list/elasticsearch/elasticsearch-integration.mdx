...
<Callout variant="tip">
  ¡Nueva opción de OpenTelemetry disponible! Considere usar nuestra [integración de Elasticsearch OpenTelemetry](/docs/opentelemetry/integrations/elasticsearch/elasticsearch-otel-integration-overview) en su lugar. Ofrece monitoreo neutral al proveedor, rendimiento mejorado y una arquitectura preparada para el futuro utilizando protocolos OpenTelemetry estándar de la industria.
</Callout>
