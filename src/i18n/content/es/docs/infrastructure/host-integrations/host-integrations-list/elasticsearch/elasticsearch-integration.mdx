...
<CollapserGroup>
  <Collapser
    id="windows-install"
    title={<><img src={osWindows} title="Windows installation" alt="Windows installation" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}>instalación de Windows</img></>}
  >
...
La integración Elasticsearch recopila información tanto métrica como de inventario. En la tabla, utilice la columna <DoNotTranslate>**Applies to**</DoNotTranslate> para las configuraciones disponibles para cada colección:
