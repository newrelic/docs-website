...
3. Vaya a <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DoNotTranslate> y luego haga clic en <DoNotTranslate>**Metrics & events**</DoNotTranslate>. Ejecute la siguiente consulta para confirmar que New Relic está reportando métrica personalizada:
