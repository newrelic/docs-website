...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        URI de conexión de MongoDB. <DNT>**Required**</DNT>
      </td>
...
Las siguientes dimensiones métricas se capturan raspando el exportador y se vinculan a la entidad <DNT>**MONGODB_INSTANCE**</DNT>:
...
Las siguientes dimensiones métricas se capturan raspando el exportador y se vinculan a la entidad <DNT>**MONGODB_COLLECTION**</DNT>:
...
Las siguientes dimensiones métricas se capturan raspando el exportador y se vinculan a la entidad <DNT>**MONGODB_DATABASE**</DNT>:
