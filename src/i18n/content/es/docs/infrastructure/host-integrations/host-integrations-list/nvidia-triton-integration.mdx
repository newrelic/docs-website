...
<Steps>
  ...
  <Step>
    ...
    1. Vaya a **[one.newrelic.com](https://one.newrelic.com) > + Add data** y escriba **NVIDIA Triton**.
    ...
    Puedes encontrar tu dashboard personalizado de NVIDIA Triton en la UI <DoNotTranslate>**Dashboards**</DoNotTranslate>. Consulte nuestra sección [dashboard](/docs/query-your-data/explore-query-data/dashboards/introduction-dashboards) para obtener más información.
