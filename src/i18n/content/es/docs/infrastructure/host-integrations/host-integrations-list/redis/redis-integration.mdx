...
La integración Redis recopila información métrica(<DoNotTranslate>**M**</DoNotTranslate>) e Inventario(<DoNotTranslate>**I**</DoNotTranslate>). En la tabla, utilice la columna <DoNotTranslate>**Applies To**</DoNotTranslate> para las configuraciones disponibles para cada colección:
