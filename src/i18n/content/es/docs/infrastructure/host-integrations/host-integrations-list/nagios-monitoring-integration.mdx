...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Esto apunta a un [archivo yaml](#service-checks-yaml) que contiene definiciones de las verificações de servicio que ejecutará la integración. <DoNotTranslate>**Required.**</DoNotTranslate>
      </td>
...
Para encontrar sus datos de integración, vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Third-party services**</DoNotTranslate> y seleccione uno de los enlaces de integración de Nagios.
