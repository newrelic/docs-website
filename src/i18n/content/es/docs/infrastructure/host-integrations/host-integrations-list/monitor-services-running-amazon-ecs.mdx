...
2. En el panel de navegación, en <DoNotTranslate>**Auto scaling**</DoNotTranslate>, elija <DoNotTranslate>**Launch configurations**</DoNotTranslate>.

3. En la página siguiente, seleccione la configuración de lanzamiento que desea actualizar.

4. Haga clic derecho y seleccione <DoNotTranslate>**Copy launch configuration**</DoNotTranslate>.

5. En la pestaña <DoNotTranslate>**Launch configuration details**</DoNotTranslate>, haga clic en <DoNotTranslate>**Edit details**</DoNotTranslate>.
...
7. Elija <DoNotTranslate>**Skip to review**</DoNotTranslate>.

8. Elija <DoNotTranslate>**Create launch configuration**</DoNotTranslate>.
...
4. Si su página de estado de NGINX está configurada para atender solicitudes del `STATUS_URL` en el puerto 80, el agente de infraestructura comienza a monitorearla. Después de cinco minutos, verifique que los datos de NGINX aparezcan en nuestra UI de infraestructura (ya sea: <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Third party services**</DoNotTranslate> o <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Third-party services**</DoNotTranslate>).
...
5. Si la configuración funciona, colóquela en la configuración de lanzamiento de EC2:
   ...
   6. En la sección <DoNotTranslate>**User data**</DoNotTranslate>, edite la sección `write_files` (en la parte marcada como `text/cloud-config`).
...
6. Elija <DoNotTranslate>**Skip to review**</DoNotTranslate>.

7. Elija <DoNotTranslate>**Create launch configuration**</DoNotTranslate>.
