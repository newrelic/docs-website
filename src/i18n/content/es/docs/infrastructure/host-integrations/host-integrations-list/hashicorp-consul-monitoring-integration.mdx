...
Nuestra [integración en el host](/docs/integrations/host-integrations/getting-started/introduction-host-integrations) HashiCorp Consul recopila y envía inventario y métricas de su entorno de centro de datos Consul a New Relic, donde puede ver el estado de su entorno. Recopilamos datos tanto a nivel del centro de datos como del agente/nodo.
...
<ButtonGroup>
  <ButtonLink role="button" to="https://one.newrelic.com/launcher/nr1-core.explorer?pane=eyJuZXJkbGV0SWQiOiJucjEtY29yZS5saXN0aW5nIn0=&cards[0]=" variant="primary">
    Instalación guiada, región de EE. UU. (predeterminada)
  </ButtonLink>
  ...
  <ButtonLink role="button" to="https://one.jp.newrelic.com/launcher/nr1-core.explorer?pane=eyJuZXJkbGV0SWQiOiJucjEtY29yZS5saXN0aW5nIn0=&cards[0]=" variant="primary">
    Instalación guiada, región de Japón
  </ButtonLink>
</ButtonGroup>
...
<CollapserGroup>
  ...
  <Collapser id="metrics-nofanout" title="Solo métrica con token y sin Fan Out">
    En esta configuración usamos un token ACL para conectarnos y no recopilamos métricas de otros nodos cónsules conectados (FAN\_OUT: false):
  ...
  <Collapser id="multi-instance" title="Monitoreo multiinstancia">
...
### Muestra de centro de datos Consul métrica [#consul-datacenter-sample]
