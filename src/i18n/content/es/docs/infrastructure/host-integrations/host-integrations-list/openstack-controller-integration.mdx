...
5. Puede deshabilitar la captura de cualquier recurso configurando <DoNotTranslate>**enabled**</DoNotTranslate> en <DoNotTranslate>**false**</DoNotTranslate> para ese recurso en <DoNotTranslate>**config/os-config.json**</DoNotTranslate>.
