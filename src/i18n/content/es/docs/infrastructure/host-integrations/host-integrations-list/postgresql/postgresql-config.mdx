...
La integración PostgreSQL recopila información tanto métrica (<DoNotTranslate>**M**</DoNotTranslate>) como de inventario (<DoNotTranslate>**I**</DoNotTranslate>). La columna <DoNotTranslate>**Applies To**</DoNotTranslate> en la siguiente tabla indica qué configuraciones se pueden usar para cada colección específica:
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        El nombre de usuario para la conexión PostgreSQL. <DoNotTranslate>**Required.**</DoNotTranslate>
      </td>
    ...
    <tr>
      ...
      <td>
        La contraseña para la conexión PostgreSQL. <DoNotTranslate>**Required.**</DoNotTranslate>
      </td>
