...
<CollapserGroup>
  ...
  >
    ...
    <DoNotTranslate>**Recommendation:**</DoNotTranslate> [Configure un archivo de registro](/docs/infrastructure/new-relic-infrastructure/troubleshooting/generating-logs-troubleshooting-infrastructure) en la configuración del agente de infraestructura. Esto ayuda a separar los tipos de errores para que pueda detectar los errores de integración más fácilmente.
