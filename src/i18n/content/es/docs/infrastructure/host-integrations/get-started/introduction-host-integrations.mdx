...
En New Relic, <DoNotTranslate>**on-host integrations**</DoNotTranslate> es lo que llamamos nuestra integración que trabaja en conjunto con nuestro agente de infraestructura. Estas integraciones recopilan datos de los servicios admitidos y utilizan el agente de infraestructura para enviar esos datos a New Relic.
...
Para comenzar con la integración en el host: Si ya tienes New Relic, ve a la [página<DoNotTranslate>**Add data**</DoNotTranslate> ](https://one.newrelic.com/marketplace)y busca el servicio que deseas monitor.
