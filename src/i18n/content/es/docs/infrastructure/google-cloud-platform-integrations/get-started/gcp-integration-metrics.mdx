...
## Google Cloud métrica [#gcp-metrics-table]

La siguiente tabla es una lista no exhaustiva de métricas recopiladas por GCP integración y sus traducciones [métricas dimensionales](/docs/telemetry-data-platform/ingest-manage-data/understand-data/new-relic-data-types/#dimensional-metrics) .
...
<table>
  <tbody>
    ...
    <tr>
      <td>
        Almacenamiento de datos de GCP
      </td>
    ...
    <tr>
      <td>
        Almacenamiento de base de fuego de GCP
      </td>
