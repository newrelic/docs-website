...
## Métricas de Google Cloud [#gcp-metrics-table]

La siguiente tabla enumera algunas de las métricas recopiladas por las integraciones de GCP y sus traducciones de [métricas dimensionales](/docs/telemetry-data-platform/ingest-manage-data/understand-data/new-relic-data-types/#dimensional-metrics).
