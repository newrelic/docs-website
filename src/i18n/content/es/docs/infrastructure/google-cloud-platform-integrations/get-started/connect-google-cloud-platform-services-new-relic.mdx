  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        Antes de agregar el ID de la cuenta de servicio, asegúrate de hacer clic en el botón &quot;Obtener datos&quot; en el asistente de incorporación de New Relic para verificar la autorización para la recuperación de datos de Google.

        En el proyecto de GCP <DNT>**IAM &amp; admin**</DNT>, la cuenta de servicio debe tener la función <DNT>**Viewer**</DNT> y la función <DNT>**Service Usage Consumer**</DNT> o, alternativamente, una [función personalizada](/docs/integrations/google-cloud-platform-integrations/get-started/integrations-custom-roles).
      </td>
    </tr>
    ...
    <tr>
      <td>
        ...
        Tenga en cuenta que este método de autorización no permitirá que New Relic recopile etiquetas y otros atributos que puedan ser útiles para limitar su consulta, dashboard y alerta de NRQL.
...
<CollapserGroup>
  <Collapser id="service" title="Cuenta de servicio (recomendado)">
    ...
    Si su organización utiliza una [restricción de dominio](https://cloud.google.com/resource-manager/docs/organization-policy/restricting-domains), deberá actualizar la política para permitir New Relic, dependiendo de qué restricción aplique su organización:

    * **`iam.allowedPolicyMemberDomains`**: permitir el ID de dominio de New Relic `C02x1gp26`.
    * **`iam.managed.allowedPolicyMembers`**: Permita el ID de organización de GCP de New Relic `740422149647` o el número de proyecto de GCP `397727728820`.
  ...
  <Collapser id="user" title="Cuenta de usuario">
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        1. Desde <DNT>**[one.newrelic.com &gt; All capabilities](https://one.newrelic.com/all-capabilities) &gt; Infrastructure &gt; GCP &gt; Manage services**</DNT>.
