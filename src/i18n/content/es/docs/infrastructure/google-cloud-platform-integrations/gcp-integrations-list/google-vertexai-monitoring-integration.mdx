...
New Relic also collects metrics for the following Vertex AI resource types. These resource types don&apos;t create entities in the entity explorer, so query their metrics directly on the `Metric` event type.

<CollapserGroup>
  <Collapser id="metrics-only-publisher-model" title="Publisher Model — 15 metrics">
    <table>
      <thead>
        <tr>
          <th style={{ width: "40%" }}>
  ...
  <Collapser id="metrics-only-deployment-resource-pool" title="Deployment Resource Pool — 8 metrics">
    <table>
      <thead>
        <tr>
          <th style={{ width: "40%" }}>
  ...
  <Collapser id="metrics-only-reasoning-engine" title="Reasoning Engine — 8 metrics">
    <table>
      <thead>
        <tr>
          <th style={{ width: "40%" }}>
  ...
  <Collapser id="metrics-only-index-endpoint" title="Index Endpoint — 6 metrics">
    <table>
      <thead>
        <tr>
          <th style={{ width: "40%" }}>
  ...
  <Collapser id="metrics-only-model" title="Model — 3 metrics">
    <table>
      <thead>
        <tr>
          <th style={{ width: "40%" }}>
  ...
  <Collapser id="metrics-only-online-evaluator" title="Online Evaluator — 2 metrics">
    <table>
      <thead>
        <tr>
          <th style={{ width: "40%" }}>
