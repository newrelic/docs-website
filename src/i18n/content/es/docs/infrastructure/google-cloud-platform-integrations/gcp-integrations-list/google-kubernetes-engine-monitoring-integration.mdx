...
[La integración de New Relic](/docs/infrastructure/integrations-getting-started/getting-started/introduction-infrastructure-integrations) con [Google Kubernetes Engine](https://cloud.google.com/kubernetes-engine/) (GKE) arroja datos sobre el clúster alojado en la infraestructura de Google. Puede monitor y alertar sobre los datos de su instancia de GKE desde nuestra [UI de infraestructura](/docs/infrastructure), y puede crear [consultas personalizadas y un panel de gráficos](/docs/insights).

## Activar la integración [#activate]

Para habilitar la integración:

1. Asegúrese de haber [instalado el agente de infraestructura](/docs/infrastructure/new-relic-infrastructure/installation) antes de activar la integración GCP desde New Relic.
2. Siga los procedimientos estándar para [conectar su servicio GCP a New Relic](/docs/connect-google-cloud-platform-services-infrastructure).
