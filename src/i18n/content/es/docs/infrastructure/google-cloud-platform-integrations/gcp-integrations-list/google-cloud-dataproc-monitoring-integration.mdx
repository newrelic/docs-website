...
<CollapserGroup>
  <Collapser id="metrics-only-job" title="Job — 3 metrics">
    <table>
      <thead>
        <tr>
          <th style={{ width: "40%" }}>
  ...
  <Collapser id="metrics-only-batch" title="Batch — 1 metric">
    <table>
      <thead>
        <tr>
          <th style={{ width: "40%" }}>
  ...
  <Collapser id="metrics-only-session" title="Session — 1 metric">
    <table>
      <thead>
        <tr>
          <th style={{ width: "40%" }}>
