  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * `NEW_RELIC_REGION`: su [región del centro de datos](/docs/accounts/accounts-billing/account-setup/choose-your-data-center) (`US`, `EU` o `JP`). El valor predeterminado es `US`.
