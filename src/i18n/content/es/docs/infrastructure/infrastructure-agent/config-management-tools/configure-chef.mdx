...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        La [región del centro de datos](/docs/accounts/accounts-billing/account-setup/choose-your-data-center) para su organización (`US`, `EU` o `JP`). El valor predeterminado es `US`.
      </td>
    </tr>
