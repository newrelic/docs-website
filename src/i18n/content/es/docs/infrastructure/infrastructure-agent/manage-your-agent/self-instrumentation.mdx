...
<Callout variant="tip">
  Reemplace el marcador de posición `ACCOUNT_ID` con su número de cuenta en la carga útil json a continuación. Más información sobre [la importación del dashboard](/docs.newrelic.com/docs/query-your-data/explore-query-data/dashboards/introduction-dashboards/#dashboards-import)
</Callout>
