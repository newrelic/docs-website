...
La forma más rápida de comenzar con nuestro [agente de infraestructura](/docs/infrastructure/infrastructure-monitoring/get-started/get-started-infrastructure-monitoring/) es a través de nuestra [instalación guiada](/docs/new-relic-one/use-new-relic-one/cross-product-functions/install-configure/new-relic-guided-install-overview/). Si se encuentra en la UE, pruebe nuestra instalación guiada de la UE. Si se encuentra en la región de JP, pruebe nuestra instalación guiada de JP.
