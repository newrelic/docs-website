...
<CollapserGroup>
  ...
  <Collapser
    id="avg-free-memory"
    title={<><img src={osDocker} title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}>docker: ver la memoria promedio libre para el extremo raspado</img></>}
  >
  ...
  <Collapser
    ...
    title={<><img src={osk8} title="img-integration-k8.png" alt="img-integration-k8.png" style={{ height: '35px', width: '40px' }}>Kubernetes: vea el uso promedio de memoria para el pod en un despliegue</img></>}
  >
