...
<Callout variant="tip">
  Para ejecutar una consulta al estilo PromQL en [New Relic](/docs/new-relic-one/use-new-relic-one/get-started/introduction-new-relic-one), vaya al [generador de consultas modo avanzado estilo PromQL](/docs/infrastructure/prometheus-integrations/view-query-data/view-query-your-prometheus-data/#build-query).
</Callout>
