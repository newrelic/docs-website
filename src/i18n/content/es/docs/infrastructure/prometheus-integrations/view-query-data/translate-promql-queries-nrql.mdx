...
<Callout variant="tip">
  Para ejecutar una consulta de estilo PromQL en [New Relic One](/docs/new-relic-one/use-new-relic-one/get-started/introduction-new-relic-one), vaya al [generador de consultas modo avanzado de estilo PromQL](/docs/infrastructure/prometheus-integrations/view-query-data/view-query-your-prometheus-data/#build-query).
</Callout>
...
<Video id="oFBJY3OSvLM" type="youtube" />
