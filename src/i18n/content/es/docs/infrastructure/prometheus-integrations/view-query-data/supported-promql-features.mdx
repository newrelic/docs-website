...
<CollapserGroup>
  ...
  <Collapser title="Grafana specific features">
    The translation logic also has some limited support for grafana syntax that&apos;s not a part of the promQL language.
