...
<DNT>**Recommendation:**</DNT> Coloque los archivos del paquete, la clave y el certificado de CA en un secreto e inclúyalos en el contenedor de integración de Prometheus OpenMetrics.
