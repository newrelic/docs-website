...
Por favor, consulte la siguiente [página](/docs/infrastructure/prometheus-integrations/install-configure-prometheus-agent/install-prometheus-agent) para comprender los beneficios del agente Prometheus y obtener una visibilidad completa de su carga de trabajo Prometheus ejecutándose en un clúster de Kubernetes.
