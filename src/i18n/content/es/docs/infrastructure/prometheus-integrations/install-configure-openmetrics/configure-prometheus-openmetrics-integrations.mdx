...
<CollapserGroup>
  <Collapser
    ...
    title={<><img src={osk8} title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png" style={{ width: '30px', height: '25px' }} />PuertoKubernetes </>
    }
  >
  ...
  <Collapser
    ...
    title={<><img src={osk8} title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png" style={{ width: '30px', height: '25px' }} /></>
    }
  >
