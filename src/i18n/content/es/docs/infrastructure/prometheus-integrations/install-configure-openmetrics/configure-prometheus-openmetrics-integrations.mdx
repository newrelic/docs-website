...
Para recargar la configuración, reinicie la integración. <DNT>**Recommendation:**</DNT> Reduzca el despliegue a cero réplicas y luego vuelva a escalarlo a una réplica:
