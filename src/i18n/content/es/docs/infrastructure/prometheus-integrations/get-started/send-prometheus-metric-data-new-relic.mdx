...
El agente Prometheus de New Relic le permite extraer fácilmente Prometheus métrica de un clúster de Kubernetes. Al aprovechar el descubrimiento de servicios y las etiquetas de Kubernetes, obtendrá acceso instantáneo a métrica, dashboard y <InlinePopover type="alerts" />de la carga de trabajo más popular.
...
* Obtenga automáticamente información sobre la carga de trabajo más popular. Aproveche el conjunto predefinido de dashboard y alerta.
...
* Consulta y visualiza estos datos en la UI de New Relic.
* Conecte su [dashboard de Grafana](/docs/integrations/grafana-integrations/get-started/grafana-support-prometheus-promql) (opcional).
