...
<Callout variant="caution">
  Una cuenta puede tener hasta 1500 clústeres de HA de Prometheus únicos. Si se supera este límite, se descartarán los datos de los clústeres de HA adicionales. En tales casos, New Relic genera `PrometheusHAClusterLimit` eventos [`NrIntegrationError`](/docs/data-apis/ingest-apis/metric-api/troubleshoot-nrintegrationerror-events/).
</Callout>
