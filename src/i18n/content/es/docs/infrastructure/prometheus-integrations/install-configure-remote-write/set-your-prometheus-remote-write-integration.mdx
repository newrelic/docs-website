...
Vaya al [iniciador de configuración de escritura remota de Prometheus en la UI](https://one.newrelic.com/launcher/nr1-core.settings?pane=eyJuZXJkbGV0SWQiOiJwcm9tZXRoZXVzLXJlbW90ZS13cml0ZS1pbnRlZ3JhdGlvbi1uZXJkbGV0cy5zZXR1cC1wcm9tZXRoZXVzIn0=) y complete estos pasos para agregar datos de Prometheus.
...
1. Introduzca un nombre para el servidor Prometheus que se conectará y su URL `remote_write` . <DoNotTranslate>**Important:**</DoNotTranslate> El nombre que ingreses para el servidor creará un atributo en tus datos. También será el nombre que identifique qué servidor Prometheus está enviando datos a New Relic.
...
<CollapserGroup>
  ...
  <Collapser
    ...
    title={<><InlineCode>prometheus_server</InlineCode> Parámetro de URL</>}
  >
