...
* Si empleó la instalación guiada, seleccione la opción <DNT>**Scrape all Prometheus endpoints**</DNT> .<img title="Kubernetes Guided Install" alt="Kubernetes Guided Install" src={infrastructurePrometheusScrapeOnlyMetrics}/>
