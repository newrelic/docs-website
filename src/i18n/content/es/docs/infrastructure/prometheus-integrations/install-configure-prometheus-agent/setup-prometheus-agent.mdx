...
* Si utilizó la instalación guiada, seleccione la opción <DoNotTranslate>**Scrape all Prometheus endpoints**</DoNotTranslate> .<img title="Kubernetes Guided Install" alt="Kubernetes Guided Install" src={infrastructurePrometheusScrapeOnlyMetrics}/>
