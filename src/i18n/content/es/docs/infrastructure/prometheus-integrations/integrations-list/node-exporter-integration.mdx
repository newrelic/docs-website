---
title: Integración del Node Exporter
tags:
  - Integrations
  - Node Exporter
  - Prometheus
...
3. Vea sus datos en la yendo New Relic UI a **<DoNotTranslate>[one.newrelic.com](https://one.newrelic.com/)</DoNotTranslate> > Infrastructure > Hosts**.