...
<Callout variant="tip">
  Consulte nuestro [tutorial de solución de problemas](/docs/tutorial-troubleshoot-infra-hosts/diagnose-app-infra-data) para sus datos de host de infraestructura. La serie de tutoriales le guía a través de cómo encontrar datos en la UI de infraestructura para resolver un evento de alerta y tomar una decisión de recursos sobre sus hosts.
</Callout>
