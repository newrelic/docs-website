...
* Ver el dashboard:
  ...
  * Para el resto del dashboard de integración, vaya a <DNT>**[one.newrelic.com &gt; All capabilities](https://one.newrelic.com/all-capabilities) &gt; Infrastructure**</DNT> y haga clic en su integración.
