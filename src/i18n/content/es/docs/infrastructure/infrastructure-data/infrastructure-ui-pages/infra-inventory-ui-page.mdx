...
<CollapserGroup>
  ...
  <Collapser id="alerts" title="Ver eventos de alerta de umbral del host">
    Para ver los [eventos de umbral de alerta](/docs/alerts/new-relic-alerts/getting-started/alerts-glossary#alert-threshold) de uno o más hosts, seleccione el icono <DNT>**Critical**</DNT> <Icon name="fe-x-circle" /> o el icono <DNT>**Warning**</DNT> <Icon name="fe-alert-triangle" /> del host.
  </Collapser>
</CollapserGroup>
