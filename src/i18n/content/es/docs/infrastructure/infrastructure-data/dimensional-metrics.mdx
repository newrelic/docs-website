---
title: Formatos dimensionales métricos para agente e integración en el host
tags:
  - Infrastructure
  - Manage your data
...
En el pasado, nuestro agente de infraestructura e integración en el host ha informado [métrica como atributo adjunto al evento](/docs/data-apis/understand-data/new-relic-data-types/#metric-event-attributes), también conocido como &amp;quot;datos de muestra&amp;quot;. Ahora hemos hecho que estas métricas también estén disponibles como [métrica dimensional](/docs/data-apis/understand-data/new-relic-data-types/#dimensional-metrics), un formato de datos que permite un mejor análisis y agregación a lo largo del tiempo.

La siguiente tabla presenta los nombres dimensionales y métricos equivalentes para nuestro agente de infraestructura y para nuestra integración en el host. Para obtener consejos sobre cómo realizar una consulta dimensional métrica, consulte [consulta dimensional métrica](/docs/data-apis/understand-data/metric-data/query-metric-data-type).
