...
4. Habilite la opción
   ...
   <DNT>**Don't trigger alerts for hosts that perform a clean shutdown**</DNT>
...
2. Utilice el enlace de la notificación por correo electrónico para monitor los cambios continuos en su entorno desde la [página](/docs/infrastructure/new-relic-infrastructure/infrastructure-ui-pages/infrastructure-events-page-live-feed-every-config-change)
   ...
   <DNT>[**Events**](/docs/infrastructure/new-relic-infrastructure/infrastructure-ui-pages/infrastructure-events-page-live-feed-every-config-change)</DNT>
...
3. Opcional: utilice el [enlace](/docs/alerts/new-relic-alerts/reviewing-alert-incidents/acknowledge-alert-incidents)
   ...
   <DNT>[**Acknowledge**](/docs/alerts/new-relic-alerts/reviewing-alert-incidents/acknowledge-alert-incidents)</DNT>
...
4. Utilice los enlaces de correo electrónico para examinar detalles adicionales en la [página](/docs/alerts-applied-intelligence/new-relic-alerts/alert-incidents/view-event-details-incidents)
   ...
   <DNT>[**Incident details**](/docs/alerts-applied-intelligence/new-relic-alerts/alert-incidents/view-event-details-incidents)</DNT>
