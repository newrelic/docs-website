...
<Callout variant="tip">
  Si su organización aloja datos en una región del centro de datos distinta de EE. UU., asegúrese de utilizar los extremos de la región correctos. [Obtenga más información sobre las regiones del centro de datos y los extremos.](/docs/accounts/accounts-billing/account-setup/choose-your-data-center)
</Callout>
