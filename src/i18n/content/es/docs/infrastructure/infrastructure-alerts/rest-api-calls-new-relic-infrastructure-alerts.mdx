  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * Cree una condición con filtrado de exclusión (por ejemplo, `environment NOT LIKE x`). Para más información sobre esto, consulte [esta publicación sobre el filtrado de exclusión](https://support.newrelic.com/s/hubtopic/aAX8W0000008Znr/relic-solution-use-the-infrastructure-alerts-rest-api-pt-1).
...
<Callout variant="tip">
  Si su organización aloja datos en una región de centro de datos distinta a la de EE. UU. (predeterminada), asegúrese de estar utilizando los extremos de región correctos. [Obtenga más información sobre las regiones del centro de datos y los extremos.](/docs/accounts/accounts-billing/account-setup/choose-your-data-center)
</Callout>
