...
6. Confirme que ha configurado su Kinesis Data Firehose con los detalles de destino correctos:
   ...
   * Asegúrese de que se haya seleccionado el centro de datos correcto de EE. UU., la UE o JP para su cuenta de New Relic. Consejo: si el `license_key` comienza con “eu”, entonces debe seleccionar el centro de datos de la UE. Si el `license_key` comienza con “jp”, entonces debe seleccionar el centro de datos de JP.
