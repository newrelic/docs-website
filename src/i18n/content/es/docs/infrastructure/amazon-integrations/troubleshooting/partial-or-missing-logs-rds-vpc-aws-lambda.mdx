...
Recomendado: la forma principal de actualizar la función Lambda de ingesta de logs es seguir los [procedimientos estándar](/docs/serverless-function-monitoring/aws-lambda-monitoring/get-started/update-lambda-monitoring) para actualizar la función utilizando la CLI de New Relic.

También puedes actualizar la función manualmente:

1. Evite falsos positivos en las alertas: siga los [procedimientos de la UI](/docs/alerts/new-relic-alerts/configuring-alert-policies/update-or-disable-policies-conditions#condition-on-off) o los [procedimientos de la API](/docs/alerts/rest-api-alerts/new-relic-alerts-rest-api/disable-enable-alerts-conditions-using-api) para desactivar todas las condiciones de alerta asociadas con las integraciones de monitoreo con AWS Lambda, RDS Enhanced Monitoring y VPC Flow Logs.
