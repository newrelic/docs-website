...
Esto sucede porque la lista desplegable <DoNotTranslate>**Define thresholds**</DoNotTranslate> en nuestra UI de infraestructura solo muestra la métrica que New Relic ha podido recolectar en la última hora.