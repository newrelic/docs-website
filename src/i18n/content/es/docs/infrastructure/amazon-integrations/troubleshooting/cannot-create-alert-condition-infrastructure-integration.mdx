...
4. Para el campo `policy_id`, use la ID única de la política de alertas asociada a la condición. Para encontrar el ID de la política, abra la política en [one.newrelic.com](https://one.newrelic.com), haga clic en el ícono <DNT>**(i)**</DNT> y lea el valor de la etiqueta de ID de la política.
