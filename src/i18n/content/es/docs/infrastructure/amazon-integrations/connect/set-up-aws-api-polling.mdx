...
Consulte nuestra documentación para [instalar una integración de CloudWatch Metric Streams de New Relic](/docs/infrastructure/amazon-integrations/aws-integration-for-metrics/via-cloudformation-and-api-polling/) o para [migrar sus integraciones de sondeo de API a CloudWatch Metric Streams](/docs/infrastructure/amazon-integrations/aws-integration-for-metrics/migrate-from-api-polling-to-cwms/).
