...
3. **Agregue la nueva AWS cuenta** en el <DoNotTranslate>**Metric streams**</DoNotTranslate> modo en la New Relic UI. Vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS**</DoNotTranslate>, haga clic en <DoNotTranslate>**Add an AWS account**</DoNotTranslate>, luego en <DoNotTranslate>**Use metric streams**</DoNotTranslate> y siga los pasos.
...
1. Vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS**</DoNotTranslate> y busque las cuentas <DoNotTranslate>**Stream**</DoNotTranslate> .
