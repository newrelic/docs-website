...
<Callout title="avance">
  ...
  Esta función se proporciona actualmente como parte de un programa de vista previa de conformidad con nuestras [políticas de prelanzamiento](/docs/licenses/license-information/referenced-policies/new-relic-pre-release-policy).<br />
</Callout>
    ...
    <CollapserGroup>
      <Collapser id="metrics-data-type" title="Para el tipo de datos métrica">
        ...
        1. Seleccione el tipo de integración métrica:
           ...
           * <DNT>**[Integration via CloudFormation and CloudWatch metric stream](/docs/infrastructure/amazon-integrations/aws-integration-for-metrics/via-cloudformation-cwms/)**</DNT> es el método recomendado para crear un flujo de tiempo real de métrica a New Relic.
      ...
      <Collapser id="log-data-type" title="Para el tipo de datos de logs">
        ...
        4. New Relic Seleccionar extremos de de API Logs: el sistema establece automáticamente el extremo en función de la región de su New Relic cuenta .
           ...
           * Para la cuenta de Japón, los logs se envían a `https://log-api.jp.nr-data.net/log/v1`
...
<Steps>
  ...
  <Step>
    ### Administrar integraciones de AWS [#manage-aws-integrations]

    1. Inicie sesión en su cuenta [de New Relic](https://one.newrelic.com/) y navegue hasta <DNT>**Infrastructure &gt; AWS**</DNT>.
    2. Para verificar si <DNT>Auto-Discovery</DNT> está habilitado para sus cuentas de AWS, haga clic en <DNT>**Manage AWS Integrations**</DNT>.
    3. Para habilitar Auto-Discovery para una cuenta de AWS, en la lista de cuentas, haga clic en <DNT>**Install**</DNT> para esa cuenta.
    4. Para la detección automática, haga clic en <DNT>**Install**</DNT>.
  </Step>
...
<CollapserGroup>
  ...
  <Collapser id="disable-auto-discovery" title="Deshabilitar el descubrimiento automático">
    ...
    1. Inicie sesión en su cuenta [de New Relic](https://one.newrelic.com/) y navegue hasta <DNT>**Infrastructure &gt; AWS**</DNT>.
    2. Para verificar si <DNT>Auto-Discovery</DNT> está habilitado para sus cuentas de AWS, haga clic en <DNT>**Manage Auto-Discovery**</DNT>.
