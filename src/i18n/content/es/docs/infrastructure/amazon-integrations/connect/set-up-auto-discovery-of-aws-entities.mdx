...
<Steps>
  ...
  <Step>
    ...
    <Callout variant="tip">
      De forma predeterminada, New Relic escanea todas las regiones habilitadas en tu cuenta una vez al día. Puede [actualizar la frecuencia de escaneo y las regiones](#select-region-and-frequency) luego de crear la stack , gestionando la configuración <DNT>Auto-Discovery</DNT> en New Relic One.
    </Callout>
  </Step>
  ...
  <Step>
    ...
    1. Haga clic en <DNT>**Launch your CloudFormation in AWS**</DNT> para navegar a su AWS Console. La stack CloudFormation incluye el parámetro configurado en función de sus selecciones en New Relic One, por lo que no es necesario realizar ninguna edición adicional a menos que desee realizar cambios.
...
<Steps>
  ...
  <Step>
    ...
    3. Una vez creada la stack , regresa a New Relic One.
  </Step>
  ...
  <Step>
    ...
    Para habilitar <DNT>Auto-Discovery</DNT>, en la pantalla de confirmación de New Relic One, haga clic en <DNT>**Save**</DNT>.
  </Step>
</Steps>
