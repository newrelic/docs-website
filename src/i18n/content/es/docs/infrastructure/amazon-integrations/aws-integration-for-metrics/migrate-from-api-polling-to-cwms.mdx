...
<Steps>
    ...
    * AWS X-Ray
    ...
    <CollapserGroup>
      ...
      <Collapser id="without-template" title="Migrar sin plantilla de CloudFormation">
        ...
        1. Consulta [Integrar manualmente desde la consola de AWS](/docs/infrastructure/amazon-integrations/aws-integration-for-metrics/manual/) y completa los pasos.
        2. [Deshabilite toda integración de sondeo innecesaria](/docs/infrastructure/amazon-integrations/connect/uninstall-aws/) en la cuenta de proveedor de AWS anterior.
  ...
  <Step>
    ## Valide los datos de sus flujos de métricas [#validate-data]
