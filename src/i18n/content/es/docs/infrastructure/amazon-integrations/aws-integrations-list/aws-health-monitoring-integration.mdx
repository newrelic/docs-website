...
Los eventos AWS Health se incorporan como <DoNotTranslate>**AwsHealthNotification**</DoNotTranslate> evento. Puede consultar, crear widgets y definir la política de alertas NRQL en función de estos eventos.

La siguiente tabla muestra el atributo principal disponible para el evento <DoNotTranslate>**AwsHealthNotification**</DoNotTranslate> :
