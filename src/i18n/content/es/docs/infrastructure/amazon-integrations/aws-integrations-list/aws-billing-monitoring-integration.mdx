...
<Callout variant="important">
  Solo necesita habilitar la casilla de verificación <DoNotTranslate>**Receive Billing Alerts**</DoNotTranslate> para acceder al dashboard de Facturación (Costos).
</Callout>
...
1. Desde la consola de administración de AWS, seleccione <DoNotTranslate>**Services > IAM > Roles**</DoNotTranslate>.

2. Seleccione el rol que ha configurado para New Relic y luego seleccione <DoNotTranslate>**Permissions**</DoNotTranslate>.

3. En la pestaña <DoNotTranslate>**Inline policy**</DoNotTranslate> del rol seleccionado, seleccione expandir <Icon name="fe-chevron-down"/> si ya existe uno, o seleccione la opción para agregar una nueva política en línea al rol.
...
6. Introduzca la siguiente declaración de permiso en <DoNotTranslate>**Policy Document**</DoNotTranslate>:
...
Para encontrar sus datos de integración en la UI de infraestructura, vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS**</DoNotTranslate> y seleccione uno de los enlaces de integración de facturación AWS .
...
<CollapserGroup>
  ...
  >
    ...
    * Gastos previstos
      ...
      <DoNotTranslate>**NRQL example**</DoNotTranslate>: Para obtener una tabla de diferentes presupuestos con gasto real, pronóstico, límites y uso versus costo monetario, ejecute la siguiente consulta NRQL:
      ...
      <Callout variant="tip">
        El `providerAccountId` es el ID de tu cuenta de servicios en la nube en New Relic. Puedes encontrarlo en <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS**</DoNotTranslate>, al lado de <DoNotTranslate>**Provider account**</DoNotTranslate>.
      </Callout>
  </Collapser>
  ...
  >
    ...
    <DoNotTranslate>**NRQL example**</DoNotTranslate>: Para agrupar proveedores por nombres de servicios, ejecute la siguiente consulta NRQL:
  ...
  >
    ...
    <DoNotTranslate>**NRQL example**</DoNotTranslate>: Para agrupar proveedores por nombres de cuentas, ejecute la siguiente consulta NRQL:
  ...
  >
    ...
    <DoNotTranslate>**NRQL example**</DoNotTranslate>: Para comprender la división de costos de los servicios de AWS para un ID de cuenta de AWS en particular, ejecute la siguiente consulta NRQL:
    ...
    <DoNotTranslate>**NRQL example**</DoNotTranslate>: Para comprender la división de costos de las cuentas de AWS para su servicio AWS EC2, ejecute la siguiente consulta NRQL:
