---
title: Amazon Athena monitoreo integración
tags:
  - Integrations
  - Amazon integrations
...
New Relic ofrece una integración para informar sus datos [de Amazon Athena](https://aws.amazon.com/athena/) . Este documento explica cómo activar esta integración y describe los datos que se pueden reportar.
...
Información [de sondeo](/docs/infrastructure/amazon-integrations/aws-integrations-list/aws-polling-intervals-infrastructure-integrations) predeterminada para la integración de Amazon Athena:
...
Esta integración recopila datos de Amazon Athena para WorkGroup.

### Datos del grupo de trabajo Athena
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        La cantidad de datos en Megabytes que Athena escaneó por consulta. Para consultas que fueron canceladas (ya sea por el usuario, o automáticamente, si alcanzó el límite), esto incluye la cantidad de datos escaneados antes del tiempo de cancelación.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        La cantidad de tiempo en segundos que le toma a Athena ejecutar la consulta.
      </td>
    </tr>
  </tbody>
</table>