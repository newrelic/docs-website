...
Datos de fragmentos: para recopilar datos de fragmentos, habilite <DoNotTranslate>**Collect shards data**</DoNotTranslate> en las opciones de configuración de la integración en la UI.
...
Para encontrar sus datos de integración, vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS**</DoNotTranslate> y seleccione uno de los enlaces de integración de Kinesis Data Streams.
