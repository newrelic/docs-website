...
Para permitir que New Relic acceda a los datos de Redshift, su cuenta de AWS debe tener la política <DoNotTranslate>**ReadOnly**</DoNotTranslate> asociada o se deben otorgar los siguientes permisos a su cuenta de New Relic:
...
Para encontrar sus datos de integración, vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS**</DoNotTranslate> y seleccione uno de los enlaces de integración de Redshift.
