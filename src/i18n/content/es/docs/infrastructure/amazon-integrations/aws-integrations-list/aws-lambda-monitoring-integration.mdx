...
<DoNotTranslate>**We also offers a more in-depth Lambda monitoring feature**</DoNotTranslate>. Para obtener más información, consulte [Monitoreo del servidor New Relic para AWS Lambda](/docs/serverless-function-monitoring/aws-lambda-monitoring/get-started/introduction-new-relic-monitoring-aws-lambda).
...
Para encontrar sus datos de integración, vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS**</DoNotTranslate> y seleccione uno de los enlaces de integración de Lambda.
