...
Para encontrar los datos de esta integración, vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS**</DoNotTranslate> y seleccione uno de los enlaces de integración de Amazon ECS/ECR.
