...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Estado de conexión de la sesión de ZooKeeper del corredor, que puede ser uno de los siguientes: NOT_CONNECTED: '0.0', ASSOCIATING: '0.1', CONNECTING: '0.5', CONNECTEDREADONLY: '0.8', CONNECTED: '1.0', CLOSED: '5.0', AUTH_FAILED: '10.0'.
      </td>
    </tr>
  </tbody>
</table>
