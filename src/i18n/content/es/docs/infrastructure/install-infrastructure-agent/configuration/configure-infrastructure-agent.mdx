...
<CollapserGroup>
  ...
  >
    ...
    * <DoNotTranslate>**From inside the config file:**</DoNotTranslate> Agregue una entrada al [archivo de configuración de la infraestructura](https://github.com/newrelic/infrastructure-agent/blob/master/assets/examples/infrastructure/newrelic-infra-template.yml.example) para permitir que el agente obtenga las variables de entorno que ha configurado.
    ...
    * <DoNotTranslate>**From the command line:**</DoNotTranslate> Utilice otra variable de entorno para pasar por esta configuración.
