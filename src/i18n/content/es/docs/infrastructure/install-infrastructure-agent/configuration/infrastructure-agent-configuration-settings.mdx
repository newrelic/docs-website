...
<CollapserGroup>
  ...
  >
    ...
    <Callout variant="important">
      <DoNotTranslate>**Recommendation:**</DoNotTranslate> No cambie esta configuración.
    </Callout>
  ...
  >
    ...
    Si se establece en <DoNotTranslate>**negative value**</DoNotTranslate>, el agente seguirá comprobando la conexión hasta que tenga éxito.
