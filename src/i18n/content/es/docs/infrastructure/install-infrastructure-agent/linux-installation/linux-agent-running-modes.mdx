  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <DoNotTranslate>**Process samples**</DoNotTranslate> No reportes estas métricas:
        ...
        * Recuento de escritura de I/O por segundo
          ...
          Los siguientes <DoNotTranslate>**inventory sources**</DoNotTranslate> no se informan:
...
<CollapserGroup>
  ...
  >
    Para cambiar el modo de ejecución <DoNotTranslate>**from root to privileged or unprivileged**</DoNotTranslate>, siga las instrucciones de instalación/actualización en este documento.
  </Collapser>
  ...
  >
    Para cambiar el modo de ejecución <DoNotTranslate>**from privileged or unprivileged to any other mode:**</DoNotTranslate>
