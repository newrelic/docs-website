...
Después de una configuración exitosa, pueden pasar hasta quince minutos antes de que la métrica comience a aparecer en New Relic. Vea las páginas de infraestructura de su host en <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DoNotTranslate>.
