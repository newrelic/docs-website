...
* Hosts únicos: vea la etiqueta `agentVersion` en cualquier [entidad de host](/docs/new-relic-solutions/new-relic-one/core-concepts/what-entity-new-relic/#find) o busque su `Agent version` en la UI

  <DoNotTranslate>**Infrastructure**</DoNotTranslate>

  .

* Múltiples hosts: vaya a

  <DoNotTranslate>**Infrastructure > Navigator**</DoNotTranslate>

  y agrupe la entidad de informes por `agentVersion` para ver una lista de hosts activos por versión.
...
<CollapserGroup>
  <Collapser
    id="apt-update"
    title={<>Actualizar usando apt (<img src={osDebian} title="Debian icon" alt="Debian.webp" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}>debian,<img src={osUbuntu} title="ubuntu icon" alt="ubuntu icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>ubuntu)</img></>}
  >
  ...
  <Collapser
    id="yum-update"
    title={<>Actualizar usando yum (<img src={osAmazonLinux} title="amazon linux.webp" alt="amazon linux.webp" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}>amazon linux,<img src={osCentos} title="centos icon" alt="centos icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>CentOS,<img src={osRedhat} title="redhat icon" alt="redhat icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>RHEL)</img></>}
  >
  ...
  <Collapser
    id="zypper-update"
    title={<>Actualizar usando Zypper (<img src={osSuse} title="suse icon" alt="suse icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}>SLES)</img></>}
  >
  ...
  <Collapser
    ...
    title={<>Actualización sobre<img src={osWindows} title="Windows Server" alt="Windows Server icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}>Servidor Windows (32 bits)</img></>}
  >
    Para actualizar manualmente el agente de infraestructura en Windows Server:

    1. Descargue la última imagen del instalador .MSI desde [download.newrelic.com/infrastructure_agent/windows/386/newrelic-infra-386.msi](https://download.newrelic.com/infrastructure_agent/windows/386/newrelic-infra-386.msi)
  ...
  <Collapser
    id="windows-update"
    title={<>Actualización sobre<img src={osWindows} title="Windows Server" alt="Windows Server icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}>Servidor Windows (64 bits)</img></>}
  >
    Para actualizar manualmente el agente de infraestructura en Windows Server:

    1. Descargue la última imagen del instalador .MSI desde [download.newrelic.com/infrastructure_agent/windows/newrelic-infra.msi](https://download.newrelic.com/infrastructure_agent/windows/newrelic-infra.msi)
  ...
  <Collapser
    ...
    title="Actualización con herramientas de administración de configuración"
  >
    ...
    * <img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="Ansible" alt="Ansible" src={osAnsibleRed}>[](/docs/infrastructure/new-relic-infrastructure/config-management-tools/configure-new-relic-infrastructure-using-ansible)</img>
      ...
      [Configurar con Ansible](/docs/infrastructure/new-relic-infrastructure/config-management-tools/configure-new-relic-infrastructure-using-ansible)
    ...
    * <img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="Chef" alt="Chef" src={osChef}>[](/docs/infrastructure/new-relic-infrastructure/config-management-tools/configure-new-relic-infrastructure-using-chef)</img>
      ...
      [Configurar con Chef](/docs/infrastructure/new-relic-infrastructure/config-management-tools/configure-new-relic-infrastructure-using-chef)

    * <img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="EBS" alt="EBS" src={osEbs}>[Configurar con AWS Elastic Beanstalk](/docs/infrastructure/install-infrastructure-agent/config-management-tools/install-infrastructure-agent-aws-elastic-beanstalk)</img>
    ...
    * <img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="Puppet" alt="Puppet" src={osPuppet}>[](/docs/infrastructure/new-relic-infrastructure/config-management-tools/configure-new-relic-infrastructure-puppet)</img>
      ...
      [Configurar con Puppet](/docs/infrastructure/new-relic-infrastructure/config-management-tools/configure-new-relic-infrastructure-puppet)
  </Collapser>
</CollapserGroup>
