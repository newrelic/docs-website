...
Este método le proporciona <DoNotTranslate>**full control**</DoNotTranslate> de la instalación. Usted es responsable de colocar los archivos en las carpetas correctas, proporcionar los valores de configuración correctos y garantizar que el agente tenga todos los permisos correctos.
...
<DoNotTranslate>**Optionally**</DoNotTranslate>, puede:
