...
1. Reemplace
   ...
   <DNT>**YOUR_NEW_RELIC_ACCOUNT_ID**</DNT>

   con su ID de cuenta de New Relic.

2. Reemplaza

   <DNT>**YOUR_NEW_RELIC_LICENSE_KEY**</DNT>
