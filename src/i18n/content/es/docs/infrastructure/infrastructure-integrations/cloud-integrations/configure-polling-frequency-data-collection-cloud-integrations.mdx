...
3. Seleccione
   ...
   junto a la integración.

4. Utilice el desplegable junto a

   <DoNotTranslate>**Data polling interval every**</DoNotTranslate>

   para seleccionar con qué frecuencia desea que New Relic capture sus datos de integración en la nube.
...
4. En
   ...
   <DoNotTranslate>**Data collections and filters**</DoNotTranslate>

   , gira los controles que quieras
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        Cambie esto a <DoNotTranslate>**Off**</DoNotTranslate> si no desea que la integración recopile su etiqueta de recurso en la nube y así reducir el volumen de llamadas API.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        La recopilación de inventario ampliada es <DoNotTranslate>**disabled by default**</DoNotTranslate>.

        Cambie esto a <DoNotTranslate>**On**</DoNotTranslate> si desea monitor el inventario extendido. Esto aumentará el volumen de llamadas API.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        De forma predeterminada, no informamos fragmentos métricos. Cambie esto a <DoNotTranslate>**On**</DoNotTranslate> si desea monitor el fragmento métrico además del flujo de datos métrico.
      </td>
    </tr>
    ...
    <tr id="lambda-edge">
      ...
      <td>
        ...
        De forma predeterminada, no informamos datos de Lambda@Edge. Cambie esto a <DoNotTranslate>**On**</DoNotTranslate> si utiliza Lambda@Edge en AWS CloudFront y desea obtener metadatos de la ubicación de ejecución de Lambda.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        De forma predeterminada, no informamos la métrica del nodo de Elasticsearch. Cambie esto a <DoNotTranslate>**On**</DoNotTranslate> si desea monitor el nodo métrico además del clúster métrico.
      </td>
    </tr>

    <tr>
      <td>
        <DoNotTranslate>**Collect NAT Gateway data**</DoNotTranslate> y <DoNotTranslate>**Collect VPN data**</DoNotTranslate>
      </td>

      <td>
        Disponible para la integración de AWS VPC.

        Por defecto, no reportamos NAT Gateway ni VPN métrica. Cámbielos a <DoNotTranslate>**On**</DoNotTranslate> si desea monitor NAT Gateway y VPN métrica e inventario, además de otro inventario de entidades relacionadas con VPC.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        De forma predeterminada, recopilamos metadatos de instancias EC2 que incluyen direcciones IP públicas y privadas, y detalles de la interfaz de red. Cambie esto a <DoNotTranslate>**Off**</DoNotTranslate> si no desea que New Relic almacene y muestre estos datos de IP.
      </td>
    </tr>
  </tbody>
</table>
...
Cuando un filtro es <DoNotTranslate>**On**</DoNotTranslate>, especifica los datos que desea que se recopilen; por ejemplo, si <DoNotTranslate>**Limit to AWS region**</DoNotTranslate> es <DoNotTranslate>**On**</DoNotTranslate>, las regiones que seleccione serán aquellas para las que se recopilarán datos. Hay diferentes filtros disponibles, dependiendo de la integración:
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Ingrese <DoNotTranslate>**one**</DoNotTranslate> clave de etiqueta asociada con los recursos que desea monitor. Los valores de filtro distinguen entre mayúsculas y minúsculas y puede utilizar este filtro en combinación con el filtro <DoNotTranslate>**tag value**</DoNotTranslate> . Aplicable únicamente para AWS y Azure.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Ingrese <DoNotTranslate>**one**</DoNotTranslate> valor de etiqueta asociado con los recursos que desea monitor. Los valores de filtro distinguen entre mayúsculas y minúsculas y puede utilizar este filtro en combinación con <DoNotTranslate>**tag key**</DoNotTranslate>. Aplicable únicamente para AWS y Azure.
      </td>
    </tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Cuando creas [la condición de alerta](/docs/infrastructure/new-relic-infrastructure/infrastructure-alert-conditions) <DoNotTranslate>**after**</DoNotTranslate> estableces filtros, asegúrate de que tus <InlinePopover type="alerts"/>no sean activados por recursos que hayas filtrado.
      </td>
    </tr>
