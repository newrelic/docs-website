...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Cuando creas [la condición de alerta](/docs/infrastructure/new-relic-infrastructure/infrastructure-alert-conditions) <DNT>**after**</DNT> estableces filtros, asegúrate de que tus <InlinePopover type="alerts"/>no sean activados por recursos que hayas filtrado.
      </td>
    </tr>
