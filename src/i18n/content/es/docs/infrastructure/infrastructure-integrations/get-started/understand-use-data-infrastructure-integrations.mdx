...
* Ver panel: puede encontrar su panel en la New Relic UI. Ve a
...
<CollapserGroup id="query-examples">
  ...
  <Collapser
    ...
    title="Ejemplo de consulta de Azure Service Bus"
  >
  ...
  <Collapser
    ...
    title="Ejemplo de consulta de cambio de inventario"
  >
...
<CollapserGroup>
  <Collapser
    id="metric-tips"
    title="Consejos de datos métricos"
  >
    ...
    * Los valores métricos se tratan como <DoNotTranslate>**attributes**</DoNotTranslate>: valores principales pares adjuntos a un [evento](/docs/data-analysis/metrics/analyze-your-metrics/data-collection-metric-timeslice-event-data#event-data). Por ejemplo, la integración de MySQL tiene una métrica de "conexiones activas"; esto se encontraría consultando el atributo `connectionsActive` del evento `MysqlSample` .
  ...
  <Collapser
    id="event-tips"
    title="Consejos sobre datos de eventos"
  >
  ...
  <Collapser
    id="event-tips"
    title="Consejos sobre datos de inventario"
  >
