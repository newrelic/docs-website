...
1. Vaya a <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure**</DNT>. Pase el mouse sobre el gráfico sobre el que desea recibir alertas, seleccione las elipses <Icon name="fe-more-horizontal"/> y luego seleccione <DNT>**Create alert condition**</DNT>.
