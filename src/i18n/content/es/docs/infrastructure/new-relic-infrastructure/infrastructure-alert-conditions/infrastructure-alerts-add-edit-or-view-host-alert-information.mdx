...
<Callout
  ...
  variant="important"
>
  La API REST de infraestructura tiene un límite de 3700 condiciones de alerta, incluidas ambas condiciones activas <DoNotTranslate>**and**</DoNotTranslate> deshabilitadas. La API, ya sea que se use directamente o a través de la UI, rechazará todas las solicitudes para agregar cualquier condición de alerta adicional más allá del límite de 3700 condiciones de alerta.
</Callout>

Para agregar una condición de alerta de infraestructura a una política de alertas:

1. Vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure**</DoNotTranslate>. Pase el mouse sobre el gráfico sobre el que desea recibir alertas, seleccione las elipses <Icon name="fe-more-horizontal"/> y luego seleccione <DoNotTranslate>**Create alert condition**</DoNotTranslate>.

2. Escriba un nombre de condición significativo.

3. Seleccione <DoNotTranslate>**Alert type**</DoNotTranslate> o consulte los [ejemplos](/docs/infrastructure/new-relic-infrastructure/infrastructure-alert-conditions/infrastructure-alerting-examples) para decidir qué tipo seleccionar.
...
5. Defina el [umbral](/docs/alerts/new-relic-alerts/getting-started/alerts-glossary#alert-threshold) <DoNotTranslate>**Critical**</DoNotTranslate> (obligatorio) y <DoNotTranslate>**Warning**</DoNotTranslate> (opcional, si está disponible) para activar la notificación de alerta.

6. Opcional: para crear los criterios de condición de forma proactiva pero no recibir notificación de alerta en este momento, desactive la [opción de casilla de verificación<DoNotTranslate>**Enabled**</DoNotTranslate> ](/docs/infrastructure/new-relic-infrastructure/configuration/infrastructure-alerts-add-edit-or-view-host-alert-information#enabled).
...
9. Opcional: establezca el límite de tiempo [<DoNotTranslate>**Close open incidents after**</DoNotTranslate>](#incident-time-limit) para cerrar automáticamente el incidente abierto después de un cierto período de tiempo (el valor predeterminado es 24 horas para condiciones de infraestructura).

10. Seleccione <DoNotTranslate>**Create**</DoNotTranslate>.
...
<CollapserGroup>
  <Collapser
    className="freq-link"
    id="alerts-ui"
    title="Utilice la UI de alertas"
  >
    Vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Alerts & AI > Alert policies > New alert policy > Create new condition**</DoNotTranslate> y luego seleccione <DoNotTranslate>**Infrastructure**</DoNotTranslate> como producto.
  </Collapser>

  <Collapser
    className="freq-link"
    id="infrastructure-ui"
    title="Utilice la UI de infraestructura"
  >
    1. Vaya a

       <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Hosts**</DoNotTranslate>

       .

    2. Pase el mouse sobre el gráfico sobre el que desea alertar, seleccione las elipses
  ...
  <Collapser
    className="freq-link"
    id="integration"
    title="Utilice la configuración de infraestructura para la integración"
  >
    <Callout variant="tip">
      Utilice este método para crear una condición de alerta para la integración de infraestructura.
    </Callout>

    1. Vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Settings > Alerts**</DoNotTranslate> y luego haga clic en <DoNotTranslate>**Create alert condition**</DoNotTranslate>.

    2. Nombre y describa la condición de alerta.

    3. Haga clic en el tipo de alerta <DoNotTranslate>**Integrations**</DoNotTranslate> y luego seleccione la fuente de datos de integración que desea utilizar.

    4. Utilice el <DoNotTranslate>**Filter entities**</DoNotTranslate> desplegable para limitar su condición a un atributo específico.

    5. Utilice el <DoNotTranslate>**Define thresholds**</DoNotTranslate> desplegable para definir el umbral de su condición y luego haga clic en <DoNotTranslate>**Create**</DoNotTranslate>.
...
3. De la lista
   ...
   , seleccione el incidente de alerta.
...
1. Vaya a
   ...
   <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Settings > Alerts**</DoNotTranslate>

   .

2. Opcional: use la ventana de búsqueda o la casilla de verificación

   <DoNotTranslate>**Select all**</DoNotTranslate>

   para ubicar una o más condiciones de alerta.

3. Seleccione cualquiera de las funciones disponibles para

   <Icon name="fe-edit-2"/>

   editar, deshabilitar, habilitar o

   <Icon name="fe-trash-2"/>

   eliminar las condiciones seleccionadas.
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        * Ver, cambiar, deshabilitar (o volver a habilitar) o eliminar: utilice la [de infraestructura ](#maintain-alerts)
    ...
    <tr>
      ...
      <td>
        * Ver información resumida sobre [el evento](/docs/alerts/new-relic-alerts/getting-started/alerts-glossary#event): Utilice la [de infraestructura ](#view-alerts)
    ...
    <tr>
      ...
      <td>
        ...
        * Para políticas que solo necesitan [notificación por correo electrónico](#notification): vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Settings > Alerts & AI > Create a new policy**</DoNotTranslate> y agregue una o más direcciones de correo electrónico según sea necesario.
...
El uso del campo <DoNotTranslate>**Description**</DoNotTranslate> está disponible para estos tipos de condición de alerta:
...
El texto que coloca en el campo <DoNotTranslate>**Description**</DoNotTranslate> de una condición de alerta se pasa en sentido descendente al incidente y notificación asociados. Una descripción se puede utilizar para varios propósitos, que incluyen:
...
1. Seleccione una condición de alerta y realice cambios en el enlace
