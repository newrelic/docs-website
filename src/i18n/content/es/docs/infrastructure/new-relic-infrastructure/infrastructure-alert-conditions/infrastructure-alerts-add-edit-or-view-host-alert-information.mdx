...
<CollapserGroup>
  ...
  >
    Vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert policies > New alert policy > Create new condition**</DoNotTranslate> y luego seleccione <DoNotTranslate>**Infrastructure**</DoNotTranslate> como producto.
  </Collapser>
