...
Si completó la [integraciónAPM/infraestructura](/docs/infrastructure/new-relic-infrastructure/data-instrumentation/new-relic-apm-data-infrastructure) pero no ve los datos APM en <DoNotTranslate>**infrastructure**</DoNotTranslate>, pruebe estos procedimientos de resolución de problemas.
