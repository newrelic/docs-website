...
Cuando APM y el agente de infraestructura están instalados en los mismos hosts y usan la misma New Relic <InlinePopover type="licenseKey"/>o clave de licencia de cuentas en la misma organización, los datos APM deben aparecer en <DoNotTranslate>**infrastructure**</DoNotTranslate> y viceversa. Si no ve este vínculo APM-infraestructura, siga estos consejos de resolución de problemas.
...
Si completó la [integración APM/infraestructura](/docs/infrastructure/new-relic-infrastructure/data-instrumentation/new-relic-apm-data-infrastructure) pero no ve los datos APM en <DoNotTranslate>**infrastructure**</DoNotTranslate>, pruebe estos procedimientos de resolución de problemas.

<CollapserGroup>
  <Collapser
    id="restart-app-server"
    title="Reinicie el servidor de aplicaciones."
  >
  ...
  <Collapser
    id="hostnames"
    title="Asegúrese de que el nombre del host sea el mismo en APM y en UI de infraestructura."
  >
    ...
    2. Desde la página APM

       <DoNotTranslate>**Overview**</DoNotTranslate>

       de la aplicación, observe el nombre de host asociado de la aplicación. Compare ese nombre con el nombre del mismo host en el monitoreo de infraestructura.
  ...
  <Collapser
    id="gap-fqdn-issue"
    title="Compruebe si hay problemas de reconocimiento del FQDN del host de reemplazo."
  >
  ...
  <Collapser
    id="gap-fqdn-issue"
    title="Asegúrese de que se hayan completado los pasos de integración de Kubernetes."
  >
