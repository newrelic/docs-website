...
<CollapserGroup>
  ...
  >
    * <DoNotTranslate>**Disable a single plugin:**</DoNotTranslate> Para deshabilitar un complemento, establezca el valor de propiedad correspondiente en `-1`.

    * <DoNotTranslate>**Disable all plugins:**</DoNotTranslate> `disable_all_plugins: true`

    * <DoNotTranslate>**Enable selected plugins:**</DoNotTranslate> Para habilitar determinado complemento, inserte una excepción en `disable_all_plugins`. Por ejemplo, la siguiente configuración desactiva todos los complementos, pero el complemento Interfaces de red informa cada 120 segundos:
