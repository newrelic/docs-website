...
<CollapserGroup>
  ...
  >
    ...
    * <DNT>**Enable selected plugins:**</DNT> Para habilitar determinado complemento, inserte una excepción en `disable_all_plugins`. Por ejemplo, la siguiente configuración desactiva todos los complementos, pero el complemento Interfaces de red informa cada 120 segundos:
