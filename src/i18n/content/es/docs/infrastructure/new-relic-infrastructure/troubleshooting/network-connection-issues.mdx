...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="Linux"
  >
    1. <DoNotTranslate>**Resolve the domain:**</DoNotTranslate> Utilice `nslookup` o `dig` para validar que el sistema Linux pueda resolver el dominio en una dirección IP:
    ...
    2. <DoNotTranslate>**Ping the server:**</DoNotTranslate> Intente hacer ping a la dirección IP obtenida anteriormente para asegurarse de que puede comunicarse con el servidor.
    ...
    3. <DoNotTranslate>**Traceroute:**</DoNotTranslate> Utilice `traceroute` para comprobar la ruta de red entre su sistema y el servidor:
    ...
    4. <DoNotTranslate>**Curl:**</DoNotTranslate> Utilice `curl` para comprobar si se puede llegar al extremo:
