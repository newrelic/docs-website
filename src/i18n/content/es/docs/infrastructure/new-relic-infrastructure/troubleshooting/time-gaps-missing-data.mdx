...
1. Elimine el límite de un subproceso para el agente, permitiendo un subproceso por núcleo.
   ...
   <CollapserGroup>
     <Collapser id="apt-install-verify" title="Edite el archivo de configuración newrelic-infra.yml (Windows)">
     ...
     <Collapser id="apt-install-verify" title="Edite el archivo de configuración newrelic-infra.yml (Linux)">
