          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  **Host:** [https://cloud.getdbt.com/api/v2/accounts/ACCOUNT\_ID/](https://cloud.getdbt.com/api/v2/accounts/ACCOUNT_ID/) (Reemplace `ACCOUNT_ID` con el ID de su cuenta de dbt Cloud)
              ...
              <tr>
                ...
                <td>
                  **Host:** [https://insights-collector.newrelic.com/v1/accounts/ACCOUNT\_ID/events](https://insights-collector.newrelic.com/v1/accounts/ACCOUNT_ID/events) (Reemplace `ACCOUNT_ID` con el ID de su cuenta)
              ...
              <tr>
                ...
                <td>
                  **Host:** [https://insights-api.newrelic.com/v1/accounts/ACCOUNT\_ID/query](https://insights-api.newrelic.com/v1/accounts/ACCOUNT_ID/query) (Reemplace `ACCOUNT_ID` con el ID de su cuenta)
