...
La integración de Databricks está diseñada para ser desplegada en el nodo del controlador de un [clúster](https://docs.databricks.com/en/getting-started/concepts.html#cluster) de Databricks de uso general, trabajo o pipeline. Para desplegar la integración de esta manera, siga los pasos para [desplegar la integración en un clúster de Databricks](https://github.com/newrelic/newrelic-databricks-integration/blob/main/docs/installation.md#deploy-the-integration-to-a-databricks-cluster).
