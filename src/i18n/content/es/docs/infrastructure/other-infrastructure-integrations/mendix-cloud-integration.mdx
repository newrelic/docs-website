...
1. Vaya a la página <DNT>**Environment**</DNT> de su aplicación en el <DNT>**Developer Portal**</DNT>.

2. Haga clic en <DNT>**Details**</DNT> en el entorno que desea monitor con New Relic.

3. Cambie a la pestaña <DNT>**Details**</DNT> .
   ...
   <table>
     ...
     <tbody>
       <tr>
         ...
         <td>
           New Relic [clave de licencia](/docs/apis/intro-apis/new-relic-api-keys/).
         </td>
       </tr>
       ...
       <tr>
         ...
         <td>
           URI para la de New Relic log de API. Para obtener más información, consulte [New Relic Regiones](https://docs.mendix.com/developerportal/operate/newrelic-metrics/#uri-regions). Para conocer valores válidos, consulte [Enviar sus datos de logging con nuestra API de log](/docs/logs/log-api/introduction-log-api/) . Ejemplo: `https://log-api.eu.newrelic.com/log/v1`
         </td>
       </tr>
       ...
       <tr>
         ...
         <td>
           URI para la New Relicmétrica de API. Para obtener más información, consulte [New Relic Regiones](https://docs.mendix.com/developerportal/operate/newrelic-metrics/#uri-regions). Para valores válidos, consulte [Informe métrica a través de la APImétrica](/docs/data-apis/ingest-apis/metric-api/report-metrics-metric-api/). Ejemplo: `https://metric-api.eu.newrelic.com/metric/v1`.
         </td>
       </tr>
       ...
       <tr>
         ...
         <td>
           Las direcciones de correo electrónico se redactan automáticamente antes de enviar las entradas log a New Relic. Para deshabilitar esta redacción, establezca `LOGS_REDACTION` en `false`. Predeterminado: `true`.
         </td>
       </tr>
     </tbody>
   </table>

5. Regrese a la página <DNT>**Environments**</DNT> de su aplicación y a <DNT>**Deploy**</DNT> o <DNT>**Transport**</DNT> su aplicación en el entorno seleccionado.
