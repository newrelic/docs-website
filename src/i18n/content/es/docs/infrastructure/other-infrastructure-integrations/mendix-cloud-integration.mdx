   ...
   <table>
     ...
     <tbody>
       ...
       <tr>
         ...
         <td>
           URI para la API de logs de New Relic. Para obtener más información, consulte [regiones New Relic](https://docs.mendix.com/developerportal/operate/newrelic-metrics/#uri-regions). Para conocer valores válidos, consulte [Enviar sus datos de logging con nuestra API de log](/docs/logs/log-api/introduction-log-api/). Ejemplo: `https://log-api.eu.newrelic.com/log/v1` (UE), `https://log-api.jp.nr-data.net/log/v1` (Japón)
         </td>
       </tr>
       ...
       <tr>
         ...
         <td>
           URI para la New Relic métrica de API. Para obtener más información, consulte [regiones New Relic](https://docs.mendix.com/developerportal/operate/newrelic-metrics/#uri-regions). Para valores válidos, consulte [Informe métrica a través de la APImétrica](/docs/data-apis/ingest-apis/metric-api/report-metrics-metric-api/). Ejemplo: `https://metric-api.eu.newrelic.com/metric/v1` (UE), `https://metric-api.jp.nr-data.net/metric/v1` (Japón).
         </td>
       </tr>
