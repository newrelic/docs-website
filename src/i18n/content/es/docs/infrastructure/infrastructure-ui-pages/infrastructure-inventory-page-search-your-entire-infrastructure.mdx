...
<CollapserGroup>
  ...
  >
    Para ver [el incidente umbral de alerta](/docs/alerts/new-relic-alerts/getting-started/alerts-glossary#alert-threshold) de uno o más hosts, seleccione el <DNT>**Critical**</DNT> del host <Icon name="fe-x-circle"/> icono o <DNT>**Warning**</DNT> <Icon name="fe-alert-triangle"/> icono.
  </Collapser>
</CollapserGroup>
...
<CollapserGroup>
  ...
  >
    ...
    * Entornos de prueba
    ...
    9. En la barra lateral, haga clic en
    ...
    10. Localice el filtro establecido desplazándose o ingresando un término de búsqueda.

    11. Haga clic en el conjunto de filtros para abrirlo.

    12. En la barra lateral, haga clic en una opción para actualizar su conjunto de filtros y luego guárdela.
