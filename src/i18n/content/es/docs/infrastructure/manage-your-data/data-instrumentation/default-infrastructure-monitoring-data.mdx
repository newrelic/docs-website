...
El agente de monitoreo de infraestructura de New Relic recopila y muestra datos utilizando seis [eventos](/docs/using-new-relic/data/understand-data/new-relic-data-types#event-data) primarios, cada uno con [atributos](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#attribute) asociados que representan una variedad de métricas y metadatos.
...
Si está utilizando integración, consulte el documento de integración para obtener más información sobre los datos reportados. Para conocer el atributo común AWS , consulte [DatosAWS ](#shared-attributes).
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        `StorageSample` Representa un único dispositivo de almacenamiento asociado con un servidor. Cada muestra recopila información descriptiva sobre el dispositivo, el tipo de sistema de archivos que utiliza y su uso y capacidad actuales. Tomamos una instantánea de estos datos cada 20 segundos para cada sistema de archivos montado y la empaquetamos en un evento `StorageSample` , que luego se envía a New Relic. Estos datos aparecen en la [página UI <DoNotTranslate>**Storage**</DoNotTranslate> ](/docs/infrastructure/infrastructure-ui-pages/infra-hosts-ui-page#storage).
        ...
        <CollapserGroup>
          <Collapser
            id="linux-supported"
            title="Sistemas de almacenamiento Linux compatibles"
          >
          ...
          <Collapser
            ...
            title="Sistemas de almacenamiento de Windows compatibles"
          >
    ...
    <tr>
      ...
      <td>
        `InfrastructureEvent` describe los cambios (deltas) que ocurren en el estado activo de un sistema. Cuando se agrega, elimina o cambia un inventario o estado del sistema, generaremos un `InfrastructureEvent` que registrará esa actividad. Estos datos aparecen en la [página UI <DoNotTranslate>**Events**</DoNotTranslate> ](/docs/infrastructure/new-relic-infrastructure/infrastructure-ui-pages/infrastructure-events-page-live-feed-every-config-change).
      </td>
    </tr>
  </tbody>
</table>
...
Si una integración AWS está habilitada, su evento de infraestructura también puede tener [un atributoAWS ](#shared-attributes)adjunto.
...
<CollapserGroup>
  ...
  <Collapser
    id="ec2-general"
    title="Otro atributo Amazon EC2"
  >
