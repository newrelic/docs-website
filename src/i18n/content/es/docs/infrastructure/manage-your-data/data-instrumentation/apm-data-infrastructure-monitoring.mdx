...
<Steps>
  <Step>
    ...
    * Ambos agentes deben usar el mismo

      <InlinePopover type="licenseKey"/>

      o usar clave de licencia de cuentas de la misma organización.

      * Un usuario que vea la página APM

        <DoNotTranslate>**Summary**</DoNotTranslate>

        debe tener acceso a ambas cuentas si se utilizan claves de licencia separadas para APM y agente de infraestructura.
  ...
  <Step>
    ...
    * Lo primero que hará es ir a la aplicación `Billing Service` en APM y abrir la página

      <DoNotTranslate>**Summary**</DoNotTranslate>

      para obtener una descripción general del estado de su sistema. Una puntuación alta de Apdex, que es una medida de satisfacción del usuario, puede indicar que hay un problema en su sistema. Aquí puedes ver que la puntuación es .79. y ha desencadenado un incidente crítico.
  ...
  <Step>
    ...
    Desplácese hacia abajo hasta la sección <DoNotTranslate>**Infrastructure**</DoNotTranslate> de la página de resumen de APM. Aquí verá una tabla que enumera cada host conectado a la aplicación `Billing Service` y un registro de sus <DoNotTranslate>**Response time**</DoNotTranslate>, <DoNotTranslate>**Throughput**</DoNotTranslate>, <DoNotTranslate>**Error rate**</DoNotTranslate>, <DoNotTranslate>**CPU%**</DoNotTranslate>. y <DoNotTranslate>**Memory %**</DoNotTranslate>. Debajo del gráfico hay histogramas que resaltan dos de estas señales doradas. Las selecciones predeterminadas son <DoNotTranslate>**CPU %**</DoNotTranslate> y <DoNotTranslate>**Memory %**</DoNotTranslate> , pero también puede hacer clic en el menú desplegable en la parte superior izquierda y seleccionar una vista diferente.
  ...
  <Step>
    ...
    Ahora que sabe que una implementación reciente en su aplicación `Billing Service` provocó un aumento en los errores y un incidente crítico con Apdex, es posible que desee buscar un host específico para mayor claridad. Haga clic en el nombre del host que desea inspeccionar. Mostrará una barra lateral que importa toda la información relevante de la página <DoNotTranslate>**Infrastructure**</DoNotTranslate> . Esto te permite acceder a toda la información que necesitas sobre tu hosting y cualquier error de servicio sin dejar el resto de tus datos.
