...
Utilice nuestra <DNT>**Logs**</DNT> UI en <DNT>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DNT> para buscar rápidamente entre sus datos log en segundos. Cada log enumera los atributos disponibles en la columna `log_summary`. Para profundizar en detalles adicionales, haga clic en cualquier atributo resaltado.
...
Con <DNT>**Logs**</DNT>, puede buscar en sus datos log ingresando palabras clave simples, como `new` y `relic`, o frases como `"new relic agent"`, directamente en el campo de búsqueda.
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <DNT>**Exception:**</DNT> Las búsquedas con comodines no distinguen entre mayúsculas y minúsculas para los valores de atributos.
      </td>
    </tr>
...
Para cambiar de una consulta de sintaxis de Lucene a una consulta NRQL, a la derecha del generador de consultas, haga clic [en el botón <DNT>**NRQL**</DNT> ](/docs/logs/ui-data/use-logs-ui#workflow-search).
