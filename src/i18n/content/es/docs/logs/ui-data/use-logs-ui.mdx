...
* [Programe búsquedas NRQL automatizadas](#workflow-search) para recibir resultados de consultas periódicas por email.
...
<CollapserGroup>
  <Collapser id="workflow-path" title="1. Vaya a la UI de registro.">
    ...
    Si utiliza nuestro [centro de datos de la región de la UE](/docs/using-new-relic/welcome-new-relic/get-started/our-eu-us-region-data-centers/), vaya a <DNT>**[one.eu.newrelic.com](https://one.eu.newrelic.com) &gt; Logs**</DNT>. Si utiliza el centro de datos de la región de JP, vaya a <DNT>**[one.jp.newrelic.com](https://one.jp.newrelic.com) &gt; Logs**</DNT>.
  ...
  <Collapser id="workflow-search" title="5. consulta y búsqueda.">
    ...
    * En la tabla de registro, haga clic en el icono <DNT>**+**</DNT> para agregar un atributo y luego haga clic en él para agregarlo a la consulta.
      ...
      **Programa una búsqueda**
      ...
      Luego de redactar y ejecutar una consulta en la UI de logs, puede programarla para que se ejecute automáticamente y recibir los resultados por email:

      1. Desde la página <DNT>**All logs**</DNT>, redacte y ejecute su consulta.

      2. Para programar la búsqueda, emplee cualquiera de estas opciones:

         * En la esquina superior derecha, haga clic <Icon name="fe-more-horizontal" /> y seleccione <DNT>**Schedule search**</DNT>.
         * Debajo del gráfico de tendencias de la consulta, haga clic en el icono del reloj.

      3. Configure su [búsqueda NRQL programada](/docs/nrql/using-nrql/schedule-nrql-searches) con ajustes de notificación, programación y formato de salida.

      Para ver y gestionar todas sus búsquedas programadas, vaya a <DNT>**[one.newrelic.com](https://one.newrelic.com) &gt; Administration &gt; Scheduled searches**</DNT>. Obtenga más información sobre [cómo gestionar las búsquedas programadas](/docs/nrql/using-nrql/schedule-nrql-searches/#manage).
  </Collapser>

  <Collapser id="query-builder" title="6. Análisis avanzado de logs con el generador de consultas NRDB.">
  ...
  <Collapser id="workflow-related" title="7. Obtener logs relacionados.">
    ...
    * <DNT>**Controlling data access:**</DNT> Para restringir qué usuario puede acceder a particiones de log específicas, emplee [el control de acceso a datos](/docs/accounts/accounts-billing/new-relic-one-user-management/data-access-control) para crear políticas para grupos de usuarios.
  ...
  <Collapser id="traces-in-context-overview" title="8. Sumérgete en rastreo distribuido.">
  ...
  <Collapser id="share" title="9. Comparte tus hallazgos.">
...
<CollapserGroup>
  <Collapser id="alert" title="Cree una alerta a partir de datos log .">
    ...
    3. Haga clic en el botón de puntos suspensivos junto al botón <DNT>**Query in Lucene**</DNT>.

    4. Seleccione <DNT>**Create alert**</DNT>.

    5. Complete el procedimiento.

    6. Revise la consulta NRQL que activará la condición de alerta.
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        * Centro de datos de la región de JP [(si está disponible)](/docs/using-new-relic/welcome-new-relic/get-started/our-eu-us-region-data-centers/): ve a <DNT>**[one.jp.newrelic.com/](https://one.jp.newrelic.com) &gt; Logs**</DNT>.
      </td>
    </tr>
