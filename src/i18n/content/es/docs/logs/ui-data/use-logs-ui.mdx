...
<CollapserGroup>
  ...
  >
    ...
    * <DoNotTranslate>**Getting more context:**</DoNotTranslate>
      ...
      Para ver el registro relacionado con otros telemetry data para sus aplicaciones y hosts, use [iniciar sesión en contexto](/docs/logs/logs-context/logs-in-context).
  </Collapser>
...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="Solucionar un error (iniciar sesión en contexto)."
  >
    Para comprender mejor lo que estaba sucediendo en el host en el momento en que ocurrió un error en su aplicación, debe poder ver [el inicio de sesión en contexto](/docs/logs/logs-context/configure-logs-context-apm-agents/). Luego, para solucionar errores relacionados:
  ...
  <Collapser
    ...
    title="Solucionar problemas de latencia (iniciar sesión en contexto)"
  >
    Para solucionar problemas de latencia de esta manera, debe poder ver [el contexto de inicio de sesión](/docs/logs/logs-context/configure-logs-context-apm-agents/). Luego, para comprender mejor cómo funcionaban sus sistemas cuando el rendimiento disminuyó notablemente:
...
Dependiendo de su suscripción a New Relic, puede acceder a su registro desde varios lugares en la UI de New Relic. Para algunas de estas opciones, debes poder ver [el inicio de sesión en contexto](/docs/logs/logs-context/configure-logs-context-apm-agents/).

<Callout variant="tip">
  Permita que el <InlinePopover type="apm"/>agente de su aplicación reenvíe los datos log directamente a New Relic con [el registro de APM en contexto](/docs/apm/new-relic-apm/getting-started/get-started-logs-context). ¡No es necesario instalar ni mantener software adicional de terceros!
</Callout>
