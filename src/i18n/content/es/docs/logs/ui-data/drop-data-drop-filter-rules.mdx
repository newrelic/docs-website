...
Para crear una nueva regla de filtro de caída, puede utilizar [una consultalog ](/docs/logs/new-relic-logs/ui-data/query-syntax-logs)nueva o existente. Hay dos formas diferentes de crear un filtro de caída:
...
6. Seleccione las particiones en las que se encuentra el registro.
...
2. Desde **Manage data** en el panel de navegación izquierdo de la UI de registro, haga clic en **Drop filters**.
...
5. Seleccione las particiones en las que se encuentra el registro.
