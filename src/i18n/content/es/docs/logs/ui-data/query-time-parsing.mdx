...
<Steps>
  <Step>
    ...
    1. En la tabla log o en la vista de **Log details**, resalte una cadena de anclaje que contenga los valores que desea extraer. En este caso, resaltaría `level=info msg="Running script"`. Se ve así en la tabla de logs:<img
  ...
  <Step>
    ...
    3. Si necesita cambiar el nombre de alguna variable antes de crear su regla, haga clic en el nombre, proporcione un nombre nuevo y luego haga clic en **Save**. También puede eliminar variables haciendo clic en la variable que desea eliminar y haciendo clic en **Delete**.<img
