...
<Steps>
  <Step>
    ...
    1. En la tabla log o en la vista de **Log details**, resalte una cadena de anclaje que contenga los valores que desea extraer. En este caso, resaltaría `level=info msg="Running script"`. Se ve así en la tabla de logs:<img title="Screenshot showing a highlighted section of a log" alt="Screenshot showing a highlighted section of a log" src={logsExampleLogRecordtoHighlight}/>
