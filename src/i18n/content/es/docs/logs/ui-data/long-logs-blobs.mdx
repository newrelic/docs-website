...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Logs**</DoNotTranslate>: Para consultar datos de blobs extendidos en su registro, asegúrese de incluir comillas invertidas en la sintaxis de blobs de su atributo.
</figcaption>
