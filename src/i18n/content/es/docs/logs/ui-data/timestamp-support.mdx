...
<CollapserGroup>
  ...
  >
    Una timestamp <DoNotTranslate>**epoch**</DoNotTranslate> de Unix se basa en la cantidad de segundos (o milisegundos) que han transcurrido desde las 00:00:00 UTC del 1 de enero de 1970. Dos formatos de ejemplo para `Fri, 03 Nov 2023 16:06:32 GMT` serían:
...
<CollapserGroup>
  ...
  >
    Si recibimos un log JSON como este con `timestamp` en formato <DoNotTranslate>**epoch**</DoNotTranslate> (sin precisión de ms):
  ...
  >
    Si recibimos un log JSON como este con timestamp en formato <DoNotTranslate>**ISO8601**</DoNotTranslate> como este:
...
<CollapserGroup>
  ...
  >
    ...
    A este mensaje de registro con timestamp en formato <DoNotTranslate>**ISO8601**</DoNotTranslate>:
  ...
  >
    ...
    Al siguiente mensaje de log con timestamp en formato <DoNotTranslate>**epoch**</DoNotTranslate>:
