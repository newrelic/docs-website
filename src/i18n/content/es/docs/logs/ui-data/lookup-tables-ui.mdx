...
Nuestra característica <DoNotTranslate>**lookups**</DoNotTranslate> le permite enriquecer sus datos log y otros datos almacenados New Reliccon datos sobre su negocio que usted define en un archivo CSV.
...
### Usando la UIde la tabla de búsquedas [#lookup-ui]
...
La UI para cargar la tabla de búsquedas se encuentra en la UI usuario de registro, pero puede usar los datos de su tabla de búsquedas al consultar cualquier tipo de datos, no solo el registro.

Para encontrar la tabla de búsquedas UI: Desde [one.newrelic.com](https://one.newrelic.com), haga clic en <DoNotTranslate>**Logs**</DoNotTranslate> y luego haga clic en <DoNotTranslate>**Lookup tables**</DoNotTranslate>. Desde allí, puede cargar, descargar, actualizar y eliminar tablas.
