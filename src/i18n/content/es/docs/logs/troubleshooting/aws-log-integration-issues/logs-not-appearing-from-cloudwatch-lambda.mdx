...
* Es posible que la región de New Relic y la clave de licencia de ingesta proporcionada a la función Lambda o Firehose no coincidan. Verificarlo y compararlo.
  ...
  Por ejemplo, si la región de New Relic es la UE, proporcione una clave de licencia de ingesta de New Relic de la región de la UE. De manera similar, si la región de New Relic es JP, proporcione una clave de licencia de ingesta de New Relic de la región de JP.
