  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        Si no aparecen datos en el generador de consultas, entonces no aparecerán datos en la UI <DoNotTranslate>**Logs**</DoNotTranslate>. Para obtener más información, consulte [nuestros documentos sobre opciones de consulta de datos](/docs/query-your-data/explore-query-data/get-started/introduction-querying-new-relic-data).
      </td>
    </tr>
  </tbody>
</table>