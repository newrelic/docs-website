...
4. Configurar logs en el contexto para Ruby.
   ...
   <CollapserGroup>
     <Collapser id="enable-rails" title="Configuración estándar Ruby on Rails">
     ...
     <Collapser id="incompabilities" title="Gemas incompatibles">
     ...
     <Collapser id="rails-adv-config" title="Configuración avanzada de Rails">
     ...
     <Collapser id="enable-non-rails" title="Configuración Ruby sin Rails">
     ...
     <Collapser id="lograge-adv-config" title="Configuración de registro">
     ...
     <Collapser id="adv-ruby-config" title="Otras extensiones de registro">
