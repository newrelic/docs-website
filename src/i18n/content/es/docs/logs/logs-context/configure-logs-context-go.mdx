...
<CollapserGroup>
  <Collapser id="1-automatic" title="Decorar y reenviar registros con APM">
  ...
  <Collapser id="2-manual" title="Decorar el registro con APM y reenviar el registro manualmente">
