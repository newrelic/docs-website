...
## Registro de biblioteca y atributo [#supported-libraries]

La siguiente tabla proporciona información sobre todas las bibliotecas y atributos definidos por el usuario admitidos.
...
<table>
  <thead>
    <tr>
      ...
      <th>
        ¿Se admite el atributo definido por el usuario?
      </th>
    </tr>
  </thead>
...
<CollapserGroup>
  <Collapser id="1-automatic" title="Opción 1: Decorar y reenviar registros con APM">
    ...
    Al emplear esta opción, sus registros incluirán `span.id`, `trace.id`, `hostname`, `entity.guid` y `entity.name`. Estos atributos vinculan sus registros a tramos, trazas y otra telemetría, lo que facilita la resolución de problemas. [Obtenga información sobre las limitaciones del reenvío de registros.](/docs/logs/logs-context/get-started-logs-context#forwarding-details)
  ...
  <Collapser id="2-manual" title="Opción 2: Decorar registros con APM y reenviar registros manualmente">
...
<CollapserGroup>
  <Collapser id="1-standard-library-log" title="Log de biblioteca estándar">
  ...
  <Collapser id="2-zerolog" title="Zerolog">
  ...
  <Collapser id="3-logrus" title="Logro">
  ...
  <Collapser id="4-zap" title="Borrar">
  ...
  <Collapser id="5-slog" title="Sudar tinta">
