...
<CollapserGroup>
  <Collapser id="1-agent" title="Opción 1 (recomendada): Deje que el agente reenvíe su registro.">
  ...
  <Collapser id="2-decorate" title="Opción 2: Utilice su propio reenviador de logs.">
...
<CollapserGroup>
  <Collapser id="java-dropwizard" title="Asistente para caídas 1.3 o superior">
  ...
  <Collapser id="java-adding-classpath" title="adiciones de ruta de clase java.util.logging">
  ...
  <Collapser id="java-logback" title="Versión de inicio de sesión 1.2.0 o superior">
    <Callout variant="tip">
      Aproveche nuestra solución [logs en el contexto automático](#automatic) para Java. ¡No es necesario utilizar este proceso manual!
    </Callout>
  ...
  <Collapser id="spring" title="Primavera y Springboot">
