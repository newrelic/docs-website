...
<CollapserGroup>
  ...
  >
    ...
    6. Asegúrese de que `NewRelicAsyncAppender` sea el complemento <DNT>**first**</DNT> utilizado en su logger. Reemplace los apéndices de su loggerraíz con el apéndice `ASYNC` creado en el paso anterior. Luego, enumere los demás apéndices <DNT>**after**</DNT> o `NewRelicAsyncAppender` en la lista `<root>` .
