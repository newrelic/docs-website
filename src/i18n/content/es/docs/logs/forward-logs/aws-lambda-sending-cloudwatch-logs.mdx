...
4. Abra los detalles `newrelic-log-ingestion` y haga clic en
...
5. En el menú
   ...
   de la función, vaya a

   <DoNotTranslate>**Environment Variables**</DoNotTranslate>

   y configure el reenvío de registros utilizando las siguientes variables de entorno:
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Un valor booleano para determinar si desea generar mensajes de depuración en la consola de CloudWatch. <DoNotTranslate>**Optional.**</DoNotTranslate>
    ...
    <tr>
      ...
      <td>
        <InlinePopover type="licenseKey"/>se utiliza para enviar datos a New Relic. <DoNotTranslate>**Required.**</DoNotTranslate>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Determina si los registros se reenvían a New Relic. <DoNotTranslate>**Required.**</DoNotTranslate> Para activar el registro, configúrelo en `true`.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Especifique la etiqueta que se agregará a todos los registros de eventos. <DoNotTranslate>**Optional.**</DoNotTranslate>
    ...
    <tr>
      ...
      <td>
        Si ha configurado su grupo log de Lambda para utilizar una ruta diferente a `/aws/lambda`, puede especificarla con esta variable. <DoNotTranslate>**Optional.**</DoNotTranslate>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Si ha configurado su grupo log de VPC para utilizar una ruta diferente a `/aws/vpc/flow-log`, puede especificarla con esta variable. <DoNotTranslate>**Optional.**</DoNotTranslate>
      </td>
    </tr>
  </tbody>
</table>

6. Reconozca que la aplicación crea funciones de IAM personalizadas y luego haga clic en
...
2. Desplácese hacia abajo y haga clic en la pestaña `Configuration` .

3. En el menú de la izquierda dentro de la pestaña `Configuration` , haga clic en `Environment Variables`.
...
4. Aquí puede ver una lista de las variables de entorno ya existentes; simplemente haga clic en
   ...
   en la parte superior derecha de la tabla `Environment Variables` .

5. Actualice el `NR_LOGGING_ENDPOINT` con el extremo apropiado:

   * Para _nosotros_: `https://log-api.newrelic.com/log/v1`
   * Para _la UE_: `https://log-api.eu.newrelic.com/log/v1`
...
Puede configurar la cantidad de reintentos que desea realizar en caso de que la función no pueda enviar los datos en caso de problemas de comunicación. El número recomendado es 3 reintentos, pero puedes cambiar el comportamiento de reintento cambiando el siguiente parámetro:
