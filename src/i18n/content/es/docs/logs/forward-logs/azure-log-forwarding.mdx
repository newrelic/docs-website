...
<CollapserGroup>
  ...
  >
    ...
    3. En <DNT>**Allow Blob public access**</DNT>, seleccione <DNT>**Disabled**</DNT>.<img title="Disabling public access to the blobs/containers in the Storage account" alt="Disabling public access to the blobs/containers in the Storage account" src={disablePublicBlobAccessStorageAccount}/>
  ...
  >
    ...
    4. En <DNT>**Platform settings**</DNT>, para <DNT>**FTP state**</DNT>, seleccione <DNT>**Disabled**</DNT>.<img title="Disabling FTP access to the Function App" alt="Disabling FTP access to the Function App" src={disableFtpAccessStorageAccount}/>
  ...
  >
    ...
    2. En el menú de la izquierda, vaya a <DNT>**Settings > Configuration**</DNT>.
    3. Seleccione la pestaña <DNT>**General settings**</DNT> .
    4. En <DNT>**Platform settings**</DNT>, para <DNT>**HTTPS Only**</DNT>, seleccione <DNT>**On**</DNT>.<img title="Enforcing HTTPS to the Function App" alt="Enforcing HTTPS to the Function App" src={enforceHttpsFunctionApp}/>
    5. Haga clic en <DNT>**Save**</DNT>.
  </Collapser>
  ...
  >
    ...
    3. Dentro del cuadro <DNT>**Inbound Traffic**</DNT> , haga clic en <DNT>**Access restriction**</DNT>.<img title="Disabling public network access to the Function App" alt="Disabling public network access to the Function App" src={disablePublicNetworkAccessFunctionApp}/>
