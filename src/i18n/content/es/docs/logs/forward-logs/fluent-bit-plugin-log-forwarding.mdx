...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <DoNotTranslate>**Deprecated.**</DoNotTranslate> Se necesita una [clave de inserción de información valiosa](/docs/insights/insights-data-sources/custom-data/send-custom-events-event-api#register) de New Relic, pero se prefiere usar el atributo `licenseKey` . Utilice `licenseKey` o `apiKey`, no ambos.
      </td>
    </tr>
