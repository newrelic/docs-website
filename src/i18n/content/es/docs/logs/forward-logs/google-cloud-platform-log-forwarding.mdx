...
<CollapserGroup>
  <Collapser id="ingest-url" title="1. Genere una URL de ingesta de GCP Pub/Sub.">
  ...
  <Collapser id="create-gcp-topic" title="2. Cree un tema de publicación/subscripción de GCP.">
    ...
    2. Haga clic en <DNT>**Create Topic**</DNT>.
    3. Ingrese un <DNT>**Topic ID**</DNT> significativo y luego configure otras opciones según sea necesario.
    4. Haga clic en <DNT>**Create Topic**</DNT>.
  </Collapser>

  <Collapser id="configure-gcp-log-forwarding" title="3. Prepare el tema de publicación/subscripción de GCP para reenviar el registro a New Relic.">
  ...
  <Collapser id="forward-logs" title="4. Cree un receptor de enrutamiento para reenviar el registro a New Relic.">
    ...
    2. Haga clic en <DNT>**Create Sink**</DNT>.
    3. Introduzca un <DNT>**Sink name**</DNT> y <DNT>**Sink description**</DNT>, luego haga clic en <DNT>**Next**</DNT>.
    4. En <DNT>**Select sink service**</DNT>, seleccione <DNT>**Cloud Pub/Sub topic**</DNT> y seleccione el [tema de Pub/Sub](#create-gcp-topic) que creó anteriormente.
    5. Configure los filtros restantes según sea necesario y luego haga clic en <DNT>**Create sink**</DNT> para completar la configuración.
  </Collapser>
</CollapserGroup>
...
<CollapserGroup>
  <Collapser id="dataflow-login-gcp" title="1. log en su cuenta Google Cloud Platform .">
  ...
  <Collapser id="dataflow-repo" title="2. Clonar el repositorio GitHub de DataflowTemplates.">
  ...
  <Collapser id="dataflow-configuration" title="3. Compile y ejecute el reenviador de flujo de datos.">
  ...
  <Collapser id="dataflow-bucket" title="4. Cree un depósito de GCP para la plantilla de flujo de datos.">
  ...
  <Collapser id="dataflow-account" title="5. Cree una cuenta de servicio.">
  ...
  <Collapser id="dataflow-compile" title="6. Compile y publique la plantilla PubsubToNewRelic.">
  ...
  <Collapser id="dataflow-job" title="7. Ejecute la plantilla como un trabajo de Dataflow.">
    ...
    * La New Relic <InlinePopover type="licenseKey" />usada para enviar tu registro

    De forma predeterminada, este comando envía los logs al centro de datos de EE. UU. Para cuentas de la UE o de Japón, consulte la sección a continuación.

    <CollapserGroup>
      <Collapser id="eu-customers-gcp-dataflow" title="Cuentas de la región de Europa y Japón">
        Las cuentas de Europa y Japón también deben agregar el parámetro `logsApiUrl` con el extremo adecuado.
  ...
  <Collapser id="dataflow-config" title="8. Opcional: ajuste su trabajo de reenviador de registros de Dataflow.">
