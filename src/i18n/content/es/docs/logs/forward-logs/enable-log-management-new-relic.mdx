...
4. Dependiendo de dónde se almacenen los datos de su cuenta en New Relic, use el nombre de DNS `log-api.newrelic.com` (EE. UU., predeterminado), `log-api.eu.newrelic.com` (UE) o `log-api.jp.nr-data.net` (Japón) para la configuración.
