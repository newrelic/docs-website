  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * Utilice nuestro [contexto de inicio de sesión de APM](/docs/apm/new-relic-apm/getting-started/get-started-logs-context)
    ...
    <tr>
      ...
      <td>
        Utilice nuestro agente <InlinePopover type="apm"/>y agente de monitoreo de infraestructura. Permita que el agente APM de su aplicación reenvíe los datos log directamente a New Relic con [el registro de APM en contexto](/docs/apm/new-relic-apm/getting-started/get-started-logs-context). ¡No es necesario instalar ni mantener software adicional de terceros!
      </td>
    </tr>
...
6. Si corresponde, configure el agente
   ...
   de su aplicación siguiendo los procedimientos [de registro manual en contexto](/docs/logs/enable-log-management-new-relic/configure-logs-context/configure-logs-context-apm-agents/) .
...
* Vea su registro en el contexto del rendimiento de su aplicación en la [UIde APM](/docs/logs/ui-data/use-logs-ui/#links). Solucionar [errores](/docs/apm/apm-ui-pages/error-analytics/errors-page-find-fix-verify-problems/) con [rastreo distribuido](/docs/apm/distributed-tracing/ui-data/understand-use-distributed-tracing-data), rastreo del stack, registro de aplicación y más.
