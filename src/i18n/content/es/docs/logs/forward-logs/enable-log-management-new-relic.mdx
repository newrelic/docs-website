  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * Utilice protocolos syslog para reenviar sus logs a través de un [extremo TCP](/docs/logs/log-api/use-tcp-endpoint-forward-logs-new-relic).
...
3. Instale un [reenviador de logs compatible](#log-forwarding).
...
En algunas situaciones es posible que no tenga reenviador de logs; por ejemplo, con CDN, dispositivos de hardware o servicios gestionados. Puede utilizar protocolos syslog como `rsyslog` y `syslog-ng` y reenviar sus logs a New Relic a través de un [extremo TCP](/docs/logs/log-management/log-api/use-tcp-endpoint-forward-logs-new-relic/).
