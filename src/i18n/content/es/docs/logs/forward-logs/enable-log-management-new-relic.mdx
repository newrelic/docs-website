...
4. Dependiendo de dónde se almacenen los datos de su cuenta en New Relic, utilice el nombre DNS `log-api.newrelic.com` (EE. UU.), `log-api.eu.newrelic.com` (UE) o `log-api.jp.nr-data.net` (Japón) para la configuración.
