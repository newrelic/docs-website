...
2. Siga los procedimientos para [crear un flujo de entrega de Amazon Kinesis Data Firehose](https://docs.aws.amazon.com/firehose/latest/dev/basic-create.html) y seleccione New Relic como destino: en la Consola de administración de AWS, vaya a <DoNotTranslate>**Amazon Kinesis**</DoNotTranslate>.
3. Seleccione <DoNotTranslate>**Kinesis Data Firehose**</DoNotTranslate> y haga clic en <DoNotTranslate>**Create delivery stream**</DoNotTranslate>.
4. Ingrese un nombre para la transmisión y seleccione su fuente de datos.
5. Al seleccionar el destino, haga clic en <DoNotTranslate>**Third-party partner**</DoNotTranslate> y luego <DoNotTranslate>**New Relic.**</DoNotTranslate>
6. En <DoNotTranslate>**HTTP endpoint URL**</DoNotTranslate>, seleccione <DoNotTranslate>**New Relic logs - US**</DoNotTranslate>. Este es el extremo de EE. UU. ([https://aws-api.newrelic.com/firehose/v1](https://aws-api.newrelic.com/firehose/v1)). Para utilizar el extremo UE, complete los pasos restantes de este procedimiento y luego vaya a [la configuración de la cuenta UE](#configure-eu-stream).
7. Pega tu <InlinePopover type="licenseKey"/>en el campo <DoNotTranslate>**API key**</DoNotTranslate> .
8. Asegúrese de que <DoNotTranslate>**Content encoding**</DoNotTranslate> esté configurado en `GZIP`.
9. Establezca un <DoNotTranslate>**buffer size**</DoNotTranslate> de `1 MiB` en `Buffer hints/Buffer size`. (Tenga en cuenta que la sección `Buffer hints` está plegada de forma predeterminada. Para obtener más información, consulte la [sección de configuración del búfer](#buffer-settings).
...
2. Una vez que se haya creado su transmisión, navegue hasta [Amazon Kinesis Console](https://console.aws.amazon.com/kinesis/) y haga clic en <DoNotTranslate>**Delivery streams**</DoNotTranslate>.

3. Haga clic en el nombre de su flujo de entrega recién creado y seleccione la pestaña <DoNotTranslate>**Configuration**</DoNotTranslate> .

4. Junto a la sección <DoNotTranslate>**Destination settings**</DoNotTranslate> , haga clic en <DoNotTranslate>**Edit**</DoNotTranslate>.

5. Actualice el valor de <DoNotTranslate>**HTTP endpoint URL**</DoNotTranslate> a nuestro extremo Firehose para cuentas de la UE:

   ```
   https://aws-api.eu.newrelic.com/firehose/v1
   ```

6. Haga clic en <DoNotTranslate>**Save changes**</DoNotTranslate> para asegurarse de que su transmisión esté actualizada.
