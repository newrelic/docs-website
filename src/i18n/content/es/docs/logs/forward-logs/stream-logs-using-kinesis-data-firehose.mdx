...
6. En <DNT>**HTTP endpoint URL**</DNT>, seleccione <DNT>**New Relic logs - US**</DNT>. Este es el extremo de EE. UU. (predeterminado) ([https://aws-api.newrelic.com/firehose/v1](https://aws-api.newrelic.com/firehose/v1)). Para usar el extremo de la UE, complete los pasos restantes en este procedimiento, luego vaya a [configuración de la cuenta de la UE](#configure-eu-stream).
...
## Configure su flujo para enviar logs a cuentas de la UE o JP [#configure-eu-stream]

Si tiene una cuenta de New Relic en nuestro centro de datos de la UE o JP:
...
5. Actualice el valor de <DNT>**HTTP endpoint URL**</DNT> al extremo de Firehose adecuado para su región:

   * Para las cuentas de la UE:
     ```
     https://aws-api.eu.newrelic.com/firehose/v1
     ```
   * Para las cuentas de JP:
     ```
