  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * Extremo US (predeterminado): `https://log-api.newrelic.com/log/v1`
        * Extremo UE: `https://log-api.eu.newrelic.com/log/v1`
        * Extremo de Japón: `https://log-api.jp.nr-data.net/log/v1`
      </td>
    </tr>
...
3. Ejecute el siguiente comando para agregar un mensaje de log de prueba a su archivo de log:

   ```bash
   echo "test message" >> /PATH/TO/YOUR/LOG/FILE
   ```

4. Busque en nuestra [UI de logs](https://one.newrelic.com/launcher/logger.log-launcher) `test message`.
