...
<Callout variant="important">
  Si utiliza una cuenta regional, utilice el extremo adecuado en lugar de `newrelic.syslog.nr-data.net`:

  * Cuentas de la UE: `newrelic.syslog.eu.nr-data.net`
  * Cuentas de JP: `newrelic.syslog.jp.nr-data.net`

  No olvides reemplazarlo en los archivos de configuración; usar el extremo de EE. UU. para una cuenta regional no funcionará.
</Callout>
