...
6. (Opcional): Agrega un atributo personalizado a tus datos `syslog` .
   ...
   * <DoNotTranslate>**Add custom attributes directly in the template string.**</DoNotTranslate> Deberá evitar las comillas dobles (`"`) para los valores de cadena. Por ejemplo:
   ...
   * <DoNotTranslate>**Add custom attributes using a custom property variable in the template string.**</DoNotTranslate> Este método evita la necesidad de escapar de los valores de cadena.
