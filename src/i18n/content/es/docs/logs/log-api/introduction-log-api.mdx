...
Extremo de la [Unión Europea](/docs/accounts/accounts-billing/account-setup/choose-your-data-center) (UE):

```
https://log-api.eu.newrelic.com/log/v1
```

Extremo de [Japón](/docs/accounts/accounts-billing/account-setup/choose-your-data-center):
