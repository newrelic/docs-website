...
* Instale el panel <DNT>**Logs analysis**</DNT> y/o <DNT>**APM logs monitoring quickstart**</DNT> para obtener rápidamente más información valiosa en sus datos log . Para agregar estos paneles, vaya a <DNT>**[one.newrelic.com](https://one.newrelic.com) > Add Data > Logging > Dashboards**</DNT>.
