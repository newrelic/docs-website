---
title: 'Almacenamiento Live Archives : facturación y reglas'
tags:
  - Logs
  - Log management
  - Get started
...
Cuando compra el complemento Live Archives Storage, medimos el almacenamiento en GB meses. Los meses GB se calculan para cada día.
...
* Repita esta misma medición para cada día del mes 9, ya que el “cubo” de 30 días de Live Archives Storage permanece lleno con 30 GB para todo el mes.
