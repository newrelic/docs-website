...
<Steps>
  ...
  <Step>
    ...
    <Callout variant="tip">
      Los pasos anteriores agregan Live Archives además de la retención estándar, por lo que un log llega primero al almacenamiento estándar. Si tiene logs que nunca necesita en el almacenamiento estándar, como los logs de cumplimiento o auditoría, seleccione <DNT>**Direct to live archive**</DNT> como el namespace de la partición en lugar de <DNT>**Standard**</DNT>. Los logs enviados a esa partición omiten el almacenamiento estándar por completo y van directamente a Live Archives. Consulte [Elegir un namespace](/docs/logs/ui-data/data-partitions/#namespace) para obtener más detalles.
    </Callout>
  </Step>
  ...
  <Step>
    ...
    * <DNT>**Compute**</DNT>: la consulta de datos de Live Archives se facturará en unidad de capacidad de computación. Consulte nuestra [documentación del plan de uso](/docs/licenses/license-information/usage-plans/new-relic-usage-plan/#list-price) para obtener más información sobre la unidad de capacidad de computación.
    ...
    Una vez que consultes Live Archives, podrás explorar tu consumo calculado en el centro de gestión de consumo.
    ...
    2. Seleccione <DNT>**Consumption management**</DNT>.
