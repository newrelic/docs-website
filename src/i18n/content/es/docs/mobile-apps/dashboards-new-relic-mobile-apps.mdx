...
Puede limitar la información que se muestra utilizando la función de filtrado, que es una representación visual de las condiciones de la consulta. En cualquier dashboard, toque el enlace <DoNotTranslate>**Filter by any attribute or value**</DoNotTranslate> en la parte superior.
