...
Los usuarios pueden configurar un flujo de trabajo con notificaciones push para móviles como un [destino](/docs/alerts-applied-intelligence/notifications/notification-integrations#mobile_push).
