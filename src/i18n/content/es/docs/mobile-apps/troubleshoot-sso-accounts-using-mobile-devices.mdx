...
Si ve algún error después de iniciar sesión correctamente en su proveedor de SSO con su dispositivo móvil, verifique que pueda iniciar sesión en <DNT>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DNT> con un browser web de escritorio.
