    ...
    <SideBySide>
      ...
      <Side>
        ...
        * Una sección
          ...
          que brinda acceso a errores, logs y Gestión de vulnerabilidades con un solo clic, lo que le permite solucionar problemas a medida que surgen sin tener que buscar cuál es el problema.
    ...
    <SideBySide>
      ...
      <Side>
        ...
        * Una página de resumen
          ...
          que muestra todo su log ingerido y le brinda la opción de ordenarlos, filtrarlos y agregarlos al panel para un acceso futuro más rápido.

        * Una sección

          <DNT>**Attributes**</DNT>

          que enumera todos los atributos de su log para facilitar la consulta de su log.
