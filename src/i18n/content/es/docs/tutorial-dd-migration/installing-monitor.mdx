  ...
  <Collapser id="apm-dash" title="Dashboard de aplicaciones">
    <SideBySide>
      ...
      <Side>
        ...
        * Datos sobre cualquier evento de alerta, vulnerabilidades, tasas de error en los despliegues e información sobre la salud de todo su stack desde la misma página de <DNT>**Summary**</DNT>.
