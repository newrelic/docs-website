  ...
  <Step>
    ...
    <CollapserGroup>
      <Collapser
        ...
        title="A través de la UI"
      >
        Para comprobar que está capturando el registro de eventos, vaya a la pestaña <DNT>**JS Errors**</DNT> . Verifique varios errores diferentes para verificar que aparezca el registro de eventos.<img src={omaOeScBrowserErrorLog} alt="Browser JavaScript Error Logs" title="Browser JavaScript Error Logs"/>
      </Collapser>
    </CollapserGroup>
  ...
  <Step>
    ...
    <CollapserGroup>
      <Collapser
        ...
        title="A través de la UI"
      >
        Verifique la agrupación AJAX para su aplicación seleccionándola en el menú de la izquierda y agrupándola por <DNT>**groupedRequestUrl**</DNT>. Si lo que ve se parece mucho a la captura de pantalla a continuación, tome nota y siga las instrucciones de esta guía sobre cómo solucionarlo.<img src={omaOeScBrowserGroupedAjaxRequests} alt="AJAX Grouping" title="AJAX Grouping"/>
      </Collapser>
