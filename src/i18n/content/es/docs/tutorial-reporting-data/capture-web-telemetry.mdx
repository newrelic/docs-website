...
<Steps>
  ...
  <Step>
    ...
    <CollapserGroup>
      ...
      >
        Abra su aplicación sitio web en <DNT>**Browser**</DNT>. Abra la vista <DNT>**Errors**</DNT> en el menú de la izquierda y verifique que pueda ver errores de JavaScript. Si su aplicación no recibe mucho tráfico, es posible que deba retroceder 24 horas o más para ver errores.<img
    ...
    <CollapserGroup>
      <Collapser
        ...
        title="A través de la UI"
      >
        Para comprobar que está capturando el registro de eventos, vaya a la pestaña <DNT>**JS Errors**</DNT> . Verifique varios errores diferentes para verificar que aparezca el registro de eventos.<img
  ...
  <Step>
    ...
    <CollapserGroup>
      <Collapser
        ...
        title="A través de la UI"
      >
        Verifique la UI <DNT>**Page views**</DNT> de su aplicación seleccionándola en el menú de la izquierda. Si lo que ve se parece mucho a la captura de pantalla a continuación, tome nota y siga las instrucciones de esta guía sobre cómo solucionarlo.<img
  ...
  <Step>
    ...
    <CollapserGroup>
      <Collapser
        ...
        title="A través de la UI"
      >
        Verifique la agrupación AJAX para su aplicación seleccionándola en el menú de la izquierda y agrupándola por <DNT>**groupedRequestUrl**</DNT>. Si lo que ve se parece mucho a la captura de pantalla a continuación, tome nota y siga las instrucciones de esta guía sobre cómo solucionarlo.<img
