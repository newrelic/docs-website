...
2. Inserte esa clave en el siguiente JSON y luego envíe el JSON a nuestro extremo. Nota: si tiene una cuenta de New Relic de la UE o JP, use el [extremo regional](/docs/distributed-tracing/trace-api/trace-api-general-requirements-limits#requirements) adecuado en su lugar.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Cualquier conjunto de pares de valor principal que agregue más detalles sobre un span. Se requiere `duration.ms`, y se recomienda encarecidamente agregar los atributos `name` y `parent.id`.
      </td>
