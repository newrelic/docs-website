...
* <DNT>**HTTP status code**</DNT> (sincrónico). Los errores de autenticación y solicitud se indicarán mediante un código de estado HTTP.
  ...
  <CollapserGroup>
    <Collapser id="status-codes" title="Ver códigos de estado HTTP">
      <table>
        <thead>
          <tr>
