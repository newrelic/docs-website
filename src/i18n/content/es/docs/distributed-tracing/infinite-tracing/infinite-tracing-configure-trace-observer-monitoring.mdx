...
3. Haga clic en el botón <DNT>**Trace observer monitoring**</DNT> .
...
* Se agregan dos columnas al listado principal de observadores de traza:
  ...
  * <DNT>**Traces Seen**</DNT>: Cuántas trazas vio el observador de trazas en los últimos 60 minutos.
  * <DNT>**Traces Kept**</DNT>: El número y porcentaje de trazas que se retuvieron.
