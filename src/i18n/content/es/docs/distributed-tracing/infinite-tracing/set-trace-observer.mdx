...
1. Vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infinite Tracing settings**</DoNotTranslate>.
...
3. Si ya no hay observadores de traza presentes, haga clic en <DoNotTranslate>**New trace observer**</DoNotTranslate> para agregar uno, complete la información y haga clic en <DoNotTranslate>**Create**</DoNotTranslate>. Tenga en cuenta que ofrecemos las siguientes regiones:
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  Reemplace esto con el valor extremo <DoNotTranslate>**For other integrations**</DoNotTranslate> que copió en un paso anterior.
                </td>
              </tr>
            </tbody>
          </table>
...
4. En el menú desplegable <DoNotTranslate>**Endpoints**</DoNotTranslate> , copia el valor extremo en <DoNotTranslate>**For other integrations**</DoNotTranslate> y tenlo listo. En nuestros ejemplos de código se hace referencia a este valor como YOUR_TRACE_OBSERVER_URL. Esto se utiliza para probar el [observador de traza](#sample-payload).
...
1. Regrese a la aplicación de traza observer (<DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infinite Tracing settings**</DoNotTranslate>).

2. Para su observador de traza, vaya al final de la fila, haga clic en el icono de puntos suspensivos <DoNotTranslate>**...**</DoNotTranslate> y luego haga clic en <DoNotTranslate>**Edit mobile, browser, lambda sources**</DoNotTranslate>.
