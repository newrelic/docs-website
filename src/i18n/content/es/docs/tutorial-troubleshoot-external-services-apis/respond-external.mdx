...
<Steps>
  ...
  <Step>
    ...
    Una vez que haya completado los pasos adicionales del documento anterior, vaya a <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/nr1-core?filters=(domain%3D'APM'ANDtype%3D'APPLICATION'))**</DoNotTranslate> > seleccione su aplicación > <DoNotTranslate>**External services**</DoNotTranslate>. Debería ver fluir información sobre sus API y servicios externos.
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    Ha instrumentado su servicio que maneja todo el proceso de entrega. Vaya a la página <DoNotTranslate>**External services**</DoNotTranslate> y luego haga clic en <DoNotTranslate>**Maps**</DoNotTranslate>.
