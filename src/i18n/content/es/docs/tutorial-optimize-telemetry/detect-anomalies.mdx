...
2. Seleccione <DoNotTranslate>**Install this quickstart**</DoNotTranslate>.
...
4. Seleccione <DoNotTranslate>**Done**</DoNotTranslate>.

5. Cuando el inicio rápido termine de instalarse, abra el dashboard <DoNotTranslate>**Data governance entity breakdowns**</DoNotTranslate> para acceder a sus datos.
