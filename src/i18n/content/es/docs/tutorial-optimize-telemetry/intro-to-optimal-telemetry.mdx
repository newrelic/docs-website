...
Deberá asegurarse de tener datos administrados con New Relic para poder usar <DoNotTranslate>**data ingest governance**</DoNotTranslate> para optimizarlos. Consulte nuestro [documento de gestión de datos](/docs/data-apis/manage-data/manage-your-data/) si necesita más información.
