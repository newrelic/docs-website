...
<figcaption>
  Vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Destinations**</DoNotTranslate>. Utilice destinos para elegir dónde se envía su notificación.
</figcaption>
...
Para realizar un seguimiento de los errores, se recomienda visitar el [registro de notificaciones](/docs/alerts-applied-intelligence/notifications/notification-integrations/#notifications-log) y el [evento NrIntegrationError](/docs/data-apis/ingest-apis/metric-api/troubleshoot-nrintegrationerror-events/#error-details).
