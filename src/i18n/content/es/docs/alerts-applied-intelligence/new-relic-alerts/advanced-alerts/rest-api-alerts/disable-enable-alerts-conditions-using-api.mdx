...
La API REST ya no es la forma preferida de administrar su alerta mediante programación. Para obtener más contexto, lea la [Introducción a las API de <InlinePopover type="alerts"/>y la inteligencia aplicada](/docs/alerts-applied-intelligence/new-relic-alerts/advanced-alerts/alerts-api/intro-alerts-api).
...
1. Obtenga el <DoNotTranslate>**policy_id**</DoNotTranslate> de la política que desea actualizar. Para una política imaginaria denominada `Logjam Alert`, el comando sería:
