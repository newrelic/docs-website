...
<CollapserGroup>
  ...
  >
    ...
    <figcaption>
      Si sus datos llegan de manera consistente y predecible, use <DoNotTranslate>**event flow**</DoNotTranslate>. Si sus datos llegan de manera inconsistente e impredecible, use <DoNotTranslate>**event timer**</DoNotTranslate>.
    </figcaption>
  </Collapser>
</CollapserGroup>
...
[evento timer](#event-timer) funciona mejor para datos que llegan con poca frecuencia en lotes, como datos de integración en la nube o registros de errores poco frecuentes.
...
Puede configurar su ventana de agregación en cualquier valor entre <DoNotTranslate>**30 seconds**</DoNotTranslate> y <DoNotTranslate>**6 hours**</DoNotTranslate>. El valor predeterminado es <DoNotTranslate>**1 minute**</DoNotTranslate>.
...
El retraso predeterminado es <DoNotTranslate>**2 minutes**</DoNotTranslate>. El valor predeterminado del temporizador es <DoNotTranslate>**1 minute**</DoNotTranslate>, tiene un valor mínimo de <DoNotTranslate>**5 seconds**</DoNotTranslate> y un valor máximo de <DoNotTranslate>**20 minutes**</DoNotTranslate>.
