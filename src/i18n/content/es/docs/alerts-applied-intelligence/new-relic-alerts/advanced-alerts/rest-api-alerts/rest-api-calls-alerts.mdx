...
El [Explorador de API REST](/docs/apm/apis/api-explorer-v2/getting-started-new-relics-api-explorer) también incluye el formato de solicitud curl, el parámetro disponible, códigos de estado de respuesta potenciales y la estructura de respuesta JSON para cada una de las API de llamada disponibles. También puedes [crear condición de alerta en la UI](/docs/alerts/new-relic-alerts/defining-conditions/define-alert-conditions).

## Antes de usar la API REST [#before-start]

Antes de utilizar la API REST para administrar datos de alertas, lea la [Introducción a las API para <InlinePopover type="alerts"/>e inteligencia aplicada](/docs/alerts-applied-intelligence/new-relic-alerts/advanced-alerts/alerts-api/intro-alerts-api).

Para alertas de infraestructura, consulte [API REST para alerta de monitoreo de infraestructura](/docs/infrastructure/new-relic-infrastructure/infrastructure-alert-conditions/rest-api-calls-new-relic-infrastructure-alerts).
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        En general, cualquier [rol](/docs/accounts-partnerships/accounts/account-setup/users-roles) puede utilizar una [clave de API](/docs/apis/rest-api-v2/requirements/rest-api-key) <InlinePopover type="userKey"/>o REST con <DoNotTranslate>**GET > List**</DoNotTranslate> funciones para <DoNotTranslate>**view**</DoNotTranslate> alertar datos. El propietario de la cuenta y los administradores pueden utilizar su clave de API.
        ...
        * Condiciones para
          ...
          ([se aplican algunas limitaciones).](#excluded)
    ...
    <tr>
      ...
      <td>
        Puede tener una función de propietario o administrador en su cuenta <DoNotTranslate>**and**</DoNotTranslate> una [clave de usuario](/docs/apis/get-started/intro-apis/types-new-relic-api-keys#user-api-key) <DoNotTranslate>**or**</DoNotTranslate> tener una función personalizada que otorga permisos para administrar la alerta <DoNotTranslate>**and**</DoNotTranslate> una [clave de usuario](/docs/apis/get-started/intro-apis/types-new-relic-api-keys#user-api-key) para poder utilizar cualquier función de mantenimiento, incluidas <DoNotTranslate>**POST > Create**</DoNotTranslate>, <DoNotTranslate>**PUT > Add**</DoNotTranslate>, <DoNotTranslate>**PUT > Update**</DoNotTranslate> y <DoNotTranslate>**DELETE**</DoNotTranslate>.
      </td>
    </tr>
  </tbody>
</table>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**Required.**</DoNotTranslate> Si no cambia el nombre, el valor predeterminado es una política llamada cadena.
...
<DoNotTranslate>**Exception:**</DoNotTranslate> Las siguientes condiciones de APM son <DoNotTranslate>**not available**</DoNotTranslate> de estos extremos de API:
...
<CollapserGroup>
  ...
  >
    ...
    * El `policy_id` (disponible en <DoNotTranslate>**[API Explorer](https://rpm.newrelic.com/api/explore/alerts_policies/list) > Alerts Policies > GET > List**</DoNotTranslate>)
    ...
    * Los valores `condition` requeridos en la API de llamada (descritos en la página del Explorador de API y en el [glosario de API de condición de alerta](/docs/alerts/new-relic-alerts/rest-api-alerts/alerts-conditions-api-field-names))
      ...
      La respuesta JSON devuelve una condición `id`, que deberá actualizar o eliminar. También puede ver la condición `id` de <DoNotTranslate>**[API Explorer](https://rpm.newrelic.com/api/explore/alerts_conditions/list) > Alerts Conditions > GET > List**</DoNotTranslate>.
  </Collapser>
  ...
  >
    ...
    * La condición es `id` (disponible desde <DoNotTranslate>**[API Explorer](https://rpm.newrelic.com/api/explore/alerts_condition/list) > Alerts Conditions > GET > List**</DoNotTranslate>)
  ...
  >
    ...
    * El `condition_id` (disponible en <DoNotTranslate>**[API Explorer](https://rpm.newrelic.com/api/explore/alerts_conditions/list) > Alerts Conditions > GET > List**</DoNotTranslate>)
...
<DoNotTranslate>**Exception:**</DoNotTranslate> Las condiciones de anomalía NRQL son <DoNotTranslate>**not available**</DoNotTranslate> de este extremo.
...
<CollapserGroup>
  ...
  >
    ...
    * La condición es `id` (disponible en [API Explorer <Icon name="fe-external-link"/>](https://rpm.newrelic.com/api/explore/alerts_nrql_conditions/list) <DoNotTranslate>**Alerts NRQL Conditions > GET > List**</DoNotTranslate>)
...
<CollapserGroup>
  ...
  >
    ...
    * Los valores `external_service_condition` requeridos en la llamada API (descritos en la página API Explorer y en el [glosario API condición de alerta](/docs/alerts/new-relic-alerts/rest-api-alerts/alerts-conditions-api-field-names))
      ...
      La respuesta JSON devuelve una condición `id`, que deberá actualizar o eliminar. También puede ver la condición `id` de <DoNotTranslate>**[API Explorer](https://rpm.newrelic.com/api/explore/alerts_external_service_conditions/list) > Alerts External Service Conditions > GET > List**</DoNotTranslate>.
  </Collapser>
  ...
  >
    ...
    * La condición del servicio externo `id` (disponible en <DoNotTranslate>**[API Explorer](https://rpm.newrelic.com/api/explore/alerts_external_service_conditions/list) > Alerts External Service Conditions > GET > List**</DoNotTranslate>)
  ...
  >
    ...
    * El `condition_id` (disponible en <DoNotTranslate>**[API Explorer](https://rpm.newrelic.com/api/explore/alerts_conditions/list) > Alerts External Service Conditions > GET > List**</DoNotTranslate>)
...
<CollapserGroup>
  ...
  >
    ...
    * Los valores `synthetics_condition` requeridos en la API de llamada (descritos en la página del Explorador de API y en el [glosario de API de condición de alerta](/docs/alerts/new-relic-alerts/rest-api-alerts/alerts-conditions-api-field-names))
      ...
      La respuesta JSON devuelve una condición `id`, que deberá actualizar o eliminar. También puede ver la condición `id` de <DoNotTranslate>**[API Explorer](https://rpm.newrelic.com/api/explore/alerts_synthetics_conditions/list) > Alerts Synthetics Conditions > GET > List**</DoNotTranslate>.
  </Collapser>
  ...
  >
    ...
    * La condición `id` (disponible en <DoNotTranslate>**[API Explorer](https://rpm.newrelic.com/api/explore/alerts_synthetics_conditions/list) > Alerts Synthetics Conditions > GET > List**</DoNotTranslate>)
  ...
  >
    ...
    * El `condition_id` (disponible en <DoNotTranslate>**[API Explorer](https://rpm.newrelic.com/api/explore/alerts_synthetics_conditions/list) > Alerts Synthetics Conditions > GET > List**</DoNotTranslate>)
...
<CollapserGroup>
  ...
  >
    ...
    * Los valores `location_failure_condition` requeridos en la API de llamada (descritos en la página del Explorador de API y en el [glosario de API de condición de alerta](/docs/alerts/new-relic-alerts/rest-api-alerts/alerts-conditions-api-field-names))
      ...
      La respuesta JSON devuelve una condición `id`, que deberá actualizar o eliminar. También puede ver la condición `id` de <DoNotTranslate>**[API Explorer](https://rpm.newrelic.com/api/explore/alerts_location_failure_conditions/list) > Alerts Location Failure Conditions > GET > List**</DoNotTranslate>.
  </Collapser>
  ...
  >
    ...
    * La condición `id` (disponible en <DoNotTranslate>**[API Explorer](https://rpm.newrelic.com/api/explore/alerts_location_failure_conditions/list) > Alerts Location Failure Conditions > GET > List**</DoNotTranslate>)
  ...
  >
    ...
    * El `condition_id` (disponible en <DoNotTranslate>**[API Explorer](https://rpm.newrelic.com/api/explore/alerts_location_failure_conditions/list) > Alerts Location Failure Conditions > GET > List**</DoNotTranslate>)
...
## Actividad de alerta: evento, incidente [#alert-activity]
...
<CollapserGroup>
  ...
  >
    Para ver [el evento](/docs/alerts/new-relic-alerts-beta/getting-started/alerts-glossary#event) de [entidad](/docs/alerts/new-relic-alerts-beta/getting-started/alerts-glossary#alert-entity) monitor por APM, browser, móvil, monitoreo sintético y alerta, incluya estos valores en la llamada API:
    ...
    * Otros valores opcionales para usar como filtros (descritos en la [página de API Explorer](https://rpm.newrelic.com/api/explore/alerts_events/list)) que dependen del tipo de producto (monitoreo de navegador, monitoreo de móviles, etc.), entidad (como apps o clave de transacción para APM, monitoreo sintético, etc. ) y tipo de evento (notificación, implementación, instrumentación, etc.)

    * Un valor [de paginación](/docs/apis/rest-api-v2/requirements/pagination-api-output) opcional.
  ...
  >
    Para ver [el incidente](/docs/new-relic-solutions/get-started/glossary/#alert-incident) de cualquier monitor [de entidad](/docs/alerts/new-relic-alerts-beta/getting-started/alerts-glossary#alert-entity) para su cuenta, incluya estos valores en la llamada API:

    * Su [clave de usuario](/docs/apis/get-started/intro-apis/types-new-relic-api-keys#user-api-key) o [clave REST de API](/docs/apis/rest-api-v2/requirements/rest-api-key)

    * Una bandera opcional para mostrar solo aquellos incidentes que están abiertos actualmente.
  ...
  <Collapser
    ...
    title="Lista de incidentes"
  >
    Para ver [el incidente](/docs/alerts/new-relic-alerts-beta/getting-started/alerts-glossary#alert-incident) de cualquier monitor [de entidad](/docs/alerts/new-relic-alerts-beta/getting-started/alerts-glossary#alert-entity) para su cuenta, incluya estos valores en la llamada API:

    * Su [clave de usuario](/docs/apis/get-started/intro-apis/types-new-relic-api-keys#user-api-key) o [clave REST de API](/docs/apis/rest-api-v2/requirements/rest-api-key)

    * Una bandera opcional para mostrar solo aquellos incidentes que están abiertos actualmente.

    * Un indicador opcional para excluir datos de incidentes de la respuesta
  ...
  >
    Para mostrar un único [incidente](/docs/alerts/new-relic-alerts-beta/getting-started/alerts-glossary#alert-incident) asociado con su cuenta, incluya estos valores en la llamada API:

    * Su [clave de usuario](/docs/apis/get-started/intro-apis/types-new-relic-api-keys#user-api-key) o [clave REST de API](/docs/apis/rest-api-v2/requirements/rest-api-key)

    * Una identificación de incidente
  ...
  >
    Para reconocer un [incidente](/docs/alerts/new-relic-alerts-beta/getting-started/alerts-glossary#alert-incident) asociado con su cuenta, incluya estos valores en la llamada API:
  ...
  >
    Para cerrar un [incidente](/docs/alerts/new-relic-alerts-beta/getting-started/alerts-glossary#alert-incident) asociado con su cuenta, incluya estos valores en la llamada API:
