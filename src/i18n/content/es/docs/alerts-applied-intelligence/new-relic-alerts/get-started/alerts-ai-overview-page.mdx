...
En la página <InlinePopover type="alerts"/><DoNotTranslate>**Overview**</DoNotTranslate> , encontrará una vista consolidada de su incidente de alerta actual. La página <DoNotTranslate>**Issues & activity**</DoNotTranslate> tiene vistas de sus problemas activos y de incidentes recientes.

## Por qué es importante [#why]

Las páginas <DoNotTranslate>**Overview**</DoNotTranslate> y <DoNotTranslate>**Issues & activity**</DoNotTranslate> proporcionan análisis sobre el rendimiento (o no) de su sistema. Puede cambiar rápidamente entre [<DoNotTranslate>**Overview**</DoNotTranslate>](#summary), [<DoNotTranslate>**Issues**</DoNotTranslate>](#issues) y [<DoNotTranslate>**Incidents**</DoNotTranslate>](#incidents) para buscar problemas críticos que afecten a sus sistemas.
