---
title: Página de descripción general de alerta e IA
tags:
...
En la página <InlinePopover type="alerts"/><DoNotTranslate>**Overview**</DoNotTranslate> , encontrará una vista consolidada de su incidente de alerta actual. La página <DoNotTranslate>**Issues & activity**</DoNotTranslate> tiene vistas de sus problemas activos, incidentes recientes y anomalías.

## Por qué es importante [#why]

Las páginas <DoNotTranslate>**Overview**</DoNotTranslate> y <DoNotTranslate>**Issues & activity**</DoNotTranslate> proporcionan análisis sobre el rendimiento (o no) de su sistema. Puede cambiar rápidamente entre [<DoNotTranslate>**Overview**</DoNotTranslate>](#summary), [<DoNotTranslate>**Issues**</DoNotTranslate>](#issues), [<DoNotTranslate>**Incidents**</DoNotTranslate>](#incidents) y [<DoNotTranslate>**Anomalies**</DoNotTranslate>](#anomalies) para buscar problemas críticos que afecten a sus sistemas.
...
En la página <DoNotTranslate>**Issues & activity**</DoNotTranslate> , los incidentes son eventos que describen los síntomas que afectan su sistema a lo largo del tiempo. Estos síntomas son detectados por sus herramientas de monitoreo, que evalúan sus flujos de datos y eventos.
...
En la página <DoNotTranslate>**Issues & activity**</DoNotTranslate> , las anomalías son valores atípicos en el rendimiento y funcionamiento de su sistema que pueden ser señal de un problema. Vea cada anomalía en un solo lugar. Puede filtrar sus anomalías por estado de anomalía, entidad, configuración y tipo de configuración.

De forma predeterminada, esta página muestra una lista de todas sus anomalías recientes en la cuenta seleccionada. Seleccione una anomalía para ver un análisis detallado y más contexto.

### Columnas de alimentación de anomalías
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Valores: abierto o cerrado.
      </td>
    </tr>

    <tr>
      <td>
        Categoría de anomalía
      </td>

      <td>
        Valores: tasa de errores, rendimiento web, rendimiento no web.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Un gráfico para ilustrar la anomalía.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Hace cuánto comenzó la anomalía.
      </td>
    </tr>
