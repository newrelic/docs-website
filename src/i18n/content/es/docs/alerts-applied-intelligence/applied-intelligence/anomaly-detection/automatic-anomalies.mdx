...
<DoNotTranslate>**Anomaly analysis:**</DoNotTranslate> Para cada anomalía, proporcionamos un enlace en Slack a una página de análisis de anomalías. Esta página genera automáticamente Insights sobre la anomalía. La página también está disponible en la pestaña anomalía, que enumera las anomalías recientes. Esta página utiliza sus datos de detección de anomalías y <InlinePopover type="apm"/>existentes para proporcionar explicaciones sobre la causa de la anomalía.
