...
<figcaption>
  Vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Browser >**</DoNotTranslate> (seleccione una aplicación browser ) <DoNotTranslate>**> Page views >**</DoNotTranslate> (haga clic en un monitor de página mediante monitoreo sintético) > (desplácese hacia abajo hasta el gráfico <DoNotTranslate>**Synthetic monitors comparison**</DoNotTranslate>).
</figcaption>
...
Según las [fuentes de datos de comparación](#data-sources), el gráfico <DoNotTranslate>**Synthetic monitors comparison**</DoNotTranslate> muestra:
...
### ¿No ves datos en el gráfico <DoNotTranslate>**Synthetic monitors comparison**</DoNotTranslate> ?
