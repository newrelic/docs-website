...
En el resultado de ese comando, debería ver el siguiente encabezado <DoNotTranslate>**response**</DoNotTranslate> que le indica que el servidor ofrece NTLM a través de HTTP como mecanismo de autenticación válido:
