...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Nuestro monitor ejecuta tres comprobaciones antes de entrar en un estado de error. Este sistema de impacto múltiple ayuda a reducir el ruido. Para obtener más información sobre esto, consulte [esta publicación del foro sobre el comportamiento de los tres strikes](https://forum.newrelic.com/s/hubtopic/aAX8W0000008b18WAA/relic-solution-understanding-the-three-strikes-behavior-in-synthetics).
      </td>
    </tr>
