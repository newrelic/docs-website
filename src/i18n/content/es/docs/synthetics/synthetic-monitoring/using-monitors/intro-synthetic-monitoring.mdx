...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Nuestros monitores ejecutan tres comprobaciones antes de entrar en un estado de fallo. Este sistema de múltiples fallos ayuda a reducir el ruido. Para más información sobre esto, consulta [esta publicación del foro sobre el comportamiento de tres strikes](https://support.newrelic.com/s/hubtopic/aAX8W0000008b18WAA/relic-solution-understanding-the-three-strikes-behavior-in-synthetics).
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        Puede [desbloquear](/docs/synthetics/new-relic-synthetics/scripting-monitors/write-scripted-browsers#unblock-service) cualquiera de los servicios bloqueados de forma predeterminada, o [bloquear](/docs/synthetics/synthetic-monitoring/scripting-monitors/synthetic-scripted-browser-reference-monitor-versions-chrome-100/#wildcard-use) servicios adicionales.
      </td>
    </tr>
