...
Para ver una breve demostración de cómo crear un monitor Sintético con New Relic, mire el siguiente vídeo (5:10 minutos).
...
Si aún no lo has hecho, [crea tu cuenta gratuita de New Relic](https://newrelic.com/signup) para que puedas crear tu primer monitor Sintético.<InlineSignup/>
...
<CollapserGroup>
  <Collapser
    className="freq-link"
    id="compatibility"
    title="¿Existe algún requisito del sistema con el monitoreo sintético?"
  >
  ...
  <Collapser
    className="freq-link"
    id="privacy"
    title="¿Qué tipo de datos genera el monitor Sintético?"
  >
  ...
  <Collapser
    className="freq-link"
    id="perms"
    title="¿Cómo funcionan los permisos de New Relic?"
  >
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Los monitores de pasos son monitores avanzados que no requieren código para su configuración.
    ...
    <tr>
      ...
      <td>
        Los monitores browser simples son monitores de browser simples y prediseñados con script. Realizan una solicitud a su sitio utilizando una instancia de Google Chrome.

        En comparación con un simple monitor de ping, esta es una emulación más precisa de la visita de un cliente real. El agente de usuario se identifica como `Google Chrome`.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        El monitor utiliza el browser Google Chrome. También puede utilizar una variedad de [módulos de terceros](/docs/synthetics/new-relic-synthetics/scripting-monitors/scripted-monitor-runtime-environment#runtime-table) para crear su monitor personalizado.
      </td>
    </tr>
...
El monitoreo sintético le permite monitor proactivamente su sitio web o los extremos de API para garantizar que su contenido no solo esté disponible, sino que sea completamente funcional. [El browser con secuencias de comandos](/docs/synthetics/new-relic-synthetics/scripting-monitors/writing-synthetic-scripts) envía una instancia real de Google Chrome con tecnología Selenium a su sitio desde ubicaciones alrededor del mundo para que tenga la seguridad de que su contenido siempre estará activo, en todas partes.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Para browser simple y un script de monitorización del browser, no solo verifican que su host esté activo. Carga el contenido real de la página en un browser Google Chrome real y totalmente virtualizado (con tecnología Selenium) para proporcionar pruebas que reflejen las acciones de su usuario.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Utilice [la emulación de dispositivos](/docs/synthetics/synthetic-monitoring/using-monitors/device-emulation) para simular dispositivos móviles o tabletas de forma sencilla y supervise el script del browser.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Monitoreo sintético incluye una API REST, que puedes utilizar para gestionar:
