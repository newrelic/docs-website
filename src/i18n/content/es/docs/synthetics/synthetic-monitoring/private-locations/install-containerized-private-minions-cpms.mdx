...
<CollapserGroup>
  <Collapser
    ...
    title={<><img src={dockimport} title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}>Docker Requisitos del entorno del sistema contenedor</img></>}
  >
    <table>
      <thead>
        <tr>
      ...
      <tbody>
        <tr>
          ...
          <td>
            ...
            _También debe configurar Docker para ejecutar el contenedor de Linux para que llamadas por minuto funcione en sistemas Windows._
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Una CPU AMD64/x86_64 multinúcleo moderna
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**Ping:**</DoNotTranslate> Despreciable<br/> <DoNotTranslate>**Scripted API:**</DoNotTranslate> 7<br/> <DoNotTranslate>**Simple browser:**</DoNotTranslate> 27<br/> <DoNotTranslate>**Scripted browser:**</DoNotTranslate> 28
            ...
            _La línea de base para llamadas Docker por minuto es de 0,5 IOPS sin trabajos de monitor en ejecución._
          </td>
        </tr>
  ...
  <Collapser
    ...
    title={<><img src={synthetick8logo} title="Kubernetes icon" alt="Kubernetes icon" style={{ height: '35px', width: '40px' }}>Requisitos del entorno del sistema de orquestación de contenedores Kubernetes (llamadas por minuto v3.0.0 o superior)</img></>}
  >
    <table>
      <thead>
        <tr>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**CPU (vCPU/Core):**</DoNotTranslate> 0,5 hasta 0,75<br/> <DoNotTranslate>**Memory:**</DoNotTranslate> 800Mi hasta 1600Mi
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**CPU (vCPU/Core):**</DoNotTranslate> 0,5 hasta 1<br/> <DoNotTranslate>**Memory:**</DoNotTranslate> 1250Mi hasta 3000Mi
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**Root volume:**</DoNotTranslate> Un mínimo de 50 GiB (nodo + PV)<br/> <DoNotTranslate>**Persistent volume (PV):**</DoNotTranslate> Un mínimo de 20 GiB
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**Ping:**</DoNotTranslate> Despreciable<br/> <DoNotTranslate>**Scripted API:**</DoNotTranslate> 11<br/> <DoNotTranslate>**Simple browser:**</DoNotTranslate> 33<br/> <DoNotTranslate>**Scripted browser:**</DoNotTranslate> 31
            ...
            _La línea de base para llamadas de Kubernetes por minuto es 3.0 IOPS sin trabajos de monitor en ejecución._
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Recomendamos que su clúster de Kubernetes sea compatible con [Kubernetes v1.15](https://kubernetes.io/blog/2019/06/19/kubernetes-1-15-release-announcement/). <Callout variant="caution">Para Kubernetes v1.21 o posterior, utilice la versión minion [v3.0.61](/docs/release-notes/synthetics-release-notes/containerized-private-minions-release-notes/containerized-private-minion-cpm-3061) o posterior.</Callout>
          </td>
        </tr>
...
2. En el índice
   ...
   , ubica la ubicación privada a la que deseas que se asignen tus llamadas por minuto.

3. Anote la clave asociada con la ubicación privada con la clave
...
<CollapserGroup>
  <Collapser
    ...
    title={<><img src={dockimport} title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}/>Docker dependencia</>}
  >
...
<CollapserGroup>
  <Collapser
    id="docker-update"
    title={<><img src={dockimport} title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}>Docker procedimiento de inicio</img></>}
  >
  ...
  <Collapser
    ...
    title={<><img src={synthetick8logo} title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png" style={{ height: '35px', width: '40px' }}>Procedimiento de inicio de Kubernetes</img></>}
  >
    <Callout
      variant="important"
      title="AVISO EOL"
...
<CollapserGroup>
  <Collapser
    id="docker-stop"
    title={<><img src={dockimport} title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}>Docker procedimiento de parada</img></>}
  >
  ...
  <Collapser
    ...
    title={<><img src={synthetick8logo} title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png" style={{ height: '35px', width: '40px' }}>Procedimiento de eliminación de Kubernetes</img></>}
  >
    1. Obtén el MINION_POD_INSTALLATION_NAME del pod minion que deseas eliminar:
...
<CollapserGroup>
  <Collapser
    id="run-non-root"
    title={<><img src={dockimport} title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}/>Ejecutar como usuario no root para Docker</>}
  >
