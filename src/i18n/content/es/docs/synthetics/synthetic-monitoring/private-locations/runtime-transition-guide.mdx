...
| Versión del entorno de ejecución de la API | `1.2.134` or lower | `1.2.143` o superior |
| Versión del tiempo de ejecución de Browser | `3.0.55` or lower  | `3.0.63` o superior  |
