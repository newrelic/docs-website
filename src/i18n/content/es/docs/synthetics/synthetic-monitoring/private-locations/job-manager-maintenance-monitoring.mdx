...
* `:8080/status/check`: proporciona detalles sobre las verificaciones de estado internas que realiza el Synthetics Job Manager. `HTTP 200` significa que el estado es saludable.
...
Puede monitorear el estado de su Synthetics Job Manager consultando los logs del contenedor de synthetics job manager.

<CollapserGroup>
  <Collapser id="review-docker-logs" title="Revisar los logs de Docker">
  ...
  <Collapser id="review-podman-logs" title="Revisar los logs de Podman">
  ...
  <Collapser id="review-kubernetes-logs" title="Revisar logs de Kubernetes">
...
<CollapserGroup>
  <Collapser id="docker-debug-logs" title="Habilitar el registro de depuración de Docker">
    <Callout variant="tip">
  ...
  <Collapser id="podman-debug-logs" title="Habilitar logs de depuración de Podman">
    <Callout variant="tip">
  ...
  <Collapser id="kubernetes-debug-logs" title="Habilitar logs de depuración de Kubernetes">
    <Callout variant="tip">
...
## Recuperar información de depuración [#retrieve-debugging-information]

Puede obtener información de depuración sobre su gestor de trabajos de Sintéticos para ayudar a solucionar problemas. Esto incluye información sobre el pod del gestor de trabajos de Sintéticos y el nodo en el que se ejecuta.
