...
<CollapserGroup>
  ...
  >
    Haga clic en el <Icon name="fe-more-horizontal"/> y seleccione <DNT>**Clear queue**</DNT>.
  ...
  >
    Haga clic en el <Icon name="fe-more-horizontal"/> y seleccione <DNT>**Edit**</DNT>.
  </Collapser>
  ...
  >
    ...
    <Steps>
      <Step>
        ...
        1. Vaya a <DNT>**[one.newrelic.com > Synthetic monitoring > Private locations](https://one.newrelic.com/synthetics/private-location-list)**</DNT>. Luego haga clic en <DNT>**Create private location**</DNT>.<img title="Screenshot showing where to add a new private location" alt="Screenshot showing where to add a new private location" src={syntheticPrivateLocationAdd}/>
