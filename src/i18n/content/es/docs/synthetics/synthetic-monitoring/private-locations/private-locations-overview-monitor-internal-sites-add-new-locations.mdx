...
Después de crear la ubicación, monitoreo sintético lista tu <DNT>**Private location key**</DNT> para que puedas [instalar un minion privado](/docs/synthetics/new-relic-synthetics/private-locations/install-containerized-private-minions-cpms#install-update).
    ...
    <Steps>
      <Step>
        ...
        1. Ir a <DNT>**[one.newrelic.com &gt; Synthetic monitoring &gt; Private locations](https://one.newrelic.com/synthetics/private-location-list)**</DNT>. Luego haga clic en <DNT>**Create private location**</DNT>.
           ...
           <img title="Screenshot showing where to add a new private location" alt="Screenshot showing where to add a new private location" src="/images/synthetic_screenshot-crop_private-location-add.webp" />

        2. Ingrese el nombre de la ubicación privada y marque <DNT>**Enable verified script execution**</DNT>. Luego haga clic en <DNT>**Generate key**</DNT> para crear la nueva ubicación privada.
        ...
        3. Actualiza tus administradores de trabajo o minion privado con la nueva ubicación privada. La sección <DNT>**Configure and deploy**</DNT> incluye código de muestra:
