...
<CollapserGroup>
  <Collapser
    ...
    title={<><img src={dockimport} title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}>Revisar el docker registro</img></>}
  >
  ...
  <Collapser
    ...
    title={<><img src={synthetick8logo} title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png" style={{ height: '35px', width: '40px' }}>Revisar el registro de Kubernetes</img></>}
  >
...
<CollapserGroup>
  <Collapser
    ...
    title={<><img src={dockimport} title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}>Habilitar el docker registro de depuración</img></>}
  >
    <Callout variant="tip">
  ...
  <Collapser
    ...
    title={<><img src={synthetick8logo} title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png" style={{ height: '35px', width: '40px' }}>Habilitar el registro de depuración de Kubernetes</img></>}
  >
    <Callout variant="tip">
      Agregar `-f` al `Kubernetes logs` hace que el comando siga el registro.
    </Callout>

    Para habilitar el registro DEBUG, agregue la opción `--set synthetics.minionLogLevel=DEBUG` cuando ejecute su `helm install`:
