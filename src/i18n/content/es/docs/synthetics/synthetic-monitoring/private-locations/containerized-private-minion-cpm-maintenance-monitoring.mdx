...
<CollapserGroup>
  <Collapser
    ...
    title={<><img src="/images/synthetic_logo_docker-logo.webp" title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}>Revisar el docker registro</img></>}
  >
...
<CollapserGroup>
  <Collapser
    ...
    title={<><img src="/images/synthetic_logo_docker-logo.webp" title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}>Habilitar el docker registro de depuración</img></>}
  >
    <Callout variant="tip">
