    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            <DNT>**Linux kernel:**</DNT> [3.10 o superior](https://docs.redhat.com/en/documentation/openshift_container_platform/3.11/html/installing_clusters/install-config-install-prerequisites#hardware)<br /> <DNT>**macOS:**</DNT> 10.11 o superior<br />
