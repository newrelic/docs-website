...
<CollapserGroup>
  <Collapser
    ...
    title={<><img src={syntheticDocker} title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}>Docker Requisitos del entorno del sistema contenedor</img></>}
  >
    <table>
      <thead>
        <tr>
      ...
      <tbody>
        <tr>
          ...
          <td>
            ...
            _También debe configurar docker para ejecutar el contenedor de Linux para que los administradores de trabajos de Sintético funcionen en sistemas Windows._
          </td>
        </tr>
  ...
  <Collapser
    ...
    title={<><img src={synthetick8s} title="Kubernetes icon" alt="Kubernetes icon" style={{ height: '35px', width: '40px' }}>Requisitos del entorno del sistema de orquestación de contenedores Kubernetes</img></>}
  >
    <table>
      <thead>
        <tr>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**CPU (vCPU/Core):**</DoNotTranslate> 0,5 hasta 0,75<br/> <DoNotTranslate>**Memory:**</DoNotTranslate> 500Mi hasta 1Gi
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**CPU (vCPU/Core):**</DoNotTranslate> 0,5 hasta 0,75<br/> <DoNotTranslate>**Memory:**</DoNotTranslate> 1250Mi hasta 2500Mi
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**CPU (vCPU/Core):**</DoNotTranslate> 1,0 hasta 1,5<br/> <DoNotTranslate>**Memory:**</DoNotTranslate> 2000Mi hasta 3000Mi
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**Root volume:**</DoNotTranslate> Un mínimo de 50 GiB<br/>
          </td>
        </tr>
...
2. En el índice
   ...
   , localice la ubicación privada a la que desea que se asigne su administrador de trabajos de Sintético.
...
<CollapserGroup>
  <Collapser
    id="docker-update"
    title={<><img src={syntheticDocker} title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}>Docker procedimiento de inicio</img></>}
  >
  ...
  <Collapser
    ...
    title={<><img src={synthetick8s} title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png" style={{ height: '35px', width: '40px' }}>Procedimiento de inicio de Kubernetes</img></>}
  >
    1. Localice su [clave de ubicación privada](#private-location-key).
...
<CollapserGroup>
  <Collapser
    id="docker-stop"
    title={<><img src={syntheticDocker} title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}>Docker procedimiento de parada</img></>}
  >
  ...
  <Collapser
    ...
    title={<><img src={synthetick8s} title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png" style={{ height: '35px', width: '40px' }}>Procedimiento de eliminación de Kubernetes</img></>}
  >
...
<CollapserGroup>
  <Collapser
    ...
    title={<><img src={syntheticDocker} title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}/>Docker dependencia</>}
  >
...
<CollapserGroup>
  <Collapser
    id="run-non-root"
    title={<><img src={syntheticDocker} title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}/>Ejecutar como usuario no root para Docker</>}
  >
...
<CollapserGroup>
  <Collapser
    id="help"
    title="Mantener el administrador de trabajos."
  >
  ...
  <Collapser
    id="license"
    title="Mostrar información de licencia"
  >
  ...
  <Collapser
    id="image"
    title="Repositorio de imágenes Docker"
  >
