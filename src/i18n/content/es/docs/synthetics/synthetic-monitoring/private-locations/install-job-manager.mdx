...
Nuestros administradores de trabajos de monitoreo sintético son recursos basados en [contenedores](https://www.docker.com/resources/what-container)que aceptan y ejecutan [monitores sintéticos](/docs/synthetics/synthetic-monitoring/using-monitors/intro-synthetic-monitoring/#types-of-synthetic-monitors) asignados a [ubicaciones privadas](/docs/synthetics/synthetic-monitoring/private-locations/private-locations-overview-monitor-internal-sites-add-new-locations). El administrador de trabajos puede operar en un entorno de sistema de contenedor Docker, un entorno de sistema de contenedor Podman, un entorno de sistema de orquestación de contenedor Kubernetes o un entorno de sistema de contenedor OpenShift.

<Callout variant="important">
  Si está migrando de los runtimes de Node.js 16/Chrome 134 a Node.js 22/Chrome 146, consulte la [guía de transición del runtime de la ubicación privada](/docs/synthetics/synthetic-monitoring/private-locations/runtime-transition-guide) para obtener estrategias de migración, ejemplos de despliegue y pasos de resolución de problemas.
</Callout>
...
## Requisitos de versión [#version-requirements]
...
<CollapserGroup>
  <Collapser id="docker-requirements" title="Requisitos del entorno del sistema de contenedor Docker">
    <table>
      <thead>
        <tr>
  ...
  <Collapser id="podman-requirements" title="Requisitos del entorno del sistema de contenedores Podman">
    <table>
      <thead>
        <tr>
          <th style={{ width: "265px" }}>
  ...
  <Collapser id="kubernetes-requirements" title="Requisitos del entorno del sistema de orquestación de contenedores Kubernetes">
    <table>
      <thead>
        <tr>
          <th style={{ width: "265px" }}>
...
Si ejecuta más de un contenedor de ubicación privada de Docker o Podman en el mismo host, tendrá conflictos de puertos. Para evitar esta contención de puertos, asegúrese de ejecutar cada gestor de trabajos en un host separado.
...
<CollapserGroup>
  <Collapser id="docker-update" title="Procedimiento de inicio de Docker">
    ...
    3. Ejecute el script apropiado para su sistema. Adapte el valor predeterminado común `/var/run/docker.sock` en los siguientes ejemplos para que coincida con su sistema.
       ...
       * Ventanas:
       ...
       Vea los logs de su contenedor de administrador de trabajos:
  ...
  <Collapser id="podman-update" title="Procedimiento de inicio de Podman">
    1. Localice su [clave de ubicación privada](#private-location-key).
    ...
    Para ver los logs del contenedor de su gestor de trabajos:
  ...
  <Collapser id="kubernetes-install" title="Procedimiento de inicio de Kubernetes">
    1. Localice su [clave de ubicación privada](#private-location-key).
...
<CollapserGroup>
  <Collapser id="docker-stop" title="Procedimiento de detención de Docker">
  ...
  <Collapser id="podman-stop" title="Procedimiento de detención de Podman">
  ...
  <Collapser id="kubernetes-delete" title="Procedimiento de eliminación de Kubernetes">
    ...
    2. Elimine el pod del gestor de trabajos:
...
<CollapserGroup>
  <Collapser id="docker-dependencies" title="Dependencias de Docker">
...
<CollapserGroup>
  <Collapser id="podman-dependencies" title="Dependencias de Podman">
...
<CollapserGroup>
  <Collapser id="run-non-root" title="Ejecutar como usuario no root para Docker">
