...
Al validar un monitor creado en un runtime anterior frente al [runtime**más reciente** de Chrome](/docs/synthetics/synthetic-monitoring/scripting-monitors/synthetic-scripted-browser-reference-monitor-versions-chrome-100), `findElement` y otros métodos para encontrar e interactuar con elementos en la página pueden fallar debido a diferencias en el manejo de promesas. Si el monitor pasa en un runtime legacy, falla en el nuevo runtime y el elemento está presente en la captura de pantalla, mejore su lógica de manejo de promesas.
