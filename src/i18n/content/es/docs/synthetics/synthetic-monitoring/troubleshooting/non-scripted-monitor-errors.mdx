...
<CollapserGroup id="non-scripted-errors">
  ...
  >
    ...
    Vaya a <DoNotTranslate>**[one.newrelic.com > Synthetic monitoring](https://one.newrelic.com/synthetics-nerdlets)**</DoNotTranslate> > (seleccione un monitor) > <DoNotTranslate>**General > Advanced options**</DoNotTranslate> y luego desactive <DoNotTranslate>**Verify SSL check**</DoNotTranslate>.

    ### Causa

    Los errores SSLVerificationError son el resultado de un error opcional <DoNotTranslate>**Verify SSL check**</DoNotTranslate> en el host de destino.
  ...
  >
    ...
    <DoNotTranslate>**Public synthetic monitoring locations:**</DoNotTranslate> Asegúrese de que los servicios DNS públicos, como el DNS público de Google y el DNS proporcionado por Amazon, puedan buscar el registro DNS del sitio de destino.
