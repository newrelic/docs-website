...
<CollapserGroup>
  <Collapser
    ...
    title="No se puede hacer clic en el elemento A en el punto (X, Y). Otro elemento recibiría el clic: Elemento B"
  >
    ### Problema
  ...
  <Collapser
    ...
    title="Error: elemento no visible"
  >
    ### Problema
  ...
  <Collapser
    id="no-such-element"
    title="Error: no existe tal elemento: No se puede localizar el elemento: <LOCATOR>"
  >
    ### Problema
  ...
  <Collapser
    id="job-timed-out"
    title="JobTimeoutError: el tiempo de espera del trabajo se agotó después de 180 s"
  >
    ### Problema
  ...
  <Collapser
    ...
    title="NetworkError: el monitor no produjo tráfico"
  >
    ### Problema
  ...
  <Collapser
    ...
    title="Error de referencia: $network no está definido"
  >
    ### Problema
  ...
  <Collapser
    ...
    title="Error de tiempo de espera de secuencia de comandos"
  >
    ### Problema
  ...
  <Collapser
    ...
    title="StaleElementReferenceError: el elemento no está adjunto al documento de la página"
  >
    ### Problema
  ...
  <Collapser
    id="task-timed-out"
    title="TaskTimedOut: la tarea agotó el tiempo de espera a que se ubique el elemento usando: <LOCATOR>"
  >
    ### Problema
  ...
  <Collapser
    ...
    title="TimeoutError: Se agotó el tiempo de carga de la página (no se pueden finalizar todas las solicitudes de red a tiempo)"
  >
    ### Problema
  ...
  <Collapser
    ...
    title="TypeError: $browser.isElementPresent no es una función"
  >
    ### Problema
...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="Error de sintaxis: token inesperado <"
  >
    ### Problema
  ...
  <Collapser
    ...
    title="Error de sintaxis: token u inesperado en JSON en la posición 0"
  >
    ### Problema
  ...
  <Collapser
    ...
    title="TypeError: no se puede leer la propiedad 'statusCode' de indefinido"
  >
    ### Problema

    El objeto de respuesta (y por lo tanto respuesta.statusCode) en una devolución de llamada de solicitud de API no está definido.
