...
<figcaption>
  La página <DoNotTranslate>**Summary**</DoNotTranslate> le brinda una vista de alto nivel del rendimiento de su sitio web y tiene accesos directos a verificaciones de ubicación, incidente de alerta y metadatos de su monitor.
</figcaption>

## Comprender la página Resumen [#understanding]

Utilice la página <DoNotTranslate>**Summary**</DoNotTranslate> para comprender el rendimiento de su sitio web:
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        Esto solo está disponible para <DoNotTranslate>**ping**</DoNotTranslate> resultados del monitor.
      </td>
    </tr>
...
La página <DoNotTranslate>**Summary**</DoNotTranslate> admite las siguientes funciones:
...
<table>
  ...
  <tbody>
    ...
    <tr id="hide-location">
      ...
      <td>
        Haga clic en <DoNotTranslate>**Run check button**</DoNotTranslate> para volver a verificar cualquier monitor fallido.
      </td>
    </tr>
...
<Callout variant="important">
  La siguiente tabla se aplica a la vista anterior de la página de resumen de monitoreo sintético. Haga clic en <DoNotTranslate>**Show new view**</DoNotTranslate> para acceder a una nueva experiencia de resumen seleccionada.
</Callout>
