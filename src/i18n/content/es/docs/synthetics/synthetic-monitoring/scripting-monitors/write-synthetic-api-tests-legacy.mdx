...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > Synthetic monitoring > Create monitor](https://one.newrelic.com/synthetics-nerdlets/monitor-create)**</DoNotTranslate>: El editor script sugiere funciones, selectores y otros elementos para simplificar [los comandos del script (disponibles en GitHub)](https://github.com/request/request).
</figcaption>
