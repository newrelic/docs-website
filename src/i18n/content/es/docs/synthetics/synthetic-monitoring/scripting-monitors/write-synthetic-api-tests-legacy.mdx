...
Consulte los \[ejemplos de tiempo de ejecución de API de Node 16.10 o posterior]\([Detalles para escribir scripts en el tiempo de ejecución Node 16.10](/docs/synthetics/synthetic-monitoring/scripting-monitors/write-synthetic-api-tests/) para crear monitores utilizando nuestros tiempos de ejecución de Synthetics más recientes.
...
<CollapserGroup>
  <Collapser id="use-agentOptions" title="Usando una opción SSL o agentOptions">
