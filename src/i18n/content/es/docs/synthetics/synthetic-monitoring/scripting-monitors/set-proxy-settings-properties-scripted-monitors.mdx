...
<CollapserGroup>
  ...
  >
    <Callout variant="tip">
      Este método es <DoNotTranslate>**Chrome-specific**</DoNotTranslate>: solo se aplica a los tipos de script de monitorización del browser. Se puede utilizar para permitir una configuración de proxy más flexible y compleja. En la mayoría de los casos, este método no será necesario.
    </Callout>
