...
Una vez completada la configuración, Inteligencia para costos en la nube accede automáticamente a sus datos de costos y uso desde su contenedor de almacenamiento de objetos designado. Este proceso comienza luego de otorgar las licencias de acceso necesarios. Tenga en cuenta que nuestro servicio solo puede recuperar reportes después de que se exportaron a su contenedor de almacenamiento. Cerciorar de que el prefijo de la ruta de la carpeta esté configurado como se describe en los [requisitos previos](/docs/cci/getting-started/prerequisites) y las instrucciones [de configuración](/docs/cci/getting-started/setup) respectivas.
