...
Consulta los datos de Cloud Cost Intelligence utilizando NRQL para analizar y optimizar el gasto en la nube. Hay tres tipos de eventos disponibles con atributos para consultas detalladas:
...
<CollapserGroup>
  <Collapser id="cloud-cost-attributes" title="atributo CloudCost">
    Navegue a **All Capabilities &gt; Cloud Cost Intelligence** y abra la consola de consultas para ingresar:
