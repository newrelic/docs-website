...
Consulta los datos de Inteligencia para costos en la nube utilizando NRQL para analizar y optimizar el gasto cloud. Hay cinco tipos de eventos disponibles con atributos para consultas detalladas:
...
<table>
  ...
  <tr>
    ...
    <td>
      Evento de costo, admite el lenguaje NRQL completo
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      Asignación de costos de Kubernetes, admite el lenguaje NRQL completo
    </td>
  </tr>
...
Navegue a <DNT>**All Capabilities &gt; Cloud Cost Intelligence**</DNT> y abra <DNT>**Query Console**</DNT> para ingresar sus consultas.
