...
<CollapserGroup>
  <Collapser id="state-select" title="A continuación se presentan las cláusulas necesarias que capturan el traductor de NRQL a SQL para los conceptos básicos de XDS.">
