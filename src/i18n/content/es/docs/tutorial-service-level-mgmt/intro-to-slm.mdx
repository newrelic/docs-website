---
title: Gestione la confiabilidad con nivel de servicio
...
Administración a nivel de servicio se aplica mejor a las prácticas de **tiempo de actividad, rendimiento y confiabilidad**, pero también se aplica a otras prácticas de **experiencia del cliente**, **innovación y crecimiento**, y **eficiencia operativa** ([obtenga más información sobre estas prácticas](/docs/new-relic-solutions/observability-maturity/introduction)). Independientemente del área que desee mejorar, el uso de SLM tiene dos áreas principales de impacto: resultados comerciales y resultados operativos.
...
## ¿Por qué utilizar administración a nivel de servicio? [#why-slm]
...
>
  Un [nivel de servicio](https://en.wikipedia.org/wiki/Service_level) mide el rendimiento de un sistema. Usted mide el nivel de servicio utilizando indicadores y comparándolos con un conjunto de objetivos para el rendimiento y los resultados esperados.
</Collapser>
...
>
  Un presupuesto de errores mide y comunica el cumplimiento de sus objetivos de nivel de servicio. Tenemos información más detallada sobre este método avanzado en nuestros [documentos de administración a nivel de servicio](/docs/service-level-management/intro-slm).
  ...
  **Referencias**
  ...
  Google define un presupuesto de error como:
  ...
  Atlassian define un presupuesto de error como:
...
* Tenga datos para monitor y establecer SLI, por ejemplo, a través de [la instrumentación APM](/docs/apm/new-relic-apm/getting-started/introduction-apm) de su aplicación principal.
* También puedes utilizar [la prueba sintética](/docs/synthetics/synthetic-monitoring/getting-started/get-started-synthetic-monitoring) de tu aplicación para generar datos para monitor sin depender de los clientes.
* Si bien no es obligatorio, le recomendamos encarecidamente que adquiera habilidades básicas con [el panel de New Relic y NRQL](https://learn.newrelic.com/webinar-getting-started-with-dashboards-nrql).

## ¿Qué hay en esta serie? [#the-series]
