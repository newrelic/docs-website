...
Hay [varios tipos de datos `Metric` ](/docs/data-apis/understand-data/metric-data/metric-data-type/#metric-types)(por ejemplo, `gauge` y `count`) y cada tipo tiene varios <DoNotTranslate>**fields**</DoNotTranslate> asociados. Para obtener detalles sobre los tipos de campos disponibles, consulte [`getField()`](/docs/query-your-data/nrql-new-relic-query-language/get-started/nrql-syntax-clauses-functions/#func-getfield).
