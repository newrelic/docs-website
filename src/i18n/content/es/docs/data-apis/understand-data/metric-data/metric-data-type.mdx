  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        Generalmente, querrá tomar el `rate` de `sum`:
    ...
    <tr>
      ...
      <td>
        Equivalente al tipo `count` descrito anteriormente, pero además esto da acceso a los campos de métrica acumulativa. Para obtener más información sobre esto, consulte [Métricas acumulativas](/docs/data-apis/understand-data/metric-data/cumulative-metrics).

        <Callout variant="important">
          Este tipo es un poco más grande que un `count` típico y, por lo tanto, puede aumentar la [ingesta de datos](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/data-ingest-billing).
        </Callout>
      </td>
