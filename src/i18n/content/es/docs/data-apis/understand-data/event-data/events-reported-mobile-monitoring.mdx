  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        Las excepciones serán visibles en la consulta de este evento y en la [página<DoNotTranslate>**Handled exceptions**</DoNotTranslate> UI ](/docs/mobile-monitoring/mobile-monitoring-ui/crashes/handled-exceptions-analyze-trends-prevent-crashes), incluido el rastreo del stack.
      </td>
    </tr>
