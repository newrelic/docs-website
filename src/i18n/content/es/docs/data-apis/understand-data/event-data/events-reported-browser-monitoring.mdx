...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        `UserAction` El evento se captura como resultado de una interacción del usuario con la aplicación sitio web. Este evento incluye información de acción y el identificador del objetivo DOM junto con varios atributos predeterminados, como la aplicación y los datos geográficos.
      </td>
    </tr>
  </tbody>
</table>
