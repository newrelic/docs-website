...
La pestaña <DoNotTranslate>**Data ingestion**</DoNotTranslate> se encuentra en la [UIusuario de administración de datos](/docs/data-apis/manage-data/manage-your-data). La UI de ingesta de datos muestra un resumen de su uso por fuente de datos. Para organizaciones con varias cuentas, también puede ver el uso de cuentas específicas.
...
<figcaption>
  En el [menú de usuario](/docs/accounts/accounts-billing/general-account-settings/intro-account-settings), seleccione <DoNotTranslate>**Manage your data**</DoNotTranslate>.
</figcaption>
...
Para ver la consulta NRQL subyacente utilizada para crear ese gráfico, haga clic en <DoNotTranslate>**View NRQL**</DoNotTranslate>.
...
<CollapserGroup>
  ...
  >
    ...
    * [Establezca puntuaciones Apdex adecuadas](/docs/apm/new-relic-apm/apdex/change-your-apdex-settings/), por ejemplo, para la frecuencia de traza.
  ...
  >
    ...
    * [Contexto de inicio de sesión automático](/docs/logs/logs-context/disable-automatic-logging): deshabilite o habilite a través de la UI o API, o ajuste la configuración del lado del cliente.
...
<CollapserGroup>
  <Collapser
    ...
    title="Métrica"
  >
    En el gráfico de ingesta de datos, <DoNotTranslate>**Metrics**</DoNotTranslate> es una combinación de dos tipos de métrica: [intervalo de tiempo de métrica data](/docs/data-apis/understand-data/new-relic-data-types/#timeslice-data) y [métrica dimensional](/docs/data-apis/understand-data/new-relic-data-types/#dimensional-metrics).
  ...
  >
    La actividad de seguimiento de cambios se almacena en el namespace <DoNotTranslate>**Deployment**</DoNotTranslate>. Los cambios individuales que usted rastrea tienen un promedio de alrededor de 200 a 250 bytes para su ingesta.
  </Collapser>
  ...
  <Collapser
    ...
    title="Seguridad"
  >
    Los eventos reportados por la característica de seguridad de New Relic se almacenan en el namespace <DoNotTranslate>**Security**</DoNotTranslate>. Estos son principalmente informes de vulnerabilidades proporcionados por la característica Gestión de vulnerabilidades, pero pueden ampliarse para incluir productos adicionales en el futuro.
    ...
    Las características de seguridad que aún se encuentran en versión preliminar pública utilizan un namespace <DoNotTranslate>**Security:Preview**</DoNotTranslate> separado y no son facturables.
