...
Puedes formar y realizar la llamada en el explorador de API de NerdGraph: <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com) > Apps > NerdGraph API explorer**</DoNotTranslate>.
...
* <DoNotTranslate>**Drop entire data types or a data subset**</DoNotTranslate> (con filtro opcional). Esto usa el tipo `DROP_DATA` <DoNotTranslate>**action**</DoNotTranslate> y usa NRQL del formulario:
...
* <DoNotTranslate>**Drop attributes from data types**</DoNotTranslate> (con filtro opcional). Esto usa el tipo `DROP_ATTRIBUTES` <DoNotTranslate>**action**</DoNotTranslate> y usa NRQL del formulario:
...
<DoNotTranslate>**Drop attributes from dimensional metrics rollups**</DoNotTranslate> (con filtro opcional). Esto usa el tipo `DROP_ATTRIBUTES_FROM_METRIC_AGGREGATES` <DoNotTranslate>**action**</DoNotTranslate> y usa NRQL del formulario:
