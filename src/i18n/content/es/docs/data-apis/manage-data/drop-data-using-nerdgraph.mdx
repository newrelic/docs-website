...
<Callout variant="important">
  Desde febrero de 2026, las reglas de descarte dirigidas a eventos de infraestructura en `SystemSample`, `ProcessSample`, `NetworkSample` y `StorageSample` también descartarán correctamente los datos agregados.
</Callout>
