...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <DoNotTranslate>**Required**</DoNotTranslate>. Debe ser `application/json`.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <DoNotTranslate>**Required.**</DoNotTranslate> Un <InlinePopover type="licenseKey"/>para la cuenta a la que desea informar datos. Si esto se proporciona como encabezado y parámetro de consulta, los valores deben coincidir.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <DoNotTranslate>**Required if GZIP.**</DoNotTranslate> El valor debe ser `GZIP` o `Identity.` Si no hay ningún valor presente, se supone `Identity` .
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <DoNotTranslate>**Optional - Reserved for future use.**</DoNotTranslate> El valor debe ser un `UUID4` válido. Se espera que el valor sea único para cada solicitud.
      </td>
    </tr>
  </tbody>
</table>
...
La carga útil debe estar codificada como <DoNotTranslate>**UTF-8**</DoNotTranslate>.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <DoNotTranslate>**Required**</DoNotTranslate>. El nombre de la métrica. El valor debe tener menos de 255 caracteres.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <DoNotTranslate>**Required**</DoNotTranslate>. El valor varía según el [tipo de métrica](/docs/telemetry-data-platform/ingest-manage-data/understand-data/metric-data-type). Para `gauge` y `count` el valor debe ser un único número. Para `summary`, el valor debe ser un mapa con pares principales de valor que especifiquen el recuento, la suma, el mínimo y el máximo.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <DoNotTranslate>**Required for `count` and `summary` [metric types](/docs/telemetry-data-platform/ingest-manage-data/understand-data/metric-data-type)**</DoNotTranslate>. La duración de la ventana de tiempo.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <DoNotTranslate>**Recommended**</DoNotTranslate>. Este debería ser uno de los [tipos métricos admitidos](/docs/telemetry-data-platform/ingest-manage-data/understand-data/metric-data-type). Si no especifica un tipo, el valor predeterminado será `gauge`.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <DoNotTranslate>**Recommended**</DoNotTranslate>. Un mapa de pares de valores principales asociados con esta métrica específica. Los valores pueden ser cadenas, números JSON o booleanos. Las claves distinguen entre mayúsculas y minúsculas y deben tener menos de 255 caracteres.
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <DoNotTranslate>**Required for `count` and `summary`.**</DoNotTranslate>La duración de la ventana de tiempo.
      </td>
    </tr>
