...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Tiene servidores Prometheus que reportan demasiadas series temporales únicas a través [del extremo remote\_write de New Relic](/docs/integrations/prometheus-integrations/get-started/monitor-prometheus-new-relic#remote-write).

        Reduzca el número de series de tiempo únicas reportadas modificando su [configuración del servidor Prometheus](https://prometheus.io/docs/prometheus/latest/configuration/configuration/) para reducir el número de objetivos que se recopilan, o utilizando [reglas de reetiquetado](https://prometheus.io/docs/prometheus/latest/configuration/configuration/#relabel_config) en la [sección remote\_write](https://prometheus.io/docs/prometheus/latest/configuration/configuration/#remote_write) de la configuración de su servidor para descartar series de tiempo o etiquetas altamente únicas.
      </td>
    </tr>
...
1. Asegúrese de tener una [clave de consulta API con Insights](/docs/insights/insights-api/get-data/query-insights-event-data-api) (vaya a <DNT>**[one.newrelic.com/api-keys](https://one.newrelic.com/api-keys)**</DNT>).
