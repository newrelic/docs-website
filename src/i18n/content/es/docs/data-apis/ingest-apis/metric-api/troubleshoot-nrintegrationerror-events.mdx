...
1. Asegúrese de tener una [clave de consulta API con información valiosa](/docs/insights/insights-api/get-data/query-insights-event-data-api) (vaya a <DoNotTranslate>**[insights.newrelic.com](https://insights.newrelic.com) > Manage data > API keys**</DoNotTranslate>).
