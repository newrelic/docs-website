...
* Una New Relic <InlinePopover type="licenseKey" />para la cuenta a la que desea informar datos.
...
* Para EE. UU. (predeterminado), `https://security-api.newrelic.com/security/v1`
* Para la UE, `https://security-api.service.eu.newrelic.com/security/v1`
* Para JP, `https://security-api.service.jp.newrelic.com/security/v1`
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Un identificador único para una entidad específica dentro de la plataforma New Relic, esencial para rastrear y administrar aplicaciones, servicios o componentes de infraestructura.

        Un ejemplo de `entityGuid` sería:
