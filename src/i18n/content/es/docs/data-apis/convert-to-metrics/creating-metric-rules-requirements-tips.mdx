  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <DoNotTranslate>**Example:**</DoNotTranslate> Si desea crear una métrica denominada `foo.count` que cuente la transacción denominada `foo`, el NRQL se vería así:
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <DoNotTranslate>**Example:**</DoNotTranslate> Si incluyera la zona de disponibilidad en el nombre de su métrica, significaría que, para esa métrica, no podría ver los resultados en todas las zonas de disponibilidad.
      </td>
    </tr>
