...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Tamaño o longitud máxima total: <DoNotTranslate>**1MB (10^6 bytes) maximum per POST**</DoNotTranslate>. Recomendamos encarecidamente utilizar compresión.
    ...
    <tr>
      ...
      <td>
        ...
        * Para evento enviado vía agente: 255 caracteres
          ...
          Atributo total máximo por evento: 254. <DoNotTranslate>**Exception:**</DoNotTranslate> Si utiliza una API de agente APM, el máximo es 64.
