...
Estos son los servicios de extremo de New Relic disponibles a través de AWS PrivateLink. Los extremos de EE. UU. (predeterminados) se dividen en tres zonas de disponibilidad de AWS (us-east-1, us-east-2, us-west-2), que se muestran como pestañas separadas a continuación:
...
<Tabs>
  ...
  <TabsPages>
    ...
    <TabsPageItem id="jp-endpoints">
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              `synthetics-horde.jp.nr-data.net`
            </td>
      ...
      <Callout variant="important">
        Los servicios de extremo para `identity-api.jp.newrelic.com`, `infrastructure-command-api.jp.newrelic.com` y `synthetics-horde.jp.nr-data.net` no tienen nombres privados de DNS asociados.
...
### Extremos PrivateLink de FedRAMP [#fedramp]

Para obtener información sobre los extremos PrivateLink compatibles con FedRAMP, consulte [Conectividad de AWS PrivateLink](/docs/security/security-privacy/compliance/fedramp-compliant-endpoints#privatelink) en nuestra guía de FedRAMP.
