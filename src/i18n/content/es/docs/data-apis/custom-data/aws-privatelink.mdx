  ...
  <TabsPages>
    <TabsPageItem id="us-endpoints">
      ...
      <Callout variant="important">
        Revise las siguientes restricciones al configurar `identity-api.newrelic.com` y `infrastructure-command-api.newrelic.com` nombre de host:
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Seleccione <DoNotTranslate>**Other endpoint services**</DoNotTranslate>.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Para <DoNotTranslate>**Service name**</DoNotTranslate>, busque el valor en la tabla y haga clic en <DoNotTranslate>**Verify**</DoNotTranslate>.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Seleccione las zonas. Para <DoNotTranslate>**IP address type**</DoNotTranslate>, seleccione <DoNotTranslate>**IPv4**</DoNotTranslate>.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Seleccione el <DoNotTranslate>**Group ID**</DoNotTranslate>.
      </td>
    </tr>
