...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > [(user menu)](/docs/accounts/accounts-billing/general-account-settings/intro-account-settings) > Account settings > Partnerships**</DoNotTranslate>: Los propietarios de asociaciones pueden acceder a la consola de administración de asociaciones desde la configuración de su cuenta en la New Relic UI.
</figcaption>
...
Para ver la actividad de un cliente que no aparece en ninguna de las vistas filtradas: Vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > [(user menu)](/docs/accounts/accounts-billing/general-account-settings/intro-account-settings) > Switch accounts > Other accounts**</DoNotTranslate>.
