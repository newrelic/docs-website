  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <DoNotTranslate>**Example without email:**</DoNotTranslate> "12345:MiSecreto:0987654321"

        Usando la sintaxis de Ruby: `"#{account_id}:#{secret}:#{timestamp}"`

        <DoNotTranslate>**Example with email:**</DoNotTranslate> "12345:MiSecreto:0987654321:[usuario@host.com](mailto:user@host.com)"
