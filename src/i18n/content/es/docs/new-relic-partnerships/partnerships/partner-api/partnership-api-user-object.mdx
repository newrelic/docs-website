...
<CollapserGroup>
  ...
  <Collapser id="attr-owner" title="dueño">
    <table>
      <tbody>
        <tr>
          <th>
...
Antes de emplear esta API, lea los [requisitos](/docs/new-relic-partnerships/partner-integration-guide/partner-account-maintenance/partner-api/).
...
<CollapserGroup>
  <Collapser id="request-example" title="Solicitud JSON de objeto de usuario">
    ```
    {
      "users": [
        {
  ...
  <Collapser id="response-example" title="Respuesta JSON">
...
<CollapserGroup>
  ...
  <Collapser id="example-update" title="Actualizar">
  ...
  <Collapser id="example-delete" title="Borrar">
    Pedido:
