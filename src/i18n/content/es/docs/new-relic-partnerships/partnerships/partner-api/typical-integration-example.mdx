...
<DNT>**Recommendation:**</DNT> Inicie nuevos proyectos consultando [Introducción a la API](/docs/apm/apis/requirements/new-relic-rest-api-v2-getting-started) y los [ejemplos de New Relic REST API v2](/docs/apis/rest-api-v2). Además, comience a migrar cualquiera de sus scripts API v1 a su equivalente v2.
