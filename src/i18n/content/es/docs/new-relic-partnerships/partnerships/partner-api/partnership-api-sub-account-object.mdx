...
Antes de emplear la API de asociación, primero lea [los requisitos](/docs/new-relic-partnerships/partner-integration-guide/partner-account-maintenance/partner-api/).

Estos son los atributos del objeto de cuenta secundaria API de asociación:

<CollapserGroup>
  <Collapser id="attr-name" title="Nombre (requerido)">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser id="attr-testing" title="pruebas">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser id="attr-users" title="usuario (REQUERIDO para algunas cuentas)">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser id="attr-subscriptions" title="Se requiere contraseña)">
    <table>
      <tbody>
        <tr>
          <th>
    ...
    Si está creando una cuenta infantil con un usuario existente como cuenta `Owner`, la contraseña *debe* coincidir con la contraseña actual del usuario.
  </Collapser>
</CollapserGroup>
...
Tenga en cuenta que esto es solo un ejemplo y que, para algunas cuentas, el [atributo`users` ](#account-attributes)no es necesario y se ignorará.

<CollapserGroup>
  <Collapser id="account-request" title="Solicitud JSON de objeto de cuenta infantil">
    ```
    {
      "sub_account": {
  ...
  <Collapser id="account-request" title="Respuesta JSON">
    ```
    {
      "id": XXXXXX,
      "name": "Sample Account",
...
<CollapserGroup>
  <Collapser id="example-create" title="Crear">
    Pedido:
