...
La API de asociación no le permite actualizar o degradar la suscripción de un producto individual para una cuenta. En cambio, la API requiere que reemplace ([agregue](#example-create)) la configuración de suscripción del producto <DNT>**all**</DNT> para la cuenta.
...
<CollapserGroup>
  ...
  >
    ...
    El atributo [`product ID`](#api-product-mapping) identifica el producto New Relic que se define para esta suscripción. Es <DNT>**required**</DNT> para <DNT>**Create**</DNT> llamadas.
  </Collapser>
  ...
  >
    ...
    El atributo `quantity` es <DNT>**required**</DNT> para <DNT>**Create**</DNT> llamadas, incluso si el nivel de un producto es ilimitado. La API ignorará el valor de cantidad ingresado para la suscripción ilimitada de productos, como New Relic APM Lite.
  ...
  >
    ...
    Aún no es compatible a través de la suscripción extrema de Partnership API. Sin embargo, puede pasar el `promo_code` como parte de la suscripción con la [llamada <DNT>**Create**</DNT> de la API de la cuenta](/docs/accounts-partnerships/partnerships/partner-api/partner-api-account-object).
  </Collapser>
...
<Callout variant="important">
  Los nuevos planes de servicio <DNT>**Startup**</DNT> y <DNT>**Small Business**</DNT> ya no están disponibles a través de la API de asociación de New Relic.
</Callout>
...
<CollapserGroup>
  ...
  >
    ...
    Además, el precio y la retención de datos dependen de si selecciona modelos de precios basados en hosts o unidades de computación (CU). Utilice el formato <DNT>**integer**</DNT> del ID del producto para identificar el nivel de suscripción y el tipo de plan.
    ...
    Si selecciona planes de precios basados en la unidad de computación (CU), utilice estos formatos de ID de producto <DNT>**integer**</DNT> para identificar el nivel de suscripción y el tipo de plan.
  ...
  <Collapser
    ...
    title="Móvil"
  >
    La estructura de precios de New Relic Mobile permite 100.000 usuarios activos mensuales por cuenta en el nivel de suscripción Enterprise. La retención de datos varía según el nivel de suscripción. Utilice el formato <DNT>**integer**</DNT> del ID del producto para identificar el nivel de suscripción.
  ...
  >
    ...
    * El precio de la cuenta Pro comienza en 500.000 páginas vistas por mes y tres meses de retención de datos.
      ...
      Utilice el formato <DNT>**integer**</DNT> del ID del producto para identificar el nivel de suscripción.
  ...
  <Collapser
    ...
    title="Sintético"
  >
    Con la estructura de precios del monitoreo sintético, la cantidad predeterminada de verificaciones de monitoreo permitidas y el período de retención de datos varían según el nivel de suscripción. Utilice el formato <DNT>**integer**</DNT> del ID del producto para identificar el nivel de suscripción.
  ...
  >
    ...
    New Relic Infrastructure ofrece planes de precios basados únicamente en unidades de computación (CU). Utilice el formato <DNT>**integer**</DNT> del ID del producto para identificar el nivel de suscripción.
...
<table>
  ...
  <tbody>
    <tr>
      <td>
        <DNT>**List**</DNT> (índice) todas las suscripciones de una cuenta.
      </td>
    ...
    <tr>
      <td>
        <DNT>**Show**</DNT> una suscripción para una cuenta.
      </td>
    ...
    <tr>
      <td>
        <DNT>**Replace**</DNT> el nivel de suscripción actual con una nueva suscripción.
      </td>
