...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Un resumen de lo que se incluyó en este cambio que está visible en la página <DoNotTranslate>**Change tracking**</DoNotTranslate>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        El SHA de confirmación para este cambio que es visible en la página <DoNotTranslate>**Change tracking**</DoNotTranslate>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Una descripción de alto nivel de este cambio, visible en la página <DoNotTranslate>**Overview**</DoNotTranslate> y en la página <DoNotTranslate>**Change tracking**</DoNotTranslate> cuando selecciona un cambio individual.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Un nombre de usuario para asociar con el cambio que es visible en las páginas <DoNotTranslate>**Overview**</DoNotTranslate> y <DoNotTranslate>**Deployments**</DoNotTranslate>
      </td>
    </tr>
  </tbody>
</table>
...
Consulta la página [del marcador de despliegue de la aplicación New Relic](https://github.com/marketplace/actions/new-relic-application-deployment-marker) y haz clic en el botón <DoNotTranslate>**Use latest version**</DoNotTranslate> para asegurarte de utilizar la última versión disponible.
...
> _Además de `NEW_RELIC_API_KEY`, este ejemplo muestra cómo segmentar varios elementos almacenando varios secretos como "`NEW_RELIC_DEPLOYMENT_ENTITY_GUID_<ID>`", donde `<ID>` es el identificador único del elemento de destino._
