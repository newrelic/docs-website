...
2. Busque
   ...
   <DoNotTranslate>**New Relic Alerts**</DoNotTranslate>
...
6. Desplácese hacia abajo hasta la sección
   ...
   <DoNotTranslate>**Webhook URL**</DoNotTranslate>

   y haga clic en

   <DoNotTranslate>**Copy URL**</DoNotTranslate>
...
1. Vaya a la pantalla de configuración de notificación desplegable:
   ...
   <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/) > (user menu) > Administration > Integrations > Deploy notifications**</DoNotTranslate>
...
3. Haga clic en
   ...
   <DoNotTranslate>**Send a test request**</DoNotTranslate>
...
4. En
   ...
   <DoNotTranslate>**Toggle this webhook**</DoNotTranslate>
...
5. Para eliminar permanentemente la configuración de notificación del webhook, haga clic en
   ...
   <DoNotTranslate>**Delete this webhook**</DoNotTranslate>
