---
title: Seguimiento de cambios mediante la CLI
tags:
  - APM
  - APM UI pages
  - Events
...
Si bien puede designar qué cambios desea monitor usando GraphQL o una integración CI/CD, también puede usar nuestra CLI para hacer lo mismo. Si utiliza la CLI para designar los cambios que desea monitor, puede ejecutar una [consulta GraphQL](#list-with-graphql) o ejecutar una [consulta NRQL](/docs/change-tracking/change-tracking-graphql#key-signals) en la base de datos New Relic para recuperar una lista de esos cambios.
...
## Instale la CLI [#install-cli]

Tenemos una nueva versión de [la CLI](/docs/new-relic-solutions/tutorials/new-relic-cli) que le permite enviar mutaciones GraphQL para crear marcadores. Incluso si ha estado usando la CLI, deberá actualizarla para aprovechar esta característica.

Siga los pasos [aquí](https://github.com/newrelic/newrelic-cli#installation--upgrades) para instalar o actualizar la CLI.

## Hacer un marcador de cambio con la CLI [#make-marker-cli]
