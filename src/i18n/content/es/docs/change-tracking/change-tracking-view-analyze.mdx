...
* <DoNotTranslate>**Charts in APM and dashboards:**</DoNotTranslate> En los gráficos de series temporales aparece una línea vertical con la cabeza de un alfiler. Este marcador representa el cambio registrado y, si hace clic en la cabeza del alfiler, puede comenzar a profundizar en el impacto que tuvo el cambio en la salud y la calidad de la entidad.
...
* <DoNotTranslate>**Activity stream component:**</DoNotTranslate> Puede ver los cambios registrados en el feed de actividades en el panel plegable derecho en varias páginas de la UI de New Relic.
...
Cuando haces clic en un cambio del que estás realizando un seguimiento en New Relic, como en un gráfico o en la página <DoNotTranslate>**Issues**</DoNotTranslate> , abrirás una página <DoNotTranslate>**Change details**</DoNotTranslate> . Contiene los datos que envió cuando registró el cambio más una gran cantidad de información sobre su impacto.
...
<figcaption>
  La página <DoNotTranslate>**Change details**</DoNotTranslate> .
</figcaption>
...
* Un enlace (<DoNotTranslate>**See all changes on this entity**</DoNotTranslate>) a una página que contiene la página de lista desplegable filtrada para esta entidad. Úselo para alejar rápidamente y ver todos los cambios recientes en esta parte de su sistema.
...
La página <DoNotTranslate>**Change details**</DoNotTranslate> se basa en la idea de que los registros y señales generados durante un período de tiempo previo a este cambio se comparan con un período de igual duración después de este cambio. Puedes cambiar la duración de ese período usando un selector de tiempo en la esquina superior derecha. Tenga en cuenta que esto afectará tanto a los gráficos de series temporales como a otros elementos UI característicos impulsados por datos información valiosa.
...
Junto al selector de tiempo en la esquina superior derecha de la página <DoNotTranslate>**Change details**</DoNotTranslate> , verá <DoNotTranslate>**compared with**</DoNotTranslate> junto a un menú desplegable. Usando ese menú desplegable, puede seleccionar otro cambio registrado. Esto cambiará la página a un modo comparativo.
...
A diferencia de los gráficos dashboard normal, estos paneles de tendencias personalizados son gráficos que están completamente integrados con la ventana de tiempo y la configuración <DoNotTranslate>**compared with**</DoNotTranslate> en la página <DoNotTranslate>**Change details**</DoNotTranslate>. Incluso puede exportarlos al panel de control y todos están vinculados a una entidad específica y a su cuenta de usuario.
...
Con el seguimiento de cambios, puede ver detalles sobre cómo las transacciones web se vieron afectadas por un cambio en la aplicación APM. Cuando realice un seguimiento de los cambios en la aplicación APM, verá el encabezado <DoNotTranslate>**Web transaction impacts**</DoNotTranslate>. La tabla de esta sección muestra indicadores de rendimiento para hasta diez de las transacciones web que más tiempo consumen de la aplicación:
