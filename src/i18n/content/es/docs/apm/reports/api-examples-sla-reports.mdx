...
Las métricas del navegador para el [nivel](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#tier) <DoNotTranslate>**End user**</DoNotTranslate> están disponibles solo si ha [instalado el agente <InlinePopover type="browser"/>](/docs/browser/new-relic-browser/getting-started/browser-settings).
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <DoNotTranslate>**Recommendation:**</DoNotTranslate> Para evitar una serie de ceros, divida este número de manera adecuada para sus propios fines.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        * Transacción que no esté en una de esas categorías, en caso de que la carga de la página no se complete por algún motivo
          ...
          Esta es la razón por la que hay menos (a veces muchas menos) páginas vistas en la sección <DoNotTranslate>**End User**</DoNotTranslate> (datos del navegador) que en la sección de datos <DoNotTranslate>**App server**</DoNotTranslate> .
      </td>
    </tr>
  </tbody>
</table>
