...
<CollapserGroup>
  ...
  >
    ...
    <figcaption>
      <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & services > (select an app) > Monitor > Databases > (select a trace) > Trace details:**</DoNotTranslate> Para ver información sobre una base de datos y una instancia específicas que pueden estar contribuyendo al problema de rendimiento de una aplicación, seleccione el icono <DoNotTranslate>**Database**</DoNotTranslate> .
    </figcaption>
  </Collapser>
