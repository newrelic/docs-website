...
* Los ejemplos usan `X-Api-Key` que se puede usar para una
  ...
  <a href="/docs/apis/intro-apis/new-relic-api-keys/#user-api-key">clave de usuario</a>

  o una

  <a href="/docs/apis/intro-apis/new-relic-api-keys/#rest-api-key">clave de API REST</a>
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            <DoNotTranslate>**Required**</DoNotTranslate>. Un ID único para este despliegue, visible en la página [Resumen](/docs/apm/applications-menu/monitoring/apm-overview-page) y en la página [de despliegue](/docs/apm/applications-menu/events/deployments-page) . Puede ser cualquier cadena, pero suele ser un número de versión o una suma de comprobación de Git.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**Optional**</DoNotTranslate>. Un resumen de lo que cambió en este despliegue, visible en la página [de despliegue](/docs/apm/applications-menu/events/deployments-page) cuando seleccionas <DoNotTranslate>**(selected deployment) > Change log**</DoNotTranslate>.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**Optional**</DoNotTranslate>. Una descripción de alto nivel de este despliegue, visible en la página [Resumen](/docs/apm/applications-menu/monitoring/apm-overview-page) y en la página [de despliegue](/docs/apm/applications-menu/events/deployments-page) cuando selecciona un despliegue individual.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**Optional**</DoNotTranslate>. Un nombre de usuario para asociar con el despliegue, visible en la página [Resumen](/docs/apm/applications-menu/monitoring/apm-overview-page) y en la página [de despliegue](/docs/apm/applications-menu/events/deployments-page) .
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**Optional**</DoNotTranslate>. Cuando se produjo el despliegue, hasta el segundo. Si no se especifica, el despliegue se registrará en el momento en que se recibió la llamada API. requisitos timestamp :
