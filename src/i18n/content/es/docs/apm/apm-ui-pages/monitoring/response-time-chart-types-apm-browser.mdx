...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Si el tiempo de respuesta es <DoNotTranslate>**less than**</DoNotTranslate> el tiempo total empleado, está aprovechando la simultaneidad con un modelo informático asincrónico o sin bloqueo.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Si el tiempo de respuesta es <DoNotTranslate>**equal to**</DoNotTranslate> el tiempo total empleado, es posible que esté utilizando un modelo informático síncrono o de bloqueo.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Si el tiempo de respuesta es <DoNotTranslate>**greater than**</DoNotTranslate> el tiempo total invertido, esto puede deberse a una contención de recursos. Por ejemplo, si el trabajo de respuesta se ejecuta en un grupo de subprocesos muy competitivo, otros trabajos deben finalizar antes de que se pueda completar la respuesta. (El agente no realiza un seguimiento del tiempo dedicado a esperar recursos).
      </td>
    </tr>
  </tbody>
</table>
