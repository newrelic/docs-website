...
La característica de servicios externos está disponible en el panel de navegación izquierdo una vez que selecciona un servicio de monitor APM. Puedes abrirlo yendo a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & Services**</DoNotTranslate>. Seleccione una aplicación y luego, en la sección <DoNotTranslate>**Monitor**</DoNotTranslate> , haga clic en <DoNotTranslate>**External services**</DoNotTranslate>.

## El mapa de servicios exteriores [#use-the-map]

El mapa de apertura muestra el servicio seleccionado como un vértice (forma hexagonal) con rectángulos alrededor de los servicios ascendentes o descendentes. La vista inicial es el servicio descendente, por lo que la pestaña <DoNotTranslate>**Downstream entities**</DoNotTranslate> está seleccionada de forma predeterminada. Cuando está en esa pestaña, los gráficos de rendimiento (<DoNotTranslate>**Response time**</DoNotTranslate>, <DoNotTranslate>**Throughput**</DoNotTranslate> y <DoNotTranslate>**Error rate**</DoNotTranslate>) se aplican a los servicios posteriores. Puede hacer clic en <DoNotTranslate>**Upstream entities**</DoNotTranslate> para cambiar a esos gráficos de rendimiento.
...
Como complemento de la vista de mapa, la vista de tabla enumera todos los servicios relacionados en formato de columnas. Cuando hace clic en <DoNotTranslate>**List**</DoNotTranslate> en la parte superior derecha de la página, ve los mismos servicios en la vista del mapa:
...
De manera similar a la vista del mapa, puede hacer clic en una entidad (servicios) específica para ver la transacción en las tablas desglosadas. A medida que profundizas y encuentras un extremo interesante, puedes hacer clic en <DoNotTranslate>**Traces**</DoNotTranslate> para cambiar a los detalles del rastreo distribuido.

A la derecha de cada columna de rendimiento hay una columna <DoNotTranslate>**% change**</DoNotTranslate> (cambio porcentual) correspondiente. El cálculo del cambio porcentual se basa en el período de tiempo que elija en el selector de tiempo principal y en el selector de tiempo de comparación (<DoNotTranslate>**Compare to**</DoNotTranslate>). El selector de tiempo de comparación indica cuánto antes de la ventana de tiempo principal debe comenzar la comparación.

Aquí hay un ejemplo con <DoNotTranslate>**Response time**</DoNotTranslate>: si la hora actual son las 11 a. m. y el selector de tiempo principal es <DoNotTranslate>**last 30 minutes**</DoNotTranslate> y el selector de tiempo <DoNotTranslate>**Compare to**</DoNotTranslate> es <DoNotTranslate>**1 hour ago**</DoNotTranslate>:
