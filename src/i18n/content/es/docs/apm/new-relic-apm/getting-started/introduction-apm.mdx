...
Monitor el estado básico de su aplicación en el momento en que New Relic reciba datos de su aplicación. Verá <InlinePopover type="dashboards"/>básico en la página <DoNotTranslate>**APM Summary**</DoNotTranslate> de la UI de New Relic, que puede utilizar para comprender rápidamente el rendimiento de su aplicación sin ninguna personalización.
