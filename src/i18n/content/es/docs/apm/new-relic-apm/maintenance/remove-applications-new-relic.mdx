...
<CollapserGroup>
  ...
  >
    Si tiene varios datos de informes de agentes bajo el mismo nombre UI , debe asegurarse de desactivar o desinstalar <DoNotTranslate>**all**</DoNotTranslate> del agente asociado con esa entidad.
  </Collapser>
  ...
  >
    ...
    1. Desde <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DoNotTranslate>, seleccione <DoNotTranslate>**APM**</DoNotTranslate> y luego seleccione una aplicación.

    2. Desplácese hacia abajo hasta <DoNotTranslate>**Settings**</DoNotTranslate> y seleccione <DoNotTranslate>**Application.**</DoNotTranslate>

    3. Compare el nombre en el campo <DoNotTranslate>**Application alias**</DoNotTranslate> con el nombre en el mensaje <DoNotTranslate>**Your application still reports as**</DoNotTranslate> directamente debajo de él.

       Para obtener información del host sobre una aplicación con la que no está familiarizado:

    4. Desde <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DoNotTranslate>, seleccione <DoNotTranslate>**APM**</DoNotTranslate> y luego seleccione una aplicación.

    5. Desde la vista de resumen, revise la lista <DoNotTranslate>**Servers**</DoNotTranslate> .
