...
El módulo <DoNotTranslate>**mod_headers**</DoNotTranslate> de Apache incluye una variable `%t` que tiene el formato correcto. Para habilitar los informes de la cola de solicitudes, agregue este código a su configuración de Apache:
