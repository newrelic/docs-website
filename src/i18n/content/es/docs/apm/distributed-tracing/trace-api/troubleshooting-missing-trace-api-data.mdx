...
* Si sus intervalos tienen una marca de tiempo, asegúrese de que cumplan con las siguientes pautas:
  ...
  * Los timestamp de los spans deben haber ocurrido en las últimas 24 horas.
  * `newrelic`La marca de tiempo en formato debe estar en <DNT>**milliseconds**</DNT>. Puede obtener la hora actual en milisegundos en [currentmillis.com](https://currentmillis.com).
  * `zipkin`La marca de tiempo en formato debe estar en <DNT>**microseconds**</DNT>.
