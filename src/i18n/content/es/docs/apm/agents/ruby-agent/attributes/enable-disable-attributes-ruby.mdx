...
<CollapserGroup>
  ...
  >
    ...
    <DoNotTranslate>**Note:**</DoNotTranslate> Todos los atributos de usuario están predeterminados en `true`. Sin embargo, de forma predeterminada, los parámetros de solicitud están deshabilitados para todos los destinos.
