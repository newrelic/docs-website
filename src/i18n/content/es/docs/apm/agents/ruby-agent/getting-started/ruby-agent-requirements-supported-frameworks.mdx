...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Ruby 2.5.x, 2.4.x: Último soporte completo por el agente v9.24.0. <br />Ruby 2.3.x, 2.2.x: Último soporte completo por el agente v8.16.0. <br />Ruby 2.1.x, 2.0.x: Último soporte completo por el agente v6.15.0. <br />Ruby 1.9.3: Último agente v3.18.1. <br />Ruby 1.8.7: Último agente v3.18.1.
      </td>
    </tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Excon \{&apos;&lt;&apos;} 0.55.0: Último soporte completo por el agente v8.16.0.
      </td>
    </tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Soporte para reenvío de logs de APM. También compatible con `rails_semantic_logger`.
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        El contexto se propagará correctamente desde los procesos hijos bifurcados de regreso al proceso padre.
      </td>
    </tr>
...
Si tiene preguntas sobre versiones o bibliotecas específicas que no se incluyen aquí, visite nuestro [foro de la comunidad Explorers Hub](https://support.newrelic.com/).
