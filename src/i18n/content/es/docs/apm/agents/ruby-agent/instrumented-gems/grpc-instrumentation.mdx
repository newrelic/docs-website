...
En la UI [página Resumen](/docs/apm/applications-menu/monitoring/apm-overview-page), las solicitudes de los clientes de gRPC aparecen como transacciones web y aportan datos a los siguientes gráficos: <DoNotTranslate>**Web transactions time**</DoNotTranslate>, <DoNotTranslate>**Throughput**</DoNotTranslate> y <DoNotTranslate>**Error rate**</DoNotTranslate>.
...
En el caso de una excepción de Ruby basada en gRPC, la información sobre la excepción aparecerá en la página <DoNotTranslate>**Events > Errors**</DoNotTranslate> .
