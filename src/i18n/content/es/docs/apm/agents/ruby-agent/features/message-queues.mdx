...
La UI de APM muestra la transacción iniciada a través de la recepción de mensajes de RabbitMQ (suscripción/consumo de mensajes) como <DoNotTranslate>**Message**</DoNotTranslate> tareas en segundo plano. La creación de mensajes a través de RabbitMQ también aparece en la traza de la transacción.
...
<CollapserGroup>
  ...
  >
    La página <DoNotTranslate>**Transaction trace**</DoNotTranslate> incluye una pestaña dedicada <DoNotTranslate>**Details**</DoNotTranslate> que muestra información más detallada sobre la transacción. Aquí hay un ejemplo:
