...
<Callout variant="caution">
  El modo de desarrolladores es <DoNotTranslate>**deprecated**</DoNotTranslate> y ya no se admite a partir de [la versión 4.1.0 del agente Ruby](/docs/release-notes/agent-release-notes/ruby-release-notes/ruby-agent-410333).
</Callout>
...
<Callout variant="caution">
  Si está utilizando Passenger, Unicorn u otros servidores de aplicaciones bifurcados en su escritorio, puede notar algún comportamiento extraño con datos que desaparecen si su servidor de aplicaciones lanza varias instancias. Consulte los <DoNotTranslate>**Troubleshooting**</DoNotTranslate> consejos que aparecen a continuación.
</Callout>
