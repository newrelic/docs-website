...
<Callout variant="important">
  Si está utilizando el agente en un contenedor docker , instale el contenedor del agente <DoNotTranslate>**within each**</DoNotTranslate>.
</Callout>
   ...
   <table>
     ...
     <tbody>
       <tr>
         ...
         <td>
           * <DoNotTranslate>**Rails**</DoNotTranslate>: Rails llamará automáticamente `Bundler.require` y hará que se requiera `newrelic_rpm` durante el inicio de su aplicación.

           * <DoNotTranslate>**Roda, Sinatra**</DoNotTranslate>: Si está utilizando Roda, Sinatra u otro framework, debe llamar manualmente a `require 'newrelic_rpm'`. Además, si utiliza Infinite Tracing, llame manualmente a `require 'newrelic/infinite_tracing'`.
