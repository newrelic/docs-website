...
<CollapserGroup>
  ...
  >
    ...
    * Vistas de página (<InlinePopover type="browser"/>): no disponible
      ...
      <DoNotTranslate>**Note:**</DoNotTranslate> El atributo `httpResponseCode` (valor de cadena) está obsoleto a partir de la versión 6.12.0 del agente. En su lugar, se debe utilizar `http.statusCode` (valor entero).
  </Collapser>
  ...
  >
    ...
    * Vistas de página (monitoreo de navegador): No disponible
      ...
      <DoNotTranslate>**Note:**</DoNotTranslate> La propiedad `resque.capture_params` está en desuso. Sin embargo, si se establece en `true`, permitirá la captura de argumentos de Resque para errores de traza de la transacción y traza.
  </Collapser>
  ...
  >
    ...
    * Vistas de página (monitoreo de navegador): No disponible
      ...
      <DoNotTranslate>**Note:**</DoNotTranslate> La propiedad `sidekiq.capture_params` está en desuso. Sin embargo, si se establece en `true`, permitirá la captura de argumentos de Sidekiq para errores de traza de la transacción y de traza.
  </Collapser>
</CollapserGroup>
...
Al actualizar al agente Ruby <DoNotTranslate>**3.12.0**</DoNotTranslate> o superior, actualice su configuración <DoNotTranslate>**newrelic.yml**</DoNotTranslate> .