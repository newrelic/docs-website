...
Si está utilizando una versión del agente Ruby <DoNotTranslate>**prior to 3.8.0**</DoNotTranslate> con Unicorn, deberá realizar una de las siguientes acciones para obtener informes de datos:
