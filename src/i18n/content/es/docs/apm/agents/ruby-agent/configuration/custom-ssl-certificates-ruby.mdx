...
Especifique una ruta a un archivo <DoNotTranslate>**.pem**</DoNotTranslate> que contenga cada certificado que desee que utilice el agente al validar la identidad del proxy o servidor. Puede concatenar varios certificados en un único archivo <DoNotTranslate>**.pem**</DoNotTranslate> .

* <DoNotTranslate>**Relative path:**</DoNotTranslate>
...
* <DoNotTranslate>**Absolute path:**</DoNotTranslate>
