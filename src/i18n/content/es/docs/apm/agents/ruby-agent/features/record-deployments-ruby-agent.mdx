...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        La revisión registrada para el despliegue. <DoNotTranslate>**Recommendation:**</DoNotTranslate> Si utiliza Subversion, considere incluir la etiqueta o el nombre de la rama además de la revisión.
      </td>
    </tr>
