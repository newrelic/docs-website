...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Ver `Tracer.start_datastore_segment()`. Usted <DoNotTranslate>**must**</DoNotTranslate> llama `finish` en el objeto devuelto por este método.
      </td>
    </tr>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Utilice `Tracer.start_external_segment()`. Usted <DoNotTranslate>**must**</DoNotTranslate> llama `finish` en el objeto devuelto por este método.
      </td>
    </tr>
