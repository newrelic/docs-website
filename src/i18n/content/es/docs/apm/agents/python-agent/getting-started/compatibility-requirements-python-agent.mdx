...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Versiones de Python compatibles: 3.9, 3.10, 3.11, 3.12, 3.13 y 3.14.
        ...
        * La versión 3.8 de Python solo es compatible con las versiones del agente de Python 11.5.0 o inferiores.
      </td>
    </tr>

    <tr>
      <td>
        Implementaciones de intérpretes de Python
      </td>

      <td>
        Se admiten CPython, Free-Threaded CPython y PyPy.

        Otras implementaciones de Python pueden funcionar, pero no están oficialmente soportadas ni probadas.
      </td>
    </tr>
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        * [LangGraph](https://pypi.org/project/langgraph/) versiones 1.0.7 y superiores con LangChain versiones 1.2.4 y superiores.
        * Versiones 1.3.0 y superiores [del SDK de Google Gen AI](https://pypi.org/project/google-genai/) .
        * [Google ADK](https://pypi.org/project/google-adk/) versiones 2.0.0 y superiores.
        * Versiones 2.3.3 y superiores [de FastMCP](https://pypi.org/project/fastmcp/).
        * [Autogen](https://github.com/microsoft/autogen) versiones 0.6.1 y superiores.
        * [Strands Agents](https://pypi.org/project/strands-agents/) versiones 1.19.0 y superiores.
      </td>
    </tr>
