...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Opcional. El nombre de la transacción. Podría ser una función que acepte un parámetro callable\_name. El valor predeterminado es `None`. De forma predeterminada, el nombre será el nombre de la función a la que se ha aplicado el decorador, pero puede sobrescribirlo proporcionando este nombre.
      </td>
    </tr>
