...
Las llamadas en este procedimiento deben realizarse en <DoNotTranslate>**every**</DoNotTranslate> solicitud que desea monitor. Usted <DoNotTranslate>**cannot**</DoNotTranslate> llama a estas funciones una vez en el ámbito global y almacena en caché el resultado para su uso posterior.
...
1. Deshabilitar la instrumentación automática: en el archivo <DoNotTranslate>**newrelic.ini**</DoNotTranslate> , establezca [`browser_monitoring.auto_instrument`](/docs/agents/python-agent/installation-configuration/python-agent-configuration#browser-auto) en `false`.

2. Reinicie su aplicación.

3. Realice estas llamadas en el controlador de solicitudes de <DoNotTranslate>**every**</DoNotTranslate> página que desea monitor:
...
3. Realice estas llamadas en el controlador de solicitudes de <DoNotTranslate>**every**</DoNotTranslate> página que desea monitor, reemplazando "NONCE" con su CSP nonce:
