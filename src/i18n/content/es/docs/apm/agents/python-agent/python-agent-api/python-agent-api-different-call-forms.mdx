---
title: API del agente Python diferentes formas de llamada
...
Para ver un ejemplo de una API de Python del agente con los cuatro posibles, consulte la entrada de llamada [`function_trace`](/docs/agents/python-agent/python-agent-api/function_trace) .