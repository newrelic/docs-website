...
## Nombrar dinámicamente segmentos y atributos de segmento [#dynamically-name-segments-and-segment-attributes]

Para nombrar dinámicamente los segmentos y los valores de atributo de segmento, utilice las llamadas API de instrumentación personalizada, que aceptan una función en lugar de un valor estático para varios parámetros. Antes de la versión del agente 13.0.0, también podría hacer esto en el archivo de configuración usando una función Lambda. Esto ahora solo se admite en las llamadas API de instrumentación personalizada.

Las siguientes llamadas API admiten la nomenclatura dinámica:

* [`background_task`](/docs/agents/python-agent/python-agent-api/backgroundtask-python-agent-api)
* [`database_trace`](/docs/agents/python-agent/python-agent-api/databasetrace-python-agent-api)
* [`external_trace`](/docs/agents/python-agent/python-agent-api/externaltrace-python-agent-api)
* [`function_trace`](/docs/agents/python-agent/python-agent-api/functiontrace-python-agent-api)
* [`generator_trace`](/docs/agents/python-agent/python-agent-api/generatortrace-python-agent-api)
* [`memcache_trace`](/docs/agents/python-agent/python-agent-api/memcachetrace-python-agent-api)
* [`profile_trace`](/docs/agents/python-agent/python-agent-api/profiletrace-python-agent-api)
* [`web_transaction`](/docs/agents/python-agent/python-agent-api/web_transaction-python-agent-api)
