...
<CollapserGroup>
  ...
  >
    En este ejemplo, utiliza el módulo <DoNotTranslate>**`dumbdbm`**</DoNotTranslate> de Python y desea calcular el tiempo que llevó abrir una base de datos y luego volver a escribir esa base de datos en un archivo. En este caso usarías:
