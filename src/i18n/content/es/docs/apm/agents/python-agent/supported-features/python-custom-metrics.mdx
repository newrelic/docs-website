...
<DoNotTranslate>**Recommendation:**</DoNotTranslate> Para evitar posibles problemas con los datos, mantenga el número total de métricas únicas introducidas por métrica personalizada por debajo de 2000.
...
class Stats(dict):
    ...
    def merge_value(self, value):
        ...
        self.sum_of_squares += value <DoNotTranslate>** 2
        self.count += 1
```
...
```
newrelic.agent.register_data_source(source, application=None, name=None, settings=None, **</DoNotTranslate>properties)
```
