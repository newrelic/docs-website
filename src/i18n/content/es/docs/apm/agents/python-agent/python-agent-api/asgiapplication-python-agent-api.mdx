...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <DoNotTranslate>**Required**</DoNotTranslate>. El objeto ASGI que se va a empaquetar.
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <DoNotTranslate>**Required**</DoNotTranslate>. El módulo que contiene el objeto ASGI.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <DoNotTranslate>**Required**</DoNotTranslate>. Representa el método de clase o el método para buscar el objeto ASGI dentro de un archivo.
      </td>
    </tr>
  </tbody>
</table>
