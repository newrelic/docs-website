...
<DoNotTranslate>**Recommendation:**</DoNotTranslate> Configure su `app.yaml` para [deshabilitar las comprobaciones de estado](https://cloud.google.com/appengine/docs/flexible/python/configuring-your-app-with-app-yaml#health_checks) agregando:
