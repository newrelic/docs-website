...
Para ignorar estos errores, configúrelo desde la UI de New Relic <DoNotTranslate>**Application settings**</DoNotTranslate> o desde el archivo de configuración del agente. Los cambios UI anulan los cambios en el archivo de configuración según las [reglas de precedencia de configuración](/docs/agents/python-agent/installation-configuration/python-agent-configuration#options).
...
1. Desde
   ...
   <DoNotTranslate>**APM > (select an app) > Settings > Application**</DoNotTranslate>

   .

2. Seleccione

   <DoNotTranslate>**Server-side agent configuration**</DoNotTranslate>
