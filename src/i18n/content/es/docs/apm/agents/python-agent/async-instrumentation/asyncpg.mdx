...
Si inicia su aplicación con `python app.py` y usa nuestro agente Python <DoNotTranslate>**version 5.20.0.149**</DoNotTranslate> o superior, puede usar el [método de integración del script de administración](/docs/agents/python-agent/installation-configuration/python-agent-installation#integration) recomendado. Por ejemplo:
