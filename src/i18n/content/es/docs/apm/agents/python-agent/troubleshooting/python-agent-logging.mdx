...
1. Abra su <DoNotTranslate>**newrelic.ini**</DoNotTranslate>, generalmente ubicado dentro de la jerarquía de su aplicación.
...
6. Si envía su archivo de registro al soporte de New Relic, adjunte su <DoNotTranslate>**newrelic.ini**</DoNotTranslate> a su ticket de soporte e indique a Soporte su zona horaria.
