---
title: callable_name (API del agente Python)
type: apiDoc
shortDescription: Devuelve un nombre de cadena que identifica el objeto proporcionado.
tags:
  - Agents
  - Python agent
  - Python agent API
...
Esta llamada devuelve un nombre de cadena que identifica el objeto proporcionado. Esto se usa a menudo para nombrar mediante programación [la función traza](/docs/agents/python-agent/python-agent-api/function_trace).
  ...
  <tbody>
    <tr>
      <td>
        ...
        _función_, _clase_ o _función miembro_
      </td>
...
### Establecer nombre para la función traza [#trace-example]

A continuación se muestra un ejemplo del uso `callable_name` para establecer el nombre de una [función traza](/docs/agents/python-agent/python-agent-api/function_trace):
