...
Para obtener algunos consejos sobre cómo configurar el registro para el agente Python, consulte [Configurar el registro de Python en contexto](/docs/logs/logs-context/configure-logs-context-python).
