...
<CollapserGroup>
  <Collapser id="opentelemetry.enabled" title="opentelemetry.enabled">
    ...
    Si está habilitado, se utilizará cualquier API de OpenTelemetry y [framework instrumentado de OpenTelemetry](https://github.com/open-telemetry/opentelemetry-python-contrib/tree/main/instrumentation#readme) que esté instalado.
  </Collapser>
  ...
  <Collapser id="opentelemetry.traces.enabled" title="opentelemetry.traces.enabled">
    ...
    Si está habilitado, se utilizará cualquier API de span y traza de OpenTelemetry.
  </Collapser>
</CollapserGroup>
