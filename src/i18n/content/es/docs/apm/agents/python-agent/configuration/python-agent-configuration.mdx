...
<CollapserGroup>
  ...
  >
    ...
    Esta es una configuración informativa que se emplea para informar cuando el agente se inyecta en un clúster de Kubernetes. <Callout variant="caution">Esta configuración **no** habilita/deshabilita esta función del agente.</Callout>
  </Collapser>
</CollapserGroup>
