...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Opcional. El nombre de la función. Podría ser una función que acepte un parámetro callable\_name. Si no se establece, el valor predeterminado es el nombre capturado de la función.
      </td>
    </tr>
...
Si desea nombrar la métrica dinámicamente (en lugar de nombrar la métrica en función del identificador de la función que se está llamando), puede proporcionar el nombre como una función cuando se crea el objeto `FunctionTraceWrapper`.
