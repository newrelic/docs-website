...
<CollapserGroup>
  ...
  >
    ...
    * Evento browser : Deshabilitado
      ...
      <DoNotTranslate>**Note:**</DoNotTranslate> El atributo `httpResponseCode` (valor de cadena) se elimina a partir de la versión 7.0.0 del agente. En su lugar, se debe utilizar `http.statusCode` (valor entero).
  </Collapser>
  ...
  >
    ...
    * Evento browser : Deshabilitado
      ...
      <DoNotTranslate>**Note:**</DoNotTranslate> El atributo `httpResponseMessage` (valor de cadena) se elimina a partir de la versión 7.0.0 del agente. En su lugar, se debe utilizar `http.statusText` (valor de cadena).
  </Collapser>
