...
<CollapserGroup>
  <Collapser id="no_data" title="No ver datos">
  ...
  <Collapser id="installation" title="Problemas de instalación">
    <table>
      <thead>
        <tr>
          <th>
  ...
  <Collapser id="logs" title="Archivo de log">
  ...
  <Collapser id="vm_metrics" title="Falta máquina virtual (VM) métrica">
...
* [Resolución de problemas de instalación](https://knowledge.newrelic.com/s/article/Nodejs-Troubleshooting-Framework-Install)
* [Configuración general resolución de problemas](https://knowledge.newrelic.com/s/article/Nodejs-Troubleshooting-Framework-Configuration)