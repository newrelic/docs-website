...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        La transacción no tiene nombre. Si no está utilizando Express o Restify y no nombró explícitamente la transacción, aparece este error. Esto es para evitar que el nombre de la transacción pase a <DoNotTranslate>\*\*/\*\*</DoNotTranslate>\*. Para obtener más información, consulte [cómo nombrar su transacción](/docs/nodejs/nodejs-agent-api).
      </td>
    </tr>
