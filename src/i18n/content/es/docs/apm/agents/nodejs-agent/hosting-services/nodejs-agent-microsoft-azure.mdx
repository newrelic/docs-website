...
1. Inicia sesión en <DoNotTranslate>**[portal.azure.com](https://portal.azure.com)**</DoNotTranslate>.

2. Seleccione <DoNotTranslate>**App Services > (select a Node.js app) > Configure**</DoNotTranslate>.

3. Agregue lo siguiente al <DoNotTranslate>**app settings**</DoNotTranslate>:
...
Genera algo de tráfico a tu aplicación y espera unos minutos. Después de esperar, consulta tus datos yendo a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & services > (select your app)**</DoNotTranslate>.
