...
* Estándar (muestreo basado en cabecera): Antes de que lleguen las trazas, determinamos un porcentaje establecido de trazas para aceptar y analizar. Esto le brinda un punto de partida sólido para ver cómo el rastreo puede ayudarle. Está activado de forma predeterminada en los agentes de Node.js 8.3.0 y superiores. De forma predeterminada, el agente de Node.js muestrea 10 trazas por minuto, con un límite máximo de 2000 spans por minuto.
