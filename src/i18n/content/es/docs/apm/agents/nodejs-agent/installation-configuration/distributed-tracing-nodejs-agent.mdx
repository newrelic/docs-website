...
<DoNotTranslate>**Recommendation:**</DoNotTranslate> Antes de realizar cualquier instrumentación personalizada, lea:
  ...
  >
    ...
    2. Invoque la llamada API del agente para generar una carga útil distribuida de rastreo (consulte la [API del agente de Node.js.](/docs/agents/nodejs-agent/api-guides/nodejs-agent-api#transaction-handle-createDistributedTracePayload)
       ...
       <Callout variant="important">
         Para mantener el orden correcto de los tramos en una traza, asegúrese de <DoNotTranslate>**generate the payload in the context of the span that sends it**</DoNotTranslate>.
       </Callout>
