...
<CollapserGroup>
  ...
  <Collapser id="utilization-gcp-use-instance-as-host" title="gcp_use_instance_as_host">
    ...
    Cuando está habilitado, el agente utiliza el ID de la instancia de metadatos de GCP para establecer el nombre de host de la aplicación en ejecución.
  </Collapser>
  ...
  <Collapser id="utilization-gcp-cloud-run-include-revision-in-host" title="gcp_cloud_run.include_revision_in_host">
    ...
    Cuando está habilitado, y `gcp_use_instance_as_host` también está habilitado, la revisión de GCP Cloud Run (`K_REVISION`) se antepone al ID de la instancia al establecer el nombre de host de la aplicación en ejecución, lo que da como resultado un nombre de host de `${K_REVISION}-${instance_id}`.
  </Collapser>
</CollapserGroup>
