...
El SDK de C admite la instrumentación de aplicaciones multiproceso, pero debe inicializarse antes de instrumentar varios subprocesos. Al llamar a cualquiera de las siguientes funciones, asegúrese de que sean <DoNotTranslate>**called on the main thread**</DoNotTranslate> antes de llamar a cualquier otra función del SDK de C:
