...
2. Asegúrese de que el [proceso daemon (`newrelic-daemon`)](/docs/install-c-sdk-compile-link-your-code#daemon) esté en funcionamiento para que se invoque <DoNotTranslate>**before**</DoNotTranslate> iniciando su aplicación instrumentada.
