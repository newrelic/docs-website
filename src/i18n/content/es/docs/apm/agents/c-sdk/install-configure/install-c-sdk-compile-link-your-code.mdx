...
<CollapserGroup>
  ...
  >
    ...
    2. Verifique el resultado en los archivos `c_sdk.log` y `newrelic-daemon.log` .
       ...
       La arquitectura del SDK de C requiere que el daemon se invoque primero <DoNotTranslate>**before**</DoNotTranslate> cuando se invoca su aplicación instrumentada.
