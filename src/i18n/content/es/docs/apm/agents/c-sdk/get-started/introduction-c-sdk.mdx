...
<figcaption>
  <DoNotTranslate>**C SDK architecture:**</DoNotTranslate> Para enviar datos desde su aplicación a New Relic, se debe invocar al daemon <DoNotTranslate>**before**</DoNotTranslate> realizando llamadas a la biblioteca de instrumentación C SDK de su aplicación.
</figcaption>
