...
Los errores de transacción y [la traza de error](#error-trace-examples) aparecen en la [página<DoNotTranslate>**Error analytics**</DoNotTranslate> ](/docs/apm/applications-menu/error-analytics/error-analytics-manage-error-traces)en la UI de New Relic. El SDK de C informa el número total de errores y hasta 100 trazas de errores por minuto en la página <DoNotTranslate>**Error analytics**</DoNotTranslate> .
