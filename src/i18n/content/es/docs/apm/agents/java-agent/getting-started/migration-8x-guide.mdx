...
2. Para cada alerta devuelta, puede utilizar la identificación o el nombre en la UI <DoNotTranslate>**Alerts & AI > [Alerts Conditions](https://one.newrelic.com/alerts-ai/condition-builder/condition-list)**</DoNotTranslate> para encontrar la alerta.
