...
<Callout variant="important">
  Este documento detalla cómo usar la nueva solución basada en el agente APM para el monitoreo sin servidor de Java. Esta solución se lanzó el 10 de abril de 2026. Los usuarios que utilizaban el monitoreo Java antes de esta versión o que utilizan las versiones 11 u 8 de Java deben utilizar en su lugar nuestra [solución legacy de Java basada en Open Tracing](/docs/serverless-function-monitoring/aws-lambda-monitoring/instrument-lambda-function/instrument-your-own/#console).
</Callout>
