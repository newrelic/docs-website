...
La UI de <InlinePopover type="apm"/>mostrará la transacción iniciada a través de JMS 1.1 o la recepción de mensajes de RabbitMQ como <DoNotTranslate>**Message**</DoNotTranslate> tareas en segundo plano. La creación de mensajes vía JMS o RabbitMQ también aparece en la traza de la transacción.
...
<figcaption>
  Vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & services**</DoNotTranslate> y haga clic en su aplicación. En la sección <DoNotTranslate>**Monitor**</DoNotTranslate> , haga clic en <DoNotTranslate>**Transaction**</DoNotTranslate>, seleccione una transacción para ver la tabla de desglose.
</figcaption>
