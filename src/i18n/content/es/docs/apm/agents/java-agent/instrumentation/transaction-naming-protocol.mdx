...
Para algunas aplicaciones, es posible que desee desactivar la denominación de transacciones basada en componentes. [Establezca este valor en su archivo <DoNotTranslate>**newrelic.yml**</DoNotTranslate> ](/docs/java/java-agent-configuration#cfg-enable_auto_transaction_naming):
