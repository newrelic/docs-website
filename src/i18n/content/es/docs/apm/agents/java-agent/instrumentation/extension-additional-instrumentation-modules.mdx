...
<Callout variant="tip">
  Si tiene comentarios, preguntas o problemas con esta instrumentación, cree una publicación en el [foro de soporte de New Relic](https://support.newrelic.com/s/hubtopic/Topic__c/Default?c__categories=%5B%7B%22icon%22%3A%22standard%3Adefault%22%2C%22id%22%3A%22a6c8W000000EesiQAC%22%2C%22sObjectType%22%3A%22Category__c%22%2C%22title%22%3A%22Java%20Agent%22%2C%22titleFormatted%22%3A%22Java%20Agent%22%7D%5D) y etiquete la publicación con `java_incubator`.
</Callout>
...
<CollapserGroup>
  <Collapser className="freq-link" id="class-histogram" title="Histograma de clase">
    <table>
      <tbody>
        <tr>
          <th>
...
<CollapserGroup>
  <Collapser className="freq-link" id="apache-camel-212" title="Camello Apache 2.12">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser className="freq-link" id="c3p0-db-connection" title="C3P0 grupos de conexiones de base de datos">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser className="freq-link" id="code-hale-metrics-2" title="Coda Hale métrica 2">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser className="freq-link" id="coda-hale-metrics-3" title="Coda Hale métrica 3">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser className="freq-link" id="ratpack-1-6-0" title="Ratpack 1.6.0 o superior">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser className="freq-link" id="ratpack-http-1-4-0" title="Cliente Ratpack Http 1.4.0 o superior">
    <table>
      <tbody>
        <tr>
          <th>
...
<CollapserGroup>
  ...
  <Collapser className="freq-link" id="akka-http-20" title="Akka HTTP [2.0 – 2.4.1]">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser className="freq-link" id="akka-http-242" title="Akka HTTP [2.4.2 – 2.4.4]">
    <table>
      <tbody>
        <tr>
          <th>
