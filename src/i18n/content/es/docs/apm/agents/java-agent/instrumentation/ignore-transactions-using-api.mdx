...
<Callout variant="important">
  Ignorar la transacción implica cambiar el código fuente de su aplicación y volver a compilarla en todos los casos <DoNotTranslate>**unless**</DoNotTranslate> en los que utilice un [archivo de instrumentación XML](/docs/agents/java-agent/custom-instrumentation/java-custom-instrumentation-xml-examples#file-format). Si no puede manipular su código, use XML para ignorar la transacción.
</Callout>
