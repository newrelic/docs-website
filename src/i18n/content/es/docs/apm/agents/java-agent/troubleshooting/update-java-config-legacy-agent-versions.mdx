  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        La sección del archivo de configuración <DoNotTranslate>**newrelic.yml**</DoNotTranslate> denominada `analytics_events` ha quedado obsoleta. Utilice la sección `transaction_events` en su lugar.
      </td>
    </tr>
