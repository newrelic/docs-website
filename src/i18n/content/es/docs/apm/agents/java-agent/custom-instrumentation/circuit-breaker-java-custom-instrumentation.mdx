...
<CollapserGroup>
  ...
  >
    Utilice la tabla <DoNotTranslate>**Top methods by call count**</DoNotTranslate> en la página del interruptor <DoNotTranslate>**Events**</DoNotTranslate> para encontrar métodos que podrían estar sobre instrumentados. Identificar y desactivar la instrumentación personalizada.
