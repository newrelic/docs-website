...
* <DoNotTranslate>**[Tokens](#tokens)**</DoNotTranslate>
...
* <DoNotTranslate>**[Segments](#segments)**</DoNotTranslate>
...
<CollapserGroup>
  ...
  >
    Para ver los detalles de la traza de la transacción, vaya a: <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com) APM & services > (select an app) > Transactions > Transaction trace > Trace details**</DoNotTranslate>.
