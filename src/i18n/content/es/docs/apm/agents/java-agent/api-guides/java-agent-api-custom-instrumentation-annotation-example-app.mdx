...
<CollapserGroup>
  ...
  >
    Esta parte de la llamada API indica a la transacción web que contiene un valor `storeId` que aparezca en [la página<DoNotTranslate>**Transactions**</DoNotTranslate> ](/docs/apm/applications-menu/monitoring/transactions-dashboard)de APM con el nombre de transacción personalizado que configuró. Una solicitud a cualquier tienda aparecerá bajo el mismo nombre agregado.
