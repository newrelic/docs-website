...
3. Agregue la métrica que desea monitor a un dashboard haciendo clic en <DoNotTranslate>**Add to dashboard**</DoNotTranslate>.
...
* <DoNotTranslate>**The instrumentation adds a 150 to 200 byte payload to message headers.**</DoNotTranslate>
