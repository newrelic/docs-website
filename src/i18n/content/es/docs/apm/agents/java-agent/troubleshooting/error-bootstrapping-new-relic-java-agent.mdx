...
<CollapserGroup>
  ...
  >
    ...
    Para resolver este problema, verifique los permisos del usuario que inicia el proceso Java que ejecuta el agente de Java. Asegúrese de que el usuario tenga permisos <DoNotTranslate>**write**</DoNotTranslate> y <DoNotTranslate>**execute**</DoNotTranslate> para la ubicación del directorio temporal.
  </Collapser>
