...
<CollapserGroup>
  ...
  >
    <DoNotTranslate>**Recommendation:**</DoNotTranslate> Utilice el ayudante `StartExternalSegment`, ya que New Relic lo utiliza para trazar la actividad entre su aplicación mediante [Distributed tracing](/docs/agents/go-agent/features/distributed-tracing-go).
