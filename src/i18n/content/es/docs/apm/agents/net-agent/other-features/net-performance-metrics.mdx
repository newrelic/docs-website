...
Puedes ver estas métricas en <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & services**</DoNotTranslate>. Seleccione una aplicación y vaya a <DoNotTranslate>**More views > Dotnet VMs**</DoNotTranslate>.
