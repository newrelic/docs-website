...
<CollapserGroup>
  ...
  >
    Las variables de entorno que aparecen en la pestaña <DoNotTranslate>**Environment**</DoNotTranslate> en <DoNotTranslate>**Process Explorer**</DoNotTranslate> de Kudu deberían ser similares a estas:
  ...
  >
    ...
    Si realizó algún cambio en las variables de entorno, asegúrese de reiniciar su aplicación a través del Portal de Azure. Luego inspeccione el nuevo PID del proceso en <DoNotTranslate>**Process Explorer**</DoNotTranslate> para asegurarse de que los cambios se hayan realizado correctamente.
  </Collapser>
  ...
  >
    Para el paquete NuGet, las variables de entorno [deben agregarse como configuración de la aplicación](/docs/apm/agents/net-agent/azure-installation/install-net-agent-azure-web-apps/#nuget-install-net-core). Las variables de entorno que aparecen en la pestaña <DoNotTranslate>**Environment**</DoNotTranslate> en <DoNotTranslate>**Process Explorer**</DoNotTranslate> de Kudu deberían ser similares a estas:
  ...
  >
    ...
    Asegúrese de que el nodo <DoNotTranslate>**log**</DoNotTranslate> de su archivo `newrelic.config` incluya un atributo de directorio. Si Visual Studio le impide editar el archivo `newrelic.config` que NuGet agregó a su proyecto, debe hacer una copia local de este en su aplicación:
