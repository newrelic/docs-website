...
3. Ejecute estos comandos <DoNotTranslate>**each**</DoNotTranslate> cada vez que reinicie su servidor o cree una script de inicio para restaurar esta configuración.

4. Recicle su grupo de aplicaciones o, desde un símbolo del sistema, ejecute <DoNotTranslate>**`IISRESET`**</DoNotTranslate>.
