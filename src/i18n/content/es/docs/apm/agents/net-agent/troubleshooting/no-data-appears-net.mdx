...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        <DoNotTranslate>**.NET Core:**</DoNotTranslate> Consulta los requisitos de Kestrel.
      </td>
    ...
    <tr>
      <td>
        <DoNotTranslate>**.NET Core:**</DoNotTranslate> Verifique las variables de entorno.
      </td>
    ...
    <tr>
      <td>
        <DoNotTranslate>**.NET Framework:**</DoNotTranslate> Reinicie IIS.
      </td>
...
<table>
  ...
  <tbody>
    <tr>
      <td>
        <DoNotTranslate>**.NET Framework:**</DoNotTranslate> Verifique los permisos del Registro.
      </td>
    ...
    <tr>
      <td>
        <DoNotTranslate>**.NET Framework:**</DoNotTranslate> Ejecute el Visor de eventos de Windows.
      </td>
    ...
    <tr>
      <td>
        <DoNotTranslate>**.NET 8:**</DoNotTranslate> Asegúrese de que los diagnósticos en tiempo de ejecución estén habilitados
      </td>
