...
<DoNotTranslate>**Exception:**</DoNotTranslate> Para conflictos con System Center Operations Manager (SCOM) de Microsoft, siga los [procedimientos de resolución de problemas específicos para SCOM](/docs/agents/net-agent/troubleshooting/resolve-net-scom-conflicts).
...
<CollapserGroup>
  ...
  >
    ...
    1. Ejecute <DoNotTranslate>**Process Explorer**</DoNotTranslate> como administrador.

    2. Para encontrar el proceso de su aplicación, haga clic derecho en la aplicación y luego seleccione <DoNotTranslate>**Properties > Environment**</DoNotTranslate>.
  ...
  >
    Si el generador de perfiles en conflicto se ha deshabilitado y todavía hay un problema, compare las claves de registro con [<DoNotTranslate>**Process Explorer**</DoNotTranslate>](https://technet.microsoft.com/en-us/sysinternals/bb896653.aspx) para ver qué generador de perfiles está presente. En la máquina donde tiene este problema, verifique <DoNotTranslate>**WAS**</DoNotTranslate> y <DoNotTranslate>**W3SVC REG**</DoNotTranslate> para aplicaciones IIS, o verifique sus claves de servicio o claves de aplicaciones que no sean IIS.
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Si usa <DoNotTranslate>**cmd**</DoNotTranslate>, haga lo siguiente para <DoNotTranslate>**WAS**</DoNotTranslate> y <DoNotTranslate>**W3SVC REG**</DoNotTranslate> o para su servicio/aplicación que no sea IIS. A continuación se muestra un ejemplo de una aplicación IIS:

            1. En la línea de comando, ingrese `regedit`.

            2. Desde

               <DoNotTranslate>**Registry Editor**</DoNotTranslate>

               , seleccione

               <DoNotTranslate>**HKEY_LOCAL_MACHINE > SYSTEM > CurrentControlSet > Services**</DoNotTranslate>

               .

            3. Si corresponde, seleccione la carpeta

               <DoNotTranslate>**WAS**</DoNotTranslate>
            ...
            4. Si corresponde, seleccione la carpeta
               ...
               <DoNotTranslate>**W3SVC**</DoNotTranslate>
