...
<CollapserGroup>
  ...
  >
    ...
    1. En el servidor donde está instalada su aplicación, [descargue Microsoft Windows <DoNotTranslate>**Sysinternals Process Explorer**</DoNotTranslate>](https://technet.microsoft.com/en-us/sysinternals/bb896653.aspx).

    2. Descomprima el archivo y ejecute `procexp.exe` como administrador.

    3. Seleccione <DoNotTranslate>**View > Show Lower Pane**</DoNotTranslate> y luego seleccione <DoNotTranslate>**View > Lower Pane View > DLLs**</DoNotTranslate>.

    4. Genera algo de tráfico a tu aplicación.

    5. Para actualizar la lista de procesos, seleccione <DoNotTranslate>**View > Refresh Now**</DoNotTranslate>.
  ...
  >
    ...
    <table>
      ...
      <tbody>
        <tr>
          <td>
            Establezca permisos para el grupo <DoNotTranslate>**Everyone**</DoNotTranslate> .
          </td>

          <td>
            Ajuste los permisos en las siguientes carpetas para el grupo <DoNotTranslate>**Everyone**</DoNotTranslate> para otorgarle todos los permisos <DoNotTranslate>**except**</DoNotTranslate> `Full Control`:
        ...
        <tr>
          ...
          <td>
            Si sus políticas de seguridad no permiten ajustar los permisos para el grupo <DoNotTranslate>**Everyone**</DoNotTranslate> , ajuste los permisos para el usuario individual. Registre el usuario bajo el cual se ejecuta su aplicación, luego ajuste los permisos para cada uno de esos usuarios.
          </td>
        </tr>
