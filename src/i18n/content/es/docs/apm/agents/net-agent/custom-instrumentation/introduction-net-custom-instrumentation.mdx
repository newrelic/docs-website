...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <DoNotTranslate>**Create a new transaction.**</DoNotTranslate> Para más detalles, consulte:
    ...
    <tr>
      ...
      <td>
        <DoNotTranslate>**Add detail to an existing transaction.**</DoNotTranslate> Para más detalles, consulte:
...
Cuando crea una transacción mediante instrumentación personalizada utilizando el [método de atributo](#ci-methods), debe categorizarla como <DoNotTranslate>**web**</DoNotTranslate> o <DoNotTranslate>**non-web**</DoNotTranslate>. (Esto no es posible con la instrumentación XML; todas las transacciones creadas en XML se clasifican como <DoNotTranslate>**non-web**</DoNotTranslate>.)
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Utilice <DoNotTranslate>**web**</DoNotTranslate> para solicitudes web. Solo puede marcar una nueva transacción como transacción web con [instrumentación personalizada usando atributo](/docs/agents/net-agent/api-guides/custom-instrumentation-attributes-net), no usando XML.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Utilice <DoNotTranslate>**non-web**</DoNotTranslate> para otros tipos de solicitudes en segundo plano, como aplicaciones y servicios de consola.
