...
<sup>\*</sup> Logs en el contexto será capturado por la extensión Lambda o CloudWatch, no por el reenvío de logdel agente.
...
* Actualmente no se admite la función Lambda de AspNetCore. La función Lambda de AspNetCore se basa en un método genérico que está registrado como controlador lambda.
