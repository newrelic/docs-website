...
<CollapserGroup>
  ...
  >
    ...
    <Callout variant="caution">
      Siga estos pasos cuidadosamente. Pueden ocurrir problemas graves si modifica el registro incorrectamente. <DoNotTranslate>**Recommendation:**</DoNotTranslate> Antes de modificar el registro, haga una copia de seguridad.
    </Callout>

    A continuación se muestra un ejemplo de cómo actualizar el registro de Windows a TLS 1.2. Esto requiere que TLS esté habilitado para la función <DoNotTranslate>**Client**</DoNotTranslate> , porque su servidor se está conectando como cliente a New Relic.
