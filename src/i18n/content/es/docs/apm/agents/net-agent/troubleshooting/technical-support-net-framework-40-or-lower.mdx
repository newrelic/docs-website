...
<Callout variant="important">
  New Relic proporciona <DoNotTranslate>**limited technical support**</DoNotTranslate> para clientes que utilizan .NET framework 4.0 o inferior.
</Callout>
...
<Callout variant="important">
  La aplicación que se ejecuta en .NET framework versión 4.0 o inferior requiere una versión del agente New Relic .NET <DoNotTranslate>**lower than 7.0**</DoNotTranslate>.
</Callout>
