...
* Si no obtiene resultados, configure las [variables de entorno](https://support.newrelic.com/s/hubtopic/aAX8W0000008a6F/relic-solution-net-core-agent-required-environment-variables), reinicie la aplicación y vuelva al paso 1.
...
Si los pasos anteriores no resolvieron el problema, le recomendamos que se comunique con el soporte o solicite ayuda en el [foro de soporte](https://support.newrelic.com/s/).