...
<CollapserGroup>
  ...
  >
    El elemento `analyticsEvents` en <DoNotTranslate>**newrelic.config**</DoNotTranslate> está obsoleto. Habilite el elemento [`transactionEvents`](/docs/agents/net-agent/installation-configuration/net-agent-configuration#transaction_events) en <DoNotTranslate>**newrelic.config**</DoNotTranslate>:
