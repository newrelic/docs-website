...
<CollapserGroup>
  ...
  >
    ...
    .NET framework 4.6.2 o superior requiere la versión 7.0 o superior del agente New Relic .NET.

    <DoNotTranslate>
      **.NET Framework 4.5.1, 4.5.2, and 4.6.1**
    </DoNotTranslate>

    Para una aplicación de instrumento que se ejecuta en .NET framework 4.5.1, 4.5.2 o 4.6.1, debe ejecutar una versión del agente New Relic .NET inferior a 10.0 pero no inferior a 7.0.
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            A menos que haya instalado <DoNotTranslate>**only**</DoNotTranslate> .NET framework 4.0 o superior, <DoNotTranslate>**must**</DoNotTranslate> tiene instalada la versión 3.5 de .NET framework en el host de destino, además de cualquier otra versión de .NET framework que haya instalado.
          </td>
        </tr>
...
<CollapserGroup>
  ...
  >
    El agente instrumentó automáticamente algún marco de aplicación; Nos referimos a estos marcos como <DoNotTranslate>**fully supported**</DoNotTranslate>.
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            Estos marcos <DoNotTranslate>**are fully supported:**</DoNotTranslate>
            ...
            * [WCF](/docs/apm/agents/net-agent/other-installation/install-net-agent-windows-communication-foundation-wcf/)
              ...
              * [<DoNotTranslate>**Binding Types**</DoNotTranslate>](https://docs.microsoft.com/en-us/dotnet/framework/wcf/system-provided-bindings) (tanto cliente como servicio)  
                ...
                <table>
                  <thead>
                    <tr>
                      ...
                      <th>
                        Soporte de rastreo multiaplicación (CAT)
                      </th>
                    </tr>
                  </thead>
              ...
              * <DoNotTranslate>**Invocation Methods**</DoNotTranslate> (tanto cliente como servicio)
        ...
        <tr>
          ...
          <td>
            ASP clásico es <DoNotTranslate>**not supported**</DoNotTranslate>, porque el agente solo puede implementar aplicaciones basadas en .NET framework .

            SharePoint es <DoNotTranslate>**not supported**</DoNotTranslate>.
          </td>
        </tr>
      </tbody>
    </table>
  ...
  >
    ...
    * Versiones compatibles verificadas: 4.0.40
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            * Versiones compatibles verificadas: 2.3.8
        ...
        <tr>
          ...
          <td>
            ...
            * Versiones compatibles verificadas: .NET framework 4.6.2, 4.7.1, 4.8
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            ...
            Versiones compatibles verificadas: 1.10.0
        ...
        <tr>
          ...
          <td>
            ...
            * Versiones compatibles verificadas: 4.0.5
  ...
  <Collapser
    ...
    title="CMS"
  >
    El agente instrumentó automáticamente el sistema de gestión de contenidos <DoNotTranslate>**EPiServer**</DoNotTranslate> .
  </Collapser>
        ...
        <tr>
          ...
          <td>
            ...
            * `DownloadData`
              ...
              Versiones compatibles verificadas: 105.2.3, 106.0.0, 106.6.10, 106.11.0, 106.12.0, 106.13.0, 106.15.0, 107.3.0, 108.0.3, 109.0.1
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            * Versiones compatibles verificadas: 3.5.2, 5.1.0, 6.2.1, 3.6.9, 4.1.3, 5.2.0, 6.0.0, 6.2.1, 6.4.0, 6.5.0, 6.6.0
          </td>
        </tr>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            3. Desde <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DoNotTranslate>, vaya a <DoNotTranslate>**APM & services**</DoNotTranslate> y luego seleccione su aplicación. Para comprobar que su instalación es exitosa, consulte lo siguiente:
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Cuando instalas la infraestructura y el agente APM en el mismo host, se detectan automáticamente entre sí. Luego puede ver una lista de hosts en la UI de APM y filtrar sus hosts por aplicación de APM en nuestra UI de infraestructura. Para obtener más información, consulte [Datos de APM en UIde infraestructura](/docs/infrastructure/manage-your-data/data-instrumentation/apm-data-infrastructure-monitoring/).
      </td>
    </tr>
