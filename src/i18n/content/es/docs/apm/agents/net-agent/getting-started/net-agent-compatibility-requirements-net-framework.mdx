...
<CollapserGroup>
  <Collapser className="freq-link" id="net-version" title="Versión framework .NET">
  ...
  <Collapser id="lifespan" title="Vida útil de la aplicación">
  ...
  <Collapser className="freq-link" id="code-access" title="Seguridad de acceso al código">
...
<CollapserGroup>
  ...
  <Collapser id="technologies" title="Lenguajes y tecnologías .NET compatibles para el panel">
