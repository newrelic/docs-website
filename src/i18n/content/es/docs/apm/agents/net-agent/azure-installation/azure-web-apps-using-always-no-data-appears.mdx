...
Si está utilizando el nivel <DoNotTranslate>**Standard**</DoNotTranslate> o <DoNotTranslate>**Basic**</DoNotTranslate> de Microsoft con Azure Portal, asegúrese de que la configuración `Always On` esté deshabilitada.

1. En Azure Portal, seleccione

   <DoNotTranslate>**(your app) > Settings > Application Settings**</DoNotTranslate>

   .

2. Establezca el interruptor `Always On` en `Off`.

Aquí hay algunas otras opciones que puedes probar. Si no funcionan, <DoNotTranslate>**must**</DoNotTranslate> [desactiva la configuración `Always On` ](#4-0-framework).
...
<CollapserGroup>
  ...
  >
    Para nombrar su aplicación en el <DoNotTranslate>**`newrelic.config`**</DoNotTranslate> local usando Kudu:

    1. Desde el Portal de Microsoft Azure, seleccione <DoNotTranslate>**(your app) > Tools > Kudu**</DoNotTranslate> y luego seleccione <DoNotTranslate>**Go**</DoNotTranslate>.

    2. Seleccione <DoNotTranslate>**Debug Console > CMD**</DoNotTranslate>.

    3. Seleccione <DoNotTranslate>**Site > wwwroot > newrelic**</DoNotTranslate>.
