...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="ignoreClasses"
  >
    Una lista de nombres de clases completos que se ignorarán. El número máximo de combinaciones de clase de error y mensaje que <DoNotTranslate>**SHOULD**</DoNotTranslate> debe informar es 50. Si se enumeran más de 50, solo se emplearán los primeros 50 <DoNotTranslate>**SHOULD**</DoNotTranslate> .
  </Collapser>
