...
<CollapserGroup>
  ...
  <Collapser id="env-var-core" title=".NET Core: comprobar las variables de entorno">
    ...
    <Callout variant="tip">
      Para obtener consejos sobre cómo establecer esta variable de entorno por proceso en lugar de en todo el sistema, consulte [nuestra publicación del foro sobre cómo establecer variables de entorno](https://knowledge.newrelic.com/s/article/Setting-dot-NET-Core-agent-environment-variables-per-process).
    </Callout>
  </Collapser>
</CollapserGroup>
