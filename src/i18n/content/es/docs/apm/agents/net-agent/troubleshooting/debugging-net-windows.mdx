...
2. Lance la versión apropiada de Process Explorer para su entorno (32 vs 64 bits) como administrador (haga clic derecho en <DoNotTranslate>**Run as Administrator**</DoNotTranslate>).
...
4. En la barra de menú de Process Explorer, seleccione <DoNotTranslate>**View > Show lower pane**</DoNotTranslate> y luego <DoNotTranslate>**View > Lower pane view > DLLs**</DoNotTranslate>.
...
Para verificar las variables de entorno requeridas: haga clic derecho en el proceso en Process Explorer y seleccione <DoNotTranslate>**Properties**</DoNotTranslate>. Verás un conjunto de pestañas en la parte superior de la ventana que aparece. Seleccione la pestaña <DoNotTranslate>**Environment**</DoNotTranslate> .
