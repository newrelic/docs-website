...
<CollapserGroup>
  ...
  <Collapser id="ITransaction" title="ITransacción">
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            Acepta encabezados de contexto de traza entrantes de otro servicio (ver a continuación para obtener más detalles).
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Agrega encabezados de contexto de traza a una solicitud saliente (ver a continuación para obtener más detalles).
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Acepta un rastreo distribuido carga entrante de otro servicio (ver más abajo para más detalles).
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Crea un rastreo distribuido carga para incluirlo en una solicitud saliente (ver más abajo para más detalles).
          </td>
        </tr>
    ...
    <CollapserGroup>
      <Collapser id="" title="AceptarDistributedTraceHeaders">
        ### Sintaxis
      ...
      <Collapser id="" title="Insertar encabezados de seguimiento distribuido">
        ### Sintaxis
      ...
      <Collapser id="" title="Agregar atributo personalizado">
        ### Sintaxis
      ...
      <Collapser id="" title="Intervalo actual">
      ...
      <Collapser id="" title="Establecer ID de usuario">
        ### Sintaxis
      ...
      <Collapser id="" title="Segmento de almacén de datos de registro">
        ### Sintaxis
  ...
  <Collapser id="ISpan" title="España">
    ...
    * La propiedad `CurrentSpan` en [`ITransaction`](/docs/apm/agents/net-agent/net-agent-api/net-agent-api/#ITransaction).
    ...
    <CollapserGroup>
      ...
      <Collapser id="" title="Escoger un nombre">
