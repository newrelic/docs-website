...
Para obtener un tutorial completo y ejecutable, que incluye ejemplos de antipatrones verificados por compilación, consulte el [ejemplo de inyección de dependencia de la API](https://github.com/newrelic/newrelic-dotnet-examples/tree/main/api-dependency-injection) en el respositorio `newrelic-dotnet-examples`.
