---
title: Cómo verificar la suma de comprobación de las descargas del agente .NET
tags:
  - Agents
  - NET agent
  - Other installation
...
Lea acerca de cómo confirmar la suma de verificación para el instalador del agente .NET de New Relic. Si necesita el hash para nuestras versiones actuales, [descargue su hash SHA256 desde nuestro sitio de descargas](https://download.newrelic.com/dot_net_agent/latest_release/SHA256/).
