...
El agente .NET de New Relic es compatible con .NET Framework y .NET Core. Este documento describe la compatibilidad y el soporte para la aplicación ..NET Core.
...
<Tabs>
  ...
  <TabsPages>
    <TabsPageItem id="1">
      ...
      <CollapserGroup>
        <Collapser className="freq-link" id="net-version" title="Versión .NET Core">
      ...
      <CollapserGroup>
        ...
        <Collapser className="freq-link" id="logging-frameworks" title="Marco de registro">
    ...
    <TabsPageItem id="2">
      ...
      <CollapserGroup>
        ...
        <Collapser className="freq-link" id="other-apm" title="Uso de otro software de monitoreo">
      ...
      <CollapserGroup>
        ...
        <Collapser className="freq-link" id="binding-types" title="Tipos de encuadernación">
        ...
        <Collapser className="freq-link" id="hosting-models" title="Modelos de invocación">
        ...
        <Collapser className="freq-link" id="unsupported-frameworks" title="Marco no compatible">
