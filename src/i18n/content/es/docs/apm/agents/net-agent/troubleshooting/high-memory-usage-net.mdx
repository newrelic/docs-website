...
Después de instalar el agente .NET de New Relic, verá un aumento en el uso de memoria `Working Set` en herramientas de monitoreo como Microsoft Windows <DoNotTranslate>**Task Manager**</DoNotTranslate>. El aumento suele ser de unos 100 MB por aplicación de monitor. Esto puede ocurrir tanto en máquinas físicas como virtuales.
