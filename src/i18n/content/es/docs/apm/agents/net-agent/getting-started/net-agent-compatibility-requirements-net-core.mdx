...
<CollapserGroup>
  <Collapser className="freq-link" id="net-version" title="Versión de Microsoft .NET Core">
  ...
  <Collapser className="freq-link" id="target-framework" title="Versión framework objetivo">
  ...
  <Collapser className="freq-link" id="app-web-servers" title="Servidores de aplicaciones/web">
  ...
  <Collapser className="freq-link" id="operating-system" title="Sistema operativo">
  ...
  <Collapser className="freq-link" id="architecture" title="Arquitectura del procesador">
  ...
  <Collapser className="freq-link" id="user-rights" title="Permisos">
  ...
  <Collapser className="freq-link" id="security-requirements" title="Requerimientos de seguridad">
  ...
  <Collapser className="freq-link" title="Requisitos de red">
...
<CollapserGroup>
  <Collapser className="freq-link" id="app-frameworks" title="Marco de la aplicación">
  ...
  <Collapser className="freq-link" id="database" title="Almacenes de datos">
  ...
  <Collapser className="freq-link" id="additional-frameworks" title="Biblioteca de llamadas externas">
  ...
  <Collapser className="freq-link" id="messaging" title="Mensajería">
  ...
  <Collapser className="freq-link" id="logging-frameworks" title="Marco de logging">
  ...
  <Collapser className="freq-link" id="large-language-models" title="Modelo de lenguaje extenso (LLM)">
