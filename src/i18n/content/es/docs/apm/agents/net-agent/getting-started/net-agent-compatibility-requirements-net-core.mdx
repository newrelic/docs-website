...
<CollapserGroup>
  ...
  >
    ...
    >
      ...
      * [.NET versión 5](https://devblogs.microsoft.com/dotnet/dotnet-5-end-of-support-update/) el 10 de mayo de 2022
        ...
        Las fechas oficiales de inicio y finalización del ciclo de vida del producto se pueden encontrar en la [documentación de Microsoft](https://dotnet.microsoft.com/en-us/platform/support/policy/dotnet-core). Nuestro soporte de agente .NET para estas versiones de framework finaliza con el último agente .NET 9.x New Relic. A partir de la versión 10.0 del agente New Relic .NET, apuntaremos a .NET Core 3.1 en adelante.
    </Callout>

    El agente .NET admite las versiones 2.0, 2.1, 2.2, 3.0, 3.1 y .NET Core 5.0, 6.0, 7.0 y 8.0 de .NET Core.
    ...
    <Callout variant="important">
      En la plataforma Linux ARM64, el agente .NET <DoNotTranslate>**only**</DoNotTranslate> admite versiones de .NET 5.0 o superiores.
    </Callout>

    El agente **no** es compatible con las versiones 1.0 o 1.1 de .NET Core. Para aplicaciones .NET Core 2.1 o superior con la compilación de nivel habilitada, el agente deshabilitará la compilación de nivel. La compatibilidad con .NET Core 2.1 requiere el tiempo de ejecución de .NET Core 2.1.3 y SDK de .NET Core 2.1.401 o superior debido a [un error en la API de creación de perfiles de .NET Core](https://github.com/dotnet/coreclr/issues/18448).
  </Collapser>
  ...
  >
    ...
    <Callout variant="important">
      En la plataforma Linux ARM64, el agente .NET <DoNotTranslate>**only**</DoNotTranslate> admite el marco objetivo de `net5.0` o superior.
    </Callout>
      ...
      <tbody>
        <tr>
          ...
          <td>
            ...
            * Versiones compatibles verificadas: 3.17.0, 3.23.0
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            ...
            * Versiones compatibles verificadas: 4.4.0, 4.6.1, 4.7.0, 4.8.4, 4.8.5, 4.8.6
            ...
            * Versiones compatibles verificadas: 1.0.19239.1, 2.1.5, 3.1.1, 4.1.1, 5.0.1, 5.1.1, 5.2.0
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            ...
            * Versiones compatibles verificadas: 4.0.13
        ...
        <tr>
          ...
          <td>
            ...
            Versiones compatibles verificadas: 2.3.0, 2.8.1, 2.13.1, 2.14.1, 2.17.1, 2.19.0, 2.20.0, 2.21.0, 2.22.0, 2.23.0, 2.23.1, 2.24.0
        ...
        <tr>
          ...
          <td>
            ...
            * Versiones compatibles verificadas: 6.10.7, 8.0.15, 8.0.30, 8.0.33, 8.1.0, 8.2.0, 8.3.0
            ...
            * Versiones compatibles verificadas: 1.0.1, 1.3.13, 2.1.2, 2.3.1, 2.3.3, 2.3.5
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            ...
            Versiones compatibles verificadas: 1.0.488, 1.1.608, 1.2.6, 2.0.601, 2.1.58, 2.2.88, 2.6.66, 2.6.116, 2.7.4, 2.7.10, 2.7.17, 2.7.33
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            ...
            * Versiones compatibles verificadas: 8.0.0, 8.1.0, 8.1.1, 8.9.1, 8.9.2, 8.9.3, 8.10.0, 8.11.0, 8.12.0
            ...
            * Versiones compatibles verificadas: 7.0.0, 7.17.5
      ...
      <tbody>
        <tr>
          ...
          <td>
            ...
            * Versiones compatibles verificadas: 1.4.0, 2.2.0
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            ...
            * Versiones compatibles verificadas: 3.5.2, 3.6.9, 4.1.3, 5.1.0, 5.2.0, 6.0.0, 6.2.1, 6.4.0, 6.5.0, 6.6.0
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            ...
            * Versiones compatibles verificadas: 7.1.0, 7.3.1, 8.1.1
          </td>
        </tr>
      </tbody>
    </table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Cuando instalas la infraestructura y el agente APM en el mismo host, se detectan automáticamente entre sí. Luego puede ver una lista de hosts en la UI de APM y filtrar los hosts de su infraestructura por aplicación APM en nuestra UI de infraestructura. Para obtener más información, consulte [Datos de APM en la UIde la infraestructura](/docs/infrastructure/new-relic-infrastructure/data-instrumentation/new-relic-apm-data-infrastructure).
      </td>
    </tr>
