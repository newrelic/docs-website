  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        Agregue estos argumentos a la <DoNotTranslate>**Azure App Service deploy -> Additional Deployment Options -> Additional Arguments**</DoNotTranslate>
        ...
        <DoNotTranslate>**Note**</DoNotTranslate> las comillas simples escapadas.
      </td>
    </tr>
  </tbody>
</table>
