...
<Callout variant="important">
  Los datos del rastreo de sesión <DoNotTranslate>**only**</DoNotTranslate> informarán a la primera aplicación de la lista. Otros datos del navegador se completarán en cada una de las hasta tres aplicaciones, pero los datos del rastreo de sesión se limitarán a la aplicación más específica.
</Callout>
