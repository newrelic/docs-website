...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Obtenga el [ID de cuenta](/docs/accounts/accounts-billing/account-structure/account-id) de la cuenta que desea habilitar. Luego use eso para ir a esta URL: `https://one.newrelic.com/admin-portal/apm-agents/hsm?account=YOUR_ACCOUNT_ID`. En esa página, puede configurar el modo de alta seguridad.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        Evita el perfilado de aplicaciones
      </td>

      <td>
        El modo de alta seguridad no permite que se reporten datos de perfilado de aplicaciones para lo siguiente:

        * [Perfilado en tiempo real para Java usando JFR](/docs/apm/agents/java-agent/features/real-time-profiling-java-using-jfr-metrics/)
      </td>
    </tr>
  </tbody>
</table>
