...
Para Laravel Horizon y Laravel Queue, configure [newrelic.daemon.app\_connect\_timeout](https://docs.newrelic.com/docs/apm/agents/php-agent/configuration/php-agent-configuration/#inivar-daemon-app_connect_timeout) Ajuste INI a 5s: Ajuste INI a 5s:
