...
<Callout variant="tip">
  <DoNotTranslate>**Note:**</DoNotTranslate> No asigne un nombre a su transacción con valores que cambien con frecuencia, como ID de usuario, hash, etc. Implemente [nombres de transacciones útiles](/docs/agents/php-agent/features/php-frameworks-integrating-support-new-relic) en su API de llamadas.
</Callout>
