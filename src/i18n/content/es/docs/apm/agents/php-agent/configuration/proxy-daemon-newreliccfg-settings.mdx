...
<CollapserGroup>
  ...
  >
    ...
    * `debug`
      ...
      Si tiene problemas con el daemon, establezca el nivel de registros <DoNotTranslate>**debug**</DoNotTranslate> durante al menos el tiempo suficiente para reproducir el problema. A menudo es necesario un <DoNotTranslate>**debug**</DoNotTranslate> archivo de registro para depurar problemas con el daemon proxy.
  ...
  >
    ...
    * <DoNotTranslate>**Recommended.**</DoNotTranslate> Para utilizar un archivo específico como socket de dominio UNIX (UDS), proporcione un nombre de ruta <DoNotTranslate>**absolute**</DoNotTranslate> como una cadena.
