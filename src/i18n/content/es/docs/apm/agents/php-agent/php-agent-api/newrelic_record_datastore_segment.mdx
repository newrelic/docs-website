...
Registra un segmento de almacenamiento de datos. Los segmentos de almacenamiento de datos aparecen en las pestañas <DoNotTranslate>**Breakdown table**</DoNotTranslate> y <DoNotTranslate>**Databases**</DoNotTranslate> de la [página de transacciones](/docs/apm/applications-menu/monitoring/transactions-page) en la UI de New Relic.
