...
Si es <DoNotTranslate>**using a third party error handler**</DoNotTranslate> (por ejemplo: [XDebug](https://xdebug.org/) o [el controlador de errores de Laravel)](https://laravel.com/docs/5.2/errors):
...
Si eres <DoNotTranslate>**not using a third party error handler**</DoNotTranslate>, pero aún no ves el error esperado (por ejemplo: errores 404):
