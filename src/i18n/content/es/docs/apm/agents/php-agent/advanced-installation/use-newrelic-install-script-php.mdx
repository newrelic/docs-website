...
<CollapserGroup>
  ...
  >
    Invoque el modo de instalación utilizando <DoNotTranslate>**one**</DoNotTranslate> de estos métodos:
  ...
  >
    ...
    <DoNotTranslate>**Example:**</DoNotTranslate> El menú muestra siete opciones:
  ...
  >
    Después de instalar New Relic con éxito y reiniciar su servidor web, puede comenzar a recopilar datos sobre su aplicación. Después de unos minutos, los datos comenzarán a aparecer en su [página APM <DoNotTranslate>**Summary**</DoNotTranslate> ](/docs/apm/apm-ui-pages/monitoring/apm-summary-page-view-transaction-apdex-usage-data/).
