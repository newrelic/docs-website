...
<CollapserGroup>
  ...
  >
    Los cambios de configuración en los archivos `newrelic.ini` o <DoNotTranslate>**`newrelic.cfg`**</DoNotTranslate> [no surten efecto](/docs/agents/php-agent/troubleshooting/ini-settings-not-taking-effect-immediately) (por ejemplo, nombrar su aplicación, generar un registro, cambiar su clave de licencia) hasta que reinicie el servidor web.
  </Collapser>
