  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        El símbolo del proceso de instalación para el nombre de su aplicación y la clave de licencia. Su <InlinePopover type="licenseKey"/>aparece en la sección de información de la cuenta de <DoNotTranslate>**Account settings**</DoNotTranslate>. Para la instalación sin cabeza, también puede [preconfigurar su clave de licencia y el nombre de la aplicación usando `debconf`](#preseeding).
      </td>
    </tr>
