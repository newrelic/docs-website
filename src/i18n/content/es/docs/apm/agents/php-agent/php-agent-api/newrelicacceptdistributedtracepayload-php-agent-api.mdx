---
title: newrelic_accept_distributed_trace_payload (API del agente PHP)
type: apiDoc
shortDescription: Acepta una carga útil rastreo distribuida.
tags:
  - Agents
  - PHP agent
  - PHP agent API
...
Acepta una carga útil rastreo distribuida.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Requerido: una cadena con formato JSON creada usando `newrelic_create_distributed_trace_payload`.
      </td>
    </tr>
  </tbody>
</table>
