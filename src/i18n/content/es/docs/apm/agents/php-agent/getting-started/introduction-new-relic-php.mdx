...
Reúna los datos de su log y de la aplicación para que la resolución de problemas sea más fácil y rápida. No es necesario cambiar a otra página de UI.

* Con [logs en el contexto](/docs/logs/logs-context/configure-logs-context-php/), puede ver el mensaje de log relacionado con sus errores y la traza directamente en UI de su aplicación.
...
* Cree y comparta [un dashboard](/docs/query-your-data/explore-query-data/query-builder/introduction-query-builder)interactivo y personalizable
...
* [Tiempo de carga de la página](/docs/agents/php-agent/features/page-load-timing-php): integre el agente PHP con [<InlinePopover type="browser" />](/docs/browser/new-relic-browser/getting-started/new-relic-browser)para obtener visibilidad de la actividad del usuario final.
