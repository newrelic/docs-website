...
## Lanzamientos de PHP [#php-release]
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        La compatibilidad con las versiones 7.0 y 7.1 de PHP finalizará el <DoNotTranslate>**EOL**</DoNotTranslate> 1 de junio de 2024.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        [La compilación Just-In-Time](https://php.watch/articles/jit-in-depth) se admite a partir de la versión 10.18.0.8 del agente. PHP desactiva automáticamente JIT para cualquier versión anterior del agente PHP.

        PHP 8.1 y posteriores no son compatibles con [Fibers](https://www.php.net/manual/en/language.fibers.php).
      </td>
    </tr>
  </tbody>
</table>
...
* Para las compilaciones de PHP compiladas con Zend Thread Safety (ZTS), solo [el agente PHP 9.19](/docs/release-notes/agent-release-notes/php-release-notes/php-agent-9190309) y versiones anteriores admiten estas compilaciones.
...
Instalando el acceso root del agente PHP <DoNotTranslate>**requires**</DoNotTranslate> a:
...
Ejecutando el acceso raíz del agente <DoNotTranslate>**does not require**</DoNotTranslate> . El agente necesita acceso de lectura/escritura a los siguientes archivos (la ubicación de estos archivos se puede [personalizar en la configuración del agente PHP](/docs/php/php-agent-phpini-settings)):
    ...
    <tr>
      ...
      <td>
        ...
        * Cualquier otra distribución de Linux con:
          ...
          * glibc 2.17 o superior con soporte [NPTL](https://en.wikipedia.org/wiki/Native_POSIX_Thread_Library) o musl libc versión 1.1.24 y más alto
      </td>
    ...
    <tr>
      ...
      <td>
        ...
        * La distribución de origen del agente PHP 9.18.1 - 10.9.0 proporciona compatibilidad con ARM64 SÓLO en Amazon Linux 2 (incluido AWS Graviton 2) y Centos 8.
          ...
          Para obtener más información sobre la compatibilidad y la instalación de ARM64, consulte [la información de instalación de ARM64](/docs/apm/agents/php-agent/installation/php-agent-installation-arm64).
      </td>
    </tr>
  </tbody>
</table>
...
Si desea sugerir soporte para otros frameworks PHP populares, visite el [Foro de soporte](https://discuss.newrelic.com/tags/phpagent) y cree un `Feature Idea`. Para obtener más información, consulte [frameworks PHP: integración del soporte para New Relic](/docs/php/framework-developers-integrated-support-for-new-relic).
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        [Logs en contexto](/docs/logs/logs-context/configure-logs-context-php/)
      </td>
