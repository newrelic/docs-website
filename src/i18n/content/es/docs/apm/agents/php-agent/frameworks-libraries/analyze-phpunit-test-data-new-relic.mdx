...
<CollapserGroup>
  ...
  >
    <DoNotTranslate>**TestSuite**</DoNotTranslate> evento incluye el siguiente atributo:
  ...
  >
    <DoNotTranslate>**Test**</DoNotTranslate> evento incluye el siguiente atributo:
    ...
    <table>
      ...
      <tbody>
        ...
        <tr id="test-message">
          ...
          <td>
            Cualquier mensaje asociado con el resultado de la prueba. Por ejemplo: <DoNotTranslate>**Failed asserting that false is true**</DoNotTranslate> o <DoNotTranslate>**This test depends on 'StackTest::testFailure' to pass.**</DoNotTranslate>.
          </td>
        </tr>
        ...
        <tr id="test-outcome">
          ...
          <td>
            El resultado de la prueba. Las opciones incluyen <DoNotTranslate>**passed**</DoNotTranslate>, <DoNotTranslate>**failed**</DoNotTranslate>, <DoNotTranslate>**skipped**</DoNotTranslate>, <DoNotTranslate>**risky**</DoNotTranslate>, <DoNotTranslate>**warning**</DoNotTranslate> y <DoNotTranslate>**incomplete**</DoNotTranslate>.
          </td>
        </tr>
