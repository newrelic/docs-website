...
Cuando el daemon está en un estado inicial o inactivo, debe ocurrir <DoNotTranslate>**two**</DoNotTranslate> transacción antes de que comience a informar.

En un estado <DoNotTranslate>**initial**</DoNotTranslate> :
...
En un estado <DoNotTranslate>**idle**</DoNotTranslate> :
...
* <DoNotTranslate>**Recommended process:**</DoNotTranslate> Utilice `/etc/init.d/newrelic-daemon stop`. Este es el método preferido para interactuar con el daemon.
