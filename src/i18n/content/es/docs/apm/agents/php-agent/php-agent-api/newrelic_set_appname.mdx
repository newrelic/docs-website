  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        Si `true`, el agente envía los datos que se recopilaron justo antes de ejecutar esta llamada. <DoNotTranslate>**The data is associated with the old app name**</DoNotTranslate>. Esto tiene un impacto muy leve en el rendimiento, ya que el agente tarda unos milisegundos en volcar sus datos.
      </td>
    </tr>
  </tbody>
</table>
