...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Requerido. Nombra tu métrica personalizada con un prefijo <DoNotTranslate>**Custom/**</DoNotTranslate> (por ejemplo, <DoNotTranslate>**Custom/MyMetric**</DoNotTranslate>). Esto ayuda a que la UI organice sus métricas personalizadas en un solo lugar y las hace fáciles de encontrar a través del Explorador de métricas.
      </td>
    </tr>
