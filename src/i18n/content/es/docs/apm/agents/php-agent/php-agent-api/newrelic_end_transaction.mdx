  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        Si `false` o se omite, datos de la transacción <DoNotTranslate>**is**</DoNotTranslate> registrada por el daemon.

        Si es `true`, datos de la transacción <DoNotTranslate>**is not**</DoNotTranslate> registrada por el daemon.
      </td>
    </tr>
  </tbody>
</table>
