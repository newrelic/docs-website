...
<DoNotTranslate>**PHP version 5.6 or higher**</DoNotTranslate>: Haga que el agente PHP note errores desde su propio controlador de errores.
...
<DoNotTranslate>**PHP version 5.5 or lower**</DoNotTranslate>: Haga que el agente PHP note errores desde su propio controlador de errores.
