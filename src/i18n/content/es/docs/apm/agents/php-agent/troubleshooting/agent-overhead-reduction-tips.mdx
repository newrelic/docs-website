...
Una fuente de reloj de bajo rendimiento puede afectar al agente que verifica la hora para cada span. Asegúrese de usar un [clocksource](https://support.newrelic.com/s/hubtopic/aAX8W0000008a7rWAA/relic-solution-php-agent-cpu-overhead-tips) adecuado. Fargate se ve afectado por el clocksource y se sabe que causa una [sobrecarga](/docs/apm/agents/php-agent/troubleshooting/fargate-nitro-clock-performance-impact/) adicional.