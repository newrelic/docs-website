...
Para instalar o actualizar el agente PHP de New Relic en ARM64 con la versión 9.18.0 - 10.9.0 del agente PHP de New Relic, debe instalar la fuente del agente PHP de New Relic para la plataforma ARM64 <DoNotTranslate>**[github.com/newrelic/newrelic-php-agent](https://github.com/newrelic/newrelic-php-agent)**</DoNotTranslate>.

La creación del agente PHP New Relic para ARM64 desde el código fuente solo es compatible con Amazon Linux 2 y CentOS Linux 8 (incluido el uso con <DoNotTranslate>**[AWS Graviton 2 processor](https://aws.amazon.com/ec2/graviton/)**</DoNotTranslate>)
...
Clonar de <DoNotTranslate>**[github.com/newrelic/newrelic-php-agent](https://github.com/newrelic/newrelic-php-agent)**</DoNotTranslate>. Aquí también puede sugerir un cambio y aprender cómo [contribuir](https://github.com/newrelic/newrelic-php-agent/issues) a nuestro repositorio de código abierto del agente PHP.

### Construir [#install]

<Callout variant="tip">
  El archivo <DoNotTranslate>**[docs/development.md](https://github.com/newrelic/newrelic-php-agent/blob/main/docs/development.md)**</DoNotTranslate> en el repositorio PHP de newrelic-agente tiene una guía detallada para la instalación.
</Callout>
