...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        En la sección <DoNotTranslate>**transaction_events**</DoNotTranslate> , ajuste la [configuración](/docs/agents/java-agent/configuration/java-agent-configuration-config-file#ae-max_samples_stored) para `max_samples_stored`.
      </td>
    </tr>
