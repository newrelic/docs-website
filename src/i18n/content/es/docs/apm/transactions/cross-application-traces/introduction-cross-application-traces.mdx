...
<Callout variant="important">
  En lugar de utilizar el rastreo multiaplicación, recomendamos nuestro [rastreo distribuido característico](/docs/apm/distributed-tracing/getting-started/introduction-distributed-tracing). rastreo distribuido es una mejora de la característica de rastreo multiaplicación y se recomienda para sistemas distribuidos grandes.
</Callout>
