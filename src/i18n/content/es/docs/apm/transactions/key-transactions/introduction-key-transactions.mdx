...
<CollapserGroup>
  ...
  >
    ...
    1. Vaya a
       ...
       y seleccione una transacción clave.

    2. Cerca del nombre de la entidad en la parte superior de la página, seleccione el menú
    ...
    3. En el campo
       ...
       del menú emergente, agregue una etiqueta con este formato: `accountId: 123456789`.
