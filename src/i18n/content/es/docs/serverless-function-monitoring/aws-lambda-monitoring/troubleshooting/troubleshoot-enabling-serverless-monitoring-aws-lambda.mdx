...
* No veo datos en la página UI
  ...
  <DoNotTranslate>**CloudWatch metrics**</DoNotTranslate>
...
* No veo datos en
  ...
  <DoNotTranslate>**Troubleshooting**</DoNotTranslate>
  ...
  <DoNotTranslate>**Invocations**</DoNotTranslate>
...
<CollapserGroup>
  ...
  >
    ...
    2. Haga clic en el enlace <DoNotTranslate>**logs**</DoNotTranslate> después de que se ejecute su función.

    3. Esto lo llevará al registro de CloudWatch en AWS. En la barra lateral izquierda de AWS, en <DoNotTranslate>**Logs**</DoNotTranslate>, haga clic en <DoNotTranslate>**Insights.**</DoNotTranslate>

    4. Selecciona tu transmisión <DoNotTranslate>**function**</DoNotTranslate> y también la <DoNotTranslate>**newrelic-log-ingestion**</DoNotTranslate> .

    5. Aplique un <DoNotTranslate>**Time Filter**</DoNotTranslate> apropiado y una entrada log <DoNotTranslate>**limit**</DoNotTranslate> (el valor predeterminado de 20 puede no ser suficiente).

    6. En <DoNotTranslate>**Actions**</DoNotTranslate> seleccione <DoNotTranslate>**Copy query results (ASCII)**</DoNotTranslate>.

    7. Pegue el texto copiado en un nuevo archivo de texto, luego <DoNotTranslate>**save and upload the text file to the ticket.**</DoNotTranslate>
