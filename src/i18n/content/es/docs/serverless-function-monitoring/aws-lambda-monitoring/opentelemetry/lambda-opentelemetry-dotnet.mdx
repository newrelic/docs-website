...
<Steps>
  ...
  <Step>
    ...
    9. Elija <DNT>**Add environment variable**</DNT> nuevamente.
    10. Para <DNT>**Key**</DNT> configúrelo en `OTEL_SERVICE_NAME` y establezca <DNT>**Value**</DNT> en el nombre de su función. Luego elija <DNT>**Save**</DNT>.
  ...
  <Step>
    ## Configurar el Collector [#collector]
  ...
  <Step>
    ...
    El anterior es solo un ejemplo básico, para una instrumentación más avanzada, consulte la [documentación del SDK de .NET de OpenTelemetry](https://github.com/open-telemetry/opentelemetry-dotnet).
  </Step>
