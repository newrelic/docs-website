...
3. En
   ...
   , pegue uno de los ARN de capa para la arquitectura de su función de la lista siguiente. Reemplace `{region}`con su región de AWS, como `us-east-1`.
...
5. Para
   ...
   configúrelo en `AWS_LAMBDA_EXEC_WRAPPER` y configure

   <DoNotTranslate>**Value**</DoNotTranslate>

   en una de las siguientes opciones (depende de su tipo de controlador). Luego elija
