...
<CollapserGroup>
  ...
  >
    ...
    3. Deshabilite la extensión agregando la variable de entorno `NEW_RELIC_LAMBDA_EXTENSION_ENABLED` a su función, con el valor `false`.

    4. Cree un filtro de suscripción de logs de CloudWatch para invocar la función `newrelic-log-ingestion` con el log de su función.
