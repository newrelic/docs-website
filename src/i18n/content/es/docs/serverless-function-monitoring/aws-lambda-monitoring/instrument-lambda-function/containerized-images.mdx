...
<img title="containerized images " alt="A diagram demonstrating how New Relic integrates with your Lambda containerized function." src={serverlessContainerizedImagesWithLambda} />
