...
1. Ejecute lo siguiente, reemplazando `YOUR_REGION` con su región (por ejemplo, `us-west-2`).
   ...
   Si creó la stack de CloudFormation existente con el parámetro stack FunctionRole, especifique el nombre del rol de función con `--parameter-overrides` como se muestra a continuación.
