...
Nuestros ejemplos están publicados, junto con la New Relic Lambda Extension, en este [repositorio de GitHub](https://github.com/newrelic/newrelic-lambda-extension-rust). Hay uno para cada runtime de Lambda que admite New Relic:
...
<DocTiles>
  <DocTile title="Compatibilidad y requisitos" path="/docs/serverless-function-monitoring/aws-lambda-monitoring/instrument-lambda-function/compatibility-requirement-lambda-monitoring">
    Obtenga más información sobre los runtimes compatibles y los requisitos previos.
  </DocTile>
  ...
  <DocTile title="Datos e UI" path="/docs/serverless-function-monitoring/aws-lambda-monitoring/ui-data/understand-lambda-monitoring-ui/">
    Aprenda a usar New Relic para monitorear las funciones de AWS Lambda.
  </DocTile>
