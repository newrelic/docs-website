...
<CollapserGroup>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Mapea cada namespace de Kubernetes a una clave de licencia de New Relic para el enrutamiento de exportación OTLP de múltiples cuentas. Los namespace que no están presentes en el mapa recurren al 
        ...
        <tr>
          ...
          <td>
            Especifica un secreto de Kubernetes existente que contiene una clave 

            `NAMESPACE_LICENSE_KEY_MAP`

             con un mapa de namespace a clave de licencia codificado en JSON. Use esto en lugar de 

            `namespaceLicenseKeys`

             para evitar almacenar la clave de licencia en values.yaml.
          </td>
        ...
        <tr>
          ...
          <td>
            Especifica la región de la cuenta de New Relic. Valores aceptados: 
            ...
            `US`
             ...
             (predeterminado). Requerido cuando se usa 
        ...
        <tr>
          ...
          <td>
            Activa extremos compatibles con FedRAMP (

            `gov-otlp.nr-data.net`

            ). Esta es la forma preferida de activar el cumplimiento de FedRAMP y tiene prioridad sobre la detección basada en la región (equivalente a 

            `region="GOV"`

            ). También puede configurarlo con 
        ...
        <tr>
          ...
          <td>
            Controla el reporte del log de aplicación. Valores aceptados: 
            ...
            `"auto"`
             ...
             (enviar a menos que el agente APM adjunto esté recopilando logs activamente por sí mismo, o que haya un agente OTel adjunto). Consulte 

            [Detección automática y retroceso](/docs/ebpf/logs/#automatic-backoff)
        ...
        <tr>
          <td>
            `agentMetadataReporting`
          </td>

          <td>
            Habilita el reporte de metadatos de agente y entidad. Por defecto, el agente exporta los metadatos de agente y entidad a New Relic a través de HTTP. Establezca esto en 

            `false`

             para deshabilitar por completo la ruta de exportación HTTP del reporte de metadatos.
          </td>
        ...
        <tr>
          ...
          <td>
            Controla el reporte de telemetría de GenAI. Valores aceptados: 
            ...
            `"auto"`
             ...
             (enviar solo cuando ningún agente APM de lenguaje o agente OTel ya esté reportando datos de monitoreo de IA para la entidad).
          </td>
        ...
        <tr>
          <td>
            `ai_monitoring.samplingLatency`
          </td>

          <td>
            Define el umbral de muestreo basado en latencia para exportar spans de GenAI. Admite cualquier percentil de 
        ...
        <tr>
          <td>
            `ai_monitoring.samplingErrorRate`
          </td>

          <td>
            Define el umbral de la tasa de errores para una ruta de GenAI donde superarlo significa que se exportan los spans correspondientes de la ruta. Opciones: 
        ...
        <tr>
          <td>
            `ai_monitoring.genAICaptureMessageContent`
          </td>
          ...
          <td>
            ...
            , captura el contenido completo del símbolo y la finalización para las interacciones de GenAI. Solo tiene efecto cuando 
        ...
        <tr>
          ...
          <td>
            Define los patrones de normalización de rutas HTTP. Cada patrón debe contener al menos un comodín 
            ...
            `!`
             ...
             para los patrones de exclusión a fin de preservar las rutas tal como están (omitir el clúster automático). El agente aplica estos patrones antes del clúster automático y tienen prioridad sobre este.
          </td>
        ...
        <tr>
          ...
          <td>
            Establece el número máximo de bytes capturados del cuerpo de una solicitud/respuesta HTTP. Predeterminado: 
            ...
            `1024`
             ...
             (1 KB). Aumente este valor si New Relic trunca la carga del monitoreo de IA.
          </td>
  ...
  <Collapser id="log-data-filters" title="Filtros de datos de log">
    Configure filtros para controlar el log de aplicación que el agente eBPF recopila y reporta. Esta configuración solo tiene efecto cuando `reportLogs` se establece en `"true"` o `"auto"`.
    ...
    <table>
      ...
      <tbody>
        <tr>
          <td>
            `logDataFilters.applicationLogReporting.enabled`
          </td>

          <td>
            Habilita la recopilación de logs de las entidades que coinciden con los filtros a continuación.
          </td>
        ...
        <tr>
          <td>
            `logDataFilters.applicationLogReporting.fileRegex`
          </td>

          <td>
            Expresión regular para coincidir con los nombres de los archivos de log que se incluirán.
          </td>
        ...
        <tr>
          <td>
            `logDataFilters.applicationLogReporting.logLevelThreshold`
          </td>

          <td>
            Nivel de logs mínimo para reportar (por ejemplo, 
        ...
        <tr>
          <td>
            `logDataFilters.applicationLogReporting.maxSamplesPerMinute`
          </td>

          <td>
            Número máximo de muestras de log para recopilar por minuto de una entidad. Una vez que se alcanza este límite, los eventos se muestrean para mantener una distribución uniforme a lo largo del ciclo de recolección.
          </td>
        ...
        <tr>
          <td>
            `logDataFilters.applicationLogReporting.keepStdStreamEntityRegex`
          </td>

          <td>
            Expresión regular para coincidir con los nombres de las entidades y conservar los logs de STDOUT y STDERR. Use 

            `.*`

             para reenviar los logs de todas las entidades.
          </td>
        ...
        <tr>
          <td>
            `logDataFilters.applicationLogReporting.keepFileEntityRegex`
          </td>

          <td>
            Expresión regular para coincidir con los nombres de las entidades para conservar los logs de los archivos de log. Use 
  ...
  <Collapser id="protocol-tracing" title="Configuración de seguimiento de protocolo">
    ...
    * DNS
    ...
    El rastreo del protocolo de MySQL (`protocols.mysql`) también cubre MariaDB y Aurora MySQL, ya que ambos motores utilizan el mismo protocolo de red que MySQL. La configuración no requiere una sección `mariadb` o `aurora_mysql` independiente; habilitar o deshabilitar `protocols.mysql` controla el rastreo para todos los motores compatibles. El agente detecta automáticamente el tipo específico de base de datos por conexión durante el protocolo de enlace del servidor y lo informa en cada registro. No se puede configurar esta detección manualmente.
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Define el umbral de muestreo basado en latencia para exportar spans. Admite valores de 
