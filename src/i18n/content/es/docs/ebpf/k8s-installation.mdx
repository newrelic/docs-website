    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Habilitar la generación de informes de métricas de red. Cuando está habilitado, el agente recopila e informa las métricas de red, incluidas las estadísticas de TCP. Se renombra de 

            `tcpStatsReporting`

            . El nombre anterior está en desuso, sin embargo, se admite la compatibilidad con versiones anteriores.
          </td>
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            Descartar datos de los servicios newrelic y newrelic-bundle. (RENOMBRADO de 

            `dropDataNewRelic`

             para mayor claridad. El nombre anterior está en desuso, pero aún se admite la compatibilidad con versiones anteriores).
          </td>
        ...
        <tr>
          ...
          <td>
            Lista de espacios de nombres de Kubernetes para los que el agente debe descartar todos los datos. (RENOMBRADO de 
        ...
        <tr>
          ...
          <td>
            Defina una expresión regular para que coincida con los nombres de los servicios de k8s para descartarlos. Ejemplo 
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Etiquetas de pod para que coincidan con el filtrado de datos APM. Un mapa vacío significa que no hay filtrado basado en etiquetas. (Ejemplo: dropPodLabels: 
        ...
        <tr>
          ...
          <td>
            Lista de nombres de entidades para descartar datos de APM de ebpf
          </td>
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            Etiquetas de pod para que coincidan con el filtrado de datos de métricas de red. Un mapa vacío significa que no hay filtrado basado en etiquetas. (Ejemplo: dropPodLabels: 
