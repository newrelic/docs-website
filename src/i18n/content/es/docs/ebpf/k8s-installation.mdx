    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            HTTP/HTTPS proxy hostname for routing OTLP telemetry data through a corporate proxy. If empty, no proxy is used.
          </td>
        ...
        <tr>
          ...
          <td>
            Proxy URL scheme. Accepted values: 
        ...
        <tr>
          ...
          <td>
            Username for proxy Basic Authentication. If empty, no authentication is used.
          </td>
        ...
        <tr>
          ...
          <td>
            Password for proxy Basic Authentication. Only used together with 
        ...
        <tr>
          ...
          <td>
            Complete proxy URL. When set, this overrides the individual 
        ...
        <tr>
          ...
          <td>
            Name of an existing Kubernetes secret containing proxy credentials. The secret must contain the keys 
