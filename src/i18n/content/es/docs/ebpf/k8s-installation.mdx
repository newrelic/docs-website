...
<CollapserGroup>
  <Collapser id="general-configuration" title="Configuración general">
    ...
    <Callout variant="important">
      El proxy HTTPS no es compatible con el tráfico gRPC. Sin embargo, el tráfico TLS permanece seguro porque el túnel TLS se establece directamente entre el cliente y el extremo.
    </Callout>
  </Collapser>
