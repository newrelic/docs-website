...
<CollapserGroup>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Controls application log reporting. Accepted values: 
            ...
            `"auto"`
             ...
             (send unless the attached APM agent is actively collecting logs itself, or an OTel agent is attached at all). See 

            [Automatic detection and backoff](/docs/ebpf/logs/#automatic-backoff)
  ...
  <Collapser id="log-data-filters" title="Log data filters">
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            Enables log collection from entities matching the filters below.
          </td>
        ...
        <tr>
          ...
          <td>
            Regular expression to match log file names to include.
          </td>
        ...
        <tr>
          ...
          <td>
            Minimum log level to report (for example, 
        ...
        <tr>
          ...
          <td>
            Maximum number of log samples to collect per minute from an entity. Once this limit is reached, events are sampled to maintain an even distribution across the harvest cycle.
          </td>
        ...
        <tr>
          ...
          <td>
            Regular expression to match entity names to keep logs from STDOUT and STDERR. Use 

            `.*`

             to forward logs for all entities.
          </td>
        ...
        <tr>
          ...
          <td>
            Regular expression to match entity names to keep logs from log files. Use 
