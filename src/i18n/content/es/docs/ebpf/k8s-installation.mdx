    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Enables agent and entity metadata reporting. By default, the agent exports agent and entity metadata to New Relic over HTTP. Set this to 

            `false`

             to disable the metadata reporting HTTP export path entirely.
          </td>
        ...
        <tr>
          ...
          <td>
            Controls GenAI telemetry reporting. Accepted values: 
            ...
            `"auto"`
             ...
             (send only when no language APM or OTel agent is already reporting AI monitoring data for the entity).
          </td>
        ...
        <tr>
          ...
          <td>
            Defines the latency-based sampling threshold for exporting GenAI spans. Supports any percentile from 
        ...
        <tr>
          ...
          <td>
            Defines the error-rate threshold for a GenAI route where surpassing it means the corresponding spans of the route are exported. Options: 
        ...
        <tr>
          ...
          <td>
            ...
            , captures full prompt and completion content for GenAI interactions. Only takes effect when 
