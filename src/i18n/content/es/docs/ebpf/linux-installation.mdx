    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Establece la ruta del directorio donde se descargan y colocan los encabezados de Linux necesarios para que los emplee el agente eBPF. Esto es útil en entornos restringidos donde el agente no puede descargar los encabezados de Linux necesarios. El agente identifica los encabezados requeridos según la versión del kernel.
          </td>
