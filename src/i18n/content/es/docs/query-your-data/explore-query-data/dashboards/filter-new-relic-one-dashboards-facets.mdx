---
title: Filtrar el dashboard de New Relic por facetas
tags:
  - Query your data
...
Puede filtrar su [dashboard de New Relic](/docs/dashboards/new-relic-one-dashboards/get-started/introduction-new-relic-one-dashboards) por atributo facetado, lo que hace que su dashboard sea más interactivo y fácil de usar.

## ¿Por qué utilizar el filtrado de facetas? [#feature]

Para nuestro [dashboard](/docs/dashboards/new-relic-one-dashboards/get-started/introduction-new-relic-one-dashboards), cualquier consulta NRQL que contenga una [cláusula`FACET` ](/docs/query-data/nrql-new-relic-query-language/getting-started/nrql-syntax-components-functions#sel-facet)y cumpla otros [requisitos de tipo de gráfico](#requirements), puede configurar el atributo facetado para filtrar el dashboard actual o un dashboard vinculado relacionado. Al permitirle filtrar rápidamente su dashboard y vincularlo a un dashboard prefiltrado, su dashboard es más interactivo y fácil de usar.
...
Para más información sobre esta característica, consulte la [publicación en el foro de soporte sobre el filtrado de facetas](https://support.newrelic.com/s/hubtopic/aAX8W0000008aPj/facet-linking-in-new-relic-one-now-you-can-use-facets-to-filter-your-new-reli).
...
Luego, utilizando el enlace de facetas, puede filtrar su dashboard por esas facetas.