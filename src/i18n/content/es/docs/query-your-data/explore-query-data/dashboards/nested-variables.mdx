...
<Callout variant="tip">
  Para reducir el desorden en la barra de variables, oculte las variables padre o de soporte que no requieren la entrada del usuario. Las variables ocultas siguen funcionando normalmente. Para obtener más información, consulta [Mostrar y ocultar variables](/docs/query-your-data/explore-query-data/dashboards/dashboard-template-variables/#variable-visibility).
</Callout>