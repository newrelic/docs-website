...
<Tabs>
  ...
  <TabsPages>
    <TabsPageItem id="dashboard">
      ...
      * Si comparte un dashboard con widgets que utilizan variables de plantilla, vinculación de facetas, visualizaciones personalizadas, tablas de logs o gráficos basados en SQL ([<DNT>Lens</DNT>](/docs/new-relic-lens/query-data)), estos widgets no mostrarán ninguna información en la vista compartida.
