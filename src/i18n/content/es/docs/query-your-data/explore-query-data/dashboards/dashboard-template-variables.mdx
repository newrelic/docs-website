...
El conmutador <DNT>**Include variable**</DNT> le permite establecer un valor deseado e incluir o excluir ese valor en sus dashboards. Consulte la sección [variables de plantilla](#create-variables) para obtener más información.
...
Puede ocultar las variables de plantilla de la barra de variables en el modo Vista mientras continúan funcionando normalmente en segundo plano. En el modo de edición, las variables ocultas se muestran con un ícono <Icon name="fe-eye-off" />, para que los editores de dashboards puedan identificarlas y gestionarlas.

Considere ocultar las variables que:

* Agregar desorden a la barra de variables, como [variables anidadas](/docs/query-your-data/explore-query-data/dashboards/nested-variables)
* Potencie la lógica del dashboard sin necesidad de entradas del visualizador
* Derivar valores automáticamente de otras variables

Para configurar la visibilidad, utilice la opción <DNT>**Hide on variables bar**</DNT> al [definir una variable de plantilla](#step1). Para acceso programático, use el campo `hiddenOnVariablesBar` en la [API de dashboards de NerdGraph](/docs/apis/nerdgraph/examples/nerdgraph-dashboards).
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Opcional. Active este interruptor para ocultar la variable de la barra de variables en el modo de visualización. La variable continúa funcionando normalmente en segundo plano. En el modo de edición, las variables ocultas se muestran con un icono <Icon name="fe-eye-off" />. Para obtener más información, consulte [Mostrar y ocultar variables](#variable-visibility).
          </td>
        </tr>
      </tbody>
    </table>
