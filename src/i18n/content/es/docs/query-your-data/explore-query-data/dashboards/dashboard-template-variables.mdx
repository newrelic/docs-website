...
<CollapserGroup>
  ...
  >
    ...
    1. Desde un nuevo dashboard sin variables, haga clic en editar <Icon name="fe-edit-2"/> y luego haga clic en el botón <DNT>**+ Add variable**</DNT> ubicado en la esquina superior izquierda. Una vez que haya terminado de agregar variables, haga clic en <DNT>**Done editing**</DNT>.
...
Este es un ejemplo del widget resultante, a la derecha, con el menú desplegable `country` a la izquierda.<img title="Country template variable example" alt="Country template variable example" src="/images/dashboards_screenshot-crop_country-variable-example.webp"/>
...
<CollapserGroup>
  ...
  <Collapser
    id="from-data-types"
    title="Emplee variables para seleccionar su tipo de datos `FROM`"
  >
