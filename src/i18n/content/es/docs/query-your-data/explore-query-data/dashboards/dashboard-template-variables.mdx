...
Cuando habilitas el interruptor <DNT>**Include variable**</DNT> y seleccionas un valor, los datos del dashboard se filtran por ese valor. Puedes hacer clic en <DNT>**Refresh to default value**</DNT> para restaurar los valores predeterminados configurados. Para obtener más información, consulte las [variables de plantilla](#create-variables).
