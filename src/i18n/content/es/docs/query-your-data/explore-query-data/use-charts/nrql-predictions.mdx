...
<DNT>**NRQL predictions**</DNT> está disponible para todos los clientes y todos los usuarios. Los [CCU Core](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing/#core-compute-capacity-unit) se consumen cuando se ejecutan consultas de NRQL con la cláusula `PREDICT`.
...
<CollapserGroup>
  ...
  >
    ...
    <figcaption>
      \{&lt;&gt;Ejemplo de predicciones realizadas con la palabra clave &lt;InlineCode&gt;BY&lt;/InlineCode&gt;. El área recuadrada indica qué sección del gráfico se ve afectada por la palabra clave &lt;InlineCode&gt;BY&lt;/InlineCode&gt;.&lt;/&gt;}
    </figcaption>
  </Collapser>
  ...
  >
    ...
    <figcaption>
      \{&lt;&gt;Ejemplo de predicciones realizadas con la palabra clave &lt;InlineCode&gt;USING&lt;/InlineCode&gt;. La palabra clave &lt;InlineCode&gt;USING&lt;/InlineCode&gt; afecta la cantidad de datos utilizados para el entrenamiento que no se visualizan en el gráfico.&lt;/&gt;}
    </figcaption>
  </Collapser>
