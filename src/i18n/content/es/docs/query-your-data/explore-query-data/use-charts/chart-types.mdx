...
<CollapserGroup>
    ...
    <table>
      <tbody>
        <tr>
          ...
          <td>
            Monitor los valores, incluido el umbral para los estados <DoNotTranslate>**Critical**</DoNotTranslate> y <DoNotTranslate>**Warning**</DoNotTranslate>, en una fuente grande y fácil de leer.
          </td>
        </tr>
  ...
  >
    ...
    Bullet tiene por defecto un límite que es el doble del valor de la consulta resultante. Para ajustar el límite, use el campo <DoNotTranslate>**Limit**</DoNotTranslate> para ingresar otro número. La bala se ajustará en consecuencia.
  ...
  >
    ...
    Para utilizar esto, seleccione el menú <DoNotTranslate>**Share**</DoNotTranslate> y haga clic en <DoNotTranslate>**Copy JSON**</DoNotTranslate>.
  ...
  >
    ...
    4. Haga clic en la entidad que le interese y luego, en el menú desplegable, haga clic en uno de los enlaces de esa entidad (verá los enlaces <DoNotTranslate>**Entity summary**</DoNotTranslate> y <DoNotTranslate>**Logs**</DoNotTranslate> ).
