...
1. En New Relic, [cree una nueva clave de consulta de Insights](/docs/apis/intro-apis/new-relic-api-keys/#insights-query-key).
   ...
   <Callout variant="important">
     En Grafana, deberá poner esto en un encabezado HTTP <DNT>**X-Query-Key**</DNT> personalizado (consulte el paso 7 a continuación), pero es la misma entidad que la consulta de New Relic.

     Si su cuenta está en la **región JP**, las claves de consulta de Insights no son compatibles. Cree una [clave de API de usuario](/docs/apis/intro-apis/new-relic-api-keys/#user-key) en su lugar, y úsela con el encabezado <DNT>**api-key**</DNT> en el paso 7.
   </Callout>
...
6. Ingrese el <DNT>**URL**</DNT> correcto:
   ...
   * EE. UU. (predeterminado): [prometheus-api.newrelic.com](https://prometheus-api.newrelic.com)
...
7. En <DNT>**Custom Headers**</DNT>, seleccione <DNT>**Add Header**</DNT>. Para las cuentas de EE. UU. y la UE, establezca el nombre de <DNT>**Header**</DNT> en <DNT>**X-Query-Key**</DNT> e ingrese la consulta de Insights del paso 1. Para las cuentas de JP, establezca el nombre de <DNT>**Header**</DNT> en <DNT>**api-key**</DNT> e ingrese la clave de API de usuario del paso 1.
...
<CollapserGroup>
  <Collapser id="" title="Imagen de configuración de muestra">
...
<CollapserGroup>
  <Collapser id="" title="X-consulta (Clave de consulta)">
    ...
    **Excepción de la región JP**: la región JP no admite la consulta de Insights. Utilice una [clave de API de usuario](/docs/apis/intro-apis/new-relic-api-keys/#user-key) con el nombre de encabezado <DNT>**api-key**</DNT> en lugar de <DNT>**X-Query-Key**</DNT>.
  </Collapser>

  <Collapser id="" title="Solo X-Prometheus">
    <Callout variant="important">
  ...
  <Collapser id="" title="Servidor X-Prometheus">
...
1. Vaya a <DNT>**Configuration &gt; Data Sources**</DNT>.
2. Haga clic en la fuente de datos que desea eliminar.
3. Haga clic en el botón <DNT>**Delete**</DNT> en la parte inferior de la página.