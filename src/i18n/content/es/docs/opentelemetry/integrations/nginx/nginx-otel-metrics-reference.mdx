...
* [Monitorear NGINX en entornos autohospedados](/docs/opentelemetry/integrations/nginx/nginx-otel-host/) - Configuración completa para despliegues en el host
* [Monitorear NGINX en Kubernetes](/docs/opentelemetry/integrations/nginx/nginx-otel-kubernetes/) - Configuración completa para despliegues de Kubernetes

**Uso de datos:**

* [Encuentra y consulta tus datos de NGINX](/docs/opentelemetry/integrations/nginx/find-and-query-your-data/) - Dashboards, consultas NRQL y alertas
