            ...
            <TabsPages>
              <TabsPageItem id="helm">
                **Paso 1. Crear secreto de credenciales de New Relic**
                ...
                <CollapserGroup>
                  <Collapser id="secret-us" title="Región de EE. UU. (predeterminado)">
                    ```bash
                  ...
                  <Collapser id="secret-jp" title="Región de JP">
                    ```bash
                    kubectl create secret generic newrelic-otlp-secret \
                      --namespace newrelic \
                      --from-literal=NEW_RELIC_LICENSE_KEY='your-license-key-here' \
              ...
              <TabsPageItem id="manifest">
                **Paso 1. Crear secreto de credenciales de New Relic**
                ...
                <CollapserGroup>
                  <Collapser id="manifest-secret-us" title="Región de EE. UU. (predeterminado)">
                    ```bash
                    kubectl create secret generic newrelic-otlp-secret \
                      --namespace newrelic \
                      --from-literal=NEW_RELIC_LICENSE_KEY='your-license-key-here' \
                  ...
                  <Collapser id="manifest-secret-jp" title="Región de JP">
                    ```bash
                    kubectl create secret generic newrelic-otlp-secret \
                      --namespace newrelic \
                      --from-literal=NEW_RELIC_LICENSE_KEY='your-license-key-here' \
            ...
            <TabsPages>
              <TabsPageItem id="helm-prom">
                ...
                **Paso 1. Crear secreto de credenciales de New Relic**
                ...
                <CollapserGroup>
                  <Collapser id="secret-us-prometheus" title="Región de EE. UU. (predeterminado)">
                    ```bash
                    kubectl create secret generic newrelic-otlp-secret \
                      --namespace newrelic \
                      --from-literal=NEW_RELIC_LICENSE_KEY='your-license-key-here' \
                  ...
                  <Collapser id="secret-jp-prometheus" title="Región de JP">
                    ```bash
                    kubectl create secret generic newrelic-otlp-secret \
                      --namespace newrelic \
                      --from-literal=NEW_RELIC_LICENSE_KEY='your-license-key-here' \
              ...
              <TabsPageItem id="manifest-prom">
                ...
                **Paso 1. Crear secreto de credenciales de New Relic**
                ...
                <CollapserGroup>
                  <Collapser id="manifest-secret-us-prometheus" title="Región de EE. UU. (predeterminado)">
                    ```bash
                    kubectl create secret generic newrelic-otlp-secret \
                      --namespace newrelic \
                      --from-literal=NEW_RELIC_LICENSE_KEY='your-license-key-here' \
                  ...
                  <Collapser id="manifest-secret-jp-prometheus" title="Región de JP">
                    ```bash
                    kubectl create secret generic newrelic-otlp-secret \
                      --namespace newrelic \
                      --from-literal=NEW_RELIC_LICENSE_KEY='your-license-key-here' \
