          ...
          <CollapserGroup>
            <Collapser id="configure-log-collection" title="Configurar la recopilación de logs">
              ...
              **Parámetro de configuración**
              ...
              | Multiple broker receivers                             | Para múltiples brokers, cree receptores `filelog` separados (p. ej., `filelog/kafka_broker_2`, `filelog/kafka_broker_3`) con sus respectivos ID de broker                                                |
