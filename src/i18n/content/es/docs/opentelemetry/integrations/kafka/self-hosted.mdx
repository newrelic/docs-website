    ...
    <TabsPageItem id="java-agent">
      ...
      <Steps>
        ...
        <Step>
          ...
          | `NEW_RELIC_OTLP_ENDPOINT`          | Extremo de ingesta de OTLP. Use `https://otlp.nr-data.net:4317` para la región de EE. UU. o `https://otlp.eu01.nr-data.net:4317` para la región de la UE. Para otras configuraciones, consulte [Configure su extremo OTLP](/docs/opentelemetry/best-practices/opentelemetry-otlp/#configure-endpoint-port-protocol). |
        </Step>
