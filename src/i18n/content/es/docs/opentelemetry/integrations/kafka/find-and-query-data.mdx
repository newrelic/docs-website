...
/\* ### 3. Servicios de terceros Ideal para: monitoreo enfocado en la integración 1. Vaya a &lt;DNT&gt;\*\*\[one.newrelic.com]\(https\://one.newrelic.com) &gt; All capabilities &gt; Infrastructure &gt; Third-party services\*\*&lt;/DNT&gt; 2. Selecciona &lt;DNT&gt;\*\*Kafka (OpenTelemetry)\*\*&lt;/DNT&gt; &gt; &lt;DNT&gt;\*\*OpenTelemetry Kafka\*\*&lt;/DNT&gt; &lt;img title=&quot;Servicios de terceros de Kafka OTel&quot; alt=&quot;Vista de servicios de terceros que muestra la integración de Kafka (OpenTelemetry)&quot; src=&quot;/images/infrastructure\_screenshot-crop\_otel-kafka-third-party-integrations.webp&quot; /&gt; \*/
...
<CollapserGroup>
  <Collapser id="cluster-overview-queries" title="Descripción general del clúster">
    Obtenga estadísticas de alto nivel y la salud del clúster:
...
1. Vaya a [one.newrelic.com](https://one.newrelic.com) &gt; <DNT>**Dashboards**</DNT>

2. Hacer clic <DNT>**Create a dashboard**</DNT>
...
* [Crear condiciones de alerta NRQL](/docs/alerts/create-alert/create-alert-condition/create-nrql-alert-conditions/) - Configurar el monitoreo proactivo
