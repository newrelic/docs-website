...
/\* ### 3. Servicios de terceros Ideal para: Monitoreo enfocado en la integración 1. Vaya a &lt;DNT&gt;\*\*\[one.newrelic.com]\(https\://one.newrelic.com) &gt; All capabilities &gt; Infrastructure &gt; Third-party services\*\*&lt;/DNT&gt; 2. Select &lt;DNT&gt;\*\*Kafka (OpenTelemetry)\*\*&lt;/DNT&gt; &gt; &lt;DNT&gt;\*\*OTel Kafka Dashboard\*\*&lt;/DNT&gt; &lt;img title=&quot;Servicios de terceros de Kafka OTel&quot; alt=&quot;Vista de servicios de terceros que muestra la integración de Kafka (OpenTelemetry)&quot; src=&quot;/images/infrastructure\_screenshot-crop\_otel-kafka-third-party-integrations.webp&quot; /&gt; \*/
...
2. Buscar <DNT>**&quot;OTel Kafka Dashboard&quot;**</DNT>
...
<CollapserGroup>
  <Collapser id="cluster-overview-queries" title="Descripción general del clúster">
    Obtenga estadísticas de clúster de alto nivel:
  ...
  <Collapser id="cluster-health-queries" title="Estado del clúster">
    Realice un seguimiento del estado general del clúster y el estado de la partición:
