...
<Steps>
  ...
  <Step>
    ...
    Cree una nueva definición de tarea de ECS que incluya el contenedor sidecar del recolector. Elija entre NRDOT Collector (distribución de New Relic) u OpenTelemetry Collector, luego seleccione la definición de tarea para su plataforma de contenedores:

    <Tabs>
      <TabsBar>
        <TabsBarItem id="ec2-nrdot">Collector NRDOT</TabsBarItem> <TabsBarItem id="ec2-otel">Collector OpenTelemetry</TabsBarItem>
      </TabsBar>

      <TabsPages>
        <TabsPageItem id="ec2-nrdot">
          <Callout variant="tip">
            **NRDOT Collector** es la distribución de New Relic de OpenTelemetry Collector con soporte de New Relic para asistencia. Agrupa los receptores `awsecscontainermetrics` y `hostmetrics` utilizados por esta configuración, por lo que se ejecuta con la misma configuración del recolector que guardó en el paso anterior.
          </Callout>
