...
Esta página describe cómo New Relic maneja OpenTelemetry métrica que recibe a través del [extremo OTLPNew Relic ](/docs/opentelemetry/best-practices/opentelemetry-otlp). La integración de OpenTelemetry métrica con New Relic requiere configurar la fuente métrica para exportar a este extremo; revise los requisitos de configuración del extremo. Para información sobre la configuración de servicios con OpenTelemetry métrica consulte [OpenTelemetry APM monitoreo](/docs/opentelemetry/get-started/apm-monitoring/opentelemetry-apm-intro).
