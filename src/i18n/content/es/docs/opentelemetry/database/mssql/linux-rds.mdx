...
<Steps>
  ...
  <Step>
    ...
    | `<YOUR_NEWRELIC_PASSWORD>` | La contraseña que estableció para el usuario newrelic                                                                                                                                        |
    | `<YOUR-RDS-ENDPOINT>`      | Su extremo de RDS SQL Server (por ejemplo, `mydb-instance.xxxxxxxxxxxx.us-east-1.rds.amazonaws.com`)                                                                                         |
