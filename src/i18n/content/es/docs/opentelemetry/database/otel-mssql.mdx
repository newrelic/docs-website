...
* [Manual install](/docs/opentelemetry/database/otel-mssql/#manual): The manual install method allows you to set up the NRDOT Collector on your own by following the instructions in this documentation. This method is ideal for users who prefer a hands-on approach or have specific configuration requirements.

<Tabs>
  <TabsBar>
    <TabsBarItem id="guided">Guided install</TabsBarItem> <TabsBarItem id="manual">Manual install</TabsBarItem>
  </TabsBar>
  ...
  <TabsPages>
    <TabsPageItem id="guided">
      ...
      2. Vaya a <DNT>**[left navigation pane &gt; + Integration &amp; Agents &gt; MSSQL (OpenTelemetry)](https://onenr.io/0ZQWeWqeBRW)**</DNT>.
