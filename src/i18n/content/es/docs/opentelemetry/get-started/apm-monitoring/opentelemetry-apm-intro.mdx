...
<Steps>
  ...
  <Step>
    ...
    * Encuentra tu entidad en <DNT>**All entities &gt; Services - OpenTelemetry**</DNT>. El nombre de la entidad se establece en el valor del atributo de recurso `service.name` de la aplicación. Para obtener más información sobre cómo las entidades de servicio New Relic se derivan del atributo de recurso OpenTelemetry , consulte [Servicios](/docs/opentelemetry/best-practices/opentelemetry-best-practices-resources/#services).
