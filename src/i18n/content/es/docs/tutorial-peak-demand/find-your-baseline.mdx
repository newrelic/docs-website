...
<Steps>
  <Step>
    ...
    Vaya a <DoNotTranslate>**[one.newrelic.com > Query Your Data](https://one.newrelic.com/data-exploration/query-builder)**</DoNotTranslate> y luego ingrese la siguiente consulta:
  ...
  <Step>
    ...
    Ahora que tiene algo de línea de base, puede crear un nivel de servicio significativo. Desde la página <DoNotTranslate>**Query Your Data**</DoNotTranslate> , regrese a <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com) > APM & Services**</DoNotTranslate> y luego haga clic en <DoNotTranslate>**Service levels**</DoNotTranslate> ubicado debajo de <DoNotTranslate>**Reports**</DoNotTranslate>.
