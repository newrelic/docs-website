...
<Steps>
  ...
  <Step>
    ...
    * Marque <DoNotTranslate>**Instant service-level insights**</DoNotTranslate>, <DoNotTranslate>**Full-body requests**</DoNotTranslate> y <DoNotTranslate>**Application profiles through Pixie**</DoNotTranslate> para habilitar Pixie.
  ...
  <Step>
    ...
    Debes probar tu consulta antes de enviar métrica al escalador automático de New Relic. Vaya a <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com) > Query your Data**</DoNotTranslate>, luego copie y pegue la siguiente consulta NRQL:
