  ...
  <TabsPages>
    <TabsPageItem id="iam-role-1">
      ...
      * Se alinea con las mejores prácticas de seguridad AWS
      ...
      <Callout variant="tip">
        **Importante:** Los ARN de rol van directamente en las entradas del flujo de trabajo; no los almacene en [el administrador de secretos](/docs/workflow-automation/limitations-and-faq/workflow-best-practices/#secure-credentials). No son credenciales sensibles; son identificadores de recursos.
      </Callout>
    ...
    <TabsPageItem id="iam-user-1">
      ...
      * Autenticación simplificada flujo de trabajo
      ...
      Nunca codifique las credenciales AWS en el flujo de trabajo. En su lugar, almacénelos en [el administrador de secretos](/docs/workflow-automation/limitations-and-faq/workflow-best-practices/#secure-credentials) de New Relic.
    ...
    <TabsPageItem id="session-tokens-1">
      ...
      * Entornos con requisitos de cumplimiento para el acceso limitado en el tiempo (normalmente de 1 a 12 horas).
      ...
      3. Almacene las tres credenciales en [el administrador de secretos](/docs/workflow-automation/limitations-and-faq/workflow-best-practices/#secure-credentials):
...
Pegue el ARN del rol directamente en las entradas del flujo de trabajo (no se necesita ningún [administrador de secretos](/docs/workflow-automation/limitations-and-faq/workflow-best-practices/#secure-credentials)):
...
[Administrador de secretos](/docs/workflow-automation/limitations-and-faq/workflow-best-practices/#secure-credentials) de referencia para claves de acceso:
