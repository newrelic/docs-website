...
## acciones de comunicación disponibles

Referencia rápida de todas las acciones de comunicación por plataforma:
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        [Publicar mensaje](#slackchatpostmessage)
      </td>

      <td>
        Envía mensajes a los canales de Slack con archivos adjuntos opcionales.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        [Obtén reacciones](#slackchatgetreactions)
      </td>

      <td>
        Recuperar reacciones con emojis de los mensajes de Slack.
      </td>
    </tr>
  </tbody>
</table>
