...
Para obtener más ejemplos de flujo de trabajo empleando AWS Execute API, consulte la página [de ejemplos de flujo de trabajo](/docs/workflow-automation/workflow-examples).