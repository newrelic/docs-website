...
<Callout variant="tip">
  **Para enviar notificaciones desde flujo de trabajo**: use el catálogo de acciones para agregar acciones de notificación (como `slack.chat.postMessage`) directamente en sus pasos de flujo de trabajo. Consulte [Acciones de Slack](/docs/workflow-automation/setup-and-configuration/actions-catalog/slack/slack-chat) y [Acciones de PagerDuty](/docs/workflow-automation/setup-and-configuration/actions-catalog/pagerduty/pagerduty-incident).
</Callout>
...
4. (Opcional) También puedes agregar otros destinos como [Slack](/docs/alerts/get-notified/notification-integrations/#slack) para recibir notificaciones además de activar el flujo de trabajo:
