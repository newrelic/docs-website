...
<DocTiles>
  <DocTile title="Esquema de definición: Paso de espera" path="/docs/workflow-automation/workflow-automation-apis/definition-schema#wait">
    Aprenda a configurar pasos de espera con señales
  </DocTile>
  ...
  <DocTile title="Iniciar ejecución de flujo de trabajo" path="/docs/workflow-automation/workflow-automation-apis/start-workflow-run">
    Ejecute un flujo de trabajo para obtener un runId para señalización
  </DocTile>

  <DocTile title="Información de la ejecución del flujo de trabajo" path="/docs/workflow-automation/workflow-automation-apis/workflow-run-info">
    Verificar si el flujo de trabajo está esperando una señal
  </DocTile>
</DocTiles>