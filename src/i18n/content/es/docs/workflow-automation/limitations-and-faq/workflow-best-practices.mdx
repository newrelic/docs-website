...
* **No**: Cree flujos de trabajo separados para **consultar alerta**, **dar formato al mensaje**, **enviar a Slack**
...
* **Hacer**: **Redimensionamiento automático de EC2 para alertas de CPU alto**
* **No**: **Flujo de trabajo 1** o **Automatización de EC2**
...
La automatización de flujos de trabajo generará registros de eventos de las ejecuciones, y estos registros de eventos no se pueden eliminar por motivos de integridad y auditabilidad. Evite agregar información de identificación personal o datos personales a los `workflow definition name` y `step name`.

## Temas relacionados [#related-topics]

<DocTiles>
  <DocTile title="Límites del flujo de trabajo" path="/docs/workflow-automation/limitations-and-faq/workflow-limits">
    Comprender los tiempos de espera, los límites de tasa y las restricciones del sistema
  </DocTile>

  <DocTile title="Resolución de problemas" path="/docs/workflow-automation/troubleshooting">
    Depurar errores y fallas comunes en los flujos de trabajo
  </DocTile>
  ...
  <DocTile title="APIs de automatización de flujos de trabajo" path="/docs/workflow-automation/workflow-automation-apis/using-workflow-automation-api">
    Administre flujos de trabajo programáticamente para CI/CD
  </DocTile>

  <DocTile title="Ejemplos de flujo de trabajo" path="/docs/workflow-automation/workflow-examples/workflow-examples">
    Vea las mejores prácticas aplicadas en flujos de trabajo reales
  </DocTile>
</DocTiles>