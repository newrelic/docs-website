...
<CollapserGroup>
  <Collapser id="aws.lambda.invoke" title="Invocar una función Lambda">
  ...
  <Collapser id="aws.lambda.updateFunctionConfiguration" title="Actualizar configuración de la función">
  ...
  <Collapser id="aws.lambda.getFunction" title="Describir una función Lambda específica">
  ...
  <Collapser id="aws.lambda.listAliases" title="Listar los alias de una función Lambda específica">
    Devuelve una lista de alias para una función Lambda específica. Los alias son punteros a versiones de funciones.
  ...
  <Collapser id="aws.bedrock.invokeAgent" title="Invocar un agente de Bedrock">
    Invoca un agente de Bedrock.
