...
Esta página proporciona una referencia completa sobre http put disponible en el catálogo de acciones de automatización del flujo de trabajo. Estas acciones le permiten realizar operaciones de solicitud de venta http.
...
<Callout variant="tip">
  Las acciones HTTP admiten la sintaxis de secretos para cualquier valor de encabezado, lo que le permite pasar de forma segura datos sensibles, como claves de API. Consulte [gestión de secretos](/docs/workflow-automation/limitations-and-faq/workflow-best-practices#secure-credentials) para obtener más información.
</Callout>
...
## PUT un recurso en una URL [#http-put]
