...
<CollapserGroup>
  <Collapser id="newrelic.notification.createSignalUrl" title="Create a signal URL">
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  The name of the wait step in the workflow that contains the list of signals the workflow run waits for. Must be a valid wait step name present in the workflow definition, and that wait step must contain at least one signal. Maximum length: 100 characters.
                </td>
