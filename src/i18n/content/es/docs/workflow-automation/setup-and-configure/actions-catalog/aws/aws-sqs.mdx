...
<CollapserGroup>
  <Collapser id="aws.sqs.sendMessage" title="Enviar un mensaje a una cola de SQS">
...
<CollapserGroup>
  <Collapser id="aws.sqs.receiveMessage" title="Recibir un mensaje de una cola SQS">
