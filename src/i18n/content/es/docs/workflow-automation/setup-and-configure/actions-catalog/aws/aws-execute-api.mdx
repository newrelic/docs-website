...
Esta página proporciona una referencia completa para AWS Execute API, disponible en el catálogo de acciones de automatización de workflows. Estas acciones le permiten ejecutar cualquier operación de la API de AWS.
...
Para usar esta acción, debe configurar las credenciales de AWS. Consulte [Configurar credenciales de AWS](/docs/workflow-automation/setup-and-configure/set-up-aws-credentials/) para obtener instrucciones detalladas sobre cómo crear un rol de IAM o un usuario de IAM.
...
## Ejecutar una API de AWS [#aws-execute-api]
