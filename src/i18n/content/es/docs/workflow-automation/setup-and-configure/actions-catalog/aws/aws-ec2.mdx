...
<CollapserGroup>
  <Collapser id="aws.ec2.runInstances" title="Instancia de ejecución">
  ...
  <Collapser id="aws.ec2.startInstances" title="Reiniciar instancias">
  ...
  <Collapser id="aws.ec2.stopInstances" title="Detener instancias">
  ...
  <Collapser id="aws.ec2.terminateInstances" title="Apagar instancias">
  ...
  <Collapser id="aws.ec2.createSnapshot" title="Crear instantánea de EBS">
  ...
  <Collapser id="aws.ec2.deleteSnapshot" title="Eliminar instantánea">
