...
<CollapserGroup>
  <Collapser id="newrelic.ingest.sendEvents" title="Enviar eventos">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  [Lee más sobre nuestras claves de API](/docs/apis/intro-apis/new-relic-api-keys#license-key) para crear y administrar tu **clave de licencia de la cuenta de New Relic**.
                </td>
...
<CollapserGroup>
  <Collapser id="newrelic.ingest.sendLogs" title="Enviar logs">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  No ingrese credenciales en texto plano. Consulte el ejemplo de sintaxis de secretos a continuación.

                  Ejemplo: `"{{ .secrets.secretName }}"`, donde `secretName` es la clave bajo la cual se almacena la clave de licencia.
                </td>
              </tr>
