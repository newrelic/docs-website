---
title: Notificaciones y destinos de alertas
tags:
  - workflow automation
  - workflow
  - notifications
...
1. **Envíe notificaciones desde flujos de trabajo**: Use acciones de **Slack**, **PagerDuty**, correo electrónico o **webhook** dentro de sus flujos de trabajo para notificar a los equipos cuando los flujos de trabajo se completen, fallen o requieran aprobación.
2. **Desencadena flujos de trabajo desde alertas**: Configura **Workflow Automation** como destino en las alertas de New Relic para iniciar flujos de trabajo automáticamente cuando se infrinjan las condiciones de alerta.

<Callout variant="important">
  **Dos conceptos diferentes:**

  * **Notificaciones salientes**: Su flujo de trabajo envía mensajes a **Slack**/**PagerDuty** usando acciones como `slack.chat.postMessage`
...
* Credenciales almacenadas en el [gestor de secretos](/docs/workflow-automation/limitations-and-faq/workflow-best-practices#secure-credentials).
...
<Callout variant="tip">
  ...
  * **Slack**: Utilice [`slack.chat.postMessage`](/docs/workflow-automation/setup-and-configure/actions-catalog/slack/slack-chat) para la integración directa con Slack
  * **PagerDuty**: Utilice [acciones de PagerDuty](/docs/workflow-automation/setup-and-configure/actions-catalog/pagerduty/pagerduty-incident) para la gestión de incidentes
  * **Correo electrónico**: Usa [`newrelic.notification.sendEmail`](/docs/workflow-automation/setup-and-configure/actions-catalog/newrelic/newrelic-notification) después de configurar destinos de correo electrónico en [Alerts &gt; Destinations](/docs/alerts/get-notified/destinations/)
</Callout>
...
2. Para configurar su flujo de notificación de trabajo, en la página Configurar su flujo de notificación de trabajo, proporcione la información requerida:
   ...
   * Haga clic en **Additional settings** para enriquecer sus datos creando [consultas NRQL](/docs/alerts/get-notified/alert-event-workflows#enrichments) para recopilar datos relacionados de toda su plataforma New Relic. Para ver ejemplos de enriquecimiento, consulte [Enriquecimiento de datos del flujo de trabajo](/docs/alerts/get-notified/custom-variables-alert-event-workflows#enrichment-examples).
...
4. (Opcional) También puede agregar otros destinos como [Slack](/docs/workflow-automation/setup-and-configure/actions-catalog/slack/slack-chat#configure-slack-integration) para recibir notificaciones además de activar el flujo de trabajo:
...
## Qué datos se pasan [#data-passed]
...
<DocTiles>
  ...
  <DocTile title="Ejemplo de integración de Slack" path="/docs/workflow-automation/workflow-examples/integrations/slack">
