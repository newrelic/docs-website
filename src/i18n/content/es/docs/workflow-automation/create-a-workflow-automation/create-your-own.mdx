...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        [Error](/docs/workflow-automation/workflow-automation-apis/definition-schema#error)
      </td>

      <td>
        Hacer fallar el flujo de trabajo con un mensaje personalizado, opcionalmente controlado por una condición
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        Hacer fallar el flujo de trabajo con un mensaje
      </td>

      <td>
        `type: error` con `message:` y opcional `condition:`
      </td>

      <td>
        Detener el flujo de trabajo con un mensaje de falla personalizado cuando se cumple una condición
      </td>
    </tr>
  </tbody>
</table>
