...
* **Aprenda primero los conceptos básicos**: lea [los conceptos básicos](#core-concepts) y [los patrones de flujo de trabajo](#workflow-patterns) para comprender los fundamentos y luego aplíquelos.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Utilice `type: assign` para establecer variables como cadenas, enteros, booleanos, mapas y listas.
      </td>
    </tr>
...
<Callout variant="important">
  Para conocer las mejores prácticas y limitaciones de seguridad y privacidad, incluida la eliminación de datos, consulte [mejores prácticas de seguridad](/docs/workflow-automation/limitations-and-faq/workflow-best-practices/#security).
</Callout>
...
2. Defina el parámetro para las credenciales (del [administrador de secretos](/docs/workflow-automation/limitations-and-faq/workflow-best-practices/#secure-credentials): `${{ :secrets:keyName }}`), configuración (regiones, tipo de instancia) y datos de tiempo de ejecución (ID de cuenta, ID de alerta)
...
* **Administrador de secretos**: configurado, consulte [administrador de secretos](/docs/workflow-automation/limitations-and-faq/workflow-best-practices/#secure-credentials)
...
Este flujo de trabajo requiere credenciales, configuración y contexto de tiempo de ejecución como entradas. Los valores sensibles provienen del [administrador de secretos](/docs/workflow-automation/limitations-and-faq/workflow-best-practices/#secure-credentials) que emplea la sintaxis `${{ :secrets:keyName }}`.

**Categorías de entrada:**

* **Autenticación**: credenciales de AWS y Slack del [administrador de secretos](/docs/workflow-automation/limitations-and-faq/workflow-best-practices/#secure-credentials)
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            ID de clave de acceso de AWS recuperada del [administrador de secretos](/docs/workflow-automation/limitations-and-faq/workflow-best-practices/#secure-credentials) para la autenticación con los servicios de AWS.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Clave de acceso secreta de AWS recuperada del [administrador de secretos](/docs/workflow-automation/limitations-and-faq/workflow-best-practices/#secure-credentials). Se empareja con el ID de la clave de acceso.
          </td>
        </tr>
...
<Steps>
  ...
  <Step>
    ...
    * **`generateIdempotencyToken`**: Crea un UUID único para evitar cambios de tamaño duplicados si el flujo de trabajo se ejecuta dos veces.
