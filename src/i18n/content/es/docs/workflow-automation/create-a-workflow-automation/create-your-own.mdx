...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Fail the workflow with a custom message, optionally gated by a condition
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        `type: error` with `message:` and optional `condition:`
      </td>

      <td>
        Stop the workflow with a custom failure message when a condition is met
      </td>
    </tr>
  </tbody>
</table>
