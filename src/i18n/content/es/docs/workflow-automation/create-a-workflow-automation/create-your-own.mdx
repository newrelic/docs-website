...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        [Bucles](/docs/workflow-automation/workflow-examples#loop-structure)
      </td>
...
Para obtener información detallada sobre la estructura del bucle, los parámetros y el uso avanzado (incluido romper/continuar), consulte [Estructura del bucle](/docs/workflow-automation/workflow-examples#loop-structure).
