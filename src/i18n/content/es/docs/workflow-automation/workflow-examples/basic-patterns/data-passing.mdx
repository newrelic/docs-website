...
<DocTiles>
  <DocTile title="Bucles" path="/docs/workflow-automation/workflow-examples/basic-patterns/loops">
    Pasar datos a través de las iteraciones del bucle
  </DocTile>

  <DocTile title="Lógica condicional" path="/docs/workflow-automation/workflow-examples/basic-patterns/conditional-logic">
    Usar datos en condiciones de switch
  </DocTile>

  <DocTile title="Análisis de JSON" path="/docs/workflow-automation/workflow-examples/basic-patterns/json-parsing">
    Extraer y pasar datos JSON
  </DocTile>
</DocTiles>