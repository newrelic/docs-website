...
<DocTiles>
  <DocTile title="Análisis de JSON" path="/docs/workflow-automation/workflow-examples/basic-patterns/json-parsing">
    Analizar y transformar respuestas HTTP
  </DocTile>

  <DocTile title="Encuesta de la API REST" path="/docs/workflow-automation/workflow-examples/integrations/rest-api-polling">
    Cree flujos de trabajo completos de integración de API
  </DocTile>

  <DocTile title="Acciones HTTP" path="/docs/workflow-automation/setup-and-configure/actions-catalog/actions-catalog">
    Conozca todos los parámetros de acción HTTP
  </DocTile>
</DocTiles>