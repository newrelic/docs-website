...
<DocTiles>
  <DocTile title="HTTP GET/POST" path="/docs/workflow-automation/workflow-examples/basic-patterns/http-get-post">
    Obtener datos JSON de APIs
  </DocTile>

  <DocTile title="Paso de datos" path="/docs/workflow-automation/workflow-examples/basic-patterns/data-passing">
    Pasar datos analizados entre pasos
  </DocTile>

  <DocTile title="Acciones de transformación de utilidades" path="/docs/workflow-automation/setup-and-configure/actions-catalog/utils/utils-transform">
