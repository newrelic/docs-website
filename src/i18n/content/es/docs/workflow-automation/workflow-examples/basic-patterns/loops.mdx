...
<DocTiles>
  <DocTile title="Lógica condicional" path="/docs/workflow-automation/workflow-examples/basic-patterns/conditional-logic">
    Combina ciclos con sentencias switch
  </DocTile>

  <DocTile title="Encuesta de la API REST" path="/docs/workflow-automation/workflow-examples/integrations/rest-api-polling">
    Use bucles para flujos de trabajo de sondeo de API
  </DocTile>

  <DocTile title="Esquema de definición: Bucle" path="/docs/workflow-automation/workflow-automation-apis/definition-schema#loop">
    Referencia completa del paso de bucle
  </DocTile>
</DocTiles>