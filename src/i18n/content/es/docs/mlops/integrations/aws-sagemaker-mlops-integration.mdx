...
Realice los siguientes pasos para monitor su métrica y objetos de Amazon SageMaker (que se envían a AWS CloudWatch) y verlos como [entidad](/docs/new-relic-one/use-new-relic-one/core-concepts/what-entity-new-relic/) y [dashboard](/docs/query-your-data/explore-query-data/dashboards/introduction-dashboards/) en New Relic.
...
* URL del extremo HTTP - centro de datos de EE. UU. (predeterminado): `https://aws-api.newrelic.com/cloudwatch-metrics/v1`
* URL extremo HTTP - Centro de datos de la UE: `https://aws-api.eu01.nr-data.net/cloudwatch-metrics/v1`
* URL del extremo HTTP - centro de datos de JP: `https://aws-api.jp.nr-data.net/cloudwatch-metrics/v1`
...
## Explora tu entidad y dashboard de control [#explore-entities-dashboards]
