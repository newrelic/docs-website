...
<Callout variant="important">
  Para instrumentar su aplicación impulsada por OpenAI, recomendamos usar el monitoreo de IA en lugar de este método de instalación más antiguo. [Consulte nuestra documentación para comenzar](/docs/ai-monitoring/intro-to-ai-monitoring/).
</Callout>
...
<CollapserGroup>
  <Collapser id="install-with-python" title="Instalar para la aplicación Python">
    <Steps>
      <Step>
  ...
  <Collapser id="install-with-node" title="Instalar con Node.js">
    <Steps>
      <Step>
...
Si está utilizando una cuenta de EU o JP, debe configurar su `EVENT_CLIENT_HOST` de la siguiente manera:
...
2. Haga clic en <DNT>**Model Performance**</DNT>.
3. Busque en <DNT>**Applications**</DNT>.
