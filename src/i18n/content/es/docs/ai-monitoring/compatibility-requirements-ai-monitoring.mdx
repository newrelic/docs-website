...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Para obtener una lista completa de las bibliotecas de IA compatibles con el agente de Java, consulte [Instrumentación integrada para el monitoreo de IA](/docs/apm/agents/java-agent/getting-started/compatibility-requirements-java-agent/#ai-monitoring)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Para obtener la lista completa de bibliotecas de monitoreo de IA compatibles, consulte la [página de requisitos de compatibilidad del agente de Node.js](https://docs.newrelic.com/docs/apm/agents/nodejs-agent/getting-started/compatibility-requirements-nodejs-agent/#ai-monitoring-support).
      </td>
    </tr>
