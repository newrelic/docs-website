...
* **Criterios coincidentes** (opcional): una cláusula NRQL que agrega especificidad al filtro de caída. Por ejemplo, si solo desea eliminar datos de `openai`, puede agregar `AND vendor IN 'openai'`
