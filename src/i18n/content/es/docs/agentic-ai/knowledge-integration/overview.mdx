...
* Encuentre fácilmente soluciones a problemas que ya se resolvieron anteriormente. Haga preguntas como:
  ...
  * &quot;Muéstrame el runbook para un error `database connection limit exceeded`.&quot;
  ...
  <Callout variant="important">
    En este momento, todos los documentos indexados pueden ser recuperados por todos los usuarios dentro de su organización. Verifique que solo se indexe el contenido apropiado, ya que actualmente no existe ninguna opción para restringir el acceso o redactar información luego de la indexación.
  </Callout>
...
* Los permisos de usuario adecuados están configurados para la indexación (necesitarás el rol de Administrador de la organización, que te permite realizar acciones —como configurar y administrar los conectores de conocimiento— que pueden tener implicaciones futuras en la facturación).

Tiene dos opciones para asignar el rol de Administrador de la organización:

* **Aplicar a un grupo de usuarios existente:** Agregue el rol de Administrador de la organización a un grupo de usuarios existente que será responsable de gestionar los conectores de conocimiento.
