...
Al configurar el conector de conocimiento New Relic AI, puede esperar resultados tangibles como una resolución de incidentes más rápida, respuestas de IA más precisas y conscientes del contexto, y una reducción de la búsqueda manual en múltiples documentos. Este enfoque unificado ayuda a su equipo a tomar mejores decisiones y responder a los problemas de manera más eficiente.

## Casos de uso y valor

Los siguientes ejemplos muestran cómo la integración del conector de conocimiento ayuda a abordar desafíos como la documentación fragmentada y la respuesta lenta a incidentes al revelar información relevante.

<CollapserGroup>
  <Collapser id="retro-docsearch-tool" title="Búsqueda de documentos retro">
    Cuando ocurre un incidente crítico, se enfrenta a una investigación que consume mucho tiempo porque el contexto histórico está fragmentado en múltiples fuentes, como Confluence y runbooks.
    ...
    * Proporcionar un resumen inmediato de la causa raíz de un incidente original.
  ...
  <Collapser id="what-happened-previously" title="What happened previously">
    Cuando un problema de TI vuelve a ocurrir, a menudo tendrás que dedicar tiempo valioso a intentar averiguar si ya sucedió antes. Su contexto histórico a menudo está disperso en documentos retrospectivos o post mortem separados, lo que puede dificultar encontrar rápidamente la información que necesita para resolver un incidente recurrente.

    Al aprovechar RAG, la plataforma New Relic AI almacena información de sus documentos retrospectivos o post mortem existentes para referencia futura. Esto lo ayudará a ahorrar tiempo valioso durante un incidente. El widget What happened previously, con implementación de RAG, le permite:

    * Encuentre rápidamente información relevante y aprenda de incidentes anteriores.
