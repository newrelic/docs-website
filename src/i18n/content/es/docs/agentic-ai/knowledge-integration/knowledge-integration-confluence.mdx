---
title: Conector de conocimiento New Relic AI con confluencia
...
<Steps>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Ingrese una descripción para su conector.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Elija la categoría de conocimiento de la lista desplegable, esto ayudará a New Relic AI a buscar información en el lugar correcto. Puede elegir entre las siguientes opciones:
  ...
  <Step>
    En la página <DNT>**Data source authentication**</DNT>, seleccione el método de autenticación requerido. Puede elegir entre las siguientes opciones:
