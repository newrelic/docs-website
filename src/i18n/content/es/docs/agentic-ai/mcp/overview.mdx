...
<Callout title="Restricciones de cumplimiento" variant="important">
  Debido a requisitos de seguridad y cumplimiento, no debe utilizar el servidor MCP de New Relic AI si sus cuentas o datos están sujetos a los mandatos de cumplimiento de FedRAMP. El uso de esta característica en versión preliminar pública con cuentas reguladas por FedRAMP está estrictamente prohibido.
</Callout>
...
* **Operaciones automatizadas:** Realice tareas como verificar el estado de las alertas, generar reportes de eventos de alerta y analizar cómo los despliegues afectan sus sistemas.
...
* **OAuth**: New Relic proporciona OAuth extremo preconfigurado:
  ...
  * URL del token:
    ...
    * EE. UU. (por defecto): `https://mcp.newrelic.com/oauth2/token`
