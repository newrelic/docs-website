...
<Callout variant="tip">
  **Facturación:** la mayoría de las herramientas de MCP se miden como [unidades de computación Core (CCU)](/docs/licenses/license-information/product-definitions/new-relic-one-pricing-definitions/#compute-capacity-unit) con cargo a su asignación de Core Compute existente. Cuatro herramientas de análisis impulsadas por IA (`natural_language_to_nrql_query`, `generate_alert_insights_report`, `generate_user_impact_report`, `analyze_deployment_impact`) se miden como [unidades de capacidad de computación Advanced (aCCU)](/docs/licenses/license-information/product-definitions/new-relic-one-pricing-definitions/#compute-capacity-unit) y requieren el complemento Advanced Compute.
</Callout>
