...
<Callout variant="important">
  **Region Notice:** The configuration examples in this topic use the US region MCP connection URL: [https://mcp.newrelic.com/mcp/](https://mcp.newrelic.com/mcp/). If your New Relic account is in a different region, replace this URL with the appropriate regional endpoint in all configuration files and command-line arguments:
