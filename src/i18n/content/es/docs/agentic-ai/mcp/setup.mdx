...
<Callout variant="important">
  **Aviso de región:** Los ejemplos de configuración en este tema usan la URL de conexión de MCP de la región de EE. UU.: [https://mcp.newrelic.com/mcp/](https://mcp.newrelic.com/mcp/). Si su cuenta de New Relic está en una región diferente, reemplace esta URL con el extremo regional apropiado en todos los archivos de configuración y argumentos de la línea de comando:
