...
<Callout variant="important">
  Roku tiene `roRegex` restricciones de patrón que afectan las reglas de ofuscación. Consulte [Limitaciones para streaming de video &amp; anuncios](/docs/streaming-video-&-ads/limitations#roku-regex) para obtener más detalles.
</Callout>