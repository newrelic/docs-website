...
<Callout variant="important">
  Roku tiene restricciones de patrones de expresiones regulares que afectan las reglas de ofuscación. Consulte [Limitaciones para Streaming Video &amp; Ads](/docs/streaming-video-&-ads/limitations#roku-regex) para obtener más detalles.
</Callout>