...
En este caso, puede anular manualmente la coincidencia del trabajo de descubrimiento usando la sintaxis <DoNotTranslate>**bang (!)**</DoNotTranslate> : `"!profile-name.yml"`, que le permite forzar cualquier perfil que desee:
