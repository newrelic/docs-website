...
Para resolver este problema, primero investigue la consulta NRQL subyacente para su gráfico sankey seleccionando la acción <DoNotTranslate>**View query**</DoNotTranslate> en el icono superior derecho del gráfico e identifique cualquier campo que devuelva valores nulos o vacíos de su consulta. El siguiente paso sería actualizar la plantilla de flujo en su exportador de flujo para garantizar que todos los campos necesarios se envíen al agente de KTranslate como se esperaba.