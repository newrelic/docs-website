...
<Tabs>
  ...
  <TabsPages>
    <TabsPageItem id="arm-deploy">
      ...
      * Despliegue la Function App en su plan de alojamiento seleccionado con el entorno de ejecución de Node.js 22 y las funciones de VNet Flow Logs
      ...
      * Opcionalmente, habilite las redes privadas con integración de VNet y extremos privados
      ...
      8. Asegúrese de que el [extremo New Relic](/docs/logs/log-api/introduction-log-api/#endpoint) esté configurado en el correspondiente a su cuenta (US, EU, JP o FedRAMP para US Gov Cloud).
      ...
      11. (Opcional) Seleccione el desplegable <DNT>**Function App Plan**</DNT>. Cuatro valores: `FlexConsumption` (predeterminado), `ElasticPremium`, `Basic` o `Consumption`. Consulte [Elegir un plan de alojamiento](#hosting-plans) a continuación para obtener orientación sobre cuándo elegir cada uno.

      12. (Opcional) Configure los ajustes avanzados:
      ...
      13. Haga clic en <DNT>**Review + create**</DNT>, revise la configuración y haga clic en <DNT>**Create**</DNT>.

      14. De vuelta en New Relic, en el paso <DNT>**Create log partition**</DNT>, haga clic en <DNT>**Create partition**</DNT>. Esto crea una partición de datos `Log_VNET_Flows_Azure` (regla: `instrumentation.name = 'vnet-app'`, retención STANDARD) para que sus VNet Flow Logs se almacenen y consulten por separado de sus otros registros. Si ya existe una partición `Log_VNET_Flows_Azure` en la cuenta, haga clic en <DNT>**Continue**</DNT> para omitir este paso.

      15. En el paso <DNT>**Test your logs**</DNT>, confirme que los datos están llegando ejecutando `SELECT * FROM Log_VNET_Flows_Azure`, luego haga clic en <DNT>**See your data**</DNT>.

      ### Elegir un plan de alojamiento [#hosting-plans]

      La plantilla despliega la Function App en uno de los cuatro planes de alojamiento de Azure, seleccionado con el desplegable <DNT>**Function App Plan**</DNT>. El valor predeterminado es `FlexConsumption`.
      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td>
              Cualquier región donde Flex Consumption esté disponible de forma general. Modelo sin servidor moderno con integración nativa de VNet que escala elásticamente sin capacidad precalentada.
            </td>
          ...
          <tr>
            ...
            <td>
              Cargas de trabajo de producción o en ráfagas en regiones donde el consumo de Flex aún no está disponible, o cargas de trabajo con un SLA estricto sin inicio en frío.
            </td>
          ...
          <tr>
            ...
            <td>
              Inquilinos pequeños o despliegues de desarrollo que necesitan redes privadas. La opción más económica con capacidad para VNet. No es adecuado para cargas de trabajo de alto rendimiento.
            </td>
          ...
          <tr>
            ...
            <td>
              Despliegues de desarrollo o evaluación en red pública donde no se requiere red privada. El más barato en general.
            </td>
      ...
      <Callout variant="important">
        `Consumption` no admite la integración de Azure VNet. Si habilita <DNT>**Disable Public Access To Storage Account**</DNT>, elija uno entre `FlexConsumption`, `ElasticPremium` o `Basic` — el despliegue falla rápidamente en el primer minuto si combina `Consumption` con redes privadas.
      </Callout>
      ...
      * Enruta todo el tráfico saliente — incluidas las llamadas a la API de New Relic Logs — a través de la subred de integración de VNet.
    </TabsPageItem>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Extremo de API de New Relic Logs. Por defecto el extremo estadounidense. Sobrescribir para otras regiones: 
