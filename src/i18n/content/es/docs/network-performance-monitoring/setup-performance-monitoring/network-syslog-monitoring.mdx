...
<CollapserGroup>
  ...
  >
    1. Vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Add more data**</DoNotTranslate>.

    2. Desplácese hacia abajo hasta que vea <DoNotTranslate>**Network**</DoNotTranslate> y haga clic en <DoNotTranslate>**Syslog**</DoNotTranslate>.
