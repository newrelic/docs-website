...
<CollapserGroup>
  <Collapser
    id="docker"
    title="Requisitos previos para la instalación Docker"
  >
  ...
  <Collapser
    id="podman"
    title="Requisitos previos para la instalación de Podman"
  >
  ...
  <Collapser
    id="linux"
    title="Requisitos previos de instalación del servicio Baremetal Linux"
  >
...
<CollapserGroup>
  <Collapser
    id="snmp"
    title="Requisitos previos de los dispositivos SNMP"
  >
...
<CollapserGroup>
  ...
  >
    1. Ir a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Add more data**</DoNotTranslate>

    2. Desplácese hacia abajo hasta que vea <DoNotTranslate>**Network**</DoNotTranslate> y haga clic en <DoNotTranslate>**SNMP**</DoNotTranslate>.
    ...
    3. Siga los pasos descritos en el proceso de instalación guiada. Puede emplear Docker, Podman o Linux.
       ...
       <figcaption>
         <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/ll-capabilities) > Add more data > Network > SNMP**</DoNotTranslate> para configurar el monitoreo de datos SNMP.
       </figcaption>
    ...
    <Tabs>
      ...
      <TabsPages>
        <TabsPageItem id="dockerInstall">
          1. En un host Linux con Docker instalado, descargue la imagen <DoNotTranslate>**ktranslate**</DoNotTranslate> ejecutando una de las siguientes opciones:
        ...
        <TabsPageItem id="podmanInstall">
          1. En un host con Podman instalado, descargue la imagen <DoNotTranslate>**ktranslate**</DoNotTranslate> ejecutando el siguiente comando:
        ...
        <TabsPageItem id="linuxInstall">
          ...
          * Apt:
          ...
          4. Edite el archivo `snmp-base.yaml` y defina los atributos `discovery.cidrs` y `discovery.default_communities` con los valores apropiados para su red. <Callout variant="tip">Recomendamos configurar `discovery.add_mibs: true` para automatizar la adición de todos los MIB descubiertos al atributo `global.mibs_enabled` . Además, se recomienda configurar `discovery.check_all_ips: true` para evitar problemas de descubrimiento en [dispositivos con posturas de seguridad estrictas](/docs/network-performance-monitoring/troubleshooting/snmp-discovery-no-devices).</Callout>
...
<Collapser
  ...
  title="Configuración manual del contenedor para capturas SNMP"
>
  <Tabs>
    <TabsBar>
