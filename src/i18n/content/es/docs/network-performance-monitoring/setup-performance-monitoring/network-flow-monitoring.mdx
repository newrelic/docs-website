...
<CollapserGroup>
  ...
  >
    Recomendamos utilizar un contenedor docker para desplegar el agente para la recopilación de flujo de red. Para usarlo, necesitas:
  ...
  >
    * Los dispositivos de origen deben configurarse para enviar datos de flujo al host que ejecuta el Monitoreo de red agente. A continuación se explica cómo configurar la exportación de flujo de red en algunos dispositivos (esta no es una lista exhaustiva):
...
<CollapserGroup>
  ...
  >
    ...
    2. Desplácese hacia abajo hasta que vea
       ...
       <DoNotTranslate>**Network Flows**</DoNotTranslate>
    ...
    <figcaption>
      <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/ll-capabilities) > Add more data > Network > Network Flows**</DoNotTranslate> para configurar el monitoreo de datos de flujo de red.
    </figcaption>

    4. Investigue los datos de flujo de su red en la New Relic
  ...
  >
    ...
    * [Quay.io](https://quay.io/)
    ...
    4. Ejecute `ktranslate` para escuchar los flujos de red ejecutando:
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            El tiempo, en segundos New Relic APIde Unix, en que la del evento recibió este registro de flujo.
          </td>
        </tr>
      </tbody>
    </table>
