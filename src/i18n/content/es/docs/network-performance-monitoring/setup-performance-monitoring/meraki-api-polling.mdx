...
<Tabs>
  <TabsBar>
    ...
    <TabsBarItem id="podmanExistingContainer">
      Contenedor Podman existente
    </TabsBarItem>

    <TabsBarItem id="podmanDedicatedContainer">
      Contenedor Podman dedicado
    </TabsBarItem>
  </TabsBar>

  <TabsPages>
    <TabsPageItem id="dockerExistingContainer">
      1. En su archivo de configuración existente para el agente SNMP, agregue manualmente el objeto de dispositivo Meraki. Reemplace `$DASHBOARD_API_KEY` con [la clave de API de su dashboard Meraki](https://documentation.meraki.com/General_Administration/Other_Topics/Cisco_Meraki_Dashboard_API#Enable_API_Access):
    ...
    <TabsPageItem id="dockerDedicatedContainer">
      1. En un host Linux con Docker instalado, use el editor de texto de su elección para crear el archivo de configuración que usará para ejecutar el contenedor. Reemplace `$DASHBOARD_API_KEY` con [la clave de API dashboard de Meraki](https://documentation.meraki.com/General_Administration/Other_Topics/Cisco_Meraki_Dashboard_API#Enable_API_Access).
