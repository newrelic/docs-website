...
<Tabs>
  ...
  <TabsPages>
    <TabsPageItem id="dockerExistingContainer">
      1. En su archivo de configuración existente para el agente SNMP, agregue manualmente el objeto de dispositivo Meraki. Reemplace `$MERAKI_DASHBOARD_API_KEY` con [la clave APIde su panel de Meraki](https://documentation.meraki.com/General_Administration/Other_Topics/Cisco_Meraki_Dashboard_API#Generate_API_Key):
    ...
    <TabsPageItem id="dockerDedicatedContainer">
      1. En un host Linux con Docker instalado, use el editor de texto de su elección para crear el archivo de configuración que usará para ejecutar el contenedor. Reemplace `$MERAKI_DASHBOARD_API_KEY` con [la clave de APIde su panel de Meraki](https://documentation.meraki.com/General_Administration/Other_Topics/Cisco_Meraki_Dashboard_API#Generate_API_Key).
