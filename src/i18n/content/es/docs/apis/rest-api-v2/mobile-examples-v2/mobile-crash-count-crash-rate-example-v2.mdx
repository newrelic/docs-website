...
<Callout variant="tip">
  También puede usar el New Relic API Explorer para obtener [datos de métricas móviles](https://api.newrelic.com/docs/#/Mobile%20Applications/get_mobile_applications__mobile_application_id__metrics_data_json).
</Callout>
