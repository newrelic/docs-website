...
Esto describe cómo utilizar la API REST de New Relic (v2) para obtener <DoNotTranslate>**crash count**</DoNotTranslate> y <DoNotTranslate>**crash rate**</DoNotTranslate> generales y específicos de la versión de su aplicación móvil, que aparecen en la [página<DoNotTranslate>**Summary**</DoNotTranslate> ](/docs/mobile-monitoring/mobile-monitoring-ui/mobile-app-pages/mobile-apps-overview-page)en la esquina superior derecha.
