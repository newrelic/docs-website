...
<Callout variant="tip">
  Para obtener la misma información del [Explorador de la API de New Relic (v2)](https://api.newrelic.com/docs), selecciona <DNT>**Users &gt; GET List**</DNT>.
</Callout>
...
## Listar todos los usuarios de la cuenta [#list\_all\_users][#list_all_users]
...
## Listado por correo electrónico del usuario [#list\_by\_mail][#list_by_mail]
...
## Listado por usuario `id` [#list\_by\_userid][#list_by_userid]
