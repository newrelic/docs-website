...
<Callout variant="tip">
  Para obtener la misma información del [Explorador de API de New Relic (v2)](https://rpm.newrelic.com/api/explore), seleccione <DoNotTranslate>**Users > GET List**</DoNotTranslate>.
</Callout>
...
<DoNotTranslate>**Note:**</DoNotTranslate> La coincidencia de caracteres es una cadena simple. No hay capacidad de expresión regular disponible, por lo que pueden ocurrir múltiples coincidencias si la cadena seleccionada no es única.
