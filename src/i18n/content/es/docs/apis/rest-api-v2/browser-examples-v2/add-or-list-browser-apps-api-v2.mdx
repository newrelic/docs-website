  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        El script del cargador <DoNotTranslate>**must**</DoNotTranslate> se insertará correctamente en las páginas HTML del usuario:
        ...
        * Todo el script del cargador debe insertarse en línea, **no** como un vínculo al archivo
          ...
          <DoNotTranslate>**.js**</DoNotTranslate>
