...
New Relic proporciona información resumida para la aplicación como <DoNotTranslate>**three- to four-minute average**</DoNotTranslate> continuo.
...
<table>
  ...
  <tbody>
    <tr>
      <td>
        Para <DoNotTranslate>**all**</DoNotTranslate> aplicación para tu cuenta
      </td>
    ...
    <tr>
      <td>
        Para una aplicación <DoNotTranslate>**specific**</DoNotTranslate>
      </td>
    ...
    <tr>
      <td>
        Al utilizar el <DoNotTranslate>**app ID**</DoNotTranslate>
      </td>
...
New Relic proporciona información resumida para la clave de transacción como un <DoNotTranslate>**ten minute average**</DoNotTranslate> continuo.
...
<table>
  ...
  <tbody>
    <tr>
      <td>
        Por <DoNotTranslate>**all**</DoNotTranslate> clave de transacción para tu cuenta
      </td>
    ...
    <tr>
      <td>
        Para una transacción clave <DoNotTranslate>**specific**</DoNotTranslate>
      </td>
    ...
    <tr>
      <td>
        Al utilizar el <DoNotTranslate>**key transaction ID**</DoNotTranslate>
      </td>
