...
Para cambiar el alias del nombre de la aplicación desde la API REST de New Relic (v2), use este comando. También puedes cambiar el alias de la aplicación desde el [API Explorer](/docs/apis/rest-api-v2/api-explorer-v2/getting-started-new-relics-api-explorer) de New Relic seleccionando [<DNT>**Applications &gt; Update**</DNT>](https://api.newrelic.com/docs/#/Applications/put_applications__id__json).
...
<Callout variant="important">
  Cambiar el alias de la aplicación hace que todos los agentes que reportan bajo este identificador de aplicación se reinicien. Consulte [renombrar la aplicación](/docs/apm/agents/manage-apm-agents/app-naming/name-your-application/#app-alias) para obtener más detalles.
</Callout>
