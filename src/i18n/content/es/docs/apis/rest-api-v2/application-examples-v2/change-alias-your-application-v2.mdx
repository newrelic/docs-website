...
Para cambiar el alias del nombre de la aplicación desde la API REST de New Relic (v2), utilice este comando. También puede cambiar el alias de la aplicación desde [el Explorador de API](/docs/apis/rest-api-v2/api-explorer-v2/getting-started-new-relics-api-explorer) de New Relic seleccionando [<DoNotTranslate>**Applications > Update**</DoNotTranslate>](https://rpm.newrelic.com/api/explore/applications/update).
