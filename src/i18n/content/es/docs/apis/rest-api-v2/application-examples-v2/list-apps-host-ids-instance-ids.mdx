...
También puede utilizar [<DoNotTranslate>**Applications > List**</DoNotTranslate>del Explorador de API REST](/docs/apis/using-the-api-explorer) para enumerar los detalles de ID. Ingrese el nombre correcto de la aplicación.
...
También puede utilizar <DoNotTranslate>**Applications > List**</DoNotTranslate>o <DoNotTranslate>**Applications > List**</DoNotTranslate> del [de API REST](/docs/apis/using-the-api-explorer) para enumerar los detalles de ID. Ingrese el nombre correcto de la aplicación.
