...
Puede utilizar la API REST de New Relic (v2) para obtener el uso promedio de CPU para su aplicación en un solo host. Este valor aparece en la [página APM <DoNotTranslate>**Summary**</DoNotTranslate> ](/docs/apm/applications-menu/monitoring/apm-overview-page)de la tabla <DoNotTranslate>**Hosts**</DoNotTranslate> , en la columna denominada <DoNotTranslate>**CPU usage**</DoNotTranslate>.
...
<Callout variant="tip">
  Para obtener la misma información del [Explorador de API de New Relic (v2)](https://rpm.newrelic.com/api/explore), seleccione [<DoNotTranslate>**Applications > GET Metric Data**</DoNotTranslate>](https://rpm.newrelic.com/api/explore/applications/data) e incluya su [clave de API](/docs/apis/rest-api-v2/getting-started/introduction-new-relic-rest-api-v2#api_key). Añade tu [ID de la aplicación](/docs/apm/apis/requirements/identification-code) y la métrica `names[]=CPU/User Time` y `values[]=percent` en los campos correspondientes.
</Callout>