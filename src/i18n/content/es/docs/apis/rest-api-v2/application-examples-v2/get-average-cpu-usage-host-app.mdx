...
<Callout variant="tip">
  Para obtener la misma información del [New Relic API Explorer (v2)](https://api.newrelic.com/docs), selecciona [<DNT>**Applications &gt; GET Metric Data**</DNT>](https://api.newrelic.com/docs/#/Applications/get_applications__application_id__metrics_data_json) e incluye tu [clave de API](/docs/apis/rest-api-v2/getting-started/introduction-new-relic-rest-api-v2#api_key). Agrega tu [ID de la aplicación](/docs/apm/apis/requirements/identification-code) y las métricas `names[]=CPU/User Time` y `values[]=percent` en los campos correspondientes.
</Callout>