...
Esto devolverá las mismas puntuaciones de Apdex que se muestran en su [página APM <DoNotTranslate>**Overview**</DoNotTranslate> ](/docs/apm/applications-menu/monitoring/applications-overview-dashboard).
...
<DoNotTranslate>**Tip:**</DoNotTranslate> Para devolver una serie de puntuaciones de Apdex en lugar de un promedio, omita `&summarize=true`.
