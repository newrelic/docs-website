...
Puede utilizar la API REST de New Relic (v2) para obtener el uso de memoria promedio para su aplicación en un solo host. Este valor aparece en la [página APM <DoNotTranslate>**Summary**</DoNotTranslate> ](/docs/apm/applications-menu/monitoring/apm-overview-page)de la tabla <DoNotTranslate>**Hosts**</DoNotTranslate> , en la columna denominada <DoNotTranslate>**Memory**</DoNotTranslate> o en el gráfico correspondiente.
...
Para obtener el uso promedio de memoria para su aplicación, use un comando similar al del ejemplo anterior, pero elimine la referencia a <DoNotTranslate>**hosts**</DoNotTranslate> y `$HOST_ID`. Reemplace `$APP_ID` y `$API_KEY` con su [ID de aplicación](/docs/apm/apis/requirements/identification-code) y su [clave de API](/docs/apis/rest-api-v2/getting-started/introduction-new-relic-rest-api-v2#api_key).
