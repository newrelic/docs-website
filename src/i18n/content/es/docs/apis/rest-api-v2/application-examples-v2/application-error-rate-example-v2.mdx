...
El porcentaje promedio aparece encima del gráfico <DoNotTranslate>**Error rate**</DoNotTranslate> en [la página<DoNotTranslate>**Summary**</DoNotTranslate> ](/docs/apm/applications-menu/monitoring/apm-overview-page)de tu aplicación. New Relic utiliza esta fórmula para calcularlo:
...
Para obtener el <DoNotTranslate>**error count:**</DoNotTranslate>
...
Para obtener <DoNotTranslate>**HttpDispatcher call count**</DoNotTranslate> (aplicación web):
...
Para obtener <DoNotTranslate>**OtherTransaction call count**</DoNotTranslate> (aplicación no web):
