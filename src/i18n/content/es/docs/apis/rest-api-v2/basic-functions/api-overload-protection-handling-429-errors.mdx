...
Durante el intervalo de tiempo <DoNotTranslate>**reporting period**</DoNotTranslate> , New Relic rastrea el impacto de cada solicitud de API en nuestro sistema.
