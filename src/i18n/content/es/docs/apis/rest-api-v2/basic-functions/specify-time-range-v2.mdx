...
Si está utilizando New Relic REST API Explorer (v2), puede usar el diamante<img title="icon-api-diamond" alt="icon-api-diamond" src={apisanddataRESTAPIExplorerDiamond}/>
