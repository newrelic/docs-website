...
Para las cuentas de EE. UU. (predeterminado), utilice el siguiente extremo:
...
Para las cuentas del [centro de datos de JP](/docs/accounts/accounts-billing/account-setup/choose-your-data-center), usa el siguiente extremo:
...
<CollapserGroup>
  ...
  <Collapser className="freq-link" id="create-monitor" title="Crear un monitor">
    Utilice las [API de NerdGraph](/docs/apis/nerdgraph/examples/synthetics-api/overview/) para administrar sus monitores sintéticos usando nuestros runtimes más recientes.
