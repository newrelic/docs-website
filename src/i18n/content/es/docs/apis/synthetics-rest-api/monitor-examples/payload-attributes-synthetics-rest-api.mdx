---
title: Atributo de carga útil para la API REST de monitoreo sintético
tags:
  - APIs
...
Para conocer los requisitos de la API REST para el monitoreo sintético, consulte [Usar la API](/docs/apis/synthetics-rest-api/monitor-examples/manage-synthetics-monitors-rest-api#use-api).
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Doble: Valor del [informe SLA de monitoreo sintético](/docs/synthetics/new-relic-synthetics/pages/synthetics-sla-report-aggregate-monitor-metrics), en segundos.
      </td>
    </tr>
