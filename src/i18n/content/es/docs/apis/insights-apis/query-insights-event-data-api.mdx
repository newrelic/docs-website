...
<Callout variant="tip">
  <DoNotTranslate>**This API is no longer the preferred way to query New Relic data.**</DoNotTranslate> Utilice [NerdGraph](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph/) para hacer eso.
</Callout>

## Requisitos y recomendaciones [#requirements]

<DoNotTranslate>**This API is no longer the preferred way to query New Relic data.**</DoNotTranslate> Para obtener mejores resultados, debe utilizar [NerdGraph](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph) para consultar datos.
...
2. Haga clic en <DoNotTranslate>**Create a key button**</DoNotTranslate> ubicado en la esquina superior derecha de la página clave de API.
...
Puedes usar <DoNotTranslate>**Powershell**</DoNotTranslate> para consultar eventos vía API:
