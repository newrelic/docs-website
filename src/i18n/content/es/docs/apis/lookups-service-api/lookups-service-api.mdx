...
Extremo de Estados Unidos (EE. UU.) (predeterminado):
...
Extremo de [Japón](/docs/accounts/accounts-billing/account-setup/choose-your-data-center) (JP):
...
<CollapserGroup>
  <Collapser id="multipart-form-data-request" title="Solicitud con datos multiparte/formulario">
    #### Campos admitidos
  ...
  <Collapser id="application-json-request" title="Solicitar con aplicación/json">
    #### Campos admitidos
...
<CollapserGroup>
  <Collapser id="create-a-new-table" title="Crear una nueva tabla">
  ...
  <Collapser id="update-a-table" title="Actualizar una tabla existente">
...
<Collapser id="download-an-existing-table" title="Descargar una tabla existente">
...
<Collapser id="delete-an-existing-table" title="Eliminar una tabla existente">
...
<Collapser id="list-tables" title="Tablas de listado actualizadas para una cuenta">
