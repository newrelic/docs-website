...
<CollapserGroup>
    ...
    mutation {
      dashboardUpdateWidgetsInPage(
        ...
        widgets: [{
          ...
          description: "Real-time performance indicators for critical services"
          link: {
            url: "https://your-company.com/performance-guide"
          }
        }]
      ) {
        errors {
  ...
  <Collapser id="bulk-update-widget-links" title="Actualizar múltiples widgets de forma masiva">
    Puede actualizar enlaces y descripciones para múltiples widgets en una sola llamada de API:
    ...
    mutation {
      dashboardUpdateWidgetsInPage(
        ...
        widgets: [
          {
            id: "WIDGET_ID_1"
            description: "CPU usage across all application instances"
            link: { url: "https://docs.company.com/cpu-monitoring" }
          },
          {
            id: "WIDGET_ID_2"
            description: "Memory consumption trends - alert threshold: 85%"
            link: { url: "https://docs.company.com/memory-monitoring" }
          },
          {
            id: "WIDGET_ID_3"
            description: "Network throughput and latency metrics"
            link: { url: "https://docs.company.com/network-monitoring" }
          }
        ]
      ) {
        errors {
