...
Para comenzar fácilmente, usa nuestro [explorador de la API de NerdGraph](/docs/apis/nerdgraph/get-started/nerdgraph-explorer) para crear y editar información de equipos. Las definiciones están disponibles en NerdGraph para cada uno de los campos de los siguientes ejemplos. Si necesitas ayuda para usar el IDE de GraphiQL, consulta nuestro [tutorial del explorador de la API de NerdGraph](/docs/apis/nerdgraph/get-started/nerdgraph-explorer/). Si necesitas configurar permisos personalizados para administrar Teams, consulta [Crear roles personalizados para Teams](/docs/apis/nerdgraph/examples/nerdgraph-teams-custom-role-tutorial).
...
* `onCallMembers`: una lista de entidades `OnCallMember` que representan contactos fuera del horario laboral habitual. Cada entidad requiere un campo de ID que contenga el GUID de entidad del usuario. Los miembros de guardia deben ser miembros del equipo. Para encontrar los GUID de usuario, consulte [Recuperar el ID de usuario](#user-id).
...
* `onCallMembers` acepta una lista de entidad `OnCallMember`. Cada entidad requiere un campo de ID que contenga el GUID de entidad del usuario. Para encontrar los GUID de usuario, consulte [Recuperar el ID de usuario](#user-id).
