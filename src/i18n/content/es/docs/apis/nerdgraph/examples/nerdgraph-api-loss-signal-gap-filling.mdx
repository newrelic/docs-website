...
<Callout variant="tip">
  ...
  Para obtener más información sobre la pérdida de señales, el llenado de vacíos y cómo solicitar acceso a estas características, consulte [esta publicación del foro de soporte](https://support.newrelic.com/s/hubtopic/aAX8W0000008b5p/announcing-new-relic-one-streaming-alerts-for-nrql-conditions).
</Callout>
