...
Se utilizarán los siguientes [componentes NRQL](/docs/query-your-data/nrql-new-relic-query-language/get-started/nrql-syntax-clauses-functions) <DoNotTranslate>**cannot**</DoNotTranslate> en la consulta:
