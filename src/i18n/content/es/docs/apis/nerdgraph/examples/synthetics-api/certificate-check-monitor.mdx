...
Puede crear un monitor de verificación de certificado empleando la mutación <DNT>`syntheticsCreateCertCheckMonitor`</DNT>. Esta mutación le permite configurar el monitoreo de la expiración del certificado SSL en cualquier dominio.
...
Puede actualizar un monitor de verificación de certificado existente empleando la mutación <DNT>`syntheticsUpdateCertCheckMonitor`</DNT>. Esto le permite modificar la configuración de un monitor de verificación de certificados que ya se creó.
...
Cuando ya no se necesita un monitor de verificación de certificado, puede eliminarlo de forma permanente empleando la mutación <DNT>`syntheticsDeleteMonitor`</DNT>.
...
## Consulta de monitores de verificación de certificados [#query-certificate-check-monitors]

Utiliza NerdGraph para obtener metadatos, mapear ID o comprobar el estado de tus monitores de verificación de certificados.

Para obtener más información, consulte:

* [Consultar todos los monitores](/docs/apis/nerdgraph/examples/synthetics-api/query-synthetics-data#query-monitors): para listar todos los monitores sintéticos y su configuración.
* [Mapear el ID del monitor al GUID de la entidad](/docs/apis/nerdgraph/examples/synthetics-api/query-synthetics-data#query-guid-mapping): para migrar los ID de los monitores legacy a los GUID de las entidades.
* [Estado de actualización de runtime](/docs/apis/nerdgraph/examples/synthetics-api/query-synthetics-data#query-runtime-upgrade-all): para comprobar si tus monitores están listos para las últimas actualizaciones de runtime.
