---
title: 'Tutorial de NerdGraph: Crear y configurar widgets de dashboard'
tags:
  - APIs
  - NerdGraph
  - Examples
...
Con la API del dashboard de New Relic, puede usar [NerdGraph](https://api.newrelic.com/graphiql) para crear su [dashboard](/docs/query-your-data/explore-query-data/dashboards/introduction-dashboards). Este documento explica los diferentes tipos de widgets que puede agregar a su dashboard y cómo crearlos y obtenerlos usando la API.
...
* `visualization`: El tipo de visualización del widget, como una cadena. Por ejemplo: `viz.line`, `viz.area`. Consulte los [ejemplos a continuación](#typed-widget-data).
...
* `configuration`: La [configuración tipada](#widget-typed) del widget. Es una representación GraphQL convenientemente tipada de los widgets más comunes: [área](#area), [barras](#bar), [cartelera](#billboard), [líneas](#line), [markdown](#markdown), [pastel](#pie) y [tabla](#table).
* `rawConfiguration`: La [configuración sin tipo](#widget-untyped) del widget. Es una forma libre (escalar JSON) de almacenar propiedades de widgets no cubiertas por la configuración tipada, como [mapa de calor](#heatmap), [histograma](#histogram), [bullet](#bullet), [embudo](#funnel), etc. En este caso, `configuration` es nulo y `rawConfiguration` contiene todos los datos requeridos por el widget.
...
<CollapserGroup>
  <Collapser id="widget-typed" title="Widget escrito">
  ...
  <Collapser id="widget-untyped" title="Widget sin tipo">
...
<CollapserGroup>
  <Collapser id="area-input" title="Aporte">
    ```graphql
    {
      widgets: {
        configuration: {
  ...
  <Collapser id="area-output" title="Producción">
    ```json
    {
...
<CollapserGroup>
  <Collapser id="bar-input" title="Aporte">
    ```graphql
    {  
      widgets: {
        configuration: {
  ...
  <Collapser id="bar-output" title="Producción">
    ```json
    {
...
<CollapserGroup>
  <Collapser id="billboard-input" title="Aporte">
    ```graphql
    {  
      widgets: {
        configuration: {
  ...
  <Collapser id="billboard-output" title="Producción">
    ```json
    {
...
<CollapserGroup>
  <Collapser id="line-input" title="Aporte">
    ```graphql
    {
      widgets: {
        configuration: {
  ...
  <Collapser id="line-output" title="Producción">
    ```json
    {
...
<CollapserGroup>
  <Collapser id="markdown-input" title="Aporte">
    ```graphql
    {
      widgets: {
        configuration: {
  ...
  <Collapser id="markdown-output" title="Producción">
    ```json
    {
...
<CollapserGroup>
  <Collapser id="pie-input" title="Aporte">
    ```graphql
    {
      widgets: {
        configuration: {
  ...
  <Collapser id="pie-output" title="Producción">
    ```json
    {
...
<CollapserGroup>
  <Collapser id="table-input" title="Aporte">
    ```graphql
    {
      widgets: {
        configuration: {
  ...
  <Collapser id="table-output" title="Producción">
    ```json
    {
...
<CollapserGroup>
  <Collapser id="linep-input" title="Aporte">
    ```graphql
    {
      widgets: {
        visualization: "viz.area"
  ...
  <Collapser id="linep-output" title="Producción">
    ```json
    {
      "visualization": "viz.area",
      "configuration": null,
...
<CollapserGroup>
  <Collapser id="bullet-input" title="Aporte">
    ```graphql
    {
      widgets: {
  ...
  <Collapser id="bullet-output" title="Producción">
    ```json
    {
      "visualization": "viz.bullet",
      "configuration": null,
...
<CollapserGroup>
  <Collapser id="event-feed-input" title="Aporte">
    ```graphql
    {
      widgets: {
  ...
  <Collapser id="event-feed-output" title="Producción">
    ```json
    {
      "visualization": "viz.event-feed",
      "configuration": null,
...
<CollapserGroup>
  <Collapser id="funnel-input" title="Aporte">
    ```graphql
    {
      widgets: {
  ...
  <Collapser id="funnel-output" title="Producción">
    ```json
    {
      "visualization": "viz.funnel",
      "configuration": null,
...
<CollapserGroup>
  <Collapser id="heatmap-input" title="Aporte">
    ```graphql
    {
      widgets: {
  ...
  <Collapser id="heatmap-output" title="Producción">
    ```json
    {
      "visualization": "viz.heatmap",
      "configuration": null,
...
<CollapserGroup>
  <Collapser id="histogram-input" title="Aporte">
    ```graphql
    {
      widgets: {
  ...
  <Collapser id="histogram-output" title="Producción">
    ```json
    {
      "visualization": "viz.histogram",
      "configuration": null,
...
<CollapserGroup>
  <Collapser id="inventory-input" title="Aporte">
    ```graphql
    {
      widgets: {
  ...
  <Collapser id="inventory-output" title="Producción">
    ```json
    {
      "visualization": "infra.inventory",
      "configuration": null,
...
<CollapserGroup>
  <Collapser id="json-input" title="Aporte">
    ```graphql
    {
      widgets: {
  ...
  <Collapser id="json-output" title="Producción">
    ```json
    {
      "visualization": "viz.json",
      "configuration": null,
...
<CollapserGroup>
  <Collapser id="linem-input" title="Aporte">
    ```graphql
    {
      widgets: {
        visualization: "viz.line"
  ...
  <Collapser id="linem-output" title="Producción">
    ```json
    {
      "visualization": "viz.line",
      "configuration": null,
...
<CollapserGroup>
  <Collapser id="service-map-input" title="Aporte">
    ```graphql
    {
      widgets: {
  ...
  <Collapser id="service-map-output" title="Producción">
    ```json
    {
      "visualization": "topology.service-map",
      "configuration": null,
