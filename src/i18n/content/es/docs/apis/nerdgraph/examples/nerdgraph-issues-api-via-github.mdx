...
<CollapserGroup>
  ...
  >
    ...
    Con la paginación del cursor, continúa realizando solicitudes a través de los datos del resultado hasta que el `nextCursor` devuelto por la respuesta vuelve vacío. Una respuesta vacía significa que has llegado al final de tus resultados.
...
<CollapserGroup>
  ...
  >
    ...
    Con la paginación del cursor, continúa realizando una solicitud a través de los datos del resultado hasta que el siguiente cursor que se devuelve de la respuesta vuelve vacío. Significa que llegas al final de tus resultados.
