...
1. [Encuentre los ID de licencias necesarias para Teams](#retrieve-organization-scoped-capabilities)
2. [Recuperar el ID de su organización](#retrieve-your-organization-id)
3. [Crear el rol personalizado para el administrador de Teams](#create-custom-role)
...
<CollapserGroup>
  <Collapser id="retrieve-organization-scoped-capabilities" title="Encuentre los ID de licencias necesarias para Teams">
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Los ID de licencias para la función Teams identificados en el primer paso.
          </td>
        </tr>
