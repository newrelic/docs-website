    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Los ID de cuenta objetivo para la evaluación de reglas. La consulta NRQL se ejecuta en cada cuenta especificada en esta lista para evaluar el cumplimiento.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            ID de cuentas auxiliares para incluir durante la ejecución de la consulta. Habilita las consultas NRQL entre cuentas al unir datos de estas cuentas secundarias con cada cuenta objetivo principal.
          </td>
        </tr>
