...
3. Ejecute la mutación <DoNotTranslate>**dashboardCreateSnapshotURL**</DoNotTranslate> en el [explorador NerdGraphQL](https://api.newrelic.com/graphiql) tantas veces como páginas dashboard desee exportar. Solo necesita proporcionar el GUID de la página dashboard deseado como parámetro.
