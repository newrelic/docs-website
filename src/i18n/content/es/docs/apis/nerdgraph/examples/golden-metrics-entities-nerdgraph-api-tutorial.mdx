...
El objeto de entrada de métricas define las partes de una consulta NRDB, divididas en secciones. Una de estas secciones es el `eventId`, que se utiliza para identificar el campo que define el GUID dentro del *evento NRDB* que desea utilizar como métrica dorada. Por ejemplo:
