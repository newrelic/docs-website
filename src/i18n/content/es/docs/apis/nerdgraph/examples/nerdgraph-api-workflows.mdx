---
title: 'Tutorial de NerdGraph: Crear y gestionar el flujo de trabajo de inteligencia aplicada'
tags:
...
Para la inteligencia aplicada de New Relic, puede crear y administrar [el flujo de trabajo](/docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows) utilizando nuestra API NerdGraph.
...
Cuando actualice un flujo de trabajo, tenga en cuenta que el único atributo obligatorio que debe proporcionar es el ID del flujo de trabajo y el ID de la cuenta. El resto son opcionales. Por ejemplo, solo necesita proporcionar el nombre si solo desea actualizarlo.

Para obtener el ID del flujo de trabajo, vaya a la tabla del flujo de trabajo y haga clic en <DoNotTranslate>**...**</DoNotTranslate> al final de la fila. Luego, elija <DoNotTranslate>**Copy workflow id to clipboard**</DoNotTranslate>.

A continuación se muestra un ejemplo de cómo actualizar un flujo de trabajo:
