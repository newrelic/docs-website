...
Para obtener el ID del flujo de trabajo, vaya a la tabla del flujo de trabajo y haga clic en el icono <DoNotTranslate>**<Icon name="fe-more-horizontal"/>**</DoNotTranslate> al final de la fila. Luego, elija <DoNotTranslate>**Copy workflow id to clipboard**</DoNotTranslate>.
