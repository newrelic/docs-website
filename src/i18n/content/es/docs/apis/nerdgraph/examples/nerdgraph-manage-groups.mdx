...
Después de tener el identificador único de cada permiso que desea asignar al nuevo rol, utilice la siguiente mutación para crear un [rol](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts/#roles):
...
* `id`: Devuelve el ID único del rol personalizado recién creado.
  ...
  <Callout variant="important">
    ...
    * Reemplace el ejemplo `permissionIds: [1, 2, 3]` con los ID de permisos reales que recuperó de la consulta de permisos.
  </Callout>
