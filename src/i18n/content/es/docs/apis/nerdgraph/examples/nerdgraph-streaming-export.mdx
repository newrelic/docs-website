...
<CollapserGroup>
  ...
  >
    ...
    * Este rol debe tener una política con estos permisos: `s3:PutObject` y `s3:GetObject`.
    ...
    4. Haga clic en <DoNotTranslate>**Create function**</DoNotTranslate>.

    5. Seleccione el entorno de ejecución de Java 11.

    6. Haga clic en <DoNotTranslate>**Change default execution role > Use an existing role**</DoNotTranslate>. Ingrese aquí el rol que creó en el paso 2.

    7. Desplácese hacia abajo y haga clic en <DoNotTranslate>**Create function**</DoNotTranslate>.

    8. Una vez creada la función, haga clic en <DoNotTranslate>**Upload from**</DoNotTranslate> y seleccione <DoNotTranslate>**.zip or .jar file**</DoNotTranslate> en el menú desplegable.

    9. Haga clic en <DoNotTranslate>**Upload**</DoNotTranslate> en el cuadro que aparece y seleccione el archivo ZIP creado en el paso 1.

    10. Una vez que haya finalizado la carga, haga clic en <DoNotTranslate>**Save**</DoNotTranslate> para salir del cuadro emergente.

    11. Edite <DoNotTranslate>**Runtime settings**</DoNotTranslate> agregando el controlador. En nuestra función proporcionada, el controlador es <DoNotTranslate>`metadatasetter.App::handleRequest`</DoNotTranslate>.

    12. Todo lo que queda por hacer ahora es habilitar esta función Lambda para que se active al crear objetos S3. Haga clic en <DoNotTranslate>**Add trigger**</DoNotTranslate> para comenzar a configurarlo.

    13. En el menú desplegable, seleccione <DoNotTranslate>**S3**</DoNotTranslate> como fuente.

    14. Ingrese el nombre del depósito de S3 al que desea aplicar los metadatos en el campo <DoNotTranslate>**Bucket**</DoNotTranslate> .

    15. Elimine el <DoNotTranslate>**All object create events**</DoNotTranslate> predeterminado de los tipos de eventos. En el menú desplegable de tipos de eventos, seleccione <DoNotTranslate>**PUT**</DoNotTranslate>.

    16. Marque la casilla <DoNotTranslate>**Recursive invocation**</DoNotTranslate> y luego haga clic en <DoNotTranslate>**Add**</DoNotTranslate> en la parte inferior derecha.
