...
* Región de EE. UU. (predeterminado): `https://api.newrelic.com/graphql`
* Región de la UE: `https://api.eu.newrelic.com/graphql`
* Región de JP: `https://api.jp.newrelic.com/graphql`
