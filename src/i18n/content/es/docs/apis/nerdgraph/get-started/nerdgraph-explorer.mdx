...
<Steps>
  <Step>
    ...
    1. Vaya a <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com) > All capabilities > Apps > [NerdGraph API explorer](https://api.newrelic.com/graphiql)**</DoNotTranslate>.
