...
<Steps>
  <Step>
    ...
    1. Abra el explorador de la API de NerdGraph. La URL depende de la región del centro de datos que aloja su cuenta:

       * EE. UU. (región predeterminada): <DNT>[one.newrelic.com/nerdgraph-graphiql](https://one.newrelic.com/nerdgraph-graphiql)</DNT>
       * UE: <DNT>[one.eu.newrelic.com/nerdgraph-graphiql](https://one.eu.newrelic.com/nerdgraph-graphiql)</DNT>
       * JP: <DNT>[one.jp.newrelic.com/nerdgraph-graphiql](https://one.jp.newrelic.com/nerdgraph-graphiql)</DNT>
