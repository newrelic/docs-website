...
NerdGraph impone un límite de <DoNotTranslate>**25 concurrent requests per user**</DoNotTranslate>.

La tasa de solicitudes que realiza no está limitada, solo la cantidad de <DoNotTranslate>**concurrent**</DoNotTranslate> solicitudes.
...
Podemos permitir más de 25 solicitudes simultáneas por usuario, según el estado del sistema, pero <DoNotTranslate>**only 25 concurrent requests are guaranteed.**</DoNotTranslate>
