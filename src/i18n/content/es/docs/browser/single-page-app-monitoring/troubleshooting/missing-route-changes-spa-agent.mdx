...
<DoNotTranslate>**Recommendation:**</DoNotTranslate> Si no tiene acceso al evento del enrutador ni al controlador de eventos de interacción, implemente esto lo antes posible en un código que sepa que es el resultado de la interacción del usuario.
