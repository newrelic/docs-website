...
4. Para la versión 2.1 de SPA y posteriores, el monitor verifica si hay una devolución de llamada de larga duración durante un máximo de 5 segundos. Si se identifica una devolución de llamada de larga duración, el sistema extiende la interacción actual y vuelve a ejecutar el monitor.
