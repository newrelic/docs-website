...
<CollapserGroup>
  ...
  >
    Verifique que el monitoreo del navegador se haya habilitado en <DoNotTranslate>**Browser settings**</DoNotTranslate> de su aplicación:
  ...
  >
    Si ve errores de JavaScript en su página web, o si no ve ningún dato en su [página<DoNotTranslate>**Errors**</DoNotTranslate> ](/docs/errors-inbox/browser-tab)en la UI de New Relic, verifique si se ha habilitado algún otro marco de monitoreo de errores de JavaScript para su aplicación. Algunos monitores de errores de JavaScript pueden interferir con la funcionalidad de monitoreo del navegador.
  </Collapser>
...
<CollapserGroup>
  ...
  >
    ...
    Para solucionar este problema, utilice <DoNotTranslate>**one**</DoNotTranslate> de estas soluciones alternativas:
