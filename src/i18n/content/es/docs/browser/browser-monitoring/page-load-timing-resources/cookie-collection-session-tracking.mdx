...
La característica de sincronización [de carga de la página](/docs/browser/new-relic-browser/page-load-timing-resources/page-load-timing-process) del navegador puede rastrear sesiones utilizando la API sessionStorage que puede almacenar un identificador de sesión simple.
...
2. A medida que se carga la página del usuario, nuestro
...
## Activar o desactivar el seguimiento [#settings]
...
2. En la configuración
   ...
   <DoNotTranslate>**Privacy**</DoNotTranslate>
