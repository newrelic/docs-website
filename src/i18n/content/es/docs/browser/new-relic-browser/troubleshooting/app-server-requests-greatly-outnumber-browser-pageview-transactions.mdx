...
<CollapserGroup>
  ...
  >
    Las páginas web no son <DoNotTranslate>**text/html**</DoNotTranslate>. (Para evitar dañar los datos, browser no instrumenta páginas que no sean HTML, porque no están diseñadas para ser analizadas por un browser).
  </Collapser>
  ...
  >
    Algunas solicitudes a su backend se realizan a través de AJAX. El rendimiento de AJAX se rastrea por separado en [la página<DoNotTranslate>**AJAX**</DoNotTranslate> ](/docs/browser/new-relic-browser/browser-pro-features/ajax-dashboard-identifying-time-consuming-calls)del navegador.
  </Collapser>
  ...
  >
    El usuario sale de la página antes de que termine de cargarse o antes de llegar al <DoNotTranslate>**window.onload() event**</DoNotTranslate>.
