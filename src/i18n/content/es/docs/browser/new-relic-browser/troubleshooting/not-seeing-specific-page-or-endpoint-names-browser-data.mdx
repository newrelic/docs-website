...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Si su sitio es una aplicación de una sola página y solo ve `/` en las vistas de página, entonces su agrupación está funcionando correctamente. New Relic registra las solicitudes posteriores a medida que se carga AJAX y su [página<DoNotTranslate>**AJAX**</DoNotTranslate> ](/docs/browser/new-relic-browser/browser-pro-features/ajax-dashboard-identifying-time-consuming-calls)contendrá información más detallada. Si no es así, siga los consejos de este documento.
      </td>
    </tr>
