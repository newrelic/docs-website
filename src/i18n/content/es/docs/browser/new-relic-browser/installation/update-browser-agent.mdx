...
Utilice cualquiera de las siguientes opciones para acceder al fragmento de JavaScript browser necesario para actualizar una instalación de copiar y pegar. Después de acceder al fragmento, asegúrese de reemplazar <DoNotTranslate>**all**</DoNotTranslate> de su fragmento existente con la nueva versión.
...
<CollapserGroup>
  ...
  >
    Descargue la última versión del fragmento: vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Browser > (select an app) > Application settings**</DoNotTranslate>.
