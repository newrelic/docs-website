...
<DoNotTranslate>**Note:**</DoNotTranslate> Para los navegadores que tienen la API de sincronización de navegación, esto no es un problema, ya que la hora de inicio de la navegación se puede determinar sin utilizar una cookie.