...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Los datos se envían 10 segundos luego de la carga inicial de la página y luego cada 30 segundos. Si el tamaño de la carga útil de la cosecha es mayor a 16 KB, los datos se envían anticipadamente.
      </td>
    </tr>
