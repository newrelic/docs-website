...
<table id="navigation-api">
  ...
  <tbody>
    <tr>
      <td>
        Navegador <DoNotTranslate>**with**</DoNotTranslate> API de especificación de tiempo de navegación
      </td>
    ...
    <tr>
      <td>
        Navegador <DoNotTranslate>**without**</DoNotTranslate> API de especificación de tiempo de navegación
      </td>
...
Para ambas páginas web https <DoNotTranslate>**and**</DoNotTranslate> http, transmitimos datos a través de https. Esto resume cuándo se transmiten los datos hacia y desde la página web.
