...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Requerido. Proporcione un mensaje de error significativo que pueda utilizar al analizar datos en [la página<DoNotTranslate>**Errors**</DoNotTranslate> ](/docs/errors-inbox/browser-tab)del navegador.
      </td>
    </tr>
