...
* Si está instalando el agente de browser a través de npm y construyendo un agente personalizado con funciones seleccionadas, debe habilitar al menos una función al crear la instancia de `Agent`. Por ejemplo, agregue lo siguiente en el arreglo`features`:
