...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Requerido<DoNotTranslate>**.**</DoNotTranslate> Cuando ocurre un error, se llama a la devolución de llamada con el objeto de error como parámetro. La devolución de llamada se llamará con cada error, por lo que no es específica de un error.
      </td>
    </tr>
  </tbody>
</table>
