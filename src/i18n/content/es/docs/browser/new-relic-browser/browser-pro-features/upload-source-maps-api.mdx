...
<Callout variant="important">
  Los siguientes ejemplos son para cuentas de EE. UU. (predeterminado). Para otras regiones, use el extremo correspondiente:

  * Cuentas de la UE: `https://sourcemaps.service.eu.newrelic.com`
  * Cuentas de JP: `https://sourcemaps.service.jp.newrelic.com`

  Para obtener más información, consulte [Elija su centro de datos](/docs/accounts/accounts-billing/account-setup/choose-your-data-center).
</Callout>
