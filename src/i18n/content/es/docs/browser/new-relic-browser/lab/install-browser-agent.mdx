...
<Steps>
  ...
  <Step>
    En el lado derecho de la barra de navegación superior, haga clic en <DNT>**Add data**</DNT>.
  ...
  <Step>
    Desplácese hacia abajo hasta <DNT>**Browser & mobile**</DNT> y seleccione <DNT>**Browser monitoring**</DNT>.
  ...
  <Step>
    Seleccione <DNT>**Copy/paste JavaScript code**</DNT> para su método de implementación.
  ...
  <Step>
    Desplácese hacia abajo hasta <DNT>**Name your app**</DNT>. Asigne a su aplicación el nombre <DNT>**Relicstaurants**</DNT> y haga clic en <DNT>**Enable**</DNT>.
...
Su aplicación ahora envía datos del navegador a New Relic. Vea estos datos en New Relic, en <DNT>**Browser**</DNT>.
...
<Steps>
  ...
  <Step>
    En la barra de navegación de la izquierda, navegue hasta <DNT>**Browser**</DNT> y seleccione <DNT>**Relicstaurants**</DNT>.
    ...
    Aquí verá <DNT>**Page views with JavaScript errors**</DNT>, <DNT>**Core web vitals**</DNT>, <DNT>**User time on the site**</DNT>, <DNT>**Initial page load and route changes**</DNT> y otros datos de rendimiento de su aplicación.
