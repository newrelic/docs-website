...
¿Qué significa [esta migración](https://support.newrelic.com/s/hubtopic/aAX8W0000008dKO/plan-to-upgrade-alert-notification-channels-to-workflows-and-destinations) para su equipo? En nuestro modelo de notificación anterior, su equipo creaba una condición de alerta con diferentes umbrales y parámetros. Si esa condición estaba asociada a una política específica, se incumplía y quería que su equipo lo supiera de inmediato, agregaba <DNT>**notification settings**</DNT>. Nuestra configuración de notificación le indicaba a New Relic qué datos enviar y a dónde.
