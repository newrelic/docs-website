...
<CollapserGroup>
  ...
  <Collapser className="freq-link" id="email" title="Correo electrónico">
    ...
    6. Haga clic en <DNT>**Additional settings**</DNT> para enriquecer sus datos. Habilite <DNT>**Enrich your data**</DNT> para crear una consulta NRQL.

    7. Haga clic en <DNT>**Save and exit**</DNT>.

    8. Seleccione <DNT>**Email**</DNT> como método de notificación.
    ...
    9. Agregue los correos electrónicos a los que desea enviar la notificación. Puede agregar uno o más destinatarios.
       ...
       * Cuando crea un destino con una dirección de correo electrónico ya asociada a un destino existente, aparecerá un símbolo que ofrece la opción de fusionar los dos. Al seleccionar <DNT>**Merge**</DNT> se combinarán los destinos, lo que garantizará que las notificaciones se envíen de manera eficiente al destinatario previsto.
       * Puede seguir la notificación de correo electrónico por destino en el [log de notificaciones](/docs/alerts-applied-intelligence/notifications/destinations/#notifications-log).
  ...
  <Collapser className="freq-link" id="slack" title="Slack">
    ...
    Tu espacio de trabajo de Slack debe tener instalada la [aplicación New Relic](https://newrelic.slack.com/apps/AP92KQJS3-new-relic?tab=more_info)(o la [aplicación UE](https://slack.com/apps/AS5D75HQQ-new-relic-eu?tab=more_info) para `one.eu.newrelic` clientes). Un administrador del espacio de trabajo debe aprobar la aplicación antes de que usted pueda instalarla individualmente. Si necesita ayuda, siga estos pasos en la UI:

    1. Inicie sesión en New Relic.

    2. Visita nuestro [Centro de ayuda](https://one.newrelic.com/help-xp).

    3. Haga clic en **Create a Support Case**.

       ### Configurar un destino de Slack [#set-slack-destination]

    4. Vaya a <DNT>**[one.newrelic.com &gt; All capabilities](https://one.newrelic.com/all-capabilities) &amp;gt; Alerts**</DNT>, haga clic en <DNT>**Destinations**</DNT> y luego seleccione <DNT>**Slack**</DNT>.

    5. Haga clic en el botón <DNT>**Authenticate in one click**</DNT> para ir a la página de inicio de Slack y continuar con el proceso de autenticación OAuth2. Si no ha iniciado sesión en el espacio de trabajo requerido, se le redirigirá a Slack para iniciar sesión.
    ...
    6. Agregue el nombre de su espacio de trabajo o seleccione el espacio de trabajo relevante y haga clic en <DNT>**Continue**</DNT>.

       <img width="50%;" title="add a Slack workspace." alt="add a workspace." src="/images/accounts_screenshot-crop_slack-sign-in.webp" />

    7. Cuando inicie sesión en el espacio de trabajo seleccionado, permita que New Relic realice las acciones especificadas.
    ...
    8. Haga clic en <DNT>**Allow**</DNT> y regrese a la página de destino.
