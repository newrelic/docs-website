...
<CollapserGroup>
  ...
  >
    ...
    3. Seleccione o cree un nombre de destino.

    4. Seleccione o cree una fuente de evento.
    ...
    5. En la consola de AWS EventBridge, elija <DNT>**Partner event sources**</DNT> en el panel de navegación.

    6. Seleccione el botón junto a la fuente del evento del socio y luego elija <DNT>**Associate with event bus**</DNT>.
    ...
    7. Crea una regla para el bus de eventos.
  ...
  >
    ...
    ### Configurar un destino de inserción móvil [#set-mobile_push-destination][#set-mobile_push-destination]
  ...
  >
    ...
    * El reconocimiento de un problema de New Relic se activa cuando se reconoce el incidente de PagerDuty.
    ...
    6. Vaya a <DNT>**Services > Service Directory**</DNT> y seleccione el servicio donde desea agregar la integración.

    7. Seleccione la pestaña <DNT>**Integrations**</DNT> y haga clic en <DNT>**Add an integration**</DNT>.

    8. Busque y marque la integración de New Relic en la lista y haga clic en <DNT>**Add**</DNT>.
    ...
    9. Haga clic a la derecha para ver y copiar su <DNT>**Integration Key**</DNT>.
    ...
    10. Vaya a <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) &amp;gt; Alerts &amp;gt; Workflows**</DNT> y haga clic en un flujo de trabajo existente, o haga clic en el botón <DNT>**+ Add a new workflow**</DNT> y elija el notificador de PagerDuty.

    11. Elija un destino o cree uno nuevo.

    12. (Opcional) Edite el resumen de incidentes predeterminado.
  ...
  >
    ...
    * Para recuperar el usuario de la columna `caller` , necesitamos permisos de lectura para la tabla `sys_user` .
    ...
    3. Active la palanca `two-way integration` .

    4. Abra y descargue este [archivo XML](https://storage.googleapis.com/newrelic-notifications/snow-two-way-sync/Newrelic-Snow-Sync-Configurations.xml), que incluye la regla comercial que activa el evento de regreso a New Relic.

    5. En el menú de la barra lateral de ServiceNow, vaya a <DNT>**System Definition > Business Rules**</DNT>.

    6. Haga clic en el icono de menú en uno de los encabezados de columna, seleccione <DNT>**Import XML**</DNT> y cargue el archivo XML que descargó.
  ...
  >
    ...
    * Desde ServiceNow podrás enviar y ver como imágenes los enriquecimientos de New Relic.
      ...
      <Callout variant="important">
        Si no tiene acceso para crear un nuevo destino, envíe un email a [notificationWorkflows@newrelic.com](mailto:notificationWorkflows@newrelic.com) con su nombre y número de cuenta para obtener ayuda.
      </Callout>
    ...
    10. [Descargue e instale la aplicación New Relic](https://store.servicenow.com/sn_appstore_store.do#!/store/application/d117597d1b9b9d9078faddf7b04bcba7/1.1.1) en la tienda ServiceNow.

    11. Cree un usuario dentro de ServiceNow. Asegúrese de habilitar la opción <DNT>**Web service access only**</DNT> y otorgar el rol `x_newre_core.inbound_api` al usuario creado. Copie y guarde la contraseña generada.

    12. Vaya a <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) &amp;gt; Alerts**</DNT>, haga clic en <DNT>**Destinations**</DNT> y luego seleccione <DNT>**Webhook**</DNT>.
    ...
    14. Haga clic en <DNT>**Save destination**</DNT>.
    ...
    15. Vaya a <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) &amp;gt; Alerts**</DNT>, haga clic en <DNT>**Workflows**</DNT>.

    16. Haga clic en el <Icon name="fe-more-horizontal"/> en un webhook existente y seleccione <DNT>**Edit**</DNT> o haga clic en el botón <DNT>**+ Add a new workflow**</DNT> .

    17. Haga clic en el canal <DNT>**Webhook**</DNT> .

    18. Modifique la carga útil predeterminada agregando el atributo `serviceNowFields` que necesite.
    ...
    19. Haga clic en <DNT>**Send test notification**</DNT> para comprobar sus cambios.

    20. Haga clic en <DNT>**Save message**</DNT>.

    21. Haga clic en <DNT>**Activate workflow**</DNT>.
  </Collapser>
  ...
  >
    ...
    9. Vaya a <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) &amp;gt; Alerts &amp;gt; Workflows**</DNT> y haga clic en un flujo de trabajo existente o en el botón <DNT>**+ Add a workflow**</DNT> .

    10. Seleccione un destino, también conocido como espacio de trabajo, y un canal de Slack para enviar mensajes. Puede crear un nuevo destino si no hay un destino predefinido para el espacio de trabajo requerido.

    11. También puede optar por recibir actualizaciones de notificaciones, como cuando se reconoce o cierra un problema, en el canal. Esto también se conoce como transmisión del hilo.

        <img
          title="thread braodcast"
          alt="a screenshot depicting the thread broadcast in the UI."
          src="/images/alerts_screenshot-crop_thread-broadcast.webp"
        />

    12. Puede utilizar la notificación predeterminada o enriquecerla con detalles personalizados. Elija variables del [menú de variables](/docs/alerts-applied-intelligence/notifications/message-templates/#variables-menu) y aplique [la sintaxis del manillar](/docs/alerts-applied-intelligence/notifications/message-templates/#handlebars-syntax) para enriquecer su carga útil.

    13. Haga clic en el botón <DNT>**Send test notification**</DNT> para enviar una notificación de prueba con una carga útil de ejemplo predefinida al canal. Esto crea un mensaje en el canal de Slack seleccionado.
