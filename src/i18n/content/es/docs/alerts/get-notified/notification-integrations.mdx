...
<CollapserGroup>
  ...
  >
    ...
    1. Vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts**</DoNotTranslate>, haga clic en <DoNotTranslate>**Destinations**</DoNotTranslate> y luego seleccione <DoNotTranslate>**Jira**</DoNotTranslate>.
    ...
    * El reconocimiento del problema de New Relic se activa cuando el estado del problema de Jira cambia a `in-progress`.
    ...
    1. Vaya a
       ...
       <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Workflows**</DoNotTranslate>
  ...
  >
    ...
    1. Vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts**</DoNotTranslate>, haga clic en <DoNotTranslate>**Destinations**</DoNotTranslate> y luego seleccione <DoNotTranslate>**AWS EventBridge**</DoNotTranslate>.
  ...
  >
    ...
    1. Vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts**</DoNotTranslate>.
  ...
  >
    ...
    * [Token de usuario personal](https://support.pagerduty.com/docs/generating-api-keys#section-generating-a-personal-rest-api-key): si su cuenta tiene permisos avanzados, puede crear una clave de API REST personal única. Las solicitudes realizadas utilizando la clave de API REST personal están restringidas a los permisos del usuario. Si elige proporcionar un token de usuario clave de API, asegúrese de que tenga los permisos requeridos descritos anteriormente. [Consulte las instrucciones de PagerDuty](https://support.pagerduty.com/docs/api-access-keys#generate-a-user-token-rest-api-key).
    ...
    1. Vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts**</DoNotTranslate>, haga clic en <DoNotTranslate>**Destinations**</DoNotTranslate> y luego seleccione <DoNotTranslate>**PagerDuty**</DoNotTranslate>.
  ...
  >
    ...
    * Para recuperar el usuario de la columna `caller` , necesitamos permisos de lectura para la tabla `sys_user` .
    ...
    1. Vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts**</DoNotTranslate>, haga clic en <DoNotTranslate>**Destinations**</DoNotTranslate> y luego seleccione <DoNotTranslate>**ServiceNow**</DoNotTranslate>.
    ...
    1. Vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Workflows**</DoNotTranslate> y haga clic en un flujo de trabajo existente o en el botón <DoNotTranslate>**+ Add a new workflow**</DoNotTranslate>
  ...
  >
    ...
    * Desde ServiceNow podrás enviar y ver como imágenes los enriquecimientos de New Relic.
    ...
    3. Vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts**</DoNotTranslate>, haga clic en <DoNotTranslate>**Destinations**</DoNotTranslate> y luego seleccione <DoNotTranslate>**ServiceNow**</DoNotTranslate>.
    ...
    3. Vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts**</DoNotTranslate>, haga clic en <DoNotTranslate>**Destinations**</DoNotTranslate> y luego seleccione <DoNotTranslate>**Webhook**</DoNotTranslate>.
    ...
    5. Haga clic en <DoNotTranslate>**Save destination**</DoNotTranslate>.
    ...
    1. Vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts**</DoNotTranslate>, haga clic en <DoNotTranslate>**Workflows**</DoNotTranslate>.
  ...
  >
    ...
    1. Vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts**</DoNotTranslate>, haga clic en <DoNotTranslate>**Destinations**</DoNotTranslate> y luego seleccione <DoNotTranslate>**Slack**</DoNotTranslate>.
    ...
    1. Vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Workflows**</DoNotTranslate> y haga clic en un flujo de trabajo existente o en el botón <DoNotTranslate>**+ Add a workflow**</DoNotTranslate> .
  ...
  >
    ...
    1. Vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts**</DoNotTranslate>, haga clic en <DoNotTranslate>**Destinations**</DoNotTranslate> y luego seleccione <DoNotTranslate>**Webhook**</DoNotTranslate>.
    ...
    * Si agregó la misma clave de encabezado tanto al destino como al canal, el destino tendrá prioridad. El canal no será empleado.
    ...
    Vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Workflows**</DoNotTranslate> y haga clic en un flujo de trabajo existente, o en el botón <DoNotTranslate>**+ Add a new workflow**</DoNotTranslate> y seleccione un destino de Webhook.
