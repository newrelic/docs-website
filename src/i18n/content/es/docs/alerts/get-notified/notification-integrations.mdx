...
<CollapserGroup>
  ...
  >
    ...
    8. También puede optar por recibir actualizaciones de notificaciones, como cuando se reconoce o cierra un problema, en el canal. Esto también se conoce como transmisión del hilo.<img title="thread braodcast" alt="a screenshot depicting the thread broadcast in the UI." src="/images/alerts_screenshot-crop_thread-broadcast.webp"/>
