...
<CollapserGroup>
  ...
  >
    ...
    4. Haga clic en el botón <DNT>**Send test notification**</DNT> para enviar una notificación de prueba con una carga útil de ejemplo predefinida al canal. Esto crea un mensaje en el canal de Slack seleccionado.
