...
Alerta envía una notificación oportuna cuando su sistema tiene problemas. A veces hay notificaciones que sabes que no necesitas ver. Puedes usar <DNT>**muting rules**</DNT> para dejar de ser bombardeado con mensajes que no necesitan tu atención.
...
Puede crear, habilitar, deshabilitar y administrar reglas de silenciamiento. Vaya a <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Muting rules**</DNT>. Habilite o deshabilite las reglas de silencio en cualquier momento. Haga clic en el <Icon name="fe-more-horizontal"/> icono en la fila de cada regla para editar y eliminar reglas.
...
<CollapserGroup>
  ...
  >
    incidentes y problemas están marcados con el <Icon name="fe-bell-off"/> icono en la columna <DNT>**Muted**</DNT> :
