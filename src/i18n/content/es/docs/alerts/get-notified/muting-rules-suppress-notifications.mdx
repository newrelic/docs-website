...
* <DNT>**Close ongoing incidents**</DNT>:Esto significa que si se activa un incidente justo después de que la regla de silencio esté inactiva, recibirás una notificación. Le recomendamos que mantenga esta configuración predeterminada.
