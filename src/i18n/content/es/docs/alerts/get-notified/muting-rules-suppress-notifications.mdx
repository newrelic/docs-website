...
## Cómo suprimir la notificación [#notify]

Si una regla de silencio está activa, por ejemplo, mantenimiento planeado, no recibirás notificación cuando se active un incidente.

Cuando la regla de silencio ya no está activa, tienes estas opciones:

* <DNT>**Close ongoing incidents**</DNT>:Esto significa que si se activa un incidente o sigue abierto justo después de que la regla de silenciamiento expiró o se deshabilitó, recibirás una notificación. Le recomendamos que mantenga esta configuración predeterminada.

* <DNT>**Continue ongoing incidents**</DNT>:Esto significa que si un incidente que comenzó durante una ventana de silenciamiento continúa después de que la regla de silenciamiento se vuelve inactiva, no se le notificará.
