...
La característica de flujo de trabajo se encuentra en el menú <DoNotTranslate>**Alerts **</DoNotTranslate>.

1. Vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Enrich and Notify > Workflow > Add a workflow**</DoNotTranslate>.
...
Para acceder al log de notificaciones de problemas, vaya a <DoNotTranslate>**[one.newrelic.com > Alerts > Workflows](https://one.newrelic.com/alerts-ai/workflows)**</DoNotTranslate> y luego haga clic en <DoNotTranslate>**Issue notification log**</DoNotTranslate>.
