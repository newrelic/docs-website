...
Supongamos que ejecuta un sitio de comercio electrónico y creó una condición de alerta para desencadenar un incidente cada vez que su sitio genera errores de respuesta 404. Puede emplear una plantilla de título para que el incidente de esta condición sea fácilmente identificable.

Denominó esta condición de alerta `high error rate - checkout`. Pero desea que el título del incidente refleje dónde se generan los errores. En este caso, los errores de este incidente se originaron en su entidad de pago.
...
<CollapserGroup>
  <Collapser
    id="template-ui"
    title="Crear una plantilla de título en la UI"
  >
  ...
  <Collapser
    id="template-ui"
    title="Crea una plantilla de título en GraphQL"
  >
