---
title: Atributos del evento de alerta
tags:
  - Alerts
  - Alert violations
  - Alert events
...
Una condición que abre un evento de alerta genera un evento, el cual pasa información importante aguas abajo.

Para obtener más información sobre la definición de eventos de alerta y otros términos, consulta [nuestro glosario](/docs/new-relic-solutions/get-started/glossary/).

## ¿Qué es un evento de alerta? [#definition]

Un [evento de alerta](/docs/new-relic-solutions/get-started/glossary#alert-event) es un evento en el que se infringe un umbral de condición definido en una política de alertas. Este evento tiene varios atributos (metadatos) asociados, y diferentes atributos pueden ser utilizados por diferentes funcionalidades.

<Callout variant="important">
  El evento de alerta es un concepto utilizado para determinar las funciones de alerta. Si bien puedes consultar algunos de sus atributos asociados a través de NerdGraph, no puedes consultar directamente el evento de alerta.
</Callout>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        Solo NRQL o condiciones de infraestructura. No disponible para su uso con [título](docs/alerts/create-alert/condition-details/title-template) o [plantillas de descripción](/docs/alerts/create-alert/condition-details/custom-alert-event-descriptions) de condiciones de alerta.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        El identificador único del incidente. No disponible para su uso con [título](docs/alerts/create-alert/condition-details/title-template) o [plantillas de descripción](/docs/alerts/create-alert/condition-details/custom-alert-event-descriptions) de condiciones de alerta.
      </td>
    </tr>
