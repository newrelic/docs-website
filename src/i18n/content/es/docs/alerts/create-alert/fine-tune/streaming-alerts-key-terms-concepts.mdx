...
<Callout variant="tip">
  ...
  Para obtener más información sobre la pérdida de señal y el relleno de vacíos, consulte [esta publicación del foro de soporte](https://knowledge.newrelic.com/s/article/How-Can-I-Figure-Out-When-To-Use-Gap-Filling-and-Loss-of-Signal).
</Callout>