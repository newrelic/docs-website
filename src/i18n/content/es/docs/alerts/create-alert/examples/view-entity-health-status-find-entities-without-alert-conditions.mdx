...
* Si es <DNT>**yes**</DNT>, su indicador de estado de salud en el índice seleccionado (APM, browser, etc.) estará codificado por colores según el estado actual. Para ver un resumen del incidente de alerta actual, pase el mouse sobre su indicador de estado de salud.
