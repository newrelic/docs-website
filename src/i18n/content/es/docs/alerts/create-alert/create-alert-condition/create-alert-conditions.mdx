...
1. Vaya a
   ...
   <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert conditions > (select a condition)**</DNT>
...
1. Vaya a
   ...
   <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert conditions (policies)**</DNT>
...
Para ver [información sobre políticas y condiciones para una entidad específica](/docs/alerts/new-relic-alerts-beta/configuring-alert-policies/view-policy-conditions-new-relic-products): desde UI del producto de esa entidad, seleccione <DNT>**Settings**</DNT> y luego haga clic en <DNT>**Alert conditions**</DNT>.