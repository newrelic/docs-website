...
Vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert Conditions & Policies**</DoNotTranslate> para crear una condición de alerta NRQL a partir de una política. Luego, haga clic en <DoNotTranslate>**+ New alert condition**</DoNotTranslate>.
...
<figcaption>
  Vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert Conditions & Policies > + New alert condition**</DoNotTranslate>.
</figcaption>
...
<figcaption>
  Vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert conditions (Policies)**</DoNotTranslate> y luego <DoNotTranslate>**+ New alert condition**</DoNotTranslate>. La pérdida de señal solo está disponible para condiciones NRQL.
</figcaption>
