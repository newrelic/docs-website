...
<Steps>
  ...
  <Step>
    ...
    <CollapserGroup>
      ...
      <Collapser id="predict-alert" title="Alertas predictivas con umbral estático (disponible en vista previa pública)">
        ...
        El <DNT>**Predictive Alerts**</DNT> en New Relic emplea datos históricos para construir modelos que predicen infracciones del umbral estático. Puedes establecer hasta qué punto en el futuro deseas predecir. Si se anticipa una infracción, se activa un evento de alerta predictiva que le permite actuar antes de que se produzcan interrupciones.

        Para habilitar el <DNT>**Predictive Alerts**</DNT>:
        ...
        3. Establezca el tiempo de anticipación para predecir qué tan lejos en el futuro podría superar el umbral. El tiempo máximo de anticipación es 360 veces la [duración de la ventana](/docs/alerts/create-alert/create-alert-condition/alert-conditions/#window-duration).
        ...
        Para obtener más información sobre <DNT>**Predictive Alerts**</DNT>, consulte nuestra [documentación](/docs/alerts/create-alert/set-thresholds/predictive-alerts).
      </Collapser>
