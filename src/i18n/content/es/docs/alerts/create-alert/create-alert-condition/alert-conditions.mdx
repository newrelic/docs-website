...
<Steps>
  <Step>
    ...
    * Seleccione <DNT>**Alert Conditions**</DNT> en la navegación izquierda.
    * Luego seleccione <DNT>**New alert condition**</DNT>.
    * Seleccione <DNT>**Write your own query**</DNT>.
  ...
  <Step>
    ...
    Para este ejemplo, el gráfico mostrará la latencia promedio de su aplicación `WebPortal` . Haga clic en <DNT>**Next**</DNT> y comience a configurar su condición de alerta.
...
<DocTiles>
  <DocTile title="Create your first New Relic alert" path="/docs/tutorial-create-alerts/create-new-relic-alerts/" label={{text: "Start here", color: "orange"}}>Un curso intensivo sobre alertas para principiantes </DocTile><DocTile title="Advanced alert conditions" path="/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-alert-conditions/">Si ya configuró su condición de alerta, profundice con las configuraciones avanzadas</DocTile> <DocTile title="Get notified" path="/docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows/">Use Flujo de trabajo para recibir notificaciones sobre cualquier comportamiento inusual en su stack</DocTile>
</DocTiles>