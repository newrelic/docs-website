    ...
    <CollapserGroup>
      ...
      <Collapser id="predict-alert" title="Alertas predictivas con umbral estático (disponible en vista previa pública)">
        <Callout title="avance">
          ...
          Cuando el periodo de vista previa pública de alertas predictivas finaliza en cualquier momento por cualquier motivo, su ventana de evaluación de condición de alerta solo se evaluará en relación con el umbral estático, lo que puede generar una ligera demora en la detección de una alerta de infracción.
        </Callout>
