...
<Steps>
  ...
  <Step>
    ...
    <CollapserGroup>
      ...
      >
        A diferencia de los umbrales de anomalía, un umbral estático no analiza su conjunto de datos como un todo y determina qué comportamiento es inusual en función del historial de su sistema. En cambio, un umbral estático abrirá un incidente cada vez que su sistema se comporte de manera diferente a los criterios que <DNT>**you set**</DNT>.
