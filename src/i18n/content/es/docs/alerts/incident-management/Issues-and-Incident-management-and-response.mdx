...
* <DNT>
  ...
  : Puede explorar millones de mensajes de log con un solo clic y utilizar consultas manuales para encontrar patrones anómalos y problemas difíciles de encontrar.
