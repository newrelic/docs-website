...
* El `id` de la condición (disponible en [API Explorer:](https://api.newrelic.com/docs/#/Alerts%20Conditions) <DNT>**Alerts Conditions &gt; GET &gt; List**</DNT>)
* De forma predeterminada, este extremo utiliza el centro de datos de EE. UU. Si su organización aloja datos en el centro de datos de la UE, asegúrese de usar los [extremos de API adecuados para las cuentas de la región de la UE](/docs/using-new-relic/welcome-new-relic/getting-started/introduction-eu-region-data-center#endpoints).
...
2. Con el ID de la política, realice una llamada API que devuelva las condiciones asociadas con esa política. Hay cuatro categorías de condiciones diferentes. Si no conoce la categoría, es posible que sea necesario realizar hasta cuatro API de llamadas para encontrar la condición.
   ...
   <CollapserGroup>
     <Collapser id="types-conditions-API" title="Detalles sobre la búsqueda de ID de condición">
       ...
       * [Monitoreo sintético](/docs/alerts/new-relic-alerts/rest-api-alerts/rest-api-calls-new-relic-alerts#synthetics-conditions-list)\
   ...
   <CollapserGroup>
     <Collapser id="update-api-requests" title="Detalles sobre las solicitudes de actualización de API">
       ...
       * [Condiciones para servicios externos](/docs/alerts/new-relic-alerts/rest-api-alerts/rest-api-calls-new-relic-alerts#ext-conditions-update)\
         Condiciones disponibles: `apm_external_service`, `mobile_external_service`\
         [API Explorer PUT&gt;Update link](https://api.newrelic.com/docs/#/Alerts%20External%20Service%20Conditions/put_alerts_external_service_conditions__condition_id__json)
