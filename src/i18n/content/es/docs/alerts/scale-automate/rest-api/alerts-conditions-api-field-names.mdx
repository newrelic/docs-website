...
<CollapserGroup>
  ...
  >
    ...
    El <DNT>**user_defined\[value_function]**</DNT> asociado con la métrica se compara con el valor <DNT>**terms\[threshold]**</DNT> al evaluar si se debe desencadenar un incidente. La comparación se realiza utilizando el operador definido por <DNT>**terms\[operator]**</DNT>.
  ...
  >
    Este es el valor numérico obtenido de la métrica personalizada especificada por <DNT>**user_defined\[metric]**</DNT>.
