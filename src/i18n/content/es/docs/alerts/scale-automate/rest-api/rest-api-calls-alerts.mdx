...
<Callout variant="important">
  De forma predeterminada, este extremo utiliza el centro de datos de EE. UU. Si su organización aloja datos en el centro de datos de la UE, asegúrese de utilizar los [extremos de API adecuados para las cuentas de la región de la UE](/docs/using-new-relic/welcome-new-relic/getting-started/introduction-eu-region-data-center#endpoints). Para las cuentas del [centro de datos de JP](/docs/accounts/accounts-billing/account-setup/choose-your-data-center), asegúrese de utilizar los extremos de API adecuados de la región de JP.
</Callout>
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            Determina cómo las alertas [crearán eventos de alerta](/docs/alerts/organize-alerts/specify-when-alerts-create-events/). Debe ser uno de los siguientes:

            * `PER_POLICY` (predeterminado): Agrupar por [política](/docs/alerts/organize-alerts/specify-when-alerts-create-events/#preference-policy).
            * `PER_CONDITION`: Agrupar por [condición](/docs/alerts/organize-alerts/specify-when-alerts-create-events/#preference-condition).
            * `PER_CONDITION_AND_TARGET`: Agrupar por [objetivo y condición](/docs/alerts/organize-alerts/specify-when-alerts-create-events/#preference-target).
          </td>
        </tr>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            * `PER_POLICY` (predeterminado): Agrupar por [política](/docs/alerts/organize-alerts/specify-when-alerts-create-events/#preference-policy).
            * `PER_CONDITION`: Agrupar por [condición](/docs/alerts/organize-alerts/specify-when-alerts-create-events/#preference-condition).
            * `PER_CONDITION_AND_TARGET`: Agrupar por [condición y señal](/docs/alerts/organize-alerts/specify-when-alerts-create-events/#preference-signal).
          </td>
        </tr>
...
Estas funciones de la API incluyen enlaces al API Explorer, donde puede crear, actualizar, eliminar o listar [condiciones](/docs/alerts/create-alert/create-alert-condition/alert-conditions) de políticas. Estas llamadas son para condiciones con estos tipos de entidades:
...
<Callout variant="important">
  El Explorador de API proporciona información sobre otros tipos de condiciones mediante <DNT>**separate endpoints**</DNT>, incluidos los [servicios externos](#ext-services-conditions) (APM y móvil) y el [monitoreo sintético](#synthetics-conditions). Considere todos los tipos de condiciones de alerta al buscar o actualizar. De forma predeterminada, este extremo usa el centro de datos de EE. UU. Si su cuenta aloja datos en el centro de datos de la UE, asegúrese de usar los [extremos de API para cuentas de la región de la UE](/docs/using-new-relic/welcome-new-relic/getting-started/introduction-eu-region-data-center#endpoints) adecuados.
</Callout>
...
Estas funciones de la API incluyen enlaces al API Explorer, donde puede crear, actualizar, eliminar o enumerar [condiciones](/docs/alerts/create-alert/create-alert-condition/alert-conditions) NRQL para sus políticas.

<DNT>**Exception:**</DNT> Las condiciones de anomalía NRQL son <DNT>**not available**</DNT> de este extremo.

<Callout variant="important">
  De forma predeterminada, este extremo utiliza el centro de datos de EE. UU. Si su organización aloja datos en el centro de datos de la UE, asegúrese de estar utilizando los [extremos de API adecuados para las cuentas de la región de la UE](/docs/using-new-relic/welcome-new-relic/getting-started/introduction-eu-region-data-center#endpoints). Para las cuentas del [centro de datos de JP](/docs/accounts/accounts-billing/account-setup/choose-your-data-center), asegúrese de utilizar los extremos de API adecuados de la región de JP.
</Callout>
...
Estas funciones de la API incluyen enlaces al API Explorer, donde puede crear, actualizar, eliminar o listar [condiciones](/docs/alerts/create-alert/create-alert-condition/alert-conditions) de políticas. Estas llamadas son para condiciones de servicios externos. Las llamadas de API se pueden usar con <InlinePopover type="apm" />y aplicaciones de monitoreo móvil.
...
Estas funciones de la API incluyen enlaces al API Explorer, donde puede crear, actualizar, eliminar o listar [condiciones](/docs/alerts/create-alert/create-alert-condition/alert-conditions) para sus políticas de alertas. Las llamadas de API se pueden usar con el monitoreo sintético.
...
Estas funciones de la API incluyen enlaces al API Explorer, donde puede crear, actualizar, eliminar o listar [condiciones](/docs/alerts/create-alert/create-alert-condition/alert-conditions) para sus políticas de alertas. Las llamadas de API se pueden utilizar para condiciones de múltiples ubicaciones con monitoreo sintético. Antes de crear o actualizar una condición, lea las [reglas para condiciones de alerta de múltiples ubicaciones](/docs/alerts-applied-intelligence/new-relic-alerts/advanced-alerts/advanced-techniques/multi-location-synthetic-monitoring-alert-conditions/#rules).
...
<CollapserGroup>
  <Collapser id="list-condition-by-entity" title="Condición de lista por entidad">
    Para ver las [condiciones](/docs/alerts/overview#alert-condition) de una [entidad](/docs/alerts/overview#alert-entity) que se aplican a una entidad en APM, browser, mobile o transacciones clave, incluya estos valores en la llamada a la API:

    * Su [clave de usuario.](/docs/apis/get-started/intro-apis/types-new-relic-api-keys#user-api-key)

    * El `entity_id` Esta es la [entidad (objetivo de la alerta)](/docs/alerts/overview#alert-entity) específica a monitorear.
  ...
  <Collapser id="add-entity" title="Agregar una entidad a una condición">
    Para agregar una [entidad](/docs/alerts/overview#alert-entity) a una condición, incluya estos valores en la llamada de API:

    * Tu [clave de usuario](/docs/apis/get-started/intro-apis/types-new-relic-api-keys#user-api-key)

    * El `entity_id` Esta es la [entidad (objetivo de la alerta)](/docs/alerts/overview#alert-entity) a monitorear. Es el ID numérico de la aplicación APM, la aplicación de navegador, la transacción clave o la aplicación móvil.
  ...
  <Collapser id="remove_entity" title="Eliminar una entidad de una condición">
    Para eliminar una [entidad](/docs/alerts/overview#alert-entity) monitoreada de una condición, incluya estos valores en la llamada a la API:

    * Tu [clave de usuario](/docs/apis/get-started/intro-apis/types-new-relic-api-keys#user-api-key)

    * El `entity_id` Esta es la [entidad (objetivo de la alerta)](/docs/alerts/overview#alert-entity) monitoreada específica que se eliminará. Es el ID numérico de la aplicación APM, la aplicación de navegador, la transacción clave o la aplicación móvil.
