...
<Callout variant="important">
  Si tu organización aloja datos en el centro de datos de la UE, asegúrate de usar los [extremos de API adecuados para las cuentas de la región de la UE](/docs/using-new-relic/welcome-new-relic/getting-started/introduction-eu-region-data-center#endpoints). Para las cuentas del [centro de datos de JP](/docs/accounts/accounts-billing/account-setup/choose-your-data-center), asegúrate de usar los extremos de API adecuados de la región de JP.
</Callout>
