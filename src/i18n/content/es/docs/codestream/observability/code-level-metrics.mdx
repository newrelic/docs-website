...
Puede desactivar CodeLenses yendo a la sección CodeStream de la configuración de su IDE y desmarcando la configuración <DoNotTranslate>**CodeStream: Show Golden Signals In Editor**</DoNotTranslate> .