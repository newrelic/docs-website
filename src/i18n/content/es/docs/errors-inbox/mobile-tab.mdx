---
title: Pestaña de fallos de grupo
tags:
  - APM
  - APM UI pages
  - Error analytics
...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile > Crashes (errors inbox)**</DoNotTranslate>: Con nuestra pestaña de **Group crashes** \[fallas grupales], puede analizar la tasa de fallas y el usuario sin fallas de un vistazo o profundizar en la ubicación de fallas específica.
</figcaption>
...
<CollapserGroup>
  ...
  >
    ...
    * Filtre por un <DoNotTranslate>**Version**</DoNotTranslate> específico o por uno o más atributos <DoNotTranslate>**Filter**</DoNotTranslate>, como `Last Interaction`, `App Build` o cualquiera de la lista más larga de atributos estándar y personalizados.)
  ...
  >
    Desde la tabla <DoNotTranslate>**Crash types**</DoNotTranslate> , puede profundizar en un [tipo de falla](/docs/mobile-monitoring/mobile-monitoring-ui/crashes/investigate-mobile-app-crash-report) específico. Desde aquí podrás:
...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile > Crashes (errors inbox)**</DoNotTranslate>: seleccione una ubicación de fallas para abrir la página de **Crash details** .
</figcaption>
...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile > Crashes (errors inbox) > Select a crash location **</DoNotTranslate>: Desde la página de **Crash details**, puede clasificar ocurrencias de errores específicas agregando actualizaciones de estado o asignaciones.
</figcaption>
...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile > Crashes (errors inbox) > Select a crash location **</DoNotTranslate>: Profundice en el evento que condujo a un accidente específico empleando nuestra traza de evento.
</figcaption>
...
## ¿Por qué están deshabilitados los perfiles? [#profiles-disabled]

Los perfiles se deshabilitan cuando no hay diferencias estadísticamente significativas entre los valores de atributos de las sesiones fallidas y libres de fallas o no hay perfiles disponibles que coincidan con los filtros aplicados.