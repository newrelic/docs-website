...
Esta configuración ofuscará las URL que coincidan con una URL de ejemplo de `/api/v1/users/12345456/edit` y reemplazará todos los dígitos en el medio de la URL con `**</DoNotTranslate>` (dos asteriscos). La URL resultante será `/api/v1/users/**/edit`.
