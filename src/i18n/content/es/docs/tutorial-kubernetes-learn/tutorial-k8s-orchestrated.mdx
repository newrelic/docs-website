---
title: Comprender y monitor la capa orquestada de Kubernetes
...
<Steps>
  <Step>
    ## Navegue al dashboarddescripción general

    Vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Kubernetes > Overview Dashboard**</DoNotTranslate>.  

  </Step>

  <Step>
    ## Clasifica tu despliegue
  ...
  <Step>
    ...
    Desplácese un poco hacia abajo y busque la tabla <DoNotTranslate>**Pending and Failed Pods**</DoNotTranslate> . Esta tabla le mostrará todos los pods que han fallado o están atascados pendientes por cualquier motivo. Es normal que el pod falle hasta cierto punto dependiendo del estado de la línea de base de su sistema.
...
<UserJourneyControls
  nextStep={{"path":"/docs/tutorial-kubernetes-learn/tutorial-k8s-services","title":"Próximo paso","body":"Monitor los servicios y aplicaciones de Kubernetes."}}
  previousStep={{"path":"/docs/tutorial-kubernetes-learn/tutorial-k8s-layers","title":"Paso anterior","body":"Monitor clúster de Kubernetes."}}
/>