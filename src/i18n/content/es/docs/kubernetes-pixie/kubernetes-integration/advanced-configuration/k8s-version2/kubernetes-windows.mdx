...
<Callout variant="important">
  **El monitoreo de nodos de Windows ahora está disponible a nivel general (GA) en la integración de New Relic Kubernetes v3.** El enfoque de instalación v2 descrito en esta página está obsoleto y se eliminará en una versión futura. Utilice la [guía de instalación de la integración de Kubernetes](/install/kubernetes) para obtener las instrucciones de instalación actuales, que admiten nodos de Windows de forma nativa.
</Callout>

Utilice esta opción cuando tenga un sistema Kubernetes basado en Windows. Tenga en cuenta que la integración de Windows tiene varias [limitaciones](#k8-windows-limitations).
