...
Para obtener información sobre el cumplimiento de FedRAMP en New Relic, visite nuestra [página de documentación FedRAMP Moderate](/docs/security/security-privacy/compliance/certificates-standards-regulations/fedramp-moderate/).
