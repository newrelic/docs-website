...
Si primero desea completar el [tutorial de Kubernetes](https://kubernetes.io/docs/tutorials/stateless-application/guestbook/), siga las instrucciones del tutorial, pero **no** siga las instrucciones de la sección <DoNotTranslate>**Cleaning up**</DoNotTranslate> .
...
Si no hay errores, debería ver los datos Redis en la UI de infraestructura. Para encontrar el panel Redis , vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Third party services**</DoNotTranslate> y seleccione el dashboard <DoNotTranslate>**Redis**</DoNotTranslate>.
