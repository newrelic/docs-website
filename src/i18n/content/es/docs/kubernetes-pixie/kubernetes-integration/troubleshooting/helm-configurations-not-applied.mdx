...
Ha completado el [procedimiento de instalación](/docs/kubernetes-monitoring-integration#install) para la integración de Kubernetes de New Relic con Helm para `nri-bundle`, pero nuestras plantillas de Helm no respetan algunos [valores globales](https://github.com/newrelic/helm-charts/tree/master/charts/nri-bundle#values) en su `values.yaml`.
