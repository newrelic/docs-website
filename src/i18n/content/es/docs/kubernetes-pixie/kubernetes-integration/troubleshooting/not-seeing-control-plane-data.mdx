...
<CollapserGroup>
  <Collapser id="control-plane-sample-missing" title="Falta una muestra del plano de control">
    ...
    * También es posible que el componente del plano de control de la integración no se esté ejecutando en todos los nodos maestros. Puedes comprobarlo ejecutando este comando:
