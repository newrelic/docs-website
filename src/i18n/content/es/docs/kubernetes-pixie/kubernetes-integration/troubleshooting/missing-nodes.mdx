...
1. Confirme que el agente de infraestructura se pueda programar en cada nodo ejecutando:
   ...
   <Callout variant="caution">
     Tenga en cuenta que en la versión V2 de la integración de Kubernetes este comando cambia. Ver [resolución de problemas K8s v2: Nodos faltantes](/docs/kubernetes-pixie/kubernetes-integration/advanced-configuration/k8s-version2/troubleshooting/missing-nodes).
   </Callout>
...
3. [Recuperar el log del agente de infraestructura](/docs/kubernetes-pixie/kubernetes-integration/advanced-configuration/get-logs-version/) sobre los nodos que no aparecen en el cluster explorer y confirmar que no hay ningún [mensaje de error](/docs/kubernetes-pixie/kubernetes-integration/troubleshooting/common-error-messages/error-messages).
