---
title: Integración de eAPM New Relic
tags:
  - Integrations
  - eBPF integration
  - eAPM
...
## Diferencias clave entre eAPM y APM [#key-differences]
...
## Instalación del agente eAPM [#installation]
...
6. Para instalar el gráfico Helm del agente eAPM, reemplace `your-custom-values.yaml` con la ruta a su archivo `values.yaml` y ejecute:
...
<Callout variant="tip" title="consejo">
  El gráfico Helm eAPM ofrece múltiples opciones de configuración. Revise el archivo [`value.yaml`](https://github.com/newrelic/helm-charts/blob/master/charts/nr-ebpf-agent/values.yaml) para adaptar la instalación a sus necesidades.
</Callout>

## Acceda a la impulsada por eAPM APM UI [#eapm-access]
...
## Cómo funcionan juntos el agente eAPM y APM [#eapm-apm]
