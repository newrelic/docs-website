  ...
  <TabsPages>
    ...
    <TabsPageItem id="man-helm">
      ...
      * Garantiza que sus valores de configuración sean consistentes en todos los gráficos instalados.
      ...
      El gráfico `nri-bundle` es el que instala y configura nuestra [instalación guiada de Kubernetes](/install/kubernetes#guided-install).
    ...
    <TabsPageItem id="gke-autopilot">
      ...
      * Un manifiesto simple con valores requeridos precargados
      ...
      <CollapserGroup>
        ...
        >
          Puedes instalar en el piloto automático de GKE usando el mismo flujo de instalación que nuestra pestaña [de instalación guiada](/install/kubernetes/?dropdown1=guided) .
        </Collapser>
