...
Dependiendo de lo que necesites, puedes optar por instalar el agente operador de forma independiente o junto con nuestra integración K8s. Le recomendamos encarecidamente que lo instale junto con la integración K8s para aprovechar nuestra experiencia de observación stack completa.

Recomendamos encarecidamente instalarlo junto con la integración Kubernetes para aprovechar toda nuestra experiencia [de observabilidad stack completa](/docs/apm/apm-ui-pages/monitoring/kubernetes-summary-page/) .
