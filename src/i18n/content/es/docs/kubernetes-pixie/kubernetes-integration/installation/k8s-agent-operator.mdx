...
Ejecute el siguiente comando para instalar el CR de instrumentación:
...
<CollapserGroup>
  ...
  <Collapser id="namespace-label-selector" title="Selector de etiquetas de espacio de nombres">
    Define el pod autoinstrumentado en el nivel namespace. Permitido cuando el CR y el operador están en el mismo namespace. De lo contrario, este selector debe dejarse vacío.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [.NET en Windows 2022](https://hub.docker.com/repository/docker/newrelic/newrelic-dotnet-windows2022-init/general)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        [.NET en Windows 2025](https://hub.docker.com/repository/docker/newrelic/newrelic-dotnet-windows2025-init/general)
      </td>
    </tr>
...
<Callout variant="tip">
  Si su clúster utiliza un entorno de ejecución de contenedores que requiere un prefijo de registro explícito (como CRI-O), anteponga `docker.io/` a la ruta de la imagen. Por ejemplo: `image: docker.io/newrelic/newrelic-java-init:latest`.
</Callout>
...
* Obtenga información sobre sus aplicaciones y resuelva eventos de alertas mediante la página [Resumen de APM](/docs/apm/agents/manage-apm-agents/agent-data/triage-run-diagnostics/).
