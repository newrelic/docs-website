...
<CollapserGroup>
  ...
  >
    ...
    1. Vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Settings > Alerts > Kubernetes**</DoNotTranslate> y luego seleccione <DoNotTranslate>**Create alert condition**</DoNotTranslate>.
