...
La integración Kubernetes evento se instala por defecto tanto al utilizar nuestra [instalación guiada](/install/kubernetes), como al [instalar a través de Helm](/docs/kubernetes-pixie/kubernetes-integration/installation/install-kubernetes-integration-using-helm).
