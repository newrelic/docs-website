...
Los eventos recopilados por New Relic tendrán exactamente los mismos atributos que los proporcionados por Kubernetes. Para obtener una referencia de estos atributos, consulte la [documentación principal de eventos v1 de Kubernetes](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.34/#event-v1-core).
