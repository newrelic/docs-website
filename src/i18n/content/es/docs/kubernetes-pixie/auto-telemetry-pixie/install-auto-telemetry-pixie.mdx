...
2. Haga clic en <DoNotTranslate>**Continue**</DoNotTranslate>.

3. Seleccione los datos que desea recopilar, observar y depurar y haga clic en <DoNotTranslate>**Continue**</DoNotTranslate>.

4. En la página <DoNotTranslate>**Choose install method**</DoNotTranslate> , seleccione <DoNotTranslate>**Helm**</DoNotTranslate> o <DoNotTranslate>**manifest**</DoNotTranslate>.
...
5. Haga clic en <DoNotTranslate>**Continue**</DoNotTranslate> para abrir la página <DoNotTranslate>**Listening for data**</DoNotTranslate> .

6. Cuando reciba el mensaje <DoNotTranslate>**See your data**</DoNotTranslate>, haga clic en <DoNotTranslate>**Kubernetes Cluster Explorer**</DoNotTranslate> para ver su clúster.
...
La integración de Pixie se instala como parte de la integración de Kubernetes de New Relic. Para actualizar la integración de Kubernetes, consulte nuestra [documentación de instalación de Kubernetes](/docs/kubernetes-pixie/kubernetes-integration/installation/kubernetes-integration-install-configure#update).
