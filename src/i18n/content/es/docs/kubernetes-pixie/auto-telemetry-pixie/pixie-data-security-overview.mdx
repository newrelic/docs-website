...
Los datos que ves en la pestaña <DoNotTranslate>**Live debugging**</DoNotTranslate> provienen de Community Cloud for Pixie y, por lo tanto, son potencialmente confidenciales. New Relic no lo almacena, es efímero y se puede consultar durante menos de 24 horas.
