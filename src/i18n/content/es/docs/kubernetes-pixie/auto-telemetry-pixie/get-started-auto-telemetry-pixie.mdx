...
<figcaption>
  Visualiza la dependencia de tu aplicación utilizando el <DoNotTranslate>**Service map**</DoNotTranslate> creado a partir de la traza HTTP de Pixie.
</figcaption>
...
<figcaption>
  Ejecute el script en la pestaña <DoNotTranslate>**Live debugging with Pixie**</DoNotTranslate> para depurar su aplicación Kubernetes .
</figcaption>
