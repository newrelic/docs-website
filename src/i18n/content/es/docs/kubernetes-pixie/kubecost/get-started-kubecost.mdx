...
6. Espera unos minutos. En la pestaña anterior donde configuró la escritura remota, haga clic en el botón <DoNotTranslate>**See your data**</DoNotTranslate> para ver si se han recibido datos.
