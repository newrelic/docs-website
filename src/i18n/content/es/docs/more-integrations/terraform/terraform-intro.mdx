...
<Steps>
  ...
  <Step>
    ...
    3. Tu [regiónNew Relic ](/docs/using-new-relic/welcome-new-relic/get-started/our-eu-us-region-data-centers#verifying-account). Su región es `US` si su URL de New Relic es `one.newrelic.com` y `EU` si su URL está en `one.eu.newrelic.com`.
