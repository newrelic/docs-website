---
title: Stack completa de WordPress
tags:
...
<Steps>
  ...
  <Step>
    ### Configurar WordPress para exponer el registro de depuración
  ...
  <Step>
    ### Reenviar el registro de depuración de WordPress a New Relic

    Puede utilizar nuestro [reenvío de registros](/docs/logs/forward-logs/forward-your-logs-using-infrastructure-agent/) para reenviar el registro de WordPress a New Relic.
