...
* Asegúrese de que
  ...
  contenga su clave de licencia de 40 caracteres hexadecimales y que sea una licencia válida para el ID de cuenta de New Relic seleccionado.
...
* El registro detallado se puede habilitar usando la variable de entorno `NR_STATSD_VERBOSE`, modifique el comando de ejecución docker agregando la siguiente variable: `-e NR_STATSD_VERBOSE=true`.
