...
<Steps>
  ...
  <Step>
    ...
    * [Óxido](https://github.com/open-telemetry/opentelemetry-rust)
  ...
  <Step>
    ...
    * [Óxido](https://crates.io/crates/opentelemetry-otlp)
...
New Relic actualmente admite [la especificaciónOpenTelemetry](https://github.com/open-telemetry/opentelemetry-specification/tags) `v1.8.0` con algunas excepciones:
