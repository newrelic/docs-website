...
* <DoNotTranslate>**Collector:**</DoNotTranslate>
  ...
  Si está ejecutando su propia instancia del recolector OpenTelemetry, puede configurarlo para realizar formas de muestreo más sofisticadas, como muestreo al final ([ver más abajo](#infinite-tracing)).
...
<CollapserGroup>
  ...
  <Collapser
    className="freq-link"
    id="ot-tail-based"
    title="OpenTelemetry al muestreadores finales"
  >
    El recolector OpenTelemetry dispone de un [procesador de muestreo al final](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/main/processor/tailsamplingprocessor).
  </Collapser>

  <Collapser
    className="freq-link"
    id="infinite-tracing"
    title="New Relic muestreo al final con Infinite Tracing"
  >
