    ...
    <TabsPageItem id="manual-setup-tutorial">
      ...
      <Steps>
        ...
        <Step>
          ...
          * Constantes estáticas para contener claves de atributos que se pueden usar para proporcionar información valiosa a nivel de solicitud en sus intervalos.
