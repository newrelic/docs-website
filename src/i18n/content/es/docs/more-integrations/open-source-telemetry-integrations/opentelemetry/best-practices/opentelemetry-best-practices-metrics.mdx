...
* Las sumas acumulativas monótonas se asignan a nuestro tipo de métrica [cumulativeCount](/docs/telemetry-data-platform/understand-data/metric-data/metric-data-type/#metric-types) . Esto es cierto con la excepción de las cuentas que enviaban sumas monótonas acumuladas antes de gaDateAndYear, que continúan asignadas al tipo de métrica `gauge` : consulte [nuestra guía de transición](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/cumulative-metrics-transition-guide).
...
Los clientes de New Relic que informaron sumas acumuladas antes de gaDateAndYear, convierten sus sumas acumuladas a nuestro tipo `gauge` . Para obtener detalles sobre cómo está cambiando esto, consulte nuestra [guía de transición métrica acumulativa](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/cumulative-metrics-transition-guide).
