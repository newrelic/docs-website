...
Esta guía explica cómo recopilar métricas de su Cónsul administrado por HCP desplegadamente utilizando el recolector OpenTelemetry. El recolector recopila, procesa y envía telemetry data (incluidos métricas, logs y trazas) a varios servidores de observabilidad, incluido New Relic.
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            [Revisar la configuración extrema de OTLP](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-otlp)
          </td>
        </tr>
