...
* Revise su versión de OTLP: New Relic usa [la versión OTLP v0.18.0](https://github.com/open-telemetry/opentelemetry-proto/releases/tag/v0.18.0). Se admiten versiones posteriores, pero aún no se implementaron nuevas características. Las características experimentales que ya no están disponibles en 0.18.0 no son compatibles.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        rastreo infinito<br/>(Ver [mejores prácticas](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-best-practices-traces#infinite-tracing) para detalles extremos)
      </td>
...
## Configuración: procesamiento por lotes de carga útil, compresión y límites de velocidad [#payload-limits]
