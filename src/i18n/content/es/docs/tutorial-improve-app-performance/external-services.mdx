...
<Steps>
  ...
  <Step>
    ...
    3. Vea un desglose de la transacción entre los dos servicios.<img
    ...
    4. Si decide que una transacción en particular está tomando más tiempo, haga clic en esa transacción para centrarse específicamente en su dependencia.<img
    ...
    6. Si llega a un punto en el desglose donde desea ver el rastreo distribuido, haga clic en <DNT>**List**</DNT> en la esquina superior derecha y luego haga clic en <DNT>**Traces**</DNT> en la tabla.<img
