...
<Steps>
  <Step>
    Navegue a la UI de usuario de servicios externos: vaya a <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/nr1-core?filters=(domain%3D'APM'ANDtype%3D'APPLICATION')) > (select an app) > Monitor > External services**</DoNotTranslate>. Alterna <DoNotTranslate>**Show new view**</DoNotTranslate> en la parte superior izquierda si aún no está habilitado y luego haz clic en <DoNotTranslate>**Map**</DoNotTranslate> en la parte superior derecha.
    ...
    Pase el cursor sobre todas sus dependencias upstream e intente identificar aquellas que tengan un tiempo de respuesta o un recuento de trazas elevado. Preste especial atención a cualquiera que tenga picos significativos en su historia reciente. Si encuentra un servicio sospechoso, profundice pasando el cursor sobre él y seleccionando el botón <DoNotTranslate>**View traces**</DoNotTranslate> . Este nuevo panel muestra información sobre esa traza de la transacción, que registra las llamadas a funciones disponibles, llamadas a base de datos y llamadas externas de esa transacción.
  </Step>
  ...
  <Step>
    ...
    6. Si llega a un punto en el desglose donde desea ver el rastreo distribuido, haga clic en <DoNotTranslate>**List**</DoNotTranslate> en la esquina superior derecha y luego haga clic en <DoNotTranslate>**Traces**</DoNotTranslate> en la tabla.<img title="Screenshot showing the trace link in the table view" alt="Screenshot showing the trace link in the table view" src={apmExternalServicesLinkTable}/>
  ...
  <Step>
    ...
    Primero navegue a la vista de lista seleccionando <DoNotTranslate>**List**</DoNotTranslate> en la parte superior derecha. Esta página muestra varias tablas y gráficos que puede utilizar para identificar servicios externos lentos. Utilizará esta página para clasificar sus servicios:
    ...
    Profundice en los servicios identificados anteriormente seleccionando <DoNotTranslate>**View traces**</DoNotTranslate> junto al nombre de ese servicio en la tabla inferior. Utilice esta información para reemplazar esos servicios, optimizar la API de llamadas o distribuir cargas entre sus servicios.
  </Step>
</Steps>
