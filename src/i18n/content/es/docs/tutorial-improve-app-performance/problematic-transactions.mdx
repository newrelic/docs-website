---
title: Diagnosticar transacción lenta
...
## El qué y el porqué de la transacción [#why]
...
## Observar la transacción para mejorar el rendimiento. [#observe]
...
<Steps>
  <Step>
    Navegue a la UI de transacciones: Vaya a <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/nr1-core?filters=(domain%3D'APM'ANDtype%3D'APPLICATION')) > (select an app) > Monitor > Transactions**</DoNotTranslate>
  </Step>

  <Step>
    ### Encuentra tu transacción lenta: [#slow-transactions]
    ...
    <SideBySide>
      <Side>
        ...
        2. Eche un vistazo al gráfico
           ...
           <DoNotTranslate>**Top 20 transactions**</DoNotTranslate>
  ...
  <Step>
    ### Mejora tu rendimiento [#improve-performance]
...
* ¿Sigues viendo un tiempo de respuesta lento? Quizás haya un [problema con la base de datos](/docs/journey-app-slow/slow-database-queries) o quizás sus [servicios externos](<>) se estén ejecutando lentamente:
