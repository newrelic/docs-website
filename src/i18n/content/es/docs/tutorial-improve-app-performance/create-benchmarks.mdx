...
<Steps>
  ...
  <Step>
    ...
    Seleccione <DoNotTranslate>**Continue**</DoNotTranslate> en el panel izquierdo una vez que haya confirmado que su consulta es correcta para completar la creación de su nivel de servicio.
  </Step>
</Steps>
