...
Defina la lista de aplicaciones y servicios para los cuales está intentando optimizar errores. El equipo encargado del proceso de optimización de errores debe tener plena responsabilidad y control sobre estas aplicaciones y servicios. Una vez que haya decidido, configure una [carga de trabajo](/docs/new-relic-solutions/new-relic-one/workloads/workloads-isolate-resolve-alert-events-faster) para estas entidades.
...
Solo toma unos minutos configurar una carga de trabajo. Consulta [las instrucciones de la carga de trabajo](/docs/new-relic-solutions/new-relic-one/workloads/workloads-isolate-resolve-alert-events-faster).
