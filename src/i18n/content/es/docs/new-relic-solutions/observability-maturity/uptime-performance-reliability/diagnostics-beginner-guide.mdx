...
La clave para identificar patrones y anomalías en los datos de rendimiento es que no es necesario saber cómo debería funcionar el servicio: <DNT>**You only need to determine if the recent behavior has changed.**</DNT>
