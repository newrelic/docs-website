...
<Steps>
  ...
  <Step>
    Vaya a <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Apps**</DoNotTranslate>. Ya sea que esté creando una aplicación New Relic o una visualización personalizada, encontrará su proyecto en <DoNotTranslate>**Apps**</DoNotTranslate>.
  </Step>

  <Step>
    Si estás sirviendo un Nerdpack con un pícher y un Nerdlet, encontrarás tu aplicación local en <DoNotTranslate>**Your apps:**</DoNotTranslate>. Si está ofreciendo un Nerdpack con una visualización, vaya a <DoNotTranslate>**Favorite apps > Custom Visualizations**</DoNotTranslate>.
...
Lea la documentación [`nr1 nerdpack:serve`](/explore-docs/nr1-nerdpack#nr1-nerdpackserve) para obtener más información. O vea la página de ayuda `nr1` :
