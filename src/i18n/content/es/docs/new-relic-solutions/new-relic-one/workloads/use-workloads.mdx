---
title: UI de carga de trabajo estándar
tags:
  - New Relic
  - Use New Relic
  - Workloads
...
La interfaz de usuario de cargas de trabajo estándar le ofrece varias vistas para comprender sus cargas de trabajo de New Relic a un alto nivel y con detalle granular. Esta página describe la interfaz de usuario para [carga de trabajo estándar](/docs/new-relic-solutions/new-relic-one/workloads/create-workloads). Para [carga de trabajo inteligente](/docs/new-relic-solutions/new-relic-one/workloads/workloads-overview#intelligent-workloads), consulta la documentación de [crear una carga de trabajo inteligente](/docs/new-relic-solutions/new-relic-one/workloads/create-intelligent-workload).

Para ver tu carga de trabajo, ve a <DNT>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DNT> y haz clic en <DNT>**Workload**</DNT>.
