...
Para ver tu carga de trabajo, ve a <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DoNotTranslate> y haz clic en <DoNotTranslate>**Workloads**</DoNotTranslate>.

## Resumen [#health]

La página <DoNotTranslate>**Summary**</DoNotTranslate> proporciona datos de estado relevantes que le ayudan a operar la carga de trabajo. Muestra el estado global de la carga de trabajo, así como el estado individual de todas las entidades que componen la carga de trabajo en cada momento.
...
La página <DoNotTranslate>**Activity**</DoNotTranslate> muestra datos de rendimiento relacionados con la entidad en la carga de trabajo, junto con el evento que podría explicar cualquier cambio en esas series de tiempo.
...
La página <DoNotTranslate>**General settings**</DoNotTranslate> le brinda información sobre el equipo responsable de la carga de trabajo. Contiene:
