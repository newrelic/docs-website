---
title: UI de cargas de trabajo estándar
tags:
  - New Relic
  - Use New Relic
  - Workloads
...
La UI de cargas de trabajo estándar le ofrece varias vistas para comprender sus cargas de trabajo de New Relic a un alto nivel y con detalle granular. Esta página describe la UI para [Intelligent Workloads estándar](/docs/new-relic-solutions/new-relic-one/workloads/create-workloads). Para [Intelligent Workloads](/docs/new-relic-solutions/new-relic-one/workloads/workloads-overview#intelligent-workloads), consulte la documentación de [Introducción a las Intelligent Workloads](/docs/new-relic-solutions/new-relic-one/workloads/create-intelligent-workload).
...
La página <DNT>**Performance risks**</DNT> muestra los riesgos de rendimiento detectados en las entidades que conforman la carga de trabajo, por lo que no tiene que revisar cada entidad individualmente. Para obtener más información, consulte [Performance Risks inbox](/docs/errors-inbox/performance-risks/introduction).
