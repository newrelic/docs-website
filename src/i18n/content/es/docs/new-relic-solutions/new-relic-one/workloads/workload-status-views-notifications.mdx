...
1. Vaya a <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DoNotTranslate> y seleccione <DoNotTranslate>**Alerts**</DoNotTranslate>. Seleccione la política donde desea agregar la nueva condición de alerta o cree una nueva política con el canal de notificación adecuado. Luego haga clic en <DoNotTranslate>**Create a condition**</DoNotTranslate>.
