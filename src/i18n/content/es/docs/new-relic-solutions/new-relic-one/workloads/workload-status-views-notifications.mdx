...
<Callout variant="tip">
  Esta página se aplica tanto a [cargas de trabajo estándar](/docs/new-relic-solutions/new-relic-one/workloads/create-workloads) como a [Intelligent Workloads](/docs/new-relic-solutions/new-relic-one/workloads/workloads-overview#intelligent-workloads). Los valores de estado y las notificaciones funcionan de la misma manera para ambos tipos.
</Callout>
