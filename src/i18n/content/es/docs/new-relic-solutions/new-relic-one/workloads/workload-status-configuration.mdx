...
Para administrar la configuración del estado de la carga de trabajo, vaya a la página <DoNotTranslate>**Health status**</DoNotTranslate> de una carga de trabajo.
...
Si va a la página <DoNotTranslate>**Health status**</DoNotTranslate> , puede ver cómo se configuró el cálculo del estado y el resultado de todas las reglas y/o estados estáticos que se tuvieron en cuenta para calcular el valor del estado de la carga de trabajo global.
