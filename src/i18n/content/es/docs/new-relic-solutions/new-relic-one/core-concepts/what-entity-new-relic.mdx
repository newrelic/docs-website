...
Estos atributos están destinados a ser sintetizados a partir de la telemetría que recibimos. <DNT>**Do not**</DNT> configúrelos a menos que sea consciente de las implicaciones y consecuencias.
