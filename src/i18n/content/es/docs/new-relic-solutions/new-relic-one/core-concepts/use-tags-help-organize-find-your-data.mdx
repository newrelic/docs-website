...
3. En el campo <DoNotTranslate>**Add a new tag...**</DoNotTranslate> del widget de etiqueta, agregue una etiqueta con este formato: `accountId: 123456789`.<img title="Add tags in New Relic" alt="Add tags in New Relic" src={solutionsTagManagement}/>
