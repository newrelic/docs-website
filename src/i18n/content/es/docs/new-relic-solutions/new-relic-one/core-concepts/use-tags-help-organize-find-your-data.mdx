...
3. En el campo <DNT>**Add a new tag...**</DNT> del widget de etiqueta, agregue una etiqueta con este formato: `accountId: 123456789`.<img title="Add tags in New Relic" alt="Add tags in New Relic" src="/images/solutions_screenshot-full_tag-management.webp"/>
