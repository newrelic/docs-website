...
* Organiza y busca mejor

  <InlinePopover type="dashboards"/>

  y [carga de trabajo](/docs/new-relic-one/use-new-relic-one/workloads/workloads-isolate-resolve-incidents-faster).
...
<CollapserGroup>
  <Collapser
    ...
    title="Etiqueta relacionada con la cuenta"
  >
  ...
  <Collapser
    ...
    title="Etiqueta de host/entorno"
  >
  ...
  <Collapser
    ...
    title="Etiqueta de atributo de recurso OpenTelemetry"
  >
    Ciertos [atributos de recursos de OpenTelemetry](https://github.com/open-telemetry/opentelemetry-specification/blob/main/specification/resource/semantic_conventions/README.md) se aplican automáticamente como etiqueta de entidad. Cuando los siguientes atributos estén presentes en los datos de tramo asociados con una entidad de servicio, se adjuntarán a esa entidad:
    ...
    * `telemetry.sdk.language`: Se almacenará como una etiqueta denominada `language`

    * `telemetry.sdk.version`

    * `service.namespace`

      Esta etiqueta automatizada se realiza mediante la síntesis de entidad New Relic, que está [documentada en GitHub](https://github.com/newrelic/entity-definitions#entity-definitions). En el caso de los servicios OpenTelemetry, las [definiciones de etiquetas](https://github.com/newrelic/entity-definitions/blob/main/definitions/ext-service/definition.yml#L58) están en `ext-service` entidad.
  </Collapser>
</CollapserGroup>
...
1. Vaya a <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DoNotTranslate> y seleccione una entidad de monitoreo, como una aplicación de monitoreo o un host.
2. Cerca del nombre de la entidad en la parte superior de la página, haga clic en el botón <DoNotTranslate>**tags**</DoNotTranslate> .
3. En el campo <DoNotTranslate>**Add a new tag...**</DoNotTranslate> del widget de etiquetas, agregue una etiqueta con este formato: `accountId: 123456789`.<img title="Add tags in New Relic" alt="Add tags in New Relic" src={solutionsTagManagement}/>
...
2. Cerca del nombre de la entidad en la parte superior de la página, haga clic en el botón
...
<CollapserGroup>
  <Collapser
    id="add-via-ui-api"
    title="Administrar etiqueta de condición de alerta"
  >
    1. Navegue hasta una condición.

    2. Cerca del nombre de la condición en la parte superior del formulario, haga clic en <DoNotTranslate>**Manage tags**</DoNotTranslate>.
  ...
  <Collapser
    ...
    title="Automatiza la etiqueta con nuestra CLI"
  >
...
<figcaption>
  Utilice la barra de filtro en la [UIde usuario del explorador de entidades](/docs/new-relic-solutions/new-relic-one/core-concepts/new-relic-explorer-view-performance-across-apps-services-hosts#find) para filtrar a entidades específicas.
</figcaption>
...
<CollapserGroup>
  <Collapser
    id="tag-format"
    title="Formato de etiqueta y límites"
  >
  ...
  <Collapser
    id="simple-tags"
    title="Mantenga la etiqueta simple"
  >
  ...
  <Collapser
    id="consistent-tags"
    title="Utilice una etiqueta consistente"
  >
  ...
  <Collapser
    id="cross-team-tags"
    title="Usar etiqueta entre equipos"
  >
...
<CollapserGroup>
  <Collapser
    id="team-tags"
    title="Etiqueta relacionada con el equipo"
  >
  ...
  <Collapser
    id="environment-tags"
    title="Etiqueta relacionada con el medio ambiente"
  >
  ...
  <Collapser
    id="criticality-tags"
    title="Etiqueta relacionada con la criticidad"
  >
...
## Consulta personalizada, panel y alerta [#query-tags]
...
<CollapserGroup>
  <Collapser
    ...
    title="Rendimiento entre fragmentos"
  >
  ...
  <Collapser
    id="apm-errors-team"
    title="Alerta sobre tasa de errores para equipos"
  >
  ...
  <Collapser
    id="infra-teams"
    title="Encuentre equipos internos que posean entidades específicas para el monitoreo de infraestructura."
  >
  ...
  <Collapser
    id="infra-experiment"
    title="Comparar grupos en un experimento de prueba de carga de CPU"
  >
  ...
  <Collapser
    id="propagation-off"
    title="Desactivar la propagación de etiquetas para etiquetas de infraestructura"
  >
