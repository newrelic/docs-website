...
New Relic también te permite escribir “anomalía consulta” en tus datos. Estas son consultas que usted escribe sin establecer límites estrictos a los resultados. Más bien, permite que [la inteligencia aplicada](https://newrelic.com/platform/applied-intelligence) aprenda automáticamente sus datos de rendimiento y luego le avise cuando sus datos se desvíen demasiado de sus números de anomalía.
...
2. Crea una condición. Seleccionar <DoNotTranslate>**NRQL**</DoNotTranslate>
...
3. Defina su consulta y decida cuán restrictivamente la inteligencia aplicada debe analizar sus datos usando un control deslizante simple y una visualización basada en su rendimiento reciente.
...
La inteligencia aplicada es una excelente manera de ayudarlo a conocer de manera proactiva sus gastos en la nube o cualquiera de sus datos de rendimiento.
