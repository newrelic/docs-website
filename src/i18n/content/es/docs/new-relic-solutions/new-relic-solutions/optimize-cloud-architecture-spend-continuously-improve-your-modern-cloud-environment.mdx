...
2. Crea una condición. Seleccionar <DNT>**NRQL**</DNT>
   ...
   /\* &lt;img title=&quot;Ingresa una consulta NQRL&quot; alt=&quot;Ingresa una consulta NQRL&quot; src=&quot;/images/alert-policy\_screenshot-full\_enter-nrql.webp&quot; /&gt; \*/
...
3. Defina su consulta y decida cuán restrictivamente las alertas New Relic deben analizar sus datos empleando un control deslizante simple y una visualización basada en su rendimiento reciente.
   ...
   /\* &lt;img title=&quot;Ingresar un umbral&quot; alt=&quot;Ingresar un umbral&quot; src=&quot;/images/alert-policy\_screenshot-full\_enter-threshold.webp&quot; /&gt; \*/
