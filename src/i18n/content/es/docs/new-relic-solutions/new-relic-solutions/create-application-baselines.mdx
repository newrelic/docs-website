...
<CollapserGroup>
  <Collapser id="components-list" title="Ejemplo: lista de componentes">
...
<CollapserGroup>
  <Collapser id="connect-migration-example" title="Ejemplo: componentes coincidentes con productos New Relic">
...
<CollapserGroup>
  <Collapser id="deploy-apm" title="Desplegar APM">
  ...
  <Collapser id="deploy-infrastructure" title="Desplegar infraestructura">
  ...
  <Collapser id="deploy-infrastructure-on-host" title="Implementar infraestructura integrada en el host">
  ...
  <Collapser id="create-synthetics-monitor" title="Crear monitor Sintético">
...
<CollapserGroup>
  <Collapser id="baseline-maturity-example" title="Ejemplo: Rendimiento de componentes comparado con línea de base">
