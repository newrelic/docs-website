...
Para ayudarlo a crear una aplicación New Relic, le proporcionamos el [SDK New Relic One](/docs/new-relic-solutions/build-nr-ui/sdk-component/intro-to-sdk). En esta página, aprenderá cómo usar `NerdStorageVault` para almacenar datos en una solución de almacenamiento cifrada.
