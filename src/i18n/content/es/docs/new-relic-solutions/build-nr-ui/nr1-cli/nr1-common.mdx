...
Para obtener más información sobre Nerdpacks y su estructura de archivos, consulte [Estructura de archivos de Nerdpack](/explore-docs/nerdpack-file-structure). Para obtener más información sobre cómo configurar sus Nerdpacks, consulte nuestros [comandos CLI de Nerdpack](/explore-docs/nr1-nerdpack).
