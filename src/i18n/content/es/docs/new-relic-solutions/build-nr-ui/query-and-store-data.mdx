...
Para ayudarlo a crear una aplicación New Relic, le proporcionamos el SDK de New Relic One. Aquí puede aprender a emplear los componentes de consulta del SDK, que le permiten realizar consultas y mutaciones a través de [NerdGraph](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph/), nuestro extremo GraphQL.
...
* `CHART`: El formato empleado por el motor de gráficos que también exponemos.
