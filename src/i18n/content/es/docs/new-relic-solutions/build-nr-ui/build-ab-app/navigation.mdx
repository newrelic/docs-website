...
<Steps>
  ...
  <Step>
    ...
    <Callout variant="tip">
      ...
      * Reemplazó todas las instancias de `<YOUR NEW RELIC ACCOUNT ID>` y `<YOUR NEW RELIC ENTITY GUID>` en su proyecto con su New Relic [ID](https://docs.newrelic.com/docs/accounts/accounts-billing/account-setup/account-id) de cuenta y GUID de entidad reales, respectivamente
    </Callout>
  </Step>
</Steps>
