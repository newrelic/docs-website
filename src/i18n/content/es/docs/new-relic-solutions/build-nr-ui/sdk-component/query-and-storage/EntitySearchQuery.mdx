---
title: Consulta de búsqueda de entidad
...
<table>
  <tbody>
    ...
    <tr>
      <td>
        `filters` <h5>cadena|(forma|forma|forma)\[]</h5>
      </td>
    ...
    <tr>
      <td>
        `includeCount` <h5>booleano</h5>
      </td>

      <td>
        Si es `true`, la respuesta de la consulta incluye el recuento total de entidades para cada dominio y tipo.
      </td>
    </tr>

    <tr>
      <td>
        `includeResults` <h5>booleano</h5>
      </td>

      <td>
        Si `true`, la respuesta de la consulta incluye entidad.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        <OptionReference array>
          EntitySearchQuery.SORT_TYPE.alertas, EntitySearchQuery.SORT_TYPE.dominio, EntitySearchQuery.SORT_TYPE.MOST_RELEVANT, EntitySearchQuery.SORT_TYPE.NAME, EntitySearchQuery.SORT_TYPE.REPORTING, EntitySearchQuery.SORT_TYPE.TYPE,
        </OptionReference>
      </td>
    </tr>
  </tbody>
