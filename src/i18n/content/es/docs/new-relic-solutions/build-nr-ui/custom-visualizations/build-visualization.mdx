...
<Callout variant="tip">
  Si recibe un `RequestError` para un certificado autofirmado cuando ejecuta `nr1 create`, es posible que deba agregar un certificado a la cadena de certificados de Node. Lea más sobre esta y otras configuraciones avanzadas en Habilitar configuración avanzada para su Nerdpack.
</Callout>
