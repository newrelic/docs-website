...
Para agregar una instancia de su visualización a un dashboard, primero debe [publicar su Nerdpack](/docs/new-relic-solutions/new-relic-one/build-nr-apps/publish).
