...
Tenga en cuenta que solo [las ediciones](https://newrelic.com/pricing) Pro y Enterprise permiten múltiples cuentas, la capacidad de agregar grupos y roles personalizados y la capacidad de tener más de cinco usuarios de plataforma completa. Esto significa que si tienes la edición Free o Standard, planificar tu usuario es menos importante.
