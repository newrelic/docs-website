...
Cuando se registra en New Relic, debe elegir en cuál de nuestras regiones de centro de datos estará su organización. Existen algunas diferencias entre las regiones: por ejemplo, tienen diferentes extremos de API y tienen algunas diferencias de características. [Obtenga más información sobre las regiones del centro de datos.](/docs/accounts/accounts-billing/account-setup/choose-your-data-center/)
