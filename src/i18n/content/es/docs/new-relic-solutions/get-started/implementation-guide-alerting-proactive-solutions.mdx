...
Para enviarle mensajes de notificación de alerta, utilizamos <DoNotTranslate>**workflows**</DoNotTranslate> (las reglas de cómo el incidente crea la notificación y qué datos se envían) y <DoNotTranslate>**notification destinations**</DoNotTranslate> (dónde se envía la notificación). Le recomendamos que planifique cómo se configurarán para que sean coherentes y mantenibles en toda su organización. Si se está integrando con otro servicio, como Slack o PagerDuty, considere cómo controlará y mantendrá esta integración a largo plazo.
