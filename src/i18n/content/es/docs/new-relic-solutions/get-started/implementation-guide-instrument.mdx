...
Nuestro agente APM y nuestro agente de infraestructura están diseñados para informar el registro listo para usar para algunas configuraciones y marcos de registro comunes. A ese log lo llamamos _logs en el contexto_ porque los ve no solo en nuestra UI de usuario de registro principal, sino también junto con los datos de su aplicación y host en la UI de infraestructura y APM.
