...
Cuando esté listo, le sugerimos crear un dashboard. Cuando ejecuta una consulta, puede presionar <DoNotTranslate>**Add to dashboard**</DoNotTranslate> en la parte inferior de la pantalla y luego tendrá la opción de crear un nuevo dashboard.
...
Nuestra característica <DoNotTranslate>**workloads**</DoNotTranslate> te brinda la posibilidad de agrupar y monitor entidades según tus propios criterios (por ejemplo, un equipo específico o un conjunto de responsabilidades). Luego podrá ver datos agregados de salud y actividad para esa carga de trabajo en toda su stack.
...
¿Listo para continuar su viaje de implementación? Vaya a la siguiente etapa: [<DoNotTranslate>**Alerting and proactive solutions**</DoNotTranslate>](/docs/new-relic-solutions/get-started/implementation-guide-alerting-proactive-solutions/).