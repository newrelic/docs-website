...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        La [región](/docs/accounts/accounts-billing/account-setup/choose-your-data-center/) en la que está alojada su cuenta de New Relic. Valores aceptados: EU, JP o US. No distingue entre mayúsculas y minúsculas. Por defecto: US
      </td>
    </tr>
