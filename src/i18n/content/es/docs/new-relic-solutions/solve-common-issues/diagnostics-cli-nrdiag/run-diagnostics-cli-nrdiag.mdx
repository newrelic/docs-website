...
<CollapserGroup>
  ...
  >
    ...
    4. Para la resolución de problemas de la aplicación web, asegúrese de ejecutar el ejecutable desde el directorio <DoNotTranslate>**parent**</DoNotTranslate> de su proyecto o especifique la ubicación del archivo de configuración con la opción `-c` .
