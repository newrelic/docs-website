...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Utilice [valores`audit_log` ](/docs/agents/ruby-agent/installation-configuration/ruby-agent-configuration#audit_log). Para obtener más información, consulte [Registro de auditoría del agente Ruby](/docs/agents/ruby-agent/troubleshooting/ruby-agent-audit-log).
      </td>
    </tr>
  </tbody>
</table>
