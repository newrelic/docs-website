    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            Utilice [`phpinfo()`](/docs/agents/php-agent/configuration/php-agent-configuration#inivar-background) y busque en las secciones denominadas <DoNotTranslate>**Scan this dir for additional .ini files**</DoNotTranslate> o <DoNotTranslate>**Additional .ini files parsed**</DoNotTranslate> la ubicación del archivo `newrelic.ini` . Este archivo estará en el directorio raíz del agente, que se llama `newrelic-php5`.
