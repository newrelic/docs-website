...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="KPI del flujo de negocios"
  >
...
El objetivo es dar señales que tengan un nivel de independencia, y cuando ocurra un incidente podrás deducir por lo que está _en rojo_ cuál puede ser el problema.
