...
El objetivo es proporcionar señales que tengan un nivel de independencia, y cuando ocurra un evento de alerta, podrá deducir a partir de lo que está en *rojo* cuál puede ser el problema.
