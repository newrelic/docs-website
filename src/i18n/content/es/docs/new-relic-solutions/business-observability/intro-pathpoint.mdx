...
<img title="Example Flow List" alt="Example Flow List" src={exampleFlowList} />
...
<img title="Airport Flow Example" alt="Airport Flow Example" src={airportFlowExample} />
...
<img title="Rideshare Flow Example" alt="Rideshare Flow Example" src={rideShareFlowExample} />

<figcaption>
  El viaje compartido, incluidas las etapas y los pasos (sin señales)
</figcaption>

### Seleccionar señales relevantes [#selecting-relevant-signals]
...
<img title="Signal Selection" alt="Selection Selection" src={signalSelection} />
