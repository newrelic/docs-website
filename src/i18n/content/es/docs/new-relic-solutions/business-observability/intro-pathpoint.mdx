...
Pathpoint es un proyecto de catálogo de código abierto desarrollado por el equipo de los laboratorios New Relic. Consulte el [repositorio de GitHub Pathpoint](https://github.com/newrelic/nr-labs-pathpoint).

¿Quieres comprender los beneficios de Pathpoint a un alto nivel? Consulte la [página del producto Pathpoint](https://newrelic.com/platform/pathpoint).
