...
<Steps>
  <Step>
    Seleccione un punto de contacto para probar. Haga clic derecho sobre él y haga clic en <DNT>**Queries**</DNT>.
  ...
  <Step>
    Abre una ventana. Haga clic en <DNT>**Test**</DNT>.
  ...
  <Step>
    La ventana le mostrará los resultados de la prueba. Por ejemplo, si ve <DNT>**Successfully validated**</DNT>, significa que su punto de contacto está en buen estado.

    Si la validación falla, averigüe por qué y corríjalo. Luego, pruébelo nuevamente hasta que reciba el mensaje <DNT>**Successfully validated**</DNT> .
  </Step>

  <Callout variant="important">
    Al probar un punto de contacto, si recibe un error <DNT>**Incorrectly validated**</DNT> , es posible que se deba a que la consulta se ejecutó con el ID de cuenta incorrecto.
...
<Steps>
  <Step>
    Seleccione un punto de contacto para probar. Haga clic derecho sobre él y seleccione <DNT>**Tune**</DNT>.
  ...
  <Step>
    Introduzca nuevos valores de umbral <DNT>**Min**</DNT> y <DNT>**Max**</DNT> y haga clic en <DNT>**Save/Update**</DNT>.
...
<Steps>
  <Step>
    Haga clic derecho en el punto de contacto particular con el que desea trabajar y haga clic en <DNT>**Queries**</DNT>.
...
<Steps>
  ...
  <Step>
    Si el punto de contacto está activado, haga clic en el botón <DNT>**On**</DNT> para desactivarlo.
