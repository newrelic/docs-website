...
Para obtener detalles adicionales, consulta [Configura tu entorno de desarrollo](/docs/new-relic-solutions/new-relic-one/build-nr-apps/set-up-dev-env/).
...
## Importar el `PlatformStateContext` [#import]
