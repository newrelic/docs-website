...
A partir de la versión 2.49.1 de nuestra CLI de `nr1`, puede crear aplicaciones de New Relic y visualizaciones personalizadas con [React hooks](https://react.dev/reference/react/hooks). ¡Esta guía ofrece algunos ejemplos de Nerdlet de React hooks en acción!
