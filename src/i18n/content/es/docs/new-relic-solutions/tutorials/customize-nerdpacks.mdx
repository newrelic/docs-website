...
<Steps>
  ...
  <Step>
    [Agregue **Victory Charts Visualizations** a su cuenta](/docs/new-relic-solutions/new-relic-one/build-nr-apps/subscribe).
  </Step>
  ...
  <Step>
    Como vas a usar una versión modificada del Nerdpack **Victory Charts Visualizations** en lugar de a la que te suscribiste, puedes [cancelar la suscripción](/docs/new-relic-solutions/new-relic-one/build-nr-apps/subscribe/#unsubscribe-from-a-nerdpack) a nuestra versión ahora.
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    ¡Perfecto! Clonaste y actualizaste la visualización de la **Circular progress bar** de código abierto del catálogo de Instant Observability. Lo único que queda por hacer es publicar tu versión en el catálogo para que tus cuentas puedan [suscribirse](/docs/new-relic-solutions/new-relic-one/build-nr-apps/subscribe/#subscribe-to-a-nerdpack) a ella.
  </Step>
...
<Steps>
  <Step>
    Desde su directorio raíz, [publica](/docs/new-relic-solutions/new-relic-one/build-nr-apps/publish/) tu Nerdpack:
  ...
  <Step>
    [Suscríbete](/docs/new-relic-solutions/new-relic-one/build-nr-apps/subscribe/#subscribe-to-a-nerdpack) a tu Nerdpack:
