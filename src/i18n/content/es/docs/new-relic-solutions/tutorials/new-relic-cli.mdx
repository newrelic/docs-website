...
Eche un vistazo a [todos los comandos disponibles](https://github.com/newrelic/newrelic-cli/blob/master/docs/cli/newrelic.md) en la CLI de New Relic. Por ejemplo, puede crear una [carga de trabajo de New Relic](\(/docs/new-relic-solutions/new-relic-one/workloads/workloads-isolate-resolve-alert-events-faster\)) usando [`workload create`](https://github.com/newrelic/newrelic-cli/blob/master/docs/cli/newrelic_workload_create.md)
