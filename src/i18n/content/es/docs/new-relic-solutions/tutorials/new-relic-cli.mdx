...
<Steps>
  ...
  <Step>
    ...
    <Callout variant="important">
      Debe establecer la [región](/docs/accounts/accounts-billing/account-setup/choose-your-data-center) de la cuenta de New Relic. Use `-r` para establecer `us`, `eu` o `jp`.
    </Callout>
  </Step>
...
Consulte [todos los comandos disponibles](https://github.com/newrelic/newrelic-cli/blob/master/docs/cli/newrelic.md) en la CLI de New Relic. Por ejemplo, puede crear una [carga de trabajo de New Relic](/docs/new-relic-solutions/new-relic-one/workloads/workloads-overview) usando [`workload create`](https://github.com/newrelic/newrelic-cli/blob/master/docs/cli/newrelic_workload_create.md)

Si desea interactuar con otros miembros de la comunidad, visite nuestra página de [New Relic Explorer Hub](https://support.newrelic.com/s/hubtopic/Topic__c/Default?c__categories=%5B%7B%22icon%22%3A%22standard%3Adefault%22%2C%22id%22%3A%22a6c8W000000EeszQAC%22%2C%22sObjectType%22%3A%22Category__c%22%2C%22title%22%3A%22Build%20on%20New%20Relic%22%2C%22titleFormatted%22%3A%22Build%20on%20New%20Relic%22%7D%5D). Agradecemos los requests de características o los informes de errores en [GitHub](https://github.com/newrelic/newrelic-cli).