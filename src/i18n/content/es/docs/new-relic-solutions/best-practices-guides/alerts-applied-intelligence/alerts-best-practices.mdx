...
* [Configurar la cobertura de alertas a escala con alertas inteligentes](/docs/alerts/smart-alerts-coverage) (vista previa pública)
...
* Lea más sobre [cuándo es posible que desee usar la configuración de pérdida de señal y llenado de vacíos](https://knowledge.newrelic.com/s/article/How-Can-I-Figure-Out-When-To-Use-Gap-Filling-and-Loss-of-Signal).