...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <DNT>**Avoid setting thresholds too low**</DNT>. Por ejemplo, si establece un umbral de condición de CPU del 75% durante 5 minutos en sus servidores de producción y rutinariamente supera ese nivel, esto aumentará la probabilidad de alerta no procesable o falso positivo.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <DNT>**You don't need to edit files or restart the software**</DNT>, así que siéntete libre de realizar cambios rápidos en tus niveles de umbral y ajustarlos según sea necesario.
      </td>
    </tr>
