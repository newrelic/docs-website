...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Desplácese por la columna <DoNotTranslate>**Notified**</DoNotTranslate> para asegurarse de que todos los problemas se dirijan a al menos un destino. Si no es necesario enrutar, considere eliminar la condición, ya que puede ser ruido.
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <DoNotTranslate>**Avoid setting thresholds too low**</DoNotTranslate>. Por ejemplo, si establece un umbral de condición de CPU del 75% durante 5 minutos en sus servidores de producción y rutinariamente supera ese nivel, esto aumentará la probabilidad de alerta no procesable o falso positivo.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <DoNotTranslate>**You don't need to edit files or restart the software**</DoNotTranslate>, así que siéntete libre de realizar cambios rápidos en tus niveles de umbral y ajustarlos según sea necesario.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Puede <DoNotTranslate>**disable any condition**</DoNotTranslate> en una política, si es necesario. Esto es útil, por ejemplo, si deseas seguir usando otras condiciones en la póliza mientras experimentas con otras métricas o umbrales.
      </td>
    </tr>
  </tbody>
</table>
