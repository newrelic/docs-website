...
* <DNT>**Static threshold alerts**</DNT> son excelentes cuando ya conoce la naturaleza de una aplicación y no es probable que su comportamiento normal cambie pronto. La puntuación Apdex, el tiempo de respuesta, la tasa de errores y el rendimiento son algunos de los umbrales estáticos sobre los que puede crear una política de alertas.
* <DNT>**Dynamic anomaly alerts**</DNT> Facilite la determinación y el establecimiento de un umbral de alerta dinámico para su aplicación con diferentes patrones estacionales y tendencias de crecimiento (lo que dificulta establecer un umbral que defina el comportamiento normal). Estos <InlinePopover type="alerts" />utilizan anomalías modeladas a partir de los datos métricos históricos de su aplicación.
...
* [entidad](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#alert-entity) a la que se dirige la política (por ejemplo, aplicaciones APM, <InlinePopover type="browser" />aplicaciones o hosts)
...
1. Vaya a <DNT>**[one.newrelic.com &gt; All capabilities](https://one.newrelic.com/all-capabilities) &gt; Key transactions**</DNT> y luego seleccione <DNT>**Add more**</DNT>. Luego seleccione la aplicación y la transacción web o, desde la transacción seleccionada, seleccione <DNT>**Track as key transaction**</DNT>.
2. Escriba un nombre para la transacción clave y seleccione <DNT>**Track key transaction**</DNT>.
...
4. Para ver los detalles dashboard de transacción clave, seleccione <DNT>**View new key transaction**</DNT>.
...
1. En la barra de menú New Relic , seleccione <DNT>**APM &amp; services &gt; (select an app) &gt; Events &gt; Deployments**</DNT>.
2. Para ver el rendimiento después de un despliegue, vaya al dashboard de descripción general de la aplicación seleccionada en la sección <DNT>**Recent events**</DNT>.
...
1. En la barra de menú de APM, seleccione <DNT>**Applications &gt; (select an app) &gt; Reports**</DNT>.
2. Seleccione el informe que desea ver.
3. Si desea guardar o exportar un informe para compartir, seleccione <DNT>**Download this report as .csv**</DNT>, lo que creará un informe con valores separados por comas.
...
1. Vaya a <DNT>**[one.newrelic.com &gt; All capabilities](https://one.newrelic.com/all-capabilities) &gt; More &gt; Service maps**</DNT>.
...
3. Modifique los archivos de configuración comparando archivos nuevos con archivos existentes. En particular, asegúrese de que elementos como <InlinePopover type="licenseKey" />y las extensiones personalizadas se copien en la nueva configuración.
...
[Cómo administra sus usuarios.](/docs/accounts/accounts-billing/new-relic-one-user-management/introduction-managing-users)