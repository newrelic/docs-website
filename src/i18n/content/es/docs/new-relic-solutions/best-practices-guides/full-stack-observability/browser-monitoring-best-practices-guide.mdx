...
Revise la pestaña <DoNotTranslate>**Page Views**</DoNotTranslate> en la UI de monitoreo de navegador o ejecute la siguiente consulta NRQL:
...
¿No estás seguro de por dónde empezar con la configuración? Intente utilizar el [dashboardde investigación de segmentos del navegador](https://newrelic.com/instant-observability/browser-segment-investigation/eb24e234-90aa-4908-972d-64d6d56b557e).
...
1. En la UI usuario de monitoreo de navegador, seleccione
...
* <DoNotTranslate>**Core web vitals:**</DoNotTranslate>
  ...
  Alerta si el tiempo desde la primera entrada o la pintura con contenido más grande están por encima del umbral `Needs improvement` .
...
Comience con el <DoNotTranslate>**browser examples quickstart**</DoNotTranslate>
