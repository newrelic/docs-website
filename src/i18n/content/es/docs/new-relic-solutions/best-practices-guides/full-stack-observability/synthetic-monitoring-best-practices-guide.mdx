...
<Steps>
  ...
  <Step>
    ...
    1. Para agregar un monitor, vaya a <DNT>**[one.newrelic.com &gt; All capabilities](https://one.newrelic.com/all-capabilities) &gt; Synthetic Monitoring**</DNT>.
       ...
       Si tiene una cuenta regional, utilice la URL adecuada:

       * UE: <DNT>**[one.eu.newrelic.com](https://one.eu.newrelic.com)**</DNT>
       * JP: <DNT>**[one.jp.newrelic.com](https://one.jp.newrelic.com)**</DNT>
  ...
  <Step>
    ...
    Para identificar rápidamente los monitores que están fallando, puede usar la página del [índice de monitores sintéticos](/docs/synthetics/synthetic-monitoring/pages/synthetic-monitoring-summary) para ver qué monitores tienen eventos de alerta abiertos, tasas de éxito durante 24 horas, número de ubicaciones con fallas, el período del monitor y el tipo de monitor. Cuando hagas clic en un monitor, irás a la [página de Resumen](/docs/synthetics/new-relic-synthetics/pages/synthetics-overview-page-view-monitors-performance), donde encontrarás información para evaluar dónde está fallando ese monitor en particular, por qué está fallando, por ejemplo, el último mensaje de error, los códigos de respuesta de error, la duración por dominio y más. Con esta información, tendrá una visión más profunda del rendimiento de su aplicación a lo largo del tiempo.
