...
<Steps>
  ...
  <Step>
    ...
    2. Haga clic en <DNT>**Create monitor**</DNT>.
       ...
       <img src={syntheticsCreateMonitor} title="Create your synthetic monitor" alt="A screenshot showing the location of the Create monitor button in the UI." />
  ...
  <Step>
    ...
    <img src={syntheticsMonitorCriticalAlert} title="Synthetic monitor critical alert" alt="A screenshot that shows where your critical alerts are located in the UI." />
  </Step>
