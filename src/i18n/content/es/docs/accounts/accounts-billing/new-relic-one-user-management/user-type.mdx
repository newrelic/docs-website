...
En este documento, aprenderá cómo definimos <DoNotTranslate>**user type**</DoNotTranslate>, a qué características tiene acceso cada tipo de usuario y cómo decidir sobre un tipo de usuario.
...
El <DoNotTranslate>**user type**</DoNotTranslate> de un usuario de New Relic determina el conjunto máximo de permisos de New Relic al que puede acceder. El tipo de usuario está destinado a ser una configuración a bastante largo plazo basada en las responsabilidades esperadas de un usuario durante los próximos meses o más.
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            Todo característico. Esto incluye aquellos en la columna <DoNotTranslate>**Basic user**</DoNotTranslate> más la capacidad de:
