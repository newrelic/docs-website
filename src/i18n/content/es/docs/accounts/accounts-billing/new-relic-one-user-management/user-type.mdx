...
<CollapserGroup>
  <Collapser id="ai-capabilities" title="Acceso a alertas">
    Aquí hay más detalles sobre cómo el tipo de usuario afecta el acceso a las características de alertas:
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          <td>
            Acceso a características de nivel superior de [<DNT>Alerts</DNT>](/docs/alerts/overview), que incluyen:
