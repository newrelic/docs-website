...
<CollapserGroup>
  ...
  <Collapser id="manage-user-type-scim" title="Administrar el tipo de usuario con SCIM">
    ...
    * Directorio activo de Azure: consulte la discusión del foro de New Relic sobre cómo configurar Azure AD para SCIM con tipos de usuario [aquí](https://forum.newrelic.com/s/hubtopic/aAX8W0000008d6MWAQ/relic-solution-make-full-core-basic-users-in-azure-active-directory-w-scim).
