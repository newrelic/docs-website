...
<Callout variant="important">
  Los usuarios con acceso restringido podrían ver información de las particiones de logs restringidas a través de [exportaciones históricas](/docs/apis/nerdgraph/examples/nerdgraph-historical-data-export/), [notificaciones de alertas](/docs/alerts/get-notified/alert-event-workflows/) o la [API de Insights](/docs/apis/insights-apis/query-insights-event-data-api/). Consulte [riesgos potenciales de exposición de datos](#data-exposure-risks) para obtener detalles y mitigaciones.
</Callout>
