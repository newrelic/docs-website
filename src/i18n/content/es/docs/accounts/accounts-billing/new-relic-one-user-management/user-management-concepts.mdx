...
Puedes crear un rol <DNT>**Group admin**</DNT> para asignarlo a un grupo. Esta función le da al grupo la capacidad de agregar y eliminar usuarios de uno o más grupos que seleccione.
...
Para emplear el rol <DNT>**Group admin**</DNT>, un usuario debe estar en un grupo con roles de alcance de organización que incluyan licencias de administración de dominio de autenticación.
