...
* <DNT>**User**</DNT>
  ...
  <DNT>[**All product admin**](#standard-roles)</DNT>
...
* Un
  ...
  <DNT>[**authentication domain**](/docs/accounts/accounts-billing/new-relic-one-pricing-users/configure-authentication-domains)</DNT>
