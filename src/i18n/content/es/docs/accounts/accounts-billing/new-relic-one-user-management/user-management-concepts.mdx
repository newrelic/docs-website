...
* **Roles de alcance de la organización**: estos roles se aplican para funciones de toda la organización, como gestionar el dominio de autenticación, crear cuentas, configurar los ajustes de la organización o gestionar cuadros de mando y equipos. Los roles estándar incluyen:
  ...
  * <DNT>**Organization product admin**</DNT>: Licencias relacionadas con características de observabilidad de ámbito organizacional como el cuadro de mando y la gestión de equipos. Este es el equivalente en el ámbito de la organización a <DNT>**All product admin**</DNT>. No contiene características administrativas como IAM, facturación o configuración de la organización.
...
<Callout variant="important">
  Los roles personalizados con alcance de organización no reciben nuevos permisos automáticamente. Cuando New Relic lanza una nueva característica con alcance de organización, sus permisos se agregan a los roles estándar, por lo que los usuarios que tienen esos roles estándar obtienen la nueva característica automáticamente. Un rol personalizado con alcance de organización solo contiene los permisos que le agregue, por lo que un administrador debe agregar nuevos a cada rol personalizado que deba tenerlo.

  Para que los usuarios reciban nuevas características de ámbito organizacional automáticamente, asigne el rol estándar <DNT>**Organization product admin**</DNT> para obtener acceso completo al producto, o el rol <DNT>**Organization read only**</DNT> para acceso de lectura.
</Callout>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Proporciona acceso de solo lectura a la plataforma New Relic (a excepción de [las credenciales seguras del monitor Sintético](/docs/synthetics/synthetic-monitoring/using-monitors/store-secure-credentials-scripted-browsers-api-tests/)).
      </td>
