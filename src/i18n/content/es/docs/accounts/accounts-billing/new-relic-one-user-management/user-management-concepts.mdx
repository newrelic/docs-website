...
Las organizaciones con [Pro o edición Enterprise](https://newrelic.com/pricing) pueden tener múltiples cuentas en su organización y pueden crear roles y grupos personalizados. Nuestras ediciones Gratuita y Estándar permiten solo una cuenta en una organización y no le permiten crear roles o grupos personalizados.
