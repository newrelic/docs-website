...
Aquí se detallan los contenidos del menú de usuario. <DoNotTranslate>**Note that the user menu is subject to change: this was last updated March 9, 2023.**</DoNotTranslate>
...
2. <DoNotTranslate>**User preferences**</DoNotTranslate>
...
3. <DoNotTranslate>**API keys**</DoNotTranslate>

   : administra tu [clave de API de New Relic](/docs/apis/intro-apis/new-relic-api-keys).

4. <DoNotTranslate>**Manage your plan**</DoNotTranslate>
...
5. <DoNotTranslate>**Administration**</DoNotTranslate>
...
En la parte inferior derecha, encima de tu nombre, hay un botón <DoNotTranslate>**Add user**</DoNotTranslate> . Utilice esto para [invitar al usuario](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-ui-and-tasks#add-users) a New Relic.