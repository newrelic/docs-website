...
3. Agregue usuarios a un grupo designado: los usuarios con el tipo de usuario core o de plataforma full deben agregarse a un grupo con una [concesión de acceso](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts/#access-grants) a nivel de organización que les asigne el rol de Tenant Manager.
...
<DocTiles>
  <DocTile title="Paso 1" path="/docs/accounts/accounts-billing/account-structure/multi-tenancy/org-creation">
    Crear cuentas y organización
  </DocTile>

  <DocTile title="Paso 2" path="/docs/accounts/accounts-billing/account-structure/multi-tenancy/delegated-administration">
    Gestionar usuarios y accesos
  </DocTile>

  <DocTile title="Paso 3" path="/docs/accounts/accounts-billing/account-structure/multi-tenancy/share-accounts">
    Compartir cuentas (opcional)
  </DocTile>
</DocTiles>