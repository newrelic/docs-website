...
<CollapserGroup>
  <Collapser id="heroku-add-on-license-key" title="Clave de licencia">
  ...
  <Collapser id="heroku-add-on-account-url" title="URL de la cuenta">
    Si instala el complemento New Relic varias veces y necesita verificar la URL que usa su aplicación Heroku para informar a New Relic, busque en el log de su agente una línea que indique `reporting to` seguida de una URL que use este formato:
  ...
  <Collapser id="heroku-add-on-account" title="ID de la cuenta">
...
<CollapserGroup>
  <Collapser id="heroku-add-on-login" title="Inicie sesión en la cuenta complementaria de New Relic a través de Heroku">
  ...
  <Collapser id="regular-login" title="Inicie sesión en cuentas habituales de New Relic">
