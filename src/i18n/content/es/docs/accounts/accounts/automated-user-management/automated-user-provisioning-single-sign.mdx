...
4. Si no emplea uno de los servicios anteriores, deberá:

   * Utilice la UI del dominio de autenticación para [habilitar SCIM como origen de usuarios](/docs/accounts/accounts-billing/new-relic-one-user-management/authentication-domains-saml-sso-scim-more/#source-users).
