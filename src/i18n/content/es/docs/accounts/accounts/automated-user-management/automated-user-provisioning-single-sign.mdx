...
3. Si usa Azure AD, Okta o OneLogin, use la guía correspondiente: [Azure AD](/docs/azure-scimsso-application-configuration) \| [Okta](/docs/okta-scimsso-application-configuration) \| [OneLogin](/docs/onelogin-scimsso-application-configuration).
