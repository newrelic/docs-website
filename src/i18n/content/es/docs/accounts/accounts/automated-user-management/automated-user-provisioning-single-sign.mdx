...
* Debe tener un [tipo de usuario](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type) Core o Full Platform y estar en un grupo con el [rol<DNT>**Authentication domain manager**</DNT> ](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts#admin-settings)con alcance de organización.
