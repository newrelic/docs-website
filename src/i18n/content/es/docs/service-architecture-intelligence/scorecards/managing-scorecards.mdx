...
<Callout variant="tip" title="consejo">
  Utilice las mutaciones de NerdGraph para crear o administrar sus reglas de Scorecards. Para obtener más información, consulte [Crear roles personalizados para Scorecards](/docs/apis/nerdgraph/examples/nerdgraph-scorecards-custom-tutorial).
</Callout>
