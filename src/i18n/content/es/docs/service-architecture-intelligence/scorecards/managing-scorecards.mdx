...
* El usuario con el rol <DNT>**Organization Product Admin**</DNT> puede crear, actualizar y eliminar cuadros de mando y reglas. Si necesita delegar estas licencias a otros usuarios, puede [crear un rol personalizado para Scorecards](/docs/apis/nerdgraph/examples/nerdgraph-scorecards-custom-tutorial)
...
* El usuario con el rol <DNT>**Org Product Admin**</DNT> puede crear, actualizar y eliminar cuadros de mando y reglas. Si necesita delegar estas licencias a otros usuarios, puede [crear un rol personalizado para Scorecards](/docs/apis/nerdgraph/examples/nerdgraph-scorecards-custom-tutorial)
