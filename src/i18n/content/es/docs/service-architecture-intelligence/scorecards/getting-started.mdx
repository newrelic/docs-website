...
Las reglas se agrupan por [nivel de madurez](/docs/service-architecture-intelligence/scorecards/service-maturity) (básico, intermedio y avanzado), para que pueda ver cómo se distribuyen sus estándares y realizar un seguimiento de cómo progresan los servicios desde el cumplimiento básico hasta la excelencia operativa.
...
La vista de la entidad enumera cada entidad evaluada por el Scorecard, con una columna de nivel de madurez y un desglose de cuántas reglas aprueba cada entidad en cada nivel de madurez. Úselo para filtrar sus servicios y ver exactamente dónde se encuentra cada uno en la escala de madurez. Para obtener más información, consulte [Madurez del servicio](/docs/service-architecture-intelligence/scorecards/service-maturity).
