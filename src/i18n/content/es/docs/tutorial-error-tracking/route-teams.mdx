---
title: Asignar errores a equipos y actualizar el estado de error
...
## Gestiona tus grupos de errores [#manage]

<Steps>
  <Step>
    ## Asignar el error al equipo correcto

    Desde la página <DoNotTranslate>**Error group summary**</DoNotTranslate> , puede asignar el grupo de error al equipo correcto.
  ...
  <Step>
    ...
    * Si se espera un grupo de errores, puede marcar el error como
      ...
      <DoNotTranslate>**Ignored**</DoNotTranslate>
    ...
    * New Relic rastrea el estado de un error a lo largo del tiempo. Por ejemplo, si marca un grupo de error como
      ...
      <DoNotTranslate>**Regression**</DoNotTranslate>
...
* ¿Está interesado en obtener más información sobre Errors Inbox? Consulte nuestro [documentoErrors Inbox ](/docs/errors-inbox/errors-inbox)para conocer algunas de las mejores prácticas.
* Si está buscando resolver incidentes en su infraestructura, consulte nuestro tutorial sobre [resolución de problemas de datos del host](/docs/tutorial-troubleshoot-infra-hosts/collect-your-data).
* ¿Tu aplicación es lenta? Consulta nuestro [tutorial sobre resolución de problemas de comportamiento lento de aplicaciones](/docs/tutorial-app-slow/root-causes).

<UserJourneyControls previousStep={{"path":"/docs/tutorial-errors/solve-critical-errors","title":"Paso anterior","body":"Localice el error en su sistema que provocó una interrupción del servicio."}}/>