...
* **Requisitos del sistema SAP**: Confirme que sus sistemas SAP cumplen con los niveles de lanzamiento de componentes de software requeridos especificados por New Relic Monitoring para soluciones SAP. Para obtener detalles sobre los proveedores de datos disponibles por tipo de sistema, consulte la [Referencia de proveedores de datos](/docs/sap-solutions/additional-resources/data-providers-reference).
...
* **Cargue el rol de autorización** [`NEWR_DATA_PROVIDER`](/docs/sap-solutions/additional-resources/additional-configuration/#upload-authorization-role).

* Cree un usuario del sistema con el rol cargado para las conexiones RFC. Consulte [Crear ID de usuario RFC de New Relic](/docs/sap-solutions/additional-resources/additional-configuration/#create-rfc-user-id).
...
* Modificar las políticas de firewall para permitir el tráfico HTTPS a New Relic si está bloqueado.
  ...
  <Callout variant="tip">
    Estas conexiones se pueden configurar en el **Central Monitoring System** utilizando la **SAP Transaction SM59** y se pueden probar. Consulte la [Establecer destino HTTP en New Relic Cloud](/docs/sap-solutions/additional-resources/additional-configuration/#set-http-destination-to-new-relic-cloud) para obtener más detalles.
  </Callout>

* Para cada sistema monitoreado especificado, use la transacción `SM59` y el ID del sistema remoto para crear la **RFC Destination** y probar las conexiones. Consulte la [Crear destinos RFC para sistemas monitoreados](/docs/sap-solutions/additional-resources/additional-configuration/#create-rfc-for-monitored-systems) para obtener más detalles.
...
* Cerciorar de lo siguiente para monitorear la base de datos remota de HANA:
  ...
  * Para cada base de datos HANA remota, use la transacción `SAP DBACOCKPIT` para crear una conexión de base de datos. Consulte [Crear conexión de base de datos](/docs/sap-solutions/additional-resources/additional-configuration/#create-database-connection) para obtener detalles.
...
Las claves de servicio también se utilizan para crear [Destinos HTTP externos](/docs/sap-solutions/additional-resources/additional-configuration/#create-authentication-endpoint) y sirven como host de API para los proveedores de datos de API.