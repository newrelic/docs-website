...
Programe tres trabajos de recopilación de datos con variantes centradas en los siguientes grupos de proveedores de datos. Para obtener instrucciones sobre cómo programar trabajos del administrador de recopilación antes de `SP03`, consulte [Variantes y trabajos anteriores a SP03](/docs/sap-solutions/additional-resources/variants-and-jobs-before-sp03). Separe los proveedores de datos en tres grupos para la programación. Para obtener una lista completa de todos los proveedores de datos, consulte la [Referencia de proveedores de datos](/docs/sap-solutions/additional-resources/data-providers-reference).

* **TRACE**: En este grupo se encuentran los proveedores de datos relacionados con el rendimiento base de datos (STAD):

  * Incluye proveedores relacionados con la base de datos de rendimiento, como [`NR.SAP.TRANSACTION`](/docs/sap-solutions/additional-resources/data-providers-reference/#sap-appl-metrics) (proveedor de datos de rastreo), [`NR.SAP.TRANSACTION.COMPLETE`](/docs/sap-solutions/additional-resources/data-providers-reference/#sap-appl-metrics) (recopilación completa de la base de datos de rendimiento con proceso RFC en segundo plano paralelo), `NR.SAP.SYSTEM.PROCESS`, `NR_SAP_PROGRAM`, `NR_SAP_WORKLOAD_COMPLETE` y `NR.SAP.WORKLOAD.COMPLETE`.
...
* **IDOC**: En los sistemas de producción, la recopilación de IDOC puede tardar un tiempo significativo:
  * Incluye proveedores relacionados con IDOC, como [`NR_SAP_IDOC`](/docs/sap-solutions/additional-resources/data-providers-reference/#idoc-all) (proveedor de datos de eventos de estado principal de IDOC), [`NR_SAP_IDOC_COMPLETE`](/docs/sap-solutions/additional-resources/data-providers-reference/#idoc-all) (recuperación completa de IDOC con recopilación BG RFC) y `NR_SAP_IDOC_Configuration` (descarga de datos maestros de IDOC para mejorar el rendimiento del proveedor de datos de IDOC).

* **SISTEMA**: El resto de los proveedores de datos. Consulte la [lista completa por grupo de monitoreo](/docs/sap-solutions/additional-resources/data-providers-reference).
