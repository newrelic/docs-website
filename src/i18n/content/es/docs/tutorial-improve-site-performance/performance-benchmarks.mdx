...
<Steps>
  <Step>
    ...
    <DoNotTranslate>**SLIs for APM services instrumented with the New Relic agent**</DoNotTranslate>: Según `Transaction` evento, estos SLI son los más comunes para servicios basados en solicitudes:
    ...
    <DoNotTranslate>**SLIs for browser applications**</DoNotTranslate>: Los siguientes SLI se basan en los principales web Métricas de Google.
  ...
  <Step>
    Elija la entidad correspondiente para la que desea crear un nivel de servicio. Podría ser una carga de trabajo completa, un servicio específico, un monitor Sintético o incluso una transacción específica. Una vez que haya seleccionado su entidad, haga clic en <DoNotTranslate>**Continue**</DoNotTranslate> en el lado izquierdo del panel de la UI .
  </Step>
  ...
  <Step>
    ...
    Seleccione <DoNotTranslate>**Continue**</DoNotTranslate> en el panel izquierdo una vez que haya confirmado que su consulta es correcta.
  </Step>
</Steps>
