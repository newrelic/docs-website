...
## New Relic PHP v11.8.0.22

### Nueva característica

* hazaña(agente): Agregar instrumentación de AWS DynamoDB

### Seguridad

* seguridad (daemon): actualizar golang a la versión 1.24.2
* seguridad (daemon): bump golang.org\\/x\\/net de 0,36,0 a 0,38,0
