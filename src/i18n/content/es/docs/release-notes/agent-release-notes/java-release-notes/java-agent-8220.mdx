...
* Eliminar la instrumentación de MonoFlatMapMain para corregir posibles fugas de memoria por @deleonenriqueta en [2400](https://github.com/newrelic/newrelic-java-agent/pull/2400)
