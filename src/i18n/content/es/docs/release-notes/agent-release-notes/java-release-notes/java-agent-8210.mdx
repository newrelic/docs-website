...
Actualización de la versión de CSEC a 1.7.0 [2348](https://github.com/newrelic/newrelic-java-agent/pull/2348) Registro de cambios: [https://github.com/newrelic/csec-java-agent/releases/tag/1.7.0](https://github.com/newrelic/csec-java-agent/releases/tag/1.7.0)
