...
<Callout variant="important">
  ...
  Actualice al agente iOS de New Relic 7.5.8. Identificamos un error en la versión 7.5.7 del SDK de iOS que podría provocar un bloqueo al iniciar el agente, y se incluye una solución en el agente de New Relic para iOS 7.5.8. liberar.
</Callout>
