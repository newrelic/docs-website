...
**Requisitos previos:** configuración activa de Autopilot, seguimiento de cambios configurado con los SHA de los commits que fluyen hacia New Relic, acceso de administrador de la organización de GitHub para crear un PAT detallado y acceso de administrador de la organización de New Relic.