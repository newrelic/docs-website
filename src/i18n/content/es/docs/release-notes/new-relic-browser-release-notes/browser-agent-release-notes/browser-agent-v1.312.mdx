...
#### .at causa problemas en navegadores más antiguos

.at() no se está transpilando correctamente y está causando problemas de inicialización, se cambió a indexación.
...
De acuerdo con nuestra [política de compatibilidad de navegadores](https://docs.newrelic.com/docs/browser/new-relic-browser/getting-started/compatibility-requirements-browser-monitoring/#browser-types), la v1.312.1 del agente de Browser se creó y probó para estos navegadores y rangos de versiones: Chrome 136-146, Edge 136-146, Safari 18-26 y Firefox 138-148. Para dispositivos móviles, la v1.312.1 se compiló y probó para Android OS 16 e iOS Safari 18-26.2.