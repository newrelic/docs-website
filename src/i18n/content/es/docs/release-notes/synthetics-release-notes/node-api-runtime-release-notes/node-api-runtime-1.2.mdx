...
* **Monitores de API con script**: se actualizó la ejecución del script para que se ejecute en un contexto aislado, lo que evita que los script recorran la cadena de prototipos de JavaScript para acceder a objetos y funciones restringidos por el sandbox.
