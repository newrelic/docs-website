...
* Si actualmente está empleando la versión más reciente de Ping Runtime 1.51.0, Le recomendamos que actualice Sintéticos Kevin a la versión release-443 o superior o la más reciente para garantizar la seguridad y estabilidad de su entorno.