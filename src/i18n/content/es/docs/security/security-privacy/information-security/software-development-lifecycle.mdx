---
title: Software seguro ciclo de vida de desarrollo
tags:
  - Security
...
El código de implementación es monitoreado por las partes interesadas y el ingeniero del producto para continuar con el proceso de desarrollo iterativo. El equipo de seguridad continúa evaluando la seguridad del código de implementación mediante la realización de análisis de seguridad periódicos, pruebas de penetración de terceros y mediante el [proceso de divulgación coordinada](/docs/security/new-relic-security/data-privacy/reporting-security-vulnerabilities).