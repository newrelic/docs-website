...
<DoNotTranslate>**Versions affected:**</DoNotTranslate> Todas las versiones del agente entre (a) 4.12.0 y 6.5.1; y (b) 7.0.0 y 7.4.1

<DoNotTranslate>**Fix versions:**</DoNotTranslate> 6.5.2, 6.5.3, 6.5.4, 7.4.2, 7.4.3 y 7.5.0
...
<DoNotTranslate>**Note:**</DoNotTranslate> Esta solución alternativa se recomienda solo como solución temporal hasta que pueda actualizar la versión de su agente.
...
<CollapserGroup>
  ...
  >
    La información de la versión del agente se muestra en la <DoNotTranslate>**Environment**</DoNotTranslate> página dentro de New Relic su dashboard One. Consulte nuestra [página de documentos](/docs/apm/agents/manage-apm-agents/troubleshooting/get-environment-data-about-your-apm-app) para obtener más información.
  </Collapser>
