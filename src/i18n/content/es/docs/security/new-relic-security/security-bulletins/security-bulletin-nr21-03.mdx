...
<CollapserGroup>
  <Collapser id="upgrade-options" title="¿Cuáles son nuestras opciones si no podemos actualizar nuestro agente de Java o versión de Java?">
    Implemente la [solución alternativa recomendada en este boletín](#action).
  </Collapser>

  <Collapser id="versions" title="¿Cómo puedo saber qué versiones del agente estamos ejecutando?">
  ...
  <Collapser id="patch-v5" title="¿Por qué no hay un parche para el agente v5 e inferiores?">
  ...
  <Collapser id="update-742" title="Ya actualicé a 6.5.1 o 7.4.1, ¿tengo que actualizar nuevamente?">
