---
title: Boletín de Seguridad NR19-05
tags:
  - Security
...
* Utilice consulta parametrizada, esto también ayuda a prevenir [vulnerabilidades de inyección SQL](https://docs.microsoft.com/en-us/sql/relational-databases/security/sql-injection).
