...
* [Foro de soporte New Relic](https://support.newrelic.com/s/hubtopic/aAX8W0000008ckb/log4j-zero-day-vulnerability-and-the-new-relic-java-agent)

## Preguntas frecuentes [#faq]

<CollapserGroup>
  <Collapser id="357-update" title="He actualizado a llamadas por minuto 3.0.55 ya. ¿Necesito actualizar a 3.0.58?">
