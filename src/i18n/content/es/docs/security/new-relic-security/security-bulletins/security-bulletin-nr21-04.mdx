---
title: Apache Log4j vulnerabilidades críticas CVE-2021-44228 - llamadas por minuto
tags:
  - Security
...
Este paso remediará su minion privado en contenedores New Relic (llamadas por minuto) únicamente. Es posible que también necesites actualizar tu agente de Java New Relic . Consulte [NR21-03](/docs/security/new-relic-security/security-bulletins/security-bulletin-nr21-03) para obtener más información.
...
<CollapserGroup>
  <Collapser
    id="357-update"
    title="He actualizado a llamadas por minuto 3.0.55 ya. ¿Necesito actualizar a 3.0.58?"
  >
    La Fundación Apache ha revelado vulnerabilidades adicionales en framework log4j (CVE-2021-45046 y CVE-2021-45105) y advierte que log4j v2.16.0 no es una protección suficiente contra la explotación. llamadas por minuto 3.0.58 y las versiones posteriores son las únicas versiones de llamadas por minuto disponibles con log4j 2.17.0.
  </Collapser>
</CollapserGroup>
