...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile > (select an app) > Summary**</DoNotTranslate>: vea datos de Unity, realice un seguimiento de las solicitudes y errores HTTP y monitor el rendimiento de su aplicación a lo largo del tiempo.
</figcaption>
...
<Steps>
  ...
  <Step>
    ...
    2. Agrega el token a tu proyecto de Unity:
       ...
       2. Vaya a <DoNotTranslate>**Tools > New Relic > Getting Started**</DoNotTranslate> para abrir la ventana del editor.
  ...
  <Step>
    ...
    1. En su IDE de Unity, vaya a <DoNotTranslate>**Assets**</DoNotTranslate> y abra <DoNotTranslate>**External Dependency Manager**</DoNotTranslate>.

    2. Haga clic en <DoNotTranslate>**iOS Resolver**</DoNotTranslate>.
