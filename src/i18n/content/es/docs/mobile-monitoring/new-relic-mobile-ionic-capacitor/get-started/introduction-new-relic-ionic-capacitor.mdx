...
<Steps>
  ...
  <Step>
    ...
    2. Agregue los siguientes cambios para aplicar el complemento Gradle Pplugin:
    ...
    O, si su proyecto emplea la forma tradicional de aplicar el complemento, agregue este fragmento:
