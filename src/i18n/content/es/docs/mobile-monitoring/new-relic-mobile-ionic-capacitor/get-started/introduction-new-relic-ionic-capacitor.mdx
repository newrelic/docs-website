---
title: Monitor la aplicación móvil de su condensador iónico
tags:
  - Mobile monitoring
...
<Steps>
  <Step>
    ...
    1. Vaya a
       ...
       <DoNotTranslate>**[one.newrelic.com](https://onenr.io/0EjOpynz0Q6) > Browser & Mobile > (choose Android or iOS)**</DoNotTranslate>

       y luego complete los pasos de instrumentación en la UI.

    2. Desde

       <DoNotTranslate>**Step 4**</DoNotTranslate>

       en la UI, copie los token de la aplicación (uno para iOS y Android, si corresponde).
  </Step>
  ...
  <Step>
    ...
    5. Para vincular automáticamente el paquete, reconstruya su proyecto:
...
<CollapserGroup>
  <Collapser
    id="v1.2.0"
    title="Capacitor agente v1.2.0 y superior"
  >
  ...
  <Collapser
    id=" v1.1.1"
    title="Capacitor agente v1.1.1 y anteriores"
  >
    ...
    2. Haga clic en <DoNotTranslate>**Query builder**</DoNotTranslate>.
    ...
    4. Haga clic en <DoNotTranslate>**Add to dashboard**</DoNotTranslate>.<img title="Query builder" alt="This is an image of a sample query in the Query builder." src={mobileQueryExample}/>

       <figcaption>
         <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Query builder**</DoNotTranslate>: Utilice <DoNotTranslate>**Query builder**</DoNotTranslate> para crear un panel personalizado para rastrear errores de JavaScript desde su aplicación Capacitor.
       </figcaption>
