...
<CollapserGroup>
  ...
  <Collapser id=" v1.1.1" title="Capacitor agente v1.1.1 y anteriores">
    El agente Capacitor crea eventos personalizados para errores de JavaScript y los informa a New Relic. En la UI, puede realizar un seguimiento de estos eventos de error de JavaScript con un panel personalizado.
    ...
    4. Haga clic en <DNT>**Add to dashboard**</DNT>.
       ...
       <figcaption>
         <DNT>**[one.newrelic.com](https://one.newrelic.com/all-capabilities) &amp;gt; Query builder**</DNT>: Utilice <DNT>**Query builder**</DNT> para crear un panel personalizado para rastrear errores de JavaScript desde su aplicación Capacitor.
       </figcaption>
