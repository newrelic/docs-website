...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Especifique qué tipos de compilación de variantes deben reportar los mapas de ProGuard a New Relic. Para las aplicaciones de React Native, esto también controla qué tipos de compilación de variantes cargan automáticamente el mapa de origen de JavaScript. Por defecto: `Release`
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Establezca en `false` para deshabilitar la instrumentación de webview.

        * Por defecto: `true`

        Compatible cuando se usa con el agente de Android v7.6.15 y versiones posteriores.
      </td>
    </tr>
  </tbody>
</table>
...
<CollapserGroup>
  ...
  <Collapser id="app-level" title="Habilitar cargas de mapas para múltiples variantes">
    Se pueden especificar varios tipos de compilación, separados por comas. Para las aplicaciones de React Native, agregar `Debug` aquí también habilita la carga automática del mapa de origen de JavaScript para las compilaciones de depuración:
  ...
  <Collapser id="app-level" title="Deshabilitar la instrumentación de Webview">
    Para deshabilitar la instrumentación de webview
