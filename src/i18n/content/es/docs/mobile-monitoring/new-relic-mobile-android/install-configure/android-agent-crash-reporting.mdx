...
* Si ve informes de fallos ofuscados en la [página<DNT>**Crashes**</DNT> ](/docs/mobile-monitoring/mobile-monitoring-ui/crashes/mobile-apps-crashes-dashboard), es posible que no haya subido ningún archivo `mapping.txt` .
