...
1. Vaya a
   ...
   <DoNotTranslate>**> More views > Interactions**</DoNotTranslate>
...
Para mostrar la lista completa de todos los métodos instrumentados: Desde la interacción seleccionada, seleccione el enlace <DoNotTranslate>**Breakdown table**</DoNotTranslate> . Si utiliza instrumentación personalizada para cualquiera de las métricas, la categoría para la clase y el nombre del método indicará <DoNotTranslate>**custom**</DoNotTranslate>.
...
1. Vaya a
   ...
   <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile > (select an app) > App > Interactions**</DoNotTranslate>

   .

2. En la tabla

   <DoNotTranslate>**Slowest traces**</DoNotTranslate>
...
* Para ayudar a proporcionar contexto para los datos, haga clic en

  <DoNotTranslate>**Previous interaction**</DoNotTranslate>
