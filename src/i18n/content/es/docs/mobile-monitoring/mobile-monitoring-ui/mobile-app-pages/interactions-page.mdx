...
1. Vaya a
   ...
   <DNT>**> More views > Interactions**</DNT>
...
1. Vaya a
   ...
   <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile > (select an app) > App > Interactions**</DNT>

   .

2. En la tabla

   <DNT>**Slowest traces**</DNT>
