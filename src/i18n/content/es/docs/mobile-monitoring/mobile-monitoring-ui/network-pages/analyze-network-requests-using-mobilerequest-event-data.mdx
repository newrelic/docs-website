...
## Permitir `MobileRequest` [#enable-mobilerequest]
...
<CollapserGroup>
  <Collapser id="enable-for-android" title="Habilitar para Android">
  ...
  <Collapser id="enable-for-ios" title="Habilitar para iOS">
