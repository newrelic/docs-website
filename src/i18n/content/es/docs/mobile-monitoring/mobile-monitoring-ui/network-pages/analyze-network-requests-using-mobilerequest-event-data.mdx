...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        La página <DoNotTranslate>**HTTP requests**</DoNotTranslate> incluye gráficos para sus 20 dominios principales por tiempo de respuesta y rendimiento promedio.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        La página <DoNotTranslate>**HTTP errors**</DoNotTranslate> le ayuda a comprender mejor los errores HTTP y los fallos de red asociados con su aplicación móvil y a conectar los errores con los servicios que están causando problemas.
      </td>
    </tr>
  </tbody>
</table>