...
1. Vaya a
   ...
   . Luego busque su aplicación y haga clic en
...
3. En la [página](/docs/mobile-monitoring/mobile-monitoring-ui/crashes/investigate-mobile-app-crash-report#viewing)
   ...
   [ ](/docs/mobile-monitoring/mobile-monitoring-ui/crashes/investigate-mobile-app-crash-report#viewing)del informe de fallos seleccionado, busque el `App Image Uuid` en la lista de atributos.
...
2. Busque el UUID de compilación en la [sección](#binary-example)

   <DoNotTranslate>[**Binary images**](#binary-example)</DoNotTranslate>

   [ ](#binary-example)del informe de fallos exportado.
...
A continuación se muestra un ejemplo de la sección <DoNotTranslate>**Binary images**</DoNotTranslate> de un informe de fallos exportado. Esta sección enumera el UUID de compilación para cada biblioteca vinculada dinámicamente incluida en la aplicación, así como el UUID de compilación para la aplicación principal.
