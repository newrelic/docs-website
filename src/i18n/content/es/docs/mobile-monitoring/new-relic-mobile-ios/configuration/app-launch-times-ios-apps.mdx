...
Con el agente iOS, puede informar el tiempo de lanzamiento de la aplicación, también conocido como "tiempo frío" y "tiempo caliente" (no se informan los tiempos cálidos y precalentados). De forma predeterminada, los tiempos de lanzamiento de la aplicación se recopilan con el indicador de característica [`NRFeatureFlag_AppStartMetrics`](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/configure-settings/#applaunchtime).
