...
* <DoNotTranslate>**Banner notification**</DoNotTranslate>: Aparece un banner de advertencia en la [página<DoNotTranslate>**Crash report**</DoNotTranslate> ](/docs/mobile-monitoring/mobile-monitoring-ui/crashes/mobile-apps-crash-report-dashboard). La advertencia dice:

  ```
  We were unable to locate your dsym.
  ```

* <DoNotTranslate>**Upload prompt**</DoNotTranslate>: desde la página <DoNotTranslate>**Crash type summary**</DoNotTranslate> se le indicará automáticamente que [cargue un archivo dSYM](/docs/mobile-monitoring/new-relic-mobile-ios/install-configure/upload-dsyms-bitcode-apps#mobile-ui) si falta.

* <DoNotTranslate>**Machine code**</DoNotTranslate>: El rastreo del bloqueo de la pila en la página <DoNotTranslate>**Crash report**</DoNotTranslate> muestra código de máquina y no un mensaje de error legible por humanos.
...
Utilice la [versión de la aplicación y el número de compilación](#identifyingAppVersion) para identificar el archivo de la aplicación correspondiente en Xcode <DoNotTranslate>**Organizer**</DoNotTranslate> y descargue los dSYM.
...
<figcaption>
  <DoNotTranslate>**Using Xcode to download dSYMs:**</DoNotTranslate> En la pestaña <DoNotTranslate>**Archives**</DoNotTranslate> , seleccione la aplicación y la versión/compilación y luego seleccione <DoNotTranslate>**Download dSYMs**</DoNotTranslate>.
</figcaption>
