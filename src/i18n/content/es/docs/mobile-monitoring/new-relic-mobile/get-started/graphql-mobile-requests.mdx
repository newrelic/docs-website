...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile > (select an app) > HTTP requests**</DoNotTranslate>: vea sus solicitudes de GraphQL según el nombre personalizado de su función.
</figcaption>
