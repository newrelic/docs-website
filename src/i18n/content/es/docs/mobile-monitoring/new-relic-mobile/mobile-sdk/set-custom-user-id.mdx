...
<Tabs>
  ...
  <TabsPages>
    <TabsPageItem id="android">
      ...
      Un identificador de usuario es útil por varias razones. Con la [UIde análisis de fallos](/docs/mobile-monitoring/mobile-monitoring-ui/crashes/crash-analysis-group-filter-your-crashes), puede:
