  ...
  <TabsPages>
    ...
    <TabsPageItem id="xamarin">
      <Callout variant="important">
        ...
        Para obtener detalles sobre cómo agregar indicadores de características, consulte [Configurar los ajustes de monitoreo de móviles](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/configure-settings/#xamarin).
      </Callout>
