...
<Tabs>
  ...
  <TabsPages>
      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td>
              Requerido. El tipo de evento. <DoNotTranslate>**Do not**</DoNotTranslate> utiliza `$eventType` para nombrar tu evento personalizado. En su lugar, utilice un atributo personalizado o el `name` opcional.
            </td>
          </tr>
    ...
    <TabsPageItem id="ios">
      ...
      * Utilice la palabra clave `name` para mostrar su evento en la [UIde monitoreo de móviles](/docs/mobile-monitoring/mobile-monitoring-ui/mobile-app-pages/mobile-apps-index). Para crear un nombre útil, puedes combinar varios atributos. Usar el parámetro `name` tiene el mismo efecto que agregar una clave `name` en el diccionario de atributos.
