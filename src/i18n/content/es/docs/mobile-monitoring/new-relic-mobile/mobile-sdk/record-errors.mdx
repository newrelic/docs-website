...
<Tabs>
  ...
  <TabsPages>
    <TabsPageItem id="ios">
      ...
      Esta API toma una instancia de un error y un diccionario de atributos opcional, luego crea un evento `recordHandledException` . Puede ver los datos del evento en laUI <InlinePopover type="mobile"/>en lugares como la [página<DoNotTranslate>**Handled exceptions**</DoNotTranslate> ](/docs/mobile-monitoring/mobile-monitoring-ui/crashes/handled-exceptions-analyze-trends-prevent-crashes)y la [ruta<DoNotTranslate>**Crash events**</DoNotTranslate> ](/docs/mobile-monitoring/mobile-monitoring-ui/crashes/mobile-crash-event-trail). También puede consultar estos datos con NRQL y registrarlos en el panel de New Relic.
    ...
    <TabsPageItem id="capacitor">
      ...
      Registra errores de JavaScript/TypeScript para el condensador iónico. Asegúrese de agregar este método al controlador de errores global de su framework.
