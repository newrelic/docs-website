      ...
      * Cambie la configuración como parte de la llamada de inicio del agente utilizando el método `.with` . Por ejemplo:
      ...
      <table>
        ...
        <tbody>
          <tr>
            <td>
              Habilitar o deshabilitar los reportes en segundo plano cuando la aplicación pasa al estado de segundo plano. Cuando está habilitado, el agente informa los datos capturados mientras la aplicación está en segundo plano y el [atributo`background` ](/attribute-dictionary/?event=MobileSession&attribute=background)se agrega al atributo de sesión.
            </td>
      ...
      <table>
        ...
        <tbody>
          <tr>
            <td>
              Habilite o deshabilite la persistencia de eventos, lo que permite al agente capturar eventos durante escenarios de cierre forzado y salida de procesos.
            </td>

            <td>
              La persistencia de eventos está habilitada de forma predeterminada. Para deshabilitarla, agregue la siguiente marca de característica:
      ...
      * Swift:
      ...
      <table>
        ...
        <tbody>
          <tr>
            <td>
              Habilite o deshabilite el almacenamiento de datos sin conexión cuando no haya una conexión a Internet disponible. Cuando se agrega un evento mientras la aplicación no tiene acceso a internet, se agrega un [atributo`offline` ](/attribute-dictionary/?event=MobileSession&attribute=offline)al evento. Para configurar la cantidad de almacenamiento offline, consulte [Establecer el tamaño máximo de almacenamiento offline](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/set-max-offline-storage/#ios).
            </td>
    ...
    <TabsPageItem id="react">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td>
              Habilite o deshabilite el informe automático de errores de JavaScript como [eventos`MobileJSError` ](/attribute-dictionary/?event=MobileJSError). Cuando está habilitado, el agente captura los errores de JavaScript no controlados y los informa sin ninguna instrumentación adicional.

              El valor predeterminado es `true`. Disponible para el agente React Native versión 1.9.0 o superior.
            </td>
