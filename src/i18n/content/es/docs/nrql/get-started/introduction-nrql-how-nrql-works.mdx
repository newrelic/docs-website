...
Otra excelente manera de explorar sus datos es ingresar a cualquier panel existente que tenga, hacer clic en <DNT>**View query**</DNT> y ejecutar su gráfico en el generador de consultas.<img title="new-relic-view-chart-nrql-query.png" alt="New Relic view chart NRQL query" src={queriesnrqlViewQueryforChart}/>
