...
<CollapserGroup>
  ...
  >
    ...
    Con la cláusula `PREDICT` , puede agregar predicciones de tendencias de datos futuras en gráficos de líneas basados en datos históricos. Tenga en cuenta los siguientes puntos al emplear esta cláusula:
