...
<CollapserGroup>
  ...
  >
    ...
    <CollapserGroup>
      <Collapser title={<>Consulta usando <InlineCode>
          LIMIT
        </InlineCode></>}>
...
<CollapserGroup>
  ...
  >
    ...
    <CollapserGroup>
      <Collapser title={<>Usando <InlineCode>
          tuple
        </InlineCode></>}>
  ...
  >
    ...
    * 'base64url': utiliza el [estándar RFC4648 base-64 con URL y alfabeto seguro para nombres de archivos](https://datatracker.ietf.org/doc/html/rfc4648#section-5)
      ...
      <CollapserGroup>
        ...
        <Collapser title={<>Usar <InlineCode>
            decode()
  ...
  >
    ...
    * falseValue: este valor opcional se devuelve si la expresión booleana es falsa o, si no se proporciona NULL, se devuelve
      ...
      <CollapserGroup>
        ...
        <Collapser title={<>Usar con <InlineCode>
            AND
        ...
        <Collapser title={<>Anidado <InlineCode>
            If()
          </InlineCode></>}>
  ...
  >
    ...
    * str: el valor de la cadena que se escribirá en minúsculas
      ...
      * Si este argumento se evalúa como nulo, la función `lower()` devolverá nulo.
      ...
      _Función relacionada: [<InlineCode>
  ...
  >
    ...
    * length: la longitud, o número de caracteres, de la subcadena que se extraerá de str.
      ...
      * _Opcional_ : si no se proporciona la longitud, se incluirán todos los caracteres de str después de la posición inicial resuelta.
      ...
      _Consulte la función [<InlineCode>
      position()
    ...
    * zona horaria: un valor de zona horaria opcional que se utiliza para interpretar la cadena de fecha y hora (ej. UTC).
      ...
      * Debe ser un valor de cadena constante y su valor predeterminado será UTC o el valor proporcionado en `WITH TIMEZONE` si está disponible.
      ...
      <CollapserGroup>
        ...
        <Collapser title={<>Traducir una timestamp usando la zona horaria en la cláusula <InlineCode>
            WITH TIMEZONE
          </InlineCode></>}>
    ...
    * zona horaria: un valor de zona horaria opcional que se utiliza para interpretar el parámetro de cadena de fecha (ej. hora del Pacífico).
      ...
      * Debe ser un valor de cadena constante y su valor predeterminado será UTC o el valor proporcionado en `WITH TIMEZONE` si está disponible.
            ...
            <tbody>
              ...
              <tr>
                ...
                <td rowspan="3">
                  ...
                  Nota: Dentro de la cadena de fecha y hora AM/PM debe estar en mayúsculas.
                </td>
      ...
      <CollapserGroup>
        ...
        <Collapser title={<>Analizar una cadena de fecha y hora utilizando la zona horaria en la cláusula <InlineCode>
            WITH TIMEZONE
          </InlineCode></>}>
