...
<CollapserGroup>
  ...
  >
    ...
    * No admite [datos de intervalo de tiempo de métrica](/docs/data-analysis/metrics/analyze-your-metrics/data-collection-metric-timeslice-event-data#timeslice-data) mientras se encuentra en Vista previa pública.
    ...
    Para obtener más información sobre el comportamiento predeterminado del modelo de predicción, consulte [Predicciones NRQL](/docs/query-your-data/explore-query-data/use-charts/nrql-predictions/#defaults). Puede personalizar las predicciones configurando manualmente los hiperparámetros del modelo de entrenamiento y agregando las palabras clave `USING` y `BY` .
