...
Con NRQL, puede ejecutar un <DoNotTranslate>**subquery**</DoNotTranslate>, que es una consulta anidada dentro de otra consulta. Una subconsulta es una consulta anidada dentro de otra consulta: le permiten utilizar el resultado de una consulta en otra consulta. Con subconsultas, puedes:
...
* Las subconsultas no son compatibles con la condición de alerta NRQL. Debido a que las consultas con subconsultas requieren realizar múltiples pases sobre los datos, las subconsultas son incompatibles con las alertas de transmisión.
