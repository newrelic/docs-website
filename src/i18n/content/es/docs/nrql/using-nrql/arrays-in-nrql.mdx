...
<CollapserGroup>
  ...
  >
    ...
    <DoNotTranslate>**Example:**</DoNotTranslate> Considere una matriz simple, `[100, 110, 90, 100, 105]`, almacenada en un atributo de duración.

    `getfield(durations, 2)` devolverá `90`.

    Puede utilizar la abreviatura de corchetes `[ ]` en lugar de la función `getfield()`.

    <DoNotTranslate>**Example:**</DoNotTranslate> `durations[4]` devolverá `105`.
  </Collapser>
  ...
  >
    ...
    <DoNotTranslate>**Example:**</DoNotTranslate> Considere una matriz simple, `countries`, con el valor `["US", "CA", "UK"]`.
