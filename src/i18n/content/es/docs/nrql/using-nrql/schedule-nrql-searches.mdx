...
* **Permisos de usuario**: Se requieren permisos de [Automatización de flujo de trabajo](/docs/workflow-automation/create-a-workflow-automation/managing-workflow/#before-you-begin) para crear y administrar búsquedas programadas.
...
* [Explore la automatización de flujos de trabajo](/docs/alerts/get-notified/alert-event-workflows) para posibilidades de automatización más avanzadas.