...
<Callout variant="important">
  ...
  Puntos de datos de métricas sin procesar que:

  * Comenzar antes de `SINCE '2023-12-20T00:04Z'` y finalizar dentro de la ventana de tiempo
  * Comenzar dentro de la ventana de tiempo y terminar después `UNTIL '2023-12-22T00:03Z'`

  ambos serán ignorados al procesar la consulta.
</Callout>
