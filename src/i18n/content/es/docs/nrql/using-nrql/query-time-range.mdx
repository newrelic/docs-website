...
<Callout variant="important">
  Las consultas de [puntos de datos de métricas sin procesar](/docs/data-apis/understand-data/metric-data/query-metric-data-type) no ajustan el rango de tiempo y pueden excluir los puntos de datos de los límites.
  ...
  Que se incluya un punto de datos sin procesar depende de su **hora de inicio**, no de su hora de finalización:

  * Un punto de datos que comienza dentro de la ventana se incluye, incluso si termina después de `UNTIL '2023-12-22T00:03Z'`.
  * Un punto de datos que comienza antes de `SINCE '2023-12-20T00:04Z'` se excluye, incluso si termina dentro de la ventana.
</Callout>
