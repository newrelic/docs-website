...
이는 다양한 제품(예: APM, 브라우저 모니터링, 인프라 모니터링 등)으로 청구되는 [가격 모델인 원래 가격](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-pricing-models/) 모델을 사용하는 New Relic 조직에 영향을 미칩니다.
