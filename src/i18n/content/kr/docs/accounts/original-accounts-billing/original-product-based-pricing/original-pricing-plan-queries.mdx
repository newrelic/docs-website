...
* UI에서 [쿼리 빌더를](/docs/query-your-data/explore-query-data/query-builder/introduction-query-builder) 사용하여 쿼리하면 특정 계정 및 모든 하위 계정에서 쿼리됩니다. [계정 간 쿼리에 NerdGraph를 사용할](/docs/apis/nerdgraph/examples/nerdgraph-nrql-tutorial/#cross-account-query)수도 있습니다.
