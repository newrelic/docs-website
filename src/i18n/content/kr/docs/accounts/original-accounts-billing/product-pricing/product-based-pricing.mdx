...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities)** 에서 [계정 드롭다운](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#account-dropdown) 을 선택합니다.
