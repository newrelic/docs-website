...
<CollapserGroup>
  ...
  >
    ...
    * <InlinePopover type="apm"/>
      ...
      (CU 기반 가격 또는 [호스트 기반 가격](#host-based)중 선택)
  ...
  >
    ...
    New Relic <InlinePopover type="apm"/>호스트 기반 가격과 [CU 기반 가격](#compute-unit)중에서 선택할 수 있습니다. 자체 데이터 센터에서 관리하는 호스트로 구성된 정적 환경이 주로 있는 경우 호스트 기반 요금이 이상적입니다.
...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities)** 에서 [사용자 메뉴](/docs/accounts/accounts-billing/general-account-settings/intro-account-settings) 를 선택합니다.
...
다음은 New Relic 사용자 인터페이스의 [사용자 메뉴](/docs/accounts/accounts-billing/general-account-settings/intro-account-settings) 에서 사용할 수 있는 옵션에 대한 요약입니다.
