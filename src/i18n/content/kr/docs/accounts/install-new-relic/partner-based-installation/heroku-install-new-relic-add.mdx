...
<CollapserGroup>
  <Collapser id="heroku-java" title="자바">
  ...
  <Collapser id="heroku-nodejs" title="노드.js">
  ...
  <Collapser id="heroku-python" title="파이썬">
  ...
  <Collapser id="heroku-ruby" title="루비">
...
<CollapserGroup>
  <Collapser id="heroku-add-on-license-key" title="라이센스 키">
  ...
  <Collapser id="heroku-add-on-account-url" title="계정 URL">
  ...
  <Collapser id="heroku-add-on-account" title="계정 ID">
...
<CollapserGroup>
  <Collapser id="heroku-add-on-login" title="Heroku를 통해 New Relic 애드온 계정에 로그인">
  ...
  <Collapser id="regular-login" title="일반 New Relic 계정에 로그인">
