...
[Heroku](https://devcenter.heroku.com/articles/newrelic) 는 다양한 에이전트 언어로 웹 애플리케이션을 호스팅하기 위한 PaaS(Platform as a Service) 솔루션입니다. New Relic을 사용하면 다음과 같은 모니터링 솔루션의 측정항목을 사용하여 Heroku를 확장할 수 있습니다. <InlinePopover type="apm"/>그리고 <InlinePopover type="browser"/>. New Relic 애드온은 Java, Node.js, PHP, Python, Ruby.
