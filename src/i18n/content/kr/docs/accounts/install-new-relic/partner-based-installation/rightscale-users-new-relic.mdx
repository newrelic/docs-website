...
![화면 실행 script.png](./images/screen-run-script.png "화면 실행 script.png")
...
![화면 nr 오른쪽 크기 applist.png](./images/screen-nr-rightscale-applist.png "화면 nr 오른쪽 크기 applist.png")
