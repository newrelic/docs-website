...
3. 지정된 그룹에 사용자 추가: 코어 또는 풀 플랫폼 사용자 유형의 사용자는 Tenant Manager 역할을 할당하는 조직 범위의 [액세스 권한 부여](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts/#access-grants) 가 있는 그룹에 추가되어야 합니다.
...
<DocTiles>
  <DocTile title="1단계" path="/docs/accounts/accounts-billing/account-structure/multi-tenancy/org-creation">
    계정 및 조직 생성
  </DocTile>

  <DocTile title="2단계" path="/docs/accounts/accounts-billing/account-structure/multi-tenancy/delegated-administration">
    사용자 및 액세스 관리
  </DocTile>

  <DocTile title="3단계" path="/docs/accounts/accounts-billing/account-structure/multi-tenancy/share-accounts">
    계정 공유(선택 사항)
  </DocTile>
</DocTiles>