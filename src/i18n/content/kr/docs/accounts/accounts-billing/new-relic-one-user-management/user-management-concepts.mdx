...
뉴렐릭은 기본적으로 사용 가능하고 일반적인 사용자 관리 사용 사례를 충족하는 여러 표준 역할(<DNT>**standard roles**</DNT> )을 제공합니다.
...
그룹에 다양한 관리 설정(<DNT>**Administration settings**</DNT> )을 추가할 수 있습니다. 기본 사용자는 이 설정을 사용할 수 없습니다.
