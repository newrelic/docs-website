...
<Steps>
  ...
  <Step>
    ...
    <CollapserGroup>
      ...
      >
        그룹에 액세스를 추가하기 전에 [사용자 관리 개념을](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts#understand-concepts) 잘 이해하고 추가하려는 액세스에 대한 좋은 계획이 있는지 확인하십시오.
