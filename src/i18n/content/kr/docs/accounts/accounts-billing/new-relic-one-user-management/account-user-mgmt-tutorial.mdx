...
기존 액세스 권한을 보려면 [계정 드롭다운](/docs/using-new-relic/welcome-new-relic/get-started/glossary#account-dropdown) 에서 **관리** 를 클릭한 다음 **액세스 관리** 를 클릭합니다. 액세스 권한을 생성하지 않은 경우에도 기본 생성 그룹과 해당 그룹의 액세스 권한이 표시됩니다. (이에 대한 자세한 내용은 [1단계](#create-organization) 로 돌아가십시오).
...
<CollapserGroup>
  ...
  >
    ...
    1. **액세스 관리 **UI에서 **액세스 권한 부여 및 그룹 **을 클릭합니다.
