...
**인증 도메인은** [프로비저닝(추가 및 업데이트) 방법](#source-users) 과 [인증(로그인) 방법](#authentication) 과 같은 동일한 사용자 관리 설정으로 관리되는 New Relic 사용자 그룹입니다.
...
<CollapserGroup>
  ...
  >
    ...
    현재 [Okta](/docs/accounts/accounts/automated-user-management/okta-scimsso-application-configuration) 및 [Azure](https://forum.newrelic.com/s/hubtopic/aAX8W0000008d6MWAQ/relic-solution-make-full-core-basic-users-in-azure-active-directory-w-scim) 에 대한 지침이 있습니다. 다른 ID 공급자 서비스의 경우 [SCIM API 사용자 유형 사양을](/docs/accounts/accounts/automated-user-management/tutorial-manage-users-groups-scim/#manage-user-type) 사용하여 사용자 유형 정보를 보내도록 ID 공급자를 구성할 수 있습니다.
