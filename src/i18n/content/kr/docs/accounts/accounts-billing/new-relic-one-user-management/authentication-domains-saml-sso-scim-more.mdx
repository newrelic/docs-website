...
**Authentication Domain UI** \[인증 도메인 UI] 에서 사용자 프로비저닝 방법으로 SCIM을 선택한 경우 사용자의 [사용자 유형을](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type) 관리하는 방법에 대한 두 가지 옵션이 있습니다.
