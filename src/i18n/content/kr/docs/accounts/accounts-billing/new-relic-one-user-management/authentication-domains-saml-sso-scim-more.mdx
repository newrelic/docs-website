...
<CollapserGroup>
  ...
  <Collapser id="manage-user-type-scim" title="SCIM으로 사용자 유형 관리">
    ...
    * Azure Active Directory: [여기에서](https://support.newrelic.com/s/hubtopic/aAX8W0000008d6MWAQ/relic-solution-make-full-core-basic-users-in-azure-active-directory-w-scim) 사용자 유형을 사용하여 SCIM용 Azure AD를 구성하는 방법에 대한 뉴웰릭 포럼 토론을 참조하세요.
