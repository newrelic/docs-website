...
인증 도메인은 [New Relic One 사용자 모델](/docs/accounts/accounts-billing/new-relic-one-pricing-users/users-roles) 의 사용자를 관리하기 위한 것입니다. 사용자가 원래 사용자 모델을 사용하는 경우 [원래 계정](/docs/accounts/original-accounts-billing/original-users-roles/original-account-structure) 을 참조하십시오.
...
* 인증 도메인을 보거나 편집하려면 사용자는 다음을 수행해야 합니다.
  ...
  * [**인증 도메인 관리자** 역할](/docs/accounts/accounts-billing/new-relic-one-pricing-users/users-roles#standard-roles) 이 있는 그룹에 속해 있어야 합니다.
...
<CollapserGroup>
  ...
  >
    ...
    * 사용자 유형 업그레이드 요청을 처리하는 방법을 관리하는 기능. 이러한 옵션에는 다음이 포함됩니다.
      ...
      * **검토 필요** : 이 옵션을 사용하면 관리자( [**인증 도메인 관리자** 역할](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts/#standard-roles) 이 있는 사용자)는 사용자가 업그레이드를 요청할 때 이메일을 수신하고 [**사용자 관리** UI](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-ui-and-tasks#where) 에서 해당 요청을 승인하거나 거부할 수 있습니다.
  </Collapser>
