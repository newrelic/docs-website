...
* 이를 구성하려면 **Organization settings**\[조직 설정] [관리자 설정이](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts/#admin-settings)필요합니다.
