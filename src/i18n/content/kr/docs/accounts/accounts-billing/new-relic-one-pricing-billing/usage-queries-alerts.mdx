...
[사용량 UI는](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/billing-ui) 시간 경과에 따른 데이터 수집을 표시합니다. UI가 제공하는 것보다 더 자세한 정보가 필요한 경우 다음과 같은 [NRQL](/docs/query-data/nrql-new-relic-query-language/getting-started/introduction-nrql) 쿼리를 사용할 수 있습니다.
