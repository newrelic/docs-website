...
New Relic이 현재 SSO 통합을 지원하는 SAML 서비스 공급자 목록을 보려면 New Relic 제목 표시줄에서 **([계정 드롭다운](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#account-dropdown) ) > 계정 설정 > 보안 및 인증 > 싱글 사인온을** 선택합니다.

제공자는 다음과 같습니다.

* [ADFS(Active Directory Federation Services)](http://technet.microsoft.com/en-us/library/hh831502.aspx "링크가 새 창에서 열립니다.")
* [인증0](http://developers.auth0.com/newrelic "링크가 새 창에서 열립니다.")
* [Azure AD(Microsoft Azure Active Directory)](https://docs.microsoft.com/en-us/azure/active-directory/saas-apps/new-relic-tutorial "링크가 새 창에서 열립니다.")
* [옥타](http://www.okta.com/newrelic "링크가 새 창에서 열립니다.")
* [원로그인](http://www.onelogin.com/partners/app-partners/new-relic/ "링크가 새 창에서 열립니다.")
* [핑 ID](https://www.pingidentity.com/en.html)
* [영업](http://wiki.developerforce.com/page/Configuring-SAML-SSO-to-NewRelic "링크가 새 창에서 열립니다.")
* SAML 2.0을 사용하는 SSO 시스템에 대한 일반 지원

Google SSO 인증을 New Relic 계정에 연결하는 방법을 배우려면 이 짧은 비디오(약 3분 10분)를 시청하십시오.
...
<CollapserGroup>
  ...
  >
    ...
    <Callout variant="important">
      로그아웃 URL은 URL의 어디에도 `newrelic.com` 을 포함 **할 수 없습니다** .
    </Callout>
  ...
  >
    ...
    1. **[계정 드롭다운](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#account-dropdown) > 계정 설정 > 계정 > 요약** 으로 이동합니다.
    2. **사용자** 목록에서 새 사용자를 추가하거나 기존 사용자의 역할을 편집하거나 삭제하는 옵션을 선택합니다.
  ...
  >
    ...
    ![화면 saml 계층 구조.png](./images/screen-saml-heirarchy.png "화면 saml 계층 구조.png")
