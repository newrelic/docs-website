...
감사 로깅은 APM 에이전트에 대한 [감사 모드](/docs/agents/manage-apm-agents/configuration/log-audit-all-data-your-new-relic-agent-transmits) 구성과 다릅니다. APM 감사 모드는 앱에서 전송되는 모든 데이터에 대한 정보를 기록합니다.
