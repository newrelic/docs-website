...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        사용자의 성입니다. [유효성 검사 규칙](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-ui-and-tasks/#name-field-requirements)을 참조하세요.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        사용자의 이름입니다. [유효성 검사 규칙](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-ui-and-tasks/#name-field-requirements)을 참조하세요.
      </td>
    </tr>
