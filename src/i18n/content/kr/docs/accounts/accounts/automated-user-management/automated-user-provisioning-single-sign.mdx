...
* 권한 관련 요구 사항:
  ...
  * [New Relic One 사용자 모델](/docs/accounts/original-accounts-billing/original-users-roles/overview-user-models) 이어야 합니다. 이 기능은 해당 모델에 사용자를 생성합니다. [원래 사용자 모델](/docs/accounts/original-accounts-billing/original-users-roles/overview-user-models) 을 사용 중이라면 New Relic 계정 담당자에게 문의하세요.
  * 핵심 사용자 또는 전체 플랫폼 사용자의 [사용자 유형](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type) 이 있어야 하며 [**인증 도메인 관리자** 역할](/docs/accounts/accounts-billing/new-relic-one-pricing-users/users-roles#standard-roles) 이 있는 그룹에 속해 있어야 합니다.
