...
* [사용자 유형이](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type) 코어 사용자 또는 전체 플랫폼 사용자여야 하며 조직 범위 [<DNT>**Authentication domain manager**</DNT> 역할이](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts#admin-settings) 있는 그룹에 속해 있어야 합니다.
