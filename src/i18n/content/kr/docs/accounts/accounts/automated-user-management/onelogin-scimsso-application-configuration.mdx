...
<CollapserGroup>
  ...
  >
    ...
    <img
      ...
      alt="조건 및 작업에 대한 OneLogin 규칙 세부 정보 페이지를 보여주는 화면 캡처."
...
<img
  ...
  alt="OneLogin 프로비저닝 페이지를 보여주는 화면 캡처."
...
1. **그룹** 필드를 클릭합니다.
   ...
   <img
     ...
     alt="구성할 필드를 보여주는 OneLogin 매개변수 양식의 스크린샷."
...
2. **사용자 프로비저닝에 포함을 선택** 합니다.
   ...
   <img
     ...
     alt="OneLogin 매개변수 세부정보 페이지를 보여주는 스크린샷."
