...
[자동화된 사용자 관리](/docs/accounts/accounts/automated-user-management/automated-user-provisioning-single-sign) 를 통해 SCIM을 통해 ID 공급자로부터 New Relic 사용자를 가져오고 구성할 수 있습니다. 이 가이드는 New Relic OneLogin SCIM/SSO 애플리케이션을 구성하는 방법에 대한 OneLogin 관련 세부 정보를 제공합니다.
...
<CollapserGroup>
  ...
  >
    ...
    ![조건 및 작업에 대한 OneLogin 규칙 세부 정보 페이지를 보여주는 화면 캡처.](./images/onelogin_rules_conditions_actions.png "onelogin_rules_conditions_actions.png")
...
![OneLogin 프로비저닝 페이지를 보여주는 화면 캡처.](./images/onelogin_provisioning_form.png "onelogin_provisioning_form.png")
...
1. **그룹** 필드를 클릭합니다.
   ...
   ![구성할 필드를 보여주는 OneLogin 매개변수 양식의 스크린샷.](./images/onelogin_parameter_form_general.png "onelogin_parameter_form_general.png")

2. **사용자 프로비저닝에 포함을 선택** 합니다.

   ![OneLogin 매개변수 세부정보 페이지를 보여주는 스크린샷.](./images/onelogin_parameter_form_specific.png "onelogin_parameter_form_specific.png")
