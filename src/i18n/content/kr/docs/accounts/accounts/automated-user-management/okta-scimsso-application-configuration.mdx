...
New Relic 인증 도메인 UI로 이동하려면: **[one.newrelic.com](https://one.newrelic.com)** 에서, [계정 드롭다운](/docs/using-new-relic/welcome-new-relic/get-started/glossary/#account-dropdown) 을 클릭하고 **액세스 관리** 를 클릭한 다음 **인증 도메인** 을 클릭합니다.
