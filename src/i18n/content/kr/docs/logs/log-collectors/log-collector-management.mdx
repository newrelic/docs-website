...
이러한 요구 사항에 대한 자세한 내용은 [Forward your loger to Newrelrik(리거를 뉴렐릭으로 전달)](/docs/logs/forward-logs/enable-log-management-new-relic) 을 참조하세요.<br />
