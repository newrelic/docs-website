...
* <DNT>**Standard:**</DNT>
  ...
  귀하의 뉴렐릭 구독에 의해 결정되는 계정의 기본 보존 기간입니다. 이는 계정에서 사용할 수 있는 최대 보존 기간이며 대부분의 파티션에 대해 선택하게 될 네임스페이스입니다.

* <DNT>**Secondary:**</DNT>

  30일 보존. Secondary 네임스페이스의 멤버인 파티션으로 전송된 모든 로그는 수집 후 30일이 지나면 순차적으로 삭제됩니다.
...
6. 규칙의
   ...
   설정: 이 파티션에 저장할 로그와 일치하는 유효한 NRQL `WHERE` 절을 입력합니다.
