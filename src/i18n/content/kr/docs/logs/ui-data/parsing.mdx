...
![로그 구문 분석 규칙 UI](./images/log-parsing-rule-ui.png "새로운 Relic Logs 구문 분석 규칙 UI")
...
![로그 구문 분석 규칙](./images/log-parsing-rules.png "새 로그 구문 분석 규칙 만들기")
...
![로그 구문 분석 규칙](./images/log-parsing-rules-list.png "로그 구문 분석 규칙")
