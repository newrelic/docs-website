...
뉴렐릭에서 로그 구문 분석(<DoNotTranslate>**parsing**</DoNotTranslate>)은 구조화되지 않은 로그 데이터에서 [속성](/docs/new-relic-solutions/get-started/glossary/#attribute)(키:값 쌍)을 추출하는 프로세스를 의미합니다. 이러한 속성을 사용하면 보다 실질적이고 유용한 방식으로 로그를 검색하고 쿼리할 수 있으며, 이는 결과적으로 더 나은 차트와 알림을 구축하는 데 도움이 됩니다.
    ...
    <tr>
      ...
      <td>
        ...
        * 데이터 보강이 이뤄지기 전에(
          ...
          <DoNotTranslate>**before**</DoNotTranslate>
...
<CollapserGroup>
  ...
  >
    ...
    `keepAttributes` 옵션을 사용하면 추출할 속성 목록을 정의할 수 있습니다. 예를 들어, 다음 Grok 표현식을 사용하면:
  ...
  >
    ...
    * <DoNotTranslate>**dropOriginal**</DoNotTranslate>

      : (기본값은 `true`) 구문 분석에 사용된 CSV 스니펫을 삭제합니다. `true` (기본값)으로 설정하면 구문 분석 규칙이 원래 필드를 삭제합니다.

    * <DoNotTranslate>**noPrefix**</DoNotTranslate>

      : (기본값은 `false`) Grok 필드 이름을 결과 객체의 접두사로 포함하지 않습니다.

    * <DoNotTranslate>**separator**</DoNotTranslate>
    ...
    * <DoNotTranslate>**quoteChar**</DoNotTranslate>
  ...
  >
    ...
    * <DoNotTranslate>**city**</DoNotTranslate>

      : 도시 이름

    * <DoNotTranslate>**countryCode**</DoNotTranslate>

      : 국가의 약자

    * <DoNotTranslate>**countryName**</DoNotTranslate>

      : 국가 이름

    * <DoNotTranslate>**latitude**</DoNotTranslate>

      : 위도

    * <DoNotTranslate>**longitude**</DoNotTranslate>

      : 경도

    * <DoNotTranslate>**postalCode**</DoNotTranslate>
    ...
    * <DoNotTranslate>**regionName**</DoNotTranslate>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        계정당 제한은 계정이 공정한 리소스 할당량 이상을 사용하는 것을 방지하기 위함입니다. 이 제한은 계정에 대한 분당 모든(<DoNotTranslate>**all**</DoNotTranslate>) 로그 메시지를 처리하는 데 소요된 총 시간을 고려합니다.
      </td>
    </tr>
  </tbody>
</table>
...
<Callout variant="tip">
  제한에 도달했는지 쉽게 확인하려면 뉴렐릭 UI의 [시스템 <DoNotTranslate>**Limits**</DoNotTranslate> 페이지](/docs/telemetry-data-platform/ingest-manage-data/manage-data/view-system-limits#limits-ui)로 이동합니다.
</Callout>
...
<figcaption>
  로그 UI의 왼쪽 탐색 메뉴에서 <DoNotTranslate>**Parsing**</DoNotTranslate>을 선택한 다음 유효한 NRQL `WHERE` 절과 Grok 패턴을 사용하여 고유한 커스텀 구문 분석 규칙을 생성합니다.
</figcaption>
...
2. 로그 UI 왼쪽 탐색 메뉴의
   ...
   <DoNotTranslate>**Create parsing rule**</DoNotTranslate>
...
6. 매치하는 로그가 있으면 선택하거나
   ...
   <DoNotTranslate>**Paste log**</DoNotTranslate>

   탭을 클릭하여 샘플 로그를 붙여넣습니다.

7. 구문 분석 규칙을 입력하고

   <DoNotTranslate>**Output**</DoNotTranslate>
