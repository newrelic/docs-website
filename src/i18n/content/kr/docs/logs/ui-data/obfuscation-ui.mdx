...
import obfuscationCreateExpression from 'images/ObfuscationCreateExpression.png'
...
import obfuscationExp from 'images/log-obfuscation-exp051322.png'
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > 로그 > 난독화** : 먼저 하나 이상의 난독화 표현식을 생성한 다음 난독화 규칙을 생성합니다.
</figcaption>
...
<CollapserGroup>
  ...
  >
    ...
    **로그 UI 사용:**
    ...
    1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Logs** 로 이동하고 왼쪽 탐색 메뉴에서 **Obfuscation** 을 선택합니다.
