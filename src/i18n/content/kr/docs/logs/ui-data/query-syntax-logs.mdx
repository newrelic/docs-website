...
**[one.newrelic.com](https://one.newrelic.com)** 에서 로그 UI를 사용하여 몇 초 만에 로그 데이터를 빠르게 검색할 수 있습니다. 각 로그는 `log_summary` 열에 사용 가능한 속성을 나열합니다. 추가 세부 정보로 드릴다운하려면 강조 표시된 속성을 클릭합니다.
