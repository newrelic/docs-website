...
**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**에서 로그 UI를 사용하여 몇 초 만에 로그 데이터를 빠르게 검색할 수 있습니다. 각 로그는 `log_summary` 열에 사용 가능한 속성을 나열합니다. 추가적인 세부 정보를 확인하려면 강조 표시된 속성을 클릭합니다.
