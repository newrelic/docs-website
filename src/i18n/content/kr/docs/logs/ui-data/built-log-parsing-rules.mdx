...
* 기본 제공 로그 구문 분석을 활성화하려면 [`logtype` 속성 추가에](/docs/logs/ui-data/parsing#logtype) 대한 설명서를 참조하세요.
...
<CollapserGroup>
  ...
  <Collapser
    id="linux_messages"
    title="Linux 메시지(/var/log/messages)"
  >
