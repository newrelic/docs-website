...
<CollapserGroup>
  ...
  >
    ...
    <Callout variant="important">
      IIS는 여러 <a href="https://docs.microsoft.com/en-us/previous-versions/iis/6.0-sdk/ms524877(v=vs.90)">구성 옵션</a> 을 허용합니다. 기본값 이외의 옵션을 구성한 경우 Grok 패턴은 로그를 구문 분석하지 않습니다. 이 경우 <a href="https://docs.newrelic.com/docs/logs/ui-data/parsing/#custom-parsing">사용자 정의 구문 분석</a> 을 사용하는 것이 좋습니다.
    </Callout>
  </Collapser>
