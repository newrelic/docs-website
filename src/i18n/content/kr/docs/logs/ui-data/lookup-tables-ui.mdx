...
[UI](#lookup-ui) 또는 [Lookups Service API를](#lookups-service-api) 통해 조회 테이블을 추가하고 관리할 수 있습니다.
...
### 조회 서비스 API 사용 [#lookups-service-api]

또는 [Lookups Service API를](/docs/apis/lookups-service-api/lookups-service-api) 사용하여 테이블을 추가하고 관리할 수 있습니다. Lookups Service API는 조회 테이블을 CSV 파일 및 JSON 개체로 업로드하는 것을 지원합니다.
