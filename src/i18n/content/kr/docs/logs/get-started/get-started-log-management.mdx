...
로그 관리 권한에 대한 액세스는 사용자의 사용자 유형에 따라 다릅니다. 자세한 내용은 [사용자 유형](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type#user-type-capabilities)을 참조하십시오.

로그 관련 권한에 대한 자세한 내용은 [권한](/docs/accounts/accounts-billing/new-relic-one-user-management/user-permissions#logs)을 참조하십시오.
