...
<Callout variant="important">
  **일본 데이터센터 계정:** 이 기능의 이메일 공지는 SendGrid의 EU 엔드포인트를 통해 처리됩니다. 이는 EU 데이터 개인정보 보호 통제에 대한 일본의 적정성 결정을 준수합니다.
</Callout>
...
역할 기반 권한 외에도 [데이터 액세스 제어](/docs/accounts/accounts-billing/new-relic-one-user-management/data-access-control)를 사용하면 특정 로그 데이터에 어떤 사용자가 액세스할 수 있는지 제어할 수 있습니다. 이를 통해 사용자 그룹을 기반으로 특정 [로그 파티션](/docs/logs/ui-data/data-partitions/)에 대한 액세스를 제한하거나 허용할 수 있습니다.
