...
에이전트 에이전트, <InlinePopover type="apm"/>에이전트를 설치하거나 로그 포워딩을 설정한 후 10분 후에 뉴렐릭 UI 에 예상되는 로그 데이터가 표시되지 않습니다.
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        이 오류는 잘못된 보안 키를 사용하고 있음을 의미합니다. 뉴렐릭은 로그 배송을 활성화하려면 <InlinePopover type="licenseKey"/>필요합니다.
    ...
    <tr>
      ...
      <td>
        ...
        쿼리 빌더에 데이터가 표시되지 않으면 <DNT>**Logs**</DNT> UI에도 데이터가 표시되지 않습니다. 자세한 내용은 [데이터 쿼리 옵션에 대한 문서를](/docs/query-your-data/explore-query-data/get-started/introduction-querying-new-relic-data) 참조하세요.
      </td>
    </tr>
  </tbody>
</table>
