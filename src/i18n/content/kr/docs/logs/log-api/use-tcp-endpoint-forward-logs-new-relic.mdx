...
5. `newrelic.conf` 에 다음을 추가합니다. 강조 표시된 값을 바꿉니다. <var>YOUR_LICENSE_KEY</var> 의 경우 [New Relic 라이선스 키](/docs/apis/intro-apis/new-relic-api-keys/#ingest-license-key) 를 사용하세요.
...
2. `newrelic.conf` 에 다음을 추가합니다. 강조 표시된 값을 모두 바꿉니다. <var>YOUR_LICENSE_KEY</var> 의 경우 [New Relic 라이선스 키](/docs/apis/intro-apis/new-relic-api-keys/#ingest-license-key) 를 사용하세요.
...
5. New Relic `syslog` 형식을 정의합니다. <var>YOUR_LICENSE_KEY</var> 의 경우 [New Relic 라이센스 키](/docs/apis/intro-apis/new-relic-api-keys/#ingest-license-key) 를 사용합니다.
