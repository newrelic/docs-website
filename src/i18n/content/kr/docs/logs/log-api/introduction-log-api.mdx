...
[유럽 연합](/docs/accounts/accounts-billing/account-setup/choose-your-data-center) (EU) 엔드포인트:

```
https://log-api.eu.newrelic.com/log/v1
```

[일본](/docs/accounts/accounts-billing/account-setup/choose-your-data-center) 엔드포인트:
...
5. `POST` 요청에서 New Relic 계정에 대한 적절한 HTTP 엔드포인트로 JSON 메시지를 보냅니다.
   ...
   * 일본: `https://log-api.jp.nr-data.net/log/v1`
