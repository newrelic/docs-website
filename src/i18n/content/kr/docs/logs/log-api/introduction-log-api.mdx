...
귀하의 <InlinePopover type="licenseKey" /> 는 Log API에 대한 귀하의 요청을 인증하는 역할을 하며 제출된 로그 메시지가 기록될 New Relic 계정을 결정합니다. HTTP 헤더 또는 쿼리 문자열 매개변수로 전달되어야 합니다.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        New Relic <InlinePopover type="licenseKey" /> . [쿼리 매개변수를 통해 보낼](#query-parameters) 수도 있습니다.
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        귀하의 <InlinePopover type="licenseKey" /> . [HTTP 헤더를 통해 보낼](#auth-header) 수도 있습니다.
      </td>
    </tr>
  </tbody>
</table>
