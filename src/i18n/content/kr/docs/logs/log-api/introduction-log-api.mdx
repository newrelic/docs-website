...
<CollapserGroup>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            기본적으로 검색되는 <DoNotTranslate>**main**</DoNotTranslate> 로그 메시지 필드입니다.
          </td>
        </tr>
  ...
  >
    세부 형식을 사용하여 본문을 생성하는 경우 각 JSON 객체는 다음 형식을 갖는 하나 이상의 JSON 객체를 포함하는 <DoNotTranslate>**JSON array**</DoNotTranslate> 이어야 합니다.
...
유효한 JSON 페이로드는 모두 허용됩니다. 페이로드는 <DoNotTranslate>**UTF-8**</DoNotTranslate> 으로 인코딩되어야 합니다.
