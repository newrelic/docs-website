...
1. [라이센스 키를](/docs/apis/intro-apis/new-relic-api-keys/#license-key)받으십시오.
...
[라이선스 키는](/docs/apis/intro-apis/new-relic-api-keys/#license-key) Log API에 대한 요청을 인증하는 역할을 하며 제출된 로그 메시지가 기록될 New Relic 계정을 결정합니다. HTTP 헤더 또는 쿼리 문자열 매개변수로 전달되어야 합니다.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        New Relic [라이선스 키](/docs/apis/intro-apis/new-relic-api-keys/#license-key). [쿼리 매개변수를 통해 보낼](#query-parameters) 수도 있습니다.
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        [라이센스 키](/docs/apis/intro-apis/new-relic-api-keys/#license-key). [HTTP 헤더를 통해 보낼](#auth-header) 수도 있습니다.
      </td>
    </tr>
  </tbody>
</table>
