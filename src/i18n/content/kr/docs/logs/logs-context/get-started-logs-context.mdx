...
[로그를 New Relic에 보고하는 방법에는 여러 가지가](/docs/logs/get-started/get-started-log-management) 있습니다. APM 에이전트를 사용하는 것은 특히 다른 에이전트를 사용하지 않아도 되는 이점을 중시하는 소규모 팀과 DevOps 팀에게 널리 사용되는 방법 중 하나입니다. <InlinePopover type="logs"/>도구.
