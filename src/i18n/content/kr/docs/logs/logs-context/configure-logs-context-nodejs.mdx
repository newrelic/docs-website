...
<CollapserGroup>
  ...
  >
    ...
    로그 전달 기능이 있는 에이전트 버전( [NodeJS 에이전트 8.11.0 이상](https://docs.newrelic.com/docs/release-notes/agent-release-notes/nodejs-release-notes/) )을 설치하고 전달을 활성화하도록 구성을 업데이트하기만 하면 됩니다.
