...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        * [메타데이터 추적](/docs/apm/agents/net-agent/net-agent-api/net-agent-api/#TraceMetadata)
    ...
    <tr>
      ...
      <td>
        * [get\_link\_metadata](/docs/apm/agents/python-agent/python-agent-api/getlinkingmetadata-python-agent-api/)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        * [link\_metadata](https://www.rubydoc.info/gems/newrelic_rpm/NewRelic/Agent#linking_metadata-instance_method)
