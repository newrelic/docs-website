...
<CollapserGroup>
  ...
  >
    ...
    ![컨텍스트 로그인 - Log4Net](./images/LogsInContext-Log4Net.png "New Relic의 .NET 에이전트와 관련된 로그에 대한 log4net 확장")
...
<CollapserGroup>
  ...
  >
    ...
    ![컨텍스트 로그인 - NLog](./images/LogsInContext-NLog.png "New Relic의 .NET 에이전트와 관련된 로그용 NLog 확장")
...
<CollapserGroup>
  ...
  >
    ...
    ![컨텍스트에 로그인](./images/LogsInContext-Serilog.png "New Relic의 .NET 에이전트와 관련된 로그용 Serilog 확장")
