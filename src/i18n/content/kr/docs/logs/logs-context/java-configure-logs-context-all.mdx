...
Java APM 에이전트를 사용하면 **문맥적 로그**를 확보하여, 다른 뉴렐릭 데이터의 문맥적 앱 로그를 볼 수 있습니다. 이 기능에 대한 일반 정보는 [문맥적 APM 로그](/docs/apm/new-relic-apm/getting-started/get-started-logs-context)를 참조하십시오.
