...
<Callout variant="important">
  ...
  에이전트 로그 전달은 [지원되는 프레임워크](/docs/logs/logs-context/java-configure-logs-context-all#automatic) 가 감지될 때 데이터 소비를 증가시킵니다. 양은 애플리케이션 및 생성하는 로그의 양에 따라 다릅니다. 이 기능은 비활성화할 수 있습니다. 옵션에 대한 자세한 내용은 [자동 로깅 비활성화](https://docs.newrelic.com/docs/logs/logs-context/disable-automatic-logging/) 를 참조하십시오.
