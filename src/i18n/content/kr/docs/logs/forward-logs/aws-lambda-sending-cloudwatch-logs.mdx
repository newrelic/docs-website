...
3. `newrelic`을 검색하고 <DNT>**Show apps that create custom IAM roles or resource policies**</DNT>를 확인하여 `newrelic-log-ingestion`을 찾습니다.

4. `newrelic-log-ingestion` 세부정보를 열고 <DNT>**Deploy**</DNT>를 클릭합니다.

5. 함수의 <DNT>**Configure**</DNT> 메뉴에서 <DNT>**Environment Variables**</DNT>로 이동하고 다음 환경 변수를 사용하여 로그 포워딩을 구성합니다.
...
6. 앱이 커스텀 IAM 역할을 생성한다는 것을 확인한 후, <DNT>**Deploy**</DNT>를 클릭합니다.
