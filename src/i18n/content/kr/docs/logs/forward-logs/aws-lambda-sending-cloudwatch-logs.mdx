...
1. [뉴렐릭 라이선스 키](/docs/accounts/install-new-relic/account-setup/license-key)가 있는지 확인합니다.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [뉴렐릭 라이선스 키](/docs/accounts/install-new-relic/account-setup/license-key)는 뉴렐릭에 데이터를 전송하는 데 사용됩니다. **필수 항목입니다.**
      </td>
    </tr>
