...
<Callout variant="important">
  [FedRAMP 고객](/docs/security/security-privacy/compliance/certificates-standards-regulations/fedramp-moderate) 인 경우 Kinesis Data Firehose를 사용하여 로그 스트리밍을 활성화해서는 안 됩니다. AWS Kinesis Data Firehose 통합은 현재 FedRAMP 인증을 받지 않았기 때문입니다.
</Callout>
