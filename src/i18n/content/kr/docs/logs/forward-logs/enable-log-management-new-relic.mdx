...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        뉴렐릭의 솔루션을 사용해 인프라 에이전트, Fluent Bit, Fluentd, Logstash 및 syslog/TCP 등 [운영 시스템에서 로그를 전달](#forward-infra)합니다. 앱 및 호스트의 로그를 위한 경량 데이터 수집기로 [인프라 모니터링을 위한 안내 설치](/docs/logs/forward-logs/forward-your-logs-using-infrastructure-agent)를 사용합니다.
      </td>
    </tr>
...
5. 해당되는 경우 [수동 문맥적 로그](/docs/logs/enable-log-management-new-relic/configure-logs-context/configure-logs-context-apm-agents/) 절차에 따라 앱의
