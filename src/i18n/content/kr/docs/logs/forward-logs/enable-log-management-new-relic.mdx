...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        뉴렐릭의 [쿠버네티스 플러그인](/docs/logs/forward-logs/kubernetes-plugin-log-forwarding/) 또는 [Docker용 인프라 모니터링 에이전트](/docs/infrastructure/install-infrastructure-agent/linux-installation/container-infrastructure-monitoring/#requirements)를 사용합니다.
      </td>
    </tr>
