...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <InlinePopover type="apm"/>에이전트와 인프라 모니터링 에이전트를 사용합니다. 앱의 APM 에이전트가 [APM의 문맥적 로그](/docs/apm/new-relic-apm/getting-started/get-started-logs-context)를 사용해 로그 데이터를 뉴렐릭으로 직접 전달하도록 합니다. 추가로 서드파티 소프트웨어를 설치하거나 유지 관리할 필요가 없습니다!
      </td>
    </tr>
