...
`logConfiguration` 블록을 사용하여 INSERT_API_KEY를 New Relic 라이센스 키로 바꿉니다. 구성 세부 정보 [는 GitHub의 FireLens 작업 정의를](https://github.com/aws-samples/amazon-ecs-firelens-examples) 참조하십시오.
