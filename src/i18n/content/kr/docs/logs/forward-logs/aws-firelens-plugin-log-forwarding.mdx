...
작업 정의에서 New Relic <LicenseKey/> 가 노출되지 않도록 하려면 [AWS Secrets Manager](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/specifying-sensitive-data-secrets.html) 서비스를 사용하는 것이 좋습니다.
...
`logConfiguration` 블록을 사용하여 INSERT_API_KEY를 New Relic <LicenseKey/> 바꿉니다. 구성 세부 정보 [는 GitHub의 FireLens 작업 정의를](https://github.com/aws-samples/amazon-ecs-firelens-examples) 참조하십시오.
