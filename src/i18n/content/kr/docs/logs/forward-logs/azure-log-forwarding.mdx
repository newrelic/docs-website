...
<CollapserGroup>
  ...
  >
    ...
    3. **Allow Blob public access** \[Blob 공용 액세스 허용] 에서 **Disabled** \[비활성화를] 선택합니다.<img title="Disabling public access to the blobs/containers in the Storage account" alt="Disabling public access to the blobs/containers in the Storage account" src={disablePublicBlobAccessStorageAccount}/>
    4. **저장** 을 클릭합니다.
  </Collapser>
  ...
  >
    ...
    4. **Platform settings** \[플랫폼 설정] 에서 **FTP state** \[FTP 상태] 에 대해 **Disabled** \[비활성화를] 선택합니다.<img title="Disabling FTP access to the Function App" alt="Disabling FTP access to the Function App" src={disableFtpAccessStorageAccount}/>
    5. **저장** 을 클릭합니다.
  </Collapser>
  ...
  >
    ...
    2. 왼쪽 메뉴에서 **Settings** > **Configuration**으로 이동합니다.
    3. **General settings** \[일반 설정] 탭을 선택합니다.
    4. **Platform settings** \[플랫폼 설정] 에서 **HTTPS Only** \[HTTPS 전용] 에 대해 **On** \[켜기를] 선택합니다.<img title="Enforcing HTTPS to the Function App" alt="Enforcing HTTPS to the Function App" src={enforceHttpsFunctionApp}/>
    5. **저장** 을 클릭합니다.
  </Collapser>
