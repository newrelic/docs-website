...
<CollapserGroup>
  ...
  >
    ...
    2. 왼쪽 메뉴에서 **Settings** > **Configuration**으로 이동합니다.
    3. **General settings** \[일반 설정] 탭을 선택합니다.
    4. **Platform settings** \[플랫폼 설정] 에서 **HTTPS Only** \[HTTPS 전용] 에 대해 **On**선택합니다.<img title="Enforcing HTTPS to the Function App" alt="Enforcing HTTPS to the Function App" src={enforceHttpsFunctionApp}/>
    5. **저장** 을 클릭합니다.
  </Collapser>
