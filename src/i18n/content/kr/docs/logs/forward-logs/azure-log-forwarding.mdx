...
2. **[one.newrelic.com](https://one.newrelic.com/launcher/logger.log-launcher)** 으로 이동하여 왼쪽 메뉴에서 **Add data** \[데이터 추가를] 클릭합니다.

3. **Logging** \[로깅] 아래에서 **Microsoft Azure Event Hub** \[Microsoft Azure 이벤트 허브] 타일을 클릭합니다.
