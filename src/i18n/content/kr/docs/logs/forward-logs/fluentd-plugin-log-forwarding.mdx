...
Shift-JIS(SP932)로 인코딩된 일본어 로그 파일은 [필요한 UTF-8 인코딩](/docs/data-apis/custom-data/custom-events/data-requirements-limits-custom-event-data/#general)으로 변환되며, 로그 데이터를 뉴렐릭으로 가져오고 보내는 데 필요합니다.
