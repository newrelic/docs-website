...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        기본값은 [https://log-api.newrelic.com/log/v1](https://log-api.newrelic.com/log/v1) 입니다. - EU 키를 사용하는 경우 [https://log-api.eu.newrelic.com/log/v1](https://log-api.eu.newrelic.com/log/v1)으로 설정해야 합니다.
      </td>
    </tr>
  </tbody>
</table>
