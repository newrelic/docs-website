...
* New Relic Instant Observability에서 [Cloudflare 네트워크 로그 빠른 시작](https://newrelic.com/instant-observability/cloudflare/fc2bb0ac-6622-43c6-8c1f-6a4c26ab5434) 으로 이동하고 **+ 빠른 시작 설치** 를 클릭합니다.
