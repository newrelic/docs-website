...
<CollapserGroup>
  ...
  >
    ...
    1. [<DoNotTranslate>**Add data**</DoNotTranslate> UI](https://one.newrelic.com/marketplace) 로 이동하여 <DoNotTranslate>**Logging**</DoNotTranslate> 클릭하고 <DoNotTranslate>**Google Cloud Platform**</DoNotTranslate> 클릭합니다.

    2. 로그를 전달할 뉴렐릭 계정을 선택하고 <DoNotTranslate>**Continue**</DoNotTranslate> 클릭합니다.

    3. 선택 사항: 다음 단계에서 생성할 수집 URL로 전송되는 모든 로그 이벤트에 포함할 메타데이터(속성-값 쌍)를 구성합니다.

    4. <DoNotTranslate>**Generate URL**</DoNotTranslate> 을(를) 클릭합니다.

    5. 새로 생성된 <DoNotTranslate>**ingest URL**</DoNotTranslate> ) 복사하여 안전한 곳에 보관하세요.
  ...
  >
    ...
    2. <DoNotTranslate>**Create Topic**</DoNotTranslate>
    ...
    4. <DoNotTranslate>**Create Topic**</DoNotTranslate>
  ...
  >
    ...
    3. 아래로 스크롤하여 <DoNotTranslate>**Subscriptions**</DoNotTranslate> 탭을 선택한 다음 <DoNotTranslate>**Create Subscription**</DoNotTranslate> 클릭하고 <DoNotTranslate>**Create a simple subscription**</DoNotTranslate> 선택합니다.
    ...
    4. <DoNotTranslate>**Subscription ID**</DoNotTranslate> 을 입력하세요. 그런 다음 <DoNotTranslate>**Delivery Type**</DoNotTranslate> 아래에서 <DoNotTranslate>**Push**</DoNotTranslate> 선택합니다.

    5. <DoNotTranslate>**Endpoint URL**</DoNotTranslate> 필드에 이전에 생성한 [수집 URL을](#ingest-url) 붙여넣습니다.

    6. 필요에 따라 나머지 설정을 구성하고 <DoNotTranslate>**Create**</DoNotTranslate> 클릭합니다.
  </Collapser>
  ...
  >
    ...
    2. <DoNotTranslate>**Create Sink**</DoNotTranslate>

       을(를) 클릭합니다.

    3. <DoNotTranslate>**Sink name**</DoNotTranslate>
    ...
    4. <DoNotTranslate>**Select sink service**</DoNotTranslate>
