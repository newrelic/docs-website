...
<CollapserGroup>
  ...
  >
    ...
    ![더 많은 데이터 소스 추가](./images/gcp-add-more-data.png "더 많은 데이터 소스 추가")
  ...
  >
    ...
    ![GCP 주제 만들기](./images/gcp-create-topic.png "GCP 주제 만들기")
  ...
  >
    ...
    ![GCP Pub/Sub 주제 구독 만들기](./images/gcp-create-subscription.png "GCP Pub/Sub 주제 구독 만들기")
    ...
    3. 아래로 스크롤하여 **구독** 탭을 선택한 다음 **구독 만들기** 를 클릭 **하고 간단한 구독 만들기** 를 선택합니다.
       ...
       ![GCP Pub/Sub 주제 구독 유형 선택](./images/gcp-create-subscription-type.png "GCP Pub/Sub 주제 구독 유형 선택")
  ...
  >
    ...
    ![GCP Pub/Sub 로그 라우터 싱크 만들기](./images/gcp-create-sink.png "GCP Pub/Sub 로그 라우터 싱크 만들기")
