...
<CollapserGroup>
  ...
  >
    ...
    1. [<DNT>**Integrations & Agents**</DNT> UI](https://one.newrelic.com/marketplace) 로 이동하여 <DNT>**Logging**</DNT> 클릭하고 <DNT>**Google Cloud Platform**</DNT> 클릭합니다.

    2. 로그를 전달할 뉴렐릭 계정을 선택하고 <DNT>**Continue**</DNT> 클릭합니다.

    3. 선택 사항: 다음 단계에서 생성할 수집 URL로 전송되는 모든 로그 이벤트에 포함할 메타데이터(속성-값 쌍)를 구성합니다.

    4. <DNT>**Generate URL**</DNT> 을(를) 클릭합니다.

    5. 새로 생성된 <DNT>**ingest URL**</DNT> ) 복사하여 안전한 곳에 보관하세요.
  ...
  >
    ...
    3. 아래로 스크롤하여 <DNT>**Subscriptions**</DNT> 탭을 선택한 다음 <DNT>**Create Subscription**</DNT> 클릭하고 <DNT>**Create a simple subscription**</DNT> 선택합니다.
    ...
    4. <DNT>**Subscription ID**</DNT> 을 입력하세요. 그런 다음 <DNT>**Delivery Type**</DNT> 아래에서 <DNT>**Push**</DNT> 선택합니다.

    5. <DNT>**Endpoint URL**</DNT> 필드에 이전에 생성한 [수집 URL을](#ingest-url) 붙여넣습니다.

    6. 필요에 따라 나머지 설정을 구성하고 <DNT>**Create**</DNT> 클릭합니다.
  </Collapser>
  ...
  >
    ...
    4. <DNT>
       ...
       선택하고 이전에 생성한 [Pub/Sub 주제를](#create-gcp-topic) 선택합니다.

    5. 필요에 따라 나머지 필터를 구성한 다음
