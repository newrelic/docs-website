...
<CollapserGroup>
  ...
  >
    <Callout variant="important">
      인프라 에이전트 v.1.24.3부터 사용 가능합니다. Windows Server 2019 이상과만 호환됩니다. 이전 버전에는 [winlog](https://docs.newrelic.com/docs/logs/forward-logs/forward-your-logs-using-infrastructure-agent/#winlog)를 대신 사용하십시오.
    </Callout>
