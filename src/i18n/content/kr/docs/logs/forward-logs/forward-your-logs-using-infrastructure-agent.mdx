...
<CollapserGroup>
  ...
  >
    ...
    `attributes` 구성 매개변수의 일반적인 용도 중 하나는 `logtype` 속성을 지정하는 것입니다. 이 속성을 사용하면 뉴렐릭의 로그 관리 기능이 지원하는 [내장된 구문 분석 규칙](/docs/logs/log-management/ui-data/parsing/#built-in-rules) 중 하나를 활용할 수 있습니다.
