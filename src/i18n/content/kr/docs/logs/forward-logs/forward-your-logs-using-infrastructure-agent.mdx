...
<img title="Logs in context for a host" alt="Screenshot of logs in context for a host" src={logsHostLogsUi} />
...
* Amazon Linux 2 및 2023 (2023의 경우 ARM64가 지원되지 않음)
* CentOS 버전 8 및 9 Stream(Rocky Linux 및 AlmaLinux도 지원됨)
* RedHat 버전 8 및 9
* Debian 버전 9(Strech), 10(Buster) 및 11(Bullseye)
* SLES(SUSE Linux Enterprise Server) 버전 12 및 15 (ARM64는 지원되지 않음)
* Ubuntu 버전 16.04.x, 18.04.x, 20.04.x, 22.04.x (LTS 버전)
  * Ubuntu 24.04.x LTS는 아직 지원되지 않습니다.
...
<TechTileGrid>
  <TechTile name="Amazon Linux" to="https://one.newrelic.com/marketplace?state=8f14e646-461e-b010-4675-3a0658bb3d20" icon={<img src={infrastructureAmazonLinux} alt="Amazon Linux" variant="TechTile"/>} />

  <TechTile name="Ansible" to="/docs/infrastructure/new-relic-infrastructure/config-management-tools/configure-new-relic-infrastructure-using-ansible" icon={<img src={osAnsibleRed} alt="Ansible" variant="TechTile"/>} />

  <TechTile name="CentOS" to="https://one.newrelic.com/marketplace?state=8f14e646-461e-b010-4675-3a0658bb3d20" icon={<img src={infrastructureCentos} alt="CentOS" variant="TechTile"/>} />

  <TechTile name="Debian" to="https://one.newrelic.com/marketplace?state=8f14e646-461e-b010-4675-3a0658bb3d20" icon={<img src={infrastructureDebian} alt="Debian" variant="TechTile"/>} />

  <TechTile name="RHEL" to="https://one.newrelic.com/marketplace?state=8f14e646-461e-b010-4675-3a0658bb3d20" icon={<img src={infrastructureRedhat} alt="Red Hat" variant="TechTile"/>} />

  <TechTile name="SLES" to="https://one.newrelic.com/marketplace?state=8f14e646-461e-b010-4675-3a0658bb3d20" icon={<img src={infrastructureSuse} alt="SLES" variant="TechTile"/>} />

  <TechTile name="Ubuntu" to="https://one.newrelic.com/marketplace?state=8f14e646-461e-b010-4675-3a0658bb3d20" icon={<img src={infrastructureUbuntu} alt="Ubuntu" variant="TechTile"/>} />

  <TechTile name="Windows" to="https://one.newrelic.com/marketplace?state=a792b092-300f-a5a4-ff62-510f4e0c52a5" icon={<img src={infrastructureWindows} alt="Windows" variant="TechTile"/>} />
</TechTileGrid>
...
<CollapserGroup>
  ...
  <Collapser className="freq-link" id="proxy" title="인프라 에이전트 프록시를 사용하여 데이터가 표시되지 않음">
    ...
    <DNT>**Linux**</DNT> `HTTP` 프록시의 경우 인증서를 설정할 필요가 없습니다. 플러그인은 시스템 인증서를 로드하고 뉴렐릭은 로그를 로깅 엔드포인트로 보냅니다. 그러나 `caBundleFile` 또는 `caBundleDir` 매개변수를 사용하여 프록시 자체 서명 인증서(PEM 파일)를 지정할 수 있습니다.
