...
<CollapserGroup>
  ...
  >
    ...
    `attributes` 구성 매개변수의 일반적인 용도 중 하나는 `logtype` 속성을 지정하는 것입니다. 이 속성을 사용하면 New Relic Logs [에서 지원하는 기본 제공 구문 분석 규칙](https://docs.newrelic.com/docs/logs/log-management/ui-data/parsing/#built-in-rules) 중 하나를 활용할 수 있습니다.
  ...
  >
    ...
    **매개변수:**
    ...
    `config_file:` 기존 Fluent Bit 구성 파일의 경로입니다. 소스가 겹치면 New Relic Logs에 중복 메시지가 표시됩니다.
