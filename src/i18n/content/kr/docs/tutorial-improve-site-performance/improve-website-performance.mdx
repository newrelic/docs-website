---
title: New Relic으로 웹사이트 성능을 향상하세요
...
이 튜토리얼에서는 New Relic을 사용하여 사이트 경험을 향상시키는 방법을 안내합니다. 시작하려면 사이트를 계측해야 합니다. 계측이란 각 방문에 대한 실제 최종 사용자 경험을 측정하는 일부 JavaScript 코드를 추가하는 것을 의미합니다. 여기에서 현재 사이트 성능을 평가하는 방법, 사이트를 개선할 수 있는 부분, 향후 상황을 계속 주시할 수 있는 방법을 배우게 됩니다.

<img
  title="Improve your site with New Relic"
  alt="New Relic browser agent summary page."
  src="/images/browser_screenshot-full_browser-summary.webp"
/>
...
기본적으로 두 가지 설치 방법이 있습니다. <InlinePopover type="browser"/>대리인:
...
<UserJourneyControls nextStep={{"path":"/docs/tutorial-improve-site-performance/guide-to-monitoring-core-web-vitals","title":"다음 단계","body":"사이트의 핵심 웹 바이탈 측정"}}/>
