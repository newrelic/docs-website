...
<Steps>
  <Step>
    ...
    인프라 에이전트를 설치하려면 [안내 설치 를](https://one.newrelic.com/nr1-core?state=a36f15a1-c5ce-528c-2ec2-8bcaacc40c03) 사용하는 것이 좋습니다. 설치 안내는 New Relic이 검사한 다음 시스템에 대한 추가 계측에 대한 권장 사항을 제시할 수 있는 CLI 설치 프로그램입니다. 이러한 권장 사항은 당사 에이전트 및 귀하의 시스템과 관련된 모든 통합을 위한 것입니다.
  </Step>
  ...
  <Step>
    ...
    <table>
      ...
      <tbody>
        <tr>
          <td>
            호스트를 실행하기 위한 Windows, MacOS 또는 Linux 운영 체제
          </td>
  ...
  <Step>
    ...
    설치가 완료되면 UI에서 인프라 데이터를 찾을 수 있습니다. **[one.newrelic.com > All Capabilities > Infrastructure](https://one.newrelic.com/infra/infrastructure/hosts)** 로 이동합니다. 이제 계측된 호스트에 대한 요약 페이지가 표시됩니다.
...
## 에이전트와 통합은 어떻게 서로 관련되어 있나요? [#agent-integration]
...
설치 안내를 통해 설치를 중단했지만 마음이 바뀐 경우 [인프라 통합 소개](/docs/infrastructure/infrastructure-integrations/get-started/introduction-infrastructure-integrations) 문서에서 통합 제안을 확인할 수 있습니다.

<UserJourneyControls nextStep={{"path":"/docs/tutorial-troubleshoot-infra-hosts/diagnose-app-infra-data","title":"다음 단계","body":"호스트 데이터로 실패한 앱 진단"}}/>