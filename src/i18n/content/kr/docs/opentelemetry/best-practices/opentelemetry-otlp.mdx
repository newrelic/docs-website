...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        무한 추적<br/>(엔드포인트 세부정보는 [모범 사례](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-best-practices-traces#infinite-tracing) 참조)
      </td>
...
## 구성: 페이로드 일괄 처리, 압축 및 속도 제한 [#payload-limits]
