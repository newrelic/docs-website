...
뉴렐릭은 OTLP 페이로드의 속성에 다양한 제한을 적용합니다. 일반적으로 당사는 유효성 검사에 대해 관대한 입장을 취하며, 데이터를 완전히 삭제하기보다는 속성을 정리하거나, 자르거나, 다른 방식으로 수정합니다. 속성이 수정될 때마다 [NrIntegrationError](https://docs.newrelic.com/docs/data-apis/manage-data/nrintegrationerror/) 를 생성하여 근본적인 문제를 추적하고 해결할 수 있도록 지원합니다.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        문자열 유형의 속성 값의 최대 길이는 4,095자입니다. 이 한도를 초과하는 값은 잘립니다.
      </td>
      ...
      <td>
        ...
        [OpenTelemetry 문서](https://opentelemetry.io/docs/specs/otel/configuration/sdk-environment-variables/)
    ...
    <tr>
      ...
      <td>
        속성 키의 최대 길이는 255자입니다. 이 제한을 초과하는 키는 잘립니다.
      </td>
    ...
    <tr>
      ...
      <td>
        각 속성 소스에는 개수 제한이 적용됩니다. 초과하면 초과된 속성은 잘리며, OpenTelemetry 시맨틱 규칙에 정의된 속성을 우선시합니다. 제한은 다음과 같습니다:<br />

        * 최대 리소스 속성: 64
        * 최대 범위 속성: 8
        * 최대 레코드 속성(스팬, 메트릭 데이터 포인트, 로그): 128
      </td>

      <td>
        `OTEL_ATTRIBUTE_COUNT_LIMIT=64`

        을(를) 설정하여 부분적으로 완화할 수 있습니다. 자세한 내용은 
    ...
    <tr>
      ...
      <td>
        속성 값은 다음 유형으로 제한됩니다: 문자열, 정수, double, boolean 및 바이트 어레이. 복잡한 유형의 속성 값은 제거됩니다. 로그 속성은 이 제한에서 제외됩니다. 
      ...
      <td>
        ...
        **참고:**
        ...
        `NrIntegrationErrors`
         ...
         이(가) 더 조치 가능한 유효성 검사 문제를 가릴 수 있으므로, 이 경우 
    ...
    <tr>
      ...
      <td>
        어레이의 최대 길이는 64개 항목입니다. 이 한도를 초과하는 속성은 제거됩니다.
      </td>
    ...
    <tr>
      ...
      <td>
        어레이 항목은 모두 동일한 유형이어야 합니다. 이기종 어레이 항목이 있는 속성은 제거됩니다. 로그 속성은 이 제한에서 제외됩니다. 
    ...
    <tr>
      ...
      <td>
        어레이 항목은 설정 해제되어서는 안 됩니다(즉, 

        `null`

        ). 설정 해제된 어레이 항목은 제거됩니다.
      </td>
    ...
    <tr>
      ...
      <td>
        어레이 항목은 다음 유형으로 제한됩니다: string, integer, double, boolean. 복잡한 유형을 가진 어레이 속성 값은 제거됩니다. 로그 속성은 이 제한에서 제외됩니다. 
    ...
    <tr>
      ...
      <td>
        바이트 어레이의 최대 길이는 128,000입니다. 이 한도를 초과하는 속성은 제거됩니다.
      </td>
...
**\[1]**: [OTLP 속성 유형](#otlp-attribute-types)을 참조하십시오.
