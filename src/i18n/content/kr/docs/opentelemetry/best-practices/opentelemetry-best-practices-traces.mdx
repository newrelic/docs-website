...
이 페이지에서는 뉴렐릭이 OpenTelemetry [뉴렐릭 OTLP 엔드포인트를 통해 수신한 범위를](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-otlp) 처리하는 방법을 설명합니다. OpenTelemetry 트레이스를 뉴렐릭과 통합하려면 트레이스 소스를 이 엔드포인트로 내보내도록 구성해야 합니다. 엔드포인트 설정 요구 사항을 검토하세요. OpenTelemetry 트레이스를 사용한 서비스 구성에 대한 자세한 내용은 [OpenTelemetry APM 모니터링을](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/apm-monitoring/opentelemetry-apm-intro) 참조하세요.
