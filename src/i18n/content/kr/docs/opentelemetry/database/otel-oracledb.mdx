            ...
            <Steps>
              ...
              <Step>
                ...
                2. 이전 단계에서 생성한 `oracle-config.yaml` 파일에 아래 설정 내용을 추가하세요.
                   ...
                   <CollapserGroup>
                     <Collapser id="nrdot-host-config" title="NRDOT host with database configuration">
                       ```yaml
                       extensions:
                         health_check:
                       receivers:
                     ...
                     <Collapser id="database-config" title="Database configuration">
                       ```yaml
                       receivers:
                         nroracledb:
                           endpoint: "<YOUR_DB_HOST>:<YOUR_DB_PORT>"
                ...
                <table>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        Per-session cumulative wait counts and durations from 
              ...
              <Step>
                ...
                <CollapserGroup>
                  <Collapser id="multi-receiver-config" title="Multi-receiver configuration">
    ...
    <TabsPageItem id="rds">
      ...
      <Steps>
        ...
        <Step>
          ...
          2. 이전 단계에서 생성한 `oracle-config.yaml` 파일에 아래 설정 내용을 추가하세요.
             ...
             <CollapserGroup>
               ...
               <Collapser id="rds-database-config" title="Database configuration">
                 ```yaml
                 receivers:
                   nroracledb/rds:
                     endpoint: "<YOUR_DB_HOST>:<YOUR_DB_PORT>"
        ...
        <Step>
          ...
          <CollapserGroup>
            <Collapser id="rds-multi-receiver-config" title="Multi-receiver configuration">
              The `config.yaml` below demonstrates how to set up multiple receivers for different on-host (multitenant) instances while sharing common processors and exporters.
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            `received/sent`
             ...
             via SQLNet from/to client/dblink
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            ...
            . Low values indicate shared pool pressure. 
        ...
        <tr>
          ...
          <td>
            ...
            `V$SYSMETRIC`
             ...
             (% MemSort/(MemSort + DiskSort)). Low values indicate PGA memory pressure. 
        ...
        <tr>
          ...
          <td>
            ...
            `V$SYSMETRIC`
             ...
             (e.g., Parse Failure Count Per Sec). 
        ...
        <tr>
          ...
          <td>
            ...
            `V$SYSMETRIC`
             ...
             (% SoftParses/TotalParses). High values indicate good cursor reuse. 
        ...
        <tr>
          ...
          <td>
            ...
            . High values indicate good cursor reuse. 
