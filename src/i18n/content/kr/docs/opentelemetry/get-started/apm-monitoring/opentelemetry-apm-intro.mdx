...
<Steps>
  ...
  <Step>
    ...
    * <DNT>**All entities &gt; Services - OpenTelemetry**</DNT>에서 엔터티를 찾을 수 있습니다. 엔터티 이름은 앱의 `service.name` 리소스 속성 값으로 설정됩니다. 뉴렐릭 서비스 엔터티가 OpenTelemetry 리소스 속성에서 어떻게 파생되는지에 대한 자세한 내용은 [서비스](/docs/opentelemetry/best-practices/opentelemetry-best-practices-resources/#services)를 참조하십시오.
