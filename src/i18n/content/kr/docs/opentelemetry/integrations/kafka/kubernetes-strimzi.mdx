          ...
          <CollapserGroup>
            <Collapser id="helm-nrdot" title="NRDOT Collector 사용(권장)">
              ...
              **구성 매개변수**
              ...
              | `resources.limits` 그리고 `resources.requests`                                                                | Adjust according to your workload needs                                                                   |
            </Collapser>
    ...
    <CollapserGroup>
      <Collapser id="configure-log-collection-strimzi" title="로그 수집 구성">
        ...
        **구성 매개변수**
        ...
        | Multiple broker receivers                             | 여러 브로커를 사용하는 경우, 각 브로커 ID를 사용하여 별도의 `filelog` 수신기(예: `filelog/kafka_broker_1`, `filelog/kafka_broker_2`)를 생성하십시오.                                                                                                                                                                                                                                   |
...
| 로그     | `Log`    | Logs from producer and consumer applications (via OTel Java agent) and broker logs collected via the optional log forwarding step |
