...
* `https://otlp.nr-data.net:4317` 뉴렐릭 OTLP 엔드포인트를 사용하세요(EU 지역의 경우 `https://otlp.eu01.nr-data.net:4317` 사용). 다른 엔드포인트 및 설정 옵션은 [OTLP 엔드포인트 구성을](/docs/opentelemetry/best-practices/opentelemetry-otlp/#configure-endpoint-port-protocol) 참조하세요.
