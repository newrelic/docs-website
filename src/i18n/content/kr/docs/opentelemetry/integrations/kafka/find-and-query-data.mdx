...
/\* ### 3. 타사 서비스 최적 사용 대상: 통합 중심 모니터링 1. &lt;DNT&gt;\*\*\[one.newrelic.com]\(https\://one.newrelic.com)으로 이동 &gt; All capabilities &gt; Infrastructure &gt; Third-party services&lt;/DNT&gt; 2. &lt;DNT&gt;\*\*Kafka(OpenTelemetry)\*\*&lt;/DNT&gt; 선택 &gt; &lt;DNT&gt;\*\*OpenTelemetry Kafka\*\*&lt;/DNT&gt; &lt;img title=&quot;OTel Kafka 타사 서비스&quot; alt=&quot;Kafka(OpenTelemetry) 통합을 보여주는 타사 서비스 보기&quot; src=&quot;/images/infrastructure\_screenshot-crop\_otel-kafka-third-party-통합.webp&quot; /&gt; \*/
...
1. [one.newrelic.com](https://one.newrelic.com) 으로 이동하세요 &gt; <DNT>**Dashboards**</DNT>

2. 딸깍 하는 소리 <DNT>**Create a dashboard**</DNT>
