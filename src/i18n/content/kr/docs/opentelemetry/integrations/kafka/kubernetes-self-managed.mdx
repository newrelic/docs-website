            ...
            <TabsPages>
              <TabsPageItem id="helm">
                **1단계. 뉴렐릭 자격 증명 시크릿 생성**
                ...
                <CollapserGroup>
                  <Collapser id="secret-us" title="미국 리전(기본값)">
                    ```bash
                  ...
                  <Collapser id="secret-jp" title="JP 지역">
                    ```bash
                    kubectl create secret generic newrelic-otlp-secret \
                      --namespace newrelic \
                      --from-literal=NEW_RELIC_LICENSE_KEY='your-license-key-here' \
              ...
              <TabsPageItem id="manifest">
                **1단계. 뉴렐릭 자격 증명 시크릿 생성**
                ...
                <CollapserGroup>
                  <Collapser id="manifest-secret-us" title="미국 리전(기본값)">
                    ```bash
                    kubectl create secret generic newrelic-otlp-secret \
                      --namespace newrelic \
                      --from-literal=NEW_RELIC_LICENSE_KEY='your-license-key-here' \
                  ...
                  <Collapser id="manifest-secret-jp" title="JP 지역">
                    ```bash
                    kubectl create secret generic newrelic-otlp-secret \
                      --namespace newrelic \
                      --from-literal=NEW_RELIC_LICENSE_KEY='your-license-key-here' \
            ...
            <TabsPages>
              <TabsPageItem id="helm-prom">
                ...
                **1단계. 뉴렐릭 자격 증명 시크릿 생성**
                ...
                <CollapserGroup>
                  <Collapser id="secret-us-prometheus" title="미국 리전(기본값)">
                    ```bash
                    kubectl create secret generic newrelic-otlp-secret \
                      --namespace newrelic \
                      --from-literal=NEW_RELIC_LICENSE_KEY='your-license-key-here' \
                  ...
                  <Collapser id="secret-jp-prometheus" title="JP 지역">
                    ```bash
                    kubectl create secret generic newrelic-otlp-secret \
                      --namespace newrelic \
                      --from-literal=NEW_RELIC_LICENSE_KEY='your-license-key-here' \
              ...
              <TabsPageItem id="manifest-prom">
                ...
                **1단계. 뉴렐릭 자격 증명 시크릿 생성**
                ...
                <CollapserGroup>
                  <Collapser id="manifest-secret-us-prometheus" title="미국 리전(기본값)">
                    ```bash
                    kubectl create secret generic newrelic-otlp-secret \
                      --namespace newrelic \
                      --from-literal=NEW_RELIC_LICENSE_KEY='your-license-key-here' \
                  ...
                  <Collapser id="manifest-secret-jp-prometheus" title="JP 지역">
                    ```bash
                    kubectl create secret generic newrelic-otlp-secret \
                      --namespace newrelic \
                      --from-literal=NEW_RELIC_LICENSE_KEY='your-license-key-here' \
