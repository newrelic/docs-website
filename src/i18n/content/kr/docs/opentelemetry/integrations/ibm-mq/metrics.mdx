...
<CollapserGroup>
  <Collapser id="metrics-qmgr-status" title="큐 관리자 상태 및 현황">
    | 미터법                                                 | 설명                                                       |
    | --------------------------------------------------- | -------------------------------------------------------- |
  ...
  <Collapser id="metrics-qmgr-resources" title="큐 관리자 리소스(CPU, 메모리, 로그, 파일 시스템)">
    | 미터법                                                          | 설명                                                                                       |
    | ------------------------------------------------------------ | ---------------------------------------------------------------------------------------- |
  ...
  <Collapser id="metrics-queue-state" title="대기열 깊이, 경과 시간 및 핸들">
    | 미터법                                | 설명                                 |
    | ---------------------------------- | ---------------------------------- |
  ...
  <Collapser id="metrics-queue-throughputl" title="대기열 처리량 및 타이밍(MQI)">
  ...
  <Collapser id="metrics-channel" title="채널 메트릭">
    | 미터법                                                                      | 설명                                                                                               |
    | ------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------ |
  ...
  <Collapser id="metrics-qmgr-mqi" title="큐 관리자 MQI 활동 및 오류">
  ...
  <Collapser id="status-codes" title="MQ 상태 코드 참조">
...
<CollapserGroup>
  <Collapser id="common-attributes" title="공통 속성">
    | 기인하다                       | 설명                                                                                                              | 예시                              |
    | -------------------------- | --------------------------------------------------------------------------------------------------------------- | ------------------------------- |
