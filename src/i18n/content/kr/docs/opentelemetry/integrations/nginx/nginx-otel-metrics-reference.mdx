...
* [자체 호스팅 환경에서 NGINX 모니터링](/docs/opentelemetry/integrations/nginx/nginx-otel-host/) - 호스트 내 구현을 위한 전체 설정, 배포
* [Kubernetes에서 NGINX 모니터링](/docs/opentelemetry/integrations/nginx/nginx-otel-kubernetes/) - Kubernetes 구현, 배포에 대한 전체 설정

**데이터 사용량:**

* [NGINX 데이터 찾기 및 쿼리](/docs/opentelemetry/integrations/nginx/find-and-query-your-data/) - Dashboards, NRQL 쿼리 및 알림
