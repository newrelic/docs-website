...
<Steps>
  ...
  <Step>
    ...
    3. 경고에 대한 추가 설정을 지정합니다. 여기에는 진행 중인 인시던트가 자동으로 종료될 때까지의 시간 설정과 인시던트에 대한 [사용자 지정 설명](/docs/alerts-applied-intelligence/new-relic-alerts/advanced-alerts/advanced-techniques/alert-custom-incident-descriptions) 입력이 포함됩니다.
