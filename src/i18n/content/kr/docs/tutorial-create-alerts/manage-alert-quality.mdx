...
<CollapserGroup>
  ...
  >
    ...
    <DoNotTranslate>**Goal:**</DoNotTranslate> 낮은 가치와 귀찮은 수를 줄이세요.
  ...
  >
    ...
    <DoNotTranslate>**Goal:**</DoNotTranslate> 인시던트의 총 누적 시간을 줄입니다.
    ...
    * 감지 및 응답 시간 개선에 대한 중요성을 전달하여
      ...
      <DoNotTranslate>**percent investigated**</DoNotTranslate>

      및

      <DoNotTranslate>**mean-time-to-investigate**</DoNotTranslate>
  ...
  >
    ...
    <DoNotTranslate>**Goal:**</DoNotTranslate> MTTC 감소
  ...
  <Collapser
    ...
    title="5분 미만의 KPI 비율"
  >
    이는 총 지속 시간이 5분 미만인 인시던트의 비율입니다. 이는 인시던트의 상태가 너무 자주 변경되어 인시던트의 원인과 심각도가 모호해진다는 의미일 수 있습니다. 이 상태를 <DoNotTranslate>**incident flapping**</DoNotTranslate> 이라고 합니다.

    <DoNotTranslate>**Goal:**</DoNotTranslate> 짧은 기간으로 인시던트 비율을 최소화합니다.
...
<CollapserGroup>
  ...
  >
    ...
    <DoNotTranslate>**Goal:**</DoNotTranslate> 인시던트 참여율을 높이세요.
  ...
  >
    ...
    <DoNotTranslate>**Goal:**</DoNotTranslate> 조사에 소요되는 평균 시간을 줄입니다.
