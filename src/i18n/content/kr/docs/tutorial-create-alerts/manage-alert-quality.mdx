...
경고 피로를 해결하고 향후 발생을 방지하려면 경고 품질을 개선해야 합니다. 경보 품질 관리(AQM) 정책을 채택하면 방해 사건 수를 줄이는 데 중점을 두어 다음 사항에만 집중할 수 있습니다. <InlinePopover type="alerts"/>진정한 비즈니스 영향을 미칩니다. 이를 통해 경고 피로도가 줄어들고 귀하와 귀하의 팀이 적시에 적절한 장소에 주의를 집중할 수 있습니다.
...
<CollapserGroup>
  ...
  >
    ...
    **Goal** \[목표]: 가치가 낮고 성가신 사건의 수를 줄입니다.
  ...
  >
    ...
    * 탐지 및 응답 시간 개선에 대한 KPI의 중요성을 전달하여 KPI **조사** 비율 및 **평균 조사 시간을** 개선합니다.
    * 모든 이해 관계자에게 AQM KPI를 보고합니다.
  ...
  <Collapser
    ...
    title="5분 미만의 KPI 비율"
  >
    총 기간이 5분 미만인 사건의 비율입니다. 이는 인시던트 상태가 너무 자주 변경되어 인시던트의 원인과 심각도를 가릴 수 있음을 나타낼 수 있습니다. 이 상태를 **사건 플래핑(incident flapping)** 이라고 합니다.
