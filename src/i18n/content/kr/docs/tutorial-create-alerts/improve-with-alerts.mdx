...
<Steps>
  ...
  <Step>
    ...
    * \*\*누적 사고 시간: 누적 기간이 긴 경보
    * \*\*평균 종료 시간: 인시던트가 종료될 때까지 걸리는 시간
...
<UserJourneyControls previousStep={{"path":"/docs/tutorial-create-alerts/create-an-alert/","title":"이전 단계","body":"New Relic을 사용하여 알림을 만드는 방법 알아보기"}}/>