...
알림 피로 등을 방지하기 위해 알림 품질을 관리하는 방법과 사용 방법을 알아볼 수 있습니다. <InlinePopover type="alerts"/>아래 프로세스에 따라 데이터를 수집하고 조직에 긍정적인 영향을 미치세요.
...
<Steps>
  <Step>
    ...
    1. [**Alert Quality Management**](https://newrelic.com/instant-observability/alert-quality-management)\[경고 품질 관리] 즉시 관찰 가능성 페이지로 이동합니다.
    2. **Install now** \[지금 설치를]클릭합니다.
  ...
  <Step>
    ...
    3. 대시보드를 사용하여 가장 시끄러운 인시던트 정책을 식별합니다.
...
<UserJourneyControls
  previousStep={{"path":"/docs/tutorial-create-alerts/create-an-alert/","title":"이전 단계","body":"New Relic을 사용하여 알림을 만드는 방법 알아보기"}}
  nextStep={{"path":"/docs/tutorial-create-alerts/manage-alert-quality/","title":"다음 단계","body":"알림 품질을 관리하고 개선하는 방법 알아보기"}}
/>
