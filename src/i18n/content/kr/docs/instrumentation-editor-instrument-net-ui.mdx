...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM & services > (.NET 앱 선택) > Settings > Instrumentation:** **Instrumentation** 편집기는 UI에서 사용자 정의 계측을 보거나 편집하는 쉬운 방법을 제공합니다. 이 XML 예제는 어셈블리 이름, 클래스 이름 및 메서드 이름을 보여줍니다.
</figcaption>
...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM** 으로 이동합니다. 앱을 찾은 다음 **Settings > Instrumentation** 을 클릭합니다.
