...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM > (.NET 앱 선택) > Settings > Instrumentation:** **계측** 편집기를 사용하면 UI에서 사용자 지정 계측을 쉽게 보거나 편집할 수 있습니다. 이 XML 예제는 어셈블리 이름, 클래스 이름 및 메서드 이름을 보여줍니다.
</figcaption>
...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities)** 으로 이동하여 **APM** 을 클릭합니다. 앱을 찾은 다음 **Settings > Instrumentation** 을 클릭합니다.
