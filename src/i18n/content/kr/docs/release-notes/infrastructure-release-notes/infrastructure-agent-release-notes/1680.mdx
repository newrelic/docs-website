...
* [#2125](https://github.com/newrelic/infrastructure-agent/pull/2125)에서 go 버전을 1.25.0으로 업그레이드했습니다.
* [#2128](https://github.com/newrelic/infrastructure-agent/pull/2128)에서 의존성/종속성 newrelic/nri-winservices를 v1.3.0으로 업데이트했습니다.