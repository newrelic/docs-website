...
* ~~Netty &apos;알 수 없음&apos; 트랜잭션 [2274](https://github.com/newrelic/newrelic-java-agent/pull/2274)수정~~
  ...
  * ~~이 수정을 통해 이전 Netty 측정, 계측 변경 사항을 기능 플래그 뒤로 이동하여 HTTP2 트랜잭션과 관련된 일부 경우에 가시성을 높였습니다. 이 세분성을 다시 활성화하려면(&apos;알 수 없음&apos; 트랜잭션이 표시될 수 있음) 구성 설정을 사용하세요.~~:
...
<Callout variant="caution">
  **알려진 문제**: 이 릴리스에는 Netty와 관련하여 &apos;알 수 없는&apos; 트랜잭션이 지속되는 알려진 문제가 있습니다. 이후 버전으로 업데이트하세요.
</Callout>
