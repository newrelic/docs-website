...
* @obenkenobi가 [2465년](https://github.com/newrelic/newrelic-java-agent/pull/2465)에 MongoDB Reactive Streams 5.2.0 이상을 지원했습니다.
* @kanderson250이 [2466년](https://github.com/newrelic/newrelic-java-agent/pull/2466)에 Jedis 6을 지원했습니다.

## 수정 사항

* CouchBase: 이중 측정을 방지하기 위해 건너뛰기 클래스 추가, [2462](https://github.com/newrelic/newrelic-java-agent/pull/2462)에서 @jtduffy 작성
* Spring WebClient 5.x: @jtduffy가 [2464년](https://github.com/newrelic/newrelic-java-agent/pull/2464)에 작성한 전체 응답 대신 헤더만 래핑
