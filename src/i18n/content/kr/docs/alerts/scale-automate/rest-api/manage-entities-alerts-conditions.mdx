...
<InlinePopover type="alerts" />에서 <DNT>**entity**</DNT> 은(는) 애플리케이션, 브라우저 또는 호스트와 같은 모니터링을 위한 모든 타겟으로 정의됩니다. [알림 UI](https://one.newrelic.com/alerts/) 는 선택할 수 있는 사용 가능한 엔티티를 보여줍니다. 또한 REST API 및 API Explorer를 사용하여 조건에 대한 엔티티를 [추가](https://api.newrelic.com/docs/#/Alerts%20Entity%20Conditions/put_alerts_entity_conditions__entity_id__json) 하거나 [제거](https://api.newrelic.com/docs/#/Alerts%20Entity%20Conditions/delete_alerts_entity_conditions__entity_id__json) 할 수 있습니다.
