...
3. 정책과 연결된 조건 목록을 가져오고 적절한 범주에 대해 수정할 조건을 선택합니다.
   ...
   * [<InlinePopover type="apm" />, <InlinePopover type="browser" />및<InlinePopover type="mobile" />](/docs/alerts/new-relic-alerts/rest-api-alerts/rest-api-calls-new-relic-alerts#conditions)
