...
* 조건의 `id` ( [API 탐색기에서 사용 가능:](https://rpm.newrelic.com/api/explore/alerts_condition/list)

  <DNT>**Alerts Conditions > GET > List**</DNT>
   ...
   <CollapserGroup>
     ...
     >
       ...
       * <InlinePopover type="apm">[](/docs/alerts/new-relic-alerts/rest-api-alerts/rest-api-calls-new-relic-alerts#conditions-list)</InlinePopover>
         ...
         [및](/docs/alerts/new-relic-alerts/rest-api-alerts/rest-api-calls-new-relic-alerts#conditions-list)
...
1. 업데이트하려는 정책의 <DNT>**policy_id**</DNT> 가져옵니다. `Logjam Alert` 라는 가상 정책의 경우 명령은 다음과 같습니다.
