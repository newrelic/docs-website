...
* 기본적으로 이 엔드포인트는 미국 데이터센터를 사용합니다. 조직에서 EU 데이터센터에 데이터를 호스팅하는 경우, 적절한 [EU 지역 계정용 API 엔드포인트](/docs/using-new-relic/welcome-new-relic/getting-started/introduction-eu-region-data-center#endpoints)를 사용하고 있는지 확인하십시오.
