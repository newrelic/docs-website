...
<CollapserGroup>
  ...
  >
    ...
    2. 선택한 제품의 색인에서 엔터티의 색상별 상태가 연한 녹색 아이콘으로 표시되어 있는지 확인하세요.<img title="Alerts v3: alert icons" alt="icon-alerts-q-green.png" src="/images/accounts_icon_green-question-mark.webp"/>
