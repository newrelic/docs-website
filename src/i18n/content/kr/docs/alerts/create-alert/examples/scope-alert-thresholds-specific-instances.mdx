...
* [`condition_id`](/docs/using-new-relic/welcome-new-relic/get-started/glossary#alert-condition) (API 탐색기에서 사용 가능: [<DNT>**Alerts Conditions &gt; GET &gt; List**</DNT>](https://api.newrelic.com/docs/#/Alerts%20Entity%20Conditions))
