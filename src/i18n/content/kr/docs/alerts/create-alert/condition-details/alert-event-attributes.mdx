...
공지 이벤트를 여는 조건은 중요한 정보를 다운스트림으로 전달하는 이벤트를 생성합니다.

공지 이벤트 및 기타 용어의 정의에 대한 자세한 내용 [은 용어집을](/docs/new-relic-solutions/get-started/glossary/) 참조하십시오.

## 공지이벤트란 무엇인가요? [#definition]

[공지이벤트](/docs/new-relic-solutions/get-started/glossary#alert-event) 는 공지사항에 정의된 조건을 위반한 이벤트입니다. 이 이벤트에는 다양한 속성(메타데이터)이 첨부되어 있으며, 각기 다른 속성은 서로 다른 기능에서 사용될 수 있습니다.

<Callout variant="important">
  공지 이벤트는 알림 여부를 결정하는 데 사용되는 개념입니다. NerdGraph를 통해 관련 속성 중 일부를 쿼리할 수 있지만 공지 이벤트를 직접 쿼리할 수는 없습니다.
</Callout>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        NRQL 또는 인프라 조건에만 해당됩니다. 공지 조건 [제목](docs/alerts/create-alert/condition-details/title-template) 또는 [설명 템플릿](/docs/alerts/create-alert/condition-details/custom-alert-event-descriptions) 과 함께 사용할 수 없습니다.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        인시던트만의 독특한 아이템입니다. 공지 조건 [제목](docs/alerts/create-alert/condition-details/title-template) 또는 [설명 템플릿](/docs/alerts/create-alert/condition-details/custom-alert-event-descriptions) 과 함께 사용할 수 없습니다.
      </td>
    </tr>
