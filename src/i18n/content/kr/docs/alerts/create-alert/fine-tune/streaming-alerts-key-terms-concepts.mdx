...
<Callout variant="tip">
  ...
  신호 손실 및 간격 채우기에 대해 자세히 알아보려면 [이 Support Forum 게시물](https://knowledge.newrelic.com/s/article/How-Can-I-Figure-Out-When-To-Use-Gap-Filling-and-Loss-of-Signal)을 참조하십시오.
</Callout>