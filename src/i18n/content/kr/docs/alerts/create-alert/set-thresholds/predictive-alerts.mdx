...
<DNT>**Predictive Alerts**</DNT> 모든 고객의 모든 [<DNT>Full platform users</DNT>](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type/#user-type-capabilities) 이(가) 사용할 수 있습니다. [<DNT>Data + User</DNT>](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing/) 요금 모델을 사용하는 고객의 경우 추가 비용이 없습니다. [<DNT>Data + Core Compute</DNT>](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing/) 요금제 모델을 사용하는 고객의 경우, 이력 데이터를 분석하고 예측을 생성할 때 [Core CCU](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing/#core-compute-capacity-unit) 가 소비됩니다.
