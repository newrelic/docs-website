...
[특정 엔터티에 대한 정책 및 조건 정보를](/docs/alerts/new-relic-alerts-beta/configuring-alert-policies/view-policy-conditions-new-relic-products) 보려면 해당 엔터티의 제품 UI 에서 <DNT>**Settings**</DNT>을 선택한 다음 <DNT>**Alert conditions**</DNT>을 클릭하세요.