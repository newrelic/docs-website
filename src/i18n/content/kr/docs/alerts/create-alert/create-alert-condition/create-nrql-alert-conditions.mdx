...
정책에서 NRQL 알림 조건을 생성하려면 <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert Conditions & Policies**</DNT>로 이동합니다. 그런 다음 <DNT>**+ New alert condition**</DNT>을 클릭합니다.
...
<figcaption>
  <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert Conditions & Policies > + New alert condition**</DNT>으로 이동합니다.
</figcaption>
...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="3단계. 임계값 정의"
  >
    인시던트를 열 항목을 결정하기 위해 [임계값](/docs/alerts-applied-intelligence/new-relic-alerts/advanced-alerts/advanced-techniques/set-thresholds-alert-condition/)을 정의할 수 있습니다. 정의한 후 <DNT>**Next**</DNT>를 클릭합니다.
  </Collapser>
  ...
  >
    ...
    * <DNT>**Save & set up notifications**</DNT>을 클릭합니다.

    <DNT>**Existing policy**</DNT>를 선택한 경우, 정책을 선택한 후 <DNT>**Save condition**</DNT>을 클릭합니다.
  </Collapser>
</CollapserGroup>
...
1. <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & Services**</DNT>로 이동하여 앱을 선택합니다.

2. 왼쪽 창에서 <DNT>**Metrics explorer**</DNT>를 선택하고 설정을 추가합니다.

3. 차트의 오른쪽 모서리에서 <Icon name="fe-more-horizontal"/> 아이콘을 클릭하고 <DNT>**Create alert condition**</DNT>을 선택합니다.
