...
<Steps>
  <Step>
    ...
    * 왼쪽 탐색에서 <DNT>**Alert Conditions**</DNT> 선택합니다.
    * 그런 다음 <DNT>**New alert condition**</DNT> 선택합니다.
    * <DNT>**Write your own query**</DNT> 선택합니다.
...
<DocTiles>
  <DocTile title="Create your first New Relic alert" path="/docs/tutorial-create-alerts/create-new-relic-alerts/" label={{text: "Start here", color: "orange"}}>초보자를 위한 알림 집중 코스 공지 </DocTile><DocTile title="Advanced alert conditions" path="/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-alert-conditions/">조건을 이미 설정했다면 고급 설정으로 더 깊이 파고들어 보세요</DocTile> <DocTile title="Get notified" path="/docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows/">.</DocTile>
</DocTiles>