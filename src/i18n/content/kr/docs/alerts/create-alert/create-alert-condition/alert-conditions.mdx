...
<Steps>
  ...
  <Step>
    ...
    <CollapserGroup>
      ...
      <Collapser id="predict-alert" title="정적 예비 값을 사용한 예측 알림(공개 미리 보기에서 사용 가능)">
        <Callout title="시사">
        ...
        뉴렐릭의 <DNT>**Predictive Alerts**</DNT> 는 이력 데이터를 사용하여 정적 레버 값 위반을 예측하는 모델을 구축합니다. 예측할 미래 시점을 설정할 수 있습니다. 침해가 예상되면 예측적 공지 이벤트가 발생하여 중단이 발생하기 전에 조치를 취할 수 있습니다.

        <DNT>**Predictive Alerts**</DNT> 을 활성화하려면:
        ...
        3. 미래 예측 시간을 설정하여 컴퓨팅, 경계가 얼마나 미래에 침해될지 예측합니다. 최대 예측 시간은 [창 기간의](/docs/alerts/create-alert/create-alert-condition/alert-conditions/#window-duration) 360배입니다.
        ...
        <DNT>**Predictive Alerts**</DNT> 에 대해 자세히 알아보려면 [설명서를](/docs/alerts/create-alert/set-thresholds/predictive-alerts) 참조하세요.
      </Collapser>
