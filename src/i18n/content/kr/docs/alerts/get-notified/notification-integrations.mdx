...
<CollapserGroup>
  ...
  >
    ...
    3. 문제가 확인되거나 종료된 경우와 같은 공지 업데이트를 채널에서도 수신하도록 선택할 수 있습니다. 이를 스레드 브로드캐스트라고도 합니다.<img title="thread braodcast" alt="a screenshot depicting the thread broadcast in the UI." src={alertsThreadBroadcast}/>
