...
<CollapserGroup>
  ...
  <Collapser className="freq-link" id="slack" title="느슨하게">
    ...
    1. <DNT>**[one.newrelic.com &gt; All capabilities](https://one.newrelic.com/all-capabilities) &amp;gt; Alerts**</DNT> 으로 이동하여 <DNT>**Destinations**</DNT> 클릭한 다음 <DNT>**Slack**</DNT> 선택합니다.
    2. <DNT>**Authenticate in one click**</DNT> 버튼을 클릭하여 Slack 방문 페이지로 이동하고 OAuth2 인증 프로세스를 계속하세요. 필수 워크스페이스에 로그인하지 않은 경우 로그인을 위해 Slack으로 리디렉션됩니다.
    ...
    3. 작업공간 이름을 추가하거나 관련 작업공간을 선택하고 <DNT>**Continue**</DNT> 클릭합니다.
    ...
    5. <DNT>**Allow**</DNT> 클릭하고 대상 페이지로 돌아갑니다.
