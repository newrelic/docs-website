...
알림은 시스템에 문제가 있을 때 적시에 공지를 보냅니다. 때로는 볼 필요가 없다는 것을 알고 있는 공지가 있습니다. <DNT>**muting rules**</DNT> 사용하면 주의가 필요하지 않은 메시지가 쏟아지는 것을 막을 수 있습니다.
...
음소거 규칙을 생성, 활성화, 비활성화 및 관리할 수 있습니다. <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Muting rules**</DNT> 로 이동합니다. 언제든지 음소거 규칙을 활성화하거나 비활성화할 수 있습니다. 다음을 클릭하세요. <Icon name="fe-more-horizontal"/> 규칙을 편집하고 제거하려면 각 규칙의 행에 있는 아이콘을 클릭하세요.
...
<img
  ...
  src="/images/accounts_screenshot-full_muting-rules.webp"
/>

<figcaption>
  <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Muting rules**</DNT>: 원치 않는 공지의 작은 또는 큰 집합에 대해 복잡한 음소거 규칙을 생성할 수 있습니다.
</figcaption>
...
<img
  ...
  src="/images/accounts_screenshot-full_rules-recurring.webp"
/>

<figcaption>
  <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Muting rules**</DNT>: 음소거 규칙 예약을 위한 유연하고 강력한 옵션입니다.
</figcaption>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        <DNT>**is**</DNT> 이(가) 음소거한 인시던트로 인해 문제가 활성화되었습니다.
      </td>
...
<CollapserGroup>
  ...
  >
    <img
      ...
      src="/images/accounts_screenshot-full_rules-incident-violations.webp"
    />

    <figcaption>
      <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Issues**</DNT> 으로 이동하여 음소거된 문제를 클릭하세요.
    </figcaption>
  </Collapser>
  ...
  >
    인시던트와 이슈는 <Icon name="fe-bell-off"/> <DNT>**Muted**</DNT> 열의 아이콘:

    <img
      title="Alert incident lifecycle: Muting rule incidents"
      alt="Alert incident lifecycle: Muting rule incidents"
      src="/images/accounts_screenshot-full_muting-rules-open-incidents-.webp"
    />
