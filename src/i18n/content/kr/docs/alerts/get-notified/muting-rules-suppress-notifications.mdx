...
음소거 규칙을 생성, 활성화, 비활성화 및 관리할 수 있습니다. <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Muting rules**</DoNotTranslate> 로 이동합니다. 언제든지 음소거 규칙을 활성화하거나 비활성화할 수 있습니다. 다음을 클릭하세요. <Icon name="fe-more-horizontal"/> 규칙을 편집하고 제거하려면 각 규칙의 행에 있는 아이콘을 클릭하세요.
...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Muting rules**</DoNotTranslate>: 원치 않는 공지의 작은 또는 큰 집합에 대해 복잡한 음소거 규칙을 생성할 수 있습니다.
</figcaption>
...
음소거 규칙을 만들려면 <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Muting rules**</DoNotTranslate> 으로 이동하여 <DoNotTranslate>**+ Add a rule**</DoNotTranslate> 클릭하세요. 음소거 규칙의 이름과 설명(선택 사항)을 입력하고 규칙을 적용할 계정을 선택하세요.
...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Muting rules**</DoNotTranslate>: 음소거 규칙 예약을 위한 유연하고 강력한 옵션입니다.
</figcaption>
...
<CollapserGroup>
  ...
  >
    ...
    <figcaption>
      <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Issues**</DoNotTranslate> 으로 이동하여 음소거된 문제를 클릭하세요.
    </figcaption>
  </Collapser>
