...
음소거 규칙을 만들고, 활성화하고, 비활성화하고, 관리할 수 있습니다. <DNT>**[one.newrelic.com &gt; All capabilities](https://one.newrelic.com/all-capabilities) &amp;gt; Alerts &amp;gt; Muting rules**</DNT> 로 이동합니다. 언제든지 음소거 규칙을 활성화하거나 비활성화할 수 있습니다. 클릭하세요 <Icon name="fe-more-horizontal" /> 각 규칙의 행에 있는 아이콘을 클릭하여 규칙을 편집하고 제거합니다.
...
* `IS_ANY`: <DNT>**Caution:**</DNT> 이 연산자가 포함된 조건은 계정에서 <DNT>**all**</DNT> 인시던트를 음소거합니다.
