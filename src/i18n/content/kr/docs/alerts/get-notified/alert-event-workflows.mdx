...
5. 권장 사항: 팀 태그별로 문제를 필터링하여 해당 엔터티가 문제에 포함될 때 모든 팀이 알림을 받을 수 있도록 합니다. 단계는 아래 데모에서 찾을 수 있습니다.
   ...
   태그 사용에 대한 몇 가지 팁은 [워크플로우 패턴에 대한 이 지원 포럼 게시물](https://support.newrelic.com/s/hubtopic/aAX8W0000008dNf/relic-solution-patterns-for-implementing-alerts-workflows)을 참조하십시오.
