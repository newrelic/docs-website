...
음소거 규칙을 생성, 활성화, 비활성화 및 관리할 수 있습니다. **[one.newrelic.com](https://one.newrelic.com/all-capabilities)** 으로 이동하여 상단 탐색 메뉴에서 **Alerts & AI** 를 클릭한 다음 **Muting rules** 를 클릭합니다. 언제든지 음소거 규칙을 활성화하거나 비활성화할 수 있습니다.
...
<CollapserGroup>
  ...
  >
    ...
    <figcaption>
      **[one.newrelic.com](https://one.newrelic.com/all-capabilities)** 으로 이동하여 상단 탐색 메뉴에서 **Alerts & A** I, **Incidents를 차례로 클릭합니다.**
    </figcaption>
  </Collapser>
  ...
  >
    ...
    <figcaption>
      **[one.newrelic.com](https://one.newrelic.com/all-capabilities)** 으로 이동하고 상단 탐색 메뉴에서 **Alerts & AI** 를 클릭하고 **Incidents** 를 클릭한 다음 **Open issues를 클릭합니다.**
    </figcaption>
  </Collapser>
  ...
  >
    ...
    <figcaption>
      **[one.newrelic.com](https://one.newrelic.com/all-capabilities)** 으로 이동하여 상단 탐색 메뉴에서 **Alerts & AI** 를 클릭한 다음 **Events를 클릭합니다.**
    </figcaption>
  </Collapser>
  ...
  >
    ...
    <figcaption>
      **[one.newrelic.com](https://one.newrelic.com/all-capabilities)** 으로 이동하여 상단 탐색 메뉴에서 **Alerts & AI** , **Events** , **All events 를 차례로 클릭합니다.**
    </figcaption>
  </Collapser>
</CollapserGroup>
