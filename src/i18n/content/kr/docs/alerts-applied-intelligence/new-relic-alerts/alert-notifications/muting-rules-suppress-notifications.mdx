...
음소거 규칙을 생성, 활성화, 비활성화 및 관리할 수 있습니다. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI > Muting rules**로 이동합니다. 언제든지 음소거 규칙을 활성화하거나 비활성화합니다. 클릭 <Icon name="fe-more-horizontal"/> 규칙을 편집하고 제거하려면 각 규칙의 행에 있는 아이콘을 클릭하십시오.
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI > Muting rules** : 원치 않는 알림의 작거나 큰 집합을 대상으로 하는 복잡한 음소거 규칙을 만들 수 있습니다.
</figcaption>
...
뮤팅 규칙을 생성하려면 **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI > Muting rules** 으로 이동하고 **+ Add a rule**클릭합니다. 음소거 규칙의 이름과 설명(선택 사항)을 입력하고 규칙을 적용할 계정을 선택합니다.
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI > Muting rules**: 규칙 숨기기 일정을 위한 유연하고 강력한 옵션입니다.
</figcaption>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        음소거된 사건 **으로** 인해 문제가 열립니다.
      </td>

      <td/>

      <td>
        "미결 문제" 알림이 전송 **되지 않습니다** (음소거됨).
      </td>
    </tr>
    ...
    <tr>
      <td>
        새로운 **음소거되지** 않은 사건이 열린 문제에 추가되었습니다.
      </td>

      <td>
        "미결 문제" 알림 **이 전송되지 않았습니다.**
      </td>
...
<CollapserGroup>
  ...
  >
    ...
    <figcaption>
      **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI > Issues** 이동하여 음소거된 문제를 클릭합니다.
    </figcaption>
  </Collapser>
