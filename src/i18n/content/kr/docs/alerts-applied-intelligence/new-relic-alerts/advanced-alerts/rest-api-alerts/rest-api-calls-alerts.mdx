...
REST API를 사용하여 알림 데이터를 관리하기 전에 [API 소개를 읽어보세요. <InlinePopover type="alerts"/>그리고 응용지능](/docs/alerts-applied-intelligence/new-relic-alerts/advanced-alerts/alerts-api/intro-alerts-api).
