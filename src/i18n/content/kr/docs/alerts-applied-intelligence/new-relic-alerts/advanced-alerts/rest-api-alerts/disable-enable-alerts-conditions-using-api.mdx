...
REST API는 더 이상 경고를 프로그래밍 방식으로 관리하는 데 선호되는 방법이 아닙니다. 자세한 내용은 [API 소개를 읽어보세요. <InlinePopover type="alerts"/>그리고 응용지능](/docs/alerts-applied-intelligence/new-relic-alerts/advanced-alerts/alerts-api/intro-alerts-api).
   ...
   <CollapserGroup>
     ...
     >
       ...
       * <InlinePopover type="apm">[](/docs/alerts/new-relic-alerts/rest-api-alerts/rest-api-calls-new-relic-alerts#conditions-list)</InlinePopover>
         ...
         [, 그리고](/docs/alerts/new-relic-alerts/rest-api-alerts/rest-api-calls-new-relic-alerts#conditions-list)
