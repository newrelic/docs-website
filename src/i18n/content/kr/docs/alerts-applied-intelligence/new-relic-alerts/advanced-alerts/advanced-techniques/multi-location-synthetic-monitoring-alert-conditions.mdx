...
1. **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Alert conditions (정책)** 으로 이동 [하여 조건을 생성하는](/docs/alerts/new-relic-alerts/defining-conditions/define-alert-conditions#create-condition) 프로세스를 시작합니다.
