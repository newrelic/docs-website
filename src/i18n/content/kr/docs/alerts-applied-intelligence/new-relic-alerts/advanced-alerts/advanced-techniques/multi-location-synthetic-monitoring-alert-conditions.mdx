...
1. **[one.newrelic.com](https://one.newrelic.com/ "링크가 새 창에서 열립니다.")** 상단 탐색에서 **Alerts & AI** 를 클릭하고 **Alert conditions (Policies)** 를 클릭하고 프로세스를 시작하여 [조건을 생성합니다](/docs/alerts/new-relic-alerts/defining-conditions/define-alert-conditions#create-condition) .
