...
[NRQL 조건](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/nrql-alert-conditions/) 을 사용하여 알림을 받고자 하는 신호 부분을 제어할 수 있습니다. NRQL 조건은 [스트리밍 알고리즘](/docs/using-new-relic/welcome-new-relic/get-started/glossary#streaming-algorithm) 에 의해 처리되는 데이터를 필터링합니다.
...
<Callout variant="tip">
  이 문서에서는 개념적 수준에서 이러한 도구를 다룹니다. [NRQL 경고 조건 생성](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/nrql-alert-conditions) 에서 이러한 도구를 사용하는 방법에 대한 직접적인 지침을 찾을 수 있습니다.
</Callout>
...
집계 기간을 **30 seconds** \[30초] 에서 **2 hours** \[2시간] 사이로 설정할 수 있습니다. 기본값은 **1 minute** \[1분] 입니다.
