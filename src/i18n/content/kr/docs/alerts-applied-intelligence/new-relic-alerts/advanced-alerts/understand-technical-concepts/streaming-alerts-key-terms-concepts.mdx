...
<CollapserGroup>
  ...
  >
    ...
    <figcaption>
      데이터가 일관되고 예측 가능하게 도착하는 경우 <DoNotTranslate>**event flow**</DoNotTranslate> 사용하세요. 데이터가 일관되지 않고 예측할 수 없게 도착하는 경우 <DoNotTranslate>**event timer**</DoNotTranslate> 사용하세요.
    </figcaption>
  </Collapser>
</CollapserGroup>
...
집계 창을 <DoNotTranslate>**30 seconds**</DoNotTranslate> 에서 <DoNotTranslate>**6 hours**</DoNotTranslate> 사이의 값으로 설정할 수 있습니다. 기본값은 <DoNotTranslate>**1 minute**</DoNotTranslate> 입니다.
...
지연 기본값은 <DoNotTranslate>**2 minutes**</DoNotTranslate> 입니다. 타이머 기본값은 <DoNotTranslate>**1 minute**</DoNotTranslate> 이고 최소값은 <DoNotTranslate>**5 seconds**</DoNotTranslate>, 최대값은 <DoNotTranslate>**20 minutes**</DoNotTranslate> 입니다.
