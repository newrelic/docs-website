...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Alert conditions (Policies) > (select a policy) > (select a condition)**</DoNotTranslate>: 필드를 열려면 <DoNotTranslate>**+ Add custom incident description**</DoNotTranslate> 클릭하세요.
</figcaption>
