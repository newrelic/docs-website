...
[집계 창 기간](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/streaming-alerts-key-terms-concepts/#window-duration)을 설정하여 데이터가 집계되기 전에 스트리밍 시간 창에서 데이터가 누적되는 기간을 선택할 수 있습니다. 30초에서 120분 사이로 설정할 수 있으며, 기본값은 1분입니다.
...
[지연/타이머](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/streaming-alerts-key-terms-concepts/#delay-timer)를 조정하여 [스트리밍 알림 알고리즘](/docs/new-relic-solutions/get-started/glossary/#streaming-algorithm)을 데이터 동작과 조정할 수 있습니다. 데이터가 희박하거나 일관성이 없는 경우, 이벤트 타이머 집계 방법을 사용할 수 있습니다.
