...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [하위 쿼리](/docs/query-your-data/nrql-new-relic-query-language/get-started/subqueries-in-nrql)는 스트리밍과 호환되지 않습니다. <InlinePopover type="alerts"/>하위 쿼리를 실행하려면 데이터를 여러 번 통과해야 하기 때문입니다.
      </td>
    </tr>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * 인시던트 및 알림에 포함될 **Add details** \[세부 사항 추가] 페이지에서 조건에 대한 커스텀 인시던트 설명을 제공합니다.
