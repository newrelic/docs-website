...
**[one.newrelic.com > All capabilities ](https://one.newrelic.com/all-capabilities)> Alerts & AI > Alert Conditions & Policies**로이동하여 정책에서 NRQL 알림 조건을 생성합니다. 그런 다음 **+ New alert condition**을 클릭합니다.
...
<figcaption>
  **[one.newrelic.com >All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Alert Conditions & Policies > + New alert condition**으로 이동합니다.
</figcaption>
...
1. **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM 및 서비스**로 이동하여 앱을 선택합니다.

2. 왼쪽 창에서 **Metrics explorer**를 선택하고 구성을 추가합니다.

3. 차트의 오른쪽 모서리에서 <Icon name="fe-more-horizontal"/> 아이콘을 클릭하고 **Create alert condition**을 선택합니다.
...
null 값을 처리하는 방법을 결정하려면 [alerts 조건 UI](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-alert-conditions/#signal-loss)에서 신호 손실 및 간격 채우기 설정을 조정합니다.
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * 인시던트 및 알림에 포함될 [조건에 대한 커스텀 인시던트에 대한 설명](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/alert-custom-incident-descriptions)을 제공합니다.
...
* 슬라이드 바이 간격 변경( [슬라이딩 창 집계](https://docs.newrelic.com/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-alert-conditions/#sliding-window-aggregation) 조건에서만)
...
<figcaption>
  **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Alert conditions (Policies)**으로 이동한 다음 **+ New alert condition**으로 이동합니다. 신호 손실은 NRQL 조건에서만 사용할 수 있습니다.
</figcaption>
