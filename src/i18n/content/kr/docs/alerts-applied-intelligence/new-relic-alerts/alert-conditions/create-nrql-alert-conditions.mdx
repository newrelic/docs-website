...
**[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI > Alert Conditions & Policies**로 이동하여 정책에서 NRQL 알림 조건을 생성합니다. 그런 다음 **+ New alert condition**을 클릭합니다.
