...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert conditions (Policies) > (select a policy) > Add a condition**</DoNotTranslate>. <DoNotTranslate>**NRQL**</DoNotTranslate> 클릭한 다음 <DoNotTranslate>**Next, define thresholds**</DoNotTranslate> 클릭합니다.
</figcaption>
...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert conditions (Policies) > (select a policy)**</DoNotTranslate> 으로 이동한 다음 <DoNotTranslate>**Add a condition**</DoNotTranslate> 로 이동하세요. 신호 손실은 NRQL 조건에서만 사용할 수 있습니다.
</figcaption>
