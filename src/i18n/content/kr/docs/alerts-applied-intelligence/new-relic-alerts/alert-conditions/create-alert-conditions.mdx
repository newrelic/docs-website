...
1. **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Alert conditions > (조건 선택)** 로 이동합니다.
2. 줄임표 메뉴(...)를 클릭하고 **Edit** \[편집을] 클릭하여 편집한 다음 의미 있는 조건 이름을 입력합니다.
