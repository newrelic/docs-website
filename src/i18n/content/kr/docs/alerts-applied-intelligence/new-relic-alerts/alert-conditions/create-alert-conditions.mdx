...
<CollapserGroup>
  ...
  >
    ...
    조건과 함께 동적 대상 지정을 사용하려면 [인시던트 종료 타이머를](/docs/alerts/new-relic-alerts/reviewing-alert-incidents/how-alert-condition-violations-are-closed#time-limit) 설정해야 합니다.
