...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="이상 조건"
  >
    [이상 경고를 사용하면](/docs/alerts/new-relic-alerts/configuring-alert-policies/create-anomaly-alert-conditions) 주간 또는 계절별 패턴과 같이 변화하는 데이터 및 추세에 동적으로 조정되는 조건을 만들 수 있습니다. 이 기능은 다음에서 사용할 수 있습니다. [<InlinePopover type="apm"/>](/docs/apm/new-relic-apm/getting-started/welcome-new-relic-apm)그리고 [<InlinePopover type="browser"/>](/docs/browser/new-relic-browser/getting-started/new-relic-browser)앱뿐만 아니라 [NRQL 쿼리](/docs/alerts/new-relic-alerts/defining-conditions/create-alert-conditions-nrql-queries) 도 가능합니다.
  </Collapser>
