  ...
  <Step>
    ...
    <CollapserGroup>
      ...
      >
        ...
        [문서](/docs/alerts-applied-intelligence/new-relic-alerts/advanced-alerts/advanced-techniques/alert-custom-incident-descriptions) 에서 사용자 정의 사고 설명에 대해 자세히 알아보십시오.
      </Collapser>
