  ...
  >
    ...
    * 가입하려는 각 비공개 채널에 대한 초대장이 필요합니다.
      ...
      **허용** 을 클릭하고 대상 페이지로 돌아갑니다.
      ...
      메시지를 보낼 대상(Workspace)과 Slack 채널을 선택합니다. 필요한 작업 공간에 대해 미리 정의된 대상이 없는 경우 새 대상을 생성할 수 있습니다. 개인 정보 보호를 위해 개인 채널을 선택하려면 사용자가 한 번 인증해야 합니다. 기본 알림을 사용하거나 문제 페이로드의 자유 텍스트 또는 동적 변수를 사용하여 더 많은 세부 정보를 제공할 수 있습니다. [변수 메뉴](/docs/alerts-applied-intelligence/notifications/message-templates/#variables-menu) 에서 변수를 선택하고 [핸들바 구문](/docs/alerts-applied-intelligence/notifications/message-templates/#handlebars-syntax) 을 적용하여 페이로드를 풍부하게 만드십시오.
