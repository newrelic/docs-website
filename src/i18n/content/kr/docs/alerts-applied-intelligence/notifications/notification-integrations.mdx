...
<CollapserGroup>
  ...
  >
    ...
    * **사용자 ID:** 현재 로그인한 사용자를 기준으로 자동으로 채워집니다.
      ...
      <Callout variant="important">
        현재 로그인한 사용자에 대한 모바일 푸시 대상 생성으로 제한됩니다. 사용자에 대해 하나의 푸시 대상만 만들 수 있습니다. 하나 이상을 만들려고 하면 오류가 나타납니다. 대상을 저장하기 전에 연결 **테스트** 버튼을 통해 연결을 테스트하는 것이 좋습니다.
      </Callout>

      ## 푸시 알림 수신 시기 구성 [#workflow-mobile]

      워크플로를 만들거나 편집하고 모바일 알리미를 클릭하고 원하는 대상을 선택하고 워크플로를 저장합니다.
  </Collapser>
</CollapserGroup>
