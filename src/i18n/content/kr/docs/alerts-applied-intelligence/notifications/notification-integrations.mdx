...
<CollapserGroup>
  ...
  >
    ...
    * PagerDuty 인시던트가 확인되면 New Relic 문제에 대한 확인이 트리거됩니다.
    ...
    3. 목록에서 New Relic 통합을 찾아 표시하고 **Add **을 클릭합니다.<img title="PagerDuty New Relic integration." alt="New Relic integration." src={accountsPagerDutyAddNewRelicIntegration}/>

    4. 오른쪽을 클릭하여 **통합 키 **을 보고 복사합니다.<img title="PagerDuty New Relic integration key." alt="New Relic integration key." src={accountsPagerDutyIntegrationOpened}/>
