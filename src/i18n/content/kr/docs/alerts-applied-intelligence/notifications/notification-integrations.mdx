...
<CollapserGroup>
  ...
  >
    ...
    Slack 워크스페이스에는 [New Relic 애플리케이션](https://newrelic.slack.com/apps/AP92KQJS3-new-relic?tab=more_info) 이 설치되어 있어야 합니다. 애플리케이션을 개별적으로 설치하기 전에 워크스페이스 관리자가 애플리케이션을 승인해야 합니다. 앱 지원은 [support@newrelic.com](mailto:support@newrelic.com) 으로 문의하십시오.
