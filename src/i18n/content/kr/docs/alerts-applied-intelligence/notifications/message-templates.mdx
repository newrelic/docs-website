...
Handlebars 언어는 반복(루프), 조건문 등과 같은 [중첩 입력 개체](https://handlebarsjs.com/guide/#nested-input-objects) 및 함수 평가를 포함하여 기본 변수 대체 외에도 많은 기능을 제공합니다. 핸들바에서 이러한 기능을 도우미라고 합니다.
