...
* 기본. 이 대상에는 오류가 없습니다.
* 구성\_오류. 이 대상은 구성 오류로 인해 알림을 수신하지 않습니다. 자세한 내용은 NrIntegrationError 표를 참조하십시오.
* 알수없는 오류. 이 대상은 알 수 없는 오류로 인해 알림을 수신하지 않습니다. 자세한 내용은 [NrIntegrationError 테이블](/docs/data-apis/ingest-apis/metric-api/troubleshoot-nrintegrationerror-events/#error-details) 을 참조하십시오.
* 스로틀링\_경고. 이 대상은 제한 오류로 인해 알림을 수신하지 않습니다. 자세한 내용은 타사 목적지를 확인하십시오.
* 설치되지 않았습니다. New Relic 애플리케이션이 설치되지 않았으며 이 대상을 더 이상 사용할 수 없습니다.
* EXTERNAL_SERVER_ERROR. 이 대상은 외부 서버 오류로 인해 알림을 수신하지 않습니다. 자세한 내용은 타사 목적지를 확인하십시오.
* 타임아웃\_오류. 이 대상은 시간 초과로 인해 알림을 수신하지 않습니다. 자세한 내용은 타사 목적지를 확인하십시오.
* AUTH_ERROR. 이 목적지는 알림을 수신하지 않습니다. 타사 대상 자격 증명을 확인하십시오.
