...
<Callout variant="tip">
  `aiNotifications` [NerdGraph API](https://developer.newrelic.com/collect-data/get-started-nerdgraph-api-explorer/) 를 사용하여 대상을 구성할 수도 있습니다.
</Callout>

## 필요한 기능 [#required-roles]

대상 설정에는 다음과 같은 특정 [기능이](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts#capabilities) 필요합니다.
...
1. [one.newrelic.com](https://docs.newrelic.com/one.newrelic.com) 으로 이동하여 **Alerts & AI** 를 클릭 **하고 Enrich and Respond** 아래의 왼쪽 탐색 메뉴에서 **Destinations** 를 클릭합니다. 대상 테이블에는 기존 대상에 대한 정보가 표시되며 사용자가 활성화, 비활성화 및 수정할 수 있습니다.
