...
응용 프로그램을 음소거하면 구성에서 영구적으로 제거됩니다. 다시 추가하려면 **[one.newrelic.com](https://one.newrelic.com/all-capabilities)** 으로 이동하십시오. 상단 탐색 메뉴에서 **Alerts & AI** 를 클릭한 다음 **anomaly detection** 을 클릭하고 편집할 구성을 선택합니다.
