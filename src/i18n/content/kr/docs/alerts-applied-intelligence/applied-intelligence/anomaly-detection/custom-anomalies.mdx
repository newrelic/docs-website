...
[경고 조건](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/nrql-alert-conditions/)에서 사용자 정의 이상 임계값을 생성할 수 있습니다. 이상 임계값을 설정하기 위한 몇 가지 팁은 다음과 같습니다.
