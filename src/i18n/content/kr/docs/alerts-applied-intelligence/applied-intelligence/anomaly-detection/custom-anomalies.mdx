...
2. **+ New alert condition > Use guided mode** 클릭합니다.
3. **Set thresholds** \[임계값 설정] 에 도달할 때까지 단계별 안내를 따르세요.
4. **Anomaly** \[이상 현상 을] 선택합니다.
...
6. 경고 조건의 세부 정보를 추가하고 **Save condition**클릭합니다.
