...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities)** 으로 이동하여 **알림 및 AI** 를 클릭합니다. 왼쪽 탐색의 **Incident Intelligence** 아래에서 **Decisions** 를 클릭합니다.
...
사용자 정의 결정을 작성하여 노이즈를 줄이고 상관 관계를 개선할 수 있습니다. 결정을 내리려면 **[one.newrelic.com](https://one.newrelic.com/all-capabilities)** 으로 이동하여 **Alerts & AI** 를 클릭하십시오. 왼쪽 탐색의 **사고 정보** 아래에서 **결정** 을 클릭한 다음 **결정 추가** 를 클릭합니다.
