...
1. **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Incident intelligence > Decisions** 으로 이동합니다.
...
사용자 지정 결정을 작성하여 노이즈를 줄이고 상관 관계를 개선할 수 있습니다. 결정 작성을 시작하려면 **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Incident Intelligence > Decisions** 로 이동한 다음 **Add decision** 을 클릭하십시오.
