...
<table id="global-decision-descriptions">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        New Relic [조건 ID](/docs/alerts-applied-intelligence/new-relic-alerts/advanced-alerts/understand-technical-concepts/incident-event-attributes/#attributes) 가 동일하기 때문에 상관 관계가 활성화됩니다. 예를 들어, 관련 서비스와 함께 CPU 사용량이 증가하면 동일한 CPU 사용량 조건에서 인시던트가 발생하여 식별됩니다. 이 논리는 상관 시간 창을 정의할 때 조건 수준의 세분성과 유연성으로 인해 조건당 하나의 문제에 대한 [경고 정책 문제 생성 기본 설정 옵션](/docs.newrelic.com/docs/alerts-applied-intelligence/new-relic-alerts/alert-policies/specify-when-alerts-create-incidents#preference-options) 을 넘어 가치가 있습니다.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        New Relic [조건 이름과 제목](/docs/alerts-applied-intelligence/new-relic-alerts/advanced-alerts/understand-technical-concepts/incident-event-attributes/#attributes) 이 동일하기 때문에 상관 관계가 활성화됩니다. 이는 동일한 경고 메시지와 더 긴밀한 관련성을 나타내기 위해 조건과 함께 제목을 비교함으로써 개선된 옵션입니다.
      </td>
    </tr>
...
* 논리 필터: [](#operators)[속성](/docs/alerts-applied-intelligence/new-relic-alerts/advanced-alerts/understand-technical-concepts/incident-event-attributes/#attributes)에 대한 연산자 로 정의된 논리 조건입니다.
