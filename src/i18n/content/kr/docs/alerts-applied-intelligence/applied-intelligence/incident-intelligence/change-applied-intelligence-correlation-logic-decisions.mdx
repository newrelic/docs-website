...
사용자 정의 결정을 작성하여 노이즈를 줄이고 상관 관계를 개선할 수 있습니다. 결정을 내리려면 **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI > Incident Intelligence > Decisions** 로 이동한 다음 **Add decision** 을 클릭하십시오.
...
1. **[one.newrelic.com](https://one.newrelic.com)** 에서 **Alerts & AI** 를 클릭하고 **Issues & Activity** 를 클릭한 다음 **Incidents** 탭을 클릭합니다.
