...
사용자 지정 결정을 구축하여 잡음을 줄이고 상관 관계를 개선할 수 있습니다. 의사결정을 시작하려면 **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI** > **Correlate** > **Decisions**로 이동한 다음 **Create new decision** 을 클릭하십시오.
