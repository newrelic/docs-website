...
문제 알림 로그에 액세스하려면 **[one.newrelic.com > Alerts & AI > Workflows](https://one.newrelic.com/alerts-ai/workflows)**로 이동한 다음 **Issue Notification Log**클릭하십시오.
...
사용자는 문제 알림 로그의 행을 클릭하여 추가 세부 정보를 볼 수 있습니다. 그러면 오류 세부 정보(해당하는 경우)와 타사의 알림 링크가 표시됩니다.