...
6. 알림: 하나 이상의 대상을 선택하고 선택적 메시지를 추가합니다.
...
7. 알리미 요구 사항을 완료한 후 **업데이트 메시지** 클릭
8. 선택적으로 워크플로를 테스트합니다. 계정의 기존 데이터를 사용하여 구성한 항목을 테스트하고 샘플 알림을 보냅니다.
9. **활성화** 를 클릭하여 워크플로를 완료합니다.
