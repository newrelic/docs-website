...
워크플로우 기능은 <DoNotTranslate>**Alerts **</DoNotTranslate>메뉴 아래에 있습니다.

1. <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Enrich and Notify > Workflow > Add a workflow**</DoNotTranslate> 으)로 이동합니다.
...
문제 공지 로그에 액세스하려면 <DoNotTranslate>**[one.newrelic.com > Alerts > Workflows](https://one.newrelic.com/alerts-ai/workflows)**</DoNotTranslate> 으로 이동한 다음 <DoNotTranslate>**Issue notification log**</DoNotTranslate> 클릭하세요.
