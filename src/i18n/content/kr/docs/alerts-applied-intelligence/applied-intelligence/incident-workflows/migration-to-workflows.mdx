...
`incident_id` 는 기본 알림 시스템에서 보낸 모든 알림에 있었습니다. 워크플로에서는 [결정](https://docs.newrelic.com/docs/alerts-applied-intelligence/applied-intelligence/incident-intelligence/change-applied-intelligence-correlation-logic-decisions/) [유예 기간을](https://docs.newrelic.com/docs/alerts-applied-intelligence/applied-intelligence/incident-intelligence/user-settings/#grace-period)사용하는 계정에서만 사용할 수 있습니다.
