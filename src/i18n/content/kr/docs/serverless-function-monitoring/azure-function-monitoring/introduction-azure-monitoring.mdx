...
<Steps>
    ...
    <Tabs>
      ...
      <TabsPages>
        ...
        <TabsPageItem id="windows">
          다음 런타임 환경에 대해 에서 New Relic을 사용하여 Azure Function App을 모니터링할 수 있습니다.Windows
  ...
  <Step>
    ...
    Azure Function을 New Relic으로 계측한 후 런타임 환경에 대한 [환경 변수를 구성합니다](/docs/serverless-function-monitoring/azure-function-monitoring/env-variables-azure) .
  </Step>
