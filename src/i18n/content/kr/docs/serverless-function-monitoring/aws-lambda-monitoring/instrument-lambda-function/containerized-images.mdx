...
<Steps>
  <Step>
    ...
    <Tabs>
      <TabsBar>
        <TabsBarItem id="java">Java</TabsBarItem> <TabsBarItem id="python">Python</TabsBarItem> <TabsBarItem id="nodejs">Node.js</TabsBarItem> <TabsBarItem id="ruby">루비</TabsBarItem> <TabsBarItem id="dotnet">.NET</TabsBarItem> <TabsBarItem id="extension">확장 전용</TabsBarItem>
      </TabsBar>
