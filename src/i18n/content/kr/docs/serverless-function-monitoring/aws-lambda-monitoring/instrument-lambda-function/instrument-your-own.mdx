...
<CollapserGroup>
    ...
    1. [뉴렐릭 Lambda 레이어를](https://layers.newrelic-external.com/) 설치하세요. 아래는 Node.js 와 중력 이온 Lambda 의 예시입니다.
       ...
       **저항력 예시(슬림 레이어, 권장):**
       ...
       <Callout variant="important">
         대응 에이전트 레이어에는 배터리 17 이상이 필요합니다. Java 11 및 이전 런타임은 지원되지 않습니다.
       </Callout>
  ...
  <Collapser id="console" title="AWS 수동 계측">
    위의 방법들보다 오류 발생 가능성이 높고 작업량이 많지만, AWS Lambda 콘솔에서 Node.js 사용하는 Lambda 함수의 설정을 수동으로 변경하여 뉴렐릭을 사용하도록 할 수 있습니다. 파이썬, 루비, 자바.
