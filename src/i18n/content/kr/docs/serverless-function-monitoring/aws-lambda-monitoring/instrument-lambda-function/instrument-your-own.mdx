  ...
  <Collapser id="console" title="AWS 수동 계측">
    ...
    13. 다음 환경 변수를 정의합니다.
        ...
        * `NEW_RELIC_LAMBDA_HANDLER`: 이전에 복사한 함수의 원래 Handler 값으로 설정합니다.
          ...
          * `NEW_RELIC_LOG_ENDPOINT`: https://log-api.newrelic.com/log/v1로 설정하세요.
          * `NEW_RELIC_TELEMETRY_ENDPOINT`: https://cloud-collector.newrelic.com/aws/lambda/v1로 설정합니다.
...
<CollapserGroup>
  ...
  <Collapser id="fallback" title="CloudWatch 전용 및 CloudWatch 대체">
