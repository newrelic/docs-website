...
## AWS 권한 [#aws-permissions]

### 인프라 통합 권한 [#integration-permissions]

기본적으로 뉴렐릭은 AWS 관리형 정책 `ReadOnlyAccess`을 사용합니다. 이를 통해 인프라 통합은 Lambda 함수 및 CloudWatch 지표뿐만 아니라 계정의 모든 리소스를 볼 수 있습니다. 뉴렐릭은 이 기본값을 권장하지만, 조직에서 타사 통합에 대해 엄격한 보안 태세를 요구하는 경우 대신 IAM 역할에 최소한 다음 권한을 부여할 수 있습니다:
...
자세한 내용은 [newrelic-lambda CLI 리포지터리를](https://github.com/newrelic/newrelic-lambda-cli#installation) 참조하세요.
...
<Tabs>
  ...
  <TabsPages>
    <TabsPageItem id="1">
      ...
      * 루비: `ruby3.2`, `ruby3.3`, `ruby3.4`, `ruby4.0`
      * .NET: `dotnet6`, `dotnet8`
    </TabsPageItem>
    ...
    <TabsPageItem id="3">
      ...
      * 파이썬(OS/Arch: Linux, Windows, ARM, ARM 64, x86, x86-64): `python3.7`, `python3.8`, `python3.9`, `python3.10`, `python3.11`, `python3.12`, `python3.13`, `python3.14`
