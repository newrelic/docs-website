...
당사의 예제는 뉴렐릭 Lambda 확장 프로그램과 함께 이 [GitHub 저장소](https://github.com/newrelic/newrelic-lambda-extension-rust)에 게시되어 있습니다. 뉴렐릭이 지원하는 각 Lambda 런타임마다 하나씩 제공됩니다:

* [노드.js](https://github.com/newrelic/newrelic-lambda-extension-rust/tree/main/examples/sam/node)
* [파이썬](https://github.com/newrelic/newrelic-lambda-extension-rust/tree/main/examples/sam/python)
* [가다](https://github.com/newrelic/newrelic-lambda-extension-rust/tree/main/examples/sam/go)
* [자바](https://github.com/newrelic/newrelic-lambda-extension-rust/tree/main/examples/sam/java)
* [루비](https://github.com/newrelic/newrelic-lambda-extension-rust/tree/main/examples/sam/ruby)
* [.그물](https://github.com/newrelic/newrelic-lambda-extension-rust/tree/main/examples/sam/dotnet)

또한 당사의 [분산 추적 예제](https://github.com/newrelic/newrelic-lambda-extension-rust/tree/main/examples/sam/distributedtracing)에서 복잡한 서버리스 애플리케이션에 분산 추적을 계측하는 방법을 알아볼 수 있습니다. 이는 Node, 파이썬, 루비 및 자바 함수를 사용하여 Lambda 함수를 호출할 수 있는 인기 있는 두 서비스인 SQS 및 SNS에 대한 수동 트레이스 전파를 보여줍니다.
...
<DocTiles>
  <DocTile title="호환성 및 요구 사항" path="/docs/serverless-function-monitoring/aws-lambda-monitoring/instrument-lambda-function/compatibility-requirement-lambda-monitoring">
    지원되는 런타임 및 전제 조건에 대해 자세히 알아보십시오.
  </DocTile>
