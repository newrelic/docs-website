...
먼저 [AWS Lambda용 OpenTelemetry SDK](https://www.nuget.org/packages/OpenTelemetry.Instrumentation.AWSLambda/) 와 [OTLP 내보내기 패키지를](https://www.nuget.org/packages/OpenTelemetry.Exporter.OpenTelemetryProtocol) 추가합니다.
