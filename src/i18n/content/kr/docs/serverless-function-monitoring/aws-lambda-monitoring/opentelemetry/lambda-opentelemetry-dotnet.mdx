...
<Steps>
  <Step>
    ...
    3. <DoNotTranslate>**Specify an ARN**</DoNotTranslate> 아래에 아래 목록에서 함수 아키텍처에 대한 계층 ARN 중 하나를 붙여넣습니다. `{region}`AWS 지역(예: `us-east-1`)으로 바꿉니다.
  ...
  <Step>
    ...
    4. <DoNotTranslate>**Environment variables**</DoNotTranslate>
    ...
    5. <DoNotTranslate>**Add environment variable**</DoNotTranslate>

       선택합니다.

    6. <DoNotTranslate>**Key**</DoNotTranslate>
    ...
    7. <DoNotTranslate>**Add environment variable**</DoNotTranslate>

       다시 선택하세요.

    8. <DoNotTranslate>**Key**</DoNotTranslate>
    ...
    9. <DoNotTranslate>**Add environment variable**</DoNotTranslate>

       다시 선택하세요.

    10. <DoNotTranslate>**Key**</DoNotTranslate>
