...
<figcaption>
  **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > All entities > Amazon Web Services > Lambda functions**: 차트와 세부 정보를 보려면 Lambda 함수를 클릭합니다.
</figcaption>
