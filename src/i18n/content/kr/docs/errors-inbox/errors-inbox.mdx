...
<CollapserGroup>
  <Collapser
    ...
    title="발생 탭"
  >
    <DoNotTranslate>**Occurrences**</DoNotTranslate> 드롭다운 메뉴에는 다음과 같은 세부정보가 포함되어 있습니다.
    ...
    * <DoNotTranslate>**Distributed trace**</DoNotTranslate> 에서는 이 페이지에 표시된 오류 발생과 관련된 트레이스를 볼 수 있습니다. 폭포 보기에서 트레이스의 범위를 보려면 다음을 수행하세요.
