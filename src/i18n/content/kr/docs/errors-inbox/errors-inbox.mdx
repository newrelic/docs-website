...
<CollapserGroup>
  <Collapser
    ...
    title="발생 탭"
  >
    <DNT>**Occurrences**</DNT> 드롭다운 메뉴에는 다음과 같은 세부정보가 포함되어 있습니다.
  ...
  <Collapser
    ...
    title="토론 탭"
  >
    <DNT>**Discussions**</DNT> 탭은 상세하고 체계적인 공동작업을 위한 공간을 제공합니다. 이는 공동 작업자를 연결하고 팀 전체가 어디에 앉아 있는지에 관계없이 동일한 컨텍스트를 갖도록 보장하는 데 핵심입니다. 토론에는 다음이 포함됩니다.
