...
[로그 관리 기능](/docs/logs/logs-context/logs-in-context) 에 대한 액세스는 사용자 유형에 따라 제한됩니다. [사용자 유형 기능을](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type#user-type-capabilities) 참조하십시오.
