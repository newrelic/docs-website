...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Browser > (앱 선택) > Errors**로 이동합니다.
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Browser 이동합니다. 그런 다음 앱을 클릭하고 **오류** 섹션에서 오류(오류 수신함)를 클릭합니다 ****. **프로필 보기\*\* 버튼을 클릭하여 특성 프로필 테이블을 엽니다.
</figcaption>
