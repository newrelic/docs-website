...
[NRQL 경고 조건을](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-alert-conditions/) 생성하면 개발자가 트리거할 수 있습니다. <InlinePopover type="alerts"/>오류의 영향을 받는 사용자 수가 임계값을 초과하는 경우.
