...
* [브라우저](/docs/data-apis/custom-data/custom-events/report-mobile-monitoring-custom-events-attributes/#track-user)
* [이동하는](/docs/browser/new-relic-browser/browser-apis/setuserid/)