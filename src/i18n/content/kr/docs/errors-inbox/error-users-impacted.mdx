...
이제 오류 그룹의 영향을 받은 사용자 수를 확인할 수 있으므로 가장 큰 영향을 미치는 오류 그룹에 집중할 수 있습니다. 영향을 받은 사용자는 목록 보기의 발생 횟수 측정항목 옆에 나열됩니다. 특정 수 이상의 사용자에게 영향을 미치는 오류 그룹에 대한 [경고를 설정할](/docs/errors-inbox/error-users-impacted/#alerting-on-users-impacted) 수도 있습니다.
...
[NRQL 경고 조건을](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-alert-conditions/) 생성하면 개발자는 오류의 영향을 받는 사용자 수가 임계값을 초과할 때 경고를 트리거할 수 있습니다.
...
[UniqueCount()](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-nrql-alert-conditions/) 함수 사용, 엔터티의 [엔터티 ID를 찾는 방법](/docs/new-relic-solutions/new-relic-one/core-concepts/what-entity-new-relic/#find) 에 대해 자세히 알아보세요.
