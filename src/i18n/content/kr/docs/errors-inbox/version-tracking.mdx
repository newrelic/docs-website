...
<Callout variant="tip">
  <DoNotTranslate>**Resolve in next version**</DoNotTranslate> 및 <DoNotTranslate>**Resolve in specific version**</DoNotTranslate> 옵션은 팀에서 의미 체계 버전 관리를 사용하는 경우에만 지원됩니다.
</Callout>
