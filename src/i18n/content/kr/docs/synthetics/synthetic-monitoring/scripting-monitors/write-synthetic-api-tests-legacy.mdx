...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > Create monitor** : 스크립트 편집기는 [스크립팅 명령을 단순화하는 기능, 선택기 및 기타 요소를 제안합니다(GitHub에서 사용 가능)](https://github.com/request/request) .
</figcaption>
