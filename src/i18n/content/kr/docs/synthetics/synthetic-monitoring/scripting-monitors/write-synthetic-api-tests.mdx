...
API 테스트는 `$http` 객체를 통해 사용할 수 있는 [got 모듈](https://github.com/sindresorhus/got) 에 의해 구동됩니다. 모니터 생성에 대한 지침은 모니터 [추가](/docs/synthetics/new-relic-synthetics/using-monitors/adding-editing-monitors#adding-monitors) 를 참조하십시오.
