...
<Callout variant="important">
  이 문서는 Node 16.10 스크립트 API 런타임 이상을 대상으로 합니다. [`http-request` 기반 Node 10 및 이전 런타임에 대한 세부정보](/docs/synthetics/new-relic-synthetics/scripting-moitors/write-synthetic-api-tests-legacy.mdx)
</Callout>
