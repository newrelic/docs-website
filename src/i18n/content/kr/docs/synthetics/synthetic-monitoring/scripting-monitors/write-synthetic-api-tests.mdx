...
<Callout variant="tip">
  다른 API 테스트 예제를 확인하고 공유하려면 지원 포럼의 [신세틱스 스크립트](https://support.newrelic.com/s/hubtopic/Topic__c/Default?c__categories=%5B%7B%22icon%22%3A%22standard%3Adefault%22%2C%22id%22%3A%22a6c8W000000EeseQAC%22%2C%22sObjectType%22%3A%22Category__c%22%2C%22title%22%3A%22Synthetics%22%2C%22titleFormatted%22%3A%22Synthetics%22%7D%5D) 섹션 또는 [신세틱 모니터링 퀵스타트 라이브러리](https://newrelic.github.io/quickstarts-synthetics-library/#/)를 방문하십시오.
</Callout>
