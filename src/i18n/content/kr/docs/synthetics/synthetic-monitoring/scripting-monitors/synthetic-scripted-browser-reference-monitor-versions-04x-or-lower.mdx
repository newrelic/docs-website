...
* 스크립팅된 브라우저 예제를 보고 공유하려면 New Relic의 [지원 포럼](https://discuss.newrelic.com/c/support-products-agents/synthetics) 에서 [synthetic-script](https://discuss.newrelic.com/tags/c/support-products-agents/synthetics/synthetics-script) 태그가 지정된 주제를 확인하십시오.
