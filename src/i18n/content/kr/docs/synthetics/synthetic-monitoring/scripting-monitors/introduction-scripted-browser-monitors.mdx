...
스크립티드 모니터는 [셀레니엄 웹 드라이버](https://www.selenium.dev/documentation/webdriver/) 가 운영합니다. 펼쳐보기가 실행될 때마다 뉴렐릭은 웹사이트를 탐색하고 각 펼쳐보기 단계를 따르는 완전히 가상화된 셀레니엄 기반 Google Chrome 브라우저를 만듭니다. 신세틱 모니터링에는 펼쳐보기를 단순화하기 위한 기능, 로케이터 및 기타 요소를 제안하는 IDE 스타일의 펼쳐보기 편집기가 포함되어 있습니다.
