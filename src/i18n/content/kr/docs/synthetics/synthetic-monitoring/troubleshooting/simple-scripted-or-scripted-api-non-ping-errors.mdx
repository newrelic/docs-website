...
<CollapserGroup>
  <Collapser
    ...
    title="요소 A는 지점(X, Y)에서 클릭할 수 없습니다. 다른 요소는 클릭을 수신합니다. 요소 B"
  >
    ### 문제
  ...
  <Collapser
    id="no-such-element"
    title="오류: 해당 요소 없음: <LOCATOR> 요소를 찾을 수 없습니다."
  >
    ### 문제
    ...
    * 대상 요소는 다음과 같은 기능으로 [찾을](/docs/synthetics/new-relic-synthetics/scripting-monitors/synthetics-scripted-browser-reference-monitor-versions-050#locators) 수 없습니다.
      ...
      * $browser.waitForAndFindElement(locator: $driver.Locator \[, 시간 초과: 숫자
  ...
  <Collapser
    id="job-timed-out"
    title="JobTimeoutError: 180초 후 작업 시간이 초과되었습니다."
  >
    ### 문제
  ...
  <Collapser
    ...
    title="NetworkError: 모니터에서 트래픽이 생성되지 않았습니다."
  >
    ### 문제
  ...
  <Collapser
    ...
    title="ReferenceError: $network가 정의되지 않았습니다"
  >
    ### 문제
  ...
  <Collapser
    ...
    title="StaleElementReferenceError: 요소가 페이지 문서에 첨부되지 않았습니다."
  >
    ### 문제
  ...
  <Collapser
    id="task-timed-out"
    title="TaskTimedOut: <LOCATOR>를 사용하여 요소를 찾는 작업이 시간 초과되었습니다."
  >
    ### 문제
  ...
  <Collapser
    ...
    title="TypeError: $browser.isElementPresent는 함수가 아닙니다."
  >
    ### 문제

    런타임 >= 0.5.0인 Synthetics 모니터에서 사용하는 `isElementPresent()` 함수는 Selenium 3에서 더 이상 사용되지 않습니다.
...
<CollapserGroup>
  ...
  >
    ...
    * `$globalAgents.https`
      ...
      경우에 따라 API 모니터의 특정 [요청 옵션](https://github.com/request/request#requestoptions-callback) 으로 인해 Synthetics에서 계측하지 않은 새 HTTP 에이전트를 사용하여 HTTP 트래픽을 수집할 수 있습니다.
  </Collapser>
  ...
  <Collapser
    ...
    title="SyntaxError: 위치 0에서 JSON의 예기치 않은 토큰 u"
  >
    ### 문제
  ...
  <Collapser
    ...
    title="TypeError: 정의되지 않은 'statusCode' 속성을 읽을 수 없습니다."
  >
    ### 문제
