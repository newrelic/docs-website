  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * 신세틱스 Job Manager &quot;심장 박동&quot; 30초마다

          [`SyntheticsPrivateMinion` 이벤트에는](/attribute-dictionary/?event=SyntheticsPrivateMinion) 작업 성공 및 실패 횟수, 대기열 크기, 미니언 버전 등을 포함한 기본 신세틱스 Job Manager 상태가 포함되어 있습니다.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        신세틱 모델링 엔드포인트로부터 수신된 데이터에는 예정된 점검 내용이 포함되어 있습니다. 여기에는 신세틱스 잡 매니저에 대한 확인을 완료하는 데 필요한 정보가 포함됩니다.
    ...
    <tr>
      ...
      <td>
        [합성 위치 공개 기능은](/docs/synthetics/new-relic-synthetics/administration/synthetics-public-minion-ips) 개인 정보가 아닌 자격 증명을 사용하여 활성화될 것으로 예상됩니다. 이들의 IP 주소는 데이터 보호 및 개인 정보 보호법에 따라 개인 데이터로 정의되지 않습니다.
      </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * 합성 표시 위치에 대한 IP를 허용 목록 또는 거부 목록에 추가하세요.
    ...
    <tr>
      ...
      <td>
        큐 외에도 목표 URL 모니터 by 뉴렐릭 Synthetics Job Managers는 정기적으로 신세틱 모델링 파트포인트와 데이터를 주고받습니다. 이 엔드포인트로 들어오고 나가는 모든 트래픽에 대해 프록시를 구성하려면 [HORDE\_API\_PROXY\_HOST 및 HORDE\_API\_PROXY\_PORT 환경 변수를](/docs/synthetics/synthetic-monitoring/private-locations/job-manager-configuration/#environment-variables) 설정하십시오.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        실행하려는 펼쳐보기만 신세틱스 작업 관리자에서 실행되도록 허용하려면 [확인된 실행을](/docs/synthetics/new-relic-synthetics/private-locations/verified-script-execution-private-locations) 사용하세요.
      </td>
    </tr>
  </tbody>
</table>