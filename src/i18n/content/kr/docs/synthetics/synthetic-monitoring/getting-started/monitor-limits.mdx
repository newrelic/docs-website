...
조직의 [가격 책정 버전](https://newrelic.com/pricing) (Standard, Pro 또는 Enterprise)에 따라 매월 무료로 포함되는 합성 모니터 검사 수가 결정됩니다.
...
[가격 버전에](https://newrelic.com/pricing) 따라 매월 무료로 포함되는 종합 모니터 수표 수가 결정됩니다. 이러한 제한은 단순 ping 모니터를 제외한 모든 [모니터 유형](/docs/synthetics/synthetic-monitoring/getting-started/types-synthetic-monitors) 에 적용됩니다.
