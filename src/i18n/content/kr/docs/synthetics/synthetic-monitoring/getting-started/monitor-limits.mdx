...
[가격 버전에](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing/#editions) 따라 매월 무료로 포함되는 종합 모니터 수표 수가 결정됩니다. 이러한 제한은 단순 ping 모니터를 제외한 모든 [모니터 유형](/docs/synthetics/synthetic-monitoring/getting-started/types-synthetic-monitors) 에 적용됩니다.
