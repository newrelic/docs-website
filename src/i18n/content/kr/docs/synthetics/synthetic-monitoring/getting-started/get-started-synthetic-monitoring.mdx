...
<Steps>
  ...
  <Step>
    ...
    <SideBySide>
      ...
      <Side>
        <img title="View your summary page" alt="A screenshot of the summary page after a simple browser monitor reports data" src={syntheticResultsPageforSimpleBrowserMonitor} />
      </Side>
    </SideBySide>
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <SideBySide>
      ...
      <Side>
        <img title="View your summary page" alt="A screenshot of the summary page after a simple browser monitor reports data" src={syntheticStepMonitorSummaryPage} />
      </Side>
    </SideBySide>
  </Step>
</Steps>
...
<Tabs>
  <TabsBar>
    <TabsBarItem id="URL">URL로 이동</TabsBarItem> <TabsBarItem id="element">페이지 요소와</TabsBarItem> <TabsBarItem id="wait">상호 작용 페이지 요소 대기</TabsBarItem> <TabsBarItem id="login">웹사이트에 로그인</TabsBarItem>
  </TabsBar>
