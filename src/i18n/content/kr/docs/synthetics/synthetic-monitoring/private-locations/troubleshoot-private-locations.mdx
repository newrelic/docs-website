...
New Relic의 종합 모니터링을 위해 [개인 위치](/docs/synthetics/new-relic-synthetics/private-locations/private-locations-overview-monitor-internal-sites-add-new-locations) 를 설정하는 동안 문제가 발생하면 다음 문제 해결 팁을 시도하여 일반적인 미니언 또는 작업 관리자 문제를 식별하십시오.
