    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**CPU (vCPU/Core):**</DoNotTranslate> 0.5-0.75<br/> <DoNotTranslate>**Memory:**</DoNotTranslate> 500Mi-1Gi
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**CPU (vCPU/Core):**</DoNotTranslate> 0.5-0.75<br/> <DoNotTranslate>**Memory:**</DoNotTranslate> 1250Mi-2500Mi
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**CPU (vCPU/Core):**</DoNotTranslate> 1.0-1.5<br/> <DoNotTranslate>**Memory:**</DoNotTranslate> 2000Mi-3000Mi
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**Root volume:**</DoNotTranslate> 최소 50GiB<br/>
          </td>
        </tr>
...
2. <DoNotTranslate>**Private locations**</DoNotTranslate>
   ...
   색인에서 귀하의 신세틱스 작업 관리자를 배정할 별자리 로케이션을 찾으세요.
...
<CollapserGroup>
  ...
  >
    ...
    * 쓰기 가능한 Docker UNIX 소켓은 `/var/run/docker.sock` 또는 `DOCKER_HOST` [환경 변수](/docs/synthetics/synthetic-monitoring/private-locations/job-manager-configuration/#environment-variables) 에 마운트됩니다. 자세한 내용은 Docker의 [데몬 소켓 옵션](https://docs.docker.com/engine/reference/commandline/dockerd/#daemon-socket-option) 을 참조하십시오.
      ...
      <Callout variant="caution">
        호스트의 코어 수는 호스트에서 동시에 실행할 수 있는 런타임 컨테이너 신세틱스 작업 수를 결정합니다. 메모리 요구 사항은 예상되는 런타임 컨테이너 수에 따라 확장되므로 리소스 경합을 방지하려면 <DoNotTranslate>**not running multiple synthetics job managers on the same host**</DoNotTranslate> 사용하는 것이 좋습니다.
      </Callout>
