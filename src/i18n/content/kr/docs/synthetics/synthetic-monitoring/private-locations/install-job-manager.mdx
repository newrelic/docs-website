    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            <DNT>**Linux kernel:**</DNT> 4.18 or higher (Recommended for v447+)<br /> <DNT>**macOS:**</DNT> 10.11 or higher<br /> <DNT>**Windows:**</DNT> Windows 10 64-bit or higher
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            <DNT>**Linux kernel:**</DNT> 4.18 or higher (Recommended for v447+) <br /><DNT>**macOS:**</DNT> 10.11 or higher<br />
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            <DNT>**Linux kernel:**</DNT> [4.18 or higher (Recommended for v447+)](https://docs.redhat.com/en/documentation/openshift_container_platform/4.16/html/deploying_installer-provisioned_clusters_on_bare_metal/ipi-install-prerequisites#minimum-resource-requirements)<br /> <DNT>**macOS:**</DNT> 10.11 or higher<br />
