...
<CollapserGroup>
  <Collapser id="docker-requirements" title="도커 컨테이너 시스템 환경 요구 사항">
    <table>
      <thead>
        <tr>
  ...
  <Collapser id="podman-requirements" title="Podman 컨테이너 시스템 환경 요구 사항">
    <table>
      <thead>
        <tr>
          <th style={{ width: "265px" }}>
  ...
  <Collapser id="kubernetes-requirements" title="Kubernetes 컨테이너 오케스트레이션 시스템 환경 요구 사항">
    <table>
      <thead>
        <tr>
          <th style={{ width: "265px" }}>
...
<CollapserGroup>
  <Collapser id="docker-update" title="도커 시작 절차">
  ...
  <Collapser id="podman-update" title="Podman 시작 절차">
    1. [개인 위치 키](#private-location-key) 를 찾습니다.
  ...
  <Collapser id="kubernetes-install" title="Kubernetes 시작 절차">
    1. [개인 위치 키](#private-location-key) 를 찾습니다.
...
<CollapserGroup>
  <Collapser id="docker-stop" title="도커 정지 절차">
  ...
  <Collapser id="podman-stop" title="Podman 정지 절차">
  ...
  <Collapser id="kubernetes-delete" title="Kubernetes 삭제 절차">
...
<CollapserGroup>
  <Collapser id="docker-dependencies" title="도커 의존성/종속성">
...
<CollapserGroup>
  <Collapser id="podman-dependencies" title="Podman 종속성">
...
<CollapserGroup>
  <Collapser id="run-non-root" title="도커에 대해 루트가 아닌 사용자로 실행">
