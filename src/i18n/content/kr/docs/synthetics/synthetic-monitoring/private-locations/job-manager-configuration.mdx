...
* **작업 지속 시간($D\_\{avg,m}$):** 평균에는 **시간 초과되는** 작업(일반적으로 약 3분)이 포함되어야 합니다. 이러한 작업은 전체 지속 시간 동안 코어를 점유합니다.
...
## Kubernetes 및 OpenShift의 크기 조정 고려 사항 [#kubernetes-sizing]
