...
이를 확인하는 방법을 알아보려면 [내 개인 위치에 더 많은 합성 작업 관리자가 필요합니까?](/docs/synthetics/new-relic-synthetics/private-locations/monitor-private-locations#more-minions) 를 참조하세요.
