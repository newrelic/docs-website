...
<CollapserGroup>
  <Collapser
    ...
    title={<><img src={dockimport} title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}/>Docker 컨테이너 시스템 환경 요구 사항</>}
  >
    <table>
      <thead>
        <tr>
      ...
      <tbody>
        <tr>
          ...
          <td>
            <DoNotTranslate>**Linux kernel:**</DoNotTranslate> 3.10 이상<br/> <DoNotTranslate>**macOS:**</DoNotTranslate> 10.11 이상<br/> <DoNotTranslate>**Windows:**</DoNotTranslate> Windows 10 64비트 이상

            _또한 CPM이 Windows 시스템에서 작동하려면 Linux 컨테이너를 실행하도록 Docker를 구성해야 합니다._
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**Ping:**</DoNotTranslate> 무시할 만한<br/> <DoNotTranslate>**Scripted API:**</DoNotTranslate> 7<br/> <DoNotTranslate>**Simple browser:**</DoNotTranslate> 27<br/> <DoNotTranslate>**Scripted browser:**</DoNotTranslate> 28
            ...
            _Docker CPM의 기준은 실행 중인 모니터 작업이 없는 0.5 IOPS입니다._
          </td>
        </tr>
  ...
  <Collapser
    ...
    title={<><img src={synthetick8logo} title="Kubernetes icon" alt="Kubernetes icon" style={{ height: '35px', width: '40px' }}/>Kubernetes 컨테이너 오케스트레이션 시스템 환경 요구 사항(CPM v3.0.0 이상)</>}
  >
    <table>
      <thead>
        <tr>
      ...
      <tbody>
        <tr>
          ...
          <td>
            <DoNotTranslate>**Linux kernel:**</DoNotTranslate> 3.10 이상<br/> <DoNotTranslate>**macOS:**</DoNotTranslate> 10.11 이상<br/>
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**CPU (vCPU/Core):**</DoNotTranslate> 0.5-0.75<br/> <DoNotTranslate>**Memory:**</DoNotTranslate> 800Mi-1600Mi
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**CPU (vCPU/Core):**</DoNotTranslate> 0.5-1<br/> <DoNotTranslate>**Memory:**</DoNotTranslate> 1250Mi-3000Mi
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**Root volume:**</DoNotTranslate> 최소 50GiB(노드 + PV)<br/> <DoNotTranslate>**Persistent volume (PV):**</DoNotTranslate> 최소 20GiB
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**Ping:**</DoNotTranslate> 무시할 만한<br/> <DoNotTranslate>**Scripted API:**</DoNotTranslate> 11<br/> <DoNotTranslate>**Simple browser:**</DoNotTranslate> 33<br/> <DoNotTranslate>**Scripted browser:**</DoNotTranslate> 31
            ...
            _Kubernetes CPM의 기준은 실행 중인 모니터 작업이 없는 3.0 IOPS입니다._
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Kubernetes 클러스터는 [Kubernetes v1.15를](https://kubernetes.io/blog/2019/06/19/kubernetes-1-15-release-announcement/) 지원하는 것이 좋습니다. <Callout variant="caution">Kubernetes v1.21 이상의 경우 minion 릴리스 [v3.0.61](/docs/release-notes/synthetics-release-notes/containerized-private-minions-release-notes/containerized-private-minion-cpm-3061) 이상을 사용하세요.</Callout>
          </td>
        </tr>
...
1. <DoNotTranslate>**[one.newrelic.com > Synthetic monitoring > Private locations](https://one.newrelic.com/synthetics-nerdlets/private-location-list)**</DoNotTranslate>

   으)로 이동합니다.

2. <DoNotTranslate>**Private locations**</DoNotTranslate>

   색인에서 귀하의 분당 호출 번호를 할당할 카테고리 로케이션을 찾으세요.
...
<CollapserGroup>
  <Collapser
    ...
    title={<><img src={dockimport} title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}/>도커 종속성</>}
  >
    ...
    * 쓰기 가능한 Docker UNIX 소켓은 `/var/run/docker.sock` 또는 `DOCKER_HOST` [환경 변수](/docs/synthetics/new-relic-synthetics/private-locations/containerized-private-minion-cpm-configuration#environment-variables) 에 마운트됩니다. 자세한 내용은 Docker의 [데몬 소켓 옵션](https://docs.docker.com/engine/reference/commandline/dockerd/#daemon-socket-option) 을 참조하십시오.
      ...
      <Callout variant="caution">
        호스트의 코어 수는 분당 호출이 호스트에서 동시에 실행할 수 있는 실행기 컨테이너 수를 결정합니다. 메모리 요구 사항은 예상되는 실행기 컨테이너 수에 따라 조정되므로 리소스 경합을 방지하려면 <DoNotTranslate>**not running multiple CPMs on the same host**</DoNotTranslate> 사용하는 것이 좋습니다.
      </Callout>
...
<CollapserGroup>
  <Collapser
    id="docker-update"
    title={<><img src={dockimport} title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}/>도커 시작 절차</>}
  >
  ...
  <Collapser
    ...
    title={<><img src={synthetick8logo} title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png" style={{ height: '35px', width: '40px' }}/>Kubernetes 시작 절차</>}
  >
    <Callout
      variant="important"
      title="EOL 공지"
...
<CollapserGroup>
  <Collapser
    id="docker-stop"
    title={<><img src={dockimport} title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}/>도커 중지 절차</>}
  >
  ...
  <Collapser
    ...
    title={<><img src={synthetick8logo} title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png" style={{ height: '35px', width: '40px' }}/>Kubernetes 삭제 절차</>}
  >
    1. 삭제하려는 미니언 포드의 MINION_POD_INSTALLATION_NAME을 가져옵니다.
...
<CollapserGroup>
  <Collapser
    id="run-non-root"
    title={<><img src={dockimport} title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}/>Docker에 대해 루트가 아닌 사용자로 실행</>}
  >
