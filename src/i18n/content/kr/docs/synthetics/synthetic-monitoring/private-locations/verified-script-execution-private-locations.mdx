...
뉴렐릭 UI의 배열 위치 목록에는 <DNT>**VSE**</DNT> 열이 포함되어 있습니다. 자물쇠 <Icon name="fe-lock"/> 아이콘은 해당 위치에 대해 확인된 스크립트 실행이 설정되었음을 나타냅니다.
...
3. <DNT>**Verified script execution**</DNT>

   확인란을 선택합니다. 암호를 입력한 후 저장하세요. 암호를 안전한 곳에 기록해 두십시오.

4. <DNT>**[one.newrelic.com > Synthetic monitoring > Private locations](https://one.newrelic.com/synthetics-nerdlets/private-location-list)**</DNT>
