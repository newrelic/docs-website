...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > Private locations > (개인 위치 선택)로 이동** 합니다. 개인 위치의 줄임표 아이콘을 선택하고 **편집** 을 클릭합니다. 확인된 스크립트 실행을 활성화한 다음 저장합니다.
...
2. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > (할당된 모니터) > Settings > General** 으로 이동합니다.
...
2. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > Private locations > (개인 위치 선택)로 이동** 합니다. **확인된 스크립트 실행 활성화** 확인란의 선택을 취소한 다음 저장합니다.
...
4. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > Private locations > (개인 위치 선택)로 이동** 합니다. 개인 위치의 줄임표 아이콘을 선택하고 **편집** 을 클릭합니다. 확인된 스크립트 실행을 활성화한 다음 저장합니다.
