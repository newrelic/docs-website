...
<CollapserGroup>
  <Collapser
    ...
    title={<><img src={dockerLogoCrop} title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}/>Docker 로그 검토</>}
  >
  ...
  <Collapser
    ...
    title={<><img src={imgIntegrationK8S402X} title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png" style={{ height: '35px', width: '40px' }}/>Kubernetes 로그 검토</>}
  >
...
<CollapserGroup>
  <Collapser
    ...
    title={<><img src={dockerLogoCrop} title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}/>Docker 디버그 로그 활성화</>}
  >
    <Callout variant="tip">
  ...
  <Collapser
    ...
    title={<><img src={imgIntegrationK8S402X} title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png" style={{ height: '35px', width: '40px' }}/>Kubernetes 디버그 로그 활성화</>}
  >
    <Callout variant="tip">
...
## 새로운 유물 인프라로 CPM 모니터링 [#monitor-via-infrastructure]
