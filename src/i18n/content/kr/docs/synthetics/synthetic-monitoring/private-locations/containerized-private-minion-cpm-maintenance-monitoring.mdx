...
<CollapserGroup>
  <Collapser
    ...
    title={<><img src="/images/synthetic_logo_docker-logo.webp" title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}/>Docker 로그 검토</>}
  >
  ...
  <Collapser
    ...
    title={<><img src="/images/synthetic_logo_k8logo.webp" title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png" style={{ height: '35px', width: '40px' }}/>Kubernetes 로그 검토</>}
  >
...
<CollapserGroup>
  <Collapser
    ...
    title={<><img src="/images/synthetic_logo_docker-logo.webp" title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}/>Docker 디버그 로그 활성화</>}
  >
    <Callout variant="tip">
  ...
  <Collapser
    ...
    title={<><img src="/images/synthetic_logo_k8logo.webp" title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png" style={{ height: '35px', width: '40px' }}/>Kubernetes 디버그 로그 활성화</>}
  >
    <Callout variant="tip">
      `Kubernetes logs` 에 `-f` 를 추가하면 명령이 로그를 따릅니다.
    </Callout>

    DEBUG 로그를 활성화하려면 `helm install` 을 실행할 때 `--set synthetics.minionLogLevel=DEBUG` 옵션을 추가합니다.
