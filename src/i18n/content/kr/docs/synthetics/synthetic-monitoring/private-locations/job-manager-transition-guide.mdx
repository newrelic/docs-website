...
작업 관리자를 다운로드할 준비가 되셨습니까? 시작하기 위한 몇 가지 옵션이 있습니다. 설치 절차에 대한 [설치 문서](/docs/synthetics/synthetic-monitoring/private-locations/install-job-manager) 를 확인하거나 신규 또는 기존 [개인 위치](/docs/synthetics/new-relic-synthetics/private-locations/private-locations-overview-monitor-internal-sites-add-new-locations) 작업에 대한 [구성 문서](/docs/synthetics/new-relic-synthetics/private-locations/job-manager-configuration) 를 읽어보십시오.
