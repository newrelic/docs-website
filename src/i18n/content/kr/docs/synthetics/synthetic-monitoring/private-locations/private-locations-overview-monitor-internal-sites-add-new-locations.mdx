...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetic monitoring >Private locations** : **개인 위치** 페이지를 사용하여 개인 위치를 생성, 편집 및 삭제합니다.
</figcaption>

1. [계정 액세스 요구](#account-access) 사항을 포함하여 [요구 사항](#requirements) 을 충족하는지 확인합니다.

2. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetic monitoring >Private locations** 로 이동합니다. 그런 다음 선택 <Icon name="fe-plus-circle"/>**개인 위치를 만듭니다** .
...
이러한 도구에 액세스하려면 **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetic monitoring >Private locations** 로 이동하십시오. 그런 다음 다음 단계를 따르세요.
