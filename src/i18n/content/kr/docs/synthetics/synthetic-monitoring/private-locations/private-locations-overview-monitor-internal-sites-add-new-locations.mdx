...
<img
  ...
  src={syntheticPrivateLocations}
/>

<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > Private Locations** : **개인 위치** 페이지를 사용하여 개인 위치를 생성, 편집 및 삭제합니다.
</figcaption>
...
2. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > Private locations** 로 이동합니다. 그런 다음 선택 <Icon name="fe-plus-circle"/>**개인 위치를 만듭니다** .
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > Create monitor** : 개인 위치와 미니언에 새 작업을 할당하려면 모니터 **만들기** 페이지에서 이름을 선택합니다.
</figcaption>
...
이러한 도구에 액세스하려면 **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > Private locations** 로 이동하십시오. 그런 다음 다음 단계를 따르세요.
