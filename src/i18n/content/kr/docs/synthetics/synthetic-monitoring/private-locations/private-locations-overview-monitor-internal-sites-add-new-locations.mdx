  ...
  <tbody>
    ...
    <tr id="account-access">
      ...
      <td>
        ...
        * 최신 사용자 모델: 계정에 대한 사용자 액세스 권한 [은 해당 계정에 대한 액세스 권한이 부여](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts#understand-concepts) 되었는지 여부에 따라 다릅니다.
      </td>
    </tr>
  </tbody>
</table>
