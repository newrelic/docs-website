...
[합성 작업 관리자](/docs/synthetics/new-relic-synthetics/private-locations/install-job-manager) [를 설치하거나 개인 미니언(레거시)](/docs/synthetics/new-relic-synthetics/private-locations/install-containerized-private-minions-cpms) 을 설치하기 전에 개인 위치를 생성해야 합니다. 새 개인 위치를 만들려면:
