  ...
  >
    ...
    <Steps>
      <Step>
        ...
        1. **[one.newrelic.com > Synthetic monitoring > Private locations](https://one.newrelic.com/synthetics/private-location-list)** 로 이동합니다. 그런 다음 **Create private location** \[비공개 위치 생성을] 클릭합니다.<img title="Screenshot showing where to add a new private location" alt="Screenshot showing where to add a new private location" src="/images/synthetic_screenshot-crop_private-location-add.webp"/>
      ...
      <Step>
        ...
        1. **[one.newrelic.com > Synthetic monitoring](https://one.newrelic.com/synthetics)** 으로 이동합니다. 모니터 오른쪽에 있는 줄임표 아이콘 **...** 을 클릭하고 **Monitor settings** \[모니터 설정 을] 선택합니다.
