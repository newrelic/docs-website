...
위치를 생성한 후 신세틱 모니터링은 다음 [미니언을 설치할](/docs/synthetics/new-relic-synthetics/private-locations/install-containerized-private-minions-cpms#install-update) 수 있도록 <DNT>**Private location key**</DNT> 을 나열합니다.
  ...
  <Collapser id="rotate-private-location-keys" title="개인 위치 키 순환">
    ...
    <Steps>
      <Step>
        ...
        2. 로케이션 이름을 입력하고, <DNT>**Enable verified script execution**</DNT> 확인하세요. 그런 다음 <DNT>**Generate key**</DNT> 클릭하여 새 로케이션을 생성하세요.
        ...
        3. 새로운 절연 로케이션으로 작업 관리자나 절연 항언을 업데이트하세요. <DNT>**Configure and deploy**</DNT> 섹션에는 샘플 코드가 포함되어 있습니다.
