  ...
  >
    ...
    <Steps>
      <Step>
        ...
        1. **[one.newrelic.com > Synthetic monitoring > Private locations](https://one.newrelic.com/synthetics/private-location-list)** 로 이동합니다. 그런 다음 **Create private location** \[비공개 위치 생성을] 클릭합니다.<img
