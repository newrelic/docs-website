...
<CollapserGroup>
  ...
  >
    ...
    1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetic monitoring >(모니터 선택) > Summary** 이동합니다.
...
1. 종합 모니터링 UI에서: **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetic monitoring >(모니터 선택) > Summary** 이동합니다.
