...
<CollapserGroup>
  ...
  >
    ...
    1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > (모니터 선택) > Summary** 이동합니다.
...
1. 합성 모니터링 UI에서: **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > (모니터 선택) > Summary** 이동합니다.
