...
[종합 모니터링은](/docs/synthetics/new-relic-synthetics/getting-started/introduction-new-relic-synthetics) 웹사이트, 중요한 비즈니스 거래, API 엔드포인트를 정기적으로 확인하여 최적의 성능을 측정합니다. 우리의 [<InlinePopover type="browser"/>](/docs/browser/new-relic-browser/getting-started/introduction-new-relic-browser)다양한 장치, 브라우저 및 연결 속도에 걸쳐 웹페이지 성능의 실제 결과를 추적합니다. 함께 사용하면 실제 사용자(브라우저) 상호 작용과 합성 모니터 간의 직접적인 페이지 로드 시간 비교를 제공합니다.
