...
<CollapserGroup>
  ...
  >
    ...
    1. **[one.newrelic.com > Synthetic monitoring](https://one.newrelic.com/synthetics-nerdlets)** > (모니터 선택) > **Summary**으로 이동합니다.
  ...
  >
    ...
    1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Browser > (브라우저 앱 선택) > Page views** 로 이동합니다.
...
1. 합성 모니터링 UI에서: **[one.newrelic.com > Synthetic monitoring](https://one.newrelic.com/synthetics-nerdlets)** > (모니터 선택) > **Summary**으로 이동합니다.

   또는

   브라우저 모니터링 UI에서: **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Browser > (브라우저 앱 선택) >Page views** 로 이동한 다음 종합 모니터링으로 모니터링되는 페이지를 선택합니다.
