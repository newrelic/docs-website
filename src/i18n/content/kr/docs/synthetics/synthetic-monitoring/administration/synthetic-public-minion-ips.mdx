...
<Callout variant="important">
  두 환경에서 요청을 보낼 수 있으므로 허용 목록 또는 관련 구성에 [IP 및 IP 범위 목록](#dynamic-ip-addresses) 이 모두 포함되어 있는지 확인하십시오. IP 전용, DNS 이름 전용, IP 및 DNS 이름 목록 파일에 포함된 IP는 허용 목록 구성을 보다 쉽게 하기 위해 /32 주소로 IP 범위 목록에 추가되었습니다. **이 /32 주소는 새로운 것이 아닙니다.**
</Callout>
...
<Callout variant="important">
  [추가 IP 주소 범위](/docs/synthetics/synthetic-monitoring/administration/new-synthetic-public-minion-ips/#us_new_ip) 는 2022년 10월 3일에 추가됩니다. 일부 고객은 이 트래픽을 허용하기 위해 방화벽, 봇 감지 또는 관련 구성을 업데이트해야 할 수 있습니다. 이들은 IP 범위 목록에 추가되었지만 2022년 10월 3일까지는 사용되지 않습니다.
</Callout>
