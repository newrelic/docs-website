...
<Callout variant="important">
  ...
  **2025년 4월 14일** 까지 허용 목록을 업데이트하지 않으면 신세틱스 검사가 어플리케이션에 연결하지 못할 수 있으며, 그로 인해 연결이 실패하고 알림이 발생할 수 있습니다.
</Callout>
...
<Callout variant="important">
  JSON 형식의 IP 범위 목록은 **2025년 4월 14일** 이후 변경됩니다. 일부 이전 IP가 위에 지정된 새로운 범위로 대체되기 때문입니다. 새로 언급된 범위를 화이트리스트/포함했는지 확인하세요.
</Callout>
