...
New Relic 권한이 작동하는 방식에 대한 자세한 내용은 [사용자 관리 개념을](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts/#groups) 참조하세요. 세분화된 합성 관련 기능을 보려면 [기능을](/docs/accounts/accounts-billing/new-relic-one-user-management/user-permissions/#synthetics) 참조하세요.
