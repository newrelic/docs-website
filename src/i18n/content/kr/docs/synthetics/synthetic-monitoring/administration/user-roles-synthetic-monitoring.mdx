...
종합 모니터링 기능에 대한 액세스는 사용자가 최신 [New Relic One 사용자 모델](#new-pricing) 을 사용하는지 아니면 [원래 사용자 모델](#original-pricing) 을 사용하는지에 따라 다릅니다.
...
## New Relic One 사용자 모델의 사용자 [#new-pricing]

종합 모니터링 UI를 사용하려면 [전체 플랫폼 사용자](/docs/accounts/accounts-billing/new-relic-one-pricing-users/users-roles#user-type) 유형의 사용자 유형이 필요합니다. 역할 및 기능에 대한 자세한 내용은 [기능](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts#capabilities) 을 참조하십시오.