  ...
  <tbody>
    ...
    <tr>
      <td>
        ...
        [신세틱스 Job Manager 설정](/docs/synthetics/synthetic-monitoring/private-locations/job-manager-configuration/#user-defined-vars) 에 대한 문서를 참조하세요.
      </td>
...
<CollapserGroup>
  <Collapser
    id="Chrome100"
    title={<>Chrome (<strong>최신</strong>)</>
    }
  >
    최신 Chrome 브라우저 런타임 세부 정보:
