...
New Relic은 보안 자격 증명으로 모니터를 저장하거나 검증하는 인스턴스를 기록합니다. 로그는 [NrAuditEvents를](/docs/accounts/accounts/account-maintenance/query-account-audit-logs-nrauditevent) 통해 쿼리할 수 있습니다.
