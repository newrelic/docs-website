...
<CollapserGroup>
  ...
  >
    ...
    1. **[one.newrelic.com > Synthetic monitoring > Secure credentials](https://one.newrelic.com/synthetics/secure-credential-list)** 으로 이동합니다.
    ...
    3. 변경하려는 자격 증명에 대해 줄임표 아이콘 **...** 을 클릭하고 **Edit** \[편집] 을 클릭합니다.
