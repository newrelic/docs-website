...
1. <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetic monitoring**</DoNotTranslate> 으)로 이동합니다.

2. 왼쪽 탐색 창에서 <DoNotTranslate>**Runtime upgrades**</DoNotTranslate> 클릭합니다.

3. <DoNotTranslate>**Upgrade all**</DoNotTranslate> 을(를) 클릭합니다.
...
3. 왼쪽 탐색 창에서 <DoNotTranslate>**General**</DoNotTranslate> 클릭합니다.

4. 현재 런타임 보기를 전환하려면 <DoNotTranslate>**Runtime**</DoNotTranslate> 필드의 다운 드롭 메뉴 메뉴를 사용하세요(스크립팅된 API 모니터에는 Node.js 16을 사용하고, 펼쳐 브라우저 모니터에는 Chrome 100+를 사용하세요).
...
5. <DoNotTranslate>**Validate**</DoNotTranslate> 클릭하여 모니터가 새 런타임에서 작동하는지 확인하세요. 필요한 경우 스크립트를 수정하십시오.

6. <DoNotTranslate>**Save monitor**</DoNotTranslate> 을(를) 클릭합니다.
...
4. 고려하는 필드를 설정하세요. <DoNotTranslate>**Name**</DoNotTranslate> 필수 필드입니다.

5. <DoNotTranslate>**Runtime**</DoNotTranslate> 필드의 다운 드롭 메뉴 메뉴를 사용하여 구형과 새 런타임 환경 간에 전환할 수 있습니다.

6. <DoNotTranslate>**Select locations**</DoNotTranslate> 을(를) 클릭합니다.

7. 단계 빌더를 구성하려면 <DoNotTranslate>**Define steps**</DoNotTranslate> 클릭하세요.

8. <DoNotTranslate>**Save monitor**</DoNotTranslate> 을(를) 클릭합니다.
