...
REST API와 달리 NerdGraph를 사용하면 [끊어진 링크](/docs/apis/nerdgraph/examples/nerdgraph-synthetics-tutorial/#create-broken-links), [단계](/docs/apis/nerdgraph/examples/nerdgraph-synthetics-tutorial/#create-step)및 [인증서 확인](/docs/apis/nerdgraph/examples/nerdgraph-synthetics-tutorial/#create-certificate-check) 모니터를 프로그래밍 방식으로 만들 수 있습니다.
