...
<CollapserGroup>
  ...
  >
    ...
    * 포드가 `ImagePullBackOff` 상태인 경우 [여기에](/docs/kubernetes-pixie/kubernetes-integration/installation/kubernetes-integration-install-configure/#before-start) 나열된 도메인에서 이미지를 가져올 수 있도록 네트워크 연결을 확인하세요.
