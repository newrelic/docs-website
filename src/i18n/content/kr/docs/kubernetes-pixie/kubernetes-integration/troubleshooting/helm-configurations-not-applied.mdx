...
`nri-bundle`에 대해 Helm과 함께 [뉴렐릭의 Kubernetes 통합을](/install/kubernetes/?dropdown1=helm) 설치했지만 Helm 템플릿이 `values.yaml`의 일부 [글로벌 값을](https://github.com/newrelic/helm-charts/tree/master/charts/nri-bundle#values) 따르지 않습니다.
