...
2. 차트를 생성하거나 업데이트할 때 차트 유형 **테이블** 을 선택하고 다음 이벤트 쿼리를 사용하여 YOUR_CLUSTER_NAME을 클러스터 이름으로 바꿉니다.
...
클러스터의 최신 이벤트에 대한 세부 정보를 보려면 다음 쿼리를 사용하여 YOUR_CLUSTER_NAME을 클러스터 이름으로 바꿉니다.
