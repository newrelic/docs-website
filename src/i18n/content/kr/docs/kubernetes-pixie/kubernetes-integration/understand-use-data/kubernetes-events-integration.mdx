...
Kubernetes 이벤트 통합은 [안내 설치를](/install/kubernetes) 사용하거나 [Helm을 통해 설치할](/docs/kubernetes-pixie/kubernetes-integration/installation/install-kubernetes-integration-using-helm) 때 기본적으로 설치됩니다.
...
1. [이벤트 페이지로 이동](https://one.newrelic.com):
...
3. 사용
   ...
   필드를 사용하여 특정 이벤트를 찾습니다. 특정 이벤트 집합에 초점을 맞추려면 필터 집합을 선택하거나 변경하세요.
...
* <DNT>
  ...
  <DNT>
    **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Kubernetes cluster explorer**
  </DNT>
