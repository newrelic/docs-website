...
뉴렐릭이 수집한 이벤트는 Kubernetes에서 제공하는 것과 정확히 동일한 속성을 갖습니다. 이러한 속성에 대한 자세한 내용은 [Kubernetes 이벤트 v1 코어 문서](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.34/#event-v1-core)를 참조하십시오.
