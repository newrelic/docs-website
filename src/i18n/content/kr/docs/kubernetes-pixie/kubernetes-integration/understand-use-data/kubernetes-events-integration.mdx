...
Kubernetes 이벤트 통합은 [가이드 설치](/install/kubernetes) 를 사용하거나 [Helm을 통해 설치할](/docs/kubernetes-pixie/kubernetes-integration/installation/install-kubernetes-integration-using-helm) 때 기본적으로 설치됩니다.
