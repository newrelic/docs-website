...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Dashboards**: [쿼리 빌더](/docs/chart-builder/use-chart-builder/get-started/introduction-chart-builder)를 사용하여 쿠버네티스 데이터를 쿼리하고 명확한 시각화를 생성할 수 있습니다.
</figcaption>
