...
쿠버네티스 데이터의 알림 위반 시 공지를 받을 수 있습니다.
...
<CollapserGroup>
  ...
  >
    쿠버네티스 통합은 자체 경고 정책 및 알림 조건과 함께 제공됩니다. 사전 정의된 알림 조건이 무엇인지 확인하려면 [쿠버네티스 통합: 사전 정의된 알림 정책](/docs/integrations/kubernetes-integration/kubernetes-events/kubernetes-integration-predefined-alert-policy)을 참조하십시오.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        마지막 확인 시점에 저장된 오브젝트의 개수, 유형별로 분할.
      </td>
    </tr>
  </tbody>
</table>
