...
<Callout variant="tip">
  일부 환경의 경우, 안내 설치 대신 수동 설치를 해야 하거나 선택할 수 있습니다. [Helm](/docs/kubernetes-pixie/kubernetes-integration/installation/install-kubernetes-integration-using-helm/), [Windows](/docs/kubernetes-pixie/kubernetes-integration/installation/install-kubernetes-integration-windows/)및 [EKS Fargate](/docs/kubernetes-pixie/kubernetes-integration/advanced-configuration/install-fargate-integration/)를 사용한 수동 설치 문서를 참조하십시오.
</Callout>
