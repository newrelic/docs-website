...
<Callout variant="important">
  [Kubernetes 탐색기](https://docs.newrelic.com/docs/kubernetes-pixie/kubernetes-integration/understand-use-data/kubernetes-cluster-explorer/#navigator-preview) 대신 [클러스터](/docs/kubernetes-pixie/kubernetes-integration/understand-use-data/kubernetes-cluster-explorer/#cluster-explorer-use) 탐색기를 사용하는 경우 `interval` 보다 큰 값으로 설정할 수 `40s` 없습니다.
</Callout>
