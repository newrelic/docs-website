...
<Callout variant="important">
  지원되는 [쿠버네티스 버전 1.24.x 이하 버전을](/docs/kubernetes-pixie/kubernetes-integration/get-started/kubernetes-integration-compatibility-requirements) 사용하고 있는지 확인합니다. 파드 보안 정책은 버전 1.25부터 사용되지 않습니다.
</Callout>

버전이 1.25 이상을 사용하는 경우, 위의 명령을 실행할 때 이 오류가 발생합니다.
