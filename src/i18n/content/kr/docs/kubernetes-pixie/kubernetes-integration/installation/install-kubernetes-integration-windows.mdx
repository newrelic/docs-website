---
title: Windows용 Kubernetes 통합 설치
tags:
  - Integrations
...
* [호환성 및 요구 사항을](#k8-windows-req) 확인하십시오.
* [매니페스트 파일을 업데이트](#k8-windows-install) 합니다.
* 통합의 [제한 사항](#k8-windows-limitations) 에 대해 알아보십시오.

## 호환성 및 요구 사항 [#k8-windows-req]

[New Relic의 Kubernetes 통합](/docs/integrations/kubernetes-integration/get-started/introduction-kubernetes-integration) 을 설치하기 전에 [호환성 및 요구 사항](/docs/integrations/kubernetes-integration/get-started/kubernetes-integration-compatibility-requirements) 을 검토하십시오.
