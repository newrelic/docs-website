...
<CollapserGroup>
  <Collapser id="invalid-license" title="마스터 노드에 올바른 레이블이 있는지 확인하십시오.">
  ...
  <Collapser id="unable-connect" title="마스터 노드에서 통합이 실행 중인지 확인하십시오.">
  ...
  <Collapser id="cannot-list-pods-for-cluster" title="마스터 노드에서 실행 중인 통합 중 하나의 자세한 로그를 검색하고 제어 평면 구성 요소 작업을 확인합니다.">
