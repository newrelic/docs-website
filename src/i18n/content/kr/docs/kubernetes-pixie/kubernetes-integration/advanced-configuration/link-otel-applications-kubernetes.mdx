...
* 다음 환경 변수를 생성했습니다.
  ...
  * `NEW_RELIC_API_KEY` ([라이센스 키](/docs/apis/intro-apis/new-relic-api-keys/#license-key))
...
먼저 New Relic [라이선스 키](https://opentelemetry.io/docs/collector/configuration/) 와 함께 [OpenTelemetry 수집기 구성 YAML 파일](/docs/apis/intro-apis/new-relic-api-keys/#license-key) 에 OTLP 내보내기를 헤더로 추가하여 구성합니다.
