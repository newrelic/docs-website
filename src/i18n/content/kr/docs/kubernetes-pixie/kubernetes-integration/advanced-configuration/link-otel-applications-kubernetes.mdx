...
* 다음 환경 변수를 생성했습니다.
  ...
  * `NEW_RELIC_API_KEY` ( [라이센스 키 입수](/docs/apis/intro-apis/new-relic-api-keys/#overview-keys) )
...
먼저 New Relic API 키(라이센스 수집 키)와 함께 [OpenTelemetry 수집기 구성 YAML 파일](https://opentelemetry.io/docs/collector/configuration/) 에 OTLP 내보내기를 헤더로 추가하여 구성합니다.
