...
New Relic의 FedRAMP 규정 준수에 대한 자세한 내용은 [FedRAMP Moderate 설명서 페이지를](/docs/security/security-privacy/compliance/certificates-standards-regulations/fedramp/) 참조하십시오.
