...
<CollapserGroup>
  ...
  >
    ...
    11. <DoNotTranslate>**Service**</DoNotTranslate> 리소스의 `TargetPort` <DoNotTranslate>**Deployment**</DoNotTranslate> 컨테이너의 <DoNotTranslate>**Port**</DoNotTranslate> 와 일치하는지 확인하세요.
