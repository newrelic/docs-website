...
[New Relic Kubernetes 통합 v3](/docs/kubernetes-pixie/kubernetes-integration/advanced-configuration/k8s-version2/changes-since-v3/) 이상에서는 클러스터에서 지표가 수집되는 간격을 변경할 수 있습니다. 이를 통해 데이터 해상도와 사용량 간의 균형을 선택할 수 있습니다. 최적의 경험을 위해 15-30초 사이의 간격을 선택하는 것이 좋습니다.
