...
새로운 [`nri-kubernetes` v3 아키텍처는](/docs/kubernetes-pixie/kubernetes-integration/advanced-configuration/k8s-version2/changes-since-v3/) 아직 Windows를 지원하지 않습니다. Windows 워크로드를 모니터링할 수 있는 독립 실행형 릴리스로 `newrelic-infrastructure` 차트를 설치합니다.
