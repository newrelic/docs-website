...
Kubernetes에서 실행되는 다음 서비스를 지원합니다.
...
**[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure** 로 이동하여 **타사 서비스** 를 선택한 다음 서비스의 대시보드를 선택합니다. 보고되는 데이터가 표시되어야 합니다.
