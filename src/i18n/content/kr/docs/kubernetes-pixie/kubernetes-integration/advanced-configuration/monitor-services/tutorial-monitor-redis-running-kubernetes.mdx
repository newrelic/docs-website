...
오류가 없으면 인프라 UI에 Redis 데이터가 표시되어야 합니다. Redis 대시보드를 찾으려면 [**one.newrelic.com**](http://one.newrelic.com) **> Infrastructure > Third party services** 로 이동하여 **Redis** 대시보드를 선택합니다.
