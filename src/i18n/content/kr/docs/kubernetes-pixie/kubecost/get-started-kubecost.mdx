...
시작하려면 먼저 New Relic에서 [Prometheus Remote Write를](/docs/infrastructure/prometheus-integrations/install-configure-remote-write/set-your-prometheus-remote-write-integration/) 설정한 다음 Kubecost 에이전트를 설치하세요.
