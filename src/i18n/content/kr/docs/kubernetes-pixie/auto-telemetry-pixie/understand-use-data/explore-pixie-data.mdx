...
Pixie를 사용하여 [선택한 프로토콜](/docs/kubernetes-pixie/auto-telemetry-pixie/understand-use-data/overview/#pixie-long-term-storage) 에 대한 애플리케이션의 전체 요청 및 응답을 검사할 수 있습니다.

Pixie에서 추적한 프로토콜은 **모든 엔터티** 페이지의 **기타 엔터티** 섹션에 표시됩니다.

<img
  title="Pixie entities show up under the Other Entities section"
  alt="Pixie entities show up under the Other Entities section"
  src={pixieEntities}
/>

<figcaption>
  Pixie 엔터티는 기타 엔터티 섹션 아래에 표시됩니다.
</figcaption>

<Callout variant="important">
  이러한 Pixie 엔터티가 누락된 경우 [사용자 정의 Pixie Ingest](/docs/kubernetes-pixie/auto-telemetry-pixie/understand-use-data/overview/#pixie-configure-storage) 구성을 확인하여 프로토콜에 대한 수집을 비활성화하지 않았는지 확인하십시오.
</Callout>

**DNS - Pixie** 엔터티 목록에서 항목을 선택하면 **요약** 보기가 열립니다. 이 보기는 응답 시간, 처리량 및 오류율의 그래프와 이 서비스에서 수행한 전신 DNS 요청의 샘플을 보여줍니다.
