...
<Callout variant="important">
  <DNT>**Customize Pixie Ingest**</DNT> 기능을 사용하려면 뉴렐릭 Pixie 통합 버전 2.X.X+가 필요합니다. 이 기능에 액세스하려면 [통합을 업그레이드](/docs/kubernetes-pixie/auto-telemetry-pixie/install-auto-telemetry-pixie/#upgrade) 해야 할 수도 있습니다.
</Callout>
...
2. <DNT>**Live debugging with Pixie**</DNT> 탭을 선택합니다.
3. 오른쪽 상단에서 <DNT>**Customize Pixie Ingest**</DNT> 버튼을 선택합니다.
...
<figcaption>
  <DNT>**Live debugging with Pixie**</DNT> 탭 내에서 뉴렐릭에 유지되는 Pixie 스프레드시트 데이터를 맞춤설정할 수 있습니다.
</figcaption>

뉴렐릭 Pixie 통합은 Pixie의 [플러그인 시스템을](https://docs.px.dev/reference/plugins/plugin-system/) 사용하여 장기간 저장을 위해 선별된 Pixie 텔리메트리 데이터를 뉴렐릭으로 내보냅니다. <DNT>**Customize Pixie Ingest**</DNT> 페이지에는 Pixie의 검색어 페이지에 대한 삽입된 보기가 포함되어 있습니다.
