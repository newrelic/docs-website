...
New Relic UI에서는 단기 및 장기 저장소 모두에서 원격 측정 데이터와 상호 작용할 수 있습니다.
...
New Relic Pixie 통합은 Pixie의 [플러그인 시스템](https://docs.px.dev/reference/plugins/plugin-system/) 을 사용하여 장기 저장을 위해 일부 Pixie 원격 측정 데이터를 New Relic으로 내보냅니다.**Pixie Ingest 사용자 정의** 페이지에는 Pixie의 플러그인 구성 페이지가 포함된 보기가 포함되어 있습니다.
...
<Callout variant="important">
  **Pixie Ingest 사용자 정의** 기능을 사용하려면 New Relic Pixie 통합 버전 2.X.X+가 필요합니다.이 기능에 액세스하려면 [통합을 업그레이드](https://docs.newrelic.com/docs/kubernetes-pixie/auto-telemetry-pixie/install-auto-telemetry-pixie/#upgrade) 해야 할 수 있습니다.
</Callout>