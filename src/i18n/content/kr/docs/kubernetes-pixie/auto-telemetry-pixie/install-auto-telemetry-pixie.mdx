...
Pixie를 사용하여 자동 원격 측정을 시작하고 실행하려면 [안내 설치](https://one.newrelic.com/marketplace?state=fc4edc3d-8214-a314-7432-3e62d7de43d7) 부터 시작하세요. 안내식 설치는 클러스터에 Pixie와의 New Relic 통합을 배포합니다. Pixie 사용을 시작하기 위해 추가 구성이나 설치를 수행할 필요가 없습니다.
...
## 안내된 설치 프로세스를 사용하여 설치 [#install-beginning]

1. [New Relic 모니터링 안내 설치를](https://one.newrelic.com/marketplace?state=fc4edc3d-8214-a314-7432-3e62d7de43d7) 엽니다.

2. 안내 설치에 사용할 계정을 선택하고

   <DNT>
     **Continue**
   </DNT>

   클릭합니다. 참고: 단일 계정인 경우 이 옵션이 표시되지 않습니다.
...
2. <DNT>**Continue**</DNT> 을(를) 클릭합니다.

3. 수집, 관찰, 디버깅하려는 데이터를 선택하고 <DNT>**Continue**</DNT> 클릭합니다.

4. <DNT>**Choose install method**</DNT> 페이지에서 <DNT>**Helm**</DNT> 또는 <DNT>**manifest**</DNT> 중 하나를 선택합니다.
...
5. <DNT>**Continue**</DNT> 클릭하여 <DNT>**Listening for data**</DNT> 페이지를 엽니다.

6. <DNT>**See your data**</DNT> 메시지가 표시되면 <DNT>**Kubernetes Cluster Explorer**</DNT> 클릭하여 클러스터를 확인하세요.
...
Pixie 통합은 뉴렐릭의 Kubernetes 통합의 일부로 설치됩니다. Kubernetes 통합을 업그레이드하려면 [Kubernetes 설치 설명서를](/install/kubernetes#update) 참조하세요.
