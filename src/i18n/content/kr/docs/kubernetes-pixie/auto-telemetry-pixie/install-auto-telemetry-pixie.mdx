...
3. 나머지 필드를 완료하고 **Continue** \[계속을] 클릭하여 나머지 설치를 완료합니다.
...
Pixie 통합은 New Relic의 Kubernetes 통합의 일부로 설치됩니다.Kubernetes 통합을 업그레이드하려면 [Kubernetes 설치 문서](/install/kubernetes#update) 를 참조하십시오.
