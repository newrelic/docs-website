...
Pixie를 사용한 자동 원격 측정을 시작하고 실행하려면 설치 안내부터 시작하세요.안내식 설치는 클러스터에 New Relic의 Kubernetes 통합과 함께 Pixie를 배포합니다.Pixie 사용을 시작하기 위해 추가 구성이나 설치를 수행할 필요가 없습니다.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Pixie UI에서 New Relic에 대한 링크를 따라가고 New Relic 계정이 없는 경우 먼저 계정을 만들어야 합니다.Pixie UI에서 New Relic 아이콘을 클릭하고 단계에 따라 New Relic 계정을 만드세요.그렇게 하면 Pixie 계정이 연결됩니다.그런 다음 [안내된 설치 프로세스를 계속합니다](#install-helm-command-manifest) .
      </td>
    </tr>
...
Pixie 통합은 New Relic의 Kubernetes 통합의 일부로 설치됩니다.Kubernetes 통합을 제거하려면 [Kubernetes 설치 문서](/docs/kubernetes-pixie/kubernetes-integration/installation/kubernetes-integration-install-configure#uninstall) 를 참조하십시오.