...
2. 안내 설치에 사용할 계정을 선택하고 <DNT>**Continue**</DNT> 클릭합니다. 참고: 단일 계정인 경우 이 옵션이 표시되지 않습니다.
3. 나머지 필드를 완료하고 <DNT>**Continue**</DNT> 클릭하여 나머지 설치를 완료합니다.
...
4. <DNT>**Choose install method**</DNT> 페이지에서 <DNT>**Helm**</DNT> 또는 <DNT>**manifest**</DNT> 중 하나를 선택합니다.
   ...
   <CollapserGroup>
     <Collapser className="freq-link" id="helm-method" title="투구 방식">
     ...
     <Collapser className="freq-link" id="manifest-method" title="매니페스트 방법">
...
<Callout variant="important" title="EOL 공지">
  2022년 8월 이후에는 Pixie와의 통합 버전 1을 포함하여 여러 기능에 대한 지원이 중단됩니다. 이 전환을 쉽게 준비하는 방법을 포함한 자세한 내용은 [지원 포럼 게시물](https://support.newrelic.com/s/hubtopic/aAX8W0000008dL8/july-2022-end-of-life-announcements)을 참조하십시오.
</Callout>
