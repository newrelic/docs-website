    ...
    <tr>
      ...
      <td>
        **선택 사항.**
         ...
         로그 그룹의 ARN 또는 이름입니다. ARN으로 로그 그룹을 참조할 때 
    ...
    <tr>
      ...
      <td>
        **선택 사항.**
         ...
         밀리초 단위의 Unix 타임스탬프로 표시된 시간 범위의 시작입니다.
      </td>
    ...
    <tr>
      ...
      <td>
        **선택 사항.**
         ...
         시간 범위의 끝으로, 밀리초 단위의 Unix 타임스탬프로 표현됩니다.
      </td>
    ...
    <tr>
      ...
      <td>
        **선택 사항.**
        ...
        인 경우, 가장 빠른 로그 이벤트를 먼저 반환합니다. 기본값은 
    ...
    <tr>
      ...
      <td>
        **선택 사항.**
         ...
         뉴렐릭 엔티티 상관관계를 위해 로그 이벤트와 연결할 엔티티 메타데이터입니다.
      </td>
