...
<CollapserGroup>
  <Collapser id="aws.systemsManager.writeDocument" title="문서 만들기">
      ...
      <TabsPages>
        ...
        <TabsPageItem id="writedocumentoutputs">
          ...
          <Callout variant="important">
            ...
            * 자세한 내용은 [AWS 자격 증명을](/docs/workflow-automation/setup-and-configure/set-up-aws-credentials) 참조하십시오.
          </Callout>
        </TabsPageItem>
        ...
        <TabsPageItem id="writedocumentexample">
          ...
          **예시 3: 보다 복잡한 SSM 문서**
          ...
          <Collapser id="example3.complex.document" title="복잡한 SSM 문서 예시">
            **SSM 문서에서 API 게이트웨이 롤백을 수행합니다.**
...
<CollapserGroup>
  <Collapser id="aws.systemsManager.deleteDocument" title="문서 삭제">
...
<CollapserGroup>
  <Collapser id="aws.systemsManager.startAutomation" title="자동화 시작">
      ...
      <TabsPages>
        ...
        <TabsPageItem id="automationstatusoutputs">
          ...
          <Callout variant="important">
            ...
            3. [AWS 자격 증명](/docs/workflow-automation/setup-and-configure/set-up-aws-credentials) 설정 방법은 안내를 참조하십시오.
