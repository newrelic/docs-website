...
IAM 사용자 및 IAM 역할을 만드는 방법과 펠로우 자동화 AWS 작업과 통합하기 위한 정적 및 세션 AWS 자격 증명을 설정하는 방법에 대한 자세한 내용은 [AWS 자격 증명 설정을](/docs/workflow-automation/setup-and-configure/set-up-aws-credentials/) 참조하세요.
      ...
      <TabsPages>
        ...
        <TabsPageItem id="automationstatusoutputs">
          ...
          <Callout variant="important">
            ...
            3. [AWS 자격 증명을](/docs/workflow-automation/setup-and-configure/set-up-aws-credentials) 설정하려면 지침을 참조하세요.
