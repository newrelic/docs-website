...
<CollapserGroup>
  <Collapser id="aws.ec2.runInstances" title="인스턴스 실행">
  ...
  <Collapser id="aws.ec2.startInstances" title="인스턴스 재시작">
  ...
  <Collapser id="aws.ec2.terminateInstances" title="인스턴스를 종료합니다">
  ...
  <Collapser id="aws.ec2.createSnapshot" title="EBS 스냅샷 생성">
  ...
  <Collapser id="aws.ec2.deleteSnapshot" title="스냅샷 삭제">
    지정된 스냅샷을 삭제합니다.
