...
이 페이지는 자동화 작업 카탈로그에서 사용할 수 있는 AWS Execute API 에 대한 포괄적인 참조 정보를 제공합니다. 이러한 작업을 통해 모든 AWS API 작업을 실행할 수 있습니다.
...
이 기능을 사용하려면 AWS 자격 증명을 구성해야 합니다. IAM 역할 또는 IAM 사용자를 생성하는 방법에 대한 자세한 지침은 [AWS 자격 증명 설정하기를](/docs/workflow-automation/setup-and-configure/set-up-aws-credentials/) 참조하세요.
