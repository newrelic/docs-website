...
* **하지 말아야 할 것**: **쿼리 공지** 에 대한 별도의 활동 흐름 만들기, **메시지 형식 지정**, **Slack으로 보내기**
...
* **실행 방법**: **CPU 사용량 알림 시 EC2 자동 크기 조정**
* **하지 마세요**: **워크플로우 1** 또는 **EC2 자동화**
