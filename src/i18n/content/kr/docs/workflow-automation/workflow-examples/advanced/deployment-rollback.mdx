...
<DocTiles>
  <DocTile title="EC2 관리" path="/docs/workflow-automation/workflow-examples/advanced/ec2-management">
    워크플로우를 사용하여 인프라 변경을 자동화하세요
  </DocTile>

  <DocTile title="API 게이트웨이 롤백" path="/docs/workflow-automation/workflow-examples/advanced/api-gateway-rollback">
    롤백 API 게이트웨이 구현, 배포
  </DocTile>

  <DocTile title="NRQL 액션" path="/docs/workflow-automation/setup-and-configure/actions-catalog/newrelic/query/newrelic-nrdb">
    컨테이너 구현, NRQL사용한 데이터 배포
  </DocTile>
</DocTiles>