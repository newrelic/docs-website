...
<DocTiles>
  <DocTile title="루프" path="/docs/workflow-automation/workflow-examples/basic-patterns/loops">
    루프 반복을 통해 데이터를 전달합니다.
  </DocTile>
  ...
  <DocTile title="JSON 파싱" path="/docs/workflow-automation/workflow-examples/basic-patterns/json-parsing">
    JSON 데이터를 추출하여 전달합니다.
  </DocTile>
</DocTiles>