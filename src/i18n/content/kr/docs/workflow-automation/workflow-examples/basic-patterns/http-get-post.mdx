...
<DocTiles>
  <DocTile title="JSON 파싱" path="/docs/workflow-automation/workflow-examples/basic-patterns/json-parsing">
    HTTP 응답을 구문 분석하고 변환합니다.
  </DocTile>

  <DocTile title="REST API 폴링" path="/docs/workflow-automation/workflow-examples/integrations/rest-api-polling">
    완벽한 API 통합 워크플로우를 구축하세요
  </DocTile>

  <DocTile title="HTTP 동작" path="/docs/workflow-automation/setup-and-configure/actions-catalog/actions-catalog">
    모든 HTTP 작업에 대해 알아보십시오.
  </DocTile>
</DocTiles>