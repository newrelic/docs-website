...
![태그를 사용한 New Relic 필터링 워크로드](./images/new-relic-tags-workloads_0.png "태그를 사용한 New Relic 필터링 워크로드")<figcaption>여기에서 특정 계정에 대한 [워크로드](/docs/new-relic-one/use-new-relic-one/workloads/workloads-isolate-resolve-incidents-faster) 를 필터링하는 데 사용되는 `accountId` 태그를 볼 수 있습니다.</figcaption>
...
![New Relic 고급 태그 필터 쿼리](./images/new-relic-advanced-tag-filter-query.png "New Relic 고급 태그 필터 쿼리")
