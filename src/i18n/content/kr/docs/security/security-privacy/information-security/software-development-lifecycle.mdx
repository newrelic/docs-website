...
구현하다, 배포하다 코드는 반복적인 개발 프로세스를 계속하기 위해 이해관계자와 제품 엔지니어가 모니터링합니다. 보안 팀은 정기적인 보안 검색, 제3자 침투 테스트 및 [조정된 공개 프로세스를](/docs/security/new-relic-security/data-privacy/reporting-security-vulnerabilities) 통해 구현, 배포 코드의 보안을 지속적으로 평가합니다.
