...
<DNT>**Versions affected:**</DNT> (a) 4.12.0과 6.5.1, 그리고 (b) 7.0.0과 7.4.1 사이의 모든 에이전트 버전

<DNT>**Fix versions:**</DNT> 6.5.2, 6.5.3, 6.5.4, 7.4.2, 7.4.3 및 7.5.0
...
<DNT>**Note:**</DNT> 이 해결 방법은 에이전트 버전을 업데이트할 수 있을 때까지 임시 해결책으로만 권장됩니다.
...
* [New Relic 지원 포럼](https://support.newrelic.com/s/hubtopic/aAX8W0000008ckb/log4j-zero-day-vulnerability-and-the-new-relic-java-agent)

## 자주 묻는 질문 [#faq]

<CollapserGroup>
  <Collapser id="upgrade-options" title="Java 에이전트 또는 Java 버전을 업그레이드할 수 없는 경우 옵션은 무엇입니까?">
    [이 게시판에서 권장하는 해결 방법을](#action) 구현하십시오.
  </Collapser>

  <Collapser id="versions" title="실행 중인 에이전트 버전을 어떻게 알 수 있습니까?">
    에이전트 버전 정보는 뉴렐릭 One 대시보드의 <DNT>**Environment**</DNT> 페이지에 표시됩니다. 자세한 내용은 [문서 페이지](/docs/apm/agents/manage-apm-agents/troubleshooting/get-environment-data-about-your-apm-app)를 참조하십시오.
  </Collapser>

  <Collapser id="patch-v5" title="에이전트 v5 이하용 패치가 없는 이유는 무엇입니까?">
  ...
  <Collapser id="update-742" title="이미 6.5.1 또는 7.4.1로 업데이트했는데 다시 업데이트해야 합니까?">
