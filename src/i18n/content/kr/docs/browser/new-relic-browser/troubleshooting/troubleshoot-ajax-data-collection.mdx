...
애플리케이션이 [다음과 같이 계측된 경우 <InlinePopover type="browser"/>](/docs/browser/new-relic-browser/installation-configuration/troubleshooting-browser-monitoring-installation)다른 [Pro 기능](/docs/browser/new-relic-browser/browser-pro-features) 에 대한 데이터를 올바르게 수집하고 있다면 다음 단계를 따르세요.
