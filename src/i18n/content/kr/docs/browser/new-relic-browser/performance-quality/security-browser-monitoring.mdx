...
브라우저는 웹사이트의 성능을 분석하는 데 도움이 되는 다양한 유형의 데이터를 보고합니다. [Pro 기능](https://newrelic.com/pricing)을 구독하지 않는 한, <DNT>**only**</DNT> 페이지 뷰 데이터를 보고합니다. 또한 AJAX requests, JavaScript 오류 및 세션 트레이스에 대한 [기능을 활성화](/docs/browser/new-relic-browser/welcome-new-relic-browser/new-relic-browser#enhanced-features) 할 수 있습니다.
