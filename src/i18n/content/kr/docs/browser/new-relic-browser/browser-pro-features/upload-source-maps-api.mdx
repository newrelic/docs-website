...
<Callout variant="important">
  다음 예시는 미국 계정(기본값)을 위한 것입니다. 다른 리전의 경우 해당 엔드포인트를 사용하세요:

  * EU 계정: `https://sourcemaps.service.eu.newrelic.com`
  * JP 계정: `https://sourcemaps.service.jp.newrelic.com`

  자세한 내용은 [데이터센터 선택](/docs/accounts/accounts-billing/account-setup/choose-your-data-center)을 참조하십시오.
</Callout>
