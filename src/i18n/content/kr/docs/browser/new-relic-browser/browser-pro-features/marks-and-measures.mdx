...
<Callout variant="important">
  이 기능은 현재 공개 미리보기 상태이며 변경될 수 있습니다. 이 기능을 사용할 때는 주의하세요. 공개 미리 보기 기능은 복사 및 붙여넣기 또는 에이전트의 NPM 구현을 통한 수동 가입에만 사용할 수 있습니다. APM이 주입된 애플리케이션에 액세스하려면 지원 담당자에게 문의하세요. 참여에 대한 자세한 내용은 [공개 미리보기 기능을](/docs/browser/new-relic-browser/configuration/public-preview-features) 참조하세요.
</Callout>
