...
2. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) >Browser > (앱 선택) > Application settings** 으로 이동합니다.
3. **분산 추적** 토글을 켭니다.
...
<CollapserGroup>
  ...
  >
    ...
    3. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) >Browser > (앱 선택) > Application settings** 으로 이동합니다.
