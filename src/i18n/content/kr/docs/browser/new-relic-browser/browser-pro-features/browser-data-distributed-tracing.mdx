...
2. [one.newrelic.com](https://one.newrelic.com) 으로 이동, **브라우저** 를 클릭합니다. 앱을 선택한 다음 **애플리케이션 설정** 을 클릭합니다.
3. **분산 추적** 토글을 켭니다.
...
<CollapserGroup>
  ...
  >
    ...
    3. [one.newrelic.com](https://one.newrelic.com) 으로 이동, **브라우저** 를 클릭합니다. 앱을 선택한 다음 **애플리케이션 설정** 을 클릭합니다.
