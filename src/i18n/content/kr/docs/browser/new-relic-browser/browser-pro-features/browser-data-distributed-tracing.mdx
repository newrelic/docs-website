...
귀하의 제품에 필요한 최소 버전이 있는지 확인하십시오. <InlinePopover type="browser"/>대리인과 귀하의 <InlinePopover type="apm"/>대리인:
...
2. **[one.newrelic.com > All capabilties](https://one.newrelic.com/all-capabilities) > Browser > (앱 선택) > Settings > Application settings** 으로 이동합니다.
3. **분산 추적** 토글을 켭니다.
...
<CollapserGroup>
  ...
  >
    ...
    3. **[one.newrelic.com > All capabilties](https://one.newrelic.com/all-capabilities) > Browser > (앱 선택) > Settings > Application settings** 으로 이동합니다.
