...
우리의 <InlinePopover type="browser"/>[**Page views** \[페이지 보기\] 페이지](/docs/browser/new-relic-browser/additional-standard-features/page-views-insights-your-sites-popularity) 및 [**AJAX** 페이지](/docs/browser/new-relic-browser/browser-pro-features/ajax-dashboard-identifying-time-consuming-calls) 의 데이터에 대해 URL 패턴을 사용합니다. URL 패턴을 사용하면 다음과 같은 이점이 있습니다.
