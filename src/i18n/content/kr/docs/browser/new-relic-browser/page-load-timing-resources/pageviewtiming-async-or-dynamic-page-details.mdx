...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [`largestContentfulPaint`](/attribute-dictionary/?event=PageViewTiming&attribute=largestContentfulPaint) 측정항목은 [에이전트 버전 1163 이상](/docs/release-notes/new-relic-browser-release-notes/browser-agent-release-notes/browser-agent-v1163) 에서 사용할 수 있습니다. 뷰포트에 표시되는 가장 큰 콘텐츠 요소의 렌더링 시간을 보고합니다.
    ...
    <tr>
      ...
      <td>
        [`firstInteraction`](/attribute-dictionary/?event=PageViewTiming&attribute=firstInteraction) 및 [`firstInputDelay`](/attribute-dictionary/?event=PageViewTiming&attribute=firstInputDelay) 을 추가하면 사용자가 해당 시각적 콘텐츠와 상호작용하는 방식을 빠르게 확인할 수 있습니다. 이러한 측정항목은 상호작용 시기뿐만 아니라 상호작용 유형(마우스다운, 포인터다운 등)과 사이트에서 응답을 받는 데 걸린 시간을 알려줍니다.
        ...
        더 자세한 설명은 당사를 참조하세요. [<InlinePopover type="browser"/>릴리즈 노트](/docs/release-notes/new-relic-browser-release-notes/browser-agent-release-notes/browser-agent-v1153).
      </td>
    </tr>
