...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        이 메트릭은 현재 14.1(데스크톱) 또는 14.5(iOS) 미만의 Safari를 제외한 대부분의 최신 브라우저 버전에서 지원됩니다. [MDN 문서를 통한 호환성 매트릭스](https://developer.mozilla.org/en-US/docs/Web/API/Document/visibilitychange_event#browser_compatibility) .
      </td>
    </tr>
