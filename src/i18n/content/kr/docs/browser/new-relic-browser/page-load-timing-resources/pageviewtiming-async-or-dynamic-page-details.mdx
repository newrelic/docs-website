...
이러한 지표 각각에 대해 대부분의 사용자에게 권장되는 팝업 목표, 좋은 레버 값을 달성했는지 확인하기 위해 측정할 항목은 모바일 및 데스크톱 기기에 걸쳐 분류된 페이지 로드의 <DoNotTranslate>**75th percentile**</DoNotTranslate> 입니다.
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        콘텐츠가 가장 많은 페인트는 Google에서 [코어 웹 바이탈](https://web.dev/vitals/) 로 식별한 세 가지 지표 중 하나입니다. LCP 값은 최대 2.5초는 "좋음"으로 간주되고, 2.5-4.0초 사이는 "개선 필요"로 간주되며, 4.0초 이상은 "나쁨"으로 간주됩니다.
      </td>
    </tr>
