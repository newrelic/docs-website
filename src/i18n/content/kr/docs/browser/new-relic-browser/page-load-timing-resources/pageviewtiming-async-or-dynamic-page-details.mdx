...
브라우저 모니터링을 위한 [에이전트 버전 1177](/docs/release-notes/new-relic-browser-release-notes/browser-agent-release-notes/browser-agent-v1177) 부터 [Google의 Core Web Vitals](https://web.dev/vitals/) 를 완벽하게 지원합니다.
