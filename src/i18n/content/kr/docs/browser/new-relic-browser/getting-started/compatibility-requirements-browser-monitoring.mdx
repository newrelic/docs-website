...
계측은 Google Chrome, Mozilla Firefox, Microsoft Internet Explorer 및 Edge, Apple Safari를 포함한 모든 브라우저 유형과 호환됩니다. 사용자 인터페이스는 [New Relic이 지원하는 브라우저 버전](/docs/data-analysis/user-interface-functions/view-your-data/supported-browsers-new-relics-ui) 과 호환됩니다.
  ...
  <tbody>
    ...
    <tr>
      <td>
        ...
        <Callout variant="important">
          FedRAMP 호환 엔드포인트를 사용하는 경우 `https://gov-bam.nr-data.net` 을 추가합니다.
        </Callout>
      </td>
