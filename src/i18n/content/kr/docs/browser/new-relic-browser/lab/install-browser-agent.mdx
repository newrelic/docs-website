...
<Steps>
  ...
  <Step>
    상단 탐색 메뉴 오른쪽에서 <DoNotTranslate>**Add data**</DoNotTranslate> 클릭합니다.
  ...
  <Step>
    <DoNotTranslate>**Browser & mobile**</DoNotTranslate> 까지 아래로 스크롤하고 <DoNotTranslate>**Browser monitoring**</DoNotTranslate>) 선택합니다.
  ...
  <Step>
    구현, 배포 방법으로 <DoNotTranslate>**Copy/paste JavaScript code**</DoNotTranslate> 선택합니다.
  ...
  <Step>
    <DoNotTranslate>**Name your app**</DoNotTranslate> 까지 아래로 스크롤합니다. 앱 이름을 <DoNotTranslate>**Relicstaurants**</DoNotTranslate> 로 지정하고 <DoNotTranslate>**Enable**</DoNotTranslate> 클릭합니다.
...
귀하의 앱은 이제 뉴렐릭으로 브라우저 데이터를 보내고 있습니다. <DoNotTranslate>**Browser**</DoNotTranslate> 아래의 뉴렐릭에서 이 데이터를 확인하세요.
...
<Steps>
  ...
  <Step>
    왼쪽 탐색 메뉴에서 <DoNotTranslate>**Browser**</DoNotTranslate> 으로 이동하여 <DoNotTranslate>**Relicstaurants**</DoNotTranslate> 선택합니다.
    ...
    여기에서는 앱의 <DoNotTranslate>**Page views with JavaScript errors**</DoNotTranslate>, <DoNotTranslate>**Core web vitals**</DoNotTranslate>, <DoNotTranslate>**User time on the site**</DoNotTranslate>, <DoNotTranslate>**Initial page load and route changes**</DoNotTranslate> 및 기타 성능 데이터를 볼 수 있습니다.
