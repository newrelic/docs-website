...
이 문제는 Next.JS 릴리스 [v13.4.20-canary.5](https://github.com/vercel/next.js/releases/tag/v13.4.20-canary.5) 에서 해결되었습니다. Next.JS 프레임워크 버전 13.4.20-canary.5 이상으로 업그레이드하세요.
