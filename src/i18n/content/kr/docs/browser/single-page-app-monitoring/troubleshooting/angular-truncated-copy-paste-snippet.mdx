...
이 문제는 Angular CLI 빌드 시스템의 종속성 내의 버그로 인해 발생합니다. Angular CLI 버전 12, 13, 14는 New Relic을 포함할 수 있는 임의 크기의 인라인 스크립트를 자르는 종속성을 사용합니다. <InlinePopover type="browser"/>대리인. 이 문제는 Angular 버전 15에서 수정되었음을 확인했으며 Angular 프로젝트를 업그레이드할 것을 권장합니다.
