...
권장 사항: 특정 문제 해결 절차를 따르기 전에 [진단 브라우저 검사를](/docs/agents/manage-apm-agents/troubleshooting/new-relic-diagnostics) 실행하십시오. Diagnostics CLI가 다운로드되면, 목표는 버섯줄 옵션: `/nrdiag -browser-url YOUR-WEBSITE-URL -suites browser` 실행하여 브라우저를 확인합니다. Diagnostics CLI에서 반환된 정보는 뉴렐릭 지원팀과 통신할 때 사용할 수 있습니다.
...
<CollapserGroup>
  ...
  >
    ...
    * <DNT>**Go**</DNT>: 해당사항 없음
    * <DNT>**Java**</DNT>: `</body>` 태그 앞(누락된 경우 페이지에 추가해야 함)
    * <DNT>**.NET**</DNT>: 첫 번째 스크립트 요소 바로 앞
    * <DNT>**Node.js**</DNT>: 첫 번째 스크립트 요소 바로 앞
    * <DNT>**PHP**</DNT>: body 요소의 끝 부분
    * <DNT>**Python**</DNT>: head 요소 또는 body 요소의 끝 부분
    * <DNT>**Ruby**</DNT>: 첫 번째 스크립트 요소 바로 앞
