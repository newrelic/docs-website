...
우리의 <InlinePopover type="browser"/>**Session traces** \[세션 추적] UI는 웹페이지의 전체 수명 주기 동안(최대 10분) 로드 및 상호 작용 이벤트에 대한 자세한 타임라인을 제공합니다. 세션 URL 또는 세션 추적 ID를 선택한 후 자세한 폭포 시각화 및 히트맵 개요를 사용하여 측정항목을 검사하고 다음과 관련된 문제를 식별할 수 있습니다.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        [첫 번째 입력 지연](/attribute-dictionary/?event=PageViewTiming&attribute=firstInputDelay)
      </td>
