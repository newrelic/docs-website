...
<DNT>**[one.newrelic.com &gt; All Capabilities](https://one.newrelic.com/all-capabilities) &amp;gt; Browser**</DNT> (브라우저 앱 선택) &amp;gt; <DNT>**Application settings**</DNT> 로 이동합니다. 이 페이지에서 <DNT>**Pro**</DNT> 또는 <DNT>**Pro + SPA**</DNT> 브라우저 에이전트가 선택되었는지 확인하세요.
