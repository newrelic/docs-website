...
1. **[one.newrelic.com](https://one.newrelic.com) > Browser > (앱 선택) > [JS 오류](/docs/browser/new-relic-browser/browser-pro-features/javascript-errors-page-examining-errors-over-time)** 로 이동한 다음 JS 오류 그룹을 선택합니다. ( **Errors without a stack trace** 선택하지 마십시오.)
