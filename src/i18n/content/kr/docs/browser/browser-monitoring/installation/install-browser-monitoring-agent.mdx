...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities)**으로 이동하여, **Add data**를 클릭한 다음 **Browser and mobile**을 클릭합니다.
...
### APM으로 모니터링되는 앱 활성화 [#select-apm-app]
...
### APM 에이전트를 사용한 웹페이지 계측 [#agent-instrumentation]

이 정보는 APM에서 모니터링하는 앱에도 적용됩니다.
...
[REST API](/docs/browser/new-relic-browser/browser-agent-apis/adding-or-listing-browser-apps-api-v2)를 사용하면 브라우저 모니터링 UI 외부에서 배포를 관리할 수 있습니다. 이는 여러 앱을 배포하는 대규모 조직에 유용합니다.
