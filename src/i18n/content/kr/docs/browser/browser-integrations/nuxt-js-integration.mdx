...
Nuxt.js 대시보드를 사용하면 JavaScript 오류가 있는 애플리케이션 오류율, 초기 페이지 로드 평균, 경로 변경, 처리량 및 페이지 뷰를 쉽게 추적할 수 있습니다. 인프라 에이전트와 Vue <InlinePopover type="browser"/>으로 구축된 Nuxt.js 대시보드를 사용하면 중요한 정보를 모두 한 곳에서 볼 수 있습니다.
...
* [대시보드를 관리](/docs/query-your-data/explore-query-data/dashboards/manage-your-dashboard)하여
  ...
  의 디스플레이 모드를 조정하거나 대시보드에 더 많은 콘텐츠를 추가할 수 있습니다.