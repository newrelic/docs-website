...
<img title="An example line chart showing pageview count over time." alt="A screenshot of an example line chart showing pageview count over time." src="/images/queries-nrql_screenshot-crop_line-type-chart.webp" />
