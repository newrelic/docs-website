...
선택적으로, 값에 따라 게이지의 색상을 지정하도록 임계값을 설정합니다. 게이지 차트는 <DNT>**Good**</DNT>, <DNT>**Warning**</DNT>, <DNT>**Approaching critical**</DNT> 및 <DNT>**Critical**</DNT> 임계값을 지원합니다. 각 임계값은 지정한 값부터 적용되며, 값이 각 범위로 넘어갈 때 게이지의 색상이 변경됩니다.
