...
<DNT>**NRQL predictions**</DNT> 모든 고객 및 모든 사용자가 이용할 수 있습니다. `PREDICT` 절을 사용하여 NRQL 쿼리가 실행될 때 [코어 CCU](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing/#core-compute-capacity-unit) 가 소비됩니다.
...
<CollapserGroup>
  ...
  >
    ...
    <figcaption>
      \{&lt;&gt;&lt;InlineCode&gt;BY&lt;/InlineCode&gt; 키워드로 만든 예측 예시. 상자로 표시된 영역은 차트의 어떤 부분이 &lt;InlineCode&gt;BY&lt;/InlineCode&gt; 키워드의 영향을 받는지 나타냅니다.&lt;/&gt;}
    </figcaption>
  </Collapser>
  ...
  >
    ...
    <figcaption>
      \{&lt;&gt;&lt;InlineCode&gt;USING&lt;/InlineCode&gt; 키워드를 사용하여 만든 예측의 예. &lt;InlineCode&gt;USING&lt;/InlineCode&gt; 키워드는 차트에 시각화되지 않는 훈련에 사용되는 데이터 양에 영향을 미칩니다.&lt;/&gt;}
    </figcaption>
  </Collapser>
