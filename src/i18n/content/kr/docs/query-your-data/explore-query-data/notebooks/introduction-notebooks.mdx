...
<CollapserGroup>
  <Collapser id="create-notebook" title="Create a notebook">
  ...
  <Collapser id="manage-notebooks" title="Manage your notebooks">
  ...
  <Collapser id="delete-notebook" title="Delete a notebook">
