...
[NRQL 문서](/docs/insights/nrql-new-relic-query-language/using-nrql/introduction-nrql) 에서 NRQL 쿼리를 구성하는 방법을 알아볼 수 있습니다. 다음 표에는 쿼리 빌더에서 NRQL을 사용하기 위한 몇 가지 추가 팁이 나와 있습니다.
