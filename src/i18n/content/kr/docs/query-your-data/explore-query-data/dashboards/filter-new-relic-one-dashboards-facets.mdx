...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Dashboards** : `FACET` 절을 포함하고 [차트 유형 요구 사항](#requirements) 을 충족하는 쿼리의 경우 해당 속성을 설정하여 간편한 대시보드 필터로 사용할 수 있습니다. 속성을 설정하여 현재 있는 대시보드를 필터링하거나 선택한 관련 대시보드를 필터링할 수 있습니다.
</figcaption>
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) >Dashboards** : 패싯 필터링에 대해 설정한 속성을 선택하면 현재 대시보드가 필터링됩니다.
</figcaption>
