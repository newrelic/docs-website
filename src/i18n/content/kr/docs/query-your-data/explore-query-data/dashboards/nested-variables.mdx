...
<Callout variant="tip">
  변수 표시줄의 복잡성을 줄이려면 사용자 입력이 필요하지 않은 상위 변수 또는 보조 변수를 숨기세요. 숨겨진 변수는 계속해서 정상적으로 작동합니다. 자세한 내용은 [변수 표시 및 숨기기를](/docs/query-your-data/explore-query-data/dashboards/dashboard-template-variables/#variable-visibility) 참조하세요.
</Callout>