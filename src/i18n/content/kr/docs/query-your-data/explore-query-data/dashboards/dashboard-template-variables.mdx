...
다음은 오른쪽에 있는 결과의 예이고 왼쪽에는 `country` 드롭다운 메뉴가 있습니다.<img title="Country template variable example" alt="Country template variable example" src={dashboardsCountryVariableExample}/>
