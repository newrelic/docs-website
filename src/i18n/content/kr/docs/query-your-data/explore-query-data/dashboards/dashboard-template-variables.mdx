...
맞춤형 대시보드의 경우 <DNT>**template variables**</DNT> 사용하여 차트 및 기타 설명을 동적으로 필터링할 수 있습니다. 템플릿 변수를 사용하면 대시보드를 더 유용하게 만들고 다양한 사용 사례에 재사용할 수 있는 대시보드를 더 쉽게 만들 수 있습니다.
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            \*\*변수 포함\*\* 토글은 대시보드에서 해당 변수에 대한 기본 설정(포함 또는 제외)을 결정합니다. 이 설정은 대시보드를 보는 사용자가 변수 드롭다운 메뉴 메뉴의 \*\* 변수 포함\*\* 토글을 사용하여 수정할 수 있습니다. 선택한 사이트 설정은 세션 기간 동안 유효합니다.
