...
<DNT>**Include variable**</DNT> 토글을 활성화하고 값을 선택하면 대시보드 데이터가 해당 값으로 필터링됩니다. <DNT>**Refresh to default value**</DNT> 클릭하면 설정된 기본값으로 복원할 수 있습니다. 자세한 내용은 [템플릿 변수를](#create-variables) 참조하세요.
