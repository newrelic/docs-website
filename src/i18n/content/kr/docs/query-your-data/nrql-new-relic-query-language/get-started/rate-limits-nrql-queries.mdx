...
* New Relic 사용자가 실행하는 사용자 지정 쿼리
* 쿼리를 실행하는 사용자 지정 대시보드의 위젯
* 사용자가 시작한 작업으로 인해 로드되는 선별된 보기(예: 사용자가 APM **요약** , APM **트랜잭션** , **분산 추적** , 브라우저 **요약** 및 [NRDB](/docs/data-apis/get-started/nrdb-horsepower-under-hood) 데이터를 반환하는 기타 페이지를 로드할 때)
