...
하위 쿼리가 반환할 수 있는 최대 결과 수는 [LIMIT 최대 값인](/docs/query-your-data/nrql-new-relic-query-language/get-started/nrql-syntax-clauses-functions/#sel-limit) 2,000과 같습니다.
