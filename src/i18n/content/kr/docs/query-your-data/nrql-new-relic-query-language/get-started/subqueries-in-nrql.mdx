...
[`SINCE`](/docs/query-your-data/nrql-new-relic-query-language/get-started/nrql-syntax-clauses-functions/#sel-since) / [`UNTIL`](/docs/query-your-data/nrql-new-relic-query-language/get-started/nrql-syntax-clauses-functions/#sel-until) 로 명시적으로 지정하지 않는 한 하위 쿼리의 시간 범위는 외부 쿼리의 시간 범위와 동일합니다.
...
하위 쿼리가 반환할 수 있는 최대 결과 수는 [`LIMIT MAX` 값](/docs/query-your-data/nrql-new-relic-query-language/get-started/nrql-syntax-clauses-functions/#sel-limit) 과 동일합니다(2,000).
