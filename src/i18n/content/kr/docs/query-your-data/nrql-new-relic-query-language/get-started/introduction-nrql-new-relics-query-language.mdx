...
특정 데이터 유형에 사용할 수 있는 [속성](/docs/using-new-relic/welcome-new-relic/get-started/glossary#attribute)을 보려면 `FROM <var>DATA_TYPE</var> SELECT`를 입력하고 스페이스바를 누릅니다. 인터페이스는 사용 가능한 속성을 제안합니다. 예:
