...
* [NRQL 기반 알림](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/nrql-alert-conditions)(가장 기본적이고 강력한 알림 유형) 설정
...
<CollapserGroup>
  ...
  >
    ...
    NRQL을 사용하여 뉴렐릭의 가장 강력한 기본 알림 유형인 [NRQL 기반 알림](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/nrql-alert-conditions/)을 구축할 수 있습니다. 이는 문제에 대한 알림을 받아 적시에 해결하는 데 도움이 됩니다.
  </Collapser>
