...
New Relic에 저장된 대부분의 데이터는 트랜잭션 및 트랜잭션 오류, PageView 및 PageActions, 로그 및 인프라 등과 같은 다른 데이터와 관련이 있습니다. 이제 최종적으로 분석을 수행하고 하위 쿼리 조인을 사용하여 이러한 이벤트 간의 상관 관계를 계산할 수 있습니다.
