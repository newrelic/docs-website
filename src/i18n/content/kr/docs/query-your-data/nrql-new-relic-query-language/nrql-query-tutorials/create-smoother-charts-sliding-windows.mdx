...
<Callout variant="tip">
  상태 [고급 신호 설정](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/streaming-alerts-key-terms-concepts/#advanced-signal) 에서 UI를 통해 슬라이딩 창을 사용할 수도 있습니다.
</Callout>
