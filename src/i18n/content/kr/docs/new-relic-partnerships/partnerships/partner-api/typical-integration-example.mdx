...
권장사항: [API시작하기](/docs/apm/apis/requirements/new-relic-rest-api-v2-getting-started) 및 [뉴렐릭 REST API v2 예제를](/docs/apis/rest-api-v2) 참조하여 새 프로젝트를 시작하세요. 또한 API v1 스크립트를 해당 v2 스크립트로 마이그레이션하기 시작하세요.
