...
자동 배포를 하든 사용자가 그렇게 하도록 허용하든 이 작업에는 계정 생성 페이로드의 <LicenseKey/> 가 필요합니다. 수동 배포를 계획 중인 경우 사용자가 라이선스 키를 쉽게 사용할 수 있도록 하는 것이 좋습니다. 이는 사용자의 편의를 위한 것입니다. 키는 계정에 로그인하여 사용할 수 있습니다.
