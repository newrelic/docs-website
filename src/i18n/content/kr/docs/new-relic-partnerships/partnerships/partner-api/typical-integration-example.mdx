...
자동 배포를 의도하든 사용자가 그렇게 하도록 허용하든 이 작업에는 계정 생성 페이로드의 라이센스 키가 필요합니다. 수동 배포를 계획하는 경우 사용자가 라이센스 키를 쉽게 사용할 수 있도록 하는 것이 좋습니다. 이것은 사용자를 위한 편의입니다. 키는 계정에 로그인하여 사용할 수 있습니다.
