...
이는 사용자 개체의 속성 목록입니다. 뉴렐릭 계정을 만들 때 한 명의 사용자에게 [<DNT>**owner**</DNT>](#attr-owner) 속성을 할당해야 합니다.
...
<CollapserGroup>
  ...
  >
    ...
    신규 사용자의 경우 이 속성은 <DNT>**required**</DNT> 입니다.
  ...
  <Collapser id="attr-owner" title="소유자">
    <table>
      <tbody>
        <tr>
          <th>
    ...
    이 사용자가 계정의 [소유자](/docs/accounts-partnerships/accounts/account-setup/users-roles) 인지 여부를 나타내는 플래그입니다. 뉴렐릭 계정을 만들 때 <DNT>**must**</DNT> 한 사용자에게 <DNT>**owner**</DNT> 역할을 할당합니다.
  </Collapser>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        <DNT>**Create**</DNT> (추가) 사용자를 계정에 추가합니다.
...
<CollapserGroup>
  <Collapser id="request-example" title="사용자 개체 JSON 요청">
    ```
    {
      "users": [
        {
  ...
  <Collapser id="response-example" title="JSON 응답">
