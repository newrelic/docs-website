...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="합성품"
  >
    New Relic Synthetics의 가격 구조에서 허용 가능한 모니터링 검사의 기본 수와 데이터 보존 기간은 구독 수준에 따라 다릅니다. 제품 ID의 **정수** 형식을 사용하여 구독 수준을 식별합니다.
    ...
    <Callout variant="tip">
      이전에 더 이상 사용되지 않는 Partnership 가용성 모니터링 API를 사용한 경우 [Synthetics API](/docs/synthetics/new-relic-synthetics/scripting-monitors/write-synthetics-api-tests) 를 사용하여 확인을 프로비저닝하고 [REST API를 사용하여 경고](/docs/alerts/rest-api-alerts/new-relic-alerts-rest-api/rest-api-calls-new-relic-alerts) 를 생성하여 고객에 대한 경고 알림을 생성할 수 있습니다.
    </Callout>
  </Collapser>
