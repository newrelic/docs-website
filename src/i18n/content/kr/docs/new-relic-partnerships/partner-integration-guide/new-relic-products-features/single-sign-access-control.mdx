...
2. 뉴렐릭 의 [사용자 메뉴](/docs/accounts/accounts-billing/general-account-settings/intro-account-settings) UI

   <DNT>**Account settings > Partnerships > Edit settings**</DNT>

   에서 을 선택합니다.

3. <DNT>**SSO type**</DNT>

   에 대해 `signature` 선택합니다.
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <DNT>**Example without email:**</DNT> "12345:내비밀:0987654321"
