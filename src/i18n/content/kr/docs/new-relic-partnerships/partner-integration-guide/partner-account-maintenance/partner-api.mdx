...
* **사용자 모델.** New Relic 조직의 사용자가 [New Relic One 사용자 모델](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-user-models) 로 전환된 경우 [원래 사용자 모델](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-user-models) 에서 사용자를 생성하거나 제어하는 API 호출을 더 이상 사용할 수 없습니다. API 영향은 다음과 같습니다.
