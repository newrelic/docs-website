...
<DoNotTranslate>**[Amazon SageMaker Model Monitor](https://docs.aws.amazon.com/sagemaker/latest/dg/model-monitor.html)**</DoNotTranslate> 는 다음과 같은 유형의 모니터링을 제공합니다.
...
보려면 <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Model performance**</DoNotTranslate> 으로 이동하세요.
