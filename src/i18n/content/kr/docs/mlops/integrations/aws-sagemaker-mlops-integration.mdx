...
* HTTP 엔드포인트 URL - 미국 데이터 센터(기본값): `https://aws-api.newrelic.com/cloudwatch-metrics/v1`
* HTTP 끝점 URL - EU 데이터 센터: `https://aws-api.eu01.nr-data.net/cloudwatch-metrics/v1`
* HTTP 엔드포인트 URL-JP 데이터센터: `https://aws-api.jp.nr-data.net/cloudwatch-metrics/v1`
