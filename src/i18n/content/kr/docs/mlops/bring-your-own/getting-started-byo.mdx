...
[라이센스 키](/docs/apis/intro-apis/new-relic-api-keys/#license-key) ( `ingest - license` 라고도 함)를 가져오고 환경 변수로 설정합니다: `NEW_RELIC_INSERT_KEY` . 자세한 내용과 지침을 [보려면 여기를 클릭하십시오](https://docs.newrelic.com/docs/apis/intro-apis/new-relic-api-keys/#license-key) . New Relic EU 지역에 데이터를 보고하고 있습니까? 자세한 지침을 보려면 [여기](#EU-account-users) 를 클릭하십시오.
