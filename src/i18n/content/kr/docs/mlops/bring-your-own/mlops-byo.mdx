...
3. **New Relic Platform에서 데이터 보기:**
   ...
   * **데이터 쿼리:** [메트릭 및 이벤트를](/docs/query-your-data/explore-query-data/browse-data/introduction-data-explorer) 사용하여 보낸 데이터를 보거나 [쿼리 빌더](/docs/query-your-data/explore-query-data/query-builder/introduction-query-builder/) 에서 다음 쿼리를 사용합니다.
