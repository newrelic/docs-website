...
1. **[예제 노트북](https://github.com/newrelic-experimental/ml-performance-monitoring/blob/main/examples/sklearn.RandomForestClassifier_on_Iris_dataset.ipynb) 실행:** [수집 키](#stream-data) 를 환경 변수로 정의하거나 매개변수로 보내야 합니다. (여기에 [노트북의 예가](https://github.com/newrelic-experimental/ml-performance-monitoring/tree/main/examples) 있습니다.)
