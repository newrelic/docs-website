...
3. **자체 데이터 가져오기(BYO):** 다른 라이선스에 가입하고 싶지 않거나 Amazon SageMaker를 사용하지 않는 경우 자체 ML 모델 원격 측정을 New Relic으로 쉽게 가져와 ML에서 가치를 얻을 수 있습니다. 모델 데이터. 몇 분 만에 특성 분포, 통계 데이터 및 예측 분포를 얻을 수 있습니다. [문서에서 BYO에 대해 자세히 알아보세요](/docs/alerts-applied-intelligence/mlops/bring-your-own/mlops-byo) .
