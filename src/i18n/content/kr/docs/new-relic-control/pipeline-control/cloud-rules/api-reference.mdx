...
* [디멘션 메트릭](/docs/data-apis/understand-data/new-relic-data-types/#dimensional-metrics). 몇 가지 주의 사항:
...
* 뉴렐릭에 의해 규칙이 비활성화된 경우(예: EOL 정책): 사용자가 정책을 재정의하는 데 필요한 내부 권한을 보유하고 있지 않으면 요청이 실패합니다.
