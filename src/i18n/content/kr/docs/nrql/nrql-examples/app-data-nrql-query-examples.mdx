...
NRQL을 사용하여 수집된 애플리케이션 데이터를 쿼리할 수 있습니다. [<InlinePopover type="apm"/>](/docs/apm/), [<InlinePopover type="browser"/>](/docs/browser/)및 [모바일 모니터링](/docs/mobile-monitoring/). 그런 다음 이 데이터를 사용하여 다양한 질문에 답할 수 있습니다. 다음은 몇 가지 기본적인 예입니다.
