...
<CollapserGroup>
  ...
  >
    ...
    <figcaption>
      <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Alert conditions (Policies) > (select a policy) > Add a condition**</DoNotTranslate>. <DoNotTranslate>**NRQL**</DoNotTranslate>을 클릭한 다음 한도(thresholds)를 정의합니다.
    </figcaption>
