...
데이터를 탐색하는 또 다른 좋은 방법은 기존 대시보드로 이동하여 <DNT>**View query**</DNT>를 클릭하고 쿼리 빌더에서 차트를 실행하는 것입니다.<img title="new-relic-view-chart-nrql-query.png" alt="New Relic view chart NRQL query" src="/images/queries-nrql_screenshot-crop_view-query-for-chart.webp"/>

<figcaption>
  NRQL로 작성된 차트에는 옵션으로 <DNT>**View query**</DNT>가 있습니다. 그런 다음 해당 쿼리를 수정하고 맞춤화하여 변경 사항이 시각화에 어떤 영향을 미치는지 확인할 수 있습니다.
</figcaption>
