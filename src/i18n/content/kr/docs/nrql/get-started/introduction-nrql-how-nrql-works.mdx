...
```
    ...
    <tr>
      ...
      <td>
        NRQL 쿼리에 주석을 추가할 수 있습니다. [주석에 대해 자세히 알아보십시오](/docs/query-your-data/nrql-new-relic-query-language/get-started/nrql-syntax-clauses-functions#comments).
      </td>
    </tr>
  </tbody>
</table>
...
결과는 필수 절과 문(`FROM` 및 `SELECT`)를 사용하는 매우 기본적인 NRQL 쿼리이며, 아래와 같이 각각에 연관된 <InlinePopover type="apm"/>트랜잭션과 관련된 `appId`를 제공합니다.
