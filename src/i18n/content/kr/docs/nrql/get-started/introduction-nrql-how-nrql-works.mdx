...
데이터를 탐색하는 또 다른 좋은 방법은 기존 대시보드로 이동하여 <DNT>**View query**</DNT>를 클릭하고 쿼리 빌더에서 차트를 실행하는 것입니다.<img title="new-relic-view-chart-nrql-query.png" alt="New Relic view chart NRQL query" src={queriesnrqlViewQueryforChart}/>
