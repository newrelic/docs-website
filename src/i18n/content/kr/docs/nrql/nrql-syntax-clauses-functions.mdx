...
<CollapserGroup>
  ...
  >
    ...
    * pattern - 날짜 문자열 매개변수를 구문 분석하는 데 사용되는 선택적 날짜/시간 패턴입니다. 패턴 문자열을 구성하는 *방법*은 [DatetimeFormatter 문서](https://docs.oracle.com/javase/8/docs/api/java/time/format/DateTimeFormatter.html)의 형식화 및 구문 분석을 위한 패턴 섹션을 참조하십시오.
