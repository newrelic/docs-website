...
[클라우드](/docs/integrations/microsoft-azure-integrations/azure-integrations-list) [통합에서 들어오는 데이터( AWS 폴링 통합](/docs/infrastructure/amazon-integrations/aws-integrations-list), [GCP](/docs/integrations/google-cloud-platform-integrations) 및 Azure 의 메트릭)를 제외하고 차원 메트릭을 기반으로 하는[NRQL 경고 도 지원됩니다.](/docs/alerts/new-relic-alerts/defining-conditions/create-alert-conditions-nrql-queries) AWS CloudWatch Metric Streams 지표는 차원 지표 및 NRQL로 수집됩니다. <InlinePopover type="alerts"/>권장됩니다.
