...
<CollapserGroup>
  ...
  >
    ...
    <DoNotTranslate>**Example:**</DoNotTranslate> 기간 속성에 저장된 간단한 추가 `[100, 110, 90, 100, 105]` 를 고려해보세요.

    `getfield(durations, 2)` `90` 을 반환합니다.

    `getfield()` 함수 대신 대괄호 `[ ]` 약어를 사용할 수 있습니다.

    <DoNotTranslate>**Example:**</DoNotTranslate> `durations[4]` `105` 을 반환합니다.
  </Collapser>
  ...
  >
    ...
    <DoNotTranslate>**Example:**</DoNotTranslate> 값이 `["US", "CA", "UK"]` 인 간단한 추가 `countries` 을 생각해 보세요.
