...
NRQL을 사용하면 다른 쿼리 내에 중첩된 쿼리인 <DoNotTranslate>**subquery**</DoNotTranslate> 을 실행할 수 있습니다. 하위 쿼리는 다른 쿼리 내에 중첩된 하나의 쿼리입니다. 이를 통해 한 쿼리의 결과를 다른 쿼리에서 사용할 수 있습니다. 하위 쿼리를 사용하면 다음을 수행할 수 있습니다.
