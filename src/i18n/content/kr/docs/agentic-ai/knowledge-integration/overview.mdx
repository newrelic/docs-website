...
* **문제 발생 시 더 빠르게 해결:** 뉴렐릭 AI 내에서 내부 런북과 문서에서 관련 컨텍스트에 즉시 액세스하여 평균해결시간(MTTR)을 단축합니다.

* **실행 가능한 맞춤형 권장 사항을 받으세요.** 제공된 답변은 귀하의 환경에 맞게 구성되었으며 귀하의 모범 사례와 역량 데이터를 기반으로 합니다.

* **중요하고 상황에 맞는 질문에 답하세요.** 이전에 해결된 문제에 대한 해결책을 쉽게 찾을 수 있습니다. 다음과 같은 질문을 해보세요.
