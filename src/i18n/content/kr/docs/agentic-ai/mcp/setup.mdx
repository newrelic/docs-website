...
<Callout variant="important">
  **리전 알림:** 이 주제의 설정 예제에서는 미국 리전 MCP 연결 URL을 사용합니다: [https://mcp.newrelic.com/mcp/](https://mcp.newrelic.com/mcp/). 뉴렐릭 계정이 다른 리전에 있는 경우, 모든 설정 파일 및 명령줄 인수에서 이 URL을 적절한 리전 엔드포인트로 교체하십시오:
