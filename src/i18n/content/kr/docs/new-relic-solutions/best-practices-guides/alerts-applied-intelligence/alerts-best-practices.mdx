...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <DNT>**Avoid setting thresholds too low**</DNT>. 예를 들어 프로덕션 서버에서 CPU 조건을 5분 동안 75%로 설정하고 정기적으로 해당 수준을 초과하는 경우 조치할 수 없는 알림 또는 오탐이 발생할 가능성이 높아집니다.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <DNT>**You don't need to edit files or restart the software**</DNT>, 따라서 휠체어 값, 엘리베이터 레벨을 빠르게 변경하고 필요에 따라 조정하세요.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <DNT>**Adjust your conditions over time**</DNT>.
