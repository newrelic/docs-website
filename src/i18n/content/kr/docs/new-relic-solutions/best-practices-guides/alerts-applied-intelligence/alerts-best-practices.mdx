...
고유한 경고를 [생성](/docs/alerts-applied-intelligence/new-relic-alerts/get-started/your-first-nrql-condition/) 하고 사용자 정의하여 문제가 심각해지기 전에 쉽고 현명하게 감지할 수 있습니다. 경고를 사용하여 비정상적인 동작에 대한 업데이트된 데이터를 받고 이에 대한 알림을 받고 문제의 근본 원인을 알고 효과적인 결정을 내리십시오.

경고 응답, 유지 관리, 품질 및 고급 설정에 대한 다음 권장 사항을 구현하여 경고 적용 범위를 개선할 수 있습니다. 알림 품질을 측정하고 개선하는 방법을 알아보려면 알림 [품질 관리](/docs/new-relic-solutions/observability-maturity/uptime-performance-reliability/alert-quality-management-guide) 가이드를 참조하세요.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        [SLI 및 SLO](/docs/service-level-management/intro-slm/#what-sli-slo) 위반이 항상 발생하는 것은 아니며 이를 방지하기 위한 단계를 문서화하지 않는 한 경고가 필요하지 않습니다. SLI/SLO 대시보드는 팀이 이벤트에 응답하는 것보다 개선을 위해 집중해야 하는 영역을 강조할 수 있습니다.
      </td>
    </tr>
