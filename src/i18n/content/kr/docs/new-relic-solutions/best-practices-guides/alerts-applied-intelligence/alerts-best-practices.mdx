...
경고를 사용하면 문제가 심각해지기 전에 문제 감지를 시작할 수 있습니다. New Relic 쿼리 언어인 NRQL을 사용하면 가장 우려되는 사항에 초점을 맞춘 [알림 조건을 만들고 사용자 지정할](/docs/alerts-applied-intelligence/new-relic-alerts/get-started/your-first-nrql-condition/) 수 있습니다. 사용 <InlinePopover type="alerts"/>데이터의 비정상적인 동작에 대한 업데이트를 받고, 이를 확인해야 하는 사람들에게 알림을 전달하고, 문제의 근본 원인을 파악하면서 효과적인 결정을 내리세요.
