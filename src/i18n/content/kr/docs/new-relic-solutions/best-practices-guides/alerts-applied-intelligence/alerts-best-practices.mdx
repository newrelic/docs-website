...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        활용 [하기](/docs/alerts/get-notified/alert-event-workflows/#enrichments)
      </td>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        이것이 [공지 이벤트 마감](/docs/alerts/alert-event-management/how-alert-condition-events-are-closed/) 에 미칠 영향을 이해하실 수 있을 겁니다.
      </td>
    </tr>
...
* [스마트 알림을 통해 대규모로 공지 커버리지 설정](/docs/alerts/smart-alerts-coverage) (퍼블릭 프리뷰)
...
조건문의 `where` 절에서 모든 데이터를 제외하면 남은 데이터가 없게 됩니다. 이는 뉴렐릭에 대한 [신호 손실](https://support.newrelic.com/s/hubtopic/aAX8W0000008bEyWAI/relic-solution-how-can-i-figure-out-when-to-use-gap-filling-and-loss-of-signal) 이며 공지 조건은 ANY 바이올린 값에 대해 평가할 수 없습니다. 이는 NRQL 쿼리 결과에 데이터가 없다는 것을 의미하지만, 뉴럴릭이 데이터를 수신하지 못하고 있다는 것을 의미하는 것은 아닙니다. 공지를 받으시려면, 분실신호값, 유대값을 추가하셔야 합니다.
...
알림 기능을 처음 사용하시는 경우, [문제 설정 옵션](/docs/alerts/organize-alerts/specify-when-alerts-create-events) 에 대해 자세히 알아보세요.
...
* [신호 손실 및 갭 채우기 설정을 사용해야 하는 경우](https://knowledge.newrelic.com/s/article/How-Can-I-Figure-Out-When-To-Use-Gap-Filling-and-Loss-of-Signal)에 대해 자세히 알아보십시오.