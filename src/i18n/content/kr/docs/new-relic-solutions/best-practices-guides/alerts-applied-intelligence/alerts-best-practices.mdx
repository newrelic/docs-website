  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * 알림 조건에서 [`facet/where`](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/nrql-alert-conditions/#syntax) 절의 현재 값입니다.
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        관련 사고는 하나의 포괄적인 [문제](/docs/alerts-applied-intelligence/overview/#concepts-terms)로 연관됩니다.
...
* [경고 개념 및 용어](/docs/alerts-applied-intelligence/overview/#concepts-terms)에 대해 알아봅니다.
