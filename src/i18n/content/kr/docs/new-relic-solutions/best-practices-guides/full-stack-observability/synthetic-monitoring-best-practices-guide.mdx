...
1. 모니터를 추가하려면 **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Synthetic Monitoring** 으로 이동하세요. ( [EU 기반 계정이](/docs/using-new-relic/welcome-new-relic/get-started/introduction-eu-region-data-center) 있는 경우 **[one.eu.newrelic.com](http://one.eu.newrelic.com)** 으로 이동하세요.) **Create monitor** \[모니터 생성 을] 클릭합니다.
...
1. **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Synthetic Monitoring** 으로 이동합니다.
...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities)** 으로 이동하세요. 그런 다음 **Synthetic Monitoring** \[종합 모니터링 을] 클릭합니다.
...
1. **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Synthetic Monitoring** 으로 이동합니다.
2. **Create Monitor** \[모니터 생성] 버튼을 클릭하세요.
