...
1. 모니터를 추가하려면 **[one.newrelic.com](https://one.newrelic.com) > Synthetics** 로 이동하십시오. ( [EU 기반 계정](/docs/using-new-relic/welcome-new-relic/get-started/introduction-eu-region-data-center) 이 있는 경우 **[one.eu.newrelic.com](http://one.eu.newrelic.com)** 으로 이동합니다.) **모니터 만들기** 를 클릭합니다.
...
<CollapserGroup>
  ...
  >
    ...
    **\[one.newrelic.com** ]( [https://one.newrelic.com](https://one.newrelic.com) )으로 이동합니다. > Synthetics\*\*.
  </Collapser>
</CollapserGroup>
...
1. **[one.newrelic.com](https://one.newrelic.com) > Synthetics** 으로 이동합니다.
...
1. **[one.newrelic.com](https://one.newrelic.com)** 으로 이동, 그런 다음 **합성** 을 클릭합니다.
