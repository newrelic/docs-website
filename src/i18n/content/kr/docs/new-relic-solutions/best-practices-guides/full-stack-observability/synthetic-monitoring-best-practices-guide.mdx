...
1. 모니터를 추가하려면 <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Synthetic Monitoring**</DoNotTranslate> 으로 이동하세요. ( [EU 기반 계정이](/docs/using-new-relic/welcome-new-relic/get-started/introduction-eu-region-data-center) 있는 경우 <DoNotTranslate>**[one.eu.newrelic.com](http://one.eu.newrelic.com)**</DoNotTranslate> 로 이동하세요.) <DoNotTranslate>**Create monitor**</DoNotTranslate> 클릭하세요.
...
5. 모니터 유형에 따라 <DoNotTranslate>**Save monitor**</DoNotTranslate>, <DoNotTranslate>**Validate**</DoNotTranslate> 또는 <DoNotTranslate>**Write script**</DoNotTranslate> 중 하나가 됩니다.
...
7. 이제 스크립트를 작성할 준비가 되었습니다.

다음은 newrelic.com의 성능을 테스트하고 특정 요소가 로드되었는지 확인하는 예제 스크립트입니다.
