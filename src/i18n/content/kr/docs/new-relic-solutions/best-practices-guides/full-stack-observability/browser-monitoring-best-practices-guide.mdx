...
New Relic은 브라우저 모니터링을 포함하여 모든 제품에서 [통합 알림을](/docs/alerts-applied-intelligence/applied-intelligence/incident-intelligence/basic-alerting-concepts) 제공하므로 항상 알 수 있습니다. 시작하려면 다음 샘플 알림과 함께 Apdex 점수를 모니터링하도록 알림을 설정하는 것이 좋습니다.
...
* 커뮤니티 포럼인 [New Relic 지원 포럼](https://discuss.newrelic.com/) 에서 질문하십시오.