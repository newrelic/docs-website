...
New Relic은 브라우저 모니터링을 포함하여 모든 제품에서 [통합 알림을](/docs/alerts-applied-intelligence/overview/#concepts-terms) 제공하므로 항상 알 수 있습니다. 시작하려면 다음 샘플 알림과 함께 핵심 웹 바이탈을 모니터링하도록 알림을 설정하는 것이 좋습니다.
