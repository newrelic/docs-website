...
1. 브라우저 모니터링 UI에서
   ...
   <DNT>**Settings > Segment allow lists**</DNT>

   선택합니다.

2. <DNT>**Allow listed segments**</DNT>
...
1. 브라우저 모니터링 UI에서
   ...
   <DNT>**Settings > Domain conditions**</DNT>

   선택합니다.

2. 도메인 조건이 없으면

   <DNT>**Enable domain conditions**</DNT>

   선택합니다. 조건이 있으면

   <DNT>**Next, Choose your setting**</DNT>
...
3. 모니터링할 도메인에서 수집할 데이터를 식별하려면
   ...
   <DNT>**Next, Create conditions.**</DNT>
...
1. <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Service levels**</DNT>

   으)로 이동합니다.

2. <DNT>**Add a service level**</DNT>
...
1. <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alerts conditions (Policies)**</DNT>
...
5. <DNT>**Page view throughput**</DNT>
...
1. <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert conditions (Policies) > New alert**</DNT>

   으)로 이동합니다.

2. <DNT>**Issue Creation Preference**</DNT>
...
1. <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Query builder**</DNT>
...
* <DNT>**Content type:**</DNT>

  사용자가 보고 있는 콘텐츠 유형을 추적하세요.

* <DNT>**Video playback:**</DNT>
