...
브라우저 SPA 모니터링은 새 [브라우저 에이전트 설치](/docs/browser/browser-monitoring/installation/install-browser-monitoring-agent) 에 대해 기본적으로 활성화됩니다. 이 설정을 편집하려면 <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Browser > (select an app) > Settings > Application settings**</DoNotTranslate> 으로 이동하세요.
...
브라우저 모니터링 UI에서 <DoNotTranslate>**Page Views**</DoNotTranslate> 탭을 검토하거나 다음 NRQL 쿼리를 실행하세요.
...
세그먼트가 많은 URL이 많으면 URL이 요약되어 `website.com/product/widget-name` `website.com/` <DoNotTranslate>**or**</DoNotTranslate> `website.com/product/` 이 될 수 있습니다. 이 예에서 첫 번째 요약 URL은 특별히 유용하지 않지만 두 번째 URL은 제품에 대한 고객 경험 데이터를 집계하는 유용한 방법이 될 수 있습니다.
...
2. <DoNotTranslate>**Allow listed segments**</DoNotTranslate>
...
1. <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Service levels**</DoNotTranslate>

   으)로 이동합니다.

2. <DoNotTranslate>**Add a service level**</DoNotTranslate>
...
1. <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Alerts conditions (Policies)**</DoNotTranslate>
...
3. <DoNotTranslate>**Create a condition**</DoNotTranslate>
...
5. <DoNotTranslate>**Page view throughput**</DoNotTranslate>
...
1. <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Alert conditions (Policies) > New alert**</DoNotTranslate>

   으)로 이동합니다.

2. <DoNotTranslate>**Issue Creation Preference**</DoNotTranslate>
...
1. <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Query builder**</DoNotTranslate>
...
3. <DoNotTranslate>**widget title**</DoNotTranslate>
