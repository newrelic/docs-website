...
구성을 조정해야 하는지 여부가 확실하지 않습니까? 도움이 [되도록 세그먼트 허용 목록 조사 대시보드](https://newrelic.com/instant-observability/browser-segment-investigation/eb24e234-90aa-4908-972d-64d6d56b557e) 를 가져옵니다.
...
1. **[one.newrelic.com](https://one.newrelic.com) > Service levels** 으로 이동합니다.
2. **서비스 수준 표시기 추가를** 선택합니다.
3. 엔터티 유형을 **브라우저 애플리케이션** 으로 필터링합니다.
4. 서비스 수준을 설정할 웹 애플리케이션을 선택합니다.
5. 서비스 수준을 설정할 SLI를 선택합니다. 최소한 성공률을 위한 서비스 수준과 가장 큰 내용의 페인트를 만드십시오. 각각에 대해 별도의 서비스 수준을 만들어야 합니다.
6. 임계값, 준수율 및 기간을 설정하라는 메시지를 따릅니다. 과거 이력을 기반으로 한 기본값이 자동으로 계산됩니다. 수락하거나 변경할 수 있습니다.
...
1. **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Policies** 으로 이동합니다.
...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities)** 으로 이동한 다음 **데이터 쿼리** 를 클릭하여 [쿼리 빌더](/docs/query-your-data/explore-query-data/query-builder/introduction-query-builder) 에 액세스합니다.
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Dashboards > (선택한 대시보드)**
</figcaption>
