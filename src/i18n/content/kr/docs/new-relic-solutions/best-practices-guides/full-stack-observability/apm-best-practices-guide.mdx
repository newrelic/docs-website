...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Key transactions** 로 이동한 다음 **Add more** 를 선택합니다. 그런 다음 앱 및 웹 트랜잭션을 선택하거나 선택한 트랜잭션에서 **주요 트랜잭션으로 추적을** 선택합니다.
...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > More > Service maps** 으로 이동합니다.
