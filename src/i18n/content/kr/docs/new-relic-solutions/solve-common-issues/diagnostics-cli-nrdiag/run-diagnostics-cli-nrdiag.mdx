...
<Callout variant="important">
  시스템이 외부 IP 주소에 연결 **하지 않도록** 구성된 경우 이 방법은 작동하지 않습니다. 대신 이메일에 있는 [출력 파일](/docs/using-new-relic/cross-product-functions/diagnostics-cli-nrdiag/interpret-nrdiag-output) 을 New Relic 지원팀에 첨부하십시오. [라이선스 키](/docs/apis/intro-apis/new-relic-api-keys/#license-key)에 문제가 있는 경우 지원을 위해 이메일로 출력 파일을 보내야 합니다.
</Callout>
