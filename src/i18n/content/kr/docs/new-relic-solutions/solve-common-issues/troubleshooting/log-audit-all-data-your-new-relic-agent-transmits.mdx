...
앱이 뉴렐릭으로 전송하는 <DoNotTranslate>**all**</DoNotTranslate> 데이터에 대한 정보를 기록하고 확인해야 하는 경우 짧은 기간 동안 감사 로깅을 활성화할 수 있습니다. 이는 디버깅이나 감사 등에서 정확히 전송되는 내용에 대한 자세한 정보가 필요할 때 유용합니다.
