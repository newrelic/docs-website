...
<table>
  <tbody>
    ...
    <tr>
      <td>
        `includeCount` <h5>부울</h5>
      </td>

      <td>
        `true` 인 경우 쿼리 응답에는 각 도메인 및 유형에 대한 총 엔터티 수가 포함됩니다.
      </td>
    </tr>

    <tr>
      <td>
        `includeResults` <h5>부울</h5>
      </td>

      <td>
        `true` 인 경우 쿼리 응답에 엔터티가 포함됩니다.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        <OptionReference array>
          EntitySearchQuery.SORT_TYPE.알림, EntitySearchQuery.SORT_TYPE.도메인, EntitySearchQuery.SORT_TYPE.MOST_RELEVANT, EntitySearchQuery.SORT_TYPE.NAME, EntitySearchQuery.SORT_TYPE.REPORTING, EntitySearchQuery.SORT_TYPE.TYPE,
        </OptionReference>
      </td>
    </tr>
  </tbody>
