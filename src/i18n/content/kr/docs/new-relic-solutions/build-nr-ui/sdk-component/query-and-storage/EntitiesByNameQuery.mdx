    ...
    <tr>
      ...
      <td>
        ...
        <OptionReference array>
          EntitiesByNameQuery.SORT_TYPE.알림, EntitiesByNameQuery.SORT_TYPE.도메인, EntitiesByNameQuery.SORT_TYPE.MOST_RELEVANT, EntitiesByNameQuery.SORT_TYPE.NAME, EntitiesByNameQuery.SORT_TYPE.REPORTING, EntitiesByNameQuery.SORT_TYPE.TYPE,
        </OptionReference>
      </td>
    </tr>
  </tbody>
