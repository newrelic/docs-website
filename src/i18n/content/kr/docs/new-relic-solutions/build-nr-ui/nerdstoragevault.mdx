...
여러분의 뉴킹릭 제작을 돕기 위해 [뉴킹릭 One SDK](/docs/new-relic-solutions/build-nr-ui/sdk-component/intro-to-sdk) 를 제공합니다. 이 페이지에서는 `NerdStorageVault` 사용하여 암호화된 저장 솔루션에 데이터를 저장하는 방법을 알아봅니다.
