...
여러분의 [뉴킹릭](/docs/new-relic-solutions/tutorials/build-hello-world-app) 제작을 돕기 위해 [뉴렐릭 One SDK](/docs/new-relic-solutions/build-nr-ui/sdk-component/intro-to-sdk) 를 제공합니다. 여기에서는 [NerdGraph(](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph/) GraphQL 저장소)를 통해 쿼리와 변형을 수행할 수 있는 SDK 쿼리 구성 요소를 사용하는 방법을 알아볼 수 있습니다.
