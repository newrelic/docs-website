...
여러분의 뉴킹릭 제작을 돕기 위해 뉴킹릭 One SDK를 제공합니다. 여기서는 GraphQL 엔드포인트인 [NerdGraph를](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph/) 통해 쿼리 및 변형을 만들 수 있는 SDK 쿼리 구성 요소를 사용하는 방법을 배울 수 있습니다.
