  ...
  <Step>
    ...
    **App performance** \[앱 성능 을] 클릭합니다.
    ...
    <Callout variant="tip">
      ...
      * 새로운 UUID를 생성했습니다.
      * 프로젝트의 모든 `<YOUR NEW RELIC ACCOUNT ID>` 및 `<YOUR NEW RELIC ENTITY GUID>` ) 각각 실제 New Relic [계정 ID](https://docs.newrelic.com/docs/accounts/accounts-billing/account-setup/account-id) 및 엔터티 GUID로 대체했습니다.
    </Callout>
  </Step>
</Steps>
