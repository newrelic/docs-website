...
<Steps>
  <Step>
    [교과](https://github.com/newrelic-experimental/nru-programmability-course) 과정 저장소 의 _third-party-services/ab-test 디렉터리로 변경합니다._
  ...
  <Step>
    ...
    <Callout variant="tip">
      ...
      * 새로운 UUID를 생성했습니다.
      * 프로젝트에 있는 모든 `<YOUR NEW RELIC ACCOUNT ID>` 을(를) 실제 New Relic [계정 ID](https://docs.newrelic.com/docs/accounts/accounts-billing/account-setup/account-id)로 대체했습니다.
    </Callout>
