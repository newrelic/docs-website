...
* 다른 <InlinePopover type="dashboards" />및 데이터와 함께 [뉴렐릭 플랫폼](/docs/new-relic-one/use-new-relic-one/get-started/introduction-new-relic-one) 에 상주하세요.
...
<figcaption>
  <DNT>**[one.newrelic.com](https://one.newrelic.com/all-capabilities):**</DNT> 다음은 뉴쿨릭을 기반으로 구축된 맞춤 제작의 예입니다. 이 애플리케이션은 <InlinePopover type="browser" />에서 보고된 PageView 이벤트를 사용하여 웹사이트에 대한 매우 상세한 분석을 제공합니다.
</figcaption>
