...
뉴렐릭의 GraphQL API 인 [NerdGraph를](https://docs.newrelic.com/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph/) 사용하여 프로그래밍 방식으로 새 대시보드 또는 기존 대시보드에 사용자 정의 시각화를 추가하세요.
...
1. <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Dashboards**</DoNotTranslate> 으로 이동하여 대시보드를 선택하세요.
