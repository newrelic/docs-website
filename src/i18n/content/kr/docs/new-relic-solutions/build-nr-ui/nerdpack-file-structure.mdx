...
* **Nerdpack 생성**: 뉴웰릭 One CLI 명령 [`nr1 create`](/docs/new-relic-solutions/build-nr-ui/nr1-cli/nr1-common/#nr1-create) 을 사용하고 `Nerdpack` 선택하여 Nerdlet과 실행 프로그램이 포함된 Nerdpack 템플릿을 생성합니다.

* **Nerdlet 또는 실행 프로그램을 개별적으로 생성**: 뉴렐릭 One CLI 명령 [`nr1 create`](/docs/new-relic-solutions/build-nr-ui/nr1-cli/nr1-common/#nr1-create) 을 사용하고 `Nerdlet` 또는 `launcher` 중 하나를 선택합니다. 이는 기존 Nerdpack에 Nerdlet을 추가할 때 유용할 수 있습니다.
