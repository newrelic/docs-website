...
import omaOeScBrowserErrors from 'images/oma-oe-sc_screenshot-browser-errors.png'
import omaOeScBrowserErrorLog from 'images/oma-oe-sc_screenshot-browser-errorlog.png'
import omaOeScBrowserGroupedPageViews from 'images/oma-oe-sc_screenshot-poor-pageview-grouping.png'
import omaOeScBrowserGroupedAjaxRequests from 'images/oma-oe-sc_screenshot-poor-ajax-grouping.png'
...
<CollapserGroup>
  <Collapser
    ...
    title="UI를 통해"
  >
    이벤트 로그를 캡처하고 있는지 확인하려면 JS 오류 탭으로 이동하십시오. 이벤트 로그가 나타나는지 확인하려면 여러 가지 다른 오류를 드릴다운하십시오.<img src={omaOeScBrowserErrorLog} alt="Browser JavaScript Error Logs" title="Browser JavaScript Error Logs"/>
  </Collapser>
</CollapserGroup>
