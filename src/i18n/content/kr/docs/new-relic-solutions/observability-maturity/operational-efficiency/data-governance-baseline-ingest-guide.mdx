...
<CollapserGroup>
  ...
  >
    ...
    Standard 에디션의 경우 매월 최대 100GB의 데이터를 무료로 수집할 수 있습니다. 현재 무료 계정으로 작업 중인 경우 100GB를 월별 수집 목표로 고려할 수 있습니다. 무료 계정에서는 매월 100GB를 초과하여 수집되는 추가 데이터에 대해 GB당 $0.30가 청구됩니다( [자세히 알아보기](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/data-ingest-billing#standard-data) ).
