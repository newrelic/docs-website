...
<CollapserGroup>
  ...
  >
    ...
    `NrConsumption` 사용하면 "얼마나 많은지"와 같은 질문을 할 수 있습니다. <InlinePopover type="browser"/>데이터는 지난 30일 동안 각 계정에서 수집되었습니까?" 및 "이전 30일 이후 수집이 어떻게 변경되었습니까?" 다음은 해당 데이터를 반환하는 쿼리입니다.
