...
<DoNotTranslate>**Data ingest governance**</DoNotTranslate> 조직이 수집한 텔레메트리 데이터에 대해 최적의 가치를 얻는 관행입니다. 이는 수많은 사업부와 작업 그룹이 있는 복잡한 조직에 특히 중요합니다. 이것은 뉴렐릭 데이터 수집 최적화에 대한 4부로 구성된 가이드 중 두 번째 부분이며, [옵저버빌리티 성숙도에 대한 시리즈](/docs/new-relic-solutions/observability-maturity/introduction) 의 일부입니다.
...
<CollapserGroup>
  ...
  >
    ...
    모든 [버전](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing#editions) 에서는 매월 100GB의 데이터 수집이 무료로 제공됩니다. 무료 금액 이상의 데이터 수집 가격에 대한 자세한 내용은 [정가표를](/docs/licenses/license-information/usage-plans/new-relic-usage-plan/#list-price) 참조하세요.
  </Collapser>
  ...
  >
    <CollapserGroup>
      ...
      >
        ...
        <figcaption>
          성장 패턴을 이해하기 위해 <DoNotTranslate>**COMPARE WITH**</DoNotTranslate> 사용하는 것을 보여주는 예시 차트입니다.
        </figcaption>
      </Collapser>
      ...
      >
        ...
        1일 수집 비율에 대한 원시 시계열의 들쭉날쭉함을 참고하세요.
        ...
        <figcaption>
          일일 요율 시계열 <DoNotTranslate>**without**</DoNotTranslate> 평활화
        </figcaption>
        ...
        <figcaption>
          일일 요율 시계열 <DoNotTranslate>**with**</DoNotTranslate> 평활화
        </figcaption>
      </Collapser>
      ...
      >
        ...
        <figcaption>
          <DoNotTranslate>**Metric**</DoNotTranslate> 네임스페이스의 <DoNotTranslate>**metricName**</DoNotTranslate> 속성에 의한 수집 목록
        </figcaption>
      </Collapser>
    </CollapserGroup>
  </Collapser>
...
<figcaption>
  NRQL 사용하여 완충, 목표 30일 수집 <DoNotTranslate>**target**</DoNotTranslate>을 나타내는 라인을 렌더링할 수 있습니다.
</figcaption>
...
<figcaption>
  NRQL을 사용하여 일일 수집 <DoNotTranslate>**target**</DoNotTranslate> 나타내는 라인을 렌더링할 수 있습니다.
</figcaption>
...
<DoNotTranslate>**Optimize**</DoNotTranslate> 및 <DoNotTranslate>**Forecast**</DoNotTranslate> 과 같은 데이터 수집 거버넌스의 다른 단계를 용이하게 하려면 보고서에 유용한 열을 추가하세요. 다음 필드는 최적화 및 계획 결정을 안내하는 데 도움이 됩니다.
...
<figcaption>
  Lookout을 사용하여 <DoNotTranslate>**usageMetric**</DoNotTranslate> 까지 수집에서 이상 동작을 찾을 수 있습니다.
</figcaption>
...
<figcaption>
  Lookout을 사용하여 <DoNotTranslate>**consumingAccountName**</DoNotTranslate> 까지 수집에서 이상 동작을 찾을 수 있습니다.
</figcaption>
...
5. 빠른 시작 설치가 완료되면 `Data governance entity breakdowns` 대시보드를 엽니다.
   ...
   <figcaption>
     엔터티 분석 대시보드는 <DoNotTranslate>**bytecountestimate()**</DoNotTranslate> 사용하여 클러스터 이름과 같은 유용한 속성별로 패싯을 수집합니다.
   </figcaption>
...
다행히도 이 강력한 <InlinePopover type="dashboards"/>세트는 [뉴렐릭 Instant 옵저버빌리티에서 직접](https://onenr.io/0EPwJJO9Ow7) 설치할 수 있습니다.
