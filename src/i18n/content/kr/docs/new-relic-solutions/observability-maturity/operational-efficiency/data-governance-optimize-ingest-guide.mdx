...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="클라우드 측정항목"
  >
    경우에 따라 중복 적용 범위가 있는 데이터를 절약할 수 있습니다.예를 들어, AWS RDS 통합이 실행되고 있고 nri-mysql 또는 nri-postgresql과 같은 SQL 데이터베이스를 모니터링하는 New Relic 온호스트 통합 중 하나가 실행 중인 환경에서 일부 겹치는 지표를 삭제할 수 있습니다.
