...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="예 2: 고객 경험에 중점"
  >
    모바일 모니터링에 중점을 두고 새로운 사용자 지향 플랫폼을 담당하는 팀입니다. <InlinePopover type="browser"/>예산이 50% 초과되었습니다. 수집 크기를 적절하게 조정해야 하지만 **고객 경험** 관찰 가능성을 희생하지 않는다는 점에 대해 단호합니다.
...
<CollapserGroup>
  ...
  >
    ...
    * `config_file`: 기존 Fluent Bit 구성 파일의 경로입니다. 소스가 겹치면 New Relic의 메시지가 중복됩니다.
