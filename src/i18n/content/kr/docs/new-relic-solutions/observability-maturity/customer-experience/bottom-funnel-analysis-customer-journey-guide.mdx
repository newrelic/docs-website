...
import cxBotfaFunnel from 'images/cx_diagram_botfa-funnel.png'

import cxBotfaEcommerce from 'images/cx_diagram_botfa-ecommerce.png'

import cxBotfaCarInsurance from 'images/cx_diagram_botfa-car-insurance.png'

import cxBotfaPagesActions from 'images/cx_diagram_pages-actions.png'

import cxBotfaDashboard from 'images/cx_diagram_botfa-dashboard.png'

import cxBotfaKpiTracking from 'images/cx_diagram_botfa-kpi-tracking.png'
...
* [해당 페이지에 브라우저 에이전트(Pro 버전) 설치](/docs/browser/browser-monitoring/installation/)
