...
가지고 있는 계정의 수를 최소화해야 합니다. 이를 통해 계정 및 사용자 구조를 단순하게 유지하고 사용자가 관련 데이터에 더 쉽게 액세스할 수 있습니다. [계정을 추가하는 이유에 대해 자세히 알아보세요](/docs/accounts/accounts-billing/account-structure/new-relic-account-structure#add-accounts).
