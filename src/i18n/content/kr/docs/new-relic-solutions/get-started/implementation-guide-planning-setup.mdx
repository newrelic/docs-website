...
Pro 및 Enterprise [버전](https://newrelic.com/pricing) 에서만 다중 계정, 사용자 정의 그룹 및 역할 추가 기능, 5명 이상의 전체 플랫폼 사용자 보유 기능이 허용됩니다. 이는 무료 또는 표준 버전을 사용하는 경우 사용자 계획이 덜 중요하다는 것을 의미합니다.
