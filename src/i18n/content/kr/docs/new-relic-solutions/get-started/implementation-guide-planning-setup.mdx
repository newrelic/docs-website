...
* **예상 업무에 따라 사용자 유형을 지정합니다.** 관리 업무를 수행하려면 사용자를 핵심 또는 전체 플랫폼 사용자로 지정해야 합니다. [사용자 유형에 대해 자세히 알아보세요.](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type)

* **사용자를 적절한 [그룹](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts/#understand-concepts) 에 할당합니다.** 그룹에 관리자를 추가하는 옵션:

  * 모든 항목에 대한 액세스 권한을 부여하는 기본 [**Admin** \[관리\] 그룹](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts/#default-groups) 에 추가하세요.
  * 특정 그룹의 사용자를 추가/제거할 수 있는 권한을 부여하는 [**Group admin** \[그룹 관리자\] 역할을](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts#group-admin) 부여합니다.
