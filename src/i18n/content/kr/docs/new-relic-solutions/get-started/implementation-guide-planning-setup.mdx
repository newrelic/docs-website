...
뉴렐릭에 가입할 때 조직이 위치할 데이터센터 지역을 선택해야 합니다. 지역 간에는 몇 가지 차이점이 있습니다: 예를 들어, API 엔드포인트가 다르고 일부 기능에 차이가 있습니다. [데이터센터 지역에 대해 자세히 알아보세요.](/docs/accounts/accounts-billing/account-setup/choose-your-data-center/)
