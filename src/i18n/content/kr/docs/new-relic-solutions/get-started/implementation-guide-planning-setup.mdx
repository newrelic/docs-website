...
* [<DNT>**workloads**</DNT> 기능을](/docs/new-relic-solutions/new-relic-one/workloads/workloads-isolate-resolve-incidents-faster) 사용하면 관련 앱, 서비스, 호스트 및 기타 엔터티를 비즈니스 관련 그룹으로 그룹화하고 해당 정보를 하나의 대시보드에서 볼 수 있습니다. 관련 엔터티를 워크로드로 그룹화하는 방법에 대해 잠시 생각해 보세요.
