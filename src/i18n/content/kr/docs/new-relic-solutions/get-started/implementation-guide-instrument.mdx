...
* 다음 중 하나 이상을 포함할 수 있는 애플리케이션 모니터링을 설정합니다.
  ...
  * 우리의
    ...
    대부분의 언어별 앱 프레임워크 중 일부를 모니터링하는 에이전트.
...
우리의 <InlinePopover type="apm"/>에이전트는 가장 많이 사용되는 도구 중 하나이므로 다음으로 몇 가지 APM 팁과 고려 사항을 제공합니다.
