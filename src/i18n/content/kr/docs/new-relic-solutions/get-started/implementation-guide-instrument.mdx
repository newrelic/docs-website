...
<CollapserGroup>
  ...
  >
    ...
    * 쿠버네티스:
      ...
      * [Kubernetes를 통해 에이전트 설치](/install/kubernetes)
...
* <InlinePopover type="apm"/>
  ...
  에이전트: 앱 모니터링에 가장 인기 있는 선택입니다. 아직 APM 에이전트를 설치하지 않은 경우(예: 안내 설치를 통해)

  <DNT>
    [**Add your data**](https://one.newrelic.com/marketplace?state=b0897c4b-8fb0-eac2-7d6a-613337a6e03d)
  </DNT>

  [UI 페이지](https://one.newrelic.com/marketplace?state=b0897c4b-8fb0-eac2-7d6a-613337a6e03d) 로 이동하여 언어를 선택하세요. 완료되면 [APM 요약 UI](/docs/apm/apm-ui-pages/monitoring/apm-summary-page-view-transaction-apdex-usage-data) 및 [분산 추적 UI](/docs/distributed-tracing/ui-data/understand-use-distributed-tracing-ui) 에서 앱 데이터를 찾으세요.
...
<InlinePopover type="apm"/>에이전트는 가장 널리 사용되는 도구 중 하나이므로 다음으로 몇 가지 APM 팁과 고려 사항을 알려 드리겠습니다.
...
특히 APM 에이전트가 이미 설치되어 있는 경우 브라우저 모니터링을 쉽게 설정할 수 있습니다. 시작하려면 [<DNT>**Add your data**</DNT> UI 페이지를](https://one.newrelic.com/marketplace?state=dbe79256-a6cf-ea3e-baac-c5dab3a0b5cb) 확인하고 <DNT>**Browser monitoring**</DNT> 클릭하세요.
...
시작하려면 [<DNT>**Add your data**</DNT> UI 페이지를](https://one.newrelic.com/marketplace?state=dbe79256-a6cf-ea3e-baac-c5dab3a0b5cb) 확인하고 모바일 프레임워크를 선택하세요. 완료되면 [모바일 모니터링 UI](/docs/mobile-monitoring/mobile-monitoring-ui/mobile-app-pages/mobile-apps-summary-page) 에 데이터가 표시됩니다.
...
* [사용 UI](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing#usage-ui) 로 이동하여 데이터 수집에 대한 높은 수준의 보기를 얻으십시오.
...
* 수집된 데이터의 개요를 보려면 [사용량 UI](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing#usage-ui) 로 이동합니다(결제 권한이 필요함).
...
구현 여정을 계속할 준비가 되셨나요? 다음 단계로 이동합니다: [<DNT>**Understand and organize your data**</DNT>](/docs/new-relic-solutions/get-started/implementation-guide-organize-data).
