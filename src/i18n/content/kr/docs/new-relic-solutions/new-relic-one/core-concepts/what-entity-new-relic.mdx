...
<Callout variant="important">
  엔터티에서 보고하는 원격 분석을 기반으로 자동 관계가 생성됩니다. 이러한 관계에는 TTL(Time To Live)이 있습니다. 즉, 관계를 생성하는 데 사용된 메트릭이 지정된 기간 동안 보고되지 않으면 자동으로 삭제됩니다. 관계의 기본 TTL은 <b>75분</b>입니다. TTL은 각 관계에 대해 구성할 수 있으며 <b>10분에서 최대 3일까지</b>가능합니다.
</Callout>
