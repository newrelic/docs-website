...
엔터티 필터 표시줄은 기본 엔터티 목록 보기, APM, 브라우저 모니터링 UI, 인프라 UI 등 여러 New Relic 환경에서 사용할 수 있습니다. 이것을 사용하여 엔터티를 필터링하고 보기를 저장하는 방법을 알아보려면 [엔터티 필터를](/docs/new-relic-solutions/new-relic-one/core-concepts/search-filter-entities) 참조하십시오.
...
* 엔터티의 GUID 및 기타 메타데이터를 찾으려면 [엔터티 목록](/docs/new-relic-solutions/new-relic-one/core-concepts/new-relic-explorer-view-performance-across-apps-services-hosts#find) 에서 엔터티의

  <Icon name="fe-more-horizontal"/>

  아이콘을 클릭하고 **See metadata and tags** \[메타데이터 및 태그 보기 를] 클릭합니다.
...
* 엔터티 유형에 대한 기술 세부 정보를 알아보려면 [GitHub 저장소의 엔터티 문서를](https://github.com/newrelic/entity-definitions/tree/main) 참조하세요. 엔티티 유형의 `definition` 파일에서 다음과 같은 정보를 볼 수 있습니다.
