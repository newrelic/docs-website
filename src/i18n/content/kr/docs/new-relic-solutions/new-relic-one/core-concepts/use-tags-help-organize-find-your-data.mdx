...
3. 팝업 메뉴의 **Add a new tag...**\[새 태그 추가...] 필드에서 `accountId: 123456789`형식의 태그를 추가합니다.<img title="Add tags in New Relic" alt="Add tags in New Relic" src={solutionsTagManagement}/>
