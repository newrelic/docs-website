...
[API](/docs/apis/nerdgraph/examples/nerdgraph-tagging-api-tutorial/) 또는 [New Relic CLI를](https://developer.newrelic.com/automate-workflows/5-mins-tag-resources) 사용하여 프로그래밍 방식으로 태그를 자동화할 수도 있습니다.
