...
3. 태그의 <DNT>**Add a new tag...**</DNT> 필드에 다음 형식의 태그를 추가하세요: `accountId: 123456789`.<img title="Add tags in New Relic" alt="Add tags in New Relic" src={solutionsTagManagement}/>
