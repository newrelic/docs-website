...
import solutionsWorkloadStatusMain from 'images/solutions_screenshot-crop_workload-status-main.png'

import solutionsWorkloadStatusRule from 'images/new-relic-workloads-status-rule.png'

import solutionsWorkloadsPreview from 'images/solutions_screenshot-crop_workloads-preview.png'
