...
우리는 [공지 인시던트](/docs/alerts) 의 결과를 기반으로 모든 모니터 엔터티에 대한 상태 값을 제공합니다. <DoNotTranslate>**All entities**</DoNotTranslate> 뷰에서 엔터티별 [공지현황을 색상](/docs/alerts/new-relic-alerts/configuring-alert-policies/identify-entities-without-alert-policies#colors) 별로 확인할 수 있습니다.
...
1. <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DoNotTranslate> 으로 이동하여 <DoNotTranslate>**Alerts**</DoNotTranslate> 선택합니다. 새로운 공지 조건을 추가하려는 정책을 선택하거나, 적절한 공지 채널로 새 정책을 생성하세요. 그런 다음 <DoNotTranslate>**Create a condition**</DoNotTranslate>) 클릭하세요.

2. <DoNotTranslate>**Select a product**</DoNotTranslate> 으로 이동하려면 <DoNotTranslate>**NRQL**</DoNotTranslate> 클릭하세요.
