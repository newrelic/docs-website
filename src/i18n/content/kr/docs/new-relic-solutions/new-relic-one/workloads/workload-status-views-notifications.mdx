...
<Callout variant="tip">
  이 페이지는 [표준 워크로드](/docs/new-relic-solutions/new-relic-one/workloads/create-workloads) 와 [지능형 워크로드](/docs/new-relic-solutions/new-relic-one/workloads/workloads-overview#intelligent-workloads) 모두에 적용됩니다. 상태 값과 공지는 두 유형 모두 동일한 방식으로 작동합니다.
</Callout>
