...
서비스 맵을 보려면 **[one.newrelic.com](https://one.newrelic.com/all-capabilities)** 에서 **Explorer** 를 클릭하십시오. 보려는 엔터티를 선택하면 사이드바에서 서비스 맵을 선택할 수 있습니다.
...
3. 연결 목록에서 지도에 표시할 엔터티에 대한 확인란을 선택된 상태로 유지합니다. 지도에서 제거하려는 엔티티의 확인란을 선택 취소합니다.
