...
<CollapserGroup>
  <Collapser id="access-rules" title="보기 정규화 규칙">
    <DNT>**Metric normalization rules**</DNT> 페이지를 보려면 <DNT>[https://one.newrelic.com](https://one.newrelic.com) &gt; **All Entities**</DNT> &gt; 엔티티 선택 &gt; <DNT>**Settings** &gt; **Metric normalization** </DNT>(으)로 이동하십시오.
