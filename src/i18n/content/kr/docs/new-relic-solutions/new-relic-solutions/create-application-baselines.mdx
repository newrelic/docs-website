...
<CollapserGroup>
  <Collapser id="components-list" title="예: 구성 요소 목록">
...
<CollapserGroup>
  <Collapser id="connect-migration-example" title="예: New Relic 제품과 일치하는 구성 요소">
...
<CollapserGroup>
  <Collapser id="deploy-apm" title="APM 배포">
  ...
  <Collapser id="deploy-infrastructure" title="인프라 배포">
  ...
  <Collapser id="deploy-infrastructure-on-host" title="인프라 온-호스트 통합 배포">
  ...
  <Collapser id="create-synthetics-monitor" title="합성 모니터 만들기">
...
<CollapserGroup>
  <Collapser id="baseline-maturity-example" title="예: 기준선과 비교한 구성 요소 성능">
