...
<Steps>
  ...
  <Step>
    [귀하의 계정에 **Victory Charts Visualizations** \[승리 차트 시각화를\] 추가하십시오](/docs/new-relic-solutions/new-relic-one/build-nr-apps/subscribe).
  </Step>
  ...
  <Step>
    구독한 버전 대신 조정된 버전의 **Victory Charts Visualizations** Nerdpack을 사용할 것이므로, 이제 당사 버전에서 [구독 취소](/docs/new-relic-solutions/new-relic-one/build-nr-apps/subscribe/#unsubscribe-from-a-nerdpack) 할 수 있습니다.
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    완벽한! Instant Observability 카탈로그에서 오픈 소스 **Circular progress bar** \[원형 진행률 표시줄] 시각화를 복제하고 업데이트했습니다. 남은 유일한 일은 귀하의 버전을 카탈로그에 게시하여 귀하의 계정이 이를 [구독](/docs/new-relic-solutions/new-relic-one/build-nr-apps/subscribe/#subscribe-to-a-nerdpack) 할 수 있도록 하는 것입니다.
  </Step>
...
<Steps>
  <Step>
    루트 디렉터리에서 Nerdpack을 [게시](/docs/new-relic-solutions/new-relic-one/build-nr-apps/publish/) 합니다:
  ...
  <Step>
    Nerdpack을 [구독](/docs/new-relic-solutions/new-relic-one/build-nr-apps/subscribe/#subscribe-to-a-nerdpack) 합니다:
