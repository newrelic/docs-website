...
New Relic CLI에서 [사용 가능한 모든 명령을](https://github.com/newrelic/newrelic-cli/blob/master/docs/cli/newrelic.md) 살펴보세요. 예를 들어, 사용하여 [New Relic 워크플로를](/docs/new-relic-one/use-new-relic-one/core-concepts/new-relic-one-workloads-isolate-resolve-incidents-faster) 생성할 수 있습니다.[`workload create`](https://github.com/newrelic/newrelic-cli/blob/master/docs/cli/newrelic_workload_create.md)
