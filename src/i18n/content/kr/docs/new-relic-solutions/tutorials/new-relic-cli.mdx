...
<Steps>
  ...
  <Step>
    ...
    <Callout variant="important">
      뉴렐릭 계정의 [지역을](/docs/accounts/accounts-billing/account-setup/choose-your-data-center) 설정해야 합니다. `-r` 사용하여 `us`, `eu` 또는 `jp` 설정합니다.
    </Callout>
  </Step>
...
뉴렐릭 CLI에서 [사용 가능한 모든 명령어를](https://github.com/newrelic/newrelic-cli/blob/master/docs/cli/newrelic.md) 살펴보세요. 예를 들어, [뉴렐릭 워크로드](/docs/new-relic-solutions/new-relic-one/workloads/workloads-overview) 를 [`workload create`](https://github.com/newrelic/newrelic-cli/blob/master/docs/cli/newrelic_workload_create.md)사용하여 만들 수 있습니다.

다른 커뮤니티 멤버들과 소통하고 싶으시다면 [뉴렐릭 Explorer Hub](https://support.newrelic.com/s/hubtopic/Topic__c/Default?c__categories=%5B%7B%22icon%22%3A%22standard%3Adefault%22%2C%22id%22%3A%22a6c8W000000EeszQAC%22%2C%22sObjectType%22%3A%22Category__c%22%2C%22title%22%3A%22Build%20on%20New%20Relic%22%2C%22titleFormatted%22%3A%22Build%20on%20New%20Relic%22%7D%5D) 페이지를 방문해 주십시오. [GitHub](https://github.com/newrelic/newrelic-cli)에서 기능 requests 또는 버그 리포트를 환영합니다.