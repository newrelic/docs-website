...
뉴렐릭 CLI에서 [사용 가능한 모든 명령어를](https://github.com/newrelic/newrelic-cli/blob/master/docs/cli/newrelic.md) 살펴보세요. 예를 들어, [뉴렐릭 워크로드를](\(/docs/new-relic-solutions/new-relic-one/workloads/workloads-isolate-resolve-alert-events-faster\)) [`workload create`](https://github.com/newrelic/newrelic-cli/blob/master/docs/cli/newrelic_workload_create.md)사용하여 만들 수 있습니다.
