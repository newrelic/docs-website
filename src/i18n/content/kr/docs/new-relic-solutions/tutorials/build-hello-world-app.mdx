...
<Steps>
  ...
  <Step>
    선택적 단계로 _icon.png_ 라는 이미지를 사용하여 [사용자 지정 실행기 아이콘을 추가](https://developer.newrelic.com/build-apps/publish-deploy/catalog/#update-your-nerdpacks-icons)할 수 있습니다.
