...
환경 설정에 대한 자세한 내용은 [개발 환경 설정](https://developer.newrelic.com/build-apps/set-up-dev-env/) 및 [Nerdpack에 대한 고급 구성 활성화를](https://developer.newrelic.com/build-apps/advanced-config) 참조하세요.
...
<Steps>
  ...
  <Step>
    [뉴렐릭](https://one.newrelic.com) 에서 <DoNotTranslate>**Add Data**</DoNotTranslate> 클릭합니다.
...
<Steps>
  ...
  <Step>
    ...
    런처나 Nerdlet에 스크린샷을 추가한 경우 <DoNotTranslate>**What's inside**</DoNotTranslate> 아래에서 볼 수 있습니다.
...
<Steps>
  ...
  <Step>
    애플리케이션 설명 페이지에서 <DoNotTranslate>**Add this app**</DoNotTranslate> 클릭합니다.
  ...
  <Step>
    <DoNotTranslate>**Apps**</DoNotTranslate> 페이지로 이동:
