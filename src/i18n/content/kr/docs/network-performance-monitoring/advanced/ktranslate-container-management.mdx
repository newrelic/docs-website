...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [](/docs/apis/intro-apis/new-relic-api-keys/#license-key)데이터를 New Relic API로 전송하기 위해 **ktranslate의** New Relic 라이센스 키를 보유하기 위해 Docker 런타임 중에 사용해야 하는 환경 변수입니다. 예: `-e NEW_RELIC_API_KEY=$LICENSE_KEY` .
      </td>
    </tr>
