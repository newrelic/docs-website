...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [새로운 Relic Log API 엔드포인트](/docs/logs/log-management/log-api/introduction-log-api/#endpoint) :
...
<Callout variant="tip">
  **ktranslate** 의 기본 수신 포트는 `5143 (TCP/UDP)` 입니다. `514` (또는 다른 포트)의 기본 syslog 포트를 사용해야 하는 경우 Docker 런타임 중에 새 수신 엔드포인트를 제공하면 됩니다. 예: `-syslog="0.0.0.0:514"` .
</Callout>
