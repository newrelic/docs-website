...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [New Relic Event API](/docs/data-apis/ingest-apis/event-api/introduction-event-api#requirements) 미국 엔드포인트: `https://insights-collector.newrelic.com` EU 엔드포인트: `https://insights-collector.eu01.nr-data.net`
      </td>
