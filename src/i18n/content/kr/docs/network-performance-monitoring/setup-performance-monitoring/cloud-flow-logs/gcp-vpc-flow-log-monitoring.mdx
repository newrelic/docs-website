...
2. <DNT>**Logging Sink**</DNT>
   ...
   <Callout variant="tip">[안내 설치 과정](https://one.newrelic.com/marketplace?duration=1800000&state=00731ead-620f-4a71-b1fa-b4fc6af24fca) 에서 ypu는 필터 조건이 어떤 것인지에 대한 몇 가지 예를 찾을 수 있습니다. 환경이 복잡한 경우 필요에 따라 이러한 조건을 조정해야 할 수도 있습니다.</Callout>
