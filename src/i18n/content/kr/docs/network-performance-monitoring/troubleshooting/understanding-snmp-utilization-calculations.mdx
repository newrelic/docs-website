...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="SNMP 변환"
  >
    <DoNotTranslate>**Metric Name**</DoNotTranslate>: 다양한
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            16진수 값을 정수 형식으로 변환하는 데 사용됩니다. <DoNotTranslate>**current**</DoNotTranslate> 에 대한 옵션: `LittleEndian` \| `BigEndian`. <DoNotTranslate>**desired**</DoNotTranslate> 에 대한 옵션: `uint16` \| `uint32` \| `uint64`
          </td>
        </tr>
