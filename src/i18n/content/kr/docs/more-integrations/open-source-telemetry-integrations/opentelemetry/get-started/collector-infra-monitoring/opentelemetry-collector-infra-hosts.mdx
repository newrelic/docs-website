...
* `$NEW_RELIC_OTLP_ENDPOINT` env var를 적절한 [엔드포인트](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-otlp) 로 설정합니다.
