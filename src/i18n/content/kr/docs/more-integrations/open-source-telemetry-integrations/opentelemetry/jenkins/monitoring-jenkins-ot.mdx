...
import opentelemetryJenkis01 from 'images/opentelemetry_screenshot-full_jenkis-01.png'
...
7. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM & Services > Services - OpenTelemetry > jenkins** 합니다.
