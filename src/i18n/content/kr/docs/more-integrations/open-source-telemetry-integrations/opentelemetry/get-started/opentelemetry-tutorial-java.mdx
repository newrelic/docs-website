...
2. 거기에서 오류가 있는 트레이스를 찾아 클릭하여 엽니다.
   ...
   <Callout variant="tip">OpenTelemetry Java 에이전트를 사용하면 뉴렐릭 APM Java 에이전트에서 볼 수 있는 것과 다른 결과가 나타날 수 있습니다. 이는 두 에이전트 유형이 다르게 오류를 처리하기 때문입니다. 자세한 내용은 [OpenTelemetry 및 뉴렐릭에서 오류를 처리하는 방법](https://newrelic.com/blog/how-to-relic/error-rate-opentelemetry-and-new-relic)을 참조하십시오.</Callout>
