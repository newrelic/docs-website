...
<Steps>
  ...
  <Step>
    ...
    * 뉴렐릭에 표시될 서비스 이름
    * [뉴웰릭 OTLP](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-otlp) 엔드포인트로 데이터를 전송하는 OpenTelemetry Protocol(OTLP) 내보내기 도구
  ...
  <Step>
    ...
    * <DoNotTranslate>**All entities -> Services - OpenTelemetry**</DoNotTranslate>
      ...
      에서 귀하의 엔터티를 찾습니다. 엔터티 이름은 앱의 `service.name` 리소스 속성 값으로 설정됩니다. 뉴렐릭 서비스 엔터티가 OpenTelemetry 리소스 속성에서 파생되는 방법에 대한 자세한 내용은 [서비스](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-best-practices-resources/#services)를 참조하십시오.
    ...
    * 자세한 내용은 [OpenTelemetry APM UI](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/apm-monitoring/opentelemetry-apm-ui)를 참조하십시오.
