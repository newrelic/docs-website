...
[측정항목 또는 범위를 사용하도록 선택](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/view-your-data/opentelemetry-find-entities/#metric-span-toggle)하여 **Transactions** \[거래] 보기를 강화할 수 있습니다.
