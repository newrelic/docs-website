...
코드 베이스 내에서 OTLP 감수성을 사용하는 경우 [해당 언어 SDK를](https://opentelemetry.io/docs/languages/o) 참조해야 합니다. 개별 지표 데이터 포인트 또는 리소스 속성 수준에 `newrelic_metric_type=cumulativeCount` 속성을 추가하는 방법이면 충분합니다.
