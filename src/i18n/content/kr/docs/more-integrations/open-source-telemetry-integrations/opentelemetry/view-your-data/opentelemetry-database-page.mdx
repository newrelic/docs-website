...
OpenTelemetry를 사용하면 [`SpanKind`](https://github.com/open-telemetry/opentelemetry-specification/blob/main/specification/trace/api.md#spankind) 및 `db.system` 속성의 존재에 의존하여 데이터베이스의 클라이언트 사용량을 나타내는 범위를 식별합니다.
