...
이제 [배포를 기록](/docs/change-tracking/change-tracking-introduction/#start-tracking) 하고 OpenTelemetry 서비스의 활동 피드에서 확인할 수 있습니다. 또한 **요약** 보기의 세 차트에서 변경 마커를 볼 수 있지만 New Relic APM은 트랜잭션 및 데이터베이스 차트에도 표시합니다.
