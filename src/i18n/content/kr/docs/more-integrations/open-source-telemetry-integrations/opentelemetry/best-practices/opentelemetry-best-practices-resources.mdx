...
자세한 내용은 [인프라 모니터링을 위한 수집기](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/collector-infra-monitoring/opentelemetry-collector-infra-intro/) 의 호스트 모니터링 예를 참조하세요.
...
자세한 내용은 [인프라 모니터링을 위한 수집기](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/collector-infra-monitoring/opentelemetry-collector-infra-intro/) 의 Redis 예제를 참조하세요.
