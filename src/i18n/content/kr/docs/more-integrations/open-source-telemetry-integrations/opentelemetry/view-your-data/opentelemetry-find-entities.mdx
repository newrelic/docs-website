...
import opentelemetryMetricSpanToggleSummary from 'images/opentelemetry_screenshot-crop_metric-span-toggle-summary.png'
...
[태그](https://docs.newrelic.com/docs/new-relic-solutions/new-relic-one/core-concepts/use-tags-help-organize-find-your-data/) 는 모니터링되는 앱 및 호스트와 같은 엔터티에 추가할 수 있는 키-값 쌍입니다. 계정 ID와 같은 특정 중요한 데이터 속성은 자동으로 태그로 할당됩니다. [사용자 정의 태그](https://docs.newrelic.com/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-best-practices-resources/tags) 를 추가할 수도 있습니다.
