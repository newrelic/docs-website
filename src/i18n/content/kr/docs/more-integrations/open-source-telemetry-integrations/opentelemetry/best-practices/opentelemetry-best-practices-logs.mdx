...
* `service.name` 속성으로 로그에 주석을 달도록 [리소스 프로세서](https://github.com/open-telemetry/opentelemetry-collector/tree/main/processor/resourceprocessor) 로 구성할 수 있는 전용 [Collector 에이전트](https://opentelemetry.io/docs/collector/getting-started/#agent) 인스턴스와 함께 애플리케이션을 배포할 수 있습니다.
