...
이 페이지에서는 OpenTelemetry 및 뉴렐릭에 대한 개요를 제공합니다. APM 및 관측 모니터링을 포함한 일반적인 통합 패턴을 보여주는 작업 코드 예제는 [뉴렐릭을 사용하여 OpenTelemetry 시작하기를](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/opentelemetry-get-started-intro/) 참조하세요. 뉴렐릭이 OpenTelemetry 데이터를 수신, 처리 및 수집하는 방법에 대한 자세한 내용은 [뉴렐릭의OpenTelemetry 데이터를](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-data-overview/) 참조하고, 특히 [뉴렐릭의 OTLP 엔드포인트](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-otlp/) 에 대한 세부정보를 참조하세요.
...
많은 경우, 기능과 OpenTelemetry 및 뉴렐릭에서 사용할 수 있는 구성 요소 간에 중복되는 부분이 있습니다. 예를 들어, [OpenTelemetry APM 모니터링은](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/apm-monitoring/opentelemetry-apm-intro/) [뉴렐릭 APM 에이전트를](/docs/apm/new-relic-apm/getting-started/introduction-apm/) 미러링하고, [OpenTelemetry 수집기를 사용한 모니터링은](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/collector-infra-monitoring/opentelemetry-collector-infra-intro/) [뉴렐릭 인프라 에이전트](/docs/infrastructure/infrastructure-monitoring/get-started/get-started-infrastructure-monitoring/) 의 기능을 미러링합니다.
