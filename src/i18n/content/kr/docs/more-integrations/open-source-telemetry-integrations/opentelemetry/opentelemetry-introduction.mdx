...
New Relic 및 OpenTelemetry 계측을 모두 탐색하는 것이 좋습니다. 이 섹션의 정보에는 고려해야 할 몇 가지 광범위한 개념이 있습니다. 차이점을 더 자세히 보려면 [자세한](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/opentelemetry-comparison) 비교를 참조하십시오. 또한 [CNCF Slack 채널인 #otel-newrelic](https://cloud-native.slack.com/archives/C024DRQ63UP) 에서 이에 대해 논의하여 가장 적합한 것이 무엇인지 결정할 수 있습니다. [여기에서 CNCF의 Slack 계정에 먼저 가입해야](https://slack.cncf.io/) 할 수도 있습니다.
