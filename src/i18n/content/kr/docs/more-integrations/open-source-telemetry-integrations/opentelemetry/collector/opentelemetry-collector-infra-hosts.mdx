...
* `$NEW_RELIC_OTLP_ENDPOINT` env var를 적절한 [엔드포인트](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/opentelemetry-set-up-your-app/#review-settings) 로 설정합니다.
...
작업 코드 예제는 [OpenTelemetry 수집 설정을 통한 호스트 모니터링을](https://github.com/newrelic/newrelic-opentelemetry-examples/tree/main/other-examples/collector/host-monitoring) 참조하세요.
