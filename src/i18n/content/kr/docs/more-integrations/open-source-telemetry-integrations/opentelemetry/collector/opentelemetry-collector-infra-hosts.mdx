...
수집기에서 호스트 수신기를 설정하는 경우 OpenTelemetry를 사용하여 인프라 호스트에 대한 메트릭을 수집할 수 있습니다. 수집기는 원격 측정 데이터를 수집, 처리 및 New Relic(또는 관측 가능성 백엔드)으로 내보내는 OpenTelemetry의 구성 요소입니다.
