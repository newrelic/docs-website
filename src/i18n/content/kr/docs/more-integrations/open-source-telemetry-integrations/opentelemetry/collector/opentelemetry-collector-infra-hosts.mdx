...
* 데이터를 보고하려는 New Relic 계정의 [라이선스 키를](/docs/apis/intro-apis/new-relic-api-keys/#license-key) 가져옵니다.
...
* OTLP_ENDPOINT_HERE를 적절한 [끝점](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/opentelemetry-setup#review-settings) 으로 바꾸십시오.
* YOUR_KEY_HERE를 [라이선스 키로](/docs/apis/intro-apis/new-relic-api-keys/#license-key)교체
