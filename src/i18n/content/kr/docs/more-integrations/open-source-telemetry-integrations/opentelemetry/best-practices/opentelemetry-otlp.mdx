...
* OTLP 버전을 검토하세요. 뉴켈릭은 [OTLP 릴리스 v0.18.0 을](https://github.com/open-telemetry/opentelemetry-proto/releases/tag/v0.18.0) 사용합니다. 이후 버전은 지원되지만 새로운 기능은 아직 구현되지 않았습니다. 0.18.0에서 더 이상 사용할 수 없는 실험적 기능은 지원되지 않습니다.
