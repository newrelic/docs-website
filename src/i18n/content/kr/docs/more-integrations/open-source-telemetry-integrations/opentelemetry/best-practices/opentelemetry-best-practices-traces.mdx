...
<CollapserGroup>
  ...
  >
    OpenTelemetry 수집기에는 [꼬리 기반 샘플링 프로세서](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/main/processor/tailsamplingprocessor) 가 있습니다. 꼬리 기반 샘플링 프로세서의 사용을 보여주는 [예가](https://github.com/newrelic/newrelic-opentelemetry-examples/tree/main/collector/k8s-collector-tail-sampling) 있습니다.
  </Collapser>

  <Collapser
    className="freq-link"
    id="infinite-tracing"
    title="Infinite Tracing을 통한 새로운 Relic 꼬리 기반 샘플링"
  >
