...
* gaDate에서 eolDate까지:
  ...
  * 더 이상 사용되지 않는 `gauge` 유형 수집을 사용하는 계정은 `cumulativeCount` 유형 수집을 선택할 수 있습니다.
...
gaDate 이전에 누적 단조 합계를 수집한 경우 이 180일 기간은 영향을 받은 지표를 활용하는 쿼리 및 <InlinePopover type="alerts"/>업데이트할 시간을 제공합니다.
