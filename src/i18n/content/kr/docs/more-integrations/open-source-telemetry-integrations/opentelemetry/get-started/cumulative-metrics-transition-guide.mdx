...
아래에서는 알림이 일반적으로 차트보다 더 중요하기 때문에 [알림 조건](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/nrql-alert-conditions)업데이트에 중점을 둡니다. 사용자 지정 차트의 경우 다음 중 하나를 수행할 수 있습니다.
