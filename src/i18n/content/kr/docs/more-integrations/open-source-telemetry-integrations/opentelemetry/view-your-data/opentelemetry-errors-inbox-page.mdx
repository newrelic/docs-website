...
Detect, triage, and take actions on errors with [errors inbox](https://docs.newrelic.com/docs/errors-inbox/errors-inbox/).
...
Errors inbox can be accessed at the [scoped level](https://docswebsitedevelop-meda123docswebsitepatch13.gtsb.io/docs/errors-inbox/errors-inbox/#scoped) through a specific entity or at the global level via the top navigation link labeled ‘Errors inbox.’ The global experience requires a [workload](https://docs.newrelic.com/docs/new-relic-solutions/new-relic-one/workloads/use-workloads/) to be set up.
...
Troubleshooting: In the event your inbox is too noisy, check out [these tips](https://docs.newrelic.com/docs/errors-inbox/errors-inbox/#similar-events). If on the other hand, you’re not seeing errors data in Errors inbox, check out the [requirements](https://docs.newrelic.com/docs/errors-inbox/errors-inbox#requirements) to get started.
