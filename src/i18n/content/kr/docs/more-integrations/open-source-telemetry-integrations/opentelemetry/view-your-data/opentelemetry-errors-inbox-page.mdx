...
오류 받은 편지함은 특정 엔터티를 통해 [범위가 지정된 수준](/docs/errors-inbox/errors-inbox/#scoped) 에서 액세스하거나 '오류 받은 편지함'이라고 표시된 상단 탐색 링크를 통해 전역 수준에서 액세스할 수 있습니다. 글로벌 경험을 위해서는 [워크로드](/docs/new-relic-solutions/new-relic-one/workloads/use-workloads/) 를 설정해야 합니다.
