...
* 이것은 또한 OpenTelemetry 수집기를 로드 테스트할 수 있는 기회를 제공하고 프로덕션과 같은 로드를 충분히 처리할 수 있는지 확인합니다. 수집기 크기 조정에 대한 팁은 [OpenTelemetry 문서를](https://opentelemetry.io/docs/collector/scaling)참조하십시오.
