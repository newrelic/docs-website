...
집계 시간성을 구성하는 방법을 이해하려면 [Java](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/opentelemetry-tutorial-java) 및 [Go](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/opentelemetry-tutorial-go) OpenTelemetry SDK를 사용하는 다음 예제를 참조하세요.
