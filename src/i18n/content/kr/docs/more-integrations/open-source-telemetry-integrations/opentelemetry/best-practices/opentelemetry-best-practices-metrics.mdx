...
* 단순 누적 합계 매핑은 다음에 따라 달라집니다.
  ...
  * [cumulativeCount](/telemetry-data-platform/understand-data/metric-data/metric-data-type/#metric-types) 지표 유형에 대한 액세스 권한이 있는 경우 이것이 사용됩니다. 변환 프로세스에 대한 자세한 내용은 [누적 메트릭](/docs/data-apis/understand-data/metric-data/cumulative-metrics) 을 참조하십시오.
