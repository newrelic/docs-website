...
<Callout variant="important">
  ...
  [](https://github.com/open-telemetry/opentelemetry-collector-contrib/pull/22839)[OpenTelemetry Collector Contrib 리포지토리](https://github.com/open-telemetry/opentelemetry-collector-contrib) 의 PR22839가 병합되면 아래 설명서가 업데이트되어 Contrib 리포지토리의 기본 분기를 반영합니다.
</Callout>

최신 설치 지침은 [https://github.com/4demos/opentelemetry-collector-contrib.git](https://github.com/4demos/opentelemetry-collector-contrib) 을 참조하십시오.
