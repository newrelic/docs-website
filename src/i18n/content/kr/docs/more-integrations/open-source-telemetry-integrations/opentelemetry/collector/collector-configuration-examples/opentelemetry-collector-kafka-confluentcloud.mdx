...
* [클라우드 API 키](https://docs.confluent.io/cloud/current/access-management/authenticate/api-keys/api-keys.html#cloud-cloud-api-keys)
...
다음 지표를 사용하는 이 New Relic [예제 대시보드](./dashboard.json) 를 확인하십시오.
