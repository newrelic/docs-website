...
New Relic에 데이터를 전송하도록 Jenkins OpenTelemetry 플러그인을 구성하려면 New Relic [OTLP 엔드포인트](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/opentelemetry-setup/#note-endpoints) 와 [라이선스 키가](/docs/apis/intro-apis/new-relic-api-keys/#license-key) 필요합니다.
