...
New Relic에 데이터를 보내도록 Jenkins OpenTelemetry 플러그인을 구성하려면 New Relic [OTLP 엔드포인트](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/opentelemetry-setup/#note-endpoints) 와 <LicenseKey/> 가 필요합니다.
