...
<Steps>
  <Step>
    ...
    다음으로, <DoNotTranslate>**main.tf**</DoNotTranslate> 에서 `terraform` 및 `required_providers` 블록을 설정하여 Terraform에 뉴렐릭 공급자를 설치하고 사용하도록 지시합니다.
  ...
  <Step>
    ...
    <DoNotTranslate>**main.tf**</DoNotTranslate> 에서 공급자에 해당 값을 설정합니다.
  ...
  <Step>
    ...
    [뉴렐릭에 로그인](https://login.newrelic.com/login) 하고 [<DoNotTranslate>**Alert Policies**</DoNotTranslate>으로 이동하여](/docs/alerts-applied-intelligence/new-relic-alerts/alert-policies/create-edit-or-find-alert-policy#alert-policy-view) Terraform이 새 정책을 생성했는지 확인하세요.
