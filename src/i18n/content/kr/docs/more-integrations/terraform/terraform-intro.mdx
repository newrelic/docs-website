...
<Steps>
  ...
  <Step>
    ...
    3. 당신의 [New Region 지역](/docs/using-new-relic/welcome-new-relic/get-started/our-eu-us-region-data-centers#verifying-account) . 계정 설정 페이지가 one.newrelic.com 에 있는 경우 지역은 `US` 이고 계정이 one.eu.newrelic.com 에 있는 경우 `EU` }입니다.
