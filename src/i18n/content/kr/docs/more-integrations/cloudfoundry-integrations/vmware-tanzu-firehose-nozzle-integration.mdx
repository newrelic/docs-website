...
노즐은 Ops Manager에서 타일로 설치하거나 CLI 명령 cf push를 사용하여 일반 애플리케이션으로 배포할 수 있습니다. 그런 다음 VMware Tanzu 배포의 상태와 성능을 모니터링하고 설정할 수 있습니다. <InlinePopover type="alerts"/>VMware Tanzu Firehose에서 수집된 지표를 기반으로 합니다.
