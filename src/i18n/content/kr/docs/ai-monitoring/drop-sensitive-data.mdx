...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com) > All capabilities > AI monitoring > Drop filters**</DoNotTranslate> 에서: 삭제 필터를 만들려면 민감한 데이터가 포함될 수 있는 이벤트를 선택한 다음 삭제하려는 데이터 유형에 해당하는 정규식을 선택하세요.
</figcaption>
