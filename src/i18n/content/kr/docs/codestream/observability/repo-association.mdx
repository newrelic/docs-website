...
<CollapserGroup>
  ...
  >
    **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & Services > (앱 선택)을** 통해 APM 요약 페이지로 이동한 다음 페이지 오른쪽 하단에서 **Repositories** \[리포지토리] 섹션을 찾으세요.
