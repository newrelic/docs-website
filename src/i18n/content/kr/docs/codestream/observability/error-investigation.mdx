...
CodeStream은 귀하에게 할당된 오류뿐만 아니라 IDE에서 열린 코드에서 발생한 가장 최근 오류 5개도 보여줍니다. 이 섹션 제목에 있는 드롭다운 목록을 통해 기간을 제어할 수 있습니다. 이 목록은 New Relic의 [오류 받은 편지함](/docs/errors-inbox/errors-inbox/) 에 표시되는 오류의 하위 집합일 수 있습니다.
