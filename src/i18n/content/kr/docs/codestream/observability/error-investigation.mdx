...
[논스 인박스(errors inbox)](/docs/errors-inbox/errors-inbox/) 의 오류에서 직접 이와 동일한 오류 경험을 할 수 있습니다 New Relic. 스택 추적으로 오류를 볼 때 <DoNotTranslate>**Open in IDE**</DoNotTranslate> 클릭하여 IDE의 코드로 직접 이동하세요.
