...
* <DNT>**Node.js:**</DNT> 코드베이스에 익명 함수가 포함된 경우 [추적 변경을](/docs/change-tracking/change-tracking-introduction/) 사용하여 형상, 배포 정보를 뉴렐릭으로 보내거나 빌드 파이프라인의 [환경 변수를 사용하여 빌드 SHA를](/docs/codestream/observability/error-investigation/#buildsha) 보낼 수 있습니다.
