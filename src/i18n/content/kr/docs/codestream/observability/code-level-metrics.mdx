...
* <DoNotTranslate>**.NET:**</DoNotTranslate>
  ...
  <DoNotTranslate>**Tools > Options > Text Editor > All Languages > CodeLens**</DoNotTranslate>
...
IDE 설정의 CodeStream 섹션으로 이동하고 <DoNotTranslate>**CodeStream: Show Golden Signals In Editor**</DoNotTranslate> 설정을 선택 취소하여 CodeLense를 끌 수 있습니다.