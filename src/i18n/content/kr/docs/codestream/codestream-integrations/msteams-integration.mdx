...
import codestreamMsteamsCodestreamBotWelcome from 'images/codestream_screenshot-crop_msteams-welcome.png'
...
2. 설치되면 CodeStream 앱에 대한 다음 팝업이 표시되고 **Add** 버튼을 클릭합니다. 확장하지 말고 옵션을 선택하여 팀 또는 채팅에 추가하십시오. 추가를 클릭하기만 하면 됩니다.

   <img title="Add" alt="A screenshot showing the Add button." src={codestreamMsteamsCodestreamAppPage}/>

3. 이렇게 하면 CodeStream 봇과의 비공개 채팅으로 이동하고 Teams 사이드바에 CodeStream 로고가 표시됩니다. 봇의 환영 메시지에서 **Sign In **버튼을 클릭하거나 이 채팅에 `signin` 를 입력하고 제출합니다.
...
7. 공유할 채널로 이동하여 `@` 를 입력한 다음 팝업에서 **Get bots **을 선택합니다.
