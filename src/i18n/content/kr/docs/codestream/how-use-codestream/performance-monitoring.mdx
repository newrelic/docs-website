...
* **Java:** Java 에이전트 버전 7.10 이상이 필요합니다. 코드 수준 메트릭은 [Java 에이전트 구성에서 활성화](/docs/apm/agents/java-agent/features/java-codestream-integration/) 되어야 합니다. VS Code를 사용하는 경우 [Red Hat 확장에 의한 Java용 언어 지원](https://marketplace.visualstudio.com/items?itemName=redhat.java) 도 설치되어 있어야 합니다.
