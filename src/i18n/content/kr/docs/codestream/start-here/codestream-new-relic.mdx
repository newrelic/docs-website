...
* [New Relic 계정](https://newrelic.com/signup) (New Relic 계정이 없으면 [newrelic.com/signup](https://newrelic.com/signup) 에서 가입하십시오. 영원히 무료입니다!)
* [새로운 유물 사용자 키](https://one.newrelic.com/launcher/api-keys-ui.api-keys-launcher)
...
<CollapserGroup>
  ...
  >
    환경 변수 `NEW_RELIC_METADATA_REPOSITORY_URL` 를 설정합니다. 새로운 Relic APM 에이전트는 리포지토리 엔터티를 생성하고 이를 애플리케이션 엔터티에 자동으로 연결합니다.
...
* [새로운 유물 계정](https://newrelic.com/signup)
...
* [새로운 유물 사용자 API 키](https://one.newrelic.com/launcher/api-keys-ui.api-keys-launcher)
