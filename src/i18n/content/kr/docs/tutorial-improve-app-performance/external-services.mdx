...
<Steps>
  ...
  <Step>
    ...
    6. 드릴다운에서 분산 추적을 보려는 지점에 도달하면 오른쪽 위에서 **List** \[목록을] 클릭한 다음 테이블에서 **Traces** \[추적을] 클릭합니다.<img title="Screenshot showing the trace link in the table view" alt="Screenshot showing the trace link in the table view" src={apmExternalServicesLinkTable}/>
