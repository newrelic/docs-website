...
<Steps>
  ...
  <Step>
    ...
    4. 특정 트랜잭션에 가장 많은 시간이 소요된다고 판단되면 해당 트랜잭션을 클릭하여 종속성을 구체적으로 살펴보세요.<img
    ...
    6. 드릴다운에서 분산 추적을 보려는 지점에 도달하면 오른쪽 위에서 **List** \[목록을] 클릭한 다음 테이블에서 **Traces** \[추적을] 클릭합니다.<img
