...
대시보드를 설치한 후 <DoNotTranslate>**Lookout**</DoNotTranslate> 보기를 사용하여 수집 패턴을 대략적으로 확인할 수 있습니다. 거기에서 NRQL 쿼리를 생성하여 모든 수집을 이상적으로 검색할 수 있습니다. 예를 들어, 다음 NRQL 쿼리는 지난 24시간 동안 `usageMetric` 이(가) 이상적으로 수행한 모든 수집에 대한 정보를 제공합니다.
...
2. <DoNotTranslate>**Install this quickstart**</DoNotTranslate> 선택합니다.
...
4. <DoNotTranslate>**Done**</DoNotTranslate> 선택합니다.

5. 퀵스타트 설치가 완료되면 <DoNotTranslate>**Data governance entity breakdowns**</DoNotTranslate> 대시보드를 열어 데이터에 액세스하세요.
