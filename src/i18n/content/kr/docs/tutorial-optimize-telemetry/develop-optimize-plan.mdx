...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="예 2: 고객 경험에 중점"
  >
    다음에 중점을 두고 새로운 사용자 대면 플랫폼을 담당하는 팀 <InlinePopover type="mobile"/>브라우저 모니터링은 예산을 50% 초과하여 실행되고 있습니다. 수집 크기를 적절하게 조정해야 하지만 **Customer experience** \[고객 경험] 관찰 가능성을 희생하지 않는다는 점에 대해 단호합니다.
