...
이것이 <DoNotTranslate>**Data ingest governance**</DoNotTranslate> 또는 귀하의 조직이 수집한 텔레메트리 데이터에 대한 최적의 가치를 보장하는 방식이 필요한 곳입니다. 우리 가이드는 조직 내에서 이 개념을 사용하기 위한 모범 사례를 준비하고 수행하는 데 도움이 될 것입니다. 이 튜토리얼 시리즈를 완료하면 다음을 수행할 수 있습니다.
...
<DoNotTranslate>**data ingest governance**</DoNotTranslate> 사용하여 최적화할 수 있도록 데이터가 뉴렐릭으로 관리되는지 확인해야 합니다. 자세한 정보가 필요하면 [데이터 관리 문서를](/docs/data-apis/manage-data/manage-your-data/) 참조하세요.
