...
<Steps>
  <Step>
    ...
    기준선을 만들고 수집 데이터를 모니터링하는 데 사용하는 대시보드입니다. <DoNotTranslate>**Overview**</DoNotTranslate> 탭은 수집을 감시하는 데 도움이 되는 다양한 차트를 제공하며, 브라우저, APM 데이터, 로그 및 트레이스와 같은 특정 텔레메트리 유형에 대한 자세한 보기를 제공하는 여러 탭이 있습니다.

    보고서를 생성하려면 텔레메트리 최적화를 시작해야 합니다. 아래 단계에 따라 대시보드를 설치한 후 <DoNotTranslate>**Baseline Reports**</DoNotTranslate> 탭을 사용해야 합니다.
    ...
    4. <DoNotTranslate>**Done**</DoNotTranslate>
  ...
  <Step>
    ...
    * 특정 하위 계정 또는 사업부에 대한 대상입니다.
    ...
    2. <DoNotTranslate>**Add a chart**</DoNotTranslate>

       선택합니다.

    3. 차트에서 사용할 NRQL 쿼리를 입력합니다.

    4. <DoNotTranslate>**Run**</DoNotTranslate>
  ...
  <Step>
    ...
    기준 대시보드를 설치하고 필요에 맞게 보고하는 데이터를 변경한 후에는 적절한 양의 데이터를 수집할 수 있을 만큼 충분한 시간이 지난 후 수집 데이터에 대한 표 형식 보고서를 생성할 수 있습니다. <DoNotTranslate>**Baseline report**</DoNotTranslate> 부터 이 작업을 수행할 수 있으며 가장 일반적인 기간은 30일입니다. 보고서를 생성하려면:
    ...
    3. <DoNotTranslate>**Last 30 days**</DoNotTranslate>
