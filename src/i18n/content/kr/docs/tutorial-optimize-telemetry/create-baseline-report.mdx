...
<Steps>
  <Step>
    ...
    2. 브라우저 창의 오른쪽 상단에 있는 <DNT>**Install this quickstart**</DNT> 을 클릭합니다.
    3. 해당하는 경우 계정 전환기에서 기본 또는 최상위 계정을 선택합니다.
    4. <DNT>**Done**</DNT> 을(를) 클릭합니다.
    5. 퀵스타트 설치가 완료되면 <DNT>**Data ingest governance baseline**</DNT> 대시보드를 엽니다.
  </Step>
  ...
  <Step>
    ...
    * 특정 하위 계정 또는 사업부에 대한 대상입니다.
    ...
    1. 기준 대시보드에서 <DNT>**+ Add widget**</DNT> 선택합니다.
    2. <DNT>**Add a chart**</DNT> 선택합니다.
    ...
    1. 기준 대시보드에서 수정하려는 차트에 대해 <DNT>**...**</DNT> 선택합니다.
    2. <DNT>**Edit**</DNT> 선택합니다.
  ...
  <Step>
    ...
    2. <DNT>**Baseline report**</DNT> 탭을 선택합니다.
    3. <DNT>**Last 30 days**</DNT> 테이블에서 <DNT>**...**</DNT> 선택하고 <DNT>**Export as CSV**</DNT> 선택합니다.
