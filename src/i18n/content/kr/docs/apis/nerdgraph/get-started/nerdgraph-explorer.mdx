...
<Steps>
  <Step>
    ...
    1. <DoNotTranslate>[one.newrelic.com > All capabilities > Apps > NerdGraph API explorer](https://one.newrelic.com/nerdgraph-graphiql)</DoNotTranslate> 으)로 이동합니다.
  ...
  <Step>
    ...
    빨간색 <DoNotTranslate>**Execute query**</DoNotTranslate> 버튼을 클릭하세요. 결과는 요청과 거의 동일한 형태입니다. 쿼리 빌더의 모든 필드는 사용 가능한 모든 데이터 유형과 해당 속성을 설명하는 GraphQL 스키마를 구성합니다. 각 필드에 대해 자세히 알아보려면 필드 옆에 있는 돋보기 아이콘을 클릭하세요.
  ...
  <Step>
    ...
    1. <DoNotTranslate>**Tools**</DoNotTranslate>
