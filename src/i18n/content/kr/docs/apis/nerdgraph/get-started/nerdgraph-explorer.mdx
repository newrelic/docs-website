...
<Steps>
  <Step>
    ...
    1. NerdGraph API 탐색기를 엽니다. URL은 계정을 호스팅하는 데이터센터 지역에 따라 다릅니다:

       * 미국(기본 지역): <DNT>[one.newrelic.com/nerdgraph-graphiql](https://one.newrelic.com/nerdgraph-graphiql)</DNT>
       * 유럽 연합: <DNT>[one.eu.newrelic.com/nerdgraph-graphiql](https://one.eu.newrelic.com/nerdgraph-graphiql)</DNT>
