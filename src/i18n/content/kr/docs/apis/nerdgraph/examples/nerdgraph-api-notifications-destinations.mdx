...
<CollapserGroup>
  ...
  <Collapser className="freq-link" id="microsoft-teams" title="마이크로소프트 팀">
    ...
    Microsoft Teams에 연결되는 뉴렐릭 대상을 만들기 전에 Microsoft Teams 작업 영역에 [Microsoft Teams용 뉴렐릭 앱을 설치](/docs/alerts/get-notified/microsoft-teams-integrations/#add-new-relic-for-microsoft-team) 해야 합니다. 설치가 완료되면 이 변형에 필요한 보안 코드를 받게 됩니다.
    ...
    <Callout variant="important">
      뉴렐릭 대상을 만든 후 응답에서 `destinationId` 을 가져옵니다. 공지채널을 구성하기 위해 필요한 ID입니다. 전체 활동 내용은 [Microsoft Teams 채널 설정 섹션을](/docs/apis/nerdgraph/examples/nerdgraph-api-notifications-channels/#microsoft-teams) 참조하세요.
    </Callout>
  </Collapser>
