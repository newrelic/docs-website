...
<Callout variant="important">
  서비스 수준을 생성하려면 API 키에 [측정항목 규칙](/docs/data-apis/convert-to-metrics/analyze-monitor-data-trends-metrics/) 을 수정 및 삭제할 수 [있는 권한이 있는 역할이](/docs/accounts/original-accounts-billing/original-users-roles/users-roles-original-user-model) 필요합니다.
</Callout>
