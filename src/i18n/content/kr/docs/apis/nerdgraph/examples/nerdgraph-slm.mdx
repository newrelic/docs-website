...
* <DNT>**`entityGuid`**</DNT>: 이 SLI를 연결하려는 [엔티티](/docs/service-level-management/create-slm#sli-entity) (예: <InlinePopover type="apm" />서비스, 브라우저 애플리케이션 등)의 GUID입니다. UI의 엔티티 페이지 <DNT>**See metadata and manage tags**</DNT> 아래에서 이 GUID를 찾을 수 있습니다.
