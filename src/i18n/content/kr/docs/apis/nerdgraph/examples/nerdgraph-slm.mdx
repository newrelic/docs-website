...
[SLI와 SLO 구성의 기본 개념(예: SLI가 연결된 엔터티)을 알아보려면 SLI 및 SLO 만들기 및 편집을](/docs/service-level-management/create-slm#sli-entity) 참조하세요. 또한 해당 문서를 참조하여 가장 일반적인 지표의 예를 찾을 수 있습니다. <InlinePopover type="apm"/>서비스와 <InlinePopover type="browser"/>응용 프로그램.
