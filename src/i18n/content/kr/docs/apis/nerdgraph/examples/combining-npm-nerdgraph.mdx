...
<Steps>
  ...
  <Step>
    ...
    [api.newrelic.com/graphiql](https://api.newrelic.com/graphiql) 에서 NerdGraph 탐색기를 엽니다. 그리고 아래 쿼리를 사용하여 브라우저 애플리케이션의 구성 값을 가져옵니다. 뉴렐릭 계정에서 [EU 데이터센터](/docs/using-new-relic/welcome-new-relic/get-started/our-eu-us-region-data-centers)를 사용하는 경우 [api.eu.newrelic.com/graphiql](https://api.eu.newrelic.com/graphiql)로 이동합니다. [JP 데이터센터](/docs/accounts/accounts-billing/account-setup/choose-your-data-center) 계정의 경우 [api.jp.newrelic.com/graphiql](https://api.jp.newrelic.com/graphiql)로 이동합니다.
