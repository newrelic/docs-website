...
1. [Teams에 필요한 권한 ID 찾기](#retrieve-organization-scoped-capabilities)
2. [귀하의 조직 ID를 검색하세요](#retrieve-your-organization-id)
3. [Teams 관리자를 위한 사용자 지정 역할 만들기](#create-custom-role)
...
<CollapserGroup>
  <Collapser id="retrieve-organization-scoped-capabilities" title="Teams에 필요한 권한 ID 찾기">
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            첫 번째 단계에서 식별된 Teams 기능에 대한 권한 ID입니다.
          </td>
        </tr>
