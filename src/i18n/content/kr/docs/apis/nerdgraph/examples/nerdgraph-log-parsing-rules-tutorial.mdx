...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        이 구문 분석 규칙에 대한 [Grok](https://grokdebug.herokuapp.com/patterns#) 패턴입니다. 예를 들어 `logtype = 'alb'` 과 같은 [기본 제공 구문 분석 규칙](/docs/logs/log-management/ui-data/built-log-parsing-rulesets/) 과 함께 사용 중인 Grok 패턴에 대해 `logtype` 를 포함할 수 있습니다. 그러나 `logtype` 사용으로 제한되지 않습니다. 모든 속성을 일치 기준으로 사용할 수 있습니다.
      </td>
    </tr>
