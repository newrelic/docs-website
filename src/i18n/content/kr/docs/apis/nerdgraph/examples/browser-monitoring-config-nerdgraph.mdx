...
[애플리케이션에 복사/붙여넣기할](/docs/browser/browser-monitoring/installation/install-browser-monitoring-agent/#copy-paste) 자바스크립트 스니펫을 검색할 수 있습니다. 반환된 스니펫은 복사/붙여넣기 전에 구문 분석해야 하는 JSON 인코딩 문자열입니다.
