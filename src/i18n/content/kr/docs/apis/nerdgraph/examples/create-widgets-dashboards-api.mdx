---
title: 'NerdGraph 튜토리얼: 대시보드 위젯 만들기 및 구성'
tags:
  - APIs
  - NerdGraph
  - Examples
...
<CollapserGroup>
  <Collapser id="widget-typed" title="입력된 위젯">
  ...
  <Collapser id="widget-untyped" title="유형이 지정되지 않은 위젯">
...
<CollapserGroup>
  <Collapser id="area-input" title="입력">
    ```graphql
    {
      widgets: {
        configuration: {
  ...
  <Collapser id="area-output" title="산출">
    ```json
    {
...
<CollapserGroup>
  <Collapser id="bar-input" title="입력">
    ```graphql
    {  
      widgets: {
        configuration: {
  ...
  <Collapser id="bar-output" title="산출">
    ```json
    {
...
<CollapserGroup>
  <Collapser id="billboard-input" title="입력">
    ```graphql
    {  
      widgets: {
        configuration: {
  ...
  <Collapser id="billboard-output" title="산출">
    ```json
    {
...
<CollapserGroup>
  <Collapser id="line-input" title="입력">
    ```graphql
    {
      widgets: {
        configuration: {
  ...
  <Collapser id="line-output" title="산출">
    ```json
    {
...
<CollapserGroup>
  <Collapser id="markdown-input" title="입력">
    ```graphql
    {
      widgets: {
        configuration: {
  ...
  <Collapser id="markdown-output" title="산출">
    ```json
    {
...
<CollapserGroup>
  <Collapser id="pie-input" title="입력">
    ```graphql
    {
      widgets: {
        configuration: {
  ...
  <Collapser id="pie-output" title="산출">
    ```json
    {
...
<CollapserGroup>
  <Collapser id="table-input" title="입력">
    ```graphql
    {
      widgets: {
        configuration: {
  ...
  <Collapser id="table-output" title="산출">
    ```json
    {
...
<CollapserGroup>
  <Collapser id="linep-input" title="입력">
    ```graphql
    {
      widgets: {
        visualization: "viz.area"
  ...
  <Collapser id="linep-output" title="산출">
    ```json
    {
      "visualization": "viz.area",
      "configuration": null,
...
<CollapserGroup>
  <Collapser id="bullet-input" title="입력">
    ```graphql
    {
      widgets: {
  ...
  <Collapser id="bullet-output" title="산출">
    ```json
    {
      "visualization": "viz.bullet",
      "configuration": null,
...
<CollapserGroup>
  <Collapser id="event-feed-input" title="입력">
    ```graphql
    {
      widgets: {
  ...
  <Collapser id="event-feed-output" title="산출">
    ```json
    {
      "visualization": "viz.event-feed",
      "configuration": null,
...
<CollapserGroup>
  <Collapser id="funnel-input" title="입력">
    ```graphql
    {
      widgets: {
  ...
  <Collapser id="funnel-output" title="산출">
    ```json
    {
      "visualization": "viz.funnel",
      "configuration": null,
...
<CollapserGroup>
  <Collapser id="heatmap-input" title="입력">
    ```graphql
    {
      widgets: {
  ...
  <Collapser id="heatmap-output" title="산출">
    ```json
    {
      "visualization": "viz.heatmap",
      "configuration": null,
...
<CollapserGroup>
  <Collapser id="histogram-input" title="입력">
    ```graphql
    {
      widgets: {
  ...
  <Collapser id="histogram-output" title="산출">
    ```json
    {
      "visualization": "viz.histogram",
      "configuration": null,
...
<CollapserGroup>
  <Collapser id="inventory-input" title="입력">
    ```graphql
    {
      widgets: {
  ...
  <Collapser id="inventory-output" title="산출">
    ```json
    {
      "visualization": "infra.inventory",
      "configuration": null,
...
<CollapserGroup>
  <Collapser id="json-input" title="입력">
    ```graphql
    {
      widgets: {
  ...
  <Collapser id="json-output" title="산출">
    ```json
    {
      "visualization": "viz.json",
      "configuration": null,
...
<CollapserGroup>
  <Collapser id="linem-input" title="입력">
    ```graphql
    {
      widgets: {
        visualization: "viz.line"
  ...
  <Collapser id="linem-output" title="산출">
    ```json
    {
      "visualization": "viz.line",
      "configuration": null,
...
<CollapserGroup>
  <Collapser id="service-map-input" title="입력">
    ```graphql
    {
      widgets: {
  ...
  <Collapser id="service-map-output" title="산출">
    ```json
    {
      "visualization": "topology.service-map",
      "configuration": null,
