...
<CollapserGroup>
  ...
  <Collapser id="mapping-mobile" title="이동하는">
  ...
  <Collapser id="mapping-insights" title="인사이트">
  ...
  <Collapser id="mapping-browser" title="브라우저">
  ...
  <Collapser id="mapping-syntehtics" title="합성품">
  ...
  <Collapser id="mapping-infrastructure" title="하부 구조">
  ...
  <Collapser id="mapping-lambda" title="Lambda용 서버리스">
    <table>
      <thead>
        <tr>
          <th style={{ width: "200px" }}>
  ...
  <Collapser id="mapping-traces" title="트레이스">
    <table>
      <thead>
        <tr>
          <th style={{ width: "200px" }}>
  ...
  <Collapser id="mapping-logs" title="로그">
    <table>
      <thead>
        <tr>
          <th style={{ width: "200px" }}>
  ...
  <Collapser id="mapping-metrics" title="메트릭">
    <table>
      <thead>
        <tr>
          <th style={{ width: "200px" }}>
...
<CollapserGroup>
  <Collapser id="type-subscription" title="신청">
    <table>
      <thead>
        <tr>
          <th style={{ width: "200px" }}>
  ...
  <Collapser id="type-product" title="제품">
    <table>
      <thead>
        <tr>
          <th style={{ width: "200px" }}>
  ...
  <Collapser id="type-unit-measure" title="측정 단위">
    <table>
      <thead>
        <tr>
          <th style={{ width: "200px" }}>
...
<CollapserGroup>
  <Collapser id="example-replace" title="많은 제품으로 구독 생성(기존 대체)">
    ```
    mutation {
      organizationProvisioningUpdatePartnerSubscription (
        accountId: PARTNER_ACCOUNT_ID,
  ...
  <Collapser id="example-replace-logs" title="하나의 제품으로 구독 생성(기존 교체) - 로그">
    ```
    mutation {
        organizationProvisioningUpdatePartnerSubscription (
          accountId: :PARTNER_ACCOUNT_ID,
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        NerdGraph에 `curl` 요청을 하려면 형식이 Partnership API와 다릅니다.
