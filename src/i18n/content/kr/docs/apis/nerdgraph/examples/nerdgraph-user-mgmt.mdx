...
New Relic의 [NerdGraph API](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph) 를 사용하여 사용자 그룹과 해당 그룹이 액세스할 수 있는 항목을 보고 관리할 수 있습니다. UI에서 이 작업을 수행하는 방법은 [사용자 관리 UI 문서](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-ui-and-tasks) 를 참조하세요.

## 요구 사항 [#requirements]

NerdGraph를 통해 사용자 및 그룹을 관리하기 위한 몇 가지 요구 사항:

* [Pro 또는 Enterprise 에디션](https://newrelic.com/pricing) 이 필요합니다(Standard 에디션 조직은 그룹 또는 역할을 구성할 수 없음).
