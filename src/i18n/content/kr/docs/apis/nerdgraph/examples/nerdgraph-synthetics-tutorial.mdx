...
[NerdGraph API를](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph/) 사용하면 [합성 모니터](/docs/synthetics/synthetic-monitoring/using-monitors/add-edit-monitors/)(비공개 위치) 생성, 업데이트 또는 삭제를 자동화할 수 있습니다.\[/docs/synthetics/synthetic-monitoring/private-locations/private-locations-overview-monitor-internal-sites-add-new -locations/], (보안 자격 증명)\[/docs/synthetics/synthetic-monitoring/using-monitors/store-secure-credentials-scripted-browsers-api-tests/] 및 (다운타임 모니터링)\[/docs/synthetics/ 합성 모니터링/모니터 사용/모니터-중단 시간-비활성화-모니터링-예정된 유지 관리 시간/].
...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="매일 실행되는 모니터 가동 중지 시간 만들기"
  >
    ```
    mutation {
  ...
  <Collapser
    ...
    title="매주 실행되는 모니터 가동 중지 시간 만들기"
  >
    ```
    mutation {
  ...
  <Collapser
    ...
    title="매월 실행되는 모니터 가동 중지 시간 만들기"
  >
    ```
    mutation {
