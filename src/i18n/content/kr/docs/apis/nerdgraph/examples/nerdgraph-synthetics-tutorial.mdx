...
<CollapserGroup>
  ...
  >
    ...
    * `RUNTIME_TYPE`: 모니터에서 사용하는 런타임 유형입니다. &amp;quot;CHROME_BROWSER&amp;quot;는 유일하게 허용되는 값입니다.
...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="모니터 ID를 엔터티 GUID에 매핑하는 쿼리"
  >
  ...
  <Collapser
    ...
    title="모든 런타임 업그레이드 테스트 상태를 검색하는 쿼리"
  >
  ...
  <Collapser
    ...
    title="모니터 ID별로 런타임 업그레이드 테스트 상태를 검색하는 쿼리"
  >
