---
title: 'NerdGraph 튜토리얼: 이슈 및 인시던트 쿼리 API'
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        환경에 대해 알아보려면 [알림 개요를](/docs/alerts-applied-intelligence/applied-intelligence/incident-intelligence/get-started-incident-intelligence/) 참조하세요.
      </td>
    </tr>
...
<CollapserGroup>
  <Collapser id="list-issues" title="문제 나열">
  ...
  <Collapser id="cursor" title="커서 페이지 매김">
    페이지 매김을 통해 반환될 수 있는 최대 문제 수는 NRQL [`LIMIT` MAX](/docs.newrelic.com/docs/nrql/nrql-syntax-clauses-functions/#sel-limit) 에 의해 설정되며 이 한도를 초과하면 필터링이 필요합니다.
  ...
  <Collapser id="filter" title="문제 필터링">
  ...
  <Collapser id="find" title="ID로 문제 찾기">
...
<CollapserGroup>
  <Collapser id="list-issue-events" title="문제 이벤트 나열">
  ...
  <Collapser className="freq-link" id="filter-issues-events" title="문제 이벤트 필터링">
...
<CollapserGroup>
  <Collapser id="list incidents" title="인시던트 나열">
  ...
  <Collapser id="filter-incidents" title="인시던트 필터링">
    ### 커서 페이지 매김

    페이지 매김을 통해 반환될 수 있는 최대 인시던트 수는 NRQL [LIMIT MAX](/docs.newrelic.com/docs/nrql/nrql-syntax-clauses-functions/#sel-limit) 에 의해 설정되며, 이 한도를 초과하면 필터링이 필요합니다.
  ...
  <Collapser id="find-incidents-by-id" title="사건 ID로 사건 찾기">
...
<CollapserGroup>
  <Collapser id="list-incident-events" title="인시던트 이벤트 나열">
  ...
  <Collapser id="filter-incident-events" title="인시던트 이벤트 필터링">
    ### 커서 페이지 매김
...
<CollapserGroup>
  <Collapser className="freq-link" id="configbyenvironment" title="ConfigByEnvironment 쿼리">
    ### 요구
...
<CollapserGroup>
  <Collapser className="freq-link" id="ackissues" title="문제 확인 또는 확인 취소">
    ### 요구
...
<CollapserGroup>
  <Collapser className="freq-link" id="listallissues" title="예: 모든 문제 나열">
