...
<CollapserGroup>
  <Collapser id="list-all-policies" title="계정에 대한 모든 정책 나열">
    다음은 예입니다.
  ...
  <Collapser id="paginate" title="커서 페이지 매김으로 정책을 통해 페이지 매김">
  ...
  <Collapser id="list-policies-by-id" title="선택한 ID로 모든 정책 찾기">
  ...
  <Collapser id="find-policies-by-name" title="이름으로 모든 정책 찾기">
    ...
    이 예에서는 이름에 `DevOps` 포함된 정책을 찾으려고 합니다.
  ...
  <Collapser id="find-by-id" title="아이디로 정책 찾기">
