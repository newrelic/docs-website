...
* [데이터 플러스](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/data-ingest-billing#data-prices) 가 필요합니다.
* 데이터를 내보내려면 \*\* 기능이 있는 [핵심 또는 전체 플랫폼 사용자](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type) 여야 합니다.
