...
<CollapserGroup>
  ...
  >
    ...
    * <DoNotTranslate>**Built-in suggestions.**</DoNotTranslate> 각 [이벤트 유형](/docs/using-new-relic/welcome-new-relic/getting-started/glossary#event) 에는 고유한 권장 속성 세트가 제공됩니다. 뉴웰릭이 중요성과 인기를 위해 선택한 속성입니다.

    * <DoNotTranslate>**Usage-based suggestions.**</DoNotTranslate> 일부 속성 제안은 계정에서 자주 사용되는 쿼리를 기반으로 합니다. 이러한 제안에는 사용자 정의 속성이 포함될 수 있습니다.

    * <DoNotTranslate>**Role restriction.**</DoNotTranslate> [제한된 사용자는](/docs/accounts/accounts/roles-permissions/users-roles) 계정 관련 패싯 제안에 액세스할 수 없습니다.
