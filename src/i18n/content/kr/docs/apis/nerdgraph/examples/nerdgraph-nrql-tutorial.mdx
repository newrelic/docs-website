...
NerdGraph를 사용하여 만든 NRQL 쿼리에는 [NRQL 쿼리 제한](/docs/query-your-data/nrql-new-relic-query-language/get-started/rate-limits-nrql-queries) 이 적용됩니다.

## NerdGraph를 사용한 기본 NRQL 쿼리 [#basic-queries]

NerdGraph를 사용하여 기본 NRQL 쿼리를 만들려면:

1. api.newrelic.com/graphiql 에서 [NerdGraph](https://api.newrelic.com/graphiql) 탐색기로 이동합니다.
