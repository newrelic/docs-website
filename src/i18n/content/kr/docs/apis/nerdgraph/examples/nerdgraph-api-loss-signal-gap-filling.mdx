...
<Callout variant="tip">
  ...
  신호 손실, 간극 채움에 대한 설명과 이 기능에 대한 액세스를 요청하는 방법은 [이 Support Forum 게시물](https://support.newrelic.com/s/hubtopic/aAX8W0000008b5p/announcing-new-relic-one-streaming-alerts-for-nrql-conditions)을 참조하십시오.
</Callout>
