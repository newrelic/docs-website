...
<Callout variant="important">
  레이블용 API는 2022년 6월 30일(2022년 3월 31일에서 연장됨)부로 수명이 종료되었습니다. 보다 자세한 내용은 [태그](/docs/new-relic-one/use-new-relic-one/core-concepts/tagging-use-tags-organize-group-what-you-monitor)에 대한 문서와 EOL에 대한 [지원 포럼 게시물](https://support.newrelic.com/s/hubtopic/aAX8W0000008cts/important-upcoming-changes-to-capabilities-and-support-across-errors-classic)을 참조하십시오.
</Callout>
