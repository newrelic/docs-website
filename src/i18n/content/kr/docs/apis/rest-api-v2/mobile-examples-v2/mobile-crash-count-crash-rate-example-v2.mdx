...
<Callout variant="tip">
  뉴렐릭 API Explorer를 사용하여 [모바일 메트릭 데이터](https://api.newrelic.com/docs/#/Mobile%20Applications/get_mobile_applications__mobile_application_id__metrics_data_json)를 검색할 수도 있습니다.
</Callout>
