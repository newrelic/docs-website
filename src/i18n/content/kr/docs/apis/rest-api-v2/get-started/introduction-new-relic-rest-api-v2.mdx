...
[New Relic의 REST API](/docs/apis/getting-started/introduction-new-relic-apis) 를 사용하면 New Relic 도구에서 데이터를 검색하고 데이터를 New Relic 도구로 푸시하고 구성 및 삭제 기능을 포함할 수 있습니다. [API 탐색기](/docs/apis/rest-api-v2/api-explorer-v2/getting-started-new-relics-api-explorer) 를 사용하여 REST API를 통해 사용할 수 있는 데이터를 이해하고, curl 명령을 얻고, JSON 응답을 볼 수도 있습니다.
