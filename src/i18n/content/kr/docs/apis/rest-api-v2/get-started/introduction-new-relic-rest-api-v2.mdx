...
* [APM 예제](/docs/apis/rest-api-v2/application-examples-v2) (메트릭 타임슬라이스 데이터를 검색하는 방법)

  <InlinePopover type="apm"/>

  ).

* [브라우저 예제](/docs/apis/rest-api-v2/browser-examples-v2) (메트릭 타임슬라이스 데이터를 검색하는 방법)

  <InlinePopover type="browser"/>

  ). REST API는 Lite 브라우저 에이전트 스크립트만 반환합니다. 자세한 내용은 [Lite, Pro 및 Pro+SPA 유형을 비교하는 이 표를 참조하세요](/docs/browser/browser-monitoring/installation/install-browser-monitoring-agent).
