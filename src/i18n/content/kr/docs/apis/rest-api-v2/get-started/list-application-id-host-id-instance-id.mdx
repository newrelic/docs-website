...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM > (앱 선택)으로** 이동합니다.
...
<CollapserGroup>
  ...
  >
    ...
    1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM > Applications > (앱 선택) > JVMs**으로 이동합니다.
