...
[REST API 탐색기의 <DoNotTranslate>**Applications > List**</DoNotTranslate>](/docs/apis/using-the-api-explorer) 사용하여 ID 세부정보를 나열할 수도 있습니다. 올바른 애플리케이션 이름을 입력하세요.
...
[REST API 탐색기의 <DoNotTranslate>**Applications > List**</DoNotTranslate>](/docs/apis/using-the-api-explorer) 또는 <DoNotTranslate>**Applications > List**</DoNotTranslate> 사용하여 ID 세부정보를 나열할 수도 있습니다. 올바른 애플리케이션 이름을 입력하세요.
