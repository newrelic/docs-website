...
## 모든 애플리케이션 ID 나열 [#view_all_app_id]
...
## 이름으로 앱 ID 나열 [#view_single_app_id]
...
## 측정항목 이름 나열 지침 [#name_list_guidelines]
...
## 앱의 측정항목 이름 나열 [#view_app_metrics_names]
...
## 앱의 메트릭 타임슬라이스 데이터 값 가져오기 [#app_metric_data_values]
