...
<Callout variant="tip">
  [뉴렐릭 API Explorer(v2)](https://api.newrelic.com/docs) 에서 동일한 정보를 얻으려면 [<DNT>**Application Hosts &gt; GET Metric Data**</DNT>을](https://api.newrelic.com/docs/#/Applications/get_applications__application_id__hosts__host_id__metrics_data_json) 선택하고 [API 키를](/docs/apis/rest-api-v2/getting-started/introduction-new-relic-rest-api-v2#api_key) 포함하세요. 해당 필드에 [애플리케이션 ID](/docs/apm/apis/requirements/identification-code), [호스트 ID](/docs/apis/rest-api-v2/requirements/listing-host-instance-application-server-ids#locating_host_id), `names[]=CPU/User Time` 및 `values[]=percent` 메트릭을 추가하세요.
</Callout>
...
<Callout variant="tip">
  [뉴렐릭 API Explorer(v2)](https://api.newrelic.com/docs)에서 동일한 정보를 얻으려면 [<DNT>**Applications &gt; GET Metric Data**</DNT>을](https://api.newrelic.com/docs/#/Applications/get_applications__application_id__metrics_data_json) 선택하고 [API 키를](/docs/apis/rest-api-v2/getting-started/introduction-new-relic-rest-api-v2#api_key) 포함하세요. 해당 필드에 [애플리케이션 ID](/docs/apm/apis/requirements/identification-code), `names[]=CPU/User Time` 및 `values[]=percent` 메트릭을 추가하세요.
</Callout>