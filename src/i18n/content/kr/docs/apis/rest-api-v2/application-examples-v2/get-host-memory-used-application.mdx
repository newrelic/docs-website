...
1. <DNT>[**Application Hosts > GET Metric Data**](https://rpm.newrelic.com/api/explore/application_hosts/data)</DNT>
...
1. <DNT>[**Applications > GET Metric Data**](https://rpm.newrelic.com/api/explore/applications/data)</DNT>
