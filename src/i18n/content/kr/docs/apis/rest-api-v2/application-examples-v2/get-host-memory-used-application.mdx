...
1. [<DNT>**Application Hosts &gt; GET Metric Data**</DNT>](https://rpm.newrelic.com/api/explore/application_hosts/data) 선택하고 [API 키를](/docs/apis/rest-api-v2/getting-started/introduction-new-relic-rest-api-v2#api_key) 포함합니다.
...
1. [<DNT>**Applications &gt; GET Metric Data**</DNT>](https://rpm.newrelic.com/api/explore/applications/data) 선택하고 [API 키를](/docs/apis/rest-api-v2/getting-started/introduction-new-relic-rest-api-v2#api_key) 포함합니다.
