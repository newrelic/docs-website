...
뉴렐릭 REST API (v2)에서 앱 이름의 별칭을 변경하려면 이 명령을 사용하세요. 을(를) [<DNT>**Applications &gt; Update**</DNT>](https://api.newrelic.com/docs/#/Applications/put_applications__id__json) 선택하여 뉴렐릭의 API 탐색기 에서 [앱 별칭을 변경할 수도 있습니다.](/docs/apis/rest-api-v2/api-explorer-v2/getting-started-new-relics-api-explorer)
...
<Callout variant="important">
  앱 별칭을 변경하면 이 앱 식별자로 보고하는 모든 에이전트가 다시 시작됩니다. 자세한 내용은 [애플리케이션 이름 바꾸기](/docs/apm/agents/manage-apm-agents/app-naming/name-your-application/#app-alias)를 참조하십시오.
</Callout>
