...
New Relic 사용자 인터페이스에 표시되는 애플리케이션 이름은 구성 설정에 할당된 기본 이름에 대해 사람이 읽을 수 있는 [별칭](/docs/agents/manage-apm-agents/app-naming/rename-your-application#app-alias) 입니다. 이를 변경하면 다음을 포함하여 플랫폼의 모든 곳에서 앱 이름이 업데이트됩니다. <InlinePopover type="apm"/>, <InlinePopover type="browser"/>, 등.
