...
<Callout variant="important">
  2024년 10월 22일부로 컨테이너화된 미니언(분당 호출 수) 및 구형 신세틱스 손잡이 버전이 [종료](/whats-new/2024/04/whats-new-04-09-eol-synthetics-runtime-cpm) 됩니다. 2024년 6월 30일에는 구형 신세틱스 파티션 버전을 사용하여 새로운 모니터 생성이 차단됩니다. 신세틱스 REST API 실내 신세틱스 전시 버전을 사용한 모니터 생성만 지원합니다. 성능 저하를 방지하려면 [NerdGraph API](/docs/apis/nerdgraph/examples/nerdgraph-synthetics-tutorial/) 사용하여 최신 런타임을 사용하여 신세틱스 모니터를 관리하세요.
</Callout>
...
<CollapserGroup>
  ...
  >
    ...
    모든 분야가 요구됩니다. 그러나 모니터 <DoNotTranslate>**cannot**</DoNotTranslate> 의 `TYPE` 가 변경됩니다.
