...
<Callout variant="tip">
  <DoNotTranslate>**This API is no longer the preferred way to query New Relic data.**</DoNotTranslate> 그렇게 하려면 [NerdGraph를](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph/) 사용하세요.
</Callout>

## 요구 사항 및 권장 사항 [#requirements]

<DoNotTranslate>**This API is no longer the preferred way to query New Relic data.**</DoNotTranslate> 최상의 결과를 얻으려면 [NerdGraph를](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph) 사용하여 데이터를 쿼리해야 합니다.
...
2. API 키 페이지 오른쪽 상단에 있는 <DoNotTranslate>**Create a key button**</DoNotTranslate> 클릭합니다.
3. 새 키를 구성합니다.
...
<DoNotTranslate>**Powershell**</DoNotTranslate> 사용하여 API를 통해 이벤트를 쿼리할 수 있습니다.
