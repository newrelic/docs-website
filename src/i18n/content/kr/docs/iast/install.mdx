...
<Steps>
  <Step>
    <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com) > All capabilities > IAST**</DoNotTranslate> 으로 이동하여 <DoNotTranslate>**Set up IAST with applications**</DoNotTranslate> 클릭합니다.
  ...
  <Step>
    IAST가 운영 환경에서 실행되고 있지 않은지 확인하고 <DoNotTranslate>**Continue**</DoNotTranslate> 클릭합니다.  
  ...
  <Step>
    ...
    <CollapserGroup>
      <Collapser
        ...
        title={<><InlineCode>newrelic.yml</InlineCode> 구성 파일</>}
      >
        ```yml
        security:
            enabled: true
      ...
      <Collapser
        ...
        title={<><InlineCode>newrelic.yml</InlineCode> EU용 구성 파일</>}
      >
        ```yml
        security:
            enabled: true
      ...
      <Collapser
        ...
        title={<><InlineCode>newrelic.yml</InlineCode> Fed 사용자를 위한 구성 파일</>}
      >
        ```yml
        security:
            enabled: true
  ...
  <Step>
    테스트된 애플리케이션의 개요를 보려면 <DoNotTranslate>**See your data**</DoNotTranslate> 클릭하세요.  
