...
<Steps>
  <Step>
    **[one.newrelic.com](https://one.newrelic.com) > All capabilities > IAST** 로 이동하여 **Set up IAST with applications** \[애플리케이션으로 IAST 설정을] 클릭합니다.
  ...
  <Step>
    IAST가 운영 환경에서 실행되고 있지 않은지 확인하고 **Continue** \[계속을] 클릭합니다.  
  ...
  <Step>
    테스트된 애플리케이션의 개요를 보려면 **See your data** \[데이터 보기를] 클릭하세요.  
