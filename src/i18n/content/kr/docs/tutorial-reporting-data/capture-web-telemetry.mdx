  ...
  <Step>
    ...
    <CollapserGroup>
      <Collapser
        ...
        title="UI를 통해"
      >
        <DNT>**Browser**</DNT> 에서 웹 애플리케이션을 엽니다. 왼쪽 메뉴에서 <DNT>**Errors**</DNT> 보기를 열고 자바스크립트 오류가 보이는지 확인하세요. 애플리케이션의 트래픽이 많지 않으면 오류를 확인하기 위해 24시간 이상 이전으로 돌아가야 할 수도 있습니다.<img
    ...
    <CollapserGroup>
      <Collapser
        ...
        title="UI를 통해"
      >
        이벤트 로그를 캡처하고 있는지 확인하려면 <DNT>**JS Errors**</DNT> 탭으로 이동하세요. 다양한 오류를 확인하여 이벤트 로그가 나타나는지 확인하세요.<img
  ...
  <Step>
    ...
    <CollapserGroup>
      <Collapser
        ...
        title="UI를 통해"
      >
        왼쪽 메뉴에서 앱을 선택하여 앱의 <DNT>**Page views**</DNT> UI를 확인하세요. 보이는 내용이 아래 스크린샷과 많이 일치하는 경우 메모를 작성하고 문제 해결 방법에 대한 이 가이드의 지침을 따르세요.<img
  ...
  <Step>
    ...
    <CollapserGroup>
      <Collapser
        ...
        title="UI를 통해"
      >
        왼쪽 메뉴에서 앱을 선택하고 <DNT>**groupedRequestUrl**</DNT> 별로 그룹화하여 앱의 AJAX 그룹화를 확인하세요. 표시되는 내용이 아래 스크린샷과 많이 일치하는 경우 메모를 작성하고 문제 해결 방법에 대한 이 가이드의 지침을 따르세요.<img
