...
<Steps>
  ...
  <Step>
    ...
    <CollapserGroup>
      <Collapser
        ...
        title="UI를 통해"
      >
        <DoNotTranslate>**Browser**</DoNotTranslate> 에서 웹 애플리케이션을 엽니다. 왼쪽 메뉴에서 <DoNotTranslate>**Errors**</DoNotTranslate> 보기를 열고 자바스크립트 오류가 보이는지 확인하세요. 애플리케이션의 트래픽이 많지 않으면 오류를 확인하기 위해 24시간 이상 이전으로 돌아가야 할 수도 있습니다.<img src={omaOeScBrowserErrors} alt="Browser JavaScript Errors" title="Browser JavaScript Errors"/>
      </Collapser>
    ...
    <CollapserGroup>
      <Collapser
        ...
        title="UI를 통해"
      >
        이벤트 로그를 캡처하고 있는지 확인하려면 <DoNotTranslate>**JS Errors**</DoNotTranslate> 탭으로 이동하세요. 다양한 오류를 확인하여 이벤트 로그가 나타나는지 확인하세요.<img src={omaOeScBrowserErrorLog} alt="Browser JavaScript Error Logs" title="Browser JavaScript Error Logs"/>
      </Collapser>
    </CollapserGroup>
    ...
    <CollapserGroup>
      <Collapser
        ...
        title="UI를 통해"
      >
        <DoNotTranslate>**JS Errors**</DoNotTranslate> 탭을 통해 여러 오류를 확인하세요. 오류 이벤트 로그 아래에 스택 추적이 나타납니다.
      </Collapser>
  ...
  <Step>
    ...
    다음으로 페이지 보기 그룹화를 확인하세요. <DoNotTranslate>**Page views**</DoNotTranslate> UI의 페이지 URL은 페이지 성능을 더 잘 관리하는 데 도움이 되도록 자동으로 그룹화됩니다. 자동 그룹화를 결정하는 알고리즘은 웹 앱이 처음으로 업로드될 때 실행됩니다. 현재 웹 트래픽이 앱을 처음 사용할 때와 많이 다르다면 그룹이 너무 적은 것일 수 있습니다.
    ...
    <CollapserGroup>
      <Collapser
        ...
        title="UI를 통해"
      >
        왼쪽 메뉴에서 앱을 선택하여 앱의 <DoNotTranslate>**Page views**</DoNotTranslate> UI를 확인하세요. 보이는 내용이 아래 스크린샷과 많이 일치하는 경우 메모를 작성하고 문제 해결 방법에 대한 이 가이드의 지침을 따르세요.<img src={omaOeScBrowserGroupedPageViews} alt="Browser Page URL Grouping" title="Browser Page URL Grouping"/>
      </Collapser>
  ...
  <Step>
    ...
    <CollapserGroup>
      <Collapser
        ...
        title="UI를 통해"
      >
        왼쪽 메뉴에서 앱을 선택하고 <DoNotTranslate>**groupedRequestUrl**</DoNotTranslate> 별로 그룹화하여 앱의 AJAX 그룹화를 확인하세요. 표시되는 내용이 아래 스크린샷과 많이 일치하는 경우 메모를 작성하고 문제 해결 방법에 대한 이 가이드의 지침을 따르세요.<img src={omaOeScBrowserGroupedAjaxRequests} alt="AJAX Grouping" title="AJAX Grouping"/>
      </Collapser>
