...
<CollapserGroup>
  ...
  >
    ...
    **모범 사례:\*** [경고 품질 관리 가이드를](/docs/tutorial-create-alerts/manage-alert-quality/) 따르면 다음을 통해 서비스 동작을 이해하는 데 도움이 됩니다. <InlinePopover type="alerts"/>귀하의 서비스 제공을 개선하는 데 도움이 됩니다.
  </Collapser>
</CollapserGroup>
