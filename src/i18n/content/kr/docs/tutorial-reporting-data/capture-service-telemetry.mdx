...
<Steps>
  ...
  <Step>
    ...
    <CollapserGroup>
      ...
      >
        ...
        서비스에 제공하는 이름은 <DoNotTranslate>**namespace**</DoNotTranslate> (에이전트 데이터를 찾을 위치)을 제공합니다. 뉴웰릭이 서비스 동작을 이해하기 위해 사용하는 가장 중요한 전략 중 하나는 유사한 항목을 함께 집계하고 이 집계의 공통점을 사용하여 차이를 격리하는 것입니다. 서비스를 구현하는 경우 이름을 지정하는 데 도움이 되도록 다음을 요청하세요.
  ...
  <Step>
    ...
    * <DoNotTranslate>**Defect detection:**</DoNotTranslate>
      ...
      간단한 참/거짓 결과를 생성하는 엔드포인트에 대한 테스트를 인코딩함으로써 운영에서는 개별 오류를 격리하여 서비스 제공의 무결성이 손상되었는지 확인할 수 있습니다.
