...
cloud 지출을 분석하고 최적화하려면 NRQL을 사용하여 클라우드 비용 인텔리전스 데이터를 쿼리하세요. 상세 쿼리를 위한 속성이 포함된 5가지 이벤트 유형을 사용할 수 있습니다:
...
<table>
  ...
  <tr>
    ...
    <td>
      Kubernetes 비용 할당, 전체 NRQL 언어를 지원합니다.
    </td>
  </tr>
...
<DNT>**All Capabilities &gt; Cloud Cost Intelligence**</DNT> (으)로 이동하여 <DNT>**Query Console**</DNT> 을(를) 열고 쿼리를 입력합니다.
