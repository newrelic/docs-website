...
쿼리 클라우드 분석 인텔리전스 데이터는 NRQL 사용하여 cloud 지출을 분석하고 최적화합니다. 세부 쿼리에 대한 속성과 함께 세 가지 이벤트 유형을 사용할 수 있습니다.
...
<CollapserGroup>
  <Collapser id="cloud-cost-attributes" title="CloudCost 속성">
    **All Capabilities &gt; Cloud Cost Intelligence** 로 이동하여 쿼리 콘솔을 열고 다음을 입력하십시오.
