...
효율적인 [NRQL](/docs/nrql/get-started/introduction-nrql-new-relics-query-language) 쿼리를 작성하려면 [NRQL 입문 튜토리얼을](/docs/nrql/nrql-tutorials/introduction-nrql-tutorial) 참조하세요.

## 쿼리 클라우드 컴퓨팅 인텔리전스 데이터
...
<Tabs>
  ...
  <TabsPages>
    ...
    <TabsPageItem id="kubernetescost">
      ...
      이는 리소스 사용량에 기반한 정확한 비용 할당을 위해 `net_unblended_cost` 에 CPU 및 메모리 가중치의 합을 곱합니다.
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              컨테이너가 할당된 총 CPU 코어 수 중에서 사용한 CPU 코어 수입니다.
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              구현하다, 배포하다 컨테이너에 대해 요청된 CPU 코어입니다.
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              이 컨테이너에 할당된 CPU 코어 수입니다. (0.00005877)
            </td>
          </tr>
...
<CollapserGroup>
  <Collapser id="state-select" title="지원되는 NRQL 조항">
