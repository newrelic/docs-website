...
<CollapserGroup>
  ...
  >
    ...
    * APM 모니터링 엔터티에 대해 분산 추적이 활성화되면 레거시 [서비스 맵에는](/docs/understand-dependencies/understand-system-dependencies/service-maps/introduction-service-maps) 다음이 모니터링하는 응용 프로그램이 표시되지 않습니다.
