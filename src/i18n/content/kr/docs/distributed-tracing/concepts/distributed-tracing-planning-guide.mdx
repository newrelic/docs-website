...
<CollapserGroup>
  ...
  >
    ...
    <figcaption>
      **[one.newrelic.com](https://one.newrelic.com) > APM > (앱 선택) > Monitor > Transactions > (트랜잭션 추적 선택)** : 연결된 트랜잭션에 대한 링크와 함께 분산 추적이 활성화되기 전의 트랜잭션 추적 UI를 보여줍니다. 분산 추적이 활성화되면 서비스의 URL이 표시됩니다.
    </figcaption>
