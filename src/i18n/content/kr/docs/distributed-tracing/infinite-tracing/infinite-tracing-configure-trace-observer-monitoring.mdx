...
New Relic Edge 앱은 추적 관찰자 모니터링을 제공하므로 추적 관찰자의 샘플링 동작에 대한 추가 통찰력을 얻을 수 있습니다. 이 선택적 기능은 추적 관찰자가 보고 보관한 추적의 양을 보여줍니다. 추적 관찰자 메트릭은 선택한 계정에 기록되며 New Relic Edge 앱 또는 쿼리 빌더에서 볼 수 있습니다.
...
추적 관찰자 메트릭을 수신하는 계정을 변경하기로 결정한 경우 New Relic Edge 앱에서 이를 수행할 수 있습니다.

1. **Apps > Your apps > New Relic Edge** 로 이동합니다.
...
모니터링 계정에 대한 액세스 권한이 없으면 Edge 앱에서 추적 관찰자 메트릭을 보거나 이러한 메트릭에 대해 NRQL 쿼리를 실행할 수 없습니다. 액세스 권한이 없는 경우 다음과 같이 표시됩니다.
...
### Edge 앱에서 보기 [#view-in-edge]

추적 관찰자 모니터링을 켜면 추적 관찰자 메트릭이 Edge 앱에 추가됩니다.
