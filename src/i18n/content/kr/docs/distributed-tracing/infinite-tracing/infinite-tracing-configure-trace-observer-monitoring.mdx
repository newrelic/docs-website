...
Infinite Tracing 설정 앱(이전의 "New Relic Edge")은 추적 관찰자 모니터링을 제공하므로 추적 관찰자의 샘플링 동작에 대한 추가 통찰력을 얻을 수 있습니다.이 선택적 기능은 추적 관찰자가 보고 보관한 추적의 양을 보여줍니다.추적 관찰자 메트릭은 선택한 계정에 기록되며 New Relic Edge 앱 또는 쿼리 빌더에서 볼 수 있습니다.
...
New Relic Edge 앱에서 토글을 클릭하여 추적 관찰자 모니터링을 켤 수 있습니다. 추적 관찰자 모니터링을 활성화하는 즉시 추적 관찰자 메트릭이 캡처되어 앱에 표시되거나 쿼리 빌더에서 볼 수 있습니다. 추적 관찰자 메트릭은 소급되지 않으며 추적 관찰자 모니터링이 활성화된 경우에만 캡처됩니다.

1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) >Apps > Your apps > New Relic Edge** 로 이동합니다.
2. 계정 선택기를 사용하여 추적 관찰자 지표에 사용할 계정을 선택합니다.
3. 활성화하려면 **추적 관찰자 모니터링** 토글을 클릭합니다.

## 추적 관찰자 모니터링 계정 전환 [#switch-accounts]

추적 관찰자 메트릭을 수신하는 계정을 변경하기로 결정한 경우 Infinite Tracing 설정 앱에서 변경할 수 있습니다.

1. **> Apps > Your apps > Infinite Tracing settings** 으로 이동합니다.
...
모니터링 계정에 대한 액세스 권한이 있는 사람은 누구나 Edge 앱 또는 쿼리 빌더에서 추적 관찰자 메트릭을 볼 수 있습니다.

모니터링 계정에 대한 액세스 권한이 없으면 Infinite Tracing 설정 앱에서 추적 관찰자 메트릭을 보거나 이러한 메트릭에 대해 NRQL 쿼리를 실행할 수 없습니다.액세스 권한이 없는 경우 다음과 같이 표시됩니다.
...
### Infinite Tracing 설정 앱에서 보기 [#view-in-edge]

추적 관찰자 모니터링을 켜면 추적 관찰자 메트릭이 무한 추적 설정 앱에 추가됩니다.
...
* 화면 오른쪽에 새 창이 추가됩니다.
  ...
  * **어떤 흔적이 남았습니까?** (하단 차트): 어떤 범주의 트레이스가 보관되었는지 보여줍니다. 차트는 추적이 다양한 유형의 무한 추적 필터로 캡처되었는지 여부를 보여줍니다.
  ...
  메트릭을 보는 프로그래밍 방식을 선호하는 경우 다음은 NRQL 쿼리의 몇 가지 예입니다. 다음 예는 Edge 앱의 두 차트를 복제합니다.
