...
* 두 개의 열이 기본 추적 관찰자 목록에 추가됩니다.
  ...
  * <DNT>
    ...
    : 지난 60분 동안 트레이스 관찰자가 본 트레이스 수입니다.
...
* 화면 오른쪽에 새 창이 추가됩니다.
  ...
  * <DNT>**Monitoring account**</DNT>: 오른쪽 창 상단에 트레이스 관찰자 메트릭이 기록되는 계정입니다.

  * <DNT>**How many traces were kept?**</DNT> (상위 차트): <DNT>**Traces Kept**</DNT> 과 동일한 정보를 표시하지만 시간이 지남에 따라 이것이 어떻게 나타나는지 보여줍니다. 샘플링의 규모와 추세를 확인할 수 있습니다.

  * <DNT>**Which traces were kept?**</DNT> (하단 차트): 어떤 트레이가 보관되었는지 보여줍니다. 차트는 트레이스가 다양한 유형의 Infinite Tracing 필터에 의해 캡처되었는지 여부를 보여줍니다.
...
<DNT>**How many traces were kept?**</DNT> (상위 차트):
...
<DNT>**Which traces were kept?**</DNT> (하단 차트):
