...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Apps** 으로 이동한 다음 **Your apps** 에서 **Infinite Tracing settings** 을 클릭합니다.
...
1. 추적 관찰자 앱( **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Apps > Your Apps > Infinite Tracing settings** )으로 돌아갑니다.
