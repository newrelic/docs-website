...
4. <DNT>**Endpoints**</DNT> 드롭다운 메뉴에서 <DNT>**For other integrations**</DNT> 아래의 엔드포인트 값을 복사하여 준비하세요. 이 값은 코드 예제에서 YOUR_TRACE_OBSERVER_URL로 참조됩니다. [트레이스 옵저버를](#sample-payload) 테스트하는데 사용됩니다.
