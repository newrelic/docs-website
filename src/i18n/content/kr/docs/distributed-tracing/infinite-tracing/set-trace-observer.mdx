...
1. [one.newrelic.com](https://one.newrelic.com) 으로 이동하여 **앱** 을 클릭한 다음 **내 앱** 에서 **무한 추적 설정** 을 클릭합니다.
...
1. 추적 관찰자 앱( **[one.newrelic.com](https://one.newrelic.com) > Apps > Your apps > Infinite Tracing settings** )으로 돌아갑니다.
