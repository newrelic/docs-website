...
* EU 데이터센터: `https://trace-api.eu.newrelic.com/trace/v1` (다른 [EU 엔드포인트](/docs/using-new-relic/welcome-new-relic/getting-started/introduction-eu-region-data-center#endpoints) 참조).
* JP 데이터센터: `https://trace-api.jp.nr-data.net/trace/v1` (다른 [JP 엔드포인트](/docs/accounts/accounts-billing/account-setup/choose-your-data-center/#jp-endpoints) 참조).
* [무한 추적](/docs/understand-dependencies/distributed-tracing/infinite-tracing/introduction-infinite-tracing) : [추적 관찰자 설정](/docs/understand-dependencies/distributed-tracing/infinite-tracing/set-trace-observer) 을 완료하면 끝점으로 사용할 사용자 정의 YOUR\_TRACE\_OBSERVER\_URL 값을 얻습니다. Trace API(예: [Kamon 리포터](/docs/more-integrations/open-source-telemetry-integrations/kamon/kamon-reporter/#install) )를 사용하는 통합을 사용하는 경우 해당 엔드포인트와 해당 통합을 구성해야 합니다. 또한 범위의 100%를 보내도록 [추적 서비스의 샘플링](/docs/understand-dependencies/distributed-tracing/get-started/how-new-relic-distributed-tracing-works#tail-based) 을 조정하는 것이 좋습니다.
...
* <DNT>**HTTP status code**</DNT> (동기식). 인증 및 요청 오류는 HTTP 상태 코드를 통해 표시됩니다.
  ...
  <CollapserGroup>
    <Collapser id="status-codes" title="HTTP 상태 코드 보기">
      <table>
        <thead>
          <tr>
