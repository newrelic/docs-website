...
* [무한 추적](/docs/understand-dependencies/distributed-tracing/infinite-tracing/introduction-infinite-tracing) : [추적 관찰자 설정](/docs/understand-dependencies/distributed-tracing/infinite-tracing/set-trace-observer) 을 완료하면 끝점으로 사용할 사용자 지정
  ...
  값을 얻게 됩니다. Trace API(예: [Kamon 리포터](/docs/more-integrations/open-source-telemetry-integrations/kamon/kamon-reporter/#install) )를 사용하는 통합을 사용하는 경우 해당 엔드포인트와 통합을 구성해야 합니다. 또한 [추적 서비스의 샘플링](/docs/understand-dependencies/distributed-tracing/get-started/how-new-relic-distributed-tracing-works#tail-based) 을 조정하여 스팬을 100% 보내야 합니다.
