...
* [새로운 유물 형식의 추적 데이터](/docs/apm/distributed-tracing/trace-api/report-new-relic-format-traces-trace-api)
...
* [무한 추적](/docs/understand-dependencies/distributed-tracing/infinite-tracing/introduction-infinite-tracing) : [추적 관찰자 설정](/docs/understand-dependencies/distributed-tracing/infinite-tracing/set-trace-observer) 을 완료하면 끝점으로 사용할 사용자 지정

  <var>YOUR_TRACE_OBSERVER_URL</var>

  값을 얻습니다. Trace API를 사용하는 통합(예: [이러한 통합](/docs/understand-dependencies/distributed-tracing/enable-configure/integrations-enable-distributed-tracing) )을 사용하는 경우 해당 엔드포인트와 통합을 구성해야 합니다. 또한 100% 범위를 보내도록 [추적 서비스의 샘플링](/docs/understand-dependencies/distributed-tracing/get-started/how-new-relic-distributed-tracing-works#tail-based) 을 조정하고 싶을 것입니다.

* FedRAMP의 경우 [FedRAMP 끝점](/docs/security/security-privacy/compliance/fedramp-compliant-endpoints/#trace-api) 을 참조하십시오.
...
추적 관련 제한은 [분산 추적 작동 방식](/docs/distributed-tracing/concepts/how-new-relic-distributed-tracing-works) 을 참조하세요.