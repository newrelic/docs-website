...
<CollapserGroup>
  <Collapser
    id="newrelic"
    title="새로운 유물 형식 속성의 예"
  >
    여러 유형의 속성이 추가된 [새로운 Relic 형식](/docs/apm/distributed-tracing/trace-api/report-new-relic-format-traces-trace-api) JSON. 맞춤 속성의 중요성은 `customAttribute` 에 설명되어 있습니다.
