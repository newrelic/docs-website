...
2. 해당 키를 다음 JSON에 삽입한 다음 JSON을 당사 엔드포인트로 보냅니다. 참고: EU 또는 JP 뉴렐릭 계정이 있는 경우 대신 적절한 [지역 엔드포인트](/docs/distributed-tracing/trace-api/trace-api-general-requirements-limits#requirements) 를 사용하세요.
