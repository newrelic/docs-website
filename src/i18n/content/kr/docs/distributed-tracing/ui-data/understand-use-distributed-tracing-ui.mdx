...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="모든 계정의 추적 보기"
  >
    액세스 권한이 있는 모든 계정의 추적을 보려면 **[one.newrelic.com](https://one.newrelic.com)** 으로 이동하십시오. **데이터 찾아보기 를** 클릭한 다음 **추적** 을 클릭합니다.
...
<CollapserGroup>
  ...
  >
    ...
    3. [범위](/docs/using-new-relic/welcome-new-relic/getting-started/glossary#span) 에 오류가 있습니다.
       ...
       <figcaption>
         **[one.newrelic.com](https://one.newrelic.com) > Apps > Distributed tracing** 으로 이동합니다.
       </figcaption>
  </Collapser>
