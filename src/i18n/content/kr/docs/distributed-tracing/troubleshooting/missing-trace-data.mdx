...
* [계측 상태 앱을](https://one.newrelic.com/dt-setup-assistant) 사용하여 샘플링 속도를 포함하여 트레이스 계측의 개요를 확인하십시오. 이렇게 하면 누락된 스팬과 조각난 추적을 이해하는 데 도움이 될 수 있습니다. 이것을 찾으려면 **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Apps > Distributed tracing instrumentation status**로 이동하십시오.
