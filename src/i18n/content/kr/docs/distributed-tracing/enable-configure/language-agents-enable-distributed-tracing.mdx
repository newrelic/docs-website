...
New Relic에는 C, Go, Java, Node.js, .NET, PHP, Python 및 Ruby용 APM 언어 에이전트가 있습니다. 이들 각각은 분산 추적의 기능을 활용하는 몇 가지 방법을 제공합니다.

* [표준 분산 추적을 위한 빠른 시작(권장):](#quick-start-apm) 시작하는 빠른 방법
* [무한 추적:](#infinite-tracing) 표준 분산 추적에 대한 고급 대안
...
## 표준 분산 추적을 위한 빠른 시작(권장): [#quick-start-apm]
...
각 서비스를 계측하는 데 도움이 되도록 다양한 언어에 대한 설치 도우미가 있습니다.
...
## 무한 추적 설정(고급 옵션) [#infinite-tracing]
...
### 1단계. 위의 빠른 시작에서 표준 분산 추적을 위한 계측 완료

Infinite Tracing 설정은 표준 분산 추적을 위한 [빠른 시작](#quick-start-apm) 의 계측 단계를 기반으로 합니다.
