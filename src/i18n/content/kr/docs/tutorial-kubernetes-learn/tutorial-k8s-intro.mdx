  ...
  <Step>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          <td>
            [안내 설치(JP)](https://onenr.io/0oQDrE83ZRy)
          </td>

          <td>
            귀사의 뉴렐릭 조직이 [JP](/docs/using-new-relic/welcome-new-relic/get-started/our-eu-us-region-data-centers) 데이터센터를 사용하고 퀵스타트의 보너스 대시보드와 알림이 필요하지 않은 경우 사용합니다.
          </td>
        </tr>
