    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            New Relic 조직이 **EU** 데이터 센터를 사용 하지 [않고 보너스](/docs/using-new-relic/welcome-new-relic/get-started/our-eu-us-region-data-centers) 대시보드 및 빠른 <InlinePopover type="alerts"/>시작에서.
          </td>
        </tr>
