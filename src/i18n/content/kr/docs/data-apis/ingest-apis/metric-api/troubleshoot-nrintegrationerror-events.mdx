...
1. [인사이트 조회 API 키](/docs/insights/insights-api/get-data/query-insights-event-data-api) 가 있는지 확인하세요( <DoNotTranslate>**[insights.newrelic.com](https://insights.newrelic.com) > Manage data > API keys**</DoNotTranslate> 으로 이동).
