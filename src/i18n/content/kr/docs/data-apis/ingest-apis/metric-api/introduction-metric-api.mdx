...
데이터를 보내려는 New Relic 계정에 대한 New Relic <LicenseKey/> 가 필요합니다. 한도 및 제한된 속성에 대한 자세한 내용은 [Metric API 요구 사항 및 한도](/docs/metric-api-general-requirements-limits) 를 참조하세요.
