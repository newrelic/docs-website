...
데이터를 보내려는 New Relic 계정에 대한 New Relic [라이센스 키](/docs/apis/intro-apis/new-relic-api-keys/#ingest-license-key) 가 필요합니다. 제한 및 제한된 속성에 대한 정보는 [Metric API 요구사항 및 제한](/docs/metric-api-general-requirements-limits) 을 참조하십시오.
...
* [one.newrelic.com](https://one.newrelic.com) 에서 **Explorer** 를 선택하고 서비스를 찾습니다.
