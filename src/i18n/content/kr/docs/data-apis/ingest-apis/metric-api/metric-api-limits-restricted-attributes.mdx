...
Metric API 한도는 개별 계정 수준에서 적용됩니다. DPM 및 카디널리티의 기본 제한 범위는 [무료 버전](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing/#editions) 조직의 경우 3M, 일부 유료 조직의 경우 최대 10.2M입니다. 조직의 한도를 이해하려면 [한도 UI를](/docs/data-apis/manage-data/view-system-limits) 참조하세요. 유료 조직의 요청에 따라 DPM 및 카디널리티를 15M까지 늘릴 수 있습니다. 분당 최대 페이로드는 사례별로 100,000 이상으로 조정될 수 있습니다. 지표 속도 제한 변경을 요청하려면 New Relic 계정 담당자에게 문의하거나 [지원 포털을](http://support.newrelic.com/) 방문하세요.
