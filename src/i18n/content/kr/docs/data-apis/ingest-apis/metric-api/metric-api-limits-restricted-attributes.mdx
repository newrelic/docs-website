...
메트릭 API 한도는 개별 계정 수준에서 적용됩니다. 기본 카디널리티 한도는 [무료 에디션](https://newrelic.com/pricing)을 사용하는 조직의 경우 300만에서 일부 유료 조직의 경우 최대 1,020만까지입니다. 조직의 한도를 파악하려면 [한도 UI](/docs/data-apis/manage-data/view-system-limits)를 참조하세요. 유료 조직의 경우 요청 시 카디널리티를 15M까지 늘릴 수 있습니다. 분당 최대 페이로드는 사례별로 100k 이상으로 조정할 수 있습니다. 메트릭 속도 제한 변경을 요청하려면 뉴렐릭 계정 담당자에게 문의하거나 [지원 포털](http://support.newrelic.com/)을 방문하세요.
