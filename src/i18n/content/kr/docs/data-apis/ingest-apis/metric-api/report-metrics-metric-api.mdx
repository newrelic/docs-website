...
<Callout variant="tip">
  조직에서 EU 또는 JP 데이터센터에 데이터를 호스팅하는 경우 올바른 리전 엔드포인트를 사용하고 있는지 확인하십시오. 이 API의 경우:

  * EU 끝점: `https://metric-api.eu.newrelic.com/metric/v1`
  * JP 엔드포인트: `https://metric-api.jp.nr-data.net/metric/v1`
</Callout>
