...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <DNT>**Recommended**</DNT>. 이는 [지원되는 지표 유형](/docs/telemetry-data-platform/ingest-manage-data/understand-data/metric-data-type) 중 하나여야 합니다. 유형을 지정하지 않으면 기본값은 `gauge` 입니다.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <DNT>**Recommended**</DNT>. 이 특정 지표와 관련된 키/값 쌍의 맵입니다. 값은 문자열, JSON 숫자 또는 부울일 수 있습니다. 키는 대소문자를 구분하며 255자 미만이어야 합니다.
      </td>
    </tr>
  </tbody>
</table>
