...
1. 데이터를 보고하려는 계정의 [라이선스 키를](/docs/apis/intro-apis/new-relic-api-keys/#license-key) 가져옵니다.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        **필수의.** 데이터를 보고하려는 계정의 [라이선스 키](/docs/apis/intro-apis/new-relic-api-keys/#license-key) . 이것이 헤더와 쿼리 매개변수로 모두 제공되는 경우 값이 일치해야 합니다.
      </td>
    </tr>
