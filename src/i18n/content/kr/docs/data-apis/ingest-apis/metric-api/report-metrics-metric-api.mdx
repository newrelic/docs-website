...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <DNT>**Required**</DNT>. [Unix 시간 기준](https://currentmillis.com/) 지표의 시작 시간입니다. 기본값은 UTC 시간대를 사용합니다. 이 필드는 초, 마이크로초, 나노초도 지원합니다. 그러나 데이터는 저장 및 쿼리를 위해 밀리초로 변환됩니다. 48시간 이전 또는 보고된 시점으로부터 24시간이 지난 타임스탬프가 포함된 지표는 삭제됩니다.
      </td>
    </tr>
