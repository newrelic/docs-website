...
* 데이터를 보고하려는 계정의 뉴렐릭 <InlinePopover type="licenseKey" />.
...
* 미국의 경우(기본값), `https://security-api.newrelic.com/security/v1`
* EU의 경우, `https://security-api.service.eu.newrelic.com/security/v1`
* JP의 경우, `https://security-api.service.jp.newrelic.com/security/v1`
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        문제가 감지된 시점의 타임스탬프(epoch 이후 밀리초 단위). 제공되지 않은 경우 데이터가 뉴렐릭으로 전송된 시점을 사용합니다.
      </td>
    </tr>
  </tbody>
</table>