...
사건 이벤트 데이터를 New Relic에 보내기 시작했으면 구문 분석 오류에 대한 알림을 받도록 [NRQL 경고 조건](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/nrql-alert-conditions) 을 설정하는 것이 좋습니다.
