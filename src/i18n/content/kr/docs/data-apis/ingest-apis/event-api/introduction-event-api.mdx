    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            키 누락 또는 유효하지 않음: 유효하지 않은 라이센스 키입니다. 유효한 <InlinePopover type="licenseKey" /> 를 등록하십시오. `License` 유형의 키를 사용해야 합니다. `Browser` , `Mobile` 또는 `User` 키는 작동하지 않습니다.
          </td>
        </tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        오류를 생성한 요청에 사용된 <InlinePopover type="licenseKey" /> 의 처음 6자입니다.
      </td>
    </tr>
