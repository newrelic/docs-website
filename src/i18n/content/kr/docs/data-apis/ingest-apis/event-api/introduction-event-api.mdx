...
1. 데이터를 보고할 계정의 [라이선스 키를](/docs/apis/intro-apis/new-relic-api-keys/#license-key) 받습니다.
...
* `Api-Key` 에는 올바른 [라이센스 키가](/docs/apis/intro-apis/new-relic-api-keys/#license-key)포함되어 있습니다.
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            키 누락 또는 유효하지 않음: 유효하지 않은 라이센스 키입니다. 유효한 [라이센스 키를](/docs/apis/intro-apis/new-relic-api-keys/#license-key)등록하십시오. `License` 유형의 키를 사용해야 합니다. `Browser` , `Mobile` 또는 `User` 키는 작동하지 않습니다.
          </td>
        </tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        오류를 생성한 요청에 사용된 [라이센스 키](/docs/apis/intro-apis/new-relic-api-keys/#license-key) 의 처음 6자입니다.
      </td>
    </tr>
