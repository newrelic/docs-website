...
APM의 일부 차트에는 [해당 차트를 생성한 NRQL 쿼리를 볼](/docs/query-your-data/nrql-new-relic-query-language/get-started/introduction-nrql-new-relics-query-language) 수 있는 옵션이 있습니다. 이는 메트릭을 쿼리하는 방법을 이해하기 위한 좋은 출발점입니다. 아래 NRQL 쿼리는 <InlinePopover type="apm" />요약 페이지의 오류율 차트에서 약간 수정되었습니다.
