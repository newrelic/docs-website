...
메트릭 유형은 더 긴 기간 동안 데이터가 집계되는 방식을 결정하고 메트릭 유형의 사용 가능한 [필드](/docs/query-your-data/nrql-new-relic-query-language/get-started/nrql-syntax-clauses-functions/#func-getfield) 및 기능을 결정합니다.
