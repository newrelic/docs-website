...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        위에서 설명한 `count` 유형과 동일하지만 추가로 누적 측정항목 필드에 대한 액세스를 제공합니다. 이 기능은 현재 미리 보기 상태입니다. 이에 대한 자세한 내용은 [누적 메트릭](/docs/data-apis/understand-data/metric-data/cumulative-metrics) 을 참조하십시오. <Callout variant="important">누적 값은 이것을 일반적인 `count` 보다 약간 크게 만들 수 있으므로 [데이터 수집](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/data-ingest-billing) 에 추가될 수 있습니다.</Callout>
      </td>
