...
[NRQL](/docs/query-your-data/nrql-new-relic-query-language/get-started/introduction-nrql-new-relics-query-language) 을 사용하여 `NrIntegrationError` 이벤트를 쿼리하고 문제가 발생할 때 알림을 받도록 [NRQL 경고 조건](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/nrql-alert-conditions) 을 설정할 수 있습니다.
