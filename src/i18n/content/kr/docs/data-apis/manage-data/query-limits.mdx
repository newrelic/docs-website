...
다음 NRQL 쿼리를 사용하여 경고를 만들 수 있습니다. [여기에서 NRQL 쿼리](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/nrql-alert-conditions/#create) 로 경고를 만드는 방법에 대해 알아보세요.
