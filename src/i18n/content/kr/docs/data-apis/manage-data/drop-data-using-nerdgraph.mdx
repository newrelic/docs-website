...
* New Relic One 사용자 모델: "NRQL 삭제 규칙" [기능](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts/#capabilities) 이 있는 역할을 할당받아야 합니다.
...
* 다음 주의 사항이 있는 [차원 측정항목](/docs/telemetry-data-platform/ingest-manage-data/understand-data/new-relic-data-types#dimensional-metrics) :
  ...
  * 청구 영향: [New Relic One 가격 책정](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing) 의 경우 삭제된 데이터는 청구할 수 없습니다. [원래 가격](/docs/accounts/original-accounts-billing/product-pricing/product-based-pricing) 의 경우 삭제된 데이터에 대해 청구할 수 있습니다.
...
* 복잡한 조직의 데이터 수집 관리에 대한 자세한 내용은 [데이터 수집 거버넌스](/docs/new-relic-solutions/observability-maturity/operational-efficiency/dg-intro) 를 참조하세요.