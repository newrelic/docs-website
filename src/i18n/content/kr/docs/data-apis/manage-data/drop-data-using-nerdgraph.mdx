...
드롭 필터 규칙을 만들고 편집하는 기능은 [`NRQL drop rules` 기능](/docs/accounts/accounts-billing/new-relic-one-user-management/user-capabilities#insights)에 연결되어 있습니다.
...
NerdGraph API 탐색기( **[one.newrelic.com](https://one.newrelic.com) > Apps > NerdGraph API explorer**) 에서 호출을 구성하고 만들 수 있습니다.
