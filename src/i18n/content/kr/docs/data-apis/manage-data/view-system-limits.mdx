...
한도 UI를 찾으려면 [사용자 메뉴](/docs/accounts/accounts-billing/general-account-settings/intro-account-settings) 에서 <DoNotTranslate>**Manage your data**</DoNotTranslate> 클릭하고 <DoNotTranslate>**Limits**</DoNotTranslate> 클릭합니다.
