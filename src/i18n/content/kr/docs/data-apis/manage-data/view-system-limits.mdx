...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        [메트릭 타임슬라이스 데이터](/docs/telemetry-data-platform/ingest-manage-data/understand-data/new-relic-data-types#timeslice-data) 비율(APM, 브라우저, <InlinePopover type="mobile"/>)
      </td>
