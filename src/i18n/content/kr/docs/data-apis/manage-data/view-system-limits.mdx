...
import dataLimitsUi from 'images/data-limits-ui.png'
...
한도 UI를 찾으려면 [계정 드롭다운](/docs/glossary/glossary/#account-dropdown) 에서 **데이터 관리** 를 클릭하고 **한도** 를 클릭합니다.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [추적 한계](/docs/distributed-tracing/concepts/how-new-relic-distributed-tracing-works) 를 참조하십시오.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        * NRDB 레코드\* 검사: 계정당 시간당 1,000억
        * 쿼리 비율: 초당 계정당 20
        * [다른 쿼리 제한](/docs/query-your-data/nrql-new-relic-query-language/get-started/rate-limits-nrql-queries) 보기
      </td>
    </tr>
  </tbody>
</table>
