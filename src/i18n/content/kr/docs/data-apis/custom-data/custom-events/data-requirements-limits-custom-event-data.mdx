  ...
  <tbody>
    ...
    <tr id="prohibited-eventType">
      ...
      <td>
        ...
        * `Entity`, `EntityUpdate` 및 `Entity[0-9]` 접두사가 있는 문자열(예: `Entity2` 또는 `Entity1HOUR` ).

        * `EntityRelationship`, `RelationshipUpdate` 및 `Relationship[0-9]` 로 접두사가 붙은 문자열(예: `Relationship2` 또는 `Relationship1HOUR`)
