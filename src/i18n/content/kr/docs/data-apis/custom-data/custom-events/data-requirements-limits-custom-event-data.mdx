...
* <InlinePopover type="apm">[](/docs/insights/insights-data-sources/custom-data/insert-custom-events-new-relic-apm-agents)</InlinePopover>
  ...
  [에이전트 API](/docs/insights/insights-data-sources/custom-data/insert-custom-events-new-relic-apm-agents)

* [이벤트 API](/docs/insights/insights-data-sources/custom-data/send-custom-events-event-api) (이벤트 API 사용 시 추가 요구 사항이 있습니다.)

* [에이전트 API 및 ](/docs/insights/insights-data-sources/custom-data/insert-data-via-new-relic-browser)
  ...
  (맞춤 `PageAction` 이벤트에는 추가 요구사항이 있습니다.)
