...
<CollapserGroup>
  ...
  <Collapser className="freq-link" id="php-att" title="PHP">
    ...
    기본적으로 분당 기록되는 최대 맞춤형 대시보드 수는 30,000개입니다. [newrelic.custom\_events.max\_samples\_stored](/docs/apm/agents/php-agent/configuration/php-agent-configuration/#inivar-custom-events-maxsamples) 를 통해 최대 100,000까지 늘릴 수 있습니다. 구성 설정.
