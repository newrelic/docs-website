...
* [**iOS 방법:**](/docs/mobile-monitoring/new-relic-mobile-ios/ios-sdk-api/setmaxeventbuffertime-ios-sdk-api)

  ```
  + (void) setMaxEventBufferTime:(unsigned int)seconds;
  ```

* [**안드로이드 방법** :](/docs/mobile-monitoring/new-relic-mobile-android/android-sdk-api/setmaxeventbuffertime-android-agent-api)
