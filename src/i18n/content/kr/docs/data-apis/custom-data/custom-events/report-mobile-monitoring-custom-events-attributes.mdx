...
New Relic의 [모바일 모니터링](/docs/mobile-monitoring/new-relic-mobile/getting-started/introduction-new-relic-mobile) 은 상호 작용, 세션, 충돌 및 요청 오류에 대한 데이터와 같은 일부 [기본 이벤트 데이터](/docs/insights/insights-data-sources/default-data/mobile-default-events-insights) 를 모바일 앱에서 New Relic으로 보냅니다. 더 자세한 쿼리 및 분석을 위해 고유한 사용자 정의 속성 및 이벤트를 생성할 수도 있습니다.

## 사용자 정의 속성 및 이벤트 생성 [#custom-attributes-instructions]

모바일 에이전트 SDK를 사용하여 기본 모바일 모니터링 이벤트에 대한 사용자 정의 세션 수준 속성을 생성할 수 있습니다. 예를 들어 iOS 또는 Android 앱의 일부에 대한 `username` 속성을 기록하려면 `setAttribute` API( [Android](/docs/mobile-monitoring/new-relic-mobile-android/android-sdk-api/set-attribute) \| [iOS](/docs/mobile-monitoring/new-relic-mobile-ios/ios-sdk-api/set-attribute) )를 사용합니다. 이러한 속성은 세션 관련 정보이며 여러 모바일 이벤트 유형에서 공유됩니다.

`recordCustomEvent` API( [Android](/docs/mobile-monitoring/new-relic-mobile-android/android-sdk-api/recordcustomevent-android-sdk-api) \| [iOS](/docs/mobile-monitoring/new-relic-mobile-ios/ios-sdk-api/recordcustomevent-ios-sdk-api) )를 사용하여 완전히 새로운 맞춤 이벤트 유형을 만들고 고유한 맞춤 속성을 할당할 수도 있습니다.
...
* [안드로이드 SDK API 가이드](/docs/mobile-monitoring/mobile-sdk-api/new-relic-mobile-sdk-api/working-android-sdk-api)
* [iOS SDK API 가이드](/docs/mobile-monitoring/mobile-sdk-api/new-relic-mobile-sdk-api/working-ios-sdk-api)
* [NRQL 쿼리 예](#examples)
...
에이전트가 이벤트를 메모리에 저장하는 최대 시간(초)을 설정하려면 다음 SDK 호출을 사용하십시오.

* [아이폰 OS 방법](/docs/mobile-monitoring/new-relic-mobile-ios/ios-sdk-api/setmaxeventbuffertime-ios-sdk-api):

  ```
  + (void) setMaxEventBufferTime:(unsigned int)seconds;
  ```

* [안드로이드 방식](/docs/mobile-monitoring/new-relic-mobile-android/android-sdk-api/setmaxeventbuffertime-android-agent-api):
