...
## 브라우저 모니터링: 사용자 정의 속성 기록 [#collecting_browser][#collecting_browser]
...
## 인프라 모니터링: 사용자 정의 속성 기록 [#collecting_browser][#collecting_browser]
...
## 모바일 모니터링: 사용자 정의 속성 기록 [#collecting_mobile][#collecting_mobile]
