...
iOS 및 Android용 공식 New Relic Cordova 플러그인을 사용하면 개발자가 모바일 에이전트를 [Cordova 애플리케이션](http://cordova.apache.org/) 에 쉽게 임베드할 수 있습니다. JavaScript로 작성된 플러그인은 New Relic의 기본 에이전트를 자동으로 포함하여 모바일 모니터링 및 성능 가시성을 제공합니다.
