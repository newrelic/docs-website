...
<Steps>
  <Step>
    ...
    1. **[one.newrelic.com](https://onenr.io/02wdd6ngXwE) > Browser & Mobile > (Android 또는 iOS 선택)** 로 이동한 다음 UI에서 계측 단계를 완료하세요.
