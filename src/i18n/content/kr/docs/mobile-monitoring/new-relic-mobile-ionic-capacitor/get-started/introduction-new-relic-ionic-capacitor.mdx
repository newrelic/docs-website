...
<Steps>
  <Step>
    ...
    1. <DNT>**[one.newrelic.com](https://onenr.io/0EjOpynz0Q6) > Browser & Mobile > (choose Android or iOS)**</DNT>
...
<CollapserGroup>
  ...
  >
    ...
    4. <DNT>**Add to dashboard**</DNT> 클릭합니다.<img title="Query builder" alt="This is an image of a sample query in the Query builder." src={mobileQueryExample}/>
