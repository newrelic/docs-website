...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile > (select an app) > Summary**</DoNotTranslate>: React Native 에이전트는 하이브리드 앱의 충돌 데이터, 네트워크 트래픽 및 기타 정보를 분석할 수 있는 뉴렐릭으로 데이터를 보냅니다.
</figcaption>
...
<Steps>
  ...
  <Step>
    ...
    1. <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile > (select your mobile app) > Settings**</DoNotTranslate>
...
<CollapserGroup>
  <Collapser
    id="v1.2.0"
    title="React Native 에이전트 버전 1.2.0 이상"
  >
  ...
  <Collapser
    id="v1.1.0"
    title="React Native 에이전트 버전 1.1.0 이하"
  >
    ...
    2. <DoNotTranslate>**Query your data**</DoNotTranslate>을 클릭합니다.
    ...
    4. <DoNotTranslate>**Add to dashboard**</DoNotTranslate>를 클릭합니다.<img title="Query your data" alt="This is an image of a sample query in the Query builder." src={mobileQueryExample}/>

       <figcaption>
         <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Query your data**</DoNotTranslate>: <DoNotTranslate>**Query builder**</DoNotTranslate>를 사용하여 React 앱에서 JavaScript 오류를 추적하기 위한 커스텀 대시보드를 생성합니다.
       </figcaption>
...
뉴렐릭에서 JavaScript 콘솔 로그를 보려면 <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Query your data**</DoNotTranslate>으로 이동하여 다음 쿼리를 추가하고 해당 JavaScript 콘솔 로그를 식별합니다.
