...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        에이전트 버전별 최소 지원 iOS 버전:

        * 에이전트 버전 7.7.7 이상: iOS 15.0 이상
        * 에이전트 버전 7.6.2 ～7.7.6: iOS 15.6 이상
        * 에이전트 버전 7.6.0 및 7.6.1: iOS 16 이상
        * 7.6.0 이전 에이전트 버전: iOS 10 이상, iOS 15.0～15.5 제외

        <Callout variant="important">
          에이전트 버전 7.7.7 이상만 iOS 15.0부터 iOS 15.5까지 지원합니다. 이전의 모든 에이전트 버전은 해당 OS 버전과 완전히 호환되지 않습니다. 앱이 해당 버전 중 하나라도 지원하는 경우 에이전트 버전 7.7.7 이상을 사용하십시오.
        </Callout>
