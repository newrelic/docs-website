...
<Callout variant="important">
  이 기능은 Swift 코드와 함께 사용하면 안 됩니다. Swift 코드에서 처리된 오류를 추적하려면 [recordError를](/docs/mobile-monitoring/new-relic-mobile-ios/ios-sdk-api/recorderror-ios-sdk-api) 사용하세요.
</Callout>
