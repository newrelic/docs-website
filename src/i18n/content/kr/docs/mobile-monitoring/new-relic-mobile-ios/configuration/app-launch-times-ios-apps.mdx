...
iOS 에이전트를 사용하면 "콜드 타임" 및 "핫 타임"이라고도 알려진 앱 설치 시간을 보고할 수 있습니다(웜 시간 및 예열 시간은 보고되지 않음). 기본적으로 앱 설치 시간은 기능 플래그 [`NRFeatureFlag_AppStartMetrics`](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/configure-settings/#ios-applaunchtime) 를 통해 수집됩니다.
