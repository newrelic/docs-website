...
* <DNT>
  ...
  [페이지](/docs/mobile-monitoring/mobile-monitoring-ui/crashes/mobile-apps-crash-report-dashboard) 에 배너 경고가 나타납니다. 경고 내용은 다음과 같습니다.
...
* <DNT>
  ...
  페이지의 충돌 스택 추적은 사람이 읽을 수 있는 오류 메시지가 아닌 기계어 코드를 표시합니다.
...
4. <DNT>
   ...
   클릭합니다. dSYM을 직접 끌어서 놓거나 컴퓨터에서 파일을 선택할 수 있습니다.
