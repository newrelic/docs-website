...
New Relic은 [iOS 에이전트의 설치 프로세스](/docs/mobile-monitoring/mobile-monitoring-installation/getting-started/ios-installation-configuration) 및 [tvOS 에이전트의 설치 프로세스](/docs/mobile-monitoring/new-relic-mobile-ios/get-started/tvos-installation-configuration) 의 일부로 빌드 후 스크립트를 제공합니다. 이 스크립트는 앱의 dSYM 파일을 자동으로 업로드합니다.
...
자동 스크립트는 Python 2를 사용합니다. 2019년 10월 [macOS 10.15(Catalina)](https://developer.apple.com/documentation/macos_release_notes/macos_catalina_10_15_beta_10_release_notes#3318248) 부터 Python은 기본적으로 설치되지 않습니다. 자동 스크립트(권장)를 사용하는 경우 [Python 2](https://www.python.org/downloads/mac-osx/) 를 수동으로 설치해야 할 수 있습니다. Homebrew를 사용하는 경우 Homebrew의 [Python을](https://docs.brew.sh/Homebrew-and-Python) 참조하십시오.
