...
이 절차는 Cocoapods를 사용하는 tvOS 앱에만 적용됩니다. 다른 모든 유형의 tvOS 앱에 대해서는 [tvOS 설치 및 구성](/docs/mobile-monitoring/new-relic-mobile-ios/tvos/new-relic-tvos-compatibility-requirements) 을 참조하십시오.
