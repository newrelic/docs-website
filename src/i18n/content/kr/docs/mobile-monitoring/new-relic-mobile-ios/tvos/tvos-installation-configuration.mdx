...
몇 분 안에 iOS 앱에 대한 데이터가 표시되기 시작합니다. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Mobile > (선택한 앱)** 으로 이동합니다. 그렇지 않은 경우 [데이터가 표시되지 않음](/docs/mobile-monitoring/mobile-monitoring-installation/ios/no-data-appears-ios) 을 참조하십시오.
