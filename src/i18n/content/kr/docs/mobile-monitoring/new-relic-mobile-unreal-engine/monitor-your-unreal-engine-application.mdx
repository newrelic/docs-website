...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile > (select an app) > Summary**</DoNotTranslate>: Unreal Engine 데이터 및 오류를 확인하고 시간 경과에 따른 앱 성능을 모니터링하세요.
</figcaption>
...
<Steps>
  ...
  <Step>
    ...
    2. [Github에`NewRelic` 폴더를](https://github.com/ndesai-newrelic/newrelic-unreal-plugin/tree/master/Plugins/NewRelic) 복사합니다. 당신은 다음과 같은 것을 가져야합니다
...
3. <DoNotTranslate>**Exceptions > Handled exceptions**</DoNotTranslate>
