...
## (선택 사항) Flutter 에이전트 계측 사용자 지정 [#customize-instrumentation]
...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="레코드 메트릭"
  >
    **[recordMetric](/docs/mobile-monitoring/new-relic-mobile-android/android-sdk-api/recordmetric-android-sdk-api/)(문자열 이름, 문자열 범주, int? 값, 문자열? countUnit, 문자열? valueUnit): 무효;**

    사용자 지정 메트릭(임의의 숫자 데이터)을 기록합니다. 여기서 countUnit은 메트릭 개수의 측정 단위이고 valueUnit은 메트릭 값의 측정 단위입니다. countUnit 또는 valueUnit을 사용하는 경우 value, countUnit 및 valueUnit을 모두 설정해야 합니다.
  ...
  <Collapser
    ...
    title="에이전트 종료"
  >
    **[종료](/docs/mobile-monitoring/new-relic-mobile-android/android-sdk-api/shut-down/)(): 무효;**
