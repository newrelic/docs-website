...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Mobile > (앱 선택) > Exceptions > Handled exceptions > (예외 선택) > Occurrences:** 스레드 세부 정보를 사용하여 처리된 예외에 대한 스택 추적의 패턴을 추가로 검사합니다.
</figcaption>
