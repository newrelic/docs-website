...
2. <DNT>
   ...
   [테이블](/docs/mobile-monitoring/mobile-monitoring-ui/crashes/view-mobile-app-crashes) 에서 임의의 행을 선택합니다.
...
3. 선택한 충돌 보고서의
   ...
   [페이지](/docs/mobile-monitoring/mobile-monitoring-ui/crashes/investigate-mobile-app-crash-report#viewing) 에서 속성 목록의 `App Image Uuid` 을 찾으세요.
...
2. 내보낸 충돌 보고서의
   ...
   [섹션](#binary-example) 에서 빌드 UUID를 찾습니다.
