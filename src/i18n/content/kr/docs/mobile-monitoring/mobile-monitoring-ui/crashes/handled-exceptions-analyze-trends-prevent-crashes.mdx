...
import mobileHandledExceptionsOccurrences from 'images/mobile_screenshot-full_handled-exception-occurrences.png'
...
**처리된 예외** 기능은 열악한 모바일 애플리케이션 경험에 기여하는 중요한 요소를 식별하고 필터링 가능한 데이터를 사용하여 해결 방법을 더 빨리 찾을 수 있도록 도와줍니다. 또한 [처리된 예외 API를](#hex-api) 사용하여 보내는 데이터를 사용자 지정하고 NRQL을 사용하여 데이터를 쿼리하고 공유할 수 있습니다.
