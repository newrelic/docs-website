...
<CollapserGroup>
  ...
  >
    ...
    * 다른 과거 패턴을 찾으려면 선택한 [기간](#time-period) 을 변경하세요.
      ...
      <figcaption>
        **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Mobile > (앱 선택) > Exceptions > Crash analysis:** 다음은 **충돌 위치** 그룹으로 필터링된 **상위 5개 발생** 차트의 예입니다. 그룹이나 필터를 선택하여 원하는 방식으로 충돌 데이터를 분석하세요.
      </figcaption>
  </Collapser>
