...
<CollapserGroup>
  ...
  >
    ...
    * 티켓을 제출하고 충돌을 해결하십시오.
      ...
      <figcaption>
        **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Mobile > (앱 선택) > Crashes > Crash type > (충돌 선택) > (아래로 스크롤하여 **Stack trace and interaction trail**):** 이것은 재기호화 옵션이 포함된 상호 작용 추적의 예입니다. 충돌 발생. Xcode를 사용하여 소스 코드를 분석하고 디버그하려면 **Export crash details** 를 선택합니다.
      </figcaption>
  </Collapser>
</CollapserGroup>
