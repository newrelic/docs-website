...
모든 계측된 방법의 전체 목록을 표시하려면 다음과 같이 하십시오. 선택한 복합체합성에서 **Breakdown table** \[분석표] 링크를 선택합니다. 지표에 대해 관습 측정을 사용하는 경우 클래스 및 메서드 이름의 범주는 **custom** 을 나타냅니다.
...
* 데이터에 대한 컨텍스트를 제공하려면 **Previous interaction** \[이전의 블록결합을] 클릭하세요.