...
1. <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com) > Add data > Mobile > Android**</DoNotTranslate>
...
7. Android 앱의 데이터를 확인합니다. <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile > (select an app)**</DoNotTranslate>으로 이동합니다.
