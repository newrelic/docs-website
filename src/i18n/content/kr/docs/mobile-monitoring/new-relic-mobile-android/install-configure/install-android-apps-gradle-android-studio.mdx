...
9. 몇 분 기다렸다가 [**요약** 페이지](/docs/mobile-monitoring/mobile-monitoring-ui/mobile-app-pages/mobile-apps-overview-page) 에서 Android 앱에 대한 데이터를 봅니다. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Mobile > (앱 선택)**으로 이동합니다.
