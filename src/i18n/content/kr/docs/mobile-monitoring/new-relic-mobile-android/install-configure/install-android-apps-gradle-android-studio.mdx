...
* 기존 Android 설치를 업그레이드하려면: **[one.newrelic.com](https://one.newrelic.com) > Mobile > (앱 선택) > Settings > Installation** 로 이동합니다.
...
9. 몇 분 기다렸다가 [**요약** 페이지](/docs/mobile-monitoring/mobile-monitoring-ui/mobile-app-pages/mobile-apps-overview-page) 에서 Android 앱에 대한 데이터를 봅니다. **[one.newrelic.com](https://one.newrelic.com) > Mobile > (앱 선택)으로** 이동합니다.
...
Android 에이전트를 최신 상태로 유지하려면 절차에 따라 New Relic용 [Android 에이전트 SDK를 업그레이드하십시오](/docs/mobile-monitoring/new-relic-mobile-android/install-configure/upgrading-new-relic-mobiles-android-sdk) . 모바일 앱용 최신 Android 버전을 설치하려면: **[one.newrelic.com](https://one.newrelic.com) > Mobile > (앱 선택) > Settings > Installation** 로 이동합니다.
