...
기본적으로, <InlinePopover type="mobile"/>모바일 애플리케이션에 대한 충돌 보고를 활성화하여 충돌을 추적하고 진단하는 데 도움을 줍니다. Android 애플리케이션이 충돌하면 에이전트는 충돌 보고서를 New Relic [수집기](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#collector) 에 업로드합니다. ProGuard 또는 DexGuard를 사용하는 경우 충돌 세부 정보가 자동으로 처리되고 난독 해제됩니다.
