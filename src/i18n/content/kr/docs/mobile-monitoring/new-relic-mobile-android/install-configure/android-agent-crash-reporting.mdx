...
* [<DNT>**Crashes**</DNT> 페이지](/docs/mobile-monitoring/mobile-monitoring-ui/crashes/mobile-apps-crashes-dashboard) 에 난독화된 충돌 보고서가 표시되면 `mapping.txt` 파일을 업로드하지 않은 것일 수 있습니다.
