...
<Callout variant="important">
  New Relic [Android 에이전트 버전 6.9.2](/docs/release-notes/mobile-release-notes/android-release-notes/android-692) 부터 `noticeNetworkFailure` 메서드는 더 이상 사용되지 않습니다. `noticeNetworkFailure` 메서드는 버전 6.9.0 이하에서 계속 작동하지만 앱에 `noticeNetworkFailure` 메서드가 포함된 경우에는 이를[noticeHttpTransaction](/docs/mobile-monitoring/new-relic-mobile-android/android-sdk-api/notice-http-transaction/) 으로 대체할 것을 권장합니다.
</Callout>
