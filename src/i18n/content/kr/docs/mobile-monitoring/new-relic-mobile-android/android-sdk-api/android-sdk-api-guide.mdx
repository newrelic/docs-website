...
2. **[one.newrelic.com](https://one.newrelic.com/all-capabilities)** 으로 이동, **데이터 추가** 를 클릭한 다음 Android용 단계를 따릅니다.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [`shutdown`](/docs/mobile-monitoring/new-relic-mobile-android/android-sdk-api/shut-down)) 참조하십시오.
      </td>
    </tr>
  </tbody>
</table>
