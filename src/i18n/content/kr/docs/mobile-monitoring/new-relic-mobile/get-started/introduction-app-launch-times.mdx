...
iOS 에이전트 버전 7.4.0부터, New Relic은 콜드 시작 시간과 핫 시작 시간을 자동으로 보고합니다. 참고: 예열 및 예열 시간은 보고되지 않습니다. 이 [지침을](/docs/mobile-monitoring/new-relic-mobile-ios/configuration/app-launch-times-ios-apps)참조하십시오.