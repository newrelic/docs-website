...
뉴렐릭을 설치하면 <InlinePopover type="mobile"/>기능이 iOS 또는 Android 앱의 일부가 됩니다. 이러한 기능은 애플리케이션의 "샌드박스" 내에 있으므로 모바일 앱의 성능 데이터 외에는 어떤 것도 액세스할 수 없습니다. 당사는 배터리 잔량 등 기기 자체에 대한 성능 데이터를 수집하지 않습니다.
...
* <DNT>
  ...
  API를 사용하여 수집 및 크래시 수집기 데이터 엔드포인트의 URI 권한을 지정할 수 있습니다. 자세한 내용은 [Android 에이전트 설정 및 기능 플래그 문서를](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/configure-settings/) 참조하세요.

* <DNT>
    **iOS:**
  </DNT>

  자세한 내용은 [iOS 에이전트 설정 및 기능 플래그 문서를](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/configure-settings/) 참조하세요.
