...
<Tabs>
  ...
  <TabsPages>
      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td>
              필수의. 에이전트가 이벤트를 메모리에 저장할 수 있는 최대 시간(초). 기본값 하베스트 길이는 60초입니다.
            </td>
          </tr>
        </tbody>
      </table>
    ...
    <TabsPageItem id="ios">
      ...
      이벤트 하베스트 길이를 설정합니다. 기본값은 60초입니다.
    ...
    <TabsPageItem id="capacitor">
      ...
      이벤트 하베스트 길이를 설정합니다. 기본값은 60초(1분)입니다. 최소값은 60초보다 작을 수 없습니다. 최대값은 600초를 초과해서는 안 됩니다.
