  ...
  <TabsPages>
    <TabsPageItem id="android">
      ...
      * <DoNotTranslate>**Do not use `eventType` to name your custom events.**</DoNotTranslate>
        ...
        이벤트 이름을 지정하는 속성을 생성하거나 선택적 `name` 보고서를 사용합니다. 다양한 맞춤형 대시보드를 만들 수 있습니다. 제한해야 하는 것은 이벤트 유형뿐입니다.
      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td>
              필수의. 이벤트 유형입니다. <DoNotTranslate>**Do not**</DoNotTranslate> `$eventType` 사용하여 맞춤형 대시보드 이름을 지정합니다. 대신 사용자 정의 속성이나 선택적 `name` 사용하세요.
            </td>
          </tr>
