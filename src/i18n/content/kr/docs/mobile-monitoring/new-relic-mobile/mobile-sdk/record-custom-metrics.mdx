...
<Tabs>
  ...
  <TabsPages>
    ...
    <TabsPageItem id="ios">
      ...
      이 메소드는 개수가 1이고 총 값이 전달된 값과 동일한 `Custom/[Category]/[Name]` 형식의 측정항목을 기록합니다. 여러 번의 호출은 [다음에 대한 표준 측정항목 집계 규칙 에 따라 개수와 값을 집계합니다. <InlinePopover type="mobile"/>](/docs/mobile-monitoring/new-relic-mobile/getting-started/mobile-data-retention).
