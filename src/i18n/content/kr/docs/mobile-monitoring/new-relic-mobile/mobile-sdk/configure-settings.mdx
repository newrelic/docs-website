...
<Tabs>
  ...
  <TabsPages>
    <TabsPageItem id="android">
      ...
      * `.with` 메서드를 사용하여 에이전트 시작 호출의 일부로 설정을 변경합니다. 예를 들어:
        ...
        <table>
          ...
          <tr>
            <td>
              이벤트 데이터 수집을 활성화하거나 비활성화합니다. 이러한 이벤트는 [NRQL로](/docs/insights/explore-data/attributes/mobile-default-attributes-insights) 쿼리하고 [<DNT>**Crash analysis**</DNT> 페이지](/docs/mobile-monitoring/mobile-monitoring-ui/crashes/crash-analysis-group-filter-your-crashes) 에서 사용할 수 있습니다.
          ...
          <tr>
            <td>
              이벤트 데이터 보고를 활성화하거나 비활성화합니다. 이벤트 <DNT>**collection**</DNT> 은(는) 계속 발생하지만 해당 이벤트는 수집기로 전송되지 않습니다. 수집을 비활성화하고 싶지만 에이전트가 수집한 내용을 계속 볼 수 있는 경우 `withAnalyticsEvents` 대신 이를 사용하기로 결정할 수 있습니다.
        ...
        ## 오프라인 저장 [#android-offline-storage]
          ...
          <tbody>
            <tr>
              <td>
                ...
                오프라인 저장소의 양을 구성하려면 [최대 오프라인 저장소 크기 설정을](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/set-max-offline-storage) 참조하세요.
              </td>
        ...
        ## 배경보고 [#android-background-reporting]
        ...
        ## ApplicationExitInfo 보고 [#android-applicationexitinfo-reporting]
      ...
      * 빠른:
        ...
        <table>
          ...
          <tbody>
            <tr>
              <td>
                [<DNT>**Crash analysis**</DNT> 페이지](/docs/mobile-monitoring/mobile-monitoring-ui/crashes/crash-analysis-group-filter-your-crashes) 에 표시되는 충돌 보고를 활성화 또는 비활성화합니다.

                수집 데이터 업로드 끝점의 URI 기관 구성 요소를 지정합니다. 이 엔드포인트는 처리된 예외 업로드에도 사용됩니다.

                데이터 수집을 보고할 때 에이전트가 사용할 데이터 끝점을 바꾸려면 `NewRelic.start(withApplicationToken:)` 메서드 호출에 `andCollectorAddress:` 추가하세요.
            ...
            <tr>
              <td>
                ...
                비정상 종료를 보고할 때 에이전트가 사용할 데이터 엔드포인트를 바꾸려면 `NewRelic.start(withApplicationToken:)` 메서드 호출에 `andCrashCollectorAddress:` 추가하세요.
        ...
        <table>
          ...
          <tbody>
            <tr>
              <td>
                기본 소스화된 클래스 및 메서드에 대해서만 캡슐화 추적을 활성화하거나 비활성화합니다. 맞춤 상호작용이 보고됩니다. The Traces는 [<DNT>**Interactions**</DNT> 페이지](/docs/mobile-monitoring/mobile-monitoring-ui/mobile-app-pages/interactions-page) 에 나타납니다.
            ...
            <tr>
              <td>
                [<DNT>**Interactions**</DNT> 페이지](/docs/mobile-monitoring/mobile-monitoring-ui/mobile-app-pages/interactions-page) 에 표시되는 상호작용 추적을 전역적으로 활성화하거나 비활성화합니다.

                에이전트가 시작된 후에는 상호작용 추적이 비활성화됩니다. 에이전트를 시작하기 전에 실행된 활동이나 메소드에 대한 상호작용은 계속해서 <DNT>**Interactions**</DNT> 페이지에 나타날 수 있습니다.
            ...
            <tr>
              <td>
                ...
                Swift 코드에 대한 확장 결합 추적을 활성화하거나 비활성화합니다. 트레이스는 [<DNT>**Interactions**</DNT> 페이지](/docs/mobile-monitoring/mobile-monitoring-ui/mobile-app-pages/interactions-page) 에 나타납니다. [`NRFeatureFlag_InteractionTracing`](#interactionTracing) 비활성화되면 이 기능은 항상 비활성화됩니다.
            ...
            <tr>
              <td>
                ...
                * 핫 타임은 앱이 백그라운드에서 실행되고 첫 번째 그리기까지 재개되는 데 걸리는 시간을 나타냅니다.
                  ...
                  기본값은 `true` 입니다(에이전트 버전 7.4.0 기준).
              </td>
        ...
        <table>
          ...
          <tbody>
            <tr>
              <td>
                인터넷 연결을 사용할 수 없을 때 오프라인 데이터 저장소를 활성화하거나 비활성화합니다. 오프라인 저장소의 양을 구성하려면 [최대 오프라인 저장소 크기 설정을](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/set-max-offline-storage/#ios) 참조하세요.
              </td>
          ...
          <tbody>
            <tr>
              ...
              <td>
                ...
                백그라운드 계측을 사용하기 위한 iOS 앱 프로젝트의 전제 조건:

                * 앱 번들 ID가 포함된 항목을 포함하여 다시와 함께 키 `Permitted background task scheduler identifiers` (를) 추가하세요.
                * Xcode 프로젝트 기능의 **Background Fetch** \[배경 모드] 섹션에서 **Background Processing** \[배경 가져오기] 및 **Background Modes** \[배경 처리를] 활성화합니다.
    ...
    <TabsPageItem id="capacitor">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td>
              인터넷 연결을 사용할 수 없을 때 오프라인 데이터 저장소를 활성화하거나 비활성화합니다. 오프라인 저장소의 양을 구성하려면 [최대 오프라인 저장소 크기 설정을](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/set-max-offline-storage/#capacitor) 참조하세요.
            </td>

            <td>
              오프라인 저장소는 기본적으로 활성화되어 있습니다. 이를 비활성화하려면 다음 기능 플래그를 추가하십시오.
          ...
          <tr>
            ...
            <td>
              ...
              * 앱의 `Info.plist` 파일에 '허용된 백그라운드 작업 스케줄러 식별자' 키를 추가하세요. 이 키는 앱의 번들 제외인 단일 문자열 값을 포함하는 제외여야 합니다.
              * Xcode 프로젝트 기능의 **Background Modes** 섹션에서 **Background Fetch** 및 **Background Process** 를 활성화하세요.
    ...
    <TabsPageItem id="cordova">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td>
              인터넷 연결을 사용할 수 없을 때 오프라인 데이터 저장소를 활성화하거나 비활성화합니다. 오프라인 저장소의 양을 구성하려면 [최대 오프라인 저장소 크기 설정을](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/set-max-offline-storage/#cordova) 참조하세요.
            </td>
    ...
    <TabsPageItem id="maui">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td>
              인터넷 연결을 사용할 수 없을 때 오프라인 데이터 저장소를 활성화하거나 비활성화합니다. 오프라인 저장소의 양을 구성하려면 [최대 오프라인 저장소 크기 설정을](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/set-max-offline-storage/#maui) 참조하세요.
            </td>
    ...
    <TabsPageItem id="flutter">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td>
              인터넷 연결을 사용할 수 없을 때 오프라인 데이터 저장소를 활성화하거나 비활성화합니다. 오프라인 저장소의 양을 구성하려면 [최대 오프라인 저장소 크기 설정을](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/set-max-offline-storage/#flutter) 참조하세요.
            </td>
    ...
    <TabsPageItem id="react">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td>
              인터넷 연결을 사용할 수 없을 때 오프라인 데이터 저장소를 활성화하거나 비활성화합니다. 오프라인 저장소의 양을 구성하려면 [최대 오프라인 저장소 크기 설정을](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/set-max-offline-storage/#react) 참조하세요.
            </td>
    ...
    <TabsPageItem id="unity">
      ...
      1. Unity Editor를 실행하고 Unity 프로젝트를 엽니다.

      2. 메뉴 모음에서 **Tools > New Relic > Getting Started > New Relic Configuration** 선택하세요.

      3. 왼쪽 **Inspector** 창에는 기본 설정 목록이 표시됩니다. 활성화하려면 설정 옆의 확인란을 선택하고 비활성화하려면 확인란을 선택 취소하면 됩니다.
      ...
      4. **Add component** \[구성 요소 추가 를] 클릭합니다.
    </TabsPageItem>

    <TabsPageItem id="unreal">
      뉴렐릭은 Unreal Engine의 모바일 앱 모니터링을 위한 기본 설정을 제공합니다. Unreal 편집기 내에서 이러한 설정을 특정 요구 사항에 맞게 쉽게 조정할 수 있습니다.

      이러한 설정을 구성하려면:

      1. Unreal Editor를 설치하고 Unreal 프로젝트를 엽니다.
      2. 메뉴 표시줄에서 **Plugins > New Relic >** 을 선택하세요.
    ...
    <TabsPageItem id="xamarin">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td>
              인터넷 연결을 사용할 수 없을 때 오프라인 데이터 저장소를 활성화하거나 비활성화합니다. 오프라인 저장소의 양을 구성하려면 [최대 오프라인 저장소 크기 설정을](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/set-max-offline-storage/#xamarin) 참조하세요.
            </td>
