    ...
    <TabsPageItem id="android">
      ...
      * `.with` 메서드를 사용하여 에이전트 시작 호출의 일부로 설정을 변경합니다. 예를 들어:
      ...
      <table>
        ...
        <tr>
          <td>
            이벤트 데이터 수집을 활성화하거나 비활성화합니다. 이러한 이벤트는 [NRQL로](/docs/insights/explore-data/attributes/mobile-default-attributes-insights) 쿼리하고 [<DoNotTranslate>**Crash analysis**</DoNotTranslate> 페이지](/docs/mobile-monitoring/mobile-monitoring-ui/crashes/crash-analysis-group-filter-your-crashes) 에서 사용할 수 있습니다.
        ...
        <tr>
          <td>
            이벤트 데이터 보고를 활성화하거나 비활성화합니다. 이벤트 <DoNotTranslate>**collection**</DoNotTranslate> 은(는) 계속 발생하지만 해당 이벤트는 수집기로 전송되지 않습니다. 수집을 비활성화하고 싶지만 에이전트가 수집한 내용을 계속 볼 수 있는 경우 `withAnalyticsEvents` 대신 이를 사용하기로 결정할 수 있습니다.
      ...
      * 빠른:
      ...
      <table>
        ...
        <tbody>
          <tr>
            <td>
              [<DoNotTranslate>**Crash analysis**</DoNotTranslate> 페이지](/docs/mobile-monitoring/mobile-monitoring-ui/crashes/crash-analysis-group-filter-your-crashes) 에 표시되는 충돌 보고를 활성화 또는 비활성화합니다.
      ...
      <table>
        ...
        <tbody>
          <tr>
            <td>
              기본 소스화된 클래스 및 메서드에 대해서만 캡슐화 추적을 활성화하거나 비활성화합니다. 맞춤 상호작용이 보고됩니다. The Traces는 [<DoNotTranslate>**Interactions**</DoNotTranslate> 페이지](/docs/mobile-monitoring/mobile-monitoring-ui/mobile-app-pages/interactions-page) 에 나타납니다.
          ...
          <tr>
            <td>
              [<DoNotTranslate>**Interactions**</DoNotTranslate> 페이지](/docs/mobile-monitoring/mobile-monitoring-ui/mobile-app-pages/interactions-page) 에 표시되는 상호작용 추적을 전역적으로 활성화하거나 비활성화합니다.

              에이전트가 시작된 후에는 상호작용 추적이 비활성화됩니다. 에이전트를 시작하기 전에 실행된 활동이나 메소드에 대한 상호작용은 계속해서 <DoNotTranslate>**Interactions**</DoNotTranslate> 페이지에 나타날 수 있습니다.
          ...
          <tr>
            <td>
              ...
              Swift 코드에 대한 확장 결합 추적을 활성화하거나 비활성화합니다. 트레이스는 [<DoNotTranslate>**Interactions**</DoNotTranslate> 페이지](/docs/mobile-monitoring/mobile-monitoring-ui/mobile-app-pages/interactions-page) 에 나타납니다. [`NRFeatureFlag_InteractionTracing`](#interactionTracing) 비활성화되면 이 기능은 항상 비활성화됩니다.
