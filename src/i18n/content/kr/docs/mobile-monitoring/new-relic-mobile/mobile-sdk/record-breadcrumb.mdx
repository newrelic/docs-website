...
<Tabs>
  ...
  <TabsPages>
    ...
    <TabsPageItem id="ios">
      ...
      이 호출을 사용하면 `MobileBreadcrumb` 을 이벤트 유형으로 사용하여 [`recordCustomEvent` 호출을](/docs/mobile-monitoring/new-relic-mobile-ios/ios-sdk-api/recordcustomevent-ios-sdk-ap) 사용하는 것과 동일한 결과가 나타납니다. 이 API를 사용하는 방법에 대한 컨텍스트는 사용자 정의 속성 및 이벤트 전송에 대해 읽어보십시오.
