...
<Tabs>
  ...
  <TabsPages>
    ...
    <TabsPageItem id="unity">
      ...
      선택한 모든 맞춤 속성 외에도 이벤트에는 연결된 [세션 속성](/docs/insights/explore-data/attributes/mobile-default-attributes-insights#mobile-list) 도 있습니다. [`setAttribute`](docs/mobile-monitoring/new-relic-mobile/mobile-sdk/create-attribute/) 사용과 달리 탐색경로 이벤트에 속성을 추가하면 해당 이벤트에만 속성이 추가됩니다. 세션 속성이 아닙니다.
