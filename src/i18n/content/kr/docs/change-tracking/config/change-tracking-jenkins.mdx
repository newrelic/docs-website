...
1. Jenkins 작업 설정에서 <DNT>**Post-build Actions section**</DNT>으로 이동하여 <DNT>**Add post-build action**</DNT>을 클릭한 다음, <DNT>**New Relic Deployment Notifications**</DNT>를 선택합니다.
...
1. <DNT>**Plugins**</DNT> 페이지에서 <DNT>**Installed plugins**</DNT>를 클릭합니다.
