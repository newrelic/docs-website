...
1. Jenkins를 열고 <DoNotTranslate>**Manage Jenkins**</DoNotTranslate>, <DoNotTranslate>**Plugins**</DoNotTranslate>으로 이동합니다.
...
2. <DoNotTranslate>**Available plugins**</DoNotTranslate>를 클릭한 다음 `newrelic-deployment-notifier`를 검색합니다. <DoNotTranslate>**Install**</DoNotTranslate>을 클릭합니다.
   ...
   <table>
     ...
     <tbody>
       ...
       <tr>
         ...
         <td>
           배포를 수행하는 사용자입니다. <DoNotTranslate>**Tip:**</DoNotTranslate> [Build User Vars 플러그인](https://wiki.jenkins.io/display/JENKINS/Build+User+Vars+Plugin)을 설치하면 Jenkins 사용자에 관한 환경 변수를 확보할 수 있으며, 확보된 변수를 이 필드에서 사용할 수 있습니다. (예: `${BUILD_USER}`)
...
5. (선택사항) 이 Jenkins 작업이 여러 엔터티에 영향을 미치는 경우 알림 수신에도 추가할 수 있습니다. 더 많은 앱을 추가하려면 <DoNotTranslate>**Add another notification**</DoNotTranslate> 버튼을 클릭합니다.
