...
* **APM 및 대시보드의 차트:** 핀 머리가 있는 수직선이 시계열 차트에 나타납니다. <img title="A screenshot showing a deployment in a time series chart" alt="A screenshot showing a deployment in a time series chart" src={trackingDeploymentinTimeseriesChart}>이 마커는 기록된 변경 사항을 나타내며 핀 머리를 클릭하면 변경 사항이 엔터티 상태 및 품질에 미치는 영향을 자세히 살펴볼 수 있습니다.</img>
