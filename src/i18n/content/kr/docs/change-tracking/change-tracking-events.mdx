    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            부품 검색 속성을 사용하면 뉴렐릭 내에서 특정 항목을 찾을 수 있습니다. 해당 내용을 사용하여 검색할 수 있습니다. `GUID` 또는 `entityGuid` 알 수 없는 경우 다른 식별 정보를 제공하여 검색할 수 있습니다. `entityGuid` 은(는) 뉴렐릭이 측정, 축소 또는 설정 중에 분량 또는 마이크로서비스와 같은 시스템 구성 요소에 할당하는 고유한 항목입니다. 부분에 대한 자세한 내용은 [뉴렐릭 부분을](/docs/new-relic-solutions/new-relic-one/core-concepts/what-entity-new-relic/#what-is-entity) 참조하세요.
