...
GraphQL 변형을 보내 마커를 생성할 수 있는 새로운 버전의 [CLI가](/docs/new-relic-solutions/tutorials/new-relic-cli) 있습니다. CLI를 사용하고 있더라도 이 기능을 활용하려면 CLI를 업그레이드해야 합니다.

CLI를 설치하거나 업그레이드하려면 [여기](https://github.com/newrelic/newrelic-cli#installation--upgrades) 의 단계를 따르십시오.

## CLI를 사용하여 변경 마커 만들기 [#make-marker-cli]

CLI에는 다양한 옵션(아래 표시)이 있지만 `create` 명령은 특정 New Relic 엔터티에 대한 특정 변경 사항을 표시합니다.
...
* 변경 사항 쿼리: 자체 GraphQL 또는 NRQL 쿼리를 작성하여 추적 중인 변경 사항에 대한 세부 정보를 확인할 수 있습니다. 자세한 내용은 [변경 데이터 쿼리를](/docs/change-tracking/change-tracking-view-analyze/#query-deployments) 참조하세요.
