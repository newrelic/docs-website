...
* APM, 브라우저, 차트의 마커로 이러한 변경 사항을 확인하세요.

  <InlinePopover type="mobile"/>

  , 서비스 수준 관리, 사용자 정의 대시보드 및 New Relic 전반에 걸친 더 많은 경험을 제공합니다.
...
변경 추적은 단순한 배포 추적을 훨씬 뛰어 넘습니다. <InlinePopover type="apm"/>서비스. 모바일 앱, 인프라 호스트, 워크로드 등의 변경 사항을 추적할 수도 있습니다.
