...
서비스 수준 목표를 설정할 때 다음을 구성할 수 있습니다. <InlinePopover type="alerts"/>규정 준수 기간이 끝나기 전에 오류 예산이 소진될 경우 이를 알려드립니다. 이러한 경고는 비즈니스에 큰 영향을 미치는 사고가 발생한 시기를 알려줍니다. 트리거되면 우선순위가 부여되어야 하며 관련 팀을 참여시켜 문제의 원인 진단을 시작해야 합니다.
...
<figcaption>
  **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Service Levels > Choose a service level** 으로 이동한 다음 **Settings** \[설정] 옵션에서 **Alert conditions** \[경고] 조건을 클릭합니다.
</figcaption>
...
<figcaption>
  **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Service Levels > Choose a service level** 으로 이동한 다음 **Settings** \[설정] 옵션에서 **Alert conditions** \[경고 조건을] 클릭합니다. **Alert** \[경고] 버튼을 클릭하여 측면 패널을 엽니다.
</figcaption>
...
New Relic 알림은 최대 2시간의 데이터를 집계할 수 있습니다. 따라서 New Relic은 아직 느린 연소 속도에 대해 경고하는 기능을 제공하지 않습니다.
