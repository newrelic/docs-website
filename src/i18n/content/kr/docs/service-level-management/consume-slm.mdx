...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Service levels** 을 클릭하고 SLI를 선택합니다.
</figcaption>
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Service levels** 에서 SLI를 선택하고 **Automap** 을 선택합니다.
</figcaption>