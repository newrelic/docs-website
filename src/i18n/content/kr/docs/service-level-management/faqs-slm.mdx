...
* [New Relic One 사용자 모델](/docs/accounts/original-accounts-billing/original-users-roles/overview-user-models) 의 사용자는 "이벤트-메트릭 규칙 수정" [기능](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts#capabilities) 이 필요합니다.
...
SLI 쿼리는 NRDB 이벤트를 지원합니다. SLI 쿼리에 대한 차원 메트릭 지원은 로드맵에 있습니다.

## SLI 데이터에 대한 알림을 받을 수 있습니까? [#sli-alerts]

New Relic의 서비스 수준에 대한 경고는 로드맵에 있습니다.
