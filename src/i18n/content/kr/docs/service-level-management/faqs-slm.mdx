...
* [최신 사용자 모델의 사용자](/docs/accounts/original-accounts-billing/original-users-roles/overview-user-models) 는 "이벤트를 메트릭 규칙으로 수정" [기능](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts#capabilities) 이 필요합니다.
