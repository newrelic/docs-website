...
* SLM 제품에 완전히 액세스하려면 [전체 플랫폼 사용자](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type) 여야 합니다.
...
* [핵심 플랫폼 사용자](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type) 는 기능이 제한된 읽기 전용 모드로 액세스할 수 있습니다.
