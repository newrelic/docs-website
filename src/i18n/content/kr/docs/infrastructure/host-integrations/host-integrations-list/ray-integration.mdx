...
<Steps>
  ...
  <Step>
    ## Ray에 대해 `nri-prometheus` 구성 [#configure]
  ...
  <Step>
    ...
    Apache Druid 퀵스타트를 사용하고 인덱스 및 알림을 보려면 `Install now` 버튼을 클릭하여 [Ray 퀵스타트 페이지를](https://newrelic.com/instant-observability/ray) 팔로우할 수도 있습니다.
