...
<Callout title="베타 기능">
  이 기능은 현재 오픈 베타 버전이며 2021년 10월에 릴리스된 [0.0.5](https://github.com/newrelic/newrelic-prometheus-exporters-packages/releases/tag/nri-powerdns-0.0.5) 부터 시작하는 버전에만 적용됩니다.
</Callout>
...
<CollapserGroup>
  <Collapser
    ...
    title="리눅스 설치"
  >
    1. 파일 이름 `nri-powerdns` 을(를) 사용하여 [통합 설치](/docs/install-integrations-package) 지침을 따르십시오.
