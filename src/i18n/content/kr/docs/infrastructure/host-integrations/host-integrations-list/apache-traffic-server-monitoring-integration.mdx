...
Apache 통합은 TCP 연결, DNS 조회, HTTPS, SSL, 서버 및 작업자 상태와 같은 네트워크 지표를 수집합니다. 통합을 설치하려면 [가이드 설치](https://one.newrelic.com/launcher/nr1-core.explorer?pane=eyJuZXJkbGV0SWQiOiJucjEtY29yZS5saXN0aW5nIn0=&cards%5B0%5D=) 의 단계를 따르십시오. 다른 방식으로 통합을 설치해야 하는 경우 [Apache 모니터링 통합을](https://docs.newrelic.com/docs/infrastructure/host-integrations/host-integrations-list/apache-monitoring-integration/) 참조하십시오.
