...
<CollapserGroup>
  ...
  >
    ...
    5. <DoNotTranslate>**Optional**</DoNotTranslate>: Tomcat 모니터링에 관심이 있다면 다음 샘플 지표 파일을 사용하세요.
...
<DoNotTranslate>**Recommendation:**</DoNotTranslate> 다양한 응용 프로그램에서 유사한 지표에 대해 동일한 명명 체계를 사용합니다.
...
JMX 통합은 JMX 통합의 설정 보고서를 캡처합니다. 데이터는 [인벤토리 페이지](/docs/infrastructure/new-relic-infrastructure/infrastructure-ui-pages/infrastructure-inventory-page-search-your-entire-infrastructure) 의 <DoNotTranslate>**config/jmx**</DoNotTranslate> 소스 아래에서 사용할 수 있습니다. 인벤토리 데이터에 대한 자세한 내용은 [통합 데이터 이해를](/docs/infrastructure/integrations-getting-started/getting-started/understand-integration-data-data-types#inventory-data) 참조하세요.
