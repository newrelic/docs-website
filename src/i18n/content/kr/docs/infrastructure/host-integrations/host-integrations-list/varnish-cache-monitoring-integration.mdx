...
New Relic에서 통합 데이터를 찾으려면 **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > Third-party services** 로 이동하여 Varnish Cache 통합 링크 중 하나를 선택하십시오.
