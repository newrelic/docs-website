...
1. nri-aerospike를 설치하려면 아래 명령을 사용하십시오.
   ...
   * <DoNotTranslate>**Exporter**</DoNotTranslate>
     ...
     이 `/var/db/newrelic-infra/newrelic-integrations/bin` 디렉터리에 설치된 것을 볼 수 있습니다.
...
Aerospike 대시보드는 맞춤형 대시보드로 간주되며 <DoNotTranslate>**Dashboards**</DoNotTranslate> UI 에서 찾을 수 있습니다. 대시보드 사용 및 편집에 대한 문서는 [대시보드 문서 를](/docs/query-your-data/explore-query-data/dashboards/introduction-dashboards) 참조하세요.
