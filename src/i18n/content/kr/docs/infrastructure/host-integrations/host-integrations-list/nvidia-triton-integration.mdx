...
<Steps>
  ...
  <Step>
    ...
    1. **[one.newrelic.com](https://one.newrelic.com) > + Add data** 으로 이동하여 하고 **NVIDIA Triton 을** 입력하세요.
    ...
    <DoNotTranslate>**Dashboards**</DoNotTranslate> UI에서 맞춤형 NVIDIA Triton 대시보드를 찾을 수 있습니다. 자세한 내용은 [대시보드](/docs/query-your-data/explore-query-data/dashboards/introduction-dashboards) 섹션을 참조하세요.
