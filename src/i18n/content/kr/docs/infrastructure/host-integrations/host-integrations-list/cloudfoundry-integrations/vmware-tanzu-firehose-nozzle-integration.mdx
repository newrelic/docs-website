...
* <DNT>
  ...
  : 이 쉼표 또는 파이프로 구분된 목록에 나열된 소스가 있는 로그 메시지에 대해서만 이벤트를 생성합니다.

* <DNT>
    **LogMessage Source Exclude Filter**
  </DNT>

  : 쉼표나 파이프로 구분된 목록에 소스가 나열된 로그 메시지에 대한 이벤트를 생성하지 않습니다.

* <DNT>
    **LogMessage Message Include Filter**
  </DNT>

  : 쉼표나 파이프로 구분된 목록에 나열된 텍스트가 포함된 로그 메시지에 대해서만 이벤트를 생성합니다.

* <DNT>
    **LogMessage Message Exclude Filter**
  </DNT>

  : 쉼표나 파이프로 구분된 목록에 나열된 텍스트가 포함된 로그 메시지에 대해 이벤트를 생성하지 않습니다.
