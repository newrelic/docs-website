...
<CollapserGroup>
  ...
  >
    ...
    Prometheus 메트릭을 스크랩하고 NewRelic에 전달하는 방법에는 여러 가지가 있습니다. [자세한 내용은 문서를](/docs/infrastructure/prometheus-integrations/install-configure-prometheus-agent/setup-prometheus-agent)확인하세요.
