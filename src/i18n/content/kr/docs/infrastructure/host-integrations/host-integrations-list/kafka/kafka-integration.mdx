...
[Apache Kafka](https://cwiki.apache.org/confluence/display/KAFKA/Time+Based+Release+Plan#TimeBasedReleasePlan-WhatIsOurEOLPolicy?) 0.10, 0.11, 1.0 및 1.1은 이제 [단종](https://docs.confluent.io/platform/current/installation/versions-interoperability.html#cp-and-apache-ak-compatibility) 되었습니다. 현재 권장되는 버전은 2.2.1 이상입니다.
