...
<CollapserGroup>
  ...
  >
    1. [New Relic의 Kafka 통합을 위한 .MSI 설치 프로그램 이미지를 다운로드하십시오](https://download.newrelic.com/infrastructure_agent/windows/integrations/nri-kafka/nri-kafka-amd64.msi) .
