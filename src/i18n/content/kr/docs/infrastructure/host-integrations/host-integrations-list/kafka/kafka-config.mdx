...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        PEM 형식의 SSL 및 SASL\_SSL 수신기에 대한 인증 기관 파일입니다.
      </td>
    ...
    <tr>
      ...
      <td>
        PEM 형식의 SSL 및 SASL\_SSL 수신기용 클라이언트 인증서 파일입니다.
      </td>
    ...
    <tr>
      ...
      <td>
        PEM 형식의 SSL 및 SASL\_SSL 리스너용 클라이언트 키 파일입니다.
      </td>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        참고: 이 옵션은 CONSUMER\_OFFSET이 true일 때 설정해야 합니다.
      </td>
    ...
    <tr>
      ...
      <td>
        활성 소비자가 없는 소비자 그룹에서 오프셋 메트릭을 수집하려면 CONSUMER\_OFFSET을 true로 설정해야 합니다.
      </td>
    ...
    <tr>
      ...
      <td>
        주제별 consumerGroup에 대한 추가 메트릭 집계를 활성화합니다.CONSUMER\_OFFSET을 true로 설정해야 합니다.
      </td>
...
<CollapserGroup>
  <Collapser id="duplicate-info" title="보고되는 중복 데이터">
  ...
  <Collapser id="zookeeper-node-not-found" title="통합에서 'zk: 노드를 찾을 수 없음' 오류를 기록합니다.">
    [구성 파일](#config) 에서 `zookeeper_path` 이(가) 올바르게 설정되었는지 확인하십시오.
  </Collapser>

  <Collapser id="jmx-connection-errors" title="JMX 연결 오류">
  ...
  <Collapser id="kerberos-authentication" title="Kerberos 인증 실패">
