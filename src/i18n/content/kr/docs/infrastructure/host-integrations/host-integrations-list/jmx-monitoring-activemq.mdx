...
<figcaption>
  New Relic으로 ActiveMQ를 설정하면 데이터가 이와 같은 빠른 시작 대시보드에 즉시 표시됩니다.
</figcaption>
...
[ActiveMQ 빠른 시작](https://newrelic.com/instant-observability/activemq) 을 설치하면 New Relic에서 중요한 데이터 ActiveMQ 데이터를 볼 수 있습니다.
