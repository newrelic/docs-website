...
<CollapserGroup>
  ...
  >
    ...
    1. 파일 이름 `nri-cassandra` 을(를) 사용하여 [통합 설치](/docs/install-integrations-package) 지침을 따르십시오.
...
### jmxterm을 통한 문제 해결 [#jmxterm]

[JMXTerm](https://docs.cyclopsgroup.org/jmxterm) 은 통합 패키지에 번들로 제공되는 명령줄 대화형 도구입니다.

JMXTerm용 문서는 GitHub의 [nrjmx 페이지](https://github.com/newrelic/nrjmx/#troubleshooting-via-jmxterm) 에서 찾을 수 있습니다.

## 소스 코드 확인 [#source-code]

이 통합은 오픈 소스 소프트웨어입니다. 즉 [, 소스 코드를 탐색하고](https://github.com/newrelic/nri-cassandra "링크가 새 창에서 열립니다.") 개선 사항을 보내거나 고유한 포크를 만들어 빌드할 수 있습니다.