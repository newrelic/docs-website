...
2. <DNT>**Dashboards**</DNT> 탭을 클릭하고 검색 필드에 <DNT>**Redis Enterprise**</DNT> 입력합니다.<img title="Redis Enterprise dashboards" alt="A screenshot of the Redis Enterprise dashboards." src={infrastructureRedisEnterpriseDashboard}/>
