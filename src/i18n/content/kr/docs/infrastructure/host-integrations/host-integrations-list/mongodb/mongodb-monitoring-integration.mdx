...
MongoDB 통합은 지표 정보와 인벤토리 정보를 모두 수집합니다. 다음 표에서 각 컬렉션에 사용할 수 있는 설정은 <DoNotTranslate>**Applies To**</DoNotTranslate> 열을 참조하세요.
