...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <DoNotTranslate>**Required.**</DoNotTranslate> 지표의 이름입니다.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <DoNotTranslate>**Required.**</DoNotTranslate> [지표 유형](#metric-types):
    ...
    <tr>
      ...
      <td>
        <DoNotTranslate>**Optional**</DoNotTranslate> 간단한 카운터 또는 타이머 카운터의 경우. 많은 지표를 전송해야 하는 경우 샘플링을 사용하여 네트워크 트래픽을 줄일 수 있습니다. 단점은 데이터 해상도가 감소한다는 것입니다.
    ...
    <tr>
      ...
      <td>
        <DoNotTranslate>**Optional.**</DoNotTranslate> 지표에 첨부된 태그는 속성(핵심 가치 쌍)으로 변환됩니다. 태그 지정 옵션에 대한 자세한 내용은 [태그 를](#add-tags) 참조하세요.
      </td>
    </tr>
  </tbody>
</table>
...
<CollapserGroup>
  ...
  >
    ...
    NRQL 공지 조건을 생성할 때 반드시 <DoNotTranslate>**Condition name**</DoNotTranslate> 을 설정하세요.
