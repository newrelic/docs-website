...
우리의 통합은 VMware Tanzu Application Service 버전 2.10~4.0 및 Ops Manager 버전 2.8~3.0과 호환됩니다. BOSH 줄기세포는 Ubuntu Jammy를 기반으로 해야 합니다.

통합을 설치하기 전에 VMware Tanzu 계정이 있는지 확인하십시오.
