...
VMware Tanzu 통합을 설치하고 활성화하면 [**one.newrelic.com**](http://one.newrelic.com) **> Infrastructure > Third-party services > VMware Tanzu dashboard** 에서 데이터와 사전 정의된 차트를 찾을 수 있습니다. 데이터를 쿼리하여 사용자 지정 차트와 대시보드를 만들고 계정에 추가할 수 있습니다.
