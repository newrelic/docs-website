...
1. [one.newrelic.com](https://one.newrelic.com) 에서
   ...
   <DNT>**Add data > Infrastructure & OS > MySQL**</DNT>
...
1. [one.newrelic.com](https://one.newrelic.com) 에서
   ...
   <DNT>**Add data > Infrastructure & OS > Apache**</DNT>
...
1. [one.newrelic.com](https://one.newrelic.com) 에서 <DNT>**Add data > Application monitoring > Python**</DNT> 클릭합니다.
