...
3. 이 제품을 안정 영역에 추가하려면 Ops Manager 왼쪽 탐색 보기에 업로드된 제품 설명에 있는
...
5. <DoNotTranslate>**Apply Changes**</DoNotTranslate>
...
2. <DoNotTranslate>**Import a Product**</DoNotTranslate> 클릭하고 뉴렐릭 Service Broker for VMware Tanzu 타일을 가져옵니다.
...
3. 업로드한 '뉴렐릭 Service Broker' 오른쪽에 있는 <DoNotTranslate>**+**</DoNotTranslate> 버튼을 클릭하세요.
...
16. 애플리케이션을 다시 준비하십시오. <DoNotTranslate>**Bind**</DoNotTranslate> 페이지 상단이나 터미널 창에서 링크를 선택하고 `cf restage` 실행하여 변경할 수 있습니다.
