...
<Callout title="공개 미리보기">
  이 기능은 현재 공개 미리 보기 상태이며 [0.3.0](https://github.com/newrelic/nri-winservices/releases/tag/v0.3.0-beta) 부터 시작하는 버전에만 적용됩니다.2021년 9월 출시.자세한 내용은 [Explorer Hub 게시물](https://discuss.newrelic.com/t/introducing-new-open-beta-version-of-the-windows-services-integration/160162) 을 확인하세요.
</Callout>
