...
* [Windows Services Quickstart를](https://newrelic.com/instant-observability/winservices) 설치하거나 고유한 [대시보드를](/docs/query-your-data/explore-query-data/dashboards/introduction-dashboards) 만들어 Windows 서비스를 추적하세요.
