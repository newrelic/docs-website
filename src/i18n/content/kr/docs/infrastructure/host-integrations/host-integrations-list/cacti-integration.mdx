...
<Steps>
  ...
  <Step>
    ...
    귀하의 Cacti 대시보드는 맞춤형 대시보드로 간주되며 <DoNotTranslate>**Dashboards**</DoNotTranslate> UI 에서 찾을 수 있습니다. 대시보드 사용 및 편집에 대한 문서는 [대시보드 문서 를](/docs/query-your-data/explore-query-data/dashboards/introduction-dashboards) 참조하세요.
