...
설치가 완료되면 <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capaibilities)**</DoNotTranslate> 으로 이동한 다음 <DoNotTranslate>**Metrics & events**</DoNotTranslate> 클릭하여 뉴렐릭이 Redmine 데이터를 수집하고 있는지 확인하세요. 다음 NRQL 쿼리를 실행하여 뉴렐릭이 Redmine 데이터를 수신하고 있는지 확인하세요.
...
3. <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DoNotTranslate> 으로 이동한 다음 <DoNotTranslate>**Metrics & events**</DoNotTranslate> 클릭하세요. 다음 쿼리를 실행하여 뉴렐릭이 맞춤 지표를 보고하는지 확인하세요.
