...
Couchbase [통합](/docs/infrastructure/host-integrations/get-started/introduction-host-integrations) 은 Couchbase 클러스터에서 인벤토리 및 메트릭 데이터를 수집하여 뉴렐릭 플랫폼으로 전송하며, 여기서 Couchbase 환경의 상태를 빠르게 확인할 수 있습니다. 문제의 근본 원인을 트레이스할 수 있도록 클러스터, 노드, 쿼리 엔진 및 버킷 수준에서 데이터를 수집합니다.
...
통합 데이터는 [통합 대시보드](/docs/infrastructure/infrastructure-data/infra-integration-data)에 보고됩니다.
