...
<CollapserGroup>
  <Collapser id="bucket-parameters" title="버킷 매개변수">
    <table>
      <thead>
        <tr>
  ...
  <Collapser id="cluster-parameters" title="클러스터 매개변수">
    <table>
      <thead>
        <tr>
          <th style={{ width: "300px" }}>
  ...
  <Collapser id="node-parameters" title="노드 매개변수">
    <table>
      <thead>
        <tr>
          <th style={{ width: "300px" }}>
  ...
  <Collapser id="query-engine-parameters" title="쿼리 엔진 매개변수">
    <table>
      <thead>
        <tr>
          <th style={{ width: "300px" }}>
