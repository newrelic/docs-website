...
<CollapserGroup>
  <Collapser
    ...
    title="리눅스 설치"
  >
    1. [인프라 에이전트를 설치하고](/docs/integrations/host-integrations/installation/install-infrastructure-host-integrations/#install) `INTEGRATION_FILE_NAME` 변수를 `nri-vsphere` 로 바꿉니다.
