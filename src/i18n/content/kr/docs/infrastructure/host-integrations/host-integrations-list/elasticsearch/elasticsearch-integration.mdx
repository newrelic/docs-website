...
<Callout variant="tip">
  새로운 OpenTelemetry 옵션이 추가되었습니다! 대신 당사의 [Elasticsearch OpenTelemetry 통합 기능을](/docs/opentelemetry/integrations/elasticsearch/elasticsearch-otel-integration-overview) 사용해 보시는 것을 고려해 보세요. 업계 표준 OpenTelemetry 프로토콜을 사용하여 공급업체 비종속 모니터링, 향상된 성능 및 미래 대비 기능을 제공합니다.
</Callout>
...
* Elasticsearch가 Kubernetes 또는 Amazon ECS에서 실행되고 있지 않다면 Elasticsearch를 실행하는 호스트에 [인프라 에이전트를 설치하십시오](/docs/infrastructure/install-infrastructure-agent/get-started/install-infrastructure-agent-new-relic) . 그렇지 않으면:
  ...
  * 만약 실행 중이라면<img style={{ width: '32px', height: '32px'}} class="inline" title="Kubernetes" alt="Kubernetes" src="/images/os_icon_k8.webp" />Kubernetes, [이러한 요구 사항 ](/docs/monitor-service-running-kubernetes#requirements)참조.
  * 만약 실행 중이라면<img style={{ width: '32px', height: '32px'}} class="inline" title="ECS" alt="ECS" src="/images/os_icon_ecs.webp" />Amazon ECS, [이러한 요구 사항 ](/docs/integrations/host-integrations/host-integrations-list/monitor-services-running-amazon-ecs)참조.
...
* 활성화된 경우<img style={{ width: '32px', height: '32px'}} class="inline" title="Kubernetes" alt="Kubernetes" src="/images/os_icon_k8.webp" />Kubernetes, [Kubernetes에서 실행 중인 모니터링 서비스 ](/docs/monitor-service-running-kubernetes)참조.
* 활성화된 경우<img style={{ width: '32px', height: '32px'}} class="inline" title="ECS" alt="ECS" src="/images/os_icon_ecs.webp" />Amazon ECS, [ECS에서 실행되는 모니터링 서비스 참조 ](/docs/integrations/host-integrations/host-integrations-list/monitor-services-running-amazon-ecs).
