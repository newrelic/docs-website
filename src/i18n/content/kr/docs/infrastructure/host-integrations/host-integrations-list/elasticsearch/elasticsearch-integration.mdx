...
* <img style={{ width: '32px', height: '32px'}} class="inline" title="Kubernetes" alt="Kubernetes" src={osk8}>을 통해 활성화된 경우</img>

  Kubernetes, [Kubernetes에서 실행 중인 모니터링 서비스 ](/docs/monitor-service-running-kubernetes)참조.

* <img style={{ width: '32px', height: '32px'}} class="inline" title="ECS" alt="ECS" src={osEcs}>을 통해 활성화된 경우</img>
