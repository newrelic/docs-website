...
<CollapserGroup>
  ...
  >
    ...
    <DNT>**Recommendation:**</DNT> 베어링 에이전트 설정에서 [로그 파일을 구성합니다](/docs/infrastructure/new-relic-infrastructure/troubleshooting/generating-logs-troubleshooting-infrastructure) . 이렇게 하면 오류 유형을 분리하여 통합 오류를 더 쉽게 발견할 수 있습니다.
