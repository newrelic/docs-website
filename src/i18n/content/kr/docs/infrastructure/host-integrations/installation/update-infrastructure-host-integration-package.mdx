...
<CollapserGroup>
  ...
  >
    <DNT>**Recommendation:**</DNT> 인프라 에이전트를 [업데이트합니다](/docs/infrastructure/new-relic-infrastructure/installation/update-infrastructure-agent) ([버전 1.0.703 이상](/docs/release-notes/infrastructure-release-notes/infrastructure-agent-release-notes)).
