  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * <DoNotTranslate>**Debian**</DoNotTranslate> 또는 <DoNotTranslate>**Ubuntu**</DoNotTranslate>:

          ```
          dpkg -l | grep INTEGRATION_FILE_NAME
          ```

        * <DoNotTranslate>**Amazon Linux, CentOS, SLES, or RHEL**</DoNotTranslate>:
...
<CollapserGroup>
  ...
  >
    <DoNotTranslate>**Recommendation:**</DoNotTranslate> 인프라 에이전트를 [업데이트합니다](/docs/infrastructure/new-relic-infrastructure/installation/update-infrastructure-agent) ([버전 1.0.703 이상](/docs/release-notes/infrastructure-release-notes/infrastructure-agent-release-notes)).
