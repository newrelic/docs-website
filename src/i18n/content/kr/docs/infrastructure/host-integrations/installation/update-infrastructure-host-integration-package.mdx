...
<CollapserGroup>
  ...
  >
    ...
    **기타 모든 호스트 내 Microsoft Windows 통합**
    ...
    1. [저장소에서 최신 MSI 설치 프로그램 이미지를](https://download.newrelic.com/infrastructure_agent/windows/integrations/) 다운로드하십시오.
  ...
  <Collapser
    id="apt"
    title={<>apt로 업데이트 (<img src={osDebian} title="Debian icon" alt="Debian.png" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>데비안,<img src={osUbuntu} title="ubuntu icon" alt="ubuntu icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>우분투)</>}
  >
  ...
  <Collapser
    id="yum"
    title={<>yum으로 업데이트(<img src={osAmazonLinux} title="amazon linux.png" alt="amazon linux.png" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>아마존 리눅스,<img src={osCentos} title="centos icon" alt="centos icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>CentOS,<img src={osRedhat} title="redhat icon" alt="redhat icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>RHEL)</>}
  >
    **권장 사항:** 인프라 에이전트를 [업데이트](/docs/infrastructure/new-relic-infrastructure/installation/update-infrastructure-agent) 합니다( [버전 1.0.703 이상](/docs/release-notes/infrastructure-release-notes/infrastructure-agent-release-notes) ).
