...
* <img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="Kubernetes" alt="Kubernetes" src={osk8} />[Kubernetes ](/docs/integrations/kubernetes-integration/link-apps-services/monitor-services-running-kubernetes)에서 호스트 내 통합 업데이트
* <img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="ECS" alt="ECS" src={osEcs} />[Amazon ECS ](/docs/integrations/host-integrations/host-integrations-list/monitor-services-running-amazon-ecs)에서 온 호스트 통합 업데이트(EC2 시작 유형)
...
<CollapserGroup>
  <Collapser
    id="windows"
    title={<>MSI 파일을 사용하여 업데이트(<img src={osWindows} title="Windows Server" alt="Windows Server" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }} /></>
    }
  >
    사용 중인 통합에 따라 세 가지 접근 방식이 있습니다.

    <DNT>**On-host Microsoft Windows services integration**</DNT>
    ...
    <DNT>\*\* Nri-kafka, nri-jmx integration\*\*</DNT>
    ...
    <DNT>**All other on-host Microsoft Windows integrations**</DNT>
  ...
  <Collapser
    id="apt"
    title={<>적절한 업데이트(<img src={osDebian} title="Debian icon" alt="Debian.webp" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}>데비안,<img src={osUbuntu} title="ubuntu icon" alt="ubuntu icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }} /></img></>
    }
  >
  ...
  <Collapser
    id="zypper"
    title={<>zypper로 업데이트(<img src={osSuse} title="suse icon" alt="suse icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }} /></>
    }
  >
    권장 사항: [](/docs/infrastructure/new-relic-infrastructure/installation/update-infrastructure-agent)인프라 에이전트([버전 1.0.703 이상](/docs/release-notes/infrastructure-release-notes/infrastructure-agent-release-notes))를 업데이트하세요 .
  ...
  <Collapser
    id="tarball"
    title={<>tarball에서 업데이트(<img src={osLinux} title="Linux" alt="Linux icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }} /></>
    }
  >
    <Callout variant="tip">
