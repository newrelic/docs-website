...
New Relic과 호스트 내 통합을 생성했지만 New Relic의 인프라 UI에 데이터가 표시되지 않습니다.

## 해결책

문제를 해결하고 해결하려면:

1. 통합이 활성화되고 보고되는지 확인합니다. [**one.newrelic.com**](http://one.newrelic.com) **> Infrastructure > Third-party Services** 이동하여 **Active integrations** 아래에서 통합 이름을 찾습니다.
