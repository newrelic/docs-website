---
title: 인프라 에이전트 통합을 위한 데이터 수집 및 보고
tags:
  - Integrations
...
이 문서는 [인프라 에이전트 통합이](/docs/infrastructure/host-integrations/installation/install-infrastructure-host-integrations) 데이터를 수집하고 보고하는 방법을 설명합니다.

## 데이터 수집 및 보고 프로세스 [#data-collection]

다음은 인프라 에이전트 온호스트 통합이 데이터를 New Relic으로 보내는 방법입니다.
