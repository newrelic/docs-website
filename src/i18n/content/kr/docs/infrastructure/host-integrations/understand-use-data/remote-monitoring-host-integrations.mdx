...
<CollapserGroup>
  <Collapser
    ...
    title="경고 확인"
  >
    [**원격 모니터링을 활성화하면 이 새로운 기능의 영향을 받는 값을 사용하는 경우 구성된 경고에 영향을 미칠 수 있습니다**](/docs/verify-your-alerts-after-activating-remote-monitoring) . 기존을 확인하는 것이 좋습니다. <InlinePopover type="alerts"/>예상대로 계속 작동하는지 확인합니다.
  </Collapser>
