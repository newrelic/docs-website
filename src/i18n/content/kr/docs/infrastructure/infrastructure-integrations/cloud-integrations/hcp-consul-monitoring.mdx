...
HCP 포털 계정의 <DoNotTranslate>**Overview**</DoNotTranslate> 페이지에서 Terraform 구현, 배포 파일을 생성합니다.
...
[종단 간 개요](https://learn.hashicorp.com/tutorials/cloud/consul-end-to-end-overview) 에서 적절한 환경에 대한 단계를 따라 Consul 클러스터를 구현하다, 배포합니다. <DoNotTranslate>**Important:**</DoNotTranslate> <DoNotTranslate>**Deploy**</DoNotTranslate> 페이지 하단의 <DoNotTranslate>**Consul CLI configuration**</DoNotTranslate> 을 따르세요.
...
뉴렐릭 Instant 옵저버빌리티의 [HCP Consul 퀵스타트](https://newrelic.com/instant-observability/hcp-consul) 로 이동하여 <DoNotTranslate>**+ Install now**</DoNotTranslate> 클릭합니다.
