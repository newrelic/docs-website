...
* <DNT>**Billing:**</DNT>
  ...
  AWS CloudWatch 청구서를 관리해야 하는 경우 폴링 빈도를 줄이는 것이 좋습니다. 이 작업을 수행하기 전에 클라우드 통합에 설정된 [공지](/docs/infrastructure/new-relic-infrastructure/infrastructure-alert-conditions) [조건이](/docs/infrastructure/new-relic-infrastructure/infrastructure-alert-conditions) 이 축소의 영향을 받지 않는지 확인하세요.

* <DNT>**New services:**</DNT>

  새로운 서비스 또는 설정을 구현, 배포하고 데이터를 더 자주 수집하려는 경우 폴링 빈도를 일시적으로 늘릴 수 있습니다.
...
4. <DNT>**Data polling interval every**</DNT>
   ...
   옆에 있는 다운 드롭 메뉴를 사용하여 뉴렐릭이 클라우드 통합 데이터를 캡처하는 빈도를 선택하세요.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        필터를 설정한 [공지 조건](/docs/infrastructure/new-relic-infrastructure/infrastructure-alert-conditions) <DNT>**after**</DNT> 을 생성할 때 필터링한 리소스에 의해 <InlinePopover type="alerts"/>이 트리거되지 않는지 확인하세요.
      </td>
    </tr>
