...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [필터를 설정한](/docs/infrastructure/new-relic-infrastructure/infrastructure-alert-conditions) **후** 알림 조건을 생성할 때 다음 사항을 <InlinePopover type="alerts"/>확인하세요. 필터링한 리소스에 의해 트리거되지 않습니다.
      </td>
    </tr>
