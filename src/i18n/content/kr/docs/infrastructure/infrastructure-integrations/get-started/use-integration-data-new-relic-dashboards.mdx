...
* **[one.newrelic.com](https://one.newrelic.com) > Infrastructure > Third-party services** 페이지에서 통합 대시보드를 선택합니다. 여기에서 차트를 생성한 [NRQL 쿼리를 볼](/docs/integrations/new-relic-integrations/getting-started/infrastructure-integration-dashboards-charts#functions) 수 있습니다. 통합 데이터에 대한 NRQL 쿼리의 예는 [쿼리 예](#query-examples) 를 참조하십시오.
