...
import infrastructureDashboardsExample from 'images/infrastructure_screenshot-crop_dashboards-example.webp'
...
* 대시보드 보기:
  ...
  * AWS, Azure, GCP 데이터의 경우:
    ...
    <img title="Dashboards example" alt="Screenshot of the AWS integration page" src={infrastructureDashboardsExample} width="50%" />
