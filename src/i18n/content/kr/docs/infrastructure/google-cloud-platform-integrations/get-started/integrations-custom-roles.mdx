...
<CollapserGroup>
  <Collapser className="freq-link" id="permissions-all" title="공통 권한">
  ...
  <Collapser className="freq-link" id="permissions-services" title="서비스별 권한">
  ...
  <Collapser className="freq-link" id="permissions-UI" title="UI를 통해 프로젝트를 연결할 수 있는 권한">
