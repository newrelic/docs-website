    ...
    <TabsPageItem id="permissions-services">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td>
              [Google 데이터스토어](/docs/integrations/google-cloud-platform-integrations/gcp-integrations-list/google-datastore-monitoring-integration)
            </td>
          ...
          <tr>
            <td>
              [Google Firebase Realtime 데이터베이스](/docs/integrations/google-cloud-platform-integrations/gcp-integrations-list/google-cloud-firebase-database-monitoring-integration)
            </td>
          ...
          <tr>
            <td>
              [Memcached용 Google Memorystore](/docs/integrations/google-cloud-platform-integrations/gcp-integrations-list/google-memorystore-memcached)
            </td>
          ...
          <tr>
            <td>
              [Redis용 Google 메모리 저장소](/docs/integrations/google-cloud-platform-integrations/gcp-integrations-list/google-memorystore-redis)
            </td>
          ...
          <tr>
            <td>
              [Valkey용 Google Memorystore](/docs/infrastructure/google-cloud-platform-integrations/gcp-integrations-list/google-memorystore-valkey)
            </td>
