...
1. **[one.newrelic.com](https://one.newrelic.com) > Infrastructure > GCP** 로 이동합니다. 인프라의 **Google Cloud Services** 통합 페이지 상단 **에서 GCP 계정 추가** 를 선택합니다.
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        1. **[one.newrelic.com](https://one.newrelic.com) > Infrastructure > GCP > Manage services** 에서.
    ...
    <tr>
      ...
      <td>
        ...
        **사용자 계정** 을 사용하여 GCP 프로젝트를 등록한 경우 다음 단계를 따르세요.
        ...
        1. **[one.newrelic.com](https://one.newrelic.com) > Infrastructure > GCP > Manage services** 로 이동합니다.
