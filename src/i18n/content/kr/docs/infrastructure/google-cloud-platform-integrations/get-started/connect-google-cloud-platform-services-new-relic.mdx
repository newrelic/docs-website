...
1. [**one.newrelic.com**](http://one.newrelic.com) **> Infrastructure > GCP** 로 이동합니다. 인프라의 **Google Cloud Services** 통합 페이지 상단 **Add a GCP account** 를 선택합니다.
...
New Relic이 하나 이상의 Google 프로젝트 서비스를 통합하도록 승인하면 New Relic은 정기적인 폴링 간격으로 GCP 데이터 모니터링을 시작합니다. 몇 분 후 데이터가 New Relic UI에 나타납니다. 대시보드 및 경고 설정에 대한 링크를 포함 [하여 데이터를 찾고 사용](/docs/infrastructure/integrations/find-use-infrastructure-integration-data) 하려면 [**one.newrelic.com**](http://one.newrelic.com) **> Infrastructure > GCP** 로 이동하십시오.
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        1. **[one.newrelic.com](http://one.newrelic.com) > Infrastructure > GCP** **> Manage services** 에서.
    ...
    <tr>
      ...
      <td>
        ...
        **사용자 계정** 을 사용하여 GCP 프로젝트를 등록한 경우 다음 단계를 따르세요.
        ...
        1. **[one.newrelic.com](http://one.newrelic.com) > Infrastructure > GCP** **> Manage services** 로 이동합니다.
