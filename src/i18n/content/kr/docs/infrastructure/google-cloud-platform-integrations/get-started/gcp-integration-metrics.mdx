...
## Google Cloud 측정항목 [#gcp-metrics-table]

다음 표는 GCP 통합으로 수집된 지표와 [차원 지표](/docs/telemetry-data-platform/ingest-manage-data/understand-data/new-relic-data-types/#dimensional-metrics) 번역의 비포괄적 목록입니다.
