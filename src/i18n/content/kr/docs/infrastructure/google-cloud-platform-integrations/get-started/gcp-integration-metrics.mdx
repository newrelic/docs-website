...
## Google Cloud 메트릭 [#gcp-metrics-table]

다음 표에는 GCP 통합에서 수집한 일부 메트릭과 해당 [차원 메트릭](/docs/telemetry-data-platform/ingest-manage-data/understand-data/new-relic-data-types/#dimensional-metrics) 번역이 나열되어 있습니다.
