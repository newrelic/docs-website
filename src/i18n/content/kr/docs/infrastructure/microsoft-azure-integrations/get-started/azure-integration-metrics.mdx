...
각 폴링 통합 및 해당 이름에서 사용할 수 있는 지표에 대한 참조는 [각 개별 통합 문서를 확인하세요](https://docs.newrelic.com/docs/infrastructure/microsoft-azure-integrations/get-started/activate-azure-integrations/).
