...
4. <DNT>**Redirect URI**</DNT>

   에서 `Web`선택하고 로그인 URI로 `https://www.newrelic.com` 추가합니다.
...
2. <DNT>**Client secrets**</DNT>
   ...
   를 클릭합니다. 최대 2년까지 비밀 만료 날짜를 선택하세요. 비밀번호가 만료되면 다음 단계에 따라 [애플리케이션 세부정보를 업데이트하세요](#update-app).

3. <DNT>**Client Secret**</DNT>

   값을 복사하고 나중에 사용할 수 있도록 저장합니다.
...
1. Azure
   ...
   섹션에서 뉴렐릭을 모니터할 구독을 선택합니다.

2. <DNT>**Access control (IAM) > Add > Add role assignment**</DNT>
...
4. <DNT>**Select**</DNT>
   ...
   드롭다운 메뉴에서 앱 이름을 선택하세요. 예를 들어, `NewRelic-Integrations`.

5. <DNT>**Selected members**</DNT>

   에서 앱 이름이 나타나는지 확인한 다음
...
1. <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Azure**</DNT>
   ...
   으로 이동하여 추가하려는 Azure 서비스를 선택하세요.

2. UI의 단계에 따라 New Relic에서 통합을 활성화합니다.

3. Azure 계정 단계를 이미 완료한 경우 단계 끝으로 건너뛰어 양식을 작성하세요. ( `Azure account name` 의 경우

   <DNT>**Integrations**</DNT>

   대시보드에서 계정을 식별하는 데 사용할 이름을 입력하세요.)
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        1. <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Azure > Manage services**</DNT>

           으)로 이동합니다.

        2. <DNT>**Edit Azure account**</DNT>
    ...
    <tr>
      ...
      <td>
        ...
        4. [Azure](https://portal.azure.com/) 에 로그인하고
        ...
        5. 등록된 앱을 찾습니다(권장 이름은 `NewRelic-Integrations`). 사용 가능한 앱의 전체 목록을 보려면 검색 필드 옆에 있는 드롭다운 메뉴를 선택하고
