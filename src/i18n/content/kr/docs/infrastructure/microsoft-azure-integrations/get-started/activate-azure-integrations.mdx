...
인프라 UI에서 직접 이러한 통합 활성화 지침을 사용하려면 **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > Azure > Add an Azure account** 이동합니다.
...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > Azure** 로 이동하여 추가하려는 Azure 서비스를 선택합니다.
...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > Azure** 로 이동하고 편집하려는 Azure 계정에서 **Manage Services** 를 클릭합니다.
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Manage Services > Azure > Manage services** 로 이동합니다.
