...
4. <DNT>**Redirect URI**</DNT> 에서 `Web` 선택하고 `https://newrelic.com` 로그인 URI로 추가합니다.
...
1. Azure Portal에서 <DNT>**Subscriptions**</DNT> 로 이동하여 모니터링하려는 항목을 선택합니다.
2. 왼쪽 메뉴에서 <DNT>**Settings**</DNT> 아래에 있는 <DNT>**Resource providers**</DNT> 클릭합니다.
3. 검색창을 이용해 <DNT>**microsoft.insights**</DNT> 찾으세요. 상태가 <DNT>`NotRegistered`</DNT> 인 경우, 해당 상태를 선택하고 <DNT>**Register**</DNT> 클릭합니다. 상태가 `Registered` 으로 변경될 때까지 기다리세요.
4. 구독 페이지로 돌아가서 왼쪽 메뉴에서 <DNT>**Access control (IAM)**</DNT> 클릭하세요.
5. <DNT>**+ Add**</DNT> 클릭한 다음 <DNT>**Add role assignment**</DNT> 선택합니다.
6. <DNT>**Reader**</DNT> 역할을 검색하여 선택한 다음 <DNT>**Next**</DNT> 클릭합니다.
7. 회원 탭에서 <DNT>**+ Select members**</DNT> 클릭합니다. 뉴킹릭 계약 이름(예: <DNT>**NewRelic-Integrations)**</DNT>)을 검색하여 선택하고 <DNT>**Select button**</DNT> 을 클릭하세요.
8. <DNT>**Review + assign**</DNT> 클릭하여 역할을 저장하세요.
9. 첫 번째 역할을 저장한 후 &quot;역할 할당 추가&quot; 프로세스를 반복하여 동일한 뉴렐릭 애플리케이션에 <DNT>**Monitoring Reader**</DNT> 역할도 할당합니다.
10. 구독 단계에서 <DNT>**Monitoring Reader**</DNT> 역할이 할당되었는지 확인하세요.
