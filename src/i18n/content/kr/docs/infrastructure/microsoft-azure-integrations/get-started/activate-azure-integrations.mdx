...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > Azure** 로 이동하고 편집하려는 Azure 계정에서 **서비스 관리** 를 클릭합니다.
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > Azure > Manage services** 로 이동합니다.
