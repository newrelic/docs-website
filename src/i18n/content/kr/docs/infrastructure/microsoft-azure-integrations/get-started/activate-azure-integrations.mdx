...
새로운 Relic [인프라 통합](/docs/infrastructure/integrations/intro-infrastructure-integrations) 을 통해 특정 시스템의 데이터를 보고하고 [인프라의](/docs/infrastructure/new-relic-infrastructure/getting-started/introduction-new-relic-infrastructure) 기본 자동 모니터링을 보완할 수 있습니다. Microsoft Azure 통합은 다양한 Azure 플랫폼 서비스의 데이터를 New Relic 계정으로 보고합니다. 이 문서에서는 Azure 통합을 활성화하는 방법을 설명합니다.
