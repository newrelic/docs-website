---
title: Azure Monitor 통합을 통한 Azure Functions Workflow 서비스
...
[뉴렐릭의 통합](/docs/infrastructure/introduction-infra-monitoring) 에는 [Microsoft Azure Functions 워크플로우](https://azure.microsoft.com/en-us/products/logic-apps/) 인덱스 및 기타 데이터를 뉴렐릭에 보고하기 위한 통합이 포함되어 있습니다. 이 문서에서는 통합을 활성화하는 방법과 보고되는 데이터에 대해 설명합니다.
...
표준 [Azure Monitor 통합 절차](/docs/infrastructure/microsoft-azure-integrations/azure-integrations-list/azure-monitor) 에 따라 New Relic 인프라 모니터링에서 Azure Functions Workflow 서비스를 활성화하세요.
...
New Relic은 기본 [폴링](/docs/infrastructure/microsoft-azure-integrations/azure-integrations-list/azure-monitor/#settings) 간격에 따라 Azure Monitor 통합을 통해 Functions Workflow 서비스를 쿼리합니다.
...
### Azure Functions 워크플로 메트릭 [#Azure-functions-workflow]
