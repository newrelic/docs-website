...
1. <DoNotTranslate>**Azure Portal**</DoNotTranslate> 으로 이동하여 터미널을 선택하여 셸을 엽니다. <Icon name="fe-terminal"/> 상.
...
3. <DoNotTranslate>**Services > Subscriptions**</DoNotTranslate> 에서 구독을 선택하고 <DoNotTranslate>**Access control (IAM)**</DoNotTranslate> 로 이동한 후 다음을 선택하세요. <Icon name="fe-plus"/> <DoNotTranslate>**Add**</DoNotTranslate>.

4. <DoNotTranslate>**Role**</DoNotTranslate> 검색 창에 새로 생성된 역할 정의의 이름을 추가합니다(예: `NewRelic Integrations`).

5. <DoNotTranslate>**Select**</DoNotTranslate> 검색 창에서 뉴쿨릭 통합 기능의 이름을 추가하고 선택합니다.

6. 애플리케이션이 <DoNotTranslate>**Selected members**</DoNotTranslate> 목록에 추가되었는지 확인한 다음 <DoNotTranslate>**Save**</DoNotTranslate>.
...
통합 데이터를 보려면 <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Azure**</DoNotTranslate> 으로 이동하여 Cosmos DB 통합을 선택하세요.
