...
1. <DNT>**Azure Portal**</DNT> 으로 이동하여 터미널을 선택하여 셸을 엽니다. <Icon name="fe-terminal"/> 상.
...
3. <DNT>**Services > Subscriptions**</DNT> 에서 구독을 선택하고 <DNT>**Access control (IAM)**</DNT> 로 이동한 후 다음을 선택하세요. <Icon name="fe-plus"/> <DNT>**Add**</DNT>.
