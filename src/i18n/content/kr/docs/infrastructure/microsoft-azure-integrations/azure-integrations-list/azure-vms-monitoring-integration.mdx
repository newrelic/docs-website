...
<DNT>**Host not reporting**</DNT> 공지 조건을 사용하는 경우 VM에 대한 Azure 메타데이터를 가져오면 호스트 레지스트리가 변경되어 잘못된 공지 공지가 발생합니다. 오탐을 예방하려면:
...
1. 각 Azure 제외에 대해 해당
   ...
   공지 조건을 [비활성화합니다](/docs/infrastructure/new-relic-infrastructure/infrastructure-alert-conditions/infrastructure-alerts-add-edit-or-view-host-alert-information#maintain-alerts) .
...
3. 각
   ...
   공지 조건을 [다시 활성화합니다](/docs/infrastructure/new-relic-infrastructure/infrastructure-alert-conditions/infrastructure-alerts-add-edit-or-view-host-alert-information#maintain-alerts) .
