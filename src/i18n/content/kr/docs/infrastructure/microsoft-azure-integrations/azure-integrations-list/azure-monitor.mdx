...
2. 새 **Azure Monitor 메트릭** 통합을 사용하도록 **Save Changes** \[설정하고 변경 내용 저장] 단추를 클릭합니다.<img title="Shows where to enable the Azure monitor" alt="Shows where to enable the Azure monitor" src={infrastructureAzureMonitorMetricsIntegration}/>
3. **Azure Monitor 메트** 릭 통합을 사용할 수 있게 됩니다<img title="Shows where azure monitor metrics integration" alt="Shows where azure monitor metrics integration" src={infrastructureAzureMonitorMetricsConfigure}>.</img>
