...
이 통합은 Azure에서 직접 New Relic을 설정 및 구성하고 Azure에 New Relic 데이터를 저장할 수 있는 서비스인 Azure Native New Relic Service를 강화합니다. [Azure Native New Relic Service에 대해 자세히 알아보세요.](/docs/infrastructure/microsoft-azure-integrations/get-started/azure-native)
