...
2. **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Azure** 로 이동하여 **Azure Monitor** 통합을 찾으세요.
...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="엔티티"
  >
    공개 미리 보기의 일부로 엔터티의 일부 목록을 사용할 수 있습니다. 사용자 정의를 만들 수 있습니다 <InlinePopover type="dashboards"/>그리고 <InlinePopover type="alerts"/>새로운 지표 위에.
...
1. **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Azure** 로 이동한 다음 **Manage Services** \[서비스 관리를] 클릭합니다.
2. 새로운 **Azure Monitor metrics** \[Azure Monitor 메트릭] 통합을 활성화하고 **Save Changes** \[변경 내용 저장을] 클릭합니다.<img title="Shows where to enable the Azure monitor" alt="Shows where to enable the Azure monitor" src={infrastructureAzureMonitorMetricsIntegration}/>
