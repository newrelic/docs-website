...
이러한 이유로 뉴렐릭은 [설정 옵션을](/docs/integrations/new-relic-integrations/getting-started/configure-polling-frequency-data-collection-cloud-integrations) 통해 Azure Storage의 폴링 빈도를 5분 간격으로 설정할 수 있더라도 보수적인 폴링 기간(예: 30분)으로 시작할 것을 권장합니다. 그런 다음 [인프라 통합의 <DNT>**Account status**</DNT> 대시보드](/docs/infrastructure/integrations/find-use-infrastructure-integration-data) 에서 <DNT>**Remaining hourly quota**</DNT> 차트를 확인한 후 필요에 따라 폴링 기간을 변경할 수 있습니다.
