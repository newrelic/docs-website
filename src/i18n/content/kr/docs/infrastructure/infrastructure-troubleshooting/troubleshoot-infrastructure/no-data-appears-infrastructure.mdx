...
5. 호스트에 [고유한 호스트명](/docs/infrastructure/new-relic-infrastructure/getting-started/compatibility-requirements-new-relic-infrastructure#hostname)이 있는지 확인하고, 호스트명이 `localhost`이(가) 아닌지 확인하십시오. 자세한 내용은 이 [지원 포럼 게시물](https://support.newrelic.com/s/hubtopic/aAX8W0000008ZJa/relic-solution-a-common-reason-host-failing-the-infrastructure-dashboard)을 참조하십시오.
