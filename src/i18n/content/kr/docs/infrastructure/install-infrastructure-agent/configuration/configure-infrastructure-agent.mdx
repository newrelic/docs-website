...
<CollapserGroup>
  ...
  >
    ...
    * <DNT>**From inside the config file:**</DNT> 에이전트가 사용자가 설정한 환경 변수를 가져올 수 있도록 [인프라 구성 파일](https://github.com/newrelic/infrastructure-agent/blob/master/assets/examples/infrastructure/newrelic-infra-template.yml.example) 에 항목을 추가합니다.
    ...
    * <DNT>**From the command line:**</DNT> 이러한 설정을 전달하려면 다른 환경 변수를 사용하십시오.
