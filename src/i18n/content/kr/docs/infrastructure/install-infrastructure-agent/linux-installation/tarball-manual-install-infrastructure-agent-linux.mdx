...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        [버전 1.4.0](/docs/release-notes/infrastructure-release-notes/infrastructure-agent-release-notes/new-relic-infrastructure-agent-140) 부터 인프라 에이전트 패키지에는 [실행 중인 에이전트의 문제](/docs/infrastructure/install-configure-manage-infrastructure/manage-your-agent/troubleshoot-running-agent) 를 해결하는 데 사용되는 추가 `newrelic-infra-ctl` 바이너리가 포함되어 있습니다. 이 바이너리는 에이전트를 실행하는 데 필요하지 않지만 경로에 추가하는 것이 좋습니다.
      </td>
    </tr>
...
1. [패키지된 에이전트 파일](https://download.newrelic.com/infrastructure_agent/binaries/linux/) 을 다운로드합니다.
