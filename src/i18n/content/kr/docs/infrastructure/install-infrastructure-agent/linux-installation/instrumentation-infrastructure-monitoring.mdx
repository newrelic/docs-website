...
* [v1.12](https://docs.docker.com/engine/release-notes/prior-releases/#1120-2016-07-28) 에서 [v23](https://docs.docker.com/engine/release-notes/23.0/)까지의 엔진이 포함된 Docker
