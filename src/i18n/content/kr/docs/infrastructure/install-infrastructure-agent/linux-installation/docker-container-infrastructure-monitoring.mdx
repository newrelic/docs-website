...
1. [](/docs/infrastructure/new-relic-infrastructure/configuration/configure-infrastructure-agent)뉴렐릭 <InlinePopover type="licenseKey" />`newrelic-infra.yml`로 에이전트 구성 파일을 생성합니다. 구성 옵션에 대한 자세한 설명은 [구성 설정](/docs/infrastructure/install-configure-infrastructure/configuration/infrastructure-configuration-settings)을 참조하십시오.
...
3. [](/docs/infrastructure/new-relic-infrastructure/configuration/configure-infrastructure-agent)뉴렐릭 <InlinePopover type="licenseKey" />`newrelic-infra.yml`로 에이전트 구성 파일을 생성합니다. 구성 옵션에 대한 자세한 설명은 [구성 설정](/docs/infrastructure/install-configure-infrastructure/configuration/infrastructure-configuration-settings)을 참조하십시오.
