...
1. 뉴렐릭 [라이선스 키로](/docs/accounts/install-new-relic/account-setup/license-key) `newrelic-infra.yml` 에이전트 [구성 파일](/docs/infrastructure/new-relic-infrastructure/configuration/configure-infrastructure-agent)을 생성합니다. 자세한 구성 옵션 설명은 [구성 설정](/docs/infrastructure/install-configure-infrastructure/configuration/infrastructure-configuration-settings)을 참조하십시오.
...
3. 뉴렐릭 [라이선스 키로](/docs/accounts/install-new-relic/account-setup/license-key) `newrelic-infra.yml` 에이전트 [구성 파일](/docs/infrastructure/new-relic-infrastructure/configuration/configure-infrastructure-agent)을 생성합니다. 자세한 구성 옵션 설명은 [구성 설정](/docs/infrastructure/install-configure-infrastructure/configuration/infrastructure-configuration-settings)을 참조하십시오.
