...
* **[one.newrelic.com](https://one.newrelic.com) > Infrastructure** **> Hosts > Containers** 로 이동합니다.

  또는

* **[one.newrelic.com](https://one.newrelic.com) > Infrastructure** **> Third-party services** 로 이동하여 Docker 관련 링크를 선택합니다.
...
1. **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI** 로 이동합니다.

   또는

   **[one.newrelic.com](https://one.newrelic.com) > Infrastructure > Settings > Alerts** 로 이동합니다.
