...
수동 설치를 원하는 경우 PowerShell 스크립트를 사용하거나 단계별 지침을 따를 수 있습니다.
...
<CollapserGroup>
  ...
  >
    ...
    4. `C:\Program Files\New Relic\newrelic-infra\` 에 있는 `newrelic-infra.yml` 의 `license_key` 속성에 [라이센스 키를](/docs/apis/intro-apis/new-relic-api-keys/#license-key) 추가합니다. 완료되면 `newrelic-infra.yml` 의 내용은 다음과 같아야 합니다.
