...
다음 예에서는 <InlinePopover type="licenseKey" /> 설정하고 아웃바운드 통신을 위한 프록시 서버를 구성하고 하나의 사용자 정의 [속성을](/docs/using-new-relic/welcome-new-relic/get-started/glossary#attribute)추가합니다.
