...
지원되는 [Amazon Web Services 계정](http://aws.amazon.com/elasticbeanstalk/) 이 있는지 확인하십시오. 또한 New Relic을 설치하려면 <LicenseKey/> 가 필요합니다. 계정 [가입](http://newrelic.com/signup "링크가 새 창에서 열립니다.") 시 New Relic에서 제공하는 40자의 16진수 문자열입니다.
...
2. 운영 체제에 따라 파일에 다음 콘텐츠를 추가하고 `YOUR_LICENSE_KEY` 을 New Relic <LicenseKey/> 바꿉니다.
