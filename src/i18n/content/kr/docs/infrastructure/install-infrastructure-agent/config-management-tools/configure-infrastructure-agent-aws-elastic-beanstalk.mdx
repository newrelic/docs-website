...
성공적으로 설정한 후 인덱스가 뉴렐릭에 표시되기 시작하는 데 최대 15분이 걸릴 수 있습니다. <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DoNotTranslate> 에서 호스트의 인프라 페이지를 확인하세요.
