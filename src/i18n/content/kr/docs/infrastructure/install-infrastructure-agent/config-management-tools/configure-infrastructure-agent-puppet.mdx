...
`newrelic_installer` 모듈을 사용하여 New Relic의 인프라 에이전트, 로그 통합 및 PHP APM 에이전트를 설치하고 구성하는 방법을 알아보세요. Puppet 사용 방법에 대한 설명은 [Puppet 설명서 를](https://docs.puppet.com)참조하십시오. 이것은 [지역 사회가 지원하는](https://github.com/newrelic/puppet-install) 노력입니다.
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        * `'logs'` - New Relic Infrastructure Agent에 대한 로그 통합. \*_ `'infrastructure'`필요_
