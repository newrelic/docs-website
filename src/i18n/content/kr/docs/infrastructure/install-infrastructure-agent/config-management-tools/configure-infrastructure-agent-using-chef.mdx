...
`newrelic_install` 리소스 관리자는 최소한의 구성으로 [가이드 설치를](/docs/infrastructure/host-integrations/installation/new-relic-guided-install-overview) 사용하여 New Relic을 구성합니다. 그것은:
