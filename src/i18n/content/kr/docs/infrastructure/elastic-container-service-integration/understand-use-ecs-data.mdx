...
1. [one.newrelic.com](https://one.newrelic.com) 으로 이동하여 [**탐색기**](/docs/new-relic-one/use-new-relic-one/ui-data/new-relic-one-entity-explorer-view-performance-across-apps-services-hosts) 를 선택합니다.
