...
1. 뉴렐릭의 ECS 통합 작업을 등록하려면 [이 스택](https://console.aws.amazon.com/cloudformation/home#/stacks/create/review?templateURL=https://nr-downloads-main.s3.amazonaws.com/infrastructure_agent/integrations/ecs/cloudformation/task/master.yaml&stackName=NewRelicECSIntegration)을 배포합니다. 원하는 지역에 스택을 배포하고 있는지 확인합니다. 이 스택은 다음 리소스를 생성합니다.
