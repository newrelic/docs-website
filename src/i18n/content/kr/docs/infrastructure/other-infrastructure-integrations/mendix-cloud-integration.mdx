...
1. <DNT>**Developer Portal**</DNT> 에서 앱의 <DNT>**Environment**</DNT> 페이지로 이동합니다.

2. 뉴렐릭으로 모니터링하려는 환경에서 <DNT>**Details**</DNT> 클릭하세요.

3. <DNT>**Details**</DNT> 탭으로 전환하세요.
   ...
   <table>
     ...
     <tbody>
       <tr>
         ...
         <td>
           뉴렐릭 [클러스터](/docs/apis/intro-apis/new-relic-api-keys/).
         </td>
       </tr>
       ...
       <tr>
         ...
         <td>
           뉴렐릭의 로그 API에 대한 URI입니다. 자세한 내용은 [뉴렐릭 지역을](https://docs.mendix.com/developerportal/operate/newrelic-metrics/#uri-regions) 참조하세요. 유효한 값은 [로그 API로 로깅 데이터 전송](/docs/logs/log-api/introduction-log-api/) 을 참조하십시오. 예: `https://log-api.eu.newrelic.com/log/v1` (EU), `https://log-api.jp.nr-data.net/log/v1` (일본)
         </td>
       </tr>
       ...
       <tr>
         ...
         <td>
           뉴렐릭 메트릭 API의 URI입니다. 자세한 내용은 [뉴렐릭 지역을](https://docs.mendix.com/developerportal/operate/newrelic-metrics/#uri-regions) 참조하세요. 유효한 값은 [메트릭 API를 통한 메트릭 보고를](/docs/data-apis/ingest-apis/metric-api/report-metrics-metric-api/) 참조하세요. 예: `https://metric-api.eu.newrelic.com/metric/v1` (EU), `https://metric-api.jp.nr-data.net/metric/v1` (일본).
         </td>
       </tr>

       <tr>
         <td>
           `NEW_RELIC_APP_NAME` (선택 과목)
         </td>
       ...
       <tr>
         <td>
           `LOGS_REDACTION` (선택 과목)
         </td>

         <td>
           로그 항목이 New Relic으로 전송되기 전에 이메일 주소가 자동으로 수정됩니다. 이 수정을 비활성화하려면 `LOGS_REDACTION` `false` 로 설정하세요. 기본값: `true`.
         </td>
       </tr>
     </tbody>
   </table>

5. 앱의 <DNT>**Environments**</DNT> 페이지로 돌아가서 앱을 선택한 환경으로 <DNT>**Deploy**</DNT> 또는 <DNT>**Transport**</DNT> 하세요.
