          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  **Host:** [https://cloud.getdbt.com/api/v2/accounts/ACCOUNT\_ID/](https://cloud.getdbt.com/api/v2/accounts/ACCOUNT_ID/) (`ACCOUNT_ID`을 dbt Cloud 계정 ID로 바꾸십시오)
              ...
              <tr>
                ...
                <td>
                  **Host:** [https://insights-collector.newrelic.com/v1/accounts/ACCOUNT\_ID/events](https://insights-collector.newrelic.com/v1/accounts/ACCOUNT_ID/events) (`ACCOUNT_ID`을 계정 ID로 바꾸십시오)
              ...
              <tr>
                ...
                <td>
                  **Host:** [https://insights-api.newrelic.com/v1/accounts/ACCOUNT\_ID/query](https://insights-api.newrelic.com/v1/accounts/ACCOUNT_ID/query) (`ACCOUNT_ID`을 계정 ID로 바꾸십시오)
