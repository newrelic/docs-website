...
<Steps>
    ...
    * AWS 엑스레이
    ...
    <CollapserGroup>
      ...
      <Collapser id="without-template" title="CloudFormation 템플릿 없이 마이그레이션">
        ...
        1. [AWS 콘솔에서 수동으로 통합](/docs/infrastructure/amazon-integrations/aws-integration-for-metrics/manual/) 을 참조하여 단계를 완료하세요.
        2. 이전 AWS 공급자 계정에서 [불필요한 모든 폴링 통합을 비활성화합니다](/docs/infrastructure/amazon-integrations/connect/uninstall-aws/) .
  ...
  <Step>
    ## 메트릭 스트림 데이터를 검증하십시오. [#validate-data]
