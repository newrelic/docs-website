...
* <DoNotTranslate>**Open issues**</DoNotTranslate>

  : AWS 인프라에 영향을 미칠 수 있는 문제를 표시합니다.

* <DoNotTranslate>**Scheduled changes**</DoNotTranslate>
...
1. <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS**</DoNotTranslate>

   으)로 이동합니다.

2. 사용 가능한 AWS 상태 통합 링크를 선택합니다.

3. AWS 상태 이벤트가 생성, 수정 또는 삭제되는 타임라인을 보려면
   ...
   [ 페이지를](/docs/infrastructure/new-relic-infrastructure/infrastructure-ui-pages/infrastructure-events-page-live-feed-every-config-change) 사용하세요.

## 이벤트 모니터링 및 경고 [#event-monitoring]

AWS 상태 이벤트는 <DoNotTranslate>**AwsHealthNotification**</DoNotTranslate> 이벤트로 수집됩니다. 이러한 이벤트를 기반으로 NRQL 공지를 쿼리하고, 생성하고, 정의할 수 있습니다.

다음 표는 <DoNotTranslate>**AwsHealthNotification**</DoNotTranslate> 이벤트에 사용할 수 있는 주요 속성을 보여줍니다.
