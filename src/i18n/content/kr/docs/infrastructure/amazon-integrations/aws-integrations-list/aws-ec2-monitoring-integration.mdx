...
[뉴렐릭 감시 모니터링 통합](/docs/infrastructure/introduction-infra-monitoring) 에는 EC2 감시 데이터를 뉴렐릭에 보고하기 위한 Amazon Elastic 컴퓨트 Cloud(EC2) 통합이 포함되어 있습니다. 이 문서에서는 통합 기능, 통합을 활성화하는 방법, 보고할 수 있는 데이터 등을 설명합니다.
