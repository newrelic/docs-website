...
<table>
  ...
  <tbody>
    <tr>
      <td>
        대시보드 및 [알림](/docs/infrastructure/new-relic-infrastructure/infrastructure-alert-conditions/infrastructure-alerts-add-edit-or-view-host-alert-information#integration)
      </td>

      <td>
        [**one.newrelic.com**](http://one.newrelic.com) **> Infrastructure > AWS** **> IoT** 로 이동합니다.
      </td>
    </tr>
...
AWS IoT에 대한 [인벤토리 데이터를 보려면](/docs/integrations/new-relic-integrations/getting-started/understand-use-data-infrastructure-integrations#overview) [**one.newrelic.com**](https://one.newrelic.com) **> Infrastructure > Inventory** 로 이동하여 다음을 검색하거나 선택합니다.
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            요청을 트리거한 규칙에 의해 지정된 [작업 유형](http://docs.aws.amazon.com/iot/latest/developerguide/iot-rule-actions.html) 입니다.
          </td>
        </tr>
      </tbody>
    </table>
