...
1. RDS 강화 모니터링 활성화가 필요한 RDS 인스턴스를 지정합니다. 인스턴스를 생성하거나 수정할 때 이를 지정할 수 있습니다.
...
3. 서버리스 저장소에서 새 AWS Lambda 함수를 생성합니다.
...
1. <DNT>**AWS Console > CloudWatch > Logs**</DNT>

   에서 `RDSOSMetrics` 로그 그룹을 선택하고

   <DNT>**Actions > Create Lambda subscription filter**</DNT>

   적용합니다.

2. <DNT>**Lambda function**</DNT>

   에 대해 `newrelic-log-ingestion` 선택합니다.

3. <DNT>**Log Format**</DNT>
