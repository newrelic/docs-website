...
[통합 데이터를 보고 사용](/docs/infrastructure/integrations/find-use-infrastructure-integration-data) 하려면 **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS** 로 이동하여 AWS ALB 통합 링크 중 하나를 선택합니다.
...
New Relic Infrastructure Amazon 통합은 다음 Amazon ALB 데이터를 공급자 `Alb` 에 수집합니다.
...
New Relic Infrastructure Amazon 통합은 다음 Amazon NLB 데이터를 공급자 `Nlb` 에 수집합니다.
