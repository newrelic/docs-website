...
각 환경에 대해 보고할 측정항목을 선택한 후 Elastic Beanstalk는 `instance` 및 `environment` 데이터 객체가 생성되는 순간부터 인벤토리 데이터를 생성합니다.
...
[통합 데이터를 보고 사용](/docs/infrastructure/integrations/find-use-infrastructure-integration-data) 하려면 [**one.newrelic.com**](http://one.newrelic.com) **> Infrastructure > AWS** 로 이동하여 AWS Elastic Beanstalk 통합 링크 중 하나를 선택하십시오.
