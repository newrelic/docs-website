  ...
  >
    ...
    * 예상 비용
      ...
      **NRQL 예** : 실제 지출, 예측, 한도 및 사용량 대 금전적 비용이 있는 다양한 예산 테이블의 경우 다음 NRQL 쿼리를 실행합니다.
      ...
      <Callout variant="tip">
        `providerAccountId` 은 New Relic의 클라우드 서비스 계정 ID입니다. **제공자 계정** 옆에 있는 **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS** 에서 찾을 수 있습니다.
      </Callout>
  </Collapser>
