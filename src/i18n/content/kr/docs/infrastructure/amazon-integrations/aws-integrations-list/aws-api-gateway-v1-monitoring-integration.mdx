...
<Callout variant="tip">
  API Gateway v1(REST) 메트릭은 [CloudWatch Metric Streams 통합](/docs/infrastructure/amazon-integrations/aws-integrations-list/aws-metric-stream/) 및 Amazon API Gateway용 API 폴링 통합을 통해 모두 사용할 수 있습니다.
</Callout>
...
이 통합을 활성화하려면 다음 방법 중 하나를 사용하십시오:

* <DNT>**CloudWatch Metric Streams**</DNT> (권장): 절차에 따라 [CloudWatch Metric Streams를 설정](/docs/infrastructure/amazon-integrations/connect/aws-metric-stream-setup/)하십시오.
* <DNT>**API polling**</DNT>: [AWS 서비스를 뉴렐릭에 연결](/docs/infrastructure/infrastructure-integrations/getting-started/connect-aws-integrations-infrastructure)하려면 표준 절차를 따르십시오.
...
데이터를 쿼리하는 방법은 수집 방법에 따라 다릅니다:

* <DNT>**CloudWatch Metric Streams**</DNT>: 데이터는 차원 메트릭으로 보고됩니다. <DNT>**[one.newrelic.com](https://one.newrelic.com/all-capabilities) &gt; Metrics &amp; Events**</DNT> 로 이동하여 `aws.apigateway`(으)로 필터링합니다.
* <DNT>**API polling**</DNT>: 데이터는 `ApiGatewaySample` [이벤트 유형](/docs/data-apis/understand-data/new-relic-data-types/#event-data)으로 보고되며, 이를 [쿼리하고 탐색](/docs/using-new-relic/data/understand-data/query-new-relic-data)할 수 있습니다.
