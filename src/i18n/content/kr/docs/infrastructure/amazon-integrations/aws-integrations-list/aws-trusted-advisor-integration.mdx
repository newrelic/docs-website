...
[통합 데이터를 보고 사용](/docs/infrastructure/integrations/find-use-infrastructure-integration-data) 하려면 **[one.newrelic.com](https://one.newrelic.com) > Infrastructure > AWS** 로 이동하여 AWS Trusted Advisor 통합 링크를 선택합니다.
