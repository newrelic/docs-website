...
이 통합의 데이터를 [보고 사용](/docs/integrations/infrastructure-integrations/get-started/understand-use-data-infrastructure-integrations/) 하려면 **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS** 로 이동하여 Elasticsearch 통합 링크 중 하나를 선택하십시오.
