...
이 통합의 데이터를 [보고 사용](/docs/integrations/infrastructure-integrations/get-started/understand-use-data-infrastructure-integrations/) 하려면 **[one.newrelic.com](https://one.newrelic.com) > Infrastructure > AWS** 로 이동하여 Elasticsearch 통합 링크 중 하나를 선택하십시오.
...
통합은 이 ElasticSearch 데이터를 [인벤토리 데이터](/docs/infrastructure/integrations-getting-started/getting-started/understand-integration-data-data-types#inventory-data) 로 수집합니다.

### 구성

통합은 `aws/elasticsearch/cluster/config` 에서 이 데이터를 수집합니다.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Elasticsearch 도메인의 Amazon 리소스 이름(ARN).
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        도메인 생성 상태입니다. Elasticsearch 도메인 생성이 완료되면 True입니다. 도메인 생성이 아직 진행 중인 경우 False입니다.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        도메인 삭제 상태입니다. 도메인에 대한 삭제 요청을 받았지만 리소스 정리가 아직 진행 중인 경우 True입니다. 도메인이 삭제되지 않은 경우 False입니다.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        지정된 Elasticsearch 도메인의 고유 식별자입니다.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        인덱스 및 검색 요청을 제출하는 데 사용하는 Elasticsearch 도메인 엔드포인트.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Elasticsearch 도메인 구성의 상태입니다. `True` Amazon Elasticsearch Service가 구성 변경을 처리하는 경우. 구성이 활성인 경우 `False` .
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Elasticsearch 도메인 버전 업그레이드 상태입니다. `True` Amazon Elasticsearch Service가 버전 업그레이드를 진행 중인 경우. 구성이 활성인 경우 `False` .
      </td>
    </tr>
  </tbody>
</table>
...
통합은 `aws/elasticsearch/cluster/config/eBSOptions` 에서 이 데이터를 수집합니다.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        EBS 기반 스토리지가 활성화되었는지 여부를 지정합니다.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        프로비저닝된 IOPS EBS 볼륨(SSD)에 대한 IOPD를 지정합니다.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        EBS 기반 스토리지의 볼륨 유형을 지정합니다.
      </td>
    </tr>
  </tbody>
</table>

### 스냅샷 옵션 [#snapshotOptions]

통합은 `aws/elasticsearch/cluster/config/snapshotOptions` 에서 이 데이터를 수집합니다.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        서비스가 지정된 Elasticsearch 도메인의 일일 자동 스냅샷을 생성하는 시간을 UTC 형식으로 지정합니다.
      </td>
    </tr>
  </tbody>
</table>
...
통합은 `aws/elasticsearch/cluster/config/elasticsearchClusterConfig` 에서 이 데이터를 수집합니다.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        클러스터에 대해 활성 및 대기 상태인 전용 마스터 노드의 총 수입니다.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        전용 마스터 노드가 활성화되었는지 여부를 나타내는 부울 값입니다.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Elasticsearch 클러스터의 인스턴스 유형입니다.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        영역 인식이 활성화되었는지 여부를 나타내는 부울 값입니다.
      </td>
    </tr>
  </tbody>
</table>