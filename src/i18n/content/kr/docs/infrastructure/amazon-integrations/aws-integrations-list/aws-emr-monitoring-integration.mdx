...
[통합 데이터를](/docs/infrastructure/integrations/find-use-infrastructure-integration-data) 사용하려면 **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS** 로 이동하고 EMR 통합 링크 중 하나를 선택하십시오.
