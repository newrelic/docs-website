...
[통합 데이터](/docs/infrastructure/integrations/find-use-infrastructure-integration-data) 를 사용하려면 **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS** 로 이동하여 EMR 통합 링크 중 하나를 선택합니다.
