  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        이 값은 5분 간격으로 확인되며, 값 1은 확인 시 클러스터가 유휴 상태였음을 의미할 뿐 전체 5분 동안 유휴 상태였음을 의미하지는 않습니다. <DNT>**Recommendation:**</DNT> 오탐을 방지하려면 5분 단위 점검이 1회 이상 연속으로 이 값이 1인 경우 경고 값인 레버 값을 올리세요. 예를 들어, 이 값이 30분 이상 1이었다면 공지를 올립니다.
      </td>
    </tr>
