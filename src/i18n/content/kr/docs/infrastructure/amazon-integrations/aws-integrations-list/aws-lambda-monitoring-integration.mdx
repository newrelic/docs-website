...
<DNT>**We also offers a more in-depth Lambda monitoring feature**</DNT>. 자세한 내용은 [뉴렐릭 서버리스 모니터링 AWS Lambda](/docs/serverless-function-monitoring/aws-lambda-monitoring/get-started/introduction-new-relic-monitoring-aws-lambda) 참조하세요.
