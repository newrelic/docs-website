...
New Relic에 보고되는 데이터에는 연결 시간, 상태 확인, 첫 번째 바이트까지의 시간 및 기타 [메트릭이](#metrics)포함됩니다. Route 53 데이터는 사전 구축된 <InlinePopover type="dashboards"/>또한 [맞춤 검색어와 차트를](/docs/infrastructure/integrations-getting-started/getting-started/use-integration-data-new-relic-insights)만들 수도 있습니다.
...
통합 데이터를 찾으려면 **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS** 로 이동하고 Route 53 통합 링크 중 하나를 선택하십시오.
