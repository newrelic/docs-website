...
<Callout title="시사">
  ...
  이 기능은 현재 [사전 출시 정책](/docs/licenses/license-information/referenced-policies/new-relic-pre-release-policy) 에 따라 미리 보기 프로그램의 일부로 제공됩니다.<br />
</Callout>
...
<DNT>**Auto-Discovery**</DNT> 기능은 **[Advanced 컴퓨트](https://newrelic.com/pricing/compute#pricing_plan-compute)** 고객만 사용할 수 있습니다. 등록하려면 <DNT>**[one.newrelic.com &gt; Administration](https://one.newrelic.com/admin-portal) &gt; Preview &amp; Trials**</DNT> 으로 이동하여 <DNT>**AWS Auto-Discovery**</DNT> 에 등록하세요.
    ...
    <CollapserGroup>
      <Collapser id="metrics-data-type" title="메트릭 데이터 유형의 경우">
        ...
        1. 메트릭 통합 유형을 선택하세요:
           ...
           * <DNT>**[Integration via CloudFormation and CloudWatch metric stream](/docs/infrastructure/amazon-integrations/aws-integration-for-metrics/via-cloudformation-cwms/)**</DNT> 뉴렐릭에 대한 지표 스트림을 생성하는 데 권장되는 방법입니다.
      ...
      <Collapser id="log-data-type" title="로그 데이터 유형의 경우">
        ...
        4. 뉴렐릭 Logs API 엔드포인트 선택: 뉴렐릭 계정의 지역을 기준으로 시스템이 자동으로 엔드포인트를 설정합니다.
           ...
           * EU 계정의 경우 로그는 다음으로 전송됩니다. `https://log-api.eu.newrelic.com/log/v1`
           * 일본 계정의 경우, 로그는 다음으로 전송됩니다. `https://log-api.jp.nr-data.net/log/v1`
...
<Steps>
  ...
  <Step>
    ### AWS 통합 관리 [#manage-aws-integrations]

    1. [뉴렐릭](https://one.newrelic.com/) 계정에 로그인하고 <DNT>**Infrastructure &gt; AWS**</DNT> 으로 이동하세요.
    2. AWS 계정에 <DNT>Auto-Discovery</DNT> 활성화되어 있는지 확인하려면 <DNT>**Manage AWS Integrations**</DNT> 클릭하세요.
    3. AWS 계정에 대한 자동 검색을 활성화하려면 계정 목록에서 해당 계정에 대해 <DNT>**Install**</DNT> 클릭합니다.
    4. 자동 검색을 하려면 <DNT>**Install**</DNT> 클릭하세요.
  </Step>
...
<CollapserGroup>
  ...
  <Collapser id="disable-auto-discovery" title="자동 검색 비활성화">
    ...
    1. [뉴렐릭](https://one.newrelic.com/) 계정에 로그인하고 <DNT>**Infrastructure &gt; AWS**</DNT> 으로 이동하세요.
    2. AWS 계정에 <DNT>Auto-Discovery</DNT> 활성화되어 있는지 확인하려면 <DNT>**Manage Auto-Discovery**</DNT> 클릭하세요.
