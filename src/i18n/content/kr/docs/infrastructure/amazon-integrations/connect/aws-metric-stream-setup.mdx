...
* **[one.newrelic.com](https://one.newrelic.com/all-capabilities) >Infrastructure > AWS** 로 이동 **하여 AWS 계정 추가** 를 클릭한 다음 **Use metric streams** 을 클릭하고 단계를 따릅니다.
...
3. New Relic UI의 **지표 스트림** 모드에서 **새 AWS 계정을 추가합니다** . **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS** 로 이동 **하여 AWS 계정 추가** 를 클릭한 다음 **Use metric streams** 을 클릭하고 단계를 따릅니다.
