...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        메트릭을 내보내려는 계정과 연결된 <LicenseKey/> 입니다.
      </td>
...
<Callout variant="tip">
  AWS S3 또는 AWS Billing과 같은 글로벌 서비스에 대한 AWS CloudWatch 지표는 **us-east-1** 리전에서만 사용할 수 있습니다. 해당 지역에 구성된 활성 CloudWatch 지표 스트림이 있는지 확인하십시오.
</Callout>
