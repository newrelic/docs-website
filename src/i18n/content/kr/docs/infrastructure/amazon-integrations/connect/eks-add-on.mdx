...
1. <DoNotTranslate>**EKS Cluster > Add-Ons > Get More add-ons**</DoNotTranslate> 으로 이동합니다.
...
2. AWS Marketplace 추가 기능에서 뉴렐릭 Kubernetes 통합을 검색하거나 찾아보고 이동하여 확인란을 선택하고 <DoNotTranslate>**Next**</DoNotTranslate>을 클릭합니다.
...
3. 최신 기본 버전을 선택하거나 필요한 경우 대체 버전을 선택하고 <DoNotTranslate>**Next**</DoNotTranslate> 클릭합니다.
...
4. <DoNotTranslate>**Create**</DoNotTranslate> 을(를) 클릭합니다.
