...
AWS 데이터를 보려면: <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS**</DNT> 으로 이동하세요. 나열된 AWS 통합의 경우:

* 활성 스트림의 경우 <DNT>**Explore your data**</DNT> 링크를 선택하세요.

  또는

* 다른 통합의 경우 사용 가능한 대시보드를 찾아보거나 <DNT>**Explore Data**</DNT> 링크를 클릭하세요.
