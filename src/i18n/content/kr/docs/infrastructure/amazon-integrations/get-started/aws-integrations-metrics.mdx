...
## ## 차원 지표 명명 규칙 [#metric-naming-convention]
...
* 지표는 모두 소문자로 된 AWS 네임스페이스가 접두사로 붙습니다. 여기서 /는 로 바뀝니다. :
...
각 폴링 통합 및 해당 이름에서 사용 가능한 측정항목에 대한 참조는 [개별 통합에 대한 문서를 확인하세요](https://docs.newrelic.com/docs/infrastructure/amazon-integrations/get-started/introduction-aws-integrations/).

다음 표는 AWS 폴링 통합과 해당 [차원 지표](/docs/telemetry-data-platform/ingest-manage-data/understand-data/new-relic-data-types/#dimensional-metrics) 변환을 통해 수집된 지표의 포괄적이지 않은 목록입니다.
