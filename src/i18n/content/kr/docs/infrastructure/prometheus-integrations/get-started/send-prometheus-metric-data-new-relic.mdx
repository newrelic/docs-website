...
New Relic의 Prometheus 에이전트를 사용하면 Kubernetes 클러스터에서 Prometheus 메트릭을 쉽게 스크랩할 수 있습니다. 서비스 검색 및 Kubernetes 레이블을 활용하면 가장 인기 있는 워크로드의 메트릭, 대시보드 및 경고에 즉시 액세스할 수 있습니다.
