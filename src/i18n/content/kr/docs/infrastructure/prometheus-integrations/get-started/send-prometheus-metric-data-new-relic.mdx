...
New Relic의 Prometheus 에이전트를 사용하면 Kubernetes 클러스터에서 Prometheus 측정항목을 쉽게 스크랩할 수 있습니다. 서비스 검색 및 Kubernetes 레이블을 활용하면 지표, 대시보드 및 <InlinePopover type="alerts"/>가장 인기 있는 워크로드 중 하나입니다.
