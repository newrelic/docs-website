...
* 안내 설치를 사용하셨다면 <DNT>**Scrape all Prometheus endpoints**</DNT> 옵션을 선택하세요.<img title="Kubernetes Guided Install" alt="Kubernetes Guided Install" src={infrastructurePrometheusScrapeOnlyMetrics}/>
