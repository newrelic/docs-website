...
2. 통합이 올바르게 구성되었는지 확인하려면 <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com) > All capabilities > Query your data**</DoNotTranslate> 으로 이동하여 다음 NRQL 쿼리를 실행하여 데이터가 보고되었는지 확인하세요.
