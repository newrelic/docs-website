...
<CollapserGroup>
  ...
  <Collapser title="429: 속도 제한 오류">
    이는 한 번에 전송되는 데이터 양(예: 카디널리티)에 대한 [속도 제한](/docs/data-apis/ingest-apis/metric-api/metric-api-limits-restricted-attributes/#rate-limit-incidents) 에 도달했음을 의미합니다. 전송하는 Prometheus 또는 일반 메트릭 데이터의 양을 줄이거나 속도 제한 증가를 요청하여 문제를 해결할 수 있습니다.
  </Collapser>
</CollapserGroup>
