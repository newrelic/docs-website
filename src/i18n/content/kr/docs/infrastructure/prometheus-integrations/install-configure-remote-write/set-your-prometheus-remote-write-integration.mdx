...
다음으로 [Helm 차트](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/values.yaml) 의 해당 필드에 있는 Prometheus CRD(`kind:Prometheus`)에 다음을 추가합니다.
