...
4. [내장된](/docs/alerts-applied-intelligence/new-relic-alerts/learn-alerts/introduction-alerts/) 및 알림 에 액세스하려면 [Velero 퀵스타트를](https://newrelic.com/instant-observability/velero-prometheus) <InlinePopover type="dashboards" />설치하세요.
