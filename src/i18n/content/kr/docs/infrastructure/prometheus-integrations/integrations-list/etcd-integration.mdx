...
4. 내장된 대시보드 및 [경고에](/docs/alerts-applied-intelligence/new-relic-alerts/learn-alerts/introduction-alerts/) 액세스하려면 [Etcd 빠른 시작을](https://newrelic.com/instant-observability/etcd) 설치하십시오.
