...
4. 내장 대시보드 및 [경고](/docs/alerts-applied-intelligence/new-relic-alerts/learn-alerts/introduction-alerts/) 에 액세스하려면 [Redis(Prometheus) 빠른 시작을](https://newrelic.com/instant-observability/redis-prometheus) 설치하십시오.
