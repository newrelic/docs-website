...
4. [Redis (Prometheus) 퀵스타트를](https://newrelic.com/instant-observability/redis-prometheus) 설치하여 기본 제공 <InlinePopover type="dashboards" />및 [알림에](/docs/alerts-applied-intelligence/new-relic-alerts/learn-alerts/introduction-alerts/) 액세스하세요.
