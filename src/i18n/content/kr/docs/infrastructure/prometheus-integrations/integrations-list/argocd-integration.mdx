...
4. 내장된 기능에 액세스하려면 [Argo CD 빠른 시작을](https://newrelic.com/instant-observability/argocd-quickstart) 설치하십시오. <InlinePopover type="dashboards"/>및 [경고](/docs/alerts-applied-intelligence/new-relic-alerts/learn-alerts/introduction-alerts/).
