...
4. 기본 제공 대시보드 및 [경고](/docs/alerts-applied-intelligence/new-relic-alerts/learn-alerts/introduction-alerts/) 에 액세스하려면 [NGINX 인그레스 컨트롤러 빠른 시작을](https://newrelic.com/instant-observability/nginx-ingress-controller) 설치하세요.
