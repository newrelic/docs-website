...
Prometheus 통합 데이터에 대한 NRQL 쿼리 결과를 보려면: **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Query your data 으로 이동** . 자세한 내용은 [쿼리 작성기 설명서](/docs/chart-builder/use-chart-builder/get-started/introduction-chart-builder) 를 참조하십시오.
