...
<CollapserGroup>
  ...
  <Collapser
    id="avg-free-memory"
    title={<><img src={dockerLogoCrop} title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}/>Docker: 스크래핑된 엔드포인트에 대한 평균 여유 메모리 보기</>}
  >
  ...
  <Collapser
    ...
    title={<><img src={imgIntegrationK8S402X} title="img-integration-k8.png" alt="img-integration-k8.png" style={{ height: '35px', width: '40px' }}/>쿠버네티스: 배포에서 파드의 평균 메모리 사용량 보기</>}
  >
...
Prometheus 통합 데이터에 대한 NRQL 쿼리 결과를 보려면 **[one.newrelic.com](https://one.newrelic.com) > Query your data**로 이동합니다. 보다 자세한 내용은 [Query Builder 문서](/docs/chart-builder/use-chart-builder/get-started/introduction-chart-builder)를 참조하십시오.
