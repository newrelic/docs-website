...
[메트릭 이름과 속성](#nrql-examples)을 사용하여 데이터를 쿼리할 수 있습니다. 패싯, 시계열 및 시간 선택에 대한 보다 자세한 내용은 [NRQL 문서](/docs/query-data/nrql-new-relic-query-language/getting-started/nrql-syntax-components-functions)를 참조하십시오.
...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="OpenMetrics를 사용하여 파드당 연결된 Redis 클라이언트 보기"
  >
    <img
      style={{ width: '40px', height: '35px'}}
      class="inline"
  ...
  <Collapser
    ...
    title={<><img src="/images/os_icon_k8.webp" title="img-integration-k8.png" alt="img-integration-k8.png" style={{ height: '35px', width: '40px' }}/>쿠버네티스: 배포에서 파드의 평균 메모리 사용량 보기</>}
  >
...
Prometheus 통합 데이터에 대한 NRQL 쿼리 결과를 보려면, <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Query your data**</DNT>로 이동합니다. 자세한 내용은 [쿼리 빌더 문서](/docs/chart-builder/use-chart-builder/get-started/introduction-chart-builder)를 참조하십시오.
