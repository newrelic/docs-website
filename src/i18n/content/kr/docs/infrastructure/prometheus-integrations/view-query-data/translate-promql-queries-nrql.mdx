...
<CollapserGroup>
  ...
  >
    ...
    <figcaption>
      <DoNotTranslate>**PromQL-style example:**</DoNotTranslate> 데이터를 필터링하려면 PromQL 스타일 쿼리: container_memory_usage_bytes&#x7B;id="/".
    </figcaption>
  </Collapser>
  ...
  >
    ...
    <figcaption>
      <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Query your data**</DoNotTranslate>: 이 예는 FROM Metric SELECT keyset() WHERE metricName = 'container_memory_usage_bytes'을 실행한 후 표시되는 데이터를 보여줍니다.
    </figcaption>
    ...
    <figcaption>
      <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Query your data**</DoNotTranslate>: 이 예는 FROM Metric SELECT latest(container_memory_usage_bytes) FACET id을 실행한 후 표시되는 데이터를 보여줍니다.
    </figcaption>
    ...
    <figcaption>
      <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Query your data**</DoNotTranslate>: 이 예는 `From Metric select latest(container_memory_usage_bytes) where id = "/" timeseries` 실행 후 표시되는 데이터를 보여줍니다.
    </figcaption>
  </Collapser>
</CollapserGroup>
