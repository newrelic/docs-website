...
<Callout variant="tip">
  [뉴렐릭 One](/docs/new-relic-one/use-new-relic-one/get-started/introduction-new-relic-one) 에서 PromQL 스타일 쿼리를 실행하려면 [쿼리 빌더 고급 PromQL 스타일 모드](/docs/infrastructure/prometheus-integrations/view-query-data/view-query-your-prometheus-data/#build-query) 로 이동하세요.
</Callout>
