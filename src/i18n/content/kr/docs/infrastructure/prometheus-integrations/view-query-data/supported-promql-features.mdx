...
슬라이딩 윈도우 시계열 집계를 지원합니다. 자세한 내용은 [NRQL 참조](/docs/query-your-data/nrql-new-relic-query-language/get-started/nrql-syntax-clauses-functions#slide-by) 및 [슬라이딩 윈도우 심층 분석을](/docs/query-your-data/nrql-new-relic-query-language/nrql-query-tutorials/create-smoother-charts-sliding-windows)참조하세요.
