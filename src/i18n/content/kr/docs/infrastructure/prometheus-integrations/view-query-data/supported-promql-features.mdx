...
<CollapserGroup>
  <Collapser id="" title="집계 연산자 및 함수">
    * 집계 연산자:
...
* 즉각적인 쿼리를 제공할 때 최대 1분 이전의 데이터를 검사합니다. 스크랩 간격이 1분보다 길면 일부 쿼리에서 <DNT>**No data found**</DNT>(데이터를 찾을 수 없음)가 표시될 수 있습니다. 최소한 분당 한 번 데이터를 전송하여 이를 방지하십시오.
