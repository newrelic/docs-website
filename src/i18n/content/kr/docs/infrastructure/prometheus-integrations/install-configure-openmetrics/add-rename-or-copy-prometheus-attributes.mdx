...
New Relic Prometheus OpenMetrics 통합은 New Relic으로 보내기 전에 Docker 및 Kubernetes에 대한 Prometheus 메트릭을 변환하는 제어를 제공합니다. 통합 구성 파일에서 변환을 정의하면 모든 엔드포인트에 대해 변환이 수행됩니다.
