...
자세한 내용은 [Docker](/docs/integrations/prometheus-integrations/get-started/monitor-prometheus-new-relic#OpenMetrics) 및 [Kubernetes](/docs/integrations/prometheus-integrations/get-started/monitor-prometheus-new-relic#OpenMetrics) 에 대한 Prometheus OpenMetrics 통합 요구 사항을 참조하세요. [`NrIntegrationError` 이벤트에 대한 문제 해결 절차](/docs/integrations/prometheus-integrations/troubleshooting/rate-limit-errors-prometheus-integration) 도 참조하세요.
