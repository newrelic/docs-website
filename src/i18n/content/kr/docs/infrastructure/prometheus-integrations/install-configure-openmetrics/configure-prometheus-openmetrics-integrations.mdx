...
<CollapserGroup>
  <Collapser
    ...
    title={<><img src={imgIntegrationK8S402X} title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png" style={{ height: '35px', width: '40px' }}/>Kubernetes 포트 및 엔드포인트 경로</>}
  >
  ...
  <Collapser
    ...
    title={<><img src={imgIntegrationK8S402X} title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png" style={{ height: '35px', width: '40px' }}/>예: Kubernetes 포트 및 경로에 대한 레이블</>}
  >
