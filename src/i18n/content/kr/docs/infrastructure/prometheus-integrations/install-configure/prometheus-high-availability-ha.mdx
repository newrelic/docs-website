...
<Callout variant="caution">
  계정은 최대 1,500개의 고유한 Prometheus HA 클러스터를 가질 수 있습니다. 이 한도를 초과하면 추가 HA 클러스터의 데이터가 삭제됩니다. 이러한 경우 뉴렐릭은 `PrometheusHAClusterLimit` [`NrIntegrationError`](/docs/data-apis/ingest-apis/metric-api/troubleshoot-nrintegrationerror-events/) 이벤트를 생성합니다.
</Callout>
