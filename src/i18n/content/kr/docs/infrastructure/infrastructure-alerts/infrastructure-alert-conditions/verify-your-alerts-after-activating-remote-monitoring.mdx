...
이 문서에서는 그 이유를 설명합니다. <InlinePopover type="alerts"/>Apache, Cassandra, MySQL, Nginx 및 Redis 통합에서 [원격 모니터링을](/docs/remote-monitoring-host-legacy-integrations) 활성화하면 영향을 받으며 이러한 경우 진행 방법은 다음과 같습니다.
