...
<Callout variant="tip">
  조직이 미국 이외의 데이터센터 리전에서 데이터를 호스팅하는 경우 올바른 리전 엔드포인트를 사용하고 있는지 확인하십시오. [데이터센터 리전 및 엔드포인트에 대해 자세히 알아보십시오.](/docs/accounts/accounts-billing/account-setup/choose-your-data-center)
</Callout>
