  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * 제외 필터링을 사용하여 조건을 생성하십시오(예: `environment NOT LIKE x`). 이에 대한 자세한 내용은 [제외 필터링에 대한 이 게시물](https://support.newrelic.com/s/hubtopic/aAX8W0000008Znr/relic-solution-use-the-infrastructure-alerts-rest-api-pt-1)을 참조하십시오.
...
<Callout variant="tip">
  조직이 미국(기본값) 이외의 데이터센터 리전에서 데이터를 호스팅하는 경우 올바른 리전 엔드포인트를 사용하고 있는지 확인하십시오. [데이터센터 리전 및 엔드포인트에 대해 자세히 알아보십시오.](/docs/accounts/accounts-billing/account-setup/choose-your-data-center)
</Callout>
