  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <DNT>**Process samples**</DNT> 다음 지표를 보고하지 마세요:
        ...
        * 초당 I/O 쓰기 수
          ...
          다음 <DNT>**inventory sources**</DNT> (는) 보고되지 않습니다.
...
<CollapserGroup>
  <Collapser id="root-rootless" title="루트에서 특권/비특권으로">
    실행 모드 <DNT>**from root to privileged or unprivileged**</DNT> 를 전환하려면 이 문서의 설치/업데이트 지침을 따르세요.
  </Collapser>

  <Collapser id="rootless-root" title="특권/비특권에서 다른 모드로">
    실행 모드를 변경하려면 <DNT>**from privileged or unprivileged to any other mode:**</DNT>
