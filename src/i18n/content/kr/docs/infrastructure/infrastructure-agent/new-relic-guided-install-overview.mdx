...
시작할 준비가 되셨습니까? <DNT>**Guided install**</DNT> 버튼을 클릭합니다. 또는 조직이 [EU 데이터센터](/docs/using-new-relic/welcome-new-relic/get-started/our-eu-us-region-data-centers)에 위치한 경우 <DNT>**EU Guided install**</DNT>을 클릭합니다. 또는 조직이 [JP 데이터센터](/docs/accounts/accounts-billing/account-setup/choose-your-data-center)에 위치한 경우 <DNT>**JP Guided install**</DNT>를 클릭합니다.
