...
* APM: **[one.newrelic.com > All capabilties](https://one.newrelic.com/all-capabilities) > APM & services** > (앱 선택) > **Summary** \[요약] 으로 이동합니다.
* 트랜잭션: **[one.newrelic.com > All capabilties](https://one.newrelic.com/all-capabilities) > APM & services** 으로 이동합니다. 앱을 선택한 다음 **Monitor** \[모니터] 섹션에서 **Transactions** \[트랜잭션을] 클릭합니다.