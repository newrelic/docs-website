...
* APM: **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM > (앱 선택) > Summary** 이동합니다.
* 트랜잭션: **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM > (앱 선택) > Monitor > Transactions** 으로 이동합니다.