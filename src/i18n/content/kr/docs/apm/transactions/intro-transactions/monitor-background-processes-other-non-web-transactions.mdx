...
* APM: **[one.newrelic.com](https://one.newrelic.com/all-capabilities) APM & services > (앱 선택) > Summary** 이동합니다.
* 거래: **[one.newrelic.com](https://one.newrelic.com/all-capabilities) APM & services > (앱 선택) > Monitor > Transactions** 로 이동합니다.