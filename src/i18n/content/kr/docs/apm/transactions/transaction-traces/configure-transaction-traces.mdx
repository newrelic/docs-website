...
New Relic 에이전트에 대해 서버측 구성 설정을 사용할 수 있는 경우 **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM & services > (앱 선택) > Settings > Application > Server-side agent configuration** 에서 확인할 수 있습니다.
