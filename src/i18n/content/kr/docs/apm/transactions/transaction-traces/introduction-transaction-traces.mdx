...
1. 다음 중 하나를 수행합니다.
   ...
   * New Relic Explorer: **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Explorer > (앱 선택) > Monitor > Transactions** 로 이동합니다.
   * APM: **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM & services > (앱 선택) > Monitor > Transactions** 으로 이동합니다.
