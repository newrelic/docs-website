...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <DNT>**transaction_events**</DNT> 섹션에서 `max_samples_stored` 에 대한 [설정을](/docs/agents/java-agent/configuration/java-agent-configuration-config-file#ae-max_samples_stored) 조정합니다.
      </td>
    </tr>
