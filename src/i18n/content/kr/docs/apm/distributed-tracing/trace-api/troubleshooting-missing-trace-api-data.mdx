...
* 범위 데이터가 보고되었는지 확인하려면 방금 업로드한 범위에 대해 [쿼리 빌더](https://one.newrelic.com/launcher/nr1-core.home#pane=eyJuZXJkbGV0SWQiOiJucjEtY29yZS5zZWFyY2gtcm9vdCJ9&overlay=eyJvdmVybGF5SWQiOiJ3YW5kYS1kYXRhLWV4cGxvcmF0aW9uLm5ycWwtZWRpdG9yIiwibmVyZGxldElkIjoid2FuZGEtZGF0YS1leHBsb3JhdGlvbi5kYXRhLWV4cGxvcmVyIiwiaW5pdGlhbEFjdGl2ZUludGVyZmFjZSI6Im5ycWxFZGl0b3IiLCJpbml0aWFsQWNjb3VudElkIjoxfQ==) 에서 NRQL 쿼리를 실행하세요. 트레이스 데이터를 보고하는 데 사용된 것과 동일한 블루렐릭 계정에 있어야 합니다(동일한 <InlinePopover type="licenseKey"/>). 예시 쿼리:
...
* 범위에 타임스탬프가 있는 경우 다음 지침을 충족하는지 확인하세요.
  ...
  * `newrelic`-형식 타임스탬프는
    ...
    이어야 합니다. [currentmillis.com](https://currentmillis.com) 에서 현재 시간을 밀리초 단위로 확인할 수 있습니다.
