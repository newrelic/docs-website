...
**End user** \[최종 사용자] [계층](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#tier) 에 대한 브라우저 측정항목은 [다음을 설치한 경우에만 사용할 수 있습니다. <InlinePopover type="browser"/>대리인](/docs/browser/new-relic-browser/getting-started/browser-settings).
