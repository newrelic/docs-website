...
차트의 배경이 연한 빨간색이면 경고 조건의 [**Critical** \[중요\] 임계값이](/docs/alerts/new-relic-alerts/defining-conditions/define-thresholds-trigger-alert) 위반된 기간을 나타냅니다. 알림 에서 [인시던트](/docs/alerts/new-relic-alerts/getting-started/introduction-new-relic-alerts) 세부 [정보를 보려면 차트를 클릭합니다.](/docs/alerts-applied-intelligence/new-relic-alerts/alert-incidents/view-event-details-incidents)
