...
* New Relic Explorer: **[one.newrelic.com](https://one.newrelic.com) > Explorer > (앱 선택) > 모니터 > Monitor > External services** 로 이동합니다.
* APM: **[one.newrelic.com](https://one.newrelic.com) > APM > (앱 선택) > Monitor > External services** 로 이동합니다.
