...
Explorer에서 서비스를 선택하면 왼쪽 탐색 창에서 외부 서비스 기능을 사용할 수 있습니다. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM & Services** 로 이동하여 열 수 있습니다.앱을 선택한 다음 **Monitor** \[모니터] 섹션에서 **External services** \[외부 서비스] 를 클릭합니다.
...
6. 드릴다운에서 분산 추적을 보려는 지점에 도달하면 오른쪽 상단의 **목록** 을 클릭한 다음 **추적** 을 클릭합니다. 테이블에서.
