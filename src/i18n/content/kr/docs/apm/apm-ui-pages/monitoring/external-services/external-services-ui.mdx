...
* APM: **[one.newrelic.com](https://one.newrelic.com/all-capabilities) APM & services > (앱 선택) > Monitor > External services** 로 이동합니다.
...
4. 특정 트랜잭션에 가장 많은 시간이 소요된다고 판단되면 해당 트랜잭션을 클릭하여 해당 종속성에 중점을 둡니다.
