...
* New Relic Explorer: **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Explorer > (앱 선택) > 모니터 > Monitor > External services** 로 이동합니다.
* APM: **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM > (앱 선택) > Monitor > External services** 로 이동합니다.
...
4. 특정 트랜잭션에 가장 많은 시간이 걸린다고 판단되면 해당 트랜잭션을 클릭하여 해당 종속성에 중점을 둡니다.
...
6. 드릴다운에서 분산 추적을 보고 싶은 지점에 도달하면 오른쪽 상단의 **목록 **을 클릭한 다음 테이블에서 **추적 **을 클릭합니다.
