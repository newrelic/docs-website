...
* **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM > (앱 선택)** 으로 이동한 다음 선택한 앱의 **Summary** 페이지에서 **Error rate** 표 제목을 클릭합니다.

  또는

* **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM > (앱 선택) > Events > Errors** 로 이동합니다.
