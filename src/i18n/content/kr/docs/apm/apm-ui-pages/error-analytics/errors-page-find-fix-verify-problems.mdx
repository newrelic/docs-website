...
* **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM & services > (앱 선택)** 으로 이동한 다음 선택한 앱의 **Error rate** 페이지에서 **Summary** 표의 제목을 클릭합니다.

  또는

* **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM & services > (앱 선택) > Events > Errors** 로 이동합니다.
