...
<Callout variant="important">
  이전 배포 마커 대신 [태킹 변경](/docs/change-tracking/change-tracking-introduction/) 기능을 사용하는 것이 좋습니다. 배포 마커 기능을 사용해 왔다면 계속 사용할 수 있지만 변경 사항 태킹 기능은 APM뿐만 아니라 브라우저와 모바일에서도 사용할 수 있습니다.
</Callout>
...
5. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > ( [사용자 메뉴](/docs/accounts/accounts-billing/general-account-settings/intro-account-settings) ) > Account settings > Integrations > Deploy notifications > Webhook** 으로 이동합니다.
