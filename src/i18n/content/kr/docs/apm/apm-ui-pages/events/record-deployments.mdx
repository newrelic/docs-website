    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            <DoNotTranslate>**Required**</DoNotTranslate>. [요약](/docs/apm/applications-menu/monitoring/apm-overview-page) 페이지와 [구현 배포](/docs/apm/applications-menu/events/deployments-page) 페이지에 표시되는 이 구현의 고유 ID입니다. 임의의 문자열일 수 있지만 일반적으로 버전 번호 또는 Git 체크섬입니다.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**Optional**</DoNotTranslate>. 이 구현, 구현에서 변경된 사항에 대한 요약은 <DoNotTranslate>**(selected deployment) > Change log**</DoNotTranslate> 선택하면 [구현, 배포](/docs/apm/applications-menu/events/deployments-page) 페이지에 표시됩니다.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**Optional**</DoNotTranslate>. 이 구현, 배포에 대한 상위 수준 설명은 개별 구현, 배포를 선택할 때 [요약](/docs/apm/applications-menu/monitoring/apm-overview-page) 페이지 및 [구현, 배포](/docs/apm/applications-menu/events/deployments-page) 페이지에 표시됩니다.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**Optional**</DoNotTranslate>. [요약](/docs/apm/applications-menu/monitoring/apm-overview-page) 페이지 및 [구현, 배포](/docs/apm/applications-menu/events/deployments-page) 페이지에 표시되는 구현, 배포와 연결할 사용자 이름입니다.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**Optional**</DoNotTranslate>. 구현, 배포가 발생했을 때 두 번째까지. 지정하지 않으면 API 호출을 수신한 시점에 구현, 배포가 기록됩니다. 타임스탬프 요구 사항:
