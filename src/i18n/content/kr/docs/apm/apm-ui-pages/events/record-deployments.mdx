...
<Callout variant="important">
  이전 배포 마커 대신 [변경 내용 추적](/docs/change-tracking/change-tracking-introduction/) 기능을 사용하는 것이 좋습니다. 배포 마커 기능을 사용해 온 경우에도 계속 사용할 수 있지만 변경 내용 추적 기능은 다음에 대해 사용할 수 있습니다. <InlinePopover type="browser"/>그리고 <InlinePopover type="mobile"/>, 게다가 <InlinePopover type="apm"/>.
</Callout>
