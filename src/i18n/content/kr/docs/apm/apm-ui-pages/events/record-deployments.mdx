...
* <DNT>
  ...
  : New Relic [REST API v2를](#api) 사용하세요.

* <DNT>
    **C**
  </DNT>

  : SDK 관련 메서드가 없습니다. [REST API를](#api) 사용하세요.

* <DNT>
    **Go**
  </DNT>

  : 에이전트별 방법이 없습니다. [REST API를](#api) 사용하세요.

* <DNT>
    **Java**
  </DNT>

  : [잔류 에이전트 `jar`를](/docs/agents/java-agent/instrumentation/recording-deployments-java-agent) 호출합니다.

* <DNT>
    **.NET**
  </DNT>

  : [PowerShell 및 REST API를](#powershell) 사용합니다.
...
* <DNT>
  ...
  : [PHP 스크립트를](/docs/agents/php-agent/features/recording-deployments-using-php-script) 사용하십시오.

* <DNT>
    **Python**
  </DNT>

  : `newrelic-admin` 스크립트의 [`record-deploy`](/docs/agents/python-agent/installation-configuration/python-agent-admin-script#record-deploy) 하위 명령을 사용합니다.

* <DNT>
    **Ruby**
  </DNT>

  : [Capistrano 레시피를](/docs/agents/ruby-agent/features/recording-deployments-ruby-agent#capistrano3) 사용하세요.
