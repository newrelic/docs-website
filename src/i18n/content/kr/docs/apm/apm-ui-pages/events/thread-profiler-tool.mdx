...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM & services > (앱 선택) > Events > Thread profiler**으로 이동합니다.
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM & services > (앱 선택) > Events > Thread profiler** : 이 페이지를 사용하여 스레드 프로파일러 기간에 대한 설정을 정의하고 결과를 볼 수 있습니다.
</figcaption>
