...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM > (앱 선택) > Events > Thread profiler** 로 이동합니다.
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM > (앱 선택) > Events > Thread profiler** : 이 페이지에서 스레드 프로파일러 기간에 대한 설정을 정의하고 결과를 볼 수 있습니다.
</figcaption>
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            스레드 프로파일러는 Ruby 애플리케이션 내에서 스레드 역추적을 캡처하는 기능에 따라 다릅니다. 이러한 이유로 **MRI 1.9.2 이상** 이 필요합니다( `Thread#backtrace` 메서드의 경우).
          </td>
        </tr>
