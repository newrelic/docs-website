...
<CollapserGroup>
  ...
  >
    ...
    <figcaption>
      <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & services > (select an app) > Monitor > Databases > (select a trace) > Trace details:**</DoNotTranslate> 앱 성능 문제의 원인이 될 수 있는 특정 데이터베이스 및 인스턴스에 대한 정보를 보려면 <DoNotTranslate>**Database**</DoNotTranslate> 아이콘을 선택하세요.
    </figcaption>
  </Collapser>
