...
* 새 유물 라이센스 키: [`license_key`](https://newrelic.github.io/c-sdk/struct__newrelic__app__config__t.html#aac3c5f9a0e5da64836a806c47b954b71)
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        앱 이름을 설정하거나 변경하려면 [라이선스 키](/docs/accounts/accounts-billing/account-setup/new-relic-license-key) , 로깅 수준, 트랜잭션 추적, 데이터 저장소 추적 등을 설정하고 다음을 사용합니다.
...
UI에서 애플리케이션의 별칭 또는 Apdex T 임계값을 변경하려면 **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM & services > (앱 선택) > Settings > Application**으로 이동합니다.
