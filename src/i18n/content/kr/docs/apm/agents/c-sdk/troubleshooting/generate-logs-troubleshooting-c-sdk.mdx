...
* <DNT>**C SDK logs:**</DNT> 이러한 로그는 뉴렐릭 C SDK API 호출을 사용하여 코드를 복사한 방법의 오류로 인해 생성됩니다.
* <DNT>**Daemon logs:**</DNT> 뉴렐릭으로의 데이터 전송과 관련된 로그입니다.
...
<CollapserGroup>
  <Collapser id="c-sdk-logs" title="C SDK 로그">
  ...
  <Collapser id="daemon-logs" title="데몬 로그">
