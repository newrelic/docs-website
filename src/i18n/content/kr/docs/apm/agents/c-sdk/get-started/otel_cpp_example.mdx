...
OpenTelemetry C++ 사용자는 [GitHub에 훌륭한 예제를](https://github.com/open-telemetry/opentelemetry-cpp/tree/main/examples) 많이 가지고 있습니다. OpenTelemetry C++ SDK 빌드 및 사용과 예제 빌드 및 실행에 대한 자세한 안내는 해당 [`CONTRIBUTING.md`](https://github.com/open-telemetry/opentelemetry-cpp/blob/main/CONTRIBUTING.md) 참조하세요.
...
1. 스팬 데이터를 보려면: <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) &amp;gt; Query your data**</DNT> 으로 이동하여 다음 쿼리를 입력하세요.
