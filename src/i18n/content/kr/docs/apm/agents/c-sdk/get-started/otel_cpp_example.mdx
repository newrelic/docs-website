...
1. 스팬 데이터를 보려면: <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Query your data**</DoNotTranslate> 으로 이동하여 다음 쿼리를 입력하세요.
