...
<Callout variant="tip">
  ...
  * [APM에 대한 영향은](/docs/apm/distributed-tracing/getting-started/transition-guide-distributed-tracing) 현재 <InlinePopover type="apm" />사용자이지만 분산 추적을 설정하지 않은 경우 예상되는 사항을 알려줍니다.
</Callout>
