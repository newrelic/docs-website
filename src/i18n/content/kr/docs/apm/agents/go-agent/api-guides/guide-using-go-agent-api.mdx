...
다음을 사용하여 앱의 브라우저 성능을 모니터링하려면 [<InlinePopover type="browser"/>Go 에이전트에서는](/docs/agents/go-agent/features/install-new-relic-browser-go-apps) 다음 방법 중 하나를 사용할 수 있습니다.
