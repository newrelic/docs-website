...
HTTP 응답 또는 백그라운드 작업과 같은 특정 앱 서버 활동과 [연결된 프로세서를](/docs/apm/transactions/intro-transactions/transactions-new-relic-apm) [생성하여 Go 피규어](/docs/agents/go-agent/get-started/new-relic-go) 또는 마이크로서비스에 대한 뉴렐릭을 모니터링하세요. 그런 다음 [APM <DNT>**Transactions**</DNT> 페이지를](/docs/apm/applications-menu/monitoring/transactions-page) 포함하여 뉴렐릭에서 앱의 성능을 볼 수 있습니다.
...
1. <DNT>**Errors**</DNT> 페이지에서 aTrays를 클릭하여 [<DNT>**Error details**</DNT> 페이지](/docs/apm/apm-ui-pages/error-analytics/errors-page-find-fix-verify-problems) 로 이동합니다.
2. 오류 세부정보 페이지에서 <DNT>**See logs**</DNT> 클릭합니다.
