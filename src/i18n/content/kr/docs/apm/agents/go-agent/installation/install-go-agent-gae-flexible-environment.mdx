...
[Go 에이전트를](/docs/agents/go-agent/get-started/introduction-new-relic-go) 사용하면 [Google App Engine(GAE) 가변형 환경](https://cloud.google.com/appengine/docs/flexible/go/) 에 있는 애플리케이션을 모니터링할 수 있습니다. GAE Flex 앱에 New Relic을 추가하면 앱의 상태와 성능에 대한 통찰력을 얻을 수 있으며 [APM](/docs/apm/new-relic-apm/getting-started/introduction-new-relic-apm) 에서 볼 수 있는 측정항목을 통해 GAE를 확장합니다. [<InlinePopover type="browser"/>](/docs/browser/new-relic-browser/getting-started/introduction-new-relic-browser).
