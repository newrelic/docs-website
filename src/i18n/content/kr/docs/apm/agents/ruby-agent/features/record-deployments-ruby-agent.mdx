...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        사용할 뉴렐릭 <InlinePopover type="licenseKey" />. 기본적으로 이는 지정된 `rails_env` 에 대한 `newrelic.yml` 파일의 정의에서 나옵니다. 이는 [REST API 키 와](/docs/apis/getting-started/intro-apis/access-rest-api-keys) 동일 하지 **않습니다** .
      </td>
    </tr>
