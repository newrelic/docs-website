...
`Proc` 기반 콜백을 에이전트에 제공하여 발견된 각 오류에 원하는 [오류 그룹을](../../../errors-inbox/errors-inbox) 동적으로 적용할 수 있습니다. Ruby 에이전트 API [`NewRelic::Agent.set_error_group_callback`](https://www.rubydoc.info/github/newrelic/newrelic-ruby-agent/NewRelic/Agent#set_error_group_callback-instance_method) 를 사용하여 에이전트에 콜백을 제공하십시오.
