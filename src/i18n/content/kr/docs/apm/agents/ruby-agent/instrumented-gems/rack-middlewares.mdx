...
import apmWebTransactions from 'images/apm_screenshot-crop_web-transactions.png'

import apmTransactionspagesummary from 'images/apm_screenshot-full_transactionspagesummary.png'

import apmTracespagesummary from 'images/apm_screenshot-full_trace-summary.png'
