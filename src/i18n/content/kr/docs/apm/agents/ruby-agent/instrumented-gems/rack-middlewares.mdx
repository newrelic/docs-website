...
<CollapserGroup>
  ...
  >
    ...
    <figcaption>
      **APM > (선택한 애플리케이션) > Monitor > Transactions > (선택한 트랜잭션) > Trace details:** 다음은 앱에 대해 선택한 트랜잭션에 대한 미들웨어 시간의 예입니다.
    </figcaption>
  </Collapser>
  ...
  >
    ...
    <figcaption>
      **APM > (선택한 애플리케이션) > Monitor > Transactions > (선택한 트랜잭션 추적):** 다음은 트랜잭션 추적의 미들웨어 세부 정보 예입니다.
    </figcaption>
  </Collapser>
</CollapserGroup>
