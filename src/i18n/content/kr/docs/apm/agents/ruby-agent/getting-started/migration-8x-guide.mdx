...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [`Tracer#start_external_request_segment`](https://www.rubydoc.info/gems/newrelic_rpm/NewRelic/Agent/Tracer.start_external_request_segment) API 메소드
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        [`Tracer#in_transaction`](https://www.rubydoc.info/gems/newrelic_rpm/NewRelic/Agent/Tracer.in_transaction) API 메소드
      </td>
    </tr>
