...
1. New Relic의 표준 절차에 따라 [라이선스 키](/docs/apis/intro-apis/new-relic-api-keys/#ingest-license-key) 를 포함하여 [gem을 설치합니다](/docs/agents/ruby-agent/installation/install-new-relic-ruby-agent#Installing_the_Gem) .
...
<CollapserGroup>
  ...
  >
    1. 표준 절차에 따라 [라이선스 키](/docs/apis/intro-apis/new-relic-api-keys/#ingest-license-key) 를 포함하여 New Relic의 Ruby 에이전트를 설치합니다.
