...
1. New Relic의 표준 절차에 따라

   <InlinePopover type="licenseKey" />

   를 포함하여 [gem을 설치하십시오](/docs/agents/ruby-agent/installation/install-new-relic-ruby-agent#Installing_the_Gem) .
...
<CollapserGroup>
  ...
  >
    1. <InlinePopover type="licenseKey" /> 를 포함하여 표준 절차에 따라 New Relic의 Ruby 에이전트를 설치하십시오.
