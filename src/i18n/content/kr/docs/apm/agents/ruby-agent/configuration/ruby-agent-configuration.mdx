...
<CollapserGroup>
  ...
  >
    ...
    <b>폐기됨</b> :[transaction_events.enabled](/docs/agents/ruby-agent/configuration/ruby-agent-configuration#transaction_events-enabled) 를 참조하십시오.
...
<CollapserGroup>
  ...
  >
    ...
    `true` 인 경우 에이전트는 추적된 메서드에 대한 소스 코드 수준 측정항목을 보고합니다. [New Relic CodeStream 통합](/docs/apm/agents/ruby-agent/features/ruby-codestream-integration/) 을 참조하십시오.
  </Collapser>
</CollapserGroup>
...
<CollapserGroup>
  ...
  >
    ...
    <b>사용 중단됨</b> [instrumentation.rake](/docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-rake) 를 참조하세요.
  ...
  >
    ...
    <b>사용되지 않음</b> 참조: [instrumentation.sinatra](/docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-sinatra) .
  ...
  >
    ...
    <b>사용되지 않음</b> [instrumentation.memcache-client를](/docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-memcache-client) 참조하십시오.
  ...
  >
    ...
    <b>사용 중단됨</b> [instrumentation.mongo](/docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-mongo) 를 참조하세요.
  ...
  >
    ...
    <b>사용 중단됨</b> [instrumentation.rack_urlmap](/docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-rack_urlmap) 을 참조하세요.
...
<CollapserGroup>
  ...
  >
    ...
    분산 추적을 사용하면 요청이 분산 시스템을 통과하는 경로를 볼 수 있습니다.Ruby 에이전트 8.0.0 이상에서는 기본적으로 켜져 있습니다.

    자세한 정보 [는 Ruby 서비스에 대한 분산 추적을](/docs/apm/agents/ruby-agent/configuration/distributed-tracing-ruby-agent) 참조하십시오.
  </Collapser>
</CollapserGroup>
...
<CollapserGroup>
  ...
  >
    ...
    시작 시 Net::HTTP의 자동 계측을 제어합니다. `auto` , `prepend` , `chain` 또는 `disabled` 중 하나일 수 있습니다.
  </Collapser>
  ...
  >
    ...
    시작 시 Typhoeus의 자동 계측을 제어합니다. `auto` , `prepend` , `chain` 또는 `disabled` 중 하나일 수 있습니다.
  </Collapser>
  ...
  >
    ...
    시작 시 토끼의 자동 계측을 제어합니다. `auto` , `prepend` , `chain` 또는 `disabled` 중 하나일 수 있습니다.
  </Collapser>
  ...
  >
    ...
    시작 시 Elasticsearch 라이브러리의 자동 계측을 제어합니다. `auto` , `prepend` , `chain` 또는 `disabled` 중 하나일 수 있습니다.
  </Collapser>
  ...
  >
    ...
    시작 시 http.rb gem의 자동 계측을 제어합니다. `auto` , `prepend` , `chain` 또는 `disabled` 중 하나일 수 있습니다.
  </Collapser>
  ...
  >
    ...
    시작 시 resque의 자동 계측을 제어합니다. `auto` , `prepend` , `chain` 또는 `disabled` 중 하나일 수 있습니다.
  </Collapser>
  ...
  >
    ...
    에이전트가 비동기 트랜잭션 내부에 스팬을 올바르게 중첩할 수 있도록 시작 시 Thread 클래스의 자동 계측을 제어합니다. 이렇게 하면 에이전트가 생성된 모든 스레드를 자동으로 추적할 수 없습니다( `instrumentation.thread.tracing` 참조). `auto` , `prepend` , `chain` 또는 `disabled` 중 하나일 수 있습니다.
  </Collapser>
  ...
  >
    ...
    시작 시 Redis의 자동 계측을 제어합니다. `auto` , `prepend` , `chain` 또는 `disabled` 중 하나일 수 있습니다.
  </Collapser>
  ...
  >
    ...
    시작 시 갈퀴의 자동 계측을 제어합니다. `auto` , `prepend` , `chain` 또는 `disabled` 중 하나일 수 있습니다.
  </Collapser>
  ...
  >
    ...
    시작 시 지연된 작업의 자동 계측을 제어합니다. `auto` , `prepend` , `chain` 또는 `disabled` 중 하나일 수 있습니다.
  </Collapser>
  ...
  >
    ...
    시작 시 HTTPClient의 자동 계측을 제어합니다. `auto` , `prepend` , `chain` 또는 `disabled` 중 하나일 수 있습니다.
  </Collapser>
  ...
  >
    ...
    시작 시 Curb의 자동 계측을 제어합니다. `auto` , `prepend` , `chain` 또는 `disabled` 중 하나일 수 있습니다.
  </Collapser>
  ...
  >
    ...
    시작 시 Sinatra의 자동 계측을 제어합니다. `auto` , `prepend` , `chain` 또는 `disabled` 중 하나일 수 있습니다.
  </Collapser>
  ...
  >
    ...
    Rack의 자동 계측을 제어합니다. 활성화되면 에이전트는 Rack::Builder의 `to_app` 메서드에 연결하여 애플리케이션 시작 중에 계측할 gem을 찾습니다. `auto` , `prepend` , `chain` 또는 `disabled` 중 하나일 수 있습니다.
  </Collapser>
  ...
  >
    ...
    시작 시 Rack::URLMap의 자동 계측을 제어합니다. `auto` , `prepend` , `chain` 또는 `disabled` 중 하나일 수 있습니다.
  </Collapser>
  ...
  >
    ...
    Puma::Rack의 자동 계측을 제어합니다. 활성화되면 에이전트는 Puma::Rack::Builder의 `to_app` 메서드에 연결하여 애플리케이션 시작 중에 계측할 gem을 찾습니다. `auto` , `prepend` , `chain` 또는 `disabled` 중 하나일 수 있습니다.
  </Collapser>
  ...
  >
    ...
    시작 시 Puma::Rack::URLMap의 자동 계측을 제어합니다. `auto` , `prepend` , `chain` 또는 `disabled` 중 하나일 수 있습니다.
  </Collapser>
  ...
  >
    ...
    시작 시 Memcache에 대한 memcached gem의 자동 계측을 제어합니다. `auto` , `prepend` , `chain` 또는 `disabled` 중 하나일 수 있습니다.
  </Collapser>
  ...
  >
    ...
    시작 시 Memcache용 Memcache-client gem의 자동 계측을 제어합니다. `auto` , `prepend` , `chain` 또는 `disabled` 중 하나일 수 있습니다.
  </Collapser>
  ...
  >
    ...
    시작 시 Memcache에 대한 dali gem의 자동 계측을 제어합니다. `auto` , `prepend` , `chain` 또는 `disabled` 중 하나일 수 있습니다.
  </Collapser>
  ...
  >
    ...
    시작 시 Ruby 표준 라이브러리 Logger의 자동 계측을 제어합니다. `auto` , `prepend` , `chain` 또는 `disabled` 중 하나일 수 있습니다.
  </Collapser>
  ...
  >
    ...
    시작 시 Tilt 템플릿 렌더링 라이브러리의 자동 계측을 제어합니다. `auto` , `prepend` , `chain` 또는 `disabled` 중 하나일 수 있습니다.
  </Collapser>
  ...
  >
    ...
    시작 시 gRPC 클라이언트의 자동 계측을 제어합니다. `auto` , `prepend` , `chain` 또는 `disabled` 중 하나일 수 있습니다.
  </Collapser>
  ...
  >
    ...
    New Relic이 무시할 gRPC 호스트 이름과 일치하는 쉼표로 구분된 호스트 이름 패턴 목록을 지정합니다. New Relic의 gRPC 클라이언트 계측은 이러한 패턴과 일치하는 호스트로 스트리밍되는 트래픽을 무시하고 New Relic의 gRPC 서버 계측은 호스트 이름이 이러한 패턴과 일치하는 호스트에서 실행되는 서버의 트래픽을 무시합니다. 기본적으로 gRPC 계측 자체가 활성화되면 트래픽이 무시되지 않습니다(예: `private.com$,exception.*` .
  </Collapser>
  ...
  >
    ...
    시작 시 gRPC 서버의 자동 계측을 제어합니다. `auto` , `prepend` , `chain` 또는 `disabled` 중 하나일 수 있습니다.
  </Collapser>
  ...
  >
    ...
    시작 시 ActiveSupport::Logger의 자동 계측을 제어합니다. `auto` , `prepend` , `chain` 또는 `disabled` 중 하나일 수 있습니다.
  </Collapser>
  ...
  >
    ...
    시작 시 Grape의 자동 계측을 제어합니다. `auto` , `prepend` , `chain` 또는 `disabled` 중 하나일 수 있습니다.
  </Collapser>
</CollapserGroup>
