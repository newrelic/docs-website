...
<CollapserGroup>
  ...
  >
    ...
    <b>지원 중단</b> 참조: [`instrumentation.bunny`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-bunny).
  ...
  >
    ...
    <b>지원 중단</b> 참조: [`instrumentation.curb`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-curb).
  ...
  >
    ...
    <b>지원 중단</b> 참조: [`instrumentation.memcache`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-memcache).
  ...
  >
    ...
    <b>지원 중단</b> 참조: [`instrumentation.delayed_job`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-delayed_job).

    `true` 인 경우 [`Delayed::Job` 계측을](/docs/agents/ruby-agent/background-jobs/delayedjob)비활성화합니다.
  </Collapser>
  ...
  >
    ...
    <b>지원 중단</b> 참조: [`instrumentation.excon`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-excon).
  ...
  >
    ...
    <b>지원 중단</b> 참조: [`instrumentation.memcached`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-memcached).
  ...
  >
    ...
    <b>지원 중단</b> 참조: [`instrumentation.memcache-client`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-memcache-client).
  ...
  >
    ...
    <b>지원 중단</b> 참조: [`instrumentation.grape`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-grape).
  ...
  >
    ...
    <b>지원 중단</b> 참조: [`instrumentation.httpclient`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-httpclient).
  ...
  >
    ...
    <b>지원 중단</b> 참조: [`instrumentation.httprb`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-httprb).
  ...
  >
    ...
    <b>지원 중단</b> 참조: [`instrumentation.mongo`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-mongo).
  ...
  >
    ...
    <b>지원 중단</b> 참조: [`instrumentation.net_http`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-net_http).

    `true` 인 경우 `Net::HTTP` 에 대한 계측을 비활성화합니다.
  </Collapser>
  ...
  >
    ...
    <b>지원 중단</b> 참조: [`instrumentation.puma_rack`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-puma_rack).

    `true` 인 경우 에이전트가 애플리케이션 시작 중에 계측할 gem을 찾기 위해 `Puma::Rack::Builder` 의 `to_app` 메서드에 연결하는 것을 방지합니다.
  </Collapser>
  ...
  >
    ...
    <b>지원 중단</b> 참조: [`instrumentation.puma_rack_urlmap`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-puma_rack_urlmap).

    `true` 인 경우 에이전트가 미들웨어 추적을 설치하기 위해 `Puma::Rack::URLMap` 에 연결하는 것을 방지합니다.
  </Collapser>
  ...
  >
    ...
    <b>지원 중단</b> 참조: [`instrumentation.rack`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-rack).

    `true` 인 경우 에이전트가 애플리케이션 시작 중에 계측할 gem을 찾기 위해 `Rack::Builder` 의 `to_app` 메서드에 연결하는 것을 방지합니다.
  </Collapser>
  ...
  >
    ...
    <b>지원 중단</b> 참조: [`instrumentation.rack_urlmap`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-rack_urlmap).

    `true` 인 경우 에이전트가 미들웨어 추적을 설치하기 위해 `Rack::URLMap` 에 연결하는 것을 방지합니다.
  </Collapser>
  ...
  >
    ...
    <b>지원 중단</b> 참조: [`instrumentation.rake`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-rake).
  ...
  >
    ...
    <b>지원 중단</b> 참조: [`instrumentation.redis`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-redis).
  ...
  >
    ...
    <b>지원 중단</b> 참조: [`instrumentation.resque`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-resque).
  ...
  >
    ...
    <b>지원 중단</b> 참조: [`instrumentation.sinatra`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-sinatra).

    `true` 인 경우 [Sinatra 계측을](/docs/agents/ruby-agent/frameworks/sinatra-support)비활성화합니다.
  </Collapser>
  ...
  >
    ...
    <b>지원 중단</b> 참조: [`instrumentation.typhoeus`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-typhoeus).
