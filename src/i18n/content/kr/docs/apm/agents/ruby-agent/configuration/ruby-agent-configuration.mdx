...
<CollapserGroup>
  ...
  >
    ...
    `true` 인 경우 [높은 보안 모드를](/docs/accounts-partnerships/accounts/security/high-security) 활성화합니다. 이 설정을 활성화하기 전에 높은 보안 모드의 의미를 이해해야 합니다.
  </Collapser>
...
<CollapserGroup>
  ...
  >
    ...
    * [높은 보안 모드를](/docs/agents/manage-apm-agents/configuration/high-security-mode) 활성화하면 자동으로 `obfuscated` 으로 설정됩니다.
  </Collapser>
...
<CollapserGroup>
  ...
  >
    ...
    true인 경우 에이전트는 [허용 목록](#strip_exception_messages-allowlist) 에 있는 예외를 제외한 모든 예외에서 메시지를 제거합니다. [높은 수준의 보안 모드](/docs/accounts-partnerships/accounts/security/high-security) 에서는 자동으로 활성화됩니다.
  </Collapser>
