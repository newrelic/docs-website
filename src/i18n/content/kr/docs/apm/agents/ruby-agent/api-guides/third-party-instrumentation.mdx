...
누구나 <DNT>Ruby</DNT> 에이전트 위에 빌드되는 gem을 작성할 수 있습니다. 뉴렐릭은 이러한 확장을 추적하고 <DNT>Ruby</DNT> 에이전트를 구축하는 다른 gem에 대한 링크를 제공하기 위해 [extends_newrelic_rpm](https://github.com/newrelic/extends_newrelic_rpm) 이라는 클러스터를 유지 관리합니다.
