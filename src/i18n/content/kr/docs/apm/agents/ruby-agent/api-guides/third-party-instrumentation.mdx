...
<CollapserGroup>
  ...
  <Collapser id="perform_action_with_newrelic_trace" title="perform_action_with_newrelic_trace">
    ...
    매개변수 및 사용법에 대한 추가 정보 [는 perform\_action\_with\_newrelic\_trace의 전체 문서를](https://www.rubydoc.info/github/newrelic/newrelic-ruby-agent/NewRelic/Agent/Instrumentation/ControllerInstrumentation#perform_action_with_newrelic_trace-instance_method) 참조하십시오.
  </Collapser>
</CollapserGroup>
