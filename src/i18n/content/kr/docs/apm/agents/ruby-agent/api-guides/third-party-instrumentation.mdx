...
<CollapserGroup>
  ...
  >
    ...
    매개변수 및 사용법에 대한 추가 정보 [는 perform_action_with_newrelic_trace의 전체 문서를](https://www.rubydoc.info/gems/newrelic_rpm/NewRelic/Agent/Instrumentation/ControllerInstrumentation#perform_action_with_newrelic_trace-instance_method) 참조하십시오.
  </Collapser>
</CollapserGroup>
