...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        IIS 응용 프로그램 풀에 이미 원하는 고유 이름이 있거나 [SNCI(공유 네트워크 콘텐츠 인프라)](https://www.iis.net/learn/web-hosting/scenario-build-a-web-farm-with-iis-servers "링크가 새 창에서 열립니다.") 를 사용하는 경우 할당된 앱 풀을 따라 앱 이름을 지정할 수 있습니다.
