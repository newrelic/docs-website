...
현재 실행 중인 [범위](/docs/apm/agents/net-agent/net-agent-api/ispan/) 에 대한 액세스를 제공하여 New Relic API 내에서 [범위별 메서드를](/docs/apm/agents/net-agent/net-agent-api/ispan) 사용할 수 있도록 합니다.
