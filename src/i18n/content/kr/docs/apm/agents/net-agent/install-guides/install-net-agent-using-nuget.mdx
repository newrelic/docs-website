...
4. 환경 변수(아래) 및 기타 필요한 구성을 설정합니다. 이 작업을 수행하는 방법은 환경과 시스템에 따라 다릅니다.
   ...
   <CollapserGroup>
     ...
     >
       ...
       [라이선스 키](/docs/apis/intro-apis/new-relic-api-keys/#license-key) 와 앱 이름은 필수 환경 변수가 아닙니다. [다른 방법으로 설정할 수 있습니다](/docs/agents/net-agent/installation/net-agent-install-resources#env-variables).
     </Collapser>
