...
1. [.NET 에이전트 다운로드 사이트](https://download.newrelic.com/dot_net_agent/latest_release/) 로 이동하여 애플리케이션의 아키텍처(64비트 또는 32비트)와 일치하는 파일을 가져옵니다.
...
* <DNT>**License key**</DNT>. <InlinePopover type="licenseKey"/>설정을 위한 환경 변수는 다음과 같습니다.
...
* <DNT>**App name**</DNT>. [의미 있는 애플리케이션 이름을](/docs/agents/manage-apm-agents/app-naming/name-your-application#app-name) 설정하는 것이 좋지만 설치 후에 설정할 수도 있습니다. 환경 변수는 다음과 같습니다.
       ...
       <table>
         ...
         <tbody>
           <tr>
             ...
             <td>
               <DNT>**Required**</DNT>. 귀하의 <InlinePopover type="licenseKey"/>.
             </td>
           </tr>
       ...
       <table>
         ...
         <tbody>
           <tr>
             ...
             <td>
               <DNT>**Required**</DNT>. 에이전트가 설치된 위치입니다. 이는 절대 경로 또는 상대 경로일 수 있습니다. 포장 견적이 필요합니다.
             </td>
           </tr>
           ...
           <tr>
             ...
             <td>
               <DNT>**Required**</DNT>. 로컬(앱별) 설치인지 아니면 전역(시스템 전체) 설치인지 결정합니다.
             </td>
           </tr>
           ...
           <tr>
             ...
             <td>
               선택 과목. 64비트 버전이 아닌 32비트 버전의 에이전트를 설치합니다. 뉴렐릭 <DNT>**does not recommend**</DNT> 이 에이전트의 32비트 버전을 전역적으로 설치하고 있습니다.
             </td>
           </tr>
