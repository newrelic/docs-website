...
<CollapserGroup>
  ...
  >
    ...
    2. [.NET 에이전트 다운로드 사이트](https://download.newrelic.com/dot_net_agent/latest_release/) 에서 .NET Core 에이전트의 스크립트 가능한 설치 프로그램 패키지를 다운로드합니다. 이러한 패키지 중 하나를 다운로드하거나 사용하면 [라이센스 조건](/docs/licenses/license-information/agent-licenses/net-agent-licenses) 에 동의하고 수락하는 것입니다.
