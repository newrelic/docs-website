...
* [속성 기반 사용자 정의 계측 문제 해결](https://support.newrelic.com/s/hubtopic/aAX8W0000008a5g/relic-solution-troubleshooting-attributebased-custom-instrumentation-issues)
* [.NET 에이전트 로그 파일에서 사용자 지정 계측 추적기 팩토리 구축](https://knowledge.newrelic.com/s/article/Building-Custom-Instrumentation-Tracer-Factories-From-dot-NET-Agent)
