...
<CollapserGroup>
  ...
  <Collapser id="GetBrowserTimingHeader" title="GetBrowserTimingHeader">
    ...
    * [트랜잭션](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#transaction) 내에서 호출되어야 합니다.
    ...
    <CollapserGroup>
      <Collapser id="with-aspx" title="ASPX와 함께">
        ```aspnet
        <html>
        <head>
            <%= NewRelic.Api.Agent.NewRelic.GetBrowserTimingHeader()%>
      ...
      <Collapser id="with-razor" title="면도기로">
        ```cshtml
        <!DOCTYPE html>
        <html lang="en">
        <head>
      ...
      <Collapser id="with-blazor" title="블레이저와 함께">
  ...
  <Collapser id="ITransaction" title="I트랜잭션">
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            다른 서비스에서 들어오는 트레이스 컨텍스트 헤더를 허용합니다(자세한 내용은 아래 참조).
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            나가는 요청에 트레이스 컨텍스트 헤더를 추가합니다(자세한 내용은 아래 참조).
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            다른 서비스로부터 들어오는 수신 트레이스 페이로드를 허용합니다(자세한 내용은 아래 참조).
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            발신 요청에 포함할 내보내기 트레이스 페이로드를 생성합니다(자세한 내용은 아래 참조).
          </td>
        </tr>
    ...
    <CollapserGroup>
      ...
      <Collapser id="AcceptDistributedTracePayload" title="AcceptDistributedTracePayload(구식)">
      ...
      <Collapser id="CreateDistributedTracePayload" title="CreateDistributedTracePayload(구식)">
        <Callout variant="caution">
      ...
      <Collapser id="AddCustomAttribute" title="사용자 정의 속성 추가">
        ### 통사론
  ...
  <Collapser id="ISpan" title="이스판">
    ...
    * [`ITransaction`](/docs/apm/agents/net-agent/net-agent-api/net-agent-api/#ITransaction) 의 `CurrentSpan` 속성입니다.
    ...
    <CollapserGroup>
      <Collapser id="ISpanAddCustomAttribute" title="사용자 정의 속성 추가">
  ...
  <Collapser id="NoticeError" title="NoticeError">
    ...
    * 모든 앱 유형
    ...
    <CollapserGroup>
      <Collapser id="exception-overload" title="알림 오류(예외)">
        ```cs
        NewRelic.Api.Agent.NewRelic.NoticeError(Exception $exception)
        ```
      ...
      <Collapser id="exception-idictionary-overload" title="NoticeError(예외, 사전)">
        ```cs
        NewRelic.Api.Agent.NewRelic.NoticeError(Exception $exception, IDictionary<TKey, TValue> $attributes)
        ```
      ...
      <Collapser id="NoticeError(String, IDictionary)" title="string-idictionary-overload">
        ```cs
        NewRelic.Api.Agent.NewRelic.NoticeError(string $error_message, IDictionary<TKey, TValue> $attributes)
        ```
      ...
      <Collapser id="string-idictionary-bool-overload" title="NoticeError(문자열, IDictionary, bool)">
        ```cs
        NewRelic.Api.Agent.NewRelic.NoticeError(string $error_message, IDictionary<TKey, TValue> $attributes, bool $is_expected)
        ```
