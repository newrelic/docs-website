...
<CollapserGroup>
  ...
  <Collapser id="ITransaction" title="I트랜잭션">
    ...
    <CollapserGroup>
      <Collapser id="" title="AcceptDistributedTraceHeaders">
        ### 통사론
      ...
      <Collapser id="" title="InsertDistributedTraceHeaders">
        ### 통사론
      ...
      <Collapser id="" title="AcceptDistributedTracePayload(구식)">
      ...
      <Collapser id="" title="CreateDistributedTracePayload(구식)">
        <Callout variant="caution">
      ...
      <Collapser id="" title="사용자 정의 속성 추가">
        ### 통사론
      ...
      <Collapser id="" title="레코드데이터저장소세그먼트">
        ### 통사론
