...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        [XML 파일을 사용하여](/docs/agents/net-agent/custom-instrumentation/add-detail-transactions-xml-net#example-custom-txn-async) IIS 앱에서 비동기 메서드를 계측합니다. 또한 [누락된 비동기 측정항목](/docs/agents/net-agent/troubleshooting/missing-async-metrics) 에 대한 New Relic의 문제 해결 팁을 참조하세요.
      </td>
    </tr>
