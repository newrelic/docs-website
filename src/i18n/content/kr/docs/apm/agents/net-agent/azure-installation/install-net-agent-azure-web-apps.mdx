...
2. Visual Studio에서 애플리케이션을 열고 [**Package manager** \[패키지 관리자\] 콘솔](https://learn.microsoft.com/en-us/nuget/consume-packages/install-use-packages-powershell) 에서 적절한 명령을 실행하여 New Relic NuGet 패키지를 설치합니다.
