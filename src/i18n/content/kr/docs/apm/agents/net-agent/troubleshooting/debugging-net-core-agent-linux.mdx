...
* 결과가 없으면 [환경 변수](https://support.newrelic.com/s/hubtopic/aAX8W0000008a6F/relic-solution-net-core-agent-required-environment-variables)를 설정하고 애플리케이션을 다시 시작한 다음 1단계로 돌아갑니다.
...
위의 단계로 문제가 해결되지 않으면 지원팀에 문의하거나 [지원 포럼](https://support.newrelic.com/s/)에 도움을 요청하시기 바랍니다.