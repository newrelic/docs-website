...
<Callout variant="important">
  ...
  * 에이전트를 업데이트하려면 Windows 관리자 그룹에 <DNT>**Administrator**</DNT> 권한이 필요합니다. 자세한 내용은 [권한 문서를](/docs/apm/agents/net-agent/getting-started/net-agent-compatibility-requirements-net-framework/#user-rights) 참조하세요.
