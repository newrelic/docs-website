      ...
      <tbody>
        ...
        <tr id="500">
          ...
          <td>
            ...
            [커스텀 측정](/docs/apm/agents/net-agent/custom-instrumentation/introduction-net-custom-instrumentation/)을 사용하도록 [커스텀 트랜잭션](/docs/apm/agents/net-agent/custom-instrumentation/create-transactions-xml-net/)을 업데이트해야 할 수 있습니다. UI에 표시되는 내용의 예는 이 [뉴렐릭 온라인 기술 커뮤니티 게시물](https://support.newrelic.com/s/hubtopic/aAX8W0000008YBU/change-in-nonweb-transaction-reporting-with-version-5x)을 참조하십시오.
          </td>
        </tr>
