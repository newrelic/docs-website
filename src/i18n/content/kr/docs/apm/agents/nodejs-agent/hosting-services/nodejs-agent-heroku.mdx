...
5. New Relic 앱 이름, [라이센스 키](/docs/apis/intro-apis/new-relic-api-keys/#license-key)및 [로그 설정을](/docs/agents/nodejs-agent/installation-configuration/nodejs-agent-configuration#logging_config)확인하십시오.
