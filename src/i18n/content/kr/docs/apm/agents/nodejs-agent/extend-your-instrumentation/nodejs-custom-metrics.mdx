...
API 호출을 통해 임의의 성능 데이터(예: 타이밍 또는 컴퓨터 리소스 데이터)를 기록합니다. [메트릭 및 이벤트를](/docs/query-your-data/explore-query-data/data-explorer/introduction-data-explorer) 사용하여 사용자 정의 메트릭을 검색하고, 사용자 정의 가능한 차트를 만들고, 해당 차트를 New Relic 대시보드에 추가하십시오. 사용자 지정 메트릭을 사용하면 New Relic 내에서 모니터링을 통합할 수 있습니다.
...
사용자 정의 메트릭을 보려면 [메트릭 및 이벤트를](/docs/query-your-data/explore-query-data/data-explorer/introduction-data-explorer) 사용하여 메트릭을 검색하고, 사용자 정의 가능한 차트를 만들고, 해당 차트를 New Relic 대시보드에 추가하십시오.