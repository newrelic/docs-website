...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [맞춤형 지표를](/docs/agents/manage-apm-agents/agent-data/custom-metrics) 생성합니다. [`newrelic.recordMetric()`](/docs/agents/nodejs-agent/supported-features/nodejs-agent-api#record_metric) 및 [`newrelic.incrementMetric()`](/docs/agents/nodejs-agent/supported-features/nodejs-agent-api#increment_metric) 참조하세요. 데이터를 보려면 [<DoNotTranslate>**metrics and events**</DoNotTranslate>](/docs/query-your-data/explore-query-data/data-explorer/introduction-data-explorer) 사용하세요.
      </td>
    </tr>
  </tbody>
</table>
