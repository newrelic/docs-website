...
<CollapserGroup>
  ...
  >
    ...
    * 브라우저 이벤트: 비활성화됨
      ...
      <DNT>**Note:**</DNT> 에이전트 버전 7.0.0부터 `httpResponseCode` 속성(문자열 값)이 제거되었습니다. 대신 `http.statusCode` (정수 값)을 사용해야 합니다.
  </Collapser>
  ...
  >
    ...
    * 브라우저 이벤트: 비활성화됨
      ...
      <DNT>**Note:**</DNT> 에이전트 버전 7.0.0부터 `httpResponseMessage` 속성(문자열 값)이 제거되었습니다. 대신 `http.statusText` (문자열 값)을 사용해야 합니다.
  </Collapser>
