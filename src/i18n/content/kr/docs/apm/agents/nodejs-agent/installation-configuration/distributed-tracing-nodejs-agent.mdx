...
* Infinite Tracing (tail-based sampling): Our cloud-based service accepts all your traces and then sorts through them to find the most important ones. After you set up standard tracing, we recommend you add this option because it analyzes all of your traces.
