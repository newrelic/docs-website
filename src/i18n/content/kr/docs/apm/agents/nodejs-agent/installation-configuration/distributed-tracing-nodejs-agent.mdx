...
<CollapserGroup>
  <Collapser id="node-version" title="Node.js 에이전트 호환성">
...
<CollapserGroup>
  <Collapser id="node-config-standard" title="Node.js 에이전트 구성">
