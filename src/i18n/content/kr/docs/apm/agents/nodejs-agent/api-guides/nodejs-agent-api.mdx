...
<CollapserGroup>
  ...
  >
    ...
    활성화하기 위해 HTML 페이지의 헤더에 삽입할 HTML 조각을 반환합니다. [<InlinePopover type="browser"/>](/docs/agents/nodejs-agent/supported-features/page-load-timing-nodejs). HTML은 브라우저에 작은 JavaScript 파일을 가져오고 페이지 타이머를 시작하도록 지시합니다.
  </Collapser>
