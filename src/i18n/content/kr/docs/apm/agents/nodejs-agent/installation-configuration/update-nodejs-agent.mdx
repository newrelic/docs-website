  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * <DNT>**v7:**</DNT> 애플리케이션은 API 메소드 [`transactionHandle.ignore()`](/docs/agents/nodejs-agent/api-guides/nodejs-agent-api/#transaction-handle-ignore) 을 사용해야 합니다.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        * <DNT>**v7:**</DNT> 애플리케이션은 API 메소드 [`transactionHandle.insertDistributedTraceHeaders(headers)`](/docs/agents/nodejs-agent/api-guides/nodejs-agent-api/#transaction-handle-insertDistributedTraceHeaders) 및 [`transactionHandle.acceptDistributedTraceHeaders(transportType, headers) `](/docs/agents/nodejs-agent/api-guides/nodejs-agent-api/#transaction-handle-acceptDistributedTraceHeaders)사용해야 합니다. 이러한 방법을 사용하면 Node.js 에이전트는 이제 `transactionHandle.acceptDistributedTraceHeaders(headers)` `transactionHandle.insertDistributedTraceHeaders(headers)` 할 때 W3C의 `traceparent` 및 `tracestate` 헤더를 허용하고, 뉴렐릭 트레이스 헤더 형식은 [`distributed_tracing.exclude_newrelic_header:true`(를) 사용하여 비활성화됩니다.](/docs/agents/nodejs-agent/installation-configuration/nodejs-agent-configuration/#dt-exclude-newrelic-header)
      </td>
    </tr>
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        * <DNT>**v5:**</DNT> 애플리케이션은 API 메소드 [`newrelic.addCustomAttribute()`](/docs/agents/nodejs-agent/api-guides/nodejs-agent-api#add-custom-attribute) 및 [`newrelic.addCustomAttributes()`](/docs/agents/nodejs-agent/api-guides/nodejs-agent-api#add-custom-attributes) 사용해야 합니다. 이는 기존 방법을 즉시 대체할 수 있는 방법입니다.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        * <DNT>**v5:**</DNT> 애플리케이션은 API 메소드 [`newrelic.startWebTransaction()`](/docs/agents/nodejs-agent/api-guides/nodejs-agent-api#startWebTransaction) 및 [`newrelic.startBackgroundTransaction()`](/docs/agents/nodejs-agent/api-guides/nodejs-agent-api#startBackgroundTransaction) 로 업데이트해야 합니다.
    ...
    <tr>
      ...
      <td>
        ...
        * <DNT>**v5:**</DNT> 애플리케이션은 [`newrelic.startSegment()`](/docs/agents/nodejs-agent/api-guides/nodejs-agent-api#startSegment) 으로 업데이트되어야 합니다.
      </td>
    </tr>
