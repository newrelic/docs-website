...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        선택 사항. 함수 이름. callable\_name 파라미터를 받는 함수일 수 있습니다. 설정되지 않은 경우, 함수의 캡처된 이름으로 기본 설정됩니다.
      </td>
    </tr>
...
메트릭의 이름을 동적으로 지정하려는 경우(호출되는 함수의 식별자를 기반으로 메트릭의 이름을 지정하는 대신), `FunctionTraceWrapper` 객체가 생성될 때 이름을 함수로 제공할 수 있습니다.
