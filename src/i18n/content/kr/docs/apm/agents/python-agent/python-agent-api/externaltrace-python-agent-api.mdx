...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        필수 항목입니다. 사용 중인 외부 라이브러리의 이름(또는 유형)입니다. 이를 정의하는 문자열 또는 래핑되는 함수와 동일한 파라미터를 받고 라이브러리를 반환하는 함수를 전달하십시오.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        필수 항목입니다. 라이브러리 호출에 의해 요청된 URL입니다. 이를 정의하는 문자열, 또는 래핑되는 함수와 동일한 파라미터를 받고 URL을 반환하는 함수 중 하나를 전달하십시오.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        선택 사항. 수행되는 호출의 유형을 정의하는 메서드입니다. 이들은 일반적으로 `get`, `post`, `put` 또는 `delete`입니다. 래핑되는 함수와 동일한 파라미터를 받고 메서드를 반환하는 함수일 수 있습니다.
      </td>
    </tr>
  </tbody>
</table>
