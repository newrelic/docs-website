...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        선택 과목. 로그 이벤트의 우선 순위를 설정합니다. [event_harvest_config.harvest_limits.log_event_data를](/docs/apm/agents/python-agent/configuration/python-agent-configuration#event_harvest_config.harvest_limits.log_event_data) 참조하십시오. 우선 순위가 로깅 이벤트에 미치는 영향에 대한 추가 정보는
      </td>
    </tr>
  </tbody>
</table>
