...
<CollapserGroup>
  ...
  <Collapser id="distributed-tracing-sampler-remote_parent_sampled" title="distributed_tracing.sampler.remote_parent_sampled">
    ...
    * `default` 기본 동작이며, 트레이스를 샘플링할지 여부를 결정하기 위해 샘플링 결정을 적응 샘플링 알고리즘에 위임합니다.
...
하이브리드 에이전트 구성에 사용할 수 있는 설정은 다음과 같습니다.
...
<CollapserGroup>
  <Collapser id="opentelemetry.enabled" title="OpenTelemetry.활성화됨">
    ...
    활성화된 경우, 설치된 모든 OpenTelemetry API 및 [OpenTelemetry 계측된 API가](https://github.com/open-telemetry/opentelemetry-python-contrib/tree/main/instrumentation#readme) 사용됩니다.
  </Collapser>
  ...
  <Collapser id="opentelemetry.traces.enabled" title="OpenTelemetry.트레이스.enabled">
    ...
    활성화된 경우, 모든 OpenTelemetry 스팬 및 트레이스 API가 사용됩니다.
  </Collapser>
</CollapserGroup>
