  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * 에서 [서버 측 설정을](/docs/agents/manage-apm-agents/configuration/configure-agent#ssc) 포함하여 설정에 대한 참조를 얻으려면 을

          <DNT>**all**</DNT>

          UI [`application_settings`](/docs/agents/python-agent/python-agent-api/application_settings)사용하세요.
      </td>
    </tr>
