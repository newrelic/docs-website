...
1. 표준 절차에 따라
   ...
   를 포함하여 [Python 에이전트를 설치하십시오](/docs/agents/python-agent/getting-started/python-agent-quick-start#install) .
...
<CollapserGroup>
  ...
  >
    ...
    1. 표준 절차에 따라 <InlinePopover type="licenseKey" /> 를 포함하여 [Python 에이전트를 설치하십시오](/docs/agents/python-agent/getting-started/python-agent-quick-start#install) .
