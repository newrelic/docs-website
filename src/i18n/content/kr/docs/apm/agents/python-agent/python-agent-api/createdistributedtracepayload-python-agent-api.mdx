...
<Callout variant="caution">
  이 API는 더 이상 사용되지 않습니다. 대신 [`newrelic.agent.insert_distributed_trace_headers`](/docs/apm/agents/python-agent/python-agent-api/insertdistributedtraceheaders-python-agent-api) ) 사용하십시오.
</Callout>
