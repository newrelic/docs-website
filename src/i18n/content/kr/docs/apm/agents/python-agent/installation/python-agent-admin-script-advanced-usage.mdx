...
샘플 에이전트 구성 파일을 생성합니다. `license_key` 옵션은 [라이센스 키](/docs/apis/intro-apis/new-relic-api-keys/#license-key)입니다.
...
* `NEW_RELIC_LICENSE_KEY` - New Relic [라이센스 키](/docs/apis/intro-apis/new-relic-api-keys/#license-key).
