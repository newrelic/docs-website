...
<Callout variant="important">
  이 문서에서는 자바 서버리스 모니터링을 위한 새로운 APM 에이전트 기반 솔루션을 사용하는 방법에 대해 자세히 설명합니다. 이 솔루션은 2026년 4월 10일에 릴리스되었습니다. 이 릴리스 이전에 자바 모니터링을 사용했거나 자바 버전 11 또는 8을 사용하는 사용자는 대신 [구형 Open Tracing 기반 자바 솔루션](/docs/serverless-function-monitoring/aws-lambda-monitoring/instrument-lambda-function/instrument-your-own/#console)을 사용해야 합니다.
</Callout>
