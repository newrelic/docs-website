...
일부 애플리케이션의 경우 구성 요소 기반 트랜잭션 이름 지정을 비활성화할 수 있습니다. [<DNT>**newrelic.yml**</DNT> 파일에서 이 값을 설정하세요](/docs/java/java-agent-configuration#cfg-enable_auto_transaction_naming).
