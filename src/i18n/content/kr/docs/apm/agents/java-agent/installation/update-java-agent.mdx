...
1. <DNT>**entire**</DNT> [에이전트](/docs/agents/manage-apm-agents/troubleshooting/find-agent-root-directory#java-agent) 에이전트를 다른 위치에 백업합니다. 해당 디렉토리의 이름을 `NewRelic_Agent#.#.#` 로 바꾸십시오. 여기서 `#.#.#` 는 에이전트 버전 번호입니다.
