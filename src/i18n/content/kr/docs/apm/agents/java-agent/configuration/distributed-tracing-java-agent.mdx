...
[에이전트에 대한 표준 폐기 추적은](#quick-start-apm) APM 트레이스의 최대 10%를 캡처하지만 모든 데이터를 분석하고 가장 관련성이 높은 트레이스를 찾으려면 [무한 추적을 설정할](/docs/understand-dependencies/distributed-tracing/infinite-tracing/introduction-infinite-tracing) 수 있습니다.
