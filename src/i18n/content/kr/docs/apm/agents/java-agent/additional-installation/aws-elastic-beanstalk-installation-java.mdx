...
7. 왼쪽 창에서 <DoNotTranslate>**Configurations**</DoNotTranslate> 선택합니다.

8. <DoNotTranslate>**Updates, monitoring, and logging**</DoNotTranslate> 으로 스크롤하고 오른쪽 상단에서 <DoNotTranslate>**Edit**</DoNotTranslate> 선택합니다.

9. <DoNotTranslate>**Platform Software**</DoNotTranslate> 으로 스크롤하고 <DoNotTranslate>**JVM Options**</DoNotTranslate> 필드에 다음 줄을 추가합니다.

   ```
   -javaagent:/full/path/to/newrelic.jar
   ```

10. 저장하려면 <DoNotTranslate>**Apply**</DoNotTranslate> 선택하세요.
