...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM & services** 로 이동하여 앱을 클릭합니다. **Monitor** \[모니터] 섹션에서 **Transaction** \[트랜잭션을] 클릭하고 트랜잭션을 선택하여 분석 테이블을 확인하십시오.
</figcaption>
