...
뉴렐릭 Java 에이전트를 사용하면, [느린 앱 튜토리얼](/docs/journey-app-slow/root-causes/)에서 앱의 성능 문제를 해결할 수 있습니다.

<Callout variant="tip">
  Java 관련 동향이 궁금하신가요? [2024년 Java 생태계 현황](https://newrelic.com/resources/report/2024-state-of-the-java-ecosystem) 보고서를 확인하십시오.
</Callout>
...
3. 뉴렐릭 실행 프로그램을 사용하거나 [설치 문서](/install/java/)에 따라 Java 에이전트를 설치합니다.
...
[뉴렐릭 UI에서 앱 성능을 확인하려면](/docs/apm/applications-menu/monitoring/apm-overview-page) <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & services > (select an app) > Summary**</DNT>로 이동합니다. APM 사용자 인터페이스에는 전용 [<DNT>**JVM metrics**</DNT> 페이지](/docs/agents/java-agent/features/jvm-metrics-page), [트랜잭션](/docs/apm/transactions) 및 [오류](/docs/apm/applications-menu/error-analytics/introduction-error-analytics) 세부정보, Java 스레드를 샘플링하고 스택 트레이스를 보고하는 [스레드 프로파일러 도구](/docs/apm/applications-menu/events/thread-profiler-tool) 등이 포함되어 있습니다.
...
* [브라우저 계측:](/docs/browser/new-relic-browser/page-load-timing-resources/page-load-timing-process) Java 에이전트를

  <InlinePopover type="browser">
    [](/docs/browser/new-relic-browser/getting-started/new-relic-browser)
  </InlinePopover>

  과 통합하면 엔드유저 활동에 대한 가시성을 확보할 수 있습니다.
