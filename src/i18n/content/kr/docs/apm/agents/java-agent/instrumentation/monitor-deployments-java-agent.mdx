...
New Relic을 사용하면 명령줄에서 애플리케이션 배포에 대한 정보를 보낼 수 있습니다. 그런 다음 UI의 [**배포** 페이지](/docs/apm/applications-menu/events/deployments-page) 에서 배포 정보를 볼 수 있습니다. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) APM & services > Applications > (앱 선택) > Events > Deployments** 로 이동합니다.
