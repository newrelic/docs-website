...
<Callout variant="tip">
  이 계측에 대한 피드백, 질문 또는 문제가 있는 경우 [뉴렐릭 지원 포럼](https://support.newrelic.com/s/hubtopic/Topic__c/Default?c__categories=%5B%7B%22icon%22%3A%22standard%3Adefault%22%2C%22id%22%3A%22a6c8W000000EesiQAC%22%2C%22sObjectType%22%3A%22Category__c%22%2C%22title%22%3A%22Java%20Agent%22%2C%22titleFormatted%22%3A%22Java%20Agent%22%7D%5D)에 게시물을 작성하고 게시물에 `java_incubator`(으)로 태그를 지정하십시오.
</Callout>
...
<CollapserGroup>
  <Collapser className="freq-link" id="class-histogram" title="클래스 히스토그램">
    <table>
      <tbody>
        <tr>
          <th>
...
<CollapserGroup>
  <Collapser className="freq-link" id="apache-camel-212" title="아파치 카멜 2.12">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser className="freq-link" id="c3p0-db-connection" title="C3P0 데이터베이스 연결 풀">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser className="freq-link" id="code-hale-metrics-2" title="코다 헤일의 메트릭스 2">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser className="freq-link" id="coda-hale-metrics-3" title="코다 헤일의 메트릭스 3">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser className="freq-link" id="ratpack-1-6-0" title="Ratpack 1.6.0 이상">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser className="freq-link" id="ratpack-http-1-4-0" title="Ratpack Http 클라이언트 1.4.0 이상">
    <table>
      <tbody>
        <tr>
          <th>
...
<CollapserGroup>
  <Collapser className="freq-link" id="akka-20" title="아카 [2.0]">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser className="freq-link" id="akka-21" title="아카 [2.1]">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser className="freq-link" id="akka-http-10" title="아카 HTTP [1.0]">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser className="freq-link" id="akka-http-20" title="아카 HTTP [2.0 – 2.4.1]">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser className="freq-link" id="akka-http-242" title="아카 HTTP [2.4.2 – 2.4.4]">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser className="freq-link" id="hystrix-102" title="히스트릭스 [1.0.2 – 1.1.7]">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser className="freq-link" id="hystrix-120" title="히스트릭스 [1.2.0 – 1.2.18]">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser className="freq-link" id="hystrix-130" title="히스트릭스 [1.3.0 – 1.3.13]">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser className="freq-link" id="play-20" title="플레이 [2.0]">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser className="freq-link" id="play-21" title="재생 [2.1]">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser className="freq-link" id="play22" title="재생 [2.2]">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser className="freq-link" id="solr-310" title="솔러 [3.1.0 – 3.4.0]">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser className="freq-link" id="solr-350" title="솔러 [3.5.0]">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser className="freq-link" id="solr-360" title="솔러 [3.6.0 – 3.6.2]">
    <table>
      <tbody>
        <tr>
          <th>
