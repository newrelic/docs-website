...
1. <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & services > (select an app) > Monitoring > JVMs > (select a JVM)**</DNT>
...
<CollapserGroup>
  ...
  >
    ...
    3. <DNT>**Enable Performance Monitoring Infrastructure (PMI)**</DNT>

       확인란을 선택합니다.

    4. <DNT>**Currently monitored statistic set**</DNT>
