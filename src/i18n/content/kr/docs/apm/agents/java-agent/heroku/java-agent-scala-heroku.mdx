...
[Heroku](https://devcenter.heroku.com/articles/newrelic) 는 Scala를 포함한 다양한 에이전트 언어로 웹 제작을 호스팅하기 위한 PaaS(Platform as a Service) 솔루션입니다. 뉴렐릭을 사용하면 Heroku 및 의 [APM](/docs/apm/new-relic-apm) 지표로 [<InlinePopover type="browser"/>](/docs/browser/new-relic-browser)확장할 수 있습니다.
