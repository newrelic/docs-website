...
APM 의 [반대 저항을](/docs/agents/java-agent/getting-started/introduction-new-relic-java) 사용하면 [Google App Engine(GAE) 가변형 환경](https://cloud.google.com/appengine/docs/flexible/java/) 에 상주하는 모니터링을 할 수 있습니다. GAE Flex 앱에 뉴렐릭을 추가하면 인사이트 앱의 성능과 성능에 대한 정보를 얻을 수 있으며 [<InlinePopover type="apm"/>](/docs/apm/new-relic-apm/getting-started/introduction-new-relic-apm), [<InlinePopover type="browser"/>](/docs/browser/new-relic-browser/getting-started/introduction-new-relic-browser)및 [대시보드](/docs/query-your-data/explore-query-data/dashboards/introduction-new-relic-one-dashboards) 에서 볼 수 있는 지표로 GAE를 확장합니다.
...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="3. app.yaml 구성"
  >
    커스텀 런타임이 포함된 GAE 가변형 환경 앱에는 [`app.yaml`](https://cloud.google.com/appengine/docs/flexible/java/configuring-your-app-with-app-yaml) 설정 파일이 필요합니다. 최소한 다음이 포함되어 있는지 확인하세요.
  ...
  >
    ...
    4. 뉴렐릭에서 GAE Flex 앱 데이터를 보려면 [APM <DNT>**Summary**</DNT> 페이지](/docs/apm/applications-menu/monitoring/apm-overview-page) 로 이동하세요.
  </Collapser>
</CollapserGroup>
...
권장사항: 다음을 추가하여 [상태 확인을 비활성화](https://cloud.google.com/appengine/docs/flexible/java/configuring-your-app-with-app-yaml#health_checks) 하도록 `app.yaml` 구성하세요.
