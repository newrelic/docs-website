...
<DNT>**Recommendation:**</DNT> 다음을 추가하여 [상태 확인을 비활성화](https://cloud.google.com/appengine/docs/flexible/java/configuring-your-app-with-app-yaml#health_checks) 하도록 `app.yaml` 구성합니다.
