...
<CollapserGroup>
  <Collapser id="setup-gae" title="1. GAE Flexible 프로젝트 설정 및 종속성 설치">
  ...
  <Collapser id="configure-pom-xml" title="2. Java 에이전트 및 빌드 프로젝트를 포함하도록 Maven pom.xml 구성">
  ...
  <Collapser id="configure-dockerfile" title="4. Dockerfile 구성">
  ...
  <Collapser id="build-docker-image" title="5. 도커 이미지 빌드">
  ...
  <Collapser id="deploy-docker-image-to-gae" title="6. 초기화된 GAE 가변형 환경에 Docker 이미지 배포">
