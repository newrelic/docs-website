...
7. <DoNotTranslate>**Recommendation:**</DoNotTranslate>
   ...
   [GAE 상태 확인을 비활성화합니다](#health-checks).
...
<CollapserGroup>
  ...
  >
    ...
    4. 뉴렐릭에서 GAE Flex 앱 데이터를 보려면 [APM <DoNotTranslate>**Summary**</DoNotTranslate> 페이지](/docs/apm/applications-menu/monitoring/apm-overview-page) 로 이동하세요.
  </Collapser>
</CollapserGroup>
...
<DoNotTranslate>**Recommendation:**</DoNotTranslate> 다음을 추가하여 [상태 확인을 비활성화](https://cloud.google.com/appengine/docs/flexible/java/configuring-your-app-with-app-yaml#health_checks) 하도록 `app.yaml` 구성합니다.
