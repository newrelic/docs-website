...
2. 반환된 각 공지에 대해 <DoNotTranslate>**Alerts> [Alerts Conditions](https://one.newrelic.com/alerts-ai/condition-builder/condition-list)**</DoNotTranslate> UI 의 ID나 이름을 사용하여 공지를 찾을 수 있습니다.
