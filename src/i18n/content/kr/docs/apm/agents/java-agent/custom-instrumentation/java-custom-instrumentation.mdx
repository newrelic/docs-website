...
또한 사용자 정의를 통해 JMX(Java Management Extensions)를 모니터링할 수도 있습니다. JMX는 애플리케이션, 장치 및 서비스를 모니터링하고 관리하는 방법입니다. [외부 <DNT>**YAML**</DNT> 파일을](/docs/java/custom-jmx-instrumentation-by-yml) 통해 JMX 모니터링을 구현할 수 있습니다.
