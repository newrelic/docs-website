...
성공적으로 설정한 후 New Relic에 메트릭이 표시되기 시작하는 데 최대 15분이 소요될 수 있습니다. [APM **요약** 페이지](/docs/apm/applications-menu/monitoring/applications-overview-dashboard) 를 보려면: **[one.newrelic.com](https://one.newrelic.com/all-capabilities) APM & services > (앱 선택)** 으로 이동합니다.