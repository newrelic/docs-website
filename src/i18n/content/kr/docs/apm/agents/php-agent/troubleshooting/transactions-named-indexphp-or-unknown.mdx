...
<Callout variant="tip">
  <DNT>**Note:**</DNT> 사용자 ID, 반사 등과 같이 자주 변경되는 값을 사용하여 프로세서의 이름을 지정하지 마십시오. API 호출에 [유용한 트랜잭션 이름 지정을](/docs/agents/php-agent/features/php-frameworks-integrating-support-new-relic) 구현하세요.
</Callout>
