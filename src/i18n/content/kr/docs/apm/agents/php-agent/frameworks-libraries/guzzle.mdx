...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) APM & services > (앱 선택) > 개요 > 웹 트랜잭션 시간** : New Relic UI에서 Guzzle을 통한 순차적 요청.
</figcaption>
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) APM & services > (앱 선택) > Summary > Web transactions time** : New Relic UI에서 Guzzle을 사용한 병렬 요청
</figcaption>
