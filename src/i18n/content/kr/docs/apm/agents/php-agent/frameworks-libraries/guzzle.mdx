...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM > (선택한 앱) > Overview > Web transactions time** : New Relic UI에서 Guzzle을 사용한 순차적 요청.
</figcaption>
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM > (선택한 앱) > Summary > Web transactions time** : New Relic UI에서 Guzzle을 사용한 병렬 요청
</figcaption>
