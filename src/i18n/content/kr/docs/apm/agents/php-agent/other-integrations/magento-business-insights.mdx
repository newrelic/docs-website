...
<Steps>
  ...
  <Step>
    ...
    1. <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/) > Add data**</DoNotTranslate>

       으)로 이동합니다.

    2. <DoNotTranslate>**MySQL**</DoNotTranslate>
  ...
  <Step>
    ...
    2. <DoNotTranslate>**Elasticsearch**</DoNotTranslate>
  ...
  <Step>
    ...
    2. 구성 파일에 다음 코드 조각을 추가합니다. `USERNAME`, `PASSWORD` 및 `DATABASE_NAME` 교체를 변경해야 합니다.
  ...
  <Step>
    ...
    1. <DoNotTranslate>**[one.newrelic.com > Add Data](https://one.newrelic.com) > Dashboards**</DoNotTranslate>
    ...
    귀하의 Magento 대시보드는 맞춤형 대시보드로 간주되며 <DoNotTranslate>**Dashboards**</DoNotTranslate> UI 에서 찾을 수 있습니다. 대시보드 사용 및 편집에 대한 자세한 내용은 [대시보드 문서 를](/docs/query-your-data/explore-query-data/dashboards/introduction-dashboards) 참조하세요.
  </Step>
</Steps>
