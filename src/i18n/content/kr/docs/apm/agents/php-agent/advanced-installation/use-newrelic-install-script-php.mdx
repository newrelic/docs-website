...
명령줄에서 해당 위치에서 [스크립트를](https://github.com/newrelic/newrelic-php-agent/blob/main/agent/newrelic-install.sh) 실행합니다.
...
<CollapserGroup>
  ...
  >
    다음 방법 중 <DNT>**one**</DNT> 사용하여 설치 모드를 호출합니다.
  ...
  >
    해당 항목에 뉴렐릭 <InlinePopover type="licenseKey"/>을 입력하세요. 이 키는 나머지 설치 프로세스 동안 생성된 모든 INI 파일에 삽입됩니다.
  </Collapser>
  ...
  >
    ...
    <DNT>**Example:**</DNT> 메뉴에는 7가지 옵션이 표시됩니다.
  ...
  >
    뉴렐릭을 성공적으로 설치하고 웹 서버를 다시 시작한 후에는 독창적인 데이터 수집을 시작할 수 있습니다. 몇 분 후에 [APM <DNT>**Summary**</DNT> 페이지](/docs/apm/apm-ui-pages/monitoring/apm-summary-page-view-transaction-apdex-usage-data/) 에 데이터가 표시되기 시작합니다.
