...
이를 구현하려면 먼저 [`newrelic_end_transaction()`](/docs/apm/agents/php-agent/php-agent-api/newrelic_end_transaction/) 사용한 초기 자동 트랜잭션을 무시한 다음 [`newrelic_start_transaction()`](/docs/apm/agents/php-agent/php-agent-api/newrelic_start_transaction/) 및 [`newrelic_end_transaction()`](/docs/apm/agents/php-agent/php-agent-api/newrelic_end_transaction/) 사용하여 각 트랜잭션을 차례로 계측합니다.
