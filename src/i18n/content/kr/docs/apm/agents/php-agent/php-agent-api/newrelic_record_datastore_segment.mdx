...
데이터스토어 세그먼트를 기록합니다. 데이터스토어 세그먼트는 <DNT>**Breakdown table**</DNT> <DNT>**Databases**</DNT> 뉴렐릭 에 [있는 프로세서](/docs/apm/applications-menu/monitoring/transactions-page) 페이지 의 및 탭에 UI 나타납니다.
