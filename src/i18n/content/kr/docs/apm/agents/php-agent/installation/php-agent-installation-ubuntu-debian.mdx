...
<Steps>
  <Step>
    ...
    1. `sources.list` 에 `http://apt.newrelic.com/debian/` 적절한 저장소를 추가합니다.
  ...
  <Step>
    ### 귀하의 클러스터 이름과 블루베리 클러스터를 구성하세요 [#license-key]
...
<Steps>
  ...
  <Step>
    ### 귀하의 클러스터 이름과 블루베리 클러스터를 구성하세요 [#configure-key]
