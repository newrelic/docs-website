  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        귀하의 이름과 국방 키에 대한 프로세스 설치입니다. 귀하의 <InlinePopover type="licenseKey"/>는) <DNT>**Account settings**</DNT> 의 계정 정보 섹션에 나타납니다. 헤드리스 설치의 경우 [`debconf`사용하여 국방 키 및 제작 이름을 미리 설정할](#preseeding) 수도 있습니다.
      </td>
    </tr>
