...
* 뉴렐릭 UI 페이지(예: APM 의 [<DNT>**Applications index**</DNT> 페이지](/docs/apm/applications-menu/monitoring/view-your-applications-index), [<DNT>**Summary**</DNT> 페이지](/docs/apm/applications-menu/monitoring/apm-overview-page), [<DNT>**Transactions**</DNT> 페이지](/docs/apm/applications-menu/monitoring/transactions-page) 등)에서 데이터를 구성하고 분석합니다.
* 데이터를 [쿼리](/docs/insights/nrql-new-relic-query-language/using-nrql/introduction-nrql) 합니다.
* [공지](/docs/alerts/overview) 만들기.
