...
[PHPUnit](https://phpunit.de/) 을 사용하여 단위 테스트를 관리하고 실행하면 New Relic PHP 에이전트는 테스트 요약 결과를 자동으로 캡처하고 테스트 데이터를 한 눈에 쿼리하고 시각화할 수 있는 [이벤트](/docs/insights/new-relic-insights/understanding-insights/new-relic-insights#database) 로 [New Relic](/docs/insights/new-relic-insights/understanding-insights/new-relic-insights) 에 이를 보낼 수 있습니다. 이 기능은 PHP 에이전트 버전 **6.7.0** 에서 릴리스되었으며 PHPUnit 버전 **3.7** - **8.x** 를 지원합니다.
    ...
    <table>
      ...
      <tbody>
        ...
        <tr id="test-message">
          ...
          <td>
            테스트 결과와 관련된 모든 메시지. 예를 들면 다음과 같습니다. **false가 true임을 어설션하는 데 실패** 했거나 **이 테스트는 'StackTest::testFailure'에 따라 통과해야 합니다.** .
          </td>
        </tr>
        ...
        <tr id="test-outcome">
          ...
          <td>
            테스트 결과입니다. 옵션에는 **통과** , **실패** , **건너뜀** , **위험** , **경고** 및 **불완전** 이 포함됩니다.
          </td>
        </tr>
