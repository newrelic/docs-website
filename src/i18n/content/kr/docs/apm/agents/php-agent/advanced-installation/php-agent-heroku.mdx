...
[Heroku](//www.heroku.com/) 는 PHP를 포함한 다양한 언어로 웹 호스팅을 위한 PaaS(Platform as a Service) 솔루션입니다. 뉴렐릭을 사용하면 Heroku 및 의 [<InlinePopover type="apm"/>](/docs/apm/new-relic-apm/getting-started/welcome-new-relic-apm)지표로 [<InlinePopover type="browser"/>](/docs/browser/new-relic-browser/getting-started/new-relic-browser)확장할 수 있습니다.
