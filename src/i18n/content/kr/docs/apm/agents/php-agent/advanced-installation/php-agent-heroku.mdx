...
PHP 에이전트를 설치하기 전에, PHP 웹 애플리케이션이 Heroku에 설치되어 실행 중인지 확인하십시오. 자세한 내용은 [Heroku에서 PHP 시작하기](https://devcenter.heroku.com/articles/getting-started-with-php)를 참조하세요.
