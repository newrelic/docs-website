...
[Heroku](//www.heroku.com/) 는 PHP를 포함한 다양한 언어로 웹 애플리케이션을 호스팅하기 위한 PaaS(Platform as a Service) 솔루션입니다. New Relic을 사용하면 다음의 메트릭으로 Heroku를 확장할 수 있습니다. [<InlinePopover type="apm"/>](/docs/apm/new-relic-apm/getting-started/welcome-new-relic-apm)그리고 [<InlinePopover type="browser"/>](/docs/browser/new-relic-browser/getting-started/new-relic-browser).
