...
<figcaption>
  **[one.newrelic.com > All capabilties](https://one.newrelic.com/all-capabilities) > APM & services > (앱 선택) > Summary**: PHP 에이전트를 설치한 후 앱의 성능 요약을 봅니다.
</figcaption>
...
* [페이지 로드 타이밍](/docs/agents/php-agent/features/page-load-timing-php): PHP 에이전트를 다음과 통합합니다.

  <InlinePopover type="browser">[](/docs/browser/new-relic-browser/getting-started/new-relic-browser)</InlinePopover>

  최종 사용자 활동에 대한 가시성을 확보합니다.
