...
New Relic PHP 에이전트를 사용하여 [My app is slow 자습서](/docs/journey-app-slow/root-causes/)에서 앱의 성능 문제를 해결하십시오.
...
<figcaption>
  <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & services > (select an app) > Summary**</DNT>: PHP 에이전트를 설치한 후 앱 성능 요약을 확인하세요.
</figcaption>
...
<DNT>**standard installations**</DNT> 에 대해서는 다음을 참조하세요.
...
다른 유형의 PHP 설치 및 <DNT>**advanced installation**</DNT> 주제는 다음을 참조하세요.
...
* [페이지 로드 타이밍](/docs/agents/php-agent/features/page-load-timing-php): PHP 에이전트를

  <InlinePopover type="browser">
    [](/docs/browser/new-relic-browser/getting-started/new-relic-browser)
  </InlinePopover>

  와 통합하여 최종 사용자 활동에 대한 가시성을 확보합니다.
