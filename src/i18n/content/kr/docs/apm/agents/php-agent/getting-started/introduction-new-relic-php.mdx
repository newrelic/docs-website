...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & services > (select an app) > Summary**</DoNotTranslate>: PHP 에이전트를 설치한 후 앱 성능 요약을 확인하세요.
</figcaption>
...
<DoNotTranslate>**standard installations**</DoNotTranslate> 에 대해서는 다음을 참조하세요.
...
다른 유형의 PHP 설치 및 <DoNotTranslate>**advanced installation**</DoNotTranslate> 주제는 다음을 참조하세요.
