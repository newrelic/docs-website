...
* 맞춤화와 상호작용이 가능한 [대시보드](/docs/query-your-data/explore-query-data/query-builder/introduction-query-builder)생성 및 공유
...
* [페이지 로드 타이밍](/docs/agents/php-agent/features/page-load-timing-php): PHP 에이전트를 [<InlinePopover type="browser" />](/docs/browser/new-relic-browser/getting-started/new-relic-browser)와 통합하여 최종 사용자 활동에 대한 가시성을 확보합니다.
