...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) 또는** [one.eu.newrelic.com](https://one.eu.newrelic.com) **으로 이동한 다음 More > Manage Insights Data\*\***를 선택 합니다.
