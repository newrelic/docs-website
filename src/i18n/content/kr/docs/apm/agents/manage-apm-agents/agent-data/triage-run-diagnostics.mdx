---
title: APM 요약 페이지에서 근본 원인 분석 시작
tags:
  - APM
  - Triage
  - Diagnostics
...
우리 모두는 아침에 일어나 리더십 팀에서 무언가 잘못되고 있으며 가능한 한 빨리 수정해야 한다는 신호를 받는 것이 어떤 것인지 알고 있습니다. 이곳이 우리의 <InlinePopover type="apm"/>도구가 들어갑니다. 시간이 한정되어 있고 긴급한 경우 APM 요약 페이지를 사용하여 애플리케이션의 오류를 찾고 한 곳에서 문제를 심사할 수 있습니다.

APM 요약 페이지는 각 서비스에 대한 중요한 지표의 개요입니다. 서비스 저하의 원인을 조사하기 위해 가장 먼저 방문하는 곳입니다. APM 요약 페이지에서 서비스 상태를 확인하고, 더 큰 맥락에서 문제를 이해하고, 문제를 해결하는 데 필요한 조치를 취할 수 있습니다.
...
이 문서는 New Relic의 APM 도구를 사용하여 서비스 저하의 근본 원인을 확인하는 방법에 대한 _**가상의**_ 예를 안내합니다. **신발을 판매하는 가상의 전자 상거래 회사에서 일하는**상황을 살펴보겠습니다. 당신은 체크아웃 팀의 엔지니어링 관리자입니다. 고객들은 체크아웃하기까지 너무 오래 기다려야 한다고 불평해 왔습니다.
