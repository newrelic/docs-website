...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <DNT>**newrelic.ini**</DNT> 파일에서 `process_host.display_name` 편집합니다.
      </td>
    </tr>
...
호스트 인스턴스에서 APM 에이전트를 제거한 후 이전 호스트가 APM 보기에서 사라지는 데 최대 75분이 걸릴 수 있습니다. 인프라 에이전트를 제거하여 호스트를 제거한 경우 호스트가 사라지는 데 최대 24시간이 걸릴 수 있습니다.
