...
import nrAttributeCollectionDiagram from 'images/nr-attribute-collection-diagram.png'

import screenTxTraceAttributes from 'images/screen-tx-trace-attributes.png'
...
<img
  ...
  src={nrAttributeCollectionDiagram}
/>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * [노드 에이전트 6.10.0 이상](/docs/release-notes/agent-release-notes/nodejs-release-notes/node-agent-6-10-0/)
...
<img
  ...
  src={screenTxTraceAttributes}
/>

<figcaption>
  **APM > (앱 선택) > Monitoring > Transactions > (트랜잭션 선택) > (추적 선택):** 다음은 트랜잭션 추적에 **대한 요청 속성** 및 **사용자 지정 속성** 에 대한 Ruby 에이전트의 예입니다. 정확한 속성은 에이전트와 속성 구성에 따라 다릅니다.
</figcaption>
