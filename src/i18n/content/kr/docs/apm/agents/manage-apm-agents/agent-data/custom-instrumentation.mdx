...
[지원되는 프레임워크를](/docs/agents/manage-apm-agents/installation/compatibility-requirements) 사용 중이지만 APM [<DNT>**Transactions**</DNT> 페이지](/docs/applications-menu/transactions-dashboard) 에 트랜잭션이 표시되지 않는 경우 [support.newrelic.com](https://support.newrelic.com) 에서 지원을 받아 프레임워크 계측이 작동하는지 확인하세요.
...
<CollapserGroup>
  ...
  >
    ...
    * [주석](/docs/java/custom-instrumentation-by-annotation): 코드에 <DNT>**@Trace**</DNT> 주석을 추가하여 뉴렐릭 권한화된 특정 메서드를 보장합니다. 몇 가지 방법만 사용하면 주석을 쉽게 구현할 수 있습니다. 보다 복잡한 계측의 경우 또는 코드를 수정할 수 없는 경우 XML을 사용하십시오.
