...
3. 해당 쿼리의 경우 해당 쿼리 위로 마우스를 가져간 다음
...
* <DNT>
  ...
  [v2.8.0 이상](/docs/release-notes/agent-release-notes/go-release-notes)

* <DNT>
    **Java:**
  </DNT>

  [v5.5.0 이상](/docs/release-notes/agent-release-notes/java-release-notes)

* <DNT>
    **.NET:**
  </DNT>

  [v8.23.107.0 이상](/docs/release-notes/agent-release-notes/net-release-notes)

* <DNT>
    **Node.js:**
  </DNT>

  [v5.13.0 이상](/docs/release-notes/agent-release-notes/nodejs-release-notes)

* <DNT>
    **PHP:**
  </DNT>

  [v9.5.0.252 이상](/docs/release-notes/agent-release-notes/php-release-notes)

* <DNT>
    **Python:**
  </DNT>

  [v5.2.0.127 이상](/docs/release-notes/agent-release-notes/python-release-notes)

* <DNT>
    **Ruby:**
  </DNT>

  [v6.7.0.359 이상](/docs/release-notes/agent-release-notes/ruby-release-notes)
