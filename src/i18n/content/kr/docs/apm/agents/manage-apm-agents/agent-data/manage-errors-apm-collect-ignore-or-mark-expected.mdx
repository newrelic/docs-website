...
<CollapserGroup>
  ...
  >
    ...
    2. 무시하려는 오류가 있는 애플리케이션의
       ...
       [ 메뉴로 이동하세요](/docs/agents/manage-apm-agents/configuration/server-side-agent-configuration#customize-ssc) .
  ...
  >
    ...
    * <DNT>**Java**</DNT>
      ...
      : `error_collector.ignore_classes`, `error_collector.ignore_classes.message` 또는 `error_collector.ignore_status_codes`. 추가 정보는 [저항 오류 설정 을](/docs/agents/java-agent/configuration/java-agent-error-configuration) 참조하세요.

    * <DNT>**.NET**</DNT>

      : [`ignoreErrors`](/docs/apm/agents/net-agent/configuration/net-agent-configuration/#error-ignoreErrors) 또는 [`ignoreStatusCodes`](/docs/apm/agents/net-agent/configuration/net-agent-configuration/#error-ignoreStatusCodes).

    * <DNT>**Node.js**</DNT>

      : `ignore_status_codes`, [`ignore_classes`](/docs/agents/nodejs-agent/installation-configuration/nodejs-agent-configuration#error_ignore) 또는 [`ignore_messages`](/docs/agents/nodejs-agent/installation-configuration/nodejs-agent-configuration#error_ignore).

    * <DNT>**PHP**</DNT>

      : [`error_collector.ignore_exceptions`](/docs/apm/agents/php-agent/configuration/php-agent-configuration/#inivar-err-ignore-exceptions) 또는 [`error_collector.ignore_errors`](/docs/apm/agents/php-agent/configuration/php-agent-configuration/#inivar-err-ignore-errors).

    * <DNT>**Python**</DNT>

      : [`error_collector.ignore_classes`](/docs/agents/python-agent/configuration/python-agent-configuration/#error-ignore) 또는 [`error_collector.ignore_status_codes`](/docs/agents/python-agent/configuration/python-agent-configuration/#error-ignore-status-codes).
...
* [APM ](/docs/apm/applications-menu/monitoring/apm-overview-page)
  ...
  [ 페이지](/docs/apm/applications-menu/monitoring/apm-overview-page): 오류가 포함된 애플리케이션의 상위 수준 보기를 표시합니다.
