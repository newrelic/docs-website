...
[사용량 기반 가격 책정 모델을 사용](docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing) 하는 고객은 [Enterprise 버전](https://newrelic.com/pricing) 이 필요합니다. 원래 가격 모델의 고객은 구독 수준에 따라 액세스할 수 있습니다.
