...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        * [원래 사용자 모델의 사용자](/docs/accounts/original-accounts-billing/original-users-roles/users-roles-original-user-model) : 계정 소유자만 이를 구성할 수 있습니다. **[one.newrelic.com](https://one.newrelic.com/all-capabilities)** 으로 이동, [계정 드롭다운](/docs/using-new-relic/welcome-new-relic/get-started/glossary#account-dropdown) 을 클릭하고 **계정 설정** 을 선택합니다. 해당 페이지에서 **높은 보안 모드** 를 선택합니다.
