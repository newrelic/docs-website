...
<CollapserGroup>
  ...
  >
    ...
    1. <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > (select an app) > Settings > Application > Application settings**</DNT>

       으로 이동합니다.

    2. <DNT>**Application server**</DNT>
