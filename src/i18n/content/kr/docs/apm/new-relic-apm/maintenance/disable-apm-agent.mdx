...
<CollapserGroup>
  ...
  >
    ...
    * [`agent_enabled`](/docs/agents/ruby-agent/configuration/ruby-agent-configuration#agent_enabled) 구성 설정을 사용하세요. 이는 구성 파일이나 환경별 섹션에서 수행할 수 있습니다. 나중에 앱 서버를 다시 시작하세요.
