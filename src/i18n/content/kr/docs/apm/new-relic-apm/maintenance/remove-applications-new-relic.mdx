...
<CollapserGroup>
  ...
  >
    ...
    3. UI(및 [브라우저 모니터링의 모든 관련 앱)에서](/docs/browser/browser-monitoring/installation/install-browser-monitoring-agent/#select-apm-app) APM 애플리케이션을 제거하려면 다음 단계를 사용하십시오.
       ...
       * **UI에서 앱을 삭제합니다.** **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM & services > (앱/서비스 선택) > Settings > Application** 으로 이동하고 **Delete application** 버튼을 클릭합니다.
  </Collapser>
