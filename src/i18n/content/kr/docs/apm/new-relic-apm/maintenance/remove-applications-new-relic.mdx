...
<CollapserGroup>
  ...
  >
    ...
    * **UI에서 삭제합니다.** **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Browser > (앱 선택) > Settings > Application settings** 으로 이동하여 **Delete application** 버튼을 클릭합니다.
  </Collapser>
  ...
  >
    ...
    * **UI를 사용하여 제거하십시오.** **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Mobile > (앱 선택) > Settings > Application** 으로 이동하여 **애플리케이션 삭제** 를 클릭합니다.
