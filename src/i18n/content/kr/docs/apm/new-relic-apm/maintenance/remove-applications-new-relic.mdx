...
<CollapserGroup>
  ...
  <Collapser id="remove-otel-apps" title="오픈 텔레메트리">
    93일 후에 앱이 UI에서 제거됩니다. 그보다 빨리 삭제하고 싶다면 [NerdGraph를 이용해 관련 문제를 삭제하세요](/docs/apis/nerdgraph/examples/nerdgraph-entities-api-tutorial/#delete-entities). 분리 ID를 찾으려면 [분리를](/docs/new-relic-one/use-new-relic-one/core-concepts/what-entity-new-relic/#find) 참조하세요.
  </Collapser>
</CollapserGroup>
