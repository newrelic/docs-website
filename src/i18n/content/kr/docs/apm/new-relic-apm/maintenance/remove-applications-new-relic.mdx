...
<CollapserGroup>
  ...
  >
    ...
    3. UI(및 [브라우저 모니터링의 모든 관련 앱)에서](/docs/browser/browser-monitoring/installation/install-browser-monitoring-agent/#select-apm-app) APM 애플리케이션을 제거하려면 다음 단계를 사용하십시오.
       ...
       * **UI에서 앱을 삭제합니다.** **[one.newrelic.com](https://one.newrelic.com/all-capabilities) APM & services > (앱/서비스 선택) > Settings > Application** 으로 이동하여 **Delete application** 버튼을 클릭합니다.
  </Collapser>
  ...
  >
    ...
    * **UI에서 삭제합니다.** **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Browser > (앱 선택) > Settings > Application settings** 으로 이동하고 **Delete application** 버튼을 클릭합니다.
  </Collapser>
  ...
  >
    ...
    * **UI를 사용하여 제거하십시오.** **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Mobile > (앱 선택) > Settings > Application** 으로 이동하여 **Delete application** 를 클릭합니다.
...
<CollapserGroup>
  ...
  >
    모든 앱 데이터는 New Relic에서 해당 엔터티를 제거하기 전에 New Relic에 대한 보고를 중지해야 합니다. 대부분의 경우 10-15분 정도 걸립니다. 드문 경우지만 12-24시간이 소요될 수 있습니다.
  </Collapser>
  ...
  >
    ...
    1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities)** 에서 **APM** 을 선택한 다음 애플리케이션을 선택합니다.
    ...
    4. **[one.newrelic.com](https://one.newrelic.com/all-capabilities)** 에서 **APM** 을 선택한 다음 애플리케이션을 선택합니다.
