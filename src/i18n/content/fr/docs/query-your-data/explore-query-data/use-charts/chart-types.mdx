...
<img title="A bar chart example that compares transaction counts across applications." alt="A screenshot of a bar chart example that compares transaction counts across applications." src="/images/queries-nrql_screenshot-crop_bar-type-chart.webp" />
...
Facultativement, définissez des seuils pour colorer la jauge en fonction de sa valeur. Les graphiques à jauge prennent en charge les seuils <DNT>**Good**</DNT>, <DNT>**Warning**</DNT>, <DNT>**Approaching critical**</DNT> et <DNT>**Critical**</DNT>. Chaque seuil prend effet à partir d’une valeur que vous spécifiez, et la jauge change de couleur à mesure que la valeur franchit chaque plage.
