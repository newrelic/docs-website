...
<DNT>**NRQL predictions**</DNT> est disponible pour tous les clients et tous les utilisateurs. Les [CCU Core](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing/#core-compute-capacity-unit) sont consommées lorsque des requêtes NRQL sont exécutées avec la clause `PREDICT`.
...
<CollapserGroup>
  ...
  >
    ...
    <figcaption>
      \{&lt;&gt;Exemple de prédictions effectuées avec le mot-clé &lt;InlineCode&gt;BY&lt;/InlineCode&gt;. La zone encadrée indique quelle section du graphique est affectée par le mot-clé &lt;InlineCode&gt;BY&lt;/InlineCode&gt;.&lt;/&gt;}
    </figcaption>
  </Collapser>
  ...
  >
    ...
    <figcaption>
      \{&lt;&gt;Exemple de prédictions effectuées avec le mot-clé &lt;InlineCode&gt;USING&lt;/InlineCode&gt;. Le mot-clé &lt;InlineCode&gt;USING&lt;/InlineCode&gt; affecte la quantité de données utilisées pour l&apos;entraînement qui n&apos;est pas visualisée sur le graphique.&lt;/&gt;}
    </figcaption>
  </Collapser>
