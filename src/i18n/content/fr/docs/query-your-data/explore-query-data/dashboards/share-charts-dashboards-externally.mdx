...
<Tabs>
  ...
  <TabsPages>
    <TabsPageItem id="dashboard">
      ...
      * Si vous partagez un dashboard avec des widgets qui utilisent des variables de template, la liaison de facettes, des visualisations personnalisées, des tables de logs ou des graphiques basés sur SQL ([<DNT>Lens</DNT>](/docs/new-relic-lens/query-data)), ces widgets n&apos;afficheront aucune information dans la vue partagée.
