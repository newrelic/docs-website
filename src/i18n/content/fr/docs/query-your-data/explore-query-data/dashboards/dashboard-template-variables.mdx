...
Le bouton à bascule <DNT>**Include variable**</DNT> vous permet de définir une valeur souhaitée et d&apos;inclure ou d&apos;exclure cette valeur dans vos dashboards. Consultez la section [variables de template](#create-variables) pour plus d&apos;informations.
...
Vous pouvez masquer les variables de template de la barre des variables en mode Vue, alors qu&apos;elles continuent de fonctionner normalement en arrière-plan. En mode Édition, les variables masquées s&apos;affichent avec une icône <Icon name="fe-eye-off" />, afin que les éditeurs de dashboards puissent les identifier et les gérer.

Envisagez de masquer les variables qui :

* Ajouter de l&apos;encombrement à la barre des variables, comme des [variables imbriquées](/docs/query-your-data/explore-query-data/dashboards/nested-variables)
* Alimentez la logique du dashboard sans nécessiter de saisie du lecteur
* Dériver automatiquement des valeurs à partir d&apos;autres variables

Pour configurer la visibilité, utilisez l&apos;option <DNT>**Hide on variables bar**</DNT> lors de la [définition d&apos;une variable de template](#step1). Pour un accès programmatique, utilisez le champ `hiddenOnVariablesBar` dans l&apos;[API de dashboards NerdGraph](/docs/apis/nerdgraph/examples/nerdgraph-dashboards).
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Facultatif. Activez ce bouton pour masquer la variable de la barre des variables en mode Vue. La variable continue de fonctionner normalement en arrière-plan. En mode Édition, les variables cachées s&apos;affichent avec une icône <Icon name="fe-eye-off" />. Pour plus d&apos;informations, consultez [Afficher et masquer les variables](#variable-visibility).
          </td>
        </tr>
      </tbody>
    </table>
