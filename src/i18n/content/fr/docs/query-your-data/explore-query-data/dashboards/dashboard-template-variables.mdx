...
<CollapserGroup>
  ...
  <Collapser id="titles-labels-on-your-list-variables" title="Utilisez des titres ou des étiquettes sur vos variables de liste">
    ...
    Par exemple, disons que vous avez une variable comme celle-ci :
    ...
    Les titres que vous avez ajoutés seront affichés dans la liste déroulante de la variable. Cela n&apos;affectera en rien la logique de votre variable ou de votre widget.
