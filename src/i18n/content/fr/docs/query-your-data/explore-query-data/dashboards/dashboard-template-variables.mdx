...
Lorsque vous activez le bouton <DNT>**Include variable**</DNT> et sélectionnez une valeur, les données du dashboard sont filtrées par cette valeur. Vous pouvez cliquer sur <DNT>**Refresh to default value**</DNT> pour restaurer les paramètres par défaut configurés. Pour plus d&apos;informations, consultez les [variables de modèle](#create-variables).
