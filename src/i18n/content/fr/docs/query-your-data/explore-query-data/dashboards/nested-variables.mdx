...
<Callout variant="tip">
  Pour réduire l&apos;encombrement dans la barre des variables, masquez les variables parentes ou de support qui ne nécessitent pas de saisie utilisateur. Les variables cachées continuent de fonctionner normalement. Pour plus d&apos;informations, consultez [Afficher et masquer les variables](/docs/query-your-data/explore-query-data/dashboards/dashboard-template-variables/#variable-visibility).
</Callout>