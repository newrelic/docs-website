...
Pour en savoir plus sur cette fonctionnalité, consultez la [publication sur le forum de support concernant le filtrage par facettes](https://support.newrelic.com/s/hubtopic/aAX8W0000008aPj/facet-linking-in-new-relic-one-now-you-can-use-facets-to-filter-your-new-reli).
