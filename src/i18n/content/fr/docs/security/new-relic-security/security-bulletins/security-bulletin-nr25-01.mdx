  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        * Exécutez la requête NRQL suivante : `FROM Log select count(*) where (plugin.type like '%fluent%' or plugin.source like '%fluent%' or plugin.source like '%-fb-%') facet plugin.type, plugin.source, plugin.version`
