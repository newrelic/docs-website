...
* [Monitorer NGINX dans des environnements auto-hébergés](/docs/opentelemetry/integrations/nginx/nginx-otel-host/) - Configuration complète pour les déploiements sur l&apos;hôte
* [Monitorer NGINX sur Kubernetes](/docs/opentelemetry/integrations/nginx/nginx-otel-kubernetes/) - Configuration complète pour les déploiements Kubernetes

**Utilisation des données :**

* [Trouver et interroger vos données NGINX](/docs/opentelemetry/integrations/nginx/find-and-query-your-data/) - Dashboards, requêtes NRQL et alertes
