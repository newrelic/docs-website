...
<CollapserGroup>
  <Collapser id="producer-metrics" title="Métriques du producteur">
    ...
    | `kafka.producer.incoming_byte_rate`        | Rate of incoming bytes (responses from brokers) | identifiant-client, identifiant-nœud |
    | `kafka.producer.incoming_byte_total`       | Total incoming bytes (responses from brokers)   | identifiant-client, identifiant-nœud |
