            ...
            <TabsPages>
              <TabsPageItem id="helm">
                **Étape 1. Créer un secret d&apos;identifiants New Relic**
                ...
                <CollapserGroup>
                  <Collapser id="secret-us" title="Région États-Unis (par défaut)">
                    ```bash
              ...
              <TabsPageItem id="manifest">
                **Étape 1. Créer un secret d&apos;identifiants New Relic**
                ...
                <CollapserGroup>
                  <Collapser id="manifest-secret-us" title="Région États-Unis (par défaut)">
                    ```bash
                    kubectl create secret generic newrelic-otlp-secret \
                      --namespace newrelic \
                      --from-literal=NEW_RELIC_LICENSE_KEY='your-license-key-here' \
            ...
            <TabsPages>
              <TabsPageItem id="helm-prom">
                ...
                **Étape 1. Créer un secret d&apos;identifiants New Relic**
                ...
                <CollapserGroup>
                  <Collapser id="secret-us-prometheus" title="Région États-Unis (par défaut)">
                    ```bash
                    kubectl create secret generic newrelic-otlp-secret \
                      --namespace newrelic \
                      --from-literal=NEW_RELIC_LICENSE_KEY='your-license-key-here' \
              ...
              <TabsPageItem id="manifest-prom">
                ...
                **Étape 1. Créer un secret d&apos;identifiants New Relic**
                ...
                <CollapserGroup>
                  <Collapser id="manifest-secret-us-prometheus" title="Région États-Unis (par défaut)">
                    ```bash
                    kubectl create secret generic newrelic-otlp-secret \
                      --namespace newrelic \
                      --from-literal=NEW_RELIC_LICENSE_KEY='your-license-key-here' \
