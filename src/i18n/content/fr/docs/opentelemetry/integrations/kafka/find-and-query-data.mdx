...
/\* ### 3. Services tiers Idéal pour : le monitoring axé sur l&apos;intégration 1. Accédez à &lt;DNT&gt;\*\*\[one.newrelic.com]\(https\://one.newrelic.com) &gt; All capabilities &gt; Infrastructure &gt; Third-party services\*\*&lt;/DNT&gt; 2. Sélectionnez &lt;DNT&gt;\*\*Kafka (OpenTelemetry)\*\*&lt;/DNT&gt; &gt; &lt;DNT&gt;\*\*OTel Kafka Dashboard\*\*&lt;/DNT&gt; &lt;img title=&quot;Services tiers OTel Kafka&quot; alt=&quot;Vue des services tiers montrant l&apos;intégration Kafka (OpenTelemetry)&quot; src=&quot;/images/infrastructure\_screenshot-crop\_otel-kafka-third-party-integrations.webp&quot; /&gt; \*/
...
2. Rechercher <DNT>**&quot;OTel Kafka Dashboard&quot;**</DNT>
...
<CollapserGroup>
  <Collapser id="cluster-overview-queries" title="Aperçu du cluster">
    Obtenez des statistiques de cluster de haut niveau :
  ...
  <Collapser id="cluster-health-queries" title="Santé Cluster">
    Suivez l&apos;intégrité globale du cluster et l&apos;état des partitions :
