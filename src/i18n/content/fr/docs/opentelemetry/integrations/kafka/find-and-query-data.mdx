...
/\* ### 3. Services tiers Idéal pour : une supervision axée sur l&apos;intégration 1. Allez sur &lt;DNT&gt;\*\*\[one.newrelic.com]\(https\://one.newrelic.com) &gt; All capabilities &gt; Infrastructure &gt; Third-party services\*\*&lt;/DNT&gt; 2. Sélectionnez &lt;DNT&gt;\*\*Kafka (OpenTelemetry)\*\*&lt;/DNT&gt; &gt; &lt;DNT&gt;\*\*OpenTelemetry Kafka\*\*&lt;/DNT&gt; &lt;img title=&quot;Services tiers OTel Kafka&quot; alt=&quot;Vue Services tiers affichant l&apos;intégration Kafka (OpenTelemetry)&quot; src=&quot;/images/infrastructure\_screenshot-crop\_otel-kafka-third-party-integrations.webp&quot; /&gt; \*/
...
<CollapserGroup>
  <Collapser id="cluster-overview-queries" title="Aperçu du cluster">
    Obtenez des statistiques de haut niveau et l&apos;état de santé du cluster :
...
1. Allez sur [one.newrelic.com](https://one.newrelic.com) &gt; <DNT>**Dashboards**</DNT>

2. Cliquez <DNT>**Create a dashboard**</DNT>
...
* [Référence des métriques Kafka](/docs/opentelemetry/integrations/kafka/metrics-reference) - Liste complète des métriques disponibles avec leurs descriptions
* [Créer des conditions d&apos;alerte NRQL](/docs/alerts/create-alert/create-alert-condition/create-nrql-alert-conditions/) - Configurer un monitoring proactif
