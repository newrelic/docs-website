    ...
    <TabsPageItem id="java-agent">
      ...
      <Steps>
        ...
        <Step>
          ...
          | `NEW_RELIC_OTLP_ENDPOINT`          | Point de terminaison d&apos;ingestion OTLP. Utilisez `https://otlp.nr-data.net:4317` pour la région US (par défaut), `https://otlp.eu01.nr-data.net:4317` pour la région EU ou `https://otlp.jp.nr-data.net:4317` pour la région JP. Pour d&apos;autres configurations, consultez [Configurer votre point de terminaison OTLP](/docs/opentelemetry/best-practices/opentelemetry-otlp/#configure-endpoint-port-protocol). |
        </Step>
