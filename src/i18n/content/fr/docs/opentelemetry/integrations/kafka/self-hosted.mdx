...
<CollapserGroup>
  ...
  <Collapser id="jmx-subprocess-error" title="Erreur de sous-processus du récepteur JMX">
    ...
    **Vérifiez les identifiants d&apos;authentification JMX**: un nom d&apos;utilisateur ou un mot de passe incorrect est une cause fréquente d&apos;échecs de sous-processus

    Vérifiez que la configuration de votre récepteur JMX inclut les identifiants corrects :
    ...
    **Vérifiez que les identifiants sont définis**:
