...
* **Collecteur OpenTelemetry** - [OpenTelemetry Collector Contrib](https://github.com/open-telemetry/opentelemetry-collector-contrib/releases/latest) installé et en cours d&apos;exécution sur votre hôte. Installer via un package officiel (.deb ou .rpm) pour garantir que l&apos;unité de service systemd est créée correctement
