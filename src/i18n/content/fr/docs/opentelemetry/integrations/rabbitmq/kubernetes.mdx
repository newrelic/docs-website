...
<Steps>
  <Step>
    ...
    <CollapserGroup>
      <Collapser id="k8s-reqs" title="Prérequis du cluster Kubernetes">
  ...
  <Step>
    ### Vérifier le point de terminaison de gestion [#verify-endpoint]
  ...
  <Step>
    ...
    <Tabs>
      <TabsBar>
        <TabsBarItem id="us">Région US (par défaut)</TabsBarItem> <TabsBarItem id="eu">Région EU</TabsBarItem> <TabsBarItem id="jp">Région JP</TabsBarItem>
      </TabsBar>
