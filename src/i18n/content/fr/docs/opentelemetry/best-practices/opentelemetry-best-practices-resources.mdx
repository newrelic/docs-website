...
Votre infrastructure hébergée dans AWS peut être monitorée grâce à l&apos;intégration de New Relic avec [Amazon flux de métriques CloudWatch](/docs/infrastructure/amazon-integrations/aws-integration-for-metrics/via-cloudformation-cwms/). Il ne s&apos;agit pas d&apos;une solution OpenTelemetry pour le monitoring de votre infrastructure. Cependant, New Relic prend en charge un certain nombre de relations entre les services instrumentés OpenTelemetry et l&apos;infrastructure monitorée à l&apos;aide d&apos;Amazon flux de métriques CloudWatch. Les relations prises en charge sont répertoriées ci-dessous.
