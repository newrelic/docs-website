...
Consultez [les types d&apos;attributs OTLP](/docs/opentelemetry/best-practices/opentelemetry-otlp/#otlp-attribute-types) pour plus de détails sur les types d&amp;apos;attributs pris en charge par le point de terminaison OTLP de New Relic.
...
Pour afficher le journal d’un service, accédez à la [page de Logs](/docs/logs/ui-data/use-logs-ui/) de ce service.
