...
* **Masquage :** Remplace du contenu spécifique tout en préservant la mise en page. Le texte devient des astérisques (\*\*\*\*\*) et les images deviennent des blocs de remplacement.
