...
4. Dans le volet de gauche, sous <DNT>**Settings**</DNT>, cliquez sur <DNT>**Application Settings**</DNT>.
5. Activez <DNT>**Mobile Logs**</DNT> .
6. Cliquez sur <DNT>**Save**</DNT>.

* **Exigence de l&apos;Agent iOS :** La collecte automatique est **désactivée par défaut**. Pour l&apos;activer :
  ...
  2. Le bouton à bascule <DNT>**Mobile Logs**</DNT> est **On** dans l&apos;interface utilisateur New Relic.
...
2. Dans le volet de gauche, sous <DNT>**Settings**</DNT>, cliquez sur <DNT>**Application Settings**</DNT>.
...
## Comment les logs sont collectés [#collection-methods]

* **Collecte manuelle via l&apos;API (recommandé) :** Utilisez notre API pour envoyer des **messages de log, des attributs et des exceptions**spécifiques.
* **Collecte automatique :** L&apos;agent iOS peut capturer automatiquement les logs envoyés vers la sortie standard (`stdout`) et l&apos;erreur standard (`stderr`). Vous devez activer le feature flag `NRFeatureFlag_AutoCollectLogs` dans le code d&apos;initialisation de votre application pour la collecte automatique des logs.
