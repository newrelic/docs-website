...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Version minimale d&apos;iOS prise en charge, par version de l&apos;agent :

        * Version de l&apos;agent 7.7.7 ou version ultérieure : iOS 15.0 ou version ultérieure
        * Versions de l&apos;agent 7.6.2 à 7.7.6 : iOS 15.6 ou version ultérieure
        * Versions de l&apos;agent 7.6.0 et 7.6.1 : iOS 16 ou version ultérieure
        * Versions de l&apos;agent antérieures à 7.6.0 : iOS 10 ou version ultérieure, à l&apos;exception d&apos;iOS 15.0 à 15.5

        <Callout variant="important">
          Seule la version 7.7.7 de l&apos;agent ou une version ultérieure prend en charge iOS 15.0 à iOS 15.5. Toute version antérieure de l&apos;agent est totalement incompatible avec ces versions d&apos;OS. Si votre application prend en charge l&apos;une d&apos;entre elles, utilisez la version 7.7.7 de l&apos;agent ou une version ultérieure.
        </Callout>
