...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        * Agent version 7.6.2 ou version ultérieure : iOS 15 ou version ultérieure
        * Version de l&apos;agent 7.6.0 ou version ultérieure : iOS 16 ou version ultérieure
        * Versions de l&apos;agent antérieures à 7.6.0 : iOS 10 ou version ultérieure
