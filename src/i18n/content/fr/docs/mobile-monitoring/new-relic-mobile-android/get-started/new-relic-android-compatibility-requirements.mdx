...
<Callout variant="important">
  Depuis janvier 2021, notre agent Android a mis fin à la prise en charge du plug-in Android Gradle version 2. Pour plus d’informations, consultez notre [message sur le forum d’assistance](https://support.newrelic.com/s/hubtopic/aAX8W0000008bKn/important-upcoming-changes-to-capabilities-across-browser-php-python-mobile).
</Callout>
