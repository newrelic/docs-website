...
* Compte New Relic
* Destination e-mail (voir [Envoyer des notifications](/docs/workflow-automation/setup-and-configure/create-destinations))
...
**Pour planifier**, utilisez l&apos;[API CreateSchedule](/docs/workflow-automation/workflow-automation-apis/create-schedule) avec l&apos;expression cron `*/10 * * * *` (toutes les 10 minutes). L&apos;intervalle minimum est de 10 minutes. Consultez les [limites de workflow](/docs/workflow-automation/limitations-and-faq/workflow-limits) pour plus de détails.
...
<DocTiles>
  <DocTile title="Restauration du déploiement" path="/docs/workflow-automation/workflow-examples/advanced/deployment-rollback">
    Utiliser NRQL dans les workflows de déploiement
  </DocTile>

  <DocTile title="Gestion EC2" path="/docs/workflow-automation/workflow-examples/advanced/ec2-management">
    Combiner les requêtes NRQL avec l&apos;automatisation de l&apos;infrastructure
  </DocTile>

  <DocTile title="Actions NRQL" path="/docs/workflow-automation/setup-and-configure/actions-catalog/newrelic/query/newrelic-nrdb">
    Apprendre la syntaxe des actions de requête NRQL
  </DocTile>
</DocTiles>