...
<DocTiles>
  <DocTile title="Logique conditionnelle" path="/docs/workflow-automation/workflow-examples/basic-patterns/conditional-logic">
    Combiner des boucles avec des instructions switch
  </DocTile>

  <DocTile title="Interrogation de l'API REST" path="/docs/workflow-automation/workflow-examples/integrations/rest-api-polling">
    Utilisez des boucles pour les workflows d&apos;interrogation d&apos;API
  </DocTile>

  <DocTile title="Schéma de définition : Boucle" path="/docs/workflow-automation/workflow-automation-apis/definition-schema#loop">
    Référence complète de l&apos;étape de boucle
  </DocTile>
</DocTiles>