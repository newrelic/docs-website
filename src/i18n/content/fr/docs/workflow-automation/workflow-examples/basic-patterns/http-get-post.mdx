...
<DocTiles>
  <DocTile title="Analyse JSON" path="/docs/workflow-automation/workflow-examples/basic-patterns/json-parsing">
    Analyser et transformer les réponses HTTP
  </DocTile>

  <DocTile title="Interrogation de l'API REST" path="/docs/workflow-automation/workflow-examples/integrations/rest-api-polling">
    Créez des workflows d&apos;intégration d&apos;API complets
  </DocTile>

  <DocTile title="actions HTTP" path="/docs/workflow-automation/setup-and-configure/actions-catalog/actions-catalog">
    Découvrir tous les paramètres d&apos;action HTTP
  </DocTile>
</DocTiles>