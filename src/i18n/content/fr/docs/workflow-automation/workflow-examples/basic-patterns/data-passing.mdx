...
<DocTiles>
  <DocTile title="Boucles" path="/docs/workflow-automation/workflow-examples/basic-patterns/loops">
    Passer des données à travers les itérations de boucle
  </DocTile>

  <DocTile title="Logique conditionnelle" path="/docs/workflow-automation/workflow-examples/basic-patterns/conditional-logic">
    Utiliser des données dans les conditions de switch
  </DocTile>

  <DocTile title="Analyse JSON" path="/docs/workflow-automation/workflow-examples/basic-patterns/json-parsing">
    Extraire et transmettre des données JSON
  </DocTile>
</DocTiles>