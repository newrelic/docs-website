...
* **[Créez votre propre workflow](/docs/workflow-automation/create-a-workflow-automation/create-your-own)** - Guide étape par étape pour la création d&apos;un workflow
* **[Catalogue des actions](/docs/workflow-automation/setup-and-configuration/actions-catalog/actions-catalog)** - Parcourir toutes les actions disponibles
* **[Utiliser un modèle](/docs/workflow-automation/create-a-workflow-automation/use-a-template)** - déployer un workflow préconfiguré
* **[Configurer les informations d&apos;identification AWS](/docs/workflow-automation/setup-and-configuration/set-up-aws-credentials)** - Configurer l&apos;authentification AWS