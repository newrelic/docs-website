...
<CollapserGroup>
  ...
  <Collapser id="aws-bedrock-invokeAgent" title="Invoquer un agent AWS Bedrock">
    ...
    ### Exemple de rôle AWS pour exécuter un agent Bedrock
    ...
    ### Politique de confiance pour la production
    ...
    ### Stratégie de confiance pour la préproduction ou le développement
