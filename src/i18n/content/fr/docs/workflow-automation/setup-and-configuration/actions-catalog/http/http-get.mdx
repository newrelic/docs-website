        ...
        <tbody>
          <tr>
            ...
            <td>
              ...
              [utilisation des entrées de workflow](/docs/workflow-automation/workflow-examples/#using-workflow-inputs)
