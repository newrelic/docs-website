  ...
  <TabsPages>
    <TabsPageItem id="iam-role-1">
      ...
      * Conforme aux bonnes pratiques de sécurité AWS
      ...
      <Callout variant="tip">
        **Important :** Les ARN de rôle vont directement dans les entrées de workflow : ne les stockez pas dans le [gestionnaire de secrets](/docs/workflow-automation/limitations-and-faq/workflow-best-practices/#secure-credentials). Ce ne sont pas des informations d&apos;identification sensibles ; ce sont des identificateurs de ressources.
      </Callout>
    ...
    <TabsPageItem id="iam-user-1">
      ...
      * Flux d&apos;authentification simplifié
      ...
      Ne codez jamais en dur les informations d&apos;identification AWS dans les workflows. Stockez-les plutôt dans le [gestionnaire de secrets](/docs/workflow-automation/limitations-and-faq/workflow-best-practices/#secure-credentials) de New Relic.
    ...
    <TabsPageItem id="session-tokens-1">
      ...
      * Environnements soumis à des exigences de conformité en matière d&apos;accès limité dans le temps (généralement de 1 à 12 heures)
      ...
      3. Stockez les trois informations d&apos;identification dans le [gestionnaire de secrets](/docs/workflow-automation/limitations-and-faq/workflow-best-practices/#secure-credentials):
...
Collez l&apos;ARN du rôle directement dans les entrées de workflow : pas besoin de [gestionnaire de secrets](/docs/workflow-automation/limitations-and-faq/workflow-best-practices/#secure-credentials) :
...
Référez-vous au [gestionnaire de secrets](/docs/workflow-automation/limitations-and-faq/workflow-best-practices/#secure-credentials) pour les clés d&apos;accès :
