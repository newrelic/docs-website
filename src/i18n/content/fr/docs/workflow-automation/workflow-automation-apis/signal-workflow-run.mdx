...
<DocTiles>
  <DocTile title="Schéma de définition : Étape d'attente" path="/docs/workflow-automation/workflow-automation-apis/definition-schema#wait">
    Apprenez à configurer des étapes d&apos;attente avec des signaux
  </DocTile>

  <DocTile title="Démarrer l'exécution du workflow" path="/docs/workflow-automation/workflow-automation-apis/start-workflow-run">
    Exécutez un workflow pour obtenir un runId pour le signalement
  </DocTile>

  <DocTile title="Informations sur l'exécution du workflow" path="/docs/workflow-automation/workflow-automation-apis/workflow-run-info">
    Vérifier si le workflow est en attente d&apos;un signal
  </DocTile>
</DocTiles>