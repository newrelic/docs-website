...
<Callout variant="tip">
  ...
  * **E-mail**: utilisez [`newrelic.notification.sendEmail`](/docs/workflow-automation/setup-and-configure/actions-catalog/newrelic/notification/newrelic-notification) après avoir configuré des destinations e-mail dans [Alerts &gt; Destinations](/docs/alerts/get-notified/destinations/)
</Callout>
