...
<CollapserGroup>
  <Collapser id="aws.ec2.runInstances" title="Instance d'exécution">
  ...
  <Collapser id="aws.ec2.startInstances" title="Redémarrer les instances">
  ...
  <Collapser id="aws.ec2.stopInstances" title="Arrêter les instances">
  ...
  <Collapser id="aws.ec2.terminateInstances" title="Arrêter les instances">
  ...
  <Collapser id="aws.ec2.createSnapshot" title="Créer un instantané EBS">
  ...
  <Collapser id="aws.ec2.deleteSnapshot" title="Supprimer l'instantané">
