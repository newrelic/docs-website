...
<CollapserGroup>
  <Collapser id="aws.sqs.sendMessage" title="Envoyer un message à une file d'attente SQS">
...
<CollapserGroup>
  <Collapser id="aws.sqs.receiveMessage" title="Recevoir un message d'une file d'attente SQS">
