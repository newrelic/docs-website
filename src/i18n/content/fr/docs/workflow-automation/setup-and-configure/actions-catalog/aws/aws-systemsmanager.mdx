...
<CollapserGroup>
  <Collapser id="aws.systemsManager.writeDocument" title="Créer un document">
      ...
      <TabsPages>
        ...
        <TabsPageItem id="writedocumentoutputs">
          ...
          <Callout variant="important">
            ...
            * Reportez-vous aux [identifiants AWS](/docs/workflow-automation/setup-and-configure/set-up-aws-credentials) pour obtenir des instructions.
          </Callout>
        </TabsPageItem>
...
<CollapserGroup>
  <Collapser id="aws.systemsManager.deleteDocument" title="Supprimer le document">
...
<CollapserGroup>
  <Collapser id="aws.systemsManager.startAutomation" title="Démarrer l'automatisation">
      ...
      <TabsPages>
        ...
        <TabsPageItem id="automationstatusoutputs">
          ...
          <Callout variant="important">
            ...
            3. Reportez-vous aux instructions pour configurer les [identifiants AWS](/docs/workflow-automation/setup-and-configure/set-up-aws-credentials).
