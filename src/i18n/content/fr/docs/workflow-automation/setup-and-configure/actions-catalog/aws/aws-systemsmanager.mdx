      ...
      <TabsPages>
        ...
        <TabsPageItem id="writedocumentoutputs">
          ...
          <Callout variant="important">
            ...
            * Reportez-vous à [Informations d&apos;identification AWS](/docs/workflow-automation/setup-and-configure/set-up-aws-credentials) pour obtenir des instructions.
          </Callout>
        </TabsPageItem>
        ...
        <TabsPageItem id="writedocumentexample">
          ...
          **Exemple 3 : Un document SSM plus complexe**
          ...
          <Collapser id="ssm.document.performing" title="Document SSM effectuant un rollback de le gateway API">
      ...
      <TabsPages>
        ...
        <TabsPageItem id="automationstatusoutputs">
          ...
          <Callout variant="important">
            ...
            3. Consultez les instructions pour configurer [les identifiants AWS](/docs/workflow-automation/setup-and-configure/set-up-aws-credentials).
