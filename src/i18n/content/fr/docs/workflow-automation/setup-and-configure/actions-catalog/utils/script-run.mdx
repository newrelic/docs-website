---
title: Action d'exécution de script
tags:
  - workflow automation
  - workflow
  ...
  - Utils actions
  - Script actions
metaDescription: Execute Python scripts in workflow automation to transform data and perform custom operations
freshnessValidatedDate: '2026-02-24T00:00:00.000Z'
translationType: machine
---

Cette page constitue une référence complète pour l&apos;action `script.run` disponible dans le catalogue d&apos;actions d&apos;automatisation de workflow. Cette action vous permet d&apos;exécuter des scripts Python au sein de vos workflows pour la transformation de données, le traitement et les opérations personnalisées.
