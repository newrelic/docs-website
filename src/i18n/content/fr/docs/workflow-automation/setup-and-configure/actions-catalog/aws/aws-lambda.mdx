...
<CollapserGroup>
  <Collapser id="aws.lambda.invoke" title="Invoquer une fonction Lambda">
  ...
  <Collapser id="aws.lambda.updateFunctionConfiguration" title="Mise à jour de la configuration de la fonction">
  ...
  <Collapser id="aws.lambda.getFunction" title="Décrire une fonction Lambda spécifique">
  ...
  <Collapser id="aws.lambda.listAliases" title="Lister les alias d'une fonction Lambda spécifique">
    Renvoie une liste d&apos;alias pour une fonction Lambda spécifique. Les alias sont des pointeurs vers des versions de fonction.
  ...
  <Collapser id="aws.bedrock.invokeAgent" title="Invoquer un agent Bedrock">
    Invoque un agent Bedrock.
