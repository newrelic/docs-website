...
Pour utiliser cette action, vous devez configurer les identifiants AWS. Consultez [Configurer les identifiants AWS](/docs/workflow-automation/setup-and-configure/set-up-aws-credentials/) pour des instructions détaillées sur la création d&apos;un rôle IAM ou d&apos;un utilisateur IAM.
...
## Exécuter une API AWS [#aws-execute-api]
