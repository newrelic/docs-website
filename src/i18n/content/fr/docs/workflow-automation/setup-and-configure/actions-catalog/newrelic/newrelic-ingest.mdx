...
<CollapserGroup>
  <Collapser id="newrelic.ingest.sendEvents" title="Envoyer des événements">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  [En savoir plus sur nos clés d&apos;API](/docs/apis/intro-apis/new-relic-api-keys#license-key) pour créer et gérer votre **clé de licence de compte New Relic**.
                </td>
...
<CollapserGroup>
  <Collapser id="newrelic.ingest.sendLogs" title="Envoyer les logs">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  Ne saisissez pas d&apos;identifiants en clair. Veuillez consulter l&apos;exemple de syntaxe des secrets ci-dessous.

                  Exemple : `"{{ .secrets.secretName }}"`, où `secretName` est la clé sous laquelle la clé de licence est stockée.
                </td>
              </tr>
