...
* **À ne pas faire**: Créer des workflows distincts pour **interroger l&apos;alerte**, **formater le message**, **envoyer vers Slack**
...
* **À faire**: **Redimensionnement automatique EC2 pour les alertes de CPU élevé**
* **À ne pas faire**: **Workflow 1** ou **Automatisation EC2**
...
<Callout variant="important">
  Redimensionne automatiquement les instances EC2 lorsque le processeur dépasse 80 % pendant 10 minutes. Notifie l&apos;équipe DevOps via Slack. Utilisé par les ingénieurs de garde pour gérer les coûts d&apos;infrastructure.
</Callout>
...
### Évitez l&apos;utilisation d&apos;informations personnelles

L&apos;automatisation des workflows générera des enregistrements d&apos;événements pour les exécutions, et ces enregistrements ne peuvent pas être supprimés à des fins d&apos;intégrité et d&apos;auditabilité. Évitez d&apos;ajouter des informations personnellement identifiables ou des données personnelles dans les `workflow definition name` et `step name`.

## Sujets connexes [#related-topics]

<DocTiles>
  <DocTile title="Limites de workflow" path="/docs/workflow-automation/limitations-and-faq/workflow-limits">
    Comprendre les délais d&apos;attente, les limites de débit et les contraintes du système
  </DocTile>

  <DocTile title="Dépannage" path="/docs/workflow-automation/troubleshooting">
    Déboguer les erreurs et échecs courants des workflows
  </DocTile>
  ...
  <DocTile title="API d'automatisation de workflows" path="/docs/workflow-automation/workflow-automation-apis/using-workflow-automation-api">
    Gérer les workflows par programmation pour la CI/CD
  </DocTile>

  <DocTile title="Exemples de workflow" path="/docs/workflow-automation/workflow-examples/workflow-examples">
    Voir les bonnes pratiques appliquées dans des workflows réels
  </DocTile>
</DocTiles>