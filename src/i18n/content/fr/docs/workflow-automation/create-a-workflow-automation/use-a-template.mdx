...
<CollapserGroup>
  ...
  <Collapser id="ec2-instance-management" title="Gestion des instances EC2">
    ...
    * **Slack**: Application de notification et d&apos;approbation
    * **New Relic**: Condition d’alerte monitorant EC2, EC2 intégré à New Relic via les [flux de métriques CloudWatch](/docs/infrastructure/amazon-integrations/aws-integration-for-metrics/via-cloudformation-cwms/), et l’ [intégration de monitoring EC2](/docs/infrastructure/amazon-integrations/aws-integrations-list/aws-ec2-monitoring-integration#activate)
