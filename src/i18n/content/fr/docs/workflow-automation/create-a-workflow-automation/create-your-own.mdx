...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        [Boucles](/docs/workflow-automation/workflow-examples#loop-structure)
      </td>
...
Pour des informations détaillées sur la structure de la boucle, les paramètres et l&apos;utilisation avancée (y compris break/continue), consultez [Structure de la boucle](/docs/workflow-automation/workflow-examples#loop-structure).
