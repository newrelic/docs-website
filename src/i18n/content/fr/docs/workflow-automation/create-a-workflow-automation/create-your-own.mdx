...
<Callout variant="important">
  Pour les bonnes pratiques et les limites en matière de sécurité et de confidentialité, notamment la suppression des données, consultez les [bonnes pratiques de sécurité](/docs/workflow-automation/limitations-and-faq/workflow-best-practices/#security).
</Callout>
