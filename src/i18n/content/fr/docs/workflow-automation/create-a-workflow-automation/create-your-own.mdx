...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        [Erreur](/docs/workflow-automation/workflow-automation-apis/definition-schema#error)
      </td>

      <td>
        Faire échouer le workflow avec un message personnalisé, éventuellement conditionné
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        Faire échouer le workflow avec un message
      </td>

      <td>
        `type: error` avec `message:` et facultatif `condition:`
      </td>

      <td>
        Arrêter le workflow avec un message d’échec personnalisé lorsqu’une condition est remplie
      </td>
    </tr>
  </tbody>
</table>
