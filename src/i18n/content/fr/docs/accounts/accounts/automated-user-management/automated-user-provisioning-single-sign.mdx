...
* Vous devez avoir un [type d&apos;utilisateur](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type) Core ou Full platform et être dans un groupe avec le [rôle<DNT>**Authentication domain manager**</DNT> ](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts#admin-settings)au niveau de l&apos;organisation.
