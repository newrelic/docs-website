...
<CollapserGroup>
  ...
  <Collapser id="manage-user-type-scim" title="Gérer le type d'utilisateur avec SCIM">
    ...
    * Azure Active Directory : reportez-vous à la discussion du forum New Relic sur la configuration Azure AD pour SCIM avec les types d’utilisateur [ici](https://support.newrelic.com/s/hubtopic/aAX8W0000008d6MWAQ/relic-solution-make-full-core-basic-users-in-azure-active-directory-w-scim).
