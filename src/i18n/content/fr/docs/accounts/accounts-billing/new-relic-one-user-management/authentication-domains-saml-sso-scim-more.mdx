...
### Configurer l&apos;authentification multifacteur (MFA) [#mfa]

Vous pouvez ajouter une couche de sécurité à vos données en exigeant l&apos;authentification multifacteur (MFA) pour tous les utilisateurs d&apos;un domaine d&apos;authentification. Une fois activé, tous les utilisateurs du domaine d&apos;authentification recevront un e-mail de vérification à chaque connexion. Ils recevront également dix codes de sauvegarde la première fois qu&apos;ils devront vérifier leur e-mail, qui pourront être utilisés s&apos;ils ne peuvent pas accéder à leur e-mail. Assurez-vous que vos utilisateurs copient ces codes dans un endroit sûr.
