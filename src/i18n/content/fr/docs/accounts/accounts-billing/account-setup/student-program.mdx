...
<Callout variant="important">
  L&apos;inscription en libre-service n&apos;est pas disponible pour le moment. Pour demander New Relic for Students, consultez d&apos;abord les [conditions d&apos;éligibilité](#student-eligibility) ci-dessus, puis [ouvrez un dossier d&apos;assistance](/docs/new-relic-solutions/solve-common-issues/find-help-get-support/#file-ticket) pour que l&apos;édition Étudiant soit provisionnée sur votre compte. Les étapes en libre-service ci-dessous fonctionneront une fois que l&apos;inscription en libre-service sera rétablie.
</Callout>
...
3. Connectez-vous à <DNT>**[one.newrelic.com &gt; All capabilities](https://one.newrelic.com/all-capabilities)**</DNT> et dans le coin inférieur gauche, cliquez sur <DNT>**Help &gt; Resources &gt; New Relic for Students**</DNT>.
4. Cliquez sur <DNT>**GitHub Education**</DNT>, puis suivez les étapes pour utiliser OAuth pour connecter votre compte GitHub Student à New Relic.
