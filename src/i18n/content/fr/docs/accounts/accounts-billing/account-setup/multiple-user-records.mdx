...
Chaque [organisation New Relic](/docs/accounts/accounts-billing/account-structure/new-relic-account-structure) à laquelle vous avez accès possède son propre enregistrement utilisateur pour votre adresse e-mail. Pour basculer entre ces enregistrements utilisateur, allez dans le menu utilisateur et sélectionnez <DNT>**Other users**</DNT>. Choisissez ensuite un enregistrement utilisateur pour une autre organisation. New Relic vous invite à vous connecter pour cette organisation, soit directement, soit via votre fournisseur d&apos;identité.
