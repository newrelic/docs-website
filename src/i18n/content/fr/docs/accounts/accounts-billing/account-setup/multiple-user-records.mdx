...
<Callout variant="important">
  Pour être entièrement supprimé d&apos;un domaine d&apos;authentification ou d&apos;une organisation, utilisez l&apos;une de ces méthodes :
  ...
  * **Méthode de secours :** créez un [ticket de support New Relic](/docs/new-relic-solutions/solve-common-issues/find-help-get-support/#file-ticket) avec un consentement explicite pour supprimer votre utilisateur d&apos;un ou plusieurs domaines d&apos;authentification de cette organisation. La suppression est définitive et ne peut pas être annulée.
</Callout>
...
Lorsque vous vous connectez à New Relic, vous pouvez accéder au [menu utilisateur](/docs/accounts/accounts-billing/general-account-settings/intro-account-settings) pour basculer vers d&apos;autres enregistrements d&apos;utilisateur ayant la même adresse e-mail. Lorsque vous choisissez un enregistrement d&apos;utilisateur dans le menu, vous serez invité à vous connecter pour cet enregistrement d&apos;utilisateur (soit directement à New Relic, soit via votre fournisseur d&apos;identité).
