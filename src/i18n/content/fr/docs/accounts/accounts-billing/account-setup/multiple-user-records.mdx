...
<Callout variant="important">
  Pour être entièrement supprimé du ou des domaine(s) d’authentification d’une organisation, ce qui est permanent et ne peut pas être annulé, utilisez l’un de ces chemins :

  * **Méthode privilégiée :** demandez à un utilisateur administrateur de cette organisation de supprimer votre utilisateur d&apos;un ou plusieurs domaines d&apos;authentification de cette organisation
  * **Chemin de repli :** Créez un [ticket de support New Relic](/docs/new-relic-solutions/solve-common-issues/find-help-get-support/#file-ticket) avec le consentement explicite de supprimer votre utilisateur d&apos;un ou plusieurs domaines d&apos;authentification dans cette organisation.
</Callout>
...
Chaque [organisation New Relic](/docs/accounts/accounts-billing/account-structure/new-relic-account-structure) à laquelle vous avez accès possède son propre enregistrement utilisateur pour votre adresse e-mail. Pour basculer entre ces enregistrements d&apos;utilisateur, dans le menu utilisateur, sélectionnez <DNT>**Other users**</DNT>. Chaque entrée affiche le nom de l&apos;organisation et le [domaine d&apos;authentification](/docs/accounts/accounts-billing/new-relic-one-user-management/authentication-domains-saml-sso-scim-more) pour cet enregistrement d&apos;utilisateur. Si une organisation possède plus d&apos;un domaine d&apos;authentification, vous aurez un enregistrement d&apos;utilisateur distinct pour chacun d&apos;eux. Choisir une autre entrée vous invite à vous connecter pour cette organisation, soit directement, soit via votre fournisseur d&apos;identité.

Si vous n&apos;avez accès qu&apos;à une seule organisation, l&apos;option <DNT>**Other users**</DNT> n&apos;apparaîtra pas dans le menu utilisateur.

<Callout variant="tip">
  Pour accéder aux enregistrements d&apos;utilisateurs qui ont une adresse e-mail différente, vous devez vous déconnecter et re-connecter .
</Callout>
...
La vérification de votre adresse e-mail vous permettra de choisir à quel enregistrement d&apos;utilisateur accéder. Si vous ne vérifiez pas votre adresse e-mail, New Relic essaiera de vous connecter avec l&apos;enregistrement d&apos;utilisateur le plus récemment créé associé à votre adresse e-mail.
