...
<Steps>
  ...
  <Step>
    ...
    3. Votre [région New Relic](/docs/using-new-relic/welcome-new-relic/get-started/our-eu-us-region-data-centers#verifying-account). Votre région est `US` si votre URL New Relic est `one.newrelic.com`, `EU` si votre URL est à `one.eu.newrelic.com`, ou `JP` si votre URL est à `one.jp.newrelic.com`.
    ...
    provider "newrelic" {
      ...
      region = "US"        # US, EU, or JP (defaults to US)
    }
    ```
