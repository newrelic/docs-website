...
Pour trouver votre identifiant de compte et votre identifiant d’application mobile, ouvrez votre application mobile dans [one.newrelic.com](https://one.newrelic.com), cliquez sur l&apos;icône <DNT>**(i)**</DNT>, et lisez les valeurs de l&apos;onglet <DNT>**Metadata**</DNT>.
