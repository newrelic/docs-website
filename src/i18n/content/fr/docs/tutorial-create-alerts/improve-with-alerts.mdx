...
<Steps>
  ...
  <Step>
    ...
    * <DNT>**Alert event count**</DNT>: alertes avec un nombre élevé d&apos;événements d&apos;alerte
    * <DNT>**Accumulated alert event time**</DNT>: alertes avec des durées cumulées élevées
    * <DNT>**Mean time to close**</DNT>: le temps nécessaire pour que les événements d&apos;alerte soient fermés
    * <DNT>**Percent under 5 minutes**</DNT>: le nombre d&apos;événements d&apos;alerte ouverts depuis moins de 5 minutes
  ...
  <Step>
    ...
    Vous devez traiter les événements d&apos;alerte en suivant les directives suivantes après avoir établi vos bases de référence :
    ...
    * Si l&apos;événement d&apos;alerte est toujours actif, ne le fermez pas et ne l&apos;acquittez pas.
  </Step>

  <Step>
    ## Rassemblez vos données

    Il faut un certain temps pour accumuler vos données d&apos;alerte depuis le dashboard. Vous devriez attendre au moins deux semaines pour collecter ces données, mais vérifiez régulièrement que les intervenants sur les événements d&apos;alerte respectent les consignes décrites à l&apos;étape précédente.
  </Step>
  ...
  <Step>
    ...
    3. Utilisez le dashboard pour identifier les règles d&apos;événements d&apos;alerte les plus bruyantes.
