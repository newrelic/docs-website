...
<Callout variant="important">
  Roku a `roRegex` restrictions de modèle qui affectent les règles d’obfuscation. Consultez [Limitations pour Streaming vidéo et publicitaire](/docs/streaming-video-&-ads/limitations#roku-regex) pour plus de détails.
</Callout>