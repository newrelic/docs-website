...
<Callout variant="important">
  Roku présente des restrictions de modèle d’expression régulière qui affectent les règles d’obfuscation. Consultez [Limitations pour Streaming vidéo et publicitaire](/docs/streaming-video-&-ads/limitations#roku-regex) pour plus de détails.
</Callout>