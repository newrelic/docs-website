...
* URL du point de terminaison HTTP - centre de données américain (par défaut) : `https://aws-api.newrelic.com/cloudwatch-metrics/v1`
* URL du point de terminaison HTTP - Centre de données de l&apos;UE : `https://aws-api.eu01.nr-data.net/cloudwatch-metrics/v1`
* URL du point de terminaison HTTP - data center JP : `https://aws-api.jp.nr-data.net/cloudwatch-metrics/v1`
