...
<CollapserGroup>
  ...
  <Collapser id="cloudformation" title="Modèles CloudFormation / SAM">
    ...
    1. Installez la [couche Lambda New Relic](https://layers.newrelic-external.com/). Vous trouverez ci-dessous des exemples pour les fonctions Lambda des agents Node.js et Java.
       ...
       **Exemple d&apos;agent Java (couche fine, recommandée) :**

       <Callout variant="important">
         La couche de l&apos;agent Java nécessite Java 17 ou une version ultérieure. Les runtimes Java 11 et antérieurs ne sont pas pris en charge.
       </Callout>
  ...
  <Collapser id="console" title="Instrumentation manuelle AWS">
    Bien que cela soit plus sujet aux erreurs et plus laborieux que les approches ci-dessus, vous pouvez modifier manuellement la configuration d’une fonction Lambda pour utiliser New Relic depuis la console AWS Lambda, pour Node.js, Python, Ruby et Java.
