      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              Set the logs endpoint. Select the URL as per your region:

              * US region (default):<br />`https://log-api.newrelic.com/log/v1`
              * EU region:<br />`https://log-api.eu.newrelic.com/log/v1`
              * JP region:<br />`https://log-api.jp.nr-data.net/log/v1`
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              Set the telemetry endpoint. Select the URL as per your region:

              * US region (default):<br />`https://cloud-collector.newrelic.com/aws/lambda/v1`
              * EU data center:<br />`https://cloud-collector.eu01.nr-data.net/aws/lambda/v1`
              * JP data center:<br />`https://cloud-collector.jp.nr-data.net/aws/lambda/v1`
            </td>
          </tr>
