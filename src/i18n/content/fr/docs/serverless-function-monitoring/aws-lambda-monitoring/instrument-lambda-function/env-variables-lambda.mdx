...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Spécifie le wrapper de gestionnaire utilisé pour trouver le gestionnaire réel de votre fonction. Pour les environnements d&apos;exécution Go, cette variable n&apos;est pas requise.
      </td>
    </tr>
  ...
  <TabsPages>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              Définit le nom de l&apos;application utilisé comme nom d&apos;entité APM dans l&apos;UI de New Relic lorsque `NEW_RELIC_APM_LAMBDA_MODE` est `true`. Consultez [NEW\_RELIC\_APP\_NAME pour les fonctions Lambda en mode APM](/docs/serverless-function-monitoring/aws-lambda-monitoring/instrument-lambda-function/app-name-apm-lambda/) pour plus de détails sur le regroupement d’entités, le reporting multi-régions, le comportement inter-runtime et le nommage partagé avec les services non-Lambda.
            </td>
          </tr>
    ...
    <TabsPageItem id="java">
      <Callout variant="important">
        La nouvelle couche de l&apos;agent Java nécessite Java 17 ou supérieur. Il s’agit d’une solution distincte de la [solution Java](/docs/serverless-function-monitoring/aws-lambda-monitoring/instrument-lambda-function/instrument-your-own/#console) legacy. Si vous utilisez le monitoring serverless pour votre application avant le 10 avril 2026 ou si vous êtes sur Java 8 ou 11, veuillez continuer à utiliser la solution legacy qui est basée sur Open Tracing.
      </Callout>
      ...
      <table>
        ...
        <tbody>
            ...
            <td>
              **Requis**
              ...
              `/opt/newrelic-java-handler`
               ...
               lors de l&apos;utilisation de la couche de l&apos;agent Java de New Relic. Cela pointe AWS Lambda vers le script wrapper de l&apos;agent inclus dans la couche.
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              Active le mode serverless. Détecté automatiquement lorsque 

              `AWS_LAMBDA_FUNCTION_NAME`

               est présent. Préconfiguré pour 
          ...
          <tr>
            ...
            <td>
              Par défaut, configure le fichier de log de l&apos;agent Java pour qu&apos;il se trouve dans le chemin absolu 
          ...
          <tr>
            ...
            <td>
              Activer le logging de débogage en définissant ceci sur 
      ...
      Vous pouvez trouver plus de variables d’environnement dans notre [documentation de configuration de l’agent Java](/docs/apm/agents/java-agent/configuration/java-agent-configuration-config-file/) et le [monitoring serverless Java](/docs/apm/agents/java-agent/getting-started/java-agent-approaches-lambda).
    </TabsPageItem>
          ...
          <tr>
            ...
            <td>
              `debug`
               ...
               pour le débogage, ou vide pour les informations
            </td>
      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td>
              Lorsque `NEW_RELIC_APM_LAMBDA_MODE` est `true`, l&apos;extension utilise cette valeur comme nom d&apos;entité APM lors de l&apos;appel de connexion de démarrage à froid. Consultez [NEW\_RELIC\_APP\_NAME pour les fonctions Lambda en mode APM](/docs/serverless-function-monitoring/aws-lambda-monitoring/instrument-lambda-function/app-name-apm-lambda/) pour plus de détails sur le regroupement d’entités, le reporting multi-région, le comportement inter-runtime et le nommage partagé avec les services non-Lambda.
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              Envoyer les logs de la plateforme en définissant cette option sur 
          ...
          <tr>
            ...
            <td>
              Détermine quels logs envoyer. Définissez sur 
              ...
              , ou utilisez une liste séparée par des virgules (par exemple : 

              `platform,extension`

              ). Cette variable a priorité sur les variables individuelles de type de log.
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              Définir le point de terminaison des logs. Sélectionnez l’URL en fonction de votre région :

              * Région US (par défaut) :<br />`https://log-api.newrelic.com/log/v1`
              * Région UE :<br />`https://log-api.eu.newrelic.com/log/v1`
              * Région JP :<br />`https://log-api.jp.nr-data.net/log/v1`
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              Définir le point de terminaison de télémétrie. Sélectionnez l’URL en fonction de votre région :

              * Région US (par défaut) :<br />`https://cloud-collector.newrelic.com/aws/lambda/v1`
              * Data center de l&apos;UE :<br />`https://cloud-collector.eu01.nr-data.net/aws/lambda/v1`
              * Data center JP :<br />`https://cloud-collector.jp.nr-data.net/aws/lambda/v1`
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              Pour aider New Relic à cartographier et afficher correctement les relations entre vos entités monitorées, fournissez l&apos;ID du compte AWS où se trouvent vos ressources monitorées, telles que la base de données et la fonction Lambda.
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              Configure un proxy pour le trafic sortant de l&apos;extension et n&apos;affecte pas le trafic de la fonction Lambda.

              <br />

              <br />

              * **Prend en charge :** les schémas `http://`, `https://` et `socks5://`
              * **Authentification :** prend en charge `user:pass` (masqué dans le log)
              * **Solution de secours :** utilise `HTTPS_PROXY` ou `HTTP_PROXY` si non défini

              <Callout variant="tip" title="remarque">
                Le trafic localhost ne passe jamais par un proxy.
              </Callout>
            </td>
          </tr>
        </tbody>
