...
## Étape 2 : Installer la couche [#install]
...
## Étape 3 : Configurer la couche [#configure]
...
## Étape 4 : ajouter des variables d’environnement New Relic [#env-variables]
...
## Étape 5 : Configurer le Collector [#collector]
...
## Étape 6 : Affichez vos données dans l&apos;interface utilisateur de New Relic \[view-data]
