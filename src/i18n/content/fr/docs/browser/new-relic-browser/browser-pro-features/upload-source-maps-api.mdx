...
<Callout variant="important">
  Les exemples suivants sont pour les comptes américains (par défaut). Pour les autres régions, utilisez le point de terminaison correspondant :

  * Comptes UE : `https://sourcemaps.service.eu.newrelic.com`
  * Comptes JP : `https://sourcemaps.service.jp.newrelic.com`

  Pour plus d&apos;informations, consultez [Choisir votre data center](/docs/accounts/accounts-billing/account-setup/choose-your-data-center).
</Callout>
