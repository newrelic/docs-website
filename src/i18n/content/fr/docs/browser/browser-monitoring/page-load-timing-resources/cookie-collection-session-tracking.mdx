...
* La session est réinitialisée par programme lors de l&apos;appel de la fonction pour mettre à jour l&apos;ID utilisateur via [setUserId()](/docs/browser/new-relic-browser/browser-apis/setuserid)
