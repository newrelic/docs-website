...
<Steps>
  <Step>
    ...
    4. Dans la page des paramètres de l&apos;application, assurez-vous que l&apos;agent browser <DNT>**Pro**</DNT> ou <DNT>**Pro + SPA**</DNT> est sélectionné. Le suivi de session n&apos;est pas disponible pour l&apos;agent Lite browser.
...
## Désactiver le tracing de session [#disable-tracing]

Pour désactiver le tracing de session dans l’ UI:
