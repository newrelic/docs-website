...
<Steps>
  ...
  <Step>
    ...
    Si vous utilisez l&apos;agent du navigateur à l&apos;aide de la méthode copier/coller, vous devrez à nouveau copier/coller depuis l&apos;UI . Cela est dû au fait que lorsque vous activez la relecture de session, l’ snippet JavaScript est mis à jour pour inclure les nouvelles mises à jour de configuration.
