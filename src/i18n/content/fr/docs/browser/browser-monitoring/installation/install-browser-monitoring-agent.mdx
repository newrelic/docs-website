...
<Tabs>
  ...
  <TabsPages>
    <TabsPageItem id="1">
      Accédez à <DNT>**[one.newrelic.com](https://one.newrelic.com) &amp;gt; Integrations &amp;amp; Agents &amp;gt; Browser and mobile &amp;gt; Browser monitoring**</DNT> et suivez les instructions pour générer l’ snippet JavaScript du navigateur dans l’ UI.

      <ButtonGroup>
        <ButtonLink role="button" to="https://onenr.io/0MRNpYqNqQn" variant="primary">
          Obtenez snippetvotre navigateur
        </ButtonLink>
      </ButtonGroup>
