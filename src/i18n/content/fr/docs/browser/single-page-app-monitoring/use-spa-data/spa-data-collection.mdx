...
4. Pour la version SPA 2.1 et ultérieure, le moniteur vérifie les rappels de longue durée pendant un maximum de 5 secondes. Si un rappel de longue durée est identifié, le système étend l&apos; interaction en cours et réexécute le moniteur.
