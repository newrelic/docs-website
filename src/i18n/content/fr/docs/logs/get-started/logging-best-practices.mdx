...
* Utilisez le [générateur de requêtes](/docs/query-your-data/explore-query-data/query-builder/introduction-query-builder) pour exécuter des recherches à l&amp;apos;aide de NRQL. Le générateur de requêtes vous permet d&amp;apos;utiliser toutes les fonctions avancées disponibles dans NRQL.
