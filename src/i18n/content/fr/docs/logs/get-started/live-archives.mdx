...
<Steps>
  ...
  <Step>
    ...
    <Callout variant="tip">
      Les étapes ci-dessus ajoutent les Live Archives en plus de la rétention standard, de sorte qu’un log arrive d’abord dans le stockage standard. Si vous avez des logs dont vous n’avez absolument pas besoin dans le stockage standard, tels que les logs de conformité ou d’audit, sélectionnez <DNT>**Direct to live archive**</DNT> comme espace de nommage de la partition au lieu de <DNT>**Standard**</DNT>. Les logs envoyés à cette partition ignorent complètement le stockage standard et vont directement dans les Live Archives. Consultez [Choisir un espace de nommage](/docs/logs/ui-data/data-partitions/#namespace) pour plus de détails.
    </Callout>
  </Step>
