...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        * [Obtenir des métadonnées de trace](https://pkg.go.dev/github.com/newrelic/go-agent/v3/newrelic#Transaction.GetTraceMetadata)
        * [Obtenir des métadonnées de liaison](https://pkg.go.dev/github.com/newrelic/go-agent/v3/newrelic#Transaction.GetLinkingMetadata)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        * [obtenir des métadonnées de trace](http://newrelic.github.io/java-agent-api/javadoc/com/newrelic/api/agent/Agent.html#getTraceMetadata\(\))
        * [obtenir des métadonnées de liaison](http://newrelic.github.io/java-agent-api/javadoc/com/newrelic/api/agent/Agent.html#getLinkingMetadata\(\))
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        * [TraceMétadonnées](/docs/apm/agents/net-agent/net-agent-api/net-agent-api/#TraceMetadata)
        * [Obtenir des métadonnées de liaison](/docs/apm/agents/net-agent/net-agent-api/net-agent-api/#GetLinkingMetadata)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        * [newrelic\_get\_trace\_metadata](/docs/apm/agents/php-agent/php-agent-api/newrelicgettracemetadata/)

        * [newrelic\_get\_linking\_metadata](/docs/apm/agents/php-agent/php-agent-api/newrelicgetlinkingmetadata/)
    ...
    <tr>
      ...
      <td>
        * [get\_linking\_metadata](/docs/apm/agents/python-agent/python-agent-api/getlinkingmetadata-python-agent-api/)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        * [linking\_metadata](https://www.rubydoc.info/gems/newrelic_rpm/NewRelic/Agent#linking_metadata-instance_method)
        * [current\_trace\_id](https://www.rubydoc.info/gems/newrelic_rpm/NewRelic/Agent/Tracer#current_trace_id-class_method)
        * [current\_span\_id](https://www.rubydoc.info/gems/newrelic_rpm/NewRelic/Agent/Tracer#current_span_id-class_method)
      </td>
    </tr>
  </tbody>
</table>
...
* Python : [exemple de gestionnaire de flux](/docs/logs/logs-context/configure-logs-context-python/#python-formatter)
