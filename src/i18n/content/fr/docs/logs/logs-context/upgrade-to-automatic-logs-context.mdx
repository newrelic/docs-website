...
Si vous disposez d&apos;un traitement de données étendu ou d&apos;une logique d&apos;enrichissement dans votre de redirecteur de existante, l&apos;envoi du log log configurationdirectement depuis les agents APM ignorera cette étape.
