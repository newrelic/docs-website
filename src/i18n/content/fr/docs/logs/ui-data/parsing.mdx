...
d&apos;ingestion de New Relic log pipeline peut analyser les données en faisant correspondre un événement de log à une règle décrivant comment le log doit être analysé. Il existe deux façons d&apos;analyser un événement de log :
