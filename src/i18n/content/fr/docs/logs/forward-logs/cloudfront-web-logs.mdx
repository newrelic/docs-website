...
9. Dans la section des paramètres <DNT>**Destination**</DNT>, pour l’URL du point de terminaison HTTP, sélectionnez le point de terminaison qui correspond à la région de votre data center New Relic.
