...
6. Sous <DNT>**HTTP endpoint URL**</DNT>, sélectionnez <DNT>**New Relic logs - US**</DNT>. Il s&apos;agit du point de terminaison américain (par défaut) ([https://aws-api.newrelic.com/firehose/v1](https://aws-api.newrelic.com/firehose/v1)). Pour utiliser le point de terminaison européen, suivez les étapes restantes de cette procédure, puis accédez à la [configuration du compte européen](#configure-eu-stream).
...
## Configurez votre flux pour envoyer le log aux comptes de l&apos;UE ou JP [#configure-eu-stream]

Si vous avez un compte New Relic dans notre data center UE ou JP :
...
5. Mettez à jour la valeur de <DNT>**HTTP endpoint URL**</DNT> avec le point de terminaison Firehose approprié pour votre région :
