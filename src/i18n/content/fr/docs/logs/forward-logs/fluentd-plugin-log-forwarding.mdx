...
Les fichiers log japonais encodés en Shift-JIS (SP932) sont convertis en [encodage UTF-8 requis](/docs/data-apis/custom-data/custom-events/data-requirements-limits-custom-event-data/#general) et sont requis pour l&amp;apos;importation et l&amp;apos;envoi de données log à New Relic.
