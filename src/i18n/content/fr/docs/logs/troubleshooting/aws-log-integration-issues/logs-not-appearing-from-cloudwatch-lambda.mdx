...
* La région New Relic et la clé de licence d&apos;ingestion fournie à la fonction Lambda ou à Firehose peuvent ne pas correspondre. Vérifiez-le et faites-le correspondre.
  ...
  Par exemple, si la région New Relic est EU, fournissez une clé de licence d&apos;ingestion New Relic de la région EU. De même, si la région New Relic est JP, fournissez une clé de licence d&apos;ingestion New Relic de la région JP.
