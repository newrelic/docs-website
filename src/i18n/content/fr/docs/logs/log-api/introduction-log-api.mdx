...
Point de terminaison des États-Unis (US) (par défaut) :

```
https://log-api.newrelic.com/log/v1
```

Point de terminaison de l’[Union européenne](/docs/accounts/accounts-billing/account-setup/choose-your-data-center) (EU) :

```
https://log-api.eu.newrelic.com/log/v1
```

Point de terminaison [Japon](/docs/accounts/accounts-billing/account-setup/choose-your-data-center) :
