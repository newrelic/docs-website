...
<Callout variant="important">
  Si vous utilisez un compte régional, utilisez le point de terminaison approprié au lieu de `newrelic.syslog.nr-data.net`:

  * Comptes UE : `newrelic.syslog.eu.nr-data.net`
  * Comptes JP : `newrelic.syslog.jp.nr-data.net`

  N&apos;oubliez pas de le remplacer dans les fichiers de configuration ; l&apos;utilisation du point de terminaison américain pour un compte régional ne fonctionnera pas.
</Callout>
