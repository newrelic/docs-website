...
* [Créez des workloads](/docs/new-relic-solutions/new-relic-one/workloads/workloads-isolate-resolve-alert-events-faster), qui vous permettent de regrouper des ensembles d&apos;entités importants pour l&apos;entreprise.
