...
Vous pouvez ajouter des KPI à vos Workloads intelligents de deux façons : créer des KPI personnalisés ou ajouter des KPI existants provenant d&apos;autres workloads.
