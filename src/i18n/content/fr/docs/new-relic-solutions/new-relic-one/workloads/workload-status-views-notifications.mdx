...
<Callout variant="tip">
  Cette page s’applique à la fois aux [workloads standard](/docs/new-relic-solutions/new-relic-one/workloads/create-workloads) et aux [workloads intelligents](/docs/new-relic-solutions/new-relic-one/workloads/workloads-overview#intelligent-workloads). Les valeurs de statut et les notifications fonctionnent de la même manière pour les deux types.
</Callout>
