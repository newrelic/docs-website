...
Une fois dans un workload, la navigation de gauche vous donne accès à :
...
* **TRIAGE**: Outils pour investiguer les problèmes
  ...
  * **Performance risks**: visualisez et analysez les risques de performance dans le workload ([voir la section Risques de performance](#performance-risks))
...
### Risques de performance [#performance-risks]

La page des risques de performance affiche les risques de performance détectés sur l’ensemble des entités participant à votre workload, vous n’avez donc pas à vérifier chaque entité individuellement. Pour en savoir plus sur les risques de performance, consultez la [documentation Performance Risks inbox](/docs/errors-inbox/performance-risks/introduction).
