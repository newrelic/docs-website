...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        Utilisez les [enrichissements](/docs/alerts/get-notified/alert-event-workflows/#enrichments)
      </td>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        Vous comprendrez l&apos;impact que cela aura sur la [clôture de vos événements d&apos;alerte](/docs/alerts/alert-event-management/how-alert-condition-events-are-closed/).
      </td>
    </tr>
...
* [Configurer la couverture des alertes à grande échelle avec les alertes intelligentes](/docs/alerts/smart-alerts-coverage) (aperçu public)
...
Si la clause `where` de votre condition exclut toutes les données, il ne restera plus de données. Il s&apos;agit d&apos;une [perte de signal](https://support.newrelic.com/s/hubtopic/aAX8W0000008bEyWAI/relic-solution-how-can-i-figure-out-when-to-use-gap-filling-and-loss-of-signal) pour New Relic et la condition d&apos;alerte NE PEUT PAS être évaluée par rapport à AUCUN seuil. Cela signifie que le résultat de la requête NRQL ne contient pas de données, mais cela ne signifie pas que New Relic ne reçoit pas de données. Si vous souhaitez recevoir une notification, vous devez ajouter un seuil de perte de signal.
...
Si vous débutez avec les alertes, apprenez-en plus sur vos [options de préférences d&apos;incidents](/docs/alerts/organize-alerts/specify-when-alerts-create-events).
...
* En savoir plus sur [quand vous pourriez vouloir utiliser les paramètres de perte de signal et de comblement des lacunes](https://knowledge.newrelic.com/s/article/How-Can-I-Figure-Out-When-To-Use-Gap-Filling-and-Loss-of-Signal).