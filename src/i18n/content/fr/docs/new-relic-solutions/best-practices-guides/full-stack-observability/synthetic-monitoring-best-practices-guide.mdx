...
<Steps>
  ...
  <Step>
    ...
    1. Pour ajouter un monitor, accédez à <DNT>**[one.newrelic.com &gt; All capabilities](https://one.newrelic.com/all-capabilities) &amp;gt; Synthetic Monitoring**</DNT>.
  ...
  <Step>
    ...
    <CollapserGroup>
      ...
      <Collapser id="overview-ui" title="page d'index du moniteur">
