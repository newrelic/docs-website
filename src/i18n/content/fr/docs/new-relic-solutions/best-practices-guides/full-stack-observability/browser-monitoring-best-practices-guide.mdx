---
title: guide des bonnes pratiques monitoring des navigateurs
tags:
  - New Relic solutions
...
Si vous utilisez également [APM](https://newrelic.com/application-monitoring), nous vous recommandons d&amp;apos;activer [instrumentationautomatique](/docs/browser/new-relic-browser/installation-configuration/add-apps-new-relic-browser) lorsque cela est possible, car cela injectera automatiquement l&amp;apos;agent JavaScript monitoring des navigateurs dans votre frontend pour vous. Non seulement l&amp;apos;agent du navigateur restera automatiquement à jour avec cette approche, mais l&amp;apos;utilisation de ces produits ensemble contribue à unifier la visibilité du front-end backend .
