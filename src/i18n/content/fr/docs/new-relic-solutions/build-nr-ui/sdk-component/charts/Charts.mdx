...
Dans votre application, vous pouvez afficher des données dans des graphiques, comme ceux utilisés ailleurs dans l&apos;interface utilisateur de New Relic. Le SDK New Relic One fournit des composants React pour différents types de graphiques.
