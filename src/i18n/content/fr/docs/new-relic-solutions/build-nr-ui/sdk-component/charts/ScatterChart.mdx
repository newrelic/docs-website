...
<table>
  <tbody>
    ...
    <tr>
      <td>
        `onClickScatter` <h5>fonction</h5>
      </td>

      <td>
        Ajoute un écouteur de clic qui se déclenche lorsque l&apos;utilisateur clique sur le scatter correspondant.
      </td>
    </tr>
    ...
    <tr>
      <td>
        `onHoverScatter` <h5>fonction</h5>
      </td>

      <td>
        Ajoute un écouteur de survol qui se déclenche lorsque le curseur est survolé sur le scatter correspondant.
      </td>
    </tr>
