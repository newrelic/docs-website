...
Crée un graphique à deux dimensions. Les données peuvent être obtenues en effectuant une requête NRQL sur un compte particulier ou elles peuvent être transmises via la propriété `data`.
...
<table>
  <tbody>
    <tr>
      <td>
        `accountId` <h4>OBSOLÈTE</h4> <h5>numéro</h5>
      </td>
