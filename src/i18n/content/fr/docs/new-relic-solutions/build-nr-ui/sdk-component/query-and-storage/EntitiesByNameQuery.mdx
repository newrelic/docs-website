...
Interroger les entités par leur nom.
    ...
    <tr>
      ...
      <td>
        ...
        * `NO_CACHE`: La requête ne renvoie **jamais** vos données initiales à partir du cache. Au lieu de cela, il fait **toujours** une demande en utilisant votre interface réseau. Contrairement à la politique `NETWORK_ONLY`, aucune donnée n&apos;est écrite dans le cache une fois la requête terminée.
          ...
          <OptionReference>
            EntitiesByNameQuery.FETCH\_POLICY\_TYPE.CACHE\_AND\_NETWORK, EntitiesByNameQuery.FETCH\_POLICY\_TYPE.CACHE\_FIRST, EntitiesByNameQuery.FETCH\_POLICY\_TYPE.CACHE\_ONLY, EntitiesByNameQuery.FETCH\_POLICY\_TYPE.NETWORK\_ONLY, EntitiesByNameQuery.FETCH\_POLICY\_TYPE.NO\_CACHE,
          </OptionReference>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        <OptionReference array>
          EntitiesByNameQuery.SORT\_TYPE.ALERT\_SEVERITY, EntitiesByNameQuery.SORT\_TYPE.DOMAIN, EntitiesByNameQuery.SORT\_TYPE.MOST\_RELEVANT, EntitiesByNameQuery.SORT\_TYPE.NAME, EntitiesByNameQuery.SORT\_TYPE.REPORTING, EntitiesByNameQuery.SORT\_TYPE.TYPE,
        </OptionReference>
      </td>
    </tr>
  </tbody>
...
<FunctionDefinition arguments={[{"description":"Object containing the query options. Any `EntitiesByNameQuery` prop is a valid option except `children` and `pollInterval`.","name":"props","type":"Object"}]} returnValue={{"description":"","type":"PromiseQueryResult"}} />
