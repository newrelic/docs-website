...
Crée un tableau d&apos;entonnoirs. Les données peuvent être obtenues en effectuant une requête NRQL sur un compte particulier ou elles peuvent être transmises via la propriété `data`.
...
<table>
  <tbody>
    ...
    <tr>
      <td>
        `onClickFunnel` <h5>fonction</h5>
      </td>

      <td>
        Ajoute un écouteur de clic qui se déclenche lorsque l&apos;utilisateur clique sur les entonnoirs correspondants.
      </td>
    </tr>

    <tr>
      <td>
        `onHoverFunnel` <h5>fonction</h5>
      </td>

      <td>
        Ajoute un écouteur de survol qui se déclenche lorsque le curseur est survolé sur les entonnoirs correspondants.
      </td>
    </tr>
