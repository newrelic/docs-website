...
<table>
  <tbody>
    ...
    <tr>
      <td>
        `onClickSparkline` <h5>fonction</h5>
      </td>

      <td>
        Ajoute un écouteur de clic qui se déclenche lorsque l&apos;utilisateur clique sur le graphique sparkline correspondant.
      </td>
    </tr>
    ...
    <tr>
      <td>
        `onHoverSparkline` <h5>fonction</h5>
      </td>

      <td>
        Ajoute un écouteur de survol qui se déclenche lorsque le curseur passe sur le graphique sparkline correspondant.
      </td>
    </tr>
