...
Crée un graphique à barres. Les données peuvent être obtenues en effectuant une requête NRQL sur un compte particulier ou elles peuvent être transmises via la propriété `data`.
...
<table>
  <tbody>
    ...
    <tr>
      <td>
        `onClickBar` <h5>fonction</h5>
      </td>

      <td>
        Ajoute un écouteur de clic qui se déclenche lorsque l&apos;utilisateur clique sur la barre correspondante.
      </td>
    </tr>

    <tr>
      <td>
        `onHoverBar` <h5>fonction</h5>
      </td>

      <td>
        Ajoute un écouteur de survol qui se déclenche lorsque le curseur passe sur la barre correspondante.
      </td>
    </tr>
