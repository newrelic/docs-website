...
## Lancer des services de démonstration [#spin-demo-services]
...
Ensuite, vous utilisez [la télémétrie](https://github.com/newrelic/newrelic-telemetry-sdk-python) pour envoyer des données télémétriques depuis votre service flashDB vers New Relic.

<Callout variant="tip">
  Cette procédure fait partie du cours qui vous apprend à créer un quickstart. Passez à la leçon suivante : [envoyer des données télémétriques à New Relic](/docs/new-relic-solutions/build-nr-ui/contribute-nr-io/send-telemetry-to-nr).
</Callout>