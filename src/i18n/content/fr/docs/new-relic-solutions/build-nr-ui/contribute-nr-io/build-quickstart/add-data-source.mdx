...
Les sources de données CORE sont fournies par New Relic One et n&apos;existent pas dans ce référentiel, les sources de données COMMUNITY sont définies dans le référentiel quickstart .
