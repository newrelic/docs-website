...
Pour ajouter une instance de votre visualisation à un dashboard, vous devez d’abord [publier votre Nerdpack](/docs/new-relic-solutions/new-relic-one/build-nr-apps/publish).
