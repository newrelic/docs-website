...
<CollapserGroup>
  ...
  <Collapser id="cloud-integration" title="intégration dans le nuage">
    <Callout variant="IMPORTANT" title="Les moteurs de la croissance">
