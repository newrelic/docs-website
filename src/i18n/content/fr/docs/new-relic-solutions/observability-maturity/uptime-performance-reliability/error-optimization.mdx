...
Il ne faut que quelques minutes pour configurer une charge de travail. Consultez [les instructions sur les charges de travail](/docs/new-relic-solutions/new-relic-one/workloads/workloads-isolate-resolve-alert-events-faster).
