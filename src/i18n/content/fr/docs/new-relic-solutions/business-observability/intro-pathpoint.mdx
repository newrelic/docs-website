...
L&apos;objectif est de fournir des signaux ayant un niveau d&apos;indépendance, et lorsqu&apos;un événement d&apos;alerte se produit, vous serez en mesure de déduire de ce qui est *rouge* quel peut être le problème.
