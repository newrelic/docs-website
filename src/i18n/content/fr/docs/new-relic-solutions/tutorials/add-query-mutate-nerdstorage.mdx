...
Ce guide nécessite que vous disposiez d&apos;une clé API et de la CLI New Relic One.
...
<Steps>
  ...
  <Step>
    Utilisez l&apos;interface de ligne de commande New Relic One pour mettre à jour l&apos;UUID de l&apos;application et exécuter l&apos;application localement.
