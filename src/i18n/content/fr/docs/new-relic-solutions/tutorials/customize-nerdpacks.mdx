...
<Steps>
  ...
  <Step>
    [Ajoutez des **Victory Charts Visualizations** à votre compte](/docs/new-relic-solutions/new-relic-one/build-nr-apps/subscribe).
  </Step>
  ...
  <Step>
    Comme vous allez utiliser une version modifiée du Nerdpack **Victory Charts Visualizations** au lieu de celle à laquelle vous vous êtes abonné, vous pouvez vous [désabonner](/docs/new-relic-solutions/new-relic-one/build-nr-apps/subscribe/#unsubscribe-from-a-nerdpack) de notre version maintenant.
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    Parfait ! Vous avez cloné et mis à jour la visualisation de la **Circular progress bar** open source à partir du catalogue Instant Observability. Il ne reste plus qu&apos;à publier votre version dans le catalogue afin que vos comptes puissent s&apos;y [abonner](/docs/new-relic-solutions/new-relic-one/build-nr-apps/subscribe/#subscribe-to-a-nerdpack).
  </Step>
...
<Steps>
  <Step>
    Depuis son répertoire racine, [publiez](/docs/new-relic-solutions/new-relic-one/build-nr-apps/publish/) votre Nerdpack :
  ...
  <Step>
    [Abonnez-vous](/docs/new-relic-solutions/new-relic-one/build-nr-apps/subscribe/#subscribe-to-a-nerdpack) à votre Nerdpack :
