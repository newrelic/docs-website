...
<Steps>
  ...
  <Step>
    ...
    <Callout variant="important">
      Vous devez définir la [région](/docs/accounts/accounts-billing/account-setup/choose-your-data-center) de votre compte New Relic. Utilisez `-r` pour définir `us`, `eu`, ou `jp`.
    </Callout>
  </Step>
...
Consultez [toutes les commandes disponibles](https://github.com/newrelic/newrelic-cli/blob/master/docs/cli/newrelic.md) dans la CLI New Relic. Par exemple, vous pouvez créer une [workload New Relic](/docs/new-relic-solutions/new-relic-one/workloads/workloads-overview) à l&apos;aide de [`workload create`](https://github.com/newrelic/newrelic-cli/blob/master/docs/cli/newrelic_workload_create.md)

Si vous souhaitez échanger avec d’autres membres de la communauté, visitez notre page [New Relic Explorer Hub](https://support.newrelic.com/s/hubtopic/Topic__c/Default?c__categories=%5B%7B%22icon%22%3A%22standard%3Adefault%22%2C%22id%22%3A%22a6c8W000000EeszQAC%22%2C%22sObjectType%22%3A%22Category__c%22%2C%22title%22%3A%22Build%20on%20New%20Relic%22%2C%22titleFormatted%22%3A%22Build%20on%20New%20Relic%22%7D%5D). Nous acceptons volontiers les requests de fonctionnalité ou les signalements de bugs sur [GitHub](https://github.com/newrelic/newrelic-cli).