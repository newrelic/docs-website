...
<Steps>
  ...
  <Step>
    ...
    Pour ajouter plusieurs balises à votre application à la fois, modifiez et exécutez cet snippet:
...
Jetez un œil à [toutes les commandes disponibles](https://github.com/newrelic/newrelic-cli/blob/master/docs/cli/newrelic.md) dans la CLI New Relic. Par exemple, vous pouvez créer un [workflowNew Relic](/docs/new-relic-one/use-new-relic-one/core-concepts/new-relic-one-workloads-isolate-resolve-incidents-faster) en utilisant [`workload create`](https://github.com/newrelic/newrelic-cli/blob/master/docs/cli/newrelic_workload_create.md)
