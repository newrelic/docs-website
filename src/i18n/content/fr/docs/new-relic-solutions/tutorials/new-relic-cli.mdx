...
Consultez [toutes les commandes disponibles](https://github.com/newrelic/newrelic-cli/blob/master/docs/cli/newrelic.md) dans la CLI New Relic. Par exemple, vous pouvez créer une [charge de travail New Relic](\(/docs/new-relic-solutions/new-relic-one/workloads/workloads-isolate-resolve-alert-events-faster\)) à l&apos;aide de [`workload create`](https://github.com/newrelic/newrelic-cli/blob/master/docs/cli/newrelic_workload_create.md)
