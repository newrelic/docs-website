...
À partir de la version 2.49.1 de notre CLI `nr1`, vous pouvez créer des applications New Relic et des visualisations personnalisées avec [React hooks](https://react.dev/reference/react/hooks). Ce guide donne quelques exemples de Nerdlet de React hooks en action !
