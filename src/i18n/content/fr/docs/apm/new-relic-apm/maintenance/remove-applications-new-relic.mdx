...
<CollapserGroup>
  ...
  <Collapser id="remove-otel-apps" title="OpenTelemetry">
    Après 93 jours, l&apos;application sera supprimée de l&apos;UI. Si vous souhaitez le supprimer plus tôt, utilisez [NerdGraph pour supprimer l&apos;entité concernée](/docs/apis/nerdgraph/examples/nerdgraph-entities-api-tutorial/#delete-entities). Pour rechercher les ID d’entité, consultez [entité](/docs/new-relic-one/use-new-relic-one/core-concepts/what-entity-new-relic/#find).
  </Collapser>
</CollapserGroup>
