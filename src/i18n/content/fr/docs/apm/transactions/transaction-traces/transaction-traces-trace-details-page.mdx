...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Tronque en fonction de la durée du segment ; les 2 000 segments les plus lents sont capturés pour la trace. Pour plus d&apos;informations, voir [configurationdu traceur de transaction PHP](/docs/apm/transactions/transaction-traces/transaction-traces-trace-details-page/).
      </td>
    </tr>
