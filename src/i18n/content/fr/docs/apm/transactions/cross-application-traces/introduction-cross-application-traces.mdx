...
Le tracing inter-applications d&apos;APM vous permet de lier les transactions entre vos applications de monitoring APM.

## Qu&apos;est-ce que le tracing inter-applications ? [#feature]

<Callout variant="caution">
  Le tracing inter-application a été complètement supprimé de l&apos;agent Python, à partir de la version 12.0.0.
</Callout>
...
Le tracing inter-applications s&apos;appuie sur trois en-têtes HTTP afin d&apos;échanger des informations entre les applications appelantes et appelées.
