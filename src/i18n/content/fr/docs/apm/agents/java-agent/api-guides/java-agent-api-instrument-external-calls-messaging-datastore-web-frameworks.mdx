...
<CollapserGroup>
  <Collapser id="datstore" title="implémentation API du magasin de données">
    ```java
    TracedMethod tracedMethod = NewRelic.getAgent().getTracedMethod();
