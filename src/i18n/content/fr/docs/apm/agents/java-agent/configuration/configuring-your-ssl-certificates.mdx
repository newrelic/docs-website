...
<Callout variant="caution">
  ...
  Veuillez consulter [ce message du forum de la communauté](https://support.newrelic.com/s/hubtopic/aAX8W0000008cBh/important-upcoming-new-relic-server-certificate-update-will-impact-most-users) pour plus de détails.
</Callout>
