...
<Callout variant="important">
  Ce document détaille comment utiliser la nouvelle solution basée sur l&apos;agent APM pour le monitoring serverless Java. Cette solution est sortie le 10 avril 2026. Les utilisateurs qui utilisaient le monitoring Java avant cette sortie ou qui utilisent les versions 11 ou 8 de Java devraient plutôt utiliser notre [solution Java legacy basée sur Open Tracing](/docs/serverless-function-monitoring/aws-lambda-monitoring/instrument-lambda-function/instrument-your-own/#console).
</Callout>
