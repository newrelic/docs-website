...
7. Vérifiez que votre application renvoie le nom attendu : dans vos fichiers journaux New Relic , recherchez `"reporting to"`, puis sélectionnez le lien dans le message. Par exemple:
