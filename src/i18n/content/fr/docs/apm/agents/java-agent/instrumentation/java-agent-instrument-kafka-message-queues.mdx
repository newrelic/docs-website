...
<Callout variant="tip">
  Nous avons également une intégration Kafka, qui \[fait XYZ]. Pour plus de détails à ce sujet, voir [Intégration pour monitoring Kafka](/docs/integrations/host-integrations/host-integrations-list/kafka-monitoring-integration).
</Callout>
