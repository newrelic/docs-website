...
Pour terminer une installation de base de l’agent Node.js, vous pouvez utiliser notre installation guidée pour une installation automatisée, (choisissez EU si vous êtes dans la région EU, ou JP si vous êtes dans la région JP) ou suivre les instructions de ce document. Dans tous les cas, vous avez besoin d’un compte New Relic si vous n’en avez pas déjà un. ([C’est gratuit, pour toujours !](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing/#how-pricing-works))
