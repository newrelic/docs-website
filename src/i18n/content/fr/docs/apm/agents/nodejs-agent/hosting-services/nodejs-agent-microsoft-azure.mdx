---
title: Node.js agent sur Microsoft Azure Web Apps
tags:
  - Agents
  - Nodejs agent
  - Hosting services
...
Découvrez les considérations spéciales pour l’utilisation de Microsoft Azure Web Apps comme service d’hébergement avec l’agent Node.js de New Relic.

## Ce dont vous avez besoin [#compatibility]

En plus de la [compatibilité et des exigences pour l&apos;agent Node.js](/docs/agents/nodejs-agent/getting-started/compatibility-requirements-nodejs-agent), ce didacticiel suppose que vous disposez d&amp;apos;une installation fonctionnelle de Node.js et du SDK Windows Azure pour Node.js pour votre plateforme :

* Installez le SDK Azure pour Node.js.
...
Après l’installation, vous devez configurer votre application dans Azure Web Apps :
...
3. Ajoutez ce qui suit au <DNT>**app settings**</DNT>:
   ...
   * `new_relic_app_name`: Le nom de votre site Web Windows Azure
