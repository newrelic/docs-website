...
<CollapserGroup>
  ...
  <Collapser id="agent-enabled" title="agent">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser id="certificates" title="certificats">
    <table>
      <tbody>
        <tr>
          <th>
...
<CollapserGroup>
  ...
  <Collapser id="log_level" title="niveau">
    <table>
      <tbody>
        <tr>
          <th>
    ...
    Définit le niveau de détail enregistré dans le log agent . Du plus petit détail au plus détaillé, les valeurs possibles sont `fatal`, `error`, `warn`, `info`, `debug` ou `trace`.
...
## Variables de nuages [#cloud\_config][#cloud_config]
...
<CollapserGroup>
  <Collapser id="audit_log-enabled" title="activé">
    <table>
      <tbody>
        <tr>
          <th>
...
<CollapserGroup>
  <Collapser id="attributes_enabled" title="activé">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser id="attributes_exclude" title="exclure">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser id="attributes_include" title="inclure">
    <table>
      <tbody>
        <tr>
          <th>
...
<CollapserGroup>
  <Collapser id="error_collector" title="activé">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser id="error_ignore" title="ignorer les codes d'état">
    <table>
      <tbody>
        <tr>
          <th>
...
<CollapserGroup>
  <Collapser id="tracer_enabled" title="activé">
    <table>
      <tbody>
        <tr>
          <th>
...
<CollapserGroup>
  <Collapser id="rules_names" title="nom">
    <table>
      <tbody>
        <tr>
          <th>
...
<CollapserGroup>
  <Collapser id="tx_events_enabled" title="activé">
    <table>
      <tbody>
        <tr>
          <th>
...
<CollapserGroup>
  ...
  <Collapser id="browser-debug" title="déboguer">
    <table>
      <tbody>
        <tr>
          <th>
...
<CollapserGroup>
  <Collapser id="custom_events_enabled" title="activé">
    <table>
      <tbody>
        <tr>
          <th>
...
<CollapserGroup>
  <Collapser id="slow-sql-enabled" title="activé">
    <table>
      <tbody>
        <tr>
          <th>
...
## variables du traceur de magasin de données [#datastore-tracer]
...
## Traçage inter-applications (OBSOLÈTE) [#cross-app-tracing]

Les variables de l&apos;agent Node.js qui contrôlent [le traçage inter-applications](/docs/apm/transactions/cross-application-traces/introduction-cross-application-traces) apparaissent généralement dans la section `cross_application_tracer` du fichier de configuration `newrelic.js` de votre application :
...
<CollapserGroup>
  <Collapser id="cat-enabled" title="activé">
    <table>
      <tbody>
        <tr>
          <th>
...
<CollapserGroup>
  <Collapser id="allow-raw-enabled" title="activé">
    <table>
      <tbody>
        <tr>
          <th>
...
<CollapserGroup>
  ...
  <Collapser id="dt-exclude-newrelic-header" title="exclure_newrelic_header">
    <table>
      <tbody>
        <tr>
          <th>
...
<Collapser id="grpc_error_ignore" title="ignorer les codes d'état">
  <table>
    <tbody>
      <tr>
        <th>
...
<CollapserGroup>
  <Collapser id="span-events-enabled" title="activé">
    <table>
      <tbody>
        <tr>
          <th>
...
Pour activer le tracing infini, ajoutez les paramètres ci-dessous. Définissez la configuration du tracing infini dans la section `infinite_tracing` . De plus, le tracing distribué doit être [activé](/docs/apm/agents/nodejs-agent/installation-configuration/distributed-tracing-nodejs-agent). Notez que le tracing distribué est activé par défaut pour les Node.js agent APM versions 8.3.0 et supérieures de l&amp;apos; .
...
<CollapserGroup>
  ...
  <Collapser id="infinite-tracing-queue-size" title="span_events.queue_size">
    ...
    La quantité de traçage infini que l&apos;agent conservera en mémoire avant de les supprimer.

    Ce paramètre devrait rarement avoir besoin d&apos;être modifié par rapport à la valeur par défaut, car la file d&apos;attente n&apos;est pas utilisée la plupart du temps. La file d&apos;attente est utilisée uniquement lors des reconnexions au point de terminaison Infinite Tracing lorsque l&apos;agent ne peut pas diffuser de données. Il est possible que l&apos;agent abandonne les intervalles de traçage infinis pendant ces périodes, dans ce cas, l&apos;augmentation de ce nombre peut aider.
  </Collapser>
</CollapserGroup>
...
## niveau du code métrique [#code-level-metrics]
...
<CollapserGroup>
  <Collapser id="array" title="éventail">
