...
<CollapserGroup>
  ...
  <Collapser id="dt-sampler-remote-parent-sampled" title="échantillonneur.remote_parent_sampled">
    ...
    Lorsque l&apos;en-tête traceparent a un indicateur échantillonné de `01`, cela contrôle la manière de gérer l&apos;échantillonnage des spans. Les valeurs autorisées sont :

    * `always_on`: l&apos;agent échantillonnera les spans
    * `always_off`: l&apos;agent n&apos;échantillonnera PAS les spans
  ...
  <Collapser id="dt-sampler-remote-parent-not-sampled" title="sampler.remote_parent_not_sampled">
    ...
    Lorsque l&apos;en-tête traceparent possède un indicateur échantillonné de `00`, cela contrôle la manière de gérer l&apos;échantillonnage des spans. Les valeurs autorisées sont :
