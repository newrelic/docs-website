...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Requis. Le nom (ou type) de la bibliothèque externe utilisée. Passez soit une chaîne qui le définit, soit une fonction qui accepte les mêmes paramètres que la fonction encapsulée et renvoie la bibliothèque.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Requis. L&apos;URL qui a été demandée par l&apos;appel de la bibliothèque. Passez soit une chaîne de caractères qui le définit, soit une fonction qui accepte les mêmes paramètres que la fonction encapsulée et renvoie l&apos;URL.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Facultatif. La méthode définissant le type d&apos;appel effectué. Il s&apos;agit généralement de `get`, `post`, `put` ou `delete`. Il peut s&apos;agir d&apos;une fonction qui accepte les mêmes paramètres que la fonction encapsulée et renvoie la méthode.
      </td>
    </tr>
  </tbody>
</table>
