...
<CollapserGroup>
  ...
  <Collapser className="freq-link" id="per-request-configuration" title="configurationpar requête">
...
## configurationd&apos;environnements multiples [#config-file-deployment-environments]
...
<CollapserGroup>
  ...
  <Collapser id="developer_mode" title="développeurs">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser id="log_file" title="enregistrer">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser id="log_level" title="enregistrer">
    <table>
      <tbody>
        <tr>
          <th>
...
<CollapserGroup>
  <Collapser id="ai-monitoring-enabled" title="ai_monitoring.activé">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser id="ai-monitoring-streaming" title="ai_monitoring.streaming.activé">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser id="ai-monitoring-record-content" title="ai_monitoring.record_content.activé">
    <table>
      <tbody>
        <tr>
          <th>
...
## configurationdu traceur de transactions [#txn-tracer-settings]
...
## configurationdes segments de transaction [#txn-segment-settings]
...
## configurationdu collecteur d&apos;erreurs [#error-collector-settings]
...
## monitoring des paramètres des navigateurs [#browser-settings]
...
<CollapserGroup>
  ...
  <Collapser id="browser-content-type" title="browser_monitoring.content_type">
    ...
    <CollapserGroup>
      <Collapser id="example-instrument-xhtml-xml" title="Instrumenter le réponses de page xhtml+xml">
        ...
        <Callout variant="important">
          monitoring L&apos; JavaScript de des navigateurs snippet empêche la page de valider `application/xhtml+xml` comme, bien que la page devrait se charger et s&amp;apos;afficher dans le navigateur final de l&amp;apos;utilisateur.
        </Callout>
      </Collapser>
    </CollapserGroup>
  </Collapser>
...
## configurationde l&apos;événement [#txn-span-events-settings]
...
## configurationde récolte d&apos;événement [#event-harvest-config]
...
## paramètres du niveau du code métrique [#codestream-integration]
...
<CollapserGroup>
  ...
  <Collapser id="application_logging.forwarding.context_data.include" title="application.forwarding.context_data.include">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser id="application_logging.forwarding.context_data.exclude" title="application.forwarding.context_data.exclude">
    <table>
      <tbody>
        <tr>
          <th>
...
## Paramètres d&apos;apprentissage automatique [#ml-settings]
...
Les paramètres suivants sont disponibles pour la configuration des données d’apprentissage automatique dans l’agent.
...
<CollapserGroup>
  <Collapser id="machine-learning-enabled" title="machine_learning.enabled">
    ...
    Définissez sur `true` pour activer la collecte d’attributs agent pour les métriques d’apprentissage automatique.
  </Collapser>
  ...
  <Collapser id="ml-insights-events-enabled" title="ml_insights_events.enabled">
    ...
    Autoriser l&apos;enregistrement d&apos;un événement d&apos;apprentissage automatique sur l&apos; API d&apos;événement via [`record_ml_event()`](/docs/agents/python-agent/python-agent-api/recordmlevent-python-agent-api/).
...
<CollapserGroup>
  ...
  <Collapser id="cross-application-tracer" title="cross_application_tracer.enabled">
    ...
    Permet [le traçage inter-applications](/docs/apm/transactions/cross-application-traces/introduction-cross-application-traces), qui connecte vos applications et services au sein de votre architecture orientée services.
  </Collapser>
  ...
  <Collapser id="shutdown-timeout" title="délai d'arrêt">
    <table>
      <tbody>
        <tr>
          <th>
...
## instrumentationintégrée [#builtin-instrumentation]
