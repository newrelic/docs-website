...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Facultatif. Le nom de la transaction. Il pourrait s’agir d’une fonction qui accepte un paramètre callable\_name. La valeur par défaut est `None`. Par défaut, le nom sera celui de la fonction à laquelle le décorateur a été appliqué, mais vous pouvez le remplacer en fournissant ce nom.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        S&apos;il n&apos;est pas fourni, le groupe prend par défaut la valeur `Function` en supposant que le nom est de la forme `module:class.function` ou `module:function` et représente le nom de la fonction en cours d&apos;exécution. Si vous créez un groupe personnalisé, nous vous recommandons de le préfixer par `Python/`. Peut être une fonction qui accepte les mêmes paramètres que la fonction encapsulée.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Facultatif. La partie schéma de l&apos;URL de la requête. Peut être une fonction qui accepte les mêmes paramètres que la fonction encapsulée.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Facultatif. La partie hôte de l&apos;URL de la requête. Peut être une fonction qui accepte les mêmes paramètres que la fonction encapsulée.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Facultatif. La partie port de l&apos;URL de la requête. Il peut s&apos;agir d&apos;une fonction qui accepte les mêmes paramètres que la fonction encapsulée.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Facultatif. La méthode de requête HTTP, telle que GET ou POST. Peut être une fonction qui accepte les mêmes paramètres que la fonction encapsulée.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Facultatif. Le reste du chemin de l&apos;URL de la requête. Il peut s&apos;agir d&apos;une fonction qui accepte les mêmes paramètres que la fonction encapsulée.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Facultatif. La partie de l&apos;URL de la requête qui suit le point d&apos;interrogation. Peut être une fonction qui accepte les mêmes paramètres que la fonction encapsulée.
      </td>
    </tr>
    ...
    <tr>
      <td>
        ...
        *itérable ou dict* ou *fonction*
      </td>

      <td>
        Facultatif. Les en-têtes de requête HTTP Un itérable d’itérables à deux éléments \[name, value] ou dict de `{name:value}`, où nom est le nom de l’en-tête, et valeur est la valeur de l’en-tête. Peut être une fonction qui accepte les mêmes paramètres que la fonction encapsulée.
      </td>
    </tr>
  </tbody>
</table>
