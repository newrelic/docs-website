...
Pour Laravel Horizon et Laravel Queue, définissez la valeur de [newrelic.daemon.app\_connect\_timeout](/docs/apm/agents/php-agent/configuration/php-agent-configuration/#inivar-daemon-app_connect_timeout) Paramètre INI à 5 s :
