...
Enregistre un segment datastore . les segments de magasin de données apparaissent dans les onglets <DNT>**Breakdown table**</DNT> et <DNT>**Databases**</DNT> de la [page Transactions](/docs/apm/applications-menu/monitoring/transactions-page) dans l&amp;apos;UI New Relic.
