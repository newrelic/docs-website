...
Avant d&apos;installer l&apos;agent PHP, assurez-vous que votre application web PHP est installée et s&apos;exécute sous Heroku. Pour plus d&apos;informations, voir [Getting Started with PHP on Heroku](https://devcenter.heroku.com/articles/getting-started-with-php).
