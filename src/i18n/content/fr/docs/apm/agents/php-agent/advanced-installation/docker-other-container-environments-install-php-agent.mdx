...
Pour voir un exemple d’application, accédez au [forum d’assistance de New Relic](https://knowledge.newrelic.com/s/article/PHP-Agent-And-Daemon-Containers). Si vous utilisez des conteneurs d’application de courte durée, nous vous recommandons d’utiliser un conteneur séparé pour le daemon de l’agent PHP.
...
<Callout variant="tip">
  ...
  * [Monitoring du conteneur qui exécute un seul scriptPHP](https://support.newrelic.com/s/hubtopic/aAX8W0000008aNC/relic-solution-single-php-script-docker-containers)
  * [Conseils de dépannage pour l&apos;agent PHP](https://support.newrelic.com/s/hubtopic/aAX8W0000008bSo/troubleshooting-frameworks)
</Callout>
