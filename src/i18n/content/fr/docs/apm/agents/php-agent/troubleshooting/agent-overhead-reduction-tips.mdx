...
Une source d&apos;horloge peu performante peut affecter l&apos;agent qui vérifie l&apos;heure pour chaque span. Veuillez vous assurer que vous utilisez une [source d&apos;horloge](https://support.newrelic.com/s/hubtopic/aAX8W0000008a7rWAA/relic-solution-php-agent-cpu-overhead-tips) appropriée. Fargate est affecté par la source d&apos;horloge et est connu pour entraîner une [surcharge](/docs/apm/agents/php-agent/troubleshooting/fargate-nitro-clock-performance-impact/) supplémentaire.