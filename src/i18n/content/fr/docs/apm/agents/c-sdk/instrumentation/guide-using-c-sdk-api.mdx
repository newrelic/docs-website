...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Suivez les procédures pour activer et instrumenter [le tracing distribué](/docs/agents/c-sdk/instrumentation/enable-distributed-tracing-your-c-applications).
      </td>
    </tr>
