...
<table>
  ...
  <tbody>
    ...
    <tr id="audit-mode">
      ...
      <td>
        Le log d&apos;audit est un enregistrement en texte brut de toutes les données envoyées à New Relic par le C SDK. Lors [du démarrage du daemon C SDK](/docs/agents/c-sdk/install-configure/install-c-sdk-compile-link-your-code#daemon), ajoutez `-auditlog <file>` au fichier de configuration du daemon. Par exemple:
