...
<CollapserGroup>
  ...
  <Collapser id="custom-segments" title="Instrumenter les appels à du code arbitraire (segments personnalisés)">
  ...
  <Collapser id="slow-query-datastore" title="Rapport de requête lente trace pour les segments datastore (SQL uniquement)">
    ...
    1. Activez le tracing des requêtes lentes en définissant [`transaction_tracer.datastore_reporting.enabled`](https://newrelic.github.io/c-sdk/structnewrelic__transaction__tracer__config__t.html) sur `true`.
