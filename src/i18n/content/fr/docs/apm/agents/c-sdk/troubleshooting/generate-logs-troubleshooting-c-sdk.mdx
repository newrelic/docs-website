...
* <DNT>**C SDK logs:**</DNT> Ces logs sont générés en raison d&apos;erreurs dans la façon dont vous avez instrumenté votre code à New Relic l&apos;aide de l&apos;API C SDK.
* <DNT>**Daemon logs:**</DNT> Il s&apos;agit des logs liés à la transmission de données à New Relic.
...
2. Exécutez les deux logs pendant 5 à 10 minutes.
