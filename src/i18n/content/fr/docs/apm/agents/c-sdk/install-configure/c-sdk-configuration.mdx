...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Pour définir ou modifier le nom de l&apos;application, définir le <InlinePopover type="licenseKey" />, le niveau de logging, le tracing des transactions, le tracing datastore , etc., utilisez :
    ...
    <tr>
      <td>
        Configuration supplémentaire du tracing des transactions
      </td>
    ...
    <tr>
      ...
      <td>
        Pour définir le point de terminaison du socket pour les communications agent-daemon, utilisez :
...
Si vous devez modifier le nom de votre application dans votre configuration une fois votre application connectée au daemon :
