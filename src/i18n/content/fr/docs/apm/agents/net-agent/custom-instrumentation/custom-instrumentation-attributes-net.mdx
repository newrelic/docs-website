...
* [Résoudre les problèmes instrumentation personnalisée basée sur les attributs](https://support.newrelic.com/s/hubtopic/aAX8W0000008a5g/relic-solution-troubleshooting-attributebased-custom-instrumentation-issues)
* [Construire des usines de traceur personnalisées instrumentation à partir d&apos;agent .NET fichier de log](https://knowledge.newrelic.com/s/article/Building-Custom-Instrumentation-Tracer-Factories-From-dot-NET-Agent)
