...
* Si vous n’obtenez aucun résultat, définissez vos [variables d’environnement](https://support.newrelic.com/s/hubtopic/aAX8W0000008a6F/relic-solution-net-core-agent-required-environment-variables), redémarrez votre application, et retournez à l’étape 1.
...
Si les étapes ci-dessus n’ont pas résolu le problème, nous vous recommandons de contacter l’assistance ou de demander de l’aide sur le [Forum d’assistance](https://support.newrelic.com/s/).