...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Sérialisé sous forme de tableau JSON. Les éléments individuels du tableau suivent les mêmes règles de conversion de type listées ci-dessus. Les éléments nuls sont filtrés et ne sont pas inclus dans le tableau sérialisé. Les tableaux vides et les tableaux ne contenant que des valeurs nulles ne sont pas enregistrés. Nécessite la version 10.50.0 ou ultérieure de l&apos;agent .NET.
      </td>
    </tr>
