...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Ruby 2.3.x, 2.2.x : Dernière version entièrement prise en charge par l&apos;agent v8.16.0. <br />Ruby 2.1.x, 2.0.x : Dernière version entièrement prise en charge par l&apos;agent v6.15.0. <br />Ruby 1.9.3 : Dernier agent v3.18.1. <br />Ruby 1.8.7 : Dernier agent v3.18.1.
      </td>
    </tr>
