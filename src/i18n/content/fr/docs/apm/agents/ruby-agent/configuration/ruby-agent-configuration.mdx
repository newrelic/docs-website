...
<CollapserGroup>
  ...
  <Collapser id="distributed_tracing-sampler-remote_parent_sampled" title="distributed_tracing.sampler.remote_parent_sampled">
    ...
    Ce paramètre contrôle le comportement de l&apos;échantillonnage transaction lorsqu&apos;un parent distant est échantillonné. Les valeurs disponibles sont `default`, `always_on`, et `always_off`.
  </Collapser>
  ...
  <Collapser id="distributed_tracing-sampler-remote_parent_not_sampled" title="distributed_tracing.sampler.remote_parent_not_sampled">
    ...
    Ce paramètre contrôle le comportement de l&apos;échantillonnage transaction lorsqu&apos;un parent distant n&apos;est pas échantillonné. Les valeurs disponibles sont `default`, `always_on`, et `always_off`.
  </Collapser>
</CollapserGroup>
