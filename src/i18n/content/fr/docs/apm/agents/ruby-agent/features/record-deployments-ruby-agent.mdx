...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        La New Relic <InlinePopover type="licenseKey" />à utiliser. Par défaut, cela provient de la définition dans le fichier `newrelic.yml` pour le `rails_env` donné. Ce **n’est pas** la même chose que votre [clé API REST](/docs/apis/getting-started/intro-apis/access-rest-api-keys).
      </td>
    </tr>
