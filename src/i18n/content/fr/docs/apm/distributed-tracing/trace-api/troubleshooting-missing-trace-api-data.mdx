...
* Si vos travées ont un horodatage, assurez-vous qu&apos;elles respectent les directives suivantes :
  ...
  * L’horodatage des spans doit avoir eu lieu au cours des 24 dernières heures.
...
* Confirmez que votre trace a une span racine (un `parent.id` nul sur une span). Exemple de requête :
