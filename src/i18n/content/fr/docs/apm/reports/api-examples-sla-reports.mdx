...
<CollapserGroup>
  <Collapser id="app-nerdgraph-response-time" title="App average response time (NerdGraph)">
  ...
  <Collapser id="app-nerdgraph-request-count" title="App request count (NerdGraph)">
  ...
  <Collapser id="apdex-nerdgraph" title="Apdex SLA data (NerdGraph)">
