...
Vous pouvez utiliser l&apos;[API New Relic REST v2](/docs/apis/rest-api-v2/requirements/new-relic-rest-api-v2-getting-started) pour enregistrer un nouveau déploiement et récupérer une liste des déploiements passés. De plus, certains agents APM disposent de méthodes spécifiques à l&amp;apos;agent pour enregistrer automatiquement les déploiements.
...
* <DNT>**Ruby**</DNT>:Utilisez une [recette Capistrano](/docs/agents/ruby-agent/features/recording-deployments-ruby-agent#capistrano3).
