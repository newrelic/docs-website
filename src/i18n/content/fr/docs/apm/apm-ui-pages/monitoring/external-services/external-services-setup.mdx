      ...
      <TabsPages>
        <TabsPageItem id="send-data-apm">
          ...
          2. Assurez-vous que le tracing distribué est activé dans l&apos;agent :
             ...
             * Si vous disposez d&apos;un agent plus ancien, suivez les étapes configuration pour activer le tracing distribué standard ou le tracing infini. Lorsque vous activez le tracing distribué, il remplace l’ancien tracing inter-applications.
