...
<CollapserGroup>
  <Collapser id="go" title="Go">
    ...
    * Pour d&apos;autres options de configuration datastore , voir [configurationdu traceur du magasin de données](/docs/agents/go-agent/configuration/go-agent-configuration#datastore-tracer).
  </Collapser>
