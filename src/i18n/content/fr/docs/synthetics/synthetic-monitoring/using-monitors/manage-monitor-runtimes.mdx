  ...
  <tbody>
    ...
    <tr>
      <td>
        ...
        Consultez la documentation sur la [configuration du Job Manager Synthetics](/docs/synthetics/synthetic-monitoring/private-locations/job-manager-configuration/#user-defined-vars).
      </td>
...
<CollapserGroup>
  <Collapser
    id="Chrome100"
    title={<>Chrome (<strong>Dernière version</strong>)</>
    }
  >
    Derniers détails du runtime de navigateur Chrome :
