---
title: Codes de réponse monitoring synthétique
tags:
  - Synthetics
...
Le moniteur synthétique renvoie un certain nombre de codes de réponse supplémentaires au-delà des codes de réponse HTTP standard, visibles dans la [page<DNT>**Resources**</DNT> ](/docs/synthetics/new-relic-synthetics/pages/synthetics-resources-understand-load-times). Ces codes de réponse sont basés sur [les codes de réponse de Chromium](https://code.google.com/p/chromium/codesearch#chromium/src/net/base/net_error_list.h&sq=package:chromium) et vous donnent plus de détails sur le comportement de votre moniteur.

## Codes de réponse

monitoring synthétique renvoie les codes de réponse supplémentaires suivants :
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        `net::ERR_ABORTED, "An operation was aborted (due to user action)"` Un code de réponse spécifique à Chrome lorsque le script atteint un délai d&apos;expiration et que l&apos;exécuteur s&apos;arrête. Pour ce faire, le runner met fin à toutes requests en attente.
      </td>
    </tr>
