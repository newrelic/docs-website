  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * « Heartbeat » du Synthetics Job Manager toutes les 30 secondes

          L&apos;[événement`SyntheticsPrivateMinion` ](/attribute-dictionary/?event=SyntheticsPrivateMinion)contient le statut de base du gestionnaire de tâches Synthetics, y compris le nombre de tâches réussies et échouées, la taille de la file d&apos;attente, la version du minion, etc.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Les données reçues du point de terminaison de monitoring synthétique contiennent les détails du contrôle planifié. Cela inclut les informations nécessaires pour effectuer la vérification pour le Synthetics Job Manager :
    ...
    <tr>
      ...
      <td>
        Les [emplacements publics Synthetic](/docs/synthetics/new-relic-synthetics/administration/synthetics-public-minion-ips) doivent être activés à l&apos;aide d&apos;identifiants non personnels. Leurs adresses IP ne sont pas définies comme des données personnelles en vertu des lois sur la protection des données et de la vie privée.
      </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * Ajoutez les adresses IP des emplacements publics Synthetic à votre liste d&apos;autorisation ou de blocage.
    ...
    <tr>
      ...
      <td>
        Outre les URL cibles monitorées par New Relic, les gestionnaires de tâches Synthetics envoient et reçoivent régulièrement des données vers et depuis le point de terminaison de monitoring synthétique. Pour configurer un proxy pour tout le trafic vers et depuis ce point de terminaison, définissez les [variables d&apos;environnement HORDE\_API\_PROXY\_HOST et HORDE\_API\_PROXY\_PORT](/docs/synthetics/synthetic-monitoring/private-locations/job-manager-configuration/#environment-variables).
      </td>
    </tr>

    <tr>
      <td>
        Sécurité du Synthetics Job Manager
      </td>

      <td>
        Pour garantir que seuls les scripts que vous souhaitez exécuter sont autorisés à s&apos;exécuter sur votre Synthetics Job Manager, utilisez l&apos;[exécution de script vérifiée](/docs/synthetics/new-relic-synthetics/private-locations/verified-script-execution-private-locations).
      </td>
    </tr>
  </tbody>
</table>