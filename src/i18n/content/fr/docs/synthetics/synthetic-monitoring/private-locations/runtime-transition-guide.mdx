...
<Callout variant="important">
  **Action requise.** New Relic met fin à la prise en charge du runtime Chrome 134 le 18 août 2026 et du runtime Node.js 16 le 18 novembre 2026. Si vous ne mettez pas à jour vos éléments à monitorer qui sont sur des runtimes plus anciens, New Relic migrera automatiquement vos éléments à monitorer aux dates susmentionnées. Cependant, la migration automatique peut ne pas détecter les scripts à monitorer qui réussissent mais échouent silencieusement sur certaines étapes du script.
</Callout>
...
| Version du runtime de l&apos;API | `1.2.134` ou inférieur | `1.2.143` ou supérieur |
| Version du runtime Browser       | `3.0.55` ou inférieur  | `3.0.63` ou supérieur  |
...
<CollapserGroup>
  <Collapser id="deploy-docker" title="Pour Docker">
  ...
  <Collapser id="deploy-podman" title="Pour Podman">
  ...
  <Collapser id="deploy-kubernetes" title="Pour Kubernetes">
...
| août 2026     | Fin de support du runtime Chrome 134 ; migration automatique des moniteurs Chrome 134 restants                               |
| Novembre 2026 | Fin du support de l&apos;environnement d&apos;exécution Node.js 16 ; migration automatique des moniteurs Node.js 16 restants |
