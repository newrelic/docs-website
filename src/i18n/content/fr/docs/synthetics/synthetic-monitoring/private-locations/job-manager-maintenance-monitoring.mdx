...
* Consultez vos [logs Docker ](#monitor-docker-logs), [vos logs Podman](#monitor-podman-logs), [vos logs Kubernetes ](#monitor-docker-logs)ou [vos logs OpenShift](#review-openshift-logs).
...
* `:8080/status/check`: fournit des détails sur les vérifications d&apos;intégrité internes effectuées par le Synthetics Job Manager. `HTTP 200` signifie que l&apos;état est sain.
...
Vous pouvez monitorer la santé de votre Synthetics Job Manager en consultant les logs du conteneur synthetics job manager.

<CollapserGroup>
  <Collapser id="review-docker-logs" title="Réviser les logs Docker">
  ...
  <Collapser id="review-podman-logs" title="Consulter les logs Podman">
  ...
  <Collapser id="review-kubernetes-logs" title="Consulter les logs Kubernetes">
  ...
  <Collapser id="review-Openshift-logs" title="Consulter les logs OpenShift">
...
<CollapserGroup>
  <Collapser id="docker-debug-logs" title="Activer les logs de débogage Docker">
    <Callout variant="tip">
  ...
  <Collapser id="podman-debug-logs" title="Activer les logs de débogage Podman">
    <Callout variant="tip">
  ...
  <Collapser id="kubernetes-debug-logs" title="Activer les logs de débogage Kubernetes">
    <Callout variant="tip">
  ...
  <Collapser id="openshift-debug-logs" title="Activer les logs de débogage OpenShift">
    <Callout variant="tip">
...
## Récupérer les informations de débogage [#retrieve-debugging-information]

Vous pouvez récupérer des informations de débogage sur votre gestionnaire de tâches Synthetics pour vous aider à résoudre les problèmes. Cela inclut des informations sur le pod du gestionnaire de tâches Synthetics et le nœud sur lequel il s&apos;exécute.

<CollapserGroup>
  <Collapser id="retrieve-kubernetes-debugging" title="Récupérer pour Kubernetes">
  ...
  <Collapser id="retrieve-openshift-debugging" title="Récupérer pour OpenShift">
