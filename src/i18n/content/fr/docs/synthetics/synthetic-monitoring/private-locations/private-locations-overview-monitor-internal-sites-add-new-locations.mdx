...
Après avoir créé l&apos;emplacement, Synthétique monitoring répertorie votre <DNT>**Private location key**</DNT> afin que vous puissiez [installer un minion privé](/docs/synthetics/new-relic-synthetics/private-locations/install-containerized-private-minions-cpms#install-update).
  ...
  <Collapser id="rotate-private-location-keys" title="Faire tourner les clés privées du site">
    ...
    <Steps>
      <Step>
        ...
        2. Entrez le nom du site privé et cochez <DNT>**Enable verified script execution**</DNT>. Cliquez ensuite sur <DNT>**Generate key**</DNT> pour créer le nouveau site privé.
        ...
        3. Mettez à jour vos gestionnaires d&apos;emplois ou minions privés avec le nouveau site privé. La section <DNT>**Configure and deploy**</DNT> inclut un exemple de code :
