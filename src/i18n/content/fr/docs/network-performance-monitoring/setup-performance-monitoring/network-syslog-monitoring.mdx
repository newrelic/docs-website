...
<CollapserGroup>
  ...
  <Collapser id="net-sys" title="Prérequis pour les périphériques réseau syslog">
    <Callout variant="important">
      `ktranslate` gère automatiquement syslog dans les formats suivants : [RFC3164](https://datatracker.ietf.org/doc/html/rfc3164), [RFC5424](https://datatracker.ietf.org/doc/html/rfc5424) et [RFC6587](https://datatracker.ietf.org/doc/html/rfc6587). Tous les messages reçus en dehors de ces formats seront rejetés, sauf si vous configurez [-syslog.format=NoFormat](/docs/network-performance-monitoring/advanced/ktranslate-container-management/#container-runtime-options) drapeau lors de l&amp;apos;exécution.
    </Callout>
