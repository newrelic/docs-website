    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            [configurationSNMPv3](#snmpv3-config) unique à analyser pendant l&amp;apos;interrogation SNMP.
          </td>
        </tr>
...
<Collapser id="cloud-secrets" title="configurationdes secrets du cloud">
  <Tabs>
    <TabsBar>
...
<CollapserGroup>
  <Collapser id="snmpv3-config" title="configurationSNMPv3">
    <table>
      <thead>
        <tr>
          <th style={{ width: "200px" }}>
