...
<CollapserGroup>
  ...
  <Collapser id="see-my-application" title="Je ne vois pas ma candidature dans IAST">
    ...
    * Proxy ou pare-feu bloquant l&apos;accès. Ajoutez à la liste blanche les IP suivantes `18.188.255.152, 18.116.243.59, 18.219.12.171` pour le domaine <DNT>**csec.nr-data.net**</DNT>, les IP suivantes `3.13.224.132, 18.218.78.150, 13.58.129.59` pour le domaine <DNT>**csec-gov.nr-data.net**</DNT> et les IP suivantes `3.122.48.53, 63.176.82.192, 3.123.117.125` pour le domaine <DNT>**csec.eu01.nr-data.net**</DNT>. Mais notre recommandation est d&apos;ajouter le domaine dans la liste blanche plutôt que les IP car ces IP sont vouées à changer à tout moment.
