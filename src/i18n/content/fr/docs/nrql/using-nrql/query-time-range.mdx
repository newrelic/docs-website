...
<Callout variant="important">
  Les requêtes pour les [points de données de métriques bruts](/docs/data-apis/understand-data/metric-data/query-metric-data-type) n&apos;ajustent pas la plage temporelle et peuvent exclure les points de données aux limites.
  ...
  L&apos;inclusion d&apos;un point de données brut dépend de son **heure de début**, et non de son heure de fin :

  * Un point de données qui commence dans la fenêtre est inclus, même s&apos;il se termine après `UNTIL '2023-12-22T00:03Z'`.
  * Un point de données qui commence avant `SINCE '2023-12-20T00:04Z'` est exclu, même s&apos;il se termine dans la fenêtre.
</Callout>
