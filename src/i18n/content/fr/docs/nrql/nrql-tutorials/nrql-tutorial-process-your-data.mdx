...
Lorsque vous devez concentrer vos données sur des dates spécifiques d&apos;un événement d&apos;alerte et que vous souhaitez examiner les données sans fenêtre temporelle glissante par rapport à l&apos;heure actuelle, cela vous aidera à obtenir des données dans une fenêtre temporelle statique. Dans la prochaine et dernière leçon, vous continuerez d&apos;apprendre à utiliser le temps dans vos rapports avec les cohortes temporelles.
