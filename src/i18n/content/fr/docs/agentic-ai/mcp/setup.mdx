...
<Callout variant="important">
  **Remarque sur la région :** les exemples de configuration de cette rubrique utilisent l’URL de connexion MCP de la région États-Unis : [https://mcp.newrelic.com/mcp/](https://mcp.newrelic.com/mcp/). Si votre compte New Relic se trouve dans une autre région, remplacez cette URL par le point de terminaison régional approprié dans tous les fichiers de configuration et arguments de ligne de commande :
