...
## Configuration de l&apos;interface de ligne de commande Codex [#codex-cli]

### Méthode de clé API [#api-key]

1. Assurez-vous que l&apos;outil [Codex CLI est installé](https://developers.openai.com/codex/cli/) sur votre machine.

2. Configurez le serveur MCP en modifiant le fichier de configuration situé à `~/.codex/config.toml` et ajoutez la configuration suivante :
...
3. Authentifiez-vous et connectez-vous :
   ...
   * Ouvrez votre terminal et exécutez `codex`.
   * Tapez la commande `/mcp` et appuyez sur Entrée.
   * Vous verrez le serveur New Relic répertorié avec une URL.

### Méthode OAuth (recommandée) [#oauth]

1. Assurez-vous que l&apos;outil [Codex CLI est installé](https://developers.openai.com/codex/cli/) sur votre machine.

2. Exécutez la commande ci-dessous dans votre terminal :
...
3. Authentifiez-vous et connectez-vous :
   ...
   * Le flux Oauth vous mènera à la page d&apos;authentification où vous devrez fournir vos identifiants pour vous authentifier.
   * Une fois l&apos;authentification effectuée, le navigateur confirmera la réussite de l&apos;opération.
   * Ouvrez votre terminal et exécutez `codex`.
   * Tapez la commande `/mcp` et appuyez sur Entrée.
   * Vous verrez le serveur New Relic listé avec une URL. Ouvrez cette URL dans votre navigateur.
