...
Pour modifier l’alias du nom de l’application à partir de l&apos;API REST New Relic (v2), utilisez cette commande. Vous pouvez également modifier l’alias de l’application depuis [l’explorateur d’API](/docs/apis/rest-api-v2/api-explorer-v2/getting-started-new-relics-api-explorer) de New Relic en sélectionnant [<DNT>**Applications &gt; Update**</DNT>](https://api.newrelic.com/docs/#/Applications/put_applications__id__json).
...
<Callout variant="important">
  La modification de l&apos;alias de l&apos;application provoque le redémarrage de tous les agents qui transmettent des données sous cet identifiant d&apos;application. Consultez [renommer votre application](/docs/apm/agents/manage-apm-agents/app-naming/name-your-application/#app-alias) pour plus de détails.
</Callout>
