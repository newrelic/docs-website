...
<Callout variant="tip">
  Pour obtenir les mêmes informations à partir de [New Relic API Explorer (v2)](https://api.newrelic.com/docs), sélectionnez [<DNT>**Application Hosts &gt; GET Metric Data**</DNT>](https://api.newrelic.com/docs/#/Applications/get_applications__application_id__hosts__host_id__metrics_data_json) et incluez votre [clé API](/docs/apis/rest-api-v2/getting-started/introduction-new-relic-rest-api-v2#api_key). Ajoutez votre [identifiant d’application](/docs/apm/apis/requirements/identification-code), [ID hôte](/docs/apis/rest-api-v2/requirements/listing-host-instance-application-server-ids#locating_host_id), ainsi que les métriques `names[]=CPU/User Time` et `values[]=percent` dans les champs appropriés.
</Callout>
