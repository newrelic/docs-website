...
## durée totale du magasin de données [#datastore]
...
Si vous n&apos;utilisez **pas** d&amp;apos;agent Ruby, utilisez les calculs pour obtenir la valeur [de la base de données](#database) . Ces valeurs ne sont fournies que par les versions 3.10.0.279 ou inférieures de l&amp;apos;agent Ruby. L&amp;apos;agent Ruby version 3.11.0 ou supérieure utilise à la place les valeurs [du magasin de données](#datastore) .
