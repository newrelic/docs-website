...
Vous pouvez utiliser New Relic REST API (v2) pour obtenir le débit moyen de votre application, y compris le débit des [Web application](/docs/using-new-relic/welcome-new-relic/getting-started/glossary#transaction) et [Web .application](/docs/using-new-relic/welcome-new-relic/getting-started/glossary#non-web-transaction) Ces valeurs apparaissent dans le [graphique de débit](/docs/apm/applications-menu/monitoring/apm-overview-page-view-transaction-apdex-usage-data#overview_charts) sur la page <DNT>**APM Summary**</DNT> de votre application :
