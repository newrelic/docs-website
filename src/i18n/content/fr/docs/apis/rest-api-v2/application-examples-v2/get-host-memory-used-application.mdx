...
1. Sélectionnez [<DNT>**Application Hosts &gt; GET Metric Data**</DNT>](https://api.newrelic.com/docs/#/Applications/get_applications__application_id__hosts__host_id__metrics_data_json), et incluez votre [clé API](/docs/apis/rest-api-v2/getting-started/introduction-new-relic-rest-api-v2#api_key).
...
1. Sélectionnez [<DNT>**Applications &gt; GET Metric Data**</DNT>](https://api.newrelic.com/docs/#/Applications/get_applications__application_id__metrics_data_json), et incluez votre [clé API](/docs/apis/rest-api-v2/getting-started/introduction-new-relic-rest-api-v2#api_key).
