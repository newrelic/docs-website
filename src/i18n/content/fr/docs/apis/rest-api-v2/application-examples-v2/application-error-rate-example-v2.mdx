...
Voici un exemple d&apos;utilisation de New Relic Data API (v2) pour obtenir le application taux d&apos;erreur moyen de votre sur une période donnée. Cette valeur apparaît sous forme de pourcentage au-dessus du [graphique du taux d&apos;erreur](#avg-error-image) sur votre [pageAPM <DNT>**Summary**</DNT> ](/docs/apm/applications-menu/monitoring/apm-overview-page).
