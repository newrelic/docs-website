...
Avant de pouvoir utiliser l’ [API Explorer](https://api.newrelic.com/docs), l’accès à l’API doit être activé et une [clé API utilisateur](/docs/apis/rest-api-v2/requirements/rest-api-key) doit être générée pour votre compte.
