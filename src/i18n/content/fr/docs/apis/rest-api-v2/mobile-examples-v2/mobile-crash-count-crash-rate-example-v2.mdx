...
<Callout variant="tip">
  Vous pouvez également utiliser l’API Explorer de New Relic pour récupérer des [données de métrique mobile](https://api.newrelic.com/docs/#/Mobile%20Applications/get_mobile_applications__mobile_application_id__metrics_data_json).
</Callout>
