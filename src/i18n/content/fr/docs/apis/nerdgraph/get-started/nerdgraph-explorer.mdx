...
<Steps>
  <Step>
    ...
    1. Ouvrez l&apos;explorateur d&apos;API NerdGraph. L&apos;URL dépend de la région du data center qui héberge votre compte :

       * US (région par défaut) : <DNT>[one.newrelic.com/nerdgraph-graphiql](https://one.newrelic.com/nerdgraph-graphiql)</DNT>
