...
Vous pouvez créer un moniteur de vérification de certificat en utilisant la mutation <DNT>`syntheticsCreateCertCheckMonitor`</DNT>. Cette mutation vous permet de configurer monitoring de l&apos;expiration des certificats SSL sur n&apos;importe quel domaine.
...
Vous pouvez mettre à jour un moniteur de vérification de certificat existant en utilisant la mutation <DNT>`syntheticsUpdateCertCheckMonitor`</DNT>. Cela vous permet de modifier la configuration d&apos;un moniteur de vérification de certificats déjà créé.
...
Lorsqu&apos;un moniteur de vérification de certificat n&apos;est plus nécessaire, vous pouvez le supprimer définitivement à l&apos;aide de la mutation <DNT>`syntheticsDeleteMonitor`</DNT>.
...
## Requête sur les moniteurs de vérification de certificat [#query-certificate-check-monitors]

Utilisez NerdGraph pour récupérer des métadonnées, mapper des ID, ou vérifier le statut de vos moniteurs de vérification de certificat.
