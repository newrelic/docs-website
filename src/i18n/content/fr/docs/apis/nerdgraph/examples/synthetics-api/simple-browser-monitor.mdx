...
* [Mapper l&apos;ID de moniteur au GUID d&apos;entité](/docs/apis/nerdgraph/examples/synthetics-api/query-synthetics-data#query-guid-mapping): pour migrer les ID de moniteur hérité vers les GUID d&apos;entité.
