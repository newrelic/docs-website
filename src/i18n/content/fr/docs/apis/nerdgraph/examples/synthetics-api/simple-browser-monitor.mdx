...
Vous pouvez créer un simple moniteur de navigateur en utilisant la mutation <DNT>`syntheticsCreateSimpleBrowserMonitor`</DNT>.
...
Vous pouvez mettre à jour un moniteur de navigateur simple existant en utilisant la mutation <DNT>`syntheticsUpdateSimpleBrowserMonitor`</DNT>. Cela vous permet de modifier la configuration d&apos;un simple moniteur de navigateur déjà créé.
...
Lorsqu&apos;un simple moniteur de navigateur n&apos;est plus nécessaire, vous pouvez le supprimer définitivement à l&apos;aide de la mutation <DNT>`syntheticsDeleteMonitor`</DNT>.
...
## Requête de moniteurs de browser simple [#query-simple-browser-monitors]

Utilisez NerdGraph pour récupérer des métadonnées, mapper des ID, ou vérifier le statut de vos éléments à monitorer de type browser simple.

Pour plus d&apos;informations, consultez :

* [Requête de tous les moniteurs](/docs/apis/nerdgraph/examples/synthetics-api/query-synthetics-data#query-monitors): pour lister tous les monitorer Synthétiques et leur configuration.
* [Mapper l&apos;ID de moniteur au GUID d&apos;entité](/docs/apis/nerdgraph/examples/synthetics-api/query-synthetics-data#query-guid-mapping): pour migrer les ID de moniteur legacy vers les GUID d&apos;entité.
* [Statut de la mise à niveau du runtime](/docs/apis/nerdgraph/examples/synthetics-api/query-synthetics-data#query-runtime-upgrade-all): pour vérifier si vos moniteurs sont prêts pour les dernières mises à niveau du runtime.

Pour consulter la liste complète des exemples de requêtes, reportez-vous au document [Requête de données Synthetics](/docs/apis/nerdgraph/examples/synthetics-api/query-synthetics-data).