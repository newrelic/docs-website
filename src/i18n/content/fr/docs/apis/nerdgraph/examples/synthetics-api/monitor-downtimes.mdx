...
Vous pouvez créer un moniteur à usage unique temps d&apos;arrêt en utilisant la mutation <DNT>`syntheticsCreateOnceMonitorDowntime`</DNT>. Utilisez ceci pour la maintenance planifiée ou les événements ponctuels.
...
Vous pouvez créer un moniteur quotidien récurrent de temps d&apos;arrêt en utilisant la mutation <DNT>`syntheticsCreateDailyMonitorDowntime`</DNT>. Utilisez ceci pour les fenêtres de maintenance régulières qui ont lieu quotidiennement.
...
Vous pouvez créer un moniteur hebdomadaire récurrent de temps d&apos;arrêt en utilisant la mutation <DNT>`syntheticsCreateWeeklyMonitorDowntime`</DNT>. Utilisez ceci pour les fenêtres de maintenance qui ont lieu certains jours de la semaine.
...
Vous pouvez créer un moniteur mensuel récurrent de temps d&apos;arrêt en utilisant la mutation <DNT>`syntheticsCreateMonthlyMonitorDowntime`</DNT>. Utilisez ceci pour les fenêtres de maintenance qui ont lieu à des dates précises chaque mois.
...
Vous pouvez mettre à jour un moniteur de temps d&apos;arrêt existant en utilisant la mutation <DNT>`syntheticsEditMonitorDowntime`</DNT>. Cela vous permet de modifier n&apos;importe quel type de temps d&apos;arrêt (une fois, quotidiennement, hebdomadairement ou mensuellement) en utilisant cette seule mutation.
...
Vous pouvez supprimer un moniteur de temps d&apos;arrêt en utilisant la mutation <DNT>`syntheticsDeleteMonitorDowntime`</DNT>. Une fois supprimés, les temps d&apos;arrêt programmés seront retirés et le système de monitoring reprendra son fonctionnement normal.
...
Utilisez NerdGraph pour récupérer les planifications de temps d’arrêt, les configurations, et les métadonnées.

Pour plus d&apos;informations, consultez :

* [Requête sur les temps d’arrêt des moniteurs](/docs/apis/nerdgraph/examples/synthetics-api/query-synthetics-data#query-monitor-downtimes) - Obtenez tous les temps d’arrêt programmés des moniteurs avec leurs configurations.
