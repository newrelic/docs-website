...
* [Requête des temps d’arrêt à monitorer](/docs/apis/nerdgraph/examples/synthetics-api/query-synthetics-data#query-monitor-downtimes) - Obtenez tous les temps d’arrêt programmés à monitorer avec leur configuration.
