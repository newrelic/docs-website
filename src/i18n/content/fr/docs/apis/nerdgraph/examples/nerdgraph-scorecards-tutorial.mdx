    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Les ID de compte cibles pour l’évaluation de la règle. La requête NRQL s’exécute sur chaque compte spécifié dans cette liste pour évaluer la conformité.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            ID de compte auxiliaires à inclure lors de l&apos;exécution de la requête. Permet les requêtes NRQL inter-comptes en joignant les données de ces comptes secondaires à chaque compte cible principal.
          </td>
        </tr>
