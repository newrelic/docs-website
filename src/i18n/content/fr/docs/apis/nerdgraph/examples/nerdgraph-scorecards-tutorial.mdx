...
<CollapserGroup>
  <Collapser id="fetch-organization-id" title="Fetch your organization ID">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            [Fetch your organization ID](#fetch-organization-id)

             above to know how to fetch it
          </td>
        </tr>
      </tbody>
    </table>
