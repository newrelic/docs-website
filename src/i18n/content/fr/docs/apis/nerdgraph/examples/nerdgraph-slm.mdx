...
* <DNT>**`entityGuid`**</DNT>: le GUID de l&apos;[entité](/docs/service-level-management/create-slm#sli-entity) (par exemple, le service <InlinePopover type="apm" />, l&apos;application de navigateur, etc.) à laquelle vous souhaitez associer ce SLI. Sur l&apos;UI, vous pouvez trouver ce GUID sur la page de l&apos;entité, sous <DNT>**See metadata and manage tags**</DNT>.
