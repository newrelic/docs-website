...
* `managers`: A list of user entity GUIDs who are managers or the main point of contact of this team. Managers must be team members. To find user GUIDs, see [Retrieve the user Id](#user-id).
* `onCallMembers`: A list of `OnCallMember` entities representing contacts outside regular working hours. Each entity requires an ID field containing the user&apos;s entity GUID. On-call members must be team members. To find user GUIDs, see [Retrieve the user Id](#user-id).
...
* `onCallMembers` accepts a list of `OnCallMember` entities. Each entity requires an ID field containing the user&apos;s entity GUID. To find user GUIDs, see [Retrieve the user Id](#user-id).
