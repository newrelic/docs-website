...
<Callout variant="caution">
  Toute personne disposant du dashboard en direct ou des URL de graphique peut afficher toutes les informations du dashboard. Partagez les informations avec soin et conformément aux politiques et procédures internes de votre entreprise.
</Callout>
