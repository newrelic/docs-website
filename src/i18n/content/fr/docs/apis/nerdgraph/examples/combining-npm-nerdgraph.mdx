...
Une fois que vous avez localisé l&apos;endroit où vous souhaitez ajouter l&apos;agent de navigateur, ajoutez ce snippet de code dans ce fichier.
...
<Steps>
  ...
  <Step>
    ...
    Ouvrez l&apos;explorateur NerdGraph sur [api.newrelic.com/graphiql](https://api.newrelic.com/graphiql) et utilisez la requête ci-dessous pour récupérer les valeurs de configuration de l&apos;application navigateur. Si votre compte New Relic utilise un [data center de l&apos;UE](/docs/using-new-relic/welcome-new-relic/get-started/our-eu-us-region-data-centers), accédez à [api.eu.newrelic.com/graphiql](https://api.eu.newrelic.com/graphiql). Pour les comptes utilisant un [data center JP](/docs/accounts/accounts-billing/account-setup/choose-your-data-center), accédez à [api.jp.newrelic.com/graphiql](https://api.jp.newrelic.com/graphiql).
