...
<CollapserGroup>
  ...
  <Collapser id="bulk-update-widget-links" title="Mettre à jour plusieurs widgets en masse">
    Vous pouvez mettre à jour les liens et les descriptions de plusieurs widgets en un seul appel d&apos;API :
