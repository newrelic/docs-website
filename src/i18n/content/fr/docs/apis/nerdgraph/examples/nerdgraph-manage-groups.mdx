...
* [Type d&apos;utilisateur](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type): utilisateur Core ou utilisateur Full Platform
* [Rôle](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts/#roles): <DNT>**Authentication Domain Manager**</DNT>
...
Lorsque vous avez terminé, s&apos;il y a déjà des utilisateurs dans le groupe que vous avez créé et que ce groupe a accès à au moins un rôle et un compte, ils devraient y avoir accès en quelques minutes (bien que pour [les comptes New Relic des régions UE et JP](/docs/using-new-relic/welcome-new-relic/get-started/our-eu-us-region-data-centers), cela puisse prendre jusqu&apos;à 20 minutes environ). Si vos utilisateurs ne sont pas encore dans ce groupe (ce qui serait le cas si vous venez de créer un nouveau groupe), vous pouvez [ajouter des utilisateurs à ce groupe](/docs/accounts/accounts-billing/new-relic-one-user-management/account-user-mgmt-tutorial#add-users).
