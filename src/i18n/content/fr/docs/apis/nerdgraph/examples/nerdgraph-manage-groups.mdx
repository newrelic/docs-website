...
Après avoir obtenu l&apos;identifiant unique de chaque autorisation que vous souhaitez attribuer au nouveau rôle, utilisez la mutation suivante pour créer un [rôle](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts/#roles):
...
* `id`: Renvoie l&apos;ID unique du rôle personnalisé nouvellement créé.
  ...
  <Callout variant="important">
    ...
    * Remplacez l&apos;exemple `permissionIds: [1, 2, 3]` par les ID d&apos;autorisation réels que vous avez récupérés à partir de la requête d&apos;autorisations.
  </Callout>
