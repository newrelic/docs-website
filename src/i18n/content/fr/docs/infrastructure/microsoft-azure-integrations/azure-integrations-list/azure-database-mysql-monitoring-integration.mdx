---
title: Azure Base de données pour MySQL monitoring l'intégration
tags:
  - Integrations
...
New Relic interroge votre service de bases de données Azure selon un intervalle [d&apos;interrogation](/docs/integrations/microsoft-azure-integrations/getting-started/azure-integration-polling) par défaut, qui varie en fonction de l&amp;apos;intégration. Pour l’intégration de la base de données Azure pour MySQL :
...
Les données sur une seule base de données sont attachées au type d&apos;événement `AzureMySqlServerSample` , avec une valeur de fournisseur de `AzureMySqlServer`.
