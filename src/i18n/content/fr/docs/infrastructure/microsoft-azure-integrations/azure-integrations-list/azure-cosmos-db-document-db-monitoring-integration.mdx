...
<Callout variant="important">
  Pour plus d’informations sur les événements ou les mesures Cosmos DB obsolètes, consultez [Intégration Azure Cosmos DB (obsolète)](/docs/azure-cosmos-db-document-db-monitoring-integration-deprecated). Nous vous recommandons fortement de migrer vers l&amp;apos;événement et les métriques pris en charge dans ce document.
</Callout>
