...
<Callout variant="tip">
  Si votre organisation héberge des données dans une région data center autre que les États-Unis, assurez-vous d’utiliser les points de terminaison de région corrects. [En savoir plus sur les régions data center et les points de terminaison.](/docs/accounts/accounts-billing/account-setup/choose-your-data-center)
</Callout>
