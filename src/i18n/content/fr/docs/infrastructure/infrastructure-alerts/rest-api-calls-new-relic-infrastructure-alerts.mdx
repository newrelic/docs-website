  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * Créez une condition avec un filtrage d’exclusion (par exemple, l’instance `environment NOT LIKE x`). Pour en savoir plus à ce sujet, consultez [ce message sur le filtrage d’exclusion](https://support.newrelic.com/s/hubtopic/aAX8W0000008Znr/relic-solution-use-the-infrastructure-alerts-rest-api-pt-1).
...
<Callout variant="tip">
  Si votre organisation héberge des données dans une région de data center autre que les États-Unis (par défaut), assurez-vous d&apos;utiliser les points de terminaison de région corrects. [En savoir plus sur les régions data center et les points de terminaison.](/docs/accounts/accounts-billing/account-setup/choose-your-data-center)
</Callout>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        Le paramètre [limite de temps des événements d&apos;alerte](/docs/infrastructure/new-relic-infrastructure/infrastructure-alert-conditions/infrastructure-alerts-add-edit-or-view-host-alert-information/#incident-time-limit), exprimé en heures. Les valeurs possibles sont `0`, `1`, `2`, `4`, `8`,`12`, `24`, `48`, `72`. Cela détermine le temps qui s&apos;écoule avant qu&apos;un incident ne soit automatiquement fermé.
