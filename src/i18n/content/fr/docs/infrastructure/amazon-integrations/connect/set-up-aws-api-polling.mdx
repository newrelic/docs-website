...
Consultez notre documentation pour [installer une intégration de flux de métriques CloudWatch New Relic](/docs/infrastructure/amazon-integrations/aws-integration-for-metrics/via-cloudformation-and-api-polling/) ou pour [migrer vos intégrations d’interrogation d’API vers les flux de métriques CloudWatch](/docs/infrastructure/amazon-integrations/aws-integration-for-metrics/migrate-from-api-polling-to-cwms/).
