...
<Callout title="Aperçu">
  ...
  Cette fonctionnalité est actuellement disponible dans le cadre d&apos;un programme de prévisualisation, conformément à nos [politiques de version préliminaire](/docs/licenses/license-information/referenced-policies/new-relic-pre-release-policy).<br />
</Callout>
    ...
    <CollapserGroup>
      <Collapser id="metrics-data-type" title="Pour le type de données Métriques">
        ...
        1. Sélectionnez le type d&apos;intégration métrique :
           ...
           * <DNT>**[Integration via CloudFormation and CloudWatch metric stream](/docs/infrastructure/amazon-integrations/aws-integration-for-metrics/via-cloudformation-cwms/)**</DNT> est la méthode recommandée pour créer un flux de métriques en temps réel vers New Relic.
      ...
      <Collapser id="log-data-type" title="Pour le type de données de log">
        ...
        4. Sélectionnez les points de terminaison d&apos;API des logs New Relic : le système définit automatiquement le point de terminaison en fonction de la région de votre compte New Relic.
           ...
           * Pour le compte EU, les logs sont envoyés à `https://log-api.eu.newrelic.com/log/v1`
           * Pour les comptes japonais, les logs sont envoyés à `https://log-api.jp.nr-data.net/log/v1`
...
<Steps>
  ...
  <Step>
    ### Gérer les intégrations AWS [#manage-aws-integrations]

    1. Connectez-vous à votre compte [New Relic](https://one.newrelic.com/) et accédez à <DNT>**Infrastructure &gt; AWS**</DNT>.
    2. Pour vérifier si <DNT>Auto-Discovery</DNT> est activé pour vos comptes AWS, cliquez sur <DNT>**Manage AWS Integrations**</DNT>.
    3. Pour activer la découverte automatique pour un compte AWS, dans la liste des comptes, cliquez sur <DNT>**Install**</DNT> pour ce compte.
    4. Pour la découverte automatique, cliquez sur <DNT>**Install**</DNT>.
  </Step>
...
<CollapserGroup>
  ...
  <Collapser id="disable-auto-discovery" title="Désactiver la découverte automatique">
    ...
    1. Connectez-vous à votre compte [New Relic](https://one.newrelic.com/) et accédez à <DNT>**Infrastructure &gt; AWS**</DNT>.
    2. Pour vérifier si <DNT>Auto-Discovery</DNT> est activé pour vos comptes AWS, cliquez sur <DNT>**Manage Auto-Discovery**</DNT>.
