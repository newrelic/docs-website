...
<Steps>
  ...
  <Step>
    ...
    <Callout variant="tip">
      Par défaut, New Relic analyse toutes les régions activées dans votre compte une fois par jour. Vous pouvez [mettre à jour la fréquence d&apos;analyse et les régions](#select-region-and-frequency) après la création de la stack , en gérant les paramètres <DNT>Auto-Discovery</DNT> dans New Relic One.
    </Callout>
  </Step>
...
<Steps>
  ...
  <Step>
    ...
    3. Une fois la stack créée, revenez à New Relic One.
  </Step>
  ...
  <Step>
    ...
    Pour activer <DNT>Auto-Discovery</DNT>, sur l&amp;apos;écran de confirmation de New Relic One, cliquez sur <DNT>**Save**</DNT>.
  </Step>
</Steps>
