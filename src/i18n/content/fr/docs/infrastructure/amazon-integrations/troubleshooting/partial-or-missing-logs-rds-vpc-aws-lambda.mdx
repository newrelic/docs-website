...
1. Évitez les faux positifs dans les alertes : suivez [les procédures de l’interface utilisateur](/docs/alerts/new-relic-alerts/configuring-alert-policies/update-or-disable-policies-conditions#condition-on-off) ou [les procédures de l’API](/docs/alerts/rest-api-alerts/new-relic-alerts-rest-api/disable-enable-alerts-conditions-using-api) pour désactiver toutes les conditions d’alerte associées aux intégrations de monitoring avec AWS Lambda, le monitoring amélioré RDS et les logs de flux VPC.
