...
4. Pour le champ `policy_id`, utilisez l&apos;ID unique de la règle d’alerte associée à la condition. Pour trouver l’ID de la politique, ouvrez la politique dans [one.newrelic.com](https://one.newrelic.com), cliquez sur l&apos;icône <DNT>**(i)**</DNT>, et lisez la valeur du tag d&apos;ID de la politique.
