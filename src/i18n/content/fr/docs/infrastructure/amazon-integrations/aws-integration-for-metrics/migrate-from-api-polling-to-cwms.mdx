...
<Steps>
    ...
    * AWS X-Ray
    ...
    <CollapserGroup>
      ...
      <Collapser id="without-template" title="Migrer sans modèle CloudFormation">
        ...
        1. Reportez-vous à [Intégrer manuellement depuis la console AWS](/docs/infrastructure/amazon-integrations/aws-integration-for-metrics/manual/) et suivez les étapes.
        2. [Désactivez toutes les intégrations d’interrogation inutiles](/docs/infrastructure/amazon-integrations/connect/uninstall-aws/) dans le compte de fournisseur AWS précédent.
  ...
  <Step>
    ## Validez vos données de flux de métriques [#validate-data]
