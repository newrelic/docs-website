...
* **Une [clé de licence](https://one.newrelic.com/api-keys)New Relic**: vous aurez besoin d’une clé de licence pour connecter vos services AWS à votre compte New Relic.
