---
title: Intégration via CloudFormation et sondage API
tags:
...
Pour une intégration transparente de votre compte AWS avec New Relic, [l&apos;intégration via CloudFormation et flux de métriques CloudWatch](/docs/infrastructure/amazon-integrations/aws-integration-for-metrics/via-cloudformation) est l&apos;approche la plus recommandée. Vous pouvez également utiliser API Polling pour l&apos;intégration avec certaines limitations de récupération de données. Pour plus de détails, reportez-vous au tableau de comparaison dans [Ingestion des métriques AWS](/docs/infrastructure/amazon-integrations/get-started/introduction-aws-integrations/#aws-metrics-ingestion). Il est recommandé d&apos;utiliser API Polling uniquement pour les services non pris en charge par flux de métriques CloudWatch.
...
Pour intégrer votre compte AWS à New Relic à l&apos;aide de CloudFormation et d&apos;API Polling, procédez comme suit :
