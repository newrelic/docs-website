...
Nous proposons également une Lambda monitoring fonctionnalité plus approfondie. Pour plus d&apos;informations, consultez [monitoring sans serveur New Relic pour AWS Lambda](/docs/serverless-function-monitoring/aws-lambda-monitoring/get-started/introduction-new-relic-monitoring-aws-lambda).
