   ...
   <CollapserGroup>
     ...
     <Collapser id="fargate-cloudformation" title="Type de lancement d'AWS Fargate">
       ...
       **Differences between forward modes:**
       ...
       | :------------------------------------------ | :---------------------- | :------------------------------ |
       | Host entity visible in NR1                  | Non                     | Oui                             |
       | Host inventory visible in Infrastructure UI | Non                     | Oui                             |
       | Integration inventory                       | Non                     | Oui                             |
       | Integration events forwarded                | Oui                     | Oui                             |
       | Integration entities (e.g., Redis server)   | Non                     | Oui                             |
       | Host metrics (CPU, Memory, Disk)            | Non                     | Non                             |
       | Container metadata decorated                | Non                     | Oui                             |
       | Entity metadata on integration events       | Non                     | Partiel                         |
