...
Voici quelques conditions d’alerte ECS recommandées. Pour ajouter ces alertes, accédez à l’ [UI des alertes](https://one.newrelic.com/alerts/) et ajoutez les [conditions d’alerte NRQL](/docs/alerts/new-relic-alerts/defining-conditions/create-alert-conditions-nrql-queries) suivantes à une règle d’alerte existante ou nouvelle :
