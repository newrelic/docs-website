...
En utilisant [le nom et l&apos;attribut métrique](#nrql-examples), vous pouvez interroger vos données. Pour plus d&amp;apos;informations sur les facettes, les séries chronologiques et la sélection temporelle, consultez la [documentation NRQL](/docs/query-data/nrql-new-relic-query-language/getting-started/nrql-syntax-components-functions).
...
Pour afficher les résultats de la requête NRQL pour les données de votre intégration Prometheus : accédez à <DNT>**[one.newrelic.com &gt; All capabilities](https://one.newrelic.com/all-capabilities) &amp;gt; Query your data**</DNT>. Pour plus d&amp;apos;informations, consultez notre [documentation sur le générateur de requêtes](/docs/chart-builder/use-chart-builder/get-started/introduction-chart-builder).
