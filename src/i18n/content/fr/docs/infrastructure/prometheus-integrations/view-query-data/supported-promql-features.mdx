---
title: Fonctionnalités PromQL prises en charge
tags:
  - Integrations
...
<CollapserGroup>
  ...
  <Collapser title="Fonctions de tri">
  ...
  <Collapser title="Fonctions utilitaires">
    * [`label_join()`](https://prometheus.io/docs/prometheus/latest/querying/functions/#label_join)
  </Collapser>

  <Collapser title="Fonctionnalités spécifiques à Grafana">
    La logique de traduction offre également une prise en charge limitée de la syntaxe Grafana qui ne fait pas partie du langage PromQL.
