...
/\* To learn how to convert from a PromQL query to an NRQL alert condition that can be used with New Relic, watch this short video (approx. 5:45 minutes). &lt;Video id=&quot;oFBJY3OSvLM&quot; type=&quot;youtube&quot; /&gt; \*/
