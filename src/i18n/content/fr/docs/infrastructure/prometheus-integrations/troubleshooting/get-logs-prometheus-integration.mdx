---
title: Obtenir le log (intégration Prometheus )
...
Vous souhaitez obtenir le log de votre intégration Prometheus OpenMetrics avec New Relic pour Docker ou Kubernetes.
