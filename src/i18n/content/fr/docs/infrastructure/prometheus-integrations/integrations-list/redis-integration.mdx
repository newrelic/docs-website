...
[Redis](https://redis.io/) est un magasin de données open source en mémoire utilisé par les développeurs comme base de données, cache, moteur de streaming et courtier de messages.
