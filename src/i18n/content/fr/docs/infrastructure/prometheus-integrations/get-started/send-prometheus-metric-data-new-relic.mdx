...
* Obtenez une vue entièrement connectée de la relation entre les données sur votre stack logicielle et les comportements et résultats que vous monitorez.
* Connectez votre [dashboard Grafana](/docs/integrations/grafana-integrations/get-started/grafana-support-prometheus-promql) (facultatif).
