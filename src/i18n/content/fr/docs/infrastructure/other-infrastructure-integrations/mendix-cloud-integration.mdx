   ...
   <table>
     ...
     <tbody>
       ...
       <tr>
         ...
         <td>
           URI pour l’API des Métriques de New Relic. Pour plus d&apos;informations, consultez [Régions New Relic](https://docs.mendix.com/developerportal/operate/newrelic-metrics/#uri-regions). Pour les valeurs valides, consultez [Signaler des métriques via l&apos;API métrique](/docs/data-apis/ingest-apis/metric-api/report-metrics-metric-api/). Exemple : `https://metric-api.eu.newrelic.com/metric/v1` (UE), `https://metric-api.jp.nr-data.net/metric/v1` (Japon).
         </td>
       </tr>
