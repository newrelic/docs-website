...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Buildpack de l&apos;extension .NET New Relic 1.2.8
      </td>
    </tr>
...
La tuile installe un ou plusieurs des 4 buildpacks suivants selon la configuration de la tuile :

* Buildpack d&apos;extension New Relic Dotnet Core pour les applications Dotnet Core (Ubuntu Jammy)
* Buildpack mis en cache de l&apos;extension New Relic Dotnet Core pour les applications Dotnet Core (Ubuntu Jammy) s&apos;exécutant dans des déploiements PCF déconnectés (isolés)
* Buildpack mis en cache de l&apos;extension HWC New Relic pour les applications Dotnet Framework (Windows 2019)
* Buildpack d&apos;extension New Relic HWC pour les applications Dotnet Framework (Windows 2019) s&apos;exécutant dans des déploiements PCF déconnectés (isolés)

Les 4 buildpacks utilisent l&apos;approche multi-buildpack de Cloud Foundry et nécessitent que le buildpack standard Dotnet Core ou le buildpack HWC soit spécifié dans la chaîne de buildpacks, soit dans le manifeste de l&apos;application, soit dans la ligne de commande CF CLI.
...
<Callout variant="important">
  La version en cache de ce buildpack d&apos;extension pour .NET Core et .NET Framework contient la version New Relic .NET Agents `10.49.x`
</Callout>
