...
## Installer des versions d&apos;agent spécifiques [#install-specific-versions]
...
Pour trouver les versions d&apos;agent infrastructure disponibles et leurs détails de sortie, reportez-vous aux [notes de sortie de l&apos;agent d&apos;infrastructure](/docs/release-notes/infrastructure-release-notes/infrastructure-agent-release-notes/).
