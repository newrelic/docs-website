...
Prêt à commencer ? Cliquez sur le bouton <DNT>**Guided install**</DNT>. Ou, si votre organisation se trouve dans un [data center de l&apos;UE](/docs/using-new-relic/welcome-new-relic/get-started/our-eu-us-region-data-centers), cliquez sur <DNT>**EU Guided install**</DNT>. Ou, si votre organisation se trouve dans un [data center JP](/docs/accounts/accounts-billing/account-setup/choose-your-data-center), cliquez sur <DNT>**JP Guided install**</DNT>.
