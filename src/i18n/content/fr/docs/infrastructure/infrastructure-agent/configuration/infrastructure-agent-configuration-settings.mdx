...
<CollapserGroup>
  ...
  <Collapser className="freq-link" id="logging-http-client-timeout" title="logging_http_client_timeout">
    Définit le délai d&apos;attente du client HTTP (en secondes) pour le plugin de sortie fluent-bit New Relic. Ceci contrôle la durée pendant laquelle le redirecteur de logging attendra une réponse lors de l&apos;envoi des données de log à New Relic.

    Pour plus d&apos;informations, consultez la [documentation du plugin de sortie fluent-bit](https://github.com/newrelic/newrelic-fluent-bit-output#httpclienttimeout).
...
<CollapserGroup>
  ...
  <Collapser className="freq-link" id="safe-bin-dir" title="safe_bin_dir">
    Répertoire où l&apos;agent recherche des exécutables pour les intégrations.
  ...
  <Collapser className="freq-link" id="agent-temp-dir" title="agent_temp_dir">
    Répertoire où l&apos;agent stocke les fichiers temporaires (par exemple, la configuration du redirecteur de logs et les données de découverte d&apos;intégration). Ce répertoire est supprimé à chaque redémarrage de l&apos;agent, mais uniquement s&apos;il correspond toujours à sa valeur par défaut.
  ...
  <Collapser className="freq-link" id="logging-configs-dir" title="logging_configs_dir">
    Répertoire contenant les fichiers de configuration pour le redirecteur de logs.
  ...
  <Collapser className="freq-link" id="logging-home-dir" title="logging_home_dir">
    Répertoire contenant les binaires et autres fichiers requis pour le redirecteur de logs.
  ...
  <Collapser className="freq-link" id="logging-bin-dir" title="logging_bin_dir">
    Répertoire contenant les binaires pour le redirecteur de logs.
