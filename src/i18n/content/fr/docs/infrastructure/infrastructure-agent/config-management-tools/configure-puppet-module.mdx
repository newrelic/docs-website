  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * `NEW_RELIC_REGION`: votre [région de data center](/docs/accounts/accounts-billing/account-setup/choose-your-data-center) (`US`, `EU` ou `JP`). La valeur par défaut est `US`.
