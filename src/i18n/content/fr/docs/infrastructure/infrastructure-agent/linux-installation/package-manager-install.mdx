...
Le moyen le plus rapide de démarrer avec notre [agent d’infrastructure](/docs/infrastructure/infrastructure-monitoring/get-started/get-started-infrastructure-monitoring/) est d’utiliser notre [installation guidée](/docs/new-relic-one/use-new-relic-one/cross-product-functions/install-configure/new-relic-guided-install-overview/). Si vous êtes dans l’UE, essayez notre installation guidée pour l’UE. Si vous êtes dans la région JP, essayez notre installation guidée JP.
...
<ButtonGroup>
  ...
  <ButtonLink role="button" to="https://onenr.io/0bRKrBNeEwE" variant="primary">
