...
<img title="Linkerd dashboard" alt="Linkerd dashboard" src="/images/infrastructure_screenshot_full-linkerd-dashboard.webp" />
...
<Steps>
  <Step>
    ...
    Pour utiliser l’intégration Linkerd, vous devez également [installer l’agent d’infrastructure](/docs/infrastructure/install-infrastructure-agent/get-started/install-infrastructure-agent-new-relic/) sur le même hôte. L&amp;apos;agent infrastructure monitore l&amp;apos;hôte lui-même, tandis que l&amp;apos;intégration que vous installerez à l&amp;apos;étape suivante étend votre monitoring avec des données spécifiques à Linkerd.
  </Step>

  <Step>
    ## exposer les métriques Linkerd [#expose-linkerd-metrics]
  ...
  <Step>
    ## Activer l&apos;intégration de Linkerd avec nri-prometheus [#enable-linkerd]
