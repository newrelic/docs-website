...
Notre [intégration](/docs/infrastructure/host-integrations/get-started/introduction-host-integrations) Couchbase collecte et envoie des données d&apos;inventaire et de métrique depuis votre cluster Couchbase vers la plateforme New Relic, où vous pouvez rapidement voir l&apos;état de santé de votre environnement Couchbase. Nous collectons des données au niveau du cluster, du nœud, du moteur de requête et du bucket afin que vous puissiez suivre la trace d&apos;un problème jusqu&apos;à sa source.
...
<ButtonGroup>
  <ButtonLink role="button" to="https://one.newrelic.com/marketplace/install-data-source?state=7cd80f29-a702-ebb3-edcd-80cab8b61ee2" variant="primary">
    Installation guidée, région US (par défaut)
  </ButtonLink>
...
Les données d&apos;intégration sont rapportées au [dashboard d&apos;intégration](/docs/infrastructure/infrastructure-data/infra-integration-data).
