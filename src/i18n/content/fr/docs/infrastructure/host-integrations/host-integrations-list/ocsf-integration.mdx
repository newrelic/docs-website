...
Utilisez New Relic pour monitorer en toute transparence les données Open Cybersecurity Schema Framework (OCSF). Vous bénéficierez d&apos;une visibilité complète sur les données liées à la sécurité provenant de multiples sources afin de faciliter la détection des menaces, la réponse aux événements d&apos;alerte et la conformité.
