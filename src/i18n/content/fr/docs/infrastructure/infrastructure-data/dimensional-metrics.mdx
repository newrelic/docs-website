---
title: Formats dimensionnels métriques pour agent et intégration sur hôte
tags:
  - Infrastructure
  - Manage your data
...
Dans le passé, notre agent infrastructure et intégration sur hôte ont signalé [des métriques comme attribut attaché à événement](/docs/data-apis/understand-data/new-relic-data-types/#metric-event-attributes), également appelés « exemples de données ». Nous avons désormais rendu ces métriques également disponibles sous forme [de métriques dimensionnelles](/docs/data-apis/understand-data/new-relic-data-types/#dimensional-metrics), un format de données qui permet une analyse et une agrégation améliorées au fil du temps.

Le tableau suivant présente les noms métriques dimensionnels équivalents pour notre agent infrastructure et pour notre intégration sur hôte. Pour obtenir des conseils sur la manière de requêter des métriques dimensionnelles, voir [requête métriques dimensionnelles](/docs/data-apis/understand-data/metric-data/query-metric-data-type).
...
<table>
  <tbody>
    <tr>
      ...
      <th style={{ width: "275px" }}>
        Exemple de nom de métrique (précédent)
      </th>
    </tr>
