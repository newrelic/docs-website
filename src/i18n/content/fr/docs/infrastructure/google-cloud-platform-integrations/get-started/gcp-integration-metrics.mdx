...
Le tableau suivant répertorie certaines des métriques collectées par les intégrations GCP et leurs traductions de [métriques dimensionnelles](/docs/telemetry-data-platform/ingest-manage-data/understand-data/new-relic-data-types/#dimensional-metrics).
