---
title: Métriques d'intégration GCP
tags:
  - Integrations
...
## Métriques Google Cloud [#gcp-metrics-table]

Le tableau suivant est une liste non exhaustive des métriques collectées par l&apos;intégration GCP et de leurs traductions [métriques dimensionnelles](/docs/telemetry-data-platform/ingest-manage-data/understand-data/new-relic-data-types/#dimensional-metrics) .
