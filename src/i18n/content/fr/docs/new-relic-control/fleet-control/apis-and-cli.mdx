...
Pour explorer l&apos;API de manière interactive, utilisez le [<DNT>NerdGraph Explorer</DNT>](https://one.newrelic.com/nerdgraph-graphiql) (ou la [région UE](https://one.eu.newrelic.com/nerdgraph-graphiql), ou la [région JP](https://one.jp.newrelic.com/nerdgraph-graphiql)).
