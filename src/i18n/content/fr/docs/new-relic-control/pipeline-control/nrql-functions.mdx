---
title: Prise en charge des fonctions NRQL dans les règles de pipeline
metaDescription: Learn about the support for NRQL functions in pipeline rules and how to use them effectively.
freshnessValidatedDate: never
translationType: machine
---

Ce document décrit les fonctions NRQL prises en charge par le gateway Pipeline Control. Cette amélioration fournit des moyens de gérer vos données dans New Relic.
...
## Exemples de fonctions NRQL dans les règles de pipeline
