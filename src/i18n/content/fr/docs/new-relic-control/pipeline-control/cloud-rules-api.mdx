...
Vous pouvez modifier les règles cloud existantes pour ajuster leurs critères de filtrage, leurs types de données ou leur étendue de déploiement.
...
* **Vérifiez la réponse de l’API :** l’objet d’entité dans la réponse reflétera le nom, la description et le NRQL mis à jour.
