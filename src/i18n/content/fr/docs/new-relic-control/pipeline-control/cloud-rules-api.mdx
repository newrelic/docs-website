...
Utilisez la mutation `updatePipelineCloudRule`, en fournissant la règle `id` et un objet `pipelineCloudRuleEntity` contenant les champs que vous souhaitez modifier.
