...
To create and edit rules, you can either use the Pipeline Control UI or the [NerdGraph](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph) API explorer *(**[one.newrelic.com](https://one.newrelic.com) &gt; Apps &gt; NerdGraph API explorer**)*.
