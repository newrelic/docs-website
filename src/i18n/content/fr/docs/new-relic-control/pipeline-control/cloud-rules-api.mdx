...
<Callout variant="important">
  The entitlement check is performed against the following internal policies: Policy Name: legacy\_drop\_rules\_eol (Product Line: generic) Policy Name: pipeline\_cloud\_drop\_rules\_ccu (Product Line: nr\_queries)
</Callout>
