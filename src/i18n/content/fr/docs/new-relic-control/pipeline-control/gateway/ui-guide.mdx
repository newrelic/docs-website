...
Créez des règles de filtrage basées sur OTTL pour supprimer conditionnellement des enregistrements de télémétrie entiers ou des attributs spécifiques. Prise en charge :
