...
Ensuite, vous apprendrez à [configurer le DNS et les certificats de sécurité](/docs/new-relic-control/pipeline-control/gateway/dns-certificate) pour l&apos;ALB AWS.