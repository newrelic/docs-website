...
* Déclaration de version : version : `2.0.1` spécifie le schéma de configuration
...
2. Vous déployez via l&apos;interface utilisateur (téléversement YAML) sur votre flotte de gateways.
3. Le gateway applique la configuration à tous les clusters de gateways de la flotte.
4. Tous les clusters de la flotte traitent les données de manière identique en utilisant les mêmes règles.

**Gestion des versions :**

* Chaque changement de configuration crée une nouvelle version (par flotte)
...
* Différentes flottes peuvent maintenir différentes configurations et versions.

## Prochaines étapes

**Commencer avec l&apos;installation du gateway :**

* [Installer avec Flux](/docs/new-relic-control/pipeline-control/gateway/set-up-and-deploy-pipeline-control) - Gestion complète du cycle de vie du gateway via l&apos;interface utilisateur (installation, mise à niveau, mise à l&apos;échelle)
* [Installer sans Flux](/docs/new-relic-control/pipeline-control/gateway/install-gateway-without-flux) - Mode configuration uniquement pour des permissions réduites
...
**Explorer les types de processeurs :**
