...
* `conditionalSamplingRules`: Tableau de règles conditionnelles (évaluées dans l&apos;ordre) - **pris en charge uniquement pour les logs et les événements**
...
Pour les traces, vous pouvez uniquement configurer le pourcentage d&apos;échantillonnage global. Ce pourcentage s&apos;applique à **toutes les traces uniformément**, y compris les traces d&apos;erreur et les traces lentes :
