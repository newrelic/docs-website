...
* **Sources :**
  ...
  * Affiche les quatre types de télémétrie (métriques, événements, logs, traces) que les agents et les collecteurs envoient à New Relic. Chaque source affiche le volume de données transitant par le pipeline. Ceci représente les points d&apos;entrée de vos données d&apos;observabilité.
...
* **Cloud :**
  ...
  * Indique les règles cloud qui s&apos;exécutent dans l&apos;infrastructure de New Relic. Affiche le nombre de règles actives (par exemple, &quot;0 règle&quot; lorsqu&apos;aucune règle cloud n&apos;est configurée). Cela représente le filtrage supplémentaire appliqué après que les données ont atteint les points de terminaison New Relic.