...
* [Métriques dimensionnelles](/docs/data-apis/understand-data/new-relic-data-types/#dimensional-metrics). Quelques mises en garde :
...
* Si la règle a été désactivée par New Relic (par exemple, politique de fin de vie) : la requête échouera à moins que l&apos;utilisateur ne possède les droits internes nécessaires pour outrepasser la politique.
...
* Parcourez le [forum d’assistance](https://support.newrelic.com/s/hubtopic/Topic__c/Default?c__categories=%5B%7B%22icon%22%3A%22standard%3Adefault%22%2C%22id%22%3A%22a6c8W000000EesuQAC%22%2C%22sObjectType%22%3A%22Category__c%22%2C%22title%22%3A%22Dashboards%22%2C%22titleFormatted%22%3A%22Dashboards%22%7D%5D) pour les discussions de la communauté sur les règles cloud.
