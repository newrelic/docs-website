...
<Callout variant="important">
  ...
  Veuillez mettre à jour vers l&apos;agent New Relic iOS 7.5.8. Nous avons identifié un bug dans la version 7.5.7 du SDK iOS qui pourrait provoquer un plantage au lancement de l&apos;agent, et un correctif est inclus dans l&apos;agent iOS New Relic 7.5.8 sortie.
</Callout>
