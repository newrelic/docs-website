...
#### .at cause des problèmes dans les anciens navigateurs

.at() n&apos;est pas correctement transpilé et provoque des problèmes d&apos;initialisation, passage à l&apos;indexation.
...
Conformément à notre [politique de prise en charge des navigateurs](https://docs.newrelic.com/docs/browser/new-relic-browser/getting-started/compatibility-requirements-browser-monitoring/#browser-types), la v1.312.1 de l&apos;agent Browser a été conçue pour et testée sur les navigateurs et plages de versions suivants : Chrome 136-146, Edge 136-146, Safari 18-26 et Firefox 138-148. Pour les appareils mobiles, la v1.312.1 a été compilée et testée pour Android OS 16 et iOS Safari 18-26.2.