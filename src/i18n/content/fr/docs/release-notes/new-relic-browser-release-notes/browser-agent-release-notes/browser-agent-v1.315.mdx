...
#### Améliorer l&apos;API SPA pour prendre en charge l&apos;option targetPageLoad

Permettre à l&apos;API SPA de cibler et de travailler sur l&apos;événement `BrowserInteraction` de type `initialPageLoad`. Une nouvelle option est ajoutée à `.interaction` qui lie désormais le handle retourné à l&apos;interaction de chargement initial de la page à tout moment.
...
Conformément à notre [politique de prise en charge des navigateurs](https://docs.newrelic.com/docs/browser/new-relic-browser/getting-started/compatibility-requirements-browser-monitoring/#browser-types), la v1.315.0 de l&apos;agent Browser a été conçue pour et testée sur ces navigateurs et plages de versions : Chrome 136-146, Edge 136-146, Safari 18-26 et Firefox 138-148. Pour les appareils mobiles, la v1.315.0 a été compilée et testée pour Android OS 16 et iOS Safari de 18 à 26.2.