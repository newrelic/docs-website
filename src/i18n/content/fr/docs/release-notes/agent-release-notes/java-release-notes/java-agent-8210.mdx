...
Mise à jour de la version CSEC vers 1.7.0 [2348](https://github.com/newrelic/newrelic-java-agent/pull/2348) Journal des modifications : [https://github.com/newrelic/csec-java-agent/releases/tag/1.7.0](https://github.com/newrelic/csec-java-agent/releases/tag/1.7.0)
