...
* Prise en charge de MongoDB Reactive Streams 5.2.0 et versions ultérieures par @obenkenobi en [2465](https://github.com/newrelic/newrelic-java-agent/pull/2465)
* Support de Jedis 6 par @kanderson250 en [2466](https://github.com/newrelic/newrelic-java-agent/pull/2466)

## Corrections

* CouchBase : ajout d&apos;une classe skip pour éviter la double instrumentation par @jtduffy dans [2462](https://github.com/newrelic/newrelic-java-agent/pull/2462)
* Spring WebClient 5.x : encapsuler uniquement les en-têtes au lieu de la réponse entière par @jtduffy dans [2464](https://github.com/newrelic/newrelic-java-agent/pull/2464)
