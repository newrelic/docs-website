...
* Agent mis à jour pour utiliser `@apm-js-collab/tracing-hooks` pour l&apos;enregistrement CJS/ESM pour le traçage de l&apos;instrumentation basée sur le canal ([#3324](https://github.com/newrelic/node-newrelic/pull/3324)) ([4b2c14f](https://github.com/newrelic/node-newrelic/commit/4b2c14f35d5c658160ad9420ca562f73ae55bbc0))
