...
* correction : gestion du processus Windows dans #2080
* corvée(dépendances) : passer nri-docker à la version 2.5.1 et nri-Prometheus à la version 2.26.1 dans #2081