...
1. Assurez-vous de disposer d&apos;une [clé API de requête Insights](/docs/insights/insights-api/get-data/query-insights-event-data-api) (accédez à <DNT>**[one.newrelic.com/api-keys](https://one.newrelic.com/api-keys)**</DNT>).
