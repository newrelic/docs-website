...
<Callout variant="tip">
  Si votre organisation héberge des données dans le data center de l&apos;UE ou JP, assurez-vous d&apos;utiliser le point de terminaison régional correct. Pour cette API :

  * Point de terminaison de l&apos;UE : `https://metric-api.eu.newrelic.com/metric/v1`
  * Point de terminaison JP : `https://metric-api.jp.nr-data.net/metric/v1`
</Callout>
