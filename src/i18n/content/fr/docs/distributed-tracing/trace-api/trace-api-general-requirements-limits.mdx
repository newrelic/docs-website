      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td>
              Données acceptées. Cela signifie que vous avez passé les vérifications préliminaires, mais cela ne garantit pas que les données ont été analysées et indexées avec succès dans le cadre d&apos;une trace distribuée.
            </td>
          </tr>
