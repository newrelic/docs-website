...
Notez que si vous utilisiez Infinite Tracing, ou si vous aviez un compte New Relic de région EU ou JP, le [point de terminaison](/docs/distributed-tracing/trace-api/trace-api-general-requirements-limits#requirements) serait différent.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Les spans Zipkin v2 doivent avoir des durées spécifiées en microsecondes et seront converties en millisecondes.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Nous utilisons le nom de service Zipkin v2 pour identifier l’entité qui a créé cette plage. Si aucune valeur ou une chaîne vide n&apos;est fournie, la span est attribuée à une entité « INCONNUE » et s&apos;affichera comme telle dans l&apos;UI. Cette valeur doit être fournie pour obtenir une expérience complète dans l&apos;UI.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Nous ne prenons actuellement pas en charge les annotations dans l&apos;API de trace. Les spans ne seront pas rejetées si elles contiennent des annotations, mais les données d&apos;annotations ne seront pas écrites.
      </td>
    </tr>
  </tbody>
</table>
