...
* **Taille moyenne des spans**: 900 octets
...
* **Stockage par span**: `~900 bytes` (protobuf sérialisé)
...
**Exemple de calcul**: à 10 000 spans/seconde avec `traces_ttl` de 1 heure :
