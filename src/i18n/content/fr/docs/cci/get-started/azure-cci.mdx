...
* Rôle de contributeur de gestion des coûts
...
<Steps>
  <Step>
    ...
    1. Dans le portail Azure, accédez à <DNT>**Cost Management &amp; Billing**</DNT>.
    2. Sélectionnez votre <DNT>**Billing Scope**</DNT>, puis développez <DNT>**Settings**</DNT> et cliquez sur <DNT>**Exports**</DNT>.
    3. Passez en revue la liste pour une exportation au format <DNT>**Cost and Usage (FOCUS)**</DNT> et une compression <DNT>**Parquet**</DNT>.
  ...
  <Step>
    ...
    4. Sélectionnez <DNT>**Cost and Usage (FOCUS)**</DNT> comme type d’exportation.
  ...
  <Step>
    ...
    Le traitement initial prend jusqu&apos;à 48 heures. Vos données de coût apparaissent ensuite dans le dashboard Cost Overview.
  </Step>
