...
Interrogez les données d&apos;Intelligence Coûts du cloud à l&apos;aide de NRQL pour analyser et optimiser les dépenses cloud. Cinq types d&apos;événements sont disponibles avec des attributs pour des requêtes détaillées :
...
<table>
  ...
  <tr>
    ...
    <td>
      Événement de coût, prend en charge le langage NRQL complet
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      Allocation des coûts Kubernetes, prend en charge le langage NRQL complet
    </td>
  </tr>
...
Pour écrire des requêtes [NRQL](/docs/nrql/get-started/introduction-nrql-new-relics-query-language) efficaces, consultez le [tutoriel d&apos;introduction à NRQL](/docs/nrql/nrql-tutorials/introduction-nrql-tutorial).

## Interroger les données de Cloud Cost Intelligence

Accédez à <DNT>**All Capabilities &gt; Cloud Cost Intelligence**</DNT> et ouvrez <DNT>**Query Console**</DNT> pour saisir vos requêtes.
...
<Tabs>
  ...
  <TabsPages>
    ...
    <TabsPageItem id="kubernetescost">
      ...
      Cela multiplie `net_unblended_cost` par la somme de la pondération du CPU et de la mémoire pour une allocation précise des coûts basée sur l&apos;utilisation des ressources.
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              Prix réduit du compte individuel.
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              Cœurs de processeur utilisés par le conteneur sur le total alloué.
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              Cœurs de CPU demandés pour le déploiement des conteneurs.
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              Cœurs de processeur alloués pour ce conteneur. (0.00005877)
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              Coût calculé avec l&apos;utilisation du CPU.
            </td>
          </tr>
...
<CollapserGroup>
  <Collapser id="state-select" title="Clauses NRQL prises en charge">
