...
Interrogez les données de Cloud Cost Intelligence à l&apos;aide de NRQL pour analyser et optimiser les dépenses cloud. Trois types d&apos;événements sont disponibles avec des attributs pour des requêtes détaillées :
...
<CollapserGroup>
  <Collapser id="cloud-cost-attributes" title="Attribut CloudCost">
    Accédez à **All Capabilities &gt; Cloud Cost Intelligence** et ouvrez la console de requête pour saisir :
