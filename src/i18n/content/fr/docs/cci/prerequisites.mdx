...
<CollapserGroup>
  ...
  <Collapser id="iam-role-cci-access" title="Rôle IAM pour CCI à assumer">
    ...
    <Callout variant="caution" title="Note">
      L&apos;externalId est un identifiant unique et dynamique du service d&apos;intégration CCI ; il est généré une fois que nous revenons à CCI pour démarrer l&apos;intégration.
    </Callout>
