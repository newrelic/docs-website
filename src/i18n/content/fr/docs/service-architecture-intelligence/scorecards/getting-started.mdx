...
Rules are grouped by [maturity level](/docs/service-architecture-intelligence/scorecards/service-maturity) (Basic, Intermediate, and Advanced), so you can see how your standards are distributed and track how services progress from basic compliance to operational excellence.
