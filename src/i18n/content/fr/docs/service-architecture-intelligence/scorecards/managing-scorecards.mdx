...
<Callout variant="tip" title="conseil">
  Utilisez les mutations NerdGraph pour créer ou gérer vos règles de Scorecards. Pour plus d’informations, reportez-vous à la section [Créer des rôles personnalisés pour les Scorecards](/docs/apis/nerdgraph/examples/nerdgraph-scorecards-custom-tutorial).
</Callout>
