    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Liste de noms d&apos;entités séparés par des virgules pour la suppression des données de la matrice réseau. (Exemple : &quot;kube-dns,otel-collector,service1&quot;).
          </td>
        ...
        <tr>
          ...
          <td>
            Liste de noms d&apos;entités, séparés par des virgules, à conserver en permanence dans les données de la matrice réseau. Par défaut, toutes les entités sont conservées/activées. Cela contourne le filtre DROP_NETWORK_METRICS_DATA_FOR_ENTITY_NAME. (Exemple : &quot;critical-service,important-app,must-monitor&quot;).
          </td>
        ...
        <tr>
          ...
          <td>
            Liste de noms d&apos;entités séparés par des virgules pour la suppression des données eBPF APM. (Exemple : &quot;kube-dns,otel-collector,service1&quot;)
          </td>
        ...
        <tr>
          ...
          <td>
            Liste de noms d&apos;entités séparés par des virgules pour toujours conserver les données eBPF APM. Par défaut, toutes les entités sont conservées/activées. Cela contourne le filtre DROP_APM_DATA_FOR_ENTITY_NAME. (Exemple : &quot;critical-service,important-app,must-monitor&quot;)
          </td>
        ...
        <tr>
          ...
          <td>
            Modèle d&apos;expressions régulières pour correspondre aux noms d&apos;entités pour supprimer TOUTES les données (statistiques TCP + données APM)(Exemple : &quot;java-app|otel-collector|\bservice1\b&quot;)
          </td>
        ...
        <tr>
          ...
          <td>
            Modèle d&apos;expressions régulières pour faire correspondre les noms d&apos;entités pour toujours conserver TOUTES les données. Cela contourne tous les filtres de suppression. (Exemple : &quot;critical-service|important-app|\bmust-monitor\b&quot;)
          </td>
        ...
        <tr>
          ...
          <td>
            Supprimer toutes les données des applications/entités sur lesquelles des agents NewRelic/OpenTelemetry APM sont en cours d&apos;exécution.
          </td>
