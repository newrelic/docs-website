    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Définit le chemin du répertoire dans lequel les en-têtes Linux requis sont téléchargés et placés pour que l&apos;agent eBPF les utilise. Ceci est utile dans les environnements restreints où l&apos;agent n&apos;est pas en mesure de télécharger les en-têtes Linux requis. Les en-têtes requis sont identifiés par l&apos;agent en fonction de la version du noyau.
          </td>
