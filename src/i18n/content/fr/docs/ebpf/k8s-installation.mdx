    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Activer le reporting des métriques réseau. Lorsqu&apos;il est activé, l&apos;agent collecte et rapporte les métriques réseau, y compris les statistiques TCP. Il est renommé de 

            `tcpStatsReporting`

            . L&apos;ancien nom est obsolète, mais la compatibilité descendante est prise en charge.
          </td>
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            Supprimer les données des espaces de noms newrelic et des services newrelic-bundle. (RENOMMÉ de 

            `dropDataNewRelic`

             pour plus de clarté. L&apos;ancien nom est obsolète, mais toujours pris en charge pour la compatibilité descendante).
          </td>
        ...
        <tr>
          ...
          <td>
            Liste des espaces de noms Kubernetes pour lesquels toutes les données doivent être supprimées par l&apos;agent. (RENOMMÉ de 
        ...
        <tr>
          ...
          <td>
            Définir une expression régulière pour faire correspondre les noms de service k8s à supprimer. Exemple 
        ...
        <tr>
          ...
          <td>
            Cette configuration agit comme une dérivation pour la configuration 
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Labels de pod à faire correspondre pour filtrer les données APM. Une carte vide signifie aucun filtrage basé sur les labels. (Exemple : dropPodLabels : 
        ...
        <tr>
          ...
          <td>
            Liste des noms d&apos;entités pour supprimer les données APM ebpf
          </td>
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            Labels de pod à faire correspondre pour filtrer les données des métriques réseau. Une carte vide signifie aucun filtrage basé sur les labels. (Exemple : dropPodLabels : 
