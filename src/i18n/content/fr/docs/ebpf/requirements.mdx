  ...
  <TabsPages>
    ...
    <TabsPageItem id="linux">
      ...
      * Versions du noyau Linux :
        ...
        * `x86-64` (amd64) : `v5.8` à `v6.14`
        * `arm64` (aarch64) : `v5.8` à `v6.14`

      <Callout variant="important">
        Certaines distributions Linux vous permettent d&apos;exécuter d&apos;anciennes versions du noyau sur des sorties plus récentes du système d&apos;exploitation. Même si votre distribution est [listée ci-dessous](#supported-linux-distributions), l&apos;agent eBPF ne fonctionnera pas si la version du noyau est inférieure à `5.8`. Il en va de même pour les noyaux plus récents : l&apos;agent ne fonctionnera pas sur les versions supérieures à la plage prise en charge, y compris `v7.x`.
      </Callout>
