  ...
  <Step>
    ...
    <CollapserGroup>
      ...
      <Collapser id="disable-health-status-reporting" title="Rapport sur l'état de santé">
        Dans New Relic, les entités sont associées à [un code de couleur pour état de santé](/docs/alerts/create-alert/examples/view-entity-health-status-find-entities-without-alert-conditions/#colors). Vous pouvez visualiser l&apos;état actuel de ces entités à partir de leurs index et cartes respectifs. Lorsqu&apos;une condition d&apos;alerte est associée à une entité, l&apos;état de santé de cette entité est déterminé par la condition d&apos;alerte. Si l&apos;alerte déclenche un incident, l&apos;état de santé de l&apos;entité change en fonction du niveau de gravité de l&apos;incident.
...
<DocTiles>
  ...
  <DocTile title="État d'alerte avancé" path="/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-alert-conditions/">
    Si vous avez déjà configuré votre condition d&apos;alerte, approfondissez vos connaissances avec les paramètres avancés
  </DocTile>

  <DocTile title="Être averti" path="/docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows/">
