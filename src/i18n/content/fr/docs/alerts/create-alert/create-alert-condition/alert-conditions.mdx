    ...
    <CollapserGroup>
      ...
      <Collapser id="predict-alert" title="Alertes prédictives avec seuil statique (Disponible en aperçu public)">
        <Callout title="Aperçu">
          ...
          When the Predictive Alerts public preview period ends at any point for any reason, your alert conditions evaluation window will only evaluate against the static threshold, which may result in a slight delay to detecting an alert violation.
        </Callout>
