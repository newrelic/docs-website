...
<DNT>**Predictive Alerts**</DNT> est disponible pour tous les [<DNT>Full platform users</DNT>](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type/#user-type-capabilities) de tous les clients. Pour les clients utilisant le modèle de tarification [<DNT>Data + User</DNT>](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing/), il n’y a aucun coût supplémentaire. Pour les clients du modèle de tarification [<DNT>Data + Core Compute</DNT>](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing/), les [Core CCUs](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing/#core-compute-capacity-unit) sont consommés lorsque les données historiques sont analysées et que des prédictions sont générées.
