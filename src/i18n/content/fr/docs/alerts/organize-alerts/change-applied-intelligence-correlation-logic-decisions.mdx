...
<CollapserGroup>
  <Collapser className="freq-link" id="configure-source-nr-alerts" title="Alertes">
    ...
    2. À gauche, sous <DNT>**incident intelligence**</DNT>, cliquez sur <DNT>**Sources**</DNT>, puis sur <DNT>**Alerts**</DNT>.
  ...
  <Collapser className="freq-link" id="configure-aporia" title="Aporia (MLOps)">
    En intégrant l&apos;intelligence incident à vos modèles d&apos;apprentissage automatique Aporia , vous pouvez monitorer les performances de votre modèle d&apos;apprentissage automatique. Pour configurer notre intégration Aporia, consultez notre [documentation](/docs/integrations/mlops-integrations/aporia-mlops-integration/).
  </Collapser>

  <Collapser className="freq-link" id="configure-aporia" title="Superwise (MLOps)">
    En intégrant l&apos;intelligence incident à vos modèles d&apos;apprentissage automatique Superwise , vous pouvez monitorer les performances de votre modèle d&apos;apprentissage automatique. Pour configurer notre intégration Superwise, consultez notre [documentation](/docs/alerts-applied-intelligence/mlops/integrations/superwise-mlops-integration/).
  </Collapser>
