...
* Slack : disponible dans [le flux de travail](/docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows/), [la boîte de réception des erreurs](/docs/errors-inbox/) et [les discussions](/docs/new-relic-solutions/new-relic-one/ui-data/collaborate/collaboration-slack-integration/).
...
* E-mail : Disponible dans [le flux de travail](/docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows/) et [les discussions](/docs/new-relic-solutions/new-relic-one/ui-data/collaborate/collaborate-with-teammates/).
