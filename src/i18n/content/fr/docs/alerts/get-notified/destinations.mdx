...
* **Workflow Automation**: Disponible dans [workflows](/docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows/). Déclenche [des workflows de réponse aux incidents automatisés](/docs/workflow-automation/setup-and-configuration/create-destinations#trigger-from-alerts) lorsque les conditions d&apos;alerte sont dépassées.f
