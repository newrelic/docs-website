...
Que signifie [cette migration](https://support.newrelic.com/s/hubtopic/aAX8W0000008dKO/plan-to-upgrade-alert-notification-channels-to-workflows-and-destinations) pour votre équipe ? Dans notre précédent modèle de notification, votre équipe créait une condition d’alerte avec différents seuils et paramètres. Si cette condition était associée à une politique spécifique, qu’elle était violée, et que vous vouliez que votre équipe en soit informée immédiatement, vous ajoutiez <DNT>**notification settings**</DNT>. Nos paramètres de notification indiquaient à New Relic quelles données envoyer et à quel endroit.
