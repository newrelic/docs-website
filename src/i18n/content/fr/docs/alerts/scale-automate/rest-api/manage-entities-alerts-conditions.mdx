...
Dans <InlinePopover type="alerts" />, un <DNT>**entity**</DNT> est défini comme toute cible de monitoring, telle qu&apos;une application, un navigateur ou un hôte. L&apos;[UI des alertes](https://one.newrelic.com/alerts/) affiche les entités disponibles que vous pouvez sélectionner. Vous pouvez également utiliser l&apos;API REST et API Explorer pour [ajouter](https://api.newrelic.com/docs/#/Alerts%20Entity%20Conditions/put_alerts_entity_conditions__entity_id__json) ou [supprimer](https://api.newrelic.com/docs/#/Alerts%20Entity%20Conditions/delete_alerts_entity_conditions__entity_id__json) des entités pour une condition.
