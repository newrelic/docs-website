...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        Ajoutez notre e-mail à votre liste de domaines autorisés
      </td>

      <td>
        De nombreux messages peuvent se retrouver dans votre filtre anti-spam ou celui de votre entreprise. Pour vous assurer que votre système reconnaît les e-mails que nous envoyons, ajoutez [noreply@newrelic.com](mailto:noreply@newrelic.com) et \*@mailer-d.newrelic.com à votre liste de domaines autorisés ou à votre liste d&apos;« expéditeurs approuvés » en tant que source d&apos;e-mails de confiance.
      </td>
    </tr>
