...
* Un bon nommage de la télémétrie donne aux équipes opérationnelles un langage commun à utiliser avec les développeurs lors des événements d&apos;alerte, réduisant ainsi le temps de triage et de résolution des problèmes.
...
<CollapserGroup>
  ...
  <Collapser id="kpi-mean-time-to-close" title="Temps moyen de fermeture">
    Le &quot;Temps moyen de clôture&quot; désigne la durée moyenne des événements d&apos;alerte déclenchés par des alertes dans New Relic.

    <DNT>**Goal:**</DNT> Diminution constante du délai de clôture des événements d&apos;alerte pour les services identifiés.
