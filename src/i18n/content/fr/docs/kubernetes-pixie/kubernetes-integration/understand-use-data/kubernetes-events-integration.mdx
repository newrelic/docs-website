...
Les événements collectés par New Relic auront exactement les mêmes attributs que ceux donnés par Kubernetes. Pour une référence de ces attributs, consultez la [documentation principale Kubernetes événement v1](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.34/#event-v1-core).
