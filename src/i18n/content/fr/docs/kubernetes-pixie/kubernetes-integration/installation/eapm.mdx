---
title: Intégration de New Relic eAPM
tags:
  - Integrations
  - eBPF integration
  - eAPM
...
## Principales différences entre eAPM et APM [#key-differences]
...
## Installation de l&apos;agent eAPM [#installation]
...
6. Pour installer le graphique Helm de l&apos;agent eAPM, remplacez `your-custom-values.yaml` par le chemin d&amp;apos;accès à votre fichier `values.yaml` , exécutez :
...
<Callout variant="tip" title="conseil">
  Le graphique Helm eAPM offre plusieurs options de configuration. Consultez le fichier [`value.yaml`](https://github.com/newrelic/helm-charts/blob/master/charts/nr-ebpf-agent/values.yaml) pour adapter l’installation à vos besoins.
</Callout>

## Accéder à l&apos;UI APM optimisée par eAPM [#eapm-access]
...
## Comment l&apos;agent eAPM et l&apos;APM fonctionnent ensemble [#eapm-apm]
