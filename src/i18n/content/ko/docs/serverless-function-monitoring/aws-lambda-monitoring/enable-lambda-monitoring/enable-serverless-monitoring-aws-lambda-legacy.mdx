...
<CollapserGroup>
  ...
  >
    ...
    4. Lambdaコードで、コンポーネントをインポートし、アプリケーションを作成し、Lambdaの起動方法を更新します。[インストゥルメントされたLambdaの例については、GitHubリポジトリ](https://github.com/newrelic/go-agent/blob/master/_integrations/nrlambda/example/main.go)を参照してください。
