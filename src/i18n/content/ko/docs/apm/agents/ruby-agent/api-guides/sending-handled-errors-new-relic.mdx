...
エラーデータをNew Relicに送信して、独自のコードで処理していることを伝えるには、RubyエージェントのAPI [`NewRelic::Agent.notice_error`](http://www.rubydoc.info/github/newrelic/newrelic-ruby-agent/NewRelic/Agent#notice_error-instance_method)呼び出しをエラーハンドラ内で使用します。
