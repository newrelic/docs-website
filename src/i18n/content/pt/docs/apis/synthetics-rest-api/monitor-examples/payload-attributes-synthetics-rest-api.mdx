---
title: Atributo de carga útil para a API REST de monitoramento sintético
tags:
  - APIs
...
Para requisitos da API REST para Sintético, consulte [Usar a API](/docs/apis/synthetics-rest-api/monitor-examples/manage-synthetics-monitors-rest-api#use-api).

## Atributo de monitoramento sintético [#api-attributes]
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Duplo: Valor do [relatório de SLA de monitoramento sintético](/docs/synthetics/new-relic-synthetics/pages/synthetics-sla-report-aggregate-monitor-metrics), em segundos.
      </td>
    </tr>
