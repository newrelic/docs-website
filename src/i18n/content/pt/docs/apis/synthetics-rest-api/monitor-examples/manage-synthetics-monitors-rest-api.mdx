...
Para contas baseadas nos EUA (padrão), use o seguinte endpoint:
...
Para contas do [data center JP](/docs/accounts/accounts-billing/account-setup/choose-your-data-center), use o seguinte endpoint:
...
<CollapserGroup>
  ...
  <Collapser className="freq-link" id="create-monitor" title="Crie um monitor">
    Use as [APIs do NerdGraph](/docs/apis/nerdgraph/examples/synthetics-api/overview/) para gerenciar seus monitores sintéticos usando nossos runtimes mais recentes.
