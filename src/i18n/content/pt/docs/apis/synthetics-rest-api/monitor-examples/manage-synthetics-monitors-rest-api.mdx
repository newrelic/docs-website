...
Para usar a [API REST de monitoramento sintético](/docs/apis/synthetics-rest-api), você deve ter a capacidade de gerenciar o monitor Sintético e usar uma [chave de usuário](/docs/apis/rest-api-v2/getting-started/introduction-new-relic-rest-api-v2#api_key) (a chave de API REST não funcionará).
