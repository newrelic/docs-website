...
Durante o processo de criação da chave, fornecemos temporariamente a chave completa. Entretanto, uma vez que a chave é criada, apenas os primeiros 8 caracteres são exibidos na interface da chave de API .

Se você precisar recuperar a chave completa após a criação, clique nas reticências na interface da chave de API , copie o ID da chave e [use o NerdGraph para consultar a chave completa.](/docs/apis/nerdgraph/examples/use-nerdgraph-manage-license-keys-user-keys/#query-keys)
