...
<CollapserGroup>
  ...
  >
    ...
    4. Insira um novo nome de chave, selecione <DNT>**Ingest - License**</DNT> para <DNT>**Key type**</DNT>, adicione uma descrição opcional e clique em <DNT>**Save**</DNT>.<img
    ...
    5. Atualize qualquer script ou código que faça referência à chave antiga com o novo valor principal. Você pode encontrar a nova chave clicando no ícone <DNT>**...**</DNT> na mesma linha da nova chave e depois clicando em <DNT>**Copy key**</DNT>.<img
  ...
  >
    ...
    4. Insira um novo nome de chave, selecione <DNT>**Ingest - Browser**</DNT> para <DNT>**Key type**</DNT>, adicione uma descrição opcional e clique em <DNT>**Save**</DNT>.<img
         title="Screenshot of create an API page"
         alt="Screenshot of create an API page"
         src="/images/apis-and-data_screenshot-crop_create-browser-key.webp"
       />

    5. Atualize qualquer script ou código que faça referência à chave antiga com o novo valor principal. Você pode encontrar a nova chave clicando no ícone <DNT>**...**</DNT> na mesma linha da nova chave e clicando em <DNT>**Copy key**</DNT>.<img
         title="Screenshot of the copy key options"
         alt="Screenshot of the copy key options"
         src="/images/apis-and-data_screenshot-crop_copy-key.webp"
       />
  ...
  >
    ...
    4. Insira um novo nome de chave, selecione <DNT>**User**</DNT> para <DNT>**Key type**</DNT>, adicione uma descrição opcional e clique em <DNT>**Save**</DNT>.<img
         title="Screenshot of create an API page"
         alt="Screenshot of create an API page"
...
<CollapserGroup>
  ...
  >
    ...
    2. Acesse [<DNT>**one.newrelic.com/api-keys**</DNT>](https://one.newrelic.com/api-keys) (ou [<DNT>**one.eu.newrelic.com/api-keys**</DNT>](https://one.eu.newrelic.com/api-keys) para nosso data center na UE).
    3. No lado esquerdo da página, encontre a seção <DNT>**Looking for other keys?**</DNT> e clique no link do tipo de chave que você deseja girar:<img
       ...
       />
    4. Clique no ícone <DNT>**+**</DNT> para criar uma nova inserção ou chave de consulta.<img
    ...
    6. Depois que qualquer dependência externa for atualizada, você poderá excluir com segurança a chave antiga. Para remover uma chave, passe o mouse sobre ela e clique em <DNT>**Delete**</DNT>.<img
  ...
  >
    ...
    1. Log no New Relic em uma conta com permissões de administrador.
    2. Acesse [<DNT>**one.newrelic.com/api-keys**</DNT>](https://one.newrelic.com/api-keys) (ou [<DNT>**one.eu.newrelic.com/api-keys**</DNT>](https://one.eu.newrelic.com/api-keys) para nosso data center na UE).
    3. No lado esquerdo da página, encontre a seção <DNT>**Looking for other keys?**</DNT> e clique em <DNT>**REST API key**</DNT>.<img
