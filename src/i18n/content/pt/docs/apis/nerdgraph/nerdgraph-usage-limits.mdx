...
NerdGraph impõe um limite de <DoNotTranslate>**25 concurrent requests per user**</DoNotTranslate>.

A taxa de solicitações que você faz não é limitada, apenas o número de <DoNotTranslate>**concurrent**</DoNotTranslate> solicitações.
...
Podemos permitir mais de 25 solicitações simultâneas por usuário, com base no estado do sistema, mas <DoNotTranslate>**only 25 concurrent requests are guaranteed.**</DoNotTranslate>
