...
<Steps>
  <Step>
    ...
    1. Abra o explorador da API NerdGraph. A URL depende da região do data center que hospeda sua conta:

       * EUA (região padrão): <DNT>[one.newrelic.com/nerdgraph-graphiql](https://one.newrelic.com/nerdgraph-graphiql)</DNT>
