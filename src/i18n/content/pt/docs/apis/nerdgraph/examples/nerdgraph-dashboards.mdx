...
<CollapserGroup>
  ...
  <Collapser id="bulk-update-widget-links" title="Atualizar vários widgets em massa">
    Você pode atualizar links e descrições de vários widgets em uma única chamada de API:
