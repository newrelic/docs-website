...
<CollapserGroup>
  <Collapser
    ...
    title="Contas de provedores disponíveis"
  >
  ...
  <Collapser
    ...
    title="Informações específicas da conta do provedor"
  >
  ...
  <Collapser
    ...
    title="Dados de integração específicos de um provedor de nuvem específico"
  >
  ...
  <Collapser
    ...
    title="Lista de contas de nuvem habilitadas"
  >
  ...
  <Collapser
    ...
    title="Dados específicos da conta vinculada"
  >
  ...
  <Collapser
    ...
    title="Integração na nuvem habilitada para todas as contas vinculadas"
  >
  ...
  <Collapser
    ...
    title="Dados específicos de integração na nuvem para uma conta vinculada específica"
  >
...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="Vincule uma conta AWS usando CloudWatch Metric Streams"
  >
  ...
  <Collapser
    id="link-azure"
    title="Vincular uma conta do Microsoft Azure"
  >
  ...
  <Collapser
    ...
    title="Girar um token secreto do cliente do Azure em uma conta existente"
  >
  ...
  <Collapser
    id="link-gcp"
    title="Vincular um projeto do Google Cloud Platform (GCP)"
  >
  ...
  <Collapser
    ...
    title="Renomeie uma ou mais contas na nuvem"
  >
  ...
  <Collapser
    ...
    title="Habilite uma integração em uma conta na nuvem"
  >
  ...
  <Collapser
    ...
    title="Habilite uma integração em várias contas na nuvem"
  >
  ...
  <Collapser
    ...
    title="Habilite múltiplas integrações em múltiplas contas na nuvem"
  >
  ...
  <Collapser
    ...
    title="Modificar a configuração de uma integração (regiões, intervalo de sondagem, etc.)"
  >
  ...
  <Collapser
    ...
    title="Desabilitar (remover) uma integração"
  >
...
<CollapserGroup>
  <Collapser
    id="send-query-fetch"
    title="Enviar consulta para buscar dados da conta"
  >
  ...
  <Collapser
    ...
    title="Habilite a integração do AWS SQS"
  >
  ...
  <Collapser
    ...
    title="Habilite a integração em várias contas de provedores"
  >
    Se você tiver várias contas com a mesma conta de provedor, poderá ativar a mesma integração em várias contas de provedor ao mesmo tempo. Use o ID da sua conta New Relic no parâmetro `<NR_ACCOUNT_ID>` e o ID das contas do provedor no valor do parâmetro `<LINKED_CLOUD_ACCOUNT_ID_n>` .
...
<CollapserGroup>
  <Collapser
    ...
    title="Atualizar o intervalo de sondagem"
  >
...
<CollapserGroup>
  <Collapser
    ...
    title="Desative a integração SQS"
  >
