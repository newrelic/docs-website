...
<CollapserGroup>
  ...
  <Collapser id="mapping-mobile" title="Mobile">
  ...
  <Collapser id="mapping-insights" title="Insights">
  ...
  <Collapser id="mapping-browser" title="Browser">
  ...
  <Collapser id="mapping-syntehtics" title="Sintético">
  ...
  <Collapser id="mapping-infrastructure" title="A infraestrutura">
  ...
  <Collapser id="mapping-lambda" title="Sem servidor para Lambda">
    <table>
      <thead>
        <tr>
          <th style={{ width: "200px" }}>
  ...
  <Collapser id="mapping-traces" title="Traces">
    <table>
      <thead>
        <tr>
          <th style={{ width: "200px" }}>
  ...
  <Collapser id="mapping-logs" title="Registro">
    <table>
      <thead>
        <tr>
          <th style={{ width: "200px" }}>
  ...
  <Collapser id="mapping-metrics" title="Métrica">
    <table>
      <thead>
        <tr>
          <th style={{ width: "200px" }}>
...
<CollapserGroup>
  <Collapser id="type-subscription" title="Assinatura">
    <table>
      <thead>
        <tr>
          <th style={{ width: "200px" }}>
  ...
  <Collapser id="type-product" title="Produtos">
    <table>
      <thead>
        <tr>
          <th style={{ width: "200px" }}>
  ...
  <Collapser id="type-unit-measure" title="Unidade de medida">
    <table>
      <thead>
        <tr>
          <th style={{ width: "200px" }}>
...
<CollapserGroup>
  <Collapser id="example-replace" title="Crie (substitua a existente) assinatura com muitos produtos">
    ```
    mutation {
      organizationProvisioningUpdatePartnerSubscription (
        accountId: PARTNER_ACCOUNT_ID,
  ...
  <Collapser id="example-replace-logs" title="Criar (substituir a existente) assinatura por um produto - log">
    ```
    mutation {
        organizationProvisioningUpdatePartnerSubscription (
          accountId: :PARTNER_ACCOUNT_ID,
    ...
    <DNT>**Response**</DNT>: Assim que o NerdGraph receber sua solicitação e validar que ela está no formato correto, ele responderá com uma mensagem como esta. Isso não significa que sua mensagem foi processada ou aplicada com êxito; mas foi validado para estar no formato correto e colocado na fila para processamento.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        `Curl` formato de solicitação
      </td>

      <td>
        Para fazer uma solicitação `curl` ao NerdGraph, o formato será diferente da API Partnership:
