...
<CollapserGroup>
  ...
  >
    ...
    * <DoNotTranslate>**Built-in suggestions.**</DoNotTranslate> Cada [tipo de evento](/docs/using-new-relic/welcome-new-relic/getting-started/glossary#event) vem com seu próprio conjunto de atributos recomendados. Estes são atributos escolhidos pela New Relic por sua importância e popularidade.

    * <DoNotTranslate>**Usage-based suggestions.**</DoNotTranslate> Algumas sugestões de atributo são baseadas nas consultas que têm sido frequentemente utilizadas pela sua conta. Essas sugestões podem incluir atributo personalizado.

    * <DoNotTranslate>**Role restriction.**</DoNotTranslate> [usuário restrito](/docs/accounts/accounts/roles-permissions/users-roles) não tem acesso a sugestões de facetas relacionadas à conta.
