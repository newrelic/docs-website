...
<CollapserGroup>
  <Collapser
    id="location-field"
    title="Definir campos de localização"
  >
  ...
  <Collapser
    id="optional-fields"
    title="Definir campos opcionais"
  >
    ...
    * TLS_VALIDATION: Verifica a [validade](/docs/synthetics/synthetic-monitoring/using-monitors/add-edit-monitors/#simple) da cadeia de certificados SSL.

    Para [monitor de navegador simples](#create-simple-browser):
    ...
    * SCRIPT_LANGUAGE: O idioma usado em seu monitor. "JAVASCRIPT" é o único valor aceito.
    ...
    * SCRIPT_LANGUAGE: O idioma usado em seu monitor. "JAVASCRIPT" é o único valor aceito.
    ...
    Para [monitorar o script com do navegador](#create-scripted-browser):
    ...
    * DAYS_UNTIL_EXPIRATION: Notifica quando você precisa atualizar seu certificado. Por exemplo, se você desejasse uma notificação 30 dias antes da expiração do certificado, você inseriria 30.

    Para todos os monitores:

    * APDEX_TARGET: o destino Apdex do monitor usado para preencher relatórios de SLA. O padrão é 7 segundos (7.000 ms).
  </Collapser>
</CollapserGroup>
...
<CollapserGroup>
  ...
  >
    Você pode consultar seus monitores Sintético para obter informações de status atuais sobre seus dados ou detalhes sobre a configuração monitor . Alguns exemplos de consulta incluem:
  ...
  <Collapser
    id="private-examples"
    title="Consulta localização privada"
  >
  ...
  <Collapser
    ...
    title="Consultar credenciais seguras"
  >
  ...
  <Collapser
    ...
    title="Scriptdo monitor de consulta"
  >
    Recupere o script usado em uma API com script ou monitore o script do navegador. Outros tipos de monitor retornarão um erro.
  ...
  <Collapser
    ...
    title="Etapas do monitor de consulta"
  >
  ...
  <Collapser
    ...
    title="Consulta para mapear o ID do monitor para o GUID da entidade"
  >
...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="Crie um monitor de navegador simples"
  >
    Monitor de navegador simples usa instância do Chrome para imitar visitas de clientes. Aqui está um exemplo para criar um no NerdGraph:
  ...
  <Collapser
    ...
    title="Crie um navegador com script"
  >
    [monitor de navegador com script](/docs/synthetics/synthetic-monitoring/scripting-monitors/introduction-scripted-browser-monitors) são interações mais complexas com suas páginas e aplicativos. Aqui está um exemplo para criar um no NerdGraph:
  ...
  <Collapser
    ...
    title="Crie um monitor de API com script"
  >
  ...
  <Collapser
    id="create-step"
    title="Crie um monitor de passos"
  >
    O monitor de etapas fornece um monitor baseado em navegador de várias etapas sem código. Aqui está um exemplo para criar um no NerdGraph:
  ...
  <Collapser
    ...
    title="Crie um monitor de verificação de certificado"
  >
  ...
  <Collapser
    ...
    title="Crie um monitor de links quebrados"
  >
...
<CollapserGroup>
  <Collapser
    id="update-ping"
    title="Atualizar um monitor de ping"
  >
  ...
  <Collapser
    ...
    title="Atualize um monitor de navegador simples"
  >
    Para atualizar um monitor de navegador simples (incluindo a capacidade de atualizar a versão de tempo de execução), use isto:
  ...
  <Collapser
    ...
    title="Atualizar um script com do monitor do navegador"
  >
    Para atualizar um script com do monitor do navegador (incluindo a capacidade de atualizar a versão de tempo de execução), use isto:
  ...
  <Collapser
    id="update-API-test"
    title="Atualizar um monitor de teste de API"
  >
  ...
  <Collapser
    id="update-step"
    title="Atualizar um monitor de etapas"
  >
  ...
  <Collapser
    ...
    title="Atualizar um monitor de verificação de certificado"
  >
  ...
  <Collapser
    ...
    title="Atualizar um monitor de links quebrados"
  >
  ...
  <Collapser
    ...
    title="Atualizar o tempo de execução de um monitor"
  >
    Você pode usar o exemplo abaixo para atualizar um navegador simples, uma API com script ou monitorar o script do navegador para os novos tempos de execução do Chrome 100+ ou Node.js 16.10. O exemplo a seguir atualiza um script monitor de browser com para o novo tempo de execução do tempo de execução legado.

    * Para atualizar um monitor de navegador simples usando o exemplo abaixo, altere a mutação para `syntheticsUpdateSimpleBrowserMonitor` em vez de `syntheticsUpdateScriptBrowserMonitor`.
...
<CollapserGroup>
  <Collapser
    id="private-location"
    title="Crie uma localização privada"
  >
    ```
    mutation{
  ...
  <Collapser
    id="private-location"
    title="Atualizar uma localização privada"
  >
    ```
    mutation {
  ...
  <Collapser
    ...
    title="Excluir um local privado"
  >
    ```
    mutation {
  ...
  <Collapser
    ...
    title="Limpar uma fila de trabalhos de localização privada"
  >
...
<CollapserGroup>
  <Collapser
    ...
    title="Crie uma credencial segura"
  >
    ```
    mutation {
  ...
  <Collapser
    id="update-secure"
    title="Atualizar uma credencial segura"
  >
    ```
    mutation {
  ...
  <Collapser
    id="secure-credential"
    title="Excluir uma credencial segura"
  >
    ```
    mutation {
...
Monitorar período de inatividade permite especificar horários em que seu Sintético deve parar de funcionar. Fornecemos diferentes trechos que demonstram como agendar o período de inatividade do monitor para o seu Sintético. Você precisa atualizar esses trechos para especificar o fuso horário, os horários de início e de término. Para saber mais sobre quando você pode agendar o período de inatividade do monitor, confira nosso documento [Desativar monitoramento durante horários de manutenção programados](docs/synthetics/synthetic-monitoring/using-monitors/monitor-downtimes-disable-monitoring-during-scheduled-maintenance-times/). Para encontrar valores de fuso horário, consulte [o banco de dados tz de fusos horários](https://en.wikipedia.org/wiki/List_of_tz_database_time_zones). Por exemplo, América/Los Angeles usaria a abreviatura PDT.

<CollapserGroup>
  <Collapser
    id="create-once-downtime"
    title="Crie um monitor de período de inatividade que seja executado uma vez"
  >
    ```
    mutation {
  ...
  <Collapser
    ...
    title="Crie um monitor de período de inatividade que seja executado diariamente"
  >
    ```
    mutation {
  ...
  <Collapser
    ...
    title="Crie um monitor de período de inatividade que seja executado semanalmente"
  >
    ```
    mutation {
  ...
  <Collapser
    ...
    title="Crie um período de inatividade do monitor que seja executado mensalmente"
  >
    ```
    mutation {
  ...
  <Collapser
    id="update-downtime"
    title="Atualizar um período de inatividade do monitor"
  >
    ```
    mutation {
  ...
  <Collapser
    id="delete-downtime"
    title="Excluir um período de inatividade do monitor"
  >
    ```
    mutation {
