...
<CollapserGroup>
  ...
  <Collapser
    id="downtime-query"
    title="Consultar monitor período de inatividade"
  >
  ...
  <Collapser
    ...
    title="Consulta para recuperar o status de todos os testes de atualização em tempo de execução"
  >
  ...
  <Collapser
    ...
    title="Consulta para recuperar o status de um teste de atualização em tempo de execução por ID monitor"
  >
...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="Crie um monitor de browser simples"
  >
  ...
  <Collapser
    ...
    title="Crie um browser com script"
  >
...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="Atualize um monitor de browser simples"
  >
  ...
  <Collapser
    ...
    title="Atualizar um script com do monitor do browser"
  >
