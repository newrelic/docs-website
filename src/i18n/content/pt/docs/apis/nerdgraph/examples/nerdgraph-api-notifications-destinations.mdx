---
title: 'Tutorial NerdGraph: destinos de inteligência aplicada'
tags:
  - Notifications
...
Além de gerenciar seus [destinos de inteligência aplicada na interface](/docs/alerts-applied-intelligence/notifications/destinations), você pode utilizar nossa API NerdGraph.
...
<CollapserGroup>
  <Collapser
    ...
    title="Listando todos os destinos de uma conta"
  >
  ...
  <Collapser
    id="paginate"
    title="Paginando destinos com paginação de cursor"
  >
  ...
  <Collapser
    ...
    title="Encontre todos os destinos por nome"
  >
  ...
  <Collapser
    id="find-by-id"
    title="Encontre o destino por ID"
  >
  ...
  <Collapser
    id="find-by-type"
    title="Encontre todos os destinos por tipo"
  >
