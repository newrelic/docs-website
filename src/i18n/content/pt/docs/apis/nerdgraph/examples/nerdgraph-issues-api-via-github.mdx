---
title: 'Tutorial Nerdgraph: API de consulta de problemas e incidentes'
...
<CollapserGroup>
  ...
  >
    Observe que o número máximo de problemas que podem ser retornados por meio da paginação é definido pelo NRQL [LIMIT MAX](/docs.newrelic.com/docs/nrql/nrql-syntax-clauses-functions/#sel-limit) e a filtragem será necessária caso esse limite seja excedido.
