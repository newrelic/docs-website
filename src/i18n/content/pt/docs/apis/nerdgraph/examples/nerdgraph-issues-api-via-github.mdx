---
title: 'Tutorial Nerdgraph: APIde consulta de problemas e incidentes'
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Consulte [a visão geral da inteligência aplicada](/docs/alerts-applied-intelligence/applied-intelligence/incident-intelligence/get-started-incident-intelligence/) para aprender sobre os ambientes.
      </td>
    </tr>
...
<CollapserGroup>
  ...
  <Collapser
    id="cursor"
    title="Paginação do cursor"
  >
    Para paginar seus dados, você deve incluir o campo `nextCursor` em sua consulta inicial.

    Com a paginação do cursor, você continua fazendo solicitações por meio dos dados de resultado até que o `nextCursor` retornado da resposta retorne vazio. Uma resposta vazia significa que você chegou ao final dos resultados.
  ...
  <Collapser
    id="find"
    title="Encontre problemas por ID"
  >
...
<CollapserGroup>
  <Collapser
    ...
    title="Listar evento de problemas"
  >
...
<CollapserGroup>
  ...
  >
    ...
    Com a paginação do cursor, você continua fazendo uma solicitação através dos dados do resultado até que o nextCursor retornado da resposta retorne vazio. Isso significa que você chega ao fim de seus resultados.
  ...
  <Collapser
    ...
    title="Encontre incidentes por ID do incidente"
  >
...
<CollapserGroup>
  <Collapser
    ...
    title="Listar evento de incidente"
  >
  ...
  <Collapser
    ...
    title="Filtrar evento de incidente"
  >
    ### Paginação do cursor
...
<CollapserGroup>
  <Collapser
    className="freq-link"
    id="ackissues"
    title="Reconhecer ou não reconhecer problemas"
  >
    ### Solicitar
...
<CollapserGroup>
  <Collapser
    className="freq-link"
    id="listallissues"
    title="Exemplo: liste todos os problemas"
  >
