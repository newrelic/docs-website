...
* Administrador de produtos da organização
...
1. [Encontre os IDs de permissão necessários para Scorecards](#retrieve-organization-scoped-capabilities)
2. [Recupere o ID da sua organização](#retrieve-your-organization-id)
3. [Crie a função personalizada para administrador de Scorecards](#create-custom-role)
...
* Você precisa ser um Administrador de produto da organização para criar uma função personalizada.
...
<CollapserGroup>
  <Collapser id="retrieve-organization-scoped-capabilities" title="Encontre os IDs de permissão necessários para Scorecards">
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Liste os IDs para o recurso identificado usando a consulta 
  ...
  <Collapser id="add-custom-role-to-a-user-group" title="Adicionar função personalizada a um grupo de usuários">
    ...
    Você pode usar a consulta `customerAdministration` para recuperar a lista de IDs de grupo.
