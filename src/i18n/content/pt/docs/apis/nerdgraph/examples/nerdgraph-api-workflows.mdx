...
Para obter o ID do fluxo de trabalho, acesse a tabela de fluxo de trabalho e clique no ícone <DoNotTranslate>**<Icon name="fe-more-horizontal"/>**</DoNotTranslate> no final da linha. Em seguida, escolha <DoNotTranslate>**Copy workflow id to clipboard**</DoNotTranslate>.
