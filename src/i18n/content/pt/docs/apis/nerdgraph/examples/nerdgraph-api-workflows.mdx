---
title: 'Tutorial NerdGraph: Criar e gerenciar fluxo de trabalho de inteligência aplicada'
tags:
...
Para obter inteligência aplicada da New Relic, você pode criar e gerenciar [fluxo de trabalho](/docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows) usando nossa API NerdGraph.
...
Ao atualizar um fluxo de trabalho, observe que os únicos atributos obrigatórios que você precisa fornecer são o ID do fluxo de trabalho e o ID da conta. O resto é opcional. Por exemplo, você só precisará fornecer o nome se pretender apenas atualizá-lo.

Para obter o ID do fluxo de trabalho, acesse a tabela de fluxo de trabalho e clique em <DoNotTranslate>**...**</DoNotTranslate> no final da linha. Em seguida, escolha <DoNotTranslate>**Copy workflow id to clipboard**</DoNotTranslate>.

Aqui está um exemplo de atualização de um fluxo de trabalho:
