---
title: 'Tutorial NerdGraph: Alerta canal de notificação'
tags:
  - Alerts
...
<CollapserGroup>
  <Collapser
    ...
    title="Listar todos os canais de notificação de uma conta"
  >
  ...
  <Collapser
    id="paginate"
    title="Paginar pelo canal de notificação com paginação por cursor"
  >
  ...
  <Collapser
    id="find-by-id"
    title="Encontre um canal de notificação específico por ID"
  >
  ...
  <Collapser
    ...
    title="Liste o canal de notificação com suas políticas associadas"
  >
...
<CollapserGroup>
  <Collapser
    ...
    title="Crie um canal de notificação por e-mail"
  >
  ...
  <Collapser
    ...
    title="Crie um canal de notificação do OpsGenie"
  >
  ...
  <Collapser
    ...
    title="Crie um canal de notificação PagerDuty"
  >
  ...
  <Collapser
    ...
    title="Crie um canal de notificação no Slack"
  >
  ...
  <Collapser
    ...
    title="Crie um canal de notificação VictorOps"
  >
  ...
  <Collapser
    ...
    title="Crie um canal de notificação de Webhook"
  >
  ...
  <Collapser
    ...
    title="Crie um canal de notificação xMatters"
  >
...
<CollapserGroup>
  <Collapser
    ...
    title="Atualizar um canal de notificação por e-mail"
  >
  ...
  <Collapser
    ...
    title="Atualizar um canal de notificação do OpsGenie"
  >
  ...
  <Collapser
    ...
    title="Atualizar um canal de notificação do PagerDuty"
  >
  ...
  <Collapser
    ...
    title="Atualizar um canal de notificação do Slack"
  >
  ...
  <Collapser
    ...
    title="Atualizar um canal de notificação VictorOps"
  >
  ...
  <Collapser
    ...
    title="Atualizar um canal de notificação do Webhook"
  >
  ...
  <Collapser
    ...
    title="Atualizar um canal de notificação xMatters"
  >
