...
* <DNT>**`entityGuid`**</DNT>: o GUID da [entidade](/docs/service-level-management/create-slm#sli-entity) (por exemplo, serviço <InlinePopover type="apm" />, aplicativo de browser, etc.) à qual você deseja relacionar este SLI. Na interface, você pode encontrar esse GUID na página da entidade, em <DNT>**See metadata and manage tags**</DNT>.
