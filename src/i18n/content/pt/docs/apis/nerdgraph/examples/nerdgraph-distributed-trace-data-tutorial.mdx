---
title: 'Tutorial do NerdGraph: Visualizando detalhes distributed trace'
tags:
  - APIs
  - NerdGraph
  - Examples
...
<CollapserGroup>
  ...
  <Collapser
    id="trace-data"
    title="Consulta span dados de relacionamento"
  >
  ...
  <Collapser
    id="entity-data"
    title="Consultar dados da entidade em um trace"
  >
