...
<Callout variant="caution">
  Qualquer pessoa com os URLs dashboard ou do gráfico ao vivo pode visualizar todas as informações do dashboard. Compartilhe informações com cuidado e de acordo com as políticas e procedimentos internos da sua empresa.
</Callout>
