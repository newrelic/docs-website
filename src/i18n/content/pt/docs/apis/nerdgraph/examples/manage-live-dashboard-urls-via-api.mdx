...
Com o [gerenciamento de acesso configurado](/docs/query-your-data/explore-query-data/dashboards/share-dashboards-publicly/#access-management) necessário, você pode criar, gerenciar e revogar URLs de dashboard em tempo real acessíveis publicamente usando consultas e mutações no [NerdGraph](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph). Você também pode fazer isso a partir da [interface do New Relic](/docs/query-your-data/explore-query-data/dashboards/share-dashboards-publicly).
...
<CollapserGroup>
  ...
  <Collapser id="create-dashboard-url-with-psswd-nerdgraph" title="Crie uma URL com proteção por senha">
    ...
    * Selecione quaisquer outros campos que você deseja na resposta.
    ...
    O `uuid` é o ID do dashboard compartilhado. Você pode usá-lo para [atualizar](#update-dashboard-url-nerdgraph) ou [revogar](revoke-dashboard-url-nerdgraph) a URL do dashboard compartilhado pelo NerdGraph. Para compartilhar o dashboard com usuários externos, copie a URL e a senha da resposta. As senhas não podem ser recuperadas posteriormente. Se você perdê-la, basta [redefinir a senha](#reset-password-dashboard-url-nerdgraph) e compartilhá-la novamente com os usuários. Siga nossas [práticas recomendadas de gerenciamento de senhas](/docs/query-your-data/explore-query-data/dashboards/share-dashboards-publicly/#password-management) para gerenciar a senha com segurança.
  </Collapser>

  <Collapser id="update-dashboard-url-nerdgraph" title="Atualizar duração de expiração dashboard ao vivo">
    Certifique-se de ter as [permissões](/docs/query-your-data/explore-query-data/dashboards/share-dashboards-publicly/#configure-roles) para modificar a configuração do dashboard compartilhado.
  ...
  <Collapser id="enable-password-dashboard-url-nerdgraph" title="Habilitar proteção por senha para o URL ativo">
    Certifique-se de ter as [permissões](/docs/query-your-data/explore-query-data/dashboards/share-dashboards-publicly/#configure-roles) para modificar a configuração do dashboard compartilhado. Para habilitar a proteção por senha para uma URL de dashboard ao vivo:
    ...
    * Selecione quaisquer outros campos que você deseja na resposta.
    ...
    Após habilitar a senha para os dashboards compartilhados, você precisa compartilhar a senha com os usuários. Copie e salve a senha, pois você não poderá recuperá-la mais tarde. Se você perdê-la, basta [redefinir a senha](#reset-password-dashboard-url-nerdgraph) e compartilhá-la novamente com os usuários. Siga nossas [práticas recomendadas de gerenciamento de senhas](/docs/query-your-data/explore-query-data/dashboards/share-dashboards-publicly/#password-management) para gerenciar a senha com segurança.
  </Collapser>

  <Collapser id="disable-password-dashboard-url-nerdgraph" title="Desabilitar a proteção por senha para o URL ativo">
    Certifique-se de ter as [permissões](/docs/query-your-data/explore-query-data/dashboards/share-dashboards-publicly/#configure-roles) para modificar a configuração do dashboard compartilhado. Para desativar a proteção por senha de um URL de dashboard ao vivo:
  ...
  <Collapser id="reset-password-dashboard-url-nerdgraph" title="Redefinir a senha para o URL ativo">
    Certifique-se de ter as [permissões](/docs/query-your-data/explore-query-data/dashboards/share-dashboards-publicly/#configure-roles) para modificar a configuração do dashboard compartilhado. Para redefinir a senha de uma URL de dashboard ao vivo:
    ...
    * `password`: Selecione esta opção para obter a nova senha dashboard ativo na resposta.
    ...
    Após redefinir a senha dos dashboards compartilhados, você precisa compartilhar a nova senha com os usuários. Copie e salve a senha, pois você não poderá recuperá-la mais tarde. Se você o perder, basta redefini-lo novamente. Siga nossas [práticas recomendadas de gerenciamento de senhas](/docs/query-your-data/explore-query-data/dashboards/share-dashboards-publicly/#password-management) para gerenciar a senha com segurança.
  </Collapser>

  <Collapser id="revoke-dashboard-url-nerdgraph" title="Revogar uma URL ativa">
    Com base nas [permissões](/docs/query-your-data/explore-query-data/dashboards/share-dashboards-publicly/#configure-roles) que você tem, você pode revogar apenas as URLs que você criou, ou todas as URLs criadas por usuários na conta. Para revogar uma URL de dashboard compartilhado:
  ...
  <Collapser id="list-dashboard-url-nerdgraph" title="Listar todos os URLs compartilhados">
    Com base nas [permissões](/docs/query-your-data/explore-query-data/dashboards/share-dashboards-publicly/#configure-roles) que você possui, você pode recuperar a lista de URLs que criou, ou todas as URLs criadas por usuários na conta. Para obter a lista de URLs de dashboards compartilhados:
...
<DocTiles>
  <DocTile title="Introdução ao compartilhamento público" path="/docs/query-your-data/explore-query-data/dashboards/get-started-sharing-dashboards-publicly">
    Introdução ao compartilhamento público de dashboards e gráficos, com detalhes de disponibilidade e preços.
  </DocTile>

  <DocTile title="Compartilhar o dashboard publicamente" path="/docs/query-your-data/explore-query-data/dashboards/share-dashboards-publicly">
    Compartilhe dashboards inteiros com visualizadores externos via URLs ativas, com proteção por senha e controles de expiração.
  </DocTile>
</DocTiles>