...
Para começar de forma fácil, use nosso [explorador da API NerdGraph](/docs/apis/nerdgraph/get-started/nerdgraph-explorer) para criar e editar informações de equipes. As definições estão disponíveis no NerdGraph para cada um dos campos nos exemplos abaixo. Se precisar de ajuda para usar o IDE GraphiQL, consulte nosso [tutorial do explorador da API NerdGraph](/docs/apis/nerdgraph/get-started/nerdgraph-explorer/). Se você precisar configurar permissões personalizadas para gerenciar Teams, consulte [Criar Funções Personalizadas para Teams](/docs/apis/nerdgraph/examples/nerdgraph-teams-custom-role-tutorial).
...
* `managers`: uma lista de GUIDs de entidades de usuário que são gerentes ou o principal ponto de contato desta equipe. Gerentes devem ser membros da equipe. Para encontrar GUIDs de usuário, consulte [Recuperar o ID do usuário](#user-id).
* `onCallMembers`: Uma lista de `OnCallMember` entidades representando contatos fora do horário normal de trabalho. Cada entidade requer um campo de ID contendo o GUID da entidade do usuário. Os membros de plantão devem ser membros da equipe. Para encontrar GUIDs de usuário, consulte [Recuperar o ID do usuário](#user-id).
...
* `onCallMembers` aceita uma lista de entidades `OnCallMember`. Cada entidade requer um campo de ID contendo o GUID da entidade do usuário. Para encontrar GUIDs de usuário, consulte [Recuperar o ID do usuário](#user-id).
