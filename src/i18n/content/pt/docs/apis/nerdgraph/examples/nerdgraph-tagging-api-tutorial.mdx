...
4. Para o agente <InlinePopover type="apm" />, é necessário reiniciar após adicionar uma nova tag.
...
4. Para o agente <InlinePopover type="apm" />, é necessário reiniciar após alterar a tag.
