---
title: 'Tutorial do NerdGraph: Gerenciar grupos e usuários'
tags:
  - APIs
  - NerdGraph
...
* [Tipo de usuário](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type): usuário core ou usuário full platform
* [Função](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts/#roles): <DNT>**Authentication Domain Manager**</DNT>
...
Quando terminar, se já houver usuários no grupo que você criou e esse grupo tiver acesso a pelo menos uma função e conta, eles deverão ter acesso em alguns minutos (embora para [contas do New Relic das regiões EU e JP](/docs/using-new-relic/welcome-new-relic/get-started/our-eu-us-region-data-centers), isso possa levar cerca de 20 minutos). Se os seus usuários ainda não estiverem nesse grupo (o que seria verdade se você acabou de criar um novo grupo), você pode [adicionar usuários a esse grupo](/docs/accounts/accounts-billing/new-relic-one-user-management/account-user-mgmt-tutorial#add-users).
...
## Conceder acesso a um grupo ou usuário [#grant-access]
...
## Atualizar concessões de acesso [#update-grants]
...
## Revogar concessões de grupo ou usuário [#revoke-grants]
