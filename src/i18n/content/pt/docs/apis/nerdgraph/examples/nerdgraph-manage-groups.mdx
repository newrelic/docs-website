...
* Você deve ser um usuário do [nosso modelo de usuário mais recente](/docs/accounts/original-accounts-billing/original-users-roles/overview-user-models#determine-user-model). Outros requisitos relacionados a permissões:
  ...
  * [Configurações de administração](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts#admin-settings) necessárias:
...
* Se ainda não o fez, sugerimos que consulte a interface
...
2. [Opcional: Crie um novo grupo](#create-group):

   <DoNotTranslate>**Not available if using SCIM provisioning.**</DoNotTranslate>
...
* <DoNotTranslate>**Organization manager setting**</DoNotTranslate>
...
* <DoNotTranslate>**Group admin**</DoNotTranslate>
