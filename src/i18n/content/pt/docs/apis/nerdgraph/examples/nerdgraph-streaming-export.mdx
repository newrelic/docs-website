...
4. Use
   ...
   <DNT>**Direct PUT or other sources**</DNT>
...
2. Crie uma função para uma conta da AWS e selecione
   ...
   <DNT>**for another AWS account**</DNT>
...
1. Na coluna da esquerda, vá para
   ...
   <DNT>**Shared access policies**</DNT>
...
5. Clique na política criada e copie o
   ...
   <DNT>**Connection string–primary key**</DNT>
