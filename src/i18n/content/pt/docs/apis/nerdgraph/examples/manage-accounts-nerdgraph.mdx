---
title: 'Tutorial do NerdGraph: visualizar, criar e renomear contas'
tags:
  - APIs
  - NerdGraph
  - Examples
...
Como alternativa ao [uso da interface New Relic](/docs/accounts/accounts-billing/account-structure/add-accounts), você pode usar [o NerdGraph](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph) para visualizar as contas da sua organização, criar contas e renomear contas.
...
Atualmente você não pode excluir contas usando NerdGraph. Em vez disso, tente estas opções relacionadas:

* [Downgrade ou cancelamento de contas](/docs/accounts/accounts-billing/account-setup/downgradecancel-account)
* [Remover uma entidade monitor](/docs/apis/nerdgraph/examples/nerdgraph-entities-api-tutorial/#delete-entities)