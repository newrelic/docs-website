---
title: 'Tutorial NerdGraph: Topologia para correlação de incidentes de inteligência aplicada'
...
Este tutorial explicará como usar nossa API NerdGraph para configurar sua topologia. A configuração da topologia permite que suas [decisões de inteligência aplicada](/docs/alerts-applied-intelligence/applied-intelligence/incident-intelligence/change-applied-intelligence-correlation-logic-decisions) correlacionem melhor o incidente.
...
* [O que são decisões de inteligência aplicada](/docs/alerts-applied-intelligence/applied-intelligence/incident-intelligence/change-applied-intelligence-correlation-logic-decisions) e [como funciona a correlação de topologia](/docs/alerts-applied-intelligence/applied-intelligence/incident-intelligence/change-applied-intelligence-correlation-logic-decisions/#topology).
