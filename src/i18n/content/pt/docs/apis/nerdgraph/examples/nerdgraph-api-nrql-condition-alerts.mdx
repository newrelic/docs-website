...
Este documento cobre o seguinte:
...
* [Atualizar mutações](#update-mutations)
* [Listar e filtrar condições NRQL](#filtering)
* [Consulta de condição NRQL singular](#singular-condition)
* [Crie uma descrição](#description)
* [Excluir condições](#delete-conditions)
...
<CollapserGroup>
  <Collapser
    id="pagination"
    title="Usar paginação de cursor"
  >
  ...
  <Collapser
    id="specific-fields"
    title="Solicitar campos específicos do tipo"
  >
