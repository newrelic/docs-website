    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Os IDs de conta de destino para avaliação de regras. A consulta NRQL é executada em cada conta especificada nesta lista para avaliar a conformidade.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            IDs de contas auxiliares a serem incluídos durante a execução da consulta. Permite consultas NRQL entre contas ao unir dados dessas contas secundárias com cada conta de destino principal.
          </td>
        </tr>
