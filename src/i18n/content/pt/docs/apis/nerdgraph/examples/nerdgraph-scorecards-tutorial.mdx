...
<CollapserGroup>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            A conta onde a entidade será armazenada.
          </td>
        </tr>
      </tbody>
    </table>
  ...
  <Collapser id="add-rule" title="Crie uma regra">
    Você pode criar uma nova regra para um Scorecard usando a mutação `entityManagementCreateScorecardRule` .
...
<CollapserGroup>
  ...
  <Collapser id="fetch-rule" title="Recuperar detalhes do Scorecard associados a uma regra">
    Você pode recuperar os detalhes do Scorecard associados a uma regra específica recuperando primeiro o ID da coleção que contém a regra usando a consulta `FindRuleOwnerCollections` e, em seguida, recuperando os detalhes dos pais da coleção usando a consulta `FetchCollectionParent` .
    ...
    Você pode recuperar os detalhes dos pais da coleção usando a consulta `FetchCollectionParent` , que requer o ID da coleção obtido da resposta `FindRuleOwnerCollections` .
