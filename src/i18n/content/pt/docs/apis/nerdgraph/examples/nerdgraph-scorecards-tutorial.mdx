    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            The account IDs targeted for rule evaluation. The NRQL query executes against each account specified in this list to assess compliance.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Auxiliary account IDs to include during query execution. Enables cross-account NRQL queries by joining data from these secondary accounts with each primary target account.
          </td>
        </tr>
