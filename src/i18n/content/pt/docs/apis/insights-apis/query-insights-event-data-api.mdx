...
<Callout variant="tip">
  <DoNotTranslate>**This API is no longer the preferred way to query New Relic data.**</DoNotTranslate> Por favor, use [o NerdGraph](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph/) para fazer isso.
</Callout>

## Requisitos e recomendações [#requirements]

<DoNotTranslate>**This API is no longer the preferred way to query New Relic data.**</DoNotTranslate> Para melhores resultados, você deve usar [o NerdGraph](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph) para consultar os dados.
...
Ao [criar ou editar uma chave de consulta](#register), você verá um exemplo de consulta curl que pode usar como modelo. A consulta de exemplo não funcionará a menos que você siga estas regras de consulta:
...
Você pode usar <DoNotTranslate>**Powershell**</DoNotTranslate> para consultar evento via API:
