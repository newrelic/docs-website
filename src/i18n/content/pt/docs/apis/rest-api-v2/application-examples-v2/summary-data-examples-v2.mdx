...
New Relic fornece informações resumidas para o aplicativo como um <DoNotTranslate>**three- to four-minute average**</DoNotTranslate> contínuo.
...
<table>
  ...
  <tbody>
    <tr>
      <td>
        Para <DoNotTranslate>**all**</DoNotTranslate> aplicativo para sua conta
      </td>
    ...
    <tr>
      <td>
        Para um aplicativo <DoNotTranslate>**specific**</DoNotTranslate>
      </td>
    ...
    <tr>
      <td>
        Ao usar o <DoNotTranslate>**app ID**</DoNotTranslate>
      </td>
...
A New Relic fornece informações resumidas para transação principal como um <DoNotTranslate>**ten minute average**</DoNotTranslate> contínuo.
...
<table>
  ...
  <tbody>
    <tr>
      <td>
        Por <DoNotTranslate>**all**</DoNotTranslate> transação principal para sua conta
      </td>
    ...
    <tr>
      <td>
        Para uma transação principal <DoNotTranslate>**specific**</DoNotTranslate>
      </td>
    ...
    <tr>
      <td>
        Ao usar o <DoNotTranslate>**key transaction ID**</DoNotTranslate>
      </td>
