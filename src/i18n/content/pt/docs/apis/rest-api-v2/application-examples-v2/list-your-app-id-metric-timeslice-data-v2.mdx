...
Para visualizar o ID de um aplicativo específico se você souber o nome, substitua `$NAME` pelo nome no seguinte comando:
...
Filtre a saída do nome da métrica para retornar uma lista menor, especificando o filtro <DoNotTranslate>**name=**</DoNotTranslate> desta forma:
