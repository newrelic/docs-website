...
## Listar todos os IDs do aplicativo [#view_all_app_id]
...
## Listar o ID do aplicativo por nome [#view_single_app_id]
...
## Diretrizes para listagem de nomes métrica [#name_list_guidelines]
...
## Liste nomes de métricas para seu aplicativo [#view_app_metrics_names]
...
## Obtenha os valores de dados da métrica de fração de tempo do seu aplicativo [#app_metric_data_values]
...
<CollapserGroup>
  <Collapser
    ...
    title="Um nome de métrica, vários valores"
  >
  ...
  <Collapser
    id="multiple-same-name"
    title="Vários nomes de métricas, valores individuais"
  >
