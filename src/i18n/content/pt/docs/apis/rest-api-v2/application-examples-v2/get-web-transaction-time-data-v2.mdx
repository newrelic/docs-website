...
Se o seu gráfico <DNT>**Web transaction time**</DNT> mostrar a categoria genérica <DNT>**Database**</DNT> , não use esses cálculos. Em vez disso, use os cálculos [do banco de dados](#database) .
