...
* Seu ID do aplicativo New Relic (do URL que seu navegador mostra na interface do usuário do APM ou na [interface do usuário do API Explorer](/docs/apis/api-explorer-examples-metric-data#app_id))

## Fórmula [#avg-error-time-formula]

A porcentagem média aparece acima do gráfico <DoNotTranslate>**Error rate**</DoNotTranslate> na [página<DoNotTranslate>**Summary**</DoNotTranslate> ](/docs/apm/applications-menu/monitoring/apm-overview-page)do seu aplicativo. A New Relic usa esta fórmula para calculá-lo:
...
Para obter o <DoNotTranslate>**error count:**</DoNotTranslate>
...
Para obter o <DoNotTranslate>**HttpDispatcher call count**</DoNotTranslate> (aplicativo da web):
...
Para obter o <DoNotTranslate>**OtherTransaction call count**</DoNotTranslate> (aplicativo não web):
