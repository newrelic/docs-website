...
Você pode usar a API REST do New Relic (v2) para obter as taxas médias de transferência para seu aplicativo, incluindo taxas de transferência [de aplicativos da web](/docs/using-new-relic/welcome-new-relic/getting-started/glossary#transaction) e [de aplicativos não-web](/docs/using-new-relic/welcome-new-relic/getting-started/glossary#non-web-transaction) . Esses valores aparecem no [gráfico de taxas de transferência](/docs/apm/applications-menu/monitoring/apm-overview-page-view-transaction-apdex-usage-data#overview_charts) na página <DNT>**APM Summary**</DNT> do seu aplicativo:
...
2. Clique no título
   ...
   do aplicativo e selecione sua opção.
