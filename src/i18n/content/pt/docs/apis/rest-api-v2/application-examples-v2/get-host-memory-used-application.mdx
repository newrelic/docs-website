...
Você pode usar a API REST do New Relic (v2) para obter o uso médio de memória para seu aplicativo em um único host. Esse valor aparece na [página <DoNotTranslate>**Summary**</DoNotTranslate> do APM](/docs/apm/applications-menu/monitoring/apm-overview-page) na tabela <DoNotTranslate>**Hosts**</DoNotTranslate> , na coluna denominada <DoNotTranslate>**Memory**</DoNotTranslate> ou no gráfico correspondente.
...
1. Selecione
   ...
   <DoNotTranslate>[**Application Hosts > GET Metric Data**](https://rpm.newrelic.com/api/explore/application_hosts/data)</DoNotTranslate>
...
Para obter o uso médio de memória para seu aplicativo, use um comando semelhante ao do exemplo anterior, mas remova a referência a <DoNotTranslate>**hosts**</DoNotTranslate> e `$HOST_ID`. Substitua `$APP_ID` e `$API_KEY` pelo [ID do aplicativo](/docs/apm/apis/requirements/identification-code) e pela [chave de API](/docs/apis/rest-api-v2/getting-started/introduction-new-relic-rest-api-v2#api_key).
...
1. Selecione
   ...
   <DoNotTranslate>[**Applications > GET Metric Data**](https://rpm.newrelic.com/api/explore/applications/data)</DoNotTranslate>
