...
Para alterar o alias do nome do aplicativo da API REST New Relic (v2), use este comando. Você também pode alterar o alias do aplicativo no [API Explorer](/docs/apis/rest-api-v2/api-explorer-v2/getting-started-new-relics-api-explorer) da New Relic selecionando [<DoNotTranslate>**Applications > Update**</DoNotTranslate>](https://rpm.newrelic.com/api/explore/applications/update).
