...
Para alterar o alias do nome do aplicativo a partir da API REST do New Relic (v2), use este comando. Você também pode alterar o alias do aplicativo a partir do [API Explorer](/docs/apis/rest-api-v2/api-explorer-v2/getting-started-new-relics-api-explorer) da New Relic selecionando [<DNT>**Applications &gt; Update**</DNT>](https://api.newrelic.com/docs/#/Applications/put_applications__id__json).
...
<Callout variant="important">
  A alteração do alias do aplicativo faz com que todos os agentes que reportam sob este identificador de aplicativo sejam reiniciados. Consulte [renomear o aplicativo](/docs/apm/agents/manage-apm-agents/app-naming/name-your-application/#app-alias) para obter detalhes.
</Callout>
