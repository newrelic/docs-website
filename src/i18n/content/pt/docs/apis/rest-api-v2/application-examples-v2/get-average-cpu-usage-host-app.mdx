...
Você pode usar a API REST do New Relic (v2) para obter o uso médio da CPU do seu aplicativo em um único host. Esse valor aparece na [página <DoNotTranslate>**Summary**</DoNotTranslate> do APM](/docs/apm/applications-menu/monitoring/apm-overview-page) na tabela <DoNotTranslate>**Hosts**</DoNotTranslate> , na coluna denominada <DoNotTranslate>**CPU usage**</DoNotTranslate>.
...
<Callout variant="tip">
  Para obter as mesmas informações do [New Relic API Explorer (v2)](https://rpm.newrelic.com/api/explore), selecione [<DoNotTranslate>**Application Hosts > GET Metric Data**</DoNotTranslate>](https://rpm.newrelic.com/api/explore/application_hosts/data) e inclua sua [chave de API](/docs/apis/rest-api-v2/getting-started/introduction-new-relic-rest-api-v2#api_key). Adicione o [ID do aplicativo](/docs/apm/apis/requirements/identification-code), [o ID do host](/docs/apis/rest-api-v2/requirements/listing-host-instance-application-server-ids#locating_host_id) e as métricas `names[]=CPU/User Time` e `values[]=percent` nos campos apropriados.
</Callout>
...
<Callout variant="tip">
  Para obter as mesmas informações do [New Relic API Explorer (v2)](https://rpm.newrelic.com/api/explore), selecione [<DoNotTranslate>**Applications > GET Metric Data**</DoNotTranslate>](https://rpm.newrelic.com/api/explore/applications/data) e inclua sua [chave de API](/docs/apis/rest-api-v2/getting-started/introduction-new-relic-rest-api-v2#api_key). Adicione seu [ID do aplicativo](/docs/apm/apis/requirements/identification-code) e as métricas `names[]=CPU/User Time` e `values[]=percent` nos campos apropriados.
</Callout>