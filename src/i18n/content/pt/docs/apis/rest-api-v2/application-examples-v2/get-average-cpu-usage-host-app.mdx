...
<Callout variant="tip">
  Para obter as mesmas informações do [New Relic API Explorer (v2)](https://api.newrelic.com/docs), selecione [<DNT>**Applications &gt; GET Metric Data**</DNT>](https://api.newrelic.com/docs/#/Applications/get_applications__application_id__metrics_data_json) e inclua sua [chave de API](/docs/apis/rest-api-v2/getting-started/introduction-new-relic-rest-api-v2#api_key). Adicione seu [ID do aplicativo](/docs/apm/apis/requirements/identification-code) e as métricas `names[]=CPU/User Time` e `values[]=percent` nos campos apropriados.
</Callout>