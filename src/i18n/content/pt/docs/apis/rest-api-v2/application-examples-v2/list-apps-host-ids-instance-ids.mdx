...
## Listar os IDs atuais por nome do aplicativo [#list_current_ids]
...
## Listar os IDs atuais por ID do aplicativo [#ids_app_id_list]
...
## Listar os IDs atuais de todos os aplicativos [#ids_all_apps]
...
## Exemplo de listas de ID do host e ID da instância [#example_id_list]
