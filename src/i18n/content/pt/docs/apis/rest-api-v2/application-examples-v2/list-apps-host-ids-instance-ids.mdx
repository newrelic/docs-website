...
Você também pode usar o [<DoNotTranslate>**Applications > List**</DoNotTranslate>do REST API Explorer](/docs/apis/using-the-api-explorer) para listar os detalhes do ID. Insira o nome correto do aplicativo.
...
Você também pode usar <DoNotTranslate>**Applications > List**</DoNotTranslate>ou <DoNotTranslate>**Applications > List**</DoNotTranslate> do [API Explorer](/docs/apis/using-the-api-explorer) para listar os detalhes do ID. Insira o nome correto do aplicativo.
