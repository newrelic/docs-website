...
Durante o intervalo de tempo <DoNotTranslate>**reporting period**</DoNotTranslate> , a New Relic rastreia o impacto de cada solicitação de API em nosso sistema.
