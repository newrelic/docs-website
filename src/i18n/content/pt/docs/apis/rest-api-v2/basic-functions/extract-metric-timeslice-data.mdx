...
<DoNotTranslate>**Example #2:**</DoNotTranslate> Se você solicitar um intervalo > 7 dias, mas ≤ 3 semanas, onde o período padrão é de 3 horas, você poderá especificar períodos como 6, 12 ou 24 horas. No entanto, você não pode solicitar períodos de 1 hora, porque é menor que o padrão (3 horas).
...
## Extraindo dados de métrica de fração de tempo inexistentes [#non-existent_data_help]
