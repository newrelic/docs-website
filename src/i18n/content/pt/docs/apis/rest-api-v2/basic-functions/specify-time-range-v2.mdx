...
Se você estiver usando o New Relic REST API Explorer (v2), poderá usar o diamante<img
  title="icon-api-diamond"
  alt="icon-api-diamond"
  src="/images/apis-and-data_icon_REST-API-explorer-diamond.webp"
/>
