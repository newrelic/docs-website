...
A API do New Relic requer uma [chave de API de usuário](/docs/apis/get-started/intro-apis/types-new-relic-api-keys#user-api-key): A chave de usuário também é usada para nossa [API NerdGraph](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph).
