...
* [Exemplos de navegador](/docs/apis/rest-api-v2/browser-examples-v2) (como recuperar dados de métrica de fração de tempo de

  <InlinePopover type="browser"/>

  ). A API REST retorna apenas o script do navegador do agente Lite. Para obter mais informações, [consulte esta tabela comparando os tipos Lite, Pro e Pro+SPA](/docs/browser/browser-monitoring/installation/install-browser-monitoring-agent).
