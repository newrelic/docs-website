...
1. Vá para o [API Explorer](https://api.newrelic.com/docs) e, em seguida, selecione o nome da sua conta no dropdown <DNT>**Select an account**</DNT>.
2. Acesse a página <DNT>**Application host**</DNT> do API Explorer em [api.newrelic.com/docs](https://api.newrelic.com/docs/#/Applications/get_applications__application_id__hosts_json).
...
<CollapserGroup>
  <Collapser id="host_id" title="ID do host e dados de resumo usando o REST API Explorer">
    ...
    1. Vá para o [API Explorer](https://api.newrelic.com/docs/#/Applications/get_applications__application_id__hosts_json), em seguida, selecione o nome da sua conta no dropdown <DNT>**Select an account**</DNT>.
...
O significado do ID da instância depende do agente de idiomas da New Relic sendo usado. Você pode listar este ID a partir da API REST.
...
Você pode recuperar métricas de resumo para a instância, bem como valores específicos de métrica de fração de tempo usando o `INSTANCE_ID`. Para obter detalhes sobre as métricas disponíveis, use a página [Instância de Aplicativo do Explorer da API REST](https://api.newrelic.com/docs/#/Applications/get_applications__application_id__instances__instance_id__metrics_json).
