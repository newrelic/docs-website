...
<Callout variant="tip">
  Para obter as mesmas informações do [New Relic API Explorer (v2)](https://rpm.newrelic.com/api/explore), selecione <DoNotTranslate>**Users > GET List**</DoNotTranslate>.
</Callout>
...
<DoNotTranslate>**Note:**</DoNotTranslate> A correspondência de caracteres é uma string simples. Nenhum recurso de expressão regular está disponível, portanto, múltiplas correspondências poderão ocorrer se a string selecionada não for exclusiva.
