...
O `EndUser/RB:average_dom_content_load_time` é o tempo gasto no browser para analisar e interpretar o HTML. Isso é medido pelo evento <DoNotTranslate>**DOM Content**</DoNotTranslate> do browser.
