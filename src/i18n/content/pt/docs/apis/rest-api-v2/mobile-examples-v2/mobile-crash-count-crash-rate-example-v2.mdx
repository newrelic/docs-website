...
<Callout variant="tip">
  Você também pode usar o New Relic API Explorer para recuperar [dados de métrica mobile](https://api.newrelic.com/docs/#/Mobile%20Applications/get_mobile_applications__mobile_application_id__metrics_data_json).
</Callout>
