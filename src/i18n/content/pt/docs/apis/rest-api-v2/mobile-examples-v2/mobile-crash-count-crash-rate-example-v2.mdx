...
Isto descreve como usar a API REST New Relic (v2) para obter <DoNotTranslate>**crash count**</DoNotTranslate> e <DoNotTranslate>**crash rate**</DoNotTranslate> gerais e específicos da versão do seu aplicativo mobile, que aparecem na [página<DoNotTranslate>**Summary**</DoNotTranslate> ](/docs/mobile-monitoring/mobile-monitoring-ui/mobile-app-pages/mobile-apps-overview-page)no canto superior direito.
