...
<Callout variant="important">
  A API REST para rótulos atingiu o fim da vida útil em 30 de junho de 2022 (prorrogado de 31 de março de 2022). Para obter mais informações, consulte nossa documentação sobre [tags](/docs/new-relic-one/use-new-relic-one/core-concepts/tagging-use-tags-organize-group-what-you-monitor) e nossa [postagem no Fórum de Suporte](https://support.newrelic.com/s/hubtopic/aAX8W0000008cts/important-upcoming-changes-to-capabilities-and-support-across-errors-classic) sobre o EOL.
</Callout>
