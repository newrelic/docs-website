...
<Callout variant="important">
  A API REST v2 da New Relic (incluindo os endpoints de alertas) e a API v0 de implantações [chegarão ao fim da vida útil em 31 de julho de 2027](/eol/2026/07/eol-31-07-26-rest-api-v2). Após essa data, esses endpoints não estarão mais disponíveis. Migre as integrações para o NerdGraph antes dessa data.
</Callout>
