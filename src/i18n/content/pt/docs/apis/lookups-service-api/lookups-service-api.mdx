...
Endpoint dos Estados Unidos (EUA) (padrão):
...
Endpoint do [Japão](/docs/accounts/accounts-billing/account-setup/choose-your-data-center) (JP):
...
<CollapserGroup>
  <Collapser id="multipart-form-data-request" title="Solicitação com multipart/form-data">
    #### Campos Suportados
  ...
  <Collapser id="application-json-request" title="Solicitar com aplicativo/json">
    #### Campos Suportados
...
<CollapserGroup>
  <Collapser id="create-a-new-table" title="Crie uma nova tabela">
  ...
  <Collapser id="update-a-table" title="Atualizar uma tabela existente">
...
<Collapser id="download-an-existing-table" title="Baixe uma tabela existente">
...
<Collapser id="delete-an-existing-table" title="Excluir uma tabela existente">
...
<Collapser id="list-tables" title="Listando tabelas atualizadas para uma conta">
