...
Para saber quando a instrumentação CR vai injetar o agente APM, precisamos usar seletores. Há 2 seletores de rótulos disponíveis que você pode usar juntos (eles agem como um operador lógico AND (`&&`)) ou separadamente, dependendo de suas necessidades.
