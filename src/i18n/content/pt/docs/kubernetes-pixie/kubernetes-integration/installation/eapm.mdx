...
* **Uso da interfaceAPM :** Encargos podem ser incorridos com base na utilização da interface APM do usuário, medida em unidade de capacidade de computação (CU) para o Produto de computação principal.
