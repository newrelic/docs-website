  ...
  <TabsPages>
    ...
    <TabsPageItem id="man-helm">
      ...
      * Ele garante que seus valores de configuração sejam consistentes nos gráficos instalados.
      ...
      O gráfico `nri-bundle` é aquele instalado e configurado por nossa [instalação guiada do Kubernetes](/install/kubernetes#guided-install).
    ...
    <TabsPageItem id="gke-autopilot">
      ...
      * Um manifesto simples com valores obrigatórios pré-preenchidos
      ...
      <CollapserGroup>
        ...
        >
          Você pode instalar no piloto automático do GKE usando o mesmo fluxo de instalação da nossa guia [de instalação guiada](/install/kubernetes/?dropdown1=guided) .
        </Collapser>
