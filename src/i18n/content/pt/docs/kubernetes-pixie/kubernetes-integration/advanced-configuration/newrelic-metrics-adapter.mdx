...
1. Se ainda não estiver instalado, [instale nossa integração Kubernetes](/docs/kubernetes-pixie/kubernetes-integration/installation/kubernetes-integration-install-configure/#installer).
...
<CollapserGroup>
  <Collapser
    className="freq-link"
    id="verbose-helm"
    title="Obtenha um registro detalhado"
  >
