...
<CollapserGroup>
  <Collapser id="invalid-license" title="Verifique se os nós mestres possuem os rótulos corretos">
  ...
  <Collapser id="unable-connect" title="Verifique se a integração está sendo executada nos nós mestres">
  ...
  <Collapser id="cannot-list-pods-for-cluster" title="Recuperar o log detalhado de uma das integração em execução em um nó mestre e verificar os trabalhos dos componentes do plano de controle">
