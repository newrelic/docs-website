...
<CollapserGroup>
  ...
  >
    ...
    1. Vá para <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Settings > Alerts > Kubernetes**</DoNotTranslate> e selecione <DoNotTranslate>**Create alert condition**</DoNotTranslate>.
