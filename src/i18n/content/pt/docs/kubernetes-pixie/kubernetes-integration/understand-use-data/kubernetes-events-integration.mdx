...
Os eventos coletados pelo New Relic terão exatamente os mesmos atributos fornecidos pelo Kubernetes. Para uma referência desses atributos, consulte a [documentação do evento v1 core do Kubernetes](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.34/#event-v1-core).
