...
Você concluiu o [procedimento de instalação](/docs/kubernetes-monitoring-integration#install) para integração do Kubernetes da New Relic com Helm para `nri-bundle`, mas nossos modelos Helm não estão respeitando alguns [valores globais](https://github.com/newrelic/helm-charts/tree/master/charts/nri-bundle#values) em seu `values.yaml`.
