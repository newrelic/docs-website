...
1. Confirme se o agente de infraestrutura pode ser planejado em cada nó executando:
   ...
   <Callout variant="caution">
     Observe que na versão V2 da integração do Kubernetes este comando muda. Consulte [resolução de problemas K8s v2: Nós ausentes](/docs/kubernetes-pixie/kubernetes-integration/advanced-configuration/k8s-version2/troubleshooting/missing-nodes).
   </Callout>
