...
6. Espere alguns minutos. Na guia anterior, onde você configurou a gravação remota, clique no botão <DoNotTranslate>**See your data**</DoNotTranslate> para ver se os dados foram recebidos.
