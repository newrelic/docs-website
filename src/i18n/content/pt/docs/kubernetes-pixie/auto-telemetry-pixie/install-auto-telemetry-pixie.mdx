...
2. Clique em <DoNotTranslate>**Continue**</DoNotTranslate>.

3. Selecione os dados que deseja coletar, observar e depurar e clique em <DoNotTranslate>**Continue**</DoNotTranslate>.

4. Na página <DoNotTranslate>**Choose install method**</DoNotTranslate> , selecione <DoNotTranslate>**Helm**</DoNotTranslate> ou <DoNotTranslate>**manifest**</DoNotTranslate>.
...
5. Clique em <DoNotTranslate>**Continue**</DoNotTranslate> para abrir a página <DoNotTranslate>**Listening for data**</DoNotTranslate> .

6. Ao receber a mensagem <DoNotTranslate>**See your data**</DoNotTranslate>, clique em <DoNotTranslate>**Kubernetes Cluster Explorer**</DoNotTranslate> para ver seu cluster.
...
A integração Pixie é instalada como parte da integração Kubernetes da New Relic. Para atualizar a integração do Kubernetes, consulte nossa [documentação de instalação do Kubernetes](/docs/kubernetes-pixie/kubernetes-integration/installation/kubernetes-integration-install-configure#update).
