...
2. Selecione a conta que deseja usar para a instalação guiada e clique em <DNT>**Continue**</DNT>. Observação: se você tiver uma única conta, não verá esta opção.
3. Preencha os campos restantes e clique em <DNT>**Continue**</DNT> para concluir o restante da instalação.
...
4. Na página <DNT>**Choose install method**</DNT> , selecione <DNT>**Helm**</DNT> ou <DNT>**manifest**</DNT>.
   ...
   <CollapserGroup>
     <Collapser className="freq-link" id="helm-method" title="Método Helm">
     ...
     <Collapser className="freq-link" id="manifest-method" title="método manifesto">
...
<Callout variant="important" title="AVISO DE EOL">
  Após agosto de 2022, descontinuaremos o suporte para vários recursos, incluindo a versão 1 da nossa integração com o Pixie. Para obter mais detalhes, incluindo como é possível se preparar facilmente para essa transição, consulte nossa [publicação no Fórum de Suporte](https://support.newrelic.com/s/hubtopic/aAX8W0000008dL8/july-2022-end-of-life-announcements).
</Callout>
