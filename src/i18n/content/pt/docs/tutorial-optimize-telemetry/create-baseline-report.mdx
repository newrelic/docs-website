...
<Steps>
  <Step>
    ...
    2. Clique em <DNT>**Install this quickstart**</DNT> na parte superior direita da janela do Browser.
    3. Selecione sua conta principal ou de nível superior no alternador de contas, se aplicável.
    4. Clique em <DNT>**Done**</DNT>.
    5. Quando a instalação do guia de início rápido terminar, abra o dashboard <DNT>**Data ingest governance baseline**</DNT> .
  </Step>
  ...
  <Step>
    ...
    * Destino para subcontas ou unidades de negócios específicas.
    ...
    1. No baseline dashboard,<DNT>**+ Add widget**</DNT> selecione .
    2. Selecione <DNT>**Add a chart**</DNT>.
    3. Insira a consulta NRQL que o gráfico usará.
    4. Selecione <DNT>**Run**</DNT>.
    ...
    1. No baseline dashboard, selecione <DNT>**...**</DNT> para o gráfico que você deseja modificar.
    2. Selecione <DNT>**Edit**</DNT>.
  ...
  <Step>
    ...
    2. Selecione a guia <DNT>**Baseline report**</DNT> .
    3. Selecione <DNT>**...**</DNT> na tabela <DNT>**Last 30 days**</DNT> e escolha <DNT>**Export as CSV**</DNT>.
