...
2. Selecione <DoNotTranslate>**Install this quickstart**</DoNotTranslate>.
...
4. Selecione <DoNotTranslate>**Done**</DoNotTranslate>.

5. Quando a instalação do guia de início rápido terminar, abra o dashboard <DoNotTranslate>**Data governance entity breakdowns**</DoNotTranslate> para acessar seus dados.
