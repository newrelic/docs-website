...
* [Habilitar gerenciamento de logs](/docs/logs/forward-logs/enable-log-management-new-relic)
* [Encaminhar logs com o Fluent Bit](/docs/logs/forward-logs/logs-fluent-bit)
