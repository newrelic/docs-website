...
<Callout variant="tip">
  Para a região da UE, use `https://opamp.service.eu.newrelic.com/v1/opamp` como o endpoint e `https://system-identity-oauth.service.eu.newrelic.com/oauth2/token` como o `token_url`.
</Callout>
