...
1. **Defina a seção `secretsProviders` :** configure seus provedores secretos centralmente nesta seção. Certifique-se de que cada entrada corresponda a um provedor suportado.
