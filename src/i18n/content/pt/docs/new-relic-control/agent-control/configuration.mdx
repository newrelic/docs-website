...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Um arquivo contendo agente de configuração de infraestrutura
      </td>
    ...
    <tr>
      ...
      <td>
        Um mapa de string contendo integração no host configuração
      </td>
    ...
    <tr>
      ...
      <td>
        Um mapa de string contendo encaminhamento de configuração de logs
      </td>
