...
6. Forneça sua chave de licença. Se você criar uma nova chave, copie-a para a área de transferência ou salve-a em algum lugar seguro. Você precisará dele em breve.
...
1. Execute o seguinte comando para verificar o status do seu pod:
