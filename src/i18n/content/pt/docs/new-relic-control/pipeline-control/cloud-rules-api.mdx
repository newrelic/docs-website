...
Você pode modificar as regras cloud existentes para ajustar seus critérios de filtragem, tipos de dados ou escopo de implantação.
...
* **Verifique a resposta da API:** O objeto de entidade na resposta refletirá o nome, a descrição e o NRQL atualizados.
