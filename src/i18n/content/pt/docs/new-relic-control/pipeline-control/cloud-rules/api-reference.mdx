...
* [Eventos padrão de monitoramento de infraestrutura](/docs/infrastructure/manage-your-data/data-instrumentation/default-infrastructure-monitoring-data) e eventos de [integrações de infraestrutura](/docs/integrations/infrastructure-integrations/get-started/introduction-infrastructure-integrations).

<Callout variant="important">
  A partir de fevereiro de 2026, as regras de descarte direcionadas a eventos de infraestrutura em `SystemSample`, `ProcessSample`, `NetworkSample` e `StorageSample` também descartarão corretamente os dados agregados.
</Callout>

* [Métricas dimensionais](/docs/data-apis/understand-data/new-relic-data-types/#dimensional-metrics). Algumas ressalvas:
...
Use a mutação `entityManagementUpdatePipelineCloudRule`, fornecendo o `id` da regra e um objeto `pipelineCloudRuleEntity` contendo os campos que você deseja alterar.
...
* Se a regra foi desativada pela New Relic (por exemplo, política de EOL): a solicitação falhará a menos que o usuário possua as permissões internas necessárias para ignorar a política.
...
* Navegue pelo [Fórum de Suporte](https://support.newrelic.com/s/hubtopic/Topic__c/Default?c__categories=%5B%7B%22icon%22%3A%22standard%3Adefault%22%2C%22id%22%3A%22a6c8W000000EesuQAC%22%2C%22sObjectType%22%3A%22Category__c%22%2C%22title%22%3A%22Dashboards%22%2C%22titleFormatted%22%3A%22Dashboards%22%7D%5D) para ver discussões da comunidade sobre regras de cloud.
