...
* `conditionalSamplingRules`: Array de regras condicionais (avaliadas em ordem) - **suportado apenas para logs e eventos**
...
Para traces, você só pode configurar a porcentagem de amostragem global. Essa porcentagem se aplica a **todos os traces uniformemente**, incluindo traces de erro e traces lentos:
