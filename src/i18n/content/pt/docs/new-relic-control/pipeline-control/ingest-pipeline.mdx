...
* **Fontes:**
  ...
  * Exibe os quatro tipos de telemetria (Métricas, Evento, Logs, Traces) que agentes e coletores enviam para a New Relic. Cada origem mostra o volume de dados fluindo pelo pipeline. Isso representa os pontos de entrada para seus dados de observabilidade.
...
* **Nuvem:**
  ...
  * Indica regras de cloud em execução na infraestrutura da New Relic. Mostra o número de regras ativas (por exemplo, &quot;0 regras&quot; quando nenhuma regra de cloud está configurada). Isso representa a filtragem adicional aplicada após os dados chegarem aos endpoints da New Relic.