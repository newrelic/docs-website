...
Para explorar a API de forma interativa, use o [<DNT>NerdGraph Explorer</DNT>](https://one.newrelic.com/nerdgraph-graphiql) (ou a [região da UE](https://one.eu.newrelic.com/nerdgraph-graphiql), ou a [região do Japão](https://one.jp.newrelic.com/nerdgraph-graphiql)).
