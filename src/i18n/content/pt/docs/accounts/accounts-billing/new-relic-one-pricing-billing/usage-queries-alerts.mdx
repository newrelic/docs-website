...
<CollapserGroup>
  <Collapser id="daily-core-ccu" title="Daily core compute usage">
  ...
  <Collapser id="daily-advanced-ccu" title="Daily advanced compute usage">
  ...
  <Collapser id="daily-core-ccu-capability" title="Daily core compute usage by capability">
  ...
  <Collapser id="daily-advanced-ccu-capability" title="Daily advanced compute usage by capability">
  ...
  <Collapser id="month-core-ccu" title="Month-to-date core compute usage">
  ...
  <Collapser id="month-advanced-ccu" title="Month-to-date advanced compute usage">
