...
<CollapserGroup>
  ...
  <Collapser id="month-gb" title="Uso de dados acumulado no mês">
    Esta consulta mostra os dados ingeridos da plataforma completa atual. Em outras palavras, mostra quanto você seria cobrado pelos seus dados naquele mês se fosse cobrado agora.
