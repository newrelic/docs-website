...
Para criar um novo domínio na página da interface do domínio de autenticação, clique em <DNT>**Create authentication domain**</DNT>. Para mais informações sobre as opções de configuração, continue lendo.
...
* <DNT>**Manual**</DNT>
  ...
  <DNT>[**User management**](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-ui-and-tasks#where)</DNT>
...
* <DNT>**Manage user type in New Relic**</DNT>

  : esta é a opção padrão. Ele permite que você gerencie o tipo de usuário de seus usuários no New Relic.

* <DNT>**Manage user type with SCIM**</DNT>

  : ativar isso significa que

  <DNT>**you can no longer manage user type from New Relic**</DNT>
...
<CollapserGroup>
  ...
  >
    ...
    1. Certifique-se de que seu domínio de autenticação

       <DNT>**Source of users**</DNT>

       tenha [o SCIM ativado](#source-users).
   ...
   <CollapserGroup>
     ...
     >
       ...
       8. A partir daí, vá para a guia
          ...
          <DNT>**Advanced Sign-on Settings**</DNT>

          , você verá

          <DNT>**Authentication Domain ID**</DNT>

          , que precisará editar neste campo na Etapa 9 das instruções gerais abaixo. À direita, clique em

          <DNT>**View SAML setup instructions**</DNT>
