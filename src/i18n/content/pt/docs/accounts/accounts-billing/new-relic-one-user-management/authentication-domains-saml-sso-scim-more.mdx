...
3. Enable the MFA toggle. Once enabled, users in that authentication domain are prompted to verify their email at their next login and all subsequent logins.
