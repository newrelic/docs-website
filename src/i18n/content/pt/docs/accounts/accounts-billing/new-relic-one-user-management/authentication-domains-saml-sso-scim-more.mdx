...
<CollapserGroup>
  ...
  <Collapser id="manage-user-type-scim" title="Gerencie o tipo de usuário com SCIM">
    ...
    * Diretório ativo do Azure: consulte a discussão do fórum New Relic sobre como configurar o Azure AD para SCIM com tipos de usuário [aqui](https://support.newrelic.com/s/hubtopic/aAX8W0000008d6MWAQ/relic-solution-make-full-core-basic-users-in-azure-active-directory-w-scim).
