...
<Callout variant="important">
  Usuários com acesso restrito ainda podem ver informações de partições de log restritas por meio de [exportações históricas](/docs/apis/nerdgraph/examples/nerdgraph-historical-data-export/), [notificações de alerta](/docs/alerts/get-notified/alert-event-workflows/) ou da [API Insights](/docs/apis/insights-apis/query-insights-event-data-api/). Consulte [riscos potenciais de exposição de dados](#data-exposure-risks) para detalhes e mitigações.
</Callout>
