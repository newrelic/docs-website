...
3. Adicione usuários a um grupo designado: usuários com o tipo de usuário core ou full da plataforma precisam ser adicionados a um grupo com uma [concessão de acesso](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts/#access-grants) com escopo de organização que lhes atribua a função de Tenant Manager.
...
<DocTiles>
  <DocTile title="Passo 1" path="/docs/accounts/accounts-billing/account-structure/multi-tenancy/org-creation">
    Criar contas e organização
  </DocTile>

  <DocTile title="Passo 2" path="/docs/accounts/accounts-billing/account-structure/multi-tenancy/delegated-administration">
    Gerenciar usuário e acesso
  </DocTile>

  <DocTile title="Passo 3" path="/docs/accounts/accounts-billing/account-structure/multi-tenancy/share-accounts">
