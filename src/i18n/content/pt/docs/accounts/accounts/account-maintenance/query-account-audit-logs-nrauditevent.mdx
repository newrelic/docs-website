...
## O que é `NrAuditEvent`? [#attributes]
...
<CollapserGroup>
  <Collapser
    id="all-changes"
    title="Que alterações foram feitas na conta New Relic?"
  >
  ...
  <Collapser
    id="what-changed"
    title="Que tipo de alteração de conta foi mais realizada?"
  >
  ...
  <Collapser
    id="accounts-created"
    title="Quais contas foram adicionadas à nossa organização?"
  >
  ...
  <Collapser
    id="graph-changes"
    title="Que tendências aparecem nas mudanças de conta?"
  >
  ...
  <Collapser
    id="user-mgmt"
    title="Quais mudanças no gerenciamento de usuários foram feitas?"
  >
    Observe que [o modelo de usuário](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-user-models) dos seus usuários impactará essas consultas. Caso seus usuários estejam em nosso modelo de usuário original, você só poderá consultar por conta. Se seus usuários estiverem em nosso modelo de usuário mais recente, você deverá consultar a conta de nível superior em sua [organização New Relic](/docs/accounts/accounts-billing/new-relic-one-pricing-users/new-relic-account-structure).
  ...
  <Collapser
    id="synth-changes"
    title="Monitoramento sintético: Quais mudanças foram feitas em um monitor?"
  >
  ...
  <Collapser
    id="workload-changes"
    title="Carga de trabalho: quais alterações foram feitas em qualquer configuração workload ?"
  >
  ...
  <Collapser
    id="target-type"
    title="Quais tipos de destino estão na minha conta?"
  >
...
<CollapserGroup>
  <Collapser
    id="events-users"
    title="Quais alterações na conta foram feitas por algum usuário?"
  >
  ...
  <Collapser
    id="who-changed"
    title="Quais alterações na conta foram feitas por um usuário específico?"
  >
  ...
  <Collapser
    id="most-changes"
    title="Quem fez mais alterações na conta?"
  >
  ...
  <Collapser
    id="synth-user"
    title="Monitoramento sintético: Quais monitores foram criados por um usuário específico?"
  >
...
<CollapserGroup>
  <Collapser
    id="events-api-key"
    title="Quais alterações na conta foram feitas usando uma chave de API?"
  >
