...
<CollapserGroup>
  ...
  >
    ...
    4. Quando o usuário faz login com sucesso no endpoint de SSO SAML (Auth0, Okta, OneLogin, Ping Identity, Salesforce etc.), a New Relic sinaliza o usuário como <DNT>**Active**</DNT>.
