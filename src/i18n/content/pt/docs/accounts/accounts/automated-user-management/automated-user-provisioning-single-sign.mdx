...
* Você deve ter um [tipo de usuário](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type) core ou da plataforma completa e estar em um grupo com a [função<DNT>**Authentication domain manager**</DNT> ](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts#admin-settings)com escopo de organização.
