...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <DoNotTranslate>**Required.**</DoNotTranslate> Nome do grupo.
      </td>
    </tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <DoNotTranslate>**Required.**</DoNotTranslate> Identificador exclusivo para o usuário no sistema da New Relic. Use o endereço de e-mail do usuário.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <DoNotTranslate>**Required.**</DoNotTranslate> Endereço de e-mail do usuário.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <DoNotTranslate>**Required.**</DoNotTranslate> Booleano que indica se o usuário deve ou não estar ativo ou inativo no New Relic.
      </td>
    </tr>
...
<CollapserGroup>
  ...
  <Collapser
    id="get-group-query"
    title="Obter grupo por consulta"
  >
    Solicitação de exemplo:
  ...
  <Collapser
    ...
    title="Atualizar grupo com PATCH (campos de não-membro)"
  >
    Solicitação de exemplo:
  ...
  <Collapser
    ...
    title="Atualizar grupo com PATCH (Adicionar membros)"
  >
    Solicitação de exemplo:
  ...
  <Collapser
    ...
    title="Atualizar grupo com PATCH (Remover membros)"
  >
    Solicitação de exemplo:
  ...
  <Collapser
    id="get-user-query"
    title="Obter usuário por consulta"
  >
    Solicitação de exemplo:
  ...
  <Collapser
    id="update-user-put"
    title="Atualizar usuário com PUT"
  >
  ...
  <Collapser
    ...
    title="Atualizar usuário com PATCH"
  >
    Solicitação de exemplo:
