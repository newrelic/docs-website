...
<CollapserGroup>
  <Collapser id="heroku-add-on-license-key" title="chave de licença">
  ...
  <Collapser id="heroku-add-on-account-url" title="URL da conta">
  ...
  <Collapser id="heroku-add-on-account" title="ID da conta">
...
<CollapserGroup>
  <Collapser id="heroku-add-on-login" title="Faça login na conta complementar do New Relic por meio do Heroku">
  ...
  <Collapser id="regular-login" title="Faça login em contas normais da New Relic">
