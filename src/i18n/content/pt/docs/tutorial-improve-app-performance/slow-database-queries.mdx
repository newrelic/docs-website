...
<Steps>
  <Step>
    Navegue até a interface do banco de dados: vá para <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/nr1-core?filters=(domain%3D'APM'ANDtype%3D'APPLICATION')) > (select an app) > monitor > databases**</DoNotTranslate>
  </Step>

  <Step>
    ### Tempo consumido pelas operações do banco de dados

    O gráfico <DoNotTranslate>**Most time consuming**</DoNotTranslate> mostra o tempo total de processamento de consulta por uma operação de banco de dados.
  ...
  <Step>
    ...
    O gráfico <DoNotTranslate>**Top databases by query time**</DoNotTranslate> mostra o desempenho do seu banco de dados com base no tempo necessário para executar uma consulta.
  ...
  <Step>
    ...
    O gráfico <DoNotTranslate>**Top databases by throughput**</DoNotTranslate> mostra as taxas de transferência do seu banco de dados ao longo do tempo.
