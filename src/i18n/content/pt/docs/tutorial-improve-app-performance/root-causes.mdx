---
title: Solucionar problemas de desempenho lento do aplicativo
...
## Identifique problemas de aplicativos [#identify]

<SideBySide>
  <Side>
    Observe o gráfico <DoNotTranslate>**Web transactions time**</DoNotTranslate> . Este gráfico exibe o tempo médio de resposta de determinadas métricas em seu aplicativo. À medida que seu gráfico é preenchido com dados, observe picos estranhos em qualquer linha ou segmento. Ao mesmo tempo, anote quaisquer segmentos ou linhas que levem consistentemente muito tempo.

    <Callout variant="tip">
      Use o seletor de hora para procurar picos em vários intervalos de tempo.<img title="Time picker" alt="Image showing the time picker for APM" src={journeyTime} style={{ maxWidth: '60%' }}/>
    </Callout>
  </Side>
...
<DocTiles>
  ...
  >
    A linha azul é <DoNotTranslate>**application code**</DoNotTranslate>, especificamente o tempo gasto em seu aplicativo em código que não é externo ou em chamadas de banco de dados. Para solucionar isso, clique aqui para ver a etapa 2 do tutorial.
  </DocTile>
  ...
  >
    O segmento amarelo é <DoNotTranslate>**database queries**</DoNotTranslate>, especificamente o tempo gasto ligando e aguardando consulta ao banco de dados. Para solucionar isso, clique aqui para ver a etapa 3 do tutorial.
  </DocTile>
