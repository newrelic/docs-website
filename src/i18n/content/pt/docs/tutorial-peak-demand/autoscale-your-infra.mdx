...
<Steps>
  ...
  <Step>
    ...
    * Marque <DoNotTranslate>**Instant service-level insights**</DoNotTranslate>, <DoNotTranslate>**Full-body requests**</DoNotTranslate> e <DoNotTranslate>**Application profiles through Pixie**</DoNotTranslate> para ativar o Pixie.
  ...
  <Step>
    ...
    Você deve testar sua consulta antes de enviar a métrica para o escalonador automático da New Relic. Vá para <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com) > Query your Data**</DoNotTranslate> e copie e cole a seguinte consulta NRQL:
