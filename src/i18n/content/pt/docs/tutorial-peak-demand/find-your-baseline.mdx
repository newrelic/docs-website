...
<Steps>
  <Step>
    ...
    Vá para <DoNotTranslate>**[one.newrelic.com > Query Your Data](https://one.newrelic.com/data-exploration/query-builder)**</DoNotTranslate> e insira a seguinte consulta:
  ...
  <Step>
    ...
    Agora que você tem uma linha de base, pode criar um nível de serviço significativo. Na página <DoNotTranslate>**Query Your Data**</DoNotTranslate> , volte para <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com) > APM & Services**</DoNotTranslate> e clique em <DoNotTranslate>**Service levels**</DoNotTranslate> localizado em <DoNotTranslate>**Reports**</DoNotTranslate>.
