...
Com nosso <InlinePopover type="apm"/>agente PHP, você pode obter o <DoNotTranslate>**logs in context**</DoNotTranslate>, que permite ver o registro do seu aplicativo no contexto de outros dados New Relic . Para informações gerais sobre este recurso, consulte [logs contextualizados APM](/docs/apm/new-relic-apm/getting-started/get-started-logs-context).
