    ...
    <tr>
      ...
      <td>
        ...
        * [newrelic_get_linking_metadata](/docs/apm/agents/php-agent/php-agent-api/newrelicgetlinkingmetadata/)
          ...
          Para PHP, o logs contextualizados só é compatível com a interface distributed tracing , e não na guia <DoNotTranslate>**Logs**</DoNotTranslate> da interface <InlinePopover type="apm"/>.
      </td>
    </tr>
