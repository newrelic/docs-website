...
4. Configure logs contextualizados para Ruby.
   ...
   <CollapserGroup>
     <Collapser id="enable-rails" title="Configuração padrão Ruby on Rails">
     ...
     <Collapser id="incompabilities" title="Gemas incompatíveis">
     ...
     <Collapser id="rails-adv-config" title="Configuração avançada do Rails">
     ...
     <Collapser id="enable-non-rails" title="Configuração Ruby sem Rails">
     ...
     <Collapser id="lograge-adv-config" title="Configuração de log">
     ...
     <Collapser id="adv-ruby-config" title="Outras extensões de registro">
