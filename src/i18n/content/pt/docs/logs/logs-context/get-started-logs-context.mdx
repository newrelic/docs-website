...
Ao configurar um <InlinePopover type="apm"/>agente, você obtém automaticamente um gráfico de métricas de logging na página <DoNotTranslate>**Summary**</DoNotTranslate> do APM :
