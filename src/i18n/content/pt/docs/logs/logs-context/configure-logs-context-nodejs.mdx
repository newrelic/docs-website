...
3. Instale [uma frameworkcompatível](#automatic) para enriquecer seus dados log ou use diretamente [a APIde encaminhamento de logs do agente](https://newrelic.github.io/node-newrelic/API.html#recordLogEvent).
