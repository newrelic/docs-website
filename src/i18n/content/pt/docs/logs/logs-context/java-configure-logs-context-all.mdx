...
<CollapserGroup>
  <Collapser id="1-agent" title="Opção 1 (recomendada): Deixe o agente encaminhar seu log.">
  ...
  <Collapser id="2-decorate" title="Opção 2: Use seu próprio direcionador de logs.">
...
<CollapserGroup>
  <Collapser id="java-dropwizard" title="Dropwizard 1.3 ou superior">
  ...
  <Collapser id="java-adding-classpath" title="adições de caminho de classe java.util.logging">
  ...
  <Collapser id="java-logback" title="Logback versão 1.2.0 ou superior">
    <Callout variant="tip">
      Aproveite nossa solução [de logs contextualizados automático](#automatic) para Java. Não há necessidade de usar este processo manual!
    </Callout>
  ...
  <Collapser id="spring" title="Primavera e Springboot">
