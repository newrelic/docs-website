...
<CollapserGroup>
  ...
  >
    ...
    6. Certifique-se de que `NewRelicAsyncAppender` seja o anexador <DNT>**first**</DNT> usado em seu agente. Substitua os anexadores do seu agente raiz pelo anexador `ASYNC` criado na etapa anterior. Em seguida, liste quaisquer outros anexadores <DNT>**after**</DNT> a `NewRelicAsyncAppender` na lista `<root>` .
