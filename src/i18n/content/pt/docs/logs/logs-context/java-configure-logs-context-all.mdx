...
Com nosso <InlinePopover type="apm"/>agente Java, você pode obter o <DoNotTranslate>**logs in context**</DoNotTranslate>, que permite ver o registro do seu aplicativo no contexto de outros dados New Relic . Para informações gerais sobre este recurso, consulte [logs contextualizados APM](/docs/apm/new-relic-apm/getting-started/get-started-logs-context).
...
<CollapserGroup>
  ...
  >
    ...
    3. Atualize a dependência do seu projeto para incluir a extensão Dropwizard 1.3 conforme aplicável:
       ...
       <DoNotTranslate>**Gradle:**</DoNotTranslate> Adicione o seguinte ao seu arquivo `build.gradle` :
       ...
       <DoNotTranslate>**Maven:**</DoNotTranslate> Adicione o seguinte ao seu arquivo `pom.xml` :
  ...
  >
    ...
    Oferecemos uma extensão [Log4j 2.x](https://logging.apache.org/log4j/2.0/log4j-slf4j-impl/index.html) para logs contextualizados com o agente Java. Para começar, revise o [código](https://github.com/newrelic/java-log-extensions/tree/main/log4j2) e um [exemplo de aplicativo](https://github.com/newrelic/java-log-extensions/tree/main/examples/log4j2-app) no GitHub.
    ...
    3. Atualize a dependência do seu projeto para incluir a extensão Log4j 2.x conforme aplicável:
       ...
       <DoNotTranslate>**Gradle:**</DoNotTranslate> Adicione a seção destacada ao seu arquivo `build.gradle` :
       ...
       <DoNotTranslate>**Maven:**</DoNotTranslate> Adicione a seção destacada ao seu arquivo `pom.xml` :
  ...
  >
    ...
    6. Certifique-se de que `NewRelicAsyncAppender` seja o anexador <DoNotTranslate>**first**</DoNotTranslate> usado em seu agente. Substitua os anexadores do seu agente raiz pelo anexador `ASYNC` criado na etapa anterior. Em seguida, liste quaisquer outros anexadores <DoNotTranslate>**after**</DoNotTranslate> a `NewRelicAsyncAppender` na lista `<root>` .
