...
Para obter mais informações sobre esses requisitos, consulte [Encaminhar seus logs para o New Relic](/docs/logs/forward-logs/enable-log-management-new-relic).<br />
