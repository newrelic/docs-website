...
* A região New Relic e a chave de licença ingest fornecida para a função do Lambda ou Firehose podem não corresponder. Verifique e combine.
  ...
  Por exemplo, se a região da New Relic for a UE, forneça uma chave de licença de ingestão da New Relic da região da UE. Da mesma forma, se a região da New Relic for JP, forneça uma chave de licença de ingestão da New Relic da região JP.
