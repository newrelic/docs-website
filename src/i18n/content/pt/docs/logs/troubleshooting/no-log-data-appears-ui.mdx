  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        Se nenhum dado aparecer no criador de consulta, nenhum dado aparecerá na interface <DoNotTranslate>**Logs**</DoNotTranslate> . Para obter mais informações, consulte [nossos documentos sobre opções de consulta de dados](/docs/query-your-data/explore-query-data/get-started/introduction-querying-new-relic-data).
      </td>
    </tr>
  </tbody>
</table>