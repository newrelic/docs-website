...
<Steps>
  <Step>
    ...
    1. Na tabela de log ou na guia **Formatted** da visualização de detalhes do log, realce uma sequência de âncora que contém os valores que você deseja extrair. Nesse caso, você destacaria `level=info msg="Running script"`. Fica assim na tabela de log:<img title="Screenshot showing a highlighted section of a log" alt="Screenshot showing a highlighted section of a log" src={logsExampleLogRecordtoHighlight}/>
    ...
    2. Clique na opção **Create query time parsing rule**.
       ...
       **Tabela log:**<img title="Screenshot showing how you can begin with the logs table UI" alt="Screenshot showing how you can begin with the logs table UI" src={logsLogsTableEntryPoint}/>

       **Visualização de detalhes log**:<img title="Screenshot showing how you can start creating rules in the logs detail view" alt="Screenshot showing how you can start creating rules in the logs detail view." src={logsLogsDetailEntryPoint}/>
  </Step>
  ...
  <Step>
    ...
    3. Se precisar renomear alguma variável antes de criar sua regra, clique no nome, forneça um novo nome e clique em **Save**. Você também pode excluir variáveis clicando na variável que deseja excluir e clicando em **Delete**.<img title="Screenshot showing where you can delete values" alt="Screenshot showing where you can delete values" src={logsDeleteQueryTimeRule}/>
    ...
    **Detalhes log**<img title="Screenshot showing how you can see your newly extracted values in the log details view" alt="Screenshot showing how you can see your newly extracted values in the log details view" src={logsViewResultsinLogDetailsView}/>

    <figcaption>
      Depois de visualizar os valores recém-extraídos, feche a visualização **Log details** .
    </figcaption>

    **Tabela log**<img title="Screenshot showing the final results after you create the rules" alt="Screenshot showing the final results after you create the rules" src={logsLogTableResults}/>
