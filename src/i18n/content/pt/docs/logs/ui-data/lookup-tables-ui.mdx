...
Nosso recurso <DoNotTranslate>**lookups**</DoNotTranslate> permite enriquecer seus dados log e outros dados armazenados New Reliccom dados sobre sua empresa definidos em um arquivo CSV.
...
Para encontrar a tabela de consulta da interface: Em [one.newrelic.com](https://one.newrelic.com), clique em <DoNotTranslate>**Logs**</DoNotTranslate> e, em seguida, clique em <DoNotTranslate>**Lookup tables**</DoNotTranslate>. A partir daí, você pode fazer upload, download, atualizar e excluir tabelas.
