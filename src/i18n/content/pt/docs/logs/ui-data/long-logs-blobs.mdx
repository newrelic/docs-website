...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Logs**</DoNotTranslate>: Para consultar dados de blob estendidos em seu log, certifique-se de incluir crases na sintaxe do blob do seu atributo.
</figcaption>
