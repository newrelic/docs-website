    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Quando `x-edge-result-type` <DoNotTranslate>**is not**</DoNotTranslate> `Error`, este campo contém o mesmo valor que `x-edge-result-type`. Quando `x-edge-result-type` <DoNotTranslate>**is**</DoNotTranslate> `Error`, este campo contém o tipo específico de erro.
          </td>
        </tr>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Quando `x_edge_result_type` <DoNotTranslate>**is not**</DoNotTranslate> `Error`, este campo contém o mesmo valor que `x_edge_result_type`. Quando `x_edge_result_type` <DoNotTranslate>**is**</DoNotTranslate> `Error`, este campo contém o tipo específico de erro.
          </td>
        </tr>
