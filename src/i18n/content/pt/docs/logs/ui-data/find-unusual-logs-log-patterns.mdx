...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        O recurso Padrões de log não é compatível com FedRAMP. FedRAMP ou outras contas HITRUST não são elegíveis para usar padrões.
      </td>
    </tr>
...
2. Na navegação esquerda da interface de registro, clique em
...
* Crie
  ...
  para padrões adicionando [alertas NRQL](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-nrql-alert-conditions).
