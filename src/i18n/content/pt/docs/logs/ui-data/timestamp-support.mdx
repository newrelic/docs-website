...
<CollapserGroup>
  ...
  >
    Um timestamp unix <DoNotTranslate>**epoch**</DoNotTranslate> é baseado no número de segundos (ou milissegundos) decorridos desde 00:00:00 UTC de 1º de janeiro de 1970. Dois exemplos de formatos para `Fri, 03 Nov 2023 16:06:32 GMT` seriam:
...
<CollapserGroup>
  ...
  >
    Se recebermos um log JSON como este com `timestamp` no formato <DoNotTranslate>**epoch**</DoNotTranslate> (sem precisão de ms):
  ...
  >
    Se recebermos um log JSON como este com timestamp no formato <DoNotTranslate>**ISO8601**</DoNotTranslate> como este:
...
<CollapserGroup>
  ...
  >
    ...
    Para esta mensagem faça log com timestamp no formato <DoNotTranslate>**ISO8601**</DoNotTranslate>:
  ...
  >
    ...
    Para a seguinte mensagem do log com timestamp no formato <DoNotTranslate>**epoch**</DoNotTranslate>:
