...
<Callout variant="important">
  Se você estiver usando uma conta regional, use o endpoint apropriado em vez de `newrelic.syslog.nr-data.net`:

  * Contas da UE: `newrelic.syslog.eu.nr-data.net`
  * Contas JP: `newrelic.syslog.jp.nr-data.net`

  Não se esqueça de substituí-lo nos arquivos de configuração; usar o endpoint dos EUA para uma conta regional não funcionará.
</Callout>
