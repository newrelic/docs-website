...
6. (Opcional): Adicione atributo personalizado aos seus dados `syslog` .
   ...
   * <DoNotTranslate>**Add custom attributes directly in the template string.**</DoNotTranslate> Você precisará escapar das aspas duplas (`"`) para os valores da string. Por exemplo:
   ...
   * <DoNotTranslate>**Add custom attributes using a custom property variable in the template string.**</DoNotTranslate> Este método evita a necessidade de escapar de valores de string.
