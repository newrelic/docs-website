...
<CollapserGroup>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Este é o campo <DoNotTranslate>**main**</DoNotTranslate> mensagem do log que é pesquisado por padrão
          </td>
        </tr>
  ...
  >
    Ao usar o formato detalhado para criar seu corpo, ele deve ser um <DoNotTranslate>**JSON array**</DoNotTranslate> contendo um ou mais objetos JSON, cada um deles com o seguinte formato:
...
Aceitamos qualquer carga JSON válida. A carga deve ser codificada como <DoNotTranslate>**UTF-8**</DoNotTranslate>.
...
* Obtenha visibilidade mais profunda dos dados de desempenho do seu aplicativo e da sua plataforma encaminhando seu log com nossos recursos [de contexto de log](/docs/logs/logs-context/configure-logs-context-apm-agents/) .
