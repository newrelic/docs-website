...
Endpoint da [União Europeia](/docs/accounts/accounts-billing/account-setup/choose-your-data-center) (UE):

```
https://log-api.eu.newrelic.com/log/v1
```

Endpoint do [Japão](/docs/accounts/accounts-billing/account-setup/choose-your-data-center):
...
5. Envie sua mensagem JSON para o endpoint HTTP apropriado para sua conta New Relic em uma solicitação `POST` .
   ...
   * Japão: `https://log-api.jp.nr-data.net/log/v1`
