...
1. Instale a integração do New Relic Kubernetes seguindo as etapas [desta página](/install/kubernetes). Esta integração inclui o plug-in Kubernetes para log.
