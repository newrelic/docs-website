...
Para desativar os recursos de encaminhamento de logs, siga os procedimentos padrão na [documentaçãoGoogle Cloud Platform ](https://cloud.google.com/sdk/docs/). Você não precisa fazer mais nada no New Relic.