...
<CollapserGroup>
  <Collapser id="ingest-url" title="1. Gere um URL de ingestão do GCP Pub/Sub.">
  ...
  <Collapser id="create-gcp-topic" title="2. Crie um tópico Pub/Sub do GCP.">
    ...
    2. Clique em <DNT>**Create Topic**</DNT>.
    3. Insira um <DNT>**Topic ID**</DNT> significativo e configure outras opções conforme necessário.
    4. Clique em <DNT>**Create Topic**</DNT>.
  </Collapser>

  <Collapser id="configure-gcp-log-forwarding" title="3. Prepare o tópico Pub/Sub do GCP para encaminhar o log para New Relic.">
  ...
  <Collapser id="forward-logs" title="4. Crie um coletor de roteamento para encaminhar o log para New Relic.">
    ...
    2. Clique em <DNT>**Create Sink**</DNT>.
    3. Insira <DNT>**Sink name**</DNT> e <DNT>**Sink description**</DNT> e clique em <DNT>**Next**</DNT>.
    4. Em <DNT>**Select sink service**</DNT>, selecione <DNT>**Cloud Pub/Sub topic**</DNT> e selecione o [tópico do Pub/Sub](#create-gcp-topic) que você criou anteriormente.
    5. Configure os filtros restantes conforme necessário e clique em <DNT>**Create sink**</DNT> para concluir a configuração.
  </Collapser>
</CollapserGroup>
...
<CollapserGroup>
  <Collapser id="dataflow-login-gcp" title="1. log em sua conta Google Cloud Platform .">
  ...
  <Collapser id="dataflow-repo" title="2. Clone o repositório DataflowTemplates GitHub.">
  ...
  <Collapser id="dataflow-configuration" title="3. Compile e execute o encaminhador do Dataflow.">
  ...
  <Collapser id="dataflow-bucket" title="4. Crie um bucket do GCP para o modelo do Dataflow.">
  ...
  <Collapser id="dataflow-account" title="5. Crie uma conta de serviço.">
  ...
  <Collapser id="dataflow-compile" title="6. Compile e publique o modelo PubsubToNewRelic.">
  ...
  <Collapser id="dataflow-job" title="7. Execute o modelo como um job do Dataflow.">
    ...
    * A New Relic <InlinePopover type="licenseKey" />usada para enviar seu registro

    Por padrão, este comando envia logs para o data center dos EUA. Para contas da UE ou do Japão, consulte a seção abaixo.

    <CollapserGroup>
      <Collapser id="eu-customers-gcp-dataflow" title="Contas das regiões da Europa e do Japão">
        As contas da Europa e do Japão também devem adicionar o parâmetro `logsApiUrl` com o endpoint apropriado.
  ...
  <Collapser id="dataflow-config" title="8. Opcional: ajuste seu trabalho de direcionamento de logs do Dataflow.">
