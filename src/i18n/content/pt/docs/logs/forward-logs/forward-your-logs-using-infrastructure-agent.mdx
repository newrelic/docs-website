...
<CollapserGroup>
  ...
  >
    ...
    <DNT>**Linux**</DNT> Para proxies `HTTP` você não precisa configurar nenhum certificado. O plug-in carrega os certificados do sistema e o New Relic envia o log para o endpoint de registro. No entanto, você pode especificar o certificado autoassinado do proxy (arquivo PEM) usando o parâmetro `caBundleFile` ou `caBundleDir` .
