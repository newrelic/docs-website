...
3. Procure por `newrelic` e marque
   ...
   para encontrar `newrelic-log-ingestion`.

4. Abra os detalhes `newrelic-log-ingestion` e clique em
...
5. No menu
   ...
   e configure o encaminhamento de logs usando as seguintes variáveis de ambiente:
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Um booleano para determinar se você deseja gerar mensagens de depuração no console do CloudWatch. <DoNotTranslate>**Optional.**</DoNotTranslate>
    ...
    <tr>
      ...
      <td>
        <InlinePopover type="licenseKey"/>é usado para enviar dados para o New Relic. <DoNotTranslate>**Required.**</DoNotTranslate>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Determina se os logs serão encaminhados para New Relic. <DoNotTranslate>**Required.**</DoNotTranslate> Para ativar a geração de registros, defina como `true`.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Especifique a tag a ser adicionada a todos os eventos de log. <DoNotTranslate>**Optional.**</DoNotTranslate>
    ...
    <tr>
      ...
      <td>
        Se você configurou seu grupo log do Lambda para usar um caminho diferente de `/aws/lambda`, poderá especificá-lo com esta variável. <DoNotTranslate>**Optional.**</DoNotTranslate>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Se você configurou seu grupo log de VPC para usar um caminho diferente de `/aws/vpc/flow-log`, poderá especificá-lo com esta variável. <DoNotTranslate>**Optional.**</DoNotTranslate>
      </td>
    </tr>
  </tbody>
</table>

6. Reconheça que o aplicativo cria funções personalizadas do IAM e clique em
...
2. Role para baixo e clique na guia `Configuration` .

3. No menu esquerdo da guia `Configuration` , clique em `Environment Variables`.

4. Aqui você pode ver uma lista das variáveis de ambiente já existentes, basta clicar em

   <DoNotTranslate>**Edit**</DoNotTranslate>

   no canto superior direito da tabela `Environment Variables` .

5. Atualize `NR_LOGGING_ENDPOINT` com o endpoint apropriado:

   * Para _nós_: `https://log-api.newrelic.com/log/v1`
   * Para _a UE_: `https://log-api.eu.newrelic.com/log/v1`
   * Para _FedRAMP_: `https://gov-log-api.newrelic.com/log/v1`
...
Você pode configurar o número de tentativas que deseja realizar caso a função falhe no envio dos dados em caso de problemas de comunicação. O número recomendado é de 3 tentativas, mas você pode alterar o comportamento de novas tentativas alterando o parâmetro abaixo:
