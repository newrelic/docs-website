...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Utilize nossas soluções para [encaminhar log do sistema operacional](#forward-infra), incluindo nosso agente de infraestrutura, Fluent Bit, Fluentd, Logstash e syslog/TCP. Utilize nossa [instalação guiada para monitoramento de infraestrutura](/docs/logs/forward-logs/forward-your-logs-using-infrastructure-agent) como um coletor de dados leve para log de seus aplicativos e hosts.
      </td>
    </tr>
...
5. Se aplicável, configure o agente
