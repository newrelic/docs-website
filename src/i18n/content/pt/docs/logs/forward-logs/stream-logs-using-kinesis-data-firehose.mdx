...
6. Em <DNT>**HTTP endpoint URL**</DNT>, selecione <DNT>**New Relic logs - US**</DNT>. Este é o endpoint dos EUA (padrão) ([https://aws-api.newrelic.com/firehose/v1](https://aws-api.newrelic.com/firehose/v1)). Para usar o endpoint da UE, conclua as etapas restantes neste procedimento e, em seguida, vá para a [configuração de conta da UE](#configure-eu-stream).
...
## Configure seu stream para enviar logs para contas da UE ou do JP [#configure-eu-stream]

Se você tiver uma conta da New Relic em nosso data center da EU ou JP:
...
5. Atualize o valor de <DNT>**HTTP endpoint URL**</DNT> para o endpoint do Firehose apropriado para a sua região:
