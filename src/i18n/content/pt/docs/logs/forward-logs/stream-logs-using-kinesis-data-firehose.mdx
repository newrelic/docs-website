...
<Callout variant="important">
  Se você for um [cliente FedRAMP](/docs/security/security-privacy/compliance/certificates-standards-regulations/fedramp-moderate), não deverá habilitar o streaming log usando o Kinesis Data Firehose porque a integração AWS Kinesis Data Firehose não é autorizada pelo FedRAMP no momento.
</Callout>
