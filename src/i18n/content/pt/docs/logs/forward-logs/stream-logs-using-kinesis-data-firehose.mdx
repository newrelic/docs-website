...
2. Siga os procedimentos para [criar um fluxo de entrega do Amazon Kinesis Data Firehose](https://docs.aws.amazon.com/firehose/latest/dev/basic-create.html) e selecione New Relic como destino: No AWS Management Console, vá para <DoNotTranslate>**Amazon Kinesis**</DoNotTranslate>.
3. Selecione <DoNotTranslate>**Kinesis Data Firehose**</DoNotTranslate> e clique em <DoNotTranslate>**Create delivery stream**</DoNotTranslate>.
4. Insira um nome para o stream e selecione sua fonte de dados.
5. Ao selecionar o destino, clique em <DoNotTranslate>**Third-party partner**</DoNotTranslate> e depois <DoNotTranslate>**New Relic.**</DoNotTranslate>
6. Em <DoNotTranslate>**HTTP endpoint URL**</DoNotTranslate>, selecione <DoNotTranslate>**New Relic logs - US**</DoNotTranslate>. Este é o endpoint dos EUA ([https://aws-api.newrelic.com/firehose/v1](https://aws-api.newrelic.com/firehose/v1)). Para usar o endpoint da UE, conclua as etapas restantes deste procedimento e vá para [configuração da conta da UE](#configure-eu-stream).
7. Cole seu <InlinePopover type="licenseKey"/>no campo <DoNotTranslate>**API key**</DoNotTranslate> .
8. Certifique-se de que <DoNotTranslate>**Content encoding**</DoNotTranslate> esteja definido como `GZIP`.
9. Defina um <DoNotTranslate>**buffer size**</DoNotTranslate> de `1 MiB` em `Buffer hints/Buffer size`. (Observe que a seção `Buffer hints` é dobrada por padrão. Para obter mais informações, consulte a [seção de configurações de buffer](#buffer-settings).
...
2. Depois que seu stream for criado, navegue até o [console do Amazon Kinesis](https://console.aws.amazon.com/kinesis/) e clique em <DoNotTranslate>**Delivery streams**</DoNotTranslate>.

3. Clique no nome do fluxo de entrega recém-criado e selecione a guia <DoNotTranslate>**Configuration**</DoNotTranslate> .

4. Ao lado da seção <DoNotTranslate>**Destination settings**</DoNotTranslate> , clique em <DoNotTranslate>**Edit**</DoNotTranslate>.

5. Atualize o valor de <DoNotTranslate>**HTTP endpoint URL**</DoNotTranslate> para nosso endpoint Firehose para contas da UE:

   ```
   https://aws-api.eu.newrelic.com/firehose/v1
   ```

6. Clique em <DoNotTranslate>**Save changes**</DoNotTranslate> para garantir que seu stream esteja atualizado.
