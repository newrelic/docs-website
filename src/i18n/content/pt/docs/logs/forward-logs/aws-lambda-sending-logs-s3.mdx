...
Você pode enviar seus [buckets do Amazon S3](https://aws.amazon.com/s3/) para New Relic usando nossa função do Lambda AWS , `NewRelic-log-ingestion-s3`. Isso pode ser facilmente implantado no repositório do aplicativo AWS Serverless.
