...
<CollapserGroup>
  ...
  >
    ...
    3. Under <DoNotTranslate>**Allow Blob public access**</DoNotTranslate>, select <DoNotTranslate>**Disabled**</DoNotTranslate>.<img title="Disabling public access to the blobs/containers in the Storage account" alt="Disabling public access to the blobs/containers in the Storage account" src={disablePublicBlobAccessStorageAccount}/>
  ...
  >
    ...
    4. Under <DoNotTranslate>**Platform settings**</DoNotTranslate>, for <DoNotTranslate>**FTP state**</DoNotTranslate>, select <DoNotTranslate>**Disabled**</DoNotTranslate>.<img title="Disabling FTP access to the Function App" alt="Disabling FTP access to the Function App" src={disableFtpAccessStorageAccount}/>
  ...
  >
    ...
    2. No menu esquerdo, vá para <DoNotTranslate>**Settings > Configuration**</DoNotTranslate>.
    3. Selecione a guia <DoNotTranslate>**General settings**</DoNotTranslate> .
    4. Under <DoNotTranslate>**Platform settings**</DoNotTranslate>, for <DoNotTranslate>**HTTPS Only**</DoNotTranslate>, select <DoNotTranslate>**On**</DoNotTranslate>.<img title="Enforcing HTTPS to the Function App" alt="Enforcing HTTPS to the Function App" src={enforceHttpsFunctionApp}/>
    5. Clique em <DoNotTranslate>**Save**</DoNotTranslate>.
  </Collapser>
  ...
  >
    ...
    3. Inside the <DoNotTranslate>**Inbound Traffic**</DoNotTranslate> box, click <DoNotTranslate>**Access restriction**</DoNotTranslate>.<img title="Disabling public network access to the Function App" alt="Disabling public network access to the Function App" src={disablePublicNetworkAccessFunctionApp}/>
