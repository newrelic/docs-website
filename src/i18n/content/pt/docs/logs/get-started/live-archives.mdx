...
<Steps>
  ...
  <Step>
    ...
    5. Os
       ...
       dias serão atualizados para refletir a retenção regular _e_ a [retençãoLive Archives ](/docs/logs/get-started/live-archives-billing/#what-counts).
  ...
  <Step>
    ...
    Existem duas maneiras de consultar Live Archives: com Lucene ou NRQL. Se você quiser usar a sintaxe de registro com a qual está familiarizado fora do New Relic, sugerimos consultar na interface <DoNotTranslate>**Logs**</DoNotTranslate> . Para consultar Live Archives você precisará do recurso de **Live archives query**.
  ...
  <Step>
    ...
    Caso queira consultar utilizando a mesma linguagem que utiliza para Errors Inbox ou alerta, sugerimos consultar em NRQL. Para consultar Live Archives você precisará do recurso de **Live archives query** .
