...
<Steps>
  ...
  <Step>
    ...
    6. Clique em **NRQL** no canto superior direito.

    7. Insira a consulta NRQL que você deseja executar.

    8. Pratique a consulta primeiro para ter certeza de que funciona conforme o esperado.
    ...
    10. Uma tela mostrará que você está prestes a consultar Live Archives. Consultar Live Archives é mais caro, então selecione
