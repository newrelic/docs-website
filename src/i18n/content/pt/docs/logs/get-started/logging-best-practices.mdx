...
* Instale o painel <DNT>**Logs analysis**</DNT> e/ou <DNT>**APM logs monitoring quickstart**</DNT> para obter rapidamente mais insights sobre seus dados log . Para adicionar esses painéis, vá para <DNT>**[one.newrelic.com](https://one.newrelic.com) > Add Data > Logging > Dashboards**</DNT>.
