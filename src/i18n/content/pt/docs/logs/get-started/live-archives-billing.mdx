---
title: 'Armazenamento Live Archives : cobrança e regras'
tags:
  - Logs
  - Log management
  - Get started
...
Quando você compra o complemento Live Archives Storage, medimos o armazenamento em GB meses. Os meses GB são calculados para cada dia.
...
* Repita esta mesma medição para cada dia do mês 9, já que o “balde” de 30 dias de armazenamento do Live Archives permanece cheio com 30 GB para o mês inteiro.
