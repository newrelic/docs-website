...
O recurso fluxo de trabalho está localizado no menu <DoNotTranslate>**Alerts **</DoNotTranslate>.

1. Vá para <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Enrich and Notify > Workflow > Add a workflow**</DoNotTranslate>.
...
Para acessar o log de notificação de problemas, vá para <DoNotTranslate>**[one.newrelic.com > Alerts > Workflows](https://one.newrelic.com/alerts-ai/workflows)**</DoNotTranslate> e clique em <DoNotTranslate>**Issue notification log**</DoNotTranslate>.
