...
Uma explicação das variáveis utilizadas para [o fluxo de trabalho](/docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows) de inteligência aplicada da New Relic.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Uma lista de componentes de aprendizado de máquina de inteligência aplicada da New Relic.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Uma lista de sinais clássicos de aprendizado de máquina de inteligência aplicada da New Relic.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        (Descontinuado) Uma lista de respostas sugeridas pelo aprendizado de máquina de inteligência aplicada da New Relic.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Se o problema estiver correlacionado (verdadeiro, falso).
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Se o problema for reconhecido (verdadeiro, falso).
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ID da conta associada aos ambientes de inteligência aplicada da New Relic.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Nível de prioridade do problema (CRÍTICO, ALTO, MÉDIO, BAIXO).
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Prioridade de emissão em letras minúsculas (Crítica, Alta, Média, Baixa).
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Estado do ciclo de vida do problema (CRIADO, ATIVADO, FECHADO).
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Estado do ciclo de vida do problema em letras minúsculas (ativo (aberto), fechado).
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        O evento disparador de notificação (STATE_CHANGE, INCIDENT_ADDED, INCIDENT_CLOSED, CLOSE_INACTIVE, CLOSE_TTL, USER_ACTION, PRIORITY_CHANGED, MERGE_REQUEST).
      </td>
    </tr>
...
<CollapserGroup>
  ...
  >
    Há momentos em que você deseja saber quando o tráfego para seu aplicativo diminui. Você pode usar o &#x7B;&#x7B;entitiesData.names}} variável no lugar do nome do seu aplicativo.
  ...
  >
    Há momentos em que você deseja saber quando seu pedido de transação falhou. Esta consulta mostra as respostas de código de status HTTP mais recentes filtradas por &#x7B;&#x7B;entitiesData.names}} variável que violou seu limite de política de alertas.
  ...
  >
    Se a consulta condição do alerta for facetada, você poderá usar o valor da faceta que aciona o incidente em uma consulta. Por exemplo, se a condição do alerta for esta:
