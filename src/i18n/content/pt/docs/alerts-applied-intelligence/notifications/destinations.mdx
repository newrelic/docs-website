...
<figcaption>
  Vá para <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Destinations**</DoNotTranslate>. Utilize destinos para escolher para onde suas notificações serão enviadas.
</figcaption>

1. Vá para

   <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Enrich and Notify > Destinations**</DoNotTranslate>
...
<figcaption>
  Vá para <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Destinations**</DoNotTranslate>. Clique na guia <DoNotTranslate>**Destinations**</DoNotTranslate> para ver a tabela de destinos.
</figcaption>
