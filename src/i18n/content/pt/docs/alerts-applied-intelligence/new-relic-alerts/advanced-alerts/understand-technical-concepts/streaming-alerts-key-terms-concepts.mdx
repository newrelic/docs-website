...
<CollapserGroup>
  ...
  >
    ...
    <figcaption>
      Se seus dados chegarem de forma consistente e previsível, use <DoNotTranslate>**event flow**</DoNotTranslate>. Se seus dados chegarem de forma inconsistente e imprevisível, use <DoNotTranslate>**event timer**</DoNotTranslate>.
    </figcaption>
  </Collapser>
</CollapserGroup>
...
Você pode definir sua janela de agregação para qualquer valor entre <DoNotTranslate>**30 seconds**</DoNotTranslate> e <DoNotTranslate>**6 hours**</DoNotTranslate>. O padrão é <DoNotTranslate>**1 minute**</DoNotTranslate>.
...
O atraso padrão é <DoNotTranslate>**2 minutes**</DoNotTranslate>. O padrão do temporizador é <DoNotTranslate>**1 minute**</DoNotTranslate>, tem um valor mínimo de <DoNotTranslate>**5 seconds**</DoNotTranslate> e um valor máximo de <DoNotTranslate>**20 minutes**</DoNotTranslate>.
