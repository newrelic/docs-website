...
<figcaption>
  Vá para <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert conditions (Policies) > (select a policy)**</DoNotTranslate> e depois <DoNotTranslate>**Add a condition**</DoNotTranslate>. A perda de sinal está disponível apenas para condições NRQL.
</figcaption>
