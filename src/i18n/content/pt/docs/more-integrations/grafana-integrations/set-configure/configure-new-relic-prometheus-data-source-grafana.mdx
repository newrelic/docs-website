...
1. No New Relic, [crie uma nova chave de consulta do Insights](/docs/apis/intro-apis/new-relic-api-keys/#insights-query-key).
   ...
   <Callout variant="important">
     Observação: no Grafana, você precisará colocar isso em um cabeçalho HTTP <DoNotTranslate>**X-Query-Key**</DoNotTranslate> personalizado (veja a etapa 7 abaixo), mas é a mesma entidade que a chave de consulta New Relic.
   </Callout>

2. Na tela [Grafana](https://grafana.com/login) <DoNotTranslate>**Home**</DoNotTranslate> , vá para <DoNotTranslate>**Configuration > Data Sources**</DoNotTranslate> e clique em <DoNotTranslate>**Add data source**</DoNotTranslate>.

3. Na tela <DoNotTranslate>**Add data source**</DoNotTranslate> em <DoNotTranslate>**Time series databases**</DoNotTranslate> opções, selecione <DoNotTranslate>**Prometheus**</DoNotTranslate>.

4. Insira o <DoNotTranslate>**Name**</DoNotTranslate> que você deseja usar para sua nova fonte de dados do Prometheus.

5. Defina o botão <DoNotTranslate>**Default**</DoNotTranslate> para a posição ativado ou desativado, dependendo se você deseja que esta seja sua fonte de dados padrão para a consulta do Prometheus.

   * Desativado: esta não é sua fonte de dados padrão
   * Ativado: esta é sua fonte de dados padrão

6. Insira o <DoNotTranslate>**URL**</DoNotTranslate> correto:
...
7. Em <DoNotTranslate>**Custom Headers**</DoNotTranslate>, selecione <DoNotTranslate>**Add Header**</DoNotTranslate>. Defina o nome <DoNotTranslate>**Header**</DoNotTranslate> como <DoNotTranslate>**X-Query-Key.**</DoNotTranslate> Para <DoNotTranslate>**Value**</DoNotTranslate>, insira a chave de consulta que você criou na etapa 1.

8. Clique em <DoNotTranslate>**Save & Test**</DoNotTranslate>.

<Callout variant="tip">
  Se seus gráficos aparecerem como agrupamentos de pontos e não como linhas conectadas, você poderá alterar o estilo do gráfico para exibir linhas. Para fazer isso, vá até o <DoNotTranslate>**[Graph panel](https://grafana.com/docs/grafana/latest/panels/visualizations/graph-panel/)**</DoNotTranslate> do Grafana e selecione <DoNotTranslate>**Stacking and null value > connected**</DoNotTranslate>.
</Callout>
...
<CollapserGroup>
  ...
  >
    O parâmetro [chave de consulta](/docs/apis/get-started/intro-apis/types-new-relic-api-keys#x-query-key) é necessário para autenticar no New Relic e identificar a conta que contém sua métrica. Grafana chama isso de <DoNotTranslate>**X-Query key**</DoNotTranslate>, embora apareça como <DoNotTranslate>**Query key**</DoNotTranslate> na interface do New Relic.
