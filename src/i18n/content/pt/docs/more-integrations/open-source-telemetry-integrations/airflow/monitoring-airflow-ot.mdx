...
2. Ao instalar com pip, adicione o `otel` extra ao comando. a. por exemplo. `pip install "apache-airflow[otel]"`
...
4. Vá para
   ...
   <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & services > Services - OpenTelemetry > Airflow**</DoNotTranslate>

   .

5. Clique em

   <DoNotTranslate>**Metrics Explorer**</DoNotTranslate>
