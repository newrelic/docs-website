...
Para entender como configurar a temporalidade de agregação, consulte estes exemplos usando os SDKs [Java](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/apm-monitoring/opentelemetry-apm-java) e [Python](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/apm-monitoring/opentelemetry-apm-python) OpenTelemetry.
