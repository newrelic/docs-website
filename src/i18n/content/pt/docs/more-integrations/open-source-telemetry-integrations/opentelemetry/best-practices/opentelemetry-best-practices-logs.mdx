...
O [exemplo de log in Context with Log4j2 no GitHub](https://github.com/newrelic/newrelic-opentelemetry-examples/tree/main/other-examples/java/logs-in-context-log4j2) demonstra um exemplo funcional de ponta a ponta para um aplicativo Java simples usando Log4j2.
