...
OpenTelemetry é um kit de ferramentas para reunir telemetria a partir de aplicativos, infraestrutura (ex. hosts, k8s, etc.) e muito mais. Ao configurar fontes de dados OpenTelemetry para exportar para o New Relic, você pode aproveitar uma ampla gama de recursos da plataforma para analisar os dados e diagnosticar problemas.

Esta página fornece uma visão geral do OpenTelemetry e do New Relic. Para obter exemplos de código funcional que demonstram padrões de integração comuns, incluindo APM e monitoramento de infraestrutura, consulte [introdução ao OpenTelemetry with New Relic](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/opentelemetry-get-started-intro/). Para obter informações sobre como a New Relic recebe, processa e ingere dados do OpenTelemetry, consulte [Dados do OpenTelemetry na New Relic](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-data-overview/) e, em particular, detalhes sobre [o endpoint OTLP da New Relic](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-otlp/).
...
Em muitos casos, há sobreposição entre recurso e componentes disponíveis no OpenTelemetry e no New Relic. Por exemplo, [o monitoramento OpenTelemetry APM ](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/apm-monitoring/opentelemetry-apm-intro/)espelha [o agente New Relic APM ](/docs/apm/new-relic-apm/getting-started/introduction-apm/), e [o monitoramento de infraestrutura com o coletor OpenTelemetry](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/collector-infra-monitoring/opentelemetry-collector-infra-intro/) espelha os recursos do [agente do New Relic Infrastructure](/docs/infrastructure/infrastructure-monitoring/get-started/get-started-infrastructure-monitoring/).
