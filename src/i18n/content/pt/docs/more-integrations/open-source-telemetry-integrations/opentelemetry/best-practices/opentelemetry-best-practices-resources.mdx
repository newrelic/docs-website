...
Consulte o exemplo de monitoramento de host no [coletor para monitoramento de infraestrutura](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/collector-infra-monitoring/opentelemetry-collector-infra-intro/) para obter mais detalhes.
...
Consulte o exemplo Redis em [Coletor para monitoramento de infraestrutura](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/collector-infra-monitoring/opentelemetry-collector-infra-intro/) para obter mais detalhes.
