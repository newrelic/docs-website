...
<Steps>
  ...
  <Step>
    ...
    * O exportador OpenTelemetry Protocol (OTLP) para enviar dados para o [endpoint OTLP da New Relic](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-otlp).
  ...
  <Step>
    ...
    * Encontre sua entidade em
      ...
      <DoNotTranslate>**All entities -> Services - OpenTelemetry**</DoNotTranslate>

      . O nome da entidade é definido como o valor do atributo de recurso `service.name` do aplicativo. Para obter mais informações sobre como as entidades de serviço New Relic são derivadas do atributo de recursos OpenTelemetry , consulte [Serviços](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-best-practices-resources/#services)
    ...
    * Consulte [InterfaceOpenTelemetry APM ](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/apm-monitoring/opentelemetry-apm-ui)para obter mais informações.
