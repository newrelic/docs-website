...
<Steps>
  ...
  <Step>
    ...
    New Relic suporta ingestão nativa de OTLP (OpenTelemetry Protocol). Consulte [Configuração OTLP](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-otlp/) para obter instruções detalhadas de configuração.
  </Step>
