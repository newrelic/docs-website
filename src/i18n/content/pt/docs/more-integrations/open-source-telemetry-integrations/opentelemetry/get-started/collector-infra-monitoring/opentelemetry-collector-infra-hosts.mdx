...
* Defina `$NEW_RELIC_OTLP_ENDPOINT` env var para o [endpoint](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-otlp) apropriado.
