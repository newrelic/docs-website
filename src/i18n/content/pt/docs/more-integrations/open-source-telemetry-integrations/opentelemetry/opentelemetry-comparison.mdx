...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        Melhore a experiência do usuário final no navegador e em dispositivos móveis
      </td>
...
## Página do navegador [#browsers-page]

<CollapserGroup>
  <Collapser
    className="freq-link"
    id="auto-instrumentation"
    title="Instrumentação automática do aplicativo frontend do navegador"
  >
    Agente New Relic: ✅ OpenTelemetry em New Relic: 👀
...
<CollapserGroup>
  ...
  <Collapser
    className="freq-link"
    id="auto-log-ingest"
    title="Log in context: ingestão automática de log"
  >
    Agente New Relic: ✅ OpenTelemetry em New Relic: ❌
  </Collapser>
