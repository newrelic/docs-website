...
A interface OpenTelemetry APM é uma experiência com curadoria disponível para [serviço entidade](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-best-practices-resources/#services). Se você ainda não configurou seu serviço com New Relic e OpenTelemetry, consulte [monitoramentoOpenTelemetry APM ](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/apm-monitoring/opentelemetry-apm-intro/).
...
Dentro do explorador de entidades você pode filtrar por [tag entidade](/docs/new-relic-solutions/new-relic-one/core-concepts/use-tags-help-organize-find-your-data/). Para obter detalhes sobre como as tags entidade são computadas, consulte [os recursos de OpenTelemetry no New Relic](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-best-practices-resources).
...
* **Instância**: detalhamento de sinais clássicos por instância quando um serviço é escalado horizontalmente. Depende do atributo de recurso `service.instance.id` (ver [atributo de entidade de serviço](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-best-practices-resources/#services) para mais detalhes).

## Página: distributed tracing [#distributed-tracing-page]

A distributed tracing página fornece detalhados insights sobre os dados de trace do OpenTelemetry. Consulte [distributed tracing](/docs/distributed-tracing/ui-data/understand-use-distributed-tracing-ui/) para obter informações de uso da página. Consulte [traces do OpenTelemetry no New Relic](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-best-practices-traces) para obter detalhes sobre como os dados de trace do OpenTelemetry são ingeridos no New Relic.
