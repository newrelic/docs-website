...
Esta página descreve como o New Relic lida com os intervalos OpenTelemetry recebidos por meio do [endpoint OTLP do New Relic](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-otlp). A integração do traces de OpenTelemetry com New Relic requer a configuração da origem do trace para exportar para este endpoint - revise os requisitos de configuração endpoint. Para obter informações sobre como configurar serviços com traces de OpenTelemetry, consulte [OpenTelemetry APM monitoramento](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/apm-monitoring/opentelemetry-apm-intro).
