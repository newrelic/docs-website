...
2. Clique em <DoNotTranslate>**Import a Product**</DoNotTranslate> e importe o bloco New Relic Service Broker para VMware Tanzu.
...
3. Clique no botão <DoNotTranslate>**+**</DoNotTranslate> à direita de “New Relic Service Broker” que você carregou.
...
16. Refaça o aplicativo. Você pode selecionar o link na parte superior da página <DoNotTranslate>**Bind**</DoNotTranslate> ou em uma janela de terminal e executar `cf restage` para fazer as alterações.
