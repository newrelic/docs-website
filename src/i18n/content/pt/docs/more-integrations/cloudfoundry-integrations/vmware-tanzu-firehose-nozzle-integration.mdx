...
<Callout variant="important">
  <DoNotTranslate>**Note**</DoNotTranslate>: ao executar o bocal como um aplicativo, você pode usar as variáveis de ambiente acima no arquivo de manifesto do aplicativo.
</Callout>
