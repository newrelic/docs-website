...
<CollapserGroup>
  <Collapser id="general-configuration" title="Configuração geral">
    ...
    <Callout variant="important">
      O proxy HTTPS não é suportado para tráfego gRPC. No entanto, o tráfego TLS permanece seguro porque o túnel TLS é estabelecido diretamente entre o cliente e o endpoint.
    </Callout>
  </Collapser>
