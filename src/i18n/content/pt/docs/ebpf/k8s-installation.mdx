    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Habilitar o relatório de métricas de rede. Quando habilitado, o agente coleta e relata métricas de rede, incluindo estatísticas TCP. Ele é renomeado de 

            `tcpStatsReporting`

            . O nome antigo está obsoleto, no entanto, a compatibilidade com versões anteriores é suportada.
          </td>
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            Descartar dados dos serviços newrelic namespace e newrelic-bundle. (RENOMEADO de 

            `dropDataNewRelic`

             para maior clareza. O nome antigo está obsoleto, mas ainda é suportado para compatibilidade com versões anteriores).
          </td>
        ...
        <tr>
          ...
          <td>
            Lista de namespaces do Kubernetes para os quais todos os dados devem ser descartados pelo agente. (RENOMEADO de 
        ...
        <tr>
          ...
          <td>
            Defina uma regex para corresponder aos nomes dos serviços k8s a serem descartados. Exemplo 
            ...
            `dropDataServiceNameRegex`
             ...
             para maior clareza. O nome antigo está obsoleto, mas ainda é compatível com versões anteriores).
          </td>
        ...
        <tr>
          ...
          <td>
            Esta configuração atua como uma exceção para a configuração 

            `dropServiceNameRegex`

            . Os nomes dos serviços que corresponderem a esta expressão regular não terão seus dados descartados por 
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Rótulos de pod para correspondência para filtragem de dados APM. Mapa vazio significa nenhuma filtragem baseada em rótulo. (Exemplo: dropPodLabels: 
        ...
        <tr>
          ...
          <td>
            Lista de nomes de entidades para descartar dados ebpf APM
          </td>
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            Rótulos de pod para corresponder à filtragem de dados de métricas de rede. Mapa vazio significa nenhuma filtragem baseada em rótulos. (Exemplo: dropPodLabels: 
        ...
        <tr>
          ...
          <td>
            Lista de nomes de entidades para descartar dados de métricas de rede para
          </td>
