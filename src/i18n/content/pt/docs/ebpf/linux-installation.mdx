    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Lista de nomes de entidades separados por vírgula para extração de dados de métricas de rede. (Exemplo: &quot;kube-dns,otel-collector,service1&quot;).
          </td>
        ...
        <tr>
          ...
          <td>
            Lista separada por vírgulas de nomes de entidades para sempre manter os dados de métricas de rede. Por padrão, todas as entidades são mantidas/habilitadas. Isso ignora o filtro DROP_NETWORK_METRICS_DATA_FOR_ENTITY_NAME. (Exemplo: &quot;critical-service,important-app,must-monitor&quot;).
          </td>
        ...
        <tr>
          ...
          <td>
            Lista separada por vírgulas de nomes de entidades para descartar dados eBPF APM. (Exemplo: &quot;kube-dns,otel-collector,service1&quot;)
          </td>
        ...
        <tr>
          ...
          <td>
            Lista separada por vírgulas dos nomes das entidades para sempre manter os dados do eBPF APM. Por padrão, todas as entidades são mantidas/habilitadas. Isso ignora o filtro DROP_APM_DATA_FOR_ENTITY_NAME. (Exemplo: &quot;critical-service,important-app,must-monitor&quot;)
          </td>
        ...
        <tr>
          ...
          <td>
            Padrão de expressão regular para corresponder aos nomes das entidades para descartar TODOS os dados (estatísticas TCP + dados APM)(Exemplo: &quot;java-app|otel-collector|\bservice1\b&quot;)
          </td>
        ...
        <tr>
          ...
          <td>
            Padrão de expressão regular para corresponder nomes de entidades para sempre manter TODOS os dados. Isso ignora todos os filtros de descarte. (Exemplo: &quot;critical-service|important-app|\bmust-monitor\b&quot;)
          </td>
        ...
        <tr>
          ...
          <td>
            Descartar todos os dados para aplicações/entidades que possuem agentes NewRelic/OpenTelemetry APM em execução
          </td>
