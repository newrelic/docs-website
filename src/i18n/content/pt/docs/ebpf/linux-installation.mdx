    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Define o caminho do diretório onde os cabeçalhos Linux necessários são baixados e colocados para uso pelo agente eBPF. Isso é útil em ambientes restritos onde o agente não consegue baixar os cabeçalhos Linux necessários. Os cabeçalhos necessários são identificados pelo agente com base na versão do kernel.
          </td>
