...
> *Há diversas [variáveis de ambiente padrão do GitHub](https://docs.github.com/en/actions/learn-github-actions/variables#default-environment-variables) que também são usadas nesses exemplos.*
