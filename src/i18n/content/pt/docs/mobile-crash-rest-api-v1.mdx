...
Para encontrar o ID da sua conta e o ID do aplicativo mobile, abra seu aplicativo mobile em [one.newrelic.com](https://one.newrelic.com), clique no ícone <DNT>**(i)**</DNT> e leia os valores da guia <DNT>**Metadata**</DNT>.
