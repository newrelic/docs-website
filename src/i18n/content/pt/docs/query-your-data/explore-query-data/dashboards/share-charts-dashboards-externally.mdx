...
<Tabs>
  ...
  <TabsPages>
    <TabsPageItem id="dashboard">
      ...
      * Se você compartilhar um dashboard com widgets que usam variáveis de template, vinculação de facetas, visualizações personalizadas, tabelas de log ou gráficos baseados em SQL ([<DNT>Lens</DNT>](/docs/new-relic-lens/query-data)), esses widgets não exibirão nenhuma informação na visualização compartilhada.
