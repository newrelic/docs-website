      ...
      <CollapserGroup>
        ...
        <Collapser id="access-dashboard-as-a-user" title="Compartilhar painel de controle externamente">
          ...
          * Sobre gatilhos de taxa de atualização
          ...
          Você pode monitorar seus custos de uso em **[New Relic Administration](https://one.newrelic.com/admin-portal) &gt; Compute Management &gt; Advanced capabilities**. Para otimizar seus custos, consulte a seção [práticas recomendadas de gestão de preços](#pricing-management).
        </Collapser>
