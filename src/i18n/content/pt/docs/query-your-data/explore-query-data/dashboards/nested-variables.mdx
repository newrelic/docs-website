...
<Callout variant="tip">
  Para reduzir a poluição visual na barra de variáveis, oculte as variáveis pai ou de suporte que não exigem entrada do usuário. Variáveis ocultas continuam funcionando normalmente. Para obter mais informações, consulte [Mostrar e ocultar variáveis](/docs/query-your-data/explore-query-data/dashboards/dashboard-template-variables/#variable-visibility).
</Callout>