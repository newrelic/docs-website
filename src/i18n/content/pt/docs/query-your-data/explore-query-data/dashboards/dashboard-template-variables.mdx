...
Para o painel personalizado, você pode usar <DNT>**template variables**</DNT> para filtrar dinamicamente gráficos e outros widgets. Variáveis de modelo tornam seu painel mais útil e ajudam você a criar painéis que podem ser reutilizados para diferentes casos de uso com mais facilidade.
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            A opção \*\*Include variable\*\* determinará a configuração padrão, incluir ou excluir, para essa variável no dashboard. Esta configuração pode ser modificada pelo usuário visualizando o dashboard usando a opção \*\*Include variable\*\* no menu dropdown de variáveis. A configuração selecionada pelo usuário será válida durante toda a sessão.
