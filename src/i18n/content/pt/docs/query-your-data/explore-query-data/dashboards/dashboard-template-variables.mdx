...
Quando você ativa o botão de alternância <DNT>**Include variable**</DNT> e seleciona um valor, os dados do dashboard são filtrados por esse valor. Você pode clicar em <DNT>**Refresh to default value**</DNT> para restaurar os padrões configurados. Para mais informações, consulte [variáveis de template](#create-variables).
