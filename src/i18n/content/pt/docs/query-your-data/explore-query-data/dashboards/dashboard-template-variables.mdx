...
<CollapserGroup>
  ...
  <Collapser
    id="from-data-types"
    title={<>Use variables to select your <InlineCode>
      FROM
    </InlineCode> data type</>
    }
  >
  ...
  <Collapser id="titles-labels-on-your-list-variables" title="Use titles or labels on your list variables">
