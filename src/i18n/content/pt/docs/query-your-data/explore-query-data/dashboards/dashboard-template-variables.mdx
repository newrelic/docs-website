...
<CollapserGroup>
  ...
  >
    ...
    1. Em um novo dashboard sem variáveis, clique no botão editar <Icon name="fe-edit-2"/> botão e, em seguida, clique no botão <DNT>**+ Add variable**</DNT> localizado no canto superior esquerdo. Depois de terminar de adicionar variáveis, clique em <DNT>**Done editing**</DNT>.
...
Aqui está um exemplo do widget resultante, à direita, com o dropdown `country` à esquerda.<img title="Country template variable example" alt="Country template variable example" src="/images/dashboards_screenshot-crop_country-variable-example.webp"/>
...
<CollapserGroup>
  ...
  <Collapser
    id="from-data-types"
    title="Use variáveis para selecionar seu tipo de dados `FROM`"
  >
