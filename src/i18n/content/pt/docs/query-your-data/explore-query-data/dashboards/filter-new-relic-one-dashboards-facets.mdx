...
Para saber mais sobre este recurso, consulte a [postagem no Fórum de Suporte sobre a filtragem de facetas](https://support.newrelic.com/s/hubtopic/aAX8W0000008aPj/facet-linking-in-new-relic-one-now-you-can-use-facets-to-filter-your-new-reli).
