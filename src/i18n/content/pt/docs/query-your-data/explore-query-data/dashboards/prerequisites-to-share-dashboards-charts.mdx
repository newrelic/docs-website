...
<CollapserGroup>
  ...
  <Collapser id="enable-disable-policy" title="Habilitar ou desabilitar a política de criação de URL ao vivo em contas">
    ...
    * Substitua `1, 2, 3` pelos IDs de conta reais.
