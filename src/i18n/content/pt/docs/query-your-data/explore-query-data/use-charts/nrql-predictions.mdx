...
<DNT>**NRQL predictions**</DNT> está disponível para todos os clientes e todos os usuários. [CCUs Core](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing/#core-compute-capacity-unit) são consumidas quando as consultas NRQL são executadas com a cláusula `PREDICT`.
...
<CollapserGroup>
  ...
  >
    ...
    <figcaption>
      \{&lt;&gt;Exemplo de previsões feitas com a palavra-chave &lt;InlineCode&gt;BY&lt;/InlineCode&gt;. A área delimitada indica qual seção do gráfico é afetada pela palavra-chave &lt;InlineCode&gt;BY&lt;/InlineCode&gt;.&lt;/&gt;}
    </figcaption>
  </Collapser>
  ...
  >
    ...
    <figcaption>
      \{&lt;&gt;Exemplo de previsões feitas com a palavra-chave &lt;InlineCode&gt;USING&lt;/InlineCode&gt;. A palavra-chave &lt;InlineCode&gt;USING&lt;/InlineCode&gt; afeta a quantidade de dados usados para treinamento que não é visualizada no gráfico.&lt;/&gt;}
    </figcaption>
  </Collapser>
