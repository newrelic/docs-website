...
<CollapserGroup>
  ...
  >
    ...
    4. Clique na entidade de seu interesse e, no menu suspenso, clique em um dos links dessa entidade (você verá os links <DNT>**Entity summary**</DNT> e <DNT>**Logs**</DNT> ).
