...
Opcionalmente, defina limites para colorir o medidor com base em seu valor. Os gráficos de medidor suportam limites <DNT>**Good**</DNT>, <DNT>**Warning**</DNT>, <DNT>**Approaching critical**</DNT> e <DNT>**Critical**</DNT>. Cada limite entra em vigor a partir de um valor que você especifica, e o medidor muda de cor à medida que o valor passa para cada intervalo.
