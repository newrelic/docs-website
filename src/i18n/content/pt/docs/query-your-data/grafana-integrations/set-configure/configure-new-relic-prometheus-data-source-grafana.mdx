...
1. No New Relic, [crie uma nova chave de consulta do Insights](/docs/apis/intro-apis/new-relic-api-keys/#insights-query-key).
   ...
   <Callout variant="important">
     No Grafana, você precisará colocar isso em um cabeçalho HTTP <DNT>**X-Query-Key**</DNT> personalizado (veja a etapa 7 abaixo), mas é a mesma entidade que a chave de consulta do New Relic.

     Se a sua conta estiver na **região do JP**, as chaves de consulta do Insights não são suportadas. Em vez disso, crie uma [chave de API de usuário](/docs/apis/intro-apis/new-relic-api-keys/#user-key) e use-a com o cabeçalho <DNT>**api-key**</DNT> na etapa 7.
   </Callout>
...
6. Insira o <DNT>**URL**</DNT> correto:
   ...
   * EUA (padrão): [prometheus-api.newrelic.com](https://prometheus-api.newrelic.com)
...
7. Em <DNT>**Custom Headers**</DNT>, selecione <DNT>**Add Header**</DNT>. Para contas dos EUA e da UE, defina o nome de <DNT>**Header**</DNT> como <DNT>**X-Query-Key**</DNT> e insira a chave de consulta do Insights da etapa 1. Para contas do JP, defina o nome de <DNT>**Header**</DNT> como <DNT>**api-key**</DNT> e insira a chave de API de usuário da etapa 1.
...
<CollapserGroup>
  <Collapser id="" title="Exemplo de imagem de configuração">
...
<CollapserGroup>
  <Collapser id="" title="X-chave de consulta">
    ...
    **Exceção da região do JP**: a região do JP não oferece suporte a chaves de consulta do Insights. Use uma [chave de API de usuário](/docs/apis/intro-apis/new-relic-api-keys/#user-key) com o nome do cabeçalho <DNT>**api-key**</DNT> em vez de <DNT>**X-Query-Key**</DNT>.
  </Collapser>

  <Collapser id="" title="X-Prometheus-Only">
    <Callout variant="important">
  ...
  <Collapser id="" title="X-Prometheus-Server">
...
1. Vá para <DNT>**Configuration &gt; Data Sources**</DNT>.
2. Clique na fonte de dados que deseja excluir.
3. Clique no botão <DNT>**Delete**</DNT> na parte inferior da página.