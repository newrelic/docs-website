---
title: Solucionar problemas de contas SSO e aplicativos móveis
tags:
  - Mobile apps
...
## Sem nome de usuário ou senha [#no-sso-user]
...
1. No
   ...
   do aplicativo móvel, selecione o link
...
## Erros após fazer login [#sso-errors]

Se você encontrar algum erro após fazer login no seu provedor de SSO com seu dispositivo móvel, verifique se consegue fazer login no <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DoNotTranslate> com um browser da Web para desktop.

* Se não, entre em contato com seu administrador.
* Se sim, obtenha suporte em [support.newrelic.com](https://support.newrelic.com).

## Problemas de reautenticação [#sso-reauth]
