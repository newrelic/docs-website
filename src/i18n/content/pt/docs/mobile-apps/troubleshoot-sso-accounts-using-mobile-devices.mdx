...
Se você encontrar algum erro após fazer login no seu provedor de SSO com seu dispositivo móvel, verifique se consegue fazer login no <DNT>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DNT> com um browser da Web para desktop.
