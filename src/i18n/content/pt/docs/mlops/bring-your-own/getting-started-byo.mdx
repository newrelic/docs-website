...
Feito! Para verificar seu aplicativo, acesse <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DoNotTranslate> e veja os dados em tempo real.
