...
<CollapserGroup>
  <Collapser id="install-with-python" title="Instalar para aplicativo Python">
    <Steps>
      <Step>
  ...
  <Collapser id="install-with-node" title="Instalar com Node.js">
    <Steps>
      <Step>
...
## Usuário da conta da UE e do JP [#EU-account-users]

Se você estiver usando uma conta da UE ou JP, deverá definir seu `EVENT_CLIENT_HOST` da seguinte forma:
...
2. Clique em <DNT>**Model Performance**</DNT>.
3. Pesquise em <DNT>**Applications**</DNT>.
