...
* URL do endpoint HTTP - datacenter dos EUA (padrão): `https://aws-api.newrelic.com/cloudwatch-metrics/v1`
* URL do endpoint HTTP – datacenter da UE: `https://aws-api.eu01.nr-data.net/cloudwatch-metrics/v1`
* URL do endpoint HTTP - data center do JP: `https://aws-api.jp.nr-data.net/cloudwatch-metrics/v1`
