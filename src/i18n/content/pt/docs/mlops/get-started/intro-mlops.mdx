...
Para usar o monitoramento de desempenho do modelo nos [alertas da New Relic](/docs/alerts-applied-intelligence/new-relic-alerts/get-started/introduction-applied-intelligence/), você tem algumas opções diferentes:
