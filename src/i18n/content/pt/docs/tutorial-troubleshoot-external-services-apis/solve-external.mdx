...
<Steps>
  <Step>
    ...
    Na visualização do mapa, passe o mouse sobre a API ou serviço externo problemático e selecione <DoNotTranslate>**Show entity preview**</DoNotTranslate>.
  ...
  <Step>
    ...
    Passe o mouse sobre o serviço externo problemático novamente e desta vez clique em <DoNotTranslate>**View traces**</DoNotTranslate>.
