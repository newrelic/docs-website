...
<Steps>
  ...
  <Step>
    ...
    Depois de concluir as etapas adicionais do documento acima, vá para <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/nr1-core?filters=(domain%3D'APM'ANDtype%3D'APPLICATION'))**</DoNotTranslate> > selecione seu aplicativo > <DoNotTranslate>**External services**</DoNotTranslate>. Você deverá ver dados sobre sua API e fluxo de serviços externos.
  </Step>
</Steps>

## Identifique APIproblemática
...
<Steps>
  ...
  <Step>
    ...
    Você tem um instrumento de serviço que cuida de todo o processo de entrega. Vá para a página <DoNotTranslate>**External services**</DoNotTranslate> e clique em <DoNotTranslate>**Maps**</DoNotTranslate>.
