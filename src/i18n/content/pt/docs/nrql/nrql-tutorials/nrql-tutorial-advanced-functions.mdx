...
Esperamos que o NRQL seja útil para explorar os dados e, caso haja mais dúvidas ou problemas, fique à vontade para [entrar em contato com o suporte da New Relic](https://support.newrelic.com/). Ou, se preferir, é possível compartilhar a experiência com a nossa [comunidade online](https://support.newrelic.com/s/).