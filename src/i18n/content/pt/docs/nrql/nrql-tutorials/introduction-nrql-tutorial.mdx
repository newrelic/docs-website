...
<Steps>
  ...
  <Step>
    Observe que isso pode retornar um gráfico mais plano, já que temos apenas 24 pontos de dados no período de 1 dia que está sendo plotado. Mas e se você quiser ver a granularidade máxima possível? Qualquer consulta de série temporal pode ter até 366 intervalos de dados, o que significa que a granularidade máxima possível para 24 horas é agrupar nossos dados em janelas de 4 minutos. consulte isso usando `TIMESERIES 4 minutes` ou `TIMESERIES MAX`:
