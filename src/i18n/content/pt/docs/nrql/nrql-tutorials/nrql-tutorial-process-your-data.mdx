...
Quando você precisa focar seus dados em datas específicas de um evento de alerta e deseja investigar os dados sem uma janela de tempo móvel relativa ao horário atual, isso ajudará você a obter dados em uma janela de tempo estática. Na próxima e última lição, você continuará aprendendo a usar o tempo em seus relatórios com coortes baseadas no tempo.
