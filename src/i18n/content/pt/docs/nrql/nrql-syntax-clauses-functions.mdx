...
<CollapserGroup>
  ...
  >
    ...
    <CollapserGroup>
      <Collapser title={<>Consultar usando <InlineCode>
          LIMIT
        </InlineCode></>}>
  ...
  >
    ...
    * falseValue - este valor opcional é retornado se a expressão booleana for falsa, ou se não for fornecido NULL, será retornado
      ...
      <CollapserGroup>
        ...
        <Collapser title={<>Use com <InlineCode>
            AND
        ...
        <Collapser title={<>Aninhado <InlineCode>
            If()
          </InlineCode></>}>
  ...
  >
    ...
    * str - O valor da string deve estar em letras minúsculas
      ...
      * Se esse argumento for avaliado como nulo, a função `lower()` retornará nulo.
      ...
      _Função relacionada: [<InlineCode>
    ...
    * timezone - Um valor opcional de fuso horário usado para interpretar a string de data e hora (ex. UTC).
      ...
      * Deve ser um valor de string constante e o padrão será UTC ou o valor fornecido em `WITH TIMEZONE` , se disponível.
      ...
      <CollapserGroup>
        ...
        <Collapser title={<>Traduzir um timestamp usando o fuso horário na cláusula <InlineCode>
            WITH TIMEZONE
          </InlineCode></>}>
    ...
    * timezone - Um valor opcional de fuso horário usado para interpretar o parâmetro datestring (ex. PST).
      ...
      * Deve ser um valor de string constante e o padrão será UTC ou o valor fornecido em `WITH TIMEZONE` , se disponível.
            ...
            <tbody>
              ...
              <tr>
                ...
                <td rowspan="3">
                  ...
                  Nota: Dentro da string de data e hora, AM/PM deve estar em letras maiúsculas.
                </td>
      ...
      <CollapserGroup>
        ...
        <Collapser title={<>Analisar uma string de data e hora usando o fuso horário na cláusula <InlineCode>
            WITH TIMEZONE
          </InlineCode></>}>
