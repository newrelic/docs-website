...
<CollapserGroup>
  ...
  >
    ...
    * padrão - Um padrão de data e hora opcional usado para formatar o resultado. Consulte a seção *Padrões para formatação e análise* na [documentação do DatetimeFormatter](https://docs.oracle.com/javase/8/docs/api/java/time/format/DateTimeFormatter.html) para saber como construir uma string padrão.
  ...
  >
    ...
    * padrão - Um padrão de data e hora opcional usado para analisar o parâmetro datestring. Consulte a seção *Padrões para formatação e análise* na [documentação do DatetimeFormatter](https://docs.oracle.com/javase/8/docs/api/java/time/format/DateTimeFormatter.html) para saber como construir uma string padrão.
