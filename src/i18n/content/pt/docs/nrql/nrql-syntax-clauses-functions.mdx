...
<CollapserGroup>
  ...
  >
    ...
    * `width:` Indica a largura do intervalo de amostragem. O valor máximo do intervalo é o valor do argumento `start` mais este valor `width` .
    ...
    * `start:` O início do intervalo do histograma.
    ...
    <CollapserGroup>
      ...
      <Collapser
        ...
        title="Histograma com largura: 5, baldes: 10"
      >
      ...
      <Collapser
        ...
        title="Histograma com largura: 3, baldes: 3, início: 1"
      >
