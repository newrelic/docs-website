...
<CollapserGroup>
  <Collapser id="error_rate_request_domain" title="Taxa de erros por domínio de solicitação">
  ...
  <Collapser id="error_rate_business_api" title="Taxa de erros para API crítica para negócios">
  ...
  <Collapser id="response_time_percentile" title="Tempo de resposta percentil de API importante">
  ...
  <Collapser id="volume_network" title="Volume de solicitações de rede">
  ...
  <Collapser id="slow_response_user_impact" title="Impacto do usuário com resposta lenta">
  ...
  <Collapser id="response_time_distribution_by" title="Distribuição do tempo de resposta por domínio, operadora, proprietário de ASN, país, etc.">
  ...
  <Collapser id="percentile_response_time" title="Percentual de tempo de resposta">
  ...
  <Collapser id="req_per_session" title="Solicitações por sessão">
...
<CollapserGroup>
  <Collapser id="http-errors" title="Erros HTTP">
  ...
  <Collapser id="network-failures" title="Falhas de rede">
  ...
  <Collapser id="error-users" title="Taxa de erros: Porcentagem de usuários impactados">
  ...
  <Collapser id="versions" title="Erros por versão">
  ...
  <Collapser id="uuid" title="Dispositivos exclusivos (por UUID)">
  ...
  <Collapser id="history-http" title="Contagens históricas de erros HTTP">
...
<CollapserGroup>
  <Collapser id="app-exceptions" title="Exceções de aplicativos">
  ...
  <Collapser id="exception-locations" title="Principais locais de exceção">
  ...
  <Collapser id="exception-last-interaction" title="Interações mais comuns gerando exceções">
  ...
  <Collapser id="exception-message" title="Mensagem de exceção mais comum">
  ...
  <Collapser id="exception-methods-users" title="Exceções de relatório de métodos mais comuns">
  ...
  <Collapser id="handled-exceptions-rate" title="Taxa de exceção tratada">
