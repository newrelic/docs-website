...
2. Continue com uma etapa ou etapas adicionais que descrevam o número de usuários que também concluíram ações adicionais, normalmente além dos 100% da etapa âncora. No entanto, poderá ser 100% se cada usuário que concluir a ação (A) também concluir as ações adicionais que você está consultando.
