...
* **Permissões do usuário**: as permissões de [Automação de fluxo de trabalho](/docs/workflow-automation/create-a-workflow-automation/managing-workflow/#before-you-begin) são necessárias para criar e gerenciar pesquisas agendadas.
...
* [Explore a automação de fluxos de trabalho](/docs/alerts/get-notified/alert-event-workflows) para possibilidades de automação mais avançadas.