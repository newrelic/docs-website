...
Observando a resposta JSON a esta consulta, os intervalos da série temporal se baseiam no final do intervalo de tempo e o horário de início é ajustado para que o primeiro intervalo na resposta cubra cinco minutos completos: `"beginTime": "2023-12-20T00:08:12Z", "endTime": "2023-12-21T00:03:12Z"`.
...
A hora é relativa à hora em que você executa a consulta. Por exemplo, suponha que você executou uma consulta em `2023-12-18T12:34:56.789Z`. Você obteria resultados diferentes dependendo do valor de tempo relativo usado:<table style={{ width: "auto" }}>
  <thead>
    <tr>
      <th>
...
<Collapser title="Exemplos de tempo temporal relativo">
  Nestes exemplos, suponha que a consulta foi executada às `2023-12-18T12:34:56.789Z` (segunda-feira).<table style={{ width: "auto" }}>
    <thead>
      <tr>
        <th>
