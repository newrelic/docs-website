...
<Callout variant="important">
  ...
  Pontos de dados de métricas brutos que:

  * Começar antes de `SINCE '2023-12-20T00:04Z'` e terminar dentro da janela de tempo
  * Começar dentro da janela de tempo e terminar depois `UNTIL '2023-12-22T00:03Z'`

  serão ambos ignorados ao processar a consulta.
</Callout>
