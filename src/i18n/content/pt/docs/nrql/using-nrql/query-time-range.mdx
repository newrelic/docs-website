...
<Callout variant="tip">
  Para cada uma das opções listadas abaixo, o fuso horário _padrão_ é UTC. Observe que o fuso horário preferido do usuário não é usado para execução de consulta: a preferência de fuso horário do usuário _exibe_ apenas valores DateTime.
...
<Collapser title={<>Referências de dias - <InlineCode>today</InlineCode>, <InlineCode>yesterday</InlineCode> ou um dia da semana</>}>
...
<Collapser title={<>Referências do dia - <InlineCode>day ref AT time</InlineCode></>}>
...
<Collapser title={<>Referências de início de unidade de tempo - <InlineCode>this time unit</InlineCode> ou <InlineCode>last time unit</InlineCode></>}>
