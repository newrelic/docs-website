...
<Callout variant="important">
  Consultas de [pontos de dados de métrica brutos](/docs/data-apis/understand-data/metric-data/query-metric-data-type) não ajustam o intervalo de tempo e podem excluir pontos de dados de limite.
  ...
  A inclusão de um datapoint bruto depende do seu **horário de início**, não do seu horário de término:

  * Um datapoint que começa dentro da janela é incluído, mesmo que termine depois de `UNTIL '2023-12-22T00:03Z'`.
  * Um datapoint que começa antes de `SINCE '2023-12-20T00:04Z'` é excluído, mesmo que termine dentro da janela.
</Callout>
