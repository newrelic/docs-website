...
Outra ótima maneira de explorar seus dados é acessar qualquer painel existente, clicar em <DNT>**View query**</DNT> e executar seu gráfico no criador de consulta.<img
