...
Outra ótima maneira de explorar seus dados é acessar qualquer painel existente, clicar em <DNT>**View query**</DNT> e executar seu gráfico no criador de consulta.<img title="new-relic-view-chart-nrql-query.png" alt="New Relic view chart NRQL query" src="/images/queries-nrql_screenshot-crop_view-query-for-chart.webp"/>

<figcaption>
  Os gráficos criados com NRQL terão <DNT>**View query**</DNT> como opção. Você pode então editar e personalizar essa consulta para ver como suas alterações afetam a visualização resultante.
</figcaption>
...
<CollapserGroup>
  <Collapser
    ...
    title="Consulta NRQL básica de dados do Browser"
  >
