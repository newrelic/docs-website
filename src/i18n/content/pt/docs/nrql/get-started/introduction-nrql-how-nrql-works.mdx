...
Outra ótima maneira de explorar seus dados é acessar qualquer painel existente, clicar em <DNT>**View query**</DNT> e executar seu gráfico no criador de consulta.<img title="new-relic-view-chart-nrql-query.png" alt="New Relic view chart NRQL query" src={queriesnrqlViewQueryforChart}/>
