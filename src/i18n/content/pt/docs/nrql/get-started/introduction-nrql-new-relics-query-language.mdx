...
<CollapserGroup>
  ...
  >
    ...
    <figcaption>
      <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert conditions (Policies) > (select a policy) > Add a condition**</DoNotTranslate>. Clique em <DoNotTranslate>**NRQL**</DoNotTranslate> e depois em <DoNotTranslate>**Next, define thresholds**</DoNotTranslate>.
    </figcaption>
