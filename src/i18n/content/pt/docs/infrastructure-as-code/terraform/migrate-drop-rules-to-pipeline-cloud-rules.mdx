...
<Callout variant="important">
  A partir de 21 de maio de 2025, novos clientes não poderão mais usar regras de exclusão NRQL. [As regras de exclusão do NRQL deixarão de vigorar](/eol/2025/05/drop-rule-filter) em 7 de janeiro de 2026.
