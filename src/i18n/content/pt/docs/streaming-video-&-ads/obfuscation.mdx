...
<Callout variant="important">
  O Roku tem `roRegex` restrições de padrão que afetam as regras de ofuscação. Consulte [Limitações para Streaming de Vídeo &amp; Anúncios](/docs/streaming-video-&-ads/limitations#roku-regex) para obter detalhes.
</Callout>