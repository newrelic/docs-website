...
<Callout variant="important">
  O Roku tem restrições de padrão regex que afetam as regras de ofuscação. Consulte [Limitações para Streaming de Vídeo &amp; Anúncios](/docs/streaming-video-&-ads/limitations#roku-regex) para obter detalhes.
</Callout>