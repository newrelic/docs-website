...
<Steps>
  ...
  <Step>
    **Inicialize o agente**: abra seu arquivo principal BrightScript (por exemplo, `Main.brs`). Inicialize o agente New Relic chamando a função `NewRelic` com seu `ACCOUNT ID` e <InlinePopover type="licenseKey" />.
