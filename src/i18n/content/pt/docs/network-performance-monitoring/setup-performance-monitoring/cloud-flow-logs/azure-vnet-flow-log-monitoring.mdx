      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td>
              Any region where Flex Consumption is Generally Available. Modern serverless model with native VNet integration that scales elastically without pre-warmed capacity.
            </td>
          ...
          <tr>
            ...
            <td>
              Production or bursty workloads in regions where Flex Consumption is not yet available, or workloads with a strict no-cold-start SLA.
            </td>
          ...
          <tr>
            ...
            <td>
              Small tenants or development deployments that need private networking. Cheapest VNet-capable option. Not suitable for high-throughput workloads.
            </td>
          ...
          <tr>
            ...
            <td>
              Public-network development or evaluation deployments where private networking isn&apos;t required. Cheapest overall.
            </td>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        New Relic Logs API endpoint. Defaults to the US endpoint. Override for other regions: 
