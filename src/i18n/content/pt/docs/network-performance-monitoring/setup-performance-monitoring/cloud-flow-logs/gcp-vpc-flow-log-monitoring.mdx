...
<Callout variant="important">
  O log do Google VPC Flow ainda não é compatível com clientes FedRAMP. Enquanto isso, você pode usar [nossa APIde ingestão FedRAMP](/docs/security/security-privacy/compliance/fedramp-compliant-endpoints#data-ingest-apis).
</Callout>
...
1. Inicie o <DoNotTranslate>**[guided install process](https://one.newrelic.com/nr1-core?&state=bd947742-3034-63b7-7196-8baaf36dd8d9)**</DoNotTranslate>.

2. No dropdown <DoNotTranslate>**Select an account**</DoNotTranslate>, escolha a conta New Relic para a qual você deseja enviar o log do Google VPC Flow e clique em <DoNotTranslate>**Continue**</DoNotTranslate>.

3. Na seção <DoNotTranslate>**Choose Setup Options**</DoNotTranslate> :
...
4. <DoNotTranslate>**Enable Flow Logging**</DoNotTranslate> - Ative o registro de fluxo para uma sub-rede. Você precisa ativar o log de fluxo para cada sub-rede da qual deseja coletar logs de fluxo. Você pode alterar essa configuração por meio da CLI, do Cloud Console ou de qualquer outra ferramenta de configuração de nuvem usada pela sua equipe.
...
6. Se você escolheu <DoNotTranslate>**GCloud CLI**</DoNotTranslate> como método de configuração:
...
7. Se você escolheu <DoNotTranslate>**Terraform**</DoNotTranslate> como método de configuração:
