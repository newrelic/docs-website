...
<CollapserGroup>
  ...
  >
    ...
    2. Role para baixo até ver <DoNotTranslate>**Network**</DoNotTranslate> e clique em <DoNotTranslate>**Network Flows**</DoNotTranslate>.
    ...
    <Tabs>
      ...
      <TabsPages>
        ...
        <TabsPageItem id="podmanInstall">
          1. Em um host com o Podman instalado, faça download da imagem <DoNotTranslate>**ktranslate**</DoNotTranslate> executando o seguinte comando:
