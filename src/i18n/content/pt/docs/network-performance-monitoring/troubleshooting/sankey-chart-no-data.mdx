...
* `in_bytes` ou `in_pkts`, dependendo se você selecionou a alternância
  ...
  <DoNotTranslate>**Byte traffic**</DoNotTranslate>

  ou

  <DoNotTranslate>**Packet traffic**</DoNotTranslate>
...
Para resolver esse problema, primeiro investigue a consulta NRQL subjacente do seu gráfico sankey selecionando a ação <DoNotTranslate>**View query**</DoNotTranslate> no ícone superior direito do gráfico e identifique quaisquer campos que retornem valores nulos ou vazios da sua consulta. A próxima etapa seria atualizar o modelo de fluxo no seu exportador de fluxo para garantir que todos os campos necessários sejam enviados para o agente KTranslate conforme esperado.