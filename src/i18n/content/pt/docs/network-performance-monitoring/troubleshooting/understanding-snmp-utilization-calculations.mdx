...
<CollapserGroup>
  <Collapser id="cpu-utilization" title="% de utilização da CPU">
  ...
  <Collapser id="memory-utilization" title="% de utilização de memória">
  ...
  <Collapser id="interface-utilization" title="% de utilização da interface">
  ...
  <Collapser id="interface-throughput" title="Interface taxas de transferência">
  ...
  <Collapser id="interface-errors" title="% de erros de interface">
  ...
  <Collapser id="snmp-conversions" title="Conversões SNMP">
