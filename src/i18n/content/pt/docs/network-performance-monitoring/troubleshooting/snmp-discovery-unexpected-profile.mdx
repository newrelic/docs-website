...
Nesse caso, você pode substituir manualmente a correspondência do trabalho de descoberta usando a sintaxe <DoNotTranslate>**bang (!)**</DoNotTranslate> : `"!profile-name.yml"`, que permite forçar qualquer perfil desejado:
