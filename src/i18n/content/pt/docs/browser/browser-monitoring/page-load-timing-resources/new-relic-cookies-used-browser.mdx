  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        Com o lançamento do [agente browser v1169](/docs/release-notes/new-relic-browser-release-notes/browser-agent-release-notes/browser-agent-v1169), você pode desativar a coleta de cookies ([`JSESSIONID`](#jsessionid) e [`NREUM`](#nreum)) para seu aplicativo de browser usando a página <DoNotTranslate>**Application settings**</DoNotTranslate> na interface do New Relic. Depois que esse valor de configuração for definido como falso (OFF), você não verá mais as informações da sessão nos dados do evento.
