...
Antes de começar, você pode verificar se o aplicativo do browser atende aos nossos [requisitos e compatibilidade](/docs/browser/new-relic-browser/getting-started/compatibility-requirements-browser-monitoring).
...
Para instalar o browser agente: Acesse <DNT>**[one.newrelic.com](https://one.newrelic.com) > Integrations & Agents > Browser and mobile > Browser monitoring**</DNT> e siga as instruções.
