...
Para instalar o browser agente: Acesse <DNT>**[one.newrelic.com](https://one.newrelic.com) > Add data > Browser and mobile > Browser monitoring**</DNT> e siga as instruções.
