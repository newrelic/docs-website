...
Antes de 8 de maio de 2024, embora os bytes Session Replay sejam gratuitos, você pode visualizar seu consumo para ajudar no planejamento assim que os bytes forem pagos:
