...
* Um agente de navegador **Pro** ou **Pro + SPA**:
...
<Steps>
  ...
  <Step>
    Alternar **Automatically collect console logs** para **ON**.
  </Step>
  ...
  <Step>
    Alternar o nível de verbosidade necessário para **ON**. O nível de verbosidade padrão é definido como **WARN**. Os níveis que você pode escolher são:
...
<Steps>
  ...
  <Step>
    Alternar **Automatically collect console logs** para **OFF**.
  </Step>
</Steps>
