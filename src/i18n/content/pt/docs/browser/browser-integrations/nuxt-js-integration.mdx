...
Após instalar o agente de infraestrutura, a próxima etapa é instalar o monitor do browser. De <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com)**</DoNotTranslate>:
