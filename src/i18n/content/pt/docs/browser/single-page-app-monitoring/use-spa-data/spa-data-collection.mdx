...
4. Para novos SPAs (agente v1.298.0 e posteriores), o monitor verifica retornos de chamada de longa duração por um período máximo de 5 segundos. Se for identificada uma função de retorno de chamada de longa duração, o sistema estende a interação atual e executa o monitor novamente.
