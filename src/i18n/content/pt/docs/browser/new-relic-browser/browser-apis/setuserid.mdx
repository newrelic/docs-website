...
* Se você estiver instalando o agente do browser via npm e criando um agente personalizado com recursos selecionados, deve habilitar pelo menos um recurso ao criar a instância `Agent`. Por exemplo, adicione o seguinte no array`features`:
