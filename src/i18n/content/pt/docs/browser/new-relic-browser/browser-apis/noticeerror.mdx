...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Obrigatório. Forneça uma mensagem de erro significativa que você possa usar ao analisar dados na [página<DoNotTranslate>**Errors**</DoNotTranslate> ](/docs/errors-inbox/browser-tab)do browser.
      </td>
    </tr>
...
Se um erro não for gerado, não haverá stack trace. Se quiser que a API `newrelic.noticeError` relate um stack trace com todos os tipos de browser, você deverá lançar manualmente e capturar o erro antes de transmiti-lo à API.
