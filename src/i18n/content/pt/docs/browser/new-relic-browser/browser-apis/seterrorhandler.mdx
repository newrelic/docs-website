...
type: apiDoc
shortDescription: Permite ignorar e agrupar seletivamente os erros conhecidos que o navegador do agente captura.
tags:
  - Browser
  - Browser monitoring
...
Permite ignorar e agrupar seletivamente os erros conhecidos que o navegador do agente captura.

## Requisitos

* Navegador Pro ou agente Pro+SPA (v974 ou superior)
...
A chamada de API `newrelic.setErrorHandler()` permite ignorar seletivamente erros conhecidos capturados pelo navegador do agente. É necessária uma única função de tratamento de erros, que será chamada para cada erro que o navegador do agente capturar. Se o manipulador retornar `true`, o New Relic **não** registrará o erro. Caso contrário, o erro será processado normalmente.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Obrigatório<DoNotTranslate>**.**</DoNotTranslate> Quando ocorre um erro, o retorno de chamada é chamado com o objeto de erro como parâmetro. O retorno de chamada será chamado com cada erro, portanto não é específico para um erro.
      </td>
    </tr>
  </tbody>
</table>
...
Inclua o objeto de erro dentro da função de retorno de chamada para ignorar erros específicos que o navegador do agente captura.
