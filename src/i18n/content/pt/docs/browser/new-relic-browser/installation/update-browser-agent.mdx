...
Use qualquer uma das opções a seguir para acessar o trecho JavaScript do browser necessário para atualizar uma instalação de copiar/colar. Depois de acessar o trecho, certifique-se de substituir <DoNotTranslate>**all**</DoNotTranslate> do seu trecho existente pela nova versão.
