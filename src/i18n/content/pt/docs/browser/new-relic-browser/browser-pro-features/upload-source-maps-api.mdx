...
<Callout variant="important">
  Os exemplos a seguir são para contas dos EUA (padrão). Para outras regiões, use o endpoint correspondente:

  * Contas da UE: `https://sourcemaps.service.eu.newrelic.com`
  * Contas JP: `https://sourcemaps.service.jp.newrelic.com`

  Para mais informações, consulte [Escolha seu data center](/docs/accounts/accounts-billing/account-setup/choose-your-data-center).
</Callout>
