...
Quando terminar, vá para a [guia<DoNotTranslate>**Group errors**</DoNotTranslate> ](/docs/errors-inbox/browser-tab)no browser, selecione um agrupamento de erros e veja se os traces de pilha de erros não foi minimizado.
