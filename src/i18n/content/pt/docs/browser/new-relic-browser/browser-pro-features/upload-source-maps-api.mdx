...
Quando terminar, vá para a [guia<DoNotTranslate>**Group errors**</DoNotTranslate> ](docs/errors-inbox/browser-tab)no navegador, selecione um agrupamento de erros e veja se o rastreamento de pilha de erros não foi minificado.
