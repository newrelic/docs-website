...
When you're done, go to the [<DoNotTranslate>**Group errors**</DoNotTranslate> tab](docs/errors-inbox/browser-tab) in browser, select an error grouping, and see if your error stack traces have been un-minified.
