...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Na interface distributed tracing , os spans finais do usuário são indicados com o<img title="distributed-tracing-browser-span-icon.png" alt="New Relic distributed tracing browser span icon" src={browserBrowserIcon} style={{height: "30px", width: "30px"}}/>
