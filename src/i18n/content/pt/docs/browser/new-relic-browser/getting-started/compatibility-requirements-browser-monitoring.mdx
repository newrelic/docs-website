...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Se você estiver usando AngularJS e quiser usar nosso [recurso de monitoramento SPA](/docs/browser/single-page-app-monitoring/get-started/welcome-single-page-app-monitoring), observe que as versões 0.6.18 a 0.6.24 do Zone.js não são compatíveis com o browser. Em todos os casos, o agente browser <DoNotTranslate>**must**</DoNotTranslate> deve ser carregado antes do Zone.js para evitar erros.
      </td>
    </tr>
