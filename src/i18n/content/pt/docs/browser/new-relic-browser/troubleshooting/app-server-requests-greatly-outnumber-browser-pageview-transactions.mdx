...
<CollapserGroup>
  ...
  >
    As páginas da Web não são <DoNotTranslate>**text/html**</DoNotTranslate>. (Para evitar danos aos dados, o browser não utiliza páginas não HTML, porque elas não se destinam a serem analisadas por um browser.)
  </Collapser>
  ...
  >
    Algumas solicitações ao seu backend são feitas através de AJAX. As taxas de transferência AJAX são rastreadas separadamente na [página<DoNotTranslate>**AJAX**</DoNotTranslate> ](/docs/browser/new-relic-browser/browser-pro-features/ajax-dashboard-identifying-time-consuming-calls)do browser.
  </Collapser>
