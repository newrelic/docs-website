...
<CollapserGroup>
  ...
  >
    ...
    * Parâmetro personalizado adicional definido pela [API do agente browser](/docs/browser/new-relic-browser/browser-agent-apis/report-data-events-browser-agent-api), se definido antes do carregamento da página
      ...
      Essas informações aparecem na [página<DoNotTranslate>**Page views**</DoNotTranslate> ](/docs/browser/new-relic-browser/dashboard-details/page-views-dashboard). Por motivos de segurança de dados, o browser não registra nem coleta strings de consulta de URL.
