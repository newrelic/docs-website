...
4. [Reimplante o navegador do agente](/docs/browser/new-relic-browser/installation/upgrade-browser-agent) (reiniciando o agente

   <InlinePopover type="apm"/>

   associado ou atualizando a instalação de copiar/colar do navegador).
