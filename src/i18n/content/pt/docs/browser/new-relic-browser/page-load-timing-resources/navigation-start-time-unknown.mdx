...
<DoNotTranslate>**Note:**</DoNotTranslate> Para browsers que possuem a API Navigation Timing, isso não é um problema, pois o horário de início da navegação pode ser determinado sem o uso de cookie.