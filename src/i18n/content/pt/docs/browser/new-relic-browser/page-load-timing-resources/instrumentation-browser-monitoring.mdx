...
<table id="navigation-api">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Para navegadores que não implementam a API Navigation Timing Specification, contamos com o [cookie NREUM](/docs/browser/new-relic-browser/miscellaneous/new-relic-cookies#nreum) e o navegador agente para coletar informações de tempo.
