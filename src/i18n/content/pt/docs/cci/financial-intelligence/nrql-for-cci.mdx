...
Consulte os dados do Cloud Cost Intelligence usando NRQL para analisar e otimizar os gastos com a nuvem. Três tipos de eventos estão disponíveis com atributos para consultas detalhadas:
...
<CollapserGroup>
  <Collapser id="cloud-cost-attributes" title="Atributo CloudCost">
    Navegue até **All Capabilities &gt; Cloud Cost Intelligence** e abra o Console de consulta para inserir:
