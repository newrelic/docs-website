...
<Steps>
  ...
  <Step>
    ...
    <Callout variant="important">
      Lembre-se do nome da exportação para a integração CCI. Certifique-se de que o prefixo do caminho S3 seja `cost-and-usage-reports`. O primeiro relatório é entregue em 24 horas; os relatórios subsequentes são entregues periodicamente. Sua exportação também deve incluir todas as 114 colunas obrigatórias para que a CCI ingira e processe seus dados de faturamento — consulte o [dicionário de dados](/attribute-dictionary) para obter a lista completa.
    </Callout>
  </Step>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Integre seus serviços da AWS com o New Relic via 
