...
<CollapserGroup>
  <Collapser
    ...
    title="O elemento A não é clicável no ponto (X, Y). Outro elemento receberia o clique: Elemento B"
  >
    ### Problema
  ...
  <Collapser
    ...
    title="Erro: elemento não visível"
  >
    ### Problema
  ...
  <Collapser
    id="no-such-element"
    title="Erro: tal elemento não existe: Não foi possível localizar o elemento: <LOCATOR>"
  >
    ### Problema
  ...
  <Collapser
    id="job-timed-out"
    title="JobTimeoutError: O tempo limite do trabalho expirou após 180s"
  >
    ### Problema
  ...
  <Collapser
    ...
    title="NetworkError: o monitor não produziu tráfego"
  >
    ### Problema
  ...
  <Collapser
    ...
    title="ReferenceError: $network não está definido"
  >
    ### Problema
  ...
  <Collapser
    ...
    title="StaleElementReferenceError: o elemento não está anexado ao documento da página"
  >
    ### Problema
  ...
  <Collapser
    id="task-timed-out"
    title="TaskTimedOut: tempo limite da tarefa expirou aguardando a localização do elemento usando: <LOCATOR>"
  >
    ### Problema
  ...
  <Collapser
    ...
    title="TimeoutError: Tempo limite de carregamento da página expirou (não foi possível concluir todas as solicitações de rede no prazo)"
  >
    ### Problema
  ...
  <Collapser
    ...
    title="TypeError: $browser.isElementPresent não é uma função"
  >
    ### Problema
...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="SyntaxError: token inesperado u em JSON na posição 0"
  >
    ### Problema
  ...
  <Collapser
    ...
    title="TypeError: Não é possível ler a propriedade 'statusCode' de indefinido"
  >
    ### Problema
