...
Na saída desse comando, você verá o seguinte cabeçalho <DoNotTranslate>**response**</DoNotTranslate> informando que o servidor está oferecendo NTLM sobre HTTP como um mecanismo de autenticação válido:
