---
title: Códigos de resposta de monitoramento sintético
tags:
  - Synthetics
...
O monitor Sintético retorna vários códigos de resposta adicionais além dos códigos de resposta HTTP padrão, visíveis na [página<DNT>**Resources**</DNT> ](/docs/synthetics/new-relic-synthetics/pages/synthetics-resources-understand-load-times). Esses códigos de resposta são baseados nos [códigos de resposta do Chromium](https://code.google.com/p/chromium/codesearch#chromium/src/net/base/net_error_list.h&sq=package:chromium) e fornecem mais detalhes sobre o comportamento do seu monitor.
