...
Os resultados dos testes de API e browser com script também incluem um <DoNotTranslate>**Script log**</DoNotTranslate>, que inclui o conteúdo do script selecionado. Você também pode registrar manualmente os marcos do script incluindo [funções de registro em log](/docs/synthetics/new-relic-synthetics/scripting-monitors/writing-scripted-browsers#logging) no seu script.

O log do console está localizado no final do log do script:
