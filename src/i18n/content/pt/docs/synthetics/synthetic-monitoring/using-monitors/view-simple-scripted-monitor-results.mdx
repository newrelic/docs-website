...
1. Navegue até
   ...
   <DNT>**Synthetic Monitoring > Results**</DNT>
...
Observação: <DNT>Script logs</DNT> estão disponíveis apenas para testes que falharam ou nos quais o usuário optou por incluir o registro personalizado.
