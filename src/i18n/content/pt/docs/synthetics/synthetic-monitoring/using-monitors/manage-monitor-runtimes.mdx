...
<CollapserGroup>
  ...
  >
    ...
    * <DNT>**Browser**</DNT>: Chrome 117 (Requer a versão 2.2+ da imagem Sintético-node-navegador-runtime para localização privada. O Chrome 112 ou 100 será usado por imagens de tempo de execução de navegador mais antigas.)
