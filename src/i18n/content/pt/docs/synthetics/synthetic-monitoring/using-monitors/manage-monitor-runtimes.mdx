...
<Callout variant="tip">
  The [runtime upgrades UI](/docs/synthetics/synthetic-monitoring/using-monitors/runtime-upgrade-ui/) can be used to upgrade the runtime of multiple monitors.
</Callout>
