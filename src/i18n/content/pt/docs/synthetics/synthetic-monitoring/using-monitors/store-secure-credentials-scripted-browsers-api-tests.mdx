...
1. Vá para
   ...
   <DNT>**[one.newrelic.com > Synthetic monitoring > Secure credentials](https://one.newrelic.com/synthetics-nerdlets/secure-credential-list)**</DNT>

   .

2. Para adicionar uma nova credencial segura, procure o botão

   <DNT>**Create secure credential +**</DNT>
