...
<CollapserGroup>
  ...
  >
    ...
    5. Vá para <DNT>**[one.newrelic.com > Synthetic monitoring > Secure credentials](https://one.newrelic.com/synthetics/secure-credential-list)**</DNT>.

    6. Copie o nome do segredo no campo de texto do filtro.
    ...
    7. Clique no ícone de reticências <DNT>**...**</DNT> da credencial que deseja alterar e clique em <DNT>**Edit**</DNT>.
