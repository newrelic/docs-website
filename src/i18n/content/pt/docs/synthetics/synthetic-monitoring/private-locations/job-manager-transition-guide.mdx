...
Decidiu atualizar para o novo tempo de execução? Confira nossa [APINerdGraph](/docs/apis/nerdgraph/examples/nerdgraph-synthetics-tutorial/#update-monitors) para atualizar o monitor programaticamente.
