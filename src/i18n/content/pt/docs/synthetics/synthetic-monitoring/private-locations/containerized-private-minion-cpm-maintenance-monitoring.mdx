...
<CollapserGroup>
  <Collapser
    ...
    title={<><img src="/images/synthetic_logo_docker-logo.webp" title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}>Revise o Docker log</img></>}
  >
  ...
  <Collapser
    ...
    title={<><img src="/images/synthetic_logo_k8logo.webp" title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png" style={{ height: '35px', width: '40px' }}>Revise o registro do Kubernetes</img></>}
  >
...
<CollapserGroup>
  <Collapser
    ...
    title={<><img src="/images/synthetic_logo_docker-logo.webp" title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}>Habilitar Docker log de depuração</img></>}
  >
    <Callout variant="tip">
  ...
  <Collapser
    ...
    title={<><img src="/images/synthetic_logo_k8logo.webp" title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png" style={{ height: '35px', width: '40px' }}>Habilitar log de depuração do Kubernetes</img></>}
  >
    <Callout variant="tip">
