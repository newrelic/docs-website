...
<CollapserGroup>
  <Collapser
    ...
    title={<><img src="/images/synthetic_logo_docker.webp" title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}/>Docker requisitos de ambiente do sistema de contêiner</>}
  >
    <table>
      <thead>
        <tr>
  ...
  <Collapser
    ...
    title={<><img src="/images/synthetic_logo_k8logo.webp" title="Kubernetes icon" alt="Kubernetes icon" style={{ height: '35px', width: '40px' }}>Requisitos do ambiente do sistema de orquestração do contêiner Kubernetes (chamadas por minuto v3.0.0 ou superior)</img></>}
  >
    <table>
      <thead>
        <tr>
...
<CollapserGroup>
  <Collapser
    ...
    title={<><img src="/images/synthetic_logo_docker.webp" title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}/>Docker dependência</>}
  >
...
<CollapserGroup>
  <Collapser
    id="docker-update"
    title={<><img src="/images/synthetic_logo_docker.webp" title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}/>Docker procedimento de início</>}
  >
  ...
  <Collapser
    ...
    title={<><img src="/images/synthetic_logo_k8logo.webp" title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png" style={{ height: '35px', width: '40px' }}>Procedimento de inicialização do Kubernetes</img></>}
  >
    <Callout
      variant="important"
      title="AVISO DE EOL"
...
<CollapserGroup>
  <Collapser
    id="docker-stop"
    title={<><img src="/images/synthetic_logo_docker.webp" title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}/>Docker procedimento de parada</>}
  >
  ...
  <Collapser
    ...
    title={<><img src="/images/synthetic_logo_k8logo.webp" title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png" style={{ height: '35px', width: '40px' }}>Procedimento de exclusão do Kubernetes</img></>}
  >
