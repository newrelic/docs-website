...
<CollapserGroup>
  <Collapser
    ...
    title={<><img src={dockimport} title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}/>Docker requisitos de ambiente do sistema de contêiner</>}
  >
    <table>
      <thead>
        <tr>
      ...
      <tbody>
        <tr>
          ...
          <td>
            <DoNotTranslate>**Linux kernel:**</DoNotTranslate> 3.10 ou superior<br/> <DoNotTranslate>**macOS:**</DoNotTranslate> 10.11 ou superior<br/> <DoNotTranslate>**Windows:**</DoNotTranslate> Windows 10 de 64 bits ou superior

            _Você também deve configurar Docker para executar o contêiner Linux para que as chamadas por minuto funcionem em sistemas Windows._
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Uma moderna CPU AMD64 / x86_64 multi-core
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**Ping:**</DoNotTranslate> Insignificante<br/> <DoNotTranslate>**Scripted API:**</DoNotTranslate> 7<br/> <DoNotTranslate>**Simple browser:**</DoNotTranslate> 27<br/> <DoNotTranslate>**Scripted browser:**</DoNotTranslate> 28
            ...
            _Baseline para chamadas Docker por minuto é 0,5 IOPS sem nenhum trabalho de monitor em execução._
          </td>
        </tr>
  ...
  <Collapser
    ...
    title={<><img src={synthetick8logo} title="Kubernetes icon" alt="Kubernetes icon" style={{ height: '35px', width: '40px' }}>Requisitos do ambiente do sistema de orquestração do contêiner Kubernetes (chamadas por minuto v3.0.0 ou superior)</img></>}
  >
    <table>
      <thead>
        <tr>
      ...
      <tbody>
        <tr>
          ...
          <td>
            <DoNotTranslate>**Linux kernel:**</DoNotTranslate> 3.10 ou superior<br/> <DoNotTranslate>**macOS:**</DoNotTranslate> 10.11 ou superior<br/>
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**CPU (vCPU/Core):**</DoNotTranslate> 0,5 até 0,75<br/> <DoNotTranslate>**Memory:**</DoNotTranslate> 800 Mi até 1.600 Mi
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**CPU (vCPU/Core):**</DoNotTranslate> 0,5 até 1<br/> <DoNotTranslate>**Memory:**</DoNotTranslate> 1.250 Mi até 3.000 Mi
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**Root volume:**</DoNotTranslate> Um mínimo de 50 GiB (nó + PV)<br/> <DoNotTranslate>**Persistent volume (PV):**</DoNotTranslate> Mínimo de 20 GiB
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**Ping:**</DoNotTranslate> Insignificante<br/> <DoNotTranslate>**Scripted API:**</DoNotTranslate> 11<br/> <DoNotTranslate>**Simple browser:**</DoNotTranslate> 33<br/> <DoNotTranslate>**Scripted browser:**</DoNotTranslate> 31
            ...
            _Baseline para chamadas por minuto do Kubernetes é 3,0 IOPS sem nenhum trabalho de monitor em execução._
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Recomendamos que seu cluster do Kubernetes suporte [Kubernetes v1.15](https://kubernetes.io/blog/2019/06/19/kubernetes-1-15-release-announcement/). <Callout variant="caution">Para Kubernetes v1.21 ou mais recente, use a versão minion [v3.0.61](/docs/release-notes/synthetics-release-notes/containerized-private-minions-release-notes/containerized-private-minion-cpm-3061) ou mais recente.</Callout>
          </td>
        </tr>
...
2. No índice
   ...
   , localize a localização privada à qual você deseja que suas chamadas por minuto sejam atribuídas.

3. Observe a chave associada à localização privada com a chave
...
<CollapserGroup>
  <Collapser
    ...
    title={<><img src={dockimport} title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}/>Docker dependência</>}
  >
    ...
    * Seu soquete UNIX Docker gravável é montado na [variável de ambiente](/docs/synthetics/new-relic-synthetics/private-locations/containerized-private-minion-cpm-configuration#environment-variables) `/var/run/docker.sock` ou `DOCKER_HOST`. Para obter mais informações, consulte [Opção de soquete Daemon](https://docs.docker.com/engine/reference/commandline/dockerd/#daemon-socket-option) do Docker.
      ...
      <Callout variant="caution">
        A contagem de núcleos no host determina quantos contêineres runners as chamadas por minuto podem ser executadas simultaneamente no host. Como os requisitos de memória são dimensionados para a contagem esperada do contêiner do executor, recomendamos <DoNotTranslate>**not running multiple CPMs on the same host**</DoNotTranslate> para evitar contenção de recursos.
      </Callout>
...
<CollapserGroup>
  <Collapser
    id="docker-update"
    title={<><img src={dockimport} title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}/>Docker procedimento de início</>}
  >
  ...
  <Collapser
    ...
    title={<><img src={synthetick8logo} title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png" style={{ height: '35px', width: '40px' }}>Procedimento de inicialização do Kubernetes</img></>}
  >
    <Callout
      variant="important"
      title="AVISO DE EOL"
...
<CollapserGroup>
  <Collapser
    id="docker-stop"
    title={<><img src={dockimport} title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}/>Docker procedimento de parada</>}
  >
  ...
  <Collapser
    ...
    title={<><img src={synthetick8logo} title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png" style={{ height: '35px', width: '40px' }}>Procedimento de exclusão do Kubernetes</img></>}
  >
...
<CollapserGroup>
  <Collapser
    id="run-non-root"
    title={<><img src={dockimport} title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}/>Execute como usuário não root para Docker</>}
  >
