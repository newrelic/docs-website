...
<Callout variant="important">
  **Ação necessária.** A New Relic está encerrando o suporte para o runtime do Chrome 134 em 18 de agosto de 2026 e para o runtime do Node.js 16 em 18 de novembro de 2026. Se você não atualizar seus monitores que estão em tempos de execução mais antigos, a New Relic migrará automaticamente seus monitores nas datas mencionadas. No entanto, a migração automática pode não detectar monitores que passam, mas falham silenciosamente em algumas etapas do script.
</Callout>
...
| Versão do runtime da API               | `1.2.134` ou inferior | `1.2.143` ou superior |
| Versão de tempo de execução do browser | `3.0.55` ou inferior  | `3.0.63` ou superior  |
...
| Agosto de 2026   | Fim do suporte para o runtime do Chrome 134; migração automática dos monitores restantes do Chrome 134                    |
| Novembro de 2026 | Fim do suporte para o runtime Node.js 16; migração automática dos monitores restantes do Node.js 16                       |
