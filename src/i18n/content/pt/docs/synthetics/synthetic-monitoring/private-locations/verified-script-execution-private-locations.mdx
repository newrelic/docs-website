...
A lista de localização privada na interface do New Relic inclui uma coluna <DNT>**VSE**</DNT> . Uma fechadura <Icon name="fe-lock"/> O ícone indica que a execução verificada do script foi configurada para esse local.
...
2. Selecione o lápis
   ...
   <DNT>**Advanced settings (optional)**</DNT>
...
4. Vá para
   ...
   <DNT>**[one.newrelic.com > Synthetic monitoring > Private locations](https://one.newrelic.com/synthetics-nerdlets/private-location-list)**</DNT>
