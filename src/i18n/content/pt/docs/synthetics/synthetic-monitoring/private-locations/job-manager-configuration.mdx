    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Se definido, habilita o Webassembly para o tempo de Node Browser Runtime. Para utilizar o Node Browser Runtime, seu gerenciador de tarefas Sintético deve utilizar o runtime Node versão 2.3.21 ou superior.
          </td>
        </tr>
      </tbody>
    </table>
