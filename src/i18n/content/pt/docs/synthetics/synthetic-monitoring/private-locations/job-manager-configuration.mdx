...
Onde $D\_avg,m$ é a sua **duração média de execução do job em minutos**.
...
Onde $N\_m$ é o seu **número de jobs por 5 minutos**. Este valor $P\_est$ é o seu **paralelismo estimado**.
