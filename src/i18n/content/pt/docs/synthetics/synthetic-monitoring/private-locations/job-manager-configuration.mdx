...
<CollapserGroup>
  ...
  <Collapser id="kubernetes" title="Kubernetes">
    ...
    * name: mount-custom-mods-pod image: nginx resources: requests: memory: &quot;64Mi&quot; cpu: &quot;250m&quot; limits: memory: &quot;128Mi&quot; cpu: &quot;500m&quot; volumeMounts:

      * mountPath: &quot;/var/lib/newrelic/synthetics/modules&quot; name: custom-modules-storage volumes:

    * name: custom-modules-storage persistentVolumeClaim: claimName: custom-modules-pvc EOF
    ...
    1. Verifique se o `mount-custom-mods-pod` está em execução.
    ...
    3. Verifique se `/var/lib/newrelic/synthetics/modules/custom-modules/package.json` existe no PV.
