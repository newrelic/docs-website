...
<CollapserGroup>
  ...
  <Collapser
    ...
    title={<><img src="/images/synthetic_logo_k8logo.webp" title="Kubernetes icon" alt="Kubernetes icon" style={{ height: '35px', width: '40px' }}>Requisitos do ambiente do sistema de orquestração de contêineres Kubernetes</img></>}
  >
    <table>
      <thead>
        <tr>
