...
4. Opcional: Defina estas configurações adicionais:
   ...
   * <DNT>
       **[Verified script execution](/docs/synthetics/new-relic-synthetics/private-locations/verified-script-execution-private-locations)**
     </DNT>
  ...
  >
    ...
    <Steps>
      <Step>
        ...
        1. Vá para <DNT>**[one.newrelic.com > Synthetic monitoring > Private locations](https://one.newrelic.com/synthetics/private-location-list)**</DNT>. Em seguida, clique em <DNT>**Create private location**</DNT>.<img
             title="Screenshot showing where to add a new private location"
             alt="Screenshot showing where to add a new private location"
             src="/images/synthetic_screenshot-crop_private-location-add.webp"
           />
