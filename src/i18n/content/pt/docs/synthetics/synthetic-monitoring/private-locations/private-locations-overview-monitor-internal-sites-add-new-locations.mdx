...
Depois de criar o local, o monitoramento sintético lista seu <DNT>**Private location key**</DNT> para que você possa [instalar um minion privado](/docs/synthetics/new-relic-synthetics/private-locations/install-containerized-private-minions-cpms#install-update).
  ...
  <Collapser id="rotate-private-location-keys" title="Girar chaves de localização privada">
    ...
    <Steps>
      <Step>
        ...
        2. Insira o nome da localização privada e marque <DNT>**Enable verified script execution**</DNT>. Em seguida, clique em <DNT>**Generate key**</DNT> para criar a nova localização privada.
        ...
        3. Atualize seus gerentes de trabalho ou minion privado com a nova localização privada. A seção <DNT>**Configure and deploy**</DNT> inclui código de exemplo:
