...
* `:8080/status/check`: fornece detalhes sobre as verificações de integridade internas que o Synthetics Job Manager executa. `HTTP 200` significa que o status está saudável.
...
Você pode monitorar a integridade do seu Synthetics Job Manager verificando os logs do contêiner do synthetics job manager.

<CollapserGroup>
  <Collapser id="review-docker-logs" title="Revise os logs do Docker">
  ...
  <Collapser id="review-podman-logs" title="Revise os logs do Podman">
  ...
  <Collapser id="review-kubernetes-logs" title="Revisar logs do Kubernetes">
...
<CollapserGroup>
  <Collapser id="docker-debug-logs" title="Habilitar log de depuração do Docker">
    <Callout variant="tip">
  ...
  <Collapser id="podman-debug-logs" title="Habilitar log de depuração do Podman">
    <Callout variant="tip">
  ...
  <Collapser id="kubernetes-debug-logs" title="Habilitar log de depuração do Kubernetes">
    <Callout variant="tip">
...
## Recuperar informações de depuração [#retrieve-debugging-information]

Você pode recuperar informações de depuração sobre o seu gerenciador de rotinas sintéticas para ajudar a solucionar problemas. Isso inclui informações sobre o pod do gerenciador de tarefas do Synthetics e o nó em que ele está sendo executado.

<CollapserGroup>
  <Collapser id="retrieve-kubernetes-debugging" title="Recuperar para Kubernetes">
  ...
  <Collapser id="retrieve-openshift-debugging" title="Recuperar para OpenShift">
