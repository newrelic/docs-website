...
<Callout variant="tip">
  Para visualizar e compartilhar outros exemplos de testes de API, visite a seção de [scripts de Sintéticos](https://support.newrelic.com/s/hubtopic/Topic__c/Default?c__categories=%5B%7B%22icon%22%3A%22standard%3Adefault%22%2C%22id%22%3A%22a6c8W000000EeseQAC%22%2C%22sObjectType%22%3A%22Category__c%22%2C%22title%22%3A%22Synthetics%22%2C%22titleFormatted%22%3A%22Synthetics%22%7D%5D) no Fórum de Suporte ou a [biblioteca de quickstarts de monitoramento sintético](https://newrelic.github.io/quickstarts-synthetics-library/#/).
</Callout>
