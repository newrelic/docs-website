...
O navegador com script emula uma experiência personalizada do usuário por meio de um navegador com script que navega no seu site, realiza ações específicas e garante que elementos específicos estejam presentes. [Selenium Webdriver](https://www.selenium.dev/documentation/webdriver/) controla o monitor com script. Cada vez que seu script é executado, o New Relic cria um navegador Chrome ou Firefox totalmente virtualizado, baseado em Selenium, que navega em seu site e segue cada etapa do script. monitoramento sintético inclui um editor script no estilo IDE que sugere funções, localizador e outros elementos para simplificar o script. Consulte [a referência do navegador com script](/docs/synthetics/synthetic-monitoring/scripting-monitors/synthetic-scripted-browser-reference-monitor-versions-chrome-100/) para obter uma lista de todas as funções disponíveis.
...
3. Selecione o bloco <DNT>**User flow / functionality**</DNT> para testar a disponibilidade e a funcionalidade do seu site em diferentes locais.
   ...
   <img title="Create monitor - User flow / functionality" alt="Create monitor - User flow / functionality" src={syntheticUserFlowFunctionality} />
...
4. Configurar o monitor. Preencha os campos desejados. Adicione um nome para seu monitor. Selecione o navegador e os dispositivos emulados que você gostaria de testar.
   ...
   <img title="Create monitor - configure monitor" alt="Create monitor - configure monitor" src={syntheticConfigureMonitor} />

5. Clique em <DNT>**Select locations**</DNT> para selecionar o local onde deseja testar o monitor.

   <img title="Create monitor - select locations" alt="Create monitor - select locations" src={syntheticSelectLocations} />
...
<CollapserGroup>
  <Collapser id="locate-by-class" title="Localize por classe CSS">
  ...
  <Collapser id="locate-by-id" title="Localizar por ID HTML">
  ...
  <Collapser id="locate-by-link-text" title="Localizar por texto vincular">
  ...
  <Collapser id="locate-by-name" title="Localizar por nome">
  ...
  <Collapser id="locate-by-xpath" title="Localizar por XPath">
...
<CollapserGroup>
  <Collapser id="clicking-elements" title="Clique em elemento da página">
  ...
  <Collapser id="entering-text" title="Insira o texto">
...
<CollapserGroup>
  <Collapser id="wait-page-title" title="Aguarde o título da página">
  ...
  <Collapser id="wait-page-element" title="Aguarde um elemento específico">
...
<CollapserGroup>
  <Collapser id="log-static" title="Log texto estático">
  ...
  <Collapser id="pass-a-variable" title="Passe uma variável para a função log">
