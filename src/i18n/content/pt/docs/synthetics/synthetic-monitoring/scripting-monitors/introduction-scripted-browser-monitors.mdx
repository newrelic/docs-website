...
3. Selecione o bloco <DoNotTranslate>**User flow / functionality**</DoNotTranslate> para testar a disponibilidade e a funcionalidade do seu site em diferentes locais.
...
5. Clique em <DoNotTranslate>**Select locations**</DoNotTranslate> para selecionar o local onde deseja testar o monitor.
...
6. Clique em <DoNotTranslate>**Write script**</DoNotTranslate> para adicionar seu script descrevendo as ações que você deseja que o monitor execute. O monitor preenche previamente o editor com um script de exemplo com o qual você pode trabalhar ou pode removê-lo e começar do zero.

7. Clique em <DoNotTranslate>**Validate**</DoNotTranslate> se quiser testar seu script. Isso pode levar alguns minutos dependendo do script.
