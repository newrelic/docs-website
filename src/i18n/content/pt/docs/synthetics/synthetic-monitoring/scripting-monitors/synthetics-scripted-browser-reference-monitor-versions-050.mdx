...
## APISelenium Webdriver [#selenium]

Ao utilizar as variáveis `$driver` e `$browser`, seu [browser com script](/docs/synthetics/new-relic-synthetics/scripting-monitors/write-scripted-browsers) obtém acesso ao [Selenium Webdriver API 3.6.0](http://seleniumhq.github.io/selenium/docs/api/javascript/index.html) para monitor versão 0.6.x e [API Selenium Webdriver 3.5.0](http://seleniumhq.github.io/selenium/docs/api/javascript/index.html) para monitor versão 0.5.x.
