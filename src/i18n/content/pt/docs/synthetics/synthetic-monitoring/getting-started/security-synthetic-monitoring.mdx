  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * &quot;Heartbeat&quot; do Synthetics Job Manager a cada 30 segundos

          O [evento`SyntheticsPrivateMinion` ](/attribute-dictionary/?event=SyntheticsPrivateMinion)contém o status básico do Synthetics Job Manager, incluindo contagens de sucesso e falha de jobs, tamanho da fila, versão do minion, etc.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Os dados recebidos do endpoint de monitoramento sintético contêm os detalhes da verificação agendada. Isso inclui as informações necessárias para concluir a verificação para o Synthetics Job Manager:
    ...
    <tr>
      ...
      <td>
        Espera-se que os [locais públicos do Synthetic](/docs/synthetics/new-relic-synthetics/administration/synthetics-public-minion-ips) sejam ativados usando credenciais não pessoais. Seus endereços IP não são definidos como dados pessoais sob as leis de proteção de dados e privacidade.
      </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * Adicione os IPs de locais públicos sintéticos à sua lista de permissões ou lista de bloqueio.
    ...
    <tr>
      ...
      <td>
        Além das URLs de destino monitoradas pela New Relic, os Synthetics Job Managers enviarão dados para o endpoint de monitoramento sintético e receberão dados dele regularmente. Para configurar um proxy para todo o tráfego de e para este endpoint, defina as [variáveis de ambiente HORDE\_API\_PROXY\_HOST e HORDE\_API\_PROXY\_PORT](/docs/synthetics/synthetic-monitoring/private-locations/job-manager-configuration/#environment-variables).
      </td>
    </tr>

    <tr>
      <td>
        Segurança do Synthetics Job Manager
      </td>

      <td>
        Para garantir que apenas os scripts que você pretende executar tenham permissão para serem executados no seu Synthetics Job Manager, use a [execução de script verificada](/docs/synthetics/new-relic-synthetics/private-locations/verified-script-execution-private-locations).
      </td>
    </tr>
  </tbody>
</table>