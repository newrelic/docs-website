...
<Tabs>
  <TabsBar>
    <TabsBarItem id="URL">Ir para uma URL</TabsBarItem> <TabsBarItem id="element">Interagir com um elemento de página</TabsBarItem> <TabsBarItem id="wait">Aguardar um elemento de página</TabsBarItem> <TabsBarItem id="login">fazer login em um site</TabsBarItem>
  </TabsBar>
