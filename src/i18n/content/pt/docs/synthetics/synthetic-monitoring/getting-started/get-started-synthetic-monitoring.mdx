...
Vá para <DoNotTranslate>**[one.newrelic.com > Synthetic monitoring > Create a monitor](https://one.newrelic.com/synthetics-nerdlets/monitor-create)**</DoNotTranslate> e escolha <DoNotTranslate>**User flow/functionality**</DoNotTranslate> para Browser com script.
