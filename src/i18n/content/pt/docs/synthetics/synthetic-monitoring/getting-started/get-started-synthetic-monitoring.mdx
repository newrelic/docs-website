  ...
  <Step>
    ...
    <SideBySide>
      <Side>
        ...
        Independentemente do que você escolher construir, lembre-se de clicar em <DNT>**Validate**</DNT> antes de salvar seu monitor. A validação verifica se as etapas que você reuniu foram executadas com êxito.  
