...
<CollapserGroup>
  ...
  >
    ...
    Uma solicitação bem-sucedida retornará uma resposta <DoNotTranslate>**200 OK**</DoNotTranslate> . Os [dados retornados](/docs/apis/synthetics-rest-api/monitor-examples/payload-attributes-synthetics-rest-api#api-attributes) serão um objeto JSON no seguinte formato:
  ...
  >
    ...
    Um ID de monitor inválido retornará o erro <DoNotTranslate>**404 Not Found**</DoNotTranslate>: O monitor especificado não existe.
  </Collapser>
  ...
  >
    ...
    Além disso, para <DoNotTranslate>**add a scripted monitor**</DoNotTranslate> por meio da chamada de API REST, um [endpoint adicional de API](/docs/apis/synthetics-rest-api/monitor-examples/manage-synthetics-monitor-scripts-rest-api) para enviar o script para o monitor recém-criado.
    ...
    Uma solicitação bem-sucedida retornará uma resposta <DoNotTranslate>**201 Created**</DoNotTranslate> , com o URI do monitor recém-criado especificado no cabeçalho `location` . Os possíveis códigos de erro incluem:

    * <DoNotTranslate>**400 Bad Request**</DoNotTranslate>
    ...
    * <DoNotTranslate>**402 Payment Required**</DoNotTranslate>
  ...
  >
    ...
    Uma solicitação bem-sucedida retornará uma resposta <DoNotTranslate>**204 No Content**</DoNotTranslate> , com corpo vazio. Os possíveis códigos de erro incluem:

    * <DoNotTranslate>**400 Bad Request**</DoNotTranslate>

      : um ou mais valores de monitor são inválidos ou o formato da solicitação é inválido. Por exemplo, a frequência está fora dos limites ou um ou mais dos locais especificados são inválidos (consulte a mensagem de erro no corpo da resposta).

    * <DoNotTranslate>**404 Not Found**</DoNotTranslate>
  ...
  >
    ...
    Uma solicitação bem-sucedida retornará uma resposta <DoNotTranslate>**204 No Content**</DoNotTranslate> , com corpo vazio. Uma solicitação malsucedida retornará a resposta <DoNotTranslate>**404 Not Found**</DoNotTranslate>: O monitor especificado não existe.
  </Collapser>
...
Além da API geral, existem vários métodos de API para os tipos de monitor <DoNotTranslate>**scripted browser**</DoNotTranslate> (`SCRIPT_BROWSER`) e <DoNotTranslate>**api test**</DoNotTranslate> (`SCRIPT_API`).
...
<CollapserGroup>
  ...
  >
    ...
    Uma solicitação bem-sucedida retornará uma resposta <DoNotTranslate>**200 OK**</DoNotTranslate> . Os dados retornados serão um objeto JSON no seguinte formato:
    ...
    * <DoNotTranslate>**403 Forbidden:**</DoNotTranslate>
...
## Exemplo de navegador com script

Aqui está um exemplo de uso da API REST da New Relic e do script bash para criar um script com monitor de navegador.

<CollapserGroup>
  <Collapser
    id="sample-script"
    title="Exemplo de API de navegador com script"
  >
    O exemplo a seguir mostra o comando curl para criar um script com do monitor do navegador.
