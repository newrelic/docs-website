...
<CollapserGroup>
  ...
  >
    ...
    <DoNotTranslate>**Goal:**</DoNotTranslate> Reduza o número de incidentes de baixo valor e incômodos.
  ...
  >
    Este é o percentual de incidentes com duração total inferior a cinco minutos. Isso pode indicar um incidente que muda de estado com muita frequência, o que obscurece a causa e a gravidade do incidente. Este estado é conhecido como <DoNotTranslate>**incident flapping**</DoNotTranslate>.
