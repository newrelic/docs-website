...
<Steps>
  ...
  <Step>
    ...
    9. Escolha <DNT>**Add environment variable**</DNT> novamente.
    10. Para <DNT>**Key**</DNT> defina-o como `OTEL_SERVICE_NAME` e defina <DNT>**Value**</DNT> como o nome da sua função. Em seguida, escolha <DNT>**Save**</DNT>.
