...
<Steps>
  <Step>
    ...
    3. Em <DoNotTranslate>**Specify an ARN**</DoNotTranslate>, cole um dos ARNs de camada para a arquitetura da sua função na lista abaixo. Substitua `{region}`pela sua região da AWS, como `us-east-1`.
