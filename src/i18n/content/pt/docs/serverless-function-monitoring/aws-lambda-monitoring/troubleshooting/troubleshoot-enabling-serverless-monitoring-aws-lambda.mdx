...
<CollapserGroup>
  ...
  >
    ...
    2. Clique no link <DoNotTranslate>**logs**</DoNotTranslate> após a execução da função.

    3. Isso o levará ao log do CloudWatch na AWS. Na barra lateral esquerda da AWS, em <DoNotTranslate>**Logs**</DoNotTranslate>, clique em <DoNotTranslate>**Insights.**</DoNotTranslate>

    4. Selecione seu <DoNotTranslate>**function**</DoNotTranslate> e também o stream <DoNotTranslate>**newrelic-log-ingestion**</DoNotTranslate> .

    5. Aplique um <DoNotTranslate>**Time Filter**</DoNotTranslate> apropriado e uma entrada log <DoNotTranslate>**limit**</DoNotTranslate> (o padrão de 20 pode não ser suficiente).

    6. Em <DoNotTranslate>**Actions**</DoNotTranslate> selecione <DoNotTranslate>**Copy query results (ASCII)**</DoNotTranslate>.

    7. Cole o texto copiado em um novo arquivo de texto e <DoNotTranslate>**save and upload the text file to the ticket.**</DoNotTranslate>
