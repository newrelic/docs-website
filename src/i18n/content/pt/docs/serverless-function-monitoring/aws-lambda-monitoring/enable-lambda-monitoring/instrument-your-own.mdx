...
<CollapserGroup>
  ...
  >
    Serverless Framework is a popular development and deployment tool for serverless applications. It's written in Node.js, and for AWS, acts mostly as a higher-level abstraction on top of CloudFormation templates. It works well for Node, Python, Ruby and Java functions.
...
2. For Python, Ruby, Node.js and Java, we also include:
