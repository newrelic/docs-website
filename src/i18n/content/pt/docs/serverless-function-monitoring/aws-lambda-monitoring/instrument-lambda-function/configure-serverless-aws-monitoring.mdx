...
Nossos exemplos são publicados, junto com a New Relic Lambda Extension, neste [repositório do GitHub](https://github.com/newrelic/newrelic-lambda-extension-rust). Há um para cada runtime do Lambda suportado pela New Relic:

* [Node.js](https://github.com/newrelic/newrelic-lambda-extension-rust/tree/main/examples/sam/node)
* [Python](https://github.com/newrelic/newrelic-lambda-extension-rust/tree/main/examples/sam/python)
* [Go](https://github.com/newrelic/newrelic-lambda-extension-rust/tree/main/examples/sam/go)
* [Java](https://github.com/newrelic/newrelic-lambda-extension-rust/tree/main/examples/sam/java)
* [Ruby](https://github.com/newrelic/newrelic-lambda-extension-rust/tree/main/examples/sam/ruby)
* [.NET](https://github.com/newrelic/newrelic-lambda-extension-rust/tree/main/examples/sam/dotnet)

Você também pode aprender como instrumentar distributed tracing em um aplicativo Serverless não trivial em nosso [exemplo de distributed tracing](https://github.com/newrelic/newrelic-lambda-extension-rust/tree/main/examples/sam/distributedtracing). Ele ilustra a propagação manual trace para SQS e SNS, dois dos serviços mais populares que podem invocar a função do Lambda, com funções Node, Python, Ruby e Java.
...
<DocTiles>
  <DocTile title="Compatibilidade e requisitos" path="/docs/serverless-function-monitoring/aws-lambda-monitoring/instrument-lambda-function/compatibility-requirement-lambda-monitoring">
    Saiba mais sobre runtimes suportados e pré-requisitos.
  </DocTile>
  ...
  <DocTile title="Dados e interface" path="/docs/serverless-function-monitoring/aws-lambda-monitoring/ui-data/understand-lambda-monitoring-ui/">
    Saiba como usar o New Relic para monitorar suas funções do AWS Lambda.
  </DocTile>

  <DocTile title="Resolução de problemas" path="/docs/serverless-function-monitoring/aws-lambda-monitoring/troubleshooting">
    Saiba como solucionar problemas relacionados à instalação.
  </DocTile>
</DocTiles>