...
<Steps>
  <Step>
    ...
    <Tabs>
      <TabsBar>
        <TabsBarItem id="java">Java</TabsBarItem> <TabsBarItem id="python">Python</TabsBarItem> <TabsBarItem id="nodejs">Node.js</TabsBarItem> <TabsBarItem id="ruby">Ruby</TabsBarItem> <TabsBarItem id="dotnet">.NET</TabsBarItem> <TabsBarItem id="extension">somente extensão</TabsBarItem>
      </TabsBar>
