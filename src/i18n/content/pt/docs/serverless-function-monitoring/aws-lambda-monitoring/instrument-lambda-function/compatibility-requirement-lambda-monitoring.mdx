...
### Permissões de integração de infraestrutura [#integration-permissions]
...
### Permissões da CLI [#cli-permissions]
...
Para mais informações, consulte o [repositório da CLI newrelic-lambda](https://github.com/newrelic/newrelic-lambda-cli#installation).
...
<Tabs>
  ...
  <TabsPages>
    ...
    <TabsPageItem id="3">
      ...
      * Python (SO/arquitetura: Linux, Windows, ARM, ARM 64, x86, x86-64): `python3.7`, `python3.8`, `python3.9`, `python3.10`, `python3.11`, `python3.12`, `python3.13`, `python3.14`
