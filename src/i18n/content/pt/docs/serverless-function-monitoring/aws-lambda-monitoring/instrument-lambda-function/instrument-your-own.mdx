...
<CollapserGroup>
  ...
  <Collapser id="cloudformation" title="Modelos CloudFormation/SAM">
    ...
    1. Instale a [camada Lambda do New Relic](https://layers.newrelic-external.com/). Abaixo estão exemplos para funções do Lambda do agente Node.js e Java.
       ...
       **Exemplo de agente Java (camada slim, recomendado):**

       <Callout variant="important">
         A camada do agente Java requer o Java 17 ou posterior. Runtimes do Java 11 e anteriores não são suportados.
       </Callout>
  ...
  <Collapser id="console" title="Instrumentação manual AWS">
    Embora seja mais propenso a erros e trabalhoso do que as abordagens acima, você pode alterar manualmente a configuração de uma função do Lambda para usar o New Relic a partir do console do AWS Lambda, para Node.js, Python, Ruby e Java.
