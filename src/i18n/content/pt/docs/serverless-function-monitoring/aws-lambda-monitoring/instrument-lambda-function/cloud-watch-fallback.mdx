...
<CollapserGroup>
  ...
  >
    ...
    4. Crie um filtro de assinatura de log do CloudWatch para invocar a função `newrelic-log-ingestion` com o log da sua função.
    ...
    * Como alternativa, use o console AWS para criar um filtro de assinatura do grupo log do CloudWatch da sua função para invocar a `newrelic-log-ingestion` função do Lambda.
    ...
    5. Defina o
       ...
       <DNT>
         **Subscription filter pattern to**
       </DNT>
