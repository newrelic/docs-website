...
Os dados exibidos [na interface](/docs/lambda-monitoring-ui) são uma combinação dessas fontes de dados. Por exemplo, a página <DoNotTranslate>**Overview**</DoNotTranslate> exibe dados relatados pela instrumentação, enquanto a página <DoNotTranslate>**Metrics**</DoNotTranslate> exibe dados do CloudWatch.
