...
Este método fornece <DoNotTranslate>**full control**</DoNotTranslate> da instalação. Você é responsável por colocar os arquivos nas pastas corretas, fornecer os valores de configuração corretos e garantir que o agente tenha todas as permissões corretas.
...
<DoNotTranslate>**Optionally**</DoNotTranslate>, você pode:
