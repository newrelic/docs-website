...
2. Determine o número da versão de distribuição:
   ...
   <CollapserGroup>
     <Collapser
       id="debian-version"
       title={<><img src="/images/os_icon_debian.webp" title="Debian icon" alt="Debian.png" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}>Debian</img></>}
     >
       ```bash
       cat /etc/os-release
       ```
     ...
     <Collapser
       id="ubuntu-version"
       title={<><img src="/images/os_icon_ubuntu.webp" title="ubuntu icon" alt="ubuntu icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}>Ubuntu</img></>}
     >
       ```bash
       cat /etc/lsb-release
       ```
     ...
     <Collapser
       id="sles-version"
       title={<><img src="/images/os_icon_suse.webp" title="suse icon" alt="suse icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}>SLES</img></>}
     >
       ```bash
...
3. Habilite a chave GPG do New Relic:
   ...
   <CollapserGroup>
     <Collapser
       id="debian-gpg"
       title={<><img src="/images/os_icon_debian.webp" title="Debian.png" alt="Debian.png" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}>Debian</img></>}
     >
       ```bash
...
4. Adicione o repositório do agente de infraestrutura:
   ...
   <CollapserGroup>
     ...
     <Collapser
       ...
       title={<><img src="/images/os_icon_amazon-linux.webp" title="amazon linux.png" alt="amazon linux.png" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}>Amazon Linux</img></>}
     >
       <DNT>
         **Amazon Linux 2 (x86)**
       </DNT>
     ...
     <Collapser
       ...
       title={<><img src="/images/os_icon_centos.webp" title="centos icon" alt="centos icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}>CentOS /<img src="/images/os_icon_redhat.webp" title="redhat icon" alt="redhat icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>RHEL e Oracle Linux</img></>}
     >
       <DNT>
...
6. Instale o pacote `newrelic-infra` no modo root (padrão), usuário privilegiado ou usuário não privilegiado. Para obter mais informações sobre cada modo de execução, consulte [Modos de execução do agente Linux](/docs/infrastructure/install-configure-infrastructure/linux-installation/linux-agent-running-modes).
   ...
   <CollapserGroup>
     ...
     >
       * <DNT>
           **<img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="Debian.png" alt="Debian.png" src="/images/os_icon_debian.webp"/>**
         </DNT>
       ...
       * <DNT>
           **<img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="amazon linux.png" alt="amazon linux.png" src="/images/os_icon_amazon-linux.webp"/>**
         </DNT>
