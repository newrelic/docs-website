---
title: Pacote de instrumentação para monitoramento de infraestrutura
tags:
  - Infrastructure
...
Se você atender aos [requisitos](#requirements) e tiver instalado o agente de monitoramento de infraestrutura correto, não haverá etapas adicionais para ativar o monitoramento de contêiner. Se um tempo de execução de contêiner estiver em execução, os dados serão relatados automaticamente.

Também é possível usar uma imagem de contêiner contendo o agente de monitoramento de infraestrutura. Para mais informações, consulte [contêiner para monitoramento de infraestrutura](/docs/infrastructure/install-infrastructure-agent/linux-installation/container-infrastructure-monitoring).
...
* Vá para <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Hosts > Containers**</DoNotTranslate>.

  OU

* Vá para <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Third-party services**</DoNotTranslate> e selecione links relacionados Docker .
...
1. Vá para <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI**</DoNotTranslate>.
   ...
   Vá para <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Settings > Alerts**</DoNotTranslate>.

2. Crie uma nova [condição do alerta](/docs/alerts/new-relic-alerts/defining-conditions/create-alert-conditions).

3. Para o tipo de condição, selecione <DoNotTranslate>**Container metrics**</DoNotTranslate>.
