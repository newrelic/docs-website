...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="fedramp"
  >
    Especifica se o endpoint Fedramp deve ser usado.
  ...
  >
    ...
    <Callout variant="important">
      <DoNotTranslate>**Recommendation:**</DoNotTranslate> Não mude esta configuração.
    </Callout>
  ...
  >
    ...
    Se definido como <DoNotTranslate>**negative value**</DoNotTranslate>, o agente continuará verificando a conexão até que seja bem-sucedida.
