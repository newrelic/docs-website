...
<CollapserGroup>
  ...
  >
    ...
    * <DNT>**From inside the config file:**</DNT> Adicione uma entrada ao [arquivo de configuração da infraestrutura](https://github.com/newrelic/infrastructure-agent/blob/master/assets/examples/infrastructure/newrelic-infra-template.yml.example) para permitir que o agente obtenha as variáveis de ambiente que você definiu.
    ...
    * <DNT>**From the command line:**</DNT> Use outra variável de ambiente para passar por essas configurações.
