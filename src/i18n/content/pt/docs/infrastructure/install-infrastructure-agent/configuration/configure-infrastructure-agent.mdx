...
<img title="infrastructure config cascade (orders of precedence).webp" alt="infrastructure config cascade (orders of precedence).webp" src={infrastructureCascadeConfig} />
