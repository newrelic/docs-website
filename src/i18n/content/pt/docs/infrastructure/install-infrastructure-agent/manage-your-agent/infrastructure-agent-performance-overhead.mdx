...
<CollapserGroup>
  ...
  >
    ...
    * <DoNotTranslate>**Memory**</DoNotTranslate>: 32,0GB

    * <DoNotTranslate>**Storage**</DoNotTranslate>: 160,0GB

    * <DoNotTranslate>**Operating system**</DoNotTranslate>: CentOS 7

      Para este tipo de host clássico de tarefa única, o uso típico é:

    * <DoNotTranslate>**CPU**</DoNotTranslate>: cerca de 0,3%

    * <DoNotTranslate>**Virtual memory**</DoNotTranslate>: cerca de 1 GB

    * <DoNotTranslate>**Resident memory**</DoNotTranslate>: 25 a 35MB

    * <DoNotTranslate>**Storage on disk**</DoNotTranslate>: cerca de 50 MB
  </Collapser>
  ...
  >
    ...
    * <DoNotTranslate>**Number of containers**</DoNotTranslate>: 25 contêineres, cerca de 100 processos de longa duração rodando em contêineres

    * <DoNotTranslate>**Operating system**</DoNotTranslate>: CentOS 7

      Para este tipo de host Docker, o uso típico é:

    * <DoNotTranslate>**CPU**</DoNotTranslate>: cerca de 0,8%
  ...
  >
    ...
    * <DoNotTranslate>**Memory**</DoNotTranslate>: 2,0GB

    * <DoNotTranslate>**Storage**</DoNotTranslate>: 30,0GB

    * <DoNotTranslate>**Operating system**</DoNotTranslate>: Servidor Windows 2012 R2

      Para este tipo de host Windows, o uso típico é:

    * <DoNotTranslate>**CPU**</DoNotTranslate>: 2 a 3%

    * <DoNotTranslate>**Resident Memory**</DoNotTranslate>: 30MB
  ...
  >
    ...
    * <DoNotTranslate>**Virtual memory**</DoNotTranslate>

      : cerca de 0,75 GB ARM versus 1 GB AMD

    * <DoNotTranslate>**Resident memory**</DoNotTranslate>
