...
* <DoNotTranslate>**SystemD**</DoNotTranslate> (Amazon Linux 2, SLES 12, CentOS 7 ou superior, Debian 8 ou superior, RHEL 7 ou superior, Ubuntu 15.04 ou superior):
...
* <DoNotTranslate>**Upstart**</DoNotTranslate> (Amazon Linux, RHEL 6, Ubuntu 14.04 ou inferior):
...
<Callout variant="important">
  Para iniciar, parar ou reiniciar o agente, você deve executar `cmd.exe` ou PowerShell como <DoNotTranslate>**Administrator**</DoNotTranslate>.
</Callout>
