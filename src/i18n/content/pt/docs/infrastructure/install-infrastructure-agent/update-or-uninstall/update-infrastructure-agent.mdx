...
<CollapserGroup>
  <Collapser
    id="apt-update"
    title={<>Atualizar usando apt (<img src="/images/os_icon_debian.webp" title="Debian icon" alt="Debian.webp" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}>Debian,<img src="/images/os_icon_ubuntu.webp" title="ubuntu icon" alt="ubuntu icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>Ubuntu)</img></>}
  >
  ...
  <Collapser
    id="zypper-update"
    title={<>Atualizar usando Zypper (<img src="/images/os_icon_suse.webp" title="suse icon" alt="suse icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}>LES)</img></>}
  >
  ...
  <Collapser
    ...
    title={<>Atualizar em<img src="/images/os_icon_windows.webp" title="Windows Server" alt="Windows Server icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}>Servidor Windows (32 bits)</img></>}
  >
  ...
  <Collapser
    id="windows-update"
    title={<>Atualizar em<img src="/images/os_icon_windows.webp" title="Windows Server" alt="Windows Server icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}>Servidor Windows (64 bits)</img></>}
  >
    Para atualizar manualmente o agente de infraestrutura no Windows Server:
  ...
  >
    ...
    * <img
      ...
      >
        [Configurar com AWS Elastic Beanstalk](/docs/infrastructure/install-infrastructure-agent/config-management-tools/install-infrastructure-agent-aws-elastic-beanstalk)
      </img>
