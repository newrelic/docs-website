...
Após uma configuração bem-sucedida, pode levar até quinze minutos para que a métrica comece a aparecer no New Relic. Visualize as páginas de infraestrutura do seu host em <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DoNotTranslate>.
