...
<CollapserGroup>
  ...
  >
    ...
    Use JSON padrão, não JSON "bem impresso", para a saída. <DNT>**Recommendation:**</DNT> Inclua uma opção de linha de comando opcional (por exemplo, `--pretty`) para tornar o JSON "bem impresso" para fins de depuração.
  </Collapser>
...
Uma carga útil mínima seria um objeto JSON com apenas os campos de cabeçalho. <DNT>**Recommendation:**</DNT> Se não houver dados para coletar, use o código de retorno do programa e a mensagem do log escrita em `stderr`.
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <DNT>**Recommendation:**</DNT> Use nomes de domínio reversos para gerar nomes de integração exclusivos.
      </td>
    </tr>
        ...
        <tbody>
          <tr>
            ...
            <td>
              ...
              <DNT>**Recommendation:**</DNT> Para garantir que os tipos de eventos usados pela sua integração sejam exclusivos, prefixe o tipo de evento com o nome ou sigla da sua empresa. Por exemplo, se sua integração personalizada capturar a métrica do nó Cassandra e a métrica da família de colunas Cassandra como amostras diferentes, armazene-as em tipos de eventos diferentes, como `MyOrgCassandraSample` e `MyOrgCassandraColumnFamilySample`.
          ...
          <tr>
            ...
            <td>
              ...
              <DNT>**Recommendation:**</DNT> Prefixe sua métrica com uma categoria para ajudar na navegação pela métrica na interface do New Relic . A integração New Relic usa atualmente:
          ...
          <tr>
            ...
            <td>
              <DNT>**Recommendation:**</DNT> Especifique a unidade de medida usando um sufixo de unidade se ainda não estiver incluído no nome da métrica original, como nos exemplos a seguir:
