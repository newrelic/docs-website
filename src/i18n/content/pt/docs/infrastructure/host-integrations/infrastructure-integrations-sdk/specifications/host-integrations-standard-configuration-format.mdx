...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Lista opcional de argumentos de linha de comando quando `name` é usado para fornecer o executável de integração. _Disponível desde a versão do agente <DNT>**1.13.0**</DNT>._
      </td>
    </tr>
