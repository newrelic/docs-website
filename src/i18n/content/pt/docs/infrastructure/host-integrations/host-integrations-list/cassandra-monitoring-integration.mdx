...
A integração Cassandra coleta informações métricas(<DoNotTranslate>**M**</DoNotTranslate>) e de inventário(<DoNotTranslate>**I**</DoNotTranslate>). Na tabela, use a coluna <DoNotTranslate>**Applies To**</DoNotTranslate> para as configurações disponíveis para cada coleção:
...
Os dados desta integração podem ser encontrados em: <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > Third-party services > Cassandra**</DoNotTranslate>.
