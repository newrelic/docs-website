...
A integração do Microsoft SQL Server coleta informações métricas e de inventário. Na tabela, use a coluna <DoNotTranslate>**Applies to**</DoNotTranslate> para as configurações disponíveis para cada coleção:
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Porta na qual o servidor MS SQL está escutando. <br/><DoNotTranslate>**Note**</DoNotTranslate>: a porta só é necessária quando `INSTANCE` não é especificado.
      </td>
    ...
    <tr>
      ...
      <td>
        A instância do MS SQL Server à qual se conectar. <br/><DoNotTranslate>**Note**</DoNotTranslate>: obrigatório somente quando `PORT` não for especificado. Não use ambos.
      </td>
