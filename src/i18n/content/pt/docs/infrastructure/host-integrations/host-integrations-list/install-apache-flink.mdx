...
Para instrumentar o Apache Flink início rápido e ver métricas e alertas, você também pode seguir nossa [página Apache Flink início rápido](https://newrelic.com/instant-observability/apache-flink) clicando no botão <DoNotTranslate>**Install now**</DoNotTranslate> .
