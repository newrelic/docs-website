...
<CollapserGroup>
  ...
  >
    ...
    5. Para ativar a análise automática de log e encaminhamento de erros do Mongodb, crie um arquivo YAML com o seguinte conteúdo em `/etc/newrelic-infra/logging.d/mongodb-log.yml`. Não há necessidade de reiniciar o agente.
