...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        URI de conexão do MongoDB. <DNT>**Required**</DNT>
      </td>
...
As seguintes métricas dimensionais são capturadas raspando o exportador e vinculadas à entidade <DNT>**MONGODB_COLLECTION**</DNT>:
...
As seguintes métricas dimensionais são capturadas raspando o exportador e vinculadas à entidade <DNT>**MONGODB_DATABASE**</DNT>:
