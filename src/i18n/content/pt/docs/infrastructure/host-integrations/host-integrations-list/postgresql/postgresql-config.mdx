...
A integração PostgreSQL coleta informações métricas (<DoNotTranslate>**M**</DoNotTranslate>) e de inventário (<DoNotTranslate>**I**</DoNotTranslate>). A coluna <DoNotTranslate>**Applies To**</DoNotTranslate> na tabela a seguir indica quais configurações podem ser usadas para cada coleção específica:
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        O nome de usuário para a conexão PostgreSQL. <DoNotTranslate>**Required.**</DoNotTranslate>
      </td>
    ...
    <tr>
      ...
      <td>
        A senha para a conexão PostgreSQL. <DoNotTranslate>**Required.**</DoNotTranslate>
      </td>
