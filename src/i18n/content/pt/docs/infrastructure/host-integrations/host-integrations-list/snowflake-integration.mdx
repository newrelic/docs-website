...
<Steps>
  ...
  <Step>
    ...
    Execute o comando abaixo para armazenar as métricas do Snowflake em formato JSON, permitindo que o nri-flex as leia. Certifique-se de modificar `ACCOUNT`, `USERNAME` e `SNOWSQL_PWD` de acordo.
