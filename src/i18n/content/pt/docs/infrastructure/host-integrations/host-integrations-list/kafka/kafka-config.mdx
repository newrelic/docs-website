...
A integração Kafka coleta informações métricas e de inventário. Verifique a coluna <DoNotTranslate>**Applies To**</DoNotTranslate> abaixo para ver as configurações disponíveis para cada coleção:
...
A integração Kafka coleta informações métricas(<strong>M</strong>) e de Inventário(<strong>I</strong>). Verifique a coluna <DoNotTranslate>**Applies To**</DoNotTranslate> abaixo para descobrir quais configurações podem ser usadas para cada coleção específica:
...
A integração Kafka coleta informações métricas e de inventário. Verifique a coluna <DoNotTranslate>**Applies To**</DoNotTranslate> abaixo para descobrir quais configurações podem ser usadas para cada coleção específica:
