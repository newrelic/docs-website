...
<CollapserGroup>
  <Collapser id="32-bit-path" title="Windows de 32 bits">
    ```shell
    msiexec.exe /qn /i PATH_TO\nri-mssql-amd386.msi
    ```
  </Collapser>

  <Collapser id="64-bit-path" title="Windows de 64 bits">
    ```shell
    msiexec.exe /qn /i PATH_TO\nri-mssql-amd64.msi
    ```
  </Collapser>
...
<CollapserGroup>
  <Collapser id="sql-user" title="Para usuário SQL">
  ...
  <Collapser id="domain-user" title="Para usuário de domínio Windows">
...
<CollapserGroup>
  ...
  <Collapser id="basic-config-domain" title="Configuração básica com autenticação de domínio Windows">
  ...
  <Collapser id="multi-instance" title="Conexão multi-instância">
  ...
  <Collapser id="metrics-connect-ssl" title="Conexão somente métrica via SSL">
  ...
  <Collapser id="disable-buffer_reserve" title="Pool de buffers e otimização métrica de reserva de partição">
...
<CollapserGroup>
  <Collapser id="database-metric" title="Métrica de banco de dados">
  ...
  <Collapser id="instance-metric" title="Instância métrica">
  ...
  <Collapser id="wait-metric" title="Espere métrica">
