...
<CollapserGroup>
  <Collapser
    id="step1"
    title="Etapa 1. Crie um token ao portador na plataforma Ansible Automation"
  >
    ...
    Crie um arquivo chamado "bearer_token_file" no caminho desejado.
  ...
  <Collapser
    id="step2"
    title="Etapa 2. Configurando a integração do Prometheus OpenMetrics"
  >
  ...
  <Collapser
    id="step3"
    title="Etapa 3. Encaminhar log do controlador Ansible para New Relic"
  >
  ...
  <Collapser
    id="step4"
    title="Etapa 4. Reinicie seu agente de infraestrutura"
  >
  ...
  <Collapser
    id="step5"
    title="Etapa 5. Use NRQL para visualizar seus dados"
  >
