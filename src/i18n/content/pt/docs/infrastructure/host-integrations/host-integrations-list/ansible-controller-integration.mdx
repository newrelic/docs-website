...
import infrastructureAnsibleControllerDashboard from 'images/infrastructure_screenshot-full_ansible-controller-dashboard.webp'
...
<CollapserGroup>
  ...
  >
    Depois de fazer login na plataforma Ansible Automation, navegue até a seção <DoNotTranslate>**Users**</DoNotTranslate>, selecione <DoNotTranslate>**admin**</DoNotTranslate> e adicione um <DoNotTranslate>**token**</DoNotTranslate> ao usuário. Copie o token e salve-o no caminho desejado.
...
Com o agente de infraestrutura instalado e instrumentado com seu aplicativo, você pode visualizar seus dados brutos em nosso <DoNotTranslate>**Metrics & events**</DoNotTranslate>. Nosso dashboard padrão transforma esses dados brutos em tabelas e gráficos, que fornecem uma visão panorâmica da saúde do seu sistema. Para instalar nosso painel padrão, acesse nossa [página de observabilidade instantânea](https://newrelic.com/instant-observability/ansible-automation-controller) do Ansible Automation Controller).
