...
<Callout title="PRÉVIA PÚBLICA">
  Este recurso está atualmente em versão prévia pública e se aplica apenas às versões a partir de [0.0.5](https://github.com/newrelic/newrelic-prometheus-exporters-packages/releases/tag/nri-powerdns-0.0.5) lançadas em outubro de 2021.
</Callout>
