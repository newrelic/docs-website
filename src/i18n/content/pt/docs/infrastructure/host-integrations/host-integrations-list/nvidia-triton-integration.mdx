...
<Steps>
  ...
  <Step>
    ...
    1. Acesse **[one.newrelic.com](https://one.newrelic.com) > + Add data** e digite **NVIDIA Triton**.
    ...
    Você pode encontrar seu dashboard personalizado do NVIDIA Triton na interface <DoNotTranslate>**Dashboards**</DoNotTranslate>. Consulte nossa seção [dashboard](/docs/query-your-data/explore-query-data/dashboards/introduction-dashboards) para obter mais informações.
