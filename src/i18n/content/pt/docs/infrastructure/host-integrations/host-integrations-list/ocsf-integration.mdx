...
Use o New Relic para monitorar dados do Open Cybersecurity Schema Framework (OCSF) de forma integrada. Você terá visibilidade abrangente de dados relacionados à segurança de múltiplas fontes para facilitar a detecção de ameaças, a resposta a eventos de alerta e a conformidade.
