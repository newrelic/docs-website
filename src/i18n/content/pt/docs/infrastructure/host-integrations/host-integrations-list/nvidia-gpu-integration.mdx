...
```
  ...
  <Step>
    ...
    1. Vá para <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/)**</DoNotTranslate> e clique em <DoNotTranslate>**Dashboards**</DoNotTranslate>.

    2. Clique na guia <DoNotTranslate>**Import dashboard**</DoNotTranslate>.
    ...
    5. Clique em <DoNotTranslate>**Import dashboard**</DoNotTranslate> para confirmar a ação.
