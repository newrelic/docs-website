...
```
  ...
  <Step>
    ...
    1. Vá para
       ...
       <DNT>**[one.newrelic.com](https://one.newrelic.com/)**</DNT> e clique em <DNT>**Dashboards**</DNT>.

    2. Clique na guia <DNT>**Import dashboard**</DNT>.
    ...
    5. Clique em <DNT>**Import dashboard**</DNT> para confirmar a ação.
