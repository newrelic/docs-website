...
A integração Redis coleta informações métricas(<DoNotTranslate>**M**</DoNotTranslate>) e de inventário(<DoNotTranslate>**I**</DoNotTranslate>). Na tabela, use a coluna <DoNotTranslate>**Applies To**</DoNotTranslate> para as configurações disponíveis para cada coleção:
