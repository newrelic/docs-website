...
<ButtonGroup>
  ...
  <ButtonLink role="button" to="https://onenr.io/0LwGrMWyYQ6" variant="primary">
...
<CollapserGroup>
  ...
  <Collapser id="linux-install" title="Linux">
    ...
    4. Edite o arquivo `redis-config.yml` com base nos métodos de conexão do servidor Redis:
       ...
       <CollapserGroup>
         <Collapser id="socket-connect" title="Conecte-se com soquete Unix">
         ...
         <Collapser id="tcp-connect" title="Conecte-se com TCP">
...
<CollapserGroup>
  ...
  <Collapser id="basic-auth" title="Autenticação básica">
  ...
  <Collapser id="acl-auth" title="Autenticação Redis 6+ ACL">
  ...
  <Collapser id="metrics-tls-connection" title="Métrica somente com conexão TLS">
  ...
  <Collapser id="metrics-connect-socket" title="Conexão somente métrica via soquete">
  ...
  <Collapser id="renamed-commands" title="Usando comandos renomeados">
  ...
  <Collapser id="multi-instance-keys-filtering" title="Monitoramento multi-instância com filtragem de chaves">
