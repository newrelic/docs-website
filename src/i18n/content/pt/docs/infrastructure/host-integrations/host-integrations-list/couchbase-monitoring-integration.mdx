...
<CollapserGroup>
  <Collapser id="bucket-parameters" title="Parâmetro de intervalo">
    <table>
      <thead>
        <tr>
  ...
  <Collapser id="cluster-parameters" title="Parâmetro cluster">
    <table>
      <thead>
        <tr>
          <th style={{ width: "300px" }}>
  ...
  <Collapser id="node-parameters" title="Parâmetro do nó">
    <table>
      <thead>
        <tr>
          <th style={{ width: "300px" }}>
  ...
  <Collapser id="query-engine-parameters" title="Parâmetro do mecanismo de consulta">
    <table>
      <thead>
        <tr>
          <th style={{ width: "300px" }}>
