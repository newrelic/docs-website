...
A integração do Couchbase captura o parâmetro de configuração do banco de dados do Couchbase. Os dados estão disponíveis na [página Inventário](/docs/infrastructure/new-relic-infrastructure/infrastructure-ui-pages/infrastructure-inventory-page-search-your-entire-infrastructure) na interface da infraestrutura, na fonte <DoNotTranslate>**config/couchbase**</DoNotTranslate> . Para obter mais informações sobre dados de inventário, consulte [Compreender os dados](/docs/infrastructure/integrations-getting-started/getting-started/understand-integration-data-data-types#inventory-data).
