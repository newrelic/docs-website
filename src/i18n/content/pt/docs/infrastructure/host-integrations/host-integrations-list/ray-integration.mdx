...
<Steps>
  ...
  <Step>
    ...
    Para instrumentar o Apache Druid início rápido e ver métricas e alertas, você também pode acompanhar nossa [página Ray início rápido](https://newrelic.com/instant-observability/ray) clicando no botão `Install now` .
