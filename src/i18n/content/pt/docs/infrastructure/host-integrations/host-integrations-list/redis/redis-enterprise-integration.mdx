...
2. Clique na guia <DNT>**Dashboards**</DNT> e, no campo de pesquisa, insira <DNT>**Redis Enterprise**</DNT>.<img title="Redis Enterprise dashboards" alt="A screenshot of the Redis Enterprise dashboards." src={infrastructureRedisEnterpriseDashboard}/>
