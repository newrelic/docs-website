...
2. Login em sua instância do Redis Entprise e clique em
   ...
   <Callout variant="tip">Recomendamos usar uma conta interna, mas você poderá usar o LDAP se tiver o LDAP ativado.</Callout>
...
1. Vá para <DoNotTranslate>**[one.newrelic.com/marketplace](https://one.newrelic.com/marketplace)**</DoNotTranslate>.

2. Clique na guia <DoNotTranslate>**Dashboards**</DoNotTranslate> e, no campo de pesquisa, insira <DoNotTranslate>**Redis Enterprise**</DoNotTranslate>.<img title="Redis Enterprise dashboards" alt="A screenshot of the Redis Enterprise dashboards." src={infrastructureRedisEnterpriseDashboard}/>
...
3. Clique em um dos painéis e selecione uma conta no dropdown. Em seguida, clique em <DoNotTranslate>**View dashboard**</DoNotTranslate> para adicioná-lo à sua conta.