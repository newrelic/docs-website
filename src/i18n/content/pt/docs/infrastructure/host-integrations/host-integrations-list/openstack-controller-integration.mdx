...
5. Você pode desativar a captura de quaisquer recursos definindo <DoNotTranslate>**enabled**</DoNotTranslate> como <DoNotTranslate>**false**</DoNotTranslate> para esse recurso em <DoNotTranslate>**config/os-config.json**</DoNotTranslate>.
