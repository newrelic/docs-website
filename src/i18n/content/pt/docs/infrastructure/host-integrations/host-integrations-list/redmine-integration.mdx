...
Depois de instalado, confirme se o New Relic está ingerindo seus dados do Redmine acessando <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capaibilities)**</DoNotTranslate> e clicando em <DoNotTranslate>**Metrics & events**</DoNotTranslate>. Execute a seguinte consulta NRQL para confirmar se o New Relic está recebendo dados do Redmine:
...
3. Vá para <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DoNotTranslate> e clique em <DoNotTranslate>**Metrics & events**</DoNotTranslate>. Execute a seguinte consulta para confirmar se New Relic está reportando métrica personalizada:
