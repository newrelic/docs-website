...
Pronto para começar? Clique no botão <DoNotTranslate>**Guided install**</DoNotTranslate> . Ou, se sua organização estiver localizada em um [data center da UE](/docs/using-new-relic/welcome-new-relic/get-started/our-eu-us-region-data-centers), clique em <DoNotTranslate>**EU Guided install**</DoNotTranslate>.
...
<CollapserGroup>
  <Collapser
    className="freq-link"
    id="mysql"
    title="MySQL: permissões de usuário incorretas"
  >
