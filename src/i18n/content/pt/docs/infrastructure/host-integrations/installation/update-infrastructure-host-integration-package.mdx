...
<CollapserGroup>
  <Collapser
    id="windows"
    title={<>Atualizar usando arquivos MSI (<img src={osWindows} title="Windows Server" alt="Windows Server" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }} /></>
    }
  >
  ...
  <Collapser
    id="apt"
    title={<>Atualizar com apt (<img src={osDebian} title="Debian icon" alt="Debian.webp" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}>Debian,<img src={osUbuntu} title="ubuntu icon" alt="ubuntu icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }} /></img></>
    }
  >
  ...
  <Collapser
    id="zypper"
    title={<>Atualizar com zypper (<img src={osSuse} title="suse icon" alt="suse icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }} /></>
    }
  >
    Recomendação: [Atualize](/docs/infrastructure/new-relic-infrastructure/installation/update-infrastructure-agent) o agente de infraestrutura ([versão 1.0.703 ou superior](/docs/release-notes/infrastructure-release-notes/infrastructure-agent-release-notes)).
  ...
  <Collapser
    id="tarball"
    title={<>Atualização do tarball (<img src={osLinux} title="Linux" alt="Linux icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }} /></>
    }
  >
    <Callout variant="tip">
