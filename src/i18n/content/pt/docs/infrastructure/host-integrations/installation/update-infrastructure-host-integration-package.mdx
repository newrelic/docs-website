...
<CollapserGroup>
  ...
  >
    <DNT>**Recommendation:**</DNT> [Atualize](/docs/infrastructure/new-relic-infrastructure/installation/update-infrastructure-agent) o agente de infraestrutura ([versão 1.0.703 ou superior](/docs/release-notes/infrastructure-release-notes/infrastructure-agent-release-notes)).
