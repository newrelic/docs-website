...
<CollapserGroup>
  ...
  >
    ...
    * <DoNotTranslate>**Display name**</DoNotTranslate>

      : Nova chave exclusiva da entidade (em vez de usar o nome de exibição)

    * <DoNotTranslate>**Entity GUID**</DoNotTranslate>

      : GUID da nova entidade

    * <DoNotTranslate>**Entity ID**</DoNotTranslate>

      : Novo ID da entidade

    * <DoNotTranslate>**Entity key**</DoNotTranslate>

      : Nova chave exclusiva da entidade (em vez de usar o nome de exibição)

    * <DoNotTranslate>**External key**</DoNotTranslate>
