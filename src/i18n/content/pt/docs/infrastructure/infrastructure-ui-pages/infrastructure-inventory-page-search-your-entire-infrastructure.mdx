...
<CollapserGroup>
  ...
  >
    ...
    * Ambientes de teste
    ...
    9. Na barra lateral, clique em <DNT>**Saved filter sets**</DNT> para abrir uma lista.

    10. Localize o conjunto de filtros rolando ou inserindo um termo de pesquisa.

    11. Clique no conjunto de filtros para abri-lo.

    12. Na barra lateral, clique em uma opção para atualizar seu conjunto de filtros e salve.
