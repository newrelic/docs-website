...
<CollapserGroup>
  ...
  >
    ...
    1. Escolha uma destas opções para alterar o nível de log para detalhado:
       ...
       * <DoNotTranslate>**Recommended:**</DoNotTranslate> Configure a variável de ambiente `NRIA_LOG_LEVEL` como `debug`. Executar isso na linha de comando seria semelhante a:
