...
A infraestrutura usa um subconjunto dos [níveis de gravidade padrão do Syslog](https://en.wikipedia.org/wiki/Syslog#Severity_level):
...
* <DoNotTranslate>**when agent runs in verbose mode**</DoNotTranslate>
...
* <DoNotTranslate>**otherwise**</DoNotTranslate>
