...
1. Vá para <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure**</DNT>. Passe o mouse sobre um gráfico sobre o qual deseja alertar e selecione as reticências <Icon name="fe-more-horizontal"/> ícone e selecione <DNT>**Create alert condition**</DNT>.
