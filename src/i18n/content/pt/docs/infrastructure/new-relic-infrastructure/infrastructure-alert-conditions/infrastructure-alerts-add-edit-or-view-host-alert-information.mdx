...
<Callout
  ...
  variant="important"
>
  A infraestrutura REST API tem um limite de 3.700 condições do alerta, incluindo ambas as condições ativas <DoNotTranslate>**and**</DoNotTranslate> desativadas. A API, seja usada diretamente ou por meio da interface, rejeitará todas as solicitações para adicionar qualquer condição do alerta adicional além do limite de 3.700 condições do alerta.
</Callout>
...
3. Selecione <DoNotTranslate>**Alert type**</DoNotTranslate> ou consulte os [exemplos](/docs/infrastructure/new-relic-infrastructure/infrastructure-alert-conditions/infrastructure-alerting-examples) para decidir qual tipo selecionar.
...
5. Defina o [limite](/docs/alerts/new-relic-alerts/getting-started/alerts-glossary#alert-threshold) <DoNotTranslate>**Critical**</DoNotTranslate> (obrigatório) e <DoNotTranslate>**Warning**</DoNotTranslate> (opcional, se disponível) para acionamento da notificação de alerta.
...
<CollapserGroup>
  <Collapser
    className="freq-link"
    id="alerts-ui"
    title="Utilize a interface de alertas"
  >
    Vá para <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Alerts & AI > Alert policies > New alert policy > Create new condition**</DoNotTranslate> e selecione <DoNotTranslate>**Infrastructure**</DoNotTranslate> como produto.
  </Collapser>

  <Collapser
    className="freq-link"
    id="infrastructure-ui"
    title="Utilize a interface de infraestrutura"
  >
    1. Vá para
    ...
    2. Passe o mouse sobre o gráfico que deseja alertar e selecione as reticências
  ...
  <Collapser
    className="freq-link"
    id="integration"
    title="Use configurações de infraestrutura para integração"
  >
    <Callout variant="tip">
      Use este método para criar uma condição de alerta para integração de infraestrutura.
    </Callout>

    1. Vá para <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Settings > Alerts**</DoNotTranslate> e clique em <DoNotTranslate>**Create alert condition**</DoNotTranslate>.

    2. Nomeie e descreva a condição do alerta.

    3. Clique no tipo de alerta <DoNotTranslate>**Integrations**</DoNotTranslate> e selecione a fonte de dados de integração que deseja usar.

    4. Use o dropdown <DoNotTranslate>**Filter entities**</DoNotTranslate> para limitar sua condição a um atributo específico.

    5. Use o menu suspenso <DoNotTranslate>**Define thresholds**</DoNotTranslate> para definir o limite da sua condição e clique em <DoNotTranslate>**Create**</DoNotTranslate>.
...
3. Na lista
   ...
   , selecione o incidente de alerta.
...
2. Opcional: use a janela de pesquisa ou a caixa de seleção

   <DoNotTranslate>**Select all**</DoNotTranslate>

   para localizar uma ou mais condições do alerta.

3. Selecione qualquer uma das funções disponíveis para

   <Icon name="fe-edit-2"/>

   editar, desativar, ativar ou

   <Icon name="fe-trash-2"/>

   exclua as condições selecionadas.
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        * Visualizar, alterar, desativar (ou reativar) ou excluir: Utilize a interface [de infraestrutura ](#maintain-alerts)
    ...
    <tr>
      ...
      <td>
        * Visualizar informações resumidas sobre [o evento](/docs/alerts/new-relic-alerts/getting-started/alerts-glossary#event): Utilize a interface [de infraestrutura ](#view-alerts)
    ...
    <tr>
      ...
      <td>
        ...
        * Para políticas que necessitam apenas [de notificação por e-mail](#notification): acesse <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Settings > Alerts & AI > Create a new policy**</DoNotTranslate> e adicione um ou mais endereços de e-mail conforme necessário.
...
O uso do campo <DoNotTranslate>**Description**</DoNotTranslate> está disponível para estes tipos de condição do alerta:
...
O texto que você coloca no campo <DoNotTranslate>**Description**</DoNotTranslate> de uma condição do alerta é transmitido posteriormente ao incidente e à notificação associados. Uma descrição pode ser usada para diversos fins, incluindo:
...
1. Selecione uma condição do alerta e faça alterações no link
