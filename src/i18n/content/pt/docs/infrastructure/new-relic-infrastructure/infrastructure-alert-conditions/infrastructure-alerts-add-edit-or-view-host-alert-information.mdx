...
<CollapserGroup>
  ...
  >
    Vá para <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert policies > New alert policy > Create new condition**</DoNotTranslate> e selecione <DoNotTranslate>**Infrastructure**</DoNotTranslate> como produto.
  </Collapser>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * Para políticas que necessitam apenas [de notificação por e-mail](#notification): acesse <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Settings > Alerts > Create a new policy**</DoNotTranslate> e adicione um ou mais endereços de e-mail conforme necessário.
