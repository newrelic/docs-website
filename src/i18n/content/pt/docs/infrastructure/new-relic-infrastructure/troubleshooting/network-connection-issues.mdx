...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="Linux"
  >
    1. <DoNotTranslate>**Resolve the domain:**</DoNotTranslate> Use `nslookup` ou `dig` para validar se o sistema Linux pode resolver o domínio para um endereço IP:
    ...
    2. <DoNotTranslate>**Ping the server:**</DoNotTranslate> Tente executar ping no endereço IP obtido acima para garantir que você pode acessar o servidor.
    ...
    3. <DoNotTranslate>**Traceroute:**</DoNotTranslate> Use `traceroute` para verificar o caminho de rede entre seu sistema e o servidor:
    ...
    4. <DoNotTranslate>**Curl:**</DoNotTranslate> Use `curl` para verificar se o endpoint está acessível:
