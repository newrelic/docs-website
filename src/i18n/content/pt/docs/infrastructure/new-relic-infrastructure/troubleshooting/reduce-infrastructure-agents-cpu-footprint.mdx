...
<CollapserGroup>
  ...
  >
    ...
    * <DNT>**Enable selected plugins:**</DNT> Para ativar determinado plug-in, insira uma exceção em `disable_all_plugins`. Por exemplo, a configuração a seguir desativa todos os plug-ins, mas o plug-in de interfaces de rede reporta a cada 120 segundos:
