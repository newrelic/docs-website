...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        `StorageSample` representa um único dispositivo de armazenamento associado a um servidor. Cada amostra reúne informações descritivas sobre o dispositivo, o tipo de sistema de arquivos que ele usa e seu uso e capacidade atuais. Tiramos um snapshot desses dados a cada 20 segundos para cada sistema de arquivos montado e os empacotamos em um evento `StorageSample` , que é então enviado ao New Relic. Esses dados aparecem na [página da interface do usuário<DNT>**Storage**</DNT> ](/docs/infrastructure/infrastructure-ui-pages/infra-hosts-ui-page#storage).
