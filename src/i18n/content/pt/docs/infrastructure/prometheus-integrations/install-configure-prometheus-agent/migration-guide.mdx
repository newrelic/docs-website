...
Embora nossa integração do Prometheus OpenMetrics no Kubernetes tenha sido substituída pelo agente NR Prometheus, ela terá suporte por um período de tempo (~~Junho de 2023~~janeiro de 2024).
