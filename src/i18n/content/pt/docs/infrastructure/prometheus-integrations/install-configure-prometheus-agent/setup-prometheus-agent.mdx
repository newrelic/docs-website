...
* Se você usou a instalação guiada, selecione a opção <DoNotTranslate>**Scrape all Prometheus endpoints**</DoNotTranslate> .<img title="Kubernetes Guided Install" alt="Kubernetes Guided Install" src={infrastructurePrometheusScrapeOnlyMetrics}/>
