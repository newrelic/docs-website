...
<Callout variant="caution">
  Uma conta pode ter até 1.500 cluster HA do Prometheus exclusivos. Se esse limite for excedido, os dados de cluster HA adicionais serão descartados. Nesses casos, a New Relic gera `PrometheusHAClusterLimit` evento [`NrIntegrationError`](/docs/data-apis/ingest-apis/metric-api/troubleshoot-nrintegrationerror-events/).
</Callout>
