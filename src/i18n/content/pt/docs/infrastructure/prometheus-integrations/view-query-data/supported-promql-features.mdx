...
<CollapserGroup>
  <Collapser
    id=""
    title="Operadores e funções de agregação"
  >
  ...
  <Collapser
    id=""
    title="Operadores binários aritméticos"
  >
  ...
  <Collapser
    id=""
    title="Funções semelhantes a taxas"
  >
  ...
  <Collapser
    id=""
    title="Seletores de série temporal"
  >
...
* Para garantir a estabilidade e o desempenho do nosso sistema para todos os usuários, colocamos alguns limites nas consultas que podem ser executadas. Em todos os casos, aplicamos um limite de 366 passos na consulta de alcance. Também padrão é retornar apenas 100 séries temporais da consulta por padrão.
...
* Inspecionamos dados com até um minuto de idade ao atender consultas instantâneas. Se o intervalo de raspagem for superior a 1 minuto, algumas consultas poderão resultar em

  <DoNotTranslate>**No data found**</DoNotTranslate>

  . Evite isso enviando dados pelo menos uma vez por minuto.
