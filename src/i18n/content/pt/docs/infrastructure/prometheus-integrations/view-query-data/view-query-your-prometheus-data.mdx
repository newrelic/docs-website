...
<CollapserGroup>
  <Collapser
    id="get-names"
    title="Obtenha nomes de métricas"
  >
  ...
  <Collapser
    id="get-attributes"
    title="Obtenha o atributo de uma métrica"
  >
  ...
  <Collapser
    ...
    title="Obtenha os valores de um atributo no OpenMetrics"
  >
...
Usando [a métrica nome e atributo](#nrql-examples) você pode consultar seus dados. Para obter mais informações sobre facetas, séries temporais e seleção temporal, consulte a [documentação do NRQL](/docs/query-data/nrql-new-relic-query-language/getting-started/nrql-syntax-components-functions).
...
<CollapserGroup>
  <Collapser
    id="get-raw"
    title="Obtenha valores métricos"
  >
  ...
  <Collapser
    id="get-graph"
    title="Obtenha um gráfico da métrica"
  >
  ...
  <Collapser
    ...
    title="Visualize clientes Redis conectados por pod com OpenMetrics"
  >
    <img
      style={{ width: '40px', height: '35px'}}
      class="inline"
  ...
  <Collapser
    id="avg-free-memory"
    title={<><img src="/images/os_icon_docker.webp" title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}>Docker: Ver média de memória livre para endpoint raspado</img></>}
  >
  ...
  <Collapser
    ...
    title={<><img src="/images/os_icon_k8.webp" title="img-integration-k8.png" alt="img-integration-k8.png" style={{ height: '35px', width: '40px' }}>Kubernetes: Veja o uso médio de memória do pod na implantação</img></>}
  >
...
Para visualizar os resultados da consulta NRQL para os dados da integração do Prometheus: Vá para <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Query your data**</DNT>. Para mais informações, consulte nossa [documentação do criador de consulta](/docs/chart-builder/use-chart-builder/get-started/introduction-chart-builder).
