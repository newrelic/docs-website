...
<img style={{ width: '40px', height: '35px'}} class="inline" title="img-integration-k8.png" alt="img-integration-k8.png" src={osk8}/>
...
<CollapserGroup>
  ...
  >
    <img style={{ width: '40px', height: '35px'}} class="inline" title="Docker icon" alt="Docker icon" src={osDocker}/>
    ...
    <img style={{ width: '40px', height: '35px'}} class="inline" title="Kubernetes icon" alt="Kubernetes icon" src={osk8}/>
  ...
  <Collapser
    id="avg-free-memory"
    title={<><img src={osDocker} title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}>Docker: Ver média de memória livre para endpoint raspado</img></>}
  >
  ...
  <Collapser
    ...
    title={<><img src={osk8} title="img-integration-k8.png" alt="img-integration-k8.png" style={{ height: '35px', width: '40px' }}>Kubernetes: Veja o uso médio de memória do pod na implantação</img></>}
  >
