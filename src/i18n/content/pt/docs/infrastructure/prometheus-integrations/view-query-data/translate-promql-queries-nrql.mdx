...
<CollapserGroup>
  ...
  >
    ...
    <figcaption>
      <DNT>**PromQL-style example:**</DNT> Para filtrar os dados, execute esta consulta estilo PromQL: container_memory_usage_bytes&#x7B;id="/".
    </figcaption>
  </Collapser>
  ...
  >
    ...
    <figcaption>
      <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Query your data**</DNT>: Este exemplo mostra os dados que você vê após executar FROM métrica SELECT keyset() WHERE metricName = 'container_memory_usage_bytes'.
    </figcaption>
    ...
    <figcaption>
      <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Query your data**</DNT>: Este exemplo mostra os dados que você vê após executar FROM métrica SELECT latest(container_memory_usage_bytes) FACET id.
    </figcaption>
