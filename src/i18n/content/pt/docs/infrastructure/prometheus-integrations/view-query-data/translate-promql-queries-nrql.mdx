...
<Callout variant="tip">
  Para executar a consulta estilo PromQL no [New Relic One](/docs/new-relic-one/use-new-relic-one/get-started/introduction-new-relic-one), acesse o [criador de consulta advanced PromQL-style mode](/docs/query-your-data/explore-query-data/chart-builder/use-advanced-promql-mode-specify-data).
</Callout>
...
<Callout variant="tip">
  Para ver como New Relic traduz a consulta estilo PromQL para NRQL, escreva uma consulta na [guia estilo PromQL do criador de consulta](/docs/query-your-data/explore-query-data/chart-builder/use-advanced-promql-mode-specify-data) e depois mude para a [guiaNRQL ](/docs/chart-builder/use-chart-builder/choose-data/use-advanced-nrql-mode-specify-data).
</Callout>
...
<CollapserGroup>
  <Collapser
    id="prom-ql-example"
    title="Exemplo de consulta no estilo PromQL"
  >
    <DoNotTranslate>
      **1. Start your query.**
    </DoNotTranslate>
    ...
    <figcaption>
      <DoNotTranslate>**PromQL-style example:**</DoNotTranslate> Para filtrar os dados, execute esta consulta estilo PromQL: container_memory_usage_bytes&#x7B;id="/".
    </figcaption>
  </Collapser>

  <Collapser
    id="nrql-query-example"
    title="Exemplo de consulta NRQL"
  >
    <DoNotTranslate>
    ...
    <figcaption>
      <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Query your data**</DoNotTranslate>: Este exemplo mostra os dados que você vê após executar FROM métrica SELECT keyset() WHERE metricName = 'container_memory_usage_bytes'.
    </figcaption>
    ...
    <figcaption>
      <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Query your data**</DoNotTranslate>: Este exemplo mostra os dados que você vê após executar FROM métrica SELECT latest(container_memory_usage_bytes) FACET id.
    </figcaption>
    ...
    <figcaption>
      <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Query your data**</DoNotTranslate>: este exemplo mostra os dados exibidos após a execução `From Metric select latest(container_memory_usage_bytes) where id = "/" timeseries`.
    </figcaption>
  </Collapser>
</CollapserGroup>
