...
<Callout variant="tip">
  Para executar uma consulta no estilo PromQL no [New Relic One](/docs/new-relic-one/use-new-relic-one/get-started/introduction-new-relic-one), vá para o [modo avançado de criação de consulta no estilo PromQL](/docs/infrastructure/prometheus-integrations/view-query-data/view-query-your-prometheus-data/#build-query).
</Callout>
