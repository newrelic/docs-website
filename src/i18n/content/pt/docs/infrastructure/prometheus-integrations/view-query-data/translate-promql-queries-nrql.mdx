...
<Callout variant="tip">
  Para executar uma consulta no estilo PromQL no [New Relic](/docs/new-relic-one/use-new-relic-one/get-started/introduction-new-relic-one), vá para o [modo de estilo PromQL avançado do criador de consulta](/docs/infrastructure/prometheus-integrations/view-query-data/view-query-your-prometheus-data/#build-query).
</Callout>
