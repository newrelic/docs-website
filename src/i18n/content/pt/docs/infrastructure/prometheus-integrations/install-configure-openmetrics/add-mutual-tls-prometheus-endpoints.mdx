...
<DoNotTranslate>**Recommendation:**</DoNotTranslate> Coloque o pacote CA, a chave e os arquivos de certificado em segredo e inclua-os no contêiner de integração do Prometheus OpenMetrics.
