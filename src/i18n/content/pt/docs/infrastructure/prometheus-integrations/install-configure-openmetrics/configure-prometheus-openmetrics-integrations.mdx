...
Para recarregar a configuração, reinicie a integração. <DNT>**Recommendation:**</DNT> Reduza a implantação para zero réplicas e depois reduza para uma réplica:
