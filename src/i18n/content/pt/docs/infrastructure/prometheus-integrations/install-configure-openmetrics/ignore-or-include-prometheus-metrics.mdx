...
<Callout variant="caution">
  A filtragem do tipo [histograma](https://prometheus.io/docs/concepts/metric_types/#histogram) e métrica [de resumo](https://prometheus.io/docs/concepts/metric_types/#summary) se aplica ao `base name`. Você não pode filtrar pela série temporal `_bucket`, `_sum` ou `_count` para essa métrica.
</Callout>
