...
Por favor, verifique a [página](/docs/infrastructure/prometheus-integrations/install-configure-prometheus-agent/install-prometheus-agent) a seguir para entender os benefícios do agente Prometheus e obter uma visibilidade completa de sua carga de trabalho do Prometheus rodando em um cluster do Kubernetes.
