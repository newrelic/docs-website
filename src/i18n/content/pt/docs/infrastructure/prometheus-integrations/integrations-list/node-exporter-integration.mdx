---
title: Node Exporter integração
tags:
  - Integrations
  - Node Exporter
  - Prometheus
...
3. Veja seus dados na interface do New Relic acessando **<DoNotTranslate>[one.newrelic.com](https://one.newrelic.com/)</DoNotTranslate> > Infrastructure > Hosts**.