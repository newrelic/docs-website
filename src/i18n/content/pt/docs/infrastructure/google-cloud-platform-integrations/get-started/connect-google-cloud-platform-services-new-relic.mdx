  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        Antes de adicionar a conta de serviço, clique em &quot;Obter dados&quot; do assistente de integração para verificar a autorização de recuperação de dados do Google.
