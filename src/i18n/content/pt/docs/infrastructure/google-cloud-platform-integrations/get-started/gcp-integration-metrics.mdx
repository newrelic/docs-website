...
## Métrica Google Cloud [#gcp-metrics-table]

A tabela a seguir é uma lista não abrangente de métricas coletadas pela integração do GCP e suas traduções [de métricas dimensionais](/docs/telemetry-data-platform/ingest-manage-data/understand-data/new-relic-data-types/#dimensional-metrics) .
...
<table>
  <tbody>
    ...
    <tr>
      <td>
        Mecanismo de aplicativos do GCP
      </td>
    ...
    <tr>
      <td>
        Banco de dados do GCP Firebase
      </td>
