...
## Métricas do Google Cloud [#gcp-metrics-table]

A tabela a seguir lista algumas das métricas coletadas pelas integrações do GCP e suas traduções de [métricas dimensionais](/docs/telemetry-data-platform/ingest-manage-data/understand-data/new-relic-data-types/#dimensional-metrics).
