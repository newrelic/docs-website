...
1. Vá para a página <DNT>**Environment**</DNT> do seu aplicativo em <DNT>**Developer Portal**</DNT>.

2. Clique em <DNT>**Details**</DNT> no ambiente que você deseja monitor com New Relic.

3. Mude para a guia <DNT>**Details**</DNT> .
   ...
   <table>
     ...
     <tbody>
       <tr>
         ...
         <td>
           New Relic [chave de licença](/docs/apis/intro-apis/new-relic-api-keys/).
         </td>
       </tr>
       ...
       <tr>
         ...
         <td>
           URI para a New Relicde log do API. Para mais informações, consulte [Regiões New Relic ](https://docs.mendix.com/developerportal/operate/newrelic-metrics/#uri-regions). Para valores válidos, consulte [Enviar seus dados de registro com nosso exemplo de API de log](/docs/logs/log-api/introduction-log-api/) : `https://log-api.eu.newrelic.com/log/v1`
         </td>
       </tr>
...
5. Retorne à página <DNT>**Environments**</DNT> do seu aplicativo e <DNT>**Deploy**</DNT> ou <DNT>**Transport**</DNT> seu aplicativo no ambiente selecionado.
