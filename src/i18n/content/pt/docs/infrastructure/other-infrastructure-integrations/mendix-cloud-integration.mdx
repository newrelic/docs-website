   ...
   <table>
     ...
     <tbody>
       ...
       <tr>
         ...
         <td>
           URI para a API de logs do New Relic. Para mais informações, consulte [Regiões New Relic](https://docs.mendix.com/developerportal/operate/newrelic-metrics/#uri-regions). Para valores válidos, consulte [Enviar seus dados de logging com nossa API de log](/docs/logs/log-api/introduction-log-api/) Exemplo: `https://log-api.eu.newrelic.com/log/v1` (UE), `https://log-api.jp.nr-data.net/log/v1` (Japão)
         </td>
       </tr>
       ...
       <tr>
         ...
         <td>
           URI para a New Relic métrica do API. Para mais informações, consulte [Regiões New Relic](https://docs.mendix.com/developerportal/operate/newrelic-metrics/#uri-regions). Para valores válidos, consulte [Reportar métrica via API de métrica](/docs/data-apis/ingest-apis/metric-api/report-metrics-metric-api/). Exemplo: `https://metric-api.eu.newrelic.com/metric/v1` (EU), `https://metric-api.jp.nr-data.net/metric/v1` (Japão).
         </td>
       </tr>
