  ...
  >
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          <td>
            Vários plug-ins reúnem detalhes de todo o sistema por meio deste diretório. Utilizado para infraestrutura <DoNotTranslate>**Inventory**</DoNotTranslate> e métrica.
          </td>
        ...
        <tr>
          <td>
            Vários plug-ins reúnem configurações `sysctl` por meio deste diretório. Utilizado para infraestrutura <DoNotTranslate>**Inventory**</DoNotTranslate> e métrica.
          </td>
        ...
        <tr>
          <td>
            Vários plug-ins (`sshd_config`, `hostinfo`) leem configurações específicas neste diretório. Utilizado para infraestrutura <DoNotTranslate>**Inventory**</DoNotTranslate> e métrica.
          </td>
