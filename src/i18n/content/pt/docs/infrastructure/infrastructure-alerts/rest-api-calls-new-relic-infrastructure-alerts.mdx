...
<Callout variant="tip">
  Se a sua organização hospeda dados em uma região de data center diferente dos EUA, certifique-se de estar usando os endpoints de região corretos. [Saiba mais sobre regiões de data center e endpoints.](/docs/accounts/accounts-billing/account-setup/choose-your-data-center)
</Callout>
