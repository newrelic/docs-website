  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * Crie uma condição com filtragem de exclusão (por exemplo, `environment NOT LIKE x`). Para saber mais sobre isso, consulte [esta postagem sobre filtragem de exclusão](https://support.newrelic.com/s/hubtopic/aAX8W0000008Znr/relic-solution-use-the-infrastructure-alerts-rest-api-pt-1).
...
<Callout variant="tip">
  Se a organização hospeda dados em uma região de data center diferente dos EUA (padrão), é necessário certificar-se de usar os endpoints de região corretos. [Saiba mais sobre regiões de data center e endpoints.](/docs/accounts/accounts-billing/account-setup/choose-your-data-center)
</Callout>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        A configuração de [limite de tempo do evento de alerta](/docs/infrastructure/new-relic-infrastructure/infrastructure-alert-conditions/infrastructure-alerts-add-edit-or-view-host-alert-information/#incident-time-limit), expressa em horas. Os valores possíveis são `0`, `1`, `2`, `4`, `8`,`12`, `24`, `48`, `72`. Isso determina quanto tempo passará antes que um incidente seja encerrado automaticamente.
