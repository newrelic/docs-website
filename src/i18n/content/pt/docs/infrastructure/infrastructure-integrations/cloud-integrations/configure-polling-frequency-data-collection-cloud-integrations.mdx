...
4. Use o menu suspenso ao lado de
   ...
   <DNT>**Data polling interval every**</DNT>
...
4. Em
   ...
   <DNT>**Data collections and filters**</DNT>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Ao criar [a condição do alerta](/docs/infrastructure/new-relic-infrastructure/infrastructure-alert-conditions) <DNT>**after**</DNT> você define filtros, certifique-se de que seus <InlinePopover type="alerts"/>não sejam acionados por recursos que você filtrou.
      </td>
    </tr>
