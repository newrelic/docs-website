...
3. Selecione
   ...
   ao lado da integração.

4. Use o menu suspenso ao lado de

   <DoNotTranslate>**Data polling interval every**</DoNotTranslate>

   para selecionar com que frequência você deseja que New Relic capture seus dados de integração na nuvem.
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        Mude para <DoNotTranslate>**Off**</DoNotTranslate> se não quiser que a integração colete sua tag de recurso de nuvem e, assim, reduza o volume de chamadas de API.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        A coleta de inventário estendida é <DoNotTranslate>**disabled by default**</DoNotTranslate>.

        Mude para <DoNotTranslate>**On**</DoNotTranslate> se quiser monitor o inventário estendido. Isso aumentará o volume de chamadas de API.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        Por padrão, não reportamos métricas de fragmentos. Mude para <DoNotTranslate>**On**</DoNotTranslate> se desejar monitor a métrica do fragmento além da métrica do fluxo de dados.
      </td>
    </tr>
    ...
    <tr id="lambda-edge">
      ...
      <td>
        ...
        Por padrão, não reportamos dados do Lambda@Edge. Mude para <DoNotTranslate>**On**</DoNotTranslate> se você estiver usando o Lambda@Edge no AWS CloudFront e quiser obter metadados do local de execução do Lambda.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        Por padrão, não informamos a métrica do nó Elasticsearch. Mude para <DoNotTranslate>**On**</DoNotTranslate> se desejar monitor a métrica do nó além da métrica cluster .
      </td>
    </tr>

    <tr>
      <td>
        <DoNotTranslate>**Collect NAT Gateway data**</DoNotTranslate> e <DoNotTranslate>**Collect VPN data**</DoNotTranslate>
      </td>

      <td>
        Disponível para integração AWS VPC.

        Por padrão, não reportamos NAT Gateway nem métricas de VPN. Mude-os para <DoNotTranslate>**On**</DoNotTranslate> se desejar monitor métricas e inventário de gateway NAT e VPN, além de outro inventário de entidade relacionado a VPC.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        Por padrão, coletamos instâncias de metadados do EC2 que incluem endereços IP públicos e privados e detalhes da interface de rede. Mude para <DoNotTranslate>**Off**</DoNotTranslate> se não quiser que o New Relic armazene e exiba esses dados de IP.
      </td>
    </tr>
  </tbody>
</table>
...
Quando um filtro é <DoNotTranslate>**On**</DoNotTranslate>, você especifica os dados que deseja coletar; por exemplo, se <DoNotTranslate>**Limit to AWS region**</DoNotTranslate> for <DoNotTranslate>**On**</DoNotTranslate>, as regiões selecionadas serão aquelas para as quais os dados serão coletados. Existem diferentes filtros disponíveis, dependendo da integração:
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Insira a chave tag <DoNotTranslate>**one**</DoNotTranslate> associada aos recursos que você deseja monitor. Os valores de filtro diferenciam maiúsculas de minúsculas e você pode usar esse filtro em combinação com o filtro <DoNotTranslate>**tag value**</DoNotTranslate> . Aplicável apenas para AWS e Azure.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Insira o valor tag <DoNotTranslate>**one**</DoNotTranslate> associado aos recursos que você deseja monitor. Os valores do filtro diferenciam maiúsculas de minúsculas e você pode usar esse filtro em combinação com <DoNotTranslate>**tag key**</DoNotTranslate>. Aplicável apenas para AWS e Azure.
      </td>
    </tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Ao criar [a condição do alerta](/docs/infrastructure/new-relic-infrastructure/infrastructure-alert-conditions) <DoNotTranslate>**after**</DoNotTranslate> você define filtros, certifique-se de que seus <InlinePopover type="alerts"/>não sejam acionados por recursos que você filtrou.
      </td>
    </tr>
