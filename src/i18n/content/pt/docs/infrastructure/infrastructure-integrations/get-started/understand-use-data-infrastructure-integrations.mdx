...
<CollapserGroup id="query-examples">
  ...
  <Collapser
    ...
    title="Exemplo de consulta do Azure Functions"
  >
  ...
  <Collapser
    ...
    title="Exemplo de consulta de alteração de inventário"
  >
...
<CollapserGroup>
  ...
  >
    ...
    * Valores métricos são tratados como <DoNotTranslate>**attributes**</DoNotTranslate>: pares de valores principais anexados a um [evento](/docs/data-analysis/metrics/analyze-your-metrics/data-collection-metric-timeslice-event-data#event-data). Por exemplo, a integração MySQL possui uma métrica de 'conexões ativas'; isso seria encontrado consultando o atributo `connectionsActive` do evento `MysqlSample` .
  ...
  <Collapser
    id="event-tips"
    title="Dicas de dados de eventos"
  >
  ...
  <Collapser
    id="event-tips"
    title="Dicas de dados de inventário"
  >
