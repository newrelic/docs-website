...
<Steps>
    ...
    * AWS X-Ray
    ...
    <CollapserGroup>
      ...
      <Collapser id="without-template" title="Migrar sem o modelo CloudFormation">
        ...
        1. Consulte [Integrar Manualmente pelo Console da AWS](/docs/infrastructure/amazon-integrations/aws-integration-for-metrics/manual/) e conclua as etapas.
        2. [Desabilite todas as integrações de pesquisa desnecessárias](/docs/infrastructure/amazon-integrations/connect/uninstall-aws/) na conta anterior do provedor AWS.
  ...
  <Step>
    ## Valide seus dados de fluxos de métricas [#validate-data]
