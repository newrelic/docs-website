...
Para ingerir o CloudWatch Metric personalizado, seu namespace personalizado precisa estar visível na configuração do CloudWatch Metric Streams . Certifique-se de que ele não esteja sendo filtrado por regras de inclusão ou exclusão.
