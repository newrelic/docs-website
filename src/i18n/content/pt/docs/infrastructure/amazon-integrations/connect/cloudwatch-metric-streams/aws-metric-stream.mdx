...
<Tabs>
  ...
  <TabsPages>
    <TabsPageItem id="1">
      ...
      1. Replique o namespace da pesquisa em fluxos métricos acessando <DNT>**[one.newrelic.com &gt; All capabilities](https://one.newrelic.com/all-capabilities) &amp;gt; Infrastructure &amp;gt; AWS &amp;gt; Migrate to AWS Cloudwatch metric streams**</DNT> e configurando sua conta do AWS Metric Streams.
    ...
    <TabsPageItem id="2">
      ...
      1. Acesse <DNT>**[one.newrelic.com &gt; All capabilities](https://one.newrelic.com/all-capabilities) &amp;gt; Infrastructure &amp;gt; AWS &amp;gt; Add an AWS account**</DNT> e adicione sua conta AWS. Esta etapa é necessária mesmo se você já tiver vinculado sua conta AWS à integração de polling.
...
* <DNT>**Dashboards**</DNT>: <InlinePopover type="dashboards" />personalizados que usam evento de integração da AWS baseado em enquete ainda funcionarão conforme esperado.
* <DNT>**Alerts**</DNT>: condição do alerta de que usar evento AWS baseado em enquete ainda funcionará. Recomendamos adaptá-los ao formato métrico dimensional (usando NRQL como fonte).
