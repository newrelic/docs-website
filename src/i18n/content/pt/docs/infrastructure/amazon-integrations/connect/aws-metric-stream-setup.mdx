...
1. <DoNotTranslate>**Create a Kinesis Data Firehose Delivery Stream**</DoNotTranslate>
   ...
   e configure o seguinte parâmetro de destino:
...
3. <DoNotTranslate>**Add the new AWS account**</DoNotTranslate>
   ...
   na interface New Relic . Vá para
...
Saiba mais sobre preços, limitações e configuração avançada na [documentaçãoAWS ](https://aws.amazon.com/about-aws/whats-new/2022/04/amazon-cloudwatch-metric-streams-additional-statistics/).
