...
<Steps>
  ...
  <Step>
    ...
    <Callout variant="tip">
      Por padrão, o New Relic verifica todas as regiões habilitadas na sua conta uma vez por dia. Você pode [atualizar a frequência de varredura e as regiões](#select-region-and-frequency) após a criação da stack , gerenciando as configurações <DNT>Auto-Discovery</DNT> no New Relic One.
    </Callout>
  </Step>
  ...
  <Step>
    ...
    1. Clique em <DNT>**Launch your CloudFormation in AWS**</DNT> para navegar até o seu AWS Console. A stack do CloudFormation inclui o parâmetro configurado com base em suas seleções no New Relic One, portanto, nenhuma edição adicional é necessária, a menos que você queira fazer alterações.
...
<Steps>
  ...
  <Step>
    ...
    3. Depois que a stack for criada, volte para a New Relic One.
  </Step>
  ...
  <Step>
    ...
    Para habilitar <DNT>Auto-Discovery</DNT>, na tela de confirmação do New Relic One, clique em <DNT>**Save**</DNT>.
  </Step>
</Steps>
