...
<Callout title="visualização">
  ...
  Este recurso é fornecido atualmente como parte de um programa de pré-visualização em conformidade com nossas [políticas de pré-lançamento](/docs/licenses/license-information/referenced-policies/new-relic-pre-release-policy).<br />
</Callout>
    ...
    <CollapserGroup>
      <Collapser id="metrics-data-type" title="Para tipo de dados métricos">
        ...
        1. Selecione o tipo de integração métrica:
           ...
           * <DNT>**[Integration via CloudFormation and CloudWatch metric stream](/docs/infrastructure/amazon-integrations/aws-integration-for-metrics/via-cloudformation-cwms/)**</DNT> é o método recomendado para criar um fluxo real de tempo de métrica para New Relic.
      ...
      <Collapser id="log-data-type" title="Para tipo de dados Logs">
        ...
        4. New Relic Selecione Logs endpointda API: O sistema define automaticamente o endpoint com base na região da sua New Relic conta .
           ...
           * Para a conta da UE, os logs são enviados para `https://log-api.eu.newrelic.com/log/v1`
           * Para a conta do Japão, os logs são enviados para `https://log-api.jp.nr-data.net/log/v1`
...
<Steps>
  ...
  <Step>
    ### Gerenciar integrações da AWS [#manage-aws-integrations]

    1. Entre na sua conta [New Relic](https://one.newrelic.com/) e navegue até <DNT>**Infrastructure &gt; AWS**</DNT>.
    2. Para verificar se <DNT>Auto-Discovery</DNT> está habilitado para suas contas da AWS, clique em <DNT>**Manage AWS Integrations**</DNT>.
    3. Para habilitar o Auto-Discovery para uma conta da AWS, na lista de contas, clique em <DNT>**Install**</DNT> para essa conta.
    4. Para Descoberta Automática, clique em <DNT>**Install**</DNT>.
  </Step>
...
<CollapserGroup>
  ...
  <Collapser id="disable-auto-discovery" title="Desativar descoberta automática">
    ...
    1. Entre na sua conta [New Relic](https://one.newrelic.com/) e navegue até <DNT>**Infrastructure &gt; AWS**</DNT>.
    2. Para verificar se <DNT>Auto-Discovery</DNT> está habilitado para suas contas da AWS, clique em <DNT>**Manage Auto-Discovery**</DNT>.
