  ...
  <TabsPages>
    <TabsPageItem id="1">
      ...
      1. Replique o namespace da pesquisa em fluxos métricos acessando
         ...
         <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS > Migrate to AWS Cloudwatch metric streams**</DNT>
    ...
    <TabsPageItem id="2">
      ...
      1. Acesse
         ...
         <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS > Add an AWS account**</DNT>
