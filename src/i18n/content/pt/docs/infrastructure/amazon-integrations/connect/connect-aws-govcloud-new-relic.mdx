...
* Se você estiver utilizando nosso [monitoramento AWS Lambda ](/docs/serverless-function-monitoring/aws-lambda-monitoring/get-started/introduction-new-relic-monitoring-aws-lambda): nosso `newrelic-log-ingestion` não está implantado no [repositório do aplicativo AWS Serverless](https://aws.amazon.com/serverless/serverlessrepo/) para AWS GovCloud; ele deve ser instalado manualmente. Para obter instruções, consulte [Habilitar monitoramento do Lambda](/docs/serverless-function-monitoring/aws-lambda-monitoring/get-started/enable-new-relic-monitoring-aws-lambda#connect-aws).
