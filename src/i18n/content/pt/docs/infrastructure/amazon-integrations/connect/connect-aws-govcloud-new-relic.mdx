---
title: Conecte o AWS GovCloud ao New Relic
tags:
  - Integrations
  - Amazon integrations
  - Get started
...
* Se você estiver utilizando nosso [monitoramento AWS Lambda ](/docs/serverless-function-monitoring/aws-lambda-monitoring/get-started/introduction-new-relic-monitoring-aws-lambda): nosso `newrelic-log-ingestion` não está implantado no [repositório do aplicativoAWS Serverless](https://aws.amazon.com/serverless/serverlessrepo/) para AWS GovCloud; ele deve ser instalado manualmente. Para obter instruções, consulte [Habilitar monitoramento do Lambda](/docs/serverless-function-monitoring/aws-lambda-monitoring/get-started/enable-new-relic-monitoring-aws-lambda#connect-aws).
...
4. Dê um nome à sua conta da AWS, forneça as credenciais para conectar sua conta e clique em

   <DoNotTranslate>**Submit**</DoNotTranslate>

   .

5. Selecione os Amazon Web Services a serem monitorados com a integração New Relic Infrastructure e clique em
...
1. No [console do IAM](https://console.amazonaws-us-gov.com/iam/home#/users), clique em <DoNotTranslate>**Add user**</DoNotTranslate>.

2. Para <DoNotTranslate>**User name**</DoNotTranslate>, digite <DoNotTranslate>**NewRelicInfrastructure-Integrations**</DoNotTranslate>. Para <DoNotTranslate>**Select AWS access type**</DoNotTranslate>, selecione como <DoNotTranslate>**Programmatic access**</DoNotTranslate>.
   ...
   <figcaption>
     <DoNotTranslate>**AWS IAM console > Add user**</DoNotTranslate>: adicione <DoNotTranslate>**NewRelicInfrastructure-Integrations**</DoNotTranslate> como usuário.
   </figcaption>

3. Anexe a política: pesquise <DoNotTranslate>**ReadOnlyAccess**</DoNotTranslate>, marque a caixa de seleção da política chamada <DoNotTranslate>**ReadOnlyAccess**</DoNotTranslate> e clique em <DoNotTranslate>**Next: Tags**</DoNotTranslate> (adicionar tag é opcional). Alternativamente, você pode [criar sua própria política gerenciada](/docs/integrations/amazon-integrations/getting-started/integrations-managed-policies) e limitar as permissões concedidas New Relic de acordo com os serviços da AWS que você deseja monitor.
   ...
   <figcaption>
     <DoNotTranslate>**AWS IAM console > Add user > Set permissions**</DoNotTranslate>: selecione <DoNotTranslate>**ReadOnlyAccess**</DoNotTranslate>.
   </figcaption>

4. Na página <DoNotTranslate>**Tags**</DoNotTranslate> , clique em <DoNotTranslate>**Next: Review**</DoNotTranslate>. Revise o resumo de detalhes do usuário e clique em <DoNotTranslate>**Create user**</DoNotTranslate>.
   ...
   <figcaption>
     <DoNotTranslate>**AWS IAM console > Add user > Set permissions > Tags > Review**</DoNotTranslate>: verifique se as informações do novo usuário estão precisas.
   </figcaption>

5. Seu usuário deve ser criado com sucesso. Faça download das credenciais de segurança do usuário clicando no botão <DoNotTranslate>**Download .csv**</DoNotTranslate> e depois em <DoNotTranslate>**Close**</DoNotTranslate>.