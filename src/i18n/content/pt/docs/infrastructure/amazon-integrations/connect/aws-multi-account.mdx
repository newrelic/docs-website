...
2. Clique em <DNT>**Add AWS account**</DNT>.
   ...
   <img title="Add AWS account to New Relic" alt="Add AWS account to New Relic" src={infrastructureAwsAddAccount} />
...
6. Depois de concluir todas as etapas, clique no link <DNT>**Explore data**</DNT> para conferir sua métrica.
   ...
   <img title="Explore your data link" alt="Explore your data link" src={infrastructureAwsExploreYourData} />
...
<img title="See the status of your account" alt="See the status of your account" src={infrastructureAwsSeeAccountStatus} />
...
<img title="See the status of your account" alt="See the status of your account" src={infrastructureAwsAccountStatusDashboard} />