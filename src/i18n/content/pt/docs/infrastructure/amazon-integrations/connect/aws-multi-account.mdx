...
1. Acesse o AWS Management Console da conta de monitoramento e siga estas etapas para copiar o <DNT>**Monitoring accounts sink ARN**</DNT>:
...
2. Acesse o AWS Management Console da conta de origem e [vincule a conta de monitoramento](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Unified-Cross-Account-Setup.html) para os recursos <DNT>**Metrics**</DNT> :
...
3. Retorne ao AWS Management Console da conta de monitoramento:
