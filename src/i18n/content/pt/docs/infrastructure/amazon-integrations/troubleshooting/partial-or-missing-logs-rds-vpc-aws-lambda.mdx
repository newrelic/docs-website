...
1. Evite falsos positivos em alertas: siga os [procedimentos da interface](/docs/alerts/new-relic-alerts/configuring-alert-policies/update-or-disable-policies-conditions#condition-on-off) ou [procedimentos da API](/docs/alerts/rest-api-alerts/new-relic-alerts-rest-api/disable-enable-alerts-conditions-using-api) para desativar todas as condições do alerta associadas às integrações de monitoramento com AWS Lambda, RDS Enhanced Monitoring e VPC Flow Logs.
