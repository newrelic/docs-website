...
4. Para o campo `policy_id`, use a ID única da política de alertas associada à condição. Para encontrar o ID da política, abra a política em [one.newrelic.com](https://one.newrelic.com), clique no ícone <DNT>**(i)**</DNT> e leia o valor da tag de ID da política.
