...
Isso acontece porque a lista dropdown <DoNotTranslate>**Define thresholds**</DoNotTranslate> em nossa interface de infraestrutura mostra apenas a métrica que New Relic conseguiu coletar na última hora.