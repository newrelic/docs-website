...
1. Verifique se o métrica Stream está no estado `Running` por meio do console AWS ou API. Consulte os [documentos de resolução de problemasAWS ](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-metric-streams-troubleshoot.html)para obter detalhes adicionais.
...
### Erros no dashboardStatus [#errors-status-dashboard]
