...
6. Confirme se você configurou o Kinesis Data Firehose com os detalhes de destino corretos:
   ...
   * Certifique-se de que o data center correto, US, EU ou JP, foi selecionado para a sua conta do New Relic. Dica: se o `license_key` começar com &quot;eu&quot;, então você precisa selecionar o data center EU. Se o `license_key` começar com &quot;jp&quot;, então você precisa selecionar o data center JP.
