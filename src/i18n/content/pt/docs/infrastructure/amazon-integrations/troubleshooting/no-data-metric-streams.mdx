...
6. Confirme se você configurou o Kinesis Data Firehose com os detalhes de destino corretos:
   ...
   * Deve-se garantir que o data center correto, US (padrão), EU ou JP, tenha sido selecionado para a conta do New Relic. Dica: se o `license_key` começar com &quot;eu&quot;, então você precisa selecionar o data center EU. Se o `license_key` começar com &quot;jp&quot;, então você precisa selecionar o data center JP.
