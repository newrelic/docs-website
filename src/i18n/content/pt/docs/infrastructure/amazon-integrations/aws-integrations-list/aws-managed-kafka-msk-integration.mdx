...
<Callout variant="important">
  Habilite a [integração doAWS CloudWatch Metric Streams ](/docs.newrelic.com/install/aws-cloudwatch/)para monitorar todas as métricas do CloudWatch dos seus serviços da AWS, incluindo namespace personalizado. A integração individual não é mais nossa opção recomendada.
</Callout>
