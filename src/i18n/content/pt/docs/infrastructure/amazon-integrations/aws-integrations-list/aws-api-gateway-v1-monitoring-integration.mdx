...
[A integração New Relic Infrastructure ](/docs/infrastructure/integrations-getting-started/getting-started/introduction-infrastructure-integrations)inclui uma integração para relatar seus dados do Amazon API Gateway para New Relic. Este documento explica como ativar esta integração e descreve os dados que podem ser reportados.
...
Para encontrar seus dados de integração na interface de infraestrutura, acesse <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS**</DoNotTranslate> e selecione um dos links de integração API Gateway.
