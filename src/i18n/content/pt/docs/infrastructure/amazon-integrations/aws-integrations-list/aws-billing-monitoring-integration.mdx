...
1. No console de gerenciamento da AWS, selecione <DNT>**Services > IAM > Roles**</DNT>.

2. Selecione a função que você configurou para New Relic e selecione <DNT>**Permissions**</DNT>.

3. Na guia <DNT>**Inline policy**</DNT> da função selecionada, selecione a opção expandir <Icon name="fe-chevron-down"/> ícone se já existir, ou selecione a opção para adicionar uma nova política em linha à função.
