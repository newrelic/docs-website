...
[O EC2 da Amazon](https://aws.amazon.com/ec2/) é uma parte central da plataforma de computação em nuvem da Amazon. Todos os usuários de monitoramento de infraestrutura New Relic , independentemente do [nível de assinatura](https://newrelic.com/infrastructure/pricing), podem usar o agente New Relic Infrastructure para obter uma visão abrangente e em tempo real do desempenho e status de seu host. A integração EC2 da New Relic usa a [política`ec2Describe*` ](/docs/infrastructure/infrastructure-integrations/getting-started/integrations-managed-policies)para adicionar dados sobre suas instâncias de EC2 aos dados padrão de monitoramento de infraestrutura. Também importamos [tags personalizadas Amazon EC2 ](http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Using_Tags.html)e as adicionamos aos seus dados.
...
Para suas instâncias de monitoramento EC2 da New Relic antes dessa data, você tem a opção de manter nossos formatos tag legados. Para manter esses formatos, acesse a interface de configuração New Relic para seu host EC2 e selecione <DoNotTranslate>**Keep legacy metadata format**</DoNotTranslate>. Isso permite que você acesse tags que possuem formatos atuais e legados. Desativar o formato legado significa que você só pode usar o formato atual. Se você desabilitar o formato legado, considere verificar se você tem dashboard ou condição de alerta usando esse formato.
...
<table>
  ...
  <tbody>
    <tr>
      <td>
        [<DoNotTranslate>**System**</DoNotTranslate> página](/docs/infrastructure/infrastructure-ui-pages/infra-hosts-ui-page#system)
      </td>
    ...
    <tr>
      <td>
        [<DoNotTranslate>**Processes**</DoNotTranslate> página](/docs/infrastructure/new-relic-infrastructure/infrastructure-ui-pages/infrastructure-processes-page-inspect-process-performance)
      </td>
    ...
    <tr>
      <td>
        [<DoNotTranslate>**Network**</DoNotTranslate> página](/docs/infrastructure/new-relic-infrastructure/infrastructure-ui-pages/infrastructure-network-page-measure-compare-capacity)
      </td>
    ...
    <tr>
      <td>
        [<DoNotTranslate>**Storage**</DoNotTranslate> página](/docs/infrastructure/new-relic-infrastructure/infrastructure-ui-pages/infrastructure-storage-page-evaluate-disk-usage-efficiency)
      </td>
    ...
    <tr>
      <td>
        [<DoNotTranslate>**Integrations**</DoNotTranslate> página](/docs/integrations/new-relic-integrations/getting-started/infrastructure-integration-dashboards-charts)
      </td>
