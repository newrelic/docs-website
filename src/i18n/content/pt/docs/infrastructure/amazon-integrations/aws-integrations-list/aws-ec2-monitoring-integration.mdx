...
[O monitoramento de infraestrutura da New Relic](/docs/infrastructure/introduction-infra-monitoring) inclui uma integração Amazon Elastic computar Cloud (EC2) para relatar seus metadados EC2 para a New Relic. Este documento explica o recurso de integração, como ativá-lo e quais dados podem ser informados.
