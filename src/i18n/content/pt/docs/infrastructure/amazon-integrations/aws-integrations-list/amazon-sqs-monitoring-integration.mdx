...
Para encontrar seus dados de integração, acesse <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS**</DoNotTranslate> e selecione um dos links de integração SQS.
