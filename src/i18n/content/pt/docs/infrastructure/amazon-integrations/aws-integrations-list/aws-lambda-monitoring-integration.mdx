...
<DNT>**We also offers a more in-depth Lambda monitoring feature**</DNT>. Para obter mais informações, consulte [New Relic monitoramento Serverless para AWS Lambda](/docs/serverless-function-monitoring/aws-lambda-monitoring/get-started/introduction-new-relic-monitoring-aws-lambda).
