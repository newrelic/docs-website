...
<DoNotTranslate>**We also offers a more in-depth Lambda monitoring feature**</DoNotTranslate>. Para obter mais informações, consulte [New Relic monitoramento Serverless para AWS Lambda](/docs/serverless-function-monitoring/aws-lambda-monitoring/get-started/introduction-new-relic-monitoring-aws-lambda).
...
Para encontrar seus dados de integração, acesse <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS**</DoNotTranslate> e selecione um dos links de integração do Lambda.
