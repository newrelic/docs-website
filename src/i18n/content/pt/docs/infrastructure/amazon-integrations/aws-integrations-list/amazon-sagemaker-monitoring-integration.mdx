...
Para encontrar a métrica da sua integração, acesse <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Metrics and events**</DoNotTranslate> e filtre por `aws.sagemaker`.
