...
3. Para visualizar uma linha do tempo quando um evento do AWS Health é criado, modificado ou excluído, use a [página](/docs/infrastructure/new-relic-infrastructure/infrastructure-ui-pages/infrastructure-events-page-live-feed-every-config-change)
