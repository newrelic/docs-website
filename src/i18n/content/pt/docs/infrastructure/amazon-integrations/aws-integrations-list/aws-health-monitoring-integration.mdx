...
3. Para visualizar uma linha do tempo quando um evento de integridade da AWS é criado, modificado ou excluído, use a [página](/docs/infrastructure/new-relic-infrastructure/infrastructure-ui-pages/infrastructure-events-page-live-feed-every-config-change)
...
Os eventos AWS Health são ingeridos como evento <DoNotTranslate>**AwsHealthNotification**</DoNotTranslate>. Você pode consultar, criar widget e definir políticas de alertas NRQL com base nesses eventos.

A tabela a seguir mostra os principais atributos disponíveis para o evento <DoNotTranslate>**AwsHealthNotification**</DoNotTranslate> :
