...
[A integração New Relic Infrastructure ](/docs/infrastructure/integrations-getting-started/getting-started/introduction-infrastructure-integrations)inclui uma integração para coleta [de dados aprimorados do Amazon RDS](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_Monitoring.OS.html); isso complementa a [integração básica New Relic RDS](/docs/infrastructure/amazon-integrations/amazon-integrations/aws-rds-monitoring-integration) com tempo real métrica sobre o sistema operacional em que a instância do banco de dados é executada.
...
1. Especifique a instância RDS que necessita de Habilitar monitoramento RDS Enhanced. Você pode especificar isso ao criar ou modificar a instância: em
   ...
   <DoNotTranslate>**Enable Enhanced Monitoring**</DoNotTranslate>
   ...
   <DoNotTranslate>**Granularity**</DoNotTranslate>
...
3. Crie uma nova função AWS do Lambda no repositório Serverless: Vá para
   ...
   <DoNotTranslate>**Lambda > Create Function > Browse serverless App repository**</DoNotTranslate>
...
1. Em
   ...
   <DoNotTranslate>**AWS Console > CloudWatch > Logs**</DoNotTranslate>

   , selecione `RDSOSMetrics` grupo log e aplique

   <DoNotTranslate>**Actions > Create Lambda subscription filter**</DoNotTranslate>

   .

2. Para

   <DoNotTranslate>**Lambda function**</DoNotTranslate>

   , selecione `newrelic-log-ingestion`.

3. No dropdown

   <DoNotTranslate>**Log Format**</DoNotTranslate>
...
4. Insira uma assinatura
   ...
   <DoNotTranslate>**filter name**</DoNotTranslate>

   .

5. Na parte inferior, clique no botão

   <DoNotTranslate>**Start streaming**</DoNotTranslate>
...
Para encontrar seus dados de integração, acesse <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS**</DoNotTranslate> e selecione o link <DoNotTranslate>**RDS > Enhanced monitoring dashboard**</DoNotTranslate> .
