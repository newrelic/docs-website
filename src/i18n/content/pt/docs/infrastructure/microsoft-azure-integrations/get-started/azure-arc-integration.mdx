...
<CollapserGroup>
  ...
  >
    O Azure Arc estende a plataforma Azure para ajudá-lo a criar aplicativos e serviços com flexibilidade para execução em data centers e ambientes multicloud. O Azure Arc ajuda você a desenvolver aplicativos nativos na nuvem com um modelo consistente de desenvolvimento, operações e segurança.
  </Collapser>
</CollapserGroup>
