...
1. Faça login no portal do Azure e vá para
   ...
   <DNT>**Azure Active Directory**</DNT>
...
2. Em
   ...
   <DNT>**App registrations > New registration**</DNT>
...
1. No Azure, no aplicativo que você acabou de criar, selecione
   ...
   <DNT>**Certificates & secrets**</DNT>

   .

2. Em

   <DNT>**Client secrets**</DNT>

   , clique em

   <DNT>**New client secret**</DNT>
...
2. Selecione
   ...
   <DNT>**Access control (IAM) > Add > Add role assignment**</DNT>
    ...
    <tr>
      ...
      <td>
        ...
        1. Vá para
           ...
           <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Azure > Manage services**</DNT>

           .

        2. Na página

           <DNT>**Edit Azure account**</DNT>
    ...
    <tr>
      ...
      <td>
        ...
        4. Faça login no [Azure](https://portal.azure.com/) e entre em
           ...
           <DNT>**All Services > Identity > App registrations**</DNT>
