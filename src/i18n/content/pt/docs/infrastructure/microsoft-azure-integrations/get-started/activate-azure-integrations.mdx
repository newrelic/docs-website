...
* Uma estimativa da chamada de API que fazemos para os serviços do Azure pode ser encontrada no [dashboardstatus da sua conta](/docs/infrastructure/infrastructure-integrations/cloud-integrations/cloud-integrations-account-status-dashboard).
...
3. Você colocará as informações necessárias na interface

   <DoNotTranslate>**Integrations**</DoNotTranslate>

   .

Para utilizar estas instruções de ativação de integração diretamente da nossa interface de infraestrutura, acesse <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Azure > Add an Azure account**</DoNotTranslate>.
...
1. Faça login no portal do Azure e vá para

   <DoNotTranslate>**Azure Active Directory**</DoNotTranslate>
...
2. Em
   ...
   <DoNotTranslate>**App registrations > New registration**</DoNotTranslate>
...
4. Em
   ...
   <DoNotTranslate>**Redirect URI**</DoNotTranslate>

   selecione `Web`e adicione `https://www.newrelic.com` como o URI de login.

5. Crie o aplicativo clicando em

   <DoNotTranslate>**Register**</DoNotTranslate>
...
6. No
   ...
   do seu aplicativo, copie o

   <DoNotTranslate>**Application (client) ID**</DoNotTranslate>

   e salve-o para uso posterior.
...
1. No Azure, no aplicativo que você acabou de criar, selecione

   <DoNotTranslate>**Certificates & secrets**</DoNotTranslate>

   .

2. Em

   <DoNotTranslate>**Client secrets**</DoNotTranslate>

   , clique em

   <DoNotTranslate>**New client secret**</DoNotTranslate>

   e depois em

   <DoNotTranslate>**Add**</DoNotTranslate>

   . Escolha a data de validade secreta que pode ser de até 2 anos. Assim que o segredo expirar, siga as etapas para [atualizar os detalhes do aplicativo](#update-app).

3. Copie o valor de

   <DoNotTranslate>**Client Secret**</DoNotTranslate>
...
1. Na seção Azure
   ...
   , selecione a assinatura que você deseja que New Relic monitor.

2. Selecione

   <DoNotTranslate>**Access control (IAM) > Add > Add role assignment**</DoNotTranslate>
...
3. No dropdown
   ...
   <DoNotTranslate>**Reader**</DoNotTranslate>
...
4. No dropdown
   ...
   , selecione o nome do aplicativo; por exemplo, `NewRelic-Integrations`.

5. Em

   <DoNotTranslate>**Selected members**</DoNotTranslate>

   , verifique se o nome do seu aplicativo aparece e selecione
...
1. Vá para
   ...
   e selecione o serviço Azure que deseja adicionar.

2. Siga os passos da interface para ativar a integração no New Relic.

3. Se você já concluiu as etapas da conta do Azure, pule para o final das etapas para preencher o formulário. (Para `Azure account name`, insira o nome que deseja usar para identificar a conta no dashboard

   <DoNotTranslate>**Integrations**</DoNotTranslate>

   .)

Depois de ativar uma integração do Azure, começaremos a monitorar seus dados do Azure em [intervalos regulares de sondagem](/docs/infrastructure/microsoft-azure-integrations/azure-integrations-list/azure-polling-intervals-infrastructure-integrations). Para [encontrar e usar seus dados](/docs/infrastructure/integrations/find-use-infrastructure-integration-data), use [métrica e evento](/docs/query-your-data/explore-query-data/data-explorer/introduction-data-explorer) ou vá para <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Azure**</DoNotTranslate>.
...
Será necessária a atualização das credenciais de autenticação do aplicativo utilizando a interface de infraestrutura ou a [APIintegração na nuvem](/docs/apis/nerdgraph/examples/nerdgraph-cloud-integrations-api-tutorial/) assim que o segredo do cliente expirar (o prazo máximo de validade disponível no Azure é de 2 anos).
...
1. Vá para
   ...
   na conta do Azure que deseja editar.
...
3. Edite o campo
   ...
   com o novo valor e confirme com
    ...
    <tr>
      ...
      <td>
        ...
        1. Vá para
           ...
           <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Azure > Manage services**</DoNotTranslate>

           .

        2. Na página

           <DoNotTranslate>**Edit Azure account**</DoNotTranslate>
    ...
    <tr>
      ...
      <td>
        ...
        2. Na página
           ...
           <DoNotTranslate>**Unlink this account**</DoNotTranslate>

           .

        3. Salve suas alterações.

        4. Faça login no [Azure](https://portal.azure.com/) e entre em

           <DoNotTranslate>**All Services > Identity > App registrations**</DoNotTranslate>
           ...
           <DoNotTranslate>**App registrations**</DoNotTranslate>

           .

        5. Encontre o aplicativo registrado (o nome recomendado é `NewRelic-Integrations`). Para ver a lista completa de aplicativos disponíveis, selecione o menu dropdown ao lado do campo de pesquisa e selecione

           <DoNotTranslate>**All apps**</DoNotTranslate>

           .

        6. Selecione o aplicativo e, no painel aberto, selecione
