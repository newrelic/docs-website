...
[A integração da New Relic](/docs/infrastructure/integrations-getting-started/getting-started/introduction-infrastructure-integrations) inclui uma integração para reportar seus dados [Microsoft Azure Cost Management](https://docs.microsoft.com/en-us/azure/cost-management/) para New Relic. Aqui explicamos como ativar a integração e quais dados ela coleta.
