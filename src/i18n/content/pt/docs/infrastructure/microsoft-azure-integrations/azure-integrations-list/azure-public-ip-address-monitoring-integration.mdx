...
* Execute [consultas personalizadas e visualize os dados](/docs/infrastructure/infrastructure-data/infra-integration-data).
...
### Métricas de endereços IP públicos do Azure [#Azure Public IP Addresses]
