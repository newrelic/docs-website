...
<Callout variant="important">
  Para obter informações sobre evento ou métrica do Cosmos DB preterido, consulte [integração do Azure Cosmos DB (obsoleto)](/docs/azure-cosmos-db-document-db-monitoring-integration-deprecated). Recomendamos fortemente a migração para o evento e métrica suportados neste documento.
</Callout>
