...
<CollapserGroup>
  <Collapser
    className="freq-link"
    id="azure"
    title="Custos do Microsoft Azure"
  >
    Dado que a nova integração permite ingerir todas as métricas de todos os serviços, <DoNotTranslate>**the amount of API calls to Azure will depend on the number of resources that are monitored by New Relic**</DoNotTranslate>. A configuração do parâmetro intervalo de sondagem de integração pode ajudar a controlar a quantidade dessas chamadas de API.
...
2. Acesse
   ...
   <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Azure**</DoNotTranslate>

   e procure a integração

   <DoNotTranslate>**Azure Monitor**</DoNotTranslate>

   .

3. Clique em

   <DoNotTranslate>**Configure**</DoNotTranslate>
...
<CollapserGroup>
  ...
  >
    ...
    Para definir as configurações de sinal, em <DoNotTranslate>**Condition Settings**</DoNotTranslate>, clique em <DoNotTranslate>**Advanced Signal Settings**</DoNotTranslate> e insira os seguintes valores:

    * <DoNotTranslate>**Aggregation window**</DoNotTranslate>

      : Com uma janela de agregação de um minuto, recomendamos definir um deslocamento de avaliação de oito minutos.
...
1. Vá para <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Azure**</DoNotTranslate> e clique em <DoNotTranslate>**Manage Services**</DoNotTranslate>.
2. Ative a nova integração <DoNotTranslate>**Azure Monitor metrics**</DoNotTranslate> e clique em <DoNotTranslate>**Save Changes**</DoNotTranslate>.<img title="Shows where to enable the Azure monitor" alt="Shows where to enable the Azure monitor" src={infrastructureAzureMonitorMetricsIntegration}/>
3. A integração <DoNotTranslate>**Azure Monitor metrics**</DoNotTranslate> fica disponível.<img title="Shows where azure monitor metrics integration" alt="Shows where azure monitor metrics integration" src={infrastructureAzureMonitorMetricsConfigure}/>
4. Habilite e configure a nova integração.<img title="Shows where azure monitor enable toggle button" alt="Shows where azure monitor enable toggle button" src={infrastructureAzureMonitorEnableToggle}/>
5. Depois que a configuração estiver concluída, você poderá desativar a integração de votação anterior nas configurações de <DoNotTranslate>**Manage services**</DoNotTranslate> .
