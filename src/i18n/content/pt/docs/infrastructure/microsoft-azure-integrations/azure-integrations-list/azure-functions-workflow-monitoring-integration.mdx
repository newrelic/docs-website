...
Siga [o procedimento padrão de integraçãoAzure Monitor ](/docs/infrastructure/microsoft-azure-integrations/azure-integrations-list/azure-monitor)para ativar o serviço de fluxo de trabalho Azure Functions no monitoramento de infraestrutura do New Relic .
