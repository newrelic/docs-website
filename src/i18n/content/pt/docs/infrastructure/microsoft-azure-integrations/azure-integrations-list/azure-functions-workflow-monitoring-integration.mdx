...
[A integração da New Relic](/docs/infrastructure/integrations-getting-started/getting-started/introduction-infrastructure-integrations) inclui uma integração para reportar seu [fluxo de trabalho métrico do Microsoft Azure Functions ](https://azure.microsoft.com/en-us/products/logic-apps/)e outros dados para a New Relic. Este documento explica como ativar a integração e descreve os dados reportados.
