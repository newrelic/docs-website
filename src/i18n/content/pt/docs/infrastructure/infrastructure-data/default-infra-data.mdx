...
<Callout variant="tip">
  Confira nosso [tutorial de solução de problemas](/docs/tutorial-troubleshoot-infra-hosts/diagnose-app-infra-data) para seus dados de host de infraestrutura. A série de tutoriais mostra como encontrar dados na interface de infraestrutura para resolver um evento de alerta e tomar uma decisão sobre recursos em seus hosts.
</Callout>
