...
<CollapserGroup>
  ...
  <Collapser id="alerts" title="Visualizar eventos de alerta de limite do host">
    Para visualizar os [eventos de limite de alerta](/docs/alerts/new-relic-alerts/getting-started/alerts-glossary#alert-threshold) de um ou mais hosts, selecione o ícone <DNT>**Critical**</DNT> <Icon name="fe-x-circle" /> ou o ícone <DNT>**Warning**</DNT> <Icon name="fe-alert-triangle" /> do host.
  </Collapser>
</CollapserGroup>
