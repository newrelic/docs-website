...
* Instale o kit de desenvolvimento de fantoches: [https://www.puppet.com/docs/pdk/2.x/pdk\_install.html](https://www.puppet.com/docs/pdk/2.x/pdk_install.html)
...
## Executar `newrelic-newrelic_installer` [#beginning]
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * `NEW_RELIC_API_KEY`: sua [chave de usuário](/docs/apis/intro-apis/new-relic-api-keys) do New Relic. <DNT>**Required**</DNT>.
        * `NEW_RELIC_ACCOUNT_ID`: seu ID de conta New Relic. <DNT>**Required**</DNT>.
