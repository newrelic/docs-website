...
A maneira mais rápida de começar a usar nosso [agente de infraestrutura](/docs/infrastructure/infrastructure-monitoring/get-started/get-started-infrastructure-monitoring/) é por meio da nossa [instalação guiada](/docs/new-relic-one/use-new-relic-one/cross-product-functions/install-configure/new-relic-guided-install-overview/). Se você estiver na UE, experimente nossa instalação guiada da UE. Se você estiver na região JP, experimente nossa instalação guiada do JP.
