...
Pronto para começar? Clique no botão <DNT>**Guided install**</DNT>. Ou, se sua organização estiver localizada em um [data center da UE](/docs/using-new-relic/welcome-new-relic/get-started/our-eu-us-region-data-centers), clique em <DNT>**EU Guided install**</DNT>. Ou, se sua organização estiver localizada em um [data center do JP](/docs/accounts/accounts-billing/account-setup/choose-your-data-center), clique em <DNT>**JP Guided install**</DNT>.
