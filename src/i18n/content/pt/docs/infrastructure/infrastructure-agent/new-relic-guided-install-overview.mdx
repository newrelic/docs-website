...
## Instalar versões específicas do agente [#install-specific-versions]
...
Para encontrar as versões disponíveis do agente de infraestrutura e seus detalhes de lançamento, consulte as [notas de lançamento do agente de infraestrutura](/docs/release-notes/infrastructure-release-notes/infrastructure-agent-release-notes/).
