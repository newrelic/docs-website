...
<Callout variant="important">
  **Aviso de região:** os exemplos de configuração neste tópico usam o URL de conexão MCP da região US: [https://mcp.newrelic.com/mcp/](https://mcp.newrelic.com/mcp/). Se a sua conta do New Relic estiver em uma região diferente, substitua este URL pelo endpoint regional apropriado em todos os arquivos de configuração e argumentos de linha de comando:
