---
title: Conector de conhecimento New Relic AI com confluência
...
<Steps>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Insira uma descrição para seu conector.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Escolha a categoria de conhecimento na lista suspensa. Isso ajudará o New Relic AI a procurar informações no lugar certo. Você pode escolher entre as seguintes opções:
  ...
  <Step>
    Na página <DNT>**Data source authentication**</DNT>, selecione o método de autenticação necessário. Você pode escolher entre as seguintes opções:
