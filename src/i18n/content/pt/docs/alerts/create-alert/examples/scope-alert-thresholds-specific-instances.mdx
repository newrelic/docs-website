...
* A [`condition_id`](/docs/using-new-relic/welcome-new-relic/get-started/glossary#alert-condition) (disponível no API Explorer: [<DNT>**Alerts Conditions &gt; GET &gt; List**</DNT>](https://api.newrelic.com/docs/#/Alerts%20Entity%20Conditions))
