...
* Se <DNT>**yes**</DNT>, seu indicador de status de saúde no índice selecionado (APM, navegador, etc.) será codificado por cores de acordo com o estado atual. Para visualizar um resumo dos eventos de alerta atuais, posicione o ponteiro do mouse sobre o indicador de status de integridade. No entanto, se o [botão de alternância<DNT>**Do not report system health status**</DNT> estiver ativado](/docs/alerts/create-alert/create-alert-condition/alert-conditions/#disable-health-status-reporting) ao definir limites para condições de alerta, o indicador não mudará de cor, mesmo quando ocorrer um evento de alerta.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        A entidade está operacional. Estamos coletando dados que você pode visualizar na interface apropriada. Não há eventos de alerta relatados para ele atualmente.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        * [Notificações](/docs/alerts/get-notified/destinations) foram enviadas com base na [preferência de rollup de eventos de alerta](/docs/alerts/organize-alerts/specify-when-alerts-create-events/) selecionada.
        * O evento de alerta aparece no [índice<DNT>**Alert events**</DNT> ](/docs/alerts/alert-event-management/view-alert-event-details).
      </td>
    </tr>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        A entidade é avaliada para pelo menos uma condição e os resultados mostram que não há eventos de alerta presentes.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Há pelo menos um evento de alerta aberto no momento em que a entidade está passando pela avaliação.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        O último evento de alerta aberto associado à entidade foi fechado.
      </td>
    </tr>
  </tbody>
</table>
...
Aqui está um exemplo de um aplicativo listado no <InlinePopover type="apm" />índice que <DNT>**is**</DNT> associado a uma ou mais condições. Seu status de integridade codificado por cores é verde, pois estamos coletando dados para ele e atualmente não há eventos de alerta de Aviso (amarelo) ou Crítico (vermelho).
...
<Callout variant="tip">
  Para visualizar a lista de [eventos de alerta abertos](/docs/alerts/alert-event-management/view-alert-event-details) atualmente em todos os produtos, não apenas nesta entidade, selecione <DNT>**View all alert events**</DNT>.
</Callout>