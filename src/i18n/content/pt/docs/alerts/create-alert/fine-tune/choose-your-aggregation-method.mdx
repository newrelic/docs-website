...
Para obter mais informações sobre quando usar o preenchimento de lacunas e a perda de sinal, consulte a postagem do fórum sobre [quando usar o preenchimento de lacunas e a perda de sinal](https://knowledge.newrelic.com/s/article/How-Can-I-Figure-Out-When-To-Use-Gap-Filling-and-Loss-of-Signal).