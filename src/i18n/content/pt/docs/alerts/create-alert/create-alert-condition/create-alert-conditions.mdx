...
Para visualizar [informações de política e condição de uma entidade específica](/docs/alerts/new-relic-alerts-beta/configuring-alert-policies/view-policy-conditions-new-relic-products): Na interface do produto dessa entidade, selecione <DNT>**Settings**</DNT> e clique em <DNT>**Alert conditions**</DNT>.