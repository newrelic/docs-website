...
* [A página](https://one.newrelic.com/alerts-ai/detection-gaps/)
  ...
  <DNT>
    [**Alert coverage gaps**](https://one.newrelic.com/alerts-ai/detection-gaps/)
  </DNT>
...
* Use
  ...
  para criar alertas do zero.

* <DNT>
    Use **Guided mode**
  </DNT>

  para escolher entre as opções recomendadas e criar sua consulta NRQL para você.
