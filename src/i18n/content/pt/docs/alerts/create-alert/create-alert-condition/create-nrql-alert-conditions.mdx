...
Vá para <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert Conditions & Policies**</DoNotTranslate> para criar uma condição do alerta NRQL a partir de uma política. Em seguida, clique em <DoNotTranslate>**+ New alert condition**</DoNotTranslate>.
...
<figcaption>
  Vá para <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert Conditions & Policies > + New alert condition**</DoNotTranslate>.
</figcaption>
...
<figcaption>
  Vá para <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert conditions (Policies)**</DoNotTranslate> e depois <DoNotTranslate>**+ New alert condition**</DoNotTranslate>. A perda de sinal está disponível apenas para condições NRQL.
</figcaption>
