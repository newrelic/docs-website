...
Para obter mais informações, confira nossa [postagem no blog](https://knowledge.newrelic.com/s/article/How-Can-I-Figure-Out-When-To-Use-Gap-Filling-and-Loss-of-Signal) sobre resolução de problemas para valores zero versus nulos.
...
<Callout variant="tip">
  ...
  Para saber mais sobre perda de sinal, preenchimento de lacunas e como solicitar acesso a esses recursos, consulte [esta publicação no Fórum de Suporte](https://support.newrelic.com/s/hubtopic/aAX8W0000008b5p/announcing-new-relic-one-streaming-alerts-for-nrql-conditions).
</Callout>
...
* O NerdGraph é a nossa API recomendada para isso, mas se você estiver usando nossa API REST, você pode encontrar essa configuração no explorador da API REST na seção <DNT>**&quot;signal&quot;**</DNT> da [API de condições NRQL de alerta](https://api.newrelic.com/docs/#/Alerts%20NRQL%20Conditions).
