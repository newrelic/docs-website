...
Vá para <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert Conditions & Policies**</DNT> para criar uma condição do alerta NRQL a partir de uma política. Em seguida, clique em <DNT>**+ New alert condition**</DNT>.
...
<figcaption>
  Vá para <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert Conditions & Policies > + New alert condition**</DNT>.
</figcaption>
...
<CollapserGroup>
  ...
  >
    ...
    Clique em <DNT>**Next**</DNT> quando terminar sua configuração.
  </Collapser>
  ...
  >
    Você pode definir [limite](/docs/alerts-applied-intelligence/new-relic-alerts/advanced-alerts/advanced-techniques/set-thresholds-alert-condition/) para determinar o que abrirá um incidente. Depois de definido, clique em <DNT>**Next**</DNT>.
  </Collapser>
  ...
  >
    ...
    Se você selecionar <DNT>**New policy**</DNT>:
    ...
    * Clique em <DNT>**Save & set up notifications**</DNT>.

    Se você selecionou <DNT>**Existing policy**</DNT>, clique em <DNT>**Save condition**</DNT> depois de escolher uma política.
  </Collapser>
</CollapserGroup>
...
1. Vá para <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & Services**</DNT> e selecione um aplicativo.

2. No painel esquerdo, selecione <DNT>**Metrics explorer**</DNT> e adicione sua configuração.

3. No canto direito do gráfico, clique no botão <Icon name="fe-more-horizontal"/> ícone e selecione <DNT>**Create alert condition**</DNT>.
...
1. Para uma política, ao criar uma condição, em
   ...
   <DNT>**Next, define thresholds**</DNT>
...
* Na interface das condições NRQL, acesse
  ...
  <DNT>**Condition settings > Advanced signal settings > fill data gaps with**</DNT>
...
* Na interface de condições NRQL, acesse
  ...
  <DNT>**Adjust to signal behavior > Use evaluation delay**</DNT>
