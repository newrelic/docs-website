...
<img width="80%;" title="A diagram showing some basic concepts and terms for New Relic alerting" alt="A diagram showing some basic concepts and terms for New Relic alerting" src={accountsAlertingConcepts} />
...
<Steps>
  <Step>
    ...
    * Selecione <DNT>**Alert Conditions**</DNT> na navegação esquerda.
    * Em seguida, selecione <DNT>**New alert condition**</DNT>.
    * Selecione <DNT>**Write your own query**</DNT>.
  ...
  <Step>
    ...
    <img title="set a query" alt="A screenshot showing a user how to set the signal behavior for an alert condition." src={alertsSetaQuery} />

    Neste exemplo, o gráfico mostrará a latência média do seu aplicativo `WebPortal` . Clique em <DNT>**Next**</DNT> e comece a configurar sua condição do alerta.
    ...
    <CollapserGroup>
      <Collapser id="window-duration" title="Duração da janela">
        <img title="fine tune alert settings" alt="A screenshot depicting advanced signal settings." src={alertsFineTuneAlertSignals} />
  ...
  <Step>
    ...
    <img title="set a threshold" alt="A screenshot depicting how to set the threshold for an alert condition." src={alertsSetaThresholdforanAlertCondition} />
  ...
  <Step>
    ...
    <img title="name an alert condition " alt="A screenshot demonstrating how you can new alert condition." src={alertsNameYourAlertCondition} />
    ...
    <CollapserGroup>
      ...
      <Collapser id="title-template" title="Use o modelo de título">
        <img title="alert details page" alt="A screenshot depicting the final step of creating an alert condition- the alert details page" src={alertsAddingAlertDetailstoanAlertCondition} />
...
<DocTiles>
  <DocTile title="Create your first New Relic alert" path="/docs/tutorial-create-alerts/create-new-relic-alerts/" label={{text: "Start here", color: "orange"}}>Um curso intensivo sobre alertas para iniciantes </DocTile><DocTile title="Advanced alert conditions" path="/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-alert-conditions/">Se você já configurou sua condição de alerta, vá mais fundo com as configurações avançadas</DocTile> <DocTile title="Get notified" path="/docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows/">Use o fluxo de trabalho para ser notificado sobre qualquer comportamento incomum em sua stack</DocTile>
</DocTiles>