...
<Steps>
  ...
  <Step>
    ...
    <CollapserGroup>
      ...
      <Collapser id="predict-alert" title="Alertas preditivos com limite estático (disponível em pré-visualização pública)">
        ...
        O <DNT>**Predictive Alerts**</DNT> no New Relic usa dados históricos para construir modelos que preveem violações de limites estáticos. Você pode definir até onde no futuro deseja prever. Se uma violação for prevista, um evento de alerta preditivo será acionado, permitindo que você aja antes que as interrupções ocorram.

        Para habilitar o <DNT>**Predictive Alerts**</DNT>:
        ...
        3. Defina o tempo de previsão para prever em quanto tempo o limite poderá ser ultrapassado. O tempo máximo de previsão é 360 vezes a [duração da janela](/docs/alerts/create-alert/create-alert-condition/alert-conditions/#window-duration).
        ...
        Para saber mais sobre o <DNT>**Predictive Alerts**</DNT>, consulte nossa [documentação](/docs/alerts/create-alert/set-thresholds/predictive-alerts).
      </Collapser>
