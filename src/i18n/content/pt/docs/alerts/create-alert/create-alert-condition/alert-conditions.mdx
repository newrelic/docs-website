...
* [A página ](https://one.newrelic.com/alerts-ai/detection-gaps/)
  ...
  <DNT>[**Alert coverage gaps**](https://one.newrelic.com/alerts-ai/detection-gaps/)</DNT>

Você também pode usar um de nossos criadores de alerta:

* Use

  <DNT>**Write your own query**</DNT>
...
<Steps>
  <Step>
    ...
    * Selecione
      ...
      <DNT>**Alert Conditions**</DNT>

      na navegação esquerda.

    * Em seguida, selecione

      <DNT>**New alert condition**</DNT>
  ...
  <Step>
    ...
    <CollapserGroup>
      ...
      >
        ...
        * <DNT>**High-frequency data (for example, pageviews every minute)**</DNT>
        ...
        * <DNT>**Low-frequency data (for example, hourly signals)**</DNT>
  ...
  <Step>
    ...
    <CollapserGroup>
      ...
      >
        Ao contrário dos limites de anomalia, um limite estático não analisa o seu conjunto de dados como um todo e determina qual comportamento é incomum com base no histórico do seu sistema. Em vez disso, um limite estático abrirá um incidente sempre que o sistema se comportar de maneira diferente dos critérios <DNT>**you set**</DNT>.
...
1. Vá para
   ...
   , use o botão de alternância para ativar ou desativar a condição.
