...
<DocTiles>
  <DocTile title="Create your first New Relic alert" path="/docs/tutorial-create-alerts/create-new-relic-alerts/" label={{text: "Start here", color: "orange"}}>Um curso intensivo sobre alertas para iniciantes </DocTile><DocTile title="Advanced alert conditions" path="/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-alert-conditions/">Se você já configurou sua condição do alerta, aprofunde-se com as configurações avançadas</DocTile> <DocTile title="Get notified" path="/docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows/">Use o fluxo de trabalho para ser notificado sobre qualquer comportamento incomum em sua stack</DocTile>
</DocTiles>