    ...
    <CollapserGroup>
      ...
      <Collapser id="predict-alert" title="Alertas preditivos com limite estático (disponível em pré-visualização pública)">
        <Callout title="visualização">
          ...
          Quando o período de visualização pública dos alertas preditivos termina em qualquer momento e por qualquer motivo, sua janela de avaliação do alerta será avaliada apenas em relação ao limite estático, o que pode resultar em um pequeno atraso na detecção de uma violação de alerta.
        </Callout>
