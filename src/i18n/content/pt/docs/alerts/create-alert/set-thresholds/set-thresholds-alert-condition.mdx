...
Ao criar uma condição, você define <DNT>**thresholds**</DNT> personalizados que determinam o que abrirá um incidente. Este documento explica o que são limites e como defini-los.
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            Opcional. Ele abrirá um incidente de nível de prioridade crítica e enviará uma notificação dependendo da [configuração de preferência de criação de problemas](/docs/alerts/new-relic-alerts/configuring-alert-policies/specify-when-new-relic-creates-incidents) da política e de qualquer [fluxo de trabalho](/docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows/) que você possa ter configurado. Limite de sinal perdido, quando acionado, também abre incidente de nível de prioridade crítica. Veja [abaixo](/docs/alerts/create-alert/set-thresholds/set-thresholds-alert-condition/#signal-loss) mais detalhes.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Opcional. Ele abrirá um incidente de nível de alta prioridade e poderá enviar notificações dependendo da [configuração de preferência de criação de problemas](/docs/alerts/new-relic-alerts/configuring-alert-policies/specify-when-new-relic-creates-incidents) da política e de qualquer [fluxo de trabalho](/docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows/) que você possa ter configurado. Use um limite de aviso se quiser monitor quando um comportamento do sistema é preocupante ou digno de nota, mas não é importante o suficiente para exigir um limite de nível crítico.
          </td>
        </tr>
      </tbody>
    </table>
