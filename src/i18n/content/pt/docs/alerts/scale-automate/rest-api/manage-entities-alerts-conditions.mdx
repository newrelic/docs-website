...
3. Obtenha a lista de condições associadas à política e escolha aquela que deseja modificar para a categoria apropriada:
   ...
   * [<InlinePopover type="apm" />, <InlinePopover type="browser" />e<InlinePopover type="mobile" />](/docs/alerts/new-relic-alerts/rest-api-alerts/rest-api-calls-new-relic-alerts#conditions)
