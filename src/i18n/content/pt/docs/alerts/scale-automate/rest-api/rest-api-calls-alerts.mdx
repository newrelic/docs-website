...
<Callout variant="important">
  Se a sua organização hospeda dados no data center da UE, certifique-se de estar usando os [endpoints de API adequados para contas da região da UE](/docs/using-new-relic/welcome-new-relic/getting-started/introduction-eu-region-data-center#endpoints). Para contas de [data center do JP](/docs/accounts/accounts-billing/account-setup/choose-your-data-center), certifique-se de estar usando os endpoints de API adequados da região do JP.
</Callout>
...
<Callout variant="important">
  Se a sua organização hospeda dados no data center EU, certifique-se de estar usando os [endpoints de API adequados para contas da região EU](/docs/using-new-relic/welcome-new-relic/getting-started/introduction-eu-region-data-center#endpoints). Para contas de [data center do JP](/docs/accounts/accounts-billing/account-setup/choose-your-data-center), certifique-se de estar usando os endpoints de API adequados da região do JP.
</Callout>
