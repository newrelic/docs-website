...
<Callout variant="important">
  Por padrão, este endpoint usa o data center dos EUA. Se a organização hospedar dados no data center da UE, é necessário garantir o uso dos [endpoints de API adequados para contas da região da UE](/docs/using-new-relic/welcome-new-relic/getting-started/introduction-eu-region-data-center#endpoints). Para contas do [data center do JP](/docs/accounts/accounts-billing/account-setup/choose-your-data-center), certifique-se de estar utilizando os endpoints de API adequados da região do JP.
</Callout>
...
<Callout variant="important">
  O API Explorer fornece informações sobre outros tipos de condições usando <DNT>**separate endpoints**</DNT>, incluindo [serviços externos](#ext-services-conditions) (APM e dispositivos móveis) e [monitoramento sintético](#synthetics-conditions). Considerar todos os tipos de condição do alerta ao pesquisar ou atualizar. Por padrão, este endpoint usa o data center dos EUA. Se a conta hospedar dados no data center da UE, deve-se garantir o uso dos [endpoints de API adequados para contas da região da UE](/docs/using-new-relic/welcome-new-relic/getting-started/introduction-eu-region-data-center#endpoints).
</Callout>
...
<Callout variant="important">
  Por padrão, este endpoint usa o data center dos EUA. Se a organização hospeda dados no data center da UE, certifique-se de estar utilizando os [endpoints de API adequados para contas da região da UE](/docs/using-new-relic/welcome-new-relic/getting-started/introduction-eu-region-data-center#endpoints). Para contas do [data center do JP](/docs/accounts/accounts-billing/account-setup/choose-your-data-center), certifique-se de estar utilizando os endpoints de API adequados da região do JP.
</Callout>
