...
* Atlassian Jira: Disponível em [fluxos de trabalho](/docs/alerts/get-notified/alert-event-workflows/), [caixa de entrada de erros](/docs/errors-inbox/).

* ServiceNow: Disponível em [fluxos de trabalho](/docs/alerts/get-notified/alert-event-workflows/).

* Slack: Disponível em [fluxos de trabalho](/docs/alerts/get-notified/alert-event-workflows/), [inbox de erros](/docs/errors-inbox/) e [Discussões](/docs/new-relic-solutions/new-relic-one/ui-data/collaborate/collaboration-slack-integration/).

* Webhook: Disponível em [fluxos de trabalho](/docs/alerts/get-notified/alert-event-workflows/).
...
* E-mail: Disponível em [fluxos de trabalho](/docs/alerts/get-notified/alert-event-workflows/) e [Discussões](/docs/new-relic-solutions/new-relic-one/ui-data/collaborate/collaborate-with-teammates/).

* AWS EventBridge: Disponível em [fluxos de trabalho](/docs/alerts/get-notified/alert-event-workflows/).

* PagerDuty: Disponível em [fluxos de trabalho](/docs/alerts/get-notified/alert-event-workflows/).

* New Relic Mobile Push: Disponível em [fluxos de trabalho](/docs/alerts/get-notified/alert-event-workflows/).

* Microsoft Teams: Disponível em [fluxo de trabalho](/docs/alerts/get-notified/microsoft-teams-integrations/).

* **Automação de fluxo de trabalho**: Disponível em [fluxos de trabalho](/docs/alerts/get-notified/alert-event-workflows/). Aciona [fluxos de trabalho automatizados de resposta a eventos de alerta](/docs/workflow-automation/setup-and-configuration/create-destinations#trigger-from-alerts) quando as condições de alerta são violadas.
...
/\* &lt;img title=&quot;Página de visão geral de destinos&quot; alt=&quot;Página de visão geral de destinos.&quot; src=&quot;/images/accounts\_screenshot-full\_destinations-overview\.webp&quot; /&gt; &lt;figcaption&gt; Vá para &lt;DNT&gt;\*\*\[one.newrelic.com &gt; All capabilities]\(https\://one.newrelic.com/all-capabilities) &gt; Alerts &gt; Destinations\*\*&lt;/DNT&gt;. Use destinos para escolher para onde suas notificações são enviadas. &lt;/figcaption&gt; \*/
...
/\* &lt;img title=&quot;Status do destino na tabela de Destinos.&quot; alt=&quot;Status do destino na tabela de Destinos.&quot; src=&quot;/images/accounts\_screenshot-full\_destinations-status.webp&quot; /&gt; &lt;figcaption&gt; Acesse &lt;DNT&gt;\*\*\[one.newrelic.com &gt; All capabilities]\(https\://one.newrelic.com/all-capabilities) &gt; Alerts &gt; Destinations\*\*&lt;/DNT&gt;. Clique na aba &lt;DNT&gt;\*\*Destinations\*\*&lt;/DNT&gt; para ver a tabela de destinos. &lt;/figcaption&gt; \*/

### logde notificação de problemas [#notifications-log]

O [Log de notificação de problemas](/docs/alerts/get-notified/alert-event-workflows/#issue-notification-log) fornece um registro detalhado para acompanhar todas as notificações geradas por fluxos de trabalho. Essas informações ajudam você a solucionar problemas, monitorar o desempenho do fluxo de trabalho e garantir que as notificações sejam enviadas para os destinos corretos. Como resultado, você pode identificar rapidamente quaisquer problemas que possam surgir e tomar medidas corretivas conforme necessário.
...
Isso é especialmente útil ao usar os recursos <DNT>**Alert conditions (policies)**</DNT> e [fluxos de trabalho](/docs/alerts/get-notified/alert-event-workflows/). Dessa forma, você pode criar uma condição que é acionada no evento de um erro de notificação, e uma nova notificação pode ser enviada para outro local.
