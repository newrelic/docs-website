...
* **Fluxo de trabalho automação**: Disponível em [fluxo de trabalho](/docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows/). Aciona [resposta automatizada a incidentes de fluxo de trabalho](/docs/workflow-automation/setup-and-configuration/create-destinations#trigger-from-alerts) quando a condição de alerta é violada.
