...
<img title="An example webhook notification message template." alt="A screenshot of an example webhook notification message template." src={accountsNotificationPayloadTemplate} />
...
<img title="The variables menu that shows the breadth of variable options available." alt="A screenshot of the variables menu that. shows the breadth of variable options available." src={accountsNotificationCustomVariables} />
