...
O que [esta migração](https://support.newrelic.com/s/hubtopic/aAX8W0000008dKO/plan-to-upgrade-alert-notification-channels-to-workflows-and-destinations) significa para a equipe? Em nosso modelo de notificação anterior, sua equipe criaria uma condição do alerta com diferentes limites e parâmetros. Se essa condição estivesse associada a uma política específica, fosse violada, e fosse necessário que sua equipe soubesse disso imediatamente, seria adicionado <DNT>**notification settings**</DNT>. Nossas configurações de notificação informariam ao New Relic quais dados enviar e para onde.
