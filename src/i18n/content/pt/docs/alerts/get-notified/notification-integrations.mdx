...
<CollapserGroup>
  ...
  >
    ...
    4. Clique no botão <DNT>**Send test notification**</DNT> para enviar uma notificação de teste com um exemplo de carga predefinido para o canal. Isso cria uma mensagem no canal do Slack selecionado.
