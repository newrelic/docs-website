...
<CollapserGroup>
  ...
  <Collapser className="freq-link" id="servicenow-certified" title="ServiceNow (Certified application)">
    ...
    * No ServiceNow você pode enviar e ver como imagens os enriquecimentos da New Relic.
    ...
    <Callout variant="important">
      Se você não tiver acesso para criar um novo destino, envie um e-mail para notificationWorkflows@newrelic.com com o nome e o número da sua conta para obter assistência.
    </Callout>
  ...
  <Collapser className="freq-link" id="slack" title="Slack">
    ...
    1. Vá para <DNT>**[one.newrelic.com &gt; All capabilities](https://one.newrelic.com/all-capabilities) &amp;gt; Alerts**</DNT>, clique em <DNT>**Destinations**</DNT> e selecione <DNT>**Slack**</DNT>.
    2. Clique no botão <DNT>**Authenticate in one click**</DNT> para acessar a página inicial do Slack e continuar o processo de autenticação do OAuth2. Se não estiver conectado ao workspace necessário, você será redirecionado ao Slack para fazer login.
    ...
    3. Adicione o nome do seu espaço de trabalho ou selecione o espaço de trabalho relevante e clique em <DNT>**Continue**</DNT>.
    ...
    5. Clique em <DNT>**Allow**</DNT> e retorne à página de destino.
