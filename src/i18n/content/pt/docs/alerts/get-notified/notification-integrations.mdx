...
<CollapserGroup>
  ...
  >
    ...
    3. Selecione ou crie um nome de destino.

    4. Selecione ou crie uma fonte de evento.
    ...
    5. No console do AWS EventBridge, escolha <DNT>**Partner event sources**</DNT> no painel de navegação.

    6. Selecione o botão próximo à origem do evento do parceiro e escolha <DNT>**Associate with event bus**</DNT>.
    ...
    7. Crie uma regra para o barramento de eventos.
  ...
  >
    ...
    ### Configure um destino de push mobile [#set-mobile_push-destination][#set-mobile_push-destination]
  ...
  >
    ...
    * O reconhecimento de um problema do New Relic é acionado quando o incidente do PagerDuty é reconhecido.
    ...
    6. Vá para <DNT>**Services > Service Directory**</DNT> e selecione o serviço ao qual deseja adicionar a integração.

    7. Selecione a guia <DNT>**Integrations**</DNT> e clique em <DNT>**Add an integration**</DNT>.

    8. Encontre e marque a integração do New Relic na lista e clique em <DNT>**Add**</DNT>.
    ...
    9. Clique à direita para visualizar e copiar seu <DNT>**Integration Key**</DNT>.
    ...
    10. Vá para <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) &amp;gt; Alerts &amp;gt; Workflows**</DNT> e clique em um fluxo de trabalho existente ou clique no botão <DNT>**+ Add a new workflow**</DNT> e escolha o notificador PagerDuty.

    11. Escolha um destino ou crie um novo.

    12. (Opcional) Edite o resumo do incidente padrão.
  ...
  >
    ...
    * Para buscar usuário para a coluna `caller` , precisamos de permissões de leitura para a tabela `sys_user` .
    ...
    3. Ative o botão `two-way integration` .

    4. Abra e baixe este [arquivo XML](https://storage.googleapis.com/newrelic-notifications/snow-two-way-sync/Newrelic-Snow-Sync-Configurations.xml), que inclui a regra de negócios que aciona o evento de volta para o New Relic.

    5. No menu da barra lateral do ServiceNow, acesse <DNT>**System Definition > Business Rules**</DNT>.

    6. Clique no ícone do menu em um dos cabeçalhos das colunas, selecione <DNT>**Import XML**</DNT> e faça upload do arquivo XML que você baixou.
  ...
  >
    ...
    * No ServiceNow você pode enviar e ver como imagens os enriquecimentos da New Relic.
      ...
      <Callout variant="important">
        Se você não tiver acesso para criar um novo destino, envie um e-mail para [notificationWorkflows@newrelic.com](mailto:notificationWorkflows@newrelic.com) com o nome e o número da sua conta para obter assistência.
      </Callout>
    ...
    10. [Baixe e instale o aplicativo New Relic](https://store.servicenow.com/sn_appstore_store.do#!/store/application/d117597d1b9b9d9078faddf7b04bcba7/1.1.1) na loja ServiceNow.

    11. Crie um usuário dentro do ServiceNow. Certifique-se de ativar a opção <DNT>**Web service access only**</DNT> e conceder a função `x_newre_core.inbound_api` ao usuário criado. Copie e salve a senha gerada.

    12. Vá para <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) &amp;gt; Alerts**</DNT>, clique em <DNT>**Destinations**</DNT> e selecione <DNT>**Webhook**</DNT>.
    ...
    14. Clique em <DNT>**Save destination**</DNT>.
    ...
    15. Vá para <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) &amp;gt; Alerts**</DNT> e clique em <DNT>**Workflows**</DNT>.

    16. Clique no <Icon name="fe-more-horizontal"/> em um Webhook existente e selecione <DNT>**Edit**</DNT> ou clique no botão <DNT>**+ Add a new workflow**</DNT> .

    17. Clique no canal <DNT>**Webhook**</DNT> .

    18. Modifique a carga padrão adicionando o atributo `serviceNowFields` necessário.
    ...
    19. Clique em <DNT>**Send test notification**</DNT> para verificar suas alterações.

    20. Clique em <DNT>**Save message**</DNT>.

    21. Clique em <DNT>**Activate workflow**</DNT>.
  </Collapser>
  ...
  >
    ...
    9. Vá para <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) &amp;gt; Alerts &amp;gt; Workflows**</DNT> e clique em um fluxo de trabalho existente ou no botão <DNT>**+ Add a workflow**</DNT> .

    10. Selecione um destino, também conhecido como espaço de trabalho, e um canal do Slack para enviar mensagens. Você poderá criar um novo destino se não houver um destino predefinido para o espaço de trabalho necessário.

    11. Você também pode optar por receber atualizações de notificação, como quando um problema é confirmado ou encerrado, no canal. Isso também é conhecido como transmissão de thread.
