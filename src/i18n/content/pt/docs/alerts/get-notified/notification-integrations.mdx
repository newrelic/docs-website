...
<CollapserGroup>
  ...
  >
    ...
    3. Você também pode optar por receber atualizações de notificação, como quando um problema é confirmado ou encerrado, no canal. Isso também é conhecido como transmissão de thread.<img title="thread braodcast" alt="a screenshot depicting the thread broadcast in the UI." src={alertsThreadBroadcast}/>
