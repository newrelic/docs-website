...
Você pode criar, ativar, desativar e gerenciar regras de silenciamento. Vá para <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Muting rules**</DoNotTranslate>. Ative ou desative regras de silenciamento a qualquer momento. Clique no <Icon name="fe-more-horizontal"/> ícone na linha de cada regra para editar e remover regras.
...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Muting rules**</DoNotTranslate>: Você pode criar regras de muting complexas para destinar um conjunto pequeno ou grande de notificações indesejadas.
</figcaption>
...
Para criar uma regra de silenciamento, vá para <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Muting rules**</DoNotTranslate> e clique em <DoNotTranslate>**+ Add a rule**</DoNotTranslate>. Insira um nome e uma descrição (opcional) para a regra de silenciamento e selecione a conta à qual a regra será aplicada.
...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Muting rules**</DoNotTranslate>: opções flexíveis e poderosas para programar suas regras de silenciamento.
</figcaption>
...
<CollapserGroup>
  ...
  >
    ...
    <figcaption>
      Vá para <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Issues**</DoNotTranslate> e clique em um problema silenciado.
    </figcaption>
  </Collapser>
