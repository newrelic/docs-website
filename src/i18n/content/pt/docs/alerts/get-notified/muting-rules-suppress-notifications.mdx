...
Alerta envia notificações oportunas quando seu sistema está com problemas. Às vezes há notificações que você sabe que não precisa ver. Você pode usar <DNT>**muting rules**</DNT> para evitar ser bombardeado por mensagens que não precisam de sua atenção.
...
<CollapserGroup>
  ...
  >
    Incidente e os problemas são marcados com o <Icon name="fe-bell-off"/> ícone na coluna <DNT>**Muted**</DNT> :
