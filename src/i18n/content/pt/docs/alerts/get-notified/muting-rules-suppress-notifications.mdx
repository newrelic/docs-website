...
* <DNT>**Close ongoing incidents**</DNT>: Isso significa que se um incidente for acionado logo após a regra de silenciamento ficar inativa, você receberá uma notificação. Recomendamos que você mantenha esta configuração padrão.
