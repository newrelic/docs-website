...
<Steps>
  ...
  <Step>
    ...
    <CollapserGroup>
      ...
      >
        Ao contrário dos limites de anomalia, um limite estático não analisa o seu conjunto de dados como um todo e determina qual comportamento é incomum com base no histórico do seu sistema. Em vez disso, um limite estático abrirá um incidente sempre que o sistema se comportar de maneira diferente dos critérios <DNT>**you set**</DNT>. Os limites de alerta estático são muito mais personalizáveis e nós os recomendamos se você tiver uma boa noção dos seus dados e do que procura.
