...
<Steps>
  ...
  <Step>
    ...
    Vamos ver como isso pode parecer na prática. Ao visualizar a página <DoNotTranslate>**All entities**</DoNotTranslate> , você percebe quatro serviços em alerta.
  ...
  <Step>
    ...
    Você tem seu ponto de entrada em seu sistema, então agora pode analisar os erros que afetam seu aplicativo. Na página de resumo `api-gateway` , clique na guia <DoNotTranslate>**Errors**</DoNotTranslate> em <DoNotTranslate>**Triage**</DoNotTranslate>. Sua página de erros filtra seus dados para uma visualização somente de erros.
  ...
  <Step>
    ## Ajuste a série temporal [#timeseries]
