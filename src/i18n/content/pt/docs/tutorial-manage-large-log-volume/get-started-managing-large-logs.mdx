...
* <DNT>
  ...
  : Todo mundo precisa de coisas diferentes em seu log. Alguns podem precisar ingerir uma grande quantidade para manter registros, enquanto outros podem precisar ingerir uma pequena quantidade. Alguns podem precisar analisar intensamente seu log, enquanto outros mal conseguem analisá-lo. Nossa plataforma de gerenciamento de logs oferece ferramentas para você gerenciar o que você nos envia.

* <DNT>
    **Transparent**
  </DNT>

  : Não há surpresas no faturamento. A New Relic cobra apenas pelos dados que você ingere a um preço fixo por gigabyte.

* <DNT>
    **Usage-based**
  </DNT>

  : Pague apenas pelo registro que você ingere. Nem todos os logs são valiosos, portanto não adianta ingerir e pagar por logs que você nunca usará. Neste tutorial, exploraremos como ingerir logs seletivamente de maneira acessível e eficaz.
