...
<Steps>
  <Step>
    ...
    Vá para <DoNotTranslate>**[one.newrelic.com > Logs](https://one.newrelic.com/launcher/logger.log-launcher)**</DoNotTranslate>  
