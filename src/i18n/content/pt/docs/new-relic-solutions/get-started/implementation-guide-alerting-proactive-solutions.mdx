...
Para encaminhar mensagens de notificação de alerta para você, usamos <DoNotTranslate>**workflows**</DoNotTranslate> (as regras de como o incidente cria a notificação e quais dados são enviados) e <DoNotTranslate>**notification destinations**</DoNotTranslate> (para onde as notificações são enviadas). Recomendamos que você planeje como eles serão configurados para serem consistentes e fáceis de manter em toda a sua organização. Se você estiver integrando outro serviço, como Slack ou PagerDuty, considere como você controlará e manterá essa integração no longo prazo.
