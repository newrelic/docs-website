...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Use [valores`audit_log` ](/docs/agents/ruby-agent/installation-configuration/ruby-agent-configuration#audit_log). Para obter mais informações, consulte [Log de auditoria do agente Ruby](/docs/agents/ruby-agent/troubleshooting/ruby-agent-audit-log).
      </td>
    </tr>
  </tbody>
</table>
