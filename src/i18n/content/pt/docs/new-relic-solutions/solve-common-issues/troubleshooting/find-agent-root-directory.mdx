    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            Use [`phpinfo()`](/docs/agents/php-agent/configuration/php-agent-configuration#inivar-background) e procure nas seções chamadas <DoNotTranslate>**Scan this dir for additional .ini files**</DoNotTranslate> ou <DoNotTranslate>**Additional .ini files parsed**</DoNotTranslate> o local do arquivo `newrelic.ini` . Esse arquivo estará no diretório raiz do agente, chamado `newrelic-php5`.
