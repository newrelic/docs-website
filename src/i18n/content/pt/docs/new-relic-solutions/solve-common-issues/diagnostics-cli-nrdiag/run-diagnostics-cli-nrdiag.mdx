...
Por padrão, a Diagnostics CLI faz o upload dos resultados para contas do New Relic hospedadas no data center dos EUA. Se a sua conta estiver hospedada no data center da UE ou do Japão, adicione `-region eu` ou `-region jp` ao comando.
