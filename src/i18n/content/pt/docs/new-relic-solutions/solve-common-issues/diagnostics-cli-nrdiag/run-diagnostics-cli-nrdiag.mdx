...
<CollapserGroup>
  ...
  <Collapser id="macos-run" title="Mac OS">
    1. Certifique-se de ter a CLI de diagnóstico:
  ...
  <Collapser id="browser-run" title="Monitoramento de browser">
  ...
  <Collapser id="docker" title="Docker contêiner">
...
<CollapserGroup>
  <Collapser id="list-available-scripts" title="Listar script disponível">
  ...
  <Collapser id="view-script" title="Ver um script">
  ...
  <Collapser id="run-script" title="Execute um script">
  ...
  <Collapser id="run-script-with-args" title="Execute um script com argumentos">
  ...
  <Collapser id="run-script-and-suites" title="Execute um script junto com suítes">
...
<CollapserGroup>
  <Collapser id="linux-attach-examples" title="Linux e macOS">
    * Para sistemas de 64 bits:
