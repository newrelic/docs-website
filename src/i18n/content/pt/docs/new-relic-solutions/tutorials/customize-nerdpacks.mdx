...
<Steps>
  ...
  <Step>
    [Adicione **Victory Charts Visualizations** à sua conta](/docs/new-relic-solutions/new-relic-one/build-nr-apps/subscribe).
  </Step>
  ...
  <Step>
    Como você vai usar uma versão modificada do Nerdpack **Victory Charts Visualizations** em vez daquela que você assinou, você pode [cancelar a assinatura](/docs/new-relic-solutions/new-relic-one/build-nr-apps/subscribe/#unsubscribe-from-a-nerdpack) da nossa versão agora.
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    Perfeito! Você clonou e atualizou a visualização da **Circular progress bar** do código aberto do catálogo de Instant Observability. A única coisa que resta a fazer é publicar sua versão no catálogo para que suas contas possam [assiná-la](/docs/new-relic-solutions/new-relic-one/build-nr-apps/subscribe/#subscribe-to-a-nerdpack).
  </Step>
...
<Steps>
  <Step>
    A partir do seu diretório raiz, [publique](/docs/new-relic-solutions/new-relic-one/build-nr-apps/publish/) seu Nerdpack:
  ...
  <Step>
    [Assine](/docs/new-relic-solutions/new-relic-one/build-nr-apps/subscribe/#subscribe-to-a-nerdpack) seu Nerdpack:
