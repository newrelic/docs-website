...
Para detalhes adicionais, consulte [Configurar seu ambiente de desenvolvimento](/docs/new-relic-solutions/new-relic-one/build-nr-apps/set-up-dev-env/).
...
## Importar o `PlatformStateContext` [#import]
