...
<Steps>
  ...
  <Step>
    Edite o arquivo `index.js` e defina `this.accountId` como [sua ID de conta,](/docs/accounts/accounts-billing/account-structure/account-id/) conforme mostrado no exemplo.
