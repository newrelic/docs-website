...
Para obter detalhes adicionais sobre como configurar seu ambiente, consulte [Configurar seu ambiente de desenvolvimento](/build-apps/set-up-dev-env) e [Habilitar configuração avançada para seu Nerdpack](/build-apps/advanced-config).
