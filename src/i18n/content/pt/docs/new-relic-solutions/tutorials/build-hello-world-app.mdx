...
Para obter detalhes adicionais sobre como configurar seu ambiente, consulte [Configurar seu ambiente de desenvolvimento](https://developer.newrelic.com/build-apps/set-up-dev-env/) e [Habilitar configuração avançada para seu Nerdpack](https://developer.newrelic.com/build-apps/advanced-config).
...
<Steps>
  <Step>
    Em _my-awesome-nerdpack/nerdlets/home/index.js_, altere a mensagem de retorno padrão para "Hello, world!":
  ...
  <Step>
    Como etapa opcional, você pode [adicionar um ícone de inicialização personalizado](https://developer.newrelic.com/build-apps/publish-deploy/catalog/#update-your-nerdpacks-icons) usando qualquer imagem chamada _icon.webp_.

    Em _launchers/launcher_, adicione uma imagem chamada _icon.png_:
  ...
  <Step>
    Em seguida, altere o nome do iniciador para algo mais significativo. Em _my-awesome-nerdpack/launchers/launcher/nr1.json_, altere `displayName` para "Hello world":
...
<Steps>
  ...
  <Step>
    Em [New Relic](https://one.newrelic.com), clique em <DoNotTranslate>**Add Data**</DoNotTranslate>:
...
<Steps>
  <Step>
    ...
    * _launchers/launcher/catalog_: Contém a captura de tela do launcher
    * _nerdlets/home/catalog_: Contém Nerdlet captura de tela
    * _catalog_: Contém documentação, captura de tela, descrição e mais informações sobre o seu Nerdpack
  ...
  <Step>
    ...
    E se você adicionou captura de tela ao seu launcher ou Nerdlet, você pode vê-los em <DoNotTranslate>**What's inside**</DoNotTranslate>:
...
<Steps>
  ...
  <Step>
    Na página de descrição do seu aplicativo, clique em <DoNotTranslate>**Add this app**</DoNotTranslate>:
  ...
  <Step>
    Vá para a página <DoNotTranslate>**Apps**</DoNotTranslate> :
