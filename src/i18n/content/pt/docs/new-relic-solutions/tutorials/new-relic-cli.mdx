...
Confira [todos os comandos disponíveis](https://github.com/newrelic/newrelic-cli/blob/master/docs/cli/newrelic.md) na New Relic CLI. Por exemplo, você pode criar um [workload do New Relic](\(/docs/new-relic-solutions/new-relic-one/workloads/workloads-isolate-resolve-alert-events-faster\)) usando [`workload create`](https://github.com/newrelic/newrelic-cli/blob/master/docs/cli/newrelic_workload_create.md)
