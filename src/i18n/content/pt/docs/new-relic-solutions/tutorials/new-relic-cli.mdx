...
<Steps>
  ...
  <Step>
    ...
    <Callout variant="important">
      É necessário definir a [região](/docs/accounts/accounts-billing/account-setup/choose-your-data-center) da conta do New Relic. Use `-r` para definir `us`, `eu` ou `jp`.
    </Callout>
  </Step>
...
Confira [todos os comandos disponíveis](https://github.com/newrelic/newrelic-cli/blob/master/docs/cli/newrelic.md) na New Relic CLI. Por exemplo, você pode criar uma [carga de trabalho do New Relic](/docs/new-relic-solutions/new-relic-one/workloads/workloads-overview) usando [`workload create`](https://github.com/newrelic/newrelic-cli/blob/master/docs/cli/newrelic_workload_create.md)

Caso deseje interagir com outros membros da comunidade, visite a nossa página do [New Relic Explorer Hub](https://support.newrelic.com/s/hubtopic/Topic__c/Default?c__categories=%5B%7B%22icon%22%3A%22standard%3Adefault%22%2C%22id%22%3A%22a6c8W000000EeszQAC%22%2C%22sObjectType%22%3A%22Category__c%22%2C%22title%22%3A%22Build%20on%20New%20Relic%22%2C%22titleFormatted%22%3A%22Build%20on%20New%20Relic%22%7D%5D). São bem-vindos requests de recurso ou relatórios de bugs no [GitHub](https://github.com/newrelic/newrelic-cli).