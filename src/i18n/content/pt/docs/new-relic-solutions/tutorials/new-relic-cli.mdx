...
Dê uma olhada em [todos os comandos disponíveis](https://github.com/newrelic/newrelic-cli/blob/master/docs/cli/newrelic.md) na CLI do New Relic. Por exemplo, você pode criar um [fluxo de trabalho New Relic](/docs/new-relic-one/use-new-relic-one/core-concepts/new-relic-one-workloads-isolate-resolve-incidents-faster) usando [`workload create`](https://github.com/newrelic/newrelic-cli/blob/master/docs/cli/newrelic_workload_create.md)
