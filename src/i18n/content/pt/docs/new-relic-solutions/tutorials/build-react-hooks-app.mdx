...
Os diretórios _launchers_ e _nerdlets_ contêm a lógica do seu aplicativo. É nesses diretórios que você atualiza a maior parte do seu código. Os arquivos _nr1.json_ em todo o Nerdpack contêm metadados sobre seu Nerdpack, Nerdlets e inicializadores.

<Callout variant="tip">
  Leia [nossa documentação](https://developer.newrelic.com/explore-docs/nerdpack-file-structure/) para saber mais sobre a estrutura de arquivos do Nerdpack.
</Callout>

<Steps>
  <Step>
    Em _my-awesome-nerdpack/nerdlets/home/index.js_, altere a classe _HomeNerdlet_ para uma função:
...
<Steps>
  <Step>
    Em _my-awesome-nerdpack/nerdlets/home/index.js_, chame `useState()` em seu componente de função:
...
<Steps>
  <Step>
    Em _my-awesome-nerdpack/nerdlets/home/index.js_, crie um efeito:
