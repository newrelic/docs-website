...
Para ajudá-lo a criar um aplicativo New Relic, fornecemos o SDK New Relic One. Aqui você aprende a usar os componentes de consulta do SDK, que permitem fazer consultas e mutações via [NerdGraph](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph/), nosso endpoint GraphQL.
...
* `CHART`: o formato usado pelo mecanismo de gráficos que também expomos.
