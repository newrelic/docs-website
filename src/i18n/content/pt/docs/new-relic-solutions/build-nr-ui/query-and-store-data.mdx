...
Para ajudar você a criar um [aplicativo New Relic](/docs/new-relic-solutions/tutorials/build-hello-world-app), fornecemos o [New Relic One SDK](/docs/new-relic-solutions/build-nr-ui/sdk-component/intro-to-sdk). Aqui você pode aprender a usar os componentes do SDK consulta, que permitem fazer consultas e mutações via [NerdGraph](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph/), nosso endpoint GraphQL.
