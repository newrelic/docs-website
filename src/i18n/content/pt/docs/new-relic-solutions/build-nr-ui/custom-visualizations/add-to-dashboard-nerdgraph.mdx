...
Adicione sua visualização personalizada a um novo ou dashboard existente, de forma programática, com New Relic GraphQL API da , [NerdGraph](https://docs.newrelic.com/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph/).
...
1. Vá para <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Dashboards**</DoNotTranslate> e selecione seu dashboard.
