...
Para adicionar uma instância da sua visualização a um dashboard, primeiro você precisa [publicar seu Nerdpack](/docs/new-relic-solutions/new-relic-one/build-nr-apps/publish).
