...
<Steps>
  ...
  <Step>
    ...
    <Callout variant="important">
      Certifique-se de substituir `<YOUR NEW RELIC ACCOUNT ID>` pelo [ID real da sua conta](https://docs.newrelic.com/docs/accounts/accounts-billing/account-setup/account-id) New Relic.
    </Callout>
  </Step>
  ...
  <Step>
    ...
    * [Instruções do Chrome](https://developers.google.com/web/tools/chrome-devtools#console)
      ...
      <Callout variant="tip">
        ...
        * Gerou um novo UUID
        * Todas as instâncias de `<YOUR NEW RELIC ACCOUNT ID>` no seu projeto foram substituídas pelo New Relic [ID real da sua conta](https://docs.newrelic.com/docs/accounts/accounts-billing/account-setup/account-id)
      </Callout>
  </Step>
