...
<Steps>
  ...
  <Step>
    ...
    <Callout variant="tip">
      ...
      * Gerou um novo UUID
      * Substituídas todas as instâncias de `<YOUR NEW RELIC ACCOUNT ID>` e `<YOUR NEW RELIC ENTITY GUID>` no seu projeto pelo New Relic [ID](https://docs.newrelic.com/docs/accounts/accounts-billing/account-setup/account-id) da conta e GUID da entidade reais, respectivamente
    </Callout>
  </Step>
</Steps>
