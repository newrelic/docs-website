---
title: Descreva seu aplicativo para o catálogo
...
## Criar informações de catálogo [#create]

Para fornecer informações ao catálogo sobre seu app, você precisa criar o diretório `catalog` em seu Nerdpack.

<Steps>
  <Step>
    Mude para o diretório _description-app/ab-test_ do [repositório de cursos](https://github.com/newrelic-experimental/nru-programmability-course):
  ...
  <Step>
    Crie os diretórios _do catálogo_ :

    ```sh
    nr1 create --type catalog
    ```

    Isso cria um diretório raiz `catalog` com arquivos de modelo para inserir informações personalizadas sobre seu aplicativo e um diretório `catalog` para cada item do Nerdpack onde a captura de tela pode ser armazenada.
  </Step>
  ...
  <Step>
    Salve [esta captura de tela](https://github.com/newrelic-experimental/nru-programmability-course/raw/main/publish/ab-test/catalog/screenshots/screenshot.webp) nos dois diretórios a seguir:
  ...
  <Step>
    Salve o ícone a seguir como `icon.png` em `nru-programmability-course/describe-app/ab-test`.
