...
Para ajudar você a criar um aplicativo New Relic, fornecemos o [New Relic One SDK](/docs/new-relic-solutions/build-nr-ui/sdk-component/intro-to-sdk). Nesta página, você aprenderá como usar `NerdStorageVault` para armazenar dados em uma solução de armazenamento criptografada.
