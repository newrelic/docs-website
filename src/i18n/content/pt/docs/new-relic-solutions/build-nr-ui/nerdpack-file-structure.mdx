...
* **Gere um Nerdpack**: use o comando CLI do New Relic One [`nr1 create`](/docs/new-relic-solutions/build-nr-ui/nr1-cli/nr1-common/#nr1-create) e selecione `Nerdpack` para criar um modelo Nerdpack que inclua um Nerdlet e um inicializador.

* **Gere o Nerdlet ou o iniciador individualmente**: use o comando da CLI do New Relic One [`nr1 create`](/docs/new-relic-solutions/build-nr-ui/nr1-cli/nr1-common/#nr1-create) e escolha `Nerdlet` ou `launcher`. Isso pode ser útil ao adicionar Nerdlets a um Nerdpack existente.
