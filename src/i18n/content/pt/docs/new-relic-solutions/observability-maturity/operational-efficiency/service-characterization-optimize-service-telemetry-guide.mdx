...
* Guias de instrumentação:
  ...
  * [Pitão](/docs/apm/agents/python-agent/custom-instrumentation/python-custom-instrumentation/)
...
* [Pitão `external_trace`](/docs/apm/agents/python-agent/python-agent-api/externaltrace-python-agent-api/)
