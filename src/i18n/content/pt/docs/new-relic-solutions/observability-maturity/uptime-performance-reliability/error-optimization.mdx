...
Leva apenas alguns minutos para configurar uma carga de trabalho. Veja [as instruções de carga de trabalho](/docs/new-relic-solutions/new-relic-one/workloads/workloads-isolate-resolve-alert-events-faster).
