...
1. Na interface de monitoramento do Browser, selecione
...
* <DNT>
  ...
  Alerta se a interação com a próxima pintura ou com a pintura de maior conteúdo estiver acima do limite `Needs improvement` .
