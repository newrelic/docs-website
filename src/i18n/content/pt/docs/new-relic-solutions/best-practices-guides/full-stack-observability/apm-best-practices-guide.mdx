...
* <DoNotTranslate>**Static threshold alerts**</DoNotTranslate>
...
* <DoNotTranslate>**Dynamic anomaly alerts**</DoNotTranslate>
...
* Para configurar seu canal de notificação de alerta, [siga os procedimentos padrão](/docs/alerts/new-relic-alerts/managing-notification-channels/notification-channels-controlling-where-send-alerts).
...
1. Vá para
   ...
   <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Key transactions**</DoNotTranslate>

   e selecione

   <DoNotTranslate>**Add more**</DoNotTranslate>

   . Em seguida, selecione o aplicativo e a transação da web ou, na transação selecionada, selecione

   <DoNotTranslate>**Track as key transaction**</DoNotTranslate>

   .

2. Digite um nome para o principal da transação e selecione

   <DoNotTranslate>**Track key transaction**</DoNotTranslate>
...
4. Para visualizar os detalhes dashboard principal da transação, selecione
   ...
   <DoNotTranslate>**View new key transaction**</DoNotTranslate>
...
1. Na barra de menu New Relic , selecione
   ...
   <DoNotTranslate>**APM & services > (select an app) > Events > Deployments**</DoNotTranslate>

   .

2. Para visualizar o desempenho após uma implantação, acesse o dashboard Visão geral do aplicativo selecionado na seção

   <DoNotTranslate>**Recent events**</DoNotTranslate>
...
1. Na barra de menu do APM, selecione
   ...
   <DoNotTranslate>**Applications > (select an app) > Reports**</DoNotTranslate>
...
3. Se quiser salvar ou exportar um relatório para compartilhar, selecione
   ...
   <DoNotTranslate>**Download this report as .csv**</DoNotTranslate>
...
1. Vá para
   ...
   <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > More > Service maps**</DoNotTranslate>
...
Para implantar o agente automaticamente <DoNotTranslate>**(preferred as a method to avoid errors)**</DoNotTranslate>:
