...
<Steps>
  ...
  <Step>
    ...
    1. Para adicionar um monitor, vá para <DNT>**[one.newrelic.com &gt; All capabilities](https://one.newrelic.com/all-capabilities) &gt; Synthetic Monitoring**</DNT>.
       ...
       Se você tiver uma conta regional, use a URL apropriada:
  ...
  <Step>
    ...
    Para identificar rapidamente os monitores com falha, você pode usar a página [índice de monitores sintéticos](/docs/synthetics/synthetic-monitoring/pages/synthetic-monitoring-summary) para ver quais monitores têm eventos de alerta abertos, taxas de sucesso em 24 horas, número de locais com falha, o período do monitor e o tipo de monitor. Ao clicar em um monitor, você será direcionado para a [página de resumo](/docs/synthetics/new-relic-synthetics/pages/synthetics-overview-page-view-monitors-performance), onde encontrará informações para avaliar onde aquele monitor específico está falhando, por que está falhando, por exemplo, a última mensagem de erro, códigos de resposta de erro, duração por domínio e muito mais. Com essas informações, você terá uma visão mais aprofundada do desempenho da sua aplicação ao longo do tempo.
