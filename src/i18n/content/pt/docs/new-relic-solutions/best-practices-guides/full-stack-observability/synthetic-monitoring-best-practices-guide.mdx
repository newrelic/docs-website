...
1. Para adicionar um monitor, vá para <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Synthetic Monitoring**</DoNotTranslate>. (Se você tiver uma [conta na UE](/docs/using-new-relic/welcome-new-relic/get-started/introduction-eu-region-data-center), vá para <DoNotTranslate>**[one.eu.newrelic.com](http://one.eu.newrelic.com)**</DoNotTranslate>.) Clique em <DoNotTranslate>**Create monitor**</DoNotTranslate>.
...
## 6. Configure e desenvolva um teste de Browser com script [#scripted-test]
...
7. Agora você está pronto para escrever seu script.

Aqui está um exemplo de script para testar o desempenho de newrelic.com e verificar se certos elementos foram carregados:
