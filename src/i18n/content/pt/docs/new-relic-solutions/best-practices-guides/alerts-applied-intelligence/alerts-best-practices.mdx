...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <DNT>**Avoid setting thresholds too low**</DNT>. Por exemplo, se você definir um limite de condição de CPU de 75% por 5 minutos em seus servidores de produção e ele ultrapassar esse nível rotineiramente, isso aumentará a probabilidade de alertas inacionáveis ou falsos positivos.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <DNT>**You don't need to edit files or restart the software**</DNT>, então sinta-se à vontade para fazer alterações rápidas nos níveis de limite e ajustá-los conforme necessário.
      </td>
    </tr>
