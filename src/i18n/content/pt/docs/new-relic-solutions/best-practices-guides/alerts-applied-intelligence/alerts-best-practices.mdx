...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        Use [enriquecimentos](/docs/alerts/get-notified/alert-event-workflows/#enrichments)
      </td>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        Você entenderá o impacto que isso terá no seu [fechamento de eventos de alerta](/docs/alerts/alert-event-management/how-alert-condition-events-are-closed/).
      </td>
    </tr>
...
* [Configure a cobertura de alertas em escala com alertas inteligentes](/docs/alerts/smart-alerts-coverage) (visualização pública)
...
Se a cláusula `where` da sua condição excluir todos os dados, não restará nenhum dado. Isso é uma [perda de sinal](https://support.newrelic.com/s/hubtopic/aAX8W0000008bEyWAI/relic-solution-how-can-i-figure-out-when-to-use-gap-filling-and-loss-of-signal) para a New Relic e a condição de alerta NÃO PODE ser avaliada em relação a NENHUM limite. Isso significa que o resultado da consulta NRQL não possui dados, mas isso não significa que a New Relic não esteja recebendo dados. Se você deseja receber uma notificação, você deve adicionar um limite de perda de sinal.
...
Se você é novo nos alertas, saiba mais sobre suas [opções de preferências de problemas](/docs/alerts/organize-alerts/specify-when-alerts-create-events).
...
* Leia mais sobre [quando pode ser necessário usar as configurações de perda de sinal e preenchimento de lacunas](https://knowledge.newrelic.com/s/article/How-Can-I-Figure-Out-When-To-Use-Gap-Filling-and-Loss-of-Signal).