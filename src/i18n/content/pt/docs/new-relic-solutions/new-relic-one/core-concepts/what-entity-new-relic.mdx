...
A observabilidade do New Relic é construída em torno do conceito de <DoNotTranslate>**entities**</DoNotTranslate>. Este documento explica como definimos entidade, o que você pode fazer com elas e como você pode criar sua própria entidade ou agrupamentos de entidade.
...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com)**</DoNotTranslate>: ao abrir o New Relic, você acessa a página <DoNotTranslate>**All entities**</DoNotTranslate> , que oferece uma visão geral da entidade do seu monitor. Nessa página, você pode visualizar metadados de uma entidade ou clicar em uma entidade para ver detalhes de desempenho.
</figcaption>
...
Para encontrar o GUID de uma entidade e outros metadados na interface: em qualquer [lista de entidades](/docs/new-relic-solutions/new-relic-one/core-concepts/new-relic-explorer-view-performance-across-apps-services-hosts#find), clique no nome de uma entidade <Icon name="fe-more-horizontal"/> ícone e clique em <DoNotTranslate>**See metadata & tags**</DoNotTranslate>.
...
* Ao visualizar uma entidade na interface, use a [interface](#related-entities)

  <DoNotTranslate>[**Related entities**](#related-entities)</DoNotTranslate>
...
As opções para o tempo de expiração da entidade são:
...
Esses atributos devem ser sintetizados a partir da telemetria que recebemos. <DoNotTranslate>**Do not**</DoNotTranslate> defina-os, a menos que você esteja ciente das implicações e consequências.
...
Ao visualizar uma entidade nas visualizações [entidade explorer](/docs/new-relic-solutions/new-relic-one/core-concepts/new-relic-explorer-view-performance-across-apps-services-hosts#find), Navigator e Lookout, você pode ver seu <DoNotTranslate>**Related entities**</DoNotTranslate> no painel direito. Isto dá uma visualização das diversas entidades ligadas diretamente à entidade atual. Você pode visualizar rapidamente métricas importantes para essas entidades relacionadas e navegar de uma entidade para outra, por todas as partes conectadas da sua stack.
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            A relação entre um aplicativo de backend e o aplicativo de navegador que ele retorna na resposta.
          </td>
        </tr>
      </tbody>
    </table>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Esse relacionamento é criado quando um agente APM [injeta](/docs/browser/browser-monitoring/installation/install-browser-monitoring-agent/#select-apm-app) o navegador do agente em uma página.
          </td>
        </tr>
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            Este relacionamento é criado quando há uma verificação do monitoramento sintético do instrumento da página com o agente navegador.
          </td>
        </tr>
  ...
  >
    <table>
      ...
      <tbody>
        ...
        <tr>
          <td>
            Aplicativo de navegador com agente New Relic
          </td>
          ...
          <td>
            Um aplicativo de navegador informa uma métrica `Ajax/HostTransaction` ao chamar um serviço externo (URL).
...
Quando os relacionamentos não são detectados automaticamente, você pode criá-los manualmente usando nossa [API NerdGraph](/docs/apis/nerdgraph/examples/nerdgraph-entities-api-tutorial/#manual-relationships) ou pode fazer isso na interface do New Relic com o link <DoNotTranslate>**Add/edit related entities**</DoNotTranslate> em <DoNotTranslate>**Related entities**</DoNotTranslate>. Atualmente, você só pode criar manualmente relacionamentos de chamadas/chamados por entre entidades de serviço.
