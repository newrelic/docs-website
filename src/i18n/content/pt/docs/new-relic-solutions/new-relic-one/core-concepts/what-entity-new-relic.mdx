...
* Ao visualizar uma entidade na interface, use a [interface](#related-entities)
  ...
  <DNT>[**Related entities**](#related-entities)</DNT>
...
Esses atributos devem ser sintetizados a partir da telemetria que recebemos. <DNT>**Do not**</DNT> defina-os, a menos que você esteja ciente das implicações e consequências.
