...
3. No campo <DoNotTranslate>**Add a new tag...**</DoNotTranslate> do widget de tag, adicione uma tag com este formato: `accountId: 123456789`.<img title="Add tags in New Relic" alt="Add tags in New Relic" src={solutionsTagManagement}/>
