...
3. In the <DoNotTranslate>**Add a new tag...**</DoNotTranslate> field of the tags widget, add a tag with this format: `accountId: 123456789`.<img title="Add tags in New Relic" alt="Add tags in New Relic" src={solutionsTagManagement}/>
