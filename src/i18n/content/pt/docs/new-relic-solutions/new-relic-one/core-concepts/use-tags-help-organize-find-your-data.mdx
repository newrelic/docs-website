...
* Organize e pesquise melhor

  <InlinePopover type="dashboards"/>

  e [carga de trabalho](/docs/new-relic-one/use-new-relic-one/workloads/workloads-isolate-resolve-incidents-faster).
...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="Tag de configuração do agente"
  >
  ...
  <Collapser
    ...
    title="Tag de atributo do recurso OpenTelemetry"
  >
    Certos [atributos de recursos OpenTelemetry](https://github.com/open-telemetry/opentelemetry-specification/blob/main/specification/resource/semantic_conventions/README.md) são aplicados automaticamente como tag de entidade. Quando os seguintes atributos estiverem presentes nos dados span associados a uma entidade de serviço, eles serão anexados a essa entidade:
    ...
    * `telemetry.sdk.language`: Será armazenado como uma tag chamada `language`

    * `telemetry.sdk.version`

    * `service.namespace`

      Essa tag automatizada é feita usando a síntese de entidade New Relic, que está [documentada no GitHub](https://github.com/newrelic/entity-definitions#entity-definitions). No caso dos serviços OpenTelemetry, as [definições de tags](https://github.com/newrelic/entity-definitions/blob/main/definitions/ext-service/definition.yml#L58) estão em `ext-service` entidade.
  </Collapser>
</CollapserGroup>
...
1. Vá para <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DoNotTranslate> e selecione uma entidade de monitoramento, como um aplicativo de monitoramento ou host.
2. Perto do nome da entidade, na parte superior da página, clique no botão <DoNotTranslate>**tags**</DoNotTranslate> .
3. No campo <DoNotTranslate>**Add a new tag...**</DoNotTranslate> do widget de tags, adicione uma tag com este formato: `accountId: 123456789`.<img title="Add tags in New Relic" alt="Add tags in New Relic" src={solutionsTagManagement}/>
...
2. Perto do nome da entidade, na parte superior da página, clique no botão
...
<CollapserGroup>
  <Collapser
    id="add-via-ui-api"
    title="Gerenciar condição do alerta tag"
  >
    1. Navegue até uma condição.

    2. Perto do nome da condição, na parte superior do formulário, clique em <DoNotTranslate>**Manage tags**</DoNotTranslate>.
  ...
  <Collapser
    ...
    title="Automatize tags com nossa CLI"
  >
...
<CollapserGroup>
  <Collapser
    id="tag-format"
    title="Formato e limites da tag"
  >
...
<CollapserGroup>
  <Collapser
    id="team-tags"
    title="Tag relacionada à equipe"
  >
  ...
  <Collapser
    id="environment-tags"
    title="Tag relacionada ao meio ambiente"
  >
  ...
  <Collapser
    id="criticality-tags"
    title="Tag relacionada à criticidade"
  >
...
<CollapserGroup>
  <Collapser
    ...
    title="Taxas de transferência entre fragmentos"
  >
  ...
  <Collapser
    id="apm-errors-team"
    title="Alerta sobre taxa de erros para equipes"
  >
  ...
  <Collapser
    id="infra-teams"
    title="Encontre equipes internas que possuam entidade específica para monitoramento de infraestrutura"
  >
  ...
  <Collapser
    id="infra-experiment"
    title="Compare grupos em um experimento de teste de carga de CPU"
  >
  ...
  <Collapser
    id="propagation-off"
    title="Desativar a propagação tag para tags de infraestrutura"
  >
