...
3. No campo <DNT>**Add a new tag...**</DNT> do widget de tag, adicione uma tag com este formato: `accountId: 123456789`.<img title="Add tags in New Relic" alt="Add tags in New Relic" src={solutionsTagManagement}/>
