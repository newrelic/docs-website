...
<Steps>
  ...
  <Step>
    Vá para <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Apps**</DoNotTranslate>. Esteja você criando um aplicativo New Relic ou uma visualização personalizada, você encontrará seu projeto em <DoNotTranslate>**Apps**</DoNotTranslate>.
  </Step>

  <Step>
    Se você estiver servindo um Nerdpack com um iniciador e um Nerdlet, encontrará seu aplicativo local em <DoNotTranslate>**Your apps:**</DoNotTranslate>. Se você estiver servindo um Nerdpack com visualização, vá para <DoNotTranslate>**Favorite apps > Custom Visualizations**</DoNotTranslate>.
...
Leia a documentação do [`nr1 nerdpack:serve`](/explore-docs/nr1-nerdpack#nr1-nerdpackserve) para saber mais. Ou veja a página de ajuda `nr1` :
