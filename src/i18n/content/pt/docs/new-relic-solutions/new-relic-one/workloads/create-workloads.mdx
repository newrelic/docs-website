...
Existem dois tipos de contas que contribuem para a carga de trabalho: a <DoNotTranslate>**workload account**</DoNotTranslate> e a <DoNotTranslate>**scope accounts**</DoNotTranslate>. Se a sua [organização New Relic](/docs/accounts/accounts-billing/account-structure/new-relic-account-structure) tiver mais de uma conta, a diferenciação entre a workload e as contas de escopo facilitará o gerenciamento da sua carga de trabalho.
...
<CollapserGroup>
  ...
  >
    ...
    <figcaption>
      <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Workloads > Create a workload:**</DoNotTranslate> Ao [criar uma workload](#create), você escolhe as contas associadas e monitora a entidade.
    </figcaption>

    Veja como criar uma workload na interface de carga de trabalho:

    1. Vá para <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Workloads**</DoNotTranslate> e clique em <DoNotTranslate>**+ Create a workload**</DoNotTranslate>.

    2. Dê à workload um nome que seja significativo para você e sua equipe.

    3. No dropdown <DoNotTranslate>**Select an account**</DoNotTranslate>, selecione a [contaworkload ](#accounts)que você deseja usar.
    ...
    7. Clique em <DoNotTranslate>**Create a workload**</DoNotTranslate> para salvá-lo.
...
<CollapserGroup>
  ...
  >
    ...
    Para adicionar painel a uma workload: Depois de criar uma workload, vá para a página <DoNotTranslate>**Activity**</DoNotTranslate> de uma workload e clique em <DoNotTranslate>**Add dashboard**</DoNotTranslate>.
  </Collapser>
</CollapserGroup>