...
A New Relic também permite que você escreva “anomalia consulta” em seus dados. São consultas que você escreve sem estabelecer limites rígidos para os resultados. Em vez disso, você permite que [a inteligência aplicada](https://newrelic.com/platform/applied-intelligence) aprenda automaticamente seus dados de desempenho e, em seguida, alerte você quando seus dados se afastarem muito dos números de anomalias.
...
2. Crie uma condição. Selecione <DoNotTranslate>**NRQL**</DoNotTranslate>
...
3. Defina sua consulta e decida até que ponto a inteligência aplicada restritivamente deve analisar seus dados usando um controle deslizante simples e uma visualização com base em seu desempenho recente.
...
A inteligência aplicada é uma ótima maneira de ajudá-lo a aprender proativamente sobre seus gastos com nuvem ou sobre qualquer um dos seus dados de desempenho.
