...
<CollapserGroup>
  <Collapser id="components-list" title="Exemplo: Lista de componentes">
...
<CollapserGroup>
  <Collapser id="connect-migration-example" title="Exemplo: componentes correspondentes a produtos New Relic">
...
<CollapserGroup>
  <Collapser id="deploy-apm" title="Implantar APM">
  ...
  <Collapser id="deploy-infrastructure" title="Infraestrutura implantar">
  ...
  <Collapser id="deploy-infrastructure-on-host" title="Implantar infraestrutura integração no host">
  ...
  <Collapser id="create-synthetics-monitor" title="Criar monitor Sintético">
...
<CollapserGroup>
  <Collapser id="baseline-maturity-example" title="Exemplo: desempenho do componente comparado com a linha de base">
