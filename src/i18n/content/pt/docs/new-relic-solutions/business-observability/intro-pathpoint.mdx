...
O objetivo é fornecer sinais que tenham um nível de independência, e quando ocorrer um incidente, você poderá deduzir pelo que está _vermelho_ qual pode ser o problema.
