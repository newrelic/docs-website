...
<Steps>
  <Step>
    Selecione um ponto de contato para testar. Clique com o botão direito e clique em <DNT>**Queries**</DNT>.
  ...
  <Step>
    Abre uma janela. Clique em <DNT>**Test**</DNT>.
  ...
  <Step>
    A janela mostrará os resultados do teste. Por exemplo, se você vir <DNT>**Successfully validated**</DNT>, significa que seu ponto de contato está íntegro.

    Se a validação falhar, descubra o motivo e corrija. Em seguida, teste novamente até receber a mensagem <DNT>**Successfully validated**</DNT> .
  </Step>

  <Callout variant="important">
    Ao testar um ponto de contato, se você receber um erro <DNT>**Incorrectly validated**</DNT> , isso pode ser causado pela execução da consulta no ID de conta errado.
...
<Steps>
  <Step>
    Selecione um ponto de contato para testar. Clique com o botão direito e selecione <DNT>**Tune**</DNT>.
  ...
  <Step>
    Insira novos valores de limite <DNT>**Min**</DNT> e <DNT>**Max**</DNT> e clique em <DNT>**Save/Update**</DNT>.
...
<Steps>
  <Step>
    Clique com o botão direito no ponto de contato específico com o qual deseja trabalhar e clique em <DNT>**Queries**</DNT>.
...
<Steps>
  ...
  <Step>
    Se o touchpoint estiver ativado, clique no botão de alternância <DNT>**On**</DNT> para desligá-lo.
