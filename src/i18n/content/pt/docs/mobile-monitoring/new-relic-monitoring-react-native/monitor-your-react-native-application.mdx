...
<CollapserGroup>
  ...
  >
    ...
    4. Clique em <DNT>**Add to dashboard**</DNT>.<img title="Query your data" alt="This is an image of a sample query in the Query builder." src="/images/mobile_screenshot-full_query-example.webp"/>
