---
title: Monitoramento de Mobile Android New Relic com distributed tracing
metaDescription: This page describes how to set up Android distributed tracing.
freshnessValidatedDate: never
translationType: machine
---

O agente <InlinePopover type="mobile"/>Android New Relic oferece suporte distributed tracing. Isso permite que você veja como a atividade do seu aplicativo móvel se conecta aos serviços relacionados.
...
Para agentes móveis que suportam esse recurso, ele está habilitado por padrão. Você também precisa ativar [AnalyticsEvents](/docs/mobile-monitoring/new-relic-mobile-android/android-sdk-api/android-agent-configuration-feature-flags/#ff-analytics-events) para que esse recurso funcione.

Se preferir desativar distributed tracing, consulte [Sinalização de recurso do Android](/docs/mobile-monitoring/new-relic-mobile-android/android-sdk-api/android-agent-configuration-feature-flags/#dt).
