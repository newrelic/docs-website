...
* Se você vir relatórios de falhas ofuscados na [página<DNT>**Crashes**</DNT> ](/docs/mobile-monitoring/mobile-monitoring-ui/crashes/mobile-apps-crashes-dashboard), talvez você não tenha carregado um arquivo `mapping.txt` .
