...
4. Execute seu aplicativo em um emulador ou dispositivo para começar a ver dados na [página<DoNotTranslate>**Overview**</DoNotTranslate> ](/docs/mobile-apps/mobile-apps-dashboard)do seu aplicativo para dispositivos móveis.

5. Opcional: use a página <InlinePopover type="mobile"/><DoNotTranslate>**Settings**</DoNotTranslate> para [personalizar seu aplicativo móvel](/docs/mobile-apps/customizing-your-mobile-app-settings).
...
Para adicionar suporte para <DoNotTranslate>**DexGuard**</DoNotTranslate>:
...
5. Execute seu aplicativo em um emulador ou dispositivo para começar a ver dados na [página<DoNotTranslate>**Overview**</DoNotTranslate> ](/docs/mobile-apps/mobile-apps-dashboard)do seu aplicativo para dispositivos móveis.

6. Opcional: Use a página Monitoramento de Mobile <DoNotTranslate>**Settings**</DoNotTranslate> para [personalizar seu aplicativo móvel](/docs/mobile-apps/customizing-your-mobile-app-settings).
