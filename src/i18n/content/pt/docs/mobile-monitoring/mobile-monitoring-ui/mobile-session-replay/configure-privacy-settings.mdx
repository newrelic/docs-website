...
4. **Regras de prioridade pai/filho**

   Observe que, se houver regras conflitantes, o mascaramento de um pai tem prioridade sobre as regras de subárvore.

   *Exemplo:* Se um pai tiver o atributo `nr-block`, mas um filho tiver `nr-unmask`, toda a subárvore é substituída pelo espaço reservado de retângulo preto bloqueando o conteúdo; nenhum conteúdo filho na subárvore é capturado.
