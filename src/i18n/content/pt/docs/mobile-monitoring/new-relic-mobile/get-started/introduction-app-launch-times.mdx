---
title: Visão geral dos tempos de lançamento do aplicativo
tags:
  - Mobile monitoring
  - New Relic Mobile
  - Get started
...
## Comparativo de mercado de tempo de inicialização de aplicativos móveis [#benchmarks]
...
* [(Android) Configure os horários de lançamento do aplicativo](/docs/mobile-monitoring/new-relic-mobile-android/install-configure/configure-app-launch-time-android-apps).

* [(iOS) Configure os horários de lançamento do aplicativo](/docs/mobile-monitoring/new-relic-mobile-ios/configuration/app-launch-times-ios-apps).
