...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile > (select an app) > HTTP requests**</DoNotTranslate>: visualize suas solicitações GraphQL com base no nome personalizado de sua função.
</figcaption>
...
3. No menu à esquerda, clique em
   ...
   <DoNotTranslate>**HTTP requests**</DoNotTranslate>
...
4. No dropdown
   ...
   <DoNotTranslate>**Operation Name**</DoNotTranslate>
