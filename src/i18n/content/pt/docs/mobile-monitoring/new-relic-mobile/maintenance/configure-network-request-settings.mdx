...
Para definir essas configurações, vá para <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile > (select a mobile app) > Settings > Network settings**</DoNotTranslate>.
...
1. Em
   ...
   <DoNotTranslate>**Network settings page**</DoNotTranslate>

   , selecione a guia

   <DoNotTranslate>**Show only hostnames**</DoNotTranslate>

   .

2. Clique em

   <DoNotTranslate>**Add a hostname**</DoNotTranslate>

   .

3. Insira o nome do host `*.ecommerce.com` e clique em

   <DoNotTranslate>**Add to list**</DoNotTranslate>
...
1. Em
   ...
   <DoNotTranslate>**Status codes**</DoNotTranslate>

   .

2. Clique em

   <DoNotTranslate>**Create a status code rule**</DoNotTranslate>
...
1. Na página
   ...
   <DoNotTranslate>**Network settings**</DoNotTranslate>

   , selecione a guia

   <DoNotTranslate>**Aliases and groups**</DoNotTranslate>

   .

2. Clique em

   <DoNotTranslate>**Create an alias**</DoNotTranslate>
...
4. Insira o alias `ecommerce.com` e clique em
   ...
   <DoNotTranslate>**Save alias**</DoNotTranslate>
