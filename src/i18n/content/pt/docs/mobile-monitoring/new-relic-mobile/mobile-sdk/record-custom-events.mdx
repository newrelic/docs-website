      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td>
              Obrigatório. O tipo de evento. <DNT>**Do not**</DNT> use `$eventType` para nomear seu evento personalizado. Em vez disso, use um atributo personalizado ou o opcional `name`.
            </td>
          </tr>
