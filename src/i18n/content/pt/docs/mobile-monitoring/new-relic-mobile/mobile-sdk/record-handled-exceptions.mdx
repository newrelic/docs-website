  ...
  <TabsPages>
    ...
    <TabsPageItem id="ios">
      ...
      <Callout variant="important">
        Esta função não deve ser usada com código Swift. Use [recordError](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/record-errors/) para rastrear erros manipulados no código Swift.
      </Callout>
