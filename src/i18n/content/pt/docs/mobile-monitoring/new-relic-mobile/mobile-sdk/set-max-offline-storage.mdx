  ...
  <TabsPages>
    ...
    <TabsPageItem id="xamarin">
      <Callout variant="important">
        ...
        Para obter detalhes sobre como adicionar flags de recurso, consulte [Definir configurações de monitoramento de Mobile](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/configure-settings/#xamarin).
      </Callout>
