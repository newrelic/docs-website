...
<Tabs>
  ...
  <TabsPages>
    <TabsPageItem id="android">
      ...
      Por padrão, <InlinePopover type="mobile" />coleta um máximo de 1.000 eventos por ciclo de coleta de eventos, que tem 60 segundos de duração por padrão. Este método controla o tamanho máximo do pool de eventos armazenado na memória até o próximo ciclo de coleta. Quando o limite de tamanho do pool é atingido, o agente Android da New Relic começará a [amostrar eventos](/docs/agents/manage-apm-agents/agent-data/new-relic-events-limits-sampling), descartando alguns eventos antigos e novos, até que o pool de eventos seja transmitido com o próximo ciclo de coleta. Este método permite substituir o tamanho máximo desse pool de eventos.

      O valor padrão para o ciclo de coleta de eventos é 60 segundos. Consulte [Definir o Tempo Máximo de Buffer de Eventos](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/set-max-event-buffer-time) para alterar a duração do ciclo de coleta de eventos.
    ...
    <TabsPageItem id="ios">
      ...
      <Callout variant="important">
        Embora você possa definir o tamanho do pool de eventos maior que `1000`, o agente impõe um limite interno rigoroso aos dados de rede. No máximo **1.000 transações de rede** serão registradas e transmitidas por ciclo de coleta, independentemente do tamanho que você configurar para o pool de eventos.
      </Callout>

      O valor padrão do ciclo de coleta de eventos é 60 segundos. Consulte também [Definir o tempo máximo de buffer de eventos](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/set-max-event-buffer-time/) para alterar a duração do ciclo de coleta de eventos.
