...
import unrealPluginRecordError from 'images/newrelic_unreal_sdk_record_error.webp'
...
<Tabs>
  ...
  <TabsPages>
    <TabsPageItem id="ios">
      ...
      Essa API pega uma instância de um erro e um dicionário de atributo opcional e cria um evento `recordHandledException` . Você pode visualizar dados de eventos na interface do usuário <InlinePopover type="mobile"/>em locais como a [página<DoNotTranslate>**Handled exceptions**</DoNotTranslate> ](/docs/mobile-monitoring/mobile-monitoring-ui/crashes/handled-exceptions-analyze-trends-prevent-crashes)e a [trilha<DoNotTranslate>**Crash events**</DoNotTranslate> ](/docs/mobile-monitoring/mobile-monitoring-ui/crashes/mobile-crash-event-trail). Você também pode consultar esses dados com NRQL e mapeá-los no painel do New Relic.
