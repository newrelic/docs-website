        ...
        <tbody>
          <tr>
            <td>
              ...
              * Para configurar a quantidade de armazenamento offline, consulte [Definir tamanho máximo de armazenamento offline](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/set-max-offline-storage/#android).
