  ...
  <TabsPages>
    <TabsPageItem id="android">
      ...
      * Altere a configuração como parte da chamada inicial do agente usando o método `.with` . Por exemplo:
        ...
        ## Configurações de tempo de lançamento do aplicativo [#applaunchtime]
        ...
        ## Relatório ApplicationExitInfo [#android-applicationexitinfo-reporting]
    ...
    <TabsPageItem id="ios">
      ...
      * Swift:
        ...
        ## Configurações de endpoint de dados [#logging]
        ...
        ## Sinalizador de recurso de relatório de falhas e erros [#crashes]
        ...
        ## interação recurso flags [#interactions]
        ...
        ## Sinalizadores de recursos de rede [#networking]
        ...
        ## Configurações de endpoint do FedRAMP [#fedramp]
