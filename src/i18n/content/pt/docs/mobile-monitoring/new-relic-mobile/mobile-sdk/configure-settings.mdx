      ...
      * Altere a configuração como parte da chamada inicial do agente usando o método `.with` . Por exemplo:
      ...
      <table>
        ...
        <tbody>
          <tr>
            <td>
              Ative ou desative o relatório em segundo plano quando o aplicativo for para o estado de segundo plano. Quando ativado, o agente reporta os dados capturados enquanto o aplicativo está em segundo plano, e o [atributo`background` ](/attribute-dictionary/?event=MobileSession&attribute=background)é adicionado ao atributo de sessão.
            </td>
      ...
      <table>
        ...
        <tbody>
          <tr>
            <td>
              Ativar ou desativar a persistência de evento, o que permite ao agente capturar eventos durante cenários de encerramento forçado e saída de processo.
            </td>

            <td>
              A persistência de evento está habilitada por padrão. Para desabilitá-la, adicione o seguinte sinalizador de recurso:
      ...
      * Swift:
      ...
      <table>
        ...
        <tbody>
          <tr>
            <td>
              Ative ou desative o armazenamento de dados offline quando não houver conexão com a internet disponível. Quando um evento é adicionado enquanto a internet não está acessível pelo aplicativo, um [atributo`offline` ](/attribute-dictionary/?event=MobileSession&attribute=offline)é adicionado ao evento. Para configurar a quantidade de armazenamento offline, consulte [Definir tamanho máximo de armazenamento offline](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/set-max-offline-storage/#ios).
            </td>
    ...
    <TabsPageItem id="react">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td>
              Ativar ou desativar o relato automático de erros de JavaScript como [eventos`MobileJSError` ](/attribute-dictionary/?event=MobileJSError). Quando ativado, o agente captura erros de JavaScript não tratados e os relata sem nenhuma instrumentação adicional.

              O valor padrão é `true`. Disponível para a versão 1.9.0 ou superior do agente React Native.
            </td>
