...
<Steps>
  ...
  <Step>
    ...
    2. Adicione as seguintes alterações para aplicar o Gradle Pplugin:
    ...
    Ou, se seu projeto estiver usando a maneira tradicional de aplicar o plug-in, adicione este trecho:
