...
<Steps>
  <Step>
    ...
    1. Acesse
       ...
       e conclua as etapas de instrumentação na interface.

    2. Em

       <DoNotTranslate>**Step 4**</DoNotTranslate>

       na interface, copie o(s) token(s) do aplicativo (um para iOS e Android, se aplicável).
  </Step>
  ...
  <Step>
    ...
    5. Para vincular automaticamente o pacote, reconstrua seu projeto:
...
<CollapserGroup>
  <Collapser
    id="v1.2.0"
    title="Agente capacitor v1.2.0 e superior"
  >
  ...
  <Collapser
    id=" v1.1.1"
    title="Agente capacitor v1.1.1 e inferior"
  >
    ...
    2. Clique em <DoNotTranslate>**Query builder**</DoNotTranslate>.
    ...
    4. Clique em <DoNotTranslate>**Add to dashboard**</DoNotTranslate>.<img title="Query builder" alt="This is an image of a sample query in the Query builder." src={mobileQueryExample}/>

       <figcaption>
         <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Query builder**</DoNotTranslate>: use <DoNotTranslate>**Query builder**</DoNotTranslate> para criar um painel personalizado para rastrear erros de JavaScript do seu aplicativo Capacitor.
       </figcaption>
