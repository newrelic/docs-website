...
<Steps>
  ...
  <Step>
    ### (Somente Ionic Cordova) Configure sua frameworkIonic [#ionic]

    Se você estiver usando uma [frameworkiônica](https://ionicframework.com/docs/v1/guide/preface.html), adicione isto ao diretório do projeto Cordova:
