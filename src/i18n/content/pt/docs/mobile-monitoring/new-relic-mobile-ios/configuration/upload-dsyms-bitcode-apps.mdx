...
Se você vir um código de máquina ilegível na [página<DoNotTranslate>**Crashes**</DoNotTranslate> ](/docs/mobile-monitoring/mobile-monitoring-ui/crashes/mobile-apps-crashes-dashboard), seus arquivos dSYM podem não ter sido carregados corretamente. Em alguns casos, pode ser necessário fazer [upload manual de arquivos dSYM](#manual-dsym).
...
* <DoNotTranslate>**Banner notification**</DoNotTranslate>
  ...
  <DoNotTranslate>[**Crash report**](/docs/mobile-monitoring/mobile-monitoring-ui/crashes/mobile-apps-crash-report-dashboard)</DoNotTranslate>
...
* <DoNotTranslate>**Upload prompt**</DoNotTranslate>

  : na página

  <DoNotTranslate>**Crash type summary**</DoNotTranslate>

  você será automaticamente solicitado a fazer upload de um arquivo dSYM se ele estiver faltando.

* <DoNotTranslate>**Machine code**</DoNotTranslate>

  : o stack trace de falhas na página

  <DoNotTranslate>**Crash report**</DoNotTranslate>
...
3. Selecione uma falha específica na lista
   ...
   <DoNotTranslate>**Crash types**</DoNotTranslate>

   .

4. Clique em

   <DoNotTranslate>**Upload dSYM**</DoNotTranslate>
...
<CollapserGroup>
  ...
  >
    ...
    2. Faça upload do arquivo zip dSYM usando o seguinte comando:
       ...
       * Para <DoNotTranslate>**US accounts**</DoNotTranslate>:
       ...
       * Para <DoNotTranslate>**EU accounts**</DoNotTranslate>:
