...
Esses procedimentos para configurar seu aplicativo iOS/tvOS com CocoaPods e Objective-C também aparecem na página <DoNotTranslate>**Get Started**</DoNotTranslate> do New Relic.
...
Esses procedimentos para configurar seu aplicativo iOS/tvOS com CocoaPods e Swift também aparecem na página <DoNotTranslate>**Get Started**</DoNotTranslate> do New Relic.

1. No <DoNotTranslate>**Podfile**</DoNotTranslate> do seu projeto, adicione a seguinte linha:
