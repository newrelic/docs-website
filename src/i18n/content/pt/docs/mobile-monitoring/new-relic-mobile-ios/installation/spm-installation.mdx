...
1. Selecione <DoNotTranslate>**File > Swift Packages > Add Package Dependency...**</DoNotTranslate>.
...
3. Selecione o produto do pacote NewRelic, selecione seu destino e selecione <DoNotTranslate>**Finish**</DoNotTranslate>.
...
5. Com base na versão do seu agente iOS, adicione o script de compilação abaixo ao <DoNotTranslate>**Build Phases**</DoNotTranslate> do seu destino. Certifique-se de que o script seja o último script de construção e substitua `APP_TOKEN` pelo [token do seu aplicativo](/docs/mobile-apps/viewing-your-application-token).
