...
<figcaption>
  De <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com) > All capabilities > AI monitoring > Drop filters**</DoNotTranslate>: para criar um filtro de descarte, selecione o evento que pode conter dados confidenciais e escolha o Regex que corresponde ao tipo de dados que você deseja descartar.
</figcaption>
