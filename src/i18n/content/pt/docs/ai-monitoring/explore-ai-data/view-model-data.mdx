...
<figcaption>
  Vá para **<DoNotTranslate>[one.newrelic.com](https://one.newrelic.com) > All Capabilities > AI monitoring</DoNotTranslate>**: no AI Monitoring, você pode escolher entre inventário de modelo ou comparação de modelo.
</figcaption>
...
<figcaption>
  Acesse **<DoNotTranslate>[one.newrelic.com](https://one.newrelic.com) > All Capabilities > AI monitoring > Model inventory</DoNotTranslate>**: Visualize dados sobre interação com seu modelo de IA.
</figcaption>

A página <DoNotTranslate>model inventory</DoNotTranslate> fornece insights sobre o desempenho geral e o uso do seu modelo de IA. Você pode analisar dados de chamadas feitas ao seu modelo para entender como o modelo de IA afeta seu aplicativo de IA.
...
<figcaption>
  Vá para **<DoNotTranslate>[one.newrelic.com](https://one.newrelic.com) > All Capabilities > AI monitoring > Model inventory > Errors</DoNotTranslate>**: visualizar dados sobre erros do modelo de IA.
</figcaption>
...
<figcaption>
  Vá para **<DoNotTranslate>[one.newrelic.com](https://one.newrelic.com) > All Capabilities > AI monitoring > Model inventory > Performance</DoNotTranslate>**: visualize dados sobre o desempenho do seu modelo de IA.
</figcaption>
...
<figcaption>
  Vá para **<DoNotTranslate>[one.newrelic.com](https://one.newrelic.com) > All Capabilities > AI monitoring > Model inventory > Cost</DoNotTranslate>**: visualize dados sobre o custo do seu modelo de IA.
</figcaption>
...
<figcaption>
  Vá para **<DoNotTranslate>[one.newrelic.com](https://one.newrelic.com) > All Capabilities > AI monitoring > Model comparison</DoNotTranslate>**: compare dados sobre os diferentes modelos de IA em sua stack.
</figcaption>
...
<figcaption>
  Vá para **<DoNotTranslate>[one.newrelic.com](https://one.newrelic.com) > All Capabilities > AI monitoring > Model comparison</DoNotTranslate>**: Compare o desempenho entre diferentes modelos de IA em sua stack.
</figcaption>
...
<figcaption>
  Vá para **<DoNotTranslate>[one.newrelic.com](https://one.newrelic.com) > All Capabilities > AI monitoring > Model comparison</DoNotTranslate>**: compare o custo entre os diferentes modelos de IA em sua stack.
</figcaption>
