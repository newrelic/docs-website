...
<Steps>
  ...
  <Step>
    ...
    <CollapserGroup>
      ...
      >
        Abra seu aplicativo da web em <DNT>**Browser**</DNT>. Abra a visualização <DNT>**Errors**</DNT> no menu esquerdo e verifique se você pode ver erros de JavaScript. Se o seu aplicativo não receber muito tráfego, talvez seja necessário voltar 24 horas ou mais para ver os erros.<img src={omaOeScBrowserErrors} alt="Browser JavaScript Errors" title="Browser JavaScript Errors"/>
      </Collapser>
    ...
    <CollapserGroup>
      <Collapser
        ...
        title="Através da interface"
      >
        Para verificar se você está capturando o registro de eventos, vá para a guia <DNT>**JS Errors**</DNT> . Verifique vários erros diferentes para verificar se o log de eventos aparece.<img src={omaOeScBrowserErrorLog} alt="Browser JavaScript Error Logs" title="Browser JavaScript Error Logs"/>
      </Collapser>
    </CollapserGroup>
  ...
  <Step>
    ...
    <CollapserGroup>
      <Collapser
        ...
        title="Através da interface"
      >
        Verifique a interface do usuário <DNT>**Page views**</DNT> do seu aplicativo selecionando-a no menu à esquerda. Se o que você vê se parece muito com a captura de tela abaixo, anote e siga as instruções neste guia sobre como resolver o problema.<img src={omaOeScBrowserGroupedPageViews} alt="Browser Page URL Grouping" title="Browser Page URL Grouping"/>
      </Collapser>
  ...
  <Step>
    ...
    <CollapserGroup>
      <Collapser
        ...
        title="Através da interface"
      >
        Verifique o agrupamento AJAX do seu aplicativo selecionando-o no menu esquerdo e agrupando por <DNT>**groupedRequestUrl**</DNT>. Se o que você vê se parece muito com a captura de tela abaixo, anote e siga as instruções neste guia sobre como resolver o problema.<img src={omaOeScBrowserGroupedAjaxRequests} alt="AJAX Grouping" title="AJAX Grouping"/>
      </Collapser>
