...
<CollapserGroup>
  ...
  >
    ...
    <DoNotTranslate>**Best practices:**</DoNotTranslate>\* siga o [guia de gerenciamento de qualidade de alerta](/docs/tutorial-create-alerts/manage-alert-quality/) para ajudá-lo a entender o comportamento de seus serviços usando <InlinePopover type="alerts"/>para ajudar a melhorar a prestação de serviços.
  </Collapser>
</CollapserGroup>
...
* Guias de instrumentação:
  ...
  * [.LÍQUIDO](/docs/apm/agents/net-agent/custom-instrumentation/introduction-net-custom-instrumentation)
