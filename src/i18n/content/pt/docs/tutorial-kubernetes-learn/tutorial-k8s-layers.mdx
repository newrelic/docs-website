...
* <DoNotTranslate>**The cluster**</DoNotTranslate>: representa todo o sistema Kubernetes. O cluster contém múltiplas implantações, que por sua vez abrigam muitos pods. Cada pod mantém seus serviços e aplicativos individuais.
* <DoNotTranslate>**The orchestrated**</DoNotTranslate>: estes são os elementos principais de um sistema Kubernetes. Os componentes orquestrados consistem em implantação inteira que gira o pod para cima e para baixo conforme necessário.
* <DoNotTranslate>**The services and applications**</DoNotTranslate>: serviços e aplicativos são os cavalos de batalha do sistema Kubernetes. Dentro de um sistema Kubernetes, cada pod abriga um ou mais serviços e aplicativos. Os serviços e aplicativos fornecem a funcionalidade essencial que orienta o propósito do sistema. Pode ser computação, um aplicativo da web ou qualquer outro aplicativo.
...
<Steps>
  <Step>
    ## Acesse o dashboardde visão geral do Kubernetes

    Vá para <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Kubernetes > Overview Dashboard**</DoNotTranslate>. Certifique-se de rolar para baixo para ver todos os gráficos disponíveis para você.
