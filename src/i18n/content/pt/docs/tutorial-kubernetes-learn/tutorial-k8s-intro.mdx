  ...
  <Step>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          <td>
            [Instalação guiada (JP)](https://onenr.io/0oQDrE83ZRy)
          </td>

          <td>
            Use isto se a sua organização New Relic usar o data center [JP](/docs/using-new-relic/welcome-new-relic/get-started/our-eu-us-region-data-centers) e você não precisar dos dashboards e alertas bônus do início rápido.
          </td>
        </tr>
