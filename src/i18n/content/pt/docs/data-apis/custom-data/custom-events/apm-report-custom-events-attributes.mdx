...
<CollapserGroup>
  ...
  <Collapser className="freq-link" id="php-att" title="PHP">
    ...
    Por padrão, o número máximo de eventos personalizados gravados por minuto é 30.000. Você pode aumentar até 100.000 por meio do [newrelic.custom\_events.max\_samples\_stored](/docs/apm/agents/php-agent/configuration/php-agent-configuration/#inivar-custom-events-maxsamples) configuração de configuração.
