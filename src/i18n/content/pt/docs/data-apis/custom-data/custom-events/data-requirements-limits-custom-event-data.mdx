...
* <InlinePopover type="apm">[](/docs/insights/insights-data-sources/custom-data/insert-custom-events-new-relic-apm-agents)</InlinePopover>
  ...
  [API do agente](/docs/insights/insights-data-sources/custom-data/insert-custom-events-new-relic-apm-agents)
...
* [API do agente e ](/docs/insights/insights-data-sources/custom-data/insert-data-via-new-relic-browser)
    ...
    <tr>
      ...
      <td>
        ...
        * Para evento enviado via agente: 255 caracteres
          ...
          Atributo total máximo por evento: 254. <DoNotTranslate>**Exception:**</DoNotTranslate> Se você usar uma API de agente APM, o máximo será 64.
