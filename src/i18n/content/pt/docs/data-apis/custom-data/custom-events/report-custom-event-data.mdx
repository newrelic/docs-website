...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Use a API do browser do agente para [enviar evento personalizado](/docs/data-apis/custom-data/custom-events/report-browser-monitoring-custom-events-attributes) e [definir atributo personalizado](/docs/browser/new-relic-browser/browser-agent-spa-api/setcustomattribute-browser-agent-api).
