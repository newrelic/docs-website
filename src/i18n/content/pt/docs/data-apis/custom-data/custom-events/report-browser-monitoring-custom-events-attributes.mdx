...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        `PageAction` eventos são relatados a cada 30 segundos, com um máximo de 120 eventos por ciclo de coleta de 30 segundos, por browser. Depois que o limite de 120 eventos for atingido, eventos adicionais não serão capturados para esse ciclo.
      </td>
    </tr>
...
<CollapserGroup>
  <Collapser
    ...
    title={<>Usar <Link to="/docs/browser/new-relic-browser/browser-agent-spa-api/newrelicsetcustomattribute-browser-agent-api"><InlineCode>setCustomAttribute</InlineCode></Link> chamada de API do browser</>}
  >
