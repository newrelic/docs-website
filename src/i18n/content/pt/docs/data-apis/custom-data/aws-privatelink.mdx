  ...
  <TabsPages>
    ...
    <TabsPageItem id="us-endpoints-use2">
      ...
      <Callout variant="important">
        Revise as seguintes restrições ao configurar o nome do host `api.newrelic.com`, `identity-api.newrelic.com`, `infrastructure-command-api.newrelic.com` ou `synthetics-horde.nr-data.net` :
