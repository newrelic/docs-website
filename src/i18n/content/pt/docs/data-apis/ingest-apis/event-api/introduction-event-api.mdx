...
<CollapserGroup>
  <Collapser id="ruby-example" title="Chamando a API de evento de um aplicativo Ruby">
...
<Callout variant="tip">
  Se a sua organização hospeda dados no data center da UE ou do JP, certifique-se de estar usando os endpoints regionais adequados. Consulte os [endpoints da região da UE](/docs/accounts/accounts-billing/account-setup/choose-your-data-center/#eu-endpoints) ou os [endpoints da região do JP](/docs/accounts/accounts-billing/account-setup/choose-your-data-center/#jp-endpoints).
</Callout>
...
<CollapserGroup>
  <Collapser id="json-guidelines" title="Diretrizes de formato JSON">
  ...
  <Collapser id="json-example" title="Exemplo JSON">
  ...
  <Collapser id="limits" title="Limites e caracteres restritos">
...
<CollapserGroup>
  <Collapser id="numberone" title="Exemplo Linux/bash">
    ```bash
  ...
  <Collapser id="numbertwo" title="Exemplo de Windows/PowerShell">
    ```powershell
...
<CollapserGroup>
  <Collapser id="success" title="Código de resposta de sucesso">
    <table>
      <thead>
        <tr>
  ...
  <Collapser id="errors-submission" title="Erros de envio">
  ...
  <Collapser id="errors-parsing" title="Erros de análise">
