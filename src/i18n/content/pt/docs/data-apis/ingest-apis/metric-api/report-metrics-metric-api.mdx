...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <DNT>**Recommended**</DNT>. Este deve ser um dos [tipos de métrica suportados](/docs/telemetry-data-platform/ingest-manage-data/understand-data/metric-data-type). Se você não especificar um tipo, o padrão será `gauge`.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <DNT>**Recommended**</DNT>. Um mapa de pares de valores principais associados a esta métrica específica. Os valores podem ser strings, números JSON ou booleanos. As chaves diferenciam maiúsculas de minúsculas e devem ter menos de 255 caracteres.
      </td>
    </tr>
  </tbody>
</table>
