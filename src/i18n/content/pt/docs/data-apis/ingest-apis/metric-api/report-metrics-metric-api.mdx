...
<Callout variant="tip">
  Se a sua organização hospeda dados no data center da UE ou JP, certifique-se de usar o endpoint regional correto. Para esta API:

  * Endpoint da UE: `https://metric-api.eu.newrelic.com/metric/v1`
  * Endpoint JP: `https://metric-api.jp.nr-data.net/metric/v1`
</Callout>
