...
* Uma New Relic <InlinePopover type="licenseKey" />para a conta para a qual você deseja relatar dados.
...
* Para os EUA (padrão), `https://security-api.newrelic.com/security/v1`
* Para a UE, `https://security-api.service.eu.newrelic.com/security/v1`
* Para o JP, `https://security-api.service.jp.newrelic.com/security/v1`
