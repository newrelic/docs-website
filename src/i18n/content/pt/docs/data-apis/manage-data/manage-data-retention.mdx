...
Para saber mais sobre planos e custos para alterar a retenção, consulte [Opções de dados: Data Plus e original](https://docs.newrelic.com/docs/accounts/accounts-billing/new-relic-one-pricing-billing/data-ingest-billing/#upgrade-data-plus).
...
* **Retenção efetiva:** Esta é a quantidade de tempo que os dados são retidos atualmente para um tipo de dados. Para que o usuário possa editar isso, a organização (conta) precisa estar na [versão Pro ou superior](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing/#how-pricing-works).

Se o seu Billing User não conseguir realizar nenhuma dessas duas tarefas, entre em contato com o suporte ou com a equipe da sua conta, se houver.
...
Se o seu usuário não conseguir realizar nenhuma dessas duas tarefas depois de consultar os detalhes acima, entre em contato com o suporte ou com a equipe da sua conta, se houver.
