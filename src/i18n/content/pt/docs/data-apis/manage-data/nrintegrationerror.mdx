...
<CollapserGroup>
  <Collapser
    id="simple-query"
    title="Consulta de problemas de API de eventos"
  >
  ...
  <Collapser
    id="simple-query"
    title="Consulta de problemas de API métrica"
  >
  ...
  <Collapser
    id="limit-query"
    title="Consulta relacionada a limites"
  >
  ...
  <Collapser
    id="trace-data"
    title="Consulta de problemas distributed tracing"
  >
  ...
  <Collapser
    id="time-based-query"
    title="Consulta de problemas ao longo do tempo"
  >
