...
Usamos a seguinte consulta para criar este dashboard. Para criar um dashboard como este no New Relic, selecione <DoNotTranslate>**Dashboards**</DoNotTranslate> e depois <DoNotTranslate>**Create a dashboard**</DoNotTranslate>. Em seguida, adicione um novo gráfico para cada consulta que você deseja monitor regularmente. Os três limites métricos incluídos nestas consultas são descritos em seção separada, abaixo.
...
<CollapserGroup>
  <Collapser
    className="freq-link"
    id=""
    title="Limites de consumo de recursos em %"
  >
    ```
  ...
  <Collapser
    className="freq-link"
    id=""
    title="% máxima de consumo em uma hora"
  >
    ```
  ...
  <Collapser
    className="freq-link"
    id=""
    title="API APM faz solicitação de evento de transação do agente por minuto"
  >
    ```
  ...
  <Collapser
    className="freq-link"
    id=""
    title="API trace com linha de limite"
  >
    ```
  ...
  <Collapser
    className="freq-link"
    id=""
    title="NrIntegrationError por limite"
  >
    ```
  ...
  <Collapser
    className="freq-link"
    id=""
    title="Limites de múltiplas contas (somente em gráficos de série temporal)"
  >
    ...
    2. Clique em <DoNotTranslate>**Add another query**</DoNotTranslate>.
  ...
  <Collapser
    className="freq-link"
    id=""
    title="Lista de limites e NrIntegrationError"
  >
    ```
...
<CollapserGroup>
  <Collapser
    className="freq-link"
    id=""
    title="Limites facetados por LimitName e com escopo definido por Timewindow"
  >
    ```
  ...
  <Collapser
    className="freq-link"
    id=""
    title="Alerta sobre um único limite"
  >
    ```
  ...
  <Collapser
    className="freq-link"
    id=""
    title="Alerta sobre limite de impacto facetado por dataType, impacto, recurso e motivo"
  >
    ```
  ...
  <Collapser
    className="freq-link"
    id=""
    title="Alerta sobre o impacto de um único dataType"
  >
    ```
