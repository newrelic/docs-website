...
<Callout variant="important">
  Desde fevereiro de 2026, as regras de descarte direcionadas a eventos de infraestrutura em `SystemSample`, `ProcessSample`, `NetworkSample` e `StorageSample` também descartarão corretamente os dados agregados.
</Callout>
