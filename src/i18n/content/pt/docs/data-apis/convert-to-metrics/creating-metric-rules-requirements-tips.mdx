  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <DoNotTranslate>**Example:**</DoNotTranslate> Se você quiser criar uma métrica chamada `foo.count` que conte a transação chamada `foo`, o NRQL ficaria assim:
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <DoNotTranslate>**Example:**</DoNotTranslate> Se você incluísse a zona de disponibilidade no nome da sua métrica, isso significaria que, para essa métrica, você não conseguiria ver resultados em todas as zonas de disponibilidade.
      </td>
    </tr>
