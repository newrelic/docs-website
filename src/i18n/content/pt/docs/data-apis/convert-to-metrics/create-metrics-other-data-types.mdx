...
<CollapserGroup>
  <Collapser id="api-examoke" title="Exemplo de solicitação da API NerdGraph">
  ...
  <Collapser id="example-response" title="Exemplo de resposta da API NerdGraph">
...
<CollapserGroup>
  <Collapser id="summary" title="Exemplo de métrica de resumo">
  ...
  <Collapser id="uniqueCount" title="Exemplo de métrica de contagem">
  ...
  <Collapser id="distribution" title="Exemplo de métrica de distribuição">
