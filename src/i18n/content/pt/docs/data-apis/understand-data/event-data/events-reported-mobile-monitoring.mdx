  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        As exceções ficarão visíveis na consulta deste evento e na [página da interface<DoNotTranslate>**Handled exceptions**</DoNotTranslate> ](/docs/mobile-monitoring/mobile-monitoring-ui/crashes/handled-exceptions-analyze-trends-prevent-crashes), incluindo stack trace.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Não existe lista de atributos para este tipo de evento por se tratar de um evento personalizado; atributo incluirá o [atributo da sessão](#session-list) e qualquer [atributo personalizado que você adicionar](/docs/mobile-monitoring/new-relic-mobile/maintenance/add-custom-data-new-relic-mobile).
      </td>
    </tr>
  </tbody>
</table>
