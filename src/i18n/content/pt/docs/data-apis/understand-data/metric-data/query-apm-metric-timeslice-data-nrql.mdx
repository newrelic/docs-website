...
A New Relic reporta [métricas de diversas maneiras](/docs/using-new-relic/data/understand-data/new-relic-data-types#metrics). Uma variedade de dados métricos que chamamos de <DoNotTranslate>**metric timeslice data**</DoNotTranslate>; este é o tipo de dados usado para gerar muitos dos gráficos em APM, <InlinePopover type="mobile"/>e browser (para mais detalhes, veja [métrica de fração de tempo data](/docs/using-new-relic/data/understand-data/new-relic-data-types#timeslice-data)).
