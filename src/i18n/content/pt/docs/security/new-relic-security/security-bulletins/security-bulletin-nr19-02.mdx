---
title: Boletim de Segurança NR19-02
tags:
  - Security
...
<DoNotTranslate>**Release date:**</DoNotTranslate> 1º de abril de 2019

<DoNotTranslate>**Vulnerability identifier:**</DoNotTranslate> NR19-02
...
* Defina `attributed.enabled` como `false` para evitar que todos os atributos sejam coletados.
* [Atualize para o agente New Relic Node.js mais recente.](/docs/agents/nodejs-agent/installation-configuration/upgrade-nodejs-agent)
