---
title: New Relic aconselha atualização do agente .NET para clientes que utilizam Microsoft Extensions Logging com encaminhamento de logs habilitado
tags:
  - Security
...
Esta orientação se aplica ao usuário do agente .NET versões 9.7.0 a 10.0.0 que usam a framework de criação de log MEL. O agente .NET que usa a estrutura de log Log4net, Serilog e NLog não é afetado.
...
* <DoNotTranslate>**Technical Links**</DoNotTranslate>

  : [Atualizando o agente .NET](/docs/apm/agents/net-agent/installation/update-net-agent/)

* <DoNotTranslate>**Workarounds**</DoNotTranslate>

  : Clientes afetados que não conseguem atualizar seu agente .NET para 10.1.0 ou mais tarde neste momento pode [desativar o encaminhamento de logs](/docs/logs/logs-context/disable-automatic-logging/).
