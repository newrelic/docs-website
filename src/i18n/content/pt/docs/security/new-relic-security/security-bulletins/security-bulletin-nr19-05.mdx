---
title: Boletim de Segurança NR19-05
tags:
  - Security
...
<DoNotTranslate>**Release date:**</DoNotTranslate> 26 de agosto de 2019
...
* Utilize consulta parametrizada, isso também ajuda a evitar [vulnerabilidades de injeção SQL](https://docs.microsoft.com/en-us/sql/relational-databases/security/sql-injection).
