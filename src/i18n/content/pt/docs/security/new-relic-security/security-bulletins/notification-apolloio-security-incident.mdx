...
Siga [discuss.newrelic.com/c/security-notifications](https://discuss.newrelic.com/c/security-notifications) para obter informações adicionais sobre este incidente.
