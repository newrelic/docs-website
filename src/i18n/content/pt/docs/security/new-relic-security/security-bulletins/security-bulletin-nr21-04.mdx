---
title: Apache Log4j Critical vulnerabilidades CVE-2021-44228 - chamadas por minuto
tags:
  - Security
...
<DoNotTranslate>**Vulnerability identifier:**</DoNotTranslate> NR21-04

<DoNotTranslate>**Priority:**</DoNotTranslate> Crítico
...
<CollapserGroup>
  <Collapser
    id="357-update"
    title="Atualizei para chamadas por minuto 3.0.55 já. Preciso atualizar para 3.0.58?"
  >
