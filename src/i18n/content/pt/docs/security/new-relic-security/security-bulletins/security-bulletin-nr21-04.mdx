---
title: Apache Log4j Critical vulnerabilidades CVE-2021-44228 - CPM
tags:
  - Security
...
Esta etapa corrigirá apenas seu minion privado New Relic Containerized (chamadas por minuto). Também pode ser necessário atualizar seu agente Java do New Relic. Consulte a [NR21-03](/docs/security/new-relic-security/security-bulletins/security-bulletin-nr21-03) para mais informações.
...
* [Fórum de suporte New Relic](https://support.newrelic.com/s/hubtopic/aAX8W0000008ckb/log4j-zero-day-vulnerability-and-the-new-relic-java-agent)

## Perguntas frequentes [#faq]

<CollapserGroup>
  <Collapser id="357-update" title="Atualizei para chamadas por minuto 3.0.55 já. Preciso atualizar para 3.0.58?">
    A Apache Foundation divulgou vulnerabilidades adicionais na framework log4j (CVE-2021-45046 e CVE-2021-45105) e informa que log4j v2.16.0 não é proteção suficiente contra exploração. chamadas por minuto 3.0.58 e versões posteriores são as únicas versões de chamadas por minuto disponíveis com log4j 2.17.0.
  </Collapser>
</CollapserGroup>

## Histórico de publicação [#history]
