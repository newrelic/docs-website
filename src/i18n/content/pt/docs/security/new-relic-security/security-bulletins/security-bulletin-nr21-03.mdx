...
<DoNotTranslate>**Versions affected:**</DoNotTranslate> Todas as versões do agente entre (a) 4.12.0 e 6.5.1; e (b) 7.0.0 e 7.4.1

<DoNotTranslate>**Fix versions:**</DoNotTranslate> 6.5.2, 6.5.3, 6.5.4, 7.4.2, 7.4.3 e 7.5.0
...
<DoNotTranslate>**Note:**</DoNotTranslate> Esta solução alternativa é recomendada apenas como uma solução temporária até que você possa atualizar a versão do seu agente.
...
<CollapserGroup>
  ...
  >
    As informações da versão do agente são exibidas na <DoNotTranslate>**Environment**</DoNotTranslate> página New Relic dashboarddo do One . Consulte nossa [página de documentos](/docs/apm/agents/manage-apm-agents/troubleshooting/get-environment-data-about-your-apm-app) para obter mais informações.
  </Collapser>
