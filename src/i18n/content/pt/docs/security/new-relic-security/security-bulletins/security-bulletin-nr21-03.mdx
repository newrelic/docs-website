...
<CollapserGroup>
  ...
  >
    As informações da versão do agente são exibidas na <DoNotTranslate>**Environment**</DoNotTranslate> página Dashboard New Relic One . Consulte nossa [página de documentos](/docs/apm/agents/manage-apm-agents/troubleshooting/get-environment-data-about-your-apm-app) para obter mais informações.
  </Collapser>
