---
title: Software seguro ciclo de vida de desenvolvimento
tags:
  - Security
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Padrões e práticas de codificação seguras
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Revisão de código, revisão de segurança, análise de código estático, análise de composição, cálculo aplicar hash, código assinado
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Hacker One e o programa de divulgação coordenado da New Relic, verificações regulares, testes de penetração de terceiros
      </td>
    </tr>
  </tbody>
</table>
...
Cada engenheiro de produto recebe treinamento de codificação segura que inclui tópicos como o [top 10 do OWASP](https://owasp.org/www-project-top-ten/), limpeza de entrada e uso da estrutura e processo seguros já implementados na New Relic. Na fase de construção a equipe de engenharia implementa recursos de segurança apropriados no projeto seguindo os padrões de codificação segura da New Relic.
