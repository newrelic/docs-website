...
<CollapserGroup>
  ...
  <Collapser id="step2-enable-additional-metrics-otelcol" title="(Opcional) Habilitar métricas adicionais">
...
<CollapserGroup>
  ...
  <Collapser id="plus-server-zone" title="Zonas do servidor HTTP">
    <Callout variant="important">
      **Nota:** Estas métricas estão desativadas por padrão. Para habilitá-las, consulte [(Opcional) Habilitar métricas adicionais](#step2-enable-additional-metrics-otelcol) para o OpenTelemetry Collector Contrib.
    </Callout>
