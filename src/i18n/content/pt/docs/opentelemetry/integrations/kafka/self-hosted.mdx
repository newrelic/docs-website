    ...
    <TabsPageItem id="java-agent">
      ...
      <Steps>
        ...
        <Step>
          ...
          | `NEW_RELIC_OTLP_ENDPOINT`          | Endpoint de ingestão OTLP. Use `https://otlp.nr-data.net:4317` para a região dos EUA, `https://otlp.eu01.nr-data.net:4317` para a região da UE ou `https://otlp.jp.nr-data.net:4317` para a região do JP. Para outras configurações, consulte [Configure seu endpoint OTLP](/docs/opentelemetry/best-practices/opentelemetry-otlp/#configure-endpoint-port-protocol). |
        </Step>
