          ...
          <CollapserGroup>
            <Collapser id="helm-nrdot" title="Usando o NRDOT Collector (recomendado)">
              ...
              **Parâmetro de configuração**
              ...
              | `resources.limits` e `resources.requests`                                                                  | Adjust according to your workload needs                                                                   |
            </Collapser>
    ...
    <CollapserGroup>
      <Collapser id="configure-log-collection-strimzi" title="Configure a coleta de logs">
        ...
        **Parâmetro de configuração**
        ...
        | Multiple broker receivers                             | Para múltiplos brokers, crie receptores `filelog` separados (por exemplo, `filelog/kafka_broker_1`, `filelog/kafka_broker_2`) com seus respectivos IDs de broker                                                                                                                                                                                    |
...
| Registro | `Log`          | Logs from producer and consumer applications (via OTel Java agent) and broker logs collected via the optional log forwarding step |
