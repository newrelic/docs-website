...
/\* ### 3. Serviços de terceiros Ideal para: Monitoramento focado em integração 1. Vá para &lt;DNT&gt;\*\*\[one.newrelic.com]\(https\://one.newrelic.com) &gt; All capabilities &gt; Infrastructure &gt; Third-party services\*\*&lt;/DNT&gt; 2. Select &lt;DNT&gt;\*\*Kafka (OpenTelemetry)\*\*&lt;/DNT&gt; &gt; &lt;DNT&gt;\*\*OTel Kafka Dashboard\*\*&lt;/DNT&gt; &lt;img title=&quot;Serviços de terceiros OTel Kafka&quot; alt=&quot;Visualização de serviços de terceiros mostrando a integração do Kafka (OpenTelemetry)&quot; src=&quot;/images/infrastructure\_screenshot-crop\_otel-kafka-third-party-integrations.webp&quot; /&gt; \*/
...
2. Pesquisar por <DNT>**&quot;OTel Kafka Dashboard&quot;**</DNT>

<img title="OTel Kafka Dashboard" alt="Pre-built dashboard showing Kafka cluster health, network throughput, and broker metrics" src="/images/otel-kafka-prebuilt-dashboards.webp" />
...
<CollapserGroup>
  <Collapser id="cluster-overview-queries" title="Visão geral do cluster">
    Obtenha estatísticas de cluster de alto nível:
  ...
  <Collapser id="cluster-health-queries" title="Integridade do cluster">
    Acompanhe a integridade geral do cluster e o status da partição:
...
1. Vá para [one.newrelic.com](https://one.newrelic.com) &gt; Dashboards

2. Clique em &quot;Create a dashboard&quot;
...
* **[Criar condições de alerta NRQL](/docs/alerts/create-alert/create-alert-condition/create-nrql-alert-conditions/)** - Configure o monitoramento proativo
* **[Tutorial NRQL](/docs/query-your-data/nrql-new-relic-query-language/get-started/introduction-nrql-new-relics-query-language)** - Aprenda técnicas avançadas de consulta