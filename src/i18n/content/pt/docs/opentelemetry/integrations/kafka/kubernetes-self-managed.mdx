            ...
            <TabsPages>
              <TabsPageItem id="helm">
                **Passo 1. Criar segredo de credenciais da New Relic**
                ...
                <CollapserGroup>
                  <Collapser id="secret-us" title="Região dos EUA (padrão)">
                    ```bash
              ...
              <TabsPageItem id="manifest">
                **Passo 1. Criar segredo de credenciais da New Relic**
                ...
                <CollapserGroup>
                  <Collapser id="manifest-secret-us" title="Região dos EUA (padrão)">
                    ```bash
                    kubectl create secret generic newrelic-otlp-secret \
                      --namespace newrelic \
                      --from-literal=NEW_RELIC_LICENSE_KEY='your-license-key-here' \
            ...
            <TabsPages>
              <TabsPageItem id="helm-prom">
                ...
                **Passo 1. Criar segredo de credenciais da New Relic**
                ...
                <CollapserGroup>
                  <Collapser id="secret-us-prometheus" title="Região dos EUA (padrão)">
                    ```bash
                    kubectl create secret generic newrelic-otlp-secret \
                      --namespace newrelic \
                      --from-literal=NEW_RELIC_LICENSE_KEY='your-license-key-here' \
              ...
              <TabsPageItem id="manifest-prom">
                ...
                **Passo 1. Criar segredo de credenciais da New Relic**
                ...
                <CollapserGroup>
                  <Collapser id="manifest-secret-us-prometheus" title="Região dos EUA (padrão)">
                    ```bash
                    kubectl create secret generic newrelic-otlp-secret \
                      --namespace newrelic \
                      --from-literal=NEW_RELIC_LICENSE_KEY='your-license-key-here' \
