            ...
            <TabsPages>
              <TabsPageItem id="helm">
                **Passo 1. Criar segredo de credenciais da New Relic**
                ...
                <CollapserGroup>
                  <Collapser id="secret-us" title="US region (default)">
                    ```bash
              ...
              <TabsPageItem id="manifest">
                **Passo 1. Criar segredo de credenciais da New Relic**
                ...
                <CollapserGroup>
                  <Collapser id="manifest-secret-us" title="US region (default)">
                    ```bash
                    kubectl create secret generic newrelic-otlp-secret \
                      --namespace newrelic \
                      --from-literal=NEW_RELIC_LICENSE_KEY='your-license-key-here' \
            ...
            <TabsPages>
              <TabsPageItem id="helm-prom">
                ...
                **Passo 1. Criar segredo de credenciais da New Relic**
                ...
                <CollapserGroup>
                  <Collapser id="secret-us-prometheus" title="US region (default)">
                    ```bash
                    kubectl create secret generic newrelic-otlp-secret \
                      --namespace newrelic \
                      --from-literal=NEW_RELIC_LICENSE_KEY='your-license-key-here' \
              ...
              <TabsPageItem id="manifest-prom">
                ...
                **Passo 1. Criar segredo de credenciais da New Relic**
                ...
                <CollapserGroup>
                  <Collapser id="manifest-secret-us-prometheus" title="US region (default)">
                    ```bash
                    kubectl create secret generic newrelic-otlp-secret \
                      --namespace newrelic \
                      --from-literal=NEW_RELIC_LICENSE_KEY='your-license-key-here' \
