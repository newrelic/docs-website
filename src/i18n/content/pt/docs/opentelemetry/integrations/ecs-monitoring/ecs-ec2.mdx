...
<Steps>
  ...
  <Step>
    ...
    Crie uma nova definição de tarefa do ECS que inclua o contêiner sidecar do coletor. Escolha entre o NRDOT Collector (distribuição da New Relic) ou o OpenTelemetry Collector e, em seguida, selecione a definição de tarefa para a sua plataforma de contêiner:
    ...
    <Tabs>
      ...
      <TabsPages>
        <TabsPageItem id="ec2-nrdot">
          <Callout variant="tip">
            **NRDOT Collector** é a distribuição da New Relic do OpenTelemetry Collector com suporte da New Relic para assistência. Ele agrupa os receptores `awsecscontainermetrics` e `hostmetrics` usados por esta configuração, portanto, é executado com a mesma configuração de coletor que você armazenou na etapa anterior.
          </Callout>

          <Callout variant="important">
            O NRDOT Collector publica apenas imagens de contêiner do Linux. Para monitorar contêiner do Windows, use a guia **OpenTelemetry Collector**.
          </Callout>
