      ...
      * Para instalação via Helm: conclua a [instalação base do OpenTelemetry no Kubernetes via Helm](/docs/kubernetes-pixie/k8s-otel/install/#helm-install)
      ...
      <CollapserGroup>
        ...
        <Collapser id="nrdot-k8s-helm-install" title="Instalação via Helm">
          1. Atualize seu [`values.yaml`](https://github.com/newrelic/helm-charts/blob/5cfdda9d64dc26c289438554a23665434d4d584b/charts/nr-k8s-otel-collector/values.yaml) para o Helm chart `nr-k8s-otel-collector` com as seguintes alterações:

          a. Atualize o [repositório da imagem do coletor](https://github.com/newrelic/helm-charts/blob/5cfdda9d64dc26c289438554a23665434d4d584b/charts/nr-k8s-otel-collector/values.yaml#L90) e a [tag](https://github.com/newrelic/helm-charts/blob/5cfdda9d64dc26c289438554a23665434d4d584b/charts/nr-k8s-otel-collector/values.yaml#L91) para usar o NRDOT:
          ...
          b. Adicione as seguintes seções sob [`deployment.extraConfig`](https://github.com/newrelic/helm-charts/blob/5cfdda9d64dc26c289438554a23665434d4d584b/charts/nr-k8s-otel-collector/values.yaml#L259):
