...
* [Direto ao coletor](https://opentelemetry.io/docs/specs/otel/logs/#direct-to-collector):
  ...
  * Consulte a [documentação relevante da linguagem OpenTelemetry](https://opentelemetry.io/docs/languages/) para obter detalhes de implementação específicos e [o monitoramento OpenTelemetry APM](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/apm-monitoring/opentelemetry-apm-intro/) para obter detalhes sobre serviços de monitoramento com New Relic.
...
Independentemente do método de coleta escolhido, uma integração bem-sucedida requer a configuração de sua origem log para exportar o log para este endpoint. Certifique-se de revisar os [requisitos de configuração do endpoint](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-otlp/#configure-endpoint-port-protocol) antes de continuar.
...
log estão correlacionados com uma entidade de serviço se incluírem o [atributo exigido](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-best-practices-resources/#required-attributes). Normalmente, eles vêm do atributo de recurso do log, como `ResourceLogs.Resource.attributes`, mas também podem ser analisados a partir de `LogRecord.body` conforme descrito na [nota de rodapé nº 3 do mapeamento OTLP](#otlp-mapping-notes).
