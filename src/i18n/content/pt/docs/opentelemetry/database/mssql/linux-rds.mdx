...
<Steps>
  ...
  <Step>
    ...
    | `<YOUR_NEWRELIC_PASSWORD>` | A senha que você definiu para o usuário newrelic                                                                                                                               |
    | `<YOUR-RDS-ENDPOINT>`      | Seu endpoint do RDS SQL Server (por exemplo, `mydb-instance.xxxxxxxxxxxx.us-east-1.rds.amazonaws.com`)                                                                         |
