...
<CollapserGroup>
  ...
  <Collapser id="connections-metrics" title="Métricas de conexões">
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Tamanho máximo de disco permitido para o banco de dados SQL Server
          </td>
        </tr>
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            Objeto de banco de dados bloqueado por uma sessão
          </td>
        </tr>
      </tbody>
    </table>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Memória total do servidor em KB
          </td>
        </tr>
      </tbody>
    </table>
