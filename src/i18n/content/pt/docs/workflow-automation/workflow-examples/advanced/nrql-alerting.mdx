...
* Conta New Relic
* Destino de e-mail (consulte [Enviar notificações](/docs/workflow-automation/setup-and-configure/create-destinations))
...
**Para agendar**, use a [API CreateSchedule](/docs/workflow-automation/workflow-automation-apis/create-schedule) com a expressão cron `*/10 * * * *` (a cada 10 minutos). O intervalo mínimo é de 10 minutos. Consulte [limites do fluxo de trabalho](/docs/workflow-automation/limitations-and-faq/workflow-limits) para obter detalhes.
