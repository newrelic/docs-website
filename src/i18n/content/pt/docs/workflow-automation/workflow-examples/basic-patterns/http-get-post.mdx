...
<DocTiles>
  <DocTile title="análise sintática JSON" path="/docs/workflow-automation/workflow-examples/basic-patterns/json-parsing">
    Analisar e transformar respostas HTTP
  </DocTile>

  <DocTile title="Polling de API REST" path="/docs/workflow-automation/workflow-examples/integrations/rest-api-polling">
    Crie fluxos de trabalho completos de integração de API
  </DocTile>

  <DocTile title="Ações HTTP" path="/docs/workflow-automation/setup-and-configure/actions-catalog/actions-catalog">
    Conheça todos os parâmetros de ação HTTP
  </DocTile>
</DocTiles>