...
<DocTiles>
  <DocTile title="Laços" path="/docs/workflow-automation/workflow-examples/basic-patterns/loops">
    Passar dados através de iterações de loop
  </DocTile>

  <DocTile title="Lógica condicional" path="/docs/workflow-automation/workflow-examples/basic-patterns/conditional-logic">
    Use dados em condições de switch
  </DocTile>

  <DocTile title="análise sintática JSON" path="/docs/workflow-automation/workflow-examples/basic-patterns/json-parsing">
    Extrair e passar dados JSON
  </DocTile>
</DocTiles>