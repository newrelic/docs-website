...
<DocTiles>
  <DocTile title="Lógica condicional" path="/docs/workflow-automation/workflow-examples/basic-patterns/conditional-logic">
    Combine loops com instruções switch
  </DocTile>

  <DocTile title="Polling de API REST" path="/docs/workflow-automation/workflow-examples/integrations/rest-api-polling">
    Use loops para fluxos de trabalho de polling de API
  </DocTile>

  <DocTile title="Esquema de definição: Loop" path="/docs/workflow-automation/workflow-automation-apis/definition-schema#loop">
    Referência completa da etapa de loop
  </DocTile>
</DocTiles>