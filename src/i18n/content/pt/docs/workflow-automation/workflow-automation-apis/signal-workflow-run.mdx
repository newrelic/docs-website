...
<DocTiles>
  <DocTile title="Esquema de definição: Etapa de espera" path="/docs/workflow-automation/workflow-automation-apis/definition-schema#wait">
    Aprenda a configurar etapas de espera com sinais
  </DocTile>
  ...
  <DocTile title="Iniciar execução do fluxo de trabalho" path="/docs/workflow-automation/workflow-automation-apis/start-workflow-run">
    Execute um fluxo de trabalho para obter um runId para sinalização
  </DocTile>
  ...
  <DocTile title="Informações da execução do fluxo de trabalho" path="/docs/workflow-automation/workflow-automation-apis/workflow-run-info">
    Verifique se o fluxo de trabalho está aguardando um sinal
  </DocTile>
</DocTiles>