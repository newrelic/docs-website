...
<CollapserGroup>
  <Collapser id="aws.lambda.invoke" title="Invocar uma função Lambda">
  ...
  <Collapser id="aws.lambda.updateFunctionConfiguration" title="Atualizar configuração da função">
  ...
  <Collapser id="aws.lambda.getFunction" title="Descreva uma Função Lambda específica">
    Recupera os detalhes de configuração, a localização do código e outros metadados para uma Função Lambda específica.
  ...
  <Collapser id="aws.lambda.listAliases" title="Listar os aliases de uma Função Lambda específica">
    Retorna uma lista de aliases para uma função do Lambda específica. Aliases são ponteiros para versões de função.
  ...
  <Collapser id="aws.bedrock.invokeAgent" title="Invocar um agente do Bedrock">
    Invoca um agente do Bedrock.
    ...
    ### Exemplo de função da AWS para executar o agente do Bedrock
    ...
    ### Política de confiança para produção
    ...
    ### Política de confiança para staging ou desenvolvimento
