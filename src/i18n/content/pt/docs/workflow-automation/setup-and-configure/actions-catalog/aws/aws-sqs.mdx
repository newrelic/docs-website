...
<CollapserGroup>
  <Collapser id="aws.sqs.sendMessage" title="Enviar uma mensagem para uma fila SQS">
...
<CollapserGroup>
  <Collapser id="aws.sqs.receiveMessage" title="Receber uma mensagem de uma fila SQS">
