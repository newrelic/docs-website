...
<CollapserGroup>
  <Collapser id="aws.systemsManager.writeDocument" title="Criar documento">
...
<CollapserGroup>
  <Collapser id="aws.systemsManager.deleteDocument" title="Excluir documento">
...
<CollapserGroup>
  <Collapser id="aws.systemsManager.startAutomation" title="Iniciar automação">
      ...
      <TabsPages>
        ...
        <TabsPageItem id="automationstatusoutputs">
          ...
          <Callout variant="important">
            ...
            3. Consulte as instruções para configurar as [credenciais da AWS](/docs/workflow-automation/setup-and-configure/set-up-aws-credentials).
