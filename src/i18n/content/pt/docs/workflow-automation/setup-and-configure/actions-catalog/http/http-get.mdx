...
<Callout variant="tip">
  Ações HTTP suportam sintaxe de segredo para qualquer valor de cabeçalho, permitindo que você passe dados sensíveis, como chaves de API, com segurança. Consulte [gerenciador de segredos](/docs/workflow-automation/limitations-and-faq/workflow-best-practices#secure-credentials) para mais informações.
</Callout>
