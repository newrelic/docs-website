...
<Callout variant="tip">
  ...
  * **E-mail**: Use [`newrelic.notification.sendEmail`](/docs/workflow-automation/setup-and-configure/actions-catalog/newrelic/notification/newrelic-notification) após configurar destinos de e-mail em [Alerts &gt; Destinations](/docs/alerts/get-notified/destinations/)
</Callout>
