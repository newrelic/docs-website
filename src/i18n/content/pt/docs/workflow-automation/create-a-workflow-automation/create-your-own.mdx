...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        [Laços](/docs/workflow-automation/workflow-examples#loop-structure)
      </td>
...
Para obter informações detalhadas sobre a estrutura do loop, parâmetros e uso avançado (incluindo break/continue), consulte [Estrutura do loop](/docs/workflow-automation/workflow-examples#loop-structure).
