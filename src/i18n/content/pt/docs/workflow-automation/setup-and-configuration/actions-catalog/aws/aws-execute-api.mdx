...
Para obter mais exemplos de fluxo de trabalho usando API AWS Execute, consulte a página [de exemplos de fluxo de trabalho](/docs/workflow-automation/workflow-examples).