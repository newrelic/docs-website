...
## Ações de comunicação disponíveis

Guia rápido de todas as ações de comunicação por plataforma:
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        [Postar mensagem](#slackchatpostmessage)
      </td>

      <td>
        Envie mensagens para canais do Slack com anexos de arquivo opcionais.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        [Obtenha reações](#slackchatgetreactions)
      </td>

      <td>
        Recuperar reações com emojis de mensagens do Slack.
      </td>
    </tr>
  </tbody>
</table>
