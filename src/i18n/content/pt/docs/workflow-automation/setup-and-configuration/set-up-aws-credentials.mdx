  ...
  <TabsPages>
    <TabsPageItem id="iam-role-1">
      ...
      * Alinha-se com as práticas de segurança recomendadas AWS
      ...
      6. Na página **Add permissions**, anexe políticas com base no seu fluxo de trabalho:
         ...
         * Para outros serviços: consulte [Permissões da AWS necessárias.](#required-aws-permissions)
      ...
      <Callout variant="tip">
        **Importante:** os ARNs de função devem ser inseridos diretamente nas entradas do fluxo de trabalho — não os armazene no [gerenciador de segredos](/docs/workflow-automation/limitations-and-faq/workflow-best-practices/#secure-credentials). Não são credenciais confidenciais; são identificadores de recursos.
      </Callout>
    ...
    <TabsPageItem id="iam-user-1">
      ...
      * Fluxo de trabalho de autenticação simplificado
      ...
      Nunca codifique credenciais AWS no fluxo de trabalho. Em vez disso, armazene-os no [gerenciador de segredos](/docs/workflow-automation/limitations-and-faq/workflow-best-practices/#secure-credentials) do New Relic.
...
Cole o ARN da função diretamente nas entradas do fluxo de trabalho — sem necessidade [de gerenciador de segredos](/docs/workflow-automation/limitations-and-faq/workflow-best-practices/#secure-credentials) :
...
[Gerenciador de segredos](/docs/workflow-automation/limitations-and-faq/workflow-best-practices/#secure-credentials) de referência para chaves de acesso:
