...
A organização New Relic configurada como <DoNotTranslate>**partnership accounts**</DoNotTranslate> tem acesso a uma forma hierárquica aprimorada de organizar sua estrutura de conta.
...
A conta do proprietário da parceria (POA) é a entidade usada para administrar uma parceria. Ele controla quais usuários gerenciam contas em parcerias, têm acesso à [APIdo parceiro](/docs/new-relic-partnerships/partner-integration-guide/partner-account-maintenance/partner-api) e gerenciam outros aspectos da parceria.

<DoNotTranslate>**Do not monitor your own applications from the partnership owner account.**</DoNotTranslate> Em vez disso, crie uma conta dentro da parceria e monitor os aplicativos dessa conta.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        * Contas infantis podem ser criadas através da [APIPartnership](/docs/new-relic-partnerships/partnerships/partner-api/partnership-api-sub-account-object) ou [da interface do usuárioNew Relic ](/docs/accounts/install-new-relic/account-setup/manage-apps-or-users-sub-accounts).
...
Você pode usar a [APIde usuário de parceria](/docs/accounts-partnerships/partnerships/partner-api/partnership-api-user-object) para adicionar e manter seu usuário de clientes. Uma conta deve sempre ter pelo menos uma pessoa (o [Proprietário](/docs/accounts-partnerships/accounts/account-billing-usage/users-roles#owner)) associada a ela.
