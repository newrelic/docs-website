...
1. Vá para
   ...
   <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > [(user menu)](/docs/accounts/accounts-billing/general-account-settings/intro-account-settings) > Account settings**</DoNotTranslate>

   .

2. Na barra de menu à esquerda, selecione

   <DoNotTranslate>**Partnerships**</DoNotTranslate>
...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > [(user menu)](/docs/accounts/accounts-billing/general-account-settings/intro-account-settings) > Account settings > Partnerships**</DoNotTranslate>: Os proprietários da parceria podem acessar o console de administração da parceria nas configurações de sua conta na interface do New Relic .
</figcaption>
...
Para visualizar a atividade de um cliente que não aparece em nenhuma das visualizações filtradas: Vá para <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > [(user menu)](/docs/accounts/accounts-billing/general-account-settings/intro-account-settings) > Switch accounts > Other accounts**</DoNotTranslate>.
