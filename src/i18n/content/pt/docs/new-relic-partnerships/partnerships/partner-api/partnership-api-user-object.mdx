...
Esta é a lista de atributos no objeto usuário. Certifique-se de atribuir o atributo [<DNT>**owner**</DNT>](#attr-owner) a um usuário ao criar uma conta New Relic.
...
<CollapserGroup>
  ...
  >
    ...
    Este atributo é <DNT>**required**</DNT> para novo usuário.
  ...
  <Collapser id="attr-owner" title="proprietário">
    <table>
      <tbody>
        <tr>
          <th>
    ...
    Um sinalizador para indicar se este usuário é o [proprietário](/docs/accounts-partnerships/accounts/account-setup/users-roles) da conta. Ao criar uma conta New Relic, você <DNT>**must**</DNT> atribui a um usuário uma função <DNT>**owner**</DNT> .
  </Collapser>
...
<table>
  ...
  <tbody>
    <tr>
      <td>
        <DNT>**List**</DNT> (índice) todos os usuários de uma conta.
      </td>
    ...
    <tr>
      <td>
        <DNT>**Update**</DNT> o papel de uma pessoa na conta.
      </td>
    ...
    <tr>
      <td>
        <DNT>**Create**</DNT> (adicionar) um usuário a uma conta.
    ...
    <tr>
      <td>
        <DNT>**Delete**</DNT> um usuário de uma conta.
...
Antes de usar esta API, leia os [requisitos](/docs/new-relic-partnerships/partner-integration-guide/partner-account-maintenance/partner-api/).

Aqui está um exemplo de solicitação e resposta JSON usando o objeto de usuário da API de parceria.

<CollapserGroup>
  <Collapser id="request-example" title="Solicitação JSON de objeto de usuário">
    ```
    {
      "users": [
        {
  ...
  <Collapser id="response-example" title="Resposta JSON">
