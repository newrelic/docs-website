...
<DNT>**Recommendation:**</DNT> Inicie novos projetos consultando os exemplos [de Introdução à API](/docs/apm/apis/requirements/new-relic-rest-api-v2-getting-started) e da [API REST v2 do New Relic](/docs/apis/rest-api-v2). Além disso, comece a migrar qualquer script da API v1 para seu equivalente v2.
