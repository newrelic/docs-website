...
<Callout variant="tip" title="dica">
  Use mutações do NerdGraph para criar ou gerenciar suas regras do Scorecards. Para obter mais informações, consulte [Criar funções personalizadas para Scorecards](/docs/apis/nerdgraph/examples/nerdgraph-scorecards-custom-tutorial).
</Callout>
