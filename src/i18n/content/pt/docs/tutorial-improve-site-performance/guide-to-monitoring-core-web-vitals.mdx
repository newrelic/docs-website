...
Se você já monitorou seu aplicativo de Browser com New Relic, acesse <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Browser > (select an app) > Monitor > Web vitals**</DoNotTranslate>.
...
* [atraso da primeira entrada](https://web.dev/fid/): mede a interatividade entre a entrada do usuário e a resposta do browser
