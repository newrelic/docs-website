...
<CollapserGroup>
  <Collapser id="no_data" title="Não vendo dados">
  ...
  <Collapser id="installation" title="Problemas de instalação">
    <table>
      <thead>
        <tr>
          <th>
  ...
  <Collapser id="logs" title="Arquivo de log">
  ...
  <Collapser id="vm_metrics" title="Métrica de VM ausente">
...
* [Resolução de problemas instalados](https://knowledge.newrelic.com/s/article/Nodejs-Troubleshooting-Framework-Install)
* [Configuração geral resolução de problemas](https://knowledge.newrelic.com/s/article/Nodejs-Troubleshooting-Framework-Configuration)