...
| Modelo | Imagem | Texto | Visão | | --- | --- | --- | --- | | Laboratórios AI21 Jurássico-2 | ❌ | ✅ | - | | Amazona Titã | ❌ | ✅ | - | | Claude Antrópico | ❌ | ✅ | ❌ | | Coerente | ❌ | ✅ | - | | Meta Lhama2 | ❌ | ✅ | - | | Meta Lhama3 | ❌ | ✅ | - |
...
| Agente | Cadeia | Ferramentas | Lojas de vetores | | --- | --- | --- | --- | | ✅ | ✅ | ✅ | ✅ |

Modelos/provedores são geralmente suportados transitivamente pela nossa instrumentação do módulo do provedor.

| Provedor | Suportado | Transitivamente | | --- | --- | --- | | Azure OpenAI | ❌ | ❌ | | Base Amazônica | ❌ | ❌ | | OpenAI | ✅ | ✅ |

### OpenAI

Através do módulo `openai` , oferecemos suporte a:

| Áudio | Bate-papo | Conclusões | Incorporações | Arquivos | Imagens | | --- | --- | --- | --- | --- | --- | | ❌ | ✅ | ✅ | ✅ | ❌ | ❌ |
