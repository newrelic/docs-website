...
<Callout variant="important">
  A versão mais recente suportada pode não ser a mais recente.
</Callout>
...
| Modelo | Imagem | Texto | Visão | | -------------------- | ----- | ---- | ------ | | AI21 Labs Jurassic-2 | ❌ | ✅ | - | | Amazon Titan | ❌ | ✅ | - | | Anthropic Claude | ❌ | ✅ | ❌ | | Cohere | ❌ | ✅ | - | | Meta Llama2 | ❌ | ✅ | - | | Meta Llama3 | ❌ | ✅ | - |
...
| Agentes | Cadeiaa | Ferramentas | Lojas de vetores | | ------ | ------ | ----- | ------------ | | ✅ | ✅ | ✅ | ✅ |

Modelos e provedores geralmente são suportados transitivamente por nossa instrumentação do módulo do provedor.

| Provedor | Suportado | Transitivamente | | -------------- | --------- | ------------ | | Azure OpenAI | ❌ | ❌ | | Amazon Bedrock | ❌ | ❌ | | OpenAI | ✅ | ✅ |

### OpenAI

Através do módulo `openai` , oferecemos suporte a:

| Áudio | Bate-papo | Complementações | Incorporações | Arquivos | Imagens | | ----- | ---- | ----------- | ---------- | ----- | ------ | | ❌ | ✅ | ✅ | ✅ | ❌ | ❌ |
