...
<CollapserGroup>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Via pacotes [MySQL](https://www.npmjs.com/package/mysql) e [mysql2](https://www.npmjs.com/package/mysql2)
          </td>
        </tr>
  ...
  >
    Para oferecer suporte [ao log do APM no contexto](/docs/apm/new-relic-apm/getting-started/get-started-logs-context), o agente Node.js utiliza a seguinte biblioteca:
  ...
  >
    ...
    * [Amazon SQS](https://www.npmjs.com/package/aws-sdk) – versões 2 e 3 do AWS SDK.
    * [Amazon SNS](https://www.npmjs.com/package/aws-sdk) – versões 2 e 3 do AWS SDK.
