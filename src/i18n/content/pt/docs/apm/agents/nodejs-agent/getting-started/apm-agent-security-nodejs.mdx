...
* [Atributo personalizado](https://newrelic.github.io/node-newrelic/API.html#addCustomAttribute)
* [API do agente Node.js (]()https://newrelic.github.io/node-newrelic/API.html)
