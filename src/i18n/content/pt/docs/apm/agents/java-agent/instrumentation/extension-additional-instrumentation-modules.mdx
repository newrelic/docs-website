...
<Callout variant="tip">
  Caso haja feedback, dúvidas ou problemas com esta instrumentação, crie uma postagem no [Fórum de suporte do New Relic](https://support.newrelic.com/s/hubtopic/Topic__c/Default?c__categories=%5B%7B%22icon%22%3A%22standard%3Adefault%22%2C%22id%22%3A%22a6c8W000000EesiQAC%22%2C%22sObjectType%22%3A%22Category__c%22%2C%22title%22%3A%22Java%20Agent%22%2C%22titleFormatted%22%3A%22Java%20Agent%22%7D%5D) e adicione a tag `java_incubator` à postagem.
</Callout>
...
<CollapserGroup>
  <Collapser className="freq-link" id="class-histogram" title="Histograma de classe">
    <table>
      <tbody>
        <tr>
          <th>
...
<CollapserGroup>
  <Collapser className="freq-link" id="apache-camel-212" title="Camelo Apache 2.12">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser className="freq-link" id="c3p0-db-connection" title="Conjuntos de conexões de banco de dados C3P0">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser className="freq-link" id="code-hale-metrics-2" title="Métrica 2 de Coda Hale">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser className="freq-link" id="coda-hale-metrics-3" title="Métrica 3 de Coda Hale">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser className="freq-link" id="ratpack-1-6-0" title="Ratpack 1.6.0 ou superior">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser className="freq-link" id="ratpack-http-1-4-0" title="Cliente HTTP Ratpack 1.4.0 ou superior">
    <table>
      <tbody>
        <tr>
          <th>
