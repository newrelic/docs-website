...
Para o usuário WebSphere e WebLogic, o agente Java também relata o nome da instância para cada instância ativa do servidor de aplicativos, que é visível na página <DoNotTranslate>**Settings > Environment**</DoNotTranslate> do APM. Geralmente, esse nome é fornecido pelo servidor de aplicativos. Se um nome de instância for definido, ele será usado em vez do nome de exibição na interface do New Relic.
...
* <DoNotTranslate>**Port**</DoNotTranslate>
  ...
  <DoNotTranslate>**0**</DoNotTranslate>

  . Este valor é configurável pelo usuário.

* <DoNotTranslate>**Dispatcher Name**</DoNotTranslate>
