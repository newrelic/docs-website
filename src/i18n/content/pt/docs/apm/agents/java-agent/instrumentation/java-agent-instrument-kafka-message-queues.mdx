...
3. Adicione a métrica que deseja monitor a um dashboard clicando em <DoNotTranslate>**Add to dashboard**</DoNotTranslate>.
...
## Transação Kafka Connect habilitada [#collect-kafka-connect-transactions]
...
<CollapserGroup>
  ...
  >
    Se você ainda não habilitou distributed tracing para seu aplicativo, leia o [guia de transiçãodistributed tracing ](/docs/apm/distributed-tracing/getting-started/transition-guide-distributed-tracing)antes de habilitá-lo.
