...
<DNT>**Recommendation:**</DNT> Configure seu `app.yaml` para [desativar verificações de integridade](https://cloud.google.com/appengine/docs/flexible/java/configuring-your-app-with-app-yaml#health_checks) adicionando:
