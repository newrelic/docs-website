...
<CollapserGroup>
  <Collapser id="setup-gae" title="1. Configure o projeto flexível do GAE e instale a dependência">
  ...
  <Collapser id="configure-pom-xml" title="2. Configure o Maven pom.xml para incluir o agente Java e o projeto de construção">
  ...
  <Collapser id="configure-dockerfile" title="4. Configure o Dockerfile">
  ...
  <Collapser id="build-docker-image" title="5. Construa a imagem Docker">
  ...
  <Collapser id="deploy-docker-image-to-gae" title="6. implantar imagem Docker no ambiente flexível GAE inicializado">
