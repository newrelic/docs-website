...
<CollapserGroup>
  ...
  >
    ...
    * <DoNotTranslate>**JBoss**</DoNotTranslate>: `log/boot.log`

    * <DoNotTranslate>**Glassfish**</DoNotTranslate>: `domain-dir/logs/server.log`

    * <DoNotTranslate>**Tomcat**</DoNotTranslate>: `catalina.out` (se especificado em `catalina.sh`) ou `catalina.bat`

    * <DoNotTranslate>**WebLogic**</DoNotTranslate>:[`server_name.log`](http://docs.oracle.com/cd/E17904_01/web.1111/e13739/logging_services.htm#i1179712)

    * <DoNotTranslate>**WebObjects**</DoNotTranslate>: `/var/log/webobjects.log`
