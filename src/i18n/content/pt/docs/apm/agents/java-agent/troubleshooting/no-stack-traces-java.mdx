---
title: Sem rastreamento de pilha (Java)
...
Dependendo da situação, você poderá encontrar [rastreamento de erros](/docs/apm/applications-menu/error-analytics/error-analytics-manage-error-traces) na interface do APM que não inclui rastreamento de pilha para seu aplicativo Java.
...
<CollapserGroup>
  ...
  >
    Esse é [um comportamento normal](#cause) de como o agente Java trata 500 erros. Para forçar o relatório do rastreamento de pilha, chame a API Java da New Relic a partir do seu próprio código. A execução do método `NewRelic.noticeError (Throwable t)` fará com que um erro seja relatado junto com o backtrace stack representado por `Throwable`. Para obter mais informações sobre esse método e suas sobrecargas, consulte [API do agente Java da New Relic no GitHub.](https://newrelic.github.io/java-agent-api/javadoc/com/newrelic/api/agent/NewRelic.html#noticeError-java.lang.Throwable-)
  </Collapser>
</CollapserGroup>
