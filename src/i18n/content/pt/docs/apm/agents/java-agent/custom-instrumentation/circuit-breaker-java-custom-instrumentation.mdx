...
<CollapserGroup>
  ...
  >
    Use a tabela <DoNotTranslate>**Top methods by call count**</DoNotTranslate> na página do circuit breaker <DoNotTranslate>**Events**</DoNotTranslate> para encontrar métodos que possam estar superinstrumentados. Identifique e desative a instrumentação personalizada.
