...
<CollapserGroup>
  ...
  <Collapser id="event_ingest_uri" title="event_ingest_uri">
    ...
    Evento ingerir URI usado por algum recurso do agente. O padrão é o endpoint de ingestão de produção dos EUA. Pode ser configurado manualmente para enviar o evento para outro endpoint de ingestão. Exemplos:
  ...
  <Collapser id="metric_ingest_uri" title="metric_ingest_uri">
    ...
    URI de ingestão de métrica usado por algum recurso do agente. O padrão é o endpoint de ingestão de produção dos EUA. Pode ser configurado manualmente para enviar a métrica para outro endpoint de ingestão. Exemplos:
