...
<Callout variant="important">
  Este documento detalha como usar a nova solução baseada no agente APM para o monitoramento Serverless Java. Esta solução foi lançada em 10 de abril de 2026. Usuários que estavam usando o monitoramento de Java antes desta versão ou que estão usando as versões 11 ou 8 do Java devem, em vez disso, usar nossa [solução Java legada baseada em Open Tracing](/docs/serverless-function-monitoring/aws-lambda-monitoring/instrument-lambda-function/instrument-your-own/#console).
</Callout>
