...
A interface <InlinePopover type="apm"/>mostrará a transação iniciada via JMS 1.1 ou recebimento de mensagem RabbitMQ como <DoNotTranslate>**Message**</DoNotTranslate> tarefas em segundo plano. A criação de mensagens via JMS ou RabbitMQ também aparece no trace da transação.
...
<figcaption>
  Vá para <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & services**</DoNotTranslate> e clique no seu aplicativo. Na seção <DoNotTranslate>**Monitor**</DoNotTranslate> , clique em <DoNotTranslate>**Transaction**</DoNotTranslate> e selecione uma transação para ver a tabela detalhada.
</figcaption>
