...
<CollapserGroup>
  ...
  <Collapser id="frameworks" title="Estrutura e biblioteca">
    ...
    * Spring Boot Actuator v3 para o mais recente (nomeação de transação)
  ...
  <Collapser id="http-messaging" title="HTTP e mensagens">
    ...
    * [Métrica do cliente Kafka](/docs/agents/java-agent/instrumentation/java-agent-instrument-kafka-message-queues) 0.10.0.0 até a mais recente (para métrica)
