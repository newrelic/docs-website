...
<CollapserGroup>
  ...
  >
    ...
    * [Kafka Client Metrics](/docs/agents/java-agent/instrumentation/java-agent-instrument-kafka-message-queues) 0.10.0.0 a 3.6.x (para métrica)
  ...
  <Collapser
    ...
    title="Informações do banco de dados em nível de instância"
  >
  ...
  <Collapser
    id="async"
    title="Instrumentação assíncrona"
  >
  ...
  <Collapser
    id="other"
    title="Outro recurso instrumentado"
  >
