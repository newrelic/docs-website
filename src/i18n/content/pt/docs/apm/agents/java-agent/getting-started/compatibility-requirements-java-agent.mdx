...
<CollapserGroup>
  ...
  <Collapser id="http-messaging" title="HTTP e mensagens">
    ...
    * Kafka Client Node métrica]\(/docs/agente/java-instrumentação de agente/agente Java-instrumento-kafka-fila de mensagens) 3.7.0 até o mais recente (para métrica)
    ...
    * [Kafka Client Spans](/docs/agents/java-agent/instrumentation/java-agent-instrument-kafka-message-queues) 0.11.0.0 a 3.6.x (para distributed tracing)

    * [Kafka Connect](/docs/agents/java-agent/instrumentation/java-agent-instrument-kafka-message-queues) 1.0.0 a 3.6.x (para métrica)

    * [Kafka Connect](/docs/agents/java-agent/instrumentation/java-agent-instrument-kafka-message-queues) 2.0.0 a 3.6.x (para distributed tracing e dados de transação)

    * [Kafka Streams](/docs/agents/java-agent/instrumentation/java-agent-instrument-kafka-message-queues) 1.0.0 a 3.6.x (para métrica)

    * [Kafka Streams](/docs/agents/java-agent/instrumentation/java-agent-instrument-kafka-message-queues) 2.0.0 a 3.6.x (para distributed tracing e dados de transação)
