  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        A seção no arquivo de configuração <DoNotTranslate>**newrelic.yml**</DoNotTranslate> chamada `analytics_events` foi descontinuada. Use a seção `transaction_events` .
      </td>
    </tr>
