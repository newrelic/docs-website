...
Especifique um caminho para um arquivo <DoNotTranslate>**.pem**</DoNotTranslate> contendo cada certificado que você deseja que o agente use ao validar a identidade do proxy ou servidor. Você pode concatenar vários certificados em um único arquivo <DoNotTranslate>**.pem**</DoNotTranslate> .
