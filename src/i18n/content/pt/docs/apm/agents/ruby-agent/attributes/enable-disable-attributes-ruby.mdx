...
<CollapserGroup>
  ...
  >
    ...
    <DoNotTranslate>**Note:**</DoNotTranslate> Todos os atributos do usuário são padronizados como `true`. No entanto, por padrão, os parâmetros de solicitação estão desabilitados para todos os destinos.
