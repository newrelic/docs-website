...
<CollapserGroup>
  ...
  <Collapser id="error_collector-attributes-exclude" title="error_collector.attributes.exclude">
    ...
    Para evitar a coleta [de mensagens de erro](/attribute-dictionary?attribute_name=error.message) , use a configuração [strip\_exception\_messages](/docs/agents/ruby-agent/configuration/ruby-agent-configuration#strip_exception_messages-enabled) .
  </Collapser>
