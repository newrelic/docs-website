...
2. No seu aplicativo Roda, abaixo da diretiva Roda `require` , adicione `require 'newrelic_rpm'`. Por exemplo:
...
<Callout variant="important">
  Todos os métodos newrelic\_ignore\* devem ser chamados fora do bloco `route` .
</Callout>
