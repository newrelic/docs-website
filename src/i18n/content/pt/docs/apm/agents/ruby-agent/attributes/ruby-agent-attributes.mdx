...
<CollapserGroup>
  ...
  >
    ...
    * Visualizações de página (<InlinePopover type="browser"/>): indisponíveis
      ...
      <DoNotTranslate>**Note:**</DoNotTranslate> O atributo `httpResponseCode` (valor de string) foi descontinuado a partir da versão 6.12.0 do agente. `http.statusCode` (valor inteiro) deve ser usado em seu lugar.
  </Collapser>
  ...
  >
    ...
    * Visualizações de página (monitoramento do browser): indisponíveis
      ...
      <DoNotTranslate>**Note:**</DoNotTranslate> A propriedade `resque.capture_params` está obsoleta. Porém, se definido como `true`, permitirá a captura de argumentos de Resque para rastreamento da transação, erros de rastreamento.
  </Collapser>
  ...
  >
    ...
    * Visualizações de página (monitoramento do browser): indisponíveis
      ...
      <DoNotTranslate>**Note:**</DoNotTranslate> A propriedade `sidekiq.capture_params` está obsoleta. No entanto, se definido como `true`, permitirá a captura de argumentos do Sidekiq para rastreamento da transação e erros de rastreamento.
  </Collapser>
</CollapserGroup>
...
Ao atualizar para o agente Ruby <DoNotTranslate>**3.12.0**</DoNotTranslate> ou superior, atualize sua configuração <DoNotTranslate>**newrelic.yml**</DoNotTranslate> .