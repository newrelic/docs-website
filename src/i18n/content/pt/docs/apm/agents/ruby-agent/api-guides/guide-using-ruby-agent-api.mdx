...
* [Visão geral](https://rubydoc.info/github/newrelic/newrelic-ruby-agent)
* [Métodos de API pública](https://rubydoc.info/github/newrelic/newrelic-ruby-agent/NewRelic/Agent)

As seções a seguir explicam objetivos comuns, soluções e links para partes relevantes da documentação.

<Callout variant="important">
  Ao usar a API do agente Ruby, certifique-se de ter a versão mais recente do agente Ruby. Várias API usadas nos exemplos a seguir requerem o agente Ruby [versão 4.6.0](/docs/release-notes/agent-release-notes/ruby-release-notes/ruby-agent-3170325) ou superior.
</Callout>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Use a [APItracer ](/docs/agents/ruby-agent/customization/ruby-custom-instrumentation#advanced-tracing).
      </td>
    </tr>
...
Para obter mais informações sobre como correlacionar dados log com outros dados de telemetria, consulte nossa documentação [de logs em contexto](/docs/logs/logs-context/configure-logs-context-ruby/) .
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Crie um [evento personalizado](/docs/insights/insights-data-sources/custom-events). Consulte [`record_custom_event()`](https://www.rubydoc.info/github/newrelic/newrelic-ruby-agent/NewRelic/Agent#record_custom_event-instance_method).
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Adicionar [atributo personalizado](/docs/agents/manage-apm-agents/agent-data/collect-custom-attributes). Passe um hash apply de atributo para [`record_custom_event()`](https://www.rubydoc.info/github/newrelic/newrelic-ruby-agent/NewRelic/Agent#record_custom_event-instance_method).
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Crie uma [métrica personalizada](/docs/agents/manage-apm-agents/agent-data/custom-metrics). Consulte [`record_metric()`](https://www.rubydoc.info/github/newrelic/newrelic-ruby-agent/NewRelic/Agent#record_metric-instance_method).
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Consulte `Tracer.start_datastore_segment()`. Você <DoNotTranslate>**must**</DoNotTranslate> chama `finish` no objeto retornado por este método.
      </td>
    </tr>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Use `Tracer.start_external_segment()`. Você <DoNotTranslate>**must**</DoNotTranslate> chama `finish` no objeto retornado por este método.
      </td>
    </tr>
