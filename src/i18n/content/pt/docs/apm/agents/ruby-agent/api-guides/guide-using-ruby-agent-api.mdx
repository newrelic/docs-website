...
O agente New Relic <DNT>Ruby</DNT> fornece uma API pública com documentação disponível no GitHub. A documentação do GitHub explica como configurar a instrumentação personalizada do seu aplicativo <DNT>Ruby</DNT> e coletar dados mais detalhados:
