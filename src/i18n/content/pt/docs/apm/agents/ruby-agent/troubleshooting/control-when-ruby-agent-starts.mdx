...
<CollapserGroup>
  ...
  <Collapser id="manually-start-and-stop-the-agent" title="Iniciar e parar manualmente o agente">
    ...
    Se quiser interromper o agente antes do término do processo, você pode ligar para [`NewRelic::Agent.shutdown`](https://www.rubydoc.info/gems/newrelic_rpm/NewRelic/Agent#shutdown-instance_method).
  </Collapser>
</CollapserGroup>
