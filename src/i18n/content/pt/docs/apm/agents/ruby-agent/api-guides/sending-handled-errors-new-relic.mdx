...
Para enviar dados de erro que você está processando em seu próprio código para o New Relic, use a chamada da API do agente Ruby [`NewRelic::Agent.notice_error`](https://www.rubydoc.info/github/newrelic/newrelic-ruby-agent/NewRelic/Agent#notice_error-instance_method) em seu gerenciador de erros.

## Notificar o agente New Relic Ruby sobre um erro [#solution]
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        Substitui a opção `:trace_only` , que foi descontinuada na versão [4.3.x](/docs/release-notes/agent-release-notes/ruby-release-notes/ruby-agent-430335) do agente Ruby.
      </td>
    </tr>
