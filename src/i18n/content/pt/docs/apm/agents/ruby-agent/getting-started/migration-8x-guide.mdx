...
## Mudanças no `add_method_tracer` [#add\_method\_tracer][#add_method_tracer]
...
## Distributed tracing está ativado por padrão [#distributed\_tracing][#distributed_tracing]
...
## O rastreamento multiaplicativo está obsoleto [#cross\_application\_tracing][#cross_application_tracing]
...
## Métodos de API obsoletos e instrumentação herdada foram removidos [#removed\_deprecated][#removed_deprecated]
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Métodos de API [`disable_all_tracing`](https://www.rubydoc.info/gems/newrelic_rpm/NewRelic/Agent:disable_all_tracing) ou [`ignore_transaction`](https://www.rubydoc.info/gems/newrelic_rpm/NewRelic/Agent:ignore_transaction)
      </td>
    </tr>
