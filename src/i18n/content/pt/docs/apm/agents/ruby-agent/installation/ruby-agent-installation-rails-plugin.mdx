...
## Instale o plug-in New Relic Rails [#Installing\_the\_Plugin][#Installing_the_Plugin]
...
## Atualizar o arquivo de configuração [#Configuration\_file][#Configuration_file]
...
## Atualize o arquivo newrelic.yml [#Updating\_newrelicyml][#Updating_newrelicyml]
...
## Atualizar o agente Ruby [#Update\_the\_Agent][#Update_the_Agent]
...
## Desinstale o plug-in Rails [#Uninstalling\_Plugin][#Uninstalling_Plugin]
