...
O [agente New Relic Ruby](/docs/agents/ruby-agent/getting-started/new-relic-ruby) instrumenta automaticamente a gema Redis (gem versão 3.0.0 ou mais alto). Depois de [instalar o agente](/docs/agents/ruby-agent/installation-configuration/ruby-agent-installation) e gerar tráfego para seu aplicativo, você poderá visualizar as operações do Redis na [página <DoNotTranslate>**Summary**</DoNotTranslate> do APM](/docs/apm/applications-menu/monitoring/apm-overview-page), na [página<DoNotTranslate>**Databases**</DoNotTranslate> ](/docs/apm/applications-menu/monitoring/databases-slow-queries-page)e no [trace da transação](/docs/apm/transactions/transaction-traces/transaction-traces). Por exemplo, o gráfico principal na página APM <DoNotTranslate>**Summary**</DoNotTranslate> mostrará informações do Redis codificadas por cores.
