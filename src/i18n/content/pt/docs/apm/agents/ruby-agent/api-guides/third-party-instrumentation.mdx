...
<CollapserGroup>
  ...
  <Collapser id="perform_action_with_newrelic_trace" title="perform_action_with_newrelic_trace">
    ...
    Veja a [documentação completa de perform\_action\_with\_newrelic\_trace](https://www.rubydoc.info/gems/newrelic_rpm/NewRelic/Agent/Instrumentation/ControllerInstrumentation#perform_action_with_newrelic_trace-instance_method) para mais informações sobre parâmetro e uso.
  </Collapser>
</CollapserGroup>
