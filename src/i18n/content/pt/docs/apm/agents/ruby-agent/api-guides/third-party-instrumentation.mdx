...
<CollapserGroup>
  ...
  >
    ...
    Consulte a [documentação completa de perform_action_with_newrelic_trace](https://www.rubydoc.info/gems/newrelic_rpm/NewRelic/Agent/Instrumentation/ControllerInstrumentation#perform_action_with_newrelic_trace-instance_method) para obter mais informações sobre parâmetros e uso.
  </Collapser>
</CollapserGroup>
