...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        A revisão registrada para a implantação. <DNT>**Recommendation:**</DNT> Se você estiver usando o Subversion, considere incluir a tag ou o nome da ramificação além da revisão.
      </td>
    </tr>
