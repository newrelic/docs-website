...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        A New Relic <InlinePopover type="licenseKey" />para usar. Por padrão, isso vem da definição no arquivo `newrelic.yml` para o `rails_env` fornecido. Esta **não** é a mesma que sua [chave de API REST](/docs/apis/getting-started/intro-apis/access-rest-api-keys).
      </td>
    </tr>
