...
<CollapserGroup>
  <Collapser id="upgrade" title="Atualize para newrelic_rpm 3.8.0 ou superior">
    Conforme observado acima, as versões 3.8.0 ou superior da gem newrelic\_rpm devem funcionar corretamente automaticamente, independentemente da configuração do seu unicórnio.
  </Collapser>

  <Collapser
    id="upload"
    title={<>Carregar <InlineCode>
      preload_app true
    </InlineCode></>
    }
  >
  ...
  <Collapser id="manual-start" title="Iniciar manualmente o agente">
