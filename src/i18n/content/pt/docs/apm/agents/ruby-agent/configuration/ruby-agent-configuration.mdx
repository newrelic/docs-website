...
O agente Ruby oferece suporte [ao log APM no contexto](/docs/apm/new-relic-apm/getting-started/get-started-logs-context). Para obter algumas dicas sobre como configurar o log para o agente Ruby, consulte [Configurar log Ruby no contexto](/docs/logs/logs-context/configure-logs-context-ruby).
