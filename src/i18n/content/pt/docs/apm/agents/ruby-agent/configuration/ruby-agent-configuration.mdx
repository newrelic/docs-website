...
<CollapserGroup>
  ...
  >
    ...
    O manipulador de saída que envia todos os dados armazenados em cache para o coletor antes do encerramento é instalado à força. Isto é verdade mesmo que detecte cenários onde geralmente não deveria estar. O caso de uso conhecido para esta opção é onde o Sinatra está sendo executado como um serviço incorporado em outra framework e o agente está detectando o aplicativo Sinatra e ignorando o manipulador `at_exit` como resultado. Sinatra normalmente executa o aplicativo inteiro em um bloco `at_exit` e, de outra forma, se comportaria mal se o manipulador `at_exit` do agente também fosse instalado nessas circunstâncias. Nota: `send_data_on_exit` também deve ser definido como `true` em conjunto com esta configuração."
  </Collapser>
...
<CollapserGroup>
  ...
  <Collapser
    id="browser_monitoring-content_security_policy_nonce"
    title="browser_monitoring.content_security_policy_nonce"
  >
    <table>
      <tbody>
        <tr>
...
<CollapserGroup>
  ...
  <Collapser
    id="instrumentation-dynamodb"
    title="instrumentation.dynamodb"
  >
    <table>
      <tbody>
        <tr>
...
<CollapserGroup>
  ...
  >
    ...
    * Ao configurar o agente para [AI Monitoring](/docs/ai-monitoring/intro-to-ai-monitoring), defina o valor máximo `10000`. Isso garante que o agente capture a quantidade máxima de distributed tracing.
  </Collapser>
</CollapserGroup>
