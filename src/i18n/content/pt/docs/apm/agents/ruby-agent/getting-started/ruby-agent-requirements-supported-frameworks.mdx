...
## Detalhes da instância [#instance_details]
...
## Trabalhos em segundo plano [#background_jobs]
...
## Clientes HTTP/rede [#http_network_clients]
...
## Enfileiramento de mensagens [#http_clients]
