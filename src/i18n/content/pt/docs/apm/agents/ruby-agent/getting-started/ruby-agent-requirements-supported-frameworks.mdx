...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Ruby 2.5.x, 2.4.x: Último totalmente suportado pelo agente v9.24.0. <br />Ruby 2.3.x, 2.2.x: Último totalmente suportado pelo agente v8.16.0. <br />Ruby 2.1.x, 2.0.x: Último totalmente suportado pelo agente v6.15.0. <br />Ruby 1.9.3: Último agente v3.18.1. <br />Ruby 1.8.7: Último agente v3.18.1.
      </td>
    </tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Excon \{&apos;&lt;&apos;} 0.55.0: Último totalmente suportado pelo agente v8.16.0.
      </td>
    </tr>
...
O agente pode encaminhar logs das seguintes bibliotecas para [logs APM no contexto](/docs/logs/logs-context/get-started-logs-context/).
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Suporte para encaminhamento de logs APM usando a biblioteca do Logger de Rubby e qualquer biblioteca de logging que herde do Logger de Rubby, como ActiveSupport::BroadcastLogger.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Suporte para encaminhamento de logs APM. Também compatível com `rails_semantic_logger`.
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        O contexto se propagará corretamente dos processos filhos bifurcados de volta para o processo pai.
      </td>
    </tr>
...
Se você tiver dúvidas sobre versões ou bibliotecas específicas não abordadas aqui, visite nosso [fórum da comunidade Explorers Hub](https://support.newrelic.com/).
