...
## Versões Ruby [#ruby_versions][#ruby_versions]
...
## Servidores web [#web_servers][#web_servers]
...
## Web frameworks [#web_frameworks][#web_frameworks]
...
## Detalhes da instância [#instance_details][#instance_details]
...
## Trabalhos em segundo plano [#background_jobs][#background_jobs]
...
## Clientes HTTP/rede [#http_network_clients][#http_network_clients]
...
## Enfileiramento de mensagens [#http_clients][#http_clients]
...
* <DNT>Acts_as_Solr</DNT>: Suportado pela última vez na versão 8.16.0 do agente
