...
Se você tiver dúvidas sobre versões específicas ou bibliotecas não abordadas aqui, visite nosso [fórum da comunidade Explorers Hub](https://support.newrelic.com/).
