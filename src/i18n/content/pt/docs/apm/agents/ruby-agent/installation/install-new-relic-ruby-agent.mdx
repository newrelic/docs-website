...
## Instale a joia [#Installing\_the\_Gem][#Installing_the_Gem]
...
## Instale o arquivo de configuração [#Configuration\_file][#Configuration_file]
...
3. Edite o valor `license_key` para incluir seu <InlinePopover type="licenseKey" />.
...
## Instalar agente fora do ambiente de produção [#Outside\_production\_environments][#Outside_production_environments]
...
## Desinstale a gem do agente Ruby [#Uninstalling\_Gem][#Uninstalling_Gem]
