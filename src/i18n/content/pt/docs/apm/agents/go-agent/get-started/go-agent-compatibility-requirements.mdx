...
O agente oferece suporte a Linux, macOS e Windows. Você também pode usar o agente Go em um [ambiente flexível do Google App Engine (GAE)](/docs/agents/go-agent/get-started/install-new-relic-go-agent-gae-flexible-environment).
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Capture e envie log em dados de contexto do log escrito em zerolog
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Capture e envie log em dados de contexto do log escrito em logrus
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Capture e envie log em dados de contexto do log escrito no pacote log da biblioteca padrão
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Servidores, clientes, editores e assinantes do instrumento por meio da frameworkMicro
      </td>
    </tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        [<InlinePopover type="browser"/>](/docs/browser/new-relic-browser/getting-started/introduction-new-relic-browser)
      </td>
