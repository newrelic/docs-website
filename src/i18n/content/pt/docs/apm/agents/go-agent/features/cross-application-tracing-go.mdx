...
<Callout variant="important">
  [distributed tracing](/docs/apm/distributed-tracing/getting-started/introduction-distributed-tracing) já está disponível. distributed tracing é uma melhoria no rastreamento multiaplicativo e é recomendado para sistemas distribuídos grandes.
</Callout>
...
<CollapserGroup>
  ...
  >
    ...
    Entretanto, uma transação foi iniciada sem que as chamadas para `Transaction.SetWebRequest` e `Transaction.SetWebResponse` <DoNotTranslate>**will not**</DoNotTranslate> tivessem CAT ativado:
