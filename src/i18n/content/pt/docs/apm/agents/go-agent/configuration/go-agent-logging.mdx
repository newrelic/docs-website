...
New Relic oferece uma [integração para o sistema de registro Logrus](https://github.com/newrelic/go-agent/blob/master/_integrations/nrlogrus/nrlogrus.go). Aqui está um exemplo de uso da integração New Relic Logrus em um aplicativo:
