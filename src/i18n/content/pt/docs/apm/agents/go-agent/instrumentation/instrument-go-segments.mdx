...
<CollapserGroup>
  ...
  >
    <DNT>**Recommendation:**</DNT> Use o auxiliar `StartExternalSegment`, pois New Relic o utiliza para trace atividades entre seu aplicativo usando [Distributed tracing](/docs/agents/go-agent/features/distributed-tracing-go).
