...
O rastreamento distribuído permite que você visualize toda a jornada das suas requisições em um [sistema distribuído](/docs/distributed-tracing/concepts/introduction-distributed-tracing). Para o agente Go, oferecemos dois tipos de rastreamento distribuído (para mais detalhes, consulte [Como funciona a amostragem de span](/docs/distributed-tracing/concepts/how-new-relic-distributed-tracing-works/#sampling)):
