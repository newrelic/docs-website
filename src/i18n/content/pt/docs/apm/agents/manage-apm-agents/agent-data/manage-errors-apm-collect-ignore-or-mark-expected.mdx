...
* <DNT>**Go**</DNT>: [`NoticeError()`](https://github.com/newrelic/go-agent/blob/master/transaction.go)
* <DNT>**Java**</DNT>: [`NoticeError()`](http://newrelic.github.io/java-agent-api/javadoc/index.html?com/newrelic/api/agent/NewRelic.html)
* <DNT>**.NET**</DNT>: [`NoticeError()`](/docs/agents/net-agent/net-agent-api/notice-error)
* <DNT>**Node.js**</DNT>: [`noticeError()`](/docs/apm/agents/nodejs-agent/api-guides/nodejs-agent-api/#noticeError)
