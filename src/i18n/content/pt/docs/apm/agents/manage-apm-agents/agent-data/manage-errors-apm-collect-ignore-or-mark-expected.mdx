...
<CollapserGroup>
  <Collapser
    ...
    title="Erro ignorado ao usar configuração no lado do servidor na interface"
  >
    ...
    2. [Acesse o menu ](/docs/agents/manage-apm-agents/configuration/server-side-agent-configuration#customize-ssc)

       <DoNotTranslate>[**Server-side configuration**](/docs/agents/manage-apm-agents/configuration/server-side-agent-configuration#customize-ssc)</DoNotTranslate>

       [ ](/docs/agents/manage-apm-agents/configuration/server-side-agent-configuration#customize-ssc)do aplicativo que contém erros que você deseja ignorar.

    3. Em

       <DoNotTranslate>**Error collection**</DoNotTranslate>

       , procure

       <DoNotTranslate>**Ignore from error collection**</DoNotTranslate>

       . Adicione

       <DoNotTranslate>**HTTP code**</DoNotTranslate>

       ou

       <DoNotTranslate>**Error class**</DoNotTranslate>

       para os erros que você deseja ignorar.

    4. Selecione

       <DoNotTranslate>**Save server-side configuration**</DoNotTranslate>
  ...
  <Collapser
    ...
    title="Erro ignorado ao usar a configuração do agente"
  >
    ...
    * <DoNotTranslate>**Java**</DoNotTranslate>
      ...
      : `error_collector.ignore_classes`, `error_collector.ignore_classes.message` ou `error_collector.ignore_status_codes`. Para obter informações adicionais, consulte [Configuração de erro do agente Java](/docs/agents/java-agent/configuration/java-agent-error-configuration).

    * <DoNotTranslate>**.NET**</DoNotTranslate>

      : [`ignoreErrors`](/docs/apm/agents/net-agent/configuration/net-agent-configuration/#error-ignoreErrors) ou [`ignoreStatusCodes`](/docs/apm/agents/net-agent/configuration/net-agent-configuration/#error-ignoreStatusCodes).

    * <DoNotTranslate>**Node.js**</DoNotTranslate>

      : `ignore_status_codes`, [`ignore_classes`](/docs/agents/nodejs-agent/installation-configuration/nodejs-agent-configuration#error_ignore) ou [`ignore_messages`](/docs/agents/nodejs-agent/installation-configuration/nodejs-agent-configuration#error_ignore).

    * <DoNotTranslate>**PHP**</DoNotTranslate>

      : [`error_collector.ignore_exceptions`](/docs/apm/agents/php-agent/configuration/php-agent-configuration/#inivar-err-ignore-exceptions) ou [`error_collector.ignore_errors`](/docs/apm/agents/php-agent/configuration/php-agent-configuration/#inivar-err-ignore-errors).

    * <DoNotTranslate>**Python**</DoNotTranslate>

      : [`error_collector.ignore_classes`](/docs/agents/python-agent/configuration/python-agent-configuration/#error-ignore) ou [`error_collector.ignore_status_codes`](/docs/agents/python-agent/configuration/python-agent-configuration/#error-ignore-status-codes).
...
* [.LÍQUIDO](/docs/apm/agents/net-agent/configuration/net-agent-configuration/#error_collector)
* [Ir](/docs/apm/agents/go-agent/configuration/go-agent-configuration/#error-collector)
* [Python](/docs/agents/python-agent/configuration/python-agent-configuration/#error-collector-settings)

Se erro esperado estiver habilitado, a página [<DoNotTranslate>**Error analytics**</DoNotTranslate>](/docs/apm/applications-menu/error-analytics/error-analytics-explore-events-behind-errors) do APM terá, por padrão, um filtro aplicado com o atributo `error.expected` definido como `false`, o que significa que erro esperado não será exibido. Para visualizar o erro esperado, desative o filtro `error.expected` .
...
* [Página ](/docs/apm/applications-menu/monitoring/apm-overview-page)

  <DoNotTranslate>[**Overview**](/docs/apm/applications-menu/monitoring/apm-overview-page)</DoNotTranslate>

  [ do APM](/docs/apm/applications-menu/monitoring/apm-overview-page): mostra uma visualização de alto nível do seu aplicativo, que inclui erros.
