...
<CollapserGroup>
  ...
  >
    ...
    2. [Acesse o menu ](/docs/agents/manage-apm-agents/configuration/server-side-agent-configuration#customize-ssc)
       ...
       <DNT>[**Server-side configuration**](/docs/agents/manage-apm-agents/configuration/server-side-agent-configuration#customize-ssc)</DNT>
    ...
    3. Em
       ...
       <DNT>**Ignore from error collection**</DNT>
    ...
    4. Selecione
       ...
       <DNT>**Save server-side configuration**</DNT>
