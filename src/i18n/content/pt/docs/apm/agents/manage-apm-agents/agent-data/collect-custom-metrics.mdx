    ...
    <tr>
      ...
      <td>
        ...
        * <DNT>
          ...
          [`record_custom_metric` e `register_data_source`](/docs/python/python-custom-metrics)

        * <DNT>
            **Ruby:**
          </DNT>

          [`record_metric` e `increment_metric`](/docs/ruby/ruby-custom-metrics)
      </td>
    </tr>
...
## Evite problemas de agrupamento [#best_practices]
