...
<Callout variant="important">
  Os dados de rastreamento da sessão serão <DNT>**only**</DNT> reportados ao primeiro aplicativo listado. Outros dados do browser serão preenchidos em cada um dos três aplicativos, mas os dados de rastreamento da sessão serão limitados ao aplicativo mais específico.
</Callout>
