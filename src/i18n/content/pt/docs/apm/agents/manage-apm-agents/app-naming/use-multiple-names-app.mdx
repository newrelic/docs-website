...
Normalmente, quando duas instâncias relatam com o mesmo nome de aplicativo, idioma do agente e [chave de licença](/docs/apis/intro-apis/new-relic-api-keys/#ingest-license-key), a New Relic agrega seus dados em um único aplicativo monitor da New Relic. Você também pode visualizar dados de hosts e instâncias individuais na [página New Relic APM <DoNotTranslate>**Overview**</DoNotTranslate> ](/docs/apm/applications-menu/monitoring/apm-overview-page#infra-server)do aplicativo.
...
<Callout variant="important">
  Os dados de rastreamento da sessão serão <DoNotTranslate>**only**</DoNotTranslate> reportados ao primeiro aplicativo listado. Outros dados do browser serão preenchidos em cada um dos três aplicativos, mas os dados de rastreamento da sessão serão limitados ao aplicativo mais específico.
</Callout>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Identifique no máximo três nomes separados por ponto e vírgula `;` em sua [configuração newrelic_app_config_t\*;](/docs/agents/c-sdk/install-configure/install-c-sdk-compile-link-your-code#app-name).
      </td>
    </tr>
...
<CollapserGroup>
  <Collapser
    id="example1"
    title="Um aplicativo, três clusters"
  >
  ...
  <Collapser
    id="example2"
    title="Duas instâncias de um aplicativo"
  >
    ...
    * Dois aplicativos: um para cada datacenter (`East` e `West`)
