...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        [Evento do navegador](/docs/insights/insights-data-sources/default-events-attributes/browser-default-events-attributes-insights)
      </td>
...
* [Pitão](/docs/agents/python-agent/attributes/python-agent-attributes)
