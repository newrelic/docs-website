...
<Steps>
  ...
  <Step>
    ...
    O gráfico de log fornece uma visão resumida do log do seu aplicativo relatado por meio do nosso recurso [de logs contextualizados](/docs/logs/logs-context/get-started-logs-context/) . Clicar em <DoNotTranslate>**Logs**</DoNotTranslate> leva você para a [interface de registro](/docs/logs/ui-data/use-logs-ui/) completa .
    ...
    Com o logs contextualizados, seu log individual é marcado com a entidade ou serviço ao qual está relacionado. No gráfico de log você pode selecionar <DoNotTranslate>**Log patterns (top 10)**</DoNotTranslate> para exibir grupos de log que são idênticos até o identificador de string exclusivo.
