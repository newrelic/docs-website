...
Este documento mostra um exemplo _fictício_ de como usar as ferramentas APM da New Relic para determinar a causa raiz da degradação do serviço. Você explorará uma situação em que <DNT>**you work for a fictional e-commerce company that sells shoes**</DNT>. Você é gerente de engenharia da equipe de checkout. Os clientes reclamam que precisam esperar muito para finalizar a compra.
