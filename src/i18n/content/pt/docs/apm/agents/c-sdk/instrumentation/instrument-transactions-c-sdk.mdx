---
title: Instrumento de transação com o C SDK
...
1. Adicione o seguinte código imediatamente <DoNotTranslate>**before**</DoNotTranslate> à transação que você deseja monitor:
...
2. Adicione imediatamente o seguinte código <DoNotTranslate>**after**</DoNotTranslate> à web ou transação fora da web que você deseja monitor:

   ```c
   newrelic_end_transaction(&txn);
   ```

## Segmentos e erros do instrumento [#segments-errors]
