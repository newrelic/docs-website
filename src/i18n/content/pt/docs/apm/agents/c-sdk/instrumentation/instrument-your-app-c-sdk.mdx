...
2. Adicione `newrelic_end_transaction()` imediatamente <DNT>**after**</DNT> à transação fora da web que você deseja monitor, fornecendo um ponteiro para a transação, `&txn`, como parâmetro.
