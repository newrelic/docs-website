...
* <DNT>**C SDK logs:**</DNT> Esses logs são gerados devido a erros na forma como você instrumentou seu código usando a chamada de API do New Relic C SDK.
* <DNT>**Daemon logs:**</DNT> Estes são registros relacionados à transmissão de dados para a New Relic.
...
<CollapserGroup>
  <Collapser id="c-sdk-logs" title="Registro do SDK C">
  ...
  <Collapser id="daemon-logs" title="Registro do daemon">
