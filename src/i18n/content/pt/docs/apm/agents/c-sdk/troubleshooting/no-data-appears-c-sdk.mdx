...
2. Certifique-se de que o [processo daemon (`newrelic-daemon`)](/docs/install-c-sdk-compile-link-your-code#daemon) esteja ativo e em execução para que seja chamado <DoNotTranslate>**before**</DoNotTranslate> iniciando seu aplicativo instrumentado.
