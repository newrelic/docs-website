...
<CollapserGroup>
  ...
  >
    ...
    2. Verifique a saída nos arquivos `c_sdk.log` e `newrelic-daemon.log` .
       ...
       A arquitetura do C SDK exige que o daemon seja invocado primeiro <DoNotTranslate>**before**</DoNotTranslate> quando seu aplicativo instrumentado for invocado.
