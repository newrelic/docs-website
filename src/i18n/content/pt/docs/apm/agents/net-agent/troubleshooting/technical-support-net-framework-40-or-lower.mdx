...
<Callout variant="important">
  A New Relic fornece <DoNotTranslate>**limited technical support**</DoNotTranslate> para clientes que usam o .NET framework 4.0 ou inferior.
</Callout>
...
<Callout variant="important">
  O aplicativo em execução no .NET framework versão 4.0 ou inferior requer uma versão do agente .NET New Relic <DoNotTranslate>**lower than 7.0**</DoNotTranslate>.
</Callout>
