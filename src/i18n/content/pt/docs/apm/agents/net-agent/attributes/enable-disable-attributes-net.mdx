...
<CollapserGroup>
  ...
  >
    O elemento `analyticsEvents` em <DoNotTranslate>**newrelic.config**</DoNotTranslate> está obsoleto. Habilite o elemento [`transactionEvents`](/docs/agents/net-agent/installation-configuration/net-agent-configuration#transaction_events) em <DoNotTranslate>**newrelic.config**</DoNotTranslate>:
