...
1. Na barra de navegação do console Kudu, selecione o menu
   ...
   <DoNotTranslate>**Debug console**</DoNotTranslate>

   e selecione

   <DoNotTranslate>**CMD**</DoNotTranslate>

   ou

   <DoNotTranslate>**PowerShell**</DoNotTranslate>
...
1. Na barra de tarefas do Windows, selecione
   ...
   <DoNotTranslate>**Start > Run**</DoNotTranslate>
...
2. Depois que a página de informações do sistema for carregada, selecione
   ...
   <DoNotTranslate>**File > Save**</DoNotTranslate>
