...
<CollapserGroup>
  ...
  >
    ...
    Envie mensagem do log para o console, além do arquivo de log. Como alternativa, defina a variável de ambiente `NEW_RELIC_LOG_CONSOLE` no ambiente do aplicativo.
  </Collapser>
  ...
  >
    ...
    Se desativado, nenhum registro será tentado. Destinado a sistemas de arquivos somente leitura. Como alternativa, defina a variável de ambiente `NEW_RELIC_LOG_ENABLED` no ambiente do aplicativo.
  </Collapser>
