...
* Se não houver resultados, é necessário definir as [variáveis de ambiente](https://support.newrelic.com/s/hubtopic/aAX8W0000008a6F/relic-solution-net-core-agent-required-environment-variables), reiniciar o aplicativo e voltar para a Etapa 1.
...
Se as etapas acima não solucionaram o problema, recomendamos entrar em contato com o suporte ou pedir ajuda no [Fórum de Suporte](https://support.newrelic.com/s/).