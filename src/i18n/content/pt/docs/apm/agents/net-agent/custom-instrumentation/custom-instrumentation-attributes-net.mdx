...
* [Solucionar problemas de instrumentação personalizada baseada em atributo](https://support.newrelic.com/s/hubtopic/aAX8W0000008a5g/relic-solution-troubleshooting-attributebased-custom-instrumentation-issues)
* [Construir instrumentação personalizada tracer factorys from .NET agent arquivo de log](https://knowledge.newrelic.com/s/article/Building-Custom-Instrumentation-Tracer-Factories-From-dot-NET-Agent)
