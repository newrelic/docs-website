...
<DoNotTranslate>**Exception:**</DoNotTranslate> Para conflitos com o System Center Operations Manager (SCOM) da Microsoft, siga os [procedimentos de resolução de problemas específicos para SCOM](/docs/agents/net-agent/troubleshooting/resolve-net-scom-conflicts).
...
<CollapserGroup>
  ...
  >
    ...
    1. Execute <DoNotTranslate>**Process Explorer**</DoNotTranslate> como administrador.

    2. Para encontrar o processo do seu aplicativo, clique com o botão direito no aplicativo e selecione <DoNotTranslate>**Properties > Environment**</DoNotTranslate>.
  ...
  >
    Se o profiler conflitante tiver sido desativado e ainda houver um problema, compare as chaves do registro com [<DoNotTranslate>**Process Explorer**</DoNotTranslate>](https://technet.microsoft.com/en-us/sysinternals/bb896653.aspx) para ver qual profiler está presente. Na máquina onde você está enfrentando esse problema, verifique <DoNotTranslate>**WAS**</DoNotTranslate> e <DoNotTranslate>**W3SVC REG**</DoNotTranslate> para aplicativos IIS ou verifique suas chaves de serviço ou chaves de aplicativos não IIS.
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Se estiver usando <DoNotTranslate>**cmd**</DoNotTranslate>, faça o seguinte para <DoNotTranslate>**WAS**</DoNotTranslate> e <DoNotTranslate>**W3SVC REG**</DoNotTranslate> ou para seu aplicativo de serviço/não IIS. Aqui está um exemplo de um aplicativo IIS:
