...
<CollapserGroup>
  ...
  >
    Para o pacote NuGet, as variáveis de ambiente [devem ser adicionadas como configurações do aplicativo](/docs/apm/agents/net-agent/azure-installation/install-net-agent-azure-web-apps/#nuget-install-net-core). As variáveis de ambiente que aparecem na guia <DNT>**Environment**</DNT> no <DNT>**Process Explorer**</DNT> do Kudu devem ser semelhantes a estas:
