...
* Para framework instrumentado automaticamente para ..NET Core e .NET framework, consulte nossa [página de compatibilidade](/docs/apm/agents/net-agent/getting-started/net-agent-compatibility-requirements/).
