...
O agente .NET da New Relic oferece suporte tanto ao .NET Framework quanto ao ..NET Core. Este documento descreve a compatibilidade e o suporte para o aplicativo ..NET Core.
...
<Tabs>
  ...
  <TabsPages>
    <TabsPageItem id="1">
      ...
      <CollapserGroup>
        <Collapser className="freq-link" id="net-version" title="Versão do .NET Core">
