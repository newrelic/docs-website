  ...
  <TabsPages>
    ...
    <TabsPageItem id="2">
      ...
      <CollapserGroup>
        ...
        <Collapser className="freq-link" id="azure" title="Microsoft Azure">
          Para obter instruções de instalação específicas do Azure, consulte o [guia de instalação do .NET](/install/dotnet/).
        </Collapser>
        ...
        <Collapser className="freq-link" id="other-apm" title="Uso de outro software de monitoramento">
      ...
      <CollapserGroup>
        ...
        <Collapser className="freq-link" id="binding-types" title="Tipos de encadernação">
        ...
        <Collapser className="freq-link" id="hosting-models" title="Modelos de hosting">
        ...
        <Collapser className="freq-link" id="hosting-models" title="Modelos de invocação">
        ...
        <Collapser className="freq-link" id="unsupported-frameworks" title="Estrutura não suportada">
