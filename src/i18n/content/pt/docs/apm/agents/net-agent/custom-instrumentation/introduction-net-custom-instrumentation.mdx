...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <DoNotTranslate>**Create a new transaction.**</DoNotTranslate> Para obter detalhes, consulte:
    ...
    <tr>
      ...
      <td>
        <DoNotTranslate>**Add detail to an existing transaction.**</DoNotTranslate> Para obter detalhes, consulte:
...
Ao criar uma transação via instrumentação personalizada utilizando o [método de atributo](#ci-methods), você deve categorizá-la como <DoNotTranslate>**web**</DoNotTranslate> ou <DoNotTranslate>**non-web**</DoNotTranslate>. (Isso não é possível com instrumentação XML; todas as transações criadas em XML são classificadas como <DoNotTranslate>**non-web**</DoNotTranslate>.)
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Use <DoNotTranslate>**web**</DoNotTranslate> para solicitações da web. Você só pode marcar novas transações como transações da web com [instrumentação personalizada usando atributo](/docs/agents/net-agent/api-guides/custom-instrumentation-attributes-net) e não usando XML.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Use <DoNotTranslate>**non-web**</DoNotTranslate> para outros tipos de solicitações em segundo plano, como aplicativos e serviços de console.
