...
3. Siga as instruções do gerenciador de pacote apropriado para seu sistema Linux:
   ...
   <CollapserGroup>
     <Collapser id="clamshell_debian_ubuntu_mint_aptget" title="Atualize com apt (Debian, Linux Mint ou Ubuntu)">
     ...
     <Collapser id="clamshell_debian_ubuntu_mint_dpkg" title="Atualize com dpkg (Debian, Linux Mint ou Ubuntu)">
       1. Vá para <DNT>**[download.newrelic.com/dot\_net\_agent/latest\_release](https://download.newrelic.com/dot_net_agent/latest_release/)**</DNT> e copie o URL que corresponde à sua [arquitetura](/docs/agents/net-agent/getting-started/compatibility-requirements-net-agent#architecture) e ao `newrelic-dotnet-agent` mais recente .deb pacote.
     ...
     <Collapser id="clamshell_centos_rhel_oracle_yum" title="Atualize com yum (CentOS, Oracle Linux ou RHEL)">
       <Callout variant="important">
     ...
     <Collapser id="clamshell_centos_rhel_oracle_rpm" title="Atualizar com rpm (CentOS, Oracle Linux ou RHEL)">
       <Callout variant="important">
         Atualmente, a New Relic não oferece pacotes rpm Linux para ARM64. Em vez disso, [aproveite o tarball para instalar](#clamshell_tarball) nesta plataforma.
       </Callout>

       1. Vá para [download.newrelic.com/dot\_net\_agent/latest\_release](https://download.newrelic.com/dot_net_agent/latest_release/), e copie o URL que corresponde à sua [arquitetura](/docs/agents/net-agent/getting-started/compatibility-requirements-net-agent#architecture) e ao `newrelic-dotnet-agent` .rpm mais recente pacote.
