...
<CollapserGroup>
  ...
  >
    ...
    >
      ...
      * [.NET versão 5](https://devblogs.microsoft.com/dotnet/dotnet-5-end-of-support-update/) em 10 de maio de 2022
        ...
        As datas oficiais de início e término do ciclo de vida do produto podem ser encontradas na [documentação da Microsoft](https://dotnet.microsoft.com/en-us/platform/support/policy/dotnet-core). Nosso suporte ao agente .NET para essas versões framework termina com o agente .NET 9.x New Relic mais recente. A partir do agente New Relic .NET versão 10.0, iremos destinar o .NET Core 3.1 em diante.
    </Callout>

    O agente .NET oferece suporte às versões 2.0, 2.1, 2.2, 3.0, 3.1 do .NET Core e .NET 5.0, 6.0, 7.0 e 8.0.
    ...
    <Callout variant="important">
      Na plataforma Linux ARM64, o agente .NET <DoNotTranslate>**only**</DoNotTranslate> suporta versões do .NET 5.0 ou superior.
    </Callout>

    O agente **não** é compatível com as versões 1.0 ou 1.1 do .NET Core. Para aplicativos .NET Core 2.1 ou superior com compilação de nível habilitada, o agente desabilitará a compilação de nível. O suporte do .NET Core 2.1 requer o tempo de execução do .NET Core 2.1.3 e SDK do .NET Core 2.1.401 ou superior devido a [um bug na API de criação de perfil do .NET Core](https://github.com/dotnet/coreclr/issues/18448).
  </Collapser>
  ...
  >
    O agente .NET oferece suporte apenas a aplicativos direcionados ao .NET Core 2.0, 2.1, 2.2, 3.0, 3.1 e .NET 5.0, 6.0, 7.0 e 8.0. Você pode encontrar a framework de destino no arquivo `.csproj`. A compatibilidade do agente varia entre diferentes versões do .NET Core. Para obter informações sobre qual versão do agente usar para a versão de destino do .NET Core do seu aplicativo, consulte a seção acima de nossa documentação, <DoNotTranslate>**[Microsoft .NET Core version](/docs/apm/agents/net-agent/getting-started/net-agent-compatibility-requirements-net-core/#net-version)**</DoNotTranslate>.
    ...
    <Callout variant="important">
      Na plataforma Linux ARM64, o agente .NET <DoNotTranslate>**only**</DoNotTranslate> suporta estrutura de destino de `net5.0` ou superior.
    </Callout>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            * Versões compatíveis verificadas: 4.0.13
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            * Versões compatíveis verificadas: 3.5.2, 3.6.9, 4.1.3, 5.1.0, 5.2.0, 6.0.0, 6.2.1, 6.4.0, 6.5.0, 6.6.0
          </td>
        </tr>
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        Para outros tipos de aplicativos da web, você pode injetar o agente <InlinePopover type="browser"/>usando a [API do agente .NET](/docs/agents/net-agent/net-agent-api/get-browser-timing-header) ou o [método copiar/colar do browser do agente](/docs/browser/new-relic-browser/installation/install-new-relic-browser-agent#copy-paste-app).
