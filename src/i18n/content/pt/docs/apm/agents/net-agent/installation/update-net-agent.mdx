    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Anteriormente, [banco de dados](/docs/apm/apm-ui-pages/monitoring/databases-page-view-operations-throughput-response-time/) e chamadas [externas](/docs/apm/apm-ui-pages/monitoring/external-services/external-services-intro/) que ocorriam fora de uma transação geravam métricas que você podia visualizar em suas respectivas páginas na interface do APM. Agora essas métricas não serão exibidas. Em um aplicativo não web essas chamadas podem ser “envolvidas” em uma [transação customizada](/docs/apm/agents/net-agent/custom-instrumentation/create-transactions-xml-net/) para poder visualizar sua métrica.
          </td>
        </tr>
        ...
        <tr id="500">
          ...
          <td>
            ...
            A [instrumentação personalizada](/docs/apm/agents/net-agent/custom-instrumentation/introduction-net-custom-instrumentation/) pode precisar ser atualizada para usar [transações personalizadas](/docs/apm/agents/net-agent/custom-instrumentation/create-transactions-xml-net/). Para obter um exemplo do que será exibido na interface, consulte esta [postagem da Comunidade Técnica Online da New Relic](https://support.newrelic.com/s/hubtopic/aAX8W0000008YBU/change-in-nonweb-transaction-reporting-with-version-5x).
          </td>
        </tr>
