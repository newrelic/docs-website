...
3. Execute estes comandos <DoNotTranslate>**each**</DoNotTranslate> sempre que reiniciar o servidor ou crie um script de inicialização para restaurar essas configurações.

4. Recicle seu pool de aplicativos ou, em um prompt de comando, execute <DoNotTranslate>**`IISRESET`**</DoNotTranslate>.
