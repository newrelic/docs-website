...
<CollapserGroup>
  ...
  >
    ...
    <Callout variant="caution">
      Siga estas etapas cuidadosamente. Podem ocorrer problemas sérios se você modificar o registro incorretamente. <DNT>**Recommendation:**</DNT> Antes de modificar o registro, faça um backup.
    </Callout>
