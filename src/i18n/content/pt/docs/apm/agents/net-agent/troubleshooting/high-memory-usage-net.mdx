...
Depois de instalar o agente .NET da New Relic, você verá um aumento no uso de memória `Working Set` em ferramentas de monitoramento como o Microsoft Windows <DoNotTranslate>**Task Manager**</DoNotTranslate>. O aumento geralmente é de cerca de 100 MB por aplicativo de monitor. Isso pode ocorrer tanto na máquina física quanto na máquina virtual.
...
* Monitor o desempenho para ver se o aumento do uso de memória mostrado em
  ...
  <DoNotTranslate>**Task Manager**</DoNotTranslate>
