...
O observador trace é um serviço New Relic baseado em AWSque coleta e analisa todos os seus traces. Siga as instruções em <a href="/docs/understand-dependencies/distributed-tracing/infinite-tracing/set-trace-observer" target="_blank">Configurar o observador trace </a>. Quando terminar, retorne aqui com as informações do seu observador trace e continue com a próxima etapa para configurar o agente.
...
<CollapserGroup>
  <Collapser id="dot-net-version" title="Compatibilidade .NET do agente">
...
<CollapserGroup>
  <Collapser id="dot-net-config-standard" title="Configuração do agente .NET">
