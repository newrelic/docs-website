...
<CollapserGroup>
  ...
  >
    ...
    1. No servidor onde seu aplicativo está instalado, [faça download do Microsoft Windows <DoNotTranslate>**Sysinternals Process Explorer**</DoNotTranslate>](https://technet.microsoft.com/en-us/sysinternals/bb896653.aspx).

    2. Descompacte o arquivo e execute `procexp.exe` como administrador.

    3. Selecione <DoNotTranslate>**View > Show Lower Pane**</DoNotTranslate> e depois selecione <DoNotTranslate>**View > Lower Pane View > DLLs**</DoNotTranslate>.

    4. Gere algum tráfego para seu aplicativo.

    5. Para atualizar a lista de processos, selecione <DoNotTranslate>**View > Refresh Now**</DoNotTranslate>.
  ...
  >
    ...
    <table>
      ...
      <tbody>
        <tr>
          <td>
            Defina permissões para o grupo <DoNotTranslate>**Everyone**</DoNotTranslate> .
          </td>

          <td>
            Ajuste as permissões nas seguintes pastas do grupo <DoNotTranslate>**Everyone**</DoNotTranslate> para conceder ao grupo todas as permissões <DoNotTranslate>**except**</DoNotTranslate> `Full Control`:
        ...
        <tr>
          ...
          <td>
            Se suas políticas de segurança não permitirem o ajuste de permissões para o grupo <DoNotTranslate>**Everyone**</DoNotTranslate> , ajuste as permissões para usuários individuais. Registre o usuário sob o qual seu aplicativo é executado e ajuste as permissões para cada um desses usuários.
          </td>
        </tr>
