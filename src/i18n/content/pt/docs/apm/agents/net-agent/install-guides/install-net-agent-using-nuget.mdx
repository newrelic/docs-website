...
Aqui está um exemplo de uso do NuGet via Visual Studio para instalar o agente .NET: (Você também pode encontrar um exemplo semelhante em nosso [repositório de amostras de agente .NET](https://github.com/newrelic/newrelic-dotnet-examples/tree/main/elastic-beanstalk).
