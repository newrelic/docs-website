...
<CollapserGroup>
  ...
  >
    ...
    <Callout variant="important">
      Se o nome do aplicativo estiver aparecendo no New Relic, mas nenhuma transação estiver aparecendo, é provável que nenhum tráfego esteja atingindo o aplicativo ou o agente não esteja encontrando uma [framework conhecida](/docs/apm/agents/net-agent/getting-started/net-agent-compatibility-requirements-net-core/#app-frameworks) que possa instrumentar automaticamente.
