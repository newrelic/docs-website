...
<CollapserGroup>
  ...
  <Collapser id="env-var-core" title=".NET Core: verifique variáveis de ambiente">
    ...
    <Callout variant="tip">
      Para obter dicas sobre como definir essa variável de ambiente por processo em vez de em todo o sistema, consulte [nossa publicação no fórum sobre a definição de variáveis de ambiente](https://knowledge.newrelic.com/s/article/Setting-dot-NET-Core-agent-environment-variables-per-process).
    </Callout>
  </Collapser>
</CollapserGroup>
