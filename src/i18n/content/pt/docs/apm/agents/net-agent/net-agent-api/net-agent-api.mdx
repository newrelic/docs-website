...
<CollapserGroup>
  ...
  <Collapser id="GetBrowserTimingHeader" title="GetBrowserTimingHeader">
    ...
    * Deve ser chamado dentro de uma [transação](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#transaction).
    ...
    <CollapserGroup>
      <Collapser id="with-aspx" title="Com ASPX">
        ```aspnet
        <html>
        <head>
            <%= NewRelic.Api.Agent.NewRelic.GetBrowserTimingHeader()%>
      ...
      <Collapser id="with-razor" title="Com navalha">
        ```cshtml
        <!DOCTYPE html>
        <html lang="en">
        <head>
      ...
      <Collapser id="with-blazor" title="Com Blazor">
  ...
  <Collapser id="ITransaction" title="ITransação">
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            Aceita cabeçalhos de contexto de entrada para trace de outro serviço (veja abaixo para mais detalhes).
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Adiciona cabeçalhos de contexto do trace a uma solicitação de saída (veja abaixo para mais detalhes).
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Aceita uma carga distributed trace recebida de outro serviço (veja abaixo para mais detalhes).
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Cria uma carga distributed trace para inclusão em uma solicitação de saída (veja abaixo para mais detalhes).
          </td>
        </tr>
    ...
    <CollapserGroup>
      ...
      <Collapser id="AcceptDistributedTracePayload" title="AcceptDistributedTracePayload (obsoleto)">
      ...
      <Collapser id="CreateDistributedTracePayload" title="CreateDistributedTracePayload (obsoleto)">
        <Callout variant="caution">
      ...
      <Collapser id="AddCustomAttribute" title="AdicionarAtributoCustom">
        ### Sintaxe
  ...
  <Collapser id="ISpan" title="ISpan">
    ...
    * A propriedade `CurrentSpan` em [`ITransaction`](/docs/apm/agents/net-agent/net-agent-api/net-agent-api/#ITransaction).
    ...
    <CollapserGroup>
      <Collapser id="ISpanAddCustomAttribute" title="AdicionarAtributoCustom">
  ...
  <Collapser id="NoticeError" title="NoticeError">
    ...
    * Todos os tipos de aplicativos
    ...
    <CollapserGroup>
      <Collapser id="exception-overload" title="NoticeError (Exceção)">
        ```cs
        NewRelic.Api.Agent.NewRelic.NoticeError(Exception $exception)
        ```
      ...
      <Collapser id="exception-idictionary-overload" title="NoticeError(Exception, IDictionary)">
        ```cs
        NewRelic.Api.Agent.NewRelic.NoticeError(Exception $exception, IDictionary<TKey, TValue> $attributes)
        ```
      ...
      <Collapser id="string-idictionary-bool-overload" title="NoticeError(String, IDictionary, bool)">
        ```cs
        NewRelic.Api.Agent.NewRelic.NoticeError(string $error_message, IDictionary<TKey, TValue> $attributes, bool $is_expected)
        ```
