...
<CollapserGroup>
  ...
  <Collapser id="ITransaction" title="ITransação">
    ...
    <CollapserGroup>
      ...
      <Collapser id="" title="AcceptDistributedTracePayload (obsoleto)">
      ...
      <Collapser id="" title="CreateDistributedTracePayload (obsoleto)">
        <Callout variant="caution">
      ...
      <Collapser id="" title="AdicionarAtributoCustom">
        ### Sintaxe
      ...
      <Collapser id="" title="Período Atual">
      ...
      <Collapser id="" title="DefinirUserId">
        ### Sintaxe
      ...
      <Collapser id="" title="Segmento de armazenamento de dados de registro">
        ### Sintaxe
  ...
  <Collapser id="ISpan" title="ISpan">
    ...
    * A propriedade `CurrentSpan` em [`ITransaction`](/docs/apm/agents/net-agent/net-agent-api/net-agent-api/#ITransaction).
    ...
    <CollapserGroup>
      ...
      <Collapser id="" title="Nome do conjunto">
