...
Para um passo a passo completo e executável, incluindo exemplos de antipadrões verificados na compilação, consulte o [exemplo de injeção de dependência de API](https://github.com/newrelic/newrelic-dotnet-examples/tree/main/api-dependency-injection) no repositório `newrelic-dotnet-examples`.
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                Serializado como um array JSON. Elementos individuais seguem as mesmas regras de conversão de tipos acima. Elementos nulos são filtrados. Arrays vazios e arrays contendo apenas valores nulos não são registrados. Requer o agente .NET versão 10.50.0 ou superior.
              </td>
            </tr>
