...
Se você estiver usando o nível <DoNotTranslate>**Standard**</DoNotTranslate> ou <DoNotTranslate>**Basic**</DoNotTranslate> da Microsoft com o Portal do Azure, certifique-se de que a configuração `Always On` esteja desabilitada.
...
Aqui estão algumas outras opções que você pode tentar. Se isso não funcionar, <DoNotTranslate>**must**</DoNotTranslate> [desative a configuração `Always On` ](#4-0-framework).
...
<CollapserGroup>
  ...
  >
    Para nomear seu aplicativo no <DoNotTranslate>**`newrelic.config`**</DoNotTranslate> local usando Kudu:

    1. No Portal do Microsoft Azure, selecione <DoNotTranslate>**(your app) > Tools > Kudu**</DoNotTranslate> e selecione <DoNotTranslate>**Go**</DoNotTranslate>.

    2. Selecione <DoNotTranslate>**Debug Console > CMD**</DoNotTranslate>.

    3. Selecione <DoNotTranslate>**Site > wwwroot > newrelic**</DoNotTranslate>.
