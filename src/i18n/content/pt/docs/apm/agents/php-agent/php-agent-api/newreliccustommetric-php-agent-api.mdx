...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Obrigatório. Nomeie sua métrica personalizada com um prefixo <DoNotTranslate>**Custom/**</DoNotTranslate> (por exemplo, <DoNotTranslate>**Custom/MyMetric**</DoNotTranslate>). Isto ajuda a interface a organizar suas métricas personalizadas em um só lugar, e torna-as facilmente encontráveis através do métrica Explorer.
      </td>
    </tr>
