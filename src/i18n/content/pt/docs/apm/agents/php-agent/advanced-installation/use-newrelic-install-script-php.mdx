...
<CollapserGroup>
  ...
  >
    Invoque o modo de instalação usando <DoNotTranslate>**one**</DoNotTranslate> destes métodos:
  ...
  >
    ...
    <DoNotTranslate>**Example:**</DoNotTranslate> O menu mostra sete opções:
  ...
  >
    Depois de instalar o New Relic com sucesso e reiniciar o servidor web, você pode começar a coletar dados sobre o seu aplicativo. Após alguns minutos, os dados começarão a aparecer na sua [página <DoNotTranslate>**Summary**</DoNotTranslate> do APM](/docs/apm/apm-ui-pages/monitoring/apm-summary-page-view-transaction-apdex-usage-data/).
