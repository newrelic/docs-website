...
<CollapserGroup>
  ...
  >
    ...
    <DNT>**Recommendation:**</DNT> Não use esse valor, a menos que o suporte da New Relic solicite. Em vez disso, para transações ocasionais em segundo plano, use um valor de duas vezes o intervalo. Por exemplo, para um trabalho em segundo plano por hora, defina o tempo limite para 2 horas.
  </Collapser>
  ...
  >
    ...
    <DNT>**Recommendation**</DNT>: se definir um tempo limite, o valor recomendado é `"15s"`. Defina este timeout apenas quando instrumentado tarefas em background de longa duração, pois em caso de problemas de conexão o agente bloqueará pelo tempo limite determinado a cada início de transação.
  </Collapser>
