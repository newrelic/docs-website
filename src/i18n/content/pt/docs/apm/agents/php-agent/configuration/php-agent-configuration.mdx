...
<CollapserGroup>
  ...
  >
    ...
    Define o limite além das consultas que são consideradas "lentas" e, portanto, candidatas à página [<DoNotTranslate>**Slow Queries**</DoNotTranslate>](/docs/apm/applications-menu/monitoring/databases-slow-queries-dashboard) . Especifique a duração como um valor absoluto com unidades. A unidade padrão é milissegundos se nenhuma for especificada.
