...
A New Relic oferece suporte às versões 3, 4, 5, 6 e 7 do <DNT>**Guzzle HTTP client library**</DNT> com [o agente PHP New Relic versão 7.0](/docs/release-notes/agent-release-notes/php-release-notes) ou superior.
...
## Solicitações sequenciais [#more_help]
...
## Solicitações paralelas [#more_help]
