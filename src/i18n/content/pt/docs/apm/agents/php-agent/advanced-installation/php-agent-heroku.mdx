...
Antes de instalar o agente PHP, certifique-se de que seu aplicativo web PHP esteja instalado e em execução no Heroku. Para mais informações veja [Primeiros Passos com PHP no Heroku](https://devcenter.heroku.com/articles/getting-started-with-php).
