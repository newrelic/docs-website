...
<CollapserGroup>
  ...
  >
    ...
    3. Para visualizar os dados do aplicativo GAE flex no New Relic, acesse a [página <DoNotTranslate>**Overview**</DoNotTranslate> do APM](/docs/apm/applications-menu/monitoring/apm-overview-page).
  </Collapser>
</CollapserGroup>
