...
Quando o daemon está em estado inicial ou inativo, <DoNotTranslate>**two**</DoNotTranslate> transação deve ocorrer antes de começar a relatar.

Em um estado <DoNotTranslate>**initial**</DoNotTranslate> :
...
Em um estado <DoNotTranslate>**idle**</DoNotTranslate> :
...
* <DoNotTranslate>**Recommended process:**</DoNotTranslate> Usar `/etc/init.d/newrelic-daemon stop`. Este é o método preferido para interagir com o daemon.
