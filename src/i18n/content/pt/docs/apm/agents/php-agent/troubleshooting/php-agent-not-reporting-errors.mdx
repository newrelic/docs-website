...
Se você for <DoNotTranslate>**using a third party error handler**</DoNotTranslate> (por exemplo: [XDebug](https://xdebug.org/) ou [manipulador de erros do Laravel)](https://laravel.com/docs/5.2/errors):
...
Se você é <DoNotTranslate>**not using a third party error handler**</DoNotTranslate>, mas ainda não vê o erro esperado (por exemplo: erros 404):
