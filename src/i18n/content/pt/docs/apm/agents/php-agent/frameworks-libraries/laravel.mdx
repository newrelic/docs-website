...
Para Laravel Horizon e Laravel Queue, defina o [parâmetro newrelic.daemon.app\_connect\_timeout](/docs/apm/agents/php-agent/configuration/php-agent-configuration/#inivar-daemon-app_connect_timeout) Configuração INI para 5s:
