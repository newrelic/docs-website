  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        Se o valor fornecido for <DoNotTranslate>**float**</DoNotTranslate> com valor NaN, Infinity, denorm ou zero negativo, o comportamento desta função é indefinido. Para outros valores de ponto flutuante, o agente pode descartar 1 ou mais bits de precisão (ULPs) do valor fornecido.
      </td>
    </tr>
  </tbody>
</table>
