...
Registra um segmento de armazenamento de dados. Os segmentos do datastore aparecem nas guias <DoNotTranslate>**Breakdown table**</DoNotTranslate> e <DoNotTranslate>**Databases**</DoNotTranslate> da [página de transação](/docs/apm/applications-menu/monitoring/transactions-page) na interface do New Relic.
