...
Para instalar o New Relic por meio de sistemas como Puppet ou Chef, o script [`newrelic-install`](/docs/agents/php-agent/advanced-installation/using-newrelic-install-script) pode ser executado no modo <DoNotTranslate>**silent**</DoNotTranslate> e controlado por diversas variáveis de ambiente. Este documento fornece informações para configurar manualmente as variáveis de ambiente para permitir que o [script de instalação do PHP](/docs/agents/php-agent/advanced-installation/using-newrelic-install-script) seja executado no modo silencioso.
...
* Use o Puppet para instalar os arquivos usando o gerenciador de pacote nativo (
  ...
  <DoNotTranslate>**dpkg**</DoNotTranslate>
...
Para instalar o New Relic por meio de sistemas como Puppet ou Chef, o script [`newrelic-install`](/docs/agents/php-agent/advanced-installation/using-newrelic-install-script) pode ser executado no modo <DoNotTranslate>**silent**</DoNotTranslate> e controlado por diversas variáveis de ambiente.
...
<CollapserGroup>
  ...
  >
    <table>
      <tbody>
        ...
        <tr>
          ...
          <td>
            Defina como <DoNotTranslate>**x86**</DoNotTranslate> ou <DoNotTranslate>**x64**</DoNotTranslate> para substituir a detecção baseada em script.
          </td>
        </tr>
      </tbody>
    </table>
    ...
    Se você estiver executando em um sistema de 64 bits e definir isso como <DoNotTranslate>**x86**</DoNotTranslate>, forçará o script a instalar o daemon de 32 bits (se estiver instalando a partir de tarballs) e o agente.

    Definir como <DoNotTranslate>**x64**</DoNotTranslate> instalará o daemon de 64 bits e permitirá que o script detecte se sua versão do PHP é de 64 ou 32 bits.
  ...
  >
    ...
    Se esta for uma instalação nova e um novo arquivo <DoNotTranslate>**newrelic.ini**</DoNotTranslate> precisar ser criado, defina esse valor como a chave de licença.
  </Collapser>
  ...
  >
    ...
    Se você alterar isso, talvez seja necessário editar o script <DoNotTranslate>**init**</DoNotTranslate> ou seus arquivos de configuração.
  </Collapser>
