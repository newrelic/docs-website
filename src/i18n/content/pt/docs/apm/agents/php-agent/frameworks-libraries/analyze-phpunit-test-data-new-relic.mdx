...
Se você usa [PHPUnit](https://phpunit.de/) para gerenciar e executar seus testes de unidade, o agente PHP da New Relic pode capturar automaticamente os resultados do resumo do teste e enviá-los para a [New Relic](/docs/insights/new-relic-insights/understanding-insights/new-relic-insights) como um [evento](/docs/insights/new-relic-insights/understanding-insights/new-relic-insights#database) onde você pode consultar e visualizar os dados de teste rapidamente. Este recurso foi lançado na versão <DNT>**6.7.0**</DNT> do agente PHP e suporta versões do PHPUnit <DNT>**3.7**</DNT> para <DNT>**8.x**</DNT>
...
<CollapserGroup>
  ...
  <Collapser
    id="suite-failures"
    title="Falhas no conjunto de testes"
  >
...
<CollapserGroup>
  <Collapser
    ...
    title={<><InlineCode>TestSuite</InlineCode> atributo do evento</>}
  >
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            O número de testes com avisos. _Observe que o PHPUnit também os inclui no `passedCount` ._
          </td>
        </tr>
  ...
  <Collapser
    ...
    title={<><InlineCode>Test</InlineCode> atributo do evento</>}
  >
