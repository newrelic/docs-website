...
Se você usa [PHPUnit](https://phpunit.de/) para gerenciar e executar seus testes de unidade, o agente PHP da New Relic pode capturar automaticamente os resultados do resumo do teste e enviá-los para a [New Relic](/docs/insights/new-relic-insights/understanding-insights/new-relic-insights) como um [evento](/docs/insights/new-relic-insights/understanding-insights/new-relic-insights#database) onde você pode consultar e visualizar os dados de teste rapidamente. Este recurso foi lançado na versão <DoNotTranslate>**6.7.0**</DoNotTranslate> do agente PHP e suporta versões do PHPUnit <DoNotTranslate>**3.7**</DoNotTranslate> para <DoNotTranslate>**8.x**</DoNotTranslate>
...
<CollapserGroup>
  ...
  >
    <DoNotTranslate>**TestSuite**</DoNotTranslate> evento inclui o seguinte atributo:
  ...
  >
    <DoNotTranslate>**Test**</DoNotTranslate> evento inclui o seguinte atributo:
    ...
    <table>
      ...
      <tbody>
        ...
        <tr id="test-message">
          ...
          <td>
            Qualquer mensagem associada ao resultado do teste. Por exemplo: <DoNotTranslate>**Failed asserting that false is true**</DoNotTranslate> ou <DoNotTranslate>**This test depends on 'StackTest::testFailure' to pass.**</DoNotTranslate>.
          </td>
        </tr>
        ...
        <tr id="test-outcome">
          ...
          <td>
            O resultado do teste. As opções incluem <DoNotTranslate>**passed**</DoNotTranslate>, <DoNotTranslate>**failed**</DoNotTranslate>, <DoNotTranslate>**skipped**</DoNotTranslate>, <DoNotTranslate>**risky**</DoNotTranslate>, <DoNotTranslate>**warning**</DoNotTranslate> e <DoNotTranslate>**incomplete**</DoNotTranslate>.
          </td>
        </tr>
