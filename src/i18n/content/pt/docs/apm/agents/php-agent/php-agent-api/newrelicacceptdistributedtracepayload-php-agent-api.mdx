---
title: newrelic_accept_distributed_trace_payload (API do agente PHP)
type: apiDoc
shortDescription: Aceita uma carga distributed trace .
tags:
  - Agents
  - PHP agent
  - PHP agent API
...
Aceita uma carga distributed trace .
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Obrigatório: uma string formatada em JSON criada usando `newrelic_create_distributed_trace_payload`.
      </td>
    </tr>
  </tbody>
</table>
