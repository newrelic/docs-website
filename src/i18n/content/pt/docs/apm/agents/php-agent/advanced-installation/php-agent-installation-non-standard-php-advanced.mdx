...
Gere algum tráfego em seu aplicativo e aguarde de três a cinco minutos para que os resultados cheguem em sua [página APM <DoNotTranslate>**Summary**</DoNotTranslate> ](/docs/apm/apm-ui-pages/monitoring/apm-summary-page-view-transaction-apdex-usage-data/).
