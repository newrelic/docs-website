...
* Criar e compartilhar [dashboards](/docs/query-your-data/explore-query-data/query-builder/introduction-query-builder)personalizáveis e interativos
...
* [Tempo de carregamento da página](/docs/agents/php-agent/features/page-load-timing-php): integre o agente PHP ao [<InlinePopover type="browser" />](/docs/browser/new-relic-browser/getting-started/new-relic-browser)para obter visibilidade da atividade do usuário final.
