...
Após uma configuração bem-sucedida, pode levar até quinze minutos para que as métricas comecem a aparecer no New Relic. Para visualizar sua [página APM <DoNotTranslate>**Summary**</DoNotTranslate> ](/docs/apm/applications-menu/monitoring/applications-overview-dashboard): Vá para <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & services > (select your app)**</DoNotTranslate>.