...
<Callout variant="important">
  Nível do código métrico estão disponíveis no agente PHP versão 10.4.0 ou superior, e habilitados por padrão para versões 10.6.0 e superior. Para alterar esta configuração, consulte nossa [documentação](/docs/apm/agents/php-agent/configuration/php-agent-configuration/#inivar-code-level-metrics).
</Callout>
