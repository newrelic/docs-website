  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        Se `true`, o agente envia os dados que foram coletados logo antes de executar esta chamada. <DoNotTranslate>**The data is associated with the old app name**</DoNotTranslate>. Isso tem um impacto muito leve no desempenho, pois leva alguns milissegundos para o agente despejar seus dados.
      </td>
    </tr>
  </tbody>
</table>
