...
Um clocksource de baixo desempenho pode afetar o agente, que verifica o tempo para cada span. Certifique-se de que você está usando um [clocksource](https://support.newrelic.com/s/hubtopic/aAX8W0000008a7rWAA/relic-solution-php-agent-cpu-overhead-tips) apropriado. O Fargate é afetado pelo clocksource e é conhecido por causar [sobrecarga](/docs/apm/agents/php-agent/troubleshooting/fargate-nitro-clock-performance-impact/) adicional.