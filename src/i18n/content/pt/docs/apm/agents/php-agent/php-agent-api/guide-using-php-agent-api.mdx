...
Para obter mais informações sobre como correlacionar dados log com outros dados de telemetria, consulte nossa documentação [de logs em contexto](/docs/logs/logs-context/configure-logs-context-php/) .
...
## Chamadas de instrumento para serviços externos [#datastore]
