...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [Funcionalidade específica do Drupal](/docs/apm/agents/php-agent/frameworks-libraries/drupal-specific-functionality)<br /> [Instrumentação do navegador Drupal](/docs/apm/agents/php-agent/frameworks-libraries/drupal-specific-functionality/#page-load-timing-rum)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Laravel Horizon não é compatível.
      </td>
    </tr>
...
* HTTP
* Enfileiramento do Laravel <Callout variant="important">O Laravel Horizon não é suportado.</Callout>
