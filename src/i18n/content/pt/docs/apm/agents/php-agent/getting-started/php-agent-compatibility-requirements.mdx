...
<table>
  ...
  <tbody>
    <tr>
      <td>
        [Monitoramento de navegador](/docs/browser/new-relic-browser/getting-started/introduction-new-relic-browser)
      </td>

      <td>
        O agente PHP injeta automaticamente o código JS do navegador do agente quando você [ativa a instrumentação automática](/docs/browser/new-relic-browser/installation/install-new-relic-browser-agent#select-apm-app). Depois de ativar a injeção do navegador, você pode visualizar os dados na [página Resumo do APM](/docs/apm/applications-menu/monitoring/apm-overview-page) e alternar rapidamente entre o APM e os dados do navegador para um aplicativo específico. Para opções de configuração e instrumentação manual, consulte [monitoramento de Browser e agente PHP](/docs/agents/php-agent/features/page-load-timing-php).
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        O agente PHP oferece suporte ao nosso recurso de contexto de login para a biblioteca Monolog 2 e 3.
      </td>
    </tr>
