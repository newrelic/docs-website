...
## Prontidão da Versão Principal do PHP

A New Relic está comprometida com a rápida adoção de novas versões secundárias do PHP. Nosso objetivo é oferecer suporte GA para versões finais em um prazo de 60 dias. Embora as prioridades de desenvolvimento possam mudar para atender às necessidades urgentes de segurança, estamos dedicados a reduzir essa lacuna e garantir que nosso agente continue sendo a maneira mais confiável de monitorar seus aplicativos PHP modernos.
...
[Fibers](https://www.php.net/manual/en/language.fibers.php) é suportado a partir da versão 12.10. Para desativar a instrumentação de fibers, anexe `newrelic.fibers.disabled = true` ao arquivo de configuração.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [Funcionalidade específica do Drupal](/docs/apm/agents/php-agent/frameworks-libraries/drupal-specific-functionality)<br /> [Instrumentação do navegador Drupal](/docs/apm/agents/php-agent/frameworks-libraries/drupal-specific-functionality/#page-load-timing-rum)<br /> Aviso do Drupal 11.3: A próxima versão do Drupal altera suas implementações de hook e é incompatível com as versões atuais do Agente PHP. Estamos trabalhando ativamente em uma solução, mas o Drupal 11.3+ ainda não é compatível e permanecerá assim até o início de 2026.
      </td>
    </tr>
...
Caso queira sugerir suporte para outra framework PHP popular, visite o [Fórum de suporte](https://support.newrelic.com/s/hubtopic/Topic__c/Default?c__categories=%5B%7B%22icon%22%3A%22standard%3Adefault%22%2C%22id%22%3A%22a6c8W000000EeskQAC%22%2C%22sObjectType%22%3A%22Category__c%22%2C%22title%22%3A%22PHP%20Agent%22%2C%22titleFormatted%22%3A%22PHP%20Agent%22%7D%5D) e crie um `Feature Idea`. Para obter mais informações, consulte [Frameworks PHP: Integrando suporte para New Relic](/docs/apm/agents/php-agent/frameworks-libraries/php-frameworks-integrate-support-new-relic).
...
<table>
  <tbody>
    ...
    <tr>
      <td>
        Kinesis Data Streams (somente biblioteca aws-sdk-php 3)
      </td>
