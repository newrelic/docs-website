...
<Callout variant="tip">
  <DoNotTranslate>**Note:**</DoNotTranslate> Não nomeie sua transação com valores que mudam frequentemente, como IDs de usuário, aplicar hash e assim por diante. Implemente [nomenclatura de transação útil](/docs/agents/php-agent/features/php-frameworks-integrating-support-new-relic) em sua chamada de API.
</Callout>
