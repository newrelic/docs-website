...
* <DoNotTranslate>**PHP version 5 or lower**</DoNotTranslate>

  : você deve passar uma classe PHP

  <DoNotTranslate>**Exception**</DoNotTranslate>

  válida.

* <DoNotTranslate>**PHP version 7 or higher**</DoNotTranslate>

  : Você deve passar uma interface PHP

  <DoNotTranslate>**Throwable**</DoNotTranslate>
...
Esta função pode lidar com um número variável de parâmetros. Você pode passar 1 ou 5 parâmetros, dependendo do seu caso de uso.
...
<DoNotTranslate>**PHP version 5.6 or higher**</DoNotTranslate>: Faça com que o agente PHP perceba erros dentro do seu próprio manipulador de erros.
...
<DoNotTranslate>**PHP version 5.5 or lower**</DoNotTranslate>: Faça com que o agente PHP perceba erros dentro do seu próprio manipulador de erros.
