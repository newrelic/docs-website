...
Para atualizar via <DoNotTranslate>**tar archive**</DoNotTranslate>, siga os [procedimentos de instalação do arquivo tar](/docs/agents/php-agent/installation/php-agent-installation-tar-file). (Os procedimentos para instalar e atualizar com o arquivo tar são os mesmos.)

## Use o pacote `newrelic-php5` [#newrelic-php5]
       ...
       <table>
         ...
         <tbody>
           ...
           <tr>
             ...
             <td>
               Faça download da versão mais recente dos arquivos `.rpm` na [página de downloads do New Relic](https://download.newrelic.com/pub/newrelic/el5/i386/) e execute o comando a seguir. Certifique-se de substituir `X.X.X.X` pelo [número de versão mais recente do New Relic para PHP](/docs/releases/php).
       ...
       <table>
         ...
         <tbody>
           ...
           <tr>
             ...
             <td>
               Faça download da versão mais recente dos arquivos `.deb` na [página de downloads do New Relic](https://download.newrelic.com/debian/dists/newrelic/non-free/binary-i386/) e execute o comando a seguir. Certifique-se de substituir `X.X.X.X` pelo [número de versão mais recente do New Relic para PHP](/docs/releases/php).
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        Para clientes que iniciam o daemon manualmente, você pode encontrar o <DoNotTranslate>**newly renamed command line flags**</DoNotTranslate> com os sinalizadores `-h` ou `--help` . O <DoNotTranslate>**following old flags will be removed**</DoNotTranslate> em uma versão futura:
