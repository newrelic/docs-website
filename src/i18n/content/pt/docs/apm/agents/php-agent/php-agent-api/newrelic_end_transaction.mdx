  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        Se `false` ou omitido, dados da transação <DoNotTranslate>**is**</DoNotTranslate> registrados pelo daemon.

        Se `true`, dados da transação <DoNotTranslate>**is not**</DoNotTranslate> registrados pelo daemon.
      </td>
    </tr>
  </tbody>
</table>
