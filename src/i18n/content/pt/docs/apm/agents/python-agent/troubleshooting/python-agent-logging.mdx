...
1. Abra seu <DoNotTranslate>**newrelic.ini**</DoNotTranslate>, geralmente localizado na hierarquia do seu aplicativo.
...
6. Se estiver enviando seu arquivo de log para o suporte da New Relic, anexe seu <DoNotTranslate>**newrelic.ini**</DoNotTranslate> ao seu ticket de suporte e informe ao suporte seu fuso horário.
