...
Se você iniciar seu aplicativo com `python app.py` e usar nosso agente Python <DoNotTranslate>**version 5.20.0.149**</DoNotTranslate> ou superior, poderá usar o [método de integração de script administrativo](/docs/agents/python-agent/installation-configuration/python-agent-installation#integration) recomendado. Por exemplo:
