...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Obrigatório. O nome (ou tipo) da biblioteca externa em uso. Passe uma string que o defina ou uma função que aceite os mesmos parâmetros que a função sendo encapsulada e retorne a biblioteca.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Obrigatório. A URL que foi solicitada pela chamada da biblioteca. Passe uma string que o define ou uma função que aceita os mesmos parâmetros da função que está sendo encapsulada e retorna a URL.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Opcional. O método que define o tipo de chamada que está sendo feita. Geralmente são `get`, `post`, `put` ou `delete`. Pode ser uma função que aceita os mesmos parâmetros da função que está sendo encapsulada e retorna o método.
      </td>
    </tr>
  </tbody>
</table>
