...
1. Siga os procedimentos padrão para [instalar o agente Python](/docs/agents/python-agent/getting-started/python-agent-quick-start#install), incluindo seu
...
<DoNotTranslate>**Recommendation:**</DoNotTranslate> Configure seu `app.yaml` para [desativar verificações de integridade](https://cloud.google.com/appengine/docs/flexible/python/configuring-your-app-with-app-yaml#health_checks) adicionando:
