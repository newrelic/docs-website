...
<CollapserGroup>
  <Collapser id="solution-content" title="Verifique a estrutura do conteúdo.">
  ...
  <Collapser id="solution-compression" title="Verifique se a compactação do conteúdo não está interferindo.">
  ...
  <Collapser id="solution-compression" title="Verifique a origem da página para blocos condicionais.">
