...
<DoNotTranslate>**Recommendation:**</DoNotTranslate> Para evitar potenciais problemas de dados, mantenha o número total de métricas únicas introduzidas pela métrica personalizada abaixo de 2000.
