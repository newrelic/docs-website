...
<img title="screen-rabbitmq-transaction.png" alt="New Relic for Python rabbitmq task" src={apmRabbitmqTransactionTask} />
...
<img title="screen-rabbitmq-trace-slowest.png" alt="New Relic for Python rabbitmq transaction trace summary" src={apmRabbitMqTransactionTraceSummary} />
