...
<CollapserGroup>
  ...
  >
    ...
    2. Invoque a chamada da API do agente para gerar uma carga útil distributed trace (consulte a [API do agente Python](/docs/agents/python-agent/python-agent-api/create_distributed_trace_payload)).
       ...
       <Callout variant="important">Para manter a ordem adequada dos períodos em um trace, certifique-se de <DNT>**generate the payload in the context of the span that sends it**</DNT>.</Callout>
