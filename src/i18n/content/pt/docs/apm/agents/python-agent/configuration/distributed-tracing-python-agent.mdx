      ...
      <tbody>
        <tr>
          ...
          <td>
            ...
            <DNT>**General configuration options:**</DNT>
            ...
            <DNT>**Batching and compression configuration options:**</DNT>
...
<CollapserGroup>
  <Collapser id="python-version" title="Compatibilidade do agente com Python">
...
<CollapserGroup>
  <Collapser id="python-config-standard" title="Configuração do agente Python">
...
<CollapserGroup>
  <Collapser id="calling-service" title="Instrumento o serviço de chamada">
    ...
    2. Invoque a chamada API do agente para gerar uma carga distributed trace (consulte [API Python do agente](/docs/agents/python-agent/python-agent-api/create_distributed_trace_payload)).
