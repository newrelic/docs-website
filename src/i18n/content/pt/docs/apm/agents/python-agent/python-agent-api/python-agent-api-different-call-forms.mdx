---
title: Formulários de chamada diferentes da API do agente Python
...
* Um
  ...
  <DoNotTranslate>**decorator**</DoNotTranslate>
...
* Um
  ...
  <DoNotTranslate>**context manager**</DoNotTranslate>
...
* Um
  ...
  <DoNotTranslate>**wrapper**</DoNotTranslate>

  . O wrapper é usado para criar uma função encapsulada sem o uso de um decorador.

* Um

  <DoNotTranslate>**path-based wrapper**</DoNotTranslate>
...
Para obter um exemplo de uma API Python do agente com todos os quatro possíveis, consulte a entrada de chamada [`function_trace`](/docs/agents/python-agent/python-agent-api/function_trace) .