...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Versões Python (CPython/PyPy) suportadas: 2.7, 3.7, 3.8, 3.9, 3.10 e 3.11.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Se você tiver a versão 9.9.0 do agente Python, poderá coletar dados de IA de determinadas bibliotecas e estruturas de IA:
