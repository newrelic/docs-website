...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Versões Python (CPython/PyPy) suportadas: 3.7, 3.8, 3.9, 3.10, 3.11 e 3.12.

        <DoNotTranslate>**Recommendation:**</DoNotTranslate> Use Python versão 3.7 ou superior com nosso agente.
        ...
        * Para Python versão 2.7, siga nossos requisitos [de suporte de fim de vida útil (EOL)](#version) .
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        * [WebFação](/docs/apm/agents/python-agent/hosting-services/python-agent-webfaction/)
      </td>
    </tr>
...
O agente em geral suportará todas [as ramificações Python](https://devguide.python.org/#status-of-python-branches) lançadas e ativas. No entanto, para acompanhar as próximas mudanças, o agente também seguirá este cronograma de suporte à versão Python. A política de suporte de versão não substitui nossa [política geral de fim de vida útil (EOL)](/docs/agents/manage-apm-agents/maintenance/new-relic-agent-plugin-end-life-policy).
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        1º de abril de 2024 (ver nota abaixo)
      </td>
    </tr>
  </tbody>
</table>
...
<Callout variant="note">
  O Python 2.7 não é mais suportado oficialmente no trabalho ou manutenção subsequente framework , mas a data em que o Python 2.7 será removido do agente é a ser definida.
</Callout>
