...
<Callout variant="important">
  Para nosso agente Python, [o rastreamento multiaplicativo](/docs/apm/transactions/cross-application-traces/introduction-cross-application-traces) foi descontinuado desde [a versão do agente v7.0.0.166](/docs/release-notes/agent-release-notes/python-release-notes/python-agent-70000166). Um recurso [distributed tracing](/docs/apm/distributed-tracing/getting-started/introduction-distributed-tracing) já está disponível. distributed tracing melhora o rastreamento multiaplicativo e é recomendado para atividades de monitoramento em sistemas distribuídos complexos.
</Callout>
