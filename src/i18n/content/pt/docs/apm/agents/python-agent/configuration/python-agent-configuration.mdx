...
<CollapserGroup>
  <Collapser id="opentelemetry.enabled" title="opentelemetry.enabled">
    ...
    Se habilitado, qualquer API OpenTelemetry e [framework instrumentado pelo OpenTelemetry](https://github.com/open-telemetry/opentelemetry-python-contrib/tree/main/instrumentation#readme) instalado será utilizado.
  </Collapser>
  ...
  <Collapser id="opentelemetry.traces.enabled" title="opentelemetry.traces.enabled">
    ...
    Se ativado, quaisquer APIs de span e trace do OpenTelemetry serão usadas.
  </Collapser>
</CollapserGroup>
