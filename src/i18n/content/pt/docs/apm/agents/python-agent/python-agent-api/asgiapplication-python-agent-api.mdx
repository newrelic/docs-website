...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <DoNotTranslate>**Required**</DoNotTranslate>. O objeto ASGI a ser empacotado.
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <DoNotTranslate>**Required**</DoNotTranslate>. O módulo que contém o objeto ASGI.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <DoNotTranslate>**Required**</DoNotTranslate>. Representa o método de classe ou método para localizar o objeto ASGI em um arquivo.
      </td>
    </tr>
  </tbody>
</table>
