...
* <DoNotTranslate>**Port:**</DoNotTranslate>
  ...
  <DoNotTranslate>**80**</DoNotTranslate>

  ou

  <DoNotTranslate>**443**</DoNotTranslate>
...
1. Verifique se o nome do host do host do coletor de dados primário pode ser resolvido com ferramentas do sistema UNIX, como
   ...
   <DoNotTranslate>**dig**</DoNotTranslate>

   ou

   <DoNotTranslate>**nslookup.**</DoNotTranslate>
...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="Traceroute"
  >
    Ao usar <DoNotTranslate>**traceroute**</DoNotTranslate>, diga para usar as portas <DoNotTranslate>**80**</DoNotTranslate> e <DoNotTranslate>**443**</DoNotTranslate>.
