...
## Comandos da API REST v2 [#examples_v2][#examples_v2]

<CollapserGroup>
  <Collapser
    id="browser-v2"
    title="Tempo de carregamento do browser e contagem de visualizações de página (v2)"
  >
  ...
  <Collapser
    id="app-v2"
    title="App tempo de resposta e contagem de solicitações (v2)"
  >
  ...
  <Collapser
    id="apdex-v2"
    title="Dados de SLA do Apdex (v2)"
  >
...
## Comandos da API REST v1 (obsoleto) [#examples_v1][#examples_v1]
...
<CollapserGroup>
  <Collapser
    id="browser-v1"
    title="Tempo de carregamento do browser e contagem de visualizações de página (v1)"
  >
  ...
  <Collapser
    id="app-v1"
    title="App tempo de resposta e contagem de solicitações (v1)"
  >
  ...
  <Collapser
    id="apdex-v1"
    title="Dados de SLA do Apdex (v1)"
  >
