...
<Callout variant="tip">
  O acesso a este recurso depende do seu [nível de assinatura](https://newrelic.com/application-monitoring/features/edition).
</Callout>

## Métrica do browser para SLA [#browser-metrics]

As métricas do browser para o [nível](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#tier) <DoNotTranslate>**End user**</DoNotTranslate> estarão disponíveis somente se você tiver [instalado o agente <InlinePopover type="browser"/>](/docs/browser/new-relic-browser/getting-started/browser-settings).
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <DoNotTranslate>**Recommendation:**</DoNotTranslate> Para evitar uma sequência de zeros, divida esse número adequadamente para seus próprios propósitos.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        * Transação não está em uma dessas categorias, caso o carregamento da página não seja concluído por algum motivo
          ...
          É por isso que há menos (às vezes muito menos) visualizações de página na seção <DoNotTranslate>**End User**</DoNotTranslate> (dados do browser) do que na seção de dados <DoNotTranslate>**App server**</DoNotTranslate> .
      </td>
    </tr>
  </tbody>
</table>
...
## Comandos da API REST v2 [#examples_v2]
...
## Comandos da API REST v1 (obsoleto) [#examples_v1]
