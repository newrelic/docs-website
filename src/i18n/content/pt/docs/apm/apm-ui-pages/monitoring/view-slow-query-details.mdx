...
No APM, quando coletamos [o rastreamento da transação](/docs/apm/transactions/transaction-traces/introduction-transaction-traces), também podemos encontrar alguns dados <DoNotTranslate>**Slow query**</DoNotTranslate> adicionais e exibi-los na página [<DoNotTranslate>**Databases**</DoNotTranslate>](/docs/apm/apm-ui-pages/monitoring/databases-page-view-operations-throughput-response-time/) . Vejamos o que são dados de consulta lenta, onde encontrá-los e como configurá-los.
