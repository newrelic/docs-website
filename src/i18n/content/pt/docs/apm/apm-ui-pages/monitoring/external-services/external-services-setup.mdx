    ...
    <Tabs>
      ...
      <TabsPages>
        ...
        <TabsPageItem id="otel-sample">
          ...
          Consulte [Amostragem](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/opentelemetry-concepts/#sampling) para dicas sobre configuração.
        </TabsPageItem>
      </TabsPages>
    </Tabs>
  </Step>
