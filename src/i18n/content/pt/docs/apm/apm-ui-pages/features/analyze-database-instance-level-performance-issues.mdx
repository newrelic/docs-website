...
<CollapserGroup>
  ...
  >
    ...
    <figcaption>
      <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & services > (select an app) > Monitor > Databases > (select a trace) > Trace details:**</DoNotTranslate> Para visualizar informações sobre um banco de dados e uma instância específicos que podem estar contribuindo para o problema de desempenho de um aplicativo, selecione o ícone <DoNotTranslate>**Database**</DoNotTranslate> .
    </figcaption>
  </Collapser>
