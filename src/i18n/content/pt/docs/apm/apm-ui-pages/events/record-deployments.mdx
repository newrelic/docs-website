...
* Os exemplos usam `X-Api-Key` que pode ser usado para uma
  ...
  <a href="/docs/apis/intro-apis/new-relic-api-keys/#user-api-key">chave de usuário</a>

  ou uma

  <a href="/docs/apis/intro-apis/new-relic-api-keys/#rest-api-key">chave de API REST</a>
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            <DoNotTranslate>**Required**</DoNotTranslate>. Um ID único para esta implantação, visível na página [Resumo](/docs/apm/applications-menu/monitoring/apm-overview-page) e na página [Implantações](/docs/apm/applications-menu/events/deployments-page) . Pode ser qualquer string, mas geralmente é um número de versão ou uma soma de verificação do Git.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**Optional**</DoNotTranslate>. Um resumo do que mudou nesta implantação, visível na página [Implantações](/docs/apm/applications-menu/events/deployments-page) ao selecionar <DoNotTranslate>**(selected deployment) > Change log**</DoNotTranslate>.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**Optional**</DoNotTranslate>. Uma descrição resumida desta implantação, visível na página [Resumo](/docs/apm/applications-menu/monitoring/apm-overview-page) e na página [Implantações](/docs/apm/applications-menu/events/deployments-page) quando você seleciona uma implantação individual.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**Optional**</DoNotTranslate>. Um nome de usuário para associar à implantação, visível na página [Resumo](/docs/apm/applications-menu/monitoring/apm-overview-page) e na página [Implantações](/docs/apm/applications-menu/events/deployments-page) .
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**Optional**</DoNotTranslate>. Quando a implantação ocorreu, até o segundo. Se não for especificado, a implantação será registrada no momento em que a chamada de API foi recebida. requisitos timestamp :
...
* <DoNotTranslate>**All agents**</DoNotTranslate>
