...
Veja como funciona o marcador de implantação neste pequeno vídeo (4:30 minutos):<Video id="HPeXZubcZ7o" type="youtube"/>

## Opções para rastreamento de implantação [#options]

Você pode usar a [API REST v2](/docs/apis/rest-api-v2/requirements/new-relic-rest-api-v2-getting-started) do New Relic para registrar novas implantações e recuperar uma lista de implantações anteriores. Além disso, alguns agentes APM possuem métodos específicos do agente para registrar a implantação automaticamente.
...
<CollapserGroup>
  <Collapser
    className="freq-link"
    id="post-deployment"
    title="Grave uma implantação com POST"
  >
  ...
  <Collapser
    className="freq-link"
    id="powershell"
    title="Grave uma implantação com PowerShell"
  >
  ...
  <Collapser
    className="freq-link"
    id="get-list"
    title="Veja lista de implantação com GET"
  >
  ...
  <Collapser
    ...
    title="Limites de caracteres e parâmetro JSON"
  >
...
* <DNT>
  ...
  : Use a [API REST v2 do](#api) New Relic.

* <DNT>
    **C**
  </DNT>

  : nenhum método específico do SDK. Utilize a [API REST](#api).

* <DNT>
    **Go**
  </DNT>

  : Nenhum método específico do agente. Utilize a [API REST](#api).

* <DNT>
    **Java**
  </DNT>

  : Chame o [agente Java `jar`](/docs/agents/java-agent/instrumentation/recording-deployments-java-agent).

* <DNT>
    **.NET**
  </DNT>

  : Use [o PowerShell e a API REST](#powershell).
...
* <DNT>
  ...
  : Use um [script PHP](/docs/agents/php-agent/features/recording-deployments-using-php-script).

* <DNT>
    **Python**
  </DNT>

  : use o subcomando [`record-deploy`](/docs/agents/python-agent/installation-configuration/python-agent-admin-script#record-deploy) do script `newrelic-admin` .

* <DNT>
    **Ruby**
  </DNT>

  : Use uma [receita Capistrano](/docs/agents/ruby-agent/features/recording-deployments-ruby-agent#capistrano3).

## Ver detalhes da implantação [#dep_procedures]
