...
While you can use either the New Relic [REST API v2](/docs/apis/rest-api-v2/requirements/new-relic-rest-api-v2-getting-started) or [NerdGraph](/docs/change-tracking/change-tracking-graphql) to record new deployments and retrieve a list of past deployments, we recommend using NerdGraph. You can use the New Relic to record new deployments and retrieve a list of past deployments. Additionally, some APM agents offer agent-specific methods to automatically record deployments.
