...
<CollapserGroup>
  ...
  >
    ...
    1. Acesse
       ...
       e selecione um principal de transação.

    2. Perto do nome da entidade, na parte superior da página, selecione o menu
    ...
    3. No campo
       ...
       <DoNotTranslate>**Add a new tag...**</DoNotTranslate>

       do menu pop-up, adicione uma tag com este formato: `accountId: 123456789`.
