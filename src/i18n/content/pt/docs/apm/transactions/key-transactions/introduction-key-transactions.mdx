...
<CollapserGroup>
  ...
  >
    ...
    Depois de criar o principal de transação, eles se tornam parte do ecossistema da entidade New Relic. Você pode ver todas as transações, incluindo o `getPlans` principal de transação que acabou de criar, em <DoNotTranslate>**entity list view**</DoNotTranslate>.
  </Collapser>
  ...
  >
    ...
    <Callout variant="important">
      Transação principal As configurações do Apdex substituem o valor T definido para esse aplicativo. Isso pode significar, por exemplo, que um principal de transação poderia ser relatado como <DoNotTranslate>**Satisfied**</DoNotTranslate> , mas uma transação diferente no mesmo aplicativo com o mesmo tempo de resposta poderia ser <DoNotTranslate>**Frustrated**</DoNotTranslate>.
    </Callout>
  ...
  >
    ...
    4. Selecione
       ...
       <DoNotTranslate>**stop tracking**</DoNotTranslate>
...
<CollapserGroup>
  ...
  >
    ...
    1. Acesse <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DoNotTranslate> e selecione um principal de transação.

    2. Perto do nome da entidade, na parte superior da página, selecione o menu <DoNotTranslate>**See metadata and manage tags**</DoNotTranslate> .

    3. No campo <DoNotTranslate>**Add a new tag...**</DoNotTranslate> do menu pop-up, adicione uma tag com este formato: `accountId: 123456789`.
...
Depois de criar uma transação chave, você poderá aumentar sua visibilidade conectando-a às nossas ferramentas e carga de trabalho <InlinePopover type="alerts"/>e de inteligência aplicada.
