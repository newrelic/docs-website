...
<CollapserGroup>
  ...
  >
    O dropdown <DoNotTranslate>**Occurrences**</DoNotTranslate> inclui detalhes como:
    ...
    * Em <DoNotTranslate>**Distributed trace**</DoNotTranslate>, você verá o trace associado à ocorrência de erro exibida nesta página. Para ver os intervalos do trace em uma visualização em cascata:
