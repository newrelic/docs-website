...
<CollapserGroup>
  ...
  >
    O dropdown <DNT>**Occurrences**</DNT> inclui detalhes como:
  ...
  >
    A guia <DNT>**Discussions**</DNT> oferece espaço para colaboração detalhada e organizada. Isso é fundamental para envolver os colaboradores e garantir que toda a equipe tenha o mesmo contexto, independentemente de onde estejam. As discussões incluem:
