...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile > Crashes (errors inbox)**</DoNotTranslate>: Com nossa guia de **Group crashes** \[falhas de grupo], você pode analisar rapidamente as taxas de falha e o usuário livre de falhas ou se aprofundar na localização específica da falha.
</figcaption>
...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile > Crashes (errors inbox)**</DoNotTranslate>: selecione um local de falha para abrir a página de **Crash details** .
</figcaption>
...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile > Crashes (errors inbox) > Select a crash location **</DoNotTranslate>: na página de **Crash details**, você pode fazer a triagem de ocorrências de erros específicas adicionando atualizações de status ou atribuições.
</figcaption>
...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile > Crashes (errors inbox) > Select a crash location **</DoNotTranslate>: aprofunde-se no evento que levou a uma falha específica usando nossa trilha de evento.
</figcaption>
...
## Por que os perfis estão desativados? [#profiles-disabled]

Os perfis são desabilitados quando não há diferenças estatisticamente significativas entre os valores de atributo das sessões com falhas e sem falhas ou não há perfis disponíveis que correspondam aos filtros aplicados.