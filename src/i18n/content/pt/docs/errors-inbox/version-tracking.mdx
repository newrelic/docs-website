...
Para aplicativos de navegador, o campo de evento é `application.version`.
...
* Para entidade APM, configure variáveis de ambiente para entidade APM.
  ...
  * [Pitão](/docs/apm/agents/python-agent/configuration/python-agent-configuration/#errors-inbox-configuration)
...
* [Para entidade do navegador, use `application.version`](/docs/browser/new-relic-browser/browser-apis/setApplicationVersion/).
