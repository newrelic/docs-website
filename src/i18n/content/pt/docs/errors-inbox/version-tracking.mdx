...
<Callout variant="tip">
  As opções <DoNotTranslate>**Resolve in next version**</DoNotTranslate> e <DoNotTranslate>**Resolve in specific version**</DoNotTranslate> só serão suportadas se sua equipe usar controle de versão semântico.
</Callout>
