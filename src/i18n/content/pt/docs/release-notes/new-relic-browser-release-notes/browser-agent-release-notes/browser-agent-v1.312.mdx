...
#### .at causa problemas em navegadores mais antigos

.at() não está sendo transpilado corretamente e está causando problemas de inicialização, alterado para indexação.
...
De acordo com a nossa [política de suporte a navegadores](https://docs.newrelic.com/docs/browser/new-relic-browser/getting-started/compatibility-requirements-browser-monitoring/#browser-types), a v1.312.1 do agente de Browser foi desenvolvida para e testada nestes navegadores e intervalos de versões: Chrome 136-146, Edge 136-146, Safari 18-26 e Firefox 138-148. Para dispositivos móveis, a v1.312.1 foi compilada e testada para Android OS 16 e iOS Safari 18-26.2.