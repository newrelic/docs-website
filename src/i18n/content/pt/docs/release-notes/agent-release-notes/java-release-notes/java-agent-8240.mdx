...
* Suporte ao MongoDB Reactive Streams 5.2.0 e superior por @obenkenobi em [2465](https://github.com/newrelic/newrelic-java-agent/pull/2465)
* Suporte para Jedis 6 por @kanderson250 em [2466](https://github.com/newrelic/newrelic-java-agent/pull/2466)

## Correções

* CouchBase: Adicionar classe skip para evitar instrumentação dupla por @jtduffy em [2462](https://github.com/newrelic/newrelic-java-agent/pull/2462)
* Spring WebClient 5.x: Encapsule apenas cabeçalhos em vez de toda a resposta por @jtduffy em [2464](https://github.com/newrelic/newrelic-java-agent/pull/2464)
