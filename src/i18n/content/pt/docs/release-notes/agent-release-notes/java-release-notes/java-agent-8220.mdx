...
* Barramento de Serviço do Azure 7.15.0 instrumentação por @jbedell-newrelic em [2384](https://github.com/newrelic/newrelic-java-agent/pull/2384)
* Vinculando metadados para serviços de aplicativo do Azure por @jbedell-newrelic em [2399](https://github.com/newrelic/newrelic-java-agent/pull/2399)
* Erros de conexão agora registrados como SEVERE por @jtduffy em [2377](https://github.com/newrelic/newrelic-java-agent/pull/2377)
* Registrar e ofuscar chaves inválidas adicionadas como atributo aos logs e eventos por @jtduffy em [2388](https://github.com/newrelic/newrelic-java-agent/pull/2388)

## Correções

* Realocar a biblioteca de anotações do IntelliJ por @meiao em [2383](https://github.com/newrelic/newrelic-java-agent/pull/2383)
* Suporte à configuração sampling\_target do lado do servidor por @jtduffy em [2386](https://github.com/newrelic/newrelic-java-agent/pull/2386)
* Remover a instrumentação MonoFlatMapMain para corrigir possíveis vazamentos de memória por @deleonenriqueta em [2400](https://github.com/newrelic/newrelic-java-agent/pull/2400)
