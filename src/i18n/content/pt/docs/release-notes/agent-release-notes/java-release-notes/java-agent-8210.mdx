...
Atualização da versão do CSEC para 1.7.0 [2348](https://github.com/newrelic/newrelic-java-agent/pull/2348) Changelog: [https://github.com/newrelic/csec-java-agent/releases/tag/1.7.0](https://github.com/newrelic/csec-java-agent/releases/tag/1.7.0)
