...
3. Clique no botão de alternância <DNT>**Trace observer monitoring**</DNT> .
...
* Duas colunas são adicionadas à listagem principal do observador trace :
  ...
  * <DNT>**Traces Seen**</DNT>: Quantos traços foram vistos pelo observador trace nos últimos 60 minutos.
  * <DNT>**Traces Kept**</DNT>: o número e a porcentagem de rastreamento que foram retidos.
