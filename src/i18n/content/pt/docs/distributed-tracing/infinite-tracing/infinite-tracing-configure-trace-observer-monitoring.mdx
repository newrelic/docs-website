...
1. Vá para
   ...
   <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infinite Tracing settings**</DoNotTranslate>
...
3. Clique no botão de alternância
   ...
   <DoNotTranslate>**Trace observer monitoring**</DoNotTranslate>
...
* Duas colunas são adicionadas à listagem principal do observador trace :
  ...
  * <DoNotTranslate>**Traces Seen**</DoNotTranslate>

    : Quantos traços foram vistos pelo observador trace nos últimos 60 minutos.

  * <DoNotTranslate>**Traces Kept**</DoNotTranslate>

    : o número e a porcentagem de rastreamento que foram retidos.

* Um novo painel é adicionado no lado direito da tela:

  * <DoNotTranslate>**Monitoring account**</DoNotTranslate>: No topo do painel direito, esta é a conta onde estão escritas as métricas do observador trace .

  * <DoNotTranslate>**How many traces were kept?**</DoNotTranslate> (gráfico superior): mostra as mesmas informações que <DoNotTranslate>**Traces Kept**</DoNotTranslate>, mas mostra como fica ao longo do tempo. Você pode ver a magnitude da amostragem e quaisquer tendências.

  * <DoNotTranslate>**Which traces were kept?**</DoNotTranslate> (gráfico inferior): Mostra quais categorias de rastreamento foram mantidas. O gráfico mostra se o rastreamento foi capturado por diferentes tipos de filtros de rastreamento infinito:
...
<DoNotTranslate>**How many traces were kept?**</DoNotTranslate> (topo nas paradas):
...
<DoNotTranslate>**Which traces were kept?**</DoNotTranslate> (gráfico inferior):
