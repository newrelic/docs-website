...
<CollapserGroup>
  <Collapser id="trace-origin-sampling" title="Agente de linguagem: amostragem adaptativa">
    ...
    O serviço de origem trace coleta amostras de 10 rastreamentos por minuto por padrão. Ele tenta distribuir a coleta desses 10 traços ao longo de um minuto para obter uma amostra representativa ao longo do tempo. A taxa de amostragem exata depende do número de transações no minuto anterior e se adapta às mudanças na transação taxas de transferência.
