...
2. Insira essa chave no JSON a seguir e, em seguida, envie o JSON para o nosso endpoint. Observação: se você tiver uma conta da New Relic na UE ou no JP, use o [endpoint regional](/docs/distributed-tracing/trace-api/trace-api-general-requirements-limits#requirements) apropriado.
