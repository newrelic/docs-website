...
* Se você estiver usando o Rastreamento Infinito, use o valor [YOUR\_TRACE\_OBSERVER\_URL](/docs/understand-dependencies/distributed-tracing/infinite-tracing/set-trace-observer#ui-endpoints) no lugar do endpoint padrão.
...
Observe que, se você estivesse usando o Infinite Tracing ou tivesse uma conta da New Relic na região da UE ou JP, o [endpoint](/docs/distributed-tracing/trace-api/trace-api-general-requirements-limits#requirements) seria diferente.
