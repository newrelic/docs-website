...
<CollapserGroup>
  ...
  <Collapser id="see-my-application" title="Não vejo meu aplicativo no IAST">
    ...
    * Proxy ou firewall bloqueando o acesso. Coloque na lista de permissões os seguintes IPs `18.188.255.152, 18.116.243.59, 18.219.12.171` para o domínio <DNT>**csec.nr-data.net**</DNT>, os seguintes IPs `3.13.224.132, 18.218.78.150, 13.58.129.59` para o domínio <DNT>**csec-gov.nr-data.net**</DNT> e os seguintes IPs `3.122.48.53, 63.176.82.192, 3.123.117.125` para o domínio <DNT>**csec.eu01.nr-data.net**</DNT>. Mas nossa recomendação é adicionar domínios na lista de permissões em vez dos IPs, pois esses IPs podem mudar a qualquer momento.
