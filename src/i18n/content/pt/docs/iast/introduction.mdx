...
* <DoNotTranslate>**Find and fix exploitable vulnerabilities**</DoNotTranslate>

  : Não há necessidade de esperar pelos resultados da verificação.

* <DoNotTranslate>**Ship code faster**</DoNotTranslate>

  : Precisão de detecção incomparável e substancialmente menos falsos positivos.

* <DoNotTranslate>**See and secure every application**</DoNotTranslate>

  : visibilidade total do seu código, componentes da web e dados de configuração.

* <DoNotTranslate>**Reduce time and cost**</DoNotTranslate>

  : Quando você elimina vulnerabilidades.

* <DoNotTranslate>**Cut down the noise**</DoNotTranslate>

  : uso de análises estáticas de testes de segurança de aplicativos (SAST) e de testes dinâmicos de segurança de aplicativos (DAST).
