...
<CollapserGroup id="non-scripted-errors">
  ...
  >
    ...
    **\[one.newrelic.com** ]( [https://one.newrelic.com](https://one.newrelic.com) )にアクセスします> Synthetics > (モニターを選択) > Settings > General > Advanced options**で、Verify SSL チェック\*\*を無効にし**ます。
