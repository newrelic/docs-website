...
ご使用の [価格エディションによって、](https://newrelic.com/pricing) 1 か月あたり無料で含まれる合成モニター チェックの数が決まります。これらの制限は、単純な ping モニターを除くすべての [モニター タイプ](/docs/synthetics/synthetic-monitoring/getting-started/types-synthetic-monitors) に適用されます。
