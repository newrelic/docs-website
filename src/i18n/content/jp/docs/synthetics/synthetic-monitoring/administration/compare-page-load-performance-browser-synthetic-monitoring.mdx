...
<CollapserGroup>
  ...
  >
    ...
    1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetic monitoring >(モニターを選択) > Summary**に移動します。
...
1. シンセティック モニタリング UI から: **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > シンセティック モニタリング >(モニターを選択) > サマリー**に移動します。
