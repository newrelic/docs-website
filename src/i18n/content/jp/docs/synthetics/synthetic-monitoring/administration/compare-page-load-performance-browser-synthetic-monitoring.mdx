...
<CollapserGroup>
  ...
  >
    ...
    1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > (モニターを選択) > Summary**に移動します。
...
1. SyntheticモニタリングUIから: **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > (モニターを選択) > Summary**に移動します。
