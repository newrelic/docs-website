...
* [カスタムヘッダー](/docs/synthetics/new-relic-synthetics/administration/identify-synthetics-requests-your-app)を使用して許可リストにIPアドレスを追加できます。
...
<Callout variant="important">
  [新しいIPアドレスの範囲](/docs/synthetics/synthetic-monitoring/administration/new-synthetic-public-minion-ips)では、ファイアウォールの設定を再設定する必要があります。
</Callout>
  ...
  <thead>
    ...
    <tr>
      <td>
        ...
        * [IP範囲リスト](https://nr-synthetics-assets.s3.amazonaws.com/nat-ip-dnsname/production/ip-ranges.json)
      </td>
    </tr>
  </thead>
</table>
