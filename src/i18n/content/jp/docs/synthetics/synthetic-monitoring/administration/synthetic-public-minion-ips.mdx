...
<Callout variant="important">
  許可リストまたは関連する設定には、_IPとIP範囲リスト_の[両方](#dynamic-ip-addresses)が含まれていることを確認してください。リクエストはどちらの環境からも送信できます。
</Callout>
...
<Callout variant="important">
  2022年10月3日に[IPアドレスの範囲が追加](/docs/synthetics/synthetic-monitoring/administration/new-synthetic-public-minion-ips/#us_new_ip)されます。一部のお客様は、このトラフィックを許可するために、ファイアウォール、ボット検出、または関連する設定を更新する必要があります。
</Callout>
