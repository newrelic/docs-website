...
New Relic One ユーザーモデルのユーザーの場合、合成モニタリング UI を使用して合成モニターを作成および管理する機能には、 [フルプラットフォームユーザー](/docs/accounts/accounts-billing/new-relic-one-pricing-users/users-roles#user-type) のユーザータイプが必要です。

APIの使用に関する制限については、 [User limitations](/docs/accounts/accounts-billing/new-relic-one-pricing-users/transition-guide-new-pricing-plan#limitations) を参照してください。