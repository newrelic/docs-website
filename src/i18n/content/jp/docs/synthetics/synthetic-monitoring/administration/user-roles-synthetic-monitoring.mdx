...
シンセティックモニタリングUIを使用するには、 [フルプラットフォームユーザー](/docs/accounts/accounts-billing/new-relic-one-pricing-users/users-roles#user-type) のユーザータイプが必要です。ロールとケイパビリティについては、 [ケイパビリティ](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts#capabilities) を参照してください。
