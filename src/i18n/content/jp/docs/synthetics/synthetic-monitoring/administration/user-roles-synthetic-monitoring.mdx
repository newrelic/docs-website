...
New Relic 権限の仕組みの詳細については、 [「 ユーザー管理の概念 」](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts/#groups)を参照してください。詳細な合成関連の機能を確認するには、 [「機能」](/docs/accounts/accounts-billing/new-relic-one-user-management/user-permissions/#synthetics)を参照してください。
