...
これを確認する方法について[は、プライベート ロケーションにさらに合成ジョブ マネージャーが必要ですか?](/docs/synthetics/new-relic-synthetics/private-locations/monitor-private-locations#more-minions)を参照してください。
