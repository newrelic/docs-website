...
<CollapserGroup>
  <Collapser
    ...
    title={<><img src="/images/synthetic_logo_docker-logo.webp" title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}/>Dockerのログを確認する</>}
  >
  ...
  <Collapser
    ...
    title={<><img src="/images/synthetic_logo_k8logo.webp" title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png" style={{ height: '35px', width: '40px' }}/>レビュー Kubernetesのログ</>}
  >
...
<CollapserGroup>
  <Collapser
    ...
    title={<><img src="/images/synthetic_logo_docker-logo.webp" title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}/>Dockerのデバッグログを有効にする</>}
  >
    <Callout variant="tip">
  ...
  <Collapser
    ...
    title={<><img src="/images/synthetic_logo_k8logo.webp" title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png" style={{ height: '35px', width: '40px' }}/>Kubernetesのデバッグログの有効化</>}
  >
    <Callout variant="tip">
