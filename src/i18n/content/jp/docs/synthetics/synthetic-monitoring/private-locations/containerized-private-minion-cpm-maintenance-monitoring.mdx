...
<CollapserGroup>
  <Collapser
    ...
    title={<><ImageSizing width="40px" height="35px"><img src={dockerLogoCrop} title="Docker icon" alt="Docker icon"/></ImageSizing>Review Docker logs</>}
  >
  ...
  <Collapser
    ...
    title={<><ImageSizing width="40px" height="35px"><img src={imgIntegrationK8S402X} title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png"/></ImageSizing>Review Kubernetes logs</>}
  >
...
<CollapserGroup>
  <Collapser
    ...
    title={<><ImageSizing width="40px" height="35px"><img src={dockerLogoCrop} title="Docker icon" alt="Docker icon"/></ImageSizing>Enable Docker debug logs</>}
  >
    <Callout variant="tip">
  ...
  <Collapser
    ...
    title={<><ImageSizing width="40px" height="35px"><img src={imgIntegrationK8S402X} title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png"/></ImageSizing>Enable Kubernetes debug logs</>}
  >
    <Callout variant="tip">
