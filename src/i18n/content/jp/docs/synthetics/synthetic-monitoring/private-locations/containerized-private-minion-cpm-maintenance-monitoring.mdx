...
* Check if the CPM is healthy and working with the [CPM status API](#cpm-status-api).
...
## Check CPM status via Synthetics REST API [#cpm-status-api]

Querying a running CPM with the [Synthetics REST API](https://docs.newrelic.co.jp/docs/apis/synthetics-rest-api/monitor-examples/manage-synthetics-monitors-rest-api) is the easiest way to check if it's healthy and working. The container exposes two ports: `8080` and `8180`. You can check the CPM with the following endpoints:
...
<CollapserGroup>
  <Collapser
    ...
    title={<><ImageSizing width="40px" height="35px">![Docker icon](/sites/default/files/thumbnails/image/docker-logo-crop.png "Docker icon")</ImageSizing>Review Docker logs</>}
  >
  ...
  <Collapser
    ...
    title={<><ImageSizing width="40px" height="35px">![img-integration-k8s@2x.png](/sites/default/files/thumbnails/image/img-integration-k8s%402x.png "img-integration-k8s@2x.png")</ImageSizing>Review Kubernetes logs</>}
  >
...
<CollapserGroup>
  <Collapser
    ...
    title={<><ImageSizing width="40px" height="35px">![Docker icon](/sites/default/files/thumbnails/image/docker-logo-crop.png "Docker icon")</ImageSizing>Enable Docker debug logs</>}
  >
    <Callout variant="tip">
  ...
  <Collapser
    ...
    title={<><ImageSizing width="40px" height="35px">![img-integration-k8s@2x.png](/sites/default/files/thumbnails/image/img-integration-k8s%402x.png "img-integration-k8s@2x.png")</ImageSizing>Enable Kubernetes debug logs</>}
  >
    <Callout variant="tip">
