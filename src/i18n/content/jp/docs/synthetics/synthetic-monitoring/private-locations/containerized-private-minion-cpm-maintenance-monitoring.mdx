...
<CollapserGroup>
  <Collapser
    ...
    title={<><ImageSizing width="40px" height="35px">![Docker icon](./images/docker-logo-crop.png "Docker icon")</ImageSizing>Review Docker logs</>}
  >
  ...
  <Collapser
    ...
    title={<><ImageSizing width="40px" height="35px">![img-integration-k8s@2x.png](./images/img-integration-k8s%402x.png "img-integration-k8s@2x.png")</ImageSizing>Review Kubernetes logs</>}
  >
...
<CollapserGroup>
  <Collapser
    ...
    title={<><ImageSizing width="40px" height="35px">![Docker icon](./images/docker-logo-crop.png "Docker icon")</ImageSizing>Enable Docker debug logs</>}
  >
    <Callout variant="tip">
  ...
  <Collapser
    ...
    title={<><ImageSizing width="40px" height="35px">![img-integration-k8s@2x.png](./images/img-integration-k8s%402x.png "img-integration-k8s@2x.png")</ImageSizing>Enable Kubernetes debug logs</>}
  >
    <Callout variant="tip">
