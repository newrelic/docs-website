...
<CollapserGroup>
  <Collapser
    ...
    title={<><img src="/images/synthetic_logo_docker.webp" title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}/>コンテナシステム環境要件</>}
  >
    <table>
      <thead>
        <tr>
  ...
  <Collapser
    ...
    title={<><img src="/images/synthetic_logo_k8logo.webp" title="Kubernetes icon" alt="Kubernetes icon" style={{ height: '35px', width: '40px' }}/>Kubernetesコンテナオーケストレーションシステムの環境要件（CPM v3.0.0以降）</>}
  >
    <table>
      <thead>
        <tr>
...
<CollapserGroup>
  <Collapser
    ...
    title={<><img src="/images/synthetic_logo_docker.webp" title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}/>の依存関係</>}
  >
...
<CollapserGroup>
  <Collapser
    id="docker-update"
    title={<><img src="/images/synthetic_logo_docker.webp" title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}/>開始手順</>}
  >
  ...
  <Collapser
    ...
    title={<><img src="/images/synthetic_logo_k8logo.webp" title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png" style={{ height: '35px', width: '40px' }}/>の開始手順</>}
  >
    <Callout
      variant="important"
      title="EOL通知"
...
<CollapserGroup>
  <Collapser
    id="docker-stop"
    title={<><img src="/images/synthetic_logo_docker.webp" title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}/>停止手順</>}
  >
  ...
  <Collapser
    ...
    title={<><img src="/images/synthetic_logo_k8logo.webp" title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png" style={{ height: '35px', width: '40px' }}/>の削除手順</>}
  >
...
<CollapserGroup>
  <Collapser
    id="run-non-root"
    title={<><img src="/images/synthetic_logo_docker.webp" title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}/>の非rootユーザーとして実行</>}
  >
