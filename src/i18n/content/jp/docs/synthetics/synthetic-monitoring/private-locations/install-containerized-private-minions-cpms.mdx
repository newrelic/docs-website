...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        To set up communication with New Relic by proxy, use the [environment variables](https://docs.newrelic.co.jp/docs/synthetics/new-relic-synthetics/private-locations/containerized-private-minion-cpm-configuration#environment-variables) named `MINION_API_PROXY*.`
      </td>
    </tr>
