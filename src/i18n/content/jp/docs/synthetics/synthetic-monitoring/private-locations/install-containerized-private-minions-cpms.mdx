      ...
      <tbody>
        <tr>
          ...
          <td>
            ...
            _また、Windows ベースのdockerホストで 1分間あたりの呼出回数 を動作させるには、Linux コンテナーを実行するようにdockerを構成する必要があります。_
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**Ping:**</DoNotTranslate> 無視できる<br/><DoNotTranslate>**Scripted API:**</DoNotTranslate> 7<br/> <DoNotTranslate>**Simple browser:**</DoNotTranslate> 27<br/> <DoNotTranslate>**Scripted browser:**</DoNotTranslate> 28
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            <DoNotTranslate>**Linux kernel:**</DoNotTranslate> 3.10以上<br/><DoNotTranslate>**macOS:**</DoNotTranslate> 10.11 以上<br/>
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**Root volume:**</DoNotTranslate> 最小 50 GiB (ノード + PV)<br/> <DoNotTranslate>**Persistent volume (PV):**</DoNotTranslate>最小 20 GiB
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**Ping:**</DoNotTranslate> 無視できる<br/><DoNotTranslate>**Scripted API:**</DoNotTranslate> 11<br/> <DoNotTranslate>**Simple browser:**</DoNotTranslate> 33<br/> <DoNotTranslate>**Scripted browser:**</DoNotTranslate> 31
        ...
        <tr>
          ...
          <td>
            Kubernetes クラスターが[Kubernetes v1.15](https://kubernetes.io/blog/2019/06/19/kubernetes-1-15-release-announcement/)をサポートすることをお勧めします。<Callout variant="caution">Kubernetes v1.21 以降の場合は、minion リリース[v3.0.61](/docs/release-notes/synthetics-release-notes/containerized-private-minions-release-notes/containerized-private-minion-cpm-3061)以降を使用します。</Callout>
          </td>
        </tr>
...
2. <DoNotTranslate>**Private locations**</DoNotTranslate>
   ...
   インデックスで、1 分間あたりの発信回数を割り当てるプライベート ロケーションを見つけます。
...
<CollapserGroup>
  ...
  >
    ...
    * 書き込み可能なDockerUNIXソケットは、 `/var/run/docker.sock`または`DOCKER_HOST` [環境変数](/docs/synthetics/new-relic-synthetics/private-locations/containerized-private-minion-cpm-configuration#environment-variables)にマウントされます。詳細については、Dockerの[デーモンソケットオプション](https://docs.docker.com/engine/reference/commandline/dockerd/#daemon-socket-option)を参照してください。
      ...
      <Callout variant="caution">
        ホスト上のコア数によって、1分間あたりの呼発信回数がホスト上で同時に実行できるランナー コンテナの数が決まります。 メモリ要件はランナー コンテナの予想される数に合わせて調整されるため、リソースの競合を避けるために<DoNotTranslate>**not running multiple CPMs on the same host**</DoNotTranslate>を推奨します。
      </Callout>
