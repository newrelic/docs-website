  ...
  >
    ...
    <Steps>
      <Step>
        ...
        1. **[one.newrelic.com > Synthetic monitoring > Private locations](https://one.newrelic.com/synthetics/private-location-list)**の順に移動します。次に、**Create private location**をクリックします。<img
