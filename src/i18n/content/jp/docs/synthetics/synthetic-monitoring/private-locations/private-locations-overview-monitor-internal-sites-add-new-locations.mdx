...
<img
  ...
  src={privateLocations}
/>

<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Synthetics > Private Locations**：**Private Locations**ページを使用して、プライベートロケーションを作成、編集、および削除します。
</figcaption>
...
2. **[one.newrelic.com](https://one.newrelic.com) > Synthetics > Private locations**の順に移動します。次に、<Icon name="fe-plus-circle"/>**Create private location**を選択します。
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Synthetics > Create monitor**：プライベートロケーションとそのミニオンに新しいジョブを割り当てるには、**Create monitor**ページから名前を選択します。
</figcaption>
...
これらのツールにアクセスするには、**[one.newrelic.com](https://one.newrelic.com) > Synthetics > Private locations**の順に選択します。以下の手順に従います：
