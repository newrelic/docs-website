...
1. **\[one.newrelic.com** ]( [https://one.newrelic.com](https://one.newrelic.com) )にアクセスします> 合成 > (モニターを選択)\*\*.
...
<figcaption>
  **\[one.newrelic.com** ]( [https://one.newrelic.com](https://one.newrelic.com) )> Synthetics > (モニターを選択) > Failures > (チェックの失敗を選択):**失敗したモニター チェックの詳細を表示するには、 <Icon name="fe-rotate-cw"/>**チェック\*\*を実行します。
</figcaption>
