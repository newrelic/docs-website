...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > (モニターを選択) > Results**に移動します。
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > (モニターを選択) > Results > (結果を選択)** : ロード時間や合計ロード サイズなど、各モニター チェックの詳細を表示します。
</figcaption>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        2. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > (モニターを選択) > Results > (結果を選択) > View transaction trace**に移動します。
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > (モニターを選択) > 結果 > (結果を選択)**
</figcaption>
