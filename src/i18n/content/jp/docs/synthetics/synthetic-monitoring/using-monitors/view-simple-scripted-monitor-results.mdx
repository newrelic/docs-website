...
1. **\[one.newrelic.com** ]( [https://one.newrelic.com](https://one.newrelic.com) )にアクセスします> 合成 > (モニターを選択) > 結果\*\*。
...
<figcaption>
  **\[one.newrelic.com** ]( [https://one.newrelic.com](https://one.newrelic.com) )> Synthetics > (モニターを選択) > Results > (結果を選択)\*\*: ロード時間と合計ロード サイズを含む、各モニター チェックの詳細を表示します。
</figcaption>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        2. **\[one.newrelic.com** ]( [https://one.newrelic.com](https://one.newrelic.com) )にアクセスします> Synthetics > (モニターを選択) > Results > (結果を選択) > View transaction trace\*\*.
...
<figcaption>
  **\[one.newrelic.com** ]( [https://one.newrelic.com](https://one.newrelic.com) )> 合成 > (モニターを選択) > 結果 > (結果を選択)\*\*
</figcaption>
