...
<Callout variant="tip">
  モニターのランタイム バージョンが不明な場合は、[モニターを編集し](/docs/synthetics/synthetic-monitoring/using-monitors/new-runtime/#runtime-convert)、\[モニターの構成] タブの<DoNotTranslate>**"Runtime"**</DoNotTranslate>ドロップダウンを確認してください。 `runtimeType = 'NODE_API'`が存在する`SyntheticCheck`イベントの`runtimeTypeVersion`属性をクエリすることもできます。
</Callout>
...
<CollapserGroup>
  ...
  >
    ...
    * <DoNotTranslate>**Browser**</DoNotTranslate>
      ...
      : Chrome 117 (プライベートロケーション用の外形監視-node-browser-runtime イメージのバージョン 2.2 以降が必要です。 Chrome 112 または 100 は、古いbrowserランタイム イメージで使用されます。)

    * <DoNotTranslate>**Selenium WebDriver**</DoNotTranslate>

      ：4.1.0 (下位互換性のある Selenium ウェブサイト 3.6 構文を使用して`$selenium`および`$webDriver`を介して公開され、 `$browser`および`$driver`を介して公開されます)
...
<Callout variant="tip">
  モニターのバージョンが不明な場合は、 <DoNotTranslate>**[one.newrelic.com > Synthetic monitoring](https://one.newrelic.com/synthetics-nerdlets) > Upgrade monitors**</DoNotTranslate>に移動してください。 最新のランタイム バージョンを使用している場合、 <DoNotTranslate>**Upgrade monitors**</DoNotTranslate>オプションは表示されません。
</Callout>
...
<CollapserGroup>
  ...
  >
    ...
    * <DoNotTranslate>**Selenium WebDriver**</DoNotTranslate>
      ...
      ：3.6.0 ( `$browser`および`$driver`経由で公開)
  ...
  >
    ...
    * <DoNotTranslate>**Selenium WebDriver**</DoNotTranslate>
      ...
      ：3.5.0 ( `$browser>`および`$driver`経由で公開)
  ...
  >
    ...
    * <DoNotTranslate>**Selenium WebDriver**</DoNotTranslate>
      ...
      : 2.47.0 ( `$browser>`および`$driver`経由で公開)
  ...
  >
    ...
    * <DoNotTranslate>**Selenium WebDriver**</DoNotTranslate>
      ...
      : 2.44.0 ( `$browser>`および`$driver`経由で公開)
