...
<CollapserGroup>
  ...
  >
    モニターが新しい機能にアクセスし、期待どおりに動作するようにするには、\[**モニターのアップグレード**] ボタンが表示されるたびにモニターをアップグレードしてください。**\[one.newrelic.com** ]( [https://one.newrelic.com](https://one.newrelic.com) ) にアクセスして、モニターをアップグレードすることもできます。> 合成 > モニターをアップグレード\*\*。
...
<Callout variant="tip">
  モニターのバージョンが不明な場合は、 **\[one.newrelic.com** ]( [https://one.newrelic.com](https://one.newrelic.com) ) にアクセスしてください。> シンセティック > モニターのアップグレード** .既に最新のランタイム バージョンを使用している場合、\[ **モニターのアップグレード]\*\* オプションは表示されません。
</Callout>
