...
<CollapserGroup>
  ...
  >
    ...
    1. **[one.newrelic.com](https://one.newrelic.com) > Synthetics**に移動し、アップグレードするモニターを選択します。
  ...
  >
    モニターが新しい機能にアクセスし、期待どおりに動作するようにするには、\[**モニターのアップグレード**] ボタンが表示されるたびにモニターをアップグレードしてください。**[one.newrelic.com](https://one.newrelic.com) > Synthetics > Upgrade monitoring**に移動して、モニターをアップグレードすることもできます。
...
<Callout variant="tip">
  モニターのバージョンが不明な場合は、 **[one.newrelic.com](https://one.newrelic.com) > Synthetics > Upgrade Monitor**に移動してください。既に最新のランタイム バージョンを使用している場合、\[**モニターのアップグレード**] オプションは表示されません。
</Callout>
