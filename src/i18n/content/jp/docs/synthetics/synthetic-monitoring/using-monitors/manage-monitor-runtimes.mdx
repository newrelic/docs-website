...
<CollapserGroup>
  <Collapser
    id="NewUpgrade"
    title={<>Chrome 100、Node.js 16 以降にアップグレードしてください</>}
  >
  ...
  >
    モニターが新しい機能にアクセスし、期待どおりに動作するようにするには、\[**モニターのアップグレード**] ボタンが表示されるたびにモニターをアップグレードしてください。**[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetic monitoring >Upgrade monitoring**に移動して、モニターをアップグレードすることもできます。
