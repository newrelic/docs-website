  ...
  <tbody>
    ...
    <tr>
      <td>
        ...
        [外形監視 Job Manager の設定](/docs/synthetics/synthetic-monitoring/private-locations/job-manager-configuration/#user-defined-vars)についてはドキュメントを参照してください。
      </td>
...
<CollapserGroup>
  <Collapser
    id="Chrome100"
    title={<>Chrome（<strong>最新</strong>）</>
    }
  >
    最新のChromeブラウザランタイムの詳細：
