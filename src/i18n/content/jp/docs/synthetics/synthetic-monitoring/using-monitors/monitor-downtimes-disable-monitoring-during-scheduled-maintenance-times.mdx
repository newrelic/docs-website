...
<Callout variant="important">
  During synthetic monitor downtimes, your selected monitors stop running until their scheduled end time. To temporarily disable alerts without pausing your monitors, [mute them](https://docs.newrelic.co.jp/docs/synthetics/new-relic-synthetics/using-monitors/alerting-synthetics#mute) instead.
</Callout>
