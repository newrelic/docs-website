...
<CollapserGroup>
  ...
  >
    1. [**one.newrelic.com**](http://one.newrelic.com/)へ移動します。\[**Synthetics**] を選択します。エクスプローラーnavの右端にある<Icon name="fe-plus-circle"/> \[[**Create monitor**](https://one.newrelic.com/synthetics-nerdlets/monitor-create)] をクリックします。
