...
import syntheticAddMoreDataCreate from 'images/synthetic_screenshot-full_add-more-data-create.webp'

import syntheticCreateMonitorPage from 'images/synthetic_screenshot-crop_Create-monitor-page.webp'
...
<CollapserGroup>
  ...
  >
    ...
    3. オプション：**デバイスエミュレーション**、**検証文字列**または**高度なオプション**を追加します。

       * デバイスの種類や画面の向きなどの[デバイスエミュレーション](/docs/synthetics/synthetic-monitoring/using-monitors/device-emulation)設定は、シンプルブラウザモニターで利用できます。
    ...
    4. 各場所でモニターを実行する[期間](#setting-frequency)を選択します。
