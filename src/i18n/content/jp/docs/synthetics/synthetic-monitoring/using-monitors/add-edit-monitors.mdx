...
<CollapserGroup>
  ...
  >
    ...
    数分待ってから、[**Monitor**インデックス](/docs/new-relic-one-monitors-index)からモニターを確認します。
  </Collapser>
