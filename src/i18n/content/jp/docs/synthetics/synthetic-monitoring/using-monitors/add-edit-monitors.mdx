...
<CollapserGroup>
  ...
  >
    1. [**one.newrelic.com**](http://one.newrelic.com/)へ移動してから、\[**Synthetics**] を選択します。エクスプローラーnavの右端にある<Icon name="fe-plus-circle"/> \[[**Create monitor**](https://one.newrelic.com/synthetics-nerdlets/monitor-create?account=3501165&state=81b68a54-0e7f-46ac-d519-09477745afee)] をクリックします。
