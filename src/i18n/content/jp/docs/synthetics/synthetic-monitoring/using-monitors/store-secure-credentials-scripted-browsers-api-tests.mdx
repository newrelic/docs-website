...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        アカウント管理者は、 [ユーザーの権限を管理](/docs/accounts/accounts-billing/general-account-settings/factors-affecting-access-features-data)することにより、安全な資格情報を`create` 、 `view` 、または`delete`できるユーザーを制御できます。
      </td>
    </tr>
