...
<CollapserGroup>
  ...
  >
    ...
    1. **[one.newrelic.com > Synthetic monitoring \[合成モニタリング\] > Secure credentials \[安全な認証情報\]](http://one.newrelic.com/synthetics/secure-credential-list)**に移動します。変更する資格情報の 3 つの点**...**をクリックし、 **Edit** \[編集] をクリックします。
  ...
  >
    ...
    4. 用語`$secure.`を検索して、安全な認証情報へのすべての参照を強調表示し、見つかったものをメモします。
       ...
       次に、スクリプト内で見つかった資格情報をローテーションします。

    5. **[one.newrelic.com > Synthetic monitoring > Secure credentials](http://one.newrelic.com/synthetics/secure-credential-list)**に移動します。
    ...
    7. 変更する資格情報の 3 点アイコン**...**をクリックし、 **Edit** \[編集] をクリックします。
