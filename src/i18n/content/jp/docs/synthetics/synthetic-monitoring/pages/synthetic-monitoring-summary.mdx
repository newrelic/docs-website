...
<table>
  ...
  <tbody>
    ...
    <tr id="view-alert">
      ...
      <td>
        [アクティビティパネル](#activity-panel) で、表示されたアラートをクリックすると、 [アラートインシデント](/docs/alerts-applied-intelligence/new-relic-alerts/alert-incidents/view-event-details-incidents) のページに直接移動します。
      </td>
    </tr>
