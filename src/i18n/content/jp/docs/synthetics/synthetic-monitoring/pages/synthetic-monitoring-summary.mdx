...
モニターの**概要**ページにアクセスするには: **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Explorer > Synthetic monitoring > (select a monitor)**に移動します。**[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > (モニターを選択)**からもアクセスできます。
