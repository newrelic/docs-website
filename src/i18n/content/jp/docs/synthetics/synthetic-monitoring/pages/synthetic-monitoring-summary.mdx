...
モニターの**\[概要**] ページにアクセスするには: **[one.newrelic.com](https://one.newrelic.com) > Explorer > 合成モニター > (モニターを選択)**に移動します。**[one.newrelic.com](https://one.newrelic.com) > Synthetics > (モニターを選択)**からもアクセスできます。
