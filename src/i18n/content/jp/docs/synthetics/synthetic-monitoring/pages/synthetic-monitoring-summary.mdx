...
モニターの**概要**ページにアクセスするには: **\[one.newrelic.com** ]( [https://one.newrelic.com](https://one.newrelic.com) ) にアクセスします。> エクスプローラー > 合成モニター > (モニターを選択) **. **[one.newrelic.com ](https://one.newrelic.com)> Synthetics > (モニターを選択)\*\* からもアクセスできます。
