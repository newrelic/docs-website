...
* スクリプト化されたブラウザーの例を表示および共有するには、New Relic の[サポート フォーラム](https://discuss.newrelic.com/c/support-products-agents/synthetics)で、 [synthetic-script](https://discuss.newrelic.com/tags/c/support-products-agents/synthetics/synthetics-script)というタグが付けられたトピックを確認してください。
