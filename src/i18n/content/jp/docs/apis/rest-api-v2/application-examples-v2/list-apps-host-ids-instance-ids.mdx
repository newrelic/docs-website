...
[REST API Explorer の<DoNotTranslate>**Applications > List**</DoNotTranslate>](/docs/apis/using-the-api-explorer)を使用して ID の詳細を一覧表示することもできます。 正しいアプリケーション名を入力してください。
...
[REST API Explorer の<DoNotTranslate>**Applications > List**</DoNotTranslate>](/docs/apis/using-the-api-explorer)または<DoNotTranslate>**Applications > List**</DoNotTranslate>を使用して ID の詳細を一覧表示することもできます。 正しいアプリケーション名を入力してください。
