...
* 必ず $&#x7B;APPID}に置き換えてください。 と $&#x7B;APIKEY}を入れてください。には、あなたの [アプリケーションID](/docs/apm/apis/requirements/identification-code) と [APIキー](/docs/apis/rest-api-v2/requirements/rest-api-key) を入力してください。
