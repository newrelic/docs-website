...
<Callout variant="tip">
  [New Relic API Explorer（v2）](https://api.newrelic.com/docs)から同じ情報を取得するには、[<DNT>**Application Hosts &gt; GET Metric Data**</DNT>](https://api.newrelic.com/docs/#/Applications/get_applications__application_id__hosts__host_id__metrics_data_json)を選択し、[APIキー](/docs/apis/rest-api-v2/getting-started/introduction-new-relic-rest-api-v2#api_key)を含めます。適切なフィールドに、[アプリケーションID](/docs/apm/apis/requirements/identification-code)、[ホストID](/docs/apis/rest-api-v2/requirements/listing-host-instance-application-server-ids#locating_host_id)、および`names[]=CPU/User Time`と`values[]=percent`のメトリクスを追加します。
</Callout>
...
<Callout variant="tip">
  [New Relic API Explorer（v2）](https://api.newrelic.com/docs)から同じ情報を取得するには、[<DNT>**Applications &gt; GET Metric Data**</DNT>](https://api.newrelic.com/docs/#/Applications/get_applications__application_id__metrics_data_json)を選択し、[APIキー](/docs/apis/rest-api-v2/getting-started/introduction-new-relic-rest-api-v2#api_key)を含めます。適切なフィールドに[アプリケーションID](/docs/apm/apis/requirements/identification-code)、および`names[]=CPU/User Time`と`values[]=percent`のメトリクスを追加します。
</Callout>