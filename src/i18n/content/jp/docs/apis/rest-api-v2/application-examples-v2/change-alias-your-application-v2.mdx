...
New Relic REST API（v2）からアプリ名のエイリアスを変更するには、このコマンドを使用します。New Relicの[API Explorer](/docs/apis/rest-api-v2/api-explorer-v2/getting-started-new-relics-api-explorer)から[<DNT>**Applications &gt; Update**</DNT>](https://api.newrelic.com/docs/#/Applications/put_applications__id__json)を選択して、アプリのエイリアスを変更することもできます。
...
<Callout variant="important">
  アプリのエイリアスを変更すると、このアプリ識別子でレポートするすべてのエージェントが再起動されます。詳細については、[アプリケーションの名前変更](/docs/apm/agents/manage-apm-agents/app-naming/name-your-application/#app-alias)をご覧ください。
</Callout>
