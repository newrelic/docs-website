...
[New Relic API Explorer（v2）](https://api.newrelic.com/docs)から同じ情報を取得するには：

1. [<DNT>**Application Hosts &gt; GET Metric Data**</DNT>](https://api.newrelic.com/docs/#/Applications/get_applications__application_id__hosts__host_id__metrics_data_json)を選択し、[APIキー](/docs/apis/rest-api-v2/getting-started/introduction-new-relic-rest-api-v2#api_key)を含めます。
...
1. [<DNT>**Applications &gt; GET Metric Data**</DNT>](https://api.newrelic.com/docs/#/Applications/get_applications__application_id__metrics_data_json)を選択し、[APIキー](/docs/apis/rest-api-v2/getting-started/introduction-new-relic-rest-api-v2#api_key)を含めてください。
