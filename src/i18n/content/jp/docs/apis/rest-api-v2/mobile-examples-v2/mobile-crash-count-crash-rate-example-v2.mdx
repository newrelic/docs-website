...
<Callout variant="tip">
  New Relic API Explorerを使用して、[モバイルメトリクスデータ](https://api.newrelic.com/docs/#/Mobile%20Applications/get_mobile_applications__mobile_application_id__metrics_data_json)を取得することもできます。
</Callout>
