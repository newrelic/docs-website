...
* 主要なエンドポイント：[`https://api.newrelic.com/graphql`](https://api.newrelic.com/graphql)
* EUエンドポイント：[EUデータセンター](/docs/using-new-relic/welcome-new-relic/get-started/our-eu-us-region-data-centers)にデータのあるアカウントの場合は、[`https://api.eu.newrelic.com/graphiql`](https://api.eu.newrelic.com/graphiql)を使用します。
