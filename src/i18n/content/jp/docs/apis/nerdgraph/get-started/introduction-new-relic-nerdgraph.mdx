...
GraphQLの使用を開始するには、NerdGraphエクスプローラーで再生することをお勧めします。エクスプローラーを見つけて使用する方法については、[NerdGraphエクスプローラーチュートリアル](/docs/apis/nerdgraph/get-started/nerdgraph-explorer)を参照してください。
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        * [ユーザーグループとアクセス許可の管理](/docs/apis/nerdgraph/examples/nerdgraph-user-mgmt)
