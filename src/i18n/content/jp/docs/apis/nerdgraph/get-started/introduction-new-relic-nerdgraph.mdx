...
* メインエンドポイント：[https://api.newrelic.com/graphql](https://api.newrelic.com/graphql)
* EUデータセンターを使用するアカウントのエンドポイント：[https://api.eu.newrelic.com/graphql](https://api.eu.newrelic.com/graphql)
