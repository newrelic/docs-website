...
<Steps>
  <Step>
    ...
    1. NerdGraph APIエクスプローラーを開きます。URLは、アカウントをホストするデータセンターのリージョンによって異なります：

       * US（デフォルトリージョン）： <DNT>[one.newrelic.com/nerdgraph-graphiql](https://one.newrelic.com/nerdgraph-graphiql)</DNT>
