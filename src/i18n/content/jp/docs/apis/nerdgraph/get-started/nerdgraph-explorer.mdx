...
有効な[NewRelicユーザーキー](/docs/apis/get-started/intro-apis/types-new-relic-api-keys#user-api-key)があることを確認してください。NerdGraphエクスプローラーから作成するか、 [APIキーUI](https://one.newrelic.com/launcher/api-keys-ui.api-keys-launcher)で表示して作成できます。
