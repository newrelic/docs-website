...
<Callout variant="tip">
  廃止されたInsights Dashboard APIを使用している場合は、新しいAPIの使用に移行するための [移行ガイド](/docs/new-relic-one/use-new-relic-one/core-concepts/dashboards-api-migration-insights-api-nerdgraph/) を用意しています。
</Callout>
