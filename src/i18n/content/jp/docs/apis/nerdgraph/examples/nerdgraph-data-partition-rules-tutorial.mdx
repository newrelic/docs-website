...
NerdGraphは、 [api.newrelic.com/graphiql](https://api.newrelic.com/graphiql) で、 [データ・パーティション・ルール](https://docs.newrelic.com/docs/logs/log-management/ui-data/data-partitions/) のログの作成、照会、管理にご利用いただけます。NerdGraphは、GraphQL形式のAPIエクスプローラーです。
