---
title: 'NerdGraph チュートリアル: アラートインシデント相関のトポロジー'
metaDescription: 'Use New Relic NerdGraph to set up or view alert topology, used for incident correlation.'
freshnessValidatedDate: never
translationType: machine
---

このチュートリアルでは、NerdGraph API を使用してトポロジを設定する方法について説明します。 トポロジ設定により[、集計の決定と](/docs/alerts-applied-intelligence/applied-intelligence/incident-intelligence/change-applied-intelligence-correlation-logic-decisions)インシデントの相関関係をより適切に把握できるようになります。
...
New Relic の[アラートを](/docs/alerts-applied-intelligence/new-relic-alerts/get-started/introduction-applied-intelligence/)使用すると、インシデントの相関関係を制御するカスタム[決定](/docs/alerts-applied-intelligence/applied-intelligence/incident-intelligence/change-applied-intelligence-correlation-logic-decisions)を作成できます。 1 種類のカスタム決定ロジックでは、「トポロジ」の概念が使用されます。これは、サービス マップ (インフラストラクチャ内のサービスとリソースが相互にどのように関連しているか) を表します。
...
* [相関決定とは何か](/docs/alerts-applied-intelligence/applied-intelligence/incident-intelligence/change-applied-intelligence-correlation-logic-decisions)、 [トポロジ相関はどのように機能するか](/docs/alerts-applied-intelligence/applied-intelligence/incident-intelligence/change-applied-intelligence-correlation-logic-decisions/#topology)。
