...
チャートやダッシュボードを含むレポートをスケジュールする必要がありますか？ダッシュボードの共有方法を自動化したいと思いませんか？ [GraphQL](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph) mutation を使用して、ダッシュボードを PDF または PNG ファイルとしてプログラムで取得できます。

<Callout variant="tip">
  また、 [UIを使用してダッシュボードをPDFファイルとしてエクスポートすることもできます](/docs/dashboards/manage-your-dashboard/manage-your-dashboard#dash-export) 。
</Callout>
