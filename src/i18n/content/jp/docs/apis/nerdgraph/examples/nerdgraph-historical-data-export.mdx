---
title: 'NerdGraph: 履歴データのエクスポートを使用して、より大きな NRQL 応答を返す'
tags:
  - APIs
  - NerdGraph
  - Examples
...
* データをエクスポートするには、\*\* 機能を持つ[コアまたはフル プラットフォーム ユーザー](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type)である必要があります
