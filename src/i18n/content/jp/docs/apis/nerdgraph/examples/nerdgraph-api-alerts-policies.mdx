---
title: 'NerdGraph チュートリアル: アラートポリシー'
tags:
  - Alerts
...
<CollapserGroup>
  <Collapser id="list-all-policies" title="アカウントの全ポリシーの一覧表示">
    次の例を見てみましょう。
  ...
  <Collapser id="paginate" title="カーソルページネーションによるポリシーのページネーション">
  ...
  <Collapser id="list-policies-by-id" title="選択されたIDですべてのポリシーを見つける">
  ...
  <Collapser id="find-policies-by-name" title="すべてのポリシーを名前で検索">
    ...
    この例では、名前に`DevOps`が含まれるポリシーを検索します。
  ...
  <Collapser id="find-by-id" title="IDによるポリシーの検索">
