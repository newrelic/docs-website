...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="カーソルのページネーション"
  >
    ページネーションを通じて返される問題の最大数は NRQL [LIMIT MAX](/docs.newrelic.com/docs/nrql/nrql-syntax-clauses-functions/#sel-limit)によって設定されており、この制限を超える場合はフィルタリングが必要になることに注意してください。
