...
ワークフロー ID を取得するには、ワークフロー テーブルに移動し、行の末尾にある<DoNotTranslate>**...**</DoNotTranslate>をクリックします。 次に、 <DoNotTranslate>**Copy workflow id to clipboard**</DoNotTranslate>を選択します。
