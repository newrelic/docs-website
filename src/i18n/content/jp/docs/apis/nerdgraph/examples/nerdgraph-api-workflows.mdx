...
<CollapserGroup>
  <Collapser id="account" title="アカウントのすべてのワークフローを一覧表示する">
    ```graphql
    {
      actor {
  ...
  <Collapser id="pagination" title="カーソルページ付けを使用したポリシーのページ付け：">
  ...
  <Collapser id="by-id" title="IDでワークフローを検索">
    ```graphql
    {
      actor {
        account(id: YOUR_ACCOUNT_ID) {
  ...
  <Collapser id="by-name" title="名前でワークフローを検索">
    ```graphql
    {
      actor {
        account(id: YOUR_ACCOUNT_ID) {
  ...
  <Collapser id="destination-type" title="宛先タイプでワークフローを検索">
  ...
  <Collapser id="payload" title="ワークフロー チャネルのペイロードの一覧表示">
    ```graphql
    {
    actor {
    account(id: YOUR_ACCOUNT_ID) {
...
<CollapserGroup>
  <Collapser id="issues" title="すべての問題をキャッチするワークフローを作成する">
