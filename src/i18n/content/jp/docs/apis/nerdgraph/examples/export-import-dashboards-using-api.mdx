...
<Callout variant="tip">
  また、ダッシュボード
  [を画像としてエクスポートすることもできます](/docs/apis/nerdgraph/examples/export-dashboards-pdfpng-using-api)
  。
</Callout>
...
GraphiQL の出力に含まれるエンティティ情報の例。

![ダッシュボード_API_entity_section.png](src/images/dashboards_api_entity_section.png 'ダッシュボード_API_entity_section.png')
...
![ダッシュボード_API_paste_entity.png](src/images/dashboards_api_paste_entity.png 'ダッシュボード_API_paste_entity.png')
