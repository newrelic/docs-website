...
* <DNT>**`entityGuid`**</DNT>: このSLIを関連付ける[エンティティ](/docs/service-level-management/create-slm#sli-entity)（たとえば、<InlinePopover type="apm" />サービス、ブラウザアプリケーションなど）のGUID。UIでは、エンティティページの<DNT>**See metadata and manage tags**</DNT>の下にこのGUIDがあります。
