    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ルール評価のターゲットとなるアカウントIDです。コンプライアンスを評価するために、このリストで指定された各アカウントに対してNRQLクエリが実行されます。
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            クエリ実行中に含める補助アカウントIDです。これらのセカンダリアカウントからのデータを各プライマリターゲットアカウントと結合することで、クロスアカウントのNRQLクエリを有効にします。
          </td>
        </tr>
