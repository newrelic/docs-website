...
<CollapserGroup>
  ...
  >
    [New Relic ブラウザ エージェントのリリース ページ](https://docs.newrelic.com/docs/browser/browser-monitoring/getting-started/browser-agent-eol-policy/)から、必要なエージェントのバージョンを見つけます。
