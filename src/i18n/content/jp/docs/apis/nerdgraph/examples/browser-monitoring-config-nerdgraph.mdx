...
JavaScript スニペットを取得して、 [コピーしてアプリケーションに貼り付ける](/docs/browser/browser-monitoring/installation/install-browser-monitoring-agent/#copy-paste)ことができます。返されるスニペットは JSON でエンコードされた文字列であり、コピーして貼り付ける前に解析する必要があることに注意してください。
