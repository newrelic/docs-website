...
Synthetics REST APIを使用するには、Synthetics関連の[権限](/docs/accounts/accounts-billing/new-relic-one-user-management/user-permissions)、および<InlinePopover type="userKey"/>が必要です。
