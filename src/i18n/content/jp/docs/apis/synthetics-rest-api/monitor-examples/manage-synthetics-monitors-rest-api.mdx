...
Synthetics REST APIを使用するには、Synthetics関連の[機能](/docs/accounts/accounts-billing/new-relic-one-user-management/user-capabilities)、および<InlinePopover type="userKey"/>が必要です。
