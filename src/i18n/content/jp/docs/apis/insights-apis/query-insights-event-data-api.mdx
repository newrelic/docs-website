...
1. [one.newrelic.com/api-keys](https://one.newrelic.com/api-keys)に移動します。EUデータセンターを使用している場合は、代わりに[one.eu.newrelic.com/api-keys](https://one.eu.newrelic.com/api-keys)に移動してください
