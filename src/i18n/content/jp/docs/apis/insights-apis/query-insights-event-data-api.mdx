...
[クエリ制限](/docs/query-your-data/nrql-new-relic-query-language/get-started/rate-limits-nrql-queries/)があります。特に、これらの一般ガイドラインに従う場合は、これらの制限に遭遇することはありません。
...
New Relicによって[レート制限がアカウントに](/docs/insights/use-insights-ui/manage-account-data/rate-limits-insights)適用されている場合、クエリAPIは503エラーを返します。チャートではタイムアウトエラーメッセージを表示できます。