---
title: New Relic で Web サイトのパフォーマンスを向上させる
...
## サイトに関するパフォーマンス データを取得する [#capture]
...
をインストールするには 2 つの基本的な方法があります<InlinePopover type="browser"/>エージェント：
...
<UserJourneyControls nextStep={{"path":"/docs/tutorial-improve-site-performance/guide-to-monitoring-core-web-vitals","title":"次のステップ","body":"サイトの中核となるウェブ バイタルを測定する"}}/>
