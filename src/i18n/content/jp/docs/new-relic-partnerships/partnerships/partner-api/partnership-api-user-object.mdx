...
<CollapserGroup>
  ...
  <Collapser id="attr-owner" title="所有者 （オーナー）">
    <table>
      <tbody>
        <tr>
          <th>
...
<CollapserGroup>
  <Collapser id="request-example" title="ユーザーオブジェクトのJSONリクエスト">
    ```
    {
      "users": [
        {
  ...
  <Collapser id="response-example" title="JSONレスポンス">
...
<CollapserGroup>
  <Collapser id="example-list" title="リスト">
    リストリクエスト
  ...
  <Collapser id="example-create" title="クリエイト">
    <Callout variant="important">
  ...
  <Collapser id="example-update" title="アップデート">
    アップデートの依頼。
  ...
  <Collapser id="example-delete" title="削除">
    リクエスト：
