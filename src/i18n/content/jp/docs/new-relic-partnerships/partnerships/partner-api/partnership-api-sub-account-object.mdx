...
<CollapserGroup>
  ...
  >
    ...
    * 他のすべてのアカウントは、当社の [オリジナルのユーザーモデル](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-user-models) のユーザーを持っています。子アカウントを作成する際には、アカウント `オーナー` という 1 人のユーザーしか定義できません。ユーザーを追加するには、 [Partnership API ユーザーオブジェクト](/docs/new-relic-partnerships/partnerships/partner-api/partnership-api-user-object) を使用します。
