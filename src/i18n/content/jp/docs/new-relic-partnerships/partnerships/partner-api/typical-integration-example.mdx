...
あなたの意図が自動展開であろうと、ユーザーがそうできるようにすることであろうと、 <InlinePopover type="licenseKey"/>この操作には、アカウント作成ペイロードからの . 手動展開を計画している場合は、ライセンス キーをユーザーが簡単に利用できるようにしておくと便利です。これは、ユーザーにとって便利です。キーは、アカウントにログインすることで入手できます。
