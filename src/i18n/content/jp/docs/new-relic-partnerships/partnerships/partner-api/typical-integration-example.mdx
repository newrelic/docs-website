...
自動展開するか、ユーザーに許可するかにかかわらず、この操作にはアカウント作成ペイロードからの [ライセンス キー](/docs/apis/intro-apis/new-relic-api-keys/#license-key) が必要です。 手動展開を計画している場合は、ライセンス キーをユーザーが簡単に利用できるようにしておくと便利です。これは、ユーザーにとって便利です。キーは、アカウントにログインすることで入手できます。
