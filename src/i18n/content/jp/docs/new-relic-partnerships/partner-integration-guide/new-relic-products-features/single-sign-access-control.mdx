...
2. New Relic UI の[ユーザー メニュー](/docs/accounts/accounts-billing/general-account-settings/intro-account-settings)から、 **Account settings > Partnerships > Edit settings**を選択します。
3. **SSO タイプ**には、 `signature`を選択します。
