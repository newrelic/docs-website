...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > [(ユーザーメニュー)](/docs/accounts/accounts-billing/general-account-settings/intro-account-settings) > アカウント設定**に移動します。
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > [(ユーザーメニュー)](/docs/accounts/accounts-billing/general-account-settings/intro-account-settings) > アカウント設定 > パートナーシップ**: パートナーシップの所有者は、New Relic UI のアカウント設定からパートナーシップ管理コンソールにアクセスできます。
</figcaption>
...
フィルタリングされたビューのいずれにも表示されない顧客のアクティビティを表示するには: **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > [(ユーザーメニュー)](/docs/accounts/accounts-billing/general-account-settings/intro-account-settings) > アカウントの切り替え > その他のアカウント**に移動します。
