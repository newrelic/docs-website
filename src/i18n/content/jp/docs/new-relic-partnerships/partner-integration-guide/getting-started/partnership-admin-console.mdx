...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) >[(アカウントドロップダウン)](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#account-dropdown) > アカウント設定**に移動します。
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) >[(アカウント ドロップダウン)](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#account-dropdown) > アカウント設定 > パートナーシップ**: パートナーシップの所有者は、New Relic UI のアカウント設定からパートナーシップ管理コンソールにアクセスできます。
</figcaption>
...
フィルタリングされたビューのいずれにも表示されない顧客のアクティビティを表示するには: **[one.newrelic.com](https://one.newrelic.com/all-capabilities) >[(アカウントのドロップダウン)](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#account-dropdown) > アカウントの切り替え > その他のアカウント**に移動します。
