...
<figcaption>
  <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > [(user menu)](/docs/accounts/accounts-billing/general-account-settings/intro-account-settings) > Account settings > Partnerships**</DNT>: パートナーシップのオーナーは、 New Relic UIのアカウント設定からパートナーシップ アドミンコンソールにアクセスできます。
</figcaption>
...
フィルターされたビューのいずれにも表示されない顧客のアクティビティを表示するには、 <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > [(user menu)](/docs/accounts/accounts-billing/general-account-settings/intro-account-settings) > Switch accounts > Other accounts**</DNT>に移動します。
...
Partnership Admin Console からドリルダウンする場合は、ユーザー (通常は`support@partner.com`など) をアカウントに追加します。通常、これはアカウントの作成時に行われます。このユーザーをアカウント所有者としてプロビジョニングすることは避けてください。
