...
1. **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > [(ユーザーメニュー)](/docs/accounts/accounts-billing/general-account-settings/intro-account-settings) > Account settings**に移動します。
...
<figcaption>
  **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > [(ユーザー メニュー)](/docs/accounts/accounts-billing/general-account-settings/intro-account-settings) > Account settings > Partnerships**: パートナーシップ所有者は、New Relic UI のアカウント設定からパートナーシップ管理コンソールにアクセスできます。
</figcaption>
...
フィルターされたビューのいずれにも表示されない顧客のアクティビティを表示するには: **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > [(ユーザー メニュー)](/docs/accounts/accounts-billing/general-account-settings/intro-account-settings) > Switch accounts > Other accounts**に移動します。
