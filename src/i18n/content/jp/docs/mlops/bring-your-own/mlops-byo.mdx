...
3. **データをNew Relic Platformで見ることができます。**
   ...
   * データの**クエリ:**[データ エクスプローラー](/docs/query-your-data/explore-query-data/browse-data/introduction-data-explorer)を使用して送信したデータを表示するか、[クエリ ビルダー](/docs/query-your-data/explore-query-data/query-builder/introduction-query-builder/)で次のクエリを使用します。
