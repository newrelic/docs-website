...
import modelperformancemonitoringAmazonSagemakerDashboard from 'images/model-performance-monitoring_screenshot-crop_amazon-sagemaker-dashboard.png'

import modelperformancemonitoringAmazonSagemakerModelDataEntity from 'images/model-performance-monitoring_screenshot-crop_amazon-sagemaker-model-data-entity.png'
...
**[one.newrelic.com](https://one.newrelic.com/all-capabilities) > モデルのパフォーマンス**に移動して、以下を表示します。
