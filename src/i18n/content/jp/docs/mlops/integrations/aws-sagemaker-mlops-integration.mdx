...
<img
  title="Sagemaker、Cloudwatch、New Relicのフロー.png"
  alt="Sagemaker、Cloudwatch、New Relicの流れを汲む。"
  src={awsSmFlow}
/>
...
<img
  title="機械学習用エンドポイントのダッシュボード"
  alt="機械学習エンドポイントのダッシュボード"
  src={awsSm03}
/>
...
<img
  title="モデルデータのエンティティのダッシュボード.png"
  alt="モデルデータエンティティのダッシュボード"
  src={awsSm04}
/>
