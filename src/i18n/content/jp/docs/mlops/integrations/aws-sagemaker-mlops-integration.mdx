...
* HTTPエンドポイントURL - 米国データセンター（デフォルト）： `https://aws-api.newrelic.com/cloudwatch-metrics/v1`
* HTTPエンドポイントURL-EUデータセンター： `https://aws-api.eu01.nr-data.net/cloudwatch-metrics/v1`
* HTTPエンドポイントURL - JPデータセンター： `https://aws-api.jp.nr-data.net/cloudwatch-metrics/v1`
