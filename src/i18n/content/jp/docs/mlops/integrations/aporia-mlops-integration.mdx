...
5. **New Relic API キーを取得し**ます。Aporia アイコンをクリックしたら、ステップ 1 に従います。\[ **Prediction data & model quality alerts** ] で、 **\[Select** ] をクリックして既存のキーを選択するか、\[ **Create API key** ] をクリックします。これにより、New Relic へのデータのレポートに使用される New Relic
