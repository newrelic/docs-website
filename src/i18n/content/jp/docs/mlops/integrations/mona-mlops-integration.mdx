...
import modelperformancemonitoringMonaDashboard from 'images/model-performance-monitoring_screenshot-crop_mona-dashboard.png'
...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > +Add more data**から**New Relic アカウントにログインします**。
...
6. **API キーの選択または作成:**[ ](/docs/apis/intro-apis/new-relic-api-keys/#license-key)New Relic に戻り、New Relic 統合ページから、 **Processed contextual data**の下で処理済みのライセンス キーを作成 (または既存のキーを選択) します。 Mona に戻り、このキーを**Ingest license key**フィールドに入力します。
