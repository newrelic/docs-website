...
<ImageSizing width="320px" verticalAlign="middle">![New Relic One entity alert status](./images/new-relic-one-entity-alert-status-red.png "new-relic-one-entity-alert-status.png")</ImageSizing>
