...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        In the UI, data is available for eight days after an entity no longer exists, with one exception: Data reported by integrations, such as AWS, is only available for one day after an entity ceases to exist.
      </td>
    </tr>
