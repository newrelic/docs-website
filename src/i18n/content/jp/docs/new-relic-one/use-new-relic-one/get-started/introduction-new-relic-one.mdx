...
以前にNew Relic Insightを使用してダッシュボードを作成した場合は、それらを[New Relic Oneダッシュボードとして使用できます](/docs/new-relic-one/use-new-relic-one/core-concepts/transition-new-relic-one-insights)。
