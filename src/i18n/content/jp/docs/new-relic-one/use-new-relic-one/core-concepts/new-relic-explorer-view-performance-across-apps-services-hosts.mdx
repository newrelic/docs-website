...
<figcaption>
  **[one.newrelic.com](http://one.newrelic.com) > Explorer**: Use the entity explorer to locate and examine the entities you monitor.
</figcaption>
...
The entity explorer shows a color-coded [health](/docs/alerts/new-relic-alerts/getting-started/introduction-new-relic-alerts) status for entities. For example, you may see a red alert status indicating a critical violation in progress.
