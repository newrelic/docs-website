...
<CollapserGroup>
  ...
  >
    ...
    * drag-select <img style={{ width: '22px'}} src={smDragSelectToggle0}/> アイコンをクリックすると、ドラッグセレクトモードに切り替わります。マウスをクリック＆ドラッグして、選択したいノードの周りに四角を描きます。
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            2つ以上のノードを選択し、 <img style={{ width: '22px'}} src={smGroupingIcon}/> **Create group**.
          </td>
        </tr>
