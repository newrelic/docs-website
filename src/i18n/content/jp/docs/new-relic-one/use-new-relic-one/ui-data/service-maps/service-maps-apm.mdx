...
<CollapserGroup>
  ...
  >
    ...
    * drag-select <ImageSizing width="22px"><img src={smDragSelectToggle0}/> </ImageSizing>アイコンをクリックすると、ドラッグセレクトモードに切り替わります。マウスをクリック＆ドラッグして、選択したいノードの周りに四角を描きます。
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            2つ以上のノードを選択し、 <ImageSizing width="22px"><img src={smGroupingIcon}/> </ImageSizing>**Create group**.
          </td>
        </tr>
