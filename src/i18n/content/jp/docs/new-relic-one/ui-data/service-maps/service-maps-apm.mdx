...
<CollapserGroup>
  ...
  >
    ...
    2. **App/Service**リストから、<img src={customNode}/>**Create custom node**。
...
<CollapserGroup>
  ...
  >
    ...
    * ドラッグ選択をクリックします<img style={{ width: '22px'}} class="inline" src={smDragSelectToggle0}/>アイコンをクリックしてドラッグ選択モードに切り替えます。マウスをクリックしてドラッグし、選択するノードの周りに正方形を描画します。
