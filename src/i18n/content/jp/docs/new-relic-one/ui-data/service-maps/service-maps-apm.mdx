...
<CollapserGroup>
  ...
  >
    ...
    4. 接続先を追加します。左（着信用）または右（発信用）の矢印 <Icon name="fe-arrow-right"/>アイコンを選択します。次に、ターゲット・ノード上のプラス <Icon style={{color: '#B9D7B6'}} name="fe-plus-circle"/>アイコンを選択します。
    ...
    10. 接続を解除するには、マイナス <Icon style={{color: '#D75968'}} name="fe-minus-circle"/>のアイコンを選択します。
