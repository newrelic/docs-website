...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <DNT>**Change tracking**</DNT>ページに表示されるこの変更の概要
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <DNT>**Change tracking**</DNT>ページに表示されるこの変更のコミット SHA
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        この変更の概要説明。 <DNT>**Overview**</DNT>ページと、個々の変更を選択すると<DNT>**Change tracking**</DNT>ページに表示されます。
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <DNT>**Overview**</DNT>ページと<DNT>**Deployments**</DNT>ページに表示される変更に関連付けるユーザー名
      </td>
    </tr>
  </tbody>
</table>
...
[New Relicアプリケーション デプロイメント マーカー](https://github.com/marketplace/actions/new-relic-application-deployment-marker)ページを確認し、<DNT>**Use latest version**</DNT> ボタンをクリックして、利用可能な最新バージョンを使用していることを確認してください。
