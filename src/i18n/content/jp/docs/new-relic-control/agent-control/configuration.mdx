...
<Callout variant="tip">
  EU リージョンの場合、エンドポイントとして`https://opamp.service.eu.newrelic.com/v1/opamp`使用し、 `token_url`として`https://system-identity-oauth.service.eu.newrelic.com/oauth2/token`使用します。
</Callout>
