...
* [次元メトリクス](/docs/data-apis/understand-data/new-relic-data-types/#dimensional-metrics)。いくつかの注意事項：
...
* New Relicによってルールが無効にされた場合（たとえば、EOLポリシー）：ユーザーがポリシーをオーバーライドするために必要な内部権限を持っていない限り、リクエストは失敗します。
