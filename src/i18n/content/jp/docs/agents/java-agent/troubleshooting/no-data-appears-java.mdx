...
6. アプリケーションサーバーログに目を通して、New Relic Javaエージェントに関連したエラーが無いか確認してください。トラブルシューティングページの[Bootstrap New Relic Javaエージェントエラー](/docs/agents/java-agent/troubleshooting/error-bootstrapping-new-relic-java-agent)と[Javaアプリケーションサーバーエラー](/docs/agents/java-agent/troubleshooting/errors-starting-java-app-server)では、Javaエージェントデータのレポートを阻止するアプリケーションサーバーログの観測可能エラーの例が示されています。
