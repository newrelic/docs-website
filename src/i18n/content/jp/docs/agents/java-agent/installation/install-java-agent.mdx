...
* New Relic Diagnostics を使用して、デプロイの前後に[設定を検証](https://docs.newrelic.co.jp/docs/using-new-relic/cross-product-functions/troubleshooting/new-relic-diagnostics)することをお勧めします。
