...
Javaエージェントは、JMXを使用してJVMデータを収集し、[リアルタイムJavaプロファイリング](http://docs.newrelic.co.jp/docs/agents/java-agent/features/real-time-java-profiling-using-jfr-metrics)用のJFR（Java Flight Recorder）デーモンと通信します。
