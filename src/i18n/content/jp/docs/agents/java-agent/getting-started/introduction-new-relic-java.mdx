...
tags:
  ...
  - Getting started
metaDescription: >-
  For an overview of New Relic's Java agent (compatibility, requirements,
  installation, configuration), start here.
---
...
1. システムが[Javaエージェントの互換性要件](/docs/compatibility-requirements-java-agent)を満たしていることを確認してください。
2. New Relicアカウントに[サインアップ](/docs/accounts-partnerships/accounts/account-setup/creating-your-new-relic-account)します。
...
## ガイド付きインストールによるJavaエージェントの評価 [#guided-install]
