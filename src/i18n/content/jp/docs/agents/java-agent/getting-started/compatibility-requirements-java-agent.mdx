...
<CollapserGroup>
  ...
  >
    ...
    * [Kafka Clients](https://jajp-newrelic-docs.onelink-translations.com/docs/agents/java-agent/instrumentation/use-kafka-message-queues) 0.10.0.0以降（メトリックおよびイベントデータ向け）
    * [Kafka Clients](https://jajp-newrelic-docs.onelink-translations.com/docs/agents/java-agent/instrumentation/use-kafka-message-queues) 0.11.0.0以降（ディストリビューティッド（分散）トレーシング、メトリック、およびイベントデータ向け）
    * OkHttp 3.x～4.3.x
