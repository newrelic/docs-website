...
メトリックスに名前を付けて保存する方法の詳細については、[カスタムJMX YAMLファイルの例](https://docs.newrelic.co.jp/docs/agents/java-agent/custom-instrumentation/custom-jmx-yaml-examples)をご覧ください。
