...
<CollapserGroup>
  ...
  >
    ...
    カウンタは、サンプルYAMLファイル内のオブジェクトから探すことができます。[Metric Explorer](https://docs.newrelic.co.jp/docs/insights/use-insights-ui/explore-data/metric-explorer-search-chart-metrics-sent-new-relic-agents)で、以下を検索します。
...
メトリックスに名前を付けて保存する方法の詳細については、[カスタムJMX YAMLファイルの例](https://docs.newrelic.co.jp/docs/agents/java-agent/custom-instrumentation/custom-jmx-yaml-examples#metric_names)をご覧ください。
