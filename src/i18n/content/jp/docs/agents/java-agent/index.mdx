...
<LandingPageHero>
  ...
  ![APMを使用して、お使いのJavaアプリケーションのパフォーマンス概要を表示します。](https://jajp-newrelic-docs.onelink-translations.com/sites/default/files/thumbnails/image/Java_agent_landing_image.png "Java_agent_landing_image.png")
