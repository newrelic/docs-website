...
![PHP - APM 要旨](https://jajp-newrelic-docs.onelink-translations.com/sites/default/files/thumbnails/image/php-summary.png "PHP - APM 要旨")
...
![この図には、PHPエージェントからNew Relicへのデータの流れが示されています。](https://jajp-newrelic-docs.onelink-translations.com/sites/default/files/thumbnails/image/PHP_Agent_Diagram_5.png "PHP_Agent_Diagram_4.png")
...
エージェントをインストールするには、[New Relicにサインアップ](https://newrelic.com/signup)する必要があります。ログイン後、ランチャーを使用するか、特定のインストール方法を参照します。
