...
<Callout variant="important">
  2021年1月時点で、PHP 5.3およびPHP 5.4のサポートが終了します。詳細については、[PHPエージェントリリースノートv9.15.0](/docs/release-notes/agent-release-notes/php-release-notes/php-agent-9150293)および[Explorers Hubの投稿](https://discuss.newrelic.com/t/important-upcoming-changes-to-capabilities-across-browser-php-python-mobile-and-android-agents/123951)をご覧ください。
</Callout>

* 当社では、PHPの[サポートされているリリース](http://php.net/supported-versions.php)（特に7.3と7.4）の使用を推奨しています。
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        * CentOS 5.5以降（5.6は除く）
          ...
          <Callout variant="important">
            2021年1月時点で、CentOS 5のサポートが終了します。詳細については、[PHPエージェントリリースノートv9.15.0](/docs/release-notes/agent-release-notes/php-release-notes/php-agent-9150293)および[Explorers Hubの投稿](https://discuss.newrelic.com/t/important-upcoming-changes-to-capabilities-across-browser-php-python-mobile-and-android-agents/123951)をご覧ください。
          </Callout>
        * Debian 5.0（"lenny"）以降
    ...
    <tr>
      ...
      <td>
        <Callout variant="important">
          2021年1月時点で、macOSのサポートが終了します。詳細については、[PHPエージェントリリースノートv9.15.0](/docs/release-notes/agent-release-notes/php-release-notes/php-agent-9150293)および[Explorers Hubの投稿](https://discuss.newrelic.com/t/important-upcoming-changes-to-capabilities-across-browser-php-python-mobile-and-android-agents/123951)をご覧ください。
        </Callout>

        macOS 10.6以降（[macOSトラブルシューティングに関するメモ](/docs/agents/php-agent/troubleshooting/known-php-limitations#osx)を参照してください）
    ...
    <tr>
      ...
      <td>
        * SolarisとSmartOSに対してサポートされている最後のPHPエージェントバージョンは[8.1](https://jajp-newrelic-docs.onelink-translations.com/docs/release-notes/agent-release-notes/php-release-notes/php-agent-810209)です
        * SmartOS：すべてのバージョン
...
詳しくは、[PHPフレームワーク：New Relicのサポートの統合](/docs/php/framework-developers-integrated-support-for-new-relic)をご覧ください。その他の一般的なPHPフレームワークのサポートを提案する場合、[Explorers Hub](https://discuss.newrelic.com/tags/phpagent)にアクセスして`Feature Idea`を作成してください。
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        [Guzzle](https://jajp-newrelic-docs.onelink-translations.com/docs/agents/php-agent/frameworks-libraries/guzzle)
      </td>

      <td>
        [PHPUnit](https://jajp-newrelic-docs.onelink-translations.com/docs/agents/php-agent/frameworks-libraries/analyze-phpunit-test-data-insights)
      </td>
    </tr>
...
* HTTP
* [PHPエージェント6.6.0.169リリース](/docs/release-notes/agent-release-notes/php-release-notes/php-agent-660169)の実験的な機能として利用可能なLaravelキューイングは、[PHPエージェント8.0.0.204](https://jajp-newrelic-docs.onelink-translations.com/docs/release-notes/agent-release-notes/php-release-notes/php-agent-800204)以降ではデフォルトで有効化されています。
