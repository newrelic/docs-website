...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        * SolarisとSmartOSに対してサポートされている最後のPHPエージェントバージョンは[8.1](/docs/release-notes/agent-release-notes/php-release-notes/php-agent-810209)です
        * SmartOS：すべてのバージョン
...
* HTTP
* [PHPエージェント6.6.0.169リリース](/docs/release-notes/agent-release-notes/php-release-notes/php-agent-660169)の実験的な機能として利用可能なLaravelキューイングは、[PHPエージェント8.0.0.204](/docs/release-notes/agent-release-notes/php-release-notes/php-agent-800204)以降ではデフォルトで有効化されています。
