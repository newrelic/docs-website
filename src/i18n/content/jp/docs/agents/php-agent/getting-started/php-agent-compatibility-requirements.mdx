...
インストレーションの際には、New Relicの[ライセンスキー](/docs/subscriptions/license-key)が必要です。ライセンスキーは40文字の16進数の文字列で構成され、[サインアップ](/docs/subscriptions/creating-your-new-relic-account)時にNew Relicから提供されます。詳細については、PHP[インストールスクリプト](/docs/php/the-newrelic-install-script)とPHP INIファイルの[ライセンスキー設定](/docs/php/php-agent-phpini-settings#inivar-license)を参照してください。
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        * SolarisおよびSmartOSがサポートされている最後のPHPエージェントバージョンは[8.1](https://docs.newrelic.com/docs/release-notes/agent-release-notes/php-release-notes/php-agent-810209)です
        * SmartOS：全バージョン
...
* HTTP
* [PHPエージェント6.6.0.169リリース](/docs/release-notes/agent-release-notes/php-release-notes/php-agent-660169)の実験的な機能として使用できるLaravelキューイングは、[PHPエージェント8.0.0.204](https://docs.newrelic.com/docs/release-notes/agent-release-notes/php-release-notes/php-agent-800204)以降では、デフォルトで有効化されています。
