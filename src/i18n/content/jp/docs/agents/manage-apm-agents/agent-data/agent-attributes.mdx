...
![nr attribute collection diagram.png](https://jajp-newrelic-docs.onelink-translations.com/sites/default/files/styles/inline_660px/public/thumbnails/image/nr%20attribute%20collection%20diagram.png?itok=gL6rmAi3 "nr attribute collection diagram.png")
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        [スパンイベント](https://jajp-newrelic-docs.onelink-translations.com/docs/apm/distributed-tracing/getting-started/introduction-distributed-tracing)
      </td>
      ...
      <td>
        ...
        * [Java エージェント 5.13.0 以降](https://jajp-newrelic-docs.onelink-translations.com/docs/release-notes/agent-release-notes/java-release-notes/java-agent-5130)
        * [Goエージェント3.6.0以降](https://jajp-newrelic-docs.onelink-translations.com/docs/release-notes/agent-release-notes/go-release-notes/go-agent-360)
        * [.NETエージェント8.25以降](https://jajp-newrelic-docs.onelink-translations.com/docs/release-notes/agent-release-notes/net-release-notes/net-agent-8252140)
        * [Nodeエージェント6.10.0以降](https://jajp-newrelic-docs.onelink-translations.com/docs/release-notes/agent-release-notes/nodejs-release-notes/node-agent-6100)
        * [PHPエージェント9.12.0.268以上](https://docs/release-notes/agent-release-notes/php-release-notes/php-agent-9120268)
        * [Pythonエージェント5.8.0.136以降](https://jajp-newrelic-docs.onelink-translations.com/docs/release-notes/agent-release-notes/python-release-notes/python-agent-580136)
        * [Rubyエージェント6.8.0以降](https://jajp-newrelic-docs.onelink-translations.com/docs/release-notes/agent-release-notes/ruby-release-notes/ruby-agent-680360)
      </td>
    </tr>

    <tr>
      <td>
        [トランザクションセグメント](https://jajp-newrelic-docs.onelink-translations.com/docs/apm/transactions/transaction-traces/transaction-trace-details)
      </td>
...
![screen-tx-trace-attributes.png](https://jajp-newrelic-docs.onelink-translations.com/sites/default/files/styles/inline_660px/public/thumbnails/image/screen-tx-trace-attributes.png?itok=f6zH9Al2 "screen-tx-trace-attributes.png")
