...
* [Node.js](https://jajp-newrelic-docs.onelink-translations.com/docs/agents/nodejs-agent/installation-configuration/nodejs-agent-configuration)
* [.NET](https://jajp-newrelic-docs.onelink-translations.com/docs/agents/net-agent/configuration/net-agent-configuration#error_collector)
