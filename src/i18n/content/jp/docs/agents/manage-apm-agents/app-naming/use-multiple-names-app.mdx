...
![Insightsのトランザクションイベント](https://jajp-newrelic-docs.onelink-translations.com/sites/default/files/styles/inline_660px/public/thumbnails/image/Insights-ToggleOnOff.png?itok=d5tcMnJ6 "Insightsのトランザクションイベント")
