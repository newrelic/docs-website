...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        [互換性と要件（.NET Framework）](https://jajp-newrelic-docs.onelink-translations.com/docs/agents/net-agent/getting-started/compatibility-requirements-net-framework-agent)

        または

        [互換性と要件（.NET Core）](https://jajp-newrelic-docs.onelink-translations.com/docs/agents/net-agent/getting-started/compatibility-requirements-net-core-20-agent)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        [必要なすべての環境変数](https://jajp-newrelic-docs.onelink-translations.com/docs/agents/net-agent/installation/install-net-core-20-agent-linux#environment_setup)が設定されていることを確認してからエージェントを再起動します。
      </td>
    </tr>
