...
# エージェントがWCFアプリ（.NET）のContent-Typeヘッダーを変更します [#page-title]
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        [CAT設定を変更する方法](https://jajp-newrelic-docs.onelink-translations.com/docs/agents/net-agent/configuration/net-agent-configuration#cross_application_tracer)についてお読みください。
    ...
    <tr>
      ...
      <td>
        [DT設定を有効にする](https://jajp-newrelic-docs.onelink-translations.com/docs/agents/net-agent/configuration/net-agent-configuration#distributed_tracing)方法についてお読みください。
