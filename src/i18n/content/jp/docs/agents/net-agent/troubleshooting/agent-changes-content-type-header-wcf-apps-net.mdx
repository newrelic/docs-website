...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        [CAT設定を変更する方法](https://docs.newrelic.co.jp/docs/agents/net-agent/configuration/net-agent-configuration)についてお読みください。
    ...
    <tr>
      ...
      <td>
        [DT設定を有効にする](https://docs.newrelic.co.jp/docs/agents/net-agent/configuration/net-agent-configuration)方法についてお読みください。
