...
* .NETエージェントのバージョン[6.16.178.0](https://jajp-newrelic-docs.onelink-translations.com/docs/release-notes/agent-release-notes/net-release-notes/net-agent-6161780)またはそれ以降。
