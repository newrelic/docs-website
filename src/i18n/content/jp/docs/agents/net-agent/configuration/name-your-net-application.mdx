          ...
          >
            **.NETフレームワークアプリの場合：**
            ...
            1. ファイルの `appSettings` セクションに次のエントリを追加して、アプリケーションを再起動します。
               ...
               ```
               <appSettings><add key = "<span id="cke_bm_17881S" style="display: none;"></span>NewRelic<span id="cke_bm_17881E" style="display: none;"> </span>.AppName" value = "<var>App Name</var>" /> </appSettings>
               ```
