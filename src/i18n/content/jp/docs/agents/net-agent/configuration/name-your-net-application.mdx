...
（.NET に固有ではない）APM アプリの命名の一般的な概要については、[アプリケーションに名前を付ける](https://docs.newrelic.co.jp/docs/agents/manage-apm-agents/app-naming/name-your-application)を参照してください。データの連続性を損なうことなくアプリケーションの名前を変更するには、[UI エイリアス変更オプション](https://docs.newrelic.co.jp/docs/agents/manage-apm-agents/app-naming/name-your-application)を使用します。
...
<Callout variant="important">
  一部のメソッドは他のメソッドよりも[優先](https://docs.newrelic.co.jp/docs/agents/net-agent/configuration/net-agent-configuration)されます。命名方法を選択する前に、設定がどのように影響を受けるかを理解してください。
</Callout>
