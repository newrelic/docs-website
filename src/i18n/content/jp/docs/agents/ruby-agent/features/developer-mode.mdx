...
![screen-ruby-developer-mode-breakdown-chart](https://jajp-newrelic-docs.onelink-translations.com/sites/default/files/thumbnails/image/screen-breakdown-chart.png "screen-ruby-developer-mode-breakdown-chart")
