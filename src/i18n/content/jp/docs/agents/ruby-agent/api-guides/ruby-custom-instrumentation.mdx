...
エージェントによってトレーシングコードが自動的にインストゥルメントされない場合、通常は標準の[メソッドトレーサー](https://docs.newrelic.co.jp/docs/agents/ruby-agent/api-guides/ruby-custom-instrumentation)で十分です。
