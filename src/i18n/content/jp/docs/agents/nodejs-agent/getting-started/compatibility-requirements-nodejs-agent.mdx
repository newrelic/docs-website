...
他のメッセージキューライブラリには、[カスタムインストゥルメンテーション](https://docs.newrelic.com/docs/agents/nodejs-agent/supported-features/nodejs-custom-instrumentation#message-client)を使用します。
