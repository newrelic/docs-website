...
他のメッセージキューライブラリには、[カスタムインストゥルメンテーション](https://jajp-newrelic-docs.onelink-translations.com/docs/agents/nodejs-agent/supported-features/nodejs-custom-instrumentation#message-client)を使用します。
