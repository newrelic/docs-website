...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="Tornado 6"
  >
    エージェントは現在、Tornado 6についてのみサポートを提供しています。詳細については、[Tornado 6 ウェブフレームワークの文書](/docs/agents/python-agent/web-frameworks-servers/python-agent-tornado-6-web-framework)を参照してください。
  </Collapser>
