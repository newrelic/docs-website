...
GoエージェントはLinux、macOS、WindowsでGolang1.7以上を必要とします。詳細については、「[Goエージェントの互換性と要件](/docs/agents/go-agent/get-started/go-agent-compatibility-requirements)」をご覧ください。
...
1. [https://github.com/newrelic/go-agent](https://github.com/newrelic/go-agent)から、お好みのプロセスに従います。
