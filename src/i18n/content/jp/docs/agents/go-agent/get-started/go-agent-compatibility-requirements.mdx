...
New Relicアカウントをまだお持ちでない場合は、[New Relicアカウントを新たに作成](https://newrelic.com/signup)します。永久無料です。[Go向けNew Relicをインストール](https://docs.newrelic.com/docs/agents/go-agent/installation/install-new-relic-go)する前に、システムがこれらの要件を満たしていることを確認してください。
