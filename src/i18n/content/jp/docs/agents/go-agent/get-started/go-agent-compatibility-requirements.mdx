...
[Go向けNew Relicをインストール](https://jajp-newrelic-docs.onelink-translations.com/docs/agents/go-agent/installation/install-new-relic-go)する前に、システムがこれらの要件を満たしていることを確認してください。
