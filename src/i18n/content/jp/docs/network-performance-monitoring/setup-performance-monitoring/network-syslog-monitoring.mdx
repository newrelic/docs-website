...
<CollapserGroup>
  ...
  >
    1. <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Add more data**</DoNotTranslate>に移動します。

    2. <DoNotTranslate>**Network**</DoNotTranslate>が表示されるまで下にスクロールし、 <DoNotTranslate>**Syslog**</DoNotTranslate>をクリックします。
