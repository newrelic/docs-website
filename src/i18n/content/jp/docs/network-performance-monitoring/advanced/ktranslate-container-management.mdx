...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [](/docs/apis/intro-apis/new-relic-api-keys/#license-key)**ktranslate が** データを New Relic API に送信するための New Relicライセンス キーを保持するために、Docker ランタイム中に使用する必要がある環境変数。 例: `-e NEW_RELIC_API_KEY=$LICENSE_KEY` .
      </td>
    </tr>
