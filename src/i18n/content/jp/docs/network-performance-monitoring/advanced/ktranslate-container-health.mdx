...
2. <DNT>**Find logs where**</DNT>

   に`collector.name:"ktranslate"`と入力し、
...
1. <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Query your data**</DNT>
