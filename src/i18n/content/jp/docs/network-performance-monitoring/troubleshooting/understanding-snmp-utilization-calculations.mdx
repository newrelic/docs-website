...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="SNMP変換"
  >
    <DoNotTranslate>**Metric Name**</DoNotTranslate>： 様々な
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            16 進数値を整数形式に変換するために使用されます。 <DoNotTranslate>**current**</DoNotTranslate>のオプション: `LittleEndian` \| `BigEndian` 。 <DoNotTranslate>**desired**</DoNotTranslate>のオプション: `uint16` \| `uint32` \| `uint64`
          </td>
        </tr>
