...
<CollapserGroup>
  <Collapser
    id="windows"
    title={<>MSIファイルを使用してインストール（<ImageSizing width="32px" height="32px" verticalAlign="middle">![Windows Server](./images/windows.png "Windows Server")</ImageSizing> Windows Server）</>}
  >
  ...
  <Collapser
    id="apt"
    title={<>aptでインストールする（<ImageSizing width="32px" height="32px" verticalAlign="middle">![Debian.png](./images/Debian.png "Debian アイコン")</ImageSizing>Debian、<ImageSizing width="32px" height="32px" verticalAlign="middle">![ubuntu アイコン](./images/ubuntu-icon.png "ubuntu アイコン")</ImageSizing>Ubuntu）</>}
  >
  ...
  <Collapser
    id="yum"
    title={<>yumでインストールする（<ImageSizing width="32px" height="32px" verticalAlign="middle">![amazon linux.png](./images/amazon-linux.png "amazon linux.png")</ImageSizing>Amazon Linux、<ImageSizing width="32px" height="32px" verticalAlign="middle">![centosアイコン](./images/centos-icon.png "centosアイコン")</ImageSizing>CentOS、<ImageSizing width="32px" height="32px" verticalAlign="middle">![redhat アイコン](./images/red-hat-new2.png "redhat アイコン")</ImageSizing>RHEL）</>}
  >
  ...
  <Collapser
    id="zypper"
    title={<>Zypperでインストール（<ImageSizing width="32px" height="32px" verticalAlign="middle">![suse アイコン](./images/suse-icon.png "suse アイコン")</ImageSizing>SLES）</>}
  >
  ...
  <Collapser
    id="tarball"
    title={<>tarball からインストール（<ImageSizing width="32px" height="32px" verticalAlign="middle">![Linux アイコン](./images/otherlinux.png "Linux")</ImageSizing>その他の distros）</>}
  >
    <Callout variant="tip">
