...
![エージェントとNew Relic](./images/Agents%20and%20NR%20%288%29.png "エージェントとNew Relic")
...
<CollapserGroup>
  ...
  >
    ...
    3. 定義ファイルを含むバイナリを[エージェントディレクトリ](https://docs.newrelic.co.jp/docs/infrastructure/install-configure-manage-infrastructure/linux-installation/tarball-manual-install-infrastructure-linux)の`newrelic-integrations`または`custom-integrations`に配置します。
    4. インテグレーションの設定ファイルを[プラグインディレクトリ](https://docs.newrelic.co.jp/docs/infrastructure/install-configure-manage-infrastructure/linux-installation/tarball-manual-install-infrastructure-linux)の下に配置します。
