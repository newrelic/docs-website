...
![エージェントとNew Relic](https://jajp-newrelic-docs.onelink-translations.com/sites/default/files/thumbnails/image/Agents%20and%20NR%20%288%29.png "エージェントとNew Relic")
...
* <ImageSizing width="32px" height="32px" verticalAlign="middle">![Kubernetes](https://jajp-newrelic-docs.onelink-translations.com/sites/default/files/thumbnails/image/kubernetes-logo.png "Kubernetes")</ImageSizing> [Kubernetes にオンホスト インテグレーションをインストールする](/docs/integrations/kubernetes-integration/link-apps-services/monitor-services-running-kubernetes)
* <ImageSizing width="32px" height="32px" verticalAlign="middle">![ECS](https://jajp-newrelic-docs.onelink-translations.com/sites/default/files/thumbnails/image/ecs.png "ECS")</ImageSizing> [ Amazon ECS でオンホストインテグレーションをインストール](/docs/integrations/host-integrations/host-integrations-list/monitor-services-running-amazon-ecs)（EC2 起動タイプ）
...
<CollapserGroup>
  <Collapser
    id="windows"
    title={<>MSIファイルを使用してインストール（<img src="https://jajp-newrelic-docs.onelink-translations.com/sites/default/files/thumbnails/image/windows.png" title="Windows Server" alt="Windows Server" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/> Windows Server）</>}
  >
  ...
  <Collapser
    id="zypper"
    title={<>Zypperでインストール（<img src="https://jajp-newrelic-docs.onelink-translations.com/sites/default/files/thumbnails/image/suse-icon.png" title="suse アイコン" alt="suse アイコン" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>SLES）</>}
  >
  ...
  <Collapser
    id="tarball"
    title={<>tarball からインストール（<img src="https://jajp-newrelic-docs.onelink-translations.com/sites/default/files/thumbnails/image/otherlinux.png" title="Linux" alt="Linux アイコン" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>その他の distros）</>}
  >
    <Callout variant="tip">
    ...
    2. エージェントがインテグレーションの定義、設定、および実行ファイルを見つけることができるように、当社の[インテグレーションのファイル構造と配置ルール](https://jajp-newrelic-docs.onelink-translations.com/docs/integrations/integrations-sdk/getting-started/integration-file-structure-activation)に従ってTarファイルを解凍します。
    3. 定義ファイルを含むバイナリを[エージェントディレクトリ](https://jajp-newrelic-docs.onelink-translations.com/docs/infrastructure/install-configure-manage-infrastructure/linux-installation/tarball-manual-install-infrastructure-linux#agent-directory)の`newrelic-integrations`または`custom-integrations`に配置します。
    4. インテグレーションの設定ファイルを[プラグインディレクトリ](https://jajp-newrelic-docs.onelink-translations.com/docs/infrastructure/install-configure-manage-infrastructure/linux-installation/tarball-manual-install-infrastructure-linux#configure-plugin)の下に配置します。
