...
![エージェントとNew Relic](./image/Agents%20and%20NR%20%288%29.png "エージェントとNew Relic")
...
* <ImageSizing width="32px" height="32px" verticalAlign="middle">![Kubernetes](./image/kubernetes-logo.png "Kubernetes")</ImageSizing> [Kubernetes にオンホスト インテグレーションをインストールする](/docs/integrations/kubernetes-integration/link-apps-services/monitor-services-running-kubernetes)
* <ImageSizing width="32px" height="32px" verticalAlign="middle">![ECS](./image/ecs.png "ECS")</ImageSizing> [ Amazon ECS でオンホストインテグレーションをインストール](/docs/integrations/host-integrations/host-integrations-list/monitor-services-running-amazon-ecs)（EC2 起動タイプ）
