...
<CollapserGroup>
  <Collapser
    id="windows"
    title={<>MSIファイルを使用してインストール（<ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={windows} title="Windows Server" alt="Windows Server"/></ImageSizing> Windows Server）</>}
  >
  ...
  <Collapser
    id="apt"
    title={<>aptでインストールする（<ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={debian} title="Debian アイコン" alt="Debian.png"/></ImageSizing>Debian、<ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={ubuntuIcon} title="ubuntu アイコン" alt="ubuntu アイコン"/></ImageSizing>Ubuntu）</>}
  >
  ...
  <Collapser
    id="yum"
    title={<>yumでインストールする（<ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={amazonLinux} title="amazon linux.png" alt="amazon linux.png"/></ImageSizing>Amazon Linux、<ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={centosIcon} title="centosアイコン" alt="centosアイコン"/></ImageSizing>CentOS、<ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={redHatNew2} title="redhat アイコン" alt="redhat アイコン"/></ImageSizing>RHEL）</>}
  >
  ...
  <Collapser
    id="zypper"
    title={<>Zypperでインストール（<ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={suseIcon} title="suse アイコン" alt="suse アイコン"/></ImageSizing>SLES）</>}
  >
  ...
  <Collapser
    id="tarball"
    title={<>tarball からインストール（<ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={otherlinux} title="Linux" alt="Linux アイコン"/></ImageSizing>その他の distros）</>}
  >
    <Callout variant="tip">
