...
<CollapserGroup>
  <Collapser
    id="windows"
    title={<>MSIファイルを使用してインストール（<ImageSizing width="32px" height="32px" verticalAlign="middle">![Windows Server](https://docs.newrelic.co.jp/sites/default/files/thumbnails/image/windows.png "Windows Server")</ImageSizing> Windows Server）</>}
  >
  ...
  <Collapser
    id="zypper"
    title={<>Zypperでインストール（<ImageSizing width="32px" height="32px" verticalAlign="middle">![suse アイコン](https://docs.newrelic.co.jp/sites/default/files/thumbnails/image/suse-icon.png "suse アイコン")</ImageSizing>SLES）</>}
  >
  ...
  <Collapser
    id="tarball"
    title={<>tarball からインストール（<ImageSizing width="32px" height="32px" verticalAlign="middle">![Linux アイコン](https://docs.newrelic.co.jp/sites/default/files/thumbnails/image/otherlinux.png "Linux")</ImageSizing>その他の distros）</>}
  >
    <Callout variant="tip">
