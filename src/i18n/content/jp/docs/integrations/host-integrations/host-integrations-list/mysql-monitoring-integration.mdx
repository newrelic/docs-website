...
<CollapserGroup>
  ...
  >
    ...
    6. [Infrastructure エージェントを再起動します](https://docs.newrelic.co.jp/docs/infrastructure/new-relic-infrastructure/configuration/start-stop-restart-check-infrastructure-agent-status)。
