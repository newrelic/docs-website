...
1. New Relicで、[Insightsクエリキーを新規作成します](/docs/apis/get-started/intro-apis/types-new-relic-api-keys)。
...
<CollapserGroup>
  <Collapser
    ...
    title="サンプル設定の画像"
  >
    ![Grafanaでのデータソースワークフロー追加のスクリーンキャプチャ](https://jajp-newrelic-docs.onelink-translations.com/sites/default/files/thumbnails/image/Grafana%20Data%20Source%20Config_0.png "New RelicをGrafanaのPrometheusデータソースとして設定")
