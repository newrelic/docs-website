...
<CollapserGroup>
  <Collapser
    ...
    title={<><ImageSizing verticalAlign="middle">![EKS](https://docs.newrelic.co.jp/sites/default/files/thumbnails/image/eks.png)</ImageSizing> <Link to="#install-amazon-eks"> Amazon EKS</Link></>}
  >
  ...
  <Collapser
    ...
    title={<><ImageSizing verticalAlign="middle">![CKE](https://docs.newrelic.co.jp/sites/default/files/thumbnails/image/cke.jpeg)</ImageSizing> <Link to="#install-google-kubernetes-engine"> Google Kubernetes Engine （GKE）</Link></>}
  >
  ...
  <Collapser
    ...
    title={<><ImageSizing verticalAlign="middle">![OpenShift](https://docs.newrelic.co.jp/sites/default/files/thumbnails/image/openshift.png)</ImageSizing> OpenShiftコンテナプラットフォーム</>}
  >
  ...
  <Collapser
    ...
    title={<><ImageSizing verticalAlign="middle">![AKS](https://docs.newrelic.co.jp/sites/default/files/thumbnails/image/aks.png)</ImageSizing> Azure Kubernetes Service (AKS)</>}
  >
  ...
  <Collapser
    className="freq-link"
    id="install-pks"
    title={<><ImageSizing verticalAlign="middle">![PKS](https://docs.newrelic.co.jp/sites/default/files/thumbnails/image/pivotal.png)</ImageSizing> Pivotal Container Service (PKS / VMware Tanzu)</>}
  >
