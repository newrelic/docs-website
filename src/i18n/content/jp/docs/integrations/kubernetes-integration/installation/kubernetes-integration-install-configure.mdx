...
<CollapserGroup>
  <Collapser
    ...
    title={<><ImageSizing verticalAlign="middle">![EKS](./images/eks.png)</ImageSizing> <Link to="#install-amazon-eks"> Amazon EKS</Link></>}
  >
  ...
  <Collapser
    ...
    title={<><ImageSizing verticalAlign="middle">![CKE](./images/cke.jpeg)</ImageSizing> <Link to="#install-google-kubernetes-engine"> Google Kubernetes Engine （GKE）</Link></>}
  >
  ...
  <Collapser
    ...
    title={<><ImageSizing verticalAlign="middle">![OpenShift](./images/openshift.png)</ImageSizing> OpenShiftコンテナプラットフォーム</>}
  >
  ...
  <Collapser
    ...
    title={<><ImageSizing verticalAlign="middle">![AKS](./images/aks.png)</ImageSizing> Azure Kubernetes Service (AKS)</>}
  >
  ...
  <Collapser
    className="freq-link"
    id="install-pks"
    title={<><ImageSizing verticalAlign="middle">![PKS](./images/pivotal.png)</ImageSizing> Pivotal Container Service (PKS / VMware Tanzu)</>}
  >
