...
<CollapserGroup>
  <Collapser
    ...
    title={<><ImageSizing verticalAlign="middle"><img src={eks} alt="EKS"/></ImageSizing> <Link to="#install-amazon-eks"> Amazon EKS</Link></>}
  >
  ...
  <Collapser
    ...
    title={<><ImageSizing verticalAlign="middle"><img src={cke} alt="CKE"/></ImageSizing> <Link to="#install-google-kubernetes-engine"> Google Kubernetes Engine （GKE）</Link></>}
  >
  ...
  <Collapser
    ...
    title={<><ImageSizing verticalAlign="middle"><img src={openshift} alt="OpenShift"/></ImageSizing> OpenShiftコンテナプラットフォーム</>}
  >
  ...
  <Collapser
    ...
    title={<><ImageSizing verticalAlign="middle"><img src={aks} alt="AKS"/></ImageSizing> Azure Kubernetes Service (AKS)</>}
  >
  ...
  <Collapser
    className="freq-link"
    id="install-pks"
    title={<><ImageSizing verticalAlign="middle"><img src={pivotal} alt="PKS"/></ImageSizing> Pivotal Container Service (PKS / VMware Tanzu)</>}
  >
