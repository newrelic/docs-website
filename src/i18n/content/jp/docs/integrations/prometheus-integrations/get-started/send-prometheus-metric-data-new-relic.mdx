...
<CollapserGroup>
  ...
  >
    ...
    送信するメトリックスには限度があります。詳細については、[メトリックスAPIのドキュメント](https://docs.newrelic.co.jp/docs/data-ingest-apis/get-data-new-relic/metric-api/metric-api-limits-restricted-attributes)をご覧ください。
