...
![インテグレーション後にリモート書込みダッシュボード画面を表示する。](https://jajp-newrelic-docs.onelink-translations.com/sites/default/files/styles/inline_660px/public/thumbnails/image/Prometheus%20remote%20write%20dashboard.png?itok=tReo2zqe "Prometheusリモート書込みインテグレーションダッシュボード")
...
![インテグレーション後、OpenMetricsダッシュボード画面を表示する。](https://jajp-newrelic-docs.onelink-translations.com/sites/default/files/thumbnails/image/OpenMetrics%20Kube%20for%20Stitched%20Path.png "OpenMetricsのデータ表示")
...
<CollapserGroup>
  ...
  >
    ...
    送信するメトリックスには限度があります。詳細については、[メトリックスAPIのドキュメント](https://jajp-newrelic-docs.onelink-translations.com/docs/data-ingest-apis/get-data-new-relic/metric-api/metric-api-limits-restricted-attributes#requirements)をご覧ください。
