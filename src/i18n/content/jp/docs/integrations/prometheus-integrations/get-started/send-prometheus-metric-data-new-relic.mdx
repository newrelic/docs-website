...
<CollapserGroup>
  ...
  >
    ...
    送信するメトリックスには限度があります。詳細については、[メトリックスAPIのドキュメント](/docs/data-ingest-apis/get-data-new-relic/metric-api/metric-api-limits-restricted-attributes#requirements)をご覧ください。
