...
![インテグレーション後にリモート書込みダッシュボード画面を表示する。](./image/Prometheus%20remote%20write%20dashboard.png "Prometheusリモート書込みインテグレーションダッシュボード")
...
![インテグレーション後、OpenMetricsダッシュボード画面を表示する。](./image/OpenMetrics%20Kube%20for%20Stitched%20Path.png "OpenMetricsのデータ表示")
