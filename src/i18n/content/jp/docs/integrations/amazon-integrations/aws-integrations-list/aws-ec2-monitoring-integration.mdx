...
`プロバイダ`の値が`Ec2Instance`の場合、`ComputeSample`[イベントタイプ](/docs/insights/use-insights-ui/getting-started/introduction-new-relic-insights#event-type)を使用して[データのクエリと調査](/docs/using-new-relic/data/understand-data/query-new-relic-data)を行えます。
