...
このインテグレーションを有効にするには、標準手順に従い、[AWSサービスをInfrastructureに接続します](https://docs.newrelic.co.jp/docs/infrastructure/infrastructure-integrations/getting-started/connect-aws-integrations-infrastructure)。
...
`プロバイダ`の値が`Ec2Instance`の場合、`ComputeSample`[イベントタイプ](/docs/insights/use-insights-ui/getting-started/introduction-new-relic-insights#event-type)を使用して[データのクエリと調査](https://docs.newrelic.co.jp/docs/using-new-relic/data/understand-data/query-new-relic-data)を行えます。
