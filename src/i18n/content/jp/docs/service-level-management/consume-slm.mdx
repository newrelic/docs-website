...
import sliAnalyze from 'images/sli_analyze.png'
...
\*_任意のSLIをクリックすると、SLIカードが表示されます。<img
  title="SLIカード"
  alt="SLIカード"
  src={sliCard}
/>_ SLIが参照するエンティティとSLIの名前を示します。
