...
関係マップを使用すると、影響を受けるサービス レベルに関する関係を表示することで、問題がいつどこで始まったかを正確に特定できます。
...
<figcaption>
  **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities)> Service levels**、SLI を選択し、**Relationships map**を選択します。
</figcaption>