...
import slmAnalyzeMenu from 'images/slm_screenshot-crop_analyze-menu.png'

import slmBadEventsQuery from 'images/slm_screenshot-crop_bad-events-query.png'
