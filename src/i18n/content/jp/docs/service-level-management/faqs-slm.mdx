...
* SLM製品に完全にアクセスするには、[完全なプラットフォームユーザー](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type)である必要があります。
...
* [コアプラットフォームユーザー](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type)として、機能が制限された読み取り専用モードでアクセスできるようになります。
