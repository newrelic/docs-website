...
* [新しいユーザーモデル](/docs/accounts/original-accounts-billing/original-users-roles/overview-user-models)のユーザーには、「イベントからメトリックへのルールの変更」 [機能](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts#capabilities)が必要です。
