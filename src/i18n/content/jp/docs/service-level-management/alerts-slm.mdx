...
import slmAlertsOptionsFastBurn from 'images/slm_screenshot-crop_fast-burn.png'

import slmAlertsOptionsSlowBurn from 'images/slm_screenshot-crop_slow-burn.png'
