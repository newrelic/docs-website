...
* <DNT>**Organization Product Admin**</DNT>ロールを持つユーザーは、スコアカードとルールを作成、更新、削除できます。これらの権限を他のユーザーに委任する必要がある場合は、[スコアカードのカスタムロールを作成](/docs/apis/nerdgraph/examples/nerdgraph-scorecards-custom-tutorial)できます。
...
* <DNT>**Org Product Admin**</DNT>ロールを持つユーザーは、スコアカードとルールを作成、更新、削除できます。これらの権限を他のユーザーに委任する必要がある場合は、[スコアカードのカスタムロールを作成](/docs/apis/nerdgraph/examples/nerdgraph-scorecards-custom-tutorial)できます。
