...
<Callout variant="tip" title="ヒント">
  NerdGraphミューテーションを使用して、Scorecardsルールを作成または管理します。詳細については、[Scorecardsのカスタムロールの作成](/docs/apis/nerdgraph/examples/nerdgraph-scorecards-custom-tutorial)を参照してください。
</Callout>
