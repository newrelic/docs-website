...
* 実用的なリソース インサイト: インサイトからインフラストラクチャ アクティビティ (実行ステータス、関連イベント、スコアカードなど) にアクセスして、リソース最適化の取り組みを通知します。
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        [問題」](https://docs.newrelic.com/docs/alerts/alert-event-management/Issues-and-alert-event-management-and-response/)
    ...
    <tr>
      ...
      <td>
        ソフトウェアライフサイクルにおけるリソースのステージまたは目的。例：
        ...
        。これにより、チームは安定性、テスト、およびデプロイメントのワークフローを管理できます。この列にデータを入力するために、New Relicはエンティティ上の
