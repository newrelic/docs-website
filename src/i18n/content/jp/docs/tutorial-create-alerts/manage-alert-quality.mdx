...
<CollapserGroup>
  ...
  >
    ...
    <DoNotTranslate>**Goal:**</DoNotTranslate> 価値の低い迷惑なインシデントの数を減らします。
  ...
  >
    ...
    <DoNotTranslate>**Goal:**</DoNotTranslate> インシデントの合計累積時間を短縮します。
  ...
  >
    ...
    <DoNotTranslate>**Goal:**</DoNotTranslate> MTTCの短縮
  ...
  <Collapser
    ...
    title="5分未満の割合 KPI"
  >
    これは、合計継続時間が 5 分未満のインシデントの割合です。 これは、インシデントの状態が頻繁に変化していることを示しており、インシデントの原因と重大度が不明瞭になる可能性があります。 この状態は<DoNotTranslate>**incident flapping**</DoNotTranslate>と呼ばれます。

    <DoNotTranslate>**Goal:**</DoNotTranslate> 短時間のインシデントの割合を最小限に抑えます。
...
<CollapserGroup>
  ...
  >
    ...
    <DoNotTranslate>**Goal:**</DoNotTranslate> インシデントエンゲージメントの割合を増やします。
  ...
  >
    ...
    <DoNotTranslate>**Goal:**</DoNotTranslate> 調査にかかる平均時間を短縮します。
