        ...
        <TabsPageItem id="create-alert-guided">
          <SideBySide>
            <Side>
              ...
              1. <DoNotTranslate>**one.newrelic.com**</DoNotTranslate>から、[<DoNotTranslate>**Alerts & AI**</DoNotTranslate>](https://one.newrelic.com/alerts-ai)を選択し、次に[<DoNotTranslate>**Alert conditions (policies)**</DoNotTranslate>](https://one.newrelic.com/alerts-ai/alerts-classic/policies)を選択します。
...
1. <DoNotTranslate>**one.newrelic.com**</DoNotTranslate>から、[<DoNotTranslate>**Alerts & AI**</DoNotTranslate>](https://one.newrelic.com/alerts-ai)を選択し、次に[<DoNotTranslate>**Alert policies**</DoNotTranslate>](https://one.newrelic.com/alerts-ai/condition-builder/policy-list)を選択します。
