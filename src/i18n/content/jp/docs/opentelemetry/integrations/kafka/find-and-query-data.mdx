...
/\* ### 3. サードパーティ サービス 最適な用途: インテグレーション中心の監視 1. &lt;DNT&gt;\*\*\[one.newrelic.com]\(https\://one.newrelic.com) に移動します&gt; All capabilities &gt; Infrastructure &gt; Third-party services\*\*&lt;/DNT&gt; 2. Select &lt;DNT&gt;\*\*Kafka (OpenTelemetry)\*\*&lt;/DNT&gt; &gt; &lt;DNT&gt;\*\*OTel Kafka Dashboard\*\*&lt;/DNT&gt; &lt;img title=&quot;OTel Kafka Third-party Services&quot; alt=&quot;Kafka (OpenTelemetry) 統合を示すサードパーティ サービス ビュー&quot; を選択します。 src=&quot;/images/infrastruction\_screenshot-crop\_otel-kafka-third-party-インテグレーション.webp&quot; /&gt; \*/
...
2. 検索する <DNT>**&quot;OTel Kafka Dashboard&quot;**</DNT>
...
<CollapserGroup>
  ...
  <Collapser id="cluster-health-queries" title="クラスタの健全性">
