...
* [セルフホスト環境での NGINX の監視](/docs/opentelemetry/integrations/nginx/nginx-otel-host/)- オンホスト デプロイメントのセットアップを完了する
* [Kubernetes上の NGINX をモニターする](/docs/opentelemetry/integrations/nginx/nginx-otel-kubernetes/)- Kubernetesデプロイメントのセットアップを完了する

**データ使用量:**

* [NGINX データを検索して書き込みます](/docs/opentelemetry/integrations/nginx/find-and-query-your-data/)- Dashboards 、 NRQL書き込み、およびアラート
