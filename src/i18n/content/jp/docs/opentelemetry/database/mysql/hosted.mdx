...
<Steps>
    ...
    <CollapserGroup>
      ...
      <Collapser id="full" title="フル機能設定">
        ...
        <Callout variant="important">
          NRDOT Collectorを介したMySQLインテグレーションは、標準の[データ取り込みの価格設定](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/data-ingest-billing/#data)に従います。フル機能の設定では標準のセットアップよりも多くのデータが取り込まれるため、全体の請求額が増加する可能性があることにご注意ください。
        </Callout>
      </Collapser>
    </CollapserGroup>
  ...
  <Step>
    ...
    <Callout variant="tip">
      ...
      * [SQLクエリレシーバーの構成](/docs/opentelemetry/database/capabilities/sql-query-receiver): MySQLデータベースからカスタムメトリックを収集します。
