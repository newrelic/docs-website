...
<Steps>
  ...
  <Step>
    ...
    * [New Relic OTLP エンドポイント](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-otlp)にデータを送信するための OpenTelemetry Protocol (OTLP) エクスポーター。
  ...
  <Step>
    ...
    * <DoNotTranslate>**All entities -> Services - OpenTelemetry**</DoNotTranslate>
      ...
      でエンティティを見つけます。 エンティティ名は、アプリの`service.name`リソース属性の値に設定されます。 New RelicサービスエンティティがOpenTelemetryリソース属性からどのように派生するかの詳細については、 [サービス](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-best-practices-resources/#services)を参照してください。
    ...
    * 詳細については[、OpenTelemetry APM UI](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/apm-monitoring/opentelemetry-apm-ui)を参照してください。
