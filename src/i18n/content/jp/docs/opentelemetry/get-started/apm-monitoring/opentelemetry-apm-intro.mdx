...
<Steps>
  ...
  <Step>
    ...
    * <DNT>**All entities &gt; Services - OpenTelemetry**</DNT>でエンティティを見つけます。 エンティティ名は、アプリの`service.name`リソース属性の値に設定されます。 New Relic サービス エンティティが OpenTelemetry リソース属性からどのように派生されるかの詳細については、 [「サービス」](/docs/opentelemetry/best-practices/opentelemetry-best-practices-resources/#services)を参照してください。
