...
[New Relic Kubernetes 統合 v3](/docs/kubernetes-pixie/kubernetes-integration/advanced-configuration/k8s-version2/changes-since-v3/) 以降では、クラスターからメトリクスが収集される間隔を変更できます。これにより、データ解像度と使用量の間のトレードオフを選択できます。最適なエクスペリエンスを実現するには、15 ～ 30 秒の間隔を選択することをお勧めします。
