...
<CollapserGroup>
  ...
  >
    <Callout variant="important">
      Kubernetes 統合を最大限に活用するには、最新バージョンを使用することをお勧めします。[バージョン 3 で導入された変更を](/docs/kubernetes-pixie/kubernetes-integration/advanced-configuration/k8s-version2/changes-since-v3)確認してください。
    </Callout>
