...
## [プロキシを使用したPixie統合のインストール [#pixie]](https://github.com/newrelic/helm-charts/tree/master/charts/synthetics-minion)

[プロキシを使用して Pixie 統合をインストールするには、2 つのオプションがあります。](https://github.com/newrelic/helm-charts/tree/master/charts/synthetics-minion)

* [](https://github.com/newrelic/helm-charts/tree/master/charts/synthetics-minion)

* [チャートでのインストール `newrelic-pixie`:](https://github.com/newrelic/helm-charts/tree/master/charts/synthetics-minion)

  * [](https://github.com/newrelic/helm-charts/tree/master/charts/synthetics-minion)
  * [プロキシの設定は、設定オプション `proxy` を設定して、チャートの ](https://github.com/newrelic/helm-charts/tree/master/charts/synthetics-minion)[values.yaml](https://github.com/newrelic/helm-charts/blob/334ce7ae4e9753acea9e35c5b923a6795cea262e/charts/newrelic-pixie/values.yaml#L32) に記載されているように行うことができます。

* chart `nri-bundle` を依存関係としてインストールする。

  * `newrelic-pixie.proxy` を設定することで、プロキシを設定することができます。設定オプションは、 [依存関係に渡されます](https://github.com/newrelic/helm-charts/tree/master/charts/nri-bundle#configure-dependencies) `newrelic-pixie` `の値を変更します。yaml` `nri-bundle`:
