...
<CollapserGroup>
  ...
  >
    ...
    11. <DoNotTranslate>**Service**</DoNotTranslate>リソースの`TargetPort` <DoNotTranslate>**Deployment**</DoNotTranslate>のコンテナの<DoNotTranslate>**Port**</DoNotTranslate>と一致することを確認します。
