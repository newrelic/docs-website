...
* クラスターに[NewRelicKubernetes統合](/install/kubernetes)をインストールしました
...
まず、New Relic とともに OTLP エクスポーターを [OpenTelemetry Collector 設定 YAML ファイル](https://opentelemetry.io/docs/collector/configuration/) に追加します。 <InlinePopover type="licenseKey"/>ヘッダーとして。
