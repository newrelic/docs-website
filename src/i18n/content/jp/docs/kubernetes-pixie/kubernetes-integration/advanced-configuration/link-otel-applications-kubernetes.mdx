...
* 次の環境変数を作成しました。
  ...
  * `OTEL_EXPORTER_OTLP_ENDPOINT` （ [お住まいの地域または目的のエンドポイント](src/content/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/opentelemetry-setup.mdx/#review-settings)）
