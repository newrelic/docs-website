...
最初に、OTLP エクスポーターを New Relic と共に [OpenTelemetry コレクター構成 YAML ファイル](https://opentelemetry.io/docs/collector/configuration/) に追加して構成します。 <InlinePopover type="licenseKey"/>ヘッダーとして。
