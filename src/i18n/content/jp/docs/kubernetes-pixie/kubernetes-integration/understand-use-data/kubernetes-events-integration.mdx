...
New Relicによって収集されたイベントは、Kubernetesによって付与されたものとまったく同じ属性を持ちます。これらの属性のリファレンスについては、[Kubernetesイベントv1コアドキュメント](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.34/#event-v1-core)を参照してください。
