...
2. グラフを作成または更新するときは、グラフ タイプ**テーブル**を選択し、次のイベント クエリを使用して、YOUR_CLUSTER_NAME をクラスターの名前に置き換えます。
...
クラスター内の最新のイベントに関する詳細を表示するには、次のクエリを使用して、YOUR_CLUSTER_NAME をクラスターの名前に置き換えます。
...
1. [Infrastructure イベント ページ](https://one.newrelic.com)に移動します。 **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > Events**に移動します。
