...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        `DaemonSet`に関連付けられているラベル。これにより、特定のフィルタリングとクエリを行うことができます `DaemonSet`
      </td>
    </tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        `StatefulSet`に関連付けられているラベル。これにより、特定のフィルタリングとクエリを行うことができます `StatefulSet`
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        シーケンスでポッドを生成するために使用される`StatefulSet`のバージョンを示します。値の範囲<var>：</var> <var>0〜podsCurrent</var>
      </td>
    </tr>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        値は`Pending` 、 `Running` 、 `Succeeded` 、 `Failed` 、 `Unknown`
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        これが[永続](https://kubernetes.io/docs/concepts/storage/persistent-volumes/)ボリュームの場合、この値は次のように設定されます。 `true`
      </td>
    </tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        レポートシステムが関連するリースのマスターであるかどうかのゲージ、 `0`は`backup`を示し、 `1`は `master`
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        `Spectype`の場合、外部名値。 `ExternalName`
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        内部クラスタIPは、`Spectype`が `ClusterIP`
      </td>
    </tr>
