...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > ダッシュボード**:[クエリ ビルダー](/docs/chart-builder/use-chart-builder/get-started/introduction-chart-builder)を使用して、Kubernetes データにクエリを実行し、明確な視覚化を作成できます。
</figcaption>
...
<CollapserGroup>
  ...
  >
    ...
    1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > Settings > Alerts & AI > Kubernetes**に移動し、 **Create alert condition**を選択します。
