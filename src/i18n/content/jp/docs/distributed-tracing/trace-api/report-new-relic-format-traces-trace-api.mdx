...
3. [](/docs/understand-dependencies/distributed-tracing/trace-api/trace-api-general-requirements-limits#requirements)
   ...
   [](/docs/understand-dependencies/distributed-tracing/trace-api/trace-api-general-requirements-limits#requirements)
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        スパンに関する詳細を追加するキーの値のペアのセット。 `duration.ms`は必須であり、 `name`および`parent.id`属性を追加することを強くお勧めします。
      </td>
