...
2. そのキーを以下のJSONに挿入し、JSONを当社のエンドポイントに送信してください。注：EUまたはJPのNew Relicアカウントをお持ちの場合は、代わりに適切な[リージョンエンドポイント](/docs/distributed-tracing/trace-api/trace-api-general-requirements-limits#requirements)を使用してください。
