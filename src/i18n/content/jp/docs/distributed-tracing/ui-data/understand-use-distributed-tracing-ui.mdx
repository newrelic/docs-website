...
<Callout variant="tip">
  In addition to these tools, you can also use other options mentioned in [Query
  distributed trace
  data](/docs/apm/distributed-tracing/ui-data/example-insights-queries-distributed-trace-data).
</Callout>
...
<Callout variant="tip">
  Some queries that return a large number of results may return false positives.
  The trace list limits these incorrect results to 10% of the returned results.
  False positives may also result in histogram chart results that are not
...
<CollapserGroup>
  ...
  >
    ...
    3. Contains an error in any [span](/docs/using-new-relic/welcome-new-relic/getting-started/glossary#span).
       ...
       ![new-relic-one-distributed-tracing-query-example-1.png](src/images/new-relic-one-distributed-tracing-query-example-1.png "New Relic One distributed tracing example query 1")
  ...
  >
    ...
    2. Contain spans where the `customer_user_email` attribute contains a value ending with `hotmail.com` anywhere in the trace.
       ...
       ![New Relic One distributed tracing - query example 2](src/images/new-relic-one-distributed-tracing-query-example-2.png "new-relic-one-distributed-tracing-query-example-2.png")
...
![Screenshot showing the distributed tracing scatter plot chart.](src/images/scatter-plot-hover.png 'scatter-plot-hover.png')
...
![New Relic One distributed tracing - histogram](src/images/new-relic-one-distributed-tracing-histogram-selection.png 'new-relic-one-distributed-tracing-histogram-selection.png')

<Callout variant="important">
  Some queries that produce many results may result in false positives in
  histograms. This could manifest as histograms showing trace results that are
...
![New Relic distributed tracing UI - trace details page](src/images/new-relic-distributed-tracing-trace-details-UI.png 'new-relic-distributed-tracing-waterfall-view.png')

<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > APM > (select an application)
  > Monitor > Distributed tracing > (select a trace) > (select a span)**: See
  the spans in a trace. Examine individual span details and see notifications
  for spans with anomalous behavior.
</figcaption>
...
<table id="span-types">
  ...
  <tbody>
    <tr>
      ...
      <td>
        ![New Relic distributed tracing service icon](src/images/new-relic-distributed-tracing-service-icon.png "new-relic-distributed-tracing-service-span-icon.png")
      </td>
    ...
    <tr id="in-process">
      ...
      <td>
        ![New Relic distributed tracing in-process span icon ](src/images/new-relic-distributed-tracing-inprocess-icon.png "new-relic-distributed-tracing-in-process-span-icon.png")
      </td>
    ...
    <tr>
      ...
      <td>
        ![New Relic distributed tracing datastore span icon](src/images/new-relic-distributed-tracing-databases-icon.png "new-relic-distributed-tracing-database-span-icon.png")
      </td>
    ...
    <tr>
      ...
      <td>
        ![New Relic distributed tracing external span icon](src/images/new-relic-distributed-tracing-external-icon.png "new-relic-distributed-tracing-external-span-icon.png")
      </td>
    ...
    <tr>
      ...
      <td>
        ![New Relic distributed tracing browser span icon](src/images/distributed-tracing-browser-span-icon.png "distributed-tracing-browser-span-icon.png")
      </td>
    ...
    <tr>
      ...
      <td>
        ![New Relic distributed tracing external span icon](src/images/new-relic-distributed-tracing-lambda-icon.png "new-relic-distributed-tracing-lambda-icon.png")
      </td>
...
<table id="span-types-table">
  ...
  <tbody>
    <tr id="connecting-lines">
      ...
      <td>
        ![New Relic distributed tracing connecting lines image](src/images/new-relic-distributed-tracing-lines-image.png "new-relic-distributed-tracing-lines-image.png")
      </td>
    ...
    <tr>
      ...
      <td>
        ![New Relic distributed tracing error icon](src/images/new-relic-distributed-tracing-error-icon.png "new-relic-distributed-tracing-error-icon.png")
      </td>
    ...
    <tr>
      ...
      <td>
        ![New Relic distributed tracing datastore span icon](src/images/new-relic-distributed-tracing-anomalous-icon.png "new-relic-distributed-tracing-anomalous-icon.png")
      </td>
    ...
    <tr>
      ...
      <td>
        ![New Relic distributed tracing orphaned span icon](src/images/new-relic-distributed-tracing-orphan-icon.png "new-relic-distributed-tracing-fragmented-icon.png")
      </td>
    ...
    <tr>
      ...
      <td>
        ![New Relic distributed tracing multiple app names indicator](src/images/new-relic-distributed-tracing-multiapp-icon.png "new-relic-distributed-tracing-multiple-app-names-indicator.png")
      </td>
    ...
    <tr>
      ...
      <td>
        ![New Relic distributed tracing client-server time difference indicator](src/images/new-relic-distributed-tracing-client-server-time-indicator.png "new-relic-distributed-tracing-client-server-time-indicator.png")
      </td>
...
<CollapserGroup>
  ...
  >
    ...
    * Differences in duration, due to things like network latency or DNS resolution delay
      ...
      ![New Relic distributed tracing client vs server time discrepancy diagram](src/images/new-relic-distributed-tracing-client-span-time.jpg "new-relic-distributed-tracing-client-span-time.jpg")
...
{' '}
<Collapser id="1k-limit" title="Span limits and sampling">
  See
...
>
  When viewing the span waterfall, span names may be displayed in an incomplete
  form that is more human-readable than the complete span name. To find the
  complete name, select that span and look for the **Full span name**. Knowing
  the complete name can be valuable for querying that data with NRQL.
</Collapser>
