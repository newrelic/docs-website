...
<Tabs>
  ...
  <TabsPages>
    ...
    <TabsPageItem id="waterfall-view">
      ...
      * <DNT>**Focus on**</DNT>: スパンにエラーまたは異常がある場合は、それぞれのタイプのチェックボックスが表示されます。 これらのボックスをオンにすると、ウォーターフォール ビューでは他のすべての種類のスパンが折りたたまれ、色分けされたエラーまたは異常なスパンのみが表示されます。 これは問題のあるスパンを素早く見つける方法です。<img
          ...
          src="/images/distributed-tracing_screenshot-crop_focus-on-example.webp"
        />
