...
<Tabs>
  ...
  <TabsPages>
    ...
    <TabsPageItem id="3">
      ...
      * **焦点を当てる**: スパンにエラーまたは異常がある場合、これらのタイプごとにチェックボックスが表示されます。これらのボックスをチェックすると、ウォーターフォール ビューでは他のタイプのスパンがすべて折りたたまれ、色分けされたエラーまたは異常なスパンのみが表示されます。これは、問題のあるスパンを簡単に見つける方法です。<img style={{ width: "70%",align: "left" }} title="Screenshot showing the color coding of focus on" alt="Screenshot showing the color coding of focus on" src={distributedtracingFocusonExample}/>
