...
import distributedtracingUpdateSpanKey from 'images/distributed-tracing_screenshot-crop_update-span-key.png'

import distributedtracingUpdateSpanValue from 'images/distributed-tracing_screenshot-crop_update-span-value.png'
...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Apps > Your apps > Infinite Tracing settings**に移動します。
