...
import distributedtracingTraceMonitoringToggle from 'images/distributed-tracing_screenshot-full_trace-monitoring-toggle.png'
...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Apps > Your apps > New Relic Edge**に移動します。
