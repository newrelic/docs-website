...
1. トレース オブザーバー アプリに戻ります (**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infinite Tracing settings**)。

2. トレース オブザーバーの場合は、行の最後に移動し、省略記号アイコン**...**をクリックし、 **Edit mobile, browser, lambda sources** \[モバイル、ブラウザー、ラムダ ソースの編集]をクリックします。
