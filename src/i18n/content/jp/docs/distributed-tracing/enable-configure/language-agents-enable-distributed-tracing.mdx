...
<CollapserGroup>
  ...
  >
    ...
    4. （オプション）コールを外部コールとして識別します。
       ...
       * [行け](/docs/agents/go-agent/get-started/instrument-go-segments#go-external-segments)
       ...
       * [ルビー](/docs/agents/ruby-agent/api-guides/guide-using-ruby-agent-api#externals)
  </Collapser>
