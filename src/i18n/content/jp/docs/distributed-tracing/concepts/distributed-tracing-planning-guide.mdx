...
<CollapserGroup>
  ...
  >
    ...
    * APMモニター アプライアンスに対してディストリビューティッド（分散）トレーシングが有効になっている場合、レガシー[サービス マップには ](/docs/understand-dependencies/understand-system-dependencies/service-maps/introduction-service-maps)
      ...
      <InlinePopover type="mobile">[](/docs/understand-dependencies/understand-system-dependencies/service-maps/introduction-service-maps)</InlinePopover>
...
<InlinePopover type="apm"/>機能への影響を認識しており、ロールアウトについて検討している場合は、ディストリビューティッド（分散）トレーシングをセットアップする準備ができています。 [セットアップオプションを](/docs/distributed-tracing/concepts/quick-start)参照してください。