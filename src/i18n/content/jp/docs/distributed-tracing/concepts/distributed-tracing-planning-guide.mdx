...
<CollapserGroup>
  ...
  >
    ...
    * APM 監視対象エンティティに対して分散トレースが有効になっている場合、レガシー[サービス マップに](/docs/understand-dependencies/understand-system-dependencies/service-maps/introduction-service-maps)は、APM 監視対象エンティティで監視されているアプリケーションが表示されません。
