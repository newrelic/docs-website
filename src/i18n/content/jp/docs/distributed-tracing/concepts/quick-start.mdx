...
分散トレーシングの初期設定を行い、必要なデータが得られない場合は、上級者向けの [Infinite Tracing](/docs/distributed-tracing/infinite-tracing/introduction-infinite-tracing) 機能を検討することをお勧めします。また、現在New Relic APMエージェントを使用していて、分散トレーシングを有効にしたい場合は、 [プランニングガイド](/docs/distributed-tracing/concepts/distributed-tracing-planning-guide) をご覧ください。
