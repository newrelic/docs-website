...
[メトリクスはいくつかの方法で報告しています](/docs/using-new-relic/data/understand-data/new-relic-data-types#metrics) 。 **metric timeslice data** と呼んでいるメトリックデータの種類があります。APM、モバイル、ブラウザの多くのチャートを生成するために使用されているデータです（詳細は [metric timeslice data](/docs/using-new-relic/data/understand-data/new-relic-data-types#timeslice-data) をご覧ください）。
