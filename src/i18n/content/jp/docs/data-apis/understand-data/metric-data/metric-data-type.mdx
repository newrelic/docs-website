...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        ✅ [New Relic メトリクス API](/docs/data-apis/ingest-apis/metric-api/report-metrics-metric-api) ❌ [New Relic イベントからメトリクスへ](/docs/data-apis/convert-to-metrics/analyze-monitor-data-trends-metrics)✅ [Prometheus リモート書き込み](/docs/infrastructure/prometheus-integrations/get-started/send-prometheus-metric-data-new-relic)✅ [オープン テレメトリ](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-best-practices-metrics)
      </td>
    ...
    <tr>
      ...
      <td>
        ❌ [New Relic メトリクス API](/docs/data-apis/ingest-apis/metric-api/report-metrics-metric-api) ✅ [New Relic イベントからメトリクスへ](/docs/data-apis/convert-to-metrics/analyze-monitor-data-trends-metrics)(デルタのみ) ✅ [Prometheus リモート書き込み](/docs/infrastructure/prometheus-integrations/get-started/send-prometheus-metric-data-new-relic)✅ [オープン テレメトリ](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-best-practices-metrics)
      </td>
    ...
    <tr>
      ...
      <td>
        ✅ [New Relic メトリクス API](/docs/data-apis/ingest-apis/metric-api/report-metrics-metric-api) ✅ [New Relic イベントからメトリクスへ](/docs/data-apis/convert-to-metrics/analyze-monitor-data-trends-metrics)✅ [Prometheus リモート書き込み](/docs/infrastructure/prometheus-integrations/get-started/send-prometheus-metric-data-new-relic)✅ [オープン テレメトリ](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-best-practices-metrics)(レガシー)
      </td>
