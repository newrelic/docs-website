...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        上記の`count`タイプと同等ですが、これにより、累積指標フィールドへのアクセスが可能になります。詳細については、[累積指標](/docs/data-apis/understand-data/metric-data/cumulative-metrics)を参照してください。

        <Callout variant="important">
          このタイプは一般的な`count`よりもわずかに大きいため、[データ取り込み](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/data-ingest-billing)に追加できます。
        </Callout>
      </td>
    ...
    <tr>
      ...
      <td>
        ...
        ✅ [OpenTelemetry](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-best-practices-metrics) (レガシー)
      </td>
