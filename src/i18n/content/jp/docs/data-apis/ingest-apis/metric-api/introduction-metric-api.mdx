...
データを送信する New Relic アカウントの New Relic [ライセンス キーが](/docs/apis/intro-apis/new-relic-api-keys/#license-key) 必要です。 制限と制限された属性については、[メトリック API の要件と制限](/docs/metric-api-general-requirements-limits)を参照してください。
