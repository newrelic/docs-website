...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        300〜1500万DPM。[追加のアカウント条件](#additional-considerations)を参照してください。
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        300〜1500万（詳細については、[追加のアカウント条件](#additional-considerations)を参照してください）。
    ...
    <tr>
      ...
      <td>
        100k（詳細については、[追加のアカウント条件](#additional-considerations)を参照してください）。
      </td>
    </tr>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        1〜1500万（詳細については、[追加のアカウント条件](#additional-considerations)を参照してください）。
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Metric APIは、 `accountID` 、 `appId` 、 `eventType`などの[予約語をNewRelicInsightsから](/docs/insights/insights-data-sources/custom-data/insights-custom-data-requirements-limits#reserved-words)継承します。さらに、NRQLの構文用語は、バッククォート（ ``` `` ``` ）しない限り制限されます。完全なリストについては、 [予約語：NRQL構文用語](/docs/insights/insights-data-sources/custom-data/insights-custom-data-requirements-limits#reserved-syntax)を参照してください。
      </td>
    </tr>
