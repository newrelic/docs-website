...
1. [インサイト クエリ API キー](/docs/insights/insights-api/get-data/query-insights-event-data-api)があることを確認してください ( <DNT>**[one.newrelic.com/api-keys](https://one.newrelic.com/api-keys)**</DNT>に移動)。
