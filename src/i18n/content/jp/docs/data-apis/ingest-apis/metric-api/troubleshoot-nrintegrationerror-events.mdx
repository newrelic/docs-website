...
1. [インサイト クエリ API キー](/docs/insights/insights-api/get-data/query-insights-event-data-api)があることを確認してください ( <DoNotTranslate>**[insights.newrelic.com](https://insights.newrelic.com) > Manage data > API keys**</DoNotTranslate>に移動)。
