...
* データのレポート先となるアカウントの New Relic <InlinePopover type="licenseKey" />。
...
* 米国（デフォルト）の場合、 `https://security-api.newrelic.com/security/v1`
* EUの場合、 `https://security-api.service.eu.newrelic.com/security/v1`
* JPの場合、 `https://security-api.service.jp.newrelic.com/security/v1`
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        問題が検出されたときのタイムスタンプ（エポックからのミリ秒単位）。指定されていない場合は、データがNew Relicに送信された時点を使用します。
      </td>
    </tr>
  </tbody>
</table>