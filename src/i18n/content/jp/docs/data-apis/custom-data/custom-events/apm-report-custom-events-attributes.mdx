...
<CollapserGroup>
  ...
  <Collapser className="freq-link" id="php-att" title="PHP">
    ...
    デフォルトでは、1 分あたりに記録されるカスタムイベントの最大数は 30,000 です。 [newrelic.custom\_events.max\_samples\_stored](/docs/apm/agents/php-agent/configuration/php-agent-configuration/#inivar-custom-events-maxsamples)を使用して、最大100,000まで増やすことができます。 構成設定。
