...
* <InlinePopover type="apm">[](/docs/insights/insights-data-sources/custom-data/insert-custom-events-new-relic-apm-agents)</InlinePopover>
  ...
  [エージェントAPI](/docs/insights/insights-data-sources/custom-data/insert-custom-events-new-relic-apm-agents)

* [イベントAPI](/docs/insights/insights-data-sources/custom-data/send-custom-events-event-api)（イベントAPIを使用する際は、追加要件があります）

* [エージェントAPIと](/docs/insights/insights-data-sources/custom-data/insert-data-via-new-relic-browser)
  ...
  （カスタム`PageAction`イベントには追加の要件があります）
