...
[カスタム イベントを作成し](docs/data-apis/custom-data/custom-events/collect-custom-attributes/#enabling-custom)たら、 [他のイベントを](/docs/query-your-data/nrql-new-relic-query-language/get-started/nrql-syntax-clauses-functions)使用する場合と同じように、標準の NRQL クエリで使用できます。
