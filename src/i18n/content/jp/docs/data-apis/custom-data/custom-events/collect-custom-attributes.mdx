...
<CollapserGroup>
  ...
  >
    ...
    1. 属性を記録するメソッドごとに、 [`AddCustomAttribute`](/docs/apm/agents/net-agent/net-agent-api/itransaction/#addcustomattribute)を呼び出します。
...
* 概要については、
  ...
  カスタム データについては、 [「カスタム イベントと属性の挿入」](/docs/insights/insights-data-sources/custom-events/insert-custom-events-attributes-mobile-data)を参照してください。
