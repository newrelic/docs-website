...
## ブラウザモニタリング。カスタム属性の記録 [#collecting_browser][#collecting_browser]
...
## インフラストラクチャのモニタリング。カスタム属性の記録 [#collecting_browser][#collecting_browser]
...
## モバイルモニタリング。カスタム属性の記録 [#collecting_mobile][#collecting_mobile]
