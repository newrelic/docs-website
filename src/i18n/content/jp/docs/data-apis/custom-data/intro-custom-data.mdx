...
* [New Relicアプリ](/docs/new-relic-one/use-new-relic-one/build-new-relic-one/new-relic-one-build-your-own-custom-new-relic-one-application)をビルドするか[、アプリカタログ](https://opensource.newrelic.com/nerdpacks)から既存のアプリをカスタマイズします。私たちのプラットフォーム上に存在し、チームや一般の人々と共有でき、独自のJavaScriptUI機能を使用するアプリを構築できます。 New Relicデータを分析することも、必要なデータを取り込むこともできます。