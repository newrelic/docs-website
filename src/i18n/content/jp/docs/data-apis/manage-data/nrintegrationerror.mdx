...
[NRQL](/docs/query-your-data/nrql-new-relic-query-language/get-started/introduction-nrql-new-relics-query-language)を使用して`NrIntegrationError`イベントをクエリし、問題が発生したときに通知を受け取るように[NRQLアラート条件](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/nrql-alert-conditions)を設定できます。
