...
このドキュメントは、 [NewRelicOneの価格設定モデル](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-pricing-models)の組織に適用されます。元の価格モデルのデータ保持については、 [元のデータ保持](/docs/accounts/original-accounts-billing/product-based-pricing/overview-data-retention-components)を参照してください。
...
この表は、NewRelicOne価格設定モデルでの組織のデフォルトの[名前空間](/docs/glossary/glossary)保持設定を示しています。
...
[New Relic Oneの価格設定モデル](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing)を使用している組織の場合：

* [Data Plusオプション](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/data-ingest-billing#data-prices)を使用すると、最大90日間の保存にアクセスできます。
* [元のデータオプション](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/data-ingest-billing#data-prices)の場合：追加の30日間の保持には、1か月あたりの摂取GBあたり0.05ドルの費用がかかります。
