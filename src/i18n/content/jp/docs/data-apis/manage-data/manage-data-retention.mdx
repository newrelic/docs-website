...
データ保持を構成するには、課金管理者権限を持つ Pro または Enterprise エディションが必要です。これらおよびその他のいくつかのアカウントの特性により、一部の New Relic 組織は保持を独自に調整することができなくなります。請求管理者アカウントの Pro または Enterprise 組織であり、保持を編集できない場合は、New Relic アカウント担当者にお問い合わせください。
