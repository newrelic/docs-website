...
最近まで、契約上の制限を超えてデータ保持を調整することを許可してきました。2023 年 3 月 31 日以降、データ保持が規定の制限を超え、保持の延長をオプトインしない場合、アカウントは、ダッシュボード、データ分析、監査、およびレポートのニーズでの使用を含め、既定の保持制限に戻ります。

2023 年 3 月 31 日以降、契約の制限を超えてデータ保持を編集すると、延長された保持を反映するために、新しい請求の変更で保持をアップグレードするように求められます。長期的なデータ分析、ガバナンス、およびコンプライアンスのために、保持期間を延長することはビジネスに不可欠です。詳細については、以下を参照してください。
