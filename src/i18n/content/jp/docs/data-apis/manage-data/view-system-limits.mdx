...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        [メトリック タイムスライス データ](/docs/telemetry-data-platform/ingest-manage-data/understand-data/new-relic-data-types#timeslice-data)のレート (APM、ブラウザ、 <InlinePopover type="mobile"/>)
      </td>
