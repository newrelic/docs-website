...
[制限 UI を見つけるには、](/docs/licenses/license-information/general-usage-licenses/new-relic-data-usage-limits-policies)[ユーザー メニュー](/docs/accounts/accounts-billing/general-account-settings/intro-account-settings)から<DoNotTranslate>**Manage your data**</DoNotTranslate>をクリックし、 <DoNotTranslate>**Limits**</DoNotTranslate>をクリックします。
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [トレース制限](/docs/distributed-tracing/concepts/how-new-relic-distributed-tracing-works/#trace-origin-sampling)を参照してください。
      </td>
    </tr>
