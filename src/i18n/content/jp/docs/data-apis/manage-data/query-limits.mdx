...
以下の NRQL クエリを使用してアラートを作成できます。 [NRQL クエリを使ったアラートの作成についてはこちら](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/nrql-alert-conditions/#create) 。
