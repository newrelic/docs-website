...
[<img title="data-ingest-source-account.gif" alt="図は、ソースとアカウントを表示したデータインジェストです。" src={dataIngestSourceAccount}/>](/docs/accounts/accounts-billing/new-relic-one-pricing-users/usage-queries-alerts#data-queries)
...
[<img title="データファセット.png" alt="データファセット選択のスクリーンショット" src={dataFacet}/>](/docs/accounts/accounts-billing/new-relic-one-pricing-users/usage-queries-alerts#data-queries)
