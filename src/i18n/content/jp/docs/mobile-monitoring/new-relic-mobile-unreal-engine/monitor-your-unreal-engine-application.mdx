...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile > (select an app) > Summary**</DoNotTranslate>: Unreal Engine のデータとエラーを表示し、時間の経過に伴うアプリのパフォーマンスを監視します。
</figcaption>
...
<Steps>
  ...
  <Step>
    ...
    2. [Github 上の`NewRelic`フォルダ](https://github.com/ndesai-newrelic/newrelic-unreal-plugin/tree/master/Plugins/NewRelic)をコピーします。 次のようなものがあるはずです
