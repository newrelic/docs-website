...
iOS エージェント バージョン 7.4.0 以降、New Relic は、コールド スタートアップ時間とホット スタートアップ時間を自動的に報告します。注: 保温時間と予熱時間は報告されません。これらの[手順](/docs/mobile-monitoring/new-relic-mobile-ios/configuration/app-launch-times-ios-apps)を参照してください。