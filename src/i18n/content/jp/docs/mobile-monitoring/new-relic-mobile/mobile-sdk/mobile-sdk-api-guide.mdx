...
私たちの間、 <InlinePopover type="mobile"/>このソリューションは、すぐに使用できる強力なデータ収集を提供しますが、モバイル アプリが New Relic に報告するデータをカスタマイズして拡張する必要がある場合があります。たとえば、パブリック SDK API 呼び出しを使用して次のことを行うことができます。
