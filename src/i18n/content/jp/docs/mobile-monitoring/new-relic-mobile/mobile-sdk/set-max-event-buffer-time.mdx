...
<Tabs>
  ...
  <TabsPages>
      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td>
              必須。エージェントがメモリにイベントを保存する最大時間 (秒単位)。デフォルト値の収集サイクルの長さは 60 秒です。
            </td>
          </tr>
        </tbody>
      </table>
    ...
    <TabsPageItem id="ios">
      ...
      イベント収集サイクルの長さを設定します。デフォルトは60秒です。
    ...
    <TabsPageItem id="capacitor">
      ...
      イベント収集サイクルの長さを設定します。デフォルトは60秒（1分）です。最小値は 60 秒未満にすることはできません。最大値は 600 秒以下にしてください。
