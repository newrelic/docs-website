...
<Tabs>
  ...
  <TabsPages>
    ...
    <TabsPageItem id="maui">
      ...
      選択したカスタム属性に加えて、イベントには関連付けられた [セッション属性](/docs/insights/explore-data/attributes/mobile-default-attributes-insights#mobile-list)も含まれます。[`setAttribute`](docs/mobile-monitoring/new-relic-mobile/mobile-sdk/create-attribute/)を使用する場合とは異なり、ブレッドクラム イベントに属性を追加すると、そのイベントにのみ追加されます。これらはセッション属性ではありません。
