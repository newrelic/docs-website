...
<Steps>
  ...
  <Step>
    ...
    2. トークンを Unity プロジェクトに追加します。
       ...
       2. **Tools > New Relic > Getting Started**に移動して、エディターウィンドウを開きます。
  ...
  <Step>
    ...
    4. iOS の依存関係管理に Podfile を使用していない場合は、次の手順に従います。
       ...
       2. New Relic XCFramework を Xcode プロジェクトに追加します。
          ...
          3. **Embed** \[埋め込み] 列の下で**Embed & Sign** \[埋め込みと署名] をクリックします。
...
2. Unity アプリを選択します。
3. **Exceptions \[例外] > Handled exceptions \[処理された例外]**をクリックします。
