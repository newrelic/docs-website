...
7. Androidアプリのデータを表示します。<DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile > (select an app)**</DoNotTranslate>に移動します。
