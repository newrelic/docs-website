...
4. アプリをエミュレーターまたはデバイスで実行すると、モバイルアプリケーションの[<DNT>**Overview**</DNT>ページ](/docs/mobile-apps/mobile-apps-dashboard)でデータが表示されるようになります。

5. オプション：<InlinePopover type="mobile"/><DNT>**Settings**</DNT>ページを使用すると[モバイルアプリケーションをカスタマイズできます](/docs/mobile-apps/customizing-your-mobile-app-settings)。
...
5. アプリをエミュレーターまたはデバイスで実行すると、モバイルアプリケーションの[<DNT>**Overview**</DNT>ページ](/docs/mobile-apps/mobile-apps-dashboard)でデータが表示されるようになります。

6. オプション：モバイル監視<DNT>**Settings**</DNT>ページを使用すると[モバイルアプリをカスタマイズできます](/docs/mobile-apps/customizing-your-mobile-app-settings)。
