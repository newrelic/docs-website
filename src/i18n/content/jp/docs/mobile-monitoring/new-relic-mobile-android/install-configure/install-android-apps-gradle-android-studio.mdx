...
9. 数分待ち、[**概要**ページ](/docs/mobile-monitoring/mobile-monitoring-ui/mobile-app-pages/mobile-apps-overview-page)からAndroidアプリのデータを表示します。**[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Mobile >（select an app）**の順に移動します。
