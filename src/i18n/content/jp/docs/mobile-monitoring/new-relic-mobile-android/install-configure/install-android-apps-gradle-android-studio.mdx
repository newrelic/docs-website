...
Gradle構築の間のモバイルモニタリングエージェントプラグインの動作の設定方法の詳細は、[New Relic Gradleプラグイン](https://docs.newrelic.com/docs/mobile-monitoring/new-relic-mobile-android/install-configure/configure-new-relic-gradle-plugin)拡張ガイドを参照してください。