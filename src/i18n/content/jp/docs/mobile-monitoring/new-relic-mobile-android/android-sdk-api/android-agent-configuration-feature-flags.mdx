...
<CollapserGroup>
  ...
  >
    遅延クラッシュ レポートを有効または無効にします。

    [遅延クラッシュ レポート](/docs/mobile-monitoring/new-relic-mobile-android/install-configure/android-agent-crash-reporting/#deferred-crash-reporting)の詳細については、遅延クラッシュ レポートを参照してください。
...
<CollapserGroup>
  ...
  >
    アプリの起動時間 (コールド時間とホット時間) の[メトリック](https://docs.newrelic.com/docs/data-apis/understand-data/new-relic-data-types/#metrics)へのレポートを有効または無効にします
    ...
    * ホット スタート時間とは、アプリのプロセスがバックグラウンドで既に実行されている時間を指します。
      ...
      Android エージェント バージョン 6.9.0 以降で使用できます。
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              エージェント バージョン 6.9.0 以降、デフォルトで有効
            </td>
          </tr>
        </tbody>
      </table>
...
<CollapserGroup>
  ...
  >
    ...
    Android エージェント バージョン 6.11.0 以降で利用できます。
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            エージェント バージョン 6.11.0 以降、オンデマンドで有効化
          </td>
        </tr>
      </tbody>
    </table>
