...
2. **[one.newrelic.com](https://one.newrelic.com/all-capabilities)**にアクセスし、\[**データを追加**] をクリックし、Android の手順に従います。
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [`withLaunchActivityName`](/docs/mobile-monitoring/new-relic-mobile-android/android-sdk-api/with-launch-activity-name)を参照してください。
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        [`shutdown`](/docs/mobile-monitoring/new-relic-mobile-android/android-sdk-api/shut-down)を参照してください。
      </td>
    </tr>
  </tbody>
</table>
