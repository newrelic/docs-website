...
ニューレリックアンドロイド<InlinePopover type="mobile"/>エージェントは分散トレースをサポートします。これにより、モバイル アプリのアクティビティが関連サービスにどのように接続されているかを確認できます。
...
* クエリのヒント
  ...
  * 前の 2 つの条件を組み合わせて、モバイル スパンとバックエンド スパンの両方を含むトレースを照会します。
