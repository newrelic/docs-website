  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * <DNT>**Android agent version 6.0.0 through 6.5.0**</DNT> ではビルドを<DNT>**Android SDK Tools version 21 or higher**</DNT>でコンパイルする必要があります。
        * <DNT>**Android agent version 5.0.0 through 5.9.9**</DNT> ではビルドを<DNT>**Android SDK Tools version 14 or higher**</DNT>でコンパイルする必要があります。
...
<Callout variant="important">
  2021年1月時点で、当社のAndroidエージェントはAndroid Gradle Pluginバージョン2のサポートを中止しました。詳細については、[サポートフォーラムの投稿](https://support.newrelic.com/s/hubtopic/aAX8W0000008bKn/important-upcoming-changes-to-capabilities-across-browser-php-python-mobile)をご覧ください。
</Callout>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [7.7.0](/docs/release-notes/mobile-release-notes/android-release-notes/android-770)以降
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        * <DNT>**5.24 and lower:**</DNT> Kotlin Gradleプラグインのバージョン1.3.10以降が必要です
        * <DNT>**5.25:**</DNT> Kotlin Gradleプラグインのバージョン1.3.10以降が必要です
        * <DNT>**5.26:**</DNT> Androidエージェントのバージョン5.26.0～5.28.0ではサポートされていません
      </td>
    </tr>
...
<table id="Kotlin-DSL-support-by-Android-agent-version">
  ...
  <tbody>
    <tr>
      ...
      <td>
        * <DNT>**3.2 (AGP), 4.6 (Gradle) :**</DNT> Kotlin Gradleプラグインのバージョン1.3.10以降が必要です
        * <DNT>**3.3 (AGP), 5.1.1 (Gradle):**</DNT> Kotlin Gradleプラグインのバージョン1.3.10以降が必要です
        * <DNT>**3.4 (AGP), 5.1.1 (Gradle):**</DNT> Kotlin Gradleプラグインのバージョン1.3.10以降が必要です
        * <DNT>**3.5 (AGP), 5.4.1 (Gradle):**</DNT> Kotlin Gradleプラグインのバージョン1.3.10以降が必要です
        * <DNT>**3.6 (AGP), 5.6.4 (Gradle):**</DNT> Kotlin Gradleプラグインのバージョン1.3.40以降が必要です
        * <DNT>**4.0 (AGP), 6.1.1 (Gradle):**</DNT> Kotlin Gradleプラグインのバージョン1.3.40以降が必要です
        * <DNT>**4.1 (AGP), 6.5 (Gradle):**</DNT> Kotlin Gradleプラグインのバージョン1.3.40以降が必要です
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        * <DNT>**3.2 (AGP), 4.6 (Gradle) :**</DNT> Gradle 5.3が必要です
        * <DNT>**3.3 (AGP), 5.1.1 (Gradle):**</DNT> Gradle 5.3が必要です
        * <DNT>**3.4 (AGP), 5.1.1 (Gradle):**</DNT> サポート対象
        * <DNT>**3.5 (AGP), 5.4.1 (Gradle):**</DNT> サポート対象
        * <DNT>**3.6 (AGP), 5.6.4 (Gradle):**</DNT> サポート対象
        * <DNT>**4.0 (AGP), 6.1.1 (Gradle):**</DNT> サポート対象
        * <DNT>**4.1 (AGP), 6.5 (Gradle):**</DNT> サポート対象
      </td>
    </tr>
  </tbody>
</table>
