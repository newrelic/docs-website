  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        **Androidエージェントのバージョン7.0.0以降**では、以下が必要です。
        ...
        **Androidエージェントバージョン6.6.0以降**では、**Android SDK Toolsバージョン24以降**が必要です。Android SDK Toolsバージョン24以降では、以下の要件も満たす必要があります。
        ...
        * **Androidエージェントバージョン6.0.0〜6.5.0**では、ビルドを**Android SDK Toolsバージョン21以降**でコンパイルする必要があります。
        * **Androidエージェントバージョン5.0.0〜5.9.9**では、ビルドを**Android SDK Toolsバージョン14以降**でコンパイルする必要があります。
