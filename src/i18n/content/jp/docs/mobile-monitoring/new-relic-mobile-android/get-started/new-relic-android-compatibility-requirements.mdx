...
<InlinePopover type="mobile"/>の機能は、Google Play Store、Amazon Appstoreなどの標準的なアプリケーションストアに対応しています。Androidアプリケーションで、[モバイルエージェントをインストールして構成する](/docs/mobile-monitoring/new-relic-mobile-android/install-configure)前に、以下のガイドラインに従って互換性やその他の要件を確認してください。
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <Callout variant="important">
          AndroidHttpClientはバージョン23のSDKから削除されたため、Androidエージェントのバージョン6.5.0以前でのみサポートされています。
        </Callout>

        <DNT>**Android agent version 7.0.0 or higher**</DNT> が必要：

        * Android Studio Flamingo

        * Gradle 7.2

        * Android Gradleプラグイン 7.0.0

        * DexGuard 9.0以降

          <DNT>**Android agent version 6.6.0 or higher**</DNT> <DNT>**Android SDK Tools version 24 or higher**</DNT>が必要です。Android SDK Toolsバージョン24以降では、以下の要件も満たす必要があります。

        * Android Studio

        * Gradle 5.1.1

        * Android Gradleプラグイン 3.4

        * Proguard 5.0

        * DexGuard 8.0～9.x

          古いAndroidエージェントバージョンの場合、ビルドのAndroid SDK ToolsのバージョンはAndroidエージェントのバージョンと互換性がある必要があります。
        ...
        * <DNT>
          ...
          注：Androidエージェントをインストールする前に、SDKツールを最新バージョンにアップグレードしてください。
    ...
    <tr>
      ...
      <td>
        Java 1.7からJava 9。JDK 11はバージョン6.2.0以降でサポートされています。JDK 17はバージョン7.0.0以降でサポートされています。
      </td>
    </tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [7.0.0](/docs/release-notes/mobile-release-notes/android-release-notes/android-700)以降
      </td>
    </tr>
  </tbody>
</table>
...
上記の[Android Gradleプラグイン](#agent-gradle)とは互換性がありませんが、New RelicのAndroidエージェントはKotlin Gradleプラグインのバージョン<DNT>**1.3 - 1.4**</DNT>と互換性があります。
    ...
    <tr>
      ...
      <td>
        * <DNT>
          ...
          Kotlin Gradleプラグインのバージョン1.3.10以降が必要です
        ...
        * <DNT>
          ...
          Androidエージェントのバージョン5.26.0～5.28.0ではサポートされていません
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        * <DNT>
          ...
          Kotlin Gradleプラグインのバージョン1.3.40以降が必要です
