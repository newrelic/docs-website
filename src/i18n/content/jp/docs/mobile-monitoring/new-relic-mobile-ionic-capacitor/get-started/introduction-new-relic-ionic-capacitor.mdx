...
<CollapserGroup>
  ...
  >
    ...
    4. <DoNotTranslate>**Add to dashboard**</DoNotTranslate>クリックします。<img title="Query builder" alt="This is an image of a sample query in the Query builder." src={mobileQueryExample}/>
