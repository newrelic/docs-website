...
<CollapserGroup>
  ...
  >
    ...
    4. <DNT>**Add to dashboard**</DNT>クリックします。<img title="Query builder" alt="This is an image of a sample query in the Query builder." src="/images/mobile_screenshot-full_query-example.webp"/>
