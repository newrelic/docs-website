---
title: Cordova モバイル アプリケーションを監視する
tags:
  - Mobile monitoring
...
## Cordova エージェントをインストールする [#install]
...
<Steps>
  <Step>
    ...
    1. **[one.newrelic.com](https://onenr.io/02wdd6ngXwE) > Browser & Mobile > (Android または iOS を選択)**に移動し、UI でインストルメンテーションの手順を完了します。
