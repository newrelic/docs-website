...
<CollapserGroup>
  ...
  >
    ...
    4. <DoNotTranslate>**Add to dashboard**</DoNotTranslate>をクリックします。<img title="Query your data" alt="This is an image of a sample query in the Query builder." src={mobileQueryExample}/>
