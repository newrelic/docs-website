...
<Steps>
  ...
  <Step>
    ...
    <DNT>**Option 1: In the App Constructor**</DNT> You can call the tracking method directly in the constructor immediately after setting the `MainPage`.
