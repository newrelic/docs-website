...
2. モバイルアプリのバージョンや期間を選択するには、UIメニューバーの下にある **Versions** メニューと time picker を使用します。
...
* スロートランザクションのトレース詳細を表示するには（可能な場合）、そのリンクを選択します。詳細は、 [Interactions ページ](/docs/mobile-monitoring/mobile-monitoring-ui/mobile-app-pages/interactions-page/) を参照してください。
