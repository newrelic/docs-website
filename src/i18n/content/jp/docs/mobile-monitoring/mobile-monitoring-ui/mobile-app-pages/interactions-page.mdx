...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Mobile >** (アプリを選択) **> More views > Interactions**に移動します。
...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Mobile > (アプリを選択) > App > Interactions**に移動します。
2. **Slowest traces** の表から、トレースの **Activity** または **Duration** のリンクを選択します。

または

1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > モバイル > (アプリを選択) > アプリ > インタラクション > (インタラクションを選択) に移動し**ます。
