...
すべてのインストゥルメントで行われたメソッドの完全なリストを表示するには: 選択したインタラクションから、 **Breakdown table** \[内訳テーブル]リンクを選択します。 いずれかのメトリクスにカスタムインストゥルメンテーションを使用する場合、クラスとメソッド名のカテゴリには**custom**が表示されます。
...
* データのコンテキストを提供するには、 **Previous interaction** \[前のインタラクション]をクリックします。