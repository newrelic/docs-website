...
の<InlinePopover type="mobile"/>この機能には、昨年のアプリを実行しているデバイスの数を月ごとに追跡する棒グラフを含む月次レポートが含まれます。レポートを表示するには: **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities)> Mobile > (アプリを選択) > Usage > Monthly uniques**に移動します。
