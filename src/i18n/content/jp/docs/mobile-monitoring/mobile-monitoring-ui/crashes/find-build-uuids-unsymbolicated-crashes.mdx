...
2. <DNT>
     [**Crash list**](/docs/mobile-monitoring/mobile-monitoring-ui/crashes/view-mobile-app-crashes)
   </DNT>
...
3. 選択したクラッシュ レポートの
   ...
   <DNT>
     [**Crash Details**](/docs/mobile-monitoring/mobile-monitoring-ui/crashes/investigate-mobile-app-crash-report#viewing)
   </DNT>
