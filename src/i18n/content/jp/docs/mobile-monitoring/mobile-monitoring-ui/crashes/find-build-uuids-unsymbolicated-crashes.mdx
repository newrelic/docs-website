...
1. <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile**</DNT>
   ...
   <DNT>**Crashes > Crash Analysis**</DNT>

   をクリックします。

2. <DNT>[**Crash list**](/docs/mobile-monitoring/mobile-monitoring-ui/crashes/view-mobile-app-crashes)</DNT>

   [テーブル](/docs/mobile-monitoring/mobile-monitoring-ui/crashes/view-mobile-app-crashes)から任意の行を選択します。

3. 選択したクラッシュ レポートの

   <DNT>[**Crash Details**](/docs/mobile-monitoring/mobile-monitoring-ui/crashes/investigate-mobile-app-crash-report#viewing)</DNT>

   [ページ](/docs/mobile-monitoring/mobile-monitoring-ui/crashes/investigate-mobile-app-crash-report#viewing)で、属性リストの`App Image Uuid`を探します。
...
2. エクスポートされたクラッシュ レポートの

   <DNT>[**Binary images**](#binary-example)</DNT>

   [セクション](#binary-example)でビルド UUID を探します。
