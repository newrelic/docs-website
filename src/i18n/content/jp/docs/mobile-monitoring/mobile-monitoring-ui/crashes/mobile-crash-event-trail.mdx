...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Mobile > (モバイルアプリを選択) > Crash analysis > (クラッシュの種類をクリック) > (イベントトレイルまでスクロールダウン):** クラッシュイベントトレイルには、モバイルアプリのクラッシュに至るアクティビティが表示されます。
</figcaption>
