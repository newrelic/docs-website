...
* <DNT>**Banner notification**</DNT>

  :

  <DNT>[**Crash report**](/docs/mobile-monitoring/mobile-monitoring-ui/crashes/mobile-apps-crash-report-dashboard)</DNT>
...
* <DNT>**Upload prompt**</DNT>

  :

  <DNT>**Crash type summary**</DNT>

  ページでは、dSYM ファイルが見つからない場合、自動的にアップロードするように求められます。

* <DNT>**Machine code**</DNT>

  :

  <DNT>**Crash report**</DNT>
...
2. <DNT>**Crash analysis**</DNT>

   表示します。

3. <DNT>**Crash types**</DNT>

   リストから特定のクラッシュを選択します。

4. <DNT>**Upload dSYM**</DNT>
