...
* <DNT>
  ...
  [ページ](/docs/mobile-monitoring/mobile-monitoring-ui/crashes/mobile-apps-crash-report-dashboard)にバナー警告が表示されます。 警告には次のように書かれています。
...
* <DNT>
  ...
  ページでは、dSYM ファイルが見つからない場合、自動的にアップロードするように求められます。
...
* <DNT>
  ...
  ページのクラッシュ スタック トレースには、人間が判読できるエラー メッセージではなく、マシン コードが表示されます。
...
4. <DNT>
   ...
   クリックします。 dSYM を直接ドラッグ アンド ドロップするか、コンピューターからファイルを選択することができます。
