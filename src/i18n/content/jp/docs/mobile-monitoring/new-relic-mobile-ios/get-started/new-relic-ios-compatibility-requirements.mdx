...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        エージェントバージョン別のサポートされている最小iOSバージョン：

        * エージェントバージョン7.7.7以降：iOS 15.0以降
        * エージェントバージョン7.6.2～7.7.6：iOS 15.6以降
        * エージェントバージョン7.6.0および7.6.1：iOS 16以降
        * 7.6.0より前のエージェントバージョン：iOS 10以降、ただしiOS 15.0～15.5を除く

        <Callout variant="important">
          エージェントバージョン7.7.7以降のみが、iOS 15.0からiOS 15.5までをサポートしています。それ以前のすべてのエージェントバージョンは、これらのOSバージョンと完全に互換性がありません。アプリがこれらのいずれかをサポートしている場合は、エージェントバージョン7.7.7以降を使用してください。
        </Callout>
