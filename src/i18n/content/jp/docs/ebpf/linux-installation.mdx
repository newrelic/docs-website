    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            eBPF エージェントが使用するために必要な Linux ヘッダーがダウンロードされ配置されるディレクトリのパスを設定します。これは、エージェントが必要な Linux ヘッダーをダウンロードできない制限された環境で役立ちます。必要なヘッダーは、カーネル バージョンに基づいてエージェントによって識別されます。
          </td>
