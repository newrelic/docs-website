...
* データをレポートする先の New Relic アカウントの [ライセンス キー](/docs/apis/intro-apis/new-relic-api-keys/#license-key) を取得します。
...
* OTLP_ENDPOINT_HERE を適切な[endpoint](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/opentelemetry-setup#review-settings)に置き換えます。
* YOUR_KEY_HERE を [ライセンス キー](/docs/apis/intro-apis/new-relic-api-keys/#license-key)に置き換えます
