...
集約の一時性を構成する方法を理解するには、 [Java](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/opentelemetry-tutorial-java)および[Go](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/opentelemetry-tutorial-go) OpenTelemetry SDK を使用したこれらの例を参照してください。
