  ...
  <Step>
    ...
    * OpenTelemetry コレクターからのエクスポート:
    ...
    <CollapserGroup>
      ...
      >
        OTLP 標準では、gRPC トラフィックはポート `4317`に、HTTP トラフィックはポート `4318`に指定されています。New Relic US FedRamp ネイティブ OTLP エンドポイントは、これらの仕様に準拠しています。また、ポート `443`での gRPC トラフィックも許可されます。
      </Collapser>
