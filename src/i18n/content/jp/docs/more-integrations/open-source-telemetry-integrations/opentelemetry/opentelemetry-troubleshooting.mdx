...
ログ管理の場合、構造化ログ テンプレートを使用して`service.name`を挿入できます。例については[、「Log4j2 を使用したログ」を](https://github.com/newrelic/newrelic-opentelemetry-examples/blob/e3f5ee85b4dcd8dd29f8f69d78d122b82a9638ba/other-examples/java/logs-in-context-log4j2/Log4j2EventLayout.json#L2)参照してください。
