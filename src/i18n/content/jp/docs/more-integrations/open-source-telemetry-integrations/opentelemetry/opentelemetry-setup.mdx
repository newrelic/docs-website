...
サービスからテレメトリを収集するには、基本的な5段階のアプローチをお勧めします。
...
* [行け](https://github.com/open-telemetry/opentelemetry-go)
...
* [行け](https://pkg.go.dev/go.opentelemetry.io/otel/exporters/otlp)
...
* [。ネット](https://github.com/open-telemetry/opentelemetry-dotnet/tree/master/src/OpenTelemetry.Exporter.OpenTelemetryProtocol)
...
* [ルビー](https://github.com/open-telemetry/opentelemetry-ruby/tree/master/exporter/otlp)
