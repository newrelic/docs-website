...
[タグは、](/docs/new-relic-solutions/new-relic-one/core-concepts/use-tags-help-organize-find-your-data/)監視対象のアプリやホストなどのエンティティに追加できるキーと値のペアです。アカウント ID など、特定の重要なデータ属性はタグとして自動的に割り当てられます。独自の[カスタム タグ](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-best-practices-resources#tags)を追加することもできます。
