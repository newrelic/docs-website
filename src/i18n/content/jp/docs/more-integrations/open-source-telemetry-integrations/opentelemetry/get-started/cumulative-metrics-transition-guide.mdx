...
export const year = 2023 export const gaDate = 'April 4' export const eolDate = 'July 3' export const gaDateAndYear = gaDate + ', ' + year export const eolDateAndYear = eolDate + ', ' + year
