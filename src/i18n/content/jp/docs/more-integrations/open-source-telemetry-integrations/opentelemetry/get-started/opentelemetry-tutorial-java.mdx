...
1. 左ペインの **\[モニター]** セクションで、 **\[分散トレース]**をクリックし、 **\[フィボナッチ]**
   ...
   <img alt="Screenshot showing the main distributed tracing page" title="Screenshot showing the main distributed tracing page" src={opentelemetryMainDistributedTracingPage}> トレース グループをクリックします。</img>
