...
**トランザクション **ビューを強化するには、[メトリクスまたはスパンの使用を選択](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/view-your-data/opentelemetry-find-entities/#metric-span-toggle)することができます。
