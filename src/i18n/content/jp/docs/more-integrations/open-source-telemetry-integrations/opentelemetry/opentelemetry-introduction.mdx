...
New RelicとOpenTelemetryの両方のインストルメンテーションを検討することをお勧めします。また、 [CNCF Slackチャネル＃otel-newrelic](https://cloud-native.slack.com/archives/C024DRQ63UP)でこれについて話し合い、最適なものを決定することを歓迎します。[ここで最初にCNCFのSlackアカウントにサインアップする](https://slack.cncf.io/)必要があるかもしれません。
