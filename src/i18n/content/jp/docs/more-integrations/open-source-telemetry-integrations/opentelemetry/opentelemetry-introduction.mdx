...
New Relic と OpenTelemetry インストルメンテーションの両方を調べることをお勧めします。このセクションの情報には、考慮すべき幅広い概念が含まれています。違いを詳しく調べたい場合は、 [詳細な比較](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/opentelemetry-comparison)を参照してください。また、 [CNCF の Slack チャンネル #otel-newrelic で](https://cloud-native.slack.com/archives/C024DRQ63UP)これについて話し合って、自分に最適なものを決定してください。最初[にここで CNCF の Slack アカウントにサインアップする](https://slack.cncf.io/)必要がある場合があります。
