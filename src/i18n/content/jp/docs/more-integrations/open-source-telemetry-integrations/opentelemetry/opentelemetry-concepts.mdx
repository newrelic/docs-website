...
<CollapserGroup>
  ...
  >
    ...
    <img
      ...
      title="ゲージとして累積和を照会する方法を示すスクリーンショット"
      alt="ゲージとして累積和を照会する方法を示すスクリーンショット"
    />
  </Collapser>
  ...
  >
    ...
    <img
      ...
      title="累積和の一定期間における変化率を示すスクリーンショット"
      alt="累積和の一定期間における変化率を示すスクリーンショット"
    />
...
<CollapserGroup>
  ...
  >
    ...
    <img
      src={histogram1}
      title="ヒストグラム・クエリのスクリーンショット"
      alt="ヒストグラム・クエリのスクリーンショット"
    />
  </Collapser>
  ...
  >
    ...
    <img
      src={histogram2}
      title="ヒートマップを示すスクリーンショット"
      alt="ヒートマップを示すスクリーンショット"
    />
  </Collapser>
</CollapserGroup>
