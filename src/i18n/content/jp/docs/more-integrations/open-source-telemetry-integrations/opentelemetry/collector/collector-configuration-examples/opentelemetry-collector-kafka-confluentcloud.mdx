...
* [クラウド API キー](https://docs.confluent.io/cloud/current/access-management/authenticate/api-keys/api-keys.html#cloud-cloud-api-keys)
...
これらのメトリクスを使用するこの New Relic[サンプル ダッシュボード](./dashboard.json)を確認してください。
