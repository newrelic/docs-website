...
* [サービスのOpenTelemetryセットアップ：](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/opentelemetry-setup#collector-export)これらの手順では、インストルメンテーションを開始してから、トピック[「基本的なコレクターの例](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/collector/opentelemetry-collector-basic)」に進みます。
* [ホスト監視用のコレクター：](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/collector/opentelemetry-collector-infra-hosts)これは、ホストを監視するためのコレクター構成について説明しています。
* [一般的なコレクター構成：](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/collector/opentelemetry-collector-configs)これでは、さまざまなコレクター設定について説明します。