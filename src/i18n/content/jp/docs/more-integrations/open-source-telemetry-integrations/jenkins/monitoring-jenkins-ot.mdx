...
Jenkins OpenTelemetry プラグインを構成して New Relic にデータを送信するには、New Relic [OTLP エンドポイント](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/opentelemetry-setup/#note-endpoints)と<LicenseKey/>が必要です。
