...
Jenkins OpenTelemetry プラグインを設定して New Relic にデータを送信するには、New Relic [OTLP エンドポイント](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/opentelemetry-setup/#note-endpoints) と [ライセンス キー](/docs/apis/intro-apis/new-relic-api-keys/#license-key) が必要です。
