...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        2.10.x、2.11.x、2.12.x、2.13.x、3.x、および 4.x
      </td>
    </tr>
...
3. Ops Manager の左側のナビゲーション ビューで、アップロードされた製品説明の横にある**+**記号または**Add next** \[追加]をクリックして、この製品をステージング領域に追加します。
...
2. **Import a Product** \[製品のインポート]をクリックし、New Relic Service Broker for VMware Tanzu タイルをインポートします。
...
3. アップロードした「New Relic Service Broker」の右にある**+**ボタンをクリックします。
...
16. アプリケーションを再ステージングします。バインド ページの上部にあるリンク、またはターミナル ウィンドウでリンクを選択し、cf restage を実行して変更を加えることができます。
