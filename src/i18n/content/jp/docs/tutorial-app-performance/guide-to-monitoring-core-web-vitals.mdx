...
## New Relic で Web の重要な要素を見つける [#find]
...
このチュートリアルでは、コア Web Vitals で実行できるいくつかのアクションについて説明しました。次のステップにはいくつかのオプションがあります。

* **Web Vitals**でデータが欠落していることに気付いた場合は、 [Web Vitals ページの欠落データ](/docs/browser/new-relic-browser/troubleshooting/missing-data-on-web-vitals-page) に関するいくつかの解決策を確認してください。
* コア Web バイタルをさらに詳しく知りたい場合は、無料の [マイペース コア Web バイタル トレーニング コース](https://learn.newrelic.com/self-paced-core-web-vitals/)でさらに学習できます。

コア Web バイタルはサイトを改善するための重要なリソースですが、ユーザー エクスペリエンスの低下の原因についてさらに詳しく知ることができます。
