...
<Steps>
  ...
  <Step>
    ...
    <SideBySide>
      <Side>
        JavaScript エラーは、サイトに多くの問題を引き起こす可能性があり、そのいずれかが顧客のフロントエンド エクスペリエンスに悪影響を及ぼす可能性があります。ニューレリック <InlinePopover type="browser"/>統合アプリの **JS errors**\[JS エラー] ページを備えています。
...
* [私のアプリはチュートリアルが遅いです](/docs/journey-app-slow/root-causes/)。
