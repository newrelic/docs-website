...
<CollapserGroup>
  ...
  <Collapser id="see-my-application" title="IAST に自分のアプリケーションが表示されません">
    ...
    * プロキシまたはファイアウォールがアクセスをブロックしています。 ドメイン<DNT>**csec.nr-data.net**</DNT>の次の IP `18.188.255.152, 18.116.243.59, 18.219.12.171` 、ドメイン<DNT>**csec-gov.nr-data.net**</DNT>の次の IP `3.13.224.132, 18.218.78.150, 13.58.129.59` 、ドメイン<DNT>**csec.eu01.nr-data.net**</DNT>の次の IP `3.122.48.53, 63.176.82.192, 3.123.117.125`をホワイトリストに追加します。 ただし、IP はいつでも変更される可能性があるため、IP ではなくドメインをホワイトリストに追加することをお勧めします。
