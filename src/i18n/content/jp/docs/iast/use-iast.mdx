...
5. さらに、アプリケーション ウィンドウの**Application coverag** \[アプリケーション カバレッジ]タブで、アプリケーションの各部分がどの程度脆弱であるかを確認します。<img title="Vulnerability coverage of your application." alt="Vulnerability coverage of your application." src={iastAppCoverage}/>
