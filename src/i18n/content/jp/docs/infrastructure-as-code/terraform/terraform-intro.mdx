...
<Steps>
  <Step>
    ...
    次に、 <DoNotTranslate>**main.tf**</DoNotTranslate>の`terraform`ブロックと`required_providers`ブロックを設定して、Terraform に New Relic プロバイダーをインストールして使用するように指示します。
  ...
  <Step>
    ...
    <DoNotTranslate>**main.tf**</DoNotTranslate>で、プロバイダーに次の値を設定します。
  ...
  <Step>
    ...
    [New Relic にログインし](https://login.newrelic.com/login)、 [<DoNotTranslate>**Alert Policies**</DoNotTranslate>に移動して](/docs/alerts-applied-intelligence/new-relic-alerts/alert-policies/create-edit-or-find-alert-policy#alert-policy-view)、Terraform によって新しいポリシーが作成されたことを確認します。
