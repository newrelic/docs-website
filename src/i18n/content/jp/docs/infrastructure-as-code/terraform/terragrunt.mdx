...
[Terraform は](https://www.terraform.io/)、HashiCorp によって構築された、人気のインフラストラクチャ・アズ・コード ソフトウェア ツールです。 これを使用して、New Relic <InlinePopover type="dashboards"/>やアラートを含むあらゆる種類のインフラストラクチャとサービスをプロビジョニングします。
