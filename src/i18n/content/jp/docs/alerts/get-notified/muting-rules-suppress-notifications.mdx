...
計画メンテナンスなどのミュート ルールがアクティブな場合、インシデントがトリガーされても通知は受信されません。

ミュート ルールがアクティブでなくなった場合は、次のオプションがあります。

* <DNT>**Close ongoing incidents**</DNT>: つまり、ミュート ルールの有効期限が切れた直後または無効になった直後にインシデントがトリガーされたり、まだ開いている場合は、通知が届きます。 このデフォルト設定を維持することをお勧めします。

* <DNT>**Continue ongoing incidents**</DNT>: つまり、ミュート ウィンドウ中に開始されたインシデントが、ミュート ルールが非アクティブになった後も継続する場合、通知は行われません。

<img title="How to suppress notifications" alt="How to suppress notifications" src="/images/alerts_screenshot-crop_suppress-notifications.webp" />
