...
ミュート ルールを作成、有効化、無効化、管理できます。 <DNT>**[one.newrelic.com &gt; All capabilities](https://one.newrelic.com/all-capabilities) &amp;gt; Alerts &amp;gt; Muting rules**</DNT>に移動します。 ミュート ルールはいつでも有効または無効にできます。 クリック<Icon name="fe-more-horizontal" />各ルールの行にあるアイコンをクリックして、ルールを編集および削除します。
...
* `IS_ANY`: <DNT>**Caution:**</DNT>この演算子を含む条件により、アカウント上の<DNT>**all**</DNT>のインシデントがミュートされます。
