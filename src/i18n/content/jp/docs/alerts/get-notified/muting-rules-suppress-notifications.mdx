...
アラートは、システムに問題が発生した場合にタイムリーに通知を送信します。 時々、見る必要がない通知が表示されることがあります。 <DNT>**muting rules**</DNT>を使用すると、注意する必要のないメッセージが大量に届くのを防ぐことができます。
...
ミュート ルールを作成、有効化、無効化、および管理できます。 <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Muting rules**</DNT>に移動します。 ミュート ルールはいつでも有効または無効にできます。 クリック<Icon name="fe-more-horizontal"/>各ルールの行にあるアイコンをクリックして、ルールを編集および削除します。
...
<figcaption>
  <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Muting rules**</DNT>: 複雑なミュート ルールを作成して、小規模または大規模な一連の不要な通知を対象にすることができます。
</figcaption>
...
<figcaption>
  <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Muting rules**</DNT>: ミュート ルールをスケジュールするための柔軟で強力なオプション。
</figcaption>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        <DNT>**is**</DNT>がミュートしたインシデントにより問題がアクティブ化されました
      </td>
...
<CollapserGroup>
  ...
  >
    ...
    <figcaption>
      <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Issues**</DNT>に移動して、ミュートされた問題をクリックします。
    </figcaption>
  </Collapser>
