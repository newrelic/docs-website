...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Destinations**</DoNotTranslate>に移動します。 通知の送信先を選択するには、送信先を使用します。
</figcaption>
...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Destinations**</DoNotTranslate>に移動します。 <DoNotTranslate>**Destinations**</DoNotTranslate>タブをクリックして宛先テーブルを表示します。
</figcaption>
