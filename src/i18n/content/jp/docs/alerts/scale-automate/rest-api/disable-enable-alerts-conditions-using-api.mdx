...
* 条件の`id` ( [API エクスプローラーから入手可能:](https://rpm.newrelic.com/api/explore/alerts_condition/list)
...
1. 更新するポリシーの<DoNotTranslate>**policy_id**</DoNotTranslate>を取得します。 `Logjam Alert`という名前の架空のポリシーの場合、コマンドは次のようになります。
