...
3. ポリシーに関連する条件のリストを取得し、該当するカテゴリーの中から変更したいものを選択します。
   ...
   * [<InlinePopover type="apm" />、 <InlinePopover type="browser" />、および<InlinePopover type="mobile" />](/docs/alerts/new-relic-alerts/rest-api-alerts/rest-api-calls-new-relic-alerts#conditions)
