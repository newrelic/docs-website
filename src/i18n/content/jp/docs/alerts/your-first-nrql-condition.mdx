  ...
  <Step>
    ...
    <CollapserGroup>
      ...
      <Collapser
        ...
        title="静的しきい値"
      >
        異常 閾値とは異なり、静的閾値はデータセット全体を参照せず、システムの履歴に基づいて異常な動作を判断します。 代わりに、静的閾値は、システムが<DNT>**you set**</DNT>の基準とは異なる動作をするたびにインシデントを開きます。 静的集計閾値はカスタマイズ性が非常に高く、データと探しているものが明確である場合に推奨されます。
