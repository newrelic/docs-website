...
1. <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert Conditions**</DoNotTranslate>に移動します。

2. <DoNotTranslate>**+ New alert condition > Use guided mode**</DoNotTranslate> (またはより高度なクエリ モード) をクリックします。
