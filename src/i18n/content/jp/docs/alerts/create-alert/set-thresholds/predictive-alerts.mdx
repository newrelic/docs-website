...
<DNT>**Predictive Alerts**</DNT> すべての顧客のすべての[<DNT>Full platform users</DNT>](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type/#user-type-capabilities)が利用できます。[<DNT>Data + User</DNT>](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing/)価格モデルをご利用の場合は、追加費用はかかりません。[<DNT>Data + Core Compute</DNT>](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing/)価格モデルをご利用の場合は、履歴データが分析され、予測が生成される際に、[Core CCU](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing/#core-compute-capacity-unit)が消費されます。
