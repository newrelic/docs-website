    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            オプション。優先度が「重大」のインシデントを開き、ポリシーの[問題作成の設定](/docs/alerts/new-relic-alerts/configuring-alert-policies/specify-when-new-relic-creates-incidents)と構成した[ワークフロー](/docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows/)に応じて通知を送信します。
          </td>
        </tr>
