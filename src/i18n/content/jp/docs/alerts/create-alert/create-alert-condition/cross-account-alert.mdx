...
* アクセス権のある複数のアカウントにわたってアラートを**管理し**、関連するすべてのイベントと問題を統合して表示できるようにします。
...
<Steps>
  ...
  <Step>
    左側のナビゲーションメニューで、 <DNT>**Configure &gt; Settings**</DNT>
  </Step>
...
* クロスアカウント条件に関連する問題と集中イベント (シグナル、集中イベント タイトルのファセット名など)。
