...
2. [条件](/docs/alerts/new-relic-alerts/configuring-alert-policies/define-alert-conditions)を作成するとき（手順 2）、
   ...
   <DNT>[**APM**](/docs/alerts/new-relic-alerts/configuring-alert-policies/select-product-targets-alert-condition)</DNT>

   を選択します。

3. 条件のタイプとして

   <DNT>**Application metric**</DNT>

   を選択します。

4. アプリの選択されたインスタンスごとに集計閾値インシデント

   <DNT>**individually**</DNT>

   を評価するには、

   <DNT>**Scope to Java application instances**</DNT>

   を選択します。

5. <DNT>**Next, select entities**</DNT>
...
7. <DNT>**By condition**</DNT>

   または

   <DNT>**By condition and signal**</DNT>
...
* [`condition_id`](/docs/using-new-relic/welcome-new-relic/get-started/glossary#alert-condition) (API エクスプローラーから入手可能:
  ...
  <DNT>[**Alerts Conditions > GET > List**](https://rpm.newrelic.com/api/explore/alerts_entity_conditions/list)</DNT>
