...
* [`condition_id`](/docs/using-new-relic/welcome-new-relic/get-started/glossary#alert-condition)（APIエクスプローラー：[<DNT>**Alerts Conditions &gt; GET &gt; List**</DNT>](https://api.newrelic.com/docs/#/Alerts%20Entity%20Conditions)から入手可能）
