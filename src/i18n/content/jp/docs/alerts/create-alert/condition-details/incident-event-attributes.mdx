  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        NRQL またはインフラストラクチャ条件のみ。 アラート条件の[タイトル](docs/alerts/create-alert/condition-details/title-template)または[説明テンプレート](/docs/alerts/create-alert/condition-details/alert-custom-incident-descriptions)では使用できません。
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        インシデントの一意の識別子。 アラート条件の[タイトル](docs/alerts/create-alert/condition-details/title-template)または[説明テンプレート](/docs/alerts/create-alert/condition-details/alert-custom-incident-descriptions)では使用できません。
      </td>
    </tr>
