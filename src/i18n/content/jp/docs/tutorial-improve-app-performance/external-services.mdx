...
<Steps>
  ...
  <Step>
    ...
    3. 2 つのサービス間のトランザクションの内訳を表示します。<img title="Screenshot showing calls to various endpoints in downstream service" alt="Screenshot showing calls to various endpoints in downstream service" src="/images/apm_screenshot-crop_external-services-downstream.webp"/>
    ...
    6. ドリルダウンで分散トレースを表示したい箇所に到達したら、右上の**List** \[リスト]をクリックし、表内の**Traces** \[トレース]をクリックします。<img title="Screenshot showing the trace link in the table view" alt="Screenshot showing the trace link in the table view" src="/images/apm_screenshot-crop_external-services-link-table.webp"/>
