...
<Steps>
  ...
  <Step>
    ...
    3. 2 つのサービス間のトランザクションの内訳を表示します。<img
    ...
    4. 特定のトランザクションに最も時間がかかっていると判断した場合は、そのトランザクションをクリックして、特にその依存関係に注目します。<img
    ...
    6. ドリルダウンで分散トレースを表示したい箇所に到達したら、右上の**List** \[リスト]をクリックし、表内の**Traces** \[トレース]をクリックします。<img
