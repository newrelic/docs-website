...
<CollapserGroup>
  ...
  >
    ...
    <CollapserGroup>
      ...
      >
        ...
        ![crop-apdex-function](./image/screen-apdex-function.png "crop-apdex-function")
  ...
  >
    ...
    <CollapserGroup>
      <Collapser title="オファーコードを使用した購入を分析する">
        ...
        ![Insightsフィルタのスクリーンショット](./image/screenshot_insights_filter_0_0.png "Insightsフィルタのスクリーンショット")
  ...
  >
    ...
    ![percentile.png](./image/percentile_0.png "percentile.png")
