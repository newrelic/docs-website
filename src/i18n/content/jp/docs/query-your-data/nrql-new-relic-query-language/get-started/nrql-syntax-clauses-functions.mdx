  ...
  >
    ...
    <CollapserGroup>
      ...
      >
        ...
        ![crop-apdex-function](src/images/screen-apdex-function.png "crop-apdex-function")
...
>
  ...
  >
    ...
    ![percentile.png](src/images/percentile_0.png "percentile.png")
  ...
  >
    ...
    <CollapserGroup>
      <Collapser title="オファーコードを使用した購入を分析する">
        ...
        ![Insightsフィルターのスクリーンショット](src/images/screenshot_insights_filter_0_0.png "Insightsフィルターのスクリーンショット")
