...
サブクエリが返すことができる結果の最大数は、 [`LIMIT MAX`の値](/docs/query-your-data/nrql-new-relic-query-language/get-started/nrql-syntax-clauses-functions/#sel-limit)と同じ : 5,000 です。その制限を超えると、結果が不完全になり、次のエラー メッセージが表示される場合があります。
