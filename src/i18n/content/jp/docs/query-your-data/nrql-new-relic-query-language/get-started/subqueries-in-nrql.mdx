...
サブクエリの時間範囲は、 [`SINCE`](/docs/query-your-data/nrql-new-relic-query-language/get-started/nrql-syntax-clauses-functions/#sel-since) / [`UNTIL`](/docs/query-your-data/nrql-new-relic-query-language/get-started/nrql-syntax-clauses-functions/#sel-until)で明示的に指定されていない限り、外側のクエリと同じになります。
...
サブクエリが返すことができる結果の最大数は、 [`LIMIT MAX`値](/docs/query-your-data/nrql-new-relic-query-language/get-started/nrql-syntax-clauses-functions/#sel-limit)と同じ : 2,000 です。
