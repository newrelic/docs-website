...
![New Relic チャートを表示 NRQL クエリ](https://jajp-newrelic-docs.onelink-translations.com/sites/default/files/thumbnails/image/new-relic-view-chart-nrql-query_0.png "new-relic-view-chart-nrql-query.png")
...
* [New Relic Insights](https://jajp-newrelic-docs.onelink-translations.com/docs/insights)
* [NerdGraph](/docs/apis/graphql-api/tutorials/nerdgraph-graphiql-nrql-tutorial): 当社のGraphQLフォーマットのAPIで、NRQLクエリ作成のオプションを含みます

![nrql_example.png](https://jajp-newrelic-docs.onelink-translations.com/sites/default/files/thumbnails/image/nrql_example.png "nrql_example.png")
...
* 次のものを含む、すべてのNew Relic製品からの[イベントデータ](/docs/using-new-relic/data/understand-data/new-relic-data-types#event-data):
  ...
  * `PageView`などの[ブラウザ監視イベント](/docs/insights/insights-data-sources/default-data/browser-default-events-insights)
  * `Mobile`などの[モバイル監視イベント](/docs/insights/insights-data-sources/default-data/mobile-default-events-insights)
...
![nrql_query01.png](https://jajp-newrelic-docs.onelink-translations.com/sites/default/files/thumbnails/image/nrql_query01.png "nrql_query01.png")
...
![nrql_query02.png](https://jajp-newrelic-docs.onelink-translations.com/sites/default/files/thumbnails/image/nrql_query02.png "nrql_query02.png")
...
![nrql_example.png](https://jajp-newrelic-docs.onelink-translations.com/sites/default/files/thumbnails/image/nrql_example_0.png "nrql_example.png")
