...
* [NRQLベースのアラート](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/nrql-alert-conditions)（主要で最も強力なアラートタイプ）の設定
...
<CollapserGroup>
  ...
  >
    ...
    <figcaption>
      **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > All capabilities > Query your data**
    </figcaption>
  ...
  >
    ...
    NRQLを使用すると、当社の主要かつ最も強力なアラートタイプである[NRQLベースのアラート](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/nrql-alert-conditions/)を構築できます。これにより、タイムリーに問題を通知し、対処できるようになります。
  </Collapser>
