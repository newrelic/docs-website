...
* [New Relicクエリビルダー](/docs/chart-builder/use-chart-builder/get-started/introduction-chart-builder)
* [NRQLベースのアラート](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-nrql-alert-conditions/)を作成する場合
* [NerdGraph](/docs/apis/graphql-api/tutorials/nerdgraph-graphiql-nrql-tutorial)：当社のAPIはデータのクエリにNRQLを使用
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Query your data**：[プラットフォームUI](/docs/new-relic-one/use-new-relic-one/get-started/introduction-new-relic-one)でNRQLクエリを実行できます。このNRQLクエリには、エンティティ名別にファセットした[ディストリビューティッド（分散）トレーシング](/docs/understand-dependencies/distributed-tracing/get-started/introduction-distributed-tracing)スパンの数が表示されます。
</figcaption>
