...
ファネルクエリには、ファネルの[属性](https://docs.newrelic.co.jp/docs/using-new-relic/welcome-new-relic/get-started/glossary#attribute)である[`funnel`関数](/docs/query-data/nrql-new-relic-query-language/getting-started/nrql-syntax-components-functions#func-funnel)と、少なくとも2つのステップが必要となります：
