...
<Callout variant="tip">
  スライドウィンドウは、条件 [アドバンスドシグナル設定](/docs/alerts-applied-intelligence/new-relic-alerts/advanced-alerts/understand-technical-concepts/streaming-alerts-key-terms-concepts/#advanced-signal) のUIからも利用可能です。
</Callout>
