...
<Callout variant="tip">
  スライドウィンドウは、条件 [アドバンスドシグナル設定](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/streaming-alerts-key-terms-concepts/#advanced-signal) のUIからも利用可能です。
</Callout>
