...
import chartBillboard from 'images/chart_billboard.png'
...
<CollapserGroup>
  ...
  >
    ...
    <img
      title="平均CPU使用率を示す面グラフタイプの例。"
      alt="平均CPU使用率を示す面グラフタイプの例のスクリーンショット。"
      src={chartArea}
    />
  ...
  >
    ...
    <img
      title="ブラウザの使用状況の比較を示すバーチャートの例。"
      alt="ブラウザの使用状況の比較を示すバーチャートの例のスクリーンショット。"
      src={chartBar}
    />
  ...
  >
    ...
    <img
      title="総セッション数を示すビルボードチャートの例。"
      alt="総セッション数を示すビルボードチャートの例のスクリーンショット。"
      src={chartBillboard}
    />
  ...
  >
    ...
    <img
      title="ページビューの合計数のうち、一意のページビューの合計数を示すブレットチャートの例。"
      alt="ページビューの合計数のうち、一意のページビューの合計数を示すブレットチャートの例のスクリーンショット。"
      src={chartBullet}
    />
  ...
  >
    ...
    <img
      title="アカウントに登録し、機能比較ページを訪問し、アップグレードしたユーザーの数を表示するNRQLファネルクエリの例。"
      alt="アカウントに登録し、機能比較ページを訪問し、アップグレードしたユーザーの数を表示するNRQLファネルクエリの例のスクリーンショット。"
  ...
  >
    ...
    <img
      title="オペレーティングシステムごとのページビューの内訳を示すヒートマップ グラフの例のスクリーンショット。"
      alt="ページビューの内訳をオペレーティングシステムごとに示すヒートマップチャートの例のスクリーンショット。"
      src={chartHeatmap}
    />
  ...
  >
    <img
      title="経時的なページビューの期間を示すヒストグラムの例。"
      alt="経時的なページビュー期間を示すヒストグラムの例のスクリーンショット。"
  ...
  >
    ...
    <img
      title="経時的なページビュー数を示す折れ線グラフの例。"
      alt="経時的なページビュー数を示す折れ線グラフの例のスクリーンショット。"
      src={chartLine}
    />
