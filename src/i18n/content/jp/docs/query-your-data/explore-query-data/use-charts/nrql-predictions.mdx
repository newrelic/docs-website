...
<DNT>**NRQL predictions**</DNT> すべての顧客およびすべてのユーザーにご利用いただけます。NRQLクエリが`PREDICT`句を使用して実行されると、[Core CCU](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing/#core-compute-capacity-unit)が消費されます。
...
<CollapserGroup>
  ...
  >
    ...
    <figcaption>
      \{&lt;&gt;&lt;InlineCode&gt;BY&lt;/InlineCode&gt; キーワードを使用した予測の例。枠で囲まれた領域は、&lt;InlineCode&gt;BY&lt;/InlineCode&gt;キーワードによってチャートのどのセクションが影響を受けるかを示しています。&lt;/&gt;}
    </figcaption>
  </Collapser>
  ...
  >
    ...
    <figcaption>
      \{&lt;&gt;&lt;InlineCode&gt;USING&lt;/InlineCode&gt; キーワードを使用した予測の例。&lt;InlineCode&gt;USING&lt;/InlineCode&gt; キーワードは、トレーニングに使用されるデータ量に影響しますが、これはチャートには視覚化されません。&lt;/&gt;}
    </figcaption>
  </Collapser>
