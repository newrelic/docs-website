...
* **イベント**: ここでは、[イベント](https://docs.newrelic.co.jp/docs/using-new-relic/data/understand-data/new-relic-data-types)や[ログ](https://docs.newrelic.co.jp/docs/using-new-relic/data/understand-data/new-relic-data-types)、[トレースデータ](https://docs.newrelic.co.jp/docs/using-new-relic/data/understand-data/new-relic-data-types)を含む、当社のすべての[`メトリック`以外のタイプの](/docs/using-new-relic/data/understand-data/new-relic-data-types#dimensional-metrics)データを指します。
