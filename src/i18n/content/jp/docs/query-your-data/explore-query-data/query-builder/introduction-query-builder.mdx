...
<figcaption>
  <DNT>**[one.newrelic.com &gt; All capabilities](https://one.newrelic.com/all-capabilities) &amp;gt; Query your data**</DNT>: データのクエリを実行して、カスタム チャート、その他の視覚化、NRQL アラートを作成します。
</figcaption>
...
書き込みビルダーを見つけるには、 <DNT>**[one.newrelic.com &gt; All capabilities](https://one.newrelic.com/all-capabilities) &amp;gt; Query builder**</DNT>にアクセスしてください。
