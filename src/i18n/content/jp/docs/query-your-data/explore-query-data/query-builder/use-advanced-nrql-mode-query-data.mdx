...
基本モードのデータ指定がNRQLクエリでどうなるかを確認するには、基本ページの詳細（NRQL）![inline-advanced-nrql.png](https://jajp-newrelic-docs.onelink-translations.com/sites/default/files/thumbnails/image/inline-advanced-nrql_0.png "inline-advanced-nrql.png")リンクをクリックします。

![querybuilder05.png](https://jajp-newrelic-docs.onelink-translations.com/sites/default/files/styles/inline_660px/public/thumbnails/image/querybuilder05.png?itok=BZGJx8pQ "querybuilder05.png")
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        ![crop-prompt-nrql.png](https://jajp-newrelic-docs.onelink-translations.com/sites/default/files/thumbnails/image/crop-prompt-nrql.png "crop-prompt-nrql.png")
