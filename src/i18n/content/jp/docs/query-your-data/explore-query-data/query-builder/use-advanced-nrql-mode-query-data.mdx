...
基本モードのデータ指定がNRQLクエリでどうなるかを確認するには、基本ページの詳細（NRQL）![inline-advanced-nrql.png](./image/inline-advanced-nrql_0.png "inline-advanced-nrql.png")リンクをクリックします。

![querybuilder05.png](./image/querybuilder05.png "querybuilder05.png")
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        ![crop-prompt-nrql.png](./image/crop-prompt-nrql.png "crop-prompt-nrql.png")
