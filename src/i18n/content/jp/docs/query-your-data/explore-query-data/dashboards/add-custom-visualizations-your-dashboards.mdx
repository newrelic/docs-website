...
1. 右上の**[one.newrelic.com](https://one.newrelic.com)**から**Apps**ボタンをクリックし、 **Apps**ページで**Custom Visualizations**をクリックします。ヒント: \[**カスタム ビジュアライゼーション**] タイルが表示されない場合は、検索を使用して見つけてください。
