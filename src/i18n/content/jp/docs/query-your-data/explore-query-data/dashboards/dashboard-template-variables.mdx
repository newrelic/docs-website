...
右側に結果ウィジェットの例を示します。左側には`country`ドロップダウンがあります。<img title="Country template variable example" alt="Country template variable example" src="/images/dashboards_screenshot-crop_country-variable-example.webp"/>
