...
この機能の詳細については、[ファセットによるフィルタリングについてのサポートフォーラムの投稿](https://support.newrelic.com/s/hubtopic/aAX8W0000008aPj/facet-linking-in-new-relic-one-now-you-can-use-facets-to-filter-your-new-reli)を参照してください。
