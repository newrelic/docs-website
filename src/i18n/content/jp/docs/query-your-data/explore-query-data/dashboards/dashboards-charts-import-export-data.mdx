...
[メトリクスとイベント](/docs/query-your-data/explore-query-data/data-explorer/introduction-data-explorer)、および[クエリ ビルダー](/docs/introduction-chart-builder)機能から、任意のダッシュボードに新しいコンテンツを追加できます。
