...
tags:
  ...
  - Dashboards
metaDescription: 'Manage your dashboard: layout, export, night mode, create/edit/delete widgets.'
---
...
マークダウン要素から、右上隅にあるアクセスメニューにアクセスし、[編集または削除を行います](/docs/dashboards/new-relic-one-dashboards/manage-your-dashboard/add-custom-content-dashboard-using-markdown)。
