...
ダッシュボードをインストールすると、 <DoNotTranslate>**Lookout**</DoNotTranslate>ビューで取り込みパターンの概要を表示できます。 そこから、取り込み異常を検索するための NRQL クエリを作成できます。 たとえば、次の NRQL クエリは、過去 24 時間の`usageMetric`によるすべての取り込み異常に関する情報を提供します。
...
2. <DoNotTranslate>**Install this quickstart**</DoNotTranslate>を選択します。
...
4. <DoNotTranslate>**Done**</DoNotTranslate>を選択します。

5. クイックスタートのインストールが完了したら、 <DoNotTranslate>**Data governance entity breakdowns**</DoNotTranslate>ダッシュボードを開いてデータにアクセスします。
