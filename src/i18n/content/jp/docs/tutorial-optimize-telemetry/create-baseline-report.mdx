...
<Steps>
  <Step>
    ...
    2. ブラウザウィンドウの右上部分にある\[ <DNT>**Install this quickstart**</DNT>をクリックします。
    3. 該当する場合は、アカウント スイッチャーでプライマリ アカウントまたはトップレベル アカウントを選択します。
    4. <DNT>**Done**</DNT>をクリックします。
    5. クイックスタートのインストールが完了したら、 <DNT>**Data ingest governance baseline**</DNT>ダッシュボードを開きます。
  </Step>
  ...
  <Step>
    ...
    * 特定のサブアカウントまたはビジネスユニットに対する目標。
    ...
    1. ベースラインダッシュボードで、 <DNT>**+ Add widget**</DNT>を選択します。
    2. <DNT>**Add a chart**</DNT>を選択します。
    3. チャートが使用する NRQL クエリを入力します。
    4. <DNT>**Run**</DNT>を選択します。
    ...
    1. ベースライン ダッシュボードで、変更するグラフの<DNT>**...**</DNT>を選択します。
    2. <DNT>**Edit**</DNT>を選択します。
  ...
  <Step>
    ...
    2. <DNT>**Baseline report**</DNT>タブを選択します。
    3. <DNT>**Last 30 days**</DNT>テーブルで<DNT>**...**</DNT>を選択し、 <DNT>**Export as CSV**</DNT>を選択します。
