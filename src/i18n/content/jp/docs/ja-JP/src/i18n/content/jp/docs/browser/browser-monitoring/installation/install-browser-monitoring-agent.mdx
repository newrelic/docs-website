...
<Callout variant="important">
  下で説明する設定オプションはBrowserエージェントのみを参照するもので、New Relic[ユーザーロール](/docs/accounts/accounts-billing/new-relic-one-user-management/new-relic-one-user-model-understand-user-structure/#roles)および[エディション](https://newrelic.com/pricing)と混同してはなりません。
</Callout>
