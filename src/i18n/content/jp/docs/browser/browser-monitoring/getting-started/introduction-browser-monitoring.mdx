...
<img
  title="browser_intro.png"
  alt="browser_intro.png"
  src={browserIntro0}
/>
...
[`PageViewTiming`イベント](/attribute-dictionary/?event=PageViewTiming)は、その他のイベントに依存しない、よりリアルタイムの配信メカニズムを提供します。追加のメトリクスには次のものがあります。
