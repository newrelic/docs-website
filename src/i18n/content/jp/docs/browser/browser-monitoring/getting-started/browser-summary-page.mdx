...
ザ<img title="view_synthetic_monitors" alt="View Synthetics monitors button" src={viewSyntheticMonitors}/>

ボタンを押すと、 **ページに** します。 Syntheticsの詳細については、 [](docs/synthetics)を参照してください。