...
<img
  title="ブラウザモニタリングのサマリーページのスクリーンショット"
  alt="ブラウザモニタリングのサマリーページのスクリーンショット"
...
<img title="合成モニターの表示" alt="Syntheticsのモニターを見るボタン" src={viewSyntheticMonitors}/> ボタンをクリックすると、 **Synthetics** のページに移動します。Syntheticsについての詳細は、 [Synthetic monitoring](docs/synthetics) をご覧ください。
