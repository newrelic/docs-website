...
<DNT>**[one.newrelic.com &gt; All Capabilities](https://one.newrelic.com/all-capabilities) &amp;gt; Browser**</DNT>（ browserアプリを選択）&amp;gt; <DNT>**Application settings**</DNT> に移動します。 このページで、 <DNT>**Pro**</DNT>または<DNT>**Pro + SPA**</DNT> BrowserAgent が選択されていることを確認します。
