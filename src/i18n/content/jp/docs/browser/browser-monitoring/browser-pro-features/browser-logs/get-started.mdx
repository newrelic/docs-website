...
<Steps>
  ...
  <Step>
    **Automatically collect console logs** \[コンソール ログを自動的に収集する]を**ON**に切り替えます。
  </Step>
  ...
  <Step>
    必要な詳細レベルを**ON**に切り替えます。デフォルトの詳細レベルは**WARN**に設定されています。選択できるレベル:
...
<Steps>
  ...
  <Step>
    **Automatically collect console logs** \[コンソール ログを自動的に収集するを]**OFF**に切り替えます。
  </Step>
</Steps>
