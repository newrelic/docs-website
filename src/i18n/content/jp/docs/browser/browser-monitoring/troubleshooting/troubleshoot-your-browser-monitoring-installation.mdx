...
<CollapserGroup>
  ...
  >
    ...
    * <DNT>**Go**</DNT>: 該当なし
    * <DNT>**Java**</DNT>: `</body>`タグの前 (欠落している場合はページに追加する必要があります)
    * <DNT>**.NET**</DNT>: 最初のスクリプト要素の直前
    * <DNT>**Node.js**</DNT>: 最初のスクリプト要素の直前
    * <DNT>**PHP**</DNT>: body要素の末尾
    * <DNT>**Python**</DNT>: ヘッド要素内またはボディ要素の末尾
    * <DNT>**Ruby**</DNT>: 最初のスクリプト要素の直前
