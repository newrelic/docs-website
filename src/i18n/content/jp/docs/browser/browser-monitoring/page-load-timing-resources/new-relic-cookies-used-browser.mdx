  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        [Browseragent v1169](/docs/release-notes/new-relic-browser-release-notes/browser-agent-release-notes/browser-agent-v1169) [`JSESSIONID`](#jsessionid)[`NREUM`](#nreum)browserのリリースにより、<DNT>**Application settings**</DNT> New RelicUIの ページを使用して、 アプリの Cookie 収集 ( および ) をオフにできるようになりました。この構成値を false (オフ) に設定すると、イベント データにセッション情報が表示されなくなります。
