...
私たちの<InlinePopover type="browser"/>監視対象サイトの各ページのヘッド セクションに小さな「ローダー」スクリプトを配置します。この JavaScript インストルメンテーションは次の目的で設計されています。
...
* [問題のあるJavaScriptのエラー](/docs/errors-inbox/browser-tab)
