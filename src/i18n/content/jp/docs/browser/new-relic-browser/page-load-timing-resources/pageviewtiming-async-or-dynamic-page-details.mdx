...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        このメトリクスは現在、14.1 (デスクトップ) または 14.5 (iOS) 未満の Safari を除く、ほとんどの最新のブラウザー バージョンでサポートされています。[MDN ドキュメントによる互換性マトリックス](https://developer.mozilla.org/en-US/docs/Web/API/Document/visibilitychange_event#browser_compatibility)。
      </td>
    </tr>
