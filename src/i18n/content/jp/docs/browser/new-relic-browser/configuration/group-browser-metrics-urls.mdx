...
私たちの<InlinePopover type="browser"/> [**Page views** \[ページ ビュー\] ページ](/docs/browser/new-relic-browser/additional-standard-features/page-views-insights-your-sites-popularity)と[**AJAX**ページ](/docs/browser/new-relic-browser/browser-pro-features/ajax-dashboard-identifying-time-consuming-calls)のデータに URL パターンを使用します。URL パターンを使用する利点は次のとおりです。
