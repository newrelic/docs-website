...
* [Chrome](https://www.google.com/chrome/) (以前の 5 つのメジャー バージョン)
* [Safari](https://www.apple.com/safari/) (以前の 10 のメジャー バージョン)
* [Firefox](https://www.mozilla.org/firefox/) (以前の 10 のメジャー バージョン)
* [Edge](https://www.microsoft.com/adge) (以前の 10 のメジャー バージョン)
