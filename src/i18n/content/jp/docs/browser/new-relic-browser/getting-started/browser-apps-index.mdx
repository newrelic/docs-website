...
始めるには[<InlinePopover type="browser"/>](/docs/browser/new-relic-browser/getting-started/introduction-new-relic-browser) 、 **[one.newrelic.com](https://one.newrelic.com/all-capabilities)**にアクセスし、ページの上部でブラウザを選択します。すでにアプリを追加している場合は、ブラウザー アプリケーションのインデックスが自動的に表示されます。
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ブラウザーの任意のページで、アプリケーションの名前の上にある \[**ブラウザー アプリケーション]**を選択します。
