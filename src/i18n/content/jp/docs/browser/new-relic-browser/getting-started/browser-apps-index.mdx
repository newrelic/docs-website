...
[<img title="ブラウザ_インデックス.png" alt="ブラウザ_インデックス.png" src={browserIndex}/>](/docs/browser/new-relic-browser/installation/install-new-relic-browser-agent)
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <img
          title="ブラウザ・リターン・インデックス.png"
          alt="ブラウザ・リターン・インデックス.png"
