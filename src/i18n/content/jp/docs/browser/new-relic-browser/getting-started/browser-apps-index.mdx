...
[ブラウザーの監視](/docs/browser/new-relic-browser/getting-started/introduction-new-relic-browser)を開始するには、 **[one.newrelic.com](https://one.newrelic.com/all-capabilities)**にアクセスし、ページの上部にあるブラウザーを選択します。すでにアプリを追加している場合は、ブラウザ アプリケーションのインデックスが自動的に表示されます。
