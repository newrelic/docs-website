...
<img
  title="New Relic Browser。フィルタリング可能なジオグラフィ"
  alt="New Relic Browser。フィルタリング可能なジオグラフィ"
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <img
          title="ブラウザ。フィルタリング可能なジオグラフィー"
          alt="ブラウザ。フィルタリング可能なジオグラフィー"
          src={iconDropdown}
        />
...
<img
  title="ブラウザでFilterable Geography（ロンドン・ズーム）"
  alt="ブラウザでFilterable Geography（ロンドン・ズーム）"
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <img
          title="ブラウザ。フィルタリング可能なGeographyの凡例"
          alt="ブラウザ。フィルタリング可能なGeographyの凡例"
...
<img
  title="ブラウザフィルタリング可能なジオグラフィー（属性）"
  alt="ブラウザフィルタリング可能なジオグラフィー（属性）"
...
<img
  title="ブラウザでフィルタリング可能な地理的な比較パフォーマンスチャート"
  alt="ブラウザでフィルタリング可能な地理的な比較パフォーマンスチャート"
