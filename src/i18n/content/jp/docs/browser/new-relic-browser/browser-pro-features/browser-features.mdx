...
* <DNT>[Session replay](/docs/browser/browser-monitoring/browser-pro-features/session-replay/get-started)</DNT>: ユーザーセッションのライブ再生を表示して、JavaScript エラーのトラブルシューティングを行い、UI デザインを改善します。
