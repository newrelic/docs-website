...
<Callout variant="important">
  以下の例は米国アカウント（デフォルト）用です。その他のリージョンについては、対応するエンドポイントを使用してください：

  * EUアカウント： `https://sourcemaps.service.eu.newrelic.com`
  * JPアカウント： `https://sourcemaps.service.jp.newrelic.com`

  詳しくは、[データセンターの選択](/docs/accounts/accounts-billing/account-setup/choose-your-data-center)をご覧ください。
</Callout>
