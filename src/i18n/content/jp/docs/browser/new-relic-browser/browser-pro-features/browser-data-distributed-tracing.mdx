...
2. **[one.newrelic.com](https://one.newrelic.com) > Browser > (アプリを選択) > Application settings**に移動します。
3. \[**分散トレース**] トグルをオンにします。
...
<CollapserGroup>
  ...
  >
    ...
    3. **[one.newrelic.com](https://one.newrelic.com) > Browser > (アプリを選択) > Application settings**に移動します。
