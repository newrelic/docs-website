...
* 分散型トレーシングのUIでは、エンドユーザーのスパンは <img title="分散型トレーシングブラウザのパンアイコン.png" alt="New Relic の分散型トレーシングブラウザのスパンアイコン" src={distributedTracingBrowserSpanIcon}/> のアイコンで表示されます。
