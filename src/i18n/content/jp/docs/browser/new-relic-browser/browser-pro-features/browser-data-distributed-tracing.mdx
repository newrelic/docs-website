...
2. <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Browser > (select an app) > Settings > Application settings**</DNT>

   に移動します。

3. <DNT>**Distributed tracing**</DNT>
...
2. <DNT>**Application settings**</DNT>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        分散トレーシングUIでは、エンドユーザーのスパンは<img title="distributed-tracing-browser-span-icon.png" alt="New Relic distributed tracing browser span icon" src={browserBrowserIcon} style={{height: "30px", width: "30px"}}/>
