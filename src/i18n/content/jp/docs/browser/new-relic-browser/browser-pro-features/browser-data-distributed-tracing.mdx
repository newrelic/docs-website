...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        分散トレース UI では、エンドユーザー スパンは<img title="distributed-tracing-browser-span-icon.png" alt="New Relic distributed tracing browser span icon" src={browserBrowserIcon} style={{height: "30px", width: "30px"}}>で示されます。</img>
