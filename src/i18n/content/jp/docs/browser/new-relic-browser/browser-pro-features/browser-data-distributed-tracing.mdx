...
必要な最小バージョンがあることを確認してください。 <InlinePopover type="browser"/>エージェントとあなたの<InlinePopover type="apm"/>エージェント：
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ディストリビューティッド（分散）トレーシング UI では、エンドユーザー スパンは<img title="distributed-tracing-browser-span-icon.png" alt="New Relic distributed tracing browser span icon" src={browserBrowserIcon} style={{height: "30px", width: "30px"}}/>
