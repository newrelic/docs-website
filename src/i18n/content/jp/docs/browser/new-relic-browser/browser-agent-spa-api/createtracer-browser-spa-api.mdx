...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities)に移動し、Browser > (SPA アプリを選択) > Page views をクリックします**。
2. \[**ページ ビュー**] からブラウザー インタラクションを選択し、\[ **Ajax リクエスト**] タブを選択します。
