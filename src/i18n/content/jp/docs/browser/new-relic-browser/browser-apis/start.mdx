...
<Callout variant="important">
  この API は、どのブラウザ エディション (Browser Lite、Pro、または Pro+SPA) でも機能します。この API を使用するために必要な設定は、現在 New Relic 内のより大規模なデプロイメント システムに接続されていません。したがって、さらなる変更が行われるまでは、コピー/ペーストまたは NPM インストールでのみ効果があります。
</Callout>
...
遅延状態での実行時にエージェント機能を開始するために使用されるブラウザ API

## 要件

エージェントのバージョン[1.239.0](/docs/release-notes/new-relic-browser-release-notes/browser-agent-release-notes)以降。
