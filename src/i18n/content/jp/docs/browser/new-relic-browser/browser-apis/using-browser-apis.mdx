...
ブラウザ API を使用すると、 <InlinePopover type="browser"/>。API の使用を開始するには、[監視するすべてのページにブラウザ エージェントが存在することを](/docs/browser/new-relic-browser/installation/install-new-relic-browser-agent)確認してください。
