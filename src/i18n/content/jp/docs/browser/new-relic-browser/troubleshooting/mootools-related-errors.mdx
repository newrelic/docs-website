...
MooTools ライブラリを使用しているときに、ブラウザ コンソールまたは[<DNT>**JavaScript errors**</DNT>ページ](/docs/browser/new-relic-browser/browser-pro-features/js-errors-dashboard-examining-errors-over-time)に以下のようなエラーが表示されます。
