...
アプリケーション[にインストルメント化されている場合<InlinePopover type="browser"/>](/docs/browser/new-relic-browser/installation-configuration/troubleshooting-browser-monitoring-installation)他の[Pro 機能](/docs/browser/new-relic-browser/browser-pro-features)のデータを正しく収集している場合は、次の手順に従います。
