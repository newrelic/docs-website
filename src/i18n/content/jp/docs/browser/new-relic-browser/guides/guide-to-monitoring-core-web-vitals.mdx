...
New Relic を初めて使用する場合は、 [無料の New Relic アカウントを作成し](https://newrelic.com/signup) 、 [ブラウザー アプリをインストルメント化します](/docs/browser/browser-monitoring/installation/install-browser-monitoring-agent) (約 5 分かかります!)。 次に、ここに戻って **、Web Vitals** ページをナビゲートする方法を学習してください。
