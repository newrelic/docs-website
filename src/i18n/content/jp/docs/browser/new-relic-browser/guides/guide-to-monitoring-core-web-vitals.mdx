...
New Relic を初めて使用する場合は[、無料の New Relic アカウントを作成し、](https://newrelic.com/signup)[ブラウザー アプリをインストルメント](docs/browser/browser-monitoring/installation/install-browser-monitoring-agent)化します (約 5 分かかります!)。次に、ここに戻って、 **Web Vitals**ページをナビゲートする方法を学習してください。
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Browser > (アプリを選択) > Monitor > Web Vitals**
</figcaption>
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Browser > (アプリを選択) > Monitor > Web Vitals > (フィルターを追加)**
</figcaption>
