...
この問題は Next.JS リリース [v13.4.20-canary.5](https://github.com/vercel/next.js/releases/tag/v13.4.20-canary.5)で解決されました。Next.JS フレームワークのバージョン 13.4.20-canary.5 以降にアップグレードしてください。
