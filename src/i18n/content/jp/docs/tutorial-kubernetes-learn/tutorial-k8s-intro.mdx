  ...
  <Step>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          <td>
            [ガイド付きインストール（JP）](https://onenr.io/0oQDrE83ZRy)
          </td>

          <td>
            [JP](/docs/using-new-relic/welcome-new-relic/get-started/our-eu-us-region-data-centers)データセンターを使用しているNew Relic組織で、クイックスタートのボーナスダッシュボードやアラートを必要としない場合に使用します。
          </td>
        </tr>
