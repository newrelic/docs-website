...
NRQLを使用してCloud Cost Intelligenceデータをクエリし、cloud支出を分析して最適化します。詳細なクエリ用の属性を持つ5つのイベントタイプが利用可能です：
...
<table>
  ...
  <tr>
    ...
    <td>
      Kubernetesのコスト割り当て、完全なNRQL言語をサポート
    </td>
  </tr>
...
効果的な[NRQL](/docs/nrql/get-started/introduction-nrql-new-relics-query-language)クエリを記述するには、 [「NRQL 入門チュートリアル」を](/docs/nrql/nrql-tutorials/introduction-nrql-tutorial)参照してください。

## Cloud Cost Intelligence データのクエリ

<DNT>**All Capabilities &gt; Cloud Cost Intelligence**</DNT>に移動し、<DNT>**Query Console**</DNT>を開いてクエリを入力します。
...
<Tabs>
  ...
  <TabsPages>
    ...
    <TabsPageItem id="kubernetescost">
      ...
      これにより、リソース使用量に基づいて正確なコスト割り当てを行うために、 `net_unblended_cost`に CPU とメモリの重み付けの合計が乗算されます。
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              1 つ以上のコンテナをホストできる Kubernetes ポッド名。
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              割り当てられた合計数のうちコンテナによって使用される CPU コア数。
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              このコンテナに割り当てられた CPU コア。（0.00005877）
            </td>
          </tr>
...
<CollapserGroup>
  <Collapser id="state-select" title="サポートされているNRQL句">
