    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            月単位で課金データが表示されるコンテナ内の相対パスを入力します (たとえば、2025 年 11 月の場合は`20251101-20251130` 、2025 年 12 月の場合は`20251201-20251231`)。**注**: 課金エクスポートをコンテナのルートに直接公開する場合は、このフィールドを空のままにしておきます。
          </td>
