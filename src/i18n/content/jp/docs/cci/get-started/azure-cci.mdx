...
<Steps>
  <Step>
    ...
    1. Azure ポータルで、<DNT>**Cost Management &amp; Billing**</DNT>に移動します。
    2. <DNT>**Billing Scope**</DNT>を選択し、<DNT>**Settings**</DNT>を展開して<DNT>**Exports**</DNT>をクリックします。
    3. <DNT>**Cost and Usage (FOCUS)**</DNT>形式と<DNT>**Parquet**</DNT>圧縮によるエクスポートのリストを確認します。
  ...
  <Step>
    ...
    4. エクスポート タイプとして<DNT>**Cost and Usage (FOCUS)**</DNT>を選択します。
  ...
  <Step>
    ...
    初期処理には最大48時間かかります。その後、コストデータがコスト概要ダッシュボードに表示されます。
  </Step>
