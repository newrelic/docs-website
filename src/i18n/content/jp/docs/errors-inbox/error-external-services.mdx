...
<Callout variant="important">
  New Relicは、チーム管理と会社管理の両方の[Atlassian-Jiraプロジェクト](https://support.atlassian.com/jira-software-cloud/docs/what-are-team-managed-and-company-managed-projects/)をサポートします。
</Callout>
