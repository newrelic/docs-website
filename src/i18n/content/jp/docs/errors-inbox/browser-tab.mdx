...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Browser > (アプリを選択) > Errors**に移動します。
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > ブラウザに移動します。次に、アプリをクリックし、 **Errors** \[エラー] セクション で **Errors \[エラー]** (エラー受信箱) をクリックします。 **View profiles\*\*\[プロファイルの表示] ボタンをクリックして、属性プロファイル テーブルを開きます。
</figcaption>
