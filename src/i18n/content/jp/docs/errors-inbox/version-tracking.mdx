...
<Callout variant="tip">
  オプション<DoNotTranslate>**Resolve in next version**</DoNotTranslate>と<DoNotTranslate>**Resolve in specific version**</DoNotTranslate>は、チームがセマンティック バージョン管理を使用している場合にのみサポートされます。
</Callout>
