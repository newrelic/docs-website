...
[uniqueCount()](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-nrql-alert-conditions/)関数の使用方法、エンティティの[エンティティ ID を検索する方法の](/docs/new-relic-solutions/new-relic-one/core-concepts/what-entity-new-relic/#find)詳細を参照してください。
