...
[uniqueCount()](https://docs.newrelic.com/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/nrql-alert-conditions/)関数の使用、エンティティの[エンティティ ID を見つける方法](https://docs.newrelic.com/docs/new-relic-solutions/new-relic-one/core-concepts/what-entity-new-relic/#find)の詳細をお読みください。
...
NRQL クエリを決定したら、それを使用して[NRQL アラート条件](https://docs.newrelic.com/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/nrql-alert-conditions/#create)を作成できます。

トリガーされたアラートの信号対雑音比を改善するには、 [アラート作成のヒント](https://docs.newrelic.com/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/nrql-alert-conditions/#condition-tips)、 [アラートしきい値の評価方法](https://docs.newrelic.com/docs/alerts-applied-intelligence/new-relic-alerts/advanced-alerts/understand-technical-concepts/streaming-alerts-key-terms-concepts/#advanced-signal)、および[アラート条件の例を](https://docs.newrelic.com/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/nrql-alert-conditions/#examples)参照してください。
