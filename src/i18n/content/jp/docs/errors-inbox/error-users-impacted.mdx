...
[NRQL アラート条件](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-alert-conditions/)を作成することで、開発者はアラート条件をトリガーできます。 <InlinePopover type="alerts"/>エラーの影響を受けるユーザーの数がしきい値を超えたとき。
