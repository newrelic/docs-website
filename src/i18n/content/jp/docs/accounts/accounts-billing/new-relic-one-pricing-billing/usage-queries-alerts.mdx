...
[New Relicの使用量と請求](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing)について理解できるように、請求関連の使用量を把握するための[使用量UI](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing#usage-ui)を用意しています。さらに、カスタムNRQLクエリを実行して追加の詳細を取得したり、使用量が特定のレベルに達した場合のアラート通知を作成したりできます。

## データインジェスト使用量のクエリ [#data-queries]

[使用量UI](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing#usage-ui)は、時間の経過に伴うデータの取り込みを表示します。UIが提供するものより詳細な情報が必要な場合は、以下のようなNRQLクエリを使用できます。
...
* アラート設定方法の基本については、[NRQLアラート条件](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/nrql-alert-conditions/#create)を参照してください。
