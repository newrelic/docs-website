...
* ユーザーの割り当てられた**ロール**：ユーザーのユーザータイプが決定されると、**ロール**を使用してユーザーのアクセスをより正確に制御できます。ロールとは**機能**のセットで、きめ細かなNew Relic機能（たとえば、New Relic

  <InlinePopover type="apm"/>

  の設定を変更する機能）です。[ユーザーグループ](#groups)に適用することで、役割を割り当てます。
