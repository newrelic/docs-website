...
* **管理者**には、より高いレベルの管理設定を含むすべての機能があります。これは、利用可能なすべての[管理設定](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts#roles)を持つ**すべての製品管理者**の[標準ロール](#standard-roles)を持つことと同等です。
