...
[_ユーザー名/パスワード (デフォルト): ユーザーは電子メールとパスワードでログインします。_ SAML SSO: ユーザーは、ID プロバイダーを使用して SAML シングル サインオン (SSO) 経由でログインします。その設定方法については、読み続けてください。](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-user-models)
