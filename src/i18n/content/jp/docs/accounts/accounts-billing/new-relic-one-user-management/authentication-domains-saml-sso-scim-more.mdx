...
**Authentication Domain UI** \[認証ドメイン UI]で、ユーザーをプロビジョニングする方法として SCIM を選択した場合、ユーザーの[ユーザー タイプ](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type)の管理方法について 2 つのオプションがあります。
