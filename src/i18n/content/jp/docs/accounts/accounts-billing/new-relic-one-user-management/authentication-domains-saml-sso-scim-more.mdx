...
認証ドメインは、 [New Relic One ユーザーモデル](/docs/accounts/accounts-billing/new-relic-one-pricing-users/users-roles) でユーザーを管理するためのものです。ユーザーが弊社のオリジナルユーザーモデルを使用している場合は、 [オリジナルアカウント](/docs/accounts/original-accounts-billing/original-users-roles/original-account-structure) を参照してください。
