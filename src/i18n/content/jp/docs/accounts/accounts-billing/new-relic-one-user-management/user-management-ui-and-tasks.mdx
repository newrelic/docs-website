...
<Callout variant="important">
  これらのUIページが表示されない場合、[元のユーザーモデル](/docs/accounts/original-accounts-billing/original-users-roles/users-roles-original-user-model)を使用しているか、または[必要なロール](#requirements)を持っていない可能性があります。
</Callout>
...
<figcaption>
  **組織を使用してUI**では、アクセス権限、カスタムグループ、カスタムロールを作成し、認証ドメインを設定できます。
</figcaption>
