...
New Relic組織のユーザー管理オプションを見つけるには：[アカウントドロップダウン](/docs/using-new-relic/welcome-new-relic/get-started/glossary#account-dropdown)から、**管理**を選択します。ユーザー管理関連のUIページは次の通りです。
