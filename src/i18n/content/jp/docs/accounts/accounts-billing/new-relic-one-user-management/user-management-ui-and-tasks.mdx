...
<img title="New Relic Oneの組織を使用してUI" alt="New Relic Oneの組織を使用してUI" src={newRelicOneUserMgmt}/> <figcaption>**組織を使用して**UIでは、アクセス権限、カスタムグループ、カスタムロールを作成し、認証ドメインを設定できます。</figcaption>
