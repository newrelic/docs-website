...
New Relic組織のユーザー管理オプションを見つけるには：[アカウントドロップダウン](/docs/using-new-relic/welcome-new-relic/get-started/glossary#account-dropdown)から、**管理**を選択します。ここには、2つのユーザー管理UIページがあります。
...
* 権限関連の要件：
  ...
  * ほとんどのユーザー管理機能には、組織および認証ドメイン関連の[管理設定](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts#roles)が必要です。
...
<figcaption>
  **アクセス管理**UIでは、グループ、ロール、認証ドメインを設定および管理できます。
</figcaption>
