...
* これを構成するには、 **Organization settings**\[組織設定の] [管理者設定](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts/#admin-settings)が必要です
