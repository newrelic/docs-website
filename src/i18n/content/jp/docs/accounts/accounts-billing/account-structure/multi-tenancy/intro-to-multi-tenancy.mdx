...
3. 指定されたグループにユーザーを追加する：コアまたはフルプラットフォームユーザータイプのユーザーは、Tenant Managerロールを割り当てる組織スコープの[アクセスグラント](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts/#access-grants)を持つグループに追加する必要があります。
...
<DocTiles>
  <DocTile title="ステップ1" path="/docs/accounts/accounts-billing/account-structure/multi-tenancy/org-creation">
    アカウントと組織を作成する
  </DocTile>

  <DocTile title="ステップ2" path="/docs/accounts/accounts-billing/account-structure/multi-tenancy/delegated-administration">
    ユーザーとアクセスを管理する
  </DocTile>

  <DocTile title="ステップ3" path="/docs/accounts/accounts-billing/account-structure/multi-tenancy/share-accounts">
    アカウントを共有する（オプション）
  </DocTile>
</DocTiles>