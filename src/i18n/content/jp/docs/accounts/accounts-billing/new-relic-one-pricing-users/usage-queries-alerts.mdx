...
<Callout variant="caution">
  アラート条件を作成する際は、[評価オフセット](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-nrql-alert-conditions#h2-evaluation-offset)値を60分に設定する必要があります。そうしない場合、条件がトリガーされない可能性があります。
</Callout>
