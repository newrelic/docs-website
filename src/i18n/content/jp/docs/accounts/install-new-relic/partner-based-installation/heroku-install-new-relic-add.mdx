...
<CollapserGroup>
  <Collapser id="heroku-add-on-license-key" title="ライセンスキー">
  ...
  <Collapser id="heroku-add-on-account-url" title="アカウントURL">
  ...
  <Collapser id="heroku-add-on-account" title="アカウントID">
...
<CollapserGroup>
  <Collapser id="heroku-add-on-login" title="HerokuからNew Relicアドオンのアカウントにサインインします。">
  ...
  <Collapser id="regular-login" title="通常のNew Relicアカウントへのサインイン">
