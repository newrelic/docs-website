...
これは、New Relic 組織の[オリジナルの価格モデル](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-pricing-models/)に影響します。これは、さまざまな製品 (たとえば、 <InlinePopover type="apm"/>、 <InlinePopover type="browser"/>、インフラストラクチャ監視など）。
