...
これは、New Relic 組織の[オリジナルの価格モデル](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-pricing-models/)に影響します。これは、さまざまな製品 (APM、ブラウザ監視、インフラストラクチャ監視など) ごとに請求される価格モデルです。
