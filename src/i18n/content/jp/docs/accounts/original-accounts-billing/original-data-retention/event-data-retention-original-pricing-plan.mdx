...
[当社の独自の価格設定モデル](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-pricing-models)を使用している組織の場合、当社のさまざまな製品が幅広い[イベント データ](/docs/using-new-relic/data/understand-data/new-relic-data-types#event-data)をレポートします。製品ごとにデータ保持期間が異なります。
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Insights Pro サブスクリプション契約によって週単位で決定される保持期間。
          </td>
        </tr>
