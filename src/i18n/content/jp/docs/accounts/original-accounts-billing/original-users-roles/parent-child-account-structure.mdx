...
* 新しいユーザーモデル：ユーザーに特定のアカウントにアクセスできるようにするアクセス許可を作成する必要があります。詳細については、[ユーザー管理コンセプト](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts#understand-concepts)を参照してください。
