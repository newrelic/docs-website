...
<CollapserGroup>
  <Collapser id="rule-example" title="アクションのみを使用するルール">
    ...
    <img title="onelogin_rules_conditions_actions.png" alt="Screen capture showing the OneLogin Rules detail page about conditions and actions." src={accountsOneLoginRulesConditionsActions} />
...
<img title="onelogin_provisioning_form.png" alt="Screen capture showing the OneLogin Provisioning page." src={accountsOneLoginProvisioningForm} />
...
1. <DNT>**Groups**</DNT>フィールドをクリックします。
   ...
   <img title="onelogin_parameter_form_general.png" alt="Screenshot of the OneLogin Parameter form showing which fields to configure." src={accountsOneLoginGeneralParameterForm} />

2. <DNT>**Include in User Provisioning**</DNT>確認してください。

   <img title="onelogin_parameter_form_specific.png" alt="Screenshot showing the OneLogin Parameter details page." src={accountsOneLoginParameterFormSpecific} />
