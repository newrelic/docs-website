---
title: 自動ユーザー管理（AUM）とシングルサインオン（SSO）の紹介
tags:
  - Accounts
...
* [ユーザーモデル](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-changes-pricing-user-model#user-models)-関連する要件。

  * この機能を利用するには、弊社の [New Relic One ユーザーモデル](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-changes-pricing-user-model#user-models) を利用している必要があり、そのモデルでユーザーを作成します。当社の [オリジナルユーザーモデル](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-changes-pricing-user-model#user-models) を利用している場合 (または、この機能を実装できない場合) は、New Relic のアカウント担当者にご相談ください。
  * AUMを設定するには、ユーザーが [**Authentication domain manager** と **Organization manager** ロール](/docs/accounts/accounts-billing/new-relic-one-user-management/new-relic-one-user-model-understand-user-structure/#standard-roles) を持っている必要があります（ [デフォルトグループ **Admin**](/docs/accounts/accounts-billing/new-relic-one-user-management/new-relic-one-user-model-understand-user-structure/#groups) のユーザーはこれらを持っています）。
...
New Relic の役割と機能の詳細については、 [標準的な役割](/docs/accounts/accounts-billing/new-relic-one-user-management/new-relic-one-user-model-understand-user-structure#standard-roles) を参照してください。