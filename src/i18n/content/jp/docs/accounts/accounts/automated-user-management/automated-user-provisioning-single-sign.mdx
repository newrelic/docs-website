...
* [ユーザー タイプ](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type)がコア ユーザーまたはフル プラットフォーム ユーザーであり、組織スコープの[<DNT>**Authentication domain manager**</DNT>ロールを](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts#admin-settings)持つグループに属している必要があります。
