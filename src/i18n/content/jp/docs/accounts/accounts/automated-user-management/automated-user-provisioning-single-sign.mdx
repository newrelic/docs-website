...
* パーミッション関連の要件。
  ...
  * [New Relic One ユーザーモデル](/docs/accounts/original-accounts-billing/original-users-roles/overview-user-models) をご利用いただく必要があります。この機能では、そのモデル上にユーザーを作成します。 [オリジナルユーザーモデル](/docs/accounts/original-accounts-billing/original-users-roles/overview-user-models) をご利用の場合は、New Relic アカウント担当者にご相談ください。
  * [ユーザータイプ](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type) がコアユーザーまたはフルプラットフォームユーザーで、 [**認証ドメインマネージャー** ロール](/docs/accounts/accounts-billing/new-relic-one-pricing-users/users-roles#standard-roles) を持つグループに所属している必要があります。
