...
SCIM 経由で New Relic にユーザーを追加しているが、 ****[SCIM 経由でユーザータイプを管理していない場合](#user-type) 、そのユーザーは [ベーシックユーザーとしてスタートします](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type) 。ユーザーをアップグレードするには、2つのオプションがあります。
