...
監査ログは、APM エージェントの[監査モード](/docs/agents/manage-apm-agents/configuration/log-audit-all-data-your-new-relic-agent-transmits)の構成とは異なります。APM 監査モードは、アプリから送信されるすべてのデータに関する情報を記録します。
