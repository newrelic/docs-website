...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ブローカーの ZooKeeper セッションの接続状態で、以下のいずれかとなる。NOT\_CONNECTED:&apos;0.0&apos;, associating:&apos;0.1&apos;, connecting:&apos;0.5&apos;, connectedreadonly: &apos;0.8&apos;, connected:&apos;1.0&apos;, closed: &apos;5.0&apos;, auth\_failed: &apos;10.0&apos;.
      </td>
    </tr>
  </tbody>
</table>
