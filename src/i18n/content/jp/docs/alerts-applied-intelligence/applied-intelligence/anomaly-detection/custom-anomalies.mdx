...
* スライダー バーを使用して
  ...
  <img title="Alerts v3: Critical alert icon" alt="icon-alert-critical.png" src={iconAlertCritical}>を調整します。プレビューチャートに異常の周囲のライトグレーの領域として表される</img>
