...
import alertsTryAnomalyThresholds from 'images/alerts_screenshot-crop_try-anomaly-thresholds.png'

import alertsSetAnomalyThresholds from 'images/alerts_screenshot-crop_set-anomaly-thresholds.png'
...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI** に移動し、左側のナビゲーション パネルで **Alerts condition (policies)** を選択します。
