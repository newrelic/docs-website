...
import alertsHowCustomAnomaliesWork from 'images/alerts_screenshot-full_how-custom-anomalies-work.webp'
...
import alertsConfigureYourAnomalyThresholds from 'images/alerts_screenshot-full_configure-your-anomaly-thresholds.webp'

import iconAlertCritical from 'images/icon-alert-critical.webp'

import iconAlertWarning from 'images/icon-alert-warning.webp'
