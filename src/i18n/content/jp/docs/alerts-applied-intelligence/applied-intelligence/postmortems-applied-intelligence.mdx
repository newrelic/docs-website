...
問題を見つけるには、 **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI > Analyze**に移動し、 **Issue & activity**をクリックします。
...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI > Analyze**に移動し、 **Issues & activity**をクリックします。
2. \[**事後分析**]タブをクリックします。
