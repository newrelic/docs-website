...
問題を見つけるには、 <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Analyze**</DoNotTranslate>に移動して<DoNotTranslate>**Issues & activity**</DoNotTranslate>をクリックします。
...
1. <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Analyze**</DoNotTranslate>に移動し、 <DoNotTranslate>**Issues & activity**</DoNotTranslate>をクリックします。
