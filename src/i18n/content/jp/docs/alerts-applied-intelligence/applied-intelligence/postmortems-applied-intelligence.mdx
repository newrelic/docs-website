...
問題を見つけるには、 [one.newrelic.com](https://one.newrelic.com) > **Alerts＆AI** > **Analyze**にアクセスし、 **Issues＆activity**をクリックします。
...
1. [one.newrelic.com](https://one.newrelic.com) > **Alerts＆AI** > **Analyze**に移動し、 **Issues＆activity**をクリックします。
2. \[**事後分析**]タブをクリックします。
