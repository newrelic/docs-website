...
次の表は、従来の通知システムで使用されていた Webhook ペイロード名と、課題ペイロードで対応する新しい名前との間の翻訳を示しています。[Handlebars](https://handlebarsjs.com/guide/)は、メッセージ テンプレートを作成するために使用される単純なテンプレート言語です。
