...
<img
  title="Incident Intelligenceのイシューフィードです。"
  alt="Incident Intelligenceのイシューフィードのスクリーンショット。"
  src={issueFeed}
/>
...
<img
  title="課題」ページには、「課題の概要」、「推奨される回答者」、「ラベルセット」、「影響を受ける組織」などのセクションがあります。"
  alt="課題」ページのスクリーンショットと、課題の概要、推奨される回答者、ラベルセット、影響を受ける企業などの各セクションの様子です。"
...
<img
  title="影響を受けたエンティティのアクションリストです。"
  alt="影響を受けたエンティティのアクションリストのスクリーンショットです。"
...
<img
  title="問題のエンティティマップビュー。"
  alt="問題のエンティティのマップビューのスクリーンショットです。"
  src={issueEntityMap}
/>
...
<img
  title="インシデント・インテリジェンスのイシュー・タイムラインには、イベントの詳細が表示されます。"
  alt="イベントの詳細が表示されたIncident Intelligence社のイシュー・タイムラインのスクリーンショットです。"
...
<img
  title="インシデント・インテリジェンスのイシュー・タイムラインには、重要なイベントの詳細が表示されます。"
  alt="クリティカルイベントの詳細が表示されたIncident Intelligenceのイシュータイムラインのスクリーンショット。"
