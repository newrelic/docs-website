...
インシデント通知ツールとしてNewRelicアラート違反を使用している場合、インシデントインテリジェンスは、問題の解決に役立つ関連チームメンバーを提案します。

インシデントインテリジェンスは、アラート違反データから学習して、新しいインシデントごとに提案を提供します。提案を受け取ったら、レスポンダーに連絡するか、その人が書いた可能性のある関連ドキュメントを検索できます。

開始するには、インシデントインテリジェンスのソースとしてアラート違反を有効にします。その後、問題フィードで提案を表示できます。ここで、提案に関するフィードバックを提供することもできます。
