...
**Issues**\[問題] ページでは、すべての問題の概要と、それらに関する役立つ情報を見つけることができます。 個々の問題をクリックして、分析の概要、イベント ログ、関連する問題の詳細などの詳細を確認することもできます。
...
事後分析の詳細な作成手順やウォークスルー デモを見るには、事後分析の[ドキュメント](https://docs.newrelic.com/docs/alerts-applied-intelligence/applied-intelligence/postmortems-applied-intelligence/)ページにアクセスしてください。
...
* **展開イベントには**、展開と関連する展開の 2 種類があります。 **[すべての展開を表示](/whats-new/applied-intelligence-deployment-events-issue-feed)** をクリックして、すべての展開イベントが到着したときに表示するか、特定の展開をクリックしてその展開を表示します。

  <InlinePopover type="apm"/>

  展開ページ。 [APM 展開ページには、](/docs/apm/apm-ui-pages/events/deployments-page-view-impact-your-app-users) 最近の展開と、エンド ユーザーとアプリ サーバーの Apdex スコア、応答時間、スループット、およびエラーへの影響が一覧表示されます。 このセクションは、New Relic がデプロイされた影響を受けるエンティティの下にあるアプリケーションを特定した場合にのみ表示されます。
