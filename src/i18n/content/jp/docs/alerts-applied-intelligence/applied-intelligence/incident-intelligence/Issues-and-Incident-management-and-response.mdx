...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI > Issues & activity**に移動します。このスクリーンショットは、問題のステータス、相関関係などを説明する問題フィードの例を示しています。
</figcaption>
...
フィルター アイコンをクリックすると、さらにフィルターが表示されます。

* 問題の状態 (作成済み、アクティブ、またはクローズ済み)
* 問題のステータス (承認済み、ミュート、または相関)
* 問題の優先度 (低、中、高、または重大)
