...
Applied Intelligenceのほとんどの機能を利用するには、 [フルプラットフォームのユーザーである必要があります。](/docs/accounts/accounts-billing/new-relic-one-user-management/new-relic-one-user-model-understand-user-structure/#user-type).

詳しくは、 [user type capabilities](/docs/accounts/accounts-billing/new-relic-one-user-management/new-relic-one-user-model-understand-user-structure/#user-capabilities) をご覧ください。
