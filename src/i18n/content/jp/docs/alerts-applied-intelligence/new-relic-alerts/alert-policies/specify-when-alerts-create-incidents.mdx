...
![アラートポリシーのインシデントプリファレンス](./images/example-policy-incident.png "アラートポリシーのインシデントプリファレンス")
...
![アラートポリシーのインシデントプリファレンス](./images/example-condition-incident.png "アラートポリシーのインシデントプリファレンス")
...
![アラートポリシーのインシデントプリファレンス](./images/example-target-incident.png "アラートポリシーのインシデントプリファレンス")

<figcaption>
  インシデントプリファレンスとして**By condition and signal**を選択すると、違反を一切グループ化しません。ポリシー内で発生する各違反に対して、新しいインシデントが作成されます。
</figcaption>

**By condition and signal**オプションを選択すると、最も詳細なインシデントレコードを作成できます。このオプションは、インフラストラクチャ全体で発生している内容を緊密に監視する場合などに便利です。ポリシー内で発生するすべての違反について、**Incidents**インデックスにインシデントが表示されます。
