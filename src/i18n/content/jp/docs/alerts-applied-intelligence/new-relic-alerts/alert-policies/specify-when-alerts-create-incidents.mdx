...
<img
  ...
  title="New Relic Oneのアラートユーザーインタフェース内のインシデントプリファレンスボタンの場所を示すスクリーンショット。"
  alt="New Relic Oneのアラートユーザーインタフェース内のインシデントプリファレンスボタンの場所を示すスクリーンショット。"
/>

<img
  src={incidentPreferenceOptions}
  title="New Relic Oneのアラートユーザーインタフェースでインシデントプリファレンスの変更方法を示すスクリーンショット。"
  alt="New Relic Oneのアラートユーザーインタフェースでインシデントプリファレンスの変更方法を示すスクリーンショット。"
/>
