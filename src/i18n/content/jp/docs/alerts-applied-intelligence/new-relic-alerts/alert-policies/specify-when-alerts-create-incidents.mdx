...
<img
  title="A screenshot showing where the incident preference button is inside the alerts user interface."
  alt="A screenshot showing where the incident preference button is inside the alerts user interface."
  src={incidentPreferenceUi}
/>

<img
  title="A screenshot showing how to change your incident preferences on the alerts user interface."
  alt="A screenshot showing how to change your incident preferences on the alerts user interface."
  src={incidentPreferenceOptions}
/>

<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Alert conditions（ポリシー）>（ポリシーを選択）：**選択したポリシーページに、アラート通知とUIの詳細についてアラートがどのようにインシデントをロールアップするかが表示されます。（デフォルトは**ポリシー別**）。このポリシーに別のオプションを選択するには、**Incident preference**をクリックします。
</figcaption>

## ポリシー別（デフォルト） [#preference-policy]

<img
  title="A diagram showing how the By policy incident preference works"
  alt="A diagram showing how the By policy incident preference works"
  src={byPolicy}
/>
...
<img
  title="A diagram showing how the By condition incident preference works"
  alt="A diagram showing how the By condition incident preference works"
  src={byCondition}
/>
...
<img
  title="Alert policy incident preferences"
  alt="Alert policy incident preferences"
  src={bySignal}
/>
