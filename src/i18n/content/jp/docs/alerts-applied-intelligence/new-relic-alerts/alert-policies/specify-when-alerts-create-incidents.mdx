...
![040315incident-pref.png](./image/040315incident-pref_0.png "040315incident-pref.png")
...
![アラートポリシーのインシデントプリファレンス](./images/sites/default/files/styles/inline_660px/public/thumbnails/image/example-policy-incident.png "アラートポリシーのインシデントプリファレンス")
...
![アラートポリシーのインシデントプリファレンス](./images/sites/default/files/styles/inline_660px/public/thumbnails/image/example-condition-incident.png "アラートポリシーのインシデントプリファレンス")
...
![アラートポリシーのインシデントプリファレンス](./images/sites/default/files/styles/inline_660px/public/thumbnails/image/example-target-incident.png "アラートポリシーのインシデントプリファレンス")
