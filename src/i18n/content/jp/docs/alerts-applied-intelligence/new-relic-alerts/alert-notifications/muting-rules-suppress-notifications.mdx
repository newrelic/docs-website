...
ミュート ルールを作成、有効化、無効化、および管理できます。 <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Muting rules**</DoNotTranslate>に移動します。 ミュート ルールはいつでも有効または無効にできます。 クリック<Icon name="fe-more-horizontal"/>各ルールの行にあるアイコンをクリックして、ルールを編集および削除します。
...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Muting rules**</DoNotTranslate>: 複雑なミュート ルールを作成して、小規模または大規模な一連の不要な通知を対象にすることができます。
</figcaption>
...
ミュート ルールを作成するには、 <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Muting rules**</DoNotTranslate>に移動して<DoNotTranslate>**+ Add a rule**</DoNotTranslate>をクリックします。 ミュート ルールの名前と説明 (オプション) を入力し、ルールを適用するアカウントを選択します。
...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Muting rules**</DoNotTranslate>: ミュート ルールをスケジュールするための柔軟で強力なオプション。
</figcaption>
...
<CollapserGroup>
  ...
  >
    ...
    <figcaption>
      <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Issues**</DoNotTranslate>に移動して、ミュートされた問題をクリックします。
    </figcaption>
  </Collapser>
