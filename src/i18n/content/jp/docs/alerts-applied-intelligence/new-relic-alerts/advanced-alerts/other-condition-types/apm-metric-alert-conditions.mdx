...
New Relic <InlinePopover type="apm"/>と<InlinePopover type="browser"/>メトリクスのアラート条件はさまざまな方法で作成できますが、NRQLを使用することをお勧めします。NRQLアラート条件を使用すると、追加の制御、検出時間の改善、すべてのデータタイプにわたる一貫性が得られます。
...
1. ツールバーで**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM**の順に移動します。
...
7. 選択したグラフの右上隅にある省略記号アイコン**...**をクリックし、**Create alert condition**を選択します。

   <Callout variant="tip">
     省略記号アイコン**...**が表示されない場合は、ページの最上部にある**Show new view** オプションが有効になっていることを確認してください。
   </Callout>
