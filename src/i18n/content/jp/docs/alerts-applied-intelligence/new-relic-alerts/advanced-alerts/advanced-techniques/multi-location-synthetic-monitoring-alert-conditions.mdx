...
3. <DoNotTranslate>**New alert condition**</DoNotTranslate>を選択します。
4. <DoNotTranslate>**Build a classic alert**</DoNotTranslate>を選択します。
5. <DoNotTranslate>**Synthetics**</DoNotTranslate>と<DoNotTranslate>**Multiple location failures**</DoNotTranslate>を選択します。
6. ターゲットとするモニターを選択するには、 <DoNotTranslate>**Next**</DoNotTranslate>クリックします。
7. <DoNotTranslate>**Next**</DoNotTranslate>クリックします。 <DoNotTranslate>**Set thresholds**</DoNotTranslate>ステップのフィールドに入力します。
8. <DoNotTranslate>**Save condition**</DoNotTranslate>をクリックします。
