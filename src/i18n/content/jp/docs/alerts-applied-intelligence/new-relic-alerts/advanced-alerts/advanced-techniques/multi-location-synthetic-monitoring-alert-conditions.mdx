...
1. **[one.newrelic.com](https://one.newrelic.com)**のトップ ナビゲーションで、 **Alerts & AI**をクリックし、 **Alert conditions (Policies)**をクリックして、プロセスを開始し[て条件を作成します](/docs/alerts/new-relic-alerts/defining-conditions/define-alert-conditions#create-condition)。
