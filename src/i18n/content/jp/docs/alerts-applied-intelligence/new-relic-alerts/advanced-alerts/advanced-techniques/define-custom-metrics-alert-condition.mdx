...
1. **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Alert conditions (Policies) > (select a policy)**に移動するか[、新しいアラート ポリシーを追加し](/docs/alerts/new-relic-alerts-beta/configuring-alert-policies/name-or-rename-alert-policy)ます。
