  ...
  >
    ...
    <table>
      ...
      <tbody>
        <tr>
          <td>
            <img title="アラート v3: Criticalアラートアイコン" alt="icon-alert-critical.png" src={iconAlertCritical}/> クリティカル（赤）
          </td>
        ...
        <tr>
          <td>
            <img title="アラート v3: Warningアラートアイコン" alt="icon-alert-warning.png" src={iconAlertWarning}/> 警告（黄）
          </td>
