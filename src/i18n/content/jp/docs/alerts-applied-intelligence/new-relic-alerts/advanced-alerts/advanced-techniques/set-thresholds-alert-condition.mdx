...
[条件](/docs/using-new-relic/welcome-new-relic/get-started/glossary#alert-condition)において、閾値とは[インシデント](/docs/new-relic-solutions/get-started/glossary/#alert-violation)を開くかどうかを判断するための設定になります。ポリシーの[問題作成設定](/docs/alerts/new-relic-alerts/configuring-alert-policies/specify-when-new-relic-creates-incidents)、および設定した[ワークフロー](/docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows/)によっては、インシデントによって次の結果が生じる可能性があります。
