   ...
   <CollapserGroup>
     ...
     >
       ...
       * <InlinePopover type="apm">[](/docs/alerts/new-relic-alerts/rest-api-alerts/rest-api-calls-new-relic-alerts#conditions-list)</InlinePopover>
         ...
         [、モバイル監視](/docs/alerts/new-relic-alerts/rest-api-alerts/rest-api-calls-new-relic-alerts#conditions-list)  
         使用可能な条件: `apm_app_metric` 、 `apm_kt_metric` 、 `browser_metric` 、および`mobile_metric`  
         [API Explorer リンク Get \[取得\] > List \[リスト\]](https://rpm.newrelic.com/api/explore/alerts_conditions/list)
