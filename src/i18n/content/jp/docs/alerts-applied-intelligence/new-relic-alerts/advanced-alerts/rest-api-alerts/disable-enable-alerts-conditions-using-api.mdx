...
REST API は、アラートをプログラムで管理するための推奨される方法ではなくなりました。 詳細については、 [「API の概要」を参照してください。 <InlinePopover type="alerts"/>そして応用知性](/docs/alerts-applied-intelligence/new-relic-alerts/advanced-alerts/alerts-api/intro-alerts-api)。
   ...
   <CollapserGroup>
     ...
     >
       ...
       * <InlinePopover type="apm">[](/docs/alerts/new-relic-alerts/rest-api-alerts/rest-api-calls-new-relic-alerts#conditions-list)</InlinePopover>
         ...
         [、 そして](/docs/alerts/new-relic-alerts/rest-api-alerts/rest-api-calls-new-relic-alerts#conditions-list)
         ...
         使用可能な条件: `apm_app_metric` 、 `apm_kt_metric` 、 `browser_metric` 、および`mobile_metric`  
         [Explorer link Get>List](https://rpm.newrelic.com/api/explore/alerts_conditions/list)
