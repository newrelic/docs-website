  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        ただし、 **を5分間に1回以上** に設定していた場合は、5分間の間に [を少なくとも1回](/docs/alerts/new-relic-alerts/configuring-alert-policies/minimum-maximum-values#violation) 破る必要があります。
      </td>
    </tr>
  </tbody>
</table>
...
4. アプリの選択したインスタンスごとにアラートしきい値インシデントを **個別に** 評価するには、 **Scope to Java application instances** \[スコープを Java アプリケーション インスタンスにする]を選択します。
...
6. オプション: 時刻を変更する
   ...
   インシデントを強制的に終了します (デフォルトは 24 時間です)。
