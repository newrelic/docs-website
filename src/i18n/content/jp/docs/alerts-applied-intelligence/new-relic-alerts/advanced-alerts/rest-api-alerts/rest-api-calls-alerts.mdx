...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="違反のリスト"
  >
    アカウントについて監視する[エンティティ](/docs/new-relic-solutions/get-started/glossary/#alert-violation)の[違反](/docs/alerts/new-relic-alerts-beta/getting-started/alerts-glossary#alert-entity)を表示するには、以下の値をAPIコールに含めます：
