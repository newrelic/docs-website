...
<CollapserGroup>
  ...
  >
    APM、ブラウザ、モバイル、キートランザクション、プラグインにおいて、[エンティティ](/docs/alerts/new-relic-alerts-beta/getting-started/alerts-glossary#alert-entity)が一部となる[条件](/docs/alerts/new-relic-alerts-beta/getting-started/alerts-glossary#alert-condition)を表示するには、以下の値をAPIコールに含めます：
