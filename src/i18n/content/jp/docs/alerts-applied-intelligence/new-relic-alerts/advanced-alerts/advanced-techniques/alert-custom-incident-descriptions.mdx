...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Alert conditions (Policies) > (select a policy) > (select a condition)**</DoNotTranslate>: フィールドを開くには<DoNotTranslate>**+ Add custom incident description**</DoNotTranslate>をクリックします。
</figcaption>
