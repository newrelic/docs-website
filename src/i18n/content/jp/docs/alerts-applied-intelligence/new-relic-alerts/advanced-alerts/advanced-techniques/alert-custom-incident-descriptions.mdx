...
[NRQL アラートの専用フィールド](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/nrql-alert-conditions/)、または[インフラストラクチャ アラートの \[この条件の説明\] セクションを](/docs/infrastructure/new-relic-infrastructure/infrastructure-alert-conditions/infrastructure-alerts-add-edit-or-view-host-alert-information/)使用して、カスタム インシデントの説明を作成できます。
