...
<img
  ...
  alt="New Relic Alerts - 異常値のNRQLアラート"
/>
...
4. [_返された値がどのようにグループ化されるかに応じて、 **予想されるグループの数** を設定してください。_ グループの中心からのずれと、違反のきっかけとなる継続時間を調整します。](/docs/alerts/new-relic-alerts/defining-conditions/create-alert-conditions-nrql-queries#syntax)
