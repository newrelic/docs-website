...
<CollapserGroup>
  ...
  >
    ...
    <figcaption>
      データが一貫して予測どおりに到着する場合は、 <DoNotTranslate>**event flow**</DoNotTranslate>を使用します。 データが一貫性がなく、予測不可能に到着する場合は、 <DoNotTranslate>**event timer**</DoNotTranslate>を使用します。
    </figcaption>
  </Collapser>
</CollapserGroup>
...
集計ウィンドウは<DoNotTranslate>**30 seconds**</DoNotTranslate>から<DoNotTranslate>**6 hours**</DoNotTranslate>までの任意の値に設定できます。 デフォルトは<DoNotTranslate>**1 minute**</DoNotTranslate>です。
...
遅延のデフォルトは<DoNotTranslate>**2 minutes**</DoNotTranslate>です。 タイマーのデフォルトは<DoNotTranslate>**1 minute**</DoNotTranslate>で、最小値は<DoNotTranslate>**5 seconds**</DoNotTranslate> 、最大値は<DoNotTranslate>**20 minutes**</DoNotTranslate>です。
