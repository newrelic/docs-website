...
![new-relic-alerts-baseline-thresholds.png](./image/new-relic-alerts-baseline-thresholds.png "new-relic-alerts-baseline-thresholds.png")
...
<CollapserGroup>
  ...
  >
    ...
    * スループットなどのデータソースの場合は、突然の上向きの変動はよく発生することで、突然の下向きの変動は問題の兆候を示している可能性があるため、**Lower**設定を使用します。
    ...
    ![New Relicベースラインのアラート方向を示す図の例](./image/new-relic-baseline-alerts-direction-image-examples_0.png "new-relic-baseline-alerts-direction-image-examples.png")
  </Collapser>
