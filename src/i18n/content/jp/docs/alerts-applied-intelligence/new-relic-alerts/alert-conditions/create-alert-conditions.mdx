...
1. **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Alert conditions > (select a condition)**に移動します。
2. 省略記号メニュー（...）をクリックし、**Edit**をクリックして編集してから、条件に見合う名前を入力します。
