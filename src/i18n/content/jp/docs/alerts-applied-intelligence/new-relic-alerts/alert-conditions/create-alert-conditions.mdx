...
1. <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert conditions > (select a condition)**</DNT>
...
1. <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert conditions (policies)**</DNT>

   に移動します。

2. 検索ボックスを使用して、列をソートするかリストをスクロールして、ポリシー名を選択して条件を表示します。

[特定のエンティティに対するポリシーと条件の情報](/docs/alerts/new-relic-alerts-beta/configuring-alert-policies/view-policy-conditions-new-relic-products)を表示するには、そのエンティティの製品のUIから<DNT>**Settings**</DNT>を選択し、<DNT>**Alert conditions**</DNT>をクリックします。