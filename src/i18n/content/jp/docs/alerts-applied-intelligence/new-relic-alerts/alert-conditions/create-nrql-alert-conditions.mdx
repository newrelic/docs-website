...
<DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert Conditions & Policies**</DNT>に移動して、ポリシーからNRQLアラート条件を作成します。次に、<DNT>**+ New alert condition**</DNT>をクリックします。
...
<figcaption>
  <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert Conditions & Policies > + New alert condition**</DNT>に移動します。
</figcaption>
...
<CollapserGroup>
  ...
  >
    ...
    設定が完了したら、<DNT>**Next**</DNT>をクリックします。
  </Collapser>
  ...
  <Collapser
    ...
    title="手順3. 閾値の定義"
  >
    [閾値](/docs/alerts-applied-intelligence/new-relic-alerts/advanced-alerts/advanced-techniques/set-thresholds-alert-condition/)を定義すると、インシデントを開く内容を決定できます。定義したら、<DNT>**Next**</DNT>をクリックします。
  </Collapser>
  ...
  >
    ...
    * <DNT>**Save & set up notifications**</DNT>をクリックします。

    <DNT>**Existing policy**</DNT>を選択した場合は、ポリシーを選択した後、<DNT>**Save condition**</DNT>をクリックします。
  </Collapser>
</CollapserGroup>
...
1. <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & Services**</DNT>に移動してアプリを選択します。

2. 左側のペインで、<DNT>**Metrics explorer**</DNT>を選択し、設定を追加します。

3. チャートの右隅にある<Icon name="fe-more-horizontal"/>アイコンをクリックし、<DNT>**Create alert condition**</DNT>を選択します。
...
4. <DNT>**+ Add lost signal threshold**</DNT>
