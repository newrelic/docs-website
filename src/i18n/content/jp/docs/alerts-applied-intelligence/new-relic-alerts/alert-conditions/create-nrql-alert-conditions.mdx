...
<img title="チャートからNRQLアラート条件を作成します。" alt="チャートからのNRQLアラート条件の作成方法を示すGIF動画。" src={inContextDemo}/> <figcaption>チャートからNRQLアラート条件を作成するには、チャートメニュー <Icon name="fe-more-horizontal"/>をクリックしてから、**アラート条件の作成**をクリックします。</figcaption>
