...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [サブクエリ](/docs/query-your-data/nrql-new-relic-query-language/get-started/subqueries-in-nrql)の実行にはデータを介しての複数のパスが必要なため、サブクエリはストリーミング<InlinePopover type="alerts"/>と互換性がありません。
      </td>
    </tr>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * **Add details** \[詳細の追加]ページで、インシデントと通知に含まれる条件のカスタムインシデントの説明を入力します。
