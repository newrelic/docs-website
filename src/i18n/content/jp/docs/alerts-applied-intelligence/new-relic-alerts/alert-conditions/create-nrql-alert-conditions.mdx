...
![NRQL条件および生成された結果の例のスクリーンショット。](./image/nr1_nrql_alert_conditions.png "NRQL条件および生成された結果の例。")
...
![signal-loss-ui.png](./image/signal-loss-ui_0.png "signal-loss-ui.png")
...
![screenshot_advanced_signal_settings.png](./image/screenshot_advanced_signal_settings2_0.png "screenshot_advanced_signal_settings.png")
