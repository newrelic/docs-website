  ...
  >
    ...
    <Table>
      ...
      <tbody>
        <tr>
          <td>
            ![icon-alert-critical.png](./images/icon-alert-critical.png "Alerts v3：重要アラートアイコン") 重要（赤）
          </td>
        ...
        <tr>
          <td>
            ![icon-alert-warning.png](./images/icon-alert-warning.png "Alerts v3：警告アラートアイコン") 警告（黄）
          </td>
