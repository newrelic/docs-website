...
ポリシーからNRQLアラート条件を作成するには、**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Alert Conditions & Policies**の順に移動します。次に、**+ 新しいアラート条件**をクリックします。
...
<figcaption>
  **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Alert Conditions & Policies > + 新しいアラート条件**の順に移動します。
</figcaption>
...
1. **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & Services**の順に移動し、アプリを選択します。
...
<figcaption>
  **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Alert conditions (Policies)**、**+ 新しいアラート条件**の順に移動します。信号損失は、NRQL条件でのみ使用できます。
</figcaption>
...
データが集計される前に、ストリーミング時間枠に蓄積されるデータの長さを選択する[集計ウィンドウ](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/streaming-alerts-key-terms-concepts/#window-duration)を設定できます。30秒から120分の間で設定できます。デフォルトは1分です。
...
[遅延/タイマー](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/streaming-alerts-key-terms-concepts/#delay-timer)を調整して、データの動作に合わせて[ストリーミングアラートアルゴリズム](/docs/new-relic-solutions/get-started/glossary/#streaming-algorithm)を調整できます。データがまばらであるか一貫性がない場合は、イベントタイマー集計法を使用することをお勧めします。
