...
null値の処理方法を決定するには、[アラート条件UI](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-alert-conditions/#signal-loss)で信号損失とギャップ充填の設定を調整します。
...
* スライドごとの間隔を変更する（[スライディングウィンドウの集計](https://docs.newrelic.com/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-alert-conditions/#sliding-window-aggregation)条件のみ）
