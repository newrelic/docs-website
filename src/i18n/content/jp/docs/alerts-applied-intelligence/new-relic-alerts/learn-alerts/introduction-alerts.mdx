...
<figcaption>
  **[one.newrelic.com](https://alerts.newrelic.com/ "新しいウィンドウにリンクが開きます。")**へ移動します。次に、**Alerts & AI（アラート & AI） > Add a condition（条件を追加する）**をクリックします。これにより、アラート条件の作成時に[閾値設定UIページ](/docs/alerts/new-relic-alerts/defining-conditions/set-thresholds-alert-condition)が表示されます。
</figcaption>
