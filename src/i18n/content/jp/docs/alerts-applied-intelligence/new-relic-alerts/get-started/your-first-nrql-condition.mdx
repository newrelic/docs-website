  ...
  <Step>
    ...
    <CollapserGroup>
      ...
      >
        ...
        カスタム インシデントの説明の詳細については、 [ドキュメント](/docs/alerts-applied-intelligence/new-relic-alerts/advanced-alerts/advanced-techniques/alert-custom-incident-descriptions)を参照してください。
      </Collapser>
