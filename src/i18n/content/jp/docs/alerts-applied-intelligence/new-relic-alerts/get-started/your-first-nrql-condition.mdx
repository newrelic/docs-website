...
<img
  title="New Relic One の NRQL クエリビルダボタンの場所を示すスクリーンショットです。"
  alt="New Relic One の NRQL クエリビルダボタンの場所を示すスクリーンショットです。"
...
<img
  title="ホスト名でファセット化された平均 CPU 使用率を見つける NRQL クエリのスクリーンショットです。"
  alt="ホスト名でファセット化された平均 CPU 使用率を見つける NRQL クエリのスクリーンショットです。"
  src={nrqlQuery}
/>
...
<img
  title="NRQL クエリをクリティカルとワーニングのしきい値ラインで視覚化したもの。"
  alt="NRQL クエリをクリティカルとワーニングのしきい値ラインで視覚化したもの。"
...
<img
  title="このクエリの視覚化では、各ホストの平均CPU使用率が表示されます。"
  alt="このクエリの視覚化では、各ホストの平均CPU使用率が表示されます。"
  src={showNrqlGraph}
/>
...
<img
  title="Create alertフォームのPolicyセクションのスクリーンショットです。"
  alt="Create alertフォームのPolicyセクションのスクリーンショットです。"
