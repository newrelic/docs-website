...
<CollapserGroup>
  ...
  >
    ...
    * PagerDuty のインシデントが承認されると、New Relic のインシデントの承認がトリガーされます。
    ...
    6. リストの中からNew Relicインテグレーションを見つけてマークし、 **Add** をクリックします。 <img
         title="PagerDuty の New Relic への統合。"
         alt="New Relicの統合。"
         src={pagerdutyAddNewrelicIntegration}
       />

    7. 右をクリックすると、 **統合キー** が表示され、コピーされます。 <img
         title="PagerDutyのNew Relic統合キー。"
         alt="New Relicの統合キーです。"
