...
<CollapserGroup>
  ...
  >
    ...
    * **API Key**: この統合では、REST API Key の提供を求められます。PagerDutyには2種類のREST APIキーがあり、 [一般アクセス](https://support.pagerduty.com/docs/generating-api-keys#section-generating-a-general-access-rest-api-key) と [ユーザートークンがあります。](https://support.pagerduty.com/docs/generating-api-keys#section-generating-a-personal-rest-api-key)
