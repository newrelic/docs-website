...
import notificationPayloadTemplate from 'images/notification-payload-template.png'

import notificationCustomVariables from 'images/notification-custom-variables.png'
...
<img
  title="Webhook通知メッセージのテンプレートの例です。"
  alt="Webhook通知メッセージテンプレートの例のスクリーンショットです。"
  src={notificationPayloadTemplate}
/>
...
<img
  title="変数の選択肢の広さを示す変数メニューです。"
  alt="変数メニューのスクリーンショットでは、利用可能な変数オプションの幅が示されています。"
  src={notificationCustomVariables}
/>
