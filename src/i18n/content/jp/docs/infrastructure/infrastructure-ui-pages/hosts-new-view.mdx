...
Infrastructure の保存済みビューがある場合は、<img src={infrastructureSavedViewsBttn} class="inline" style={{height: "30px", width: "95px"}} alt="Saved views" title="Saved views"/>
...
<CollapserGroup>
  ...
  >
    ...
    **Processes** テーブルでは、メトリック名でホストをフィルタリングできます。とともに<img src={infrastructureExportCSV} class="inline" style={{height: "30px", width: "30px"}} alt="Export CSV" title="Export CSV"/>
  ...
  >
    ...
    **Storage** テーブルでは、メトリック名でホストをフィルタリングできます。とともに<img src={infrastructureExportCSV} class="inline" style={{height: "30px", width: "30px"}} alt="Export CSV" title="Export CSV"/>
  ...
  >
    ...
    **Containers** テーブルでは、メトリクス名でホストをフィルタリングできます。とともに<img src={infrastructureExportCSV} class="inline" style={{height: "30px", width: "30px"}} alt="Export CSV" title="Export CSV"/>
