...
<CollapserGroup>
  ...
  >
    1 つ以上のホストの[閾値インシデント](/docs/alerts/new-relic-alerts/getting-started/alerts-glossary#alert-threshold)を表示するには、ホストの<DNT>**Critical**</DNT>を選択します。 <Icon name="fe-x-circle"/>アイコンまたは<DNT>**Warning**</DNT> <Icon name="fe-alert-triangle"/>アイコン。
  </Collapser>
</CollapserGroup>
