...
* [v1.12](https://docs.docker.com/engine/release-notes/prior-releases/#1120-2016-07-28) から [v23](https://docs.docker.com/engine/release-notes/23.0/)までのエンジンを搭載した Docker
...
また、インフラストラクチャ監視エージェントを含むDockerイメージを使用することもできます。詳しくは、 [インフラストラクチャモニタリング用Dockerコンテナ](/docs/infrastructure/install-infrastructure-agent/linux-installation/container-infrastructure-monitoring) をご覧ください。
