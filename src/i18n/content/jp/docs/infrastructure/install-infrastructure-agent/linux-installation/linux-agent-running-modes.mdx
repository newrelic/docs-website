  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <DNT>**Process samples**</DNT> 以下のメトリックは報告しないでください:
        ...
        * 1秒あたりのI/O書き込み回数
          ...
          次の<DNT>**inventory sources**</DNT>は報告されません:
...
<CollapserGroup>
  ...
  >
    実行モード<DNT>**from root to privileged or unprivileged**</DNT>を切り替えるには、このドキュメントのインストレーション/更新の手順に従ってください。
  </Collapser>
  ...
  >
    実行モードを変更するには <DNT>**from privileged or unprivileged to any other mode:**</DNT>
