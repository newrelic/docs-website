...
6. `newrelic-infra`パッケージをルート（デフォルト）または特権、非特権ユーザーモードでインストールします。各実行モードの詳細については、[Linuxエージェントの実行モード](/docs/infrastructure/install-configure-infrastructure/linux-installation/linux-agent-running-modes)を参照してください。
   ...
   <CollapserGroup>
     <Collapser
       ...
       title="ルート（デフォルト）"
     >
       * **<img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="Debian.png" alt="Debian.png" src={debian}/> Debianおよび<img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="ubuntu アイコン" alt="ubuntu アイコン" src={ubuntuIcon}/> Ubuntu**：

         ```
         sudo apt-get install newrelic-infra -y
         ```

       * **<img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="amazon linux.png" alt="amazon linux.png" src={amazonLinux}/> Amazon Linux、<img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="centosアイコン" alt="centosアイコン" src={centosIcon}/>CentOS、<img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="redhat アイコン" alt="redhat アイコン" src={redHatNew2}/> RHEL**：

         ```
         sudo yum install newrelic-infra -y
         ```

       * **<img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="suse アイコン" alt="suse アイコン" src={suseIcon}/> SLES**:
