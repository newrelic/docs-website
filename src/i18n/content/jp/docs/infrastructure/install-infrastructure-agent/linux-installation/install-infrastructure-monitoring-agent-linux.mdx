...
6. `newrelic-infra`パッケージをルート（デフォルト）または特権、非特権ユーザーモードでインストールします。各実行モードの詳細については、[Linuxエージェントの実行モード](/docs/infrastructure/install-configure-infrastructure/linux-installation/linux-agent-running-modes)を参照してください。
   ...
   <CollapserGroup>
     <Collapser
       ...
       title="ルート（デフォルト）"
     >
       * <DNT>**<img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="Debian.png" alt="Debian.png" src={osDebian}/>**</DNT>
       ...
       * <DNT>**<img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="amazon linux.png" alt="amazon linux.png" src={osAmazonLinux}/>**</DNT>
       ...
       * <DNT>**<img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="suse icon" alt="suse icon" src={osSuse}/>**</DNT>
