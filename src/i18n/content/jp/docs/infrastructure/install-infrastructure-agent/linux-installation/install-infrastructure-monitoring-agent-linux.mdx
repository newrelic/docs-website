...
6.  `newrelic-infra`パッケージをルート（デフォルト）または特権、非特権ユーザーモードでインストールします。各実行モードの詳細については、[Linux エージェントの実行モード](/docs/infrastructure/install-configure-infrastructure/linux-installation/linux-agent-running-modes)を参照してください。
    ...
    title="ルート（デフォルト）"
  >
    * **<ImageSizing width="32px" height="32px" verticalAlign="middle">![Debian.png](src/images/Debian.png "Debian.png")</ImageSizing> Debianおよび<ImageSizing width="32px" height="32px" verticalAlign="middle">![ubuntu アイコン](src/images/ubuntu-icon.png "ubuntu アイコン")</ImageSizing> Ubuntu**：

              ```
              sudo apt-get install newrelic-infra -y
              ```

            * **<ImageSizing width="32px" height="32px" verticalAlign="middle">![amazon linux.png](src/images/amazon-linux.png "amazon linux.png")</ImageSizing> Amazon Linux、<ImageSizing width="32px" height="32px" verticalAlign="middle">![centosアイコン](src/images/centos-icon.png "centosアイコン")</ImageSizing>CentOS、<ImageSizing width="32px" height="32px" verticalAlign="middle">![redhat アイコン](src/images/red-hat-new2.png "redhat アイコン")</ImageSizing> RHEL**：

              ```
              sudo yum install newrelic-infra -y
              ```

            * **<ImageSizing width="32px" height="32px" verticalAlign="middle">![suse アイコン](src/images/suse-icon.png "suse アイコン")</ImageSizing> SLES**:
...
- <ImageSizing width="32px" height="28px" verticalAlign="middle">
    ![Docker](src/images/docker-logo-crop.png "Docker")
  </ImageSizing>
