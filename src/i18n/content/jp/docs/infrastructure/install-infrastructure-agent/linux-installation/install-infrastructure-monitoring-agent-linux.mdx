...
2. ディストリビューションのバージョン番号を特定します。
   ...
   <CollapserGroup>
     <Collapser
       id="debian-version"
       title={<><ImageSizing width="32px" height="32px" verticalAlign="middle">![Debian.png](./images/Debian.png "Debian アイコン")</ImageSizing> Debian</>}
     >
       ```
       cat /etc/os-release
       ```
     ...
     <Collapser
       id="ubuntu-version"
       title={<><ImageSizing width="32px" height="32px" verticalAlign="middle">![ubuntu アイコン](./images/ubuntu-icon.png "ubuntu アイコン")</ImageSizing> Ubuntu</>}
     >
       ```
       cat /etc/lsb-release
       ```
     ...
     <Collapser
       ...
       title={<><ImageSizing width="32px" height="32px" verticalAlign="middle">![amazon linux.png](./images/amazon-linux.png "amazon linux.png")</ImageSizing> Amazon Linux、<ImageSizing width="32px" height="32px" verticalAlign="middle">![centosアイコン](./images/centos-icon.png "centosアイコン")</ImageSizing>CentOS、<ImageSizing width="32px" height="32px" verticalAlign="middle">![redhat アイコン](./images/red-hat-new2.png "redhat アイコン")</ImageSizing>RHEL</>}
     >
       ```
       cat /etc/os-release
       ```
     ...
     <Collapser
       id="sles-version"
       title={<><ImageSizing width="32px" height="32px" verticalAlign="middle">![suse アイコン](./images/suse-icon.png "suse アイコン")</ImageSizing> SLES</>}
     >
       ```
...
3. New RelicのGPGキーを有効にします。
   ...
   <CollapserGroup>
     <Collapser
       id="debian-gpg"
       title={<><ImageSizing width="32px" height="32px" verticalAlign="middle">![Debian.png](./images/Debian.png "Debian.png")</ImageSizing> Debian</>}
     >
       ```
...
4. Add the infrastructure monitoring agent repository:
   ...
   <CollapserGroup>
     ...
     <Collapser
       ...
       title={<><ImageSizing width="32px" height="32px" verticalAlign="middle">![amazon linux.png](./images/amazon-linux.png "amazon linux.png")</ImageSizing> Amazon Linux</>}
     >
       **Amazon Linux**
     ...
     <Collapser
       ...
       title={<><ImageSizing width="32px" height="32px" verticalAlign="middle">![centosアイコン](./images/centos-icon.png "centosアイコン")</ImageSizing> CentOS / <ImageSizing width="32px" height="32px" verticalAlign="middle">![redhat アイコン](./images/red-hat-new2.png "redhat アイコン")</ImageSizing>RHEL</>}
     >
       **CentOS 5.x, RHEL 5.x**
