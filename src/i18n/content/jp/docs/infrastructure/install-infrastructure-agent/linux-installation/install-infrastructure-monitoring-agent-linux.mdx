   ...
   <CollapserGroup>
     ...
     >
       * **<ImageSizing width="32px" height="32px" verticalAlign="middle"><img
           ...
           title="Debian.png"
           alt="Debian.png"
         /></ImageSizing> Debianおよび<ImageSizing width="32px" height="32px" verticalAlign="middle"><img
           src={ubuntuIcon}
           title="ubuntu アイコン"
           alt="ubuntu アイコン"
         /></ImageSizing> Ubuntu**：
       ...
       * **<ImageSizing width="32px" height="32px" verticalAlign="middle"><img
         ...
         /></ImageSizing> Amazon Linux、<ImageSizing width="32px" height="32px" verticalAlign="middle"><img
           src={centosIcon}
           title="centosアイコン"
           alt="centosアイコン"
         /></ImageSizing>CentOS、<ImageSizing width="32px" height="32px" verticalAlign="middle"><img
           src={redHatNew2}
           title="redhat アイコン"
           alt="redhat アイコン"
         /></ImageSizing> RHEL**：
