...
2. ディストリビューションのバージョン番号を特定します。
   ...
   <CollapserGroup>
     <Collapser
       id="debian-version"
       title={<><img src={debian} title="Debian アイコン" alt="Debian.png" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/> Debian</>}
     >
       ```
       cat /etc/os-release
       ```
     ...
     <Collapser
       id="ubuntu-version"
       title={<><img src={ubuntuIcon} title="ubuntu アイコン" alt="ubuntu アイコン" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/> Ubuntu</>}
     >
       ```
       cat /etc/lsb-release
       ```
     ...
     <Collapser
       ...
       title={<><img src={amazonLinux} title="amazon linux.png" alt="amazon linux.png" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/> Amazon Linux、<img src={centosIcon} title="centosアイコン" alt="centosアイコン" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>CentOS、<img src={redHatNew2} title="redhat アイコン" alt="redhat アイコン" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>RHEL</>}
     >
       ```
       cat /etc/os-release
       ```
     ...
     <Collapser
       id="sles-version"
       title={<><img src={suseIcon} title="suse アイコン" alt="suse アイコン" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/> SLES</>}
     >
       ```
...
4. Infrastructureモニタリングエージェント リポジトリを追加します。
   ...
   <CollapserGroup>
     ...
     <Collapser
       ...
       title={<><img src={centosIcon} title="centosアイコン" alt="centosアイコン" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/> CentOS / <img src={redHatNew2} title="redhat アイコン" alt="redhat アイコン" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>RHEL</>}
     >
       **RHEL 5.x**
