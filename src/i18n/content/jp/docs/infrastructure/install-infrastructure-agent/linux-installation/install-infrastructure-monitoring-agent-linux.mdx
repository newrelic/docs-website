...
6. `newrelic-infra`パッケージをルート（デフォルト）または特権、非特権ユーザーモードでインストールします。各実行モードの詳細については、[Linuxエージェントの実行モード](/docs/infrastructure/install-configure-infrastructure/linux-installation/linux-agent-running-modes)を参照してください。
   ...
   <CollapserGroup>
     <Collapser
       ...
       title="ルート（デフォルト）"
     >
       * **<ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={debian} title="Debian.png" alt="Debian.png"/></ImageSizing> Debianおよび<ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={ubuntuIcon} title="ubuntu アイコン" alt="ubuntu アイコン"/></ImageSizing> Ubuntu**：

         ```
         sudo apt-get install newrelic-infra -y
         ```

       * **<ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={amazonLinux} title="amazon linux.png" alt="amazon linux.png"/></ImageSizing> Amazon Linux、<ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={centosIcon} title="centosアイコン" alt="centosアイコン"/></ImageSizing>CentOS、<ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={redHatNew2} title="redhat アイコン" alt="redhat アイコン"/></ImageSizing> RHEL**：

         ```
         sudo yum install newrelic-infra -y
         ```

       * **<ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={suseIcon} title="suse アイコン" alt="suse アイコン"/></ImageSizing> SLES**:
