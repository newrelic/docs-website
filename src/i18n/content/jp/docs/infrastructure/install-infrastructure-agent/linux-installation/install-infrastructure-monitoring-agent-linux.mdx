   ...
   <CollapserGroup>
     ...
     >
       * **<ImageSizing width="32px" height="32px" verticalAlign="middle">![Debian.png](./images/Debian.png "Debian.png")</ImageSizing>Debianと<ImageSizing width="32px" height="32px" verticalAlign="middle">![ubuntu アイコン](./images/ubuntu-icon.png "ubuntu アイコン")</ImageSizing>Ubuntu**:
         ...
         ```
       * **<ImageSizing width="32px" height="32px" verticalAlign="middle">![amazon linux.png](./images/amazon%20linux.png "amazon linux.png")</ImageSizing> Amazon Linux、<ImageSizing width="32px" height="32px" verticalAlign="middle">![centosアイコン](./images/centos-icon.png "centosアイコン")</ImageSizing>CentOS、<ImageSizing width="32px" height="32px" verticalAlign="middle">![redhat アイコン](./images/red-hat-new2.png "redhat アイコン")</ImageSizing>RHEL**:
