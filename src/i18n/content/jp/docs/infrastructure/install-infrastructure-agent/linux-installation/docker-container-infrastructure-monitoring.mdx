...
1. New Relic<LicenseKey/>を使用して、 `newrelic-infra.yml`エージェント[構成ファイル](/docs/infrastructure/new-relic-infrastructure/configuration/configure-infrastructure-agent)を作成します。構成オプションの説明については、 [構成設定](/docs/infrastructure/install-configure-infrastructure/configuration/infrastructure-configuration-settings)を参照してください。
...
3. New Relic<LicenseKey/>を使用して、 `newrelic-infra.yml`エージェント[構成ファイル](/docs/infrastructure/new-relic-infrastructure/configuration/configure-infrastructure-agent)を作成します。構成オプションの説明については、 [構成設定](/docs/infrastructure/install-configure-infrastructure/configuration/infrastructure-configuration-settings)を参照してください。
