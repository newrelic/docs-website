...
<table>
  ...
  <tbody>
    <tr>
      <td>
        <ImageSizing width="32px" height="32px" verticalAlign="middle">![amazon linux.png](./images/amazon%20linux.png "amazon linux.png")</ImageSizing>[Amazon Linux](/docs/infrastructure-install-amazon-linux-centos-debian-rhel-or-ubuntu)
      </td>
    ...
    <tr>
      <td>
        <ImageSizing width="32px" height="32px" verticalAlign="middle">![Docker アイコン](./images/docker-icon.png "Docker アイコン")</ImageSizing>[Docker](https://docs.newrelic.co.jp/docs/infrastructure/install-configure-manage-infrastructure/docker-installation/docker-instrumentation-infrastructure)
      </td>
    ...
    <tr>
      <td>
        <ImageSizing width="32px" height="32px" verticalAlign="middle">![Kubernetes アイコン](./images/kubernetes-logo.png "Kubernetes アイコン")</ImageSizing>[Kubernetes](https://docs.newrelic.co.jp/docs/integrations/host-integrations/host-integrations-list/kubernetes-monitoring-integration)
      </td>
