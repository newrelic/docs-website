...
<Callout variant="important">
  New Relic CLI は FedRAMP サーバーをサポートしません。FedRAMP をご利用の場合は、 [Linux](/docs/infrastructure/install-infrastructure-agent/linux-installation/install-infrastructure-monitoring-agent-linux/)または[Windows](/docs/infrastructure/install-infrastructure-agent/windows-installation/install-infrastructure-monitoring-agent-windows/)用のインフラストラクチャ エージェントの手動インストール手順を参照してください。
</Callout>
