...
Infrastructre は、macOS [にも導入できます。](/docs/infrastructure/install-infrastructure-agent/macos-installation/install-infrastructure-monitoring-agent-macos/) 。
...
![エージェントとNew Relic](src/images/agents-and-nr.png 'エージェントとNew Relic')
