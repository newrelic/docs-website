...
`newrelic_install` リソース マネージャーは、最小限の構成で [ガイド付きインストールを](/docs/infrastructure/host-integrations/installation/new-relic-guided-install-overview)使用して New Relic をインストルメント化します。それは：
