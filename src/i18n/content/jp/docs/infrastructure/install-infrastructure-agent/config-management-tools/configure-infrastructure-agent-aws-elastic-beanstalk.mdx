...
セットアップが成功した後、New Relic にメトリクスが表示され始めるまでに最大 15 分かかる場合があります。 ホストのインフラストラクチャ ページを<DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DoNotTranslate>で表示します。
