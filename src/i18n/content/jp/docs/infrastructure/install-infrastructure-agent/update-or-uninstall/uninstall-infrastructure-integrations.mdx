...
<CollapserGroup>
  ...
  <Collapser id="uninstall-cassandra" title="カサンドラ">
    <table>
      <thead>
        <tr>
          <th style={{ width: "250px" }}>
  ...
  <Collapser id="uninstall-statsd" title="StatsD">
    1. `cd /path/to/statsd`
...
1. 以下の手順で、integrationsパッケージを削除します。古い統合機能の設定ファイルは削除されませんので、再度設定する必要はありません。
   ...
   <CollapserGroup>
     <Collapser id="uninstall-package-instructions" title="パッケージをアンインストールする">
       <table>
         <thead>
           <tr>
             <th style={{ width: "250px" }}>
