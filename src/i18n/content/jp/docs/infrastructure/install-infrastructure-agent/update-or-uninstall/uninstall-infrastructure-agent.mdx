...
<CollapserGroup>
  <Collapser
    id="apt-uninstall"
    title={<>apt ( <img src={osDebian} title="Debian icon" alt="Debian.png" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}>でアンインストール</img>デビアン、<img src={osUbuntu} title="ubuntu icon" alt="ubuntu icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>Ubuntu）</>}
  >
  ...
  <Collapser
    id="yum-uninstall"
    title={<>yum (<img src={osAmazonLinux} title="amazon linux.png" alt="amazon linux.png" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>アマゾン Linux、<img src={osCentos} title="centos icon" alt="centos icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>CentOS、<img src={osRedhat} title="redhat icon" alt="redhat icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>RHEL）</>}
  >
    root権限として、以下のコマンドを実行します。
...
## <img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="Windows Server" alt="Windows Server icon" src={osWindows}>をアンインストールする</img>インフラストラクチャエージェント [#uninstall-windows]
...
## <img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="macOS" alt="macOS icon" src={osMac}>をアンインストールする</img>macOSインフラストラクチャエージェント [#uninstall-macos]
