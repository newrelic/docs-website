...
## <img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="Windows Server" alt="Windows Server icon" src={windowsServerLogoSmall}>をアンインストールする</img>インフラストラクチャエージェント [#uninstall-windows]
...
## <img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="macOS" alt="macOS icon" src={macOsxLogo}>をアンインストールする</img>macOSインフラストラクチャエージェント [#uninstall-macos]
