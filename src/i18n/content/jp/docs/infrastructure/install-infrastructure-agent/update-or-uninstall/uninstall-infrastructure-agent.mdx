...
## アンインストール <ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={windowsServerLogoSmall} title="Windows Server" alt="Windows Serverアイコン"/> </ImageSizing>Windowsインフラストラクチャエージェント [#uninstall-windows]
...
## アンインストール <ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={macOsxLogo} title="macOS" alt="macOSアイコン"/> </ImageSizing>macOSインフラストラクチャエージェント [#uninstall-macos]
