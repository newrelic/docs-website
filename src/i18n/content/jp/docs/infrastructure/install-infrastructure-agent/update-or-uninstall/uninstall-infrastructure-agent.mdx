...
## アンインストール <ImageSizing width="32px" height="32px" verticalAlign="middle">![Windows Serverアイコン](./images/Windows_Server_logo_small.png 'Windows Server') </ImageSizing>Windows インフラストラクチャエージェント [#uninstall-windows]
...
## アンインストール <ImageSizing width="32px" height="32px" verticalAlign="middle">![macOSアイコン](./images/mac-osx-logo.png 'macOS') </ImageSizing>macOS インフラストラクチャエージェント [#uninstall-macos]
