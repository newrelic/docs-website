...
## アンインストール <img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} title="Windows Server" alt="Windows Serverアイコン" src={windowsServerLogoSmall}/> Windowsインフラストラクチャエージェント [#uninstall-windows]
...
## アンインストール <img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} title="macOS" alt="macOSアイコン" src={macOsxLogo}/> macOSインフラストラクチャエージェント [#uninstall-macos]
