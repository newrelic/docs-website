...
<CollapserGroup>
  ...
  >
    ...
    * [<img title="Ansible" alt="Ansible" src={ansibleRedLogo}/>](/docs/infrastructure/new-relic-infrastructure/config-management-tools/configure-new-relic-infrastructure-using-ansible)
    ...
    * [<img title="Chef" alt="Chef" src={chefLogo}/>](/docs/infrastructure/new-relic-infrastructure/config-management-tools/configure-new-relic-infrastructure-using-chef)
    ...
    * [<img title="Puppet" alt="Puppet" src={puppetLogo}/>](/docs/infrastructure/new-relic-infrastructure/config-management-tools/configure-new-relic-infrastructure-puppet)
