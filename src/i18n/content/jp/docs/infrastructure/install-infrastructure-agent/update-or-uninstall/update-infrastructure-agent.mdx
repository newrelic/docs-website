...
<CollapserGroup>
  <Collapser
    id="apt-update"
    title={<>aptを使用して更新する（<ImageSizing width="32px" height="32px" verticalAlign="middle">![Debian.png](./images/Debian.png "Debian アイコン")</ImageSizing>Debian、<ImageSizing width="32px" height="32px" verticalAlign="middle">![ubuntu アイコン](./images/ubuntu-icon.png "ubuntu アイコン")</ImageSizing>Ubuntu）</>}
  >
  ...
  <Collapser
    id="yum-update"
    title={<>yumを使用して更新する（<ImageSizing width="32px" height="32px" verticalAlign="middle">![amazon linux.png](./images/amazon-linux.png "amazon linux.png")</ImageSizing>Amazon Linux、<ImageSizing width="32px" height="32px" verticalAlign="middle">![centosアイコン](./images/centos-icon.png "centosアイコン")</ImageSizing>CentOS、<ImageSizing width="32px" height="32px" verticalAlign="middle">![redhat アイコン](./images/red-hat-new2.png "redhat アイコン")</ImageSizing>RHEL）</>}
  >
  ...
  <Collapser
    id="zypper-update"
    title={<>Zypperを使用して更新する（<ImageSizing width="32px" height="32px" verticalAlign="middle">![suse アイコン](./images/suse-icon.png "suse アイコン")</ImageSizing>SLES）</>}
  >
  ...
  <Collapser
    ...
    title={<><ImageSizing width="32px" height="32px" verticalAlign="middle">![Windows Serverアイコン](./images/Windows_Server_logo_small.png "Windows Server")</ImageSizing>Windowsサーバーでアップデートする（32 ビット）</>}
  >
  ...
  <Collapser
    id="windows-update"
    title={<><ImageSizing width="32px" height="32px" verticalAlign="middle">![Windows Serverアイコン](./images/Windows_Server_logo_small.png "Windows Server")</ImageSizing>Windowsサーバーでアップデートする（64 ビット）</>}
  >
    Windows Serverで、手動でInfrastructureエージェントを更新するには：
