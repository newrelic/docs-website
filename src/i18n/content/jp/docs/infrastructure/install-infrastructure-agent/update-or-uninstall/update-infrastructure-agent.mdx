...
<CollapserGroup>
  ...
  >
    ...
    * <ImageSizing width="32px" height="32px" verticalAlign="middle">[![Ansible](src/images/ansible-red-logo.png "Ansible")](/docs/infrastructure/new-relic-infrastructure/config-management-tools/configure-new-relic-infrastructure-using-ansible)</ImageSizing>
    ...
    * <ImageSizing width="32px" height="32px" verticalAlign="middle">[![Chef](src/images/chef-logo.png "Chef")](/docs/infrastructure/new-relic-infrastructure/config-management-tools/configure-new-relic-infrastructure-using-chef)</ImageSizing>
    ...
    * <ImageSizing width="32px" height="32px" verticalAlign="middle">![EBS](src/images/ebs.png "EBS")</ImageSizing>
    ...
    * <ImageSizing width="32px" height="32px" verticalAlign="middle">[![Puppet](src/images/puppet-logo.png "Puppet")](/docs/infrastructure/new-relic-infrastructure/config-management-tools/configure-new-relic-infrastructure-puppet)</ImageSizing>
