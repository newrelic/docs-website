...
<CollapserGroup>
  ...
  <Collapser
    ...
    title={<>で更新する<img src={windowsServerLogoSmall} title="Windows Server" alt="Windows Server icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>Windows Server（32ビット）</>}
  >
  ...
  <Collapser
    id="windows-update"
    title={<>で更新する<img src={windowsServerLogoSmall} title="Windows Server" alt="Windows Server icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>Windows Server（64ビット）</>}
  >
    Windows Serverで、手動でInfrastructureエージェントを更新するには：
