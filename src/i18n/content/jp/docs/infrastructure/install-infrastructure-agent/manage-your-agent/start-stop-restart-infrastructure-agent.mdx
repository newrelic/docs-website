...
* <DoNotTranslate>**SystemD**</DoNotTranslate> （Amazon Linux 2、SLES 12、CentOS 7以降、Debian 8以降、RHEL 7以降、Ubuntu 15.04以降）：
...
* <DoNotTranslate>**Upstart**</DoNotTranslate> （Amazon Linux、RHEL 6、Ubuntu 14.04以前）：
...
<Callout variant="important">
  エージェントを開始または停止、再起動するには、<DoNotTranslate>**Administrator**</DoNotTranslate>として`cmd.exe`またはPowerShellを実行する必要があります。
</Callout>
