...
## <img title="Linux" alt="Linux" src={otherlinux}/>Linux：起動、停止、再起動、エージェントのステータス確認 [#linux]
...
## <img title="Windows Server" alt="Windows Server" src={windows}/>Windows：起動、停止、再起動、エージェントのステータス確認 [#windows]
...
### <img title="CMD" alt="CMD" src={cmd}/>コマンドプロンプト（cmd.exe）
...
### <img title="PowerShell" alt="PowerShell" src={ps}/> PowerShell
