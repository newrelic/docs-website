...
## ![Linux](./image/otherlinux.png "Linux")Linux：エージェントの起動、停止、再起動、ステータス確認 [#linux]
...
## ![Windows Server](./image/windows.png "Windows Server") Windows：エージェントの起動、停止、再起動、ステータス確認 [#windows]
...
### ![CMD](./image/cmd.png "CMD") コマンドプロンプト（cmd.exe）
...
### ![PowerShell](./image/ps.png "PowerShell") PowerShell
