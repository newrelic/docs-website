...
## <img src={otherlinux} title="Linux" alt="Linux"/>Linux：起動、停止、再起動、エージェントのステータス確認 [#linux]
...
## <img src={windows} title="Windows Server" alt="Windows Server"/>Windows：起動、停止、再起動、エージェントのステータス確認 [#windows]
...
### <img src={cmd} title="CMD" alt="CMD"/>コマンドプロンプト（cmd.exe）
...
### <img src={ps} title="PowerShell" alt="PowerShell"/> PowerShell
