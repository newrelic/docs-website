...
<Callout variant="important">
  [バージョン1.4.0](/docs/release-notes/infrastructure-release-notes/infrastructure-agent-release-notes/new-relic-infrastructure-agent-140)以降、インフラストラクチャエージェントパッケージには、実行中のエージェントのトラブルシューティングに役立つ追加の`newrelic-infra-ctl`バイナリが含まれています。このバイナリはエージェントの実行には必要ありませんが、パスに追加することをお勧めします。詳細について[は、実行中のインフラストラクチャエージェントのトラブルシューティング](/docs/infrastructure/install-configure-manage-infrastructure/manage-your-agent/troubleshoot-running-agent)に関するドキュメントを参照してください。
</Callout>
