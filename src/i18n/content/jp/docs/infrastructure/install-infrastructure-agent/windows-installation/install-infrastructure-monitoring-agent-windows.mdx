...
Infrastructureモニタリングエージェントは、Windows ServerおよびWindows 10を[サポート](/docs/infrastructure/install-infrastructure-agent/get-started/requirements-infrastructure-agent)しています。[Chefでインストール](/docs/infrastructure/new-relic-infrastructure/config-management-tools/configure-new-relic-infrastructure-using-chef)することもできます。
