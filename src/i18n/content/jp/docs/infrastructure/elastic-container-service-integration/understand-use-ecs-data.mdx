...
1. **[one.newrelic.com](https://one.newrelic.com)**にアクセスし、 [**Explorer**](/docs/new-relic-one/use-new-relic-one/ui-data/new-relic-one-entity-explorer-view-performance-across-apps-services-hosts)を選択します。
