          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  **ホスト：** [https://cloud.getdbt.com/api/v2/accounts/ACCOUNT\_ID/](https://cloud.getdbt.com/api/v2/accounts/ACCOUNT_ID/)（`ACCOUNT_ID`をdbt CloudアカウントIDに置き換えてください）
              ...
              <tr>
                ...
                <td>
                  **ホスト：** [https://metadata.cloud.getdbt.com/graphql](https://metadata.cloud.getdbt.com/graphql)
              ...
              <tr>
                ...
                <td>
                  **ホスト：** [https://insights-collector.newrelic.com/v1/accounts/ACCOUNT\_ID/events](https://insights-collector.newrelic.com/v1/accounts/ACCOUNT_ID/events)（`ACCOUNT_ID`をアカウントIDに置き換えてください）
              ...
              <tr>
                ...
                <td>
                  **ホスト：** [https://insights-api.newrelic.com/v1/accounts/ACCOUNT\_ID/query](https://insights-api.newrelic.com/v1/accounts/ACCOUNT_ID/query)（`ACCOUNT_ID`をアカウントIDに置き換えてください）
