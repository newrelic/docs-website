...
<Callout variant="tip">
  [New Relic](/docs/new-relic-one/use-new-relic-one/get-started/introduction-new-relic-one)で PromQL スタイルを実行するには、 [詳細ビルダーの高度な PromQL スタイル モード](/docs/infrastructure/prometheus-integrations/view-query-data/view-query-your-prometheus-data/#build-query)に移動します。
</Callout>
