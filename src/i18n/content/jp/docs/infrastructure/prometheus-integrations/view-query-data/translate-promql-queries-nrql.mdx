...
<CollapserGroup>
  ...
  >
    ...
    <figcaption>
      <DoNotTranslate>**PromQL-style example:**</DoNotTranslate> 데이터를 필터링하려면 다음 PromQL 스타일 쿼리를 실행하세요: container_memory_usage_bytes&#x7B;id="/".
    </figcaption>
  </Collapser>
  ...
  >
    ...
    <figcaption>
      <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Query your data**</DoNotTranslate>: この例は、実行後に表示されるデータを示しています FROM Metric SELECT keyset() WHERE metricName = 'container_memory_usage_bytes'。
    </figcaption>
    ...
    <figcaption>
      <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Query your data**</DoNotTranslate>: この例は、実行後に表示されるデータを示しています FROM Metric SELECT latest(container_memory_usage_bytes) FACET id。
    </figcaption>
    ...
    <figcaption>
      <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Query your data**</DoNotTranslate>: この例では、 `From Metric select latest(container_memory_usage_bytes) where id = "/" timeseries`実行した後に表示されるデータを示します。
    </figcaption>
  </Collapser>
</CollapserGroup>
