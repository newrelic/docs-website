...
<CollapserGroup>
  ...
  <Collapser
    id="avg-free-memory"
    title={<><img src="/images/os_icon_docker.webp" title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}/>ドッカー。スクレイピングされたエンドポイントの平均メモリ使用量を表示</>}
  >
  ...
  <Collapser
    ...
    title={<><img src="/images/os_icon_k8.webp" title="img-integration-k8.png" alt="img-integration-k8.png" style={{ height: '35px', width: '40px' }}/>Kubernetesを使用しています。デプロイメント内のポッドの平均メモリ使用量を表示する</>}
  >
...
Prometheus インテグレーションのデータのNRQLクエリ結果を表示するには、<DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Query your data**</DNT> に移動します。 詳細については、[クエリビルダーのドキュメント](/docs/chart-builder/use-chart-builder/get-started/introduction-chart-builder)を参照してください。
