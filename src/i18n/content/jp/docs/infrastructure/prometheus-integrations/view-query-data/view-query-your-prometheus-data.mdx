...
Prometheus 統合のデータの NRQL クエリ結果を表示するには、 **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Query your data**に移動します。詳細については、 [クエリ ビルダーのドキュメントを](/docs/chart-builder/use-chart-builder/get-started/introduction-chart-builder)参照してください。
