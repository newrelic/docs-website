...
<CollapserGroup>
  ...
  <Collapser
    id="avg-free-memory"
    title={<><img src={osDocker} title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}/>ドッカー。スクレイピングされたエンドポイントの平均メモリ使用量を表示</>}
  >
  ...
  <Collapser
    ...
    title={<><img src={osk8} title="img-integration-k8.png" alt="img-integration-k8.png" style={{ height: '35px', width: '40px' }}/>Kubernetesを使用しています。デプロイメント内のポッドの平均メモリ使用量を表示する</>}
  >
