...
Prometheus 統合のデータの NRQL クエリ結果を表示するには: **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Query your data**に移動します。詳細については、[クエリ ビルダーのドキュメント](/docs/chart-builder/use-chart-builder/get-started/introduction-chart-builder)を参照してください。
