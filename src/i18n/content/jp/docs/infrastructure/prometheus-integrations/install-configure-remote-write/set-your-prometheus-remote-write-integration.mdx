...
[Prometheusオペレーター](https://github.com/prometheus-operator/prometheus-operator)を使用している場合は、データをレポートするアカウントのNew Relic[ライセンスキー](/docs/apis/intro-apis/new-relic-api-keys/#overview-keys)でシークレットを作成する必要があります。APIキーがタイプ`Ingest - License`であることを確認します。
