...
[New Relic OneのPrometheusリモート書込みセットアップランチャー](https://one.newrelic.com/launcher/nr1-core.settings?pane=eyJuZXJkbGV0SWQiOiJwcm9tZXRoZXVzLXJlbW90ZS13cml0ZS1pbnRlZ3JhdGlvbi1uZXJkbGV0cy5zZXR1cC1wcm9tZXRoZXVzIn0=)に移動してから、これらの手順を実行してPrometheusデータを追加します。
