...
<Callout variant="tip">
  `values.yaml`ファイルに New Relic ライセンス キーを追加する必要があります。ライセンス キーとその検索方法の詳細については、[主要な API キー を](/docs/apis/intro-apis/new-relic-api-keys/#overview-keys)お読みください。
</Callout>
...
* ガイド付きインストールを使用した場合は、 **Scrape only metrics from Prometheus integrations **オプションの選択を解除します。<img title="Kubernetes Guided Install" alt="Kubernetes Guided Install" src={infrastructurePrometheusScrapeOnlyMetrics}/>
