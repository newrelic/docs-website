...
* ガイド付きインストールを使用した場合は、 <DNT>**Scrape all Prometheus endpoints**</DNT>オプションを選択します。<img title="Kubernetes Guided Install" alt="Kubernetes Guided Install" src="/images/infrastructure_screenshot-crop_prometheus-scrape-only-metrics.webp"/>
