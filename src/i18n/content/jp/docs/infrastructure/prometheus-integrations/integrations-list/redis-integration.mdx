...
4. [Redis (Prometheus) クイックスタート](https://newrelic.com/instant-observability/redis-prometheus)をインストールして、組み込みのダッシュボードと[アラート](/docs/alerts-applied-intelligence/new-relic-alerts/learn-alerts/introduction-alerts/)にアクセスします。
