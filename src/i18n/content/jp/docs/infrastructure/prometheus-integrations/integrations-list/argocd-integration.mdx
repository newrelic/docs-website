...
4. [](https://newrelic.com/instant-observability/argocd-quickstart)組み込みの<InlinePopover type="dashboards" /> と[ アラート にアクセスするには、 Argo](/docs/alerts-applied-intelligence/new-relic-alerts/learn-alerts/introduction-alerts/) CD クイックスタート をインストールします。
