...
import kubernetesArgoCDDashboard from 'images/kubernetes_screenshot-argocd-dashboard.webp'
...
4. [Argo CDクイックスタートを](https://newrelic.com/instant-observability/argocd-quickstart) インストールしてビルトインにアクセス <InlinePopover type="dashboards"/>と [アラート](/docs/alerts-applied-intelligence/new-relic-alerts/learn-alerts/introduction-alerts/)。
