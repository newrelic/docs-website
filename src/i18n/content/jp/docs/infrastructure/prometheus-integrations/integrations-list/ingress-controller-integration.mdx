...
4. [NGINX Ingress Controller クイックスタートを](https://newrelic.com/instant-observability/nginx-ingress-controller)インストールして、組み込みのダッシュボードと[アラート](/docs/alerts-applied-intelligence/new-relic-alerts/learn-alerts/introduction-alerts/)にアクセスします。
