...
4. 組み込みの と[ アラート](/docs/alerts-applied-intelligence/new-relic-alerts/learn-alerts/introduction-alerts/) にアクセスするには、 [Etcd クイックスタート をインストールします。](https://newrelic.com/instant-observability/etcd)<InlinePopover type="dashboards" />
