...
4. [Etcd クイックスタート](https://newrelic.com/instant-observability/etcd)をインストールして、組み込みのダッシュボードと[アラート](/docs/alerts-applied-intelligence/new-relic-alerts/learn-alerts/introduction-alerts/)にアクセスします。
