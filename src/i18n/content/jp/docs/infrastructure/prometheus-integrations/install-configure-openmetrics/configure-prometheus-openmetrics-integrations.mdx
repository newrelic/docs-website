...
<ImageSizing width="40px" height="35px"><img src={dockerLogoCrop} title="Docker アイコン" alt="Docker アイコン"/> </ImageSizing>**Docker:**
...
<ImageSizing width="40px" height="35px"><img src={dockerLogoCrop} title="Docker アイコン" alt="Docker アイコン"/> </ImageSizing>**Docker:** 先ほどの設定ファイルで統合を実行するため。
