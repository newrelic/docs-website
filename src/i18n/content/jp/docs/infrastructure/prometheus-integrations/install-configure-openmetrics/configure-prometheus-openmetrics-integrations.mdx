...
<img style={{ width: '40px', height: '35px'}} title="Docker アイコン" alt="Docker アイコン" src={dockerLogoCrop}/> **Docker:**
...
<img style={{ width: '40px', height: '35px'}} title="Docker アイコン" alt="Docker アイコン" src={dockerLogoCrop}/> **Docker:** 先ほどの設定ファイルで統合を実行するため。
