...
<img title="Docker アイコン" alt="Docker アイコン" src={dockerLogoCrop}/> **ドッカーです。**
...
<img title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png" src={imgIntegrationK8}/> **Kubernetesです。**
