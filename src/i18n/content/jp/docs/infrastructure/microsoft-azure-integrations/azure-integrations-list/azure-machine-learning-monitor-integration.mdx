...
次の表に、Microsoft.MachineLearningServices/workspaces/onlineEndpoints/deployments リソース タイプで使用できるメトリックを示します。
...
次の表に、Microsoft.MachineLearningServices/workspaces/onlineEndpoints リソース タイプで使用できるメトリックを示します。
