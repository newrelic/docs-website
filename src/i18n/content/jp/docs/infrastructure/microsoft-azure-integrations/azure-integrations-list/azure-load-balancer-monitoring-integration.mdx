...
[データを照会して探索する](/docs/using-new-relic/data/understand-data/query-new-relic-data) `AzureLoadBalancerSample` [イベントタイプ](/docs/data-apis/understand-data/new-relic-data-types/#event-data), `provider` 値 `AzureLoadBalancer` を使用することができます。
