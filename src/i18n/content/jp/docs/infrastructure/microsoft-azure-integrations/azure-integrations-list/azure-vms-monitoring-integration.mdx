...
[<DNT>**Host not reporting**</DNT>アラート条件を使用する場合、VM の Azure メタデータのインポートによってホストのレジストリが変更され、誤った集計通知が発生します。 誤検知を防ぐには:](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#attribute)

1. [](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#attribute)

2. [各 Azure インスタンスについて、 ](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#attribute)

   <DNT>[**Host not reporting**](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#attribute)</DNT>

   [アラート条件](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#attribute)[を無効にします](/docs/infrastructure/new-relic-infrastructure/infrastructure-alert-conditions/infrastructure-alerts-add-edit-or-view-host-alert-information#maintain-alerts)。
...
4. 各
   ...
   アラート条件[を再度有効にします](/docs/infrastructure/new-relic-infrastructure/infrastructure-alert-conditions/infrastructure-alerts-add-edit-or-view-host-alert-information#maintain-alerts)。