...
1. Azure Portal
   ...
   <DNT>**Subscriptions**</DNT>

   セクションで、 New Relicでモニターするサブスクリプションを選択します。

2. <DNT>**Access control (IAM) > Add**</DNT>
...
3. <DNT>**Role**</DNT>
   ...
   <DNT>**Billing Reader**</DNT>

   を選択します。

4. <DNT>**Select**</DNT>

   ドロップダウンからアプリの名前を選択します (例: `NewRelic-Integrations` )。

5. <DNT>**Selected members**</DNT>
