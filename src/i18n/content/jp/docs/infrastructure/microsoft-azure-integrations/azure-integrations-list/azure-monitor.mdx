...
この統合により、Azure Native New Relic Service が強化されます。これは、Azure から直接 New Relic をセットアップおよび構成し、New Relic データを Azure に保存できるサービスです。[Azure ネイティブ New Relic サービスの詳細をご覧ください。](/docs/infrastructure/microsoft-azure-integrations/get-started/azure-native)
