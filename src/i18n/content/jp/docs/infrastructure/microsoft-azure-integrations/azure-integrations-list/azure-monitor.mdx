...
3. **Azure Monitor metrics** \[Azure Monitor メトリクス] の 統合が利用可能になります。<img title="Shows where azure monitor metrics integration" alt="Shows where azure monitor metrics integration" src={infrastructureAzureMonitorMetricsConfigure}/>
