...
2. 新しい<DNT>**Azure Monitor metrics**</DNT>インテグレーションを有効にして、 <DNT>**Save Changes**</DNT>をクリックします。<img
   ...
   />
3. <DNT>**Azure Monitor metrics**</DNT>インテグレーションが利用可能になります。<img
