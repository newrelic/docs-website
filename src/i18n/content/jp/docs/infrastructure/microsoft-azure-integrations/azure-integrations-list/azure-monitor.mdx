...
2. <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Azure**</DNT>
...
2. 新しい<DNT>**Azure Monitor metrics**</DNT>インテグレーションを有効にして、 <DNT>**Save Changes**</DNT>をクリックします。<img title="Shows where to enable the Azure monitor" alt="Shows where to enable the Azure monitor" src={infrastructureAzureMonitorMetricsIntegration}/>
3. <DNT>**Azure Monitor metrics**</DNT>インテグレーションが利用可能になります。<img title="Shows where azure monitor metrics integration" alt="Shows where azure monitor metrics integration" src={infrastructureAzureMonitorMetricsConfigure}/>
4. 新しいインテグレーションを有効にして構成します。<img title="Shows where azure monitor enable toggle button" alt="Shows where azure monitor enable toggle button" src={infrastructureAzureMonitorEnableToggle}/>
