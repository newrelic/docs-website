...
[New Relic には、](/docs/infrastructure/introduction-infra-monitoring) AzureApp Gateway データをプラットフォームにレポートするための 統合が含まれています 。ここでは、インテグレーションを有効にする方法と、インテグレーションが収集するデータについて説明します。
