...
[データを照会して探索することができます](/docs/using-new-relic/data/understand-data/query-new-relic-data) `AzureRedisCacheSample` [イベントタイプ](/docs/data-apis/understand-data/new-relic-data-types/#event-data) と、サービスでシャードが構成されている場合、 `AzureRedisCacheShardSample` イベントタイプを使用することができます。
