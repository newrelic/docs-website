...
各ポーリング統合からどのようなメトリックが利用できるか、およびその名前については、 [個々の統合のドキュメントを確認してください](https://docs.newrelic.com/docs/infrastructure/microsoft-azure-integrations/get-started/activate-azure-integrations/)。
