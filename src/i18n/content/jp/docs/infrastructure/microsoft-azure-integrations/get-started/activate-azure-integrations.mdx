...
これらのインテグレーション有効化に関する解説をInfrastructure UIから直接利用するには、**[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > Azure > Add an Azure account**に進みます。
