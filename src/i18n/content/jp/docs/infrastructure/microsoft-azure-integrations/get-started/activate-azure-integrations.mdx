...
* 必要な情報を**インテグレーション**UIに配置します。

これらのインテグレーション有効化に関する解説をInfrastructure UIから直接利用するには、**[one.newrelic.com](https://one.newrelic.com) > Infrastructure > Azure > Add an Azure account**に進みます。
...
1. **[one.newrelic.com](https://one.newrelic.com) > Infrastructure > Azure**に進み、追加するAzure Serviceを選択します。
...
Azureインテグレーションを有効にすると、当社は定期的な[ポーリング間隔](/docs/infrastructure/microsoft-azure-integrations/azure-integrations-list/azure-polling-intervals-infrastructure-integrations)でAzureデータをモニターし始めます。[データを検索し使用する](/docs/infrastructure/integrations/find-use-infrastructure-integration-data)には、[データエクスプローラー](/docs/query-your-data/explore-query-data/data-explorer/introduction-data-explorer)を使用するか、**[one.newrelic.com](https://one.newrelic.com) > Infrastructure > Azure**の順に移動します。
...
1. **[one.newrelic.com](https://one.newrelic.com) > Infrastructure > Azure**に移動し、編集するAzureアカウントで**Manage Services**をクリックします。
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        1. **[one.newrelic.com](https://one.newrelic.com) > Infrastructure > Azure > Manage services**に移動します。
