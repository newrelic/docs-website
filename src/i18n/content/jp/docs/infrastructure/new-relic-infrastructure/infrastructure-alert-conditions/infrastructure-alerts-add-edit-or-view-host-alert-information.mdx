...
3. **Events** \[イベント] リストから、アラート・インシデントを選択します。
...
アラート条件の **Description** \[説明] フィールドに入力したテキストは、関連するインシデントと通知にダウンストリームで渡されます。説明は、次のようなさまざまな目的に使用できます。
