...
1. **[one.newrelic.com](http://one.newrelic.com) >インフラストラクチャ**に移動し、次のインフラストラクチャ監視ページのいずれかを選択します： [**ホスト**](/docs/infrastructure/new-relic-infrastructure/infrastructure-ui-pages/infrastructure-compute-page-measure-resource-usage)、 [**プロセス**](/docs/infrastructure/new-relic-infrastructure/infrastructure-ui-pages/infrastructure-processes-page-inspect-process-performance)、 [**ネットワーク**](/docs/infrastructure/new-relic-infrastructure/infrastructure-ui-pages/infrastructure-network-page-measure-compare-capacity)、または[**ストレージ**](/docs/infrastructure/new-relic-infrastructure/infrastructure-ui-pages/infrastructure-storage-page-evaluate-disk-usage-efficiency)。警告するチャートにマウスを合わせ、省略記号を選択します<Icon name="fe-more-horizontal"/>アイコンをクリックし、\[**アラートの作成**]を選択します。
...
<CollapserGroup>
  <Collapser
    ...
    title="アラートUIを使用する"
  >
    **[one.newrelic.com](http://one.newrelic.com) >アラートとAI** **>アラート>****アラートポリシー>新しいアラートポリシー>新しい条件の作成**に移動し、製品として**インフラストラクチャ**を選択します。
  </Collapser>
  ...
  >
    1. **[one.newrelic.com](http://one.newrelic.com) >インフラストラクチャ**に移動します。
  ...
  >
    ...
    1. **[one.newrelic.com](http://one.newrelic.com)** >**インフラストラクチャ**>**設定**>**アラート**に移動し、**アラート条件の作成**をクリックします。
...
1. **[one.newrelic.com](http://one.newrelic.com) >インフラストラクチャ>****イベント**に移動します。
...
1. **[one.newrelic.com](http://one.newrelic.com) > インフラストラクチャー>** **設定> アラート**.
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * [メール通知が必要なポリシーのみの場合](#notification): **[one.newrelic.com](http://one.newrelic.com) > インフラストラクチャ** **> 設定> アラート> 新しいポリシー** を作成し、必要に応じて1つまたは複数のメールアドレスを追加します。
    ...
    <tr>
      ...
      <td>
        ...
        1. **[one.newrelic.com](http://one.newrelic.com) >インフラストラクチャ****>設定>アラート**に移動します。
