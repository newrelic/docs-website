...
<CollapserGroup>
  <Collapser
    ...
    title="アラートUIを使用する"
  >
    **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI > Alerts > Alert policies > New alert policy > Create new condition**に移動し、製品として**Infrastructure**を選択します。
  </Collapser>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * [メール通知](#notification)のみが必要なポリシーの場合: **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > Settings > Alerts > Create a new policy**に移動し、必要に応じて 1 つ以上のメールアドレスを追加します。
