...
New Relic のインフラ監視では、フィルターを **フィルターセット** に組み合わせて、自分にとって最も重要な基準に基づいてホストを整理することができます。

フィルターセットのメリットや使い方、理屈などをご紹介します。

## フィルターセットのメリット [#benefits]
