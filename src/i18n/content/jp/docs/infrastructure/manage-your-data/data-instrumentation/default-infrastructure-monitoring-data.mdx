...
<table>
  ...
  <tbody>
    <tr>
      <td>
        [`SystemSample`](https://jajp-newrelic-docs.onelink-translations.com/attribute-dictionary?attribute_name=&events_tids%5B%5D=8407)
      </td>
    ...
    <tr>
      <td>
        [`ProcessSample`](https://jajp-newrelic-docs.onelink-translations.com/attribute-dictionary?attribute_name=&events_tids%5B%5D=8412)
      </td>
    ...
    <tr>
      <td>
        [`StorageSample`](https://jajp-newrelic-docs.onelink-translations.com/attribute-dictionary?attribute_name=&events_tids%5B%5D=8417)
      </td>
    ...
    <tr>
      <td>
        [`NetworkSample`](https://jajp-newrelic-docs.onelink-translations.com/attribute-dictionary?attribute_name=&events_tids%5B%5D=8422)
      </td>
    ...
    <tr>
      ...
      <td>
        `ContainerSample`は、各Dockerコンテナに関する説明と状態に関する情報を収集します。この情報には、コンテナのID、名前、イメージ、イメージ名、またCPU、メモリ、ネットワークに関するメトリックスも含まれています。各コンテナに関して、このデータのスナップショットは15秒おきに記録され、`ContainerSample`イベントにパッケージされます。これがNew Relicに送信されます。このデータは[**Containers**UIページ](https://jajp-newrelic-docs.onelink-translations.com/docs/infrastructure/new-relic-infrastructure/infrastructure-ui-pages/infrastructure-hosts-page-measure-resource-usage)に表示されます。詳しくは、[Dockerモニタリング](/docs/infrastructure/new-relic-infrastructure/data-instrumentation/docker-instrumentation-infrastructure)をご覧ください。
      </td>
    </tr>

    <tr>
      <td>
        [`InfrastructureEvent`](https://jajp-newrelic-docs.onelink-translations.com/attribute-dictionary?attribute_name=&events_tids%5B%5D=8402)
      </td>
