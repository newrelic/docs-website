...
[インフラストラクチャ エージェントの統合により、](/docs/infrastructure/host-integrations/installation/install-infrastructure-host-integrations) データがインフラストラクチャ エージェントに送信され、インフラストラクチャ エージェントがそのデータを New Relic に送信します。統合がエージェントと対話する方法は、各統合の構成によって制御されます。
