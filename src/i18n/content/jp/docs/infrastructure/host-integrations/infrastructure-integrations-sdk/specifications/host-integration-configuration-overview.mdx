...
* エージェントが想定するJSON形式でさまざまな [タイプのデータ](/docs/infrastructure/infrastructure-data/default-infra-data/) をエクスポートする[ 実行可能ファイル](/docs/infrastructure/infrastructure-integrations/custom-integrations/create-integration-executable-file)
...
* <DNT>**Standard**</DNT>: 2019 年 12 月から、[インフラストラクチャエージェント バージョン 1.8.0 は](/docs/release-notes/infrastructure-release-notes/infrastructure-agent-release-notes)、一部のインテグレーションで使用される新しい形式のサポートを開始しました。 この形式では、単一の設定ファイルが使用され、その他の改善も提供されます。 詳細については、 [標準設定](/docs/create-integrations/infrastructure-integrations-sdk/specifications/host-integrations-standard-configuration-format)を参照してください。
* <DNT>**Legacy**</DNT>: これはほとんどのオンホストインテグレーションで使用される形式です。 この設定では、定義ファイルと設定ファイルの 2 つのファイルを使用します。 詳細については、 [レガシー設定](/docs/create-integrations/infrastructure-integrations-sdk/specifications/host-integrations-legacy-configuration-format/)を参照してください。