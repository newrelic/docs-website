...
import infrastructureAgentsandNr from 'images/infrastructure_diagram_agents-and-nr.png'
...
<CollapserGroup>
  ...
  <Collapser
    id="apt"
    title={<>aptでインストール（<img src={osDebian} title="Debian icon" alt="Debian.png" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>Debian、<img src={osUbuntu} title="ubuntu icon" alt="ubuntu icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>Ubuntu）</>}
  >
  ...
  <Collapser
    id="yum"
    title={<>yumでインストール（<img src={osAmazonLinux} title="amazon linux.png" alt="amazon linux.png" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>Amazon Linux、<img src={osCentos} title="centos icon" alt="centos icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>CentOS、<img src={osRedhat} title="redhat icon" alt="redhat icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>RHEL）</>}
  >
