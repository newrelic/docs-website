...
<CollapserGroup>
  ...
  >
    <DNT>**Recommendation:**</DNT> [](/docs/infrastructure/new-relic-infrastructure/installation/update-infrastructure-agent)インフラストラクチャエージェント（[ バージョン 1.0.703 以上](/docs/release-notes/infrastructure-release-notes/infrastructure-agent-release-notes) ） を更新します 。
