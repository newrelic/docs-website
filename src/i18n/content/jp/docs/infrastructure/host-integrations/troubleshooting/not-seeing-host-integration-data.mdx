...
New Relic とのオンホスト統合を作成しましたが、インフラストラクチャ UI にデータが表示されません。

## 解決

トラブルシューティングと問題解決のために

1. 統合がアクティブ化され、レポートが作成されているかどうかを確認します。**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Third-party Services** に移動し、 **Active integrations** \[アクティブな統合]で統合名を探します。
