...
1. 統合がアクティブ化され、レポートされているかどうかを確認します。**[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > Third-party Services**に移動し、 **Active integrations**の下で統合名を探します。
