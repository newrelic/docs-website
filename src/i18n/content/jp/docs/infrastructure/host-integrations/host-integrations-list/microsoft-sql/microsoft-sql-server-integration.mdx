...
当社の統合は、Microsoft SQL Server 2014 以降と互換性があります。
...
統合データを見つけるには、 **[one.newrelic.com](https://one.newrelic.com) > Infrastructure > Third-party services**に移動し、Microsoft SQL Server 統合リンクのいずれかを選択します。
