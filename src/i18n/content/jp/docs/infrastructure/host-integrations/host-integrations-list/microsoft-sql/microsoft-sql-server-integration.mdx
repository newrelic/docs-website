...
3. [MicrosoftSQLServerを有効にします](#enable-microsoft-sql-server)。
4. [インテグレーションの設定](#config)。
5. [データの検索と使用](#find-and-use)。
6. 必要に応じて、 [MicrosoftSQLServerの構成設定](/docs/infrastructure/host-integrations/host-integrations-list/microsoft-sql/microsoft-sql-server-config)を参照してください。
...
* [32ビットWindows](http://download.newrelic.com/infrastructure_agent/windows/integrations/nri-mssql/386/nri-mssql-386.msi)
* [64ビットWindows](http://download.newrelic.com/infrastructure_agent/windows/integrations/nri-mssql/nri-mssql-amd64.msi)
