...
4. お気に入りのエディタで `kafka-config.yml` 構成ファイルを編集します。いくつかの [構成ファイルの例を確認してください。](#examples) 。
...
<CollapserGroup>
  <Collapser
    id="windows-install"
    title={<><img src="/images/os_icon_windows.webp" title="Windows installation" alt="Windows installation" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>Windowsへのインストレーション</>}
  >
    1. [New Relicの Kafka インテグレーションの .exe インストーラをダウンロードします](https://download.newrelic.com/infrastructure_agent/windows/integrations/nri-kafka/nri-kafka-amd64-installer.exe)。
  ...
  <Collapser
    id="ecs-install"
    title={<><img src="/images/os_icon_ecs.webp" title="Amazon ECS installation" alt="Amazon ECS installation" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>' ' Amazon ECSへのインストレーション</>}
  >
  ...
  <Collapser
    id="k8s-install"
    title={<><img src="/images/os_icon_k8.webp" title="Kubernetes installation" alt="Kubernetes installation" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>Kubernetesへのインストレーション</>}
  >
...
* <DNT>
  ...
  インテグレーションは、パッケージマネージャの外部にインストールできるように、 [tarball 形式](/docs/integrations/host-integrations/installation/install-host-integrations-built-new-relic#tarball)でも利用できます。
...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="SSL ベースの JMX 接続による Zookeeper 検出"
  >
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ブローカーごとおよびトピックごとのトピックのディスク サイズ。`COLLECT_TOPIC_SIZE`有効な場合にのみ存在します。
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            ブローカーごとおよびトピックごとのトピック オフセット。`COLLECT_TOPIC_OFFSET`有効な場合にのみ存在します。
          </td>
        </tr>
      </tbody>
    </table>
