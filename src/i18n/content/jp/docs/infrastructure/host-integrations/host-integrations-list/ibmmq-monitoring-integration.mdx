...
特定のLinuxバージョンの包括的なリストについては、 [互換性のあるオペレーティングシステム](/docs/infrastructure/install-infrastructure-agent/get-started/requirements-infrastructure-agent/#operating-systems)の表を確認してください。
...
* `LD_LIBRARY_PATH`環境変数のライブラリパスを確認または追加します。
