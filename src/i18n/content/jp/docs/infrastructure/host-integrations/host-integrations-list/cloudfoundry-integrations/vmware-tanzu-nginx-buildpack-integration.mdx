...
この製品はテスト済みで、v3.0 までの VMware Tanzu OpsManager バージョンおよび Tanzu アプリケーション サービス 5.0 および 6.0 と互換性があります。
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        VMware Tanzu 1.0.1 用New Relic NGINX 統合ビルドパック
      </td>
    </tr>
           ...
           * `manifest.yml`：
             ...
             * `newrelic_nginx_buildpack`の前に`nginx_buildpack`をインストールする必要があります。
               ...
               * 以下のページを参考にしてください。
                 ...
                 * [nginx_buildpack ドキュメント](https://docs.cloudfoundry.org/buildpacks/nginx/index.html)
