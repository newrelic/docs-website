...
2. \`CREATE USER を使用して、データベースに新しいユーザーを追加します。 USER_PASSWORD を 新しいユーザーのパスワード に置き換えます。
   ...
   cdb_data_filescdb_pdbscdb_usersgv_$sysmetricgv_$pgastatgv_$instancegv_$filestatgv_$parametersys.dba_data_filesgv_$sessiongv_$sesstatgv_$statnamegv_$rowcachegv_$sgagv_$sysstatv_$databasegv_$librarycachegv_$sqlareagv_$system_eventdba_tablespacesgv_$session_waitgv_$rollstatv\_$instance
