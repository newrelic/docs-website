...
1. お持ちのデータベースの種類を選択してください。ユーザーの保守に関する質問については、 [Oracle のドキュメント](https://docs.oracle.com/en/database/oracle/oracle-database/index.html)を参照するか、システム管理者またはデータベース管理者に問い合わせてください。
   ...
   <CollapserGroup>
     ...
     >
       マルチテナント データベースの場合は、ルート データベースに管理者としてログインします。`CREATE USER`を使用して、新しいユーザーをデータベースに追加します (指定されたユーザー名は「共通ユーザー」になり、Oracle が推奨するように「c##」を前に付ける必要があります)。USER_PASSWORD を \[新しいユーザーのパスワード] に置き換えます ( [https://docs.oracle.com/en/database/oracle/oracle-database/12.2/dbseg/keeping-your-oracle-database-secure.html#GUID-451679EB- 8676-47E6-82A6-DF025FD65156](https://docs.oracle.com/en/database/oracle/oracle-database/12.2/dbseg/keeping-your-oracle-database-secure.html#GUID-451679EB-8676-47E6-82A6-DF025FD65156) )。
...
Infrastructure で統合データを見つけるには、 **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > Third-party services**に移動し、Oracle Database 統合リンクのいずれかを選択します。
