...
New Relic で統合データを見つけるには、 **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > Third-party services** に移動し、Oracle Database 統合リンクの 1 つを選択します。
