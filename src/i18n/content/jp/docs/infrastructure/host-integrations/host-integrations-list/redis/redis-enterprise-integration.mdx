...
2. Redis Entprise インスタンスにログインし、
   ...
   <Callout variant="tip">
     内部アカウントの使用をお勧めしますが、LDAP が有効になっている場合は LDAP を使用できます。
   </Callout>
...
1. <DNT>**[one.newrelic.com/marketplace](https://one.newrelic.com/marketplace)**</DNT>に移動します。

2. <DNT>**Dashboards**</DNT>タブをクリックし、検索フィールドに<DNT>**Redis Enterprise**</DNT>と入力します。<img title="Redis Enterprise dashboards" alt="A screenshot of the Redis Enterprise dashboards." src="/images/infrastructure_screenshot-crop_redis-enterprise-dashboard.webp"/>
...
3. ダッシュボードの 1 つをクリックし、ドロップダウンからアカウントを選択します。 次に、 <DNT>**View dashboard**</DNT>をクリックしてアカウントに追加します。
