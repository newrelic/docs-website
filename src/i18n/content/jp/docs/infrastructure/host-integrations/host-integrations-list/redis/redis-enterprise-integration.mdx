...
2. Redis Entprise インスタンスにログインし、
   ...
   <Callout variant="tip">内部アカウントの使用をお勧めしますが、LDAP が有効になっている場合は LDAP を使用できます。</Callout>

3. <DNT>**Cluster View Permissions**</DNT>
...
2. <DNT>**Dashboards**</DNT>タブをクリックし、検索フィールドに<DNT>**Redis Enterprise**</DNT>と入力します。<img title="Redis Enterprise dashboards" alt="A screenshot of the Redis Enterprise dashboards." src={infrastructureRedisEnterpriseDashboard}/>
