...
2. **Dashboards** \[ダッシュボード]タブをクリックし、検索フィールドに**Redis Enterprise**と入力します。<img title="Redis Enterprise dashboards" alt="A screenshot of the Redis Enterprise dashboards." src={infrastructureRedisEnterpriseDashboard}/>
