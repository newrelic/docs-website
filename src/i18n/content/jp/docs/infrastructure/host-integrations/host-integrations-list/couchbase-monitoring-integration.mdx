...
<CollapserGroup>
  <Collapser id="bucket-parameters" title="バケットのパラメータ">
    <table>
      <thead>
        <tr>
  ...
  <Collapser id="cluster-parameters" title="クラスターパラメータ">
    <table>
      <thead>
        <tr>
          <th style={{ width: "300px" }}>
  ...
  <Collapser id="node-parameters" title="ノードパラメータ">
    <table>
      <thead>
        <tr>
          <th style={{ width: "300px" }}>
  ...
  <Collapser id="query-engine-parameters" title="クエリエンジンのパラメータ">
    <table>
      <thead>
        <tr>
          <th style={{ width: "300px" }}>
