...
<Steps>
  ...
  <Step>
    ...
    3. 検索ボックスで、
       ...
       <DoNotTranslate>**Unix**</DoNotTranslate>
...
セキュリティを強化するために、このインテグレーションはすべての属性に対して難読化された値をサポートします。 これを行うには、属性名に`_obfuscated`を追加し、 [New Relic CLI](https://github.com/newrelic/newrelic-cli)によって生成された難読化された値を指定します。
