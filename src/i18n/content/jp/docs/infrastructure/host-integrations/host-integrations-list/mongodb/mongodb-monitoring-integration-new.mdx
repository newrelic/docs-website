...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        監視対象のクラスタを一意に識別するためのユーザー定義の名前。 <DNT>**Required**</DNT>
      </td>
    ...
    <tr>
      ...
      <td>
        MongoDB 接続 URI。 <DNT>**Required**</DNT>
      </td>
...
次のディメンションメトリックは、エクスポーターをスクレイピングしてキャプチャされ、エンティティ<DNT>**MONGODB_COLLECTION**</DNT>にリンクされます。
...
次のディメンションメトリックは、エクスポーターをスクレイピングしてキャプチャされ、エンティティ<DNT>**MONGODB_DATABASE**</DNT>にリンクされます。
