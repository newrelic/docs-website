...
<CollapserGroup>
  ...
  >
    ...
    Prometheus メトリクスをスクレイピングして NewRelic に転送するには、さまざまな方法があります。 [詳細については、ドキュメントを](/docs/infrastructure/prometheus-integrations/install-configure-prometheus-agent/setup-prometheus-agent)確認してください。
