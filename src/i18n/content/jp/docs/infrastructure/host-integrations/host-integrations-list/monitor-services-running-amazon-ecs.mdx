...
3. ナビゲーション ペインの<DNT>**Auto scaling**</DNT>の下で、 <DNT>**Launch configurations**</DNT>を選択します。

4. 次のページでは、アップデートしたいローンチ構成を選択します。

5. 右クリックして<DNT>**Copy launch configuration**</DNT>を選択します。

6. <DNT>**Launch configuration details**</DNT>タブで、 <DNT>**Edit details**</DNT>をクリックします。
...
8. <DNT>**Skip to review**</DNT>を選択します。

9. <DNT>**Create launch configuration**</DNT>を選択します。
...
2. ナビゲーション ペインの
   ...
   <DNT>**Auto scaling**</DNT>

   の下で、

   <DNT>**Auto scaling groups**</DNT>
...
5. <DNT>**Launch configuration**</DNT>
