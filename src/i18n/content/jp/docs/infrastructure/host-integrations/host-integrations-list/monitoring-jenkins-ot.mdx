...
New Relicライセンスキーで秘密のテキストを作成していない場合は、<DoNotTranslate>**+ Add**</DoNotTranslate> ボタンをクリックして <DoNotTranslate>**Jenkins Credentials Provider**</DoNotTranslate> を選択し、秘密のテキストを作成します。 <DoNotTranslate>**kind**</DoNotTranslate>と<DoNotTranslate>**secret**</DoNotTranslate>を除いてデフォルト値をそのまま使用できます。 <DoNotTranslate>**description**</DoNotTranslate>はオプションです。
...
8. <DoNotTranslate>**Distributed tracing**</DoNotTranslate>
