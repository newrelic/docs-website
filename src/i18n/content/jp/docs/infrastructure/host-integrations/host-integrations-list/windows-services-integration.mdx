...
* [Windows サービス クイックスタート](https://newrelic.com/instant-observability/winservices) をインストールするか、独自の [ダッシュボード](/docs/query-your-data/explore-query-data/dashboards/introduction-dashboards) を作成して、Windows サービスを追跡します。
