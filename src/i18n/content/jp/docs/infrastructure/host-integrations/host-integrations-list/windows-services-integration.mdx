...
[サポートされているホストに、 ](/docs/infrastructure/new-relic-infrastructure/getting-started/compatibility-requirements-new-relic-infrastructure)[インフラストラクチャエージェント](/docs/infrastructure/install-configure-manage-infrastructure) **バージョン1.12.1以上** がインストールされている必要があります。x86 Windows 版はまだサポートされていません。
