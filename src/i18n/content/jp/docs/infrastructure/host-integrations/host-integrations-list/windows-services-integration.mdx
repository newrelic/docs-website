...
<Callout title="ベータ機能">
  この機能は現在オープンベータ版であり、2021年9月にリリースされた[0.3.0](https://github.com/newrelic/nri-winservices/releases/tag/v0.3.0-beta)以降のバージョンにのみ適用されます。詳細については[、ExplorersHubの投稿](https://discuss.newrelic.com/t/introducing-new-open-beta-version-of-the-windows-services-integration/160162)を確認してください。
</Callout>
