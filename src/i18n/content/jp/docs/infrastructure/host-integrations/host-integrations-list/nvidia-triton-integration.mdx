...
<Steps>
  ...
  <Step>
    ...
    1. **[one.newrelic.com](https://one.newrelic.com) > + Add data**に移動し、 **NVIDIA Triton**と入力します。
    ...
    カスタム NVIDIA Triton ダッシュボードは<DoNotTranslate>**Dashboards**</DoNotTranslate> UI にあります。 詳細については[ダッシュボードの](/docs/query-your-data/explore-query-data/dashboards/introduction-dashboards)セクションをご覧ください。
