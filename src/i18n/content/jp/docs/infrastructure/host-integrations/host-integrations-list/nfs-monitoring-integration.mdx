...
[データを照会する場合](/docs/using-new-relic/data/understand-data/query-new-relic-data), NFS データは `NFSSample` [イベントタイプ](/docs/data-apis/understand-data/new-relic-data-types/#event-data) に添付されます。
