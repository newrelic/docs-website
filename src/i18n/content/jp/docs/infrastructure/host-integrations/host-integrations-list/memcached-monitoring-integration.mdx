...
* パスワードなどの機密情報が設定ファイルに平文で表示されないようにするには、secrets managementを使用します。詳しくは、 [secrets management の使い方](https://docs.newrelic.com/docs/integrations/host-integrations/installation/secrets-management) をご覧ください。
