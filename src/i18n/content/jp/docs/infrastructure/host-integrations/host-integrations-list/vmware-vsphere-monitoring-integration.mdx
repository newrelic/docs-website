...
import infrastructureVmwareSphereDashboard from 'images/infrastructure_screenshot-crop_vmware-sphere-dashboard.webp'

import infrastructureVmwareSphereWorkloads from 'images/infrastructure_screenshot-crop_vmware-sphere-workloads.webp'
