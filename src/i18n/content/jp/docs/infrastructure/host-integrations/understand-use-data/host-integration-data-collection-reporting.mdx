---
title: インフラストラクチャエージェント統合のためのデータ収集とレポート作成
tags:
  - Integrations
...
このドキュメントでは、 [インフラストラクチャ エージェント統合が](/docs/infrastructure/host-integrations/installation/install-infrastructure-host-integrations) データを収集してレポートする方法について説明します。

## データ収集と報告のプロセス [#data-collection]

これは、インフラストラクチャ エージェントのオンホスト統合が New Relic にデータを送信する方法です。
