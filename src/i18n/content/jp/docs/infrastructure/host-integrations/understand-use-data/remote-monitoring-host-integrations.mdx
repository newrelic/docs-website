...
<CollapserGroup>
  <Collapser
    ...
    title="アラート検証"
  >
    この新機能の影響を受ける値が使用されている場合、[**Enabling remote monitoring can affect your configured alerts**](/docs/verify-your-alerts-after-activating-remote-monitoring) \[リモート監視を有効にすると、設定されたアラートに影響を与える可能性があります]。 既存のを確認することを強くお勧めします<InlinePopover type="alerts"/>期待どおりに動作し続けることを確認するためです。
  </Collapser>
