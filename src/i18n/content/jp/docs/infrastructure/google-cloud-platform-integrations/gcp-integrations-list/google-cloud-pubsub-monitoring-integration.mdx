...
New Relic と[Google Cloud Platform (GCP)](https://cloud.google.com/) [New Relicの には 、 Pub/Sub](/docs/infrastructure/introduction-infra-monitoring)[Google Cloud データを に報告するための統合が含まれます。](https://cloud.google.com/pubsub/)New Relicこのドキュメントでは、GCP Pub/Sub 統合を有効にする方法と、レポートされるデータについて説明します。
