    ...
    <TabsPageItem id="permissions-services">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td>
              [Google データストア](/docs/integrations/google-cloud-platform-integrations/gcp-integrations-list/google-datastore-monitoring-integration)
            </td>
          ...
          <tr>
            <td>
              [Google Firebase Realtime データベース](/docs/integrations/google-cloud-platform-integrations/gcp-integrations-list/google-cloud-firebase-database-monitoring-integration)
            </td>
          ...
          <tr>
            <td>
              [Valkey向けのGoogle Memorystore](/docs/infrastructure/google-cloud-platform-integrations/gcp-integrations-list/google-memorystore-valkey)
            </td>
