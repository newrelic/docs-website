...
1. **[one.newrelic.com](https://one.newrelic.com) > Infrastructure > GCP**に移動します。Infrastructure の**Google Cloud Services** integrations ページの上部にある \[ **Add a GCP account] を**選択します。
...
New Relic に 1 つ以上の Google プロジェクトのサービスを統合する権限を与えると、New Relic は定期的なポーリング間隔で GCP データの監視を開始します。数分後、New Relic UI にデータが表示されます。ダッシュボードやアラート設定へのリンクを含む[データを見つけて使用する](/docs/infrastructure/integrations/find-use-infrastructure-integration-data)には、 **[one.newrelic.com](https://one.newrelic.com) > Infrastructure > GCP**に移動します。
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        1. **[one.newrelic.com](https://one.newrelic.com) > Infrastructure > GCP > Manage services**から。
    ...
    <tr>
      ...
      <td>
        ...
        **ユーザーアカウント** を使用して GCP プロジェクトを登録した場合は、以下の手順に従います。
        ...
        1. **[one.newrelic.com](https://one.newrelic.com) > Infrastructure > GCP > Manage services**に移動します。
