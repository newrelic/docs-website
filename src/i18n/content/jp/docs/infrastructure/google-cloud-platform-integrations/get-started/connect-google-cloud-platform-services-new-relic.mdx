...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > GCP**に移動します。**Google Cloud Services** \[Google Cloud サービスの 統合] ページで、 **Add a GCP account** \[GCP アカウントの追加]を選択します。
