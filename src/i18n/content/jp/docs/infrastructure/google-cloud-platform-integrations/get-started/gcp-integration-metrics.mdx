...
次の表は、GCP インテグレーションによって収集されたメトリクスとその[次元メトリクス](/docs/telemetry-data-platform/ingest-manage-data/understand-data/new-relic-data-types/#dimensional-metrics)変換の非包括的なリストです。
