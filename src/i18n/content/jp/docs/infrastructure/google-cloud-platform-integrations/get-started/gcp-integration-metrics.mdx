...
## Google Cloudメトリクス [#gcp-metrics-table]

次の表には、GCPインテグレーションによって収集されたメトリクスの一部とその[次元メトリクス](/docs/telemetry-data-platform/ingest-manage-data/understand-data/new-relic-data-types/#dimensional-metrics)変換が記載されています。
