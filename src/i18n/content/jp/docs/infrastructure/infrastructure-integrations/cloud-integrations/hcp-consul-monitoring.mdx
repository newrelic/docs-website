...
[End-to-End Overview](https://learn.hashicorp.com/tutorials/cloud/consul-end-to-end-overview)の適切な環境の手順に従って、Consul クラスターをデプロイします。

**非常に重要!:**

Deploy ページの下部にある**Consul CLI 設定**に従っていることを確認してください。

## [gostatsd](https://github.com/atlassian/gostatsd)インストール
...
2. **YOUR_NEW_RELIC_LICENSE_KEY を** New Relic [ライセンス キー](/docs/apis/intro-apis/new-relic-api-keys/#license-key)に置き換えます。
...
1. ここで**dogstatsd_addr**を使用して、 **consul.source.datacenter**を追加できるようにします。各メトリックにタグ付けします。これにより、New Relic ONE ダッシュボードを Consul Datacenter によってファセットすることができます。
...
New Relic で HCP Consul データを表示するには、 [クエリ ビルダー](https://docs.newrelic.com/docs/query-your-data/explore-query-data/query-builder/introduction-query-builder/)に移動します。
