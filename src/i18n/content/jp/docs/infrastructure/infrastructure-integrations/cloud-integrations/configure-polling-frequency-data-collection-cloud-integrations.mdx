...
* <DNT>**Billing:**</DNT>
  ...
  AWS CloudWatch の請求を管理する必要がある場合は、ポーリング頻度を下げることをお勧めします。 これを実行する前に、クラウド インテグレーションに設定されている[集計](/docs/infrastructure/new-relic-infrastructure/infrastructure-alert-conditions)[条件が](/docs/infrastructure/new-relic-infrastructure/infrastructure-alert-conditions)この削減の影響を受けないことを確認してください。

* <DNT>**New services:**</DNT>
...
4. <DNT>**Data polling interval every**</DNT>

   の横にある \[ ] を使用して、 New Relicがクラウドインテグレーション データをキャプチャする頻度を選択します。
...
4. <DNT>**Data collections and filters**</DNT>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [アラート条件](/docs/infrastructure/new-relic-infrastructure/infrastructure-alert-conditions)<DNT>**after**</DNT>を作成するときにフィルターを設定する場合は、フィルターで除外したリソースによって<InlinePopover type="alerts"/>がトリガーされないようにしてください。
      </td>
    </tr>
