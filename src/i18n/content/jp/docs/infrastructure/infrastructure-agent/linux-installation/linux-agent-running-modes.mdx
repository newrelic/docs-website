...
<CollapserGroup>
  <Collapser id="" title="オンホストインテグレーション">
  ...
  <Collapser id="" title="カスタムインテグレーション">
...
<CollapserGroup>
  <Collapser id="root-rootless" title="rootからprivileged/unprivilegedへ">
    実行モード<DNT>**from root to privileged or unprivileged**</DNT>を切り替えるには、このドキュメントのインストレーション/更新の手順に従ってください。
  </Collapser>

  <Collapser id="rootless-root" title="特権モード/非特権モードから他のモードへ">
