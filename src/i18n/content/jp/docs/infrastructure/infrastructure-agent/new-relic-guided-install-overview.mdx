...
始める準備はできていますか？<DNT>**Guided install**</DNT>ボタンをクリックします。または、組織が[EUデータセンター](/docs/using-new-relic/welcome-new-relic/get-started/our-eu-us-region-data-centers)にある場合は、<DNT>**EU Guided install**</DNT>をクリックします。または、組織が[JPデータセンター](/docs/accounts/accounts-billing/account-setup/choose-your-data-center)にある場合は、<DNT>**JP Guided install**</DNT>をクリックします。
