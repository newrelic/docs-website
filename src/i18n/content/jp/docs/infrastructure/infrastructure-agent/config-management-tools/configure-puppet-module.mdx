...
* Puppet 開発キットをインストールします: [https://www.puppet.com/docs/pdk/2.x/pdk\_install.html](https://www.puppet.com/docs/pdk/2.x/pdk_install.html)
...
## 走る `newrelic-newrelic_installer` [#beginning]
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        * `'logs'` - New Relic インフラストラクチャ エージェントのログ統合。\** `'infrastructure'`が必要です*
    ...
    <tr>
      ...
      <td>
        ...
        * `NEW_RELIC_API_KEY`: New Relic[ユーザー キー](/docs/apis/intro-apis/new-relic-api-keys)。 <DNT>**Required**</DNT> 。
        * `NEW_RELIC_ACCOUNT_ID`: New Relic アカウント ID。 <DNT>**Required**</DNT> 。
