...
4. `policy_id`フィールドには、条件に関連付けられたアラートポリシーのユニークIDを使用します。ポリシーIDを確認するには、[one.newrelic.com](https://one.newrelic.com)でポリシーを開き、<DNT>**(i)**</DNT>アイコンをクリックして、ポリシーIDタグから値を読み取ります。
