...
1. アラートでの誤検知を回避する：[UIの手順](/docs/alerts/new-relic-alerts/configuring-alert-policies/update-or-disable-policies-conditions#condition-on-off)または[APIの手順](/docs/alerts/rest-api-alerts/new-relic-alerts-rest-api/disable-enable-alerts-conditions-using-api)に従って、AWS Lambda、RDS Enhanced監視、およびVPC Flowログとの監視インテグレーションに関連するすべてのアラート条件を無効にします。
