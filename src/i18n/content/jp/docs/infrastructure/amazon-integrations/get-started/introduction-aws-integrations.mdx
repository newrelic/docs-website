...
[AmazonCloudWatch Metric Streams](/docs/infrastructure/amazon-integrations/connect/aws-metric-stream/)を使用して、または[ポーリング統合](/docs/infrastructure/amazon-integrations/connect/connect-aws-new-relic-infrastructure-monitoring/)経由でAWSに接続できます。
...
2. <DNT>**Amazon Web Services**</DNT>を検索してタイルをクリックします。
