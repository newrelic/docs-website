...
<Steps>
    ...
    * AWS X-Ray
    ...
    <CollapserGroup>
      ...
      <Collapser id="without-template" title="CloudFormation テンプレートを使用せずに移行する">
        ...
        1. [AWSコンソールから手動で統合する](/docs/infrastructure/amazon-integrations/aws-integration-for-metrics/manual/)を参照し、手順を完了してください。
        2. 以前のAWSプロバイダー アカウントでの[不要なポーリング統合をすべて無効にします](/docs/infrastructure/amazon-integrations/connect/uninstall-aws/)。
  ...
  <Step>
    ## メトリクスストリームのデータを検証する [#validate-data]
