...
[統合データ](/docs/infrastructure/integrations/find-use-infrastructure-integration-data)を使用するには、 **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS**に移動し、EMR 統合リンクのいずれかを選択します。
