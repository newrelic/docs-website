  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        この値は 5 分間隔でチェックされ、値 1 は、クラスターが 5 分間ずっとアイドル状態であったことを示すのではなく、チェック時にクラスターがアイドル状態であったことを示します。 <DNT>**Recommendation:**</DNT>誤検知を回避するには、この値が 5 分間のチェックで 1 回以上連続して 1 になった場合に警告閾値を上げます。 たとえば、この値が 30 分以上 1 であった場合は、この値に対して集計を発生させます。
      </td>
    </tr>
