...
<Callout variant="important">
  統合を有効にして、カスタム ネームスペースを含む サービスからすべての [AWS CloudWatch Metric Streams](/docs.newrelic.com/install/aws-cloudwatch/)CloudWatch メトリクスを監視します。AWS個別の統合は推奨オプションではなくなりました。
</Callout>
