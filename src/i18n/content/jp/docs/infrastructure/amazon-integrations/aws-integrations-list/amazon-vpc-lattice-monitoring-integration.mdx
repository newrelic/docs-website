...
2. 左側のパネルの
   ...
   ドロップダウンで、監視を有効にするために使用するオプションに応じて、 `Service Networks`または`Services`選択します。
...
[メトリクス クエリ エクスプローラー](/docs/data-apis/understand-data/metric-data/query-metric-data-type/)を介して CloudWatch データをクエリおよび探索できます。
