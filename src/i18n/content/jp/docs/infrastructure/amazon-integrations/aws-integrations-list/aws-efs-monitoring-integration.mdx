...
[データを照会して探索することができます](/docs/using-new-relic/data/understand-data/query-new-relic-data) `BlockDeviceSample` [イベントタイプ](/docs/data-apis/understand-data/new-relic-data-types/#event-data), `プロバイダ` 値 `EfsFileSystem` を使用することができます。
