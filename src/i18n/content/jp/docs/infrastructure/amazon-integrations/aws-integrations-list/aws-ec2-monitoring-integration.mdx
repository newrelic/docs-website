...
[プロバイダ](/docs/using-new-relic/data/understand-data/query-new-relic-data)の値が`Ec2Instance`の場合、[ComputeSample](/docs/data-apis/understand-data/new-relic-data-types/#event-data)`イベントタイプ`を使用して`データのクエリと調査`を行えます。
