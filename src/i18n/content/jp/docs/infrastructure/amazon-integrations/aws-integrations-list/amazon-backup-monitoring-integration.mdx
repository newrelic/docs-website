...
統合のメトリクスを見つけるには、 **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Metrics & Events**に移動し、 `aws.backup`でフィルタします。
...
セットアップできます<InlinePopover type="alerts"/>変更があった場合に通知を受け取ります。 たとえば、アラートを設定して、重大なエラーまたは致命的なエラーの関係者に関する通知を受け取ることができます。
