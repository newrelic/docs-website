...
<DNT>**We also offers a more in-depth Lambda monitoring feature**</DNT>。詳細については、 の[New Relic サーバーレス監視」AWS Lambda](/docs/serverless-function-monitoring/aws-lambda-monitoring/get-started/introduction-new-relic-monitoring-aws-lambda) を参照してください。
