...
より詳細な Lambda 監視機能も提供しています。 詳細については、[New Relic の サーバーレス監視」AWS Lambda](/docs/serverless-function-monitoring/aws-lambda-monitoring/get-started/introduction-new-relic-monitoring-aws-lambda) を参照してください。
