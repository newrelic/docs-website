...
[クエリしてデータを探索する](/docs/using-new-relic/data/understand-data/query-new-relic-data) `ServerlessSample` [イベントタイプ](/docs/data-apis/understand-data/new-relic-data-types/#event-data) 、 `provider` の値 `LambdaRegion` 、 `LambdaFunction` 、 `LambdaFunctionAlias` を使用することができます。
...
Lambda関数とAliasのデータは、 `ServerlessSample` [イベントタイプ](/docs/data-apis/understand-data/new-relic-data-types/#event-data) 、 `provider` value `LambdaFunction` と `LambdaFunctionAlias` 、にそれぞれ添付されています。
...
ラムダリージョンデータは、 `ServerlessSample` [イベントタイプ](/docs/data-apis/understand-data/new-relic-data-types/#event-data) 、 `provider` value of `LambdaRegion` に添付されています。
