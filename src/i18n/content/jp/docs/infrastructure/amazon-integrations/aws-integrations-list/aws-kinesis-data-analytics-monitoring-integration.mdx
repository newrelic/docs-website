...
[当社のインフラ監視統合](/docs/infrastructure/integrations-getting-started/getting-started/introduction-infrastructure-integrations) には、AWS Kinesis Data Analytics のデータを当社製品に報告するための統合があります。この統合を有効にする方法と、どのようなデータを収集するのかについては、こちらをご覧ください。
