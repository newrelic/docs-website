...
当社の[インフラストラクチャモニタリング統合には、](/docs/infrastructure/introduction-infra-monitoring) AWS Kinesis Data Analytics データを当社製品に報告するための統合が含まれます。 インテグレーションを有効にする方法とインテグレーションが収集するデータについて詳しくは、以下をお読みください。
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <DNT>**Known issue**</DNT>: このメトリクスは他のメトリクスよりも遅延が長いため、表示されない場合もあります。
      </td>
    </tr>
  </tbody>
</table>
