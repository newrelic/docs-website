...
[New Relic インフラストラクチャの統合](/docs/infrastructure/integrations-getting-started/getting-started/introduction-infrastructure-integrations)には、AWS Elemental MediaTailor の統合が含まれ、メトリクス データを New Relic に送信します。
...
統合のメトリクスを見つけるには、 **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Metrics and events** に移動し、 `aws.mediatailor`でフィルタリングします。
