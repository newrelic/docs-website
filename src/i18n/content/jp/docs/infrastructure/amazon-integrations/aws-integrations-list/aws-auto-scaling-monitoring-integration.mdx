...
[New Relic インフラストラクチャ統合には、](/docs/infrastructure/introduction-infra-monitoring) Auto Scaling サービスから New Relic 製品にグループに関するデータをレポートするAWS Auto Scaling 統合が含まれています。 このドキュメントでは、この統合を有効にする方法と、レポートできるデータについて説明します。
...
2. ナビゲーション ペインから<DNT>**Auto Scaling Groups &gt; (select your group)**</DNT>を選択します。
3. <DNT>**Monitoring**</DNT>タブから、 <DNT>**Auto Scaling Metrics &gt; Enable Group Metrics Collection**</DNT>または<DNT>**Display &gt; Auto Scaling**</DNT>選択します。
...
[インテグレーション データを表示する](/docs/infrastructure/integrations/find-use-infrastructure-integration-data)には、 <DNT>**[one.newrelic.com &gt; All capabilities](https://one.newrelic.com/all-capabilities) &amp;gt; Infrastructure &amp;gt; AWS**</DNT>に移動し、 <DNT>**AWS Auto Scaling**</DNT>インテグレーション リンクのいずれかを選択します。
