...
[統合データを表示する](/docs/infrastructure/integrations/find-use-infrastructure-integration-data)には、 **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS**に移動し、 **AWS Auto Scaling**統合リンクのいずれかを選択します。
