...
この統合のデータを[表示して使用する](/docs/integrations/infrastructure-integrations/get-started/understand-use-data-infrastructure-integrations/)には、 **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS**に移動し、Elasticsearch 統合リンクのいずれかを選択します。
