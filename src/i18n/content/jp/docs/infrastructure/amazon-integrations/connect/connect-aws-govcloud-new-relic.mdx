...
2. <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > GovCloud**</DNT>

   に移動します。

3. <DNT>**Add AWS GovCloud account**</DNT>

   をクリックします。

4. AWS アカウントに名前を付け、アカウントを接続するための認証情報を入力して、

   <DNT>**Submit**</DNT>

   をクリックします。

5. New Relic Infrastructureでモニターする Amazon Web Services を選択し、
