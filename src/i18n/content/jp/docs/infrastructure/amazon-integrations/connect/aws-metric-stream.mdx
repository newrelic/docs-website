...
* [_New Relicで監視したいAWSアカウントとリージョンでのみメトリックストリームが有効になっていることを確認します。_ CloudWatch Metric Streamの包含および除外フィルターを使用して、収集されるサービス/ネームスペースを選択します。](/docs/telemetry-data-platform/ingest-manage-data/manage-data/manage-your-data/)
