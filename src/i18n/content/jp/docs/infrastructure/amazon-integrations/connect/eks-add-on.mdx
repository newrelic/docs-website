...
1. <DoNotTranslate>**EKS Cluster > Add-Ons > Get More add-ons**</DoNotTranslate>に移動します。
...
2. AWS Marketplace アドオンで、 New Relic Kubernetesインテグレーションを検索、参照、または移動し、チェックボックスを選択して、<DoNotTranslate>**Next**</DoNotTranslate> をクリックします。
...
3. 必要に応じて、最新のデフォルト バージョンを選択するか、代替バージョンを選択して、 <DoNotTranslate>**Next**</DoNotTranslate>をクリックします。
...
4. <DoNotTranslate>**Create**</DoNotTranslate>をクリックします。
