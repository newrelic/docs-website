...
1. **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS**に移動します。 利用可能なサービスタイルの1つをクリックします。
...
セットアップが完了すると、**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS**でインテグレーションを確認できます。
