...
* [NerdGraphを使用してこのステップを自動化します](/docs/apis/nerdgraph/examples/nerdgraph-cloud-integrations-api-tutorial/#link-aws)。
...
AWSサービス/ネームスペースによって処理されたメトリックスアップデートの数を確認するには：
