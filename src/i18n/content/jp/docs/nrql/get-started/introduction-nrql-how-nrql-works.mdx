...
データを探索するもう1つの優れた方法として、既存のダッシュボードに移動し、<DoNotTranslate>**View query**</DoNotTranslate>をクリックして、クエリビルダーでのチャートの実行があります。<img title="new-relic-view-chart-nrql-query.png" alt="New Relic view chart NRQL query" src={queriesnrqlViewQueryforChart}/>
