...
データを探索するもう1つの優れた方法として、既存のダッシュボードに移動し、<DNT>**View query**</DNT>をクリックして、クエリビルダーでのチャートの実行があります。<img title="new-relic-view-chart-nrql-query.png" alt="New Relic view chart NRQL query" src="/images/queries-nrql_screenshot-crop_view-query-for-chart.webp"/>
