...
NRQL を使用して、によって収集されたアプリケーション データをクエリできます。 [<InlinePopover type="apm"/>](/docs/apm/)、 [<InlinePopover type="browser"/>](/docs/browser/)、[モバイルモニタリング](/docs/mobile-monitoring/)。このデータを使用して、さまざまな質問に答えることができます。ここでは基本的な例をいくつか示します。
