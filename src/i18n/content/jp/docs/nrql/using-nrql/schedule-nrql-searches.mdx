...
* **ユーザー権限**: スケジュールされた検索を作成および管理するには、 [ワークフロー自動化](/docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows/#requirements)権限が必要です。
...
* より高度な自動化の可能性については、 [ワークフロー自動化を検討してください](/docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows)。