...
<CollapserGroup>
  ...
  >
    ...
    * The joined subquery will continue to have a default [`LIMIT`](#sel-limit) of 10, with a maximum `LIMIT` of 5,000. Note that the outer query's `LIMIT` does not affect the inner query.
