...
<CollapserGroup>
  ...
  >
    ...
    **Events and attributes example:**
    ...
    If you use the [Infrastructure `ProcessSample` event's `commandLine` attribute](https://docs.newrelic.co.jp/attribute-dictionary/processsample/commandline), by default we strip options and arguments from the full command line to prevent accidental leakage of sensitive information.
  </Collapser>
