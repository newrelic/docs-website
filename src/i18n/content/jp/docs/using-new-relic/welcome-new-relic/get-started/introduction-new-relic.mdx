...
![オブザーバビリティ](https://jajp-newrelic-docs.onelink-translations.com/sites/default/files/thumbnails/image/observability.png "オブザーバビリティ")
...
どこから開始しても問題ありません。Full-stack observabilityがすべてを管理します。
...
* どのようなテクノロジーをNew Relicがインストゥルメントできるかについては、[newrelic.com/integrations](https://newrelic.com/integrations)をご覧ください。
