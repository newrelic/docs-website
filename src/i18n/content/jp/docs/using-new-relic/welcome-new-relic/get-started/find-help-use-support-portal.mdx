...
New Relicの[Docsサイト](https://docs.newrelic.co.jp/)には、有用なインストールや設定、トラブルシューティングのヒントが含まれます。[メインページ](http://jajp-newrelic-docs.onelink-translations.com)で、[リリースノート](/docs/release-notes)のような頻繁に使用するカテゴリから選択します。または、[任意のページから検索します](http://jajp-newrelic-docs.onelink-translations.com/search)。
...
![New Relic Docs - 顧客満足度のフィードバック](./images/docs-csat-widget.png "New Relic Docs - 顧客満足度のフィードバック")
