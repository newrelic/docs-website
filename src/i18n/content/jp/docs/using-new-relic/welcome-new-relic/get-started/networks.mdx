...
必須のサポートされたプロトコルバージョンへの将来のアップデートについては、[New Relicのエクスプローラーハブの`Security Notifications`タグ](https://discuss.newrelic.com/t/security-notifications/45862)に従ってください。
