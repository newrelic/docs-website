...
**このリストは最新です。最終更新日13 11月 2020。**

これは、New Relic[エージェント](/docs/apm/new-relic-apm/getting-started/glossary#agent)との通信のためにNew Relic [コレクタ](/docs/apm/new-relic-apm/getting-started/glossary#collector)（例：`https://collector.newrelic.com`）が使用するネットワークやIPアドレス、ドメイン、ポート、エンドポイントのリストです。[TLSがすべてのドメインについて必要です。](#tls)
...
モニター対象のURLにアクセスできるようにお使いのファイアウォールを設定するには、[SyntheticsパブリックミニオンIP](/docs/synthetics/new-relic-synthetics/using-monitors/synthetics-public-minion-ips)を使用します。[TLSがすべてのドメインについて必要です。](#tls)
...
これらのネットワークブロックは、サードパーティの[チケットのインテグレーション](/docs/using-new-relic/user-interface-functions/share-your-data/ticketing-integrations)にも適用されます。
