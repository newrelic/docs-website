...
この機能は[、元のユーザーモデルの](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-user-models)ユーザーのみが利用でき[、新しいユーザーモデルの](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-user-models)ユーザーは利用できません。回避策として、[電子メール通知チャネル](#email)を使用できます。
