---
title: SSO アカウントとモバイル アプリのトラブルシューティング
tags:
  - Mobile apps
...
モバイル デバイスでSSOプロバイダーに正常にサインインした後にエラーが表示される場合は、デスクトップ Web browserで <DNT>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DNT> にサインインできることを確認してください。
