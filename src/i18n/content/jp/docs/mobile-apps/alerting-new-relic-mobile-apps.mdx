...
アカウント管理者は、Android および iOS デバイス上で[応用インテリジェンス](/docs/alerts-applied-intelligence/new-relic-alerts/get-started/introduction-applied-intelligence)からプッシュ通知を受信するように構成をセットアップできます。 発行が受けられる<InlinePopover type="alerts"/>[モバイルプッシュ](/docs/alerts-applied-intelligence/notifications/notification-integrations#mobile_push)を宛先とする任意のワークフローから。
