...
[<InlinePopover type="browser"/>エージェントおよび<InlinePopover type="apm"/>エージェント](#new-relic-endpoints)が使用するエンドポイントに加えて、Browserエージェントが監視するアプリケーションでは、`js-agent.newrelic.com`への発信接続を使用します。
...
<Callout variant="important">
  [2023年8月23日、Syntheticsのプライベートロケーションで使用されるIPアドレスが変更されました。](/whats-new/2023/06/whats-new-06-23-synthetics-horde-ip-changes/)
</Callout>
