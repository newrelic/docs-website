...
Pro エディションと Enterprise [エディション](https://newrelic.com/pricing) のみが、複数のアカウント、カスタム グループとロールの追加機能、および 5 人を超えるフル プラットフォーム ユーザーを持つ機能を許可していることに注意してください。つまり、Free または Standard エディションを使用している場合、ユーザーの計画はそれほど重要ではありません。
