...
* **予想される職務に基づいてユーザー タイプを割り当てます。**管理業務を行うには、ユーザーをコア プラットフォーム ユーザーまたはフル プラットフォーム ユーザーにする必要があります。[ユーザー タイプについて詳しくは、こちらをご覧ください。](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type)

* **ユーザーを適切な[グループ](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts/#understand-concepts)に割り当てます。**管理者をグループに追加するためのオプション:

  * これらをデフォルトの[**Admin** \[管理者\]グループ](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts/#default-groups)に追加すると、すべてにアクセスできるようになります。
  * [**Group admin** \[グループ管理者\]ロールを](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts#group-admin)付与すると、特定のグループのユーザーを追加/削除できるようになります。
