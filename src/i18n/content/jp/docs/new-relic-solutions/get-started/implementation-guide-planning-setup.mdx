...
New Relicにサインアップする際、組織が属するデータセンター地域を選択する必要があります。地域間にはいくつかの違いがあります：たとえば、APIエンドポイントが異なり、機能にもいくつかの違いがあります。[データセンター地域の詳細をご覧ください。](/docs/accounts/accounts-billing/account-setup/choose-your-data-center/)
...
* [<DNT>**workloads**</DNT>機能を](/docs/new-relic-solutions/new-relic-one/workloads/workloads-isolate-resolve-alert-events-faster)使用すると、関連するアプリ、サービス、ホスト、その他のエンティティをビジネス関連のグループにまとめ、それらに関する情報を 1 つのダッシュボードで確認できます。関連するエンティティをワークロードにグループ化する方法について、時間をかけて考えてみましょう。
