...
ガイド付きインストールを使用する準備はできましたか?[New Relic のガイド付きインストール ページに移動します。](https://one.newrelic.com/marketplace?account=1&state=83ad7308-eba3-c490-39ae-54547650309e)
...
APM に関するその他のヒントについては、 [APM のベスト プラクティス](/docs/codestream/start-here/what-is-codestream)を参照してください。
...
* インストルメンテーションの最適化についてさらに詳しく知りたい場合は、 [アカウント成熟度アプリ](https://one.newrelic.com/marketplace?account=1&state=8c01154b-6b04-3abc-3c4c-3af8db3276cf)をチェックしてください。これは、インストルメンテーションを確認し、使用していない機能を確認するのに役立ちます。
