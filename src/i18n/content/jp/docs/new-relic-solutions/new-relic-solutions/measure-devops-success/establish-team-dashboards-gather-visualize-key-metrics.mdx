...
詳細については、New Relicの[目的およびベースラインチュートリアル](https://jajp-newrelic-docs.onelink-translations.com/docs/establish-objectives-baselines)を見直してください。これには、SLIやSLO、SLAについての詳細情報も含まれます。
...
![catalyst-team-dashboard-nrql.png](https://jajp-newrelic-docs.onelink-translations.com/sites/default/files/thumbnails/image/catalyst-team-dashboard-nrql-query.png "catalyst-team-dashboard-nrql.png")
...
![New Relicカタリストチームのダッシュボード](https://jajp-newrelic-docs.onelink-translations.com/sites/default/files/thumbnails/image/catalyst-team-dashboard_0.png "catalyst-team-dashboard.png")

<figcaption>
  アプリのヘルスとチームのビジネス目標での成功の両方を示す、チームダッシュボードの例は次のとおりです。
</figcaption>

追跡する大半の論理データについて、多くの[チャートタイプ](https://jajp-newrelic-docs.onelink-translations.com/docs/insights/use-insights-ui/manage-dashboards/chart-types)を作成できます。**推奨事項**：最低限、次のものが含まれます：
...
![New RelicカタリストダッシュボードKPI](https://jajp-newrelic-docs.onelink-translations.com/sites/default/files/thumbnails/image/catalyst-dashboard-kpi_0.png "catalyst-dashboard-kpi.png")
