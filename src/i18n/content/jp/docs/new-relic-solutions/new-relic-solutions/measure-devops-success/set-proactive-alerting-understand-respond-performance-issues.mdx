...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [主要ハードウェア、仮想ホスト、コンテナ](https://docs.newrelic.co.jp/docs/infrastructure/infrastructure-monitoring/get-started/get-started-infrastructure-monitoring)、[ネットワーク](https://github.com/newrelic/nri-network-telemetry)、ストレージコンポーネントに対するKPIを設定します。
      </td>
    </tr>
