...
![devops向けのプロアクティブなベースラインアラート](./image/proactive-baseline-alerts-devops_0.png "proactive-baseline-alerts-devops.png")
...
![プロアクティブなベースラインアラート - Browserの閾値](./image/proactive-baseline-alerts-thresholds.png "proactive-baseline-alerts-thresholds.png")
...
![outlier-alert.png](./image/outlier-alert.png "outlier-alert.png")
...
![New Relicプロアクティブ検出 - 最近の異常](./image/new-relic-recent-anomalies-view.png "new-relic-recent-anomalies-view.png")
...
![事前のベースラインアラート - ダッシュボード](./image/proactive-baseline-alerts-dashboards.png "proactive-baseline-alerts-dashboards.png")
