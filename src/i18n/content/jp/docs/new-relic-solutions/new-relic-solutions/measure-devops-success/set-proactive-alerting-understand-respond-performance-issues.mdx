...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [主要ハードウェア、仮想ホスト、コンテナ](https://docs.newrelic.com/docs/infrastructure/infrastructure-monitoring/get-started/get-started-infrastructure-monitoring)、[ネットワーク](https://github.com/newrelic/nri-network-telemetry)、ストレージコンポーネントに対するKPIを設定します。
      </td>
    </tr>
...
アラートを有効な通知に調整したので、異常を事前に追跡して、問題がインシデントになる前に修正することができます。異常の[プロアクティブ検知](https://docs.newrelic.com/docs/alerts-applied-intelligence/applied-intelligence/proactive-detection/proactive-detection-applied-intelligence)を有効にし、それらに一定レベルの通知を設定します。
