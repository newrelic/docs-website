...
デプロイメントを追跡し、コードやインフラストラクチャの変更が顧客体験にどう影響するかを知ることが重要です。[APM](/docs/apm/new-relic-apm/getting-started/introduction-new-relic-apm)のデプロイメントマーカー機能を使用して、各アプリケーションの[デプロイメントを記録](/docs/apm/new-relic-apm/maintenance/record-deployments)できます。
