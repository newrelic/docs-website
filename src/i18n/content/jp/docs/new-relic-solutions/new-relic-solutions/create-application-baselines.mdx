...
<CollapserGroup>
  <Collapser id="components-list" title="例コンポーネントのリスト">
...
<CollapserGroup>
  <Collapser id="connect-migration-example" title="例New Relic製品にマッチしたコンポーネント">
...
<CollapserGroup>
  <Collapser id="deploy-apm" title="APMの導入">
  ...
  <Collapser id="deploy-infrastructure" title="インフラの導入">
  ...
  <Collapser id="deploy-infrastructure-on-host" title="オンホスト・インテグレーションのインフラ展開">
  ...
  <Collapser id="create-synthetics-monitor" title="シンセティックモニターの作成">
...
<CollapserGroup>
  <Collapser id="baseline-maturity-example" title="例コンポーネントの性能をベースラインと比較">
