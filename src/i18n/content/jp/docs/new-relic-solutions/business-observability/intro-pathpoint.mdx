...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="タッチポイント"
  >
    タッチポイントは、パスポイント モデルの最も詳細なエンティティです。多くの場合、それらは当社によって監視される特定のアプリケーションです。 <InlinePopover type="apm"/>または<InlinePopover type="browser"/> , ただし、任意の NRQL クエリをタッチポイントとして使用することもできます。
