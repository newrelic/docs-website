...
Pathoint の 3 つの主要エディタのそれぞれにアクセスできる 3 つのアイコンがあります。<img title="GUI editor icons" alt="GUI editor icons" src={guiEditorIcons}/>
...
<Steps>
  ...
  <Step>
    <DNT>**JSON configuration**</DNT>をクリックします。
  </Step>
...
<Steps>
  <Step>
    New Relicアカウントから<DNT>**Apps > Pathpoint**</DNT>に移動し、<img src={threeLines} class="inline" style={{height: "30px", width: "30px"}} alt="Three lines" title="Three lines"/>

    。
  </Step>

  <Step>
    表示されたウィンドウで、 <DNT>**JSON configuration**</DNT>をクリックします。
  </Step>

  <Step>
    ダイアログ ボックス ウィンドウが開きます。 <DNT>**Description**</DNT>の下に、新しい JSON 構成ファイルについて説明します。 次に、メモを入力し、 <DNT>**From file**</DNT>をクリックして JSON 構成ファイルを参照します。
  ...
  <Step>
    Pathpoint を更新するために使用する JSON 構成ファイルを見つけて、 <DNT>**Open**</DNT>をクリックします。
