...
3. [* 数分待ってから、New RelicのUIで新しいデータを見てみましょう。](/docs/agents/manage-apm-agents/installation/update-new-relic-agent)

[それでも問題が解決しない場合は、お使いの代理店の手順に従ってください。](/docs/agents/manage-apm-agents/installation/update-new-relic-agent)
...
<table>
  ...
  </tbody>](/docs/agents/manage-apm-agents/installation/update-new-relic-agent)
</table>

[UIでメトリック正規化ルールを編集および作成することもできます。詳細については、](/docs/agents/manage-apm-agents/installation/update-new-relic-agent)[メトリックの正規化](/docs/new-relic-solutions/new-relic-one/ui-data/metric-normalization-rules)を参照してください。
