...
* [New Relic Oneプラットフォームのサポートリソースにアクセスします。](#nr-support)
...
New Relic Oneプラットフォームをナビゲートしている間、すべての[製品内サポート](https://one.newrelic.com/redirect/support)リソースにアクセスできます。上部のナビゲーションメニューにある小さい**?**アイコンを選択するだけです。

![ナビゲーションをサポート](./images/support-nav.png "ナビゲーションをサポート")

製品内サポートビューは、New Relic、当社のドキュメント、およびExplorers Hubの新機能を可視化します。サポートサイドバーを使用すれば、当社のすべてのサポートツールへ迅速にアクセスできます。

![製品内サポート](./images/in-product-support.png "New Relicの製品内サポート")
...
上記のいずれの方法もうまくいかない場合は、上部メニューの**?**アイコンをクリックするか、[support.newrelic.com](https://support.newrelic.com/home)にアクセスしてください。サポートポータルを使用して、New Relicのすべてのヘルプリソースで一元化された検索にアクセスできます。お探しのものが見つからず、サブスクリプションレベルにテクニカルサポートが含まれる場合、[サポートチケットを提出](https://support.newrelic.com/tickets)してください。
