...
<Steps>
  ...
  <Step>
    [アカウントに**Victory Charts Visualizations**を追加します](/docs/new-relic-solutions/new-relic-one/build-nr-apps/subscribe)。
  </Step>
  ...
  <Step>
    購読したものではなく、微調整したバージョンの**Victory Charts Visualizations** Nerdpackを使用するため、ここで私たちのバージョンの[購読を解除](/docs/new-relic-solutions/new-relic-one/build-nr-apps/subscribe/#unsubscribe-from-a-nerdpack)できます。
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    完璧！Instant Observabilityカタログから、オープンソースの**Circular progress bar**の視覚化を複製して更新しました。残っているのは、自分のバージョンをカタログに公開して、自分のアカウントがそれを[購読](/docs/new-relic-solutions/new-relic-one/build-nr-apps/subscribe/#subscribe-to-a-nerdpack)できるようにすることです。
  </Step>
...
<Steps>
  <Step>
    ルートディレクトリから、Nerdpackを[公開](/docs/new-relic-solutions/new-relic-one/build-nr-apps/publish/)します：
  ...
  <Step>
    Nerdpackを[購読](/docs/new-relic-solutions/new-relic-one/build-nr-apps/subscribe/#subscribe-to-a-nerdpack)します：
