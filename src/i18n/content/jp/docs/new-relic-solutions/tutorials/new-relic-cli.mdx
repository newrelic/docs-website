...
New Relic CLI で[利用可能なすべてのコマンド](https://github.com/newrelic/newrelic-cli/blob/master/docs/cli/newrelic.md)を確認してください。たとえば、[New Relic ワークロード](\(/docs/new-relic-solutions/new-relic-one/workloads/workloads-isolate-resolve-alert-events-faster\))を使用して[`workload create`](https://github.com/newrelic/newrelic-cli/blob/master/docs/cli/newrelic_workload_create.md)を作成できます。
