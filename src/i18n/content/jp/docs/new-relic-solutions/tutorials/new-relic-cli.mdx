...
<Steps>
  ...
  <Step>
    ...
    <Callout variant="important">
      お使いのNew Relicアカウントの[リージョン](/docs/accounts/accounts-billing/account-setup/choose-your-data-center)を設定する必要があります。`-r`を使用して、`us`、`eu`または`jp`を設定します。
    </Callout>
  </Step>
...
New Relic CLIで[利用可能なすべてのコマンド](https://github.com/newrelic/newrelic-cli/blob/master/docs/cli/newrelic.md)を確認してください。たとえば、[New Relicワークロード](/docs/new-relic-solutions/new-relic-one/workloads/workloads-overview)を作成できます using [`workload create`](https://github.com/newrelic/newrelic-cli/blob/master/docs/cli/newrelic_workload_create.md)

他のコミュニティメンバーと交流したい場合は、当社の[New Relic Explorer Hub](https://support.newrelic.com/s/hubtopic/Topic__c/Default?c__categories=%5B%7B%22icon%22%3A%22standard%3Adefault%22%2C%22id%22%3A%22a6c8W000000EeszQAC%22%2C%22sObjectType%22%3A%22Category__c%22%2C%22title%22%3A%22Build%20on%20New%20Relic%22%2C%22titleFormatted%22%3A%22Build%20on%20New%20Relic%22%7D%5D)ページをご覧ください。[GitHub](https://github.com/newrelic/newrelic-cli)での機能requestsやバグレポートをお待ちしております。