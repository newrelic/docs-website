...
New Relic CLI で[使用可能なすべてのコマンド](https://github.com/newrelic/newrelic-cli/blob/master/docs/cli/newrelic.md)を確認してください。たとえば、 を使用して[ New Relic ワークフロー](/docs/new-relic-one/use-new-relic-one/core-concepts/new-relic-one-workloads-isolate-resolve-incidents-faster) [`workload create`](https://github.com/newrelic/newrelic-cli/blob/master/docs/cli/newrelic_workload_create.md)を作成できます。
