...
環境設定の詳細については、 [「開発環境の設定](https://developer.newrelic.com/build-apps/set-up-dev-env/)」および「 [Nerdpack の高度な構成を有効にする」](https://developer.newrelic.com/build-apps/advanced-config)を参照してください。
