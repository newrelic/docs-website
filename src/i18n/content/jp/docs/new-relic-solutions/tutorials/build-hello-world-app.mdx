...
<Steps>
  ...
  <Step>
    [New Relic](https://one.newrelic.com)で、 <DoNotTranslate>**Add Data**</DoNotTranslate>をクリックします。
...
<Steps>
  ...
  <Step>
    ...
    ランチャーまたは Nerdlet にスクリーンショットを追加した場合は、 <DoNotTranslate>**What's inside**</DoNotTranslate>で確認できます。
...
<Steps>
  ...
  <Step>
    アプリケーションの説明ページで、 <DoNotTranslate>**Add this app**</DoNotTranslate>をクリックします。
  ...
  <Step>
    <DoNotTranslate>**Apps**</DoNotTranslate>ページに移動します:
