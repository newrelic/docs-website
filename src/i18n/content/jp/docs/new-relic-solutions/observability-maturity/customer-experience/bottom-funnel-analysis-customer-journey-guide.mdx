...
[GitHubのファネル分析のREADME](https://github.com/newrelic/oma-resource-center/blob/main/src/content/docs/oma/value-drivers/customer-experience/use-cases/bottom-of-the-funnel-analysis/README.md)の指示に従ってください。
...
* [QualityFoundationKPI](/docs/new-relic-solutions/observability-maturity/customer-experience/quality-foundation-implementation-guide)の[ビジネスクリティカルな](docs/new-relic-solutions/observability-maturity/aqm-implementation-guide/#perform-enablement-two)低下に関するアラートを作成します。
