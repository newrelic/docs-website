...
[追加するセグメントが決まったら、ブラウザ ](https://github.com/newrelic/oma-resource-center/tree/main/src/content/docs/oma/value-drivers/customer-experience/use-cases/quality-foundation#readme)[のセグメント許可リストを使って追加することができます](/docs/browser/new-relic-browser/configuration/group-browser-metrics-urls/#adding)。

### データをどのようにセグメント化するかを理解する

カスタマー・エクスペリエンス・データを異なるセグメントに分けることで、理解しやすく、実用的なものにします。ここでいうセグメントとは、データのグループを指します。 [segment allow lists](https://docs.newrelic.com/docs/browser/new-relic-browser/configuration/group-browser-metrics-urls/#adding) のように、URL のセクションを意味するものではありません。
