...
<img
  ...
  title="デジタル・カスタマー・エクスペリエンス-DCX-New Relicで測定できること"
  alt="デジタル・カスタマー・エクスペリエンス"
/>
...
<img
  src={cxQfDashboard}
  title="Quality Foundation ダッシュボード"
...
<img
  src={cxQfKpiProgress}
  title="Quality Foundation KPIs ダッシュボード"
