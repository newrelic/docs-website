...
import etoAddServiceLevel from 'images/oma-eto-add-service-level.png'

import etoSetServiceLevelTypeApm from 'images/oma-eto-sl-type-apm.png'

import etoSetServiceLevelTagApm from 'images/oma-eto-sl-tag-apm.png'

import etoSetServiceLevelTypeBrowser from 'images/oma-eto-sl-type-browser.png'

import etoSetServiceLevelTagBrowser from 'images/oma-eto-sl-tag-browser.png'

import etoSetServiceLevelTypeMobileCrash from 'images/oma-eto-sl-type-mobile-crash.png'

import etoSetServiceLevelTypeMobileRequestError from 'images/oma-eto-sl-type-mobile-request-error.png'

import etoSetServiceLevelTypeServerless from 'images/oma-eto-sl-type-serverless.png'

import etoSetServiceLevelTagServerless from 'images/oma-eto-sl-tag-serverless.png'

import etoFilterServiceLevels from 'images/oma-eto-sl-filter.png'
...
<img
  ...
  alt="Add a service level"
  src={etoAddServiceLevel}
/>
...
<CollapserGroup>
  ...
  >
    * サービス作成のステップ 2 では、 **Success** SLI を選択します。
    ...
    <img
      title="Set the service level type"
      alt="Set type"
      src={etoSetServiceLevelTypeBrowser}
    />
    ...
    * ステップ 4 では、サービス レベルにタグを追加します。デフォルトのタグを使用できます `category:success`
    ...
    <img
      title="Create a service level tag"
      alt="Create tag"
      src={etoSetServiceLevelTagBrowser}
    />
  </Collapser>
  ...
  >
    ...
    * ステップ 2 では、有効なイベントのソースとして`MobileSession`を選択します。悪い応答のソースとして`MobileCrash`を選択してください。
      ...
      <img title="Set the service level type" alt="Set type" src={etoSetServiceLevelTypeMobileCrash}/>
    ...
    * ステップ 2 では、有効なイベントのソースとして`MobileRequest`を選択します。悪い応答のソースとして`MobileRequestError`を選択してください。
      ...
      <img title="Set the service level type" alt="Set type" src={etoSetServiceLevelTypeMobileRequestError}/>
  ...
  >
    ...
    * ステップ 2 では、有効なイベントの場合は`AWSLambdaInvocation`を選択し、不適切な応答の場合は`AwsLambdaInvocationError`を選択します
    ...
    <img
      title="Set the service level type"
      alt="Set type"
      src={etoSetServiceLevelTypeServerless}
    />
