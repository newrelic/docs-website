...
* 計装ガイド
  ...
  * [行け](/docs/agents/go-agent/instrumentation)
  * [Java](/docs/apm/agents/java-agent/custom-instrumentation/java-custom-instrumentation)
  * [。ネット](/docs/apm/agents/net-agent/custom-instrumentation/introduction-net-custom-instrumentation)
  ...
  * [ルビー](/docs/apm/agents/ruby-agent/api-guides)
...
* [行け `ExternalSegment`](https://pkg.go.dev/github.com/newrelic/go-agent/v3/newrelic#ExternalSegment)
