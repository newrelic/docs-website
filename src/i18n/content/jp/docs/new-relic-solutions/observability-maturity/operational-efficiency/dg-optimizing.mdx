  ...
  >
    <CollapserGroup>
      ...
      >
        ...
        \[アナリティクス設定](イベントデータの収集の有効化・無効化)これらのイベントは New Relic データベースに報告され、 **クラッシュ分析** ページで使用されます)。イベントデータの収集を有効または無効にします。これらのイベントは New Relic データベースに報告され、 **クラッシュ分析** のページで使用されます。

        また、\[agent logging](イベントデータの収集の有効化・無効化)の設定も可能です。これらのイベントは New Relic に報告され、 **クラッシュ分析** ページで使用されます。) を多かれ少なかれ冗長にすることができます。
