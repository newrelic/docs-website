...
<CollapserGroup>
  ...
  >
    ...
    Standard エディションでは、1 か月あたり最大 100 GB のデータを無料で取得できます。現在無料アカウントで作業している場合は、毎月の取り込み目標を 100 GB と考えることができます。無料アカウントでは、1 か月あたり 100 GB を超えて取り込まれた追加データには、1 GB あたり $0.30 が請求されます ( [詳細はこちら](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/data-ingest-billing#standard-data))。
