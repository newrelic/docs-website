...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities):**</DoNotTranslate> 以下は、New Relic 上に構築されたカスタム アプリケーションの例です。 このアプリケーションは、 <InlinePopover type="browser"/>から報告された PageView イベントを使用して、Web サイトの詳細な分析を提供します。
</figcaption>
