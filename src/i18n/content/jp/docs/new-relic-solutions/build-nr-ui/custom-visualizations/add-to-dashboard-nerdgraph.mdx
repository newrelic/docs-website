...
New Relic の GraphQL API である[NerdGraph](https://docs.newrelic.com/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph/)を使用して、プログラムによってカスタム視覚化を新規または既存のダッシュボードに追加します。
