...
<table>
  <tbody>
    ...
    <tr>
      <td>
        `includeCount` <h5>ブール値</h5>
      </td>

      <td>
        `true`の場合、クエリ応答には各ドメインおよびタイプのエンティティの合計数が含まれます。
      </td>
    </tr>

    <tr>
      <td>
        `includeResults` <h5>ブール値</h5>
      </td>

      <td>
        `true`の場合、クエリ応答にはエンティティが含まれます。
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        <OptionReference array>
          EntitySearchQuery.SORT_TYPE.アラート、EntitySearchQuery.SORT_TYPE.ドメイン、EntitySearchQuery.SORT_TYPE.MOST_RELEVANT、EntitySearchQuery.SORT_TYPE.NAME、EntitySearchQuery.SORT_TYPE.REPORTING、EntitySearchQuery.SORT_TYPE.TYPE、
        </OptionReference>
      </td>
    </tr>
  </tbody>
