...
New Relic アプリケーションの構築を支援するために、 [New Relic One SDK](/docs/new-relic-solutions/build-nr-ui/sdk-component/intro-to-sdk)を提供しています。 このページでは、 `NerdStorageVault`使用して暗号化されたストレージ ソリューションにデータを保存する方法について説明します。
