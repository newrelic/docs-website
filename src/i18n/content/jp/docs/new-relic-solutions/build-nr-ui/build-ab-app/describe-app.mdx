...
<Steps>
  ...
  <Step>
    [このスクリーンショット](https://github.com/newrelic-experimental/nru-programmability-course/raw/main/publish/ab-test/catalog/screenshots/screenshot.png)を次の 2 つのディレクトリに保存します。
