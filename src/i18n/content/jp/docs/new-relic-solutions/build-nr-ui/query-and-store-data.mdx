...
[New Relic アプリケーション](/docs/new-relic-solutions/tutorials/build-hello-world-app)の構築を支援するために、 [New Relic One SDK](/docs/new-relic-solutions/build-nr-ui/sdk-component/intro-to-sdk)を提供しています。 ここでは、GraphQL エンドポイントである[NerdGraph を](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph/)介して書き込みやミューテーションを行うことができる SDK 書き込みコンポーネントの使用方法を学ぶことができます。
