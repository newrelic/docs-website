...
* New Relic APMまたはNew Relic Browserが監視するアプリケーションや、New Relic Infrastructureが監視するホストなど、ポリシーのターゲットとなる[エンティティ](https://docs.newrelic.co.jp/docs/accounts-partnerships/education/getting-started-new-relic/glossary)。
