...
1. メトリックスベースの
   ...
   を出発点として使用して、問題に対する高レベルの可視性を獲得します。
...
<CollapserGroup>
  ...
  >
    ...
    3. モバイル監視の
       ...
       [ページ](/docs/mobile-monitoring/mobile-monitoring-ui/mobile-app-pages/version-trends-compare-user-adoption-metrics-performance)を使用して、後続のリリースでクラッシュ率を改善し、回帰を回避していることを確認します。
  </Collapser>
