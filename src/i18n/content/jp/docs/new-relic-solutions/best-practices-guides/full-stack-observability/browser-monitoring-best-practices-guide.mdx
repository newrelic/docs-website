...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities)**へ移動します。次に、**Query your data**をクリックして[クエリビルダー](/docs/query-your-data/explore-query-data/query-builder/introduction-query-builder)にアクセスします。
...
* 当社のコミュニティフォーラム[New Relic Explorers Hub](https://discuss.newrelic.com/)で質問を行う。