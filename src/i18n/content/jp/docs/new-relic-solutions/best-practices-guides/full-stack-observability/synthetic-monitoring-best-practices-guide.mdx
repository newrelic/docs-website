...
1. モニターを追加するには、
   ...
   の順に移動します。( [EUベースのアカウント](/docs/using-new-relic/welcome-new-relic/get-started/introduction-eu-region-data-center)をお持ちの場合は、
...
5. モニターの種類に応じて、<DoNotTranslate>**Save monitor**</DoNotTranslate>、 <DoNotTranslate>**Validate**</DoNotTranslate>、<DoNotTranslate>**Write script**</DoNotTranslate>のいずれかを行うよう求められます。
