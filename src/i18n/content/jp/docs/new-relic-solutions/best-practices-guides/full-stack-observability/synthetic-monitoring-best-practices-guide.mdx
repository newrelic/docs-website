...
1. モニターを追加するには、**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Synthetics**の順に移動します。（[EUベースのアカウント](/docs/using-new-relic/welcome-new-relic/get-started/introduction-eu-region-data-center)をお持ちの場合は、**[one.eu.newrelic.com](http://one.eu.newrelic.com)**に移動します。） **Create monitor**をクリックします。
...
<CollapserGroup>
  ...
  >
    ...
    **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities)** > **Synthetic monitoring**の順に移動します。

    詳細については、[一般的なプラットフォーム機能に関するドキュメント](/docs/new-relic-one/use-new-relic-one/get-started/new-relic-one-core-ui-components)を参照してください。
  </Collapser>
  ...
  >
    ...
    **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Synthetics**に移動します。
  </Collapser>
</CollapserGroup>

## 4. 個々のモニター結果を表示する [#view]

世界中のさまざまな地域からアクセスされるウェブアプリのパフォーマンスを確認する必要があります。[結果](/docs/synthetics/new-relic-synthetics/pages/synthetics-results-access-individual-monitor-runs)ページには、開発から本番までのすべてがユーザー体験にいかに影響するかが表示されます。リストされているものを並べ替えて、問題のある領域や異常結果を特定できます。場所別にフィルタリングして、さまざまな場所からのモニターのパフォーマンスを比較してみてください。これを行うには、以下を実行します。

1. **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Synthetics**に移動します。
2. [one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) >から
...
1. **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Synthetics**に移動します。
2. [one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) >を選択
