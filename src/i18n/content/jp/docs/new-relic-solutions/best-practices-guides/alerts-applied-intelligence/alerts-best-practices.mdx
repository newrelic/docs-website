...
アラートを使用すると、重大になる前に問題の検出を開始できます。New Relicクエリ言語であるNRQLを使用すると、最も関心のあるものに焦点を当てた[アラート条件を作成しカスタマイズ](/docs/alerts-applied-intelligence/new-relic-alerts/get-started/your-first-nrql-condition/)できます。<InlinePopover type="alerts"/>を使用して、データ内の異常な動作について更新し、それを確認すべき人に通知し、問題の根本原因を把握しながら効果的な意思決定を行います。
