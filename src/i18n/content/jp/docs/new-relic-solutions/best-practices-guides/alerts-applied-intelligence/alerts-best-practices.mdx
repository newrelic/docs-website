...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <DoNotTranslate>**Notified**</DoNotTranslate>列をスクロールして、すべてのイシューが少なくとも1つの宛先に転送されていることを確認します。転送が不要な場合は、ノイズの可能性があるため、条件を削除することを検討してください。
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <DoNotTranslate>**Avoid setting thresholds too low**</DoNotTranslate>。たとえば、CPUの条件の閾値を本稼働サーバーで5分間75%に設定すると、日常的にそのレベルを超え、対応に困るアラートや誤検知が増加します。
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <DoNotTranslate>**You don't need to edit files or restart the software**</DoNotTranslate>。このため、必要に応じて閾値のレベルを自由にかつ迅速に変更し、調整します。
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        必要であれば、ポリシー内の<DoNotTranslate>**disable any condition**</DoNotTranslate>条件を無効化できます。これは、たとえば他のメトリクスや閾値を試しながら、そのポリシーに対する他の条件を使い続けたい場合に便利です。
      </td>
    </tr>
  </tbody>
</table>
