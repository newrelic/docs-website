...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <DNT>**Avoid setting thresholds too low**</DNT>。たとえば、CPUの条件の閾値を本稼働サーバーで5分間75%に設定すると、日常的にそのレベルを超え、対応に困るアラートや誤検知が増加します。
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <DNT>**You don't need to edit files or restart the software**</DNT>。このため、必要に応じて閾値のレベルを自由にかつ迅速に変更し、調整します。
      </td>
    </tr>
