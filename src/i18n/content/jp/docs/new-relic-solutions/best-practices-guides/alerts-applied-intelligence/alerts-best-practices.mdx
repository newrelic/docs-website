  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * アラート条件の[`facet/where`](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/nrql-alert-conditions/#syntax)句の現在の値。
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        [インシデントのクローズ](/docs/alerts-applied-intelligence/new-relic-alerts/alert-violations/how-alert-condition-violations-are-closed/)への影響を理解できます。
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        関連するインシデントは、1つの包括的な[イシュー](/docs/alerts-applied-intelligence/applied-intelligence/incident-intelligence/basic-alerting-concepts/)に関連付けられます。
...
* [アラートの概念と用語](/docs/alerts-applied-intelligence/applied-intelligence/incident-intelligence/basic-alerting-concepts/)について詳しく知る。
