...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        [エンリッチメント](/docs/alerts/get-notified/alert-event-workflows/#enrichments)の使用
      </td>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        [アラートのクローズ](/docs/alerts/alert-event-management/how-alert-condition-events-are-closed/)に与える影響を把握できます。
      </td>
    </tr>
...
* [スマートアラートを使用してアラートカバレッジを大規模に設定する](/docs/alerts/smart-alerts-coverage)（パブリックプレビュー）
...
アラートを初めて使用する場合は、[イシュープリファレンスのオプション](/docs/alerts/organize-alerts/specify-when-alerts-create-events)の詳細を確認してください。
