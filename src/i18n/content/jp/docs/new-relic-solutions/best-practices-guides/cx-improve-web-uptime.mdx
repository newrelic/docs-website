...
それを確認してください<InlinePopover type="alerts"/>ワークロードの層ごとに構成されます。 こうすることで、各層の健全性を 1 つのビューで確認できます。 これにより、トラブルシューティングの時間を節約できます。 このビューの利点を活用するために、階層ごとにアラート通知を作成する必要はありません。
