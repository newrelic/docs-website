...
[ワークロード](/docs/new-relic-one/use-new-relic-one/core-concepts/new-relic-one-workloads-isolate-resolve-incidents-faster)を表示するには、 **[one.newrelic.com](https://one.newrelic.com/all-capabilities)**にアクセスし、 **Explorer**で見つけてください。3 つのメイン タブ (Health、Activity、および Owner) とヘッダーがあります。
...
UI[またはNerdGraphAPI](/docs/nerdgraph-workloads-tutorials)を使用してワークロードを作成できます。 UIを使用してワークロードを作成するには、次の手順に従います。

1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities)**に移動し、 **Explorer**をクリックしてから、 **+ Create a** workload をクリックします。
...
<CollapserGroup>
  ...
  >
    ...
    <figcaption>
      **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Apps > Workloads** : ワークロードにダッシュボードを追加できます。
    </figcaption>

    ダッシュボードをワークロードに追加するには

    1. ワークロードを作成または編集するときは、ワークロード検索バーに`Dashboard`と入力して、ダッシュボードエンティティにフィルターします。
    ...
    3. **Add** をクリックします。
       ...
       <figcaption>
         **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Apps > Workloads** : ワークロードにリンクしたダッシュボードにフィルターを設定できます。
       </figcaption>
...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities)**にアクセスし、次に、\[**すべての機能]**を選択します。
2. \[**ワークロード]**タイルをクリックします。
3. 上部ペインで、\[**マップ**] をクリックします。
