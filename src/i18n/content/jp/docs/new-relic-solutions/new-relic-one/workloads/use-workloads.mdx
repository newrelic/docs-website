...
[ワークロード](/docs/new-relic-one/use-new-relic-one/core-concepts/new-relic-one-workloads-isolate-resolve-incidents-faster)を表示するには、 **[one.newrelic.com](https://one.newrelic.com)**にアクセスし、 **Explorer**で見つけてください。3 つのメイン タブ (Health、Activity、および Owner) とヘッダーがあります。
...
1. **[one.newrelic.com](https://one.newrelic.com)**に移動し、 **Explorer**をクリックしてから、 **+ Create a** workload をクリックします。
...
<CollapserGroup>
  ...
  >
    ...
    <figcaption>
      **[one.newrelic.com](https://one.newrelic.com) > Apps > Workloads** : ワークロードにダッシュボードを追加できます。
    </figcaption>
    ...
    3. **Add** をクリックします。
       ...
       <figcaption>
         **[one.newrelic.com](https://one.newrelic.com) > Apps > Workloads** : ワークロードにリンクしたダッシュボードにフィルターを設定できます。
       </figcaption>
...
1. **[one.newrelic.com](https://one.newrelic.com)**にアクセスし、次に、\[**すべての機能]**を選択します。
