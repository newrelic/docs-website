...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Workloads > (選択したワークロード):** ワークロード UI は、ワークロード内のエンティティがどのように実行されているかを示す厳選されたビューを提供します。表示されるグラフは、ワークロードに含めたエンティティの種類によって異なります。
</figcaption>
