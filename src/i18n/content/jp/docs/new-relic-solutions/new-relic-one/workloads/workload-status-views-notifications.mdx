...
1. **[one.newrelic.com](https://one.newrelic.com)**に移動し、 **More > Workload views**をクリックします。
2. Add view」をクリックします。
...
1. **[one.newrelic.com](https://one.newrelic.com)**にアクセスし、 **Alerts & AI**を選択します。新しいアラート条件を追加するポリシーを選択するか、適切な通知チャネルで新しいポリシーを作成します。次に、\[**条件の作成**] をクリックします。
