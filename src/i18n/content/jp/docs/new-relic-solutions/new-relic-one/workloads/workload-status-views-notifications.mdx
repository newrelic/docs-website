...
<Callout variant="tip">
  このページは、[標準ワークロード](/docs/new-relic-solutions/new-relic-one/workloads/create-workloads)と[インテリジェント ワークロード](/docs/new-relic-solutions/new-relic-one/workloads/workloads-overview#intelligent-workloads)の両方に適用されます。ステータス値と通知は、どちらのタイプでも同じように機能します。
</Callout>
