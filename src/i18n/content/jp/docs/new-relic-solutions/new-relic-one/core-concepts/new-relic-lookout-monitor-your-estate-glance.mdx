...
New Relic Lookoutは、デジタル資産全体の可視性を提供します。構成は必要ありません。不動産内で今重要なものをクエリしてシステム全体を理解したり、原因と結果を深く掘り下げたりできるため、アクションを実行するために必要なデータをすばやく取得できます。
...
New Relic Lookoutにアクセスするには、New Relic UIの\[**アプリ**]ボタンをクリックして、 **NewRelicLookout**ランチャーを見つけます。 \[**その他**]ドロップダウンを使用して、ヘッダーバーから直接NewRelicLookoutにアクセスすることもできます。 New Relic Lookoutが既存のデータから価値を提供するには、主要なサービスパフォーマンスインジケーターデータを有効にする必要があります。
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Apps > New Relic Lookout** : トレンドから大幅に逸脱したものはすべて、構成を必要としない New Relic Lookout によって自動的に検出されます。
</figcaption>
