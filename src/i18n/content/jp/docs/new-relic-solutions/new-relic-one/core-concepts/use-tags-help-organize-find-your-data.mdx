...
3. タグウィジェットの<DNT>**Add a new tag...**</DNT>フィールドに、この形式`accountId: 123456789`のタグを追加します。<img title="Add tags in New Relic" alt="Add tags in New Relic" src="/images/solutions_screenshot-full_tag-management.webp"/>
