...
2. ページ上部のエンティティ名の近くで、**タグ**ボタンをクリックします。
3. タグウィジェットの**Add a new tag...**フィールドに、この形式`accountId: 123456789`のタグを追加します。<img title="Add tags in New Relic" alt="Add tags in New Relic" src={solutionsTagManagement}/>
...
タグの処理方法は機能によって異なります。ここでは、[NRQL](/docs/query-your-data/nrql-new-relic-query-language/get-started/introduction-nrql-new-relics-query-language/)を使用してタグデータのクエリを行う方法、または[NRQL条件アラート](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/nrql-alert-conditions)を作成する方法について詳しく説明します。
