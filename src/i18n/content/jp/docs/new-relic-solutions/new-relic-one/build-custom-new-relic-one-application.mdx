...
<figcaption>
  **[one.newrelic.com：NewRelic](https://one.newrelic.com)**上に構築されたカスタムアプリケーションの例を次に示します。このアプリケーションは、New Relicのブラウザモニタリングから報告されたPageViewイベントを使用して、Webサイトの非常に詳細な分析を提供します。
</figcaption>
