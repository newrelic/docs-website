...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) :**New Relic 上に構築されたカスタム アプリケーションの例を次に示します。このアプリケーションは、当社から報告された PageView イベントを使用して、Web サイトの非常に詳細な分析を提供します。 <InlinePopover type="browser"/>。
</figcaption>
