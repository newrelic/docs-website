...
<Steps>
  <Step>
    [New Relic](https://one.newrelic.com)ホームページから、上部のナビゲーション バーの<DoNotTranslate>**+ Add data**</DoNotTranslate>に移動します。
  </Step>
...
<Steps>
  <Step>
    [New Relic](https://one.newrelic.com)から、上部のナビゲーション バーの<DoNotTranslate>**Apps**</DoNotTranslate>に移動します。
  </Step>
