...
[NerdGraph](/docs/apis/graphql-api/get-started/introduction-new-relic-nerdgraph)では、サービスマップで利用できるものと同じ関係の接続性を発見できます。詳細と例については[NerdGraph GraphiQL relationships APIチュートリアル](/docs/apis/nerdgraph/examples/nerdgraph-entities-api-tutorial/)を参照してください。
