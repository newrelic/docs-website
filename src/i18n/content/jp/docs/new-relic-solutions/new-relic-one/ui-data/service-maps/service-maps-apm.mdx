...
<Callout
  ...
  title="EOL通知"
>
  2022 年 9 月 30 日以降、従来の APM サービス マップを含むいくつかの機能のサポートを中止します。この移行を簡単に準備する方法など、詳細については、[エクスプローラー ハブの投稿](https://discuss.newrelic.com/t/july-2022-end-of-life-announcements/188318)を参照してください。
</Callout>

現在のサービス マップ機能の詳細については、 サービス マップの[使用方法 を](/docs/new-relic-solutions/new-relic-one/ui-data/service-maps/how-use-service-maps/)参照してください。
...
<CollapserGroup>
  ...
  >
    ...
    2. \[**アプリ/サービス]**リストから選択します。 <img src={customNode}/>**カスタム ノードを作成します**。

    3. ノードに名前を付けます。

    4. 接続の追加: 左矢印 (着信の場合) または右矢印 (発信の場合) を選択します。 <Icon name="fe-arrow-right"/>アイコン。次に、プラスを選択します<Icon style={{color: '#B9D7B6'}} name="fe-plus-circle"/>ターゲット ノードのアイコン。
    ...
    <tr>
      ...
      <td>
        ...
        * ドラッグ選択で
          ...
          モードで、 **Alt**キーを押しながらクリック アンド ドラッグします。
      </td>
    </tr>
...
<CollapserGroup>
  ...
  >
    ...
    * ドラッグ選択をクリック<img style={{ width: '22px'}} class="inline" src={smDragSelectToggle0}/>アイコンをクリックして、ドラッグ選択モードに切り替えます。マウスをクリックしてドラッグし、選択するノードの周りに四角形を描きます。
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            2 つ以上のノードを選択してから、 <img style={{ width: '22px'}} class="inline" src={smGroupingIcon}/>**グループを作成します**。
          </td>
        </tr>
...
1. **[one.newrelic.com](https://one.newrelic.com)**にアクセスし、 **Explorer**を選択します。
