...
2. カスタムイベントまたは属性を作成する前に、New Relicの[NRQLが使用する予約語](https://docs.newrelic.co.jp/docs/insights/insights-data-sources/custom-data/insights-custom-data-requirements-limits)のリストをご確認ください。
