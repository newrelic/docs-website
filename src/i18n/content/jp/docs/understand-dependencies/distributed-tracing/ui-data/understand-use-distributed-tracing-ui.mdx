...
<CollapserGroup>
  ...
  >
    ...
    * **アカウントのアクセス権限**. [マスター/サブアカウントの関係](/docs/accounts/install-new-relic/account-setup/manage-apps-or-users-sub-accounts#hierarchy)が、アクセスに影響を与えます。アクセスできるのがサブアカウントのみの場合、そのサブアカウントの詳細しか確認できません。マスターアカウントにアクセスできる場合、そのアカウントのサブアカウントの詳細を確認できます。
