...
<CollapserGroup>
  ...
  >
    ...
    ![new-relic-one-distributed-tracing-query-example-1.png](https://jajp-newrelic-docs.onelink-translations.com/sites/default/files/thumbnails/image/new-relic-one-distributed-tracing-query-example-1.png "New Relic Oneディストリビューティッド（分散）トレーシングのクエリの例1")
  ...
  >
    ...
    ![New Relic Oneディストリビューティッド（分散）トレーシング - クエリの例2](https://jajp-newrelic-docs.onelink-translations.com/sites/default/files/thumbnails/image/new-relic-one-distributed-tracing-query-example-2.png "new-relic-one-distributed-tracing-query-example-2.png")
...
![ディストリビューティッド（分散）トレーシングの散布図を示すスクリーンショット。](https://jajp-newrelic-docs.onelink-translations.com/sites/default/files/thumbnails/image/scatter-plot-hover.png "scatter-plot-hover.png")
...
![New Relic Oneディストリビューティッド（分散）トレーシング - ヒストグラム](https://jajp-newrelic-docs.onelink-translations.com/sites/default/files/thumbnails/image/new-relic-one-distributed-tracing-histogram-selection.png "new-relic-one-distributed-tracing-histogram-selection.png")
...
![New Relicディストリビューティッド（分散）トレーシングUI - トレース詳細ページ](https://jajp-newrelic-docs.onelink-translations.com/sites/default/files/thumbnails/image/new-relic-distributed-tracing-trace-details-UI.png "new-relic-distributed-tracing-waterfall-view.png")
...
<CollapserGroup>
  ...
  >
    ...
    * ネットワークレイテンシやDNS解決の遅延などによる、期間の差
    ...
    ![New Relicディストリビューティッド（分散）トレーシングのクライアントとサーバーの時間差の図](https://jajp-newrelic-docs.onelink-translations.com/sites/default/files/thumbnails/image/new-relic-distributed-tracing-client-span-time.jpg "new-relic-distributed-tracing-client-span-time.jpg")
  ...
  >
    ...
    * **アカウントのアクセス権限**. [マスター/サブアカウントの関係](https://jajp-newrelic-docs.onelink-translations.com/docs/accounts/install-new-relic/account-setup/manage-apps-or-users-sub-accounts#hierarchy)が、アクセスに影響を与えます。アクセスできるのがサブアカウントのみの場合、そのサブアカウントの詳細しか確認できません。マスターアカウントにアクセスできる場合、そのアカウントのサブアカウントの詳細を確認できます。
