...
<CollapserGroup>
  ...
  >
    ...
    ![データの流れを示す、次の2つの図をご覧ください：1つはエージェントについて、もう1つはInfinity Tracingのあるインテグレーションについてのものです。](./image/Infinite_Tracing_Overview.png "Infinite_Tracing_Overview.png")
...
![New Relicディストリビューティッド（分散）トレース構造図](./image/new-relic-distributed-tracing-trace-structure.png "trace-structure-diagram.png")
...
![プロプライエタリヘッダーで失敗したトレースの図。](./image/doc-5207_middleware_0.png "middleware.png")
...
<CollapserGroup>
  ...
  >
    ...
    ![さまざまなコンポーネント間のトランザクションのトリップを示す図。](./image/doc-5207_mixed_example_2_0.png "mixed_example_2.png")
  </Collapser>
  ...
  >
    ...
    ![W3C準拠ミドルウェアでの適切なトレースを示す図。](./image/doc-5207_middleware_w3c_0.png "middleware_w3c.png")
  </Collapser>
  ...
  >
    ...
    ![W3C準拠ベンダーでの適切なトレースを示す図。](./image/doc-5207_diff_vend_w3c_0.png "diff_vend_w3c.png")
  </Collapser>
</CollapserGroup>
