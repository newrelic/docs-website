...
<Callout variant="important">
  リージョンアカウントを使用している場合は、`newrelic.syslog.nr-data.net`の代わりに適切なエンドポイントを使用してください：

  * EUアカウント： `newrelic.syslog.eu.nr-data.net`
  * JPアカウント： `newrelic.syslog.jp.nr-data.net`

  設定ファイルで忘れずに置き換えてください；リージョンアカウントにUSエンドポイントを使用しても機能しません。
</Callout>
