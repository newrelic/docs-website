...
* [* 128KBを超えるデータは切り捨てられます。](/docs/logs/ui-data/long-logs-blobs)

## [制約事項 [#attributes]](/docs/logs/ui-data/long-logs-blobs)

[特定の属性には、追加の制限があります。](/docs/logs/ui-data/long-logs-blobs)
...
<table>
  ...
  </tbody>](/docs/logs/ui-data/long-logs-blobs)
</table>