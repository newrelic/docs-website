...
1. [ライセンス キー](/docs/apis/intro-apis/new-relic-api-keys/#license-key)を取得します。
...
[ライセンス キーは、](/docs/apis/intro-apis/new-relic-api-keys/#license-key) Log API へのリクエストを認証する役割を果たし、送信されたログ メッセージが書き込まれる New Relic アカウントを決定します。 HTTP ヘッダーまたはクエリ文字列パラメーターとして渡す必要があります。
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        New Relic [ライセンス キー](/docs/apis/intro-apis/new-relic-api-keys/#license-key)。 [クエリ パラメータを介してこれを送信](#query-parameters)することもできます。
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        あなたの [ライセンスキー](/docs/apis/intro-apis/new-relic-api-keys/#license-key)。 [これを HTTP ヘッダー経由で送信](#auth-header)することもできます。
      </td>
    </tr>
  </tbody>
</table>
