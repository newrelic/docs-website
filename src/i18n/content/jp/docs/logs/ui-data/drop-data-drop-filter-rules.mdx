...
<figcaption>
  削除するデータを含むログのセットをフィルターまたはクエリします。 次に、ログ UI の左側のナビゲーションにある<DoNotTranslate>**Manage data**</DoNotTranslate>から<DoNotTranslate>**Create drop filter**</DoNotTranslate>をクリックします。
</figcaption>
...
2. <DoNotTranslate>[****](#drop-attributes)</DoNotTranslate>
