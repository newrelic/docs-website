    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            `x-edge-result-type` <DNT>**is not**</DNT> `Error`の場合、このフィールドには`x-edge-result-type`と同じ値が含まれます。 `x-edge-result-type` <DNT>**is**</DNT> `Error`の場合、このフィールドには特定のタイプのエラーが含まれます。
          </td>
        </tr>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            `x_edge_result_type` <DNT>**is not**</DNT> `Error`の場合、このフィールドには`x_edge_result_type`と同じ値が含まれます。 `x_edge_result_type` <DNT>**is**</DNT> `Error`の場合、このフィールドには特定のタイプのエラーが含まれます。
          </td>
        </tr>
