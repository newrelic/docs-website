...
<CollapserGroup>
  ...
  >
    使用量がギガバイトのデータの固定月間しきい値を超えたときにアラートを作成するには、次の[NRQLクエリ](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/nrql-alert-conditions/)をアラート条件に追加します。
