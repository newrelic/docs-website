...
<CollapserGroup>
  ...
  >
    ...
    <img
      title="New Relic の .NET エージェントを使ったログのコンテキスト用 log4net 拡張機能"
      alt="ログ・イン・コンテキスト - Log4Net"
...
<CollapserGroup>
  ...
  >
    ...
    <img
      title="New Relic の .NET エージェントと連携してログを取得するための NLog 拡張機能"
      alt="コンテクストの中のログ - NLog"
...
<CollapserGroup>
  ...
  >
    ...
    <img
      title="New Relic の .NET エージェントを使用したコンテキストでのログ用 Serilog 拡張機能"
      alt="ログインコンテクストSerilog"
