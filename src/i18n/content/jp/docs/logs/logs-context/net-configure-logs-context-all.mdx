...
2. [をインストールするか](/docs/agents/net-agent/installation/introduction-net-agent-install)、 [を最新の](/docs/agents/net-agent/installation/update-net-agent) .NET エージェントバージョンに更新し、 [分散型トレーシングを有効にする](/docs/distributed-tracing/enable-configure/quick-start/) 。 [.NET エージェントのバージョン 8.21 以上](/docs/release-notes/agent-release-notes/net-release-notes/) と [New Relic .NET エージェント API のバージョン 8.21 以上](/docs/agents/net-agent/net-agent-api) を使用して、コンテキスト内のログを取得します。
