...
## APM エージェントのサポート [#agent-support]

ログ イン コンテキストとログ転送をサポートするエージェント バージョンの詳細、およびその構成に役立つドキュメントへのリンクについては、 [APM ログ イン コンテキスト](/docs/apm/new-relic-apm/getting-started/get-started-logs-context#agents)を参照してください。
