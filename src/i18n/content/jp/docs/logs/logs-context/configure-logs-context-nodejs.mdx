...
4. [Winston logging framework version 3.0.0以上](https://github.com/winstonjs/winston) をインストールすることで、ログデータを充実させることができます。
5. Winstonエクステンションを使用して、Node.jsのコンテキストでログを設定します。
