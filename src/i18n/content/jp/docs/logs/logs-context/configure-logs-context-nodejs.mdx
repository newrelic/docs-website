...
<CollapserGroup>
  ...
  >
    ...
    ログ転送機能を備えたエージェントバージョン（ [NodeJSエージェント8.11.0以降](https://docs.newrelic.com/docs/release-notes/agent-release-notes/nodejs-release-notes/)）をインストールし、構成を更新して転送を有効にするだけです。
