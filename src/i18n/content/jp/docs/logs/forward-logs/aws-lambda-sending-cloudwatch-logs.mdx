...
1. [ライセンス キーを](/docs/apis/intro-apis/new-relic-api-keys/#license-key)持っていることを確認します。
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [ライセンス キーは、](/docs/apis/intro-apis/new-relic-api-keys/#license-key) New Relic にデータを送信するために使用されます。 **必要。**
      </td>
    </tr>
