...
3. <img title="AWS Lambda - Select region" alt="AWS Lambda - Select region" src={serverlessAWSLambdaSelectRegion}>Lambda が S3 バケットと同じリージョンにインストールされていることを確認してください。</img>
...
6. **アプリケーション設定** までスクロールし、New Relic [ライセンス キー](/docs/apis/intro-apis/new-relic-api-keys/#license-key)を入力します。
