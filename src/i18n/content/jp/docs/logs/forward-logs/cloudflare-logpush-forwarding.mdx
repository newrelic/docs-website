...
7. New Relic の**Logs Endpoint**を入力します。`<NR_LICENSE_KEY>`を [ライセンス キー](/docs/apis/intro-apis/new-relic-api-keys/#license-key)に置き換えます。
   ...
   * 複数のCloudflareゾーンがあると、ゾーンごとに新しい [ライセンスキーが](/docs/apis/intro-apis/new-relic-api-keys/#license-key) 必要になる場合があります。
...
* `destination_conf`: エンドポイント URL、 [ライセンス キー](/docs/apis/intro-apis/new-relic-api-keys/#license-key)、および次の文字列形式の形式で構成されるログの宛先。
  ...
  * `<NR_LICENSE_KEY>`: [UI または API から取得できる](/docs/apis/intro-apis/new-relic-api-keys/#license-key)New Relic [ライセンス キー](/docs/apis/intro-apis/new-relic-api-keys/#manage-license-key)に置き換えます。
