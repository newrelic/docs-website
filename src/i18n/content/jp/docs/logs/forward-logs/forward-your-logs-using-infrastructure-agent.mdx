...
<CollapserGroup>
  ...
  >
    <Callout variant="important">
      Available since infrastructure agent v.1.24.3 Only compatible with Windows Server 2019 and later. Use [winlog](/docs/logs/forward-logs/forward-your-logs-using-infrastructure-agent/#winlog) instead for prior versions.
    </Callout>
...
* In the infrastructure UI, from the host table, click the

  <Icon name="fe-more-horizontal"/>

  icon for a specific host, and then click
