...
2. オプション:
   ...
   <DNT>
     [**subscription**](#subscription-activity-logs)
   </DNT>
...
2. <DNT>
     **[one.newrelic.com](https://one.newrelic.com/launcher/logger.log-launcher)**
   </DNT>
...
2. <DNT>
     **[the logs UI](https://one.newrelic.com/launcher/logger.log-launcher)**
   </DNT>
...
<CollapserGroup>
  ...
  >
    ...
    3. <DNT>**Allow Blob public access**</DNT>の下で、 <DNT>**Disabled**</DNT>を選択します。<img
  ...
  >
    ...
    4. <DNT>**Platform settings**</DNT>の下の<DNT>**FTP state**</DNT>で、 <DNT>**Disabled**</DNT>を選択します。<img
  ...
  >
    ...
    2. 左側のメニューで、 <DNT>**Settings > Configuration**</DNT>に移動します。
    3. <DNT>**General settings**</DNT>タブを選択します。
    4. <DNT>**Platform settings**</DNT>の下の<DNT>**HTTPS Only**</DNT>で、 <DNT>**On**</DNT>を選択します。<img
  ...
  >
    ...
    3. <DNT>**Inbound Traffic**</DNT>ボックス内で、 <DNT>**Access restriction**</DNT>をクリックします。<img
