...
<CollapserGroup>
  ...
  >
    ...
    4. <DoNotTranslate>**Platform settings**</DoNotTranslate>の<DoNotTranslate>**FTP state**</DoNotTranslate>で、 <DoNotTranslate>**Disabled**</DoNotTranslate>を選択します。<img title="Disabling FTP access to the Function App" alt="Disabling FTP access to the Function App" src={disableFtpAccessStorageAccount}/>
  ...
  >
    ...
    2. 左側のメニューで、 <DoNotTranslate>**Settings > Configuration**</DoNotTranslate>に移動します。
    3. <DoNotTranslate>**General settings**</DoNotTranslate>タブを選択します。
    4. <DoNotTranslate>**Platform settings**</DoNotTranslate>の<DoNotTranslate>**HTTPS Only**</DoNotTranslate>で、 <DoNotTranslate>**On**</DoNotTranslate>を選択します。<img title="Enforcing HTTPS to the Function App" alt="Enforcing HTTPS to the Function App" src={enforceHttpsFunctionApp}/>
    5. <DoNotTranslate>**Save**</DoNotTranslate>をクリックします。
  </Collapser>
