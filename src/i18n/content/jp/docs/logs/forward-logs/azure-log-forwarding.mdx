...
2. **[one.newrelic.com](https://one.newrelic.com/launcher/logger.log-launcher)**に移動し、左側のメニューから**Add data** \[データの追加]をクリックします。

3. **Logging** \[ログ]で、 **Microsoft Azure Event Hub** \[Microsoft Azure Event Hub]タイルをクリックします。
