...
2. オプション:
   ...
   <DNT>[**subscription**](#subscription-activity-logs)</DNT>
...
2. <DNT>**[one.newrelic.com](https://one.newrelic.com/launcher/logger.log-launcher)**</DNT>
...
3. <DNT>**Logging**</DNT>
   ...
   <DNT>**Microsoft Azure Event Hub**</DNT>
...
8. <DNT>**New Relic license key**</DNT>
...
2. <DNT>**[the logs UI](https://one.newrelic.com/launcher/logger.log-launcher)**</DNT>
...
<CollapserGroup>
  ...
  >
    ...
    3. <DNT>**Allow Blob public access**</DNT>の下で、 <DNT>**Disabled**</DNT>を選択します。<img title="Disabling public access to the blobs/containers in the Storage account" alt="Disabling public access to the blobs/containers in the Storage account" src={disablePublicBlobAccessStorageAccount}/>
  ...
  >
    ...
    4. <DNT>**Platform settings**</DNT>の下の<DNT>**FTP state**</DNT>で、 <DNT>**Disabled**</DNT>を選択します。<img title="Disabling FTP access to the Function App" alt="Disabling FTP access to the Function App" src={disableFtpAccessStorageAccount}/>
  ...
  >
    ...
    2. 左側のメニューで、 <DNT>**Settings > Configuration**</DNT>に移動します。
    3. <DNT>**General settings**</DNT>タブを選択します。
    4. <DNT>**Platform settings**</DNT>の下の<DNT>**HTTPS Only**</DNT>で、 <DNT>**On**</DNT>を選択します。<img title="Enforcing HTTPS to the Function App" alt="Enforcing HTTPS to the Function App" src={enforceHttpsFunctionApp}/>
    5. <DNT>**Save**</DNT>をクリックします。
  </Collapser>
  ...
  >
    ...
    3. <DNT>**Inbound Traffic**</DNT>ボックス内で、 <DNT>**Access restriction**</DNT>をクリックします。<img title="Disabling public network access to the Function App" alt="Disabling public network access to the Function App" src={disablePublicNetworkAccessFunctionApp}/>
