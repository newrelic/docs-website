...
![Microsoft Azure Event Hubのデータソースボタン](./images/azure-eventhub-tile.png)
...
![Kubernetesサービスボタン](./images/azure-eventhub-k8s-service.png)

3. 左側のメニューで、 **モニタリング`> `診断設定** を選択します。

![診断設定メニュー](./images/azure-eventhub-diagnosticsettings.png)

4. **診断設定の追加** をクリックします。

![診断設定追加ボタン](./images/azure-eventhub-add-diagnostic-setting.png)

5. 新しい設定には、意味のある名前をつけてください。

![診断設定名](./images/azure-eventhub-diagnosticsetting-name.png)

6. 収集したいKubernetes（コントロールペイン）のログを選択します。

![Kubernetesのログ](./images/azure-eventhub-diagnostic-logs.png)
...
![デスティネーション詳細設定](./images/azure-eventhub-destination-details-settings.png)

8. **Save** をクリックし、Kubernetes ログの New Relic への転送を開始します。

![診断設定保存ボタン](./images/azure-eventhub-save-button.png)
...
![Microsoft Azure Blob Storage データソースボタン](./images/azure-blobstorage-tile.png)
