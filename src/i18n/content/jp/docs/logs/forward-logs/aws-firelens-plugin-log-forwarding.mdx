...
INSERT_API_KEY を New Relic ライセンス キーに置き換えて、 `logConfiguration`ブロックを使用します。構成の詳細については、 [GitHub の FireLens タスク定義を](https://github.com/aws-samples/amazon-ecs-firelens-examples)参照してください。
