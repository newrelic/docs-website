...
5. 該当する場合は、[手動のLogs in Context](/docs/logs/enable-log-management-new-relic/configure-logs-context/configure-logs-context-apm-agents/)手順に従って、アプリの
