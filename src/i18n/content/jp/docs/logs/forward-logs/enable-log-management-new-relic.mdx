...
インフラストラクチャ ログ転送に自動的に含まれるホスト メトリックが必要ない場合、またはログ フォワーダーが既にある場合は、次のサポートされているオプションのいずれかを使用して、オペレーティング システムから New Relic にログを転送できます。
...
* [アカマイ データストリーム 2](https://newrelic.com/instant-observability/datastream2/cb995039-39d8-44d9-97c3-58174a1337f2)
* [クラウドフレア Logpush](/docs/logs/forward-logs/cloudflare-logpush-forwarding/)
* [ファストリー](https://newrelic.com/instant-observability/fastly-cdn/c5c5dd30-dcdf-46b6-9412-f9a1bba5a600)
