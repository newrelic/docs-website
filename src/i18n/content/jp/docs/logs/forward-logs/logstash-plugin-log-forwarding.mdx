...
<table>
  ...
  </tbody>](https://github.com/newrelic/logstash-examples/blob/master/README.md#example-configurations-for-logstash)
</table>
...
1. [* `logstash.conf` ファイルに以下を追加します。
     ...
     ```](https://github.com/newrelic/logstash-examples/blob/master/README.md#example-configurations-for-logstash)

2. [](https://github.com/newrelic/logstash-examples/blob/master/README.md#example-configurations-for-logstash)

   [](https://github.com/newrelic/logstash-examples/blob/master/README.md#example-configurations-for-logstash)[New Relic Logs UI](https://one.newrelic.com/launcher/logger.log-launcher) を検索して `テストメッセージ`.
