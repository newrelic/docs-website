...
Google Cloud Platform の Pub/Sub トピックから New Relic にログを転送する方法として、2 種類の方法をサポートしています。
...
## ヘッダーレス API の使用 [#gcp-headerless-api]

GCP のログをヘッダーレス API を使って New Relic に送信するためのものです。
...
<CollapserGroup>
  ...
  >
    ...
    ![データソースの追加](src/images/gcp-add-more-data.png "データソースの追加")
  ...
  >
    ...
    ![GCPトピックの作成](src/images/gcp-create-topic.png "GCPトピックの作成")
  ...
  >
    ...
    ![GCP Pub/Subトピックサブスクリプションの作成](src/images/gcp-create-subscription.png "GCP Pub/Subトピックサブスクリプションの作成")
    ...
    3. スクロールダウンして **Subscriptions** タブを選択し、 **Create Subscription** をクリックし、 **Create a simple subscription** を選択します。
       ...
       ![GCP Pub/Subトピックの購読タイプを選択](src/images/gcp-create-subscription-type.png "GCP Pub/Subトピックの購読タイプを選択")
  ...
  >
    ...
    ![GCP Pub/Subログの作成 ルーターシンク](src/images/gcp-create-sink.png "GCP Pub/Subログの作成 ルーターシンク")
