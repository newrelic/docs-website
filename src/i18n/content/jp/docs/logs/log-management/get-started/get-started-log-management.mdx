...
oEmbedVideo = Wistia.embed("3j7spmzlhc", &#x7B; videoFoam: "true" });
...
![New Relic One - Logs](./images/nrone-logs.png "New Relic One - Logs")

<figcaption>
  **[one.newrelic.com](http://one.newrelic.com) > Logs**: Use the New Relic log management UI to explore your logging data.
</figcaption>
...
* Visualize your log data directly from the [Logs UI](https://docs.newrelic.co.jp/docs/logs/new-relic-logs/ui-data/explore-your-data-new-relic-logs-ui).
...
* Forward your logs [using our Infrastructure agent](https://docs.newrelic.co.jp/docs/logs/enable-new-relic-logs/1-enable-logs/forward-your-logs-using-new-relic-infrastructure-agent) or our [Kubernetes plugin](/docs/logs/enable-logs/enable-logs/kubernetes-plugin-logs).
...
## Find your logging data in New Relic [#find-data]
