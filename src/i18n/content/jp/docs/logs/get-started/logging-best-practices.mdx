...
* <DNT>**Logs analysis**</DNT>および/または<DNT>**APM logs monitoring quickstart**</DNT>ダッシュボードをインストールして、ログ データへのインサイトを迅速に増やします。 これらのダッシュボードを追加するには、 <DNT>**[one.newrelic.com](https://one.newrelic.com) > Add Data > Logging > Dashboards**</DNT>に移動します。
