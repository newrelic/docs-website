  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        設定したしきい値より遅いトランザクションの場合、New Relic は SQL `EXPLAIN`からもデータを収集します。データベース呼び出しが設定されたしきい値よりも遅い場合、New Relic はオプションでランタイム スタック トレースを収集します。これは、コード内でデータベース呼び出しが行われた場所を特定するのに役立ちます。
      </td>
    </tr>
...
New Relic が受け取る情報を制限したい場合は、[高セキュリティ モードを](#high-security)有効にすることができます。高セキュリティ モードまたはデフォルト設定がビジネス ニーズに適合しない場合は、[カスタム](#custom)設定を適用できます。
...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="ハイセキュリティモード"
  >
    エージェントが[高セキュリティ モード](/docs/agents/manage-apm-agents/configuration/high-security-mode)の場合、[デフォルト設定](#default)はロックされ、ユーザーは変更できません。

    さらに、高セキュリティ モードでは、エージェントに応じて、カスタム イベント、カスタム インストルメンテーション、ユーザー属性、例外メッセージ、またはメッセージ キュー パラメーターに制限が適用されます。

    * [高セキュリティモードの設定に進む](/docs/agents/go-agent/get-started/apm-agent-security-go#restricted)
    * [Java高セキュリティモードの設定](/docs/agents/java-agent/getting-started/apm-agent-security-java#restricted)
    * [.NET高セキュリティモードの設定](/docs/agents/net-agent/getting-started/apm-agent-security-net#restricted)
    * [Node.js の高セキュリティ モードの設定](/docs/agents/nodejs-agent/getting-started/apm-agent-security-nodejs#restricted)
    * [PHPの高セキュリティモードの設定](/docs/agents/php-agent/getting-started/apm-agent-security-php#restricted)
    * [Pythonの高セキュリティモード設定](/docs/agents/python-agent/getting-started/apm-agent-security-python#restricted)
    * [Rubyの高セキュリティモード設定](/docs/agents/ruby-agent/getting-started/apm-agent-security-ruby#restricted)
  </Collapser>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [`proxy`](/docs/agents/net-agent/installation-configuration/net-agent-configuration#proxy) 要素
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        [`newrelic.daemon.proxy`](/docs/agents/php-agent/configuration/php-agent-configuration#inivar-daemon-proxy) またはデーモンの [`proxy`](/docs/agents/php-agent/configuration/php-agent-configuration#inivar-daemon-proxy) 設定
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        [`proxy` 設定](/docs/agents/python-agent/installation-configuration/python-agent-configuration#proxy)
      </td>
    </tr>
