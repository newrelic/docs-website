...
<CollapserGroup>
  ...
  >
    ...
    3. UI（および[ブラウザー監視の関連アプリ](/docs/browser/browser-monitoring/installation/install-browser-monitoring-agent/#select-apm-app)）からAPMアプリケーションを削除するには、いくつかのオプションがあります。

       * **UIからアプリを削除します。****[one.newrelic.com](https://one.newrelic.com) > APM>（アプリ/サービスを選択）>\[設定]>\[**アプリケーション]に移動し、 **\[アプリケーションの削除]**ボタンをクリックします。
  </Collapser>
  ...
  >
    ...
    * **UIから削除します。****[one.newrelic.com](https://one.newrelic.com) >ブラウザ>（アプリを選択）>設定>アプリケーション設定**に移動し、 **\[アプリケーションの削除]**ボタンをクリックします。
  ...
  >
    ...
    * **UIを使用して削除します。****[one.newrelic.com](https://one.newrelic.com) >モバイル>（アプリを選択）>設定>アプリケーション**に移動し、**アプリケーションの削除**をクリックします。
    * **NerdGraphを使用してエンティティを削除します。**上記を実行してもUIにそのアプリが表示される場合は[、NerdGraphを使用して関連するエンティティを削除](/docs/apis/nerdgraph/examples/nerdgraph-entities-api-tutorial/#delete-entities)できます。エンティティIDを見つける方法については、[エンティティ](/docs/new-relic-one/use-new-relic-one/core-concepts/what-entity-new-relic/#find)を参照してください。
  </Collapser>
</CollapserGroup>
...
<CollapserGroup>
  ...
  >
    ...
    1. [**one.newrelic.com**](http://one.newrelic.com)から、**APM**を選択してから、アプリケーションを選択します。
    ...
    4. [**one.newrelic.com**](http://one.newrelic.com)から、**APM**を選択してから、アプリケーションを選択します。
