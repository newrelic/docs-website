...
<CollapserGroup>
  ...
  <Collapser id="remove-otel-apps" title="OpenTelemetry">
    93 日後、アプリは UI から削除されます。 それよりも早く削除したい場合は、 [NerdGraph を使用して関連するエンティティを削除します](/docs/apis/nerdgraph/examples/nerdgraph-entities-api-tutorial/#delete-entities)。 エンティティ ID を検索するには、 [「エンティティ」](/docs/new-relic-one/use-new-relic-one/core-concepts/what-entity-new-relic/#find)を参照してください。
  </Collapser>
</CollapserGroup>
