...
<Callout variant="tip">
  ...
  [デプロイメントマーカーはブラウザアプリケーションにおいて利用できませんが、リリースバージョンにエラーをタグ付けする方法については](/docs/apm/applications-menu/events/deployments-page-view-impact-your-app-users)[ブラウザリリース](/docs/browser/new-relic-browser/browser-agent-spa-api/add-release)を参照してください。
</Callout>
