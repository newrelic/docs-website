...
<CollapserGroup>
  ...
  >
    ...
    ```
    curl -X POST "https://api.newrelic.com/v2/applications/<var><a href="/docs/apis/rest-api-v2/requirements/finding-product-id#apm">YOUR_APP_ID</a></var>/deployments.json" \
         -H "X-Api-Key:<var><a href="/docs/apis/rest-api-v2/requirements/api-keys#rest-api-key">YOUR_API_KEY</a></var>" \
         -i \
  ...
  >
    ...
    $request = [System.Net.WebRequest]::Create('https://api.newrelic.com/v2/applications/<var><a href="/docs/apis/rest-api-v2/requirements/finding-product-id#apm">YOUR_APP_ID</a></var>/deployments.json')
    $request.Method = 'POST'
    $request.Headers.add('X-Api-Key','<var><a href="/docs/apis/rest-api-v2/requirements/api-keys#rest-api-key">YOUR_API_KEY</a></var>')
  ...
  >
    ...
    ```
    curl -X GET "https://api.newrelic.com/v2/applications/<var><a href="/docs/apis/rest-api-v2/requirements/finding-product-id#apm">YOUR_APP_ID</a></var>/deployments.json" \
         -H "X-Api-Key:<var><a href="/docs/apis/rest-api-v2/requirements/api-keys#rest-api-key">YOUR_API_KEY</a></var>" \
         -i
    ```
  ...
  >
    ...
    ```
    curl -X DELETE "https://api.newrelic.com/v2/applications/<var><a href="/docs/apis/rest-api-v2/requirements/finding-product-id#apm">YOUR_APP_ID</a></var>/deployments/<var>DEPLOYMENT_ID</var>.json" \
         -H "X-Api-Key:<var><a href="/docs/apis/rest-api-v2/requirements/api-keys#admin-api">ADMIN_USERS_KEY</a></var>" \
         -i
    ```
  </Collapser>
