...
以下に示すいずれかの例で[パーソナル APIキー](https://docs.newrelic.co.jp/docs/alerts-applied-intelligence/new-relic-alerts/rest-api-alerts/rest-api-calls-alerts#personal-api-key)を使用するには、'X-Api-Key','<var><a href="/docs/apis/rest-api-v2/requirements/api-keys#rest-api-key">YOUR_API_KEY</a></var>' を'Api-Key',' <var><a href="/docs/apis/rest-api-v2/requirements/api-keys#rest-api-key"> YOUR_PERSONAL_API_KEY</a></var>' に置き換えます。
