...
<Callout variant="tip">
  ...
  [デプロイメントマーカーはブラウザアプリケーションにおいて利用できませんが、リリースバージョンにエラーをタグ付けする方法については](/docs/apm/applications-menu/events/deployments-page-view-impact-your-app-users)[ブラウザリリース](https://jajp-newrelic-docs.onelink-translations.com/docs/browser/new-relic-browser/browser-agent-spa-api/add-release)を参照してください。
</Callout>
...
<CollapserGroup>
  ...
  >
    ...
    ```
    curl -X DELETE "https://api.newrelic.com/v2/applications/<var><a href="/docs/apis/rest-api-v2/requirements/finding-product-id#apm">$APP_ID</a></var>/deployments/<var>$EMPLOYMENT_ID</var>.json" \
         -H "Api-Key:<a href="/docs/apis/rest-api-v2/getting-started/introduction-new-relic-rest-api-v2#api_key"><var>$API_KEY</var></a>" \
         -i
    ```
  </Collapser>
