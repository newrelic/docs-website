...
1. スパンデータを表示するには: <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Query your data**</DoNotTranslate>に移動して次のクエリを入力します:
