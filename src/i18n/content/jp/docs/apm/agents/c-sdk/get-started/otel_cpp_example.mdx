...
OpenTelemetry C++ リポジトリには[、GitHub に優れた例が](https://github.com/open-telemetry/opentelemetry-cpp/tree/main/examples)多数あります。 OpenTelemetry C++ SDK の構築と使用、およびサンプルの構築と実行に関する詳細な手順については、 [`CONTRIBUTING.md`](https://github.com/open-telemetry/opentelemetry-cpp/blob/main/CONTRIBUTING.md)を参照してください。
...
1. スパンデータを表示するには: <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) &amp;gt; Query your data**</DNT>に移動して次のクエリを入力します:
