...
<Callout variant="important" title="EOL通知">
  2022年4月以降、C SDK機能はサポートしていません。C++テレメトリデータをNew Relicに送信する代替手段として[OpenTelemetryを使用するオプション](/docs/apm/agents/c-sdk/get-started/otel_cpp_example)を検討してください。EOLの詳細については、[サポートフォーラムの投稿](https://discuss.newrelic.com/t/q1-bulk-eol-announcement-fy23/181744)をご覧ください。
</Callout>
