...
<Callout
  ...
  title="有効期限（EOL）の通知"
>
  2022年4月現在、C SDKを含む一部の機能のサポートを終了しています。 C++テレメトリーデータをNew Relicに送信する代わりに[OpenTelemetryを使用するオプション](/docs/apm/agents/c-sdk/get-started/otel_cpp_example)を検討してください。EOLの詳細については、[エクスプローラーハブの投稿](https://discuss.newrelic.com/t/q1-bulk-eol-announcement-fy23/181744)をご覧ください。
</Callout>
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > APM >（アプリを選択）：**以下は、C SDKをアプリにデプロイした後にNew Relicで表示できるデータの例をいくつか示したものです。
</figcaption>
