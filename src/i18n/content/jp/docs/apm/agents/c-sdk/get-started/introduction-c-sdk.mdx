...
<Callout variant="important" title="EOL通知">
  2022年4月以降、C SDK機能はサポートしていません。C++テレメトリーデータをNew Relicに送信する代替手段として[OpenTelemetryを使用するオプション](https://opentelemetry.io/docs/languages/cpp/getting-started/)を検討してください。EOLの詳細については、[サポートフォーラムの投稿](https://support.newrelic.com/s/hubtopic/aAX8W0000008d0r/q1-bulk-eol-announcement-fy23)をご覧ください。
</Callout>
