...
<Callout variant="tip">
  ...
  * [APMへの影響では](/docs/apm/distributed-tracing/getting-started/transition-guide-distributed-tracing)、現在 <InlinePopover type="apm" />ユーザーであるが、ディストリビューティッド（分散）トレーシングを設定していない場合に予想される影響について説明します。
</Callout>
