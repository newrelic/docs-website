...
<CollapserGroup>
  ...
  >
    ...
    2. 無視したいエラーがあるアプリケーションの

       <DNT>
         [**Server-side configuration**](/docs/agents/manage-apm-agents/configuration/server-side-agent-configuration#customize-ssc)
       </DNT>

       [メニュー](/docs/agents/manage-apm-agents/configuration/server-side-agent-configuration#customize-ssc)に移動します。
  ...
  >
    ...
    * <DNT>
      ...
      ：`error_collector.ignore_classes`、 `error_collector.ignore_classes.message`、または`error_collector.ignore_status_codes`。詳細については、[Javaエージェントのエラー設定](/docs/agents/java-agent/configuration/java-agent-error-configuration)を参照してください。

    * <DNT>
        **.NET**
      </DNT>

      ：[`ignoreErrors`](/docs/apm/agents/net-agent/configuration/net-agent-configuration/#error-ignoreErrors)または[`ignoreStatusCodes`](/docs/apm/agents/net-agent/configuration/net-agent-configuration/#error-ignoreStatusCodes)。

    * <DNT>
        **Node.js**
      </DNT>

      ：`ignore_status_codes`、[ `ignore_classes`](/docs/agents/nodejs-agent/installation-configuration/nodejs-agent-configuration#error_ignore)、または[`ignore_messages`](/docs/agents/nodejs-agent/installation-configuration/nodejs-agent-configuration#error_ignore)。

    * <DNT>
        **PHP**
      </DNT>

      ：[`error_collector.ignore_exceptions`](/docs/apm/agents/php-agent/configuration/php-agent-configuration/#inivar-err-ignore-exceptions)または[`error_collector.ignore_errors`](/docs/apm/agents/php-agent/configuration/php-agent-configuration/#inivar-err-ignore-errors)。

    * <DNT>
        **Python**
      </DNT>

      ：[`error_collector.ignore_classes`](/docs/agents/python-agent/configuration/python-agent-configuration/#error-ignore)または[`error_collector.ignore_status_codes`](/docs/agents/python-agent/configuration/python-agent-configuration/#error-ignore-status-codes)。
...
* [APMの](/docs/apm/applications-menu/monitoring/apm-overview-page)

  <DNT>
    [**Overview**](/docs/apm/applications-menu/monitoring/apm-overview-page)
  </DNT>

  [ページ](/docs/apm/applications-menu/monitoring/apm-overview-page)：お使いのアプリケーションの高度なビューが表示され、それにはエラーが含まれます。
