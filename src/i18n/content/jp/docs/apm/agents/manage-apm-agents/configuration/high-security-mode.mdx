...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        * [元のユーザー モデルのユーザーの場合](/docs/accounts/original-accounts-billing/original-users-roles/users-roles-original-user-model): アカウント所有者のみがこれを構成できます。**[one.newrelic.com](https://one.newrelic.com)**にアクセスし、[アカウントのドロップダウン](/docs/using-new-relic/welcome-new-relic/get-started/glossary#account-dropdown)をクリックし、\[**アカウント設定**] を選択します。そのページで、\[**高セキュリティ モード]**を選択します。
