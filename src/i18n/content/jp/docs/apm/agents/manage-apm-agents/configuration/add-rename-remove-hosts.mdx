...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        [`newrelic_datastore_segment_params_t::host`](https://newrelic.github.io/c-sdk/structnewrelic__datastore__segment__params__t.html#a6a2595298045f0174b9b9c39ea31b6eb)データストア セグメントを編集します。
      </td>
    </tr>
