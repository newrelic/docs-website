...
通常、2 つのインスタンスが同じアプリ名、エージェント言語、[ライセンスキー](/docs/apis/intro-apis/new-relic-api-keys/#ingest-license-key)でレポートする場合、 New Relicそれらのデータを 1 つのNew Relic - モニター アプリに集約します。 アプリの New Relic [APM <DoNotTranslate>**Overview**</DoNotTranslate>ページ](/docs/apm/applications-menu/monitoring/apm-overview-page#infra-server)から個々のホストとインスタンスのデータを表示することもできます。
...
<Callout variant="important">
  セッショントレース データは、リストされている最初のアプリケーションに<DoNotTranslate>**only**</DoNotTranslate>報告されます。 その他のブラウザデータは最大 3 つのアプリケーションのそれぞれに入力されますが、セッション トレース データは最も具体的なアプリケーションに限定されます。
</Callout>
