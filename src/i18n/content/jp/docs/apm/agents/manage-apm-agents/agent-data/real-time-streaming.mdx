...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities)**にアクセスし、ページの上部にある \[**データのクエリ] を選択します**。
2. [データ エクスプローラー](/docs/query-your-data/explore-query-data/browse-data/introduction-data-explorer)を使用して、グラフの作成を開始します。
