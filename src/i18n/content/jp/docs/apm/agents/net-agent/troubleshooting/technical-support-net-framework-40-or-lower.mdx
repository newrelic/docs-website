...
<Callout variant="important">
  New Relic .NET フレームワーク 4.0 以下を使用する顧客向けに <DNT>**limited technical support**</DNT> を提供します。
</Callout>
...
<Callout variant="important">
  .NET フレームワーク バージョン 4.0 以下で実行されているアプリケーションには、 New Relic .NET エージェント バージョン <DNT>**lower than 7.0**</DNT> が必要です。
</Callout>
