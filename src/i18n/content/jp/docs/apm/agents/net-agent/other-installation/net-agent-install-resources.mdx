...
1. [.NET エージェントのダウンロード サイト](https://download.newrelic.com/dot_net_agent/latest_release/) に移動し、アプリケーションのアーキテクチャ (64 ビットまたは 32 ビット) に一致するファイルを取得します。
...
* <DNT>**License key**</DNT><InlinePopover type="licenseKey"/>を設定するための環境変数は次のとおりです。
...
* <DNT>**App name**</DNT>[意味のあるアプリケーション名](/docs/agents/manage-apm-agents/app-naming/name-your-application#app-name)を設定することをお勧めしますが、インストール後に設定することもできます。 環境変数は次のとおりです。
       ...
       <table>
         ...
         <tbody>
           <tr>
             ...
             <td>
               <DNT>**Required**</DNT>. あなたの<InlinePopover type="licenseKey"/> 。
             </td>
           </tr>
       ...
       <table>
         ...
         <tbody>
           <tr>
             ...
             <td>
               <DNT>**Required**</DNT>エージェントがインストールされている場所。 絶対パスまたは相対パスを指定できます。 引用符が必要です。
             </td>
           </tr>
           ...
           <tr>
             ...
             <td>
               <DNT>**Required**</DNT>ローカル (アプリ固有) インストールかグローバル (システム全体) インストールかを決定します。
             </td>
           </tr>
           ...
           <tr>
             ...
             <td>
               オプション。 64 ビット バージョンではなく、32 ビット バージョンのエージェントをインストールします。 New Relic <DNT>**does not recommend**</DNT>エージェントの 32 ビット バージョンをグローバルにインストールしています。
             </td>
           </tr>
