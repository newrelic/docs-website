...
<CollapserGroup>
  ...
  >
    ...
    2. [.NET エージェント ダウンロード サイト](https://download.newrelic.com/dot_net_agent/latest_release/)から .NET Core エージェントのスクリプト可能なインストーラー パッケージをダウンロードします。これらのパッケージのいずれかをダウンロードまたは使用することにより、[ライセンス条項](/docs/licenses/license-information/agent-licenses/net-agent-licenses)に同意し、同意したことになります。
