  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        `GetBrowserTimingFooter` エージェント バージョン 3.x 以降、**廃止**とマークされています。
      </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        `browserMonitoring.attributes.include`/ `exclude`使用すると、どのカスタム属性を含めるかをより詳細に制御できます。 <InlinePopover type="browser"/>データ。
      </td>
    </tr>
