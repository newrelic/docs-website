...
現在実行中の[span](/docs/apm/agents/net-agent/net-agent-api/ispan/)へのアクセスを提供し、New Relic API内で[span固有のメソッド](/docs/apm/agents/net-agent/net-agent-api/ispan)を使用できるようにします。
