...
<CollapserGroup>
  ...
  >
    ...
    4. 詳細については、個々のトレースをクリックしてください。 上部のメニューで
  ...
  >
    ...
    3. 詳細については、個々のトレースをクリックしてください。 上部のメニューで
...
<DNT>**Recommendation:**</DNT> カスタム インストゥルメントを実行する前に、以下をお読みください。
