...
<CollapserGroup>
  ...
  >
    ...
    2. お使いの[アーキテクチャ](/docs/apm/agents/net-agent/getting-started/net-agent-compatibility-requirements-net-core/#architecture)に適したrpmインストールファイルを[ダウンロードサイト](https://download.newrelic.com/dot_net_agent/latest_release/)からダウンロードして実行します。
