      ...
      <tbody>
        ...
        <tr id="500">
          ...
          <td>
            ...
            [カスタムトランザクション](/docs/apm/agents/net-agent/custom-instrumentation/create-transactions-xml-net/)を使用するには、[カスタムインストゥルメンテーション](/docs/apm/agents/net-agent/custom-instrumentation/introduction-net-custom-instrumentation/)の更新が必要になる場合があります。UI上の表示例については、[New Relicオンラインテクニカルコミュニティの投稿](https://support.newrelic.com/s/hubtopic/aAX8W0000008YBU/change-in-nonweb-transaction-reporting-with-version-5x)を参照してください。
          </td>
        </tr>
