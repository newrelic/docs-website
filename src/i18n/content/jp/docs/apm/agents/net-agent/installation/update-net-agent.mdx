...
<Callout variant="important">
  ...
  * エージェントの更新には、Windows管理者グループの<DNT>**Administrator**</DNT>権限が必要です。詳しくは、[アクセス許可のドキュメント](/docs/apm/agents/net-agent/getting-started/net-agent-compatibility-requirements-net-framework/#user-rights)を参照してください。
