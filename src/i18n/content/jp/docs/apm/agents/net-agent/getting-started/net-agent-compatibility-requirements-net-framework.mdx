      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            1. [インストレーションツール](https://one.newrelic.com/marketplace?state=bf68ca4b-b7cc-3227-fcc3-3349f5aa92f6)の手順に従って、New Relic APM .NETエージェントとInfrastructureエージェントをインストールします。
