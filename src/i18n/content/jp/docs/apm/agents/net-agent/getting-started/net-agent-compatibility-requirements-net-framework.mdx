  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        ブラウザー インジェクションを有効にすると、 [APM 概要ページ](/docs/apm/apm-ui-pages/monitoring/apm-summary-page-view-transaction-apdex-usage-data/)でブラウザー データを表示し、 <InlinePopover type="apm"/>そして<InlinePopover type="browser"/>特定のアプリのデータ。 構成オプションと手動インストルメンテーションについては、 [「ブラウザ監視と .NET エージェント」](/docs/apm/agents/net-agent/other-features/browser-monitoring-net-agent/)を参照してください。
      </td>
    </tr>
