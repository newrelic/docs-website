...
<CollapserGroup>
  ...
  >
    ...
    >
      ...
      これらのフレームワークバージョンの.NETエージェントのサポートは、リリース済みバージョンと同様に継続されます。今後のメジャーリリースでは、.NET Framework 4.6.2 以降を対象としています。この移行の簡単な準備方法などの詳細については、[エクスプローラーハブの投稿](https://discuss.newrelic.com/t/q1-bulk-eol-announcement-fy23/181744)を参照してください。
    </Callout>
