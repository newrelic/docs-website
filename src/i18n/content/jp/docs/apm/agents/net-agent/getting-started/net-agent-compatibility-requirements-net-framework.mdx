      ...
      <tbody>
        <tr>
          ...
          <td>
            ...
            * [WCF](/docs/apm/agents/net-agent/other-installation/install-net-agent-windows-communication-foundation-wcf/)
              ...
              * [**バインディングタイプ**](https://docs.microsoft.com/en-us/dotnet/framework/wcf/system-provided-bindings)（クライアントとサービスの両方）  
        ...
        <tr>
          ...
          <td>
            ...
            * **Mono：**New RelicはLinuxで稼働するオープンソースの.NETフレームワークである[Mono](https://www.mono-project.com/)をサポートしていません。その理由は、Monoベースの.NETアプリケーションへのプロファイラーとして、.NETエージェントにインジェクションするプロファイラーAPIがないためです。プロファイラーAPIは、コンポーネントオブジェクトモデル（COM）ベースのインタフェースであり、Linuxではサポートされていません。
          </td>
        </tr>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            * 確認済みの互換性バージョン: 8.0.0、8.1.0、8.1.1、8.9.1、8.9.2、8.10.0、8.11.0
            * バージョン 8.10.0 以降は、.NET エージェント v10.20.1 以降でサポートされます。
