  ...
  <TabsPages>
    <TabsPageItem id="1">
      ...
      <CollapserGroup>
        ...
        <Collapser className="freq-link" id="operating-system" title="オペレーティング·システム">
        ...
        <Collapser className="freq-link" id="user-rights" title="権限">
    ...
    <TabsPageItem id="2">
      ...
      <CollapserGroup>
        ...
        <Collapser id="lifespan" title="アプリケーションの寿命">
        ...
        <Collapser className="freq-link" id="code-access" title="コードアクセスセキュリティ">
        ...
        <Collapser className="freq-link" id="other-apm" title="その他のモニターソフトウェアの使用">
      ...
      <CollapserGroup>
        ...
        <Collapser className="freq-link" id="binding-types" title="バインディングの種類">
        ...
        <Collapser className="freq-link" id="hosting-models" title="ホスティングモデル">
        ...
        <Collapser className="freq-link" id="hosting-models" title="呼び出しモデル">
        ...
        <Collapser id="technologies" title="ダッシュボード対応.NET言語とテクノロジー">
        ...
        <Collapser className="freq-link" id="unsupported-frameworks" title="サポートされていないフレームワーク">
