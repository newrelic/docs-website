    ...
    <TabsPageItem id="core">
      ...
      <CollapserGroup>
        ...
        <Collapser className="freq-link" id="target-framework-core" title="ターゲットフレームワークのバージョン">
          .NETエージェントのサポート対象は、.NET Core 3.1、.NET 5.0、6.0、8.0を対象とするアプリケーションのみです。ターゲットフレームワークは、`.csproj`ファイルで見つけることができます。エージェントの互換性は、.NET Coreのバージョンによって異なります。
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  * 最新の検証済み互換バージョン: 4.0.0-preview.4
