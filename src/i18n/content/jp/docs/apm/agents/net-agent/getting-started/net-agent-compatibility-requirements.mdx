...
New Relicの.NETエージェントは、.NET Frameworkと.NET Coreの両方をサポートしています。本文書では、.NET Coreアプリケーションの互換性とサポートを説明します。
...
<Tabs>
  ...
  <TabsPages>
    <TabsPageItem id="1">
      ...
      <CollapserGroup>
        <Collapser className="freq-link" id="net-version" title=".NET Coreバージョン">
    ...
    <TabsPageItem id="2">
      ...
      <CollapserGroup>
        <Collapser className="freq-link" id="net-version" title=".NET Frameworkのバージョン">
