      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            検証済みの互換性バージョン：2.3.0、2.8.1、2.13.1、2.14.1、2.17.1、2.19.0、2.20.0、2.21.0、2.22.0、2.23.0、2.23.1
        ...
        <tr>
          ...
          <td>
            ...
            * 検証済みの互換性バージョン：1.0.1、1.3.13、2.1.2、2.3.1、2.3.3
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            ...
            検証済みの互換性バージョン：1.0.488、1.1.608、1.2.6、2.0.601、2.1.58、2.2.88、2.6.66、2.6.116、2.7.4、2.7.10
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            ...
            * バージョン8.9.10以降は、.NETエージェントv10.20.1以降でサポートされます。
