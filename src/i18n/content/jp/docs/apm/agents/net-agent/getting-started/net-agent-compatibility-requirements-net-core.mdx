      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            検証済みの互換性バージョン：2.3.0、2.8.1、2.13.1、2.14.1、2.17.1、2.19.0、2.20.0、2.21.0
        ...
        <tr>
          ...
          <td>
            ...
            * 検証済みの互換性バージョン：6.10.7、8.0.15、8.0.30、8.0.33、8.1.0
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            * 検証済みの互換性バージョン：3.5.2、3.6.9、4.1.3、5.1.0、5.2.0, 6.0.0, 6.2.1, 6.4.0, 6.5.0
          </td>
        </tr>
      </tbody>
    </table>
