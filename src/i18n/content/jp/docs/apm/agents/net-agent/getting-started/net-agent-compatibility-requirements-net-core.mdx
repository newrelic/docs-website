      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            * 互換性を確認したバージョン: 8.0.0、8.1.0、 8.1.1、 8.9.1、8.9.2、8.9.3、8.10.0、 8.11.0、8.12.0
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        他の種類の Web アプリケーションの場合は、 <InlinePopover type="browser"/>[.NET エージェント API](/docs/agents/net-agent/net-agent-api/get-browser-timing-header)または[ブラウザ エージェントのコピー/ペースト メソッド](/docs/browser/new-relic-browser/installation/install-new-relic-browser-agent#copy-paste-app)を使用して、エージェントを削除します。
