...
<CollapserGroup>
  ...
  >
    .NET エージェントは、.NET Core 2.0、2.1、2.2、3.0、3.1、および .NET 5.0、6.0、7.0、および 8.0 をターゲットとするアプリケーションのみをサポートします。ターゲット フレームワークは、 `.csproj`ファイル内にあります。エージェントの互換性は、.NET Core のバージョンによって異なります。アプリケーションの対象バージョンの .NET Core にどのエージェントのバージョンを使用するかについては、ドキュメントの上記セクション**[「Microsoft .NET Core バージョン」](/docs/apm/agents/net-agent/getting-started/net-agent-compatibility-requirements-net-core/#net-version)**を参照してください。
...
<CollapserGroup>
  ...
  >
    ...
    * ASP.NET Core MVC 2.0、2.1、2.2、3.0、3.1、5.0、6.0、7.0、および 8.0 (Web API を含む)
    * ASP.NET Core Razor Pages 6.0、7.0、および 8.0 (.NET エージェント バージョン 10.19.0 以降)
  </Collapser>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            検証済みの互換性バージョン：2.3.0、2.8.1、2.13.1、2.14.1、2.17.1、2.19.0、2.20.0、2.21.0、2.22.0
        ...
        <tr>
          ...
          <td>
            ...
            * 検証済みの互換性バージョン：6.10.7、8.0.15、8.0.30、8.0.33、8.1.0、8.2.0

            **MySqlConnector**

            * サポートされている最小バージョン：1.0.1
            * 検証済みの互換性バージョン：1.0.1、1.3.13、2.1.2、2.3.1
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            ...
            検証済みの互換性バージョン：1.0.488、1.1.608、1.2.6、2.0.601、2.1.58、2.2.88、2.6.66、2.6.116、2.7.4
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            ...
            * 確認済みの互換性バージョン: 8.0.0、8.1.0、8.1.1、8.9.1、8.9.2、8.9.10、8.9.11、8.9.12
            * バージョン 8.9.10 以降は、.NET エージェント v10.20.1 以降でサポートされます。
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        その他の種類のウェブアプリケーションの場合は、[.NETエージェントAPI](/docs/agents/net-agent/net-agent-api/get-browser-timing-header)または[ブラウザエージェントのコピー/ペーストメソッド](/docs/browser/new-relic-browser/installation/install-new-relic-browser-agent#copy-paste-app)を使用して、ブラウザエージェントを挿入できます。
