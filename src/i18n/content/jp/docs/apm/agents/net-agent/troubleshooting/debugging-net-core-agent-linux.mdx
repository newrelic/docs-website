...
* 結果が得られない場合は、[環境変数](https://support.newrelic.com/s/hubtopic/aAX8W0000008a6F/relic-solution-net-core-agent-required-environment-variables)を設定し、アプリケーションを再起動して、ステップ1に戻ってください。
...
上記の手順で問題が解決しない場合は、サポートにお問い合わせいただくか、[サポートフォーラム](https://support.newrelic.com/s/)で質問することをお勧めします。