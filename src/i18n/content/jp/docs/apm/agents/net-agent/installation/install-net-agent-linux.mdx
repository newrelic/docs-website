...
2. お使いのパッケージマネージャーの指示に従ってください。
   ...
   <CollapserGroup>
     ...
     >
       1. `deb https://apt.newrelic.com/debian/ newrelic non-free` to `/etc/apt/sources.list.d/newrelic.list` を追加して New Relic の apt リポジトリを構成する。
     ...
     >
       1. **[download.newrelic.com/dot_net_agent/latest_release](https://download.newrelic.com/dot_net_agent/latest_release/)** にアクセスし、お使いの [アーキテクチャ](/docs/agents/net-agent/getting-started/compatibility-requirements-net-agent#architecture) と最新の `newrelic-netcore20-agent` .deb パッケージに対応する URL をコピーしてください。
     ...
     >
       ...
       1. [download.newrelic.com/dot_net_agent/latest_release](https://download.newrelic.com/dot_net_agent/latest_release/) にアクセスし、お使いの [アーキテクチャ](/docs/agents/net-agent/getting-started/compatibility-requirements-net-agent#architecture) と最新の `newrelic-netcore20-agent` .rpm パッケージに対応する URL をコピーしてください。
