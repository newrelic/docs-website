...
エラーデータをNew Relicに送信して、独自のコードで処理していることを伝えるには、RubyエージェントのAPI [`NewRelic::Agent.notice_error`](https://www.rubydoc.info/github/newrelic/newrelic-ruby-agent/NewRelic/Agent#notice_error-instance_method)呼び出しをエラーハンドラ内で使用します。
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        Rubyエージェントのバージョン`4.3.x`で非推奨となった[:trace_only](/docs/release-notes/agent-release-notes/ruby-release-notes/ruby-agent-430335)オプションを置き換えます。
      </td>
    </tr>
