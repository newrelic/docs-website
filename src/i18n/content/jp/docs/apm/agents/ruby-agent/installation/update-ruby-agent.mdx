...
1. New Relic の[ユーザー メニュー](/docs/accounts/accounts-billing/general-account-settings/intro-account-settings)から<DNT>**Account settings &gt; Connected agents**</DNT>を選択します。
2. オプション: <DNT>**Oldest agent version**</DNT>で並べ替えます。
