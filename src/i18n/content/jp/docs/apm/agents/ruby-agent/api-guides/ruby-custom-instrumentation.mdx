...
詳しくは、[New Relic RubyDocのtrace_execution_scoped](https://www.rubydoc.info/github/newrelic/newrelic-ruby-agent/NewRelic/Agent/MethodTracer#trace_execution_scoped-instance_method)を参照してください。