...
1. <InlinePopover type="licenseKey" />
   ...
   を含め、New Relic の標準的な手順に従って[gem をインストールし](/docs/agents/ruby-agent/installation/install-new-relic-ruby-agent#Installing_the_Gem)ます。
...
<CollapserGroup>
  ...
  >
    1. 標準的な手順に従って、<InlinePopover type="licenseKey" />を含め、New Relic の Ruby エージェントをインストールします。
