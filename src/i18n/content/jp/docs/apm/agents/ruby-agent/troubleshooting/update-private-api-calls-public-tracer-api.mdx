...
<CollapserGroup>
  ...
  >
    と置換する `NewRelic::Agent::Tracer.start_external_request_segment`
  </Collapser>
  ...
  >
    と置換する `NewRelic::Agent::Tracer.start_segment`
  </Collapser>
  ...
  >
    と置換する `NewRelic::Agent::Tracer.start_transaction_or_segment`
  </Collapser>
  ...
  >
    と置換する `NewRelic::Agent::Tracer.start_datastore_segment`
  </Collapser>
  ...
  >
    と置換する `NewRelic::Agent::Tracer.in_transaction`
  </Collapser>
  ...
  >
    と置換する `NewRelic::Agent::Tracer.current_transaction`
  </Collapser>
</CollapserGroup>