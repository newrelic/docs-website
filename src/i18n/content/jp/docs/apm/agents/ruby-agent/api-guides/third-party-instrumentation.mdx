...
<CollapserGroup>
  ...
  <Collapser id="perform_action_with_newrelic_trace" title="新生児のトレースを使ったアクションの実行">
    ...
    パラメータと使用法の詳細については [、perform\_action\_with\_newrelic\_trace の完全なドキュメントを](https://www.rubydoc.info/github/newrelic/newrelic-ruby-agent/NewRelic/Agent/Instrumentation/ControllerInstrumentation#perform_action_with_newrelic_trace-instance_method) 参照してください。
  </Collapser>
</CollapserGroup>
