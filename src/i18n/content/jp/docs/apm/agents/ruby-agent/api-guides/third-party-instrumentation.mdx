...
<CollapserGroup>
  ...
  >
    ...
    パラメータと使用法の詳細については [、perform_action_with_newrelic_trace の完全なドキュメントを](https://www.rubydoc.info/gems/newrelic_rpm/NewRelic/Agent/Instrumentation/ControllerInstrumentation#perform_action_with_newrelic_trace-instance_method) 参照してください。
  </Collapser>
</CollapserGroup>
