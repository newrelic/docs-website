...
<CollapserGroup>
  ...
  >
    ...
    4. New Relic gem を Gemfile に追加します。New Relic Ruby エージェントの gem は、 [rubygems.org](https://rubygems.org/ "リンクが新しいウィンドウで開きます。")から`newrelic_rpm`として入手できます。
  ...
  >
    ...
    3. New Relic gem を Gemfile に追加します。New Relic Ruby エージェントの gem は、 [rubygems.org](https://rubygems.org/ "リンクが新しいウィンドウで開きます。")から`newrelic_rpm`として入手できます。
