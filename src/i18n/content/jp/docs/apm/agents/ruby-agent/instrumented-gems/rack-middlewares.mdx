...
<CollapserGroup>
  ...
  >
    ...
    <figcaption>
      **APM > (選択したアプリケーション) > Monitor > Transactions > (選択したトランザクション) > Trace details:**アプリの選択したトランザクションのミドルウェア時間の例を次に示します。
    </figcaption>
  </Collapser>
  ...
  >
    ...
    <figcaption>
      **APM > (選択したアプリケーション) > Monitor > Transactions > (選択したトランザクション トレース):**トランザクション トレース内のミドルウェアの詳細の例を次に示します。
    </figcaption>
  </Collapser>
</CollapserGroup>
