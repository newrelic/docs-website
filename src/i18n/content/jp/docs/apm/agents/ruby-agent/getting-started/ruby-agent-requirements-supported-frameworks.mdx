...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [三部作](https://rubygems.org/gems/trilogy)
      </td>
...
現在サポートされている[インストゥルメントされた](/docs/agents/ruby-agent/features/message-queues)gem:

* Bunny: 2.0 以上 (バージョン 2.0.x - 2.6.x はエージェント バージョン 8.16.0 で最後にサポートされました)
* AWS SQS
* rdkafka
* ルビーカフカ
