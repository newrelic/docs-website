...
## Rubyバージョン [#ruby_versions][#ruby_versions]
...
## ウェブサーバー [#web_servers][#web_servers]
...
## ウェブフレームワーク [#web_frameworks][#web_frameworks]
...
## インスタンスの詳細 [#instance_details][#instance_details]
...
## バックグラウンドジョブ [#background_jobs][#background_jobs]
...
## HTTP/ネットワーククライアント [#http_network_clients][#http_network_clients]
...
## メッセージキューイング [#http_clients][#http_clients]
...
* <DNT>Acts_as_Solr</DNT>: エージェントバージョン 8.16.0 で最後にサポートされました
