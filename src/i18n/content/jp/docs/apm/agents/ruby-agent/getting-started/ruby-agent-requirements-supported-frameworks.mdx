...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Ruby 2.5.x、2.4.x:最後にエージェント v9.24.0 で完全にサポートされました。<br />Ruby 2.3.x、2.2.x:最終エージェント v8.16.0 で完全にサポートされます。<br />Ruby 2.1.x、2.0.x:エージェント v6.15.0 で完全にサポートされました。<br />Ruby 1.9.3: ラストエージェント v3.18.1。 <br />Ruby 1.8.7: ラストエージェント v3.18.1。
      </td>
    </tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Excon \{&apos;&lt;&apos;} 0.55.0：エージェント v8.16.0 で最後に完全にサポートされました。
      </td>
    </tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        APMログ転送のサポート。`rails_semantic_logger`とも互換性があります。
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        コンテキストは、フォークされた子プロセスから親プロセスへと正しく伝播されます。
      </td>
    </tr>
...
ここで取り上げられていない特定のバージョンやライブラリについて質問がある場合は、 [Explorers Hub コミュニティ フォーラムに](https://support.newrelic.com/)アクセスしてください。
