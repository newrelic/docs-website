...
<CollapserGroup>
  ...
  >
    ...
    2. 分散トレースペイロードを生成するためのエージェントAPI呼び出しを呼び出します（ [RubyエージェントAPI](/docs/agents/ruby-agent/api-guides/guide-using-ruby-agent-api#distributed)を参照）。
