...
* <DoNotTranslate>**`error_collector`**</DoNotTranslate>
...
<CollapserGroup>
  ...
  >
    ...
    <DoNotTranslate>**DEPRECATED**</DoNotTranslate> [「distributed_tracing.enabled」](#distributed_tracing-enabled)を参照してください。
