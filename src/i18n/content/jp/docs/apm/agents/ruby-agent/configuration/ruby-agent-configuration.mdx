...
<CollapserGroup>
  ...
  >
    ...
    [TransactionErrorイベントの最大数を定義する](/docs/insights/new-relic-insights/decorating-events/error-event-default-attributes-insights) 一回の収穫サイクルでInsightsに送られる。
  </Collapser>
</CollapserGroup>
...
<CollapserGroup>
  ...
  >
    ...
    `false` の場合、カスタム属性はInsightsイベントで送信されません。
  </Collapser>
</CollapserGroup>
...
<CollapserGroup>
  ...
  >
    ...
    `true` の場合、エージェントは [New Relic Insights のカスタムイベント](/docs/insights/new-relic-insights/adding-querying-data/inserting-custom-events-new-relic-apm-agents) をキャプチャします。
  </Collapser>
  ...
  >
    ...
    一度にメモリーにバッファリングするカスタムInsightsイベントの最大数を指定します。
  </Collapser>
</CollapserGroup>
