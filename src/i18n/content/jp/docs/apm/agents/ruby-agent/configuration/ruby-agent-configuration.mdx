...
<CollapserGroup>
  ...
  >
    ...
    <b>非推奨 次</b> を参照してください: [`instrumentation.bunny`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-bunny)。
  ...
  >
    ...
    <b>非推奨 次</b> を参照してください: [`instrumentation.curb`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-curb)。
  ...
  >
    ...
    <b>非推奨 次</b> を参照してください: [`instrumentation.memcache`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-memcache)。
  ...
  >
    ...
    <b>非推奨 次</b> を参照してください: [`instrumentation.delayed_job`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-delayed_job)。

    `true`の場合、 [`Delayed::Job`インストルメンテーション](/docs/agents/ruby-agent/background-jobs/delayedjob)を無効にします。
  </Collapser>
  ...
  >
    ...
    <b>非推奨 次</b> を参照してください: [`instrumentation.excon`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-excon)。
  ...
  >
    ...
    <b>非推奨 次</b> を参照してください: [`instrumentation.memcached`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-memcached)。
  ...
  >
    ...
    <b>非推奨 次</b> を参照してください: [`instrumentation.memcache-client`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-memcache-client)。
  ...
  >
    ...
    <b>非推奨 次</b> を参照してください: [`instrumentation.grape`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-grape)。
  ...
  >
    ...
    <b>非推奨 次</b> を参照してください: [`instrumentation.httpclient`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-httpclient)。
  ...
  >
    ...
    <b>非推奨 次</b> を参照してください: [`instrumentation.httprb`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-httprb)。
  ...
  >
    ...
    <b>非推奨 次</b> を参照してください: [`instrumentation.mongo`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-mongo)。
  ...
  >
    ...
    <b>非推奨 次</b> を参照してください: [`instrumentation.net_http`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-net_http)。
  ...
  >
    ...
    <b>非推奨 次</b> を参照してください: [`instrumentation.puma_rack`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-puma_rack)。

    `true`の場合、エージェントが`Puma::Rack::Builder`の`to_app`メソッドにフックして、アプリケーションの起動時に計測する gem を見つけることを防ぎます。
  </Collapser>
  ...
  >
    ...
    <b>非推奨 次</b> を参照してください: [`instrumentation.puma_rack_urlmap`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-puma_rack_urlmap)。

    `true`の場合、エージェントが`Puma::Rack::URLMap`にフックしてミドルウェア トレースをインストールするのを防ぎます。
  </Collapser>
  ...
  >
    ...
    <b>非推奨 次</b> を参照してください: [`instrumentation.rack`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-rack)。

    `true`の場合、エージェントが`Rack::Builder`の`to_app`メソッドにフックして、アプリケーションの起動時に計測する gem を見つけることを防ぎます。
  </Collapser>
  ...
  >
    ...
    <b>非推奨 次</b> を参照してください: [`instrumentation.rack_urlmap`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-rack_urlmap)。

    `true`の場合、エージェントが`Rack::URLMap`にフックしてミドルウェア トレースをインストールするのを防ぎます。
  </Collapser>
  ...
  >
    ...
    <b>非推奨 次</b> を参照してください: [`instrumentation.rake`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-rake)。
  ...
  >
    ...
    <b>非推奨 次</b> を参照してください: [`instrumentation.redis`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-redis)。
  ...
  >
    ...
    <b>非推奨 次</b> を参照してください: [`instrumentation.resque`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-resque)。
  ...
  >
    ...
    <b>非推奨 次</b> を参照してください: [`instrumentation.sinatra`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-sinatra)。

    `true`の場合、 [Sinatra インストルメンテーション](/docs/agents/ruby-agent/frameworks/sinatra-support)を無効にします。
  </Collapser>
  ...
  >
    ...
    <b>非推奨 次</b> を参照してください: [`instrumentation.typhoeus`](docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-typhoeus)。
