...
<CollapserGroup>
  ...
  >
    ...
    このエージェントから送信されるデータに適用される[ラベル名](/docs/data-analysis/user-interface-functions/labels-categories-organize-your-apps-servers)と値の辞書。コロンで区切られた`:`ペアのセミコロンで区切られた`;`文字列として表現することもできます。たとえば、 `<var>Server</var>:<var>One</var>;<var>Data Center</var>:<var>Primary</var>` 。
  </Collapser>
...
<CollapserGroup>
  ...
  >
    ...
    <b>非推奨</b>代わりに[`transaction_tracer.attributes.enabled`](#transaction_tracer-attributes-enabled)を使用してください。
  </Collapser>
...
<CollapserGroup>
  ...
  >
    ...
    <b>非推奨</b>代わりに[`error_collector.attributes.enabled`](#error_collector-attributes-enabled)を使用してください。
  </Collapser>
  ...
  >
    ...
    <b>非推奨</b>代わりに`error_collector.ignore_classes`を使用してください。エージェントが無視する必要のあるエラークラスのコンマ区切りリストを指定します。
  ...
  >
    ...
    `true`の場合、エージェントは[TransactionErrorイベント](/docs/insights/new-relic-insights/decorating-events/error-event-default-attributes-insights)を収集します。
  </Collapser>
...
<CollapserGroup>
  ...
  >
    ...
    <b>非推奨</b>代わりに[`browser_monitoring.attributes.enabled`](#browser_monitoring-attributes-enabled)を使用してください。
  </Collapser>
</CollapserGroup>
...
<CollapserGroup>
  ...
  >
    ...
    <b>非推奨</b>参照してください:[transaction_events.enabled](/docs/agents/ruby-agent/configuration/ruby-agent-configuration#transaction_events-enabled) 。

    `true`の場合、分析イベントのサンプリングを有効にします。
  </Collapser>
  ...
  >
    ...
    <b>非推奨</b>参照してください: [transaction_events.max_samples_stored](/docs/agents/ruby-agent/configuration/ruby-agent-configuration#transaction_events-max_samples_stored) 。
  ...
  >
    ...
    <b>非推奨</b>代わりに[`transaction_events.attributes.enabled`](#transaction_events-attributes-enabled)を使用してください。
  </Collapser>
</CollapserGroup>
...
<CollapserGroup>
  ...
  >
    ...
    `true`の場合、エージェントはトレースされたメソッドのソース コード レベルの指標を報告します。[New Relic CodeStream 統合](/docs/apm/agents/ruby-agent/features/ruby-codestream-integration/)を参照してください。
  </Collapser>
</CollapserGroup>
...
<CollapserGroup>
  ...
  >
    ...
    非<b>推奨</b>参照してください: [distributed_tracing-enabled](/docs/agents/ruby-agent/configuration/ruby-agent-configuration#distributed_tracing-enabled) 。
...
<CollapserGroup>
  ...
  >
    ...
    <b>非推奨</b>です: [instrumentation.rake](/docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-rake)を参照してください。

    `true`の場合、Rakeインストルメンテーションを無効にします。
  </Collapser>
  ...
  >
    ...
    <b>非推奨</b>です: [instrumentation.resque](/docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-resque)を参照してください。

    `true`の場合、 [Resqueインストルメンテーション](/docs/agents/ruby-agent/background-jobs/resque-instrumentation)を無効にします。
  </Collapser>
  ...
  >
    ...
    <b>非推奨</b>次を参照してください: [instrumentation.delayed_job](/docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-delayed_job) 。

    `true`の場合、 [Delayed::Jobインストルメンテーション](/docs/agents/ruby-agent/background-jobs/delayedjob)を無効にします。
  </Collapser>
  ...
  >
    ...
    <b>非推奨</b>です: [instrumentation.sinatra](/docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-sinatra)を参照してください。

    `true`の場合、 [Sinatraインストルメンテーション](/docs/agents/ruby-agent/frameworks/sinatra-support)を無効にします。
  </Collapser>
  ...
  >
    ...
    `true`の場合、アクティブなレコードインストルメンテーションを無効にします。
  </Collapser>
  ...
  >
    ...
    `true`の場合、DataMapperインストルメンテーションを無効にします。
  </Collapser>
  ...
  >
    ...
    `true`の場合、ActiveJobインストルメンテーションを無効にします。
  </Collapser>
  ...
  >
    ...
    `true`の場合、ActiveStorageインストルメンテーションを無効にします。
  </Collapser>
  ...
  >
    ...
    <b>非推奨</b>です: [instrumentation.memcached](/docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-memcached)を参照してください。

    `true`の場合、memcachedgemのインストルメンテーションを無効にします。
  </Collapser>
  ...
  >
    ...
    非<b>推奨</b>: [instrumentation.memcache-client](/docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-memcache-client)を参照してください。

    `true`の場合、memcache-clientgemのインストルメンテーションを無効にします。
  </Collapser>
  ...
  >
    ...
    <b>非推奨</b>です: [instrumentation.memcache](/docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-memcache)を参照してください。

    `true`の場合、ダリジェムのインストルメンテーションを無効にします。
  </Collapser>
  ...
  >
    ...
    `true`の場合、dalligemの追加のCASクライアントサポートのインストルメンテーションを無効にします。
  </Collapser>
  ...
  >
    ...
    `true`の場合、memcacheインストルメンテーションを無効にします。
  </Collapser>
  ...
  >
    ...
    `true`の場合、ガベージコレクションに費やされた時間を測定するためのGC::Profilerの使用を無効にします
  </Collapser>
  ...
  >
    ...
    <b>非推奨</b>代わりに[`disable_sequel_instrumentation`](#disable_sequel_instrumentation)を使用してください。
  </Collapser>
  ...
  >
    ...
    <b>非推奨</b>です: [instrumentation.mongo](/docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-mongo)を参照してください。

    `true`の場合、エージェントは[Mongogemのインストルメンテーションを](/docs/agents/ruby-agent/frameworks/mongo-instrumentation)インストールしません。
  </Collapser>
  ...
  >
    ...
    <b>非推奨</b>です: [instrumentation.redis](/docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-redis)を参照してください。

    `true`の場合、エージェントは[Redisのインストルメンテーションを](/docs/agents/ruby-agent/frameworks/redis-instrumentation)インストールしません。
  </Collapser>
  ...
  >
    ...
    `true`の場合、ActiveRecord 4、5、および6のインストルメンテーションを無効にします。
  </Collapser>
  ...
  >
    ...
    <b>非推奨</b>です: [instrumentation.bunny](/docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-bunny)を参照してください。

    `true`の場合、バニージェムのインストルメンテーションを無効にします。
  </Collapser>
  ...
  >
    ...
    <b>非推奨</b>です: [instrumentation.curb](/docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-curb)を参照してください。

    `true`の場合、縁石の宝石の計装を無効にします。
  </Collapser>
  ...
  >
    ...
    <b>非推奨</b>です: [instrumentation.excon](/docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-excon)を参照してください。

    `true`の場合、excongemのインストルメンテーションを無効にします。
  </Collapser>
  ...
  >
    ...
    <b>非推奨</b>です:[instrumentation.httpclient](/docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-httpclient)を参照してください。

    `true`の場合、httpclientgemのインストルメンテーションを無効にします。
  </Collapser>
  ...
  >
    ...
    <b>非推奨</b>です: [instrumentation.net_http](/docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-net_http)を参照してください。

    `true`の場合、Net::HTTPのインストルメンテーションを無効にします。
  </Collapser>
  ...
  >
    ...
    <b>非推奨</b>です: [instrumentation.rack](/docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-rack)を参照してください。

    `true`の場合、エージェントがRack :: Builderの`to_app`メソッドにフックして、アプリケーションの起動時にインストルメントするgemを見つけるのを防ぎます。
  </Collapser>
  ...
  >
    ...
    <b>非推奨</b>次を参照してください: [instrumentation.rack_urlmap](/docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-rack_urlmap) 。

    `true`の場合、エージェントがRack::URLMapにフックしてミドルウェアトレースをインストールするのを防ぎます。
  </Collapser>
  ...
  >
    ...
    <b>非推奨</b>: [instrumentation.puma_rack](/docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-puma_rack)を参照してください。

    `true`の場合、エージェントがPuma :: Rack :: Builderの`to_app`メソッドにフックして、アプリケーションの起動中にインストルメントするgemを見つけるのを防ぎます。
  </Collapser>
  ...
  >
    ...
    <b>非推奨</b>: [instrumentation.puma_rack_urlmap](/docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-puma_rack_urlmap)を参照してください。

    `true`の場合、エージェントがPuma :: Rack::URLMapにフックしてミドルウェアトレースをインストールするのを防ぎます。
  </Collapser>
  ...
  >
    ...
    <b>非推奨</b>です: [instrumentation.typhoeus](/docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-typhoeus)を参照してください。

    `true`の場合、エージェントはtyphoeusgemのインスツルメンテーションをインストールしません。
  </Collapser>
  ...
  >
    ...
    <b>非推奨</b>です: [instrumentation.httprb](/docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-httprb)を参照してください。

    `true`の場合、エージェントはhttp.rbgemのインストルメンテーションをインストールしません。
  </Collapser>
  ...
  >
    ...
    `true`の場合、エージェントはサードパーティのミドルウェアをインストルメンテーションでラップしません（Rack :: BuilderまたはRailsのどちらを介してインストールされているかに関係なく）。
  </Collapser>
  ...
  >
    ...
    <b>非推奨</b>です: [instrumentation.grape](/docs/agents/ruby-agent/configuration/ruby-agent-configuration#instrumentation-grape)を参照してください。

    `true`の場合、エージェントはGrapeインストルメンテーションをインストールしません。
  </Collapser>
</CollapserGroup>
...
<CollapserGroup>
  ...
  >
    ...
    分散トレースを使用すると、リクエストが分散システムを通過するパスを確認できます。Rubyエージェント8.0.0以降ではデフォルトでオンになっています。

    詳細について[は、Rubyサービスの分散トレースを参照してください](/docs/apm/agents/ruby-agent/configuration/distributed-tracing-ruby-agent)。
  </Collapser>
</CollapserGroup>
...
<CollapserGroup>
  ...
  >
    ...
    起動時の Net::HTTP の自動計測を制御します。`auto` 、 `prepend` 、 `chain` 、または`disabled`のいずれかです。
  </Collapser>
  ...
  >
    ...
    起動時の Typhoeus の自動計測を制御します。`auto` 、 `prepend` 、 `chain` 、または`disabled`のいずれかです。
  </Collapser>
  ...
  >
    ...
    起動時のバニーの自動計測を制御します。`auto` 、 `prepend` 、 `chain` 、または`disabled`のいずれかです。
  </Collapser>
  ...
  >
    ...
    起動時の http.rb gem の自動計測を制御します。`auto` 、 `prepend` 、 `chain` 、または`disabled`のいずれかです。
  </Collapser>
  ...
  >
    ...
    起動時の resque の自動計測を制御します。`auto` 、 `prepend` 、 `chain` 、または`disabled`のいずれかです。
  </Collapser>
  ...
  >
    ...
    起動時の Thread クラスの自動計測を制御して、エージェントが非同期トランザクション内でスパンを正しくネストできるようにします。これにより、作成されたすべてのスレッドをエージェントが自動的にトレースできるようになりません ( `instrumentation.thread.tracing`を参照)。`auto` 、 `prepend` 、 `chain` 、または`disabled`のいずれかです。
  </Collapser>
  ...
  >
    ...
    起動時の Redis の自動計測を制御します。`auto` 、 `prepend` 、 `chain` 、または`disabled`のいずれかです。
  </Collapser>
  ...
  >
    ...
    起動時のレーキの自動計測を制御します。`auto` 、 `prepend` 、 `chain` 、または`disabled`のいずれかです。
  </Collapser>
  ...
  >
    ...
    起動時の遅延ジョブの自動計測を制御します。`auto` 、 `prepend` 、 `chain` 、または`disabled`のいずれかです。
  </Collapser>
  ...
  >
    ...
    起動時の HTTPClient の自動計測を制御します。`auto` 、 `prepend` 、 `chain` 、または`disabled`のいずれかです。
  </Collapser>
  ...
  >
    ...
    起動時の Curb の自動計測を制御します。`auto` 、 `prepend` 、 `chain` 、または`disabled`のいずれかです。
  </Collapser>
  ...
  >
    ...
    起動時に Sinatra の自動計測を制御します。`auto` 、 `prepend` 、 `chain` 、または`disabled`のいずれかです。
  </Collapser>
  ...
  >
    ...
    Rack の自動計測を制御します。有効にすると、エージェントは Rack::Builder の`to_app`メソッドにフックして、アプリケーションの起動時に計測する gem を見つけます。`auto` 、 `prepend` 、 `chain` 、または`disabled`のいずれかです。
  </Collapser>
  ...
  >
    ...
    起動時の Rack::URLMap の自動計測を制御します。`auto` 、 `prepend` 、 `chain` 、または`disabled`のいずれかです。
  </Collapser>
  ...
  >
    ...
    Puma::Rack の自動計測を制御します。有効にすると、エージェントは Puma::Rack::Builder の`to_app`メソッドにフックして、アプリケーションの起動時に計測する gem を見つけます。`auto` 、 `prepend` 、 `chain` 、または`disabled`のいずれかです。
  </Collapser>
  ...
  >
    ...
    起動時の Puma::Rack::URLMap の自動計測を制御します。`auto` 、 `prepend` 、 `chain` 、または`disabled`のいずれかです。
  </Collapser>
  ...
  >
    ...
    起動時の Memcache の memcached gem の自動計測を制御します。`auto` 、 `prepend` 、 `chain` 、または`disabled`のいずれかです。
  </Collapser>
  ...
  >
    ...
    起動時の Memcache の memcache-client gem の自動計測を制御します。`auto` 、 `prepend` 、 `chain` 、または`disabled`のいずれかです。
  </Collapser>
  ...
  >
    ...
    起動時の Memcache の dalli gem の自動計測を制御します。`auto` 、 `prepend` 、 `chain` 、または`disabled`のいずれかです。
  </Collapser>
  ...
  >
    ...
    起動時の Ruby 標準ライブラリ Logger の自動計測を制御します。`auto` 、 `prepend` 、 `chain` 、または`disabled`のいずれかです。
  </Collapser>
  ...
  >
    ...
    起動時の Tilt テンプレート レンダリング ライブラリの自動計測を制御します。`auto` 、 `prepend` 、 `chain` 、または`disabled`のいずれかです。
  </Collapser>
  ...
  >
    ...
    起動時の gRPC クライアントの自動計測を制御します。`auto` 、 `prepend` 、 `chain` 、または`disabled`のいずれかです。
  </Collapser>
  ...
  >
    ...
    New Relic が無視する gRPC ホスト名に一致するコンマで区切られたホスト名パターンのリストを指定します。New Relic の gRPC クライアント インストルメンテーションは、これらのパターンのいずれかに一致するホストにストリーミングされたトラフィックを無視し、New Relic の gRPC サーバー インストルメンテーションは、ホスト名がこれらのパターンのいずれかに一致するホスト上で実行されているサーバーのトラフィックを無視します。デフォルトでは、 `private.com$,exception.*`のように gRPC インストルメンテーション自体が有効になっている場合、トラフィックは無視されません。
  </Collapser>
  ...
  >
    ...
    起動時の gRPC サーバーの自動計測を制御します。`auto` 、 `prepend` 、 `chain` 、または`disabled`のいずれかです。
  </Collapser>
  ...
  >
    ...
    起動時の ActiveSupport::Logger の自動計測を制御します。`auto` 、 `prepend` 、 `chain` 、または`disabled`のいずれかです。
  </Collapser>
  ...
  >
    ...
    起動時の Grape の自動計測を制御します。`auto` 、 `prepend` 、 `chain` 、または`disabled`のいずれかです。
  </Collapser>
</CollapserGroup>
...
<CollapserGroup>
  ...
  >
    ...
    <b>非推奨</b>`true`の場合、Resqueでトランザクショントレースおよびトレースされたエラーのジョブ引数のキャプチャを有効にします。
  </Collapser>
</CollapserGroup>
...
<CollapserGroup>
  ...
  >
    ...
    非推奨`true`の場合、 <b>Sidekiq</b>でトランザクショントレースおよびトレースされたエラーのジョブ引数のキャプチャを有効にします。
  </Collapser>
</CollapserGroup>
...
<CollapserGroup>
  ...
  >
    ...
    遅いSQLクエリの難読化レベルを定義します。有効なオプションは、 `obfuscated` 、 `raw` 、または`none`です）。
  </Collapser>
