  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * <DNT>**v7:**</DNT> アプリケーションは API メソッド[`transactionHandle.ignore()`](/docs/agents/nodejs-agent/api-guides/nodejs-agent-api/#transaction-handle-ignore)を使用する必要があります。
      </td>
    </tr>
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        * <DNT>**v5:**</DNT> アプリケーションは API メソッド[`newrelic.addCustomAttribute()`](/docs/agents/nodejs-agent/api-guides/nodejs-agent-api#add-custom-attribute)と[`newrelic.addCustomAttributes()`](/docs/agents/nodejs-agent/api-guides/nodejs-agent-api#add-custom-attributes)を使用する必要があります。 これらは古い方法の代替品です。
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        * <DNT>**v5:**</DNT> アプリケーションは API メソッド[`newrelic.startWebTransaction()`](/docs/agents/nodejs-agent/api-guides/nodejs-agent-api#startWebTransaction)および[`newrelic.startBackgroundTransaction()`](/docs/agents/nodejs-agent/api-guides/nodejs-agent-api#startBackgroundTransaction)に更新する必要があります。
    ...
    <tr>
      ...
      <td>
        ...
        * <DNT>**v5:**</DNT> アプリケーションを[`newrelic.startSegment()`](/docs/agents/nodejs-agent/api-guides/nodejs-agent-api#startSegment)に更新する必要があります。
      </td>
    </tr>
