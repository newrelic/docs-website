...
<Callout variant="tip">
  アプリケーションはKubernetesクラスタ上で実行されていますか? [Kubernetesエージェント オペレーター](/docs/kubernetes-pixie/kubernetes-integration/installation/k8s-agent-operator/)を使用して、インストレーション メソッドを試してください。
</Callout>
