...
<CollapserGroup>
  <Collapser className="freq-link" id="config_file" title="エージェント設定ファイル">
  ...
  <Collapser className="freq-link" id="environment" title="環境変数">
  ...
  <Collapser className="freq-link" id="server-side" title="サーバーサイドコンフィグレーション">
...
<CollapserGroup>
  ...
  <Collapser id="license" title="license_key（必須）">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser id="apdex" title="apdex_t（非推奨）">
    <table>
      <tbody>
        <tr>
          <th>
...
## 変数のロギング [#logging\_config][#logging_config]
...
<CollapserGroup>
  ...
  <Collapser id="log" title="filepath">
    ...
    * すべてのロギングを<DNT>**stdout**</DNT>に書き込むには、これを`stdout`に設定します。
    * すべてのロギングを<DNT>**stderr**</DNT>に書き込むには、これを`stderr`に設定します。
  </Collapser>
</CollapserGroup>
...
<CollapserGroup>
  ...
  <Collapser id="endpoints" title="endpoints">
    <table>
      <tbody>
        <tr>
          <th>
...
<CollapserGroup>
  ...
  <Collapser id="notice-error" title="notice_error_enabled">
    ...
    このオプションで、[`newrelic.noticeError`](https://newrelic.github.io/node-newrelic/API.html#noticeError)が有効になります。
  </Collapser>
</CollapserGroup>
...
## エラーコレクター変数 [#error\_config][#error_config]
...
<CollapserGroup>
  ...
  <Collapser id="error_ignore" title="ignore_status_codes">
    ...
    <Callout variant="caution">
      [`newrelic.noticeError()`](https://newrelic.github.io/node-newrelic/API.html#noticeError)を使用して記録されたエラーは、この設定値に従いません。
    </Callout>
  </Collapser>
...
## トランザクショントレーサーの変数 [#tx\_tracer\_config][#tx_tracer_config]
...
## ルールの変数 [#rules\_config][#rules_config]
...
## トランザクションイベントの変数 [#tx\_events][#tx_events]
...
<CollapserGroup>
  ...
  <Collapser id="tx_events_max_samples_stored_legacy" title="max_samples_stored(廃止予定)">
    <table>
      <tbody>
        <tr>
          <th>
  ...
  <Collapser id="tx_events_max_samples_per_minute" title="max_samples_per_minute (廃止予定)">
    <table>
      <tbody>
        <tr>
          <th>
...
<CollapserGroup>
  ...
  <Collapser id="browser-debug" title="デバッグ">
    <table>
      <tbody>
        <tr>
          <th>
...
## カスタムイベント変数 [#custom\_events][#custom_events]
...
<CollapserGroup>
  <Collapser id="allow-raw-enabled" title="enabled">
    ...
    `true`である場合、エージェントはキャプチャーしたエラーメッセージを編集します。
  </Collapser>
</CollapserGroup>
...
## gRPCサーバーインストゥルメンテーション [#grpc\_server][#grpc_server]
...
<CollapserGroup>
  ...
  <Collapser id="object" title="オブジェクト">
