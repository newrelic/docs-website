    ...
    <tr>
      ...
      <td>
        ...
        <Callout variant="important">
          クロスアプリケーション トレーシングは[ディストリビューティッド（分散）](/docs/enable-distributed-tracing)トレーシングに代わって非推奨となり、将来のエージェント バージョンでは削除される予定です。
        </Callout>
      </td>
    </tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [カスタムメトリック](/docs/agents/manage-apm-agents/agent-data/custom-metrics)を作成します。 [`newrelic.recordMetric()`](/docs/agents/nodejs-agent/supported-features/nodejs-agent-api#record_metric)と[`newrelic.incrementMetric()`](/docs/agents/nodejs-agent/supported-features/nodejs-agent-api#increment_metric)を参照してください。 データを表示するには、 [<DoNotTranslate>**metrics and events**</DoNotTranslate>](/docs/query-your-data/explore-query-data/data-explorer/introduction-data-explorer)を使用します。
      </td>
    </tr>
  </tbody>
</table>
