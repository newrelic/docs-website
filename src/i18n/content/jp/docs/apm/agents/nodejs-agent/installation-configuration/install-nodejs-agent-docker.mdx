...
5. エージェントを有効にして Docker アプリを実行するには、 [ライセンス キー](/docs/apis/intro-apis/new-relic-api-keys/#license-key) と [アプリ名を](/docs/agents/manage-apm-agents/app-naming/name-your-application) `docker run`コマンドに環境変数として追加します。
