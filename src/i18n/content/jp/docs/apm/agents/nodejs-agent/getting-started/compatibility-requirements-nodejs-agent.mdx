...
| `@aws-sdk/client-bedrock-runtime` | 3.474.0          | 3.930.0   | 11.13.0                                |
| `@aws-sdk/client-dynamodb`        | 3.0.0            | 3.930.0   | 8.7.1                                  |
| `@aws-sdk/client-sns`             | 3.0.0            | 3.930.0   | 8.7.1                                  |
| `@aws-sdk/client-sqs`             | 3.0.0            | 3.930.0   | 8.7.1                                  |
| `@aws-sdk/lib-dynamodb`           | 3.377.0          | 3.930.0   | 8.7.1                                  |
| `@aws-sdk/smithy-client`          | 3.47.0           | 3.374.0   | 8.7.1                                  |
| `@azure/functions`                | 4.7.0            | 4.9.0     | 12.18.0                                |
| `@elastic/elasticsearch`          | 7.16.0           | 9.2.0     | 11.9.0                                 |
| `@google/genai`                   | 1.1.0            | 1.29.1    | 12.21.0                                |
...
| `@smithy/smithy-client`           | 2.0.0            | 4.9.6     | 11.0.0                                 |
