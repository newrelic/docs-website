    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            2026年7月7日（Node.jsエージェントv14.2.0）
          </td>
        </tr>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            2026年5月18日をもって、Node.jsエージェントv14でのNode.js 20のサポートは終了しました。
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            2025年7月23日の時点で、Node.jsエージェントのv13を含むNode.js 18のサポートは終了しました。
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            2021年7月26日現在で、Node.jsエージェントのv8を使用したNode.js 10のサポートを終了しました。この移行の簡単な準備方法などの詳細については、[サポートフォーラムの投稿](https://support.newrelic.com/s/hubtopic/aAX8W0000008bz0/important-upcoming-changes-to-support-and-capabilities-across-browser-nodejs)を参照してください。
          </td>
        </tr>
      </tbody>
    </table>
...
`@google/adk`モジュールを通じて以下の機能をサポートします。
...
| LangGraph経由のエージェント | Chains | ツール | Vectorstores |
| ------------------ | ------ | --- | ------------ |
| ✅                  | ✅      | ✅   | ✅            |
...
`@modelcontextprotocol/sdk`モジュールを通じて以下をサポートします。

| プロンプトの取得 | リソースの読み取り | ツールのコール |
| -------- | --------- | ------- |
| ✅        | ✅         | ✅       |

MCPはプロバイダーに依存しません。MCPツールを使用するすべてのLLMプロバイダーは間接的にサポートされます。
...
`@anthropic-ai/sdk`モジュールを通じて以下をサポートします。
...
## ハイブリッドエージェントインストゥルメンテーション

一部の計装は、[ハイブリッドエージェント](/docs/apm/agents/manage-apm-agents/opentelemetry-api-support)機能を通じて利用できます。

### Next.js v16+

エージェント[バージョン14.1.0](/docs/release-notes/agent-release-notes/nodejs-release-notes/node-agent-14-1-0)以降、Next.jsフレームワークのサポートは、Next.jsに標準搭載されているOpenTelemetry計装を基盤としています。エージェントの設定方法については、[Next.jsアプリケーションのサンプル](https://github.com/newrelic/newrelic-node-examples/tree/734e1e0be7302210bfb3a113ad93ad5eeb0e0fa8/nextjs/nextjs-app-router)をご確認ください。

### Prisma 7

Prismaでは、[@prisma/instrumentation](https://www.npmjs.com/package/@prisma/instrumentation)パッケージを通じて、OpenTelemetryの直接計装に対応しています。Prismaバージョン7およびエージェント[バージョン14.1.0](/docs/release-notes/agent-release-notes/nodejs-release-notes/node-agent-14-1-0)以降、このネイティブ計装を利用することで、Prismaの処理を詳しく把握できます。New RelicエージェントでPrismaを利用する方法については、[Prismaアプリケーションのサンプル](https://github.com/newrelic/newrelic-node-examples/tree/734e1e0be7302210bfb3a113ad93ad5eeb0e0fa8/prisma/prisma-7-js)をご確認ください。
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Node.jsエージェントのバージョン11.13.0を使用している場合は、特定のAIライブラリおよびフレームワークからAIデータを収集できます。現在の互換性リストについては、上記の[AI 監視サポート](#ai-monitoring-support)を参照してください。
      </td>
    </tr>
