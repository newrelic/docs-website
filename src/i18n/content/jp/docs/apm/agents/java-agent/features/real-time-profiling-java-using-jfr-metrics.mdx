...
<img
  title="ニューレリック・オン・ジャワ・フライト・レコルト・アイ"
  alt="New Relic One Java Flight Recorder (JFR) UI"
...
<img
  title="new-relicone-java-flight-recorder-details-ui.jpg"
  alt="New Relic One Java Flight Recorder 詳細ページ UI"
...
<img title="New Relic Java flame graphのスクリーンショット" alt="New Relic Java flame graphのスクリーンショット。" src={jfrFlamegraphs}/> <figcaption>**[one.newrelic.com](one.newrelic.com/) > Explorer> (select service)> Realtime Profiling Java> (select JVM)** ：炎のグラフなど、各JVMの詳細を見ることができます。</figcaption>
