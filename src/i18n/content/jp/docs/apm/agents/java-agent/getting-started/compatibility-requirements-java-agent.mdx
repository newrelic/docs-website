...
<CollapserGroup>
  ...
  >
    ...
    * [Kafka Clients](/docs/agents/java-agent/instrumentation/java-agent-instrument-kafka-message-queues) 0.10.0.0以降（メトリックおよびイベントデータ向け）

    * [Kafka Clients](/docs/agents/java-agent/instrumentation/java-agent-instrument-kafka-message-queues) 0.11.0.0以降（ディストリビューティッド（分散）トレーシングおよびイベントデータ向け）
  ...
  >
    ...
    * Jedis Redisドライバ1.4.0～2.10.x、3.0.0～4.x
  ...
  >
    ...
    * Jedis Redisドライバ1.4～2.10.x、3.0.0～4.x
