...
<CollapserGroup>
  ...
  >
    ...
    * Linux、Windows、macOS用OpenJDKバージョン8～20

    * Linux、Windows、macOS用AdoptOpenJDKバージョン8～16

    * Linux、Windows、macOS用Temurinバージョン17～20

    * Linux、Solaris、Windows、およびmacOS用Oracle Hotspot JVMバージョン8～20

    * Linux、Windows、macOS 用の Azul Zulu JVM バージョン8と11

    * Linux、Windows、macOS用のAzul Zulu JVMバージョン8～20

    * Linux、Windows、macOS用のAmazon Corretto JVMバージョン8、11、17～20
...
<CollapserGroup>
  ...
  >
    ...
    * [Kafka Streams](/docs/agents/java-agent/instrumentation/use-kafka-message-queues) 1.0.0以降（メトリクス用）

    * [Kafka Streams](/docs/agents/java-agent/instrumentation/use-kafka-message-queues) 2.0.0以降（ディストリビューティッド（分散）トレーシングおよびトランザクションデータ用）
