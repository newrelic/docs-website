...
<table>
  ...
  </tbody>](https://github.com/newrelic/newrelic-java-agent-ansible-role/tree/master/examples)
</table>

## [Step 4.エージェントの設定 [#agent-configuration]](https://github.com/newrelic/newrelic-java-agent-ansible-role/tree/master/examples)

[以下の変数は、Javaエージェント自体の設定に使用されます。これらは、利用可能なオプションのほんの一部です。サポートされる変数の全リストについては、GitHubの ](https://github.com/newrelic/newrelic-java-agent-ansible-role/tree/master/examples)[READMEファイルを参照してください](https://github.com/newrelic/newrelic-java-agent-ansible-role#agent-configuration-variables) 。エージェントの設定方法の詳細については、 [Javaエージェントの設定](/docs/agents/java-agent/configuration/java-agent-configuration-config-file) を参照してください。
