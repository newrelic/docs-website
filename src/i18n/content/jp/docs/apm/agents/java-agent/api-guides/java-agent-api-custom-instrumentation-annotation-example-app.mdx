...
<CollapserGroup>
  <Collapser id="complete-api-example" title="完全なAPIコールの例">
    ```java
...
<CollapserGroup>
  <Collapser className="freq-link" id="import-packages" title="必要なパッケージのインポート">
  ...
  <Collapser className="freq-link" id="set-annotation" title="トランザクション・トレースのための@Traceの設定">
  ...
  <Collapser className="freq-link" id="name-transactions" title="Webトランザクションのカスタム名の作成">
  ...
  <Collapser className="freq-link" id="ignore-apdex" title="非公開データの収集時にApdexをバイパスする">
  ...
  <Collapser className="freq-link" id="record-user-id" title="ユーザーIDの記録">
  ...
  <Collapser className="freq-link" id="get-custom-metric" title="プロモーションデータの収集">
  ...
  <Collapser className="freq-link" id="control-handler" title="ハンドラーへの指示を出す">
  ...
  <Collapser className="freq-link" id="include-browser" title="HTTPレスポンスにページロードタイミングコードを含める">
  ...
  <Collapser className="freq-link" id="complete-response" title="HTTPレスポンスの完成">
