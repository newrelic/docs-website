...
<img title="Micrometer bridged with OpenTelemetry in New Relic" alt="A screenshot of the Micrometer summary page when instrumented with OpenTelemetry" src={opentelemetryMicrometerWithOtel} />
