...
2. 返されたそれぞれの集計について、<DoNotTranslate>**Alerts> [Alerts Conditions](https://one.newrelic.com/alerts-ai/condition-builder/condition-list)**</DoNotTranslate> UIで ID または名前を使用して集計を見つけることができます。
