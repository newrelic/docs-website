...
APM エージェント全体で一貫性を確保し、業界標準との整合性を高めるために、Java エージェントの場所とスパンのプロパティを変更しました。 Javaエージェント バージョン 7.6.0 以降、 新しい標準属性<DoNotTranslate>**http.statusCode**</DoNotTranslate>と<DoNotTranslate>**http.statusText**</DoNotTranslate>を導入し、 <DoNotTranslate>**httpResponseCode**</DoNotTranslate> 、 <DoNotTranslate>**response.status**</DoNotTranslate> 、および<DoNotTranslate>**response.statusMessage**</DoNotTranslate>を非推奨としてマークしました。
...
2. 返されたそれぞれの集計について、<DoNotTranslate>**Alerts & AI > [Alerts Conditions](https://one.newrelic.com/alerts-ai/condition-builder/condition-list)**</DoNotTranslate> UIで ID または名前を使用して集計を見つけることができます。
...
<DoNotTranslate>**http.statusCode**</DoNotTranslate> これも異なるデータ型を持つ<DoNotTranslate>**httpResponseCode**</DoNotTranslate>または<DoNotTranslate>**response.status**</DoNotTranslate>への参照を置き換えます。 以前は次のような参照を使用していました:
...
<DoNotTranslate>**http.statusText**</DoNotTranslate> は、 <DoNotTranslate>**response.statusMessage**</DoNotTranslate>への参照を置き換えます。 この属性のデータ型は変更されていません。
