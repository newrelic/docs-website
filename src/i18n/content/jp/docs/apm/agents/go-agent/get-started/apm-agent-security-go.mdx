...
* [* エージェントはデータベース セグメントから`QueryParameters`を削除します。](https://github.com/newrelic/go-agent/blob/master/GUIDE.md#error-reporting)

## [カスタムセキュリティ設定 [#custom]](https://github.com/newrelic/go-agent/blob/master/GUIDE.md#error-reporting)

<Callout variant="caution">
  [セキュリティ設定をカスタマイズすると、アプリケーションのセキュリティに影響を与える可能性があります。](https://github.com/newrelic/go-agent/blob/master/GUIDE.md#error-reporting)
</Callout>

[デフォルトまたは高セキュリティ モードとは異なるセキュリティ設定が必要な場合は、これらの設定をカスタマイズできます。](https://github.com/newrelic/go-agent/blob/master/GUIDE.md#error-reporting)
...
<table>
  ...
  </tbody>](https://github.com/newrelic/go-agent/blob/master/GUIDE.md#error-reporting)
</table>