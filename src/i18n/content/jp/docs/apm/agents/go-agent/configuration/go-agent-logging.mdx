...
New Relic では、Logrus ロギングシステムの [インテグレーションを提供しています。ここでは、アプリケーションでNew Relic Logrusインテグレーションを使用する例を紹介します。](https://github.com/newrelic/go-agent/blob/master/_integrations/nrlogrus/nrlogrus.go)
