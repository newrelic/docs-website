...
これを実装するには、最初に[newrelic_end_transaction（）](https://docs.newrelic.com/docs/apm/agents/php-agent/php-agent-api/newrelic_end_transaction/)を使用した最初の自動トランザクションを無視し、次に[newrelic_start_transaction（）](https://docs.newrelic.com/docs/apm/agents/php-agent/php-agent-api/newrelic_start_transaction/)と[newrelic_end_transaction（）](https://docs.newrelic.com/docs/apm/agents/php-agent/php-agent-api/newrelic_end_transaction/)を使用して各トランザクションを順番にインストルメントします。
