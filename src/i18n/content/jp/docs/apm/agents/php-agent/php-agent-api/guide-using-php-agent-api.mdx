...
* New Relic UI ページ (たとえば、APM の[<DNT>**Applications index**</DNT>ページ](/docs/apm/applications-menu/monitoring/view-your-applications-index)、 [<DNT>**Summary**</DNT>ページ](/docs/apm/applications-menu/monitoring/apm-overview-page)、 [<DNT>**Transactions**</DNT>ページ](/docs/apm/applications-menu/monitoring/transactions-page)など) でデータを整理および分析します。
* データを[クエリ](/docs/insights/nrql-new-relic-query-language/using-nrql/introduction-nrql)します。
* [アラートポリシー](/docs/alerts/overview)を作成します。
