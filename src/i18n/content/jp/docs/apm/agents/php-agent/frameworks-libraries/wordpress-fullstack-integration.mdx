...
<Steps>
  ...
  <Step>
    ...
    3. <DNT>**Install now**</DNT>をクリックして PHP エージェントのインストレーションを開始します。
  </Step>
  ...
  <Step>
    ...
    3. <DNT>**Install now**</DNT> をクリックしてMySQLエージェントのインストレーションを開始します。
  </Step>
  ...
  <Step>
    ...
    3. <DNT>**Install now**</DNT>をクリックして Apache エージェント インストレーションを開始します。
  </Step>
