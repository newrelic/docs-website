...
5. モジュール リストに`newrelic`が表示されている場合は、 `license.key`エントリに[ライセンス キーの最初と最後の数文字が表示されていることを確認してください。](/docs/apis/intro-apis/new-relic-api-keys/#ingest-license-key#finding)
