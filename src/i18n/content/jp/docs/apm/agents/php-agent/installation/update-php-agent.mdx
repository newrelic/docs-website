...
* x86_64 上の RedHat と CentOS
* x86_64 上の Ubuntu と Debian

<DNT>**tar archive**</DNT>経由で更新するには、 [tar アーカイブ インストレーション 手順](/docs/agents/php-agent/installation/php-agent-installation-tar-file)に従ってください。 (tar アーカイブを使用したインストールおよびアップデートの手順は同じです。)

## 使用 `newrelic-php5` [#newrelic-php5]
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        デーモンを手動で起動する顧客の場合は、 `-h`または`--help`フラグが付いた<DNT>**newly renamed command line flags**</DNT>を見つけることができます。 将来のリリースにおける<DNT>**following old flags will be removed**</DNT> :
