...
- [SQL](/docs/agents/php-agent/configuration/php-agent-configuration#inivar-tt-sql): エージェントは、SQL 記録を `難読化` に設定し、潜在的にセンシティブな数値や文字列リテラル値を削除します。
...
- [PHP エージェント設定ファイル](/docs/agents/php-agent/configuration/php-agent-configuration)
- [属性の設定](/docs/agents/php-agent/configuration/php-agent-configuration#inivar-attribute-settings)
- [PHP エージェント API](/docs/agents/php-agent/api-guides/php-agent-api-guide)
