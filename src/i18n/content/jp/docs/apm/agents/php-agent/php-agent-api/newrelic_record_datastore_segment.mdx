...
データストア セグメントを記録します。 データストア セグメントは、New Relic UI の[トランザクション ページ](/docs/apm/applications-menu/monitoring/transactions-page)の<DNT>**Breakdown table**</DNT>タブと<DNT>**Databases**</DNT>タブに表示されます。
