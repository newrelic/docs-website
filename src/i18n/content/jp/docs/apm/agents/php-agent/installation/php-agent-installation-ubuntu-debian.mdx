  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        インストレーション プロセスは、アプリケーション名とライセンスキーを要求します。 <InlinePopover type="licenseKey"/>は<DoNotTranslate>**Account settings**</DoNotTranslate>のアカウント情報セクションに表示されます。 ヘッドレス インストレーションの場合、 [`debconf`を使用してライセンスキーとアプリケーション名を事前にシードする](#preseeding)こともできます。
      </td>
    </tr>
