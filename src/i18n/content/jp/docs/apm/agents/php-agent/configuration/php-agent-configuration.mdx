...
<img title="php-config-order.png" alt="php-config-order.png" src={apmPhpAgentConfigurationHierarchy} />
...
<table>
  <thead>
    <tr>
      <th width={100}>
        <DNT>**Variable type**</DNT>
      </th>

      <th>
        <DNT>**Formatting and contents**</DNT>
      </th>
    </tr>
  </thead>
...
<CollapserGroup>
  ...
  <Collapser id="inivar-wt-funcs" title="newrelic.webtransaction.name.functions">
    ...
    <DNT>**Example dispatch function naming**</DNT>
