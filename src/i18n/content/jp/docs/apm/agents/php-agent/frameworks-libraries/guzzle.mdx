...
New Relic [、 New Relic PHP エージェント バージョン 7.0](/docs/release-notes/agent-release-notes/php-release-notes)以上で、<DNT>**Guzzle HTTP client library**</DNT> のバージョン 3、4、5、6、7 をサポートします。
