...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > APM > (選択したアプリ) > 概要 > Web トランザクション時間**: New Relic UI の Guzzle を使用したシーケンシャル リクエスト。
</figcaption>
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > APM > (選択したアプリ) > 概要 > Web トランザクション時間**: New Relic UI での Guzzle による並列リクエスト
</figcaption>
