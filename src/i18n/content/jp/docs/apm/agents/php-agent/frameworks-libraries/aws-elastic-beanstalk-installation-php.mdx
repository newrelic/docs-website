...
セットアップが成功した後、メトリクスが New Relic に表示されるまでに最大 15 分かかる場合があります。[APM**概要**ページ](/docs/apm/applications-menu/monitoring/applications-overview-dashboard)を表示するには: **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM > (アプリを選択) に移動します**。