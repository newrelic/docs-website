...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        PHP バージョン 7.0 および 7.1 のサポートは、2024 年 6 月 1 日に**終了**します。
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        PHP 8.x が可観測性拡張機能 (PHP エージェント) を検出すると、[ジャストインタイム コンパイル](https://php.watch/articles/jit-in-depth)が無効になります。
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        * ARM64 は、PHP バージョン 8.0 以降でのみサポートされます。
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        PHP バージョン 7.0 ～ 7.4 および 8.0 ～ 8.3 は、コードレベルのメトリックをレポートします (リリース 10.4.0 以降)。
      </td>
    </tr>
