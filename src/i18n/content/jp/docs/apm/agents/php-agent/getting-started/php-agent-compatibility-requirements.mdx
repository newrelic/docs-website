...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [Drupal固有の機能](/docs/apm/agents/php-agent/frameworks-libraries/drupal-specific-functionality)<br />[Drupalブラウザインストゥルメンテーション](/docs/apm/agents/php-agent/frameworks-libraries/drupal-specific-functionality/#page-load-timing-rum)
      </td>
    </tr>
...
* HTTP
* Laravelのキューイング<Callout variant="important">Laravel Horizonはサポートされていません。</Callout>
