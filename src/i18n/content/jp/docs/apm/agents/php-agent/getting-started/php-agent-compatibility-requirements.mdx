...
* 当社では、PHPの[サポートされているリリース](http://php.net/supported-versions.php)（特に、7.4、8.0および8.1）の使用を推奨しています。
...
* PHPバージョン5.5、5.6、7.0、7.1、7.2、7.3、7.4の32ビットサポートは、リリース[9.19](/docs/release-notes/agent-release-notes/php-release-notes/php-agent-9190309)で廃止されました。
* リリース[9.19](/docs/release-notes/agent-release-notes/php-release-notes/php-agent-9190309)は、ZTSビルドをサポートする最終リリースです。将来的には、ZTSビルドが提供されず、コードベースからサポートが完全に削除される可能性があります。
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <Callout variant="important">
          2022年6月をもって、x86アーキテクチャーのサポートを終了します。詳細については、[PHPエージェントのリリースノートv9.19.0](/docs/release-notes/agent-release-notes/php-release-notes/php-agent-9190309)を参照してください。
        </Callout>

        * AWS Linux 2

        * Red Hat Enterprise Linux（RHEL）6以上

          <Callout variant="important">
            2022年3月時点で、Red Hat Enterprise Linux（RHEL）6のサポートを終了しました。詳細については、[PHPエージェントのリリースノートv9.20.0](/docs/release-notes/agent-release-notes/php-release-notes/php-agent-9200310)を参照してください。2022年6月以降はサポート対象外となります。
          </Callout>

          <Callout variant="important">
            2021年1月時点で、Red Hat Enterprise Linux（RHEL）5のサポートを終了しました。詳細については、[PHPエージェントリリースノートv9.15.0](/docs/release-notes/agent-release-notes/php-release-notes/php-agent-9150293)および[エクスプローラーハブの投稿](https://discuss.newrelic.com/t/important-upcoming-changes-to-capabilities-across-browser-php-python-mobile-and-android-agents/123951)を参照してください。
          </Callout>

        * CentOS 6以降

          <Callout variant="important">
            2022年3月時点で、Centos 6のサポートを終了しました。詳細については、[PHPエージェントのリリースノートv9.20.0](/docs/release-notes/agent-release-notes/php-release-notes/php-agent-9200310)を参照してください。2022年6月以降はサポート対象外となります。
          </Callout>

          <Callout variant="important">
            2021年1月時点で、CentOS 5のサポートを終了しました。詳細については、[PHPエージェントリリースノートv9.15.0](/docs/release-notes/agent-release-notes/php-release-notes/php-agent-9150293)および[エクスプローラーハブの投稿](https://discuss.newrelic.com/t/important-upcoming-changes-to-capabilities-across-browser-php-python-mobile-and-android-agents/123951)を参照してください。
          </Callout>
    ...
    <tr>
      ...
      <td>
        <Callout variant="important">
          2021年1月時点で、macOSのサポートは終了しています。詳細については、[PHPエージェントリリースノートv9.15.0](/docs/release-notes/agent-release-notes/php-release-notes/php-agent-9150293)および[エクスプローラーハブの投稿](https://discuss.newrelic.com/t/important-upcoming-changes-to-capabilities-across-browser-php-python-mobile-and-android-agents/123951)を参照してください。
        </Callout>

        macOS 10.6以上macOSの最近のバージョンでは32ビットアプリケーションを実行できないため、New RelicではPHPエージェントリリース4.6による32ビットmacOSのサポートを削除しました。
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <Callout variant="important">
          2022年6月をもって、FreeBSDのサポートを終了します。詳細については、[PHPエージェントのリリースノートv9.19.0](/docs/release-notes/agent-release-notes/php-release-notes/php-agent-9190309)を参照してください。
        </Callout>
...
<Callout variant="important">
  PHPエージェントバージョン9.17以降、次のフレームワークまたはフレームワークバージョンはサポートされなくなり、今後のエージェントビルド（_Cake PHP 1.x _Joomla 1.5、1.6、2.x _Kohana _Silex 1.xおよび2.x \* Symfony 1.xおよび2.x）から削除される可能性があります。
</Callout>
