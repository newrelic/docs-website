...
<Callout variant="important">
  ...
  PHPバージョン5.5および5.6のサポートは、リリース10.11.0.3の時点で**廃止されています**。少なくともPHP 7.0に更新することを強く推奨します。
</Callout>
    ...
    <tr>
      ...
      <td>
        ...
        * Debian 11以降
        ...
        <Callout variant="important">
          ARM64のサポートは、PHP 8.0、8.1、および8.2に対してのみ提供されます。
        </Callout>

        <Callout variant="important">
          New Relic PHPエージェント10.10.0以降は、tarballディストリビューションにバイナリを含めることでARM64のサポートを提供します。
        </Callout>

        <Callout variant="important">
          New Relic PHPエージェント9.18.1～10.9.0ソースディストリビューションは、Amazon Linux 2（AWS Graviton 2を含む）およびCentos 8でのみARM64のサポートを提供します。
        </Callout>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        [Drupal 6.x、7.x、8.x、9.0、9.1、9.2、および9.3](/docs/agents/php-agent/frameworks-libraries/drupal-specific-functionality)
      </td>
