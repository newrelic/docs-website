...
* カスタマイズ可能でインタラクティブな[ダッシュボード](/docs/query-your-data/explore-query-data/query-builder/introduction-query-builder)を作成・共有する
...
* [ページロードタイミング](/docs/agents/php-agent/features/page-load-timing-php)：PHPエージェントを[<InlinePopover type="browser" />](/docs/browser/new-relic-browser/getting-started/new-relic-browser)と統合してエンドユーザーのアクティビティを可視化します。
