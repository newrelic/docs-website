...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & services > (select an app) > Summary**</DoNotTranslate>：PHPエージェントをインストールすると、アプリのパフォーマンスの概要を表示できます。
</figcaption>
...
<DoNotTranslate>**standard installations**</DoNotTranslate>については、以下を参照してください。
...
その他の種類のPHPインストレーションや<DoNotTranslate>**advanced installation**</DoNotTranslate>に関するトピックについては、以下をご覧ください。
