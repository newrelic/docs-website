...
1. 標準の手順に従って、
   ...
   を含む[Python エージェントをインストールします](/docs/agents/python-agent/getting-started/python-agent-quick-start#install)。
...
<DNT>**Recommendation:**</DNT> 以下を追加して、 `app.yaml`を構成して[ヘルスチェックを無効にします](https://cloud.google.com/appengine/docs/flexible/python/configuring-your-app-with-app-yaml#health_checks)。
