...
<CollapserGroup>
  ...
  >
    **ERROR - エージェントの設定でライセンスキーが設定されていません。**
    ...
    [ライセンス キー](/docs/apis/intro-apis/new-relic-api-keys/#ingest-license-key)がエージェント構成ファイルまたは`NEW_RELIC_LICENSE_KEY`環境変数で指定されていることを確認してください。ライセンスキーの問題を修正するか、 [support.newrelic.com](https://support.newrelic.com)でサポートを受けてください。
  </Collapser>
  ...
  >
    **ERROR - データコレクタは、エージェントから不正なライセンスキーが提供されたことを示しています。**
    ...
    エージェントが使用する値は`...`です。[ライセンスキー](/docs/apis/intro-apis/new-relic-api-keys/#ingest-license-key)の問題を修正するか、 [support.newrelic.com](https://support.newrelic.com)でサポートを受けてください。
  </Collapser>
