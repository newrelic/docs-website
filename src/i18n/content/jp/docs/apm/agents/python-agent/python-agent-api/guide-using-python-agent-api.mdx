    ...
    <tr>
      ...
      <td>
        ...
        * から
          ...
          [サーバーサイド 構成を含む](/docs/agents/manage-apm-agents/configuration/configure-agent#ssc) 設定への参照を取得するには、UI [`application_settings`](/docs/agents/python-agent/python-agent-api/application_settings)を使用します。
      </td>
    </tr>
