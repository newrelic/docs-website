...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [`add_custom_parameter`](/docs/agents/python-agent/python-agent-api/add_custom_parameter)を使用してトランザクションに[カスタム属性](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#attribute)を追加するか、他のAPI呼び出しを使用して[カスタムデータをレポート](#custom-data)します。
      </td>
    </tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        より詳細なクエリまたはエラー分析のためにイベントに属性を追加するには、 [`add_custom_parameter`](/docs/agents/python-agent/python-agent-api/add_custom_parameter)を使用します。
      </td>
    </tr>
