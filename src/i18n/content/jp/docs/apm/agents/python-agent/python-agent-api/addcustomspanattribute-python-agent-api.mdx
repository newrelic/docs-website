...
トランザクショントレースが親トランザクションによって作成されている場合、属性は分散トレースまたはAPMにあります。属性は、NewRelicUIでも[検索および照会](/docs/query-your-data/explore-query-data/explore-data/introduction-querying-new-relic-data)できます。
