...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        **transaction_events**セクションで、 `max_samples_stored`の[設定](/docs/agents/java-agent/configuration/java-agent-configuration-config-file#ae-max_samples_stored)を調整します。
      </td>
    </tr>
