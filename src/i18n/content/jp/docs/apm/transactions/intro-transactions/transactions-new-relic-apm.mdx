...
* <DNT>**Web**</DNT>
  ...
  : トランザクションは HTTP リクエストによって開始されます。 ほとんどの組織にとって、これらは顧客中心のインタラクションを表しており、したがってモニターにとって最も重要なトランザクションです。

* <DNT>**Non-web**</DNT>

  : [非ウェブ ブラウザは](/docs/apm/transactions/intro-transactions/monitor-background-processes-other-non-web-transactions)Web リクエストによって開始されません。 これらには、Web 以外のワーカー プロセス、バックグラウンド プロセス、スクリプト、メッセージキュー アクティビティ、その他のタスクが含まれます。
