    ...
    <tr>
      ...
      <td>
        ...
        * 遅いセグメントは3番目に優先されます。
          ...
          詳細については、 [GitHubの`newrelic_transaction_tracer_config_t`に関するCSDK](https://newrelic.github.io/c-sdk/structnewrelic__transaction__tracer__config__t.html)のドキュメントを参照してください。
      </td>
    </tr>
