...
<img
  ...
  alt="トランザクショントレースの詳細画面のスクリーンショットです。"
  src={trxTraceDetails}
/>
...
<table>
  ...
  <tbody>
    <tr>
      <td>
        <img title="アイコンのデータベース" alt="アイコンのデータベース" src={iconDatabase}/> データベースクエリ
      </td>
    ...
    <tr>
      <td>
        <img title="アイコンの検索" alt="アイコンの検索" src={iconParameters}/> Stack traces
      </td>
    ...
    <tr>
      <td>
        <img title="icon-web-transaction-app" alt="icon-web-transaction-app" src={iconWebtx}/> トランザクションの詳細を集約する
      </td>
...
<img title="アラートv3：アラートアイコン" alt="icon-alerts-red.png" src={iconAlertsRed}/> 赤。全トランザクション時間の25％以上がこのセグメントに費やされた。

<img title="アラートv3：アラートアイコン" alt="icon-alerts-yellow.png" src={iconAlertsYellow}/> 黄色。全トランザクション時間の5%以上がこのセグメントに費やされた。
