...
1. 次のうち1つを行います。
   * エンティティエクスプローラー：**[one.newrelic.com](https://one.newrelic.com) > Entity explorer > (アプリを選択) > Monitor > Transactions**の順に進みます。
...
トランザクショントレース、遅いクエリ、サービスマップを使用してパフォーマンスに関する問題を解決するための詳細については、 [パフォーマンスに関する問題を分析する](/docs/apm/applications-menu/features/analyze-database-instance-level-performance-issues)をご覧ください。
