...
Errors Inbox <InlinePopover type="apm"/>UIに埋め込まれているため、エラーをより早く解決できます。 エラーはグループ化されてノイズが削減され、同じエラー データを共有して表示できるため、チーム間での共同作業が容易になります。
