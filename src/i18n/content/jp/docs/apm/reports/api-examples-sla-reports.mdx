...
**エンド ユーザー**[層](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#tier)のブラウザ[メトリックは、 <InlinePopover type="browser"/>エージェント](/docs/browser/new-relic-browser/getting-started/browser-settings)。
