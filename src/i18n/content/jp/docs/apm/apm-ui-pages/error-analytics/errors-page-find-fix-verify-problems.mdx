...
エラープロファイルにアクセスするには、**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & services > Errors > Error profiles**の順に移動します。
...
1. **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & services >（アプリを選択）> Events > Errors**の順に移動し、**Show new view**を切り替えて、APMが**エラー**ページの従来のビューを表示するようにします。
