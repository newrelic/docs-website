...
<Callout variant="important">
  2021年10月1日以降、New Relic One APM **Errors** UIを優先してAPM **Errors（従来版）**UIは廃止されます。詳細については、[Explorers Hub投稿](https://discuss.newrelic.com/t/important-upcoming-changes-to-support-and-capabilities-across-browser-node-js-agent-query-builder-net-agent-apm-errors-distributed-tracing/153373)をご覧ください。
</Callout>
