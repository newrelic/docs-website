...
エラー プロファイルにアクセスするには、 **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM & サービス > エラー > エラー プロファイル**に移動します。
...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM & services > (選択したアプリ) > Events > Errors**に移動し、 **Show new view**を切り替えて、APM が**エラー**ページの従来のビューを表示するようにします。
