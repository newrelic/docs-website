...
1. **[one.newrelic.com](https://one.newrelic.com/all-capabilities) APM & services > (アプリを選択) > Events > Errors**に移動し、 **Show new view**を切り替えて、APM が**エラー**ページの従来のビューを表示するようにします。
