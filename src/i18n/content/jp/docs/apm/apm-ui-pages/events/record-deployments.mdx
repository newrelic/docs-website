...
* <DNT>
  ...
  ：New Relic [REST API v2](#api)を使用します

* <DNT>
    **C**
  </DNT>

  ：SDK固有のメソッドではありません。 [REST API](#api)を使用します

* <DNT>
    **Go**
  </DNT>

  : エージェント固有のメソッドではありません。 [REST API](#api)を使用します

* <DNT>
    **Java**
  </DNT>

  ：[Javaエージェント`jar`](/docs/agents/java-agent/instrumentation/recording-deployments-java-agent)を呼び出します

* <DNT>
    **.NET**
  </DNT>

  ：[PowerShellとREST API](#powershell)を使用します
...
* <DNT>
  ...
  ：[PHPスクリプト](/docs/agents/php-agent/features/recording-deployments-using-php-script)を使用します

* <DNT>
    **Python**
  </DNT>

  ：`newrelic-admin`スクリプトの[`record-deploy`](/docs/agents/python-agent/installation-configuration/python-agent-admin-script#record-deploy)サブコマンドを使用します

* <DNT>
    **Ruby**
  </DNT>

  ：[Capistranoレシピ](/docs/agents/ruby-agent/features/recording-deployments-ruby-agent#capistrano3)を使用します
