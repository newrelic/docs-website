    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            <DoNotTranslate>**Required**</DoNotTranslate>このデプロイメントのユニークID。[概要](/docs/apm/applications-menu/monitoring/apm-overview-page)ページと[デプロイメント](/docs/apm/applications-menu/events/deployments-page)ページで表示できます。 任意の文字列を指定できますが、通常はバージョン番号またはGitのチェックサムです。
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**Optional**</DoNotTranslate>このデプロイメント内の変更の概要。<DoNotTranslate>**(selected deployment) > Change log**</DoNotTranslate>を選択する場合、[デプロイメント](/docs/apm/applications-menu/events/deployments-page)ページに表示されます。
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**Optional**</DoNotTranslate>このデプロイメントの大まかな説明。各デプロイメントを選択する場合は、[概要](/docs/apm/applications-menu/monitoring/apm-overview-page)ページと[デプロイメント](/docs/apm/applications-menu/events/deployments-page)ページに表示されます。
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**Optional**</DoNotTranslate>デプロイメントと関連付けるユーザー名。[概要](/docs/apm/applications-menu/monitoring/apm-overview-page)ページと[デプロイメント](/docs/apm/applications-menu/events/deployments-page)ページに表示されます。
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**Optional**</DoNotTranslate>デプロイメントが発生すると、セカンドに移ります。指定されないと、デプロイメントはAPIコールの受け取り時に記録されます。タイムスタンプの要件：
