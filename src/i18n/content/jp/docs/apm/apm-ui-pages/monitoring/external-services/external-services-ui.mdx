...
外部サービス機能は、エクスプローラーでサービスを選択すると、左側のナビゲーション ウィンドウから使用できます。 **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM & Services**に行くことで開くことができます。 アプリを選択し、**Monitor** \[監視] セクションで **External services** \[外部サービス] をクリックします。
