...
<CollapserGroup>
  ...
  >
    ![その他のトランザクションタイプを選択できるドロップダウンを表示するスクリーンショット。](./image/trx-type-dropdown.png "trx-type-dropdown.png")
  ...
  >
    ![チャートを変更するセレクターを表示するスクリーンショット。](./image/chart_type_selectors.png "chart_type_selectors.png")
