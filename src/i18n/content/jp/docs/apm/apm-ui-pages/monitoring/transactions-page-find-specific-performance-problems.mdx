...
チャートの背景が薄い赤色の場合は、アラート条件の[**Critical**閾値](/docs/alerts/new-relic-alerts/defining-conditions/define-thresholds-trigger-alert)を超過している期間を示します。[アラート](/docs/alerts/new-relic-alerts/getting-started/introduction-new-relic-alerts)で[インシデントの詳細](/docs/alerts-applied-intelligence/new-relic-alerts/alert-incidents/view-event-details-incidents)を表示するには、チャートをクリックします。
