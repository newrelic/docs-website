...
<CollapserGroup>
  ...
  >
    ![crop-tx-summary-details](./imagess/icon-tx-summary_0.png "crop-tx-summary-details")
  ...
  >
    ![Transaction detailsタブ](./imagess/icon-detail-tabs_0.png "icon-detail-tabs.png")
  ...
  >
    ![通話時間/回数によるトランザクションセグメントの色分け](./imagess/APM-transaction-high-time-colorization_0.png "APM-transaction-high-time-colorization.png")
