...
New Relic ログ監視は、いくつかの異なる方法でインストールできます。

* このシリーズの [最初のステップ](/docs/journey-migration/migrating-infra/) で説明したようなインフラストラクチャ エージェント経由
* このシリーズの第 [2 ステップ](/docs/journey-migration/migrating-apm/) で説明したようなアプリケーションを通じて
* Amazon Web Services、Google Cloud Platform、Microsoft Azure などのクラウド統合を通じて
* Kubernetes または Docker コンテナ経由
* [ここに](/docs/logs/forward-logs/enable-log-management-new-relic/#forward-other)リストされている他のオプションのいずれかを使用して
