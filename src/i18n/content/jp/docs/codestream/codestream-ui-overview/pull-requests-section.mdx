...
![プル・リクエスト・セクション](/images/PullRequestsSection.png)
...
![クエリーヘッダー](/images/PRQueryHeader.png)

最初のセクションでは、実際にURL経由で任意のプルリクエストを読み込むことができます。プルリクエストのURLを取得して貼り付けるだけで、CodeStreamの中でプルリクエストを見ることができます。

![PRをURLから読み込む](/images/PRLoadFromURL.png)

Pull Requestsセクションの見出しにカーソルを合わせると、右側にアイコンが表示されます。

![Pull Requestsセクションのヘッダー](/images/PRSectionHeader.png)
