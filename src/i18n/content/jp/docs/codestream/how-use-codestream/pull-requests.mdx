...
<Callout variant="important">
  CodeStreamの **Pull Requests** は現在、GitHub、GitHub Enterprise、GitLab、GitLab Self-Managedのみに対応しています。
</Callout>

![プルリクエストセクションのスクリーンショット](/images/PullRequestsSection.png "プル・リクエスト")
...
| 機能                                                     | サポートサービス                                                                            |
| ------------------------------------------------------ | ----------------------------------------------------------------------------------- |
| [プルリクエストの作成](#create)                                  | GitHub, GitHub Enterprise, GitLab, GitLab Self-Managed, Bitbucket, Bitbucket Server |
| フォークを越えたプルリクエストの作成                                     | GitHub, GitHub Enterprise, GitLab, GitLab Self-Managed                              |
| [プルリクエストのレビューと編集](#review)                             | GitHub, GitHub Enterprise, GitLab, GitLab Self-Managed                              |
| [Display pull request comments](#pr-comments) コード注釈として | GitHub、GitLab、Bitbucket                                                             |
