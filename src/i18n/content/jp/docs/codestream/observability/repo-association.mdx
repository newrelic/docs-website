...
<CollapserGroup>
  ...
  >
    **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities)> APM & Services > (アプリを選択)**から APM 概要ページに移動し、ページの右下にある**Repositories** \[リポジトリ]セクションを探します。
