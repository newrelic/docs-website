...
* <DoNotTranslate>**PHP:**</DoNotTranslate>
  ...
  PHPエージェント バージョン 10.6.0 以降が必要です。
...
CodeLenses をオフにするには、IDE 設定の CodeStream セクションに移動し、 <DoNotTranslate>**CodeStream: Show Golden Signals In Editor**</DoNotTranslate>設定のチェックを外します。