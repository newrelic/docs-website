...
* <DNT>**Node.js:**</DNT> コードベースに匿名関数が含まれている場合は、[変更追跡 (変更追跡機能) を](/docs/change-tracking/change-tracking-introduction/)使用してデプロイメント情報を New Relic に送信するか、ビルド パイプラインの[環境変数を使用してビルド SHA](/docs/codestream/observability/error-investigation/#buildsha)を送信できます。
