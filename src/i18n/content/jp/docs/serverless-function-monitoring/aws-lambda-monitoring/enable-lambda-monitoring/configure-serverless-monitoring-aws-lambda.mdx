...
私たちの<InlinePopover type="alerts"/> APM メトリクス、キートランザクション、NRQL クエリなど、New Relic で監視できるあらゆるものに関する通知を受け取ることができます。 [アラートのドキュメントを](/docs/alerts-applied-intelligence/new-relic-alerts/learn-alerts/introduction-alerts/)参照してください。
