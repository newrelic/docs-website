...
2. <DoNotTranslate>**Configuration**</DoNotTranslate>
...
3. <DoNotTranslate>**Edit**</DoNotTranslate>

   を選択します。

4. <DoNotTranslate>**X-Ray**</DoNotTranslate>
...
2. <DoNotTranslate>**Designer**</DoNotTranslate>セクションの<DoNotTranslate>**Layers**</DoNotTranslate>の下で、 <DoNotTranslate>**Add a layer**</DoNotTranslate>を選択します。

3. <DoNotTranslate>**Specify an ARN**</DoNotTranslate>の下に、以下のリストから関数のアーキテクチャのレイヤー ARN の 1 つを貼り付けます。 `{region}`を AWS リージョン (例: `us-east-1` ) に置き換えます。

4. <DoNotTranslate>**Add**</DoNotTranslate>を選択します。
...
2. <DoNotTranslate>**Configuration**</DoNotTranslate>選択し、次に<DoNotTranslate>**Environment variables**</DoNotTranslate>選択します。

3. <DoNotTranslate>**Environment variables**</DoNotTranslate>の下で、 <DoNotTranslate>**Edit**</DoNotTranslate>を選択します。

4. <DoNotTranslate>**Add environment variable**</DoNotTranslate>を選択します。

5. <DoNotTranslate>**Key**</DoNotTranslate>の場合は、それを`AWS_LAMBDA_EXEC_WRAPPER`に設定し、 <DoNotTranslate>**Value**</DoNotTranslate>を次のオプションのいずれかに設定します (ハンドラーのタイプに応じて異なります)。 次に、 <DoNotTranslate>**Save**</DoNotTranslate>選択します。
...
3. <DoNotTranslate>**Configuration**</DoNotTranslate>選択し、次に<DoNotTranslate>**Environment variables**</DoNotTranslate>選択します。

4. <DoNotTranslate>**Environment variables**</DoNotTranslate>の下で、 <DoNotTranslate>**Edit**</DoNotTranslate>を選択します。

5. <DoNotTranslate>**Add environment variable**</DoNotTranslate>を選択します。

6. <DoNotTranslate>**Key**</DoNotTranslate>を`NEW_RELIC_LICENSE_KEY`に設定し、 <DoNotTranslate>**Value**</DoNotTranslate>を手順 1 で生成したライセンスキーの値に設定します。 次に、 <DoNotTranslate>**Save**</DoNotTranslate>選択します。

7. もう一度<DoNotTranslate>**Add environment variable**</DoNotTranslate>選択します。

8. <DoNotTranslate>**Key**</DoNotTranslate>の場合は`NEW_RELIC_OPENTELEMETRY_ENDPOINT`に設定し、 <DoNotTranslate>**Value**</DoNotTranslate>を以下のオプションのいずれかに設定します (New Relic リージョンによって異なります)。 次に、 <DoNotTranslate>**Save**</DoNotTranslate>選択します。
...
3. <DoNotTranslate>**Environment variables**</DoNotTranslate>
...
4. <DoNotTranslate>**Add environment variable**</DoNotTranslate>

   を選択します。

5. <DoNotTranslate>**Key**</DoNotTranslate>
