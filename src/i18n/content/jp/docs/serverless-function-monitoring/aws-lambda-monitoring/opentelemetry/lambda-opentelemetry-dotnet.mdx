...
<Callout variant="important">
  `your-license-key-here`を New Relic [ライセンス キー](/docs/apis/intro-apis/new-relic-api-keys/#license-key) に置き換え、 `otlp.nr-data.net:4317` New Relic リージョンに適したエンドポイントに置き換えます (上記のリストを参照)。
</Callout>
