          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                [手動ラッピング方法を](https://github.com/newrelic/newrelic-lambda-layers?tab=readme-ov-file#note-on-performance-for-es-module-functions)

                使用しない場合、これが関数のハンドラーになります。
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                https://log-api.newrelic.com/log/v に設定します
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                [米国のエンドポイント](https://cloud-collector.newrelic.com/aws/lambda/v1)
              ...
              <td>
                ...
                [EU弁護士](https://github.com/newrelic/newrelic-lambda-extension/blob/3c4218dd7727d0b0467f24f0902b616b7f4e46b7/telemetry/client.go#L24-L27)
              </td>
            </tr>
          </tbody>
        </table>
