...
<DocTiles>
  <DocTile title="Compatibility and requirement" path="/docs/serverless-function-monitoring/aws-lambda-monitoring/instrument-lambda-function/compatibility-requirement-lambda-monitoring">サポートされているランタイムと前提条件について詳しく学ぶ</DocTile><DocTile title="Data and UI" path="/docs/serverless-function-monitoring/aws-lambda-monitoring/instrument-lambda-function/instrument-your-own">New Relic を使用してAWS Lambda 関数を監視する方法について学ぶ インストレーション</DocTile><DocTile title="Troubleshooting" path="/docs/serverless-function-monitoring/aws-lambda-monitoring/troubleshooting">関連の問題のトラブルシューティング方法を学ぶ</DocTile>
</DocTiles>