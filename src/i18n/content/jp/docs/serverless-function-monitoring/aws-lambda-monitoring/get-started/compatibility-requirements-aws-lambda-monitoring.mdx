...
Python と Node.js は、Lambda エコシステムで群を抜いて最も人気のある言語です。Node.js および Python 用の[New Relic Lambda レイヤー](https://layers.newrelic-external.com/)には、最新の New Relic エージェント バージョンが含まれており、箱から出してすぐに、最小限の構成で豊富なインストルメンテーションを提供します。
