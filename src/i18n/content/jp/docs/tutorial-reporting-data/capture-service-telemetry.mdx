  ...
  <Step>
    ...
    <CollapserGroup>
      ...
      >
        ...
        サービスに付ける名前によって、 <DoNotTranslate>**namespace**</DoNotTranslate> (エージェント データがある場所) が提供されます。 New Relic がサービスの動作を理解するために使用する最も重要な戦略の 1 つは、類似するものをまとめて集約し、この集約からの共通点を使用して差異を分離することです。 デプロイ サービスを利用する場合は、名前を付けるのに役立つ次の質問をしてください。
