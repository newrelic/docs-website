  ...
  <Step>
    ...
    <CollapserGroup>
      <Collapser
        ...
        title="UI経由"
      >
        <DNT>**Browser**</DNT>で Web アプリケーションを開きます。 左側のメニューの下にある<DNT>**Errors**</DNT>ビューを開き、JavaScript エラーが表示されることを確認します。 アプリケーションのトラフィックがそれほど多くない場合は、エラーを確認するために 24 時間以上前までさかのぼる必要がある場合があります。<img src={omaOeScBrowserErrors} alt="Browser JavaScript Errors" title="Browser JavaScript Errors"/>
      </Collapser>
    ...
    <CollapserGroup>
      <Collapser
        ...
        title="UI経由"
      >
        イベント ログをキャプチャしているかどうかを確認するには、 <DNT>**JS Errors**</DNT>タブに移動します。 いくつかの異なるエラーをチェックして、イベント ログが表示されることを確認します。<img src={omaOeScBrowserErrorLog} alt="Browser JavaScript Error Logs" title="Browser JavaScript Error Logs"/>
      </Collapser>
    </CollapserGroup>
  ...
  <Step>
    ...
    <CollapserGroup>
      <Collapser
        ...
        title="UI経由"
      >
        左側のメニューから選択して、アプリの<DNT>**Page views**</DNT> UI を確認します。 表示される内容が以下のスクリーンショットとよく似ている場合は、メモを取り、このガイドの指示に従って対処してください。<img src={omaOeScBrowserGroupedPageViews} alt="Browser Page URL Grouping" title="Browser Page URL Grouping"/>
      </Collapser>
  ...
  <Step>
    ...
    <CollapserGroup>
      <Collapser
        ...
        title="UI経由"
      >
        左側のメニューからアプリを選択し、 <DNT>**groupedRequestUrl**</DNT>でグループ化して、アプリの AJAX グループ化を確認します。 表示される内容が以下のスクリーンショットとよく似ている場合は、メモを取り、このガイドの指示に従って対処してください。<img src={omaOeScBrowserGroupedAjaxRequests} alt="AJAX Grouping" title="AJAX Grouping"/>
      </Collapser>
