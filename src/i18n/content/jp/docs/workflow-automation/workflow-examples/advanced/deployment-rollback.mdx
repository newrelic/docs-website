...
<DocTiles>
  <DocTile title="EC2管理" path="/docs/workflow-automation/workflow-examples/advanced/ec2-management">
    ワークフローでインフラストラクチャの変更を自動化
  </DocTile>

  <DocTile title="APIゲートウェイのロールバック" path="/docs/workflow-automation/workflow-examples/advanced/api-gateway-rollback">
    API Gateway のデプロイメントをロールバックする
  </DocTile>

  <DocTile title="NRQLアクション" path="/docs/workflow-automation/setup-and-configure/actions-catalog/newrelic/query/newrelic-nrdb">
    NRQL でデプロイメントデータをクエリする
  </DocTile>
</DocTiles>