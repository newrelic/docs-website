...
このページでは、ワークフロー自動化アクションカタログで使用できる AWS Execute API の包括的なリファレンスを提供します。これらのアクションにより、あらゆる AWS API 操作を実行できます。
...
このアクションを使用するには、AWS 認証情報を設定する必要があります。IAM ロールまたは IAM ユーザーを作成する詳細な手順については、 [「AWS 認証情報の設定」を](/docs/workflow-automation/setup-and-configure/set-up-aws-credentials/)参照してください。
