...
<CollapserGroup>
  <Collapser id="aws.systemsManager.writeDocument" title="ドキュメントを作成">
      ...
      <TabsPages>
        ...
        <TabsPageItem id="writedocumentoutputs">
          ...
          <Callout variant="important">
            ...
            * 手順については、 [AWS 認証情報](/docs/workflow-automation/setup-and-configure/set-up-aws-credentials)を参照してください。
          </Callout>
        </TabsPageItem>
...
<CollapserGroup>
  <Collapser id="aws.systemsManager.deleteDocument" title="ドキュメントを削除">
...
<CollapserGroup>
  <Collapser id="aws.systemsManager.startAutomation" title="自動化を開始する">
      ...
      <TabsPages>
        ...
        <TabsPageItem id="automationstatusoutputs">
          ...
          <Callout variant="important">
            ...
            3. [AWS 認証情報](/docs/workflow-automation/setup-and-configure/set-up-aws-credentials)を設定する手順を参照してください。
