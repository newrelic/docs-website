...
<CollapserGroup>
  <Collapser id="aws.ec2.runInstances" title="インスタンスを実行する">
  ...
  <Collapser id="aws.ec2.terminateInstances" title="インスタンスをシャットダウンする">
  ...
  <Collapser id="aws.ec2.createSnapshot" title="EBSスナップショットを作成する">
  ...
  <Collapser id="aws.ec2.deleteSnapshot" title="スナップショットを削除">
    指定されたスナップショットを削除します。
