...
<CollapserGroup>
  <Collapser id="newrelic.notification.send" title="メッセージを送信">
...
<CollapserGroup>
  <Collapser id="newrelic.notification.sendEmail" title="メールを送信">
...
<CollapserGroup>
  <Collapser id="newrelic.workflowAutomation.start" title="ワークフローを実行する">
