...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        [ループ](/docs/workflow-automation/workflow-examples#loop-structure)
      </td>
...
ループ構造、パラメーター、高度な使用法 (break/continue を含む) の詳細については、 [「ループ構造」を](/docs/workflow-automation/workflow-examples#loop-structure)参照してください。
...
<Callout variant="tip">
  **完全なパターン例が必要ですか?**エラー処理、再試行、複雑な統合などの追加のパターンについては[、ワークフローの例を](/docs/workflow-automation/workflow-examples)参照してください。
</Callout>
