...
* **AWS テンプレート**: 権限のある[AWS 認証情報](/docs/workflow-automation/setup-and-configure/set-up-aws-credentials)(EC2、API Gateway、Systems Manager、または SQS)。
...
<Steps>
  <Step>
    ...
    [テンプレート ライブラリ](#workflow-automation-templates)を参照します。それぞれ、機能、使用時期、要件、および動作方法を示します。
  </Step>
  ...
  <Step>
    ...
    1. 手動でトリガーする（[オンデマンドでワークフローを開始するを](/docs/workflow-automation/manage-workflows/workflow-entity-overview#on-demand)参照）
    2. 実行履歴での実行の監視
...
<CollapserGroup>
  ...
  <Collapser id="ec2-instance-management" title="EC2インスタンス管理">
    ...
    * **Slack** : 通知と承認のためのアプリ
    * **New Relic**: EC2を監視するアラート条件、[CloudWatch Metric Streams](/docs/infrastructure/amazon-integrations/aws-integration-for-metrics/via-cloudformation-cwms/)経由でNew Relicと統合されたEC2、および[EC2監視インテグレーション](/docs/infrastructure/amazon-integrations/aws-integrations-list/aws-ec2-monitoring-integration#activate)
