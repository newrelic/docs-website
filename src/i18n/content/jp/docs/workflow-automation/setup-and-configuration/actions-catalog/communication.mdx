...
プラットフォーム別のすべての通信アクションのクイックリファレンス:
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        [メッセージを投稿](#slackchatpostmessage)
      </td>

      <td>
        オプションのファイル添付を使用して、Slack チャネルにメッセージを送信します。
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        [反応を得る](#slackchatgetreactions)
      </td>

      <td>
        Slack メッセージから絵文字反応を取得します。
      </td>
    </tr>
  </tbody>
</table>
