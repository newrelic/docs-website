...
topics:
  ...
  - Key transactions
japaneseVersion: >-
  https://docs.newrelic.co.jp/docs/apm/transactions/key-transactions/introduction-key-transactions
---
...
In New Relic APM, making a [transaction](/docs/apm/transactions/intro-transactions/transactions-new-relic-apm) a **key transaction** gives you the following benefits:
