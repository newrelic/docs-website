...
<CollapserGroup>
  ...
  >
    ...
    ![APM Databases slow query details: Database and instances information](./images/icapm-slow-sql.png "APM Databases slow query details: Database and instances information")
  ...
  >
    ...
    From the selected [transaction trace **Details**](/docs/apm/transactions/transaction-traces/transaction-trace-details), you select the **Database** <Icon name="database"/>
    ...
    ![APM transaction trace: Database and instances information](./images/103116slow-tx-trace_0.png "APM transaction trace: Database and instances information")
