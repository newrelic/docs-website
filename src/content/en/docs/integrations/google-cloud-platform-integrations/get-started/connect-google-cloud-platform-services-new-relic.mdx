    ...
    <tr>
      ...
      <td>
        **For [service account](#service) authorization (recommended):**
        ...
        In the GCP project **IAM & admin**, the service account must have the **Project** **Viewer** role or, alternatively, a [custom role](https://docs.newrelic.com/docs/integrations/google-cloud-platform-integrations/get-started/integrations-custom-roles).
      </td>
    </tr>
...
1. Go to [**one.newrelic.com**](http://one.newrelic.com) **> Infrastructure > GCP**. At the top of Infrastructure's **Google Cloud Services** integrations page, select **Add a GPC account**.
