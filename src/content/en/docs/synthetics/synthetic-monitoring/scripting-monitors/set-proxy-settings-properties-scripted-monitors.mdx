  ...
  >
    ...
    <CollapserGroup>
      ...
      <Collapser
        ...
        title="Examples"
      >
        An example of creating a `proxyRules` with `authCredentials`:
...
* [Write scripted browsers](/docs/synthetics/new-relic-synthetics/scripting-monitors/write-scripted-browsers) (how to write scripted browsers for synthetic monitoring)
* [Write API tests](/docs/synthetics/new-relic-synthetics/scripting-monitors/write-api-tests) (how to write API tests for synthetic monitoring)
* [Add and edit monitors](/docs/synthetics/new-relic-synthetics/using-monitors/add-edit-monitors) (how to create virtual browser monitors in New Relic)
