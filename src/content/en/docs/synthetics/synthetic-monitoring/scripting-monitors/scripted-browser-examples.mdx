...
topics:
  ...
  - Scripting monitors
japaneseVersion: >-
  https://docs.newrelic.co.jp/docs/synthetics/synthetic-monitoring/scripting-monitors/scripted-browser-examples
---
...
* [Write scripted browsers](/docs/synthetics/new-relic-synthetics/scripting-monitors/writing-scripted-browsers) (build WebDriverJS scripts for multi-step monitoring)
* [Synthetic's scripted browser reference](/docs/synthetics/new-relic-synthetics/scripting-monitors/synthetics-scripted-browser-reference-monitor-versions-050) (detailed list of all available functions)
* [Add and edit monitors](/docs/synthetics/new-relic-synthetics/using-monitors/adding-editing-monitors) (how to create synthetic monitors, including configuration options)
