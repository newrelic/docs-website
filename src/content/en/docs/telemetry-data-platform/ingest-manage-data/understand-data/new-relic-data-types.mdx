...
topics:
  ...
  - Understand data
japaneseVersion: >-
  https://docs.newrelic.co.jp/docs/telemetry-data-platform/ingest-manage-data/understand-data/new-relic-data-types
---
...
First, we’ll explain the definition of metrics from a monitoring industry perspective, and then we’ll explain how New Relic handles metrics. For a list of the metrics we collect, see [our documentation](/docs/telemetry-data-platform/ingest-manage-data/understand-data/metric-data-type).
...
* To increase the availability of your event data for querying/charting, you can [turn events into metrics](/docs/accounts/accounts/data-management).
