...
## ![Linux](./images/otherlinux.png "Linux")Linux: Start, stop, restart, or check agent status
...
## ![Windows Server](./images/windows.png "Windows Server") Windows: Start, stop, restart, or check agent status
