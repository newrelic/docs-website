...
topics:
  ...
  - Agent release notes
  - NET release notes
releaseDateTime: '2017-05-11 15:00'
releaseVersion: 6.12.61.0
downloadLink: ''
---

### New Features

* The .NET agent no longer supports Windows Server 2003. Applications running on Windows Server 2003 will be required to use .NET agent version 6.11 or lower. For more information, get support at [support.newrelic.com](https://support.newrelic.com) or download the agent at [http://download.newrelic.com/](http://download.newrelic.com/)
