...
topics:
  ...
  - Agent release notes
  - NET release notes
releaseDateTime: '2016-04-26 10:00'
releaseVersion: 5.19.47.0
downloadLink: ''
---

### New Features

* [Async mode](https://docs.newrelic.com/docs/agents/net-agent/features/async-mode-net): Added support for the `metricName` and `transactionNamingPriority` custom instrumentation options when async mode is enabled.
