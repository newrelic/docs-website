...
topics:
  ...
  - Agent release notes
  - NET release notes
releaseDateTime: '2013-09-13 14:21'
releaseVersion: 2.12.146.0
downloadLink: ''
---
...
* A [thread profiler](https://newrelic.com/docs/applications-dashboards/thread-profiler) has been added to the .NET agent. The thread profiler is a low-impact profiling tool that can be used in production to identify bottlenecks in an application.
