...
releaseDateTime: '2020-02-27 14:00'
...
* Added the following Span attributes:
  ...
  * `http.statusText`
  ...
  The above attributes will be replacing the following _deprecated_ attributes:
...
* Updates version check to be in alignment with [our stated support policy](https://docs.newrelic.com/docs/agents/nodejs-agent/getting-started/compatibility-requirements-nodejs-agent) and the version constraints in package.json
