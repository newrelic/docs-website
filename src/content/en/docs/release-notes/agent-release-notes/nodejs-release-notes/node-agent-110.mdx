...
* Added a new call to the API, `.noticeError`. See the [docs](https://npmjs.org/package/newrelic) for details, but unlike the other calls on the API, you can use this to pass off errors anywhere in your app, not just from within web requests.
