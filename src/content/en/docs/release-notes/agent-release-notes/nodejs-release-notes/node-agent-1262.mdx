...
releaseDateTime: '2016-04-07 11:00'
...
* Added a new shutdown call to the public API.
  ...
  To read more about this new API, please read our README, or visit our [docs page](https://docs.newrelic.com/docs/agents/nodejs-agent/supported-features/nodejs-agent-api#shutdown).
