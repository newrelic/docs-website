...
releaseDateTime: '2016-09-13 15:20'
releaseVersion: 1.30.2
...
<Callout variant="important">
  This release has been unpublished from npmjs.org. Please use version [1.30.3](/docs/release-notes/agent-release-notes/nodejs-release-notes/node-agent-1303) or higher.
</Callout>
