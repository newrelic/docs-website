...
* BREAKING: Updated the version of `https-proxy-agent` to v2.x - Dropped support for v0.10 and v0.12 of node.
  ...
  You can read more about the issue here: [https://docs.newrelic.com/docs/using-new-relic/new-relic-security/securi...](https://docs.newrelic.com/docs/using-new-relic/new-relic-security/security-bulletins/security-bulletin-nr18-08)
