...
topics:
  ...
  - Agent release notes
  - Go release notes
releaseDateTime: '2019-12-17 11:09'
releaseVersion: 3.0.0
downloadLink: 'https://github.com/newrelic/go-agent/tree/v3.0.0'
---
...
* A full list of changes and a step by step checklist on how to upgrade can be found in the [v3 Migration Guide](https://github.com/newrelic/go-agent/blob/master/MIGRATION.md).
