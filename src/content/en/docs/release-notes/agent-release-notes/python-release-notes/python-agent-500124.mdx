...
releaseDateTime: '2019-08-06 10:00'
releaseVersion: 5.0.0.124
...
![Image of breakdown UI page](./images/python-event-loop-breakdown-table.png)

Time spent waiting on other transactions will be shown in the transaction _Trace details_ page, as shown here:

![Image of breakdown UI page](./images/python-event-loop-trace-details.png)
...
![Image of breakdown UI page](./images/python-event-loop-insights-table.png)
