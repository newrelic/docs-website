...
releaseDateTime: '2017-11-30 11:00'
releaseVersion: 2.98.0.81
...
* **Enabled reporting of handled exceptions in Django REST Framework**
  ...
  Exceptions handled by django rest framework are now reported if the resulting response code is not ignored (see [ignore_status_codes](https://docs.newrelic.com/docs/agents/python-agent/configuration/python-agent-configuration#error-ignore-status-codes) for details).
