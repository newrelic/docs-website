...
releaseDateTime: '2014-08-26 15:30'
releaseVersion: 2.28.0.26
downloadLink: ''
---
...
* **Better monitoring of Django management commands**
  ...
  We previously published a blog post about how the agent could be used to monitor [Django management commands](http://blog.newrelic.com/2014/03/18/monitoring-django-management-commands/). This required you to manually set up the instrumentation for each specific Django management command in the agent configuration file. We have now made that easier by integrating the functionality as part of the agent itself.
