...
releaseDateTime: '2019-01-22 15:00'
releaseVersion: 4.12.0.113
downloadLink: 'https://pypi.python.org/pypi/newrelic'
---

## Notes

This release of the Python agent extends support of Amazon's [boto3](https://boto3.amazonaws.com/v1/documentation/api/latest/index.html) library and includes bug fixes.
