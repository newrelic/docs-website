...
releaseDateTime: '2020-10-28 13:00'
releaseVersion: 5.22.1.152
downloadLink: 'https://pypi.python.org/pypi/newrelic'
---

## Notes

This release of the Python agent updates transaction naming for [Starlette](https://www.starlette.io/) and [FastAPI](https://fastapi.tiangolo.com/), and includes bug fixes.
