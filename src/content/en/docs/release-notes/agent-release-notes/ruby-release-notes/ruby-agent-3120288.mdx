...
topics:
  ...
  - Agent release notes
  - Ruby release notes
releaseDateTime: '2015-05-07 11:48'
releaseVersion: 3.12.0.288
downloadLink: 'https://rubygems.org/gems/newrelic_rpm/versions/3.12.0.288'
---
...
* Flexible capturing of attributes
  ...
  [https://docs.newrelic.com/docs/agents/ruby-agent/ruby-agent-attributes](https://docs.newrelic.com/docs/agents/ruby-agent/ruby-agent-attributes)
