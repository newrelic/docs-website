...
* Excon and Typhoeus support
  ...
  The Ruby agent now supports the Excon and Typhoeus HTTP libraries! For more details see [https://newrelic.com/docs/ruby/ruby-http-clients](https://newrelic.com/docs/ruby/ruby-http-clients).
