...
* MongoDB support
  ...
  Support for more Mongo gems and more UI goodness will be coming, so watch [http://docs.newrelic.com/docs/ruby/mongo](http://docs.newrelic.com/docs/ruby/mongo) for up-to-date status.
