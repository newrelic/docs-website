...
topics:
  ...
  - Agent release notes
  - C SDK release notes
releaseDateTime: '2019-06-04 12:00'
...
* **Support for Distributed tracing**
  ...
  Refer to the New Relic [C SDK documentation](https://docs.newrelic.com/docs/agents/c-sdk/instrumentation/enable-distributed-tracing-your-c-applications) for more information on enabling distributed tracing for the C SDK.
