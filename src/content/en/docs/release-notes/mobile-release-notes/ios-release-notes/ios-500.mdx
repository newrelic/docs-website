...
topics:
  ...
  - iOS release notes
releaseDateTime: '2015-05-01 09:00'
...
The [iOS API documentation](/docs/mobile-monitoring/mobile-sdk-api/new-relic-mobile-sdk-api/working-ios-sdk-api#custom-att-events) includes details on sending custom events and attributes to Insights.
