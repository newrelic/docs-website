...
releaseDateTime: '2016-08-04 16:00'
releaseVersion: 5.7.0
downloadLink: >-
  https://download.newrelic.com/android_agent/ant/NewRelic_Android_Agent_5.7.0.zip
---

### New in this release

* We are pleased to announce support for Dexguard.
  * Full build time compatibility with _Dexguard version 7.2.04 or higher_
...
* _The Android agent now requires_ _Proguard version 5.0 or higher for Proguard support_
