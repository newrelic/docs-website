...
releaseDateTime: '2017-10-02 09:15'
releaseVersion: '1059'
downloadLink: ''
---
...
**This Browser agent version has been temporarily removed; the most up-to-date version is currently [agent version 1044](https://docs.newrelic.com/docs/release-notes/new-relic-browser-release-notes/browser-agent-release-notes/browser-agent-v1044).**
