...
releaseDateTime: '2016-11-03 13:00'
releaseVersion: v998
downloadLink: ''
---
...
For details on how and why to use this API, see our [Browser SPA API Docs](https://docs.newrelic.com/docs/browser/new-relic-browser/browser-agent-apis/report-data-events-browser-agent-api#spa-api)
