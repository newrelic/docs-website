...
<Table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        * For individual frame info: Next to the frame's source line and column, mouse over the <Icon name="more-horizontal"/>
          ellipsis.
