...
Additional documentation resources include the [Page views page](/docs/browser/new-relic-browser/dashboard-details/page-views-dashboard) (details about end users' overall experience with your site).
