...
* To record external HTTP and datastore [transactions](https://docs.newrelic.com/docs/apm/applications-menu/monitoring/transactions-page).
* To link external transactions between two applications running New Relic agents (known as [cross application tracing](https://docs.newrelic.com/docs/apm/transactions/cross-application-traces/cross-application-tracing) or CAT).
