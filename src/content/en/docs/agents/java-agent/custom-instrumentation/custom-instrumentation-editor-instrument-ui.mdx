...
3. Expand individual methods to locate uninstrumented <i className="fa fa-circle-o" style={{color: '#307099'}}><span>[circle-o]</span></i>
   methods.
...
<Table>
  ...
  <tbody>
    <tr id="disable">
      ...
      <td>
        * Select <i className="fa fa-ban" style={{color: '#55555A'}}><span>[ban-circle]</span></i>
