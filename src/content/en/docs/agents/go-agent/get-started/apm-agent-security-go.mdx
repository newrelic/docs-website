  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        By default, the agent records events sent to the Insights custom events API using [`RecordCustomEvent`](/docs/agents/go-agent/features/create-custom-events-insights-go). If you enable [high security mode](#restricted), this is automatically set to `false`.
      </td>
    </tr>
  </tbody>
</Table>
