...
* [Python agent attributes](/docs/agents/python-agent/attributes/python-agent-attributes) (summary of attributes captured by the Python agent)
* [Enabling and disabling attributes](/docs/agents/python-agent/attributes/enabling-disabling-attributes-python) (configuration settings, rules, and backwards compatibility information for Python agent attributes)
