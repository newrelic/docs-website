...
1. [Go to the <DoNotTranslate>**Alert Quality Management**</DoNotTranslate> instant observability page.](https://newrelic.com/instant-observability/alert-quality-management)
1. Click on the <DoNotTranslate>**Install now**</DoNotTranslate> button.
