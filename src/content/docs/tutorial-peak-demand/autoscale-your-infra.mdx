...
* A place to run commands for the tutorial.
    ...
    <Step>
        ...
        * Check <DoNotTranslate>**Instant service-level insights**</DoNotTranslate>, <DoNotTranslate>**Full-body requests**</DoNotTranslate>, and <DoNotTranslate>**Application profiles through Pixie**</DoNotTranslate> to enable Pixie.
    ...
    <Step>
        ...
        You should test your query before sending metrics to the autoscaler from New Relic. Go to <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com) > Query your Data**</DoNotTranslate>, then copy and paste the following NRQL query:
