...
* Network egress from your app to `otlp.nr-data.net` (US) or `otlp.eu01.nr-data.net` (EU) on port 443. For the full list of endpoints, supported ports, and compression settings, see [Send data to New Relic using OpenTelemetry Protocol (OTLP)](/docs/opentelemetry/best-practices/opentelemetry-otlp/).
