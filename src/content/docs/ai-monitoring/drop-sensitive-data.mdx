...
<Callout variant="important">
  ...
  As of May 21, 2025, new customers will no longer be able to use NRQL drop rules through the AI Monitoring UI. Instead, use [New Relic Pipeline Control](/docs/new-relic-control/pipeline-control/overview), which offers Pipeline cloud rules as a replacement for NRQL drop rules. The pipeline gateway can also assist with data management.
