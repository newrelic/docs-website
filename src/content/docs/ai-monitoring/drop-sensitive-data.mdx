...
Drop filters evaluate data sent by the agent and removes sensitive data before it's stored in NRDB. This lets you still analyze an interaction with your AI app without storing your customer's personal data in our databases. 
...
* Want to adjust your data ingest? [Learn about how to configure AI monitoring](/docs/ai-monitoring/configure-ai-monitoring). 
