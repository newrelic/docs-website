...
<Callout variant="important">
  As of May 21, 2025, new customers can no longer use NRQL drop rules via the AI Monitoring UI. Leverage [New Relic Pipeline Control](/docs/new-relic-control/pipeline-control/overview). Pipeline cloud rules are the direct replacement of NRQL drop rules, and pipeline gateway can also help manage data. 
