...
The model inventory page provides insight into the overall performance and usage of your AI models. From the overview tab, you can explore the number of requests made to a model against its response times, or you can analyze time series graphs that show you how your model's behavior changes. Each subsequent tab gives you more detailed information about errors, performance, and cost across all your AI models.

By scoping to the model itself, you get a better sense of how the model processes prompts when it makes a completion. Model inventory shows you data about calls made to your model, so you can understand how your models affect your AI app.
