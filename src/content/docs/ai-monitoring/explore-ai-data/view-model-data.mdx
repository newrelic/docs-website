...
* The 95th percentile, or **p95**, indicates the number of transactions that were below a certain value during a time period. If you've selected p95 and see that a call at 9:00pm took six seconds to complete, it means that 95% of all calls were below six seconds, but 5% of calls were above six seconds.
* The 99th percentile, or **p99**, indicates that 99% of calls or transactions were below a given value during a time window. Inversely, it means 1% of transactions were above that window. 
