...
1. Adjust the time picker. You can choose different time windows between your two models. 
...
The model performance category takes standard app performance data and places them in a comparison view. 
