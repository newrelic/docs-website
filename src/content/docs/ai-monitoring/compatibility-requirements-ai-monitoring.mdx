...
AI monitoring is compatible with Python and Node.js AI apps deployed with NVIDIA NIM. The integration allows you to instrument your AI-powered apps and collect data about models supported by NVIDIA NIM, even if those models aren't yet directly supported by AI monitoring. 
