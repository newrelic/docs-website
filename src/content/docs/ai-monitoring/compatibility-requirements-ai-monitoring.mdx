...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        * See full list of [AI libraries supported by the Java agent](/docs/apm/agents/java-agent/getting-started/compatibility-requirements-java-agent/#ai-monitoring)
      </td>
    </tr>
