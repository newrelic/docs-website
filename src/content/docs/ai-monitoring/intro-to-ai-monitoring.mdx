...
AI Monitoring directs an APM agent to collect data about payloads delivered to and from supported AI providers. A payload encompasses instructions that control your AI's behavior: event data that contains prompts from your end user and responses from your model, trace data about calls and methods within your app environment, and standard performance metrics. With AI monitoring, you can:
