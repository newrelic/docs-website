...
AI monitoring is our application monitoring (APM) for AI solution. When you enable AI monitoring, our APM agents can give you end-to-end visibility into performance, cost, and quality of your OpenAI, BedRock, or other [supported models](/docs/ai-monitoring/compatibility-requirements-ai-monitoring). AI apps for app and model performance, costs, and response quality. Explore how users interact with an AI assistant, dig into trace-level details about a model's response to an AI event, or compare the performance of different models across app environments. 
...
You can access all this information from the New Relic platform, make comparisons across apps and models, and create dashboards to help you manage your AI data effectively.
