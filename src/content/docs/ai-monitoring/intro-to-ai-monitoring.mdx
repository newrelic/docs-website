...
* If your prompt engineers updated prompt parameters for your AI, you can [track whether token usage spiked or dropped after the update](). Use AI monitoring to help you make decisions that keep costs down.  
...
When you're ready, use our doc to [manually install AI monitoring](/docs/install/ai-monitoring). This doc directs you to the relevant procedures for installing an APM agent, then walks you through configuring the agent for AI monitoring. 