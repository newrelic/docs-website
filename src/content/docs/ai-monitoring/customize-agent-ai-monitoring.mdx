...
AI monitoring is not [FedRAMP compliant](/docs/security/security-privacy/compliance/fedramp-compliant-endpoints). If you're a FedRAMP customer, we do not recommend enabling AI monitoring for the APM agents.
</Callout>
