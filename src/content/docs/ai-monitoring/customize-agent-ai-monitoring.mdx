...
<CollapserGroup>
    ...
    >
        Refer to our API docs for [`recordLlmFeedbackEvent(params)`](https://newrelic.github.io/node-newrelic/API.html#recordLlmFeedbackEvent)
    </Collapser>
    <Collapser
    ...
    >
        Refer to our API docs for [`NewRelic::Agent.set_llm_token_count_callback`](/docs/apm/agents/ruby-agent/api-guides/ai-monitoring). 
    </Collapser>
</CollapserGroup>
...
<CollapserGroup>
    ...
    Refer to our API docs for:
        ...
        * [`setLlmTokenCountCallback(callback)`](https://newrelic.github.io/node-newrelic/API.html#setLlmTokenCountCallback)
    ...
    Refer to our API docs for:
        ...
        * [`newrelic.agent.current_trace_id()`](/docs/apm/agents/python-agent/python-agent-api/currenttraceid-python-agent-api)
