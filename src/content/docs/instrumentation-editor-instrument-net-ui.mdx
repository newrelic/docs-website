...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM > (select a .NET app) > Settings > Instrumentation:** The **Instrumentation** editor provides an easy way to view or edit your custom instrumentation in the UI. This XML example shows the assembly name, class name, and method name.
</figcaption>
