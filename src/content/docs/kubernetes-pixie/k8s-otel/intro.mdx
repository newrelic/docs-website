...
OpenTelemetry observability for Kubernetes provides complete, open-source setup paired with a top-notch Kubernetes UI that is already compatible with our [proprietary Kubernetes instrumentation](/docs/kubernetes-pixie/kubernetes-integration/get-started/introduction-kubernetes-integration). Our Kubernetes UIs are designed to be provider agnostic, allowing you to select either OpenTelemetry or New Relic instrumentation based on your needs.
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        <td></td>
        <td>`hostmetrics`</td>
        <td>Scrapes metrics from the underliying node.</td>
      ...
      <tr>
        <td></td>
        <td>`filter`</td>
        <td>Optimize ingest by removing not relevant telemetry.</td>
        <td>[`Daemonset`](https://github.com/newrelic/helm-charts/blob/master/charts/nr-k8s-otel-collector/templates/daemonset-configmap.yaml), [`Deployment`](https://github.com/newrelic/helm-charts/blob/master/charts/nr-k8s-otel-collector/templates/deployment-configmap.yaml)</td>
      </tr>
      <tr>
        <td></td>
        <td>`resource`</td>
        <td>Apply changes on resource attributes.</td>
        <td>[`Daemonset`](https://github.com/newrelic/helm-charts/blob/master/charts/nr-k8s-otel-collector/templates/daemonset-configmap.yaml), [`Deployment`](https://github.com/newrelic/helm-charts/blob/master/charts/nr-k8s-otel-collector/templates/deployment-configmap.yaml)</td>
      </tr>
      <tr>
        <td></td>
      ...
      <tr>
        ...
        <td>Transform cumulative metrics to delta.</td>
        <td>[`Daemonset`](https://github.com/newrelic/helm-charts/blob/master/charts/nr-k8s-otel-collector/templates/daemonset-configmap.yaml), [`Deployment`](https://github.com/newrelic/helm-charts/blob/master/charts/nr-k8s-otel-collector/templates/deployment-configmap.yaml)</td>
      </tr>
      <tr>
        <td></td>
