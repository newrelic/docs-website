...
If your provider is OpenShift and you would like `receivers.filelog` to be enabled (the default), please make the following updates to `daemonset.containerSecurityContext`:
```yaml
  privileged: true
