...
To fetch additional metrics, you can add new pipelines and configuring the appropriate [receivers and processors](/docs/kubernetes-pixie/k8s-otel/intro/#otel-components) in your [`values.yaml`](/docs/kubernetes-pixie/k8s-otel/install/#config-params) file using the `extraConfig` section.
...
<DocTiles>
  <DocTile title="Install OpenTelemetry Collector on Kubernetes" path="/docs/kubernetes-pixie/k8s-otel/install/">
