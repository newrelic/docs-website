  ...
  <table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>Map (key-value)</td>
            <td>Sets the security context at the container level for the Daemonset. This parameter overrides global container security contexts. This chart defaults to `privileged: false`.</td>
