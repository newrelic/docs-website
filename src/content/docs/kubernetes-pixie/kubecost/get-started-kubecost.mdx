...
6. Wait a few minutes. In the previous tab where you set up Remote Write, click the <DoNotTranslate>**See your data**</DoNotTranslate> button to see whether data has been received.
7. Query your data:
