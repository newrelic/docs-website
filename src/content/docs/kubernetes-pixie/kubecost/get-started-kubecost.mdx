...
You will need to create a `Remote Write` endpoint in New Relic, which you can do by clicking the Green "Add Prometheus Data" botton on this page. Note that the bearer token will be used.
