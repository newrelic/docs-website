...
* [Explore Pixie data](/docs/kubernetes-pixie/auto-telemetry-pixie/understand-use-data/explore-pixie-data) persisted in New Relic using the Kubernetes cluster explorer and [Pixie entities](/docs/kubernetes-pixie/auto-telemetry-pixie/understand-use-data/explore-pixie-data#inspect-requests).
* [Inspect full-body application request and responses](/docs/kubernetes-pixie/auto-telemetry-pixie/understand-use-data/pixie-entities)
...
To learn how to use Pixie data to monitor service health and networking issues, see pod application CPU profiles, inspect full-body requests and more, check out the [Explore Pixie data](/docs/kubernetes-pixie/auto-telemetry-pixie/understand-use-data/explore-pixie-data) section.
...
You can [configure which Pixie data is persisted](#pixie-configure-storage) in New Relic, including persisting additional Pixie telemetry data.
