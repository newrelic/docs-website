...
import pixieHybridStorage from 'images/pixie-integration-hybrid-storage-update.png'
...
When you install Pixie using New Relic's Guided Install, the New Relic plugin for Pixie is automatically enabled and your auto-telemetry data is stored in two locations.
