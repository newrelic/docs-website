...
<figcaption>
  The New Relic Pixie integration hybrid storage model. You can interact with both sets of data from New Relic's UI.
</figcaption>
...
* HTTP/2 golden metrics (throughput, latency, error rate)
* HTTP/2 request spans
