...
You can use Pixie to inspect the full-body requests and responses made by your applications for [select protocols](/docs/kubernetes-pixie/auto-telemetry-pixie/understand-use-data/overview/#pixie-long-term-storage), including DNS, Cassandra, MySQL, PostgreSQL, Redis, AMQP, and Kafka.
...
The **Summary** view opens when you select an item from the **DNS - Pixie** entity list. This view shows graphs of the response time, throughput, and error rate, as well as a sample of the full-body DNS requests made by this service.
