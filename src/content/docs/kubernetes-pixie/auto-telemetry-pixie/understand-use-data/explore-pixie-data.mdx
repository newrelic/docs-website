...
* [Inspect full-body requests](#inspect-requests)
...
You can use Pixie to inspect the full-body requests and responses made by your applications for [select protocols](/docs/kubernetes-pixie/auto-telemetry-pixie/understand-use-data/overview/#pixie-long-term-storage).

Prototocls traced by Pixie show up under the **Other entities** section of the **All entities** page:
...
<Callout variant="important">
  If you are missing any of these Pixie entities, check your [Customize Pixie Ingest](/docs/kubernetes-pixie/auto-telemetry-pixie/understand-use-data/overview/#pixie-configure-storage) configuration to make sure you haven't disabled ingest for a protocol.
</Callout>

Selecting an item from the **DNS - Pixie** entity list will open the **Summary** view which shows graphs of the response time, throughput and error rate as well as a sample of the full-body DNS requests made by this service.
