...
The following sections show how to configure reduced ingest during installation of Pixie. You can also reduce ingest after installation by [disabling select Pixie export scripts](/docs/kubernetes-pixie/auto-telemetry-pixie/understand-use-data/overview/#pixie-configure-storage).
</Callout>
