---
title: Custom <DNT>Docker/DNT> image registry
tags:
  ...
  - Kubernetes
  - Manage Pixie data
metaDescription: How to use a custom <DNT>Docker/DNT> image registry with Pixie
freshnessValidatedDate: never
---

You can use Pixie if your environment requires the use of a custom <DNT>Docker/DNT> image registry.
