...
## Writing a Custom PxL Script

This topic is covered in detail in Pixie's documentation [here](https://docs.px.dev/tutorials/integrations/otel/#write-the-pxl-script).

Pixie has also published a [YouTube video](https://www.youtube.com/watch?v=WXY6vhnqpyc) covering this topic as well.