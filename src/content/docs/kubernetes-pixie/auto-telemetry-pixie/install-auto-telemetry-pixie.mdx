...
To get up and running with Auto-telemetry with Pixie, start with our [guided install](https://one.newrelic.com/nr1-core?state=797d48ab-b066-d3da-f4d5-652bb92e5ce9). The guided install deploys Pixie with Kubernetes integration of New Relic on your cluster. You don't need to do any further configuration or installation to start using Pixie.
