...
The Pixie integration is installed as part of New Relic’s Kubernetes integration. To upgrade the Kubernetes integration, follow the directions [here](/docs/kubernetes-pixie/kubernetes-integration/installation/kubernetes-integration-install-configure#update). Make sure to select the checkbox for “Pixie is already running in this cluster”.
