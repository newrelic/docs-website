...
* Make sure you have sufficient memory: Pixie requires, at least, 2Gb of memory on each node in your cluster. More memory may be required for larger clusters.
