...
2. Select the account you want to use for the guided install, and click <DoNotTranslate>**Continue**</DoNotTranslate>.
   Note: if you have a single account, you won't see this option.
3. Complete the remaining fields and click <DoNotTranslate>**Continue**</DoNotTranslate> to complete the remainder of the installation.
...
2. Click <DoNotTranslate>**Continue**</DoNotTranslate>.

3. Select the data you want to gather, observe, and debug, and click <DoNotTranslate>**Continue**</DoNotTranslate>.

4. On the <DoNotTranslate>**Choose install method**</DoNotTranslate> page, select either <DoNotTranslate>**Helm**</DoNotTranslate> or <DoNotTranslate>**manifest**</DoNotTranslate>.
...
5. Click <DoNotTranslate>**Continue**</DoNotTranslate> to open the <DoNotTranslate>**Listening for data**</DoNotTranslate> page.

6. When you get the message, <DoNotTranslate>**See your data**</DoNotTranslate>, click <DoNotTranslate>**Kubernetes Cluster Explorer**</DoNotTranslate> to see your cluster.
