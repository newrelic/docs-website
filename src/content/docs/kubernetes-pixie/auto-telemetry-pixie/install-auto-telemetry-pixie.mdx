...
You can determine your Pixie integration version following the steps [here](/docs/kubernetes-pixie/auto-telemetry-pixie/troubleshooting/get-pixie-integration-version).

The Pixie integration is installed as part of New Relic’s Kubernetes integration. To upgrade the Kubernetes integration, follow the directions [here](/docs/kubernetes-pixie/kubernetes-integration/installation/kubernetes-integration-install-configure#update).

## Uninstall the Pixie integration [#uninstall]

The Pixie integration is installed as part of New Relic’s Kubernetes integration. To uninstall the Kubernetes integration follow the directions [here](/docs/kubernetes-pixie/kubernetes-integration/installation/kubernetes-integration-install-configure#uninstall).
