...
The data you view on the <DoNotTranslate>**Live debugging**</DoNotTranslate> tab comes through Community Cloud for Pixie, and is therefore potentially sensitive. It is not stored by New Relic and is ephemeral and queryable for less than 24 hours.
