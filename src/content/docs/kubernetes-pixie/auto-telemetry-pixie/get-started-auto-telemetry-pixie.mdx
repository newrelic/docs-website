...
<figcaption>
  Visualize your application's dependencies using the <DoNotTranslate>**Service map**</DoNotTranslate> created from Pixie's HTTP traces.
</figcaption>
...
<figcaption>
  Run scripts in the <DoNotTranslate>**Live debugging with Pixie**</DoNotTranslate> tab to debug your Kubernetes applications.
</figcaption>
