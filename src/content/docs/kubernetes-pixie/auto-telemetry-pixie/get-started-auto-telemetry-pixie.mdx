...
import pixieServiceGraph from 'images/pixie_screenshot-crop_service-graph.png'

import pixieServiceOtelMap from 'images/pixie_screenshot-crop_service-otel-map.png'

import pixieKcePodDetails from 'images/pixie_screenshot-crop_kce-pod-details.png'

import pixieFlamegraph from 'images/pixie_screenshot-crop_flamegraph.png'

import pixieLiveDebugging from 'images/pixie_screenshot-crop_live-debugging.png'
