...
Inspect full-body requests and responses made by your applications for select protocols including DNS, Cassandra, MySQL, PostgreSQL, Redis, Kafka and AMQP.
...
<figcaption>
  Pixie entities show up under the Other Entities section.
</figcaption>

Select a Pixie entity to see golden signals (response time, throughput, and error rate) as well as a sample of the full-body requests made by a specific service.
