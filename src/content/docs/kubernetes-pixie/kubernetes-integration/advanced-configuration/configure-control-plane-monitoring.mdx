...
Clusters deployed leveraging Rancher Kubernetes Engine (RKE1) run control plane components as <DNT>Docker/DNT> containers, and not as Pods managed by the Kubelet. 
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            <DNT>**Kubeadm / Kops / ClusterAPI**</DNT>
