...
<Callout variant="tip">
  Unless otherwise specified, this page refers to the [Kubernetes integration v3](/docs/kubernetes-pixie/kubernetes-integration/advanced-configuration/k8s-version2/changes-since-v3). Details on how to configure control plane monitoring for v2 can be found in a specific section below.
</Callout>
...
See [Monitoring control plane with integration version 2](/docs/kubernetes-pixie/kubernetes-integration/advanced-configuration/k8s-version2/k8s-version2/#monitoring-control-plane), if you're using v2.
...
See [OpenShift configuration on Integration version 2](/docs/kubernetes-pixie/kubernetes-integration/advanced-configuration/k8s-version2/k8s-version2/#openshift-configuration), if you're using v2.
