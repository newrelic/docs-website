---
title: Kubernetes Integration on Hybrid cluster with Windows and Linux nodes
tags:
  - Kubernetes
  - Windows
  - Linux
  - Installation
metaDescription: "How to install New Relic to a hybrid Windows and Linux Kubernetes cluster."
