...
import kubernetesFargateOverview from 'images/kubernetes_diagram_fargate-overview.png'

import kubernetesFargateWorkflow from 'images/kubernetes_diagram_fargate-workflow.png'
