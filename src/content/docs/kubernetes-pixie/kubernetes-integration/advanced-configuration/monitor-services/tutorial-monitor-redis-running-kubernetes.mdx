...
If there are no errors, you should see Redis data in the Infrastructure UI. To find the Redis dashboards, go to **[one.newrelic.com](https://one.newrelic.com) > Infrastructure > Third party services**, and select the **Redis** dashboard.
