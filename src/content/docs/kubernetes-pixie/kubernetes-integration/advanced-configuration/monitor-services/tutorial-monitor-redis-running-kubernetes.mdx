...
If there are no errors, you should see Redis data in the infrastructure UI. To find the Redis dashboards, go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > Third party services**, and select the **Redis** dashboard.
