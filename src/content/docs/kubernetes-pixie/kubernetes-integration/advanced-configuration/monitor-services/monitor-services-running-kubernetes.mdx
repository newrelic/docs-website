...
If you have services that run on Kubernetes, and those services can be monitored by our one of our [infrastructure agent integrations](/docs/infrastructure/host-integrations/installation/install-infrastructure-host-integrations) (Cassandra, Redis, MySQL, Apache, and more), you can enable those integrations via our Kubernetes integration. 

## Get started [#overview]

Our Kubernetes integration comes bundled with our [infrastructure agent integrations](/docs/infrastructure/host-integrations/installation/install-infrastructure-host-integrations). This lets you get data for those services by adding a section to the Kubernetes integration's configuration, which lives as a ConfigMap inside a manifest.
...
* A Kubernetes cluster running the Kubernetes integration, version 1.16.0 or higher ([install](/docs/integrations/kubernetes-integration/installation/kubernetes-installation-configuration) \| [check version](/docs/integrations/kubernetes-integration/installation/kubernetes-installation-configuration#update) \| [update](/docs/integrations/kubernetes-integration/installation/kubernetes-installation-configuration#update)).
* A [supported service](/docs/infrastructure/host-integrations/installation/install-infrastructure-host-integrations#overview) running on ECS that meets our requirements. 
...
Monitoring services in Kubernetes works by leveraging our [infrastructure agent integrations](/docs/infrastructure/host-integrations/installation/install-infrastructure-host-integrations) and an autodiscovery mechanism to point them to pods with a specified selector.
