...
Monitoring services in Kubernetes works by leveraging our [core on-host integrations] and an autodiscovery mechanism to point them to pods with a specified selector.
