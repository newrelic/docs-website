...
Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure**</DoNotTranslate>, select <DoNotTranslate>**Third party services**</DoNotTranslate>, and then select the service's dashboard. You should see data being reported.
