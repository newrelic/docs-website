...
See an example of configuration for version 2 [here](/docs/kubernetes-pixie/kubernetes-integration/advanced-configuration/k8s-version2/k8s-version2/#enable-services).
...
<Callout variant="tip">
  This format applies to the [Kubernetes integration v3](/docs/kubernetes-pixie/kubernetes-integration/advanced-configuration/k8s-version2/changes-since-v3). For the older v2 version, check the section [below](#configure-values-v2).
</Callout>
...
In order for the snippet above to be recognized by the integration, it must be placed inside the designated ConfigMap. If you're using our [Kubernetes integration v3](/docs/kubernetes-pixie/kubernetes-integration/advanced-configuration/k8s-version2/changes-since-v3), a ConfigMap should already be generated, with a name ending in `-integrations-cfg`. 

For the Kubernetes Integration version 2, see [these instructions](/docs/kubernetes-pixie/kubernetes-integration/advanced-configuration/k8s-version2/k8s-version2/#add-service-yaml).
...
If you are using our [Kubernetes integration v3](/docs/kubernetes-pixie/kubernetes-integration/advanced-configuration/k8s-version2/changes-since-v3), this ConfigMap will already be mounted in the required container.
