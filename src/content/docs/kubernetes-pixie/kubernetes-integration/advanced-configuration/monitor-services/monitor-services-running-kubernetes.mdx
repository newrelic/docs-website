...
Go to **[one.newrelic.com](https://one.newrelic.com) > Infrastructure**, select **Third party services**, and then select the service's dashboard. You should see data being reported.
