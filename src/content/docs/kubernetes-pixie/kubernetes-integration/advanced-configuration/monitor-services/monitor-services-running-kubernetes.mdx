...
You can learn more about how to find and use your Kubernetes data [here](/docs/kubernetes-pixie/kubernetes-integration/understand-use-data/find-use-your-kubernetes-data/) and you can review our K8sServiceSample data schema [here](https://docs.newrelic.com/attribute-dictionary/?event=K8sServiceSample).
