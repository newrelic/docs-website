...
* A [Kubernetes cluster running a supported version](/docs/kubernetes-pixie/kubernetes-integration/get-started/kubernetes-integration-compatibility-requirements).
* A Kubernetes cluster running the Kubernetes integration ([install](/docs/integrations/kubernetes-integration/installation/kubernetes-installation-configuration) \| [check version](/docs/integrations/kubernetes-integration/installation/kubernetes-installation-configuration#update) \| [update](/docs/integrations/kubernetes-integration/installation/kubernetes-installation-configuration#update)).
...
See [this example of configuration for version 2](/docs/kubernetes-pixie/kubernetes-integration/advanced-configuration/k8s-version2/overview/#enable-services).
...
<Callout variant="tip">
  This format applies to the [Kubernetes integration v3](/docs/kubernetes-pixie/kubernetes-integration/advanced-configuration/k8s-version2/changes-since-v3). For the older v2 version, see [Monitor services running on Kubernetes](/docs/kubernetes-pixie/kubernetes-integration/advanced-configuration/k8s-version2/overview/#monitor-services).
</Callout>
...
<Callout variant="tip">
  Notice we are specifying `--tls --port 10250`. Earlier versions of the integration might have worked without this, as of [version 3](/docs/kubernetes-pixie/kubernetes-integration/advanced-configuration/k8s-version2/changes-since-v3) of the Kubernetes integration it is mandatory to specify them. The reason for this change is that the integration now connects to the Kubelet using the nodeIP rather than `localhost`, with the former requiring TLS while the latter did not.
</Callout>
...
Go to <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure**</DNT>, select <DNT>**Third party services**</DNT>, and then select the service's dashboard. You should see data being reported.
...
The integration will recognize the above snippet, if you place it inside a designated `ConfigMap`. If you're using our [Kubernetes integration v3](/docs/kubernetes-pixie/kubernetes-integration/advanced-configuration/k8s-version2/changes-since-v3), a `ConfigMap` with a name ending in `-integrations-cfg` should already exist.

If you're using Kubernetes integration version 2, see [Add a service YAML](/docs/kubernetes-pixie/kubernetes-integration/advanced-configuration/k8s-version2/overview/#add-service-yaml).
...
If you're using our [Kubernetes integration v3](/docs/kubernetes-pixie/kubernetes-integration/advanced-configuration/k8s-version2/changes-since-v3), this `ConfigMap` will already be mounted in the required container.
...
You can learn more about how to find and use your Kubernetes data [here](/docs/kubernetes-pixie/kubernetes-integration/understand-use-data/find-use-your-kubernetes-data/) and you can review our K8sServiceSample data schema [here](/attribute-dictionary/?event=K8sServiceSample).
