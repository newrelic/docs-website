...
Check out some solutions to the most common Kubernetes integration errors in version 2. These errors show up in the standard non-verbose infrastructure agent logs. If you need more detailed logs working with New Relic support, for example, see [Kubernetes logs](/docs/kubernetes-pixie/kubernetes-integration/troubleshooting/get-logs-version/).
