...
<Callout variant="important">
  ...
  To enable monitoring for your Windows nodes, use the [guided install process.](/src/install/kubernetes/intro) This process supports both Linux and Windows nodes, allowing hybrid cluster installations by default.
</Callout>
