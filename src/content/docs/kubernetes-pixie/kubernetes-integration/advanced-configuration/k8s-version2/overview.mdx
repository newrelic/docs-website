...
<Callout variant="caution">
  Keep in mind that we've deprecated version 2 and you should not use it. We maintain this documentation for users who are still using version 2, but v2 is no longer supported. 
