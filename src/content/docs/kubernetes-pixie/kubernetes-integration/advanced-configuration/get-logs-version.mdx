...
If you're using version 2 of the integration, see [Kubernetes logs in version 2](/docs/kubernetes-pixie/kubernetes-integration/advanced-configuration/k8s-version2/k8s-version2/#logs-version2)
