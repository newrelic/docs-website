...
#### How can I know which namespaces are excluded and which not?

All the namespaces within the cluster are listed thanks to the K8sNamespace sample. The attribute nrFiltered determines if the data related to the namespace is going to be scraped or not.
