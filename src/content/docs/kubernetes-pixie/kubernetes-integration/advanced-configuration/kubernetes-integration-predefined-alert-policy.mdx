...
When deploying the New Relic Kubernetes integration for the first time in an account, we deploy a default set of [pre-built alert policies](/install/kubernetes/#add-pre-built-alert-policies) to your account. The pre-defined alert policies doesn't have a [notification channel](/docs/apis/nerdgraph/examples/nerdgraph-api-notifications-channels/) by default to prevent unwanted notifications.
...
2. Select <DNT>**Alerts**</DNT> to access the pre-built resources. 
    ...
    <img
      ...
      alt="Add Kubernetes alerts"
        rc="/images/kubernetes_screenshot-crop_add-alerts.webp"
    />
...
<CollapserGroup>
    ...
    >
      This alert condition generates an alert when a container is being throttled > 25% of the time for more than 5 minutes. It runs this query:
    ...
    >
      This alert condition generates an alert when the average container CPU utilization versus limit is > 90% for more than 5 minutes. It runs this query:
    ...
    >
      This alert condition generates an alert when the average container memory utilization versus limit is > 90% for more than 5 minutes. It runs this query:
    ...
    >
      This alert condition generates an alert when the container restart count is greater than 0 in a sliding 5 minute window. It runs this query:
