...
When you [install your Kubernetes cluster with OpenTelemetry](/docs/kubernetes-pixie/kubernetes-integration/installation/k8s-otel/#install), you're automatically deploying the collector as an agent. You'll have the Kubernetes metadata in the APM telemetry and the Kubernetes UIs.

<Callout variant="tip">
  If you prefer to configure it manually, see [How to manually configure and deploy the OpenTelemetry collector as an agent](#agent-manually)
</Callout>
...
## How to manually configure and deploy the OpenTelemetry collector as an agent [#agent-manually]

If you prefer to follow a manual configuration, follow these instructions:

<CollapserGroup>
    <Collapser
        id="otlp-exporter"
        title="Configure the OTLP exporter"
    >
    ...
    <Collapser
        id="batch"
        title="Configure the batch processor"
    >
    ...
    <Collapser
        id="resource-detection"
        title="Configure the resource detection processor"
    >
    ...
    * `host.type`
    ...
    <Collapser
        id="attributes-general"
        title="Configure the Kubernetes Attributes processor (general)"
    >
    ...
    <Collapser
        id="rbac"
        title="Configure the Kubernetes Attributes processor (RBAC)"
    >
    ...
    <Collapser
        id="discovery-filter"
        title="Configure the Kubernetes Attributes processor (discovery filter)"
    >
