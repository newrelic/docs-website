...
* **Manual configuration and deployment**: If you prefer to configure it manually, follow these instructions:
  ...
  For help configuring the collector, see the sample collector configuration file, along with the sections about setting up these options:
