...
To be successful with the steps below, you should already be familiar with OpenTelemetry and Kubernetes and have done the following:
  ...
  * Created the following environment variables:
      * `OTEL_EXPORTER_OTLP_ENDPOINT` ([New Reic endpoint for your region or purpose](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/opentelemetry-setup/#review-settings))
