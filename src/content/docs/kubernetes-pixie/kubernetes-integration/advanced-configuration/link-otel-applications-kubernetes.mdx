...
To be successful with the steps below, you should already be familiar with OpenTelemetry and Kubernetes and have done the following:
  ...
  * Created the following environment variables:
      ...
      * `NEW_RELIC_API_KEY` ([license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key))
...
First, configure it by adding an OTLP exporter to your [OpenTelemetry collector configuration YAML file](https://opentelemetry.io/docs/collector/configuration/) along with your New Relic [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) as a header.
