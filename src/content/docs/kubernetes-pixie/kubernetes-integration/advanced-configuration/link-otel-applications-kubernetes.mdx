...
First, configure it by adding an OTLP exporter to your [OpenTelemetry collector configuration YAML file](https://opentelemetry.io/docs/collector/configuration/) along with your New Relic <LicenseKey/> as a header.
