...
<DocTile path="/docs/kubernetes-pixie/kubernetes-integration/installation/k8s-prebuilt-alert-policies">Check our Kubernetes pre-built alert policies</DocTile>
