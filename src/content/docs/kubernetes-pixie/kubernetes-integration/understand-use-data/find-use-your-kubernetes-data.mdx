...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Delta change of number of times the container has been restarted (requires k8s 1.23+).
      </td>
    </tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Number of stored objects at the time of last check, split by kind (alpha; deprecated in Kubernetes 1.22).
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Maximal number of currently used inflight request limit of the apiserver per request kind in the last second (requires k8s v1.23+).
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Number of pending pods, by the queue type (requires k8s v1.23+).
      </td>
    </tr>
  </tbody>
</table>
