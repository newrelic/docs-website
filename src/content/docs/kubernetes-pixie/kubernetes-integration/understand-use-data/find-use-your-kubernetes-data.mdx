...
<Callout variant="important">
  `InternalK8sCompositeSample` is an event that New Relic generates and it's quite critical for some of our interfaces. While the other events listed out in the table are billable, `InternalK8sCompositeSample` is a non-billable event. 
</Callout>
