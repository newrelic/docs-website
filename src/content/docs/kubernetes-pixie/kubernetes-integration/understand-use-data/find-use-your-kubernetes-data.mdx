...
After having installed our Kubernetes integration, you can check our detailed [Find and use your Kubernetes data](/docs/integrations/kubernetes-integration/understand-use-data/) pages.
