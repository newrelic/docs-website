...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Dashboards**</DoNotTranslate>: Using the [query builder](/docs/chart-builder/use-chart-builder/get-started/introduction-chart-builder) you can query your Kubernetes data and create clear visualizations.
</figcaption>
...
Kubernetes data is attached to the following [events](/docs/using-new-relic/data/understand-data/new-relic-data-types#event-data). You can learn more about this data in [our data dictionary](/attribute-dictionary/?dataSource=Kubernetes).
...
To learn more about these events and their attributes, see [our data dictionary](/attribute-dictionary/?dataSource=Kubernetes).
...
You can be notified about <InlinePopover type="alerts" /> and incidents for your Kubernetes data:
...
<CollapserGroup>
  ...
  >
    ...
    1. Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Settings > Alerts & AI > Kubernetes**</DoNotTranslate>, then select <DoNotTranslate>**Create alert condition**</DoNotTranslate>.
    2. To filter the alert to Kubernetes entities that only have the chosen attributes, select <DoNotTranslate>**Filter**</DoNotTranslate>.
    3. Select the threshold settings. For more on the <DoNotTranslate>**Trigger an alert when...**</DoNotTranslate> options, see [Alert types](#alert-types).
  ...
  >
    ...
    1. Select the alert type <DoNotTranslate>**Integrations**</DoNotTranslate>.
    2. From the <DoNotTranslate>**Select a data source**</DoNotTranslate> dropdown, select a Kubernetes (K8s) data source.
  </Collapser>
  ...
  >
    ...
    * <DoNotTranslate>**Available pods are less than desired pods**</DoNotTranslate> alerts:

      ```
      K8s:CLUSTER_NAME:PARENT_NAMESPACE:replicaset:REPLICASET_NAME
      ```

    * <DoNotTranslate>**CPU or memory usage**</DoNotTranslate> alerts:
      ...
      <CollapserGroup>
        ...
        >
          For <DoNotTranslate>**Available pods are less than desired pods**</DoNotTranslate> alerts, the ID of the `ReplicaSet` triggering the issue might look like this:
