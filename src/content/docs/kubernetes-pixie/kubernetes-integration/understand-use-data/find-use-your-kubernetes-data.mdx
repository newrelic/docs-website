...
<CollapserGroup>
  ...
  >
    ...
    1. Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Settings > Alerts > Kubernetes**</DoNotTranslate>, then select <DoNotTranslate>**Create alert condition**</DoNotTranslate>.
