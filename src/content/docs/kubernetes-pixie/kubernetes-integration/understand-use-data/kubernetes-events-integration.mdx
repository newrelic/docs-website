...
1. [Navigate to the events page](https://one.newrelic.com): Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Events**.
2. In **Category**, select **kubernetes**.
3. Use the <Icon name="fe-search"/> **Search events** field to look for specific events. To focus on a specific set of events, select or change the filter set. 
...
* **In New Relic**: Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Kubernetes cluster explorer**.
