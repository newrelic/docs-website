...
import kubernetesViewEvents from 'images/kubernetes_screenshot-crop_view-events.webp'

import kubernetesViewEventsCategories from 'images/kubernetes_screenshot-crop_view-events-categories.webp'

import kubernetesSeePodDetails from 'images/kubernetes_screenshot-crop_see-pod-details-link.webp'
...
The Kubernetes events integration is installed by default both when using our [Guided Install](/install/kubernetes/?dropdown1=guided), or when [installing through Helm](/install/kubernetes/?dropdown1=helm).

## View your Kubernetes events [#view-k8s-events]

Once you've successfully installed the Kubernetes event integration, you can view and query your events in New Relic. To view your Kubernetes events, go to <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Kubernetes**</DNT>. Select your cluster and click <DNT>**Kubernetes Events**</DNT> in the left navigation pane.

<img
    title="View your Kubernetes events"
    alt="View your Kubernetes events"
    src={kubernetesViewEvents}
/>
...
<img
    ...
    src={kubernetesViewEventsCategories}
/>
