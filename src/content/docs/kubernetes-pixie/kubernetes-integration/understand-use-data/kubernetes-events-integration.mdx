...
1. [Navigate to the Infrastructure event page](https://one.newrelic.com): Go to **[one.newrelic.com](https://one.newrelic.com) > Infrastructure > Events**.
...
* **In New Relic**: Go to **[one.newrelic.com](https://one.newrelic.com) > Kubernetes cluster explorer**.
