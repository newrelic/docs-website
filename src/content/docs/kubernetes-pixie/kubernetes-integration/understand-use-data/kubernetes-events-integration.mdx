...
1. [Navigate to the events page](https://one.newrelic.com): Go to <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Events**</DNT>.
2. In <DNT>**Category**</DNT>, select <DNT>**kubernetes**</DNT>.
3. Use the <Icon name="fe-search"/> <DNT>**Search events**</DNT> field to look for specific events. To focus on a specific set of events, select or change the filter set. 
...
* <DNT>**In New Relic**</DNT>: Go to <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Kubernetes cluster explorer**</DNT>.

Then, to view the pod details:

1. In the Kubernetes cluster explorer, select a pod.
2. Select <DNT>**Show pod events**</DNT>.
