...
1. [Navigate to the Infrastructure event page](https://one.newrelic.com): Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Events**.
