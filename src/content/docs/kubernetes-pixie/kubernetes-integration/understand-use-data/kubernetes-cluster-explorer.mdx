...
The Kubernetes navigator UI builds upon the concept of [New Relic Navigator](/docs/new-relic-solutions/new-relic-one/core-concepts/new-relic-explorer-view-performance-across-apps-services-hosts/#view-navigator) by enabling users to easily group entities and isolate high resource consumption, capacity issues, and alert status for Pods, DaemonSets, Deployments, StatefulSets, and Nodes.
