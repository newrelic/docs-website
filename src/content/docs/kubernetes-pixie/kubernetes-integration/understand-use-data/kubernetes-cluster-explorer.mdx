...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Kubernetes > Kubernetes dashboard**: The Kubernetes dashboard can be accessed from the Kubernetes cluster explorer. It shows useful Kubernetes metric data.
</figcaption>
