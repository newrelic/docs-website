...
<img
  title="New Relic One - Cluster explorer"
  alt="New Relic One - Cluster explorer"
...
<img
  title="New Relic One - Cluster explorer - Pod alert"
  alt="New Relic One - Cluster explorer - Pod alert"
  src={nr1PodAlert}
/>

<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Kubernetes**: Click any pod to get more information about its status and health, and to dig deeper into application data and traces, logs, and events.
</figcaption>
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Kubernetes > Kubernetes dashboard**: The Kubernetes dashboard can be accessed from the Kubernetes cluster explorer. It shows useful Kubernetes metric data.
</figcaption>
...
<img
  title="New Relic One - Cluster explorer - Search"
  alt="New Relic One - Cluster explorer - Search"
...
<img
  title="New Relic One - Cluster explorer - Time picker and Auto-refresh"
  alt="New Relic One - Cluster explorer - Time picker and Auto-refresh"
