...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Kubernetes > <your cluster> > Overview**: The Kubernetes dashboard can be accessed within the Kubernetes cluster explorer. It shows useful overview data about the status and performance of the cluster and its containerized workloads.
</figcaption>
