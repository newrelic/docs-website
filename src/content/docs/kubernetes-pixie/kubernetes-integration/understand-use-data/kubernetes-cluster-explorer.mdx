...
import nr1ClusterExplorerDashboardDetail from 'images/kubernetes_screenshot-full_cluster-dashboard-detail_1.png'
...
<Callout variant="important">
  ...
  <br />
  The Cluster overview dashbaord does not currently include information about Jobs, CronJobs or PersistentVolumes.  We plan to include more detail around these resources in a future update.
</Callout>
