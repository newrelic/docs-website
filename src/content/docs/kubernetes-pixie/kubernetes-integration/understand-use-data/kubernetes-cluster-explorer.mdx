...
<Video type="wistia" id="d6odj1911i" />
...
- Inner rings: Contain the pods ( ![Pod](src/images/pod_0.png 'Pod') ) of each node. Pods with active alerts are shown in the third innermost ring, and pods that are pending or unable to run are in the center.

![New Relic One - Cluster explorer](src/images/nr1-cluster-explorer-rings.png 'New Relic One - Cluster explorer')
...
![New Relic One - Cluster explorer - Pod alert](src/images/nr1-pod-alert.png 'New Relic One - Cluster explorer - Pod alert')

<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Kubernetes cluster
  explorer**: Click any pod to get more information about its status and health,
  and to dig deeper into application data and traces, logs, and events.
</figcaption>
...
![New Relic One - Cluster explorer - Dashboard detail](src/images/nr1-cluster-explorer-dashboard-detail.png 'New Relic One - Cluster explorer - Dashboard detail')

<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Kubernetes cluster explorer >
  Kubernetes dashboard**: The Kubernetes dashboard can be accessed from the
  Kubernetes cluster explorer. It shows useful Kubernetes metric data.
</figcaption>
...
![New Relic One - Cluster explorer - Search](src/images/nr1-cluster-explorer-search.png 'New Relic One - Cluster explorer - Search')

<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Kubernetes cluster
  explorer**: All your Kubernetes cluster's attributes and data points can be
  used to filter the cluster explorer view.
</figcaption>
...
![New Relic One - Cluster explorer - Time picker and Auto-refresh](src/images/nr1-cluster-explorer-picker-refresh.png 'New Relic One - Cluster explorer - Time picker and Auto-refresh')

<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Kubernetes cluster
  explorer**: The time picker lets you select several predefined time spans. To
  reload the data every minute, check the auto-refresh box.
</figcaption>
...
![New Relic One - Kubernetes Events](src/images/2020-04-28-17.40.27.gif '2020-04-28 17.40.27.gif')

<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Kubernetes cluster explorer >
  Events**: Browse and filter all your Kubernetes events, and dig into logs and
  infrastructure data.
</figcaption>
