...
Kubernetes cluster explorer of New Relic uses the data collected by the [Kubernetes integration](/docs/integrations/kubernetes-integration/get-started/introduction-kubernetes-integration) to show the status of your cluster, from the control plane to nodes and pods. 
