...
* Inner rings: Contain the pods ( <img title="Pod" alt="Pod" src={pod0}/> ) of each node. Pods with active alerts are shown in the third innermost ring, and pods that are pending or unable to run are in the center.
