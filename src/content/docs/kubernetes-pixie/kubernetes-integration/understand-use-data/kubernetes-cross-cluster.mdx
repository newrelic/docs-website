...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>`Alerts (Critical and Warning)`</td>
      ...
      <td>Tracking active alert events that require operator intervention.</td>
      <td>`Fleet:` Yellow: 1 to 10; Red: 11. `Cluster:` Yellow: 1 to 5; Red: 6.</td>
    </tr>
    <tr>
