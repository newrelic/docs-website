...
The New Relic Kubernetes integration supports monitoring Windows nodes in hybrid Kubernetes clusters. Your environment must meet the following requirements to monitor Windows nodes.
