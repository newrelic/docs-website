...
Notice that, depending on the installation method, the [control plane monitoring](/docs/integrations/kubernetes-integration/installation/configure-control-plane-monitoring) is not available or need extra configuration. 
