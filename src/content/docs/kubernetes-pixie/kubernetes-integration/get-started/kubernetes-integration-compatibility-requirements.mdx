...
<Callout variant="important">
  From integration version 3.6.0+ only kube-state-metrics v2+ is supported.<br/>If you are using kube-state-metrics 1.9.8 or below, you can only install the kubernetes integration up to version 3.5.0.<br/><br/>
