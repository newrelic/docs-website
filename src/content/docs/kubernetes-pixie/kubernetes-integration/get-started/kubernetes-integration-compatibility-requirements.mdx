...
You can install the [Kubernetes integration](/docs/integrations/kubernetes-integration/get-started/introduction-kubernetes-integration) [directly](/docs/integrations/kubernetes-integration/installation/guided-install) on a server or VM, or through several [cloud platforms](/docs/integrations/kubernetes-integration/installation/guided-install#cloud-platforms), such as GKE, EKS, AKS, or OpenShift. Each has a different compatibility with our integration.
...
Kubernetes integration of New Relic is compatible with different flavors. We tested the integration with the following ones:
...
* If you are using Helm, see the specific [compatibility and requirementes](/docs/kubernetes-pixie/kubernetes-integration/installation/install-kubernetes-integration-using-helm/#compatibility).
