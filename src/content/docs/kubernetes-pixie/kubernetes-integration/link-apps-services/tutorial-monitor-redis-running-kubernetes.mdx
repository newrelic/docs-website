...
* The `kubectl` command-line tool must be configured to communicate with your cluster. If you do not have a cluster, you can create one using [Minikube](https://kubernetes.io/docs/setup/minikube).
