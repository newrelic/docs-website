...
If you need to cut down even more on data ingestion, you can just increase the scrape interval in the [`nr-k8s-otel-collector` chart values](https://github.com/newrelic/helm-charts/tree/master/charts/nr-k8s-otel-collector#values) for each deployed component.
