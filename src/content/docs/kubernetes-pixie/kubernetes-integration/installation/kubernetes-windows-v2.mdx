...
freshnessValidatedDate: 2025-06-25
---

<Callout title="important">
  With the release of Windows Support for the New Relic Kubernetes Integration v3, it is not recommended to use the installation guidelines listed here. Please follow the [Kubernetes integration installation guide](/docs/kubernetes-pixie/kubernetes-integration/installation/kubernetes-windows/) for the latest instructions.
</Callout>
