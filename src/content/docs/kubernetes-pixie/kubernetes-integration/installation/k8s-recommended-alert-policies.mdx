---
title: 'Recommended alerts policies'
tags:
  - Integrations
...
When you first [deploy the Kubernetes integration](/install/kubernetes/), we deploy a default set of [pre-built alert policies](/docs/kubernetes-pixie/kubernetes-integration/installation/k8s-prebuilt-alert-policies) to your account that form the basis for alert conditions on your Kubernetes cluster.
