---
title: 'Mapping of Kubernetes OpenTelemetry metrics to New Relic integration metrics'
tags:
...
This document provides a mapping of the Kubernetes OpenTelemetry metrics to the New Relic integration metrics. This mapping helps you understand the metrics and attributes that are available for monitoring your Kubernetes cluster.
...
<table>
    <thead>
        <tr>
            <th style={{ width: "200px" }}>OpenTelmetry Metric</th>
