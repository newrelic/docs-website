...
3. Select the recommended alert policy you want to add:

    * Select <DNT>**Kubernetes**</DNT> to add the default set of recommended alert conditions:
    ...
    * Select <DNT>**Google Kubernetges Engine**</DNT> to add the default set of recommended Google Kubernetes engine alert conditions and a dasboard:
