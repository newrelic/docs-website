...
To add recommended alert policy and dashboards follow these steps:
...
5. Depending on the option you selected in step 3, you'll see different resources to add.
    ...
    <SideBySide>
      <Side>
        ...
        <figcaption>
            Select <DNT>**Kubernetes**</DNT> to add the default set of recommended alert conditions and a dashboard.
        </figcaption>
      ...
      <Side>
        ...
        <figcaption>
          Select <DNT>**Google Kubernetes Engine**</DNT> to add the default set of recommended Google Kubernetes engine alert conditions and a dashboard.
        </figcaption>
