...
+ Note: Make sure you are using kubernetes version 1.24.X or previous versions because Pod Security Policies were dropped in 1.25+ versions. If you use version 1.25+, you will get this error when running the above command:
 ```shell
