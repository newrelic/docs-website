...
<Callout
  ...
  title="EOL NOTICE"
>
  As of April 2022, we're discontinuing support for several capabilities, including Helm v2. For more details, including how you can easily prepare for this transition, see our [Explorers Hub post](https://discuss.newrelic.com/t/q1-bulk-eol-announcement-fy23/181744).
</Callout>
...
* [`nri-prometheus`](https://github.com/newrelic/helm-charts/tree/master/charts/nri-prometheus): New Relic's Prometheus OpenMetrics Integration, automatically scrapes Prometheus endpoints present in the cluster and [reports metrics to New Relic](https://docs.newrelic.com/docs/integrations/prometheus-integrations/get-started/send-prometheus-metric-data-new-relic#OpenMetrics).
* [`nri-metadata-injection`](https://github.com/newrelic/helm-charts/tree/master/charts/nri-metadata-injection): Sets up a minimal `MutatingAdmissionWebhook` that injects a couple of environment variables in the containers. These contain metadata about the cluster and New Relic installation and will be later picked up by applications instrumented using APM, allowing to [correlate APM and infrastructure data](/docs/integrations/kubernetes-integration/link-your-applications/link-your-applications-kubernetes/).
