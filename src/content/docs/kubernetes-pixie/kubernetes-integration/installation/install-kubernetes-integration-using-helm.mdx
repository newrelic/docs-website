...
To install the Kubernetes integration using Helm, you will need your New Relic [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) and your Kubernetes cluster's name:

1. Find and copy your [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key).
...
--namespace newrelic --create-namespace \
  ...
  Please notice and adjust the following flags:
    ...
    * `global.licenseKey=YOUR_NEW_RELIC_LICENSE_KEY`: Must be set to a valid [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) for your account.
