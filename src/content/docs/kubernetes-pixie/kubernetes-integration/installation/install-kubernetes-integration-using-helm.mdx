...
The full list of flags (e.g., [scrape-interval](https://docs.newrelic.com/docs/new-relic-solutions/observability-maturity/operational-efficiency/data-governance-optimize-ingest-guide/#k8s-integration)) that can be tweaked can be found in our chart's repository:
