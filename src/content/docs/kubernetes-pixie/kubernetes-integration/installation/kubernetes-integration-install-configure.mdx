...
You can choose between three options for installing the Kubernetes integration in your GKE Autopilot cluster:
...
### Guided Install [#gke-guided-install]
The guided install will ask if you are installing in a GKE Autopilot cluster. After you enter `Y`, we will set privileged, controlPlane, logging and pixie to `false` and set the kubelet scheme to http and kubelet port to 10255. 
