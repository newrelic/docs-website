...
<table>
  <thead>
    ...
    <tr>
      ...
      <td>
        Use this option if your New Relic organizaation doesn't use the [EU](/docs/using-new-relic/welcome-new-relic/get-started/our-eu-us-region-data-centers) data center, and you also want to install some bonus dashboards and alerts from the quickstart.
      </td>
    </tr>
    </tbody>
</table>
