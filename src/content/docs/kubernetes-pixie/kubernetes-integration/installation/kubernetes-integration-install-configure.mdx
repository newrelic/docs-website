...
GKE Autopilot doesn't allow privileged containers.
2. Turn off controlPlane
GKE Autopilot doesn't give access to the control plane. 
3. Disable logging
The logging integration is currently not supported in GKE Autopilot.
...
You can choose between two alternatives for installing the Kubernetes integration in your GKE Autopilot cluster:
