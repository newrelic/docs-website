...
We have some links below that will take you to the guided install that is right for you. After you start the installation process, you can use the tips in the remaining sections of this guide to help you make decisions about the various setup options.
...
<table>
  <thead>
    ...
    <tr>
      <td>
        [Guided install](https://one.newrelic.com/launcher/k8s-cluster-explorer-nerdlet.cluster-explorer-launcher?pane=eyJuZXJkbGV0SWQiOiJpbnN0YWxsLW5ld3JlbGljLmhvbWUiLCJwYXRoIjoiZ3VpZGVkIiwiZW52Ijoia3ViZXJuZXRlcyIsImFjdGl2ZUVudmlyb25tZW50IjogImt1YmVybmV0ZXMifQ==)
      </td>
      <td>
        Use this option if your account is outside the EU, and you don't need the bonus dashboards and alerts from the quickstart.
      </td>
    </tr>
    <tr>
      <td>
        [Guided install (EU)](http://one.eu.newrelic.com/launcher/k8s-cluster-explorer-nerdlet.cluster-explorer-launcher?pane=eyJuZXJkbGV0SWQiOiJucjEtaW5zdGFsbC1uZXdyZWxpYy5ucjEtaW5zdGFsbC1uZXdyZWxpYyIsInBhdGgiOiJndWlkZWQiLCJlbnYiOiJrdWJlcm5ldGVzIiwiaW5pdGlhbEFjdGlvbkluZGV4IjpudWxsLCJhY3Rpb25JbmRleCI6MX0=U)
      </td>
      <td>
        Use this option if your account is located in the [EU](/docs/using-new-relic/welcome-new-relic/get-started/our-eu-us-region-data-centers), and you don't need the bonus dashboards and alerts from the quickstart.
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Use this option if you are outside the EU, and you also want to install some bonus dashboards and alerts from the quickstart.
      </td>
    </tr>
    <tr>
      <td>
        [Guided install with quickstart (EU)](https://one.eu.newrelic.com/launcher/catalog-pack-details.launcher/?pane=eyJuZXJkbGV0SWQiOiJjYXRhbG9nLXBhY2stZGV0YWlscy5jYXRhbG9nLXBhY2stY29udGVudHMiLCJxdWlja3N0YXJ0SWQiOiI4OGE3OWY1Mi04MWMxLTRmYTItOTlmOC0zY2I1YjAxMmYxNjAifQ==)
      </td>
      <td>
        Use this option if you are within the [EU](/docs/using-new-relic/welcome-new-relic/get-started/our-eu-us-region-data-centers), and you also want to install some bonus dashboards and alerts from the quickstart.
      </td>
    </tr>
    </tbody>
</table>
...
<Steps>
  ...
  <Step>
    ...
    ### Scrape Prometheus endpoints [#scrap-endpoints]
    ...
    <CollapserGroup>
      <Collapser
        ...
        title="Scrape all Prometheus endpoints except core Kubernetes system metrics"
      >
      ...
      >
        ...
        Here's an example from `newrelic-prometheus-configurator/charts/newrelic-prometheus-agent/values.yaml` showing what is scraped:
        ```yaml
        kubernetes:
    ...
    <CollapserGroup>
      ...
      className="freq-link"
      id="full-enrichment"
      title="Full log enrichment"
      >
      If you prefer more robust data, you can opt to fully enrich your logs by adding label and annotation data to your log data.
