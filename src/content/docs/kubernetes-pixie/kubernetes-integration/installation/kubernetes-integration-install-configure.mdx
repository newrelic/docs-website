...
<Tabs>
  ...
  <TabsPages>
    <TabsPageItem id="1">
    The guided install experience simplifies the installation process for the New Relic Kubernetes integration, and gives you control over which features are enabled and which data is collected. You can choose from one of the following three options: 
