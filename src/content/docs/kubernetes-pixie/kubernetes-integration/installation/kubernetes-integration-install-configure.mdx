...
<CollapserGroup>
  <Collapser
    ...
    title={<><img src={eks} alt="EKS" style={{ verticalAlign: 'middle', width: '25px' }}/> <Link to="#install-amazon-eks"> Amazon EKS / EKS-Anywhere</Link></>}
  >
  ...
  <Collapser
    ...
    title={<><img src={eks} alt="EKS" style={{ verticalAlign: 'middle', width: '25px' }}/> <Link to="#install-amazon-eks-fargate"> Amazon EKS Fargate</Link></>}
  >
  ...
  <Collapser
    ...
    title={<><img src={cke} alt="CKE" style={{ verticalAlign: 'middle', width: '25px' }}/> <Link to="#install-google-kubernetes-engine"> Google Kubernetes Engine (GKE)</Link></>}
  >
  ...
  <Collapser
    ...
    title={<><img src={openshift} alt="OpenShift" style={{ verticalAlign: 'middle', width: '25px' }}/> OpenShift container platform</>}
  >
  ...
  <Collapser
    ...
    title={<><img src={aks} alt="AKS" style={{ verticalAlign: 'middle', width: '25px' }}/> Azure Kubernetes Service (AKS)</>}
  >
  ...
  <Collapser
    className="freq-link"
    id="install-pks"
    title={<><img src={pivotal} alt="PKS" style={{ verticalAlign: 'middle', width: '25px' }}/> Pivotal Container Service (PKS / VMware Tanzu)</>}
  >
