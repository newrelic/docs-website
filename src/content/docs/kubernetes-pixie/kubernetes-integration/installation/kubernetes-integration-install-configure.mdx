...
<ButtonGroup>
  ...
  <ButtonLink
    role="button"
    to="https://one.newrelic.com/nr1-core?state=07e01393-a461-b000-04fb-a89d1949736b"
    variant="primary"
  >
    Guided install
  </ButtonLink>
  ...
  <ButtonLink
    role="button"
    to="https://one.eu.newrelic.com/marketplace?state=5af9fb41-3b29-ccab-c838-fa129d09a22f"
    variant="primary"
  >
    EU guided install
  </ButtonLink>
