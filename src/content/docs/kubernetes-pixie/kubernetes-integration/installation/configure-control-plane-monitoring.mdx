...
* Control plane monitoring requires [Kubernetes integration version 1.16.0 or higher](/docs/release-notes/platform-release-notes/host-integrations-release-notes/new-relic-integration-kubernetes-1110).
