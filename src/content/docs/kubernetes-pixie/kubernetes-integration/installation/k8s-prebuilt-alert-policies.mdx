---
title: 'Pre-built alert policies'
tags:
  - Integrations
...
When you first [deploy the New Relic Kubernetes integration](/install/kubernetes) to an account, we deploy a default set of pre-built alert policies to that account. Once you install the integration, they are ready to use. You can add them to your account, and then customize the [conditions](/docs/alerts/create-alert/create-alert-condition/alert-conditions/) to meet your needs.


<Callout variant="important">
  The pre-built alert policies don't have a [notification channel](/docs/apis/nerdgraph/examples/nerdgraph-api-notifications-channels/) by default to prevent unwanted notifications.
</Callout>
...
3. Search <DNT>**Kubernetes**</DNT> and select the pre-built alert policy you want to add.
