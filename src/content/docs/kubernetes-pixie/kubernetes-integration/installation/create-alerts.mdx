...
4. Choose the way you want to [group the incidents](/docs/alerts/organize-alerts/specify-when-alerts-create-events/#preference-options) from this policy.
...
* [View the incident](/docs/alerts/alert-event-management/view-alert-event-details/)

* [Acknowledge the incident](/docs/alerts/get-notified/acknowledge-alert-events/)
