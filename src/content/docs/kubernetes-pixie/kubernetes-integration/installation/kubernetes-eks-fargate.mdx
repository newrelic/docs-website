---
title: 'Install Kubernetes on AWS EKS Fargate'
tags:
    - Integrations
...
## Install Kubernetes on AWS EKS Fargate [#install-eks-fargate]
...
#### Uninstall the Fargate integration [#automatic-uninstall]
...
### DaemonSet replicas are being deployed into Fargate nodes [#daemonset]
...
### Event `FailedScheduling` due to untolerated taint [#event-untolerated]
...
### Event `FailedScheduling` due to too many pods [#event-many-pods]
