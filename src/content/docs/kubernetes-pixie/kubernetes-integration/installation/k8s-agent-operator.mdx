...
## Configuring the Kubernetes agent operator [#configuring-k8s-operator]

Create a secret containing a valid [New Relic ingest license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) for each namespace you want the operator to instrument.
