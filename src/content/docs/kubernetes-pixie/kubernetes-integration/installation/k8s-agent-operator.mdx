...
The example YAML file above, shows how to configure the agent settings globally using environment variables. See each agent's configuration documentation for all available configuration options:
