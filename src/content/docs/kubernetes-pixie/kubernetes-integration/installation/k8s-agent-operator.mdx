...
To install the instrumentation CR, run this command:
...
* Get insights of your applications and resolve alert events using the [APM summary](/docs/apm/agents/manage-apm-agents/agent-data/triage-run-diagnostics/) page.
