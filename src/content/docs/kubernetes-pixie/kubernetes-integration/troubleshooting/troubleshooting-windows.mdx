---
title: 'Limitations and troubleshooting for Windows integration'
tags:
- Integrations
...
The following [Kubernetes metrics](/docs/kubernetes-pixie/kubernetes-integration/understand-use-data/find-use-your-kubernetes-data/#event-types) are unavailable on all Windows nodes regardless of mode, because the Windows kubelet either doesn't expose them or they're not applicable on Windows:
