...
<CollapserGroup>
  ...
  >
    ...
    To resolve this problem make sure you specify a valid [license key](/docs/accounts/install-new-relic/account-setup/license-key). The key should be surrounded with quotes and no leading or trailing spaces. Example:
  ...
  >
    ...
    <CollapserGroup>
      ...
      >
        ...
        * Queries for `K8sNamespaceSample`, `K8sDeploymentSample`, and `K8sReplicasetSample` do not show any data.
      </Collapser>
    </CollapserGroup>
