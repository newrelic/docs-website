...
<CollapserGroup>
  ...
  >
    During "Guided Install", the output error like below indicates that you are experiencing networking connection issue between their Kubernetes client and Kubernetes API server. Please make sure your Kubernete client can connect to your Kubernetes service before you run the Guided Install again.
    ```
