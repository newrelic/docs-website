...
1. Identify a performance issue: On the <DNT>**Web vitals**</DNT> page, locate a specific page URL. This action redirects to a detailed view of the web vitals information for that page. Examine the core Web vital scores and look for any labeled <DNT>**Needs improvement**</DNT> or <DNT>**Poor**</DNT>. These labels indicate areas where the page's performance lacks. Consider the device type or browser information, as performance issues vary significantly across different platforms and browsers. Understanding these details help pinpoint specific areas that require optimization.
