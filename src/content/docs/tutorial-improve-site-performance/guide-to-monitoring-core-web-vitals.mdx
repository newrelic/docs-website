...
Google measure overall website performance by these three metrics:
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Between 2.5 seconds and 5 seconds
      </td>
...
Core web vitals are embedded into many New Relic features, but the best way to view web vitals at a high level is:
  ...
  2. Select an app.
  3. From the left-hand menu, click <DoNotTranslate>**Web vitals**</DoNotTranslate>.
