...
<Steps>
    ...
    <DoNotTranslate>**SLIs for browser applications**</DoNotTranslate>:
    ...
    Select <DoNotTranslate>**Continue**</DoNotTranslate> in the left pane once you've confirmed your queries are correct.
    </Step>
