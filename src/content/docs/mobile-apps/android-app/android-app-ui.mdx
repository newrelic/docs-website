...
redirects:
  ...
  - /docs/mobile-apps/new-relic-mobile-apps/android-app
---
...
You can use the Android app to view your [synthetic monitoring](/docs/synthetics/new-relic-synthetics/getting-started/new-relic-synthetics) data, including charts of your monitor's availability, load times, and load sizes. Select the caret <Icon name="fe-chevron-down"/>
