...
<CollapserGroup>
  ...
  >
    ...
    * To change the duration of the visible time slice, select the clock <ImageSizing width="22px" height="20px"><img src={iconIosClock0} title="icon-ios-apm-clock" alt="icon-ios-apm-clock"/></ImageSizing> icon.
