...
{' '}
<Collapser id="mobile-apps" title="Mobile app monitoring">
  If you have installed mobile monitoring, you can monitor its performance
  directly from your Android device. Mobile monitoring includes network errors,
  API calls, and number of active users. You can also view detailed individual
  crash reports for a deeper understanding of a particular crash incident.
</Collapser>
  ...
  >
    ...
    * To change the duration of the visible time slice, select the clock <ImageSizing width="22px" height="20px">![icon-ios-apm-clock](src/images/icon-ios-clock_0.png "icon-ios-apm-clock")</ImageSizing> icon.
