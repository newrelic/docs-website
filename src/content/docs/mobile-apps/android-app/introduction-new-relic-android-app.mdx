...
<CollapserGroup>
  ...
  >
    ...
    * To change the duration of the visible time slice, select the clock <img style={{ width: '22px', height: '20px'}} title="icon-ios-apm-clock" alt="icon-ios-apm-clock" src={iconIosClock0}/> icon.
