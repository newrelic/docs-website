...
The New Relic iOS app lets you access your data wherever you are. You can view curated dashboards from across New Relic capabilities, from APM to infrastructure to browser, and access any dashboards you've built. If you need to go deeper, you can query your data directly with NRQL or search your logs. And you can receive alerts directly on the app so you can start investigating immediately.
...
<SideBySide>
  <Side>
    ...
    * **Synthetic monitoring**: See the performance of each monitor, view individual results, and track failures.
    ...
    You can also [add charts to your iOS home screen](/docs/mobile-apps/ios-app/ios-widgets/) as a custom widget.
  </Side>
  <Side>
    <img
