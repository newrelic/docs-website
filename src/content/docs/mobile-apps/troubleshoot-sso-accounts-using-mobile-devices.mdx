...
If you see any errors after successfully signing in to your SSO provider with your mobile device, verify that you are able to sign in to **[one.newrelic.com](https://one.newrelic.com/all-capabilities)** with a desktop web browser.
