      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            2. From the **Users** menu, select the plus <ImageSizing width="25px" height="20px">![icon ios plus](src/images/icon-ios-plus_0.png "icon ios plus")</ImageSizing> icon.
        ...
        <tr>
          ...
          <td>
            1. To access the **Users** menu: Select the user icon <ImageSizing width="25px" height="24px">![icon-ios-app-user](src/images/icon-ios-app-user.png "icon-ios-app-user")</ImageSizing> or slide right.
            2. From the **Users** menu, select the plus <ImageSizing width="25px" height="20px">![icon ios plus](src/images/icon-ios-plus_0.png "icon ios plus")</ImageSizing> icon.
            3. Sign in with the additional username.
          </td>
        </tr>
