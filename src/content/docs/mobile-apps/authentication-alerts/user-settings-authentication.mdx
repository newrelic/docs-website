      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            2. From the **Users** menu, select the plus <img style={{ width: '25px', height: '20px'}} title="icon ios plus" alt="icon ios plus" src={iconIosPlus0}/> icon.
        ...
        <tr>
          ...
          <td>
            1. To access the **Users** menu: Select the user icon <img style={{ width: '25px', height: '24px'}} title="icon-ios-app-user" alt="icon-ios-app-user" src={iconIosAppUser}/> or slide right.
            2. From the **Users** menu, select the plus <img style={{ width: '25px', height: '20px'}} title="icon ios plus" alt="icon ios plus" src={iconIosPlus0}/> icon.
            3. Sign in with the additional username.
          </td>
        </tr>
