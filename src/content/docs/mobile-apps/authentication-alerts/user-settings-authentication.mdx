      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            2. From the **Users** menu, select the plus <ImageSizing width="25px" height="20px"><img src={iconIosPlus0} title="icon ios plus" alt="icon ios plus"/></ImageSizing> icon.
        ...
        <tr>
          ...
          <td>
            1. To access the **Users** menu: Select the user icon <ImageSizing width="25px" height="24px"><img src={iconIosAppUser} title="icon-ios-app-user" alt="icon-ios-app-user"/></ImageSizing> or slide right.
            2. From the **Users** menu, select the plus <ImageSizing width="25px" height="20px"><img src={iconIosPlus0} title="icon ios plus" alt="icon ios plus"/></ImageSizing> icon.
            3. Sign in with the additional username.
          </td>
        </tr>
