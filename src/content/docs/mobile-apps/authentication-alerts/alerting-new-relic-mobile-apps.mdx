...
This feature is available only to users on [our original user model](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-user-models), not to users on [our newer user model](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-user-models). As a workaround, you can use the [email notification channel](#email).
