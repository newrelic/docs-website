...
<table>
  <thead>
    <tr>
      <th width={200}>
        <DNT>**New Relic account**</DNT>
      </th>

      <th>
        <DNT>**Additional requirements**</DNT>
      </th>
    </tr>
  </thead>
    ...
    <table>
      <thead>
        <tr>
          <th style={{ width: "200px" }}>
            <DNT>**Mobile device**</DNT>
          </th>

          <th>
            <DNT>**To sign in to the app with an additional user name:**</DNT>
          </th>
        </tr>
      </thead>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            1. To access the <DNT>**Users**</DNT> menu: Select the user icon <img style={{ width: '25px', height: '24px'}} class="inline" title="icon-ios-app-user" alt="icon-ios-app-user" src={mobileappsUser}/> or slide right.
            2. From the <DNT>**Users**</DNT> menu, select the plus <Icon name="fe-plus-circle"/> icon.
            3. Sign in with the additional username.
          </td>
        </tr>
