      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            2. From the **Users** menu, select the plus <Icon name="fe-plus-circle"/> icon.
        ...
        <tr>
          ...
          <td>
            1. To access the **Users** menu: Select the user icon <img style={{ width: '25px', height: '24px'}} class="inline" title="icon-ios-app-user" alt="icon-ios-app-user" src={mobileappsUser}/> or slide right.
            2. From the **Users** menu, select the plus <Icon name="fe-plus-circle"/> icon.
            3. Sign in with the additional username.
          </td>
        </tr>
