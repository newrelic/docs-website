...
Quick actions displays up to four of your favorite entities. If you have more than four favorites, you’ll see the most recently used ones. If you haven't set up any favorites, the display shows actions linking to the most-used capabilities (APM, alerts, synthetics, dashboards). 
