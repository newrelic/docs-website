...
<CollapserGroup>
  ...
  >
    ...
    * New Relic APM metrics, both real-time and [historical](#time) data, including health maps. Select the transaction <Icon name="repeat"/>
      icon to see detailed transaction metrics, or an **Overview** chart to view summary charts of your top five transactions. Select the <Icon name="filter"/>
  ...
  >
    You can use the Android app to view your [New Relic Synthetics](/docs/synthetics/new-relic-synthetics/getting-started/new-relic-synthetics) data, including charts of your monitor's availability, load times, and load sizes. To view more detailed charts, select the caret <Icon name="chevron-down"/>
    icon.
