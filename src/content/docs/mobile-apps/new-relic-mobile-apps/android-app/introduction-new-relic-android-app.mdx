...
<ImageSizing width="125px" height="230px">![New Relic Android app main menu](./images/navigation_nexus.jpg "New Relic Android app main menu")</ImageSizing>The user interface for New Relic's Android app provides functionality similar to New Relic's standard user interface, with customized details for mobile users.
...
<CollapserGroup>
  ...
  >
    ...
    * New Relic APM metrics, both real-time and [historical](#time) data, including health maps. Select the transaction <Icon name="fe-repeat"/>
