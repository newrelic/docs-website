...
![New Relic Android app main menu](./images/navigation_nexus.jpg "New Relic Android app main menu")The user interface for New Relic's Android app provides functionality similar to New Relic's standard user interface, with customized details for mobile users.
...
<CollapserGroup>
  ...
  >
    ...
    * To change the duration of the visible time slice, select the clock ![icon-ios-apm-clock](./images/icon-ios-clock_0.png "icon-ios-apm-clock") icon.
