...
![New Relic Android app dashboard](./images/deployment-markers_nexus.jpg "New Relic Android app dashboard") To view details of your New Relic apps, hosts, Synthetics monitors, Alerts, plugins, and key transactions, select a product from the main menu.

The New Relic Android app includes:

* New Relic APM metrics, both real-time and [historical](#time) data, including health maps. And, select the transaction ![icon-txn-list-ios](./images/icon-txn-list-ios.png "icon-txn-list-ios") icon for detailed transaction metrics, or an **Overview Charts** to view summary charts of your top five transactions.
...
* Select the filter <Icon name="filter"/>
...
You can use the Android app to view your [New Relic Synthetics](/docs/synthetics/new-relic-synthetics/getting-started/new-relic-synthetics) data, including charts of your monitor's availability, load times, and load sizes. Select the caret <Icon name="chevron-down"/>
