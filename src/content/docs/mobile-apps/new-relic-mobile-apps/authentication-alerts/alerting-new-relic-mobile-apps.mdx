...
This feature is available only to users on the [original user model](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-changes-pricing-user-model/#user-models), not to users on the [New Relic One user model](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-changes-pricing-user-model/#user-models). As a workaround, you can use the [email notification channel](#email). 
...
## View alert incident details <ImageSizing width="250px" height="460px">![New Relic Android app alert incident detail](./images/alerts-incident-detail-nexus.jpg "New Relic Android app alert incident detail")</ImageSizing> [#viewing-alerts]
