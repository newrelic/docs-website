...
## View alert incident details ![New Relic Android app alert incident detail](/images/alerts-incident-detail-nexus.jpg "New Relic Android app alert incident detail")
