...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <p>Depending on the partner, you may need to complete a different [authentication process](/docs/ios/ios-with-partners).</p><p>**Azure Store users:** Due to the deep integration between Azure Storefront and New Relic, Azure Storefront users cannot access their accounts on the New Relic Android or iOS apps.</p>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        <p>When you sign in to the New Relic mobile app, your session automatically redirects to your web browser. From there you can sign in to your New Relic SAML-SSO account.</p><p>If you see any errors when using SAML-SSO accounts on your mobile device, verify that you are able to sign in to [https://rpm.newrelic.com](https://rpm.newrelic.com) with a desktop web browser.</p>
