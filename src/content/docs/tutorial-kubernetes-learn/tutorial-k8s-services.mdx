---
title: Understand and monitor the service and application layer
...
Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & Services > select your application > Kubernetes**</DoNotTranslate>.     
    </Step>
    <Step>
...
<UserJourneyControls
    previousStep={{path: "/docs/tutorial-kubernetes-learn/tutorial-k8s-orchestrated", title: "Previous step", body: "Monitor Kubernetes deployments and pods."}}
/>