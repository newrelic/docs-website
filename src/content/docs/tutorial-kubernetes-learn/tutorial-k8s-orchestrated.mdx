...
Go to <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Kubernetes > Overview Dashboard**</DNT>.         
    </Step>
    <Step>
...
Scroll down a bit and find the <DNT>**Pending and Failed Pods**</DNT> table. This table will show you all the pods that have failed or are stuck pending for whatever reason. It's normal that pods fail at to a certain degree depending on the baseline health of your system. 
