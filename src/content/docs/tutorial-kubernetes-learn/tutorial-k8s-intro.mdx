...
This tutorial does not cover Pixie concepts, but there are [various other tutorials you can follow](https://docs.px.dev/tutorials/pixie-101/).
</Callout>
...
To reduce this complexity, you can report data from your containerzied applications to New Relic. This not only allows you to see the health of your applications, but also allows you  to correlate application data to the underlying Kubernetes infrastructure.
