  ...
  <Step>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          <td>
            [Guided install (JP)](https://one.jp.newrelic.com/nr1-core?account=2498654&state=d1aae74b-0ad6-b0f3-093d-cc89ecf89234)
          </td>

          <td>
            Use this if your New Relic organization uses the [JP](/docs/using-new-relic/welcome-new-relic/get-started/our-eu-us-region-data-centers) data center, and you don't need the bonus dashboards and alerts from the quickstart.
          </td>
        </tr>
