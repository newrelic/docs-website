...
3. Select **Write your own query**.

4. Write the NRQL query to create the condition. For example, if you wanted to monitor slow transactions, you can enter:
```sql
...
4. Select **Golden signal or metrics**.
    </Side>
...
/>
    ...
    <Side>
5. Choose any of the listed entity categories to determine what the alert condition will monitor. For this example, **On host integrations** is selected, but you can choose any other option that better suits your needs.

6. If you are using services like AWS, Kubernetes, on host integrations, and others, you will also need to select an entity type before you can select an individual entity. Select the entity type to narrow down the options for the next step.

7. Select the entity or entities you want to monitor. If you have many entities to choose from, you can use the filter field to shorten the list and find what you need.
    </Side>
</SideBySide>

8. Select the signal you want to monitor. This example uses **First input delay (75 percentile)**, but you can use any other option that better suits your needs.
...
9. Select **Next** once you've finished to save your progress and move on to the next step.
