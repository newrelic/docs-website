...
We recommend using the methods above to create a NRQL alert, however, if you would like to create a classic alert, you can use the original alert builder form.
...
5. Choose any of the listed categories to determine what the alert condition will monitor. For this example, **Services - APM** is selected, but you can choose any other option that better suits your needs.

5. Select a condition type to narrow down the options for the next step. You may also need to select a scope.

6. Select **Next** once you've finished to save your progress and move on to the next step.

7. On the next step, select the entity or entities you want to monitor. Use the search bar to narrow down the entity list. If you selected an APM application metric type condition, you may choose to dynamically target applications that share certain tags.  Select **Next** once you've finished.

8. On the final step, set your alert thresholds and various other condition settings. You'll name your condition on this step.

9. Select **Save condition** to finish.
