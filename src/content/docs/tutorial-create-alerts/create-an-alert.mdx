...
7. On the next step, select the entity or entities you want to monitor. Use the search bar to narrow down the entity list. If you selected an APM application metric type condition, instead of selecting specific entities, you may choose to dynamically target applications that share certain tags.  Select **Next** once you've finished.

8. On the final step, set your alert thresholds and various other condition settings. You'll also name your condition on this step.
