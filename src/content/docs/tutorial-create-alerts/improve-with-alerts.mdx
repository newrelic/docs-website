...
You can find out how to manage the quality of your alerts to prevent things like alert fatigue, as well as how you can use alerts to gather data and drive positive impact to your organization by following the process below.
...
<CollapserGroup>
    <Collapser
        id="Alerts-improve-dash"
        title="1. Install the AQM dashboard"
    >
1. Go to the [**Alert Quality Management**](https://newrelic.com/instant-observability/alert-quality-management) instant observability page.
...
The **Alerting Count by Policy** pane in the dashboard helps you identify these alert policies and determine any relevant patterns.
    ...
    <Collapser
        id="first-enablement"
        title="3. Establish your baselines"
    >
...
* If the incident alert is always on, don't close or acknowledge it. 
    ...
    >
It takes some time to accumulate your alert data from the dashboard. You should wait at least two weeks to gather this data, and regulary check to ensure that the incident responders for your alerts are following the guidelines outlined in the previous step.
    </Collapser>
    <Collapser
        id="second-enablement"
        title="5. Check your data against your baselines"
    >
...
<DocTiles>
  ...
  <DocTile title='Improve your stack with alerts' path="/docs/tutorial-create-alerts/improve-with-alerts/" label={{text: "You are here", color: "orange"}}> Learn how to use alerts to improve your system</DocTile>
</DocTiles>