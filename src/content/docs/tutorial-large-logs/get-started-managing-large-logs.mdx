...
New Relic's philosophy when it comes to log management focuses on three things: we want our logs solution to be **flexible, transparent, and usage-based**. Let's quickly talk about what these mean:
