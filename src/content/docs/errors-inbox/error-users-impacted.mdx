...
As an example, the below NRQL query measures the amount of unique users which have been impacted by an [error group](https://docs.newrelic.com/docs/errors-inbox/errors-inbox/#groups) coming from a specific entity:
