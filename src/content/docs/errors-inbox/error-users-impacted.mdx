...
By creating an [NRQL alert condition](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-alert-conditions/), developers can trigger alerts when the amount of Users impacted by errors exceeds a threshold.
...
Read more about using the [uniqueCount()](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/nrql-alert-conditions/) function, [how to find the entity id](/docs/new-relic-solutions/new-relic-one/core-concepts/what-entity-new-relic/#find) for your entities.
...
Once you have decided on a NRQL query, it can be used to create a [NRQL alert condition](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/nrql-alert-conditions/#create).

To improve the signal to noise ratio of your triggered alerts see [alert creation tips](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/nrql-alert-conditions/#condition-tips), [how alert thresholds are evaluated](/docs/alerts-applied-intelligence/new-relic-alerts/advanced-alerts/understand-technical-concepts/streaming-alerts-key-terms-concepts/#advanced-signal), and [alert condition examples](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/nrql-alert-conditions/#examples).
