...
Creating this alert requires determining the [NRQL string](https://docs.newrelic.com/docs/query-your-data/nrql-new-relic-query-language/get-started/introduction-nrql-new-relics-query-language/) which measures the amount of users impacted in the way which best captures your use case.
...
Once the NRQL string which should be alerts on is determined, it can be used as the signal parameter for [NRQL alert conditions](https://docs.newrelic.com/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-nrql-alert-conditions/#create).
