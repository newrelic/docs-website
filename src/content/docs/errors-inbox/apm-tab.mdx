...
The **Errors list view** allows you to:
...
Let's say that after you investigated your errors as a whole using the list view, you identified a specific group of hosts that is causing an error spike. You can now use the **Details view** to better understand in-context details.
...
The triage section links the specific error occurrence you're viewing to a system-created error group that has a unique fingerprint. Why does that matter? That unique fingerprint  enables you to triage an error group using a status update or assignment. The system-created error groups are the ones you find on the **Triage** tab. For more info on how they are generated, see [How error groups work](/docs/errors-inbox/errors-inbox/#how-groups-work).
