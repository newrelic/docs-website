...
With APM <DNT>**Group errors**</DNT> tab you can dynamically filter and group errors for deeper analysis.

<img
  title="group errors tab"
  alt="A depiction of the group errors tab"
  src="/images/apm_screenshot-full_group-errors-tab.webp"
/>
...
* <DNT>**Dynamic grouping:**</DNT> The default grouping for error occurrences is based on error message, error class, and transaction UI name. You have the option to change the grouping options by any attribute, up to five attributes at a time.
...
<img
  ...
  src="/images/apm_screenshot-full_error-profiles_2.webp"
/>
...
<img
  ...
  alt="A depiction of error profiles in the UI"
  src="/images/apm_screenshot-full_attribute_profiles.webp"
/>
...
* In the right pane labeled <DNT>**Distributed trace**</DNT>, you'll see the trace that's associated with the error occurrence displayed on this page. To see the trace's spans in a waterfall view:
...
* Error event data in the <DNT>**Group errors**</DNT> tab is available for up to a 7 day window of data collected over the last eight days.
* Error event metadata in the <DNT>**Triage**</DNT> tab is stored up to 13 months.
...
Expected errors aren't shown by default on the <DNT>**Group errors**</DNT> tab. You can show them by turning on the <DNT>**Show N expected errors**</DNT> switch below the <DNT>**Group by**</DNT> bar.
...
Errors outside transactions are shown by default on the <DNT>**Group errors**</DNT> tab, but if you want to view only errors outside of the transaction, apply the following filter:
...
<img
  ...
  src="/images/apm_screenshot-full_errors-outside-transactions.webp"
/>
...
<DNT>**Show only errors with stack trace**</DNT> is enabled by default, to constrain the errors shown to just those that have this type of data collected.
...
The <DNT>**Error rate chart**</DNT> is driven by a query on [metric timeslice data](/docs/query-your-data/nrql-new-relic-query-language/nrql-query-tutorials/query-apm-metric-timeslice-data-nrql), which is an unsampled aggregate data type that is accurate but has very limited dimensionality. This data can't be faceted or filtered as flexibly as error event data.

You can reproduce this chart in a dashboard, or explore the metric timeslice data further by clicking the <DNT>**...**</DNT> menu on the <DNT>**Error rate chart**</DNT>, and then using the <DNT>**View query**</DNT> or <DNT>**Add to dashboard**</DNT> options.

To chart faceted error counts using event data, as in the Top 5 errors chart, use an NRQL event query. Click the <DNT>**...**</DNT> menu on the Top 5 errors chart and choose <DNT>**View query**</DNT> for a starting point in creating your chart.
