...
Email notifications are currently sent to members of your team. If there's a new member you want to include, on the left-hand menu, click <DNT>**Add user**</DNT>.
...
Click the <DNT>**Unsubscribe**</DNT> link at the bottom of the email notification.

### Resubscribe to email notifications [#resubscribe]

If you've unsubscribed to email notifications and decide you need to resubscribe, find one your old errors inbox email notifications and click the <DNT>**Unsubscribe preferences**</DNT> link.

The email notification titles start with "<DNT>**[Errors Inbox]**</DNT>".
