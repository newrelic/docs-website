...
## SecurityPolicyViolation events aka CSP violations

New Relic listens to the `securitypolicyviolation` event emitted by browsers and report any such occurrences. However, this begins in agent version 1.313.0 and is not yet integrated into the UI such as the Errors Inbox view.
