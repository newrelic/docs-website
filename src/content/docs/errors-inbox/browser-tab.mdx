...
With **Group errors** tab you can dynamically filter and group errors for deeper analysis.
...
<img
    ...
    alt="A screenshot depiciting the browser group errors detail view. "
...
<img
    ...
    alt="A screenshot depicing the triage section of the browser group errors tab."
...
<img
    title="errors inbox stack trace"
    alt="A screenshot depicting errors inbox stack trace"
    src={errorsinboxErrorsInboxStackTrace}
/>
