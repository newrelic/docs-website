...
1. From the global navigation items, select **Detection & AI**.
2. In the left pane, select **Destinations**.
3. On the right side of the screen, select the **Destinations** tab once more.
