...
3. On the right side of the screen, select <DNT>**Destinations**</DNT>.
4. Search for your Jira destination, and at the right side of that row, select the <DNT>**...**</DNT> icon, and then click <DNT>**Delete destination**</DNT>.
