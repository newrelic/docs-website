...
When an inbox is connected to Slack, new and resurfaced error groups are sent to a Slack channel moments after they occur. This enables your team to quickly identify any new errors or regressions and resolve them quickly with direct links to the stack trace. To reduce noise, notifications are not sent for expected errors. <!-- Link to the newly created section of errors inbox -->
