...
2. Open one of your New Relic error inboxes, and click on the **Triage** tab.
3. Select the **Notification Settings** icon (looks like a bell) in the top right corner.
...
1. Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Destinations**.
