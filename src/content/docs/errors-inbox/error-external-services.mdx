...
For details, see [CodeStream and New Relic One](/docs/codestream/start-here/codestream-new-relic/#apm).
...
New Relic supports both team mananged and company managed projects [Atlassian-Jira projects](https://support.atlassian.com/jira-software-cloud/docs/what-are-team-managed-and-company-managed-projects/).
</Callout>
