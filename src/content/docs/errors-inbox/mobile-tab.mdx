...
<figcaption>
    <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile > Crashes (errors inbox)**</DoNotTranslate>: With our **Group crashes** tab you can analyze crash rate and crash free users at a glance or dive deeper into specific crash locations. 
</figcaption>
...
<figcaption>
    <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile > Crashes (errors inbox)**</DoNotTranslate>: Select a crash location to open the **Crash details** page. 
</figcaption>
...
<figcaption>
    <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile > Crashes (errors inbox) > Select a crash location **</DoNotTranslate>:  From the **Crash details** page you can triage specific error occurrences by adding status updates or assignments. 
</figcaption>
...
<figcaption>
    <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile > Crashes (errors inbox) > Select a crash location **</DoNotTranslate>:  Dig deeper into the events that led up to a specific crash using our event trail.
</figcaption>

## Mobile stack trace [#stack-trace]

The stack trace for the crashing thread is displayed beneath the crash details. Each frame within the stack indicates the associated library or package name, and method. The agent attempts to detect the specific stack frame containing the programming error responsible for the crash. If successfully detected, that stack frame appears red.
