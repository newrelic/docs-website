...
- Proactive notifications with detailed error information in Slack. For more info on how cool thsi feature is, check out the (introduction of this doc)[#intro]
