...
You can update the status (for example, resolve, ignore, unresolve) of multiple error groups (up to 2,000) all at once. In the inbox view, select the **Error group** checkbox to update all of your error groups in the inbox. You can also select individual error groups and update their statuses.
