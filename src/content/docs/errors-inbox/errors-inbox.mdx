...
<CollapserGroup>
  ...
  >
    The <DoNotTranslate>**Occurrences**</DoNotTranslate> dropdown includes details like:
    ...
    * In <DoNotTranslate>**Distributed trace**</DoNotTranslate>, you'll see the trace that's associated with the error occurrence displayed on this page. To see the trace's spans in a waterfall view:
