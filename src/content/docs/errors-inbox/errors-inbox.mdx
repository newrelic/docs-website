...
![This is an image of the main errors inbox UI](src/images/errors-ui.png 'ui-main')
...
![An image showing the details page of an error group](src/images/context.png 'Error group details page')
...
<Callout variant="important">
  Currently assigning an error group to a user does not send a notification.
  Notifications of assignment and changes to error groups will be coming soon.
</Callout>
...
<Callout variant="important">This integration supports Jira Cloud.</Callout>
<Callout variant="important">
  This integration currently supports Atlassian-Jira Classic (company-managed)
  projects.
</Callout>
...
1. Click on the Jira integration icon on the far right side of the error group you want to connect to Jira.
   ![An image showing the location the jira integration button in errors inbox.](src/images/jiraint.png 'Jira integration button')
   <figcaption>
     Clicking the Jira integration icon allows you to create a ticket based on a
     template, or create a template if you don't already have one.
   </figcaption>
