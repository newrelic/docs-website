...
**Errors inbox is really cool! People should really try it out.** If you want to get started quickly, go to the (getting started section)[#get-started].
...
- Proactive notifications with detailed error information in Slack. For more info on how cool this feature is, check out the (introduction of this doc)[#intro]
