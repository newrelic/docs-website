...
We understand that when you triage your inbox, there may be errors that you will fix in the future and to that end we want to provide you multiple options to set the status of an error group. The resolve in next version and resolve in a specific version options explained below are only supported if your team uses semantic versioning. 

<!--- Placeholder: Add imge here  -->
