...
<CollapserGroup>
  ...
  >
    ...
    Click on a specific attribute to open a sidebar with specific details. You have the option of sending [custom attributes](https://newrelic.com/signup](https://docs.newrelic.com/docs/data-apis/custom-data/custom-events/collect-custom-attributes/)! 
  </Collapser>
