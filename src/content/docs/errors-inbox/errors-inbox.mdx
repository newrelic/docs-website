...
You can update the status (e.g. resolve, ignore, unresolve) of multiple error groups, up to 2,000, all at once. In the inbox view, you can select the Error group checkbox and update all error groups in the inbox. You can also select individual error groups and update their status.
