...
<Callout variant="important">
   New Relic currently only supports [Atlassian-Jira Classic (company-managed) projects](https://support.atlassian.com/jira-software-cloud/docs/what-are-team-managed-and-company-managed-projects/). </Callout>
