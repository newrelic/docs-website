...
You must have the [New Relic infrastructure agent](/docs/infrastructure/install-configure-manage-infrastructure) **version 1.12.1 or higher** installed on a supported host. (x86 Windows versions are not yet supported.)
