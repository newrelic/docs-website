...
Congratulations! You've completed our journey on how to use New Relic to improve your app's performance! Ready to learn more about New Relic features? See the docs below for a deeper dive into the power of the feature you've used:
...
<DocTiles>
  ...
  <DocTile title='Create performance benchmarks' number='5' label={{text: 'Current doc', color: '#87CEFA'}} path="/docs/journey-app-slow/create-benchmarks/" ></DocTile>
</DocTiles>