...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>`1`</td>
            <td>`1`, `0`</td>
            <td>Disable Azure Functions instrumentation by setting the value to `0`.</td>
        </tr>
        <tr>
            <td>`NEW_RELIC_LOG_DIRECTORY`</td>
            <td></td>
            <td></td>
            <td>Modify the location where you want to store the agent and profiler logs. </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>`0`</td>
            <td>`1`,`0`</td>
            <td>Enables or disables agent specific logging.</td>
        </tr>
        <tr>
            <td>`NEW_RELIC_LOG_CONSOLE`</td>
            <td>`0`</td>
            <td>`1`,`0`</td>
            <td>Send log messages to the console instead of the log file by setting the value to `1`.</td>
        </tr>
    </tbody>
</table>
