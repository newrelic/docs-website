...
* **Ensure consistent runtime**: Ensure a consistent environment across development, testing, and deployment.

To get started using Lambda containerized functions you can either use the Node.js 16.x or Node.js 18.x operating system. 
...
You can choose any of the example code in the `serverless-newrelic-lambda-layers` repository. Once you've selected the code then edit `serverless.yml` file and add the plugin and details below.
