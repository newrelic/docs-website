...
To prevent creating two integrations for the same AWS account, it is recommended to use the `newrelic-lambda` CLI, as mentioned above, because it will detect an existing integration and using it.
