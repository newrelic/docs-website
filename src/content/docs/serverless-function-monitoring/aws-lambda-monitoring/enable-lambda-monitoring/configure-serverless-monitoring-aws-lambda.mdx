...
To set up Infinite Tracing for your Lambda functions, go to our [Infinite Tracing](/docs/distributed-tracing/infinite-tracing/set-trace-observer) documentation for steps to create a trace observer and to select which Lambda functions (data sources) should send trace spans to the Infinite Tracing trace observer.
