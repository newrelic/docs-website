...
To set up Infinite Tracing for your Lambda functions, see the [steps](/docs/distributed-tracing/infinite-tracing/set-trace-observer) to create a trace observer and to select which Lambda functions (data sources) should report spans.
