...
It's important to configure your new Lambda functions with the New Relic environment variables that match your monitoring needs. Choose your runtime to see the available environment variables and our recommendations for default settings. 
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td></td>
            <td></td>
            <td>Set to 'https://log-api.newrelic.com/log/v1</td>
            <td>`NEW_RELIC_TELEMETRY_ENDPOINT`</td>
            <td></td>
            <td></td>
            <td>Set to 'https://cloud-collector.newrelic.com/aws/lambda/v1'</td>
        </tr>
        </tr>
    </tbody>
</table>
