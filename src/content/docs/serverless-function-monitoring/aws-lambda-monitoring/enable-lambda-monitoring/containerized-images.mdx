...
### Configure your Lambda function
 ...
 2. Configure your new Lambda function using your the same Lambda function configuration but make sure to add any necessary environment variables required for New Relic integration.
