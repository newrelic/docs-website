...
First, you have to add New Relic's pre-built layer to your code. From there, you'll need to push the image to your AWS Elastic Container Registry. After you've pushed up your code combined with New Relic's prebuilt layer, you'll need to create a new function from the image you pushed to AWS ECR.
