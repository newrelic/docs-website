...
<td>Required: This must be set to `{36032161-FFC0-4B61-B559-F6C5D41BAE5A}` in order for the .NET agent to instrument your application.</td>
</tr>
<tr>
<td>`CORECLR_NEWRELIC_HOME`</td>
<td></td>
<td>`/opt/lib/newrelic-dotnet-agent`</td>
<td>Required: This must be set to `/opt/lib/newrelic-dotnet-agent` in order for the .NET agent to instrument your application.</td>
</tr>
<tr>
<td>`CORECLR_PROFILER_PATH`</td>
<td></td>
<td>`/opt/lib/newrelic-dotnet-agent/libNewRelicProfiler.so`</td>
<td>Required: This must be set to `/opt/lib/newrelic-dotnet-agent/libNewRelicProfiler.so` in order for the .NET agent to instrument your application.</td>
</tr>
<tr>
<td>`NEW_RELIC_APP_NAME`</td>
<td></td>
...
See more environment variables for the New Relic .NET agent in our [documentation](/docs/apm/agents/net-agent/configuration/net-agent-configuration/#environment-variables).
