...
### Configure your Lambda function
        1. Create a new Lambda function using the image you pushed to AWS ECR. For more information on creating this function, we recommend reviewing the AWS guide: [Pushing a Docker image to an Amazon ECR private repository](https://docs.aws.amazon.com/AmazonECR/latest/userguide/docker-push-ecr-image.html).
        2. Configure the Lambda function with the same settings as your original function, but ensure you add any required environment variables for New Relic Lambda monitoring. See our [Environment variables](#environment) for more information.
