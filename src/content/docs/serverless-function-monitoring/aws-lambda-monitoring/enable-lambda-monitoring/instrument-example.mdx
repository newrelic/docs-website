...
* Adding permissions to the function to access the AWS Secrets Manager and retrieve the New Relic [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key)
