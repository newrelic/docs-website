...
This table should help you see the range of options that we discuss below:
...
<table>
  <thead>
    ...
    <tr>
      ...
      <td>
         See the following examples for help with these supported languages:
    ...
    <tr>
      ...
      <td>
       [Colin, I'm not quite clear about why we'd centralize the environment variables here since 
       they are specific to the type of methodology you use. Could you clarify this? 
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        [Colin, are you asking that we list the layers that are compatible with runtimes for each supported language?
    ...
    <tr>
      ...
      <td>
        Here are the methodologies we describe in the sections below:
          * [CLI quickstart](#quickstarts)
          * [Continuous deployment](#cont)
              * [CloudFormation / SAM templates](#cloudformation)
...
## Additional integrations [#edge]

For most, one of the options above will work well. There's a chance that you can't use any of those
