...
For most, one of the options above will work really well. There's a chance that you can't use any of these
...
configuration of a Lambda function to use New Relic from the AWS Lambda Console, for NodeJS and Python.
...
Note that for Go, Java, and .NET, you must make source code changes to your Lambda function to instrument it.
...
2. For Python and NodeJS, we also include:
