...
<Tabs>
  <TabsBar>
    <TabsBarItem id="1">Containerized instrumentation</TabsBarItem>
    <TabsBarItem id="2">Layered instrumentation</TabsBarItem>
    <TabsBarItem id="3">Layerless instrumentation</TabsBarItem>

  </TabsBar>
  <TabsPages>
  
<TabsPageItem id="1">
* Node.js(OS/Arch: Linux, Windows, ARM, ARM 64, x86, x86-64) : `nodejs16.x`, `nodejs18.x`, `nodejs20.x`
* Python (OS/Arch: Linux, Windows, ARM, ARM 64, x86, x86-64): `python3.7`, `python3.8`, `python3.9`, `python3.10`, `python3.11`, `python3.12`
