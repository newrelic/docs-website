...
Lambda functions instrumented via OpenTelemetry (ADOT layer) now display the same APM UI experience as functions instrumented with New Relic APM agents, including a consistent <DNT>**Summary**</DNT> page and normalized metrics in `apm.*` format.
...
The New Relic APM UI does not display historical data for Lambda functions that were instrumented before the `APM + Serverless Convergence` upgrade. To view the historical data, click the **see serverless functions** option in the <DNT>APM Summary</DNT> page.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Provides a quick view of the most important performance data, including response time, throughput, and error rate. Available for both APM-instrumented and OpenTelemetry (ADOT)-instrumented Lambda functions.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Displays Lambda performance data sourced from AWS CloudWatch via New Relic's metric synthesis layer. Charts include invocation counts, duration, throttles, and error counts. Available for both APM-instrumented and OpenTelemetry (ADOT)-instrumented Lambda functions.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Lists Lambda transactions with performance data such as duration and throughput. The <DNT>**AWS Request ID**</DNT> column identifies each Lambda execution by its unique AWS request identifier, allowing you to drill down into a specific invocation's APM transaction trace.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Shows distributed traces involving the monitored Lambda function. For details, see [Distributed tracing](/docs/distributed-tracing/concepts/introduction-distributed-tracing/).
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Displays errors and exceptions for your Lambda function. You can filter by error rate, error percentage, or error class, and drill down into stack traces.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Displays recent log messages from your Lambda function. For details, see [Logs](/docs/logs/new-relic-logs/get-started/introduction-new-relic-logs).
      </td>
    </tr>
  </tbody>
</table>
