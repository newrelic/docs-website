...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>**Required**: Must be set to `newrelic-java-handler` when using the New Relic Java agent layer. This points AWS Lambda to the agent wrapper script bundled in the layer.</td>
        </tr>
        <tr>
            <td>`NEW_RELIC_SERVERLESS_MODE_ENABLED`</td>
