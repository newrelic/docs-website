...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td></td>
            <td>
                Sets the application name used as the APM entity name in the New Relic UI when `NEW_RELIC_APM_LAMBDA_MODE` is `true`.
                <br/><br/>
                <ul>
                    <li>Functions sharing the same app name and New Relic account are grouped under one APM entity, including across AWS regions.</li>
                    <li>Functions of different runtimes (for example, Python and Node.js) with the same name create separate entities per runtime.</li>
                    <li>To distinguish individual functions within a grouped entity, filter by `tags.aws.arn` in NRQL.</li>
                    <li>Changing this value creates a new entity; historical data is not migrated.</li>
                </ul>
            </td>
        </tr>
        <tr>
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td></td>
            <td>
                When `NEW_RELIC_APM_LAMBDA_MODE` is `true`, the extension uses this value as the APM entity name during the cold-start connect call.
                <br/><br/>
                <ul>
                    <li>Functions sharing the same app name and New Relic account are grouped under one APM entity, including across AWS regions.</li>
                    <li>Functions of different runtimes (for example, Python and Node.js) with the same name create separate entities per runtime.</li>
