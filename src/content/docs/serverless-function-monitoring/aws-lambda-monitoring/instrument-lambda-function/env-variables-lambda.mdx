    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <ul>
                    <li>US region (default):<br/>`https://log-api.newrelic.com/log/v1`</li>
                    <li>EU region:<br/>`https://log-api.eu.newrelic.com/log/v1`</li>
                    <li>JP region:<br/>`https://log-api.jp.nr-data.net/log/v1`</li>
                </ul>
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <ul>
                    <li>US region (default):<br/>`https://cloud-collector.newrelic.com/aws/lambda/v1`</li>
