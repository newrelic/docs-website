...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td></td>
            <td></td>
            <td>Sets the application name for APM monitoring. When `NEW_RELIC_APM_LAMBDA_MODE` is set to `true`, this name is used as the APM entity name in the New Relic UI. Lambda functions sharing the same app name and New Relic account are grouped under a single APM entity.</td>
        </tr>
        <tr>
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td></td>
            <td></td>
            <td>Sets the application name used when `NEW_RELIC_APM_LAMBDA_MODE` is enabled. The extension uses this value as the APM entity name during the cold-start connect call. Lambda functions sharing the same app name and New Relic account are grouped under a single APM entity in the New Relic UI.</td>
        </tr>
        <tr>
