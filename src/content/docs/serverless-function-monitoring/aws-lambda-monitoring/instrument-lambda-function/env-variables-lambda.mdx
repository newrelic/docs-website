...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td>`NEW_RELIC_MACHINE_LEARNING_ENABLED`</td>
            <td>`true`</td>
            <td>`true`, `false`</td>
            <td>Enables machine learning-specific features for New Relic platform. Set to `true` to activate tracking and analysis of machine learning-related data.</td>
        </tr>
        <tr>
            <td>`NEW_RELIC_ML_INSIGHTS_EVENTS_ENABLED`</td>
            <td>`true`</td>
            <td>`true`, `false`</td>
            <td>Allows New Relic to collect and store events related to machine learning insights. Set to `true` to gather detailed events for deeper analysis and reporting.</td>
        </tr>
        <tr>
            <td>`NEW_RELIC_AI_MONITORING_ENABLED`</td>
            <td>`true`</td>
            <td>`true`, `false`</td>
            <td>Activates AI monitoring features within New Relic. Set to `true` to enable specialized monitoring for AI components, including inference times and AI output analysis.</td>
        </tr>
    </tbody>
</table>
