...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>`https://log-api.newrelic.com/log/v1`, `https://log-api.eu.newrelic.com/log/v1`, `https://log-api.jp.nr-data.net/log/v1`</td>
            <td>Set the logs endpoint</td>
        </tr>
        <tr>
            <td>`NEW_RELIC_TELEMETRY_ENDPOINT`</td>
            <td>`https://cloud-collector.newrelic.com/aws/lambda/v1`</td>
            <td>`https://cloud-collector.newrelic.com/aws/lambda/v1`, `https://cloud-collector.eu01.nr-data.net/aws/lambda/v1`, `https://cloud-collector.jp.nr-data.net/aws/lambda/v1`</td>
