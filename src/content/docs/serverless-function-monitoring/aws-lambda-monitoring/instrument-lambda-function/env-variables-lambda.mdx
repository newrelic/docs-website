...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>`true`</td>
            <td>`true`, `false`</td>
            <td>Set to `true` to enable tracking and analysis of machine learning-related data.</td>
        </tr>
        <tr>
            <td>`NEW_RELIC_ML_INSIGHTS_EVENTS_ENABLED`</td>
            <td>`true`</td>
            <td>`true`, `false`</td>
            <td>Set to `true` to allow New Relic UI to collect detailed events for deeper analysis and reporting.</td>
        </tr>
        <tr>
            <td>`NEW_RELIC_AI_MONITORING_ENABLED`</td>
            <td>`true`</td>
            <td>`true`, `false`</td>
            <td>Set to `true` to enable the AI monitoring features in the New Relic UI.</td>
        </tr>
    </tbody>
</table>
