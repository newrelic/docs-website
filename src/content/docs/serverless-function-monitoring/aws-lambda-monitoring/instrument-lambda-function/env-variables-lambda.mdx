...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>`false`</td>
            <td>`true`, `false`</td>
            <td>**Required for response streaming**: Set to `true` to enable tracking and analysis of machine learning-related data.</td>
        </tr>
        <tr>
            <td>`NEW_RELIC_ML_INSIGHTS_EVENTS_ENABLED`</td>
            <td>`false`</td>
            <td>`true`, `false`</td>
            <td>**Required for response streaming**: Set to `true` to allow New Relic agent to collect detailed events for deeper analysis and reporting.</td>
        </tr>
        <tr>
