...
* Link your New Relic and AWS accounts
* Review our different instrumentation methods

Below we've listed all the instrumentation methods. The CLI, serverless framework, CloudFormation/SAM, and Terraform methods all include the extension. If you'd like to instrument 
