...
metaDescription: Instrument your Lambda function with New Relic layer
freshnessValidatedDate: never
redirects:
  - /docs/serverless-function-monitoring/aws-lambda-monitoring/enable-lambda-monitoring/instrument-your-own
---

After you've successfully linked your New Relic and AWS accounts you can instrument your layered AWS Lambda functions by adding the New Relic Lambda layer. This integrates the New Relic agent, enabling automatic monitoring whenever your functions are invoked.
