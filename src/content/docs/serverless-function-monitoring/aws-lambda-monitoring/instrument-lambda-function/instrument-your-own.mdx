...
Depending on your needs, you can choose to bypass the extension and only see telemetry in CloudWatch, bypass CloudWatch, or use CloudWatch as a fallback. The end of this doc will guide you through each option.
...
You can choose to send data to CloudWatch only. To do this:
