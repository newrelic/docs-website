...
```
  ...
  >
    ...
    To ship data to New Relic, you can use the [New Relic Terraform Provider](https://registry.terraform.io/providers/newrelic/newrelic/latest/docs/resources/cloud_aws_integrations).
  </Collapser>
