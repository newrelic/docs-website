...
<CollapserGroup>
  ...
  >
    ...
    1. Install the [New Relic Lambda layer](https://layers.newrelic-external.com/). Below are examples for Node.js and Java Lambda functions.
        ...
        **Java example (slim layer, recommended):**
            ...
            Properties:
              ...
              Environment:
                Variables:
                  ...
                  AWS_LAMBDA_EXEC_WRAPPER: newrelic-java-handler
              ...
              Tags:
                NR.Apm.Lambda.Mode: true
              Layers:
                # TODO: Replace with the finalized New Relic Java slim layer ARN for your region.
                # Slim layer (recommended) — only aws-lambda-java-core instrumentation enabled.
                # Full layer ARN available at https://layers.newrelic-external.com
                - JAVA_SLIM_LAYER_ARN_PLACEHOLDER
        ```
  ...
  >
    ...
    Python, Node.js, and .Net runtimes will follow the same instrumentation flow as Ruby, but with some different handlers. Java requires one additional step. Here's how to update your function's handler for each runtime:
    ...
    * Java:
      ...
      * **Additionally required for Java**: After setting the handler, go to the **Environment variables** tab and add `AWS_LAMBDA_EXEC_WRAPPER` with the value `newrelic-java-handler`. This is required for the Java agent layer to intercept invocations and is not needed for other runtimes.
      * **Note**: The Java agent layer requires Java 17 or later.
