...
<CollapserGroup>
  ...
  >
    ...
    **To install and configure your Serverless Framework application with New Relic:**
    ...
    4. In your AWS Management Console, on the Configuration tab, add the `NR.Apm.Lambda.Mode: true` tag to your Lambda function.
    5. Deploy your Lambda function with the updated configuration.
