...
configuration of a Lambda function to use New Relic from the AWS Lambda Console, for Node.js, Python, Ruby and Java.
...
3. For .NET, we also include:
   1. The New Relic agent
   2. Automatic instrumentation of your lambda function handler.
