...
Java, Python, Node.js, and .Net runtimes will follow the same instrumentation flow as Ruby, but with some different handlers: 
    1. Update your function's handler to point to the newly attached layer in the console for your function:
        * Java:
