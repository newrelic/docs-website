...
<Callout variant="tip">
    When manually testing, telemetry data is often delayed. We recommend waiting seven seconds, then invoking the function again to give it an opportunity to deliver previously buffered telemetry.
</Callout>
</Step>
</Steps>
