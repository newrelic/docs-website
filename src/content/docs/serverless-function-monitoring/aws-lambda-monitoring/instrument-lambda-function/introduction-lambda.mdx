...
New Relic's instrumentation for AWS Lambda provides deep visibility into the inner workings of your functions. By adding the New Relic agent to your function, each time your function is invoked, New Relic is too. This allows you to monitor the duration of your function invocations, track errors, and record details about the source events and your function's responses.

New Relic's AWS Lambda monitoring solution provides detailed insights into your Lambda functions' performance, errors, and invocations. By instrumenting your functions with New Relic, you can gain visibility into key performance metrics, such as duration, cold starts, exceptions, and tracebacks.
<img
