...
4.  A New Relic account with either an admin role or have the <DNT>**Infrastructure manager**</DNT> [add-on role](/docs/accounts/original-accounts-billing/original-users-roles/users-roles-original-user-model#add-on).
