...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="Ruby"
  >
New Relic doesn't have a layerless Ruby instrumentation method. If you're using layers, see our [Instrument your non-containerized function documentation]()
