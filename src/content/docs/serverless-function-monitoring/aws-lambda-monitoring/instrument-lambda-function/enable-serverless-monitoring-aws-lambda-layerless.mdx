...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="Ruby"
  >
New Relic doesn't have a layerless Ruby instrumentation method. If you're using layers, there are two ways to instrument your non-containerized Ruby Lambda functions: automatically or manually. 
