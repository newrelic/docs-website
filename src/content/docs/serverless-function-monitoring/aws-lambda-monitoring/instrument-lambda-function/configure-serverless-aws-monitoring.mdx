...
<Callout variant="tip">
* When you instrument New Relic's Lambda layer with the New Relic CLI, your environment variables are configured automatically. You may want to change some of the default settings and configure your Lambda functions with the environment variables that match your monitoring needs.
