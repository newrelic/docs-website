...
* [Containerized instrumentation](/docs/serverless-function-monitoring/aws-lambda-monitoring/enable-lambda-monitoring/containerized-images/): Use this method if your Lambda function runs inside a container. Containers provide a consistent, isolated execution environment for your applications. New Relic provides a pre-built Docker image that includes the New Relic Lambda layer, the New Relic Lambda extension, and the New Relic agent. 

* [Layered instrumentation](/docs/serverless-function-monitoring/aws-lambda-monitoring/instrument-lambda-function/instrument-your-own/): Use this method if your Lambda function is packaged as a Zip file and you can add layers. Layers are distribution mechanism for libraries, custom runtimes, and other dependencies.

* [SDK based instrumentation](/docs/serverless-function-monitoring/aws-lambda-monitoring/instrument-lambda-function/sdk-based-instrumentation/): Use this method if your Lambda function can't use layers, ensuring quick deployment without the necessity to modify layers.
...
* After you've installed and configured Lambda monitoring, you can start to [find and query your data](/docs/serverless-function-monitoring/aws-lambda-monitoring/ui-data/understand-lambda-monitoring) in New Relic.
* If you're having trouble, check out our [troubleshooting section](/docs/serverless-function-monitoring/aws-lambda-monitoring/troubleshooting/troubleshoot-enabling-serverless-monitoring-aws-lambda) for common issues and solutions.
