...
After instrumenting your AWS Lambda function with OpenTelemetry and invoking it, the <DNT>**CloudWatch metrics**</DNT> section or <DNT>**Invocations**</DNT> tab doesn't appear in the New Relic UI.
