...
The functionality for using AWS Lambda with OpenTelemetry for .NET is still in development.
</Callout>
...
## Step 2: Add New Relic environment variables [#env-variables]
...
## Step 3: Configure the collector [#collector]
...
The above is a basic example, for more advanced instrumentation refer to the [OpenTelemetry .NET SDK documentation](https://github.com/open-telemetry/opentelemetry-dotnet).
