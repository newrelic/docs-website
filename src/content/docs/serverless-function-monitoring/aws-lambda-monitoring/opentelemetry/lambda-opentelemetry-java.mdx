...
<Callout variant="important">
This assumes you bundled your `collector.yaml` in your function's root. If you bundled it somewhere else, replace `/var/task/collector.yaml` with the path to your `collector.yaml`.
</Callout>
