...
<Callout variant="important">
The layer ARNs above may be out of date. Refer [here](https://aws-otel.github.io/docs/getting-started/lambda/lambda-java-auto-instr) for the latest ARNs published by AWS.
</Callout>
...
For manual instrumentation, instead of using the layer ARNs in [Step 2](#install), use one of the layer ARNs  for your function's architecture in the list below:
...
<Callout variant="important">
The layer ARNs above may be out of date. Refer [here](https://aws-otel.github.io/docs/getting-started/lambda/lambda-java) for the latest ARNs published by AWS.
</Callout>
