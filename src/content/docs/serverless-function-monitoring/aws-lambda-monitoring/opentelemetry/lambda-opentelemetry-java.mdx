...
<Callout
  ...
  title="PREVIEW"
>
  AWS Lambda with OpenTelemetry for Java is still in development, and can support other languages (.NET, Python, Go, JavaScript, Ruby, and PHP).
  More information can be found in [AWS Distro for OpenTelemetry Lambda](https://aws-otel.github.io/docs/getting-started/lambda).
</Callout>
