...
<Callout variant="important">
  Replace `your-license-key-here` with your New Relic [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) and `otlp.nr-data.net:4317` with the endpoint appropriate for your New Relic region (see list above).
</Callout>
