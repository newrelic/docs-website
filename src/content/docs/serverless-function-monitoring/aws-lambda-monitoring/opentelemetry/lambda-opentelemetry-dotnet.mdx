...
3. Under <DoNotTranslate>**Specify an ARN**</DoNotTranslate>, paste one of the layer ARNs for your function's architecture from the list below. Replace `{region}`with your AWS region, such as `us-east-1`.
...
9. Choose <DoNotTranslate>**Add environment variable**</DoNotTranslate> again.
10. For the <DoNotTranslate>**Key**</DoNotTranslate> set it to `OTEL_SERVICE_NAME` and set the <DoNotTranslate>**Value**</DoNotTranslate> to your function's name. Then choose <DoNotTranslate>**Save**</DoNotTranslate>.
