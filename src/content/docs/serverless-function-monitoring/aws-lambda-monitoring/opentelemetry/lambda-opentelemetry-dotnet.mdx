...
<Callout variant="important">
The layer ARNs above may be out of date. Refer [here](https://aws-otel.github.io/docs/getting-started/lambda/lambda-dotnet) for the latest ARNs published by AWS.
</Callout>
