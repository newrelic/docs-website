...
The New Relic service receives your telemetry, processes it into [`AwsLambdaInvocation`](/attribute-dictionary/?event=AwsLambdaInvocation), [`AwsLambdaInvocationError`](/attribute-dictionary/?event=AwsLambdaInvocationError),
[`Span`](/attribute-dictionary/?event=Span), and custom events, and stores all that in our telemetry database: NRDB.
