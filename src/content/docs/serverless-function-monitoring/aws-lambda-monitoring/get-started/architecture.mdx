...
from the classic APM experience. Inside the [New Relic platfor ](/docs/new-relic-one/use-new-relic-one/get-started/introduction-new-relic-one/), Lambda functions have a custom UI, which quickly surfaces the most important information about your function, and integrates closely with our logging and distributed tracing features.
