...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        The <DNT>**Summary**</DNT> page displays charts that give you a quick view into the most important performance data. If available, this will feature data gathered from [APM agent instrumentation](/docs/serverless-function-monitoring/aws-lambda-monitoring/get-started/enable-new-relic-monitoring-aws-lambda#instrument-lambda).
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        The <DNT>**CloudWatch metrics**</DNT> page displays Lambda data that comes from AWS CloudWatch. Charts include: invocation counts, duration, throttles, and error counts.
      </td>
    </tr>
    ...
    <tr id="invocations">
      ...
      <td>
        The <DNT>**Invocations**</DNT> page lets you filter your invocations by attribute, and view duration, throughput, external calls, and invocation breakdowns.
