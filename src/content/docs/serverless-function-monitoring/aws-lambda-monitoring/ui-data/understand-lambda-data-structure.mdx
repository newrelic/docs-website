...
The data displayed in [the UI](/docs/lambda-monitoring-ui) is a combination of these data sources. For example, the <DNT>**Overview**</DNT> page displays data reported by instrumentation, while the <DNT>**Metrics**</DNT> page displays CloudWatch data.
