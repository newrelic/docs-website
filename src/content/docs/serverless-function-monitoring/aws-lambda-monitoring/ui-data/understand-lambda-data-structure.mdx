...
The data displayed in [the UI](/docs/lambda-monitoring-ui) is a combination of these data sources. For example, the <DoNotTranslate>**Overview**</DoNotTranslate> page displays data reported by instrumentation, while the <DoNotTranslate>**Metrics**</DoNotTranslate> page displays CloudWatch data.
