...
## Set up the Lambda response streaming
...
3. Save the changes and deploy the function.
    ...
    After deployment, you can view the Lambda response streaming data in the New Relic platform. For more information, refer to [View the Lambda response streaming data](#view-response-streaming-data).
...
3. In the **More views** section, click **AI Responses**.
