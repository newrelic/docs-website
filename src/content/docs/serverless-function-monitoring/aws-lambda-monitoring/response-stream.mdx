...
You can monitor AWS Lambda functions that use [response streaming](https://aws.amazon.com/blogs/compute/introducing-aws-lambda-response-streaming/) in Node.js applications to gain real-time insights into the performance and behavior of each invocation. This solution integrates with [AI monitoring](/docs/ai-monitoring/intro-to-ai-monitoring/) to allow you to track model responses and collect observability data related to Large Language Models (LLMs) in your AI workloads. By leveraging these capabilities, you can optimize your serverless applications' performance and maintain comprehensive oversight of AI-driven processes.
