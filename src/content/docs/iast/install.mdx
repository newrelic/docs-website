...
3. Once you've completed all the steps, make sure to restart your application and generate traffic against the application's APIs.

4. Click **See your data** to see an overview of your tested application.

5. For more detailed instructions, check out these examples demo below about how to set up IAST with Java (approx. 2:48 minutes) and Node.js (approx. 2:49 minutes):
