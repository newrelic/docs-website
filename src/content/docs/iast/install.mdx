 ...
 <Step>
    ...
    <Tabs>
        ...
        2. Enable IAST testing by adding code to initialize the integration after your call to `newrelic.NewApplication`.
            ...
            ```
            app, err := newrelic.NewApplication(newrelic.ConfigAppName("Your Application Name"),newrelic.ConfigLicense("NEW_RELIC_LICENSE_KEY"),)
        ```
  ...
  >
    ...
    <CollapserGroup>
        ...
        <Collapser
            ...
            title="I can see my application in the New Relic IAST UI and the security agent started successfully. How do I know IAST analysis is happening?"
        >
