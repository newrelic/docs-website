...
If you have configured your firewall correctly, check the following:
    ...
    If after checking these, you don't see vulnerabilities in IAST, please contact [New Relic Support](https://support.newrelic.com/s/) and share your application's configuration and logs with our support team. 