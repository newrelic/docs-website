...
<CollapserGroup>
    ...
    3. View the details of the test including <DoNotTranslate>**APIs covered**</DoNotTranslate>, <DoNotTranslate>**methods calls**</DoNotTranslate>, and <DoNotTranslate>**application testing efficiency**</DoNotTranslate>.

    Also, if you set the log level to <DoNotTranslate>**debug/finest**</DoNotTranslate>, you can search for <DoNotTranslate>**Fuzz request received**</DoNotTranslate> in the `nr-security-home/logs/java-security-collector.log` file. This shows that the IAST analysis is in progress.
