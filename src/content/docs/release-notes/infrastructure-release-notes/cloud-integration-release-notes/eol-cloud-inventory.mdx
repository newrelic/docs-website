...
As [previously announced](https://support.newrelic.com/s/hubtopic/aAX8W0000008cts/important-upcoming-changes-to-capabilities-and-support-across-errors-classic), we're ending support for Inventory data pushed from our Cloud Integrations (AWS, Azure, GCP).
