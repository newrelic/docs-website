...
* [Windows <DNT>Docker/DNT>](https://docs.newrelic.com/docs/infrastructure/new-relic-infrastructure/data-instrumentation/docker-instrumentation-infrastructure) support for Windows Server 2016 hosts. Only Windows server native containers are supported.
