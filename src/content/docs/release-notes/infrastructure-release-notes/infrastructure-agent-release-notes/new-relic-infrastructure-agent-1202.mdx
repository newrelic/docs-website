...
## Changed
* Bump nri-winservices to [v0.3.0-beta](https://github.com/newrelic/nri-winservices/releases/tag/v0.3.0-beta) [#706](https://github.com/newrelic/infrastructure-agent/pull/706)
