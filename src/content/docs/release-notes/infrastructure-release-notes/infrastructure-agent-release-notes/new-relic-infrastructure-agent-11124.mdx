...
* The built-in <DNT>Docker/DNT> integration has been updated to version 1.2.1. For more information, [see the <DNT>Docker/DNT> integration changelog](https://github.com/newrelic/nri-docker/blob/master/CHANGELOG.md).
