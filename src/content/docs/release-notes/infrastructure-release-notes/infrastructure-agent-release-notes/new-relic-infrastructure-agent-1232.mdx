...
## Changed
- bump flex to v1.4.4 [#976](https://github.com/newrelic/infrastructure-agent/pull/976)

## Fixed
- decorate events with custom_attributes [#939](https://github.com/newrelic/infrastructure-agent/pull/939)
