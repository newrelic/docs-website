...
## Changed
* upgrade go version to 1.25.0 in [#2125](https://github.com/newrelic/infrastructure-agent/pull/2125)
* update dependency newrelic/nri-winservices to v1.3.0 in [#2128](https://github.com/newrelic/infrastructure-agent/pull/2128)
