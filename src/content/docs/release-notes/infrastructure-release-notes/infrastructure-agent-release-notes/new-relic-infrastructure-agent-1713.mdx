...
* update alpine docker tag to v3.23 in [#2158](https://github.com/newrelic/infrastructure-agent/pull/2158)
* update go version to 1.25.5 in [#2161](https://github.com/newrelic/infrastructure-agent/pull/2161)
