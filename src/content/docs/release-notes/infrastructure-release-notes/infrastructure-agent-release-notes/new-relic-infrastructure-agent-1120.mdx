...
* [04335dd](https://github.com/newrelic/infrastructure-agent/commit/04335dd50f3b1e1468faf3fc7ff9038a05566bd2) Updated base <DNT>Docker/DNT> image for [`newrelic/infrastructure`](https://hub.docker.com/r/newrelic/infrastructure) (used by [`newrelic/infrastructure-k8s`](https://hub.docker.com/r/newrelic/infrastructure-k8s)) to Alpine `3.12` and also updated the packages to latest versions in the container.
...
* The built-in <DNT>Docker/DNT> integration has been updated to version 1.3.1. For more information, [see the nri-docker changelog](https://github.com/newrelic/nri-docker/releases/tag/v1.3.1)
