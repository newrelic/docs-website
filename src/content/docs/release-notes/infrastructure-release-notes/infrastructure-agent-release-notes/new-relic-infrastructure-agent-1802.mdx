...
- Updated `flex` to version v1.18.12 to resolve security vulnerability [CVE-2026-56854](https://github.com/advisories/GHSA-gjhq-gjfw-99mq) in [#2323](https://github.com/newrelic/infrastructure-agent/pull/2323)
