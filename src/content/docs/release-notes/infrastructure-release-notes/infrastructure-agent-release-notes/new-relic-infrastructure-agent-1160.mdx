...
version: 1.16.0
---
⚠️ Updating RPM packages to this version will disable newrelic-infra-service. More details in [#357](https://github.com/newrelic/infrastructure-agent/issues/357)
