...
* Security Bulletin [NR18-05](https://docs.newrelic.com/docs/accounts-partnerships/new-relic-security/security-bulletins/security-bulletin-nr18-05): Fixed a security issue in which, under some premises, the process sampler may not strip correctly the command-line information and submit some sensitive data to the Process View.
