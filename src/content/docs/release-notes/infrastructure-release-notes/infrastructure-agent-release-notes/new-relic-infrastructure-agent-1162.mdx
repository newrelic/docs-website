...
<Callout variant="important">
  We're releasing this version in a granular way. This means that we will release different asset types on different days (RPM, DEB, MSI, zip, targz, <DNT>Docker/DNT>).
