...
- bump http://golang.org/x/crypto  to v0.55.0 fix security [CVE-2026-56854](https://github.com/advisories/GHSA-gjhq-gjfw-99mq) in [#2321](https://github.com/newrelic/infrastructure-agent/pull/2321)

🐞 Bug fixes

- extend the WMI fallback to retrieve Queue Length in [#2312](https://github.com/newrelic/infrastructure-agent/pull/2312)
