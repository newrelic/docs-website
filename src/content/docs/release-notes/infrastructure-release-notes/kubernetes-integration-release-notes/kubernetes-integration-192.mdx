...
version: 1.9.2
redirects:
  - /docs/release-notes/platform-release-notes/host-integrations-release-notes/new-relic-integration-kubernetes-192
---
...
* **Fixed:** The <DNT>Docker/DNT> image has been rebuilt to fix this issue: [moby/moby#35443](https://github.com/moby/moby/issues/35443).
