...
Effective Wednesday, 15 November 2023, our Kubernetes integration drops support for Kubernetes v1.23 and lower. The Kubernetes integration v3.20.0 and higher will only be compatible with Kubernetes versions 1.24 and higher. For more information, read this note or contact your account team.
