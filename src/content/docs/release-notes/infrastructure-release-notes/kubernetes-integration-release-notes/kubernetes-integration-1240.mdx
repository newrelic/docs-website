...
version: 1.24.0
redirects:
  - /docs/release-notes/platform-release-notes/kubernetes-integration-release-notes/new-relic-integration-kubernetes-1240
---
...
* **Changed:** Upgraded <DNT>Docker/DNT> base image `newrelic/infrastructure-bundle` to `v1.4.0.`  
