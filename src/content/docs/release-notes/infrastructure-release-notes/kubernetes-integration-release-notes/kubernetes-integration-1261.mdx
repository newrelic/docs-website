...
version: 1.26.1
redirects:
  - /docs/release-notes/platform-release-notes/kubernetes-integration-release-notes/new-relic-integration-kubernetes-1261
---
...
* **Changed:** Upgraded <DNT>Docker/DNT> base image `newrelic/infrastructure-bundle` to `v1.5.0.`  
