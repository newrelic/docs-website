...
version: 1.26.2
redirects:
  - /docs/release-notes/platform-release-notes/kubernetes-integration-release-notes/new-relic-integration-kubernetes-1262
---
...
* **Changed:**Upgrade <DNT>Docker/DNT> image to use Tini entrypoint solving:
...
* **Changed:** Upgraded <DNT>Docker/DNT> base image `newrelic/infrastructure-bundle` to `v1.5.1.`  
