---
title: New Relic integration for Kubernetes 1.9.2
...
releaseDateTime: '2019-06-13 18:30'
releaseImpact:
  - Bug Fixes
---
...
* **Fixed:** The Docker image has been rebuilt to fix this issue: [moby/moby#35443](https://github.com/moby/moby/issues/35443).
