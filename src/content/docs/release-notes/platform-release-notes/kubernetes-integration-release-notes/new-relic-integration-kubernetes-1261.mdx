---
title: New Relic integration for Kubernetes 1.26.1
...
releaseDateTime: '2020-08-26 11:00'
releaseImpact:
  - Changes
---
...
* **Changed:** Upgraded Docker base image `newrelic/infrastructure-bundle` to `v1.5.0.`  
