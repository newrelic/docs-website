...
<div className="callout-important">
  <p>
    If you are using the <code>resourceGroup</code> attribute in alerts, custom dashboards, or saved queries for these Azure services, be sure to rename them using the new format before June 21, 2018.
  </p>
</div>
