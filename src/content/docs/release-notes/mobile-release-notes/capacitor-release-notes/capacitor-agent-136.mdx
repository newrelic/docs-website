...
* Introduced [`setMaxOfflineStorageSize`]([`setMaxOfflineStorageSize`](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/set-max-offline-storage/#capacitor) API: This new API allows the user to determine the maximum volume of data that can be stored locally. This aids in better management and control of local data storage.
