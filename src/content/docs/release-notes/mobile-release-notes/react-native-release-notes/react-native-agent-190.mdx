...
* Added source map upload support for symbolicating `MobileJSError` stack traces (automatic, manual, and CodePush/OTA). See [React Native JavaScript error reporting](/docs/mobile-monitoring/new-relic-monitoring-react-native/react-native-agent-js-error-reporting).
