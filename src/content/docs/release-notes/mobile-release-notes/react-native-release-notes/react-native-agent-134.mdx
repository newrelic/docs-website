...
Please refrain from using this release, as it encountered compilation errors during the iOS development process. Instead, we recommend using the [1.3.5 release](/docs/release-notes/mobile-release-notes/react-native-release-notes/react-native-agent-135). 
</Callout>
