...
version: 4.273.4
downloadLink: 'https://download.newrelic.com/android_agent/ant/NewRelic_Android_Agent_4.273.4.zip'
redirects:
  - /docs/release-notes/mobile-release-notes/android-release-notes/clone-android-42730
---
