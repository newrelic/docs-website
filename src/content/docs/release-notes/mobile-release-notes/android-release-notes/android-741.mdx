...
* Add `ApplicationExitInfo` as part of data reporting, and te feature is enabled by default. To disable go to your mobile applications entity application settings page.
