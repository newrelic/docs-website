...
* Add support for [native crash reporting](https://docs.newrelic.com/docs/mobile-monitoring/new-relic-mobile-android/install-configure/android-agent-native-crash-reporting/) in legacy agent crash reporting. 
* Add Distributed tracing context support to New relic SDK


## Fixed in this release
* Fixed issue that kept the app's supportsability metrics from being reported to New Relic
