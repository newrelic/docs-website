...
releaseDateTime: '2020-10-15 16:00'
releaseVersion: 5.28.0
downloadLink: >-
...
This applies to attributes passed to`recordCustomEvent()`, `recordEvent()` and `recordBreadCrumb()` API methods.
