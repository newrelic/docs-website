...
* As of this release, the oldest supported version is 7.3.1 of the [XCFramework](/docs/release-notes/mobile-release-notes/xcframework-release-notes/xcframework-agent-730).
