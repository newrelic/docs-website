...
* A feature flag has been added to enable background reporting. Background reporting is disabled by default. Enable the `NRFeatureFlag_BackgroundReporting` feature flag to turn on background reporting.
