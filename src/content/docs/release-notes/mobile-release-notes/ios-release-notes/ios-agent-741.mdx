...
* New Relic recommends that you upgrade the agent regularly and at a minimum every 3 months. The legacy iOS only and tvOS only agents were deprecated with the release of iOS agent version 7.2.1. Upgrading to the new iOS agent (for all platforms) is required.
