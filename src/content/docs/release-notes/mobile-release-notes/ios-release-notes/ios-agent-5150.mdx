...
topics:
  ...
  - iOS release notes
releaseDateTime: '2017-10-17 13:32'
releaseVersion: 5.15.0
downloadLink: 'https://download.newrelic.com/ios_agent/NewRelic_iOS_Agent_5.15.0.zip'
---

### Improvements

* [Handled Exceptions](/docs/mobile-monitoring/new-relic-mobile-ios/ios-sdk-api/record-handled-exception) in Objective-C
