...
* In [issues and incident management and response](/docs/alerts/alert-event-management/Issues-and-alert-event-management-and-response/#search-filters), added a note clarifying when warning and critical alert incidents are created.
