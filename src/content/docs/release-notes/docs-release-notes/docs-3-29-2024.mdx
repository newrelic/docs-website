...
* New on-host integration to monitor [<DoNotTranslate>Apache Druid</DoNotTranslate>>](/docs/infrastructure/host-integrations/host-integrations-list/apache-druid-integration/).
