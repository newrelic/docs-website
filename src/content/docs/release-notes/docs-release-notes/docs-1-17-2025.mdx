...
- Added a new document to update your [New Relic alert destinations and workflows](/docs/alerts/get-notified/new-relic-webhook-for-microsoft-teams-workflow/) for newly created Microsoft Teams-based workflows.
- Added a new [active user](/docs/mobile-monitoring/mobile-monitoring-ui/usage-pages/active-users) document to track the number of devices, sessions, or users running your app daily, weekly, or monthly, trended over time.
- Added a new document for [cross-account alerts](/docs/alerts/create-alert/create-alert-condition/cross-account-alert).
- Added a new document for API examples for [cross-account alert elections](/docs/apis/nerdgraph/examples/nerdgraph-api-cross-account-alerting-elections).
...
- Added information related to cross-account alerts in the following documents:
  - [User permission](/docs/accounts/accounts-billing/new-relic-one-user-management/user-permissions)
...
- Updated the NRQL query syntax in the [Dashboard Template](/docs/query-your-data/explore-query-data/dashboards/dashboard-template-variables) document.
- Fixed code formatting in the [Java agent API](/docs/apm/agents/java-agent/api-guides/guide-using-java-agent-api) document.
...
* [Browser agent v1.278.2:](/docs/release-notes/new-relic-browser-release-notes/browser-agent-release-notes/browser-agent-v1.278.2)
  * Fixed a bug to allow pageView feature to access to an event buffer.
...
* [Browser agent v1.278.3:](/docs/release-notes/new-relic-browser-release-notes/browser-agent-release-notes/browser-agent-v1.278.3)
  * Fixed an issue where obfuscation rules were not honored if added after the agent was initialized.
...
* [Node.js agent v12.10.1:](/docs/release-notes/agent-release-notes/nodejs-release-notes/node-agent-12-11-1)
  ...
  * Restored the branch to test `apollo-server-plugin` to `main`.
