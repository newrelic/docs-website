...
* In our Python agent configuration, added [startup debug](/docs/apm/agents/python-agent/configuration/python-agent-configuration/#NEW_RELIC_STARTUP_DEBUG) info.
* In [mobile monitoring configure settings](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/configure-settings/#android-background-reporting), added enable/disable info for background and `ApplicationExitInfo` reporting for Android.
* A massive overhaul of the alerts navigation makes it easier for you to find what you're looking for in those docs.

### Minor changes

* Updated [iOS](/docs/mobile-monitoring/new-relic-mobile-ios/configuration/app-launch-times-ios-apps) and [Android](/docs/mobile-monitoring/new-relic-mobile-android/install-configure/configure-app-launch-time-android-apps) app launch time docs in response to customer feedback to make them more similar to one another.
* [Infrastructure logs](/docs/infrastructure/install-infrastructure-agent/get-started/requirements-infrastructure-agent) now support Ubuntu 24.04.
