...
* A massive rework of the OpenTelemetry docs category, including a new [APM: Monitor apps and services with OpenTelemetry](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/apm-monitoring/opentelemetry-apm-intro) to give customers a solid place to start. Other changes:
...
* For our customers who'd rather not write regular expressions or Grok patterns to parse their logs, [query time parsing](/docs/logs/ui-data/query-time-parsing) is a powerful tool for parsing logs directly in the UI. (A lot of great screenshots in this one.)
...
* Our [alerts notification message templates](/docs/alerts-applied-intelligence/notifications/message-templates/#escape) now support escape characters to help our customers avoid JSON-breaking characters, among other things.
