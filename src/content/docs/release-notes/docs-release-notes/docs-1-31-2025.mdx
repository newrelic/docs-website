...
* [Android agent v7.6.3](/docs/release-notes/mobile-release-notes/android-release-notes/android-763/)
    ...
    * Enhanced logging.
    * Fixed bugs.
* [Python agent v10.5.0](/docs.newrelic.com/docs/release-notes/agent-release-notes/python-release-notes/python-agent-100500/)
    * Introduced agent health reporting.
    * Fixed bugs.
* [Ruby agent v9.17.0](/docs.newrelic.com/docs/release-notes/agent-release-notes/ruby-release-notes/ruby-agent-9-17-0/)
    * Support Ruby 3.4.0.
    ...
    * Fixed bugs.
* [Node.js agent v12.11.3](/docs.newrelic.com/docs/release-notes/agent-release-notes/nodejs-release-notes/node-agent-12-11-3/)
    * Fixed bugs.
* [Java agent v8.18.0](/docs.newrelic.com/docs/release-notes/agent-release-notes/java-release-notes/java-agent-8180/)
