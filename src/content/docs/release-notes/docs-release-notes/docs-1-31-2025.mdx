...
* The attribute values specified in the [Okta user profile configuration](/docs/accounts/accounts/automated-user-management/okta-scimsso-application-configuration/) are case-sensitive.
