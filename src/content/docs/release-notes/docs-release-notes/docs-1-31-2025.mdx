...
* The attribute values specified in the [Okta user profile configuration](/docs.newrelic.com/docs/accounts/accounts/automated-user-management/okta-scimsso-application-configuration/) are case-sensitive.
* [SCIM API user type](/docs/accounts/accounts/automated-user-management/tutorial-manage-users-groups-scim/#manage-user-type) values are case sensitive.
