...
* Enhanced the linguistic accuracy of [security-policy.](/docs/licenses/license-information/referenced-policies/security-policy)
* Improved the linguistic accuracy for [get-started with log management.](/docs/logs/get-started/get-started-log-management)
...
* Updated the support case for data retention in [Global technical support offering.](/docs/licenses/license-information/general-usage-licenses/global-technical-support-offerings)
...
* [Logs v241219](/docs/release-notes/logs-release-notes/logs-24-12-19/):
  ...
  * Excluded the `aws.region`, `aws.realm`, and `aws.accountId` attributes to get ingested via AWS Lambda and Firehose log shipping integrations, as they are intended for internal use.
...
* [Nodejs agent v12.9.0](/docs/release-notes/agent-release-notes/nodejs-release-notes/node-agent-12-9-0):
  ...
  * Updated the `match` to fail when incorrect keys are added in an object.
