...
* Updated the [Certifications, standards, and regulations](/docs/security/security-privacy/compliance/regulatory-audits-new-relic-services) information for New Relic and added details on [PCI DSS](/docs/security/security-privacy/compliance/certificates-standards-regulations/pci-dss).
