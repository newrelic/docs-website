...
version: 1.238.0
features: ["Reducing the agent chunk count","Add API: setApplicationVersion"]
bugs: ["Capture potential missing tail data for session trace","Fix distributed tracing handling of empty string fetch parameter","Typo in type declarations"]
security: []
---
...
Consistent with our [browser support policy](https://docs.newrelic.com/docs/browser/new-relic-browser/getting-started/compatibility-requirements-browser-monitoring/#browser-types), v1.238.0 of the Browser agent was built for and tested against these browsers and version ranges: Chrome 106-114, Edge 106-113, Safari 15-16, and Firefox 107-113. For mobile devices, v1.238.0 was built and tested for Android Chrome 100 and iOS Safari 15.2-16.2.