...
releaseDateTime: '2018-10-04 14:00'
releaseVersion: '1099'
downloadLink: ''
---
...
* **Action Text:** The agent now captures the text of the HTML element that was clicked when a browser interaction started. This value is stored as an attribute called `actionText` on the BrowserInteraction events. There is also a new [API actionText](https://docs.newrelic.com/docs/browser/new-relic-browser/browser-agent-spa-api/actiontext-browser-spa-api), which can be used to manually set the action text value.
