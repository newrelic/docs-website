...
version: 1.247.0
features: ["Session Replay API","Add relative timestamps to Session Replay payloads","Expose library versions used to capture session replay data","Add basic support for deferring the browser agent loader script","Enable SRI and nonce attributes for async chunks","Add session durationMs to Session Replay payloads"]
bugs: []
security: []
---
