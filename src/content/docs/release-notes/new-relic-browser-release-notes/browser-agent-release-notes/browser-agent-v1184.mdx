...
releaseDateTime: '2020-09-30 15:49'
releaseVersion: '1184'
downloadLink: ''
---
...
Custom attributes created using the [setCustomAttribute API method](https://docs.newrelic.com/docs/browser/new-relic-browser/browser-agent-spa-api/setcustomattribute-browser-agent-api) will now be included in all [PageViewTiming events](https://docs.newrelic.com/docs/browser/new-relic-browser/page-load-timing-resources/pageviewtiming-async-or-dynamic-page-details).
