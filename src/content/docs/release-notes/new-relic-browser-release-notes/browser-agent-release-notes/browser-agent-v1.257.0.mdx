...
version: 1.257.0
features: ["Session Replay preload optimizations","Decorate errors with hasReplay individually"]
bugs: ["Session replay preload without autoStart","JSEerrors harvest hasReplay decoration","Agent class type declarations","Soft navigations memory leak on harvest"]
security: []
---
...
Consistent with our [browser support policy](https://docs.newrelic.com/docs/browser/new-relic-browser/getting-started/compatibility-requirements-browser-monitoring/#browser-types), v1.257.0 of the Browser agent was built for and tested against these browsers and version ranges: Chrome 114-123, Edge 114-123, Safari 16-17, and Firefox 115-124. For mobile devices, v1.251.1 was built and tested for Android Chrome 100-123 and iOS Safari 15.5-16.2.