...
version: '1220'
---
<Callout variant="caution" title="About this release">
This release is in public preview. We're slowly rolling out these features to different browser agents based on the browser's instrumentation method. Full support will be announced soon! 
    </Callout>
