...
![New suggested service levels](src/images/suggested_service_levels.png 'New suggested service levels')
...
![Improved service level setup flow](src/images/setup_flow.png 'Improved service level setup flow')
