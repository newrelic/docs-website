...
version: 1.5.22
downloadLink: 'https://download.newrelic.com/nrdiag/nrdiag_1.5.22.zip'
redirects:
  - /docs/release-notes/platform-release-notes/diagnostics-release-notes/clone-new-relic-diagnostics-1522
  - /docs/release-notes/platform-release-notes/diagnostics-release-notes/new-relic-diagnostics-1522
---
