...
version: 1.6.25
downloadLink: 'https://download.newrelic.com/nrdiag/nrdiag_1.6.25.zip'
redirects:
  - /docs/release-notes/platform-release-notes/diagnostics-release-notes/new-relic-diagnostics-1625
---
