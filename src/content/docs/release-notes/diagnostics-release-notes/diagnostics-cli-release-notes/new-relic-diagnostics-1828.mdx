...
version: 1.8.28
downloadLink: 'https://download.newrelic.com/nrdiag/nrdiag_1.8.28.zip'
redirects:
  - /docs/release-notes/platform-release-notes/diagnostics-release-notes/new-relic-diagnostics-1828
---
