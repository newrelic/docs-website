...
version: 1.11.31
downloadLink: 'https://download.newrelic.com/nrdiag/nrdiag_1.11.31.zip'
redirects:
  - /docs/release-notes/platform-release-notes/diagnostics-release-notes/clone-new-relic-diagnostics-11131
  - /docs/release-notes/platform-release-notes/diagnostics-release-notes/new-relic-diagnostics-11131
---
