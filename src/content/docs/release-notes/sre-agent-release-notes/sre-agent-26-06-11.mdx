...
* Investigations now complete 96% of the time, up from 75%.
...
* **Dedicated Kubernetes investigation coming soon**

  * A new capability to handle K8s workload analysis including pod restarts, resource pressure, and scheduling failures is coming soon via limited preview. To sign up early contact Mikel Angulo (mangulo@newrelic.com).
