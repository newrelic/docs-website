...
* Parsed cookies from response headers and adds them to the redirect headers, which helps prevent cert checks from failing on endpoints depending on cookies.
### Improvements
