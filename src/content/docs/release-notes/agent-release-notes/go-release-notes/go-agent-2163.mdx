...
version: 2.16.3
downloadLink: 'https://github.com/newrelic/go-agent/tree/v2.16.3'
---
...
* A [ConfigFromEnvironment](https://godoc.org/github.com/newrelic/go-agent/v3/newrelic#ConfigFromEnvironment) bug has been fixed.
