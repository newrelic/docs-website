...
- Replace HandlerInterceptorPointCut [2871](https://github.com/newrelic/newrelic-java-agent/pull/2871) 
...
- Remove SpringDispatcherPointCut and SpringExceptionHandlerPointCut and instead move the functionality into our Spring instrumentation modules. [2886](https://github.com/newrelic/newrelic-java-agent/pull/2886) 
