...
bugs: [Fixes Kotlin Coroutine with CancellableContinuation]
---
<ButtonGroup>
  <ButtonLink
    role="button"
    to="https://download.newrelic.com/newrelic/java-agent/newrelic-agent/8.25.1/"
    variant="primary"
  >
...
- Fixes Kotlin Coroutine error about third party implementation of CancellableContinuation
