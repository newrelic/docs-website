...
bugs: ["Agent could cause an application deadlock", "Agent would not capture JMX Datasource information from <DNT>Tomcat</DNT> when JDNI GlobalNamingResources was used"]
security: []
---
<ButtonGroup>
  <ButtonLink
...
* Spring 5
  ...
  Spring 5 instrumentation works with Spring Boot, <DNT>Tomcat</DNT>, and <DNT>Jetty<DNT>.  
