...
features: ["Slow query tracking for Cassandra", "Synchronous calls for MongoDB Java driver 2.14", "Apache <DNT>Tomcat</DNT> 8.5", "Support for Akka forwarding and Akka broadcasting", "Support for additional JDBC drivers"]
...
* Apache <DNT>Tomcat</DNT>

  This release adds support for <DNT>Tomcat</DNT> 8.5
* Akka
