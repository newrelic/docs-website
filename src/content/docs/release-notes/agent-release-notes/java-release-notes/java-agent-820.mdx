...
bugs: ["Prevented a NullPointerException from the lettuce instrumentation", "Fix failure with browser agent auto injection for <DNT>Tomcat</DNT> versions 8.5.87+ and 9.0.74+"]
security: []
---
<ButtonGroup>
  <ButtonLink
...
- Fix failure with browser agent auto injection for <DNT>Tomcat</DNT> versions 8.5.87+ and 9.0.74+ [1225](https://github.com/newrelic/newrelic-java-agent/pull/1225)
