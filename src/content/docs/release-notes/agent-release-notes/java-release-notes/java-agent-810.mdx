...
- Performance improvements when using <DNT>Tomcat</DNT> [1131](https://github.com/newrelic/newrelic-java-agent/pull/1131)
...
- Updated <DNT>Docker/DNT>Data to increase the number of container IDs detected [1178](https://github.com/newrelic/newrelic-java-agent/pull/1178)
