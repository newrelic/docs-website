...
features: [“Support for CRaC”, “Support for JDK24”, “Add sampling options when an inbound traceparent exists”, “Support for Undertow”, “Support for Micronaut”, “Support for Couchbase Client”]
...
- Support for Micronaut Http and Micronaut Core [2280](https://github.com/newrelic/newrelic-java-agent/pull/2280) and [2219](https://github.com/newrelic/newrelic-java-agent/pull/2219)
	- If any of the [Micronaut Core Experimental Modules](https://github.com/newrelic/newrelic-java-micronaut-core) or [Micronaut Http Experimental Modules](https://github.com/newrelic/newrelic-java-micronaut-http) are currently in use, remove them from your extensions directory before upgrading to this version of the Java Agent.
