...
* Add support for <DNT>Jetty<DNT> 12, including <DNT>Jetty<DNT>’s implementation of the Jakarta EE 8, 9, and 10 specs. [1621](https://github.com/newrelic/newrelic-java-agent/pull/1621)
...
* Add a workaround for a memory leak that may occur in rare scenarios with instrumentation using the legacy async API in the Java Agent (which async servlets and <DNT>Jetty<DNT> Continuations use). [1555](https://github.com/newrelic/newrelic-java-agent/pull/1555)
