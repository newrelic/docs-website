...
* For upcoming changes to our Synthetics Monitoring, we have added an additional Synthetics Header to identify the synthetics type, initiator and additional attributes for synthetics requests.  [1607](https://github.com/newrelic/newrelic-java-agent/pull/1607)
