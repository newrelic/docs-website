...
features: []
bugs: ["Fixes for the HttpUrlConnection instrumentation", "Ensure that TokenAndRefCount.token is never null", "Fix NullPointerException being thrown when calling addCustomAttributes", "Fix ClassCircularityError when agent attaches"]
security: []
---
