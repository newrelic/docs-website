...
* Advanced Analytics for APM Errors
  ...
  With this release, the agent reports [TransactionError](https://docs.newrelic.com/docs/insights/new-relic-insights/decorating-events/error-event-default-attributes-insights) events. These new events power the beta feature [Advanced Analytics for APM Errors](https://docs.newrelic.com/docs/apm/applications-menu/events/view-apm-errors-error-traces) (apply [here <i className="fa fa-external-link fileinfo">
  \[external link\]
  </i>](https://discuss.newrelic.com/t/join-the-apm-errors-beta-of-real-time-analytics/31123 "Link opens in a new window.") to participate). The error events are also available today through [New Relic Insights <i className="fa fa-external-link fileinfo">
  \[external link\]
  </i>](http://newrelic.com/insights "Link opens in a new window.") .
