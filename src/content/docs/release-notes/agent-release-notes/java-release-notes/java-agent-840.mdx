...
* Added a public preview of the [Interactive Application Security Testing](https://docs.newrelic.com/docs/iast/introduction/) (IAST) mode of the [New Relic Security agent](https://github.com/newrelic/csec-java-agent).
