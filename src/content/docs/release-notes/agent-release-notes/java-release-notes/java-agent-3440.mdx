...
* The 3.43.0 version of the agent caused <DNT>Tomcat</DNT> to report a `ClassFormatException` error at startup. The error did not affect the application or agent.
