...
topics:
  ...
  - Agent release notes
  - Java release notes
releaseDateTime: '2018-08-08 12:08'
...
The New Relic Java agent is now fully compatible with Java 10. For more on JDK release and the Java agent, see [this topic on the Explorer's Hub](https://discuss.newrelic.com/t/jdk-releases-and-the-java-agent/55013).

* Not compatible with Java 6

In order to continue to innovate and efficiently provide new capabilities to our customers who run on the JVM, this and future agent versions are not compatible with Java 6. If you are running Java 6, you may continue to use Java agent 4.3.0 or lower. For details, see [this topic on the Explorer's Hub](https://discuss.newrelic.com/t/with-support-for-java-10-new-relic-deprecates-java-6/57738).
