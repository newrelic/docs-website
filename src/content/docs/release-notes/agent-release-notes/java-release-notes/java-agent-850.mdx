...
When the legacy Struts 2 point cut instrumentation is removed in a future release, it will be replaced with a new instrumentation module, with the same functionality.
</Callout>
