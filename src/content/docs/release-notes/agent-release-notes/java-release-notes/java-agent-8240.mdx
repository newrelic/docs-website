...
features: [“Support MongoDB Reactive Streams 5.2.0 and up”, “Jedis 6 support”, “Updates to support sampling_target config”]
bugs: [“CouchBase: Add skip class to prevent double instrumentation”, “Spring WebClient 5.x: Only wrap headers instead of the entire response”]
security: []
---
<ButtonGroup>
  <ButtonLink
    role="button"
    to="https://download.newrelic.com/newrelic/java-agent/newrelic-agent/8.24.0/"
    variant="primary"
  >
...
- Updates to support sampling_target config. by @jbedell-newrelic in [2471](https://github.com/newrelic/newrelic-java-agent/pull/2471)
