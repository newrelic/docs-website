...
- <DNT>Jetty<DNT> v12 Support: The security agent now also support <DNT>Jetty<DNT> version 12 and higher [106](https://github.com/newrelic/csec-java-agent/pull/106)
