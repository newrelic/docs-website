...
* Fix: <DNT>Jetty<DNT> 9.1 transactions were not showing up in 3.3.x or higher agents

  Starting with the 3.3.1 agent, customers were not seeing transactions from <DNT>Jetty<DNT> 9.1. This bug has been fixed.
