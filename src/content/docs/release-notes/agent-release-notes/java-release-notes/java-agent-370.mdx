...
features: ["Flexible capturing of attributes", "Agent-Side High Security Configuration", "Discovery of hostname reported to New Relic", "Improved JMX metric naming", "Improved <DNT>Jetty<DNT> coverage"]
...
* Improved <DNT>Jetty<DNT> coverage

  <DNT>Jetty<DNT> versions 9.04 through 9.06 were not instrumented. This has been fixed.
