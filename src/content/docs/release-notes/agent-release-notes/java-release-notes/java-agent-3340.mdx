...
* Fixes a <DNT>Tomcat</DNT>-specific issue where Transactions would incorrectly report extremely long response times in the `ServletRequestListener.requestInitialized()` method.
