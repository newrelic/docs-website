...
version: 9.0.2.245
downloadLink: 'https://download.newrelic.com/php_agent/archive/9.0.2.245/'
---
...
* **Potential memory exhaustion for long running transactions.** See description under _Known issues and workarounds_ in the [PHP 9.0.0.242 release notes](https://docs.newrelic.com/docs/release-notes/agent-release-notes/php-release-notes/php-agent-900242).
