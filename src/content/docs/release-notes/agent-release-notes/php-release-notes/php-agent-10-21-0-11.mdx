...
features: []
bugs: ['end guzzle's external segment for rejected request']
security: ['Upgrade golang to 1.22']
---
## New Relic PHP agent v10.21.0.11

### Bug fixes
* fix(agent): end guzzle's external segment for rejected request (https://github.com/newrelic/newrelic-php-agent/pull/883)

### Security updates
* security(daemon): Upgrade golang to 1.22 (https://github.com/newrelic/newrelic-php-agent/pull/890)
