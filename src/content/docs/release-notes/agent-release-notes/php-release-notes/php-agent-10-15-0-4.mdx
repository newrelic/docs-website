...
version: 10.15.0.4
downloadLink: 'https://download.newrelic.com/php_agent/archive/10.15.0.4'
features: ['Add support for PHP 8.3']
bugs: ['Remove NULL <DNT>Docker/DNT> ID warning message']
security: []
---
...
* Removes a warning message for `NULL` <DNT>Docker/DNT> ID
