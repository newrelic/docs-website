...
version: 11.2.0.15
downloadLink: 'https://download.newrelic.com/php_agent/archive/11.2.0.15'
features: ['Use composer API for vulnerability package management detection', 'Add Symfony 6 & 7 support']
bugs: ['Fixes newrelic_notice_error API for PHP 8+']
security: ['Upgrade Golang version to 1.23.1']
---
...
* If possible, use composer runtime API to collect information about PHP packages used by the application for [New Relic Vulnerability Management](https://docs.newrelic.com/docs/vulnerability-management/overview/).
...
* Fixes newrelic_notice_error() API for PHP 8+.
