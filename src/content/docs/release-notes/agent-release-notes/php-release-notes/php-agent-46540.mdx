...
topics:
  ...
  - Agent release notes
  - PHP Release Notes
releaseDateTime: '2014-02-27 23:55'
releaseVersion: 4.6.5.40
downloadLink: ''
---
...
* Add Laravel 4.0 support
  ...
  If you are already using the LaravelNewrelicServiceProvider from [https://packagist.org/packages/intouch/laravel-newrelic](https://packagist.org/packages/intouch/laravel-newrelic) then we recommend removing that from the list of service providers, and relying on our native support instead.
