...
version: 10.17.0.7
downloadLink: 'https://download.newrelic.com/php_agent/archive/10.17.0.7'
features: ['Adds package detection information']
bugs: ['Fix DT W3C trace state header generation']
security: []
---
...
* The PHP agent now sends up package detection information that can be viewed on the environment page. This feature will be enabled by default and you can find more information about this INI configuration [here](https://docs.newrelic.com/docs/apm/agents/php-agent/configuration/php-agent-configuration/#inivar-package-detection).
