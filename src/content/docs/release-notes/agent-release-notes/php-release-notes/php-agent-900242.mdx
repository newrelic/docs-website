...
\*\*_NOTE: A more detailed explanation of these options can be found in our [Explorer’s Hub post](https://support.newrelic.com/s/hubtopic/aAX8W0000008aaT/potential-memory-exhaustion-for-long-running-transactions-with-php-agent-9x)._
