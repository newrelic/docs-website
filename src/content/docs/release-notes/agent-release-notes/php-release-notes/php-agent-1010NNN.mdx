...
---
subject: PHP agent
releaseDate: '2022-MM-DD'
version: 10.0.1.NNN
downloadLink: 'https://download.newrelic.com/php_agent/archive/10.1.0.NNN'
---
...
* APM logs in context support for Monolog 2 and 3
  ...
  The PHP agent can also now forward log messages from Monolog for viewing on the New Relic One platform.  
  ...
  To learn more about APM logs in context see the [documentation](https://docs.newrelic.com/docs/apm/new-relic-apm/getting-started/get-started-logs-context).

  For more information about logs in context and the PHP agent check the following [documentation](https://docs.newrelic.com/docs/logs/logs-context/configure-logs-context-php/).
