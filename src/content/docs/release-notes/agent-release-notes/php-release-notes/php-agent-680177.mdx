...
topics:
  ...
  - Agent release notes
  - PHP Release Notes
releaseDateTime: '2016-11-09 11:15'
releaseVersion: 6.8.0.177
downloadLink: ''
---
...
* [Instance information](https://docs.newrelic.com/docs/apm/applications-menu/features/analyze-database-instance-level-performance-issues) for the mysql, mysqli, and PDO mysql extensions is now captured. Slow database queries and transaction traces now include the name of the host (including the port or socket) and database that the query was run against.
