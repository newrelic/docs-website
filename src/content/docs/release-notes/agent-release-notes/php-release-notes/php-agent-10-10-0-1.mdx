...
version: 10.10.0.1
downloadLink: 'https://download.newrelic.com/php_agent/archive/10.10.0.1'
features: ['Add ARM64 binaries for PHP 8.0, 8.1, 8.2']
bugs: ['Better handling for cases where both DT and CAT are enabled']
security: []
---
...
* ARM64 binaries are now available for PHP 8.0, 8.1, and 8.2.  Please see our [docs](https://docs.newrelic.com/docs/apm/agents/php-agent/installation/php-agent-installation-overview/#install-tar) for installation instructions.

### Bug Fixes

* Additional handling/msg in the case of both DT and CAT being enabled [#658](https://github.com/newrelic/newrelic-php-agent/issues/658)
