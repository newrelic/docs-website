...
version: 11.3.0.16
downloadLink: 'https://download.newrelic.com/php_agent/archive/11.3.0.16'
features: ['Memcached instance metrics with hostname', 'Dockerized Daemon supports arm64']
bugs: ['Fixes possible duplicate INI files on Debian', 'Fixes argument skipping during mysqli::real_connect'']
security: []
---
...
* [Dockerized Daemon](https://github.com/newrelic/newrelic-php-daemon-docker) now supports arm64
