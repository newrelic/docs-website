...
* The PHP agent now supports APM Log Local Decoration. See the [PHP Agent Logs In Context](https://docs.newrelic.com/docs/logs/logs-context/configure-logs-context-php/) page for more information.
