...
version: 10.13.0.2
downloadLink: 'https://download.newrelic.com/php_agent/archive/10.13.0.2'
features: ['Add APM Log Decorating']
bugs: []
security: []
---
...
* The PHP agent now supports APM local log decoration. See the [PHP Agent Logs In Context](https://docs.newrelic.com/docs/logs/logs-context/configure-logs-context-php/) page for more information.
