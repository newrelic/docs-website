...
features: ['Add APM Log Context Attributes', 'Add Docker v2 container ID support']
bugs: ['Fixes deprecation warnings with mysqli and PHP 8.1+', 'Fix errors for PHP 8+ in debug mode']
