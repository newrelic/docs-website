...
topics:
  ...
  - Agent release notes
  - PHP Release Notes
releaseDateTime: '2018-12-05 11:00'
releaseVersion: 8.4.0.231
downloadLink: 'https://download.newrelic.com/php_agent/archive/8.4.0.231/'
---
...
* **Support for Distributed tracing**
  ...
  [Read more about about distributed tracing in the PHP Agent](https://docs.newrelic.com/docs/agents/php-agent/features/distributed-tracing-php).
