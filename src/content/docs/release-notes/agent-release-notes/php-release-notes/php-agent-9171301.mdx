...
features: []
bugs: ['Fix `mysqli_commit` instrumentation returning NULL', 'Fix parameters not being passed by reference in PDO instrumentation', 'Fix "Unknown PHP version: 8.0" error on Debian and Ubuntu systems'] 
security: []
---
