...
* Add Redis Cluster instrumentation ([#1212](https://github.com/newrelic/newrelic-php-agent/pull/1212) / [#1206](https://github.com/newrelic/newrelic-php-agent/pull/1206)). Resolves [#130](https://github.com/newrelic/newrelic-php-agent/issues/130).
   * Thank you [@shavounet](https://github.com/shavounet) for your contribution!

### Security updates

* Upgrade golang to 1.26.4 ([#1232](https://github.com/newrelic/newrelic-php-agent/pull/1232))
* Update outdated dependencies ([1241](https://github.com/newrelic/newrelic-php-agent/pull/1241))

### Bug Fixes

* Fix realpath buffer overrun in install-util ([#1221](https://github.com/newrelic/newrelic-php-agent/pull/1221))
* Avoid stack overflow ([#1222](https://github.com/newrelic/newrelic-php-agent/pull/1222))
* Report correct Instance/Reporting count ([#1231](https://github.com/newrelic/newrelic-php-agent/pull/1231))
* Mitigate possible snprintf overflow ([#1223](https://github.com/newrelic/newrelic-php-agent/pull/1223))
* Remove double allocation of request_uri string ([#1236](https://github.com/newrelic/newrelic-php-agent/pull/1236))
