...
version: 8.6.0.238
downloadLink: 'https://download.newrelic.com/php_agent/archive/8.6.0.238/'
---
...
* Invoking [`function_exists()`](https://secure.php.net/function_exists) on a function disabled with the [`disable_functions`](https://secure.php.net/manual/en/ini.core.php#ini.disable-functions) configuration directive will now correctly return `false`.
