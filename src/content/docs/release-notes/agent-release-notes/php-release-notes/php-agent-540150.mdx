...
topics:
  ...
  - Agent release notes
  - PHP Release Notes
releaseDateTime: '2016-01-26 11:15'
releaseVersion: 5.4.0.150
downloadLink: ''
---
...
* Experimental support for instrumenting Guzzle has been added.
  ...
  More information can be found [on our Guzzle documentation page](https://docs.newrelic.com/docs/agents/php-agent/frameworks-libraries/guzzle).
