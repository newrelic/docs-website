...
### Bug fixes
* Fix MongoDB instrumentation for PHP 8.0+ (https://github.com/newrelic/newrelic-php-agent/pull/878)
* Fix error where Guzzle 7+ was sending up major version for VM (https://github.com/newrelic/newrelic-php-agent/pull/904)
* Install correctly on minimalist operating systems (https://github.com/newrelic/newrelic-php-agent/pull/913)
* Fix Doctrine 2.18+ detection (https://github.com/newrelic/newrelic-php-agent/pull/916)
* Slim transaction naming updates (https://github.com/newrelic/newrelic-php-agent/pull/917)
* Fix rhel and alpine init scripts (https://github.com/newrelic/newrelic-php-agent/pull/919)

### Important end-of-life information

* Support for PHP versions 7.0 and 7.1 has been deprecated.
