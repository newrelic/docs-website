...
* [#1129](https://github.com/newrelic/newrelic-php-agent/issues/1129) - Bump golang version 1.25.3 - [#1130](https://github.com/newrelic/newrelic-php-agent/pull/1130)

### Bug Fixes

* fix(agent): Fix Laravel queue job exception handling - [#1122](https://github.com/newrelic/newrelic-php-agent/pull/1122)
