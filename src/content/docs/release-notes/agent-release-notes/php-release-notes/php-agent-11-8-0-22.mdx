...
features: ['Add AWS DynamoDB Relationship']
bugs: []
security: ['Upgrade golang to 1.24.1', 'Upgrade Golang x/net version to 0.38.0']
---
...
* feat(agent): Add AWS DynamoDB Relationship

### Security

* security(daemon): bump golang to 1.24.1
