...
features: ['Drupal hook attribute instrumentation', 'instrumentation optimization']
bugs: []
security: []
---
...
* feat(agent): Drupal hook attribute instrumentation
* refactor(agent): Optimize user function instrumentation lookup for PHPs 8.0+
