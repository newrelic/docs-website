...
topics:
  ...
  - Agent release notes
  - Ruby release notes
releaseDateTime: '2015-10-19 11:32'
releaseVersion: 3.14.0.305
downloadLink: 'https://rubygems.org/downloads/newrelic_rpm-3.14.0.305.gem'
---
...
* `TransactionErrors` reported for APM error advanced analytics
  ...
  For more information, see [View APM errors and error traces](/docs/apm/applications-menu/events/view-apm-errors-error-traces).
