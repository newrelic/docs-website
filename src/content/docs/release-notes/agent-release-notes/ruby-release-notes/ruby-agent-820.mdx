...
bugs: ["Span events now recorded when using 'newrelic_ignore'", "Scrub non-unicode characters from DecoratingLogger", "Distributed tracing headers no longer emit errors when the agent is not connected"]
security: []
---
