...
topics:
  ...
  - Agent release notes
  - Ruby release notes
releaseDateTime: '2019-01-28 11:55'
...
* Tracer API for flexible custom instrumentation
  ...
  The same API contains additional methods for creating transactions and segments, and for interacting with the current transaction. For more details, see the [custom instrumentation documentation](https://docs.newrelic.com/docs/agents/ruby-agent/api-guides/ruby-custom-instrumentation).
