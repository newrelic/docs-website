...
features: ["ViewComponent instrumentation", "Use root path to access <DNT>Elasticsearch<DNT> cluster name", "Remove base64 dependency, use direct calls to String methods", "Add Falcon support", "Remove spans with name Ruby/Thread and Ruby/Fiber"]
bugs: []
security: []
---
...
Version 9.7.0 introduces ViewComponent instrumentation, changes the endpoint used to access the cluster name for <DNT>Elasticsearch<DNT> instrumentation, removes the creation of the Ruby/Thread and Ruby/Fiber spans, and adds support for Falcon.
...
- **Feature: Use root path to access <DNT>Elasticsearch<DNT> cluster name**
