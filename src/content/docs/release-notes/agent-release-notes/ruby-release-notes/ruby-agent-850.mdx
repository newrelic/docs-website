...
features: ["AWS: Support IMDSv2 by using a token with metadata API calls", "Add updated configuration options for transaction events and deprecated previous configs"]
bugs: ["Resolved Rails 5 + Puma errors", "Muffle anticipated stderr warnings for 'hostname' calls"]
security: []
---
