...
bugs: ["Environment Report now supports Rails 6.1+", "Eliminate add_method_tracer warnings when using Ruby 2.7", "Add missing field to Cross Application Tracing"]
security: []
---
