...
features: ["Drop support for Ruby 2.2 and 2.3", "Remove 37 previously deprecated configuration options", "Enable Thread instrumentation by default", "Add Fiber instrumentation", "Remove instrumentation for Acts As Solr, Authlogic, DataMapper, Rainbows, and Sunspot", "Remove support for Passenger 2.2.x-4.0.x, Puma 2.0.x, Grape 0.2.0, Padrino: 0.14.x, Rails 3.2.x, Sinatra 1.4.x and 1.5.x, Mongo 1.8.x-2.3.x, Sequel 3.37.x and 4.0.x, Delayed_Job 2.0.x-4.0.x, Sidekiq 4.2.x, Excon below 0.55.0, HttpClient 2.2.0-2.8.0, HttpRb 0.9.9-2.2.1, Typhoeus 0.5.3-1.2.x, Bunny 2.0.x-2.6.x, and ActiveMerchant 1.25.0-1.64.x", "Update API method set_transaction_name", "Remove API method NewRelic::Agent.disable_transaction_tracing", "Improve ActiveJob metric naming"]
