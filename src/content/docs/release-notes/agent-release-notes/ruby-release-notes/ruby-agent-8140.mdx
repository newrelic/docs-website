...
features: ["Speed up GUID generation", "Add instrumentation for Rails ActiveSupport::Notifications custom events"]
bugs: ["Fix how the agent handles an unknown Redis database index in RedisClient v0.11 and older"]
security: []
---
