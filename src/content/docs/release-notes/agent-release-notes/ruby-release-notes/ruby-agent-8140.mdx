...
bugs: ["Fix how the agent handles an unknown Redis database index in RedisClient versions older than v0.11", "Defer agent startup in Rails until after application-defined initializers have run"]
security: []
---
