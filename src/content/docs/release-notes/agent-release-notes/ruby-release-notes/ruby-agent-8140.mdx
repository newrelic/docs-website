...
features: ["Speed up GUID generation", "Add support for Rails ActiveSupport::Notifications for custom events"]
bugs: ["Support older versions of the RedisClient gem, handle unknown Redis database index", "Defer agent startup in Rails until after application-defined initializers have run"]
security: []
---
