...
features: ["Add Apache Kafka instrumentation for the rdkafka and ruby-kafka gems", "Add a configuration option to permit custom method tracers to be defined automatically", "Collect just MIME type for AcionDispatch 7.0+ requests"]
