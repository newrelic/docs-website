...
version: 9.7.1
downloadLink: https://rubygems.org/downloads/newrelic_rpm-9.7.1.gem
features: []
bugs: ["Stop suppressing ViewComponent errors", "Enforce maximum size limits for custom event attributes"]
security: []
---
