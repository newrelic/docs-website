...
topics:
  ...
  - Agent release notes
  - Ruby release notes
releaseDateTime: '2014-03-05 10:09'
releaseVersion: 3.7.3.199
downloadLink: ''
---
...
* Obfuscation for PostgreSQL explain plans
  ...
  For more information, see: [https://docs.newrelic.com/docs/traces/security-for-postgresql-explain-plans](https://docs.newrelic.com/docs/traces/security-for-postgresql-explain-plans)
