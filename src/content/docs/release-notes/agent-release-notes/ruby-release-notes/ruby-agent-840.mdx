...
features: ["Provide support for Rails 7.0", Improve the performance of NewRelic::Agent::GuidGenerator#generate_guid"]
bugs: ["Add ControllerInstrumentation::Shims to Sinatra framework"]
security: []
---
