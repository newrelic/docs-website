...
topics:
  ...
  - Agent release notes
  - Ruby release notes
releaseDateTime: '2013-05-30 13:09'
releaseVersion: 3.6.3.111
downloadLink: ''
---
...
* Better Sinatra Support
  ...
  A number of improvements have been made to our Sinatra instrumentation. More details: [https://newrelic.com/docs/ruby/sinatra-support-in-the-ruby-agent](https://newrelic.com/docs/ruby/sinatra-support-in-the-ruby-agent)
