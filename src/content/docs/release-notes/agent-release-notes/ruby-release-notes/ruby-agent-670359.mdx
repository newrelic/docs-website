...
* **Trace and Entity Metadata API**
  ...
  * [`Agent#linking_metadata`](https://www.rubydoc.info/gems/newrelic_rpm/NewRelic/Agent#linking_metadata-instance_method)
  * [`Tracer#trace_id`](https://www.rubydoc.info/gems/newrelic_rpm/NewRelic/Agent/Tracer#trace_id-class_method)
  * [`Tracer#span_id`](https://www.rubydoc.info/gems/newrelic_rpm/NewRelic/Agent/Tracer#span_id-class_method)
  * [`Tracer#sampled?`](https://www.rubydoc.info/gems/newrelic_rpm/NewRelic/Agent/Tracer#sampled?-class_method)
