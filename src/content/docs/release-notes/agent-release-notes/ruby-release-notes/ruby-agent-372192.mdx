...
topics:
  ...
  - Agent release notes
  - Ruby release notes
releaseDateTime: '2014-02-05 09:58'
releaseVersion: 3.7.2.192
downloadLink: ''
---
...
* Additional functionality for add_custom_parameters
  ...
  Calling add_custom_parameters adds parameters to the system codenamed Rubicon. For more information, see [http://newrelic.com/software-analytics](http://newrelic.com/software-analytics)
