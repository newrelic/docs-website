...
* **`add_method_tracer` refactored to use prepend over alias_method chaining**
  ...
  * [MethodTracer::ClassMethods#add_method_tracer](https://www.rubydoc.info/gems/newrelic_rpm/NewRelic/Agent/MethodTracer/ClassMethods#add_method_tracer-instance_method)
