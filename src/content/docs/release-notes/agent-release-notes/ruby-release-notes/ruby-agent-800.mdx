...
features: ["Distributed tracing enabled by default", "Cross Application is deprecated and disabled by default", "Update configuration default value for `span_events.max_samples_stored` from 1000 to 2000", "'add_method_tracer' now uses prepend chaining", "Add support for ARM64/Graviton2 platform using Ruby 3.0.2+"]
bugs: ["Correctly load configuration options from newrelic.yml"]
security: []
---
