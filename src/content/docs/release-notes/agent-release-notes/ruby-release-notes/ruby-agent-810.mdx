...
features: ["New instrumentation for Ruby standard library Logger"] 
bugs: ["Stop deadlocks between New Relic thread and Delayed Job sampling thread", "Allow Net::HTTP request to IPv6 addresses", "Properly install padrino instrumentation", "Allow integers to be passed to 'error_collector.ignore_status_codes' configuration"]
security: []
---
