...
bugs: ["Fix identification of Unicorn, Rainbows, and FastCGI dispatchers with Rack v3.0", "Fix recording of add_method_tracer code level metric attributes on private methods", "Fix undefined method :category error for NewRelic::Agent::Transaction::Class"]
security: []
---
