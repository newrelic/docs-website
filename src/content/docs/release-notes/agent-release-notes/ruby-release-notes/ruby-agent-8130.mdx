...
features: ["Updated support for Redis v5.0", "Updated support for Sidekiq v7.0", "Updated Rack v3.0 instrumentation to support the use of a block with Rack::Builder#run"]
bugs: ["Correctly identify Unicorn, Rainbows, and FastCGI with Rack v3.0", "'add_method_tracer' correctly records code level metric attributes on private methods"]
security: []
---
