...
topics:
  ...
  - Agent release notes
  - Ruby release notes
releaseDateTime: '2013-07-25 10:46'
releaseVersion: 3.6.6.147
downloadLink: ''
---
...
* HTTPClient and Curb support
  ...
  The Ruby agent now supports the HTTPClient and Curb HTTP libraries! Cross application tracing and more is fully supported for these libraries. For more details see [https://newrelic.com/docs/ruby/ruby-http-clients](https://newrelic.com/docs/ruby/ruby-http-clients).
