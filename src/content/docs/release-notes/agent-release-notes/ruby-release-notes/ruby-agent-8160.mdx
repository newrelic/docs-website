...
features: ["Add new Ruby on Rails library instrumentations. The agent newly supports or provides updated support for Action Cable, Action Controller, Action Mailbox, Action Mailer, Active Job, and Active Support"]
bugs: []
security: []
---
