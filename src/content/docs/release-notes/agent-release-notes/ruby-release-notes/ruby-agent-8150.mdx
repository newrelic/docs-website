...
features: ["Add support for Ruby 3.2.0", "Add instrumentation for concurrent-ruby", "Infinite Tracing uses batching and compression by default", "Add support for Padrino 0.15.2 and Sinatra 3"]
bugs: []
security: []
---
