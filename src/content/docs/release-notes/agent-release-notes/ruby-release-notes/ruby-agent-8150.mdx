...
features: ["Add support for Ruby 3.2.0", "Add instrumentation for concurrent-ruby", "Use batching and compression by default for Infinite Tracing", "Add support for Padrino 0.15.2", "Add support for Sinatra 3"]
bugs: []
security: []
---
