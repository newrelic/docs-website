...
features: ["Browser agent can run on applications using CSP nonces", "Distributed tracing may now be set in server-side application configuration"]
bugs: ["Update conflicts with use of Module#Prepend", "Update support for ActiveRecord 6.1+ instrumentation"]
security: []
---
