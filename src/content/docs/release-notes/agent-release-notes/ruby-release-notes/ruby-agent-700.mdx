...
features: ["Support for Ruby 2.0 and 2.1 dropped", "Remove previously deprecated config options, API methods, and attribute", "Remove support for Rails 3.0 and 3.1", "Prepend auto-instrumentation strategies avaliable for most Ruby gems/libraries"]
bugs: ["Transaction nesting max depth is now always consistent with length of segments"]
