...
features: ["Add <DNT>Roda</DNT> instrumentation", "New allow_all_headers configuration option", "Improved error tracking transaction linking", "Use Net::HTTP native timeout logic"]
bugs: []
security: []
---
...
- **Feature: Add <DNT>Roda</DNT> instrumentation**

  [Roda](https://roda.jeremyevans.net/) is a now an instrumented framework. The agent currently supports <DNT>Roda</DNT> versions 3.19.0+. [PR#2144](https://github.com/newrelic/newrelic-ruby-agent/pull/2144)
