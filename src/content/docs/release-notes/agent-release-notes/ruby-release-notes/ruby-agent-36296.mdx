...
topics:
  ...
  - Agent release notes
  - Ruby release notes
releaseDateTime: '2013-05-09 12:21'
releaseVersion: 3.6.2.96
downloadLink: ''
---
...
* Sequel support
  ...
  The Ruby agent now supports Sequel, a database toolkit for Ruby. This includes capturing SQL calls and model operations in transaction traces, and recording slow SQL calls. See [https://newrelic.com/docs/ruby/sequel-instrumentation](https://newrelic.com/docs/ruby/sequel-instrumentation) for full details.
