...
topics:
  ...
  - Agent release notes
  - NET release notes
releaseDateTime: '2016-08-31 15:00'
releaseVersion: 5.22.6.0
downloadLink: ''
---

### New Features

* Minor performance improvement with [cross application tracing](/docs/apm/transactions/cross-application-traces/cross-application-tracing).
