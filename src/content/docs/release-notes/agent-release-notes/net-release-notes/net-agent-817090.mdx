...
topics:
  ...
  - Agent release notes
  - NET release notes
releaseDateTime: '2018-04-19 16:00'
releaseVersion: 8.1.709.0
downloadLink: ''
---

<Callout variant="important">
  This release has been unpublished. Use version [8.1.712.0](/docs/release-notes/agent-release-notes/net-release-notes/net-agent-817120) or higher.
