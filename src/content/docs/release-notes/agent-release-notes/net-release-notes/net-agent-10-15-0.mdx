...
features: ['Add support for Serilog.Extensions.Logging and NLog.Extensions.Logging.','Log a warning when an unsupported .NET version is detected.','Use HttpWebRequest instead of HttpClient on .NET Framework.']
bugs: []
security: []
---
