...
* This release of the agent removes support for .NET Framework versions earlier than 4.5. See our [community post](https://support.newrelic.com/s/hubtopic/aAX8W0000008ZIo/net-agent-security-enhancements-and-legacy-framework-deprecation) about this from November of last year, for more details.
