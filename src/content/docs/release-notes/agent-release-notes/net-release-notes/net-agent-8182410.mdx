...
topics:
  ...
  - Agent release notes
  - NET release notes
releaseDateTime: '2019-08-26 15:00'
releaseVersion: 8.18.241.0
downloadLink: ''
---
...
* **\[.NET Core]** Adds support in the .NET Core Agent for [StackExchange.Redis](https://www.nuget.org/packages/StackExchange.Redis).
