...
topics:
  ...
  - Agent release notes
  - NET release notes
releaseDateTime: '2012-08-22 17:11'
releaseVersion: 2.0.11.1
downloadLink: ''
---
...
* Removed all of the static docs from the installer. All documents for the .net Agent are now available at: [https://newrelic.com/docs/dotnet/](https://newrelic.com/docs/dotnet/)
