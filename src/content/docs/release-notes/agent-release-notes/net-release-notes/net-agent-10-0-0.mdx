...
* This is a major release of the agent, and contains breaking changes. See the [migration guide](/docs/apm/agents/net-agent/getting-started/9x-to-10x-agent-migration-guide) for details.
