...
features: ['Add support for filtering log events based on a list of log levels so that they are not forwarded to New Relic.','Instrument OpenAsync() for SQL libraries.']
