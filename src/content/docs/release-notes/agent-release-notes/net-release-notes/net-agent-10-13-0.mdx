...
security: ['Update Grpc.Net.Client library to address <DNT>Dependabot<DNT> alerts.']
---

### Security

* Update Grpc.Net.Client library to address <DNT>Dependabot<DNT> alerts. ([#1768](https://github.com/newrelic/newrelic-dotnet-agent/issues/1768)) ([#1769](https://github.com/newrelic/newrelic-dotnet-agent/issues/1769)) ([eee7564](https://github.com/newrelic/newrelic-dotnet-agent/commit/eee7564cbe79b653ad7909af36f09c9a64cdb731))
