...
Once published, the release artifacts for this release can be found at [https://download.newrelic.com/dot_net_agent/latest_release/](https://download.newrelic.com/dot_net_agent/latest_release/) or on NuGet.org.
