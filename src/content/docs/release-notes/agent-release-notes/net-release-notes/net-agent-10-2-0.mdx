...
* Resolves an issue where some instrumentation was missing for M`icrosoft.Data.SqlClient` in .NET Framework. [#1248](https://github.com/newrelic/newrelic-dotnet-agent/pull/1248)
