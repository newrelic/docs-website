...
features: []
bugs: ['Fix a crash that can occur when the profiler logs certain characters.','Improve handling of .NET environments and settings from appsettings.*.json files.','Obfuscate logged appSettings values.','Revert RabbitMQ HandleBasicDeliver instrumentation change from [#1972](https":"//github.com/newrelic/newrelic-dotnet-agent/issues/1972).','Update instrumentation to support Elasticsearch v8.11.0.']
security: []
---
