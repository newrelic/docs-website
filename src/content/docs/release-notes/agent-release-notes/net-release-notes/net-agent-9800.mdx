...
The informational blog can be found [here](https://devblogs.microsoft.com/dotnet/net-core-2-0-will-reach-end-of-life-on-september-1-2018).  The official product lifecycle start and end dates can be found [here](https://dotnet.microsoft.com/en-us/platform/support/policy/dotnet-core).  The dotnet agent support of these framework versions is will continue as is with the released versions.  In a future major release, we will target .NET Core 3.1 onwards.
* Microsoft has officially EOL .NET Core version 2.1 on August 21, 2021.
The informational blog can be found [here](https://devblogs.microsoft.com/dotnet/net-core-2-1-will-reach-end-of-support-on-august-21-2021).  The official product lifecycle start and end dates can be found [here](https://dotnet.microsoft.com/en-us/platform/support/policy/dotnet-core).  The dotnet agent support of these framework versions is will continue as is with the released versions.  In a future major release, we will target .NET Core 3.1 onwards.
* Microsoft has officially EOL .NET Core version 2.2 on December 23, 2019.
The informational blog can be found [here](https://devblogs.microsoft.com/dotnet/net-core-2-2-will-reach-end-of-life-on-december-23-2019).  The official product lifecycle start and end dates can be found [here](https://dotnet.microsoft.com/en-us/platform/support/policy/dotnet-core).  The dotnet agent support of these framework versions is will continue as is with the released versions.  In a future major release, we will target .NET Core 3.1 onwards.
* Microsoft has officially EOL .NET Core version 3.0 on March 3, 2020.
The informational blog can be found [here](https://devblogs.microsoft.com/dotnet/net-core-3-0-end-of-life/).  The official product lifecycle start and end dates can be found [here](https://dotnet.microsoft.com/en-us/platform/support/policy/dotnet-core).  The dotnet agent support of these framework versions is will continue as is with the released versions.  In a future major release, we will target .NET Core 3.1 onwards.
