...
topics:
  ...
  - Agent release notes
  - NET release notes
releaseDateTime: '2017-05-04 15:00'
releaseVersion: ' 6.11.613.0'
downloadLink: 'https://download.newrelic.com/dot_net_agent/server2003_final/'
---

### New Features

* A new configuration option to supply a proxy URI path has been added to the `newrelic.config` file. See [`proxy-uripath`](/docs/agents/net-agent/configuration/net-agent-configuration#proxy-uripath).
