...
security: ["bump formidable and superagent"]
bugs: ["Fixed issue with CJS being imported as ESM"]
features: ["Added API `ignoreApdex` to ignore calculating apdex for the active transaction","Migrated @newrelic/superagent into agent","Migrated @newrelic/aws-sdk into agent","Migrated @newrelic/koa into mainline agent"]
---
