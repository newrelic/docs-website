...
security: []
bugs: ["Handled assigning headers in LambdaProxyWebRequest when there are no headers present"]
features: ["Added support for getting container ids from ECS metadata API"]
---
