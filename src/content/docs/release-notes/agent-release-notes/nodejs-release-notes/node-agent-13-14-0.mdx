...
security: []
bugs: ["Updated `@google/genai` subscriber to handle the new `embedContentInternal` method in 1.42.0"]
features: ["Added functionality to ingest logs from Azure Functions App automatically","Added support for error causes","Added ability to delay the start of the Profiler and run for n milliseconds before shutting down."]
---
