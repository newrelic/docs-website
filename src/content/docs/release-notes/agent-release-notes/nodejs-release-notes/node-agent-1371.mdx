...
<Callout variant="important">
  This release has been re-published to npm as 1.37.2. Please use version [1.37.2](/docs/release-notes/agent-release-notes/nodejs-release-notes/node-agent-1372) or higher.
</Callout>
