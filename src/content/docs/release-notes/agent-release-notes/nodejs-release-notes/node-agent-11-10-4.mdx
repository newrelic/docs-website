...
security: []
bugs: ["Resolved application logs getting blocked when an excessive payload is encountered","Updated Shim to properly calculate the _moduleRoot on windows environments"]
features: []
---
...
* Resolved application logs getting blocked when encountering an excessive payload ([#2013](https://github.com/newrelic/node-newrelic/pull/2013)) ([365ded4](https://github.com/newrelic/node-newrelic/commit/365ded432b7781ee9c896bf0e067dac8cc2c45cc))
...
* Abstracted registering of new aggregators into a Harvester class that's responsible for starting, stopping, and updating all registered aggregators. ([#1994](https://github.com/newrelic/node-newrelic/pull/1994)) ([1fb85a6](https://github.com/newrelic/node-newrelic/commit/1fb85a6f97c522ce2951911c670fcbddaa218049))
