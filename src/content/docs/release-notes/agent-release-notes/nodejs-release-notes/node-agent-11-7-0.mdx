...
security: []
bugs: ["Update import-in-the-middle to fix ESM on Node 18.19.0"]
features: ["Added instrumentation for Restify async handlers","Added deserialized X-NewRelic-Synthetics-Info header to transaction and transaction trace intrinsic attributes"]
---
...
We recommend updating to the latest agent version as soon as it's available. If you can't upgrade to the latest version, update your agents to a version no more than 90 days old. Read more about keeping agents up to date [here](https://docs.newrelic.com/docs/new-relic-solutions/new-relic-one/install-configure/update-new-relic-agent/).
