...
security: []
bugs: ["Updated `koa` instrumentation to properly get the matched route name and to handle changes in `@koa/router@13.0.0`"]
features: ["Added instrumentation support for Express 5 beta"]
---
