...
security: ["bump follow-redirects from 1.15.5 to 1.15.6"]
bugs: []
features: ["Added instrumentation for `initializeUnorderedBulkOp`, and `initializeOrderedBulkOp` in mongodb 4+","Added support for Mongo v5+","Added `guid` attribute to `TransactionError` events"]
---
