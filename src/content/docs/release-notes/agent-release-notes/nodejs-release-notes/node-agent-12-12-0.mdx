...
security: []
bugs: ["Updated default config to accept `undefined` as default value"]
features: ["Added health check support for upcoming feature","Added opentelemetry bridge instrumentation that adds a context manager, and processor to handle synthesizing segments and time slice metrics."]
---
