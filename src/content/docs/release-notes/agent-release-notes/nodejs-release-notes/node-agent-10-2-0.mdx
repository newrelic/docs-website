...
security: []
bugs: ["log execArgs at the debug level"]
features: ["added supportability metrics to indicate how agent was loaded and if --enable-source-maps was passed to Node.js runtime"]
---
