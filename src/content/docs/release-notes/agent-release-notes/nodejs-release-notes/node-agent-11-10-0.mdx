...
security: ["Redacted ingest key in trace level logs"]
bugs: []
features: ["Added transaction ID to ErrorTrace event","Added llm attribute to all transactions that contain llm spans for openai"]
---
