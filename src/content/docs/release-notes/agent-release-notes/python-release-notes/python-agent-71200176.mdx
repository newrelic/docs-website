...
* **Add APM Logs in Context**
  ...
  To learn more about APM logs in context see the documentation [here](/docs/logs/logs-context/logs-in-context).
  ...
  * **Adds support for forwarding application logs to New Relic**
    This automatically sends application logs that have been enriched to power APM logs in context. This is disabled by default in this release. This will be on by default in a future release.
