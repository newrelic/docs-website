...
* **Add support for redis v4.3.5 & v4.4.0 methods**

  New methods added in redis v4.3.5 & v4.4.0 will now be automatically instrumented.
...
* **Initialize external node properties**
  ...
  A bug caused by unintialized external node properties when making web requests has been fixed. Thank you [@kmorey](https://github.com/kmorey) for your contribution!
