...
<Callout variant="important">
  This release has been superseded. Please use version [2.86.2.68](/docs/release-notes/agent-release-notes/python-release-notes/python-agent-286268) or higher.
</Callout>
