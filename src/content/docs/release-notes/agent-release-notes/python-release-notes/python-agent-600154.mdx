...
This release of the Python agent adds instrumentation for [httpx](https://www.python-httpx.org/), removes support for Python 3.5, and includes performance enhancements.
