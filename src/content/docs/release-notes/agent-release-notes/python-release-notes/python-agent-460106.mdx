...
releaseDateTime: '2018-11-12 14:00'
releaseVersion: 4.6.0.106
...
* **Monitoring of Lambda functions**
  ...
  This release includes changes to the agent to enable monitoring of Lambda functions. If you are interested in learning more or previewing New Relic Lambda monitoring please email [lambda_preview@newrelic.com](mailto:lambda_preview@newrelic.com).
