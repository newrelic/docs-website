...
More information can be found in the [Message Queue documentation](https://docs.newrelic.com/docs/apm/agents/python-agent/supported-features/python-message-queues/)
