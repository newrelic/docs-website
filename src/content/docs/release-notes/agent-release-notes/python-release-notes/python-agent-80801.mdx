...
See the New Relic Ruby agent EOL policy for information about agent releases and support dates. (https://docs.newrelic.com/docs/apm/agents/python-agent/getting-started/python-agent-eol-policy/)
