...
![Image of breakdown UI page](src/images/python-event-loop-breakdown-table.png)

Time spent waiting on other transactions will be shown in the transaction _Trace details_ page, as shown here:

![Image of breakdown UI page](src/images/python-event-loop-trace-details.png)
...
![Image of breakdown UI page](src/images/python-event-loop-insights-table.png)
