...
features: ['Add support for asgiref 3.8.0 and above', 'AI monitoring configuration', 'AI monitoring public API methods', 'AI monitoring', 'Add support for OpenAI', 'Add support for Langchain', 'Add support for AWS Bedrock']
bugs: []
security: []
---
