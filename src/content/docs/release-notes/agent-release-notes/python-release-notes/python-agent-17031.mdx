...
* Instrumentation of the <DNT>feedparser</DNT> module was causing an exception when a file like object rather than a string was passed to the <DNT>feedparser</DNT>.parse() function.
