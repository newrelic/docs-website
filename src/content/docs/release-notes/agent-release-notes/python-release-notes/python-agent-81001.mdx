...
bugs: ['Fix crash in MetricNormalizationRules']
security: []
---

## Notes

This release of the Python agent fixes an issue with MetricNormalizationRules, and adds support for new commands introduced in [Redis v5](https://pypi.org/project/redis/).
