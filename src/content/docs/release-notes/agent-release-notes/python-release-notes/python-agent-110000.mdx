...
* Removes various deprecated settings
  ...
  * The following settings have been removed:
    ...
    | `analytics_events.max_samples_stored`   | [`transaction_events.max_samples_stored`](/docs/apm/agents/python-agent/configuration/python-agent-configuration#transaction-events-max-samples-stored)                                                                     |
