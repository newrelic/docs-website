...
This release of the Python agent adds support for async elasticsearch, fixes a graphql configuration parsing issue, fixes a bug in the [Kombu](https://pypi.org/project/kombu/) instrumentation and re-enables the Kombu instrumentation.
...
* Add async support for elasticsearch
  ...
  * Adds support for async elasticsearch](). Thanks [fagnerzulin](https://github.com/fagnerzulin) for the contribution!
