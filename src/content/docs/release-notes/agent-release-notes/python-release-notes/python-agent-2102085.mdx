...
* **Instrumentation for <DNT>Dropbox</DNT> v8.0 and newer caused error log messages**

  <DNT>Dropbox</DNT> client version 8.0 or higher raised instrumentation errors. These errors did not prevent metrics on <DNT>Dropbox</DNT> from being sent. These errors have been removed.
