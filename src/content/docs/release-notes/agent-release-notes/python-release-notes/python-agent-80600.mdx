...
This release of the Python agent adds support for <DNT>Elasticsearch<DNT> 8, redis.asyncio, and exposes apdexPerfZone.
...
* **Add support for eleasicsearch 8**
  Add instrumentation support for <DNT>Elasticsearch<DNT> version 8.
