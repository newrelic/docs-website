...
* **Removed builds for Python 3.5**

    Python 3.5 support was deprecated in v6.0.0, and is now fully removed. Please update to a newer version of Python for continued support.
