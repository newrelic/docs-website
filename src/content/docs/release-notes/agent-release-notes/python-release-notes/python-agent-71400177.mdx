...
* **Fixes `threading.currentThread` deprecation**
  ...
  `threading.currentThread` was [deprecated in Python 3.10](https://docs.python.org/3.12/whatsnew/3.10.html#deprecated) and has been replaced with `threading.current_thread`. Thank you [hugovk](https://github.com/hugovk) for you contribution to the agent!
