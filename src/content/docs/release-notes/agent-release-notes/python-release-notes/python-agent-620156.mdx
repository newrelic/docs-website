...
* **Adds garbage collection runtime metrics.**
  ...
  Records statistics as metrics after garbage collection sweeps. This feature is disabled by default and can be enabled and configured with [these settings](https://docs.newrelic.com/docs/agents/python-agent/configuration/python-agent-configuration).
