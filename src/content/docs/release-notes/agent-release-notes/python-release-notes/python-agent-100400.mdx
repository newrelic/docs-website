...
features: ['Add support for async PyMongo', 'Add support for Motor', 'Add support for aiomysql', 'Add AWS account ID configuration setting', 'Link AWS entity for DynamoDB', 'Add AWS entity for Lambda']
...
This release of the Python agent adds support for async [PyMongo](https://pypi.org/project/pymongo/), [Motor](https://pypi.org/project/motor/), [aiomysql](https://pypi.org/project/aiomysql/), a new AWS account ID configuration setting, linking a AWS entity for DynamoDB and Lambda, and fixes a path typing issue in newrelic.initialize().
