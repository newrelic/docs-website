...
This release of the Python agent enables log forwarding to New Relic by default. It also addressed a bug related to compressed bytes calculations and adds a new top level data usage supportability metric to the agent.
