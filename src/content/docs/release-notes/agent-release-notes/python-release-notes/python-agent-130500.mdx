...
bugs: ['Fix incomplete package reporting to New Relic', 'Reduce overhead of package version lookups', "Fix get_linking_metadata to properly pass through the specified application", 'Fix MySQL database name reporting when using the database keyword argument', 'Fix warning when accessing LangGraph v1.1+ GraphOutput values']
security: []
---
