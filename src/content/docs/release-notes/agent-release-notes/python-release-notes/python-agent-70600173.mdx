...
features: ['Add support for Aredis']
bugs: ['Fix garbage collection sampler attribute errors', 'Safeguards against lost data with infinite tracing']
security: ['Upgrades to the AWS metadata endpoint']
---
