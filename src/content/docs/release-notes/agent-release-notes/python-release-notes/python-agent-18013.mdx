...
releaseDateTime: '2012-11-14 05:00'
releaseVersion: 1.8.0.13
downloadLink: ''
---
...
This release of the Python agent enables the ability to set apdex values and alerts for key transactions (discussed [here](https://newrelic.com/docs/site/key-transactions))
