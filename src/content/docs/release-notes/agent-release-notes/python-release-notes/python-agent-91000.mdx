...
This release of the Python agent adds instrumentation for [AIOBotocore](https://pypi.org/project/aiobotocore/), support for Meta Llama3 and Mistral AI in Amazon Bedrock, fixes an issue with error parsing within [OpenAI](https://pypi.org/project/openai/), and updates [Loguru](https://pypi.org/project/loguru/)'s instrumentation to use milliseconds instead of seconds.
