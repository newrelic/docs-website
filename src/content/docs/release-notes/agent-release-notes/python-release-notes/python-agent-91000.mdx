...
* Adds support for Meta Llama3 and Mistral AI in <DoNotTranslate>Amazon Bedrock</DoNotTranslate>>
...
* **Add new <DoNotTranslate>Amazon Bedrock</DoNotTranslate>> models**

    * Add instrumentation for the following <DoNotTranslate>Amazon Bedrock</DoNotTranslate>> models:
        * Meta Llama3
        * Mistral AI
