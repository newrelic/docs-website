...
* Adds support for Meta Llama3 and Mistral AI in <DNT>Amazon Bedrock</DNT>
...
* **Add new <DNT>Amazon Bedrock</DNT> models**

    * Add instrumentation for the following <DNT>Amazon Bedrock</DNT> models:
        * Meta Llama3
        * Mistral AI
