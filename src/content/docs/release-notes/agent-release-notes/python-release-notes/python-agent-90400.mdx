...
features: ['nonced context security policies', 'wheels for Python 3.12 and musl', 'newrelic.agent.CallableObjectProxy API', 'ObjectWrapper API deprecation', 'get_browser_timing_footer API deprecation']
bugs: ['distributed tracing headers in kafka', 'case sensitive header in ASGIBrowserMiddleware']
security: []
---
