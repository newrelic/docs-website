...
This release of the Python agent adds instrumentation for [aiomcache](https://pypi.org/project/aiomcache/), support for an internally set collect_ai serverside configuration setting, fixes a crash in package catpuring in Python 2.7, an attribute check in [OpenAI](https://pypi.org/project/openai) instrumentation, and casing on [LangChain](https://pypi.org/project/langchain/) metric and span names.
