...
features: ['Adds support for custom tasks in Celery', 'Adds support for graphene-django', 'Adds support for middleware filtering in Django']
bugs: ['Safeguard for deepest unique path in GraphQL', 'Safeguard for web request parsing']
---
...
This release also adds safeguards for the deepest unique path in GraphQL as well as web URL request parsing.
