...
* **Remove data-source admin command**
  ...
  The platform API (used by newrelic-admin data-source) has been removed. Please use [data sources](/docs/agents/python-agent/supported-features/python-custom-metrics#registering-a-data-source) in place of the platform API.
