...
* Add instrumentation for `upload_file` in boto3
    ...
    * Add support for the [s3transfer](https://pypi.org/project/s3transfer/) `BoundExecutor` submit function, allowing the agent to support the `upload_file` operation in [boto3](https://pypi.org/project/boto3/).
