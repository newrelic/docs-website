...
features: ['Remove reporting of attributes with None values']
bugs: ['Add transaction trace ID to the error traces even when Distributed Tracing is not enabled']
security: []
---
