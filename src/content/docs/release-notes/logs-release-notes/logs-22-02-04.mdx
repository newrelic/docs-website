...
We've released several enhancements throughout New Relic One to make it easy for you to see relevant logs from anywhere in the UI. When you're trying to troubleshoot a problem for your app or its related entities and services, you won't need to search through thousands of logs.
...
* **Logs** menu from the top-level Explorer menu bar

We're also providing summaries of log counts and totals, so that you can quickly see trends and decide whether you want to query deeper into the log data or switch over to the more detailed **Logs** UI.
