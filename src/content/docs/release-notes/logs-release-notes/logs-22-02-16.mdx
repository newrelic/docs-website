...
import logsRn0222 from 'images/logs-rn0222.png'

import logsRnTriage from 'images/logs-rn-triage.png'
...
In addition, if you have not installed logs in context for hosts related to your app, you can install our <InlinePopover type="infrastructure" />'s log forwarder capabilities directly from the app's **Summary > Triage > Logs** menu. From there, you can click on the popup menu to go directy to the guided install.
