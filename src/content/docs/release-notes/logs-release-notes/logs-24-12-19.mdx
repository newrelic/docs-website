...
The New Relic's one-step observability AWS services logs onboarding experiences we recently released included some undesired attributes in the ingested logs. We've fixed this in this release.
