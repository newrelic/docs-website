...
Our Flutter integration monitors the performance of your iOS mobile app  built with Flutter, helping you diagnose issues in your app and optimize your code. This integration makes use of our iOS mobile agent, and gives you a pre-built dashboard with your most important Flutter app metrics (like errors, app crashes, app launches, app installations, HTTP errors, and network failures).
