...
* iOS API version 10 or higher.
* Uses our [iOS agent](/docs/mobile-monitoring/new-relic-mobile-ios/get-started/new-relic-ios-compatibility-requirements/).
...
### Step 2: Install the iOS agent [#iOS-install] 
...
3. In the search bar, type `flutter iOS`. 
