---
title: Flutter iOS app monitoring integration
tags:
    - New Relic integrations
metaDescription: Use New Relic mobile monitoring to get a dashboard with metrics from your iOS mobile app built with Flutter.
redirects: 
---

PLACEHOLDER WIP  - COPY OF FLUTTER WEB APP INTEGRATION BELOW

import browserFlutterWebDashboard from 'images/browser_screenshot-full_flutter-web-dashboard.png'

Our Flutter integration for iOS monitors the performance of your iOS mobile app built with Flutter, helping you diagnose issues in your app and optimize your code. This integration makes use of our iOS mobile agent, and gives you a pre-built dashboard with your most important Flutter app metrics (like errors, app crashes, app launches, app installations, HTTP errors, and network failures).

ZACH EDITED UP TO THIS POINT
...
This integration reports data in the form of our [browser monitoring events](/docs/data-apis/understand-data/event-data/events-reported-browser-monitoring). 
