...
Our Flutter integration monitors the performance of your Android mobile app  built with Flutter, helping you diagnose issues in your application and optimize your code. This Flutter integration makes use of our Android mobile agent, and gives you a pre-built dashboard with your most important Flutter app metrics (like errors, app crashes, app launches, app installations, HTTP errors, and network failures).
