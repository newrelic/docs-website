...
To add custom attributes, see [Create a custom attribute](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/create-attribute/).
...
To add custom breadcrumbs, see [Record breadcrumbs](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/record-breadcrumb/).
...
* **Android**: Disable entirely with [`withInteractionTracing()`](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/configure-settings/#interaction-settings), or disable only auto-instrumented traces with [`withDefaultInteractions()`](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/configure-settings/#interaction-settings).
* **iOS**: Disable entirely with [`NRFeatureFlag_InteractionTracing()`](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/configure-settings/#interaction-settings), or disable only auto-instrumented traces with [`NRFeatureFlag_DefaultInteractions()`](/docs/mobile-monitoring/new-relic-mobile-ios/api-guides/ios-agent-configuration-feature-flags#defaultInteractions).
...
To add custom events, see [Record custom events](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/record-custom-events/).
