...
To configure these settings, go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile > (select a mobile app) > Settings > Network settings**</DoNotTranslate>.
...
1. On the <DoNotTranslate>**Network settings page**</DoNotTranslate>, select the <DoNotTranslate>**Show only hostnames**</DoNotTranslate> tab.
2. Click <DoNotTranslate>**Add a hostname**</DoNotTranslate>. 
3. Enter the hostname `*.ecommerce.com` and click <DoNotTranslate>**Add to list**</DoNotTranslate>.
...
1. On the <DoNotTranslate>**Network settings page**</DoNotTranslate>, select the <DoNotTranslate>**Status codes**</DoNotTranslate> tab.
2. Click <DoNotTranslate>**Create a status code rule**</DoNotTranslate>. 
3. Enter the host `*.ecommerce.com`.
4. Enter status codes `401`, `403`, and `404`  and click <DoNotTranslate>**Add to list**</DoNotTranslate>. 
...
1. On the <DoNotTranslate>**Network settings**</DoNotTranslate> page, select the <DoNotTranslate>**Aliases and groups**</DoNotTranslate> tab.
2. Click <DoNotTranslate>**Create an alias**</DoNotTranslate>.
3. Enter `*.ecommerce.com` to group all subdomains of `ecommerce.com`.
4. Enter the alias `ecommerce.com` and click <DoNotTranslate>**Save alias**</DoNotTranslate>. 
