...
## Query network request settings via NRQL

You can use NRQL to query network request settings to do things like (insert use cases). Try out [these sample NRQL queries](/docs/query-your-data/nrql-new-relic-query-language/nrql-query-tutorials/nrql-query-examples-mobile-monitoring#network-request-settings).

## Configure network request settings via Nerdgraph

If you want to query network request data and events, try out [this NerdGraph mutation](/docs/query-your-data/nrql-new-relic-query-language/nrql-query-tutorials/nrql-query-examples-mobile-monitoring#network-request-settings)
