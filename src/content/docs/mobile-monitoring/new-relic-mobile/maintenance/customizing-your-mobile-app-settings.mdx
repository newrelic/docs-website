---
title: Customize mobile monitoring settings
tags:
  - Mobile monitoring
  - New Relic Mobile
  - Maintenance
...
To get to mobile monitoring settings, go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Mobile > (select a mobile app) > Settings**.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        Block or allow hostnames, create rules for status codes, create aliases for hostnames
      </td>
...
1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities)**, click **Mobile**, and select a monitored app.
