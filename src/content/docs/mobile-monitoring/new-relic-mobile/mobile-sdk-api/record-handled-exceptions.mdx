---
title: Record handled exceptions
type: apiDoc
...
Here's am example of recording a `ClassCastException` from within an on-click listener:
...
This function should not be used with Swift code. Please use [recordError](/docs/mobile-monitoring/new-relic-mobile-ios/ios-sdk-api/recorderror-ios-sdk-api) to track handled errors in Swift code.
</Callout>
