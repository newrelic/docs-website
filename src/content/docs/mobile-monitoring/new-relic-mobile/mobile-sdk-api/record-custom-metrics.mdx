...
metaDescription: Mobile app monitoring API to create custom metrics to record arbitrary numeric app data.
redirects:
...
Here's an example of the same metric above, but with two counts of elapsed time and exclusive time:
