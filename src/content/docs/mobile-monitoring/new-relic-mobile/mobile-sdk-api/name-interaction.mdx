...
metaDescription: Mobile app monitoring API to sets the name to rename default interaction names reported to New Relic.
redirects:
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
       Required. The custom New Relic interaction name.
      </td>
    </tr>
  </tbody>
</table>
