...
This uses the string ID for the interaction you want to end. This string is returned when you use [`startInteraction()`](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk-api/start-interaction).
