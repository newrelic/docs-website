...
<tr>
            ...
            <td> `FeatureFlag.AppStartMetrics`
            </td>
            <td>
                Boolean
            </td>
...
<tr>
            <td>
                Set the application's version as a string.
            </td>
            <td> `withApplicationVersion`
            </td>
            <td>
                String
            </td>
  ...
  <tr>
            <td>
                Set the build's version as a string.
            </td>
            <td> `withBuildVersion`
            </td>
            <td>
...
<tr>
            <td>
                Enables or disables [deferred crash reporting](/docs/mobile-monitoring/new-relic-mobile-android/install-configure/android-agent-crash-reporting/#deferred-crash-reporting).
            </td>
            <td> `withCrashReportingEnabled`
            </td>
            <td>
                Boolean
            </td>
...
<tr>
            ...
            <td> `FeatureFlag.HandledExceptions`
            </td>
            <td>
                Boolean
            </td>
  ...
  <tr>
            ...
            <td> `FeatureFlag.NativeReporting`
            </td>
            <td>
                Boolean
            </td>
...
<tr>
    ...
    Refer to [How New Relic distributed tracing works](/docs/distributed-tracing/concepts/how-new-relic-distributed-tracing-works#browser-spans) for more information on distributed tracing in mobile apps.
            ...
            <td> `FeatureFlag.DistributedTracing`
            </td>
            <td>
                Boolean
            </td>
...
<tr>
            ...
            <td> `FeatureFlag.InteractionTracing`
            </td>
            <td>
                Boolean
            </td>
...
<tr>
            ...
            <td> `FeatureFlag.DefaultInteractions`
            </td>
            <td>
                Boolean
            </td>
...
<tr>
            <td>
                  Enable or disable reporting successful HTTP requests to the [MobileRequest](/docs/insights/nrql-new-relic-query-language/nrql-query-examples/insights-query-examples-new-relic-mobile#mobilerequest-examples) event type. Enabled by default as of agent version 5.15.2
            </td>
            <td> `FeatureFlag.NetworkRequests`
            </td>
            <td>
                Boolean
            </td>
...
<tr>
            ...
            <td> `FeatureFlag.NetworkErrorRequests`
            </td>
            <td>
                Boolean
            </td>
...
<tr>
            ...
            <td> `FeatureFlag.HttpResponseBodyCaptureEnabled`
            </td>
            <td>
                Boolean
            </td>
