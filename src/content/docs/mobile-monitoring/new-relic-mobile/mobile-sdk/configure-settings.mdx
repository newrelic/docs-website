...
The Unity agent SDK allows you to configure default settings to change the behavior of the agent.
...
<table>
    ...
    <tbody>
        ...
        <tr>
          ...
          <tr>
            <td>
                Enable or disable offline data storage when no internet connection is available. To configure the amount of offline storage, see [Set max offline storage size](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/set-max-offline-storage/#unity).
            </td>
            <td>
                Offline storage is enabled by default. To disable it, add the following feature flag:
