...
<table>
    ...
    <tbody>
        <tr>
            <td>
                Enable or disable the storing of data payloads in the file system when an internet connection is not detected. 
                
                * To configure the amount of offline storage refer to [Set max offline storage size](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/set-max-offline-storage).
                * Default value is `true`.
