...
```
      ...
      ## Available configurations [#xamarain-configurations]
...
```
          ...
          <tr>
            <td>
              Enable or disable offline data storage when no internet connection is available. To configure the amount of offline storage, see [Set max offline storage size](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/set-max-offline-storage/#xamarin).
            </td>
