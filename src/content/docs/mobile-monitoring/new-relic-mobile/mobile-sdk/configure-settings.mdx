...
## ApplicationExitInfo reporting [#android-applicationexit-reporting]
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>
                ApplicationExitInfo reporting is enabled by default. To disable it, add the following feature flag:
