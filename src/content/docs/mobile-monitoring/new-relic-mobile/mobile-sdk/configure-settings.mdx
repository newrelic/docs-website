    ...
    <tbody>
        <tr>
            <td>
                ...
                * To configure the amount of offline storage, see [Set max offline storage size](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/set-max-offline-storage/#android).
