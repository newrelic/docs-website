...
<Callout variant="important">
  Offline storage is enabled by default but can be disabled with a feature flag using the disableFeatures function. See [Configure mobile monitoring settings](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/configure-settings) to disable offline storage.
</Callout>
