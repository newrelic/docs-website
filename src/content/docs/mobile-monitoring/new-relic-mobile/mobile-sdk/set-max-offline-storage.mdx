...
Offline storage is enabled by default. To enable it, add the following feature flag:

```java
NewRelic.disableFeature(FeatureFlag.OfflineStorage)
```

For details on adding feature flags, see [Configure mobile monitoring settings](docs/mobile-monitoring/new-relic-mobile/mobile-sdk/configure-settings/).
</Callout>
