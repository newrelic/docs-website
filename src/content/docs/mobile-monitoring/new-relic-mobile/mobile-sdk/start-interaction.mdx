...
Returns an interaction ID numberw hich can be used for [ending the interaction](/docs/mobile-monitoring/new-relic-mobile-android/android-sdk-api/end-interaction) at a certain point.

## Example [#example]

Here's an xample of starting to track an interaction named `RefreshContacts`:
