...
See also [`setMaxEventBufferTime()`](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/set-max-event-buffer-time/), which lets you change the length of the event harvest cycle.
