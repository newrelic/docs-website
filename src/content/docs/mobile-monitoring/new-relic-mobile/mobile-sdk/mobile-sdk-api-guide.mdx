...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        [Record a breadcrumb](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/record-breadcrumb)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        [Set the interaction name](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/name-interactions).
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        [Set the application version](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/set-application-version/)
      </td>
    </tr>

    <tr>
      <td>
        Set your app's build ID.
      </td>

      <td>
        [Set the build ID](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/set-application-build-number/)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        There are several ways to add custom attributes and events. 

          * [Create an attribute](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/set-attribute)
          * [Increment an attribute count](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/increment-session-attribute-count)
          ...
          * [Record breadcrumb events](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/record-breadcrumb)
          * [Set the maximum size of an event pool](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/set-max-event-pool-size)
          * [Set maximum time agent stores events in memory](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/set-max-event-buffer-time)
          * [Return current session ID](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/current-session-id)
    ...
    <tr>
      ...
      <td>
        [Name activity for app launch time](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/name-android-activity)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        [Enable/disable monitoring features](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/configure-settings)
            ...
            <tr>
      <td>
        Configure cross-app tracing to link transactions between your mobile and APM-monitored applications.
      </td>

      <td>
        [Configure cross-app tracing](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/cross-app-tracing)
      </td>
    </tr>
...
### Report custom attributes and events [#custom-att-events]
