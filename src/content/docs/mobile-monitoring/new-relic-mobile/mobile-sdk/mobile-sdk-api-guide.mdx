  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * [Set maximum time agent stores events in memory]
    ...
    <tr>
      ...
      <td>
        ...
        <tr>
      <td>
        Disable default mobile monitoring settings
      </td>

      <td>
        [Enable/disable monitoring features](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/enable-disable-features)
      </td>
    </tr>
  </tbody>
</table>

## Android usage guide [#android-usage]
