...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        1. [Start interactions](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/start-interaction)
        2. [Stop interactions](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/stop-interaction)
      </td>
    </tr>
...
## Usage guidelines [#android-sdk-usage]
...
Use methods in the `NewRelic` object to [report custom attributes and events](/docs/insights/new-relic-insights/adding-querying-data/custom-attributes-events-new-relic-mobile).
