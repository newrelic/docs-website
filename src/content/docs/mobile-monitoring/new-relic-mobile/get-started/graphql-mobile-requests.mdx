...
<figcaption>
    <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile > (select an app) > HTTP requests**</DoNotTranslate>: View your GraphQL requests based on the custom name of their function.
</figcaption>
...
3. On the left-hand menu, click <DoNotTranslate>**HTTP requests**</DoNotTranslate>.
4. In the <DoNotTranslate>**Group by**</DoNotTranslate> dropdown, select <DoNotTranslate>**Operation Name**</DoNotTranslate>. The HTTP requests page will show all your requests grouped by the `operationName` you set.
