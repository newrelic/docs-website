...
You can configure mobile app launch times for [Android](docs/mobile-monitoring/new-relic-mobile-android/install-configure/configure-app-launch-time-android-apps)and iOS.
