...
tags:
  ...
  - New Relic Mobile
  - Get started
metaDescription: "Use New Relic mobile monitoring capabilities to manage the performance of your iOS and Android apps and your customers' overall digital experience."
---

New Relic mobile monitoring helps you gain deeper visibility into your [Android](/docs/mobile-monitoring/new-relic-mobile-android/get-started/introduction-new-relic-mobile-android) and [iOS](/docs/mobile-monitoring/new-relic-mobile-ios/get-started/introduction-new-relic-mobile-ios) application performance, crash troubleshooting, and the time it takes to launch. With the abundance of high-quality apps in the marketplace, users have become very sensitive to app launch time and have very high expectations.

## Why would you track app launch time [#features]

Speed is an essential part of app performance. Users expect apps to be responsive and load quickly. An app with a slow start time doesn't meet this expectation and can be disappointing to users. App launch speed is indicative of the overall quality of your app and tracking it will help assess the responsiveness of your apps. New Relic gives you the ability to track key metrics to improve your app's performance, including cold time, hot time and more.
...
You you can configure mobile app launch times for [Android](docs/mobile-monitoring/new-relic-mobile-android/install-configure/configure-app-launch-time-android-apps)and iOS.
