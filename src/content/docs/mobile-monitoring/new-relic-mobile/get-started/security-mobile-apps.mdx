...
* <DoNotTranslate>**Android:**</DoNotTranslate> You can use APIs to specify the URI authority of harvest and crash collector data endpoints. For more information, see the [Android agent configuration and feature flags documentation](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/configure-settings/).
* <DoNotTranslate>**iOS:**</DoNotTranslate> For more information, see the [iOS agent configuration and feature flags documentation](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/configure-settings/).
