...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Generate unique build IDs for each app variant. Build IDs are unique identifiers assigned to each build of your app. They are helpful for tracking specific builds, especially when you have different versions with multiple builds, such as version 1.1.1 build 0.0.1. Default: `true`.
      </td>
    </tr>
