...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Specify which variant build types should report ProGuard maps to New Relic. For React Native apps, this also controls which variant build types automatically upload the JavaScript source map. Add `Debug` to this setting to get automatic source map upload for debug builds. Default: `Release`
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
          Set to `false` to disable webview instrumentation.
          * Default: `true`

          Supported when used with android agent v7.6.15 and later.
      </td>
    </tr>
...
<CollapserGroup>
  ...
  <Collapser
    id="app-level"
    title="Disable Webview Instrumentation"
  >
