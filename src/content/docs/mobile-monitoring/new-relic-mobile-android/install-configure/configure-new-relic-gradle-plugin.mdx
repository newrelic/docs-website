...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Specify which variant build types should report ProGuard maps to New Relic. For React Native apps, this also controls which variant build types automatically upload the JavaScript source map. Default: `Release`
      </td>
    </tr>
