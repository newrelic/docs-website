...
* <DNT>**Module**</DNT>: Any packaged class and/or resource collection
* <DNT>**APK**</DNT>: A module that packages the apps resources and DEX’ed classes
* <DNT>**Feature module**</DNT>: A slimmed down module that contains only a subset of the total APK
