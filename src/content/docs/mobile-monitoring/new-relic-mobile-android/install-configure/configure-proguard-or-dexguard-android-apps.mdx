...
2. Add the following to your [ProGuard config file](#proguard-library) (`proguard.cfg`, `proguard-android.txt`, `proguard-rules.pro`, etc.):
    ...
    ##
    # Retain generic signatures of TypeToken and its subclasses if 8 version 3.0 full-mode (https://r8.googlesource.com/r8/+/refs/heads/master/compatibility-faq.md#r8-full-mode) is enabled.
