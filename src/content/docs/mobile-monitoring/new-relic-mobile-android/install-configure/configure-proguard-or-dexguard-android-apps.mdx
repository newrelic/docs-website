...
4. Run your app in an emulator or device to start seeing data on your mobile app's [<DoNotTranslate>**Overview**</DoNotTranslate> page](/docs/mobile-apps/mobile-apps-dashboard).
5. Optional: Use the <InlinePopover type="mobile" /> <DoNotTranslate>**Settings**</DoNotTranslate> page to [customize your mobile app](/docs/mobile-apps/customizing-your-mobile-app-settings).
  ...
  <thead>
    <tr>
      <th style={{ width: "200px" }}>
        <DoNotTranslate>**Library**</DoNotTranslate>
      </th>

      <th>
        <DoNotTranslate>**Rules**</DoNotTranslate>
      </th>
    </tr>
  </thead>
...
To add support for <DoNotTranslate>**DexGuard**</DoNotTranslate>:
...
5. Run your app in an emulator or device to start seeing data on your mobile app's [<DoNotTranslate>**Overview**</DoNotTranslate> page](/docs/mobile-apps/mobile-apps-dashboard).
6. Optional: Use the mobile monitoring <DoNotTranslate>**Settings**</DoNotTranslate> page to [customize your mobile app](/docs/mobile-apps/customizing-your-mobile-app-settings).
