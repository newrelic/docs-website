...
* To upgrade an existing Android installation: Go to **[one.newrelic.com](https://one.newrelic.com) > Mobile > (select an app) > Settings > Installation**.
...
9. Wait a few minutes, then view data for your Android app from the [**Summary** page](/docs/mobile-monitoring/mobile-monitoring-ui/mobile-app-pages/mobile-apps-overview-page): Go to **[one.newrelic.com](https://one.newrelic.com) > Mobile > (select an app)**.
...
To keep your Android agent up to date, follow the procedures to [upgrade the Android agent SDK](/docs/mobile-monitoring/new-relic-mobile-android/install-configure/upgrading-new-relic-mobiles-android-sdk) for New Relic. To install the latest Android version for your mobile app: Go to **[one.newrelic.com](https://one.newrelic.com) > Mobile > (select an app) > Settings > Installation**.
