...
2. If applicable: From the [**Mobile apps** index](/docs/mobile-monitoring/mobile-monitoring-ui/mobile-app-pages/mobile-apps-index), select **Add a new app**. ![screen mobile app add.png](http://newrelicdev.prod.acquia-sites.com/sites/default/files/thumbnails/image/screen%20mobile%20app%20add.png "screen mobile app add.png")
