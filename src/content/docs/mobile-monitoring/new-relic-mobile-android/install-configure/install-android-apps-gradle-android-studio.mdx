---
title: Manually install the Android agent (Android Studio/Gradle)
tags:
  - Mobile monitoring
...
Our [guided install](https://onenr.io/0kjnEoryzRo) 
We recommend that you use our [guided install](https://onenr.io/0kjnEoryzRo) to set up Android monitoring. However, if you need to manually install for any reason, follow the steps below to manually install the New Relic Android agent with Gradle and Android Studio.
