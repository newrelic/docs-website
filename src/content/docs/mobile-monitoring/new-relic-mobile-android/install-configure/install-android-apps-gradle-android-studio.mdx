...
To install and configure New Relic functionality with your Android applications, we recommend you follow our [guided install](https://onenr.io/0kjnEoryzRo), located directly in the UI. Using this method, you can install and configure the Android agent with Gradle. these procedures. If you'd prefer to configure your install manually, follow along below:
