...
Our [guided install](https://onenr.io/0kjnEoryzRo) is the preferred method of installation, but if you need to manually install and configure our Android agent, follow the instructions below.
...
2. If applicable: From the [**Mobile apps** index](/docs/mobile-monitoring/mobile-monitoring-ui/mobile-app-pages/mobile-apps-index), select <Icon name="fe-plus-circle"/>
...
After installing the New Relic Android agent, you will need to make some configuration changes to your Android app in order to successfully report data to New Relic. Follow the steps below in your app's Android Studio project:
