...
Once you've [installed](/docs/mobile-monitoring/new-relic-mobile-android/get-started/introduction-new-relic-mobile-android/#installation) New Relic's agent for Android applications, configuring your mobile app can help to improve performance, stability, and user engagement of your app. To configure mobile monitoring with Gradle and Android Studio follow along below.
