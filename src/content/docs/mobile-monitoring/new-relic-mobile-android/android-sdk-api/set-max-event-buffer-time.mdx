...
This method sets the maximum time in seconds that the New Relic Android agent will store events in memory before ncluding the buffered event to be sent to New Relic in the next [harvest cycle](/docs/apm/new-relic-apm/getting-started/glossary#harvest-cycle).

* Default is 600 seconds (10 minutes).
* Minimum value cannot be less than 60 seconds.
* Maximum value cannot be greater than 60 seconds.
