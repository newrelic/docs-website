...
```
NewRelic.noticeHttpTransaction(<em>string</em> $url, <em>string</em> $httpMethod, <em>int</em> $statusCode, <em>long</em> $startTime, <em>long</em> $endTime, <em>long</em> $bytesSent, <em>long</em> $bytesReceived [, <em>string</em> $responseBody])
```
