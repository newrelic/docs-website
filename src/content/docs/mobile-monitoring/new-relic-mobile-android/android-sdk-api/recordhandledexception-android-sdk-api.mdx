...
```
NewRelic.recordHandledException(<em>Exception</em> $exceptionToHandle)
NewRelic.recordHandledException(<em>Exception</em> $exceptionToHandle, <em>Map of String, Object</em> $exceptionAttributes)
```
...
2. Record an exception in your app code, and optionally pass in a map of contextual attributes:
   ...
   ```
   NewRelic.recordHandledException(<em>Exception</em> <var>$exceptionToHandle</var>, <em>Map of String, Object</em> <var>$exceptionAttributes</var>);
   ```
