...
<CollapserGroup>
  ...
  >
    Enable or disable reporting app launch time (cold and hot time)to the [MobileRequest](/docs/insights/nrql-new-relic-query-language/nrql-query-examples/insights-query-examples-new-relic-mobile#mobilerequest-examples) event type.
