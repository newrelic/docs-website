...
<CollapserGroup>
  ...
  >
    ...
    >
      Enable or disable recording of native runtime crashes, exceptoins and _Application Not Responding_ (ANR) conditions, which appear on the [Crash Analysis page](https://docs.newrelic.com/docs/mobile-monitoring/mobile-monitoring-ui/crashes/native-reporting).
