...
```
NewRelic.noticeNetworkFailure(<em>string</em> $url, <em>string</em> $httpMethod, <em>long</em> $startTime, <em>long</em> $endTime, <em>exception</em> $exception OR <em>enum</em> $networkFailure)
```
...
<table>
  ...
  <tbody>
    <tr>
      <td colSpan={2}>
        ```
        NewRelic.noticeNetworkFailure(<em>string</em> $url, <em>string</em> $httpMethod, <em>long</em> $startTime, <em>long</em> $endTime, <em>exception</em> $exception OR $networkFailure)
        ```
      </td>
    </tr>
