...
* In the distributed tracing UI, end-user spans are indicated with the <img title="New Relic distributed tracing mobile span icon" alt="New Relic distributed tracing mobile span icon" src={mobileIcon}/> icon.
