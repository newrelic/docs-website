...
To set up Infinite Tracing, go to our [Infinite Tracing docs](/docs/distributed-tracing/infinite-tracing/set-trace-observer) for steps to create a trace observer and to select which mobile apps (data sources) should report spans.
...
* In the distributed tracing UI, end-user spans are indicated with the ![New Relic distributed tracing mobile span icon](./images/mobile-icon.png "New Relic distributed tracing mobile span icon") icon.
