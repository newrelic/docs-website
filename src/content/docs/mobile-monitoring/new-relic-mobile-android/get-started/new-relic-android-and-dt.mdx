...
To set up Infinite Tracing, see the [steps](/docs/distributed-tracing/infinite-tracing/set-trace-observer) to create a trace observer and to select which mobile apps (data sources) should report spans.
