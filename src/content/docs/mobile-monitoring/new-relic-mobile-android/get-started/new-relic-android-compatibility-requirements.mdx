    ...
    <tr>
      ...
      <td>
        ...
        <Callout variant="important">
          Build must be compiled with Android SDK Tools version 14 or higher to support version 5.0.0 and higher.
          Build must be compiled with Android SDK Tools version 21 or higher to support version 6.0.0 and higher.
        </Callout>
      </td>
    </tr>
