  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        * Version **6.6.0** and higher: Build must be compiled with Android SDK Tools version 24 or higher.
        * Version **6.0.0** through **6.5.0**: Build must be compiled with Android SDK Tools version 21 or higher.
