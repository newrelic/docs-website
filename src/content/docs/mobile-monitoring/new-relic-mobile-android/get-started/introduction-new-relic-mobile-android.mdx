...
We recommend you follow our [guided install](https://onenr.io/02R5GVpaxQb), located directly in the UI. Using this method, you can install and configure the Android agent with Gradle and Android Studio. Follow the [Android installation and configuration procedures](/docs/mobile-monitoring/new-relic-mobile-android/install-configure) for your environment as applicable.
