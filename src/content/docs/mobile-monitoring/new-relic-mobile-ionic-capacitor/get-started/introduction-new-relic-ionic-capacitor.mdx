...
<Steps>
  ...
  <Step>
    ...
    2. Add the following changes to Apply Gradle Plugin:
      ...
      If your projec is using Plugins DSL to Apply the NewRelic Gradle Plugin, make the following changes:
      ...
      Or, if your projec is using the traditional way to apply the plugin:
        ```groovy
        buildscript {
          ...
          repositories {
