---
title: Monitor your Capacitor application
tags:
  - Mobile monitoring
...
Our New Relic Capacitor agent monitors your Capacitor mobile app and provides deep insights into your app's performance, errors, and user experience. Written in JavaScript, the plugin automatically includes New Relic's native agents to provide mobile monitoring and performance visibility. Once you install and configure the Capacitor agent, you'll be able to:
...
To install the Capacitor agent, follow our [guided install](https://onenr.io/0VRVoxJW1ja), located directly in the UI.
