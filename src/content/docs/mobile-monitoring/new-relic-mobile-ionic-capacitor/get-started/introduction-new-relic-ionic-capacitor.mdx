---
title: Monitor your Ionic Capacitor application
tags:
  - Mobile monitoring
...
Our New Relic Ionic Capacitor agent monitors your Ionic Capacitor mobile app and provides deep insights into your app's performance, errors, and user experience. Written in JavaScript, the plugin automatically includes New Relic's native agents to provide mobile monitoring and performance visibility. Once you install and configure the agent, you'll be able to:
...
If you need to manually install for any reason, follow these steps:
...
1. Add the following code to launch NewRelic (don't forget to put proper application tokens):
...
2. Replace `appToken` with your application token(s) from Step 1.
