...
<CollapserGroup>
    ...
    >
        ...
        2. Click <DoNotTranslate>**Query builder**</DoNotTranslate>.
        3. Run this query:
        ...
        <figcaption>
          <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Query builder**</DoNotTranslate>: Use the <DoNotTranslate>**Query builder**</DoNotTranslate> to create a custom dashboard for tracking JavaScript errors from your Capacitor app.
        </figcaption>
