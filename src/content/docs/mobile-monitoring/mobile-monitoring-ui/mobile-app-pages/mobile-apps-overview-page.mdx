...
![new-mobile-apps-overview](src/images/new-mobile-apps-overview.png 'new-mobile-apps-overview')

<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Mobile > (select an app):**
  The Overview page provides charts and tables that you can drill down into, to
  gain insights about your mobile application's performance.
</figcaption>
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        ![NR Mobile Version Dropdown](src/images/crop-mobile-version-dropdown.png "NR Mobile Version Dropdown")
      </td>
    </tr>
