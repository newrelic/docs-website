...
You can view version trend data in the mobile monitoring UI. Here you can compare performance across the most recent versions of your mobile app using the version trends report. On this single page you have access to the key data points you need to analyze the impact of improvements, fixes, and degradations for each version. This report provides metrics to compare usage, adoption, and key technical indicators.
...
<CollapserGroup>
  ...
  >
    You can compare different versions to see how successfully they've been adopted by your users.
  ...
  >
    ...
    * **HTTP errors:**  HTTP errors are an HTTP request that have a status code greater than 400
