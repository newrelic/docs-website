...
import version-trends-time-picker from 'images/version-trends-time-picker.png'
import version-trends-ui from 'images/version-trends-ui.png'
...
For example, use the timepicker dropdown to select default or custom time periods to query:
   ...
   <img
     ...
     src={version-trends-time-picker}
   />
