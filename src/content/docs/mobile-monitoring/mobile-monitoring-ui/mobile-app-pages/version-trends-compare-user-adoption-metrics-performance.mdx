...
Here are some examples of how to interpret some of the data that appears. For additional examples and information about using the **Version trends** report, read this [blog post](https://blog.newrelic.com/2015/11/12/mobile-version-trends-report/).
