...
![Use this page to view, sort, or drill down into detailed information about the top five types of operation system versions using your mobile app.](src/images/os-version-pic_0.png 'OS Version Page')

<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Mobile > (select an app) >
  App > OS versions:** Use this page to view, sort, or drill down into detailed
  information about the top five types of operation system versions using your
  mobile app.
</figcaption>
