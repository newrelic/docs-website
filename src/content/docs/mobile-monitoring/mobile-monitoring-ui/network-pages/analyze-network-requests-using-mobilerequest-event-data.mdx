...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The <DoNotTranslate>**HTTP requests**</DoNotTranslate> page includes charts for your top 20 domains by response time and average throughput.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        The <DoNotTranslate>**HTTP errors**</DoNotTranslate> page helps you to better understand HTTP errors and network failures associated with your mobile app and to connect errors to services that are causing issues.
      </td>
    </tr>
  </tbody>
</table>
