...
* Go to **[one.newrelic.com](https://one.newrelic.com) > Mobile > (select an app) > Network > Network errors**.
* From a mobile app's [Overview](/docs/mobile-apps/mobile-apps-dashboard) page in mobile monitoring, select the **HTTP errors/network failures** chart title link.
...
1. Go to **[one.newrelic.com](https://one.newrelic.com) > Mobile > (select an app) > Network > Errors**.
...
4. To limit information to a specific [version](/docs/mobile-monitoring-ui/versions) of your app, or to change the time period, select your choice from the **Versions** menu or the [**time picker**](/docs/site/timepicker-setting-time-periods-to-view-data) below the menu bar.
5. To view details for a specific host, HTTP status error, or network failure, select its name.

Use any of our standard [user interface functions](/docs/accounts-partnerships/education/getting-started-new-relic/new-relic-user-interface) to drill down into detailed information.
