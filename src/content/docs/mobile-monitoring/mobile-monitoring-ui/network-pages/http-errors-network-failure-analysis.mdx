...
tags:
  ...
  - Network pages
metaDescription: 'Group, sort, and filter HTTP errors and network failures with New Relic Mobile''s network errors UI page.'
redirects:
...
## Find and use the HTTP errors page [#errors_ui_workflow]
...
## View more details about a specific error [#error-summary]
...
## View legacy HTTP errors UI page [#non-enterprise-http-requests]
...
## View the Errors page [#dashboard]
