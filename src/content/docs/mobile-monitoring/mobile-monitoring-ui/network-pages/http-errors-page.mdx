...
[Error profiles](/docs/mobile-monitoring/mobile-monitoring-ui/network-pages/mobile-http-error-profiles-find-error-causes/) provide visual details about significant differences in the frequency of different values for HTTP error events. For each [attribute](/docs/new-relic-solutions/get-started/glossary/#attribute), the error profile includes:
