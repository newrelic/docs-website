...
![connection types.png](src/images/connection-types.png 'connection types.png')

<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Mobile > (select an app) >
  Network > Connection types**: Use this page to view, sort, or drill down into
  detailed information about your users' mobile network connection type by
  response time impact, network failures, and active traffic.
</figcaption>
