...
1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Mobile > (select an app) > Network > HTTP requests**.
...
<CollapserGroup>
  ...
  >
    ...
    1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > (select an app) > Network > HTTP requests**.
  ...
  >
    ...
    * Average data transfer
      ...
      To view legacy details: **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Mobile > (select an app) > Network > HTTP requests > (select a request): > Switch to legacy requests**.
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              Use the [**time picker**](/docs/query-your-data/explore-query-data/dashboards/manage-your-dashboard/#dash-time-picker) below the New Relic menu bar.
            </td>
          </tr>
        </tbody>
      </table>
