        ...
        <tr>
          ...
          <td>
            <Callout variant="important">
              This feature is not available when the related app has [distributed tracing](https://docs.newrelic.com/docs/apm/distributed-tracing/getting-started/introduction-distributed-tracing) enabled.
            </Callout>
