...
The **HTTP requests** UI page of [<InlinePopover type="mobile" />](/docs/mobile-monitoring) helps you better understand HTTP requests associated with your mobile app and how those network calls are affecting performance.
