...
{' '}
<Collapser id="samples" title="Occurrences count">
  If the Mobile agent has collected more than one occurrence of the crash, you
  ...
  >
    ...
    <Callout variant="tip">
      ...
      ![Mobile Crash Report: Interaction trail](src/images/crop-interaction-multiple.png "Mobile Crash Report: Interaction trail")
    </Callout>
