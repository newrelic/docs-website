...
import browserStackTraceandInteractionTrail from 'images/browser_screenshot-full_stack-trace-and-interaction-trail.png'
...
<CollapserGroup>
  ...
  >
    ...
    <img
      src={browserStackTraceandInteractionTrail}
