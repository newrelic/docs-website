...
redirects:
  ...
  - /docs/mobile-monitoring/mobile-monitoring-ui/crashes/mobile-apps-crash-report-native
---
...
<CollapserGroup>
  ...
  >
    ...
    <Callout variant="tip">
      ...
      ![Mobile Crash Report: Interaction trail](./images/crop-interaction-multiple.png "Mobile Crash Report: Interaction trail")
    </Callout>
  </Collapser>
