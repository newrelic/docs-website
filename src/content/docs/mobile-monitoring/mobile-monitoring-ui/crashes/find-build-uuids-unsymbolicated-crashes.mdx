...
If the dSYM is not uploaded to New Relic, [mobile crash reports](/docs/mobile-monitoring/mobile-monitoring-ui/crashes/investigate-mobile-app-crash-report) cannot be symbolicated. You can [upload dSYMs](/docs/mobile-monitoring/new-relic-mobile-ios/install-configure/upload-dsyms-bitcode-apps) manually or directly through the New Relic. However, every build of an application will create a new dSYM, and it can be difficult managing which dSYM is attributed to which app build.
