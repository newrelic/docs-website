...
<Callout variant="tip">
  ...
  level](https://newrelic.com/mobile-monitoring/pricing) and [mobile data
  retention](/docs/mobile-monitoring/new-relic-mobile/getting-started/mobile-data-retention).
</Callout>
