...
![Mobile Handled Exceptions](src/images/mobile-handled-exceptions-ui.png 'Mobile Handled Exceptions')

<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Mobile > (select an app) >
  Exceptions > Handled exceptions:** As you explore the wealth of data in the
  charts and table, use groups and filters to discover patterns that help you
  determine the root cause of mobile app exceptions.
</figcaption>
...
<CollapserGroup>
  ...
  >
    ![Mobile Handled Exceptions: Percentage charts](src/images/mobile-handled-exceptions-percentages.png "Mobile Handled Exceptions: Percentage charts")
...
<CollapserGroup>
  ...
  >
    ![Mobile Handled Exceptions: Groups and filters](src/images/mobile-handled-exceptions-groups.png "Mobile Handled Exceptions: Groups and filters")
...
<CollapserGroup>
  ...
  >
    ![Mobile Handled Exceptions: Top 5 locations](src/images/mobile-handled-exceptions-locations.png "Mobile Handled Exceptions: Top 5 locations")

    <figcaption>
      **[one.newrelic.com](https://one.newrelic.com) > Mobile > (select an app) > Exceptions > Handled exceptions:** This example shows the **Expand chart** button and links to the query builder, where you can query, create dashboards, and share the handled exceptions data.
    </figcaption>
...
<CollapserGroup>
  ...
  >
    ![Mobile Handled Exceptions: Locations table](src/images/mobile-handled-exceptions-table.png "Mobile Handled Exceptions: Locations table")
