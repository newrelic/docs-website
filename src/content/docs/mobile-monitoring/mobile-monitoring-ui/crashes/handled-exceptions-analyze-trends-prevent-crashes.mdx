...
New Relic stores unsymbolicated stack traces for handled exceptions. You can view symbolicated stack traces if the appropriate `.dsym` or Android mapping files have been uploaded at build time for native iOS and Android apps. You can also [upload a dSYM](/docs/mobile-monitoring/new-relic-mobile-ios/install-configure/upload-dsyms-bitcode-apps) later for iOS apps as needed. 
