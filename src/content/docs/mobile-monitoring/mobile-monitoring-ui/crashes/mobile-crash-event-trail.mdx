...
<Callout variant="tip">
  Access to this feature depends on your [subscription
  level](http://newrelic.com/mobile-monitoring/pricing).
</Callout>
...
![New Relic Mobile crash event trail ](src/images/New-Relic-Mobile-crash-event-trail.png 'Android-Insights-event-trail.jpg')

<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Mobile > (select a mobile
  app) > Crash analysis > (selected crash type) > Event trail**: The crash event
  trail shows the activity leading up to a mobile app crash.
</figcaption>
