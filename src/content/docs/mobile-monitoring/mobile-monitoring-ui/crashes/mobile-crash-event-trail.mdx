...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Mobile > (select a mobile app) > Crash analysis > (click on a crash type) > (scroll down to Event trail):** The crash event trail shows the activity leading up to a mobile app crash.
</figcaption>
