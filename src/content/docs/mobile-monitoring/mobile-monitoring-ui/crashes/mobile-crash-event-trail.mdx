...
The crash event trail shows all mobile [event types](/docs/insights/explore-add-data/custom-events/insert-query-custom-mobile-app-events-attributes#event-definition) leading up to a crash. You can use the [Record breadkcrumb SDK](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/record-breadcrumb/) to create custom `MobileBreadcrumb` events that track whatever app activity you think would help you diagnose a crash.
