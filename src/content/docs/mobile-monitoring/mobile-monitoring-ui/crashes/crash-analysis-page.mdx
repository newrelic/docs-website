...
When your development team receives an [emailed crash notification](/docs/mobile-monitoring/mobile-monitoring-ui/crashes/receive-crash-notifications-email), they can select the email link to review detailed information about the crash in our user interface, or analyze chart data directly [through a query](/docs/nrql/nrql-examples/nrql-query-examples-mobile-monitoring/). The individual **Crash details** page also includes tracking tools for your team to follow the issue from reporting to resolution.
...
1. Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile > (select an app) > Exceptions > Crash analysis**.
   ...
   To view the filterable **Crash analysis** page directly from the [mobile app's **Summary** page](/docs/mobile-monitoring/mobile-monitoring-ui/mobile-app-pages/mobile-apps-summary-page/), select the **Crash occurrences** chart's title.
...
3. The [**Top 20 occurrences** chart](#top20-occurrences) lets you identify broad patterns about the occurrences you chose from [groups and filters](#groups-filters). You can correlate these patterns, or you can find information like [crash percentages](#percentage-charts) during the chosen [time period](#time-period).
...
<CollapserGroup>
  ...
  >
    ...
    * To look for other historical patterns, change the selected [time period](#time-period).
      ...
      <figcaption>
        **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile > (select an app) > Errors > Crash analysis:** Here is an example of the **Top 20 occurrences** chart filtered by the **Crash locations** group. Select any groups or filters to analyze your crash data any way you want.
      </figcaption>
  </Collapser>
  ...
  >
    ...
    * When did the exception first and last occur?
      ...
      <figcaption>
        **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile > (select an app) > Errors > Crash analysis**: Sort on any column to analyze patterns in the **Crash reports** table, then select any report to review crash details.
      </figcaption>
