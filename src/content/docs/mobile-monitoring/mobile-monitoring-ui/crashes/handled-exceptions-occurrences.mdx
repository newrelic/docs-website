...
![Mobile Handled Exceptions: Occurrences](src/images/mobile-handled-exceptions-occurrences.png 'Mobile Handled Exceptions: Occurrences')

<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Mobile > (select an app) >
  Exceptions > Handled exceptions > (select an exception) > Occurrences:** Use
  the thread details to further examine patterns in the stack trace for a
  handled exception.
</figcaption>
