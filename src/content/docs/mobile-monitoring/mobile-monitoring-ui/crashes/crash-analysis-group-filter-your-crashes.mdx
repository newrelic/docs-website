...
<CollapserGroup>
  ...
  >
    ...
    * To look for other historical patterns, change the selected [time period](#time-period).
      ...
      <figcaption>
        **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile > (select an app) > Errors > Crash analysis:** Here is an example of the **Top 5 occurrences** chart filtered by the **Crash locations** group. Select any groups or filters to analyze your crash data any way you want.
      </figcaption>
  </Collapser>
