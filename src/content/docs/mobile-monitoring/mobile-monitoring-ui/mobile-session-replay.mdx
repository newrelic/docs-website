...
* Adequate data plan and storage capacity on user devices for replay data transmission

**Performance considerations:**
* Session Replay captures and transmits viewport data, which may impact app performance and user data consumption
* All data is compressed client-side before transmission to minimize network usage
* Consider your sampling rates carefully to balance data collection with performance impact
...
<Steps>
  ...
  <Step>
    ...
    <Callout variant="important">
    **Sessions with errors** sampling is not yet supported in Mobile Session Replay. This documentation is provided so you can prepare for when it becomes available later in the preview period.
    </Callout>
...
**When to disable this mode:**
Most apps should disable this mode unless displaying highly sensitive information. Visible UI text is crucial for:
...
* **Data usage**: Images significantly increase replay payload size, consuming more user data and your New Relic storage
...
**Default:** Disabled in the custom masking strategy (taps and swipes are visible).

**When to hide interactions:**
...
**When to keep interactions visible:**
Keep this mode disabled (show interactions) for most apps to:
...
<Callout variant="important">
Replays in the Crashes and ANRs experiences are not yet supported in Mobile Session Replay. This documentation is provided for informational purposes only, to allow you to prepare for when they become available later in the preview period.
</Callout>
