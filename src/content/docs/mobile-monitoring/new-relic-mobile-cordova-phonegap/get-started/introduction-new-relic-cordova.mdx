...
4. Change to your Cordova project directory, then add the plugin to your project with the Cordova command line tool. Use the `--variable` argument to pass application tokens to the plugin:
   ...
   ```
5. Deploy your app.
6. View your performance data from the [mobile monitoring UI](/docs/mobile-monitoring/mobile-monitoring-ui/mobile-app-pages/mobile-apps-summary-page#summary-page/).
...
Our Cordova Plugin utilizes the same API calls as our iOS and Android SDK agents. Please refer to the[New Relic iOS SDK doc](/docs/mobile-monitoring/new-relic-mobile-ios/ios-sdk-api) or [Android SDK doc](/docs/mobile-monitoring/new-relic-mobile-android/android-sdk-api).

For JavaScript errors, you can call `  NewRelic.recordError(error)` as follows:
```js
...
The Cordova Plugin creates custom events for JavaScript errors and reports them to New Relic. In the UI, you can track these JavaScript error events with a custom dashboard.
