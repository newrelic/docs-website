...
4. Change to your Cordova project directory, then add the plugin to your project with the Cordova command line tool. Use the `--variable` argument to pass application tokens to the plugin:
   ...
   ```
5. Deploy your app.
6. View your performance data from the [mobile monitoring UI](/docs/mobile-monitoring/new-relic-mobile/get-started/introduction-mobile-monitoring/).
...
Our Cordova Plugin utilizes the same API calls as our iOS and Android SDK agents. Please refer to [New Relic iOS SDK doc](/docs/mobile-monitoring/new-relic-mobile-ios/ios-sdk-api) or [Android SDK](/docs/mobile-monitoring/new-relic-mobile-android/android-sdk-api).
