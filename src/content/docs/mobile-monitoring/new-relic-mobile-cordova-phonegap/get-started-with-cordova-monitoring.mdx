...
Need to customize your New Relic mobile agent?Our public mobile SDK API methods let you collect custom data, configure default settings, and more.

To get started, check out our [mobile SDK guide](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/mobile-sdk-api-guide).
