...
***These options are only available on Cordova plugin v6.2.1 and higher.***

The `--variable` argument can also be used to add optional configuration options on agent start. 
```
