---
title: Monitor your Cordova mobile application
tags:
  - Mobile monitoring
...
## Install the Cordova agent [#install]
...
To add optional configuration options, add them to the `--variable` argument, which will call them upon agent start. 
