...
Make sure you pasted your application token(s) into `appToken = ""` in the code above. If you deployed your hybrid app to both iOS and Android, you'll need to add two separate tokens, one for iOS and one for Android.
