...
View your app’s performance data in the New Relic mobile monitoring UI by going to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile > (select a Cordova app)**.
...
<figcaption>
  **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile > (select a Cordova app)**: The Cordova agent will collect this data and send it to New Relic, where you can view and analyze it in the UI.
</figcaption>
...
<img
  ...
  />
<figcaption>
  **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Query builder**: Use the **Query builder** to create a custom dashboard for tracking JavaScript errors from your Cordova app.
</figcaption>
