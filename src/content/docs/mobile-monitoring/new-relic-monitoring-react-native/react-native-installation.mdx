---
title: New Relic  agent
tags:
  - Mobile monitoring
  - New Relic Mobile 
  - Configuration
metaDescription: Instructions for installing and configuring the  agent.
---
...
Here's what you can do with this agent:
...
<<<<<<< Updated upstream
Before you install the React Native agent, review these guidelines for compatibility:
=======
Before you install the  agent please review these guidelines for compatibility:
>>>>>>> Stashed changes
...
Native support levels are based on [ requirements](https://github.com/facebook/react-native#-requirements).
>>>>>>> Stashed changes
...
=======
To set-up the  agent, you need to start it with `index.js`. To use this snippet, generate the platfrom-specific token for Android and iOS apps. When you have the token, insert it in <var>GENERATED_TOKEN</var>.
>>>>>>> Stashed changes
...
Once you've completed the steps above, you need to link the  Firebase library to your project and your application needs to be rebuilt.

<Callout variant="tip">
<<<<<<< Updated upstream
If you use React Native 0.60+, you automatically have access to "autolinking," which means you have no further manual installation steps.
=======
If you use  0.60+, you automatically have access to "autolinking," requiring no further manual installation steps.
>>>>>>> Stashed changes
</Callout>
...
* (Required) End an interaction
* This uses the string ID for the interaction you want to end.
...
## How to see JSerros(Fatal/Non Fatal) in New Relic One?
...
![Screenshot of JSerros](./images/jserros.png "Screenshot of JSerros")
...
### Symbolication for Javascript errors is coming in future releases.
