...
<Callout variant="important">
  Source map upload uses a [User API key](/docs/apis/intro-apis/new-relic-api-keys/#user-key). The User API key and the application token must belong to the same New Relic account.
</Callout>
