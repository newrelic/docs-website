...
<Callout variant="important">
  Querying and deleting source maps with NerdGraph requires a [User API key](/docs/apis/intro-apis/new-relic-api-keys/#user-key). Include it in the `Api-Key` header of your NerdGraph request.
</Callout>
