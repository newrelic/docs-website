...
<Callout variant="important" title="Breaking change in error reporting (1.9.0)">
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [Record custom errors](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/record-errors/#react)
      </td>
    </tr>
...
<CollapserGroup>
  <Collapser
    id="v1.9.0"
    title="React Native agent version 1.9.0 and higher"
  >
  ...
  <Collapser
    id="v1.2.0"
    title="React Native agent version 1.2.0 to 1.8.x"
  >
...
<CollapserGroup>
  <Collapser
    id="logs-v1.4.1"
    title="React Native agent version 1.4.1 and higher"
  >
    Starting with React Native agent version 1.4.1, JavaScript console logs are reported as log events. You can view them in the [Logs UI](/docs/logs/ui-data/use-logs-ui) or query them by going to <DNT>**[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Query your data**</DNT> and running:
  ...
  <Collapser
    id="logs-v1.4.0"
    title="React Native agent version 1.4.0 and lower"
  >
