...
Make sure you pasted your application token(s) (copied from [Step 2](#app-token)) into `appToken = ""` in the code above. If you're monitoring both Android-native and iOS-native apps, you'll need to add separate tokens for both.
...
Use the iOS or Android SDK APIs to create custom events and metrics. 
