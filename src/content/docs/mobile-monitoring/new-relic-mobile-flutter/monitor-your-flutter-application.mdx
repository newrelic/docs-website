...
import 'package:newrelic_mobile/newrelic_mobile.dart';
    ...
    ....
```
Make sure you pasted your application token(s) (copied from [Step 3](#app-token)) into `appToken = ""` in the code above. If you deployed your hybrid app to both iOS and Android, you'll need to add two separate tokens, one for iOS and one for Android.
</Step>
<Step>
