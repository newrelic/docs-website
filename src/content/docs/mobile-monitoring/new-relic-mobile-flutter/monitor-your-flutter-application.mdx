...
Add a name to `routes:` settings to help track each screen view/activity. Here's an example:
  ...
  >
    ...
    title="Record Metric"
    >
        **[recordMetric](/docs/mobile-monitoring/new-relic-mobile-android/android-sdk-api/recordmetric-android-sdk-api/)(String name,String category,int? value,String? countUnit, String? valueUnit): void;**
    ...
    >
        **[shutdown](/docs/mobile-monitoring/new-relic-mobile-android/android-sdk-api/shut-down/)(): void;**
