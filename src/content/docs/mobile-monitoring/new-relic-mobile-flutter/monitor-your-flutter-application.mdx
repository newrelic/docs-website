...
Make sure you pasted your application token(s) copied from [Step 2](#app-token) into `appToken = ""` in the config code above. If you have both an Android and iOS app added in New Relic, you'll need to copy and paste tokens for both.
...
Check out this optional API calls to further customize how New Relic collects data: 
