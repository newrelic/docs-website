...
* Flutter ">= 2.5.0"
* Dart ">=2.16.2 <3.0.0"
* iOS 10 OR [IOS native requirements](/docs/mobile-monitoring/new-relic-mobile-ios/get-started/new-relic-ios-compatibility-requirements)
* Android API 24+ OR [Android native requirements](/docs/mobile-monitoring/new-relic-mobile-android/get-started/n*ew-relic-android-compatibility-requirements)
...
Congratulations on finishing the Flutter agent install process! If you want to make more advanced (and optional) customizations to the agent instrumentation, you can do things like:
...
// Are these examples of custom reporting? Should these be embedded in one of the sections above? 
