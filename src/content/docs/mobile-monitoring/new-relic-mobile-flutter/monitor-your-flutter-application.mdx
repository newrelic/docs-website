...
import mobileMobileAppToken from 'images/mobile_screenshot-crop_mobile-app-token.webp'
...
<img
    ...
    alt="Screenshot of where to retrieve the application token"
    src={mobileMobileAppToken}
/> 
