...
2. Add the token to your Unity project:
  ...
  3. Paste your copied application token(s) into the field labeled `appToken = ""`.
  
  If your app is deployed to both iOS and Android, you must provide separate tokens for each platform.
