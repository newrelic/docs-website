...
* <DoNotTranslate>**Capture C# and Native C++ errors:**</DoNotTranslate> Identify and fix problems quickly.
...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile > (select an app) > Summary**</DoNotTranslate>: View Unity data, track HTTP requests and errors, and monitor how your app is performing over time.
</figcaption>
...
2. Add the token to your Unity project:
    ...
    2. Go to <DoNotTranslate>**Tools > New Relic > Getting Started**</DoNotTranslate> to open the editor window.
...
1. In your Unity IDE, go to <DoNotTranslate>**Assets**</DoNotTranslate> and open the <DoNotTranslate>**External Dependency Manager**</DoNotTranslate>.
2. Click <DoNotTranslate>**iOS Resolver**</DoNotTranslate>.
3. In the Podfile Configurations section, verify these settings:

    * <DoNotTranslate>**Add use_frameworks! to Podfile**</DoNotTranslate> is disabled
    * <DoNotTranslate>**Always add the main target to Podfile**</DoNotTranslate> is enabled
...
4. If you're not using the Podfile for iOS dependency management, follow these steps:
   ...
   2. Add the New Relic XCFramework to your Xcode project:
         ...
         3. Under the <DoNotTranslate>**Embed**</DoNotTranslate> column, click <DoNotTranslate>**Embed & Sign**</DoNotTranslate>. 
