...
```groovy
 ...
 ```
 If you are utilizing an older version of Unity Studio, you can incorporate a lower version of the classpath as a dependency which supports Gradle version 7.0 and lower.
...
3. Settings: [#configure-ios]

Within the Podfile Configurations section, please verify the following settings:

* "Add use_frameworks! to Podfile" should be unchecked.
* "Always add the main target to Podfile" should be checked.
