...
isTutorial: true
freshnessValidatedDate: 2023-12-29
---
...
1. Retrieve your application token from New Relic:
...
2. Add the token to your Unity project:
    ...
    2. Go to **Tools > New Relic > Getting Started** to open the New Relic editor window.
    3. Paste your copied application token(s) into the field labeled `appToken = ""`. If your app is deployed to both iOS and Android, you must provide separate tokens for each platform.
...
Learn about which would be the best method to use and why, see [Report mobile monitoring custom events and attributes](/docs/data-apis/custom-data/custom-events/report-mobile-monitoring-custom-events-attributes/).
      </td>
    </tr>
    <tr>
      <td id="track-custom">
