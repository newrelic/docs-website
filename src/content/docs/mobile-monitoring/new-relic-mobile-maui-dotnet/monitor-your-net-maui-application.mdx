...
2. In the config file above, replace `<APP-TOKEN-HERE>` with your custom application token(s) (copied from [Step 3]. If you're monitoring both `.NET Android` and `.NET iOS` apps, you'll need to add two different application tokens.
