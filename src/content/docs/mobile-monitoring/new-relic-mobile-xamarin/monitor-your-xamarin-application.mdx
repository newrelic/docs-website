...
1. In your project's your `App.xaml.cs` file, add the following code:
...
2. In the config file above, replace `<APP-TOKEN-HERE>` with your custom application token(s) (copied from [Step 3]. If you're monitoring both `Xamarin.Android` and `Xamarin.iOS` apps, you'll need to add two different application tokens.
