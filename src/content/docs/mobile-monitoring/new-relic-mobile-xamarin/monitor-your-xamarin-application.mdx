...
## Query Xamarin log data 

New Relic stores your Xamarin logs as custom events. You can query these logs and build dashboards for them using this NRQL query:
```
...
This plugin also provides a method to manually record any handled exception:
