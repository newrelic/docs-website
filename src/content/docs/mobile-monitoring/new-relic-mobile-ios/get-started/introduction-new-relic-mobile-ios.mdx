...
If New Relic Mobile for iOS isn't reporting data, try these [troubleshooting suggestions](/docs/mobile-monitoring/new-relic-mobile-ios/troubleshoot/no-data-appears-ios).
