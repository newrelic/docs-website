...
* We recommend you install and configure the iOS agent using either [Swift Package Manager (SPM)](/docs/mobile-monitoring/new-relic-mobile-ios/installation/spm-installation/) or [CocoaPods](/docs/mobile-monitoring/new-relic-mobile-ios/installation/cocoapods-installation/) method.
