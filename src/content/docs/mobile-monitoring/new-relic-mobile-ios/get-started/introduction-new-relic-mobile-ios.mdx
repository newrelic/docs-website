...
* **We recommend** you install and configure the iOS agent using either the [SPM installation](/docs/mobile-monitoring/new-relic-mobile-ios/installation/spm-installation) or the [CocoaPods installation](/docs/mobile-monitoring/new-relic-mobile-ios/install-configure/cocoapods-installation-configuration) method.
