...
* **We recommend** you install and configure the iOS agent using either the [SPM installation](https://docs.newrelic.com/docs/mobile-monitoring/new-relic-mobile-ios/installation/spm-installation) or the [CocoaPods installation](/docs/mobile-monitoring/new-relic-mobile-ios/install-configure/cocoapods-installation-configuration) method.
