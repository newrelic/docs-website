...
* We recommend you install and configure the iOS agent using either [Swift Package Manager (SPM)](/docs/mobile-monitoring/new-relic-mobile-ios/installation/spm-installation) or [CocoaPods](/docs/mobile-monitoring/new-relic-mobile-ios/install-configure/cocoapods-installation-configuration) method.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Use the [mobile SDK API](docs/mobile-monitoring/new-relic-mobile/mobile-sdk-api/mobile-sdk-api-guide) to instrument parts of your code that are not instrumented by default.
      </td>
