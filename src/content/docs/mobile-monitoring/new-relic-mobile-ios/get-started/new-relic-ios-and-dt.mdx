...
- In the distributed tracing UI, end-user spans are indicated with the ![New Relic distributed tracing browser span icon](src/images/mobile-icon.png 'distributed-tracing-browser-span-icon.png') icon.
