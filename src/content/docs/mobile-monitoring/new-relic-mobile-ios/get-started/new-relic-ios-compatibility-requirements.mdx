...
topics:
  ...
  - Get started
japaneseVersion: >-
  https://docs.newrelic.co.jp/docs/mobile-monitoring/new-relic-mobile-ios/get-started/new-relic-ios-compatibility-requirements
---

New Relic Mobile for iOS is compliant with standard application stores, including Apple App Store, Google Play Store, Amazon Appstore, and others. Before you [install and configure](/docs/mobile-monitoring/new-relic-mobile-ios/get-started/ios-installation-configuration) New Relic Mobile functionality with your mobile applications, follow these guidelines for compatibility and other requirements.

## Foreground monitoring [#foreground]

New Relic Mobile for iOS only monitors your app while it is in the foreground. The agent does not monitor background services while the app is closed. For more information, see our [Mobile data privacy and security documentation](/docs/mobile-monitoring/new-relic-mobile/get-started/security-mobile-apps).
...
<Table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        To take advantage of New Relic's iOS features, make sure you have the latest version of [Xcode](/docs/mobile-monitoring/new-relic-mobile-ios/install-configure/upgrade-new-relic-mobiles-ios-sdk).
      </td>
    </tr>
