...
- Disable some of the functionality of our agent. If this is an option that works for you see our [api guide](docs/mobile-monitoring/new-relic-mobile-ios/ios-sdk-api/ios-agent-configuration-feature-flags) for more info.
