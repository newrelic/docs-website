...
1. Navigate to the <DoNotTranslate>**NewRelic**</DoNotTranslate> agent in the Package Dependencies section of your Xcode project navigator.
2. Right-click on the <DoNotTranslate>**NewRelic**</DoNotTranslate> agent.
3. Select <DoNotTranslate>**Update Package**</DoNotTranslate>.
...
1. Open the <DoNotTranslate>**Terminal**</DoNotTranslate> app and navigate to the directory with your PodFile.
...
4. Right-click or control-click `NewRelic.xcframework`, and select <DoNotTranslate>**Show in Finder**</DoNotTranslate>.
