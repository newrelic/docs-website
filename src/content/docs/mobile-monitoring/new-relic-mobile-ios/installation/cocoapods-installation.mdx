...
We recommend that you use our [guided install](https://onenr.io/0qwLv87gkj5) to set up iOS monitoring. However, if you need to manually install for any reason, follow the steps below to install the New Relic iOS agent with Cocoapods.
