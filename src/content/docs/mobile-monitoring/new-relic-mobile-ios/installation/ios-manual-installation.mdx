...
1. Download and unzip the [iOS agent](/docs/release-notes/mobile-release-notes/ios-agent-release-notes).
...
5. (Optional): Add the following lines to your build script above the existing lines to skip symbol upload during debugging:
    ```
