...
To install and configure New Relic functionality with your iOS/tvOS applications, we recommend you follow our [guided install](https://onenr.io/0qwLv87gkj5), located directly in the UI. Using this method, you can install and configure the iOS agent with Swift Package Manager (SPM) or CocoaPods. these procedures. If you'd prefer to install manually, follow along below:
