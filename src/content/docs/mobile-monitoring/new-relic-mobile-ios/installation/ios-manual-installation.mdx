...
topics:
  ...
  - Installation
japaneseVersion: >-
  https://docs.newrelic.co.jp/docs/mobile-monitoring/new-relic-mobile-ios/installation/ios-manual-installation
---
...
2. If applicable: From the [Mobile Apps index](/docs/mobile-apps/mobile-apps-menu), select <Icon name="plus-circle"/>
   **Add a new app**.
