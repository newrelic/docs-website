...
6. From the downloaded repo, copy `dsym-upload-tools` into the folder that contains your `xcodeproject` file. You should now have a folder containing these files:
