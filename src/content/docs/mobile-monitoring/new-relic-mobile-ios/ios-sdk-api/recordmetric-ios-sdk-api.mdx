...
This method will record a metric of the form `Custom/[Category]/[Name]`, with a count of 1 and a total value equal to the value passed in. Multiple calls will aggregate the count and value according to standard [metric aggregation rules for New Relic Mobile](/docs/mobile-monitoring/new-relic-mobile/getting-started/mobile-data-retention).
