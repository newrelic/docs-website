...
Ensure you have your app instrumented with the latest iOS SDK by going to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Add more data** and following the instructions for iOS.
