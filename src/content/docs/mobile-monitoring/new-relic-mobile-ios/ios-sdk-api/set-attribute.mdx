...
contentType: apiDoc
template: basicDoc
shortDescription: "Creates a session-level attribute shared by multiple Mobile event types. Overwrites its previous value and type each time it is called.\r"
topics:
  - Mobile monitoring
