...
This method sets a custom user identifier value to associate mobile user sessions with NRDB events. This method can be called anytime after the New Relic iOS agent starts.
