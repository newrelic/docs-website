...
This method sets a custom user identifier value to associate all events of a mobile user sessions with a specific user id. This method can be called anytime after the New Relic iOS agent starts.
