...
tags:
  ...
  - API guides
metaDescription: 'To start interaction traces from events in your app, use the iOS SDK API for New Relic Mobile with Swift or Objective-C.'
redirects:
...
## Objective-C: Send custom attributes and events to Insights [#objc-custom-att-events]
...
## Swift: Send custom attributes and events to Insights [#swift-custom-att-events]
