...
Apple deprecated bitcode in Xcode 14. See the [Xcode 14 release notes](https://developer.apple.com/documentation/xcode-release-notes/xcode-14-release-notes) for more details.
