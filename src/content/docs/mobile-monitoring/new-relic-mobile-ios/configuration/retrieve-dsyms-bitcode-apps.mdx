...
This means that all your projects should migrate away from using bitcode. Instead, for all release builds you want to capture symbolicated crash stacks from, you can use the automatic symbol uploading script to upload your build's symbols.
