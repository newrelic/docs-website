...
![Download dSYMs for mobile app version/build](src/images/screen-dsym2.png 'Download dSYMs for mobile app version/build')

<figcaption>
  **Using Xcode to download dSYMs:** From the **Archives** tab, select the app
  and version/build, then select **Download dSYMs**.
</figcaption>
