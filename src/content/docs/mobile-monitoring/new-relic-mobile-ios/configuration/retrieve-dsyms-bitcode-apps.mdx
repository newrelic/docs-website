...
tags:
  ...
  - Configuration
metaDescription: How to retrieve dSYMs for crash reports from Bitcode-enabled iOS apps that are monitored by New Relic Mobile.
redirects:
...
If an app is missing a dSYM file, three indicators are available in the New Relic Mobile UI:
