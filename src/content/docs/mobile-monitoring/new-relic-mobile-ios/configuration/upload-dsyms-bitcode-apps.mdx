...
As of New Relic iOS Agent version 7.3.8 the Python version of the automatic script uses Python 3. As of macOS 12.3 [macOS 12.3 (Monterey)](https://developer.apple.com/documentation/macos-release-notes/macos-12_3-release-notes) Python 3 will be installed by default with Xcode. If you're using the python automatic script on macOS 12.2 or before, you may need to manually install [Python 3](https://www.python.org/downloads/mac-osx/).
...
The automatic script will create an `upload_dsym_results.log` file in your projects root directory containing information about any failures that occur during symbol upload.
