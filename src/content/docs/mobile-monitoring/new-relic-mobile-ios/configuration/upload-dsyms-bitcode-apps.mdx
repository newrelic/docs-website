...
<Callout variant="important">
  The Upload dSYM button will only appear if the "platform" attribute is native. This button will not be shown in the UI for apps on a hybrid platform such as React Native or MAUI.
</Callout>
