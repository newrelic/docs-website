...
Within a few minutes you will begin to see data for your iOS app: Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Mobile > (selected app)**. If you don't, see [No data appears](/docs/mobile-monitoring/mobile-monitoring-installation/ios/no-data-appears-ios).
