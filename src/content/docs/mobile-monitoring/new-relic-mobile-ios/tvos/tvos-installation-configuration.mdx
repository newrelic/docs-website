...
tags:
  ...
  - tvOS
metaDescription: 'New accounts: Get tvOS app monitoring at newrelic.com/signup. Existing accounts: Add New Relic Mobile to your tvOS applications from the user interface.'
redirects:
