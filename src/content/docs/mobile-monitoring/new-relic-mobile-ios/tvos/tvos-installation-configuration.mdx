...
For Admins with existing New Relic accounts, follow these steps to install and configure your application. (If you do not have a New Relic account, signup at [newrelic.com/signup](https://newrelic.com/signup)—it's free, forever.)
...
Within a few minutes you will begin to see data for your iOS app: Go to **[one.newrelic.com](https://one.newrelic.com) > Mobile > (selected app)**. If you do not, see [No data appears](/docs/mobile-monitoring/mobile-monitoring-installation/ios/no-data-appears-ios).
