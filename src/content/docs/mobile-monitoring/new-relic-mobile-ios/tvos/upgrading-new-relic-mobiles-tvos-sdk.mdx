...
![Workflow for replacing your tvOS framework.](src/images/Mobile_tvOS_replace-framework_1.png 'Mobile_tvOS_replace-framework.png')

<figcaption>
  Here is an example of the workflow to remove your existing tvOS agent
  framework so you can replace it with a newer version.
</figcaption>
