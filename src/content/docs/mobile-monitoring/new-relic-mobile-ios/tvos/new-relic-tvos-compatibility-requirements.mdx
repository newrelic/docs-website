...
Before you [install and configure](/docs/mobile-monitoring/new-relic-mobile-ios/installation/spm-installation) the iOS agent, make sure your tvOS app meets these requirements.
