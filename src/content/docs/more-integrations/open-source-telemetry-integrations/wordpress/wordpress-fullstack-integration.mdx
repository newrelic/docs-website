...
3. Click <DoNotTranslate>**Install now**</DoNotTranslate> to start the PHP agent installation.
</Step>
...
3. Click  <DoNotTranslate>**Install now**</DoNotTranslate> to start the MySQL agent installation.
...
3. Click  <DoNotTranslate>**Install now**</DoNotTranslate> to start the Apache agent installation.
</Step>
...
Your WordPress dashboard is considered a custom dashboard and can be found in the <DoNotTranslate>**Dashboards**</DoNotTranslate> UI. For docs on using and editing dashboards, see [our dashboard docs](/docs/query-your-data/explore-query-data/dashboards/introduction-dashboards).
