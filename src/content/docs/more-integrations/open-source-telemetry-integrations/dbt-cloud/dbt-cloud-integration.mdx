...
<Steps>
<Step>
#### Ensure you have the Snowflake and dbt Cloud Airflow providers
* pip install apache-airflow-providers-snowflake==3.0.0 apache-airflow-providers-dbt-cloud==3
</Step>
<Step>
