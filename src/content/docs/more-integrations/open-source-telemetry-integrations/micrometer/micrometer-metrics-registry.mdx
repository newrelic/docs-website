...
This doc walks you through procedures to forward Micrometer data with a sample Spring app. These are generalized steps that you may want to update to fit your specific environment. 
