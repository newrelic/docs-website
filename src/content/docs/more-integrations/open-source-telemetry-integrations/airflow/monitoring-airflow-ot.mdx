...
4. Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & services > Services - OpenTelemetry > Airflow**</DoNotTranslate>.
5. Click <DoNotTranslate>**Metrics Explorer**</DoNotTranslate> to visualize metrics for pipeline executions.
