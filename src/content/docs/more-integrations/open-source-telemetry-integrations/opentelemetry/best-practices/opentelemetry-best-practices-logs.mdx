...
This page describes how New Relic handles OpenTelemetry logs it receives via the [New Relic OTLP Endpoint](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-otlp). Regardless of the workflow, integrating OpenTelemetry logs with New Relic requires configuring the log source to export to this endpoint - please review endpoint configuration requirements. For information on configuring services with OpenTelemetry logs see [OpenTelemetry APM monitoring](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/opentelemetry-set-up-your-app).
...
| OTLP Log Proto Field                        | New Relic `Log` field                               |
|---------------------------------------------|-----------------------------------------------------|
...
| `ScopeLogs.InstrumentationScope.attributes` | Each key/value is an attribute on the `Log` **[1]** |
