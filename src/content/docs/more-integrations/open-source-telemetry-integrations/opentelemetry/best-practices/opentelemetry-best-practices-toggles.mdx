---
title: 'OpenTelemetry metric/trace UI toggle: Best practices'
tags:
  - Integrations
...
When you're looking at OpenTelemetry data in the New Relic UI, you may sometimes have a toggle in the chart’s context menu (…) that allows you to switch between metrics and spans. What this means is that you can choose which data type that the chart displays.

Here are some things to think about if you see a toggle on a page:
...
Not every UI page can display metric-based data. At present, only **Summary** and **Transactions** pages show metrics. The **JVMs** page can show either metrics or spans for some key health measures (response time, throughput), while the other charts will show the only data type available.
