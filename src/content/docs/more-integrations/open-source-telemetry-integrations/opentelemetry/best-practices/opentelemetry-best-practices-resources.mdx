...
* [`telemetry.sdk.language`](https://opentelemetry.io/docs/specs/semconv/attributes-registry/telemetry): When present, drives the display of any runtime specific UI. For example, the JVM runtime page for Java applications.
