...
1. Go to [one.newrelic.com](https://one.newrelic.com), and in the left navigation pane, click **APM &#38; services**.
2. In the left navigation pane, select **Services - OpenTelemetry**.
3. Under **Services - OpenTelemetry**, click the service name you want to investigate.
4. Under **Settings**, click **Alert conditions**.
  <img
