...
Conditions are queries written in NRQL, our SQL-like query language. Writing a NRQL query from scratch might seem daunting, but if you create a condition from a New Relic chart, we'll populate the condition with the NRQL used to generate the chart. Then, you can modify it if you want.
