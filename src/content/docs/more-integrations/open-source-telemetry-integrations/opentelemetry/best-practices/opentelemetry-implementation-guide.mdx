...
* **Cumulative metrics**. Ensure you use the [cumulative-to-delta processor](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-best-practices-metrics), which converts metrics with cumulative temporality to a delta format. 
