...
* Monotonic cumulative sums are mapped to our [cumulativeCount](/docs/telemetry-data-platform/understand-data/metric-data/metric-data-type/#metric-types) metric type. Related docs: 
  * For more on how this data is handled, see [Cumulative metrics](/docs/data-apis/understand-data/metric-data/cumulative-metrics).
  * See [our transition guide](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/cumulative-metrics-transition-guide) about a change in mid-2023 to how we handle cumulative sums. 
...
New Relic customers that reported cumulative sums before March 13, 2023, have their cumulative sums converted to our `gauge` type. For details on how this is changing, see our [Cumulative metrics transition guide](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/cumulative-metrics-transition-guide). 
