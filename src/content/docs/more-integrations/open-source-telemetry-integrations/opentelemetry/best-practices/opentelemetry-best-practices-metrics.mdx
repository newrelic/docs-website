...
* Monotonic cumulative sums are mapped to the [cumulativeCount](/telemetry-data-platform/understand-data/metric-data/metric-data-type/#metric-types) metric type.
...
Cumulative histograms will be converted to a [Delta histogram](#delta-histogram). For more information one our translation process, see [Cumulative metric reporting details](/docs/data-apis/understand-data/metric-data/cumulative-metrics).
