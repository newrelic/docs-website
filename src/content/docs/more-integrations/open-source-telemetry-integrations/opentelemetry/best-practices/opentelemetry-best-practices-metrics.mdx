...
* Monotonic cumulative sums are mapped to the [cumulativeCount](/telemetry-data-platform/understand-data/metric-data/metric-data-type/#metric-types) metric type. For more information on the conversion process, see [Cumulative metric reporting details (OTel and Prometheus)](https://docs.newrelic.com/docs/data-apis/understand-data/metric-data/cumulative-metrics/).
...
Cumulative histograms will be converted to a [Delta histogram](#delta-histogram). For more information one our translation process, see [Cumulative metric reporting details (OTel and Prometheus)](https://docs.newrelic.com/docs/data-apis/understand-data/metric-data/cumulative-metrics/).
...
<CollapserGroup>
  ...
  >
    ...
    ```
    <img width="1463" alt="image" src="https://user-images.githubusercontent.com/16656108/214711192-5309312b-b081-41de-9e28-904c5116a4a7.png">  
  </Collapser>
  ...
  >
    ...
    <img width="1474" alt="image" src="https://user-images.githubusercontent.com/16656108/214711744-34c96973-6a41-4c1b-9ca1-7389b16eafd9.png">
...
<CollapserGroup>
  ...
  >
    ...
    <img 
      ...
      width="1474" alt="image" src="https://user-images.githubusercontent.com/16656108/214712306-adfd2f7a-ac09-4b52-8e7b-949c9050542f.png">
  </Collapser>
  ...
  >
    ...
    <img 
      ...
      width="1463" alt="image" src="https://user-images.githubusercontent.com/16656108/214716422-9517171e-5213-4bb6-b22a-b8a121b604c4.png">
