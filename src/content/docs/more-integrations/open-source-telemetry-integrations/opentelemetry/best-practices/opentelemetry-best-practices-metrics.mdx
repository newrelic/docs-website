...
Cumulative histograms will be converted to a [Delta histogram](#delta-histogram). For more information on our translation process, see [Cumulative metrics](/docs/data-apis/understand-data/metric-data/cumulative-metrics).
