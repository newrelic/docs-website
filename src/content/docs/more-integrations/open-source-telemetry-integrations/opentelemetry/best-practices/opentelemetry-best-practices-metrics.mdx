...
* Monotonic cumulative sums are mapped to the [cumulativeCount](/telemetry-data-platform/understand-data/metric-data/metric-data-type/#metric-types) metric type. For more information on the conversion process, see [Cumulative metrics](/docs/data-apis/understand-data/metric-data/cumulative-metrics).
