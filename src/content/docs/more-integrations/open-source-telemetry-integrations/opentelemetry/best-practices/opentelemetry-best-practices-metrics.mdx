...
* Monotonic cumulative sums mapping depends on the following: 
  * If you have access to the [cumulativeCount](/docs/telemetry-data-platform/understand-data/metric-data/metric-data-type/#metric-types) metric type, this is used. For more on the conversion process, see [Cumulative metrics](/docs/data-apis/understand-data/metric-data/cumulative-metrics). 
  * If you don't have access to `cumulativeCount`, it's mapped to the [`gauge` type](/docs/data-apis/understand-data/metric-data/cumulative-metrics). 
...
If you have access to [`cumulativeCount`](/docs/data-apis/understand-data/metric-data/cumulative-metrics), cumulative histograms are converted to a [Delta histogram](#delta-histogram). For more on the translation process, see [Cumulative metrics](/docs/data-apis/understand-data/metric-data/cumulative-metrics).
