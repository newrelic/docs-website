...
* Monotonic cumulative sums mapping depends on the following: 
  * If you have access to the [cumulativeCount](/telemetry-data-platform/understand-data/metric-data/metric-data-type/#metric-types) metric type, this is used. For more on the conversion process, see [Cumulative metrics](/docs/data-apis/understand-data/metric-data/cumulative-metrics). 
