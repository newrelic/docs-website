...
The OpenTelemetry APM UI is a curated experience available for [service entities][/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-best-practices-resources/#services]. See [set up your own app](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/opentelemetry-set-up-your-app) for details on configuring services with OpenTelemetry APM monitoring. See [Find OpenTelemetry APM services](#find-opentelemetry-apm-services) to find OpenTelemetry APM entities in New Relic.
