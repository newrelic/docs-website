...
1. Go to the [Jenkins quickstart ](https://newrelic.com/instant-observability/jenkins)in New Relic Instant Observability, and click **+ Install now**.
2. Select an account and click **Begin installation**.
3. If you have already completed the steps listed in the sections above to send data to New Relic, select **done** to move onto the next step.
4. The quickstart will deploy the resources to your account. Select **see your data** to get to the dashboard.
