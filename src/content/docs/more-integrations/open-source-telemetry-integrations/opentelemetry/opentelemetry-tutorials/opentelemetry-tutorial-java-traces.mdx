...
```
export newrelicLicenseKey=INSERT_YOUR_LICENCE_KEY_HERE
...
## H. Instrument the code: Provide automatic base instrumentation [#initial-instrum]
...
## I. Instrument the code: Set a span attribute [#set-span-attrib]
...
## J. Instrument the code: Record an exception
...
Return to the main steps in the tutorial above to complete instrumentation for your application.
