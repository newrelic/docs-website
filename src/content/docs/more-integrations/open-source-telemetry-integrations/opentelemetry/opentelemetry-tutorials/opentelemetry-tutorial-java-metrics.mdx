...
* The `api-key` header is how you configure which New Relic account you want your data exported to. You'll export your license key as an environment variable when you complete the [steps](#env-vars) below.
