...
This guide covers the first option. If you wish to export your data via a collector, check out this [documenation](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/collector/opentelemetry-collector-basic/) for details.
</Callout>
