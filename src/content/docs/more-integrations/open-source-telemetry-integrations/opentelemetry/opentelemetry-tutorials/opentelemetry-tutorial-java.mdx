    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            This determines which New Relic account your data will be sent to. Make sure to use your [ingest license key](https://docs.newrelic.com/docs/apis/intro-apis/new-relic-api-keys/#license-key).
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            This is the endpoint your application telemetry will be exported to. In this case, you are setting it to one of our OTLP endpoints. If you are based in the EU, use https://otlp.eu01.nr-data.net:4317.
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            This is the name that associates your application telemetry with an entity in New Relic.
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            Configure additional resource attribute key value pairs. The `service.instance.id` uniquely identifies a particular instance of a service and is required to light up certain features in New Relic.
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            Setting a limit on the maximum attribute value length will prevent span data from getting dropped if it exceeds the [New Relic limit](https://docs.newrelic.com/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-best-practices-attributes/).
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            New Relic supports metrics in delta temporality instead of the default cumulative temporality.
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            We recommend you use exponential histogram aggregation instead of the default explicit bucket histogram aggregation for better data compression.
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            This enables log export over OTLP. Log export is disabled by default as the logs signal is still in experimental status.
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            Setting `gzip` compression allows you to maximize the amount of data you can send per request. The New Relic maximum allowed payload size is 1MB (10^6 bytes). Gzip compression has good performance and lowers data egress.
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            Enables experimental export retry to help cope with the unreliability of the internet.
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            Disables the `process.command_line` resource attribute which often exceeds the New Relic maximum attribute length limit and may contain sensitive information.
          </td>
        </tr>
      </tbody>
    </table>

### D. Add base instrumentation: traces [#base-traces]
...
### E. Add base instrumentation: metrics [#base-metrics]
...
### F. Add base instrumentation: logs [#base-logs]
