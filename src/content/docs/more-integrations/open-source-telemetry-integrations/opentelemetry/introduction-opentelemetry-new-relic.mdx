...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>[Array of primitives (homogeneous)](https://github.com/open-telemetry/opentelemetry-specification/blob/e13990125809a4ecc482553c32d05e38bb414acb/specification/common/common.md#attributes). Must be non-nested and 64 or less elements.</td>
      <td>✅</td>
    </tr>
  </tbody>
</table>
