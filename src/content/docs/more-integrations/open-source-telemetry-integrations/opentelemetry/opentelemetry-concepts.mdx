...
<Callout variant="tip">
  For information about resolving specific issues, see our [troubleshooting
  guide](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/opentelemetry-troubleshooting).
</Callout>
...
<Callout variant="caution">
  Avoid getting rate limited! You should batch requests sent to the OTLP
  endpoint as described in this section.
</Callout>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        [Batch
        Processor](https://github.com/open-telemetry/opentelemetry-collector/blob/main/processor/batchprocessor/README.md)
      </td>
    </tr>
    <tr>
      <td>Go SDK</td>
...
![Screen shot showing how to query a cumulative sum as a gauge](src/images/query-cumulative-sums.png 'Screen shot showing how to query a cumulative sum as a gauge')
...
![Screenshot showing rate of change over a given time interval for a cumulative sum](src/images/sum-derivative-function.png 'Screenshot showing rate of change over a given time interval for a cumulative sum')
...
![Screenshot showing a histogram query](src/images/histogram-1.png 'Screenshot showing a histogram query')
...
![Screenshot showing a heat map](src/images/histogram-2.png 'Screenshot showing a heat map')
