...
![Diagram showing OpenTelemetry using the OpenTelemetry Collector and New Relic's OTLP endpoint.](./images/native_otlp_with_collector.png "Diagram of OTLP with collector")
...
The collector is part of the export setup in the larger process of setting up OpenTelemetry with New Relic. As you complete the [instructions](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/opentelemetry-quick-start) you will see links to collector examples.
