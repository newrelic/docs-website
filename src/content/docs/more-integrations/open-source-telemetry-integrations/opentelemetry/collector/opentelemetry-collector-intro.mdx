...
See these topics for different ways to set up the collector:

* [OpenTelemetry setup for services:](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/opentelemetry-setup#collector-export) These instructions get you started with instrumentation and then lead you to [A basic Collector example:](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/collector/opentelemetry-collector-basic).
* [Collector for host monitoring:](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/collector/opentelemetry-collector-infra-hosts) This explains collector configurations to monitor hosts.
* [General collector configurations:](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/collector/opentelemetry-collector-configs) This discusses a variety of collector settings.
