...
/>
<figcaption>Here's an example of the collector as a gateway, but you can also set up the collector as an agent that runs with your application or runs on the same host.</figcaption>
...
The collector is part of the export step in the larger process of setting up OpenTelemetry with New Relic. As you complete the [instructions](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/opentelemetry-quick-start) you will see links to collector examples.
