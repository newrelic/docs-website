...
* [OpenTelemetry setup for services:](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/opentelemetry-setup#collector-export) These instructions get you started with instrumentation and then lead you to the topic [A basic collector example](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/collector/opentelemetry-collector-basic).
