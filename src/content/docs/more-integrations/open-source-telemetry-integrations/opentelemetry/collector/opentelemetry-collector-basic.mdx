...
3. If you are completing the installation steps, return to [Step 5. View your data in the New Relic UI](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/opentelemetry-quick-start/#view-data).
