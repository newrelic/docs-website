...
Execute the following, making sure to insert the operating system (for example, `darwin|linux`):

```
./bin/otelcontribcol_$<var>INSERT_THE_OPERATING_SYSTEM</var>_amd64 --config config.yaml
```
