...
<Steps>
    ...
    <Step>
        ...
        * Copy and store your [Confluent Cloud API key & secret](https://docs.confluent.io/confluent-cli/current/command-reference/api-key/confluent_api-key_create.html). Note that this is **Not** the same as a Cluster API Key in Confluent.
    ...
    <Step>
      ...
      ## Set environment variables and run the collector [#configure-opentelemetry-collectors]
