...
```
    ...
    <Step>
      ...
      To view your SingleStore data inside of New Relic:

      * Navigate to the metrics explorer and filter for `singlestore`. This data can be added to any custom alert or dashboard.
