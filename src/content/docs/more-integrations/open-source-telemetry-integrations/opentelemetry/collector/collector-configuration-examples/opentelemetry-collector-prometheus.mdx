...
Before you can start, you'll need to [sign up for a New Relic account](https://newrelic.com/signup). Once you've done that, you need to make the Prometheus metrics endpoint accessible from the OpenTelemetry Collector. The collector will use the Prometheus receiver component.
