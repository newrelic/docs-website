...
The attributes `server.address` and `server.port` are needed to be able to query and facet data differentiating between Redis servers and to create NewReclic entities. 
