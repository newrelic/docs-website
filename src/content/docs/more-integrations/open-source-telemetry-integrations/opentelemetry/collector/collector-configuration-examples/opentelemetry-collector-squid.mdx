...
<CollapserGroup>
  ...
  If that's your case, you'll need to temporarily include an attribute to your squid metrics in order to report them as cumulative counters before the transition EOL, as suggested in the [transition guide](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/cumulative-metrics-transition-guide/#preview).
