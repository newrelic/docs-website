...
<CollapserGroup>
  ...
  The issues has already been identified and reported in the receiver's OTEL repository.
  For more information and keep track of the issue click [here](https://github.com/open-telemetry/opentelemetry-collector-contrib/issues/23809).
