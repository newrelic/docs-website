...
The collector will use the [statsd receiver](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/main/receiver/statsd) component, and it requires permissions to listen on the configured endpoint (`localhost:8125` by default).
...
* [StatsD receiver](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/main/receiver/dockerstatsreceiver)
...
<CollapserGroup>
  ...
  This issues has already been identified and reported in the receiver's repository so it is solved as soon as possible, you get further information and keep track of it [here](https://github.com/open-telemetry/opentelemetry-collector-contrib/issues/23809).
