...
The collector will use the [statsd receiver](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/main/receiver/statsdreceiver) component, and it requires permission to listen on the configured endpoint (`localhost:8125` by default).
