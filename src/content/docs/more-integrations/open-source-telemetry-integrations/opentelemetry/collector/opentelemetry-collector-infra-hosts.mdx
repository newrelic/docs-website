...
* Get the [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) for the New Relic account to which you want to report data.
...
* Replace YOUR_KEY_HERE with your [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key)
