...
redirects:
 - /docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/opentelemetry-tutorial-java/
---
...
6. Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & services**</DoNotTranslate>.
...
### Monitor the demo app with the OpenTelemetry Java agent [#java-agent]
...
#### Custom metric instrumentation: Add a custom metric counter [#metrics-cust]
...
1. In the left pane's <DoNotTranslate>**Monitor**</DoNotTranslate> section, click <DoNotTranslate>**Distributed tracing**</DoNotTranslate>, and then click the <DoNotTranslate>**Fibonacci**</DoNotTranslate> trace group.
    <img
...
2. From there, find a trace with an error and click to open it.
    <Callout variant="tip">
      With the OpenTelemetry Java agent, you might see different result than you'd see with the New Relic APM Java agent. This is because there's a difference in error handling between the two agent types. For more information, see [Handling error rate in OpenTelemetry and New Relic](https://newrelic.com/blog/how-to-relic/error-rate-opentelemetry-and-new-relic).
    </Callout>
    <img
...
Here is what you will see after selecting your instances and clicking <DoNotTranslate>**Compare**</DoNotTranslate>, where each instance is color coded for easy identification:
...
Learn more about the logs view [here](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-best-practices-logs).
      ...
      <tbody>
        ...
        <tr>
          <td>
            ...
            `OTEL_EXPORTER_OTLP_ENDPOINT=https://otlp.eu01.nr-data.net` (For the EU)
        ...
        <tr>
          <td>
            ...
            * The specifies that OTLP `http/protobuf` should be used, which is preferred by New Relic.
          </td>
        </tr>
        <tr>
          <td>
