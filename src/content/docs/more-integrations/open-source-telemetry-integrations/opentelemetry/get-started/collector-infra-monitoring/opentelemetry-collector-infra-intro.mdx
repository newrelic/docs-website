...
The [OpenTelemetry collector](https://opentelemetry.io/docs/collector/) is a vendor-agnostic tool for receiving, processing, and exporting telemetry data. While its common to use the collector for [data processing](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/collector-processing/opentelemetry-collector-processing-intro), it also contains a variety of receivers and processors which are useful for infrastructure monitoring.
