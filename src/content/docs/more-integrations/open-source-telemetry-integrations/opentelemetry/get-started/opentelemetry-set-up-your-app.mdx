...
* [Other OTLP language support in GitHub](https://github.com/open-telemetry)
...
After you're done with your initial setup, check out our [implementation guide](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-implementation-guide).
