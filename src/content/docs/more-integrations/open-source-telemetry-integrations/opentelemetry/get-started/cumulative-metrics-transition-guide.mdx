...
If you were ingesting cumulative monotonic sums prior to March 14, this 90 day period gives you time to update queries and alerts that make use of the affected metrics.
