...
If you were ingesting cumulative monotonic sums prior to {gaDate}, this 180 day period gives you time to update queries and alerts that make use of the affected metrics.
...
Below we focus on updating [alert conditions](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/nrql-alert-conditions), because alerts are generally more important than charts. For your custom charts, you can either:
