...
If you're familiar with OpenTelemetry and ready to work with your own code, check out [Set up your own app with OpenTelemetry](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/opentelemetry-set-up-your-app). You'll be able to gather telemetry from your app and export it to New Relic.
