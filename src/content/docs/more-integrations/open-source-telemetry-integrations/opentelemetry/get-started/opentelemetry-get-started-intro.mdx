...
redirects:
  ...
  - /content/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/opentelemetry-setup
---
...
If you're familiar with OpenTelemetry and are ready to work with your own code, check out [Set up your own app with OpenTelemetry](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/opentelemetry-set-up-your-app). These steps will help you gather telemetry from your app or service and export it to New Relic.
...
* Manually insert instrumentation and SDK configurations into a demo app.
