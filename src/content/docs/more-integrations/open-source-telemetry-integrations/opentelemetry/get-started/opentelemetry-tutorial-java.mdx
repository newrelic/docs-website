...
* **Pre-instrumented app**: Run our pre-instrumented demo app for a quick way to see data in our UI.
* **OpenTelemetry Java agent**: Monitor our demo app with the OpenTelemetry Java agent
* **Manual setup**: Instrument our demo app manually
