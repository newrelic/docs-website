...
1. In the left pane's <DoNotTranslate>**Monitor**</DoNotTranslate> section, click <DoNotTranslate>**Distributed tracing**</DoNotTranslate>, and then click the <DoNotTranslate>**Fibonacci**</DoNotTranslate> trace group.
    ...
    />
2. From there, find a trace with an error and click to open it. With OpenTelemetry Java agent, you might see different result as there is a difference in error handling by New Relic Java agent and OpenTelemetry Java agent. For more information, review [Handling error rate in OpenTelemetry and New Relic](https://newrelic.com/blog/how-to-relic/error-rate-opentelemetry-and-new-relic).
    <img
