...
2. Set these two environment variables to send data to your New Relic account:
    * Make sure to use your [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key).
      ...
      <tbody>
        <tr>
          <td>
            ...
            * Headers: This determines which New Relic account your data will be sent to. Replace `YOUR_LICENSE_KEY` with your [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key).
          </td>
        </tr>
        <tr>
          <td>
