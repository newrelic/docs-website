...
* [Return to Tutorial 2 (Monitor the demo app with the OpenTelemetry Java agent)](#java-agent)
* [Return to Tutorial 3 (Set up the demo app manually)](#auto-config-ext)
