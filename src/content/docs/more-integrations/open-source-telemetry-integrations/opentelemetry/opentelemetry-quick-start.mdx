...
![Diagram showing OpenTelemetry using New Relic's OTLP endpoint.](src/images/native_otlp.svg 'Diagram of OTLP endpoint')
  ...
  <tbody>
    ...
    <tr>
      <td>
        ...
        <br />
        (See see [FedRAMP
        compliance](/docs/security/security-privacy/compliance/fedramp-compliant-endpoints/#otlp-api)
        for more information)
      </td>
      <td>✅</td>
      <td>✅</td>
      <td>
        <a href="https://gov-otlp.nr-data.net">https://gov-otlp.nr-data.net</a>
      </td>
      <td>`443`, `4317`, `4318`</td>
      <td>`api-key`</td>
      <td>
    ...
    <tr>
      <td>
        ...
        <br />
        (See [best
        practices](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/opentelemetry-concepts/#infinite-tracing)
...
<Callout variant="important">
  In Node.js, the
  [opentelemetry-collector-exporter-grpc](https://www.npmjs.com/package/@opentelemetry/exporter-trace-otlp-grpc)
  library requires additional options to enable TLS.
</Callout>
...
![Diagram showing OpenTelemetry using the OpenTelemetry Collector and New Relic's OTLP endpoint.](src/images/native_otlp_with_collector.svg 'Diagram of OTLP with collector')
