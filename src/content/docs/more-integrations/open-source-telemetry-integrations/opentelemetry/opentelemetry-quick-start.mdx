...
In this step, the focus is on how to configure an OTLP exporter in your service to export data directly to New Relic. If you need to export your data first to an OpenTelemetry collector, we have separate [collector instructions](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/collector/opentelemetry-collector-intro#setup-options).
