...
As you consider OpenTelemetry, you may also be looking at New Relic <InlinePopup type="apm" /> agents that also capture telemetry data.
...
In general, New Relic's <InlinePopup type="apm" /> and infrastructure agents will collect more telemetry data for your services and hosts. Plus, they offer a wide range of configuration options and an extensive set of auto-instrumentation capabilities.
