...
For a closer look at the differences between OpenTelemetry and New Relic instrumentation, see our [detailed comparison](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/opentelemetry-comparison).
