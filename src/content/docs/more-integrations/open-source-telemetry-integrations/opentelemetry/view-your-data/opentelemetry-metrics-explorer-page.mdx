...
After you've sent us your OpenTelemetry data and opened your service (entity) in the UI, you can click <DoNotTranslate>**Metrics explorer**</DoNotTranslate> to see information about your metrics (for selected OpenTelemetry languages). Also, if you are using the Prometheus exporter with OpenTelemetry, you can view your metric data here.
