...
<Callout title="Private preview">
  If you'd like to participate in the private preview of the Events API, let us know in our [CNCF Slack channel, #otel-newrelic](https://cloud-native.slack.com/archives/C024DRQ63UP). Once you sign up, you'll be able to try out the options below.
</Callout>
