...
You can [choose to use either metrics or spans](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/view-your-data/opentelemetry-find-entities/#metric-span-toggle) to power the the **Transactions** view.
