...
<Callout title="Preview">
  The option to query events is available only through a preview, but if you sign up, you can try out the Events API. Let us know in our [CNCF Slack channel, #otel-newrelic](https://cloud-native.slack.com/archives/C024DRQ63UP) if you'd like to participate in the preview.
</Callout>
