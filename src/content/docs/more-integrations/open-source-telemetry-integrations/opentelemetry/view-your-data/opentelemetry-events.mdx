...
<Callout title="Limited preview">
  The option to query events is in limited preview, but if you sign up for the preview, you can try out  the Events API. Let us know in our [CNCF Slack channel, #otel-newrelic](https://cloud-native.slack.com/archives/C024DRQ63UP) if you'd like to participate.
</Callout>
...
* `event.name`: The event name. This attribute is what New Relic uses to map an OpenTelemetry event into a [New Relic event type](https://docs.newrelic.com/docs/data-apis/custom-data/custom-events/data-requirements-limits-custom-event-data/#general).
