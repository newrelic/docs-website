...
## OpenTelemetry logging data is missing

### Problem

You've correlated your logs with your service using `service.id`([OpenTelemetry logs: Best practices](content/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/best-practices/opentelemetry-best-practices-logs)) to see logs associated with traces, you don't see any logs in the New Relic UI.
