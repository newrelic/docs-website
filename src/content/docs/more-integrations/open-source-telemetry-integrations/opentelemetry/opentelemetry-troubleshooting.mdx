...
* The client is configured to use TLS 1.2 or higher and the request includes the `api-key` header with a valid New Relic [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key).
