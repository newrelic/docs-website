...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        🟡 Front-end and Kubernetes observability is limited
      </td>
    </tr>
    <tr>
      <td>
...
Since alerts on OpenTelemetry data are based on spans instead of metrics, alerting with OpenTelemetry has lower fidelity than alerting with New Relic agents.
