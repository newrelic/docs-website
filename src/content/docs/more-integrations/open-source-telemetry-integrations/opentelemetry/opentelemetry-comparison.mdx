...
Before looking at the detailed feature comparisons, take a look at these high-level comparisons so you can focus on detailed sections that are important to you.
...
<CollapserGroup>
  <Collapser
    ...
    title="Messages"
  >
    New Relic agent: ✅ &nbsp; &nbsp; &nbsp; OpenTelemetry:  🟡 Limited support
...
<CollapserGroup>
  <Collapser
    ...
    title=""
  >
    New Relic agent: ✅ &nbsp; &nbsp; &nbsp; OpenTelemetry:  🟡 Basic and beginner
