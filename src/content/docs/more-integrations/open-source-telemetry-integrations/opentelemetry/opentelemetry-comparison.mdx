...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        👀  Semantic conventions for events is currently an [experimental capability](https://opentelemetry.io/docs/reference/specification/logs/semantic_conventions/events/) in the OpenTelemetry specification.
      </td>
    </tr>
    <tr>
      <td>
