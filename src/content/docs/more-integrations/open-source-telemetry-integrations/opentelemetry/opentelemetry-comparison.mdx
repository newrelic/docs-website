...
If you're a New Relic APM user considering whether to migrate to OpenTelemetry, the following comparisons may help you make your decision. New Relic APM and OpenTelemetry are like similar wrenches in your toolbox: you need to choose the one best suited to your task.

We welcome your data, whether you send it from New Relic-instrumented apps or from OpenTelemetry-instrumented apps. We want to make sure you know what to expect with both approaches. We compare a wide range of user experiences, but our main focus is on what you can see in the New Relic UI, depending on your approach.

<Callout variant="tip">
  You can expand all the collapsers on the page by pressing `s`.
</Callout>

## Comparison overview [#overview]

Before looking at the detailed feature comparisons, take a look at these high-level comparisons so you can focus on the sections that are important to you.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ❌ Not yet specified with OpenTelemetry
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td>
        🟡 OpenTelemetry auto-instrumentation is improving, but New Relic agents have overall broader coverage of languages
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td>
        🟡 RUM (real user monitoring) specifications in progress
      </td>
    </tr>
    <tr>
      <td>
...
<CollapserGroup>
  ...
  <Collapser
    className="freq-link"
    id=""
    title="Golang VMs, Python VMs, .NET VMs, Node.js VMs, Ruby VMs, and Ruby VMs"
  >
    New Relic agents: ✅ &nbsp; &nbsp; &nbsp; OpenTelemetry: ❌  
  </Collapser>
  <Collapser
...
<CollapserGroup>
  <Collapser
    ...
    title="Auto-instrumentation of browser front-end applications"
  >
    New Relic agents: ✅ &nbsp; &nbsp; &nbsp; OpenTelemetry: ❌ 
...
<CollapserGroup>
  ...
  <Collapser
    className="freq-link"
    id="k8s-integ"
    title="Application/service integration with K8s telemetry"
  >
    New Relic agents: ✅ &nbsp; &nbsp; &nbsp; OpenTelemetry: ❌
...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="Alert conditions list UI"
  >
    New Relic agents: ✅ &nbsp; &nbsp; &nbsp; OpenTelemetry: ✅ 
  </Collapser>
  <Collapser
    className="freq-link"
    id="alert-viol-list"
    title="Alert violations list UI"
  >
    New Relic agents: ✅ &nbsp; &nbsp; &nbsp; OpenTelemetry: ❌
  </Collapser>
</CollapserGroup>
...
<CollapserGroup>
  ...
  >
    ...
    OpenTelemetry users can report custom events by using New Relic’s [Event API](/docs/data-apis/ingest-apis/introduction-event-api/).
  </Collapser>
  <Collapser
    className="freq-link"
    id="workloads"
...
<CollapserGroup>
  <Collapser
    ...
    title="Installation"
  >
    New Relic agents: ✅ &nbsp; &nbsp; &nbsp; OpenTelemetry:  🟡 Basic and beginner

    New Relic APM agent and infrastructure agent documentation is comprehensive and on our website.

    For OpenTelemetry, we provide a [basic setup guide](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/opentelemetry-setup) and an [Examples repo](https://github.com/newrelic/newrelic-opentelemetry-examples/tree/main/collector) for several languages.
  </Collapser>
  ...
  >
    ...
    The OpenTelemetry APIs are documented in Github.
  </Collapser>
  <Collapser
    className="freq-link"
    id="trouble"
  ...
  >
    ...
    New Relic has a basic troubleshooting page for OpenTelemetry.
  </Collapser>
</CollapserGroup>
...
The New Relic Global Technical Support (GTS) organization has been moved to the Customer Adoption team to create a unified customer care team. A Global Technical Hub has been announced and is in the process of being created, and part of its responsibilities will be to help with the installation and configuration of OpenTelemetry-instrumented services.

We are in active discussions with GTS to improve the holistic support experience for customers using Open Source software that New Relic does not entirely control, like OpenTelemetry.
