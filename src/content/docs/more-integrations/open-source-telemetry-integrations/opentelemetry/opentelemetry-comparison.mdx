...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        👀 OpenTelemetry specification is experimental
      </td>
    </tr>
    <tr>
      <td>
...
<CollapserGroup>
  ...
  >
    ...
    There is an experimental API for reporting events via logs for OTel. OpenTelemetry users can also report custom events by using New Relic’s [Event API](/docs/data-apis/ingest-apis/introduction-event-api/).
  </Collapser>
  <Collapser
    className="freq-link"
    id="workloads"
