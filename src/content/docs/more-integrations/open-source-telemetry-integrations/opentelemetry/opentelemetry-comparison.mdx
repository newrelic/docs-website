...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        🟡 Opentelemetry events are ingested as regular logs.
      </td>
    </tr>
    <tr>
      <td>
...
<CollapserGroup>
  ...
  >
    ...
    You can report custom events from OpenTelemetry by using the New Relic [Event API](/docs/data-apis/ingest-apis/introduction-event-api/). Opentelemetry events are ingested as regular logs.
  </Collapser>
  <Collapser
    className="freq-link"
    id="workloads"
