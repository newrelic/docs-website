...
<CollapserGroup>
  ...
  >
    ...
    New Relic currently supports this capability as a [limited preview](/docs/data-apis/understand-data/new-relic-data-types/#events-new-relic) that maps event telemetry data to New Relic events.
