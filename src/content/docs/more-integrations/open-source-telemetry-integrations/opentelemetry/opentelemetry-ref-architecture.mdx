...
The diagram shows an implementation that ingests telemetry from OpenTelemetry, Prometheus, Jaeger, and a New Relic APM agent. The three services (A, B, and C) are instrumented to send metrics, traces, and logs.
