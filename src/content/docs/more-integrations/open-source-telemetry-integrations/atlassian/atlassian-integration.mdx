...
freshnessValidatedDate: 2024-04-12
---
...
<Callout variant="caution">
  ...
  If you have New Relic account information to hide, use an integration user that doesn't have access to your sensitive accounts.
</Callout>
...
New Relic data may be visible to non-New Relic users within your organization. These users can view information through the Jira application.
