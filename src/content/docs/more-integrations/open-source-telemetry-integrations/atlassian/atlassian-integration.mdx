...
When you select **Connect another New Relic organization**, you'll need to provide a New Relic API key. Adding a new key will delete your current connection, including all data synced to Atlassian. It will then start a new sync process with the account and organization access of the new API key.
