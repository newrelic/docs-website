...
You need a New Relic [OTLP Endpoint](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/opentelemetry-setup/#note-endpoints) and an <LicenseKey/> to configure the Jenkins OpenTelemetry plugin to send data to New Relic.
