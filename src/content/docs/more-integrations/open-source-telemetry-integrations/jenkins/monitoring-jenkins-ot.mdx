...
7. Under **System Configuration**, click **Configure System**.
...
You need a New Relic [OTLP Endpoint](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/opentelemetry-setup/#note-endpoints) and an [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) to configure the Jenkins OpenTelemetry plugin to send data to New Relic.
