...
- <DoNotTranslate>**Latency:**</DoNotTranslate> The amount of time it takes your application to service a request.
- <DoNotTranslate>**Traffic:**</DoNotTranslate> The amount of requests your system receives.
- <DoNotTranslate>**Errors:**</DoNotTranslate> The rate of requests that fail.
- <DoNotTranslate>**Saturation:**</DoNotTranslate> The stress on resources to meet the demands of your application.
...
Next, instruct Terraform to install and use the New Relic provider, by setting the `terraform` and `required_providers` blocks in <DoNotTranslate>**main.tf**</DoNotTranslate>:
...
In <DoNotTranslate>**main.tf**</DoNotTranslate>, set those values on the provider:
...
[Log in to New Relic](https://login.newrelic.com/login) and [navigate to <DoNotTranslate>**Alert Policies**</DoNotTranslate>](/docs/alerts-applied-intelligence/new-relic-alerts/alert-policies/create-edit-or-find-alert-policy#alert-policy-view) to confirm that Terraform created your new policy.
