...
* Installing with <DNT>Docker/DNT> Compose. This is suitable for quick POCs.
...
<Tabs>
	<TabsBar>
        ...
        <TabsBarItem id="2">
            Install with <DNT>Docker/DNT> Compose
        </TabsBarItem>
    </TabsBar>
...
Then initialize and run <DNT>Docker/DNT> compose by running the following commands:
