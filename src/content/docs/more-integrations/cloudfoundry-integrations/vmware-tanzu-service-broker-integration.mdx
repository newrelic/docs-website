...
16. Restage the application. You can select the link at the top of the <DoNotTranslate>**Bind**</DoNotTranslate> page, or in a terminal window, and run `cf restage` to make the changes.
