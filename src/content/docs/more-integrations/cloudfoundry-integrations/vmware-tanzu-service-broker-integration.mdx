...
redirects:
  - /docs/cloudfoundry/vmware-tanzu/vmware-tanzu-service-broker-integration
dataSource: vmware-tanzu
---

import infrastructureVmwareTanzuImport from 'images/vmware-service-broker-import.png'
import infrastructureVmwareTanzuImport2 from 'images/vmware-service-broker-import-2.png'
import infrastructureVmwareTanzuImport3 from 'images/vmware-service-broker-import-3.png'
import infrastructureVmwareTanzuImport4 from 'images/vmware-service-broker-import-4.png'
import infrastructureVmwareTanzuImport5 from 'images/vmware-service-broker-import-5.png'
import infrastructureVmwareTanzuImport6 from 'images/vmware-service-broker-import-6.png'
import infrastructureVmwareTanzuImport7 from 'images/vmware-service-broker-import-7.png'
import infrastructureVmwareTanzuImport8 from 'images/vmware-service-broker-import-8.png'
import infrastructureVmwareTanzuImport9 from 'images/vmware-service-broker-import-9.png'
import infrastructureVmwareTanzuImport10 from 'images/vmware-service-broker-import-10.png'
import infrastructureVmwareTanzuImport11 from 'images/vmware-service-broker-import-11.png'
import infrastructureVmwareTanzuImport12 from 'images/vmware-service-broker-import-12.png'
import infrastructureVmwareTanzuImport13 from 'images/vmware-service-broker-import-13.png'
import infrastructureVmwareTanzuImport14 from 'images/vmware-service-broker-import-14.png'
import infrastructureVmwareTanzuImport15 from 'images/vmware-service-broker-import-15.png'
import infrastructureVmwareTanzuImport16 from 'images/vmware-service-broker-import-16.png'
import infrastructureVmwareTanzuImport17 from 'images/vmware-service-broker-import-17.png'
import infrastructureVmwareTanzuImport18 from 'images/vmware-service-broker-import-18.png'
...
<Callout variant="important">
    **Note**: The current tile removes the all_open security group from the tile default security settings. If you are using a previous versions of the tile, make your VMware Tanzu environment more secure by removing the all_open security group from the Application Security Group (ASG) settings. The new version of the tile does not open the security, nor does it close the security if it was already open.
</Callout>
...
<table>
    ...
    <tr>
        ...
        <td>
            New Relic Service Broker 1.12.33
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        ...
        <td>
            2.10.x, 2.11.x, 2.12.x, 2.13.x, 3.x, and 4.x
        </td>
    </tr>
    <tr>
        <td>
...
## Upgrading to the Latest Version [#upgrade]
...
* In New Relic Service Broker v1.12.12 and earlier, the unique GUIDs for plans were calculated differently. For these plans to not break compatibility, the GUIDs must be the same as before. The migration script preserves the plan GUIDs for existing plans in the plan collection for v1.12.12 and earlier.
...
<Callout variant="tip">
    **Note**: The only case where you must override the Plan Guid Override is when you have changed the original license key that was associated with the plan created by New Relic Service Broker v1.12.12 or earlier. You can obtain the original plan GUID from Cloud Controller by running the following command and entering the original GUID in the Plan Guid Override property:
</Callout>
...
## Installing Through Ops Manager [#installing-ops]
...
## Configuring the Tile [#configure-tile]
...
6. Configure Service Broker Global Access.
...
7. Configure the New Relic Service Broker.
...
## Configuration with HTTP Proxy [#configure-http]

If the VMware Tanzu environment needs to use an HTTP or HTTPS proxy for external outbound communication,
the service broker itself does not need to know anything about the HTTP proxy,
as it relays the license keys to the consumer apps. The consumer app should specify the http\_proxy or
https\_proxy as an environment variable for the agent to communicate externally with non-Java apps,
...
These environment variables can either be set individually per app, or with environment variable groups to be
set for all apps as part of staging, running environments, etcetera using the Cloud Foundry Command Line Interface (cf CLI) tool.
...
Specifying JAVA\_OPTS in the Runtime environment variable group will not yield anything,
as the buildpack will not know about it.
...
## Packaging Dependencies for Offline Buildpacks [#product-dependencies]

If you are running VMware Tanzu in an offline (disconnected) environment, you should recreate and package the
