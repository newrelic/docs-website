    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>The REST catalog URI for your Databricks (Azure) workspace. This is the uri for the databricks catalog you are querying. Format: `https://adb-<workspace-id>.azuredatabricks.net/api/2.1/unity-catalog/iceberg-rest` </td>
        </tr>
        <tr>
          <td>**rest_catalog_warehouse**</td>
          <td>The name of the catalog for your Databricks (Azure) workspace.</td>
        </tr>
        <tr>
          <td>**oauth2_server_uri**</td>
          <td>The OAuth2 server URI for your Databricks (Azure) workspace that you want to query through <DNT>Lens</DNT>.</td>
        </tr>
        <tr>
          <td>**oauth2_token**</td>
          <td>[Create an OAuth2 token](https://learn.microsoft.com/en-us/azure/databricks/dev-tools/auth/oauth-m2m#-step-1-create-an-oauth-secret) for your Databricks (Azure) workspace.</td>
        </tr>
        <tr>
          <td>**azure_access_key**</td>
          <td>The [Azure access key](https://learn.microsoft.com/en-us/azure/storage/common/storage-account-keys-manage?tabs=azure-portal) for your Azure Storage account</td>
        </tr>
      </tbody>
    </table>
  </Collapser>
