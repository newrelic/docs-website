...
<DNT>Data connectors</DNT> connect <DNT>Lens</DNT> to external data sources like databases, data warehouses, and spreadsheets. To create, edit, or delete <DNT>connectors</DNT>, you need [specific RBAC permissions](/docs/new-relic-lens/overview#permissions).
