    ...
    <Steps>
      ...
      <Step>
        ...
        * **Permissions policy**: Search for the policy name you created in the previous step and select it.
        ...
        The trust policy should match the following format. `<AUTO_GENERATED_EXTERNAL_ID_FROM_LENS_UI>` represents the external ID <DNT>Lens</DNT> generates after you create the connector — for now, use the same temporary placeholder you entered above.
