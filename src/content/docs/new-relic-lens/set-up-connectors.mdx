...
Before querying data with [<DNT>Lens</DNT>](/docs/new-relic-lens/overview), you need to set up connections to supported data sources. <DNT>Lens</DNT> provides both <DNT>system connectors</DNT> for accessing NRDB data and <DNT>data connectors</DNT> for connecting to external databases and other data sources.
