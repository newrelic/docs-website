...
For query examples including cross-database joins, see [Query syntax differences from NRQL and examples](/docs/new-relic-lens/query-data#syntax-differences).
