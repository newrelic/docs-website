...
<DNT>Lens</DNT> is available to paying customers, including <DNT>Data+Compute</DNT> customers, <DNT>Data+User</DNT> customers, and paid non-profit accounts.

Querying `telemetry.<New Relic event>` through <DNT>Lens</DNT> is equivalent to running an API call. If your organization is on a <DNT>Compute</DNT> plan, these queries consume [<DNT>CCUs</DNT>](/docs/licenses/license-information/product-definitions/new-relic-one-pricing-definitions/#compute-capacity-unit).
...
<Steps>
  <Step>
    ...
    <DNT>Lens</DNT> is available to paying customers. See [Pricing](#pricing) for eligibility details.
  </Step>
