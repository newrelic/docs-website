...
<Callout variant="tip">
  To use workloads with Alerts and Applied Intelligence, as well as the rest of our [observability platform](https://one.newrelic.com), join the New Relic family! [Sign up](https://newrelic.com/signup) to create your free account in only a few seconds. Then ingest up to 100GB of data for free each month. Forever.
</Callout>
...
![Operational_workload.png](./images/Operational_workload.png "Operational_workload.png")
