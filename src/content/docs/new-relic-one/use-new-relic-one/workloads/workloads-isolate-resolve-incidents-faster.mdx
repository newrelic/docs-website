...
![1_workload_health_tab.png](src/images/1_workload_health_tab.png 'workload_health_tab.png')

<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Explorer > Workloads >
  (selected workload):** The workloads UI provides a curated view of how the
  entities in your workload are performing. The charts you see will depend on
  the types of entities you've included to the workload.
</figcaption>

<Callout variant="tip">
  Learn [how to use
  workloads](/docs/workloads/use-workloads/workloads/use-workloads).
</Callout>
