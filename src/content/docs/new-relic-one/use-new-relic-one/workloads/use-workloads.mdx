...
![Workload_health_tab](src/images/workloads20210526.png 'Workload_health_tab')
...
![workload_activity_tab.png](src/images/workloads20210526_activity.png 'workloads_activity_tab.png')
...
![workload_owner_tab.png](src/images/workloads20210526_owner.png 'workloads_owner_tab.png')
...
![New Relic One - workload creation UI](src/images/new-relic-create-workload.png 'new-relic-create-workload.png')

<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Explorer > Workloads > Create
  a workload:** When you [create a workload](#create), you choose the associated
  accounts and monitored entities.
</figcaption>
...
<CollapserGroup>
  ...
  >
    ...
    ![New Relic One workloads - add dashboards](src/images/new-relic-workloads-add-dashboards.png "new-relic-workloads-add-dashboards.png")
