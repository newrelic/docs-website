...
To view [workloads](/docs/new-relic-one/use-new-relic-one/core-concepts/new-relic-one-workloads-isolate-resolve-incidents-faster), go to [one.newrelic.com](https://one.newrelic.com) and find them on the **Explorer**. There are two main tabs, Health and Activity, plus the header.
...
![workload_health_tab_with_not_operational.png](./images/2_workload_health_tab_with_not_operational.png "2_workload_health_tab_with_not_operational.png")
...
![workload_activity_tab.png](./images/workloads_activity_tab.png "workloads_activity_tab.png")
