...
It contains:
1. The workload description. Type in relevant workloads details for your team, and for the workload's users.
2. The team(s) that own the workload, and how to contact them. From the drop-down menu, choose from the main communication tools in use today.
3. Links to the most relevant resources for the workload. Here you can add any tidbit from runbooks, code repositories, links to Jira, blog posts, or any other piece of information you'd like to share concerning the workload.  
