...
![new-relic-workload-status-main.png](src/images/new-relic-workload-status-main.png 'new-relic-workload-status-main.png')

## Configure the automatic workload status [#configure-automatic]

<Callout variant="important">
  You must have [workload management
  permissions](/docs/new-relic-one/use-new-relic-one/core-concepts/new-relic-one-workloads-isolate-resolve-incidents-faster#accounts)
  to carry out this configuration.
</Callout>
...
![new-relic-workloads-status-rule.png](src/images/new-relic-workloads-status-rule.png 'new-relic-workloads-status-rule.png')
...
<Callout variant="important">
  In this final calculation, any automatically calculated status is overridden
  if a [static status](#configure-static) has been set by a workload manager.
</Callout>
...
<Callout variant="tip">
  If you regularly need to communicate a temporary status due to your deployment
  or operations processes, you can automate the static status set up by
  integrating the
  [API](/docs/apis/nerdgraph/tutorials/nerdgraph-workloads-api-tutorials) into
  your workflows.
</Callout>

<Callout variant="important">
  Any static status set by a workload manager always overrides any other status
  values [calculated automatically](#configure-automatic).
</Callout>
...
![workloads_preview_1.png](src/images/workloads_preview_1_0.png 'workloads_preview_1.png')
