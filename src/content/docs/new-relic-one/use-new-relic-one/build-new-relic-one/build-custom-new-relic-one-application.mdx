...
To start building, go to our [developer site](https://developer.newrelic.com/) for in-depth guides and examples, and taking a moment to understand how [permissions](https://developer.newrelic.com/build-apps/permission-manage-apps) around custom applications work.
