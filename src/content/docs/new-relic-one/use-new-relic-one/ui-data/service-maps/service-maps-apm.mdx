    ...
    <tr>
      ...
      <td>
        * In pan <Icon name="fe-move"/>
          mode, click and drag.
        * In drag-select <img style={{ width: '22px'}} src={smDragSelectToggle0}/> mode, hold the **Alt** key, then click and drag.
      </td>
    </tr>
...
<CollapserGroup>
  ...
  >
    ...
    * Click the drag-select <img style={{ width: '22px'}} src={smDragSelectToggle0}/> icon to switch to drag-select mode. Click and drag the mouse to draw a square around the nodes you want to select.
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            Select two or more nodes, then select <img style={{ width: '22px'}} src={smGroupingIcon}/> **Create group**.
          </td>
        </tr>
