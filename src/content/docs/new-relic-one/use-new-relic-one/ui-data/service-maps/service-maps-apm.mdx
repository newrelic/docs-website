...
<Callout variant="important">
  Previously, you could have private service maps. Now, all users can view,
  edit, and delete all existing or new service maps in the account.
</Callout>
...
<CollapserGroup>
  ...
  >
    ...
    ![crop-incoming-outgoing-service-maps.png](src/images/crop-incoming-outgoing-service-maps.png "crop-incoming-outgoing-service-maps.png")
  ...
  >
    ...
    1. Go to **[one.newrelic.com](https://one.newrelic.com) > More > Service maps > (select a map) > App/Service**.
    2. From the **App/Service** list, select ![](src/images/custom-node.png) **Create custom node**.
    3. Name the node.
    ...
    ![crop-custom-connections-service-maps.png](src/images/crop-custom-connections-service-maps.png "crop-custom-connections-service-maps.png")
    ...
    <tr>
      ...
      <td>
        * In pan <Icon name="fe-move"/>
          mode, click and drag.
        * In drag-select <ImageSizing width="22px">![](src/images/sm-drag-select-toggle_0.png)</ImageSizing> mode, hold the **Alt** key, then click and drag.
      </td>
    </tr>
...
<CollapserGroup>
  ...
  >
    ...
    * Click the drag-select <ImageSizing width="22px">![](src/images/sm-drag-select-toggle_0.png)</ImageSizing> icon to switch to drag-select mode. Click and drag the mouse to draw a square around the nodes you want to select.
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            Select two or more nodes, then select <ImageSizing width="22px">![](src/images/sm-grouping-icon.png)</ImageSizing> **Create group**.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            ...
            ![Remove Nodes from Groups](src/images/crop-service-map-app-group.png "Remove Nodes from Groups")
          </td>
        </tr>
      </tbody>
    </table>
...
![Add service maps to your dashboards](src/images/map_in_dashboard.png 'map_in_dashboard.png')

<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Dashboards**: adding a
  service map to a dashboard provides context for the data being reported and
...
<CollapserGroup>
  ...
  >
    ...
    ![crop-service-map-app-group.png](src/images/crop-service-map-app-group.png "crop-service-map-app-group.png")
  ...
  >
    ...
    ![crop-app-details-service-maps.png](src/images/crop-app-details-service-maps.png "crop-app-details-service-maps.png")
  ...
  >
    ...
    * Add new apps and mobile apps to your map.
  ...
  >
    ...
    ![Screenshot showing how to discover your environment for service maps.](src/images/discover_your_environment.png "discover_your_environment.png")
  ...
  >
    ...
    ![Zoom out of your service map to view in traffic lights mode](src/images/traffic-lights_service-maps_APM.jpg "traffic-lights_service-maps_APM.jpg")
