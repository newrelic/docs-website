...
![Screenshot showing the automap UI](src/images/automaps-overview.png 'Screenshot showing the automap UI')
...
<Callout variant="important">
  Automap auto-expand logic relies on the health status of an entity, which is
  largely determined by the alert status of that entity. For optimal
  troubleshooting with automap, ensure that your [alerts are properly
  configured](docs/new-relic-solutions/best-practices-guides/alerts-applied-intelligence/alerts-best-practices/).
</Callout>
...
4. Click **Map view**:
    ...
    ![Screenshot showing the Map view button](src/images/map-view-button.png "Screenshot showing the Map view button")
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Application service instrumented with a New Relic APM agent</td>
      <td style="text-align:center">
        ![Screenshot of application icon](src/images/application-icon.svg
        "Screenshot of application icon")
      </td>
    </tr>
    <tr>
      ...
      <td style="text-align:center">
        ![Screenshot of browser application
        icon](src/images/browser-application-icon.svg "Screenshot of browser
        application icon")
      </td>
    </tr>
    <tr>
      <td>EXT|SERVICE</td>
      <td>
        Services instrumented with OpenTelemetry, including Pixie-instrumented
        services
      </td>
      <td style="text-align:center">
        ![Screenshot of application icon](src/images/application-icon.svg
    ...
    <tr>
      ...
      <td>Mobile app instrumented with a New Relic agent</td>
      <td style="text-align:center">
        ![Screenshot of browser application
        icon](src/images/mobile-application-icon.svg "Screenshot of mobile
        application icon")
      </td>
    </tr>
    <tr>
      ...
      <td style="text-align:center">
        ![Screenshot of workload icon](src/images/workload-icon.svg "Screenshot
        of workload icon")
      </td>
    </tr>
    <tr>
      ...
      <td style="text-align:center">
        ![Screenshot of synthetic icon](src/images/synthetic-icon.svg
        "Screenshot of synthetic icon")
      </td>
    </tr>
  </tbody>
</table>
...
<Video type="wistia" id="xqj83ghoog" />
...
![Screenshot showing where to uncheck options](src/images/layer-control-check-boxes.png 'Screenshot showing where to uncheck options')

Here is an example of how the controls work:

<Video type="wistia" id="e15c99hsr2" />
...
<table>
  <thead>
    <tr>
      <th style={{ width: '200px' }}>Health status</th>
  ...
  <tbody>
    <tr>
      <td>Critical</td>
      <td style="text-align:center">
        ![Screenshot showing the red critical
        hexagon](src/images/critical-health-status.svg "Screenshot showing the
        red critical hexagon")
      </td>
    </tr>
    <tr>
      <td>Warning</td>
      <td style="text-align:center">
        ![Screenshot showing the beige warning
        hexagon](src/images/warning-health-status.svg "Screenshot showing the
        beige warning hexagon")
      </td>
    </tr>
    <tr>
      <td>Not alerting</td>
      <td style="text-align:center">
        ![Screenshot showing the green not-alerting
        hexagon](src/images/not-alerting-health-status.svg "Screenshot showing
        the green not-alerting hexagon")
      </td>
    </tr>
    <tr>
      <td>Not configured</td>
      <td style="text-align:center">
        ![Screenshot showing the gray not-configured
        hexagon](src/images/not-configured-health-status.svg "Screenshot showing
        the gray not-configured hexagon")
      </td>
    </tr>
    <tr>
      <td>Anomaly</td>
      <td style="text-align:center">
        ![Screenshot showing the purple anomaly
        hexagon](src/images/anomaly-health-status.svg "Screenshot showing the
        purple anomaly hexagon")
      </td>
    </tr>
  </tbody>
</table>
