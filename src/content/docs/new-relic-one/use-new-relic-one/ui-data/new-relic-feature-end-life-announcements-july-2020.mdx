...
![New Relic One: Embed chart](src/images/nrone-embed-bb062520.png 'New Relic One: Embed chart')
...
![NR One transition: distributed tracing](src/images/nrone-transition-eol-dt070720.png 'NR One transition: distributed tracing')

<figcaption>
  New Relic One's distributed tracing page builds on capabilities you are
...
![NR One transition: Alerts violations](src/images/nrone-transition-eol-violations070620.png 'NR One transition: Alerts violations')

<figcaption>
  Here's an example of the detailed information about an Alerts violation for a
  selected entity in New Relic One.
</figcaption>
