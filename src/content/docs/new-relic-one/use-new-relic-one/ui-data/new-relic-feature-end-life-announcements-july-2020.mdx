...
**Recommendation:** For best results exploring comprehensive data about your apps and hosts, use [query builder](/docs/chart-builder/use-chart-builder/get-started/introduction-chart-builder#specify-data) in New Relic One or the [NerdGraph API](/docs/apis/nerdgraph/examples/nerdgraph-nrql-tutorial). For best results with Insights, run separate queries for apps and hosts.
