...
Some New Relic features have maps in context that show you how your monitored entities are connected and deployed. 

## Why it matters [#why]

New Relic maps in context show how your software systems are related, helping you quickly assess, diagnose, and correct issues. The map's content and presentation vary depending on your use case, while some features are always available.

## Where to find maps in context [#find]

You can find maps in context in these UI locations: 

From a distributed trace, choose a span. 
