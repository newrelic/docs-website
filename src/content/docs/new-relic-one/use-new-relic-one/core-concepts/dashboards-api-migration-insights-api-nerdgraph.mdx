...
| Insights API visualization  | Nergraph API visualization  | Notes  |
|---|---|---|
...
|application_breakdown|viz.area|Legacy predefined_metric_chart|
|scope_breakdown|viz.area|Legacy predefined_metric_chart|
|browser_breakdown|viz.area|Legacy predefined_metric_chart|
|background_breakdown|viz.area|Legacy predefined_metric_chart|
|solr_breakdown|viz.area|Legacy predefined_metric_chart|
|gc_runs_breakdown|viz.area|Legacy predefined_metric_chart|
