...
Use the New Relic Explorer at **[one.newrelic.com](http://one.newrelic.com)**!

![nrexplorer2.png](./images/nrexplorer20210722.png "nrexplorer2.png")
...
5. **[Filterbar](#filter-tag)**. Drill down and locate problematic entities easily with our improved search capabilities, and benefit from the `AND` and OR operators in place.
6. **See everything**. All the different entity types you have access to are listed in the collapsible sidebar on the left of the screen. This sidebar is interactive and used for exploratory purposes, and it allows you to see only entities of the selected type, updating the filter from the filterbar.
