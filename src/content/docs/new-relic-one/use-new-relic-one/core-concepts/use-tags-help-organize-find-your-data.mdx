...
* Identify teams, roles, environment, or regions to know who’s responsible for what (see example [use cases](#org-examples))
...
As explained in [Tag sources](#tag-sources), some important [attributes](/docs/using-new-relic/welcome-new-relic/get-started/glossary#attribute) are used as tags. You can query all attributes and create custom charts using [NRQL](/docs/query-your-data/nrql-new-relic-query-language/get-started/introduction-nrql-new-relics-query-language), and create [NRQL alert conditions](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-nrql-alert-conditions).
