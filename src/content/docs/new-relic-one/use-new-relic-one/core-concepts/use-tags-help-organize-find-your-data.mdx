...
* [Help you query and chart APM data](#query-apm-tags)
...
Different features handle tags differently. Here are some details about how you can use [NRQL](/docs/query-your-data/nrql-new-relic-query-language/get-started/introduction-nrql-new-relics-query-language/) to query tag data.

### Query APM tags [#query-apm-tags]
...
Given a service that is distributed across nine shards, each shard assigned as an `environment`, we can plot the transaction throughput on all shards using a query like: 
...
As explained in [Tag sources](#tag-sources), some important [attributes](/docs/using-new-relic/welcome-new-relic/get-started/glossary#attribute) are used as tags. You can query all attributes and create custom charts using [NRQL](/docs/query-your-data/nrql-new-relic-query-language/get-started/introduction-nrql-new-relics-query-language).