...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        When the realtionship is create, the external service reports a span with its name on the `service.name` attribute and the name of the service that initiates the call in the `parent.service.name` attribute.
      </td>
    </tr> 
    ...
    <tr>
      ...
      <td>
        When the realtionship is created, the external service reports a span with the following attributes:
