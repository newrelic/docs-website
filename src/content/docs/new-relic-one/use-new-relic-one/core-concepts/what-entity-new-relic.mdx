...
<table>
  ...
  <tbody>
    <tr>
      <td>
        Service or application instrumented with a New Relic agent
      </td>
      ...
      <td>
        When the New Relic agent detects that a service calls another service which is instrumented, it records a metric, 
        `ClientApplication/101#54321/all`. 
        * The caller in the relationship is a New Relic monitored APPLICATION, determined by the 2rd segment in the METRIC.
        * The app reporting the METRIC is the callee.
        
        In the example above, the callee is `APPLICATION 54321` for account 101.
      </td>
    </tr> 
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        You have an application running in one or more hosts, and the infra agent is running in those hosts.
      </td>
    </tr> 
    ...
    <tr>
      ...
      <td>
        You have your containers running in one or more hosts, and the host is instrumented with the infra agent.
      </td>
    </tr> 
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        A pod is created in a cluster instrumented with the New Relic Kubernetes integration.
      </td>
    </tr> 
    ...
    <tr>
      ...
      <td>
        A deployment is created in a cluster instrumented with the New Relic Kubernetes integration.
      </td>
    </tr> 
    ...
    <tr>
      ...
      <td>
        A DaemonSet is created in a cluster instrumented with the New Relic Kubernetes integration.
      </td>
    </tr> 
    ...
    <tr>
      ...
      <td>
        A StatefulSet is created in a cluster instrumented with the New Relic Kubernetes integration.
      </td>
    </tr> 
    ...
    <tr>
      ...
      <td>
        A host that's part of a cluster instrumented with the New Relic Kubernetes integration.
      </td>
    </tr> 
    ...
    <tr>
      ...
      <td>
        A deployment creates a pod in a cluster instrumented with the New Relic Kubernetes integration.
      </td>
    </tr> 
    ...
    <tr>
      ...
      <td>
        A DaemonSet created a pod in a cluster instrumented with the New Relic Kubernetes integration.
      </td>
    </tr> 
    ...
    <tr>
      ...
      <td>
        A StatefulSet creates a pod in a cluster instrumented with the New Relic Kubernetes integration.
      </td>
    </tr> 
    ...
    <tr>
      ...
      <td>
        A pod creates a container in a cluster instrumented with the New Relic Kubernetes integration.
      </td>
    </tr> 
    ...
    <tr>
      ...
      <td>
        A pod is running in a host that's part of a cluster instrumented with the New Relic Kubernetes integration.
      </td>
    </tr> 
    ...
    <tr>
      ...
      <td>
        You have an application running in docker, and the  hosts where docker is running are instrumented by the the infra agent.
