...
* What are some of the new and improved New Relic One chart, dashboard, and query features
...
The transition to New Relic One has two parts: the UI and mobile app experience (April 11, 2021) and the Dashboard API (July 2021).
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        We have already taken care of your transition from Insights to New Relic One for you! As of April 11, 2021, your old Insights web URLs redirect automatically to New Relic One.
    ...
    <tr>
      ...
      <td>
        Your Insights mobile app is deprecated as of April 11, 2021. 
