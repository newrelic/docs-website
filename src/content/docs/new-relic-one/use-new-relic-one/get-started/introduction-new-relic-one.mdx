...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Search by name [across all accounts](/docs/new-relic-one/use-new-relic-one/core-concepts/cross-account-features-security) in the unified search, or filter the explorer by tags or text
      </td>
    </tr>
