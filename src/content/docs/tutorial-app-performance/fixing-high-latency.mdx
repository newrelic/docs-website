...
This tutorial walks you through using New Relic to fix site latency. This tutorial walks you through these tasks:

* Understanding different types of latency and how your customers experience them
* Taking preventative measures ahead of high latency 
* Using New Relic to diagnose causes of latency
...
Looking into a latency issue from different points of view gives you more accuracy when it's time to plan a resolution. Once you've decided the best course of acction, you can get your site back to the levels that keep your customers happy.
