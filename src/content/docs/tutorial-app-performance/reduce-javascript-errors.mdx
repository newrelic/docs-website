...
This tutorial walks you through finding and resolve JavaScript errors. By the end of the tutorial, you will have these tasks completed:

* Finding JavaScript errors information in New Relic
* Applying our recommendations when prioritizing errors
* Using event logs to resolve JavaScript errors

## Find JavaScript errors [#find-errors] 

From the browser monitoring **Summary** page, two charts can indicate you have JavaScript errors: **Error Rate** and **Top 10 error messages**. Selecting either chart takes you to the **JS errors** page, which gives you a more detailed view of your site'sJavaScript errors. 
...
Once you've discovered some JavaScript errors, you need to prioritize your fixes. Prioritizing errors is complex, and can be based on frequency of the error, severity, regions affected, and other factors. Let's use an example to walk you through how to prioritize JavaScript errors. 
...
* **Error instances** takes you to the **Event Log** and **Stack trace** pages. You can find more details about the specific error, such as whether or not a JavaScript file caused the error, or if you need to fix parts of inline code. 
* Scroll through the **Event Log** section to ensure you've found everything that needs to be fixed. If there's more to resolve, your event logs will let you know.
