---
title: Improve your website's performance with New Relic
redirects:
...
## Capture performance data about your site [#capture]
...
Once you've instrumented your site, you can overview your site's performance with different types of data. Measuring data
...
<UserJourneyControls
    nextStep={{path: "/docs/tutorial-app-performance/guide-to-monitoring-core-web-vitals/", title: "Next step", body: "Measure your site's core web vitals"}}
/>