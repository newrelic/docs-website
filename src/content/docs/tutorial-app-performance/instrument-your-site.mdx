...
<UserJourneyControls
    nextStep={{path: "/docs/tutorial-app-performance/guide-to-monitoring-core-web-vitals/", title: "Next step", body: "Learn how to apply core web vitals insights into your site improvements"}}
/>