...
This configuration will obfuscate URLs that match an example url of `/api/v1/users/12345456/edit` and replace all the digits in the middle of the URL with `**</DoNotTranslate>` (two asterisks). The resulting URL will be `/api/v1/users/**/edit`.
