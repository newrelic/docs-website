...
* If an error group is expected, you can mark the error as <DNT>**Ignored**</DNT>. Expected errors are known to you and the team—they can be non-critical bugs, or they can be errors associated with the end user (like someone using an incorrect password). 
