...
The **Intelligent summary** page serves as your central hub for monitoring all cloud spending. It provides a comprehensive overview of your costs with dynamic visualizations that help you understand how spending flows through your organization—from services to teams to regions—all in a single, navigable interface.
...
The Intelligent summary page provides a unified view of all your cloud spending with powerful visualization and navigation capabilities:

- **Dynamic Sankey chart visualization:** Visualize how costs flow through your organization with an interactive Sankey chart that shows the relationship between services, teams, and regions. The chart is fully navigable and allows you to click through to explore specific cost segments in detail.
- **Multi-dimensional cost segregation:** See how your total cloud spending is distributed:
  - By **services** (e.g., compute, storage, networking)
  - Within services, by **teams** or **accounts**
  - Within teams, by **regions**
  - All views are dynamic and can be adjusted based on your analysis needs
- **Flexible navigation:** Switch between different views (services, accounts, regions) to analyze costs from multiple perspectives. All visualizations are interactive and update dynamically as you explore your data.
