...
The **Intelligent summary** page gives a consolidated view of all your cloud spending. It shows how costs flow through your organization and how spending is segregated between different services, within those services by different teams, and within those teams by different regions. The page is dynamic and navigable, allowing you to change views according to what is required.
...
The Intelligent summary page provides:
