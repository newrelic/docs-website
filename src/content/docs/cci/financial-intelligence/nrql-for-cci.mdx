...
Query <DNT>Cloud Cost Intelligence</DNT> data using <DNT>NRQL</DNT> to analyze and optimize cloud spending. Five event types are available with attributes for detailed queries:
