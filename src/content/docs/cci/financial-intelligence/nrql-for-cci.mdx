...
<CollapserGroup>
  <Collapser
    id="state-select"
    title="Following are the required clauses that captures the NRQL to SQL translator for XDS basics."
  >
  ...
  - [`AVERAGE()`](/docs/nrql/nrql-syntax-clauses-functions/#func-average)
