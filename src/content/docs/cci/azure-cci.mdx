    ...
    Determine whether a billing export already exists that matches the parameters specified below:
      ...
      - **If no matching export exists**: Follow the steps below to create a new billing export.
        ...
        4. **Configure storage settings**
            ...
            After configuring the export parameters, click **Next** to proceed to storage configuration. Configure the storage settings with the following specifications:
