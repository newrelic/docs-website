...
<CollapserGroup>
  ...
  >
    ...
    Learn more about [alert policies](/docs/alerts-applied-intelligence/new-relic-alerts/alert-policies/specify-when-alerts-create-incidents/).
  </Collapser>
  ...
  >
    Balancing responsiveness and fatigue in your alerting strategy is crucial, and you've laid out the key considerations regarding `pageview` monitoring for your <DNT>Cloud Cost Intelligence</DNT>. Let's explore the policy options:
