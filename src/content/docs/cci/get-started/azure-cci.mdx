...
**Already have a FOCUS export?** If you have an existing billing export with **Cost and Usage (FOCUS)** format, daily frequency, and Parquet compression, you can use it. Otherwise, create a new export in Steps 1-3.
</Callout>
...
<Steps>
  <Step>
    ...
    3. Review the list for an export with **Cost and Usage (FOCUS)** format and **Parquet** compression.
      ...
      - **If a matching export exists**: Proceed to Step 4.
      - **If no matching export exists**: Continue to Step 2.
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Enter the relative path where billing data drops in monthly format (for example, `20251101-20251130` for November 2025, or `20251201-20251231` for December 2025).
            **Note**: Leave empty if the export publishes to the container root.
          </td>
          <td>
          </td>
        </tr>
  ...
  <Step>
    ...
    Go to [**Intelligent summary**](/docs/cci/financial-intelligence/cloud-cost-insights) to view your Azure cost data and optimize spending.
  </Step>
</Steps>
