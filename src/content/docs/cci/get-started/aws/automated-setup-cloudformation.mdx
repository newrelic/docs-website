...
<Steps>
  <Step>
    ...
    Navigate to <DNT>[**one.newrelic.com**](https://one.newrelic.com/) > **Integrations & Agents** > **Cloud Cost Intelligence - AWS**</DNT>.
  </Step>
  ...
  <Step>
    ...
    2. Click **Launch your CloudFormation in AWS**. 
    3. Log in to your AWS account with **Admin role** when prompted. The **CloudFormation Stacks** screen opens in the AWS console.
  </Step>
