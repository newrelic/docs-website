...
Manually integrate your AWS account with Cloud Cost Intelligence by configuring the required AWS resources and settings. This method provides complete control over each configuration step. For the following steps, sign in to the **AWS Management Console** and remain signed in throughout the process.
...
<Steps>
  ...
  <Step>
    ...
    1. In the left navigation menu, select **Cloud Cost Intelligence** and click **Add the integration**.
