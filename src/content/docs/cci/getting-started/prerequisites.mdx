...
<CollapserGroup>
  <Collapser
    ...
    title="Create an s3 bucket for cloud ost and usage reports"
  >
...
Important: Remember the bucket name as you'll need them in the following steps and installation steps on CCI.
