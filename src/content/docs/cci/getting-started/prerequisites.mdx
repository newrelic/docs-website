...
<CollapserGroup>
  ...
  AWS Cost and Usage Reports (CUR) will be stored in an S3 bucket. We recommend the S3 bucket to be created in the `us-east-2` region. Follow these steps to create a dedicated bucket:
    ...
    1. Sign in to the <DNT>**AWS Management Console**</DNT>.
...
<Collapser
  ...
  Create a Cost and Usage Report to be delivered to your S3 bucket:
    ...
    1. Sign in to the <DNT>**AWS Management Console**</DNT>.
    2. Navigate to the <DNT>**Billing Dashboard**</DNT>.
    3. In the left navigation pane, click <DNT>**Cost & Usage Analysis**</DNT>.
    4. Click <DNT>**Data Exports**</DNT> and then <DNT>**Create**</DNT>.
  ...
  1. Sign in to <DNT>**AWS Management Console**.</DNT>
...
- [Install the Kubernetes integration](/docs.newrelic.com/install/kubernetes/). AWS Fargate integration is not supported for this feature.
...
- Configure [cost allocation tags](https://docs.aws.amazon.com/tag-editor/latest/userguide/tagging.html) in your AWS account. Tagging facilitates detailed and meaningful cost categorization. Ensure that any two custom resource tags are consistently applied across your AWS resources for effective cost filtering and grouping.
- Use an S3 bucket located in a `US-East-2` region for optimal performance and cost efficiency.
