...
<Callout variant="tip">
  <DoNotTranslate>**Note**</DoNotTranslate>: X-API-KEYs are rate limited to 600 requests per minute.
</Callout>

## GET mobile-crashes/

<DoNotTranslate>**Purpose:**</DoNotTranslate> Returns the most recent crash types.
...
<CollapserGroup>
  <Collapser
    ...
    title="Resource"
  >
    <DoNotTranslate>**Resource URL:**</DoNotTranslate>

    ```
    https://mobile-data-api.newrelic.com/v1/mobile-crashes​/{account_id}/{mobile_application_id}
    ```

    <DoNotTranslate>**URL parameters:**</DoNotTranslate>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <DoNotTranslate>**May be null.**</DoNotTranslate>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            ...
            <DoNotTranslate>**May be 0.**</DoNotTranslate>
          </td>
        </tr>
...
<DoNotTranslate>**Purpose:**</DoNotTranslate> Returns details about recent crash fingerprints.
...
<DoNotTranslate>**Purpose:**</DoNotTranslate> Returns details about a specific crash occurrence.

<Callout variant="tip">
  <DoNotTranslate>**Note**</DoNotTranslate>: Time period matters! If you do not get any crash details for an occurrence, try expanding your start and end times.
</Callout>
    ...
    <table width="100%">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            The named assigned to the thread. <DoNotTranslate>**May be null.**</DoNotTranslate>
          </td>
        </tr>
    ...
    <table width="100%">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            The filename containing the instruction. <DoNotTranslate>**May be empty or null.**</DoNotTranslate>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            The class name containing the instruction. <DoNotTranslate>**May be empty or null.**</DoNotTranslate>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            The method name containing the instruction. <DoNotTranslate>**May be empty or null.**</DoNotTranslate>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            The line number of the instruction. <DoNotTranslate>**May be 0.**</DoNotTranslate>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            The address of the symbol containing the instruction. <DoNotTranslate>**May be empty or null.**</DoNotTranslate>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            The symbol string of the symbol address. <DoNotTranslate>**May be empty or null.**</DoNotTranslate>
          </td>
        </tr>
      </tbody>
    </table>
...
<DoNotTranslate>**Purpose:**</DoNotTranslate> Returns symbolicated (iOS) or deobfuscated (Android) thread data for a given crash fingerprint.
