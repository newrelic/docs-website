...
* Your New Relic Mobile [application ID](/docs/apis/rest-api-v2/requirements/finding-product-id#mobile)
...
Additional documentation resources include [Investigate a mobile app crash report](/docs/mobile-monitoring/mobile-monitoring-ui/crashes/investigate-mobile-app-crash-report) (summary and in-depth details about unique crashes).
