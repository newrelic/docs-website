...
<CollapserGroup>
    ...
    <Steps>
        <Step>
        Go to [<DNT>**one.newrelic.com > Add Data**</DNT>](https://one.newrelic.com/marketplace), then select the feature you want to create a dashboard for. For our example, we'll choose <DNT>**Infrastructure & OS**</DNT>, and create a dashboard to monitor an Azure integration.  
        </Step>
        <Step>
...
<CollapserGroup>
    ...
    <Steps>
        <Step>
        Go to [<DNT>**Add Data**</DNT>](https://one.newrelic.com/marketplace), then select the feature you want to create a dashboard for. For our example, we'll choose <DNT>**Application monitoring**</DNT>, and create an alert to notify of us issues with a Ruby app.  
        </Step>
        <Step>
