...
As soon as you begin ingesting data, New Relic automatically begins providing you visualizations to help monitor it without any further setup from you. The dashboards and charts we generate for you give out-of-the-box, granular details on what you've chosen to monitor. For example, once you finish setting up an APM, you'll immediately have access to data on:
