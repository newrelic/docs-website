...
<DocTiles numbered>
  <DocTile title='Install an agent' path="/docs/journey-migration/installing-agent/" label={{text: "Tutorial", color: "blue"}}>Start by setting up an agent to ingest your data</DocTile>
  <DocTile title='Create dashboards' number='4' path="/docs/journey-migration/migrating-dashboards/" label={{text: "Tutorial", color: "blue"}}>Then, learn how to navigate the New Relic UI and set up your dashboards</DocTile>
