...
1. Go to <DoNotTranslate>**[one.newrelic.com > Dashboards](https://one.newrelic.com/dashboards)**</DoNotTranslate>. 
2. Click <DoNotTranslate>**View all**</DoNotTranslate>.
3. Search <DoNotTranslate>**Infrastructure Dashboard**</DoNotTranslate> from <DoNotTranslate>**Infrastructure & OS**</DoNotTranslate>.
        ...
        <SideBySide>
            ...
            /> 
                ...
                The <DoNotTranslate>**View All**</DoNotTranslate> page lets you explore our prebuilt dashboards. 
            </Side>
...
1. <DoNotTranslate>**Identify the problem you want to solve.**</DoNotTranslate> For example, you have certain processes that are consistently high resource consumers, but these processes are distributed across different hosts. 
2. <DoNotTranslate>**Experiment with NRQL.**</DoNotTranslate> You need to decide the best format for presenting this data visually. NRQL lets you create line graphs, tables, pie charts, or time series. 
...
3. <DoNotTranslate>**Adapt an existing query to create new widgets.**</DoNotTranslate> You can do this by clicking the ellipses on a graph you want to mimic and selecting <DoNotTranslate>**View query**</DoNotTranslate>. 
...
You can find specific metrics you might want to add to a dashboard via our <DoNotTranslate>**Metrics explorer**</DoNotTranslate>. There are a few different ways to access the explorer that depend on what you need. To view all metrics for all your data sources, go to <DoNotTranslate>**[one.newrelic.com > Metrics & Events](https://one.newrelic.com/data-explorer)**</DoNotTranslate>.
...
1. Go to <DoNotTranslate>**[one.newrelic.com > All Capabilities > Infrastructure](https://one.newrelic.com/infra/infrastructure/hosts)**</DoNotTranslate>, then find your host.
2. Open the host-scoped summary page.
3. Click <DoNotTranslate>**Metrics explorer**</DoNotTranslate>. Choose the metric and dimensions you want the graph to represent. For our purposes, we've chosen `host.process.threadCount` and have grouped it by `apmApplicationNames`. 
4. Click the ellipses and select <DoNotTranslate>**Add to dashboard**</DoNotTranslate>.
...
<UserJourneyControls
    previousStep={{path: "/docs/tutorial-troubleshoot-infra-hosts/investigate-your-resources", title: "Previous step", body: "Make resource decisions with your data"}}
/>