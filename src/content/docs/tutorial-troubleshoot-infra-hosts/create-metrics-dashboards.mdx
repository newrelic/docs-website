...
<Callout variant="tip">
If you want to learn more about writing NRQL queries, see our [NRQL tutorial](/docs/query-your-data/nrql-new-relic-query-language/get-started/introduction-nrql-how-nrql-works/).
</Callout>
