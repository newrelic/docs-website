...
<Callout variant="caution">
 If the API key is a [license key](/docs/apis/intro-apis/new-relic-api-keys/#ingest-license-key) then the HTTP header should be `X-License-Key` instead of `Api-Key`.
</Callout>
