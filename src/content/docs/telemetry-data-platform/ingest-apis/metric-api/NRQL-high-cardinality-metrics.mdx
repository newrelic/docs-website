...
<Callout variant="tip">
  If you'd like to learn more about limits and troubleshooting  the Metric API, [Metric API limits and restricted attributes](/docs/telemetry-data-platform/ingest-apis/metric-api/metric-api-limits-restricted-attributes/) and [Troubleshoot Metric API with NRIntegrationError events](/docs/telemetry-data-platform/ingest-apis/metric-api/troubleshoot-nrintegrationerror-events/) are both great resources to explore. 
</Callout>
