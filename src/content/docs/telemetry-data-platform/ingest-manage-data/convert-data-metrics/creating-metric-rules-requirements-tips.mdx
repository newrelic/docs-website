  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        If this limit is exceeded, the rule is disabled and an [`NrIntegrationError` event](/docs/insights/insights-data-sources/custom-data/send-custom-events-event-api#nrIntegration) is created in the account that includes:

        * The rule details
        * A message about having too many facets
        * A `newRelicFeature` of `eventToMetric`
      </td>
    </tr>
