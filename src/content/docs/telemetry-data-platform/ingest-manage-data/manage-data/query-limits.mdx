...
An `NrIntegrationError`  is generated when you experience impact and is a good way to quickly see if you’re experiencing any limit events. See [View System Limits](/docs/telemetry-data-platform/ingest-manage-data/manage-data/view-system-limits/) for more information.
