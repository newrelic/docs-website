...
This doc applies to organizations on our [New Relic One pricing plan](/docs/accounts/accounts-billing/new-relic-one-pricing-users/pricing-billing). If you're on our original product-based pricing plan, you have different data retention rules. See [Original data retention](/docs/accounts/original-accounts-billing/product-based-pricing/overview-data-retention-components). Not sure which plan you're on? See [Overview of pricing and account/user structure](/docs/transition-guide-our-new-pricing-plan-user-model).
</Callout>
