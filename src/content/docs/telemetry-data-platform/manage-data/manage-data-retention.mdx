...
You also must have one of the following roles:

* User with the Data Retention Manager add-on role
* Custom role with the Insights Event Retention (modify) capability
