...
Two things must intersect for a user to edit retention - account access to flexible retention and user permission on that account. 
Accounts with access to flexible retention are:

* legacy accounts with Insights Pro  
* NR1 accounts with Pro or Enterprise. 
