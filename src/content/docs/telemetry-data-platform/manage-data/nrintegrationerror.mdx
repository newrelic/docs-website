...
Our `NrIntegrationError` event is used to capture errors related to data ingest, including: 

* Exceeding of New Relic data limits 
* Malformed data
...
## Understand account to your account [#audit-events]

If you're trying to understand changes that have been made in your New Relic account (like what user did what when), see [`NrAuditEvent`](/docs/telemetry-data-platform/understand-data/event-data/nrauditevent-event-data-query-examples). 