...
To break down your ingested data, start from the **Data ingested per day by source** chart.Think of the data source bands as the Y axis, and the dates as the X axis. Click on the band you want to inspect above the date you want to investigate. 
...
* The ingest value provided on the **Data ingested per day by source** chart will be slightly different from that reflected during inspection. This is because our facet computation is an estimate.
