...
This document describes the structure of dimensional metric (`Metric` data) collected and reported by our platform. To learn about how to query this type of data, see [Query metrics](/docs/telemetry-data-platform/get-data/apis/query-metric-data-type/).
