...
![New Relic One query builder - metric timeslice NRQL query ](./images/new-relic-one-nrql-query-metric-timeslice-data.png "new-relic-one-nrql-query-metric-timeslice-data.png")
