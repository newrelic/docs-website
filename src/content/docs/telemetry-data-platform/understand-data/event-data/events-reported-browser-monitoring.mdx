...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        An `AjaxRequest` event is created any time an Ajax call is made. This can happen either automatically when an Ajax request occurs during a `BrowserInteraction` event or during any stand-alone Ajax request. The event attributes track geographic and browser info.
      </td>
    </tr>
