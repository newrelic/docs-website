...
There are two types of retention for partitions. Choose <DNT>**Standard**</DNT> for maximimum retention; use this for valuable data you may want to query far in the future. Choose <DNT>**Secondary**</DNT> for 30-day retention; use this for less valuable data or for data you will only need in the near future.
