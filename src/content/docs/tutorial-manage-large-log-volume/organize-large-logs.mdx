...
There are two types of retention for partitions. Choose <DoNotTranslate>**Standard**</DoNotTranslate> for maximimum retention; use this for valuable data you may want to query far in the future. Choose <DoNotTranslate>**Secondary**</DoNotTranslate> for 30-day retention; use this for less valuable data or for data you will only need in the near future. 
...
<Steps>
    ...
    Go to <DoNotTranslate>**[one.newrelic.com > Logs](https://one.newrelic.com/launcher/logger.log-launcher)**</DoNotTranslate>    
    </Step>
    <Step>
...
1. From <DoNotTranslate>**Manage data**</DoNotTranslate> on the left nav, click <DoNotTranslate>**Data partitions**</DoNotTranslate>, then click <DoNotTranslate>**Create partition rule**</DoNotTranslate>.
...
6. Click <DoNotTranslate>**Create**</DoNotTranslate> to save your new partition.
...
1. From <DoNotTranslate>**Manage Data**</DoNotTranslate> on the left nav of the logs UI, click <DoNotTranslate>**Parsing**</DoNotTranslate>, then click <DoNotTranslate>**Create parsing rule**</DoNotTranslate>.
...
6. Enter the parsing rule and validate it's working by viewing the results in the <DoNotTranslate>**Output**</DoNotTranslate> section. (See example below)
