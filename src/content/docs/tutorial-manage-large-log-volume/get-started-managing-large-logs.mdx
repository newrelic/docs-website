...
New Relic's philosphy when it comes to <InlinePopover type="logs" /> focuses on three things: we want our logs solution to be **flexible, transparent, and usage-based**. Let's quickly talk about what these mean:
