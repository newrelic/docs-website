...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>
        Acceptance criteria are the requirements that need to be met in order to mark a user story as complete. For example, if your user story is, "As a New Relic customer I want to know how to interpret AI anomalies in order to monitor my site and protect myself against incidents," then the acceptance criteria would be: A complete and published doc describing AI anomalies."
      </td>
    </tr>
