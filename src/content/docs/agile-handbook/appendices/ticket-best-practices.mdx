  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * For example, if your user story is, "As a New Relic customer I want to know how to interpret anomalies in order to monitor my site and protect myself against alert events," then the acceptance criteria would be: "A complete and published doc describing anomalies."
      </td>
    </tr>
  </tbody>
</table>
