...
The hero is responsible for routing userfeedback to liasions. This sections covers the entire lifecycle of a user feedback ticket:
...
For non-US based writers:

- Non-US based writers should route incoming issues to liaison as they have time. As they are “eternal heroes” it isn’t fair to have them do this every day.
- Non-US based writers are still responsible for triaging issues routed to them due to their liasionships on a daily basis.
 </Callout>
