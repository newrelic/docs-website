...
2. Add a category label based on the URL, such as `doc_apm` or `doc_errors-inbox` (These labels are based off of the first part of the URL after `/docs/. For example, `[https://docs.newrelic.com/docs/errors-inbox\`](https://docs.newrelic.com/docs/errors-inbox`) would have the label `docs_errors-inbox`.).
3. Add a link to the PR.
4. Work the PR to its merge at your leisure.
5. Set the Jira ticket Workflow status to **Closed**
6. Set the Jira ticket Resolution to **Done**.
