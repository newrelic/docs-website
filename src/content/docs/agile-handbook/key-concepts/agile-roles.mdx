...
- We do not expect scrum masters to clear blockers (that's a manager's job), and scrum mastering is not a full-time job.
...
- Most team members will be assigned one or more [Liaisonships](/docs/agile-handbook/sprint-mechanics/liaisonships/) (project assignments). Liaisons are responsible for nominating stories for sprints from other teams.
...
- **In [sprint planning](/docs/agile-handbook/sprint-mechanics/meetings-and-ceremonies/#sprint_planning)**: The scrum master leads conversation, tracks discussion time, adds point values to stories, and organizes/ranks sprint candidates in real time. They do not present the stories, though—stories should be introduced by the person who nominated the story for the sprint.
