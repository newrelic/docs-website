...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                While many people might edit docs in an area, you're accountable as liaison or point person for the overall quality and structure of the content. That might mean volunteering for peer edit assignments, or tag-teaming with the hero to review an incoming pull request. 
            </td>
        </tr>
    </tbody>
</table>
