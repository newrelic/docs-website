...
Planning poker is a consensus-based estimating and planning technique. To start a planning poker session, the story reporter or [liaison](/docs/agile-handbook/sprint-mechanics/liaisonships/) presents a story to the team. Then, the team all votes (at the same time, to prevent groupthink) on how difficult they think the story is.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>Defer</td>
      <td>No strong opinion. Do not play this card on the first round of poker! Seeing wildly different estimates is a sign we do not have a shared understanding of the work. Playing an early Defer card can mask that uncertainty.</td>
    </tr>
  </tbody>
</table>
