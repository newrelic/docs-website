...
This step is for a peer editor to review docs before they go live. Follow the [Peer editor workflow](/docs/style-guide/writer-workflow/peer-editor-workflow/), then move the story into Peer Edit Done. 
