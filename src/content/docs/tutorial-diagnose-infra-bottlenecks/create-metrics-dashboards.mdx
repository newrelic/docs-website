...
import createDash from 'images/infrastructure_screenshot-full_metrics-explorer.webp'
...
<UserJourneyControls
    previousStep={{path: "/docs/tutorial-diagnose-infra-bottlenecks/investigate-spike-CPU", title: "Previous step", body: "Troubleshoot a spike in CPU"}}
/>