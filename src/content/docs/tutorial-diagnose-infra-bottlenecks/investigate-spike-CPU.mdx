...
<UserJourneyControls
    previousStep={{path: "/docs/tutorial-diagnose-infra-bottlenecks/diagnose-app-infra-data", title: "Previous step", body: "Diagnose app failure with host data"}}
    nextStep={{path: "/docs/tutorial-diagnose-infra-bottlenecks/create-metrics-dashboards", title: "Next step", body: "Make dashboards to tell a data-driven story"}}
/>