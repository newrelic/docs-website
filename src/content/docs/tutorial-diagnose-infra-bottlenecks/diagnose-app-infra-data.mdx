...
<UserJourneyControls
    previousStep={{path: "/docs/tutorial-diagnose-infra-bottlenecks/instrument-your-system/", title: "Previous step", body: "Install the infrastructure agent."}}
    nextStep={{path: "/docs/tutorial-diagnose-infra-bottlenecks/investigate-spike-CPU/", title: "Next Step", body: "Investigate an unexpected spike in CPU"}}
/>