...
Browser metrics for the <DoNotTranslate>**End user**</DoNotTranslate> [tier](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#tier) are available only if you have [installed the <InlinePopover type="browser" /> agent](/docs/browser/new-relic-browser/getting-started/browser-settings).

<table>
  <thead>
    <tr>
      <th width={200}>
        <DoNotTranslate>**Browser (End user tier)**</DoNotTranslate>
      </th>

      <th>
        <DoNotTranslate>**SLA metric name:value (and formula)**</DoNotTranslate>
      </th>
    </tr>
  </thead>
...
<table>
  <thead>
    <tr>
      <th width={200}>
        <DoNotTranslate>**App server**</DoNotTranslate>
      </th>
...
<table>
  <thead>
    <tr>
      <th width={200}>
        <DoNotTranslate>**SLA tips**</DoNotTranslate>
      </th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <DoNotTranslate>**Recommendation:**</DoNotTranslate> To avoid a string of zeroes, divide this number appropriately for your own purposes.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        * Transactions not in one of those categories, in case the page load did not complete for any reason
          ...
          This is why there are fewer (sometimes many fewer) page views in the <DoNotTranslate>**End User**</DoNotTranslate> (browser) data section than in the <DoNotTranslate>**App server**</DoNotTranslate> data section.
      </td>
    </tr>
  </tbody>
</table>
