...
Browser metrics for the **End user** [tier](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#tier) are available only if you have [installed the <InlinePopover type="browser" /> agent](/docs/browser/new-relic-browser/getting-started/browser-settings).
