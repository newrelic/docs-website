...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Select the [<DNT>**End user tier**</DNT>](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#tier) (if available) or <DNT>**Application server**</DNT> heading.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Select <DNT>**Export as CSV**</DNT> to create a report file with comma-separated values.
      </td>
    </tr>
  </tbody>
</table>
