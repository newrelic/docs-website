...
To manage your weekly performance report emails, go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities)**, click the [account dropdown](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#account-dropdown), and select **User preferences**. Note that you opt in/out separately for every New Relic account you have access to.
  </Collapser>
</CollapserGroup>
