...
To view the **Background jobs analysis** report for your app: Go to **[one.newrelic.com](https://one.newrelic.com) > APM & services > (select an app) > Reports > Performance > Non-web transactions** tab. The default report compares the last 24 hours with the previous 24-hour period, 7 days ago, and averages over the last 7 days.
...
1. Go to **[one.newrelic.com](https://one.newrelic.com) > APM & services > (select an app) > Reports > Capacity**.
...
To view the database analysis report for your app: Go to **[one.newrelic.com](https://one.newrelic.com) > APM & services > (select an app) > Reports > Performance > Databases** tab. The default report compares the last 24 hours with the previous 24-hour period, 7 days ago, and averages over the last 7 days.
...
1. Go to **[one.newrelic.com](https://one.newrelic.com) > APM & services > (select an app) > Reports > Scalability**.
...
To view the web transactions analysis report for your app: Go to **[one.newrelic.com](https://one.newrelic.com) > APM & services > (select an app) > Reports > Performance > Web transactions** tab.
