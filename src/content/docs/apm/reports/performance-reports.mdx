...
To view the **Background jobs analysis** report for your app: Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM & services > (select an app) > Reports > Performance > Non-web transactions** tab. The default report compares the last 24 hours with the previous 24-hour period, 7 days ago, and averages over the last 7 days.
...
1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM & services > (select an app) > Reports > Capacity**.
...
To view the database analysis report for your app: Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM & services > (select an app) > Reports > Performance > Databases** tab. The default report compares the last 24 hours with the previous 24-hour period, 7 days ago, and averages over the last 7 days.
...
Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM & services > (select an app) > Reports > Scalability**.
...
The charts feature two lines: the primary line connects the data points, while the secondary line, labeled as "smoothed," presents a smoothed version of the primary line. The secondary line helps visualize the application's performance without being concerned about unexpected fluctuations observed in the primary line.
...
The Scalability report has a [time picker](/docs/query-your-data/explore-query-data/dashboards/manage-your-dashboard/#dash-time-picker) which allows you to view data over different time periods. The minimum recommended time period is 30 minutes because when analyzing an application’s Scalability, lower time ranges don’t give a full picture. The time picker uses the default value of the last 30 minutes, ending now.
...
To view the web transactions analysis report for your app: Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM & services > (select an app) > Reports > Performance > Web transactions** tab.
