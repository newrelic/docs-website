...
On top of the standard APM SLA reports described in this document, New Relic has developed an advanced [Service Levels management](/docs/service-levels-management/intro-slm) feature, with improved functionality. Check out our beta now!
</Callout>
