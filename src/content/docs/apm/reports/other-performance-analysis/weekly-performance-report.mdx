...
1. From the New Relic UI's [account dropdown](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#account-dropdown), select **User preferences**.
2. From **Weekly summaries**, select **See a sample email**.
...
To stop receiving weekly performance reports:

1. From the New Relic UI's [account dropdown](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#account-dropdown), select **User preferences**.
2. From **Weekly Summaries**, clear the **Weekly report** checkbox.
3. From **Weekly Summaries**, select **Save email preferences**.

To resume receiving weekly reports, select the **Weekly report** checkbox.
