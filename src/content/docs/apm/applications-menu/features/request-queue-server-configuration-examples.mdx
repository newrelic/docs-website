...
Apache's <DoNotTranslate>**mod_headers**</DoNotTranslate> module includes a `%t` variable that is formatted correctly. To enable request queue reporting, add this code to your Apache config:
...
<table>
  <thead>
    <tr>
      <th width={200}>
        <DoNotTranslate>**Nginx configuration**</DoNotTranslate>
      </th>

      <th>
        <DoNotTranslate>**Values**</DoNotTranslate>
      </th>
    </tr>
  </thead>
