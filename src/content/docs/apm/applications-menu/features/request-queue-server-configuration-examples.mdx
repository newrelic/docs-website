...
Apache's <DNT>**mod_headers**</DNT> module includes a `%t` variable that is formatted correctly. To enable request queue reporting, add this code to your Apache config:
