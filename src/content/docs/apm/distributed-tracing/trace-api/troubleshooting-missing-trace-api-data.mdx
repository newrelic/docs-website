...
You have used the [Trace API](/docs/apm/distributed-tracing/trace-api/introduction-new-relic-trace-api) to report data but either do not see your data in New Relic or you have questions about it.
