...
* If rate-limiting issues occur, we generate an `NrIntegrationError`. You can [run a NRQL query of that event](https://one.newrelic.com/launcher/nr1-core.home?pane=eyJuZXJkbGV0SWQiOiJucjEtY29yZS5ob21lLXNjcmVlbiJ9&overlay=) to see if your trace data encountered an issue. If you want to correlate your `NrIntegrationErrors`, you can use the `requestId` provided by each Trace API request.
