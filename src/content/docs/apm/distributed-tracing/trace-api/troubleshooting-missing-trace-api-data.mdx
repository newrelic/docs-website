...
* If your spans have timestamps, be sure they meet the following guidelines:
  ...
  * `newrelic`-format timestamps must be in <DoNotTranslate>**milliseconds**</DoNotTranslate>. You can get the current time in milliseconds at [currentmillis.com](https://currentmillis.com).
  * `zipkin`-format timestamps must be in <DoNotTranslate>**microseconds**</DoNotTranslate>.
