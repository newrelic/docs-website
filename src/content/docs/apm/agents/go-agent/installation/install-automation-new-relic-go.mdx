---
title: 'Simplify installation with Go instrumentation tool'
tags:
  - Agents
  - Go agent
  - Installation
...
1. Clone the [Go instrumentation repository](https://github.com/newrelic/go-agent-assisted-instrumentation) to a directory on your system. For example:
        ```sh
