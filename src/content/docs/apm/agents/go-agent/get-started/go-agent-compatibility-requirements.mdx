...
If you do not have one already, [create a New Relic account](https://newrelic.com/signup). It's free, forever. Before you [install New Relic for Go](/docs/agents/go-agent/installation/install-new-relic-go), ensure your system meets these requirements. 
