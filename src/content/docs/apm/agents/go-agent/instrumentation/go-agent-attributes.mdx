...
<CollapserGroup>
  ...
  >
    ...
    For example, to turn off <InlinePopup type="apm" /> error collection: After the [config](https://github.com/newrelic/go-agent/blob/master/GUIDE.md#config-and-application), add:
