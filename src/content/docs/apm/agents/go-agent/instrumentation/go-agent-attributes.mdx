...
<CollapserGroup>
  ...
  >
    ...
    For example, to turn off <InlinePopover type="apm"/> error collection: After the [config](https://github.com/newrelic/go-agent/blob/master/GUIDE.md#config-and-application), add:
