...
Monitor your [New Relic for Go](/docs/agents/go-agent/get-started/new-relic-go) application or microservice by creating [transactions](/docs/apm/transactions/intro-transactions/transactions-new-relic-apm) associated with specific app server activities, such as HTTP responses or background tasks. You can then view your app's performance in the New Relic, including the [APM <DoNotTranslate>**Transactions**</DoNotTranslate> page](/docs/apm/applications-menu/monitoring/transactions-page).
