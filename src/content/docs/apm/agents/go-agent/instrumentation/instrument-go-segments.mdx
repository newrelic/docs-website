...
You can instrument Go application calls that add messages to queuing systems like RabbitMQ and Kafka. Message producer segments appear in the APM <DoNotTranslate>**Transactions breakdown**</DoNotTranslate> in New Relic.
