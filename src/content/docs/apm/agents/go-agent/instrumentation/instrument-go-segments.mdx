...
<CollapserGroup>
  ...
  >
    <DNT>**Recommendation:**</DNT> Use the `StartExternalSegment` helper, since New Relic uses it to trace activity between your applications using [Distributed tracing](/docs/agents/go-agent/features/distributed-tracing-go).
