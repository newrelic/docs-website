...
* [New agent installations (recommended):](#quick-start-apm) A fast way to get started if you haven't installed the Go agent yet
...
If you already have some services instrumented with this APM agent, and you want to include them in distributed tracing, you'll need to manually enable distributed tracing for each service. See [Instrument transactions and HTTP requests](#enable).
