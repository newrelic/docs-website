    ...
    * See the documentation here and at [the Go documentation site](https://pkg.go.dev/github.com/newrelic/go-agent/v3@v3.20.0/newrelic#ConfigOption) for more information about how to use each function.
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td>
              `ApplicationLogging.Forwarding.CustomAttributes.Enabled`
            </td>
          ...
          <tr>
            ...
            <td>
              ...
              `ConfigAppLogForwardingCustomAttributesEnabled`
      ...
      * `ConfigAppLogForwardingEnabled(false)` sets `ApplicationLogging.Forwarding.CustomAttributes.Enabled=false` but also sets `CustomAttributes=nil`.
...
<CollapserGroup>
  ...
  <Collapser
    id="application-logging-forwarding-custom-attributes-enabled"
    title="ApplicationLogging.Forwarding.CustomAttributes.Enabled"
  >
    <table>
      <tbody>
      <tr>
    ...
    Configure ApplicationLogging.Forwarding.CustomAttributes.Enabled by calling `ConfigAppLogForwardingCustomAttributesEnabled()`.

    ```go
    app, err := newrelic.NewApplication(
    newrelic.ConfigAppLogForwardingCustomAttributesEnabled(true),
    )
    ```
  </Collapser>
  ...
  >
    ...
    Configure CustomAttributes by calling `ConfigCustomAttributes()`.
