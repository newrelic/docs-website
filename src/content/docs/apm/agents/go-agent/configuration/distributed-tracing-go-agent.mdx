...
<CollapserGroup>
  ...
  >
    ...
    5. For details, click on an individual trace, or if ** Group similar traces** is on in the top menu, click on a trace group.
  ...
  >
    ...
    4. Select your entity (service) in the left pane.
    5. For details, click on an individual trace, or if ** Group similar traces** is on in the top menu, click on a trace group.
    6. If you don't see the traces you want, you can filter by the `trace.id`.
  </Collapser>
  <Collapser
  ...
  >
    You can bring your logs and application data together to make troubleshooting easier and faster. With [logs in context](/docs/logs/logs-context/configure-logs-context-apm-agents/), you can see log messages alongside traces in the New Relic UI.
