  ...
  <thead>
    <tr>
      <th style={{ width: "200px" }}>
        <DoNotTranslate>**Ending the transaction**</DoNotTranslate>
      </th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        If `getTransaction` is called in the handler, then you <DoNotTranslate>**must**</DoNotTranslate> end the transaction by calling `transaction.end()`.
      </td>
    </tr>
