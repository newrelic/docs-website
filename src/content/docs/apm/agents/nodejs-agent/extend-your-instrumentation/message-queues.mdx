...
The APM UI will show transactions initiated via RabbitMQ message receipt (subscribe/consume messages) as <DoNotTranslate>**Message**</DoNotTranslate> background tasks. Message creation via RabbitMQ also appears in transaction traces.
