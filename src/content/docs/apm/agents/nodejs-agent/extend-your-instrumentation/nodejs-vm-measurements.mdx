...
1. Ensure a supported version of Node.js is installed. <DoNotTranslate>**Recommendation:**</DoNotTranslate> Use the latest LTS version. Do not use versions lower than the minimum supported version for the `@newrelic/native-metrics` module (v4 or higher).
2. To get all currently available metrics, ensure you are running the `newrelic` module for agent 1.37.0 or higher.
3. <DoNotTranslate>**Windows users:**</DoNotTranslate> Run the following command:
...
To view curated charts with Node.js VM data, go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & services > (select an app) > Node VMs**</DoNotTranslate>. For more information, see the [Node.js VMs statistics page](/docs/agents/nodejs-agent/supported-features/node-vms-statistics-page).
        ...
        <thead>
          <tr>
            <th style={{ width: "250px" }}>
              <DoNotTranslate>**GC type**</DoNotTranslate>
            </th>
