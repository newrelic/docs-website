...
1. Ensure a supported version of Node.js is installed. <DNT>**Recommendation:**</DNT> Use the latest LTS version. Do not use versions lower than the minimum supported version for the `@newrelic/native-metrics` module (v4 or higher).
