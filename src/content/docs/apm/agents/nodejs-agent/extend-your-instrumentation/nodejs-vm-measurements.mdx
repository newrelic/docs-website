...
To view curated charts with Node.js VM data, go to **[one.newrelic.com](https://one.newrelic.com) > APM > (select an app) > Node VMs**. For more information, see the [Node.js VMs statistics page](/docs/agents/nodejs-agent/supported-features/node-vms-statistics-page).

The data is also available in the [data explorer](/docs/query-your-data/explore-query-data/data-explorer/introduction-data-explorer): To access the data explorer, go to **[one.newrelic.com](https://one.newrelic.com)** and at the top of the page, click the **Query your data** icon.
