...
1. At the beginning of your html page's `head` tag, insert the results of `newrelic.getBrowserTimingHeader()` after any `CHARSET` meta tags.
   ...
   <DoNotTranslate>**Exception:**</DoNotTranslate> For maximum Internet Explorer compatibility, insert the results of `newrelic.getBrowserTimingHeader()` <DoNotTranslate>**after**</DoNotTranslate> any `X-UA-COMPATIBLE HTTP-EQUIV` meta tags.
...
<CollapserGroup>
  ...
  >
    ...
    Using <DoNotTranslate>**hapi**</DoNotTranslate>, in your `app.js`:
