...
<CollapserGroup>
  ...
  >
    ...
    * Browser events: Disabled
      ...
      <DoNotTranslate>**Note:**</DoNotTranslate> The `httpResponseCode` attribute (string value) is removed as of agent version 7.0.0. `http.statusCode` (integer value) should be used instead.
  </Collapser>
  ...
  >
    ...
    * Browser events: Disabled
      ...
      <DoNotTranslate>**Note:**</DoNotTranslate> The `httpResponseMessage` attribute (string value) is removed as of agent version 7.0.0. `http.statusText` (string value) should be used instead.
  </Collapser>
