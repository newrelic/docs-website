...
<CollapserGroup>
  ...
  >
    ...
    <Callout variant="important">
      The `expected` parameter requires a minimum of [Node.js agent v9.12.1](/docs/release-notes/agent-release-notes/nodejs-release-notes/node-agent-9-12-1/).
    </Callout>
  ...
  >
    ...
    <Callout variant="important">
      The `setErrorGroupCallback` API requires a minimum of [Node.js agent v9.14.0](/docs/release-notes/agent-release-notes/nodejs-release-notes/node-agent-9-14-0/).
    </Callout>
  ...
  >
    ...
    <Callout variant="important">
      The `setUserID` API requires a minimum of [Node.js agent v9.13.0](/docs/release-notes/agent-release-notes/nodejs-release-notes/node-agent-9-13-0/).
    </Callout>
