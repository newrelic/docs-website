...
4. If you are using environment variables instead of your `newrelic.js` config file settings to [customize your Node.js agent configuration](#variables), use this toolbelt command:
   ...
   ```
5. Verify your New Relic app name, [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key), and [log setting](/docs/agents/nodejs-agent/installation-configuration/nodejs-agent-configuration#logging_config):
