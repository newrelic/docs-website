...
With New Relic's [Node.js agent](/docs/agents/nodejs-agent/getting-started/introduction-new-relic-nodejs), you can monitor applications that reside in the [Google App Engine (GAE) flexible environment](https://cloud.google.com/appengine/docs/flexible/nodejs/). Adding New Relic to your GAE flex app gives you insight into the health and performance of your app and extends GAE with metrics you can view in [<InlinePopover type="apm"/>](/docs/apm/new-relic-apm/getting-started/introduction-new-relic-apm) and [<InlinePopover type="browser"/>](/docs/browser/new-relic-browser/getting-started/introduction-new-relic-browser).
...
1. Follow standard procedures to [install New Relic's Node.js agent](/docs/agents/nodejs-agent/installation-configuration/install-nodejs-agent), including your <InlinePopover type="licenseKey"/>. Be sure to save the `newrelic` module to the `package.json` file.
...
Google App Engine automatically includes your Node.js app's `newrelic.js` configuration file in the deployed package. Wait until the deployment completes, then view your GAE flex app data in the [APM <DNT>**Summary**</DNT> page](/docs/apm/applications-menu/monitoring/apm-overview-page).
...
<CollapserGroup>
  ...
  >
    ...
    3. To view your GAE flex app data in New Relic, go to the [APM <DNT>**Summary**</DNT> page](/docs/apm/applications-menu/monitoring/apm-overview-page).
  </Collapser>
</CollapserGroup>
