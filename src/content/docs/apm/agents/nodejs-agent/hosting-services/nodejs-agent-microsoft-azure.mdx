...
<Callout variant="important">
  The Node.js agent can not instrument Lambda functions, for that you will need to use the [Azure Functions monitoring integration](docs/infrastructure/microsoft-azure-integrations/azure-integrations-list/azure-functions-monitoring-integration/)
</Callout>
