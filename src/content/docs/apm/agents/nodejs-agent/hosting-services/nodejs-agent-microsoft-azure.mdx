...
tags:
  ...
  - Nodejs agent
  - Hosting services
metaDescription: How to install New Relic APM for Node.js on Microsoft Azure Web Apps.
redirects:
...
* [Node.js agent configuration](/docs/nodejs/customizing-your-nodejs-config-file) (changing the default values in your agent configuration file)
