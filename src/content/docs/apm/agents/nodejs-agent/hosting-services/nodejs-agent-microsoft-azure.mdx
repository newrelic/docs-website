...
1. Sign in to <DoNotTranslate>**[portal.azure.com](https://portal.azure.com)**</DoNotTranslate>.
2. Select <DoNotTranslate>**App Services > (select a Node.js app) > Configure**</DoNotTranslate>.
3. Add the following to the <DoNotTranslate>**app settings**</DoNotTranslate>:
...
Generate some traffic to your app and wait a few minutes. After waiting, see your data by going to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & services > (select your app)**</DoNotTranslate>.
