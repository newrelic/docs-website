...
Generate some traffic to your app and wait a few minutes. After waiting, see your data by going to **[one.newrelic.com](https://one.newrelic.com) > APM > (select your app)**.
