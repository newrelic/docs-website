...
3. Add the following to the **app settings**:
   ...
   * `new_relic_license_key`: Your New Relic <LicenseKey/>
4. Save your settings.
5. Restart your Node.js app.

Generate some traffic to your app and wait a few minutes. After waiting, see your data by going to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM & services > (select your app)**.
