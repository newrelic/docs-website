...
<table>
  <thead>
    <tr>
      <th width={100}>
        <DoNotTranslate>**Error code**</DoNotTranslate>
      </th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The transaction is unnamed. If you are not using Express or Restify and you did not explicitly name the transaction, this error appears. This is to avoid rolling the transaction name into <DoNotTranslate>**/\**</DoNotTranslate>*. For more information, see [naming your transactions](/docs/nodejs/nodejs-agent-api).
      </td>
    </tr>
