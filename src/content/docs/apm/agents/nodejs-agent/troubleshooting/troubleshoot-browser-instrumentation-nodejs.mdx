    ...
    <tr>
      ...
      <td>
        ...
        * Some other problem occurred that would prevent the application ID from being available.
          ...
          If these errors persist longer than 1 minute, check your [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key). Otherwise, the errors should disappear on their own.
      </td>
    </tr>
