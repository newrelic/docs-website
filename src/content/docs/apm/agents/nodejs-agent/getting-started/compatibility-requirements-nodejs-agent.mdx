 ...
 * [Winston](https://github.com/winstonjs/winston) 3.0.0 or higher (requires agent version 8.16.0) 
 * [Pino](https://github.com/pinojs/pino) 7.0.0 or higher (requires agent version 8.16.0)
 * [Bunyan](https://www.npmjs.com/package/bunyan) 1.8.12 or higher (requires agent version 9.3.0)
</Collapser>
