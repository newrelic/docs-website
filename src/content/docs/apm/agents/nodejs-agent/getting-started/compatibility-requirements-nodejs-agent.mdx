...
| `@aws-sdk/client-bedrock-runtime` | 3.474.0 | 3.986.0 | 11.13.0 |
| `@aws-sdk/client-dynamodb` | 3.0.0 | 3.986.0 | 8.7.1 |
| `@aws-sdk/client-sns` | 3.0.0 | 3.986.0 | 8.7.1 |
| `@aws-sdk/client-sqs` | 3.0.0 | 3.986.0 | 8.7.1 |
| `@aws-sdk/lib-dynamodb` | 3.377.0 | 3.986.0 | 8.7.1 |
...
| `@langchain/core` | 0.2.0 | 1.1.20 | 11.13.0 |
| `@langchain/langgraph` | 1.0.0 | 1.1.4 | 13.12.0 |
| `@langchain/openai` | 1.0.0 | 1.2.6 | 11.13.0 |
