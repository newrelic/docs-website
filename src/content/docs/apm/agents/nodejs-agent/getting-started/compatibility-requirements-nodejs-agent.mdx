...
| --- | --- | --- | --- |
| `@anthropic-ai/sdk` | 0.33.0 | 0.128.0 | 13.19.0 |
| `@apollo/gateway` | 2.3.0 | 2.14.4 | 14.0.0 |
| `@apollo/server` | 4.0.0 | 5.5.1 | 14.0.0 |
| `@aws-sdk/client-bedrock-runtime` | 3.377.0 | 3.1139.0 | 11.13.0 |
| `@aws-sdk/client-dynamodb` | 3.377.0 | 3.1139.0 | 8.7.1 |
| `@aws-sdk/client-sns` | 3.377.0 | 3.1139.0 | 8.7.1 |
| `@aws-sdk/client-sqs` | 3.377.0 | 3.1139.0 | 8.7.1 |
| `@aws-sdk/lib-dynamodb` | 3.377.0 | 3.1139.0 | 8.7.1 |
| `@aws-sdk/smithy-client` | 3.47.0 | 3.374.0 | 8.7.1 |
| `@azure/functions` | 4.7.0 | 4.16.5 | 12.18.0 |
| `@elastic/elasticsearch` | 7.16.0 | 9.5.1 | 11.9.0 |
| `@google/adk` | 1.1.0 | 2.1.0 | 13.20.0 |
| `@google/genai` | 1.1.0 | 2.24.0 | 12.21.0 |
...
| `@langchain/core` | 0.2.0 | 1.2.12 | 11.13.0 |
| `@langchain/langgraph` | 1.0.0 | 1.4.17 | 13.12.0 |
| `@langchain/openai` | 0.2.0 | 1.5.13 | 11.13.0 |
| `@modelcontextprotocol/sdk` | 1.13.0 | 1.30.1 | 13.2.0 |
| `@nestjs/core` | 10.0.0 | 12.1.0 | 10.1.0 |
| `@opensearch-project/opensearch` | 2.1.0 | 3.9.0 | 12.10.0 |
...
| `cassandra-driver` | 4.0.0 | 4.10.0 | 1.7.1 |
...
| `next` | 14.0.0 | 16.3.6 | 12.0.0 |
| `openai` | 4.0.0 | 7.23.0 | 11.13.0 |
...
| `superagent` | 3.0.0 | 10.4.1 | 4.9.0 |
| `undici` | 5.0.0 | 8.11.2 | 11.1.0 |
...
[hybrid agent](/docs/apm/agents/manage-apm-agents/opentelemetry-api-support)
feature.

### Next.js v16+

Starting with agent
[version 14.1.0](/docs/release-notes/agent-release-notes/nodejs-release-notes/node-agent-14-1-0),
