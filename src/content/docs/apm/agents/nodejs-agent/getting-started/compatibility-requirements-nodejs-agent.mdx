 ...
 * [Winston](https://github.com/winstonjs/winston) 3.0.0 or higher (requires agent version 8.11.0) 
 * [Pino](https://github.com/pinojs/pino) 7.0.0 or higher (requires agent version 8.11.0)
