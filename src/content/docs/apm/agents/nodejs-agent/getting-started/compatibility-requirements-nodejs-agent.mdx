...
| --- | --- | --- | --- |
| `@anthropic-ai/sdk` | 0.33.0 | 0.87.0 | 13.18.0 |
...
| `@aws-sdk/client-bedrock-runtime` | 3.474.0 | 3.1028.0 | 11.13.0 |
| `@aws-sdk/client-dynamodb` | 3.0.0 | 3.1028.0 | 8.7.1 |
| `@aws-sdk/client-sns` | 3.0.0 | 3.1028.0 | 8.7.1 |
| `@aws-sdk/client-sqs` | 3.0.0 | 3.1028.0 | 8.7.1 |
| `@aws-sdk/lib-dynamodb` | 3.377.0 | 3.1028.0 | 8.7.1 |
...
| `@langchain/openai` | 0.2.0 | 1.4.3 | 11.13.0 |
