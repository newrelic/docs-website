...
[ES Modules](https://nodejs.org/api/esm.html#introduction) are the official standard for packaging JavaScript code for sharing/reuse. The Node.js agent has **experimental** support for ES Module applications running Node.js version 16.12.0 or higher and agent version 9.1.0 or higher. Please see our [ES Module documentation](/docs/apm/agents/nodejs-agent/getting-started/es-modules) for additional information and instructions.
</Collapser>
