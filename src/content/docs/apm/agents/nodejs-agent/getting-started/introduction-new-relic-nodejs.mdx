...
* [Troubleshooting your Node.js installation](/docs/agents/nodejs-agent/troubleshooting/troubleshooting-your-nodejs-installation): Try these steps if you do not see any data, cannot log files, or encounter other installation problems with the Node.js agent.
