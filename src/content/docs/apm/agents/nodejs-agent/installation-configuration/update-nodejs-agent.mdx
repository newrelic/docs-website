  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * <DoNotTranslate>**Troubleshooting tips:**</DoNotTranslate> These new methods are **not** drop-in replacements for the old ones. Before moving to these new methods, review our [custom instrumentation guide](/docs/agents/nodejs-agent/supported-features/nodejs-custom-instrumentation#web-txn).
      </td>
    </tr>
