...
5. To run your Docker app with the agent enabled, add your [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) and [app name](/docs/agents/manage-apm-agents/app-naming/name-your-application) to your `docker run` command as environment variables:
