...
<Callout variant="important">
You need to set [distributed_tracing](/docs/apm/agents/nodejs-agent/installation-configuration/nodejs-agent-configuration/#dt-main) to `true` to capture trace and feedback data. It's turned on by default in Node.js agents 8.3.0 and higher. 
</Callout>
