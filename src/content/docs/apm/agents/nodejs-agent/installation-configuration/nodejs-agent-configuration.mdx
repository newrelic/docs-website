...
For more details, see our documentation for the [New Relic CodeStream integration](/docs/apm/agents/nodejs-agent/installation-configuration/codestream-integration).
...
For a configuration example, see our documentation for the [url obfuscation](/docs/url-obfuscation/configure-url-obfuscation-nodejs).
...
<CollapserGroup>
  ...
  >
    ...
    Enables regex based [url obfuscation](https://docs.newrelic.com/docs/url-obfuscation/configure-url-obfuscation-nodejs/).
  </Collapser>
