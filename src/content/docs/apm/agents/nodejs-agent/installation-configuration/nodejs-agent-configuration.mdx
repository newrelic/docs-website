...
<CollapserGroup>
  ...
  >
    ...
    This setting is required. Your New Relic [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key). For example, `license_key: '40HexadecimalCharacters'`.
  </Collapser>
