...
<CollapserGroup>
  ...
  >
    Path to the directory containing `newrelic.js`. This is available only as an environment variable. You can't set it in your config file.
  ...
  >
    ...
    This is available only as an environment variable. You can't set it in your config file.
