...
<CollapserGroup>
  ...
  >
    ...
    Specify the number of traces to sample within a minute. The value must be a number between 1-120.
    This value configures the global adaptive sampler, if a more specific adaptive sampler target is specified,
    it will take precedence.

    For example, to assign a specific shared sampling target, you would use:
  ...
  <Collapser
    id="dt-full-granularity-enabled"
    title="sampler.full_granularity.enabled"
  >
    <table>
      <tbody>
        <tr>
    ...
    Set this to `false` to disable capturing full granularity traces.

    For example, to disable this in the config file, you would use:
  ...
  >
    ...
    When a trace originates from the current service and a distributed tracing header is not present for the entry call.

      * `adaptive`: default behavior and delegates the sampling decision to the adaptive sampling algorithm to determine whether a trace will be sampled
      * `always_on`: always samples traces that have originated from application
      * `always_off`: never sampled traces that have originated from application
  ...
  <Collapser
    id="dt-sampler-root-adaptive-sampling-target"
    title="sampler.root.adaptive.sampling_target"
  >
    <table>
      <tbody>
        <tr>
    ...
    Specify the number of traces to sample within a minute. The value must be a number between 1-120.
    If not specified, it will use the shared adaptive sampler and the sampling target from `distributed_tracing.sampler.adaptive_sampling_target`.

    For example, to assign a specific sampling target for root, you would use:
  ...
  <Collapser
    id="dt-sampler-root-trace-id-ratio"
    title="sampler.root.trace_id_ratio_based.ratio"
  >
    <table>
      <tbody>
        <tr>
    ...
    Specify the percentage of traces to sample based on the trace id. Value must be a float between 0 (exclusive) and 1 (inclusive).

    For example, to assign 40% sampling ratio, you would use:
  ...
  >
    ...
    When the traceparent header has a sampled flag of `01`, this controls how to handle sampling of spans. The allowable values are:
      ...
      * `always_off`: never sampled traces that have a sampled remote parent
      * `trace_id_ratio_based`: delegates the sampling decision to the Trace ID Ratio Based sampling algorithm to determine whether a trace will be sampled
  ...
  <Collapser
    id="dt-sampler-remote-parent-sampled-adaptive-sampling-target"
    title="sampler.remote_parent_sampled.adaptive.sampling_target"
  >
    <table>
      <tbody>
        <tr>
    ...
    For example, to assign a specific sampling target for remote parent sampled, you would use:
  ...
  <Collapser
    id="dt-sampler-remote-parent-sampled-trace-id-ratio"
    title="sampler.remote_parent_sampled.trace_id_ratio_based.ratio"
  >
    <table>
      <tbody>
        <tr>
  ...
  >
    ...
    When the traceparent header is has a sampled flag of `00`, this controls how to handle sampling of spans. The allowable values are:
      ...
      * `always_off`: never sampled traces that have an unsampled remote parent
      * `trace_id_ratio_based`: delegates the sampling decision to the Trace ID Ratio Based sampling algorithm to determine whether a trace will be sampled
  ...
  <Collapser
    id="dt-sampler-remote-parent-not-sampled-adaptive-sampling-target"
    title="sampler.remote_parent_not_sampled.adaptive.sampling_target"
  >
    <table>
      <tbody>
        <tr>
    ...
    For example, to assign a specific sampling target for remote parent not sampled, you would use:
  ...
  <Collapser
    id="dt-sampler-remote-parent-not-sampled-trace-id-ratio"
    title="sampler.remote_parent_not_sampled.trace_id_ratio_based.ratio"
  >
    <table>
      <tbody>
        <tr>
  ...
  <Collapser
    id="dt-partial-granularity-enabled"
    title="sampler.partial_granularity.enabled"
  >
    <table>
      <tbody>
        <tr>
    ...
    Set this to `true` to enable capturing partial granularity traces.
  ...
  <Collapser
    id="dt-partial-granularity-type"
    title="sampler.partial_granularity.type"
  >
    <table>
      <tbody>
        <tr>
    ...
    Set this to `essential` to capture a subset of spans and attributes.
  ...
  <Collapser
    id="dt-sampler-pg-root"
    title="sampler.partial_granularity.root"
  >
    <table>
      <tbody>
        <tr>
  ...
  <Collapser
    id="dt-sampler-pg-root-adaptive-sampling-target"
    title="sampler.partial_granularity.root.adaptive.sampling_target"
  >
    <table>
      <tbody>
        <tr>
  ...
  <Collapser
    id="dt-sampler-pg-root-trace-id-ratio"
    title="sampler.partial_granularity.root.trace_id_ratio_based.ratio"
  >
    <table>
      <tbody>
        <tr>
  ...
  <Collapser
    id="dt-sampler-pg-remote-parent-sampled"
    title="sampler.partial_granularity.remote_parent_sampled"
  >
    <table>
      <tbody>
        <tr>
  ...
  <Collapser
    id="dt-sampler-pg-remote-parent-sampled-adaptive-sampling-target"
    title="sampler.partial_granularity.remote_parent_sampled.adaptive.sampling_target"
  >
    <table>
      <tbody>
        <tr>
  ...
  <Collapser
    id="dt-sampler-pg-remote-parent-sampled-trace-id-ratio"
    title="sampler.partial_granularity.remote_parent_sampled.trace_id_ratio_based.ratio"
  >
    <table>
      <tbody>
        <tr>
  ...
  <Collapser
    id="dt-sampler-pg-remote-parent-not-sampled"
    title="sampler.partial_granularity.remote_parent_not_sampled"
  >
    <table>
      <tbody>
        <tr>
  ...
  <Collapser
    id="dt-sampler-pg-remote-parent-not-sampled-adaptive-sampling-target"
    title="sampler.partial_granularity.remote_parent_not_sampled.adaptive.sampling_target"
  >
    <table>
      <tbody>
        <tr>
  ...
  <Collapser
    id="dt-sampler-pg-remote-parent-not-sampled-trace-id-ratio"
    title="sampler.partial_granularity.remote_parent_not_sampled.trace_id_ratio_based.ratio"
  >
    <table>
      <tbody>
        <tr>
