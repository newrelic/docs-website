---
title: 'Distributed tracing for the Node.js agent'
tags:
...
* [New agent installations (recommended):](#quick-start-apm) A fast way to get started
...
## New agent installations (recommended): [#quick-start-apm]

When you install a current New Relic agent, [standard distributed tracing](/docs/distributed-tracing/concepts/how-new-relic-distributed-tracing-works/#head-based) is enabled by default. So, if you haven't installed any APM agents for your services yet, or you want to instrument additional services with this agent, follow the steps in this section.
