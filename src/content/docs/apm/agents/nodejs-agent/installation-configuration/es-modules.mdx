...
In order for the agent to properly apply instrumentation within the ES module ecosystem, you must include the agent's ES module loader along with the agent in your application's invocation.
