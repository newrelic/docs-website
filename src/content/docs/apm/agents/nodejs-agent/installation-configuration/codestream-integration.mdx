...
<Callout variant="important">
  Code-level metrics are available in [Node.js agent version 9.7.5 and higher](/docs/release-notes/agent-release-notes/net-release-notes) and are disabled by default. To change this configuration, check out our [documentation](/docs/apm/agents/nodejs-agent/installation-configuration/nodejs-agent-configuration#code-level-metrics).
</Callout>
