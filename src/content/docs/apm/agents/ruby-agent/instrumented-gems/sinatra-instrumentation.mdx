...
2. In your Sinatra app, immediately below the Sinatra <DoNotTranslate>**require**</DoNotTranslate> directive, add:

    ```
    require 'newrelic_rpm'
    ```
3. Set `RACK_ENV` to the environment corresponding to the configuration definitions in your <DoNotTranslate>**newrelic.yml**</DoNotTranslate> file; for example, development, staging, production, etc.

<DoNotTranslate>**Note:**</DoNotTranslate> Developer mode only works with Rails.
