...
The [New Relic Ruby agent](/docs/agents/ruby-agent/getting-started/new-relic-ruby) automatically instruments [gRPC](https://grpc.io/) clients and servers that use the [grpc](https://rubygems.org/gems/grpc) gem (version 1.0.0 or higher). All communication types - unary, bidirectional, client-streaming, and server-streaming - are supported.
