...
<CollapserGroup>
  ...
  >
    If your background app is non-Rails application already running the Ruby agent, copy your **newrelic.yml** file to the directory where you launch the background job or in the **config** subdirectory. Make sure it includes your [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key).
