...
If you are using a Ruby agent version <DoNotTranslate>**prior to 3.8.0**</DoNotTranslate> with Unicorn, you will need to do one of the following in order to get data reporting:
