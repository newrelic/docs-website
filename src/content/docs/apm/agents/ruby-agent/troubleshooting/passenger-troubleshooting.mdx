...
<CollapserGroup>
  ...
  >
    For Passenger, the log file is `newrelic_agent.passenger.log`. <DoNotTranslate>**Recommendation:**</DoNotTranslate> For Apache users, provide write permissions for the entire /log directory.
  </Collapser>
