...
We occasionally remove deprecated APIs. If you use any of the following methods, you must update your API call(s) with the recommended replacement(s) before upgrading to certain Ruby agent versions.
