...
We occasionally remove deprecated APIs. If you use any of the following methods, you must update your API with the recommended replacement before upgrading to certain Ruby agent versions.
