...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The New Relic <InlinePopover type="licenseKey" /> to use. By default this comes from the definition in the `newrelic.yml` file for the given `rails_env`. This is <DoNotTranslate>**not**</DoNotTranslate> the same as your [REST API key](/docs/apis/getting-started/intro-apis/access-rest-api-keys).
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        The revision recorded for the deployment. <DoNotTranslate>**Recommendation:**</DoNotTranslate> If you are using Subversion, consider including the tag or branch name in addition to the revision.
      </td>
    </tr>
