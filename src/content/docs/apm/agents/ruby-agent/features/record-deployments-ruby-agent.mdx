...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The revision recorded for the deployment. <DNT>**Recommendation:**</DNT> If you are using Subversion, consider including the tag or branch name in addition to the revision.
      </td>
    </tr>
