...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The New Relic [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) to use. By default this comes from the definition in the `newrelic.yml` file for the given `rails_env`. This is **not** the same as your [REST API key](/docs/apis/getting-started/intro-apis/access-rest-api-keys).
      </td>
    </tr>
