...
<CollapserGroup>
  ...
  >
    ...
    **JRuby note**: Due to what appears to be [a bug](https://github.com/jruby/jruby/issues/1620 "Link opens in a new window") in either JRuby or certain versions of the JVM, GC timings may be off by a factor of 1000 on JRuby. For this reason, we do not currently recommend enabling `GC::Profiler` on JRuby.
  </Collapser>
