...
While a **newrelic.yml** file will be created as part of the installation, it is not necessary to have a valid [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key).
