...
<CollapserGroup>
  ...
  >
    ...
    * Page views (<InlinePopover type="browser" />): Unavailable
      ...
      <DoNotTranslate>**Note:**</DoNotTranslate> The `httpResponseCode` attribute (string value) is deprecated as of agent version 6.12.0. `http.statusCode` (integer value) should be used instead.
  </Collapser>
  ...
  >
    ...
    * Page views (browser monitoring): Unavailable
      ...
      <DoNotTranslate>**Note:**</DoNotTranslate> The `resque.capture_params` property is deprecated. However, if set to `true`, it will enable capture of Resque arguments for transaction traces, traced errors.
  </Collapser>
  ...
  >
    ...
    * Page views (browser monitoring): Unavailable
      ...
      <DoNotTranslate>**Note:**</DoNotTranslate> The `sidekiq.capture_params` property is deprecated. However, if set to `true`, it will enable capture of Sidekiq arguments for transaction traces and traced errors.
  </Collapser>
</CollapserGroup>
...
When upgrading to Ruby agent <DoNotTranslate>**3.12.0**</DoNotTranslate> or higher, upgrade your <DoNotTranslate>**newrelic.yml**</DoNotTranslate> configuration.
