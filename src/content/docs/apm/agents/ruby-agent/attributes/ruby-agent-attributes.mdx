...
* [Attribute examples](/docs/agents/ruby-agent/attributes/ruby-attribute-examples) (scenarios and results of enabling and disabling different Ruby agent attributes)
