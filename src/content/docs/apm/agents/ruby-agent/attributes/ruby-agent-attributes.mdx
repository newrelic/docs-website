...
<CollapserGroup>
  ...
  >
    ...
    * Page views (<InlinePopover type="browser"/>): Unavailable
      ...
      <DNT>**Note:**</DNT> The `httpResponseCode` attribute (string value) is deprecated as of agent version 6.12.0. `http.statusCode` (integer value) should be used instead.
  </Collapser>
  ...
  >
    ...
    * Page views (browser monitoring): Unavailable
      ...
      <DNT>**Note:**</DNT> The `resque.capture_params` property is deprecated. However, if set to `true`, it will enable capture of Resque arguments for transaction traces, traced errors.
  </Collapser>
  ...
  >
    ...
    * Page views (browser monitoring): Unavailable
      ...
      <DNT>**Note:**</DNT> The `sidekiq.capture_params` property is deprecated. However, if set to `true`, it will enable capture of Sidekiq arguments for transaction traces and traced errors.
  </Collapser>
</CollapserGroup>
...
When upgrading to Ruby agent <DNT>**3.12.0**</DNT> or higher, upgrade your <DNT>**newrelic.yml**</DNT> configuration.
