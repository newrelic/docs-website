...
<CollapserGroup>
  ...
  >
    ...
    <DoNotTranslate>**Note:**</DoNotTranslate> All user attributes default to `true`. However, by default, request parameters are disabled for all destinations.
...
<table>
  <thead>
    <tr>
      ...
      <th>
        <DoNotTranslate>**Removed Version**</DoNotTranslate>
      </th>
    </tr>
  </thead>
