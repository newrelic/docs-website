...
<CollapserGroup>
  ...
  If `true`, the agent will report source code level metrics for traced methods. Please see: https://docs.newrelic.com/docs/apm/agents/ruby-agent/features/ruby-codestream-integration/.
  </Collapser>
