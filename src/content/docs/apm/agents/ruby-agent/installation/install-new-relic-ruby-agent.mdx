...
<Callout variant="important">
  If you are using the agent in a Docker container, install the agent <DoNotTranslate>**within each**</DoNotTranslate> container.
</Callout>
   ...
   <table>
     <thead>
       <tr>
         <th style={{ width: "200px" }}>
           <DoNotTranslate>**Ruby installation**</DoNotTranslate>
         </th>
     ...
     <tbody>
       <tr>
         ...
         <td>
           * <DoNotTranslate>**Rails**</DoNotTranslate>: Rails will automatically call `Bundler.require` and cause `newrelic_rpm` to be required during startup of your application.
           * <DoNotTranslate>**Roda, Sinatra**</DoNotTranslate>: If you're using Roda, Sinatra or another framework, you must manually call `require 'newrelic_rpm'`. Additionally, if you're using Infinite Tracing, manually call `require 'newrelic/infinite_tracing'`.
