...
1. In New Relic, from the [user menu](/docs/accounts/accounts-billing/general-account-settings/intro-account-settings), select <DNT>**Account settings > Connected agents**</DNT>.
2. Optional: Sort by <DNT>**Oldest agent version**</DNT>.
