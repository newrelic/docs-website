...
1. In New Relic, from the [user menu](/docs/accounts/accounts-billing/general-account-settings/intro-account-settings), select <DoNotTranslate>**Account settings > Connected agents**</DoNotTranslate>.
2. Optional: Sort by <DoNotTranslate>**Oldest agent version**</DoNotTranslate>.
