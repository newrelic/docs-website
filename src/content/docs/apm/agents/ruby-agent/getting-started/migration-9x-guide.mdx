...
## Removed Deprecated Configuration [#removed_config]
  ...
  The following configuration options have been removed and will no longer work. Please update all configs to use the replacements listed below.
...
## Removed Support for Ruby 2.2 and 2.3 [#ruby_2223]
  ...
  Ruby 2.2 and 2.3 are no longer supported by the ruby agent. Ruby 2.4.0 is now the minumum supported ruby version.
...
## Removed Deprecated Instrumentation [#removed_gem_instrumentation]
  ...
  Support for the following gems has been dropped
    - Acts As Solr
    - Authlogic
    - DataMapper
    - Rainbows
