...
See the [milestone for 7.0 target release](https://github.com/newrelic/newrelic-ruby-agent/pulls?q=is%3Apr+is%3Aopen+label%3Aversion%3A7.0.0) for more information.
