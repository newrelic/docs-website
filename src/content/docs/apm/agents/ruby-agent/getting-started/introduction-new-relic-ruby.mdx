...
* Install [New Relic infrastructure monitoring](/docs/infrastructure) and view detailed host data for your app.
...
* [Page load timing](/docs/agents/ruby-agent/features/page-load-timing-ruby): [Automatically inject the <InlinePopover type="browser"/> agent](/docs/browser/new-relic-browser/getting-started/new-relic-browser) to get visibility into end-user activity.
