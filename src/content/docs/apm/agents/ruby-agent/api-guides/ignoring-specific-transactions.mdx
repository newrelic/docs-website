...
New Relic for <DoNotTranslate>Ruby</DoNotTranslate>> allows you to selectively disable instrumentation for particular requests within your Rails, Roda, or Sinatra application.
...
To ignore all actions on the controller <DoNotTranslate>**except**</DoNotTranslate> `index`:
