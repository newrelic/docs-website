...
These extensions are <DoNotTranslate>**not**</DoNotTranslate> supported by New Relic. New Relic gathers these links as a service to our customers. Issues with those gems should be reported to the respective projects on GitHub.
...
<CollapserGroup>
  ...
  >
    This helper method records statements for slow datastore calls to transaction traces. These are <DoNotTranslate>**not**</DoNotTranslate> obfuscated.
