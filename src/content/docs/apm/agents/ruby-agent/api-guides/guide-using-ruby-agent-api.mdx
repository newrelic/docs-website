...
The New Relic <DNT>Ruby</DNT> agent provides a public API with documentation available on RubyGems. The RubyGems documentation tells you how to set up custom instrumentation of your <DNT>Ruby</DNT> app and collect more in-depth data:
