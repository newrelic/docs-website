...
To send error data that you are handling in your own code to New Relic, use the <DoNotTranslate>Ruby</DoNotTranslate>> agent API [`NewRelic::Agent.notice_error`](https://www.rubydoc.info/github/newrelic/newrelic-ruby-agent/NewRelic/Agent#notice_error-instance_method) call within your error handler.

## Notify the New Relic <DoNotTranslate>Ruby</DoNotTranslate>> agent of an error [#solution]
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        Replaces the `:trace_only` option, which was deprecated in version [4.3.x](/docs/release-notes/agent-release-notes/ruby-release-notes/ruby-agent-430335) of the <DoNotTranslate>Ruby</DoNotTranslate>> agent.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Older <DoNotTranslate>Ruby</DoNotTranslate>> agent versions allowed passing a `:request_params` option, but those are now ignored. If you need to record the request parameters, call this method inside a transaction, or pass the information in `:custom_params`.
      </td>
    </tr>
  </tbody>
</table>
