...
To send error data that you are handling in your own code to New Relic, use the <DNT>Ruby</DNT> agent API [`NewRelic::Agent.notice_error`](https://www.rubydoc.info/gems/newrelic_rpm/NewRelic/Agent#notice_error-instance_method) call within your error handler.

## Notify the New Relic <DNT>Ruby</DNT> agent of an error [#solution]
