...
* Disable it by editing or removing the agent configuration file. Make sure that all application host instances (Passenger, <DNT>Jetty<DNT>, etc.) have been fully restarted after disabling the agent.
