...
After enabling server-side configuration, you can access and modify the settings from the UI. Select individual settings under the <DNT>**server-side agent configuration**</DNT>.
