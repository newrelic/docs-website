...
1. Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM**</DoNotTranslate>.
2. Click on your app. Then click <DoNotTranslate>**Settings > Application > Server-side agent configuration**</DoNotTranslate>.
