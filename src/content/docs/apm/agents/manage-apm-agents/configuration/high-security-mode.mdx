...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        * For users on [our original user model](/docs/accounts/original-accounts-billing/original-users-roles/users-roles-original-user-model): Only the account owner can configure this. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities)**, click the [account dropdown](/docs/using-new-relic/welcome-new-relic/get-started/glossary#account-dropdown) and select **Account settings**. On that page, select **High security mode**.
