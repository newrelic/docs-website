...
<Callout variant="important">
  Session replay and trace data, which reports to the `blobs` endpoint, do not support multiple applications reporting. Other browser data will populate into each of the up to three applications.
</Callout>
