...
<Callout variant="important">
  Session replay _and_ trace data, which reports to the `blobs` endpoint, do <DNT>**not**</DNT> support multiple applications reporting. Other browser data will populate into each of the up to three applications.
</Callout>
