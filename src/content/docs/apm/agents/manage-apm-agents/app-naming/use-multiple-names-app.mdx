...
<Callout variant="important">
  Session replay and trace data, which reports to the blobs endpoint, do not support multiple applications reporting. Only the primary app, or the first listed, will get the data. Other browser data will populate into each of the up to three applications. 
</Callout>
