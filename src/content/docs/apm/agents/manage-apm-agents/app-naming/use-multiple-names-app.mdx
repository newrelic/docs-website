...
Normally, when two instances report with the same app name, agent language, and [license key](/docs/apis/intro-apis/new-relic-api-keys/#ingest-license-key), New Relic aggregates their data into a single New Relic-monitored app. You can also view data for the individual hosts and instances from the app's [APM **Summary** page](/docs/apm/applications-menu/monitoring/apm-overview-page).
