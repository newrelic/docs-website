...
To change t[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) >interface:

1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM & services > (select an app) > Settings > Application**.
