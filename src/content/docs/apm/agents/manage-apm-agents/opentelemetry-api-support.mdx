...
<CollapserGroup>
  ...
  >
    ...
    **Example:**
    ...
    - **Exclude list**: By default, OpenTelemetry instrumentation is excluded for libraries the New Relic Ruby agent also instruments. This includes natively instrumented libraries and libraries with instrumentation packages in [opentelemetry-ruby-contrib](https://github.com/open-telemetry/opentelemetry-ruby-contrib).
