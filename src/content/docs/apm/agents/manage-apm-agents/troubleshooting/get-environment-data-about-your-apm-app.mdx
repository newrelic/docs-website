...
To see which services and settings apply to an agent, or to see which agent uses a specific service or setting, go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities)**. Click on your app in the list, then click **Settings > Environment > Environment snapshot**.
...
<figcaption>
  **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & services > Settings > Environment > Environment snapshot:** To see specific settings that apply to an agent and its services, or to see which of a setting's values apply to specific agents, mouse over any agent or value.
</figcaption>
