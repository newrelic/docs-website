...
import troubleshootingApmEnvironment from 'images/troubleshooting-apm-environment.png'
...
<img
  ...
  src={troubleshootingApmEnvironment}
/>

<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM > Settings > Environment > Environment snapshot:** To see specific settings that apply to an agent and its services, or to see which of a setting's values apply to specific agents, mouse over any agent or value.
</figcaption>
