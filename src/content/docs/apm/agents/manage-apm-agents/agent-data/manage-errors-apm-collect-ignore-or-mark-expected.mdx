...
<CollapserGroup>
  ...
  >
    ...
    * <DNT>**Node.js**</DNT>: [`ignore_status_codes`](/docs/apm/agents/nodejs-agent/installation-configuration/nodejs-agent-configuration/#error_ignore), [`ignore_classes`](/docs/apm/agents/nodejs-agent/installation-configuration/nodejs-agent-configuration/#error_ignore_classes), or [`ignore_messages`](/docs/apm/agents/nodejs-agent/installation-configuration/nodejs-agent-configuration/#error_ignore_messages).
