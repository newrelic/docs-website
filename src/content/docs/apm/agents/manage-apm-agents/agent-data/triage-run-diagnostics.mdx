...
In this example, you've already set up your alert conditions so when you scan your summary tiles you immediately see that your system has 2 critical issues. Click the tile for details.
...
Starting 15 minutes after a deployment, this tile will display a comparison between data collected before the deployment and after. For the first 3 hours after a deployment, this tile will only display a comparison of time assed since enablement matched with the corresponding time before enablement. For example, if you enabled a new feature 45 minutes ago, this tile will show a comparison between the 45 minutes before and 45 minutes after. After three hours, the tile uses the standard 3-hour comparison.

For a custom time range, click on the tile to go to the main deployments page and use the time picker there

For this example, [your last deployment](/docs/apm/apm-ui-pages/events/record-deployments/) triggered a 27% spike in error rate and a 5% increase in response time. Click the tile to view your last deployment. 
...
Vulnerability Management provides a birds-eye view of all your software's vulnerabilities. Each of your integrated agents or services, like Java, .Net or Github [Dependabot](https://newrelic.com/instant-observability/github-dependabot) will automatically send known vulnerabilities to New Relic. 
