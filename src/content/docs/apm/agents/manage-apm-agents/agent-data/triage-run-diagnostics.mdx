...
In this example, you've already set up your alert conditions so when you scan your summary tiles you immediately see that your system has 2 critical issues. Click the tile to view details about each critical issue, the incidents they contain, and their related entities.
...
Here you can see that you've enabled [Vulnerability Management](/docs/vulnerability-management/overview/) have 3 `Critical` and 9 `High` vulnerabilities detected for your monitored service. Click the tile to view your vulnerability impact. 
