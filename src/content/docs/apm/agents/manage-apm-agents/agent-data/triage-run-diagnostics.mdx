...
<Tabs stacked>
	<TabsBar>
		<TabsBarItem id="open apm">Open APM</TabsBarItem>
        <TabsBarItem id="open service">Select a service</TabsBarItem>  
		<TabsBarItem id="time-picker">Select a time period </TabsBarItem>                      
	</TabsBar>

 	<TabsPages>
		<TabsPageItem id="open apm">

Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > All capabilities > APM and services**.

        </TabsPageItem>

		<TabsPageItem id="open service">
...
### Check your golden signals 

<Tabs stacked>
	<TabsBar>
		<TabsBarItem id="transactions">Find the problematic transaction</TabsBarItem>
        <TabsBarItem id="slow-transactions">Dig deeper into your slowest transaction</TabsBarItem>
    	<TabsBarItem id="apdex">Check user satisfaction</TabsBarItem>   
        <TabsBarItem id="throughput">Take a look at throughput</TabsBarItem>   
        <TabsBarItem id="errors">Identify errors</TabsBarItem>                     
	</TabsBar>

 	<TabsPages>
		<TabsPageItem id="transactions">


        </TabsPageItem>

		<TabsPageItem id="apdex">


        </TabsPageItem>

		<TabsPageItem id="throughput">

		</TabsPageItem>    

		<TabsPageItem id="errors">
