...
Here you can see that you've enabled [Vulnerability Management](/docs/vulnerability-management/overview/) have 3 `Critical` and 9 `High` vulnerabilities detected in your monitored service. Click the tile for details.
</Collapser>
</CollapserGroup>
</Step>
