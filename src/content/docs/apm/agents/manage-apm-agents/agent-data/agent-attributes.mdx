...
* <DoNotTranslate>**Message property attributes:**</DoNotTranslate> These are the properties set on a message received from a queue or topic.
* <DoNotTranslate>**HTTP request attributes:**</DoNotTranslate> These are the parameters for an HTTP request.
* <DoNotTranslate>**User attributes:**</DoNotTranslate> These are attributes provided by the user through each agent's API.
* <DoNotTranslate>**Agent attributes:**</DoNotTranslate> These are attributes captured by the agent; for example, `http.statusCode` and `httpResponseMessage`.
...
<table>
  <thead>
    <tr>
      <th width={200}>
        <DoNotTranslate>**Collected attributes**</DoNotTranslate>
      </th>

      <th>
        <DoNotTranslate>**Location**</DoNotTranslate>
      </th>
    </tr>
  </thead>
  ...
  <tbody>
    ...
    <tr>
      <td>
        [Transaction segments](/docs/apm/transactions/transaction-traces/transaction-trace-details-page)
      </td>
...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & services > (select an app) > Monitoring > Transactions > (select a transaction) > (select a trace):**</DoNotTranslate> Here is an example from the Ruby agent of the <DoNotTranslate>**Request attributes**</DoNotTranslate> and <DoNotTranslate>**Custom attributes**</DoNotTranslate> for a transaction trace. Exact attributes depend on your agent and on your attribute configuration.
</figcaption>
...
<table>
  <thead>
    <tr>
      <th width={200}>
        <DoNotTranslate>**Parameter**</DoNotTranslate>
      </th>

      <th>
        <DoNotTranslate>**Limitations**</DoNotTranslate>
      </th>
    </tr>
  </thead>
