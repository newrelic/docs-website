...
1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities)**, and at the top of the page, select **Query your data**.
...
3. Use [the query builder](/docs/query-your-data/explore-query-data/query-builder/introduction-query-builder) to refine your query. 
