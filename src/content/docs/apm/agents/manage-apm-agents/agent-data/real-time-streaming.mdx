...
To enable real time streaming, [update](/docs/agents/manage-apm-agents/installation/update-new-relic-agent) to the latest APM agent. You do not need to configure anything to enable real time streaming; it will automatically report faster!
