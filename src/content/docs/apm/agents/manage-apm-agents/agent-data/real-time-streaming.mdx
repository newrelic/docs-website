...
3. For applicable queries, hover over the query and click <DoNotTranslate>**Edit in query builder**</DoNotTranslate> to refine your query. 
...
* <DoNotTranslate>**Go:**</DoNotTranslate> [v2.8.0 or higher](/docs/release-notes/agent-release-notes/go-release-notes)
* <DoNotTranslate>**Java:**</DoNotTranslate> [v5.5.0 or higher](/docs/release-notes/agent-release-notes/java-release-notes)
* <DoNotTranslate>**.NET:**</DoNotTranslate> [v8.23.107.0 or higher](/docs/release-notes/agent-release-notes/net-release-notes)
* <DoNotTranslate>**Node.js:**</DoNotTranslate> [v5.13.0 or higher](/docs/release-notes/agent-release-notes/nodejs-release-notes)
* <DoNotTranslate>**PHP:**</DoNotTranslate> [v9.5.0.252 or higher](/docs/release-notes/agent-release-notes/php-release-notes)
* <DoNotTranslate>**Python:**</DoNotTranslate> [v5.2.0.127 or higher](/docs/release-notes/agent-release-notes/python-release-notes)
* <DoNotTranslate>**Ruby:**</DoNotTranslate> [v6.7.0.359 or higher](/docs/release-notes/agent-release-notes/ruby-release-notes)
