...
<Callout variant="tip">
  If you are testing your custom metric implementation, run the agent for at
  least 10 minutes to ensure that the API call is reported to New Relic.
</Callout>
...
<Callout variant="important">
  To avoid potential data problems, try to keep the total number of unique
  metric timeslices introduced by custom metrics under 2000.
</Callout>
