...
<Callout variant="important">
  To avoid potential data problems, try to keep the total number of unique metric timeslices introduced by custom metrics under 5000.
</Callout>

When the total number of unique metric names exceeds 5000, limits begin to apply automatically that affect how data appears in the user interface, such as in charts and tables. For more information, see [Metric grouping issues](/docs/features/metric-grouping-issues).
