...
* <DoNotTranslate>**C SDK logs:**</DoNotTranslate> These logs are generated due to errors in how you've instrumented your code using the New Relic C SDK API calls.
* <DoNotTranslate>**Daemon logs:**</DoNotTranslate> These are logs related to transmission of data to New Relic.
