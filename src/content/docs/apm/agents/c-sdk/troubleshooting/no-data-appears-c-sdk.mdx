...
2. Make sure the [daemon process (`newrelic-daemon`)](/docs/install-c-sdk-compile-link-your-code#daemon) is up and running so that it is invoked <DNT>**before**</DNT> starting your instrumented application.
