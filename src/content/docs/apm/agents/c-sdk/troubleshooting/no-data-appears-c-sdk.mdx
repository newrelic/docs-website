...
2. Make sure the [daemon process (`newrelic-daemon`)](/docs/install-c-sdk-compile-link-your-code#daemon) is up and running so that it is invoked <DoNotTranslate>**before**</DoNotTranslate> starting your instrumented application.
