...
* Confirm that you can compile your code with the C SDK and that the daemon is started as outlined in these [instructions](/docs/apm/agents/c-sdk/install-configure/install-c-sdk-compile-link-your-code).
