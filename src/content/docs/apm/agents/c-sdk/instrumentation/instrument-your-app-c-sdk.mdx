...
1. Add the following code immediately <DNT>**before**</DNT> the transaction that you want to monitor, supplying the required parameters.
   ...
   ```
2. Add `newrelic_end_transaction()` immediately <DNT>**after**</DNT> the web or non-web transaction that you want to monitor, supplying a pointer the transaction, `&txn`, as a parameter.
