...
Transaction errors and [error traces](#error-trace-examples) appear on the [<DoNotTranslate>**Error analytics**</DoNotTranslate> page](/docs/apm/applications-menu/error-analytics/error-analytics-manage-error-traces) in the New Relic UI. The C SDK reports the total number of errors and up to 100 error traces per minute on the <DoNotTranslate>**Error analytics**</DoNotTranslate> page.
