...
1. Add the following code immediately <DoNotTranslate>**before**</DoNotTranslate> the transaction that you want to monitor:
   ...
   ```
2. Add the following code immediately <DoNotTranslate>**after**</DoNotTranslate> the web or non-web transaction that you want to monitor:
