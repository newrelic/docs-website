...
<CollapserGroup>
  ...
  >
    ...
    2. Check the output in the `c_sdk.log` and `newrelic-daemon.log` files.
       ...
       The C SDK's architecture requires that the daemon must be invoked first <DoNotTranslate>**before**</DoNotTranslate> your instrumented application is invoked.
