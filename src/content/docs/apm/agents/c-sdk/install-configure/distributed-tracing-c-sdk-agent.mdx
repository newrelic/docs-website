---
title: 'Distributed tracing for the C SDK'
tags:
  - Understand dependencies
  - Distributed tracing
  - Enable and configure
metaDescription: How to enable distributed tracing or Infinite Tracing for the APM C SDK.
---

import clogo from 'images/clogo.png'

Distributed tracing allows you to see the entire journey of your requests throughout a [distributed system](/docs/distributed-tracing/concepts/introduction-distributed-tracing). It is turned on by default in current New Relic C SDKs, but you can also enable it manually in older versions.
...
For C SDK services that are not currently instrumented with the New Relic agent, you can use the installation assistant to instrument your service and enable distributed tracing.
...
## Options for older C SDK versions [#older-agents]

If you have older C SDKs, confirm the distributed tracing features you want are supported before enabling it.

### Compatibility guide

After reviewing the compatibility information below, see [Configure your older C SDKs](#configure-agents).

<CollapserGroup>
  <Collapser
    id="c-sdk"
    title="C SDK compatibility"
  >
...
### Configure your older C SDKs [#configure-agents]
...
<CollapserGroup>
  ...
  >
    ...
    4. (Optional) Identify the call as an external call (see [C SDK](https://github.com/newrelic/c-sdk/blob/master/GUIDE.md#distributed-tracing)).
  </Collapser>
