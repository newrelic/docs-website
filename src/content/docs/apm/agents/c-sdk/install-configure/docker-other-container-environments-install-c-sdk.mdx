...
<Callout variant="caution">
  Data transmitted from the agent to the daemon is <DoNotTranslate>**not**</DoNotTranslate> encrypted. We recommend only using a private network connection between the agent and daemon. This only applies when the agent and daemon are running on different hosts.
</Callout>
