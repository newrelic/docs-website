...
* New Relic [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key): [`license_key`](https://newrelic.github.io/c-sdk/struct__newrelic__app__config__t.html#aac3c5f9a0e5da64836a806c47b954b71)
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        To set or change the app name, set the [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key), logging level, transaction tracing, datastore tracing, etc., use:
