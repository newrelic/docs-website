...
You can change your [application's alias](/docs/agents/manage-apm-agents/app-naming/name-your-application#differences) from the <DoNotTranslate>**Application**</DoNotTranslate> settings page in the New Relic UI. This is useful, for example, to give your application a different name, yet keep historic data under the new alias. For more information, see [Name your application](/docs/agents/manage-apm-agents/app-naming/name-your-application).

New Relic's C SDK does not support [server-side configuration](/docs/agents/manage-apm-agents/configuration/server-side-agent-configuration). However, you can also use this <DoNotTranslate>**Application**</DoNotTranslate> settings page in the UI to set your application's [Apdex T](/docs/apm/new-relic-apm/apdex/apdex-measure-user-satisfaction) threshold.

To change the application's alias or Apdex T threshold in the UI go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & services > (select an app) > Settings > Application**</DoNotTranslate>.
