...
To change the application's alias or Apdex T threshold in the UI go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM > (select an app) > Settings > Application**.
