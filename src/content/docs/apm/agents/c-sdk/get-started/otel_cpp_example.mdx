...
1. To see span data: Go to <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Query your data**</DNT> and enter this query:
...
services:
  cpp:
    build:
      context: .
      dockerfile: <DNT>Docker/DNT>file.ubuntu
    stdin_open: true
    environment:
