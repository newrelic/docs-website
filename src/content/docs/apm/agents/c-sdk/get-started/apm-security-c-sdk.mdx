  ...
  <tbody>
    <tr id="name">
      ...
      <td>
        ...
        * <DoNotTranslate>**Instance names:**</DoNotTranslate> By default, the configuration returned by `newrelic_new_config()` enables datastore segments with `instance_reporting` set to `true`.
        * <DoNotTranslate>**Database names:**</DoNotTranslate> By default, the configuration returned by `newrelic_new_config()` enables datastore segments with `database_name_reporting` set to `true`.
      </td>
    </tr>
