  ...
  <tbody>
    <tr id="name">
      ...
      <td>
        ...
        * <DNT>**Instance names:**</DNT> By default, the configuration returned by `newrelic_new_config()` enables datastore segments with `instance_reporting` set to `true`.
        * <DNT>**Database names:**</DNT> By default, the configuration returned by `newrelic_new_config()` enables datastore segments with `database_name_reporting` set to `true`.
      </td>
    </tr>
