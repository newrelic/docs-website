...
![Summary page - APM](src/images/c-apm-summary.png 'Summary page - APM')

<figcaption>
  [**one.newrelic.com**](http://one.newrelic.com/) **> APM > (select an app):**
  Here is an example of some of the data you can view in New Relic after you
  deploy the C SDK for your app.
</figcaption>
...
![C SDK architecture](src/images/c-sdk-daemon-architecture0430.png 'C SDK architecture')

<figcaption>
  **C SDK architecture:** To send data from your application to New Relic, the
  daemon must be invoked **before** making calls to your application's C SDK
