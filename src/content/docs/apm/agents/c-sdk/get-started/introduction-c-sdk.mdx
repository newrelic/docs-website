...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM > (select an app):** Here is an example of some of the data you can view in New Relic after you deploy the C SDK for your app.
</figcaption>
