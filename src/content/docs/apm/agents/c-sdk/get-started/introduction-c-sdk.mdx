...
Please [explore the option](/docs/apm/agents/c-sdk/get-started/otel_cpp_example) to use OpenTelemetry as an alternative to send C++ telemetry data to New Relic.
