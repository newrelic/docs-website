...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        * Start with the [APM <DoNotTranslate>**Summary**</DoNotTranslate> page](/docs/apm/applications-menu/monitoring/apm-overview-page) to monitor the throughput, response times, errors, memory and CPU usage transactions in your applications and services, then explore other details with additional [APM dashboards](/docs/apm).
...
<figcaption>
  <DoNotTranslate>**C SDK architecture:**</DoNotTranslate> To send data from your application to New Relic, the daemon must be invoked <DoNotTranslate>**before**</DoNotTranslate> making calls to your application's C SDK instrumentation library.
</figcaption>
