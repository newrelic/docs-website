...
In version 9.7 of the .NET agent, a new environment variable was introduced that disables the use of AppDomain storage by the .NET agent:
```
...
We are extremely interested in any feedback from customers experiencing this issue who try this new configuration option. If you try this configuration option out, please create an issue in our [Github Repository](https://github.com/newrelic/newrelic-dotnet-agent) describing your experience.
