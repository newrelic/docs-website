...
<Callout variant="important">
  New Relic provides <DoNotTranslate>**limited technical support**</DoNotTranslate> for customers using .NET Framework 4.0 or lower.
</Callout>
...
<Callout variant="important">
  Applications running on .NET Framework version 4.0 or lower require a New Relic .NET agent version <DoNotTranslate>**lower than 7.0**</DoNotTranslate>.
</Callout>
