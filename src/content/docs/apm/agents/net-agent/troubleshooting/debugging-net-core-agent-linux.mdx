...
* If you get no results, set your [environment variables](https://support.newrelic.com/s/hubtopic/aAX8W0000008a6F/relic-solution-net-core-agent-required-environment-variables), restart your application, and go back to Step 1.
...
If the above steps did not address the issue, we recommend you contact support on ask for help in [Support Forum](https://support.newrelic.com/s/).
