...
<Callout variant="important">
  ...
  * Ensure that the installation and execution steps have been followed ([installation guide](https://docs.newrelic.com/docs/agents/net-agent/installation/install-net-agent-linux))
</Callout>
