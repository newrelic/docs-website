...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Read about how to [change the CAT configuration](https://docs.newrelic.com/docs/agents/net-agent/configuration/net-agent-configuration#cross_application_tracer).
    ...
    <tr>
      ...
      <td>
        Read about how to [enable the DT configuration](https://docs.newrelic.com/docs/agents/net-agent/configuration/net-agent-configuration#distributed_tracing).
