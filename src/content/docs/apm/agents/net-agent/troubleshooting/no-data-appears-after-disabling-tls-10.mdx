...
<CollapserGroup>
  ...
  >
    ...
    <Callout variant="caution">
      Follow these steps carefully. Serious problems may occur if you modify the registry incorrectly. <DNT>**Recommendation:**</DNT> Before you modify the registry, make a backup.
    </Callout>
