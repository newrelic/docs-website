...
<CollapserGroup>
  ...
  >
    ...
    <Callout variant="caution">
      Follow these steps carefully. Serious problems may occur if you modify the registry incorrectly. <DoNotTranslate>**Recommendation:**</DoNotTranslate> Before you modify the registry, make a backup.
    </Callout>

    Here's an example of how to update Windows registry to TLS 1.2. This requires TLS to be enabled for the <DoNotTranslate>**Client**</DoNotTranslate> role, because your server is connecting as a client to New Relic.
