...
1. From the Kudu Console navigation bar, select the <DoNotTranslate>**Debug console**</DoNotTranslate> menu, then select either <DoNotTranslate>**CMD**</DoNotTranslate> or <DoNotTranslate>**PowerShell**</DoNotTranslate>.
...
1. From the Windows task bar, select <DoNotTranslate>**Start > Run**</DoNotTranslate> and enter `msinfo32`. Select <DoNotTranslate>**OK**</DoNotTranslate>.
2. After the system information page loads, select <DoNotTranslate>**File > Save**</DoNotTranslate>.
