...
1. From the Kudu Console navigation bar, select the <DNT>**Debug console**</DNT> menu, then select either <DNT>**CMD**</DNT> or <DNT>**PowerShell**</DNT>.
...
1. From the Windows task bar, select <DNT>**Start > Run**</DNT> and enter `msinfo32`. Select <DNT>**OK**</DNT>.
2. After the system information page loads, select <DNT>**File > Save**</DNT>.
