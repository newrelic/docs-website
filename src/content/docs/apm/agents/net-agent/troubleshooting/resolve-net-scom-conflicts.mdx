...
2. To resolve the SCOM conflict, restore the registry settings using PowerShell:
   ...
   iisreset
   ```
3. Run these commands <DNT>**each**</DNT> time you restart your server, or create a startup script to restore these settings.
4. Recycle your app pool, or from a command prompt, run <DNT>**`IISRESET`**</DNT>.
