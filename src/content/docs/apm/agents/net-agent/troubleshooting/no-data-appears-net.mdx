...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        **.NET Core:** May require custom instrumentation.
      </td>

      <td>
        ASP.NET Core apps are automatically instrumented after installation, but other .NET Core frameworks require the additional step of [custom instrumentation](/docs/agents/net-agent/custom-instrumentation/introduction-net-custom-instrumentation). 
      </td>
    </tr>
