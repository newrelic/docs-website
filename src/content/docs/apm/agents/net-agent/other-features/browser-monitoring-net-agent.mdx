...
<CollapserGroup>
  ...
  >
    To fully disable auto-instrumentation, you can aedit <DNT>**`newrelic.config`**</DNT> and set the [`browserMonitoring` `autoInstrument` flag](/docs/agents/net-agent/installation-configuration/net-agent-configuration#browsermon-autoInstrument) to `false`:
