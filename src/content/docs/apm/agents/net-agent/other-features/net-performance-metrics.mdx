...
* <DNT>**GC/PercentTimeInGC**</DNT> (.NET Framework only)  
...
* <DNT>**GC/LOH/Survived**</DNT> (.NET Core Only) 
  The amount of memory (in MB) that has survived garbage collection. Memory survives garbage collection when there is an active reference to it. Unlike Gen0 and Gen1, memory that survives garbage collection is _not_ promoted.
...
* <DNT>**Threadpool/Worker/Available**</DNT>  
...
* <DNT>**Threadpool/Worker/InUse**</DNT>  
...
* <DNT>**Threadpool/Completion/Available**</DNT>  
...
* <DNT>**Threadpool/Completion/InUse**</DNT>  
