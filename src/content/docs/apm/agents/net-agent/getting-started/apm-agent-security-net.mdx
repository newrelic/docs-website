...
<table>
  <thead>
    <tr>
      <th width="300px">
        <DoNotTranslate>**Setting**</DoNotTranslate>
      </th>

      <th>
        <DoNotTranslate>**Effects on data security**</DoNotTranslate>
      </th>
    </tr>
  </thead>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        If there are specific attribute keys that you do <DoNotTranslate>**not**</DoNotTranslate> want to send to New Relic in transaction traces, identify them using `attributes.exclude`. This restricts the information sent to New Relic.
