  ...
  You can automatically instrument the following .NET languages and technologies:
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            After installing the .NET agent, you need to [install the `nri-perfmon` integration]https://github.com/newrelic/nri-perfmon#installation) from the New Relic Open Source repo. You can forward your ADO.net logs by running the below command in the command line:
