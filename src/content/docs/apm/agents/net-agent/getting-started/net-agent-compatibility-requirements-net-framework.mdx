  ...
  The listed .NET languages and technologies are compatible with our [instant observability](https://newrelic.com/instant-observability/) dashboards. If you use any of these languages or technologies, you can view your data in a New Relic dashboard, right out of the box:
      ...
      <tbody>
        <tr>
          ...
          <td>
            New Relic can automatically instrument services written in C#.
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            After installing the .NET agent:
            
            1. Go to the New Relic Open Source repo to [install the `nri-perfmon` on-host integration](https://github.com/newrelic/nri-perfmon#installation) for New Relic infrastructure. 
            2. Run `nri-perfmon.exe`, and then follow the [usage instructions](https://github.com/newrelic/nri-perfmon#usage).
            3. Check your metrics in New Relic.
            
            When you're ready, you can run the below command in the command line to forward your ADO.net logs:

            ```
            NEW_RELIC_DISTRIBUTED_TRACING_ENABLED=true
            NEW_RELIC_LICENSE_KEY=<var>YOUR_LICENSE_KEY</var>
            NEW_RELIC_APP_NAME="<var>YOUR_APP_NAME</var>" /usr/local/newrelic-netcore20-agent/run.sh dotnet run
            ```

            In this case, <var>YOUR_APP_NAME</var> should read <var>"ADO.NET"</var>.
          </td>
        </tr>
      </tbody>
    </table>
