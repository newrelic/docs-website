...
The agent includes built-in instrumentation for some of the most popular parts of the .NET ecosystem, including frameworks, databases, and message queuing systems. After you [download and install](/install/dotnet) the agent, it runs within the monitored process. The agent does not create a separate process or service.
...
Prior versions of Npgsql may also be instrumented, but duplicate and/or missing metrics are possible.
        ...
        <tr>
          ...
          <td>
            ...
            * Known incompatible versions: 4.0.44 and above
          </td>
        </tr>
      </tbody>
    </table>
