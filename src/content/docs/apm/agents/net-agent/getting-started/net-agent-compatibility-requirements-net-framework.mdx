...
<Collapser
  ...
  >
    ...
    <DoNotTranslate>**.NET Framework 4.6.2 or higher**</DoNotTranslate>

    To instrument applications running on .NET Framework 4.6.2 or higher, you must run the New Relic .NET agent 10.0 or higher.

    <DoNotTranslate>**The .NET agent does not support .NET Framework versions 4.5.1, 4.5.2, and 4.6.1**</DoNotTranslate>

    <DoNotTranslate>**.NET Framework 4.0 or lower**</DoNotTranslate>
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            Unless you've installed <DoNotTranslate>**only**</DoNotTranslate> .NET Framework 4.0 or higher, you <DoNotTranslate>**must**</DoNotTranslate> have .NET Framework version 3.5 installed on the target host, in addition to any other .NET Framework versions you've installed.
          </td>
        </tr>
...
>
  ...
  <Callout
    variant="important"
  >
     [<DoNotTranslate>AWS Elastic Beanstalk</DoNotTranslate>>](https://aws.amazon.com/elasticbeanstalk) isn't a supported <DoNotTranslate>.NET</DoNotTranslate>> environment.
  </Callout>  
  </Collapser>
...
>
    The agent automatically instruments some application frameworks; we refer to these frameworks as <DoNotTranslate>**fully supported**</DoNotTranslate>.

    <table>
      <thead>
        <tr>
          <th style={{ width: "200px" }}>
            <DoNotTranslate>**Compatibility status**</DoNotTranslate>
          </th>

          <th>
            <DoNotTranslate>**.NET app frameworks**</DoNotTranslate>
          </th>
        </tr>
      </thead>
      ...
      <tbody>
        <tr>
          ...
          <td>
            These frameworks <DoNotTranslate>**are fully supported:**</DoNotTranslate>
            ...
            * [WCF](/docs/apm/agents/net-agent/other-installation/install-net-agent-windows-communication-foundation-wcf/)
              ...
              * <DoNotTranslate>**Hosting Models**</DoNotTranslate>
                * IIS Hosted (with and without ASP Compatibility)
                * Self Hosted
              * [<DoNotTranslate>**Binding Types**</DoNotTranslate>](https://docs.microsoft.com/en-us/dotnet/framework/wcf/system-provided-bindings) (both client and service)  
              ...
              * <DoNotTranslate>**Invocation Methods**</DoNotTranslate> (both client and service)
                * Synchronous
        ...
        <tr>
          ...
          <td>
            Classic ASP is <DoNotTranslate>**not supported**</DoNotTranslate>, because the agent can only instrument .NET Framework-based apps.

            Sharepoint is <DoNotTranslate>**not supported**</DoNotTranslate>.
          </td>
        </tr>
      </tbody>
    </table>
...
<Collapser
    ...
    title="CMS"
>
    The agent automatically instruments the <DoNotTranslate>**EPiServer**</DoNotTranslate> content management system.
</Collapser>
...
3.  From <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DoNotTranslate>, go to <DoNotTranslate>**APM & services**</DoNotTranslate>, then select your app. To check that your installation is successful, query the following:
