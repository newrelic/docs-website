  ...
  The listed .NET languages and technologies are compatible with our [instant observability](https://newrelic.com/instant-observability/) dashboards. If you use any of these languages or technologies, you can view your data in a New Relic dashboard, right out of the box:
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
If your application uses ADO.net, you can install a combination of New Relic agents that will generate an ADO.net dashboard. Here’s what you need to do:
...
4. Go to our ADO.NET quickstart page to [install the ADO.NET dashboards](https://newrelic.com/instant-observability/ado-dotnet).
        ...
        <tr>
          ...
          <td>
            To monitor Blazor WebAssembly, you need to install the .NET agent, then install the .NET quickstart from our instant observability page. Here's what you need to do:

            1. Install the New Relic APM .NET agent and the infrastructure agent by following the steps in our [guided installation](https://one.newrelic.com/marketplace?state=bf68ca4b-b7cc-3227-fcc3-3349f5aa92f6). Be sure to restart your application to complete the installation.
            2. To confirm that your data's in New Relic, go to [one.newrelic.com](https://one.newrelic.com/all-capabilities), click **Metrics & events**, then select your application. To check your captured metrics, try this query: `FROM Transaction SELECT count(*) FACET request.uri`.
            3. To get our quickstart dashboards, go to our [.NET instant observability page](https://newrelic.com/instant-observability/dotnet), then click **Install now**. 

            Once installed, your dashboards by going to [one.newrelic.com](https://one.newrelic.com/all-capabilities), then clicking the **Dashboards** tile.
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            To track your critical Blazor Server data in New Relic, install the [Blazor server](https://newrelic.com/instant-observability/blazor-server) quickstart.
            </td>
        </tr>
      </tbody>
    </table>
