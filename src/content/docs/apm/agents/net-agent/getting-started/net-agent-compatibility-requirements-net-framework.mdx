...
4. Go to our ADO.NET quickstart page to [install the ADO.NET dashboards](https://newrelic.com/instant-observability/ado-dotnet).
        ...
        <tr>
          ...
          <td>
            ...
            2. Confirm that your data is in New Relic by going to [one.newrelic.com](https://one.newrelic.com/all-capabilities), then clicking **Metrics & events**. If your data is in New Relic, you should be able to query your Blazor WebAssembly data.
            3. Go to our [.NET instant observability page](https://newrelic.com/instant-observability/dotnet), then click **Install now**. 
            4. Choose your Blazor WebAssembly account as the account you want to monitor. 

            Once installed, you'll find your dashboards by going to [one.newrelic.com](https://one.newrelic.com/all-capabilities), then clicking the **Dashboards** tile.
          </td>
        </tr>
      </tbody>
    </table>
