...
<CollapserGroup>
  ...
  <Callout
    ...
    title="EOL NOTICE"
  >
    As of April 26, 2022, we're discontinuing support for several capabilities, including .NET Framework 4.5.2, 4.6, and 4.6.1. For more details, including how you can easily prepare for this transition, see our [Explorers Hub post](https://discuss.newrelic.com/t/q1-bulk-eol-announcement-fy23/181744).
  </Callout>
