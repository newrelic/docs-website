  ...
  You can automatically instrument the following .NET languages and technologies:
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            After installing the .NET agent, you need to [install the `nri-perfmon` integration](https://github.com/newrelic/nri-perfmon#installation) from the New Relic Open Source repo. 
            
            When you're ready, you have the option to forward your ADO.net logs by running the below command in the command line:

            ```
            NEW_RELIC_DISTRIBUTED_TRACING_ENABLED=true
            NEW_RELIC_LICENSE_KEY=<var>YOUR_LICENSE_KEY</var>
            NEW_RELIC_APP_NAME="ADO.NET" /usr/local/newrelic-netcore20-agent/run.sh dotnet run
