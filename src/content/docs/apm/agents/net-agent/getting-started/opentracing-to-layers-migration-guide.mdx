...
After you've removed the `NewRelic.OpenTracing.AmazonLambda.Tracer` package removed, the next step is to select which method you will use to install and configure the .NET AWS Lambda layer. As mentioned above there are primarily three options:
