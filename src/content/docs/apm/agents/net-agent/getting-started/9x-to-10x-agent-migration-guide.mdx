...
Microsoft has announced that [.NET Framework 4.6.1 and lower](https://docs.microsoft.com/en-us/lifecycle/products/microsoft-net-framework) and .NET Core 3.0 and lower reached [end of support](https://dotnet.microsoft.com/en-us/platform/support/policy/dotnet-core). Maintaining support for EOLed frameworks keeps us from using the latest technologies; therefore, the .NET agent version 10.0 and later will stop instrumenting applications that are built with these frameworks.
...
Starting from v10.x, we will stop providing scriptable installers from our download site.
