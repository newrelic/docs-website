...
<figcaption>
After installing the .NET agent, you'll see a summary of your app's performance on our APM <DoNotTranslate>**Summary**</DoNotTranslate> page.
</figcaption>
...
The agent's support for .NET Core takes advantage of the compatibility, speed, expanded API features, and cross-platform capabilities of Microsoft's .NET Core. The agent <DoNotTranslate>**does not**</DoNotTranslate> support Microsoft .NET Core versions earlier than 2.0.
