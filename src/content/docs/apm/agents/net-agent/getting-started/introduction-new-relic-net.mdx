...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM > (select an app) > Summary**: After installing the .NET agent, you will see a summary of your app's performance on the **Summary** page.
</figcaption>
