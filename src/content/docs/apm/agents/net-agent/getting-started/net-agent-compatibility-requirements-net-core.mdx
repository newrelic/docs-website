...
For frameworks and libraries that are not [automatically instrumented](/node/9136/draft#instrumented-features) out of the box, you can extend the agent with [.NET custom instrumentation](/docs/agents/net-agent/custom-instrumentation/introduction-net-custom-instrumentation).
