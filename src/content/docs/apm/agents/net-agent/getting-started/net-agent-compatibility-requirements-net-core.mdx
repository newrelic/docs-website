...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="<DoNotTranslate>AWS Elastic Beanstalk</DoNotTranslate>>"
  >
    For [<DoNotTranslate>AWS Elastic Beanstalk</DoNotTranslate>>](https://aws.amazon.com/elasticbeanstalk) installation instructions, see:

    * [Install on <DoNotTranslate>AWS Elastic Beanstalk</DoNotTranslate>>](/docs/agents/net-agent/install-guides/install-net-agent-on-aws-elastic-beanstalk)
  </Collapser>
