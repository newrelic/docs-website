    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Use MySql.Data version 6.10.7 or later (preferred as it is considered core technology), or use the [MySQL Connector](https://github.com/mysql-net/MySqlConnector)
          </td>
        </tr>
