...
* Verified compatible versions: 1.0.1, 1.3.13, 2.1.2, 2.3.1
          </td>
        </tr>
...
Verified compatible versions: 1.0.488, 1.1.608, 1.2.6, 2.0.601, 2.1.58, 2.2.88, 2.6.66, 2.6.116, 2.7.4
		  </td>
        </tr>
...
* Verified compatible versions: 8.0.0, 8.1.0, 8.1.1, 8.9.1, 8.9.2
