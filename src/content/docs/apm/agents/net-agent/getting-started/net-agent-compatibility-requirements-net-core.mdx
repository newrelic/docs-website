...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="<DNT>AWS <DNT>Elastic Beanstalk</DNT></DNT>"
  >
    For [<DNT>AWS <DNT>Elastic Beanstalk</DNT></DNT>](https://aws.amazon.com/elasticbeanstalk) installation instructions, see:

    * [Install on <DNT>AWS <DNT>Elastic Beanstalk</DNT></DNT>](/docs/agents/net-agent/install-guides/install-net-agent-on-aws-elastic-beanstalk)
  </Collapser>
