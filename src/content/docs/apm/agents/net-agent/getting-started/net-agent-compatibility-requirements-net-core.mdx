      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            Supported Versions: 4.3.1+
            Verified Compatible Versions: 4.3.1, 4.8.3

            Microsoft.Data.SqlClient
            Supported Versions: 1.0.19239.1+
        ...
        <tr>
          ...
          <td>
            Use MySql.Data version 6.10.7 or later (the preferred method, as it's a core technology), or use the [MySQL Connector](https://github.com/mysql-net/MySqlConnector)
          </td>
        </tr>
