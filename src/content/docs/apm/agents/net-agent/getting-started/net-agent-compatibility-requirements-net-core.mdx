...
* Verified compatible versions: 1.0.1, 1.3.13, 2.1.2, 2.3.1, 2.3.3
          </td>
        </tr>
...
Verified compatible versions: 1.0.488, 1.1.608, 1.2.6, 2.0.601, 2.1.58, 2.2.88, 2.6.66, 2.6.116, 2.7.4, 2.7.10
		  </td>
        </tr>
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            2.0.10, 2.0.12, 2.0.13, 2.0.14, 5.2.8
          </td>
