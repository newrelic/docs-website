    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            The .NET agent `v9.2.0` or later automatically instruments [Microsoft.Azure.Cosmos](https://www.nuget.org/packages/Microsoft.Azure.Cosmos) library `v3.17.0` or later (`v3.23.0` is the latest tested verion). The agent instruments, but not limited to, the following methods:
