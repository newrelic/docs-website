...
<CollapserGroup>
  ...
  >
    ...
    * [.NET Core version 3.0](https://devblogs.microsoft.com/dotnet/net-core-3-0-end-of-life/) on March 3, 2020.
    ...
    The official product lifecycle start and end dates can be found [here](https://dotnet.microsoft.com/en-us/platform/support/policy/dotnet-core).  The dotnet agent support of these framework versions will continue as is with the released versions.  In a future major release, we will target .NET Core 3.1 onwards.
  </Callout>
