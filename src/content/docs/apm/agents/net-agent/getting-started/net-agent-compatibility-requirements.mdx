        ...
        ## Requirements
            ...
            >
               **<DNT>.NET Framework 4.6.2</DNT> or higher**
                ...
                To instrument applications running on <DNT>.NET Framework</DNT> 4.6.2 or higher, you must run the New Relic <DNT>.NET agent</DNT> 10.0 or higher.

                <DNT>**The <DNT>.NET agent </DNT> doesn't support .NET Framework versions 4.5.1, 4.5.2, and 4.6.1**</DNT>

                **<DNT>.NET Framework 4.0</DNT> or lower**
