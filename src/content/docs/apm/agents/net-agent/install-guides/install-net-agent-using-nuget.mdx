...
4. Set environment variables (below) and any other necessary configuration. How to do this will vary, depending on your environment and system.
   ...
   <CollapserGroup>
     ...
     >
       ...
       The [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) and app name aren't required environment variables; they [can be set in other ways](/docs/agents/net-agent/installation/net-agent-install-resources#env-variables).
     </Collapser>
