...
3. From the Package Manager command prompt, type `Install-Package NewRelic.Agent` and press <DoNotTranslate>**Enter**</DoNotTranslate>. When you build your project, the .NET agent folder will be copied to your build output directory.
