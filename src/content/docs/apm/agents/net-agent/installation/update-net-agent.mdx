...
## .NET agent versions not supported [#eol-versions]

**End of life notification:** As of July 29, 2019, New Relic will no longer accept data from .NET agent versions earlier than **5.1**.
