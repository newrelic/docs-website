...
2. Check the version of the .NET agent you currently have installed by using <DoNotTranslate>**Windows Programs and Features**</DoNotTranslate> or by using your Linux package manager.
...
<Callout variant="important">
  ...
  * Updating the agent requires <DoNotTranslate>**Administrator**</DoNotTranslate> rights in your Windows admin group. For more information, see the [permissions documentation](/docs/apm/agents/net-agent/getting-started/net-agent-compatibility-requirements-net-framework/#user-rights).
  ...
  * If your application is hosted in IIS, be sure to <DoNotTranslate>**stop IIS**</DoNotTranslate> before updating the .NET agent.
</Callout>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr id="50">
          ...
          <td>
            ...
            * You're upgrading from .NET Framework agent to version 5.0 or higher.
            ...
            2. Add this `appSetting` to your <DoNotTranslate>**web.config**</DoNotTranslate>:
        ...
        <tr id="500">
          ...
          <td>
            Metrics that are not part of a transaction won't be displayed in the UI. <DoNotTranslate>**Exception:**</DoNotTranslate> You can view [database](/docs/apm/apm-ui-pages/monitoring/databases-page-view-operations-throughput-response-time/) and [external](/docs/apm/apm-ui-pages/monitoring/external-services/external-services-intro/) metrics in their respective pages in the APM UI. Other such metrics (such as instrumented methods) can be made viewable by "wrapping" them in a [custom transaction](/docs/apm/agents/net-agent/custom-instrumentation/create-transactions-xml-net/).
        ...
        <tr id="220">
          ...
          <td>
            Version 2.19.3.0 was the last .NET agent version that required both the `GetBrowserTimingFooter()` and the `GetBrowserTimingHeader()` API calls for <InlinePopover type="browser" />. In agent version 2.20.24.0 or higher, you only need to call `GetBrowserTimingHeader()`. `GetBrowserTimingFooter()` has no effect. <DoNotTranslate>**Recommendation:**</DoNotTranslate> Remove these references from your code.
          </td>
        </tr>
        ...
        <tr id="22">
          ...
          <td>
            ...
            You may experience `cocreateinstance` errors with <DoNotTranslate>**services.exe**</DoNotTranslate> when you update an old installer (2.1.3.494 or lower) or make other changes to environment variables. To resolve this problem, refer to [Microsoft's documentation](https://learn.microsoft.com/en-us/windows/win32/procthread/changing-environment-variables).
          </td>
        </tr>
      </tbody>
    </table>
