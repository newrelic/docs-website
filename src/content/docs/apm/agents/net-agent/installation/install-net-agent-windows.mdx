...
ASP.NET Core apps are automatically instrumented, but other application frameworks will require [custom instrumentation](/docs/agents/net-agent/custom-instrumentation/introduction-net-custom-instrumentation)
