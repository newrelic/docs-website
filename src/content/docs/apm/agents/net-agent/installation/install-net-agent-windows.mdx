...
* Because most non-IIS applications are not instrumented automatically, you'll likely need to [set up custom instrumentation](/docs/apm/agents/net-agent/custom-instrumentation/introduction-net-custom-instrumentation) to get data reporting to New Relic. 
...
ASP.NET Core apps are automatically instrumented upon installation, but other .NET Core frameworks will require [custom instrumentation](/docs/agents/net-agent/custom-instrumentation/introduction-net-custom-instrumentation)
