...
<Callout variant="tip">
  Find all binaries and packages for the .NET Agent in our [latest releases](http://download.newrelic.com/dot_net_agent/latest_release). 
  
  Historical releases can be found in our [previous releases](http://download.newrelic.com/dot_net_agent/previous_releases/).
</Callout>
