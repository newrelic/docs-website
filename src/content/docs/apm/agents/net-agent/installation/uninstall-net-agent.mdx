...
<Callout variant="tip">
  Requires [<DNT>**Administrator**</DNT> rights](/docs/agents/net-agent/getting-started/compatibility-requirements-net-framework-agent#user-rights) in your Windows admin group.
</Callout>
...
2. Select <DNT>**Start > All Programs > New Relic .NET Agent > Uninstall the .NET agent**</DNT>.
