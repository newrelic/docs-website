...
Before you can install, you need a New Relic account ([It's free, forever!](https://docs.newrelic.com/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing/#how-pricing-works)). 
