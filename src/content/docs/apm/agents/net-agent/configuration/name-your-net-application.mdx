...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        If you want to rename your app programmatically, you can use the [`SetApplicationName()` agent API call](/docs/apm/agents/net-agent/net-agent-api/set-application-name/) to set the app name at run time. This name will take priority over all other application naming sources.
      </td>
    </tr>
  </tbody>
</table>
