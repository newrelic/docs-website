...
import netAgentConfigSettingsPrecedence0 from 'images/net-agent-config-settings-precedence_0.png'
...
<img
  ...
  src={netAgentConfigSettingsPrecedence0}
/>
...
<CollapserGroup>
  ...
  >
    ...
    Alternatively, set the `NEW_RELIC_UTILIZATION_DETECT_AWS` environment variable in the application's environment.
  </Collapser>
  ...
  >
    ...
    Alternatively, set the `NEW_RELIC_UTILIZATION_DETECT_AZURE` environment variable in the application's environment.
  </Collapser>
  ...
  >
    ...
    Alternatively, set the `NEW_RELIC_UTILIZATION_DETECT_GCP` environment variable in the application's environment.
  </Collapser>
  ...
  >
    ...
    Alternatively, set the `NEW_RELIC_UTILIZATION_DETECT_PCF` environment variable in the application's environment.
  </Collapser>
  ...
  >
    ...
    Alternatively, set the `NEW_RELIC_UTILIZATION_DETECT_DOCKER` environment variable in the application's environment.
  </Collapser>
  ...
  >
    ...
    Alternatively, set the `NEW_RELIC_UTILIZATION_DETECT_KUBERNETES` environment variable in the application's environment.
  </Collapser>
</CollapserGroup>
...
<Callout variant="important">
These configuration options are only available for .NET agent version 9.7.1 or higher.
    </Callout>
