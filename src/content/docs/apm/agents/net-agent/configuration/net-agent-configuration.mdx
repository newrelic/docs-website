...
<Callout variant="important">
  <DoNotTranslate>**For IIS**</DoNotTranslate>: after you change your `newrelic.config` or `app.config` file, perform an `IISRESET` from an administrative command prompt. Log level adjustments do not require a reset.
</Callout>
  ...
  <thead>
    <tr>
      <th style={{ width: "230px" }}>
        <DoNotTranslate>**.NET configuration**</DoNotTranslate>
      </th>

      <th>
        <DoNotTranslate>**Details and precedence**</DoNotTranslate>
      </th>
    </tr>
  </thead>
    ...
    <tr>
      ...
      <td>
        ...
        If the agent is disabled in the local or global `newrelic.config`: 
            * The `NewRelic.AgentEnabled` settings in `appsettings.json` <DoNotTranslate>**will enable the agent**</DoNotTranslate>.
            * The `NewRelic.AgentEnabled` settings in a `web.config` or `app.config` file <DoNotTranslate>**will be ignored**</DoNotTranslate>.
...
<CollapserGroup>
  ...
  >
    ...
    <DoNotTranslate>**Windows (MSI Installer):**</DoNotTranslate>
...
<CollapserGroup>
  ...
  >
    ...
    The directory to hold log files generated by the agent. If this is omitted, then a directory named <DoNotTranslate>**logs**</DoNotTranslate> in the New Relic agent install area will be used by default.
...
In this example, the agent excludes all attributes whose key begins with <DoNotTranslate>**myApiKey**</DoNotTranslate> (<DoNotTranslate>**myApiKey.bar**</DoNotTranslate>, <DoNotTranslate>**myApiKey.value**</DoNotTranslate>), but collects the custom attribute <DoNotTranslate>**myApiKey.foo**</DoNotTranslate>.
...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="ignoreClasses"
  >
    A list of fully qualified class names to be ignored. The maximum number of error class and message combinations that <DoNotTranslate>**SHOULD**</DoNotTranslate> be reported is 50. If more than 50 are listed, then only the first 50 <DoNotTranslate>**SHOULD**</DoNotTranslate> be used
  </Collapser>
  ...
  >
    An optional map of fully qualified class names to list of strings matching a substring of the message of an error. The maximum number of error class and message combinations that <DoNotTranslate>**SHOULD**</DoNotTranslate> be reported is 50. If more than 50 are listed, then only the first 50 <DoNotTranslate>**SHOULD**</DoNotTranslate> be used
  </Collapser>
  ...
  >
    A list of fully qualified class names to be marked as expected. The maximum number of error class and message combinations that <DoNotTranslate>**SHOULD**</DoNotTranslate> be reported is 50. If more than 50 are listed, then only the first 50 <DoNotTranslate>**SHOULD**</DoNotTranslate> be used
  </Collapser>
...
<CollapserGroup>
  ...
  >
    ...
    The default value is `apdex_f`, which sets the threshold to four times the application's <DoNotTranslate>**apdex_t**</DoNotTranslate> value. For more information about <DoNotTranslate>**apdex_t**</DoNotTranslate>, see [Apdex](/docs/site/apdex-measuring-user-satisfaction).
...
### AI (Large Language Model) Monitoring [#ai_monitoring]
...
<CollapserGroup>
  <Collapser 
    ...
    title="recordContent">
        Use this sub-element to enable recording of input and output for LLM events (such as chat completion and embedding). The default value of attribute `enabled` is `true`. Content recording is disabled in High Security Mode. 
