...
<Callout variant="important">
  This document is **not** meant to be read as a standalone document. For install instructions, see [.NET agent install](/docs/agents/net-agent/installation/install-enable-new-relic-net-agent).
</Callout>
