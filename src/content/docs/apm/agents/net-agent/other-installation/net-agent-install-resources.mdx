...
* **License key**. The environment variable for setting the [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) is:
       ...
       <table>
         ...
         <tbody>
           <tr>
             ...
             <td>
               **Required**. Your [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key).
             </td>
           </tr>
