...
<Callout variant="important">
  This document is <DoNotTranslate>**not**</DoNotTranslate> meant to be read as a standalone document. For install instructions, see [.NET agent install](/install/dotnet).
</Callout>
...
If your .NET application uses an application framework that is <DoNotTranslate>**not**</DoNotTranslate> automatically instrumented, or if the app has no framework (like a console app), after the install you will need to manually set up instrumentation of your app. Here are the steps to do that:
...
* <DoNotTranslate>**License key**</DoNotTranslate>. The environment variable for setting the <InlinePopover type="licenseKey" /> is:
...
* <DoNotTranslate>**App name**</DoNotTranslate>. Setting a [meaningful application name](/docs/agents/manage-apm-agents/app-naming/name-your-application#app-name) is recommended, but you can also set this after install. The environment variable is:
       ...
       <table>
         ...
         <tbody>
           <tr>
             ...
             <td>
               <DoNotTranslate>**Required**</DoNotTranslate>. Your <InlinePopover type="licenseKey" />.
             </td>
           </tr>
       ...
       <table>
         ...
         <tbody>
           <tr>
             ...
             <td>
               <DoNotTranslate>**Required**</DoNotTranslate>. The location where the agent is installed. This can be an absolute or relative path. Wrapping quotes are required.
             </td>
           </tr>
           ...
           <tr>
             ...
             <td>
               <DoNotTranslate>**Required**</DoNotTranslate>. Determines whether this is a local (app-specific) or global (system-wide) install.
             </td>
           </tr>
           ...
           <tr>
             ...
             <td>
               Optional. Installs the 32-bit version of the agent rather than the 64-bit version. New Relic <DoNotTranslate>**does not recommend**</DoNotTranslate> installing the 32-bit version of the agent globally.
             </td>
           </tr>
