  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        Add these arguments to the <DoNotTranslate>**Azure App Service deploy -> Additional Deployment Options -> Additional Arguments**</DoNotTranslate>
        ...
        <DoNotTranslate>**Note**</DoNotTranslate> the escaped single quotes.
      </td>
    </tr>
  </tbody>
</table>
