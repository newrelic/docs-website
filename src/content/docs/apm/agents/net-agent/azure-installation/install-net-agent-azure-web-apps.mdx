...
1. Make sure you have your <LicenseKey/> before adding the New Relic .NET agent's app settings.
...
Setting the <LicenseKey/> and app name with **Application settings** will override the `newrelic.config`.
