...
* Make sure Microsoft Application Insights is **not** installed and configured on the application. For more information, see the [Application Insights troubleshooting procedures](/docs/agents/net-agent/azure-troubleshooting/net-profiler-conflict-microsoft-application-insights).
