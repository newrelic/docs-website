...
1. Make sure you have your [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) before adding the New Relic .NET agent's app settings.
...
Setting the [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) and app name with **Application settings** will override the `newrelic.config`.
