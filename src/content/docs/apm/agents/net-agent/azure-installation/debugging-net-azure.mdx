...
1. Use Kudu's built-in Process Explorer (Windows only; for Linux installs, reference the commands in [this article](https://docs.newrelic.com/docs/apm/agents/net-agent/troubleshooting/debugging-net-core-agent-linux/).)
