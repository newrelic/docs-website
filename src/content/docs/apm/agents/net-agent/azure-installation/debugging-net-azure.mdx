...
If the above steps did not address the issue, we recommend you contact support or ask for help on [our Support Forum](https://discuss.newrelic.com/tag/dotnetagent).
