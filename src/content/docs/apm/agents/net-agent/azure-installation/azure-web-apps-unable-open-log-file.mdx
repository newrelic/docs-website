...
You are connecting via FTP to your [Microsoft Azure Web App](/docs/agents/net-agent/azure-installation/install-app-azure-web-apps). You can see a `NewRelic.Profiler.####.log` file in <DNT>**LogFiles\\NewRelic**</DNT>, but when you try to access the log file, an error message appears.
