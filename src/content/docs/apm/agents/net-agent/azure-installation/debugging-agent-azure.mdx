...
<CollapserGroup>
  ...
  For the NuGet package, the environment variables [must be added as application settings](/docs/apm/agents/net-agent/azure-installation/install-net-agent-azure-web-apps/#nuget-install-net-core). The environment variables that appear in the <DNT>**Environment**</DNT> tab in Kudu's <DNT>**Process Explorer**</DNT> should be similar to these:
