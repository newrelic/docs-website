...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM > (select an app) > Monitoring > Transactions > Type > (selected type)**: Use the **Type** menu to view your custom transactions.
</figcaption>
