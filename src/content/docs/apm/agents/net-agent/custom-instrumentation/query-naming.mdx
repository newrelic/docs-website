...
To give a name to a query, you add a parseable comment to the query text, with a format like ```/* NewRelicQueryName: myQueryName */```. Here's an example of adding that to an app's code:
