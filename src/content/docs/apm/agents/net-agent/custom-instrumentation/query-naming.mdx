...
Your database and query data can be found on the [<DNT>**Databases**</DNT> UI page](/docs/apm/apm-ui-pages/monitoring/databases-page-view-operations-throughput-response-time). A named query will appear with its name in brackets. Here's an example of that:
