...
## `NoticeError(Exception)` syntax [#exception-overload-syntax]

```cs
NewRelic.Api.Agent.NewRelic.NoticeError(Exception $exception)
```

### Parameters [#exception-overload-params]
...
## `NoticeError(Exception, IDictionary)` syntax [#exception-idictionary-overload-syntax]

```cs
NewRelic.Api.Agent.NewRelic.NoticeError(Exception $exception, IDictionary<TKey, TValue> $attributes)
```

### Parameters [#exception-idictionary-overload-params]
...
## `NoticeError(String, IDictionary)` syntax [#string-idictionary-overload-syntax]

```cs
NewRelic.Api.Agent.NewRelic.NoticeError(string $error_message, IDictionary<TKey, TValue> $attributes)
```

### Parameters [#string-idictionary-overload-params]
...
## `NoticeError(String, IDictionary, bool)` syntax [#string-idictionary-bool-overload-syntax]

```cs
NewRelic.Api.Agent.NewRelic.NoticeError(string $error_message, IDictionary<TKey, TValue> $attributes, bool $is_expected)
```

### Parameters [#string-idictionary-bool-overload-params]
