  ...
  >
    ...
    <CollapserGroup>
      ...
      >
        ...
        * This API can only be used within the context of an existing transaction. (#TODO elaborate on this)
      ...
      >
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                Required. Describes the transport of the incoming payload (for example `TransportType.Queue`). (#TODO link to documention of enum)
              </td>
            </tr>
          </tbody>
        </table>
        ...
        * [Distributed tracing must be enabled](/docs/agents/net-agent/configuration/net-agent-configuration#distributed_tracing).
        * This API can only be used within the context of an existing transaction.  (TODO elaborate)
