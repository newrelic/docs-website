...
<CollapserGroup>
  ...
  >
    The `analyticsEvents` element in <DNT>**newrelic.config**</DNT> is obsolete. Enable the [`transactionEvents`](/docs/agents/net-agent/installation-configuration/net-agent-configuration#transaction_events) element in <DNT>**newrelic.config**</DNT>:
