...
<CollapserGroup>
  ...
  >
    Our APM agents automatically report errors for unhandled exceptions. In situations where application logic handles the error our APM agent might not have a chance to see it. There is no stack trace to be reported then.
