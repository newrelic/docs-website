...
3. Select <DoNotTranslate>**Install APM**</DoNotTranslate>, and then select your target app from the dropdown.
...
3. Download a customized `newrelic.yml` file from your APM account settings:
   ...
   <CollapserGroup>
     ...
     >
       ...
       2. Select your app.
       3. Select <DoNotTranslate>**Add-ons > APM**</DoNotTranslate>.
...
* If you don't see the New Relic add-on after you generate traffic, go to Heroku, select <DoNotTranslate>**Find more add ons**</DoNotTranslate>, and add the APM add-on.
