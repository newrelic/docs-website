...
[Heroku](https://devcenter.heroku.com/articles/newrelic) is a Platform as a Service (PaaS) solution for hosting web applications in various agent languages, including Scala. With New Relic, you can extend Heroku with metrics from [APM](/docs/apm/new-relic-apm) and [<InlinePopover type="browser"/>](/docs/browser/new-relic-browser).
...
3. Select <DNT>**Install APM**</DNT>, and then select your target app from the dropdown.
...
* If you don't see the New Relic add-on after you generate traffic, go to Heroku, select <DNT>**Find more add ons**</DNT>, and add the APM add-on.
