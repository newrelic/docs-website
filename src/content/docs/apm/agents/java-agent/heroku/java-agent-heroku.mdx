...
[Heroku](https://devcenter.heroku.com/articles/newrelic) is a Platform as a Service (PaaS) solution for hosting web applications in various agent languages, including Java. With New Relic, you can extend Heroku with metrics from [APM](/docs/apm/new-relic-apm) or [<InlinePopover type="browser"/>](/docs/browser/new-relic-browser).
