...
After waiting a few minutes, data is not appearing in your Heroku app's APM [<DNT>**Summary**</DNT> page](/docs/apm/applications-menu/monitoring/apm-overview-page).
