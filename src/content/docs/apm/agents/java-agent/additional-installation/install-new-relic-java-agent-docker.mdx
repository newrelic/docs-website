...
<CollapserGroup>
  ...
  >
    1. From <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DoNotTranslate>, click <DoNotTranslate>**Add more data**</DoNotTranslate> and then search for "Java".
...
To create your license key:

1. Go to the API keys UI and create a <InlinePopover type="licenseKey" />.
