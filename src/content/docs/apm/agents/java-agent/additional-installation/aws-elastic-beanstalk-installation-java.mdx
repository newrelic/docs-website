---
title: AWS <DNT>Elastic Beanstalk</DNT> installation for Java
tags:
  - Agents
  - Java agent
  - Additional installation
metaDescription: Directions for installing the New Relic Java agent with <DNT>Elastic Beanstalk</DNT>.
redirects:
...
If you are an [<DNT>AWS <DNT>Elastic Beanstalk</DNT></DNT>](http://docs.amazonwebservices.com/elasticbeanstalk/latest/gsg/) user, the Java agent requires additional configuration.
...
To complete Java agent installation on <DNT>AWS <DNT>Elastic Beanstalk</DNT></DNT>, follow the steps for your platform:

## <DNT>Tomcat</DNT> platform

For applications deployed with the <DNT>AWS <DNT>Elastic Beanstalk</DNT> <DNT>Tomcat</DNT></DNT> Platform:
...
4. In the AWS console, open the <DNT>Elastic Beanstalk</DNT>.
...
For applications deployed with the <DNT>AWS <DNT>Elastic Beanstalk</DNT> Java SE</DNT> Platform:
...
2. To use custom JVM arguments with your Java SE application, we recommend that you include a `Procfile` at the root of the source bundle of your application. See [Java SE documentation](https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/java-se-platform.html) for details.    
    ...
    ```
3. Repackage and deploy the source bundle to your <DNT>Elastic Beanstalk</DNT>.
