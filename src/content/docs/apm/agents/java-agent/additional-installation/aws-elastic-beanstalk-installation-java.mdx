...
If you are an [<DoNotTranslate>AWS Elastic Beanstalk</DoNotTranslate>>](http://docs.amazonwebservices.com/elasticbeanstalk/latest/gsg/) user, the Java agent requires additional configuration.
...
To complete Java agent installation on <DoNotTranslate>AWS Elastic Beanstalk</DoNotTranslate>>, follow the steps for your platform:

## Tomcat platform

For applications deployed with the <DoNotTranslate>AWS Elastic Beanstalk Tomcat</DoNotTranslate>> Platform:
...
Your <DoNotTranslate>Elastic Beanstalk</DoNotTranslate>> will then update your environment.

## Java SE Platform

For applications deployed with the <DoNotTranslate>AWS Elastic Beanstalk Java SE</DoNotTranslate>> Platform:
