...
1. [Install the Java agent](/docs/agents/java-agent/installation/install-java-agent). If you already have it installed, [update](https://docs.newrelic.com/docs/agents/java-agent/installation/update-java-agent#procedures) to the [latest Java agent](https://docs.newrelic.com/docs/release-notes/agent-release-notes/java-release-notes) version. Versions [5.0.0](https://docs.newrelic.com/docs/release-notes/agent-release-notes/java-release-notes/java-agent-500) and higher include fixes for later WildFly versions 11 and higher.
