...
<CollapserGroup>
  ...
  >
    Use the <DNT>**Top methods by call count**</DNT> table on the circuit breaker <DNT>**Events**</DNT> page to find methods that might be over-instrumented. Identify and disable custom instrumentation.
