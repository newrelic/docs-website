...
<CollapserGroup>
  ...
  >
    Use the <DoNotTranslate>**Top methods by call count**</DoNotTranslate> table on the circuit breaker <DoNotTranslate>**Events**</DoNotTranslate> page to find methods that might be over-instrumented. Identify and disable custom instrumentation.
