...
Custom JMX data won't be displayed in our <InlinePopover type="apm"/> charts, but you can [query the data](#display_metrics) and create custom charts with it.
...
Here's how to search for <DNT>**JMX**</DNT> or for the direct path to the counter as set in your YAML file.
