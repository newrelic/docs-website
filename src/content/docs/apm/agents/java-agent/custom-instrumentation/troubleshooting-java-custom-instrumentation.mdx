...
**Java apps only:** To edit your XML file directly from the New Relic UI: Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM > (select a Java app) > Settings > Live Instrumentation**. From here you can:
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM > (select an app) > Events > Thread profiler:** A gray icon means it cannot be instrumented. A white icon means it is uninstrumented but can be instrumented. A blue icon means it is currently instrumented.  
</figcaption>
