...
may want additional information about the usage of the SQS SDK. This document provides examples on how to accomplish it.
...
However for message recieven operations, we do not provide an out of the box way to accept these headers.
