...
* The [**Transaction trace summary** page](/docs/apm/transactions/transaction-traces/transaction-trace-details-page) may show `Put` and `Take` operations in the **Slowest components** section. 
