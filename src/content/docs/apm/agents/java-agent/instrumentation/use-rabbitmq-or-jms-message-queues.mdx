...
The <InlinePopup type="apm" /> UI will show transactions initiated via JMS 1.1 or RabbitMQ message receipt as **Message** background tasks. Message creation via JMS or RabbitMQ also appears in transaction traces.
