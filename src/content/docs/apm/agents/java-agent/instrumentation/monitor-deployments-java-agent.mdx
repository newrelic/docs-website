...
The Java agent does not pick up proxy configurations from the `newrelic.yml` file. <DNT>**Recommendation:**</DNT> If you use a proxy in your application, use either of these options to record deployments:
