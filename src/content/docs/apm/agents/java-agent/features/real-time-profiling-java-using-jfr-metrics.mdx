...
To view your data, go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Explorer > (select service) > More Views > Realtime Profiling Java**.
...
<figcaption>
  **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Explorer > (select service) > Realtime Profiling Java**: The JVM cluster timeline view shows the JVM behavior across the cluster.
</figcaption>
...
To find the JVM details page, go to: **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Explorer > (select service) > Realtime Profiling Java > (select JVM)**. 
