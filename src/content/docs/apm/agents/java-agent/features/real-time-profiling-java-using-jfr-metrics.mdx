...
<img
  ...
  src={jfrFlamegraphs}
/>
<figcaption>**[one.newrelic.com](one.newrelic.com/) > Explorer > (select service) > Realtime Profiling Java > (select JVM)**: You can see details for each JVM, including flame graphs.</figcaption>
