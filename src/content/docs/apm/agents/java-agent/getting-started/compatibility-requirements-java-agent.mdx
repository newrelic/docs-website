...
<CollapserGroup>
  ...
  >
    ...
    * [Kafka Connect](/docs/apm/agents/java-agent/instrumentation/java-agent-instrument-kafka-message-queues/#view-kafka-metrics) 2.0.0 to latest (for metric data)
    * [Kafka Connect](/docs/apm/agents/java-agent/instrumentation/java-agent-instrument-kafka-message-queues/#collect-kafka-connect-transactions 2.0.0 to latest (for transaction tracing)
