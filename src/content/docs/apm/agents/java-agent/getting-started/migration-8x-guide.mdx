...
2. For each alert returned, you can use the id or name in the <DoNotTranslate>**Alerts> [Alerts Conditions](https://one.newrelic.com/alerts-ai/condition-builder/condition-list)**</DoNotTranslate> UI to find the alert.
