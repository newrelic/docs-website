...
Attributes removed in versions 8.0 to 8.7 are reintroduced in 8.8.0. This gives backward compatibility for customers that still use those attributes for alerts or dashboards.
</Callout>
