...
In version 8.8.0 the attributes removed in 8.x - 8.7x were reintroduced for backward compatibility for customers that still have alerts or dashboards using which use them.
</Callout>
