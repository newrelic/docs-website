...
When you make a change to your configuration or to your custom XML, in almost all cases you must restart your JVM. There are only four situations where a restart is <DoNotTranslate>**not**</DoNotTranslate> necessary:
