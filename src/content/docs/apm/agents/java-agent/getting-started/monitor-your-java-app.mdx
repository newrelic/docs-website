...
<CollapserGroup>
  ...
  If you have an Apache Tomcat app running on a host, you can use our command line installer, [guided install](https://one.newrelic.com/nr1-core?state=588ed629-42d0-08ca-5da4-b2857d2c334c).
