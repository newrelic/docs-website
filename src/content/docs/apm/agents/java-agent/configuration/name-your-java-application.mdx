...
The New Relic Java agent gives you several ways to change the application name that is reported and displayed in APM. This document gives you an overview of those naming options.
