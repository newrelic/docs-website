...
* <DNT>**Dispatcher Name**</DNT>: The name of the app server. For example, Apache <DNT>Tomcat</DNT>, Glassfish, or WebLogic. If there is no active app server, defaults to <DNT>**Unknown**</DNT>.
