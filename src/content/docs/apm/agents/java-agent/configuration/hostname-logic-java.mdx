...
<Callout variant="tip">
  You can also set the display name with a [system
  property](/docs/agents/java-agent/configuration/java-agent-configuration-config-file#System_Properties).
</Callout>

![upload.png](src/images/upload.png 'display_name example')
