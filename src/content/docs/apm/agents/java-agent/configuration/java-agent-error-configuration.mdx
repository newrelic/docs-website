...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        If a transaction in your application generates an HTTP status code (e.g., `400` for a client error), the error will be reported without the stack trace. This is because:
