...
<table>
  <thead>
    <tr>
      <th width={150}>
        <DoNotTranslate>**App type**</DoNotTranslate>
      </th>

      <th>
        <DoNotTranslate>**Naming source**</DoNotTranslate>
      </th>
    </tr>
  </thead>
...
To set the application name for individual servlets in `web.xml` using <DoNotTranslate>**init parameters**</DoNotTranslate>:
