...
import apmJava from 'images/apm_logo_java.png'
...
After you instrument each of your services with <InlinePopup type="apm" /> agents, generate some traffic in your application so we can capture some traces. Here are some ways to view your traces in the UI:
