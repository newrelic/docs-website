  ...
  <thead>
    <tr>
      <th style={{ width: "200px" }}>
        <DNT>**Java agent newrelic.yml**</DNT>
      </th>
...
<CollapserGroup>
  ...
  >
    ...
    of async servlets or <DNT>Jetty<DNT> Continuations. The memory leak would manifest as leaked transactions that were suspended
...
The agent collects utilization information and sends it to the New Relic service. The agent can collect information from Amazon Web Services (AWS), Azure, Google Cloud Platform, and Pivotal Cloud Foundry instances. It will also collect information related to the <DNT>Docker/DNT> containers and Kubernetes services.
...
<CollapserGroup>
  ...
  >
    ...
    Determines whether the agent reads <DNT>Docker/DNT> information from the file system.
  </Collapser>
</CollapserGroup>
