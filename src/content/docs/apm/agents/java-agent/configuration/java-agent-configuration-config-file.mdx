...
<CollapserGroup>
  ...
  <Collapser
    id="NEW_RELIC_METADATA_SERVICE_VERSION"
    title="NEW_RELIC_METADATA_SERVICE_VERSION"
  >
    <table>
      <tbody>
        <tr>
  ...
  Setting NEW_RELIC_METADATA_SERVICE_VERSION will create the tag, tag.service.version on error data. 
