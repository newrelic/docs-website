...
[Distributed tracing](/docs/understand-dependencies/distributed-tracing/get-started/introduction-distributed-tracing) lets you see the path that a request takes as it travels through a distributed system. It is on by default for Java agent version 7.4.0 or higher. In the config file, you can set it manually in the `distributed_tracing` stanza. It can be overridden using a `newrelic.config.distributed_tracing` prefixed system property.
...
<CollapserGroup>
  ...
  >
    ...
    For example, in the config file, you would use:
    ...
    To disable distributed tracing using a [system property](/docs/agents/java-agent/configuration/java-agent-configuration-config-file#System_Properties), you would use:
