...
<Collapser
  ...
  >
    ...
    By default, built-in actuator endpoints and custom actuator endpoints (using the @endpoint annotation and it's subclasses) will all be named as "OperationHandler/handle" in New Relic. Enabling this
