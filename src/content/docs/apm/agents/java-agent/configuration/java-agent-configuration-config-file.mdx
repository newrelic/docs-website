...
Set the custom instrumentation settings in the `class_transformer` section. You can be [override](#System_Properties) these settings with a `newrelic.config.class_transformer` prefixed system property.
