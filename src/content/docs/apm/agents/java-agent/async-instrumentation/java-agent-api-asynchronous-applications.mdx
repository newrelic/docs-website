...
<CollapserGroup>
  ...
  >
    ...
    <figcaption>
      **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM > (select an app) > Transactions > Transaction trace > Trace details**: All asynchronous method calls linked with a token are indicated with an <Icon name="fe-search"/>
      **Async** icon.
    </figcaption>
...
<CollapserGroup>
  ...
  >
    ...
    <figcaption>
      **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM > (select an app) > Transactions > Transaction trace > Trace details:** A single asynchronous segment is called out in the **Drilldown** column.
    </figcaption>
  </Collapser>
</CollapserGroup>
