...
* Check the garbage collection statistics under APM's [<DoNotTranslate>**JVMs**</DoNotTranslate> page](/docs/agents/java-agent/features/jvm-metrics-page) to determine whether or not your changes have significantly altered garbage collection patterns.
