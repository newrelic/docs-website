...
This setting is **not** included in the `newrelic.yml` by default. If you want to disable annotations, set `enable_custom_tracing: false` (prefaced with two spaces) in the `common` stanza of your `newrelic.yml`.
