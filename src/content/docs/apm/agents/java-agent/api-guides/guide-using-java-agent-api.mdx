...
The New Relic Java agent API lets you control, customize, and extend the functionality of the <InlinePopup type="apm" /> [Java agent](/docs/agents/java-agent/getting-started/new-relic-java). This API consists of:
