...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
         Group errors with your own custom defined fingerprint, implement the [`ErrorGroupCallback`](/docs/java/java-agent-api/java-agent-api-register-error-group-callback-to-set-fingerprint.mdx) interface are used to generate grouping keys for errors that will be sent to
    ...
    <tr>
      <td>
        ...
        To register an [`ErrorGroupCallback`](/docs/java/java-agent-api/java-agent-api-register-error-group-callback-to-set-fingerprint.mdx) that's used to generate a grouping key for the supplied
        error.
