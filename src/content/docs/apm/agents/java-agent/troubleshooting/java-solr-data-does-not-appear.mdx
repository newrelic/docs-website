...
You are using the [Solr platform](http://lucene.apache.org/solr/) in your web application, but Solr data does not appear in the APM UI for your app from **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM & services > (select a Java app) > Monitor**.
