...
<CollapserGroup>
	...
	>
		...
		### Fix 3: Manually Configuring JBoss Modules
...
```
	...
	>
		...
		You will follow the same steps as you did with [a previous solution](#solution-incomplete-telemetry) where you will configure JBoss modules.
