...
You are experiencing classloading issues from JBoss EAP/Wildfly.

### A. Classes Fail to Load Inside the Agent [#problem-application-runtime]
...
### B. Classes Fail to Load During Application Runtime [#problem-application-runtime]
...
### A. Incomplete Telemetry [#solution-incomplete-telemetry]
...
Caused by: java.lang.ClassNotFoundException: java.util.logging.Level from [Module "io.undertow.servlet" version 2.2.5.Final-redhat-00001 from local module loader @7ce85af2 (finder: local module finder @316acbb5 (roots: /Users/obenmeir/AppServers/jboss-eap-7.4/modules,/Users/obenmeir/AppServers/jboss-eap-7.4/modules/system/layers/base))]
	...
	... 22 more
```
#### Fix 1: Upgrade the Agent [#solution-a-fix-1]
Upgrade the Java Agent to `8.6` or higher.

#### Fix 2: Mark Packages to be Loaded by the System Classloader [#solution-a-fix-2]
...
#### Fix 3: Manually Configuring JBoss Modules [#solution-a-fix-3]
...
Here is a sample XML for `io.undertow.servlet`:
```xml
...
<module name="io.undertow.servlet" xmlns="urn:jboss:module:1.9">
    ...
    <dependencies>
        ...
        <!-- Add visibility to java.util.logging -->
...
### B. Classes Fail to Load During Application Runtime [#solution-application-runtime]
