...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="Jetty"
  >
    To enable local support for JMX on <DNT>Jetty<DNT> Application servers, configure the MBeanContainer with the <DNT>**etc/jetty-jmx.xml**</DNT> file. For more information, see:
  ...
  <Collapser
    ...
    title="Tomcat"
  >
    Local support for JMX is enabled on <DNT>Tomcat</DNT> Application servers by default. If you have changed the default settings, see:
