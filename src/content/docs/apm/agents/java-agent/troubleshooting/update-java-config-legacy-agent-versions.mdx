  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        The section in the <DoNotTranslate>**newrelic.yml**</DoNotTranslate> configuration file called `analytics_events` has been deprecated. Use the `transaction_events` section instead.
      </td>
    </tr>
