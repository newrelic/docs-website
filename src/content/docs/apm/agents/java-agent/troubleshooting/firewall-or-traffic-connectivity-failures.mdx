...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        New Relic's Java agent can cache a significant amount of metric data when it cannot connect. Even if the outage lasts a few minutes, in general, this will not result in any loss of information in the <InlinePopup type="apm" /> UI. You can safely ignore these messages.
      </td>
    </tr>
