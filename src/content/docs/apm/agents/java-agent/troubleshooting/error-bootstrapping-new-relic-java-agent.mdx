...
<CollapserGroup>
  ...
  >
    ...
    To solve this problem, verify permissions for the user starting the Java process that is running the Java agent. Make sure the user has <DoNotTranslate>**write**</DoNotTranslate> and <DoNotTranslate>**execute**</DoNotTranslate> permissions for the temp directory location.
  </Collapser>
