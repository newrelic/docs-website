...
<CollapserGroup>
  ...
  >
    ...
    To solve this problem, verify permissions for the user starting the Java process that is running the Java agent. Make sure the user has <DNT>**write**</DNT> and <DNT>**execute**</DNT> permissions for the temp directory location.
  </Collapser>
