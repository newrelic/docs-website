...
<DoNotTranslate>**Recommendation:**</DoNotTranslate> To avoid potential data problems, keep the total number of unique metrics introduced by custom metrics under 2000.
