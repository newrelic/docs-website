...
import apmPythonDiagramAppTracing from 'images/apm_diagram_python-diagram-app-tracing.png'

import apmClientCustomTransport from 'images/apm_diagram_client-custom-transport.png'

import apmPythonNonhttpTransport from 'images/apm_diagram_python-nonhttp-transport.png'
