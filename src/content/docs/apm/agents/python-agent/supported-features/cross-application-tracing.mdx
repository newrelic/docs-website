...
<Callout variant="important">
  A [distributed
  tracing](/docs/apm/distributed-tracing/getting-started/introduction-distributed-tracing)
  feature is now available. Distributed tracing improves on cross application
  tracing and is recommended for monitoring activity in complex distributed
  systems.
</Callout>
...
![client_http_transport.png](src/images/client_http_transport.png 'client_http_transport.png')
...
![client_custom_transport.png](src/images/client_custom_transport.png 'client_custom_transport.png')
...
<Callout variant="tip">
  The agent will automatically handle processing and sending responses to cross
  application trace metadata for all WSGI servers.
</Callout>
...
![server_nonhttp_transport.png](src/images/server_nonhttp_transport.png 'server_nonhttp_transport.png')
