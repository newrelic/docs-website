...
<Callout variant="caution">
  Message tasks are not started for consumers using
...
![New Relic for Python rabbitmq task](src/images/rabbitmq-transaction-task.png 'screen-rabbitmq-transaction.png')
...
![New Relic for Python rabbitmq transaction trace summary](src/images/rabbitmq-transaction-trace-summary_0.png 'screen-rabbitmq-trace-slowest.png')

<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/) > APM > (select an app) >
  (select a transaction trace):** In this example, the selected transaction
  trace's **Summary** shows RabbitMQ operations in the colored bar chart. The
  **Slowest components** section also lists the RabbitMQ `Put` and `Take`
  results.
</figcaption>
...
![New Relic for Python rabbitmq trace Messages](src/images/rabbitmq-transaction-trace.png 'screen-rabbitmq-messages.png')

<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/) > APM > (select an app) >
  (select a transaction trace):** In this example, the selected transaction
  trace's **Messages** tab lists the RabbitMQ message details.
</figcaption>
