...
The [**Transaction trace summary** page](/docs/apm/transactions/transaction-traces/transaction-trace-details-page) may show `Put` and `Take` operations for RabbitMQ in the **Slowest components** section. For example:
