...
<Callout variant="important">
  ML model metrics are available for Python agent version 10.0.0 and higher and are enabled by default. To change this configuration, check out our [documentation](/docs/apm/agents/python-agent/configuration/python-agent-configuration#ml-insights-events-enabled).
</Callout>
