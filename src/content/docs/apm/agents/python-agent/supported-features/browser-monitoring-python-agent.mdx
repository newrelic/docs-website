...
The calls in this procedure must be placed on <DoNotTranslate>**every**</DoNotTranslate> request you want to monitor. You <DoNotTranslate>**cannot**</DoNotTranslate> call these functions once at global scope and cache the result for later use.
...
1. Disable automatic instrumentation: In the <DoNotTranslate>**newrelic.ini**</DoNotTranslate> file, set [`browser_monitoring.auto_instrument`](/docs/agents/python-agent/installation-configuration/python-agent-configuration#browser-auto) to `false`.
2. Restart your application.
3. Place these calls into the request handler of <DoNotTranslate>**every**</DoNotTranslate> page you want to monitor:
...
1. Disable automatic instrumentation: In the <DoNotTranslate>**newrelic.ini**</DoNotTranslate> file, set [`browser_monitoring.auto_instrument`](/docs/agents/python-agent/installation-configuration/python-agent-configuration#browser-auto) to `false`.
2. Restart your application.
3. Place these calls into the request handler of <DoNotTranslate>**every**</DoNotTranslate> page you want to monitor, replacing "NONCE" with your CSP nonce:
