...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Python versions supported: 3.9, 3.10, 3.11, 3.12, 3.13, and 3.14.
        ...
        * Python version 3.8 is supported only by Python agent versions 11.5.0 or lower.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        CPython, Free-Threaded CPython, and PyPy are supported.
        
        Other Python implementations may work but are not officially supported or tested.
      </td>
    </tr>
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        * [Autogen](https://github.com/microsoft/autogen) versions 0.6.1 and above.
        * [Strands Agents](https://pypi.org/project/strands-agents/) versions 1.19.0 and above.
      </td>
    </tr>
