...
<CollapserGroup>
  ...
  >
    ...
    * Template rendering.
    ...
    <Callout variant="tip">
      Starting in v10.17.0, the Python agent is able to filter which Django middleware should be monitored.  See the [Django Middleware Filtering page](/docs/apm/agents/python-agent/supported-features/django-middleware-filtering/) for more information and examples.
    </Callout>
...
* [<DNT>Amazon Bedrock</DNT> Converse API and invoke_model](https://aws.amazon.com/bedrock/)
