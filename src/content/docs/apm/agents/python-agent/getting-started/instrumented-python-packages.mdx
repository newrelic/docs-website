...
## <DNT>Elasticsearch<DNT> clients

Time spent in calls made to <DNT>Elasticsearch<DNT> will be listed in both the main overview chart, as well as in the Databases tab in the UI.
