  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        If there are specific attribute keys that you do <DoNotTranslate>**not**</DoNotTranslate> want to send in transaction traces, identify them using `attributes.exclude`. This restricts the information sent.
