...
<CollapserGroup>
  ...
  >
    <DNT>**ERROR - No license key was set in agent configuration.**</DNT>
  ...
  >
    <DNT>**ERROR - Data collector indicates that an incorrect license key has been supplied by the agent.**</DNT>
  ...
  >
    <DNT>**ERROR - Unable to register application for test, connection could not be established within 30.0 seconds.**</DNT>
  ...
  >
    * <DNT>**WARNING - Data collector is not contactable.**</DNT>
    ...
    * <DNT>**ERROR - ConnectionError(MaxRetryError('Max retries exceeded for url: ...,),)**</DNT>
...
* <DNT>**Port:**</DNT> A value of `0` for the port setting indicates that the appropriate port, such as <DNT>**80**</DNT> or <DNT>**443**</DNT>, will be used depending on whether or not SSL is enabled.
...
1. Check that the hostname for the primary data collector host can be resolved with UNIX system tools such as <DNT>**dig**</DNT> or <DNT>**nslookup.**</DNT>
...
<Callout variant="important">
  ...
  * TCP port <DNT>**443**</DNT> if using HTTPS over a SSL connection
  * TCP port <DNT>**80**</DNT> if using a plain HTTP connection
</Callout>

If the hostname for the data collector host can be resolved, use UNIX system tools such as <DNT>**ping**</DNT> and <DNT>**traceroute**</DNT> to determine if network traffic can be routed to it. The network traffic path will vary. As long as the path reaches the final intended host, the length of the path and its hosts are not important.
...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="Traceroute"
  >
    When using <DNT>**traceroute**</DNT>, tell it to use ports <DNT>**80**</DNT> and <DNT>**443**</DNT>.
