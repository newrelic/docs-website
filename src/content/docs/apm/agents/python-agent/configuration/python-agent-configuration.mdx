...
<Callout variant="warning">
  The settings in this section have been deprecated starting in version 11.0.0.  Please see the drop down menus for each setting to see the new setting configuration to use.
</Callout>
