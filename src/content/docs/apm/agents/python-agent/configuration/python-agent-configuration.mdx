...
The only required Python agent configuration setting is the [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key). The license key identifies the account where the agent reports application data. Depending on how you are hosting your application, the license key can be provided via a configuration file or an environment variable.
...
<CollapserGroup>
  ...
  >
    ...
    Specifies the [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) of your New Relic account. This key associates your app's metrics with your New Relic account.
  </Collapser>
