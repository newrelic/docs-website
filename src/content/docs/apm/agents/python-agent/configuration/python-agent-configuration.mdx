...
<CollapserGroup>
  ...
  <Collapser
    id="cfg-bm-version"
    title="browser_monitoring.version"
  >
    <table>
      <tbody>
        <tr>
    ...
    Starting in Python Agent v13.6.0, customers are now able to set the browser agent version.  If left blank, it will default to the latest version of the browser agent.
  </Collapser>
