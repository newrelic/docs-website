...
Let’s say function tracing is to be added to all validation functions in the below file:
...
The following line can be added to the agent config file to add function tracing to all validation functions in `my-app/common/utils.py` through the use of wildcarding.
