...
Setting NEW_RELIC_METADATA_SERVICE_VERSION will create a tag, tag.service.version on event data. Service.version is the version of your code that is deployed, in many cases a semantic version such as 1.2.3 but not always. Sending this information allows you to facet your telemetry by the version of the software deployed so you can quickly identify which versions of your software are producing the errors. 

An upcoming release of [errors inbox](https://docs.newrelic.com/docs/errors-inbox/errors-inbox/) will automatically track which versions of your software are producing errors. 
