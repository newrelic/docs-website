...
<CollapserGroup>
  ...
  >
    ...
    This is the sampler that is applied when the trace has a remote parent (i.e., the trace originated in an upstream service) that has been sampled. Sampler options are:
    ...
    - `trace_id_ratio_based` delegates the sampling decision to the Trace ID Ratio Based sampling algorithm to determine whether a trace will be sampled. If using this option the ratio is required so instead use [distributed_tracing.sampler.remote_parent_sampled.trace_id_ratio_based.ratio](#distributed-tracing-sampler-remote-parent-sampled-trace-id-ratio-based-ratio).
  ...
  >
    ...
    This is the sampler that is applied when a trace has a remote parent (i.e., the trace originated in an upstream service) that was NOT sampled. Sampler options are:
    - `adaptive` is the default behavior and delegates the sampling decision to the adaptive sampling algorithm to determine whether a trace will be sampled.
    - `trace_id_ratio_based` delegates the sampling decision to the Trace ID Ratio Based sampling algorithm to determine whether a trace will be sampled. If using this option the ratio is required so instead use [distributed_tracing.sampler.remote_parent_not_sampled.trace_id_ratio_based.ratio](#distributed-tracing-sampler-remote-parent-not-sampled-trace-id-ratio-based-ratio).
  ...
  >
    ...
    - `adaptive` is the default behavior and delegates the sampling decision to the adaptive sampling algorithm to determine whether a trace will be sampled.
    - `trace_id_ratio_based` delegates the sampling decision to the Trace ID Ratio Based sampling algorithm to determine whether a trace will be sampled.  If using this option the ratio is required so instead use [distributed_tracing.sampler.root.trace_id_ratio_based.ratio](#distributed-tracing-sampler-root-trace-id-ratio-based-ratio).
