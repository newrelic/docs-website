...
The maximum value is `100000`. Setting this to the maximum value guarantees that the agent captures the maximum number of LLM events. 
        </Collapser>
    <Collapser
