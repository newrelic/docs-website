...
The following settings are available for configuration of machine learning metrics in the agent.
...
<CollapserGroup>
  ...
  >
    ...
    Set to `false` to disable capturing of the raw inference value.
  </Collapser>
