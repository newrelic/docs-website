  ...
  >
    ...
    <table>
      <thead>
        <tr>
          <th width="400px">
            <DNT>**Environment variable**</DNT>
          </th>

          <th>
            <DNT>**Configuration setting**</DNT>
          </th>
        </tr>
      </thead>
...
<CollapserGroup>
  ...
  >
    ...
    If `true`, the agent automatically detects that it is running in <DNT>Docker/DNT>.
  </Collapser>
  ...
  >
    ...
    <DNT>**Example: Built-in exception and user-defined exception**</DNT>
