...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Required. The name (or type) of the external library in use. Pass either a string that defines it or a function that accepts the same parameters as the function being wrapped and returns the library.
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Required. The URL that has been requested by the library call. Pass either a string that defines it or a function that accepts the same parameters as the function being wrapped and returns the URL.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Optional. The method defining the type of call being made. These are typically `get`, `post`, `put`, or `delete`.  Could be a function that accepts the same parameters as the function being wrapped and returns the method. 
      </td>
    </tr>
  </tbody>
</table>
