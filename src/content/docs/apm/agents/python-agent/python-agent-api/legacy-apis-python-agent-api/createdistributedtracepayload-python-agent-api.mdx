...
<Callout variant="caution">
  This API was deprecated in version 5.6.0.135 and completely removed in version 11.0.0. Please use [`newrelic.agent.insert_distributed_trace_headers`](/docs/apm/agents/python-agent/python-agent-api/insertdistributedtraceheaders-python-agent-api) instead.
</Callout>
...
For instructions on how to use this call, along with its partner call [`accept_distributed_trace_payload`](/docs/agents/python-agent/python-agent-api/acceptdistributedtracepayload-python-agent-api), see [Enable distributed tracing with agent APIs](/docs/enable-distributed-tracing#agent-apis).
