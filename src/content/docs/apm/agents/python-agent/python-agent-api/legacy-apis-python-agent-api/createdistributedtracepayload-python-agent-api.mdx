...
<Callout variant="caution">
  This API was deprecated in version 5.6.0.135 and completely removed in version 11.0.0. Please use [`insert_distributed_trace_headers`](/docs/apm/agents/python-agent/python-agent-api/insertdistributedtraceheaders-python-agent-api) instead.
</Callout>
