...
redirects:
  ...
  - /docs/agents/python-agent/python-agent-api/legacy-apis-python-agent-api/recordexception-python-agent-api
...
<Callout variant="caution">
  This API was deprecated in version 6.4.0.157 and completely removed in version 11.0.0. Please use [`notice_error()`](/docs/agents/python-agent/python-agent-api/notice_error).
</Callout>
