...
Adds additional attributes to function traces.
...
If you cannot use the decorator in your application, you can use the following call format:

* **The wrapper**: The wrapper form is `ProfileTraceWrapper`. It can be used to return a wrapped function without the use of a decorator.
