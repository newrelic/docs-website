...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Required. The name of the transaction. Could be a function that accepts a callable_name parameter. The default value is `None`. By default, the name will be the name of the function the decorator has been applied to but you can override this by supplying this name.
      </td>
    </tr>
