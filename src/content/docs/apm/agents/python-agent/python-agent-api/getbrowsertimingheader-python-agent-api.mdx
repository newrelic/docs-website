...
In versions 9.3.0 and below, the [`get_browser_timing_footer`](/docs/agents/python-agent/python-agent-api/get_browser_timing_footer) API was also required to enable browser timing. Starting with version 9.4.0+ this is no longer required.
</Callout>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Optional. The per-request, cryptographic nonce used by Content-Security-Policy policies.
      </td>
    </tr>
  </tbody>
</table>
