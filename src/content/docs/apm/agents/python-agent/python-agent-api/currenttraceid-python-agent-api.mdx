...
type: apiDoc
shortDescription: Returns the trace ID of the current transaction.
tags:
  - Agents
  - Python agent
  - Python agent API
...
Use `current_trace_id` to retrieve the trace ID of the current [transaction](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#transaction).
