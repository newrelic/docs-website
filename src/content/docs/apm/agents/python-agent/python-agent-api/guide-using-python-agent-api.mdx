...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Add [custom attributes](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#attribute) to your transactions using [`add_custom_attribute`](/docs/agents/python-agent/python-agent-api/add_custom_attribute), or use other API calls to [report custom data](#custom-data).
      </td>
    </tr>
