...
These API calls allow you to collect performance data on your message-passing architecture or service; for example, [<DoNotTranslate>RabbitMQ</DoNotTranslate>>](https://www.rabbitmq.com/). To use these calls, make sure you have <DoNotTranslate>Python</DoNotTranslate>> [agent version 2.88.0.72 or higher](/docs/release-notes/agent-release-notes/python-release-notes).
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * To get a reference to <DoNotTranslate>**all**</DoNotTranslate> settings, including [server-side configuration](/docs/agents/manage-apm-agents/configuration/configure-agent#ssc) from our UI, use [`application_settings`](/docs/agents/python-agent/python-agent-api/application_settings).
      </td>
    </tr>
