...
* <DoNotTranslate>**The wrapper:**</DoNotTranslate> The wrapper call is `ASGIApplicationWrapper`. You can use the wrapper in more than one place for distinct ASGI application components that may be stacked. In that case, the first wrapper encountered marks the start of the transaction and the agent determines the target app based on that first wrapper (and ignores subsequent ones).
* <DoNotTranslate>**The path-based wrapper:**</DoNotTranslate> The path-based wrapper call is `wrap_asgi_application`. Use this if you could not reference the ASGI object as a variable in the instrumentation scope. This takes the same parameters as the decorator with additional `module` and `object_path` parameters.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <DoNotTranslate>**Required**</DoNotTranslate>. The ASGI object to be wrapped.
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <DoNotTranslate>**Required**</DoNotTranslate>. The module containing the ASGI object.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <DoNotTranslate>**Required**</DoNotTranslate>. Represents the class method or method for finding the ASGI object within a file.
      </td>
    </tr>
  </tbody>
</table>
