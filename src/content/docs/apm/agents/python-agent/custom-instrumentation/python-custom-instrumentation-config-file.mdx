...
<CollapserGroup>
  <Collapser
    ...
    title="Using dumbdbm"
  >
    In this example, you use the Python <DoNotTranslate>**`dumbdbm`**</DoNotTranslate> module and want to instrument the time it took to open a database, and then to write that database back to a file. In this case you would use:
...
* Multiple lines: Follow the <DoNotTranslate>**ini**</DoNotTranslate> file convention to indent the subsequent lines.
