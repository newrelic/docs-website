...
Upgrade your <DoNotTranslate>**newrelic.ini**</DoNotTranslate> configuration file when you upgrade to Python agent <DoNotTranslate>**2.56.0.42**</DoNotTranslate> or higher. For more information about deprecated configuration settings, see [Enabling and disabling attributes](/docs/agents/python-agent/attributes/enabling-disabling-attributes-python#deprecated).
