...
<CollapserGroup>
  ...
  >
    ...
    All attribute keys in this list will <DoNotTranslate>**not**</DoNotTranslate> be sent.
  </Collapser>
  ...
  >
    ...
    All attribute keys in this list will <DoNotTranslate>**not**</DoNotTranslate> be sent in transaction traces.
  </Collapser>
  ...
  >
    ...
    All attribute keys in this list will <DoNotTranslate>**not**</DoNotTranslate> be sent in traced errors.
  </Collapser>
  ...
  >
    ...
    All attribute keys in this list will <DoNotTranslate>**not**</DoNotTranslate> be sent in transaction events.
  </Collapser>
  ...
  >
    ...
    All attribute keys found in this list will <DoNotTranslate>**not**</DoNotTranslate> be sent in page views.
  </Collapser>
</CollapserGroup>
...
<table>
  <thead>
    <tr>
      <th width={200}>
        <DoNotTranslate>**Deprecated setting**</DoNotTranslate>
      </th>

      <th>
        <DoNotTranslate>**New setting**</DoNotTranslate>
      </th>
    </tr>
  </thead>
