...
1. Follow standard procedures to [install the Python agent](/docs/agents/python-agent/getting-started/python-agent-quick-start#install), including your [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key).
