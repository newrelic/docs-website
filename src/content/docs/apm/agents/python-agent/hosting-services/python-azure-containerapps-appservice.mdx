...
<CollapserGroup>
    <Collapser
        id="add-via-console"
        title="Add the Python agent from the console"
    >
    
    This command installs the Python agent to an example Flask app: 
    ...
    <Collapser
        id="add-via-docker"
        title="Add the Python agent to a Dockerfile"
    >
    ...
    ## Initialize the agent on app start-up [#initialize-agent]
...
Once you've installed the Python agent, we recommend configuring your app in either the Azure App Service or Container Apps portal, depending on the service you're using. You can update your app settings through the Azure UI, or using the Python SDK CLI. 

<CollapserGroup>
    <Collapser
        id="config-app-services-ui"
        title="Configure your app in Azure App Services"
    >
...
5. Restart your Python app.
    ...
    <Collapser
        ...
        title="Configure your app in Azure Container Apps"
    >
1. Sign in to <DNT>**[portal.azure.com](https://portal.azure.com)**</DNT>.
