...
Microsoft Azure offers two platform services that manage your web or containerized apps. You can install the Python agent into both [Microsoft Azure App Service](https://learn.microsoft.com/en-us/azure/app-service/overview) and [Azure Container Apps](https://learn.microsoft.com/en-us/azure/container-apps/overview), which helps you track how Microsoft Azure manages app resource consumption, performance, and HTTP traffic. 
...
* Installing the [Azure SDK for Python](https://github.com/Azure/azure-sdk) in your environment
