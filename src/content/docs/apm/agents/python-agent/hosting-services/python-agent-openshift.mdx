...
1. Add the agent configuration file <DNT>**newrelic.ini**</DNT> to the root directory of your project repository that you are pushing up to OpenShift. This should contain a `[newrelic]` section along with just the specific configuration setting you need to set. For example:
