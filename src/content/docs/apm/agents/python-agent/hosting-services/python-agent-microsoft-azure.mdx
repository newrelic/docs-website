---
title: Python agent on Microsoft Azure container and service apps
...
Learn about special considerations for using Microsoft Azure container apps and app services as a hosting service with New Relic's Python agent. 
