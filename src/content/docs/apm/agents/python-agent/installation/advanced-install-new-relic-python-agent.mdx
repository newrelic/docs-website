...
* Have your New Relic [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key). (If you don't have one already, [sign up for a New Relic account](https://newrelic.com/signup).)
...
After you install the package, the `newrelic-admin script` will be in the same directory as the Python executable. To create the agent config file, run this command in the Python executable's directory and include your [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key):
