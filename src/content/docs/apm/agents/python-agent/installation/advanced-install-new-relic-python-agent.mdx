...
* Have your New Relic account's [license key](/docs/apis/intro-apis/new-relic-api-keys/#ingest-license-key). (If you do not have one already, [sign up for a New Relic account](https://newrelic.com/signup).)
...
For more details about using the admin script, see [Running the admin script from command line](/docs/agents/python-agent/installation-configuration/python-agent-integration#wrapper-script). If you cannot use the admin script method or do not want to, see the [manual integration method](/docs/agents/python-agent/installation-configuration/python-agent-integration#manual-integration).
