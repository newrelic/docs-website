    ...
    <tr>
      ...
      <td>
        **Proxy settings:**
        ...
        If you are updating from an older agent version and your config file doesn't include `proxy_scheme`, ensure you add the setting and set it appropriately. If you do not, the agent will continue to base the protocol scheme on the SSL setting for backwards compatibility.
