...
3. If you use a package manager, remove files specific to the manager:
   ...
   <CollapserGroup>
     ...
     >
       ...
       Using <DoNotTranslate>**`rpm` (32-bit)**</DoNotTranslate>:
       ...
       Using <DoNotTranslate>**`rpm` (64-bit)**</DoNotTranslate>:
     ...
     >
       ...
       Using <DoNotTranslate>**`dpkg` (32-bit)**</DoNotTranslate>:
       ...
       Using <DoNotTranslate>**`dpkg` (64-bit)**</DoNotTranslate>:
