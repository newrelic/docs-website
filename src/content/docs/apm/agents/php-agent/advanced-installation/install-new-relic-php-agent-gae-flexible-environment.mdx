...
<CollapserGroup>
  ...
  >
    ...
    RUN wget -O- https://download.newrelic.com/<NEW_KEY_ID>.gpg | sudo gpg --import --batch --no-default-keyring --keyring /usr/share/keyrings/download.newrelic.com-newrelic.gpg
