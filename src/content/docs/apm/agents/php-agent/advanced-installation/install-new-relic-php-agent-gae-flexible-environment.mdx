...
<CollapserGroup>
  ...
  >
    ...
    3. To view your GAE flex app data in New Relic, go to the [APM <DoNotTranslate>**Overview**</DoNotTranslate> page](/docs/apm/applications-menu/monitoring/apm-overview-page).
  </Collapser>
</CollapserGroup>
