...
<CollapserGroup>
  ...
  >
    1. Follow standard procedures to [install the New Relic PHP agent](/docs/agents/php-agent/installation/php-agent-installation-overview) for your specific app server, and obtain your [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key).
  ...
  >
    In this example, the Dockerfile extends the generic PHP image with application files for a single application in Debian. You can add your [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) directly to your Dockerfile, or use an environment variable in your `docker run` command.
