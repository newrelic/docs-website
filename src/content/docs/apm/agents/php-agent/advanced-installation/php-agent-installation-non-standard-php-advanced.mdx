...
2. Replace the license key setting in your `newrelic.ini` file with your [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key). Also change any other sessions as needed (for example, `newrelic.appname`).
