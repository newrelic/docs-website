...
6. Examine your web server/dispatcher logfiles (<DoNotTranslate>**not**</DoNotTranslate> `newrelic`) to help determine the issue. If you still need assistance, get support at [support.newrelic.com](https://support.newrelic.com).
...
Generate some traffic on your app, then wait for three to five minutes for results to arrive in your [APM <DoNotTranslate>**Summary**</DoNotTranslate> page](/docs/apm/apm-ui-pages/monitoring/apm-summary-page-view-transaction-apdex-usage-data/).
