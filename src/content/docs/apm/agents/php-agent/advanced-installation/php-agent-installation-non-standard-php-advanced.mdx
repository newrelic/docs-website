...
2. Replace the license key setting in your `newrelic.ini` file with your <LicenseKey />. Also change any other sessions as needed (for example, `newrelic.appname`).
