...
<CollapserGroup>
  ...
  >
    Invoke install mode by using <DoNotTranslate>**one**</DoNotTranslate> of these methods:
  ...
  >
    ...
    <DoNotTranslate>**Example:**</DoNotTranslate> The menu shows seven options:
  ...
  >
    After you install New Relic successfully and restart your web server, you can begin gathering data about your applications. After a few minutes, data will begin to appear on your [APM <DoNotTranslate>**Summary**</DoNotTranslate> page](/docs/apm/apm-ui-pages/monitoring/apm-summary-page-view-transaction-apdex-usage-data/).
...
<CollapserGroup>
  ...
  >
    ...
    This will remove all the configuration files and any links created at installation time. This will <DoNotTranslate>**not**</DoNotTranslate> affect any configuration parameters placed in files such as `php.in`. Also, this will <DoNotTranslate>**not**</DoNotTranslate> remove the software packages installed on the system.
