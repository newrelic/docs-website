...
For the PHP agent, we offer two types of distributed tracing (for more, see [How span sampling works](/docs/understand-dependencies/distributed-tracing/get-started/how-new-relic-distributed-tracing-works#sampling)):
