...
<CollapserGroup>
  ...
  >
    ...
    Span events are reported for [distributed tracing](#inivar-distributed-enabled). This value sets the maximum number of span events added to the span event reservoir per transaction. A value of 0 will use the agent default of 2000. The maxium setting is 10000..
  </Collapser>
