...
<CollapserGroup>
  ...
  >
    ...
    Seting this to `0` will effectively disable the sending of custom events. Setting [`newrelic.custom_insights_events.enabled`](#inivar-custom-events-enabled) is the preferred way to enable or disable custom event generation.
