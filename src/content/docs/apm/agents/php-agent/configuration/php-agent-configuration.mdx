...
Starting with the PHP agent 10.1.0 release, support for [logs in context](/docs/apm/new-relic-apm/getting-started/get-started-logs-context]) has been added directly to the agent, making it easy to use for [supported logging frameworks](/docs/logs/logs-context/configure-logs-context-php).
