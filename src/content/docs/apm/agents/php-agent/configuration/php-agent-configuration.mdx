...
Starting with the PHP agent 10.1.0 release, support for [logs in context](/docs/logs/logs-context/java-configure-logs-context-all) has been added directly to the agent, making it easy to use for [supported logging frameworks](/docs/logs/logs-context/configure-logs-context-php).
