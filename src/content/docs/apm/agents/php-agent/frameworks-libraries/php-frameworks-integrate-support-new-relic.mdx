...
* <DNT>**Recommendation:**</DNT> If your framework has a central function that generates all page headers and footers, install the JavaScript code here.
...
<CollapserGroup>
  ...
  >
    ...
    <DNT>**Recommendation:**</DNT> Insert the footer immediately before the `</body>` page close tag as the very last thing on the generated page.
