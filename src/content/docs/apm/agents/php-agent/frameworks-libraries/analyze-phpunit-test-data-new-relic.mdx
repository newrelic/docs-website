...
<DoNotTranslate>**Recent unsuccessful suites:**</DoNotTranslate>

```sql
SELECT latest(timestamp), latest(name) FROM TestSuite WHERE successful IS false FACET runId
```

<DoNotTranslate>**Last unsuccessful suite:**</DoNotTranslate>
...
<DoNotTranslate>**Last unsuccessful test:**</DoNotTranslate>
...
<CollapserGroup>
  ...
  >
    <DoNotTranslate>**TestSuite**</DoNotTranslate> events include the following attributes:
  ...
  >
    <DoNotTranslate>**Test**</DoNotTranslate> events include the following attributes:
    ...
    <table>
      ...
      <tbody>
        ...
        <tr id="test-message">
          ...
          <td>
            Any message associated with the test outcome. For example: <DoNotTranslate>**Failed asserting that false is true**</DoNotTranslate> or <DoNotTranslate>**This test depends on 'StackTest::testFailure' to pass.**</DoNotTranslate>.
          </td>
        </tr>
        ...
        <tr id="test-outcome">
          ...
          <td>
            The outcome of the test. Options include <DoNotTranslate>**passed**</DoNotTranslate>, <DoNotTranslate>**failed**</DoNotTranslate>, <DoNotTranslate>**skipped**</DoNotTranslate>, <DoNotTranslate>**risky**</DoNotTranslate>, <DoNotTranslate>**warning**</DoNotTranslate>, and <DoNotTranslate>**incomplete**</DoNotTranslate>.
          </td>
        </tr>
