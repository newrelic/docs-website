...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > APM > (selected app) > Overview > Web transactions time**: Sequential requests with Guzzle in the New Relic UI.
</figcaption>
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > APM > (selected app) > Summary > Web transactions time**: Parallel requests with Guzzle in the New Relic UI
</figcaption>
