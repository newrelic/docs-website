...
New Relic supports versions 5, 6 and 7 of the <DNT>**Guzzle HTTP client library**</DNT> with [New Relic PHP agent version 7.0](/docs/release-notes/agent-release-notes/php-release-notes) or higher.
