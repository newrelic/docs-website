...
After a successful setup, it can take up to fifteen minutes before metrics begin to appear in New Relic. To view your [APM **Summary** page](/docs/apm/applications-menu/monitoring/applications-overview-dashboard): Go to **[one.newrelic.com](https://one.newrelic.com) > APM > (select your app)**.
