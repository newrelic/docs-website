---
title: AWS <DNT>Elastic Beanstalk</DNT> installation for PHP
tags:
  - Agents
  - PHP agent
  - Frameworks and libraries
metaDescription: Directions for installing the New Relic PHP agent with <DNT>Elastic Beanstalk</DNT>.
redirects:
...
To install New Relic's PHP agent on AWS <DNT>Elastic Beanstalk</DNT>:
...
5. Push your app to <DNT>Elastic Beanstalk</DNT>:
