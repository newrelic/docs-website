...
Before you install New Relic's PHP agent, make sure you have a supported [Amazon Web Services account](http://aws.amazon.com/elasticbeanstalk/ "Link opens in a new window"). In addition, for any New Relic installation, you will need your New Relic <LicenseKey />. This is a 40-character hexadecimal string that New Relic provides when you [sign up](http://newrelic.com/signup "Link opens in a new window") for your account.
...
4. Replace `INSERT_LICENSE_KEY` with your New Relic <LicenseKey />.
