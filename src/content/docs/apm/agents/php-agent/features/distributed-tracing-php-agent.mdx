...
Distributed tracing is available for services instrumented with the New Relic APM agent for PHP. When you enable this feature for each of your services, you can see the entire journey of your requests throughout a [distributed system](/docs/distributed-tracing/concepts/introduction-distributed-tracing). Here are several ways to begin using the power of distributed tracing:
