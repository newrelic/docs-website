...
5. If `newrelic` does appear in your modules list, verify that the `license.key` entry shows the first and last few characters of your [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key)
