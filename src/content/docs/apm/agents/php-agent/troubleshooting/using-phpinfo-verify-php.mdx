...
5. If `newrelic` does appear in your modules list, verify that the `license.key` entry shows the first and last few characters of your [license key.](https://docs.newrelic.com/docs/accounts-partnerships/accounts/account-setup/license-key#finding)
