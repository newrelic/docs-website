...
To reinstall the agent, follow the [installation instructions](/docs/agents/php-agent/installation/php-agent-installation-overview) for your platform, or use the `newrelic-install install` command to start the <DoNotTranslate>**[newrelic-install script](/docs/agents/php-agent/advanced-installation/using-newrelic-install-script)**</DoNotTranslate>.
