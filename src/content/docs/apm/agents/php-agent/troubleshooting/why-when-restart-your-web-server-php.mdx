...
<CollapserGroup>
  ...
  >
    Configuration changes in `newrelic.ini` or <DoNotTranslate>**`newrelic.cfg`**</DoNotTranslate> files [do not take effect](/docs/agents/php-agent/troubleshooting/ini-settings-not-taking-effect-immediately) (for example, naming your app, generating logs, changing your license key) until you restart the web server.
  </Collapser>
