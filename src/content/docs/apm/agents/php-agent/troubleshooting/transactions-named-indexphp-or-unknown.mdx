...
<Callout variant="tip">
  <DoNotTranslate>**Note:**</DoNotTranslate> Do not name your transactions with values that change often, such as user IDs, hashes, and so on. Implement [useful transaction naming](/docs/agents/php-agent/features/php-frameworks-integrating-support-new-relic) in your API calls.
</Callout>
