...
The **newrelic** module appears in your `phpinfo()` page but no data is appearing in your UI and your [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) does not appear there.
