...
* <DNT>**Recommendation:**</DNT> If you have long or infrequent processes, run a cron job every five minutes with a simple transaction, such as `phpinfo()`. This will help ensure the application does not enter an idle state.
