...
If you are <DoNotTranslate>**using a third party error handler**</DoNotTranslate> (for example: [XDebug](https://xdebug.org/) or [Laravel's error handler)](https://laravel.com/docs/5.2/errors):
...
If you are <DoNotTranslate>**not using a third party error handler**</DoNotTranslate>, but you still do not see expected errors (for example: 404 errors):
