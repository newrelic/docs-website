...
<CollapserGroup>
  ...
  <Collapser title="Failure with the manual install process">
    Using the [manual install process](/docs/agents/php-agent/advanced-installation/php-agent-installation-non-standard-php-advanced#manual) with the install utility **nrmaninstall.php**, or following the manual instructions, you encounter something similar to this:
