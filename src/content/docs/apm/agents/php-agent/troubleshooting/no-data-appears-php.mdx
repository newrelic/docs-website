...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Check `phpinfo()` to [verify that you installed the PHP agent](/docs/agents/php-agent/troubleshooting/using-phpinfo-verify-php) and that the <LicenseKey /> in it is correct.
      </td>
    </tr>
