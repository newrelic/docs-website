  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        If there are specific attribute keys that you do <DoNotTranslate>**not**</DoNotTranslate> want to send to New Relic in transaction traces, identify them using `newrelic.attributes.exclude`. This restricts the information sent to New Relic.
