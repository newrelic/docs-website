---
title: How the PHP daemon works
tags:
  - Agents
  - PHP agent
  - Getting started
...
* [Starting the PHP daemon (advanced)](/docs/apm/agents/php-agent/advanced-installation/starting-php-daemon-advanced) — Control daemon startup mode and external launch options.
* [Proxy daemon settings](/docs/apm/agents/php-agent/configuration/proxy-daemon-newreliccfg-settings) — Configure the daemon's connection, timeouts, and logging via `newrelic.cfg`.
