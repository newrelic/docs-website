...
When the daemon is in an initial or idle state, <DoNotTranslate>**two**</DoNotTranslate> transactions must occur before it will start reporting.

In an <DoNotTranslate>**initial**</DoNotTranslate> state:
...
In an <DoNotTranslate>**idle**</DoNotTranslate> state:
...
* <DoNotTranslate>**Recommended process:**</DoNotTranslate> Use `/etc/init.d/newrelic-daemon stop`. This is the preferred method for interacting with the daemon.
