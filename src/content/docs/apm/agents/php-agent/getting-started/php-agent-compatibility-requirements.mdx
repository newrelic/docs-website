...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
          <Callout variant="important">
            ARM64 is supported on Amazon Linux 2 (including AWS Graviton 2) and Centos 8 with the following agents ONLY when compiled from source:

            * PHP 8.0 and with New Relic PHP Agent 9.18.1 - 10.9.0.
            * PHP 8.1 and with New Relic PHP Agent 9.19.0 - 10.9.0.
            * PHP 8.2 and with New Relic PHP Agent 10.7.0 - 10.9.0.

	    ARM64 binary support is provided for PHP 8.0, 8.1, and 8.2 ONLY with the New Relic PHP Agent 10.10.0 or later.
          </Callout>
