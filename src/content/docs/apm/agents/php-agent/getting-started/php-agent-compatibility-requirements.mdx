...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                [Just-In-Time compilation](https://php.watch/articles/jit-in-depth) is supported as of agent release 11.0. JIT is automatically disabled for any earlier versions of the PHP Agent.
