...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
          <Callout variant="important">
            ARM64 is supported on Amazon Linux 2 (including AWS Graviton 2) and Centos 8 the following agents ONLY when compiled from source:
	    ...
	    ARM64 binary support is provided for PHP 8.0, 8.1, and 8.2 with the New Relic PHP Agent 10.10.0 or later.
          </Callout>
