...
See [PHP agent release notes](/docs/release-notes/agent-release-notes/php-release-notes/) for the latest PHP agent release.
  ...
  * For PHP builds that are compiled with Zend Thread Safety (ZTS), only [PHP agent 9.19](/docs/release-notes/agent-release-notes/php-release-notes/php-agent-9190309) and earlier supports these builds.
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        PHP versions 7.0 - 7.4 and 8.0 - 8.2 report code-level metrics (starting with release 10.4.0).
      </td>
    </tr>
