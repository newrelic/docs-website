...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <Callout variant="important">
        New Relic PHP Agent 10.10.0 or later provides support for ARM64 by including binaries in tarball distribution.
      </Callout>
      <Callout variant="important">
        New Relic PHP Agent 9.18.1 - 10.9.0 source distribution provides ARM64 support ONLY on Amazon Linux 2 (including AWS Graviton 2) and Centos 8.
      </Callout>
