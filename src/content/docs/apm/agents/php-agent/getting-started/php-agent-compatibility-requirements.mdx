    ...
    <tr>
      ...
      <td>
        ...
        * Red Hat Enterprise Linux (RHEL) 6 or higher
         ...
         <Callout variant="important">
            As of March 2022, we deprecated support for Red Hat Enterprise Linux (RHEL) 6. For more information, see our [PHP agent release notes v9.20.0](/docs/release-notes/agent-release-notes/php-release-notes/php-agent-9200310).  It will no longer be supported in June 2022.
          </Callout>
        ...
        * CentOS 6 or higher
         ...
         <Callout variant="important">
            As of March 2022, we deprecated support for Centos 6. For more information, see our [PHP agent release notes v9.20.0](/docs/release-notes/agent-release-notes/php-release-notes/php-agent-9200310).  It will no longer be supported in June 2022.
          </Callout>
