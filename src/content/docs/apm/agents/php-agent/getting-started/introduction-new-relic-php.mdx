...
Our PHP agent auto-instruments your code so you can identify and solve performance issues. With performance monitoring, you can collect and analyze business data to improve customer experience and make data-driven business decisions. 
...
2. Doublecheck that your system meets the [PHP agent's compatibility and requirements](/docs/apm/agents/php-agent/getting-started/php-agent-compatibility-requirements).
