...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM > (select an app) > Summary**: After installing the PHP agent, view a summary of your app's performance.
</figcaption>
