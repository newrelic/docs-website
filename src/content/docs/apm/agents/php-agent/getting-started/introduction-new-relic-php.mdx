...
<DNT>**View logs for your infrastructure data**</DNT>
...
<Callout variant="tip">
  The number of applications/agents per daemon may be lower when running in separate <DNT>Docker/DNT> containers, depending on the capacity of the connection between containers.
</Callout>
