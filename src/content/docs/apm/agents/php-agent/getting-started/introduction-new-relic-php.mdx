...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & services > (select an app) > Summary**</DoNotTranslate>: After installing the PHP agent, view a summary of your app's performance.
</figcaption>
...
<DoNotTranslate>**View logs for your infrastructure data**</DoNotTranslate>
...
For <DoNotTranslate>**standard installations**</DoNotTranslate>, see:
...
For other types of PHP installations and <DoNotTranslate>**advanced installation**</DoNotTranslate> topics, see:
