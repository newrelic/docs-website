...
<Steps>
    ...
    <Step>
        ## Install our Apache integration
    ...
    <Step>
        ## Install our Elasticsearch integration
    ...
    <Step>
        ## Install our AWS Identity and Access Management (IAM) integration
        
        Install our AWS IAM integration collects metrics such as certificates per account, groups per account, MFA devices per account, roles per account, and users per account.

        To install the integration, follow the instructions in our guided install:
        1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities)** and click **Add data**.
        2. Search for "AWS" and click the **Integrate your AWS account** card. 
        3. Select an account and follow the install steps.
