...
If you need to install the integration in a different way, see [Apache monitoring integration](/docs/infrastructure/host-integrations/host-integrations-list/elasticsearch/elasticsearch-integration).
    ...
    <Step>
        ## Install the AWS Identity and Access Management (IAM) integration [#install-the-AWS-integration]
