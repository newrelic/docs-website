...
<Steps>
    ...
    <Step>
        ...
        To install the integration:
            ...
            1. Go to <DNT>**[one.newrelic.com](https://one.newrelic.com/) > Add data**</DNT>.
...
If you need to install the integration in a different way, see [Apache monitoring integration](/docs/infrastructure/host-integrations/host-integrations-list/apache-monitoring-integration).
    ...
    <Step>
        ## Install the <DNT>Elasticsearch<DNT> integration [#install-the-elasticsearch-integration]
        
        Our <DNT>Elasticsearch<DNT> integration collects metrics like cluster status and current shards. If you're using [Magento version 2.4 and higher](https://magentip.com/install-magento-2-4-x-on-ubuntu-with-elasticsearch/), you'll need to install our <DNT>Elasticsearch<DNT> integration.
...
<Step>
    ...
    ## Install the Magento business insights dashboard [#install-dashboard]
        ...
        1. Go to <DNT>**[one.newrelic.com > Add Data](https://one.newrelic.com) > Dashboards**</DNT>.
