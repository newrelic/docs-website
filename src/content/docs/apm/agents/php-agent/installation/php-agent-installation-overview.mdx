...
Follow this general process to install the agent on your system. The agent installation package or tar archive includes the interactive [<DNT>**`newrelic-install`**</DNT> script](/docs/agents/php-agent/installation/newrelic-install-script), which automates some installation tasks.
...
3. From your <DNT>**Account settings**</DNT>, copy your <InlinePopover type="licenseKey"/> information.
4. Install the agent package or tar archive on your system.
   ...
   <CollapserGroup>
     ...
     >
       The most common way to install the agent on RedHat or CentOS is with the installation package (<DNT>**.rpm**</DNT>) and the package manager. You can [tell the package manager](/docs/agents/php-agent/installation/php-agent-installation-redhat-centos#tell-rpm) to get it from the New Relic repository, or you can [download the <DNT>**.rpm**</DNT> file](/docs/agents/php-agent/installation/php-agent-installation-redhat-centos#download-rpm) directly from the New Relic website.

       [Install the package](/docs/agents/php-agent/installation/php-agent-installation-redhat-centos) with your preferred package manager (`yum` or `rpm`) and then run the <DNT>**newrelic-install**</DNT> script.
     </Collapser>
     ...
     >
       [Install the package](/docs/agents/php-agent/installation/php-agent-installation-ubuntu-debian) either with `apt-get` or with `dpkg` commands. Typically, running the <DNT>**newrelic-install**</DNT> script is not required.
     </Collapser>
