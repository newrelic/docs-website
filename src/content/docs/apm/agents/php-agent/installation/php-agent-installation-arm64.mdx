...
Building ARM64 from source is only supported for Amazon Linux 2 and CentOS Linux 8 (including use with **[AWS Graviton 2 processor](https://aws.amazon.com/ec2/graviton/)**)
