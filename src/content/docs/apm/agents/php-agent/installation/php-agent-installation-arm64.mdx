...
1. Copy the ```agent/scripts/newrelic.ini.template``` file in the same location as your php.ini (Running php --ini will tell you where that is).
2. Once your newrelic.ini is created and in the correct location, edit the file and add the following:
