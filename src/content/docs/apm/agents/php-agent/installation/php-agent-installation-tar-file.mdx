...
<Callout variant="tip">
  The package name for the New Relic's PHP agent is `newrelic-php5`. Although the package name references PHP 5, this package works for all [supported PHP versions](/docs/agents/php-agent/getting-started/php-agent-compatibility-requirements#php-release).
</Callout>
