...
You have basic APM data flowing. To get the full observability picture, enable these features:

* **[Distributed tracing](/docs/apm/agents/php-agent/configuration/distributed-tracing-php-agent)** — See requests flowing across all your services end-to-end.
* **[Browser monitoring](/docs/apm/agents/php-agent/features/browser-monitoring-php-agent)** — Correlate back-end performance with real-user front-end experience.
* **[Logs in context](/docs/logs/logs-context/configure-logs-context-php/)** — See log messages alongside your errors and traces without switching tools.
* **[Code-level metrics](/docs/apm/agents/php-agent/features/php-code-level-metrics)** — View APM data inline in your IDE.
* **[Custom instrumentation](/docs/apm/agents/php-agent/features/php-custom-instrumentation)** — Capture transactions not covered by automatic instrumentation.
* **[Framework-specific setup](/docs/apm/agents/php-agent/frameworks-libraries)** — Extra configuration for Laravel, WordPress, Drupal, and others.
