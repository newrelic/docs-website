...
<Steps>
  <Step>
    ...
    #### 2. Trust the New Relic GPG key [#trust-key]
  ...
  <Step>
    ...
    <Callout variant="important">
      ...
      ```
      please make sure you have the correct New Relic GPG key installed. See the [Trust the New Relic GPG key](#trust-key) section for instructions how to install the New Relic GPG key.
    </Callout>
  </Step>
