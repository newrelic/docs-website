    ...
    <tr>
      ...
      <td>
        **Configure your application name and New Relic license key.**
        ...
        The installation process prompts for your application name and license key. Your [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) appears in the account information section of **Account settings**. For headless installations, you can also [preseed your license key and application name by using `debconf`](#preseeding).
      </td>
    </tr>
...
For headless installations, you can preseed your [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) and [application name](/docs/site/naming-your-application). You must use the default php5 packages provided by your distribution. To preseed, set values in your `debconf` database by using [`debconf-set-selections`](http://manpages.ubuntu.com/manpages/trusty/en/man1/debconf-set-selections.1.html).
  ...
  <tbody>
    ...
    <tr>
      <td>
        ...
        Your [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key). This string sets [`newrelic.license`](/docs/php/php-agent-phpini-settings#inivar-license) in your `newrelic.ini`.
      </td>
