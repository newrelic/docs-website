...
To update via <DoNotTranslate>**tar archive**</DoNotTranslate>, follow the [tar archive installation procedures](/docs/agents/php-agent/installation/php-agent-installation-tar-file). (Procedures to install and update with the tar archive are the same.)
     ...
     >
       <table>
         ...
         <tbody>
           <tr>
             <td>
               <DoNotTranslate>**yum**</DoNotTranslate>
             </td>
           ...
           <tr>
             <td>
               <DoNotTranslate>**32-bit rpm**</DoNotTranslate>
             </td>
           ...
           <tr>
             <td>
               <DoNotTranslate>**64-bit rpm**</DoNotTranslate>
             </td>
     ...
     >
       <table>
         ...
         <tbody>
           <tr>
             <td>
               <DoNotTranslate>**apt-get**</DoNotTranslate>
             </td>
           ...
           <tr>
             <td>
               <DoNotTranslate>**32-bit dpkg**</DoNotTranslate>
             </td>
           ...
           <tr>
             <td>
               <DoNotTranslate>**64-bit dpkg**</DoNotTranslate>
             </td>
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <DoNotTranslate>**TLS replaces the `newrelic.daemon.ssl` ini setting.**</DoNotTranslate>
    ...
    <tr>
      ...
      <td>
        ...
        <DoNotTranslate>**PHP 5.2 is no longer supported.**</DoNotTranslate>
    ...
    <tr>
      ...
      <td>
        ...
        <DoNotTranslate>**Daemon command line flags have been renamed.**</DoNotTranslate>

        For customers who start the daemon manually, you can find the <DoNotTranslate>**newly renamed command line flags**</DoNotTranslate> with the `-h` or `--help` flags. The <DoNotTranslate>**following old flags will be removed**</DoNotTranslate> in a future release:
