...
Even though the package name for the PHP agent refers to PHP 5, the package works for all [supported PHP versions](/docs/agents/php-agent/getting-started/php-agent-compatibility-requirements#php-release), including PHP 8.0 and PHP 8.1 versions.
