...
Our PHP agent auto-instruments your code so you can start monitoring applications. Follow this procedure to install New Relic's PHP agent for APM using Amazon Linux 2, RedHat, or CentOS. <DoNotTranslate>**Exception:**</DoNotTranslate> If you have an earlier version installed, [upgrade the agent](/docs/agents/php-agent/installation/upgrading-php-agent) instead.
...
2. Use either of the following ways to obtain the installation package:
   ...
   <CollapserGroup>
     ...
     >
       For <DoNotTranslate>**32-bit**</DoNotTranslate> systems, run:

       ```bash
       sudo rpm -Uvh http://yum.newrelic.com/pub/newrelic/el5/i386/newrelic-repo-5-3.noarch.rpm
       ```

       For <DoNotTranslate>**64-bit**</DoNotTranslate> systems, run:
     ...
     >
       For <DoNotTranslate>**32-bit**</DoNotTranslate> systems, download these three files from the [32-bit packages](https://download.newrelic.com/pub/newrelic/el5/i386/) (replacing `X.X.X.X` with the most recent [PHP agent version number](/docs/release-notes/agent-release-notes/php-release-notes)):
       ...
       * ```
         ...
         For <DoNotTranslate>**64-bit**</DoNotTranslate> systems, download these three files from the [64-bit packages](https://download.newrelic.com/pub/newrelic/el5/x86_64/) (replacing `X.X.X.X` with the most recent [PHP agent version number](/docs/release-notes/agent-release-notes/php-release-notes)):
...
3. Install the agent and daemon using your preferred package manager:
   ...
   <CollapserGroup>
     ...
     <Collapser
       ...
       title="tarball"
     >
       If <DoNotTranslate>**yum**</DoNotTranslate> and <DoNotTranslate>**rpm**</DoNotTranslate> do not work with your host config, [install from the binary tarball](/docs/php/php-agent-installation-tar-files).
     </Collapser>
   </CollapserGroup>
