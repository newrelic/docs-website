  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        If the value given is a <DoNotTranslate>**float**</DoNotTranslate> with a value of NaN, Infinity, denorm or negative zero, the behavior of this function is undefined. For other floating point values, the agent may discard 1 or more bits of precision (ULPs) from the given value.
      </td>
    </tr>
  </tbody>
</table>
