...
* <DoNotTranslate>**PHP version 5 or lower**</DoNotTranslate>: You must pass a valid PHP <DoNotTranslate>**Exception**</DoNotTranslate> class.
* <DoNotTranslate>**PHP version 7 or higher**</DoNotTranslate>: You must pass a valid PHP <DoNotTranslate>**Throwable**</DoNotTranslate> interface.
...
<DoNotTranslate>**PHP version 5.6 or higher**</DoNotTranslate>: Make the PHP agent notice errors from within your own error handler.
...
<DoNotTranslate>**PHP version 5.5 or lower**</DoNotTranslate>: Make the PHP agent notice errors from within your own error handler.
