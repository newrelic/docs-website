...
Records a datastore segment. Datastore segments appear in the <DNT>**Breakdown table**</DNT> and <DNT>**Databases**</DNT> tab of the [Transactions page](/docs/apm/applications-menu/monitoring/transactions-page) in the New Relic UI.
