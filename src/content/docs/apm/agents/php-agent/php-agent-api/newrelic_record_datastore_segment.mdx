...
Records a datastore segment. Datastore segments appear in the <DoNotTranslate>**Breakdown table**</DoNotTranslate> and <DoNotTranslate>**Databases**</DoNotTranslate> tab of the [Transactions page](/docs/apm/applications-menu/monitoring/transactions-page) in the New Relic UI.
