  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        If `false` or omitted, data from the transaction <DoNotTranslate>**is**</DoNotTranslate> recorded by the daemon.

        If `true`, data from the transaction <DoNotTranslate>**is not**</DoNotTranslate> recorded by the daemon.
      </td>
    </tr>
  </tbody>
</table>
