...
This example sets an app name and keeps the existing data, but doesn't change the [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key):
