...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Required. Name your custom metrics with a <DoNotTranslate>**Custom/**</DoNotTranslate> prefix (for example, <DoNotTranslate>**Custom/MyMetric**</DoNotTranslate>). This helps the UI organize your custom metrics in one place, and it makes them easily findable via the Metric Explorer.
      </td>
    </tr>
