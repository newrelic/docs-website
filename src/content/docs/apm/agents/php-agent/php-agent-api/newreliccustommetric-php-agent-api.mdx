...
* Use [metrics and events](/docs/query-your-data/explore-query-data/data-explorer/introduction-data-explorer) to search for your custom metrics, create customizable charts, and add them to dashboards.
