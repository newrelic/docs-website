...
* Organize and analyze your data on New Relic UI pages (for example, APM's [<DoNotTranslate>**Applications index**</DoNotTranslate> page](/docs/apm/applications-menu/monitoring/view-your-applications-index), the [<DoNotTranslate>**Summary**</DoNotTranslate> page](/docs/apm/applications-menu/monitoring/apm-overview-page), the [<DoNotTranslate>**Transactions**</DoNotTranslate> page](/docs/apm/applications-menu/monitoring/transactions-page), etc.).
