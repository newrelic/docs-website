...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Optional. Defaults to the [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) set in the New Relic agent's `newrelic.ini` file.

        Provide a different [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) if you want the transaction to report to a different New Relic account. If set, this license will supersede all per-directory and global default licenses configured in INI files.
      </td>
    </tr>
  </tbody>
</table>
...
This example manually specifies the app name and the [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key):
