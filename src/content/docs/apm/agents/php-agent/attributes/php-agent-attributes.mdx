...
When upgrading to PHP agent <DoNotTranslate>**4.9**</DoNotTranslate> or higher, upgrade your configuration file. For more information about deprecated properties, see [Enabling and disabling attributes](/docs/php/php-agent-enabling-and-disabling-attributes#deprecated).
