...
<CollapserGroup>
  ...
  >
    ...
    All attribute keys in this list will <DoNotTranslate>**not**</DoNotTranslate> be sent to New Relic.
  </Collapser>
  ...
  >
    ...
    All attribute keys found in this list will <DoNotTranslate>**not**</DoNotTranslate> be sent to New Relic in page views.
  </Collapser>
  ...
  >
    ...
    All attribute keys in this list will <DoNotTranslate>**not**</DoNotTranslate> be sent to New Relic in traced errors.
  </Collapser>
  ...
  >
    ...
    All attribute keys in this list will <DoNotTranslate>**not**</DoNotTranslate> be sent to New Relic in transaction events.
  </Collapser>
  ...
  >
    ...
    All attribute keys in this list will <DoNotTranslate>**not**</DoNotTranslate> be sent to New Relic in transaction traces.
  </Collapser>
  ...
  >
    ...
    All attribute keys in this list will <DoNotTranslate>**not**</DoNotTranslate> be sent to New Relic in span events.
  </Collapser>
</CollapserGroup>
