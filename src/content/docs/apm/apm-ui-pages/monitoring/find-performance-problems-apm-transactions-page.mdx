...
The transactions page lists the selected app's transaction requests and graphs the top five transactions by wall-clock time to visually order transactions according to how much time they take to complete. The page also shows relevant [throughputs](/docs/using-new-relic/welcome-new-relic/getting-started/glossary#throughput) (requests per minute, or RPM). 
...
## Things to do from the Transactions page: basic functions
...
## Things to do from the Transactions page: deeper exploration

There are also numerous drill-down options and additional layers of detail for you to explore. You can:

* Open a detailed transaction pane for an individual transaction by clicking on them in the top 20 transactions listing
...
* To view additional details, use any of the transaction [drill-down functions](#tx_functions).
...
In addition to New Relic's standard [user interface functions](/docs/using-new-relic/user-interface-functions/view-your-data/standard-page-functions), there are also additional drill-down functions unique to the **Transactions** page. Here are the details on those functions and the data each provides. 
