...
The central chart on the transactions page shows the selected app's transaction requests and graphs the top five transactions by wall-clock time to visually order transactions according to how much time they take to complete. The page also shows relevant [throughputs](/docs/using-new-relic/welcome-new-relic/getting-started/glossary#throughput) (requests per minute, or RPM). 
...
By interacting with the main features of the page, you can:

* Look at a transaction overview showing
    * The most time consuming transaction
    * The highest average response time
    * The most dissatisfying apdex score (more on this below)
    * The highest error rate
    * The highest throughput
* View the top 20 transactions
* View web transaction data 
    * by percent of overall wall clock time
    * as a histogram
    * in a percentile chart
* View throughput data as a chart
* View [transaction traces](link) by transaction
...
There are also numerous drill-down options and additional layers of detail for you to explore. You can:

* View additional details with any of the transaction [drill-down functions](#tx_functions)
* Display a detailed transactions table by clicking [See transactions table](link)
