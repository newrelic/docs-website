...
<CollapserGroup>
  ...
  >
    ...
    If you have a multi-cluster app (an app that spans multiple clusters), when you go to the **Kubernetes** page, a summary of your clusters is displayed. To isolate a specific Kubernetes cluster, select it from the **Cluster** drop-down list. To return to a view of all clusters, click **All clusters**.
