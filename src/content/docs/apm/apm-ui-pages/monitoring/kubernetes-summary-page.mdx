...
The Kubernetes page in APM offers the following information about your Kubernetes cluster:
...
<CollapserGroup>
  ...
  >
    You can see your cluster name, deployment, and namespace. If you click the cluster name and the deployment, you'll get some details about each of them in a slide-out panel.
