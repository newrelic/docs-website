...
<CollapserGroup>
  ...
  >
    You can see your cluster name, deployment, and namespace that it's running in. If you click the deployment, you'll get details about it in a slide-out panel. In the slide-out panel, you can see
    a mini overview containing relevant information such as a count of logs and percentage of error logs in the specified time range.
