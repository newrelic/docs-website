...
To reach the recommendations center, go to <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)  > APM & Services > (select an app)**</DoNotTranslate>. Select <DoNotTranslate>**Recommendations**</DoNotTranslate> in the left navigation pane.
