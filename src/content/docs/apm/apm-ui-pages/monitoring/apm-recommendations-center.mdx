...
To reach the recommendations center, go to <DNT>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)  > APM & Services > (select an app)**</DNT>. Select <DNT>**Recommendations**</DNT> in the left navigation pane.
