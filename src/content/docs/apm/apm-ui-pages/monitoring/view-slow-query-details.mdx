...
### View slow queries in the UI [#view-in-ui]
...
1. Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & Services**</DoNotTranslate>. Select an app, then under the <DoNotTranslate>**Monitor**</DoNotTranslate> section, click <DoNotTranslate>**Databases**</DoNotTranslate>.
...
## View slow queries in GraphiQL [#view-in-graphiql]

If you'd like a more programmatic approach, you could use our NerdGraph API explorer at <DoNotTranslate>[one.newrelic.com > All capabilities > Apps > NerdGraph API explorer](https://one.newrelic.com/nerdgraph-graphiql)</DoNotTranslate>. 
