...
1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM & Services**. Select an app, then under the **Monitor** section, click **Databases**.
2. Select a database transaction.[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) >
3. If available, s[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) >the page.
