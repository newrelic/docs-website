...
1. Do one of the following:
   * Entity explorer: Go to **[one.newrelic.com](https://one.newrelic.com) > Entity explorer > (select an app) > Monitor > Databases**.
   * APM: Go to **[one.newrelic.com](https://one.newrelic.com) > APM > (select an app) > Monitor > Databases**.
