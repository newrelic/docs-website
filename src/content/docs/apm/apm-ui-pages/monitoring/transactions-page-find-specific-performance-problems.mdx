...
1. Do one of the following:
   ...
   * Go to **[one.newrelic.com](https://one.newrelic.com) > Entity explorer > (select an app) > Monitor > Transactions**.
...
<CollapserGroup>
  ...
  >
    In order to view browser information, you must [enable New Relic Browser](/docs/new-relic-browser/browser-settings). Then, to view corresponding [browser request](/docs/browser/new-relic-browser/additional-standard-features/page-views-understanding-your-sites-popularity) data, use either of these options:
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        3. To expand the transaction trace to full screen view, select the full screen <Icon style={{color: '#4392AA'}} name="maximize-2"/>
           icon.
