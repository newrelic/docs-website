...
translate:
  - jp
metaDescription: APM's Transactions page shows app, browser, and other transaction details, average response time, and throughput as requests per minute or CPU usage.
redirects:
