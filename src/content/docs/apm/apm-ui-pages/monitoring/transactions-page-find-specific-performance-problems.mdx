...
If a chart's background is light red, this indicates a time period when an alert condition's [<DNT>**Critical**</DNT> threshold](/docs/alerts/new-relic-alerts/defining-conditions/define-thresholds-trigger-alert) has been breached. To view the [incident details](/docs/alerts/alert-event-management/view-alert-event-details) in [alerts](/docs/alerts/new-relic-alerts/getting-started/introduction-new-relic-alerts), click the chart.
