...
<CollapserGroup>
  ...
  >
    ![Screenshot showing the dropdown that allows you to choose other transaction types.](src/images/trx-type-dropdown.png "trx-type-dropdown.png")
  ...
  >
    ![Transaction details tab](src/images/icon-detail-tabs_0.png "icon-detail-tabs.png")
  ...
  >
    ![Screenshot showing selectors to change the chart.](src/images/chart_type_selectors.png "chart_type_selectors.png")
  ...
  >
    ![Transaction segment with high call time count colorization](src/images/APM-transaction-high-time-colorization_0.png "APM-transaction-high-time-colorization.png")
