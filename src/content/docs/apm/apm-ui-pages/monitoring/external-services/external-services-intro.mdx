...
<figcaption>
  The thickness of the lines represents the throughput from your service to the
  upstream or downstream services. When you select a specific service, you will
  see the various endpoints making calls between the two services.
</figcaption>
