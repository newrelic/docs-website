...
The external services feature is available from the left navigation pane once you select an APM-monitored services. You can open it by going to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM & Services**. Select an app, then under the **Monitor** section, click **External services**.

## The external services map [[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) >
