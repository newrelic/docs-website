  ...
  <thead>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          The total number of calls between two services in the first view, or transactions in the drill-down views.
        </td>
      </tr>
      <tr>
        <td>
        ...
        <td>
          The number of errors per minute for calls between two services in the initial view, or transactions in the drill-down views.
        </td>
      </tr>
      <tr>
        <td>
