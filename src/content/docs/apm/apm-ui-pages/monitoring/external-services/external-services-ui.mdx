...
For example, with **Response time**, if the current time is 11 a.m. and the main time picker is **last 30 minutes** and the **Compare to** time picker is **1 hour ago**, the duration is the average from 10:30-11:00 a.m., and the **% change** compares that to the average from 9:30-10:00 a.m.
