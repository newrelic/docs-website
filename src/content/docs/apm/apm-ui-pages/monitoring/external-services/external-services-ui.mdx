...
The external services feature is available from the left navigation pane once you select a service in Explorer. You can open it by going to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM & Services**. Select an app, then under the **Monitor** section, click **External services**.
