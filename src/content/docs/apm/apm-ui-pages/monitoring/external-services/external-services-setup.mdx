...
Changing the sampling could result is some additional charges. To get an idea of how you might be affected, see how to estimate [ingest costs](/docs/data-apis/manage-data/calculate-data-ingest).
</Callout>
