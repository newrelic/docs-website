...
tags:
  ...
  - APM UI pages
  - Monitoring
metaDescription: 'New Relic APM''s External services page captures metric details about out-of-process services such as web services, cloud resources, or other network calls.'
redirects:
...
1. Do one of the following:
   * Entity explorer: Go to **[one.newrelic.com](https://one.newrelic.com) > Entity explorer > (select an app) > Monitor > External services**.
