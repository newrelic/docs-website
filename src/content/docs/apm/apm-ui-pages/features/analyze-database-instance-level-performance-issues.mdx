...
<CollapserGroup>
  ...
  >
    ...
    ![APM Databases slow query details: Database and instances information](src/images/icapm-slow-sql.png "APM Databases slow query details: Database and instances information")
  ...
  >
    ...
    ![APM transaction trace: Database and instances information](src/images/103116slow-tx-trace_0.png "APM transaction trace: Database and instances information")
...
{' '}
<Collapser id="insights-example" title="Query builder example">
  If you are using a APM agent that [supports database instance
  details](#compatibility), you can use [query
  builder](/docs/query-your-data/explore-query-data/query-builder/introduction-query-builder)
  to report on metrics, such as response time and throughput.
</Collapser>
