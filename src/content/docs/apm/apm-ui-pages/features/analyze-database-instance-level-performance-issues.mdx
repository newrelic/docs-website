...
<CollapserGroup>
  ...
  >
    To be notified about a performance issue between your app and a database instance before it adversely impacts your customers' experience, use [alerts](/docs/alerts/new-relic-alerts/getting-started/welcome-new-relic-alerts). You can create [alert policies](/docs/alerts/new-relic-alerts/configuring-alert-policies/alert-policy-workflow) that automatically [notify appropriate personnel](/docs/alerts/get-notified/intro-notifications) via PagerDuty, webhooks, etc. when problems escalate to the <DNT>**Critical**</DNT> thresholds you define.
