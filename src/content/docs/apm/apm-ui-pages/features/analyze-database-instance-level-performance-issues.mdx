...
import apmTransactionTrace:DatabaseAndInstancesInformation from 'images/103116slow-tx-trace_0.png'
...
<CollapserGroup>
  ...
  >
    ...
    <img
      src={apmTransactionTrace:DatabaseAndInstancesInformation}
