...
Click **Open in IDE** to use CodeStream to find the source of the error in your IDE. This requires that your application is associated with a [repository](/docs/codestream/start-here/codestream-new-relic/#repo-url) and a [commit SHA or release tag](/docs/codestream/start-here/codestream-new-relic/#sha).
