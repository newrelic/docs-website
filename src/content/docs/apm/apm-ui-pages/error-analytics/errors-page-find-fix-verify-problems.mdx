...
import webPortalNewRelicOne from 'images/WebPortal___New_Relic_One.png'
...
* Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM > (select an app)**, then click the **Error rate** table's title on your selected app's **Summary** page.

  OR
* Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM > (select an app) > Events > Errors**.
