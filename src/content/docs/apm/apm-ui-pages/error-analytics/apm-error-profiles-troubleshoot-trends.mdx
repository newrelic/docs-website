...
To access error profiles go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM > Errors > Error profiles**
...
1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM > (select an app) > Events > Errors**, then toggle **Show new view** so that APM shows the classic view of the **Errors** page.
