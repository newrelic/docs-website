...
You can send deployment data to a variety of webhook destinations. Simply follow the instructions for your whatever tool you're using&mdash;except Slack. If you want to use a Slack webhook, you must use the legacy New Relic Alerts app instead of the New Relic Slack app like this:
