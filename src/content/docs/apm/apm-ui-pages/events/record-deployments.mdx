    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            <DoNotTranslate>**Required**</DoNotTranslate>. A unique ID for this deployment, visible in the [Summary](/docs/apm/applications-menu/monitoring/apm-overview-page) page and on the [Deployments](/docs/apm/applications-menu/events/deployments-page) page. Can be any string, but is usually a version number or a Git checksum.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**Optional**</DoNotTranslate>. A summary of what changed in this deployment, visible in the [Deployments](/docs/apm/applications-menu/events/deployments-page) page when you select <DoNotTranslate>**(selected deployment) > Change log**</DoNotTranslate>.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**Optional**</DoNotTranslate>. A high-level description of this deployment, visible in the [Summary](/docs/apm/applications-menu/monitoring/apm-overview-page) page and on the [Deployments](/docs/apm/applications-menu/events/deployments-page) page when you select an individual deployment.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**Optional**</DoNotTranslate>. A username to associate with the deployment, visible in the [Summary](/docs/apm/applications-menu/monitoring/apm-overview-page) page and on the [Deployments](/docs/apm/applications-menu/events/deployments-page) page.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <DoNotTranslate>**Optional**</DoNotTranslate>. When the deployment occurred, down to the second. If not specified, the deployment will be recorded at the time when the API call was received. Timestamp requirements:
...
* <DoNotTranslate>**All agents**</DoNotTranslate>: Use the New Relic [REST API v2](#api).
* <DoNotTranslate>**C**</DoNotTranslate>: No SDK-specific methods. Use the [REST API](#api).
* <DoNotTranslate>**Go**</DoNotTranslate>: No agent-specific methods. Use the [REST API](#api).
* <DoNotTranslate>**Java**</DoNotTranslate>: Call the [Java agent `jar`](/docs/agents/java-agent/instrumentation/recording-deployments-java-agent).
* <DoNotTranslate>**.NET**</DoNotTranslate>: Use [PowerShell and the REST API](#powershell).
* <DoNotTranslate>**Node.js**</DoNotTranslate>: No agent-specific methods. Use the [REST API](#api).
* <DoNotTranslate>**PHP**</DoNotTranslate>: Use a [PHP script](/docs/agents/php-agent/features/recording-deployments-using-php-script).
* <DoNotTranslate>**Python**</DoNotTranslate>: Use the [`record-deploy`](/docs/agents/python-agent/installation-configuration/python-agent-admin-script#record-deploy) subcommand of the `newrelic-admin` script.
* <DoNotTranslate>**Ruby**</DoNotTranslate>: Use a [Capistrano recipe](/docs/agents/ruby-agent/features/recording-deployments-ruby-agent#capistrano3).
