...
<figcaption>
  **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & services > (select an app) > Events > Thread profiler**: Use this page to define the settings for the thread profiler duration and to view the results.
</figcaption>
