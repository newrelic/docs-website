...
![This is an image of the thread profiler.](src/images/thread-profiler-session.png 'Thread profiler overview')

<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > APM > (select an app) >
  Events > Thread profiler**: Use this page to define the settings for the
  thread profiler duration and to view the results.
</figcaption>
