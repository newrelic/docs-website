...
![This is an image of the thread profiler.](./images/thread-profiler-start_1.png "thread-profiler-start.png")
...
![thread-profile-view.png](./images/thread-profile-view_0.png "thread-profile-view.png")

**[one.newrelic.com](https://one.newrelic.com) > APM > (select an app) > Events > Thread profiler > (selected profile)**: Here is an example of a call tree from a thread profile.
