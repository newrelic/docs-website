...
5. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > ([account dropdown](/docs/using-new-relic/welcome-new-relic/get-started/glossary#account-dropdown)) > Account settings > Integrations > Deploy notifications > Webhook**.
...
<Callout variant="important">
  This section and the next are for the current deployment markers UI. When you're in New Relic, if you see a banner similar to the one below, you have access to the public preview of the new UI. See these new [instructions](/docs/apm/apm-ui-pages/events/change-tracking/deployments-page-view-impact-your-app-users/) instead.
    <img
...
1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM & services > (select an app) > Events > Deployments**.
