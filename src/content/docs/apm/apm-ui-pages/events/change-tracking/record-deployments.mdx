...
After you deploy a method to create the marker, you are ready to look at your results in the UI. See [View impact on your app and users](/docs/apm/apm-ui-pages/events/change-tracking/deployments-page-view-impact-your-app-users/) for details.
