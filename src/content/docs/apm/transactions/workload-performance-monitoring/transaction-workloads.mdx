...
1. Go to <DNT>**[one.newrelic.com](https://one.newrelic.com) > APM and Services**</DNT>
2. Select your service from the <DNT>APM summary</DNT> page
3. Go to <DNT>**Transactions > Transaction Details ></DNT> Select a transaction > View transaction 360 workload**
...
- **Team assignment**: Assign teams to transaction workloads for faster alert event response.
