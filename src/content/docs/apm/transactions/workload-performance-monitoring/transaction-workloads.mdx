...
- [Navigate to the Transaction 360 view](#navigate-to-the-transaction-360-view)
- [Transaction 360 Overview](#transaction-360-overview)
- [Dynamic flow map](#dynamic-flow-map)
- [Participating and supporting entities](#participating-and-supporting-entities)
  - [APM entities](#apm-entities)
  - [Infrastructure entities](#infrastructure-entities)
  - [Browser entities](#browser-entities)
...
* **Participating entities**: Lists the services involved in the transaction workload, along with their performance metrics, including APM services, infrastructure entities, browser applications, mobile applications, databases, serverless functions, and AI models.
...
The participating entities section provides a detailed breakdown of the services and components involved in the transaction workload, including APM services, browser applications, mobile applications, databases, serverless functions, infrastructure entities, and AI models. Each entity type offers specific monitoring capabilities to help you understand performance bottlenecks and optimize your application.

### APM entities

The participating entities section provides a detailed breakdown of the services involved in the transaction workload, such as, APM Services, browser applications, mobile applications, databases, serverless functions, or infrastructure entities.
...
The database section displays three main components:
...
<CollapserGroup>
<Collapser title="Database performance charts">
...
<CollapserGroup>
<Collapser title="Database tables and drill-down capabilities">
...
<CollapserGroup>
<Collapser title="Interactive drill-down features">
...
<CollapserGroup>
<Collapser title="Database performance metrics">
...
Serverless functions have become integral components of modern application architectures, and their performance directly impacts overall transaction performance. If your application utilizes AWS Lambda functions, you can monitor their performance within the Transaction 360 view.
...
<CollapserGroup>
<Collapser title="Serverless performance charts">
...
<CollapserGroup>
<Collapser title="Transaction table (serverless-related)">
...
<CollapserGroup>
<Collapser title="Serverless functions table">
...
Transaction 360 currently supports monitoring for AWS Lambda functions:

- **AWS Lambda**: Complete monitoring for Lambda functions including custom metrics, traces, invocation patterns, and performance analytics
