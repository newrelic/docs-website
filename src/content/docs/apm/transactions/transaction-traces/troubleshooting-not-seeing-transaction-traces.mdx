...
<CollapserGroup>
  ...
  >
    Change the <DNT>**Threshold**</DNT> value temporarily to `0.0001` so that transactions will definitely exceed the threshold. Be sure to return this to your original setting after you start receiving transaction traces.
  </Collapser>
</CollapserGroup>
