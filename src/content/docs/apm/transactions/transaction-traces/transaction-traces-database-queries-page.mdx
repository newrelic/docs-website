...
import apmTransactionTraceDbQueriesView from '/images/apm-transaction-traces-database-queries-view.webp'
import apmTransactionTraceStacktraceView from 'images/apm-transaction-traces-stacktrace-view.webp'
