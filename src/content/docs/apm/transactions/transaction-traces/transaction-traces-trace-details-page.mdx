...
![Screenshot showing the transaction trace details screen.](src/images/trx-trace-details.png 'trx-trace-details.png')

<figcaption>
  Go to **[one.newrelic.com](https://one.newrelic.com) > APM > (select an app) >
  Monitor > Transactions > (select a transaction trace) > Trace details.**
</figcaption>
...
<table>
  ...
  <tbody>
    <tr>
      <td>
        ![icon-database](src/images/icon-database.png "icon-database") Database queries
      </td>
    ...
    <tr>
      <td>
        ![icon-search](src/images/icon-parameters.png "icon-search") Stack traces
      </td>
    ...
    <tr>
      <td>
        ![icon-web-transaction-app](src/images/icon-webtx.png "icon-web-transaction-app") Aggregate transaction details
      </td>
...
![icon-alerts-red.png](src/images/icon-alerts-red.png 'Alerts v3: alert icons') Red: More than 25% of the total transaction time was spent in this segment.

![icon-alerts-yellow.png](src/images/icon-alerts-yellow.png 'Alerts v3: alert icons') Yellow: More than 5% of the total transaction time was spent in this segment.
