...
import apmTransactionTraceWaterfall from 'images/apm-transaction-traces-waterfall-crop.webp'

import apmTransactionTraceLatency from 'images/apm-transaction-traces-latency-crop.webp'

import apmTransactionTraceTimeline from 'images/apm-transaction-traces-timeline-crop.webp'

import apmTransactionTraceLegend from 'images/apm_transaction-traces-legend-crop.webp'

import apmTransactionTraceAppCodeSwatchfrom 'images/apm_transaction-traces-app-code-swatch.webp'
