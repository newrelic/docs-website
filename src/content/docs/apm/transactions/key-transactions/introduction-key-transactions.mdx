...
1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > All capabilities > Key transactions**.
2. Follow the tag creation instructions in [Assign tags](#assign-tags).
