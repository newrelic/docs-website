...
3. Select <DNT>**Make key transaction**</DNT> in the transaction details view. You can also automate this step by using the REST API to both create and stop tracking key transactions. 
