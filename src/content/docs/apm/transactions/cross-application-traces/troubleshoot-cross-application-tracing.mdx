...
<table>
  <thead>
    <tr>
      <th width={200}>
        <DoNotTranslate>**High throughput apps**</DoNotTranslate>
      </th>
  ...
  <tbody>
    <tr>
      ...
      <td>
        In the <DoNotTranslate>**transaction_events**</DoNotTranslate> section, adjust the [setting](/docs/agents/java-agent/configuration/java-agent-configuration-config-file#ae-max_samples_stored) for `max_samples_stored`.
      </td>
    </tr>
