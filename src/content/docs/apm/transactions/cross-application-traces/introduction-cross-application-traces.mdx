...
translate:
  - jp
metaDescription: New Relic APM's cross application tracing feature allows you to view details for applications that happen across multiple applications.
redirects:
...
New Relic APM's cross application tracing lets you link transactions between your APM-monitored applications.

## What is cross application tracing? [#feature]

<Callout variant="important">
  Instead of using cross application tracing, we recommend you consider our [distributed tracing](/docs/apm/distributed-tracing/getting-started/introduction-distributed-tracing). This is an improvement on cross application tracing and makes it easy for you to follow requests through the services of your distributed applications.
</Callout>
