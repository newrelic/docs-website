...
* APM: Go to **[one.newrelic.c[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) >** > (select an app) > **Summary**.
* Transactions:[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) >lities) > APM & Services**. Select an app, then under the **Monitor** section, click **Transactions**.
