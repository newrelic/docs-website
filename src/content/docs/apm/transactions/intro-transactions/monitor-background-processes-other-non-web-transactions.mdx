...
* Transactions: Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM & Services**. Select an app, then under the **Monitor** section, click **Transactions**.
