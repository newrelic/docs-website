...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [Distributed tracing](/docs/apm/distributed-tracing/getting-started/introduction-distributed-tracing) gives you visibility across distributed systems, showing you the path of a request as it travels between services. This feature is especially valuable for distributed systems that rely on many small services and microservices.
      </td>
    </tr>
