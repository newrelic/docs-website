...
![An image showing an example APM page.](./apm-screenshot.png "APM example")

<figcaption>View the status of all your services at a glance with APM.</figcaption>
...
Use our APM solutions to gather both current and historical information about memory usage, CPU utilization, database query performance, web browser rendering performance, app availability, error analysis, external services, and other useful metrics. We have agents for 
