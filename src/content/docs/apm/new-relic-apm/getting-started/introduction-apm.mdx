...
- What if your modern stack has dozens or even hundreds of dependencies to keep track of? Easily track them with relationships map, and external services. 
...
Monitor the basic health of your app the second New Relic receives data from your app. You will see basic <InlinePopover type="dashboards" /> on the **APM Summary** page in the New Relic UI, which you can use to quickly understand how your app is performing without any customization.
