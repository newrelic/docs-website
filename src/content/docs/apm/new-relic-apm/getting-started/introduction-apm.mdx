...
Want to first estimate costs before using APM? See our [cost estimate resource](https://developer.newrelic.com/collect-data/monitor-your-application/estimate-cost). 
