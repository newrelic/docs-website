...
Please consult our [upgrade guide](https://docs.newrelic.com/docs/logs/logs-context/upgrade-to-automatic-logs-context/) to learn more about how you can avoid sending duplicate logs.
