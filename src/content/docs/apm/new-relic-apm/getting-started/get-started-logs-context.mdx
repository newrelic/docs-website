...
metaDescription: Get relevant logs, traces, errors, and other telemetry data within the context of your app or host, without additional configuration or context switching in the New Relic One UI.
---
