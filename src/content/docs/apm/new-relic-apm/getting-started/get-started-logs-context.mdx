...
## Benefits of logs-in-context [#benefits]
...
2. Update to the [latest APM agent version](#agents).
...
If your APM agent doesn't support our automatic logs-in-context solutions yet, you can continue to use our [manual logs in context solutions](/docs/logs/logs-context/logs-in-context/#enable-logs), and forward your logs via our infrastructure agent or supported third-party forwarder.
