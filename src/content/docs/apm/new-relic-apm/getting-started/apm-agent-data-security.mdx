...
tags:
  ...
  - New Relic APM
  - Getting started
metaDescription: Learn about the default security settings for data reported by the New Relic APM agents and how you can change them.
redirects:
...
The APM [agent](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#agent) that you installed [receives data](#received) from your applications. The agent [retains the data](/docs/telemetry-data-platform/get-data-new-relic/manage-data/manage-retention-stored-data) based on your pricing tier.
