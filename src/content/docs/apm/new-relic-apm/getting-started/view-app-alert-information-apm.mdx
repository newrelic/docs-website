...
1. Do one of the following:
   * App: Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > (select an app) > Events > Violations**.
   * Key transaction: Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > More > Key transactions > (select a key transaction) > Events > Violations**.
