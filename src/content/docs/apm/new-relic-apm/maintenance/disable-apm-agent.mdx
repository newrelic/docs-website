...
<CollapserGroup>
  ...
  >
    ...
    * Use the [`enabled`](/docs/agents/go-agent/configuration/go-agent-configuration#enabled) configuration setting. Then, recompile and restart your app. (This will <DoNotTranslate>**not**</DoNotTranslate> reduce overhead because the instrumentation is still running; it will only prevent the sending of data to the [New Relic collector](/docs/using-new-relic/welcome-new-relic/getting-started/glossary#collector).)
