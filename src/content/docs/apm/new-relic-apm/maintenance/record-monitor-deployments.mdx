...
<Callout variant="tip">
  You can also use webhooks, Slack channels, and other options for [alerts notifications](/docs/alerts/new-relic-alerts/managing-notification-channels/notification-channels-control-where-send-alerts).
</Callout>
