...
<CollapserGroup>
  ...
  >
    To retrieve a list of all past deployments for your app, send a `GET` request that includes your [REST API key](/docs/apis/rest-api-v2/requirements/api-keys#rest-api-key) to the deployments endpoint. GET requests do not use a JSON payload.
