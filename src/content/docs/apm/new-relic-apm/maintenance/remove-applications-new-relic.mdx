...
Before attempting to remove an app monitored by New Relic <InlinePopover type="apm" />, <InlinePopover type="browser" />, or mobile monitoring from the UI, keep in mind:
...
<CollapserGroup>
  ...
  >
    ...
    3. To remove the APM application from the UI (and any [associated apps in browser monitoring](/docs/browser/browser-monitoring/installation/install-browser-monitoring-agent/#select-apm-app)), use the following steps:
       * **Delete the app from the UI.** Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & services > (select an app/service) > Settings > Application**, and click the **Delete application** button.
  </Collapser>
  ...
  >
    ...
    * **Delete it from the UI.** Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Browser > (select an app) > Settings > Application settings**, and click the **Delete application** button.
  </Collapser>
  ...
  >
    ...
    * **Remove it using the UI.** Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Mobile > (select an app) > Settings > Application**, and click **Delete application**.
