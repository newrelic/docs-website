...
* In Infrastructure, CPU percent usage is measured differently depending on if you are viewing CPU usage in relation to [hosts](/docs/infrastructure/infrastructure-ui-pages/hosts-new-view#systems), or to [processes](/docs/infrastructure/infrastructure-ui-pages/hosts-new-view/#processes).
