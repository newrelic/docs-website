...
tags:
  ...
  - New Relic APM
  - Troubleshooting
metaDescription: 'CPU usage metrics can differ between New Relic APM and Infrastructure. In New Relic Infrastructure, CPU usage can exceed 100%.'
redirects:
...
* In Infrastructure, CPU percent usage is measured differently depending on if you are viewing CPU usage in relation to [hosts](/docs/infrastructure/new-relic-infrastructure/infrastructure-ui-pages/infrastructure-compute-page-measure-resource-usage), or to [processes](/docs/infrastructure/new-relic-infrastructure/infrastructure-ui-pages/infrastructure-processes-page-inspect-process-performance).
...
<CollapserGroup>
  <Collapser
    ...
    title="New Relic APM"
  >
    To view your app's CPU usage: Go to **[one.newrelic.com](https://one.newrelic.com) > (select an app)** and see the **CPU usage** in the hosts list. The number of instances is listed under each host name (for example, **55 instances)**.
  ...
  >
    ...
    1. Go to **[one.newrelic.com](https://one.newrelic.com) > Infrastructure** and see **CPU %**.
