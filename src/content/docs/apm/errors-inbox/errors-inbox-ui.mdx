...
1. On the APM UI overview screen, click the <DoNotTranslate>**Errors inbox**</DoNotTranslate> option in the left-hand navigation in the triage section.
