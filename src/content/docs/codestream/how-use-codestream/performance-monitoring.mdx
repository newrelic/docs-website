...
CodeStream's code-level metrics give you detailed insight into specific pieces fo code are performing.
...
Your Python application code also needs to be monitored by the Python APM agent and your repository associated with a New Relic service.
</Callout>
