...
The **Observability section** of CodeStream allows developers to discover errors
related to code that they're responsible for, right from their IDE. In addition
to errors assigned to you, recent errors will be listed for each repository you
have open in your IDE that is associated with a service instrumented with a New
Relic APM agent.
...
Code-level foo metrics require that [distributed tracing](/docs/distributed-tracing/enable-configure/language-agents-enable-distributed-tracing) be enabled.
