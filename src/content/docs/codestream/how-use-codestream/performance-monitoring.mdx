...
import codestreamCodeLevelAnomalies from 'images/codestream_screenshot-crop_code-level-anomalies.png'
...
When hovering over a service name in the tree, click on the globe to open the service's summary page on New Relic. Click on any error to view the details, inclding the stack trace, and [start collaborating](#collaborate) on resolution.
