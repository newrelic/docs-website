...
* **Go:** Requires Go agent version 3.18.0 or higher. To turn on this feature, see [Go agent code-level metrics configuration](/docs/apm/agents/go-agent/configuration/go-agent-code-level-metrics-config). For additional information, see [Go agent code-level metrics instrumentation](/docs/apm/agents/go-agent/instrumentation/go-agent-code-level-metrics-instrument).
