...
![A screenshot of a stack trace error in errors inbox with the "Open in IDE button."](src/images/ErrorsInbox.png "A stack trace error in errors inbox with the "Open in IDE button")

<figcaption>
  When you've connected CodeStream to your New Relic One account, in errors
  inbox click **Open in IDE** to see the code that caused the error.
</figcaption>

![Error on New Relic One](src/images/ErrorOnNR1.png)
...
![A screenshot of the observability section with recent and assigned stack trace errors.](src/images/ObservabilitySection.png 'The observability section with recent and assigned stack trace errors.')

<figcaption>
  Use CodeStream's observability section to keep up to date with recent and
  assigned stack trace errors.
</figcaption>
...
![An animated image that shows someone commenting on a line of code associated with an error.](src/images/Observability-VSC.gif 'Someone commenting on a line of code associated with an error.')
...
![A screenshot of a comment with the most recent code contributor automatically added.](src/images/ErrorAutoMention.png 'A comment with the most recent code contributor automatically added.')
...
![A screenshot of the CodeStream's error assignment.](src/images/ErrorAssignee.png "CodeStream's error assignment.")
...
![A screenshot of the error status dropdown.](src/images/ErrorStatus.png 'The error status dropdown.')
...
![A screenshot of the git reference not configured warning message.](src/images/BuildSHANotConfigured.png 'The git reference not configured warning message.')

<figcaption>
  The git reference not configured warning message reads: Assocaite a build SHA
  or release tag with your errors so that CodeStream can help make sure you're
  looking at the right version of the code.
</figcaption>
...
![A screenshot of the git reference not found warning message.](src/images/BuildSHANotFound.png 'The git reference not found warning message.')

<figcaption>
  The git reference not found warning message reads: Your version of the code
  doesn't match the environment that triggered the error. Fetch the following
  reference to better investigate the error.
</figcaption>
...
![A screenshot of the missing repository info message.](src/images/RepoAssociation.png 'The missing repository info message.')

<figcaption>
  If there's no repository associated with CodeStream when you click **Open in
  IDE** on an error, CodeStream prompts you to do so.
</figcaption>
