...
* .NET - Code-level metrics must be [enabled in the .NET agent configuration](/docs/apm/agents/net-agent/configuration/net-agent-configuration#code_level_metrics).
