...
* **Go:** Requires Go agent version 3.18.0 or higher. For setup options, see [Go agent code-level metrics configuration](/docs/apm/agents/go-agent/configuration/go-agent-code-level-metrics-config) and [Go agent code-level metrics instrumentation](/docs/apm/agents/go-agent/instrumentation/go-agent-code-level-metrics-instrument).
