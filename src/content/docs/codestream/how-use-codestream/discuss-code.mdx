...
![A screenshot showing a codemark](/images/CodemarkInGutter1.png "codemark")
...
<Video id="rOGsg9taEuk" type="youtube" />
...
![A screenshot showing a new codemark](/images/DiscussCode1-VSC.gif "new codemark")
...
![A screenshot showing a new codemark in JetBrains](/images/Compose-JB.gif "new codemark JB")
...
![A screenshot showing the options menu to create a codemark](/images/ContextMenu4.png "context menu")
...
![A screenshot showing how to share a codemark in communication channels such as Slack](/images/SharingOptions1.png "sharing options")
...
![A screenshot showing how to comment on codemarks](/images/CodemarkComment6.png "comment codemark")
...
![A screenshot showing an issue](/images/CodemarkIssue7.png "issue codemark")
...
![A screenshot showing issue tracking services](/images/IssueTrackingIntegrations2.png "issue tracking services")
...
![A screenshot showing an issue location](/images/NewIssue-JiraOptions1.png "issue locations")
...
![A screenshot showing how to link issues to external services](/images/LinkedIssues.png "linked issues")

The issue on Jira includes a link to open the relevant code in your IDE.

![A screenshot showing a codemark permalink in Jira](/images/IssueOnJira1.png "jira issue")
...
![A screenshot showing the auto-mention feature](/images/CodemarkCompose.png "auto-mention")
...
![A screenshot showing a version diff](/images/CodemarkWithDiff1.png "version diff")
...
![A screenshot showing how to resolve a codemark](/images/ResolveCodemark.png "resolve codemark")
...
![A screenshot showing how to add a codeblock to a codemark](/images/CodemarkAddRange1.png "add codeblock")

Then select another block of code from the same file, a different file, or even a different repo.

![A screenshot showing how to select a block of code from a different location](/images/CodemarkSelectRange.png "select codeblock")
...
![A screenshot showing how to reference codeblocks](/images/ReferenceCodeBlocks.png "reference codeblocks")

Here's how that example is rendered.

![A screenshot showing a multi-range codeblock ](/images/MultiRangeCodemark.png "multi-range codemark")
...
![A screenshot showing the inline display](/images/InlineImage.png "inline image")
...
![A screenshot showing the tags menu](/images/TagsPopup.png "tags menu")
...
![A screenshot showing how to add a related codemark](/images/AddCodelink.png "add codelink")
...
![A screenshot showing a codemark with a related codemark](/images/CodemarkWithRelated.png "codemark with related codemarks")

## Manage codemarks [#manage]

Click the ellipses menu for any codemark and you'll see options to manage the codemark.

![A screenshot showing how to manage codemarks](/images/CodemarkMenu2.png "codemark menu")
...
CodeStream has built-in mechanisms for sharing to Slack, Microsoft Teams, or issue-tracking services, like Jira or Trello, but you can also grab the link for any comment, issue or feedback request to share it elsewhere. An existing Jira ticket. A wiki. A thread in your messaging service. Whatever the case may be, just look for the **Copy link** option under the ellipses menu.
...
![A screenshot showing how to create a permalink](/images/GetPermalink1.png "get-permalink")
