...
![A screenshot showing an issue locations](/images/NewIssue-JiraOptions1.png "issue locations")
...
![A screenshot showing how to select a block of code from a differnt location](/images/CodemarkSelectRange.png "select codeblock")
