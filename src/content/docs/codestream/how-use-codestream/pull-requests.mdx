...
The ability to create a pull request is available for GitHub, GitHub Enterprise, GitLab, GitLab Self-Managed, Bitbucket, and Bitbucket Server, but the ability to review a pull request is limited to GitHub, GitHub Enterprise, GitLab, and GitLab Self-Managed. 
</Callout>
...
If the feature branch you're working on doesn't have a remote tracking branch you'll be given the option to set that as part of creating the pull request.
...
<CollapserGroup>
  ...
  >
  CodeStream will automatically detect when you are working on a fork and allow you to specify both the base repo and head repo.

  ![A screenshot showing how to compare across forks](/images/OpenPRForks.png "Compare across forks")
  </Collapser>
  ...
  >
  You can also create a pull request from within a CodeStream feedback request. Once the feedback request has been approved, you'll see an option to open a pull request at the top. Before you can create a pull request, make sure that any changes included in the feedback request have been committed and pushed.
