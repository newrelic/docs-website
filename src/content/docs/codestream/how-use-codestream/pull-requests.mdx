...
CodeStream's **Pull Requests** currently only supports GitHub, GitHub Enterprise, GitLab, and GitLab Self-Managed. Unless you're already connected to one of those services, the section will only appear if you have a repository from one these services open in your IDE.
</Callout>
...
![A screenshot showing the PR section settings menu](/images/PRSectionSettings.png "pull-requests-section-settings")
<figcaption> Use this menu to fine-tune your pull request settings. </figcaption>
...
![A screenshot showing how to link to a feedback request from a PR](/images/LinkToFeedbackRequest.png "link to feedback request")
...
![A screenshot showing the details of a PR](/images/PRDetails-GH.png "pull request details")

For a GitLab merge request, you can use edit mode (via the dropdown at the top of the page) or use the sidebar.

![A screenshot showing the details of a merge request](/images/PRDetails-GL.png "merge request details")
...
![A screenshot showing a "changed files" view of a PR](/images/PRChanges-GH.png "pull request changes")
...
![A screenshot showing how to start a review](/images/PRCommentForm-GH.png "pull request review")
...
![A screenshot showing the codemark settings menu](/images/CodemarksSection-Settings.png "codemark settings")
