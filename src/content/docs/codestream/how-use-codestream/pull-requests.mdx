...
CodeStream's **Pull Requests** currently only supports GitHub, GitHub Enterprise, GitLab, and GitLab Self-Managed. 
</Callout>

![A screenshot showing the pull request section](/images/PullRequestsSection.png "pull-requests")
<figcaption>The pull request section seperates PRs by those waiting for review, those assigned to you, those created by you, and the most recent PRs.</figcaption>
...
![A screenshot showing the header icons](/images/PRQueryHeader.png "header-icons")
...
![A screenshot showing how to open a PR through a url](/images/PRLoadFromURL.png "open-pr-url")

When you hover over the Pull Requests section heading, icons appear at the right.

![A screenshot showing the pull request section heading icons](/images/PRSectionHeader.png "pull-requests-section-heading-icons")
...
-------------|-------
[Create a pull request](#create)|GitHub, GitHub Enterprise, GitLab, GitLab Self-Managed, Bitbucket, Bitbucket Server
Create a pull request across forks|GitHub, GitHub Enterprise, GitLab, GitLab Self-Managed
[Review and edit a pull request](#review)|GitHub, GitHub Enterprise, GitLab, GitLab Self-Managed
[Display pull request comments](#pr-comments) as code annotations|GitHub, GitLab, Bitbucket
...
![A screenshot showing how to open a pull request](/images/OpenPullRequest1.png "Open a pull request")
...
Other options to create pull requests are:
...
<CollapserGroup>
  ...
  ![A screenshot showing how to create a PR from a feedback request](/images/OpenPRfromFR.png "feedback request")
  ...
  ![A screenshot showing how to link to a PR from a feedback request](/images/LinkToPullRequest.png "link to pull request")
...
Pull requests review is currently not available for Bitbucket.
</Callout>
...
![A screenshot showing how to assign multiple users to PR](/images/MultipleSetting-GL.png "multiple settings")
...
### Perks of reviewing using CodeStream [#review-perks]

CodeStream does improve upon the GitHub/GitLab experience in a couple of important ways. On GitHub and GitLab you can only view the changes as a series of diff hunks. CodeStream provides that view as well, but if you'd prefer to see the changes in the context of the full file you can use either list view or tree view. Select the code you want to comment on and then click the **Comment** button, or select **Comment** from the context menu. When commenting, you can either add a single comment or start a review.

![A screenshot showing how to comment in a PR](/images/PRComment-GH.png "pull request comment")
