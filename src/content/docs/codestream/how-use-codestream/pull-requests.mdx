...
In a JetBrains IDE you’ll see a comment button appear right in the diff gutter, and clicking it will allow you to comment right in the editor.
...
As you add comments they’ll appear nested under the appropriate file in the tree view, making it easy for you, and pull request’s author, to get at them.
...
As you work your way through the files in the pull request, click the circle to mark a file as viewed. 
...
Click the PR Details entry in the tree to manage the pull request. You’ll see an interface just like what you’re using to seeing on GitHub (as depicted below) or on GitLab, so the mechanisms for changing a pull requests reviewers, assignees, and labels should be very familiar.
...
2. Review the conversation and add comments with the ability to @mention your collaborators.
