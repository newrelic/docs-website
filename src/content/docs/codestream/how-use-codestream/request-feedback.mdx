---
title: Get early feedback with CodeStream feedback requests
...
import codestreamFeedbackRequestsSection from 'images/codestream_screenshot-crop_feedback-requests-section.png'

import codestreamFeedbackRequestExample from 'images/codestream_screenshot-crop_feedback-request-example.png'

import codestreamChangedFilesList from 'images/codestream_screenshot-crop_changed-files-list.png'

import codestreamExcludeFileFromReviewButton from 'images/codestream_screenshot-crop_exclude-file-from-review-button.png'

import codestreamFeedbackRequestTeamSettings from 'images/codestream_screenshot-crop_feedback-request-team-settings.png'

import codestreamFeedbackRequestDiffView from 'images/codestream_screenshot-crop_feedback-request-diff-view.png'

import codestreamFeedbackRequestNavigateChangesButtons from 'images/codestream_screenshot-crop_feedback-request-navigate-changes-buttons.png'

import codestreamCommentSpecificCode from 'images/codestream_screenshot-crop_comment-specific-code.png'

import codestreamReviewRequestedChanges from 'images/codestream_screenshot-full_review-requested-changes.png'

import codestreamCodeReviewAmendForm from 'images/codestream_screenshot-crop_code-review-amend-form.png'

import codestreamChangedFilesReviewCheckpoints from 'images/codestream_screenshot-crop_changed-files-review-checkpoints.png'
...
## Feedback request UI [#feedback-ui]
...
* Select the **+ Request Feedback**  button in the header of the **Feedback Requests** section. If you're an admin you'll also see a gear icon to control how both [feedback request assignments](#fr-settings) and approvals work for your organization.
...
### Feedback request settings [#fr-settings]
...
### Approve change requests [#approve-changes]
...
## Approve the feedback request [#approve-fr]
