...
2. Once installed you should see the following popup for the CodeStream app, click the **Add** button. Note, do not expand it and select the options to add to team or chat. Simply click Add.
	![A screenshot showing the Add button.](/images/MSTCSAppPage.png "Add")
...
7. Paste the token into the chat and submit.
	![An image showing where to paste the token.](/images/MSTTokenMsg.png "Token")
...
8. Go to a channel in which you’d like to share, type `@`, and then select **Get bots** in the popup. 
	![An image showing the popup that appears when typing @](/images/MSTGetBots.png "Bots")
...
10. Return to the channel and @mention the CodeStream bot with the `connect` command. Repeat this in any channel that you'd like to share to.
	![An image showing the command to connect a bot.](/images/MSTConnectBot1.png "Connect bot")
...
12. When you return to CodeStream you'll now be able to share to the channels that you just connected.
	![An image showing the the CodeStream UI for sharing to a channel](/images/MSTSelectChannel.png "Share to channel")
...
![An image showing the buttons your team can select from teams.](/images/ShareOnMST1.png "Teams UI")
<figcaption>This will open the codemark in their designated IDE.</figcaption>
