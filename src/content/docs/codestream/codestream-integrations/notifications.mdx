...
* **Notify me about performance issues**: New methods in the code that are performing poorly, based on code-level metrics [anomaly detection](/docs/codestream/how-use-codestream/performance-monitoriing#clm-anomalies) will trigger a toast notification. Note that if you have mutliple repositories open in your IDE and/or multiple servics associated with those repositories, you'll only get notified about the first method with anomalous performance. Be sure to check Code-Level Metrics in the Observability section for the complete list.
