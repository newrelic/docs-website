...
CodeStream gives you a big-picture view of how the services built from your code are performing, but importantly, we also give you insight into how the code itself is performing.

## Anomaly detection [#anomalies]

CodeStream automatically calls out performance problems in your code, allowing you to proactively address performance issues as they arise.
...
CodeStream also lets you know about performance issues via [desktop notifications](/docs/codestream/codestream-settings/account-settings/#notifications) in either VS Code or JetBrains IDEs.
