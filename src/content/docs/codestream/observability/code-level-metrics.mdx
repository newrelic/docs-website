...
* <DNT>**.NET:**</DNT> If you're using Visual Studio, make sure that you have CodeLenses enabled in by going to <DNT>**Tools > Options > Text Editor > All Languages > CodeLens**</DNT> and ensure that both **Enable CodeLens** and **Show CodeStream Code-Level Metrics** are checked.
