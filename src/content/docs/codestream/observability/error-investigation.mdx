...
CodeStream shows you errors assigned to you, as well as the five most recent errors happening in the code opened in your IDE. You can control the timeframe via the dropdown list in the heading of this section. Note that this list may be a subset of the errors shown in the [errors inbox](/docs/errors-inbox/errors-inbox/) on New Relic. 
