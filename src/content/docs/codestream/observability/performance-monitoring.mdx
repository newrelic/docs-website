...
Everything in CodeStream is contextual to the repositories you have open in your IDE. If CodeStream doesn't know which services on New Relic are built from any of the repositories, you may first be prompted to [associate the repository with a service](/docs/codestream/observability/repo-association). Otherwise, you'll get a comprehensive view of how the services built from your code are performing.
