...
In CodeStream, all aspects are dependent on the repositories you have open in your IDE. If CodeStream cannot identify the services on New Relic that are derived from any of the repositories, you will be prompted to [associate the repository with a service](/docs/codestream/observability/repo-association). Otherwise, you'll get a comprehensive view of how the services built from your code are performing.
