...
No need to slow down your investigation by context switching between your IDE and your browser to search logs. CodeStream brings the New Relic log-search experience right into your IDE! Click on the <DNT>**View Logs**</DNT> entry for any service listed in the CodeStream pane, or click on the <DNT>**View Logs**</DNT> icon in CodeStream's global navigation.
