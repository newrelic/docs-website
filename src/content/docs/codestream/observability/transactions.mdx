...
Click on any transaction or segment to see the performance issue charted over time. For anomalous error rates, the errors contributing to the increased error rate are listed and you can click on one to go into CodeStream's [error investigation]() experience.
