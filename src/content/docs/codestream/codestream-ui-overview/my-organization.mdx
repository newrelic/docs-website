...
![A screenshot showing the organization menu(src/images/MyOrgMenu.png "organization-menu")

<figcaption>
  Use the **My Organization** menu to see who's in your New Relic CodeStream
...
![A screenshot showing the organization member list](src/images/MyOrgMembers.png 'organization-members')

## Invite your teammates [#invite]

Click **Invite Teammates** to invite new members to your organization.

![A screenshot showing the invitation menu](src/images/MyOrgInvite.png 'invite-menu')

<figcaption>
  Use the invite menu to invite members, see outstanding invites, and suggested
  teammates.
</figcaption>
...
![A screenshot showing a blame map.](src/images/MyOrgBlameMap.png 'blame-map')
