...
![A screenshot of the CodeStream sidebar sections](src/images/Sidebar3.png 'The CodeStream sidebar sections.')

<figcaption>
  The main sidebar sections are: pull requests, feedback requests, codemarks,
  observability, and issues.
</figcaption>
...
![A screenshot of the username menu items.](src/images/UsernameMenu.png 'The username menu items.')

<figcaption>
  The username menu gives you options for managing your account, your
  organization, how you receive notifications, and what sections are visible.
</figcaption>
...
![A screenshot of the CodeStream header menu.](src/images/GlobalOptions2.png 'The CodeStream header menu.')

<figcaption>
  The header menu items provide different options for creating and discovering
  content in your organization. From left to right: **Create**, **Activity
  feed**, **My organization**, and **Filter & search**.
</figcaption>
