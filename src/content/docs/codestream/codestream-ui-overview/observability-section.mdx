...
![A screenshot of the observability section showing recent errors and errors assigned to you.](./images/ObservabilitySection-connected.png "The observability section shows recent errors and errors assigned to you.")
...
* **Select entity from New Relic**: Use this to connect your repository to New Relic, if it isn't already.
