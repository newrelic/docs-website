...
![A screenshot of the unconnected observability section where you add your New Relic user key.](src/images/ObservabilitySection-connect1.png 'The unconnected observability section where you add your New Relic user key.')

<figcaption>
  Before you can start seeing errors in your IDE and take advantage of other New
  Relic and CodeStream features, you'll need to enter your New Relic user key.
</figcaption>
...
![A screenshot of the observability section showing recent errors and errors assigned to you.](src/images/ObservabilitySection-connected1.png 'The observability section shows recent errors and errors assigned to you.')

<figcaption>
  Once you've connected New Relic to CodeStream, you'll see observed errors
  directly in CodeStream.
</figcaption>
