...
- CodeStream uses the New Relic NodeJS agent to send telemetry data about how users use the CodeStream extension. Connections to New Relic occur on 162.247.241.2:443.