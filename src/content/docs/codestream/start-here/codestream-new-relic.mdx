...
* To use CodeStream in New Relic, you must be either a core user or full platform user. See [user type capabilities](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type/#user-type-comparison-table).  
