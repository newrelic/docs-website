...
- To use CodeStream in New Relic, you must be either a core user or full platform user. See [user type capabilities](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type#user-type-capabilities).
...
<Callout variant="caution">
  New Relic users can share stacktrace errors on CodeStream. Once you've
  connected CodeStream to New Relic, any new users you add to your CodeStream
  organization can see those errors.
</Callout>
...
<Callout variant="tip">Limited to APM errors.</Callout>
...
<CollapserGroup>
  ...
  <Collapser
    className="freq-link" id="repo-ui" title="Use the UI" > Once you've started sending data to New Relic, use the UI to connect your related repository. Go to the APM Summary page via **[one.newrelic.com](https://one.newrelic.com) > Explorer > Services - APM > (select an app)**, then look for the **Repositories** section at the bottom-right.
     ...
     ![A screenshot of the connect repository button.](src/images/connect-repo1.png "The connect repository button.")
