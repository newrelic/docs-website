...
Specifically, when CodeStream is connected to New Relic, you'll be able to jump from a stack trace error in errors inbox directly to the offending line of code in your IDE. Once in your IDE, you'll be able to use all of CodeStream's collaboration tools to resolve the issue and push up the fix to your repository.
