...
<figcaption>
  A quick overview of how you can use New Relic CodeStream to discover,
  troubleshoot, and triage errors in your IDE. (2:27)
</figcaption>
...
<Callout title="Preview release">
  CodeStream's integration with New Relic One is a preview release limited to
  New Relic One accounts on our US data center, and your use is subject to the
  pre-release policy. (This does not apply to all other CodeStream
  functionality.)
</Callout>
...
![An animated image showing how to use codemarks to leave a comment on a selection of code.](src/images/DiscussCode1-VSC.gif 'How to use codemarks to leave a comment on a selection of code.')
...
![An animated image showing how to use feedback requests.](src/images/FRRequest-VSC.gif 'How to use feedback requests.')

<figcaption>
  Once you've made some changes to a file, in the **Feedback requests** section,
  click the **+** button to request feedback on that change.
</figcaption>
...
![An animated image showing how to leave feedback on a change.](src/images/FRPerform-VSC.gif 'How to leave feedback.')
...
![An animated image showing how to review a pull request](src/images/PullRequest-VSC.gif 'How to review a pull request.')

<figcaption>
  CodeStream shows a diff view of all the files changed in a PR. Review and
  approve the PR as you would on GitHub.
</figcaption>
...
![An animated image showing how to see and respond to errors in your code.](src/images/Observability-VSC.gif 'How to see and respond to errors in your code.')

<figcaption>
  Once you've connected New Relic CodeStream to your repositories and are
  observing your code's performance, use the observability section to find
  errors and collaborate with your team on solving them.
</figcaption>
...
![A screenshot of an errors inbox error with a button to see the error in the IDE.](src/images/error-ide.png 'An errors inbox error with a button to see the error in the IDE.')

<figcaption>
  Once you've connected CodeStream to your repositories and configured it to
  connect with New Relic One, you can use errors inbox to find and an error and
  then jump to that error in your IDE and the branch of your repository that's
