...
import qsDiscussCode1 from 'src/images/codestream_screenshot-crop_discuss-code-example.png'

import codestreamRequestFeedbackButton from 'images/QS-FeedbackRequest2.png'

import qsPullRequest from 'images/codestream_screenshot-crop_pull-request-example.png'
...
<CollapserGroup>
  ...
  >
    Install CodeStream with its [Instant Observability (I/O) quickstart](https://newrelic.com/instant-observability/codestream/29bd9a4a-1c19-4219-9694-0942f6411ce7) to connect CodeStream to your New Relic account via your user key.
  </Collapser>
...
Create and review pull requests on GitHub, GitLab, or Bitbucket. Create issues on Jira, Trello, and other issue trackers. Investigate errors reported to New Relic. Share code discussions on Slack or Microsoft Teams. CodeStream brings the tools you use every day together in your IDE.
