...
![Create an account](src/images/CreateAnAccount6.png)
...
![Confirm Email](src/images/EmailConfirmation1.png)
...
![Create or join an organization](src/images/CreateOrJoinOrg.png)
...
![Invite teammates](src/images/InviteTeammates.png)
