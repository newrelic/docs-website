...
If you're an admin, use the **Organization Admin** menu under the headshot menu at the top of the CodeStream pane to change your organization's name, manage [onboarding](#onboarding) and [feedback request](#feedback-request) settings, [export data](#export), or delete your org.
