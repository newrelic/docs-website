---
title: Organization settings and administration
metaDescription: "How to manage your CodeStream organization."
---

## Managing People & Roles

Select "My Organization" from the [My Organization](/docs/codestream/how-use-codestream/my-organization) menu at the
...
If you are an organization admin, look for the Organization Admin menu under the
