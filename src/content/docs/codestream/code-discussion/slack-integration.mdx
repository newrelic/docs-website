...
You can also share an existing post to Slack, assuming that it hasn't already been shared. Go to a codemark or feedback request and look for the <DoNotTranslate>**Share**</DoNotTranslate> option under the ellipses menu. The <DoNotTranslate>**Shared To**</DoNotTranslate> section in the display of a codemark or feedback request will let you know if and where it has been shared. Click on the conversation name to open it on Slack.
