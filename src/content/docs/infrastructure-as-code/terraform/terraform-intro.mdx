...
<Steps>
  ...
  <Step>
    ...
    3. Your [New Relic region](/docs/using-new-relic/welcome-new-relic/get-started/our-eu-us-region-data-centers#verifying-account). Your region is `US` if your New Relic URL is `one.newrelic.com`, `EU` if your URL is at `one.eu.newrelic.com`, and `JP` if your URL is at `one.jp.newrelic.com`.
