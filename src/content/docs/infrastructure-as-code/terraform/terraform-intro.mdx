...
* <DNT>**Errors:**</DNT> The rate of requests that fail.
* <DNT>**Saturation:**</DNT> The stress on resources to meet the demands of your application.
...
<Steps>
  <Step>
    ...
    Next, instruct Terraform to install and use the New Relic provider, by setting the `terraform` and `required_providers` blocks in <DNT>**main.tf**</DNT>:
  ...
  <Step>
    ...
    In <DNT>**main.tf**</DNT>, set those values on the provider:
  ...
  <Step>
    ...
    [Log in to New Relic](https://login.newrelic.com/login) and [navigate to <DNT>**Alert Policies**</DNT>](/docs/alerts-applied-intelligence/new-relic-alerts/alert-policies/create-edit-or-find-alert-policy#alert-policy-view) to confirm that Terraform created your new policy.
  ...
  <Step>
    ...
    The `newrelic_alert_condition` is being deprecated and you will want to use NRQL alerts in the future.  You can use the following configuration to create a NRQL alert that performs the same function as above:
