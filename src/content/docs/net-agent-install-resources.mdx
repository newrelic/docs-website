...
<Callout variant="important">
  This document is **not** meant to be read as a standalone document. For install instructions, see [Introduction to .NET agent install](https://docs.newrelic.com/docs/agents/net-agent/installation/install-enable-new-relic-net-agent).
</Callout>
...
<CollapserGroup>
  ...
  >
    ...
    1. Ensure you have administrator rights for your Windows admin group. For more details on this, see the [permissions documentation](https://docs.newrelic.com/docs/agents/net-agent/getting-started/compatibility-requirements-net-framework-agent#user-rights).
    2. Download the scriptable installer package for .NET Framework from the [download site](https://download.newrelic.com/dot_net_agent/latest_release/ "Link opens in a new window."). By downloading or using one of these packages, you agree to and accept the [license terms](https://docs.newrelic.com/docs/licenses/license-information/agent-licenses/net-agent-licenses).
    3. Unzip the package.
  ...
  >
    <Callout variant="important">
      ...
      * Understand the [agent requirements](https://docs.newrelic.com/docs/agents/net-agent/getting-started/compatibility-requirements-net-core-agent), including the [permissions requirements](https://docs.newrelic.com/docs/agents/net-agent/getting-started/compatibility-requirements-net-core-agent#user-rights).
    ...
    1. Ensure you have administrator rights for your Windows admin group. For more details on this, see the [permissions documentation](https://docs.newrelic.com/docs/agents/net-agent/getting-started/compatibility-requirements-net-core-agent#user-rights)
    2. Download the .NET Core agent's scriptable installer package from the [.NET agent download site](https://download.newrelic.com/dot_net_agent/latest_release/ "Link opens in a new window.") . By downloading or using one of these packages, you agree to and accept the [license terms](https://docs.newrelic.com/docs/licenses/license-information/agent-licenses/net-agent-licenses).
