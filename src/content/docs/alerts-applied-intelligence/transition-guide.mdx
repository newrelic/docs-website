...
<CollapserGroup>
  ...
  >
    ...
    * [Faceted anomaly conditions documentation](docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-baseline-alert-conditions/#anomaly-facets)
