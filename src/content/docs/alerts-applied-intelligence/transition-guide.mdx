...
If you have questions or comments about anything in this EOL transition guide, do not hesitate to:
...
Use the enrich and notify features to add additional metadata to your notifications, schedule when you do not want to be notified, and configure where your notifications get sent.
...
<CollapserGroup>
  ...
  **Reason for EOL:** [Outlier conditions](/docs/alerts-applied-intelligence/new-relic-alerts/advanced-alerts/advanced-techniques/outlier-detection-nrql-alert/) do not provide efficient cluster identification and analysis capabilities.
