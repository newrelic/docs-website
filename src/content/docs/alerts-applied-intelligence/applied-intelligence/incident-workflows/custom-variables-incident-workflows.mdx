...
<table>
  ...
  <tbody>
    ...
    <tr>
     ...
     <tr>
      <td>issueActivatedAtUtc</td>
      <td>Issue ActivatedAt UTC string</td>
      <td>String format of issue activation in UTC</td>
    </tr>
     <tr>
      <td>issueClosedAtUtc</td>
      <td>Issue ClosedAt UTC string</td>
      <td>String format of issue closure in UTC</td>
    </tr>
     <tr>
      <td>issueCreatedAtUtc</td>
      <td>Issue CreatedAt UTC string</td>
      <td>String format of issue creation in UTC</td>
    </tr>
    <tr>
      <td>issueId</td>
      <td>Issue ID</td>
