...
<Video
  ...
  type="youtube"
/>
## Required capabilities [#required-roles-workflow]
...
* To access your destinations: you need `View` capabilities for `Applied intelligence:Destinations` or `Alerts`.
* To access your workflows: you need `View` capabilities for `Applied intelligence:Workflows`.
* To create workflows: you need `Modify` capabilities for `Applied intelligence:Workflows` and `Applied intelligence:Channels`.
* To modify your workflows: you need `Modify` capabilities for `Applied intelligence:Workflows` and `Applied intelligence:Channels`. In addition to      `Create` and `Delete` capabilities for `Applied intelligence:Channels`.
* To delete your workflows: you need `Delete` capabilities for `Applied intelligence:Workflows` and `Applied intelligence:Channels`.
* 
...
5. Optional: filter issues by a team tag so all teams can be notified when their entities are included in an Issue. Steps can be found in the demo below:
...
<Callout variant="important">
  The initial limit to the number of workflows you can add is 50 per [environment](/docs/alerts-applied-intelligence/applied-intelligence/incident-intelligence/get-started-incident-intelligence#1-configure-environment), and 50 per account. Please reach out to your account representitive if you would like this number to be increased.
</Callout>
