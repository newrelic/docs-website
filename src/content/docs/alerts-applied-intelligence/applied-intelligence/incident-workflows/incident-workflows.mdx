...
- Please reffer to the notification documentation on how to set up destinations and configure message templates. See [Destinations](/docs/alerts-applied-intelligence/notifications/destinations/).
</Collapser>
</CollapserGroup>
