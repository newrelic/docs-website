...
<Callout variant="important">
  The maximum number of workflows you can add is 50 per [environment](/alerts-applied-intelligence/applied-intelligence/incident-intelligence/get-started-incident-intelligence/#1-configure-environment/), and 50 per account.
</Callout>
