...
1. Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Enrich and Notify > Workflow > Add a workflow**.
...
To access the issue notification log, go to **[one.newrelic.com > Alerts & AI > Workflows](https://one.newrelic.com/alerts-ai/workflows)**, then click **Issue notification log**.
...
You can query all information from the issue notifications using `NrAiNotification` event.

Example query to see all notification sent from workflows facet by destination types:
