...
The maximum number of workflows you can add is 50 per environment and 50 per account.
</Callout>
...
<Callout variant="tip">
  You can setup notifications on WARNING violations by filtering on issues with priority equals HIGH(Warning)
</Callout>
