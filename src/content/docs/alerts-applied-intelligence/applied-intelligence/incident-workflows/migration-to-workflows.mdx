  ...
  <tbody>
    ...
    <tr>
     ...
     <tr>
      ...
      <td>
        Closed incident counts of all incidents regardless of priority.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        There is no replacement for warning counts.  All open incident counts will be represented as critical to avoid double counting incidents. 
      </td>
    </tr>
