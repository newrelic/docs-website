...
import anomalyConfAnomalyDetection from 'images/alerts_screenshot-full_configure-anomaly-detection.png'

import anomalyDetails from 'images/alerts_screenshot-full_anomaly-details.png'

import anomalySpecificConf from 'images/alerts_screenshot-crop_anomalies-specific-conf.png'

import anomalyWorkflowFilterData from 'images/alerts_screenshot-crop_workflow-filter-data.png'

import anomalyWorkflowNotify from 'images/alerts_screenshot-crop_workflow-notify.png'
...
The details of an anomaly gives you this information:
  ...
  * Name of the anomaly. You can click on it and it will take you to APM & Services capability to see a summary of it. 
