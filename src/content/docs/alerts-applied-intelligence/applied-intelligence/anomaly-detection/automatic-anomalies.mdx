...
1. Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI**</DoNotTranslate> and click <DoNotTranslate>**Anomaly detection**</DoNotTranslate> in the left pane.

2. Click <DoNotTranslate>**+ Add a configuration**</DoNotTranslate>.
    ...
    />
    <figcaption>
      To see configure an anomaly detection, go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI**</DoNotTranslate> and click <DoNotTranslate>**Anomaly detection**</DoNotTranslate> in the left pane. 
    </figcaption>
...
7. Select how you want to be notified. These are the options:
    ...
    * <DoNotTranslate>**Slack**</DoNotTranslate>. You need to select a Slack channel and the time zone the charts will use.
    * <DoNotTranslate>**Webhook**</DoNotTranslate>. You need to add the URL.
    * <DoNotTranslate>**No notifications**</DoNotTranslate>. If you prefer not to receive notifications, select this option.

8. Click <DoNotTranslate>**Save configuration**</DoNotTranslate>.
...
/>
<figcaption>
  To see the details of a detected anomaly, go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI**</DoNotTranslate>. Click the <DoNotTranslate>**Anomalies**</DoNotTranslate> tab to see the dashboard and then click the anomaly you want to see. 
</figcaption>
...
3. Click the <Icon name="fe-more-horizontal"/> icon of the configuration and select <DoNotTranslate>**View anomalies**</DoNotTranslate>. 
...
/>
<figcaption>
  To see the anomalies of a specific configuration, go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI**</DoNotTranslate> and click <DoNotTranslate>**Anomaly detection**</DoNotTranslate> in the left pane. 
</figcaption>
...
4. Click <DoNotTranslate>**Save configuration**</DoNotTranslate>.

### Use anomaly detection with Slack:

  1. Select <DoNotTranslate>**Slack**</DoNotTranslate>.
  ...
  <Callout variant="tip">If you experience an error when assigning Slack channels, make sure that the New Relic applied intelligence Slack application has been [added to your Slack workspace](https://slack.com/help/articles/202035138-Add-an-app-to-your-workspace).</Callout>
...
### Use anomaly detection with webhooks:
    ...
    1. Select <DoNotTranslate>**Webhook**</DoNotTranslate>.
...
### Use anomaly detection with workflows: 
  ...
  1. Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI**</DoNotTranslate> and click <DoNotTranslate>**Workflows**</DoNotTranslate> in the left pane.
  2. Select <DoNotTranslate>**+ Add a workflow**</DoNotTranslate>.
  3. Choose a name for your workflow that helps you easily identify it from others in your account.
  3. Click the <DoNotTranslate>**Advanced**</DoNotTranslate> button to build an advanced filter for all attributes.
  4. Click the <DoNotTranslate>**Select or enter attribute**</DoNotTranslate> selector and add `origins`. Then, select `contains` as the operator and `anomalies` as the value.
  ...
  8. Click <DoNotTranslate>**Additional settings**</DoNotTranslate> if you want to enrich your data.
  ...
  10. Click <DoNotTranslate>**Test workflow**</DoNotTranslate> if you want to check if you workflow works.
  11. Click <DoNotTranslate>**Activate workflow**</DoNotTranslate>.
  ...
  To mute in Slack, select <DoNotTranslate>**Mute this app's warnings**</DoNotTranslate> or <DoNotTranslate>**Mute all warnings**</DoNotTranslate>, then select the duration. Notifications will resume once the muting duration has completed.

  Muting an application permanently removes it from the configuration. To add it back in, go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Anomaly detection**</DoNotTranslate>, and select the configuration to edit.
  ...
  * An <DoNotTranslate>**Analyze**</DoNotTranslate> button that navigates to an analysis page in applied intelligence that identifies key attributes that are unique to the anomaly, anomalies found upstream or downstream, and any other relevant signals.

  Once an anomaly has returned to normal, we send a recovery notification with the option to provide feedback. Your feedback provides our development team with input to help us improve detection quality. When feedback is provided on throughput anomalies, an evaluation is run each hour based on your feedback to find a more suitable model. If we helped you, you can select <DoNotTranslate>**Yes**</DoNotTranslate> or <DoNotTranslate>**No**</DoNotTranslate>.
  </Collapser>
  ...
  To find these settings: from <DoNotTranslate>**Alerts & AI**</DoNotTranslate>, under <DoNotTranslate>**Anomaly detection**</DoNotTranslate>, click <DoNotTranslate>**Settings**</DoNotTranslate>.
...
Details on these UI sections:
  ...
  * <DoNotTranslate>**AI overview and anomalies tab**</DoNotTranslate>: Use the AI overview and anomalies tab setting to hide anomalies from the AI overview and anomalies tab setting. Please note you also can use filters specific to these views as well.
  * <DoNotTranslate>**Global activity stream**</DoNotTranslate>: Use the global activity stream section to customize what anomalies are shown in the various New Relic activity streams, including the New Relic homepage, <InlinePopover type="apm" /> summary, and Lookout.
  * <DoNotTranslate>**Anomaly types**</DoNotTranslate>: Use the check boxes here to hide specific types of anomalies. For example, uncheck <DoNotTranslate>**Web throughput**</DoNotTranslate> and <DoNotTranslate>**Non-web throughput**</DoNotTranslate> anomalies to hide these types of anomalies from both the activity streams and the AI overview and anomalies tab. Note they are still reported and available for querying.
...
<table>
  ...
  <tbody>
    ...
    You can also select <DoNotTranslate>**Connect to incident intelligence**</DoNotTranslate> from inside of a configuration.
