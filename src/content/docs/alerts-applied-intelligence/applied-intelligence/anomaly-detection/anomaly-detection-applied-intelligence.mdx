...
/>
<figcaption>
Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI**. Click the **Anomalies** tab to see the dashboard where your team can monitor any unusual behavior in your system.   
</figcaption>
