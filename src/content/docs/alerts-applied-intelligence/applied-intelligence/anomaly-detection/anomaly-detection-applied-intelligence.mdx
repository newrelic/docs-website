...
At New Relic, our own developers know how important it is to monitor the health of our applications. We want our customers to access to the data they need whenever they need it so our team wants to know if there are any outliers in our system's performance as soon as possible. New Relic's anomaly detection uses applied intelligence to monitor three key golden signals: throughput, error rate and latency. With anomaly detection, our developers are always aware of our baseline performance for these metrics.
...
We monitor this unusual behavior in a few ways.
...
<img
  ...
  src={alertsscreenshotfullhowcustomanomalies-work}
/>
...
<img
  ...
  src={alertsscreenshotfullconfigureyouranomalythresholds}
/>
...
<img
  ...
  src={alertsscreenshotfullfacetedanomalies}
/>
...
<img
  ...
  src={alertsscreenshotfullfacetedanomaliestwo}
/>
...
<img
  ...
  src={alertsscreenshotfullanomaliessetupperandlowerranges}
/>
