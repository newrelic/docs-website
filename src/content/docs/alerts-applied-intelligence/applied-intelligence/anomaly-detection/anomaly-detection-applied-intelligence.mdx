...
At New Relic, our own developers monitor the health of our application. We want to know if there are any outliers in our system's performance as soon as possible because we want our customers to always have access to the data they need. New Relic's anomaly detection monitors three key golden signals: throughput, error rate and latency. Since we monitor our own application, New Relic developers always understand our baseline performance for these metrics.
...
Automatic anomalies are the most efficent way for your team to learn about unusual behavior in your application. 

## How automatic anomalies function in your system [#anomaly-functions]
...
## Custom anomalies [#automatic-anomalies]
