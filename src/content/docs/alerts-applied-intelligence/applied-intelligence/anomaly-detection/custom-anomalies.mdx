...
You can create custom anomalies thresholds from an [alert condition](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/nrql-alert-conditions/). Here are some tips for setting anomaly thresholds:
...
1. Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI** and select **Alerts conditions (policies)** in the left navigation panel.
