...
You can create custom anomalies thresholds from a [policy](/docs/alerts-applied-intelligence/new-relic-alerts/alert-policies/create-edit-or-find-alert-policy/). Here are some tips for setting anomaly thresholds:
...
6. After selecting 'anomaly' for threshold type, you'll need to set your threshold. This sets the criteria that you want to be notified on. 
