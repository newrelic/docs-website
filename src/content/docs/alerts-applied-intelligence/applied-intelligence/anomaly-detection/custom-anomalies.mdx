...
This threshold predicts the future behavior for the value of your data. This prediction appears as a dotted black line on the preview chart in the anomaly condition UI. 
