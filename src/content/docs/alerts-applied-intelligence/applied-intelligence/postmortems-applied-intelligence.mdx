...
With alert's postmortems feature, events, metrics, and metadata are automatically collected to create a template you can use to run an incident postmortem for your team.
...
To find your issues, go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Analyze**</DoNotTranslate>, and click <DoNotTranslate>**Issues & activity**</DoNotTranslate>.
...
1. Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Analyze**</DoNotTranslate>, and click <DoNotTranslate>**Issues & activity**</DoNotTranslate>. 
