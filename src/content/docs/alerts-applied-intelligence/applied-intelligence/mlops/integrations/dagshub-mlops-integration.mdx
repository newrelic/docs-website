...
New Relic now offers an [MLOps](/docs/alerts-applied-intelligence/applied-intelligence/mlops/get-started/intro-mlops/) integration with DagsHub to monitor and analyze your machine learning training metrics in real-time. 
