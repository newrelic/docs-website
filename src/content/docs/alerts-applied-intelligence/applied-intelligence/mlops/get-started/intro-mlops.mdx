...
3. **Bring your own data (BYO):** If you don’t want to sign up for another license, or if you don’t use AWS Sagemaker, you can easily bring your own ML model telemetry into **[New Relic One](https://one.newrelic.com)** and start getting value from your ML model data. In just a few minutes, you can get feature distribution, statistics data, and prediction distribution. Read [more on BYO in our docs](/docs/alerts-applied-intelligence/applied-intelligence/mlops/integrations/mlops-byo). 
