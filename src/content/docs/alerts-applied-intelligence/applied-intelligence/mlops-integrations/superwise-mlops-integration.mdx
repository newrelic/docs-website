...
You’ve now successfully integrated New Relic with Superwise. Newly created alerts are now correlated with your New Relic alerts, and you should be able to see data about newly reported predictions. 
