...
To open the alert coverage gaps page, go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI**</DoNotTranslate> and select <DoNotTranslate>**Alert coverage gaps**</DoNotTranslate> in the left navigation pane. There, you will see a list of all your entitites that are not currently covered.
...
If there are no uncovered entities for <DoNotTranslate>**Browser**</DoNotTranslate> or <DoNotTranslate>**Mobile**</DoNotTranslate>, you won't see that specific tab.
    ...
    <figcaption>
      Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI**</DoNotTranslate> and select <DoNotTranslate>**Alert coverage gaps**</DoNotTranslate> in the left navigation pane. When you select this option you'll see a list of all your unmonitored entities.
    </figcaption>
...
1. Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI**</DoNotTranslate> and select <DoNotTranslate>**Alert coverage gaps**</DoNotTranslate> in the left navigation pane.

2. Click <DoNotTranslate>**Add alert**</DoNotTranslate> on the entity you want to create the alert.
...
3. Add the recommended conditions you want.
    ...
    <figcaption>
      To create an alert for an unmonitored entity, go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI**</DoNotTranslate>, select <DoNotTranslate>**Alert coverage gaps**</DoNotTranslate> in the left navigation pane, and click <DoNotTranslate>**Add alert**</DoNotTranslate>. 
    </figcaption>
...
6. Click <DoNotTranslate>**Activate conditions**</DoNotTranslate> to save the conditions. If the policy is new, you'll see the <DoNotTranslate>**Save & set up notifications**</DoNotTranslate> button. Use this button if you want to save the conditions and the notifications.
