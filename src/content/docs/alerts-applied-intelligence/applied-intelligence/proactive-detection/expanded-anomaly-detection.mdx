...
Instead of creating your alert conditions manually, simply tell us what you want to monitor. Anomaly detection will help you identify baseline performance in your system and flag you when anomalies appear in your system. 
...
When you set up anomaly detection, New Relic started analyzing the golden signals of your entities and workloads. Instead, anomalies appear in your activity feeds throughout New Relic One and the Anomalies tab as soon as they’re detected.
...
1. From one.newrelic.com, go to Alerts & AI > Proactive Detection > Settings
2. Select the Custom tab and the configuration you want to modify. 
