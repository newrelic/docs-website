...
* [Full platform user](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type) access. If you haven't already, [sign up for a New Relic account](https://newrelic.com/signup) to get started.
