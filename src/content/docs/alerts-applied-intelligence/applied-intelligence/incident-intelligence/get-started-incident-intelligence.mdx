  ...
  "pages": [
    {
      ...
      <td>
        Use [Algorithmia's docs] to configure Algorithmia Insights for New Relic.
      </td>
    </tr>
        <tr>
      <td>
...
Once your algorithm build finishes, you can test it with this sample payload to make sure it runs successfully. Your output should look something like this.
      ...
      <td>
        Use your New Relic API key for the [Algorithmia secret store](https://algorithmia.com/developers/platform/algorithm-secrets).
      </td>
    </tr>
        <tr>
      <td>
