...
To use most Applied Intelligence features, you must be a [full user](/docs/accounts/accounts-billing/new-relic-one-user-management/new-relic-one-user-model-understand-user-structure/#user-type). For more information, see [user type capabilities](/docs/accounts/accounts-billing/new-relic-one-user-management/new-relic-one-user-model-understand-user-structure/#user-capabilities).   
...
## 1. Configure your fabulous environment (one-time) [#1-configure-environment]
