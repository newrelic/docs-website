...
<CollapserGroup>
  ...
  <Collapser
    className="freq-link"
    id="configure-superwise"
    title="Superwise (MLOps)"
  >

  By integrating Incident Intelligence with your Superwise machine-learning models, you can monitor your machine learning model performance.
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          In the search bar, type **Superwise** or scroll down to the MLOps Integration section and click on the **Superwise icon**.
        </td>
      </tr>
      <tr>
        <td>
        ...
        <td>
          Select the account ID you want Superwise to integrate with.
        </td>
      </tr>
      <tr>
        <td>
        ...
        <td>
          Once you select an Account ID, click **Create a Key**, under **Prediction data + Generate Dashboard**. This will be your new telemetry API key. In addition, click **Create a Key**, under **Model Quality Metric**. This will be your Incident Insights key. Keep the New Relic page open for future steps. 
        </td>
      </tr>
      <tr>
        <td>
          5. Login into the Superwise Portal
        </td>
        <td>
           Login to the Superwise portal and go to **notification channel settings**. Select **New Relic** and create a channel name.
        </td>
      </tr>
      <tr>
        <td>
          6. Copy and Paste the Token in Superwise
        </td>
        <td>
      ...
      <tr>
        ...
        <td>
          Click on the **Test button**, in the Superwise channel portal, to verify both tokens are working properly. A **Green** or **red** status box should appear to indicate the verification 
        </td>
      </tr>
    </tbody>
  </table>
  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td>
          Once you’ve tested your tokens and confirmed the integration is set up correctly, return to the New Relic integration dashboard and click on **See your data**. This will redirect you to an automatically generated dashboard powered by Superwise.
        </td>
      </tr>
      <tr>
        <td>
          2. Analyze Superwise’s Dashboard
        </td>
        <td>
          Superwise’s dashboard contains three charts:
          ...
          * The **Model Input Drift** detection chart displays what models are drifting and may require retraining using a model drift leveler scaled between 0 and 100. 
      ...
      <tr>
        <td> 
          3 . Customize metrics and incidents in Superwise
        </td>
        <td>
          Teams can easily customize any model metric and incident type in the Superwise platform. They can then search for these metrics in the **New Relic Browser** tab under **Metrics**. To do this, follow the step 4 instructions in the Superwise Docs **(attach link here)**
        </td>
      </tr>
      <tr>
        <td> 
