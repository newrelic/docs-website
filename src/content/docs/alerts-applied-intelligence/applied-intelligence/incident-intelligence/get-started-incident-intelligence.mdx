...
<Callout variant="tip">
  Incident Intelligence is a cross-account product. This means you can send in
  data from any New Relic account or external source to correlate events.
</Callout>
...
<Callout variant="tip">
  Adding anomalies as a source won't affect your current Proactive Detection
  configurations or notifications.
</Callout>
...
<CollapserGroup>
  ...
  >
    ...
    ![ServiceNow Custom Field Example.png](src/images/image-%281%29_0.png "ServiceNow Custom Field Example.png")
...
<Callout variant="tip">
  There’s a retry mechanism that is triggered a few times with exponential
  backoff for a couple of minutes once an error occurs. If we reach the retry
  limit, the Webhook will get auto-disabled.
</Callout>
