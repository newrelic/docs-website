...
For a peek at how to build a postmortem with applied intelligence, watch this short video (2:08 minutes):
...
The event types include anomalies, incidents, alerts violations, deployments, and user activity.
...
Optionally, you can fill out the **Root caus** and **Recovery actions** sections to create a more detailed retrospective record.
...
If you decide you no longer need a postmortem, on the detailed postmortem record, click **Delete**.
