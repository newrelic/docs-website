...
An impacted entities map is available for any issue involving two or more entities. The [map](/docs/new-relic-one/use-new-relic-one/ui-data/maps-in-context/) shows not only the affected entities, but also the services and resources directly related to those entities.
