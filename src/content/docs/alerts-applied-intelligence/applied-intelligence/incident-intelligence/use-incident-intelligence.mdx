...
If you hover over an impacted entity application, you’ll notice a few calls to action: relevant dashboards, [anomaly overview](/docs/alerts-applied-intelligence/applied-intelligence/proactive-detection/proactive-detection-applied-intelligence#anomaly-overview), deployment events, and entity overview. 

![Impacted entites list of actions](./images/impacted_entities_actions.png)
...
![A screenshot ofthe issue entity map view.](./images/issue_entity_map.png "The issue entity map view.")

<figcaption>Hover over an entity to see more information about it.</figcaption>

An impacted entities map is available for any issue involving two or more entities. The map shows not only the affected entities, but also the services and resources directly related to those entities.
...
![A screenshot of the **Related activity** table.](./images/new_incident_intelligence_related_activity.png "The Incident Intelligence issue timeline related activity.")

<figcaption>
  This section shows you the number of **Related Events**, when the information was **Last Updated**, the **Source** location, its **State**, , and its **New Relic Origin**. You can also copy the **Payload** or click on **Analyze** for more information.
</figcaption>
