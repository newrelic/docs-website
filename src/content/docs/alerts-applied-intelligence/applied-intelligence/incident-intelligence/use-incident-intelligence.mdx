...
![A screenshot of the Incident Intelligence issue feed.](src/images/issue_feed.png 'The Incident Intelligence issue feed.')

<figcaption>
  This screenshot shows an example issue feed, which describes your issues'
  statuses, correlations, and more.
</figcaption>
...
![A screenshot of the Issue page and its different sections: issue summary, suggested responders, label sets, and impacted entities.](src/images/Screen-Shot-2020-10-21-at-9.32.39-AM.png 'The Issue page and its different sections: issue summary, suggested responders, label sets, and impacted entities.')
...
![A screenshot of the impacted entities list of actions.](src/images/impacted_entities_actions.png 'The impacted entities list of actions.')
...
![A screenshot of the issue entity map view.](src/images/issue_entity_map.png 'The issue entity map view.')
...
<Callout variant="tip">
  Note that root cause analysis is dependent on other New Relic data sources and
  features. This is why root cause analysis information may not always be
  present for every issue.
</Callout>

![A screenshot example root cause analysis](src/images/root-cause-analysis.png 'An example root cause analysis.')
...
![A screenshot example issue timeline.](src/images/incidents_timeline.png 'An example issue timeline.')
...
![A screenshot of the Incident Intelligence issue timeline with event detail.](src/images/screenshot_incident_intelligence_timeline_event_detail.png 'The Incident Intelligence issue timeline with event detail.')

<figcaption>Mouse over the grey line to see details of the event.</figcaption>

Finally, mouse over the incident to see information on the location, timing, and level of importance of a specific incident.

![A screenshot of the Incident Intelligence issue timeline with critical event detail.](src/images/screenshot_incident_intelligence_critical_event_detail.png 'The Incident Intelligence issue timeline with critical event detail.')

<figcaption>
  This figure shows a particular incident populated on January 11th with a level
  of **Critical**.
</figcaption>
