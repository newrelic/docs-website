...
<img
  title="The Issue page and its different sections: issue summary, suggested responders, label sets, and impacted entities."
  alt="A screenshot of the Issue page and its different sections: issue summary, suggested responders, label sets, and impacted entities."
