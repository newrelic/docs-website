...
redirects:
  ...
  - /docs/alerts-applied-intelligence/applied-intelligence/incident-intelligence/get-started-incident-intelligence/#issue details
...
![A screenshot of the Issue page and its different sections: Issue details, suggested responders, label sets, and impacted entities.](./images/Screen-Shot-2020-10-21-at-9.32.39-AM.png "The Issue page and its different sections: Issue details, suggested responders, label sets, and impacted entities.")

The **Issue page** includes the following sections:

1. **Issue details:** This section has two machine learning modules, the golden signals and the related components.
