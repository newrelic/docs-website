...
8. **User actions (above the chart):** Clicking on an incident from the incident activity list will display certain actions that you can take:
...
9. **Incident Entity Section (below the chart):** If you click on an incident from the incident activity list, you will see the following:
