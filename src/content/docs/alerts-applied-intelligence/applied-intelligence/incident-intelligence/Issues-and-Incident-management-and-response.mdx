...
## Search & filter issues [#search-&-filters]

You can easily search for any issue by using the search bar free text or by filtering the results (click on the filter icon).
For the free text option, you have the option to search by
- Issue name
- Issue ID
- Policy Name
- Condition Name
...
On the filter you will find the very same filters as the free text and more like:
- Issue state
- Issue priority
- Issue Status (Acknowledged, Mutated, or Correlated)
- Issue source (NR Alerts, NR Anomalies, or REST API)

You can also use the feed sorting option to find what you are looking for fast e.g. sort by issue duration or created time.
