...
/>
<figcaption>
  Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI > Issues & activity**. This screenshot shows an example issue feed, which describes your issues' statuses, correlations, and more.
</figcaption>
...
If you click the filter icon, you have more filters:

- Issue state (created, active, or closed)
- Issue status (acknowledged, muted, or correlated)
- Issue priority (lowe, medium, high, or critical)
