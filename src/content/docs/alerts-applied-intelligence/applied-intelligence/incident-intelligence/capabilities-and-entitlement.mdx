...
It should be formed as follows: https://authorization-management.service.newrelic.com/authorization_contexts/account/<account-id-here>/principal/<user-id-here> [see an example](https://authorization-management.service.newrelic.com/authorization_contexts/account/2596260/principal/1000585667).
