...
<table id="global-decision-descriptions">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Correlation is activated because the New Relic [condition names and titles](/docs/alerts-applied-intelligence/new-relic-alerts/advanced-alerts/understand-technical-concepts/violation-event-attributes/#attributes) are the same respectively. This is a refined option by comparing titles in addition to conditions to reveal tighter relevance with the same alert message.
      </td>
    </tr>
...
To enable a suggested decision, click **Activate decision**. Once activated, the decision will appear in your teams main decision table. All suggested decisions will be show the creator as New Relic AI. 
...
The basic ones are **equals**, **contains**, **starts with**, **ends with**, **exists**, and their negative operators accordingly. For example, **does not equal**.
