...
For Decisions users, a default topology decision is added and enabled in your account.

You also have the option to [create custom decisions](#build-decision).
...
**Topology correlation is currently in general release.** Requirements:

<Callout variant="important">
  For out-of-the-box topology correlation (without the need to explicitly set up topology graph), please make sure your telemetry data is collected by [New Relic agents](/docs/new-relic-solutions/new-relic-one/install-configure/compatibility-requirements-new-relic-agents-products/). The more types of New Relic agents are installed in your services and environment, the more opportunies for topology decisions to correlate your incidents.
</Callout>
...
To set up your topology in addition to the [New Relic entities and relationships](/docs/new-relic-solutions/new-relic-one/core-concepts/what-entity-new-relic/) collected by [New Relic agents](/docs/new-relic-solutions/new-relic-one/install-configure/compatibility-requirements-new-relic-agents-products/), you'll use [our NerdGraph API](#create-topology-graph). 
