...
import alertsBasicDecisionBuilderNameDescribe from 'images/alerts_screenshot-crop_basic-decision-builder-filter-name-describe.webp'
...
<CollapserGroup>
  <Collapser
    ...
    title="UI screenshot: Correlate by attributes"
  >
...
<CollapserGroup>
  <Collapser
    ...
    title="UI screenshot: Filter by values"
  >
...
<CollapserGroup>
  <Collapser
    ...
    title="UI screenshot: Filter by related entities"
  >
...
<CollapserGroup>
  <Collapser
    ...
    title="UI screenshot: Test with a simulation"
  >
...
<CollapserGroup>
  <Collapser
    ...
    title="UI screenshot: Name and save the decision"
  >
...
<CollapserGroup>
  <Collapser
    ...
    title="UI screenshot: Filter your data"
  >
...
<CollapserGroup>
  <Collapser
    ...
    title="UI screenshot: Use related entities"
  >
...
<CollapserGroup>
  <Collapser
    ...
    title="UI screenshot: Name decision"
  >
...
<CollapserGroup>
  <Collapser
    ...
    title="UI screenshot: Advanced settings"
  >
