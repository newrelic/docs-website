...
To enable a suggested decision, click **Add to your decisions**. Once activated, the decision will appear in your teams main decision table. All suggested decisions will show the creator as New Relic AI (this refers to New Relic applied intelligence). 
