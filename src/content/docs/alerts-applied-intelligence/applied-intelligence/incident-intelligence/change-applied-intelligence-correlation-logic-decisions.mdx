...
![Our AI correlates data related to incidents in the Decisions UI.](src/images/NRAI_Decisions_Index.png 'NRAI_Decisions_Index.png')
...
![Decisions Statistic Block](src/images/II---Decisions---Statistics.png 'Decisions Statistic Block')
...
![Suggested Decision Block](src/images/Screen-Shot-2020-07-27-at-6.50.41-AM.png 'Suggested Decision Block')
...
![New Relic topology explained 4](src/images/topology-4.png 'topology-4.png')

<figcaption>
  In this service map, the hosts and apps are the vertices, and the lines
  showing their relationships are the edges.
</figcaption>
...
![New Relic topology explained 1](src/images/topology-1.png 'topology-1.png')
...
![New Relic topology explained 2](src/images/topology-2.png 'topology-2.png')
...
![New Relic topology explained 3](src/images/topology-3.png 'topology-3.png')
