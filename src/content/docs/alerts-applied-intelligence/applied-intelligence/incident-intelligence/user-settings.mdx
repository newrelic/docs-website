...
For New Relic alert's, our grace period setting controls how much time should pass before you're notified about an issue. Our inactive issues setting controls how long you want to wait before an inactive issue is automatically closed.

These settings apply to all data coming in to your account.

To find your alert's settings, go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > General**</DoNotTranslate>.
