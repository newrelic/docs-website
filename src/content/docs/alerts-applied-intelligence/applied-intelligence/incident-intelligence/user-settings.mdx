...
The inactive issues setting controls how much time elapses before an inactive issue is automatically closed. The range is from 1-30 days and the default value is 3 days.
...
An issue is considered inactive when one of these things occurs:

* No new incident has appeared in the issue for 4 hours.
* The issue has collected 5,000 incidents.

An issue can be inactive for up to a maximum of 30 days, before it's automatically closed.