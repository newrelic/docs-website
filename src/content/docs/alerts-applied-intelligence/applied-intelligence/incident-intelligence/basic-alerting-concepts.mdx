...
/>
<figcaption>A diagram showing how the exceed of alert **conditions** thresholds result in **incidents**, how incidents result in **issues**, and how the logic in **workflows** results in notifications.   
  </figcaption>
