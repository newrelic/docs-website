...
Once you've used our anomaly detection to identify irregular behavior and decisions to group all your relevant issues together, it's important that the right people on your team are notified of any potential problems. New Relic created workflows so you can control when and where you want to receive notifications about issues. Workflows allow you to funnel the right information to the relevant person or team. Workflows also give you the opportunity to enrich your notifications with additional New Relic data.
