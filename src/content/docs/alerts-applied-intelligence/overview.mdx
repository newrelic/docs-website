...
We also have self-adjusting monitoring which uses [anomaly alert conditions](/docs/alerts/new-relic-alerts/defining-conditions/create-anomaly-alert-conditions) to allow you to create intelligent, self-adjusting conditions.
