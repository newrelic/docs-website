...
Learn how to create static [alert conditions](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-alert-conditions/) and how configure anomalies [in our anomaly docs](https://docs.newrelic.com/docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows).
...
Our correlation logic is called decisions. Learn how to set up decisions, follow our step by step guide by [in our decisions docs](https://docs.newrelic.com/docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows).
