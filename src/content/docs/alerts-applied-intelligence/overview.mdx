...
![Screenshot of the Alerts and AI overview page](src/images/alerts-ai-summary.png 'The alerts and applied intelligence overview page')

{' '}
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI: You can use the
  overview summary page to quickly review your issues and incidents.**
</figcaption>
