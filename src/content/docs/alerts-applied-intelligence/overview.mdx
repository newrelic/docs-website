...
Applied intelligence takes alerting one step further and uses machine learning to monitor patterns and trends in your data. Applied intelligence identifies any deviations from expected behavior and notifies your team instantly. You can decide what level of automation works best for each situation. Our automatic anomaly detection is easy to use and implement, while our more customizable detection options offer your team the ability to create alerts that are just right for you. 

Learn how to create static [alert conditions](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-alert-conditions/) and how to configure anomalies [in our anomaly docs](/docs/alerts-applied-intelligence/applied-intelligence/anomaly-detection/anomaly-detection-applied-intelligences).
