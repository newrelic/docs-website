...
Our correlation logic is called decisions. Learn how to set up decisions, follow our step by step guide by [in our decisions docs](/docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows).
