...
1. **Run the [example notebook](https://github.com/newrelic-experimental/ml-performance-monitoring/blob/main/examples/sklearn.RandomForestClassifier_on_Iris_dataset.ipynb):** You'll have to define your [API insert key](/docs/apis/intro-apis/new-relic-api-keys/) as an environment variable, or send it as a parameter. (You can find another example notebook [here](https://github.com/newrelic-experimental/ml-performance-monitoring/tree/main/examples))
