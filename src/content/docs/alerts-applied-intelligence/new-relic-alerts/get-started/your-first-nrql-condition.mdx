...
<figcaption>
  Click the **Query your data** capability to open the query builder and start writing a NRQL query. Once you've written a valid query, you can create a condition from it.
</figcaption>
