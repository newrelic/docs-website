...
<img
  title="A screenshot showing where you can find the NRQL query builder button in New Relic One."
  alt="A screenshot showing where you can find the NRQL query builder button in New Relic One."
