...
<figcaption>
  Click the **Query you data** button to open the query builder and start writing a NRQL query. Once you've written a valid query, you can create an alert from it.
</figcaption>
