...
japaneseVersion: >-
  https://docs.newrelic.co.jp/docs/alerts-applied-intelligence/new-relic-alerts/get-started/alerts-concepts-workflow
---

Alerts lets you create customized alerting solutions for monitoring your system. This document contains:

* An [introduction to alerts terms and concepts](#terminology)
* The [general workflow](#workflow)
