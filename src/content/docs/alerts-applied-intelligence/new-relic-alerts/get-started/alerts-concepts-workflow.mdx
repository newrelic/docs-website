...
Customize alerting solutions to monitor your systems. 
 
This is an introduction to alerts terms and concepts and describes how you can create an alert policy with related conditions.
