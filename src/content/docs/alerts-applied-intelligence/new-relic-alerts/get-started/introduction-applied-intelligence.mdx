...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Applied Intelligence provides automatic anomaly detection on all your [New Relic APM](/docs/apm)-monitored applications. We detect anomalies in throughput, latency, and error rate, with no action required from you. Benefits include:
