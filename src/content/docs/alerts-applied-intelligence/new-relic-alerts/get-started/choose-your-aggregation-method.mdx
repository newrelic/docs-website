...
![Diagram showing regularly arriving data points](src/images/time-series-data-points.png 'Diagram showing regularly arriving data points.')
...
![A screenshot showing where you can find the NRQL query builder button in New Relic One.](src/images/signal-consistency.png 'A screenshot showing where you can find the NRQL query builder button in New Relic One.')
