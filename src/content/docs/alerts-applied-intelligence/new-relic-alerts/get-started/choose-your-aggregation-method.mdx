...
![A screenshot showing where you can find the NRQL query builder button in New Relic One.](./images/signal-consistency.png 'A screenshot showing where you can find the NRQL query builder button in New Relic One.')
...
For example, you might have a condition with a query that returns a count of errors. Many minutes may go by with no errors at all, and then suddenly 5 errors arrive within a minute.
