...
On the **Overview** page, at a glance you'll be able to get a handle on the analytics describing how your system is (or isn't) performing. You can quickly switch between the [**Summary**](#summary), [**Issues**](#issues), [**Incidents**](#incidents), and [**Anomalies**](#anomalies) tabs to scan for critical problems affecting your systems.
