...
<Callout variant="caution">
  While you can _query_ for any existing notification channel type, you can only update a subset of them. Specifically, the **user** channel type has no editable fields, and the **Campfire** and **HipChat** channel types are both deprecated.
</Callout>
