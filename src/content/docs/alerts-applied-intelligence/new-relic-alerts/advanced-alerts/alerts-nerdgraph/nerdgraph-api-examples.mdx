...
import alertsAlertsQuery from 'images/alerts_screenshot-full_alerts-query.png'

import alertsAlertsMutations from 'images/alerts_screenshot-full_alerts-mutations.png'
