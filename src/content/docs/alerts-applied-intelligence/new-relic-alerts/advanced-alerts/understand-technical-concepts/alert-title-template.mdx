...
Let's say you run an e-commerce site and you have created an alert condition to trigger an incident whenever your site generates 200-response errors. You can use a title template to make incidents from this condition easily identifiable.
...
```
High error rate- checkout targeting `checkout` incident
```
