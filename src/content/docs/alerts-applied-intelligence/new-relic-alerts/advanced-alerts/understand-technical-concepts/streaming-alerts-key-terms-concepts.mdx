...
<CollapserGroup>
  ...
  >
    ...
    <figcaption>
      If your data arrives consistently and predictably, use <DoNotTranslate>**event flow**</DoNotTranslate>. If your data arrives inconsistently and unpredictably, use <DoNotTranslate>**event timer**</DoNotTranslate>.
    </figcaption>
  </Collapser>
</CollapserGroup>
...
You can set your aggregation window to anything between <DoNotTranslate>**30 seconds**</DoNotTranslate> and <DoNotTranslate>**6 hours**</DoNotTranslate>. The default is <DoNotTranslate>**1 minute**</DoNotTranslate>.
