...
Gap filling lets you customize the values to use when your signals do not have any data. You can fill gaps in your data streams with the last value received, a static value, or else do nothing and leave the gap there. The default is `None`.
