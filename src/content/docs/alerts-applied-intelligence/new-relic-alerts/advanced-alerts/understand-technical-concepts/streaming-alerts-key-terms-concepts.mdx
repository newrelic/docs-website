...
import alertsStreamingAlertsAggregationFlowchart from 'images/alerts_diagram_streaming-alerts-aggregation-flowchart.png'

import alertsStreamingAlerts from 'images/alerts_diagram_streaming-alerts.png'
