...
import accountsAlertsGreen from 'images/accounts_screenshot-full_alerts-green.png'

import accountsIconAlertsYellow from 'images/accounts_screenshot-full_icon-alerts-yellow.png'

import accountsIconAlertsRed from 'images/accounts_screenshot-full_icon-alerts-red.png'

import accountsIconAlertsGray from 'images/accounts_screenshot-full_icon-alerts-gray.png'

import accountsCropEventsAlertsIcon from 'images/accounts_screenshot-full_crop-events-alerts-icon.png'

import accountsCropEventsAlertsIconGreen from 'images/accounts_screenshot-full_crop-events-alerts-icon-green.png'
...
Entities in New Relic are automatically color-coded with their health status. For example, to view the health of your APM apps, go to **[one.newrelic.com](https://one.newrelic.com)**, then click **APM**. The **Applications** index lists all APM product entities and their current health status.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        <img title="Alerts v3: alert icons" alt="icon-alerts-yellow.png" src={accountsIconAlertsYellow}/> Yellow
      </td>
    ...
    <tr>
      <td>
        <img title="Alerts v3: alert icons" alt="icon-alerts-red.png" src={accountsIconAlertsRed}/> Red
      </td>
    ...
    <tr>
      <td>
        <img title="Alerts v3: alert icons" alt="icon-alerts-gray.png" src={accountsIconAlertsGray}/> Gray
      </td>
...
<img
  ...
  src={accountsCropEventsAlertsIcon}
/>
...
<img
  ...
  src={accountsCropEventsAlertsIconGreen}
/>
