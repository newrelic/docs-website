...
<Callout variant="important">
  To learn more about how conditions and policies work together, see
  [Introduction to important
  concepts](/docs/alerts/new-relic-alerts/getting-started/alert-policy-workflow#terminology).
</Callout>
...
<table>
  ...
  <tbody>
    <tr>
      <td>
        ![icon-alerts-green.png](src/images/icon-alerts-green.png "Alerts v3: alert icons") Green
      </td>
    ...
    <tr>
      <td>
        ![icon-alerts-yellow.png](src/images/icon-alerts-yellow.png "Alerts v3: alert icons") Yellow
      </td>
    ...
    <tr>
      <td>
        ![icon-alerts-red.png](src/images/icon-alerts-red.png "Alerts v3: alert icons") Red
      </td>
    ...
    <tr>
      <td>
        ![icon-alerts-gray.png](src/images/icon-alerts-gray.png "Alerts v3: alert icons") Gray
      </td>
...
![032715crop-events-no-v3.png](src/images/032715crop-events-no-v3_0.png '032715crop-events-no-v3.png')

<figcaption>
  Go to **[one.newrelic.com](https://one.newrelic.com/)**, then click
  **Explorer**: This example shows an app that currently isn't associated with
  any alerts conditions. Its grey status icon means it doesn't have any
  conditions.
</figcaption>
...
![032715crop-events-green.png](src/images/032715crop-events-green_0.png '032715crop-events-green.png')

<figcaption>
  Go to **[one.newrelic.com](https://one.newrelic.com)**, then click
  **Explorer**: This example shows an app that has one or more conditions. Its
  color-coded health status (green) shows the app hasn't reached any threshold
  violations.
</figcaption>

<Callout variant="tip">
  To view the index listing currently [open
  incidents](/docs/alerts/new-relic-alerts-beta/reviewing-alert-incidents/explore-incident-history)
  across all products, not just this entity, select **View all violations**.
</Callout>
