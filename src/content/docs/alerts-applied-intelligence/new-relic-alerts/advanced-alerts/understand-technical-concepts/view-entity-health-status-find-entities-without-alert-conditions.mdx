...
* If <DoNotTranslate>**yes**</DoNotTranslate>, its health status indicator on the selected index (APM, browser, etc.) will be color-coded to the current state. To view a summary of current alert incidents, mouse over its health status indicator.
* If <DoNotTranslate>**no**</DoNotTranslate>, its health status indicator on the selected index will appear grey.
...
Entities in New Relic are automatically color-coded with their health status. For example, to view the health of your <InlinePopover type="apm" /> apps, go to <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DoNotTranslate>, then click <DoNotTranslate>**APM**</DoNotTranslate>. The <DoNotTranslate>**Applications**</DoNotTranslate> index lists all <InlinePopover type="apm" /> product entities and their current health status.

<table>
  <thead>
    <tr>
      <th width={250}>
        <DoNotTranslate>**Color**</DoNotTranslate>
      </th>

      <th>
        <DoNotTranslate>**Health status**</DoNotTranslate>
      </th>
    </tr>
  </thead>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * The incident appears in the [<DoNotTranslate>**Incidents**</DoNotTranslate> index](/docs/alerts/new-relic-alerts-beta/reviewing-alert-incidents/explore-incident-history).
      </td>
    </tr>
...
<table>
  <thead>
    <tr>
      <th width={150}>
        <DoNotTranslate>**From...**</DoNotTranslate>
      </th>

      <th width={150}>
        <DoNotTranslate>**To...**</DoNotTranslate>
      </th>

      <th>
        <DoNotTranslate>**Transition explanation**</DoNotTranslate>
      </th>
    </tr>
  </thead>
...
Here's an example of an app listed on the <InlinePopover type="apm" /> index that <DoNotTranslate>**is not**</DoNotTranslate> associated with any conditions. Its color-coded health status is light grey, which indicates that there are currently no conditions targeting the entity or the entity's conditions are not currently generating a consistent signal.
...
<figcaption>
  Go to <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DoNotTranslate>, then click <DoNotTranslate>**Explorer**</DoNotTranslate>: This example shows an app that currently isn't associated with any alerts conditions.
</figcaption>
...
Here's an example of an app listed on the <InlinePopover type="apm" /> index that <DoNotTranslate>**is**</DoNotTranslate> associated with one or more conditions. Its color-coded health status is green, because we are collecting data for it, and currently there are no Warning (yellow) or Critical (red) incidents.
...
<figcaption>
  Go to <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DoNotTranslate>, then click <DoNotTranslate>**Explorer**</DoNotTranslate>: This example shows an app that has one or more conditions. Its color-coded health status (green) shows the app hasn't breached any threshold.
</figcaption>

<Callout variant="tip">
  To view the index listing currently [open incidents](/docs/alerts/new-relic-alerts-beta/reviewing-alert-incidents/explore-incident-history) across all products, not just this entity, select <DoNotTranslate>**View all incidents**</DoNotTranslate>.
</Callout>
