...
<figcaption>
  Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities)**, then click **Explorer**: This example shows an app that has one or more conditions. Its color-coded health status (green) shows the app hasn't reached any threshold incidents.
</figcaption>
