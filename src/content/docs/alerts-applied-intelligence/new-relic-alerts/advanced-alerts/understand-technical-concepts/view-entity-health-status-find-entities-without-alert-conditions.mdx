...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The entity's status is unknown. We're not receiving alerts data for the entity. This could mean alerts are not set up, the reporting system is down, or the entity's alert conditions are not consistently reporting a signal for the entity.
      </td>
    </tr>
  </tbody>
</table>
