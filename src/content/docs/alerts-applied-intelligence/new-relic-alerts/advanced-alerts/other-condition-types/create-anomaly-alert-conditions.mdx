...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > AI & Alerts > Policies > (create or select policy) > Create alert condition:** Anomaly alert conditions give you the ability to set intelligent, self-adjusting thresholds that only generate violations when abnormal behavior is detected.
</figcaption>

To create an anomaly condition, go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > AI & Alerts > Policies > (create or select policy) > Create alert condition**: When you start to create a [condition](/docs/alerts/new-relic-alerts/defining-conditions/define-alert-conditions#create-condition), choose one of the following [data sources](#availability):
