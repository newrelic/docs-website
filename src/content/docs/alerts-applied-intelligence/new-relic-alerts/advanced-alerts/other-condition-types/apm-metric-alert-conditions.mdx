...
In 2021, we made it easier to create NRQL alert conditions from charts and queries throughout New Relic. See below an example of how to create an <InlinePopup type="apm" /> external service condition using NRQL.
