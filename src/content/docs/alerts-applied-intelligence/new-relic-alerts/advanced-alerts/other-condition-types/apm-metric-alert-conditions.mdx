...
1. Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM** in the toolbar.
...
7. In the upper-right corner of the graph you choose, click the ellipsis icon **...** and select **Create alert condition**.

   <Callout variant="tip">
     If you don’t see the ellipsis icon **...**, ensure the **Show new view** option at the top of the page is enabled.
   </Callout>
