---
title: APM/Browser metric alert conditions
tags:
...
translate:
  - jp
metaDescription: How to create an APM or Browser metric alert condition using NRQL.
redirects:
  - /docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/apm-metric-alert-conditions
---

While there are various ways to create APM and Browser metric alert conditions, we recommend using NRQL because this provides additional controls, improved detection time, and consistency across all data types.
...
Setting up an APM or Browser metric condition is a two-part process: First, you need to identify the entity, then you create the NRQL condition.
