...
7. In the upper-right corner of the graph you choose, click the ellpisis icon **...** and select **Create alert condition**.

   <Callout variant="tip">
     If you don’t see the ellpisis icon **...**, ensure the **Show new view** option at the top of the page is enabled.
   </Callout>
