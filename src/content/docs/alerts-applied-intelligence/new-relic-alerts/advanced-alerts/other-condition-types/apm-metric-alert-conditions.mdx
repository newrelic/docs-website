...
1. Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM**</DoNotTranslate> in the toolbar.
2. Find the service you’d like to alert on.
3. Click on the service.
4. In the left navigation pane, click <DoNotTranslate>**External services**</DoNotTranslate>.
5. Under <DoNotTranslate>**Top 20 external services**</DoNotTranslate>, find the service you want and click on it.
   ...
   />
6. On the right side of the page, where you see graphs for <DoNotTranslate>**Response time**</DoNotTranslate> and <DoNotTranslate>**External calls per minute**</DoNotTranslate> (throughput), decide which of these two options you would like to alert on.
7. In the upper-right corner of the graph you choose, click the ellipsis icon <DoNotTranslate>**...**</DoNotTranslate> and select <DoNotTranslate>**Create alert condition**</DoNotTranslate>.

   <Callout variant="tip">
     If you don’t see the ellipsis icon <DoNotTranslate>**...**</DoNotTranslate>, ensure the <DoNotTranslate>**Show new view**</DoNotTranslate> option at the top of the page is enabled.
   </Callout>
...
2. In <DoNotTranslate>**Define your signal**</DoNotTranslate>, observe that any `LIMIT`, `SINCE...AGO`, and `TIMESERIES` clauses are removed so that the NRQL query syntax is valid.
