...
<CollapserGroup>
  ...
  >
    **Recommendation:** Due to the way NRQL data is streamed, set the `signal_aggregation_method` to `event_flow` and use the default settings of `1` for `signal_aggregation_window` and `2` for `signal_aggregation_timer`.
