...
<CollapserGroup>
  ...
  >
    **Recommendation:** Due to the way NRQL data is streamed, set the `aggregation_method` to `EVENT_FLOW` and use the default settings of `1` for `aggregation_window` and `2` for `aggregation_timer`.
