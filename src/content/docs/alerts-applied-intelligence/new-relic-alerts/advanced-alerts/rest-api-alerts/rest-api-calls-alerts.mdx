...
Before using the REST API to manage alerting data, read the [Intro to APIs for <InlinePopover type="alerts" /> and applied intelligence](/docs/alerts-applied-intelligence/new-relic-alerts/advanced-alerts/alerts-api/intro-alerts-api). 
