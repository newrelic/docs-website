...
For alerts with our <InlinePopover type="infrastructure" /> agent, see [REST API for infrastructure monitoring alerts](/docs/infrastructure/new-relic-infrastructure/infrastructure-alert-conditions/rest-api-calls-new-relic-infrastructure-alerts).
