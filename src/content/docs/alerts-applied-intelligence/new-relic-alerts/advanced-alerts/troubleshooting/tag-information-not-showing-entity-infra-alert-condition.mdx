...
[Custom incident description tags](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/alert-custom-violation-descriptions#example) are not being replaced by the values from the event.
