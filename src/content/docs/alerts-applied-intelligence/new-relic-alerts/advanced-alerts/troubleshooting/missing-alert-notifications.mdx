...
1. Check your [muting rules](/docs/alerts/new-relic-alerts/managing-notification-channels/muting-rules-suppress-notifications). The rules you define can mute specific incidents or mute notifications altogether. If you turn off your muting rules and start getting notifications again, you may want to rewrite your rules.
2. Check your [issue creation preference](/docs/alerts/new-relic-alerts/configuring-alert-policies/specify-when-new-relic-creates-incidents#preference-options). By default, a single issue record is created per policy. This option sends you the fewest number of notifications. If you want more notifications for each condition or incident in a policy, change your preferences.
