...
import nrqlOutlierViolations from 'images/NRQL_outlier_violations.png'
...
<img
  src={nrqlOutlierViolations}
  title="NRQL_outlier_violations.png"
  alt="New Relic Alerts - outlier NRQL alerts"
/>
