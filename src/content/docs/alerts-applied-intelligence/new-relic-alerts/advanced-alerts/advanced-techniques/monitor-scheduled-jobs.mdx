...
This only works for <DoNotTranslate>**Static**</DoNotTranslate> or <DoNotTranslate>**Anomaly**</DoNotTranslate> [threshold types](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-nrql-alert-conditions#threshold-types)..
...
2. In <DoNotTranslate>**Set your condition thresholds**</DoNotTranslate>, set the <DoNotTranslate>**Critical**</DoNotTranslate> threshold above or below where it would ever trigger.
3. Click <DoNotTranslate>**+ Add lost signal threshold**</DoNotTranslate>, then set the signal expiration duration time longer than your monitored job's scheduled cycle.
4. Check <DoNotTranslate>**Add lost signal threshold**</DoNotTranslate>.
