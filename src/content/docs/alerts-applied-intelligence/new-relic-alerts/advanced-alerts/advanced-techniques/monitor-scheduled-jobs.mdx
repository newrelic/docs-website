...
This only works for **Static** or **Anomaly** [threshold types](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/nrql-alert-conditions#threshold-types)..
