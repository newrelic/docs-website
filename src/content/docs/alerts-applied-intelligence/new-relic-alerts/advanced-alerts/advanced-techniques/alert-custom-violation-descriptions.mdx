...
<figcaption>
  In the **[one.newrelic.com](https://one.newrelic.com)** top nav, click **Alerts & AI**, click **Alert conditions (Policies)**, **(select a policy)**, then **(select a condition)**: Click **+ Add custom incident description** to open the field.
</figcaption>
