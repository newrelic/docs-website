...
For some types of conditions, you can define a custom incident description that passes useful information downstream for better incident responses or for use by other systems. You can create a custom incident description in the UI or with NRQL.
...
For some [types of conditions](#requirements), you can create a custom incident description that passes information about a condition and its incidens downstream. Using a description, you can:
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Alert conditions (Policies) > (select a policy) > (select a condition)**: Click **+ Add custom incident description** to open the field.
</figcaption>
...
## Create a custom incident description with NRQL [#create-description-nrql]

You can create a custom incident description using a NRQL alert condition by creating a mutation with a description.
