...
import alertsAlertsConditionDescription from 'images/alerts_screenshot-full_alerts-condition-description.png'

import alertsAlertViolationDescription from 'images/alerts_screenshot-full_alert-violation-description.png'
