...
When you create a condition, you set personalized <DoNotTranslate>**thresholds**</DoNotTranslate> that determine what will open an incident. This document explains what thresholds are and how to set them.
