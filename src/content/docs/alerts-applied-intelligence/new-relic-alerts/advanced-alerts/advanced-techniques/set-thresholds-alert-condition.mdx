...
When you create a condition, you set **thresholds** that determine what will open an incident. This document explains what thresholds are and how to set them.
  ...
  >
    ...
    <table>
      ...
      <tbody>
        <tr>
          <td>
            <img title="Alerts v3: Critical alert icon" alt="icon-alert-critical.png" src={iconAlertCritical}/> Critical (red)
          </td>
        ...
        <tr>
          <td>
            <img title="Alerts v3: Warning alert icon" alt="icon-alert-warning.png" src={iconAlertWarning}/> Warning (yellow)
          </td>
