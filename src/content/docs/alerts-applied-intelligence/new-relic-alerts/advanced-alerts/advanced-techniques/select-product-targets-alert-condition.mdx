...
<img
  src={policyAlertsUi}
  title="A screenshot showing the policy setup process on New Relic One's Alerts user interface."
  alt="A screenshot showing the policy setup process on New Relic One's Alerts user interface."
/>
