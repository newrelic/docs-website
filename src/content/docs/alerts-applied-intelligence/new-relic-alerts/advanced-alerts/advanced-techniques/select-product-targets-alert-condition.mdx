...
![A screenshot showing the policy setup process on alerts user interface.](./images/policy-alerts-UI.png "A screenshot showing the policy setup process on alerts user interface.")
