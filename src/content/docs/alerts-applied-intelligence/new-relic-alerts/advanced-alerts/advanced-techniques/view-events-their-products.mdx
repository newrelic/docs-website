...
import alertsCropApmIndexHealth from 'images/alerts_screenshot-full_crop-apm-index-health.png'

import alertsApmIndexActivity from 'images/alerts_screenshot-full_apm-index-activity.png'
