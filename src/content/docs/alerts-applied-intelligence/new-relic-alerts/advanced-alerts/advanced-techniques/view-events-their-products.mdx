...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities)**: Here's an example of a Summary of **Application activity**. It includes errors and incidents.
</figcaption>
...
To view an index of events resulting in alert incidents across all available products: Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI** and click the **Incidents** tab.
...
* To view the **Overview** page for the entity associated with the incident (if available), select the **Target**.
* To view the condition that triggered the incident, select the **Condition**.
