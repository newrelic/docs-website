...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/apm) > APM** : This example
  shows the violations for all of the APM applications for a specific account.
  The color-coded health states indicate Critical (red) conditions.
</figcaption>
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com)**: Here's an example of a
  Summary of **Application activity**. It includes errors and violations.
</figcaption>

Depending on the product, the recent events and activity list also may appear on the selected entity's **Overview** page.

<Callout variant="tip">
  **Exception:** The index for dashboards and Synthetic monitoring doesn't
  include a list of recent events and other activity.
</Callout>
