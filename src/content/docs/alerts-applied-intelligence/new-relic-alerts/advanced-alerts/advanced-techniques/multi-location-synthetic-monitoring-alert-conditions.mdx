...
import accountsSyntheticsMultiLocationAlertDiagram from 'images/accounts_screenshot-full_synthetics-multi-location-alert-diagram.png'
...
1. Go to **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Alert conditions (Policies)**, and start the process to [create a condition](/docs/alerts/new-relic-alerts/defining-conditions/define-alert-conditions#create-condition).
