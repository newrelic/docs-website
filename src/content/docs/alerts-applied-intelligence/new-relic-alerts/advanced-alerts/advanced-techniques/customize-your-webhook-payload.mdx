...
We support these default dynamic webhook values. For your convenience, they are listed in alphabetical order, but you can define your webhook values in any order. You may also add custom variables by using your own key/value pairs such as `"Error Type": "My Error"`.
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        For [static NRQL faceted alerts](/docs/alerts/new-relic-alerts/defining-conditions/create-alert-conditions-nrql-queries#threshold-types), the name of the facet that triggered the alert will be populated in the target’s **name** field.
