...
All conditions have a [incident time limit](#time-limit) setting that will automatically force-close a long-lasting incident.
...
* Your JVM has a CPU spike and this creates an incident. The JVM then crashes and is replaced by a new JVM. If you have not set a incident time limit, the crashed JVM’s incident will never close.
