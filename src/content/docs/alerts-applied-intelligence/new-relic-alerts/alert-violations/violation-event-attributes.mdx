...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The active condition's queried event type.

        NRQL conditions only.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        The unique identifier of the active condition's policy.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        The name of the active condition's policy.
      </td>
    </tr>
