...
Incidents determine when you are notified about violations disrupting your business. These violations occur when your given alert conditions are met like CPU overage, synthetic monitoring crashes, or slow web app response times. 
