  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * Useful if you need to be notified of every violating entity or if you have an external system where you want to send alert notifications
      </td>
    </tr>
  </tbody>
</table>
...
<figcaption>
  When you select **One issue per condition and signal** as your issue preference, it will group incidents sharing the same condition and signal into their own issue. If the same signal on a condition opens another incident after an issue opens (for example, a warning incident may open, followed by a critical incident a short time later on the same signal), that new incident is added to the same issue. Only one issue appears on your **Issues & activity** page for the selected condition/signal combination.
</figcaption>
