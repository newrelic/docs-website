...
![A screenshot showing where the incident preference button is inside the alerts user interface.](./images/incident-preference-UI.png "A screenshot showing where the incident preference button is inside the alerts user interface.")

![A screenshot showing how to change your incident preferences on the alerts user interface.](./images/incident-preference-options.png "A screenshot showing how to change your incident preferences on the alerts user interface.")
