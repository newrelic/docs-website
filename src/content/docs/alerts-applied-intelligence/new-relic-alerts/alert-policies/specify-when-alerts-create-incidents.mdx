...
Incidents determine when you are notified about violations disrupting your business. These violations occur when your given alert conditions are met like CPU overage, locational crashes, or slow web app response times. 
 
Control which policy conditions create incidents so you are notified about important occurring or reoccurring issues and not bombarded by unnecessary notifications.
 
Learn how to set incident preferences by your policy, condition, or condition and signal combination. 

<Callout variant="tip">
  To select when conditions create incidents and how violations are grouped, use the **Incident preference** setting inside your policy. Then, to view the alerts policy violations (incident records), select the **Incidents** indexes.
</Callout>
...
![A screenshot showing how to change your incident preferences on New Relic One's Alerts user interface.](./images/incident-preference.png "A screenshot showing how to change your incident preferences on New Relic One's Alerts user interface.")
...
## Example: By condition and signal [#preference-target]
