...
Each option for incident preference has its own advantages. You can select any preference for any policy, so no policy has to have the same incident preference.
...
![A screenshot showing where the incident preference button is inside New Relic One's Alerts user interface.](./images/incident-preference-UI-1.png "A screenshot showing where the incident preference button is inside New Relic One's Alerts user interface.")

![A screenshot showing how to change your incident preferences on New Relic One's Alerts user interface.](./images/incident-preferences.png "A screenshot showing how to change your incident preferences on New Relic One's Alerts user interface.")
...
If additional conditions are violated by any target after the incident opens, the violations are added to the same incident. Only one incident appears on your Incidents indexes for the selected policy.
