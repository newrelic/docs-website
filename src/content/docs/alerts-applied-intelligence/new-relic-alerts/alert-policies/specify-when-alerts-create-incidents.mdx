...
<img
  ...
  title="A screenshot showing where the incident preference button is inside New Relic One's Alerts user interface."
  alt="A screenshot showing where the incident preference button is inside New Relic One's Alerts user interface."
/>

<img
  src={incidentPreferenceOptions}
  title="A screenshot showing how to change your incident preferences on New Relic One's Alerts user interface."
  alt="A screenshot showing how to change your incident preferences on New Relic One's Alerts user interface."
/>
