...
1. Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Alert conditions (Policies)**, and then (**select a policy)**.
...
<CollapserGroup>
  ...
  >
    ...
    2. Click <Icon name="fe-settings"/> **Issue Creation Preference**.
  ...
  >
    ...
    1. From **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI**.
