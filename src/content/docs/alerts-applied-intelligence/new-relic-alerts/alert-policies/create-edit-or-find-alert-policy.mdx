...
For an explanation of how policies interact and relate to [alert conditions](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-alert-conditions/), [workflows](/docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows/) and other components, see [concepts](/docs/alerts-applied-intelligence/overview/#concepts-terms) and [workflows](/docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows/).


## Best practices for naming and organising policies [#best-practices-policies]

New Relic Alert Policies help organize alert conditions into coherent and manageable units. Beyond just categorization, they provide some control over incident correlation and the dissemination of notifications concerning potential issues. 
...
5. Select **Create & close** to create your policy OR **Set up notifications** to connect your policy to a [workflow](/docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows) and make sure that once an issues is detected/updated you receive notifications in services such as _PagerDuty_ or _Slack_.

You can continue from here to [define the conditions](/docs/alerts/new-relic-alerts-beta/configuring-alert-policies/define-alert-conditions) and [setup notifications using workflows](/docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows). If you decide to continue later, select the policy name from the **Alert policies** index.
...
<CollapserGroup>
  ...
  >
    ...
    1. Go to **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Alert Policies.**, then select a policy.
    2. Click the policy **settings* tab to edit it, type a [meaningful name](#best-practices-policies) for the policy (maximum 64 characters), and hit **Save**.
  </Collapser>
  ...
  >
    ...
    1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI > Alert Policies**, then select a policy.
    2. Click the **Settings** tab.
    3. Modify your **Issue Creation Preference** and hit **Save**.
  ...
  >
    ...
    1. From **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI**.
