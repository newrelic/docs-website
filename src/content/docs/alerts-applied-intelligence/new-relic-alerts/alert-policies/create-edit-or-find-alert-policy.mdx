...
<CollapserGroup>
  ...
  >
    To select how [incidents](/docs/alerts/new-relic-alerts-beta/reviewing-alert-incidents/specify-when-new-relic-creates-incidents) are grouped into incident records (by policy, by condition, or by target and condition):
