...
<Callout variant="tip">
  The [basic setup
  process](/docs/alerts/new-relic-alerts-beta/configuring-alert-policies/alert-policy-workflow)
  is the same, regardless of which product (APM, browser, etc.) uses the policy.
  The types of metrics and thresholds for conditions vary depending on the
...
<Callout variant="tip">
  To view [policy and condition information for a specific
  entity](/docs/alerts/new-relic-alerts-beta/configuring-alert-policies/view-policy-conditions-new-relic-products),
  select the **Settings > Alert conditions** page from the entity's product UI.
</Callout>
...
<CollapserGroup>
  ...
  >
    ...
    2. From the selected product's index, check whether the entity's color-coded health status is light green with an icon. ![icon-alerts-q-green.png](src/images/icon-alerts-q-green.png "Alerts v3: alert icons")
