...
A [policy](/docs/alerts-applied-intelligence/overview/#concepts-terms) is a group of one or more conditions. This document explains how to create a policy and how to view existing policies. You can also use the [REST API](/docs/alerts/rest-api-alerts/new-relic-alerts-rest-api/rest-api-calls-new-relic-alerts).

For an explanation of how policies interact with conditions and other components, see [concepts](/docs/alerts-applied-intelligence/overview/#concepts-terms) and [workflows](/docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows/).
...
5. Select **Create & close** to create your policy OR **Set up notifications** to connect your policy to a [workflow](/docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows).
...
1. Go to **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Alert Policies.**, and then (**select a policy)**.
...
1. Go to **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Alert Policies.**
