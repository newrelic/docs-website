...
1. Go to **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Alert conditions (Policies).**
...
1. Go to **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Alert conditions (Policies)**, and then (**select a policy)**.
...
<CollapserGroup>
  ...
  >
    ...
    1. Go to **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Channels**, then **(select a channel)**.
  ...
  >
    ...
    1. Go to **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Alert conditions (Policies)**, then **(select a policy)**.
    2. Click the policy name to edit it, then type a [meaningful name](#best-practices-policies) for the policy (maximum 64 characters).
  </Collapser>
  ...
  >
    ...
    1. Go to **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Alert conditions (Policies)**, **(select a policy) > Notification channels**.
  ...
  >
    To check whether a notification channel has any [policies assigned](/docs/alerts/new-relic-alerts-beta/managing-notification-channels/add-or-remove-policy-channels) to it: Go to **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Channels**.
  ...
  >
    ...
    1. From **[one.newrelic.com](https://one.newrelic.com) > Alerts**.
    2. On the left under **Incident intelligence > Sources** and then click **Alerts**.
