...
<CollapserGroup>
  ...
  >
    You can enable ![041715icon-condition-on](src/images/041715icon-condition-on.png "Alerts v3: Condition enabled") or disable ![041715icon-condition-off](src/images/041715icon-condition-off.png "Alerts v3: Condition disabled") any policy conditions, and the policy will continue to apply. To disable or re-enable a condition:
