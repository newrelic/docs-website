...
If you no longer need a notification channel, you can delete it. Deleting a channel is helpful when you’re no longer monitoring a condition or when your alerts needs change. 

Delete a channel by following the steps below.
