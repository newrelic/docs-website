...
Test your channel, so you can be confident in receiving relevant alert notifications before your customers begin experiencing problems. You can test specified conditions like web app response time, outlier detection, and synthetics monitoring.

Read how to request and troubleshoot an alert notification channel test.

<Callout variant="important">
  Before testing an alert notification channel, you must first save that new or updated notifications channel.
</Callout>
