...
You can create, enable, disable, and manage muting rules. Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Muting rules**</DoNotTranslate>. Enable or disable muting rules at any time. Click the <Icon name="fe-more-horizontal"/> icon on the row of each rule to edit and remove rules.
...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Muting rules**</DoNotTranslate>: You can create complex muting rules to target a small or large set of unwanted notifications.
</figcaption>
...
To create a muting rule, go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Muting rules**</DoNotTranslate> and click <DoNotTranslate>**+ Add a rule**</DoNotTranslate>. Enter a name and a description (optional) for the muting rule, and select the account to which the rule will apply.
...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Muting rules**</DoNotTranslate>: Flexible and powerful options for scheduling your muting rules.
</figcaption>
...
<CollapserGroup>
  ...
  >
    ...
    <figcaption>
      Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Issues**</DoNotTranslate> and click on a muted issue. 
    </figcaption>
  </Collapser>
  ...
  >
    ...
    <figcaption>
      <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Incidents > Open incidents**</DoNotTranslate>
    </figcaption>
  </Collapser>
