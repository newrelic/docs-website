...
You can create, enable, disable, and manage muting rules. Go to **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Muting rules**. Enable or disable muting rules at any time.
...
<CollapserGroup>
  ...
  >
    <img
      title="Alert issues lifecycle: Muting rule incidents"
      alt="Alert issue lifecycle: Muting rule incidents"
  ...
  >
    ...
    <img
      title="Alert issue lifecycle: Muting rule incidents"
      alt="Alert issue lifecycle: Muting rule incidents"
      src={mutingRulesOpenIncidents}
    />

    <figcaption>
      **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Incidents > Open incidents**
    </figcaption>
  </Collapser>
  ...
  >
    <img
      title="Alert issue lifecycle: Muting rule critical incidents"
      alt="Alert issue lifecycle: Muting rule critical incidents"
      src={mutingRulesViolations0}
    />

    <figcaption>
      **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Events**
    </figcaption>
  </Collapser>
  ...
  >
    ...
    <figcaption>
      **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Events > All events.**
    </figcaption>
  </Collapser>
</CollapserGroup>
