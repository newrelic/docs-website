...
![Manage muting rules](src/images/manage_muting_rules.png 'Manage muting rules')

<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Muting rules**:
  You can create complex muting rules to target a small or large set of unwanted
  notifications.
</figcaption>
...
<Callout variant="tip">
  Before creating muting rules, you'll need to [create policies and
  conditions](/docs/alerts/new-relic-alerts/configuring-alert-policies/create-edit-or-find-alert-policy)
  that generate violation notifications.
</Callout>
...
![Muting rule edit screen](src/images/violationfilter.png 'Muting rule edit screen')
...
<Callout variant="important">
  The **Repeat** day of the week checkboxes override the **Starts** and **Ends**
  date fields. If you set a start date and also choose a day of the week, your
  muting rules will be applied on the first of those days after your start date
</Callout>
...
<CollapserGroup>
  ...
  >
    ![Alert incident lifecycle: Muting rule violations](src/images/muting-rules-incident-violations.png "Alert incident lifecycle: Muting rule violations")
  ...
  >
    ...
    ![Alert incident lifecycle: Muting rule incidents](src/images/muting-rules-open-incidents.png "Alert incident lifecycle: Muting rule incidents")
  ...
  >
    ![Alert incident lifecycle: Muting rule critical violations](src/images/muting-rules-violations_0.png "Alert incident lifecycle: Muting rule critical violations")
  ...
  >
    ...
    ![Alert incident lifecycle: Muting rule events](src/images/muting-rules-events.png "Alert incident lifecycle: Muting rule events")
