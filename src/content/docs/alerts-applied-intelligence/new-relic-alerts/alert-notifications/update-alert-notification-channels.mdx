...
<Callout variant="tip">
  ...
  For example, if your channel type is email, then the channel will include an
  email address value. For more information, see [channel
  types](/docs/alerts-applied-intelligence/new-relic-alerts/alert-notifications/notification-channels-control-where-send-alerts/#channel-types).
</Callout>
...
4. Click **Update policy**.
  ...
  >
    ...
    1. Go to **[one.newrelic.com](https://one.newrelic.com/ "Link opens in a new window.")**, in the top nav click **Alerts & AI**, click **Notification channels**.
    2. In the list, click the **Delete** ![icon delete.png](src/images/icon-delete.png "icon delete.png") icon.
