...
<CollapserGroup>
  ...
  >
    ...
    To view or search the list of user names and emails: Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Channels**. In the search field, search for 'user'.
  </Collapser>
  ...
  >
    ...
    1. Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Alert conditions (Policies)**. Choose the policy you want to change.
  ...
  >
    ...
    1. Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Channels**.
  ...
  >
    ...
    1. Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Notification channels**.
  ...
  >
    ...
    1. Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Channels**, then choose a channel.
  ...
  >
    ...
    Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Channels**.
  ...
  >
    ...
    Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Channels**. Choose a channel, then click **Alert policies**.
    ...
    Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Alert conditions (Policies)**, choose a policy, then click **Notification channels.**
  </Collapser>
