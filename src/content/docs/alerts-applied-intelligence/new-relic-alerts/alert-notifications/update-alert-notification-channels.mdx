...
<Callout variant="tip">
  Your selected channel type determines the communication method that appears. For example, if your channel type is email, then the channel will include an email address value. For more information, see [channel types](/docs/alerts-applied-intelligence/new-relic-alerts/alert-notifications/notification-channels-control-where-send-alerts/#channel-types).
</Callout>
...
<CollapserGroup>
  ...
  >
    ...
    To view or search the list of user names and emails: Go to **[one.newrelic.com](https://one.newrelic.com)**, in the top nav click **Alerts & AI**, then click **Channels**. In the search field, search for 'user'.
  </Collapser>
  ...
  >
    ...
    1. Go to **[one.newrelic.com](https://one.newrelic.com)**, in the top nav click **Alerts & AI**, click **Alert conditions (Policies)**, and then choose the policy you want to change.
  ...
  >
    ...
    1. Go to **[one.newrelic.com](https://one.newrelic.com)**, in the top nav click **Alerts & AI**, click **Channels**.
  ...
  >
    ...
    1. Go to **[one.newrelic.com](https://one.newrelic.com)**, in the top nav click **Alerts & AI**, click **Notification channels**.
  ...
  >
    ...
    1. Go to **[one.newrelic.com](https://one.newrelic.com)**, in the top nav click **Alerts & AI**, click **Alert conditions (Policies)**.
  ...
  >
    ...
    1. Go to **[one.newrelic.com](https://one.newrelic.com)**, in the top nav click **Alerts & AI**, click **Channels**, then choose a channel.
  ...
  >
    ...
    Go to **[one.newrelic.com](https://one.newrelic.com)**, in the top nav click **Alerts & AI**, click **Channels**.
  ...
  >
    ...
    Go to **[one.newrelic.com](https://one.newrelic.com)**, in the top nav click **Alerts & AI**, click **Channels**, choose a channel, and then click **Alert policies**.
    ...
    Go to **[one.newrelic.com](https://one.newrelic.com)**, in the top nav click **Alerts & AI**, click **Alert conditions (Policies)**, choose a policy, then click **Notification channels.**
  </Collapser>
