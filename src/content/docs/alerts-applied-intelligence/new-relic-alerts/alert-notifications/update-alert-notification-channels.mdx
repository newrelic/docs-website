...
<CollapserGroup>
  ...
  >
    ...
    To view or search the list of user names and emails: Go to **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Channels**. In the search field, search for 'user'.
  </Collapser>
  ...
  >
    ...
    1. Go to **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Alert conditions (Policies)**, and then choose the policy you want to change.
  ...
  >
    ...
    1. Go to **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Channels**.
  ...
  >
    ...
    1. Go to **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Channels**, then choose a channel.
  ...
  >
    ...
    Go to **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Channels**.
  ...
  >
    ...
    Go to **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Channels**, choose a channel, and then click **Alert policies**.
    ...
    Go to **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Alert conditions (Policies)**, choose a policy, then click **Notification channels.**
  </Collapser>
