...
<CollapserGroup>
  ...
  >
    ...
    1. Go to **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Alert conditions (Policies)**. Choose the policy you want to change.
  ...
  >
    ...
    Go to **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Channels**. Choose a channel, then click **Alert policies**.
