...
<CollapserGroup>
  ...
  >
    This is the URL of the external service to be monitored. This string must **not** include the protocol. For example, use <var>example.com</var>, not <var><a href="https://example.com">[https://example.com](https://example.com)</a></var>.
