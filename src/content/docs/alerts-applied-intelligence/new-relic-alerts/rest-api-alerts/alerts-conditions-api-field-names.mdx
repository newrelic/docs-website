...
<CollapserGroup>
  ...
  >
    This is the URL of the external service to be monitored. This string must **not** include the protocol. For example, use example.com, not [https://example.com](https://example.com).
