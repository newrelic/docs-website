...
topics:
  ...
  - REST API alerts
japaneseVersion: >-
  https://docs.newrelic.co.jp/docs/alerts-applied-intelligence/new-relic-alerts/rest-api-alerts/rest-api-calls-alerts
---
...
<Table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        In general, any [role](/docs/accounts-partnerships/accounts/account-setup/users-roles) can use the account's [REST API key](/docs/apis/rest-api-v2/requirements/rest-api-key) with **GET > List** functions to **view** alerts data. The account Owner and Admins may use their API key.
    ...
    <tr>
      ...
      <td>
        You must have an Owner or Admin role in your account **and** an [Admin user's API key](/docs/apis/rest-api-v2/requirements/rest-api-key) in order to use any maintenance function, including **POST > Create**, **PUT > Add**, **PUT > Update**, and **DELETE**.
      </td>
    </tr>
  </tbody>
</Table>
...
<CollapserGroup>
  ...
  >
    To add new policies, use your [Admin user's API key](/docs/apis/rest-api-v2/requirements/rest-api-key), and include these two values in the API call:
  ...
  >
    Use this API to update an existing policy's `name` and `incident_preference`. You'll need your [Admin user's API key](/docs/apis/rest-api-v2/requirements/rest-api-key).
  ...
  >
    To delete an existing policy, use your [Admin user's API key](/docs/apis/rest-api-v2/requirements/rest-api-key), and include the `policy_id` (available from [API Explorer:](https://rpm.newrelic.com/api/explore/alerts_policies/list) **Alerts Policies > GET > List**) in the API call:
  ...
  >
    To view a list of existing policies for your account, use your [API key](/docs/apis/rest-api-v2/requirements/rest-api-key), and include these optional values in the API call:
...
<CollapserGroup>
  ...
  >
    To add new notification channels, use your [Admin user's API key](/docs/apis/rest-api-v2/requirements/rest-api-key) and include these values in the API call:
  ...
  >
    To delete an existing notification channels, use your [Admin user's API key](/docs/apis/rest-api-v2/requirements/rest-api-key), and include the `channel_id` (available from [API Explorer:](https://rpm.newrelic.com/api/explore/alerts_channels/list) **Alerts Channels > GET > List**) in the API call:
  ...
  >
    To view a list of existing notification channels for your account, use your [REST API key or Admin user's API key](/docs/apis/rest-api-v2/requirements/rest-api-key) and an optional [pagination](/docs/apis/rest-api-v2/requirements/pagination-api-output) value in the API call.
  ...
  >
    You can [associate a policy with one or more notification channels](/docs/alerts/new-relic-alerts-beta/managing-notification-channels/add-or-remove-policy-channels). You can also associate a notification channel with one or more policies. To add notification channels to policies, use your [Admin user's API key](/docs/apis/rest-api-v2/requirements/rest-api-key) and these values in the API call:
  ...
  >
    ...
    To remove a policy from a channel, or to remove a channel from a policy, use your [Admin user's API key](/docs/apis/rest-api-v2/requirements/rest-api-key) and these values in the API call:
...
<CollapserGroup>
  ...
  >
    ...
    * Your [Admin user's API key](/docs/apis/rest-api-v2/requirements/rest-api-key)
  ...
  >
    To view a list of existing conditions for your policy, use your [REST API key or Admin user's API key](/docs/apis/rest-api-v2/requirements/rest-api-key) and the associated [`policy_id`](#policies-list) in the API call.
...
<CollapserGroup>
  ...
  >
    ...
    * Your [Admin user's API key](/docs/apis/rest-api-v2/requirements/rest-api-key)
    * The condition's `id` (available from [API Explorer: <i className="fa fa-external-link fileinfo">
      \[external link\]
      </i>](https://rpm.newrelic.com/api/explore/alerts_nrql_conditions/list "Link opens in a new window.") **Alerts Nrql Conditions > GET > List**)
    * The required `condition` values in the API call (described in the API Explorer page and in the [Alerts conditions API glossary](/docs/alerts/new-relic-alerts/rest-api-alerts/alerts-conditions-api-field-names))
  ...
  >
    To view a list of existing conditions for your alert policy, use your [REST API key or Admin user's API key](/docs/apis/rest-api-v2/requirements/rest-api-key) and the associated [`policy_id`](#policies-list) in the API call.
...
<CollapserGroup>
  ...
  >
    To view a list of existing conditions for policies with external service apps (APM or Mobile), use your [REST API key or Admin user's API key](/docs/apis/rest-api-v2/requirements/rest-api-key) and the associated [`policy_id`](#policies-list) in the API call.
...
<CollapserGroup>
  ...
  >
    To view a list of existing policy conditions for Synthetic monitoring, use your [REST API key or Admin user's API key](/docs/apis/rest-api-v2/requirements/rest-api-key) and the associated [`policy_id`](#policies-list) in the API call.
...
<CollapserGroup>
  ...
  >
    To view a list of existing conditions for policies with plugin components or instances, use your [REST API key or Admin user's API key](/docs/apis/rest-api-v2/requirements/rest-api-key) and the associated [`policy_id`](#policies-list) in the API call.
...
<CollapserGroup>
  ...
  >
    ...
    * Your [REST API key or Admin user's API key](/docs/apis/rest-api-v2/requirements/rest-api-key)
