...
1. Go to <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts > Issues & Activity**</DoNotTranslate>. Click the <DoNotTranslate>**Issues**</DoNotTranslate> tab.
2. From the selected issue row, click the <Icon name="fe-more-horizontal"/> icon and select <DoNotTranslate>**Acknowledge this issue**</DoNotTranslate>.
    ...
    <img
      title="Alert page: Acknowledge this issue"
...
1. Go to <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts > Issues & Activity**</DoNotTranslate>.
