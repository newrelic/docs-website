...
![New Relic Alerts workflow diagram](src/images/new-relic-alert-creation-workflow-diagram.png 'new-relic-alert-creation-workflow-diagram.png')

<figcaption>
  To use alerts well, it will help you to understand the general flow of how the
  conditions and policies you create lead to violations and notifications.
</figcaption>
