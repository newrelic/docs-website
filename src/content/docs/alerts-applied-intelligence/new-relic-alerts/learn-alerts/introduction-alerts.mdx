...
![new-relic-set-thresholds-example.png](src/images/new-relic-set-thresholds-example_0.png 'new-relic-set-thresholds-example.png')

<figcaption>
  Go to **[one.newrelic.com](https://alerts.newrelic.com/ "Link opens in a new
  window.")**, then click **Alerts & AI > Add a condition:** This shows the
  [threshold-setting UI
  page](/docs/alerts/new-relic-alerts/defining-conditions/set-thresholds-alert-condition)
  when creating an alert condition.
</figcaption>
