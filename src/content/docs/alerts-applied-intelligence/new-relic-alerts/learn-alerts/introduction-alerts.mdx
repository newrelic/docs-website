...
<figcaption>
  Go to **[one.newrelic.com](https://alerts.newrelic.com/)**, then click **Alerts & AI > Add a condition:** This shows the [threshold-setting UI page](/docs/alerts/new-relic-alerts/defining-conditions/set-thresholds-alert-condition) when creating an alert condition.
</figcaption>
