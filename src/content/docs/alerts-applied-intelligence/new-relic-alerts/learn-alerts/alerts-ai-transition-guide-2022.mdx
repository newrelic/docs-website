...
<CollapserGroup>
  ...
  * [Sliding window aggregation](/docs/query-your-data/nrql-new-relic-query-language/nrql-query-tutorials/create-smoother-charts-sliding-windows)
  ...
  **Reason for EOL:** Current capabilities for [notification channels](/docs/alerts-applied-intelligence/new-relic-alerts/learn-alerts/alerts-concepts-workflow) are rigid and cannot be customized. They also require restrictive policy-based alert conditions that focus on incident creation.
