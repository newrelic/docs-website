...
topics:
  ...
  - Alert conditions
japaneseVersion: >-
  https://docs.newrelic.co.jp/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-baseline-alert-conditions
---
...
* Dynamically adjust to changing data and trend s, including daily or weekly trends.
