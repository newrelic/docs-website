...
7. Use **By condition** or **By condition and entity** [incident preference](/docs/alerts/new-relic-alerts/reviewing-alert-incidents/specify-when-new-relic-creates-incidents).
...
* Your [REST API key or Admin user's API key](/docs/apis/rest-api-v2/requirements/api-keys)
