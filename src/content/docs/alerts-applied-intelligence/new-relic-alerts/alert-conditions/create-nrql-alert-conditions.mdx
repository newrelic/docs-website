...
When you edit an existing NRQL condition, you have the option to add or remove tags associated with the condition entity. To do this, click the "Manage tags" button. In the menu that pops up, add or delete a tag.

<img width="794" alt="image" src="https://user-images.githubusercontent.com/26093145/166343821-2ee034c8-58c0-4aba-889b-5a3bda3529fc.png">
