...
Once enabled, set the slide by duration to control how much overlap time your aggregated windows have. The slide by duration must divide equally into the aggregation window duration and also be less than that duration.
