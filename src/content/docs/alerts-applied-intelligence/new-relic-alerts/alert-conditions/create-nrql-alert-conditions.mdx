...
4. Follow the steps explained in the [Create a NRQL alert condition from a policy](#alert-condition-from-policy) but be aware that step 2 is a bit different because, now, the query is built with the data you've previously configured.
