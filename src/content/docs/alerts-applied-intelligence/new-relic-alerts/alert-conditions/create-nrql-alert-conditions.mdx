...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Alert conditions (Policies) > (select a policy) > Add a condition**. Click **NRQL**, and then **Next, define thresholds**.
</figcaption>
...
<figcaption>
  Go to **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Alert conditions (Policies) > (select a policy)**, then **Add a condition**. Loss of signal is only available for NRQL conditions.
</figcaption>
