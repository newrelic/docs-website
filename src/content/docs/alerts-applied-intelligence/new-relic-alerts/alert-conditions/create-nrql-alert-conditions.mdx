...
import queriesPolicyNewAlertCondition from 'images/queries-nrql_screenshot_create-alert-condition.webp'

import queriesMetricExplorer from 'images/queries-nrql-metrics-create-alert-condition.gif'
...
<img
  width="80%;"
  title="create-alert-condition.png"
  alt="create-alert-condition.png"
...
3. In the chart's right corner, click the <Icon name="fe-more-horizontal"/> icon in the right corner and select **Create alert condition**.
