...
Follow these steps.
    ...
    <Collapser
        id="step1"
        title="Step 1. Add alerts"
        >
      1. Choose the **Write your own query** option. This option enables you to identify a signal and add a NRQL query.

    </Collapser>
    <Collapser
        id="step2"
        title="Step 2. Tell us where to look"
        >
      1. This option enables you to query the data you want to monitor. You can alert on basic NRQL queries that return a numerical value. See [How to use NRQL: the mechanics of querying](/docs/query-your-data/nrql-new-relic-query-language/get-started/introduction-nrql-how-nrql-works/) if you need help for adding a query.
    ...
    <Collapser
        id="step3"
        title="Step 3. Set thresholds"
        >
    
        Tune this condition to adjust for frequency, choppiness, or gaps in your signal. Here, you can configure the [data aggregation](/docs/alerts-applied-intelligence/new-relic-alerts/get-started/choose-your-aggregation-method/), the [gap-filling strategy](#data-gaps), and the [evaluation delay](#evaluation-delay). You can define [thresholds](/docs/alerts-applied-intelligence/new-relic-alerts/advanced-alerts/advanced-techniques/set-thresholds-alert-condition/) to determine what will open an incident. 
