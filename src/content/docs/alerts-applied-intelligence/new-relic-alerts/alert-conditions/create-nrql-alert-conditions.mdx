...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        If a `FACET` clause is used to scope each signal to a single entity, the [health status display](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/view-entity-health-status-find-entities-without-alert-conditions) will function properly when using a NRQL alert condition.
      </td>
    </tr>
