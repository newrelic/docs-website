...
To determine how null values will be handled, adjust the loss of signal and gap filling settings in the [Alert conditions UI](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/streaming-alerts-key-terms-concepts/#signal-loss).
...
* Change the slide-by interval (on [sliding windows aggregation](https://docs.newrelic.com/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/streaming-alerts-key-terms-concepts/#sliding-window-aggregation) conditions only)
...
Choose between [three streaming aggregation methods](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/streaming-alerts-key-terms-concepts/#aggregation-methods) to get the best evaluation results for your conditions.
