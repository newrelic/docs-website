...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert conditions (Policies) > (select a policy) > Add a condition**</DoNotTranslate>. Click <DoNotTranslate>**NRQL**</DoNotTranslate>, and then <DoNotTranslate>**Next, define thresholds**</DoNotTranslate>.
</figcaption>
...
1. Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert conditions (policies)**</DoNotTranslate>.
...
<figcaption>
  Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert conditions (Policies) > (select a policy)**</DoNotTranslate>, then <DoNotTranslate>**Add a condition**</DoNotTranslate>. Loss of signal is only available for NRQL conditions.
</figcaption>
