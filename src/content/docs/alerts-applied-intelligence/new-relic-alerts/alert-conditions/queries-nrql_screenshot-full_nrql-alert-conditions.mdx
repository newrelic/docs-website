...
To determine how null values will be handled, adjust the loss of signal and gap filling settings in the [Alert conditions UI](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-alert-conditions/#signal-loss).
...
* Change the slide-by interval (on [sliding windows aggregation](https://docs.newrelic.com/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-alert-conditions/#sliding-window-aggregation) conditions only)
