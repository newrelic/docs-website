---
title: Create and edit alert conditions using the UI
tags:
...
import alertsAlertConditionPage from 'images/alerts_screenshot-crop_alert-condition-page.webp'
 ...
 An alert condition contains certain parameters or thresholds that need to be met before you're informed. They can mitigate excessive alerting, or let your team know when new or unusual behavior appears. The **Alert conditions list** page is the universal hub for all of your alert conditions. 

This doc will walk you through the **Alert conditions list** page and show you:
...
* How to preview the condition as [Terraform or NerdGraph code](docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/view-alert-conditions#preview-as-code).
...
## Add alert condition details[#additional-details]
...
## Preview an alert condition as code [#preview-as-code]

Working with New Relic alert conditions in Terraform or NerdGraph can help with automation and consistency, integration with infrastructure management, collaboration and sharing, and enhanced flexibility. 

From the **Alert conditions details page** you can:

* Work with Terraform
* Query with NerdGraph
* Create with NerdGraph
* Update with NerdGraph
* Delete with NerdGraph

To start:

* Go to [one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > **Alerts & AI**
* Select **Alert Conditions** in the left navigation
* Then select the alert condition you want to view
* Select **View as code**

From here you can select whichever option works best for your needs. 
