...
<DocTiles>
  <DocTile title='Create your first New Relic alert' path="/docs/tutorial-create-alerts/create-new-relic-alerts/"> label={{text: "Start here", color: "green"}}A crash course in alerts for beginners </DocTile>
