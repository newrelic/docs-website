...
Alert conditions can elevate the quality of your alerts. An alert condition contains certain parameters or thresholds that need to be met before you're notified of any unusual behavior. They can mitigate excessive alerting, or let your team know when a new or unusual behavior appears
...
This example shows you how to manually create a new alert condition using the **Alert Condition** UI. If you're new to New Relic or haven't created an alert before, we recommend creating an alert condition from a chart. To get started with alerts, review our [tutorial about creating your first alert](/docs/tutorial-create-alerts/create-an-alert/). 
