...
<CollapserGroup>
  ...
  >
    [Baseline alerting](/docs/alerts/new-relic-alerts/configuring-alert-policies/create-baseline-alert-conditions) allows you to create conditions that dynamically adjust to changing data and trends, such as weekly or seasonal patterns. This feature is available for [APM](/docs/apm/new-relic-apm/getting-started/welcome-new-relic-apm) and [browser monitoring](/docs/browser/new-relic-browser/getting-started/new-relic-browser) apps, as well as [NRQL queries](/docs/alerts/new-relic-alerts/defining-conditions/create-alert-conditions-nrql-queries).
  </Collapser>

  <Collapser
    id="outlier-detection"
    title="Outlier detection conditions"
  >
    [Outlier detection](/docs/outlier-detection-nrql-alerts) attempts to find groupings in your data and then looks for values that are outliers from those groupings. Outlier detection is available only for NRQL alerts.
  </Collapser>
