...
<CollapserGroup>
  ...
  >
    ...
    We calculate alerting threshold incidents individually for each of the app's [selected instances](#instance-incidents). When creating your condition, select **JVM health metric** as the type of condition for your Java app's alert policy, then select any of the available thresholds:
