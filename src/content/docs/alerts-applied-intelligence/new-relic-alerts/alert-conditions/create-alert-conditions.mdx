...
<figcaption>
  Advanced signal settings in the creation of an alarm condition.
</figcaption>
...
<img
  ...
  alt="SScreenshot showing the set condition thresholds settings"
  src={alertsSetConditionThresholds}
/>

<figcaption>
  Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Alert conditions, then **+ New alert condition**.
</figcaption>
