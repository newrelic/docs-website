...
<CollapserGroup>
  ...
  >
    [Baseline alerting](/docs/alerts/new-relic-alerts/configuring-alert-policies/create-baseline-alert-conditions) allows you to create conditions that dynamically adjust to changing data and trends, such as weekly or seasonal patterns. This feature is available for [APM](/docs/apm/new-relic-apm/getting-started/welcome-new-relic-apm) and [Browser](/docs/browser/new-relic-browser/getting-started/new-relic-browser) apps, as well as [NRQL queries](/docs/alerts/new-relic-alerts/defining-conditions/create-alert-conditions-nrql-queries).
  </Collapser>
