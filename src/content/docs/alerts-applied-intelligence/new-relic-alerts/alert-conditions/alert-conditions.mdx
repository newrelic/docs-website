...
To create a new alert condition:
  * Go to [one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > <DoNotTranslate>**Alerts**</DoNotTranslate>.
...
1. Go to [one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > <DoNotTranslate>**Alerts**</DoNotTranslate>.
