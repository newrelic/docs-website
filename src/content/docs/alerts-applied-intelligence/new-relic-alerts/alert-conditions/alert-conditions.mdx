...
Creating a buffer:
  ...
  * <DoNotTranslate>**Cost****</DoNotTranslate>: You can use a `WHERE` clause as a [gap-filling strategy](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-nrql-alert-conditions/#example-null-zero) but it's important to remember that these can increase data ingest, impacting your bill. 
