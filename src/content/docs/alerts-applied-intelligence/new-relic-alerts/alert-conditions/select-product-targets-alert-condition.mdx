...
You can monitor the types of data that matter most to your business using targeted entities. 

A targeted entity is a specific entity you can create, view, and update. Learn how you can select and modify targeted entities.

<Callout variant="tip">
  This document helps set targeted entities for your alert condition. You must create a condition for your policy first before selecting product targets. For creating a condition, see [Create alerts conditions](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-alert-conditions/).
</Callout>
