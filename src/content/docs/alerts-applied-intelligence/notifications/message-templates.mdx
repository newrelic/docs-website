...
![A screenshot of an example webhook notification message template.](src/images/notification-payload-template.png 'An example webhook notification message template.')

<figcaption>
  Use the notification message template to map your New Relic notifications to
  the fields in your external services.
</figcaption>
...
![A screenshot of the variables menu that. shows the breadth of variable options available.](src/images/notification-custom-variables.png 'The variables menu that shows the breadth of variable options available.')

<figcaption>
  The variables menu shows the options you have when mapping New Relic
  notification fields onto the fields in your external service.
</figcaption>
