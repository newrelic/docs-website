...
In some cases, it is possible that an attribute is missing from the Variables menu, or is not always exist.
We can use the '#if' statement can be use to set a fallback
