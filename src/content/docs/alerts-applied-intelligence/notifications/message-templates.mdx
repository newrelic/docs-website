...
In some cases, such as for tags that were not present in previous issues, an attribute may be missing from the [variables menu](/docs/alerts-applied-intelligence/notifications/message-templates/#variables-menu), or not exist whatsoever.
