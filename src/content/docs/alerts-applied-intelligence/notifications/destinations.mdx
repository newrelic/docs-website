...
* CONFIGURATION_ERROR - This destination is not receiving notifications due to a configuration error. For more information, please refer to the NrIntegrationError table.
* UNKNOWN_ERROR - This destination is not receiving notifications due to an unknown error. For more information, please refer to the NrIntegrationError table.
* THROTTLING_WARNING - This destination is not receiving notifications due to a throttling error. For more information, please check your third-party destination.
* UNINSTALLED - The New Relic application was uninstalled and this destination is no longer available.
* EXTERNAL_SERVER_ERROR - This destination is not receiving notifications due to an external server error. For more information, please check your third-party destination.
* TIMEOUT_ERROR - This destination is not receiving notifications due to a timeout. For more information, please check your third-party destination.
* AUTH_ERROR - This destination is not receiving notifications. Please verify your third-party destination credentials.
