...
1. Go to **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Enrich and Notify > Destinations**. The destinations table shows information about the existing destinations and allows users to enable, disable, and modify.
