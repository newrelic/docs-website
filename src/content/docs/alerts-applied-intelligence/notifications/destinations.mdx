...
* Atlassian Jira
  * Available in [Workflows](/docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows/) and [Errors-Inbox](/docs/errors-inbox/)
* ServiceNow
  * [Workflows](/docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows/)
* Slack
  * [Workflows](/docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows/) and [Errors-Inbox](/docs/errors-inbox/)
* Webhook
  * [Workflows](/docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows/)
* Email 
  * [Workflows](/docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows/)
...
## Notifier Errors [#Notifier-errors]
...
This is especially useful if using the `Alert conditions (policies)` and [Workflows](docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows/) features. This way, a condition can be built which triggers on the event of a notification error, and a new notification can be sent elsewhere.
Example condition:
```
SELECT count(*)
...
```
Then, this condition can be used in the query builder of the workflow configuration, where one also defines an event-template. 