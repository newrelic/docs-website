...
<Callout variant="tip">
  It's also possible to configure destinations using the `aiNotifications`
  [NerdGraph
...
![Destinations overview page.](src/images/destinations-overview.png 'Destinations overview page')
...
![A screenshot of the filter tool that makes it easier to find the information you're looking for.](src/images/filter-destinations.png "The filter tool that makes it easier to find the information you're looking for.")
