...
<figcaption>
  Go to **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Destinations**. Use destinations to choose where your notifications are sent.
</figcaption>

1. Go to [one.newrelic.com](https://one.newrelic.com), click **Alerts & AI**, and in the left nav under **Enrich and Notify**, click **Destinations**. The destinations table shows information about the existing destinations and allows users to enable, disable, and modify.
