...
* UNKNOWN_ERROR - This destination isn't receiving notifications due to an unknown error. For more information, please refer to the NrIntegrationError table.
