...
* DEFAULT. This destination has no errors.
* CONFIGURATION_ERROR. This destination isn't receiving notifications due to a configuration error. For more information, please refer to the NrIntegrationError table.
* UNKNOWN_ERROR - This destination isn't receiving notifications due to an unknown error. For more information, please refer to the [NrIntegrationError table](/docs/data-apis/ingest-apis/metric-api/troubleshoot-nrintegrationerror-events/#error-details).
* THROTTLING_WARNING. This destination isn't receiving notifications due to a throttling error. For more information, please check your third-party destination.
* UNINSTALLED. The New Relic application isn't installed and this destination is no longer available.
* EXTERNAL_SERVER_ERROR. This destination isn't receiving notifications due to an external server error. For more information, please check your third-party destination.
* TIMEOUT_ERROR. This destination isn't receiving notifications due to a timeout. For more information, please check your third-party destination.
* AUTH_ERROR. This destination isn't receiving notifications. Please verify your third-party destination credentials.
