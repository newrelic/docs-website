...
If successful, there'll be a link to view the incident in JIRA.
  ...
  2. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI**, click **Destinations** and then select **Webhook**.
  ...
  4. [Download](https://store.servicenow.com/appStoreAttachments.do?sys_id=90ce114e1baa6510e0190d48624bcbd3) and follow the instructions from **Installation Guide** in the servicenow store.
