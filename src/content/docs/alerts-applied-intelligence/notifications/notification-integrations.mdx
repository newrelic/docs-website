...
<Callout variant="important">
Please note that if you are a PagerDuty Event Intelligence or Digital Operations customer using our Intelligent Alert Grouping on a given service, there could be a potential mismatch in Incidents sent back to New Relic.
</Callout>
