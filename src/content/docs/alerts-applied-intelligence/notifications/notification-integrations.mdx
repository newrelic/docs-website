...
<CollapserGroup>
  ...
  >
**Send email notifications to users with or without New Relic accounts.**
...
Every recipient will be translated into a 'destination'. You can follow the email notifications per distination in the [notifications-log](/docs/alerts-applied-intelligence/notifications/destinations/#notifications-log)
