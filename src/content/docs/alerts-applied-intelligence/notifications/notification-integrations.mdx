...
<CollapserGroup>
   ...
   Integrate New Relic with Atlassian Jira (Cloud) and automatically create, update, and close Jira issues.
    ...
    ### Configure the message template in Workflows [#configure-jira-message-template]
      ...
      To configure a template for a Jira issue:
        ...
        1. Navigate to workflows, and click on an existing workflow or the "Add a new Workflow" button
  ...
  To configure the two-way integration:
    ...
    Navigate to workflows, click on an existing workflow or the "Add a new Workflow" button and choose a servicenow destination.
  ...
  >
   Send notification messages to your Slack channels.
    ...
    Navigate to workflows, and click on an existing workflow or the "Add a new Workflow" button.
  ...
  >
   ...
   For notifications sent from workflows, you can acknowledge or close issues using [Nerdgraph](/docs/apis/nerdgraph/examples/nerdgraph-issues-api-via-github/#resolve-ack-issues)
    ...
    <Callout variant="important">
      1. Navigate to workflows, click on an existing workflow or the "Add a new Workflow" button and select a Webhook destination.
 ...
 For personal user tokens, we recommend you use a dedicated integration user that does not belong to a real user.
    ...
    ### Set up a destination [#set-up-pagerduty]
      ...
      To configure the message template:
          ...
          1. Navigate to workflows, and click on an existing workflow or the "Add a new Workflow" button and choose the Pagerduy notifier.
  ...
  >
    ...
    * **User id:** This will be automatically filled in based on the current logged in user.
    ...
    Navigate to workflows, and click on an existing workflow or the "Add a new Workflow" button and choose the mobile notifier.
