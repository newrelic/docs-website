...
If successful, there'll be a link to view the incident in JIRA.
  ...
  >
    ...
    <Callout variant="important">
      ...
      We recommend you to use the new certified integration with New Relic Workflows, which is available in the ServiceNow app store. Click [here](https://forum.newrelic.com/s/hubtopic/aAX8W00000006D7/coming-soon-a-new-integration-between-new-relic-workflows-and-servicenow) to install it. 
    </Callout>
