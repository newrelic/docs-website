...
<CollapserGroup>
  ...
  **Send email notifications to users**
  ...
  ## Set up a Email destination [#set-email-destination]
  * * There is no need to create email destinations manually, these destinations are created automaticlly when a workflow is activated or updated* * 
