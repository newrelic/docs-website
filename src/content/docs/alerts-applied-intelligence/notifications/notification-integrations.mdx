...
### Configure the Slack message template in workflows [#configure-slack-message-settings]
  ...
  3. You can choose to receive notification updates (e.g., issue acknowledged and issue closed) on the channel as well (AKA thread broadcast).
  ...
  5. Click the <DoNotTranslate>**Send test notification**</DoNotTranslate> button to send a test notification with a pre-defined example payload to the channel. This creates a message in the selected Slack channel.
