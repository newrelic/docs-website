...
Click a test notification with default field values to see the Jira issue. If successful, you'll have a link to view the incident in Jira.
  ...
  ### Associate the event-source in your AWS account, and create a rule [#eventbridge-rule]
    ...
    2. Select the button next to the partner event source and then choose <DoNotTranslate>**Associate with event bus**</DoNotTranslate>.
      ...
      The status of the event source changes from <DoNotTranslate>**Pending**</DoNotTranslate> to <DoNotTranslate>**Active**</DoNotTranslate>, and the name of the event bus updates to match your event source name. You can now start creating rules that match events from New Relic.
  ...
  ### Configure the message event template in workflows [#message-eventbridge]
    ...
    Navigate to <DoNotTranslate>**Workflows**</DoNotTranslate>, click on an existing workflow or the <DoNotTranslate>**Add a new Workflow**</DoNotTranslate> button, and choose the EventBridge destination.
  ...
  5. Filter the data you need. You can choose between <DoNotTranslate>**Basic**</DoNotTranslate> and <DoNotTranslate>**Advanced**</DoNotTranslate> options to add the issues you want to send.
  6. Click <DoNotTranslate>**Additional settings**</DoNotTranslate> to enrich your data. Enable <DoNotTranslate>**Enrich your data**</DoNotTranslate> to build a NRQL query.
  7. Click <DoNotTranslate>**Save and exit**</DoNotTranslate>.
  8. Select <DoNotTranslate>**Email**</DoNotTranslate> as notification method.
  ...
  11. Click <DoNotTranslate>**Send test notification**</DoNotTranslate> to make sure the email notifications reach the inbox.
  12. Click <DoNotTranslate>**Save**</DoNotTranslate>.
  13. Click <DoNotTranslate>**Activate workflow**</DoNotTranslate>.
...
```
  ...
  * <DoNotTranslate>**[Service integration using Events API keys](#pagerduty-sli)**</DoNotTranslate>: This single service integration uses the service level integration key, and requires a separate New Relic destination for each unique PagerDuty service.
  ...
  Before saving the destination, we recommend testing the connection by clicking the <DoNotTranslate>**Test connection**</DoNotTranslate> button.
...
Custom details in PagerDuty alerts are automatically populated.
  ...
  This integration requires to set up a New Relic PagerDuty integration in the service you would like New Relic to create incidents in. To create a New Relic integration in the PagerDuty service:
    ...
    4. Click on the right to view and copy your <DoNotTranslate>**Integration Key**</DoNotTranslate>.
  ...
  To create a ServiceNow destination:
   ...
   2. Enter the following information:
        ...
        * <DoNotTranslate>**Destination Name:**</DoNotTranslate> Custom name to identify the destination.
  ...
  To configure the <DoNotTranslate>**two-way integration**</DoNotTranslate>:
...
<Callout variant="important">
      If you don't have access to create a new destination, send an email to notificationWorkflows@newrelic.com with your account name and account number for assistance.
    </Callout>
  ...
  1. [Download](https://store.servicenow.com/sn_appstore_store.do#!/store/application/d117597d1b9b9d9078faddf7b04bcba7/1.1.0) and install the New Relic application on the ServiceNow store.
  2. Create a user inside ServiceNow. Make sure you enable the <DoNotTranslate>**Web service access only**</DoNotTranslate> option and grant the `x_newre_core.inbound_api` role to the created user. Copy and save the generated password.
  3. Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI**</DoNotTranslate>, click <DoNotTranslate>**Destinations**</DoNotTranslate>, and then select <DoNotTranslate>**Webhook**</DoNotTranslate>.
  4. Fill in the following fields:
        - <DoNotTranslate>**Webhook name**</DoNotTranslate>: A name to identify the webhook.
  ...
  5. Click <DoNotTranslate>**Save destination**</DoNotTranslate>.
...
/>
  ...
  5. Click <DoNotTranslate>**Send test notification**</DoNotTranslate> to check your changes.
  6. Click <DoNotTranslate>**Save message**</DoNotTranslate>.
  7. Click <DoNotTranslate>**Activate workflow**</DoNotTranslate>.
  ...
  3. Add your workspace name or select the relevant workspace, and click <DoNotTranslate>**Continue**</DoNotTranslate>.
  ...
  5. Click <DoNotTranslate>**Allow**</DoNotTranslate>, and return to the destination page.
...
In addition to the payload, you also have the ability to include additional HTTP headers in the webhook request. This can be useful for passing extra information or authentication tokens to the receiving endpoint. Here is a video tutorial for setting up webhooks.
  ...
  2. Enter the following information: 
     ...
     * <DoNotTranslate>**Webhook name:**</DoNotTranslate> Reference name for your webhook.
...
You can add secrets in the URL’s path and parameters, such as service ID or API keys. To avoid having these secrets exposed a masking option has been added. This option will mask everything past the domain, masking it from users and internal metrics alike. The full URL will only be used upon sending notifications. Due to the nature of this sensitive data, once the URL has been saved, the only way to edit it will be to completely override the previous URL.
...
Many users need to pass certain secrets in their headers, such as API keys and personal IDs. To prevent this sensitive information from being exposed, the custom headers authentication has been created. This will let you create headers that will be added to your notifications, while keeping their values encrypted and masked from both users and internal logs alike. In case a change in the value, the complete deletion and re-writing of the value will be needed. In case the same headers key will be used in both the Workflow channel and destination, the destination header will take precedence, and will be used instead of the channel header. 
