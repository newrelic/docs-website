...
<CollapserGroup>
  ...
  >
   Send email notifications to users.
    ...
    The Email Destination is created automatically when you create an Email settings(Notifier), so you don't need to configure them from the 'Destinations' menu.
