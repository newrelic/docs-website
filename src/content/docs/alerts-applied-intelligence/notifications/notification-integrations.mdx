...
### Sync with New Relic workflows [#two-way-sync-workflows]
  ...
  * Closure of a New Relic issue is triggered when the JIRA issue status changes to `done`.
...
Custom details in PagerDuty alerts are automatically populated.
  ...
  >
    ...
    <Callout>
    We don't recommend you to install this integration.
    
    Instead, we recommend you use the new certified integration with New Relic workflows. See how to install and use it, in the [next section](#servicenow-certified).
    </Callout>
...
<Collapser
  ...
  >
  The certified ServiceNow integration with New Relic workflows is available in the ServiceNow store.
  ...
  * From ServiceNow you can send and see as images the New Relic enrichments.
  ...
  There are these methods of integration from New Relic:

  * Using the ServiceNow application destination.
  
  * Using the webhook destination.
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                Included. It's created a New Relic connection automatically when the destination is created.
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                Yes, using tags on entities along with the default New Relic Flow designer
            </td>
            <td>
                Yes, using tags on entities and specifying in the webhook payload along with the default New Relic Flow designer
            </td>
        </tr>
    </tbody>
</table>
  ...
  Here's a short video (2:41 minutes) showing how to create a Webhook destination: 
