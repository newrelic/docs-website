...
<Callout variant="important">
  New Relic currently supports [Atlassian-Jira Classic (company-managed)
  projects](https://support.atlassian.com/jira-software-cloud/docs/what-are-team-managed-and-company-managed-projects/).
</Callout>

Before saving the destination, we recommend you test the connection via the **Test connection** button.

![A screenshot of a Jira destination configuration.](src/images/jira_destination.png 'Jira destination configuration.')
...
![A screenshot of the Jira-specific custom variables menu.](src/images/jira-template.png 'The Jira-specific custom variables menu.')
...
![A screenshot of a ServiceNow destination configuration.](src/images/serviceNow_destination.png 'ServiceNow destination configuration.')
...
![A screenshot of some recommended ServiceNow-incident fields and values.](src/images/serviceNow_message-template.png 'ServiceNow incident template.')
...
![A screenshot of the one-click Slack authentication.](src/images/slack_destination-authentication.png 'Create a Slack destination with a click.')

Add your workspace name or select the relevant workspace, and click **Continue**.

![add a workspace.](src/images/slack-sign-in.png 'add a slack workspace.')

When signed in to the selected workspace, allow New Relic to perform the specified actions.

![A screenshot permissions configurations.](src/images/slack_destination_allow_access.png 'select a workspace and configure permissions.')

Click **Allow**, and return to the destination page.

![A screenshot completed authentication.](src/images/slack_authentication_completed.png 'authentication completed successfully.')
...
![Slack settings, user is not authenticated.](src/images/slack_message-template-user-not-authenticated.png 'Authenticate to select private channels.')
...
![A screenshot of the Slack settings.](src/images/slack_channel-test-notification.png 'Slack settings tested successfully.')
...
![A screenshot of an invalid Json payload.](src/images/webhook-preview-error.png 'An invalid Json payload.')

If the webhook payload conforms a valid JSON, you can send a test notification to your defined webhook destination.

![A screenshot of a test webhook notification template.](src/images/webhook-notification-template.png 'A test webhook notification template.')
...
![A screenshot of the email settings.](src/images/email_settings.png 'Email settings')
