...
<CollapserGroup>
  ...
  To create a Jira destination follow these steps:
    ...
    1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI**, click **Destinations**, and then select **Jira**.
...
To configure a template for a Jira issue follow these steps:
    ...
    1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI > Workflows** and click on an existing workflow, or the **+ Add a new workflow** button.
...
To help you get started, we automatically populate the required and recommended fields and values. Required fields must include a value.
...
If successful, there'll be a link to view the incident in JIRA.
  ...
  >
    ...
    <Callout variant="important">
      Currently, we don't recommend you to install this integration since it's not certified by Servicenow anymore. 
      We recommend you to use the new certified integration with New Relic Workflows, which is available in the ServiceNow app store. Click [here](https://store.servicenow.com/sn_appstore_store.do#!/store/application/d117597d1b9b9d9078faddf7b04bcba7/1.0.0?referer=%2Fstore%2Fsearch%3Flistingtype%3Dallintegrations%25253Bancillary_app%25253Bcertified_apps%25253Bcontent%25253Bindustry_solution%25253Boem%25253Butility%25253Btemplate%26q%3Dnew%2520relic&sl=sh) to install it. 
    </Callout>
  ...
  To create a ServiceNow destination, follow these steps:
   ...
   1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI**, click **Workflows**. 
   2. Create a workflow or select an existing one.
   3. Under **Notify**, click **ServiceNow incidents**.
   4. From the **ServiceNow destination** dropdown, click **Create new destination** and fill in the following fields:
        - **Destination Name**: a name to identify the destination.
        - **Domain**: The URL of the destination.
        - **Username**: The name of the user to authenticate ServiceNow.
        - **Password**: The user's password to authenticate ServiceNow.
  5. Click **Test connection** to make sure the destination works. Once you see the connections is successful, click **Save destination**.
  ...
  Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI > Workflows** and click on an existing workflow, or the **+ Add a new workflow** button, and choose a ServiceNow destination.
  ...
  You can remove any non-required field and add your own.
    ...
    Click on **Send test notification** to see ServiceNow incidents with default field values. If successful, there is a link with the created incident.
  ...
  See how [to migrate from your old Slack webhook destination to the new Slack app](#migrate-slack) if you need more information about it.
  ...
  Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI**, click **Destinations**, and then select **Slack**.
  ...
  Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI > Workflows** and click on an existing workflow, or the **+ Add a workflow** button.
  ...
  1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI**, click **Destinations**, and then select **Webhook**.
...
Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI > Workflows** and click on an existing workflow, or the **+ Add a new workflow** button and select a Webhook destination.
...
The **Preview** section on the right hand-side shows an expected payload after the template is rendered. If the payload doesn't form a valid JSON, there'll be an error and you couldn't save the template.
  ...
  To create an AWS EventBridge destination follow these steps:
    ...
    1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI**, click **Destinations**, and then select **AWS EventBridge**.
  ...
  * **[Service integration using Events API keys](#pagerduty-sli)**: The single service integration uses the service level integration key, and requires a separate New Relic destination for each unique PagerDuty service.
  ...
  To create a PagerDuty destination follow these steps:
    ...
    1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI**, click **Destinations**, and then select **PagerDuty**.
  ...
  * The acknowledgment of a New Relic issue is triggered when the PagerDuty incident is acknowledged.
  ...
  To configure the message template:
    ...
    1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI > Workflows** and click on an existing workflow, or the **+ Add a new Workflow** button and choose the PagerDuty notifier.
  ...
  ### Configure when to receive push notifications in workflows [#mobile]
    ...
    Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI > Workflows** and click on an existing workflow, or the **+Add a new workflow** button and choose the mobile notifier.
