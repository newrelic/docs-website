...
Once the event template conforms to a valid JSON, you can send a test notification to AWS EventBridge.
  ...
  >
    **Webhook template for Splunk On-call**
     ...
     [Splunk On-Call webhook template for workflows](https://help.victorops.com/knowledge-base/new-relic-integration-guide/#:~:text=About%20Splunk%20On-Call%20and%20New%20Relic,-Operations%20and%20development&text=With%20the%20Splunk%20On-Call,solve%20problems%20in%20real-time)
  </Collapser>
</CollapserGroup>
