...
<CollapserGroup>
  ...
  >
    ...
    * **API Key**: For this integration, you will be asked to provide a REST API Key.
    ...
    <Callout variant="important">Two-way sync is not fully compatible with PagerDuty Intelligent Alert Grouping, it is recommended to turn off incident grouping for the relevent PagerDuty services or alternatively disable Two-way in New Relic.</Callout>
    ...
    * The acknowledgment of a New Relic issue is triggered when the PagerDuty incident is acknowledged.
    ...
    3. Find and mark the New Relic integration in the list and click  **Add**.
       <img
         ...
         src={pagerdutyAddNewrelicIntegration}
       />
    4. Click on the right to view and copy your  **Integration Key**.
       <img
         ...
         src={pagerDutyNewrelicIntegrationOpened}
       />
