...
<CollapserGroup>
  ...
  * **Closure of New Relic Issue:** triggered when the JIRA issue status changes to done.
  * **Acknowledgment of New Relic Issue:** triggered when the JIRA issue status changes to in-progress.
  ...
  * **Password:** The user's password. 
   ...
   * **Closure of New Relic Issue:** triggered when the Servicnow incident state changes to resolved.
   * **Acknowledgment of New Relic Issue:**  triggered when the Servicnow incident state changes to in-progress.
  ...
  * **API Key**: For account level integrations, paste the [General](https://support.pagerduty.com/docs/generating-api-keys#section-generating-a-general-access-rest-api-key) or [Personal](https://support.pagerduty.com/docs/generating-api-keys#section-generating-a-personal-rest-api-key) API key from PagerDuty, or paste the service level integration key.
  ...
  1. Select the PagerDuty destination you'd like to notify.
  2. For account integrations using API Key:
  ...
  3. Customize the summary received in PagerDuty.
  4. The custom details section in PagerDuty is automatically populated with predefined values from the New Relic issue.
