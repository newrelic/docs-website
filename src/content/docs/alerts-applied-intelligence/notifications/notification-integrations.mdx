...
<Collapser
  ...
  * You can configure routing policies in ServiceNow to generate tasks or other records in ServiceNow.
  ...
  * Send and see as images in ServiceNow the New Relic enrichments.



  ### Set up a webhook destination [#set-up-destination]
...
### Use the `serviceNowFields` in a Webhook payload [#serviceNowFields]
