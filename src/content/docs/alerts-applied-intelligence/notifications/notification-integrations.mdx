...
To send notifications from New Relic to EvenBridge, you need to create a message template. Follow the steps to configure a message template for an EventBridge destination:

1. Select or create a destination.
