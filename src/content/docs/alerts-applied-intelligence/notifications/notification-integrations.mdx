...
<CollapserGroup>
  ...
  >
    ...
    <Callout variant="important">
Coming Soon: A new integration with New Relic Workflows is now available in the ServiceNow app store! Click [here](https://store.servicenow.com/sn_appstore_store.do#!/store/application/d117597d1b9b9d9078faddf7b04bcba7/1.0.0?referer=%2Fstore%2Fsearch%3Flistingtype%3Dallintegrations%25253Bancillary_app%25253Bcertified_apps%25253Bcontent%25253Bindustry_solution%25253Boem%25253Butility%25253Btemplate%26q%3Dnew%2520relic&sl=sh) to request early access
    </Callout>
  ...
  >
   Send notification messages to your Slack channels.
    ...
    Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI > Workflows** and click on an existing workflow, or the **Add a new Workflow** button.
 ...
 For personal user tokens, we recommend you use a dedicated integration user that does not belong to a real user.
    ...
    ### Set up a destination [#set-up-pagerduty]
      ...
      To configure the message template:
          ...
          1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI > Workflows** and click on an existing workflow, or the **Add a new Workflow** button and choose the Pagerduy notifier.
