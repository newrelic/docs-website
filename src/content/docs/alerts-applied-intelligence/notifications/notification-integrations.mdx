...
-Closure of New Relic issue is triggered when the PagerDuty incident is resolved.
- Acknowledgment of New Relic Issue is triggered when the PagerDuty incident is acknowledged.
