...
<CollapserGroup>
  ...
  5. Filter the data you need. You choose between basic and advanced options to add the issues you want to send.
  ...
  9. Add the emails you want to send notifications to. You can add one or more recipients.
      ...
      * Find users with New Relic accounts when searching for their email address.
  ...
  10. Customize the email message.
      ...
      * The email body includes default data that can't be changed but you can also add your own customized additional details, these will appear under the Custom Details section.
