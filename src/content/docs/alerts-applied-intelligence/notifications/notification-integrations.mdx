...
If successful, there'll be a link to view the incident in JIRA.
  ...
  >
    ...
    <Callout variant="important">
      Below are instructions for the old integration which is no longer recommended by New Relic and is not certified by Servicenow. 
      From now on, a new ,certified,integration with New Relic Workflows is available in the ServiceNow app store. Click [here](https://forum.newrelic.com/s/hubtopic/aAX8W00000006D7/coming-soon-a-new-integration-between-new-relic-workflows-and-servicenow) to obtain it. 
    </Callout>
  ...
  To create a ServiceNow destination follow these steps:
   ...
   1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI**, click **Workflows**, and then select **ServiceNow**.

   2. Click on the servicenow notifier and add destination
