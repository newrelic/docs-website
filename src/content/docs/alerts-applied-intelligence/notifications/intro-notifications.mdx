...
## Message templates (Channel) [#message-templates]

A Messsgae template (AKA Channel) is a configuration object containing all the information required to send a notification event triggered by workflows and other New Relic entities. “Destination” and “Properties” are the main building blocks of a Message templates. A Message templates enables users to customize their notification event data before it’s sent to your third-party destination.
