...
Destinations are unique identifiers for third-party systems. Use destinations to integrate, share data and send notifications to your third-party platforms.
