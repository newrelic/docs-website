...
Workflows function in two layers: destinations and channels. You need to configure both destinations and channels in order for workflows to function seamlessly. 
