...
If you're reviewing or composing UI installation routines based on YAML, review these tips for maintaining consistency in your documentation.
...
In the left margin that lists the stage steps, use active verbs in the stage labels so that users can see the actions they need to take. For example:
