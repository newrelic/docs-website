...
If you're reviewing or composing UI installation routines based on YAML files, follow these tips to keep your documents consistent and to streamline your work.
...
Here's when to use unordered (bulleted) Markdown lists:

* To present information at the beginning of a stage (before steps).
* As a child list below a blue-circled ordered list or as a child list below a Markdown ordered list.
