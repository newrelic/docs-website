...
Use these when you need to insert a calculated value or result of a query into a sentence that's easy to read. The guidance is the same whether you call these fill-ins, replacements, substitutions, or any other term.
