...
Use ampersands in navigation items when space is tight, e.g., "AI & Alerts" in our main nav. Use them in sentences or headings only when they're part of a company or brand name.
...
-   Colons can be used to denote directory levels in file paths.

### Examples

-   Animal has 3 different styles for drumming: loud, louder, and deafening.
-   PATH="/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin"
-   Users:bowie:Library:Preferences:skittles.plist
