...
## What needs a peer review [#peer-reqs]

Any substantial pull request should be peer reviewed. The line between substantial and trivial is a bit blurry, so refer to the following table when in doubt:

<table>
<thead>
<tr>
<th style={{ width: "200px" }}>
Doesn't need a peer review
</th>
<th>
Needs a peer review
</th>
...
<tr>
<td>
Edits less than 5 lines.
</td>
<td>
Edits more than 5 lines.
</td>
</tr>
<tr>
<td>
Formatting and small markdown fixes such as fixing links, making a UI component bold, putting a command in a code block, etc.
</td>
<td>
Collapser and table edits.
</td>
</tr>
<tr>
<td>
Redirects not related to recent taxonomy changes.
</td>
<td>
Any changes that affect the taxonomy and redirects that result from those changes.
</td>
</tr>
</tbody>
</table>
