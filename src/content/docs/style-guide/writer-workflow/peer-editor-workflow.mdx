...
Needs peer review        
    ...
    <tr>
        <td>Collapser and table edits</td>
        <td>
            <Icon
            style={{color: '#328787'}}
            name="fe-check"
    ...
    <tr>
        <td>Redirects not related to recent taxonomy changes</td>
        <td>       
            <Icon
            style={{color: '#328787'}}
            name="fe-x-circle"
    ...
    <tr>
        <td>Redirects related to recent taxonomy changes</td>        <td>       
            <Icon
            style={{color: '#328787'}}
            name="fe-check"
        />
    ...
    <tr>
        <td>Any changes that affect the taxonomy</td>
        <td>       
            <Icon
            style={{color: '#328787'}}
            name="fe-check"
