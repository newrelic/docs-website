  ...
  <thead>
    ...
    <tr>
      ...
      <td>
        ...
        * `content`
        * `internal`, when issued by a New Relic employee
        * `external`, when issued by someone outside New Relic, or you're not sure they are an employee
        * `Jira’d`, if you create a Jira from the issue  

        If you create a Jira, don't close the original issue/PR, but feel free to remove it from the board until you work on it again.
        
        If you open an PR based on an external issue, label that PR as internal since you're doing the work.
      </td>
    </tr>
    <tr>
      <td>
...
* All writers should keep an eye on the Any TW columns. 
