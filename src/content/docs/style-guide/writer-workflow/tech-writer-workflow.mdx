...
5. Once you are satisfied with your pull request, click the green **Create pull request button**. 
...
7. At the bottom the pull request page, you will see a **Checks** section. These checks ensure your PR does not break the build process of the site. Ensure all checks marked `required` pass before merging. 
...
If you do not add the from_tw label when you first create a PR, it will not automatically assign a reviewer. If you forget to add the label before opening the PR:
