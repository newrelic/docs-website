...
Our troubleshooting docs has these main sections: **problem**, **solution**, and (optionally) **cause**. Otherwise, a troubleshooting doc uses the [basic doc template](/docs/style-guide/article-templates/basic-doc-template)
