...
Our troubleshooting docs have these main sections: **problem**, **solution**, and (optionally) **cause**. Otherwise, a troubleshooting doc uses the [basic doc template](/docs/style-guide/article-templates/basic-doc-template)
...
If there are multiple causes and solutions, consider creating a standard, [basic page](/node/add/page) doc rather than using the troubleshooting template. Consider the best approach to help the reader, and discuss your reasoning with your peer editor.
