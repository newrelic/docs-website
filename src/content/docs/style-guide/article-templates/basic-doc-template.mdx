...
If you want to include a screenshot with the section, provide a permalink for the Docs team to create the image for you. Due to [security requirements](https://nerdlife.datanerd.us/new-relic/docs-site-security-guidelines-for-images) (internal New Relic), the Docs team manages all images on the Docs site.
