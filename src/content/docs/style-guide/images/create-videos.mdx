...
import styleguideSelectingTheme from 'images/style-guide_screenshot-crop_camtasia-editing.png'
...
* Aim for simplicity: even for long videos, you should rarely have the need to do anything more than cut and move clips around. 
