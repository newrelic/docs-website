...
* Instead of reading the whole thing through multiple times, consider trying to read it once but, for sections you think weren't done well, immediately repeat that section again. This can be easily to edit than doing entire-script takes. 
