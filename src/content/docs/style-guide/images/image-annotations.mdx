...
5. In the dialog box that opens, go to `YOUR_GIT_DIRECTORY/newrelic-doc-tools/themes`, select the `New-Relic-Docs.snagtheme` file, and click **Open**.
   ...
   <img
     ...
     src="/images/style-guide_screenshot-crop_selecting_theme.webp"
   />
...
<img
  ...
  src="/images/style-guide_screenshot-full_example_callout_box.webp"
/>
...
<img
  ...
  src="/images/style-guide_screenshot-full_example_arrow.webp"
/>
