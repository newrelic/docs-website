...
Screenshots shouldn't require a text callout 99 percent of the time; `<figcaptions>` and written content before or after the image should be sufficient to explain the screenshot. However, if a text box is required, it shouldn't overlap any essential UI text or elements.
