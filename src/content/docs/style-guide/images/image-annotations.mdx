...
Image annotations are text and shapes in screen captures or diagrams that help to highlight information and focus attention on the most important aspects of the picture. Avoid the use of text inside a screenshot, use [captions](/docs/style-guide/images/screenshots-images/#captions) instead.
...
Screenshots shouldn't require additional text on them in 99% of all situations; it is the job of the written documentation itself to explain what is being represented in the screenshot. However, if a text box is required, it shouldn't overlap any essential elements of the UI.
...
Use an arrow in your screenshot when you want to highlight an element within the UI. If you decide to add an arrow to a screenshot, try to not overlap any essential elements of the UI.
