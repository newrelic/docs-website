...
Image annotations are text and shapes in screen captures or diagrams that help to highlight information and focus attention on the most important aspects of the screenshot. To avoid the use of text inside a screenshot, use [captions](/docs/style-guide/images/screenshots-images/#captions) instead.
