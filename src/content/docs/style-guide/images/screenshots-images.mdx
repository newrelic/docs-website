...
<CollapserGroup>
  ...
  >
    Here's are images that do not need captions because the surrounding text explains them:
...
* Be concise.
* Make sure annotations are easy to distinguish from UI text. For example, you may need to offset your boxes so they do not look like UI elements.
