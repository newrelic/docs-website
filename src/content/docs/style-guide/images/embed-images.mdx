...
* Our default is light mode. If a SME provides you with screenshots in dark mode please request new ones. If you are unable to get light mode images then a screenshot is better than no screenshot at all.  
