...
import indentSnippetsInListsTwo from 'images/indent-snippets-in-lists-2.png'
...
import imageIndentationOne from 'images/image-indentation-1.png'
...
Lists are a great way to explain procedures (numbered steps) or simply itemize items (bullet lists). While single-level lists are pretty straightforward, when you start nesting them, you can run into indentation issues. Take a look at these list topics in this section:
