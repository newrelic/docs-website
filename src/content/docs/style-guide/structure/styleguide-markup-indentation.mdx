...
import consecutiveListCollapserOne from 'images/indentation-consec-lists-in-collapser-1.png'

import consecutiveListCollapserTwo from 'images/indentation-consec-lists-in-collapser-2.png'
...
Lists are a great way to explain procedures (numbered steps) or simply itemize items (bullet lists). While single-level lists are pretty straightforward, when you start nesting them, you can run into indentation issues. Take a look at these list topics:
...
In the sections that follow, you'll see examples of how to indent child lists.
