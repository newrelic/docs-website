...
When you're writing in Markdown, keep in mind that indentation can make your mark-up more readable, and it can also affect its readability when it's rendered in HTML.
