...
import styleguideIndentsSnippetsinLists from 'images/style-guide_screenshot-crop_indents-snippets-in-lists.png'

import styleguideIndentsSnippetsinListRendered from 'images/style-guide_screenshot-crop_indents-snippets-in-list-rendered.png'

import styleguideIndentsWithExtraLineFeeds from 'images/style-guide_screenshot-crop_indents-with-extra-line-feeds.png'

import styleguideIndentsandImagesIncorrectExample from 'images/style-guide_screenshot-crop_indents-and-images-incorrect-example.png'

import styleguideIndentsandImagesCorrectExample from 'images/style-guide_screenshot-crop_indents-and-images-correct-example.png'

import styleguideIndentsTwoSpaceBullets from 'images/style-guide_screenshot-crop_indents-two-space-bullets.png'

import styleguideIndentsTwoSpaceNumberedList from 'images/style-guide_screenshot-crop_indents-two-space-numbered-list.png'

import styleguideIndentsFourSpaceBullets from 'images/style-guide_screenshot-crop_indents-four-space-bullets.png'

import styleguideIndentsBasicList from 'images/style-guide_screenshot-crop_indents-basic-list.png'

import styleguideIndentsNestedProcedureCorrectExample from 'images/style-guide_screenshot-crop_indents-nested-procedure-correct-example.png'

import styleguideIndentsNestedProcedureIncorrectExample from 'images/style-guide_screenshot-crop_indents-nested-procedure-incorrect-example.png'

import styleguideIndentsCollapserWithIncorrectLineFeeds from 'images/style-guide_screenshot-crop_indents-collapser-with-incorrect-line-feeds.png'

import styleguideIndentsCollapserWithCorrectLineFeeds from 'images/style-guide_screenshot-crop_indents-collapser-with-correct-line-feeds.png'

import styleguideIndentsImagesExampleOutput from 'images/style-guide_screenshot-crop_indents-images-example-output.png'
...
<img
  ...
  src={styleguideIndentsBasicList}
/>
...
<img
  ...
  src={styleguideIndentsFourSpaceBullets}
/>
...
<img
  title="Screenshot showing poor formatting of child bullet list"
  alt="Screenshot showing poor formatting of child bullet list"
  src={styleguideIndentsTwoSpaceBullets}
/>
...
<img
  ...
  src={styleguideIndentsTwoSpaceNumberedList}
/>
...
<img
  ...
  src={styleguideIndentsNestedProcedureCorrectExample}
/>
...
<img
  title="Screenshot showing two-space nesting problem"
  alt="Screenshot showing two-space nesting problem"
  src={styleguideIndentsNestedProcedureIncorrectExample}
/>
...
<img
  ...
  src={styleguideIndentsCollapserWithIncorrectLineFeeds}
/>

To avoid this unfortunate indentation and numbering, insert a second blank line feed so you have two line feeds separating the introductory sentence of the second procedure from the last numbered item of the first list. Here's how that mark-up looks:

<img
  title="Screenshot showing where to add extra line feed"
  alt="Screenshot showing where to add extra line feed"
  src={styleguideIndentsWithExtraLineFeeds}
/>
...
<img
  title="Screenshot showing how indentation in collapsers can go wrong"
  alt="Screenshot showing how indentation in collapsers can go wrong"
  src={styleguideIndentsCollapserWithCorrectLineFeeds}
/>
...
<img
  ...
  src={styleguideIndentsSnippetsinLists}
/>
...
<img
  title="Screenshot showing indentation in lists"
  alt="Screenshot showing indentation in lists"
  src={styleguideIndentsSnippetsinListRendered}
/>
...
<img
  ...
  src={styleguideIndentsImagesExampleOutput}
/>