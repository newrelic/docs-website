...
import consecutiveListCollapserOne from '/indentation-consec-lists-in-collapser-1.png'

import consecutiveListCollapserTwo from '/indentation-consec-lists-in-collapser-2.png'
...
When you nest bulleted lists under number lists, indent each child list by four spaces. Look at the example below where the initial child bullet list is not fully indented (see under step #4):
...
Inside a collapser, Markdown can get confused about how to format the indentations:
...
<img
  ...
  src={consecutiveListCollapserOne}
/>
...
<img
  title="Screenshot showing how indentation in collapsers can go wrong"
  alt="Screenshot showing how indentation in collapsers can go wrong"
  src={consecutiveListCollapserTwo}
/>
