...
<CollapserGroup>
  ...
  >
    ...
    * **Color:** The color is limited to the color of the variant you include, or if you don't include a variant, you get the default border color (blue-grey).
      ...
      Here are some additional considerations for preview docs:
      ...
      For the content inside the callout, you can use whatever text you want for the first line, but these are the requirements for the remainder of the callout:
