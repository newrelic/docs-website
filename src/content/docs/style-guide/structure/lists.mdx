...
<Callout variant="tip">
  For punctuation guidelines, follow the **[Microsoft Writing Style
  Guide](https://docs.microsoft.com/en-us/style-guide/scannable-content/lists),**
  which includes considerations for localization.
</Callout>

![Example: Ordered list as table with details](src/images/tables-example.png 'Example: Ordered list as table with details')
