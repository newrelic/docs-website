...
<table>
  <thead>
    ...
    <tr>
      ...
      <td>
          Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM & services > (select an app) > Transactions**, then select a transaction. 
      </td>
    </tr>
    <tr>
      <td>
