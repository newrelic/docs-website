...
Here's an example workflow using the Logs UI as an example: 
...
3. Remove all parts of the URL. We want simple URLs when possible. For logs, this looks like this: `https://one.newrelic.com/logger`. 
4. It'll prompt you to sign in. Sign in with a non-work email. The URL sends you to the logs page and auto-completes account ID identifying information. That page is deep linkable.
...
4. Confirm with another writer that this URL works by having them open the URL with the account ID number removed.  
