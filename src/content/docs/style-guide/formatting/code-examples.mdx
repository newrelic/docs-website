...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="How to know if the site will format your language"
  >
  If you're not sure if our site will format the code snippets for your particular language, do the following:
    ...
    3. If you still can't find your language, you can make a PR to add it to `gatsby-config.js`, assuming it is listed in the [Prism site](https://prismjs.com/#supported-languages).
