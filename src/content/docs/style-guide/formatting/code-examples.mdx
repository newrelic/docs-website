...
For languages that are casual about indendataion, we recommend that you look for similar examples and follow those patterns. In the case of NRQL, works with a wide range of indentation and grouping, we recommend you do the following to make it easier to read:

* Capitalize keywords, such as FROM, SELECT, FACET, WHERE, SINCE, ORDER BY, and JOIN.
