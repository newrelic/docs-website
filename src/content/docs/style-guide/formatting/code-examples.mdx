...
To format multi-line code blocks with a copy-paste button, surround the block of text with triple backtick characters:

```
```
This is an example
of some code surrounded with backticks
```
```
