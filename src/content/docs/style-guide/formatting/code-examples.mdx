...
![Screenshot showing how to format a Java code block](src/images/code-examples.png 'Screenshot showing how to format a Java code block')
...
<CollapserGroup>
  <Collapser id="var-tag-examples" title="Examples of using the <var> tag">
    ``` echo "license_key: <var>YOUR_LICENSE_KEY</var>" | sudo tee -a
