...
In this example, we add a link to the Ruby agent installation doc from Distributed tracing category. You can now access this doc from either the Distributed tracing category or the Ruby agent category.
```
