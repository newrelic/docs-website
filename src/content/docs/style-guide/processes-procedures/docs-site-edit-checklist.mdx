    ...
    <tr>
      ...
      <td>
        ...
        * Cropped images clearly show their relevance, with or without captions.
        ...
        In addition, make sure that screenshots and images follow the [Docs site's security guidelines](https://nerdlife.datanerd.us/new-relic/docs-site-security-guidelines-for-images) (internal New Relic).
      </td>
    </tr>
