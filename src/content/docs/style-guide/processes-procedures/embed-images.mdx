...
If you don't see the icon you want in either the [Gatsby theme](https://github.com/newrelic/gatsby-theme-newrelic/tree/develop/packages/gatsby-theme-newrelic#available-icons) or in the [docs site icons](https://github.com/newrelic/docs-website/blob/develop/src/@newrelic/gatsby-theme-newrelic/icons/feather.js#L100-L104), here's how you can add a new icon to the Gatsby theme:
