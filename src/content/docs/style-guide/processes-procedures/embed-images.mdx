...
* [Docs site Feather icons](https://github.com/newrelic/docs-website/blob/develop/src/@newrelic/gatsby-theme-newrelic/icons/feather.js#L100-L104) (These are the Feather icons that are not in the Gatsby theme, but are available in the docs project)
