...
Here are the two places you can look to see if we have the icon you need. At the moment, these locations have separate icons:

* [Gatsby theme](https://github.com/newrelic/docs-website/tree/develop/src/%40newrelic/gatsby-theme-newrelic/icons) (these are icons available across the developer and docs sites)
* [Docs site Feather icons](https://github.com/newrelic/docs-website/blob/develop/src/@newrelic/gatsby-theme-newrelic/icons/feather.js#L100-L104)
...
<Callout variant="tip">
Instead of following the instructions below, you can also ask developers add the icon you want.
</Callout>
