...
If you want to update the title in the left navigation, edit the `yml` file for the section that you're in. For example, the Style guide docs use `style-guide.yml`.
