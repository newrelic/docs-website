...
* **Category** or **sub-category**: we use these words a bit interchangeably to refer to specific areas of the docs site. For example, [this view](/docs/using-new-relic/welcome-new-relic/get-started) shows a list of docs in a specific category, as does [this higher level category view](/docs/using-new-relic). 
* **Auto-index pages**: This is another way to refer to a category view of docs (for example, [this view](/docs/using-new-relic/welcome-new-relic/get-started)). "Index" and "category" can be used a bit interchangably, but "category" is a more broad term for a section of the docs site while "auto-index page" refers to the actual page load that displays a category of docs. (Note that this is a different, more general use of "index" than the [authored index.mdx files](/docs/style-guide/article-templates/landing-page-template), which are used to display landing pages.)  
