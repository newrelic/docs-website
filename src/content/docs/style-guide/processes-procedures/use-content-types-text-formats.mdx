...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>tags</td>
      <td>
        Keywords related to your doc. 
        Start each topic with a `_`* on a new line. 
    ...
    <tr>
      <td>watermark</td>
      <td>Watermarks are customizible text backgrounds that indicate something special about a page. They look like large, faded text behind the doc's content. We used to insert watermarks in beta docs, but now we insert a [custom callout](/docs/style-guide/quick-reference/callouts#tr-custom-callout). Here are some other examples of watermarks: Legacy, Deprecated, and NR ONLY).</td>
    </tr>
