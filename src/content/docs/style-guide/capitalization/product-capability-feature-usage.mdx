...
Note that the use of "capability" here is different than our use of that word in the [user management space](/docs/accounts/accounts-billing/new-relic-one-user-management/user-permissions).
