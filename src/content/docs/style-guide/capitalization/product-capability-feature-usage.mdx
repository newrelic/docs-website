...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        First use: New Relic (docs, UI, titles) or New Relic intelligent observability platform (marketing content)
    ...
    <tr>
      ...
      <td>
        First use: New Relic intelligent observability or New Relic intelligent observability platform

        Subsequent uses: intelligent observability, intelligent observability platform, intelligent o11y, New Relic is an AI-native intelligent observability platform
      </td>

      <td>
        Do not use: New Relic Intelligent Observability, Intelligent Observability, IO, I/O
      </td>
    </tr>
