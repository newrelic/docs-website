...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        feature of application performance monitoring (APM) and is used to track and measure the end-user experience in an application
      </td>

      <td>
        First use: real use monitoring (RUM)
