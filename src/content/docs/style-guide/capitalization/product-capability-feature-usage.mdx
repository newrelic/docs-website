...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        First use: New Relic One (docs, UI, titles) or New Relic One observability platform (marketing content)
      ...
      <td>
        Do not use: New Relic One's, New Relic one, NR1
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        component of New Relic One apps; a specific UI view represented by a React JavaScript package
      </td>
    ...
    <tr>
      ...
      <td>
        component of New Relic One apps; the package containing all the files needed by that app
      </td>
    ...
    <tr>
      ...
      <td>
        component of New Relic One apps; used to store and retrieve simple sets of data
      </td>
    ...
    <tr>
      ...
      <td>
        IDE extension that integrates with New Relic One
      </td>
    ...
    <tr>
      ...
      <td>
        ecosystem of quickstarts for New Relic One
      </td>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        capability of New Relic One; detection and notification of issues
      </td>
    ...
    <tr>
      ...
      <td>
        feature of the applied intelligence capability in New Relic One that helps distinguish between typical and atypical system performance
      </td>
    ...
    <tr>
      ...
      <td>
        capability of New Relic One; using real-time data to track the uptime and reliability of an application
      </td>
    ...
    <tr>
      ...
      <td>
        capability of New Relic One; our AIOps solution; machine learning engine that reduces alert noise, correlates incidents, and automatically detects anomalies
      </td>
    ...
    <tr>
      ...
      <td>
        feature of New Relic One; automatically displays relationships between entities in topology view
      </td>
    ...
    <tr>
      ...
      <td>
        Pixie integration with New Relic One
      </td>
    ...
    <tr>
      ...
      <td>
        capability of New Relic One; our real-user monitoring (RUM) solution along with mobile monitoring
      </td>
    ...
    <tr>
      ...
      <td>
        capability of New Relic One that uses NRQL to build custom visualizations
      </td>
    ...
    <tr>
      ...
      <td>
        feature of New Relic One; navigating data in New Relic One without NRQL know-how
      </td>
    ...
    <tr>
      ...
      <td>
        bringing metrics, events, logs, and traces (MELT) data into New Relic One
      </td>
    ...
    <tr>
      ...
      <td>
        a combo of New Relic One front-end monitoring capabilities (browser, mobile, synthetics)
      </td>
    ...
    <tr>
      ...
      <td>
        feature of New Relic One; a solution for observing service requests as they flow through a distributed system
      </td>
    ...
    <tr>
      ...
      <td>
        capability of New Relic One; our error tracking solution for triaging and resolving full-stack errors
      </td>
    ...
    <tr>
      ...
      <td>
        feature of the applied intelligence capability in New Relic One that automatically groups alerts to decrease noise
      </td>
    ...
    <tr>
      ...
      <td>
        feature of the applied intelligence capability in new Relic One that correlates incidents and offers suggested responders
      </td>
    ...
    <tr>
      ...
      <td>
        capability of New Relic One that collects performance data on hosts and servers (IT infrastructure) to understand health
      </td>
    ...
    <tr>
      ...
      <td>
        capability of New Relic One; form of reporting that helps with proactive management of clusters
      </td>
    ...
    <tr>
      ...
      <td>
        capability of New Relic One; collecting, formatting, and analyzing log data to optimize systems
      </td>
    ...
    <tr>
      ...
      <td>
        feature of the log management capability in New Relic One; tracing logs throughout a complex service
      </td>
    ...
    <tr>
      ...
      <td>
        capability of New Relic One; our RUM solution along with browser monitoring
      </td>
    ...
    <tr>
      ...
      <td>
        capability of New Relic One; our solution for MLOps; observability for machine learning (ML) models in production
      </td>
    ...
    <tr>
      ...
      <td>
        capability of New Relic One; understanding how a network is experienced by users
      </td>
    ...
    <tr>
      ...
      <td>
        feature of New Relic One; NRQL- or Prom-QL-style way of asking bespoke questions of data
      </td>
    ...
    <tr>
      ...
      <td>
        feature of New Relic One; previously known as chart builder
      </td>
    ...
    <tr>
      ...
      <td>
        capability of New Relic One for Lambda and serverless functions
      </td>
    ...
    <tr>
      ...
      <td>
        feature of New Relic One; used to measure the performance of a service
      </td>
    ...
    <tr>
      ...
      <td>
        feature of New Relic One; visual representation of a service
      </td>
    ...
    <tr>
      ...
      <td>
        capability of New Relic One; simulating users across geographies to identify bottlenecks or experience issues; aka synthetic tests for APIs or browsers
      </td>
    ...
    <tr>
      ...
      <td>
        feature of New Relic One; used to aggregate the health and activity of all entities that provide a business logic
      </td>
