...
import styleguideNewRelicProductNamingHierarchy from 'images/style-guide_diagram_new-relic-product-naming-hierarchy.png'
...
A trademark is a word, name, symbol, or a combination of the three that identifies a particular product or service. [It's how customers recognize you in the marketplace and distinguish you from your competitors for those goods and services] (https://www.uspto.gov/trademarks/basics/what-trademark#:~:text=A%20trademark%20can%20be%20any,both%20trademarks%20and%20service%20marks).

A trademark name is the name of a company conducting business. The New Relic trade name is New Relic, Inc.
...
If a company we are working with has its trademark policy publicly available or has privately provided the policy to New Relic, please consult that policy and follow the company’s policy for use of the ® or ™ symbol.  If you are unsure of whether you need to acknowledge a third-party trademark in your copy, contact Legal in the #suplegal channel in Slack.
