...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The New Relic main landing page where users can click on various entities and click on **Lookout and Navigator**. In the platform, it’s referred to as the “All entities” page. Focus on describing the entity list view, and describing it in more informal ways; for example, the place you land when you open New Relic.
