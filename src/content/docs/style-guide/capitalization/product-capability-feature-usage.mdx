...
* Do not make New Relic or its platform, capabilities, and so on possessive using apostrophes. For example, use the “functionality of New Relic platform” or “the New Relic platform functionality” instead of “New Relic platform functionality.”
