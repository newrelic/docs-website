...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        generative AI observability assistant
      </td>

      <td>
        - The product is New Relic Grok, and that's how we want to present it.
        - If you're using "grok" by itself, you can only use it as a verb for its dictionary meaning. For example, "Can you grok it?" or "Ready to grok?"
        - Don't use "Grok" (uppercase first letter) as a noun without "New Relic" in front, even if it's the start of a sentence.
        - Don't use "GROK" (all uppercase) on its own to avoid the capitalization and sentence-starting rules described in the previous bullets.
      ...
      <td>
        Do not use: New Relic grok, Grok (unless preceded by "New Relic")
      </td>
    </tr>  
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        A feature of application performance monitoring (APM) and is used to track and measure the end-user experience in an application.
      </td>
