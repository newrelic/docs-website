...
Note: For more information, see our blog, [Introducing New Relic AI monitoring, the industry’s first APM for AI](https://newrelic.com/blog/how-to-relic/ai-monitoring#toc-what-is-ai-monitoring-)
      ...
      <td>
        capability of New Relic that monitors AI apps; bridges the gap between traditional application performance monitoring (APM) and the nuanced needs of AI applications
      </td>
...
<tr>
      ...
      <td>
        capability of New Relic that uses AI to track IT operations; uses AI to analyze data generated by software systems, predict possible problems, determine the root cause, and drive automated fixes; AI is both a New Relic capability and a generic term; using real-time data to track the uptime and reliability of an application
      </td>
