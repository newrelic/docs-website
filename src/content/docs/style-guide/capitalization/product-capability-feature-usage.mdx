...
<tr>
      ...
      <td>
        ...
        * Subsequent uses: New Relic AI. Also acceptable, NRAI. Although common variants have also been approved (including NR.ai, NR-AI, and nr.AI), NRAI is the preferred subsequent use.
      
       </td>

      <td>
        Do not use: AI (unless referring to AI in general and not the New Relic product), "our AI," NR AI, New Relic Grok 
