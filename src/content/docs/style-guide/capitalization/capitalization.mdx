...
## Use sentence case in headings and paragraphs [#heading_caps]

Use sentence case for headings and in paragraph text. This includes category headings and document titles. With sentence case, capitalize only the first letter of:
...
For detailed capitalization information and exceptions to the general sentence case guideline, see [Product, capability, and feature capitalization and usage](/docs/style-guide/capitalization/product-capability-feature-usage). For guidelines for capitalization in the UI, go to the [UI writing page on capitalization](/docs/style-guide/ui-writing/capitalization/).
