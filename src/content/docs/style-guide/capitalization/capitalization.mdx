...
In general, we only capitalize things when we need to. Over use of capitalization is distracting and limits accessibility for our readers with vision impairment. Read on for some guidelines on how to decide what to capitalize in a document's title, headings, products, features, and other elements of the page. Hello hello hello 
...
For detailed capitalization information, see [Product, capability, and feature capitalization and usage](/docs/style-guide/capitalization/product-capability-feature-usage). For guidelines for capitalization in the UI, go to the [UI writing page on capitalization](/docs/style-guide/ui-writing/capitalization/).
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & services > Transactions > Transaction traces > (select a trace) > Another thing**.
      </td>
    </tr>
  </tbody>
</table>
