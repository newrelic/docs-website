...
<CollapserGroup>
  ...
  >
    ...
    * Elixir
      ...
      To see a list of what we consider integrations, see the [integration](#integration) definition.
  </Collapser>
  ...
  >
    When describing how one entity communicates or is connected to another, focus on the calls and which direction they’re going. Avoid using `upstream` and `downstream` to describe these interactions. For example, `service A calls service B`, `called services`, `calling services`.
  </Collapser>
  ...
  <Collapser
    ...
    title="cyber words"
  >
    Do not separate or hyphenate words that begin with `cyber`, such as `cyberattack`, `cybersecurity`, `cyberspace`, and `cyberthreat`.
  </Collapser>
  ...
  <Collapser
    ...
    title="data center"
  >
    Two words (`data center`), not one (`datacenter`), deviating from [Microsoft guidance of one word](https://learn.microsoft.com/en-us/style-guide/a-z-word-list-term-collections/d/datacenter). We do this for consistency with our contracts.
  </Collapser>
  ...
  >
    ...
    Although it isn't common usage, you can use `dropdown` independently as a noun, without needing to say `dropdown menu` or `dropdown list`. For example, `select a date from the **Date** dropdown`.
  </Collapser>
  ...
  <Collapser
    id="e words"
    title="E words, like email or ecommerce"
  >
    E words are words that use `e` as a shorthand for electronic, like ebook, ecommerce, email, or esports. Treat e words like common nouns that follow sentence case. Do not hyphenate e words.
  </Collapser>
  ...
  >
    ...
    For an explanation of how the concept of "integration" relates to the concept of "agent," see [the usage dictionary entry for agent](#agent).
  </Collapser>
  ...
  <Collapser
    ...
    title="MLOps"
  >
    Refers to machine learning operations, which lets you automate the deployment of machine learning models. To learn more about deploying your machine learning models at scale, see our [model performance monitoring documentation](/docs/mlops/get-started/intro-mlops).
  </Collapser>
  ...
  <Collapser
    id="New-Relic-brand-name"
    title="New Relic brand name"
  >
  ...
  <Collapser
    ...
    title=".NET"
  >
    Always refer to the agent and language as `.NET`, never as `.Net` or `.net` or `dotnet`. See also [Microsoft Style Guide: .NET](https://learn.microsoft.com/en-us/style-guide/a-z-word-list-term-collections/n/net).
  ...
  >
    Don't use `monitoring` and `observability` interchangeably.
    ...
    <table>
      ...
      <tbody>
        <tr>
          <td>
            Relies on a wide range of telemetry types
          </td>

          <td>
            Often relies on a single measurement, such as metrics
          </td>
        </tr>

        <tr>
          <td>
            Provides additional context about each event
          </td>

          <td>
            Produces aggregate measurements
          </td>
        </tr>
        ...
        <tr>
          <td>
            Unexpected problems (unknown unknowns)
          </td>

          <td>
            Expected problems (known unknowns)
          </td>
        </tr>
    ...
    For more information about monitoring, see [Product and capabilities: monitoring](/docs/style-guide/capitalization/product-capability-feature-usage/#monitoring).
    For more information about observability, see [Product and cabilities: observability](/docs/style-guide/capitalization/product-capability-feature-usage/#observability).
  </Collapser>
  ...
  <Collapser
    id="on-premises-off-premises"
    title="on-premises, off-premises"
  >
  ...
  <Collapser
    id="open-source"
    title="open source, open-source"
  >
    Use lower case for `open source`. Some legal contracts may require upper case. Hyphenate as an adjective preceding a noun, as in `open-source software`.
  </Collapser>
  ...
  <Collapser
    ...
    title="skill set"
  >
    When referring to a skill set, separate into two words so it reads `skill set` and not `skillset`.
  </Collapser>
  ...
  <Collapser
    ...
    title="time series"
  >
    Include a space (time series) when referring to time series charts or graphs. Don't hyphenate as time-series. Don't run together as timeseries unless referring to the NRQL value `TIMESERIES` or `timeseries`.
  </Collapser>
