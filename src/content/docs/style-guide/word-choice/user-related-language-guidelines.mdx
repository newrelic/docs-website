...
For documentation about New Relic features, we don't document restrictions related to user type (basic vs. full platform) or default groups. The only doc we explain what's available by user type is in the 'User type' documentation. Some reasoning about why that is: 
