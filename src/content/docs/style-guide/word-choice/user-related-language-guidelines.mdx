  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        When referencing roles, we recommend linking to the [standard roles](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts#standard-roles) doc, which lists and defines the roles, and also explains how roles are related to the default groups (**Admin** and **User**).
      </td>
    </tr>
...
Before writing permission-related requirements for docs or similar use cases, you should read about [user management concepts](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts).
