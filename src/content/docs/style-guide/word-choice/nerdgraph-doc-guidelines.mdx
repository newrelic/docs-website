...
* **NerdGraph explorer.** We mainly refer to this as "the NerdGraph explorer" or "our NerdGraph explorer" but if it's in a context where it may not be obvious what exactly NerdGraph is, you can refer to the "NerdGraph API explorer." Other tips:
  * Because there are different URLs for the EU and JP versions of the NerdGraph explorer, we should generally link to [the NerdGraph explorer docs section](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph/#explorer) and not to the explorer URL.
