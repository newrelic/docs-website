...
* **Choose a doc to emulate.** When writing a new NerdGraph tutorial doc, look through the existing tutorial docs and choose one that is most similar to your content. Copy that and use it as a template. 
