...
* Data ingest-related billing impacts: for the New Relic One pricing model, data ingest is a billing factor. As a general rule, we don't talk about data ingest-related cost impacts in feature-related docs; this is because there are so many things that can raise or lower data ingest and therefore cost. Instead, we constrain talk about billing impacts to the [New Relic One pricing model doc](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/data-ingest-billing) and our [Manage data ingest doc](/docs/data-apis/manage-data/manage-data-coming-new-relic/#adjust-ingest).  
