...
* Editions:
  ...
  * Our pricing editions are formatted with title case: Standard, Pro, and Enterprise. Example use: _If your organization is on the [Pro edition](https://newrelic.com/pricing)..._
...
* Free tier. The usage-based pricing model's "[free tier](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing/#free)" is a state when an organization is on Standard edition but isn't yet paying money (either because they're under the free limits of usage or because they can't yet be charged because they haven't put in a credit card). The free tier of Standard works mostly the same as a customer who is paying for Standard, with a few exceptions, such as fewer synthetic checks allowed per month, and a few other differences in limitations. 
* Usage plans:
  * The usage-based pricing model has two methods of paying, sometimes referred to as "usage plans": pay-as-you-go and annual pool of funds.
  * Example use: _On the pay-as-you-go usage plan, your organization..._
