...
* Editions:
  ...
  * We don't refer to our [free tier](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing#free) an edition, but it is basically an edition, because it has different limits than Standard edition. To be on Standard edition means that a customer is paying and not on the free tier. 
