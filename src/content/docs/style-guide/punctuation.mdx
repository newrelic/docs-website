...
-   With a bullet list: Where there's an introductory word or phrase (often bolded), capitalize the first word in the text that follows.
-   In bullet list items with lead-ins: Where there's an introductory word or phrase (often bolded), capitalize the first word in the text that follows&mdash;even if it's not a complete sentence.
