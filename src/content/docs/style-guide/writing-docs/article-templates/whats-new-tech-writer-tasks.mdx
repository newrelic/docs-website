...
2. Confirm that the URLs to the docs site are absolute:
  <Callout variant="important">
  Relative paths don't resolve in the product UI which is why you need to use absolute paths for the posts.
  </Callout>
  ```
...
1. After you publish the post, perform a second merge to main to push the post into the product UI.
2. Follow up and confirm that the post is displayed in the UI, as well as the docs site.
