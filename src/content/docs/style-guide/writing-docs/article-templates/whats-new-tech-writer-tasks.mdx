...
3. Merge this second branch to `main`. This second merge displays the 'What's new?' post in the UI. (For those curious: the second branch contains a 'Whats new?' ID that connects the post from our docs site to the UI. The second merge is a second location.)   
