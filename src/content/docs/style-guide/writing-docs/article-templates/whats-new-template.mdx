...
1. Go to [https://github.com/newrelic/docs-website](https://github.com/newrelic/docs-website), and if you haven't forked the site yet, click **Fork**. Skip to step 2 if you've already forked the docs site.
   <img
     ...
     src="/images/style-guide_screenshot-crop_whats-new-instructions-fork.webp"
   />
...
2. Update your repo by clicking **Fetch upstream** and then clicking **Fetch and merge**.
   <img
     ...
     src="/images/style-guide_screenshot-crop_whats-new-instructions-fetch-upstream.webp"
   />
...
1. Click **develop**.
   <img
     ...
     src="/images/style-guide_screenshot-crop_whats-new-instructions-create-a-branch.webp"
   />
...
2. In the **Find or create a branch....** box, enter a name for your new branch: `whats-new-[number of month]-[day]-[feature name]` (for example, `whats-new-10-25-aggregation-methods`) and click **Create branch: [name you created in the box for your branch] from 'develop'**.
   <img
     title="Screenshot showing fetch upstream button"
     alt="Screenshot showing fetch upstream button"
     src="/images/style-guide_screenshot-crop_whats-new-instructions-create-a-branch-and-fetch-upstream.webp"
   />
...
1. Click the **src** folder.
   ...
   <img
     ...
     src="/images/style-guide_screenshot-crop_whats-new-instructions-src-folder.webp"
   />
...
5. Once you reach the folder for the appropriate year and month, click **Add File** and then **Upload files**.
   <img
     ...
     src="/images/style-guide_screenshot-crop_whats-new-instructions-upload-files-content.webp"
   />
...
8. Select the option to **Commit directly to the [name of your branch] branch**, and then click **Commit changes**.
   <img
     ...
     src="/images/style-guide_screenshot-crop_whats-new-instructions-commit-changes-content.webp"
   />
...
6. To upload your image files, click **Add file** and **Upload files**.
   <img
     ...
     src="/images/style-guide_screenshot-crop_whats-new-instructions-upload-files.webp"
   />
...
7. Drag the images files from your Finder (Mac) or Explorer (Windows) to the space or click **choose your files** and select the images files.
   <img
     ...
     src="/images/style-guide_screenshot-crop_whats-new-instructions-drag-and-drop-files-and-images.webp"
   />
...
9. Select the option to **Commit directly to the [name of your branch] branch**, and then click **Commit changes**.
   <img
     ...
     src="/images/style-guide_screenshot-crop_whats-new-instructions-commit-changes.webp"
   />
...
1. Click **Compare & pull request** that appears at the top of your screen.  
   <img
     ...
     src="/images/style-guide_screenshot-crop_whats-new-instructions-create-pull-request.webp"
   />
...
5. If you haven't already signed the CLA (contributor license agreement), you get a prompt in the pull request reminding you to sign it. Make sure you sign this to ensure the PR is accepted:
   <img
     ...
     src="/images/style-guide_screenshot-crop_whats-new-instructions-cla-signature.webp"
   />
...
1. Click the **Code** tab, and then click **branches**.
   <img
     ...
     src="/images/style-guide_screenshot-crop_whats-new-instructions-find-a-branch.webp"
   />
...
2. Find the branch you want to delete, and click the red trash can icon.
   <img
     ...
     src="/images/style-guide_screenshot-crop_whats-new-instructions-delete-branch.webp"
   />
...
3. If you accidentally delete a branch, you can always click **Restore**.
   <img
     ...
     src="/images/style-guide_screenshot-crop_whats-new-instructions-restore-deleted-branch.webp"
   />
...
3. In GitHub, click the pencil icon.
   <img
     ...
     src="/images/style-guide_screenshot-crop_whats-new-instructions-github-pencil-icon.webp"
   />
