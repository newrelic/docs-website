...
1. Go to [https://github.com/newrelic/docs-website](https://github.com/newrelic/docs-website), and if you haven't forked the site yet, click **Fork**. Skip to step 2 if you've already forked the docs site.
   <img
     title="Screenshot showing fork button"
     alt="Screenshot showing fork button"
     src={fork}
   />

2. Update your repo by clicking **Fetch upstream** and then clicking **Fetch and merge**.
   <img
     title="Screenshot showing fetch upstream button"
     alt="Screenshot showing fetch upstream button"
     src={fetchUpstream}
   />
...
1. Click **develop**.
   <img
     title="Screenshot showing the box to create a branch"
     alt="Screenshot showing the box to create a branch"
     src={createABranch}
   />
...
5. Once you reach the folder for the appropriate year and month, click **Add File** and then **Upload files**.
   <img
     title="Screenshot showing the add file button"
     alt="Screenshot showing the Add file button"
     src={uploadFilesContent}
   />
...
6. Drag the “What's new” file from your Finder (Mac) or Explorer (Windows) to the upload box or click **choose your files** and select your file.
   <img
     title="Screenshot showing the drag and drop box"
     alt="Screenshot showing the drag and drop box"
     src={dragFilesContent}
   />
...
8. Select the option to **Commit directly to the [name of your branch] branch**, and then click **Commit changes**.
   <img
     title="Screenshot showing the commit changes button"
     alt="Screenshot showing the commit changes button"
     src={commitChangesContent}
   />
...
6. To upload your image files, click **Add file** and **Upload files**.
   <img
     title="Screenshot showing the Upload files button"
     alt="Screenshot showing the Upload files button"
...
7. Drag the images files from your Finder (Mac) or Explorer (Windows) to the space or click **choose your files** and select the images files.
   <img
     title="Screenshot showing upload box"
     alt="Screenshot showing upload box"
     src={dragFilesImages}
   />
...
9. Select the option to **Commit directly to the [name of your branch] branch**, and then click **Commit changes**.
   <img
     title="Screenshot showing commit box"
     alt="Screenshot showing commit box"
     src={commitChangesImages}
   />
...
1. Click **Compare & pull request** that appears at the top of your screen.  
   <img
     title="Screenshot showing the pull request button"
     alt="Screenshot showing the pull request button"
     src={createPullRequest}
   />
...
4. Click **Create pull request**.
   <img
     title="Screenshot showing the button to create the pull request"
     alt="Screenshot showing the button to create the pull request"
     src={createPullRequestButton}
   />
...
5. If you haven't already signed the CLA (contributor license agreement), you get a prompt in the pull request reminding you to sign it. Make sure you sign this to ensure the PR is accepted:
   <img
     title="Screenshot showing the prompt to sign the CLA agreement"
     alt="Screenshot showing the prompt to sign the CLA agreement"
     src={claSignature}
   />
...
1. Click the **Code** tab, and then click **branches**.
   <img
     title="Screenshot showing the Code tab"
     alt="Screenshot showing the Code tab"
     src={deleteBranch1}
   />

2. Find the branch you want to delete, and click the red trash can icon.
   <img
     title="Screenshot showing the trash can icon"
     alt="Screenshot showing the trash can icon"
     src={deleteBranch2}
   />

3. If you accidentally delete a branch, you can always click **Restore**.
   <img
     title="Screenshot showing the Restore option"
     alt="Screenshot showing the Restore option"
     src={deleteBranch3}
   />
...
1. Go to [https://docs.newrelic.com/whats-new/](https://docs.newrelic.com/whats-new/) and use one of these methods to find your post:
   ...
   * Scroll to the date of the post on the main page and click the post.
     <img
       title="Screenshot showing different options to find a post"
       alt="Screenshot showing different options to find a post"
       src={findLivePost}
     />

2. Click **Edit page** at the bottom right of the page.
   <img
     title="Screenshot showing the edit page button"
     alt="Screenshot showing the edit page button"
     src={editPageButton}
   />

3. In GitHub, click the pencil icon.
   <img
     title="Screenshot showing the pencil icon"
     alt="Screenshot showing the pencil icon"
     src={editPencilIcon}
   />
...
5. Click **Propose** changes at the bottom left of the page.
   <img
     title="Screenshot showing option to propose changes"
     alt="Screenshot showing option to propose changes"
     src={proposeChanges}
   />
