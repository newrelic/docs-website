...
import styleguideWhatsNewInstructionsFork from 'images/style-guide_screenshot-crop_whats-new-instructions-fork.png'

import styleguideWhatsNewInstructionsFetchUpstream from 'images/style-guide_screenshot-crop_whats-new-instructions-fetch-upstream.png'

import styleguideWhatsNewInstructionsCreateaBranch from 'images/style-guide_screenshot-crop_whats-new-instructions-create-a-branch.png'

import styleguideWhatsNewInstructionsCreateaBranchandFetchUpstream from 'images/style-guide_screenshot-crop_whats-new-instructions-create-a-branch-and-fetch-upstream.png'

import styleguideWhatsNewInstructionsSrcFolder from 'images/style-guide_screenshot-crop_whats-new-instructions-src-folder.png'

import styleguideWhatsNewInstructionsUploadFilesContent from 'images/style-guide_screenshot-crop_whats-new-instructions-upload-files-content.png'

import styleguideWhatsNewInstructionsCommitChangesContent from 'images/style-guide_screenshot-crop_whats-new-instructions-commit-changes-content.png'

import styleguideWhatsNewInstructionsUploadFiles from 'images/style-guide_screenshot-crop_whats-new-instructions-upload-files.png'

import styleguideWhatsNewInstructionsDragandDropFilesandImages from 'images/style-guide_screenshot-crop_whats-new-instructions-drag-and-drop-files-and-images.png'

import styleguideWhatsNewInstructionsCommitChanges from 'images/style-guide_screenshot-crop_whats-new-instructions-commit-changes.png'

import styleguideWhatsNewInstructionsCreatePullRequest from 'images/style-guide_screenshot-crop_whats-new-instructions-create-pull-request.png'

import styleguideWhatsNewInstructionsClaSignature from 'images/style-guide_screenshot-crop_whats-new-instructions-cla-signature.png'

import styleguideWhatsNewInstructionsFindaBranch from 'images/style-guide_screenshot-crop_whats-new-instructions-find-a-branch.png'

import styleguideWhatsNewInstructionsDeleteBranch from 'images/style-guide_screenshot-crop_whats-new-instructions-delete-branch.png'

import styleguideWhatsNewInstructionsRestoreDeletedBranch from 'images/style-guide_screenshot-crop_whats-new-instructions-restore-deleted-branch.png'

import styleguideWhatsNewInstructionsGithubPencilIcon from 'images/style-guide_screenshot-crop_whats-new-instructions-github-pencil-icon.png'
