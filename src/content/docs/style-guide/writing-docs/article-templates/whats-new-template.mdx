...
import styleguideWhatsNewInstructionsFork from 'images/style-guide_screenshot-crop_whats-new-instructions-fork.webp'

import styleguideWhatsNewInstructionsFetchUpstream from 'images/style-guide_screenshot-crop_whats-new-instructions-fetch-upstream.webp'

import styleguideWhatsNewInstructionsCreateaBranch from 'images/style-guide_screenshot-crop_whats-new-instructions-create-a-branch.webp'

import styleguideWhatsNewInstructionsCreateaBranchandFetchUpstream from 'images/style-guide_screenshot-crop_whats-new-instructions-create-a-branch-and-fetch-upstream.webp'

import styleguideWhatsNewInstructionsSrcFolder from 'images/style-guide_screenshot-crop_whats-new-instructions-static-folder.webp'

import styleguideWhatsNewInstructionsUploadFilesContent from 'images/style-guide_screenshot-crop_whats-new-instructions-upload-files-content.webp'

import styleguideWhatsNewInstructionsCommitChangesContent from 'images/style-guide_screenshot-crop_whats-new-instructions-commit-changes-content.webp'

import styleguideWhatsNewInstructionsUploadFiles from 'images/style-guide_screenshot-crop_whats-new-instructions-upload-files.webp'

import styleguideWhatsNewInstructionsDragandDropFilesandImages from 'images/style-guide_screenshot-crop_whats-new-instructions-drag-and-drop-files-and-images.webp'

import styleguideWhatsNewInstructionsCommitChanges from 'images/style-guide_screenshot-crop_whats-new-instructions-commit-changes.webp'

import styleguideWhatsNewInstructionsCreatePullRequest from 'images/style-guide_screenshot-crop_whats-new-instructions-create-pull-request.webp'

import styleguideWhatsNewInstructionsClaSignature from 'images/style-guide_screenshot-crop_whats-new-instructions-cla-signature.webp'

import styleguideWhatsNewInstructionsFindaBranch from 'images/style-guide_screenshot-crop_whats-new-instructions-find-a-branch.webp'

import styleguideWhatsNewInstructionsDeleteBranch from 'images/style-guide_screenshot-crop_whats-new-instructions-delete-branch.webp'

import styleguideWhatsNewInstructionsRestoreDeletedBranch from 'images/style-guide_screenshot-crop_whats-new-instructions-restore-deleted-branch.webp'

import styleguideWhatsNewInstructionsGithubPencilIcon from 'images/style-guide_screenshot-crop_whats-new-instructions-github-pencil-icon.webp'
...
5. Save the images you reference in your Markdown file to the `static/images/` folder.
   ...
   * Make sure all your references to images in the Markdown file are prefixed with `/images/` like this: `/images/automap_preview.png`. This is because you'll eventually upload them to the `static/images` folder in GitHub.
...
1. Go to [https://github.com/newrelic/docs-website](https://github.com/newrelic/docs-website), and if you haven't forked the site yet, click **Fork**. Skip to step 2 if you've already forked the docs site.
   <img title="Screenshot showing fork button" alt="Screenshot showing fork button" src={styleguideWhatsNewInstructionsFork}/>

2. Update your repo by clicking **Fetch upstream** and then clicking **Fetch and merge**.
   <img title="Screenshot showing fetch upstream button" alt="Screenshot showing fetch upstream button" src={styleguideWhatsNewInstructionsFetchUpstream}/>
...
1. Click **develop**.
   <img title="Screenshot showing the box to create a branch" alt="Screenshot showing the box to create a branch" src={styleguideWhatsNewInstructionsCreateaBranch}/>
...
2. In the **Find or create a branch....** box, enter a name for your new branch: `whats-new-[number of month]-[day]-[feature name]` (for example, `whats-new-10-25-aggregation-methods`) and click **Create branch: [name you created in the box for your branch] from 'develop'**.
   <img title="Screenshot showing fetch upstream button" alt="Screenshot showing fetch upstream button" src={styleguideWhatsNewInstructionsCreateaBranchandFetchUpstream}/>
...
1. Click the **src** folder.
   ...
   <img
     ...
     src={styleguideWhatsNewInstructionsSrcFolder}
   />
...
5. Once you reach the folder for the appropriate year and month, click **Add File** and then **Upload files**.
   <img title="Screenshot showing the add file button" alt="Screenshot showing the Add file button" src={styleguideWhatsNewInstructionsUploadFilesContent}/>
...
8. Select the option to **Commit directly to the [name of your branch] branch**, and then click **Commit changes**.
   <img title="Screenshot showing the commit changes button" alt="Screenshot showing the commit changes button" src={styleguideWhatsNewInstructionsCommitChangesContent}/>
...
6. To upload your image files, click **Add file** and **Upload files**.
   <img title="Screenshot showing the Upload files button" alt="Screenshot showing the Upload files button" src={styleguideWhatsNewInstructionsUploadFiles}/>
...
7. Drag the images files from your Finder (Mac) or Explorer (Windows) to the space or click **choose your files** and select the images files.
   <img title="Screenshot showing upload box" alt="Screenshot showing upload box" src={styleguideWhatsNewInstructionsDragandDropFilesandImages}/>
...
9. Select the option to **Commit directly to the [name of your branch] branch**, and then click **Commit changes**.
   <img title="Screenshot showing commit box" alt="Screenshot showing commit box" src={styleguideWhatsNewInstructionsCommitChanges}/>
...
1. Click **Compare & pull request** that appears at the top of your screen.  
   <img title="Screenshot showing the pull request button" alt="Screenshot showing the pull request button" src={styleguideWhatsNewInstructionsCreatePullRequest}/>
...
5. If you haven't already signed the CLA (contributor license agreement), you get a prompt in the pull request reminding you to sign it. Make sure you sign this to ensure the PR is accepted:
   <img title="Screenshot showing the prompt to sign the CLA agreement" alt="Screenshot showing the prompt to sign the CLA agreement" src={styleguideWhatsNewInstructionsClaSignature}/>
...
1. Click the **Code** tab, and then click **branches**.
   <img title="Screenshot showing the Code tab" alt="Screenshot showing the Code tab" src={styleguideWhatsNewInstructionsFindaBranch}/>

2. Find the branch you want to delete, and click the red trash can icon.
   <img title="Screenshot showing the trash can icon" alt="Screenshot showing the trash can icon" src={styleguideWhatsNewInstructionsDeleteBranch}/>

3. If you accidentally delete a branch, you can always click **Restore**.
   <img title="Screenshot showing the Restore option" alt="Screenshot showing the Restore option" src={styleguideWhatsNewInstructionsRestoreDeletedBranch}/>
...
3. In GitHub, click the pencil icon.
   <img title="Screenshot showing the pencil icon" alt="Screenshot showing the pencil icon" src={styleguideWhatsNewInstructionsGithubPencilIcon}/>
