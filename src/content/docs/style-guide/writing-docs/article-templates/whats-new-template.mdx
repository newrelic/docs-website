...
* To help you format your content for the post, we provide a detailed template in the instructions below. After you become experiences, you may be able to reuse old posts and just change the details for your new posts.
...
5. Save the images you reference in your Markdown to the same working folder on your computer. 
...
## A completed example [#complete-example]

Here is an example of a completed post. This is a basic post, so your post may have elements that don't appear in this example:
