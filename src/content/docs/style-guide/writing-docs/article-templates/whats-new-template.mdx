...
`What's new` posts consist of a Markdown file (`.md`) explaining the feature, along with optional image files. Here's how to prepare your Markdown file and images:
...
5. Save the images you reference in your Markdown file to the `static/images/` folder.
   * Note that if you use image files, they must be ones you upload to the repository. You can't link to images hosted on other sites.
   * Make sure you don't have any spaces in image file names. You can replace spaces with dashes or underscores like this: `automap_preview.webp`.
   * Make sure all your references to images in the Markdown file are prefixed with `/images/` like this: `/images/automap_preview.webp`. This is because you'll eventually upload them to the `static/images` folder in GitHub.
...
1. Click the **src** folder.
   ...
   <img
     title="Screenshot showing the src folder"
     alt="Screenshot showing the src folder"
     src="/images/style-guide_screenshot-crop_whats-new-instructions-static-folder.webp"
   />
...
If you use image files, they must be ones you upload to the repository. You can't link to images hosted on other sites.

The upload routine is similar to your Markdown file:

1. Click the **static** folder.

2. Click the **images** folder.

3. To upload your image files, click **Add file** and **Upload files**.
...
4. Drag the images files from your Finder (Mac) or Explorer (Windows) to the space or click **choose your files** and select the images files.
...
5. Under **Commit changes**, enter a conventional commit message similar to what you did for the Markdown file (for example: `feat(whats-new): add automap images`).

6. Select the option to **Commit directly to the [name of your branch] branch**, and then click **Commit changes**.
...
1. Go to [docs.newrelic.com/whats-new](https://docs.newrelic.com/whats-new/) and find your post

2. Click **Edit page** at the bottom of the doc
