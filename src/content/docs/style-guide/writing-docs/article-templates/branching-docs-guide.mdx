...
* appInfo 
    * this step is the one where you display the content (includes recommendedGuided content) this is the step that contains the dropdown options that control what branching content is shown on the page.
