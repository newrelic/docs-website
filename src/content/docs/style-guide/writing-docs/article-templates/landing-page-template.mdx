...
<Callout variant="tip">
  In the front matter, the following are optional: `tags`, `translate`, and
  `redirects`. So, you can leave them out if they don't have any values.
</Callout>
...
<LandingPageHero>
  ...
  ![<var>INSERT_ALT-TEXT_HERE</var>](src/images/<var>INSERT_IMAGE_FILE_NAME</var>.png "<var>INSERT_THE_IMAGE_TITLE_HERE</var>")
...
- Insert a value for `icon` by prefixing the icon name with `fe-` (Feather icons), `logo-` (third-party logos), or `nr-` (New Relic logos). For example, here is the format for a feather icon: `fe-alert-triangle`).
  <Callout variant="tip">
    For more details about icons, see [Embed
    images](/docs/style-guide/processes-procedures/embed-images).
  </Callout>
