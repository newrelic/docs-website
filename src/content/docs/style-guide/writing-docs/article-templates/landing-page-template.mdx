...
<Callout variant="important">
  This landing page information does _not_ apply to the docs home page.
</Callout>
...
* Insert a value for `icon` by prefixing the icon name with `fe-` (Feather icons), `logo-` (third-party logos), or `nr-` (New Relic logos). For example, here is the format for a feather icon:  `fe-alert-triangle`).
  <Callout variant="tip">For more details about icons, see [Embed images](/docs/style-guide/processes-procedures/embed-images).</Callout>
