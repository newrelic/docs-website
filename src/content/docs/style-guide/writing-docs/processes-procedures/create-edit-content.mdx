...
import styleguideProvideNewDirectoryName from 'images/style-guide_screenshot-crop_provide-new-directory-name.webp'

import styleguideHowtoUseThisFork from 'images/style-guide_screenshot-crop_how-to-use-this-fork.webp'

import styleguideCreateNewForkBranch from 'images/style-guide_screenshot-crop_create-new-fork-branch.webp'
...
If you want to make changes directly in your contributors fork, you can clone the fork and push up changes right into the same branch that the contributor was working on. 

You'll need to have permission to do so, and you should always check with your contributor to make sure they aren't working in the branch at the same time.

### Clone fork and create new branch [#push-to-different-branch]

If you'd prefer a more collaborative approach, you can clone the contributors fork, and then create a branch off the contributor's branch. After you complete your changes, you can create a pull request asking the contributor to pull in your changes.

Here's how you'd do this GitHub Desktop:

1. In GitHub Desktop under **Current Repository**, click **Add > Clone Repository**.
2. Under **Clone a Repository**, click the **URL** tab.
3. In **Local Path**, modify the name of the directory where this will appear. For example, add the contributor's initials:
    <img
        title="Screen capture showing how to modify local path"
        alt="Screen capture showing how to modify local path"
        src={styleguideProvideNewDirectoryName}
    />
4. Under **How are you planning to use this fork?**, select **For my own purposes**, and then click **Continue**.
    <img
        title="Screenshot showing how to choose the purpose of fork"
        alt="Screenshot showing how to choose the purpose of fork"
        src={styleguideHowtoUseThisFork}
    />
5. Switch to your new respository and the original branch used by the contributor.
6. Create a new branch based on that original contributor branch.
    <img
        title="Screenshot showing how to create new branch"
        alt="Screenshot showing how to create new branch"
        src={styleguideCreateNewForkBranch}
    />
7. Make changes in your new branch and commit them.
8. Create a PR from your branch into the original branch created by the contributor.
