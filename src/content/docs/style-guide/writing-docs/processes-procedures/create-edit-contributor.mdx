...
Below are two options for contributing. We recommend option one if you plan on making infrequent changes to the docs site. We recommend option two for most cases, but especially if you plan on making regular contributions.   

<CollapserGroup>
    <Collapser
        id="simple-edit"
        title="Option 1: Make a simple change from the docs site"
    >
