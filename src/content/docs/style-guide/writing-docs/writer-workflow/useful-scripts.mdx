...
Use `yarn verify-mdx` to check for common issues in your MDX files. It also checks for common image import errors, like mismatches between filenames and image aliases. If you run this command without a filepath, it will check every single MDX file in the docs repo. This can take a few minutes. 
