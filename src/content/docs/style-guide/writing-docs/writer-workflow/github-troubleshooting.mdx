...
<CollapserGroup>
  <Collapser
    className="freq-link"
    id="sign-out"
    title="Sign out/sign in Github Deskptop"
  >
In GitHub Desktop, go to Preferences and log out/back in.
  </Collapser>
</CollapserGroup>Re-log in to GitHub Desktop
...
Check your these files for common markdown mistakes:
...
Local site is throwing 404 errors.

### Solutions

Try these solutions to troubleshoot problems running your local build:
