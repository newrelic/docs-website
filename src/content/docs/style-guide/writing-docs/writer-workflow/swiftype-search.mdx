...
1. Go to the page in the UI that needs a better help doc and click the question mark (?) icon in the upper-right corner:
   <img title="Screenshot showing the UI question mark button" alt="Screenshot showing the UI question mark button" src="/images/style-guide_screenshot-crop_new-relic-ui-question-mark.webp"/>
2. Copy the value of the search term that is automatically populated by that page in the search bar.
   <img title="Screenshot showing how to find the search string in the UI." alt="Screenshot showing how to find the search string in the UI." src="/images/style-guide_screenshot-crop_ui-search-string.webp"/>
3. Log into Swiftype.
