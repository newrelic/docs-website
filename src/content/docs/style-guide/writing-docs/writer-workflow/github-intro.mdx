...
* Do not link to anything non-public from a public place.
...
* Do not mention traffic or usage numbers publicly.
* Do not reference internal people by name. If they have a GH account, @mention their GH handle. If they do not, talk instead about teams ("talk to a browser team engineer" or "Support Engineer") rather than people.
