...
<table>
  <thead>
    ...
    <tr>
      ...
      <td>
        Drag PRs to this column when you are working on them. Make sure your face is on the PRs so other writers don’t mistakenly work on it.
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        This is where you insert your PRs when you are ready to get a review. This is for all types of reviews: everything from minor PRs to PRs related to complicated Jiras.
    ...
    <tr>
      ...
      <td>
        ...
        2. Review the PR in GitHub and leave comments.
        3. When you are finished with the review, move it to ** Waiting on technical writer to merge**.
      </td>
    </tr>
    <tr>
      <td>
