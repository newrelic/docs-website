...
Once you've installed `nvm`, you can install the correct version of Node. Node, or Node.js, is the JavaScript engine that powers our Gatsby site and its dependencies. Type `nvm use 18` to install Node.js version 16.
