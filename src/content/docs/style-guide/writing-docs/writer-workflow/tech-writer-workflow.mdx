...
6. Clone the entire repository to your local machine. You will not need to clone the repo again.
 
Check your repo was cloned by navigating to your local GitHub folder. 

## 2. Create a branch and edit the docs [#edit-doc]
...
1. Click on **Current Branch** and select **New Branch**. Give it a meaningful name.
2. Navigate to a doc you want to edit.
...
## 3. Commit your changes [#commit-changes]
Even though you've saved your edits, you still need to make a commit. You can think of a commit like a checkpoint in your workflow. The commit process begins with staging and ends when push your changes upstream to GitHub. 

1. Navigate back to GitHub Desktop and check out the left column. You should see:
...
## 4. Run the site locally [#run-site]
...
Node and Yarn are tools used to build the site on your local machine.
...
Once you're satisfied with doc, you'll want to push all of your commits upstream. This makes them available to everyone else in the GitHub repository. 
...
Now you're ready for a Pull Request. 

## 6. Open your pull request [#open-pr]
Your commits are available to everyone, but you'll need to notify people that your changes are ready to be merged into the `develop` branch.
...
2. This will open GitHub in your browser, and prompt you to fill in your pull request. 
    - Ensure you're merging from your branch into either the `main` or `develop` branch.
    - Scroll down to review all your commits. They should reflect all your changes.
...
4. Add any [relevant labels](/docs/style-guide/writer-workflow/github-intro) to your PR. 
