...
## Reviewing quickstart descriptions

External vendors write quickstart descriptions. When one of these are ready for a review, they open an issue in our repo with a link out to the draft. These are written with SEO in mind, so they will appear differnt than most of our other docs and will not fully follow our style guide. 

To close these issues:

1. Follow the link to the draft.
2. Review the draft with the tips below. 
3. Leave comments or direct suggestions.
4. Close the issue and leave a comment saying the review is done.

Here are a few helpful tips:
- These writers are not familiar with New Relic. Ensure they use our products correctly in the descriptions.
- They don't know all the nuances of our style guide. It is shared with them, but ensure they follow confusing aspects of it.
- Remember, these will not follow the standard we set for docs. Just sharpen them up a bit. Dont' spend more than 20 minutes per review.
