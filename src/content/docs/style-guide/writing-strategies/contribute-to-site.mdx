...
The docs team welcomes your contributions, whether you're a New Relic employee or a New Relic user. Regardless of how you contribute, a team of tech writers will review your update for style, grammar, and formatting. 

Your expertise is key to making our docs great, but how do you start? This doc walks you through three different methods for making or requesting changes to the docs site. 

## Prerequisites [#prereq]

Whatever method you choose, you need to sign up for a [GitHub account](https://github.com/join) if you haven't yet.

When you propose a change to the docs site, GitHub manages the two different versions of a doc: the original version as it exists on docs.newrelic.com and the edited version that exists on your screen. This creates a protective layer that allows the docs team to review and approve changes before they're released to the site. 
