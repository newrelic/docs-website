...
import styleguideManageProjects2 from 'images/style-guide_screenshot-crop_edit-manage-project-status2.webp'
...
<Callout variant="tip">
If you're a New Relic employee, we recommend joining the New Relic org on GitHub. To join the org, ping the @hero in our security tooling help channel.
</Callout>
