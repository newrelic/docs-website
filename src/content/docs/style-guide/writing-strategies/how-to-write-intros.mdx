...
topics:
  ...
  - Writing guidelines
---
Introductions are a lot like appetizers for a dinner party&mdash;they set the stage for the main course. If you put some extra work into the introduction, your readers will be ready for the main course.
...
<table>
  <thead>
    ...
    <tr>
      ...
      <td>
        The construction “Here are” seems to be a variation of the expletive “There are.” This is certainly clear, but it could have more punch.
      </td>
    </tr>
    </tbody>
</table>
...
This revision has these changes:
  ...
  * Keeps all emphasis on “you” the reader and potential beneficiary of this program.
  * Removes the negative “exceptions” and replace with specifics about how to qualify and apply.
...
This revision has these changes:
  ...
  * This is a short page and the intro can quickly get into the essential info. Plus, the H2s should provide the overview of the info that will be covered.
...
To improve this, you might keep the first three paragraphs, but add the following to the final paragraph:
  ...
  ```
  Before you start creating custom attributes, familiarize yourself with existing Java agent attributes and how to enable or disable them. In addition, learn the rules for which attributes the agent includes or excludes for a destination. That way, you’ll avoid redundancy.
  ```