...
Approachable, expert, visionary. That’s how we describe the New Relic voice. That doesn’t mean that our execs will sound like the UI or that the UI will sound like the docs. But they should all sound like they come from the same approachable, expert, and visionary company.
