...
Installing New Relic is a crucial piece in our customer's experience, whether it's installing APM agents, the <InlinePopover type="infrastructure" /> agent, sending logs to New Relic, or installing CodeStream, among other things.
