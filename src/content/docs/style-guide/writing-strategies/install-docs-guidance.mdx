...
<table>
  <thead>
    ...
    <tr>
      ...
      <td>
        Use [guided install](/docs/new-relic-one/install-configure/new-relic-guided-install-overview/).
      </td>
    </tr>
    <tr>
      <td>
        * APM (especially C SDK, Go, PHP, and Ruby)
        * Browser
        * Synthetics
        * Open telemetry
      ...
      <td>
        Use the [Add more data](https://one.newrelic.com/nr1-core?state=cab9400b-31f1-fab7-cd28-db21bd312951) page.
      </td>   
    </tr>
    <tr>
      <td>
      ...
      <td>
        Use a relevant docs install page.
      </td>         
    </tr>
    </tbody>
</table>
