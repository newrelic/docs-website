      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            * Did you review the [usage dictionary](/docs/style-guide/style-guide-quick-reference/usage-dictionary) and other resources in the style guide to make sure that terms are used correctly?
          </td>
        </tr>
