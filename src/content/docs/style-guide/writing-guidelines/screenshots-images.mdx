...
<CollapserGroup>
  <Collapser
    ...
    title="Icons"
  >
    Use the [Font Awesome library](http://fortawesome.github.io/Font-Awesome/icons/) to [embed generic icons](/docs/style-guide/processes-procedures/embed-images#icons).
  </Collapser>
  ...
  <Collapser
    ...
    title="Screenshots"
  >
    Follow the [New Relic Security guidelines to capture screenshots or other images](https://nerdlife.datanerd.us/new-relic/docs-site-security-guidelines-for-images) (internal New Relic) when the Docs team can't access the product or feature and the other alternatives aren't sufficient. In addition:
