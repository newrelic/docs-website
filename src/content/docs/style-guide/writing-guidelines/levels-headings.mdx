...
<Callout variant="important">
  If you don't specify an ID manually, the site will use your header text as that header's ID. Creating a manual ID can help preserve anchor links when docs move around and get rewritten.
</Callout>
