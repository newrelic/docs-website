...
* Billable users. For how to reference basic users and full platform users, see [User-related language guidelines](/docs/style-guide/writing-guidelines/user-related-language-guidelines). 
