...
* "usage-based." The New Relic One pricing plan can be referred to as "usage-based," but not "consumption-based."
* Editions:  
    ...
    * For recommendations for including the edition in feature requirements, see [edition guidelines](#edition-guidelines). 
...
* Usage plans: 
    ...
    * Do not use abbreviations for these usage plans in public-facing communication.  
