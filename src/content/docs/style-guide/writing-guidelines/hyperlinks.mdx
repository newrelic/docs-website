...
H2/H3 headings and collapsers have their own built-in IDs that you can link to. But sometimes you may occasionally want to link to a paragraph or to a table entry. In general, you should avoid this, and attempt to link to headings and collapsers, but occasionally it's useful to link to a specific entry in a table, or a very important paragraph in a conceptual explanation. 

To do that, place a `<span>` tag around some text, using this format:
