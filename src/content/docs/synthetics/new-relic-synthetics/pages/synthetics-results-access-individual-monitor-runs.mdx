...
To access your monitor's **Results**: Go to [**one.newrelic.com**](http://one.newrelic.com/) **> Synthetics > (select a monitor) > Results**.

![screen-synthetics-results.png](src/images/results.png 'screen-synthetics-results.png')

<figcaption>
  [**one.newrelic.com**](http://one.newrelic.com/) **> Synthetics > (select a
  monitor) > Results**: Use the **Results** page to locate interesting runs of
  your monitor for troubleshooting, and see where your monitors spend the most
  time.
</figcaption>
  ...
  <tbody>
    ...
    <tr id="hide-unhide">
      ...
      <td>
        ...
        ![switch monitors by selecting the monitor name](src/images/crop-synthetics-disable-chart-element-results.png "crop-quick-monitor-switcher.png")
      </td>
    </tr>
    ...
    <tr id="quickly-switch">
      ...
      <td>
        ...
        ![Switch synthetic monitor quickly](src/images/switch_0.png "Switch synthetic monitor quickly")
      </td>
    </tr>
