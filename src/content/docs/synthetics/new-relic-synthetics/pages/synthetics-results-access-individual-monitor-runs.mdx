...
To access your monitor's **Results**: Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > (select a monitor) > Results**.
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > (select a monitor) > Results**: Use the **Results** page to locate interesting runs of your monitor for troubleshooting, and see where your monitors spend the most time.
</figcaption>
