...
<CollapserGroup>
  ...
  >
    ...
    PUT requests are intended to replace target entities, so all attributes required in the JSON payload when [creating a new monitor](https://docs.newrelic.com/docs/apis/synthetics-rest-api/monitor-examples/manage-synthetics-monitors-via-rest-api#add-simple-ping-monitor) are also required when updating an existing monitor.
...
* [Manage Synthetics monitors via the REST API (v3)](/docs/apis/synthetics-rest-api/monitor-examples/manage-synthetics-monitors-via-rest-api) (Synthetics API version 3)
* [Manage Synthetics alert notifications via the REST API](/docs/apis/synthetics-rest-api/alert-examples/manage-synthetics-alert-notifications-rest-api) (REST API calls for email alerts for New Relic monitors)
* [Use Synthetics label APIs](/docs/apis/synthetics-rest-api/label-examples/use-synthetics-label-apis) (REST API calls for labels and categories used by New Relic monitors)
