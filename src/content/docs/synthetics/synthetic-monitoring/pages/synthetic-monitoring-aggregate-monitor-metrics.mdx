...
import slaReport from 'images/sla-report.png'
...
To view your account-wide SLA report: Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > SLA Report**. Choose from reports aggregated by day, week, or month by selecting **Daily**, **Weekly**, or **Monthly** as appropriate.

You can also view SLA reports for individual monitors: Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > (select a monitor) > SLA**.
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > SLA Report**: Use SLA reports to understand your monitors' performance over time.
</figcaption>
