...
![Synthetic monitoring - Failures page](src/images/failures.png 'Synthetic monitoring - Failures page')

<figcaption>
  Hover the mouse over a failure to get quick data about it. Click on the dot to
  open a detailed report of the failure. You can also click **Run check** to
  [recheck the failed
  monitors](/docs/synthetics/synthetic-monitoring/using-monitors/recheck-failed-monitors).
</figcaption>
