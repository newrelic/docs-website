...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > Create monitor**: The script editor suggests functions, selectors, and other elements to simplify [scripting commands (available in GitHub)](https://github.com/request/request).
</figcaption>
