...
<Callout variant="important">
  The containerized private minion (CPM) and legacy synthetics runtimes, including the Node 10 and older API runtimes, are [end of life on October 22, 2024](/whats-new/2024/04/whats-new-04-09-eol-synthetics-runtime-cpm/). 
  The [runtime upgrades UI](/docs/synthetics/synthetic-monitoring/using-monitors/runtime-upgrade-ui/) can be used to help update your monitors to newer runtimes. 
</Callout>
...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > Synthetic monitoring > Create monitor](https://one.newrelic.com/synthetics-nerdlets/monitor-create)**</DoNotTranslate>: The script editor suggests functions, selectors, and other elements to simplify [scripting commands (available in GitHub)](https://github.com/request/request).
</figcaption>
