...
<Callout variant="important">
  **Version management update**: New Relic is transitioning to maintain only the **Latest** Chrome version. Specific Chrome versions (such as 134 and 140) will reach end-of-life. We recommend upgrading all monitors to use **Latest** to ensure continued support and automatic updates.
</Callout>
