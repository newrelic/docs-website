...
<Callout variant="important">
  **Version management update**: New Relic is transitioning to maintain only the **Latest** Chrome version. Specific Chrome versions (such as 134 and 140) will reach end-of-life. On **Aug 18, 2026**, monitors still on older Chrome versions will be force upgraded to the latest stable version (Chrome 147 or higher). We recommend upgrading all monitors to use **Latest** before this date to ensure continued support and automatic updates.
</Callout>
...
When Chrome releases a new version, it becomes available in New Relic synthetic monitors as **Latest** within one week, ensuring your monitors stay current with the latest browser capabilities.
