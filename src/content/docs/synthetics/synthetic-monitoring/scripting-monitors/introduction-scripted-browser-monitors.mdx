...
Scripted monitors are driven by [Selenium WebDriverJS](https://seleniumhq.github.io/selenium/docs/api/javascript/index.html). Synthetic monitoring includes an IDE-style script editor what suggests functions, locators, and other elements to simplify scripting.
