...
For a look at how to use the Selenium IDE to record your workflows and export them in the format required by New Relic, watch this short YouTube video (approx. 3:49 minutes).

<Video id="Y0BCF-MSX44" type="youtube" />
