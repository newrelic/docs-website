...
<CollapserGroup>
  ...
  >
    Locate an element by its displayed link text; for example, `<a href="http://example.com>your link text here</a>`. You can locate by the <DoNotTranslate>**exact**</DoNotTranslate> link text (`$driver.By.linkText`) or by partial match (`$driver.By.partialLinkText`):
