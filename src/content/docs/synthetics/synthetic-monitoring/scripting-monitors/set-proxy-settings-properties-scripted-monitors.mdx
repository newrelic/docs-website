...
<CollapserGroup>
  ...
  >
    <Callout variant="tip">
      This method is <DoNotTranslate>**Chrome-specific**</DoNotTranslate>: it only applies to scripted browser monitor types. It can be used to allow for a more flexible and complex proxy configuration. In most cases, this method will not be needed.
    </Callout>
