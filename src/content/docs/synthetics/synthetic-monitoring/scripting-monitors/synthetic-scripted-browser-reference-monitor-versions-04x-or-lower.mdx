...
This document is for synthetic monitor versions 0.4.x or lower. See also the documentation for [Synthetic monitor versions 0.5 or higher](/docs/synthetics/new-relic-synthetics/scripting-monitors/synthetics-scripted-browser-reference-monitor-versions-050).
...
* To view and share scripted browser examples, check out topics tagged [synthetic-script](https://discuss.newrelic.com/tags/c/support-products-agents/synthetics/synthetics-script) in New Relic's [Explorers Hub](https://discuss.newrelic.com/c/support-products-agents/synthetics).
...
* [Scripted browser examples](/docs/synthetics/new-relic-synthetics/scripting-monitors/scripted-browser-examples) (example code for scripted browsers, including comments, with examples like searching a website and waiting for results to load)
