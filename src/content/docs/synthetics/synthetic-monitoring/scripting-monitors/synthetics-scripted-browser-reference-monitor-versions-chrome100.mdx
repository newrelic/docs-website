...
This document describes scripted browser functions available for the Chrome 100 runtime and newer. If you're using an older monitor version, see the [monitor version 0.5.0 and 0.6.0 documentation](/docs/synthetics/new-relic-synthetics/scripting-monitors/synthetics-scripted-browser-reference-monitor-versions-050) or the [monitor version 0.4.0 and lower documentation](/docs/synthetics/new-relic-synthetics/scripting-monitors/synthetics-scripted-browser-reference).
