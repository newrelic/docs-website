...
/>
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > Create monitor**: Create a synthetic monitor so you can proactively detect and resolve outages before your customers notice.
</figcaption>
...
/>
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > Settings > General**: Keep your monitors up to date so New Relic is always receiving the most pertinent data.
</figcaption>
...
/>
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > Settings > General**: Delete your synthetic monitors from the Edit monitor page.
</figcaption>
