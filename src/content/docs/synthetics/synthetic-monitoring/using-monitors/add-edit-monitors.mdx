...
<Video id="YgVdToVpqbs" type="youtube" />
...
You can also delete a monitor with our [NerdGraph API](/docs/apis/nerdgraph/examples/nerdgraph-synthetics-tutorial) or the [Synthetics REST API](/docs/apis/synthetics-rest-api/monitor-examples/manage-synthetics-monitors-via-rest-api#delete-monitor).
