...
<CollapserGroup>
  ...
  >
    1. Go to [**one.newrelic.com**](http://one.newrelic.com/) **> Synthetics > <Icon name="plus-circle"/>
       Create monitor**.
...
<CollapserGroup>
  ...
  >
    Specify text to search for on the page. When using simple browser or ping [monitor types](/docs/synthetics/new-relic-synthetics/getting-started/types-synthetics-monitors#types-monitors), there is a 1MB limit on the page load.
  </Collapser>
</CollapserGroup>
