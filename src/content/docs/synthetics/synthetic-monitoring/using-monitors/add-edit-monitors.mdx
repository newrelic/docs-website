...
2. Go to <DoNotTranslate>**[one.newrelic.com > Synthetic monitoring > Create a monitor](https://one.newrelic.com/synthetics-nerdlets/monitor-create)**</DoNotTranslate>, then select the monitor you'd like to create. If it's your first time, we recommend creating a ping or step monitor to start.  
