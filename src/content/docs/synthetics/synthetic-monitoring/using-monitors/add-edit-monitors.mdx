...
With only simple browser monitors, you can configure [device emulation](/docs/synthetics/synthetic-monitoring/using-monitors/device-emulation) settings, including device type and screen orientation.
  ...
  >
    ...
    6. Select <DNT>**Save monitor**</DNT> to confirm.
...
<CollapserGroup>
  ...
  >
    ...
    * <DNT>**Simple browser**</DNT>: Specify a single URL to monitor via real browser. Once each [frequency interval](#setting-frequency), New Relic will check this URL via a Selenium-powered Google Chrome browser. The non-configurable [timeout](/docs/synthetics/new-relic-synthetics/scripting-monitors/write-scripted-browsers/#waiting-elements) for this monitor is 60 seconds.
