...
import syntheticCreateNewMonitor from 'images/select-monitor-type.png'
...
/>
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Synthetics > Create monitor**: Create a synthetic monitor so you can proactively detect and resolve outages before your customers notice.
</figcaption>
...
<CollapserGroup>
  ...
  >
    1. Go to **[one.newrelic.com](https://one.newrelic.com)**, then select **Synthetics**. Click <Icon name="fe-plus-circle"/> [**Create monitor**](https://one.newrelic.com/synthetics-nerdlets/monitor-create) in the far right of the Explorer nav.
  ...
  >
    1. Go to **[one.newrelic.com](https://one.newrelic.com)**, then select **Synthetics**. Click <Icon name="fe-plus-circle"/> [**Create monitor**](https://one.newrelic.com/synthetics-nerdlets/monitor-create) located on the far right of the Explorer nav.
...
/>
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Synthetics > Settings > General**: Keep your monitors up to date so New Relic is always receiving the most pertinent data.
</figcaption>

You cannot change a monitor's [type](#setting-type) after the monitor is created, but you can edit other monitor settings.

1. From the **Monitors** tab in **[one.newrelic.com](https://one.newrelic.com) > Synthetics**, select the monitor you want to edit.
...
/>
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Synthetics > Settings > General**: Delete your synthetic monitors from the Edit monitor page.
</figcaption>
