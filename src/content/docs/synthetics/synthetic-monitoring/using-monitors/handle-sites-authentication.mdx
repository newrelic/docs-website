...
<table>
  <thead>
    <tr>
      <th>
        <DNT>**Synthetic monitor type**</DNT>
      </th>
...
In the output from that command you should see the following <DNT>**response**</DNT> header telling you the server is offering NTLM over HTTP as a valid authentication mechanism:
