...
You can check if New Relic will be able to properly authenticate against your NTLM endpoint, using [curl](https://curl.haxx.se). You must use a host with access to your endpoint. To do this, run the following command, with the URL replaced by the endpoint you want to test:
