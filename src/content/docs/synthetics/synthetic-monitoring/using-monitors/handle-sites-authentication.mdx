...
<table>
  <thead>
    <tr>
      <th>
        <DoNotTranslate>**Synthetic monitor type**</DoNotTranslate>
      </th>
...
In the output from that command you should see the following <DoNotTranslate>**response**</DoNotTranslate> header telling you the server is offering NTLM over HTTP as a valid authentication mechanism:
