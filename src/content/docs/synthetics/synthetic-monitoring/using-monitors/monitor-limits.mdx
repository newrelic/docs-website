...
For information on the cost for exceeding the included number of monitors, see [List price](/docs/licenses/license-information/usage-plans/new-relic-one-usage-plan-descriptions#list-price).
