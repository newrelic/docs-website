...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Use [device emulation](/docs/synthetics/new-relic-synthetics/using-monitors/device-emulation) to simulate mobile or tablet devices in simple and scripted browser monitors.
      </td>
    </tr>
