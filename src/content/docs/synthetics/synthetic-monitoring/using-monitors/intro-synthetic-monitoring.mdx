...
<CollapserGroup>
  ...
  >
    ...
    <Callout variant="important">
      ...
      IP addresses](/docs/synthetics/new-relic-synthetics/using-monitors/synthetics-public-minion-ips) to your allow list or [create a private location](/docs/synthetics/synthetic-monitoring/private-locations/private-locations-overview-monitor-internal-sites-add-new-locations/).
    </Callout>
  </Collapser>
