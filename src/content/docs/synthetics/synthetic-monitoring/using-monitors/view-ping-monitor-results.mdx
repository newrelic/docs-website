...
<Callout variant="tip">
  For information on **simple** or **scripted** monitors, see [View simple or
  scripted monitor
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Explorer > Synthetic monitors
  > (select a monitor)**: View a summary of the selected ping monitor including
  load time and total load size.
</figcaption>
