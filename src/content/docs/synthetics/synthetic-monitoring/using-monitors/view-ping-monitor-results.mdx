...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Explorer > Synthetic monitors > (select a monitor)**: View a summary of the selected ping monitor including load time and total load size.
</figcaption>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        2. Go to **[one.newrelic.com](https://one.newrelic.com) > Explorer > Synthetic monitors > (select a ping monitor)**.
