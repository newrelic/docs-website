...
1. Go to **[one.newrelic.com > Synthetic monitoring > Monitor downtime](https://one.newrelic.com/synthetics-nerdlets/monitor-downtime-list)**.
...
3. Select **once** for the frequency, along with the date and start time for the monitor downtime.
