...
3. Select the ellipsis **<i className="fa fa-ellipsis">
   \[... icon]
   </i>
...
4. Edit the name or frequency of the monitor downtime. To remove a monitor from the list of targets, locate the monitor in the list of **Selected targets** and select the remove **<i className="fa fa-times-circle-o">
   \[X in circle icon]
   </i>
