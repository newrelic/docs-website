...
japaneseVersion: >-
  https://docs.newrelic.co.jp/docs/synthetics/synthetic-monitoring/using-monitors/synthetic-monitoring-response-codes
---
...
* [Writing scripted browsers](/docs/synthetics/new-relic-synthetics/scripting-monitors/writing-scripted-browsers) (how to build WebDriverJS scripts for multi-step monitoring)
* [Adding and editing monitors](/docs/synthetics/new-relic-synthetics/using-monitors/adding-editing-monitors) (how to create New Relic Synthetics monitors, including configuration options)
* [Scripted browser reference](/docs/synthetics/new-relic-synthetics/scripting-monitors/synthetics-scripted-browser-reference) (all API options for scripted browsers)
