...
2. Click <DoNotTranslate>**General**</DoNotTranslate> on the left navigation pane. 
3. Use the dropdown menu to switch the current runtime view (use <DoNotTranslate>**Node.js 16**</DoNotTranslate> for scripted API monitors and <DoNotTranslate>**Chrome 100+**</DoNotTranslate> for scripted browser monitors). 
