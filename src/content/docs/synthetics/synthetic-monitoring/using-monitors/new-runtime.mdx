...
Go to <DoNotTranslate>**[one.newrelic.com > Synthetic monitoring > Runtime upgrades](https://one.newrelic.com/synthetics/runtime-upgrades)**</DoNotTranslate>. The [runtime upgrades UI](/docs/synthetics/synthetic-monitoring/using-monitors/runtime-upgrade-ui) provides proactive runtime upgrade test results and allows you to make bulk runtime upgrades.

To convert a single monitor:

1. Go to <DoNotTranslate>**[one.newrelic.com > Synthetic monitoring](https://one.newrelic.com/synthetics)**</DoNotTranslate>, then select the monitor you want to edit.
...
1. Go to <DoNotTranslate>**[one.newrelic.com > Synthetic monitoring > Create monitor](https://one.newrelic.com/synthetics/monitor-create)**</DoNotTranslate>, then select the monitor type you want to create.
