...
* Access to [Chrome 100](/docs/synthetics/synthetic-monitoring/using-monitors/manage-monitor-runtimes), so your scripted browser monitors use browser versions similar to the ones used by your customers. 
