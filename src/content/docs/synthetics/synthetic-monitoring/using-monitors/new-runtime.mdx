...
import syntheticUpgradeAllMonitors from 'images/synthetic_screenshot-full_upgrade-all-monitors.webp'

import syntheticUpgradeSpecificMonitor from 'images/synthetic_screenshot-full_upgrade-one-monitor.webp'

import syntheticsCreateMonitor from 'images/synthetic_screenshot-crop_create-monitor.webp'



If your monitors are on our old runtime, we recommend updating them. The new runtime includes better features. It improves the backend environment in which your public monitors execute.
...
Existing monitors default to the runtime used at their time of creation. We recommend converting your monitors sooner rather than later. This will stop them from breaking during future end-of-life processes.
...
To convert multiple monitors:

1. Go to <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetic monitoring**</DoNotTranslate>.

2. Click <DoNotTranslate>**Runtime upgrades**</DoNotTranslate> on the left navigation pane.

3. Click <DoNotTranslate>**Upgrade all**</DoNotTranslate>.


<img
  title="Upgrade all monitors"
  alt="Upgrade all monitors"
  src={syntheticUpgradeAllMonitors}
/>


To convert a single monitor:

1. Go to <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetic monitoring**</DoNotTranslate>.

2. Select the monitor you want to want to convert.

3. Click <DoNotTranslate>**General**</DoNotTranslate> on the left navigation pane.

4. Use the dropdown menu of the <DoNotTranslate>**Runtime**</DoNotTranslate> field to switch the current runtime view (use Node.js 16 for scripted API monitors or Chrome 100+ for scripted browser monitors). 

<img
  title="Upgrade a specific monitor"
  alt="Upgrade a specific monitor"
  src={syntheticUpgradeSpecificMonitor}
/>
...
6. Click <DoNotTranslate>**Save monitor**</DoNotTranslate>.
...
2. Click <DoNotTranslate>**Create monitor**</DoNotTranslate>.
...
4. Set the fields you consider. <DoNotTranslate>**Name**</DoNotTranslate> is a required field.

5. Use the dropdown menu of the <DoNotTranslate>**Runtime**</DoNotTranslate> field to switch between the legacy and new runtime environment.

6. Click <DoNotTranslate>**Select locations**</DoNotTranslate>.

7. Click <DoNotTranslate>**Define steps**</DoNotTranslate> to configure the step builder.

8. Click <DoNotTranslate>**Save monitor**</DoNotTranslate>.
