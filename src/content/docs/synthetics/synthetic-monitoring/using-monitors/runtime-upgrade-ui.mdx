...
Details
https://docs.google.com/document/d/1OeP-iInYNYAOuwt3moSTsRVW50092t7HQWCDBNyzMbI/edit?tab=t.0
...
>
  ...
  For step-by-step instructions on deploying new runtime images on your SJM infrastructure, see the [private location runtime transition guide](/docs/synthetics/synthetic-monitoring/private-locations/runtime-transition-guide).
</Collapser>
