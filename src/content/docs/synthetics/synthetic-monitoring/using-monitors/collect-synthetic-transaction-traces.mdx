...
<Callout variant="important">
  Synthetic monitoring and APM must be on the same account for transaction
...
![Transaction Trace](src/images/transaction-trace.png 'Transaction Trace')

<figcaption>
  With the new Summary view enabled, you can click any data point in location
  charts to access the waterfall result details.
</figcaption>
