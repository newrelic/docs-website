...
import syntheticEditSecureCredentialByName from 'synthetic_screenshot-crop_edit-secure-credential-by-name.png'

import syntheticLocateMonitorById from 'synthetic_screenshot-crop_locate-monitor-by-id.png'

import syntheticScriptEditLocation from 'synthetic_screenshot-crop_script-edit-location.png'

import syntheticSecureCredentialsInScriptExample from 'synthetic_screenshot-crop_secure-credentials-in-script-example.png'
...
<CollapserGroup>
    ...
    >
        ...
        1. Go to **[one.newrelic.com > Synthetic monitoring > Secure credentials](http://one.newrelic.com/synthetics/secure-credential-list)**. Click on the three dots **...** for the credentials you want to change and click **Edit**.
    ...
    >
        ...
        Then, rotate any credentials you found in the script:

        1. Go to **[one.newrelic.com > Synthetic monitoring > Secure credentials](http://one.newrelic.com/synthetics/secure-credential-list)**. 
        ...
        3. Click on the three dots icon **...** for the credential you want to change and click **Edit**.
