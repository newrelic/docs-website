...
You can add or update secure credentials using the UI or the [Synthetics REST API](/docs/apis/synthetics-rest-api/secure-credentials-examples/use-synthetics-secure-credentials-apis#add-secure-credential). Note, values cannot be viewed, only keys. 
