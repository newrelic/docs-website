...
<CollapserGroup>
    ...
    >
        ...
        1. Go to **[one.newrelic.com > Synthetic monitoring > Secure credentials](http://one.newrelic.com/synthetics/secure-credential-list)**. Click on the ellipsis **...** for the credentials you want to change and click **Edit**.
