...
<Callout variant="tip">
<DNT>Script logs</DNT> are only available for tests that have failed or where the user has opted to include custom logging.
</Callout>

If you want to manually record script milestones, you can [include logging functions in your script](/docs/synthetics/synthetic-monitoring/scripting-monitors/introduction-scripted-browser-monitors/#script-log-manual).
