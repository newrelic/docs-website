...
1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > (select a monitor) > Results**.
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > (select a monitor) > Results > (select a result)**: View details of each monitor check, including load time and total load size.
</figcaption>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        2. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > (select a monitor) > Results > (select a result) > View transaction trace**.
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > (select a monitor) > Results > (select a result)**
</figcaption>
