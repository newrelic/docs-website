...
* Private locations must use [job manager](/docs/synthetics/synthetic-monitoring/private-locations/job-manager-transition-guide/) and synthetics-node-browser-runtime version 1.1.96 or higher
