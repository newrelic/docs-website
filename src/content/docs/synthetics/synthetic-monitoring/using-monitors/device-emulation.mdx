...
1. Select <DoNotTranslate>**Device emulation**</DoNotTranslate>.
...
2. Select the <DoNotTranslate>**Device type**</DoNotTranslate> and <DoNotTranslate>**Orientation**</DoNotTranslate> based on the table below:
