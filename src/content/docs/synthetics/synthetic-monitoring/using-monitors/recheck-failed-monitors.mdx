...
<DoNotTranslate>**Run check**</DoNotTranslate> buttons appear on monitor result details pages if:
...
1. Go to <DoNotTranslate>**[one.newrelic.com > Synthetic monitoring](https://one.newrelic.com/synthetics-nerdlets)**</DoNotTranslate>, then select a monitor.
2. From the monitor's <DoNotTranslate>**Failures**</DoNotTranslate> page, select a link from the table.

   OR

   From the monitor's [<DoNotTranslate>**Results**</DoNotTranslate> page](/docs/synthetics/new-relic-synthetics/using-monitors/view-monitor-results), use the filter or sort options to select a location indicating <DoNotTranslate>**Results: Failed**</DoNotTranslate>.
3. Review the failed check details, then click <Icon name="fe-rotate-cw"/>
   <DoNotTranslate>**Run check**</DoNotTranslate>.
4. To view the updated status, click <DoNotTranslate>**See results**</DoNotTranslate>.
...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > Synthetic monitoring](https://one.newrelic.com/synthetics-nerdlets)**</DoNotTranslate> (select a monitor) > <DoNotTranslate>**Failures**</DoNotTranslate> > (select a check failure):To view details about a failed monitor check, click <Icon name="fe-rotate-cw"/>
  <DoNotTranslate>**Run check**</DoNotTranslate>.
</figcaption>

When you click <Icon name="fe-rotate-cw"/>
<DoNotTranslate>**Run check**</DoNotTranslate>, New Relic triggers an immediate recheck using the result's location and the monitor's current configuration. Once the job is completed, the button will display the recheck's status (`Success` or `Failure`). To view the recheck <DoNotTranslate>**Results**</DoNotTranslate> page again, click the button again.
