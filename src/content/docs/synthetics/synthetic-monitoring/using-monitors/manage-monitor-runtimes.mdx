...
<CollapserGroup>
  ...
  >
    ...
    * <DNT>**Browser**</DNT>: Chrome 117 (This requires version 2.2+ of the synthetics-node-browser-runtime image for private locations. Chrome 112 or 100 will be used by older browser runtime images.)
