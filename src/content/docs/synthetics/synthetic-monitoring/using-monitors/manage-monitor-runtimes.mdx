...
<CollapserGroup>
  ...
  >
    ...
    To ensure your monitors have access to new features and perform as expected, upgrade your monitors whenever you see the **Upgrade monitors** button. You can also upgrade your monitors by going to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > Upgrade monitors**.
...
<Callout variant="tip">
  If you're unsure about your monitor's version, go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > Upgrade monitors**. You won't see the **Upgrade monitors** option if you're already on the latest runtime version.
</Callout>
