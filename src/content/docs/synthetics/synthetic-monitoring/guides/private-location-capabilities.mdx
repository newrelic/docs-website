...
| --- | --- | --- |
| Multi-platform deployment (Docker/Podman/Kubernetes/OpenShift) | Run monitors inside your own infrastructure, behind the firewall |  Yes  |
...
| Shared locations | Share one location across all accounts in an organization |  Yes  |
