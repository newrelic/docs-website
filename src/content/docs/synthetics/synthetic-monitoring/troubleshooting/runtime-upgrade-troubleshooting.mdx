...
<Callout variant="tip">
  If you're running monitors on private locations, see the [private location runtime transition guide](/docs/synthetics/synthetic-monitoring/private-locations/runtime-transition-guide) for SJM deployment steps and private-location-specific troubleshooting.
</Callout>
