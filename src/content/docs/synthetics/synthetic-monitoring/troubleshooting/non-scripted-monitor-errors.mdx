...
<CollapserGroup id="non-scripted-errors">
  ...
  >
    ...
    Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetic monitoring >(select a monitor) > Settings > General > Advanced options**, then disable the **Verify SSL check**.
