...
1. In <DNT>**[one.newrelic.com > Synthetic monitoring](https://one.newrelic.com/synthetics-nerdlets)**</DNT> > select the failing monitor.
2. Go to <DNT>**Settings > Script**</DNT>.
