...
1. In <DoNotTranslate>**[one.newrelic.com > Synthetic monitoring](https://one.newrelic.com/synthetics-nerdlets)**</DoNotTranslate> > select the failing monitor.
2. Go to <DoNotTranslate>**Settings > Script**</DoNotTranslate>.
