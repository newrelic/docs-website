...
Once you sign in to your New Relic account, go to <DoNotTranslate>**[one.newrelic.com > Synthetic monitoring > Create a monitor](https://one.newrelic.com/synthetics-nerdlets/monitor-create)**</DoNotTranslate>. Choose the <DoNotTranslate>**Page load performance**</DoNotTranslate> tile.
...
<SideBySide>
    <Side>
Grab the URL of a page you want to test and drop it in the <DoNotTranslate>**URL**</DoNotTranslate> field. For best results, we recommend:

* Selecting at least three locations that your monitor deploys from. This helps you avoid false positives on your checks. 
* Adjusting the time period between checks with the <DoNotTranslate>**Period**</DoNotTranslate> dropdown. How often you deploy is entirely up to you.
...
<SideBySide>
  <Side>
When your monitor starts reporting, you can view your data in the synthetics <DoNotTranslate>**Summary page**</DoNotTranslate>. Go to <DoNotTranslate>**[one.newrelic.com > Synthetic monitoring](https://one.newrelic.com/synthetics-nerdlets)**</DoNotTranslate> > (Select a monitor) > (View your <DoNotTranslate>**Summary page**</DoNotTranslate>).
...
Once you've signed in to your New Relic account, go to <DoNotTranslate>**[one.newrelic.com > Synthetic monitoring > Create a monitor](https://one.newrelic.com/synthetics-nerdlets/monitor-create)**</DoNotTranslate>. Choose the <DoNotTranslate>**User step execution**</DoNotTranslate> tile. 
...
<SideBySide>
  <Side>
    ...
    Go to <DoNotTranslate>**[one.newrelic.com > Synthetic monitoring > Create a monitor](https://one.newrelic.com/synthetics-nerdlets/monitor-create)**</DoNotTranslate>, then choose <DoNotTranslate>**User step execution**</DoNotTranslate>.
...
Whatever you choose to build, remember to click <DoNotTranslate>**Validate**</DoNotTranslate> before saving your monitor. Validating checks that the steps you've strung together run successfully.  
  </Side>
...
Go to <DoNotTranslate>**[one.newrelic.com > Synthetic monitoring > Create a monitor](https://one.newrelic.com/synthetics-nerdlets/monitor-create)**</DoNotTranslate>, then choose <DoNotTranslate>**User flow/functionality**</DoNotTranslate> for scripted browser.
