...
<Steps>
  <Step>
    ...
    Once you sign in to your New Relic account, go to <DNT>**[one.newrelic.com > Synthetic monitoring > Create a monitor](https://one.newrelic.com/synthetics-nerdlets/monitor-create)**</DNT>. Choose the <DNT>**Page load performance**</DNT> tile.
  </Step>
  ...
  <Step>
    ...
    <SideBySide>
      <Side>
        Grab the URL of a page you want to test and drop it in the <DNT>**URL**</DNT> field. For best results, we recommend:
        ...
        * Adjusting the time period between checks with the <DNT>**Period**</DNT> dropdown. How often you test is entirely up to you.
      </Side>
  ...
  <Step>
    ...
    <SideBySide>
      <Side>
        When your monitor starts reporting, you can view your data in the synthetics <DNT>**Summary page**</DNT>. Go to <DNT>**[one.newrelic.com > Synthetic monitoring](https://one.newrelic.com/synthetics-nerdlets)**</DNT> > (Select a monitor) > (View your <DNT>**Summary page**</DNT>).
      </Side>
...
<Steps>
  <Step>
    ...
    Once you've signed in to your New Relic account, go to <DNT>**[one.newrelic.com > Synthetic monitoring > Create a monitor](https://one.newrelic.com/synthetics-nerdlets/monitor-create)**</DNT>. Choose the <DNT>**User step execution**</DNT> tile.
  </Step>
  ...
  <Step>
    ...
    <SideBySide>
      <Side>
        Give your monitor a name, choose how often your monitor runs its workflow, select from the available browser and emulated device types, and select the location your monitor deploys from.

        Go to <DNT>**[one.newrelic.com > Synthetic monitoring > Create a monitor](https://one.newrelic.com/synthetics-nerdlets/monitor-create)**</DNT>, then choose <DNT>**User step execution**</DNT>.
      </Side>
  ...
  <Step>
    ...
    <SideBySide>
      <Side>
        ...
        Whatever you choose to build, remember to click <DNT>**Validate**</DNT> before saving your monitor. Validating checks that the steps you've strung together run successfully.  
...
Go to <DNT>**[one.newrelic.com > Synthetic monitoring > Create a monitor](https://one.newrelic.com/synthetics-nerdlets/monitor-create)**</DNT>, then choose <DNT>**User flow/functionality**</DNT> for scripted browser.
