...
You can think of our synthetic monitors as crash test dummies for your websites, applications, and API endpoints. A synthetic monitor can be as simple as a ping monitor, or as complex as a scripted Google Chrome instance that mimics customer behavior. Either way, our suite of automated, scriptable tools let you check and resolve failures at your critical business transactions before your customers have time to notice. You don't even need an agent.

You can learn more about synthetic monitor checks and data ingest in our [Including synthetic monitor checks](/docs/synthetics/synthetic-monitoring/using-monitors/monitor-limits/) doc. 
