...
* Run an [API test](/docs/synthetics/new-relic-synthetics/scripting-monitors/writing-api-tests) to check certificates, or to send any kind of HTTP request. 
* Support for [additional Node modules](/docs/synthetics/synthetic-monitoring/scripting-monitors/import-nodejs-modules) let you expand use case coverage for your scripted API monitors. 
