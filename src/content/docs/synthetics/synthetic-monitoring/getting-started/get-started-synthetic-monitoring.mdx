...
You can test even more complex workflows with scripted browser monitors. Scripting is flexible, allowing you to mimic user behavior with conditional logic.  
