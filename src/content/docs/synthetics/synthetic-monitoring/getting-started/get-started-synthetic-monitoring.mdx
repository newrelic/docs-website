...
## Check page load performance with simple browser monitor [#getstarted]
...
## Mimic user workflows with codeless monitoring [#step]
...
You can test more complex workflows with scripted browser monitors. Scripting is flexible, allowing you to better mimic user behavior with conditional logic. Scripting 
