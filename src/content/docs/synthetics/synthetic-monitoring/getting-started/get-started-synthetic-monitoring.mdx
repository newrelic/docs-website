...
Synthetic monitoring can help you proactively catch and resolve issues with your pages, web apps, or API endpoints before they affect your customers. 
...
Simple browser and scripted browser monitors are only two of our seven available monitors. Here are docs we recommend if you want to create more synthetic monitors:
...
* [Monitor internal apps behind a firewall](/docs/synthetics/synthetic-monitoring/private-locations/install-job-manager/)
* Set up [alerts for synthetic monitors](/docs/synthetics/synthetic-monitoring/using-monitors/alerts-synthetic-monitoring/)
* [Get a general overview of synthetic monitors](/docs/synthetics/synthetic-monitoring/getting-started/intro-synthetic-monitoring)  