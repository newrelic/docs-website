...
You can create any synthetic monitor without installation. Go to **[one.newrelic.com > Synthetic monitoring > Click Create a monitor](https://one.newrelic.com/synthetics-nerdlets/monitor-create)**, then choose the **User step execution** tile. 
