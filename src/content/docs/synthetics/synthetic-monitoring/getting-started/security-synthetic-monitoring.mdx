...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [Synthetic public locations](/docs/synthetics/new-relic-synthetics/administration/synthetics-public-minion-ips) are expected to be activated using non-personal credentials. Their IP addresses are not defined as personal data under data protection and privacy laws.
      </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * Add the IPs for synthetic public locations to your allow list or deny list.
