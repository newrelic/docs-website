  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * Synthetics Job Manager "heartbeat" every 30 seconds

          The [`SyntheticsPrivateMinion` event](/attribute-dictionary/?event=SyntheticsPrivateMinion) contains basic Synthetics Job Manager status, including job success and failure counts, queue size, minion version, etc.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Data received from the synthetic monitoring endpoint contains the scheduled check's details. This includes the information necessary to complete the check for the Synthetics Job Manager:
    ...
    <tr>
      ...
      <td>
        [Synthetic public monitor runners](/docs/synthetics/new-relic-synthetics/administration/synthetics-public-minion-ips) are expected to be activated using non-personal credentials. Their IP addresses are not defined as personal data under data protection and privacy laws.
      </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * Add the synthetic public monitor runner IP addresses to your allow list or deny list.
    ...
    <tr>
      ...
      <td>
        Aside from the target URLs monitored by New Relic, Synthetics Job Managers will regularly send data to and receive from the synthetic monitoring endpoint. To configure a proxy for all traffic to and from this endpoint, set the [HORDE_API_PROXY_HOST and HORDE_API_PROXY_PORT environment variables](/docs/synthetics/synthetic-monitoring/private-locations/job-manager-configuration/#environment-variables).
      </td>
    </tr>

    <tr>
      <td>
        Synthetics Job Manager security
      </td>

      <td>
        To ensure that only the scripts you intend to run are allowed to run on your Synthetics Job Manager, use [verified script execution](/docs/synthetics/new-relic-synthetics/private-locations/verified-script-execution-private-locations).
      </td>
    </tr>
  </tbody>
</table>
