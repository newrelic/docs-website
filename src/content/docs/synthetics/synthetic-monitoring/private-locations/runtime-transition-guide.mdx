...
**Public locations:** Change the **Browser** version dropdown in the monitor's configuration page from Chrome 134 to Chrome 140. No infrastructure changes needed.
