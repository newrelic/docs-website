    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            <DoNotTranslate>**REQUIRED.**</DoNotTranslate> UUID of the Private Location, as found on the Private Location Web page.
          </td>
        </tr>
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            <DoNotTranslate>**REQUIRED if `synthetics.privateLocationKeySecretName` is not set**</DoNotTranslate>. UUID/[Private location key](/docs/synthetics/synthetic-monitoring/private-locations/install-containerized-private-minions-cpms#private-location-key) of the private location, as found on the private location web page.
          </td>
        </tr>
