...
Read on to learn how to configure your [containerized private minion (CPM)](https://docs.newrelic.com/docs/install-containerized-private-minions-cpms).
...
<Callout variant="caution">
  User-defined environment variables are not sanitized from logs. For sensitive information, consider using the [secure credentials](https://docs.newrelic.com/docs/synthetics/new-relic-synthetics/using-monitors/secure-credentials-store-credentials-information-scripted-browsers) feature.
</Callout>
