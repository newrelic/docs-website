...
<CollapserGroup>
  <Collapser
    ...
    title={<><img src="/images/synthetic_logo_docker-logo.webp" title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}/>Review Docker logs</>}
  >
...
<CollapserGroup>
  <Collapser
    ...
    title={<><img src="/images/synthetic_logo_docker-logo.webp" title="Docker icon" alt="Docker icon" style={{ height: '35px', width: '40px' }}/>Enable Docker debug logs</>}
  >
    <Callout variant="tip">
