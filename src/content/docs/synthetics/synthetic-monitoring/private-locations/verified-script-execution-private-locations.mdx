...
2. Set the passphrase in your <DNT>Docker/DNT> or Kubernetes environment for either the [containerized private minion](https://docs.newrelic.com/docs/synthetics/synthetic-monitoring/private-locations/containerized-private-minion-cpm-configuration/#environment-variables) or [synthetics job manager](https://docs.newrelic.com/docs/synthetics/synthetic-monitoring/private-locations/job-manager-configuration/#environment-variables):

   * <DNT>**Docker:**</DNT>

      Add the `MINION_VSE_PASSPHRASE` environment variable to the <DNT>Docker/DNT> `run` command used to start your private minion:
      ...
      Add the `VSE_PASSPHRASE` environment variable to the <DNT>Docker/DNT> `run` command used to start your synthetics job manager:
...
1. Update the passphrase in your <DNT>Docker/DNT> or Kubernetes environment for either the [containerized private minion](https://docs.newrelic.com/docs/synthetics/synthetic-monitoring/private-locations/containerized-private-minion-cpm-configuration/#environment-variables) or [synthetics job manager](https://docs.newrelic.com/docs/synthetics/synthetic-monitoring/private-locations/job-manager-configuration/#environment-variables):

   * <DNT>**Docker:**</DNT>

    Stop your current minion. Then use the <DNT>Docker/DNT> `run` command to start a new minion with your updated `MINION_VSE_PASSPHRASE` environment variable:
    ...
    Stop your current synthetics job manager. Then use the <DNT>Docker/DNT> `run` command to start a new synthetics job manager with your updated `VSE_PASSPHRASE` environment variable:
...
1. Remove the passphrase in your <DNT>Docker/DNT> or Kubernetes environment:

   * <DNT>**Docker:**</DNT>

    Stop your current minion container. Then use the <DNT>Docker/DNT> `run` command to start a new minion without the `MINION_VSE_PASSPHRASE` environment variable:
    ...
    Stop your current synthetics job manager container. Then use the <DNT>Docker/DNT> `run` command to start a new minion without the `VSE_PASSPHRASE` environment variable:
