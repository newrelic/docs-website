...
1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > Private locations > (select a private location)**. Select the private location's ellipses icon, and click **Edit**. Enable verified script execution, and then save.
...
1. Update the passphrase in your Docker or Kubernetes environment:
   ...
   * **Kubernetes:** Use the Helm `upgrade` command to set your updated `synthetics.minionVsePassphrase` value:
     ...
     ```
2. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > (assigned monitor) > Settings > General**.
...
1. Remove the passphrase in your Docker or Kubernetes environment:
   ...
   * **Kubernetes:** Use the Helm `upgrade` command without the `--set synthetics.minionVsePassphrase` value:
     ...
     ```
2. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > Private locations > (select a private location)**. Clear the **Enable verified script execution** checkbox, then save.
...
4. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > Private locations > (select a private location)**. Select the private location's ellipses icon, and click **Edit**. Enable verified script execution, then save.
