...
4. Go to **[one.newrelic.com](https://one.newrelic.com/) > Synthetics > Private locations > (select a private location)**. Select the private location's ellipses icon, and click **Edit**. Enable verified script execution, then save.
...
To change your passphrase or disable verified script execution, follow the same basic process to go to your minion's IP address and update its **Advanced settings**. Then go to [one.newrelic.com](https://one.newrelic.com/) to complete the process.
