...
To learn how to verify this, see [Does my private location need more synthetics job managers?](/docs/synthetics/synthetic-monitors/private-locations/monitor-private-locations#more-minions)
