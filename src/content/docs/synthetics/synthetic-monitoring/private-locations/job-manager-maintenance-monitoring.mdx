...
Increasing either to "DEBUG" or "TRACE" can provide additional logging information to help debug; however, this will cause additional logging of data, including potentially sensitive information. Please be advised before enabling the additional logging, you do this at your own risk. To ensure data privacy and security, you should limit the types of information New Relic receives.
