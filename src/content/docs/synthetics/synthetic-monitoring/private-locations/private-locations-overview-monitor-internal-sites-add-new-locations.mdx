...
<Steps>
    ...
    <Step>
      ...
      1. Go to **[one.newrelic.com > Synthetic monitoring](https://one.newrelic.com/synthetics)**. Click the three dots **...** to the right of your monitor and select **Monitor settings**.
