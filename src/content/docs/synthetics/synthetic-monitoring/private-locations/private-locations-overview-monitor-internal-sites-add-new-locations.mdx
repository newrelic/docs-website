...
<Table>
  ...
  <tbody>
    <tr id="compatibility-account-rep">
      ...
      <td>
        Private locations are disabled by default, and are an add-on feature. To activate this feature, contact your account representative or the [sales desk](http://newrelic.com/contact-sales).
      </td>
    </tr>
...
<Table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [Verified script execution](/docs/synthetics/new-relic-synthetics/private-locations/verified-script-execution-private-locations) requires that you set up a passphrase on the minion before assigning any scripts to the location.
      </td>
    </tr>
  </tbody>
</Table>
