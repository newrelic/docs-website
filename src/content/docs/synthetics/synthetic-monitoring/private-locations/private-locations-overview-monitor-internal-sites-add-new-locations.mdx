...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetic monitoring >Private Locations**: Use the **Private Locations** page to create, edit, and delete private locations.
</figcaption>

1. Ensure you meet the [requirements](#requirements), including [account access requirements](#account-access).

2. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetic monitoring >Private locations**. Then select <Icon name="fe-plus-circle"/>
...
To access these tools, go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetic monitoring >Private locations**. Then follow the steps:
