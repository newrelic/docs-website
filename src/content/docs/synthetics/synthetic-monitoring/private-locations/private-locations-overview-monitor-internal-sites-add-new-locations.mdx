...
<table>
  ...
  <tbody>
    ...
    <tr id="compatibility-outbound-network">
      ...
      <td>
        The minion needs to connect to the synthetic monitoring's horde endpoint to receive and process jobs. If your firewall rules do not permit direct access, you must [configure proxy access](/docs/synthetics/new-relic-synthetics/private-locations/install-manage-private-minions#proxy).
