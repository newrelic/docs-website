...
import syntheticPrivateLocations from 'images/synthetic_screenshot-full_private-locations.png'

import syntheticCreatePrivateLocationJob from 'images/synthetic_screenshot-full_create-private-location-job.png'
...
<img title="screenshot-manage-private-locations.png" alt="screenshot-manage-private-locations.png" src={syntheticPrivateLocations}/>

<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > Private Locations**: Use the **Private Locations** page to create, edit, and delete private locations.
</figcaption>
...
2. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > Private locations**. Then select <Icon name="fe-plus-circle"/>
...
<img
  ...
  src={syntheticCreatePrivateLocationJob}
/>

<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > Create monitor**: To assign new jobs to your private location and its minions, select its name from the **Create monitor** page.
</figcaption>
...
To access these tools, go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > Private locations**. Then follow the steps:
