...
After creating the location, synthetic monitoring lists your <DNT>**Private location key**</DNT> so you can [install a private minion](/docs/synthetics/new-relic-synthetics/private-locations/install-containerized-private-minions-cpms#install-update).
  ...
  >
    ...
    <Steps>
      <Step>
        ...
        2. Enter the private location name, and check <DNT>**Enable verified script execution**</DNT>. Then click <DNT>**Generate key**</DNT> to create the new private location.
           ...
           />
        3. Update your job managers or private minions with the new private location. The <DNT>**Configure and deploy**</DNT> section includes sample code:
