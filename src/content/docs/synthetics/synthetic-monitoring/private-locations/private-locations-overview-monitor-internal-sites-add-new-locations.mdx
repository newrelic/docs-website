...
<Steps>
    ...
    <Step>
      ...
      1. Go to **[one.newrelic.com > Synthetic monitoring > Private locations](https://one.newrelic.com/synthetics/private-location-list)**. Click the three dots **...** to the right of your monitor and select **Monitor settings**.
    ...
    <Step>
      ...
      2. Find the old location. Click the three dots icon **...** to the right, then select **Edit**.
      ...
      3. Click the trash icon and confirm to delete the private location.
