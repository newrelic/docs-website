...
Synthetic monitoring includes tools to manage locations and individual synthetics job managers or minions (legacy). You can also [install new synthetics job managers](/docs/synthetics/new-relic-synthetics/private-locations/install-job-manager) or [minions (legacy)](/docs/synthetics/new-relic-synthetics/private-locations/install-containerized-private-minions-cpms#install-update), and clear the job queue if it backs up.
