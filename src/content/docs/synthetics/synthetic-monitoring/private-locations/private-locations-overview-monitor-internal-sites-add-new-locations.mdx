...
<table>
  ...
  <tbody>
    ...
    <tr id="account-access">
      ...
      <td>
        A private location set up with a parent account can be used by the child accounts under that parent. A private location set up with a child account can only be used by that child account.
      </td>
    </tr>
  </tbody>
</table>
...
2. Go to [**one.newrelic.com**](http://one.newrelic.com/) **> Synthetics > Private locations**. Then select <Icon name="fe-plus-circle"/>
   **Create private location**.
    ...
    *Note: The Private locations sub menu becomes available after creating your first monitor.*
