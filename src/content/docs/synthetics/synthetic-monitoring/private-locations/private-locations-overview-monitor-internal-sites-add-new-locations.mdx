...
How access works depends on your [user model](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-user-models):
...
- New Relic One user model: user access to an account depends on whether they've been [granted access to that account](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts#understand-concepts).
  </td>
  </tr>
    </tbody>
</table>
...
<figcaption>
  ...
  Locations**: Use the **Private Locations** page to create, edit, and delete
  private locations.
</figcaption>
...
2. Go to [**one.newrelic.com**](http://one.newrelic.com/) **> Synthetics > Private locations**. Then select <Icon name="fe-plus-circle"/>
   **Create private location**.
   ...
   {' '}
   <Callout variant="tip">
     The private locations sub menu becomes available after you create your
     first monitor.
   </Callout>
...
<figcaption>
  ...
  monitor**: To assign new jobs to your private location and its minions, select
  its name from the **Create monitor** page.
</figcaption>

## Manage private locations [#manage-location]

<Callout variant="tip">
  If you can't access this feature, check the [Factors affecting access to
  features and
  data](/docs/accounts/accounts-billing/general-account-settings/factors-affecting-access-features-data).
</Callout>
