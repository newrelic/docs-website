...
<CollapserGroup>
  ...
  >
    ...
    6. (Optional) Start the build (If build doesn’t auto starts, run the below command):
    ...
    7. Deploy with Helm:
        ...
        - Run the below command to add the New Relic Helm chart repository to your local Helm configuration, allowing you to easily install the Kubernetess integrations.
