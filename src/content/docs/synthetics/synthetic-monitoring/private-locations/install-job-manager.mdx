...
<CollapserGroup>
  ...
  >
    ...
    * For a synthetics job manager in the **Openshift** and **Kubernetes** container orchestration system environment, the following Helm `show` commands can be used to view the `chart.yaml` and the v`alues.yaml`, respectively:
