...
import imgIntegrationK8S402X from './images/img-integration-k8s%402x.png'
...
<CollapserGroup>
  <Collapser
    ...
    title={<><ImageSizing width="40px" height="35px"><img src={dockerLogoCrop} title="Docker icon" alt="Docker icon"/></ImageSizing>Docker container system environment requirements</>}
  >
    <table>
      <thead>
        <tr>
  ...
  <Collapser
    ...
    title={<><ImageSizing width="40px" height="35px"><img src={imgIntegrationK8S402X} title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png"/></ImageSizing>Kubernetes container orchestration system environment requirements (CPM v3.0.0 or higher)</>}
  >
    <table>
      <thead>
        <tr>
...
<CollapserGroup>
  <Collapser
    ...
    title={<><ImageSizing width="40px" height="35px"><img src={dockerLogoCrop} title="Docker icon" alt="Docker icon"/></ImageSizing>Docker dependencies</>}
  >
...
<CollapserGroup>
  <Collapser
    id="docker-update"
    title={<><ImageSizing width="40px" height="35px"><img src={dockerLogoCrop} title="Docker icon" alt="Docker icon"/></ImageSizing> Docker start procedure</>}
  >
  ...
  <Collapser
    ...
    title={<><ImageSizing width="40px" height="35px"><img src={imgIntegrationK8S402X} title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png"/></ImageSizing> Kubernetes start procedure</>}
  >
    1. Locate your [private location key](#private-location-key).
...
<CollapserGroup>
  <Collapser
    id="docker-stop"
    title={<><ImageSizing width="40px" height="35px"><img src={dockerLogoCrop} title="Docker icon" alt="Docker icon"/></ImageSizing>Docker stop procedure</>}
  >
  ...
  <Collapser
    ...
    title={<><ImageSizing width="40px" height="35px"><img src={imgIntegrationK8S402X} title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png"/></ImageSizing>Kubernetes delete procedure</>}
  >
...
<CollapserGroup>
  <Collapser
    id="run-non-root"
    title={<><ImageSizing width="40px" height="35px"><img src={dockerLogoCrop} title="Docker icon" alt="Docker icon"/></ImageSizing>Run as non-root user for Docker</>}
  >
