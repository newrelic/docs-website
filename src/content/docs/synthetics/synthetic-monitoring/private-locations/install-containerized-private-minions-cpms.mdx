...
<CollapserGroup>
  ...
  <Collapser
    ...
    title={<><img src={imgIntegrationK8S402X} title="Kubernetes icon" alt="Kubernetes icon" style={{ height: '35px', width: '40px' }}/>Kubernetes container orchestration system environment requirements (CPM v3.0.0 or higher)</>}
  >
    <table>
      <thead>
        <tr>
