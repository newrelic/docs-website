...
<CollapserGroup>
  <Collapser
    ...
    title={<><ImageSizing width="40px" height="35px">![Docker icon](./images/docker-logo-crop.png "Docker icon")</ImageSizing>Docker container system environment requirements</>}
  >
    <table>
      <thead>
        <tr>
  ...
  <Collapser
    ...
    title={<><ImageSizing width="40px" height="35px">![img-integration-k8s@2x.png](./images/img-integration-k8s%402x.png "img-integration-k8s@2x.png")</ImageSizing>Kubernetes container orchestration system environment requirements (CPM v3.0.0 or higher)</>}
  >
    <table>
      <thead>
        <tr>
...
<CollapserGroup>
  <Collapser
    ...
    title={<><ImageSizing width="40px" height="35px">![Docker icon](./images/docker-logo-crop.png "Docker icon")</ImageSizing>Docker dependencies</>}
  >
...
<CollapserGroup>
  <Collapser
    id="docker-update"
    title={<><ImageSizing width="40px" height="35px">![Docker icon](./images/docker-logo-crop.png "Docker icon")</ImageSizing> Docker start procedure</>}
  >
  ...
  <Collapser
    ...
    title={<><ImageSizing width="40px" height="35px">![img-integration-k8s@2x.png](./images/img-integration-k8s%402x.png "img-integration-k8s@2x.png")</ImageSizing> Kubernetes start procedure</>}
  >
    1. Locate your [private location key](#private-location-key).
...
<CollapserGroup>
  <Collapser
    id="docker-stop"
    title={<><ImageSizing width="40px" height="35px">![Docker icon](./images/docker-logo-crop.png "Docker icon")</ImageSizing>Docker stop procedure</>}
  >
  ...
  <Collapser
    ...
    title={<><ImageSizing width="40px" height="35px">![img-integration-k8s@2x.png](./images/img-integration-k8s%402x.png "img-integration-k8s@2x.png")</ImageSizing>Kubernetes delete procedure</>}
  >
...
<CollapserGroup>
  <Collapser
    id="run-non-root"
    title={<><ImageSizing width="40px" height="35px">![Docker icon](./images/docker-logo-crop.png "Docker icon")</ImageSizing>Run as non-root user for Docker</>}
  >
