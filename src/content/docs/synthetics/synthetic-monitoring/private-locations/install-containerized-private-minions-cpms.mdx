      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <Callout variant="caution">We have identified a compatibility issue with Kubernetes v1.21+. A workaround is available by disabling the `BoundServiceAccountTokenVolume` feature gate on the cluster.
            </Callout>
          </td>
        </tr>
