...
* <DNT>Docker/DNT>: 2.5 GiB per cpu core for <DNT>Docker/DNT> CPM
* Kubernetes CPM:
...
* <DNT>Docker/DNT>: 3.256 GiB per cpu core for <DNT>Docker/DNT> synthetics job manager
...
<DNT>**New Relic access is red:**</DNT>
...
<DNT>**Network IOPS:**</DNT>

Network IOPS can also be a good place to troubleshoot if using a cloud provider for your CPM. Both <DNT>Docker/DNT> and Kubernetes CPMs require a decent amount of write throughput. Analyze your average IOPS and determine the appropriate volume size needed for your disk operations per second.

## Port conflicts running <DNT>Docker/DNT> containers on the host [#port-conflicts-docker]
