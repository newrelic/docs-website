  ...
  >
    ...
    <table>
      ...
      <tr>
        ...
        <td>
          The name of the pod in which the SJM container is run. Use this to override `SYNTHETICS` as the default. However, if multiple SJM containers need to be run in the same instance. Then it is required to be overridden.
        </td>
      </tr>
...
<CollapserGroup>
  ...
  >
    ...
    In the of SELinux Context volume is mounted with ':z' or ':Z'. The expected target directory is: `/var/lib/newrelic/synthetics/variables/`
...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="Podman"
  >
    For podman, launch SJM mounting the directory at `/var/lib/newrelic/synthetics/modules`. In the of SELinux Context volume is mounted with ':z' or ':Z'. For example:
