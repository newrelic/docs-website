...
**The equation:**
$$C_{req} = (R_{proc} + R_{growth}) \times D_{avg_m}$$
...
* $D_{avg_m}$ = The **average duration** of heavyweight jobs in **minutes**.
...
$$Parallelism_{max} \approx 15 \times AJD_m$$

Where $AJD_m$ is the average job duration in minutes.
...
$$Parallelism = \frac{SJ5_m}{Completions}$$

Where $SJ5_m$ is the number of synthetics jobs per 5 minutes.
