    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            The <DNT>Docker/DNT> Registry domain where the runtime images are hosted. Use this to override `docker.io` as the default.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            The <DNT>Docker/DNT> repository / organization where the runtime images are hosted. Use this to override `newrelic` as the default.
          </td>
        </tr>
...
2. Once you create the custom modules directory and the `package.json`, apply it to your SJM for <DNT>Docker/DNT> and Kubernetes. 
   ...
   <CollapserGroup>
     <Collapser
       ...
       title="Docker"
     >
       For <DNT>Docker/DNT>, launch SJM mounting the directory at `/var/lib/newrelic/synthetics/modules`. For example:
...
## Sizing considerations for Kubernetes and <DNT>Docker/DNT> [#kubernetes-sizing]

<Callout variant="tip">
  <DNT>Docker/DNT> specific sizing considerations will be available soon.
</Callout>
