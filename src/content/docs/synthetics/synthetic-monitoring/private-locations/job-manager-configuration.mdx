...
Read on to learn how to configure your [synthetics job manager](/docs/synthetics/private-locations/install-job-manager).

You can do the following to customize your synthetics job manager:

* Use [environment variables](#environment-variables) in your configuration.

<Callout variant="important">
  [Custom modules](/docs/synthetics/private-locations/containerized-private-minion-cpm-configuration/#custom-modules), [permanent data storage](/docs/synthetics/private-locations/containerized-private-minion-cpm-configuration/#preserve-data-volume), and [user defined environment variables](/docs/synthetics/private-locations/containerized-private-minion-cpm-configuration/#vars-scripted-monitors) are not supported for the synthetics job manager at this time.
</Callout>

You may not modify any synthetics job manager files and New Relic is not liable for any modifications you make.
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            The number of Node API runtime CronJobs to deploy. The maximum number of concurrent Node API jobs that will execute at any time.
        ...
        <tr>
          ...
          <td>
            The number of Node API runtime CronJobs to complete per minute. Increase this setting along with parallelism to improve throughput. This should be increased any time parallelism is increased. Increase this setting if you notice periods of time with no API runtime jobs running.
        ...
        <tr>
          ...
          <td>
            The number of Chrome browser runtime CronJobs to deploy. The maximum number of concurrent Chrome browser jobs that will execute at any time.
        ...
        <tr>
          ...
          <td>
            The number of Chrome browser runtime CronJobs to complete per minute. Increase this setting along with parallelism to improve throughput. This should be increased any time parallelism is increased. Increase this setting if you notice periods of time with no browser runtime jobs running.
