...
Learn how to configure your [synthetics job manager](/docs/synthetics/private-locations/install-job-manager) by using [environment variables](#environment-variables) in your configuration.
