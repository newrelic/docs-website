...
**2. Find rate of queue growth per minute ($R_{growth}$):**
...
$$Parallelism = \frac{N_{5m}}{Completions}$$

Where $N_{5m}$ is the **number** of synthetics jobs you need to run every **5 minutes**.
