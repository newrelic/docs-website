    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Set to `true` to enable Webassembly for the Node Browser Runtime. This requires job manager release-367 or higher and node browser runtime version 2.3.21 or higher.
          </td>
        </tr>
