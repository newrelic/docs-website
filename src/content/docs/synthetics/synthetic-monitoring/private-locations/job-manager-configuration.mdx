...
<CollapserGroup>
  ...
  >
    ...
    In the of SELinux Context volume is mounted with ':z' or ':Z' (refer [here](https://docs.podman.io/en/latest/markdown/podman-run.1.html#volume-v-source-volume-host-dir-container-dir-options)). The expected target directory is: `/var/lib/newrelic/synthetics/variables/`
...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="Podman"
  >
    For podman, launch SJM mounting the directory at `/var/lib/newrelic/synthetics/modules`. In the of SELinux Context volume is mounted with ':z' or ':Z' (refer [here](https://docs.podman.io/en/latest/markdown/podman-run.1.html#volume-v-source-volume-host-dir-container-dir-options)). For example:
