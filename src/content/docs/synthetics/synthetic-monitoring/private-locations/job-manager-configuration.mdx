...
$$Completions = \frac{300}{\mathrm{ajd}_s}$$

Where $\mathrm{ajd}_s$ is the average job duration in seconds.

$$Parallelism = \frac{\mathrm{sj}_{5m}}{\mathrm{Completions}}$$

Where $\mathrm{sj}_{5m}$ is the number of synthetics jobs per 5 minutes.
