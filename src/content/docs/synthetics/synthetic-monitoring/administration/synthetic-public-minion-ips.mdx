...
<Callout variant="important">
It is recommended that you add the entire global ranges provided by New Relic to your allow list. The JSON file has now been updated to include a regional breakdown of the new IP ranges. 
