...
Monitors using legacy runtimes, which include scripted browser monitors using Chrome 72 (or older), scripted API monitors using Node 10 (or older), step monitors, broken link monitors, and certificate check monitors utilize /32 IP ranges.
