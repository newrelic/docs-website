...
<Callout variant="important">
  ...
  **If no action is taken** 
    ...
    If you do not update your allowlists by **April 10, 2025**, your Synthetics checks may fail to connect to your applications, which may result in failed connections and trigger alerts.
</Callout>
...
<Callout variant="important">
  The IP range list in JSON format will change after **April 10, 2025** as some older IPs will be replaced by the new ranges specified above. Please ensure you whitelist the newly mentioned ranges.
</Callout>
