...
<Callout variant="important">
   Synthetics is adding new Ip addresses on July/15/2021 See the announcement [Here](/docs/synthetics/synthetic-monitoring/administration/new-synthetic-public-minion-ips).
</Callout>
