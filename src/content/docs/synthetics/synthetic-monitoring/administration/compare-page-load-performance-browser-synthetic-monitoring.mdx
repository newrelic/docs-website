...
<CollapserGroup>
  ...
  >
    ...
    1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > (select a monitor) > Summary**.
...
1. From synthetic monitoring UI: Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Synthetics > (select a monitor) > Summary**.
