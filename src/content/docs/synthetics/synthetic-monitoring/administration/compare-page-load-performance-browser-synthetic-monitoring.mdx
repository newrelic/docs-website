...
<figcaption>
  Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Browser >** (select a browser app) **> Page views >** (click a a page monitored by synthetic monitoring) > (scroll down to the **Synthetic monitors comparison** chart).
</figcaption>
