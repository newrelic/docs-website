...
<figcaption>
  Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Browser >** (Select a browser app) **> Page views >** (Click a a page monitored by synthetic monitoring) > (Scroll down to **Synthetic monitors comparison**.)
</figcaption>
...
### Don't see data in the the **Synthetic monitors comparison** chart?
