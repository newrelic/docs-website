...
1. From synthetic monitoring UI: Go to **[one.newrelic.com](https://one.newrelic.com) > Synthetics > (select a monitor) > Summary**.

   OR

   From browser monitoring UI: Go to **[one.newrelic.com](https://one.newrelic.com) > Browser > (select a browser app) > Page views**, then select a page monitored by synthetic monitoring.
