...
<figcaption>
  Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Browser >**</DoNotTranslate> (select a browser app) <DoNotTranslate>**> Page views >**</DoNotTranslate> (click a a page monitored by synthetic monitoring) > (scroll down to the <DoNotTranslate>**Synthetic monitors comparison**</DoNotTranslate> chart).
</figcaption>
...
Based on the [comparison data sources](#data-sources), the <DoNotTranslate>**Synthetic monitors comparison**</DoNotTranslate> chart shows:
...
### Don't see data in the <DoNotTranslate>**Synthetic monitors comparison**</DoNotTranslate> chart?
