...
### In alerts and activity streams [#alerts-activity]
...
Click any change marker or event to open the **Change details** page, which provides comprehensive impact analysis including:
...
### Adjust comparison periods [#comparison-periods]
...
### Web transaction analysis [#web-transactions]
...
### Custom trend boards [#trend-boards]
...
**To create a custom trend board:**

1. Navigate to the change details page.
2. Under **Key impacts**, click **Add any metric or event**.
3. Select what to track and how to aggregate the data.
...
<DocTiles>
  <DocTile title="Query your changes" path="/docs/change-tracking/customize-data">Learn how to query your change data in New Relic.</DocTile>
