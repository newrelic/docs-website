...
To see how a change, such as a deployment, affects an entity's metrics and events, you can create custom charts that help you identify trends. You have the option to create up to three charts to help you make decisions about your recent change.
...
/>
<figcaption>
    Here is an example of two custom charts on a deployment.
</figcaption>

What kind of trends can you see with these custom charts? You can select from any metrics or events available to your entity and then apply an aggregation function to it. For example, you could make custom charts that answer these types of questions:
...
Unlike regular dashboard charts, these custom visualizations for your deployments are fully integrated with the time window and **compared with** settings on the **Deployment details** page. You can even export these charts to dashboards, and they are all tied to a specific entity and to your user account.

To create a custom chart:

1. Open the **Deployments** page for your entity (for example: **[one.newrelic.com](https://one.newrelic.com/) > All Entities > (select an entity) > Deployments**).
2. Select a deployment.
3. In the main section of the page, click **Add any metric or event**.
