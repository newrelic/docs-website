...
Before you dive into the details here about how to view and analyze the impact of changes, make sure you've designated the changes you want to monitor using GraphQL, our CLI, or a CI/CD integration. After you've designated which changes to track, you are ready to see the results from across your stack in a number of ways:
...
* A link (**See all changes on this entity**) to a page containing the deployments list page filtered to this entity. Use this to quickly zoom out and see all recent changes on this part of your system.
...
1. Click **Change tracking** in the left navigation pane, and select a change.
1. Under the charts for **Key impacts**, click **Add any metric or event**.
1. Click **What do you want to track** and select a metric or event.
1. Click **How do you want to aggregate that?** and select a function.
