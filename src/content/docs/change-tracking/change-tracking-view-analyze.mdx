...
1. Click <DNT>**Change tracking**</DNT> in the left navigation pane, and select a change.
1. Under the charts for <DNT>**Key impacts**</DNT>, click <DNT>**Add any metric or event**</DNT>.
1. Click <DNT>**What do you want to track**</DNT> and select a metric or event.
1. Click <DNT>**How do you want to aggregate that?**</DNT> and select a function.
