...
To see how a change, such as a deployment, affects an entity's metrics and events, you can create up to three custom charts that show . With these optional charts, you can see trends for metrics and events that help you make decisions about your recent change.
<img
...
Unlike regular dashboard charts, these custom visualizations for your deployments are fully integrated with the time window and **compared with** settings on the **Deployment details** page. You can even export these charts to dashboards. These charts are all tied to a specific entity and to your user account.

Each chart can have its own aggregation function. For example, you could make custom charts that answer these types of questions:
...
1. Open the deployment page for your entity (for example: **[one.newrelic.com](https://one.newrelic.com/) > All Entities > (select an entity) > Deployments**).
2. Select a deployment.
3. Click **Add any metric or event**.
4. Click **What do you want to track** and select...
5. [INSERT MORE DETAILS HERE]
