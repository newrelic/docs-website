...
NSERT LINK HERE. Before you jump into the details about how to view and analyze the impact of changes, make sure you've designated the changes you want to monitor for recording a deployment, you are ready to see its performance in the UI. You can see the results contextualized by data from across your stack in a number of ways:
