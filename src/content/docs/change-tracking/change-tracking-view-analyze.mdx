...
To see how a change, such as a deployment, affects metrics and events in your system, you can create up to three custom charts. With these optional charts, you can see trends for a variety of metrics and events.
<img
...
Unlike regular dashboard charts, these custom visualizations for your deployments are fully integrated with the time window and **compared with** settings on the **Deployment details** page. You can even export these charts to dashboards. Each chart is tied to a specific entity and to your user account.
...
4. [INSERT INSTRUCTIONS FOR ADDING AN EVENT OR METRIC]
