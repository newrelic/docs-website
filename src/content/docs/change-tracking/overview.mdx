...
<Tabs>
  ...
  <TabsPageItem id="event">
    ...
    You can configure change tracking events using one of the following methods:
      - **[NerdGraph API](/docs/change-tracking/config/nerdgraph)**: Create change events via GraphQL mutations
      - **[New Relic CLI](/docs/change-tracking/config/cli)**: Use CLI for quick setup
      - **[GitHub Actions](/docs/change-tracking/config/github-actions)**: Automate change events in CI/CD pipelines
    ...
    You can configure change tracking deployments using one of the following methods:
      - **[NerdGraph API](/docs/change-tracking/config/nerdgraph)**: Record deployments via GraphQL mutations
      - **[New Relic CLI](/docs/change-tracking/config/cli)**: Command line deployment tracking
      - **[Jenkins](/docs/change-tracking/config/change-tracking-jenkins)**: Automated tracking with Jenkins plugin
      - **[GitHub Actions](/docs/change-tracking/config/github-actions)**: Configure deployment tracking in workflows
