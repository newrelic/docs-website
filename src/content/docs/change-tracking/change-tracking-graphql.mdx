...
* Relevant user permissions: Any user or role that can use NerdGraph can create deployment markers and track other changes, but only full platform users can access change tracking UIs and tools.
