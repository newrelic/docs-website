...
* Relevant user permissions: Any user or role that can use NerdGraph can create deployment markers and track other changes, but only [full platform users](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type) can access change tracking UIs and tools.
