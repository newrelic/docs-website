...
## Query deployments [#query-events]

You can use GraphQL and NRQL queries to fetch data about changes related to deployments. See the examples below to try out some queries. You can also learn about GraphQL queries in the [NerdGraph entities API tutorial](/docs/apis/nerdgraph/examples/nerdgraph-entities-api-tutorial/).
...
```
  ...
  >
    After you create a marker using GraphQL, you can use the [query builder](/docs/query-your-data/explore-query-data/query-builder/introduction-query-builder/) to create time series charts, draw curves for a telemetry signal over a span of time, and render deployments as markers.
