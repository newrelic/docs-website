...
Instead of designating which changes you want to monitor by using the [CLI](/docs/change-tracking/change-tracking-cli) or [Jenkins](/docs/change-tracking/ci-cd/change-tracking-jenkins), you can do the same thing using GraphQL mutations and queries.

You can send mutations and queries programmatically to our [GraphQL API](https://api.newrelic.com/graphql), or you can use [NerdGraph API Explorer](https://api.newrelic.com/graphiql), our GraphiQL integrated envionment (IDE).
