...
To get acquainted with various aspects of change tracking, watch the video below or see our [feature highlights](#feature-highlights). If you're ready to capture and analyze changes across your stack, go right to [Start tracking changes](#start-tracking).
...
Once you have an account, choose one of these options to get started.
