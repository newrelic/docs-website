...
To get acquainted with various aspects of change tracking, watch the video below or see our [feature highlights](#feature-highlights). If you're ready to capture and analyze changes across your stack, skip to the steps about how to [start tracking changes](#start-tracking).
...
After you capture changes, start using them to contextualize your telemetry, performance, and quality data. Learn more about utilizing and querying your change tracking data in [How to view and analyze your changes in New Relic](/docs/change-tracking/change-tracking-view-analyze/).
