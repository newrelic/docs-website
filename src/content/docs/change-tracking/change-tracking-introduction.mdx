...
<Callout variant="tip">
  Data stored in NRDB is immutable and as such, the markers you create are not able to be deleted. The events created will be stored for 13 months by default.
</Callout>
