...
Change tracking goes far beyond simple deployment tracking for <InlinePopup type="apm" /> services. You can also track changes in mobile apps, infrastructure hosts, workloads, and more.
...
You can capture and analyze changes in a variety of ways:
