...
* Want to see how many regressions or new error groups we detected since a change? For more about regressions, see [errors inbox](/docs/errors-inbox/errors-inbox).
...
You can capture and analyze changes in a variety of ways. Choose the option that fits best your environment:

* [NerdGraph (GraphQL) API](/docs/change-tracking/change-tracking-graphql): You can use GraphQL mutations to designate what changes to track and then run queries to list details about what you're tracking.
...
* [Jenkins](/docs/change-tracking/ci-cd/change-tracking-jenkins): Our plugin makes it easy for you to use Jenkins for tracking changes.
...
After you capture changes, start using them to contextualize your telemetry, performance, and quality data. Learn more about this in [How to view and analyze your changes in New Relic](/docs/change-tracking/change-tracking-view-analyze/).
