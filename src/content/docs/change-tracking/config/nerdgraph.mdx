...
* Flexible Data: You can use flexible categorization and custom attributes.
...
<CollapserGroup>
  ...
  >
      ...
      <thead>
        <tr>
          <th style={{ width: "220px" }}>Input argument</th>
          <th>Datatype</th>
          <th>Required?</th>
          <th>Description</th>
        </tr>
      ...
      <tbody>
        <tr>
          ...
          <td>Yes</td>
          <td>
            A `category` argument allows you to categorize changes using various category and type combinations. You can either use our predefined [standard categories and types](#standard-categories-types) or define your own custom ones.
        ...
        <tr>
          ...
          <td> No </td>
          <td>
            To use a custom `category`, `type`, or a non-standard combination, set the `dataHandlingRules` argument and the `validationFlags` field to `ALLOW_CUSTOM_CATEGORY_OR_TYPE`.
        ...
        <tr>
          ...
          <td> String </td>
          <td> No </td>
          <td> If the `category` attribute is set to `Deployment`, then within the `categoryFields` argument, you must define a `deployment` argument and ensure this `deployment` argument includes a `version`.</td>
        </tr>
        <tr>
          <td>`changelog`</td>
          <td>String</td>
