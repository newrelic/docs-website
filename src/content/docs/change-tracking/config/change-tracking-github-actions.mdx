...
<Tabs>
  ...
  >
  ### Optional inputs for change events [#event-optional]
  ...
  <table>
    ...
    <tbody>
      <tr>
        <td>`category`</td>
        <td>The category of the change event. For supported categories, refer to [change tracking categories](/docs/change-tracking/config/nerdgraph/#supported-types)</td>
      </tr>
      <tr>
        <td>`type`</td>
        <td>The type of the change event. For supported types, refer to [change tracking types](/docs/change-tracking/config/nerdgraph/#supported-types)</td>
      </tr>
      <tr>
        <td>`entitySearch`</td>
  ...
  <Collapser
    className="freq-link"
    id="event-examples"
    title="Example workflows for change events: Basic deployment event"
  >
...
jobs:
  ...
  **Legacy method** specifically designed for deployment tracking. Use this method if you need compatibility with existing deployment-focused workflows.
  ...
  <Callout variant="tip">
    **Migration recommendation**: We recommend using change tracking events (`changeTrackingCreateEvent`) for new integrations as it provides more flexibility and features.
  </Callout>
  ...
  <table>
    ...
    <tbody>
      <tr>
        <td>`apiKey`</td>
        <td>Your New Relic [personal API key](/docs/apis/get-started/intro-apis/types-new-relic-api-keys#personal-api-key)</td>
      </tr>
      <tr>
        <td>`guid`</td>
