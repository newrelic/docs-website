...
After you record a deployment for an APM application entity, whether it's with the change tracking feature or the older [REST API](/docs/apm/apm-ui-pages/events/record-deployments/#api-instructions), you can notify your team members using a webhook.

## Get your webhook destination URL [#get-webhook-url]

You can send deployment data to a variety of webhook destinations. Follow the instructions for the tool you're using to get the webhook URL.

If you're using Slack, use the legacy New Relic alerts app:
