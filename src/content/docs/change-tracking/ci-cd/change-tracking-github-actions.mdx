...
You can use the New Relic change tracking feature in conjunction with GitHub actions. This allows you to track changes you make in your environment during your release pipeline.
