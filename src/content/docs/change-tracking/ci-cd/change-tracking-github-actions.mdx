...
<table>
  <thead>
    ...
    <tr>
      ...
      <td>
        A summary of what went into this change that is visible in the <DoNotTranslate>**Change tracking**</DoNotTranslate> page
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        The Commit SHA for this change that is visible in the <DoNotTranslate>**Change tracking**</DoNotTranslate> page
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        A high-level description of this change, visible in the <DoNotTranslate>**Overview**</DoNotTranslate> page and on the <DoNotTranslate>**Change tracking**</DoNotTranslate> page when you select an individual change
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td>
        A username to associate with the change that is visible in the <DoNotTranslate>**Overview**</DoNotTranslate> and <DoNotTranslate>**Deployments**</DoNotTranslate> pages
      </td>
    </tr>
  </tbody>
</table>
...
Check the [New Relic Application Deployment Marker](https://github.com/marketplace/actions/new-relic-application-deployment-marker) page and click the <DoNotTranslate>**Use latest version**</DoNotTranslate> button to make sure you use the latest version available.
