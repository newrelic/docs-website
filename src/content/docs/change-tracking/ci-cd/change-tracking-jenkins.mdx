...
1. Download the plugin from [here](newrelic-deployment-notifier.hpi), and rename it to `newrelic-deployment-notifiier.hpi`.
...
4. Click **Advanced**.
    ...
    />
5. Under **Deploy Plugin**, click **Choose File** and upload the file `newrelic-deployment-notifiier.hpi`.
