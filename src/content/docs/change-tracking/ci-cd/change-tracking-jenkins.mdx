...
5. (Optional) You may want to configure several applications to notify you when changes affect your entities. Click the **Add another notification** button to add more apps.  
