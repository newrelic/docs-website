...
<tr>
        ...
        <tr>
          ...
          <td>
            The user conducting the deployment. **Tip:** You can install [Build User Vars Plugin](https://wiki.jenkins.io/display/JENKINS/Build+User+Vars+Plugin) to have environment variables regarding the Jenkins user, and can use them in this field, like `${BUILD_USER_ID}`. 
          </td>
        </tr>
      </tbody>
    </table>
