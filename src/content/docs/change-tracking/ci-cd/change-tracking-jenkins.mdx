...
The change tracking feature allows you to designate changes you want to monitor to see how they affect your customers and systems. Instead of designating what you want to monitor with GraphQL or our CLI, you can record changes using pipelines in Jenkins. A pipeline will call whatever build you specify and also pass additional environment variables to the build process. This populates the data that is needed for your deployment to show up in charts across New Relic.  You'll see the results in the change tracking UIs, and you can use this information to understand the impact of changes on entity health.
