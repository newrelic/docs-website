...
1. Download the plugin from <a href="https://docswebsitedevelop-rhsjenkinshpifiledownloadpage.gatsbyjs.io/95a380630e47b2a6abf0834a02a4dfd1/newrelic-deployment-notifier.hpi">here</a>.
    <Callout variant="tip">
      Note that this is a temporary location for the plugin. We'll let you know when you can download this directly in Jenkins.
    </Callout>
