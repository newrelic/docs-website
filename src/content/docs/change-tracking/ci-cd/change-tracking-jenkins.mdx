...
import apmJenkinsHomePage from './images/tracking_screenshot-crop_jenkins-home-page.png'

import apmJenkinsManage from './images/tracking_screenshot-crop_jenkins-manage.png'

import apmJenkinsAdvanced from './images/tracking_screenshot-crop_jenkins-advanced.png'

import apmJenkinsInstalledTab from './images/tracking_screenshot-crop_jenkins-installed-tab.png'

import apmJenkinsRollback from './images/tracking_screenshot-crop_jenkins-rollback.png'

import apmJenkinsPipelineSyntax from './images/tracking_screenshot-crop_jenkins-pipeline-syntax.png'

import apmJenkinsSampleStep from './images/tracking_screenshot-crop_jenkins-sample-step.png'

import apmJenkinsDeployNotification from './images/tracking_screenshot-crop_jenkins-deploy-notification.png'

import apmJenkinsPasteScript from './images/tracking_screenshot-crop_jenkins-paste-script.png'


Instead of designating the changes you want to track using GraphQL, you can record changes using pipelines in Jenkins. A pipeline will call whatever build you specify and also pass additional environment variables to the build process. This populates the data that is needed for your deployment to show up in charts across New Relic and unlock change tracking UIs illustrating its impact on entity health.
...
To record change tracking deployments you need a special Jenkins plugin. You can easily add or remove the plugin from your Jenkins instance. Complete the following as a Jenkins administrator.
...
3. Under **Build Step**, select **New Relic Deployment Notifications**.
    ...
    <img
      ...
      src={apmJenkinsDeployNotification}
    />
    ...
    <table>
      <thead>
        ...
        <tr>
          ...
          <td>
            Optional timestamp in Unix Epoch long format. If not provided, then New Relic will assume the time.
          </td>
        </tr>
        <tr>
          <td>
...
Currently, GUIDs cannot be assigned dynamically to the pipeline. You must find the entity GUID in New Relic (see [Learn about New Relic entities](https://docs.newrelic.com/docs/new-relic-solutions/new-relic-one/core-concepts/what-entity-new-relic/#find) and then hardcode this value in the pipeline script to report deployment notifications for that entity. This information is not sensitive and can be stored publicly.
...
## View your deployments in the UI [#view-in-ui]

Once you've completed the steps for recording a deployment, you are ready to see its performance in the UI. You can see the results contextualized by data from across your stack in a number of ways:

* **Charts in APM, browser, mobile, and dashboards:** A vertical line with a pinhead appears on time series charts. This marker represents the recorded deployment event, and if you click on the pinhead, you can start drilling into the impact the change had on entity health and quality.
    <img
      style={{ width: "100%" }}
