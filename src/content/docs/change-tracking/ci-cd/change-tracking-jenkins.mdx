...
4. Click **Available**.
    ...
    />
5. Search for **newrelic-deployment-notifier**. On that row, click the `Install` checkbox, then click the `Install` button. 

6. A new page appears, showing you the progression of the installation. **No restart needed**. 
