...
6. Bookmark the [optional configurations](#follow-up-config) below so you can return to them after you experiment with Infinite Tracing.
7. Select your data sources by following the steps in [Initial trace observer configuration for browser, mobile, and Lambda](#initial-config). 
