...
Follow the trace observer setup up that fits your tools:

* [Users of APM agents and third-party telemetry tools](#apm-and-third-party)
* [Users of New Relic browser, mobile, and lambda](#browser-mobile-lambda)
* [(Optional) Users of all tools: Configuration steps](#follow-up-config)
...
## Users of APM agents and and third-party telemetry tools  [#apm-and-third-party]
...
To create a new trace observer if you're using New Relic browser, mobile, or lambda:
