...
8. Return to your original distributed tracing setup instructions for your agent or third-party telemetry tool and insert your new endpoint value to route your services data to New Relic.
...
6. To set up the routing for this new trace observer endpoint, see our GraphQL tutorial about how to designate which services should route data to the new endpoint. 

7. After you are finished designating which services should route data to New Relic, you are ready to view your Infinite Tracing data in the [New Relic UI](/docs/distributed-tracing/ui-data/understand-use-distributed-tracing-ui/).
