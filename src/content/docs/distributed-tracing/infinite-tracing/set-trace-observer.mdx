...
6. To set up the routing for this new trace observer endpoint, see our GraphQL tutorial about how to designate which services should route data to the new endpoint. When you finish, return to this page.
