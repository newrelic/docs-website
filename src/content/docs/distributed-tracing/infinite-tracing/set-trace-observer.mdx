...
<CollapserGroup>
  <Collapser
   ...
   >
   As soon as you select your browser, mobile, and Lambda data sources, you should expect a delay before you see your results in the New Relic UI. This delay may be anywhere from one to two minutes. 
  ...
  >
    If your browser app is associated with an APM application that has multiple names, you can only select one of the names when you choose your data sources. If you try to select the same application that goes by another name, the UI will prompt you that you need to choose only one name.
  </Collapser>
  <Collapser
    className="freq-link"
    id="lambda-sampling"
