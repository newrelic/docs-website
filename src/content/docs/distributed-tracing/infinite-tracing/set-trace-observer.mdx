...
<Callout variant="important">
  **Prerequisites:** Infinite Tracing must be officially enabled for your account before you can set up a trace observer. This is a controlled-access feature that requires approval from New Relic. If you have not received official permission and enablement, contact your New Relic Account Team or [New Relic Customer Support](https://support.newrelic.com).
</Callout>
