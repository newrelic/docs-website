...
1. Go to [one.newrelic.com](https://one.newrelic.com) and click **Apps**, and then under **Your apps**, click **Infinite Tracing settings**.
...
1. Return to the trace observer app (**[one.newrelic.com](https://one.newrelic.com) > Apps > Your Apps > Infinite Tracing settings**).
