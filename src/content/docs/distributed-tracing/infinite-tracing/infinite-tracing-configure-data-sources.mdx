...
There are three ways you can update the data sources on a trace observer. For each of the use cases below, you can make the change by following in instructions in our GraphQL tutorial: [Update the data sources on a trace observer](/docs/apis/nerdgraph/examples/configure-infinite-tracing-graphql#updating-the-data-sources).
