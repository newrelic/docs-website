...
If you do not have access to the monitoring account, you can't see any trace observer metrics in the Edge app or execute NRQL queries on these metrics. Here's what you see if you do not have access:

![Screenshot showing what appears in the Edge app if you do not have access to the monitoring account that is receiving metrics.](./images/trace_observer_monitoring_no_access.png "trace_observer_monitoring_no_access.png")
