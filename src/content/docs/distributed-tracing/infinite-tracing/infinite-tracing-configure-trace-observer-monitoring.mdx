...
3. Click the <DoNotTranslate>**Trace observer monitoring**</DoNotTranslate> toggle.
...
* Two columns are added to the main trace observer listing:
  * <DoNotTranslate>**Traces Seen**</DoNotTranslate>: How many traces were seen by the trace observer in the last 60 minutes.
  * <DoNotTranslate>**Traces Kept**</DoNotTranslate>: The number and percentage of traces that were retained.
* A new pane is added on the right side of the screen:

  * <DoNotTranslate>**Monitoring account**</DoNotTranslate>: At the top of the right pane, this is the account where the trace observer metrics are written.
  * <DoNotTranslate>**How many traces were kept?**</DoNotTranslate> (top chart): Shows the same information as <DoNotTranslate>**Traces Kept**</DoNotTranslate>, but it shows you what this looks like over time. You can see the magnitude of sampling and any trends.
  * <DoNotTranslate>**Which traces were kept?**</DoNotTranslate> (bottom chart): Shows which categories of traces were kept. The chart shows whether traces were captured by different types of Infinite Tracing filters:
...
<DoNotTranslate>**How many traces were kept?**</DoNotTranslate> (top chart):
...
<DoNotTranslate>**Which traces were kept?**</DoNotTranslate> (bottom chart):
