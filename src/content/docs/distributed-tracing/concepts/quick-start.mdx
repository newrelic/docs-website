...
![Diagram showing the three steps to set up distributed tracing](src/images/arrow-step-diagram-trans.png 'Diagram showing the three steps to set up distributed tracing.')
...
![A sample environment diagram showing how you might identify services.](src/images/identify-services.png 'A sample environment diagram showing how you might identify services.')
   ...
   <TechTileGrid>
     ...
     <TechTile
       ...
       icon={
         <img
           src={newreliclogo}
           alt="New Relic format: use your own integration"
         />
       }
     />
   </TechTileGrid>
