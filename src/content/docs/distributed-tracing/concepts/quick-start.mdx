...
We recommend you do an initial setup of distributed tracing and consider the advanced [Infinite Tracing](/docs/distributed-tracing/infinite-tracing/introduction-infinite-tracing) feature if you are not getting the data you need. 
