...
Note: due to the increased trace data being sent from your application or third-party telemetry service, some customers find their egress costs increase as a result. We recommend keeping an eye on those costs as you roll out Infinite Tracing to ensure this solution is right for you.
