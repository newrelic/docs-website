...
<CollapserGroup>
  ...
  >
    Our <InlinePopup type="apm" /> language agents use adaptive sampling to capture a representative sample of system activity. The following is an explanation of how adaptive sampling works.
...
<CollapserGroup>
  ...
  >
    ...
    Here are two architectural diagrams: one showing how data flows if you use <InlinePopup type="apm" /> agents and another if you use New Relic integrations like OpenTelemetry exporters:
