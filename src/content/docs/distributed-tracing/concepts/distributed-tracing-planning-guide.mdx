...
Distributed tracing is enabled by default. For configuration information, See [Distributed tracing setup options](/docs/distributed-tracing/concepts/quick-start) to get started.
