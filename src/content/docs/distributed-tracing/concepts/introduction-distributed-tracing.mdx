...
I often get approached by many people asking if coding is necessary for data science. Many of them say they tried learning to code but they think it is not their cup of tea. Some of them reached a point that they now believe they could never learn to code. I had this same thought when I started learning data science. It is a problem of having a fixed mindset, it makes us think that we can’t not do certain things. Once you change that to a growth mindset then you realize the potential of perseverance. There is no limit to what we can learn and do. Many people trying to learn coding go through a journey like the one below.


If someone says that you can become a data scientist without learning to code. Do not trust them! 
Definitely not yet. 
Learning to code is absolutely, completely necessary to become a data scientist. 
