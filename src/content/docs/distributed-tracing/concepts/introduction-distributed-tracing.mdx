...
## Control your tracing costs with APM agent configuration [#span-configuration]

As you scale distributed tracing, you might want more control over data volume and costs. APM agents provide configurable controls to reduce tracing costs by 50-85% while maintaining the visibility you need.

APM agent span configuration helps you:
...
You get three configuration options to reduce your tracing data:
