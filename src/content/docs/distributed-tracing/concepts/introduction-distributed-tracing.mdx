...
---
Distributed tracing does more than show you what's happening inside an individual service (for example, in New Relic APM transaction tracing). Distributed tracing broadens your view by showing the path a request takes across multiple applications and services, from start to finish. With this wider view, you can quickly troubleshoot performance bottlenecks and errors.
