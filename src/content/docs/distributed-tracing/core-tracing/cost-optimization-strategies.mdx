...
Configure a service to sample some traces at full granularity while capturing others at partial granularity (reduced, essential, or compact). This gives you 100% trace coverage with mixed detail levels. Each individual trace is captured as either full OR partial granularity, never both simultaneously. Full granularity takes precedence when both are enabled.
