...
APM agents provide configurable controls for distributed tracing data ingestion. Partial granularity distributed traces and adaptive sampling help you ingest data in a controlled manner, capturing what matters while managing data volumes effectively. These configurations provide cost optimization controls customized to your needs, with results that vary by application. This guide shows you how to strategically apply span filtering and attribute reduction across your services.
