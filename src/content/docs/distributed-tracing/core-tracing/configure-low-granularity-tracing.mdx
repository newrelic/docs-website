...
2. Then, [configure span filtering](/docs/distributed-tracing/core-tracing/configure-minimal-spans-tracing) to implement reduced, essential, or compact granularity
