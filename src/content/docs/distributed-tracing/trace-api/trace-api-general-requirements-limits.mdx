...
* EU data center: `https://trace-api.eu.newrelic.com/trace/v1` (see other [EU endpoints](/docs/using-new-relic/welcome-new-relic/getting-started/introduction-eu-region-data-center#endpoints)).
* JP data center: `https://trace-api.jp.nr-data.net/trace/v1` (see other [JP endpoints](/docs/accounts/accounts-billing/account-setup/choose-your-data-center/#jp-endpoints)).
