...
* `newrelic`: our general format. If you do not have Zipkin-format data, use this. [Get started sending New Relic-format data](/docs/apm/distributed-tracing/trace-api/report-new-relic-format-traces-trace-api).
