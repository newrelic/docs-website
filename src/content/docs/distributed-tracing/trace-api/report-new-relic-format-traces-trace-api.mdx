...
2. Insert that key into the following JSON and then send the JSON to our endpoint. Note: if you have an EU or JP New Relic account, use the appropriate [regional endpoint](/docs/distributed-tracing/trace-api/trace-api-general-requirements-limits#requirements) instead.
