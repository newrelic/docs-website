...
Note that if you were using Infinite Tracing, or had an EU or JP-region New Relic account, the [endpoint](/docs/distributed-tracing/trace-api/trace-api-general-requirements-limits#requirements) would be different.
