...
![Distributed Tracing Zipkin Integration Searching for sample trace](src/images/Screen-Shot-2020-08-13-at-1.26.17-PM.png 'Distributed Tracing Zipkin Integration Searching for sample trace')
