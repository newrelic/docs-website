...
* Use our [instrumentation status app](https://one.newrelic.com/dt-setup-assistant) to see an overview of your trace instrumentation, including sampling rates. This can help you understand missing spans and fragmented traces. To find this, go to: **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Apps > Distributed tracing instrumentation status**.
