...
You can use our [instrumentation status app](https://one.newrelic.com/dt-setup-assistant) to see an overview of your trace instrumentation. To find this, go to: **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Apps > Distributed tracing instrumentation status**.
