...
1. **Identify services:** Identify the endpoints, services, languages, and systems that are used to complete this request. If you have a service map like the following, you could use it to create a list of services handling requests:
