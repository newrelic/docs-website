...
* [Quick-start installation (recommended):](#quick-start-apm) Steps for setting up standard distributed tracing
...
## Quick start installation (recommended) [#quick-start-apm]
