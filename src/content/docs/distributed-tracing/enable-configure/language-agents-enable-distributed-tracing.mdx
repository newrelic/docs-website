...
---
This guide starts with the steps for setting up [standard distributed tracing](/docs/understand-dependencies/distributed-tracing/get-started/how-new-relic-distributed-tracing-works#head-based) with APM agents. If you find that you want to capture even more traces, you can take the additional steps of setting Infinite Tracing. 
...
## Step 1. Make sure you have a free New Relic account.
...
To choose the installation assistant for your language, click the **Add your data** page:
...
After you set up the agents, set the folling 
...
## Step 2. Configure the agent [#configure-agents]
...
## (Optional) Set up Infinite Tracing  
...
<Callout variant="tip">
If you want to know more about this type of sampling before you set it up, you can check out [Infinite Tracing](/docs/understand-dependencies/distributed-tracing/infinite-tracing/introduction-infinite-tracing). 
</Callout>

 To set up Infinite Tracing, you first provision a trace observer and then you add some agent configurations that point to the trace observer.

### Set up the trace observer [#provision-trace-observer]

The trace observer is a New Relic AWS-based service that collects and analyzes all your traces. Follow the instructions over in [Set up trace observer](/docs/understand-dependencies/distributed-tracing/infinite-tracing/set-trace-observer). When you're done, return here with your trace observer information and configure the agent to send data to the trace observer.
