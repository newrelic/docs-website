...
This is the best approach to set up [standard distributed tracing](/docs/distributed-tracing/concepts/how-new-relic-distributed-tracing-works/#head-based) if you haven't installed any New Relic APM agents for your services yet, or if you want to instrument additional services.
...
<CollapserGroup>
  ...
  >
    ...
    To use Infinite Tracing, the Infinite Tracing gem is also available from rubygems.org as `newrelic-infinite_tracing`. For applications using Bundler, additionally include the Infinite Tracing gem in the Gemfile:
