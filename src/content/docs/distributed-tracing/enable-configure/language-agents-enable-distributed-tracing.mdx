...
When you install new instances of the New Relic APM agents for Go, Java, Node.js, .NET, PHP, Python, or Ruby, standard distributed tracing is turned on by default.
...
* [Set up tracing for new agents:](#new-agentsl) Steps for head- and tail-based sampling
...
The Infinite Tracing setup builds on the instrumentation steps above for [standard distributed tracing](#quick-start-apm). Make sure you've completed these before you got to the next step about the trace observer.
