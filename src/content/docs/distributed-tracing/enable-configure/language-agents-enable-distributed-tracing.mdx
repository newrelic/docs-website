...
New Relic APM language agents provide a number of ways to leverage the power of distributed tracing:

* [APM quick start (recommended):](#quick-start-apm) Steps for setting up standard distributed tracing
...
## APM quick start (recommended) [#quick-start-apm]
...
<CollapserGroup>
  ...
  >
    The **Explorer** helps you navigate to a specific service so you can see traces that include that service.
    ...
    5. In the left navigation's **Monitor** section, click **Distributed tracing**.
  </Collapser>
