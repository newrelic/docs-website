...
---
This is the place for all things related to distributed tracing with New Relic APM. Here's what you'll find here:

* [Quick-start:](#quick-start) Steps for standard distributed tracing
* [Infinite Tracing:](#infinite-tracing) An advanced alternative to standard distributed tracing
* [Older APM agents:](#older-agents) Your tracing options if you already have APM agents
...
We recommend this approach to set up [standard distributed tracing](/docs/understand-dependencies/distributed-tracing/get-started/how-new-relic-distributed-tracing-works#head-based) if you are just getting started installing APM agents for each service.

### Step 1. Set up a free New Relic account
...
### Step 2. Instrument your services using APM agents [#update-agents]
We have installation assistants for the following languages to help you instrument each service: 

  ![List of supported language agents](./images/language-icon-list.png)
...
To find the installation assistants, click **Add your data** below and click the language of your service under **Back-end, front-end, and mobile applications**:
...
After you instrument your services with APM agents, generate some traffic in your application so we can capture some traces. Here are two ways to view your traces in the UI:
...
## (Optional) Set up Infinite Tracing [#infinite-tracing] 
...
<Callout variant="tip">
If you want to know more about this type of sampling before you set it up, check out [Infinite Tracing](/docs/understand-dependencies/distributed-tracing/infinite-tracing/introduction-infinite-tracing). 
</Callout>

### Step 1. Complete the steps for setting up standard distributed tracing in [Quick Start](#quick-start)
...
### Step 3. (Optional) Customize Infinite Tracing
...
If you have older APM agents, here's what you need to know about whether the distributed tracing features you want are supported and how to enable your agents for distributed tracing.
...
### Configure your existing older agents [#configure-agents]
