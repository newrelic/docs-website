...
You can start an Intelligent Exemplar investigation from any APM chart that displays latency or error data.

1. Go to <DNT>**[one.newrelic.com > APM & Services](https://one.newrelic.com/apm)**</DNT> and open a service that is showing a latency or error spike.
2. On any chart displaying latency or error data, click the time window that corresponds to the spike you want to investigate.
3. In the tooltip that appears, select <DNT>**Intelligent Traces**</DNT>.
...
<figcaption>
  Click any time window on a latency or error chart, then select <DNT>**Intelligent Traces**</DNT> from the tooltip to start an investigation.
</figcaption>
