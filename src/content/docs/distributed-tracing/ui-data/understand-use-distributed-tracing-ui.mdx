...
The waterfall view is below the entity map, and displays a cascade of a trace's spans. This allows you to see how spans relate to each other in a vertical layout.
