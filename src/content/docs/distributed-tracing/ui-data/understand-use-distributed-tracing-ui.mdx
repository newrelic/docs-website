...
If you are really trying to troubleshoot errors in a transaction that spans many services:
HI ROB!

Hello, Clark!

Here's a test of the upstream setup...
...
<CollapserGroup>
    ...
    >        
        ...
        1. Select the duration type in the <DNT>**View by**</DNT> dropdown:
          * <DNT>**Backend duration**</DNT>
          * <DNT>**Root span duration**</DNT>
