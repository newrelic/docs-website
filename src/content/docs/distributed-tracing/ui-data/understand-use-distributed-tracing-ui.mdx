...
The trace scatter plot is a quick way to search for outlying traces. This is is available on the opening page of distributed tracing if you turn off **Group similar traces** toggle at the top of the page.
