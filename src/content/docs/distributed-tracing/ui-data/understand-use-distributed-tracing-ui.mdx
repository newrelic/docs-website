...
<CollapserGroup>
  ...
  >
    Preserved traces are similar to archived snapshots. They archive a trace that has been previously viewed and has surpassed the retention period. By default, unless you have purchased extended retention, a full trace is only available for 7 days. Preserved traces can exist for up to 1 year, and generally function like the original trace.
