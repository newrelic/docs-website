...
### Additional filters [#left-pane-filters]
...
When you open distributed tracing, you'll see three charts at the top (if **Group similar traces** is turned on). These charts show you the trace-count, 95th percentile duration, and error-count for each of the trace groups listed in the table below.

To change the filters on these charts, see [Filters](#left-pane-filters).
...
If a trace involves more than one entity, and we have information about those entities, the trace page includes a map. For more about how that works, see [Maps in context](/docs/new-relic-one/use-new-relic-one/ui-data/maps-in-context).
