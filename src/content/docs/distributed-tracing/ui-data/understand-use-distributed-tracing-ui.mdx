...
If, for example, you are looking to troubleshoot errors in a complex transaction spanning many services, here's what you can do in our UI:
...
3. On the [trace details page](/docs/distributed-tracing/ui-data/trace-details/), you review the span along the request route that originated the error.
...
<Tabs stacked>
	<TabsBar>
        ...
        <TabsBarItem id="2">
            [Select left-pane filters](#left-pane-filters)
        </TabsBarItem>
        <TabsBarItem id="3">
