...
<CollapserGroup>
  ...
  >
    ...
    * An <InlinePopover type="apm" /> agent may have hit its [span collection limit](/docs/distributed-tracing/concepts/how-new-relic-distributed-tracing-works/#agent-limits-sampling).
