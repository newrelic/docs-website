...
Rather than showing a random or chronologically ordered sample, <DNT>Intelligent Exemplar</DNT> evaluates the full trace dataset and surfaces a curated list of up to 500 traces that best represent the anomaly. Fragmented traces are filtered out automatically. Traces are weighted toward occurrences that fall within the spike window. 
