...
If your entity is not reporting trace data, the entity insights component will present a no data view that provides links to our docs and a Guided Install solution.
<img
