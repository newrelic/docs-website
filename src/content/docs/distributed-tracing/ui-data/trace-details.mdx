...
import newRelicDistributedTracingInprocessIcon from 'images/distributed-tracing_icon_inprocess-icon.webp'

import newRelicDistributedTracingLambdaIcon from 'images/distributed-tracing_icon_lambda-icon.webp'
