---
title: Understand trace details
tags:
    - Distributed tracing
    - UI and data
    - Trace details
...
redirects:
    - /docs.newrelic.com/docs/distributed-tracing/ui-data/understand-use-distributed-tracing-ui/#trace-details
---
...
When you select a trace from the trace list, you can see an [entity map](#entity-map) at the top, or you can toggle between [timeline](#timeline-view) and [latency](#latency-view) views. Below this top section is a [waterfall view](#waterfall-view) displaying that trace's spans. 
