...
<LandingPageHero>
  ...
  ![Here is an example showing the relationship and layout of a distributed application.](./images/index-intro.svg "Here is an example showing the relationship and layout of a distributed application.")
