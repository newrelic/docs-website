...
<LandingPageHero>
  ...
  <figcaption>
    Here is an example of distributed traces captured from an HTTP request.
  </figcaption>
</LandingPageHero>
...
Check out this [quick-start overview](/docs/distributed-tracing/enable-configure/quick-start) if you want to go directly to the setup.
