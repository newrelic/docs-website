...
## Use the /NEWR/INSTALL menu [#menu-newr-install]
...
## Connect systems and generate configurations [#connect-systems]
  ...
  - **Set up HTTP and RFC Destinations**: Use this option to invoke transaction `SM59` and verify your [RFC](/docs/sap-solutions/additional-resources/additional-configuration/#create-rfc-for-monitored-systems) and [HTTPS](/docs/sap-solutions/additional-resources/additional-configuration/#set-http-destination-to-new-relic-cloud) connections.
  ...
  - **Copy Template Tables from Client 000**: Execute this option to copy the table from client 000 by clicking the execute icon (clock symbol). Confirm the success message appears.
  ...
  <Callout variant="tip">
    Maintain the list of **Monitoring Groups** by navigating to **Expert Mode > Installation Setups > Monitoring Group Maintenance**. For a complete list of data providers in each monitoring group, see the [Data Providers Reference](/docs/sap-solutions/additional-resources/data-providers-reference).
  </Callout>
