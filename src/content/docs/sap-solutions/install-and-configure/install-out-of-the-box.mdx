...
## Install dashboards
  ...
  2. To view all the SAP dashboards, in the **Recommended Dashboards** section, click **view all**. See [Dashboards](/docs/query-your-data/explore-query-data/dashboards/introduction-dashboards/) for an introduction to our custom dashboards feature.
  ...
  3. Search for SAP and install the following dashboards:
      - **SAP Dashboards**
      - **SAP Cockpit**
    ...
    <Callout variant="important">
      For the **SAP Cockpit** dashboard, you must [create a lookup table](#create-lookup-table) named `NR_LKUP_SYSTEM`.
    </Callout>
