...
- **TRACE**: In this group are the performance database (STAD) related data providers:
  - Includes performance database-related providers such as [`NR.SAP.TRANSACTION`](/docs/sap-solutions/additional-resources/data-providers-reference/#sap-appl-metrics) (trace data provider), [`NR.SAP.TRANSACTION.COMPLETE`](/docs/sap-solutions/additional-resources/data-providers-reference/#sap-appl-metrics) (complete performance database collection with parallel background RFC process), `NR.SAP.SYSTEM.PROCESS`, `NR_SAP_PROGRAM`, `NR_SAP_WORKLOAD_COMPLETE`, and `NR.SAP.WORKLOAD.COMPLETE`.
...
- **IDOC**: In the production systems, IDOC collection may take a significant amount of time:
  - Includes IDOC-related providers such as [`NR_SAP_IDOC`](/docs/sap-solutions/additional-resources/data-providers-reference/#idoc-all) (main IDOC status event data provider), [`NR_SAP_IDOC_COMPLETE`](/docs/sap-solutions/additional-resources/data-providers-reference/#idoc-all) (complete IDOC retrieval with BG RFC collection), and `NR_SAP_IDOC_Configuration` (download IDOC master data to improve IDOC data provider performance).
- **SYSTEM**: Rest of the data providers. See the [complete list by monitoring group](/docs/sap-solutions/additional-resources/data-providers-reference).
