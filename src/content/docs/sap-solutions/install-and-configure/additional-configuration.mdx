...
<Steps>
  ...
  <Step>
    ...
    3. Enter the **Target Host**, **Service No.** as (443) (see [standard port](/docs/sap-solutions/reference/network-accessibility) for HTTPS), and **Path Prefix** (see [installation readiness checklist](/docs/sap-solutions/reference/pre-installation-checklist/#checklist-for-installation-readiness) for details).
  ...
  <Step>
    ...
    6. Click **Save**, then click **Test** to verify the connection.
