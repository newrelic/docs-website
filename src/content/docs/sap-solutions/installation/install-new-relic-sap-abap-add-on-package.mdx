...
2. Type the transaction code `SAINT` in the **SAP GUI command field** and click **Enter**.
3. Go to **Installation Package** > **Load Packages**.
4. Choose a method to load add-on files:
  ...
  <CollapserGroup>
    ...
    >
      ...
      <img
          ...
          width=""
          />
      4. The message **File K-xxxAOIINNEWR.SAR sucessfully transferred, decompressed, and deleted** appears.
    </Collapser>
  </CollapserGroup>
...
6. Select the package in the **Installable Add-on packages for your system** and click **Continue**.
7. When prompted with the question **Do you want to add Modification Adjustment Transports to the queue?**, click **No**.
...
10. In the **Installed Components** tab, verify that the installation was successful.
