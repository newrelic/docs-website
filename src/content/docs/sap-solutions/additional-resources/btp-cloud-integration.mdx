...
<Steps>
  ...
  <Step>
    ...
    For detailed instructions, see [Obtain Service Key for BTP Monitoring](/docs/sap-solutions/additional-resources/obtain-service-key/process-integration-runtime).
  </Step>
