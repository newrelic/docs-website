...
<Steps>
  ...
  <Step>
    ...
    3. Enter the **Target Host**, **Service No.** as (443) (see [standard port](/docs/sap-solutions/additional-resources/network-accessibility) for HTTPS), and **Path Prefix** (see [installation readiness checklist](/docs/sap-solutions/additional-resources/pre-installation-checklist/#checklist-for-installation-readiness) for details).
