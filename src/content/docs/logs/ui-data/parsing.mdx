...
<Callout variant="preview" title="Note">
  **New experience available:** Try [No-Code Parsing](/docs/logs/ui-data/no-code-parsing), a visual interface that automatically detects common patterns and lets you create parsing rules without writing Grok or Regex. Great for quick setup and users without pattern syntax experience.
</Callout>

New Relic parses log data automatically according to certain parsing rules. In this doc, you'll learn how logs parsing works, and how to create your own custom parsing rules using Grok and Regex.
