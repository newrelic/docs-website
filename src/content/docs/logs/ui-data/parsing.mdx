...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="Parsing CSV"
  >
    If your system is sending comma-separated values (CSV) logs and you need to parse them in New Relic, you can use `csv` [Grok type](#grok-syntax), which will parse the CSV captured by the Grok pattern.
