...
import logParsing072822 from 'images/log-parsing072822.png'
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        * To simplify the matching process, we recommend adding a [`logtype`](#logtype) attribute to your logs. However, you are not limited to using `logtype`; one or more attribute can be used as matching criteria in the NRQL where clause.
      </td>
    </tr>
