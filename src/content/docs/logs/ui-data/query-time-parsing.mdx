...
While your rules are temporary and apply to your current user session, you can still perform a variety of tasks before you end your session.


<CollapserGroup>
    <Collapser
        id="edit-and-delete-rules"
        title="Edit and delete rules [#edit-delete-rules"
    >
