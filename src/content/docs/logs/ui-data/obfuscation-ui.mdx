...
<Callout variant="tip">
  Obfuscation has per-minute CPU limits for obfuscation. If your account hits your resource limits, logs won't be obfuscated as expected. To easily check your CPU limits, go to your [system **Limits** page](/docs/data-apis/manage-data/view-system-limits/#limits-ui) in the New Relic Data Management UI.
</Callout>
