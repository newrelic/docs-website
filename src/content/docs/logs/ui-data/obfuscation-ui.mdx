...
<CollapserGroup>
  ...
  >
    Here are some examples of regex expressions that obfuscate some of the most common sensitive data types. Note, you must create  obfuscation expressions for each account where those expressions will be in use.
