...
<CollapserGroup>
  ...
  >
    ...
    **Using the logs UI:**
    ...
    3. Click the ellpisis icon **...** at the right side of the obfuscation expression you want to edit, and click **Edit**.
  ...
  >
    ...
    **Using the logs UI:**
    ...
    3. Click the ellpisis icon **...** at the right side of the obfuscation expression you want to delete, and click **Delete**.
...
<CollapserGroup>
  ...
  >
    ...
    **Using the logs UI:**
    ...
    3. Click the ellpisis icon **...** at the right side of the obfuscation rule you want to edit, and click **Edit**.
  ...
  >
    ...
    **Using the logs UI:**
    ...
    3. Click the ellpisis icon **...** at the right side of the obfuscation rule you want to delete, and click **Delete**.
