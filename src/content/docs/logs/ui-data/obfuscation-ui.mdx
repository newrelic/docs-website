...
<Callout variant="important">
  If your account hits your resource limits, logs won't be obfuscated as expected.
</Callout>
...
The JSON objects displayed in the following example are simplifications of the payloads used in the Obfuscation API. This will help you better correlate the different API operations with their equivalent UI counterparts.
...
Here is the basic process to obfuscate the sensitive data.
...
You can create, read, update, or delete obfuscation expressions by using the New Relic One UI or by using NerdGraph, our GraphQL Explorer.
...
<CollapserGroup>
  ...
  **Using the Logs UI:**
  ...
  3. Click **...** at the right side of the obfuscation expression you want to edit, and click **Edit**.
  ...
  **Using the Logs UI:**
  ...
  3. Click **...** at the right side of the obfuscation expression you want to delete, and click **Delete**.
...
You can create, read, update, or delete obfuscation rules by using the New Relic One UI or by using NerdGraph, our GraphQL Explorer.
...
<CollapserGroup>
  ...
  **Using the Logs UI:**
  ...
  3. Click **...** at the right side of the obfuscation rule you want to edit, and click **Edit**.
  ...
  **Using the Logs UI:**
  ...
  3. Click **...** at the right side of the obfuscation rule you want to delete, and click **Delete**.
