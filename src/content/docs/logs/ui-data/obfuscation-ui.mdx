...
<Callout variant="tip">
  The **Obfuscation** UI includes a **Hashing tool** so that you can find a hash from a known value and copy it for use with other expressions and rules.
</Callout>
...
<CollapserGroup>
  ...
  >
    ...
    **Using the Logs UI:**
    ...
    3. Enter a name and the regular expression matching the sensitive data you want to capture. Use [RE2 syntax](https://github.com/google/re2/wiki/Syntax).
    ...
    **Using NerdGraph:**
    ...
    <Callout variant="important">
      You must escape the `regex` when introducing it via NerdGraph:
