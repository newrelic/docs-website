...
<CollapserGroup>
  ...
  >
    ...
    Main responsability of this feature is to replace sensitive data with the hash or mask in an easy and performant way.
    ...
    For example, avoid `(([A-Z]{12})|([a-z]{6}))` in favor of `((?:[A-Z]{12})|((?:[a-z]{6}))`.
    </Callout>
