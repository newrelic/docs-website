...
* Create partitions to optimize the number of events that must be scanned for your most common queries.  There is no hard and fast rule, but generally as scanned log events gets over 500 million (especially over 1 billion) for your `common` queries you may consider to adjust your partitioning.
