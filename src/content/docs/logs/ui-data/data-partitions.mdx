...
### Tips for finding events in partitions [#tips-for-finding-events]

In order to get a sense of how many events are in a given partition run a query like this:
