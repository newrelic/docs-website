...
import logPartitionsCrop from 'images/log-partitions-crop.png'

import logPartitions from 'images/log-partitions.png'
...
<img
  src={logPartitionsCrop}
  title="Log data partitions UI"
  alt="Log data partitions UI"
/>

<figcaption>
  From the left nav in the Logs UI, select **Data partitions**, then create a Log\_ partition name with the retention namespace, optional description, and matching criteria.
</figcaption>
