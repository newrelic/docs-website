...
import LogPartCrop from 'images/log-partitions-crop.png'

import LogPartRule from 'images/log-partitions.png'
...
<img
  title="Log data partitions"
  alt="Screenshot of Log partitions UI"
  src={LogPartCrop}
/>
<figcaption>
