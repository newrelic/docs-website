...
* Create partitions to optimize the number of events that must be scanned for a given query.
...
- Default retention for a given partition (impact the total potential events that can be scanned in a query)
