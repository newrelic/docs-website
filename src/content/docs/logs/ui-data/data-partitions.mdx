...
* <DNT>**Direct to live archive:**</DNT> Skips standard retention entirely. Logs sent to a partition using this namespace go straight into long-term live archive storage instead of first landing in standard storage. This is a good fit for logs you rarely need to query but must retain for a long time, such as compliance or audit logs, since you're not paying for standard-tier storage on data you don't plan to look at day-to-day. This option requires live archives to be enabled on your account. For more information, see [Long-term log storage with live archives](/docs/logs/get-started/live-archives/).
