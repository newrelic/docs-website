...
If you want to manage your data partitions programatically, you can use [NerdGraph](https://api.newrelic.com/graphiql), our GraphQL-format API. The [NerdGraph data partitions tutorial](/docs/apis/nerdgraph/examples/nerdgraph-data-partition-rules-tutorial/) shows how to query, create, and delete data partitions using this API.
...
7. Click **Create** to save your new partition.
...
<figcaption>
  To view the list of custom parsing rules: From **Manage Data** on the left nav of the Logs UI, click **Data partitions**.
</figcaption>
