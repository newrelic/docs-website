...
A partition's namespace determines its retention period. We offer three retention options:
...
* <DNT>**Direct to live archive:**</DNT> Skips standard retention entirely. Logs sent to a partition using this namespace go straight into long-term live archive storage instead of first landing in standard storage. This namespace works best for logs you rarely need to query but must retain for a long time, such as compliance or audit logs, since you're not paying for standard-tier storage on data you don't plan to look at day-to-day. This option requires you to enable live archives on your account. For more information, see [Long-term log storage with live archives](/docs/logs/get-started/live-archives/).
