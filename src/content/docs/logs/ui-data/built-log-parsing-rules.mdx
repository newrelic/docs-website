...
New Relic can parse common log formats according to built-in rules, so that you don't have to create your own parsing rules. Here are the log parsing rules, their [Grok](https://grokdebug.herokuapp.com/patterns#) patterns, and what fields are parsed.
