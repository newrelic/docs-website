...
<CollapserGroup>
  ...
  >
    ...
    <DoNotTranslate>**Grok:**</DoNotTranslate>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            * `Error`: Typically this means the request resulted in a client error (`sc_status` is `4xx`) or a server error (`sc_status` is `5xx`). If the value of `x_edge_result_type` is `Error` and the value of this field is <DoNotTranslate>**not**</DoNotTranslate> `Error`, the client disconnected before finishing the download.
        ...
        <tr>
          ...
          <td>
            When `x-edge-result-type` <DoNotTranslate>**is not**</DoNotTranslate> `Error`, this field contains the same value as `x-edge-result-type`. When `x-edge-result-type` <DoNotTranslate>**is**</DoNotTranslate> `Error`, this field contains the specific type of error.
          </td>
        </tr>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            When `x_edge_result_type` <DoNotTranslate>**is not**</DoNotTranslate> `Error`, this field contains the same value as `x_edge_result_type`. When `x_edge_result_type` <DoNotTranslate>**is**</DoNotTranslate> `Error`, this field contains the specific type of error.
          </td>
        </tr>
  ...
  >
    ...
    * `message`: Free-form message that provides information about the event.
    ...
    <DoNotTranslate>**Structured data parsing examples:**</DoNotTranslate>
