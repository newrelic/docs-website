...
<CollapserGroup>
  ...
  >
    ...
    * `container_service`: The unique identifier used to distinguish containers in ktranslate. This is set during <DNT>Docker/DNT> runtime with the optional `--service_name` flag
  ...
  >
    ...
    * `message`: Free-form message that provides information about the event.
    ...
    <DNT>**Structured data parsing examples:**</DNT>
