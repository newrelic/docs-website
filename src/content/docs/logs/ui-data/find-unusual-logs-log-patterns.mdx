...
1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Logs**, and use the account picker dropdown to select the target account where you want to explore patterns.
