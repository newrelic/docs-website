...
import logPatternsMainUi from 'images/log-patterns-main-ui.png'

import logPatternsMainUi2 from 'images/log-patterns-main-ui-2.png'

import logPatternsLogsWithoutAPattern from 'images/log-patterns-logs-without-a-pattern.png'

import logPatternsExample1 from 'images/log-patterns-example1.png'

import logPatternsWildcard from 'images/log-patterns-wildcard.png'
...
<img
  src={logPatternsMainUi}
  title="Log patterns main UI"
  alt="Log patterns main UI"
/>
...
<img
  src={logPatternsMainUi2}
  title="Log patterns UI"
  alt="Log patterns UI"
/>
...
<img
  src={logPatternsLogsWithoutAPattern}
  title="Log patterns UI: Logs with no pattern"
  alt="Log patterns UI: Logs With No Pattern"
/>
...
<img
  src={logPatternsExample1}
  title="Log patterns UI: example log pattern"
  alt="Log patterns UI: example log pattern"
/>
...
<img
  src={logPatternsWildcard}
  title="Log patterns UI: wildcard example"
  alt="Log patterns UI: wildcard example"
/>
