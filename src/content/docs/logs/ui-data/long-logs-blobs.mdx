...
import logsLogBlobQuery from 'images/logs_screenshot-crop_log-blob-query.png'
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Logs**: To query extended blob data in your logs, be sure to include backticks in your attribute's blob syntax.
</figcaption>
