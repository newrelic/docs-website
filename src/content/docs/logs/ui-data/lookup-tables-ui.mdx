...
Our <DoNotTranslate>**lookups**</DoNotTranslate> feature lets you enrich your log data, and other New Relic-stored data, with data about your business that you define in a CSV file.
...
To find the lookup table UI: From [one.newrelic.com](https://one.newrelic.com), click <DoNotTranslate>**Logs**</DoNotTranslate>, and then click <DoNotTranslate>**Lookup tables**</DoNotTranslate>. From there, you can upload, download, update, and delete tables.
