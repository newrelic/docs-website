...
You can add and manage lookup tables through the [UI](#lookup-ui) or the [Lookups Service API](#lookup-service-api). 
...
### Using the Lookup Service API [#lookup-service-api]

Alternatively, you can add and manage tables using the [Lookup Service API](/docs/apis/lookup-service-api/lookup-service-api). The Lookup Service API supports uploading lookup tables as a CSV file and a JSON object.
