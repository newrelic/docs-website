...
The lookup table upload UI is located in the logs UI, but you can use your lookup table data when querying any data type, not just logs. 
...
[Learn more table requirements and limitations](#requirements). 
