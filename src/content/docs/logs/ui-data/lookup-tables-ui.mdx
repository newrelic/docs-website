...
You can add and manage lookup tables through the [UI](#lookup-ui) or the [Lookups Service API](#lookups-service-api). 
...
### Using the Lookups Service API [#lookups-service-api]

Alternatively, you can add and manage tables using the [Lookups Service API](/docs/apis/lookups-service-api/lookups-service-api). The Lookups Service API supports uploading lookup tables as a CSV file and a JSON object.
