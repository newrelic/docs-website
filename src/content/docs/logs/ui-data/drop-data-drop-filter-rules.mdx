...
/>
<figcaption>
  Filter or query the set of logs that contain the data you want to drop. Then, from <DoNotTranslate>**Manage data**</DoNotTranslate> on the left nav of the logs UI, click <DoNotTranslate>**Create drop filter**</DoNotTranslate>.  
</figcaption>
...
<DoNotTranslate>**From a query:**</DoNotTranslate>
...
3. Once the query is active, from <DoNotTranslate>**Manage data**</DoNotTranslate> on the left nav of the logs UI, click <DoNotTranslate>**Create drop filter**</DoNotTranslate>.
...
<DoNotTranslate>**From an attribute:**</DoNotTranslate>
1. Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Logs**</DoNotTranslate>.
2. In <DoNotTranslate>**All logs**</DoNotTranslate> click on a log that contains the attribute you want to drop to open log detail view.
3. Click on the attribute you want to drop to open the attribute menu.
4. Click <DoNotTranslate>**Create drop filter from attribute**</DoNotTranslate>.
...
<DoNotTranslate>**From scratch:**</DoNotTranslate>
1. Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Logs**</DoNotTranslate>.
2. From <DoNotTranslate>**Manage data**</DoNotTranslate> on the left nav of the logs UI, click <DoNotTranslate>**Drop filters**</DoNotTranslate>.
3. Click the <DoNotTranslate>**Create drop filter**</DoNotTranslate> button on the right hand side of the drop filters view.
4. Give the drop rule a meaningful name.
