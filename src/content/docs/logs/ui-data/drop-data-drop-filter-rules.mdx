...
<img
  src={ingestPipeline}
  title="New Relic Logs - Architecture - Drop filter"
  alt="New Relic Logs - Architecture - Drop filter"
/>
...
<img
  ...
  title="View log drop filters"
  alt="View log drop filters"
/>
