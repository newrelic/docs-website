...
Use our Logs UI at **[one.newrelic.com](https://one.newrelic.com)** or our [EU region data center](/docs/using-new-relic/welcome-new-relic/get-started/our-eu-us-region-data-centers/) (if applicable) at **[one.eu.newrelic.com](https://one.eu.newrelic.com)** to:
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Logs**: To explore and manage your logs, use the left nav. To view detailed information, click any log line.
</figcaption>
...
<CollapserGroup>
  ...
  Go to our Logs UI at **[one.newrelic.com](https://one.newrelic.com) > Logs**.
  ...
  If you have not [customized your New Relic navigation bar](/docs/new-relic-one/use-new-relic-one/ui-data/basic-ui-features/#custom-navigation), go to **[one.newrelic.com](https://one.newrelic.com)**, click **Browse data**, and select **Logs**.
  </Collapser>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Go to **[one.newrelic.com](https://one.newrelic.com) > APM**, select an app, then use any of these options:
    ...
    <tr>
      ...
      <td>
        Go to **[one.newrelic.com](https://one.newrelic.com) > APM > (select an app) > Distributed tracing > (select a trace) > Logs**.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Go to **[one.newrelic.com](https://one.newrelic.com) > Explorer** or **Infrastructure > Hosts > (select a host) > Logs**.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Go to **[one.newrelic.com](https://one.newrelic.com) > Explorer > Kubernetes cluster explorer > (select a cluster) > (select a pod or container) > See logs**.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Go to **[one.newrelic.com](https://one.newrelic.com) > Explorer > (select an entity) > Logs**.
      </td>
    </tr>
  </tbody>
</table>
