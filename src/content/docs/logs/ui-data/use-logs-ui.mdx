...
3. **Narrow your focus:**
   ...
   * To manage the amount of log data collected and to store fewer logs, create [drop filter rules](/docs/logs/ui-data/drop-data-drop-filter-rules/) that avoid collecting data you do not need.
