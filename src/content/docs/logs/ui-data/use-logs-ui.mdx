...
You can automate your log monitoring by scheduling NRQL queries to run on a recurring basis. When viewing log data, click the three-dot menu or clock icon to schedule your current query. Scheduled queries can deliver results to your email as CSV attachments and run on flexible schedules using cron expressions.

For complete details on setting up and managing scheduled queries, see [Schedule NRQL queries](/docs/data-insights/schedule-nrql-queries).
