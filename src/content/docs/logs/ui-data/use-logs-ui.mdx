...
Then, from your dashboard you can:
  ...
  >
    ...
    1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM > (select an app)**.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM > (select an app) > Distributed tracing > (select a trace) > Logs**.
      </td>
    </tr>
