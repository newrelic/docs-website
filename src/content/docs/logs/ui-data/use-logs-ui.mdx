...
<CollapserGroup>
  ...
  * On the logs table, click the **+** icon to add an attribute, then click on it to add it to the query.
  ...
  Go beyond the capabilities of the streamlined querying interface of the Logs UI by writing NRQL queries on log events directly, using the [NRDB query builder](/docs/query-your-data/explore-query-data/query-builder/introduction-query-builder/). Click the "NRQL" button to the right of the Logs search bar to go directly to this powerful NRQL interface, without losing the columns and Lucene filtering you have already selected.
