...
<CollapserGroup>
  ...
  * To help identify an issue's root cause before it occurred or its impact after an event, click the box on the log line to [show surrounding logs](/docs/logs/troubleshooting/find-issues-cause-or-impact-surrounding-logs).
  * To see logs in context of other telemetry data for your apps and hosts, use [logs in context](/docs/logs/logs-context/logs-in-context).

  </Collapser>
  
  <Collapser
    id="share"
    title="6. Share your findings."
  >
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Go to **[one.newrelic.com](https://one.newrelic.com) > Distributed tracing > (select a trace > Logs**.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Go to **[one.newrelic.com](https://one.newrelic.com) > Infrastructure > Hosts > (select a host) > Monitor > Logs**.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Go to **[one.newrelic.com](https://one.newrelic.com) > Kubernetes cluster explorer > (select a cluster) > (select a pod or container) > See logs**.
      </td>
    </tr>
