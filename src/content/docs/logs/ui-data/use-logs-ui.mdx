...
To find the **Logs** UI, go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Logs**. 
...
1. Click **Saved views** in the **Logs** left nav, then click **Save current view**.
