...
To export a subset of your logs to share, users can leverage our dedicated Export feature in the Logs UI. This feature will allow an export of up to 2000 log records in either CSV or JSON format. The log records will be downloaded locally on your machine in the Downloads folder of your browser.
