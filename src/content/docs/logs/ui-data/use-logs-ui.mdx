...
* [Schedule automated NRQL searches](/docs/nrql/using-nrql/schedule-nrql-searches) to receive regular query results via email.
...
<CollapserGroup>
  ...
  >
    ...
    2. To schedule the search, use either of these options:
       ...
       * Click the clock icon <Icon name="fe-clock"/> below the query trend chart.
