...
import logs-ui-040622 from 'images/logs-ui-040622.png'
...
<img src={logs-ui-040622} alt="Logs UI with details" title="Logs UI with details pane" />
...
1. If you have not [customized your New Relic navigation bar](/docs/new-relic-one/use-new-relic-one/ui-data/basic-ui-features/#custom-navigation), go to **[one.newrelic.com](https://one.newrelic.com)**, click **Browse data** and select **Logs**.
2. **Look for patterns:**
...
5. **Search:**
   ...
   By default, the Logs UI shows all your logs, but you can also search with keywords or phrases to find the results you want; for example, `process failed`. You can also use the search field, use the type-ahead dropdowns to select an attribute, operator, and value; for example:
