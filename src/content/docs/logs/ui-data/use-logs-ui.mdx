...
<Callout variant="tip">
  Let your app's <InlinePopup type="apm" /> agent forward log data directly to New Relic with [APM logs in context](/docs/apm/new-relic-apm/getting-started/get-started-logs-context). No need to install or maintain additional third-party software!
</Callout>
