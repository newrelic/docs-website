...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Explorer** or **Infrastructure > Hosts > (select a host) > Logs**.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Explorer > Kubernetes cluster explorer > (select a cluster) > (select a pod or container) > See logs**.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Explorer > (select an entity) > Logs**.
      </td>
    </tr>
  </tbody>
</table>
