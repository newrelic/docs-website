...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure**, select a host, and then click **Logs**.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > All entities > (select an entity) > Logs**.
      </td>
    </tr>
  </tbody>
</table>
