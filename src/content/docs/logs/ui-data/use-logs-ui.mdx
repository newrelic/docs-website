...
3. **Narrow your focus:**
   ...
   * To make your log messages easier to query and understand, use our [built-in parsing rules](/docs/logs/ui-data/built-log-parsing-rulesets/), or [create your own parsing rules](/docs/logs/ui-data/parsing/) for attributes that match a particular value.
