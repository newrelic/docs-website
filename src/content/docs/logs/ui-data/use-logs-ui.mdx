...
You can create a custom role that restricts the `NRQL Drop Rules` capability and limits the creation of drop filters. If needed, you can add the restriction to basic users as well. Learn more about drop rules in [our capability definitions](/docs/accounts/accounts-billing/new-relic-one-user-management/user-capabilities#capability-definitions).
