...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > Hosts** and select **View logs** for a specific host.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        From the Kubernetes UI, click **Logs**. 
      </td>
    </tr>
