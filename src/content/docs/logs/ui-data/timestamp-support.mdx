...
<CollapserGroup>
    ...
    >
A unix <DoNotTranslate>**epoch**</DoNotTranslate> timestamp is based on the number of seconds (or milliseconds) that have elapsed since 00:00:00 UTC on 1 January 1970. Two example formats for `Fri, 03 Nov 2023 16:06:32 GMT` would be:
...
<CollapserGroup>
    ...
    >
If we receive a JSON log like this with `timestamp` in <DoNotTranslate>**epoch**</DoNotTranslate> format (with no ms precision):
...
```
    ...
    >
If we receive a JSON log like this with timestamp in <DoNotTranslate>**ISO8601**</DoNotTranslate> format like this:
...
To this log message with timestamp in <DoNotTranslate>**ISO8601**</DoNotTranslate> format:
...
To the following log message with timestamp in <DoNotTranslate>**epoch**</DoNotTranslate> format:
