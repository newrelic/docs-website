...
To manage obfuscation expressions and rules that hash or mask your log data in New Relic, see our documentation for:

* [Logs UI](/docs/logs/ui-data/obfuscation-ui) for obfuscation expressions and rules in New Relic One
* [Obfuscation API](/docs/logs/get-started/new-relics-log-management-security-privacy) for NerdGraph, our GraphQL-format API explorer 
