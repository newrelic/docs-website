...
<Callout variant="tip">
[New Relic Log Obfuscation](https://docs.newrelic.com/docs/logs/ui-data/obfuscation-ui/) is a new feature under the [Data plus option](https://docs.newrelic.com/docs/accounts/accounts-billing/new-relic-one-pricing-billing/data-ingest-billing/#data-prices) that allows you to define customized log obfuscation rules to better obfuscate your logs. Its capabilities go way beyond the ones provided by the automatic log obfuscation described in this section. Check [this documentation](https://docs.newrelic.com/docs/logs/ui-data/obfuscation-ui/) for more details.
</Callout>
...
The automatic log obfuscation feature is enabled for all New Relic accounts, by default. If you need to opt out of automatic obfuscation, get support at [support.newrelic.com](https://support.newrelic.com).
</Callout>
...
For more information, see our documentation to [manage obfuscation expressions and rules](/docs/logs/ui-data/obfuscation-ui). You can hash or mask your log data by using the New Relic UI or by using NerdGraph, our GraphQL API.
