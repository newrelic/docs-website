...
Additionally, we provide log obfuscation features. We have two options: 

* Automatic log obfuscation, which is provided out-of-the-box for your New Relic logs data.
