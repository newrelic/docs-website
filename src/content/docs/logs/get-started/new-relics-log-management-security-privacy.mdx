...
## Log obfuscation [#auto-obfuscation]

<Callout variant="tip">
In addition to the automatic log obfuscation that comes with our log management feature, we also give you an option for [customizing your log obfuscation](#customize-obfuscation).
</Callout>

Our log management service automatically masks number patterns that appear to be for items such as credit cards or Social Security numbers. All integers, including spaces and hyphens that may be used as delimiters, are replaced with a string of `X`es.
...
## Customize obfuscation [#customize-obfuscation]
...
For more information on how to set this up, see [Log obfuscation](/docs/logs/ui-data/obfuscation-ui). 
