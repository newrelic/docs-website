...
<figcaption>
 <DoNotTranslate>**one.newrelic.com > [Data management hub](https://one.newrelic.com/data-management-hub) > Data retention > (select an app) > Edit data retention**</DoNotTranslate>: Select your archive duration to store your logs for as long as you need, for up to seven years.
</figcaption>
</Step>
...
There are two ways to query live archives: with Lucene or NRQL. If you want to use logs syntax that you're familiar with outside of New Relic, we suggest querying in the <DoNotTranslate>**Logs**</DoNotTranslate> UI.
