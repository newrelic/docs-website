...
* **SOX compliance**:  The Sarbanes-Oxley Act requires that all public companies keep financial logs for a year, but most companies store that data for thirteen months.
...
Live archives is billed differently than the rest of your logs. You can read more about it in our [Live archives storage: Billing and rules documentation](/docs/logs/get-started/live-archives-billing/). Once you query live archives, you can explore your data consumption in the [data management hub](https://one.newrelic.com/data-management-hub).
