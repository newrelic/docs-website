...
You can also edit an existing partition using the
...
To learn more about Compute Capacity Units, please see our [Usage plan documentation](https://docs.newrelic.com/docs/licenses/license-information/usage-plans/new-relic-usage-plan/#list-price).


You can see your data storage in the [data management hub](https://one.newrelic.com/data-management-hub).
...
Once you query live archives, you can explore your data consumption in the [data management hub](https://one.newrelic.com/data-management-hub).
...
* You cannot recover data if you reduce data retention later. Please choose and configure your retention periods carefully.
