...
2. Enable log management with [APM logs in context](/docs/logs/get-started/get-started-log-management) or our other [log forwarding solutions](/docs/logs/forward-logs/enable-log-management-new-relic/).
3. Explore relevant logging data across your platform, including spans, traces, errors, and more.
