...
<Video type="wistia" id="3j7spmzlhc" />
...
![Log data for an app's related service](src/images/demotron-services-logs-123021c.png "Log data for an app's related service")
...
![Log data link from APM UI](src/images/demotron-logs-123021.png 'Log data link from APM UI')
