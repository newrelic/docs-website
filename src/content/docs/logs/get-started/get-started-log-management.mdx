...
Access to log management capabilities is restricted by user type. For more details, see [user type capabilities](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type/#user-type-comparison-table). 
