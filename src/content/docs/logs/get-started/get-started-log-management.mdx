...
Want to estimate the cost of reporting your logs? Use our [cost estimator tool](https://developer.newrelic.com/collect-data/monitor-your-application/estimate-cost). 
