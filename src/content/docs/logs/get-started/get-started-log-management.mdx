...
For more on log forwarding options and specific use cases, see [Forward your logs to New Relic](/docs/logs/forward-logs/enable-log-management-new-relic).
...
You can also use NerdGraph (our GraphQL-format API) to [query data](/docs/apis/nerdgraph/examples/nerdgraph-nrql-tutorial) or [configure log management](/docs/apis/nerdgraph/examples/nerdgraph-log-parsing-rules-tutorial). 
