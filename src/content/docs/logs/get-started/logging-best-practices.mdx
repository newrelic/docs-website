...
* When forwarding logs, always use our [New Relic infrastructure agent](/docs/logs/forward-logs/forward-your-logs-using-infrastructure-agent) and/or [APM agents](/docs/apm/new-relic-apm/getting-started/get-started-logs-context#agents) when possible. If you cannot use New Relic agents, use other supported agents (FluentBit, Fluentd, Logstash, etc.).
