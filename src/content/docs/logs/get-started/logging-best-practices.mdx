...
* Create partitions to optimize the number of events that must be scanned for your most common queries. If your ingest volume is high, you'll have more events in shorter time windows which cause searches over longer time periods to take longer and potentially time out.  There is no hard and fast rule, but generally as scanned log events gets over 500 million (especially over 1 billion) for your common queries you may consider adjusting your partitioning.
