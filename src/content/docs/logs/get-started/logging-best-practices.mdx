...
* When forwarding logs, we recommend using our [New Relic infrastructure agent](/docs/logs/forward-logs/forward-your-logs-using-infrastructure-agent) and/or [APM agents](/docs/apm/new-relic-apm/getting-started/get-started-logs-context#agents). If you cannot use New Relic agents, use other supported agents (like <DNT>Fluentbit</DNT>, Fluentd, and Logstash).
...
* Use external <DNT>Fluentbit</DNT> configurations for parsing multi-line logs and for other, more extensive pre-parsing before ingesting into New Relic. For details and configuration of multi-line parsing with our infrastructure agent, see [this blog post](https://newrelic.com/blog/how-to-relic/parse-multiline-log-messages-fluent-bit-plugin).
...
* Install the <DNT>**Logs analysis**</DNT> and/or <DNT>**APM logs monitoring quickstart**</DNT> dashboards to quickly gain more insight into your log data. To add these dashboards go to <DNT>**[one.newrelic.com](https://one.newrelic.com) > Add Data > Logging > Dashboards**</DNT>.
