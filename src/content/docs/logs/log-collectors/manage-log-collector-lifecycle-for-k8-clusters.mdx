...
While you are planning to monitor the health of the Fluent Bit log collector on your Kubernetes clusters, it is presumed that either you are already collecting logs from your Kubernetes clusters using Fluent Bit, or you are planning to set up Fluent Bit for log collection. Based on your current status, you can follow the instructions below to set up health monitoring of Fluent Bit on your Kubernetes clusters.

* Install Kubernetes integration with Fluent Bit and its health monitoring
* Update the Fluent Bit configuration to enable health monitoring
