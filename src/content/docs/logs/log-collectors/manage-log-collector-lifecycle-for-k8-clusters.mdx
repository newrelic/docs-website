...
tags:
  - Fluent Bit health management
  - Fluent Bit lifecycle management
  - Fluent Bit configuration
  - Fluent Bit deployment
  - Fluent Bit setup
  - Fluent Bit monitoring
  - Log collector lifecycle management
  - Log collector health management
metaDescription: '
...
After you set up your Fluent Bit agent, you will start receiving logs in New Relic, and simultaneously, you can monitor the health and performance of your log collector. This is crucial for ensuring that your log collection infrastructure is functioning optimally and that you can troubleshoot any issues that arise. For more details, refer to Monitor the health and performance of your log collector.
...
## Next step [next-step]
After you set up your Fluent Bit agent, you can monitor its health and performance. This is crucial for ensuring that your log collection infrastructure is functioning optimally and that you can troubleshoot any issues that arise. For more details, refer to Monitor the health and performance of your log collector. 
