...
<Callout variant="important">
  ...
  Keep in mind that Agent Control currently only supports **Kubernetes**. We are working on a public preview for on-host Linux systems, and support for other environments will be added in the future.
</Callout>
