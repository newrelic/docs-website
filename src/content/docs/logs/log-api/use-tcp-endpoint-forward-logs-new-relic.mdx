...
4. [Check your New Relic account](/docs/logs/log-management/ui-data/explore-your-data-log-analytics) for logs (note logs may be found by searching for the attribute plugin.type:"syslog-newrelic").
