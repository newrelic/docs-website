...
* A valid New Relic [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) for the account you want to send logs to
...
5. Add the following to `newrelic.conf`. Replace the highlighted values. For YOUR_LICENSE_KEY, use your New Relic [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key):
...
2. Add the following to `newrelic.conf`. Replace all highlighted values. For YOUR_LICENSE_KEY, use your New Relic [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key):
...
4. Optional: Configure `syslog-ng` to tail files by adding the following to the `Sources` configuration block:
   ...
   ```
5. Define the New Relic `syslog` format. For YOUR_LICENSE_KEY, use your New Relic [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key).
