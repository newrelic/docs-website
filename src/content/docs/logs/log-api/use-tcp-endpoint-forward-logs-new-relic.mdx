...
<Callout variant="tip">
  If you're running syslog-ng from a <DNT>Docker/DNT> container and experience issues, check [balait/syslog image documentation](https://hub.docker.com/r/balabit/syslog-ng/).
</Callout>
