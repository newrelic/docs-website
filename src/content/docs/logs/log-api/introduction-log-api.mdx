...
1. Get your [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key).
...
Your [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) serves to authenticate your request to the Log API, and determines the New Relic account where your submitted log message(s) will be written. It needs to be passed as either an HTTP header or a query string parameter.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        A New Relic [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key). You can also [send this via query parameter](#query-parameters).
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Your [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key). You can also [send this via HTTP header](#auth-header).
      </td>
    </tr>
  </tbody>
</table>
