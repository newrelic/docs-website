...
<CollapserGroup>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            This is the <DoNotTranslate>**main**</DoNotTranslate> log message field that is searched by default
          </td>
        </tr>
  ...
  >
    When using the detailed format to create your body, it must be a <DoNotTranslate>**JSON array**</DoNotTranslate> containing one or more JSON objects, each of which with the following format:
...
We accept any valid JSON payload. The payload must encoded as <DoNotTranslate>**UTF-8**</DoNotTranslate>.
