    ...
    <tr>
      ...
      <td>
        ...
        * [newrelic_get_linking_metadata](/docs/apm/agents/php-agent/php-agent-api/newrelicgetlinkingmetadata/)
          ...
          For PHP, logs in context is only supported from the distributed tracing UI, not in the <DoNotTranslate>**Logs**</DoNotTranslate> tab of the <InlinePopover type="apm" /> UI.
      </td>
    </tr>
