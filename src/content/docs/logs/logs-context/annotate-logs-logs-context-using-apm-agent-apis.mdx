...
To correlate log data with other telemetry data, such as errors and distributed traces in APM, you can use [APM logs in context](/docs/apm/new-relic-apm/getting-started/get-started-logs-context). If your logging framework is not supported by our existing logs in context solutions, you can configure your logging libraries with our <InlinePopup type="apm" /> agent APIs.
    ...
    <tr>
      ...
      <td>
        ...
        * [newrelic_get_linking_metadata](/docs/apm/agents/php-agent/php-agent-api/newrelicgetlinkingmetadata/)
          ...
          For PHP, logs in context is only supported from the distributed tracing UI, not in the **Logs** tab of the <InlinePopup type="apm" /> UI.
      </td>
    </tr>
