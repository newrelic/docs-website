...
<table>
  <thead>
    ...
    <tr>
      <td>
        [C SDK (n/a)](/docs/logs/enable-log-management-new-relic/configure-logs-context/c-sdk-configure-logs-context) 
      </td>
      <td>
        See our [Log API documentation](/docs/logs/log-management/log-api/introduction-log-api/).
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td>
        * [TraceMetadata](https://docs.newrelic.com/docs/agents/net-agent/net-agent-api/tracemetadata-net-agent-api-0)
        * [GetLinkingMetadata](https://docs.newrelic.com/docs/agents/net-agent/net-agent-api/getlinkingmetadata-net-agent-api)
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        * [newrelic.getTraceMetadata](https://docs.newrelic.com/docs/agents/nodejs-agent/api-guides/nodejs-agent-api/#getTraceMetadata)
        * [newrelic.getLinkingMetadata](https://docs.newrelic.com/docs/agents/nodejs-agent/api-guides/nodejs-agent-api/#getLinkingMetadata)
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        * [newrelic_get_trace_metadata](https://docs.newrelic.com/docs/agents/php-agent/php-agent-api/newrelicgettracemetadata)
        * [newrelic_get_linking_metadata](https://docs.newrelic.com/docs/agents/php-agent/php-agent-api/newrelicgetlinkingmetadata)
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        * [get_linking_metadata](https://docs.newrelic.com/docs/agents/python-agent/python-agent-api/getlinkingmetadata-python-agent-api)
      </td>
    </tr>
    <tr>
      <td>
...
* Python: [Streamhandler example](https://docs.newrelic.com/docs/logs/enable-log-management-new-relic/configure-logs-context/configure-logs-context-python/#python-formatter)
