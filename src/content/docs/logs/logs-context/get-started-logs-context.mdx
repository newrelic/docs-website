...
<CollapserGroup>
  ...
  >
    To create an alert when your usage exceeds a fixed monthly threshold for gigabytes of data, add this [NRQL query](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/nrql-alert-conditions/) to your alert condition:
