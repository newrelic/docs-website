...
![APM logs in context](./images/ruby-errors-log-details.png "APM logs in context")

<figcaption>
  **APM logs in context:** From the left nav in the APM UI, you can select an error and immediately see related logs, log details, host name, important attributes, and more.
</figcaption>
...
<CollapserGroup>
  ...
  **INSERT .NET-specific configuration**

  **This PR https://github.com/newrelic/docs-website/pull/6767 has some config info.**
  ...
  **INSERT .NET-specific configuration**
  ...
  1. If you are currently sending logs using the old logs-in-context method, be sure to remove that code from your [specific log forwarder](/docs/logs/forward-logs/enable-log-management-new-relic#log-forwarding) before enabling local decoration. Otherwise, your app may send double log lines. Depending on your account, this could result in double billing.
  ...
  **INSERT .NET-specific configuration**
  ...
  Also, this method requires that you install a log forwarder before enabling logs in context. If you do not have a log forwarder, the New Relic One UI will prompt you to use our [infrastructure agent](/docs/logs/forward-logs/forward-your-logs-using-infrastructure-agent/).
