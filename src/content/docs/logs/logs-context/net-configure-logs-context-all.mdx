...
You have three options to configure APM logs in context to send your app's logs and linking metadata automatically to New Relic. Supported frameworks for automatic logs in context include:

- log4net 2.0.8 or higher 
- NLog 4.5 or higher 
- Serilog 2.5 or higher
