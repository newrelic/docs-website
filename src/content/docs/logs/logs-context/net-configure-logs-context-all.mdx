...
<CollapserGroup>
 ...
 ```xml
  ...
  Context data appears in New Relic prefixed with "context.".  For example, a custom log attribute named "myKey" with value "myValue" will appear in New Relic as "context.myKey : myValue".
