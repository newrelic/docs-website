...
<CollapserGroup>
  ...
  >
    ...
    * `concurrentWrites`
      ...
      <DNT>**Don't collect MDC or the MDLC data (default):**</DNT>
      ...
      <DNT>**Collect MDC or the MDLC data:**</DNT>
  ...
  >
    ...
    <DNT>**Instantiating Logger using `.config` file**</DNT>
    ...
    <DNT>**Sample `App.config` file**</DNT>
...
<CollapserGroup>
  ...
  >
    ...
    * [Serilog.Settings.Configuration](https://www.nuget.org/packages/Serilog.Settings.Configuration)
    ...
    <DNT>**Instantiating logger using `appsettings.json`**</DNT>
    ...
    <DNT>**Sample `appsettings.json` file**</DNT>
    ...
    <DNT>**Sample `web.config` file**</DNT>
