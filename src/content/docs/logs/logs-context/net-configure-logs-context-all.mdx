...
<CollapserGroup>
  ...
  All you need to do is install an agent version with log forwarding capabilities ([.NET agent 9.7.0 or higher](/docs/release-notes/agent-release-notes/net-release-notes)). If forwarding is disabled, you can use this to update your agent configuration to enable it:
