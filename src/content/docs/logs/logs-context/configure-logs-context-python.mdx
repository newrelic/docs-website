...
With our Python <InlinePopover type="apm" /> agent, you can get <DoNotTranslate>**logs in context**</DoNotTranslate>, which lets you see your app logs in the context of your other New Relic data. For general information on this feature, see [APM logs in context](/docs/apm/new-relic-apm/getting-started/get-started-logs-context).
