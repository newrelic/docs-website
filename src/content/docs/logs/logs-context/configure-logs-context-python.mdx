...
With our Python <InlinePopup type="apm" /> agent, you can get **logs in context**, which lets you see your app logs in the context of your other New Relic data. For general information on this feature, see [APM logs in context](/docs/apm/new-relic-apm/getting-started/get-started-logs-context).
...
<CollapserGroup>
  ...
  >
    You can also use our manual installation option to enable logs in context for <InlinePopup type="apm" /> apps monitored by Python.
