...
If you do not see log data in the UI, follow the [troubleshooting procedures](/docs/logs/log-management/troubleshooting/no-log-data-appears-ui/). Also, if you see JSON logs in your application's output, but your query does not return logs, check your [log forwarder](/docs/logs/new-relic-logs/enable-logs/enable-new-relic-logs).
