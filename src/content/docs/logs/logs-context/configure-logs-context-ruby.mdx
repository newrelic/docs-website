...
<CollapserGroup>
  ...
  >
    ...
    This option should also not be used with [the old log decorating formatter](#3-old-formatter). If you have references to the old formatter in your codebase, please remove them before enabling this option.
