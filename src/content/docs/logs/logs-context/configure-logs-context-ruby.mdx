...
<CollapserGroup>
  ...
  **Optional adjustments:**
  ...
  1. If you have an existing log forwarding solution, **be sure to disable it**. Otherwise, your app will be sending double log lines. Depending on your account, this could result in double billing. For more information, follow the procedures to disable your [specific log forwarder](/docs/logs/forward-logs/enable-log-management-new-relic#log-forwarding).
