...
Enabling New Relic's **logs in context** correlates your log data with data collected from our APM and infrastructure agents. This means that you'll see logs data or links to log data in other UI experiences, such as APM, infrastructure monitoring, distributed tracing, errors inbox, and more. You can use that log data to dig deeper into the performance of your app or host, without needing to manually search through log data. 
