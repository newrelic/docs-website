...
## Automatic logs in context options [#1-agent]
If you are using a supported framework, you can configure APM logs in context to send your app's logs and linking metadata automatically to New Relic. Supported frameworks for automatic logs in context include:
...
This functionality is currently (agent version 10.1.0) disabled by default.
