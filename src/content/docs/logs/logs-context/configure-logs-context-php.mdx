...
If you need to use the manual process to set up logs in context for PHP, follow these steps.


### Set up your PHP app [#configure-php]

To enable logs in context for APM apps monitored by PHP, you can use our manual installation option.
