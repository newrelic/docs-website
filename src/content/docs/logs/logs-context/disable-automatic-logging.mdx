...
After you disable via the New Relic UI, it may take several minutes for the agent to restart and stop automatic log forwarding.
  ...
  >
    Use the `dataManagementUpdateFeatureSettings` in NerdGraph API explorer: **[one.newrelic.com](https://one.newrelic.com) > Apps > NerdGraph API explorer**. Refer to the populated example and related documentation in the GraphiQL UI.
