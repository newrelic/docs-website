...
By default, New Relic APM agents automatically forward log data. You can manage this feature at the account level:
...
## Agents which automatically forward logs [#versions]
