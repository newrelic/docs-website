...
<CollapserGroup>
  ...
  >
    In the <DNT>**Data management**</DNT> UI, the <DNT>**Log settings**</DNT> UI page is where you can enable or disable [APM logs](/docs/apm/new-relic-apm/getting-started/get-started-logs-context) (both log decoration and log forwarding) for an account.
    ...
    <img
      ...
      src="/images/logs_screenshot-crop_disable-logs.webp"
    />

    1. From the [user menu](/docs/accounts/accounts-billing/general-account-settings/intro-account-settings) in the New Relic UI, click <DNT>**Manage your data > Log settings**</DNT>.
    2. Click the ellipsis <DNT>**...**</DNT> menu at the right side of the account's row.
  ...
  >
    Use the `dataManagementUpdateFeatureSettings` in NerdGraph API explorer: <DNT>**[one.newrelic.com](https://one.newrelic.com) > All capabilities > Apps > NerdGraph API explorer**</DNT>. Refer to the populated example and related documentation in the GraphiQL UI.
  ...
  >
    ...
    <Callout variant="important">
      Note that disabling log forwarding doesn't affect logging metrics, which are displayed on the <DNT>**Logs**</DNT> chart on the APM <DNT>**Summary**</DNT> page. For more detail, see [Log metrics](/docs/logs/logs-context/get-started-logs-context#apm-logs-defined).
    </Callout>
