...
By default, the above New Relic agents automatically forward log data from APM agents in the context of APM logs.
However, you can disable this feature at the account level if this your organization's Policy or other conditions such as
...
* The design of system resources does not allow for the increased overhead of the logs transfer function.
