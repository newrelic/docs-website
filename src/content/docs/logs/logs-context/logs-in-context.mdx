...
![New Relic logs in context diagram](src/images/new-relic-logs-in-context-diagram.png 'new-relic-logs-in-context-diagram.png')
...
![Logs in context in APM UI](src/images/demotron-logs-123021.png 'Logs in context in APM UI')
...
![Logs in context of trace details in APM UI](src/images/logs-in-context-traces.png 'Logs in context for trace details in APM UI')
