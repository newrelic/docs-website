...
Our <InlinePopup type="apm" /> agents have logs in context, including log forwarding, enabled by default. For more about getting and using <InlinePopup type="apm" /> logs in context, see [APM logs](/docs/apm/new-relic-apm/getting-started/get-started-logs-context). 
...
As a more powerful alternative to using an <InlinePopup type="apm" /> agent for log reporting, or as a supplement to APM logs, you can [forward logs with our infrastructure agent](/docs/logs/forward-logs/forward-your-logs-using-infrastructure-agent). 
