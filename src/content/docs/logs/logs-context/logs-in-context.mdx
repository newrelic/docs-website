...
* [Go logs in context procedures](/docs/logs/logs-context/configure-logs-context-go) for agent [v3.18.0 or higher](/docs/release-notes/agent-release-notes/go-release-notes)
