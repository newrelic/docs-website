...
When you use our <InlinePopover type="apm" /> agents, infrastructure agent, or OpenTelemetry integration to report log data, you get <DoNotTranslate>**logs in context**</DoNotTranslate>, a feature that lets you see your log data in the context of other platform UI experiences. For example, you'll see logs data in UI experiences like APM, infrastructure monitoring, distributed tracing, and errors inbox, to name a few. With that contextual knowledge, you can then dig deeper into the performance of your app or host, without needing to manually search through log data.
...
<figcaption>
  With our automatic APM logs in context, you can drill down into your logs, traces, and errors, all from the APM <DoNotTranslate>**Summary**</DoNotTranslate> page.
</figcaption>
