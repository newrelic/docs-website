...
## APM agent support [#agent-support]

For details on the agent versions that support logs-in-context and log forwarding, and links to docs to help you configure that, see [APM logs in context](/docs/apm/new-relic-apm/getting-started/get-started-logs-context#agents).
