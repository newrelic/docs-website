...
<img
  title="Logs in context in APM UI"
  alt="Logs in context in APM UI"
...
<img
  title="Logs in context for trace details in APM UI"
  alt="Logs in context of trace details in APM UI"
