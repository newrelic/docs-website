...
Automatic application log forwarding is now enabled by default in Go agent v3.20.0+ . If your applications use these Go agent versions, you don't need to change your config options to enable automatic log forwarding.
