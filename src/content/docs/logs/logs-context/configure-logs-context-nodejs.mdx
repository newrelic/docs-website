...
If you are not using a supported framework, you may instead use the agent's log forwarding API method to perform your own instrumentation. See [its documentation](https://newrelic.github.io/node-newrelic/docs/API.html#recordLogEvent) for further details.
