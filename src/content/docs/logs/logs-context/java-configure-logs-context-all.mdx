...
<CollapserGroup>
  ...
  >
    ...
    All you need to do is install an agent version with log forwarding capabilities ([Java agent 7.6.0 or higher](/docs/release-notes/agent-release-notes/java-release-notes/)). If forwarding is disabled, you can use the following configuration.
