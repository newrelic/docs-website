...
<CollapserGroup>
  ...
  Using this option, your logs will include `span.id`, `trace.id`, `hostname`, `entity.guid`, and `entity.name`. These attributes will automatically link your logs with spans, traces, and errors for your app, its associated hosts, and other entities.
