...
We curate the data automatically, so that highly correlated log data related to your errors, traces, infrastructure, etc. is already visible. But if you're missing related key telemetry, you can add more attributes to make your troubleshooting focus even more precise. For example, you may want to add more attributes to get contextual data specific to your ecosystem.
