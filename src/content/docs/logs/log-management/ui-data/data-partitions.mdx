...
If you want to manage your data partitions programatically you can use [NerdGraph](https://api.newrelic.com/graphiql), our graphQL API to do so. Follow [this tutorial](/docs/apis/nerdgraph/examples/nerdgraph-data-partition-rules-tutorial/) to query, create and delete data partitions our API. 
