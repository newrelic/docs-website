...
tags:
  ...
  - Log management
  - UI and data
metaDescription: To organize and group log data for more efficient querying, use data partitions in New Relic Logs.
---
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Logs**: From the left nav in the Logs UI, select **Data partitions**, then create a Log_ partition name with the retention namespace, optional description, and matching criteria.
</figcaption>
...
If you want to manage your data partitions programatically, you can use [NerdGraph](https://api.newrelic.com/graphiql), our graphQL API, to do so. [This tutorial](/docs/apis/nerdgraph/examples/nerdgraph-data-partition-rules-tutorial/) shows how to query, create, and delete data partitions using our API. 
