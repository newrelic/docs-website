...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        There is no separate pricing for Log Patterns. The only cost is for additional data generated and added to the log records. A pattern attribute will be added to all logs that match a pattern. Attributes may also be added when common values such as GUIDs, IP addresses, URL or email addresses are discovered and automatically extracted from the log message as part of the pattern process. 
      </td>
    </tr>
