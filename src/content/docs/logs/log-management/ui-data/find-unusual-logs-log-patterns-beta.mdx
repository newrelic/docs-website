...
tags:
  ...
  - UI and data
metaDescription: >-
  Use New Relic's log patterns to monitor the frequency of known patterns over
...
2. At the top right corner of the Log management UI, click **Log Patterns**. <ImageSizing width="110px" height="34px">![Log patterns UI icon (beta)](./images/log-patterns-beta-ui-icon.png "Log patterns UI icon (beta)")</ImageSizing>
