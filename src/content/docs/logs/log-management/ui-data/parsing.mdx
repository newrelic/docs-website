...
The following `logtype` attribute values map to a standard parsing rulesets.

* When you query from the New Relic UI, use the format `logtype:<var>alb</var>`.
* When you query from [NerdGraph](/docs/apis/nerdgraph/examples/nerdgraph-log-parsing-rules-tutorial/), use the format `logtype = '<var>alb</var>'`.
