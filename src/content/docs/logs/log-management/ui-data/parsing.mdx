...
<iframe width="560" height="315" src="https://www.youtube.com/watch?v=PD7zGXqS0P0&list=PLmhYj7Jl81JEV-llIDkCVC05tD7fbOv_b" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
**REVIEWER: This page uses the format `logtype:alb` for example, but the Built-in parsing rules doc uses the format `logtype = 'alb'`. Are they both correct? Does it matter which one to use?**
