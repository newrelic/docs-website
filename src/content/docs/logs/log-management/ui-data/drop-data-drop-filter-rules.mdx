...
![New Relic Logs - Architecture - Drop filter](./images/ingest-pipeline.svg "New Relic Logs - Architecture - Drop filter")

<figcaption>
  During the ingestion process, customer log data can be parsed, transformed, or dropped before stored in New Relic's database.
</figcaption>
