...
![NR One log summary options](./images/log-summary-click.png "NR One log summary options")

Use our [Logs UI](/docs/explore-your-data-new-relic-logs-ui) in New Relic One to quickly search through your log data in seconds. Each log lists available attributes in the `log_summary` column. To drill down into additional details, click any highlighted attribute.
