...
* The query syntax is case sensitive for attributes values, except for wildcard searches, which are case insensitive for attribute values. Attribute names are always case sensitive.
