...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Logs**: Use the left nav in the Logs UI as an easy workflow through all logs, patterns, live-tail logging, and queries. Get more details about specific logs from the center nav. You can also select tools in the left nav to manage and view more specific data.
</figcaption>
...
4. **Examine log details:**
   ...
   * To help troubleshoot problems related to a specific value in the log details, click the **Show surrounding logs** icon for the attribute's details.
