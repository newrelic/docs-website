...
![Logs UI in New Relic One](./images/logs-ui022421.png "Logs UI in New Relic One")

<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Logs**: This example shows the attributes included in the selected log. Notice that the attributes dropdown on the left side of the Logs UI indicates a significant number of errors have come from a specific service.
</figcaption>

To explore your logging data, follow this basic workflow.

1. Go to **[one.newrelic.com](https://one.newrelic.com)**, click **Browse data** and select **Logs**.
2. **Search:**
...
3. **Look for patterns:**
   ...
   To spot suspicious spikes or drops in log messages, click the [log patterns](/docs/logs/log-management/ui-data/find-unusual-logs-log-patterns-beta) icon, or skim the **Volume** chart. Then, to zoom in to a specific area, click and drag. Or, to jump directly to logs for a specific point in time, click that point on the chart.
4. **Narrow your focus:**

   ![New Relic One: Logs details](./images/logs-details022521.png "New Relic One: Logs details")

   <figcaption>
     **[one.newrelic.com](https://one.newrelic.com) > Logs details:** This example shows the attributes included in the selected log. You can include or exclude them in your query, and view surrounding logs.
   </figcaption>
   ...
   * To make your log messages easier to query and understand, create parsing rules for attributes that match a particular value.
...
5. **Examine log details:** <ImageSizing width="288px" height="192px">![NR One log summary options](./images/log-summary-click.png "NR One log summary options")</ImageSizing>

   To see which attributes are included in a log message, select the log line. Add or remove columns as needed to help you focus on the details you need. To control which attributes appear in the results, click any highlighted value in the log's `log_summary` column.
6. **Get related logs:**
   ...
   * To help identify an issue's root cause before it occurred or its impact after an event, click the [**Show surrounding logs** <Icon name="fe-eye"/>
     icon](/docs/logs/log-management/troubleshooting/find-issues-cause-or-impact-surrounding-logs).
7. **Share your findings:** <ImageSizing width="140px" height="108px">![NR One Logs: Add to dashboard](./images/crop-log-add-dashboard.png "NR One Logs: Add to dashboard")</ImageSizing>
