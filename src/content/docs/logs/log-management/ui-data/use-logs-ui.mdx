...
2. **Look for patterns:**
   ...
   * To spot suspicious spikes or drops in log messages, click the [patterns](/docs/logs/log-management/ui-data/find-unusual-logs-log-patterns/) icon on the left nav.
