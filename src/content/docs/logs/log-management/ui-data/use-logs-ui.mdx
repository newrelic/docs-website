...
To stay up to date with new capabilities and improvements, subscribe to our our [RSS feed for Logs release notes](/docs/release-notes/logs-release-notes).
...
5. **Search:**
   ...
   For more information, see the [Logs query syntax documentation](https://docs.newrelic.com/docs/logs/log-management/ui-data/query-syntax-logs/).

<Callout variant="tip">
  To organize data within an account and to optimize query performance, create [data partition rules](https://docs.newrelic.com/docs/logs/log-management/ui-data/data-partitions/).
</Callout>
