...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Use either your [insert API key](/docs/insights/insights-data-sources/custom-data/send-custom-events-event-api#register) (with `Api-Key`) or [license key](/docs/accounts/install-new-relic/account-setup/license-key) (with `X-License-Key`), or send it as [query parameters](#query-parameters).
      </td>
    </tr>
