...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Try querying the `Log` data type. For example, you can use the [NRQL query builder](https://docs.newrelic.com/docs/query-your-data/explore-query-data/query-builder/introduction-query-builder/) to look at everything in the `Log` eventType. If no data appears in the query builder, then no data will appear in the Logs UI.
