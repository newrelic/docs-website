...
Our log management capabilities help you to collect, process, explore, visualize, and alert on your log data. To get your logs into New Relic, you can:
...
## Log forwarding plugins [#log-forwarding]
...
* [AWS CloudWatch plugin](/docs/logs/enable-log-management-new-relic/enable-log-monitoring-new-relic/aws-lambda-sending-cloudwatch-logs/)
* [AWS FireLens plugin](/docs/logs/enable-log-management-new-relic/enable-log-monitoring-new-relic/aws-firelens-plugin-log-forwarding/)
* [AWS Kinesis Firehose](/docs/logs/enable-log-management-new-relic/enable-log-monitoring-new-relic/stream-logs-using-kinesis-data-firehose/)
...
* [Fluent Bit plugin](/docs/logs/enable-log-management-new-relic/enable-log-monitoring-new-relic/fluent-bit-plugin-log-forwarding/t)
* [Fluentd plugin](/docs/logs/enable-log-management-new-relic/enable-log-monitoring-new-relic/fluentd-plugin-log-forwarding/)
* [Heroku log streaming](/docs/logs/enable-log-management-new-relic/enable-log-monitoring-new-relic/heroku-log-forwarding/)
* [Kubernetes plugin](/docs/logs/enable-log-management-new-relic/enable-log-monitoring-new-relic/kubernetes-plugin-log-forwarding/)
* [Logstash plugin](/docs/logs/enable-log-management-new-relic/enable-log-monitoring-new-relic/logstash-plugin-log-forwarding/)
* [Microsoft Azure ARM template](/docs/logs/enable-log-management-new-relic/enable-log-monitoring-new-relic/azure-log-forwarding/)
* [Vector plugin](/docs/logs/enable-log-management-new-relic/enable-log-monitoring-new-relic/vector-output-sink-log-forwarding/)
