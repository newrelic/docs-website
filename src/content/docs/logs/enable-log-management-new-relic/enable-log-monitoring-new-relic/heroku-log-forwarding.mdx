...
<Callout variant="important">
Heroku does not currently support customizing the format of logs sent from Logplex. For more information, please consult Heroku's documentation on their [log format](https://devcenter.heroku.com/articles/logging#log-format).
</Callout>
