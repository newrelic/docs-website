...
1. Your New Relic user account has the [Admin role](/docs/accounts/original-accounts-billing/original-users-roles/users-roles-original-user-model/#roles) assigned to it.
2. The account you wish to send logs to has at least one [Insights Insert API Key](/docs/apis/get-started/intro-apis/new-relic-api-keys/#insights-insert-key) associated with it.
...
5. Select an [Insights insert API key](/docs/apis/get-started/intro-apis/new-relic-api-keys/#insights-insert-key) from the drop-down.
