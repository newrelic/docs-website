...
To use New Relic Logs with Fluent Bit, you'll need:
...
Fluent Bit needs to know the location of the New Relic plugin and the [New Relic license key](/docs/apis/intro-apis/new-relic-api-keys/#ingest-license-key) to send data to New Relic. To configure your Fluent Bit plugin:
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        The [New Relic license key](/docs/apis/intro-apis/new-relic-api-keys/#ingest-license-key). Use either `licenseKey` (**recommended**) or `apiKey`, not both.
    ...
    <tr>
      ...
      <td>
        This allows use of New Relic's [Insights insert key](/docs/insights/insights-data-sources/custom-data/send-custom-events-event-api#register). Use either `licenseKey` (**recommended**) or `apiKey`, not both. The use of the license key is highly recommended. 
      </td>
    </tr>
  </tbody>
</table>
