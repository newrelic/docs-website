...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        This lets you use our [Insights insert key](/docs/insights/insights-data-sources/custom-data/send-custom-events-event-api#register). Use either `licenseKey` (**recommended**) or `apiKey`, not both. The use of the license key is highly recommended. 
      </td>
    </tr>
  </tbody>
</table>
