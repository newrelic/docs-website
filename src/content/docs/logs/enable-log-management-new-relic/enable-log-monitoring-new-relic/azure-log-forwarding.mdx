...
The setup process is almost the same except for both use cases but take a look to step 9 if you want to forward [Azure Activity Logs](https://docs.microsoft.com/en-us/azure/azure-monitor/essentials/activity-log) to New Relic.
