...
* Ruby agent 6.7.0 or higher: [Install](/docs/agents/ruby-agent/installation/install-new-relic-ruby-agent) or [update](/docs/agents/ruby-agent/installation/install-new-relic-ruby-agent#Updating_the_Agent)
