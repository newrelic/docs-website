...
* [Log4j 2.x](https://logging.apache.org/log4j/2.x/index.html) or [Logs4j 2 binding](https://logging.apache.org/log4j/2.0/log4j-slf4j-impl/index.html) package installed and working on the application.
