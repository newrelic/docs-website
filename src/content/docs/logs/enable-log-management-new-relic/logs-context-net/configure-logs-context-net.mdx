...
* [New Relic .NET agent 8.21+](/docs/release-notes/agent-release-notes/net-release-notes)
* [New Relic .NET agent API 8.21+](/docs/agents/net-agent/net-agent-api)
...
* [NLog](/docs/logs/enable-new-relic-logs/logs-context-net/net-configure-nlog)
* [Serilog](/docs/logs/new-relic-logs/enable-logs-context/enable-logs-context-net-serilog)
