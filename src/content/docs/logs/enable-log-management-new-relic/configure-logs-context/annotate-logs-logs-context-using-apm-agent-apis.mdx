...
<table>
  <thead>
    ...
    <tr>
      ...
      <td>
        * [newrelic.getTraceMetadata](/docs/agents/nodejs-agent/api-guides/nodejs-agent-api/#getTraceMetadata)
        * [newrelic.getLinkingMetadata](/docs/agents/nodejs-agent/api-guides/nodejs-agent-api/#getLinkingMetadata)
      </td>
    </tr>
    <tr>
      <td>
...
* Python: [Streamhandler example](/docs/logs/enable-log-management-new-relic/configure-logs-context/configure-logs-context-python/#python-formatter)
