...
To uninstall log forwarding capabilities, follow standard procedures in [Fluentd documentation](https://www.fluentd.org). You do not need to do anything else in New Relic.
