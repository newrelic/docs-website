...
By default the Fluentd plugin forwards logs to our US endpoint: `https://log-api.newrelic.com/log/v1`. If your New Relic organization is in our [EU or Japan data center](/docs/accounts/accounts-billing/account-setup/choose-your-data-center), you must manually set the `base_uri` property to the appropriate endpoint:
