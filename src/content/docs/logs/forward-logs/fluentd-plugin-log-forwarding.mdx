...
Japanese log files encoded in Shift-JIS (SP932) are converted to the [required UTF-8 encoding](/docs/data-apis/custom-data/custom-events/data-requirements-limits-custom-event-data/#general) and are required for importing and sending log data to New Relic.
