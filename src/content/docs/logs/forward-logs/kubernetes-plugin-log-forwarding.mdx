...
New Relic simplifies log forwarding from your Kubernetes clusters with a dedicated plugin designed for seamless integration. This plugin, available as a DaemonSet within a standalone Docker image, empowers you to:

* Utilize Fluent Bit expertise: Leverage the efficiency of the Fluent Bit plugin for streamlined log forwarding to New Relic logs.
* Deploy Seamlessly in Kubernetes: Integrate effortlessly into your Kubernetes environments through a convenient DaemonSet configuration.
* Unlock Powerful Log Management: Harness the capabilities of New Relic logs for comprehensive log analysis, exploration, querying, and alerting.
