...
To uninstall log forwarding capabilities, follow standard procedures in [Kubernetes documentation](https://github.com/newrelic/helm-charts/tree/master/charts/newrelic-logging#installation). You do not need to do anything else in New Relic.
