...
New Relic offers an output [plugin](https://github.com/newrelic/newrelic-fluent-bit-output) for [Fluent Bit](/docs/logs/forward-logs/fluent-bit-plugin-log-forwarding/)to easily forward your logs to [New Relic Logs](/docs/logs/new-relic-logs/get-started/introduction-new-relic-logs). This plugin is also provided in a standalone Docker image that can be installed in a [Kubernetes](https://kubernetes.io/) cluster in the form of a [DaemonSet](https://kubernetes.io/docs/concepts/workloads/controllers/daemonset/). We refer to this as our **Kubernetes plugin** for log forwarding.
