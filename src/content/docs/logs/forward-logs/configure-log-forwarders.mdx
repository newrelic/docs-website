...
To get starting with New Relic log management, you'll first need to configure a log forwarder. A log forwarder collects logs from your infrastructure, container, application, or cloud environment and sends them to New Relic, where you can explore, query, and create alerts for your logs.
...
## Step 1: Choose a log forwarder

Depending on your environment, you have many options to choose, install, and configure a log forwarder to send logs to New Relic. Take a look at these options:
...
<table>
  <thead>
    ...
    <tr>
      <td>
        Forward logs that are written to a local file on disk
      </td>
      <td>
    ...
    <tr>
      <td>
        Forward logs from your cloud platform
      </td>
      <td>
    ...
    <tr>
      <td>
        Forward logs from apps running in Docker containers (standalone or using Kubernetes)
      </td>
      <td>
    ...
    <tr>
      <td>
        Forward logs directly from your apps, regardless of where they are hosted
      </td>
      <td>
    ...
    <tr>
      <td>
        Forward logs via APIs or other third-party services
      </td>
      <td>
...
## Install your log forwarder 

3. Choose, install, and configure one of these log forwarders:
  1. What kind of app environment do you have?
