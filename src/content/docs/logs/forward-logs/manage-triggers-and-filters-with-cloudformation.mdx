...
---
When you deploy a CloudFormation stack, the stack creates triggers on an S3 bucket and filters on a CloudWatch log group. Deleting the stack will remove these triggers and filters.
