...
Enable logging from your Amazon CloudFront distribution to send web access logs to New Relic. 

## Log types [#log-types]

There are two options for sending logs from CloudWatch: standard logging or real-time logs.  
...
Now you can enable either standard or real-time logging. For instructions on both of those, keep reading. 
