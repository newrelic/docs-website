...
3. Click <DNT>**Project settings**</DNT>.

4. In the sidebar of your Project Settings, click <DNT>**Webhooks**</DNT>.

5. Click <DNT>**Add webhook**</DNT>.

6. Name your webhook.

7. Enter New Relic's <DNT>**Logs endpoint**</DNT>:
...
8. Select either <DNT>**Workflow**</DNT> or <DNT>**Job**</DNT>, depending on the type of event you want to trigger the logpush.

9. If you've set up your receiving API or third-party service, click <DNT>**Test ping event**</DNT> to create a test event.

<InstallFeedback/>

## What's next [#next]

* Go to the [CircleCI quickstart](https://newrelic.com/instant-observability/circleci/39109d3d-b1d8-4366-8ca9-b8925005f727) in New Relic Instant Observability, and click <DNT>**+ Install now**</DNT>.
