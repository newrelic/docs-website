...
7. Enter New Relic's **Logs endpoint**:
    ...
    * EU: 
    ...
    Use the region you set on your New Relic account. Replace <var>YOUR_LICENSE_KEY</var> with your New Relic license key, which you can [retrieve from the UI or API](/docs/apis/intro-apis/new-relic-api-keys/#manage-license-key).
