...
3. Click <DoNotTranslate>**Project settings**</DoNotTranslate>.
4. In the sidebar of your Project Settings, click <DoNotTranslate>**Webhooks**</DoNotTranslate>.
5. Click <DoNotTranslate>**Add webhook**</DoNotTranslate>.
6. Name your webhook.
7. Enter New Relic's <DoNotTranslate>**Logs endpoint**</DoNotTranslate>:
    * US: 
...
8. Select either <DoNotTranslate>**Workflow**</DoNotTranslate> or <DoNotTranslate>**Job**</DoNotTranslate>, depending on the type of event you want to trigger the logpush.
9. If you've set up your receiving API or third-party service, click <DoNotTranslate>**Test ping event**</DoNotTranslate> to create a test event.

<InstallFeedback />

## What's next [#next]

* Go to the [CircleCI quickstart](https://newrelic.com/instant-observability/circleci/39109d3d-b1d8-4366-8ca9-b8925005f727) in New Relic Instant Observability, and click <DoNotTranslate>**+ Install now**</DoNotTranslate>.
