...
To uninstall log forwarding capabilities, follow standard procedures in [Kinesis Data Firehose documentation](https://docs.aws.amazon.com/firehose/latest/dev/basic-create.html). You do not need to do anything else in New Relic.
