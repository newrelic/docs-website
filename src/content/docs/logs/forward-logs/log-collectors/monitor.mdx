---
title: Monitor the performance of your log collector
metaDescription: 'Learn how to monitor the performancxe of a log collector in New Relic.'
...
Effective performance monitoring of the Fluent Bit agent is crucial for ensuring seamless log management and optimization within your Kubernetes environments. By tracking key metrics, you can quickly identify potential issues and facilitate efficient troubleshooting.

## Access Fluent Bit details
You can monitor the performance of your Fluent Bit agent on the agent details page in your New Relic account. Here’s how to access it:
