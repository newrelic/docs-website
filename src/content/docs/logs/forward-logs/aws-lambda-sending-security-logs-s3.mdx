...
3. Search for `newrelic` and check <DoNotTranslate>**Show apps that create custom IAM roles or resource policies**</DoNotTranslate> to find `newrelic-securitylake-s3-processor-LogForwarder`.
4. Click the `newrelic-securitylake-s3-processor-LogForwarder` details and click <DoNotTranslate>**Deploy**</DoNotTranslate>.
