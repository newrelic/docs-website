...
We offer many options to collect and send host logs, which are listed in the table below. Basically, you can use one of our log fowarding options (i.e., our infrastructure agent, Kubernetes plugin, or log API) or a third-party log forwarder (i.e., AWS, Azure, GCP).
