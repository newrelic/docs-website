...
<table>
  <thead>
    ...
    <tr>
      ...
      <td>
        * (Recommended) [Our infratructure agent](/docs/logs/forward-logs/forward-your-logs-using-infrastructure-agent/)
    ...
    <tr>
      ...
      <td>
        * Our <InlinePopover type="apm" /> agent and [infrastructure monitoring agent](/docs/logs/forward-logs/forward-your-logs-using-infrastructure-agent/)
      </td>
    </tr>
