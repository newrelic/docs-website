...
![Cloudflare Network Logs quickstart](https://newrelic.com/sites/default/files/styles/1920w/public/2022-03/cloudflare-dashboard.webp?itok=fOuDA0D5)
...
Learn more about the integration by reading the blog post:
*  [A faster and cheaper way to send log insights to New Relic One with the Cloudflare Logpush integration](https://newrelic.com/blog/how-to-relic/cloudflare-log-integration)
