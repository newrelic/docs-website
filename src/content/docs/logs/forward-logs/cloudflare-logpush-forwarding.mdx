...
7. Enter New Relic's **Logs Endpoint**. Replace `<NR_LICENSE_KEY>` with your [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key).
   ...
   * EU: `"https://log-api.eu.newrelic.com/log/v1?Api-Key=<NR_LICENSE_KEY>&format=cloudflare"`
   ...
   Other tips: 
      ...
      * Having more than one Cloudflare zone may require a new [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) for each zone.
...
* `destination_conf`: A log destination consisting of an endpoint URL, a [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key), and a format in the following string format:
  ...
  * `<NR_LICENSE_KEY>`: Replace with your New Relic [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key), which you can [retrieve from the UI or API](/docs/apis/intro-apis/new-relic-api-keys/#manage-license-key).
