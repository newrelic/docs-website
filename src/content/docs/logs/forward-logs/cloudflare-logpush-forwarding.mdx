...
freshnessValidatedDate: 2023-12-27
---
...
## Enable Logpush to New Relic [#dashboard]

To enable Cloudflare Logpush, follow the steps in the Cloudflare documentation based on your setup choice:

* [Enable via Cloudflare dashboard](https://developers.cloudflare.com/logs/get-started/enable-destinations/new-relic/#manage-via-the-cloudflare-dashboard)
* [Enable via API](https://developers.cloudflare.com/logs/get-started/enable-destinations/new-relic/#manage-via-api)
...
* Go the [Cloudflare Network Logs quickstart](https://newrelic.com/instant-observability/cloudflare/fc2bb0ac-6622-43c6-8c1f-6a4c26ab5434) in New Relic Instant Observability, and click <DoNotTranslate>**+ Install now**</DoNotTranslate>.
