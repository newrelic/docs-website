...
To use our Lambda function for CloudWatch logs, 
...
5. Scroll to the **Application settings** and configure log forwarding using the following environment variables:
