...
To uninstall log forwarding capabilities, follow standard procedures in [Heroku Syslog documentation](https://devcenter.heroku.com/articles/log-drains#syslog-drains). You do not need to do anything else in New Relic.
