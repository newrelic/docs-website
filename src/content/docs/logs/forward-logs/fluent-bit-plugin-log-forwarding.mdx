...
<Callout variant="caution">
    Fluent Bit versions 2.0.7 through 3.0.3 are affected by a [security vulnerability (CVE-2024-4323)](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2024-4323). If you're using one of these versions, upgrade to a different version. For more info on this, see our [security bulletin NR24-01 - Fluent Bit](https://docs.newrelic.com/docs/security/new-relic-security/security-bulletins/security-bulletin-nr24-01/).
</Callout>
