...
2. From <DNT>**[one.newrelic.com](https://one.newrelic.com/launcher/logger.log-launcher)**</DNT>, click <DNT>**Add data**</DNT> in the left nav.
...
1. Make sure you have a <InlinePopover type="licenseKey" />.
2. Go to <DNT>**[the logs UI](https://one.newrelic.com/launcher/logger.log-launcher)**</DNT> and, on the left, click <DNT>**Add data**</DNT>.
