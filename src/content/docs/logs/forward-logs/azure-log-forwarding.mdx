...
On May 2013, we included some security enhancements around the Storage Account and the Function App that our ARM templates deploy. Azure resources are secured by default and these changed settings raise the security bar to prevent this state from being modified.
