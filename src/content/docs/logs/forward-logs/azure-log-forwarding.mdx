...
<CollapserGroup>
  ...
  >
    ...
    If you want to learn more about the resources you have to create and modify, visit [Microsoft's documentation](https://learn.microsoft.com/en-us/samples/azure/azure-quickstart-templates/function-app-storage-private-endpoints/).
