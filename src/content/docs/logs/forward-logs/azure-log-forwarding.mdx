...
2. From <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/launcher/logger.log-launcher)**</DoNotTranslate>, click <DoNotTranslate>**Add data**</DoNotTranslate> in the left nav.
3. In the <DoNotTranslate>**Logging**</DoNotTranslate> category, click the <DoNotTranslate>**Microsoft Azure Event Hub**</DoNotTranslate> tile in the list of data sources.
4. Select the account where you want to send the logs, and click <DoNotTranslate>**Continue**</DoNotTranslate>.
5. Click <DoNotTranslate>**Generate API key**</DoNotTranslate> and copy the generated API key.
6. Click <DoNotTranslate>**Deploy to Azure**</DoNotTranslate> and a new tab will be open with the ARM template loaded in Azure.
7. Select the <DoNotTranslate>**Resource group**</DoNotTranslate> where you want to create the necessary resources, and a <DoNotTranslate>**Region**</DoNotTranslate>. Despite not being mandatory, we recommend installing the template in a new resource group, to avoid deleting any of the components it creates accidentally.
8. In the <DoNotTranslate>**New Relic license key**</DoNotTranslate> field, paste the previously copied API key.
...
11. Click <DoNotTranslate>**Review + create**</DoNotTranslate>, review the data you've inserted, and click <DoNotTranslate>**Create**</DoNotTranslate>.
...
3. In the left-hand menu, select <DoNotTranslate>**Monitoring`>`Diagnostic Settings**</DoNotTranslate>:
...
4. Click <DoNotTranslate>**Add diagnostic setting**</DoNotTranslate>.
5. In the <DoNotTranslate>**Diagnostic setting name**</DoNotTranslate> field, give your new setting a meaningful name.
6. Select the Kubernetes (control pane) logs you want to collect (for example, `kube-apiserver`, `kube-audit`, `kube-scheduler`).
7. On the <DoNotTranslate>**Destination details**</DoNotTranslate>, select <DoNotTranslate>**Stream to an event hub**</DoNotTranslate>, and configure the `Event hub namespace`, `Event hub name`, and `Event hub policy name`. If you opted to create a new Event Hub and a namespace during the [ARM template deployment](#eventhub-arm-setup), select the following automatically created settings (the namespace name will have a different suffix):
...
8. Click <DoNotTranslate>**Save**</DoNotTranslate> to start forwarding your Kubernetes logs to New Relic:
...
<Callout variant="important">
  New Relic Blob Storage ARM template deploys a function that forwards all the blob files within the specified container <DoNotTranslate>**at their current state**</DoNotTranslate>. If any of these blobs is modified thereafter, the <DoNotTranslate>**complete**</DoNotTranslate> contents of the file will be resent.
...
1. Make sure you have a <InlinePopover type="licenseKey" />.
2. Go to <DoNotTranslate>**[the logs UI](https://one.newrelic.com/launcher/logger.log-launcher)**</DoNotTranslate> and, on the left, click <DoNotTranslate>**Add data**</DoNotTranslate>.
3. Under <DoNotTranslate>**Logging**</DoNotTranslate>, click the `Microsoft Azure Blob Storage` tile.
4. Select the account you want to send the logs, and click <DoNotTranslate>**Continue**</DoNotTranslate>.
5. Click <DoNotTranslate>**Generate API key**</DoNotTranslate> and copy the generated <DoNotTranslate>**API key**</DoNotTranslate>.
6. Click <DoNotTranslate>**Deploy to Azure**</DoNotTranslate> and a new tab will be open with the ARM template loaded in Azure.
7. Select the <DoNotTranslate>**Resource group**</DoNotTranslate> where you want to create the necessary resources, and a <DoNotTranslate>**Region**</DoNotTranslate>. Despite not being mandatory, we recommend installing the template in a new resource group, to avoid deleting any of the components it creates accidentally.
8. In the <DoNotTranslate>**New Relic license key**</DoNotTranslate> field, paste the previously copied <DoNotTranslate>**API key**</DoNotTranslate>.
...
<CollapserGroup>
  ...
  >
    ...
    2. In the left menu, go to <DoNotTranslate>**Settings > Configuration**</DoNotTranslate>.

    3. Under <DoNotTranslate>**Allow Blob public access**</DoNotTranslate>, select <DoNotTranslate>**Disabled**</DoNotTranslate>.
      <img
      title="Disabling public access to the blobs/containers in the Storage account"
    ...
    4. Click <DoNotTranslate>**Save**</DoNotTranslate>.
  </Collapser>
  ...
  >
    ...
    3. Select the <DoNotTranslate>**General settings**</DoNotTranslate> tab.

    4. Under <DoNotTranslate>**Platform settings**</DoNotTranslate>, for <DoNotTranslate>**FTP state**</DoNotTranslate>, select <DoNotTranslate>**Disabled**</DoNotTranslate>.
      <img
      title="Disabling FTP access to the Function App"
    ...
    5. Click <DoNotTranslate>**Save**</DoNotTranslate>.
  </Collapser>
  ...
  >
    ...
    4. Under <DoNotTranslate>**Platform settings**</DoNotTranslate>, for <DoNotTranslate>**HTTPS Only**</DoNotTranslate>, select <DoNotTranslate>**On**</DoNotTranslate>.
      <img
      title="Enforcing HTTPS to the Function App"
  ...
  >
    ...
    2. In the left menu, go to <DoNotTranslate>**Settings > Networking**</DoNotTranslate>.

    3. Inside the <DoNotTranslate>**Inbound Traffic**</DoNotTranslate> box, click <DoNotTranslate>**Access restriction**</DoNotTranslate>.
      <img
      title="Disabling public network access to the Function App"
    ...
    4. Under <DoNotTranslate>**App access**</DoNotTranslate>, uncheck the <DoNotTranslate>**Allow public access**</DoNotTranslate> checkbox.
