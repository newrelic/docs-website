...
To uninstall log forwarding capabilities, follow standard procedures in [Microsoft Azure activity logs documentation](https://docs.microsoft.com/en-us/azure/azure-monitor/essentials/activity-log). You do not need to do anything else in New Relic.
