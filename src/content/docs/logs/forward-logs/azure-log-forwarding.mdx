...
2. From **[one.newrelic.com](https://one.newrelic.com/launcher/logger.log-launcher)**, click **Add data** in the left nav.
3. In the **Logging** category, click the **Microsoft Azure Event Hub** tile in the list of data sources.
