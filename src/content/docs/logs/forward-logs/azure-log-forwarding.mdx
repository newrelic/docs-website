...
<Callout variant="tip">
  Looking to forward Azure VNet Flow Logs? See [Set up Azure VNet Flow Logs monitoring](/docs/network-performance-monitoring/setup-performance-monitoring/cloud-flow-logs/azure-vnet-flow-log-monitoring) for dedicated VNet flow log forwarding with incremental delta processing. You can use ARM and Bicep deployment templates for automated setup.
</Callout>
