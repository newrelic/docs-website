...
To uninstall log forwarding capabilities, follow standard procedures in [Amazon S3 documentation](https://aws.amazon.com/s3/). You do not need to do anything else in New Relic.
