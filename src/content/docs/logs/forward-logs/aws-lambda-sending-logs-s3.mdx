...
4. Search for `newrelic` and check <DNT>**Show apps that create custom IAM roles or resource policies**</DNT> to find `NewRelic-log-ingestion-s3`.
5. Click the `NewRelic-log-ingestion-s3` details and click <DNT>**Deploy**</DNT>.
6. Scroll to the <DNT>**Application settings**</DNT> and enter your New Relic <InlinePopover type="licenseKey"/>.
...
8. Confirm that the app creates custom IAM roles, and then click <DNT>**Deploy.**</DNT>
...
1. In the left side menu, click <DNT>**Functions**</DNT>.
2. Find and select the previously created `NewRelic-s3-log-ingestion` function.
3. Under <DNT>**Designer**</DNT>, click <DNT>**Add Triggers**</DNT> and select <DNT>**S3**</DNT> from the dropdown.
...
6. Check the <DNT>**Enable trigger**</DNT> checkbox, then <DNT>**Add**</DNT> the trigger.
