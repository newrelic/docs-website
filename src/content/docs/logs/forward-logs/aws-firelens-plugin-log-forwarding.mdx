...
* An [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key)
...
To prevent exposing your New Relic [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) in your task definition, we strongly recommend using the [AWS Secrets Manager](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/specifying-sensitive-data-secrets.html) service.
...
Use the `logConfiguration` block, replacing INSERT_API_KEY with your New Relic [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key). For configuration details, see the [FireLens task definitions on GitHub](https://github.com/aws-samples/amazon-ecs-firelens-examples).
