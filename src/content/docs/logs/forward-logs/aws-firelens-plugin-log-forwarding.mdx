...
Use the `logConfiguration` block, replacing INSERT_API_KEY with your New Relic license key. For configuration details, see the [FireLens task definitions on GitHub](https://github.com/aws-samples/amazon-ecs-firelens-examples).
