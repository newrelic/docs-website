...
To prevent exposing your New Relic license key in your task definition, we strongly recommend using the [AWS Secrets Manager](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/specifying-sensitive-data-secrets.html) service.
