...
To uninstall log forwarding capabilities, follow standard procedures in [AWS Firelens documentation](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/using_firelens.html). You do not need to do anything else in New Relic.
