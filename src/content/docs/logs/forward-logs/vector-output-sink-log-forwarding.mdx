...
To uninstall log forwarding capabilities, follow standard procedures in [Vector logs sink documentation](https://vector.dev/docs/reference/configuration/sinks/new_relic/). You do not need to do anything else in New Relic.
