...
3. Add a snippet to your `vector.toml` file (located in `/etc/vector` by default), replacing YOUR_LICENSE_KEY with your New Relic [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key):
