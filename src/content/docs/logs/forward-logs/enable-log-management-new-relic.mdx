...
If you don't need the host logs automatically included with infrastructure log forwarding, or if you already have a log forwarder, you can use any of the following supported options to forward your logs to New Relic.
