...
We also support these log forwarders. Some have [quickstarts](https://newrelic.com/instant-observability/?category=logging&search=) that come with out-of-the-box dashboards and alerts after you've set up your log forwarding.
