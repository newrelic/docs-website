...
<table>
  <thead>
    ...
    <tr>
      <td>
        Collect logs from apps running in containers, either standalone or when using Kubernetes
      </td>
      <td>
        Use our [Kubernetes plugin](/docs/logs/forward-logs/kubernetes-plugin-log-forwarding/) or our [infrastructure monitoring agent with containers](/docs/infrastructure/install-infrastructure-agent/linux-installation/container-infrastructure-monitoring/#requirements).
      </td>
    </tr>
