...
4. Depending on where your account data is stored in New Relic, use the DNS name `log-api.newrelic.com` (US), `log-api.eu.newrelic.com` (EU), or `log-api.jp.nr-data.net` (Japan) for configuration.
