...
<CollapserGroup>
  <Collapser
    className="freq-link"
    id=""
    title="Infrastructure/operating system"
  >
  If you're forwarding logs from your infrastructure or OS, use one of these log forwarding options: 
    <TechTileGrid>
  <TechTile
  ...
  />
   ...
   If you're forwarding logs from your cloud environment, use one of these log forwarding options: 
    <TechTileGrid>
  <TechTile
    name="AWS Kinesis Firehouse"
    to="https://one.newrelic.com/marketplace?state=8f14e646-461e-b010-4675-3a0658bb3d20"
    icon={<img src={infrastructureAmazonLinux} alt="Amazon Linux" variant="TechTile"/>}
  />

  <TechTile
    name="AWS Lambda: Cloudwatch"
    to="/docs/infrastructure/new-relic-infrastructure/config-management-tools/configure-new-relic-infrastructure-using-ansible"
    icon={<img src={osAnsibleRed} alt="Ansible" variant="TechTile"/>}
  />
