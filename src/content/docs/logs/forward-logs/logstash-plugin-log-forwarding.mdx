...
1. Enter the following command into your terminal or command line interface:
   ...
   ```
2. In your `logstash.conf` file, add the following block of data. Be sure to replace the placeholder text with your New Relic [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key).
   ```
   output {
     newrelic {
