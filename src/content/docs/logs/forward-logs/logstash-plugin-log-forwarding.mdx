...
To uninstall log forwarding capabilities, follow standard procedures in [Logstash documentation](https://www.elastic.co/products/logstash). You do not need to do anything else in New Relic.
