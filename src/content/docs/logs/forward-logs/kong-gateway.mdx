...
<Steps>
    ...
    Once you've deployed the configurations, go to **[one.newrelic.com > All Capabilities > Logs](https://one.newrelic.com/launcher/logger.log-launcher)**. Confirm that logs from Kong Gateway are appearing in the platform by running this query:
