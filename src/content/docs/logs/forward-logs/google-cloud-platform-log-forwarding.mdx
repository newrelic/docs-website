...
<CollapserGroup>
  ...
  >
    ...
    * The New Relic <InlinePopover type="licenseKey"/> used to send your logs
    ...
    By default, this command sends logs to the US data center. For EU or Japan accounts, see the section below.

    <CollapserGroup>
      <Collapser
        id="eu-customers-gcp-dataflow"
        title="European and Japan Region Accounts"
      >
        European and Japan accounts should also add the `logsApiUrl` parameter with the appropriate endpoint.
