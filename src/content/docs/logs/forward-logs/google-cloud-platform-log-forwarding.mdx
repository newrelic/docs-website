...
To uninstall log forwarding capabilities, follow standard procedures in [Google Cloud Platform documentation](https://cloud.google.com/sdk/docs/). You do not need to do anything else in New Relic.
