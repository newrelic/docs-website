...
* [Guided install (recommended for most users)](#infra)
* [Manual installation](#manual)
* [Linux tarball](#tarball-install)
...
If you encounter problems with configuring your log forwarder, try these troubleshooting solutions:
