...
<Callout variant="tip">
  We are working to integrate log forwarder in the infrastructure agent for arm architecture, meanwhile check [this post](https://discuss.newrelic.com/t/forward-your-logs-with-the-infrastructure-agent-in-arm/157165) with the steps you can follow.
</Callout>
