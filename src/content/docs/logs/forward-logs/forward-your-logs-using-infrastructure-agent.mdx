...
Examples for supported on-host integrations are below. Note this option is currently only available [for our supported Linux platforms](https://docs.newrelic.com/docs/logs/forward-logs/forward-your-logs-using-infrastructure-agent#requirements).
