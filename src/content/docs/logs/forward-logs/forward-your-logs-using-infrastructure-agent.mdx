...
- Use this [Docker image](https://hub.docker.com/r/newrelic/newrelic-fluentbit-output) as the base image to instrument your Docker containers. 
- Install an [on-host integration](/docs/infrastructure/host-integrations/get-started/introduction-host-integrations/) instead of deploying the agent directly on your Docker containers.
