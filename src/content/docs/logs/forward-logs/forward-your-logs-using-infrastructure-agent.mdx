...
Forwarding your logs to New Relic makes all of your logging data available in one location, providing deeper visibility into both your application and your platform performance data.
With your logs in one spot, you get enhanced log management capabilities that let you collect, process, explore, query, and alert on errors or anomalies found in your log data. 

Before you get started, you need to install and configure the infrastructure agent. This doc walks you through that process. 
