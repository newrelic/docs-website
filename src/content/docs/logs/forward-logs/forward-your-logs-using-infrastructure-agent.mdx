...
* The selected host's **Summary** page in the New Relic UI: Go to **[one.newrelic.com](https://one.newrelic.com) > Explorer** or **Infrastructure > Hosts > (select an entity) > Logs**.
