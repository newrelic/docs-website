...
* The selected host's **Summary** page in the New Relic UI: Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Explorer** or **Infrastructure > Hosts > (select an entity) > Logs**.
