...
Here are examples for supported on-host integrations. This option is available only for our [supported Linux platforms](#requirements). Additional integrations as well as Windows support will arrive at a later date.
