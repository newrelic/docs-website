...
You can use our guided install process to quickly and easily install log management and infrastructure monitoring together! To get learn how to use the guided install process and use the logging data you see in New Relic One, watch this Nerdlog video on YouTube (14:46 minutes):
