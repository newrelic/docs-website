...
* Use our [guided install](/docs/infrastructure/host-integrations/installation/new-relic-guided-install-overview), which is a lightweight install route that you can use to install our infrastructure agent, an APM agent, and more. The guided install is a good choice for smaller organizations or anyone who wants to test out New Relic. 
