...
Use New Relic to analize and store the ingested logs from your Vercel projects and traces from your serverless functions.
...
<figcaption>
  Once you have installed the [Vercel quickstart](https://newrelic.com/instant-observability/vercel), go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Dashboards > Vercel** to see your Vercel dashboard.
</figcaption>
