...
4. After you've enabled the traces, you'll see them in New Relic. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > APM & services**. Then, click your app, under the **Monitor** section, and click **Distributed tracing**.
