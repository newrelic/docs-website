...
You're not seeing expected log data in the New Relic UI after ten minutes of installing the <InlinePopover type="infrastructure" /> agent, the <InlinePopover type="apm" /> agent, or setting up log forwarding.
