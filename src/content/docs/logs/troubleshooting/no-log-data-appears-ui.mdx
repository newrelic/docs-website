...
* Infrastructure agent: [logging config options](/docs/infrastructure/install-infrastructure-agent/configuration/infrastructure-agent-configuration-settings/#logging-variables)
    ...
    <tr>
      ...
      <td>
        ...
        This error means that you're using an invalid security key. New Relic requires a [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) to enable log shipping.
