...
For the infrastructure agent: see [logging config options](/docs/infrastructure/install-infrastructure-agent/configuration/infrastructure-agent-configuration-settings/#logging-variables).
    ...
    <tr>
      ...
      <td>
        ...
        If no data appears in the query builder, then no data will appear in the <DoNotTranslate>**Logs**</DoNotTranslate> UI. For more information, see [our docs about data query options](/docs/query-your-data/explore-query-data/get-started/introduction-querying-new-relic-data).
      </td>
    </tr>
  </tbody>
</table>
