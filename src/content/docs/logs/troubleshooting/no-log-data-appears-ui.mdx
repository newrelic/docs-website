...
You're not seeing expected log data in the New Relic UI after ten minutes of installing the infrastructure agent, the <InlinePopup type="apm" /> agent, or setting up log forwarding.
