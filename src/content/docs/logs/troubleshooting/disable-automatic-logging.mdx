...
Use the `dataManagementUpdateFeatureSettings` in [**api.newrelic.com/graphiql**](https://api.newrelic.com/graphiql). Refer to the populated example in GraphiQL as well as the related documentation.
...
**Reviewer: Anything else they need to do in NerdGraph?**
