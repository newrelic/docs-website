...
1. Go to <DoNotTranslate>**[one.newrelic.com > Logs](https://one.newrelic.com)**</DoNotTranslate>.
2. Enter a query to focus on the type of log info you need, then click <DoNotTranslate>**Query logs**</DoNotTranslate>.
3. Click the log line you want to examine in more detail.
4. From the log details pane, click on the <DoNotTranslate>**attribute**</DoNotTranslate> of your choice, then click <DoNotTranslate>**Show surrounding logs**</DoNotTranslate>.
