...
2. Enter a query to focus on the type of log info you need, then click <DNT>**Query logs**</DNT>. An example query:

   ```
   Find logs where annotations.restartRequested:"2020-12-23T18:00:00Z"
   ```
3. On the right, click <DNT>**Live tail**</DNT> to enable <Icon name="fe-play-circle"/> or disable <Icon name="fe-pause-circle"/> it.
