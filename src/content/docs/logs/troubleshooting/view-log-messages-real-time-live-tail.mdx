...
tags:
  ...
  - Log management
  - Troubleshooting
metaDescription: 'To view your log messages as they arrive in New Relic One in real time, enable live tail logging.'
redirects:
...
2. Enter a query to focus on the type of log info you need, then click **Query logs**; for example:
   ...
   ```
3. Click **Livetail** to enable <Icon name='fe-play-circle' /> or disable <Icon name='fe-pause-circle' /> it.
