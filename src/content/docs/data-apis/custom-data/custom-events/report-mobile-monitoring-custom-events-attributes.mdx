...
<CollapserGroup>
  ...
  >
    ...
    <DoNotTranslate>**Create an event on iOS:**</DoNotTranslate>
    ...
    <DoNotTranslate>**Create an event on Android:**</DoNotTranslate>
    ...
    <DoNotTranslate>**Replace deprecated `recordEvent` method:**</DoNotTranslate>
  ...
  >
    ...
    <DoNotTranslate>**Set the `userId` on iOS:**</DoNotTranslate>

    ```
    BOOL userIdWasSet = [NewRelic setUserId:@"jsmith"];
    ```

    <DoNotTranslate>**Set the `userId` on Android:**</DoNotTranslate>
  ...
  >
    ...
    <DoNotTranslate>**Set the `storeId` on iOS:**</DoNotTranslate>
    ...
    <DoNotTranslate>**Set the `storeId` on Android:**</DoNotTranslate>
  ...
  >
    ...
    <DoNotTranslate>**Create a counter on iOS:**</DoNotTranslate>
    ...
    <DoNotTranslate>**Create a counter on Android:**</DoNotTranslate>
    ...
    <DoNotTranslate>**Increment a counter on iOS:**</DoNotTranslate>
    ...
    <DoNotTranslate>**Increment a counter on Android:**</DoNotTranslate>
    ...
    <DoNotTranslate>**Reset a counter on iOS:**</DoNotTranslate>
    ...
    <DoNotTranslate>**Reset a counter on Android:**</DoNotTranslate>
