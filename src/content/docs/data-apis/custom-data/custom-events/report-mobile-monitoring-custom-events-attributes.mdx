...
<CollapserGroup>
  ...
  >
    ...
    <DNT>**Create an event on iOS:**</DNT>
    ...
    <DNT>**Create an event on Android:**</DNT>
    ...
    <DNT>**Replace deprecated `recordEvent` method:**</DNT>
  ...
  >
    ...
    <DNT>**Set the `userId` on iOS:**</DNT>

    ```
    BOOL userIdWasSet = [NewRelic setUserId:@"jsmith"];
    ```

    <DNT>**Set the `userId` on Android:**</DNT>
  ...
  >
    ...
    <DNT>**Set the `storeId` on iOS:**</DNT>
    ...
    <DNT>**Set the `storeId` on Android:**</DNT>
  ...
  >
    ...
    <DNT>**Create a counter on iOS:**</DNT>
    ...
    <DNT>**Create a counter on Android:**</DNT>
    ...
    <DNT>**Increment a counter on iOS:**</DNT>
    ...
    <DNT>**Increment a counter on Android:**</DNT>
    ...
    <DNT>**Reset a counter on iOS:**</DNT>
    ...
    <DNT>**Reset a counter on Android:**</DNT>
