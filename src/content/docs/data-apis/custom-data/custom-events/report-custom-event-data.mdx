...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Use <InlinePopup type="apm" /> agent APIs to [report custom events and custom attributes](/docs/data-apis/custom-data/custom-events/apm-report-custom-events-attributes/).
      </td>
    </tr>
