...
* The amount of data you have access to overtime depends on your [data retention policy](/docs/accounts/original-accounts-billing/original-data-retention/event-data-retention-original-pricing-plan).
