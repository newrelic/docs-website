...
* [<InlinePopover type="apm"/> agent APIs](/docs/insights/insights-data-sources/custom-data/insert-custom-events-new-relic-apm-agents)
...
* [Agent APIs and <InlinePopover type="browser"/>](/docs/insights/insights-data-sources/custom-data/insert-data-via-new-relic-browser) (There are additional requirements with the custom `PageAction` event.)
