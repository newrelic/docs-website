...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Total maximum size or length: <DoNotTranslate>**1MB (10^6 bytes) maximum per POST**</DoNotTranslate>. We highly recommend using compression.
    ...
    <tr>
      ...
      <td>
        ...
        * For events sent via agents: 255 characters
        ...
        Maximum total attributes per event: 254. <DoNotTranslate>**Exception:**</DoNotTranslate> If you use an APM agent API, the max is 64.
...
<table>
  <thead>
    <tr>
      <th width={200}>
        <DoNotTranslate>**Keyword**</DoNotTranslate>
      </th>
