...
<Tabs>
  ...
  <TabsPages>
    ...
    <TabsPageItem id="jp-endpoints">
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              `identity-api.jp.newrelic.com`
              `infrastructure-command-api.jp.newrelic.com`
            </td>
      ...
      <Callout variant="important">
        The endpoint services for `identity-api.jp.newrelic.com`, `infrastructure-command-api.jp.newrelic.com`, and `synthetics-horde.jp.nr-data.net` do not have associated DNS private names.
...
<CollapserGroup>
  <Collapser
    id="cross-region-supported-regions"
    title="All supported regions for cross-region connectivity"
  >
