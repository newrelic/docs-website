...
1. From the dashboards page, search for the Public API Performance pre-built dashboard. You can click the <DoNotTranslate>**View All**</DoNotTranslate> link next to the popular pre-built dashboards title to search it.
2. Select the dashboard.
3. Select an account from the dropdown.
4. Click <DoNotTranslate>**View dashboard**</DoNotTranslate> to add it to your account.
...
* Click  the <Icon name="fe-more-horizontal"/> icon on the right corner of any of the charts and select <DoNotTranslate>**View query**</DoNotTranslate> to view the [NRQL](/docs/query-data/nrql-new-relic-query-language/getting-started/introduction-nrql) query used to create the chart.
* Click  the <Icon name="fe-more-horizontal"/> icon on the right corner of any of the charts and select <DoNotTranslate>**Get as image**</DoNotTranslate> to view or download any chart as an image.
