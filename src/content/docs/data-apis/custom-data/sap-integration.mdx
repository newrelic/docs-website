...
import SAPobservability from 'images/2-SAP-observability.png'

import IDOCresolution from 'images/3-IDOC-resolution.png'
...
To learn more, contact your New Relic account rep to schedule a demo.
