...
## Limits and requirements [#requirements]

To use this feature, you must be a full platform user with [workloads-related capabilities](/docs/accounts/accounts-billing/new-relic-one-user-management/user-capabilities/#capability-definitions). 

The number of SAP systems that can be monitored by New Relic depends on your [pricing edition](https://newrelic.com/pricing). The limits apply to all SAP systems monitored by your [New Relic organization](/docs/accounts/accounts-billing/account-structure/new-relic-account-structure), whether those are SAP production or non-production systems. 

Here are the limits on the number of unique SAP System IDs that can be monitored by New Relic:
* Free tier: 0, not available
* Standard edition: 1 per month
* Pro edition: 5 per month
* Enterprise edition: 10 per month

If you go over a limit or would like a higher limit, please contact your New Relic account representative.
...
Our team will handle the integration's installation and configuration for you. (For an overview of the installation process, see our [Installation guide](https://drive.google.com/file/d/1PeCLM3vQxc-lTxt5R8ZZ6kx9kkfJEu0Y/view).) Contact your New Relic account rep to get started today! 
