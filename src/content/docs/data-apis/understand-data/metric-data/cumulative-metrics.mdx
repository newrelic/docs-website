---
title: "Cumulative metrics (preview)"
tags:
  - Integrations
...
These docs are for our [`cumulativeCount`](/docs/data-apis/understand-data/metric-data/metric-data-type/#metric-types) metric type, which is currently in a preview.
