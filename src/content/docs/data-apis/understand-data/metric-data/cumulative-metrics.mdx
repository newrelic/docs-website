...
If you were reporting OpenTelemetry cumulative metrics to New Relic before March 13, 2023, how we handle those metrics are changing. For details, see the [Cumulative metrics transition guide](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/cumulative-metrics-transition-guide).
</Callout>
