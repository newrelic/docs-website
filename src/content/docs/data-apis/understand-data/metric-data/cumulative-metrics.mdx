---
title: "Cumulative metrics (limited preview)"
tags:
  - Integrations
...
## Limited preview [#preview]

These docs are for our [`cumulativeCount`](/docs/data-apis/understand-data/metric-data/metric-data-type/#metric-types) metric type, which is currently in limited preview. 
