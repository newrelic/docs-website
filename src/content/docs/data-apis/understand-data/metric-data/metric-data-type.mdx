    ...
    <tr>
      ...
      <td>
        ...
        <Callout variant="note">
          The extra cumulative value on the `cumulativeCount` type makes it slightly larger than a typical `count`, and therefore can increase [data ingest](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/data-ingest-billing).
        </Callout>
      </td>
