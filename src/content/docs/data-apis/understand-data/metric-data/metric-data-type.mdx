  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <Callout variant="important">This type is slightly larger than a typical `count`, and therefore can add to [data ingest](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/data-ingest-billing).
        </Callout>
      </td>
