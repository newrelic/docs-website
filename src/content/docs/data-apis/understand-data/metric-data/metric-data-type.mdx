...
The metric type determines how the data is aggregated over longer time windows and determines the metric type's available [fields](/docs/query-your-data/nrql-new-relic-query-language/get-started/nrql-syntax-clauses-functions/#func-getfield) and functions. 
