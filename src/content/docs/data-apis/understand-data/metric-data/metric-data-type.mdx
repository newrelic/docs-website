...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Equivalent to the `count` type described above, but in addition this gives access to cumulative metric fields. This feature is currently in preview. For more on this, see [Cumulative metrics](/docs/data-apis/understand-data/metric-data/cumulative-metrics). 
