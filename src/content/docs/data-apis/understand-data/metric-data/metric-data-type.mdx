...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Equivalent to the `count` type described above, but in addition this gives access to cumulative metric fields. This feature is currently in limited preview. For more on this, see [Cumulative metrics](/docs/data-apis/understand-data/metric-data/cumulative-metrics). 
        <Callout variant="important">
          The cumulative value can make this slightly larger than a typical `count`, and therefore can add to [data ingest](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/data-ingest-billing).
        </Callout>
      </td>
