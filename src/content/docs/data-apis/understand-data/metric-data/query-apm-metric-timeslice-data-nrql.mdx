...
The overview metrics allow you to get a breakdown of where time is spent during execution.
These metrics are unique in a few ways:
* They are not a single timeslice but rather a combination of many
