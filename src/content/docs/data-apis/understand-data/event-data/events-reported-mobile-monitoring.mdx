  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        The exceptions will be visible in queries of this event and on the [<DoNotTranslate>**Handled exceptions**</DoNotTranslate> UI page](/docs/mobile-monitoring/mobile-monitoring-ui/crashes/handled-exceptions-analyze-trends-prevent-crashes), including stack traces.
      </td>
    </tr>
