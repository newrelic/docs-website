...
At New Relic, this metric data is attached to the [`Metric`](/docs/data-apis/understand-data/metric-data/metric-data-type) data type. It's our primary metric data type and is used by many of our tools, including:
