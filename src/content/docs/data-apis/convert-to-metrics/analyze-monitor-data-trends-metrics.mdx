...
<CollapserGroup>
  ...
  >
    ...
    <DNT>**Example response for the request:**</DNT>
  ...
  >
    ...
    <DNT>**Example request to enable an existing metrics rule:**</DNT>
...
<CollapserGroup>
  ...
  >
    ...
    <DNT>**Example listing all rules for account `123456`:**</DNT>
  ...
  >
    ...
    <DNT>**Example listing rule `36` for New Relic account `123456`:**</DNT>
