  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <DNT>**Example rule-creation query:**</DNT>
    ...
    <tr>
      ...
      <td>
        ...
        <DNT>**Example of creating a `distribution` rule:**</DNT>
...
<DNT>**Example metric creation rule that attaches five attributes:**</DNT>
...
<DNT>**Example creating multiple metrics with a single rule:**</DNT>
