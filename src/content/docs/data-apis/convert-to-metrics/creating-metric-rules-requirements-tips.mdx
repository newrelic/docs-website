...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        50K limit on unique metric-name/attribute-value combinations for a single metric in a 30 second time window. Normal [cardinality limits on rollups](https://docs.newrelic.com/docs/data-apis/ingest-apis/metric-api/metric-api-limits-restricted-attributes/#requirements) will apply.
