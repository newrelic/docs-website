  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        If the 50k in a 30 second limit is exceeded, the rule is disabled and an [`NrIntegrationError` event](/docs/telemetry-data-platform/manage-data/nrintegrationerror) is created in that account that includes:
