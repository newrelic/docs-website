...
Use New Relic's [metrics API service](/docs/introduction-events-metrics-api) to define rules for creating [metrics](/docs/telemetry-data-platform/ingest-manage-data/understand-data/metric-data-type) from your other types of data, such as events, logs, or spans. <DoNotTranslate>**Recommendation:**</DoNotTranslate> Before you begin, review our [requirements and tips for creating rules](/docs/telemetry-data-platform/ingest-manage-data/convert-data-metrics/creating-metric-rules-requirements-tips).
