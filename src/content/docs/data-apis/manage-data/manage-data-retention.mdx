...
* **Effective retention:** This is the amount of time data is currently retained for a data type. For the user to be able to edit this:
    ...
    * The user needs **View** and **Modify** permissions for the [**Insights event retention**](/docs/accounts/accounts-billing/new-relic-one-user-management/user-permissions/#data-retention) capability that points to the account(s) they need to edit **Effective retention** for.
