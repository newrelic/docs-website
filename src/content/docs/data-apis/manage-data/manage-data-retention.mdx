...
This doc applies for organizations on our [New Relic One pricing model](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-pricing-models). For data retention for our original pricing model, see [Original data retention](/docs/accounts/original-accounts-billing/product-based-pricing/overview-data-retention-components). 
...
This table shows the default [namespace](/docs/glossary/glossary) retention settings for organizations on the New Relic One pricing model. 
...
For organizations on our [New Relic One pricing model](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing): 
