...
To learn about your choices and costs for changing retention, see [Data options: Data Plus and original](https://docs.newrelic.com/docs/accounts/accounts-billing/new-relic-one-pricing-billing/data-ingest-billing/#upgrade-data-plus).
...
The way you enable users to manage data retention depends on how many accounts you have.

### Single-account organizations [#single-account-organizations]

If you have an organization with only one account, your billing user should be able to change the following:

* **Max per contract:** Upgrade the data retention plan (requires the [Data Plus](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/data-ingest-billing/#upgrade-data-plus) plan)  
* **Effective retention:** Change the amount of time data is retained for any data type in your account 

If your billing user can't perform these two tasks, contact [support](https://support.newrelic.com).

### Multiple-account organizations [#multiple-account-organizations]

If you're in an organization with more than one account, you need to make some configurations before your user can complete these data retention tasks: 

#### Upgrade your retention plan [#upgrade-retention-plan]

To ensure your user can upgrade the data retention plan (**Max per contract**), the user needs to be:

* In an organization on the Pro or Enterprise edition
* In an organization that is on the [Data Plus](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/data-ingest-billing/#upgrade-data-plus) plan
* In a group with the [Billing](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts/#admin-settings) administration setting 

When you upgrade the data retention plan (**Max per contract**), that increases the allowances for all the accounts in your organization.

#### Edit effective retention [#edit-effective-retention]

If you have multiple accounts, your user needs to be assigned a custom role with the **View and Modify** permission for the **Insights event retention** capability. This role needs to point to the account(s) that have the effective retention they need to manage. 
