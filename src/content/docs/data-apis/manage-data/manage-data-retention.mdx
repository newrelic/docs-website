...
Extending your data retention allows you to long-term analysis, visualization, and alerting for all your metrics, events, logs, and traces across all of your sources. However, it’s important to manage that data for cost, performance, and in some cases, compliance reasons. Our data management hub provides the tools you need to understand and control where your data is coming from, and adjust what’s stored and for how long. 

Until recently, we’ve been allowing you to adjust your data retention beyond your contractual limits without billing changes or contract renewals. Starting March 31, when your data retention exceeds your limits, you will lose access to this data including for use in dashboards, data analysis, auditing, and compliance needs. 

When you edit data retention beyond your contracted limits, you’ll be prompted to upgrade your retention with new billing changes to reflect your extended retention. For long term data analysis, governance, and compliance, extending your retention can be business critical. See below for details.
