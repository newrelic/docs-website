...
* [Newer user model](/docs/accounts/original-accounts-billing/original-users-roles/overview-user-models): 
  ...
  * Adjusting retention within the bounds of a contract for specific types of data or for a specific account requires the [**Insights event retention** permission](/docs/accounts/accounts-billing/new-relic-one-user-management/user-capabilities/#data-retention) 
