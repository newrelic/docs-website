...
![screenshot of data retention page](src/images/edit_retention_settings.png 'Edit data retention page')

<figcaption>
  From the data retention UI page, which shows the source of data, you can click
  **Edit settings** to adjust the data retention for each source.
</figcaption>
...
![image of child accounts to copy retention values to](src/images/copy-data-retention.png 'Copy retention values')
