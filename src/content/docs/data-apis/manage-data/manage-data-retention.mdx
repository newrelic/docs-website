...
With New Relic's **Data retention** UI page, you can review and manage how long different types of data are stored in the New Relic database (NRDB). Keep data for shorter periods to protect sensitive information and speed up queries or for longer periods to see longer-term trends. 
...
This doc applies for organizations on our [New Relic One pricing model](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-pricing-models). For our original pricing model's data retention, see [Original data retention](/docs/accounts/original-accounts-billing/product-based-pricing/overview-data-retention-components). 
...
The best way to understand your New Relic data retention is to go to the **Data retention** UI page. One reason this is recommended is because your organization may have changed the settings from the default retention settings. 
