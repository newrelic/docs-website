...
The **Data retention** UI page is located in the [Data management hub](https://one.newrelic.com/data-management-hub). To view explanations of the data retention table column headers, hover over a header. 
...
If you meet [the requirements](#requirements), you can edit retention for the data types listed in the data retention UI. 

To view and edit your retention, go to [the data management hub](https://one.newrelic.com/data-management-hub), click **Data retention**, and click **Edit data retention**. 
