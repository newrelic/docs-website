...
This table shows the default retention settings for the [namespaces](/docs/glossary/glossary). Some of these can be edited and some can't. 
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Infrastructure processes (not editable: [learn more](#infrastructure-data))
      </td>
    ...
    <tr>
      ...
      <td>
        Infrastructure integrations (not editable: [learn more](#infrastructure-data))
      </td>
...
### Requirements for editing retention [#requirements]
