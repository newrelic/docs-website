...
The way users manage data retention depends on how many accounts you have in your organization and what they are trying to do.

### Single-account organizations [#single-account-organizations
]
If you are in an organization that has only one account in it, your **Billing User** can manage the following:
...
* **Effective retention:** This is the amount of time data is currently retained for a data type.  For a user to access this option, their  account needs to be on our [Pro edition (or higher)](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing/#how-pricing-works).
...
* **Max per contract:** This is the highest value you can set for the **Effective retention** of a data type. If you would like to increase this, see our [Data Plus](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/data-ingest-billing/#data-prices) plan.
* **Effective retention:** This is the amount of time data is currently retained for a data type. For a user to access this option, their  organization needs to be on our [Pro edition (or higher)](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing/#how-pricing-works), and the user would need to have **View and Modify** permissions for the **Insights event retention** capability.
