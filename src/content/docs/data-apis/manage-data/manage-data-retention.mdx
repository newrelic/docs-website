...
* Raw metric data points have a less-than-one-minute resolution and that data is retained for 30 days. 
* Raw data is aggregated into one-minute data points. That data is retained for 13 months. 
