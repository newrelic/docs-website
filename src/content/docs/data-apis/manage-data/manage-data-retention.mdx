...
The ability to view and edit data retention is affected by which user model a user is on:
...
* The [original user model](/docs/accounts/original-accounts-billing/original-users-roles/users-roles-original-user-model): requires the **Insights event manager** capability, which the **Admin**, **Owner**, and **Data retention add-on manager** have. 
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
    Synthetics (not editable)
      </td>

      <td>
        Synthetics data (not editable)
      </td>
...
We let you adjust the retention periods for some types of data. For example, you might reduce your retention values for your APM data to optimize the performance of your querying of that data. Conversely, you might increase retention for some data types so that you can do more granular analysis over longer time ranges, or to meet data compliance requirements.

For organizations on our [usage-based pricing model](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing): 
* Our [Data Plus option](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/data-ingest-billing#data-prices) gives you access to up to 90 days of retention. 
* For our [original data option](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/data-ingest-billing#data-prices): each additional 30 days of retention costs $0.05 per GB ingested per month.

For requirements, see [Requirements](#requirements). 
