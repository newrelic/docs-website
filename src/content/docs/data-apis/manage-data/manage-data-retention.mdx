...
Metric retention periods are not editable.
  ...
  >
    Infrastructure monitoring downsamples your data as it's generated. All <InlinePopover type="infrastructure" /> metric data types (including metrics from on-host integrations) will display different granularity depending on the age of the data and the size of the time window. The following table illustrates when different downsampled buckets will be used, both in the infrastructure UI and for queries:
