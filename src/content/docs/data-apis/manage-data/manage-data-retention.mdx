...
There are two [data options](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/data-ingest-billing#data-prices) available that impact retention: the Data Plus option provides longer default retention for some data types. For details, see the [retention table](#retention-periods). 

The ability to view and edit retention is affected by which user model a user is on:
