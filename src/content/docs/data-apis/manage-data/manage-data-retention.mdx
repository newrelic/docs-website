...
If you have an organization with only one account, your billing user can change the following:
...
If you have multiple accounts, your user needs to be assigned a custom role with the **View and Modify** permission for the **Insights event retention** capability. This role needs to point to the accounts where the user wants to change the retention. 
