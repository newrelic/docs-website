...
If you meet [the requirements](#requirements), you can increase or decrease the retention periods for the types of data listed in the **Data retention** UI. To do that: on that page, click **Adjust retention**. Note that data retention is increased across the board, for all data types listed in the **Data retention** UI. 
...
When you reduce retention, it's registered within 12 hours. When that's done, new data of that type is retained for the new retention period.

Reducing data retention below your contracted retention values won't reduce any data ingest charges. Conversely, increasing retention for targeted telemetry data types is likely to trigger a conversation with New Relic about adjusting your data ingest charges.
