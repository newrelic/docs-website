...
On the <DNT>**Data retention**</DNT> UI page, located in the [data management hub](https://one.newrelic.com/admin-portal/limits-data-retention/data-retention), you can review and manage how long different types of data are stored. You may want shorter retention for some data types in order to protect sensitive information, or you may want longer retention (up to seven years) to be able to see and analyze data and trends over a longer period.
