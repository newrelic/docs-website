...
<Callout variant="tip">
With [our Data Plus option](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/data-ingest-billing/#data-plus), you get an additional 90 days of retention and other enterprise-grade capabilities, such as longer query durations, FedRAMP and HIPAA compliance, additional security features, and more.
</Callout>
...
Note that our [Data Plus option](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/data-ingest-billing/#data-plus) provides an additional 90 days of retention.
...
* For Data Plus or original data option: add data retention. 30 days of additional data retention for your organization costs $0.05 per GB ingested per 30 days.
