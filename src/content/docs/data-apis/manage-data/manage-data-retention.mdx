...
With our **Data retention** UI page, you can review and manage how long different types of data are stored. You may want shorter retention for some data types in order to protect sensitive information, or you may want longer retention to be able to see and analyze data and trends over a longer period. 
...
/>
<figcaption>
  The **Data retention** UI page is where you learn about the retention periods for your data, and edit data retention.
</figcaption>

## Requirements [#requirements]

Editing data retention requires Pro or Enterprise edition. Some kinds of New Relic organizations cannot adjust retention on their own. If you're a Pro or Enterprise organization and can't edit retention, talk to your New Relic account representative.  

Note that our [Data Plus option](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/data-ingest-billing/#data-plus) significantly increases your data retention.  
...
If you meet [the requirements](#requirements), you can edit your retention. To view and edit your retention, go to [the data management hub](https://one.newrelic.com/data-management-hub), click **Data retention**, and click **Edit data retention**. 

Options for increasing retention: 

* Switch to [Data Plus](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/data-ingest-billing/#data-plus), which significantly increases retention and offers other benefits.
* Increase data retention 30 days at a time. 

Important points about increasing retention: 

* Retention is increased across the board, for all data types listed in the **Data retention** UI. It cannot be increased only for specific data types. 
* Once you enable a higher retention period, reducing retention for specific data sources has no impact on your billing.
* Data retention changes may take up to 24 hours to take effect. 
* For each additional 30 days of retention, the cost is $0.05 per GB ingested per month. 
...
When you reduce retention, it will take effect within 12 hours. When it takes effect, new data of that type is retained for the new retention period.

## Delete data [#deleting-data]

Once [telemetry data](/docs/using-new-relic/data/understand-data/new-relic-data-types) is reported to the New Relic database and available for querying, that data cannot be edited or deleted. This is a purposeful design decision that optimizes New Relic's speed and performance. Data will expire after its [data retention period](#adjust-retention) ends. If you need to delete data that has already been reported, contact your New Relic representative.
