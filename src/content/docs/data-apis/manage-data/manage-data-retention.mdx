...
/>
<figcaption>
  The <DoNotTranslate>**Data retention**</DoNotTranslate> UI is where you can view and edit your effective retention values, as well as upgrade your retention plan.To view explanations of the table column headers, hover over a header in the Data Retention UI, but we also have explanations below in the Requirements section
</figcaption>

## Requirements [#requirements]

To upgrade your retention plan, or edit your effective retention values when you have more than one account in your organization, you need to be on the Pro or Enterprise edition. With these editions, you can designate users who are responsible for managing the retention plan or the effective amount of time data will be retained. Whether you have one user handle both tasks or assign separate users for each, you enable access differently:

* **Upgrade your retention plan (Max per contract)**: Your **Max per contract** column specifies the maximum number you can configure the **Effective retention** for a type of data. This maximum allowance always applies to all accounts in your organization, if you have more than one account. To increase your **Max per contract**, you need a user who is in a group that has the **Billing** administrative setting enabled for it. This administrative setting applies to all users in that group. Those users will have a **Billing User** role assigned to them, but this method is the only way to assign that specific role. Only these users will see an **Upgrade plan** button in the top right of the Data Retention UI.
    <Callout variant="tip">
      Some customers with upgraded retention plans can set **Effective retention** values to numbers higher than the corresponding **Max per contract** value (for an additional cost). If you need more details about this, please reach out to your New Relic account team or our [Sales team](https://newrelic.com/contact-us-customer).
    </Callout>
* **Change the current length of retention (Effective retention)**: This is the current retention time that you want that type of data to be stored and available to query. The highest number you can set this number to is in the corresponding **Max per contract** column. The users described below will be able to click the **Edit retention** button at the top right of the **Data Retention** UI:
    * For organizations with a single account: The same user described above who can upgrade the retention plan (**Max per contract**) can also set the effective retention values for the account.
    * For organizations with multiple accounts: You need a user who is assigned a custom role, which requires Pro or higher plan, with **View and Modify** for the **Insights event retention** capability.
...
To view and edit your retention, go to [the data management hub](https://one.newrelic.com/data-management-hub), click <DoNotTranslate>**Data retention**</DoNotTranslate>, and click <DoNotTranslate>**Edit data retention**</DoNotTranslate>. There you'll see options for editing data retention or upgrading to Data Plus. If you don't see that, review [the requirements](#requirements) and talk to your New Relic account representative. 
...
* When you enable a higher retention period, retention is increased across the board for all data types listed in the [<DoNotTranslate>**Data retention**</DoNotTranslate> UI](#find-ui). It cannot be increased only for specific data types. 
