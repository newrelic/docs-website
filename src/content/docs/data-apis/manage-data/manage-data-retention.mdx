...
If you meet [the requirements](#requirements), you can increase or decrease the retention periods for the data in the **Data retention** UI. For each additional 30 days added to a namespace's [default retention period](#retention-periods), the cost is $0.05 per GB ingested per month. 
