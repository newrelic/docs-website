...
- **Limited control**: Set budgets for specific accounts
...
<Steps>
  <Step>
    ...
    <Callout variant="important">
      ...
      Note that notifications are not set up by default. You must configure thresholds and destinations to receive budget alerts.
    </Callout>
