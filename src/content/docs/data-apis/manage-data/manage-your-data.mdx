...
To find the data management UI: From **[one.newrelic.com](https://one.newrelic.com/all-capabilities)** click the [account dropdown](/docs/glossary/glossary/#account-dropdown), and the click **Manage your data**.
