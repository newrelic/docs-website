...
<figcaption>
  Data management hub: from the [user menu](/docs/accounts/accounts-billing/general-account-settings/intro-account-settings) in the top right of the UI, select **Manage your data**.
</figcaption>
