...
To locate the data management UI: From [one.newrelic.com](https://one.newrelic.com) select the account dropdown, and select **Manage your data**. If you're on the [New Relic One user model](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-user-models), you can also find the Data management hub by selecting **Administration > Manage data**.
