...
<CollapserGroup>
  ...
  >
    ...
    WHERE newRelicFeature = 'Event API' SINCE 1 WEEK AGO LIMIT 100
    ```
  ...
  >
    ...
    SELECT message 
    FROM NrIntegrationError 
    WHERE newRelicFeature = 'Metrics' SINCE 1 WEEK AGO LIMIT 100
    ```
  ...
  >
    ...
    SELECT message 
    FROM NrIntegrationError 
    WHERE newRelicFeature = 'Distributed Tracing' SINCE 1 WEEK AGO LIMIT 100
    ```
