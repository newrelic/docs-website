...
For New Relic organizations on our [usage-based pricing model](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing), several factors impact your costs: which edition you're on ([Standard, Pro, or Enterprise](https://newrelic.com/pricing)), how many billable users you have, how much data you ingest, and your [data option](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/data-ingest-billing#data-prices). This resource will help you estimate your New Relic data ingest costs.
