...
To arrive at the ingest rates used in our spreadsheet calculator, we analyzed approximately 10,000 existing New Relic organizations of various sizes to determine average ingest levels. That said, you’ll get the most precise estimate by running a test installation to establish a consumption baseline. Ingest rates vary from one organization to the next, based on what kinds of things you monitor, the features you use, application behaviors, and more. 
