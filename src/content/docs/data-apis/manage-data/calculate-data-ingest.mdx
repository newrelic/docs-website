...
When it comes to estimating your costs on the [New Relic One pricing model](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing), figuring out your data ingest is probably the most complex part of the equation because it can (and will) vary. 
...
## Arriving at good estimates [#accurate-sizing]

The [cost estimator spreadsheet](https://docs.google.com/spreadsheets/d/1natQ4YhmjDIH8YgkPblIRP2R8h07V4TNAw3EJDu91_g/edit?usp=sharing) is most useful for scenarios where you know the number of application performance monitoring (APM) agents, hosts, and logs you'll need. To arrive at the ingest rates used in our spreadsheet calculator, we analyzed approximately 10,000 existing New Relic organizations of various sizes to determine average ingest levels. But ingest rates can vary from one organization to the next, based on what kinds of things are monitored, what features are used, the monitored applications' behaviors, and more. 

One alternative to using the spreadsheet is to extrapolate from an existing New Relic account. Here are some recommendations for that: 
...
## Use the cost estimator spreadsheet [#work-sizing-calculator]

The following sections explain how to use the [cost estimator spreadsheet that you previously made a copy of](#get-started). Each section describes the type of information you need to provide and how to measure your ingest for those data types.
