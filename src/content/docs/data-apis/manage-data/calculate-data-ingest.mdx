...
When it comes to estimating your costs on the [New Relic One pricing model](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing), figuring out your data ingest is probably the most complex part of the equation because it can (and will) vary. This data calculation doc should be useful if you're new to New Relic One pricing, or if you're expanding your New Relic monitoring. 

To get started, make your own copy of [this Google spreadsheet](https://docs.google.com/spreadsheets/d/1natQ4YhmjDIH8YgkPblIRP2R8h07V4TNAw3EJDu91_g/edit?usp=sharing). The instructions below will give you instructions on how to fill out that spreadsheet, which will auto-populate an estimated cost. **Note that the spreadsheet provides you only an estimate**: it's not a binding billing proposal.
