...
The <DNT>**Data ingestion**</DNT> tab is located in the [Data management UI](/docs/data-apis/manage-data/manage-your-data). It shows a summary of your data usage by source, helping you understand what data is being sent to New Relic.

<img
  title="Data ingestion UI"
  alt="Data ingestion UI"
...
The Data ingestion UI provides tools to help you monitor and analyze your data:

<DNT>**Filters and controls:**</DNT>

* <DNT>**Time range selector:**</DNT> Choose between **Auto**, **Daily**, **Weekly**, or **Monthly** views to analyze data ingestion trends over your preferred time period.
...
* <DNT>**Data source filtering:**</DNT> Use the dropdown and search functionality to filter and find specific data sources.

<DNT>**Visualizations:**</DNT>

* <DNT>**Data source table:**</DNT> View all active data sources with their respective ingestion amounts. The table shows each source's contribution to your total data ingestion (such as **BrowserEventsBytes**, **CustomEventsBytes**, **ApmEventsBytes**).
* <DNT>**Visual trend chart:**</DNT> Displays ingestion patterns over time with color-coded bands representing different data sources, making it easy to identify spikes or trends.
* <DNT>**Usage by account:**</DNT> A pie chart showing the distribution of data ingestion across your accounts, displaying both the total volume and percentage breakdown.
* <DNT>**Usage by data source:**</DNT> A pie chart breaking down your total ingestion by data source (for example, **BrowserEventsBytes** might show 95.17% of your total ingestion, **CustomEventsBytes** at 3.33%).

For detailed definitions of the metrics shown, see [Data ingest sources](#sources-list).

<Callout variant="important">
  **Multi-tenant account filtering**

  For organizations with multi-tenant accounts, you can filter data ingestion by organization or account using the **Select Organization** and **Select Account** dropdowns. This allows you to view data for all organizations and accounts, or narrow down to specific ones.
</Callout>

### Get more detail [#detail]

To view additional details about a specific data source:

1. Click the data source name in the table
2. Use the additional filtering options that appear to drill down further into that specific data source

<DNT>**Advanced options:**</DNT>

* Click <DNT>**View NRQL**</DNT> to see the underlying query for any chart
* See [Account settings](/docs/accounts/accounts-billing/general-account-settings/intro-account-settings/#video-tour) for a video tour of this and other administration UIs
* For technical details about how charts display data and error messages, see [Chart details](#technical-details-chart)

## Estimate future data ingest [#estimate]

The <DNT>**Data Ingestion**</DNT> page includes predictive capabilities that help you forecast your organization's future data usage.

To forecast usage:
1. Navigate to the <DNT>**Daily view**</DNT> of the time series chart at the top of the page
2. From the <Icon name="fe-more-horizontal"/> chart menu, select <DNT>**Predict Usage**</DNT>
3. View the data usage forecast for 1 week in both the chart and the table

To remove the forecast, select <DNT>**Remove prediction**</DNT> from the chart menu.

<Callout variant="important">
Forecasting is only available for <DNT>**Advanced Compute**</DNT> customers and only in the <DNT>**Daily view**</DNT> of the <DNT>**Data source time series chart**</DNT>.
</Callout>
