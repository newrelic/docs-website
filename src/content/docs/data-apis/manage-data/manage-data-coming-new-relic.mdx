...
* <DNT>**Total ingestion display:**</DNT> The total data ingested for the selected time period is prominently displayed (for example, "Total 250,551.32 GB").
* <DNT>**Export functionality:**</DNT> Use the <DNT>**Download CSV**</DNT> button to export your data ingestion details for further analysis or reporting.
* <DNT>**Ignored consumption toggle:**</DNT> Toggle this option to include or exclude ignored consumption data from your view.
