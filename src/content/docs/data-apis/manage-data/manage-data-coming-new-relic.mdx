...
Options for adjusting APM data ingest include:
...
Options for adjusting infrastructure data ingest include: 
...
* [Manage Pixie data](/docs/kubernetes-pixie/auto-telemetry-pixie/manage-pixie-data).  
