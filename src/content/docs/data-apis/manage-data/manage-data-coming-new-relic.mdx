...
If you're trying to estimate the cost of your data ingest, see [Estimate data ingest](https://developer.newrelic.com/collect-data/monitor-your-application/estimate-cost).
