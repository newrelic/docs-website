...
The <DNT>**Data ingestion**</DNT> tab is located in the [Data management UI](/docs/data-apis/manage-data/manage-your-data). The data ingestion UI shows a summary of your usage by data source.
...
The Data ingestion UI provides several key features to help you monitor and analyze your data:

* <DNT>**Time range selector:**</DNT> Choose between **Auto**, **Daily**, **Weekly**, or **Monthly** views to analyze data ingestion trends over your preferred time period. The date range is displayed at the top (for example, From Feb 28, 04:01 am to Mar 30, 04:01 am (UTC)).
* <DNT>**Data source filtering:**</DNT> Use the dropdown and search functionality to filter and find specific data sources from your ingestion.
* <DNT>**Data source table:**</DNT> View all active data sources with their respective ingestion amounts. The table shows each source's contribution to your total data ingestion (for example, **BrowserEventsBytes**, **CustomEventsBytes**, **ApmEventsBytes**, etc.).
* <DNT>**Visual trend chart:**</DNT> The chart displays ingestion patterns over time with color-coded bands representing different data sources, making it easy to identify spikes or trends in specific data types.
* <DNT>**Usage by account:**</DNT> A pie chart at the bottom left shows the distribution of data ingestion across your accounts, displaying both the total volume (in kilobytes) and percentage breakdown.
* <DNT>**Usage by data source:**</DNT> A pie chart at the bottom right breaks down your total ingestion by data source type, showing the volume and percentage for each source (for example, **BrowserEventsBytes** at 95.17%, **CustomEventsBytes** at 3.33%, etc.).

<Callout variant="important">
  **Multi-tenant account filtering**

  For organizations with multi-tenant accounts, you can filter data ingestion by organization or account using the **Select Organization** and **Select Account** dropdowns at the top of the page. This allows you to view data for all organizations and accounts, or narrow down to specific ones.

  <img
    title="Multi-tenant account filtering"
    alt="Organization and account filtering dropdowns"
    src="/images/accounts_screenshot-crop_multi-tenant-filtering.webp"
  />
</Callout>
...
For additional details about a data source listed in the table, click on the data source name. This displays a more detailed view with additional filtering options. For instance, when you select **MetricBytes**, a secondary dropdown menu becomes available that lets you filter the **Metric Type**.
...
<figcaption>
  When you select a data source in the table, you'll get more details about that data.
</figcaption>
...
The <DNT>**Data ingestion**</DNT> page includes predictive capabilities that help you forecast your organization's future compute usage.
...
<Callout variant="important">
Forecasting is only available for <DNT>**Advanced Compute**</DNT> customers and only in the <DNT>**Daily view**</DNT> of the <DNT>**Data ingestion time series chart**</DNT>.
</Callout>
