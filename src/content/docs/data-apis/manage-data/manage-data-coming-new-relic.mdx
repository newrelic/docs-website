...
## Manage data ingest [#manage]

How you manage your New Relic data will depend on a lot of factors specific to your organization and your needs. That said, here are some general tips for managing data ingest and avoiding unexpected charges: 

* Assign team members who will be in charge of reviewing and managing your New Relic data. Ensure they understand the [data-related billing factors](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/data-ingest-billing), including what does and doesn't count towards billing.  
* Spend some time getting acquainted with your data. Get to know the ebbs and flows in your data, and understand where your data is coming from. 
* When you first install or activate a new data-reporting solution, it's a good practice to monitor your data ingest to make sure there are no surprises.  
* It's a good practice to occasionally review your data ingest. 
* If you're concerned about specific scenarios causing sudden spikes in data, set up an alert condition to notify you if that occurs. For tips on that, see [Usage queries](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/usage-queries-alerts).

### Reducing ingest and avoiding spikes in ingest [#adjust-ingest] 

Below are some tips for common approaches New Relic customers take to either: 

* Address unexpected spikes in data, or
* Reduce the ingest of data that's not helpful to them 

All of our data-reporting solutions have various configuration options that allow you to adjust and control the data reported. We'll give some popular methods for reducing data ingest here, but we recommend you read the docs for the specific tools you're using to learn about all the options. 
...
For unexpected increases in [network performance monitoring data](/docs/network-performance-monitoring/get-started/npm-introduction), you may consider adjusting the polling interval. 
