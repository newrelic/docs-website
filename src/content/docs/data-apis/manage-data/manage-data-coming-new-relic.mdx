...
<Callout variant="important">
  The <DNT>**Auto**</DNT> view doesn't support the time picker. This view shows ingest in 5-minute intervals, so it can't display ranges longer than one day. To view a longer time range, use the <DNT>**Daily**</DNT>, <DNT>**Weekly**</DNT>, or <DNT>**Monthly**</DNT> views.
</Callout>
