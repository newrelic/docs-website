...
<CollapserGroup>
 ...
 ###  Infrastructure processes
  ...
  Performance data related to applications and services, typically managed by the customer, including data related to <DNT>Docker/DNT> containers, Windows services, Nagios checks, and cloud integrations such as managed services in AWS, Azure, and GCP.
</Collapser>
  <Collapser
    id="logging"
    title="Logging"
