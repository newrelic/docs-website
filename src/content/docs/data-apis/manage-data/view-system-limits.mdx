...
* Limit-related [`NrIntegrationError` events](/docs/data-apis/manage-data/nrintegrationerror)
...
* Green: below 80%
* Gray: limits that exist but that don't generate violation events
...
* When you select a time range greater than 6 hrs, the chart uses average values, which may be smoothed out and not show spikes. For longer ranges, you may see the message "For the time window chosen, the 'Max limit usage' value represents the average of your usage limits."
