...
![screenshot of limits graph](src/images/limits-graph.png 'limits-graph.png')
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > [account
  ...
  > Manage your data > Limits**: An example of a chart on the **Limits** UI page
  displaying a cardinality violation limit issue.
</figcaption>
...
![screenshot of limits message table](src/images/limits-table.png 'limits-table.png')

<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > [account
  dropdown](/docs/using-new-relic/welcome-new-relic/get-started/glossary#account-dropdown)
  > Manage your data > Limits**: An example of a limit events table on the
  **Limits** UI page.
</figcaption>
