...
![Data limits UI screenshot](./images/data-limits-ui.png "Data limits UI screenshot")
<figcaption>The limits UI displays information related to an account's data ingest rate and query rate, and violations of limits.</figcaption>
