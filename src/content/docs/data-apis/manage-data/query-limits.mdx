...
You can use the following NRQL queries to create alerts. Learn about creating alerts with [NRQL queries here](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/nrql-alert-conditions/#create).
