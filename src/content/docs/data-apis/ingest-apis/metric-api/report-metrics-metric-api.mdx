...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <DNT>**Recommended**</DNT>. This should be one of the [supported metric types](/docs/telemetry-data-platform/ingest-manage-data/understand-data/metric-data-type). If you do not specify a type, then this will default to a `gauge`.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <DNT>**Recommended**</DNT>. A map of key value pairs associated with this specific metric. Values can be strings, JSON numbers, or booleans. Keys are case-sensitive and must be less than 255 characters.
      </td>
    </tr>
  </tbody>
</table>
