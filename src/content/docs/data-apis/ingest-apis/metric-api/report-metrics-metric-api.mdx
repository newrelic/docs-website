...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        **Required.** A <InlinePopover type="licenseKey" /> for the account you want to report data to. If this is provided as both a header and a query parameter, the values must match.
      </td>
    </tr>
