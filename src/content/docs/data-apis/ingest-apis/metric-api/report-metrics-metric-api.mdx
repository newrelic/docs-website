...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <DoNotTranslate>**Required.**</DoNotTranslate> A <InlinePopover type="licenseKey" /> for the account you want to report data to. If this is provided as both a header and a query parameter, the values must match.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <DoNotTranslate>**Required if GZIP.**</DoNotTranslate> The value must be `GZIP` or `Identity.` If no value is present, then `Identity` is assumed.
      </td>
    </tr>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <DoNotTranslate>**Required**</DoNotTranslate>. The name of the metric. The value must be less than 255 characters.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <DoNotTranslate>**Required**</DoNotTranslate>. The value varies depending on the [metric type](/docs/telemetry-data-platform/ingest-manage-data/understand-data/metric-data-type). For `gauge` and `count` the value should be a single number. For `summary`, the value should be a map with key-value pairs specifying the count, sum, min, and max.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <DoNotTranslate>**Required for `count` and `summary` [metric types](/docs/telemetry-data-platform/ingest-manage-data/understand-data/metric-data-type)**</DoNotTranslate>. The length of the time window.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <DoNotTranslate>**Recommended**</DoNotTranslate>. This should be one of the [supported metric types](/docs/telemetry-data-platform/ingest-manage-data/understand-data/metric-data-type). If you do not specify a type, then this will default to a `gauge`.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <DoNotTranslate>**Recommended**</DoNotTranslate>. A map of key value pairs associated with this specific metric. Values can be strings, JSON numbers, or booleans. Keys are case-sensitive and must be less than 255 characters.
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <DoNotTranslate>**Required for `count` and `summary`.**</DoNotTranslate>The length of the time window.
      </td>
    </tr>
