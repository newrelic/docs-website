...
1. Go to the specific metric's page and select <DNT>**Edit Per Metric Limit**</DNT>.
    Or
   Select <DNT>**Edit Per Metric Limit**</DNT> from the kebab menu of the desired metric in the **All Metrics** table of the **Account** Page.
2. Enter the new desired limit for the metric in the form of a whole number.
3. Update the value.

The updated limit appears in the user interface within a few minutes.
