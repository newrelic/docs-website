...
You can find Cardinality Management with other administration tools by clicking your name in the lower left and going to **Administration > Cardinality Management**.
...
* The current cardinality usage for the account, which is in the 2 to 4 million range. 

You can modify this timeseries by changing the timepicker in the top right corner. 

<Callout variant="tip">
  The timepicker only affects the timeseries, and it does not affect the **Metrics** table under the timeseries.
</Callout>
