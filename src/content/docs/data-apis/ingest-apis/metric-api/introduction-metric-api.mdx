...
You'll need a New Relic <InlinePopover type="licenseKey"/> for the New Relic account you want to send data to. For information on limits and restricted attributes, see [Metric API requirements and limits](/docs/metric-api-general-requirements-limits).
...
* From <DNT>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DNT>, select <DNT>**Explorer**</DNT> and look for your service.
