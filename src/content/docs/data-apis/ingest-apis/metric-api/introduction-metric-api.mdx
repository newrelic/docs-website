...
If we do not have an existing [integration or quickstart](https://newrelic.com/instant-observability/) that meets your metric-reporting needs, you have two options:
