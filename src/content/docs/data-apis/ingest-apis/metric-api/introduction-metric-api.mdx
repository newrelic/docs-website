...
You'll need a New Relic [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) for the New Relic account you want to send data to. For information on limits and restricted attributes, see [Metric API requirements and limits](/docs/metric-api-general-requirements-limits).
