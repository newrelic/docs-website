  ...
  >
    ...
    mutation {
      dataManagementCreateAccountLimit(
        ...
        accountLimit: {
          limit: {name: "Dimensional Metric per-metric cardinality ingested}
          overrideReason: "<Provide a reason for your override>",
          overrideValue: <THE DESIRED CARDINALITY>,
          qualifier: "<METRIC NAME>"
        })
      {
        name
        unit
