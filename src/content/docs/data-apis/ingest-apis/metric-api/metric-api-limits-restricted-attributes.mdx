...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The payload must encoded as <DoNotTranslate>**UTF-8**</DoNotTranslate>.
      </td>
    </tr>
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <DoNotTranslate>**Example: Metric value used as an attribute (invalid)**</DoNotTranslate>
    ...
    <tr>
      ...
      <td>
        ...
        <DoNotTranslate>**Exception:**</DoNotTranslate> You can use `name` as an attribute key.
      </td>
    </tr>
  </tbody>
</table>
