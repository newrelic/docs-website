...
1. Ensure you have an [Insights query API key](/docs/insights/insights-api/get-data/query-insights-event-data-api) (go to <DoNotTranslate>**[insights.newrelic.com](https://insights.newrelic.com) > Manage data > API keys**</DoNotTranslate>).
