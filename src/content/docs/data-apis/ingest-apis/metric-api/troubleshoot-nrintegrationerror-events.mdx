...
2. Create an HTTP request as shown below:
   ...
   <Callout variant="tip">
     Ensure you're using the correct regional endpoints for your organization's data center:
     * **EU data center**: Use the [EU region endpoints](/docs/using-new-relic/welcome-new-relic/getting-started/introduction-eu-region-data-center#endpoints)
     * **Japan data center**: Use the Japan region endpoints for API requests
   </Callout>
