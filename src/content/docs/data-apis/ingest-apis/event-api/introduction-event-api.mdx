...
<CollapserGroup>
  ...
  >
    ...
    * `accountId`: This is a reserved attribute name. If it's included, it will be dropped during ingest.
    ...
    * `eventType`: Can be a combination of alphanumeric characters, `_` underscores, and `:` colons. [Learn more about naming restrictions](/docs/data-apis/custom-data/custom-events/data-requirements-limits-custom-event-data).
