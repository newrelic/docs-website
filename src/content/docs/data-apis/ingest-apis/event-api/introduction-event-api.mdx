    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Missing or invalid key: Invalid license key. Register a valid license key. You must use a key of the `License` type. `Browser`, `Mobile`, or `User` keys will not work.
          </td>
        </tr>
