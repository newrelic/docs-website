...
1. Get a [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) for the account you want to report data to.
...
* The `Api-Key` contains the correct [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key).
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Missing or invalid key: Invalid license key. Register a valid [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key). You must use a key of the `License` type. `Browser`, `Mobile`, or `User` keys will not work.
          </td>
        </tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The first six characters of the [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) used for the request that generated an error.
      </td>
    </tr>
