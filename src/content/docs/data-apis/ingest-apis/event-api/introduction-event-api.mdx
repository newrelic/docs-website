...
<Callout variant="tip">
  If your organization hosts data in the EU or JP data center, ensure you're using the proper regional endpoints. See [EU region endpoints](/docs/accounts/accounts-billing/account-setup/choose-your-data-center/#eu-endpoints) or [JP region endpoints](/docs/accounts/accounts-billing/account-setup/choose-your-data-center/#jp-endpoints).
</Callout>
