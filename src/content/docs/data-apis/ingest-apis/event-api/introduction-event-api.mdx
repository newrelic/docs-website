...
* The `Api-Key` contains the correct <LicenseKey/>.
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Missing or invalid key: Invalid license key. Register a valid <LicenseKey/>. You must use a key of the `License` type. `Browser`, `Mobile`, or `User` keys will not work.
          </td>
        </tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The first six characters of the <LicenseKey/> used for the request that generated an error.
      </td>
    </tr>
