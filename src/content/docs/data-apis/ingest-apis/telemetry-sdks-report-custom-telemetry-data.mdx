...
If our [pre-built solutions](https://developer.newrelic.com/instant-observability) do not meet your needs, our Telemetry SDKs are one way to create a custom telemetry solution (see other [solutions for reporting custom data](/docs/data-apis/custom-data/intro-custom-data)). 
