...
The Telemetry SDKs use our Metric API, Event API, Log API, and Trace API, which all require a <InlinePopover type="licenseKey"/>, so you'll need a license key for the account you wish to send data to.
