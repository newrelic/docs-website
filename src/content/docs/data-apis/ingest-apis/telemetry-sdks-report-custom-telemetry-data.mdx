...
The Telemetry SDKs use our Metric API, Event API, Log API, and Trace API, which all require a [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key), so you'll need a license key for the account you wish to send data to.
