...
<Steps>
    ...
    <DoNotTranslate>**SLIs for APM services instrumented with the New Relic agent**</DoNotTranslate>:
    ...
    >
        ...
        <DoNotTranslate>**Valid events fields**</DoNotTranslate>
        ...
        <DoNotTranslate>**Bad events fields**</DoNotTranslate>
    ...
    >
        ...
        <DoNotTranslate>**Good events fields**</DoNotTranslate>
    ...
    1. Navigate to <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com) > All capabilities > Service levels management**</DoNotTranslate>. This UI shows all your service levels and allows you to define, monitor, and edit them. 
    2. Select <DoNotTranslate>**+ Add a service level**</DoNotTranslate> in the top right of the UI.
    </Step>

    <Step>
    Choose the corresponding entity that you want to create a service level for. This could be an entire workload, a specific service, a synthetic monitor, or even a specific transaction. Once you've selected your entity, click <DoNotTranslate>**Continue**</DoNotTranslate> on the left side of the UI pane.
    </Step>
...
Where `{entityGuid}` is the service's GUID.
    ...
    Select <DoNotTranslate>**Continue**</DoNotTranslate> in the left pane once you've confirmed your queries are correct to complete the creation of your service levels.
    </Step>
