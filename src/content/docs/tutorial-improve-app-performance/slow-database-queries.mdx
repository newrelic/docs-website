...
redirects:
  ...
  - /docs/tutorial-app-slow/slow-database-queries
...
<Steps>
  <Step>
    Navigate to the databases UI: Go to <DNT>**[one.newrelic.com](https://one.newrelic.com/nr1-core?filters=(domain%3D'APM'ANDtype%3D'APPLICATION')) > (select an app) > monitor > databases**</DNT>
  </Step>

  <Step>
    ### Time consumed by database operations

    The <DNT>**Most time consuming**</DNT> chart shows the total processing time on queries by a database operation.
  ...
  <Step>
    ...
    The <DNT>**Top databases by query time**</DNT> chart shows how your databases are performing based on how long it takes to execute a query.
  ...
  <Step>
    ...
    The <DNT>**Top databases by throughput**</DNT> chart shows your database throughput over time.
