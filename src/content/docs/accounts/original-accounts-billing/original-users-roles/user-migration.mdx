...
* If you're using SCIM, push your groups and users from your Identity Provider and configure access before the last step of the migration where you migrate user assets. This will ensure your users' assets are migrated to the SCIM provisioned user records and that those users have access when logging in
