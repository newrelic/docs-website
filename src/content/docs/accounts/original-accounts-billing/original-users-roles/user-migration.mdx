...
Before using [the user migration wizard](#find), please review these requirements and guidelines: 
...
* If your organization has more than 20 accounts, we recommend **not** using the user migration wizard. **You can disregard this requirement if you're being helped by New Relic representatives.** (Note that this refers to having 20 or more accounts in an organization, not users.)
