...
For SCIM provisioning users: If you're using SCIM to import users and groups from your identity provider, you won't be able to edit roles and permissions in New Relic. All user and group changes are handled from your identity provider service.
</Callout>
