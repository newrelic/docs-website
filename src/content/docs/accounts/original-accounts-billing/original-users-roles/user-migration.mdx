...
If your New Relic organization was a [customer partnership](/docs/new-relic-partnerships/partner-integration-guide/partner-account-maintenance/partnership-accounts-users-subscriptions) (a complex multi-tenant structure) and you were migrated to the new user model, you may see a seeming increase in data ingest in NRQL queries you've created. Your ingested data hasn't actually changed but due to the migration, you may experience some discrepencies. 
