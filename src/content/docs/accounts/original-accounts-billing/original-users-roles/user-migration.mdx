...
![User migration page 1](src/images/user-migration-page-1.png 'user-migration-page-1.png')
...
- If you've already used the wizard to set up an admin on the new user model, have the admin sign in using their new user record to access the migration tool. The user migration wizard, when completed, destroys the old user record, but if you've started the user migration process without completing it, you may have users with access to both the original and new record, as shown below:
  ![A screenshot of what is shown when you have an email address associated with multiple New Relic logins](src/images/login-multiple-accounts-view.png 'Login UI for email addresses with multiple user records')
  {' '}
  <figcaption>
    If a user on the new model has been created and the migration process hasn't
    been completed, they may have access to both the original user record and
...
![User migration page 2](src/images/user-migration-page-2.png 'user-migration-page-2.png')
...
![User migration page 3](src/images/user-migration-page-3.png 'user-migration-page-3.png')

Name your organization something descriptive and easily recognizable.

## Step 4: Authentication domain settings [#page4]

![User migration page 4](src/images/user-migration-page-4.png 'user-migration-page-4.png')
...
![User migration page 5](src/images/user-migration-page-5.png 'user-migration-page-5.png')
...
![User migration page 6](src/images/user-migration-page-6.png 'user-migration-page-6.png')
...
![User migration page 7](src/images/user-migration-page-7.png 'user-migration-page-7.png')
...
![User migration page 8](src/images/user-migration-page-8.png 'user-migration-page-8.png')
