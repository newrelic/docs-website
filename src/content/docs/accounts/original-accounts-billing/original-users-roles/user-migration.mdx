...
Note that if you're already using an identity provider's New Relic app, you'll probably need to use a newer version made for New Relic's newer account/user model. For more on this, see [Identity provider apps](#idp-apps).
