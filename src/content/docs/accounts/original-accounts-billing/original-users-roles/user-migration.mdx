...
For details about how to create usage queries, see [Usage queries](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/usage-queries-alerts#multitenant-ingest).
