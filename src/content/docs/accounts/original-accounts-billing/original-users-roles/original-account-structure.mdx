...
This doc is about organizations on our original user model, not the [New Relic One model](/docs/accounts/accounts-billing/account-structure/new-relic-account-structure/). [Learn more about the difference.](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-user-models) 
</Callout>
...
<Callout variant="important">
Note that the user model is not directly related to our two different [pricing models](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-pricing-models). 
</Callout>
