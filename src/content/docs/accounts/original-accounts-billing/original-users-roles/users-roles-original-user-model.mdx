...
This governs the ability to use the **Invite a teammate** feature, located in the [account dropdown](/docs/new-relic-solutions/get-started/glossary/#account-dropdown). 
  ...
  >
Here's a summary of Admin and Add-on manager capabilities with [New Relic synthetic monitoring](/docs/synthetics/new-relic-synthetics/getting-started/introduction-new-relic-synthetics). To allow a User or Restricted User to execute any of these functions in synthetics, assign a synthetics add-on manager role.

Admin and manager capabilities for synthetic monitors include:
