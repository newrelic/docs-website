...
To update your users' user type:
    ...
    3. If your organization has multiple accounts, you won't be able to see all your organization's users in a single UI location. You'll have to go to the **Users and roles** UI for each account.
