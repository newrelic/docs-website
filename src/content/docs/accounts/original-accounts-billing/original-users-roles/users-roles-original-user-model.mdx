...
## User types: basic user and full user [#user-type]
  ...
  <Callout variant="important">
On March 1 2021, basic users on our original user model had basic-user restrictions enforced. Previously these basic users had been granted the same permissions as full users. For more on this change and on how to upgrade, see our <a href="https://discuss.newrelic.com/t/basic-users-can-now-request-upgrades-to-full-stack-observability-uis-on-march-1/139782">Explorer's Hub post on basic user changes</a>.
    </Callout>

On the [Users and roles](#view-access) UI page, users on our [original user model](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-changes-pricing-user-model) are categorized by user type: full user or basic user. 

If you're on [New Relic One pricing](/docs/accounts/accounts-billing/new-relic-one-pricing-users/pricing-billing), the number of full users is a factor in your billing. Otherwise, it's not a factor. To learn more, see [Transition to new pricing](/docs/accounts/accounts-billing/new-relic-one-pricing-users/transition-guide-new-pricing-plan#how-to-transition).

For how to change this, see [Update user type](#update-user-type).
