...
<CollapserGroup>
  ...
  >
This governs the ability to use the **Invite a teammate** feature, located in the [user menu](/docs/accounts/accounts-billing/general-account-settings/intro-account-settings). 
  </Collapser>  
