...
To control how users upgrade, from the **Users and roles** UI you can select **Access requests**. You have two options: 
    * **Automatic approval**: With this option, users can automatically upgrade to become full platform users. This option allows your users to more easily troubleshoot problems. 
