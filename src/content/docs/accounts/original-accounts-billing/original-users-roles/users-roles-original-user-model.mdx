...
<Callout variant="important">
  This doc contains information about how to manage users on our original user model. Not sure which pricing plan or user model you're on? See [Overview of pricing plan and user models](/docs/accounts/accounts-billing/new-relic-one-pricing-users/transition-guide-new-pricing-plan).
</Callout>
...
<Table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        One or more individuals who can [add, edit, and delete account users](/docs/accounts-partnerships/accounts/account-setup/add-update-users). Admins can also [install and configure the New Relic agent](/docs/agents/manage-apm-agents), and they can enable or set up features.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        One or more individuals who use (and optionally set up) the available New Relic features. In general, Admins take responsibility for setting up features, and Users and Restricted Users can use them.
      </td>
    </tr>
...
<CollapserGroup>
  ...
  >
    ...
    2. Select **<i className="fa fa-plus-circle">
       plus-circle
       </i>
  ...
  >
    ...
    1. Go to **[account dropdown](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#account-dropdown) > Account settings > Users and roles > Roles**.
    2. From the **Add-on roles** list, select the custom add-on role, then select **<i className="fa fa-pencil">
       pencil
       </i>
       Edit role** or **<i className="fa fa-trash-o">
       trash-o
       </i>
...
Here is a summary of Admin and Add-on manager capabilities with [New Relic Mobile](/docs/mobile-monitoring/new-relic-mobile/getting-started/introduction-new-relic-mobile). To allow a User or Restricted User to execute any of these functions in New Relic Mobile, assign a Mobile manager role.

Admin and manager capabilities for Mobile include:

* [Delete](/docs/mobile-monitoring/new-relic-mobile/maintenance/deleting-mobile-app) a mobile application from New Relic.
* Install New Relic Mobile for [Android](/docs/mobile-monitoring/new-relic-mobile-android/get-started/android-installation-configuration) or [iOS](/docs/mobile-monitoring/new-relic-mobile-ios/get-started/ios-installation-configuration).
