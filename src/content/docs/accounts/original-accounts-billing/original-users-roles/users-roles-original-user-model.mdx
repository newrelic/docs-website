...
## User types: basic user and full user [#user-type]
  ...
  <Callout variant="important">
On March 1, 2021, we ended the preview period for basic users on our original user model. Previously these basic users had the same permissions as full users. For more on this, see our [Explorer's Hub post on basic user changes](https://discuss.newrelic.com/t/basic-users-can-now-request-upgrades-to-full-stack-observability-uis-on-march-1/139782).
    </Callout>

On the [Users and roles](#view-access) UI page, users on our [original user model](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-changes-pricing-user-model) are categorized by [user type](https://docs.newrelic.com/docs/accounts/accounts-billing/new-relic-one-user-management/new-relic-one-user-model-understand-user-structure#user-type) (full user or basic user). For how to change this, see [Update user type](#update-user-type).

If you're on [New Relic One pricing](/docs/accounts/accounts-billing/new-relic-one-pricing-users/pricing-billing), the number of full users is a factor in your billing. To learn more, see [New Relic One pricing](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing#how-pricing-works).
