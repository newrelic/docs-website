...
To update your users' user type:
  ...
  3. Note that if your organization has multiple accounts, you won't be able to see all your users in a single UI location but will have to go to the **Users and roles** UI for each account. 
