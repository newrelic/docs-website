...
<CollapserGroup>
  ...
  >
    ...
    Note that billing-related aspects of your user count only apply if you're on [New Relic One pricing](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-pricing-models). If you're on our [original pricing model](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-pricing-models), billing impacts do not apply. 
