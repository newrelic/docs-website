...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="APM manager"
  >
    Here is a summary of Admin and Add-on manager capabilities with [APM](/docs/apm/new-relic-apm/getting-started/introduction-new-relic-apm). To allow a User or Restricted User to execute any of these functions in APM, assign an <InlinePopup type="apm" /> add-on manager role.

    Admin and manager capabilities for <InlinePopup type="apm" /> include:
