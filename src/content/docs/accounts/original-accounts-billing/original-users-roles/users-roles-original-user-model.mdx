...
A New Relic user is prohibited from sharing their login with other people. For more on that, see [Active session limit](/docs/accounts/accounts-billing/account-setup/troubleshoot-new-relics-password-email-address-login-problems/#active-session-limit).
...
The **Users and roles** UI is used for managing users on our [original user model](#who-is-doc-for). To find this UI: click the [account dropdown](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#account-dropdown), click **Account settings**, and then click **Users and roles**.
...
<CollapserGroup>
  ...
  >
    ...
    1. For the account you want to add a user to, go to: **[account dropdown](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#account-dropdown) > Account settings > Users and roles > Users**.
  ...
  >
    ...
    5. Go to: **[account dropdown](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#account-dropdown) > Account settings > Account > Users and roles**.
...
To understand the capabilities that a role has, go to: **[account dropdown](/docs/glossary/glossary/#account-dropdown) > Account settings > Users and roles > Roles** and select a specific role. To see descriptions of specific capabilities, go to [Capabilities](/docs/accounts/accounts-billing/new-relic-one-user-management/user-capabilities).
...
<CollapserGroup>
  ...
  >
This governs the ability to use the **Invite a teammate** feature, located in the [account dropdown](/docs/new-relic-solutions/get-started/glossary/#account-dropdown). 
  </Collapser>  
