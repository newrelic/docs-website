...
In April of 2021, we began allowing some New Relic organizations to migrate their original user model users to our new model, which offers many improvements in simplifying how you manage your users' roles and access to accounts. 
