...
metaDescription: >-
  "For New Relic accounts on our original user model: explanation of how to manage users, and how user roles work."
redirects:
...
For how to manage user type, see [Manage users](#update-user-type).
