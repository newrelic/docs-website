...
On May 1, 2023, the usage UI for our original pricing model reaches end-of-life (EoL). In this doc are NRQL queries that customers on the original pricing model can use to understand their usage. 
