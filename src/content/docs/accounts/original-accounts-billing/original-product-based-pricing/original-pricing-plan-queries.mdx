...
WHERE `productLine` = 'APM' AND `usageType` = 'Host' AND `consumingAccountId` = [YOUR_ACCOUNT_ID](/docs/accounts/accounts-billing/account-structure/account-id) 
...
FROM NrDailyUsage, NrUsage 
WHERE `productLine` = 'Browser' AND `usageType` = 'Application' AND `consumingAccountId` = [YOUR_ACCOUNT_ID](/docs/accounts/accounts-billing/account-structure/account-id) AND `isPrimaryApp` != 'false' 
COMPARE WITH 1 month ago 
SINCE '2023-02-01 00:00:00' UNTIL '2023-03-01 00:00:00' 
LIMIT 500
```
...
```sql
SELECT SUM(browserPageViewCount) as usage 
FROM NrDailyUsage, NrUsage WHERE `productLine` = 'Browser' AND `usageType` = 'Application' AND `consumingAccountId` = [YOUR_ACCOUNT_ID](/docs/accounts/accounts-billing/account-structure/account-id) AND `isPrimaryApp` != 'false' 
TIMESERIES 1 day 
...
FROM NrDailyUsage, NrUsage 
WHERE `productLine` = 'Mobile' AND `usageType` = 'Application' AND `consumingAccountId` = [YOUR_ACCOUNT_ID](/docs/accounts/accounts-billing/account-structure/account-id) 
TIMESERIES 1 day 
COMPARE WITH 1 month ago 
SINCE '2023-02-01 00:00:00' UNTIL '2023-03-01 00:00:00' 
LIMIT 500
...
FROM NrDailyUsage, NrUsage 
WHERE `productLine` = 'Infrastructure' AND `usageType` = 'Host' AND `consumingAccountId` = [YOUR_ACCOUNT_ID](/docs/accounts/accounts-billing/account-structure/account-id) 
COMPARE WITH 1 month ago 
SINCE '2023-02-01 00:00:00' UNTIL '2023-03-01 00:00:00' 
LIMIT 500
```
...
FROM NrDailyUsage, NrUsage 
WHERE `productLine` = 'Logs' AND `consumingAccountId` = [YOUR_ACCOUNT_ID](/docs/accounts/accounts-billing/account-structure/account-id) AND `metric` = 'BytesSaved' 
COMPARE WITH 1 month ago 
SINCE '2023-02-01 00:00:00' UNTIL '2023-03-01 00:00:00' 
LIMIT 500
```
...
FROM NrDailyUsage, NrUsage 
WHERE `productLine` = 'Metrics' AND `consumingAccountId` = [YOUR_ACCOUNT_ID](/docs/accounts/accounts-billing/account-structure/account-id) AND `metric` = 'DataPointsSent' 
COMPARE WITH 1 month ago 
SINCE '2023-02-01 00:00:00' UNTIL '2023-03-01 00:00:00' 
LIMIT 500
```
...
SELECT rate(SUM(usage), 1 day) as usage 
FROM NrDailyUsage, NrUsage 
WHERE `productLine` = 'Serverless' AND `consumingAccountId` = [YOUR_ACCOUNT_ID](/docs/accounts/accounts-billing/account-structure/account-id) AND `metric` = 'LambdaEventsSaved' 
COMPARE WITH 1 month ago 
SINCE '2023-02-01 00:00:00' UNTIL '2023-03-01 00:00:00' 
LIMIT 500
```
...
FROM NrDailyUsage, NrUsage 
WHERE `productLine` = 'Synthetics' AND `usageType` = 'Check' AND `consumingAccountId` = [YOUR_ACCOUNT_ID](/docs/accounts/accounts-billing/account-structure/account-id) AND `syntheticsTypeLabel` != 'Ping' 
COMPARE WITH 1 month ago 
SINCE '2023-02-01 00:00:00' UNTIL '2023-03-01 00:00:00' 
LIMIT 500
```
...
SELECT rate(SUM(syntheticsSuccessCheckCount + syntheticsFailedCheckCount), 1 day) as usage 
FROM NrDailyUsage, NrUsage 
WHERE `productLine` = 'Synthetics' AND `usageType` = 'Check' AND `consumingAccountId` = [YOUR_ACCOUNT_ID](/docs/accounts/accounts-billing/account-structure/account-id) AND `syntheticsTypeLabel` != 'Ping' TIMESERIES 1 day 
FACET syntheticsTypeLabel 
SINCE '2023-02-01 00:00:00' UNTIL '2023-03-01 00:00:00' 
LIMIT 15
```
...
SELECT rate(SUM(usage), 1 day) as usage 
FROM NrDailyUsage, NrUsage 
WHERE `productLine` = 'Traces' AND `consumingAccountId` = [YOUR_ACCOUNT_ID](/docs/accounts/accounts-billing/account-structure/account-id) AND `metric` = 'SpansSaved' 
COMPARE WITH 1 month ago 
SINCE '2023-02-01 00:00:00' UNTIL '2023-03-01 00:00:00' 
LIMIT 500
```
