...
* You can query data from a maximum of 30 accounts at once, using either the [query builder](/docs/query-your-data/explore-query-data/query-builder/introduction-query-builder) in the UI or [NerdGraph](/docs/apis/nerdgraph/examples/nerdgraph-nrql-tutorial/#cross-account-query).
