...
For APM, CU-based pricing is the best choice if you have many cloud-based dynamic computing resources. For this reason, CU-based pricing is sometimes referred to as <DoNotTranslate>**cloud pricing**</DoNotTranslate>.
...
Price points vary, depending on the New Relic product and subscription level. 
  ...
  >
    ...
    With host-based pricing, New Relic charges based on the number of <DoNotTranslate>**equivalent hosts**</DoNotTranslate> used in a month. One <DoNotTranslate>**equivalent host**</DoNotTranslate> is defined as: a [host](#understand) connected to New Relic for 750 hours (750 hours used as standard month size). If a host is connected to New Relic at any time during an hour, that hour counts towards the host calculation.

    These hours can be divided across multiple hosts. For example, you might have three hosts that are each connected to New Relic for 250 hours during one month: these hours would add up to equal one <DoNotTranslate>**equivalent host**</DoNotTranslate>.
  ...
  >
    To understand how New Relic computes both [host-based pricing](#host-based) and [CU-based pricing](#compute-unit), it's important to understand how the word <DoNotTranslate>**host**</DoNotTranslate> is used. A host can be one of the following:
    ...
    * A <DoNotTranslate>**cloud instance**</DoNotTranslate> is a type of virtual machine that is run in the public cloud. In this context, virtual machines and cloud instances are different from Java Virtual Machines (JVMs) and containers.
      ...
      For New Relic pricing calculation purposes, a <DoNotTranslate>**month**</DoNotTranslate> is defined as 750 hours.
  </Collapser>
</CollapserGroup>
