---
title: "Subscription usage (original pricing plan)"
tags:
  - Accounts
  - Original accounts and billing
  - Original pricing plan usage
metaDescription: For accounts on our original pricing plan, how to understand your product subscription usage data.
redirects:
...
* **Ruby**: 4.4.0.336 or higher
  ...
  For accounts on our [original pricing plan](/docs/accounts/original-accounts-billing/product-pricing/product-based-pricing), this explains how we calculate billable usage for Browser subscription usage. This document also provides available subscription usage attributes and [example NRQL queries](#query-examples) to use in the New Relic UI or with API calls.
...
* Switch from Browser SPA monitoring back to standard monitoring
  ...
  For accounts on our [original pricing plan](/docs/accounts/original-accounts-billing/product-pricing/product-based-pricing), this explains how we calculate billable usage for Mobile accounts. This document also provides available subscription usage attributes and [example NRQL queries](#query-examples) to use in the New Relic UI or with API calls.
...
<CollapserGroup>
  ...
  >
For accounts on our [original pricing plan](/docs/accounts/original-accounts-billing/product-pricing/product-based-pricing), this explains how we calculate billable usage for Infrastructure accounts. This document also provides available subscription usage attributes and [example NRQL queries](#query-examples) to use in the New Relic UI or with API calls.
...
<CollapserGroup>
  ...
  >
For accounts on our [original pricing plan](/docs/accounts/original-accounts-billing/product-pricing/product-based-pricing), this explains:
...
<CollapserGroup>
  ...
  >
For accounts on our [original pricing plan](/docs/accounts/original-accounts-billing/product-pricing/product-based-pricing), this explains how we calculate billable usage for Synthetics accounts. This document also provides available subscription usage attributes and [example NRQL queries](#query-examples) to use in the New Relic UI or with API calls.
