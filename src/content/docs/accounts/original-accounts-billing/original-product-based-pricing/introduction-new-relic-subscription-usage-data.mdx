...
<Callout variant="important">
  This doc is for accounts on our original [Product-based pricing](/docs/accounts/original-accounts-billing/product-pricing/product-based-pricing). If you're on the newer pricing model, see [New Relic One pricing model](/docs/accounts/accounts-billing/new-relic-one-pricing-users/pricing-billing). Not sure which you're on? See [Overview of pricing models](/docs/transition-guide-our-new-pricing-plan-user-model).
</Callout>
...
<figcaption>
  For organizations on our original pricing model, owners and admins can view usage for all products, or view it by product. 
</figcaption>
...
With [New Relic Browser Pro](https://newrelic.com/browser-monitoring/pricing), pricing is based on an account's number of page views per month. If [SPA monitoring](/docs/browser/single-page-app-monitoring/use-spa-data/understand-spa-data-collection) is enabled, browser interactions that do not require a page load are **not** counted as page views for billing purposes. With SPA monitoring, you can track an unlimited number of route changes and other custom browser interactions that do not involve page loads.

### Notes on Insights subscription [#insights]

If you switch from standard Browser monitoring to SPA monitoring, and you also pay for Insights (and do not use only your complementary Insights subscription), your Insights data usage will increase. Because SPA monitoring is a more advanced way to monitor your application, it creates more Insights events than standard monitoring for the following reasons:
