...
<table>
  ...
  <tbody>
    ...
    <tr id="monthly-pricing">
      ...
      <td>
        New Relic charges your credit card each month for a specified number of hosts or compute units. The account Owner can change the credit card number. To edit billing settings, use the [Billing UI](/docs/accounts/accounts-billing/general-account-settings/introduction-account-settings/#pricing). Adjustments to billing settings will take effect for the next billing period.
...
<CollapserGroup>
  ...
  >
    To view summary information about your subscription, go to the [billing UI](/docs/accounts/accounts-billing/general-account-settings/introduction-account-settings/#pricing). 
  ...
  >
    To adjust your subscription settings, use the [Billing UI](/docs/accounts/accounts-billing/general-account-settings/introduction-account-settings/#pricing).
  ...
  <Collapser
    ...
    title="View usage"
  >
    To view your usage, use the [usage UI](/docs/accounts/accounts-billing/general-account-settings/introduction-account-settings/#pricing).
  </Collapser>
  ...
  >
    To view or update your New Relic account's billing information, see the [billing UI](/docs/accounts/accounts-billing/general-account-settings/introduction-account-settings/#pricing).
