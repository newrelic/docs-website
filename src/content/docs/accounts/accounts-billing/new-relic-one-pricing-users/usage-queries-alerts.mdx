...
<Callout variant="tip">
  When creating alert conditions, we recommend 20 minutes for the [Evaluation offset](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-nrql-alert-conditions#h2-evaluation-offset) value.
</Callout>
