...
<Callout variant="caution">
  When creating alert conditions, you should set the [delay/timer](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-nrql-alert-conditions#delay-timer) value to 60 minutes or your conditions may not trigger.
</Callout>
