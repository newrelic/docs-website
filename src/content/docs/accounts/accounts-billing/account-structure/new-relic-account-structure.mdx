...
* Perform cross-account queries using the query builder or NerdGraph API, with a maximum of 30 accounts per query. Refer to [Cross-account queries](/docs/apis/nerdgraph/examples/nerdgraph-nrql-tutorial#cross-account-query).
* Set up cross-account alerting. Refer to [Cross-account alerting](/docs/alerts/create-alert/create-alert-condition/cross-account-alert).
