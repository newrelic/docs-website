...
Depending on your [user model](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type), you have different options for adding and managing accounts and assigning users to them. We have two user models: 
