...
A New Relic "account" can be considered a workspace. For example, you might have an account for a specific app, or a set of related hosts and services for a specific initiative or project, or you might have an account for a specific team. Each account has its own [account ID](/docs/accounts/accounts-billing/account-setup/account-id), which is relevant when doing some procedures, like making API calls. 
