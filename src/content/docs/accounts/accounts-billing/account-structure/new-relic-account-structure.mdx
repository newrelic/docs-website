...
Note that the user model is not directly related to our [two pricing models](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-changes-pricing-user-model/#pricing-plans). 
</Callout>
