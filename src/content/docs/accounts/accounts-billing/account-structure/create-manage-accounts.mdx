...
* Your aren't ingesting vast amounts of data. If you're not sure, use [our spreadsheet](https://newrelic.com/blog/nerdlog/estimate-data-cost) to estimate the amount of data you might send to New Relic
...
### Use multiple accounts to separate testing and production environments
...
### Use multiple accounts to separate projects with unique data sets
...
### Use multiple accounts to manage large data limits
...
### Use multiple accounts to manage security 
