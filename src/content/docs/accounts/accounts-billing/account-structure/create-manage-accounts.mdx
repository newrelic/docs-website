...
This doc will guide you through setting up your account structure. If you're going to create multiple accounts, it is best to do that _before_ you begin ingesting data. It can be harder to make changes after you connect New Relic to your applications because you risk losing historical context.
