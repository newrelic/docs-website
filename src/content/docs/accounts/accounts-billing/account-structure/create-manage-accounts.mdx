...
* **Organization**:  An organization represents a New Relic customer. Your New Relic organization contains your organization's accounts, users, and data.
...
If you manage a payment provider that works in multiple countries, you might need to manage different currencies and different tax regulations. Or, you could manage a social media site and you might need to comply with different data collection policies in different regions. In both those situations, it is a good idea to create multiple accounts. 
