...
3. From the sub-account's [**Applications** index](/docs/apm/applications-menu/monitoring/viewing-your-applications-index), select the app's gear <Icon name="settings"/>
