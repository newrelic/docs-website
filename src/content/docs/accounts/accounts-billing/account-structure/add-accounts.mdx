...
* User must be a core user or full platform user with [<DNT>**Organization settings**</DNT>](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts/#admin-settings).
