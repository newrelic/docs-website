...
* Your [user type](/docs/accounts/accounts-billing/new-relic-one-user-management/new-relic-one-user-model-understand-user-structure/#user-type) (basic user or full platform user). 
...
* Our [New Relic One pricing model](/docs/new-relic-one-pricing-billing): This newer pricing model gives more cross-platform access. The main factors affecting access are your [edition](https://newrelic.com/pricing) and your [user type](/docs/users-roles#user-type).

We also have several [pricing editions](https://newrelic.com/pricing): Standard, Pro, and Enterprise.

Learn more about our [pricing models](/docs/transition-guide-our-new-pricing-plan-user-model).
