...
* **Too many simultaneous logins.** A New Relic user is prohibited from sharing their login with other people. To allow our users to use New Relic on several devices, a user’s login credentials can be associated with a maximum of either three concurrent active sessions or three unique IP addresses at one time. 
