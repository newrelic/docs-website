...
* **Too many active sessions or IP addresses.** If you exceed the [active sessions limit](/docs/accounts/accounts-billing/account-setup/troubleshoot-new-relics-password-email-address-login-problems#active-session-limit), you'll see an `Active session limit reached` message on login. 
