...
* You don't have proper permissions to view that account or that UI page (for example, due to [not being assigned to an account](#account-access) or a specific feature).
