...
<UserJourneyControls
previousStep={{path: "/docs/multi-tenancy/org-creation/", title: "Step 1", body: "Create accounts and  organizations"}}
nextStep={{path: "/docs/multi-tenancy/share-accounts/", title: "Step 3", body: "Share accounts (optional)"}}
/>
