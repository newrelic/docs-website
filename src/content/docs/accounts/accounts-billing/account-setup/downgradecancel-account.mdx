...
<CollapserGroup>
  ...
  >
    ...
    * If you're being billed and want to downgrade: From **[one.newrelic.com](https://one.newrelic.com/all-capabilities)**, click the [account dropdown](/docs/using-new-relic/welcome-new-relic/get-started/glossary#account-dropdown), click **Manage your plan**, and then click **Downgrade account**. Once you are downgraded, you’ll still be able to access New Relic via the login page.
