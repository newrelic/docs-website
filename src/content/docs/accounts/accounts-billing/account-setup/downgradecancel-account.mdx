...
<Callout variant="important">
  You will not be able to cancel the single/last remaining active account in your organization. If you are seeking to do that See [Delete your organization](#delete-org) which would automatically cancel the single/last remaining active account. 
</Callout>

This is only for if you have **more than one account** in your organization, and are not looking to close all of them at this time, you can cancel one or more accounts while keeping your organization.
...
Before the organization delete button will appear, you must have met the below requiremebnts. Some of which may require reaching out to support first:
...
Once you have met the [requirements](#delete-org) for deleting your organization, follow these steps to get to the revealed organization delete button:
