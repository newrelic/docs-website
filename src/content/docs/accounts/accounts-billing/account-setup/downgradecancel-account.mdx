...
<Callout variant="important">
  ...
  * **To close every account in your organization:** See [Delete your organization](#delete-org).
  ...
  To view Parent/Child relationships, you can leverage our Nerdgraph API; see [this related article](https://knowledge.newrelic.com/s/article/Identifying-Parent-Child-Accounts). If you have sub-accounts and are unsure how canceling the parent will affect them, please [file a ticket with our support team](https://docs.newrelic.com/docs/new-relic-solutions/solve-common-issues/find-help-get-support) before proceeding.
</Callout>
