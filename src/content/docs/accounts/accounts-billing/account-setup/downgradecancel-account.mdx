...
* Your organization only has one authentication domain.
  * Customers can delete additional authentication domains, once all users have been removed from them, via the [UI](https://forum.newrelic.com/s/hubtopic/aAXPh0000006Wd7OAE/delete-authentication-domains) or [Nerdgraph](https://forum.newrelic.com/s/hubtopic/aAXPh000000664LOAQ/api-endpoint-to-delete-authentication-domains).
