...
## Delete organization or account(s) [#cancel]

If you are seeking to delete one or more accounts in or organization, but keep your organization and one or more other accounts in it, contact [support](/docs/using-new-relic/welcome-new-relic/get-started/find-help-use-support-portal).
