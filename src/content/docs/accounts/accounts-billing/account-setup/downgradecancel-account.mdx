...
<Callout variant="tip">
  Account deletion isn't available in our NerdGraph API.
</Callout>

When you delete an account:

* Users, groups, and custom roles remain, but access grants that are assigned to an account will lose that connection to the account.
