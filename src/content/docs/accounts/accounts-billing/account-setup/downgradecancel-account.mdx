...
If you're using the Pro or Enterprise edition, and you can cancel one or more accounts while keeping your organization.
...
* In an organization that is using the Pro or Enterprise edition.
...
You can only cancel an account using our NerdGraph API&mdash;not through the UI.
