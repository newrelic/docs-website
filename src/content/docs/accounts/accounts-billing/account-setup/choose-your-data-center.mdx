...
* [Infinite Tracing](/docs/understand-dependencies/distributed-tracing/infinite-tracing/introduction-infinite-tracing)
* APM's [weekly performance reports](/docs/apm/reports/other-performance-analysis/weekly-performance-report)
...
<CollapserGroup>
  <Collapser
    ...
    title="Hierarchy for partnership accounts"
  >
    With [partnership accounts](/docs/new-relic-partnerships/partner-integration-guide/partner-account-maintenance/partnership-accounts-users-subscriptions#partnerships), a new parent account must be created for any data to be host in the EU region. Data is not aggregated beyond the parent account.
  </Collapser>
</CollapserGroup>
