...
## Accounts in two regions [#account-structure]

When you sign up for New Relic, a [New Relic organization](/docs/accounts/accounts-billing/account-structure/new-relic-account-structure/#organization-accounts) is created. This is what contains all your accounts and data. When creating an organization, you must specify the data center region. By default, a New Relic organization can only be in a single data center region. However, some customers on our [original user model](/docs/accounts/original-accounts-billing/original-users-roles/overview-user-models#determine-user-model) or with custom setups (like [partnership account structures](/docs/new-relic-partnerships/partner-integration-guide/partner-account-maintenance/partnership-accounts-users-subscriptions)) can have accounts in both regions. Some notes for customers who have or need data in both regions: 

* If you want accounts in both data center regions, talk to your account representative. 
* If you have accounts or organizations in multiple data center regions, note that ingested data **cannot** be aggregated across regions or displayed in a single usage UI. To view and understand usage-related billing, you'll need to log into your accounts in both regions and look at the [usage UI](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/billing-ui).
* For organizations that have a [parent/child account structure](/docs/accounts/original-accounts-billing/original-users-roles/mastersub-account-structure), (like [partnership structure accounts](/docs/new-relic-partnerships/partner-integration-guide/partner-account-maintenance/partnership-accounts-users-subscriptions#partnerships)), parent accounts can reside in different data center regions, with all child accounts being in the same data center region as their parent account.  
