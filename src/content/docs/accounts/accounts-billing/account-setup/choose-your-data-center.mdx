...
## Accounts in multiple regions [#account-structure]

When you sign up for New Relic, a [New Relic organization](/docs/accounts/accounts-billing/account-structure/new-relic-account-structure/#organization-accounts) is created. This is what contains all your accounts and data. When creating an organization, you must specify the data center region. By default, a New Relic organization can only be in a single region. However, some customers on our original user model or with custom setups can have accounts in different regions. Some notes for customers who have or need multiple data center regions: 

* If you need multiple data center regions, talk to your account representative. 
* If you have accounts or organizations in multiple data center regions, note that billing cannot be aggregated across data center regions. To view and understand usage-related billing, you'll need to log out of 
