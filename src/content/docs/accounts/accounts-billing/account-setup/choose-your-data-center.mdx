...
* If you need New Relic accounts in different data center regions, talk to your account representative. 
* If you have accounts or organizations in multiple data center regions, note that usage and billing **cannot** be aggregated and displayed in a single usage UI. To view and understand usage-related billing, you'll need to log into the accounts in each region and look at the [usage UI](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/billing-ui).
