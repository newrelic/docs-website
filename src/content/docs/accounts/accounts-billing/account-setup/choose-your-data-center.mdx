...
* The usage UI **cannot** show aggregated data ingest from both data center regions. The usage UI will show you only the data for the current account you're in and any of its [child accounts](/docs/accounts/original-accounts-billing/original-users-roles/mastersub-account-structure). 
...
* The count of billable users is aggregated across data center regions. That count is displayed in the top-level account of your entire partnership organization.
