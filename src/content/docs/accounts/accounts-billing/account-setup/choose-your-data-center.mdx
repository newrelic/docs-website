...
* Data ingest **cannot** be aggregated across data center regions. The usage UI will only show you the data for the current account you're in and any of its [child accounts](/docs/accounts/original-accounts-billing/original-users-roles/mastersub-account-structure). 
...
* The count of billable users is aggregated across data center regions. That count is displayed in your top-level account. 
