...
* Social login: You can use Google, Google Workplace, GitHub, and Bitbucket to sign up for and log into New Relic. 
...
## User counting and tracking [#email]

For details about how user records are tracked, see [User tracking](/docs/accounts/accounts-billing/account-setup/multiple-logins-found#user-records).
