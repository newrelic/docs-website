...
>  
If you're having trouble signing in to a social provider, you can still sign in with your email and password after you [reset your password](/docs/accounts/accounts-billing/account-setup/troubleshoot-new-relics-password-email-address-login-problems/#reset-password).
</Collapser>  
</CollapserGroup>
