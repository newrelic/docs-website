...
<CollapserGroup>
  ...
  <figcaption>When you have two or more user records for the same email address, you'll receive a message about this during login.</figcaption>
    ...
    When a user record is marked as "Original" on the login screen, that means that user record is on our [original user model](/docs/accounts/original-accounts-billing/original-users-roles/overview-user-models).
