...
<CollapserGroup>
  ...
  >
A New Relic user record can have a maximum of three concurrent active sessions in use at any given time. In this context, a session represents a unique login to the New Relic platform. If you exceed this limit, you'll see an “Active session limit reached” message upon login and an option to close open sessions.
