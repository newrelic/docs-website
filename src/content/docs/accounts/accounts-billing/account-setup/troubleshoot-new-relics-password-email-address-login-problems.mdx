...
If you have problems with your email address or password when [logging in to New Relic](https://login.newrelic.com/login/), review these troubleshooting tips. (Do not have a New Relic account yet? [Sign up here](https://newrelic.com/signup). It's free!)
...
If you're logged into New Relic but do not see the accounts or data you expect, see [Factors affecting access](/docs/accounts/accounts-billing/general-account-settings/factors-affecting-access-features-data#account-access). 
...
<CollapserGroup>
  ...
  >
    If you're an existing New Relic account user and you have been [added to another account](/docs/accounts/install-new-relic/account-setup/use-multiple-accounts), you do not need to create a new password. Your existing password will work for each account, and you can [switch between accounts](/docs/accounts/install-new-relic/account-setup/use-multiple-accounts#switch-accounts) after logging in.
  </Collapser>
</CollapserGroup>
