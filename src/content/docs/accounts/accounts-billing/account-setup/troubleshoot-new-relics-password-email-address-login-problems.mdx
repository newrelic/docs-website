...
This doc contains troubleshooting tips for some common login and password issues. 

Don't have a New Relic account yet? [Sign up here](https://newrelic.com/signup). It's free!

## Account and data access issues [#account-access]
...
<CollapserGroup>
  <Collapser
    id="azure-first"
    title="Azure Native: Logging in for the first time"
  >
    If you created an Azure Native New Relic account and you're logging into New Relic for the first time, on [New Relic's login page](https://login.newrelic.com/login) click the **Forgot your password** to get your login credentials.

    Make sure to use the same email address you use to sign in to Azure.  
