...
<CollapserGroup>
  ...
  >
A New Relic user can have a maximum of either three concurrent active sessions, or three unique IP addresses in use at any given time. If you exceed this limit, you will see an "Active session limit reached" message upon login, and an option to close open sessions.
  </Collapser>
