...
## Account access or data access [#account-access]
...
## Password-related solutions [#solution]

For general information about New Relic passwords, see [our password docs](/docs/accounts/accounts/account-maintenance/change-passwords-user-preferences). 
...
## Other solutions [#solution-system]

<CollapserGroup>
  <Collapser
    id="azure-login"
    title="Can't log in to Azure Native New Relic account"
  >
    If you created an [Azure Native New Relic](/docs/infrastructure/microsoft-azure-integrations/get-started/azure-native) account and are logging into New Relic for the first time: on [our login page](https://login.newrelic.com/login), click the **Forgot your password** to get your login credentials.

    Be sure to use the same email address used for your Azure login.  
  </Collapser>
  <Collapser
    id="domain-capture"
