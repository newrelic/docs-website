...
<Callout variant="important">
  If you are seeking to be removed from an authentication domain or organization entirely:
  ...
  * Fallback path: Create a [New Relic support case](/docs/new-relic-solutions/solve-common-issues/find-help-get-support/#file-ticket) with explicit consent to remove your user from one or more authentication domains in that organization — deletion is permanent and irreversible.
</Callout>
