...
When a user is created in New Relic, that user is given a user ID. To find a user's ID, you can go to the [<DoNotTranslate>**User management**</DoNotTranslate> UI](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-ui-and-tasks) and look for a specific user's information. 
...
To avoid having to verify your email for each login, click the <DoNotTranslate>**Remember me**</DoNotTranslate> checkbox on the login screen.
