...
When a user is created in New Relic, that user is given a user ID. To find a user's ID, you can go to the [**User management** UI](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-ui-and-tasks) and look for a specific user's information. 
