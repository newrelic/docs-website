...
In the event your license key is accidentally shared and you’re seeing unexpected data, you can work with our [Support team](/docs/using-new-relic/welcome-new-relic/get-started/find-help-use-support-portal/) to change your license key.