...
With **domain capture**, you can register your domain with New Relic. When you do that, users with emails from your domain will automatically be routed into your New Relic organization, where you want them to go. 
