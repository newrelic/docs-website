...
With **domain capture**, you can register your domains with New Relic. When you do that, users that have your email domain will automatically be routed into your New Relic organization, where you want them to go. The larger your organization is, the more useful domain capture will be. 
...
As part of this process, you'll have to complete a DNS verification process. This involves providing a DNS record from your domain registrar and a TXT record from your IT department. If necessary, you'll also configure a host.
...
## Configure user settings [#user-settings]

Once you've completed the DNS verification process, you can configure the following for the users in a domain: 
