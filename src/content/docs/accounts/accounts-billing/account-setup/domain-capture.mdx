...
Sometimes your users will accidentally sign up for New Relic, creating an unnecessary and unwated [New Relic organization](/docs/accounts/accounts-billing/account-structure/new-relic-account-structure). This can result in some confusion and the need to delete the unwanted New Relic organization. 
