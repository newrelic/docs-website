...
* Your billable users ([core users](?) and [full platform users](?)). Basic users are free. Your billable user cost depends on your [pricing edition](https://newrelic.com/pricing) (Standard, Pro, or Enterprise). Standard edition includes one full platform user. 
...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="New Relic One with core users - billing calculation"
  >
 <Callout variant="important">
...
For rules pertaining to downgrading users, see [Downgrade rules](#user-downgrade-rules).
  ...
  <Collapser
    ...
    title="New Relic One without core users - billing calculation"
  >
