...
<Callout variant="tip">
To get estimates of your usage, you can view the [usage UI](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/usage-ui) or [run queries](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/usage-queries-alerts).
</Callout>

## Editions [#editions]

In addition to the billing factors, you'll also need to choose among our four editions: 
...
These are bundles of various administrative features to help you manage your New Relic environment. Editions contain various options, such as the number and types of users, tools to manage users, and the support plan you receive. 
