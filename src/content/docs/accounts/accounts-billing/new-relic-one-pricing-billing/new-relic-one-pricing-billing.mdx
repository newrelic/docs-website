...
For how to find billing and usage information in the UI, see [Billing-related UI](/docs/accounts/accounts-billing/general-account-settings/introduction-account-settings/#new-relic-one-pricing). If you need more detail than the usage UI shows, you can [run queries of your usage data and set up alerts](/docs/accounts/accounts-billing/new-relic-one-pricing-users/queries-alerts).
...
<CollapserGroup>
  ...
  >
If your organization is on the New Relic One pricing model but doesn't have the ability to add core users, you are on a version of pricing referred to as "New Relic One without core users." The following billing calculations and rules apply to your organization:
...
For rules pertaining to downgrading users, see [Downgrade rules](#user-downgrade-rules).
  ...
  >
 <Callout variant="important">
On December 15, 2021, we released a version of New Relic One pricing that added a new user type ([core user](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type)) and changed how billable users are counted. [Learn more about the core users release.](#core-users-pricing)
</Callout>
