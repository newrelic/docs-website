...
If your organization is on [New Relic One pricing](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-changes-pricing-user-model/#pricing-plans), there is a free tier of Incident Intelligence that comes with a certain number of free incident events per month (our [original pricing plan](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-changes-pricing-user-model/#pricing-plans) doesn’t have a free tier). Your usage and cost can be tracked in two places: 
...
Go to the **Sources** UI page (see above) and disconnect all the sources you don’t want. If all sources are removed, no data is sent to Incident Intelligence.
