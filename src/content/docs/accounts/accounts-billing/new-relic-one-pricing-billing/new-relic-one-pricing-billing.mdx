...
We offer a variety of options in our pricing model, to learn more, take a look at the diagram below, its description, and our [Pricing](https://newrelic.com/pricing).
...
We bill for certain user types. Core users and full platform users are billable whereas basic users are free. The cost per full platform user depends on your edition. With our Free edition, you get one free full platform user. 
