...
* Your billable users ([full platform users](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type) and [core users](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/core-users-release)). Basic users are free. Your billable user cost depends on your [pricing edition](https://newrelic.com/pricing) (Standard, Pro, or Enterprise). Standard edition includes one free full platform user. 
...
How frequently you can downgrade a full platform user depends on your [usage plan](#usage-plans): 
