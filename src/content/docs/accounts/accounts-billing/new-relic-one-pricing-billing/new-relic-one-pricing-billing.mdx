...
You can use New Relic free, forever. Here are some details about what you get for free: 
...
* A single account in your New Relic organization ([multiple accounts](/docs/accounts/accounts-billing/account-structure/new-relic-account-structure) requires [Pro or Enterprise edition](#editions)).
