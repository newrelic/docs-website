...
Whether you are thinking about using New Relic or are already sending telemetry to our platform, it's good for you to understand how the business side of New Relic works. We offer a variety of options in these three areas:
...
* **Ingest**: We bill on data ingested, no matter the type, making your billing easy to understand. You can ingest 100 GBs of data per month for free. The price per GB above the free level varies depending on which data option you have: Data or Data Plus. To learn more about how we bill for ingested data, see [Data ingest billing](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/data-ingest-billing/). To keep track of your ingest, you can use our Plan & usage page or [run queries](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/usage-queries-alerts/).
* **Users**: We bill for certain user types. Core users and full platform users are billable, and basic users are free. The cost per full platform user depends on your edition. With our Free edition, you get one free full platform user. To learn more about how we bill for users, see [User billing](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/user-count-billing/).
* **Add-ons**: These are optional features you can purchase separately. For more about this, see [Add-on billing](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/add-on-billing).

## Editions [#editions]

In addition to the billing factors, you'll also need to choose among our four editions: Free, Standard, Pro, and Enterprise. These are bundles of various administrative features to help you manage your New Relic environment. Editions contain various options, such as the number and types of users, tools to manage users, and the support plan you receive. 

When you [sign up for New Relic](https://newrelic.com/signup), you start out on the Free edition. From there, you can upgrade to the other editions, depending on your organization's needs.

### Free edition [#free]

You can use New Relic free, forever. Here are some details about what you get on the Free edition:

* Up to 100 GBs of ingested data per month. (If exceeded, ingest is disabled until the following month. It may take up to 24 hours for ingest to start again.)
...
Here are some details about the Standard edition:
...
* Bill on data ingest and platform usage (New Relic Compute usage). Users are free.
* Unlimited full platform users
* Commitment contracts (pay-as-you-go not available)
...
It includes everything in Pro, plus these features:
