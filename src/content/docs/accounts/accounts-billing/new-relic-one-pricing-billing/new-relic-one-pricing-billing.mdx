...
{/* <img
  title="Diagram showing the pricing, editions, and buying programs"
...
<Collapser id="advance-compute-capacity-unit" title="Advanced Compute">
 Advanced Compute is an add-on to your Data + User or Data + Core Compute plan that provides consumption-based pricing for Intelligent Observability features. This add-on is measured in Advanced Compute Capacity Units (aCCUs). You're billed based on your usage of Advanced CCUs.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td style={{textAlign:"left"}}>eAPM</td>
      <td style={{textAlign:"center"}}>✅</td>
      <td style={{textAlign:"center"}}>✅</td>
      <td style={{textAlign:"center"}}>❌</td>
    </tr>
    ...
    <tr>
      <td style={{textAlign:"left"}}>Ground Truth</td>
      <td style={{textAlign:"center"}}>✅</td>
      <td style={{textAlign:"center"}}>✅</td>
      <td style={{textAlign:"center"}}>✅</td>
    </tr>
    ...
    <tr>
      <td style={{textAlign:"left"}}>Cloud Cost Intelligence</td>
      <td style={{textAlign:"center"}}>❌</td>
      <td style={{textAlign:"center"}}>❌</td>
      <td style={{textAlign:"center"}}>✅</td>
    </tr>
    ...
    <tr>
      <td style={{textAlign:"left"}}>New Relic Lens</td>
      <td style={{textAlign:"center"}}>✅</td>
      <td style={{textAlign:"center"}}>✅</td>
      <td style={{textAlign:"center"}}>❌</td>
    </tr>
    <tr>
      <td style={{textAlign:"left"}}>NRQL Predictions</td>
      <td style={{textAlign:"center"}}>✅</td>
      <td style={{textAlign:"center"}}>✅</td>
      <td style={{textAlign:"center"}}>❌</td>
    </tr>
    ...
    <tr>
      <td style={{textAlign:"left"}}>Autopilot</td>
      <td style={{textAlign:"center"}}>❌</td>
      <td style={{textAlign:"center"}}>❌</td>
      <td style={{textAlign:"center"}}>✅</td>
    </tr>
    <tr>
      <td style={{textAlign:"left"}}>Memories</td>
      <td style={{textAlign:"center"}}>❌</td>
      <td style={{textAlign:"center"}}>❌</td>
      <td style={{textAlign:"center"}}>✅</td>
    </tr>
    ...
    <tr>
      <td style={{textAlign:"left"}}>Transaction 360</td>
      <td style={{textAlign:"center"}}>❌</td>
      <td style={{textAlign:"center"}}>❌</td>
      <td style={{textAlign:"center"}}>✅</td>
    </tr>
    <tr>
      <td style={{textAlign:"left"}}>Security RX Apps</td>
      <td style={{textAlign:"center"}}>❌</td>
      <td style={{textAlign:"center"}}>❌</td>
      <td style={{textAlign:"center"}}>✅</td>
    </tr>
    <tr>
      <td style={{textAlign:"left"}}>Security RX Infra</td>
      <td style={{textAlign:"center"}}>❌</td>
      <td style={{textAlign:"center"}}>❌</td>
      <td style={{textAlign:"center"}}>✅</td>
    </tr>
