...
Here are some additional limits for our free tier that make it different than being on a paid [Standard edition](#editions): 
...
Usually, technical support is not available on [Standard edition](#editions). But for a limited time, [technical support](https://support.newrelic.com/s/) is free for 60 days for Standard edition organizations when you input a credit card in the **Manage your plan** UI section.
