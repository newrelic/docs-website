...
<Callout variant="tip">
A small number of older New Relic customers are on an older pricing model. For docs on that, see [Pricing models](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-pricing-models).
</Callout>

## Not yet a customer? [#start]

If you're not yet a New Relic customer and want an overview of how our pricing works, we recommend checking out our main [pricing page](https://newrelic.com/pricing). If you want more in-depth details about how our pricing works, keep reading. 

## The billing and usage UI [#usage-ui]

If you're a New Relic customer, the best way to understand your billing is to go to the usage UI ([direct link to UI](https://one.newrelic.com/admin-portal/consumption-usage/home)). To find that, go to **[one.newrelic.com](https://one.newrelic.com)**, click the [user menu](/docs/accounts/accounts-billing/general-account-settings/intro-account-settings), then click **Administration**. You'll land on the **Plan & usage** UI page, which shows an overview of your usage.
