...
If you're a New Relic customer, you can use our usage UI to understand your usage and how it could affect your billing. While the numbers are an approximation, you can use this tool to get a picture of your usage. 
