...
Here are more user-related billing details and caveats:
  ...
  * We de-duplicate users based on email address in an organization. If there are multiple users that have the same email address in an organization, those user records count as a single user for billing purposes.
