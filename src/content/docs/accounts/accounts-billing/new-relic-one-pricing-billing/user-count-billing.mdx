...
* **User count based on email address.** For details on this, see [User tracking](/docs/accounts/accounts-billing/account-setup/multiple-logins-found#user-records).
