...
Users in your organization with the same email address are only counted as one user. For more information, see [User management concepts](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts#user-records).
