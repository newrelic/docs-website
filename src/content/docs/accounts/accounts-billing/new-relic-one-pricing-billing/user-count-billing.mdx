...
**Limit on toggling full platform users:** In this context, "toggling" is defined as a full platform user being downgraded, or deleted, in one month and then being added back in a later month as a full platform user. During a New Relic organization's contract year (defined below), you may toggle a full platform user only once. If a full platform user is toggled more than once, they'll be counted as a full platform user for the remainder of the contract year, regardless of user type adjustments.
