...
For [New Relic One pricing](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing), the count of billable users (core users and full platform users) is a billing factor. 
...
Some Pro and Enterprise edition organizations have access to tiered pricing for billable users (core users and full platform users). The prices and tier levels will vary depending on an organization's specific contract. Here's an example of how tiered pricing might work for an organization: 

* Users #1-10: x price
* Users #11-20: y price (lower than x)
* Users #21-30: z price (lower than y)
