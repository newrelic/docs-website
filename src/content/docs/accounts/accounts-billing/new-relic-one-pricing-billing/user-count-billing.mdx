...
Some Pro and Enterprise edition organizations have access to tiered pricing for billable users (full platform users). The prices and tier levels will vary depending on an organization's specific contract. Here's an example of how tiered pricing might work for an organization's full platform users:
