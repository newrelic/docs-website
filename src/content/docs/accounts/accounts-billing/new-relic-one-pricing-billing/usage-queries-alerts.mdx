...
One of the functions you can use to query your data is `bytecountestimate()` (for example, see [this query](#metrics-analysis)). Some important points to know about using it:
...
Here are some technical details about how this function finds and reports data: 
