...
The [usage UI](/docs/accounts/accounts-billing/general-account-settings/introduction-account-settings/#pricing) displays your billable users over time. If you need more detail than the UI provides, you can use the example [NRQL](/docs/query-data/nrql-new-relic-query-language/getting-started/introduction-nrql) queries here. For details about the calculation logic, see [Billable user calculations](/docs/accounts/accounts-billing/new-relic-one-pricing-users/pricing-billing#user-count). 

If you have opted in to our [limited availability release of core users](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/core-users-release), your billable user calculations and NRQL queries are different. For that reason, we have two sections of example NRQL queries: 

* [New Relic One pricing with only basic and full platform users](#primary-user-queries)
* [New Relic One pricing with core users](#core-version-user-queries)

### Primary user calculations [#primary-user-queries]

NRQL queries for determining billable user count:
...
### User calculations - core users version [#primary-user-queries]
