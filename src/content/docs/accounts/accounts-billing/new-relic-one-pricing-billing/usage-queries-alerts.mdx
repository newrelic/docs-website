...
The [NrDailyUsage event](/attribute-dictionary/?event=NrDailyUsage) is the event type that can best help you understand synthetics usage. It's generated once per day. 
