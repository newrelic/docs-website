...
* We recommend using it mainly for querying time ranges under 24 hours, and, if desired, using that to extrapolate. This is because it's a rather expensive query, and because data that passes data retention boundaries won't be found by this function. 
