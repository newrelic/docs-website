...
The [usage UI](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/billing-ui) displays your billable user count over time. If you need more detail than the UI provides, you can use the example NRQL queries below. For details about the calculation logic, see [Billable user calculations](/docs/accounts/accounts-billing/new-relic-one-pricing-users/pricing-billing#user-count). 
