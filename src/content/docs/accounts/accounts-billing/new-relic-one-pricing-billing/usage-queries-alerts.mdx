...
```
FROM NrMTDConsumption SELECT latest(GigabytesIngestedBillable)*<var>PER_GB_COST_OF_DATA</var>
```
...
**Month-to-date costs**
To return the cost for your billable users, you'll have to know your organization's costs per core and full platform user, and run a query multiplying that by the user count.
