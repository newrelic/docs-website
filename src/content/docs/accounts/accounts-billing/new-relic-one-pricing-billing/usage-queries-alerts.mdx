...
### Troubleshoot discrepancy in usage queries [#troubleshoot-usage]

If you've got custom queries that use `NrConsumption`, `NrMTDConsumption` or `NrDailyConsumption`, you may see an increase in data ingest in your custom visualizations. Your ingested data has **not** changed but due to some enhancements to our user model, you may experience some discrepancies in your query results.
