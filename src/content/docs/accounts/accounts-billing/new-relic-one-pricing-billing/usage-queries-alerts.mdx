...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ID of the New Relic account directly responsible for the stored events, as determined from the [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) used.
      </td>
    </tr>
  </tbody>
</table>
