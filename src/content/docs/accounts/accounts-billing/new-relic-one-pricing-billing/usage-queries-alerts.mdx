...
If you've got custom queries or dashboards that use the `NrConsumption`, `NrMTDConsumption` or `NrDailyConsumption`, you may see an increase in data ingest. Your ingested data has **not** changed but due to some enhancements to our user model, you may experience some discrepancies in your query results.
