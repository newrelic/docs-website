...
The Data Plus option gives you a more powerful set of features and data limits, such as higher query limits, access to longer data retention, access to log obfuscation, access to FedRAMP and HIPAA-level security, and more. 
...
For details about what's included with Data Plus and the price, see [the pricing page](https://newrelic.com/pricing), and [this blog post about Data Plus](??). We will continue to add features to Data Plus. 

Have questions about how to upgrade to Data Plus? Talk to your account representative. 
  ...
  >  
Our original data option has a cost of US$0.30 per GB of ingested data. Some customers with previous deals in place have a cost of US$0.25 per GB. 

The original data option lacks the higher data limits and features that come with [Data Plus](#data-plus). 

If you're not sure what your data cost is, see the [Usage UI](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/billing-ui).
...
## How is ingested data calculated? [#usage-calculation]
