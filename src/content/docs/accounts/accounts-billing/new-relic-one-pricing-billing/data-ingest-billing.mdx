...
The Data Plus option gives you a more powerful set of features and limits, at a price point of US$0.50 per GB of ingested data. 

Data Plus requires an organization with both:

* Pro or Enterprise edition
* The [core version of pricing](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/core-users-release) 

For details about what's included with Data Plus, see [the pricing page](https://newrelic.com/pricing), and [this blog post about Data Plus](??). 
