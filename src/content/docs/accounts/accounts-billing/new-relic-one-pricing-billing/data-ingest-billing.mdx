...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Requires core or full platform
      </td>
      <td>
      </td>
    ...
    <tr>
      <td>
         Max [query limit](/docs/query-your-data/nrql-new-relic-query-language/get-started/rate-limits-nrql-queries)
      </td>
    ...
    <tr>
      ...
      <td>
        Achieve security configurations to help you meet your FedRAMP and HIPAA requirements. This is especially helpful if you’re in a highly-regulated sector.
      </td>
    </tr>
