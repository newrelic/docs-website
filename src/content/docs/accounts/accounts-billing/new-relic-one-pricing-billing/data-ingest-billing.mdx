...
To upgrade to Data Plus, go to the [**Data retention** UI](/docs/data-apis/manage-data/manage-data-retention/#adjust-retention) in the data management hub and click **Upgrade retention**. 
  ...
  * To see the **Upgrade retention** button, you need to have [Billing permissions](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts/#admin-settings). If you meet the requirements and still don't see the **Upgrade retention** option, talk to your New Relic account representative.
