...
---
As a New Relic Admin, The <dnt>**Compute Management**</dnt>  page empowers you to see exactly how your organization is using its Compute Consumption Units (CCUs). This guide shows you how to track, analyze, and manage your compute usage.
...
The <dnt>**Core capabilities**</dnt> tab provides the details of your organization's core compute usage, and the <dnt>**Advanced capabilities**</dnt> tab provides the details about your organization's advanced compute usage. Use the following controls to focus on specific entities and see their consumption.
...
Use the chart to visualize the compute usage by the selected entities for the last 30 days. You can group the data by daily, weekly, or monthly consumption. If you are adding it as a widget to a dashboard, we recommend to select <dnt>**Auto**</dnt> grouping, as this allows the system to optimize the grouping to fit the dashboard time range.

For the understanding of your overall consumption, the donut charts give a comprehensive view of the number and percentage of CCUs contributed by capabilities, users, and accounts over one month. These charts are unaffected by any filters you apply.
