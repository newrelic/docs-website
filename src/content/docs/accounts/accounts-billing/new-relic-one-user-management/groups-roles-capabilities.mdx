...
<Callout variant="important">
  This doc applies to users on the [New Relic One user model](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-user-models). For more on this, see [User model changes](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-user-models).
</Callout>
...
Another way to think about the above: a user's user type overrides any role restrictions. For example: a basic user might be assigned a role with wide New Relic access, but their [basic user](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type) restrictions override any role-related permissions.
