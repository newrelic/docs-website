...
<CollapserGroup>
  ...
  >
    Below is a table comparing what basic users and full users can do. In short: basic users have access to our [Telemetry Data Platform](https://newrelic.com/platform) and some [Applied Intelligence](https://newrelic.com/platform) features, while full users have access to that plus [Full-Stack Observability](https://newrelic.com/platform) and all Applied Intelligence features.

    Note that for full users, this is a list of theoretically available permissions: in practice, a full user's permissions may be limited due to being in a group with limited capabilities.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Basic users can’t be assigned to default groups. They can be assigned to custom groups, but note that a basic user always has basic user permissions, no more no less, even when in a custom group. 
      </td>
    </tr>
...
* **Admin** group: has all our [standard roles](#standard-roles). 
...
<figcaption>
Here's a view of the capabilities associated with the [**All product admin** role](#standard-roles).
</figcaption>
