...
## User type: basic users and full platform users [#user-type]
  ...
  <Callout variant="important">
This section is for users on our [New Relic One user model](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-changes-pricing-user-model/#user-models). 
...
Below are details on the two user types. Note that full platform users are billable only if you're on [New Relic One pricing](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-changes-pricing-user-model#pricing-plans).
...
For organizations with New Relic One pricing, learn more about [how full platform users impact billing](/docs/accounts/accounts-billing/new-relic-one-pricing-users/pricing-billing#user-count).
  ...
  Reasons to make someone a full platform user:
    ...
    * They do not need to use our curated experiences and dashboards, but would benefit from the ability to create their own custom queries and charts of data; in other words, they do not need full access to the platform.
    * They do not manage users.
