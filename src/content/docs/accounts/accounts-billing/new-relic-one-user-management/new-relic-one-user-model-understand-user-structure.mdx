...
<CollapserGroup>
  ...
  >
    Below is a table showing basic user versus full user capabilities. In short: basic users have access to our [Telemetry Data Platform](https://newrelic.com/platform) and some of the [Applied Intelligence](https://newrelic.com/platform) features, while full users have theoretical access (role-related restrictions permitting) to everything, including [Full-Stack Observability](https://newrelic.com/platform) features and all Applied Intelligence features.
