...
For accounts on New Relic One pricing, learn more about [user-related billing calculations](/docs/accounts/accounts-billing/new-relic-one-pricing-users/pricing-billing#user-count).
  ...
  >
  A user's type (basic uesr vs full user) is meant to be a long-term assignment, based on expected New Relic responsibilities. A full user can be downgraded to a basic user [only twice in one year](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing/#user-count). Below are tips for why you'd choose full user versus basic user. 
...
For accounts on New Relic One pricing, learn more about [user-related billing calculations](/docs/accounts/accounts-billing/new-relic-one-pricing-users/pricing-billing#user-count).
  ...
  >
    If you're on the <a href="/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing">New Relic One pricing plan</a>, full users are billable, and there are restrictions around how often a full user can downgrade to be a basic user. For details, see [Calculations](/docs/accounts/accounts-billing/new-relic-one-pricing-users/pricing-billing#user-count). 
