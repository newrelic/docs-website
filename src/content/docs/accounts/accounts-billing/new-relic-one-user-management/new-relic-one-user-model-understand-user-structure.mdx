...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Basic users **cannot** be assigned to default groups. 
        
        They **can** be assigned to custom groups, but a basic user **always** has [basic user](#user-type) abilities, no more no less, no matter what group they've been placed in.
      </td>
    </tr>
...
* **Admin** group: has all our [standard roles](#standard-roles), which give full admin capabilities.
...
<figcaption>
Here's a view of the capabilities associated with the [**All product admin** role](#standard-roles). Note that our list of capabilities changes over time: this screenshot was taken in April 2021. 
</figcaption>
