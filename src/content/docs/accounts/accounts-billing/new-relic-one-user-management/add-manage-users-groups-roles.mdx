...
For users on the [New Relic One user model](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-changes-pricing-user-model/#user-models), to find your user management options: From the [account dropdown](/docs/using-new-relic/welcome-new-relic/get-started/glossary#account-dropdown), select one of these two options: 
...
* A **role** is a set of capabilities. Our default [standard roles](/docs/accounts/accounts-billing/new-relic-one-pricing-users/users-roles#standard-roles) have various capability sets, and you can [create custom roles](/docs/accounts/accounts-billing/new-relic-one-user-management/tutorial-add-new-user-groups-roles-new-relic-one-user-model/#step-2-roles) that have a custom set of capabilities.
...
* Basic users on the [New Relic One user model](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-changes-pricing-user-model/#user-models) can self-serve and immediately upgrade to be billable [full users](/docs/accounts/accounts-billing/new-relic-one-pricing-users/users-roles#user-type). This allows your basic users to better troubleshoot issues in case of an emergency.
...
<CollapserGroup>
  ...
  >
    See our [user management tutorial](/docs/accounts/accounts-billing/new-relic-one-user-management/tutorial-add-new-user-groups-roles-new-relic-one-user-model) for how to create custom roles, groups, and more.
  </Collapser>
