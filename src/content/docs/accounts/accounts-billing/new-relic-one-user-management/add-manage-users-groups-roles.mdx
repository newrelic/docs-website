...
* Before adding users, it can help to plan out how your New Relic organization will be structured. How many accounts will you have? What user groups will get access to what accounts? Will you use our default groups and roles or create your own custom groups and roles? It can help to use a spreadsheet to map out your organization and how you'll enable access grants. 
* For smaller, flatter organizations okay with full internal transparency, you may only need a couple groups. 
* A common configuration for organizations with 20 or more accounts is setting up groups with the more organization-scoped roles (**Organization manager**, **Authentication domain manager**, and **Billing user**) on the primary account, and then on other accounts, setting up groups with the more product-scoped roles (like **All product admin**, **Standard user**, or custom roles). 
