...
* **User management**: Use this to add users, [update user type](#edit-user-type), update group assignments, and approve [user upgrade requests](/docs/accounts/accounts-billing/new-relic-one-user-management/authentication-domains-saml-sso-scim-more/#session-mgmt).
