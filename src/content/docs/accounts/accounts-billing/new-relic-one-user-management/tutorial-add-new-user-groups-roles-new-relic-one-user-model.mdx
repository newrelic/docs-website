...
![New Relic organization and access UI - access grants view](src/images/new-relic-one-user-mgmt.png 'Organization and access UI - access grants view')

<figcaption>
  This is what you might see when you go to the **Organization and access** UI
  and view groups. The default available groups of **Admin** and **User** have
  access grants automatically created that grant users in those groups access to
  the roles associated with those groups and to the initial account those users
  were added in.{' '}
</figcaption>
...
1. From the **Organization and access** UI, click **Group access**. If you don't see that UI, it may be because you're logged in with an [original user model](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-user-models) record, or because you don't have the ability to manage users. For more on such factors, see [Factors affecting access](/docs/accounts/accounts-billing/account-structure/factors-affecting-access-features-data/).
   ![Group access UI](src/images/group-access-ui.png 'Group access UI')
