...
This tutorial will walk you through some in-depth procedures for managing users on the **New Relic One user model**. For short explanations, see [Common user management tasks](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-ui-and-tasks). 
