---
title: 'Access grant tutorial: Give users access to roles and/or accounts (New Relic One user model)'
tags:
  - Accounts
...
Groups are used to group your users and manage what your users can do in New Relic. By creating an access grant, you assign a group access to a specific role on a specific account. 
...
![New Relic organization and access UI - access grants view](./images/organization-access-access-grant.png "Organization and access UI - access grants view")
...
To create a custom role, click **Add new custom role**. Note that there are some hidden capabilities that are not available for adding to a custom role. For details, see [Capabilities](/docs/accounts/accounts-billing/new-relic-one-user-management/new-relic-one-user-model-understand-user-structure#standard-roles). 

To learn more about how roles and groups relate, see [User management concepts](/docs/accounts/accounts-billing/new-relic-one-user-management/add-manage-users-groups-roles/#understand-concepts).
...
To view or manage users: from the [account dropdown](/docs/using-new-relic/welcome-new-relic/get-started/glossary#account-dropdown), click **Administration**, and click **User management**. If you don’t see that option, review the [requirements](#requirements).
