...
For more information about how roles and capabilities work, see [Capabilities](/docs/accounts/accounts-billing/new-relic-one-user-management/new-relic-one-user-model-understand-user-structure#standard-roles). Or check out this NerdByte video.
