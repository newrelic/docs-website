...
Note that groups are <DoNotTranslate>**not**</DoNotTranslate> what restrict a user's New Relic permissions: it's the <DoNotTranslate>**role**</DoNotTranslate> assigned to that group that grant access to the permissions.
