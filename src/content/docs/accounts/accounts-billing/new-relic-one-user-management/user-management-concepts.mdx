...
You can add various <DNT>**Administrative settings**</DNT> to a group, which are roles that are scoped to your organization. Basic users will not be able to use these settings.
