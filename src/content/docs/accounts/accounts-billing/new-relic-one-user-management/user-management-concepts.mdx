...
At New Relic, user <DNT>**groups**</DNT> contain <DNT>**roles**</DNT>, and those roles contain <DNT>**permissions**</DNT>. You grant access through <DNT>**access grants**</DNT>, which explicitly link groups to roles over specific targets. For a New Relic user to access New Relic features, you must place them in a [group](#groups) that has an [access grant](#access-grants) with:
...
* Don't need you to specify additional target resources.
...
* Target one or more specific accounts.
...
* Target one or more specific groups.
