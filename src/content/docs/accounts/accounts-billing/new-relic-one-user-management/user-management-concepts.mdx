...
* A specific [role](#roles) (a role being a set of specific, granular [permissions](/docs/accounts/accounts-billing/new-relic-one-user-management/user-capabilities)).
...
For information on the permissions that roles have and that are available for addition to custom roles, see [Permissions](/docs/accounts/accounts-billing/new-relic-one-user-management/user-capabilities).
...
* A **permission** is an ability to use or edit a specific, granular New Relic feature. For more information, see [Permissions](/docs/accounts/accounts-billing/new-relic-one-user-management/user-capabilities). 
