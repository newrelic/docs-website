---
title: "User permission concepts: groups, roles, and capabilities"
tags:
  - Accounts
  - Accounts and billing
  - New Relic One user management
metaDescription: 'For the New Relic One user model: how user permissions work, including how groups, roles, and capabilities work.'
redirects:
...
To view roles and their capabilities, go to the [**Organization and access** UI](/docs/accounts/accounts-billing/new-relic-one-user-management/add-manage-users-groups-roles/#where) and click **Roles**. Note that the roles UI doesn't show the organization-scoped **Organization manager** or **Authentication domain manager** roles. 
