...
You can add a **Group admin** role to a user group. This role gives the group the ability to add and remove users for one or more groups you select. 

With this feature, you can give selected users the ability to add and remove users while not giving them the more powerful and organization-scoped [authentication domain settings](#admin-settings).
