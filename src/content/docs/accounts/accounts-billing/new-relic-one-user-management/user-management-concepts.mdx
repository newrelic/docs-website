...
When you create or edit a group, you can add **Administration settings** that control access to various organization-scoped capabilities. Basic users cannot be assigned these settings.
