...
A role, whether one of our [standard roles](#standard-roles) or a custom role, is a set of capabilities. To learn what capabilities a role has, go to the [**Access management** UI](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-ui-and-tasks#where) and view a specific role.
