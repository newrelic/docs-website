...
To count the users in a New Relic organization, we do a count of user IDs and then subtract user records that have duplicate email addresses. This is to ensure user records for the same user aren't counted more than once.
