...
* **User type** (basic user, core user, full platform user): This is primarily a billing consideration, based on how much you expect your users to use New Relic. User type should **not** be used to control access: for that you'd use roles. 
* **Role-based access**: We have user **groups**, and those groups contain **roles**, and those roles contain **permissions**. When you assign users to groups, you also choose which account, or accounts, those users have access to. 
