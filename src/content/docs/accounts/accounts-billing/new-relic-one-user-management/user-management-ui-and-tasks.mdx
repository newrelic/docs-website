...
To find your New Relic organization's user management options: From the [account dropdown](/docs/using-new-relic/welcome-new-relic/get-started/glossary#account-dropdown), select **Administration**. Here are the user management-related UI pages you can find there:
...
<CollapserGroup>
  ...
  * Go to the [**User management** UI](#where) and select **Add user**.
  * Go to the [user menu](/docs/accounts/accounts-billing/general-account-settings/intro-account-settings) and click **Invite a teammate**.
