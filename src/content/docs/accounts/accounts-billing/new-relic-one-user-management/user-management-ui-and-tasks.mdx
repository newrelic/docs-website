...
<Callout title="New user model">
  This doc is about managing users who are on our [New Relic One user model](/docs/accounts/original-accounts-billing/original-users-roles/overview-user-models).
</Callout>
...
* **Access management**: Use this UI to create and manage groups, roles, and access grants. Use the authentication domain UI to set up SAML SSO and SCIM provisioning. 
...
* This doc describes how to manage users on the [New Relic One user model](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-user-models).
