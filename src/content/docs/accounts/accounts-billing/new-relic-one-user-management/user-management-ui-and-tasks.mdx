...
* **Invite users:** If you're not an administrator who can add users directly, you can invite your teammates. This requests an admin to review your invite. Pending invites that haven't been reviewed are visible on the **Invitation approval** UI page. When an admin reviews an invited user, they complete the **Add user** workflow and that user is considered added to New Relic.

Other notes about adding users:

* If you have [domain capture](https://docs.newrelic.com/docs/accounts/accounts-billing/account-setup/domain-capture) set up, your users can ask to be added to your organization.
