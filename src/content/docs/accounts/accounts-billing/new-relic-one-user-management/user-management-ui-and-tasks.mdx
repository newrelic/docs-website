...
* <DNT>**Feature control manager**</DNT>: Use this to [activate and manage Intelligent Observability features](/docs/accounts/accounts-billing/new-relic-one-user-management/feature-control-manager) across multiple accounts in your organization.
* <DNT>**Access management**</DNT> ([link to UI](https://one.newrelic.com/admin-portal/organizations/organization-detail)): The primary interface for managing RBAC, organized into four dedicated tabs:
  * <DNT>**Groups**</DNT>: Create and manage user groups, and assign users to groups
