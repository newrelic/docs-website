...
* **Authentication domains** ([link to UI](one.newrelic.com/admin-portal/centralized-admin-user-auto-provisioning/home)): Use this to control how your users are added (from New Relic or from an identity provider), how they log in (manually or via SAML SSO), and more. For details, see [Authentication domains](/docs/accounts/accounts-billing/new-relic-one-user-management/authentication-domains-saml-sso-scim-more).
