...
<CollapserGroup>
  ...
  >
    SAML SSO allows your users to use a single sign-on identity provider to log in to New Relic. SCIM provisioning (also called automated user management) enables you to automatically sync users and groups from your identity provider to New Relic, which is ideal for bulk user management.

    Benefits of SCIM provisioning for bulk user management:
    ...
    * Manage users and groups centrally from your identity provider
    ...
    To set up SAML SSO and/or SCIM provisioning, refer to [Get started with SAML SSO or SCIM](/docs/accounts/accounts-billing/new-relic-one-user-management/introduction-saml-scim). This requires [Pro or Enterprise edition](https://newrelic.com/pricing).
  </Collapser>
