...
* This doc is about managing users on the [New Relic One user model](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-user-models). To learn more, see [User models](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-user-models).
* To avoid configuration conflicts, try to ensure that only one person in your organization is managing users at a time. User management by more than one user at the same time may result in errors. 
