...
* **User management**: Use this to add users, [update user type](#edit-user-type), manage what groups a user is assigned, and approve user upgrade requests.
...
<Callout variant="important">
  If you can't see these UI pages, it may be because you're on our [original user model](/docs/accounts/original-accounts-billing/original-users-roles/users-roles-original-user-model) or because you don't have a [required role](#requirements).
</Callout>
...
* This doc is about managing users on the [New Relic One user model](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-user-models).
* To manage groups, roles, and access grants, your organization must be [Pro or Enterprise](https://newrelic.com/pricing) edition.
