...
* <DoNotTranslate>**Last active**</DoNotTranslate>: The last date a user was logged in to the platform. (This does **not** track use of our APIs that require a <InlinePopover type="userKey" />.) This can be useful for deciding to downgrade a user to a lower user type. 
