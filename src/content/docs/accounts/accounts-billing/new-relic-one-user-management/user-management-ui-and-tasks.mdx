...
For tips on how to use this UI and the **Access management** UI, keep reading. 
...
* **Add users**: Go to the [**User management** UI](#where) and select **Add user**. 
* **Invite users**: Go to the [user menu](/docs/accounts/accounts-billing/general-account-settings/intro-account-settings) and click **Invite a teammate**. Details on inviting users: 
  ...
  * If you don't have that permission, you can email the user an invite, and your admins will then approve or deny the invited user. Invited users who haven't yet been approved are marked as `Pending invite approval` in the user management UI. 
