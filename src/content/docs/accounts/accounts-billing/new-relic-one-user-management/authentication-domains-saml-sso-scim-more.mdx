...
* When you enable this setting, you're prompted to create a custom URL and message that basic users see when they go to New Relic features that are off limits to them. That message will help them understand your specific process for upgrading. 
