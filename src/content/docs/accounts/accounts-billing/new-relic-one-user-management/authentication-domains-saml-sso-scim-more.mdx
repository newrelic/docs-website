...
An **authentication domain** is a grouping of New Relic users governed by the same user management settings, like [how they're provisioned](#source-users) (added and updated) and [how they're authenticated](#authentication) (logged in).
...
In the **Authentication Domain UI**, if you've selected SCIM for your method of provisioning users, you have two options for how your users' [user type](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type) is managed:
