...
<CollapserGroup>
  ...
  >
    ...
    * The ability to [manage how user type upgrade requests are handled](/docs/accounts/accounts-billing/new-relic-one-user-management/authentication-domains-saml-sso-scim-more/#manage-user-type-new-relic). 
  </Collapser>
