...
Before moving your users, you should understand some basic rules of how this works. The rules depend on whether your destination domain has SCIM for its [source of users](#source-users) or has a manual source of users:  
