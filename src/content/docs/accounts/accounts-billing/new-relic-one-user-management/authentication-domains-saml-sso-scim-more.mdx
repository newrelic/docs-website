...
1. If you're using Azure, Okta, or OneLogin, enable the New Relic integration for that service. To do this, see the instructions for your service: 
...
9. Optional. If you're also setting up SCIM provisioning, see [Automated user management](/docs/accounts/accounts/automated-user-management/automated-user-provisioning-single-sign/). 
10. When you're done with SAML, or with SCIM + SAML, you'll need to give your users access to specific roles and accounts. It may help you to read about [how access grants work](/docs/accounts/accounts-billing/new-relic-one-user-management/add-manage-users-groups-roles/#understand-concepts). 
11. Optional: In New Relic’s authentication domain UI, you can adjust [other settings](/docs/accounts/accounts-billing/new-relic-one-user-management/authentication-domains-saml-sso-scim-more/#session-mgmt), like browser session length and user upgrade method. You can adjust these settings at any time.
