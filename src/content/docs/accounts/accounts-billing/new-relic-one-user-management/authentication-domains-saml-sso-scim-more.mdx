...
In the [authentication domain UI](#ui), under **Management**, you can control how your users' [user type](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type) is managed. This includes how the user type can be edited and how  
 are handled. 
...
* The ability to manage how users' upgrade requests are handled. These options include: 
...
* When you enable **Manage user type with SCIM**, the default option is that your users are shown a message explaining that they need to "reach out to your manager or IT department" to access an off-limits feature. 
