...
<Callout variant="important">
  This doc is for managing users on the [New Relic One user model](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-user-models). For managing users on our original user model, see [Original users](/docs/accounts/original-accounts-billing/original-users-roles).
</Callout>
