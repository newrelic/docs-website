...
11. If you've enabled SCIM, you can ignore this step. If you're enabling SAML only, you need to create groups and assign access grants in New Relic. These are what give your users access to New Relic accounts. To learn how to do this:  
...
To verify it's been set up correctly, see if your users can log in to New Relic via your identity provider and ensure they have access to accounts.  
