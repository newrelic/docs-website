...
2. If you **only** want to enable SAML SSO and not SCIM, and if you use Azure, Okta, or OneLogin, follow these instructions for configuring the relevant app:
   ...
   <CollapserGroup>
     ...
     >
       ...
       8. From there, go to the **Sign On** tab. Under **Advanced Sign-on Settings**, you will see **Authentication Domain ID**, you will need to edit this field in step 9 of the general instructions below.  To the right you can click on **View SAML setup instructions**. Under step 7 of these instructions, you can find the URLs required for steps 6 & 7 in the general instructions below.
     </Collapser>
