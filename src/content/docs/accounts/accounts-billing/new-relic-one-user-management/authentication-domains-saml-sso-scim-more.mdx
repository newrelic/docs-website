...
3. Next, you'll go to our authentication domain UI. From the [account dropdown](/docs/using-new-relic/welcome-new-relic/get-started/glossary/#account-dropdown), click **Organization and access**, and then click **Authentication domains**. If you do not already have one, [create a new domain](#ui) to be used for your SAML-authenticating users. 
