...
You can move your users from one authentication domain to another. The domain you're moving users from is referred to as the **source** domain. The domain you're moving users to is referred to as the **destination** domain. 
