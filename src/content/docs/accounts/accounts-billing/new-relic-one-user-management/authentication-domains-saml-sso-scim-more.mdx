...
If you meet the [requirements](#requirements), you can add and manage authentication domains. T
...
Your existing domains will be on the left. Note that most organizations have, at most, two domains: one with the manual, default settings and one for the identity provider-related settings. 
