...
2. [How to add accounts](#xx)
3. [How to set up an authentication domain](#xxx)
4. [How to set up custom roles](#xx)
...
As covered in Step #1, an account is meant to represent a workspace for a department or a project of some sort. It's a useful way to separate your use of New Relic by business-relevant boundaries. An account can have a large variety of data reporting to it; there's nothing preventing even quite large companies from having a single account or just a handful of accounts. It's all really a matter of what your organization's goals are and how useful you find it to create the account boundaries.
