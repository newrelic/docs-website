...
If you're using SCIM provisioning, you should be done at this point because your groups and users are imported from your identity provider and aren't created on New Relic's side. You can move to the [verification step](#verification).
