...
If you're reading this, you likely already have a New Relic organization. When you [sign up for New Relic](https://newrelic.com/signup), a New Relic "organization" is created. The organization structure represents a New Relic customer: it is what contains everything relevant to a customer's use of New Relic: their accounts, their users, and their data.
