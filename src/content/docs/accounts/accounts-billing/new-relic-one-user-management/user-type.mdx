...
<table>
  ...
  <tbody>
    <tr>
      <td>
        Basic users are free. Basic users can set up our observability tools, run queries of your data, use custom, non-quickstart <InlinePopover type="dashboards" />, use some basic alerting features, and more. They **can't** use our curated experiences (for example, our <InlinePopover type="apm" /> UI, browser UI, or mobile UI).
