...
What user type to make a user is mainly a billing-related decision. Core users and full platform users are billable, while basic users are not. It is a matter of how much value an organization expects to get out of a team member's use of New Relic. (For details on billing, see [User billing](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/user-count-billing).)
