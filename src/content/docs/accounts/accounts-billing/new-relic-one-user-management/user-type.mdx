...
## Changing user type [#change-user-type]
...
* The `FullUsers' attribute is used when [querying your full platform user counts](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/usage-queries-alerts). 

## Lacking access to something? [#access]

For questions related to lack of access to New Relic, see [Factors affecting access](/docs/accounts/accounts-billing/general-account-settings/factors-affecting-access-features-data/#account-access). 
