...
* "Capabilities" in this context refers to high-level New Relic features and functionality. 
* User type is how you control user access based on that user's long term responsibilities. The more granular way to control access is using roles. [Learn more about controlling user access.](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts#user-type-groups-relation)
* The capabilities in the table below, like APM and browser monitoring, refer to access to UI experiences. All users, including basic users, are able to query all data in the accounts they have access to, and create and view custom charts. 
