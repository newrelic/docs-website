...
For more detail, see the [capabilities table](#user-type-comparison-table). 
          ...
          <td>
Core users are [available only to some organizations](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/core-users-release). Core users can access more features than basic users but less than full platform users. They have access to some powerful developer-centric features like New Relic CodeStream, our logs UI, and the ability to build New Relic One apps. 
