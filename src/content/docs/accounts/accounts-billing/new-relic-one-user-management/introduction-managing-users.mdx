...
The docs in this section are about managing users on [our newer user model](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-user-models). For original user model docs, see [Original user management](/docs/accounts/original-accounts-billing/original-users-roles).

Our primary user management docs:
