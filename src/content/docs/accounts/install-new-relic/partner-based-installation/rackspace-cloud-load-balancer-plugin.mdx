...
4. Modify the <DoNotTranslate>**config/newrelic_plugin.yml**</DoNotTranslate> with your New Relic [license key](/docs/subscriptions/license-key), Rackspace username and API key, and the region where your load balancer sits. Be sure to use lower case characters for the region name.
