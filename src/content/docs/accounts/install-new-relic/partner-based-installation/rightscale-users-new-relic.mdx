...
3. On your first login, be sure to [change your password](/docs/subscriptions/changing-passwords-and-user-preferences): From the ([user menu](/docs/accounts/accounts-billing/general-account-settings/intro-account-settings) in the New Relic UI, select **User preferences**.
