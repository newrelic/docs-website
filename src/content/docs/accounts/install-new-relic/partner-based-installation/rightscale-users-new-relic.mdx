...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        For use with Tomcat5 and Tomcat6 ServerTemplates. Installs our Java agent and configures it for use with Tomcat with New Relic APM.
      </td>
    </tr>
...
You can either manually enter the [license key](/docs/accounts-partnerships/accounts/account-setup/license-key) or create a credential for it.

## View New Relic APM monitoring data [#view]
