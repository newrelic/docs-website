...
![screen run script.png](src/images/screen-run-script.png 'screen run script.png')

<figcaption>
  Add the **APP New Relic RPM for PHP** RightScript as a **boot script** to the
  ServerTemplate that is being used to run your PHP application servers. This
  will automatically deploy the New Relic agent when a new server is launched
...
![screen nr rightscale applist.png](src/images/screen-nr-rightscale-applist.png 'screen nr rightscale applist.png')
