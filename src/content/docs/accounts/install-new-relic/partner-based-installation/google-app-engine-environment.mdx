...
<table>
  <thead>
    <tr>
      <th style={{ width: "150px" }}>
        <DoNotTranslate>**APM agent**</DoNotTranslate>
      </th>

      <th>
        <DoNotTranslate>**GAE flexible requirements**</DoNotTranslate>
      </th>
    </tr>
  </thead>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Our <DoNotTranslate>Ruby</DoNotTranslate> agent can be deployed to a prebuilt Docker image using GAE's [native support](#native-mode) or to a <DoNotTranslate>Docker</DoNotTranslate>> image with a custom runtime. For more information, see the [GAE flexible installation example for the <DoNotTranslate>Ruby</DoNotTranslate>> agent](/docs/agents/ruby-agent/installation/install-new-relic-ruby-agent-gae-flexible-environment).
      </td>
    </tr>
  </tbody>
</table>
