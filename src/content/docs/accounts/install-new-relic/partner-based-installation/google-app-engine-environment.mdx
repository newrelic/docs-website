...
You can use New Relic to monitor applications that reside in a Google App Engine flexible environment through the [APM agents](#gae-agent), and you can view data about your Google App Engine services through the [Google App Engine integration](#gae-integration) for our <InlinePopover type="infrastructure" />.
