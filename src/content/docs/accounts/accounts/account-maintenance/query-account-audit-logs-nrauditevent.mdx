...
* Login and logout events
 - These events are only written to the parent/reporting account ID of your New Relic organization.
...
<Collapser
  ...
  >
    These events are only written to the parent/reporting account ID of your New Relic organization. To query users who logged into your organization, use a query similar to the following:
