...
Audit logging is different than configuring [audit mode](/docs/agents/manage-apm-agents/configuration/log-audit-all-data-your-new-relic-agent-transmits) for an APM agent. APM audit mode records information about all data being transmitted from your app.
