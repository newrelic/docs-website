...
* Dashboard modifications, including creation, deletion, updates, and [public sharing](/docs/query-your-data/explore-query-data/dashboards/share-charts-dashboards-externally/#audit-trail-dashboard)
