...
Note that after you enable SCIM, there are necessary [next steps](#next-steps) to do, including downgrading some users to basic users, and granting user groups access to New Relic accounts. 

## Tutorial [#tutorial]

If you want to see more specific instructions on how to use this API, see the [SCIM API tutorial](/docs/accounts/accounts/automated-user-management/tutorial-manage-users-groups-scim).
...
## New Relic user type (basic vs full) schema [#user-type]

An optional [schema extension](https://datatracker.ietf.org/doc/html/rfc7643#section-3.3) for New Relic-specific user attributes. Currently this provides control only over a user's [user type](/docs/accounts/accounts-billing/new-relic-one-user-management/new-relic-one-user-model-understand-user-structure/#user-type) (basic user versus full user). For a tutorial on how to use this, see the [SCIM API tutorial](/docs/accounts/accounts/automated-user-management/tutorial-manage-users-groups-scim/#manage-user-type).
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        The user's type: 'full user' or 'basic user'.
      </td>
    </tr>
  </tbody>
</table>
...
### Downgrade users [#downgrade]

When your users are provisioned in New Relic, you should then be able to see them in the [**User management** UI](/docs/accounts/accounts-billing/new-relic-one-user-management/add-manage-users-groups-roles/#where). 

By default, users provisioned via your identity provider start out as [full users](/docs/accounts/accounts-billing/new-relic-one-user-management/new-relic-one-user-model-understand-user-structure#user-type). If your organization is on [New Relic One pricing](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing), these users are billable. To convert users to free [basic users](/docs/accounts/accounts-billing/new-relic-one-user-management/new-relic-one-user-model-understand-user-structure#user-type), you have two options: 
