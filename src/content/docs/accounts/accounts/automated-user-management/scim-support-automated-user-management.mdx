...
## New Relic User Schema Extension

Optional [schema extension](https://datatracker.ietf.org/doc/html/rfc7643#section-3.3) for New Relic-specifc user attributes.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        The User's type, e.g., 'Full User' or 'Basic User'
      </td>
    </tr>
  </tbody>
</table>
