...
Authentication is done using a bearer token. This bearer token is specific to your [New Relic authentication domain](/docs/accounts/accounts-billing/new-relic-one-user-management/authentication-domains-saml-sso-scim-more).
