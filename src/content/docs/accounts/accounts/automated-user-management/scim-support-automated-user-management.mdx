...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <DoNotTranslate>**Required.**</DoNotTranslate> Name of the group.
      </td>
    </tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <DoNotTranslate>**Required.**</DoNotTranslate> Unique identifier for the user within New Relic’s system. Use the user’s email address.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <DoNotTranslate>**Required.**</DoNotTranslate> Email address of the user.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <DoNotTranslate>**Required.**</DoNotTranslate> Boolean indicating whether or not the user should be active or inactive within New Relic.
      </td>
    </tr>
...
When your users are provisioned in New Relic, you can see them in the [<DoNotTranslate>**User management**</DoNotTranslate> UI](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-ui-and-tasks#where).

If you're adding users to New Relic via SCIM but <DoNotTranslate>**not**</DoNotTranslate> [managing their user type via SCIM](#user-type), they start out as [basic users](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type). To upgrade users, you have two options:
