...
8. If you're using **Roles** to define your New Relic groups, from the user's application page, click the proper role(s) for the user and then click **Save User**.
