...
Decide what type of groups to send along with your users to New Relic. If your organization is using <DoNotTranslate>Active Directory</DoNotTranslate>> or LDAP, you might choose to use security groups to define your users permissions at New Relic. Another reasonable group choice is OneLogin role.
