...
<CollapserGroup>
  ...
  >
    ...
    ![Screen capture showing the OneLogin Rules detail page about conditions and actions.](src/images/onelogin_rules_conditions_actions.png "onelogin_rules_conditions_actions.png")
...
![Screen capture showing the OneLogin Provisioning page.](src/images/onelogin_provisioning_form.png 'onelogin_provisioning_form.png')
...
2. Under **Require admin approval before this action is performed**, uncheck these options:
   ...
   <Callout variant="tip">
     If you do not uncheck these options, SCIM provisioning requests will not be
     sent until an administrator approves them.
   </Callout>
...
1. Click **Groups** field.
   ...
   ![Screenshot of the OneLogin Parameter form showing which fields to configure.](src/images/onelogin_parameter_form_general.png 'onelogin_parameter_form_general.png')

2. Check **Include in User Provisioning**.

   ![Screenshot showing the OneLogin Parameter details page.](src/images/onelogin_parameter_form_specific.png 'onelogin_parameter_form_specific.png')
