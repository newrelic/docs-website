...
* Once you set an [authentication domain](/docs/accounts/accounts-billing/new-relic-one-user-management/authentication-domains-saml-sso-scim-more) to use SCIM, you **must** use SCIM to manage your groups and users for that authentication domain. You can't manage them via the New Relic UI. 
