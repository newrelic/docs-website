...
* Permissions-related requirements:
  ...
  * You must have a [user type](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type) of core user or full platform user and be in a group with the [**Authentication domain** administration setting](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts#admin-settings).
