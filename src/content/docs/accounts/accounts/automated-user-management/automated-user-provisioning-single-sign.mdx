...
* You must have a [user type](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type) of core user or full platform user and be in a group with the organization scoped [<DNT>**Authentication domain manager**</DNT> role](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts#admin-settings).
...
4. If you don't use one of the above services, you'll need to use [SCIM API](/docs/accounts/accounts/automated-user-management/scim-support-automated-user-management) to integrate with your identity provider service. See [the SCIM API tutorial](/docs/accounts/accounts/automated-user-management/tutorial-manage-users-groups-scim) for all the steps involved.
