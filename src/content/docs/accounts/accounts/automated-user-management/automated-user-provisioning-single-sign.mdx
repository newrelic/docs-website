...
5. Optional: Whether you use one of the dedicated apps (Azure AD, Okta, OneLogin) or not, you have the option to manage user type (basic user versus full user) via our SCIM API. For more, see [Manage user type](/docs/accounts/accounts/automated-user-management/tutorial-manage-users-groups-scim#manage-user-type). 
