...
3. If you use Azure AD, Okta, or OneLogin, use the applicable guide: [Azure AD](https://docs.newrelic.com/docs/azure-scimsso-application-configuration) \| [Okta](https://docs.newrelic.com/docs/okta-scimsso-application-configuration) \| [OneLogin](https://docs.newrelic.com/docs/onelogin-scimsso-application-configuration). 
4. If you **don't** use one of the above services, you'll need to:
  ...
  * [Configure SAML SSO](https://docs.newrelic.com/docs/accounts/accounts-billing/new-relic-one-user-management/authentication-domains-saml-sso-scim-more/#saml).
