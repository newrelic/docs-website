...
* [User model](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type)-related requirements:
  * This feature requires you to be on our [New Relic One user model](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type) and creates users on that model. If you're on our [original user model](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type) (or otherwise can't seem to implement this feature), talk to your New Relic account representative.
