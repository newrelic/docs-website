---
title: 'SCIM API tutorial (New Relic One user model)'
tags:
  - Accounts
  - Accounts and billing
  - Automated user management
  - New Relic One user management
metaDescription: 'New Relic automated user management (AUM) tutorial: managing groups and users with the SCIM API.'
---
...
Once your a [user's type](/docs/accounts/accounts-billing/new-relic-one-user-management/new-relic-one-user-model-understand-user-structure/#user-type) (basic user or full user) can only be viewed and modified in the [User management UI](/docs/accounts/accounts-billing/new-relic-one-user-management/add-manage-users-groups-roles/#where). If you'd like to use SCIM instead, update your authentication domain configuration to [Delegate control of user type](#TODO) to your identity provider or custom application.
