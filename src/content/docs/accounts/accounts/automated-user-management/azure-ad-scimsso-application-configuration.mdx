...
Once these steps are completed, you should be able to see your users in New Relic by going to the [User management UI](/docs/accounts/accounts-billing/new-relic-one-user-management/add-manage-users-groups-roles/#where). Now that your users are present in New Relic, you must grant them access to specific roles on specific accounts. If this is not done, your users do not yet have access to New Relic. To learn how to do this, see: 
