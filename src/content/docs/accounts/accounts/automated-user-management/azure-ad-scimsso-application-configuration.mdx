...
## Step 5. Downgrade some users to basic [#downgrade]
...
* Use the [User management UI](/docs/accounts/accounts-billing/new-relic-one-user-management/add-manage-users-groups-roles/#where) to set users to basic. 
