---
title: Microsoft Entra ID formerly Azure AD SCIM /SSO application configuration
tags:
  - Accounts
...
Next, you'll set up Azure's New Relic SAML/SCIM app. Microsoft Entra ID formerly Azure AD provides an application gallery, which includes various integrations for Microsoft Entra ID, including the ones that New Relic offers. To set this up:
