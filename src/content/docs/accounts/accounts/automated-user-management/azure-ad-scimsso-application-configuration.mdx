...
## Step 8. Optional: Manage user type (full versus basic) with our SCIM API [#manage-user-type]

For more on this, see [Manage user type](/docs/accounts/accounts/automated-user-management/tutorial-manage-users-groups-scim#manage-user-type).
