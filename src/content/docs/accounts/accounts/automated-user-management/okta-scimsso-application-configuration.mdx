...
To get to the New Relic authentication domain UI: From **[one.newrelic.com](https://one.newrelic.com/all-capabilities)**, click the [account dropdown](/docs/using-new-relic/welcome-new-relic/get-started/glossary/#account-dropdown), click **Access management**, and then click **Authentication domains**.
