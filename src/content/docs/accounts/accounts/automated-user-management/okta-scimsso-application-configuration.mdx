...
2. Next, you'll configure Okta to be able to send a new attribute `nrUserType`. Steps: 
  ...
  ![Adding new attribute in Okta app](./images/new-relic-okta-app-add-user-type.png "Adding new attribute in Okta app")
...
3. Next, you'll configure your Okta user profile to have this field. Steps: 
  ...
  ![Set Okta user profile to have new attribute](./images/okta-side-define-users-type.png "Set Okta user profile to have new attribute")
