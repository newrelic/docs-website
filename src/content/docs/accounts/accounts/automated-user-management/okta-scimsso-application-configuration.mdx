...
Next, you'll set up Okta's New Relic SCIM/SSO application:
...
2. From the **Push groups** form, open the pick list on the desired group's button under the **Push gtatus** column.
