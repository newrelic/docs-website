...
metaDescription: >-
  For APM (host-based) subscription usage: calculations, UI
...
Some previous APM agents may miscount containers as hosts, which may lead to over-reporting of host-based usage.
