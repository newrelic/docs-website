...
With the **Metrics and events** data explorer you can:
...
* Understand how [NRQL](/docs/query-data/nrql-new-relic-query-language/getting-started/introduction-nrql) works: data explorer shows how queries are built while navigating available data.
...
To explore and query data types besides metrics and events, see: 
