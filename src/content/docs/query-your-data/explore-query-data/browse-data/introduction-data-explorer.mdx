...
With the **Metrics and events** explorer you can navigate all your data visually, without needing to know how to write [NRQL-format queries](/docs/query-your-data/nrql-new-relic-query-language/get-started/introduction-nrql-new-relics-query-language). 
...
With the **Metrics and events** data explorer you can access [events](/docs/using-new-relic/data/understand-data/new-relic-data-types#event-data) and [metrics](/docs/using-new-relic/data/understand-data/new-relic-data-types#metrics) data in a quick, intuitive way. You can then select **Dimensions** to facet by specific dimensions of that data. 
...
The **Metrics and events** explorer gives you access to these data types: 
...
To explore and query other types of data, see:

* [Logs](/docs/logs/ui-data/use-logs-ui)
* [Traces](/docs/distributed-tracing/ui-data/query-distributed-trace-data/)

## Explore your data [#explore-data]

To access the data explorer, go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities)** and click **Metrics and events**. 
...
<CollapserGroup>
  ...
  >
    ...
    * [`FROM`](/docs/query-your-data/nrql-new-relic-query-language/get-started/nrql-syntax-clauses-functions/#sel-from) (events only): the event selected in the first block.
  ...
  >
    You can see the full query, which is composed by the fields above and the [time range selected](#explore-data) with the time picker. Clicking on the query takes you to the query builder, which lets you edit the NRQL query. 
  </Collapser>
