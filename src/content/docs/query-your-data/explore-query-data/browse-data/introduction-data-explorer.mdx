...
With the **Metrics and events** data explorer you can navigate all your data visually, without needing to know how to write [NRQL-format queries](/docs/query-your-data/nrql-new-relic-query-language/get-started/introduction-nrql-new-relics-query-language). 
...
With the **Metrics and events** data explorer you can access all data stored in the New Relic database (NRDB) in a quick, intuitive way. You can then select **Dimensions** to facet by specific dimensions of that data. 
...
In the context of the **Metrics and events** data explorer, `events` is used in a general way to refer to all objects stored in the New Relic database. The data explorer lets you explore: 
