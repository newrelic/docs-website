...
In the context of the **Metrics and events** data explorer, `event` refers to all objects stored in the New Relic database (NRDB). The data explorer lets you explore: 
