...
Navigate all your data visually using <DoNotTranslate>**Metrics and events**</DoNotTranslate> and without needing to know how to write [NRQL-format queries](/docs/query-your-data/nrql-new-relic-query-language/get-started/introduction-nrql-new-relics-query-language).
...
With <DoNotTranslate>**Metrics and events**</DoNotTranslate> you can access all data stored in the New Relic database (NRDB) in a quick, intuitive way. You can then select <DoNotTranslate>**Dimensions**</DoNotTranslate> to facet by specific dimensions of that data. 
...
In the context of <DoNotTranslate>**Metrics and events**</DoNotTranslate>, `event` refers to all objects stored in the New Relic database (NRDB). Metrics and events let you explore: 
...
To access the data explorer, go to <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com) > All capabilities > Metrics and events**</DoNotTranslate>. 
...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Metrics & events**</DoNotTranslate>: Metrics and events view.
</figcaption>
...
3. Use the blocks on the left to browse the available data and build your search. You can only select one element per block. Blocks are searchable.
   ...
   <CollapserGroup>
       ...
       <table>
         <tbody>
           <tr>
             ...
             <td>
               Lists all available events for the selected account. By default, the sort of events is by <DoNotTranslate>**Name**</DoNotTranslate>.
             </td>
           </tr>
           ...
           <tr>
             ...
             <td>
               ...
               * By default, the sort of attributes is by <DoNotTranslate>**Name**</DoNotTranslate>.
               ...
               * Select the [function](/docs/query-data/nrql-new-relic-query-language/getting-started/nrql-syntax-clauses-functions#functions) that you want to plot. By default each attribute is set to the function [<DoNotTranslate>**Average**</DoNotTranslate>](/docs/query-data/nrql-new-relic-query-language/getting-started/nrql-syntax-clauses-functions#func-average).
             </td>
           </tr>
           ...
           <tr>
             ...
             <td>
               ...
               * By default, the sort of dimensions is by <DoNotTranslate>**Name**</DoNotTranslate>.
     ...
     >
       To explore [APM timeslice data](/docs/query-your-data/nrql-new-relic-query-language/nrql-query-tutorials/query-apm-metric-timeslice-data-nrql), <DoNotTranslate>**select AppID, AppName, or EntityGuid as dimensions**</DoNotTranslate> (or group by those dimensions). Otherwise, you'll get aggregated data for all entities.
       ...
       <table>
         <tbody>
           <tr>
             ...
             <td>
               Lists all the metrics available for the selected account. By default, the sort of metrics is by <DoNotTranslate>**Name**</DoNotTranslate>.
             </td>
           </tr>
...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="Chart area"
  >
    By default, you see the data on a <DoNotTranslate>**line chart**</DoNotTranslate>. Change the view easily to <DoNotTranslate>**Area chart**</DoNotTranslate>, <DoNotTranslate>**Pie chart**</DoNotTranslate>, and <DoNotTranslate>**Bar chart**</DoNotTranslate> using the chart picker. You can also choose to see your results' <DoNotTranslate>**raw data**</DoNotTranslate> as a table, or as in <DoNotTranslate>**JSON format**</DoNotTranslate>.
  ...
  >
    You can get the chart as an image, share it as a link, or add it to a dashboard using the <DoNotTranslate>**Options**</DoNotTranslate> menu on the top right corner.
...
## Visualize your custom metric after creating it [#visualize-metric]
  ...
  Follow these steps to visualize your custom metric through the metrics explorer:
    ...
    1. Access the data explorer, go to <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com) > All capabilities > Metrics and events**</DoNotTranslate>.

    2. Choose your entity.

    3. Click <DoNotTranslate>**See timeslice metrics for `your entity`**</DoNotTranslate> link.
...
<CollapserGroup>
  ...
  >
    <DoNotTranslate>**I've just connected new instrumentation and want to see if new data is available.**</DoNotTranslate>
  ...
  >
    <DoNotTranslate>**I changed a custom event/metric and need to check if this change has been successful.**</DoNotTranslate>
  ...
  >
    <DoNotTranslate>**I know there's something off with an event/metric from an alert or dashboard. I need to know the root cause about the event/metric/attribute behavior.**</DoNotTranslate>
