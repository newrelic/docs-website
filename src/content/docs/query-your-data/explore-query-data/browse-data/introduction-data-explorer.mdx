...
<CollapserGroup>
  ...
  This feature is currently provided as part of a preview program pursuant to our [pre-release policies](/docs/licenses/license-information/referenced-policies/new-relic-pre-release-policy).
    ...
    If you have opted for On-demand forecasting, you can add a forecast to line and area charts, which uses historical data to project future trends. 
    Select <DNT>**Make a forecast**</DNT> from the <DNT>**Options**</DNT> menu on the chart. 
    The forecast appears in dotted lines with the default range set to 20% of the query window, highlighted in gray.
   
    You can further refine your query for the forecast by adjusting the range as per your needs. For more information, see [On-demand forecasting](/docs/query-your-data/explore-query-data/use-charts/on-demand-forecasting/#customize-forecasting-range).
...
<CollapserGroup>
  ...
  >
   ...
   <Collapser
    className="freq-link"
    id="on-demand-forecasting"
    title="See forecast of a line or area chart (available with the public preview of [On-demand forecasting](/docs/query-your-data/explore-query-data/use-charts/on-demand-forecasting))"
  >
