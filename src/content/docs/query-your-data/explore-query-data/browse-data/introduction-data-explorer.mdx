...
* Metrics: 
  ...
  * [Metric timeslice data](/docs/data-apis/understand-data/new-relic-data-types/#timeslice-data): this data type is reported by <InlinePopup type="apm" /> agents, mobile agents, and the browser agent. To explore this type of data, you must choose an entity monitored by one of those agents, and then you'll see those options. 
