...
- At the top of the page, click the **Query your data** icon.
  ...
  ![NR One transition: explore data](src/images/explore-data-icon.png 'NR One transition: explore data')
...
![Data explorer view](src/images/data_explorer_updated.png 'data_explorer_updated.png')
...
<Callout variant="important">
  We use the metric system (including [metric SI
  prefixes](https://www.nist.gov/pml/weights-and-measures/metric-si-prefixes))
  to display our units.
</Callout>
...
<figcaption>Refine your exploration, or share your chart</figcaption>
