...
<Callout variant="tip">
  The NRQL console is not visible by default, but you can turn it on (and back off) in your user preferences clicking the avatar at the top right corner of the UI.
</Callout>
