...
1. Find the NRQL console at the bottom of the UI **anywhere in New Relic One**. It's omnipresent!
    * You can also access the NRQL console from the [**...** chart action menu](/docs/query-your-data/explore-query-data/dashboards/manage-your-dashboard/#dash-manage-charts) in any widget from [your dashboards](/docs/query-your-data/explore-query-data/dashboards/introduction-dashboards/).
