...
The [query builder](https://one.newrelic.com/data-exploration/query-builder) has two modes: NRQL mode and PromQL mode. You can learn about how to form NRQL queries in the [NRQL docs](/docs/insights/nrql-new-relic-query-language/using-nrql/introduction-nrql). The following table gives some additional tips for using the query builder.
