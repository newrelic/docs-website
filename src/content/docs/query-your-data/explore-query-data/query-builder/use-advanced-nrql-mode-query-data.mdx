...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The account dropdown lets you choose which accounts to run your query against:

        * By default, select a single account from the dropdown list.
        * To query across multiple accounts, turn on the <DNT>**Multi-account (up to 30)**</DNT> switch in the dropdown, then select up to 30 accounts to include in your query.
      </td>
    </tr>
  </tbody>
</table>
