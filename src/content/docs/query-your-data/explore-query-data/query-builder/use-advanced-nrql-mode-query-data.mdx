...
To see what your basic mode data specification looks like as an NRQL query, click the Advanced (NRQL) ![inline-advanced-nrql.png](src/images/inline-advanced-nrql_0.png 'inline-advanced-nrql.png') link from the basic page.

![querybuilder05.png](src/images/querybuilder05.png 'querybuilder05.png')

<figcaption>Example of an advanced (NRQL) query.</figcaption>
