...
To see what your basic mode data specification looks like as an NRQL query, click the Advanced (NRQL) <img
  src={inlineAdvancedNrql0}
  title="inline-advanced-nrql.png"
  alt="inline-advanced-nrql.png"
/> link from the basic page.
