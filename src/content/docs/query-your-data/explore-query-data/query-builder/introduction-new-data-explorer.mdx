...
* **Create a prediction on a line or area chart (available with the public preview of [NRQL Predictions](/docs/query-your-data/explore-query-data/use-charts/nrql-predictions))**: Use <DNT>**Predict trend**</DNT> from the **Options** menu to get a predicted trend.
