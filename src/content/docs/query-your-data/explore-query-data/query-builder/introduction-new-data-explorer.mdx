...
* See the forecast of your data trend (available with the public preview of [On-demand forecasting](/docs/query-your-data/explore-query-data/use-charts/on-demand-forecasting)).
...
6. **Make a forecast for a line or area chart (available with the public preview of [On-demand forecasting](/docs/query-your-data/explore-query-data/use-charts/on-demand-forecasting))**: Use <DNT>**Make a forecast**</DNT> from the **Options** menu to get a forecasted trend.
