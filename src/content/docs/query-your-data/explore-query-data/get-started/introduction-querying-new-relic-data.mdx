...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Create a [custom dashboard](/docs/query-your-data/explore-query-data/dashboards/introduction-dashboards) from the data explorer or the query builder.
      </td>
    </tr>
    <tr>
      <td>
...
* For most of our data, you can use the [data explorer](/docs/query-your-data/explore-query-data/data-explorer/introduction-data-explorer), an intuitive data navigator for exploring data and creating visualizations. You can also use the [query builder](/docs/chart-builder/use-chart-builder/choose-data/use-advanced-nrql-mode-specify-data) to refine your query.
