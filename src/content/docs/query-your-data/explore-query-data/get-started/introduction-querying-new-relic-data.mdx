...
* [Logs query](/docs/logs/new-relic-logs/ui-data/query-syntax-logs): a specialized UI for querying [log management data](/docs/logs/new-relic-logs/get-started/introduction-new-relic-logs) in New Relic.
