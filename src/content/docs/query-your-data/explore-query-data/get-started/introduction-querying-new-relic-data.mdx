...
[Our platform](/docs/new-relic-one/use-new-relic-one/get-started/introduction-new-relic-one) offers several experiences that don't require knowledge of NRQL or any query language. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Metrics & events** to start exploring your data: 
