...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Use [our NerdGraph API](/docs/apis/nerdgraph/examples/nerdgraph-nrql-tutorial), which has more features, such as historical data export.  
...
By default, the query builder queries data from your current account. You can also select up to 30 accounts from the account dropdown to run a query across them.
...
When you need programmatic options, or want to unlock more querying power, you can use APIs to query your New Relic data. Our NerdGraph API gives you more powerful options not available in the UI, such as exporting longer-term historical data sets. For more information, see [Intro to NerdGraph](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph/#tutorials).
