...
* Learn more about [blocks in notebook](https://notebooks-for-data--docs-website-netlify.netlify.app/docs/query-your-data/explore-query-data/notebooks/add-queries-to-notebooks/)
