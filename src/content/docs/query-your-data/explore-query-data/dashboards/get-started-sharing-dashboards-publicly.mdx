...
<Callout variant="important">
  Both chart sharing and dashboard sharing are available to all users. On the [<DNT>Data + User</DNT>](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing/) pricing model, there's no extra cost. On the [<DNT>Data + Core Compute</DNT>](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing/) pricing model, only dashboard sharing consumes [Core CCUs](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing/#core-compute-capacity-unit). For details, see the [Pricing](/docs/query-your-data/explore-query-data/dashboards/share-dashboards-publicly/#public-dashboard-pricing) section.
</Callout>
