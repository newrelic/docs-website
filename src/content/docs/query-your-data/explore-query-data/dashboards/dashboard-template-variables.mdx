...
## Include/exclude variables [#include-variable]

The **Include variable** toggle allows you to set a desired value and include or exclude that value in your dashboards  (see the [template variables](/docs/query-your-data/explore-query-data/dashboards/dashboard-template-variables/#create-variables) section).
