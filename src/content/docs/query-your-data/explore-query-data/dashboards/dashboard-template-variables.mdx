...
For custom dashboards, you can use <DNT>**template variables**</DNT> to dynamically filter charts and other widgets. Template variables make your dashboards more useful and help you more easily create dashboards that you can reuse for different use cases. Now, you can also use variables to condition the value of other variables. For more information, refer to [nested variables](/docs/query-your-data/explore-query-data/dashboards/nested-variables).
