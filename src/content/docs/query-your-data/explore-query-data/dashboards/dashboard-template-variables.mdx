...
You can hide template variables from the variables bar in View mode while they continue to function normally behind the scenes. In Edit mode, hidden variables display with a visibility-off icon, so dashboard editors can identify and manage them.
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Optional. Enable this toggle to hide the variable from the variables bar in View mode. The variable continues to function normally behind the scenes. In Edit mode, hidden variables display with a visibility-off icon. For more information, see [Show and hide variables](#variable-visibility).
          </td>
        </tr>
      </tbody>
    </table>
