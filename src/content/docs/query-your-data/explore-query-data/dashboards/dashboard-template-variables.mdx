...
>
  ...
  * WIDGET 2:
  ...
  Instead of creating two separate widgets, you can create one widget with a variable that has the **Identifier** output format. Then, you can use it after a `FROM` clause to query by different data types.
