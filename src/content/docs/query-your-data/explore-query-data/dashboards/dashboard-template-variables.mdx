...
<CollapserGroup>
  ...
  >
    ...
    ```
    The titles you've added will be shown in the variable’s dropdown. This won’t affect the logic for your variable/widgets at all.
    <img
      title="Screenshot showing how to create a widget query"
      alt="Screenshot showing how to create a widget query"
      src="/images/template_variable_list_based_feature.webp"
  />
  </Collapser>
</CollapserGroup>
