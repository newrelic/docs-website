...
The template variables feature is currently in limited release and available to some customers. If you have access to this feature, you'll see **Add variable** at the top of a dashboard. 
