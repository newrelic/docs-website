...
For custom dashboards, you can use <DoNotTranslate>**template variables**</DoNotTranslate> to dynamically filter charts and other widgets. Template variables help make your dashboards more useful, and help you more easily create dashboards you can reuse for different use cases. 
...
1. From a new dashboard without variables, click the edit <Icon name="fe-edit-2"/> button, and then, click <DoNotTranslate>**+ Add variable**</DoNotTranslate> button located at the top-left corner. Once you've finished adding variables, click <DoNotTranslate>**Done editing**</DoNotTranslate>.

    If the dashboard includes widgets, click the <DoNotTranslate>**+ Add variable**</DoNotTranslate> button.
...
2. Complete the <DoNotTranslate>**Add variable**</DoNotTranslate> workflow. Below are some rules and tips for each of the fields.
...
* <DoNotTranslate>**Query**</DoNotTranslate>: You can write a query that will return a dynamic list of options used in the dropdown menu. For example, the following query would return a dynamic list of `country` values:
...
* <DoNotTranslate>**Text field**</DoNotTranslate>: Instead of a dropdown of values to choose from, this allows dashboard users to filter for whatever text they input. 
    ...
    <tr>
      ...
      <td>
        This lets you change how the data generated by the variable is handled in the query. The selected option you choose here is related to the query you're going to add later in the widget. The <DoNotTranslate>**default**</DoNotTranslate> option is string because this is the more common option used in the majority of queries. You can change the <DoNotTranslate>**default**</DoNotTranslate> option to one of these:
          * <DoNotTranslate>**String**</DoNotTranslate>: Use this for non-numeric text values. 
          * <DoNotTranslate>**Number**</DoNotTranslate>: Use this for numeric values.
          * <DoNotTranslate>**Identifier**</DoNotTranslate>: Use this when you want to substitute parts of the query, like event names or facet names.
...
1. From your dashboard click <DoNotTranslate>**+ Add widget**</DoNotTranslate> button located at the top-right corner.
...
3. We choose <DoNotTranslate>**Add a chart**</DoNotTranslate> option.

4. Add your query and click <DoNotTranslate>**Run**</DoNotTranslate>. 
...
This results in the values for the last 30 minutes. When you set the time picker value to <DoNotTranslate>**Default**</DoNotTranslate> and your query has a `SINCE` clause, the latest value will be used to run the query.
...
>
  ...
  Sometimes you have queries that apply the same rules to different types of data. Here are examples three widgets that would be identical except for the data type:
  ...
  * WIDGET 3: 
  ...
  Instead of creating three separate widgets, you can create one widget with a variable that has the **identifier** output format. Then, you can use it after a `FROM` clause to query by different data types.

  For example, you might create a `{{dataType}}` variable of type **list** with three possible values: `data_type_1`, `data_type_2`, `data_type_3`. You'd set the output format to **identifier**.
