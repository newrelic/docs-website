    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Optional. Only present when "multi-select" is enabled. This toggles whether to show an Apply/Cancel button at the bottom of the variable’s dropdown filter. When shown, changes to the values are only applied after you click the button.
          </td>
        </tr>
