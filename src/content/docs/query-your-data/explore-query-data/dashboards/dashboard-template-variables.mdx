...
1. From a dashboard without variables, click the edit <Icon name="fe-edit-2"/> button, and then, click **Add variable**. 
If the dashboard has already variables, click the **+** icon to the right of the variables.

<img
  width="40%;"
  title="Dashboard without variables"
  alt="Dashboard without variables"
...
For an example of what a template variable for `country` values would look like this:
