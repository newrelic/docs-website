...
When using NerdGraph, it helps to understand that our dashboards are [entities](https://docs.newrelic.com/docs/new-relic-one/use-new-relic-one/core-concepts/what-entity-new-relic) that report data from other entities, such as monitored apps, hosts and services.
...
| Limit  | Value |
|---|---|
| Maximum number of widgets in a dashboard page     | 40 |
...
| Maximum layout height of a widget             | 8|
