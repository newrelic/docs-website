...
<CollapserGroup>
  ...
  >
    Clone any dashboard by clicking the **Clone dashboard** button that appears when you hover over any dashboard row in the index. You can clone any dashboard regardless of your [permission levels](#dashboards-permissions).
