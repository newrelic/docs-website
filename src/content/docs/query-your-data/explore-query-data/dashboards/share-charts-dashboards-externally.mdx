...
<Callout variant="important">While the chart sharing capability is available to both Core Compute and and Advanced Compute customers, the dashboard sharing feature is available only to Advanced Compute customers. </Callout>
...
4. Run any of the following queries to view the audit trails:
  ...
  ### Limitations
    ...
    * The <DNT>**TV mode**</DNT> for viewing a live dashboard is limited to 72 hours. To continue further, you need to refresh it in-between.
    * If you are sharing a dashboard having widgets that use template variables, facet linking, custom visualizations, or log tables, these widgets don't display any information in the shared view of the dashboard.
    * If the dashboard permission setting is <DNT>**Private**</DNT>, you can't share the dashboard publicly. To verify it, go to <DNT>**[one.newrelic.com > Dashboards](https://one.newrelic.com/dashboards)**</DNT> > Your dashboard > <Icon name="fe-more-horizontal"/> icon > <DNT>**Settings > Permissions**</DNT>.
