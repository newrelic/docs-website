...
* **Session-based access**: After accessing the dashboard, the session remains active for 120 hours. If they try to access the dashboard after this period, or the browser session expires, they need to re-enter the password. If there is a password reset, the session expires immediately, and they need to re-enter the new password.
