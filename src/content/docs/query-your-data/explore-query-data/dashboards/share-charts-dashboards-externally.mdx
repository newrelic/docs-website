...
<Callout variant="important">While the chart sharing feature is available to **Pro**, **Enterprise**, and **Core Compute** customers, the dashboard sharing feature is available only to **Advanced Compute** customers. To learn more, refer to **[Advanced Compute](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/add-on-billing)**.</Callout>
