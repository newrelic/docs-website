...
<Callout variant="important">While the chart sharing feature is available to **Pro**, **Enterprise**, and **Core Compute** customers, the dashboard sharing feature is available only to **[Advanced Compute](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/add-on-billing)** customers. To learn more about the associated costs and management practices for the dashboard sharing feature, refer to the [Pricing](#public-dashboard-pricing) section.</Callout>
