...
6. Save your changes. The URL is now created. You can copy the public link from the dialog.
8. If the password protection toggle is on, you must click <DNT>**Copy password**</DNT> and save it securely. This password is available only once and can't be retrieved later. You need to share the password with the URL to allow external users to access the dashboard. To manage the password, refer to the [password management best practices](#password-management).
...
4. Use the <DNT>**Protect with a password**</DNT> toggle to enable or disable password protection.
  ...
  * If you enable password protection, ensure to copy the generated password and save it securely. This password is available only once and can't be retrieved later. You need to share the password with the URL to allow external users to access the dashboard.
5. For a password-protected URL, you can change the password by clicking <DNT>**Reset password**</DNT>. When you reset the password, ensure to copy the new password and save it securely.
