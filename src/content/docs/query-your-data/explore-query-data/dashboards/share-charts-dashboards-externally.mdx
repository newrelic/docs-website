...
<Callout variant="important">While the chart sharing feature is available to **Pro**, **Enterprise**, and **Core Compute** customers, the dashboard sharing feature is available only to **Advanced Compute** customers. To learn more, refer to **[Advanced Compute](https://newrelic.com/pricing/compute#pricing_plan-compute)**.</Callout>
