...
<CollapserGroup>
<Collapser id="create-dashboard-url" title="Create a link with/without password protection">
...
<Collapser id="update-live-url" title="Manage link expiration">
...
<Collapser id="view-dashboard-links" title="View shared links in New Relic platform">
...
<Collapser id="access-dashboard-as-a-user" title="Access dashboards externally">
...
<Collapser id="revoke-dashboard-url" title="Revoke link">
...
4. Run any of the following queries to view the audit trails:
  ...
  <CollapserGroup>
    <Collapser
      id="url-last-hour"
      title="Get details of the links created or revoked in the last hour."
    >
    ...
    <Collapser
      ...
      title="Get details of the links created in the last hour."
    >
    ...
    <Collapser
      ...
      title="Get details of the links revoked in the last hour."
    >
    ...
    <Collapser
      ...
      title="Get details of the links created by a specific user in the last hour."
    >
    ...
    <Collapser
      id="url-in-account"
      title="Get all the links created in an account in the last hour."
    >
    ...
    <Collapser
      id="url-count"
      title="Get the list of dashboards from which the links were generated in a specific time period."
    >
    ...
    <Collapser
      id="operations-count"
      title="Get the list of operations performed with the links in a specific time period."
    >
  ...
  ### Best practices for password management [#best-practices-password-management]
  ...
  <CollapserGroup>
    ...
    * [**Link expiration management**](/docs/query-your-data/explore-query-data/dashboards/share-charts-dashboards-externally/#update-live-url): Set expiration times for links to ensure they are only visible for a certain period, reducing potential overuse.
    * **Widget management**:
