...
Ensure you have the necessary [permissions](/docs/query-your-data/explore-query-data/dashboards/prerequisites-to-share-dashboards-charts/#permissions-to-custom-role), and you are the owner of the dashboard, to update the live URL duration.
1. Go to <DNT>**[one.newrelic.com > Dashboards](https://one.newrelic.com/dashboards)**</DNT>.
