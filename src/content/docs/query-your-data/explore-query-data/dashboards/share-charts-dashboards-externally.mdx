...
<Callout variant="important">While the chart sharing feature is available to both Core Compute and and Advanced Compute customers, the dashboard sharing feature is available only to Advanced Compute customers. </Callout>
