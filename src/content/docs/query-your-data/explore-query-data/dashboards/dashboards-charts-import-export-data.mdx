...
import dashboardMenupng from 'images/20210628_dashboard_menu.png'

import chartActionMenupng from 'images/20210628_chart_menu.png'
...
* A chart shared with a link auto updates to show latest values, and includes a time picker to choose a time period to show adjusted value.
