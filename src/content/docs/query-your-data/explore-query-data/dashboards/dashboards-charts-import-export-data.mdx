---
title: Content management for dashboards and charts
tags:
  - Query your data
...
You have the following options to import, share and export dashboards, or add and share charts (or other content) in a dashboard.

## Import and export dashboards [#dashboards]
...
From any dashboard, you can share it by:

![Dashboard menu.png](./images/20210628_dashboard_menu.png "dashboard_menu.png")

* Copying the dashboard's permalink.
* Copying your dashboard **as JSON** and adding it to the clipboard by clicking on the **&lt;/&gt;** icon on the right corner.
* Exporting your dashboard **as a pdf file** clicking the <Icon name="fe-download"/>icon.
...
Finally, from any chart, use the chart action menu on the upper right corner to **copy or duplicate** the chart.
