...
* Export doesn't apply the same formatting logic as the UI in all cases that may result in small discrepancies (i.e -1.1E-17 will render as 0 in the UI but not in the CSV)
