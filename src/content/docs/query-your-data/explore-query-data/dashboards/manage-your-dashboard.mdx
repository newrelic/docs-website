...
### Issues with new content [#chart-error-messages]

When adding new content you may come across these issues:
...
<table>
  ...
  <tbody>
      <tr>
          ...
          <td>
            There was an unexpected error while fetching the data. Try again in a few minutes.
          </td>
        </tr>
        <tr>
          <td>
