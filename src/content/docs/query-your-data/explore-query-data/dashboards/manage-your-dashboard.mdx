...
The Markdown editor contains a **Markdown** pane, where you enter your content, as well as a **Preview** pane, where you can view it. For more information about Markdown syntax options, see the [GitHub's Markdown guide](https://docs.github.com/en/get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github/basic-writing-and-formatting-syntax).
