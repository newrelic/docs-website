...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Dashboards**</DoNotTranslate>: This is an example of a dashboard with multiple pages, represented by the
...
<Callout variant="important">
  ...
  <DoNotTranslate>**Read only**</DoNotTranslate> permissions to the dashboard.
</Callout>
