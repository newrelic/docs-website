...
<CollapserGroup>
  ...
  >
    You can duplicate your dashboard clicking the duplicate icon regardless of your permission levels. The dashboard is automatically copied and the duplicate is added to the [index](/docs/query-your-data/explore-query-data/dashboards/introduction-dashboards/#get-started). The duplicate has [**Public - Read and write** permissions](/docs/query-your-data/explore-query-data/dashboards/introduction-dashboards/#dashboards-permissions). Access the new, duplicated dashboard by clicking on the message that pops up on your screen.
...
Learn more about what you can do with the Markdown widget in the short video below: 
<Video
  id="_dLwy7xskBk"
  type="youtube"
/>
...
1. From a new or existing dashboard, enter edit mode by selecting the <Icon name="fe-edit-2"/> icon.
2. Add a new page:
...
If you accidentally deleted your dashboard, you can quickly restore it with NerdGraph. To learn how, read the [Support Forum post](https://discuss.newrelic.com/t/relic-solution-using-nerdgraph-to-recover-a-deleted-dashboard/142855), or watch this short video (2:13 minutes).
