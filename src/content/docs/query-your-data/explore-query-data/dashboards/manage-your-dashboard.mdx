...
<Collapser
  ...
  Inside a dasboard, click the '...' or 'metadata' button to access the **metadata** widget. There you can see the dashboard's entity GUID, account ID, account name, and manage all the tags added to the dashboard.
