...
>
    You can customize the color of your charts for a specific series in area, bar, line, pie, and stacked bar chats.
  
   To customize the color per series:
    1. Run your query.
    1. Open the colors menu in the customizations UI.
    1. Select the plus <Icon name="fe-plus"/> icon.
    1. Select the serie you want to change the color.
  ...
  <figcaption>
  **Query builder**: This is an example of how to change the Login Service series in a different color.
  </figcaption>
