...
<CollapserGroup>
  ...
  >
    ...
    2. Open an existing dashboard. On the top-right corner, click the <DNT>**...**</DNT>.
    3. Select <DNT>**Copy JSON to Clipboard**</DNT> or <DNT>**[Manage JSON](/docs/query-your-data/explore-query-data/dashboards/manage-your-dashboard/#manage-json)**</DNT>.
  ...
  >
    ...
    1. Go to <DNT>**[one.newrelic.com > Dashboards](https://one.newrelic.com/dashboards)**</DNT>.
    2. Open an existing dashboard’s JSON by clicking the <DNT>**...**</DNT>, then selecting <DNT>**Manage JSON**</DNT>.
