...
<Collapser
  ...
  >
    You can import your dashboard as JSON code and add it to the clipboard. Click the <Icon name="fe-more-horizontal"/> icon on the right corner and select **Copy JSON to clipboard**. See how to [import a dahsboard](/docs/query-your-data/explore-query-data/dashboards/introduction-dashboards/#dashboards-import).
  </Collapser>
  <Collapser
  ...
  Inside a dasboard, click the <Icon name="fe-tag"/> icon to access the **See metadata and manage tags** modal. There you can see the dashboard's entity GUID, account ID, account name, and manage all the tags added to the dashboard.
...
/>
  ...
  From the dashboard index, there is the [**See metadata & tags**](/docs/query-your-data/explore-query-data/dashboards/introduction-dashboards/#dashboards-metadata) option to see the metadata and tags of a dashboard.
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Dashboards**: This is an example of a dashboard with multiple pages, represented by the tabs at the top of the dashboard. You can add pages to dashboards, copy existing pages, and drag and drop the page tabs to new positions.
</figcaption>
