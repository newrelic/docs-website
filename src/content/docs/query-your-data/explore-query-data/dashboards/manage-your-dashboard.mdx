...
redirects:
  ...
  - /docs/accounts-partnerships/education/getting-started-new-relic/standard-dashboard-feature
...
<Callout variant="tip">
  After adding a widget, you can customize it by adding a clickable link to the widget title or a tooltip description. For customization options, see [Widget links and descriptions](/docs/query-your-data/explore-query-data/use-charts/use-your-charts#widget-link-description).
</Callout>
