...
To minimize disruption, customers who want to enable this functionality can create custom roles and assign them to their users before the GA date of April 30. The capabilities will activate on the GA date.
