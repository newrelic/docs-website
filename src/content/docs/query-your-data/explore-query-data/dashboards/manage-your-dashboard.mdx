...
<Callout variant="tip">
  Click the <Icon name="fe-tag"/> icon to access the **See metadata and manage tags** modal. There you can see the dashboard's entity GUID, account ID, account name, and manage all the tags added to the dashboard.
</Callout>
...
<CollapserGroup>
  ...
  To configure TV mode, from a dashboard, click the <Icon name="fe-more-horizontal"/> icon on the right corner and select **Settings**. Under the TV mode section, there're these options:
      ...
      * **Cycle to the next page every 20 seconds**. If the dashboard includes several pages, you'll see this option.
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Dashboards**: Chart action menu of a widget on the Dashboard page.
</figcaption>
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Dashboards**: Time picker on the Dashboard page.
</figcaption>
...
If you delete your dashboard, you can quickly restore it with NerdGraph. To learn how, read the [Explorers Hub post](https://discuss.newrelic.com/t/relic-solution-using-nerdgraph-to-recover-a-deleted-dashboard/142855), or watch this short video (2:14 minutes).
