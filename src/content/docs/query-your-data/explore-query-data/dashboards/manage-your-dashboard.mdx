...
<Collapser
  ...
  >
    You can customize the color of your charts for a specific series in:
    ...
    * Stacked bar charts
    ...
    To customize the color in a serie:
    * Run your query.
    * Open the colors menu in the customizations UI.
    * Select the plus <Icon name="fe-plus"/> icon.
    * Select the serie you want to change the color.
    * Select the desired color.
    
    <img
      title="dashboards-color-per-series.png"
      alt="Learn how to change the color of a serie.png"
...
<Collapser
    id="units-customization"
    title="Units customization"
  >
    You can customize the unit on your Y axis and in each of your series. It is available in:
    ...
    * Use the plus <Icon name="fe-plus"/> icon to add a per series customization.
    * Select the series that needs another unit.
    * Select the unit.
        
    <img
      title="dashboards-units-customization.png"
      alt="Learn how to customize your unit on your Y axis.png"
