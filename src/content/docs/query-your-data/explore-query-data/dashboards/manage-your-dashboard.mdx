...
<CollapserGroup>
  ...
  >
    ...
    2. Open an existing dashboard’s JSON by clicking the <DNT>**...**</DNT>, then selecting <DNT>**Copy JSON to Clipboard**</DNT> or <DNT>**[Manage JSON](/docs/query-your-data/explore-query-data/dashboards/manage-your-dashboard/#manage-json)**</DNT>.
    3. Go back to the <DNT>**Dashboards**</DNT> page.
    4. In the top-right corner, click <DNT>**Import dashboard**</DNT>.
    5. Paste your JSON code. The new and improved JSON editor includes errors and syntax checking so you can identify errors before importing the dashboard. 
