...
Once you've selected a dasboard, click the <Icon name="fe-tag"/> icon to access the **See metadata and manage tags** modal. There you can see the dashboard's entity GUID, account ID, account name, and manage all the tags added to the dashboard.
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Dashboards**: See metadata and manage tags.
</figcaption>
...
<Collapser
  ...
  >
    You can edit a dashboard if you've [permissions](/docs/query-your-data/explore-query-data/dashboards/introduction-dashboards/#dashboards-permissions) to do it.
  ...
  To configure TV mode, from a dashboard, click the <Icon name="fe-more-horizontal"/> icon on the right corner and select **Settings**. Under the TV mode section, there're these options:
      ...
      * **Show time picker**. See this option to change the [time range](#dash-time-picker) of the data on display.
  ...
  >
    You can copy your dashboard as JSON and add it to the clipboard. Click the <Icon name="fe-more-horizontal"/> icon on the right corner and select **Copy JSON to clipboard**.
  </Collapser>
  ...
  >
    You can export your dashboard as a pdf file. Click the <Icon name="fe-more-horizontal"/> icon on the right corner and select **Export dashboard as PDF**.
  </Collapser>
...
1. Click the <Icon name="fe-more-horizontal"/> icon on the right corner of the chart and select **Edit**.
