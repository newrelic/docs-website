...
The Public API Performance dashboard is a dashboard supported by our [Global Performance data sets](/docs/query-your-data/new-relic-one-dashboards/global-performance-dataset/new-relic-global-performance-data-sets). It's an out-of-the-box dashboard included as part of your New Relic account. It provides both actionable general insights about the performance of public APIs and an opportunity for new customers to test-drive our dashboarding capabilities before adding their own data.
...
1. Enable the dashboard from **[one.newrelic.com](https://one.newrelic.com/all-capabilities)**:
   * New customers: The dashboard is enabled by default and added to the favorites list. You can find it on the **Dashboards** UI page. 
   * If not yet enabled: click **Add your data**, then search for 'Public API performance', and then complete the steps to add it. 
