...
1. Go to **[one.newrelic.com](https://one.newrelic.com) > Apps > Custom Visualizations**. (If you don't see the **Custom Visualizations** tile, use the search to locate it.)
