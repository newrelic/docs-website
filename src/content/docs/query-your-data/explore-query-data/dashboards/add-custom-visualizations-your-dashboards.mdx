...
1. From [New Relic](https://one.newrelic.com), in the top right, click the **Apps** button, and then on the **Apps** page, click **Custom Visualizations**. Hint: if you do not see the **Custom Visualizations** tile, use the search to locate it.
