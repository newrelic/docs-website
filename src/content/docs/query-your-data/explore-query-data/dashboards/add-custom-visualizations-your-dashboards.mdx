...
![screenshot of custom visualization](src/images/dashboard_viz.png 'Custom visualization')

<figcaption>
  This visualization shows the number of people in each city who are viewing New
  Relic within an organization. The visualization was created using the New
  Relic One CLI and [Treemap from the Recharts
  library](https://bit.dev/recharts/recharts/treemap?example=5ced12842b76410014e81f11).
</figcaption>
