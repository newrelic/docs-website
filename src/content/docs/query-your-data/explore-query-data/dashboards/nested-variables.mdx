...
<Callout variant="tip">
  To reduce clutter in the variables bar, hide parent or supporting variables that don't require user input. Hidden variables continue to function normally. For more information, see [Show and hide variables](/docs/query-your-data/explore-query-data/dashboards/dashboard-template-variables/#variable-visibility).
</Callout>
