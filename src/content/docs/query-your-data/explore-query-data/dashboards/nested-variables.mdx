...
<Callout variant="tip">
  If nested variables add clutter to your dashboard's variables bar, you can hide parent or supporting variables that don't need viewer interaction. Hidden variables continue to function normally behind the scenes. For more information, see [Show and hide variables](/docs/query-your-data/explore-query-data/dashboards/dashboard-template-variables/#variable-visibility).
</Callout>
