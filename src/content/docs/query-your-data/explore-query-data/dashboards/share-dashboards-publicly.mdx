...
<DocTiles>
  <DocTile title="Get started with public sharing" path="/docs/query-your-data/explore-query-data/dashboards/get-started-sharing-dashboards-publicly">
    Overview of public sharing for dashboards and charts, with availability and pricing details.
  </DocTile>
