...
When external users access a shared dashboard, the page renders with the same data and visualizations as the original, with the following interactive capabilities:
...
<Callout variant="important">
  The dashboard sharing feature is available only to **Pro** and **Enterprise** customers with [Advanced Compute](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/add-on-billing) enabled. To set up public dashboard sharing for the first time, see [Get started with public dashboards](/docs/query-your-data/explore-query-data/dashboards/get-started-sharing-dashboards-publicly).
</Callout>
...
To share a dashboard publicly, ensure the following setup is in place. Refer to [Security and access management for external sharing](/docs/query-your-data/explore-query-data/dashboards/prerequisites-to-share-dashboards-charts) for setup details:

- The `Live URL control` permission is enabled for all accounts sourcing the dashboard.
- A custom role and permissions are configured for you to share dashboards.
- The accounts sourcing the dashboard have grants for your role to share data externally.
...
To update the live duration of the shared dashboard, you must have the necessary [permissions](/docs/query-your-data/explore-query-data/dashboards/prerequisites-to-share-dashboards-charts/#permissions-to-custom-role) and be the owner of the dashboard.
...
To enable or disable password protection for the live dashboard URL, you must have the necessary [permissions](/docs/query-your-data/explore-query-data/dashboards/prerequisites-to-share-dashboards-charts/#permissions-to-custom-role) and be the owner of the dashboard.
...
If you lose the password for the live dashboard URL, you can reset it. For resetting, you must have the necessary [permissions](/docs/query-your-data/explore-query-data/dashboards/prerequisites-to-share-dashboards-charts/#permissions-to-custom-role) and be the owner of the dashboard.
...
You can access shared dashboard names hyperlinked with their live URLs, all in one place in New Relic. Depending on your [permissions](/docs/query-your-data/explore-query-data/dashboards/prerequisites-to-share-dashboards-charts/#permissions-to-custom-role), you can view either the URLs you created or those created by all users in the account.
...
<CollapserGroup>
  ...
  - [**Access control**](/docs/query-your-data/explore-query-data/dashboards/prerequisites-to-share-dashboards-charts): Manage who can create, edit, or delete URLs at both the account and user-role levels. This helps control and prevent users from having excessive access to these capabilities.
...
<DocTiles>
  <DocTile title="Get started with public dashboards" path="/docs/query-your-data/explore-query-data/dashboards/get-started-sharing-dashboards-publicly">
    Step-by-step setup guide covering Advanced Compute, policy enablement, and access management.
  </DocTile>
