...
<img
  title="An area chart type example that shows the percentage of errors by host over time."
  alt="A screenshot of an area chart type example that shows the percentage of errors by host over time."
...
The bar chart compares values across the categories or series returned by your query. It's the default visualization for non-time-series queries.

<img
  title="A bar chart comparing values across categories."
  alt="A screenshot of a bar chart comparing counts across several categories, with the y-axis scaled to the data range."
  src="/images/queries-nrql_screenshot-crop_bar-chart.webp"
/>
...
<table>
  <tbody>
    <tr>
      ...
      <td>
        Compare totals across categories or series with a configurable y-axis. The bar chart is the default visualization for non-time-series queries.
      </td>
    </tr>
...
<img
  title="A simplified bar chart ranking series against the largest one."
  alt="A screenshot of a simplified bar chart where the largest series fills the full bar width and the other series appear relative to it."
  src="/images/queries-nrql_screenshot-crop_simplified-bar-chart.webp"
/>
...
<table>
    ...
    <tbody>
      <tr>
        ...
        <td>
        Select the display mode for the billboard chart. You can choose **Auto**, **Value and label**, **Value only**, **Label only**, or **None**.
        </td>
      </tr>
      <tr>
        <td>
...
<img
  title="An example bullet chart that shows a count of unique sessions against a limit."
  alt="A screenshot of an example bullet chart that shows a count of unique sessions against a limit."
...
<img
  title="An example funnel chart that shows visitors progressing from landing to browse to cart to purchase."
  alt="A screenshot of an example funnel chart that shows visitors progressing through the landing, browse, cart, and purchase steps on a shopping site."
...
<img
  title="A dashboard of gauge charts."
  alt="A screenshot of a dashboard of gauge charts, each filling an arc to show where a single value falls within its range, with green, yellow, and red threshold colors."
  src="/images/queries-nrql_screenshot_gauge-chart.webp"
/>
...
<img
  title="An example histogram showing the distribution of transaction durations."
  alt="A screenshot of an example histogram showing the distribution of transaction durations."
