...
<img
  title="A bar chart example that compares transaction counts across applications."
  alt="A screenshot of a bar chart example that compares transaction counts across applications."
