...
```
    ...
    ![A screenshot of a billboard chart example showing a total session count.](./images/202111_billboards.png "A billboard chart example showing a total session count.")
    ...
    If your service is working correctly, the billboard is green. You can set **Warning** and **Critical** thresholds on billboards, which will turn the chart's full box yellow or red. The threshold fields are on the right side of the chart edit pane, highlighted in yellow and red respectively.
