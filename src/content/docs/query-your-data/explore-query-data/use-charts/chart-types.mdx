...
<CollapserGroup>
  ...
  >
    ...
    In advanced mode, you can use facet to add up to five attributes, separated by commas. Use the [`TIMESERIES`](/docs/insights/nrql-new-relic-query-language/nrql-reference/nrql-syntax-components-functions#sel-timeseries) function when you use a `FACET` in an NRQL query.
...
```
    ...
    ![A screenshot of a billboard chart example showing a total session count.](./images/chart_billboard.png "A billboard chart example showing a total session count.")
