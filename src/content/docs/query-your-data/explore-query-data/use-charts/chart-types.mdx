...
<CollapserGroup>
  ...
  >
    ...
    <Callout title="Preview">
      The following line chart feature is currently in preview.
    </Callout>

    For line charts, you can try out an an upcoming feature that connects charts with other New Relic experiences. This will help you dive deeper into the data and uncover root causes to problems you're trying to solve. When you click on points in a chart that you're interested in, you'll see options to view entity-specific information.
    ...
    4. Click on the entity that interests you, and then in the flyout menu, click one of the links for that entity (for this preview, you'll see **Entity summary** and **Logs** links).
    ...
    As you try out this preview feature, keep the following in mind:
