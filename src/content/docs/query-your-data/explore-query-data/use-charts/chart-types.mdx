...
4. Click on the entity that interests you, and then in the flyout menu, click one of the links for that entity (you'll see <DNT>**Entity summary**</DNT> and <DNT>**Logs**</DNT> links).
