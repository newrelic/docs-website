...
```
    ...
    ![A screenshot of a billboard chart example showing a total session count.](./images/202111_billboards2.png "A billboard chart example showing a total session count.")
