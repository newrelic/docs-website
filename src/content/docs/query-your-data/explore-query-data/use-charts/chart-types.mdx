...
<CollapserGroup>
  ...
  >
    ...
    ![A screenshot of an area chart type example that shows average CPU usage.](src/images/chart_area.png "An area chart type example that shows average CPU usage.")
  ...
  >
    ...
    ![A screenshot of a bar chart example that shows a comparison of browser usage.](src/images/chart_bar.png "A bar chart example that shows a comparison of browser usage.")
...
```
    ...
    **Thresholds**
    ...
    ![A screenshot of a billboard chart.](src/images/billboards_color.png "A billboard chart.")
...
```
    ...
    ![A screenshot of an example bullet chart that shows the total number of unique pageviews out of a total number of pageviews.](src/images/chart_bullet.png "An example bullet chart that shows the total number of unique pageviews out of a total number of pageviews.")
  ...
  >
    ...
    ![A screenshot of an example heatmap chart showing a pageview breakdown by operating system.](src/images/chart_heatmap.png "An example heatmap chart showing a pageview breakdown by operating system.")
  ...
  >
    ...
    ![A screenshot of an example histogram showing pageview duration over time.](src/images/crop-insights-histogram-chart.png "An example histogram showing pageview duration over time.")
...
```
  ...
  >
    ...
    ![A screenshot of an example line chart showing pageview count over time.](src/images/chart_line.png "An example line chart showing pageview count over time.")
  ...
  >
    ...
    ![A screenshot of an example pie chart.](src/images/chart_pie.png "An example pie chart.")
...
To solve this, use a [bar chart](#widget-barchart) or [table](#widget-table) to provide a more accurate visualization of `uniqueCount` data.
  ...
  >
    ...
    * You can export a table chart to a CSV file. Details on this functionality:
    ...
    ![A screenshot of an example table chart.](src/images/chart_table.png "An example table chart.")
