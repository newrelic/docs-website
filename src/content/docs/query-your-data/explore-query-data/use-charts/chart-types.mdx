...
```
    ...
    **Thresholds**
    ...
    You can set **Warning** and **Critical** thresholds on billboards. If your service is working correctly, the chart's full box is green. When a threshold is crossed, the chart turns yellow (warning) or red (critical). Access the threshold fields are on the right side of the chart edit pane in the query builder. 

    ![A screenshot of a billboard chart.](./images/202111_billboards2.png "A billboard chart.")

    <figcaption>
      The billboard chart displays a single value in a large, easy to read font. The background color changes based on your threshold.
    </figcaption>
