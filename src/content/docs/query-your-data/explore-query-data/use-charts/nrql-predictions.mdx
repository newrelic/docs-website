...
Adding a prediction to a chart can be accomplished using either the <DNT>**Predict trend**</DNT> function added to all charts or by editing the NRQL query directly by using the `PREDICT` clause.
