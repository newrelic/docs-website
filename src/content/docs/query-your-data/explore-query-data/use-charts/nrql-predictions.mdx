...
To enroll in the <DNT>**NRQL Predictions**</DNT> feature, navigate to <DNT>**[one.newrelic.com > Administration](https://one.newrelic.com//admin-portal) > Preview & Trials**</DNT>, and enable <DNT>**NRQL predictions**</DNT>.
...
You can set the smoothing factors for each hyperparameter from 0 to 1. Higher values indicate more weight on recent data, while lower values give more weight to historical data.
