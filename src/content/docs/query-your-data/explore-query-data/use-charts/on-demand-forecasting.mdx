...
<Steps>
  ...
  The chart query is pre-populated with the `FORECAST` function. you can [refine the query](src/content/docs/nrql/nrql-syntax-clauses-functions/#sel-forecast) according to your requirements and run it to get the updated graph.
