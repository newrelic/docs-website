...
You can customize the rate of refresh in your charts by using the <DNT>**Refresh rate**</DNT> option.

<Callout variant="important">
  This option is available to customers on [New Relic's compute usage-based plan](https://newrelic.com/pricing/compute).
</Callout>

To configure the refresh rate in a chart, follow these steps:
