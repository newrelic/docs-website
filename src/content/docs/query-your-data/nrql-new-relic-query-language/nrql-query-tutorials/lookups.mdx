...
You can use lookups to make your telemetry data easier to understand, group data in custom ways, and include information in a query that wasn't previously reported. 
...
This query combines lookups and GeoIP to find which locations have the most unsuccessful statuses: 
