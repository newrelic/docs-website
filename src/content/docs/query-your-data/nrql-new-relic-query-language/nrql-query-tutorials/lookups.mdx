...
## General query syntax [#general-syntax]
...
The main benefit of using lookup tables is that you can use it with your New Relic-store telemetry data. For example, this query avoids hardcoding a long list of hosts by querying specific hosts of interest contained in a lookup table: 
