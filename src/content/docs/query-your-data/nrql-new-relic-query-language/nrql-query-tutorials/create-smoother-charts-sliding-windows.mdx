...
<Callout variant="tip">
  Sliding windows are also available via the UI in the condition [advanced signal settings](/docs/alerts-applied-intelligence/new-relic-alerts/advanced-alerts/understand-technical-concepts/streaming-alerts-key-terms-concepts/#advanced-signal).
</Callout>
