...
<Callout title="BETA FEATURE">This feature is currently in beta.</Callout>
...
![naming-convention.png](src/images/naming-convention.png 'naming-convention.png')

<figcaption>Dimensional metrics naming convention</figcaption>
