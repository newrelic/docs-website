...
<Callout variant="tip">
This feature is different from our [subquery feature](/docs/query-your-data/nrql-new-relic-query-language/get-started/subqueries-in-nrql), which allow for subqueries in `SELECT` and `WHERE` clauses. 
</Callout>
