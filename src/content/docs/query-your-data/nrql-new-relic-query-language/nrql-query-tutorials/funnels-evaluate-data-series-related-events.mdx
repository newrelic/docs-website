...
japaneseVersion: >-
  https://docs.newrelic.co.jp/docs/query-your-data/nrql-new-relic-query-language/nrql-query-tutorials/funnels-evaluate-data-series-related-events
---
...
Funnel queries require the [`funnel` function](/docs/query-data/nrql-new-relic-query-language/getting-started/nrql-syntax-components-functions#func-funnel), an [attribute](https://docs.newrelic.com/docs/using-new-relic/welcome-new-relic/get-started/glossary#attribute) to funnel, and at least two steps:
...
This example queries the New Relic Browser [`PageView`](/attribute-dictionary?attribute_name=&events_tids%5B%5D=8302) event and its attributes. It queries unique browser sessions that have progressed from registration to account upgrades. Labels are included for each step, indicated by the keyword `AS`.
