...
![Screenshot of funnel function](src/images/crop-insights-funnels.png 'crop-insights-funnels.png')

<figcaption>
  An example NRQL funnel query that displays a count of the users who registered
  for an account, visited a feature-compare page, and upgraded.
</figcaption>
