...
import queriesnrqlFacetBucketsNRQLLegacyInsights from 'images/queries-nrql_screenshot-crop_facet-buckets-NRQL-legacy-insights.png'
...
<img
  ...
  src={queriesnrqlFacetBucketsNRQLLegacyInsights}
/>
