...
<Callout variant="tip">
  For more information and examples, see the [our blog post](https://blog.newrelic.com/2017/03/20/mobile-http-request-error-insights/) explaining the power of `MobileRequestError` event data.
</Callout>
