...
You can specify which function to use as well as the size of the time window you want to inspect. More information can be found [here.](/docs/query-your-data/nrql-new-relic-query-language/get-started/nrql-syntax-clauses-functions/#func-rate)
...
<CollapserGroup>
  ...
  >
    To chart lines based on their host, you can `FACET` by `host`. This example demonstrates how you can use the `rate()` function to quickly identify a bad host.
