...
When viewing a dashboard, the time picker time range will supersede a query's
`SINCE` and `UNTIL` clauses, unless the dashboard widgets have been configured
...
<Collapser id="timeseries-snap-example" title="Metric query snapping">
  ...
  aggregations, so the actual time range snaps to nearby aggregation boundaries,
...
<Collapser id="timeseries-snap-example" title={<><InlineCode>TIMESERIES</InlineCode> query snapping</>}>
  ...
  start time is adjusted so the first bucket in the response covers a full 5 minutes.
...
<Callout variant="tip" title="Default Timezone">
  ...
  string option, or you can use NRQL's
...
### Relative time: <InlineCode>*n* \[time units] ago</InlineCode> [#relative-time-n-units-ago]
...
The time is relative to the time the query is executed.
  ...
  * `[time units]`: Available time units include `seconds`, `minutes`, `hours`, `days`, `weeks`,
`months` (A month is defined as 30 days), `quarters` (A quarter is defined as 91 days),
`years` (A year is defined as 365 days).
Time unit pluralization is optional, so you can leave the "s" off the end of the unit.
`2 day ago` and `2 days ago` have the same meaning.

<Collapser title="Relative time examples">
...
These relative time references resolve to the beginning of the temporal time interval.
...
A time range time can be specified using a DateTime string.
The parser generally supports the ISO 8601 DateTime format: `'2023-12-18T12:34:56.789-06:00'`.
But, the DateTime parser can recognize variants of the ISO standard format, like `'2023-12-18 12:34'`.
Date-only (`'2023-12-18'`) and time-only (`'12:34:56'`) strings are also supported.

<Collapser title="DateTime structure details and options">
    <table style={{width: "auto"}}>
      <thead>
      <tr>
        <th>
      ...
      <tr>
        ...
        <td style="font-family:monospace">[Date][TimeSeparator][Time][TimeZone][AM/PM]</td>
      </tr>
      <tr>
        <td><span style="font-family:monospace">Date</span></td>
        <td>
          <div style="font-family:monospace">Year-Month-Day</div>

          <div>
          * <span style="font-family:monospace">Year</span> - (*required*) 4-digit year value.
          * <span style="font-family:monospace">Month</span> - (*required*) 2-digit month value.
          * <span style="font-family:monospace">Day</span> - (*optional*) 2-digit day value.
          </div>

          A DateTime string can include a <span style="font-family:monospace">Date</span> without a
          <span style="font-family:monospace">Time</span>, with the time value defaulting to midnight at the start of
          the given date.

          The dashes between date elements are optional (but recommended), so `'20231218'` is equivalent to `'2023-12-18'`.
        </td>
      </tr>
      <tr>
        <td><span style="font-family:monospace">TimeSeparator</span></td>
        <td>
          Separates the date and time in a full DateTime string. Valid separating values are the capital letter `T` or a single space ` `.
        </td>
      </tr>
      <tr>
        <td><span style="font-family:monospace">Time</span></td>
        <td>
          <div style="font-family:monospace">Hour:Minute[[:Second].FractionalSecond]</div>

          <div>
          * <span style="font-family:monospace">Hour</span> - (*required*) 1- or 2-digit hour value, 00-23.
          2-digits is recommended, per the ISO 8601 specification.
          * <span style="font-family:monospace">Minute</span> - (*required*) 2-digit minute value, 00-59.
          * <span style="font-family:monospace">:Second</span> - (*optional*) 2-digit seconds value, 00-59.
          * <span style="font-family:monospace">[.FractionalSecond]</span> - (*optional*) 1 to
          3-digit fractional second (milliseconds) value, 000-999. Only available when a <span
          style="font-family:monospace">:Second</span> value is included.
          </div>

          A DateTime string can include a <span style="font-family:monospace">Time</span>
          without a <span style="font-family:monospace">Date</span>, with the date value defaulting
          to the current day. When a time is given without a date in the `SINCE` clause,
          if the time is in the future, the previous day will be used for the date.

          When a <span style="font-family:monospace">Time</span> follows a `T` <span
          style="font-family:monospace">TimeSeparator</span>, the colons are optional (but
          recommended). If the colons are excluded, the <span
          style="font-family:monospace">Hour</span> must include 2 digits and <span
          style="font-family:monospace">AM/PM</span> is not allowed. So,
          `'20231218T123456.789'` is equivalent to `'2023-12-18T12:34:56.789'`.
        </td>
      </tr>
      <tr>
        <td><span style="font-family:monospace">TimeZone</span></td>
        <td>
          *Optional* - If <span style="font-family:monospace">TimeZone</span> is not
          included in a DateTime string, the time zone indicated in the query's
          `WITH TIMEZONE` clause will be used if present, otherwise the UTC timezone will be used.

          The <span style="font-family:monospace">TimeZone</span> value can optionally be
          preceded by a space. It can be indicated in various formats.

          * Offset - Indicates the timezone hours and minutes relative to UTC.

            `(+|-)Hours[:]Minutes` - i.e. Plus or minus, 2 digit hours, an optional colon,
          and finally 2 digit minutes.

            Examples: `-0600`, `+0530`, `+05:30`
          * Zone ID in square brackets - A Zone ID is a textual name of a timezone. Most
          (but not all) Zone IDs consist of a region followed by a slash and then a
          subregion. An advantage of using a region based Zone ID is that the DateTime
          parser will automatically adjust for the zone's daylight saving time rules.

          Examples: `[America/Los_Angeles]`, `Etc/GMT-6`

          See the available [Zone IDs](#timezones-ids) list.

          Note, Zone IDs do not work when using <span style="font-family:monospace">AM/PM</span>.

          * Timezone Abbreviations - The parser has limited support for timezone
          abbreviations. Support is limited due to the fact that timezone abbreviations are
          not unique. See [Limited Timezone Abbreviation Support](timezones-abbrev) for
          details.
        </td>
      </tr>
      <tr>
        <td><span style="font-family:monospace">AM/PM</span></td>
        <td>
          `AM` or `PM` can be added to the end of a DateTime string. If present, the <span
          style="font-family:monospace">Hour</span> value is interpreted as a 12 hour
          value rather than a 24 hour value, with a range of 01-12 instead of 00-23.

          Note, <span style="font-family:monospace">AM/PM</span> is not supported with the
          Zone ID <span style="font-family:monospace">TimeZone</span> format.
        </td>
      </tr>
      </tbody>
    </table>
...
<Collapser title="DateTime string examples">
  <table style={{width: "auto"}}>
    ...
    <tr>
      ...
      <td style="font-family:monospace">2023-12-17T12:34:56.789Z</td>
    </tr>
    <tr>
      <td>
      ...
      <td style="font-family:monospace">2023-12-17T12:34:56.000Z</td>
    </tr>
    <tr>
      <td>
        `'2023-12-18T12:34'`<br/>
      ...
      <td style="font-family:monospace">2023-12-17T12:34:00.000Z</td>
    </tr>
    <tr>
      <td>
      ...
      <td style="font-family:monospace">2023-12-17T13:23:00.000Z</td>
    </tr>
    <tr>
      <td>
        `'12:34'`<br/>
      ...
      <td>
        (With a query execution time of <span style="font-family:monospace">2023-12-18T20:00Z</span>)<br/>
        <span style="font-family:monospace">2023-12-18T12:34:00.000Z</span>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td style="font-family:monospace">2023-12-18T00:00:00.000Z</td>
    </tr>
    <tr>
      <td>
        `'2023-12-18-06:00'`<br/>
      ...
      <td style="font-family:monospace">2023-12-18T06:00:00.000Z</td>
    </tr>
    </tbody>
  </table>
</Collapser>
...
### Limited Timezone Abbreviation Support "timezones-abbrev"

<Callout variant="caution">
  Using timezone abbreviations is not recommended. The abbreviations are not
  unique.
  In the table below, time zones in the Conflicting Zones column are not available
  through use of a timezone abbreviation.
</Callout>

It is possible to use timezone abbreviations in `SINCE`/`UNTIL` DateTime strings.

<Collapser
  className="freq-link"
  title={<>Timezone Abbreviations</>}
>
  <table style={{width: "auto"}}>
    <thead>
    <tr>
      <th>Abbreviation</th>
      <th>Primary Zone</th>
      <th>Other Supported Zones</th>
      <th>Conflicting Zones</th>
    </tr>
    </thead>
    <tbody>
    <tr>
      <td>ACDT</td>
      <td>Australian Central Daylight Time [+10:30]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>ACST</td>
      <td>Acre Standard Time [-05:00]</td>
      <td></td>
      <td>Australian Central Standard Time [+09:30]</td>
    </tr>
    <tr>
      <td>ACT</td>
      <td>Acre Standard Time [-05:00]</td>
    ...
    <tr>
      <td>ACWST</td>
      <td>Australian Central Western Standard Time [+08:45]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>ADT</td>
      <td>Atlantic Daylight Time [-03:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>AEDT</td>
      <td>Australian Eastern Daylight Time [+11:00]</td>
      <td>Australian Eastern Daylight Time (Macquarie) [+11:00]</td>
      <td></td>
    </tr>
    <tr>
      <td>AEST</td>
      <td>Australian Eastern Standard Time [+10:00]</td>
      <td>Macquarie Island Time [+10:00]</td>
      <td>Australian Eastern Standard Time [+10:00]</td>
    </tr>
    <tr>
      <td>AFT</td>
      <td>Afghanistan Time [+04:30]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>AKDT</td>
      <td>Alaska Daylight Time [-08:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>AKST</td>
      <td>Alaska Standard Time [-09:00]</td>
      <td>Gambier Time [-09:00]</td>
      <td></td>
    </tr>
    <tr>
      <td>ALMT</td>
      <td>East Kazakhstan Time [+06:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>AMT</td>
      <td>Amazon Standard Time [-04:00]</td>
      <td></td>
      <td>Armenia Standard Time [+04:00]</td>
    </tr>
    <tr>
      <td>ANAT</td>
      <td>Anadyr Standard Time [+12:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>AQTT</td>
      <td>West Kazakhstan Time [+05:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>ART</td>
      <td>Argentina Standard Time [-03:00]</td>
      <td>Western Argentina Standard Time [-03:00]</td>
      <td></td>
    </tr>
    <tr>
      <td>AST</td>
      <td>Atlantic Standard Time [-04:00]</td>
      <td></td>
      <td>Arabian Standard Time [+03:00]</td>
    </tr>
    <tr>
      <td>AWST</td>
      <td>Australian Western Standard Time [+08:00]</td>
      <td></td>
      <td>Casey Time [+11:00]</td>
    </tr>
    <tr>
      <td>AZOST</td>
      <td>Azores Summer Time [Z]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>AZOT</td>
      <td>Azores Standard Time [-01:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>AZT</td>
      <td>Azerbaijan Standard Time [+04:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>BDT</td>
      <td>Bangladesh Standard Time [+06:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>BNT</td>
      <td>Malaysia Time [+08:00]</td>
      <td>Brunei Darussalam Time [+08:00]</td>
      <td></td>
    </tr>
    <tr>
      <td>BOT</td>
      <td>Bolivia Time [-04:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>BRT</td>
      <td>Brasilia Standard Time [-03:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>BST</td>
      <td>Bougainville Standard Time [+11:00]</td>
      <td></td>
      <td>British Summer Time [+01:00]</td>
    </tr>
    <tr>
      <td>BTT</td>
      <td>Bhutan Time [+06:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>CAT</td>
      <td>East Africa Time [+03:00]</td>
      <td></td>
      <td>Central Africa Time [+02:00]<br/>East Africa Time [+02:00]</td>
    </tr>
    <tr>
      <td>CCT</td>
      <td>Myanmar Time [+06:30]</td>
      <td>Cocos Islands Time [+06:30]</td>
      <td></td>
    </tr>
    <tr>
      <td>CDT</td>
      <td>Central Daylight Time [-05:00]</td>
      <td></td>
      <td>Cuba Daylight Time [-04:00]</td>
    </tr>
    <tr>
      <td>CEST</td>
      <td>Central European Summer Time [+02:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>CET</td>
      <td>Central European Standard Time [+01:00]</td>
      <td>Central European Time [+01:00]</td>
      <td></td>
    </tr>
    <tr>
      <td>CHADT</td>
      <td>Chatham Daylight Time [+13:45]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>CHAST</td>
      <td>Chatham Standard Time [+12:45]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>CHOT</td>
      <td>Choibalsan Standard Time [+08:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>CHUT</td>
      <td>Papua New Guinea Time [+10:00]</td>
      <td>Chuuk Time [+10:00]</td>
      <td></td>
    </tr>
    <tr>
      <td>CKT</td>
      <td>Cook Islands Standard Time [-10:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>CLST</td>
      <td>Chile Time [-03:00]</td>
      <td>Chile Summer Time [-03:00]</td>
      <td></td>
    </tr>
    <tr>
      <td>CLT</td>
      <td>Chile Time [-03:00]</td>
      <td></td>
      <td>Chile Standard Time [-04:00]</td>
    </tr>
    <tr>
      <td>COT</td>
      <td>Colombia Standard Time [-05:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>CST</td>
      <td>Central Standard Time [-06:00]</td>
      <td></td>
      <td>Taipei Standard Time [+08:00]<br/>Cuba Standard Time [-05:00]<br/>China
        Standard Time [+08:00]
      </td>
    </tr>
    <tr>
      <td>CVT</td>
      <td>Cape Verde Standard Time [-01:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>CXT</td>
      <td>Indochina Time [+07:00]</td>
      <td>Christmas Island Time [+07:00]</td>
      <td></td>
    </tr>
    <tr>
      <td>ChST</td>
      <td>Chamorro Standard Time [+10:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>DAVT</td>
      <td>Davis Time [+07:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>DDUT</td>
      <td>Papua New Guinea Time [+10:00]</td>
      <td>Dumont-d’Urville Time [+10:00]</td>
      <td></td>
    </tr>
    <tr>
      <td>EASST</td>
      <td>Easter Island Summer Time [-05:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>EAST</td>
      <td>Easter Island Standard Time [-06:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
    ...
    <tr>
      <td>ECT</td>
      <td>Ecuador Time [-05:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>EDT</td>
      <td>Eastern Daylight Time [-04:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>EEST</td>
      <td>Eastern European Summer Time [+03:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>EET</td>
      <td>Eastern European Summer Time [+03:00]</td>
      <td>Eastern European Standard Time [+02:00]<br/>Eastern European Time [+02:00]
      </td>
      <td>Eastern European Standard Time [+02:00]<br/>Eastern European Standard Time
        [+03:00]
      </td>
    </tr>
    <tr>
      <td>EGST</td>
      <td>East Greenland Summer Time [Z]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>EGT</td>
      <td>East Greenland Standard Time [-01:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>EST</td>
      <td>Eastern Standard Time [-05:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>FJT</td>
      <td>Fiji Standard Time [+12:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>FKT</td>
      <td>Falkland Islands Standard Time [-03:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>FNT</td>
      <td>Fernando de Noronha Standard Time [-02:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>GALT</td>
      <td>Galapagos Time [-06:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
    ...
    <tr>
      <td>GET</td>
      <td>Georgia Standard Time [+04:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>GFT</td>
      <td>French Guiana Time [-03:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>GILT</td>
      <td>Gilbert Islands Time [+12:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>GMT</td>
      <td>Greenwich Mean Time [Z]</td>
      <td>West Africa Standard Time [Z]</td>
      <td></td>
    </tr>
    <tr>
      <td>GMT+01:00</td>
      <td>GMT+01:00 [+01:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>GMT+02:00</td>
      <td>GMT+02:00 [+02:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>GMT+03:00</td>
      <td>GMT+03:00 [+03:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>GMT+04:00</td>
      <td>GMT+04:00 [+04:00]</td>
      <td>Ulyanovsk Standard Time [+04:00]<br/>Saratov Standard Time [+04:00]<br/>Astrakhan
        Standard Time [+04:00]
      </td>
      <td></td>
    </tr>
    <tr>
      <td>GMT+05:00</td>
      <td>GMT+05:00 [+05:00]</td>
      <td>West Kazakhstan Time [+05:00]</td>
      <td></td>
    </tr>
    <tr>
      <td>GMT+06:00</td>
      <td>GMT+06:00 [+06:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>GMT+07:00</td>
      <td>GMT+07:00 [+07:00]</td>
      <td>Tomsk Standard Time [+07:00]<br/>Barnaul Standard Time [+07:00]</td>
      <td></td>
    </tr>
    <tr>
      <td>GMT+08:00</td>
      <td>GMT+08:00 [+08:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>GMT+09:00</td>
      <td>GMT+09:00 [+09:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>GMT+10:00</td>
      <td>GMT+10:00 [+10:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>GMT+11:00</td>
      <td>GMT+11:00 [+11:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>GMT+12:00</td>
      <td>GMT+12:00 [+12:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>GMT+13:00</td>
      <td>GMT+13:00 [+13:00]</td>
      <td>Kanton Standard Time [+13:00]</td>
      <td></td>
    </tr>
    <tr>
      <td>GMT+14:00</td>
      <td>GMT+14:00 [+14:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
    ...
    <tr>
      <td>GMT-03:00</td>
      <td>GMT-03:00 [-03:00]</td>
      <td>Punta Arenas Standard Time [-03:00]</td>
      <td></td>
    </tr>
    <tr>
      <td>GMT-04:00</td>
    ...
    <tr>
      <td>GST</td>
      <td>Gulf Standard Time [+04:00]</td>
      <td></td>
      <td>South Georgia Time [-02:00]</td>
    </tr>
    <tr>
      <td>GYT</td>
      <td>Guyana Time [-04:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>HADT</td>
      <td>Hawaii-Aleutian Standard Time [-10:00]</td>
      <td></td>
      <td>Hawaii-Aleutian Daylight Time [-09:00]</td>
    </tr>
    <tr>
      <td>HAST</td>
      <td>Hawaii-Aleutian Standard Time [-10:00]</td>
    ...
    <tr>
      <td>HKT</td>
      <td>Hong Kong Standard Time [+08:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>HOVT</td>
      <td>Hovd Standard Time [+07:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
    ...
    <tr>
      <td>IDT</td>
      <td>India Standard Time [+05:30]</td>
      <td></td>
      <td>Israel Daylight Time [+03:00]</td>
    </tr>
    <tr>
      <td>IOT</td>
      <td>Indian Ocean Time [+06:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>IRKT</td>
      <td>Irkutsk Standard Time [+08:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>IRST</td>
      <td>Iran Standard Time [+03:30]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      ...
      <td>Greenwich Mean Time [Z]</td>
      <td></td>
      <td>India Standard Time [+05:30]<br/>Israel Standard Time [+02:00]<br/>Irish
        Standard Time [+01:00]
      </td>
    </tr>
    <tr>
      <td>JST</td>
      <td>Japan Standard Time [+09:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>KGT</td>
      <td>Kyrgyzstan Time [+06:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>KOST</td>
      <td>Kosrae Time [+11:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>KRAT</td>
      <td>Krasnoyarsk Standard Time [+07:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>KST</td>
      <td>Korean Standard Time [+09:00]</td>
      <td>Pyongyang Time [+09:00]</td>
      <td></td>
    </tr>
    <tr>
      <td>LHDT</td>
      <td>Lord Howe Daylight Time [+11:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>LHST</td>
      <td>Lord Howe Standard Time [+10:30]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>LINT</td>
      <td>Line Islands Time [+14:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>MAGT</td>
      <td>Magadan Standard Time [+11:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>MART</td>
      <td>Marquesas Time [-09:30]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>MAWT</td>
      <td>Mawson Time [+05:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>MDT</td>
      <td>Mountain Daylight Time [-06:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>MEST</td>
      <td>Middle Europe Summer Time [+02:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>MET</td>
      <td>Middle Europe Time [+01:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>MHT</td>
      <td>Gilbert Islands Time [+12:00]</td>
      <td>Marshall Islands Time [+12:00]</td>
      <td></td>
    </tr>
    <tr>
      <td>MMT</td>
    ...
    <tr>
      <td>MSK</td>
      <td>Moscow Standard Time [+03:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>MST</td>
      <td>Mountain Standard Time [-07:00]</td>
      <td>Mexican Pacific Standard Time [-07:00]</td>
      <td></td>
    </tr>
    <tr>
      <td>MUT</td>
      <td>Mauritius Standard Time [+04:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>MVT</td>
      <td>Maldives Time [+05:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
    ...
    <tr>
      <td>NCT</td>
      <td>New Caledonia Standard Time [+11:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>NDT</td>
      <td>Newfoundland Daylight Time [-02:30]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>NFST</td>
      <td>Norfolk Summer Time [+12:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>NFT</td>
      <td>Norfolk Island Time [+11:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>NOVT</td>
      <td>Novosibirsk Standard Time [+07:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>NPT</td>
      <td>Nepal Time [+05:45]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>NRT</td>
      <td>Nauru Time [+12:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>NST</td>
      <td>Newfoundland Standard Time [-03:30]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>NUT</td>
      <td>Niue Time [-11:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>NZDT</td>
      <td>New Zealand Daylight Time [+13:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>NZST</td>
      <td>New Zealand Standard Time [+12:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>OMST</td>
      <td>Omsk Standard Time [+06:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
    ...
    <tr>
      <td>PDT</td>
      <td>Pacific Daylight Time [-07:00]</td>
      <td>Northwest Mexico Daylight Time [-07:00]</td>
      <td></td>
    </tr>
    <tr>
      <td>PET</td>
      <td>Peru Standard Time [-05:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>PETT</td>
      <td>Petropavlovsk-Kamchatski Standard Time [+12:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
    ...
    <tr>
      <td>PHOT</td>
      <td>Kanton Standard Time [+13:00]</td>
      <td>Phoenix Islands Time [+13:00]</td>
      <td></td>
    </tr>
    <tr>
      <td>PKT</td>
      <td>Pakistan Standard Time [+05:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>PMDT</td>
      <td>St. Pierre & Miquelon Daylight Time [-02:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>PMST</td>
      <td>St. Pierre & Miquelon Standard Time [-03:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>PONT</td>
      <td>Solomon Islands Time [+11:00]</td>
      <td>Ponape Time [+11:00]</td>
      <td></td>
    </tr>
    <tr>
      <td>PST</td>
      <td>Pacific Standard Time [-08:00]</td>
      <td>Northwest Mexico Standard Time [-08:00]<br/>Pitcairn Time [-08:00]</td>
      <td>Pacific Standard Time [-07:00]<br/>Philippine Standard Time [+08:00]</td>
    </tr>
    <tr>
      <td>PWT</td>
      <td>Palau Time [+09:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>PYST</td>
      <td>Paraguay Summer Time [-03:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>PYT</td>
      <td>Paraguay Standard Time [-04:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>QOST</td>
      <td>Kostanay Standard Time [+06:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      ...
      <td>East Kazakhstan Time [+06:00]</td>
      <td></td>
      <td>East Kazakhstan Time [+05:00]</td>
    </tr>
    <tr>
      <td>RET</td>
      <td>Gulf Standard Time [+04:00]</td>
      <td>Réunion Time [+04:00]</td>
      <td></td>
    </tr>
    <tr>
      <td>ROTT</td>
      <td>Rothera Time [-03:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>SAKT</td>
      <td>Sakhalin Standard Time [+11:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>SAMT</td>
      <td>Samara Standard Time [+04:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>SAST</td>
      <td>South Africa Standard Time [+02:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
    ...
    <tr>
      <td>SCT</td>
      <td>Gulf Standard Time [+04:00]</td>
      <td>Seychelles Time [+04:00]</td>
      <td></td>
    </tr>
    <tr>
      <td>SGT</td>
      <td>Singapore Standard Time [+08:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>SRET</td>
      <td>Srednekolymsk Time [+11:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>SRT</td>
      <td>Suriname Time [-03:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>SST</td>
      <td>Samoa Standard Time [-11:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>SYOT</td>
      <td>Arabian Standard Time [+03:00]</td>
      <td>Syowa Time [+03:00]</td>
      <td></td>
    </tr>
    <tr>
      <td>TAHT</td>
      <td>Tahiti Time [-10:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>TFT</td>
      <td>Maldives Time [+05:00]</td>
      <td>French Southern & Antarctic Time [+05:00]</td>
      <td></td>
    </tr>
    <tr>
      <td>TJT</td>
      <td>Tajikistan Time [+05:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>TKT</td>
      <td>Tokelau Time [+13:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>TLT</td>
      <td>East Timor Time [+09:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>TMT</td>
      <td>Turkmenistan Standard Time [+05:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>TOT</td>
      <td>Tonga Standard Time [+13:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>TRT</td>
      <td>Turkey Time [+03:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>TVT</td>
      <td>Gilbert Islands Time [+12:00]</td>
      <td>Tuvalu Time [+12:00]</td>
      <td></td>
    </tr>
    <tr>
      <td>ULAT</td>
      <td>Ulaanbaatar Standard Time [+08:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>UTC</td>
      <td>Coordinated Universal Time [Z]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>UYT</td>
      <td>Uruguay Standard Time [-03:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>UZT</td>
      <td>Uzbekistan Standard Time [+05:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>VET</td>
      <td>Venezuela Time [-04:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>VLAT</td>
      <td>Vladivostok Standard Time [+10:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>VOST</td>
      <td>Xinjiang Standard Time [+06:00]</td>
      <td>Vostok Time [+06:00]</td>
      <td></td>
    </tr>
    <tr>
      <td>VUT</td>
      <td>Vanuatu Standard Time [+11:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>WAKT</td>
      <td>Gilbert Islands Time [+12:00]</td>
      <td>Wake Island Time [+12:00]</td>
      <td></td>
    </tr>
    <tr>
      <td>WAT</td>
      <td>West Africa Standard Time [+01:00]</td>
      <td></td>
      <td>Western African Time [+02:00]</td>
    </tr>
    <tr>
      <td>WEST</td>
      <td>Western European Summer Time [+01:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>WET</td>
      <td>Western European Time [Z]</td>
      <td>Western European Standard Time [Z]</td>
      <td>Western European Standard Time [Z]</td>
    </tr>
    <tr>
      <td>WFT</td>
      <td>Gilbert Islands Time [+12:00]</td>
      <td>Wallis & Futuna Time [+12:00]</td>
      <td></td>
    </tr>
    <tr>
      <td>WGST</td>
      <td>Western Greenland Summer Time [-02:00]</td>
      <td>West Greenland Summer Time [-02:00]</td>
      <td></td>
    </tr>
    <tr>
      <td>WGT</td>
      <td>Western Greenland Time [-03:00]</td>
      <td>West Greenland Standard Time [-03:00]</td>
      <td></td>
    </tr>
    <tr>
      <td>WIB</td>
      <td>Western Indonesia Time [+07:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>WIT</td>
      <td>Eastern Indonesia Time [+09:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>WITA</td>
      <td>Central Indonesia Time [+08:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>WSST</td>
      <td>Apia Standard Time [+13:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
    ...
    <tr>
      <td>YAKT</td>
      <td>Yakutsk Standard Time [+09:00]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td>YEKT</td>
      <td>Yekaterinburg Standard Time [+05:00]</td>
      <td></td>
      <td></td>
    </tr>
    </tbody>
