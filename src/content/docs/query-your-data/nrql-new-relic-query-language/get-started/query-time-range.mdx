...
Date only (`'2023-12-18'`) strings are supported, resolving to midnight on the given day.
And, time only (`'12:34:56'`) strings are supported, resolving to the given time on the current day.
    ...
    <table style={{width: "auto"}}>
      ...
      <tr>
        ...
        <td>
          ...
          * Offset - Indicates the timezones hours and minutes relative to UTC.
          ...
          * Timezone Abbreviations - The parser has limited support for timezone
          abbreviations. Support is limited due to the fact that timezone abbreviations is
...
<Collapser title="DateTime string examples">
  <table style={{width: "auto"}}>
    ...
    <tr>
      ...
      <td>
        (With a the query execution time of <span style="font-family:monospace">2023-12-18T20:00Z</span>)<br/>
