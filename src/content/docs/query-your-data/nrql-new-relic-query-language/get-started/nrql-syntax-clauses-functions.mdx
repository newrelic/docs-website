...
import queriesnrqlFilterNRQLInsightsLegacy from 'images/queries-nrql_screenshot-crop_filter-NRQL-insights-legacy.png'
    ...
    <CollapserGroup>
      <Collapser title="Analyze purchases that used offer codes">
        ...
        <img
          ...
          src={queriesnrqlFilterNRQLInsightsLegacy}
        />
