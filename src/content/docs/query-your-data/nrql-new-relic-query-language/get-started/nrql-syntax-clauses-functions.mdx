...
Looking for basic NRQL syntax rules? See [How to use NRQL](/docs/query-data/nrql-new-relic-query-language/getting-started/introduction-nrql-how-nrql-works). For a tutorial, see [Introductory NRQL tutorial](/docs/query-data/nrql-new-relic-query-language/getting-started/introduction-nrql-tutorial).
