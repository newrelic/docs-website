      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            Keep in mind that `LIKE` is case insensitive, and if you don't include a wildcard, you'll get matches for upper and lower case. For example, this query without wildcards will match `X` and `x`:
