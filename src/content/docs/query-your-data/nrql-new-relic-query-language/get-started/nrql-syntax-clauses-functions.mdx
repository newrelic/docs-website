...
<CollapserGroup>
  ...
  >
    ...
    <CollapserGroup>
      ...
      >
        You can upload a CSV-format lookup table and query that data alongside your New Relic data. For more information, see [How to query lookup tables](/docs/query-your-data/nrql-new-relic-query-language/nrql-query-tutorials/lookups). 
      </Collapser>      
    </CollapserGroup>
  </Collapser>
</CollapserGroup>
...
Note: `aparse()` is case-insensitive.
  ...
  <Collapser
    className="freq-link"
    id="func-lookup"
    title={<InlineCode>lookup()</InlineCode>}
  >
  You can use the `lookup()` function with a lookup table name to access that table's data in a query. For a tutorial on this, see [How to query lookups](/docs/query-your-data/nrql-new-relic-query-language/nrql-query-tutorials/lookups).
