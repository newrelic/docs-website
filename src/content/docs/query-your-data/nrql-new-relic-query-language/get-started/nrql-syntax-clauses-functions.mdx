...
<CollapserGroup>
  ...
  >
    ...
    The maximum allowed value for the `LIMIT` clause is 5,000. Queries can use the `LIMIT MAX` clause instead of a specific value to automatically use the current maximum value. The maximum value may change in the future. If you want your query's behavior to remain unchanged, specify an explicit value instead of using `LIMIT MAX`.
