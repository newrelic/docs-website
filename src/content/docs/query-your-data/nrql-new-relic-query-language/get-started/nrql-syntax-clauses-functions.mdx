...
Note: `aparse()` is case-insensitive.
  ...
  >
    ...
    * path - An optional string value that is used to directly reference a particular piece of the JSON within the `attribute` parameter. See the [JSON Parse Path Syntax Reference](#json-parse-path-syntax-reference) section below.
    ...
    You can use the square-bracket syntax to pull out individual values from a `jparse()` result via a key/index, and map JSON keys directly to attributes using the `WITH` clause.
    ...
    <CollapserGroup>
      ...
      <Collapser id="mapping-json-keys-to-attributes" title="Mapping JSON keys to attributes">
        The following query uses `jparse()` in the `WITH` clause to map the JSON keys `userName` and `id` directly into attributes so they can be used in the rest of the query.
    ...
    <Collapser id="json-parse-path-syntax-reference" title="JSON Parse Path Syntax Reference">
          ...
          <table id="join-types">
            ...
            <tbody>
              ...
              <tr>
                <td>'valueC[0]'</td>
                <td>Returns list member</td>
                <td>`{"id": 1…}`</td>
              </tr>
              <tr>
                <td>'valueC[0,2]'</td>
                <td>Returns first and third members</td>
                <td>`[{"id": 1…}, {"id": 3…}]`</td>
              </tr>
              <tr>
                <td>'valueC[0:2]'</td>
                <td>Returns first through 2 members, exclusive</td>
                <td>`[{"id": 1…}, {"id": 2…}]`</td>
              </tr>
              <tr>
                <td>'valueC[:2]'</td>
                <td>Returns the first 2 members, exclusive</td>
                <td>`[{"id": 1…}, {"id": 2…}]`</td>
              </tr>
              <tr>
                <td>'valueC[:-2]'</td>
                <td>Returns everything except the last two members</td>
                <td>`[{"id": 1…}]`</td>
              </tr>
              <tr>
                <td>'valueC[1:]'</td>
                <td>Returns the second to the last members</td>
                <td>`[{"id": 2…}, {"id": 3…}]`</td>
              </tr>
              <tr>
                <td>'valueC[-1:]'</td>
                <td>Returns the last member</td>
                <td>`[{"id": 3…}]`</td>
              </tr>
              <tr>
                <td>'valueC[*]'</td>
                <td>Returns all members</td>
                <td>`[{"id": 1…}, {"id": 2…},{"id": 3…}]`</td>
              </tr>
              <tr>
                <td>'valueC[*].id'</td>
                <td>Returns key of members</td>
                <td>`[1, 2, 3]`</td>
              </tr>
              <tr>
                <td>'valueC[*]["label", other]'</td>
                <td>Returns keys of members</td>
                <td>`[["A", 7],…]`</td>
              </tr>
            </tbody>
          </table>
    ...
    <CollapserGroup>
      ...
      <Collapser id="parse-specific-value-from-log-message" title="Parse a specific value from a log message">
        A common problem is having rich and structured data hiding with a Log message. You can leverage `aparse()` and `jparse()` to trim away noise and find specific values within a log message.
