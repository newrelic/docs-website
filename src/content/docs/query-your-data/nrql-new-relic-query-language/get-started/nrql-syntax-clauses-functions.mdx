...
* [Introductory NRQL tutorial](/docs/query-your-data/nrql-new-relic-query-language/get-started/introduction-nrql-tutorial/): a basic tutorial for NRQL designed to get you familiar with basic queries
