...
## Syntax and rules [#syntax]

This resource contains explanations for the various functions and clauses available for use in a NRQL query. Other popular resources for understanding NRQL syntax and rules include:
...
* [How to use NRQL](/docs/query-data/nrql-new-relic-query-language/getting-started/introduction-nrql-how-nrql-works): explains some basic NRQL syntax rules, and how to use NRQL to query your data
