...
<CollapserGroup>
  ...
  >
    ...
    <CollapserGroup>
      ...
      >
        You can upload and query data from a lookup table. See [How to query lookup tables](/docs/query-your-data/nrql-new-relic-query-language/nrql-query-tutorials/lookups). 
      </Collapser>      
    </CollapserGroup>
  </Collapser>
</CollapserGroup>
