...
Note: `aparse()` is case-insensitive.
  ...
  >
    ...
    Common units and abbreviations for time, length, weight, volume, and data are supported.
    ...
    The largest unit of time is `year`, which is always exactly 365 days, and does not account for leap-year adjustments.
