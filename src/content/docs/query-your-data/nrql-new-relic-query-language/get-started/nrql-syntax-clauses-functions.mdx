...
Note: `aparse()` is case-insensitive.
  ...
  >
    Use the lower() function transliterates all alphabetic characters of a string value to lower-case.

    Arguments:
    * str - The string value to be transliterated to lower-case
    ...
    <CollapserGroup>
      <Collapser title="Use lower to transliterate a string value to all lower-case characters">
  ...
  * occurrence - indicates which occurrence of substr of which to return the position.
  ...
  Returns:
    ...
    * Searches are case-sensitive
    ...
    <CollapserGroup>
      <Collapser title="Use position to find the positional index of a substring within a URL">
        ...
        SELECT pageUrl, FirstColon, substring(pageUrl, 0, FirstColon) as Protocol,
          ...
          position(pageUrl, '/', -1) as LastSlash, substring(pageUrl, position(pageUrl, '/', -1)) as PathEnd as PathEnd
        ```
        <img
  ...
  >
    ...
    * length - the length, or number of characters, of the substring to extract from str.
    ...
    <CollapserGroup>
      <Collapser title="Use substring to extract various parts of a string">
        This query returns various parts of session value.
  ...
  >
    Use the upper() function transliterates all alphabetic characters of a string value to upper-case.

    Arguments:
    * str - The string value to be transliterated to upper-case
    * This can be anything that evaluates to a string, including a literal string in quotes, a queried string attribute, a function that returns a string, or even a subquery that returns a single string value.
    * If this argument evaluates to null, the upper function will return null.

    <CollapserGroup>
      <Collapser title="Use upper to transliterate a string value to all upper-case characters">
