      ...
      <Collapser id="partial-datetime-interpretation" title="Partial datetime interpretation when parsing datetime strings">
        <table>
          ...
          <tr>
            ...
            <td rowspan="3">If a 12 hour pattern (lower case h) is used, then the am-pm-of-day pattern (a) must also be used. Note, in the datetime string AM/PM must be upper case.</td>
