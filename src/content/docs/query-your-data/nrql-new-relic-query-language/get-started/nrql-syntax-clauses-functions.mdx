...
Here is a listing of the available functions in NRQL. The definitions below contain example NRQL queries.
...
<CollapserGroup>
  ...
  >
    Use the `getField()` function to extract a field from compound data types, such as [metric data](/docs.newrelic.com/docs/telemetry-data-platform/understand-data/new-relic-data-types/#metrics).
