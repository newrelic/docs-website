...
<CollapserGroup>
  ...
  >
    ...
    * 'base64': Uses the [RFC4648 base64 standard](https://datatracker.ietf.org/doc/html/rfc4648#section-4)
    * 'base64mime': Uses the [RFC2045 base64 standard (MIME)](https://datatracker.ietf.org/doc/html/rfc2045)
    * 'base64url': Uses the [RFC4648 base64 standard with URL and filename safe alphabet](https://datatracker.ietf.org/doc/html/rfc4648#section-5)
