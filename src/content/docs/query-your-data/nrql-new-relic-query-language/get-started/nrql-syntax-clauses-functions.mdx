...
<CollapserGroup>
  ...
  >
    ...
    - We support the following relative time ranges: `NOW`, `YESTERDAY`, `TODAY`, `SUNDAY`, `MONDAY`, `TUESDAY`, `WEDNESDAY`, `THURSDAY`, `FRIDAY`, `SATURDAY`, `LAST`, `THIS YEAR`, `QUARTER`, `MONTH`, `WEEK`, `DAY`, `HOUR`, `MINUTE`, `SECOND`.
  </Collapser>
