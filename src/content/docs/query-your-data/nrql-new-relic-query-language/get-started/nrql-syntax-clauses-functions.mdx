...
You can also [add comments to queries](/docs/query-your-data/nrql-new-relic-query-language/get-started/introduction-nrql-how-nrql-works#comments) to help your team better understand queries. 
