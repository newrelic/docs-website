...
* [How to use NRQL](/docs/query-data/nrql-new-relic-query-language/getting-started/introduction-nrql-how-nrql-works): explains some basic NRQL syntax rules, and how to use it to query your data
