...
* Loads of curated views initiated by a user (for example, when you load an <InlinePopup type="apm" /> UI page, the distributed tracing UI, a browser monitoring UI page, or any UI that returns data about your organization).
