...
Our New Relic query language, NRQL, has rate limits in place for each New Relic organization to ensure that our customers' rate of querying doesn't affect other customers.
