...
In this tutorial, you'll learn faceting by case, advanced aggregation functions, the value of the `EXTRAPOLATE` keyword, filtering aggregation functions, and how to override values. Specifically, you'll learn how to use:
