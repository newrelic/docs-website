...
<Tabs>
	<TabsBar>
        ...
        <TabsBarItem id="3">
            3. Filter by specific attributes
        </TabsBarItem>
    </TabsBar>
...
### 6. Use faceted queries

<Tabs>
	<TabsBar>
        <TabsBarItem id="1">
            1. Use the 'FACET' clause
        </TabsBarItem>
        <TabsBarItem id="2">
            2. Use the 'LIMIT' clause
        </TabsBarItem>
        <TabsBarItem id="3">
            3. Render your charts differently
        </TabsBarItem>
        <TabsBarItem id="4">
