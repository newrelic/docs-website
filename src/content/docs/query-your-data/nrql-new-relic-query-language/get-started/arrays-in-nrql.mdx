...
As part of New Relic’s support for Open Telemetry Protocol, OTLP, attributes can contain arrays.
...
<CollapserGroup>
  ...
  >
    ...
    <CollapserGroup>
      <Collapser title="Get an element from an array">
  ...
  >
    ...
    <CollapserGroup>
      <Collapser title="Get an array's length">
  ...
  >
    ...
    <CollapserGroup>
      <Collapser title="Check if array contains an element">
