...
![Image of a chart using clamping with both min and max](src/images/clamp.png 'clamp.png')
...
![Image of a chart using rounding functions.](src/images/floor-round-ceil.png 'floor-round-ceil.png')

<figcaption>
  Sample graph showing raw data, with floor, round, and ceiling functions
  applied.
</figcaption>
...
<Callout variant="tip">
  This can also be used to test whether something returns NULL or zero. `(zero)
  OR 1` returns 0. `(NULL) OR 1` returns 1.
</Callout>
