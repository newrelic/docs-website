...
![Image of a chart using clamping with both min and max](./images/clamp.png "clamp.png")
...
![Image of a chart using rounding functions.](./images/floor-round-ceil.png "floor-round-ceil.png")
