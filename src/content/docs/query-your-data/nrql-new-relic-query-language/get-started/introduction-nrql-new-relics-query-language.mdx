...
* To answer a specific question for the purpose of troubleshooting or business analysis
* To set up [NRQL-based alerts](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-nrql-alert-conditions) (our primary and most powerful type of alert)
...
* The [query builder](/docs/chart-builder/use-chart-builder/get-started/introduction-chart-builder) in the UI
* When building [NRQL-based alerts](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-nrql-alert-conditions/)
* Our [NerdGraph API](/docs/apis/graphql-api/tutorials/nerdgraph-graphiql-nrql-tutorial), which gives you more powerful features than querying in the UI (for example, [cross-account querying](/docs/apis/nerdgraph/examples/nerdgraph-nrql-tutorial#cross-account-query), and [asynchronous queries](/docs/apis/nerdgraph/examples/async-queries-nrql-tutorial))
