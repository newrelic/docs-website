...
* Set up [NRQL-based alerts](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/nrql-alert-conditions) (our primary and most powerful type of alert)
...
You can use NRQL to build [NRQL-based alerts](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/nrql-alert-conditions/), our primary and most powerful alert type. This will help to notify you of issues and help you address them in a timely fashion.
  </Collapser>
  <Collapser
