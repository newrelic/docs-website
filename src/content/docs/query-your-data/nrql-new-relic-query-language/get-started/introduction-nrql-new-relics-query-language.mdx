...
NRQL is an acronym of New Relic query language. It's a query language similar to ANSI SQL ([see the syntax](/docs/query-your-data/nrql-new-relic-query-language/get-started/introduction-nrql-new-relics-query-language#syntax)), and is used to retrieve detailed New Relic data and get insight into your applications, hosts, and business-important activity. NRQL can help you:
...
NRQL is a powerful tool, and it's used in many places to access your data. Those places include: 
