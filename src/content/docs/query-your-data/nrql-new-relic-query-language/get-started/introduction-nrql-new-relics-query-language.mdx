...
One way to [query your New Relic data](/docs/using-new-relic/data/understand-data/query-new-relic-data) is with the New Relic Query Language (NRQL). This document will introduce you to what NRQL is, why you'd use it, and basic syntax rules.
