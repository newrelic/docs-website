...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="agent"
  >
A New Relic agent is an installable piece of software that integrates with multiple types of technologies (for example, web frameworks, host operating systems, or database types) and reports data to New Relic, usually on a specific cadence. We have APM agents, an infrastructure agent, a browser monitoring agent, and mobile monitoring agents. The integrations included with our agents are just some of [our many integrations](https://newrelic.com/instant-observability). 
...
At New Relic, "integration" refers to any software technology that New Relic can make a connection to. So, for example, our agents contain various types of integrations (ways to report data from various app frameworks, or operating systems, or types of database services). Other integrations are configurations that allow a third-party service (for example, AWS Lambda or PagerDuty) to send data to us. 

All our integrations can be found at [New Relic Instant Observability](https://newrelic.com/instant-observability/).
  </Collapser>
