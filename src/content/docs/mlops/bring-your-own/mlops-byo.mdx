...
3. **View your data in the New Relic Platform:**
   ...
   * **Query your data:** Use the [data explorer](/docs/query-your-data/explore-query-data/browse-data/introduction-data-explorer) to view the data you sent, or use the following queries on the [query builder](/docs/query-your-data/explore-query-data/query-builder/introduction-query-builder/):
