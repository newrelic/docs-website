...
1. **Get your API key:** Use the [license key](/docs/apis/intro-apis/new-relic-api-keys/#ingest-license-key) for the New Relic account you want your data to be associated with. 
