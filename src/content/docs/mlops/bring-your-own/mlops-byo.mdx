...
* **Inference data:** Stream your model’s features and prediction values. Inference data is streamed as a [custom event](/docs/data-apis/ingest-apis/introduction-event-api/) named InferenceData.
* **Data metrics:** Instead of sending all your raw inference data, select the aggregated statistics option over the features and predictions (for example, min, max, average, or percentile). They will be sent automatically as [metrics](/docs/data-apis/ingest-apis/metric-api/introduction-metric-api/).
* **Custom metrics:** Calculate your own metrics, monitor your model performance or model data, and stream them to New Relic using the record_metrics function. They will be sent as [metrics](/docs/data-apis/ingest-apis/metric-api/introduction-metric-api/).
...
![An image of the New Relic MLOps dashboard.](../../../../images/model-performance-monitoring_screenshot-full_predictions-cachetest2.webp "An image of the model performance and predictions in New Relic")
...
![An image of the New Relic MLOps dashboard.](../../../../images/model-performance-monitoring_screenshot-full_performance-drift-cachetest2.webp "An image of the model and data drift in New Relic")
...
![An image of the New Relic MLOps dashboard.](../../../../images/model-performance-monitoring_screenshot-full_model-features.webp "An image of the model features in New Relic")

![An image of the New Relic MLOps dashboard.](../../../../images/model-performance-monitoring_screenshot-full_feature-distribution.webp "An image of the feature distribution in New Relic")

![An image of the New Relic MLOps dashboard.](../../../../images/model-performance-monitoring_screenshot-full_standard-deviation.webp "An image of the model count, missing values, and standard deviation in New Relic")

## How to start monitoring your ML model performance [#get-benefits]

First, use the [getting started](/docs/mlops/bring-your-own/getting-started-byo/) documentation to start streaming your model data. Then, click on **Model Performance** in the **All Capabilities** page in the New Relic UI (don't forget to pin it), and you will see your model performance view based on the data your model is sending.

![An image of the New Relic MLOps dashboard.](../../../../images/model-performance-monitoring_screenshot-full_model-performance-tab.webp "An image of the model performance tab in the New Relic navigation menu")
