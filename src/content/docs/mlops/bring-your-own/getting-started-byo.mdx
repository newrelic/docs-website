...
Get your [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) (also referenced as `ingest - license`) and set it as environment variable: `NEW_RELIC_INSERT_KEY`. [Click here](https://docs.newrelic.com/docs/apis/intro-apis/new-relic-api-keys/#license-key) for more details and instructions.
