...
New Relic now offers an [model performance monitoring](/docs/alerts-applied-intelligence/mlops/get-started/intro-mlops/) integration with DagsHub to monitor and analyze your machine learning training metrics in real-time.
