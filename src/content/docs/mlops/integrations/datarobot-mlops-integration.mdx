...
![A flowchart showing how data moves from Datarobot to New Relic.](src/images/algorithmia-flow.png 'Datarobot to New Relic data flow')
...
from newrelic_telemetry_sdk import GaugeMetric, MetricClien
    t
