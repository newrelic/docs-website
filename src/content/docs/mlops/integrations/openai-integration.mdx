...
![OpenAI dashboard](./src/images/model-performance-monitoring_screenshot-crop_openai-dashboard-1.webp "OpenAI dashboard")
...
2. Click on **Model Performance**.
3. Search under **Applications**.
