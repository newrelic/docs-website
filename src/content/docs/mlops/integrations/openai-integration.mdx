...
This installation method has been replaced by our new AI monitoring integration. We recommend using that integration instead for new installations. [See our docs to get started](/docs/ai-monitoring/intro-to-ai-monitoring/).
</Callout>
