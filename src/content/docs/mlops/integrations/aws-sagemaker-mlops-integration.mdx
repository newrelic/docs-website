...
* HTTP endpoint URL - US datacenter (default): `https://aws-api.newrelic.com/cloudwatch-metrics/v1`
* HTTP endpoint URL - EU datacenter: `https://aws-api.eu01.nr-data.net/cloudwatch-metrics/v1`
* HTTP endpoint URL - JP datacenter: `https://aws-api.jp.nr-data.net/cloudwatch-metrics/v1`
