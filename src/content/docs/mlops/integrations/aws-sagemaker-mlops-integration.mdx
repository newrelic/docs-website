...
![Sagemaker, Cloudwatch, and New Relic flow](src/images/aws-sm-flow.png 'Sagemaker, Cloudwatch, and New Relic flow.png')
...
<Callout variant="important">
  Each metric sent to CloudWatch is automatically sent to New Relic's metric
  table in NRDB, according to the namespace filter. You can always query them
  using NRQL: ``` FROM Metric SELECT * WHERE
  aws.Namespace='/aws/sagemaker/Endpoints' LIMIT MAX SINCE 1 WEEK AGO ```
</Callout>
...
<Callout variant="important">
  You can view each entity's metrics in a dashboard that's created automatically
  when the metrics arrive at the New Relic.
</Callout>
...
<table>
  <thead>
    <tr>
      <th style={{ width: '350px' }}>New Relic entity</th>
      <th>Namespace</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>Machine learning endpoint</td>
      <td>`/aws/sagemaker/Endpoints`, `AWS/SageMaker`</td>
    </tr>
    <tr>
      <td>Machine learning model data</td>
      <td>`aws/sagemaker/Endpoints/data-metrics`</td>
    </tr>
    <tr>
...
![Sagemaker machine learning entities](src/images/aws-sm-02.png 'Sagemaker machine learning entities.png')

- The dashboard for the metrics of the endpoint from one of the Amazon SageMaker entities

![Dashboard for the machine learning endpoint](src/images/aws-sm-03.png 'Dashboard for the for the machine learning endpoint')

- The dashboard for the model data entity

![Dashboard for the model data entity](src/images/aws-sm-04.png 'Dashboard for the model data entity.png')
