...
import modelperformancemonitoringSuperwiseDashboard from 'images/model-performance-monitoring_screenshot-crop_superwise-dashboard.png'

Superwise includes an [model performance monitoring](/docs/alerts-applied-intelligence/mlops/get-started/intro-mlops/) integration with New Relic to help users add the state of their AI as monitored by Superwise to their centralized operational view on New Relic.
...
1. **Login into your New Relic account:** Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > + Add more data**.
...
4. **Create two access tokens:**
    * Once you select an Account ID, you'll see the New Relic Integration screen. Under **Model Metrics Data**, click **Create a key**. This generates a [New Relic license key](/docs/apis/intro-apis/new-relic-api-keys/#ingest-license-key).
