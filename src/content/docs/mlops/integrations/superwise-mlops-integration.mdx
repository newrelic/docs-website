...
import superwise01 from 'images/superwise01.png'

import superwise2 from 'images/superwise2.png'

Superwise now offers an [model performance monitoring](/docs/alerts-applied-intelligence/mlops/get-started/intro-mlops/) integration with New Relic to help users add the state of their AI as monitored by Superwise to their centralized operational view on New Relic.
