...
4. **Create two access tokens:**
    * Once you select an Account ID, you'll see the New Relic Integration screen. Under **Model Metrics Data**, click **Create a key**. This generates a [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key).
