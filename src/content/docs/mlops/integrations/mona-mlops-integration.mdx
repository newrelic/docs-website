...
6. **Select or create an API key:** Now go back to New Relic and from the New Relic integration page, create a processed [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) (or select an existing key) under **Processed contextual data**. Go back to Mona and enter this key in the **Ingest license key** field.
