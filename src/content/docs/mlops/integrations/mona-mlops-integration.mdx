...
Mona now offers an [model performance monitoring](/docs/alerts-applied-intelligence/mlops/get-started/intro-mlops/) integration with New Relic so that you can add the state of your AI as monitored by Mona to your centralized operational view on New Relic.
