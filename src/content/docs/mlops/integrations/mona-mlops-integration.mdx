...
1. **Log into your New Relic account:** From **[one.newrelic.com](https://one.newrelic.com) > Explorer**. On the upper hand corner, on the main navigation menu, click on **+Add more data**.
