...
Mona now offers an [MLOps](/docs/alerts-applied-intelligence/mlops/get-started/intro-mlops/) integration with New Relic so that you can add the state of your AI as monitored by Mona to your centralized operational view on New Relic.
...
6. **Select or create an API key:** Now go back to New Relic and from the New Relic integration page, create a processed [license key](/docs/apis/intro-apis/new-relic-api-keys/#ingest-license-key) (or select an existing key) under **Processed contextual data**. Go back to Mona and enter this key in the **Ingest license key** field.

![Create ingest key.](src/images/mona01.png 'Create ingest key')
...
![Create API key.](src/images/mona02.png 'Create API key')
...
<Callout variant="Sending Older Insights">
  New Relic's Incident Intelligence can only receive new insights which first
  appeared in the last 24 hours. Insights earlier than that will not be accepted
  by New Relic.
</Callout>
...
![Anayze Mona dashboards.](src/images/mona03.png 'Anayze Mona dashboards')
