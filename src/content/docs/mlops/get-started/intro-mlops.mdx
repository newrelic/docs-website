...
To use model performance monitoring within [applied intelligence](https://docs-website-kr.netlify.app/kr/docs/new-relic-solutions/get-started/intro-new-relic/) at New Relic, you have a few different options:
