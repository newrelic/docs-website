...
* **User model.** If your New Relic organization has had its users converted to be on [our newer user model](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-user-models), you can no longer use API calls that create or govern users on our [original user model](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-user-models). The API impacts are:
