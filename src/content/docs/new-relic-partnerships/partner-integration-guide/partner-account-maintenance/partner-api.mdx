...
* **User model.** If your New Relic organization has had its users converted to be on [our newer user model](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-user-models), you can no longer use Partnership API calls that manage accounts or users. Here are details on what you'd use instead:
...
To start using the Partnership API, see the [Partner API reference docs](/docs/new-relic-partnerships/partnerships/partner-api/partner-api-reference).
