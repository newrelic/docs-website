...
<Callout variant="tip">
  If you do not have a partnership organization, you can only have one parent account. For more information, see [Manage apps or users with child accounts.](/docs/accounts/install-new-relic/account-setup/manage-apps-or-users-sub-accounts)
</Callout>
