...
New Relic organizations set up as <DoNotTranslate>**partnership accounts**</DoNotTranslate> have access to an enhanced hierarchical way of organizing their account structure.
...
* An actual <DoNotTranslate>**partnership**</DoNotTranslate>: A partnership refers to managed service providers or resellers, who offer New Relic products to their customers. Heroku is one example of such a New Relic partner.
* A <DoNotTranslate>**customer partnership**</DoNotTranslate>: some of our larger organizations also make use of our partnership account structure. We call these customers "customer partnerships."
...
<DoNotTranslate>**Do not monitor your own applications from the partnership owner account.**</DoNotTranslate> Instead, create an account within the partnership and monitor apps from that account.
  ...
  <thead>
    <tr>
      <th style={{ width: "200px" }}>
        <DoNotTranslate>**Child accounts**</DoNotTranslate>
      </th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * <DoNotTranslate>**Exception:**</DoNotTranslate> Reseller partnerships receive consolidated billing for all accounts under the partnership.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        * <DoNotTranslate>**Exception:**</DoNotTranslate> Child account users won't receive alert emails or weekly report emails unless they are explicitly granted permission on these child accounts.
      </td>
    </tr>
  </tbody>
</table>
