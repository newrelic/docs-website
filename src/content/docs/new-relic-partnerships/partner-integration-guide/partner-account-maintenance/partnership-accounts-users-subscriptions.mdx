...
<Callout variant="tip">
  If you don't have a partnership organization, you can only have one parent
  account. For more information, see [Manage apps or users with child
  accounts.](/docs/accounts/install-new-relic/account-setup/manage-apps-or-users-sub-accounts)
</Callout>

![partnership-hierarchy.png](src/images/partnership-hierarchy.png 'partnership-hierarchy.png')
...
<Callout variant="tip">
  Many of the Partnership API calls return an [account
  status](/docs/accounts-partnerships/partnerships/partner-api/partnership-api-account-object#account-status-definitions)
  as part of the XML.
</Callout>
...
<Callout variant="tip">
  Many of the Partnership API calls return a [subscription
  status](/docs/accounts-partnerships/partnerships/partner-api/partnership-api-subscription-object#subscription-state)
  as part of the XML.
</Callout>
