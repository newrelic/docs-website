...
<figcaption>
  <DNT>**New Relic partner co-branding example:**</DNT> Here is an example of co-branding with New Relic by using a header.
</figcaption>
...
3. Post the three files to publicly accessible locations hosted by the partner. Use https so your customers do not see any mixed content warnings. For example:
   ...
   ```
4. Enter the URLs for the header, footer, and CSS page locations into the appropriate fields in the New Relic <DNT>**Partnership**</DNT> console.
...
Partners can optionally display a custom subdomain; for example, <DNT>**yourcompany.newrelic.com**</DNT>, to customers accessing New Relic accounts. To arrange this, contact New Relic's Business Enablement team.
