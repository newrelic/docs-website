...
![partnership heroku example](src/images/screen-co-branding-heroku.png 'partnership heroku example')

<figcaption>
  **New Relic partner co-branding example:** Here is an example of co-branding
  with New Relic by using a header.
</figcaption>
