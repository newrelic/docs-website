...
<DNT>**Tip:**</DNT> We've found that partners typically complete integration with one to two developer weeks of effort. For more information, see [Typical component tasks](#tasks).
...
<table>
  <thead>
    <tr>
      ...
      <th>
        <DNT>**Component tasks of a typical partner integration**</DNT>
      </th>
    </tr>
  </thead>
