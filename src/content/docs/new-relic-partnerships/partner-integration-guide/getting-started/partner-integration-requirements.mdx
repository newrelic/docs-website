...
<table>
  <thead>
    <tr>
      <th width={200}>
        <DoNotTranslate>**What**</DoNotTranslate>
      </th>

      <th>
        <DoNotTranslate>**How**</DoNotTranslate>
      </th>
    </tr>
  </thead>
...
<DoNotTranslate>**Tip:**</DoNotTranslate> We've found that partners typically complete integration with one to two developer weeks of effort. For more information, see [Typical component tasks](#tasks).
...
<table>
  <thead>
    <tr>
      ...
      <th>
        <DoNotTranslate>**Component tasks of a typical partner integration**</DoNotTranslate>
      </th>
    </tr>
  </thead>
