...
Once a [New Relic account cancellation](/docs/accounts-partnerships/accounts/account-maintenance/cancel-or-delete-your-new-relic-account) takes effect, New Relic stops accepting data from agents reporting for the account. Customers may continue to access their data on New Relic until it is purged in accordance with the [data retention policy](/docs/accounts-partnerships/accounts/account-billing-usage/data-retention) corresponding to the product level.
