...
* The partner-specified portion of the URL is identified from the <DoNotTranslate>**Settings**</DoNotTranslate> tab of New Relic's [Partner Portal](/docs/accounts-partnerships/partnerships/getting-started/using-partner-portal).
...
<CollapserGroup>
  ...
  >
    ...
    <DoNotTranslate>**Return codes:**</DoNotTranslate>
