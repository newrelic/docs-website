...
When using an Admin user's API key, see the documentation for [Admin user's API keys and partnerships](/docs/apis/rest-api-v2/requirements/admin-users-api-key-partnerships).
