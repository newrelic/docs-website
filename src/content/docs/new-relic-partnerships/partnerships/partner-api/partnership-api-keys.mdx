...
To view or regenerate your keys, log into the New Relic site using your partnership owner credentials, then go to <DNT>**Partnerships > Edit settings**</DNT>. The keys are listed at the bottom of the page.
...
<DNT>**Recommendation:**</DNT> Keys used to access the New Relic site should be regenerated on a regular basis as a security best practice. The change from regenerating a key takes place immediately.
