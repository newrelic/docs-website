...
The Partner API requires that you authenticate with the [REST API key](/docs/apis/getting-started/intro-apis/understand-new-relic-api-keys#rest-api) that is specific to your [partnership owner account](/docs/new-relic-partnerships/partner-integration-guide/partner-account-maintenance/partnership-accounts-users-subscriptions#partner-owner). You cannot use an [Admin user's API key](/docs/apis/getting-started/intro-apis/understand-new-relic-api-keys#admin-api) with the Partner API, nor can you use the REST API key from another New Relic account.
