...
<DNT>**Before using the Partnership API, first read [the requirements](/docs/new-relic-partnerships/partner-integration-guide/partner-account-maintenance/partner-api/).**</DNT>
...
For some New Relic organizations, child accounts can also be created via the parent account's [<DNT>**Account settings**</DNT> page](/docs/accounts/install-new-relic/account-setup/manage-apps-or-users-sub-accounts) in the New Relic UI.
...
<table>
  ...
  <tbody>
    <tr>
      <td>
        <DNT>**Create**</DNT> a child account with the given parameters.
      </td>
