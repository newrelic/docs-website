  ...
  >
    **Request:**
    ...
    curl -X GET \
         ...
         https://rpm.newrelic.com/api/v2/partners/<span style="background-color: rgb(153, 221, 221);"><i>:PARTNER_ID</i></span>/accounts/<var>:ACCOUNT_ID</var>/subscriptions
    ```
    ...
    **Response:**
    ...
    ```
    {
      "subscriptions": [
      {
        "id": <span style="background-color: rgb(153, 221, 221);"><i>:SUBSCRIPTION_ID</i></span>,
        "starts_on": "2016-05-16",
        "expires_on": null,
        "annual_renewal_on": null,
        "products": [
