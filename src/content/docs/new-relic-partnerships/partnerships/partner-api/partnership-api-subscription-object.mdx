  ...
  >
    **Request:**
    ...
    curl -X GET \
         ...
         https://rpm.newrelic.com/api/v2/partners/<span style="background-color: rgb(153, 221, 221);">:PARTNER_ID</span>/accounts/<var>:ACCOUNT_ID</var>/subscriptions
    ```
    ...
    **Response:**
    ...
    ```
    {
      "subscriptions": [
      {
        "id": <span style="background-color: rgb(153, 221, 221);">:SUBSCRIPTION_ID</span>,
        "starts_on": "2016-05-16",
        "expires_on": null,
        "annual_renewal_on": null,
        "products": [
