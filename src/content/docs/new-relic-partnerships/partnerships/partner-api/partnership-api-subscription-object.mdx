  ...
  >
    **Request:**
    ...
    curl -X GET \
         ...
         https://rpm.newrelic.com/api/v2/partners/<font color="#000000"><span style="background-color: rgb(153, 221, 221);"><i>:PARTNER_ID</i></span></font>/accounts/<var>:ACCOUNT_ID</var>/subscriptions
    ```
    ...
    **Response:**
    ...
    ```
    {
      "subscriptions": [
      {
        "id": <font color="#000000"><span style="background-color: rgb(153, 221, 221);"><i>:SUBSCRIPTION_ID</i></span></font>,
        "starts_on": "2016-05-16",
        "expires_on": null,
        "annual_renewal_on": null,
        "products": [
