...
Whether your intention is to auto-deploy or allow the user to do so, the [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) from the account creation payload is required for this operation. If you are planning a manual deploy, it is helpful to make the license key easily available to your users. This is a convenience for your users. The key is available by logging into the account.
