...
* You may not have access to using this specific object. Before using, first read [the requirements](/docs/new-relic-partnerships/partner-integration-guide/partner-account-maintenance/partner-api/).
...
<CollapserGroup>
  ...
  >
    ...
    The account name attribute is <DoNotTranslate>**required**</DoNotTranslate> for new accounts.
...
The account API does not include an attribute to create a child account. Instead, to create child accounts, use the parent account's [<DoNotTranslate>**Account settings**</DoNotTranslate> page](/docs/accounts/install-new-relic/account-setup/manage-apps-or-users-sub-accounts) in the New Relic UI.
...
<table>
  ...
  <tbody>
    <tr>
      <td>
        List (<DoNotTranslate>**index**</DoNotTranslate>) all accounts of a partner.
      </td>
    ...
    <tr>
      <td>
        <DoNotTranslate>**Show**</DoNotTranslate> the attributes of an account.
      </td>
    ...
    <tr>
      <td>
        <DoNotTranslate>**Update**</DoNotTranslate> the attributes of an account.
      </td>
    ...
    <tr>
      <td>
        <DoNotTranslate>**Create**</DoNotTranslate> an account with the given parameters.
      </td>
    ...
    <tr>
      <td>
        <DoNotTranslate>**Cancel**</DoNotTranslate> an account.
      </td>
...
<DoNotTranslate>**Note that this is just an example, and that for some accounts, the [`users` and `subscriptions` attributes](#account-attributes) are unnecessary and are ignored.**</DoNotTranslate>
...
Here are examples of calls using the Partnership API account object. <DoNotTranslate>**Note that these are examples, and that for some accounts, the [`users` and `subscriptions` attributes](#account-attributes) don't apply and will be ignored.**</DoNotTranslate>
