...
<CollapserGroup>
  ...
  >
    ...
    The account name attribute is <DNT>**required**</DNT> for new accounts.
...
The account API does not include an attribute to create a child account. Instead, to create child accounts, use the parent account's [<DNT>**Account settings**</DNT> page](/docs/accounts/install-new-relic/account-setup/manage-apps-or-users-sub-accounts) in the New Relic UI.
...
<table>
  ...
  <tbody>
    <tr>
      <td>
        List (<DNT>**index**</DNT>) all accounts of a partner.
      </td>
    ...
    <tr>
      <td>
        <DNT>**Show**</DNT> the attributes of an account.
      </td>
    ...
    <tr>
      <td>
        <DNT>**Update**</DNT> the attributes of an account.
      </td>
    ...
    <tr>
      <td>
        <DNT>**Create**</DNT> an account with the given parameters.
      </td>
...
<DNT>**Note that this is just an example, and that for some accounts, the [`users` and `subscriptions` attributes](#account-attributes) are unnecessary and are ignored.**</DNT>
...
Here are examples of calls using the Partnership API account object. <DNT>**Note that these are examples, and that for some accounts, the [`users` and `subscriptions` attributes](#account-attributes) don't apply and will be ignored.**</DNT>
