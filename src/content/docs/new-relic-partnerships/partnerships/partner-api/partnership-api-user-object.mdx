...
This is the list of attributes in the user object. Ensure you assign the [<DNT>**owner**</DNT>](#attr-owner) attribute to one user when creating a New Relic account.
...
<CollapserGroup>
  ...
  >
    ...
    This attribute is <DNT>**required**</DNT> for new users.
  ...
  >
    ...
    A flag to indicate whether this user is the [owner](/docs/accounts-partnerships/accounts/account-setup/users-roles) of the account. When creating a New Relic account, you <DNT>**must**</DNT> assign one user an <DNT>**owner**</DNT> role.
  </Collapser>
...
<table>
  ...
  <tbody>
    <tr>
      <td>
        <DNT>**List**</DNT> (index) all users of an account.
      </td>
    ...
    <tr>
      <td>
        <DNT>**Update**</DNT> the role of a person in the account.
      </td>
    ...
    <tr>
      <td>
        <DNT>**Create**</DNT> (add) a user to an account.
    ...
    <tr>
      <td>
        <DNT>**Delete**</DNT> a user from an account.
...
<DNT>**Before using this API, read the [requirements](/docs/new-relic-partnerships/partner-integration-guide/partner-account-maintenance/partner-api/).**</DNT>
