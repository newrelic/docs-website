...
This is the list of attributes in the user object. Ensure you assign the [<DoNotTranslate>**owner**</DoNotTranslate>](#attr-owner) attribute to one user when creating a New Relic account.
...
<CollapserGroup>
  ...
  >
    ...
    This attribute is <DoNotTranslate>**required**</DoNotTranslate> for new users.
  ...
  >
    ...
    A flag to indicate whether this user is the [owner](/docs/accounts-partnerships/accounts/account-setup/users-roles) of the account. When creating a New Relic account, you <DoNotTranslate>**must**</DoNotTranslate> assign one user an <DoNotTranslate>**owner**</DoNotTranslate> role.
  </Collapser>
...
<table>
  ...
  <tbody>
    <tr>
      <td>
        <DoNotTranslate>**List**</DoNotTranslate> (index) all users of an account.
      </td>
    ...
    <tr>
      <td>
        <DoNotTranslate>**Update**</DoNotTranslate> the role of a person in the account.
      </td>
    ...
    <tr>
      <td>
        <DoNotTranslate>**Create**</DoNotTranslate> (add) a user to an account.
    ...
    <tr>
      <td>
        <DoNotTranslate>**Delete**</DoNotTranslate> a user from an account.
...
<DoNotTranslate>**Before using this API, read the [requirements](/docs/new-relic-partnerships/partner-integration-guide/partner-account-maintenance/partner-api/).**</DoNotTranslate>
