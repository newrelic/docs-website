...
One additional action you should take is adjusting the time picker. This lets you view how your data has changed over time, so you can track when a change first occurred. Let's look at these metrics graphs toggled between 3 hours ago and 6 hours ago.
