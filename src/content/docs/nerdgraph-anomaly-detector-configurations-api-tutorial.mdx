...
* <DoNotTranslate>**signalName**</DoNotTranslate>: A string representing either a global threshold, named <DoNotTranslate>**globalDefault**</DoNotTranslate>, or a signal threshold (for example, "throughput," "errorRate," etc)
* <DoNotTranslate>**domainType**</DoNotTranslate>: The global threshold does not have a domain type.
