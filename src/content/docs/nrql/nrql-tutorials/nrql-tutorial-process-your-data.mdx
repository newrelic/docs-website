...
You can now control your data and manipulate it to do what you need, allowing you to construct meaningful dashboards and alerts. Next, you'll learn how to specify time ranges using NRQL.
