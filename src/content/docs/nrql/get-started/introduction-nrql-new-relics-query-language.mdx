...
<Tabs>
  ...
  <TabsPages>
    ...
    <TabsPageItem id="nerdgraph-api-nrql-intro">
      ...
      You can also use NRQL with our [NerdGraph API](/docs/apis/graphql-api/tutorials/nerdgraph-graphiql-nrql-tutorial). This lets you run [asynchronous queries](/docs/apis/nerdgraph/examples/async-queries-nrql-tutorial) that aren't available in the UI.
    </TabsPageItem>
  </TabsPages>
</Tabs>
