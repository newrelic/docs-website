...
NRQL is an acronym of New Relic query language. It's a query language similar to ANSI SQL ([see the syntax](/docs/nrql/nrql-syntax-clauses-functions/)), and you can use it to retrieve detailed New Relic data to get insight into your applications, hosts, and business-important activity. NRQL can help you:
