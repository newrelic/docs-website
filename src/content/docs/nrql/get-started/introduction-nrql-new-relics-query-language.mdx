...
The New Relic Query Language (NRQL) is a tool you can use to [query](/docs/using-new-relic/data/understand-data/query-new-relic-data) and understand nearly any type of data, but it can seem overwhelming at first glance. Here's some information to give you a foundational understanding of NRQL, including what it is, how to use it, and tips to help you write more effective queries. Once you've learned about NRQL, you can capture and interpret your data, helping you understand patterns across your data and identify problems as they occur.
...
NRQL is an acronym for New Relic query language. It's a query language similar to ANSI SQL ([see the syntax](/docs/nrql/nrql-syntax-clauses-functions/)), and you can use it to retrieve detailed New Relic data to get insight into your applications, hosts, and business-critical activity. NRQL can help you:

* Create a new chart
* Answer a specific question for the purpose of troubleshooting or business analysis
* Set up [NRQL-based alerts](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-nrql-alert-conditions) (our primary alert type)
...
You can use NRQL to create basic queries, such as fetching rows of data in a raw tabular form that gives insight on individual events. You can also use NRQL to run calculations on the data before the results appear, such as crafting funnels based on how end users interact with your site or application.

New Relic uses NRQL internally to generate many of the charts and dashboards in the UI.
...
<CollapserGroup>
  ...
  * Go to <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert conditions (Policies) > (select a policy) > Add a condition**</DNT>. Click <DNT>**NRQL**</DNT>, and then <DNT>**Next, define thresholds**</DNT>.
    ...
    You can use NRQL to build [NRQL-based alerts](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-nrql-alert-conditions/), our primary alert type. NRQL-based alerts notify you of issues so you can respond to them.
  </Collapser>
...
If you're already familiar with writing SQL queries, NRQL has many similarities. Here's a quick breakdown of the structure of a NRQL query:
...
* [`Log` data type](/docs/using-new-relic/data/understand-data/new-relic-data-types#log-data) (data from our log management capabilities)
...
To learn more, see [how to use NRQL](/docs/query-your-data/nrql-new-relic-query-language/get-started/introduction-nrql-how-nrql-works/) and [how to use charts and dashboards with NRQL](/docs/query-your-data/nrql-new-relic-query-language/get-started/charts-and-dashboards-with-nrql/). To start using NRQL right away, try our [guided NRQL tutorial](/docs/query-your-data/nrql-new-relic-query-language/get-started/introduction-nrql-tutorial/).
