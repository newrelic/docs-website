...
Before using any tool, the best thing to do is to learn how to use it. There's a process to creating, structuring, and writing queries with NRQL. Understanding the rules of querying with NRQL enables you to get the most from your data. Even if you've never queried anything before, just a basic understanding the rules allows you to access (almost) any data you need and visualize them in [charts](/docs/query-your-data/explore-query-data/use-charts/use-your-charts) and [dashboards](/docs/query-your-data/explore-query-data/dashboards/introduction-dashboards).
...
Next, you choose an [attribute](/docs/using-new-relic/welcome-new-relic/get-started/glossary#attribute) using `SELECT`, and the query looks as follows:
...
* You choose `Transaction` as the data typ. 
