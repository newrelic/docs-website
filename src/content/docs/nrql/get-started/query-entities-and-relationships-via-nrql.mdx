...
If you're an **Advanced Compute** customer, you can now use **NRQL to directly query entity and relationship data in NRDB** alongside your telemetry data. This unified access enables faster troubleshooting and deeper system insights.
