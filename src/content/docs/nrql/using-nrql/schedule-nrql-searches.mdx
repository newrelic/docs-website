...
* **User permissions**: [Workflow Automation](/docs/alerts/get-notified/alert-event-workflows/#requirements) permissions are required to create and manage scheduled searches.
...
* [Explore workflow automation](/docs/alerts/get-notified/alert-event-workflows) for more advanced automation possibilities.
