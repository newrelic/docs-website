...
## Pricing [#pricing]
Users on [Advanced and Core Compute pricing plans](https://newrelic.com/pricing/compute#pricing_plan-compute) may incur additional CCU charges when using the  sliding window function. While this method enhances data analysis by smoothing out fluctuations, its use may lead to increased costs. For further details on pricing, contact our sales team or refer to your Order.
