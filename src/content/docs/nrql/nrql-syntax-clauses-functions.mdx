...
<Collapser
  ...
  This feature is currently provided as part of a preview program pursuant to our [pre-release policies](/docs/licenses/license-information/referenced-policies/new-relic-pre-release-policy).
    ...
    The `FORECAST` clause allows you to project future data trends for line and area charts based on historical data. You can only apply it to queries with a `TIMESERIES` clause.
    By default, the forecast range is set to 20% of the query window, and the historical data span is twice the query window.
  ...
  To learn more about how and when you can use `FORECAST`, see [On-demand forecasting](src/content/docs/query-your-data/explore-query-data/use-charts/on-demand-forecasting/).
  </Collapser>
