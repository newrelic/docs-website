      ...
      <table id="join-types">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              Returns all list values except the last **n**, where **n** is a negative number after the colon(i.e `[:-n]`). In this case, the list value at index `0` will be returned.
            </td>
          ...
          <tr>
            ...
            <td>
              Returns the last **n** list values, where **n** is a negative number before the colon(for example, `[-n:]`). In this case the list value at index `2` will be returned.
            </td>
