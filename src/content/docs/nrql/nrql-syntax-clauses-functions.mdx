  ...
  This feature is currently provided as part of a preview program pursuant to our [pre-release policies](/docs/licenses/license-information/referenced-policies/new-relic-pre-release-policy).
    ...
    * Does not support [metric timeslice data](/docs/data-analysis/metrics/analyze-your-metrics/data-collection-metric-timeslice-event-data#timeslice-data) while in Public Preview.
    ...
    <CollapserGroup>
      ...
      <tr>
        ...
        <tbody>
          ...
          <tr>
            ...
            * **Lower value**: More damping effect to the prediction curve that eventuyally levels out to a flat curve.
      ...
      Use the `USING` keyword to specify how much historical data is to be used to train the model. For example, `PREDICT USING 1 day` uses the query window plus 1 days worth of history to train the model. Make sure the time span is an `integer unit` of time.
      amount of time.
      </Collapser>
    </CollapserGroup>
