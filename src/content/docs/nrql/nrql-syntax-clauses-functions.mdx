...
<CollapserGroup>
  ...
  This feature is currently provided as part of a preview program pursuant to our [pre-release policies](/docs/licenses/license-information/referenced-policies/new-relic-pre-release-policy).
    ...
    * **Time interval**: Matches the data point interval of the time series on the query window, ensuring consistency in data projection.
        ...
        <tbody>
          <tr>
            ...
            <td>
              ...
              * **`seasonality: <season length>`**: Sets the seasonality of the time series to a known season length. Must use `integer units` for the amount of time. Examples: `1 day`, `3 hours`.
