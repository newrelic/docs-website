...
<CollapserGroup>
  ...
  This feature is currently provided as part of a preview program pursuant to our [pre-release policies](/docs/licenses/license-information/referenced-policies/new-relic-pre-release-policy).
    ...
    The `FORECAST` clause allows you to project future data trends for line and area charts based on historical data. The features are:

    * Applies only to queries with a `TIMESERIES` clause.
    * Uses the `TIMESERIES <duration>` as the interval for forecasted data points.
    * Sets the forecast range to 20% of the query window by default.
    * Utilizes two query windows into the past as historical data for generating forecasts by default.
  ...
  For more customization options, see [Customize your dashboard](/docs/query-your-data/explore-query-data/dashboards/manage-your-dashboard#dash-manage).
    ...
    You can additionally append `BY <time range>` and `USING <a historical data span>` to refine the forecast to your specific needs. 
  ...
  To learn more about how and when you can use `FORECAST`, see [On-demand forecasting](/docs/query-your-data/explore-query-data/use-charts/on-demand-forecasting/).
  </Collapser>
