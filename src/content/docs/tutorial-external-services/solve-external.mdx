...
* Any spikes in the charts. 
* Obviously high response rate or throughput.
* If response rate and throughput hit highs and lows around the same time.
...
In the screenshot above, nothing stands out except the throughput is a bit higher than you would have expected. Not anything to worry about immediately.
    </Step>
    <Step>
...
Not every solution comes directly from errors or anomalies. Sometimes the root cause can be much more mundane.
