...
You've set up policies and conditions that generate alert events, but you aren't getting notifications for them.

## Solution

1. Check your [muting rules](/docs/alerts/new-relic-alerts/managing-notification-channels/muting-rules-suppress-notifications). The rules you define can mute specific alert events or mute notifications altogether. If you turn off your muting rules and start getting notifications again, you may want to rewrite your rules.
2. Check your [issue creation preference](/docs/alerts/organize-alerts/specify-when-alerts-create-events#preference-options). By default, a single issue record is created per policy. This option sends you the fewest number of notifications. If you want more notifications for each condition or alert event in a policy, change your preferences.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        Add our email to your allow list
      </td>

      <td>
        Many messages can end up in your or your company’s spam filter. To ensure your system recognizes emails sent by us, add [noreply@newrelic.com](mailto:noreply@newrelic.com) and \*@mailer-d.newrelic.com to your allow list or “Safe Senders” list as a trusted email source.
      </td>
    </tr>
