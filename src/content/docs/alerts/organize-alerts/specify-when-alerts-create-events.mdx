...
* <DNT>**Incidents**</DNT>. Incidents are events that describe the symptoms affecting your system over time. See [View alert event details](/docs/alerts/alert-event-management/view-alert-event-details/) for more information.
