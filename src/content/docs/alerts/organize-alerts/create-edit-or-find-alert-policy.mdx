...
<CollapserGroup>
  ...
  >
    ...
    2. From the selected product's index, check whether the entity's color-coded health status is light green with an icon. <img
         title="Alerts v3: alert icons"
         alt="icon-alerts-q-green.png"
         src="/images/accounts_icon_green-question-mark.webp"
       />
