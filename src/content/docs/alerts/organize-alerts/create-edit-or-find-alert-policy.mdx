...
<CollapserGroup>
  ...
  >
    ...
    2. From the policy row, click the ellipses (...) dropdown menu and select <DNT>**Delete**</DNT>.
       ...
       In a deleted policy, [issues](/docs/alerts/alert-event-management/view-alert-event-details) and [incidents](/docs/alerts/alert-event-management/view-alert-event-details) are provided as a read only resource.
  </Collapser>
