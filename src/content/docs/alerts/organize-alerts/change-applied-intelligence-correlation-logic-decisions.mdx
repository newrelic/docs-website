...
You can use the correlation assistant to more quickly analyze [incidents](/docs/alerts/alerts-ai-overview-page#alert-events), create decision logic, and test the logic with a simulation. To use the correlation assistant:
