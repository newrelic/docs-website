  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * [Notifications](/docs/alerts/new-relic-alerts-beta/managing-notification-channels/notification-channels-controlling-where-send-alerts) have been sent based on the selected [incident rollup preference](/docs/alerts/organize-alerts/specify-when-alerts-create-events/).
