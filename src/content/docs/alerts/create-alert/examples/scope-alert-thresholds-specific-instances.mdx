...
2. When creating a [condition](/docs/alerts/create-alert/create-alert-condition/alert-conditions/#create-alert-condition), select [<DNT>**APM**</DNT>](/docs/alerts/new-relic-alerts/configuring-alert-policies/select-product-targets-alert-condition).
