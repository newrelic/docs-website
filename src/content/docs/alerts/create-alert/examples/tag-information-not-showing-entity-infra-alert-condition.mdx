...
[Custom incident description tags](/docs/alerts/create-alert/condition-details/custom-alert-event-descriptions#example) are not being replaced by the values from the event.
