...
You can enrich your anomaly detection configuration with additional metadata to provide further context and add custom incident descriptions that can provide additional instructions to your on-call engineers. Anomaly conditions default to using seasonality that is automatically detected by New Relic; however, you can also configure your own seasonality settings.
...
5. Set the [seasonality](#seasonality).
...
You can compensate for recurring fluctuations in your signals, like peak traffic holidays, by specifying a condition's seasonality. Anomaly detection defaults to automatically calculating each signal's seasonality for you (New Relic calculation) based on several factors including age of data, consistency of data, and regular fluctuations. Sometimes, you may want to set the seasonality to a specific value or turn it off entirely. You can do this by selecting one of the following options:

* <DNT>**New Relic calculation**</DNT> (default): New Relic automatically calculates the seasonality on a per signal basis based on several factors including age of data, consistency of data, and regular fluctuations.
* <DNT>**Hourly**</DNT>: This is useful if you know that your signal has an hourly pattern that you want to use for anomaly detection. Hourly applies to all signals in the condition.
* <DNT>**Daily**</DNT>: This is useful if you know that your signal has an daily pattern that you want to use for anomaly detection. Daily applies to all signals in the condition.
* <DNT>**Weekly**</DNT>: This is useful if you know that your signal has an weekly pattern that you want to use for anomaly detection. Weekly applies to all signals in the condition.
* <DNT>**None**</DNT>: Turn off seasonality completely. This means that New Relic won't take any seasonal patterns into account when evaluating your signals. This applies to all signals in the condition.
