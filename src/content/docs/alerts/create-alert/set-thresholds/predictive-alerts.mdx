...
To enable the <DNT>**Predictive capability**</DNT>, you need to enroll in <DNT>**NRQL predictions**</DNT> (Now in public preview). <DNT>**NRQL predictions**</DNT> provides the query functionality required for evaluation of predictive thresholds.

<Callout variant="tip">
  New Relic currently uses the [Holt-Winters model](https://en.wikipedia.org/wiki/Exponential_smoothing#Triple_exponential_smoothing_(Holt_Winters)) for predicting, which reliably captures hourly, daily, and weekly seasonal patterns and trends in your data.
</Callout>

To enroll in <DNT>**Predictive capability**</DNT>, refer to the **Trial & Preview** section.
...
<Steps>
  ...
  <Step>
    ...
    2. From the <DNT>**Signal behavior**</DNT> section, click <DNT>**Edit**</DNT>. the <DNT>**Set thresholds**</DNT> section opens.
  ...
  To set a static threshold for the alert condition, under <DNT>**Set condition thresholds**</DNT>:
  ...
  <Step>
    ...
    1. Under <DNT>**Set condition thresholds**</DNT>, enable the <DNT>**Predict future behavior**</DNT> toggle.
