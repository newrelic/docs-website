...
<Steps>
  ...
  <Step>
   ### Define your signal
    ...
    In this example, imagine that you have an application with usually steady throughput, and you want an alert notification when the number of transactions starts trending upward. This notification will arrive before throughput becomes an issue.
