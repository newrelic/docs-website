...
To enroll in <DNT>**Predictive capability**</DNT>, navigate to <DNT>**[one.newrelic.com > Administration](https://one.newrelic.com//admin-portal) > Preview & Trails**</DNT> and enable the <DNT>**NRQL predictions**</DNT> feature.
