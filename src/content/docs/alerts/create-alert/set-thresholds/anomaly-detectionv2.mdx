...
| Black dotted line (Baseline) | New Relic's prediction based on historical patterns |
| Light gray band (inner) | Critical threshold — the tighter the band, the more sensitive it is |
| Dark gray band (outer) | Warning threshold (optional) — the wider the band, the less sensitive it is |
| Red areas | Alert events — your signal was outside the gray band for the specified duration |
...
You can create anomaly sensitivity thresholds from an [alert condition](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-nrql-alert-conditions/). Some tips for setting anomaly thresholds:
...
7. Open alert events with a <DNT>**severity level**</DNT>. Choose from the dropdown:
   ...
   **Critical concept:** The signal must stay in violation for your specified duration before creating an alert event. Even if the signal briefly goes outside the gray band, New Relic won't create an alert unless it stays outside for the entire duration you set. This prevents false alarms from short spikes.
   </Callout>
...
Depending on how you defined your NRQL query when creating the alert condition, it may be monitoring many signals, not just one. When working with NRQL, these queries use the [`FACET` clause](/docs/query-your-data/nrql-new-relic-query-language/get-started/nrql-syntax-clauses-functions/#sel-facet). Keep these things in mind:
...
<img
  ...
  src="/images/anomaly-nraisignal-zscore-histogram.png"
/>
...
<img
  ...
  src="/images/anomaly-nraisignal-zscore-timeseries.png"
/>
...
<img
  ...
  src="/images/anomaly-nraisignal-latency-spike.png"
/>
...
<img
  ...
  src="/images/anomaly-nraisignal-stddev-at-spike.png"
/>
...
<img
  ...
  src="/images/anomaly-nraisignal-percentile-stddev.png"
/>
...
<img
  ...
  src="/images/anomaly-nraisignal-model-behavior.png"
/>
...
* **Insufficient data** — new metrics need 2-4 weeks to learn patterns accurately.
