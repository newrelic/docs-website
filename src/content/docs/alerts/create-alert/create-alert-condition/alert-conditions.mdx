...
<Steps>
  ...
  <Step>
    ...
    <Callout variant="tip">
      To set up cross account alerts, select an account from the drop-down list to query for your new alert. Click Multi-account, to select multiple accounts up to 30. 
    </Callout>
