  ...
  <Step>
    ...
    <CollapserGroup>
      ...
      >
        ...
        New Relic's <DNT>**Predictive Alerts**</DNT> analyze historical data to predict future trends. When the predicted trend breaches static thresholds, you receive an alert notification, giving you the opportunity to act before disruptions occur.

        For more information, refer to the [Predictive Alerts documentation](/docs/alerts/create-alert/set-thresholds/predictive-alerts/). If you are already acquainted with the <DNT>**Predictive Alerts**</DNT> feature, perform the following steps to enable it for your alert condition:
