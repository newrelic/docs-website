...
<CollapserGroup>
  ...
  >
    ...
    * Garbage collection CPU time
      ...
      alert events will automatically close when the inverse of the threshold is met, but by using the UI you can also change the time when an [alert event](/docs/new-relic-solutions/get-started/glossary/#alert-incident) force closes for a JVM health metric. Default is 24 hours.
  </Collapser>
