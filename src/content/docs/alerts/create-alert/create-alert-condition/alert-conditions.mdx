  ...
  <Step>
    ...
    <CollapserGroup>
      ...
      >
        ...
        <Callout variant="important">
          When you are creating a cross-account alert condition, the <DNT>**Do not report system health status**</DNT> toggle is disabled by default. To prevent the cross-account alert condition from determining the health status of the associated entity, you can enable the toggle.
        </Callout>
