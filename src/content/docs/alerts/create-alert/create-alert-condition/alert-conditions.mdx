...
<Steps>
  ...
  <Step>
    ...
    <Callout variant="tip">
      To set up cross account alerts, select data account from the drop-down list. And you can only query a data from one account for cross-account alertsat a time.
    </Callout>
