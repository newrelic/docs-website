...
For this example, the chart will show the average `pageviews` for your `WebPortal` application. Click <DNT>**Next**</DNT> and begin configuring your alert condition.
...
<CollapserGroup>
 ...
 >
   ...
   It's essential to give your alert condition a descriptive name. Let's say you name this condition <DNT>**pageviews**</DNT>, and then you create another condition for a completely different application and label that condition <DNT>**pageviews**</DNT> as well. If this occurs, you won't be able to distinguish which condition is for which application. So, make sure to give your condition a specific and unique name. In this case, you'd name this condition <DNT>**pageviews: WebPortal App**</DNT>.
 </Collapser>
...
Under <DNT>**Signal history**</DNT>, you can see the most recent results for the NRQL query you used to create your alert condition. For this example, you would see the average `pageviews` on the `WebPortal` app for the specific time frame you've set.
...
The primary and recommend condition type is a NRQL alert condition, but there are other types of conditions.  We've included a complete list of our condition types below. 
...
If you see an empty signal in the history chart on the **Alert Conditions** page, consider one of the following:
