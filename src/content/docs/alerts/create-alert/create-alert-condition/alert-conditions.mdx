  ...
  <Step>
    ...
    <CollapserGroup>
      ...
      >
        ...
        <Callout variant="tip">
          When you create a cross-account alert condition, the <DNT>**Do not report system health status**</DNT> toggle is enabled by default. To allow the cross-account alert condition determine the health status of the associated entity, you can disable the toggle.
        </Callout>
