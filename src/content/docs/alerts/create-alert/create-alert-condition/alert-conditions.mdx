    ...
    <CollapserGroup>
      ...
      >
        ...
        You need to set the priority level for both anomaly and static thresholds.  See the section above for more details.
            ...
            <Collapser
        id="predict-alert"
        title="Predictive alert (Available in public preview)"
      >
        ...
        **Predictive alert** enhances your alerting strategy by using historical data to predict when a static threshold might be breached. This proactive approach allows you to address potential issues before they impact your system, ensuring smooth operations and reduced downtime. This feature is only available for static thresholds.

        To set up a predictive alert:

        1. Select <DNT>**Static**</DNT> as the threshold condition type.
        2. Enable the <DNT>**Predict future behaviour**</DNT> toggle.
        3. Set the look-ahead period to predict when the threshold might be breached. The look-ahead period is maximum 360 times of the [window duration](/docs/alerts/create-alert/create-alert-condition/alert-conditions/#window-duration).
        4. Select the behaviour when a predictive alert is open and the threshold is breached in actual.
            * Close the predicted alert and open an actual alert.
            * Keep the predicted alert open to reduce noise.

        To learn more about predictive alerts, see our [documentation](/docs/alerts/create-alert/set-thresholds/predictive-alerts).
