...
<CollapserGroup>
  ...
  >
    ...
    Using dynamic targeting with your condition also requires that you set an [incident close timer](/docs/alerts/alert-event-management/how-alert-condition-events-are-closed#time-limit).
