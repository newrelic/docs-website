  ...
  <Step>
    ...
    <CollapserGroup>
      ...
      >
        ...
        The <DNT>**Predictive capability**</DNT> in New Relic uses historical data to build models that predict breaches of static thresholds. You set how far into the future to predict. If a breach is anticipated, a predictive alert event triggers, allowing you to act before disruptions occur.

        To enable the predictive capability:

        1. Select <DNT>**Static**</DNT> as the threshold condition type.
        2. Enable the <DNT>**Predict future behavior**</DNT> toggle.
