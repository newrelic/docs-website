...
* **Manage** alerts across multiple accounts that you have access to, enabling a consolidated view of all relevant alert events and issues.
...
<Step>
    On the left navigation menu, select <DNT>**Configure > Settings**</DNT> 
</Step>
...
* Issues and alert events pertaining to the cross account condition, including signals, facet names in the alert event titles, etc.
