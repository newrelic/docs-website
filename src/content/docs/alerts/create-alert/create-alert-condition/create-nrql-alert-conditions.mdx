...
Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert Conditions & Policies**</DoNotTranslate> to create a NRQL alert condition from a policy. Then, click <DoNotTranslate>**+ New alert condition**</DoNotTranslate>.
...
<figcaption>
  Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert Conditions & Policies > + New alert condition**</DoNotTranslate>. 
</figcaption>
...
<figcaption>
  Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert conditions (Policies)**</DoNotTranslate>, then <DoNotTranslate>**+ New alert condition**</DoNotTranslate>. Loss of signal is only available for NRQL conditions.
</figcaption>
