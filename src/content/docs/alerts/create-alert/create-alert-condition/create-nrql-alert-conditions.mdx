  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        For NRQL conditions, you can apply the `PREDICT` clause to a static condition threshold only. Adding a prediction opens an incident if the predicted signal crosses the specified threshold.
      </td>
    </tr>    
