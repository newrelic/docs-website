...
1. Go to <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert conditions > (select a condition)**</DNT>.
2. Click the ellipses menu (...) and click <DNT>**Edit**</DNT> to edit it, and then type a meaningful name for the condition.
...
1. Go to <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert conditions (policies)**</DNT>.
2. Use the search box, sort any column, or scroll the list, then select a policy's name to see its conditions.

To view [policy and condition information for a specific entity](/docs/alerts/new-relic-alerts-beta/configuring-alert-policies/view-policy-conditions-new-relic-products): From that entity's product UI, select <DNT>**Settings**</DNT>, then click <DNT>**Alert conditions**</DNT>.
