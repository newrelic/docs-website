...
The attributes you can use in a description template are a subset of attributes attached to the [incident event](/docs/alerts/create-alert/condition-details/alert-event-attributes). Here are some details about the available attributes and how to use them:

* Incident event attributes: For any of the [standard attributes available for use in a description template](/docs/alerts/create-alert/condition-details/alert-event-attributes), use the format `{{AN_ATTRIBUTE}}`. For example:
