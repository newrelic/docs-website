...
redirects:
  ...
  - /docs/alerts/create-alert/condition-details/incident-event-attributes.mdx
freshnessValidatedDate: never
---

A condition opening an alert event generates an event, which passes important information downstream.
