  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        NRQL or infrastructure conditions only. Not available for use with Alert condition [title template](docs/alerts/create-alert/condition-details/title-template) or [description template](/docs/alerts/create-alert/condition-details/alert-custom-incident-descriptions).
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        The unique identifier of the incident. Not available for use with Alert condition [title template](docs/alerts/create-alert/condition-details/title-template) or [description template](/docs/alerts/create-alert/condition-details/alert-custom-incident-descriptions).
      </td>
    </tr>
