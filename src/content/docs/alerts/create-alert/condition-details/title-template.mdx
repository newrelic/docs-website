...
You have named this alert condition `high error rate - checkout`. But you want the incident title to reflect where the errors are being generated. In this case, the errors for this incident originated in your checkout entity.
