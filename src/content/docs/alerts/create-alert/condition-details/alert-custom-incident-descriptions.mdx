...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert conditions (Policies) > (select a policy) > (select a condition)**</DoNotTranslate>: Click <DoNotTranslate>**+ Add custom incident description**</DoNotTranslate> to open the field.
</figcaption>
