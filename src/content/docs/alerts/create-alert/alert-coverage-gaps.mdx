...
<Callout variant="tip">
  To analyze and close coverage gaps across many entities at once, instead of one entity at a time, try [smart alerts](/docs/alerts/smart-alerts). From the <DNT>**Alerts Overview**</DNT> page, smart alerts apply Standards coverage and recommended thresholds at scale. This feature is currently in public preview.
</Callout>
