...
tags:
  ...
  - Alert notifications
metaDescription: >-
  New Relic Connect enables you to customize New Relic webhooks to establish
  two-way integration with incident management tools.
redirects:
...
4. Import the New Relic Connect XML files.
   * Open [this XML file](https://storage.cloud.google.com/newrelic-connect/workflows-proxy-production.xml) (which includes the business rule for New Relic Connect) Navigate to **System Definition → Business Rule** in the ServiceNow sidebar menu.
