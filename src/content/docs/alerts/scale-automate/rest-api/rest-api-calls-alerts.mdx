    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            Determines how alerts will [create incidents](/docs/alerts/organize-alerts/specify-when-alerts-create-incidents/). This must be one of the following:

            * `PER_POLICY` (default): Roll up by [policy](/docs/alerts/organize-alerts/specify-when-alerts-create-incidents/#preference-policy).
            * `PER_CONDITION`: Roll up by [condition](/docs/alerts/organize-alerts/specify-when-alerts-create-incidents/#preference-condition).
            * `PER_CONDITION_AND_TARGET`: Roll up by [target and condition](/docs/alerts/organize-alerts/specify-when-alerts-create-incidents/#preference-target).
          </td>
        </tr>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Determines how alerts will [create incidents](/docs/alerts/organize-alerts/specify-when-alerts-create-incidents/). Must be one of the following:

            * `PER_POLICY` (default): Roll up by [policy](/docs/alerts/organize-alerts/specify-when-alerts-create-incidents/#preference-policy).
            * `PER_CONDITION`: Roll up by [condition](/docs/alerts/organize-alerts/specify-when-alerts-create-incidents/#preference-condition).
            * `PER_CONDITION_AND_TARGET`: Roll up by [condition and signal](/docs/alerts/organize-alerts/specify-when-alerts-create-incidents/#preference-signal).
          </td>
        </tr>
