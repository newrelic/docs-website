...
<CollapserGroup>
  ...
  >
    ...
    <Callout variant="important">
    Users on [Advanced and Core Compute pricing plans](https://newrelic.com/pricing/compute#pricing_plan-compute) may incur additional CCU charges when using the `slide_by` signal. While the `slide_by` signal enhances data analysis by smoothing out fluctuations, its use may lead to increased costs. For further details on pricing, contact our sales team or refer to your Order.
    </Callout>
  </Collapser>
