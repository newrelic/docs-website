...
<Callout variant="caution">
  This feature uses generative AI. Always verify insights against your data before taking action. These are suggestions to guide investigation, not confirmed root causes.
</Callout>
