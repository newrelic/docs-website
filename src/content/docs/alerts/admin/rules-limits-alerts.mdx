...
Per New Relic's [acceptable use policy](/docs/licenses/license-information/general-usage-licenses/acceptable-use-policy), alert conditions found to be overwhelming our infrastructure may be shut off by New Relic administrators.

To create your own alerts on whether a condition has been shut off by New Relic administrators, see the [NrIntegrationError](/docs/data-apis/manage-data/nrintegrationerror/#query-alert) examples.
