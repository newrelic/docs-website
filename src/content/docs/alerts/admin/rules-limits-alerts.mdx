...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [Condition name](/docs/alerts/create-alert/create-alert-condition/alert-conditions)
      </td>
    ...
    <tr>
      ...
      <td>
        [Conditions per policy](/docs/alerts/create-alert/create-alert-condition/alert-conditions)
      </td>
    ...
    <tr>
      ...
      <td>
        [Custom alert event descriptions](/docs/alerts/create-alert/condition-details/custom-alert-event-descriptions)
      </td>
    ...
    <tr>
      ...
      <td>
        [Duration for condition alert event](/docs/alerts/new-relic-alerts-beta/configuring-alert-policies/define-thresholds-trigger-alert)
      </td>
    ...
    <tr>
      ...
      <td>
        ...
        alert events beyond this limit will not be persisted.
      </td>
    </tr>
...
You can see your matched data points and any limit alert events in the [limits UI](/docs/data-apis/manage-data/view-system-limits).
...
You can see your query scan operations and any limit alert events in the [limits UI](/docs/data-apis/manage-data/view-system-limits).
