...
<Callout variant="tip">
  This setting is related to the ["close open incidents after..." setting](/docs/alerts/alert-event-management/how-alert-condition-events-are-closed/#time-limit) for each condition.
