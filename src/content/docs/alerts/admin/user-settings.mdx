...
The cross-account alerts settings allow you to configure an alert condition to target data reported to a different account than the one that owns the condition.
