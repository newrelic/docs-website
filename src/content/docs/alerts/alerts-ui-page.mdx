...
When you edit an existing NRQL condition, you've the option to add or remove tags associated with the condition entity. To do this, click the <DNT>**Manage tags**</DNT> button below the condition name. In the menu that pops up, add or delete a tag.
