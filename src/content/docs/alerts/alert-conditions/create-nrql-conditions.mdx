...
No matter where you begin creating an alert condition, whether through a chart, from alert policies, or by writing your own query, NRQL is the building block upon which you can define your signal and set your thresholds.
