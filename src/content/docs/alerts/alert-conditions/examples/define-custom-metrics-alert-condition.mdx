...
redirects:
  ...
  - /docs/alerts/create-alert/examples/define-custom-metrics-alert-condition
freshnessValidatedDate: never
---

To alert on custom metrics, follow standard procedures to [add a condition](/docs/alerts/alert-conditions/create-alert-conditions/#create-policy) to a policy. The condition's [thresholds](/docs/alerts/alert-conditions/set-thresholds) section includes <DNT>**Custom Metrics**</DNT>, which you can select from the list.
...
After you name your custom metric condition, you can choose to include the [URL with runbook instructions](/docs/alerts/alert-conditions/provide-runbook/) for handling certain situations.
