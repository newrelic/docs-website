...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        No. The [threshold](/docs/alerts/alert-conditions/set-thresholds/) value must be breached for at least 5 consecutive minutes to open an incident. However, if you had set the threshold for <DNT>**at least once in**</DNT> 5 minutes, then the threshold value must be breached [at least once](/docs/alerts/alert-conditions/create-alert-conditions/#query-returns) during the 5-minute period.
      </td>
    </tr>
  </tbody>
</table>
...
1. Follow the [basic workflow process](/docs/alerts/alert-conditions/create-alert-conditions) to create an alert condition.
2. When creating an condition, select <DNT>**Services - APM**</DNT>.
