...
* Use <DNT>[Predictive alert](/docs/alerts/create-alert/set-thresholds/predictive-alerts)</DNT> to anticipate and respond to potential threshold breaches proactively (Available with the public preview of Predictive Alerts).
