...
An incident is generated when an active alert condition's threshold has been met. You can correlate similar or related incidents to an issue and group alert conditions together to create an alert policy.
...
This diagram shows how alerts work: you create an alert policy that includes an alert condition or several alert conditions. Alert conditions include a defined threshold and when that threshold is breached, an incident triggers. If you've configured a workflow, then you'll receive a notification. You can group incidents into issues and issues into decisions to have better management of your alerts.
