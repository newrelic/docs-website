...
<img
  ...
  src="/images/alerts_screenshot-full_alerts-overview-page.webp"
/>
...
Want to get started making your first alert? See how to [create your first alert](/docs/alerts/alert-conditions/create-alert-conditions).
...
<table>
  ...
  <tbody>
    <tr>
      <td>
        <DNT>
          **[Condition](/docs/alerts/alert-conditions/create-alert-conditions)**
        </DNT>
      </td>
...
## Note about EU and US data centers [#eu-datacenter]
...
Ready to try New Relic for yourself? [Sign up](https://newrelic.com/signup) for your free New Relic account and follow our [quick launch guide](/docs/new-relic-solutions/get-started/intro-new-relic/#get-started) so you can start maximizing your data today! If you need any help, check out our [tutorial series](/docs/tutorial-create-alerts/create-new-relic-alerts/) on creating alerts to get started.
