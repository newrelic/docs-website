...
### Configure the Slack message template in workflows [#configure-slack-message-settings]
  ...
  4. Click the <DNT>**Send test notification**</DNT> button to send a test notification with a pre-defined example payload to the channel. This creates a message in the selected Slack channel.
