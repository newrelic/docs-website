...
Custom details in PagerDuty alerts are automatically populated.
 ...
 <Callout variant="important">
This is a legacy integration type which is in maintenance mode. If you do not have this existing integration set up already, please refer to the certified app section.
</Callout>
