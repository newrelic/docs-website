...
1. You can choose to receive notification updates, like when an issue is acknowledged or closed, on the channel as well. This is also known as the thread broadcast.
