...
/>
  ...
  1. Go to <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts**</DNT>, click <DNT>**Destinations**</DNT>, and then select <DNT>**Slack**</DNT>.
  2. Click the <DNT>**Authenticate in one click**</DNT> button to go to the Slack landing page, and continue the OAuth2 authentication process. If you're not signed into the required workspace, you're redirected to Slack to sign in.
  ...
  3. Add your workspace name or select the relevant workspace, and click <DNT>**Continue**</DNT>.
  ...
  5. Click <DNT>**Allow**</DNT>, and return to the destination page.
