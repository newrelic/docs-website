...
* **Workflow Automation**: Available in [workflows](/docs/alerts/get-notified/alert-event-workflows/). Triggers [automated incident response workflows](/docs/workflow-automation/setup-and-configuration/create-destinations#trigger-from-alerts) when alert conditions are breached.
