...
<figcaption>
  Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Destinations**</DoNotTranslate>. Use destinations to choose where your notifications are sent.
</figcaption>

1. Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Enrich and Notify > Destinations**</DoNotTranslate>. The <DoNotTranslate>**Destinations**</DoNotTranslate> table shows information about the existing destinations and allows users to enable, disable, and modify.
...
<figcaption>
  Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Destinations**</DoNotTranslate>. Click the <DoNotTranslate>**Destinations**</DoNotTranslate> tab to see the destinations table.
</figcaption>
