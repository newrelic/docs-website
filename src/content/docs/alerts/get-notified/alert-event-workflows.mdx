...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The issue has been closed due to closing all its alert events, end of TTL, or has been `Inactive` for too long
      </td>
    ...
    <tr>
      ...
      <td>
        An alert event in the issue has moved from High priority and become a Critical priority issue
      </td>
    ...
    <tr>
      ...
      <td>
        An alert event got added to the issue, an alert event was closed, or a different issue was merged to this one
      </td>

      <td>
        An alert event has been resolved
      </td>
