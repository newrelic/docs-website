...
6. <DNT>**Workflow:**</DNT> This column displays the workflow that triggered the notification.
7. <DNT>**Error Details:**</DNT> This column displays additional details if the notification failed.
8. <DNT>**Notification Result:**</DNT> This column displays a link to evidence in the third party (for example, a Slack thread or JIRA ticket) if the notification was sent successfully.
