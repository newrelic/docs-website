...
* Install the [New Relic for Microsoft Teams app](https://appsource.microsoft.com/en-us/product/Office365/WA200008155) in your Microsoft Teams environment. For more information, see [Add New Relic for Microsoft Teams](#add-new-relic-for-microsoft-teams). 
...
Configure the alerts to be sent to the channel based on the alert conditions. To know more about alerts, see [alerts.](/docs/alerts/overview/)
