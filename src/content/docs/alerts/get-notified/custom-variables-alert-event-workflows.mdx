...
redirects:
  - /docs/alerts/get-notified/custom-variables-alert-event-workflows
---

An explanation of the variables used for New Relic alerts [workflows](/docs/alerts/get-notified/alert-event-workflows).
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        The condition's custom alert event description.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        The alert event detection condition's ID that generated the alert event.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Alert event callback URL
      </td>

      <td>
        A direct link to the relevant alert event callback.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        New Relic or third party source(s) that created the alert event(s).
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Alert event detection policy name that generated the alert event.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        The system(s) reporting the alert event(s).
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        List of all alert event descriptions.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        List of all alert event titles.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Closed alert events count
      </td>

      <td>
        The total number of closed alert events on this issue.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        A list of all the issue's aggregated alert events.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Usually the title of the first alert event.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        New Relic alert event detection original alert event ID.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Alert event detection policy's account ID.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Alert event detection policy IDs that generated the alert event.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Open alert events count
      </td>

      <td>
        The total number of open alert events on this issue.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        The number of alert events that are aggregated or correlated in the issue.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Alert event chart URL
      </td>

      <td>
        Link to the alert event chart image.
      </td>
    </tr>
