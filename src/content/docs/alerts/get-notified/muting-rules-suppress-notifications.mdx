...
Alerts sends out timely notifications when your system is having problems. Sometimes there are notifications you know you don't need to see. You can use <DNT>**muting rules**</DNT> to stop being bombarded by messages that don't need your attention.
