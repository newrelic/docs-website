...
* <DNT>**Suppress notification:**</DNT>: If there’s an ongoing incident after the muting rule window ends, you will <DNT>**not**</DNT> be notified. This works by leaving the existing, muted incident open past the muting rule window end timestamp.
