...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        An issue is activated due to an incident that <DNT>**is**</DNT> muted
      </td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        `muting_rule_disabled`
      </td>

      <td>
        Field to manage when you want to receive notifications again. The default value is [<DNT>**Notify**</DNT>](#notify).
      </td>
    </tr>
...
* `IS_ANY`: <DNT>**Caution:**</DNT> A condition with this operator will mute <DNT>**all**</DNT> incidents on the account.
