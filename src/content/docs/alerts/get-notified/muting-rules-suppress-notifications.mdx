...
* <DNT>**Close ongoing incidents**</DNT>: This means that if an incident is triggered or still open right after the mute rule has expired or been disabled, you'll receive a notification. We recommend that you keep this default setting.
