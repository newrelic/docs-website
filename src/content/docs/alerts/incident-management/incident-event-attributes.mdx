...
redirects:
  ...
  - /docs/alerts/create-alert/condition-details/incident-event-attributes
...
You may be wondering why we're using `NrAiIncident` as the name for the incident event data type. Although sometime you can see these events as "violations", they are called <DNT>**incidents**</DNT> in our UI.
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        If you use the delay and timer setting in the UI, it clears `evaluationOffsetSeconds` and uses delay and timer instead.
      </td>
    </tr>
