...
To find your issues, go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Analyze**</DoNotTranslate>, and click <DoNotTranslate>**Issues & activity**</DoNotTranslate>.
...
To see your closed issues, in the search field, click the filter button, then select the <DoNotTranslate>**Closed**</DoNotTranslate> issue state. 

On the issue detail page, click <DoNotTranslate>**Close**</DoNotTranslate>, and then click <DoNotTranslate>**Create postmortem**</DoNotTranslate>. 
...
Within an event card, click the <DoNotTranslate>**Insert charts**</DoNotTranslate> button. Choose from a collection of recommended charts related to your event.
...
For a postmortem, the title and <DoNotTranslate>**What happened**</DoNotTranslate> summary sections are required fields. 

The metadata sections and events timeline give you essential context about what entities are affected, when, and how. 

Optionally, you can fill out the <DoNotTranslate>**Root cause**</DoNotTranslate> and <DoNotTranslate>**Recovery actions**</DoNotTranslate> sections to create a more detailed retrospective record.
...
1. Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Analyze**</DoNotTranslate>, and click <DoNotTranslate>**Issues & activity**</DoNotTranslate>. 
2. Click the <DoNotTranslate>**Postmortems**</DoNotTranslate> tab.
...
If you decide you no longer need a postmortem, on the detailed postmortem record, click <DoNotTranslate>**Delete postmortem**</DoNotTranslate>.
