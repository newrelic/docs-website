...
Agent Control is a lightweight agent supervisor that manages other New Relic and OpenTelemetry agents. It communicates with Fleet Control to remotely configure, update, and monitor the health of infrastructure-level instrumentation on Kubernetes.
## Prerequisites
