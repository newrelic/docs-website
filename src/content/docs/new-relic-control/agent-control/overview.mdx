...
metaDescription: "Agent Control is a lightweight agent supervisor that manages other New Relic and OpenTelemetry agents by communicating with Fleet Control to remotely configure, update, and monitor the health of infrastructure-level instrumentation."
...
Agent Control is an agent supervisor that can be used to deploy, update, and manage other New Relic and OpenTelemetry agents. It is a lightweight agent that attaches to several types of instrumentation sources. Agent Control is required to remotely manage fleets of agents and integrations in the centralized Fleet Control capability.
...
- Popular Kubernetes environments, including Minikube, Kind, Amazon EKS, Azure AKS, and Google GKE.
