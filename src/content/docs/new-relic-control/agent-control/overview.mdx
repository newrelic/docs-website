...
- **Existing instrumentation:** If you already have a Kubernetes cluster instrumented with New Relic, you can uninstall the instrumentation and configure the Agent Control to manage such agents.
  Refer to the [migration doc](/docs/new-relic-control/agent-control/migration) for further information. 
