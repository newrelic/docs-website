...
newrelic_auth_cli_url = 'https://github.com/newrelic/newrelic-auth-rs/releases/download/0.5.3/newrelic-auth-cli_amd64.tar.gz'
...
```bash
# Requires a newrelic-auth-cli release that includes NEW_RELIC_API_KEY
# support for create-bootstrap-identity (newrelic-auth-rs#254). Bump this
# to that release's tag once it's out.
NEWRELIC_AUTH_VERSION="0.5.3"
