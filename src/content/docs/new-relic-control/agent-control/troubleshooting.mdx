...
Agent Control currently only supports **Kubernetes**. We are working on a public preview for Linux host systems, and support for other environments will be added in the future.
</Callout>
