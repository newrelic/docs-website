...
Agent Control will automatically detect the change and perform a non-disruptive, rolling update on your cluster, ensuring that your new agents are running and healthy before replacing the old ones.
...
## Key Benefits of the Update Process
