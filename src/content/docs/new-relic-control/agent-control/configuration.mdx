...
For complete remote configuration examples covering infra-agent, on-host integrations (nri-mysql, nri-flex), log forwarding, and NRDOT, see [Instrument your systems with Agent Control](/docs/new-relic-control/agent-control/instrumentation).
