...
- **0-30 seconds:** Service registers and starts
- **30-60 seconds:** First connection to Fleet Control established
- **1-2 minutes:** Configuration synchronization completes
- **2-5 minutes:** Managed agents deployed and started
- **5-10 minutes:** First telemetry data appears in New Relic UI

If the service doesn't connect within 2-3 minutes, check the troubleshooting section below.
