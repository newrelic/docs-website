...
| :--- | :--- | :--- |
| **New Relic Infrastructure Agent** | Host-level access for system metrics and Kubernetes API access for cluster data. | Kubernetes / On-host |
| **New Relic OpenTelemetry Collector (NRDOT)** | Permissions depend on specific receivers and exporters; often requires Kubernetes API access for service discovery. | Kubernetes / On-host |
