...
2. Click the <DNT>**Create deployment**</DNT> button.
...
2. In the deployment pane that opens, click the ellipses (`...`) button next to the <DNT>**Start deployment**</DNT> button at the top of the screen.
...
3. Click the <DNT>Remove</DNT> button that appears.
...
1. From the main Configurations page, click the <DNT>**Create configuration**</DNT> button.
...
4. A common workflow is to click the <DNT>**Copy**</DNT> button in the template pane and paste the contents into the active configuration pane on the left to use as a starting point.
...
1. Click the <DNT>**Create config version**</DNT> button.
...
1. On the main configurations page, click the ellipses (`...`) button located next to the main <DNT>**Create configuration**</DNT> button.
