...
To set up fleet permissions, you must have the <DNT>Organization Manager</DNT> and <DNT>AuthDomain Manager</DNT> roles.
...
2. In the modal that appears, you must:
   * Select the <DNT>**managed entity type**</DNT> (Kubernetes Cluster, Linux Host, or Windows Host). Note that Linux Host and Windows Host support is currently in public preview.
