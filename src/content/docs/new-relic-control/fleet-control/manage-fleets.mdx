...
### Agent dependencies and conflicts
...
2. In the modal that appears, you must:
   ...
   * Select the <DNT>**Agent type**</DNT> (for example, New Relic Infrastructure, NRDOT collector, Fluent Bit) from the dropdown menu. The available agent types will be filtered based on the managed entity type you selected.
