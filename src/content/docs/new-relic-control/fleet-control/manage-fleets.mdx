...
<img
  ...
  alt="The Create a fleet modal with the Access management section expanded, showing dropdowns to select an existing group (Fleet3rdGroup) and role (Fleet Manager) for fine-grained access control, with an Add Access Grant button."
