...
To navigate to Fleet Control, go to **All capabilities → New Relic Control → Fleets**. You can use the pin to add New Relic Control to the left side navigation bar for easy access.
