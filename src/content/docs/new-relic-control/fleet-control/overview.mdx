...
- **User permissions:** The `Org Product Admin` role permissions are required to create and edit fleets within Fleet Control.<br/>Or, create a custom role to create/edit fleets. To learn more, see [create custom roles](/docs/accounts/accounts-billing/new-relic-one-user-management/account-user-mgmt-tutorial/#roles). 
...
## Consideration for creating fleets

Think of how different teams within your organization will manage their respective fleets. Fleet Control allows for grouping and ownership boundaries, enabling teams to manage their observability needs independently.
