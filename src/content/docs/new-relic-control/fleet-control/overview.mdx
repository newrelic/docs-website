...
In the context of Fleet Control, a managed entity in the context of Fleet Control refers to a Kubernetes cluster running New Relic infrastructure and logging instrumentation managed by Agent Control. Agent configuration is specified at the fleet level and every Kubernetes cluster in the fleet shares the same configuration as other clusters in that fleet. 

<Callout title="important">
  You cannot add a Kubernetes cluster to a fleet before you installing Agent Control on that cluster.
</Callout>
