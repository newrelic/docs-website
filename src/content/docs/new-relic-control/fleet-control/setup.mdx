...
Agent configurations determine what data is ingested into New Relic. Since these configurations include agent versions, updating hundreds of agents required running a large script.

Now, in Fleet Control, you can create a configuration that can be applied to as many agents as you want.

Follow these steps to create an agent configuration:
...
<Callout variant="important">
  You can edit custom roles via the API `<ADD LINK>`.
</Callout>
