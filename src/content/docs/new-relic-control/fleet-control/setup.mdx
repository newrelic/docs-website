...
You will need the **Organization Manager** role or a custom role with equivalent fleet management permissions to perform these actions.
...
5. In the modal:
* Give your fleet a meaningful **Name** (e.g., `prod-us-east-1-platform-k8s`) and an optional **Description**.
