...
You do not have the necessary capabilities to create a system identity token for the fleet or Agent Control to use.
**Solution**:
...
- Refer to user permissions documentation for guidance. Ensure the documentation is updated to include permissions specific to this product.

## Problem: Outdated Helm chart version
The command line script to install the Helm chart fails because the customer's local version of Helm is outdated.
**Solution**:
