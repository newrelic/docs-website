...
The customer is unaware that the rules list shows only active states and has not deployed the change yet.
**Solution**:
- Check the updates page for pending updates to deploy.
- Ensure the customer deploys their changes for them to be reflected in the rules list.
