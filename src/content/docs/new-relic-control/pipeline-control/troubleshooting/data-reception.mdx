...
## Problem: Customer is being rate limited
The customer is hitting rate limits on their telemetry data.
**Solution**:
- Check gateway HTTP client response codes for 429 status codes received from the New Relic API.
- Review events created in the customer account indicating rate limiting.
