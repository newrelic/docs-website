...
Next, you will explore how to [implement a load balancer specifically using AWS services](/docs/new-relic-control/pipeline-control/aws-alb-for-gateway).
