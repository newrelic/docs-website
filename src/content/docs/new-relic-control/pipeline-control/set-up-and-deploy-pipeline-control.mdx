...
**APM agents protocol version:** Ensure your [APM agents](/docs/new-relic-control/pipeline-control/modify-agent-configuration/#supported-agent-versions) are updated to protocol `version 17` or above for compatibility with the gateway.
