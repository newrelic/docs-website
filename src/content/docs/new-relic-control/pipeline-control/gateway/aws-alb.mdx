...
redirects:
  ...
  - /docs/new-relic-control/pipeline-control/gateway/aws-alb-for-gateway/
...
## Next step
Next, you'll learn about [setting up DNS and security certificates](/docs/new-relic-control/pipeline-control/gateway/dns-certificate) for the AWS ALB.
