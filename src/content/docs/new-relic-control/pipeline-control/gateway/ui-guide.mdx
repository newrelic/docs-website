...
11. Click **Save draft** to save your newly created configuration version.
...
3. Click <DNT>**Start deployment**</DNT> to apply the configuration.
4. You have to again confirm that you want to start the deployment. Click <DNT>**Start deployment**</DNT> again to confirm.
