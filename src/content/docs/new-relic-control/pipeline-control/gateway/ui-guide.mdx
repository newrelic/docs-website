...
5. Enter OTTL condition: `attributes["environment"] == "test" or attributes["environment"] == "local" or severity.text == "DEBUG"`
...
**Validation Feedback**: Real-time validation shows errors in OTTL statements before rule creation:
- Syntax errors highlighted in red
- Suggestions for corrections
- Links to documentation for OTTL functions and operators
