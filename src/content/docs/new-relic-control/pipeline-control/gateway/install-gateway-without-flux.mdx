...
Install Pipeline Control gateway in configuration-only mode, where you manage gateway infrastructure (scaling, versions) manually while New Relic manages pipeline configuration (sampling, filtering, transforms) through the UI.
...
**What you get:**
- Configure pipeline rules (sampling, filtering, transforms) via New Relic UI.
...
## Managing gateway after installation
