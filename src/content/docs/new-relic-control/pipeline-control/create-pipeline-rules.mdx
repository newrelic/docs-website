...
When creating a rule, you can specify the type of data you want to filter, including Metrics, Events, Logs, or Traces. Additionally, you can decide where to deploy the rule—either on New Relic Cloud or within your own network. Deployment in your own network requires selecting a Gateway rule, whereas Cloud deployment involves creating a Cloud rule.
