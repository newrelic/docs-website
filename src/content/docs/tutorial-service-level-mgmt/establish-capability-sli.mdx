...
You don't need to have intimate knowledge of an application or service in order to complete this task. You only need to find the consumer-facing API (service boundary) and follow the steps below.
