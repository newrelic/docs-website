...
<Tabs stacked>
    ...
    <TabsPages>
        ...
        3. Reduce average number of people engaged (FTEs) per severe incident.
        </TabsPageItem>
        <TabsPageItem id="2">
        The required operational outcome in terms reliability focuses on communicating the health of your digital product. You measure operational success by what percentage of critical product applications you cover with your standard service levels. You can also look at the percentage of policy adoption by your primary stakeholders. You can do both by focusing on what is important to the stakeholders, ensuring simplicity, and proving the effectiveness of service level management.
        </TabsPageItem>
    </TabsPages>
</Tabs>
...
## Terminology [#terminology]
  ...
  >
    You can define service level management as the practice of managing and reporting on service level compliance and attainment.
  </Collapser>
  ...
  >
    A service level objective (SLO) describes the expected service level of a system, job, and/or capability. An SLO usually describes the required percentage of success of one or more SLIs within a given period of time.
  ...
  >
    A service boundary is the point in a system where the consumer client connects to make requests, also known as the external API or endpoint.

    Service boundaries can also be internal between two distinct systems, where one collection of applications serves the requests of another collection of applications. For example, an identity management system can serve for both login requests from the client and permissions authorization for different features.
