...
<UserJourneyControls
    previousStep={{path: "/docs/tutorial-innov-grow/development-quality-mgmt/", title: "Previous step", body: "Learn how to use New Relic to improve the quality of your development cycles"}}
/>