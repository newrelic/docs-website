    ...
    <tr>
      ...
      <td>
        * In pan <Icon name="fe-move"/>
          mode, click and drag.
        * In drag-select <ImageSizing width="22px">![Drag-select icon](./images/sm-drag-select-toggle_0.png "Drag-select icon")</ImageSizing> mode, hold the **Alt** key, then click and drag.
      </td>
    </tr>
...
<CollapserGroup>
  ...
  >
    ...
    * Click the drag-select <ImageSizing width="22px">![Select multiple nodes](./images/sm-drag-select-toggle_0.png "Select multiple nodes")</ImageSizing> icon to switch to drag-select mode. Click and drag the mouse to draw a square around the nodes you want to select.
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            Select two or more nodes, then select <ImageSizing width="22px">![Group nodes](./images/sm-grouping-icon.png "Group nodes")</ImageSizing> **Create group**.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            ...
            ![Remove Nodes from Groups](./images/service_map_edit_group_notes.png "Remove Nodes from Groups")
          </td>
        </tr>
      </tbody>
    </table>
