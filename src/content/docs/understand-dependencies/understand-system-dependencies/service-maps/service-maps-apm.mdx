...
<CollapserGroup>
  ...
  >
    ...
    3. Name the node.
    4. Add connections: Select the left (for incoming) or right (for outgoing) arrow <i className="fa fa-arrow-right">
       arrow-right
       </i>
    ...
    1. Mouse over the custom node and select the pencil <Icon name="edit-2"/>
       icon.
    2. Select the left (for incoming) or right (for outgoing) arrow <i className="fa fa-arrow-right">
       arrow-right
       </i>
       icons.
...
<Table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        * In pan <i className="fa fa-arrows">
          arrows
          </i>
          mode, click and drag.
