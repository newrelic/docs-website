       ...
       <table>
         ...
         <tbody>
           <tr>
             ...
             <td>
               Copy and hold to use later as <var>YOUR_TRACE_OBSERVER_HOST</var> in [Step 3. Configure the agents](#configure-agents).
             </td>
           </tr>
           ...
           <tr>
             ...
             <td>
               (Optional) Copy and hold to use later as <var>YOUR_TRACE_OBSERVER_URL</var> in [2b. Send test data to the trace observer](#test-observer).
             </td>
           </tr>
         </tbody>
       </table>
...
* Standard distributed tracing
* Infinite Tracing (requires <var>YOUR_TRACE_OBSERVER_HOST</var> from [step 2](#get-endpoints))
