...
<CollapserGroup>
  ...
  >
    ...
    6. Click the adjacent clipboard icon to copy and hold the endpoint to use later as <var>YOUR_TRACE_OBSERVER_URL</var> in [Step B. Send test data to the trace observer](#test-observer).
