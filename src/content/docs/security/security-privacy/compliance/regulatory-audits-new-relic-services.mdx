...
* Browse the [Support Forum](https://login.newrelic.com/login) to get help from the community and join in discussions.
* Find answers on our sites and learn how to use our [support portal](https://support.newrelic.com/).
* Run [New Relic Diagnostics](/docs/using-new-relic/cross-product-functions/diagnostics-cli-nrdiag/diagnostics-cli-nrdiag/), our troubleshooting tool for Linux, Windows, and macOS.
* Review New Relic's [data security and licenses documentation](/docs/licenses/license-information/referenced-policies/security-policy/).
