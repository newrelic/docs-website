...
New Relic currently maintains the following certifications/attestations:
...
* [ISO 42001](/docs/security/security-privacy/compliance/certificates-standards-regulations/iso-42001/)
* [PCI DSS](/docs/security/security-privacy/compliance/certificates-standards-regulations/pci-dss/)
* [SOC 1](/docs/security/security-privacy/compliance/certificates-standards-regulations/soc1/)
...
New Relic no longer maintains the following certifications/attestations:
* [HITRUST CSF](/docs/security/security-privacy/compliance/hitrust)
