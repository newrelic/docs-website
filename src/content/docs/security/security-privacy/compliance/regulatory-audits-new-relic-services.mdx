 ...
 **Customers' FedRAMP Obligations**
  ...
  4. **Authorized New Relic Endpoints**: Customer must send its data only to [New Relic’s FedRAMP-designated endpoints](https://docs.newrelic.com/docs/security/security-privacy/compliance/fedramp-compliant-endpoints); and

  5. **Authorized Services and Features**: Customer must only use FedRAMP audited and authorized New Relic Services and features as specified [here](https://docs.newrelic.com/docs/security/security-privacy/compliance/regulatory-audits-new-relic-services)
</Callout>
