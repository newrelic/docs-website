...
This document describes New Relic's products and services as they relate to regulatory framework compliance status. For more information, download the New Relic FedRAMP Customer Responsibility Matrix (CRM) Worksheet as a [PDF|87K](./images/New-Relic-FedRAMP-Customer-Responsibility-Matrix.pdf).
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        [Logging](/docs/security/security-privacy/compliance/fedramp-compliant-endpoints/#log-api) (with exception of [log patterns](/docs/logs/log-management/ui-data/find-unusual-logs-log-patterns-beta/))      
      </td>
