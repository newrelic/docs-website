...
New Relic customers must meet all of the following requirements for New Relic’s FedRAMP environment:
  ...
  5. **Authorized services and features**: Customer must only use [FedRAMP audited and authorized New Relic services and features](/docs/security/security-privacy/compliance/regulatory-audits-new-relic-services).
