...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        [APM](/docs/security/security-privacy/compliance/fedramp-compliant-endpoints/#apm-endpoints) (plus language agents)
      </td>
    ...
    <tr>
      <td>
        [Mobile monitoring](/docs/security/security-privacy/compliance/fedramp-compliant-endpoints/#mobile-endpoints)
      </td>
