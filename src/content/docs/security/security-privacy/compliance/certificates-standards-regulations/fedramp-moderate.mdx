...
For more information, see our [public sector solutions](https://newrelic.com/solutions/industry/public-sector), or download [the New Relic FedRAMP Customer Responsibility Matrix (CRM) Worksheet as a PDF](https://github.com/newrelic/docs-website/raw/develop/src/content/docs/security/security-privacy/compliance/certificates-standards-regulations/New.Relic.FedRAMP.CIS.CRM.pdf) (133KB).
