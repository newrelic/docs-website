...
For more information, see our [public sector solutions](https://newrelic.com/solutions/industry/public-sector), or download [the New Relic FedRAMP Customer Responsibility Matrix (CRM) Worksheet as a PDF](https://github.com/newrelic/docs-website/raw/develop/src/content/docs/security/security-privacy/compliance/certificates-standards-regulations/2022.SSP.Attachment.09-New.Relic.FedRAMP.Moderate.CIS.Workbook.xlsx.-.CIS.Worksheet.pdf) (89K).
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <a href="https://docs.newrelic.com/docs/mobile-apps/mobile-apps-intro/#mobile-app-features">New Relic Mobile App</a>
      </td>
    </tr>
  </tbody>
</table>
