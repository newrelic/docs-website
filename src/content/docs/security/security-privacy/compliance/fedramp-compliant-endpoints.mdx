...
* [Agent settings](#agents) for our [<InlinePopover type="apm" /> agents](#apm-endpoints), [infrastructure monitoring agent](#infrastructure-endpoints), [<InlinePopover type="browser" /> agent](#browser-endpoints), and [mobile monitoring agent](#mobile-endpoints)
