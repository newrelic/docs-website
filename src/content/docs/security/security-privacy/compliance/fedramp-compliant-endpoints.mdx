...
Federal Risk Authorization Management Program (FedRAMP) enables additional security measures to ensure sensitive data stays safe. New Relic is accredited so you can configure agents and data-ingest APIs to send sensitive data using FedRAMP-compliant endpoints. This doc walks you through that process for:
...
- Check out [customer requirements](#obligations) for using FedRAMP endpoints.
- Visit our [data encryption](/docs/security/new-relic-security/compliance/data-encryption) documentation to learn about security accreditation for FedRAMP.
- Read our networking](/docs/using-new-relic/welcome-new-relic/get-started/networks) documentation to learn about New Relic networks, domains, and ports.
...
APM, infrastructure, mobile, and browser agents report data to New Relic. Sending data to FedRAMP-compliant endpoints involves either code-base configuration or altering an environment variable. 
