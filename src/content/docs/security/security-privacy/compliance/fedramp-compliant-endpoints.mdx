...
A customer is encouraged to have FedRAMP and non-FedRAMP enabled organizations as required by their business needs. To [add accounts](/docs/accounts/accounts-billing/account-structure/new-relic-account-structure), talk to your New Relic account representative.
