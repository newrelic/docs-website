...
To ensure FedRAMP compliance when using the OpenTelemetry API, only send data to `https://gov-otlp.nr-data.net` with the appropriate port chosen from the [OTLP integration support matrix](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/opentelemetry-setup#review-settings). See that page for more details on FedRAMP compliance with OTLP. 
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Use [our <DNT>Fluentbit</DNT> endpoint configuration](https://github.com/newrelic/newrelic-fluent-bit-output#configuration-parameters) found on GitHub.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Our Kubernetes integration logs are based on <DNT>Fluentbit</DNT>'s output plugin. Use the [Helm chart endpoint instructions](https://github.com/newrelic/helm-charts/tree/master/charts/newrelic-logging#installation) found on GitHub.
      </td>
    </tr>
