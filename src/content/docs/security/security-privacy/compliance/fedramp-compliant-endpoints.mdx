...
* Trace data is reported by some of our agents, like our APM agents, browser agent, and mobile agent. To enable FedRAMP compliancy for that data, you would [enable FedRAMP for the applicable agent](#agents).
