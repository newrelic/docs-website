...
You can configure agents and data-ingest APIs to send sensitive data to New Relic using FedRAMP-compliant endpoints. This doc walks you through configuring FedRAMP compliance for:
...
- Visit our [data encryption](/docs/security/new-relic-security/compliance/data-encryption) documentation to learn about security accreditation for the Federal Risk Authorization Management Program (FedRAMP).
- Read our networking documentation to learn about New Relic networks, domains, and ports, see our [networking](/docs/using-new-relic/welcome-new-relic/get-started/networks) documentation.
