...
You can send FedRAMP-compliant data to New Relic by configuring your agents or data-ingest APIs:  
...
<Collapser
    ...
    title="Infrastructure monitoring 1.15.0 or higher"
  >
...
<Collapser
    ...
    title="Infrastructure monitoring below 1.15.0"
  >  
