...
APM, infrastructure, and mobile agents can be configured to send data to FedRAMP-compliant endpoints. Each kind of agent may require some additional configuring depending on your agent's language, framework, or version. 
...
<CollapserGroup>
  <Collapser
    id="infrastructure-monitoring-configurations"
