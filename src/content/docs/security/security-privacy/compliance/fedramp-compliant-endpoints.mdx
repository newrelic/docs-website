...
3. **Subscription level**: Customer must have a current and valid subscription to our Enterprise edition and use our [Data Plus option](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/data-ingest-billing#data-plus), or have an alternative New Relic-approved subscription.
