...
Notes about FedRAMP compliancy for trace data: 
* Trace data is also reported by some of our agents, like our APM agents, browser agent, and mobile agent. To enable FedRAMP compliancy for that data, you would [enable FedRAMP for the applicable agent](#agents).
* Currently [Infinite Tracing](/docs/distributed-tracing/infinite-tracing/introduction-infinite-tracing/) data is not FedRAMP compliant. 
