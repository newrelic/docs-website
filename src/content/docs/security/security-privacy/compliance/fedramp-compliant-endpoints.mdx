...
- [Telemetry integrations](#) and [telemetry SDKs](#)
...
As a note, remember that browser agents will automatically update your account information to use the correct endpoints. No additional configuration is needed.
...
Language-specific code-based or environment variable configurations:
