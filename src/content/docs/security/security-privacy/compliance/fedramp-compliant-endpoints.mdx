...
See our [OTLP integration support matrix](/docs/integrations/open-source-telemetry-integrations/opentelemetry/opentelemetry-setup#review-settings) for more details on FedRAMP compliance with OTLP.
