...
The [Prometheus remote write integration](/docs/integrations/prometheus-integrations/get-started/send-prometheus-metric-data-new-relic/#remote-write) is not available for use with the `https://gov-metric-api.newrelic.com/metric/v1` endpoint and attempted requests will result in an HTTP 403 (Forbidden) status code. Consider using the [Prometheus OpenMetrics](/docs/integrations/prometheus-integrations/get-started/send-prometheus-metric-data-new-relic/#OpenMetrics) integration instead.
</Callout>
