...
New Relic is your data processor, so we only communicate with you as our customer. We do not communicate with your own customers. New Relic is unable to provide assistance to our customers with personal data requests via any third party platforms, e.g., any data privacy / data privacy compliance platforms - the only method by which we can provide assistance is as set out below.
