...
<CollapserGroup>
  ...
  >
    Our <InlinePopover type="browser"/> agent allows you to monitor the performance of their websites. For more information, see:
  ...
  >
    By default, our <InlinePopover type="mobile"/> service collects two pieces of personal data:
