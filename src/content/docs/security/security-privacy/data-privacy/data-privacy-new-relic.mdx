...
<Callout variant="tip">
  New Relic includes the option of HIPPA-enabled accounts for customers meeting certain requirements. To learn more, see [HIPAA readiness at New Relic](/docs/security/security-privacy/compliance/hipaa-readiness-new-relic).
</Callout>
