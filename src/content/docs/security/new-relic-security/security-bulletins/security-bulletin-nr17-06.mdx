...
<Table>
  <tbody>
    ...
    <tr>
      ...
      <td>
        [6.20.166.0](https://docs.newrelic.com/docs/release-notes/agent-release-notes/net-release-notes)
      </td>
    </tr>
  </tbody>
</Table>
...
Disable [transaction trace](https://docs.newrelic.com/docs/agents/net-agent/configuration/net-agent-configuration#transaction_tracer) in the .NET agent configuration.
