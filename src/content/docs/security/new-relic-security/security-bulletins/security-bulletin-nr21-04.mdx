...
<DNT>**Customers using log4j directly in their applications should carefully review the [Apache Log4j Security Vulnerabilities](https://logging.apache.org/log4j/2.x/security.html) page for remediation details that should be considered.**</DNT>
