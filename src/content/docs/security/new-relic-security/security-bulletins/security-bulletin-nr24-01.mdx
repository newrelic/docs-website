...
releaseDate: '2024-6-8' 
---

<DoNotTranslate>**Vulnerability Identifier:**</DoNotTranslate> NR24-01
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>
                Upgrade the Infrastructure Agent to version 1.52.3 or later
            </td>
        </tr>
        <tr>
            <td>
...
2. **Once I update to the latest versions of the listed log forwarding services, do I have to do anything else?**
    ...
    There are no further configuration changes required to the Windows infrastructure agent, Kubernetes Plugin, or Fluent Bit Output Plugin after updating to the most recent versions, although New Relic recommends that you periodically check your set configurations to make sure they match your desired settings. 
