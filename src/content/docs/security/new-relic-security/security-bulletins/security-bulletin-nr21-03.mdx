...
If you are unable to upgrade either your Java agent or log4j version, you should consider using the published workaround of setting the log4j2.formatMsgNoLookups=true system property in your application startup command.
