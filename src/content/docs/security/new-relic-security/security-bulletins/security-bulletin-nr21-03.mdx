...
<DNT>**If you use log4j directly in your applications, be sure to carefully review the [Apache Log4j Security Vulnerabilities](https://logging.apache.org/log4j/2.x/security.html). This page provides remediation details for you to consider.**</DNT>
