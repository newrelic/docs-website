...
<DNT>**Release date:**</DNT> March 9th, 2021
...
* [Update to the latest <InlinePopover type="browser"/> agent.](/docs/browser/new-relic-browser/installation/update-browser-agent)
