...
### Recommended Action: 
* Customers who use Microsoft Extension Logging should [upgrade to version 10.1.0 or later ](https://docs.newrelic.com/docs/apm/agents/net-agent/installation/update-net-agent/)
* **Technical Links**: [Updating the .NET agent](https://docs.newrelic.com/docs/apm/agents/net-agent/installation/update-net-agent/)
* **Workarounds**: Affected customers who cannot update their .NET Agents to 10.1.0 or later at this time can [disable log forwarding](https://docs.newrelic.com/docs/logs/logs-context/disable-automatic-logging/). 
