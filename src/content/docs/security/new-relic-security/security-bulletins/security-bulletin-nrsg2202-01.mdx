...
<table>
  <thead>
    ...
    <tr>
      <td>
        <DoNotTranslate>**.NET agent 9.7.0 through 10.0.0**</DoNotTranslate> 
      </td>
      <td>
        <DoNotTranslate>**Microsoft Extensions Logging (MEL)**</DoNotTranslate>
      </td>
      <td>
        <DoNotTranslate>**Log forwarding enabled and log level set**</DoNotTranslate>
      </td>
      <td>
        <DoNotTranslate>**Affected**</DoNotTranslate>
      </td>
     </tr>
     <tr>
      <td> 
...
* <DoNotTranslate>**Technical Links**</DoNotTranslate>: [Updating the .NET agent](/docs/apm/agents/net-agent/installation/update-net-agent/)
* <DoNotTranslate>**Workarounds**</DoNotTranslate>: Affected customers who cannot update their .NET agents to 10.1.0 or later at this time can [disable log forwarding](/docs/logs/logs-context/disable-automatic-logging/). 
