...
3. **Review permissions:** Ensure your IAM role or user has the specific AWS permissions your workflow requires. Check the [Required AWS permissions](/docs/workflow-automation/setup-and-configure/set-up-aws-credentials#required-aws-permissions) table.
...
For detailed instructions on viewing logs and execution history, see [Monitor workflow runs](/docs/workflow-automation/manage-workflows/managing-workflow#monitor-runs).
