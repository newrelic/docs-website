...
1. **For session tokens:** Check the expiration timestamp—session tokens typically last 1-12 hours. Generate new ones before they expire using:
   ...
   ```
2. **For access keys:** Verify both the Access Key ID and Secret Access Key are correctly stored in secrets manager. Re-check the values in [NerdGraph GraphiQL explorer](https://one.newrelic.com/nerdgraph-graphiql).
...
1. **Check the run history**:
   - Go to **[one.newrelic.com](https://one.newrelic.com) > All Capabilities > Workflow Automation**
...
4. **Verify SQL syntax**: NRLens SQL differs from NRQL—review [NRLens documentation](https://docs.newrelic.com/docs/nrlens-overview) for supported syntax
...
- **[Workflow Automation community forum](https://discuss.newrelic.com/)**: Ask questions and get help from other users
- **[New Relic Support](https://support.newrelic.com/)**: Contact support for account-specific issues
- **[Workflow best practices](/docs/workflow-automation/limitations-and-faq/workflow-best-practices)**: Learn patterns for reliable workflows
- **[Workflow limits](/docs/workflow-automation/limitations-and-faq/workflow-limits)**: Understand system constraints and quotas
