...
<DocTiles>
  ...
  <DocTile title='Set up AWS credentials' path="/docs/workflow-automation/setup-and-configuration/set-up-aws-credentials">Fix AWS authentication and permission errors</DocTile>
  <DocTile title='Create destinations' path="/docs/workflow-automation/setup-and-configuration/create-destinations">Configure Slack and notification integrations correctly</DocTile>
