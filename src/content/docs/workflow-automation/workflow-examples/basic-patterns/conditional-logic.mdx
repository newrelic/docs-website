...
<DocTiles>
  <DocTile title='Loops' path="/docs/workflow-automation/workflow-examples/basic-patterns/loops">Combine conditional logic with iteration</DocTile>
  <DocTile title='Slack integration' path="/docs/workflow-automation/workflow-examples/integrations/slack">Apply switch patterns to approval workflows</DocTile>
  <DocTile title='Definition schema: Switch' path="/docs/workflow-automation/workflow-automation-apis/definition-schema#switch">Complete switch step reference</DocTile>
</DocTiles>
