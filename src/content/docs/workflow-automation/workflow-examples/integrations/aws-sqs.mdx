...
- See [Set up AWS credentials](/docs/workflow-automation/setup-and-configure/set-up-aws-credentials) for configuration instructions
...
<DocTiles>
  <DocTile title='REST API polling' path="/docs/workflow-automation/workflow-examples/integrations/rest-api-polling">Combine SQS with API polling workflows</DocTile>
  <DocTile title='Deployment rollback' path="/docs/workflow-automation/workflow-examples/advanced/deployment-rollback">Use SQS for deployment notifications</DocTile>
  <DocTile title='AWS SQS actions' path="/docs/workflow-automation/setup-and-configure/actions-catalog/aws/sqs/aws-sqs">Learn SQS action parameters</DocTile>
</DocTiles>
