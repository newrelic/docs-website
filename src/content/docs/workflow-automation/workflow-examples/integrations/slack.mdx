...
<DocTiles>
  ...
  <DocTile title='Create destinations' path="/docs/workflow-automation/setup-and-configuration/create-destinations">Configure Slack bot and channels</DocTile>
  <DocTile title='Slack actions' path="/docs/workflow-automation/setup-and-configuration/actions-catalog/slack/slack-chat">Complete Slack action reference</DocTile>
</DocTiles>
