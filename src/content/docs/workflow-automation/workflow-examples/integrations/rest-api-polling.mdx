...
<DocTiles>
  <DocTile title='Loops' path="/docs/workflow-automation/workflow-examples/basic-patterns/loops">Master loop patterns for polling</DocTile>
  <DocTile title='HTTP GET/POST' path="/docs/workflow-automation/workflow-examples/basic-patterns/http-get-post">Learn HTTP action fundamentals</DocTile>
  <DocTile title='JSON parsing' path="/docs/workflow-automation/workflow-examples/basic-patterns/json-parsing">Parse API responses effectively</DocTile>
</DocTiles>
