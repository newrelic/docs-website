...
**Requirements:** 
  - New Relic account
  - Email destination (see [Send notifications](/docs/workflow-automation/setup-and-configure/create-destinations))
...
**To schedule**, use [CreateSchedule API](/docs/workflow-automation/workflow-automation-apis/create-schedule) with cron expression `*/10 * * * *` (every 10 minutes). Minimum interval is 10 minutes. See [workflow limits](/docs/workflow-automation/limitations-and-faq/workflow-limits) for details.

## Related topics [#related-topics]

<DocTiles>
  <DocTile title='Deployment rollback' path="/docs/workflow-automation/workflow-examples/advanced/deployment-rollback">Use NRQL in deployment workflows</DocTile>
  <DocTile title='EC2 management' path="/docs/workflow-automation/workflow-examples/advanced/ec2-management">Combine NRQL queries with infrastructure automation</DocTile>
  <DocTile title='NRQL actions' path="/docs/workflow-automation/setup-and-configure/actions-catalog/newrelic/query/newrelic-nrdb">Learn NRQL query action syntax</DocTile>
</DocTiles>
