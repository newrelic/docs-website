...
**To schedule**, use [CreateSchedule API](/docs/workflow-automation/manage-workflows/start-schedule#scheduled) with cron expression `*/10 * * * *` (every 10 minutes). Minimum interval is 10 minutes. See [workflow limits](/docs/workflow-automation/limitations-and-faq/workflow-limits) for details.
...
<DocTiles>
  ...
  <DocTile title='NRQL actions' path="/docs/workflow-automation/setup-and-configure/actions-catalog/newrelic/newrelic-nrdb">Learn NRQL query action syntax</DocTile>
</DocTiles>
