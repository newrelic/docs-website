...
<DocTiles>
  ...
  <DocTile title='AWS actions' path="/docs/workflow-automation/setup-and-configure/actions-catalog/actions-catalog">Browse all AWS actions for workflows</DocTile>
</DocTiles>
