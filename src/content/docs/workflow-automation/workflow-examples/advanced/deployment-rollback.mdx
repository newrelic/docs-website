...
<DocTiles>
  ...
  <DocTile title='NRQL actions' path="/docs/workflow-automation/setup-and-configure/actions-catalog/newrelic/query/newrelic-nrdb">Query deployment data with NRQL</DocTile>
</DocTiles>
