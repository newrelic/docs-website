...
<DocTiles>
  ...
  <DocTile title='NRQL actions' path="/docs/workflow-automation/setup-and-configuration/actions-catalog/newrelic/newrelic-nrdb">Query deployment data with NRQL</DocTile>
</DocTiles>
