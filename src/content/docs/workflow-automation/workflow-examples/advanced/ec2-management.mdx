...
<DocTiles>
  <DocTile title='API gateway rollback' path="/docs/workflow-automation/workflow-examples/advanced/api-gateway-rollback">Automate API Gateway deployments</DocTile>
  <DocTile title='Deployment rollback' path="/docs/workflow-automation/workflow-examples/advanced/deployment-rollback">Monitor and manage deployments</DocTile>
  <DocTile title='Set up AWS credentials' path="/docs/workflow-automation/setup-and-configuration/set-up-aws-credentials">Configure IAM roles for EC2 workflows</DocTile>
</DocTiles>
