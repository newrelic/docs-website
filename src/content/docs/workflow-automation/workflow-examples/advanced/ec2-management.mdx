...
<DocTiles>
  ...
  <DocTile title='Set up AWS credentials' path="/docs/workflow-automation/setup-and-configure/set-up-aws-credentials">Configure IAM roles for EC2 workflows</DocTile>
</DocTiles>
