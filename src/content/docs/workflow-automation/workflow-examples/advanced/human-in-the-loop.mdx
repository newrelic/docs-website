...
This pattern combines three parts that must work together:
  ...
  * [`newrelic.notification.createSignalUrl`](/docs/workflow-automation/setup-and-configure/actions-catalog/newrelic/notification/newrelic-notification#newrelic.notification.createSignalUrl) — generates the URL a person clicks to send a signal.
...
<DocTiles>
  <DocTile title="Create a signal URL" path="/docs/workflow-automation/setup-and-configure/actions-catalog/newrelic/notification/newrelic-notification#newrelic.notification.createSignalUrl">Reference for the newrelic.notification.createSignalUrl action</DocTile>
