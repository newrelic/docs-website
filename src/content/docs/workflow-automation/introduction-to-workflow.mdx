  ...
  <TabsPages>
    ...
    <TabsPageItem id="custom">
      Build workflows from scratch using the drag-and-drop interface. Chain actions, add conditional logic, and integrate with your tools.
        ...
        3. Browse available [actions](/docs/workflow-automation/setup-and-configuration/actions-catalog)
...
<CollapserGroup>
  ...
  >
    - **[Actions catalog](/docs/workflow-automation/setup-and-configuration/actions-catalog)**: Browse all available AWS, New Relic, and HTTP actions
