...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The type of step that generated this event. `ACTION` executes an action from the catalog; `LOOP` iterates over a collection; `SWITCH` evaluates conditions; `STATE` stores key/value pairs in the workflow's shared state.
      </td>
    </tr>
    <tr>
      <td>
