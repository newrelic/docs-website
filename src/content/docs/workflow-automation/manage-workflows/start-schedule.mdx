...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td>
              **Setup**: [Configure as alert destination](/docs/workflow-automation/setup-and-configure/create-destinations#trigger-from-alerts)
            </td>
            <td>
...
After creating a schedule:
  - **View active schedules**: See all scheduled runs in the [workflow dashboard](/docs/workflow-automation/manage-workflows/managing-workflow#view-workflows)
...
<DocTiles>
  <DocTile title='Manage workflows' path="/docs/workflow-automation/manage-workflows/managing-workflow">Monitor execution history and manage running workflows</DocTile>
