...
<DocTiles>
  <DocTile title='Start and schedule workflows' path="/docs/workflow-automation/manage-workflows/start-schedule">Trigger and schedule your workflows</DocTile>
  ...
  <DocTile title='Workflow examples' path="/docs/workflow-automation/workflow-examples/workflow-examples">Learn from real-world workflow patterns</DocTile>
</DocTiles>
