...
<DocTiles>
  <DocTile title='Workflow limits' path="/docs/workflow-automation/limitations-and-faq/workflow-limits">Understand timeouts, rate limits, and system constraints</DocTile>
  <DocTile title='Troubleshooting' path="/docs/workflow-automation/troubleshooting">Debug common workflow errors and failures</DocTile>
  <DocTile title='Workflow automation APIs' path="/docs/workflow-automation/workflow-automation-apis/using-workflow-automation-api">Manage workflows programmatically for CI/CD</DocTile>
  <DocTile title='Workflow examples' path="/docs/workflow-automation/workflow-examples/workflow-examples">See best practices applied in real workflows</DocTile>
</DocTiles>
