...
<Callout variant="tip">
  **For sending notifications from workflows**: Use the actions catalog to add notification actions directly in your workflow steps:
  ...
  - **Email**: Use [`newrelic.notification.sendEmail`](/docs/workflow-automation/setup-and-configure/actions-catalog/newrelic/newrelic-notification) after setting up email destinations in [Alerts > Destinations](/docs/alerts/get-notified/destinations/)
</Callout>
