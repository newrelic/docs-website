...
redirects:
  - /docs/workflow-automation/setup-and-configure/create-destinations
...
<Callout variant="tip">
  **For sending notifications from workflows**: Use the actions catalog to add notification actions directly in your workflow steps:
  - **Slack**: Use [`slack.chat.postMessage`](/docs/workflow-automation/setup-and-configure/actions-catalog/slack/slack-chat) for direct Slack integration
  - **PagerDuty**: Use [PagerDuty actions](/docs/workflow-automation/setup-and-configure/actions-catalog/pagerduty/pagerduty-incident) for incident management
  - **Email**: Use [`newrelic.notification.sendEmail`](/docs/workflow-automation/setup-and-configure/actions-catalog/newrelic/notification/newrelic-notification) after setting up email destinations in [Alerts > Destinations](/docs/alerts/get-notified/destinations/)
</Callout>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
              Easy - requires destination setup
            </td>
            <td>
              Attachments, HTML formatting, query results
            </td>
        </tr>
        <tr>
            <td>
...
<Callout variant="important">
  ...
  2. To configure your notification workflow, on the Configure your notification workflow page, provide the required information:
      ...
      - Click **Additional settings** to enrich your data by building [NRQL queries](/docs/alerts/get-notified/alert-event-workflows#enrichments) to gather related data from across your New Relic platform. For enrichment examples, see [Workflow data enrichment](/docs/alerts/get-notified/custom-variables-alert-event-workflows#enrichment-examples).
  ...
  4. (Optional) You can also add other destinations like [Slack](/docs/workflow-automation/setup-and-configure/actions-catalog/slack/slack-chat#configure-slack-integration) to receive notifications alongside triggering the workflow:
...
<DocTiles>
  <DocTile title='Slack actions' path="/docs/workflow-automation/setup-and-configure/actions-catalog/slack/slack-chat">Send messages and get reactions in Slack channels</DocTile>
  <DocTile title='Slack integration example' path="/docs/workflow-automation/workflow-examples/integrations/slack">Build workflows with Slack approval gates</DocTile>
  <DocTile title='Use a template' path="/docs/workflow-automation/create-a-workflow-automation/use-a-template">Deploy notification workflows from templates</DocTile>
  <DocTile title='Workflow best practices' path="/docs/workflow-automation/limitations-and-faq/workflow-best-practices">Security best practices for notification credentials</DocTile>
</DocTiles>
