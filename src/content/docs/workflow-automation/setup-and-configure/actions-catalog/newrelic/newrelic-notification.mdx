...
<CollapserGroup>
  ...
  <Callout variant="important">
    ...
    The `waitStepName` you provide as input must match the name of a valid wait step in the same workflow definition, and that wait step must contain at least one signal. Otherwise the action fails.
  </Callout>
