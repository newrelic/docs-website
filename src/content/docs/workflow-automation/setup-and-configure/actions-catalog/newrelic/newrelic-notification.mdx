...
```
            ...
            <tr>
                ...
                <td>Optional</td>
                <td>String</td>
                <td>Text message which need to be sent. You must provide either `text` or `blocks`, but not both.</td>
                <td>Hello ! this message from Workflow</td>
            </tr>
            <tr>
                <td>**blocks**</td>
    ...
    Only two block types are supported. Any other block type is strictly rejected at validation time.
    ...
    <table>
        ...
        <tbody>
            <tr>
                <td>`section`</td>
                <td>
                  The only text-rendering block supported. The `text` object's `type` must be either `mrkdwn` or `plain_text`, and `text` must be a non-blank string.
                </td>
                <td>`type`, `text`</td>
...
```
  ...
  <table>
    <thead>
        <tr>
            <th>Workflow example with a blocks message</th>
        </tr>
    </thead>
    <tbody>
        <tr>
