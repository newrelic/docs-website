...
redirects:
  - /docs/workflow-automation/setup-and-configure/actions-catalog/aws/aws-execute-api
...
## Security and IAM configuration
  ...
  To use this action, you must configure AWS credentials. See [Set up AWS credentials](/docs/workflow-automation/setup-and-configure/set-up-aws-credentials/) for detailed instructions on creating an IAM role or IAM user.
...
The action identifier is `aws.execute.api`.
...
`${{ :secrets:<awsSessionToken> }}`
                ...
                <tr>
                    <td>**region**</td>
                    <td>String</td>
                    <td>**Required.** The AWS region where the target service resides.</td>
                    <td>
`region: "us-east-2"`
                    </td>
                </tr>
                <tr>
                    <td>**service**</td>
                    <td>String</td>
                    <td>**Required.** The AWS service to call. See [AWS available services](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/index.html) for a full list.</td>
                    <td>`service: "sqs"`</td>
                </tr>
                <tr>
                    <td>**api**</td>
                    <td>String</td>
                    <td>**Required.** The API operation to execute on the specified service.</td>
                    <td>
`api: "create_queue"`
                    </td>
                </tr>
                <tr>
                    <td>**parameters**</td>
                    <td>Map</td>
                    <td>**Required.** A map of parameters to pass to the API operation.</td>
                    <td>
                      <p>
```yaml
parameters: {
...
```
                ...
                <tr>
                    <td>**selectors**</td>
                    <td>List</td>
                    <td>**Optional.** A list of JMESPath selectors that extract specific fields from the action output. Use selectors to get only the specified parameters as output.</td>
                    <td>
      ...
      <table>
        ...
        <tbody>
            <tr>
                <td>**response**</td>
                <td>Object</td>
                <td>The full response object from the AWS API call. Each service and API have different response shapes. Example: `{"response":<aws api reponse>}`. For an example, see the [DynamoDB Query response](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/dynamodb/client/query.html).</td>
            </tr>
            <tr>
                <td>**success**</td>
                <td>Boolean</td>
                <td>Indicates whether the API call succeeded. Example: `success: true | false`</td>
            </tr>
            <tr>
                <td>**errorMessage**</td>
                <td>String</td>
                <td>Contains the error message if the API call failed. Example: `errorMessage: "User does not have permission to query DynamoDB"`</td>
            </tr>
        </tbody>
      </table>
          ...
          <Callout variant="important">
            ...
            - Refer to [AWS credentials](/docs/workflow-automation/setup-and-configure/set-up-aws-credentials/) for instructions.
