    ...
    <table>
        ...
        <tbody>
            <tr>
                <td>`clientId`</td>
                <td>String</td>
                <td>**Required.** Must be passed as a secret. An Azure Service Principal clientID. See how to [register an Azure app.](https://learn.microsoft.com/en-us/azure/azure-monitor/logs/api/register-app-for-token?tabs=portal)</td>
            </tr>
            <tr>
                <td>`clientSecret`</td>
                <td>String</td>
                <td>**Required.** Must be passed as a secret. An Azure Service Principal clientSecret. See how to [register an Azure app.](https://learn.microsoft.com/en-us/azure/azure-monitor/logs/api/register-app-for-token?tabs=portal)</td>
            </tr>
            <tr>
                <td>`tenantId`</td>
                <td>String</td>
            ...
            <tr>
                <td>`urlPath`</td>
                <td>String</td>
                <td>**Required.** The URL path for the [Azure API request](https://learn.microsoft.com/en-us/rest/api/azure/).</td>
            </tr>
            <tr>
                <td>`method`</td>
                <td>String</td>
                <td>**Required.** One of [`"GET", "POST", "PUT", "DELETE", "PATCH"`]</td>
            </tr>
            <tr>
                <td>`body`</td>
                <td>Map</td>
                <td>**Optional.** An optional body as a JSON map to pass when needed, typically used with `PUT`, `PATCH` and `POST` methods. Secret references are allowed.</td>
            </tr>
        </tbody>
    </table>
  </TabsPageItem>
