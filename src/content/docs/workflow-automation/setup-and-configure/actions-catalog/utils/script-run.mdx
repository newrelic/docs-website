...
redirects:
  - /docs/workflow-automation/setup-and-configure/actions-catalog/utils/script-run
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <td>**script**</td>
                    <td>String</td>
                    <td>**Required.** Any data transformation script</td>
                    <td>
```yaml
script: |
  print("Hello, World!")
```
                ...
                <tr>
                    <td>**runtime**</td>
                    <td>Enum</td>
                    <td>**Required.** Run time version of script</td>
                    <td>`PYTHON_3_13`</td>
                </tr>
                <tr>
                    <td>**parameters**</td>
                    <td>List</td>
                    <td>**Optional.** list of parameters to be used in script</td>
