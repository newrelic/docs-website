  ...
  <table>
      ...
      <tbody>
          ...
          <tr>
              <td>**issueKey**</td>
              <td>String</td>
              <td>**Required.** The key of the Jira issue to get transitions for.</td>
              <td>`"PROJ-1234"`</td>
          </tr>
          <tr>
              <td>**parameters**</td>
              <td>Map</td>
              <td>**Optional.** Optional URL query parameters for the Jira API request. See the parameters reference table below.</td>
