...
<DocTiles>
  ...
  <DocTile title='Create destinations' path="/docs/workflow-automation/setup-and-configure/create-destinations">Set up Slack and email notifications for workflows</DocTile>
