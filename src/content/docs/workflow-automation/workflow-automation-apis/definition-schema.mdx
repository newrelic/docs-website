...
<DocTiles>
  ...
  <DocTile title='Actions catalog' path="/docs/workflow-automation/setup-and-configuration/actions-catalog/actions-catalog">Browse all available actions and their input/output schemas</DocTile>
</DocTiles>
