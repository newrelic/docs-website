...
<DocTiles>
  <DocTile title='Actions catalog' path="/docs/workflow-automation/setup-and-configuration/actions-catalog/actions-catalog">Browse human-readable action documentation with examples</DocTile>
