...
<DocTiles>
  <DocTile title='Definition schema: Wait step' path="/docs/workflow-automation/workflow-automation-apis/definition-schema#wait">Learn how to configure wait steps with signals</DocTile>
  <DocTile title='Start workflow run' path="/docs/workflow-automation/workflow-automation-apis/start-workflow-run">Execute a workflow to get a runId for signaling</DocTile>
  <DocTile title='Workflow run info' path="/docs/workflow-automation/workflow-automation-apis/workflow-run-info">Check if workflow is waiting for a signal</DocTile>
</DocTiles>