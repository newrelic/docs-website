...
Most templates need credentials and integrations:
  ...
  - **AWS templates**: [AWS credentials](/docs/workflow-automation/setup-and-configure/set-up-aws-credentials) with permissions (EC2, API Gateway, Systems Manager, or SQS).
...
<Steps>
  ...
  <Step>
    ...
    1. Trigger manually (see [Start workflows on demand](/docs/workflow-automation/manage-workflows/workflow-entity-overview#on-demand))
...
<CollapserGroup>
  ...
  >
    ...
    **What you'll need:**
    ...
    - **Slack**: App for notifications and approval
    - **New Relic**: Alert condition monitoring EC2, EC2 integrated with New Relic via [CloudWatch Metric Streams](/docs/infrastructure/amazon-integrations/aws-integration-for-metrics/via-cloudformation-cwms/), and the [EC2 monitoring integration](/docs/infrastructure/amazon-integrations/aws-integrations-list/aws-ec2-monitoring-integration#activate)
...
<DocTiles>
  <DocTile title='Create your own workflow' path="/docs/workflow-automation/create-a-workflow-automation/create-your-own">Build custom workflows from scratch with advanced patterns</DocTile>
  <DocTile title='Workflow entity overview' path="/docs/workflow-automation/manage-workflows/workflow-entity-overview">Trigger your deployed template manually or on a schedule</DocTile>
  <DocTile title='Manage workflows' path="/docs/workflow-automation/manage-workflows/managing-workflow">Edit templates and monitor execution history</DocTile>
  <DocTile title='Troubleshooting' path="/docs/workflow-automation/troubleshooting">Debug common template configuration issues</DocTile>
</DocTiles>