...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        `workflow.forEach` for items, `workflow.repeat` for polling.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Slack reactions before destructive operations
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Catch failures and run cleanup
      </td>

      <td>
        Try-catch patterns with rollback procedures
      </td>
    </tr>
  </tbody>
</table>
...
3. Drag actions from the [catalog](/docs/workflow-automation/setup-and-configuration/actions-catalog), connect them with `${{ .steps.stepName.outputs.field }}` syntax to pass data
