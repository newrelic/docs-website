  ...
  <table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>string</td>
            <td>The `automationExecutionStatus: "Success"` if action is successful and will reflect any of the values listed in the `automationExecutionStatuses` input field. If the action fails, this field will be null.</td>
        </tr>
        <tr>
