...
<CollapserGroup>
    <Collapser
        ...
        title="Trigger an AWS Lambda function"
    >
...
<CollapserGroup>
    <Collapser
        ...
        title="aws.systemsManager.deleteDocument"
    >
...
<CollapserGroup>
    <Collapser
        ...
        title="aws.systemsManager.startAutomation"
    >
...
<CollapserGroup>
    <Collapser
        ...
        title="aws.systemsManager.waitForAutomationStatus"
    >
...
<Tabs>
  ...
  ```
          The output will be a map of output values from the document. Whatever we output in the document can be collected using this output field and can be used in the further steps of our workflow automation definition.
            </td>
        </tr>
        <tr>
            <td>**success**</td>
...
<CollapserGroup>
    <Collapser
        ...
        title="aws.systemsManager.writeDocument"
    >
  Write a document to the AWS account based on the aws credentials passed in the action input. See [AWS Systems Manager Documentation](https://docs.aws.amazon.com/systems-manager/?id=docs_gateway)
...
<CollapserGroup>
    <Collapser
        id="http.post"
        title="Make a HTTP POST request"
    >
...
<CollapserGroup>
    <Collapser
        id="http.delete"
        title="Make a HTTP DELETE request"
    >
...
<CollapserGroup>
    <Collapser
        ...
        title="Create a custom event in New Relic"
    >
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>Optional</td>
            <td>map</td>
            <td>Common attributes which will be part of all the events when provided. Merging for each event item when needed event item overrides common definition.</td>
        ...
        <tr>
            ...
            <td>Optional</td>
            <td>string</td>
            <td>The New Relic Account License Key is a required input that specifies the target account where events will be sent. If this value is not provided as an input, a default license key will be assumed based on the account executing the workflow.  In other words, you need to specify the New Relic license key where you want to send your events. If you don't provide one, the system will use a default license key associated with the account running the workflow.</td>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>Optional</td>
            <td>string</td>
            <td>The New Relic Account License Key is a required input that specifies the target account where logs will be sent. If this value is not provided as an input, a default license key will be assumed based on the account executing the workflow.  In other words, you need to specify the New Relic license key where you want to send your logs. If you don't provide one, the system will use a default license key associated with the account running the workflow.</td>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>Optional</td>
            <td>list of int</td>
            <td>The **New Relic Account IDs** input is a list of target IDs that allows you to specify the target accounts where the query will be executed against. If this value is not provided as an input, the query will automatically be executed against the account associated with the workflow's execution account.</td>
            <td></td>
        </tr>
        <tr>
            <td>**selectors**</td>
...
<CollapserGroup>
    <Collapser
        ...
        title="utils.datetime.fromEpoch"
    >
...
<CollapserGroup>
    <Collapser
        ...
        title="Convert data to CSV fromat"
    >
...
<DocTiles>
  <UserJourneyControls
previousStep={{path: "/docs/workflow-automation/workflow-limits/", title: "Workflow automation limits", body: "New Relic Workflow automation limits."}}
/>
  <DocTile title='JQ capabilities for data manipulation in workflow' path="/docs/workflow-automation/jq/">Learn about the key capabilities of JQ for data manipulation in workflow automation steps.</DocTile>
</DocTiles>
