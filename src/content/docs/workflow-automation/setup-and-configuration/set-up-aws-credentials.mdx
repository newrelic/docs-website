...
You've secured your AWS credentials. Now set up where your workflows will send notifications and alerts.

**Next in your journey**: [Create destinations and notifications](/docs/workflow-automation/setup-and-configuration/create-destinations) - Configure Slack, email, and other notification channels for your workflows.

**Continue setting up**:
- [Browse the actions catalog](/docs/workflow-automation/setup-and-configuration/actions-catalog) - See all available workflow actions
