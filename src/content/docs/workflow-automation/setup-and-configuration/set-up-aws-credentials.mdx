...
After configuring AWS credentials, you can create workflows:
  ...
  **Create workflows:**
  1. **[Browse AWS actions](/docs/workflow-automation/setup-and-configuration/actions-catalog/actions-catalog)**: View available AWS operations (EC2, SQS, DynamoDB, etc.)
