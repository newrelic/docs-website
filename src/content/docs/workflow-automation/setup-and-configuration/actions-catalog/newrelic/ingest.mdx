...
tags:
  ...
  - New relic actions
  - ingest actions
metaDescription: "Data ingest actions for sending custom events and logs to New Relic"
...
This page provides a reference for New Relic data ingest actions available in the workflow automation actions catalog. These actions enable you to send custom events and logs to New Relic from your workflow definitions.
