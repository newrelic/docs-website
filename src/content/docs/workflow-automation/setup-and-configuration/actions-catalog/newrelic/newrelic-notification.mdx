...
<CollapserGroup>
  ...
  <Tabs>
    <TabsBar>
      <TabsBarItem id="newrelic.workflowAutomation.startWorkflowRun-inputs">
        Inputs
      </TabsBarItem>
      <TabsBarItem id="newrelic.workflowAutomation.startWorkflowRun-outputs">
        Outputs
      </TabsBarItem>
      <TabsBarItem id="newrelic.workflowAutomation.startWorkflowRun-example">
        Example
      </TabsBarItem>
    </TabsBar>

    <TabsPages>
      <TabsPageItem id="newrelic.workflowAutomation.startWorkflowRun-inputs">
    <table>
        <thead>
            <tr>
              <th>Input Field</th>
  ...
  <TabsPageItem id="newrelic.workflowAutomation.startWorkflowRun-outputs">
  <table>
    <thead>
        <tr>
            <th>Output Field</th>
  ...
  <TabsPageItem id="newrelic.workflowAutomation.startWorkflowRun-example">
  <table>
    <thead>
        <tr>
            <th>Workflow example</th>
