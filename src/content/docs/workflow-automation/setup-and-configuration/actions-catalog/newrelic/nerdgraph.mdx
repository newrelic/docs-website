...
tags:
  ...
  - New relic actions
  - nerdgraph actions
metaDescription: "NerdGraph actions for executing GraphQL queries and mutations against New Relic"
...
This page provides a reference for New Relic NerdGraph actions available in the workflow automation actions catalog. These actions enable you to execute GraphQL queries and mutations against the New Relic NerdGraph API from your workflow definitions.
