...
metaDescription: "Notification actions for sending messages via New Relic destinations"
...
This page provides a reference for New Relic notification actions available in the workflow automation actions catalog. These actions enable you to send notifications through various channels including Slack, Microsoft Teams, and Email using New Relic destinations from your workflow definitions.
