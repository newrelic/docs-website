...
tags:
  ...
  - nrdb actions
  - nrql actions
metaDescription: "NRDB query actions for executing NRQL queries against New Relic"
...
This page provides a reference for New Relic NRDB query actions available in the workflow automation actions catalog. These actions enable you to execute NRQL queries against the New Relic Database (NRDB) from your workflow definitions.
