...
Quick reference of all communication actions by platform:
...
<table>
  ...
  <tbody>
    <tr>
      <td>**Slack**</td>
      <td>[Post message](#slackchatpostmessage)</td>
      <td>Send messages to Slack channels with optional file attachments</td>
    </tr>
    <tr>
      <td>**Slack**</td>
      <td>[Get reactions](#slackchatgetreactions)</td>
      <td>Retrieve emoji reactions from Slack messages</td>
    </tr>
  </tbody>
</table>
...
<Callout variant="important">
  ...
  - **timeout**: The time in seconds for how long to wait for any reaction. default to 60s, maximum allowed is 600s (10min).
