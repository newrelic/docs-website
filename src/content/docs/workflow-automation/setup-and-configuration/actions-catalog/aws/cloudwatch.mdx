...
This page provides a comprehensive reference for AWS CloudWatch actions available in the workflow automation actions catalog. These actions enable you to retrieve and send log events to CloudWatch Logs within your workflow definitions.

## Prerequisites

Before using AWS CloudWatch actions in workflow automation, ensure you have:

  * An AWS account with appropriate permissions.
  * AWS credentials configured (IAM user credentials, IAM role ARN, or session credentials).
  * The necessary IAM permissions for AWS CloudWatch Logs operations.
