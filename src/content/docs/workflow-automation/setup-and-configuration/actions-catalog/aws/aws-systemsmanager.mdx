  ...
  **Complete autoflows definition with SSM listing lambda functions**
   ...
   ** Example 2: Execute a Python script**
    ...
    **Example 3: A more complex SSM document**
      ...
      1. Step-1: Get the list of API gateway rest APIs. Filter my api (`Test API`) and get the rest API id.
      ...
      <Collapser
        id="ssm.document.performing"
        title="SSM document performing API gateway rollback"
      >
        ```yaml
        schemaVersion: '0.3'
