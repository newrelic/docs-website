...
This page provides a comprehensive reference for AWS Lambda actions available in the workflow automation actions catalog. These actions enable you to invoke Lambda functions, manage function configurations, and retrieve function metadata within your workflow definitions.
...
Before using AWS Lambda actions in workflow automation, ensure you have:
  ...
  * The necessary IAM permissions for AWS Lambda operations.
