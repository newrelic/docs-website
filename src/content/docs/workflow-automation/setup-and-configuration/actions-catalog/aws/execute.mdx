...
tags:
  ...
  - AWS actions
  - Execute API
metaDescription: "A reference for the AWS Execute API action available in the workflow automation actions catalog"
...
This page provides a comprehensive reference for the AWS Execute API action available in the workflow automation actions catalog. This action enables you to execute any AWS API operation for a specified service within your workflow definitions.

## Prerequisites

Before using the AWS Execute API action in workflow automation, ensure you have:

  * An AWS account with appropriate permissions.
  * AWS credentials configured (IAM user credentials, IAM role ARN, or session credentials).
  * The necessary IAM permissions for the specific AWS services and APIs you plan to use.
