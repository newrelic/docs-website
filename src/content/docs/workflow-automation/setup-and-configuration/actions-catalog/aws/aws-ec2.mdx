...
<CollapserGroup>
  ...
  ```
    ...
    >
      ...
      <Tabs>
    <TabsBar>
        <TabsBarItem id="ec2.describeInstances-inputs">
          Inputs
      </TabsBarItem>

      <TabsBarItem id="ec2.describeInstances-outputs">
        Outputs
      </TabsBarItem>

      <TabsBarItem id="ec2.describeInstances-example">
        Example
      </TabsBarItem>
    </TabsBar>
...
steps:
  ...
  <Tabs>
    <TabsBar>
        <TabsBarItem id="bedrock-invokeAgent-inputs">
          Inputs
      </TabsBarItem>

      <TabsBarItem id="bedrock-invokeAgent-outputs">
        Outputs
      </TabsBarItem>

      <TabsBarItem id="bedrock-invokeAgent-example">
        Example
      </TabsBarItem>
    </TabsBar>
