...
## Available New Relic actions

Quick reference of all New Relic actions by category:
...
<table>
  ...
  <tbody>
    <tr>
      <td>**Data Ingest**</td>
      <td>[Send custom events](#newrelicingestsendevents)</td>
      <td>Send custom events to New Relic</td>
    </tr>
    <tr>
      <td>**Data Ingest**</td>
      <td>[Send logs](#newrelicingestsendlogs)</td>
      <td>Send log data to New Relic</td>
    </tr>
    <tr>
      <td>**NerdGraph**</td>
      <td>[Execute GraphQL query or mutation](#newrelicnerdgraphexecute)</td>
      <td>Execute GraphQL commands against NerdGraph API</td>
    </tr>
    <tr>
      <td>**Query**</td>
      <td>[Run NRDB query](#newrelicnrdbquery)</td>
      <td>Execute cross-account NRQL queries</td>
    </tr>
    <tr>
      <td>**Notifications**</td>
      <td>[Send notification](#newrelicnotificationsend)</td>
      <td>Send notifications to New Relic destinations</td>
    </tr>
  </tbody>
</table>
