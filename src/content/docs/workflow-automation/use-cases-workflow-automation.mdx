...
## Workflow Automation use cases [#use-cases]

<CollapserGroup>
  <Collapser
    id="aws-lambda-function-rollback"
    title="Automate AWS lambda function rollback"
  >
  ...
  <Collapser
    id="ec2-instance-cpu-alert-response"
    title="Automate EC2 instance CPU alert response"
  >
