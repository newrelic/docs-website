...
This procedure is part of a lab that teaches you how to troubleshoot your web app with New Relic browser. Now that you've instrumented your application with our browser agent, [debug errors](/docs/browser/new-relic-browser/lab/debug-errors/).
