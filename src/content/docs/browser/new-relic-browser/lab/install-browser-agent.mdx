...
On the right side of the upper navigation bar, click <DNT>**Add data**</DNT>.
...
Scroll down to <DNT>**Browser & mobile**</DNT> and select <DNT>**Browser monitoring**</DNT>.
...
Select <DNT>**Copy/paste JavaScript code**</DNT> for your deployment method.
...
Scroll down to <DNT>**Name your app**</DNT>. Name your app <DNT>**Relicstaurants**</DNT>, and click <DNT>**Enable**</DNT>.
...
From the left hand navigation bar, navigate to <DNT>**Browser**</DNT> and select <DNT>**Relicstaurants**</DNT>.
...
Here, you see <DNT>**Page views with JavaScript errors**</DNT>, <DNT>**Core web vitals**</DNT>, <DNT>**User time on the site**</DNT>, <DNT>**Initial page load and route changes**</DNT>, and other performance data from your app.
