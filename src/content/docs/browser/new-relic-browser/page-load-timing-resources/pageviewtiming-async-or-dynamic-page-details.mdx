...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The `windowUnload` event is available with [agent v1163 or higher](/docs/release-notes/new-relic-browser-release-notes/browser-agent-release-notes/browser-agent-v1163). This occurs when the page unloading is detected. For full definition, see the [data dictionary](/attribute-dictionary/?event=PageViewTiming&attribute=windowUnload).
