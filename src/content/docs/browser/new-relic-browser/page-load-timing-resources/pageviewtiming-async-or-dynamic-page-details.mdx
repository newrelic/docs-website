...
metaDescription: 'The Pageasdfent sends each data point separately to New Relic so you can receive first paint or first interaction data regardless of when it fires.'
redirects:
...
* <DoNotTranslate>**[First Input Delay (FID)](https://web.dev/fid/)**</DoNotTranslate>: measures interactivity. To provide a good user experience, pages should have a FID of <DoNotTranslate>**less than 100 milliseconds**</DoNotTranslate>.
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        For a more detailed explanation, see our [<InlinePopover type="browser" /> release notes](/docs/release-notes/new-relic-browser-release-notes/browser-agent-release-notes/browser-agent-v1153).
      </td>
    </tr>
