...
<table id="navigation-api">
  <thead>
    <tr>
      <th style={{ width: "250px" }}>
        <DoNotTranslate>**Method**</DoNotTranslate>
      </th>

      <th>
        <DoNotTranslate>**Collecting page load timing information**</DoNotTranslate>
      </th>
    </tr>
  </thead>
  ...
  <tbody>
    <tr>
      <td>
        Browsers <DoNotTranslate>**with**</DoNotTranslate> Navigation Timing Specification API
      </td>
      ...
      <td>
        ...
        * <DoNotTranslate>**Navigation start**</DoNotTranslate>: `navigationStart`
        * <DoNotTranslate>**First byte**</DoNotTranslate>: `responseStart`
        * <DoNotTranslate>**DOM ready**</DoNotTranslate>: `DOMContentLoadedEventEnd`
        * <DoNotTranslate>**Page ready**</DoNotTranslate>: `loadEventEnd`
      </td>
    </tr>
    <tr>
      <td>
        Browsers <DoNotTranslate>**without**</DoNotTranslate> Navigation Timing Specification API
      </td>
...
For both https <DoNotTranslate>**and**</DoNotTranslate> http webpages, we transmit data via https. This summarizes when the data is transmitted to and from the webpage.
...
<table>
  <thead>
    <tr>
      <th style={{ width: "250px" }}>
        <DoNotTranslate>**Data transmission**</DoNotTranslate>
      </th>
