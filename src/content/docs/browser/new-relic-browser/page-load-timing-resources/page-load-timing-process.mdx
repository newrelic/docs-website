...
4. The user's browser receives the HTML response and starts to process the Document Object Model, or **DOM**.
...
* [Cached pages](/docs/browser/new-relic-browser/page-load-timing-resources/cached-pages) (how the New Relic agents deal with cached pages, and how browser traces are affected by cached pages)
* [Session tracking](/docs/browser/new-relic-browser/page-load-timing-resources/session-tracking) (how an application's session count relates to its page throughput)
