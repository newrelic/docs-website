...
japaneseVersion: >-
  https://docs.newrelic.co.jp/docs/browser/new-relic-browser/page-load-timing-resources/new-relic-cookies-used-browser
---
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        With the release of [Browser agent v1169](https://docs.newrelic.com/docs/release-notes/new-relic-browser-release-notes/browser-agent-release-notes/browser-agent-v1169), users can turn off cookie collection (JSESSIONID & NREUM, see below) for their Browser app using the Application Settings page. Once this configuration value is set to false (OFF), users will no longer see the session information in their event data. By default, the value is set to true (ON) for all existing Browser apps, as well as newly created ones.
      </td>
    </tr>
...
* [Security for Browser monitoring](/docs/browser/new-relic-browser/getting-started/security-new-relic-browser) (security considerations incorporated into Browser, including cookies)
