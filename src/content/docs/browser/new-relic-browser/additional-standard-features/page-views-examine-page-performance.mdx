...
metaDescription: "Our browser monitoring Page views UI provides several sort options to view details about page load, throughput, and traces."
redirects:
...
Browser monitoring lists page views as [URLs](/docs/browser/new-relic-browser/getting-started/url-whitelists-grouping-browser-metrics). This makes it easy to identify specific front-end page views; for example, `/browse/plans`.
...
3. Select the [time period](/docs/apm/new-relic-apm/ui-functions/time-picker-setting-time-periods-view-data) or sort order, or keep the defaults.
4. Select the type of view for page load timing information as a [chart (default), histogram, or percentile](/docs/apm/applications-menu/features/selecting-dashboard-views).

## Examine performance details [#view_details]

From the page view summary, click a URL to view performance details about page load, frontend and backend timing, throughput, types of browsers, and session traces.
