...
3. Select the type of view for page load timing information as a [chart (default), histogram, or percentile](/apm/apm-ui-pages/monitoring/response-time-chart-types-apm-browser/).
