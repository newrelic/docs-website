...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Browser > (select an app) >
  JS errors:** Use this page to group and filter errors, explore stack trace
  details, and examine trends.
</figcaption>
...
<Callout variant="important">
  [SPA
  monitoring](/docs/browser/single-page-app-monitoring/get-started/install-single-page-app-monitoring-new-relic-browser)
  must be enabled.
</Callout>
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Browser > (select an app) >
  JS errors > (select an error) > Error instances**: With [SPA
  monitoring](/docs/browser/single-page-app-monitoring/get-started/install-single-page-app-monitoring-new-relic-browser)
  enabled, the event log shows you the activity leading up to an error.
</figcaption>
