...
<Table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Use the **Search** <i className="fa fa-search">
        \[search icon]
        </i>
...
New Relic wraps JavaScript functions to get information about thrown errors via the stack trace. If errors are not thrown, they will not be available. For example, if you have an AngularJS application, follow the troubleshooting procedures when [AngularJS errors do not appear](/docs/browser/new-relic-browser/troubleshooting/angularjs-errors-do-not-appear) in the UI.
