...
6. To view additional details, click the **Key attribute charts** tab.

Charts on the **Key attribute charts** tab automatically refresh with comparative performance details for the selected location. Charts provide insights into performance issues related to specific locations, browsers, devices, URLs, or browser versions.
...
Here is a summary of additional options with the Filterable Geography page.
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        The map's legend lists the ten best or worst performing areas (depending on the selected performance indicator) for the selected time period. For example:
