...
metaDescription: 'Use filterable geography you to filter webpage performance metrics for locations, users, networks, browsers, etc.'
redirects:
  - /docs/browser/new-relic-browser/additional-standard-features/filterable-geography-webpage-metrics-location
---

The filterable geography page provides a world view with color-coded performance information about cities, regions, and countries anywhere around the world. You can filter and drill down into detailed information, or use your mouse to select or zoom in and out of any location on the map.
