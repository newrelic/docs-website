...
<Callout variant="important">
  The following examples are for US accounts. For EU accounts, the endpoint is `https://sourcemaps.service.eu.newrelic.com`. For JP accounts, the endpoint is `https://sourcemaps.service.jp.newrelic.com`. For more information, see [Choose your data center](/docs/accounts/accounts-billing/account-setup/choose-your-data-center).
</Callout>
