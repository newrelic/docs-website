...
* A [user API key](/docs/apis/get-started/intro-apis/types-new-relic-api-keys#user-api-key), this key **MUST** be used regardless of the user type. The Admin API key will no longer work.
