...
<CollapserGroup>
  ...
  >
    ...
    * `https://cdnjs.cloudflare.com/ajax/libs/jquery/3.1.1/jquery.js`
      ...
      If this <DoNotTranslate>**doesn't**</DoNotTranslate> apply to you, and JS URLs do <DoNotTranslate>**not**</DoNotTranslate> have version info appended, you’ll have to assist the agent by specifying a [release name and ID with the API](/docs/browser-api-newrelicaddrelease).
  </Collapser>
