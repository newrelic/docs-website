...
<Callout variant="important">
  ...
  The npm package doesn't support changing the path to the EU region. See more on [how to publish source maps in Browser](https://www.npmjs.com/package/@newrelic/publish-sourcemap).
</Callout>
...
<CollapserGroup>
  ...
  >
    ...
    publish-sourcemap <var>PATH_TO_SOURCE_MAP_FILE (local or remote)</var> <var>PATH_TO_ORIGINAL_FILE</var> --apiKey=<var>YOUR_NEW_RELIC_USER_API_KEY</var> --applicationId=<var>YOUR_NEW_RELIC_APP_ID</var>
    ```
  </Collapser>
