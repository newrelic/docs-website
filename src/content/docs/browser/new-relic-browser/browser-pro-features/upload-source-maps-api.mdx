...
<Callout variant="important">
  The following examples are for US accounts. For other regions, use the corresponding endpoint:

  * EU accounts: `https://sourcemaps.service.eu.newrelic.com`
  * JP accounts: `https://sourcemaps.service.jp.newrelic.com`

  For more information, see [Choose your data center](/docs/accounts/accounts-billing/account-setup/choose-your-data-center).
</Callout>
