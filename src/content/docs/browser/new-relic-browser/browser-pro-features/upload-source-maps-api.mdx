...
<CollapserGroup>
  ...
  >
    If you're interested in connecting New Relic to your CodeStream organization, your repository URl or build commit hash are required. Otherwise, this is optional.
