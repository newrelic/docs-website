...
- Developed using independent technologies or frameworks
...
6. **Entity-level attibution is supported** to facilitate assignment of teams, repositories and tags.
