...
* Browser agent version 1.269 or later is required to capture frustration signals and performance impact data.
...
The Performance impact tab includes the following sections:
...
* Geography analysis: Examines performance impact across different geographic locations to identify regional issues.
