...
2. Go to **[one.newrelic.com](https://one.newrelic.com) > Browser**. Select an app, then click **Application settings**.
...
<CollapserGroup>
  ...
  >
    ...
    3. Go to **[one.newrelic.com](https://one.newrelic.com) > Browser**. Select an app, then click **Application settings**.
