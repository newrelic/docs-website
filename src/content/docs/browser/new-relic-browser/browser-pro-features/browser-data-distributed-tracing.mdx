...
Make sure you have the necessary minimum versions for your browser monitoring agent and your <InlinePopup type="apm" /> agent:
...
<CollapserGroup>
  ...
  >
    ...
    2. Make sure your browser monitoring agent and <InlinePopup type="apm" /> agent are [compatible](#requirements) with distributed tracing for CORS. Update to the most recent version if applicable.
