...
2. Go to **[one.newrelic.com](https://one.newrelic.com) > Browser > (select an app) > Application settings**.
...
<CollapserGroup>
  ...
  >
    ...
    3. Go to **[one.newrelic.com](https://one.newrelic.com) > Browser > (select an app) > Application settings**.
