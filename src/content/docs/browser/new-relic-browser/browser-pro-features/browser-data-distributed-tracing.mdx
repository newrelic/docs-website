...
* In the distributed tracing UI, end-user spans are indicated with the <img title="distributed-tracing-browser-span-icon.png" alt="New Relic distributed tracing browser span icon" src={distributedTracingBrowserSpanIcon} style={{height: "30px", width: "30px"}} /> icon.
