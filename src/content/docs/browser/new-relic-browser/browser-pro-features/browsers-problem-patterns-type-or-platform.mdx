...
metaDescription: "The browsers UI in New Relic details your end users' experience with your app by type (Chrome, IE, Safari, etc.) and platform (mobile, tablet, desktop)." 
redirects:
