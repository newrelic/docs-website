...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Browser > (select an app) > Page views**: This page provides detailed information about page load time, throughput, top transactions, and traces.
</figcaption>

To view detailed information about which pages the end users are viewing for your app:

1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Browser > (select an app) > Page views**.
