...
The **Page views** page in <InlinePopover type="browser" /> provides insight into the performance of your site's pages. Sort options help you find details about percentage of page load time, average page load time, or throughput. Detailed information about the top webpages viewed, timing and throughput details, and links to browser traces or session traces also are available.
