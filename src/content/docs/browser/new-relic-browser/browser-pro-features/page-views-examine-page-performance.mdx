...
The <DNT>**Performance risk**</DNT> shows the percentage of user sessions affected by performance issues in the selected time period. It displays unhandled exceptions and application errors for JavaScript errors.
