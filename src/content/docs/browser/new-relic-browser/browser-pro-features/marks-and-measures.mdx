...
Automatically tracking marks and measures with New Relic provides actionable insights into the performance of your web applications. By capturing these events, you can:
...
<Steps>
  ...
  <Step>
    To automatically collect marks, toggle **Capture marks** to **ON**.
  </Step>

  <Step>
    To automatically collect measures, toggle **Capture measures** to **ON**.
  </Step>

  <Step>
    To collect details from observed marks or measures as custom attributes, toggle **Add details** to **ON**.
  </Step>
...
<Steps>
  ...
  <Step>
    To disable marks, toggle **Capture marks** to **OFF**.
  </Step>

  <Step>
    To disable measures, toggle **Capture measures** to **OFF**.
  </Step>
</Steps>
