...
6. [Redeploy the browser agent](/docs/browser/new-relic-browser/installation/upgrade-browser-agent) (either restarting the associated <InlinePopup type="apm" /> agent or updating the copy/paste browser installation).
