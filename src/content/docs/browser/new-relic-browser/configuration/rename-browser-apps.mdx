  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        To change the alias that appears in the New Relic UI, use the [app's **Settings** page](/docs/agents/manage-apm-agents/app-naming/rename-your-application#app-alias): Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Browser > (select an app) > Settings > Application settings**.
      </td>
    </tr>
