  ...
  <thead>
    <tr>
      <th style={{ width: "200px" }}>
        <DoNotTranslate>**Option**</DoNotTranslate>
      </th>
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        To change the alias that appears in the New Relic UI, use the [app's <DoNotTranslate>**Settings**</DoNotTranslate> page](/docs/agents/manage-apm-agents/app-naming/rename-your-application#app-alias): Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & services > (select an app) > Settings > Application**</DoNotTranslate>.
      </td>
    </tr>
