...
tags:
  ...
  - Browser monitoring
  - Configuration
metaDescription: How to rename an app monitored by New Relic Browser depends on which deployment option you originally used to add it.
redirects:
...
This information applies if you inserted Browser's JavaScript snippet into your:
