...
The browser agent type has no impact on your billing: it is simply a way to switch to a more minimal set of features, if desired. Your default browser type has all browser monitoring features enabled. 
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        This agent version lacks the [features designed for monitoring single page apps](/docs/browser/single-page-app-monitoring/get-started/introduction-single-page-app-monitoring).
      </td>
    </tr>
