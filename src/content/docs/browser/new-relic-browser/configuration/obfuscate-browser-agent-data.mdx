...
<CollapserGroup>
  <Collapser
    id="option1"
    title="Option 1: Use non-PII user identifiers"
  >
...
```
  ...
  <Collapser
    id="option2"
    title="Option 2: Create more specific obfuscation rules"
  >
