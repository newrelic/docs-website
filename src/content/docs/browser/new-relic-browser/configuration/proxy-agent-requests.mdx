...
With [browser agent version 1.240.0](/docs/release-notes/new-relic-browser-release-notes/browser-agent-release-notes) and higher, you can set up a proxy by configuring the following browser agent properties:
