...
To add new URL segments to your application's allow list, you can add them programmatically using [GraphQL](/docs/apis/nerdgraph/examples/browser-monitoring-config-nerdgraph#browser-segments), or you can use segment allow lists in the New Relic browser monitoring UI like this:
