...
template: basicDoc
shortDescription: >-
  Sets the text value of the HTML element that was clicked to start a browser
  interaction.
topics:
  - Browser
  - Browser monitoring
...
Agent version [nr-1099](https://docs.newrelic.com/docs/release-notes/new-relic-browser-release-notes/browser-agent-release-notes) or higher.
