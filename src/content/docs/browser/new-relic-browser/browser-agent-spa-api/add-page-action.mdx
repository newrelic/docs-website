---
title: addPageAction (Browser Pro and Pro+SPA)
type: apiDoc
...
metaDescription: Browser API call to report a PageAction event with your user-defined name and attributes to New Relic Dashboards. Available for browser Pro and Pro+SPA agents.
redirects:
