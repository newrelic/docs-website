...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Optional. JSON object with one or more key/value pairs. For example: `{key:"value"}`. The key will be reported as its own PageAction attribute with the specified values.
