...
template: basicDoc
shortDescription: >-
  Adds a unique name and ID to identify releases with multiple JavaScript
  bundles on the same page.
topics:
  - Browser
  - Browser monitoring
...
Agent version [nr-1016](https://docs.newrelic.com/docs/release-notes/new-relic-browser-release-notes/browser-agent-release-notes) or higher.
...
* Determine which version of a [Browser source map](https://docs.newrelic.com/docs/new-relic-browser-source-map-support) to use.
