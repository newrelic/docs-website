...
metaDescription: SPA API call with New Relic Browser to give routes more accurate names and monitor specific routes rather than by default grouping.
redirects:
...
Agent version [nr-998](https://docs.newrelic.com/docs/release-notes/new-relic-browser-release-notes/browser-agent-release-notes) or higher.
