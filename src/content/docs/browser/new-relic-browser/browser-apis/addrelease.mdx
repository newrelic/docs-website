...
To use this API, you need either a Browser Pro or Pro+SPA edition of the browser agent. If you are using the NPM package, you will need to include the `jserrors` feature.
</Callout>
