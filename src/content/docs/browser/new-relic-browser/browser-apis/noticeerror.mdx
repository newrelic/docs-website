...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Required. Provide a meaningful error message that you can use when analyzing data on browser's [<DoNotTranslate>**JavaScript errors**</DoNotTranslate> page](/docs/browser/new-relic-browser/dashboard-details/javascript-errors-dashboard).
      </td>
    </tr>
