...
If an error is caught and re-thrown, it will not have a stack trace. If you want the newrelic.noticeError API to report a stack trace with all browser types in such case, you must pass it to the API in the catch statement.
