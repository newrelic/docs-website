...
* If a session trace currently <DoNotTranslate>**is**</DoNotTranslate> in progress, this adds an object with a user-defined name, start time, and other optional fields.
* If you make this call and a session trace <DoNotTranslate>**is not**</DoNotTranslate> already in progress, this will not cause browser to capture a trace.
