...
### Capturing a log item with a specified logLevel

```js
newrelic.setUserId('my log message', {level: 'debug'})
// saves a log event with:
// a message of --> 'my log message'
// a logLevel of --> 'debug'
```
...
```js
newrelic.setUserId('my log message', {customAttributes: {myFavoriteApp: true}})
// saves a log event with:
// a message of --> 'my log message'
// a logLevel of --> 'info'
