...
<Callout variant="caution">
    On October 15, 2024, New Relic will [end of life the `createTracer()`](/eol/2024/04/eol-04-24-24-createtracer) API call.

    We recommend that you migrate to the `addPageAction()` API call to collect time data about sub-components on your pages.

    See our doc on [`addPageAction`](/docs/browser/new-relic-browser/browser-apis/addpageaction/) for information on how to implement it.
</Callout>
