...
This API will work for any browser edition (Browser Lite, Pro, or Pro+SPA).  If you are using the NPM package, you will need to include the `page_action` and/or `session_trace` feature(s).
</Callout>
