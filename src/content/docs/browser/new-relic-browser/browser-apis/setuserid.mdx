...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Required. A string identifier for the end-user, useful for tying all browser events to specific users. Value does not have to be unique. If IDs should be unique, the caller is responsible for that validation.
