...
One way to [deploy browser monitoring](/docs/browser/new-relic-browser/getting-started/adding-apps-new-relic-browser) for an app is using a New Relic APM agent.
