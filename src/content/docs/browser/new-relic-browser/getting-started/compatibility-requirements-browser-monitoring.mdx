  ...
  <thead>
    <tr>
      <th style={{ width: "200px" }}>
        <DoNotTranslate>**Exceptions**</DoNotTranslate>
      </th>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        If you're using AngularJS and you want to use our [SPA monitoring features](/docs/browser/single-page-app-monitoring/get-started/welcome-single-page-app-monitoring), note that Zone.js versions 0.6.18 to 0.6.24 are not compatible with browser. In all cases, the browser agent <DoNotTranslate>**must**</DoNotTranslate> be loaded before Zone.js to avoid errors.
      </td>
    </tr>
