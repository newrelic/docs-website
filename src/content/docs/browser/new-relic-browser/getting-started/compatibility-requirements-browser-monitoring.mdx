...
Browser monitoring includes [strict security measures](/docs/browser/new-relic-browser/performance-quality/security-new-relic-browser) to provide a robust, standalone product with browser monitoring features. Before you install the browser agent, make sure your system meets these requirements.
