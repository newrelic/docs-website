...
* <DNT>Next.js<DNT> has a known incompatibility since version 13.3.2-canary.2 where using the app router can result in links on the page not working. See [this troubleshooting page](/docs/browser/single-page-app-monitoring/troubleshooting/nextjs-app-router-links-broken) for more information.
