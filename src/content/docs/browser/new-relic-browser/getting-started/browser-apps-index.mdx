...
![browser_index.png](src/images/browser_index.png 'browser_index.png')

<figcaption>
  The browser applications index shows your app names, their health status, and
  summary information, with direct links to additional pages.
</figcaption>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        ![browser_return_index.png](src/images/browser_return_index.png "browser_return_index.png")
      </td>
    </tr>
