...
import browserIndexSummary from 'images/browser_screenshot-full_index-summary.png'

import browserReturntoIndex from 'images/browser_screenshot-crop_return-to-index.png'

To get started with [browser monitoring](/docs/browser/new-relic-browser/getting-started/introduction-new-relic-browser), go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities)** and select browser at the top of the page. If you have already added apps, the browser applications index automatically appears.
