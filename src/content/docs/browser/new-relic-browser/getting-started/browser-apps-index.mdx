...
To get started with [browser monitoring](/docs/browser/new-relic-browser/getting-started/introduction-new-relic-browser), go to **[one.newrelic.com](https://one.newrelic.com)** and select browser at the top of the page. If you have already added apps, the browser applications index automatically appears.
