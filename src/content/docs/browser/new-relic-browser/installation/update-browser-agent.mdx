...
<CollapserGroup>
  ...
  >
    ...
    This may be a good solution if you have many applications to manage, or if your browser app is linked to an <InlinePopup type="apm" /> app.
  </Collapser>
