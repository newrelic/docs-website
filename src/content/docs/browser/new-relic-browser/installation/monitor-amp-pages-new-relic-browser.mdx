...
In addition to New Relic Browser's [installation requirements](/docs/browser/new-relic-browser/getting-started/compatibility-requirements-new-relic-browser), Browser's AMP agent requires:
...
Currently, your AMP data will not appear in the New Relic browser monitoring UI. This is intentional; any AMP data sent to the New Relic collector will be removed automatically from your browser monitoring metrics.
