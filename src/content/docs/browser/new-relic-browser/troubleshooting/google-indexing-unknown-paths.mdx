...
* [How can I block Google from crawling things it thinks are URLs from **NEXT_DATA**?](https://stackoverflow.com/questions/75672103/how-can-i-block-google-from-crawling-things-it-thinks-are-urls-from-next-data)
