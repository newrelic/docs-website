...
<table>
  <thead>
    <tr>
      <th width={200}>
        <DoNotTranslate>**Adding segments to your allow list**</DoNotTranslate>
      </th>

      <th>
        <DoNotTranslate>**Tip**</DoNotTranslate>
      </th>
    </tr>
  </thead>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        1. Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Browser > (select an app) > Settings > Segment allow lists**</DoNotTranslate>.
        2. Rather than creating a new rule, edit the existing rule, and add the domain to the UI's <DoNotTranslate>**Allow listed segments**</DoNotTranslate> field.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        If your site is a single-page application and you only see `/` under page views, then your grouping is working correctly. New Relic records subsequent requests as AJAX loads, and your [<DoNotTranslate>**AJAX**</DoNotTranslate> page](/docs/browser/new-relic-browser/browser-pro-features/ajax-dashboard-identifying-time-consuming-calls) will contain more detailed information. If it doesn't, then follow the tips in this document.
      </td>
    </tr>
