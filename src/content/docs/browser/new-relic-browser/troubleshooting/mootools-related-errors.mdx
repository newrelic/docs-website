...
You're using the MooTools library and notice errors like the ones below showing up in the browser console or on the [<DNT>**JavaScript errors**</DNT> page](/docs/browser/new-relic-browser/browser-pro-features/js-errors-dashboard-examining-errors-over-time).
