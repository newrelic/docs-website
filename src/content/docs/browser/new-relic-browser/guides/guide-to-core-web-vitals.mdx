...
import browserWebVitalsPage from 'images/browser_screenshot-full_web-vitals-page.png'
...
Each web vital has the following thresholds to help you gauge your app experience.
...
**Good** web vitals can help your organization save money and increase SEO. **Poor** or **Needs improvement** web vitals can reflect negative user perceptions of your organization, which could result in dissatisfied customers or lost business opportunities.
...
New to New Relic? [Create a free New Relic account](https://newrelic.com/signup) and [instrument your browser app](docs/browser/browser-monitoring/installation/install-browser-monitoring-agent) (it takes around 5 minutes!).  
...
/>
Read on for some common filtering scenarios.

### Filter by desktop vs. browser devices

Let's say you want to compare desktop vs. mobile performance and how core web vitals differ between the two platforms. 
...
Let's say an end-user complained about performance issues in your site’s checkout page on November 1, around 12pm, and you want to see what happened for this end-user. 
...
### Filter by image resources
  
Let's say your organization recently updated images on the site’s home page on November 10 at 8am, and you want to see if the changes impacted core web vitals. 
