...
Each web vital has three metric thresholds to help you gauge your app experience:
...
Want to learn more about how core web vitals are collected? Check out these resources:
...
To monitor core web vitals, go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Browser > (select an app) > Monitor > Web vitals**. 
