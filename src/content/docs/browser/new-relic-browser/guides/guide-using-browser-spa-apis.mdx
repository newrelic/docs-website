...
<table>
  ...
  <tbody>
    <tr>
      <td>
        Set the [`actionText`](/attribute-dictionary/?event=BrowserInteraction&attribute=actionText), or text of the HTML element clicked, of a SPA [interaction](/attribute-dictionary?attribute_name=&events_tids%5B%5D=8312)
      </td>
