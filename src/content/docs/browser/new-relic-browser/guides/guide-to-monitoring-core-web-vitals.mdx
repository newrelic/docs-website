...
If you're new to New Relic, [Create a free New Relic account](https://newrelic.com/signup) and [instrument your browser app](/docs/browser/browser-monitoring/installation/install-browser-monitoring-agent) (it takes around 5 minutes!). Then come back here to learn how to navigate the **Web vitals** page.
...
/>
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Browser > (select an app) > Monitor > Web vitals > (add filters)**
</figcaption>
