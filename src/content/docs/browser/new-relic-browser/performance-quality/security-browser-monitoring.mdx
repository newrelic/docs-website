...
<Callout variant="important">
  If your end users are behind a firewall or proxy and do not have access to the CDN or to New Relic's [networks](/docs/apm/new-relic-apm/getting-started/networks) (including `bam.nr-data.net`), Browser monitoring will not work.
</Callout>
