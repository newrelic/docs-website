...
Our <InlinePopover type="browser"/> places a small "loader" script into the head section of each page on a monitored site. This JavaScript instrumentation has been designed to:
...
* [Problematic JavaScript errors](/docs/errors-inbox/browser-tab)
