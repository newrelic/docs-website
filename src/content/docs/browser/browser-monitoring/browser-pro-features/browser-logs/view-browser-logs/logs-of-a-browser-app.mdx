...
<Steps>
  ...
  <Step>
    In the left-hand menu, navigate to **Logs** under **More View**.
  </Step>
</Steps>
...
* You can also view browser logs in context with Session Replay (if you are using the Session Replay feature) or alongside JavaScript errors in the Errors Inbox. See [Logs in Session Replay](#session-replay-section) and [Logs in Error Inbox](#js-errors-section) for more details.
