...
## Getting Started with Browser logs

Get started with **Browser logs** to enhance your application's observability and debugging capabilities by following these simple setup instructions.

### Prerequisites

* Ensure you are using a **Pro** or **Pro + SPA** browser agent.
