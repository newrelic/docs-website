...
Go to <DNT>**[one.newrelic.com > All Capabilities](https://one.newrelic.com/all-capabilities) > Browser**</DNT> (select your browser app) > <DNT>**Application settings**</DNT>. From this page, check that <DNT>**Pro**</DNT> or <DNT>**Pro + SPA**</DNT> browser agent is selected. 
