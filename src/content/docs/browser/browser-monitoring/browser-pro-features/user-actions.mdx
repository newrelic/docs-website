...
User actions are tracked by default for Pro and Pro+SPA agents, but unavailable for the Lite browser agent. Confirm you're using the Pro or Pro+SPA agent by going to <DNT>**[one.newrelic.com > All Capabilities](https://one.newrelic.com/all-capabilities) > Browser**</DNT> (select your browser app) > <DNT>**Application settings**</DNT>. From this page, check that  <DNT>**Pro**</DNT> or <DNT>**Pro + SPA**</DNT> browser agent is selected. 
