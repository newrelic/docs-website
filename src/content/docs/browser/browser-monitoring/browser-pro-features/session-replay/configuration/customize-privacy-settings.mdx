...
7. Add the `nr-ignore` class to specific sensitive inputs in your HTML code that you want to keep ignore completely. For example, if you want to hide credit card numbers but show all other text, add `nr-ignore` to the credit card input field:
