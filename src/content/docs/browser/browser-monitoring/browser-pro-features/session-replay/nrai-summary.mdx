...
To use NRAI to summarize your session replay event trail data, you must have [NRAI enabled](/docs/new-relic-solutions/new-relic-one/core-concepts/new-relic-ai/#enable) for your account. Once NRAI is enabled on your account, perform the following to surface your summary:
