...
Replay data is stored in the `Browser events` namespace which has a [default retention of 8 days](/docs/data-apis/manage-data/manage-data-retention/#retention-periods). Retention can be extended with [Data Plus](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/data-ingest-billing/#data-prices) or by [editing your retiontion settings](/docs/data-apis/manage-data/manage-data-retention/#adjust-retention).
