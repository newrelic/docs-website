...
* [Optimize session replay data volume](/docs/browser/browser-monitoring/browser-pro-features/session-replay/optimize-session-replay-data-volume): Learn how to reduce payload size by addressing DOM complexity and mutation patterns.
