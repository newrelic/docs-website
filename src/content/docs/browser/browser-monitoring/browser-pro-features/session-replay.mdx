...
Session replay will be billable starting May 8, 2024. See [Data consumption](#plan-for-paid-consumption) for details.
</Callout>
...
* In [Errors Inbox](docs/errors-inbox/errors-inbox/), you can use the toggle to show only errors with replays. This will filter your views so that you always see a replay. By default, browser event data is stored 8 days, but actual data retention depends on your account.
