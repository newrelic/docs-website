...
<CollapserGroup>
  ...
  >
    ...
    * [Dropping](https://docs.newrelic.com/docs/data-apis/manage-data/drop-data-using-nerdgraph/) or not reporting PageView event data can prevent Session Replays from displaying in the UI.
  </Collapser>
