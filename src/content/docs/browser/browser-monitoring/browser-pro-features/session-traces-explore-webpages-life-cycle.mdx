...
import browserSessionError from 'images/browser_screenshot-full_session-error.png'

import browserSessionTracesOverview from 'images/browser_screenshot-crop_session-traces-overview.png'
...
<img
  ...
  src={browserBrowserSessionerror.png
/>
