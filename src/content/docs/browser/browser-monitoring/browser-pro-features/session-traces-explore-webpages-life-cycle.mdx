...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Look at the timing segments to identify performance issues affecting your [core web vitals](/docs/tutorial-improve-site-performance/guide-to-monitoring-core-web-vitals).
      </td>
    </tr>
