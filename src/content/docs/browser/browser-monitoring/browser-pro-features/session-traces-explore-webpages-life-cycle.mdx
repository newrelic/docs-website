...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Browser > (select an app) > Session traces**: Here is an example of some of the wealth of information you can explore in a session trace.
</figcaption>
