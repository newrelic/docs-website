...
import browserSessionTraceDetails from 'images/browser_screenshot-full_session-trace-details.png'

import browserSessionTraces from 'images/browser_screenshot-full_session-traces.png'
