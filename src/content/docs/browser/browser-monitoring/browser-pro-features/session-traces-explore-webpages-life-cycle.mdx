...
metaDescription: Use Browser's Session traces feature to explore a detailed timeline of the technical and user-triggered events during a webpage's full life cycle.
redirects:
...
To use Browser monitoring's session traces feature, make sure you meet these requirements:
...
* If you're using [multiple names for an app](https://docs.newrelic.com/docs/agents/manage-apm-agents/app-naming/use-multiple-names-app), session traces will only report to the [most specific application](https://docs.newrelic.com/docs/agents/manage-apm-agents/app-naming/use-multiple-names-app#most-least-specific).
* For accounts older than October 2014, you must [enable Browser monitoring](/docs/browser/new-relic-browser/installation-configuration/browser-settings-ui-options-browser-monitoring) and the enhanced Pro features.
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Browser > (select an app) > Session traces**: You can select a session trace from the Browser index. You can also select a session trace directly from the Browser **Summary**, **Page views**, **JS errors**, and **AJAX** pages.
</figcaption>
...
<Callout variant="tip">
  You can also select a session trace directly from the [Browser **Summary**](/docs/browser/new-relic-browser/dashboard-details/browser-overview-dashboard/), **[Page views](/docs/browser/new-relic-browser/dashboard-details/page-views-dashboard/)**, [**JS errors**](/docs/browser/new-relic-browser/browser-pro-features/javascript-errors-page-examining-errors-over-time) and [**AJAX**](/docs/browser/new-relic-browser/browser-pro-features/ajax-page-identifying-time-consuming-calls) pages.
</Callout>
