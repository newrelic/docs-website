...
You can decrease your consumption of session trace data by [adjusting your sampling rates](#configure-sampling-rates) or [disabling session tracing](#disable-tracing).
