...
For deeper analysis, you can also query attributes such as [`sessionTraceId`](https://docs.newrelic.com/attribute-dictionary/?event=AjaxRequest&attribute=sessionTraceId), [`largestContentfulPaint`](https://docs.newrelic.com/attribute-dictionary/?event=PageViewTiming&attribute=largestContentfulPaint), etc.
