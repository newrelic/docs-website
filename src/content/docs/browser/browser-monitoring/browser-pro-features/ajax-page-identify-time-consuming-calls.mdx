...
<CollapserGroup>
  ...
  >
    ...
    * `response.body`
    ...
    To enable payload capture, go to your [application settings and configure the capture mode](/docs/browser/new-relic-browser/configuration/configure-ajax-request-events/#enable-payload-capture).
