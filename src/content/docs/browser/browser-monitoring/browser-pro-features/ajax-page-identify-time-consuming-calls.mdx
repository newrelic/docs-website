...
![NR One browser monitoring: AJAX summary](src/images/nr-one-ajax-browser.png 'NR One browser monitoring: AJAX summary')

<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Browser > (select an app) >
  AJAX**: Identify problems due to time-consuming or failing AJAX calls that
  update parts of a webpage on your site.
</figcaption>
...
<CollapserGroup>
  ...
  >
    ...
    ![NR One browser monitoring: AJAX details](src/images/nr-one-ajax-details.png "NR One browser monitoring: AJAX details")
