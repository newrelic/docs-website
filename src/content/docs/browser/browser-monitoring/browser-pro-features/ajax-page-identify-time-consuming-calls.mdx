...
import browserBrowserAjaxDetails from 'images/browser_screenshot-crop_browser-ajax-details.png'
...
1. Go to **[one.newrelic.com](https://one.newrelic.com) > Browser > (select an app) > AJAX**.
...
<CollapserGroup>
  ...
  >
    ...
    <img
      ...
      src={browserBrowserAjaxDetails}
    />

    <figcaption>
      Go to **[one.newrelic.com](https://one.newrelic.com) > Browser > (select an app) > AJAX > (select an AJAX call)**: This example shows performance details for a specific AJAX call. You can also view performance details by page views.
    </figcaption>
