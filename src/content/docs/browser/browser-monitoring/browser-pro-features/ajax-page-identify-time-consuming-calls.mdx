...
<CollapserGroup>
  ...
  >
    ...
    * Four time periods (**Application time**, **Queue time**, **Network time**, and **Callback time**): These AJAX calls are made against apps monitored by <InlinePopup type="apm" /> agents that provide cross application tracing headers.
