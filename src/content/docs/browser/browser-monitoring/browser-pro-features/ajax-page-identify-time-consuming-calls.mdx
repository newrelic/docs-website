...
<Callout variant="tip">
For deeper debugging of failed requests, you can configure the browser agent to [capture full AJAX request and response payloads](/docs/browser/new-relic-browser/configuration/capture-ajax-payloads), including headers, bodies, and query parameters. This is especially useful for diagnosing GraphQL errors hidden in 200 OK responses.
</Callout>
