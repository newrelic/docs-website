...
4. In the file finder popup, select your source file. An error frame with a gray strip on the left side indicate minified JS. A blue strip indicates it has had a source map applied.

Other error frame features include:
