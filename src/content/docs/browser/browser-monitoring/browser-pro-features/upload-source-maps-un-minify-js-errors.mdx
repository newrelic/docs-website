...
1. Go to **[one.newrelic.com](https://one.newrelic.com) > Browser > (select an app) > [JS Errors](/docs/browser/new-relic-browser/browser-pro-features/javascript-errors-page-examining-errors-over-time)**, then select a JS error group. (Do not select an **Errors without a stack trace** group.)
