...
Want to use an API to programmatically monitor your applications? See [Browser monitoring with NerdGraph](/docs/apis/nerdgraph/examples/browser-monitoring-config-nerdgraph).

<Steps>

<Step>
### Create a browser app in our UI [#create-browser-app-ui]
...
<Step>
### Choose a deployment method [#choose-deployment]
...
<Step>
### (Optional) Enable distributed tracing [#enable-dist-tracing]
...
<Step>
### Name your browser app [#name-browser-app]
...
<Step>
### (For copy/paste method only) Inject the JavaScript snippet [#inject-js-snippet]
...
<Step>
### Generate traffic for your app [#generate-traffic]
...
It may take several minutes after enabling the browser monitoring agent before your webpage data appears in New Relic. If you're still not seeing data, check out [Browser monitoring troubleshooting](/docs/browser/browser-monitoring/troubleshooting/troubleshoot-your-browser-monitoring-installation/).
  </Callout>
...
* [Improve your website](/docs/journey-performance/improve-website-performance) with your browser monitoring data.
