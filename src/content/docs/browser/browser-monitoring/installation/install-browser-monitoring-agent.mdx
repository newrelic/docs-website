...
1. Go to **[one.newrelic.com](https://one.newrelic.com) > Browser > <Icon name="fe-plus-circle"/>
   + Add More Data**.
2. Find the header "Back-end, front-end, and mobile applications" and select the New Relic Browser tile. A menu with account options will appear and prompt you to select the account you want to add this instrumentation to. Choose your account and click the continue button.
4. From the Browser deployment page, select **Enable via APM**.
5. Select your choice of available options for **Browser agent instrumentation** [features](/docs/browser/new-relic-browser/getting-started/new-relic-browser).
6. Type or use the search window to find the app's name.
7. Select **Enable**.
...
1. Go to **[one.newrelic.com](https://one.newrelic.com) > Browser > + Add more Data**.
2. Find the header "Back-end, front-end, and mobile applications" and select the New Relic Browser tile. A menu with account options will appear and prompt you to select the account you want to add this instrumentation to. Choose your account and click the continue button.
3. From the Browser deployment page, select **Copy/Paste JavaScript Code**.
4. Select your choice of available options for **Browser agent instrumentation** [features](/docs/browser/new-relic-browser/getting-started/new-relic-browser).
5. Name your app:
