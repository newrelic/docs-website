...
5. In the **Choose your instrumentation** section, select **Lite**, **Pro**, or **Pro + SPA**. See [features](/docs/browser/new-relic-browser/getting-started/new-relic-browser) for details about each .
