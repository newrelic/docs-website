...
To get started with browser monitoring, you'll need to add our browser agent to the HTML of the views you want to monitor. The browser agent is a snippet of JavaScript code that monitors the performance of your app/site and sends that data to New Relic. 
...
Check to see if your browser app meets our [compatibility requirements](/docs/browser/new-relic-browser/getting-started/compatibility-requirements-browser-monitoring).
