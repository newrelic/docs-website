...
Have questions about the install process? See [Install methods](#choose-deployment).
...
Use this method if you can't use APM for whatever reason (for example, if you have a [SPA](/docs/browser/single-page-app-monitoring/get-started/introduction-single-page-app-monitoring) app, or if your APM agent isn't supported for auto-injection, as is true for Node.js and some Java apps). When you go this route, you'll receive a customized JavaScript snippet at the end of the install process in the New Relic UI, and you'll add that to the HTML of any pages you want to monitor in your app/site.
