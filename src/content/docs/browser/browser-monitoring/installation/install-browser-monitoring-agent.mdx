...
Browser Pro+SPA is the default agent when you enable browser monitoring. This automatically gives you access to all of our browser monitoring features.

To enable browser monitoring:

1. Go to **[one.newrelic.com](https://one.newrelic.com)**, select **Browser**, and then select **Add more data**.
2. Follow the instructions in the UI.
...
When [enabling browser monitoring](#enable), you can use an APM agent to automatically inject the browser monitoring JavaScript snippet for you. This is the easiest way to install the agent for an app that already is being monitored by APM.
...
* [New Relic One pricing](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing): This pricing plan has data ingest as a billing factor. If you want to reduce data ingest, you may want to consider downgrading to lesser agent types after install. 
