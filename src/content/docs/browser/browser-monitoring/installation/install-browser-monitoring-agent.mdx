...
<Callout variant="important">
  The configuration options explained below refer only to the browser agent, and should not to be confused with the New Relic [user roles](/docs/accounts/accounts-billing/new-relic-one-user-management/new-relic-one-user-model-understand-user-structure/#roles) and [pricing tiers](https://newrelic.com/pricing). 
</Callout>
