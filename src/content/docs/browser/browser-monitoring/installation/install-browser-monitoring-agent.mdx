...
To install the browser agent, you must have a New Relic account. Don't have a New Relic account yet? [Sign up here](https://newrelic.com/signup). It's free!

Go to the [**Add data** page for browser monitoring](https://onenr.io/0dQeZD54Nwe) in the UI and follow the instructions. 
