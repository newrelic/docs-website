...
To install the browser agent: Go to <DNT>**[one.newrelic.com](https://one.newrelic.com) > Add data > Browser and mobile > Browser monitoring**</DNT> and follow the instructions. 
