...
import browserJavascriptSnippet from 'images/browser_screenshot-crop_javascript-snippet.png'
...
<img
  ...
  alt="lkey_appId.png"
  src={browserJavascriptSnippet}
/>

<figcaption>
  Go to **[one.newrelic.com](https://one.newrelic.com) > Browser > Settings:** The end of the JavaScript generated for copy/paste deployments includes your browser monitoring license key and application ID.
</figcaption>
