...
<figcaption>
  <DNT>**[one.newrelic.com](https://one.newrelic.com) > Add data > Browser monitoring > (choose the copy/paste install method) >  (go through each installation step)**</DNT>: At the end of the instrumentation setup, your license key and application ID are displayed in the JavaScript snippet.
</figcaption>
