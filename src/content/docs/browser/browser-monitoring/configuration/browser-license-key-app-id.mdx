...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Browser > Settings:** The end
  of the JavaScript generated for copy/paste deployments includes your browser
  monitoring license key and application ID.
</figcaption>
