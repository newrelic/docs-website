...
tags:
  ...
  - Browser monitoring
  - Troubleshooting
metaDescription: 'If you have problems installing or activating New Relic''s browser monitoring for your app, try these troubleshooting tips.'
redirects:
...
<Callout variant="tip">
  To use APM and the rest of our [observability platform](https://one.newrelic.com), join the New Relic family! [Sign up](https://newrelic.com/signup) to create your free account in only a few seconds. Then ingest up to 100GB of data for free each month. Forever.
</Callout>

## Solution

**Recommendation:** Before following specific troubleshooting procedures, first run the [Diagnostics browser check](/docs/agents/manage-apm-agents/troubleshooting/new-relic-diagnostics). The information returned from the Diagnostics tool can be used when communicating with New Relic Support.
