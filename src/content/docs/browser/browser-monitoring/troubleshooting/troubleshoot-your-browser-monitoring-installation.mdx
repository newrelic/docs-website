...
<CollapserGroup>
  ...
  >
    Verify that browser monitoring has been enabled in your application's <DoNotTranslate>**Browser settings**</DoNotTranslate>:

    1. Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Browser > (select an app) > Settings**</DoNotTranslate>.
  ...
  >
    ...
    * <DoNotTranslate>**Go**</DoNotTranslate>: n/a
    * <DoNotTranslate>**Java**</DoNotTranslate>: Before the `</body>` tag (which must be added to the page if missing)
    * <DoNotTranslate>**.NET**</DoNotTranslate>: Immediately before the first script element
    * <DoNotTranslate>**Node.js**</DoNotTranslate>: Immediately before the first script element
    * <DoNotTranslate>**PHP**</DoNotTranslate>: At the end of the body element
    * <DoNotTranslate>**Python**</DoNotTranslate>: In the head element or at the end of the body element
    * <DoNotTranslate>**Ruby**</DoNotTranslate>: Immediately before the first script element
  ...
  >
    ...
    If you see JavaScript errors on your webpage, or if you do not see any data on your [<DoNotTranslate>**Errors**</DoNotTranslate> page](/docs/errors-inbox/browser-tab) in the New Relic UI, check if any other JavaScript error monitoring frameworks have been enabled for your app. Some JavaScript error monitors may interfere with functionality for browser monitoring.
  ...
  >
    ...
    * .NET agent: Make sure your <DoNotTranslate>**asp.net**</DoNotTranslate> cache directory is clean by using the command `flush_dotnet_temp.cmd`. This forces the app server to recompile ASPs with page load timing instrumentation.
  </Collapser>
...
<CollapserGroup>
  ...
  >
    ...
    To fix this issue, use <DoNotTranslate>**one**</DoNotTranslate> of these workarounds:
