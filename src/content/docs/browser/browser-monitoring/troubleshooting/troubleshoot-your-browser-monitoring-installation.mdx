...
<CollapserGroup>
  ...
  >
    More recent <InlinePopup type="apm" /> agents place the page load timing scripts more accurately. Before continuing with these troubleshooting tips, make sure you have the [most recent release](/docs/apm/new-relic-apm/maintenance/keeping-new-relic-date) for your APM agent.
