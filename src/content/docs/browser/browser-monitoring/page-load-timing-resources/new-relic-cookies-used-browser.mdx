---
title: "Browser agent cookies (deprecated)"
tags:
  - Browser
  - Browser monitoring
...
This document describes data privacy related to <InlinePopover type="browser"/> and cookies, and details about the cookies themselves. Prior to browser agent version 1220, the following [cookies](/docs/browser/new-relic-browser/performance-quality/security-new-relic-browser#cookies) were created for [session tracking](/docs/browser/new-relic-browser/page-load-timing-resources/session-tracking) in end-user browsers.
...
<CollapserGroup>
  ...
  >
    The `JSESSIONID` cookie is deprecated for agent version 1220 and higher. Session tracking is no longer done through cookies.

    It used to store a <DNT>**session identifier**</DNT> so that New Relic can monitor session counts for an application. The cookie value is generated by Jetty.
