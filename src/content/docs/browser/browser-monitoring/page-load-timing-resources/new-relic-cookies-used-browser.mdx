  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        With the release of [browser agent v1169](/docs/release-notes/new-relic-browser-release-notes/browser-agent-release-notes/browser-agent-v1169), you can turn off cookie collection ([`JSESSIONID`](#jsessionid) and [`NREUM`](#nreum)) for your browser app by using the <DoNotTranslate>**Application settings**</DoNotTranslate> page in the New Relic UI. Once this configuration value is set to false (OFF), you'll no longer see the session information in your event data.
...
It used to store a <DoNotTranslate>**session identifier**</DoNotTranslate> so that New Relic can monitor session counts for an application. The cookie value is generated by Jetty.
