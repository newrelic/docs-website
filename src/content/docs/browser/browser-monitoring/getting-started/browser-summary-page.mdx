...
* **Frontend vs. back end**: This chart links to the connected <InlinePopover type="apm" /> service application. To get more details about [distributed traces](/docs/browser/new-relic-browser/browser-pro-features/browser-data-distributed-tracing/), click the chart's title.
