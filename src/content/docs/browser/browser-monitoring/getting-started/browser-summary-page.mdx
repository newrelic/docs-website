...
import browserAlertConditions from 'images/browser_screenshot-full_browser-alert-conditions.png'

import browserAddAlert from 'images/browser_screenshot-crop_browser-add-alert.png'
...
* **Front end vs. back end**: This chart links to the connected <InlinePopover type="apm" /> service application. To get more details about [distributed traces](/docs/browser/new-relic-browser/browser-pro-features/browser-data-distributed-tracing/), click the chart's title.
...
## Add recommended conditions [#recommended-conditions]

Through the browser monitoring **Summary** page you can add recommended conditions to your entity. Follow these steps:
...
3. Choose a number of recommended conditions. The recommendations depends on the quality of the tags associated with an entity. The more accurate and informative the tags are, the more precise the recommendations will be.

<img
  title="Browser monitoring recommended conditions"
  alt="Browser monitoring recommended conditions"
  src={browserAddAlert}
/>
