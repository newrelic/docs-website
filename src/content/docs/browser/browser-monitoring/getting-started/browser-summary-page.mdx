...
import viewSyntheticMonitors from 'images/view_synthetic_monitors.png'
...
<img
  title="Screenshot of browser monitoring summary page"
  alt="Screenshot of browser monitoring summary page"
...
The <img title="view_synthetic_monitors" alt="View Synthetics monitors button" src={viewSyntheticMonitors}/> button directs you to the **Synthetics** page. To read more about Synthetics, see [Synthetic monitoring](docs/synthetics).
