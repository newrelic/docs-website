...
<Step>
There are three [primary categories](#performance-categories) that help in identifying the source of an issue. Understanding these significantly reduces time spent finding the source of the problem.
