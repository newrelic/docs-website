...
<CollapserGroup>
  <Collapser
    ...
    title="Normal"
  >
Here you can see an example of a seemingly volatile response time chart in APM. Upon close inspection, you can see that the behavior of the response time is repetitive: there's no radical change in the behavior across a 7-day period. The spikes are repetitive and not unusual compared to the rest of the timeline.
