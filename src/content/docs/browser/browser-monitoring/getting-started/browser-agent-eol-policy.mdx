...
<Callout variant="important">
  Agent version deployment may be delayed or out of sync with the latest version shown here. See [this status page](https://newrelic.github.io/newrelic-browser-agent-release/) for the current version being distributed to non-pinned apps under APM or copy-paste injection.
</Callout>
