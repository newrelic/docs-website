...
<Callout variant="tip">
Are you a Datadog user that's interested in trying out New Relic's monitoring capabilities for free? See our [guide on how to migrate from Datadog](/docs/journey-migration/migrating-from-dd/) to learn how.
</Callout>