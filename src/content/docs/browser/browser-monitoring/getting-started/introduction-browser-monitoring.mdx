---
title: Introduction to browser monitoring (copy)
tags:
  - Browser
  - Browser monitoring
  - Getting started
...
* How can you monitor and improve your [core web vitals](/docs/browser/new-relic-browser/guides/guide-to-core-web-vitals) so you can prioritize where to focus the customer experience with your website?
...
* The [**Summary** page](/docs/browser/browser-monitoring/getting-started/browser-summary-page/) shows core web vitals for your entire site.
* The [**Web vitals** page](/docs/browser/new-relic-browser/guides/guide-to-core-web-vitals#monitor) shows a breakdown of core web vitals by page URL, device type, location, and more.
...
3. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities)** and select your browser app.
