...
<figcaption>
  Go to **[one.newrelic.com](https://one.newrelic.com) > Browser > Settings**. Use browser monitoring to see actionable data about your end users' experience with your app.
</figcaption>
