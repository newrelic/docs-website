...
* How can you monitor and improve your [core web vitals](https://web.dev/vitals/) so you can prioritize where to focus the customer experience with your website?
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Browser > Settings**: Use browser monitoring to see actionable data about your end users' experience with your app.
</figcaption>

The [browser monitoring **Summary** page](/docs/browser/browser-monitoring/getting-started/browser-summary-page/) shows important[core web vitals](/docs/browser/new-relic-browser/guides/guide-to-core-web-vitals).
