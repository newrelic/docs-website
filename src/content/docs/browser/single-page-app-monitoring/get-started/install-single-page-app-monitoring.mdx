...
4. Deploy the new JavaScript snippet using the same method you used when you [originally deployed the browser agent](/docs/browser/new-relic-browser/installation-configuration/adding-apps-new-relic-browser) for your app:
