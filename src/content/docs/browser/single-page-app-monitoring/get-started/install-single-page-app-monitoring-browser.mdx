...
SPA monitoring uses a JavaScript snippet to instrument your app's webpage and collect data for monitoring. To enable your app for SPA monitoring in Browser, use the **same** method you used when you [originally deployed Browser](/docs/browser/new-relic-browser/installation-configuration/adding-apps-new-relic-browser) for your app, either:
