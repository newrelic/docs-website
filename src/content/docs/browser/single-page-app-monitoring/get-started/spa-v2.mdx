...
* Unwrapped execution: By not wrapping core globals, the upgrade Pro+SPA agent unleashes execution speed boosts for your SPAs.
...
* New API: The function `newrelic.interaction({ waitForEnd: true })`allows you to customize when a user interaction ends.
