...
<LandingPageTileGrid>
  ...
  >
    ...
    * [Install](/docs/browser/new-relic-browser/installation/install-new-relic-browser-agent) the Browser agent, then start seeing actionable performance data in the [Browser Monitoring UI](/docs/browser/new-relic-browser/getting-started/browser-overview-page-website-performance-summary), including [page load timing details](https://docs.newrelic.com/docs/browser/new-relic-browser/page-load-timing-resources/page-load-timing-process).
