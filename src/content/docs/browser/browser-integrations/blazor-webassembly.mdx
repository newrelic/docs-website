...
You don't need the <InlinePopover type="infrastructure" /> agent to integrate Blazor WebAssembly with New Relic, but we recommend installation if you want full observability of your system. The infrastructure agent collects logs and other data about your hosts, showing your performance metrics alongside your application metrics. 
