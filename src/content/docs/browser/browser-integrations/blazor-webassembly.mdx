...
2. Click <DoNotTranslate>**Browser and mobile**</DoNotTranslate>, then click <DoNotTranslate>**Browser monitoring**</DoNotTranslate>.
3. Select the <DoNotTranslate>**Select copy/paste JavaScript code**</DoNotTranslate> option (for more about this code, see [our browser install docs](/docs/browser/browser-monitoring/installation/install-browser-monitoring-agent)). 
4. Complete the rest of the steps and click <DoNotTranslate>**Enable.**</DoNotTranslate>
...
9. Go to <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DoNotTranslate>, then click <DoNotTranslate>**Metrics & events**</DoNotTranslate>. Run a sample NRQL query to confirm New Relic is collecting data: 
    ...
    ```
10. Install the default dashboards by going to the [Blazor WebAssembly instant observability page](https://newrelic.com/instant-observability/blazor-web-assembly), then clicking <DoNotTranslate>**Install**</DoNotTranslate> at the top of the page. 
11. Go to <DoNotTranslate>**Dashboards**</DoNotTranslate> from <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DoNotTranslate> and click Blazor WebAssembly to view your dashboards. 
