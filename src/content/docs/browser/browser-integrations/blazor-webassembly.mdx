...
```
4. Install the default <InlinePopover type="dashboards" /> by going to the [Blazor WebAssembly instant observability page](https://newrelic.com/instant-observability/blazor-web-assembly), then clicking **Install** at the top of the page. 
