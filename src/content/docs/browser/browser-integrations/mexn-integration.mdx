...
5. Go the `index.html ` file of your React application or Angular application.
...
For information about data reported, see the docs for each of the tools we had you install:
