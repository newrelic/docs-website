...
MEAN, MERN and MEVN stacks are open-source full stack software development kits. Both kits use a single codebase to develop web applications. New Relic has consolidated three stacks into a single quickstart. Our MExN integration makes use of the Browser agent, Node.js agent, and MongoDB integration to provide you with a pre-built dashboard with your most important metrics (like response time, CPU utilization, traffic, and login frequencies).
...
5. Go to the `index.html ` file of your React application or Angular application.
