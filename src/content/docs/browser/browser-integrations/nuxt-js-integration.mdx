...
import nuxtjsdashboard from 'images/infrastructure_screenshot-crop_nuxtjs-dashboard.png'

With our Nuxt.js dashboard, you can easily track your application error rate, initial page load average, route changes, throughput, and page views with JavaScript errors. Built with our <InlinePopover type="infrastructure" /> agent and our Vue browser monitoring, the Nuxt.js dashboard lets you view critical information all in one place.
