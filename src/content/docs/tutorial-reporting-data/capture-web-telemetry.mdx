...
<CollapserGroup>
  ...
  Open your web application in <DoNotTranslate>**Browser**</DoNotTranslate>. Open the <DoNotTranslate>**Errors**</DoNotTranslate> view under the left hand menu and verify that you can see JavaScript errors. If your application doesn't get a lot of traffic you may need to go back 24 hours or longer to see errors.
...
<CollapserGroup>
  <Collapser
    ...
    title="Via the UI"
  >
  To check you are capturing event logs, go to the <DoNotTranslate>**JS Errors**</DoNotTranslate> tab. Check several different errors to verify event logs appear. 
...
<CollapserGroup>
  <Collapser
    ...
    title="Via the UI"
  >
  Check several errors via the <DoNotTranslate>**JS Errors**</DoNotTranslate> tab. Stack traces will appear under the error event log. 
...
<CollapserGroup>
  <Collapser
    ...
    title="Via the UI"
  >
  Check the <DoNotTranslate>**Page views**</DoNotTranslate> UI for your app by selecting it from the left hand menu. If what you see looks a lot the screen shot below, make a note and follow the instructions in this guide on how to address it. 
...
<CollapserGroup>
  <Collapser
    ...
    title="Via the UI"
  >
  Check AJAX grouping for your app by selecting it from the left hand menu and grouping by <DoNotTranslate>**groupedRequestUrl**</DoNotTranslate>. If what you see looks a lot the screen shot below, make a note and follow the instructions in this guide on how to address it. 
...
<DoNotTranslate>**Cost model:**</DoNotTranslate> Dependent on your company's developer FTE model and project estimation.

<DoNotTranslate>**Estimation:**</DoNotTranslate> Typically a number of hours for a developer to become effective using New Relic instrumentation features.

* Initial: 16 hours training and exploration
* Recurring: 4 hours in a quarterly review
...
<DoNotTranslate>**Estimation:**</DoNotTranslate> This tends to be dependent on the scope of the project and the amount of instrumentation work required.
...
<DoNotTranslate>**KPIs:**</DoNotTranslate>
...
<DoNotTranslate>**Outcomes:**</DoNotTranslate>
* Less alert noise
...
<DoNotTranslate>**KPI:**</DoNotTranslate> Service quality (business KPI)
...
<DocTiles>
  ...
  <DocTile title='Capture service telemetry' path="/docs/tutorial-reporting-data/capture-service-telemetry/"></DocTile>
</DocTiles>
