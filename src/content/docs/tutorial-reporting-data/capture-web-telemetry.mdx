---
title: "Report the right web telemetry" 
...
One of the most important things you can do to maintain a high quality production environment is to make sure you have the web telemetry you need to detect and resolve poor user experience. This guide will show you how to check that you're getting the right data and that your browser monitoring is configured for you to make the most of it. We'll help you ensure that you're:   
...
Next, underlyingse NerdGraph to [track changes in your web application](/docs/change-tracking/change-tracking-graphql/) so you can see the impact of changes you make against performance KPIs, conversions, and user engagement.        
    </Step>
    <Step>
...
Seem to be missing some strong closing information. This seems to just cover grouping so we will need to tell customers what to do next and where to go from here. Is there a missing improvement process?