...
* <DoNotTranslate>**Business KPIs**</DoNotTranslate> are aligned to your overall program objectives and should be consistently measured to demonstrate ongoing improvement for each service. Business KPIs include: 
...
<DoNotTranslate>**Goal:**</DoNotTranslate> Improved service quality attainment score over time.
...
<DoNotTranslate>**Goal:**</DoNotTranslate> Consistency of attainment with consistent or improving service quality indicator.
...
* <DoNotTranslate>**Practitioner KPIs**</DoNotTranslate> are used to measure changes in the execution of job functions for those participating in the development and management of services. Practictioner KPIs include: 
...
<DoNotTranslate>**Goal:**</DoNotTranslate> A consistent or improving feature release frequency consistent with the service delivery goals.
...
<DoNotTranslate>**Goal:**</DoNotTranslate> Steady decrease of incident close time for identified services.

<DoNotTranslate>**Best practices:**</DoNotTranslate>* follow the [Alert quality management guide](/docs/tutorial-create-alerts/manage-alert-quality/) to help you understand the behavior of your services through using <InlinePopover type="alerts" /> to help improve your service delivery.
  </Collapser>
</CollapserGroup>
