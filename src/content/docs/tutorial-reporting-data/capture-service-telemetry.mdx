...
* <DoNotTranslate>**Defect detection:**</DoNotTranslate> By encoding a test for an endpoint that produces a simple true/false result, your operations can isolate discrete failures to determine if the integrity of service delivery has been compromised.
