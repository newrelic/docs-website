...
4. In the distributed tracing UI, you can click on a trace group to see individual traces involved in your transaction. 
5. Then, you can drill into individual traces.
6. [QUESTION: WHAT ADDITION STEPS DO WE NEED HERE?
