...
redirects:
  ...
  - /docs/tutorial-customer-experience/intro-to-customer-experience/
...
New Relic helps you measure and improve the performance of your digital experience. This tutorial gives you direction on how to do the following to improve this experience in a meaningful way:

* Look at customer experience in relation to global functions, lines of business, and regions
...
* [SPA enabled for AJAX settle times and distributed tracing](/docs/new-relic-solutions/best-practices-guides/full-stack-observability/browser-monitoring-best-practices-guide/#how-to-do-it)
* Synthetics monitors configured:
  ...
  * You should configure monitors for each domain and each login flow
...
<DocTiles>
  <DocTile title='Establish your current state' path="/docs/tutorial-customer-experience/establish-current-state/"> Learn how to establish your current state to create your baselines</DocTile>
  <DocTile title='Improve your customer experience' path="/docs/tutorial-customer-experience/improve-customer-experience/"> Learn how to use the data from your current state to make improvements</DocTile>
  <DocTile title='Analyze the bottom-of-the-funnel' path="/docs/tutorial-customer-experience/bottom-funnel-analysis/"> Learn how to analyze the end of a customer experience to improve your conversions</DocTile>
</DocTiles>
