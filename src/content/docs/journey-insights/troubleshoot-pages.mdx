...
import ping from 'images/tutorial_screenshot-crop_ping-wpm.webp'

import cwv from 'images/tutorial_screenshot-crop_cwv-wpm.webp'

import time from 'images/tutorial_screenshot-crop_cwv-time-wpm.gif'
