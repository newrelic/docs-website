...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Email addresses (identified in the policy) will be notified automatically about [threshold](/docs/using-new-relic/welcome-new-relic/get-started/glossary#alert-threshold) incidents for any host matching the filters you have applied, depending on the policy's [alert event preferences](/docs/alerts/organize-alerts/specify-when-alerts-create-events).
      </td>
    </tr>
