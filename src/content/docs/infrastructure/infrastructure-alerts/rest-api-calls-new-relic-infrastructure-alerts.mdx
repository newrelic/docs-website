...
<Callout variant="tip">
  If your organization hosts data in the EU data center, make sure you are using the [EU region endpoints](/docs/using-new-relic/welcome-new-relic/getting-started/introduction-eu-region-data-center#endpoints). If your organization hosts data in the JP data center, make sure you are using the [JP region endpoints](/docs/accounts/accounts-billing/account-setup/choose-your-data-center).
</Callout>
