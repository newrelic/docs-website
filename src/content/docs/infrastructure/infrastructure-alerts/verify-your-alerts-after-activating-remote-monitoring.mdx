...
This document explains why <InlinePopover type="alerts"/> are affected by enabling [remote monitoring](/docs/remote-monitoring-host-legacy-integrations) in the Apache, Cassandra, MySQL, Nginx, and Redis integrations, and how to proceed if this happens.
