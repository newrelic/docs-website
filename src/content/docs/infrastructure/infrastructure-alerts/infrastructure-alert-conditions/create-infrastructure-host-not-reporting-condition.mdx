...
4. Use the email links to examine additional details in the [**Incident details** page](/docs/alerts-applied-intelligence/new-relic-alerts/alert-incidents/view-event-details-incidents).
