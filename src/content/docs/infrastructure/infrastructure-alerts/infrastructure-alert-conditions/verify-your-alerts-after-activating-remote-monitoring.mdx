...
<Callout variant="important">
  We strongly recommend reviewing the configuration of your alerts after
  activating the `remote_monitoring` flag.
</Callout>
...
![check-alerts-1.png](src/images/check-alerts-1.png 'check alerts work after remote monitoring 1')

<figcaption>Alert before and after activating remote monitoring.</figcaption>
...
![check-alerts-3.png](src/images/check-alerts-3.png 'check alerts work after remote monitoring 3')

<figcaption>With the new filter the alert behaves as expected.</figcaption>
