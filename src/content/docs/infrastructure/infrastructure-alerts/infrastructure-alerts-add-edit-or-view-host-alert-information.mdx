  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * View detailed information about [alert incidents](/docs/new-relic-solutions/get-started/glossary/#alert-incident): Use the [alerts](/docs/alerts/alert-event-management/view-alert-event-details) UI or the [notification channel](#notification) integrated with the associated policy.
      </td>
    </tr>
