  ...
  >
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          <td>
            Various plugins gather system-wide details through this directory. Used for infrastructure <DoNotTranslate>**Inventory**</DoNotTranslate> and metrics.
          </td>
        ...
        <tr>
          <td>
            Various plugins gather `sysctl` settings through this directory. Used for infrastructure <DoNotTranslate>**Inventory**</DoNotTranslate> and metrics.
          </td>
        ...
        <tr>
          <td>
            Various plugins (`sshd_config`, `hostinfo`) read specific configs in this directory. Used for infrastructure <DoNotTranslate>**Inventory**</DoNotTranslate> and metrics.
          </td>
