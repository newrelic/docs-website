...
* Cloud platform integrations: [Amazon](/docs/infrastructure/amazon-integrations/aws-integrations-list), [Google Cloud Platform](/docs/integrations/google-cloud-platform-integrations), and [Microsoft Azure](/docs/infrastructure/microsoft-azure-integrations/azure-integrations-list), and [Google Cloud Platform](/docs/integrations/google-cloud-platform-integrations). 
...
* Our [on-host integrations](/docs/infrastructure/host-integrations), like NGINX, Cassandra, MySQL, and many more: these work in concert with our infrastructure agent. 
