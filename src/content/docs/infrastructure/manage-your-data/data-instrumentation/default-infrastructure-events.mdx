...
redirects:
  ...
  - /node/38121/
japaneseVersion: >-
  https://docs.newrelic.co.jp/docs/infrastructure/manage-your-data/data-instrumentation/default-infrastructure-events
---
...
* Better understand the Infrastructure monitoring UI.
...
* Perform more effective [queries of your data](#query-data).
...
## Overview of how data is reported [#overview]

Each [event type](#infrastructure-events) has a unique collection interval.

If you're using [infrastructure integrations](/docs/intro-infrastructure-integrations), you'll have more events than the basic event types described in this document. To see common AWS attributes, see [AWS data](#shared-attributes).

To change scheduling for data from infrastructure integrations:

* [On-host integrations](/docs/integrations/host-integrations/host-integrations-list): use an integration's `interval` [configuration](/docs/integrations/integrations-sdk/file-specifications/host-integration-configuration-overview) setting.
* Cloud integrations: edit the [polling frequency](/docs/integrations/new-relic-integrations/cloud-integrations/configure-polling-frequency-data-collection-cloud-integrations).

## Infrastructure events

The following events and their associated attributes (metrics and metadata) are used to create the Infrastructure monitoring UI visualizations. You can also [create custom queries and charts](#query-data) of this data.
...
To learn about infrastructure integration data, see the [documentation for a specific integration](/docs/integrations).
...
You can create [infrastructure custom attributes](/docs/meatballs-configuring-your-agent#attributes) in the New Relic YAML file. Use this metadata to:
...
If you [connect your Amazon Elastic Compute Cloud (EC2) account to infrastructure monitoring](/docs/infrastructure/new-relic-infrastructure/data-instrumentation/amazon-aws-ec2-integration-infrastructure), New Relic reports data from your [Amazon EC2 instances](/docs/infrastructure/infrastructure-integrations/amazon-integrations/aws-ec2-integration). Amazon EC2-related attributes are common attributes that can be used in any event. These attributes are drawn from the EC2 API. No CloudWatch information is collected.
