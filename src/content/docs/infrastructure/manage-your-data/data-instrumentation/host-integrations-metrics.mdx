...
In the past, our <InlinePopover type="infrastructure" /> agent and on-host integrations have reported [metrics as attributes attached to events](/docs/data-apis/understand-data/new-relic-data-types/#metric-event-attributes), also known as "sample data." We have now made these metrics also available as [dimensional metrics](/docs/data-apis/understand-data/new-relic-data-types/#dimensional-metrics), a data format that allows for improved analysis and aggregation over time.
