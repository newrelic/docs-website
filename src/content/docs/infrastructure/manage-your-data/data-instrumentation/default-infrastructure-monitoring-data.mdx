...
Want to try out our infrastructure monitoring agent? [Create a New Relic account](https://newrelic.com/signup) for free! No credit card required.
...
## Default-reported cloud data [#shared-attributes]

If you install the infrastructure agent on a host on Amazon, Azure, or Google Cloud Platform, you'll automatically get some basic metadata. You can see some of the metadata reported for Amazon below.

To get more detailed data from your cloud platform services, you should connect New Relic to your cloud provider: [AWS](/docs/infrastructure/amazon-integrations/connect/aws-metric-stream) | [Azure](/docs/infrastructure/microsoft-azure-integrations/get-started/activate-azure-integrations) | [GCP](/docs/infrastructure/google-cloud-platform-integrations/get-started/connect-google-cloud-platform-services-new-relic) 

Here is metadata reported by default by the infrastructure agent when installed on Amazon hosts. Note: these attributes and their values are subject to change if Amazon changes the data they expose.
