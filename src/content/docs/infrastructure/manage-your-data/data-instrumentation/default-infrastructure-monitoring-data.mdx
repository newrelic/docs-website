...
The following are [events](/docs/telemetry-data-platform/ingest-manage-data/understand-data/new-relic-data-types#events-new-relic) reported by default by the <InlinePopover type="infrastructure" /> agent and some [infrastructure integrations](/docs/intro-infrastructure-integrations).
