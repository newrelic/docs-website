...
## Troubleshooting: Installation fails with error 1603 [#error-1603]

<Callout variant="important">
  **Known Issue (v1.73.0 and above):** MSI installation may fail with error **1603** on systems with Windows Group Policy restrictions.
</Callout>

### Symptoms

* MSI installation fails with error code **1603**
...
* [Agent not starting in Windows](/docs/infrastructure/infrastructure-troubleshooting/troubleshoot-infrastructure/agent-not-starting-windows)
* [No data appears in the infrastructure UI](/docs/infrastructure/infrastructure-troubleshooting/troubleshoot-infrastructure/no-data-appears-infrastructure)
...
* [Learn to use your host data](/docs/tutorial-troubleshoot-infra-hosts/diagnose-app-infra-data) to troubleshoot an alert event.
