...
Ready to get started? Click the <DNT>**Guided install**</DNT> button. Or, if your organization is located in an [EU data center](/docs/using-new-relic/welcome-new-relic/get-started/our-eu-us-region-data-centers), click <DNT>**EU Guided install**</DNT>. Or, if your organization is located in a [JP data center](/docs/accounts/accounts-billing/account-setup/choose-your-data-center), click <DNT>**JP Guided install**</DNT>.
...
<ButtonGroup>
  ...
  <ButtonLink
    role="button"
    to="https://one.jp.newrelic.com/marketplace?&state=fc9c0e5f-95e6-a84d-4db2-d5d702de121a"
    variant="primary"
  >
    JP Guided install
  </ButtonLink>
