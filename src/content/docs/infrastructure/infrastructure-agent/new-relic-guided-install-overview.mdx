...
Ready to get started? Click the <DNT>**Guided install**</DNT> button. Or, if your organization is located in an [EU data center](/docs/using-new-relic/welcome-new-relic/get-started/our-eu-us-region-data-centers), click <DNT>**EU Guided install**</DNT>. If you're in the JP region, click <DNT>**JP Guided install**</DNT>.
