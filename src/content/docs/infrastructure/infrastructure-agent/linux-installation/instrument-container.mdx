...
Support for e2e Test validation on Operating systems using Control Group v1 has been removed from infrastructure agent v.1.63.2 and nri-docker v2.3.2 ( This change is due to GitHub's discontinuation of support for lower image [runners](https://github.com/actions/runner-images/issues/11101) that are necessary for these validations ).