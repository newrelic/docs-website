---
<<<<<<< HEAD:src/content/docs/infrastructure/install-infrastructure-agent/linux-installation/container-infrastructure-monitoring.mdx
title: Install the agent as a container
=======
title: Install infrastructure agent as a container
>>>>>>> develop:src/content/docs/infrastructure/infrastructure-agent/linux-installation/infra-agent-as-container.mdx
tags:
  - Infrastructure
