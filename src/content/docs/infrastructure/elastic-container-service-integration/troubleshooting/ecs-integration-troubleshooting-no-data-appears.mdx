...
If your New Relic account had previously installed the <InlinePopover type="infrastructure" /> agent or an infrastructure on-host integration, your data should appear in [the UI](/docs/ecs-integration-understand-use-data) within a few minutes.
