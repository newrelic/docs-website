...
6. Additional steps for [Fargate launch type](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/launch_types.html) (not EC2 launch type):
   ...
   * Then, you can add as a sidecar the container you want to monitor in this task definition. An other possibility is to do the other way around, adding the newrelic container as a sidecar to the task you want to monitor.
