...
<figcaption>
  **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Explorer > ECS dashboard:** The ECS integration reports performance data about your Amazon ECS containers.
</figcaption>
