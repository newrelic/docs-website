...
1. Go to <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DoNotTranslate> and, in the <DoNotTranslate>**Filter by name or tags**</DoNotTranslate>  field, search for ECS cluster, or type the name of your ECS cluster.
