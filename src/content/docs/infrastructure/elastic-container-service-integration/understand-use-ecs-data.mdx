...
1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities)** and select [**Explorer**](/docs/new-relic-one/use-new-relic-one/ui-data/new-relic-one-entity-explorer-view-performance-across-apps-services-hosts).
