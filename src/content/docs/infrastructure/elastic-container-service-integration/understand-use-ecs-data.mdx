...
1. Go to <DNT>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DNT> and, in the <DNT>**Filter by name or tags**</DNT>  field, search for ECS cluster, or type the name of your ECS cluster.
