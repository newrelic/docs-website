...
New Relic's [ECS integration](/docs/introduction-amazon-ecs-integration) reports and displays performance data from your [Amazon ECS](https://docs.aws.amazon.com/ecs/index.html) environment. This document provides some recommended alert conditions for monitoring ECS performance.
