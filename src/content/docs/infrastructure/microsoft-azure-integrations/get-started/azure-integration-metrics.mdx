...
### Metric name matches one of the dimension

When the metric name and the name of one of the dimensions are exactly the same, the dimension name is uncapitalized so both values are different: 
