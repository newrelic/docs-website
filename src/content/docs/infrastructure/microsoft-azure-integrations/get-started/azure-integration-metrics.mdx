...
Metrics fetched from the Azure Monitor API are stored in New Relic as [dimensional metrics](/docs/telemetry-data-platform/ingest-manage-data/understand-data/new-relic-data-types/#dimensional-metrics) following this convention:
...
For more information about supported Azure resource types, see the [Azure Monitor Metrics documentation website](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-metrics/metrics-index).
...
For a reference on available metrics from each one of the polling integrations and their names, [check out our doc on the individual integrations](/docs/infrastructure/microsoft-azure-integrations/get-started/activate-azure-integrations/).
