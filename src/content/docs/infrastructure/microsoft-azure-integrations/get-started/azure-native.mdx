...
If your team deploys software and cloud services through Azure, our [Azure Native New Relic Service](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/newrelicinc1635200720692.newrelic_liftr_payg) lets you manage your Azure-New Relic configuration directly from your Azure account. 

The Azure Native New Relic Service provides the following capabilities:
...
Some notes about the New Relic account created with this service: 
