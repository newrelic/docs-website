...
### Unavailable features [#data-plus]
...
This service comes with our [Data Plus option](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/data-ingest-billing/#data-plus), but currently these Data Plus features are **not** yet available: 

* Historical data export
* Streaming data export
* Vulnerability Management 
* FedRAMP Moderate and HIPAA (HITrust Certified), due to Enterprise edition not yet being available
