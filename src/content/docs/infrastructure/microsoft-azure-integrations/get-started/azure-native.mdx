...
The features and integrations available for the Azure Native New Relic Service is different from regular, non-Azure New Relic. 

You can use the following New Relic agents:
...
**Infrastructure agent for:** 

* Windows
* Linux 

### Available editions [#edition]

Our Standard and Pro [editions](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing/#editions) are available, but not yet Enterprise.

### Available Data Plus features [#data-plus]

This service comes with our [Data Plus option](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/data-ingest-billing/#data-plus), but currently these features are **not** yet available: 

* Historical exports
* Streaming data
* Vulnerability management 
* Private link (an AWS feature)
* FedRAMP and HIPAA (due to Enterprise edition not yet being available)
