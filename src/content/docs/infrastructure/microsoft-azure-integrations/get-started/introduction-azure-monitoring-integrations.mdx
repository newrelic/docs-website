...
We offer multiple Azure monitoring solutions for various user needs:

<SideBySide>
  <Side>
    ### Azure monitoring integrations

    Instrument your Azure services with our infrastructure agent and report data according to a regular polling interval.
  </Side>
  <Side>
    ### [Azure Native New Relic Service](src/content/docs/infrastructure/microsoft-azure-integrations/get-started/azure-native.mdx)

    Deploy New Relic APM and infrastructure agents directly through the Azure Marketplace. Manage your observability needs directly where you manage and deploy your software.
  </Side>
  <Side>
    ### [APM .NET support for Azure](/docs/apm/agents/net-agent/azure-installation/install-net-agent-azure-web-apps/)

    Monitor your Azure Web App with our .NET agent.
  </Side>
</SideBySide>

The remainder of this document covers only Azure monitoring integrations. 
