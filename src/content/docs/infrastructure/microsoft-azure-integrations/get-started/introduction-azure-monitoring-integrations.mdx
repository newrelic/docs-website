...
* New Relic in Azure: With our [Azure Native New Relic Service](/docs/infrastructure/microsoft-azure-integrations/get-started/azure-native), you can easily deploy New Relic directly from the Azure Marketplace, with your data stored on Azure. This option gets you the features of both of the two options below, and you can configure it directly from the Azure portal.
