...
6. Select <DNT>**Access control (IAM) > Add > Add role assignment**</DNT>.
7. From the <DNT>**Role**</DNT> dropdown, select <DNT>**Monitoring Reader**</DNT>.
8. From the <DNT>**Select**</DNT> dropdown, select the app's name; for example, `NewRelic-Integrations`.
9. From <DNT>**Selected members**</DNT>, verify your app name appears, then select <DNT>**Save**</DNT>.
10. Go to subscriptions settings, click on "Resource providers" add register "microsoft.insights"
