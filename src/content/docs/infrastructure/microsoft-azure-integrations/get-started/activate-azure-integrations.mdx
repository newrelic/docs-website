...
It may take few minutes until new resources are detected and synthesized as entities in New Relic One. See Cloud integrations [system limits](/docs/data-apis/manage-data/view-system-limits) for more information.
