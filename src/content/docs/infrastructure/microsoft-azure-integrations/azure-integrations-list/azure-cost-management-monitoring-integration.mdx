...
1. In the Azure Portal <DoNotTranslate>**Subscriptions**</DoNotTranslate> section, select the subscriptions that you want New Relic to monitor.
2. Select <DoNotTranslate>**Access control (IAM) > Add**</DoNotTranslate>.
3. From the <DoNotTranslate>**Role**</DoNotTranslate> dropdown, select <DoNotTranslate>**Billing Reader**</DoNotTranslate>.
