...
To find your integration data, go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > Azure** and select the Azure Redis Cache integration.
