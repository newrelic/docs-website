...
import infrastructureAzureMonitorSelect from 'images/infrastructure_screenshot-full_azure-monitor-select.png'
...
- Both the Azure Monitor integration and other Azure integartions can be enabled in parallel. See the [querying your data](#Querying-Your-Data) section to learn how to query Azure Monitor metrics in isolation.
...
Metrics collected using the from Azure Monitor are stored in New Relic as [Dimensional Metrics](/docs/data-apis/understand-data/new-relic-data-types/#dimensional-metrics) of type summary, and can be [queried](/docs/query-your-data/nrql-new-relic-query-language/nrql-query-tutorials/query-infrastructure-dimensional-metrics-nrql/) using [NRQL](/docs/query-your-data/nrql-new-relic-query-language/get-started/introduction-nrql-new-relics-query-language/).
