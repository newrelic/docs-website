...
This integration is what powers the Azure Native New Relic Service, a service that lets you set up and configure New Relic directly from Azure and store your New Relic data in Azure. [Learn more about the Azure Native New Relic Service.](/docs/infrastructure/microsoft-azure-integrations/get-started/azure-native)
