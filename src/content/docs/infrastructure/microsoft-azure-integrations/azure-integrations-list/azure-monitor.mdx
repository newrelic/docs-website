...
Given that the new integration enables ingesting all metrics from all services, <DoNotTranslate>**the amount of API calls to Azure will depend on the number of resources that are monitored by New Relic**</DoNotTranslate>. Configuration of the integration's polling interval parameters can help controlling the amount of these API calls.
...
2. Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Azure**</DoNotTranslate>, and look for the <DoNotTranslate>**Azure Monitor**</DoNotTranslate> integration.
3. Click <DoNotTranslate>**Configure**</DoNotTranslate>, and then toggle <DoNotTranslate>**Enabled**</DoNotTranslate> to <DoNotTranslate>**On**</DoNotTranslate>.
...
* <DoNotTranslate>**Aggregation window**</DoNotTranslate>: With a one minute aggregation window, we recommend setting an eight minute evalaution offset.
...
1. Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Azure**</DoNotTranslate>, then click <DoNotTranslate>**Manage Services**</DoNotTranslate>.
2. Enable the new <DoNotTranslate>**Azure Monitor metrics**</DoNotTranslate> integration and click <DoNotTranslate>**Save Changes**</DoNotTranslate>.
    <img
...
3. The <DoNotTranslate>**Azure Monitor metrics**</DoNotTranslate> integration becomes available.
    <img
...
5. Once the setup is done, you can disable the previous polling integrations under the <DoNotTranslate>**Manage services**</DoNotTranslate> settings.
