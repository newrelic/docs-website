...
You can create [NRQL alert conditions](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/nrql-alert-conditions) on Azure Monitor integration metrics.
...
For more details, see [How to create NRQL alerts](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/nrql-alert-conditions).
...
1. Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Azure and click "Manage Services"**.
...
4. Enable and configure the new integration as described [here](/docs/infrastructure/microsoft-azure-integrations/azure-integrations-list/azure-monitor/#set-up).
<img
