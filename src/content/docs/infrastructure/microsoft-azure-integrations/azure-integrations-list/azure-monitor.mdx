...
Our Azure Monitor integration is the integration that powers the Azure Native New Relic Service. This service lets you set up and configure New Relic directly from Azure, and store your New Relic data in Azure. [Learn more about the Azure Native New Relic Service.](/docs/infrastructure/microsoft-azure-integrations/get-started/azure-native/)

## Features [#features]

Our Azure Monitor integration monitors all your Azure metrics from all supported Azure services. Once you enable it, we query your Azure platform services according to the configured polling interval. This enables all of the following features:
...
## Why Azure Monitor over our other Azure integrations?

Before the Azure Monitor integration, monitoring Azure required service-specific Azure APIs to retrieve metrics and metadata.
...
For more on migrating from the previous integrations to this integration, see [Migration](#migrate).

## Requirements [#requirements]

To use the Azure Monitor integration, you must:
...
Alternatively, you can use this integration via the [Azure Native New Relic Service](/docs/infrastructure/microsoft-azure-integrations/get-started/azure-native).
...
For more detail, see [Microsoft Azure Monitor pricing documentation](https://azure.microsoft.com/en-in/pricing/details/monitor/#pricing).
...
Note that it might take a few minutes for data to show up.
...
* If you were a previous user of our older Azure integrations: Start with those resource types that we didn't previously support.

Note that the Azure Monitor integration and other Azure integrations can be enabled in parallel. See the [querying your data](#Querying-Your-Data) section to learn how to query Azure Monitor metrics in isolation.
...
## Out of the box support [#support]

Here are some details on the features you get with this integration by default, out of the box: 
...
When migrating from our traditional Azure integrations to the Azure Monitor integration, there are a few things to keep in mind:
