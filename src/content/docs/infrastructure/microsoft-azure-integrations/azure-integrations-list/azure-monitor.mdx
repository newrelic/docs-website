...
Metrics collected using the from Azure Monitor are:
- Stored in New Relic as [dimensional metrics](/docs/data-apis/understand-data/new-relic-data-types/#dimensional-metrics) of type `summary`
...
- Any metrics not mapped to an entity are available as raw dimnsional metrics
...
When migrating from individual Azure integartions to the Azure Monitor integartion, there are a few things to keep in mind:
