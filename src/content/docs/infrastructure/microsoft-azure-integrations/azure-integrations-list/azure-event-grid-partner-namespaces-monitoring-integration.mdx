---
title: Azure Event Grid Partner Namespaces through Azure Monitor Integration
tags:
  - Integrations
...
redirects:
  - /docs/integrations/microsoft-azure-integrations/azure-integrations-list/azure-event-grid-partner-namespaces-monitoring-integration
  - /docs/integrations/microsoft-azure-integrations/azure-integrations-list/azure-event-grid-partner-namespaces-monitoring-integration
---
...
New Relic queries your Azure Event Grid Partner Namespaces services through Azure Monitor integration according to a default [polling](/docs/infrastructure/microsoft-azure-integrations/azure-integrations-list/azure-monitor/#settings) interval.
