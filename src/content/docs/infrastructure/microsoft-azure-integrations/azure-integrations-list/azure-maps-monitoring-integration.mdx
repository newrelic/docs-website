...
Follow standard Azure Monitor integration procedure to [activate your Azure service in New Relic infrastructure monitoring](/docs/infrastructure/microsoft-azure-integrations/azure-integrations-list/azure-monitor).
