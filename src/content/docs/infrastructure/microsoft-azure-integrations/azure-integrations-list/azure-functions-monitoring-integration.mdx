...
To find your integration data, go to **[one.newrelic.com](https://one.newrelic.com)**, in the top nav click **Infrastructure**, then click **Azure** and look for the integration.
