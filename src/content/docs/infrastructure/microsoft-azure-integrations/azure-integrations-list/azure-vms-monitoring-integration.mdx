...
If you use <DoNotTranslate>**Host not reporting**</DoNotTranslate> alert conditions, the importing of Azure metadata for your VMs will change the hosts registry and result in false alert notifications. To prevent false positives:

1. For each Azure instance, [disable](/docs/infrastructure/new-relic-infrastructure/infrastructure-alert-conditions/infrastructure-alerts-add-edit-or-view-host-alert-information#maintain-alerts) its <DoNotTranslate>**Host not reporting**</DoNotTranslate> alert condition.
...
3. [Re-enable](/docs/infrastructure/new-relic-infrastructure/infrastructure-alert-conditions/infrastructure-alerts-add-edit-or-view-host-alert-information#maintain-alerts) each <DoNotTranslate>**Host not reporting**</DoNotTranslate> alert condition.
