...
You must install the <InlinePopover type="infrastructure" /> agent on each VM to see metrics from that host. Connecting your Azure subscription allows New Relic to access VM metadata.
