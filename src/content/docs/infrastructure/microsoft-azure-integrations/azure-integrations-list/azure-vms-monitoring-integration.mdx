...
1. For each Azure instance, [disable](/docs/alerts/alert-conditions/host-not-reporting-conditions/) its <DNT>**Host not reporting**</DNT> alert condition.
...
3. [Re-enable](/docs/alerts/alert-conditions/host-not-reporting-conditions/) each <DNT>**Host not reporting**</DNT> alert condition.
