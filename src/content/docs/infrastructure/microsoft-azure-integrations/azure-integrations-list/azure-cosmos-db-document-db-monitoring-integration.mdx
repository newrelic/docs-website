...
1. Go to the <DoNotTranslate>**Azure Portal**</DoNotTranslate> and open a shell by selecting the terminal <Icon name="fe-terminal"/>
   icon.
2. Add the following command:
   ...
   ```
3. From <DoNotTranslate>**Services > Subscriptions**</DoNotTranslate>, select the subscription, go to <DoNotTranslate>**Access control (IAM)**</DoNotTranslate>, and then select <Icon name="fe-plus"/>
   <DoNotTranslate>**Add**</DoNotTranslate>.
4. In the <DoNotTranslate>**Role**</DoNotTranslate> search box, add the name of the newly created role definition (for example, `NewRelic Integrations`).
5. In the <DoNotTranslate>**Select**</DoNotTranslate> search box, add the name of the New Relic integration application, and select it.
6. Ensure that the application is added to the <DoNotTranslate>**Selected members**</DoNotTranslate> list, then <DoNotTranslate>**Save**</DoNotTranslate>.
...
To view your integration data, go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Azure**</DoNotTranslate> and select the Cosmos DB Integration.
