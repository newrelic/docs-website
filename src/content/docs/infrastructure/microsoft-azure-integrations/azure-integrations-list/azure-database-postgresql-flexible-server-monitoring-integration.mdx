...
redirects:
  - /docs/azure-azure_postgresqlflexible-integration
...
To find your integration data, go to <DNT>**[one.newrelic.com](https://one.newrelic.com/ "Link opens in a new window.") > Infrastructure > Azure**</DNT> and select the integration.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Bytes read per second from the data disk during monitoring period
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Bytes written per second to the data disk during monitoring period
      </td>
    </tr>
  </tbody>
</table>
