...
To find your integration data, go to <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/ "Link opens in a new window.") > Infrastructure > Azure**</DoNotTranslate> and select the integration.
