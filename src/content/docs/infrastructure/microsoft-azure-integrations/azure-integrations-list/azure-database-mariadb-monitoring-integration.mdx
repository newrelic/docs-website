...
Follow standard procedures to [activate your Azure service in New Relic](/docs/infrastructure/microsoft-azure-integrations/getting-started/activate-azure-integrations), using the generic <DoNotTranslate>**Reader**</DoNotTranslate> role.
