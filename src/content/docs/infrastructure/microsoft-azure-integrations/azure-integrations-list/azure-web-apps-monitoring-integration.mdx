...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The amount of CPU consumed by the app, in seconds. For more information about this metric. Please see [https://aka.ms/website-monitor-cpu-time-vs-cpu-percentage](https://aka.ms/website-monitor-cpu-time-vs-cpu-percentage) (CPU time vs CPU percentage). For WebApps only.
      </td>
    </tr>
