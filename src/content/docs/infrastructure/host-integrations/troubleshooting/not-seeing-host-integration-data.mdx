...
1. Check to see if the integration is activated and reporting. Go to **[one.newrelic.com](https://one.newrelic.com) > Infrastructure > Third-party Services** and look for the integration name under **Active integrations**.
