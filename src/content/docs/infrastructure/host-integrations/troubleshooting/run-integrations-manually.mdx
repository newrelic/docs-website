---
title: Run infrastructure agent integrations manually (dry-run)
...
You want to know if an [infrastructure agent integration](/docs/infrastructure/host-integrations/installation/install-infrastructure-host-integrations) is configured as expected and gathering metrics. To diagnose it, use the dry-run flag with the infrastructure agent or run the integration manually.
