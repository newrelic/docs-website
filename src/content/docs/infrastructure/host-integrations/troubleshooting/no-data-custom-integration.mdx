---
title: Not seeing on-host custom integration data
...
You created a custom on-host integration with New Relic, but you are not seeing data in the infrastructure UI.

## Solution

To troubleshoot and resolve the problem:

1. Check to see if the integration is activated and reporting. Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Third-party Services** and look for the integration name under **Active integrations**.
