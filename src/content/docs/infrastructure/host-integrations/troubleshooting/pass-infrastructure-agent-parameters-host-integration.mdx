...
You have config parameters defined in the <InlinePopover type="infrastructure" /> agent and you want to pass the parameters to an [on-host integration](/docs/integrations/host-integrations/getting-started/introduction-host-integrations).
