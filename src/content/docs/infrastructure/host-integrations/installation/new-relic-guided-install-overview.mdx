...
Ready to get started? Click the <DoNotTranslate>**Guided install**</DoNotTranslate> button. Or, if your organization is located in an [EU data center](/docs/using-new-relic/welcome-new-relic/get-started/our-eu-us-region-data-centers), click <DoNotTranslate>**EU Guided install**</DoNotTranslate>.
