...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [Azure Key Vault secret retrieval configuration](#azure-key-vault-secrets)
      </td>
    </tr>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        The URL of the Azure Key Vault instance to retrieve the secret from
    ...
    <tr>
      ...
      <td>
        The name of the secret to retrieve. The agent always retrieves the latest version of the secret.
      </td>
    </tr>
  </tbody>
</table>
