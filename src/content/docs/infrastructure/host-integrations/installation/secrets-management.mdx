...
<Callout variant="important">
  If the secrets retrieval fails, the integration won't be executed, as the <InlinePopover type="infrastructure" /> agent does not have all the data it requires to execute.
</Callout>
