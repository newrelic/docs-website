...
<CollapserGroup>
  ...
  >
    <DNT>**Recommendation:**</DNT> [Update](/docs/infrastructure/new-relic-infrastructure/installation/update-infrastructure-agent) the infrastructure agent ([version 1.0.703 or higher](/docs/release-notes/infrastructure-release-notes/infrastructure-agent-release-notes)).
