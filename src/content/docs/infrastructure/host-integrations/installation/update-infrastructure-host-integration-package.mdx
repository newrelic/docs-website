  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * <DoNotTranslate>**Debian**</DoNotTranslate> or <DoNotTranslate>**Ubuntu**</DoNotTranslate>:
        ...
        * <DoNotTranslate>**Amazon Linux, CentOS, SLES, or RHEL**</DoNotTranslate>:
          ...
          ```
        * <DoNotTranslate>**Windows Server**</DoNotTranslate>
...
<CollapserGroup>
  ...
  >
    <DoNotTranslate>**Recommendation:**</DoNotTranslate> [Update](/docs/infrastructure/new-relic-infrastructure/installation/update-infrastructure-agent) the infrastructure agent ([version 1.0.703 or higher](/docs/release-notes/infrastructure-release-notes/infrastructure-agent-release-notes)).
