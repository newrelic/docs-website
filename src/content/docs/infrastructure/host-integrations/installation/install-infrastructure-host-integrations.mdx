---
title: Install core infrastructure on-host integrations
tags:
  - Integrations
...
translate:
  - jp
metaDescription: Install procedures for New Relic on-host integrations that work with the infrastructure agent.
redirects:
...
These are general install instructions for our "core" on-host integrations (those that work in tandem with our infrastructure agent), and technical details about how they work. 

## The core on-host integrations [#overview]

Some of our on-host infrastructure integrations work in tandem with our infrastructure agent, and have the same file and configuration structure. We sometimes refer to these as the "core" on-host integrations. This list of integrations includes:
...
## Select your install method [#install]
...
Our core on-host integrations are built with the same file structure and configuration structure. To understand the technical details of these files, see [Types of files](/docs/infrastructure/host-integrations/infrastructure-integrations-sdk/specifications/host-integration-files).

For these integrations, the infrastructure agent acts as a forwarder of data from your service.

For example, for the SQL Server integration:
