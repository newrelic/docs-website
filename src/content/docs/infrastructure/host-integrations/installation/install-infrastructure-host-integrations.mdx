...
* <img
  ...
  /> [Install on-host integrations on Amazon ECS](/docs/integrations/host-integrations/host-integrations-list/monitor-services-running-amazon-ecs) (EC2 launch type)
