---
title: Install and configure core on-host integrations
tags:
  - Integrations
...
translate:
  - jp
metaDescription: Details about New Relic on-host integrations that work with the infrastructure agent.
redirects:
...
These are general install instructions for our "core" on-host integrations (those that work with our infrastructure agent), and technical details about how they work. 

## The core on-host integrations [#overview]

Some of our on-host infrastructure integrations work in tandem with our infrastructure agent, and have the same file and configuration structure. We sometimes refer to these as the "core" on-host integrations. These integrations include: 
...
Data from these integrations can be found by going to: **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > Third-party services**. 
