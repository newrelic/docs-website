...
<CollapserGroup>
  ...
  >
    ...
    If you have `nrjmx` already installed and install `nri-jmx`, our JMX tool keeps the already-installed version. If you do not have `nrjmx` already installed, it gets the latest `nrjmx` release.
