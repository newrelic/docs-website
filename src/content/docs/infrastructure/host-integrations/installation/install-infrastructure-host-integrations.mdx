...
* <ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={kubernetesLogo} title="Kubernetes" alt="Kubernetes"/></ImageSizing> [Install on-host integrations on Kubernetes](/docs/integrations/kubernetes-integration/link-apps-services/monitor-services-running-kubernetes)
* <ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={ecs} title="ECS" alt="ECS"/></ImageSizing> [Install on-host integrations on Amazon ECS](/docs/integrations/host-integrations/host-integrations-list/monitor-services-running-amazon-ecs) (EC2 launch type)
