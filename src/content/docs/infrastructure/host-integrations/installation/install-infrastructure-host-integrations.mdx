---
title: Install and configure our infrastructure agent integrations
tags:
  - Integrations
...
These are general install instructions for our infrastructure agent on-host integrations (those that work with our infrastructure agent), and technical details about how they work. 

## Integrations that work in tandem with our infrastructure agent [#overview]

Some of our infrastructure integrations work in tandem with our infrastructure agent, and have the same file and configuration structure. We sometimes refer to these as the infrastructure agent integrations. These integrations include: 
...
The infrastructure agent on-host integrations are built with the same file structure and configuration structure. To understand the technical details of these files, see [Types of files](/docs/infrastructure/host-integrations/infrastructure-integrations-sdk/specifications/host-integration-files).
