...
Our discovery feature currently emits the following variables, which can be used to configure your integrations. The <InlinePopover type="infrastructure" /> agent replaces them with the corresponding values of the discovered containers.
