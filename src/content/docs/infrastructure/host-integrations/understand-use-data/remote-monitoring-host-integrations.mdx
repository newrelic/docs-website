...
<CollapserGroup>
  ...
  >
    ...
    * <DoNotTranslate>**Display name**</DoNotTranslate>: New entity unique key (instead of using the display name)
    * <DoNotTranslate>**Entity GUID**</DoNotTranslate>: New entity GUID
    * <DoNotTranslate>**Entity ID**</DoNotTranslate>: New entity ID
    * <DoNotTranslate>**Entity key**</DoNotTranslate>: New entity unique key (instead of using the display name)
    * <DoNotTranslate>**External key**</DoNotTranslate>: Using integration entity name (instead of using the agent display)
  </Collapser>
