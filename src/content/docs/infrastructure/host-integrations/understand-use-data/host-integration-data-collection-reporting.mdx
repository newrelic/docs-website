---
title: Data collection and reporting for the infrastructure agent integrations
tags:
  - Integrations
...
This doc explains how [our infrastructure agent integrations](/docs/infrastructure/host-integrations/installation/install-infrastructure-host-integrations) collect and report data.

## Data collection and reporting process [#data-collection]

This is how an infrastructure agent on-host integration sends data to New Relic:
