...
* If enabled via <img style={{ width: '32px', height: '32px'}} title="Kubernetes" alt="Kubernetes" src={kubernetes}/>Kubernetes, see [Monitor services running on Kubernetes](/docs/monitor-service-running-kubernetes).
* If enabled via <img style={{ width: '32px', height: '32px'}} title="ECS" alt="ECS" src={ecs}/>Amazon ECS, see [Monitor services running on ECS](/docs/integrations/host-integrations/host-integrations-list/monitor-services-running-amazon-ecs).
