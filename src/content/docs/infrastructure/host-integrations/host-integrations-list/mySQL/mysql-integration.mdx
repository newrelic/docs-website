...
* If enabled via <ImageSizing width="32px" height="32px"><img src={kubernetesK8} title="Kubernetes" alt="Kubernetes"/></ImageSizing>Kubernetes, see [Monitor services running on Kubernetes](/docs/monitor-service-running-kubernetes).
* If enabled via <ImageSizing width="32px" height="32px"><img src={ecs} title="ECS" alt="ECS"/></ImageSizing>Amazon ECS, see [Monitor services running on ECS](/docs/integrations/host-integrations/host-integrations-list/monitor-services-running-amazon-ecs).
