...
5. Optionally, see [MySQL's configuration settings](/docs/infrastructure/host-integrations/host-integrations-list/mySQL/mysql-advanced-config).
...
For more on how to find and use your data, see [MySQL's configuration](/docs/infrastructure/host-integrations/host-integrations-list/mySQL/mysql-advanced-config).
