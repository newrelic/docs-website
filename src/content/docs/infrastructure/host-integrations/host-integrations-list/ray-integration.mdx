...
To instrument the <DoNotTranslate>Apache Druid</DoNotTranslate>> quickstart and to see metrics and alerts, you can also follow our [Ray quickstart page](https://newrelic.com/instant-observability/ray) by clicking on the `Install now` button.
