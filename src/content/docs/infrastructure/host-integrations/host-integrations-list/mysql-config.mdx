...
redirects:
  - /docs/infrastructure/host-integrations/host-integrations-list/mySQL/mysql-config
...
The MySQL integration collects both Metrics and Inventory information. In the table, use the <DoNotTranslate>**Applies to**</DoNotTranslate> column for the settings available to each collection:
