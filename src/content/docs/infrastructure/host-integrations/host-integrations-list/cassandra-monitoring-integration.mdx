...
<tr>
  <td>**PORT**</td>
  <td>Port on which Cassandra is listening.</td>
  <td>7199</td>
...
<tr>
  <td>**USERNAME**</td>
  <td>Username for accessing JMX.</td>
  <td>N/A</td>
  <td style={{ 'text-align': 'center' }}>M</td>
</tr>
...
<tr>
  <td>**CONFIG_PATH**</td>
  <td>Path to the Cassandra configuration file.</td>
  <td>
    /etc/cassandra/
    <br />
    cassandra.yaml
...
<tr>
  <td>**COLUMN_FAMILIES_LIMIT**</td>
  <td>Limit on number of Cassandra Column Families.</td>
  <td>20</td>
  <td style={{ 'text-align': 'center' }}>M</td>
</tr>
...
<tr>
  ...
  <td>The password for the JMX SSL trust store.</td>
  <td>N/A</td>
  <td style={{ 'text-align': 'center' }}>M</td>
</tr>
