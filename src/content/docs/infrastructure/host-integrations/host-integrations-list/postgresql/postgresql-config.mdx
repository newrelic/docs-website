...
The PostgreSQL integration collects both Metrics (<DoNotTranslate>**M**</DoNotTranslate>) and Inventory (<DoNotTranslate>**I**</DoNotTranslate>) information. The <DoNotTranslate>**Applies To**</DoNotTranslate> column in the following table indicates which settings can be used for each specific collection:
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The user name for the PostgreSQL connection. <DoNotTranslate>**Required.**</DoNotTranslate>
      </td>
    ...
    <tr>
      ...
      <td>
        The password for the PostgreSQL connection. <DoNotTranslate>**Required.**</DoNotTranslate>
      </td>
