...
While our Dojo integration isn't built with our <InlinePopover type="infrastructure" /> agent, we recommend installing it if you want performance data about your hosts. You can install the <InlinePopover type="infrastructure" /> agent two different ways: 
