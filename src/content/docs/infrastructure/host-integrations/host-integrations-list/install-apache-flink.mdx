...
With our Apache Flink dashboard, you can easily track your logs, keep an eye on your instrumentation sources, and get an overview of uptime and downtime for all your applications' instances. Built with our <InlinePopover type="infrastructure" /> agent and our Prometheus OpenMetrics integration, Flink dashboards take advantage of OpenMetrics endpoint scraping, so you can view all your most important data, all in one place.
...
Before getting Flink data into New Relic, first install our <InlinePopover type="infrastructure" /> agent, then expose your metrics by installing Prometheus OpenMetrics. 
