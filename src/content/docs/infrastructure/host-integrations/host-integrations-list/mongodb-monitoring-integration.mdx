    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            The number of `getLastError` operations with a specified write concern ( w) that wait for one or more members of a replica set to acknowledge the write operation per second.
          </td>
        </tr>
