...
6. Update `server.port` on which you are running lighttpd. Here, we have updated the server.port to 9880.
...
To restart the New Relic infra agent follow the instructions in [this doc](/docs/infrastructure/install-infrastructure-agent/manage-your-agent/start-stop-restart-infrastructure-agent/) and run this command:
