...
Our ActiveMQ dashboard takes data scraped from your JMX integration and translates it into a dashboard. Storing your data in New Relic gives you a full overview of your system's health and critical business points. If you haven't already, you'll need to install our [JMX monitoring integration](/docs/infrastructure/host-integrations/host-integrations-list/jmx-monitoring-install).
