...
Explore on [one.newrelic.com](https://one.newrelic.com) using [NRQL](/docs/query-your-data/nrql-new-relic-query-language/get-started/introduction-nrql-new-relics-query-language/) the metrics stored on the `event_type`.
