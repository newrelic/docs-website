...
```
2. Open the `common.runtime.properties` file:
```shell
sudo nano common.runtime.properties
```
3. Add `prometheus.emitter` to the end of the extensions load list as shown below:
```shell
...
```
4. Navigate to the `Broker` directory and paste the following snippet at the end of `runtime.properties` file.
```shell
# Monitoring
...
```
5. Navigate to the `Coordinator-Overlord` directory and paste the following snippet at the end of `runtime.properties` file.
```shell
# Monitoring
druid.monitoring.monitors=["org.apache.druid.java.util.metrics.JvmMonitor"]
druid.emitter=prometheus
...
```
6. Navigate to the `Historical` directory and paste the following snippet at the end of `runtime.properties` file.
```shell
# Monitoring
druid.monitoring.monitors=["org.apache.druid.java.util.metrics.JvmMonitor"]
druid.emitter=prometheus
...
```
7. Navigate to the `MiddleManager` directory and paste the following snippet at the end of `runtime.properties` file.
```shell
# Monitoring
druid.monitoring.monitors=["org.apache.druid.java.util.metrics.JvmMonitor"]
druid.emitter=prometheus
...
```
8. Navigate to the `Router` directory and paste the following snippet at the end of `runtime.properties` file.
```shell
# Monitoring
druid.monitoring.monitors=["org.apache.druid.java.util.metrics.JvmMonitor"]
druid.emitter=prometheus
