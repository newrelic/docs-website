...
To find your integration data in New Relic, go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > Third-party services** and select one of the Varnish Cache integration links.
