...
The Varnish Cache integration collects both metrics(<strong>M</strong>) and inventory(<strong>I</strong>) information. Check the <DoNotTranslate>**Applies To**</DoNotTranslate> column below to find which settings can be used for each specific collection:
...
<table>
  ...
  <tbody>
    <tr>
      <td>
        <DoNotTranslate>**INSTANCE_NAME**</DoNotTranslate>
      </td>

      <td>
        User defined name to identify data from this instance in New Relic. <DoNotTranslate>**Required**</DoNotTranslate>.
      </td>
    ...
    <tr>
      <td>
        <DoNotTranslate>**PARAMS_CONFIG_FILE**</DoNotTranslate>
      </td>
    ...
    <tr>
      <td>
        <DoNotTranslate>**VARNISH_NAME**</DoNotTranslate>
      </td>

      <td>
        Name used when executing the `varnishd` daemon with a custom `-n` flag. <DoNotTranslate>**Optional**</DoNotTranslate>.
      </td>
...
To find your integration data in New Relic, go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Third-party services**</DoNotTranslate> and select one of the Varnish Cache integration links.
