...
<Callout title="BETA FEATURE">
  This feature is currently in open beta and only applies to the versions starting on [0.0.5](https://github.com/newrelic/newrelic-prometheus-exporters-packages/releases/tag/nri-powerdns-0.0.5) released in October 2021.
</Callout>
...
The integration obtains data by scrapping the PowerDNS API through a Prometheus exporter.
...
The PowerDNS integration collects dimensional Metrics:
