...
```
    ...
    ![StatsD NRQL alert condition query](src/images/statsd-nrql-alert-condition-example.png "statsd-nrql-alert-condition-example.png")

    Now we can create the alert condition with these settings:

    ![StatsD NRQL alert condition creation example](src/images/statsd-nrql-alert-condition-example-2.png "StatsD NRQL alert condition creation example")
