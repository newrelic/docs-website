...
Built with our infrastructure agent, the Apache Hadoop integration gives you a set of pre-built <InlinePopover type="dashboards" /> and <InlinePopover type ="alerts" /> that let you view your most critical performance data, all in one place.
