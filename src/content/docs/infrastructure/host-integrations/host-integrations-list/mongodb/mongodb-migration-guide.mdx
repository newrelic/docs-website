...
* Compatibility with [MongoDB Atlas](https://www.mongodb.com/cloud/atlas/efficiency) (Comming soon).
...
* Improved new [MongoDB quickstart](https://newrelic.com/instant-observability/mongodb).
