...
<Callout title="IMPORTANT!">
  This integration is within an end-of-life process, support will end on 2024 (pending final date). 
  We strongly recommend you to try the [MongoDB integration](/docs/infrastructure/host-integrations/host-integrations-list/mongodb/mongodb-monitoring-integration-new) 

  If you're still using the legacy version. See the [migration](/docs/infrastructure/host-integrations/host-integrations-list/mongodb/mongodb-migration-guide) page for guidance.
</Callout>
...
Our integration is compatible with MongoDB v3 and v4. 
For support to newer versions check the [new MongoDB integration](/docs/infrastructure/host-integrations/host-integrations-list/mongodb/mongodb-monitoring-integration-new/).
