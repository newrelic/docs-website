...
In the MongoDB shell, execute the following commands to create a user with `clusterMonitor` and `read` roles. Note: username, password values must be replaced.
