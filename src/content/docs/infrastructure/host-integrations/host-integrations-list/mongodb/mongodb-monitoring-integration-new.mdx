...
The following dimensional metrics are captured scraping the exporter and linked to the entity <DoNotTranslate>**MONGODB_COLLECTION**</DoNotTranslate>:
...
The following dimensional metrics are captured scraping the exporter and linked to the entity <DoNotTranslate>**MONGODB_DATABASE**</DoNotTranslate>:
