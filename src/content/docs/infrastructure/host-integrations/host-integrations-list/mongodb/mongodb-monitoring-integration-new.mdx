...
Our integration is compatible with MongoDB versions from 4.0 to 7.0, [Percona Server](https://www.percona.com/software/mongodb/percona-server-for-mongodb) and MongoDB Atlas M10 or higher.
