...
Our Postfix integration helps you construct a complete picture of your mail server's performance. Our Postfix integration makes use of our infrastructure monitoring agent, and gives you a pre-built dashboard with your most important Postfix app metrics (like email delivery process, mail queue, and message overview). 
