...
<CollapserGroup>
  ...
  <Collapser
    id="linux-install"
    title="VMs or on-premises hosts"
  >
   Pick your install option, complete those steps, and then return here for more instructions on configuring your integration. 
