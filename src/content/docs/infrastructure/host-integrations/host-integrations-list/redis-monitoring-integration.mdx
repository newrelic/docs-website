...
<tr>
  <td>**PORT**</td>
  <td>Port where Redis server is listening.</td>
  <td>6379</td>
...
<tr>
  <td>**USE_TLS**</td>
  <td>Use TLS when communicating with the Redis server.</td>
  <td>false</td>
  <td style={{ 'text-align': 'center' }}>M/I</td>
</tr>
...
<tr>
  <td>**KEYS**</td>
  <td>List of the keys for retrieving their lengths.</td>
  <td>N/A</td>
...
<tr>
  <td>**KEYS_LIMIT**</td>
  <td>Max number of keys to retrieve their lengths.</td>
  <td>30</td>
  <td style={{ 'text-align': 'center' }}>M</td>
</tr>
...
<tr>
  <td>**RENAMED_COMMANDS**</td>
  <td>Map default Redis commands to their renamed form.</td>
  <td>N/A</td>
  <td style={{ 'text-align': 'center' }}>M/I</td>
</tr>
