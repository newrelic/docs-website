...
If you have services that run on <DNT>Docker/DNT> containers in Amazon ECS, and are [supported](#requirements), you can enable those integrations via our ECS integration. This reports data from your monitored services, from the host, and from the containers.
