...
If you have services that run on Docker containers in Amazon ECS, and those services are supported by our [core on-host integrations](/docs/infrastructure/host-integrations/installation/install-infrastructure-host-integrations) (Cassandra, Redis, MySQL, and more), you can enable those integrations via our ECS integration. This will report data from your monitored services, from the host, and from the containers.
