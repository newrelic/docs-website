...
<Callout variant="tip">
**Correlate APM with Elasticsearch** To establish a direct relationship between your APM Application and your Elasticsearch cluster, ensure you include the resource attribute `es.cluster.name="your-cluster-name"` in your APM metrics. This enables cross-service visibility and faster troubleshooting within New Relic.
</Callout>
...
If you encounter issues during installation or don't see data in New Relic, see our comprehensive [troubleshooting guide](/docs/infrastructure/host-integrations/host-integrations-list/elasticsearch-otel/troubleshooting) for step-by-step solutions to common problems.
