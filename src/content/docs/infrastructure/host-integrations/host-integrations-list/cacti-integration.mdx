...
Integrating Cacti with New Relic provides you with a user-friendly, graphical representation of your RRD data, all within a unified platform on New Relic.
...
<figcaption>
After setting up the Cacti integration with New Relic, see your data in a dashboard. 
</figcaption>
...
Your application will begin sending metrics to [one.newrelic.com](https://one.newrelic.com) in a couple of minutes.
    </Step>
    <Step>
## Find your data 
