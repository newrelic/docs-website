...
To use the Cacti integration, you need to first [install the infrastructure agent](/docs/infrastructure/install-infrastructure-agent/get-started/install-infrastructure-agent-new-relic/) on the same host. The infrastructure agent monitors the host itself, while the Cacti integration extends your monitoring with data specific to your Druid clusters.
    </Step>
    <Step>
...
2. Add the following snippet to the `logging.yml` file. Replace `file` with your Cacti log filepath if needed:
