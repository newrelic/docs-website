...
1. Go to **[one.newrelic.com > + Integration & Agents](https://one.newrelic.com/marketplace7)  > GitHub integration**.
2. On the **Integration setup** screen:
    ...
    4. *(Optional)* Click **On-demand sync** to manually sync the data.
        ...
        <Callout variant="tip" title="tip">
            ...
            You can manually synchronize the data once every 4 hours. The **On-demand sync** button remains disabled if sync has occurred within the previous 12 hours.
...
3. On the **GitHub integration** screen:

    1. Click **Go to Teams** to view the imported teams information on [Teams](/docs/service-architecture-intelligence/teams/teams).
    2. Click **Go to Repositories** to view the imported repositories on the [Repository Catalog](/docs/service-architecture-intelligence/catalogs/repositoryCatalog).
