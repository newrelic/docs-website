...
Easily onboard users and teams to enhance your New Relic Catalog's visibility. This integration simplifies user and team onboarding, managing roles, and mapping entity ownership. This significantly reduces the setup configuration, time, and effort. Leverage this seamless connection to boost Catalog visibility and employ Scorecards for performance assessment against defined standards. For more information, refer [New Relic Catalog](https://docs-preview.newrelic.com/docs/catalogs/). {Question to SME: Where this information be available? Will it be on Teams or somewhere else?}
...
## Catalog Details [#service-catalog-details]
...
The following results are retrieved from GitHub: 
