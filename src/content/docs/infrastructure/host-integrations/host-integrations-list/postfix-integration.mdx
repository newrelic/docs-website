...
<CollapserGroup>
  ...
  >
   ...
   2. Extract the downloaded file.
    ...
    ```
   3. Navigate to pflogsumm folder and copy pflogsumm.pl file to below path.
    ```shell
...
2. Update the file `postfix-flex-config.yml` with these configurations:
  ...
  integrations:
    ...
    #Read the number of messages passed through email delivery process.  
