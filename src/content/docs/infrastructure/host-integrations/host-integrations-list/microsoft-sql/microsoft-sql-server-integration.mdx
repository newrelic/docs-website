...
To find your integration data, go to **[one.newrelic.com](https://one.newrelic.com) > Infrastructure > Third-party services** and select one of the Microsoft SQL Server integration links.
