...
* Create [dashboards](/docs/query-your-data/explore-query-data/dashboards/introduction-dashboards) to track your Windows services.
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Dashboards**: You can use the Microsoft Windows services integration metrics to create tables for your services.
</figcaption>
