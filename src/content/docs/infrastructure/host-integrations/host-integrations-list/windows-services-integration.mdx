...
This feature is currently in open beta and only applies to the versions starting on [0.3.0](https://github.com/newrelic/nri-winservices/releases/tag/v0.3.0-beta) released in September 2021 Check [our post](https://discuss.newrelic.com/t/introducing-new-open-beta-version-of-the-windows-services-integration/160162) for more details.
</Callout>
    ...
    integrations:
      - name: com.newrelic.winservices
        ...
        config:
          ...
          # Example services below are for some of the common services running on a Windows machine.
          #
