...
1. **For Standalone Database if you use Oracle DB 12c or higher,** 
   
   Use `ALTER SESSION` to access the database and manage users and user properties. Do not run this query if your Oracle DB version is lower than 12c. 
