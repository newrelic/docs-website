...
Our AMD GPU integration lets you monitor the status of your AMD GPUs. This integration uses our infrastructure agent with the Flex integration, which lets us access AMD's SMI utility.
...
<figcaption>
  After you set up our AMD GPU integration, we give you a dashboard for your GPU metrics.
</figcaption>
...
<Steps>
  ...
  <Step>
    ...
    Before configuring the Flex integration, you need to install AMD's SMI utility:
  ...
  <Step>
    ...
    2. Click on <DNT>**Create a dashboard**</DNT>.
