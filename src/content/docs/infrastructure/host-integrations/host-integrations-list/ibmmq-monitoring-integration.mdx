...
<CollapserGroup>
  ...
  <Collapser
    id="basic-config"
    title="Connecting to two different "
  >
  ...
  >
    ...
    The `ccdt` file should have a `certificateLabel` in the `transmissionSecurity` section selecting a certificate present in the keystore and trusted by the server.
