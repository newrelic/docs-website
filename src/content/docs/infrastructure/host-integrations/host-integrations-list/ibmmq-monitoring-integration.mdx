...
import ibmmq-dashboard from 'images/ibmmq-dashboard.png'

import linux from 'images/linux.png'

Our IBM MQ [integration](/docs/integrations/host-integrations/getting-started/introduction-host-integrations)
collects and sends dimensional metrics from [IBM MQ](https://www.ibm.com/products/mq). You can view this [metric data](#metrics) in pre-built dashboards, create alert policies, and create custom queries and charts.
...
* Ensure [queue monitoring]( https://www.ibm.com/docs/en/capmp/8.1.4?topic=monitoring-enabling-queue-statistics-queue-manager-mq) is enabled on MQ.
