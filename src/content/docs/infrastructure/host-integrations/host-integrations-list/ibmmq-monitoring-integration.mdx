...
3. Copy the sample configuration file by running:
  ...
  ```
4. Edit the `ibmmq-config.yml` configuration file with your favorite editor. Check out some [configuration file examples](#examples).
...
<table>
  ...
  <tr>
    <td>
      <DoNotTranslate>**queue_manager**</DoNotTranslate>
    </td>
    <td>
      Queue Manager name
    </td>
  ...
  <tr>
    <td>
      <DoNotTranslate>**channel**</DoNotTranslate>
    </td>
    <td>
  ...
  <tr>
    <td>
      <DoNotTranslate>**monitored_queues**</DoNotTranslate>
    </td>
    <td>
  ...
  <tr>
    <td>
      <DoNotTranslate>**monitored_channels**</DoNotTranslate>
    </td>
    <td>
  ...
  <tr>
    <td>
      <DoNotTranslate>**monitored_topics**</DoNotTranslate>
    </td>
    <td>
  ...
  <tr>
    <td>
      <DoNotTranslate>**monitored_subscriptions**</DoNotTranslate>
    </td>
    <td>
  ...
  <tr>
    <td>
      <DoNotTranslate>**mqsslkeyr**</DoNotTranslate>
    </td>
    <td>
  ...
  <tr>
    <td>
      <DoNotTranslate>**ccdt_url**</DoNotTranslate>
    </td>
    <td>
      Needed to configure TLS
  ...
  <tr>
    <td>
      <DoNotTranslate>**home**</DoNotTranslate>
    </td>
    <td>
  ...
  <tr>
    <td>
      <DoNotTranslate>**ld_library_path**</DoNotTranslate>
    </td>
    <td>
