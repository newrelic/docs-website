...
<CollapserGroup>
  ...
  >
    ...
    5. **Optional**: If you're interested in monitoring Tomcat, use this sample metrics file:
       ...
       ```
    6. Edit the `jmx-config.yml` file as described in the [configuration settings](/docs/infrastructure/host-integrations/host-integrations-list/jmx-monitoring-configuration/).
  ...
  >
    ...
    3. In the Integrations directory, `C:\Program Files\New Relic\newrelic-infra\integrations.d\`, create a copy of the sample configuration file by running:
       ...
       ```
    4. Edit the `jmx-config.yml` configuration file using the [configuration settings](/docs/infrastructure/host-integrations/host-integrations-list/jmx-monitoring-configuration/).
