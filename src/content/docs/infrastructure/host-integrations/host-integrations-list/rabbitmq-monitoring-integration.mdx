...
<tr>
  <td>**PORT**</td>
  <td>Port number of the RabbitMQ management plugin.</td>
  <td>15672</td>
...
<tr>
  <td>**USERNAME**</td>
  <td>User that is connecting to RabbitMQ management plugin.</td>
  <td>N/A</td>
  <td style={{ 'text-align': 'center' }}>M/I</td>
</tr>
...
<tr>
  <td>**PASSWORD**</td>
  <td>Password to connect to RabbitMQ management plugin.</td>
  <td>N/A</td>
  <td style={{ 'text-align': 'center' }}>M/I</td>
</tr>
...
<tr>
  <td>**MANAGEMENT_PATH_PREFIX**</td>
  <td>RabbitMQ Management Prefix.</td>
  <td>N/A</td>
  <td style={{ 'text-align': 'center' }}>M/I</td>
</tr>
...
<tr>
  <td>**USE_SSL**</td>
  <td>Option to connect using SSL.</td>
  <td>false</td>
  <td style={{ 'text-align': 'center' }}>M/I</td>
</tr>
...
<tr>
  <td>**CA_BUNDLE_DIR**</td>
  <td>Location of SSL certificate on the host.</td>
  <td>N/A</td>
  <td style={{ 'text-align': 'center' }}>M/I</td>
</tr>
...
<tr>
  <td>**NODE_NAME_OVERRIDE**</td>
  <td>Overrides the local node name instead of retrieving it from RabbitMQ.</td>
  <td>N/A</td>
  <td style={{ 'text-align': 'center' }}>M/I</td>
</tr>
...
<tr>
  <td>**CONFIG_PATH**</td>
  <td>Absolute path to the RabbitMQ configuration file.</td>
  <td>N/A</td>
  <td style={{ 'text-align': 'center' }}>M/I</td>
</tr>
...
<tr>
  <td>**EVENTS**</td>
  <td>Set to `true` to enable Events only collection.</td>
  <td>false</td>
  <td style={{ 'text-align': 'center' }}></td>
</tr>
