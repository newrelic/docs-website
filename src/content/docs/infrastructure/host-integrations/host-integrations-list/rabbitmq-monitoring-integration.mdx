...
<CollapserGroup>
  <Collapser
    ...
    title="Ansible"
  >
  You can get started with our [infrastructure monitoring agent](/docs/infrastructure/infrastructure-monitoring/get-started/get-started-infrastructure-monitoring/) using [configuration management tools](/docs/infrastructure/install-infrastructure-agent/linux-installation/install-configuration-management-tools).
  </Collapser>
