...
* <DNT>**Advanced:**</DNT> Integrations are also available in [tarball format](/docs/infrastructure/host-integrations/installation/install-infrastructure-host-integrations/#tarball) to allow for install outside of a package manager.
