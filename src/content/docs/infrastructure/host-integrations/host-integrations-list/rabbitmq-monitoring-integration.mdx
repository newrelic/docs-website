  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        The node name has to match exactly with the one set in the RabbitMQ `RABBITMQ_NODENAME` environment variable.
        It needs to to match the following structure `node_name@hostname`.
      </td>
