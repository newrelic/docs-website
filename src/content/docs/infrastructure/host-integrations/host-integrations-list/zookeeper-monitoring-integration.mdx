...
---
import infrastructureLighttptdDashboard from 'images/infrastructure_screenshot-full_apache-zookeeper-dashboard.webp'

With our Apache ZooKeeper dashboard, you can track your znode count, Session watch, Client connection and Jvm.  Built with our infrastructure agent and our nri-zookeeper or nri-flex, the Apache ZooKeeper dashboard lets you view critical information all in one place.

<img
    src={dashboardsApacheZooKeeperQuickstart}
