...
## Step 2: Integrate Apache ZooKeeper with New Relic:

 There are two ways to integrate Apache Zookeeper with New Relic:

 1. Use NRI-ZooKeeper for Apache ZooKeeper.
 2. NRI-Flex for Apache ZooKeeper.
