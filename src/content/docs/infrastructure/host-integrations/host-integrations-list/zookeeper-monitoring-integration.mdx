...
Before bringing ZooKeeper data into New Relic, you'll need to follow [the infrastructure agent install steps](/docs/infrastructure/install-infrastructure-agent/get-started/install-infrastructure-agent) for the host containing your Apache ZooKeeper app.
