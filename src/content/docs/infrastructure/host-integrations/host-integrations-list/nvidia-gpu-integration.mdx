...
1. Create a file named `nvidia-smi-gpu-monitoring.yml` in this path (or download from the [git repository](https://github.com/newrelic/nri-flex/blob/master/examples/nvidia-smi-gpu-monitoring.yml)):
