...
## Query your data [#data]

<CollapserGroup>
  <Collapser
    className="freq-link"
    id="database"
    title="`snowflake.database_storage` data"
  >
<table>
  <thead>
    <tr>
    ...
    <tr>
      ...
      <td>
        Provides the average number of bytes of database storage used.					
        </td>
    </tr>

<tr>
      <td>
AVERAGE_FAILSAFE_BYTES															    </td>
      <td>
        BYTES
      </td>
      <td>
        Provides the average number of bytes of Fail-safe storage used.
        </td>
</tr>
<tr>
<td>
...
<Collapser
    className="freq-link"
    id="pipe"
    title="`snowflake.pipe_usage` data"
  >
<table>
  <thead>
    <tr>
    ...
    <tr>
      <td>
        BYTES_INSERTED_AVERAGE							
      </td>
      <td>
        BYTES
      </td>
      <td>
        Provides the average number of bytes loaded during the START_TIME and END_TIME window.				
        </td>
    </tr>

        <tr>
      <td>
BYTES_INSERTED_SUM															           </td>
      <td>
        BYTES
      </td>
      <td>
        Provides the total number of bytes loaded during the START_TIME and END_TIME window.
        </td>
    </tr>
    <tr>
    <td>
        FILES_INSERTED_AVERAGE
    </td>
    <td>
        number
    </td>
    <td>
    Provides the average number of files loaded during the START_TIME and END_TIME window.
    </td>
    </tr>
        <tr>
    <td>
    ...
    <td>
    Provides the total number of files loaded during the START_TIME and END_TIME window.
    </td>
    </tr>
    </tbody>
</table>
...
<Collapser
    className="freq-link"
    id="storage"
    title="`snowflake.storage_usage` data"
  >
<table>
  <thead>
    <tr>
    ...
    <tr>
        ...
        <th>
        Provides the number of bytes owned by (and billed to) this table that are in the Fail-safe state for the table.
        </th>
        <th>
        STAGE_BYTES
        </th>
        ...
        <th>
        Provides the number of bytes of stage storage used.
        </th>
        <th>
        STORAGE_BYTES
        </th>
        ...
        <th>
        Provides the number of bytes of table storage.
        </th>
    </tr>
  </thead>
    <tbody>
