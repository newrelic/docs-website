...
Built with our <InlinePopover type="infrastructure" /> agent, the Snowflake integration gives you a set of pre-built dashboards that let you view your most critical query data, all in one place.
