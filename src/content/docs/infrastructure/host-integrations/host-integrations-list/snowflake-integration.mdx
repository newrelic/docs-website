...
binary](https://github.com/newrelic/newrelic-snowflake-integration/releases) from the link in `releases` section. Place that binary in the cloned repo from step 1.  
    </Collapser>
    <Collapser
    id="step3"
