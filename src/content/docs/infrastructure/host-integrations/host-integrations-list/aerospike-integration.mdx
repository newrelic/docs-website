...
First, find the prometheus exporter application named `nri-aerospike`. Nri-aerospike is available in the apt-get repository. 
...
*  You will see that the **Exporter** is installed in the `/var/db/newrelic-infra/newrelic-integrations/bin` directory
