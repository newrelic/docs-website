...
### Step 2: Install the MySQL agent [#mysql-install]
...
### Step 3: Install the Apache agent [#apache-install]
...
5. Update the wsgi.py and settings.py files `settings.py` `NEW_RELIC_CONFIG_FILE = BASE_DIR / `downloaded_newrelic_file`
