...
1. From [one.newrelic.com](https://one.newrelic.com) click <DNT>**Add data > Infrastructure & OS  > MySQL**</DNT>.
...
1. From [one.newrelic.com](https://one.newrelic.com) click <DNT>**Add data > Infrastructure & OS  > Apache**</DNT>.
...
1. From [one.newrelic.com](https://one.newrelic.com) click <DNT>**Add data > Application monitoring  > Python**</DNT>.
