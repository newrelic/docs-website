...
Our HashiCorp Consul [on-host integration](/docs/integrations/host-integrations/getting-started/introduction-host-integrations) collects and sends inventory and metrics from your Consul datacenter environment to New Relic, where you can see the health of your environment. We collect data on both the datacenter and agent/node levels.   
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        <DoNotTranslate>**TOKEN**</DoNotTranslate>
      </td>
    ...
    <tr>
      <td>
        <DoNotTranslate>**FAN_OUT**</DoNotTranslate>
      </td>
    ...
    <tr>
      <td>
        <DoNotTranslate>**CHECK_LEADERSHIP**</DoNotTranslate>
      </td>
...
Data from this integration can be found by going to: <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > Third-party services > Apache**</DoNotTranslate>. 
