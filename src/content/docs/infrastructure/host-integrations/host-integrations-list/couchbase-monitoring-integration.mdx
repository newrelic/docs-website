...
Our Couchbase [integration](/docs/infrastructure/host-integrations/get-started/introduction-host-integrations) collects and sends inventory and metric data from your Couchbase cluster to the New Relic platform, where you can quickly see the health of your Couchbase environment. We collect data at the cluster, node, query engine, and bucket level so you can trace a problem to its source.
...
Integration data is reported to [integration dashboards](/docs/infrastructure/infrastructure-data/infra-integration-data).
