...
<table>
    ...
    <tbody>
        <tr>
            <td><strong>Tile version</strong></td>
            <td>1.0.1</td>
        </tr>
        <tr>
        ...
        <tr>
            <td><strong>Software component version</strong></td>
            <td>New Relic Nginx Integration Buildpack for VMware Tanzu 1.0.1</td>
        </tr>
        <tr>
            <td><strong>Compatible Ops Manager version(s)</strong></td>
            <td>3.0.x</td>
        </tr>
        <tr>
            <td><strong>Compatible VMware Tanzu Application Service for VMs versions</strong></td>
            <td>5.0.x and 6.0.x</td>
        </tr>
        <tr>
            <td><strong>BOSH stemcell version</strong></td>
            <td>Ubuntu Jammy</td>
        </tr>
        <tr>
            <td><strong>CF Stack</strong></td>
