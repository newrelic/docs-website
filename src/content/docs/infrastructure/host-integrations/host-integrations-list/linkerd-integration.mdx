...
/>
<figcaption>
After setting up our Linkerd integration, we give you a dashboard for your Linkerd metrics. 
</figcaption>
...
4. The Linkerd dashboard should appear. Click on it to install it
