...
import queryAnsibleExample from 'images/queryansibleexample.png'
...
<img
  title="ansibleDashLanding.png"
  alt="ansibleDashLanding.png"
...
Before you can monitor your Tower projects with New Relic, confirm that you've already set up Prometheus to scrape data from Ansible Tower. You can learn more about this process at [Ansible Tower's docs site](https://docs.ansible.com/ansible-tower/latest/html/administration/metrics.html).
...
Our Ansible Tower integration builds atop our Prometheus remote write integration. To view your data in our quickstart dashboard, follow the below steps to integrate Ansible Tower, Prometheus, and the New Relic platform. 
...
Add this script to that same  `prometheus.yml` file: 
...
<Collapser
  ...
  id="nrql"
  title="Step 4. Build NRQL queries to generate more dashboards"
>
With your data ingested and now displaying in your dashboard, you can customize the visualizations based on your team's needs. New Relic dashboards are built and generated with NRQL queries.

To get this dashboard, for example:

<img
  title="queryansibleexample.png"
  alt="queryansibleexample.png"
  src={queryAnsibleExample}
/>
...
Now you can view your data with your new Ansible Tower dashboard. After navigating to New Relic, find the **Dashboards** tile in the top nav. 
...
/>
<figcaption>
**[one.newrelic.com](https://one.newrelic.com)** > Hover to the top nav > Click **Dashboards**: View your new visualizations for Ansible Tower!
</figcaption> 
