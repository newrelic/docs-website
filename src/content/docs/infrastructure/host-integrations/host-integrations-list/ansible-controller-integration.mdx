...
2. Use our configuration template to update the created file named "nri-prometheus-config.yml."

3. Update the fields listed below:
    a. `cluster_name: “YOUR_DESIRED_CLUSTER_NAME”`
    b. `bearer_token_file: “BEARER_TOKEN_FILE_PATH`
    c.  `urls: [“https://YOUR_HOST_IP:443/api/v2/metrics/?format=txt”]`
...
On Linux machines, your log file should be present in:
