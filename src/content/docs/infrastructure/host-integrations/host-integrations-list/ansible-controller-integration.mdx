...
<Collapser
    ...
    >
Once logged into Ansible Automation Platform, navigate to the <DoNotTranslate>**Users**</DoNotTranslate> section, select <DoNotTranslate>**admin**</DoNotTranslate> and then add a <DoNotTranslate>**token**</DoNotTranslate> to the user. Copy the token and save it in your desired path.
