...
Built with our <InlinePopover type="infrastructure" /> agent and our Prometheus OpenMetrics integration, the Ansible Automation Platform integration gives you a set of pre-built dashboards that let you view your most critical query data, all in one place.
...
The New Relic <InlinePopover type="infrastructure" /> agent is the foundation for getting your Ansible Automation Platform data into New Relic. If you haven't already done so, install the agent using one of these options:
