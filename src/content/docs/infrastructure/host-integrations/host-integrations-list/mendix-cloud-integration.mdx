...
1. Return to the <DoNotTranslate>**Environments**</DoNotTranslate> page for your app and <DoNotTranslate>**Deploy**</DoNotTranslate> or <DoNotTranslate>**Transport**</DoNotTranslate> your app into the selected environment.
