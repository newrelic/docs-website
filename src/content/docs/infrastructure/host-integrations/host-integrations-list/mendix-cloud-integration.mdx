...
1. Go to the <DoNotTranslate>**Environment**</DoNotTranslate> page of your app in the <DoNotTranslate>**Developer Portal**</DoNotTranslate>.
2. Click <DoNotTranslate>**Details**</DoNotTranslate> on the environment you wish to monitor with New Relic.
3. Switch to the <DoNotTranslate>**Details**</DoNotTranslate> tab.
...
5. Return to the <DoNotTranslate>**Environments**</DoNotTranslate> page for your app and <DoNotTranslate>**Deploy**</DoNotTranslate> or <DoNotTranslate>**Transport**</DoNotTranslate> your app into the selected environment.
