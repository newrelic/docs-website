...
<Callout variant="important">
  <DoNotTranslate>**Note**</DoNotTranslate>: New Relic logging and application metrics are supported in Mendix 9.7 and above.
</Callout>
...
<Callout variant="important">
  <DoNotTranslate>**Note**</DoNotTranslate>: To start sending data to New Relic, you must redeploy your app and then restart it. Just restarting the app is not sufficient because additional dependencies need to be included.
</Callout>
