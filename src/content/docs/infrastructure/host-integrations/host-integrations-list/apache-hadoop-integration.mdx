...
---
<!-- // import infrastructureApacheHadoopDashboard from 'images/infrastructure_screenshot-crop_apache-hadoop-dashboard.webp' -->
...
To instrument the Lighttpd quickstart and to see metrics and alerts, you can also follow our [Apache Hadoop quickstart page](https://newrelic.com/instant-observability/apache-hadoop) that has an **Install now** button.
