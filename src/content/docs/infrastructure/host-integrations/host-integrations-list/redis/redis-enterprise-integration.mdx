...
2. Log in to your Redis Entprise instance and click on <DoNotTranslate>**Access Control**</DoNotTranslate>.
    <Callout variant="tip">
    We recommend using an internal account, but you can use LDAP if you have LDAP enabled.
    </Callout>
3. Add a new user account with <DoNotTranslate>**Cluster View Permissions**</DoNotTranslate>.
...
1. Go to <DoNotTranslate>**[one.newrelic.com/marketplace](https://one.newrelic.com/marketplace)**</DoNotTranslate>.
2. Click the <DoNotTranslate>**Dashboards**</DoNotTranslate> tab, and in the search field, enter <DoNotTranslate>**Redis Enterprise**</DoNotTranslate>.
    <img
...
3. Click one of the dasboards, and select an account from the dropdown. Then, click <DoNotTranslate>**View dashboard**</DoNotTranslate> to add it to your account.
