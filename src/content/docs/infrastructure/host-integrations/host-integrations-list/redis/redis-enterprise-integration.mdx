...
2. Log in to your Redis Entprise instance and click on <DNT>**Access Control**</DNT>.
   <Callout variant="tip">We recommend using an internal account, but you can use LDAP if you have LDAP enabled.</Callout>
3. Add a new user account with <DNT>**Cluster View Permissions**</DNT>.
...
1. Go to <DNT>**[one.newrelic.com/marketplace](https://one.newrelic.com/marketplace)**</DNT>.
2. Click the <DNT>**Dashboards**</DNT> tab, and in the search field, enter <DNT>**Redis Enterprise**</DNT>.
...
3. Click one of the dasboards, and select an account from the dropdown. Then, click <DNT>**View dashboard**</DNT> to add it to your account.
