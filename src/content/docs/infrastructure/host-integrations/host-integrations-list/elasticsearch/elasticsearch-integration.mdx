...
To install the Elasticsearch monitoring integration, you must run through the following steps:
...
- Windows <ImageSizing width="32px" height="32px">![Kubernetes](./images/windows.png 'Windows')</ImageSizing>
- Linux <ImageSizing width="32px" height="32px">![Kubernetes](./images/linux.png 'Linux')</ImageSizing>
