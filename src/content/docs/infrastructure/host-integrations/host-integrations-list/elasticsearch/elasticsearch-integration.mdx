...
The Elasticsearch integration collects both Metrics and Inventory information. In the table, use the <DoNotTranslate>**Applies to**</DoNotTranslate> column for the settings available to each collection:
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        <DoNotTranslate>**LOCAL_HOSTNAME**</DoNotTranslate>
      </td>
    ...
    <tr>
      <td>
        <DoNotTranslate>**CLUSTER_ENVIRONMENT**</DoNotTranslate>
      </td>
    ...
    <tr>
      <td>
        <DoNotTranslate>**SSL_ALTERNATIVE_HOSTNAME**</DoNotTranslate>
      </td>
    ...
    <tr>
      <td>
        <DoNotTranslate>**COLLECT_INDICES**</DoNotTranslate>
      </td>
    ...
    <tr>
      <td>
        <DoNotTranslate>**COLLECT_PRIMARIES**</DoNotTranslate>
      </td>
    ...
    <tr>
      <td>
        <DoNotTranslate>**INDICES_REGEX**</DoNotTranslate>
      </td>
    ...
    <tr>
      <td>
        <DoNotTranslate>**MASTER_ONLY**</DoNotTranslate>
      </td>
