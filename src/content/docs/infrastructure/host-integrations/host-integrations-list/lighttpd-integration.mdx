...
To instrument the Lighttpd quickstart and to see metrics and alerts, you can also follow our [Lighttpd quickstart page](https://newrelic.com/instant-observability/lighttpd) that has an <DoNotTranslate>**Install now**</DoNotTranslate> button.

Here are some example queries:

<DoNotTranslate>**Example:**</DoNotTranslate> View the captured metrics on the New Relic query builder.
  
```sql
SELECT * FROM LighttpdStatusSample  LIMIT MAX
```

<DoNotTranslate>**Example:**</DoNotTranslate> Check the active connection per server.
...
To instrument the Lighttpd quickstart, install our default dashboards, and to see metrics and alerts, you can also follow our [Lighttpd quickstart page](https://newrelic.com/instant-observability/lighttpd) by clicking on the <DoNotTranslate>**Install now**</DoNotTranslate> button.
