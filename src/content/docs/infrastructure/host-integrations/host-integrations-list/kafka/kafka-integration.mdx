...
5. Optionally, see [Kafka's configuration](/docs/infrastructure/host-integrations/host-integrations-list/kafka/kafka-config).
...
<CollapserGroup>
  ...
  <Collapser
    id="producer"
    title="Producerand consumer monitoring (JMX)"
  >
...
Specific settings related to Kafka are defined using the `env` section of the `kafka-config.yml` configuration file. These settings control the connection to your Brokers, Zookeeper, and JMX as well as other security settings and features. The list of valid settings is described in the next section of this document.

The integration has two modes of operation, which are mutually exclusive, that you can set up with the `CONSUMER_OFFSET` parameter: 
...
<Callout variant="important">
  These modes are are mutually exclusive because consumer offset collection takes a long time to run and has high performance requirements.
</Callout>

The values for these settings can be defined in several ways:

- Adding the value directly in the YAML configuration file, which is the most common way.
...
For more on how to find and use your data, see [Kafka's configuration](/docs/infrastructure/host-integrations/host-integrations-list/kafka/kafka-config).
...
- [`KafkaBrokerSample`](/docs/infrastructure/host-integrations/host-integrations-list/kafka/kafka-config#broker-sample)
- [`KafkaTopicSample`](/docs/infrastructure/host-integrations/host-integrations-list/kafka/kafka-config#topic-sample)
- [`KafkaProducerSample`](/docs/infrastructure/host-integrations/host-integrations-list/kafka/kafka-config#producer-sample)
- [`KafkaConsumerSample`](/docs/infrastructure/host-integrations/host-integrations-list/kafka/kafka-config#consumer-sample)
- [`KafkaOffsetSample`](/docs/infrastructure/host-integrations/host-integrations-list/kafka/kafka-config#offset-sample)
