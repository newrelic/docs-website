...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Collects offset metrics from from consumer groups without any active consumer, it requires CONSUMER_OFFSET set to true.
      </td>
    ...
    <tr>
      ...
      <td>
        Activates emitting an extra metric aggregation for consumerGroup by topic. it requires CONSUMER_OFFSET set to true.
      </td>
