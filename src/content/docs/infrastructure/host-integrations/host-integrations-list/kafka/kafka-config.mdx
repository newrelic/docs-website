---
title: Kafka's integration configuration settings
tags:
  - Integrations
...
This integration is open source software. That means you can [browse its source code](https://github.com/newrelic/nri-kafka) and send improvements or create your own fork and build it.
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        `PLAINTEXT`, `SASL_PLAINTEXT`, `SSL`, and `SASL_SSL`.
...
The Kafka integration collects both Metrics(<strong>M</strong>) and Inventory(<strong>I</strong>) information. Check the <DNT>**Applies To**</DNT> column below to find which settings can be used for each specific collection:
