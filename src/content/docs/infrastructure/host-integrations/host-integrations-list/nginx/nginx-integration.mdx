...
* If NGINX is not running on Kubernetes or Amazon ECS, you must [install the infrastructure agent](/docs/infrastructure/install-infrastructure-agent/get-started/install-infrastructure-agent-new-relic) on a Linux OS host that's running NGINX. Otherwise:
  * If running on <ImageSizing width="32px" height="32px"><img src={kubernetesK8} title="Kubernetes" alt="Kubernetes"/></ImageSizing>Kubernetes, see [these requirements](/docs/monitor-service-running-kubernetes#requirements).
  * If running on <ImageSizing width="32px" height="32px"><img src={ecs} title="ECS" alt="ECS"/></ImageSizing>Amazon ECS, see [these requirements](/docs/integrations/host-integrations/host-integrations-list/monitor-services-running-amazon-ecs).

### Supported operating systems [#supported-os]

* Windows <ImageSizing width="32px" height="32px"><img src={windows} title="Windows" alt="Windows"/></ImageSizing>
* Linux <ImageSizing width="32px" height="32px"><img src={linux} title="Linux" alt="Linux"/></ImageSizing>
* MacOS <ImageSizing width="32px" height="32px"><img src={macos} title="MacOS" alt="MacOS"/></ImageSizing>
...
* If it was enabled via <ImageSizing width="32px" height="32px"><img src={kubernetesK8} title="Kubernetes" alt="Kubernetes"/></ImageSizing>Kubernetes, see [Monitor services running on Kubernetes](/docs/monitor-service-running-kubernetes).
* If it was enabled via <ImageSizing width="32px" height="32px"><img src={ecs} title="ECS" alt="ECS"/></ImageSizing>Amazon ECS, see [Monitor services running on ECS](/docs/integrations/host-integrations/host-integrations-list/monitor-services-running-amazon-ecs).
