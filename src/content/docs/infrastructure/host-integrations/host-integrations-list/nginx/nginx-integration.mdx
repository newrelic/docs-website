...
* If NGINX is not running on Kubernetes or Amazon ECS, you must [install the infrastructure agent](/docs/infrastructure/install-infrastructure-agent/get-started/install-infrastructure-agent-new-relic) on a Linux OS host that's running NGINX. Otherwise:
  * If running on <img style={{ width: '32px', height: '32px'}} title="Kubernetes" alt="Kubernetes" src={kubernetes}/>Kubernetes, see [these requirements](/docs/monitor-service-running-kubernetes#requirements).
  * If running on <img style={{ width: '32px', height: '32px'}} title="ECS" alt="ECS" src={ecs}/>Amazon ECS, see [these requirements](/docs/integrations/host-integrations/host-integrations-list/monitor-services-running-amazon-ecs).

### Supported operating systems [#supported-os]

* Windows <img style={{ width: '32px', height: '32px'}} title="Windows" alt="Windows" src={windows}/>
* Linux <img style={{ width: '32px', height: '32px'}} title="Linux" alt="Linux" src={linux}/>
* MacOS <img style={{ width: '32px', height: '32px'}} title="MacOS" alt="MacOS" src={macos}/>
...
* If it was enabled via <img style={{ width: '32px', height: '32px'}} title="Kubernetes" alt="Kubernetes" src={kubernetes}/>Kubernetes, see [Monitor services running on Kubernetes](/docs/monitor-service-running-kubernetes).
* If it was enabled via <img style={{ width: '32px', height: '32px'}} title="ECS" alt="ECS" src={ecs}/>Amazon ECS, see [Monitor services running on ECS](/docs/integrations/host-integrations/host-integrations-list/monitor-services-running-amazon-ecs).
