...
6. Linux users can now enable automatic NGINX error log parsing and shipment to New Relic with [one simple step.](/docs/logs/forward-logs/forward-your-logs-using-infrastructure-agent#on-host).
