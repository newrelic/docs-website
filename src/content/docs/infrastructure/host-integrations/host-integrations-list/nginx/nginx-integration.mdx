...
5. Optionally, see [NGINX's configuration settings](/docs/infrastructure/host-integrations/host-integrations-list/nginx/nginx-advanced-config).
...
For more on how to find and use your data, see [NGINX's configuration](/docs/infrastructure/host-integrations/host-integrations-list/nginx/nginx-advanced-config).
