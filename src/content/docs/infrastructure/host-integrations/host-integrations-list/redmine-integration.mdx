...
Once installed, confirm that New Relic is ingesting your Redmine data by going to <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capaibilities)**</DoNotTranslate>, then clicking <DoNotTranslate>**Metrics & events**</DoNotTranslate>. Run the following NRQL query to confirm that New Relic is receiving Redmine data:
...
3. Go to <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DoNotTranslate>, then click <DoNotTranslate>**Metrics & events**</DoNotTranslate>. Run the following query to confirm that New Relic is reporting custom metrics:
