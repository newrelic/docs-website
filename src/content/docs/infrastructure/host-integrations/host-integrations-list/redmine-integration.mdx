...
While our Redmine integration isn't built with our <InlinePopover type="infrastructure" /> agent, we recommend installing it if you want performance data about your hosts. You can install the infrastructure agent in two different ways: 
