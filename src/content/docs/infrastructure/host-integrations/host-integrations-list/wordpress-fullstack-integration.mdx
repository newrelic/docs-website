...
* [MySQL data](/docs/infrastructure/host-integrations/host-integrations-list/mysql-config/).
* [PHP data](/docs/apm/agents/php-agent/getting-started/monitor-your-php-app/).
