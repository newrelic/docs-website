...
With our Nextcloud dashboard, you can easily track the number of files in your system, your user accounts, and your database size. Built with our <InlinePopover type="infrastructure" /> agent and Prometheus OpenMetrics integration, the Nextcloud integration gives you a set of default dashboards that let you view your most critical data all in one place. 
