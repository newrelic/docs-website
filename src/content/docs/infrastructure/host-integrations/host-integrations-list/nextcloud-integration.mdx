...
<figcaption>
After setting up the Nextcloud integration with New Relic, your data will display in dashboards like these, right out of the box. 
</figcaption>

## Install the infrastructure agent [#infra]

Before getting Nextcloud data into New Relic, first install our infrastructure agent. This allows New Relic to collect performance metrics, logs, and other Nextcloud-specific data. 
