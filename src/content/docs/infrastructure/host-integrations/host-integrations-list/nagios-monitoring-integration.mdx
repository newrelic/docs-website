...
<table>
  ...
  <tbody>
    <tr>
      <td>
        <DoNotTranslate>**SERVICE_CHECKS_CONFIG**</DoNotTranslate>
      </td>
    ...
    <tr>
      <td>
        <DoNotTranslate>**OUTPUT_TABLE_NAME**</DoNotTranslate>
      </td>
...
To find your integration data go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Third-party services**</DoNotTranslate> and select one of the Nagios integration links.
