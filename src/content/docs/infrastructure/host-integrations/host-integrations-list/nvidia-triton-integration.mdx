...
1. Go to **[one.newrelic.com](https://one.newrelic.com) > + Add data** and type 
**NVIDIA Triton**. 
...
You can find your custom NVIDIA Triton dashboard in the <DoNotTranslate>**Dashboards**</DoNotTranslate> UI. See our [dashboard](/docs/query-your-data/explore-query-data/dashboards/introduction-dashboards) section for more information.
