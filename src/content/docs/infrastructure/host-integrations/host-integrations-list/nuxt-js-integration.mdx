...
translate:
  - jp
  - kr
metaDescription: "The New Relic Nuxt.js integration sends performance metrics and inventory data from your Nuxt.js application to the New Relic platform." 
redirects:
---
