...
- Use secrets management to protect sensitive information, such as passwords, from being exposed in plain text in the configuration file. For more information, see how to use [secrets management](https://docs.newrelic.com/docs/integrations/host-integrations/installation/secrets-management).
