...
The <InlinePopover type="infrastructure" /> agent will capture lines written to standard error and merge them into the [logging stream](/docs/infrastructure/new-relic-infrastructure/troubleshooting/generating-logs-troubleshooting-infrastructure) written by the infrastructure agent itself.
