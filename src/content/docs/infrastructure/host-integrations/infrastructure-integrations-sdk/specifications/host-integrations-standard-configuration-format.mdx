...
<CollapserGroup>
  ...
  >
    ...
    <Callout variant="important">
      New Relic recommends passing `env` keys in capital letters, as per the example below, for compatibility with all <InlinePopover type="infrastructure" /> agent versions since 1.8.0.<br/>
