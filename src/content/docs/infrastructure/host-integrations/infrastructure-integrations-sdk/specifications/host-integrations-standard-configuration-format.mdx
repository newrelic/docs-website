...
<CollapserGroup>
  ...
  >
    ...
    <DNT>**Pass configuration file directly**</DNT>
    ...
    <DNT>**Pass configuration through `config` section**</DNT>
    ...
    <DNT>**Pass secrets and discovery through `config` section**</DNT>
    ...
    * There may be a variable number of <DNT>Docker/DNT> containers labeled with `service=foo`, which are accessible from the agent host via a discoverable public IP and Port.
