...
<CollapserGroup>
  ...
  >
    ...
    <Callout variant="important">
      To ensure accurate reporting of metrics, especially rate metrics, set the interval to 5 minutes or less. Longer intervals may lead to inaccuracies or missing data.
    </Callout>
