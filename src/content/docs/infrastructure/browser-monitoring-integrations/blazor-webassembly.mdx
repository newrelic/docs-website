...
With our Blazor WebAssembly dashboard, you can easily track query performance and all your logins, monitor your Snowflake warehouses, and get a total overview of your storage system's health, including information about potential security incidents. 
