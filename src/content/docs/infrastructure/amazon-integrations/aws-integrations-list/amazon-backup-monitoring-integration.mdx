...
You can set up alerts to receive a notification if there are any changes. For example, you can set up an alert to notify relevant parties of critical or fatal errors.
