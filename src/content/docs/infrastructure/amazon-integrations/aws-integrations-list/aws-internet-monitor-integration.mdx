...
Metrics data from this integration is attached to the `Metric` data type. To see your data: go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Metrics and events**</DoNotTranslate> and filter by `aws.internetmonitor`.
