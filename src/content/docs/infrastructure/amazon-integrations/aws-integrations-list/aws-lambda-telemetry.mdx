...
5. Go to **Configuration**, select **Environment variables** and add `Key: NEW_RELIC_LICENSE_KEY  Value: <var>YOUR_LICENSE_KEY</var>`. Note: `Key: NEW_RELIC_ACCOUNT_ID` is an optional parameter.
