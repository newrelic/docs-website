...
4. Copy and paste `arn:aws:lambda:us-west-2:533243300146:layer:python-telemetry-api-extension:<version>` in the field, then click **Add**.
...
Trace data are displayed in **Traces** tab. To see traces sent by the extension, search for `python-telemetry-api-extension'.
