...
[New Relic infrastructure integrations](/docs/infrastructure/integrations-getting-started/getting-started/introduction-infrastructure-integrations) include an integration for AWS Elastic Transcoder, sending its metrics data to New Relic.
...
Once the integration is set up, you can find your metric data by going to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Metrics and events** and filter by `aws.elastictranscoder`.

## Metric data [#metrics]

This New Relic infrastructure integration collects the following Amazon Elastic Transcoder data:
