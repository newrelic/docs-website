...
<Callout variant="info">
  You have two options for Security Lake monitoring setup; you can consolidate multiple regions to avoide repeating steps, or you can set it up on a per-region basis. 
...
To set up this integration, you should first make sure the following steps are completed for Security Lake.
...
Here's an overview of the steps to get started: 
...
## Create Security Lake subscriber [#create-subscriber]
...
5. Select **Create**.
6. From the Subscriber details page, copy your **AWS role ID** and **Subscription endpoint** ARN's. You will need them for the next step.
...
To find your logs on New Relic, go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Logs** and set **Attributes** to `product.name`, and then choose the log source you want.
