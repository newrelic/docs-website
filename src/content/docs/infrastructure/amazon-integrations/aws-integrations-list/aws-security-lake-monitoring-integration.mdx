...
6. Install our dedicated [Amazon Security Lake log forwarder](/docs/logs/forward-logs/aws-lambda-sending-security-logs-s3/). 
Note you will need to provide the following parameters to set the forwarder lambda function.
