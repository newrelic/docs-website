...
2. Complete the prerequisites mentioned under `data access` subscriber type as mentioned in [Security Lake subscriber guide](https://docs.aws.amazon.com/security-lake/latest/userguide/subscriber-data-access.html#prereqs-creating-subscriber)
