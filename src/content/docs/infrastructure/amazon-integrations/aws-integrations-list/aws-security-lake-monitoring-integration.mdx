...
now include an integration for AWS Security Lake, sending security log data to New Relic. 
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            amount of bytes being sent or recieved
          </td>
        ...
        <tr>
          ...
          <td>
            amount of packets being sent or recieved
          </td>
