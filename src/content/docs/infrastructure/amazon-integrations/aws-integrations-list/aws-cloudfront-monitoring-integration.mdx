...
If you're using Lambda@Edge to customize content that CloudFront delivers so to execute Lambda functions in AWS locations closer to your clients, you can enable the <DNT>**Collect Lambda@Edge data**</DNT> filter in order to get Lambda execution location metadata.

## Find and use data [#find-data]

To find your integration data, go to <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS**</DNT> and select one of the CloudFront integration links.
