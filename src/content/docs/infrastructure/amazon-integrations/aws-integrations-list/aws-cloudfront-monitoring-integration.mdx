...
If you're using Lambda@Edge to customize content that CloudFront delivers so to execute Lambda functions in AWS locations closer to your clients, you can enable the <DoNotTranslate>**Collect Lambda@Edge data**</DoNotTranslate> filter in order to get Lambda execution location metadata.

## Find and use data [#find-data]

To find your integration data, go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS**</DoNotTranslate> and select one of the CloudFront integration links.
