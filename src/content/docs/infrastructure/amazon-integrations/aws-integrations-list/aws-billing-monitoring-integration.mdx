...
To find your integration data in the infrastructure UI, go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS** and select one of the AWS Billing integration links.
