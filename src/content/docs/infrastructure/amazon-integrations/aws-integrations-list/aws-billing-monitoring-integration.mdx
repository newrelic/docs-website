...
To find your integration data in Infrastructure, go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS** and select one of the AWS Billing integration links.
  ...
  >
    ...
    * Forecasted expenses
      ...
      **NRQL example**: For a table of different budgets with actual spend, forecast, limits, and usage vs. monetary cost, run the following NRQL query:
      ...
      <Callout variant="tip">
        The `providerAccountId` is your cloud service account ID in New Relic. You can find it in **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS**, next to **Provider account**.
      </Callout>
  </Collapser>
