...
5. For **Additional Arguments**, paste the code featured below. Be sure to replace `YOUR_NEWRELIC_LICENSE_KEY` with your [New Relic API Key](/docs/apis/intro-apis/new-relic-api-keys). 
...
```
Sample variables can also be specified in **Additional Arguments** as shown below. If not specified, they will take the [default values](https://github.com/newrelic/infrastructure-agent/blob/master/assets/examples/infrastructure/newrelic-infra-template.yml.example).
