...
Quickly integrate your AWS instances with New Relic's infrastructure agent through our integration for AWS System Manager Distributor. This document explains the integrations features, how to activate it, and what data can be reported.
