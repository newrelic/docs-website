...
---
Quickly install New Relic's infrastructure agent on your AWS instances through our integration for AWS System Manager Distributor. This document explains the integrations features, how to activate it, and what data can be reported.
