...
Install New Relic's <InlinePopover type="infrastructure" /> agent on your AWS instances in a single click through our integration for AWS System Manager Distributor. This document explains the integrations features, how to activate it, and what data can be reported.
