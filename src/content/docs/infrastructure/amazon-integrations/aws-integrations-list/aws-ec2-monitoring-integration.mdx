...
<table>
  ...
  <tbody>
    <tr>
      <td>
        [<DoNotTranslate>**System**</DoNotTranslate> page](/docs/infrastructure/infrastructure-ui-pages/infra-hosts-ui-page#system)
      </td>
    ...
    <tr>
      <td>
        [<DoNotTranslate>**Processes**</DoNotTranslate> page](/docs/infrastructure/new-relic-infrastructure/infrastructure-ui-pages/infrastructure-processes-page-inspect-process-performance)
      </td>
    ...
    <tr>
      <td>
        [<DoNotTranslate>**Network**</DoNotTranslate> page](/docs/infrastructure/new-relic-infrastructure/infrastructure-ui-pages/infrastructure-network-page-measure-compare-capacity)
      </td>
    ...
    <tr>
      <td>
        [<DoNotTranslate>**Storage**</DoNotTranslate> page](/docs/infrastructure/new-relic-infrastructure/infrastructure-ui-pages/infrastructure-storage-page-evaluate-disk-usage-efficiency)
      </td>
    ...
    <tr>
      <td>
        [<DoNotTranslate>**Integrations**</DoNotTranslate> page](/docs/integrations/new-relic-integrations/getting-started/infrastructure-integration-dashboards-charts)
      </td>
