...
Keeping the legacy metadata format allows you to access the tags with both legacy and non-legacy formats. Turning legacy format off means you can only use the new format.
