...
You can choose to keep the legacy metadata format. Keeping the legacy metadata format will make it so the tags and metadata related to your EC2 metrics can be accessed using the formats:
* provider.ec2Tag_\<tagName\>
* ec2Tag_\<tagName\>

Keeping this setting turned off will allow you to save ingest data. New EC2 integrations will have this setting turned off by default.
