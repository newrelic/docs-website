...
Starting October 26, 2021, EC2 instances that start being monitored by New Relic have only the following metadata [tag](/docs/new-relic-one/use-new-relic-one/core-concepts/use-tags-help-organize-find-your-data) formats: 
