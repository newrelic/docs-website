...
<DoNotTranslate>**We also offers a more in-depth Lambda monitoring feature**</DoNotTranslate>. For more information, see [New Relic Serverless monitoring for AWS Lambda](/docs/serverless-function-monitoring/aws-lambda-monitoring/get-started/introduction-new-relic-monitoring-aws-lambda).
...
To find your integration data, go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS**</DoNotTranslate> and select one of the Lambda integration links.
