...
redirects:
  ...
  - /docs/serverless-function-monitoring/aws-lambda-monitoring/get-started/compatibility-requirements-aws-lambda-monitoring/å
...
<DNT>**We also offers a more in-depth Lambda monitoring feature**</DNT>. For more information, see [New Relic Serverless monitoring for AWS Lambda](/docs/serverless-function-monitoring/aws-lambda-monitoring/get-started/introduction-new-relic-monitoring-aws-lambda).
