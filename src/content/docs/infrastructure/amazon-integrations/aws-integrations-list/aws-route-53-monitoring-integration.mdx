...
To find your integration data, go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS**</DoNotTranslate> and select one of the Route 53 integration links.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The status of the health check endpoint that CloudWatch is checking. <DoNotTranslate>**1**</DoNotTranslate> indicates healthy, and <DoNotTranslate>**0**</DoNotTranslate> indicates unhealthy. You can view `HealthCheckStatus` only across all regions; data is not available for a selected region.
      </td>
    </tr>
