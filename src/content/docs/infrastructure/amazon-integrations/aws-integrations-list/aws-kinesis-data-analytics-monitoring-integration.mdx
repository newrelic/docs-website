...
To find your integration data in our infrastructure UI, go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS**</DoNotTranslate> and select an integration.
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <DoNotTranslate>**Known issue**</DoNotTranslate>: as this metric has a longer lag than the rest, in some cases, it's not shown
      </td>
    </tr>
  </tbody>
</table>
