...
1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure**, and then click **AWS**.
...
If you're using a custom IAM policy when connecting your AWS account with the <InlinePopover type="infrastructure" /> agent, your custom policy will need the following permissions for the AWS X-Ray integration to work:
