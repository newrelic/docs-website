...
1. Go to <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure**</DNT>, and then click <DNT>**AWS**</DNT>.
2. Click <DNT>**Manage Services**</DNT> to select the AWS integration you want to activate.
3. Check the checkbox next to <DNT>**AWS X-Ray**</DNT>.
