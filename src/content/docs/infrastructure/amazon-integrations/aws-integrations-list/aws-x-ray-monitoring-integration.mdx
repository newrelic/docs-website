...
1. Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure**</DoNotTranslate>, and then click <DoNotTranslate>**AWS**</DoNotTranslate>.
2. Click <DoNotTranslate>**Manage Services**</DoNotTranslate> to select the AWS integration you want to activate.
3. Check the checkbox next to <DoNotTranslate>**AWS X-Ray**</DoNotTranslate>.
