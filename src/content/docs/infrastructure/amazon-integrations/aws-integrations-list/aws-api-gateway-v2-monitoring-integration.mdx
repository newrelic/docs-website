...
To find your integration's metrics, go to <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Metrics & Events**</DoNotTranslate> and filter by `aws.apigateway`.
