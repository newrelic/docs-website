...
* Set alert conditions on your AWS IoT integration data directly from the New Relic <DoNotTranslate>**Integrations**</DoNotTranslate> page.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS > IoT**</DoNotTranslate>.
      </td>
    </tr>
