...
<Callout variant="important">
  ...
  Currently, AWS CloudWatch metrics are supported only for AWS Glue Spark ETL jobs and not for AWS Glue Python Shell jobs. An active feature request has been submitted to the AWS Glue team to include support for Python Shell jobs.
</Callout>
