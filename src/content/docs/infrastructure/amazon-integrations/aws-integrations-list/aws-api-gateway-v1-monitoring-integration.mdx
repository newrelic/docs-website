...
<Callout variant="tip">
  API Gateway V1 exclusively facilitates API polling, while metrics for [API Gateway V2](/docs/infrastructure/amazon-integrations/aws-integrations-list/aws-api-gateway-v2-monitoring-integration) are streamed through CloudWatch Metric Streams.
</Callout>
