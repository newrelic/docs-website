---
title: Amazon API Gateway V1 monitoring integration
tags:
  - Integrations
  - Amazon integrations
...
redirects:
  - /docs/integrations/amazon-integrations/aws-integrations-list/aws-api-gateway-v1-monitoring-integration
  - /docs/aws-apigateway-integration
  - /docs/infrastructure/amazon-integrations/amazon-integrations/aws-api-gateway-v1-monitoring-integration
...
<Callout variant="tip">
  API Gateway V1 exclusively facilitates API polling, while metrics for [API Gateway V2](/docs/infrastructure/amazon-integrations/aws-integrations-list/aws-api-gateway-v1-monitoring-integration) are streamed through CloudWatch Metric Streams.
</Callout>
