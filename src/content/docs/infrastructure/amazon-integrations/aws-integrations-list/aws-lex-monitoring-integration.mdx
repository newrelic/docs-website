...
To find this integration's data, go to <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS**</DNT>, and select one of the Amazon Lex integration links.

You can [query and explore your data](/docs/using-new-relic/data/understand-data/query-new-relic-data) using the <DNT>**Metric**</DNT> table and `namespace='AWS/Lex'`.
