...
* For logs: Go to <DoNotTranslate>**[one.newrelic.com ](https://one.newrelic.com) > Logs > Attributes > AWS**</DoNotTranslate> and select <DoNotTranslate>**logGroup**</DoNotTranslate> and/or <DoNotTranslate>**logStream**</DoNotTranslate>
* For metrics: Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Metrics and events**</DoNotTranslate> and filter by `aws.apprunner`
