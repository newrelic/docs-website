...
## Features
Collect and send telemetry data to New Relic from your apps and services running on Amazon App Runner containers using our integration. Monitor your services, query incoming data, and build dashboards to observe everything at a glance. 
