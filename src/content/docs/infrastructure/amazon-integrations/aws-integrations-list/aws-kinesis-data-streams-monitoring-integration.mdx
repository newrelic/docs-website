...
Shard data: To collect shard data, enable <DoNotTranslate>**Collect shards data**</DoNotTranslate> in the integration's configuration options in the UI.
...
To find your integration data, go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS**</DoNotTranslate> and select one of the Kinesis Data Streams integration links.
