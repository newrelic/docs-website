...
To view the RDS Dashboard, go to <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS**</DNT> and scroll-down to RDS and select the RDS Dashboard link.
