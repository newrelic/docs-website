...
Data from this integration is attached to the `Metric` data type. To find this data in the UI: Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Metrics and events**</DoNotTranslate> and filter for `aws.transcribe`.
