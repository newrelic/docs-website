...
Data from this integration is attached to the `Metric` data type. To find this data in the UI: Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Metrics and events** and filter for `aws.transcribe`.
