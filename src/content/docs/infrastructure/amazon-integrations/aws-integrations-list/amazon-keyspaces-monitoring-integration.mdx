...
To find your integration's metrics, go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Metrics and events** and filter by `aws.cassandra`.
...
All imported data has one dimension: `TableName`
...
Below imported data has no dimension
