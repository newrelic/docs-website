...
To enable this integration, follow our instructions to [connect AWS services to New Relic](/docs/infrastructure/amazon-integrations/connect/aws-metric-stream-setup/). Once enabled, you can find your integration's metrics at <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Metrics and events**</DoNotTranslate> and filter by `aws.dms`.
