...
Our AWS Network Address Translation (NAT) Gateway integration reports data from your NAT Gateway service to your New Relic account using AWS CloudWatch Metric Streams. 
