...
The Amazon VPC integration generates a feed of [configuration changes](#inventory) that occur in your VPC. VPC data is available in pre-built dashboards, and you can create [custom queries and charts](/docs/infrastructure/integrations-getting-started/getting-started/use-integration-data-new-relic-insights). You can also create alert conditions to notify you about changes in the VPC.
