...
New Relic infrastructure integrations now include an integration for AWS Network Firewall, letting you send metric data from AWS Network Firewall to New Relic. This document explains the integration's features, how to activate it, and what data is available for reporting.
