...
<DoNotTranslate>**Recommended:**</DoNotTranslate> The main way to update the log ingestion lambda function is to follow [standard procedures](/docs/serverless-function-monitoring/aws-lambda-monitoring/get-started/update-lambda-monitoring) to update the function using the New Relic CLI.
