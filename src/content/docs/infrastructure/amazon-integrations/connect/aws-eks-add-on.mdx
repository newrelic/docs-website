...
To start collecting metrics and ship to New Relic, use the following sample Custom Resource Definition (CRD)
    ...
    newrelic-infrastructure:
        ...
        privileged: true
    ```
Where ** spec.global.cluster ** : Name of your EKS Cluster **spec.global.licensekey**: Your New Relic License Key that you generated at step-4 in the Prerequisites section above.