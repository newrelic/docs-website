...
1. Select metric integration type:
    * <DNT>**[CloudWatch Metric Streams](/install/aws-cloudwatch/)**</DNT> is the recommended method to create a real-time stream of metrics to New Relic.
        * <DNT>**CloudTrail**</DNT>Health
        * <DNT>**CloudTrail**</DNT>Trusted Advisor
        * <DNT>**CloudTrail**</DNT>X-Ray
...
1. To get the integrated AWS services with your account, Log in to your [New Relic](https://one.newrelic.com/) account and navigate to <DNT>**Infrastructure > AWS**</DNT>.
2. To modify the existing AWS integration, click <DNT>**Edit account**</DNT>.
3. To enable auto-discovery, select the <DNT>**Discover Configurations**</DNT> checkbox and save the change.
</Step>
<Step>
### Add permissions
To enable auto-discovery, you need to add the `cloudformation:StartResourceScan` permission to your AWS account.
1.  to enable the <DNT>**Discover Configurations**</DNT> feature, click <DNT>**Add permissions**</DNT>.
2. On the AWS console, acknowledge the CloudFormation stack creation and click <DNT>**Create stack**</DNT>.
3. To enable auto-discovery, On the confirmation screen of New Relic One, click <DNT>**Save changes**</DNT>.
</Step>
<Step>
### Enable auto-discovery
To enable auto-discovery, On the confirmation screen of New Relic One, click <DNT>**Save changes**</DNT>.
</Step>
