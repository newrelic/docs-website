...
* You have [CloudWatch cross-account observability](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Unified-Cross-Account.html) properly set up through the [Setting up cross account access](#setting-up-aws-cross-account-access) section
...
1. Go to the AWS Management Console of the monitoring account and get the **Monitoring accounts sink ARN**:
...
2. Go to the AWS Management Console of the source account and [link the monitoring account](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Unified-Cross-Account-Setup.html) for **Metrics** resources:
  - Go to *Cloudwatch -> Settings*
  - In *Source account configuration* section, click on **Configure**
  - Select **Metrics**
