...
1. In the monitoring account, write down (copy) the **Monitoring accounts sink ARN**:
...
2. In the source account:
	- In *CloudWatch -> Settings*, [link the monitoring account](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Unified-Cross-Account-Setup.html) for **Metrics** resources:
		- Go to *Cloudwatch ->  Settings*
...
3. Back in the monitoring account:
	- Go to *CloudWatch -> Settings*
