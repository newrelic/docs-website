...
Check out our doc to [install the New Relic CloudWatch Metric Streams integration](/docs/infrastructure/amazon-integrations/connect/aws-metric-stream-setup) or to [migrate your API polling integrations to CloudWatch Metric Streams](). 
