...
## Provision the New Relic Kubernetes operator EKS add-on via the AWS console [#provision-k8s]
...
## Provision the New Relic EKS add-on via the AWS command line interface (CLI) [#provision-cli]
...
## Configure the New Relic Kubernetes operator [#configure-k8s-operator]
