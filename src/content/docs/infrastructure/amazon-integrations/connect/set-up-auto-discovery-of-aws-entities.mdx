...
<Callout title="preview">
  ...
  Having opted into the preview, you gain access to this capability at no cost.
</Callout>
...
1. Log in to your [New Relic](https://one.newrelic.com/) account and navigate to <DNT>**Infrastructure > AWS**</DNT>.
2. To check the <DNT>Auto-Discovery</DNT> enablement status of your AWS accounts, click <DNT>**Manage AWS Integrations**</DNT>.
3. From the account list, click <DNT>**Install**</DNT> for the AWS account in which you want to enable it.
