...
<CollapserGroup>
    <Collapser
     ...
     <Collapser
      ...
      If you disable Auto-discovery, you lose access to entities it identifies and their configurations. AWS Reliability scorecards provide inaccurate scores, and the infrastructure map no longer displays relationships discovered by Auto-discovery.
      </Callout>
