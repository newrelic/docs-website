...
<Callout variant="tip">
By default, New Relic scans all regions enabled in your account once in a day. You can [update the scan frequency and regions](#select-region-and-frequency) after the stack is created, by managing the <DNT>Auto-Discovery</DNT> settings in New Relic One.
</Callout>
...
<Step>
### Enable Auto-Discovery [#enable-auto-discovery]
To enable <DNT>Auto-Discovery</DNT>, on the confirmation screen of New Relic One, click <DNT>**Save**</DNT>.
</Step>
