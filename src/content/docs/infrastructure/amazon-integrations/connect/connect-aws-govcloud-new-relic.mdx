...
import infrastructureAwsAddUser from 'images/infrastructure_screenshot-crop_aws-add-user.png'

import infrastructureAwsSetPermissions from 'images/infrastructure_screenshot-crop_aws-set-permissions.png'

import infrastructureAwsCreateUser from 'images/infrastructure_screenshot-crop_aws-create-user.png'
...
2. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > GovCloud**.
