...
import awsAddUser from 'images/AWS-add-user.png'

import awsSetPermissions from 'images/AWS-set-permissions.png'

import awsCreateUser from 'images/AWS-create-user.png'
