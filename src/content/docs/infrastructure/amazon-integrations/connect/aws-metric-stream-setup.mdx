...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Enable and configure AWS Config to track resource changes. Disabling this will lead to an incomplete monitoring and poor New Relic experience.
      </td>
...
Like with custom tags, New Relic also pulls metadata information from relevant AWS services in order to decorate AWS CloudWatch metrics with enriched metadata collected from AWS Services APIs. This metadata is accessible in New Relic as additional dimensions on the metrics provided by AWS CloudWatch.
  ...
  <Callout variant="important">
This is an optional capability that's complementary to the CloudWatch Metric Streams integration. However, it is necessary to have a full New Relic experience and not enabling it will lead to incomplete service discovery and monitorization.
  </Callout>
