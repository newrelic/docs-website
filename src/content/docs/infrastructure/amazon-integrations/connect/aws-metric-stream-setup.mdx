...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        The [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) associated with the account you wish to export metrics to.
      </td>
...
* Ensure the following settings are defined:
  * New Relic configuration (Destination Settings)
    ...
    * API key: Enter your [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key)
