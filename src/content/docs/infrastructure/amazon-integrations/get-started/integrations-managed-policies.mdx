...
In order to use [infrastructure integrations](/docs/infrastructure/integrations), you need to grant New Relic permission to read the relevant data from your account. Amazon Web Services (AWS) uses managed policies to grant these permissions.
...
1. [Add the permissions for <DNT>**all**</DNT> integrations](#all-permissions).
