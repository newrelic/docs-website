...
To start receiving Amazon data with [New Relic AWS integrations](/docs/infrastructure/amazon-integrations/getting-started/introduction-aws-integrations), connect your Amazon account to New Relic. If you do not have one already, [create a New Relic account](https://newrelic.com/signup). It's free, forever.
...
For API Polling integrations, if you do not see any tags in the **Add filter** menu of the **[Filter sets](/docs/scopes-organize-your-infrastructure#create)** sidebar within a few minutes, delete the integration and try again:
