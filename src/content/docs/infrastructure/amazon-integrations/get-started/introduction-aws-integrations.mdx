...
If you're currently using the API Polling integration for all other integrations, we recommend you [migrate from API polling to Amazon CloudWatch Metric Streams integration]().
