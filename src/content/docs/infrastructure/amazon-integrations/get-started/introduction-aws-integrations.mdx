...
See [Connect AWS polling integrations](/docs/infrastructure/amazon-integrations/connect/connect-aws-new-relic-infrastructure-monitoring/) to start receiving Amazon data with New Relic's AWS integrations.
