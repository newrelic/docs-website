...
## Monitor AWS with Amazon CloudWatch Metric Streams [#monitor-aws]
...
* Our CloudWatch Metric Streams integration provides the best data about your AWS stack, but if you use [integrations not supported by CloudWatch Metric Streams](/docs/infrastructure/amazon-integrations/connect/connect-aws-new-relic-infrastructure-monitoring/#integrations-not-replaced-streams), you may need to use our legacy API polling solution.
* If you're currently using API polling for supported integrations, we recommend you [migrate your data to Amazon CloudWatch Metric Streams](/docs/infrastructure/amazon-integrations/connect/cloudwatch-metric-streams/aws-metric-stream/#migrating-from-poll-integrations).
