...
To view your AWS data: Go to <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS**</DNT>. For any of the AWS integrations listed:

* For active streams, select the <DNT>**Explore your data**</DNT> link.

  OR
* For other integrations, browse the available dashboard or click on the <DNT>**Explore Data**</DNT> link.
