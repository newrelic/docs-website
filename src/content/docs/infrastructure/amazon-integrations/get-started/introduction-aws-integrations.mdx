...
To view your AWS data: Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS**</DoNotTranslate>. For any of the AWS integrations listed:

* For active streams, select the <DoNotTranslate>**Explore your data**</DoNotTranslate> link.

  OR
* For other integrations, browse the available dashboard or click on the <DoNotTranslate>**Explore Data**</DoNotTranslate> link.

You can view and reuse NRQL queries both in the pre-configured <InlinePopover type="dashboards" /> and in the <DoNotTranslate>**Events explorer**</DoNotTranslate> dashboards. This allows you to tailor queries to your specific needs.
