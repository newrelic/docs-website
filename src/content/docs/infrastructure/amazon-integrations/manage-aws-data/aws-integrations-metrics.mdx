...
Once you're collecting AWS data, you can set up alert conditions or query your data in the New Relic platform. This doc describes how we store AWS dimensional metrics so you can locate AWS namespace entities and create alerts and queries about the data that matters to you. This doc then provides you with example queries and alerts to get you started monitoring your AWS environment. 
