...
<CollapserGroup>
  ...
  >
    ...
    export JSON_FILE="<my_grafana_dashboard.json>"
    export TRANSLATOR_ENDPOINT="<US/EU Translation endpoint>" # (see API endpoints section above)
  ...
  >
    ...
    export JSON_FILE="<my_grafana_dashboard.json>"
    export TRANSLATOR_ENDPOINT="<US/EU Translation endpoint>" # (see API endpoints section above)
    export NERDGRAPH_ENDPOINT="<US/EU Nerdgraph endpoint>" # (see API endpoints section above)
