...
Reminders:
_ Slightly more complex setup.
_ No support for High Availability replicas. \* The Kubernetes operator is not available for enhanced operations automation.
...
![View of a remote write dashboard screen after integration. ](src/images/Prometheus-remote-write-dashboard.png 'Prometheus Remote Write Monitoring dashboard')

<figcaption>Prometheus remote write dashboard</figcaption>
...
![View of an OpenMetrics dashboard screen after integration. ](src/images/OpenMetrics-Kube-for-Stitched-Path.png 'OpenMetrics data view')

<figcaption>Kubernetes OpenMetrics dashboard</figcaption>
