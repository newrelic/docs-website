...
The shard identification (name of the `StatefulSet Pod`) is added as a `prometheus_server` label to all metrics and you can use it to understand what Prometheus instance is scraping that target.
