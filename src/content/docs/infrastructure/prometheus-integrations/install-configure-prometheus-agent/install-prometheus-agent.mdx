...
2. To ensure the integration has been configured correctly, go to <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com) > All capabilities > Query your data**</DoNotTranslate>, and run this NRQL query to see if data has been reported:
