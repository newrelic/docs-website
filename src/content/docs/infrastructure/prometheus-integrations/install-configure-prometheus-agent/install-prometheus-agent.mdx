...
You can install the  Prometheus Agent either as part of the Kubernetes integration or as standalone solution.
...
<Callout variant="tip">
  ...
  Please note, you will need to enable the prometheus agent by setting up `newrelic-prometheus-agent.enabled=true`
</Callout>
