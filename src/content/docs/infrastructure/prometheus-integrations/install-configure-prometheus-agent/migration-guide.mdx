...
- Prometheus Counter metrics <DNT>**without**</DNT> the name suffix `total`, `count`, `sum`, or `bucket` will be converted as <DNT>**Gauge**</DNT>.
- Prometheus Gauge metrics <DNT>**with**</DNT> the name suffix `total`, `count`, `sum`, or `bucket` will be converted as <DNT>**Counter**</DNT>.
