...
<Callout variant="tip">
  Read the full list of labels added by the Prometheus agent, [here](https://docs.newrelic.com/docs/infrastructure/prometheus-integrations/install-configure-prometheus-agent/default-metric-labels-and-metric-attributes/#metric-labels).
</Callout>
