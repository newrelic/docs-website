...
All API calls require a [user API key](/docs/apis/get-started/intro-apis/types-new-relic-api-keys#user-api-key). Include this key in the `api-key` header of your request.
...
<CollapserGroup>
  ...
  >
    ...
    export TRANSLATOR_ENDPOINT="<Regional Translation endpoint>" # (see API endpoints section above)
  ...
  >
    ...
    export JSON_FILE="my_grafana_dashboard.json"
    export TRANSLATOR_ENDPOINT="<Regional Translation endpoint>" # (see API endpoints section above)
    export NERDGRAPH_ENDPOINT="<Regional Nerdgraph endpoint>"
