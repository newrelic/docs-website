...
This API makes use of New Relic's PromQL translation logic to translate your queries, to see a list of supported PromQL features and functions, see [PromQL features support](/docs/infrastructure/prometheus-integrations/view-query-data/supported-promql-features.mdx).
...
<CollapserGroup>
  ...
  >
    ...
    export TRANSLATOR_ENDPOINT="US/EU Reigional endpoint"
  ...
  >
    ...
    <Callout variant="tip">
      For more information on how to use the NerdGraph and to find your rigional endpoint, see [Introduction New Relic Nerdgraph](docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph).
    </Callout>
    ...
    export JSON_FILE="my_grafana_dashboard.json"
    export TRANSLATOR_ENDPOINT="US/EU Reigional endpoint"
    export NERDGRAPH_ENDPOINT="US/EU Reigional Nerdgraph endpoint"
