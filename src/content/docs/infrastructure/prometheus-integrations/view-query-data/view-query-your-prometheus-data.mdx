...
To view the NRQL query results for your Prometheus integration's data: Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Query your data**. For more information, see our [query builder documentation](/docs/chart-builder/use-chart-builder/get-started/introduction-chart-builder).
