...
<Callout variant="tip">
  To run PromQL-style queries in [New Relic](/docs/new-relic-one/use-new-relic-one/get-started/introduction-new-relic-one), use the [PromQL translator in the query builder](src/content/docs/infrastructure/prometheus-integrations/view-query-data/view-query-your-prometheus-data#view-ui). 
</Callout>
