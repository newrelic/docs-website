...
<table>
  ...
  <tbody>
    <tr>
      <td>
        <DoNotTranslate>**Search for attributes:**</DoNotTranslate>
    ...
    <tr>
      <td>
        <DoNotTranslate>**Find attribute's value:**</DoNotTranslate>
    ...
    <tr>
      <td>
        <DoNotTranslate>**Visualize the attribute's value:**</DoNotTranslate>
...
<CollapserGroup>
  ...
  >
    <DoNotTranslate>**1. Start your query.**</DoNotTranslate>
    ...
    <figcaption>
      <DoNotTranslate>**PromQL-style example:**</DoNotTranslate> To filter the data, run this PromQL-style query: container_memory_usage_bytes&#x7B;id="/".
    </figcaption>
  </Collapser>
  ...
  >
    <DoNotTranslate>**1. Query available metrics.**</DoNotTranslate>
    ...
    <DoNotTranslate>**2. Find unique attributes.**</DoNotTranslate>
    ...
    <DoNotTranslate>**3. Aggregate and chart the metrics.**</DoNotTranslate>
    ...
    <figcaption>
      <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Query your data**</DoNotTranslate>: This example shows the data you see after running FROM Metric SELECT keyset() WHERE metricName = 'container_memory_usage_bytes'.
    </figcaption>
    ...
    <figcaption>
      <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Query your data**</DoNotTranslate>: This example shows the data you see after running FROM Metric SELECT latest(container_memory_usage_bytes) FACET id.
    </figcaption>

    <DoNotTranslate>**5. Add the selected ID to the query.**</DoNotTranslate>
    ...
    <figcaption>
      <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Query your data**</DoNotTranslate>: This example shows the data displayed after running `From Metric select latest(container_memory_usage_bytes) where id = "/" timeseries`.
    </figcaption>
  </Collapser>
</CollapserGroup>
