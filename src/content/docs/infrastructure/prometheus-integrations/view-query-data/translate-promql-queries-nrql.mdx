...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        <DNT>**Find attribute's value:**</DNT>
    ...
    <tr>
      <td>
        <DNT>**Visualize the attribute's value:**</DNT>
...
<CollapserGroup>
  ...
  >
    ...
    <DNT>**2. Filter the query results.**</DNT>
    ...
    <figcaption>
      <DNT>**PromQL-style example:**</DNT> To filter the data, run this PromQL-style query: container_memory_usage_bytes&#x7B;id="/".
    </figcaption>
  </Collapser>
  ...
  >
    <DNT>**1. Query available metrics.**</DNT>
    ...
    <DNT>**2. Find unique attributes.**</DNT>
    ...
    <DNT>**3. Aggregate and chart the metrics.**</DNT>
    ...
    <DNT>**5. Add the selected ID to the query.**</DNT>
