...
<Callout variant="tip">
  To run PromQL-style queries in [New Relic](/docs/new-relic-one/use-new-relic-one/get-started/introduction-new-relic-one), go to the [query builder advanced PromQL-style mode](/docs/infrastructure/prometheus-integrations/view-query-data/view-query-your-prometheus-data/#build-query).
</Callout>
