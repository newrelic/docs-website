...
import nrqlExampleSrc4 from './images/NRQL-example-4.png';

import nrqlExampleSrc5 from './images/NRQL-example-5.png';
...
<CollapserGroup>
  ...
  >
    ...
    **2. Filter the query results.**
    ...
    <img src={promqlImgSrc} style={{ width: '100%' }} />
  ...
  >
    ...
    **3. Aggregate and chart the metrics.**
    ...
    <img src={nrqlExampleSrc} style={{width: '100%'}} />
    ...
    **4. View metrics by ID.**
    ...
    <img src={nrqlExampleSrc4} style={{width: '100%'}} />
    ...
    **5. Add the selected ID to the query.**
    ...
    <img src={nrqlExampleSrc5} style={{width: '100%'}} />
