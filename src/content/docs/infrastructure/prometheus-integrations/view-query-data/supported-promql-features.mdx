...
* We inspect data up to one minute old when servicing instant queries. If your scrape interval is greater than 1 minute, some queries may result in <DNT>**No data found**</DNT>. Avoid this by sending data at least once per minute.
