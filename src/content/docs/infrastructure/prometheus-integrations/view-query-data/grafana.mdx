...
This API uses New Relic PromQL translation logic to translate your queries. To see a list of supported PromQL features and functions, see [PromQL features support guide](/docs/infrastructure/prometheus-integrations/view-query-data/supported-promql-features).
