...
Follow the troubleshooting tips from [Jenkins documentation](https://plugins.jenkins.io/prometheus/ and https://www.jenkins.io/doc/book/troubleshooting/) to make sure that metrics are configured as expected on your cluster.
