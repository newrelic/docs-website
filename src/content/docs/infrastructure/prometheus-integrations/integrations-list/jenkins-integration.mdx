...
Use the OpenTelemetry plugin in New Relic to monitor:
...
1. Follow the [Jenkins documentation](https://plugins.jenkins.io/prometheus/) for Prometheus to discover the metrics endpoints.
...
4. Install the [Jenkins quickstart](https://newrelic.com/instant-observability/jenkins) to access built-in dashboards and alerts. 
