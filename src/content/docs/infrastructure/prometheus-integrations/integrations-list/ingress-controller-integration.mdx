...
4. Install the [Ingress controller quickstart](https://newrelic.com/instant-observability/nginx-ingress-controller) to access built-in dashboards and alerts. 
