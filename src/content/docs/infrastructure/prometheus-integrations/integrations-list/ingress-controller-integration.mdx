...
1. Follow the [Ingress controller documentation](https://kubernetes.github.io/ingress-nginx/user-guide/monitoring/#prometheus-and-grafana-installation-using-pod-annotations) to add the required pod annotations for Prometheus to discover the metrics endpoints.
...
4. Install the [Ingress controller quickstart](https://newrelic.com/instant-observability/nginx-ingress-controller) to access built-in dashboards and [alerts](/docs/alerts-applied-intelligence/new-relic-alerts/learn-alerts/introduction-alerts/). 
