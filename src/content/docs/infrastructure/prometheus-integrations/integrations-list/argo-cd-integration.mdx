...
1. Follow the [Argo CD documentation](https://argo-cd.readthedocs.io/en/stable/operator-manual/metrics/#prometheus-operator) to add the required pod annotations for Prometheus to discover the metrics endpoints.
