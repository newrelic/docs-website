...
Use New Relic to display the performance and availability of the ArgoCD platform within Kubernetes.
...
### Step 1: Follow ArgoCD documentation
...
Install the [Argo CD quickstart](https://newrelic.com/instant-observability/argocd-quickstart) to access built-in dashboards and [alerts](https://docs.newrelic.com/docs/alerts-applied-intelligence/new-relic-alerts/learn-alerts/introduction-alerts/).
