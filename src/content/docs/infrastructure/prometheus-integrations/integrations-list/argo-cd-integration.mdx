...
Use New Relic to check the performance and availability of the ArgoCD platform within Kubernetes and monitor:
...
4. Install the quickstart and see alerts
  ...
  * Install the [Argo CD quickstart](https://newrelic.com/instant-observability/argocd-quickstart) to access built-in dashboards and [alerts](/docs/alerts-applied-intelligence/new-relic-alerts/learn-alerts/introduction-alerts/).
