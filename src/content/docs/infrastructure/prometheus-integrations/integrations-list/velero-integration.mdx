...
Use New Relic to view a dashboard based on Prometheus metrics which helps you understand the Velero of your k8s cluster. With New Relic you can monitor:
...
4. Install the [Velero quickstart](https://newrelic.com/instant-observability/velero-prometheus) to access built-in dashboards and and [alerts](/docs/alerts-applied-intelligence/new-relic-alerts/learn-alerts/introduction-alerts/).
