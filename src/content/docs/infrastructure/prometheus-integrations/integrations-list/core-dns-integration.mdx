...
If this is the case make sure your pod or endpoint can be identifed with one of the following labels "app.kubernetes.io/name", "app.newrelic.io/name", "k8s-app" containing the string "coredns" or "kube-dns"
</Callout>
...
<Callout title="Important!">
  ...
  Some charts of the dashboard include queries with conditions that requires yourpod or endpoint to be identifed with one of the following labels "app.kubernetes.io/name", "app.newrelic.io/name", "k8s-app" containing the string "coredns" or "kube-dns"
