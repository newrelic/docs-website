...
4. Install the quickstart and see alerts
  ...
  Install the [Envoy quickstart](https://newrelic.com/instant-observability/Envoy-quickstart) to access built-in dashboards and [alerts](/docs/alerts-applied-intelligence/new-relic-alerts/learn-alerts/introduction-alerts/).
