...
1. Follow the [Envoy documentation](https://www.envoyproxy.io/docs/envoy/latest/start/install) to install pre-built Docker images and then check out the [quick start guide](https://www.envoyproxy.io/docs/envoy/latest/start/quick-start/index.html#start-quick-start) to get your Envoy proxy up and running.
...
4. Install the [Envoy quickstart](https://newrelic.com/instant-observability/Envoy-quickstart) to access built-in dashboards and [alerts](/docs/alerts-applied-intelligence/new-relic-alerts/learn-alerts/introduction-alerts/).
