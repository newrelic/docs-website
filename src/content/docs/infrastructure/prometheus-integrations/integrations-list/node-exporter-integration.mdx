...
1. Execute the following:
    ...
    ```
3. Set the scraper to run in the background with the keyboard commands `CONTROL + z` and `bg`. In production environments, you'd want to set this up as a service (for example, with `systemd`). 
2. See your data in the New Relic UI by going to **<DNT>[one.newrelic.com](https://one.newrelic.com/)</DNT> &gt; Infrastructure &gt; Hosts**. 