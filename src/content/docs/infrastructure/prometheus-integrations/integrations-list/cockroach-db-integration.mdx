...
### Step 1: Follow CockroachDB documentation

Follow the [CockroachDB documentation](https://www.cockroachlabs.com/docs/v22.1/monitor-cockroachdb-with-prometheus.html) to add the required pod annotations for Prometheus to discover the metrics endpoints.
...
Install the [CockroachDB quickstart](https://newrelic.com/instant-observability/) to access built-in dashboards and [alerts](https://docs.newrelic.com/docs/alerts-applied-intelligence/new-relic-alerts/learn-alerts/introduction-alerts/).
