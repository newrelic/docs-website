...
1. Follow the [CockroachDB documentation](https://www.cockroachlabs.com/docs/v22.1/monitor-cockroachdb-with-prometheus.html) to add the required pod annotations for Prometheus to discover the metrics endpoints.
...
4. Install the [CockroachDB quickstart](https://newrelic.com/instant-observability/) to access built-in dashboards and [alerts](/docs/alerts-applied-intelligence/new-relic-alerts/learn-alerts/introduction-alerts/).
