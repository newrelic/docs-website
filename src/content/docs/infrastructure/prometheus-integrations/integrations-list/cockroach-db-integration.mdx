...
1. Follow CockroachDB documentation
...
4. Install the quickstart and see alerts
  ...
  * Install the [CockroachDB quickstart](https://newrelic.com/instant-observability/) to access built-in dashboards and [alerts](/docs/alerts-applied-intelligence/new-relic-alerts/learn-alerts/introduction-alerts/).
