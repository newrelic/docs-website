...
1. Follow Traefik documentation

  Follow the [Traefik documentation](https://doc.traefik.io/traefik/getting-started/quick-start-with-kubernetes/) to install and setup Traefik proxy on Kubernetes.
...
4. Install the quickstart and see alerts
  ...
  * Install the [Traefik quickstart](https://newrelic.com/instant-observability/traefik) to access built-in dashboards and alerts.
