...
1. Follow the [Cilium documentation](https://docs.cilium.io/en/stable/operations/metrics/) to add the required configuration along with an example deployment for Prometheus to discover the metrics endpoints.
