...
Use New Relic to view a dashboard based on Prometheus metrics. It helps you understand the Argo CD infrastructure of your k8s cluster. With New Relic you can monitor: 
