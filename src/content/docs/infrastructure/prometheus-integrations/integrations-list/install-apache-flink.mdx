...
Once you've installed the [Apache Flink quickstart](https://newrelic.com/instant-observability/redpanda), you can see your critical Apache Flink data in New Relic. To find your dashboard in New Relic: Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Dashboards**, then select **Apache Flink**. 
