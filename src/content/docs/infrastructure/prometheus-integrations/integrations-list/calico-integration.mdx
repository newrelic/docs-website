...
<Callout title="Important!">
  ...
  Some charts of the dashboard include queries with conditions that require you rpod or endpoint to be identifed with one of the following labels "app.kubernetes.io/name", "app.newrelic.io/name", "k8s-app" containing the string "calico"
