...
4. Install the quickstart and see alerts
  ...
  * Install the [Calico quickstart](https://newrelic.com/instant-observability/calico-newrelic) to access built-in dashboards and and [alerts](/docs/alerts-applied-intelligence/new-relic-alerts/learn-alerts/introduction-alerts/).
