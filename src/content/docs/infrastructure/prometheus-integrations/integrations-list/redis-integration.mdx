...
Follow the [Redis documentation](https://docs.gitlab.com/ee/administration/monitoring/prometheus/) for Prometheus to discover the metrics endpoints.
...
Install the [Redis quickstart](https://newrelic.com/instant-observability/gitlab-quickstart) to access built-in dashboards and alerts. 
...
The different sets of metrics exposed by this integration are defined in the [Redis documentation](https://docs.gitlab.com/ee/administration/monitoring/prometheus/gitlab_metrics.html).
...
Follow the troubleshooting tips from [Redis documentation](https://docs.gitlab.com/ee/user/clusters/agent/troubleshooting.html) to make sure that metrics are configured as expected on your cluster.
