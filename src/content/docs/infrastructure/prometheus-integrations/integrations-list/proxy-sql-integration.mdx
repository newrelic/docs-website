...
1. Follow ProxySQL documentation

  Follow the [ProxySQL documentation](https://proxysql.com/documentation/prometheus-exporter/) for Prometheus to discover the metrics endpoints.
...
4. Install the quickstart and see alerts
  ...
  * Install the [ProxySQL quickstart](https://newrelic.com/instant-observability/ProxySQL-quickstart) to access built-in dashboards and alerts. 
