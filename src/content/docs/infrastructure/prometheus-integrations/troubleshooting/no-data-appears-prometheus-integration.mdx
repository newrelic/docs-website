...
<CollapserGroup>
  <Collapser
    id="docker"
    title={<><img src={osDocker} title="Docker icon" alt="Docker icon"/> Docker troubleshooting</>}
  >
  ...
  <Collapser
    id="kubernetes"
    title={<><img src={osk8} title="img-integration-k8s@2x.png" alt="kubernetes icon"/> Kubernetes troubleshooting</>}
  >
    If you are having problems with the integration:
