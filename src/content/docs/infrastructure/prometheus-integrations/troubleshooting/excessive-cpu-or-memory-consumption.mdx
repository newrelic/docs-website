...
You have installed the [Prometheus OpenMetrics integration](/docs/integrations/prometheus-integrations/install-configure-openmetrics/install-update-or-uninstall-your-prometheus-openmetrics-integration) for <DNT>Docker/DNT> or Kubernetes, and it consumes too much memory or CPU.
