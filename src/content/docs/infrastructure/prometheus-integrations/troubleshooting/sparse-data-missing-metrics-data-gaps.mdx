...
tags:
  ...
  - Troubleshooting
metaDescription: Troubleshooting tips for the Prometheus OpenMetrics integration for <DNT>Docker/DNT> or Kubernetes if no data appears in New Relic's UI.
redirects:
...
You have installed the [Prometheus OpenMetrics integration](/docs/integrations/prometheus-integrations/install-configure-openmetrics/install-update-or-uninstall-your-prometheus-openmetrics-integration) for <DNT>Docker/DNT> or Kubernetes, but you notice sparse data, missing metrics, and data gaps in New Relic's UI.
