...
tags:
  ...
  - Troubleshooting
metaDescription: How to get scraper metrics for your Prometheus OpenMetrics integration with New Relic for <DNT>Docker/DNT> or Kubernetes.
redirects:
...
You want to get scraper metrics for your Prometheus OpenMetrics integration with New Relic for <DNT>Docker/DNT> or Kubernetes.

<img title="Docker icon" alt="Docker icon" src={osDocker}/> <DNT>**Docker:**</DNT> If you configure the `http://localhost:8080/metrics` endpoint, the integration will also scrape its own metrics.

<img title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png" src={osk8}/> <DNT>**Kubernetes:**</DNT> By default, the scraper will also scrape its own metrics.

## Solution

To learn more about what is happening inside the scraper, use the following metrics for your <DNT>Docker/DNT> or Kubernetes integration with New Relic:
