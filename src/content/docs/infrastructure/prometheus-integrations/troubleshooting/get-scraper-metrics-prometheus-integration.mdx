...
<img title="Docker icon" alt="Docker icon" src={osDocker}/> <DoNotTranslate>**Docker:**</DoNotTranslate> If you configure the `http://localhost:8080/metrics` endpoint, the integration will also scrape its own metrics.

<img title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png" src={osk8}/> <DoNotTranslate>**Kubernetes:**</DoNotTranslate> By default, the scraper will also scrape its own metrics.
