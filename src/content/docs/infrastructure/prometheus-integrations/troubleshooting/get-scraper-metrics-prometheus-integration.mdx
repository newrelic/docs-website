...
![Docker icon](src/images/docker-logo-crop.png 'Docker icon') **Docker:** If you configure the `http://localhost:8080/metrics` endpoint, the integration will also scrape its own metrics.

![img-integration-k8s@2x.png](src/images/img-integration-k8.png 'img-integration-k8s@2x.png') **Kubernetes:** By default, the scraper will also scrape its own metrics.
