...
tags:
  ...
  - Troubleshooting
metaDescription: What to do if your Prometheus OpenMetrics integration for <DNT>Docker/DNT> or Kubernetes exceeded allowable metric rate limits for your New Relic account.
redirects:
...
Your Prometheus OpenMetrics integration for <DNT>Docker/DNT> or Kubernetes exceeded allowable metric rate limits. You want to see more details about why the [`NrIntegrationError` event](/docs/telemetry-data-platform/manage-data/nrintegrationerror) has been applied to your New Relic account.
