---
title: Compare Prometheus remote write data's sent and billed bytes
tags:
...
## Understand data compression and billing [#data-compression]
...
Finally, as the data is transformed and enrichments are performed, the difference between the remote write uncompressed bytes and the [`bytecountestimate()`](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/usage-queries-alerts/#byte-count-estimate) can be seen below. The `bytecountestimate()` listed is a measure of byte count of the final state of the data before being stored.
...
## Use NRQL to query your data count [#nrql-queries]

Check the following [NRQL queries](/docs/query-your-data/nrql-new-relic-query-language/get-started/introduction-nrql-new-relics-query-language/) to gather byte count information.
