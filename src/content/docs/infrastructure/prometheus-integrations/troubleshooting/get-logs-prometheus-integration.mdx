...
<img title="Docker icon" alt="Docker icon" src={osDocker}/> <DoNotTranslate>**Docker**</DoNotTranslate>
...
<img title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png" src={osk8}/> <DoNotTranslate>**Kubernetes**</DoNotTranslate>
