...
<img title="Docker icon" alt="Docker icon" src={dockerLogoCrop}/> **Docker:**
...
<img title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png" src={imgIntegrationK8}/> **Kubernetes:**
