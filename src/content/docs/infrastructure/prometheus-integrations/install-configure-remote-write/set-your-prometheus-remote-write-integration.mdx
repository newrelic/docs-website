...
1. Enter a name for the Prometheus server to be connected and your `remote_write` URL. <DoNotTranslate>**Important:**</DoNotTranslate> The name you enter for the server will create an attribute on your data. It will also be the name that identifies which Prometheus server is sending data to New Relic.
2. Add a new `remote_write` URL to your Prometheus YML file. Add this information under `global_config` in the file, at the same indentation level as the `global` section.
    ...
    <DoNotTranslate>**Prometheus v2.26 and newer**</DoNotTranslate>
    ...
    <DoNotTranslate>**Prometheus older than v2.26**</DoNotTranslate>
    ...
    <DoNotTranslate>**Any Prometheus version**</DoNotTranslate>
    ...
    <DoNotTranslate>**European Union accounts:**</DoNotTranslate> If you're connecting from the EU, use the following URL:
