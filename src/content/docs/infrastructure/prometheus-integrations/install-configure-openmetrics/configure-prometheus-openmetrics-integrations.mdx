      ...
      <tbody>
        ...
        <tr id="scrape-enabled-label">
          <td>
            ...
            <img style={{ width: '40px', height: '35px'}} title="img-integration-k8.png" alt="img-integration-k8.png" src={imgIntegrationK8S402X}/> **Kubernetes**
          </td>
...
<img style={{ width: '40px', height: '35px'}} title="Docker icon" alt="Docker icon" src={dockerLogoCrop}/> **Docker:**
...
<img style={{ width: '40px', height: '35px'}} title="Docker icon" alt="Docker icon" src={dockerLogoCrop}/> **Docker:** To run the integration with the previous configuration
file:
