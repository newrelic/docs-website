      ...
      <tbody>
        ...
        <tr id="scrape-enabled-label">
          <td>
            ...
            <ImageSizing width="40px" height="35px"><img src={imgIntegrationK8} title="img-integration-k8.png" alt="img-integration-k8.png"/></ImageSizing> **Kubernetes**
          </td>
...
<ImageSizing width="40px" height="35px"><img src={dockerLogoCrop} title="Docker icon" alt="Docker icon"/></ImageSizing> **Docker:**
...
<ImageSizing width="40px" height="35px"><img src={dockerLogoCrop} title="Docker icon" alt="Docker icon"/></ImageSizing> **Docker:** To run the integration with the previous configuration
file:
