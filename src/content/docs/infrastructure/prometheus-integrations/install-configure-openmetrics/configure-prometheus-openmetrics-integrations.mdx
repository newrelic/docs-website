      ...
      <tbody>
        ...
        <tr id="scrape-enabled-label">
          <td>
            ...
            <img style={{ width: '30px', height: '25px'}} class="inline" title="img-integration-k8.png" alt="img-integration-k8.png" src={osk8}/> **Kubernetes**
          </td>
...
<img style={{ width: '30px', height: '25px'}} class="inline" title="Docker icon" alt="Docker icon" src={osDocker}/> **Docker**
...
<img style={{ width: '30px', height: '25px'}} class="inline" title="Docker icon" alt="Docker icon" src={osDocker}/> **Docker:** To run the integration with the previous configuration
file:
