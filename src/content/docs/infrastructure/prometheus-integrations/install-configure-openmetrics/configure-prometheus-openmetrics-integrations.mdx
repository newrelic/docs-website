...
<img style={{ width: '40px', height: '35px'}} class="inline" title="Docker icon" alt="Docker icon" src={dockerLogoCrop}/> **Docker:**
...
<img style={{ width: '40px', height: '35px'}} class="inline" title="Docker icon" alt="Docker icon" src={dockerLogoCrop}/> **Docker:** To run the integration with the previous configuration
file:
