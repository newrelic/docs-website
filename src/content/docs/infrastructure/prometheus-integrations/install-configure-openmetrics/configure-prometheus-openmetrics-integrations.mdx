      ...
      <tbody>
        ...
        <tr id="scrape-enabled-label">
          <td>
            ...
            <img style={{ width: '40px', height: '35px'}} class="inline" title="img-integration-k8.png" alt="img-integration-k8.png" src={osk8}/> **Kubernetes**
          </td>
...
<CollapserGroup>
  <Collapser
    ...
    title={<><img src={osk8} title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png" style={{ height: '35px', width: '40px' }}/> Kubernetes port and endpoint path</>}
  >
  ...
  <Collapser
    ...
    title={<><img src={osk8} title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png" style={{ height: '35px', width: '40px' }}/> Example: Labels for Kubernetes port and path</>}
  >
...
<img style={{ width: '40px', height: '35px'}} class="inline" title="Docker icon" alt="Docker icon" src={osDocker}/> **Docker**
...
<img style={{ width: '40px', height: '35px'}} class="inline" title="Docker icon" alt="Docker icon" src={osDocker}/> **Docker:** To run the integration with the previous configuration
file:
