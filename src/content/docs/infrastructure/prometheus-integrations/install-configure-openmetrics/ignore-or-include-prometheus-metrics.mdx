...
<CollapserGroup>
  ...
  >
    ...
    <DoNotTranslate>**Example configuration**</DoNotTranslate>
    ...
    <DoNotTranslate>**Example of raw Prometheus metrics**</DoNotTranslate>
    ...
    <DoNotTranslate>**Example output**</DoNotTranslate>
