...
<DoNotTranslate>**Recommendation:**</DoNotTranslate> Put the CA bundle, key, and cert files in a secret, and include them in the Prometheus OpenMetrics integration's container.
