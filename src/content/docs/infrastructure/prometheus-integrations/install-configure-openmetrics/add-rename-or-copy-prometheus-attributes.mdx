...
metaDescription: How to rename or copy Prometheus metrics for your <DNT>Docker/DNT> integration before sending them to New Relic.
redirects:
...
The New Relic Prometheus OpenMetrics integration provides controls to transform the Prometheus metrics for <DNT>Docker/DNT> before sending them to New Relic. After you define the transformations in the integration config file, they are performed for all endpoints.
