...
* Go to **[one.newrelic.com](https://one.newrelic.com) > Infrastructure > Settings > Agents > Agent version**.
* Go to **[one.newrelic.com](https://one.newrelic.com) > Infrastructure > Hosts > (select a host)**.
...
1. Go to **[one.newrelic.com](https://one.newrelic.com) > Infrastructure > Inventory**.
