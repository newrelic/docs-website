...
<CollapserGroup>
  <Collapser
    id="apt-update"
    title={<>Update using apt (<ImageSizing width="32px" height="32px" verticalAlign="middle">![Debian.png](./images/Debian.png "Debian icon")</ImageSizing>Debian, <ImageSizing width="32px" height="32px" verticalAlign="middle">![ubuntu icon](./images/ubuntu-icon.png "ubuntu icon")</ImageSizing>Ubuntu)</>}
  >
  ...
  <Collapser
    id="yum-update"
    title={<>Update using yum (<ImageSizing width="32px" height="32px" verticalAlign="middle">![amazon linux.png](./images/amazon-linux.png "amazon linux.png")</ImageSizing>Amazon Linux, <ImageSizing width="32px" height="32px" verticalAlign="middle">![centos icon](./images/centos-icon.png "centos icon")</ImageSizing>CentOS, <ImageSizing width="32px" height="32px" verticalAlign="middle">![redhat icon](./images/red-hat-new2.png "redhat icon")</ImageSizing>RHEL)</>}
  >
  ...
  <Collapser
    id="zypper-update"
    title={<>Update using Zypper (<ImageSizing width="32px" height="32px" verticalAlign="middle">![suse icon](./images/suse-icon.png "suse icon")</ImageSizing>SLES)</>}
  >
  ...
  <Collapser
    ...
    title={<>Update on <ImageSizing width="32px" height="32px" verticalAlign="middle">![Windows Server icon](./images/Windows_Server_logo_small.png "Windows Server")</ImageSizing>Windows Server (32 bits)</>}
  >
  ...
  <Collapser
    id="windows-update"
    title={<>Update on <ImageSizing width="32px" height="32px" verticalAlign="middle">![Windows Server icon](./images/Windows_Server_logo_small.png "Windows Server")</ImageSizing>Windows Server (64 bits)</>}
  >
    To manually update the infrastructure agent on Windows Server:
