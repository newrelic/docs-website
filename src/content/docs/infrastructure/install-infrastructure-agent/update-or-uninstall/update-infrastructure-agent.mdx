...
Read on to learn how to update the [infrastructure agent to the latest version](/docs/release-notes/infrastructure-release-notes/infrastructure-agent-release-notes) for Linux and Windows servers.

<Callout variant="tip">
  * To install the infrastructure agent for the first time, see the installation documentation for [Linux](/docs/infrastructure-install-amazon-linux-centos-debian-rhel-or-ubuntu), [Windows](/docs/infrastructure-install-windows-server), or [configuration management tools](/docs/infrastructure/new-relic-infrastructure/config-management-tools).
  * To uninstall the infrastructure agent, see [Uninstall the Infrastructure agent](/docs/agents/manage-apm-agents/installation/uninstall-agent).
</Callout>
...
<CollapserGroup>
  <Collapser
    id="apt-update"
    title={<>Update using apt (<ImageSizing width="32px" height="32px" verticalAlign="middle">![Debian.png](https://docs.newrelic.com/sites/default/files/thumbnails/image/Debian.png "Debian icon")</ImageSizing>Debian, <ImageSizing width="32px" height="32px" verticalAlign="middle">![ubuntu icon](https://docs.newrelic.com/sites/default/files/thumbnails/image/ubuntu-icon.png "ubuntu icon")</ImageSizing>Ubuntu)</>}
  >
  ...
  <Collapser
    id="yum-update"
    title={<>Update using yum (<ImageSizing width="32px" height="32px" verticalAlign="middle">![amazon linux.png](https://docs.newrelic.com/sites/default/files/thumbnails/image/amazon%20linux.png "amazon linux.png")</ImageSizing>Amazon Linux, <ImageSizing width="32px" height="32px" verticalAlign="middle">![centos icon](https://docs.newrelic.com/sites/default/files/thumbnails/image/centos-icon.png "centos icon")</ImageSizing>CentOS, <ImageSizing width="32px" height="32px" verticalAlign="middle">![redhat icon](https://docs.newrelic.com/sites/default/files/styles/inline_660px/public/thumbnails/image/red-hat-new2.png "redhat icon")</ImageSizing>RHEL)</>}
  >
  ...
  <Collapser
    id="zypper-update"
    title={<>Update using Zypper (<ImageSizing width="32px" height="32px" verticalAlign="middle">![suse icon](https://docs.newrelic.com/sites/default/files/thumbnails/image/suse-icon.png "suse icon")</ImageSizing>SLES)</>}
  >
  ...
  <Collapser
    ...
    title={<>Update on <ImageSizing width="32px" height="32px" verticalAlign="middle">![Windows Server icon](https://docs.newrelic.com/sites/default/files/thumbnails/image/Windows_Server_logo_small.png "Windows Server")</ImageSizing>Windows Server (32 bits)</>}
  >
  ...
  <Collapser
    id="windows-update"
    title={<>Update on <ImageSizing width="32px" height="32px" verticalAlign="middle">![Windows Server icon](https://docs.newrelic.com/sites/default/files/thumbnails/image/Windows_Server_logo_small.png "Windows Server")</ImageSizing>Windows Server (64 bits)</>}
  >
    To manually update the infrastructure agent on Windows Server:
