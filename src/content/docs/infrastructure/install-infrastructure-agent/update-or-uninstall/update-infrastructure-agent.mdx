...
To manually check the infrastructure agent versions, you can log onto a server and run `newrelic-infra --version`. The directory where you'd run this differs between operating systems, but here are the default paths when installing the infrastructure agent using a package manager:
* Linux: `/usr/bin/newrelic-infra`
* Windows: `C:\Program Files\New Relic\newrelic-infra\`

For Linux, you can check the version by using the corresponding package manager (apt, dnf, zypper, etc.).
