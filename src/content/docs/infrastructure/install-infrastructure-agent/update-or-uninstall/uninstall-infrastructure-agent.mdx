...
<CollapserGroup>
  ...
  <Collapser
    id="zipper-uninstall"
    title={<>Uninstall with Zypper (<ImageSizing width="32px" height="32px" verticalAlign="middle">![suse icon](https://docs.newrelic.com/sites/default/files/thumbnails/image/suse-icon.png "suse icon")</ImageSizing>SLES)</>}
  >
    Execute the following command as root:
