...
<CollapserGroup>
  ...
  <Collapser
    id="yum-uninstall"
    title={<>Uninstall with yum (<img src={osAmazonLinux} title="amazon linux.png" alt="amazon linux.webp" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>Amazon Linux, <img src={osCentos} title="centos icon" alt="centos icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>CentOS, <img src={osRedhat} title="redhat icon" alt="redhat icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>RHEL)</>}
  >
    Execute the following command as root:
