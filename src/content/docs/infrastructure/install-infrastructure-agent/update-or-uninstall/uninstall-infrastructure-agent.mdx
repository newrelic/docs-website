...
<CollapserGroup>
  <Collapser
    id="apt-uninstall"
    title={<>Uninstall with apt (<ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={debian} title="Debian icon" alt="Debian.png"/></ImageSizing>Debian, <ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={ubuntuIcon} title="ubuntu icon" alt="ubuntu icon"/></ImageSizing>Ubuntu)</>}
  >
  ...
  <Collapser
    id="yum-uninstall"
    title={<>Uninstall with yum (<ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={amazonLinux} title="amazon linux.png" alt="amazon linux.png"/></ImageSizing>Amazon Linux, <ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={centosIcon} title="centos icon" alt="centos icon"/></ImageSizing>CentOS, <ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={redHatNew2} title="redhat icon" alt="redhat icon"/></ImageSizing>RHEL)</>}
  >
    Execute the following command as root:
  ...
  <Collapser
    id="zipper-uninstall"
    title={<>Uninstall with Zypper (<ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={suseIcon} title="suse icon" alt="suse icon"/></ImageSizing>SLES)</>}
  >
    Execute the following command as root:
