...
## Uninstall the <ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={windowsServerLogoSmall} title="Windows Server" alt="Windows Server icon"/></ImageSizing> Windows infrastructure agent [#uninstall-windows]
...
## Uninstall the <ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={macOsxLogo} title="macOS" alt="macOS icon"/></ImageSizing> macOS infrastructure agent [#uninstall-macos]
