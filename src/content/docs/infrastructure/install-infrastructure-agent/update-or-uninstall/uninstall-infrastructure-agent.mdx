...
3. From the Windows **Control Panel**, use the **Add/Remove Programs and Features** tool to uninstall the infrastructure agent.
4. From the Windows **Program Files**, manually delete the New Relic folder to delete all files associated with the infrastructure agent for Windows.
