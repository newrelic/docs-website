...
<CollapserGroup>
  <Collapser
    id="apt-uninstall"
    title={<>Uninstall with apt (<ImageSizing width="32px" height="32px" verticalAlign="middle">![Debian.png](./images/Debian.png "Debian icon")</ImageSizing>Debian, <ImageSizing width="32px" height="32px" verticalAlign="middle">![ubuntu icon](./images/ubuntu-icon.png "ubuntu icon")</ImageSizing>Ubuntu)</>}
  >
  ...
  <Collapser
    id="yum-uninstall"
    title={<>Uninstall with yum (<ImageSizing width="32px" height="32px" verticalAlign="middle">![amazon linux.png](./images/amazon-linux.png "amazon linux.png")</ImageSizing>Amazon Linux, <ImageSizing width="32px" height="32px" verticalAlign="middle">![centos icon](./images/centos-icon.png "centos icon")</ImageSizing>CentOS, <ImageSizing width="32px" height="32px" verticalAlign="middle">![redhat icon](./images/red-hat-new2.png "redhat icon")</ImageSizing>RHEL)</>}
  >
    Execute the following command as root:
  ...
  <Collapser
    id="zipper-uninstall"
    title={<>Uninstall with Zypper (<ImageSizing width="32px" height="32px" verticalAlign="middle">![suse icon](./images/suse-icon.png "suse icon")</ImageSizing>SLES)</>}
  >
    Execute the following command as root:
