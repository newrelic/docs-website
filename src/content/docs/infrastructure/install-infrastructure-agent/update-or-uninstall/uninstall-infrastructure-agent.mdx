...
## Uninstall the <img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} title="Windows Server" alt="Windows Server icon" src={windowsServerLogoSmall}/> Windows infrastructure agent [#uninstall-windows]
...
## Uninstall the <img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} title="macOS" alt="macOS icon" src={macOsxLogo}/> macOS infrastructure agent [#uninstall-macos]
