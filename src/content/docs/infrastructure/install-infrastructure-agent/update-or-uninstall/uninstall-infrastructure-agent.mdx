...
<table>
  <thead>
    <tr>
      <th style={{ width: "250px" }}>
        <DNT>**Config management tools**</DNT>
      </th>

      <th>
        <DNT>**Uninstall New Relic infrastructure agent**</DNT>
      </th>
    </tr>
  </thead>
  ...
  <tbody>
    <tr>
      <td>
        [AWS <DNT>Elastic Beanstalk</DNT>](/docs/infrastructure/install-infrastructure-agent/config-management-tools/install-infrastructure-agent-aws-elastic-beanstalk)
      </td>
