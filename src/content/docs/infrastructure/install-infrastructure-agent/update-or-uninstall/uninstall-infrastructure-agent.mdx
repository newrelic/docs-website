...
3. From the Windows <DoNotTranslate>**Control Panel**</DoNotTranslate>, use the <DoNotTranslate>**Add/Remove Programs and Features**</DoNotTranslate> tool to uninstall the infrastructure agent.
4. From the Windows <DoNotTranslate>**Program Files**</DoNotTranslate>, manually delete the New Relic folder to delete all files associated with the infrastructure agent for Windows.
  ...
  <thead>
    <tr>
      <th style={{ width: "250px" }}>
        <DoNotTranslate>**Config management tools**</DoNotTranslate>
      </th>

      <th>
        <DoNotTranslate>**Uninstall New Relic infrastructure agent**</DoNotTranslate>
      </th>
    </tr>
  </thead>
