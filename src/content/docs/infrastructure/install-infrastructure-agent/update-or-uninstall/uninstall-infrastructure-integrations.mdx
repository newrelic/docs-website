      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            5. For a standard (non-custom) user role, select **Manage Services** for the account you want to remove. Copy the value of **User** and save it.
            ...
            6. Standard (non-custom) user role: Sign in to [Google Cloud](https://console.cloud.google.com/) and select the correct project in the **Select a project** box.

            7. From the navigation menu, select **IAM & admin > IAM**.

            8. Search for and select the user value you saved, then select **REMOVE**.
          </td>
        </tr>
      </tbody>
    </table>
