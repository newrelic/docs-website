...
<Callout variant="important">
  ...
  the infrastructure agent package includes the additional `newrelic-infra-ctl`
  binary, which is used to help troubleshoot a running agent. Although this
  binary is not required to execute the agent, we recommend to add it in your
  path. For more information, see our documentation about [troubleshooting a
  running infrastructure
  agent](/docs/infrastructure/install-configure-manage-infrastructure/manage-your-agent/troubleshoot-running-agent).
</Callout>
