...
<Callout variant="tip">
  As of [version 1.18.2](https://github.com/newrelic/infrastructure-agent/releases/tag/1.18.2), default service recovery settings are defined. The New Relic Infrastructure agent will attempt to restart on unexpected failures.
</Callout>
