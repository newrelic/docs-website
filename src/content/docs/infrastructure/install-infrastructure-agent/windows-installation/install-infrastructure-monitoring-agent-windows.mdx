...
<Callout variant="tip">
  As of [version 1.4.0](/docs/release-notes/infrastructure-release-notes/infrastructure-agent-release-notes/new-relic-infrastructure-agent-140), the infrastructure monitoring agent package includes [`newrelic-infra-ctl`](/docs/infrastructure/install-configure-manage-infrastructure/manage-your-agent/troubleshoot-running-agent), which is used to help troubleshoot a running agent. We recommend [adding it to PATH](/docs/infrastructure/install-configure-manage-infrastructure/manage-your-agent/troubleshoot-running-agent).
</Callout>
