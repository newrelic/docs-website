...
<Callout variant="tip">
  As of [version 1.18.2](https://github.com/newrelic/infrastructure-agent/releases/tag/1.18.2), default service recovery settings are defined. New Relic's Infrastructure agent will attempt to restart every 30 seconds on unexpected failures.
</Callout>
