---
title: Install the infrastructure agent for Windows Server using the MSI installer
contentType: page
template: basicDoc
topics:
  - Infrastructure
