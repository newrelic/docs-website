...
<Callout variant="important">
  Make sure any custom folder defined in the installation settings has permissions limitation proper defined. The infrastructure agent might execute any integration defined in the `NRIA_PLUGIN_DIR` directory with Administrator permissions.
</Callout>
