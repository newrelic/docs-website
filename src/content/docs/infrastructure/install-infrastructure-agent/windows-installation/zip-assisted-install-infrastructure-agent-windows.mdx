...
<Callout variant="important">
  ...
  path. [See our
  docs](/docs/infrastructure/install-configure-manage-infrastructure/manage-your-agent/troubleshoot-running-agent)
...
<Callout variant="important">
  Make sure any custom folder defined in the installation settings has
  permissions limitations properly defined. The infrastructure agent might
  execute any integration defined in the `NRIA_PLUGIN_DIR` directory with
