...
<CollapserGroup>
  ...
  <Collapser
    id="docker-host"
    title="Linux <DNT>Docker/DNT> host"
  >
    The agent has very low performance overhead on a host running <DNT>Docker/DNT>, with exact usage depending on the number of <DNT>Docker/DNT> containers your machine hosts, and whether those processes are long- or short-lived.
    ...
    * <DNT>**Operating system**</DNT>: CentOS 7
      ...
      For this type of <DNT>Docker/DNT> host, typical usage is:
