...
## <img title="Linux" alt="Linux" src={otherlinux}/>Linux: Start, stop, restart, or check agent status [#linux]
...
## <img title="Windows Server" alt="Windows Server" src={windows}/> Windows: Start, stop, restart, or check agent status [#windows]
...
### <img title="CMD" alt="CMD" src={cmd}/> Command prompt (cmd.exe)
