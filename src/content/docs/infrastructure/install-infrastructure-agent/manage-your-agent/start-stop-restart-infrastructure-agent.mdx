...
## <img title="Linux" alt="Linux" src={OsLinux}/>Linux: Start, stop, restart, or check agent status [#linux]
...
## <img title="Windows Server" alt="Windows Server" src={osWindows}/> Windows: Start, stop, restart, or check agent status [#windows]
...
### <img title="CMD" alt="CMD" src={terminalCmd}/> Command prompt (cmd.exe)
