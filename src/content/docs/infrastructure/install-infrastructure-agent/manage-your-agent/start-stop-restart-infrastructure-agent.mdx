...
* <DoNotTranslate>**SystemD**</DoNotTranslate> (Amazon Linux 2, SLES 12, CentOS 7 or higher, Debian 8 or higher, RHEL 7 or higher, Ubuntu 15.04 or higher):
  ```shell
...
* <DoNotTranslate>**Upstart**</DoNotTranslate> (Amazon Linux, RHEL 6, Ubuntu 14.04 or lower):
  ```shell
...
<Callout variant="important">
  To start, stop, or restart the agent, you must run `cmd.exe` or PowerShell as <DoNotTranslate>**Administrator**</DoNotTranslate>.
</Callout>
