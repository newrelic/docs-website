...
## ![Linux](src/images/otherlinux.png 'Linux')Linux: Start, stop, restart, or check agent status [#linux]
...
## ![Windows Server](src/images/windows.png 'Windows Server') Windows: Start, stop, restart, or check agent status [#windows]

<Callout variant="important">
  To start, stop, or restart the agent, you must run `cmd.exe` or PowerShell as
  **Administrator**.
</Callout>
...
### ![CMD](src/images/cmd.png 'CMD') Command prompt (cmd.exe)
