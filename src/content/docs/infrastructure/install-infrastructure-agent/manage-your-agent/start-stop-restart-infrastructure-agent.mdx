...
## <img title="Linux" alt="Linux" src={OsLinux} class="inline" style={{height: "30px", width: "30px"}} /> Linux [#linux]
...
## <img title="Windows Server" alt="Windows Server" src={osWindows} class="inline"/> Windows [#windows]
...
### <img title="CMD" alt="CMD" src={terminalCmd} class="inline"/> Command prompt (cmd.exe)
...
### <img title="PowerShell" alt="PowerShell" src={terminalPowershell} class="inline"/> PowerShell
...
## <img title="MacOS" alt="MacOS" src={osMac} class="inline"/> macOS [#macOS]
