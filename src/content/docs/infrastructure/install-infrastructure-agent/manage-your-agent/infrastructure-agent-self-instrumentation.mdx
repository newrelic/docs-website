...
From agent version [1.24.0](https://github.com/newrelic/infrastructure-agent/releases/tag/1.24.0) you can enable agent
self instrumentation and monitor the agent performance using New Relic [APM](/docs/apm/new-relic-apm/getting-started/introduction-apm/).
