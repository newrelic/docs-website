...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Bind mounts the host's root volume to the container. This read-only access to the host's root allows the agent to collect process and storage metrics as well as Inventory data from the host. If you interact with the `containerd` runtime, replace this mount with `/run/containerd/containerd.sock:/run/containerd/containerd.sock`.
      </td>
    </tr>
