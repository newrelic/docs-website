...
Our custom Linux installation process for <InlinePopover type="infrastructure" /> allows you to tailor all aspects of the installation process, and to place files and folders on your filesystem. You have full control of the installation.
