...
topics:
  ...
  - Linux installation
japaneseVersion: >-
  https://docs.newrelic.co.jp/docs/infrastructure/install-infrastructure-agent/linux-installation/install-infrastructure-agent-linux-using-package-manager
---
