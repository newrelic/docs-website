...
3. Once the `attrs.tag` appears in your host-level logs, you can create a parsing rule by going to <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com) > Logs </DoNotTranslate>, then click <DoNotTranslate>**Parsing**</DoNotTranslate>.
