...
<Callout variant="important">
In case you use Docker Compose to startup your applications and services and you want to collect and assign your container logs to the container entities, please follow [this guide](docs/infrastructure/install-infrastructure-agent/linux-installation/container-instrumentation-infrastructure-monitoring-logs)) to get this configured correctly.
</Callout>
