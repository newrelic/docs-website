...
* If you use Docker Compose to initiate your apps and services, follow [our documentation about container logs](docs/infrastructure/install-infrastructure-agent/linux-installation/container-instrumentation-infrastructure-monitoring-logs) to collect and assign your container logs to your container entities. 
</Callout>
