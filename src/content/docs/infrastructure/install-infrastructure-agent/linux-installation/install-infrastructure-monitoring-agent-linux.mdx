...
* Have a valid [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key).

To install infrastructure in Linux, follow these instructions:

1. Create the configuration file and add your [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key):
