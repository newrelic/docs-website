...
6. Install the `newrelic-infra` package in root (default), privileged user, or unprivileged user mode. For more information on each running mode, see [Linux agent running modes](/docs/infrastructure/install-configure-infrastructure/linux-installation/linux-agent-running-modes).
   ...
   <CollapserGroup>
     <Collapser
       ...
       title="Root (default)"
     >
       * **<ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={debian} title="Debian.png" alt="Debian.png"/></ImageSizing> Debian and <ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={ubuntuIcon} title="ubuntu icon" alt="ubuntu icon"/></ImageSizing> Ubuntu**:

         ```
         sudo apt-get install newrelic-infra -y
         ```
       * **<ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={amazonLinux} title="amazon linux.png" alt="amazon linux.png"/></ImageSizing> Amazon Linux, <ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={centosIcon} title="centos icon" alt="centos icon"/></ImageSizing> CentOS, <ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={redHatNew2} title="redhat icon" alt="redhat icon"/></ImageSizing> RHEL**:

         ```
         sudo yum install newrelic-infra -y
         ```
       * **<ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={suseIcon} title="suse icon" alt="suse icon"/></ImageSizing> SLES**:
