...
2. Determine the distribution version number:
   ...
   <CollapserGroup>
     <Collapser
       id="debian-version"
       title={<><ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={debian} title="Debian icon" alt="Debian.png"/></ImageSizing> Debian</>}
     >
       ```
       cat /etc/os-release
       ```
     ...
     <Collapser
       id="ubuntu-version"
       title={<><ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={ubuntuIcon} title="ubuntu icon" alt="ubuntu icon"/></ImageSizing> Ubuntu</>}
     >
       ```
       cat /etc/lsb-release
       ```
     ...
     <Collapser
       ...
       title={<><ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={amazonLinux} title="amazon linux.png" alt="amazon linux.png"/></ImageSizing> Amazon Linux, <ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={centosIcon} title="centos icon" alt="centos icon"/></ImageSizing> CentOS, <ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={redHatNew2} title="redhat icon" alt="redhat icon"/></ImageSizing> RHEL</>}
     >
       ```
       cat /etc/os-release
       ```
     ...
     <Collapser
       id="sles-version"
       title={<><ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={suseIcon} title="suse icon" alt="suse icon"/></ImageSizing> SLES</>}
     >
       ```
...
4. Add the infrastructure monitoring agent repository:
   ...
   <CollapserGroup>
     ...
     <Collapser
       ...
       title={<><ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={centosIcon} title="centos icon" alt="centos icon"/></ImageSizing> CentOS / <ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={redHatNew2} title="redhat icon" alt="redhat icon"/></ImageSizing> RHEL</>}
     >
       **CentOS 5.x, RHEL 5.x**
