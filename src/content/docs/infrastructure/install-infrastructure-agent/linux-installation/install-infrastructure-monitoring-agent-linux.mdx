...
2. Determine the distribution version number:
   ...
   <CollapserGroup>
     <Collapser
       id="debian-version"
       title={<><ImageSizing width="32px" height="32px" verticalAlign="middle">![Debian.png](https://docs.newrelic.com/sites/default/files/thumbnails/image/Debian.png "Debian icon")</ImageSizing> Debian</>}
     >
       ```
       cat /etc/os-release
       ```
     ...
     <Collapser
       id="ubuntu-version"
       title={<><ImageSizing width="32px" height="32px" verticalAlign="middle">![ubuntu icon](https://docs.newrelic.com/sites/default/files/thumbnails/image/ubuntu-icon.png "ubuntu icon")</ImageSizing> Ubuntu</>}
     >
       ```
       cat /etc/lsb-release
       ```
     ...
     <Collapser
       id="sles-version"
       title={<><ImageSizing width="32px" height="32px" verticalAlign="middle">![suse icon](https://docs.newrelic.com/sites/default/files/thumbnails/image/suse-icon.png "suse icon")</ImageSizing> SLES</>}
     >
       ```
...
3. Enable New Relic's GPG key.
   ...
   <CollapserGroup>
     <Collapser
       id="debian-gpg"
       title={<><ImageSizing width="32px" height="32px" verticalAlign="middle">![Debian.png](https://docs.newrelic.com/sites/default/files/thumbnails/image/Debian.png "Debian.png")</ImageSizing> Debian</>}
     >
       ```
...
4. Add the infrastructure monitoring agent repository:
   ...
   <CollapserGroup>
     ...
     <Collapser
       ...
       title={<><ImageSizing width="32px" height="32px" verticalAlign="middle">![amazon linux.png](https://docs.newrelic.com/sites/default/files/thumbnails/image/amazon%20linux.png "amazon linux.png")</ImageSizing> Amazon Linux</>}
     >
       **Amazon Linux**
     ...
     <Collapser
       ...
       title={<><ImageSizing width="32px" height="32px" verticalAlign="middle">![centos icon](https://docs.newrelic.com/sites/default/files/thumbnails/image/centos-icon.png "centos icon")</ImageSizing> CentOS / <ImageSizing width="32px" height="32px" verticalAlign="middle">![redhat icon](https://docs.newrelic.com/sites/default/files/styles/inline_660px/public/thumbnails/image/red-hat-new2.png "redhat icon")</ImageSizing> RHEL</>}
     >
       **CentOS 5.x, RHEL 5.x**
