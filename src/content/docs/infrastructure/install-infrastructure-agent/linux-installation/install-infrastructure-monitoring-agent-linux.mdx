...
2. Determine the distribution version number:
   ...
   <CollapserGroup>
     <Collapser
       id="debian-version"
       title={<><ImageSizing width="32px" height="32px" verticalAlign="middle">![Debian.png](./images/Debian.png "Debian icon")</ImageSizing> Debian</>}
     >
       ```
       cat /etc/os-release
       ```
     ...
     <Collapser
       id="ubuntu-version"
       title={<><ImageSizing width="32px" height="32px" verticalAlign="middle">![ubuntu icon](./images/ubuntu-icon.png "ubuntu icon")</ImageSizing> Ubuntu</>}
     >
       ```
       cat /etc/lsb-release
       ```
     ...
     <Collapser
       ...
       title={<><ImageSizing width="32px" height="32px" verticalAlign="middle">![amazon linux.png](./images/amazon-linux.png "amazon linux.png")</ImageSizing> Amazon Linux, <ImageSizing width="32px" height="32px" verticalAlign="middle">![centos icon](./images/centos-icon.png "centos icon")</ImageSizing> CentOS, <ImageSizing width="32px" height="32px" verticalAlign="middle">![redhat icon](./images/red-hat-new2.png "redhat icon")</ImageSizing> RHEL</>}
     >
       ```
       cat /etc/os-release
       ```
     ...
     <Collapser
       id="sles-version"
       title={<><ImageSizing width="32px" height="32px" verticalAlign="middle">![suse icon](./images/suse-icon.png "suse icon")</ImageSizing> SLES</>}
     >
       ```
...
4. Add the infrastructure monitoring agent repository:
   ...
   <CollapserGroup>
     ...
     <Collapser
       ...
       title={<><ImageSizing width="32px" height="32px" verticalAlign="middle">![centos icon](./images/centos-icon.png "centos icon")</ImageSizing> CentOS / <ImageSizing width="32px" height="32px" verticalAlign="middle">![redhat icon](./images/red-hat-new2.png "redhat icon")</ImageSizing> RHEL</>}
     >
       **CentOS 5.x, RHEL 5.x**
