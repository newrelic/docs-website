...
4. Add the infrastructure agent repository:
   ...
   <CollapserGroup>
     ...
     >
       ...
       <DNT>**Ubuntu 20.04 LTS (Focal Fossa)**</DNT>
       ...
       <DNT>**Ubuntu 20.10 (Groovy Gorilla)**</DNT>
       ...
       <DNT>**Ubuntu 21.04 (Hirsute Hippo)**</DNT>
       ...
       <DNT>**Ubuntu 22.04 (Jammy Jellyfish)**</DNT>
       ...
       <DNT>**Ubuntu 24.04 (Noble Numbat)**</DNT>
     ...
     >
       ...
       <DNT>**Amazon Linux 2023 (arm64)**</DNT>
     ...
     >
       <DNT>**CentOS, RHEL, Oracle Linux 7.x (x86)**</DNT>

       ```bash
       sudo curl -o /etc/yum.repos.d/newrelic-infra.repo https://download.newrelic.com/infrastructure_agent/linux/yum/el/7/x86_64/newrelic-infra.repo
       ```

       <DNT>**CentOS RHEL, Oracle Linux 7.x (arm64)**</DNT>
       ...
       <DNT>**CentOS, RHEL, Oracle Linux 8.x (x86)**</DNT>
       ...
       <DNT>**CentOS, RHEL, Oracle Linux 8.x (arm64)**</DNT>
...
6. Install the `newrelic-infra` package in root (default), privileged user, or unprivileged user mode. For more information on each running mode, see [Linux agent running modes](/docs/infrastructure/install-configure-infrastructure/linux-installation/linux-agent-running-modes).
   ...
   <CollapserGroup>
     <Collapser
       ...
       title="Root (default)"
     >
       * <DNT>**<img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="Debian.png" alt="Debian.png" src={osDebian}/> Debian and <img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="ubuntu icon" alt="ubuntu icon" src={osUbuntu}/> Ubuntu**</DNT>:

         ```bash
         sudo apt-get install newrelic-infra -y
         ```
       * <DNT>**<img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="amazon linux.png" alt="amazon linux.png" src={osAmazonLinux}/> Amazon Linux, <img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="centos icon" alt="centos icon" src={osCentos}/> CentOS, <img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="redhat icon" alt="redhat icon" src={osRedhat}/> RHEL & Oracle Linux**</DNT>:

         ```bash
         sudo yum install newrelic-infra -y
         ```
       * <DNT>**<img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="suse icon" alt="suse icon" src={osSuse}/> SLES**</DNT>:
