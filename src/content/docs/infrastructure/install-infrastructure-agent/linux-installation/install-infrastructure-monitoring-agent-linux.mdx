...
4. Add the infrastructure monitoring agent repository:
   ...
   <CollapserGroup>
     <Collapser
       ...
       title={<><img src={osDebian} title="Debian.png" alt="Debian.png" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/> Debian</>}
     >
       <DoNotTranslate>**Debian 10 ("Buster")**</DoNotTranslate>
       ...
       <DoNotTranslate>**Debian 11 ("Bullseye")**</DoNotTranslate>
       ...
       <DoNotTranslate>**Debian 12 ("Bookworm")**</DoNotTranslate>
     ...
     <Collapser
       ...
       title={<><img src={osUbuntu} title="ubuntu icon" alt="ubuntu icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/> Ubuntu</>}
     >
       <DoNotTranslate>**Ubuntu 16.04 LTS (Xenial Xerus)**</DoNotTranslate>
       ...
       <DoNotTranslate>**Ubuntu 18.04 LTS (Bionic Beaver)**</DoNotTranslate>
       ...
       <DoNotTranslate>**Ubuntu 20.04 LTS (Focal Fossa)**</DoNotTranslate>
       ...
       <DoNotTranslate>**Ubuntu 20.10 (Groovy Gorilla)**</DoNotTranslate>
       ...
       <DoNotTranslate>**Ubuntu 21.04 (Hirsute Hippo)**</DoNotTranslate>
       ...
       <DoNotTranslate>**Ubuntu 22.04 (Jammy Jellyfish)**</DoNotTranslate>
     ...
     >
       <DoNotTranslate>**Amazon Linux 2 (x86)**</DoNotTranslate>
       ...
       <DoNotTranslate>**Amazon Linux 2 (arm64)**</DoNotTranslate>
       ...
       <DoNotTranslate>**Amazon Linux 2023 (x86)**</DoNotTranslate>
       ...
       <DoNotTranslate>**Amazon Linux 2023 (arm64)**</DoNotTranslate>
     ...
     >
       <DoNotTranslate>**CentOS, RHEL, Oracle Linux 7.x (x86)**</DoNotTranslate>

       ```bash
       sudo curl -o /etc/yum.repos.d/newrelic-infra.repo https://download.newrelic.com/infrastructure_agent/linux/yum/el/7/x86_64/newrelic-infra.repo
       ```

       <DoNotTranslate>**CentOS RHEL, Oracle Linux 7.x (arm64)**</DoNotTranslate>
       ...
       <DoNotTranslate>**CentOS, RHEL, Oracle Linux 8.x (x86)**</DoNotTranslate>
       ...
       <DoNotTranslate>**CentOS, RHEL, Oracle Linux 8.x (arm64)**</DoNotTranslate>
       ...
       <DoNotTranslate>**RHEL 9.x (x86)**</DoNotTranslate>
       ...
       <DoNotTranslate>**RHEL 9.x (arm64)**</DoNotTranslate>
     ...
     >
       ...
       <DoNotTranslate>**SLES 12.1 (x86)**</DoNotTranslate>
       ...
       <DoNotTranslate>**SLES 12.1 (ARM)**</DoNotTranslate>
       ...
       <DoNotTranslate>**SLES 12.2 (x86)**</DoNotTranslate>
       ...
       <DoNotTranslate>**SLES 12.2 (ARM)**</DoNotTranslate>
       ...
       <DoNotTranslate>**SLES 12.3 (x86)**</DoNotTranslate>
       ...
       <DoNotTranslate>**SLES 12.3 (ARM)**</DoNotTranslate>
       ...
       <DoNotTranslate>**SLES 12.4 (x86)**</DoNotTranslate>
       ...
       <DoNotTranslate>**SLES 12.4 (ARM)**</DoNotTranslate>
       ...
       <DoNotTranslate>**SLES 12.5 (x86)**</DoNotTranslate>
       ...
       <DoNotTranslate>**SLES 12.5 (ARM)**</DoNotTranslate>
       ...
       <DoNotTranslate>**SLES 15.1 (x86)**</DoNotTranslate>
       ...
       <DoNotTranslate>**SLES 15.1 (ARM)**</DoNotTranslate>
       ...
       <DoNotTranslate>**SLES 15.2 (x86)**</DoNotTranslate>
       ...
       <DoNotTranslate>**SLES 15.2 (ARM)**</DoNotTranslate>
       ...
       <DoNotTranslate>**SLES 15.3 (x86)**</DoNotTranslate>
       ...
       <DoNotTranslate>**SLES 15.3 (ARM)**</DoNotTranslate>
       ...
       <DoNotTranslate>**SLES 15.4 (x86)**</DoNotTranslate>
       ...
       <DoNotTranslate>**SLES 15.4 (ARM)**</DoNotTranslate>
...
6. Install the `newrelic-infra` package in root (default), privileged user, or unprivileged user mode. For more information on each running mode, see [Linux agent running modes](/docs/infrastructure/install-configure-infrastructure/linux-installation/linux-agent-running-modes).
   ...
   <CollapserGroup>
     <Collapser
       ...
       title="Root (default)"
     >
       * <DoNotTranslate>**<img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="Debian.png" alt="Debian.png" src={osDebian}/> Debian and <img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="ubuntu icon" alt="ubuntu icon" src={osUbuntu}/> Ubuntu**</DoNotTranslate>:

         ```bash
         sudo apt-get install newrelic-infra -y
         ```
       * <DoNotTranslate>**<img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="amazon linux.png" alt="amazon linux.png" src={osAmazonLinux}/> Amazon Linux, <img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="centos icon" alt="centos icon" src={osCentos}/> CentOS, <img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="redhat icon" alt="redhat icon" src={osRedhat}/> RHEL & Oracle Linux**</DoNotTranslate>:

         ```bash
         sudo yum install newrelic-infra -y
         ```
       * <DoNotTranslate>**<img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="suse icon" alt="suse icon" src={osSuse}/> SLES**</DoNotTranslate>:
