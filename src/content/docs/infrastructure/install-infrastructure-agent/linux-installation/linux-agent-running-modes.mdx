  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <DoNotTranslate>**Process samples**</DoNotTranslate> do not report these metrics:
        ...
        * I/O write count per second
          ...
          The following <DoNotTranslate>**inventory sources**</DoNotTranslate> are not reported:
...
<CollapserGroup>
  ...
  >
    To switch the running mode <DoNotTranslate>**from root to privileged or unprivileged**</DoNotTranslate>, follow the installation/update instructions in this doc.
  </Collapser>
  ...
  >
    To change the running mode <DoNotTranslate>**from privileged or unprivileged to any other mode:**</DoNotTranslate>
         ...
         <tbody>
           <tr>
             <td style={{ width: "150px" }}>
               <DoNotTranslate>**Debian/Ubuntu**</DoNotTranslate>
             </td>
           ...
           <tr>
             <td>
               <DoNotTranslate>**Centos/Suse/RedHat/Amazon**</DoNotTranslate>
             </td>
