  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * <DNT>Docker/DNT> process metrics: These are not enabled by default. However, you can manually enable them by giving access rights to the `nri-agent` user.
      </td>
    </tr>
    ...
    1. Follow these steps:
       ...
       <table>
         <tbody>
           ...
           <tr>
             <td>
               <DNT>**Centos/Suse/RedHat/Amazon**</DNT>
             </td>
