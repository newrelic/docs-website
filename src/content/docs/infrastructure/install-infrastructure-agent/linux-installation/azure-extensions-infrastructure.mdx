...
1. Go to any Azure VM, Azure scale set, or Azure Service Fabric using scale sets, and select the <DoNotTranslate>**Extensions**</DoNotTranslate> tab.
   ...
   />
2. Select the <DoNotTranslate>**New Relic infrastructure**</DoNotTranslate> extension.
