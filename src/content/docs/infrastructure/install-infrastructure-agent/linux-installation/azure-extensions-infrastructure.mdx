...
New Relic uses these extensions to facilitate the installation of the <InlinePopover type="infrastructure" /> agent. This removes the need for manually updating our agent and, more importantly, automatically scales the agent with your [Azure scale sets](https://docs.microsoft.com/en-us/azure/virtual-machine-scale-sets/overview).
