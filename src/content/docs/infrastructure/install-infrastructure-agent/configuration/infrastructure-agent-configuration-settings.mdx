    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            [1.15.0](https://docs.newrelic.com/docs/release-notes/infrastructure-release-notes/infrastructure-agent-release-notes/new-relic-infrastructure-agent-1150)
          </td>
        </tr>
      </tbody>
    </table>
...
If the agent is running in a cloud instance, the agent will try to detect the cloud type and fetch [metadata](/docs/telemetry-data-platform/understand-data/new-relic-data-types/).
