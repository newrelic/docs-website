...
<CollapserGroup>
  ...
  >
    Enables [Agent's Self Instrumentation](/docs/infrastructure/install-infrastructure-agent/manage-your-agent/infrastructure-agent-instrumentation).
      ...
      <tbody>
        <tr>
          ...
          <td>
            ...
            [1.11.4](/docs/release-notes/infrastructure-release-notes/infrastructure-agent-release-notes/new-relic-infrastructure-agent-1114-0) when forwarding logs to New Relic (`3`)
          </td>
        </tr>
      </tbody>
    </table>
