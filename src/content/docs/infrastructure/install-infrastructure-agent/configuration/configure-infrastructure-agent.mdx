...
<CollapserGroup>
  ...
  >
    ...
    * <DNT>**From inside the config file:**</DNT> Add an entry to the [infrastructure config file](https://github.com/newrelic/infrastructure-agent/blob/master/assets/examples/infrastructure/newrelic-infra-template.yml.example) to allow the agent to get the environment variables you've set.
      ...
      passthrough_environment:
        ...
        - .* 
      ```
    * <DNT>**From the command line:**</DNT> Use another environment variable to pass through these settings.
