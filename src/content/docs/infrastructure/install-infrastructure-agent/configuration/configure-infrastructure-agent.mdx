...
import infrastructureConfigCascade28OrdersOfPrecedence%29 from 'images/infrastructure-config-cascade-\_28orders-of-precedence%29.png'
...
<img
  src={infrastructureConfigCascade28OrdersOfPrecedence%29}
