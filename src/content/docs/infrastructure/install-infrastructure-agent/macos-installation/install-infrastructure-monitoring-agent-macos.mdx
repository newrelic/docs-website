...
* [On-host integrations](/docs/integrations/host-integrations/get-started/introduction-host-integrations/) (including built-in integrations such as <DNT>Docker/DNT> and Flex)
* Automated deployment via configuration management tools (Chef, Ansible, <DNT>Puppet</DNT>)
