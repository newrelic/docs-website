...
With New Relic's <InlinePopover type="infrastructure" /> agent for macOS, you can monitor key performance metrics on macOS hosts. The agent can run on your own hardware or in cloud systems such as Amazon EC2.
