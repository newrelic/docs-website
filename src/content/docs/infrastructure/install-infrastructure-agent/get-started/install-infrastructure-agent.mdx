...
If you do not have a New Relic account yet, the guided install won't work. If you want to follow the procedure manually, [see our tutorial](/docs/infrastructure/install-infrastructure-agent/linux-installation/install-infrastructure-monitoring-agent-linux/). 

### Windows Server and 10 [#Windows]

If you do not have a New Relic account yet, the guided install won't work. If you want to follow the procedure manually using our MSI installer, [see our tutorial](/docs/infrastructure/install-configure-manage-infrastructure/windows-installation/install-infrastructure-windows-server-using-msi-installer). 
