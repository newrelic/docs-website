...
* <ImageSizing width="32px" height="28px" verticalAlign="middle"><img src={dockerLogoCrop} title="Docker" alt="Docker"/></ImageSizing> [Docker](/docs/infrastructure/install-infrastructure-agent/linux-installation/docker-container-infrastructure-monitoring) (install as container)
