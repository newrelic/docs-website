...
- <ImageSizing width="32px" height="32px" verticalAlign="middle">
    ![Ansible](./images/ansible-red-logo.png "Ansible")
...
- <ImageSizing width="32px" height="32px" verticalAlign="middle">
    ![Chef](./images/chef-logo.png "Chef")
...
- <ImageSizing width="32px" height="28px" verticalAlign="middle">
    ![Docker](./images/docker-logo-crop.png "Docker")
  </ImageSizing> [Docker](/docs/infrastructure/install-infrastructure-agent/linux-installation/docker-container-infrastructure-monitoring)
  (install as container)
- <ImageSizing width="32px" height="32px" verticalAlign="middle">
    ![EBS](./images/ebs.png "EBS")
  </ImageSizing>
  [Elastic
...
- <ImageSizing width="32px" height="32px" verticalAlign="middle">
    ![Puppet](./images/puppet-logo.png "Puppet")
