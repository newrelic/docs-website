...
Learn how to install and configure New Relic's infrastructure agent, logs integrations, and PHP APM agent using the `newrelic_installer` module. For an explanation of how to use Puppet, see [Puppet documentation](https://docs.puppet.com). This is a [community-supported](https://github.com/newrelic/puppet-install) effort.
