...
Read on to learn how to use Puppet to install and configure New Relic's <InlinePopover type="infrastructure" /> agent using the `newrelic-infra` module. For an explanation of how to use Puppet, see [Puppet documentation](https://docs.puppet.com). This is a community-supported effort.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Specifies the New Relic <InlinePopover type="licenseKey" /> to use.
      </td>
    </tr>
  </tbody>
</table>
