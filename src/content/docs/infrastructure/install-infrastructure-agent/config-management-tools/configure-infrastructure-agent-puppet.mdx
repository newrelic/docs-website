  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * `NEW_RELIC_API_KEY`: your New Relic [user key](/docs/apis/intro-apis/new-relic-api-keys). <DoNotTranslate>**Required**</DoNotTranslate>.
        * `NEW_RELIC_ACCOUNT_ID`: your New Relic account ID. <DoNotTranslate>**Required**</DoNotTranslate>.
