...
You can use New Relic's Ansible role to help you scale your New Relic Observability efforts. For instructions on how to use Ansible, see the [Ansible documentation](https://docs.ansible.com/). This is a [community-supported](https://github.com/newrelic/ansible-install) effort.

It uses the [New Relic CLI](https://github.com/newrelic/newrelic-cli) and [New Relic Open Installation repository](https://github.com/newrelic/open-install-library) to achieve this.
