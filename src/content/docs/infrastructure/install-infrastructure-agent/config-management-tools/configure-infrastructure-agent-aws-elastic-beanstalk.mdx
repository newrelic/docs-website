...
Amazon Web Services (AWS) [Elastic Beanstalk](https://aws.amazon.com/elasticbeanstalk) is a dynamic service that allows easy deployment and scalability for your applications. Follow these instructions to deploy the <InlinePopover type="infrastructure" /> agent to the instances launched with your AWS Elastic Beanstalk applications.
