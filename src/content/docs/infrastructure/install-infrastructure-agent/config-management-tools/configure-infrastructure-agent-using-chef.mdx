...
The `newrelic_install` resource manager will instrument New Relic using our [guided install](/docs/infrastructure/host-integrations/installation/new-relic-guided-install-overview), with minimal configuration. It will:
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The [data center region](/docs/accounts/accounts-billing/account-setup/choose-your-data-center) for your account (`US` or `EU`). Defaults to `US`.
      </td>
    </tr>
