...
Read on to learn how to use New Relic's Chef recipes to install and configure New Relic's <InlinePopover type="infrastructure" /> agent. For instructions on how to use Chef recipes, see the [Chef documentation](https://www.chef.io/solutions/infrastructure-automation/).
...
<CollapserGroup>
  ...
  >
    ...
    Defines your <InlinePopover type="licenseKey" />.
  </Collapser>
...
2. Set the New Relic <InlinePopover type="licenseKey" /> attribute. For example, add the following to your `recipes/default.rb`:
