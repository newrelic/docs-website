...
The New Relic cookbook is available in the [public Chef Supermarket](https://supermarket.chef.io/cookbooks/newrelic-install) will help you scale your New Relic Observability efforts. It uses the [New Relic CLI](https://github.com/newrelic/newrelic-cli) and [New Relic Open Installation repository](https://github.com/newrelic/open-install-library) to achieve this. This is a [community-supported](https://github.com/newrelic/chef-install) effort.
...
Infrastructure monitoring has one default recipe: `default`. Include this recipe to install and configure the infrastructure agent, logs, <InlinePopover type="apm" />. If this recipe detects an unsupported platform or version, the Chef run fails. Configuration depends on your specific setup and standards.
...
### Run `newrelic_install` recipe [#execution]
