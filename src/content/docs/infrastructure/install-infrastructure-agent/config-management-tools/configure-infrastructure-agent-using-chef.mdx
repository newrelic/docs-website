...
<CollapserGroup>
  ...
  >
    ...
    Defines your [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key).
  </Collapser>
...
2. Set the New Relic [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) attribute. For example, add the following to your `recipes/default.rb`:
