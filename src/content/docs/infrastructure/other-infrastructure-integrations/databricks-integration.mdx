...
To learn more about the Databricks Integration, visit the official New Relic Databricks Integration [repository](https://github.com/newrelic/newrelic-databricks-integration), or jump straight to the [Getting Started](https://github.com/newrelic/newrelic-databricks-integration?tab=readme-ov-file#getting-started) section for immediate setup instructions.
