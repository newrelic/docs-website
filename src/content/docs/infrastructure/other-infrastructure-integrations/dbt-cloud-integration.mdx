          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  [https://cloud.getdbt.com/api/v2/accounts/ACCOUNT_ID/](https://cloud.getdbt.com/api/v2/accounts/ACCOUNT_ID/) (Replace `ACCOUNT_ID` with your dbt Cloud account id)
                </td>
              ...
              <tr>
                ...
                <td>
                  [https://insights-collector.newrelic.com/v1/accounts/ACCOUNT_ID/events](https://insights-collector.newrelic.com/v1/accounts/ACCOUNT_ID/events) (Replace `ACCOUNT_ID` with your account id)
                </td>
              ...
              <tr>
                ...
                <td>
                  [https://insights-api.newrelic.com/v1/accounts/ACCOUNT_ID/query](https://insights-api.newrelic.com/v1/accounts/ACCOUNT_ID/query) (Replace `ACCOUNT_ID` with your account id)
                </td>
