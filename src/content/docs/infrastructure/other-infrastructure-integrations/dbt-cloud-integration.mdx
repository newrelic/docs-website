        ...
        <Step>
          ...
          <table>
              ...
              <tbody>
                  <tr>
                      <td>
                          <code style="white-space: nowrap;">`dbt_cloud_admin_api`</code>
                      </td>
                      <td>
                  ...
                  <tr>
                      <td>
                          <code style="white-space: nowrap;">`dbt_cloud_discovery_api`</code>
                      </td>
                      <td>
                  ...
                  <tr>
                      <td>
                          <code style="white-space: nowrap;">`nr_insights_insert`</code>
                      </td>
                      <td>
                  ...
                  <tr>
                      <td>
                          <code style="white-space: nowrap;">`nr_insights_query`</code> 
                      </td>
                      <td>
