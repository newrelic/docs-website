...
freshnessValidatedDate: 2026-03-15
redirects:
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        New Relic .NET extension buildpack 1.2.8
      </td>
    </tr>
...
* New Relic Dotnet Core Extension Buildpack for Dotnet Core Applications (Ubuntu Jammy)
* New Relic Dotnet Core Extension Cached Buildpack for Dotnet Core Applications (Ubuntu Jammy) running in disconnected (isolated) PCF deployments
* New Relic HWC  Extension Cached Buildpack for Dotnet Framework Applications (Windows 2019)
* New Relic HWC  Extension Buildpack for Dotnet Framework Applications (Windows 2019) running in disconnected (isolated) PCF deployments
...
<Callout variant="important">
  The cached version of this extension buildpack for both .NET Core and .NET Framework contains New Relic .NET Agents version `10.49.x`
</Callout>
