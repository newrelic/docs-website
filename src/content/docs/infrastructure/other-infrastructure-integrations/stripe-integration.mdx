...
To monitor your Stripe application, you'll instrument your application so it sends the metrics to the New Relic Metrics API. Then, you can view the data in a single, pre-built Stripe dashboard that tracks metrics like transaction overview, transaction volume, revenue, and transaction errors.  
...
Before you get started, you'll need a New Relic license key. See [New Relic API Keys](/docs/apis/intro-apis/new-relic-api-keys/) to get your license key.
