...
<i aria-hidden="true" className="fa fa-check-square-o fa-3x "><span>[checklist icon]</span></i>
...
<i aria-hidden="true" className="fa fa-exclamation-triangle fa-3x "><span>[exclamation icon]</span></i>
...
<i aria-hidden="true" className="fa fa-bar-chart fa-3x "><span>[bar chart icon]</span></i>
...
[View all infrastructure docs](/docs/infrastructure?toc=true)