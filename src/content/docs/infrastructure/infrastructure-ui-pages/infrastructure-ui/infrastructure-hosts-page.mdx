...
Here are the default graphs shown on the **Hosts** page. For additional chart options, select the dropdown <i className="fa fa-angle-down">
\[dropdown icon]
</i>
for any chart.
...
<Table>
  ...
  <tbody>
    ...
    <tr id="view-alert">
      ...
      <td>
        If present, select the host's **Critical** <i className="fa fa-times-circle-o">
        critical icon
        </i>
...
<Table>
  ...
  <tbody>
    ...
    <tr id="view-alert">
      ...
      <td>
        Select the host's **Critical** <i className="fa fa-times-circle-o">
        \[critical icon]
        </i>
        icon or **Warning** <Icon name="alert-triangle"/>
        icon.
