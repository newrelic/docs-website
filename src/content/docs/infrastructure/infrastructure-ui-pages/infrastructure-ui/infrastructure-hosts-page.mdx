...
topics:
  ...
  - Infrastructure UI
japaneseVersion: >-
  https://docs.newrelic.co.jp/docs/infrastructure/infrastructure-ui-pages/infrastructure-ui/infrastructure-hosts-page
---
...
Here are the default graphs shown on the **Hosts** page. For additional chart options, select the dropdown <i className="fa fa-angle-down"><span>[dropdown icon]</span></i>
for any chart.
...
<Table>
  ...
  <tbody>
    ...
    <tr id="alert">
      ...
      <td>
        Mouse over a chart, select <Icon name="more-horizontal"/>
    ...
    <tr id="view-alert">
      ...
      <td>
        If present, select the host's **Critical** <i className="fa fa-times-circle-o"><span>critical icon</span></i>
        icon or **Warning** <Icon name="alert-triangle"/>
        icon.
      </td>
    </tr>
  </tbody>
...
<Table>
  ...
  <tbody>
    ...
    <tr id="view-alert">
      ...
      <td>
        Select the host's **Critical** <i className="fa fa-times-circle-o"><span>[critical icon]</span></i>
        icon or **Warning** <Icon name="alert-triangle"/>
        icon.
      </td>
    </tr>
...
<Table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Use [**Group by**](https://docs.newrelic.com/docs/infrastructure/new-relic-infrastructure/filter-group/group-infrastructure-results-specific-attributes) to change how the processes are grouped in the chart and the list. The dropdown contains host-related attributes such as `image` and `operatingSystem`.
      </td>
    </tr>
