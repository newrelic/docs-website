...
<CollapserGroup>
  ...
  >
    Data collected varies by Amazon Elastic Compute Cloud (EC2) integration. For more information, see New Relic's individual [Amazon Integrations documentation](/docs/infrastructure/infrastructure-integrations/amazon-integrations).
  </Collapser>
</CollapserGroup>
