---
title: "Classic infrastructure UI"
tags:
  - Infrastructure
...
This is a guide to some older infrastructure UI components. Some of these components are currently available to all customers but are in the process of being deprecated. 

## Filter sets [#filter-sets]

The filter set UI component is used for filtering your hosts and creating saved views. This is available on the **Events** and **Inventory** UI pages. It will eventually be deprecated and entirely replaced by the [saved views](/docs/infrastructure/infrastructure-ui-pages/infra-hosts-ui-page#ui-features) feature. 
