---
title: 'Infrastructure Inventory page'
tags:
  - Infrastructure
...
## What data is reported? [#data]

The **Inventory** UI page displays data reportedy by [the infrastructure agent](/docs/infrastructure/install-infrastructure-agent/get-started/install-infrastructure-agent). 
