...
<CollapserGroup>
  ...
  >
    Use [filter sets](#filter-sets) to show only hosts matching certain criteria.
  </Collapser>
...
The filter set UI component is used for filtering your hosts and creating saved views. This is available on the **Events** and **Inventory** UI pages. It will eventually be deprecated and replaced by the improved [saved views](/docs/infrastructure/infrastructure-ui-pages/infra-hosts-ui-page#ui-features) feature. 
