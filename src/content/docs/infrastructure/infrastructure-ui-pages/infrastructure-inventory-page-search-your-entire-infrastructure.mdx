...
<CollapserGroup>
  ...
  >
    ...
    <Callout variant="tip">
        If you want to find the <DNT>Fluent Bit</DNT> version being used on your system, in the **Search Inventory** search box, enter `fluent-bit`, then click **>** to expand the search results. 
    </Callout>
...
* Hosts associated with <DNT>Docker/DNT> containers
* Test environments
