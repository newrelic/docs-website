  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <Callout variant="tip">
          Use [tagging](/docs/new-relic-one/use-new-relic-one/core-concepts/tagging-use-tags-organize-group-what-you-monitor#attributes) for detailed metadata and other information about your hosts, use .
        </Callout>
      </td>
    </tr>
  </tbody>
