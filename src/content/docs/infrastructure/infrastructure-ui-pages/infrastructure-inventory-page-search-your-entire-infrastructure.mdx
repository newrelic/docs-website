---
title: 'Infrastructure Inventory page: Search your entire infrastructure'rom 'images/No Text in Clipboard'
tags:
  - Infrastructure
...
import infrastructureInventoryNameSourcePath from 'images/infrastructure_screenshot-full_inventory-name-source-path.jpg'
...
* Quickly identify which hosts require an update timport infrastructureInventoryNamrcePath f fix a security vulnerability.

To view and search your inventory data: Go to **[one.newrelic.com](https://one.newrelic.com) > Infrastructure > Inventory**.
