...
![The new infrastructure hosts UI](./images/pegasus_ui_feb2022.png "New infrastructure UI")
...
* **Estate View** panel in the middle. 
  ...
  * Click the **...** at the right end of any entity to see the entity's tags and other related information. 
  ...
  ![View the entity's tags](./images/view_tags_menu.png "View tags")
...
![New filtering capabilities](./images/hosts_filter_dropdown.png "New filtering")
...
![Filter by metrics](./images/system_entity_dropdown.png "Filter by metrics")

Hover over any entity row to view more details on the entity. 

<ImageSizing width="320px" verticalAlign="middle">![See details on your entity](./images/new_hosts_menu.png "Entity details")</ImageSizing>
...
![The network tab](./images/network_tab.png "The network tab")
