...
Check out the new infrastructure monitoring: Go to **[one.newrelic.com](https://one.newrelic.com) > Infrastructure**, then click **Hosts (New)**. Or go to the **Explorer** and select **Hosts**.
