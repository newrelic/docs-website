...
Our 2022 relaunch of the <InlinePopover type="infrastructure" /> tools adds consistency to the way our users interact with the [our platform](/docs/new-relic-one/use-new-relic-one/get-started/introduction-new-relic-one/).
