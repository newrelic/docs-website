...
![Infrastructure entities analysis nerdlet](./images/analysis-nerdlet.png "Analysis nerdlet")
...
![Filter by metrics](./images/nerdlet-metrics.png "Filter by metrics")

Hover over any entity row to view more details on the entity. 

![See details on your entity](./images/nerdlet-entity-menu.png "Entity details")
...
![See related entities](./images/nerdlet-related-entities.png "See related entities")
