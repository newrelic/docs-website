...
<CollapserGroup>
  ...
  >
    To view one or more host's [alert threshold violations](/docs/alerts/new-relic-alerts/getting-started/alerts-glossary#alert-threshold), select the host's **Critical** <i className="fa fa-times-circle-o">
    times-circle-o
    </i>
