...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Available for AWS <DNT>Elasticsearch<DNT> integration.

        By default, we don't report <DNT>Elasticsearch<DNT> node metrics. Switch this to <DNT>**On**</DNT> if you want to monitor node metrics in addition to cluster metrics.
      </td>
    </tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        When you create [alert conditions](/docs/infrastructure/new-relic-infrastructure/infrastructure-alert-conditions) <DNT>**after**</DNT> you set filters, make sure that your <InlinePopover type="alerts" /> are not triggered by resources that you filtered out.
      </td>
    </tr>
