...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Enter **one** tag key that is associated with the resources that you want to monitor. Filter values are case-sensitive, and you can use this filter in combination with **tag value** filter. Applicable for AWS and Azure only.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Enter **one** tag value that is associated with the resources that you want to monitor. Filter values are case-sensitive, and you can use this filter in combination with **tag key**. Applicable for AWS and Azure only.
      </td>
    </tr>
