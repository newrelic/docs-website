  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        Switch this to **Off** if you do not want the integration to collect your cloud resource tags and thus reduce the volume of API calls.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        By default, we do not report shard metrics. Switch this to **On** if you want to monitor shard metrics in addition to data stream metrics.
      </td>
    </tr>
    ...
    <tr id="lambda-edge">
      ...
      <td>
        ...
        By default, we do not report Lambda@Edge data. Switch this to **On** if you're using Lambda@Edge in AWS CloudFront and want to get Lambda execution location metadata.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        By default, we do not report Elasticsearch node metrics. Switch this to **On** if you want to monitor node metrics in addition to cluster metrics.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        By default, we do not report NAT Gateway nor VPN metrics. Switch these to **On** if you want to monitor NAT Gateway and VPN metrics and inventory, in addition to other VPC related entities inventory.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        By default, we collect EC2 instance metadata that includes public and private IP addresses, and network interface details. Switch this to **Off** if you do not want New Relic to store and display these IP data.
      </td>
    </tr>
  </tbody>
</table>
