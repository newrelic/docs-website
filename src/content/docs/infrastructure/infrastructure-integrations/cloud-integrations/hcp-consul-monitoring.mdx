...
<Callout variant="tip">
Note that we also have a [HashiCorp Consul integration](/docs/infrastructure/host-integrations/host-integrations-list/hashicorp-consul-monitoring-integration) for Consul instances not on HCP.  
</Callout>
...
**Restart Consul client pods** [#restart-client-pods]
