...
![Screenshot showing gaps in metric data charts.](src/images/screen-metric-gap.png 'screen-metric-gap.png')

<figcaption>This screenshot shows a metric data chart with gaps.</figcaption>
...
<Callout variant="tip">
  This list isn't complete. We're currently reviewing the full list of metrics
  that can cause data gaps.
</Callout>
