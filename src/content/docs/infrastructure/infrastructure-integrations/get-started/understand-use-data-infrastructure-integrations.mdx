...
* View dashboards: You can find your dashboards in the New Relic UI. Go to <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure**</DNT> and look for your data. 
