...
New Relic GCP integrations query your GCP services according to a polling interval, which varies depending [on the integration](#manage-polling). New Relic applies the polling interval to every GCP entity.
