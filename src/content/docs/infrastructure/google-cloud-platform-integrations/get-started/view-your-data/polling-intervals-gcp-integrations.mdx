...
For ongoing collection, data typically appears in New Relic within 1-2 minutes after being collected from GCP, in addition to the polling interval itself.
