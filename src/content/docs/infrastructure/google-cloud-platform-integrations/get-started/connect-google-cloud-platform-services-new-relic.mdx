...
To start receiving Google Cloud Platform (GCP) data with [New Relic GCP integrations](/docs/introduction-google-cloud-platform-integrations), connect your Google project to New Relic [infrastructure monitoring](/docs/infrastructure). If you do not have one already, [create a New Relic account](https://newrelic.com/signup). It's free, forever.
