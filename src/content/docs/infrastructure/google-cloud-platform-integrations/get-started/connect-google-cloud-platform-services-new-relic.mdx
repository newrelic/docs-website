...
1. Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > GCP**. At the top of Infrastructure's **Google Cloud Services** integrations page, select **Add a GCP account**.
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        1. From **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > GCP > Manage services**.
