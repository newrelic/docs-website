  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        - <DNT>[Cloud Resource Manager API](https://console.cloud.google.com/apis/library/cloudresourcemanager.googleapis.com):</DNT> Create, read, and update metadata for GCP resource containers.
      </td>
    </tr>
