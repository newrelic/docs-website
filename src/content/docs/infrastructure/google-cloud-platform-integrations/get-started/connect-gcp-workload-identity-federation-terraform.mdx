---
title: Connect with WIF using Terraform
tags:
  - Integrations
...
For the manual setup, see [Connect with Workload Identity Federation](/docs/infrastructure/google-cloud-platform-integrations/get-started/connect-gcp-workload-identity-federation).
...
- GCP project with the required APIs enabled (see [Requirements](/docs/infrastructure/google-cloud-platform-integrations/get-started/connect-gcp-workload-identity-federation#requirements))
...
<Callout variant="tip">
  This is a reference example. Adapt the values to your project, region, and New Relic account. A full working Terraform module will be available in the Terraform Registry.
</Callout>
