...
For the manual setup, see [Manually integrate your Google Cloud Platform](/docs/infrastructure/google-cloud-platform-integrations/get-started/connect-gcp-workload-identity-federation).
