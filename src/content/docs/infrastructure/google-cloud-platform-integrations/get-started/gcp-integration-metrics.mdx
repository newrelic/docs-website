...
The following table lists some of the metrics collected by the GCP integrations and their [dimensional metrics](/docs/telemetry-data-platform/ingest-manage-data/understand-data/new-relic-data-types/#dimensional-metrics) translations.
