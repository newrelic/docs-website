...
<Callout variant="tip">
  Firebase AI Logic also exposes Prompt Template metrics (`render_count` and `render_latency`) on a separate monitored resource. Those are a preview feature and aren't collected by this integration.
</Callout>
