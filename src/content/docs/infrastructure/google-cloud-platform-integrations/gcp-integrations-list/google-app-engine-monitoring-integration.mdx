...
<Callout variant="important">
  Different metrics are available depending on whether your application is running in a [standard or flexible environment](#features), so some metrics may not be available for your application.
</Callout>
