...
* The <DNT>**Google App Engine Flexible environment**</DNT> runs applications within <DNT>Docker/DNT> containers and is suitable for applications that require configurable, gradual scaling.
