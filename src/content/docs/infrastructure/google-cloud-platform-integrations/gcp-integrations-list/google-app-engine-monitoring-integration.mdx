...
* The <DoNotTranslate>**Google App Engine Standard environment**</DoNotTranslate> provides a set of preconfigured runtimes and is suitable for applications that require fully-managed, fast scaling.
* The <DoNotTranslate>**Google App Engine Flexible environment**</DoNotTranslate> runs applications within Docker containers and is suitable for applications that require configurable, gradual scaling.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > GCP > Google App Engine**</DoNotTranslate>.
      </td>
    </tr>
