...
<CollapserGroup>
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            Indicates whether job is currently in a particular state or not. True indicates in that state and False indicates exited that state.
          </td>
        </tr>
  ...
  <Collapser
    id="metrics-only-batch"
    title="Batch — 1 metric"
  >
    <table>
      <thead>
        <tr>
  ...
  <Collapser
    id="metrics-only-session"
    title="Session — 1 metric"
  >
    <table>
      <thead>
        <tr>
