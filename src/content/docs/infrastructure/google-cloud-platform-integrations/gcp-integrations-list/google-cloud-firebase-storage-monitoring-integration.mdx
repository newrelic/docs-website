...
[New Relic integrations](/docs/infrastructure/introduction-infra-monitoring) with the [Google Cloud Platform (GCP)](https://cloud.google.com/) include one that reports [Google Firebase Storage](https://firebase.google.com/products/storage) data to New Relic. This document explains how to activate the GCP Firebase Storage integration and describes the data it reports.
