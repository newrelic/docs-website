...
<Callout variant="important">
  Cloud Pub/Sub supports 1-minute polling intervals for WIF integrations in limited preview. To request access, contact [New Relic support](https://support.newrelic.com/).
</Callout>
