...
1. Make sure you have [installed the infrastructure agent](/docs/infrastructure/new-relic-infrastructure/installation) before activating GCP integrations from New Relic.
