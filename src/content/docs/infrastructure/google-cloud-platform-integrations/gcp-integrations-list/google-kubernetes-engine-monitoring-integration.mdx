...
<Callout variant="important">
  **Recommended: Use the New Relic Kubernetes integration for GKE.**

  With Workload Identity Federation, the GCP integration does not collect metrics or create entities for Google Kubernetes Engine. For full GKE observability in New Relic — including cluster, node, pod, and container entities, metrics, dashboards, and alerting — install the [New Relic Kubernetes integration](https://docs.newrelic.com/docs/kubernetes-pixie/kubernetes-integration/installation/kubernetes-integration-install-configure/) on your GKE cluster.
</Callout>
