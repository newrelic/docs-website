...
[New Relic's integrations](/docs/infrastructure/introduction-infra-monitoring) with the [Google Cloud Platform (GCP)](https://cloud.google.com/) include one that reports [Google Cloud AlloyDB](https://cloud.google.com/alloydb) data to New Relic. This document explains how to activate the GCP AlloyDB integration and describes the data it reports.
...
After you enable the integration, your AlloyDB resources appear as entities in the New Relic entity explorer. To see dashboards and manage services, go to <DNT>[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > GCP</DNT>.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Total AlloyDB storage across the entire cluster.
      </td>
    </tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Mean number of active and idle connections to the AlloyDB instance across serving nodes.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Number of rolled back transactions across all serving nodes of the instance.
      </td>
    </tr>
