...
After activating the integration and then waiting a few minutes (based on the [polling frequency](#polling)), data will appear in the UI. To [view and use your data](/docs/infrastructure/integrations/find-use-infrastructure-integration-data), including links to your <InlinePopover type="dashboards" /> and alert settings, go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > GCP**</DoNotTranslate>, then select an integration.
