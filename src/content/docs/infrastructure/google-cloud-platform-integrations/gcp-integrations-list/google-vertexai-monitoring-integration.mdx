...
[New Relic integrations](/docs/infrastructure/introduction-infra-monitoring) with the [Google Cloud Platform (GCP)](https://cloud.google.com/) include one that reports [Google Cloud Vertex AI](https://cloud.google.com/vertex-ai) data to New Relic. This document explains how to activate the GCP Vertex AI integration and describes the data it reports.
...
<CollapserGroup>
  <Collapser
    id="metrics-only-publisher-model"
    title="Publisher Model — 15 metrics"
  >
    <table>
      <thead>
        <tr>
  ...
  <Collapser
    id="metrics-only-deployment-resource-pool"
    title="Deployment Resource Pool — 8 metrics"
  >
    <table>
      <thead>
        <tr>
  ...
  <Collapser
    id="metrics-only-reasoning-engine"
    title="Reasoning Engine — 8 metrics"
  >
    <table>
      <thead>
        <tr>
  ...
  <Collapser
    id="metrics-only-index-endpoint"
    title="Index Endpoint — 6 metrics"
  >
    <table>
      <thead>
        <tr>
  ...
  <Collapser
    id="metrics-only-model"
    title="Model — 3 metrics"
  >
    <table>
      <thead>
        <tr>
  ...
  <Collapser
    id="metrics-only-online-evaluator"
    title="Online Evaluator — 2 metrics"
  >
    <table>
      <thead>
        <tr>
