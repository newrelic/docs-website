...
<CollapserGroup>
  <Collapser
    id="metrics-only-materialized-view"
    title="Materialized View — 5 metrics"
  >
    <table>
      <thead>
        <tr>
      ...
      <tbody>
        <tr>
          ...
          <td>
            Amount of data used by intermediate processing for the materialized view in bytes.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Upper bound of processing delay for the materialized view.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Amount of data used for the materialized view storage in bytes.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Number of errors from system for the materialized view.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Number of errors from user data for the materialized view.
          </td>
        </tr>
      </tbody>
    </table>
  ...
  <Collapser
    id="metrics-only-backup"
    title="Backup — 1 metric"
  >
    <table>
      <thead>
        <tr>
