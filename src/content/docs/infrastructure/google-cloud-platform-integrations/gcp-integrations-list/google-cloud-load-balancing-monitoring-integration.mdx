---
title: <DNT>Google Cloud Load Balancing</DNT> monitoring integration
tags:
  - Integrations
  - Google Cloud Platform integrations
  - GCP integrations list
metaDescription: 'New Relic''s <DNT>Google Cloud Load Balancing</DNT> integration: how to activate it and what data it reports.'
redirects:
