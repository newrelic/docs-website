...
<CollapserGroup>
  ...
  <Collapser
    id="alerts"
    title="View host's alert threshold alert events"
  >
    To view one or more host's [alert threshold events](/docs/alerts/new-relic-alerts/getting-started/alerts-glossary#alert-threshold), select the host's <DNT>**Critical**</DNT> <Icon name="fe-x-circle"/>
