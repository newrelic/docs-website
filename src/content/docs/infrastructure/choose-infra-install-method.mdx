...
<ButtonGroup>
  ...
  <ButtonLink
    ...
    variant="primary"
  >
    Guided install for JP region
  </ButtonLink>
</ButtonGroup>

## Install and manage via New Relic Control [#newrelic-control]

If you want New Relic Control to orchestrate installation, upgrades, and remote configuration of the infrastructure agent instead of managing it yourself, use Agent Control (with Fleet Control for remote config).

* Install and manage infrastructure agent using [New Relic Control](/docs/new-relic-control/fleet-control/setup/).
