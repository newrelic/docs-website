...
* A [API key](/docs/apis/rest-api-v2/getting-started/introduction-new-relic-rest-api-v2#api_key) (`$API_KEY`)
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <DNT>**Recommendation:**</DNT> Use `where_clause` when creating a new condition.
      </td>
    </tr>
