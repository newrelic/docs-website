  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        The [incident time limit](/docs/alerts/alert-conditions/create-alert-conditions/#close-open-incidents) setting, expressed as hours. Possible values are `0`, `1`, `2`, `4`, `8`,`12`, `24`, `48`, `72`. This determines how much time will pass before an incident is automatically closed.
