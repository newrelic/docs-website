    ...
    <tr>
      ...
      <td>
        ...
        **Solution:**
        ...
        Use the **CPU** chart on our [**Hosts** page](/docs/infrastructure/new-relic-infrastructure/infrastructure-ui-pages/infrastructure-compute-page-measure-resource-usage) to create an alert condition for system metrics.
      </td>
    </tr>
