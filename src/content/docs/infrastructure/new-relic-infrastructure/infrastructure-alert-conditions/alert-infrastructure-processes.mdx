...
8. Optional: Add a [runbook url](/docs/alerts/alert-conditions/provide-runbook/).
9. Optional: Set the [<DNT>**Close open incidents after**</DNT>](/docs/alerts/alert-conditions/create-alert-conditions/#close-open-incidents) time limit to automatically close open incidents after a certain amount of time (this defaults to 24 hours for infrastructure conditions).
