...
<CollapserGroup>
  ...
  >
    Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert policies > New alert policy > Create new condition**</DoNotTranslate>, then select <DoNotTranslate>**Infrastructure**</DoNotTranslate> as the product.
  </Collapser>
