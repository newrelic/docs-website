...
<CollapserGroup>
  ...
  >
    Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alerts > Alert policies > New alert policy > Create new condition**</DoNotTranslate>, then select <DoNotTranslate>**Infrastructure**</DoNotTranslate> as the product.
  </Collapser>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * For policies only needing [email notifications](#notification): Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > Settings > Alerts > Create a new policy**</DoNotTranslate>, and add one or more email addresses as needed.
