...
<Callout variant="important">
  If New Relic hasn't received a Cloud Integration service's attribute in the past 60 minutes, then it won't be selectable for alerting in the UI. You can use the [API](/docs/infrastructure/new-relic-infrastructure/infrastructure-alert-conditions/rest-api-calls-new-relic-infrastructure-alerts/) to create an alert condition for silent attributes.  
</Callout>
...
<CollapserGroup>
  ...
  >
    Go to **[one.newrelic.com](http://one.newrelic.com) > Infrastructure**, then select any of these Infrastructure monitoring pages: [**Hosts**](/docs/infrastructure/new-relic-infrastructure/infrastructure-ui-pages/infrastructure-compute-page-measure-resource-usage), [**Processes**](/docs/infrastructure/new-relic-infrastructure/infrastructure-ui-pages/infrastructure-processes-page-inspect-process-performance), [**Network**](/docs/infrastructure/new-relic-infrastructure/infrastructure-ui-pages/infrastructure-network-page-measure-compare-capacity), or [**Storage**](/docs/infrastructure/new-relic-infrastructure/infrastructure-ui-pages/infrastructure-storage-page-evaluate-disk-usage-efficiency). Mouse over the chart you want to alert on, select the ellipses <Icon name="fe-more-horizontal"/> icon, and then select **Create alert**.
  </Collapser>
    <Collapser
    className="freq-link"
    id="infrastructure-settings"
    title="Use the Infrastructure settings"
  >
