...
<CollapserGroup>
  ...
  >
    Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI > Alerts > Alert policies > New alert policy > Create new condition**, then select **Infrastructure** as the product.
  </Collapser>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * For policies only needing [email notifications](#notification): Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > Settings > Alerts > Create a new policy**, and add one or more email addresses as needed.
