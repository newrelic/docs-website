...
## Create alert conditions for infrastructure metrics [#metrics]

To create an alert condition for your infrastructure metrics, use one of these methods:
...
## Create alert conditions for infrastructure integrations [#integrations]

To create an alert condition for one of your infrastructure integrations, use these steps:
...
The configuration settings are optional and you can always update them later.
