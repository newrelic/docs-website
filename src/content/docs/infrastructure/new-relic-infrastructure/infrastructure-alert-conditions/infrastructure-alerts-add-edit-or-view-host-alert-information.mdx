...
<CollapserGroup>
  ...
  >
    ...
    3. Mouse over the chart you want to alert on, select the ellipses <Icon name="fe-more-horizontal"/> icon, and then select <DNT>**Create alert**</DNT>.
  </Collapser>
