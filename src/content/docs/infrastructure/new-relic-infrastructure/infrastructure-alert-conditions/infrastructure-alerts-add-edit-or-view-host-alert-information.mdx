...
9. Optional: Set the [**Close open incidents after**](#incident-time-limit) time limit to automatically close open incidents after a certain amount of time (this defaults to 24 hours for infrastructure conditions).
10. Select **Create**.
