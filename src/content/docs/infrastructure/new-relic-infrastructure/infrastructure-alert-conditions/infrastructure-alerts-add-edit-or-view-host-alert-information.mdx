...
<CollapserGroup>
  ...
  >
    Go to **[one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Alerts > Alert policies > New alert policy > Create new condition**, then select **Infrastructure** as the product.
  </Collapser>
  ...
  >
    ...
    1. Go to **[one.newrelic.com](https://one.newrelic.com) > Infrastructure > Settings > Alerts**, and then click **Create alert condition**.
...
1. Go to **[one.newrelic.com](https://one.newrelic.com) > Infrastructure > Events**.
...
1. Go to **[one.newrelic.com](https://one.newrelic.com) > Infrastructure > Settings > Alerts**.
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * For policies only needing [email notifications](#notification): Go to **[one.newrelic.com](https://one.newrelic.com) > Infrastructure > Settings > Alerts > Create a new policy**, and add one or more email addresses as needed.
