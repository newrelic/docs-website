...
Your New Relic <InlinePopover type="infrastructure" /> agent is up and running, but when your CPU reaches a high percentage of usage, the agent stops intermittently to submit data.
