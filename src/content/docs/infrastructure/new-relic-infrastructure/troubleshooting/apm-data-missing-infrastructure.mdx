...
When APM and infrastructure agents are installed on the same hosts and use the same New Relic [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key), APM data should appear in **infrastructure**, and vice versa. If you do not see this APM-infrastructure linkage, follow these troubleshooting tips.
