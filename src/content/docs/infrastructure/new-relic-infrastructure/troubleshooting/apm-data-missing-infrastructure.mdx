...
When <InlinePopup type="apm" /> and infrastructure agents are installed on the same hosts and use the same New Relic <LicenseKey/>, APM data should appear in **infrastructure**, and vice versa. If you do not see this APM-infrastructure linkage, follow these troubleshooting tips.
