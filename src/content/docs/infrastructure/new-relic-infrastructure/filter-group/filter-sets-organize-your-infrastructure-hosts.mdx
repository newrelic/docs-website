...
With New Relic <InlinePopover type="infrastructure" />, you can combine filters into a filter set to organize hosts based on criteria that matter the most to you. Your account may have hundreds of hosts reporting to it, so focusing on what's important is crucial for being able to troubleshoot effectively. To learn how to use filter sets efficiently, watch this short video (approx. 2:50 minutes).
...
1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure** and click **Hosts**, **Inventory**, or **Events**.
...
1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > Settings > Filter sets**.
