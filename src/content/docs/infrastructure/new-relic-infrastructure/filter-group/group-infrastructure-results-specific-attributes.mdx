...
<CollapserGroup>
  ...
  >
    On the **[Filter sets](/docs/infrastructure/new-relic-infrastructure/filter-group/organize-infrastructure-hosts-filter-sets)** sidebar, you see [alert threshold violations](/docs/alerts/new-relic-alerts/getting-started/alerts-glossary#alert-threshold) as **Critical** <i className="fa fa-times-circle-o">
    times-circle-o
    </i>
