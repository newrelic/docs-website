...
The Infrastructure agent can be configured to send its own logs to [New Relic Logs](https://docs.newrelic.com/docs/logs/new-relic-logs/get-started/introduction-new-relic-logs). This can be useful for troubleshooting issues with log forwarding, the Infrastructure agent, or when contacting [support](https://support.newrelic.com/ "Link opens in a new window.").
