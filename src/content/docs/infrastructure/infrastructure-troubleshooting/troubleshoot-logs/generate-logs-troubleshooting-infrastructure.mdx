...
When troubleshooting your <InlinePopover type="infrastructure" /> agent, generate `debug` logs for a few minutes to find and investigate errors. This can be useful for your own troubleshooting or when working with New Relic Support.
