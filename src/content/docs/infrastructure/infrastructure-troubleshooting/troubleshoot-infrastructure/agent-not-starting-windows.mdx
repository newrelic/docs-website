...
When trying to start the service manually from <DNT>**Windows Services**</DNT> it fails with an error such as:
...
<Callout variant="important">
  To read about the agent's location and how to modify it, see [how to configure the agent directory](/docs/infrastructure/install-infrastructure-agent/windows-installation/zip-manual-install-infrastructure-agent-windows/#agent-directory).
</Callout>
