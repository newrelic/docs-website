...
You installed the <InlinePopover type="infrastructure" /> agent and waited a few minutes, but no data appears in the [infrastructure UI](/docs/infrastructure/new-relic-infrastructure/infrastructure-ui-pages/infrastructure-compute-page-measure-resource-usage).
