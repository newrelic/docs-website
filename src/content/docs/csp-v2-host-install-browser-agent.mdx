...
3. Save the text file as `nr-spa-VERSION_NUMBER.min.js`, where <var>VERSION_NUMBER</var> is the [latest Browser agent version](/docs/release-notes/new-relic-browser-release-notes/browser-agent-release-notes).
