...
- Read "[What is an entity?](/docs/new-relic-one/use-new-relic-one/core-concepts/what-entity-new-relic/)" to learn more about New Relic entities and how to synthesize your own. This will help you get more mileage from your <DoNotTranslate>**Kentik default**</DoNotTranslate> entities.
