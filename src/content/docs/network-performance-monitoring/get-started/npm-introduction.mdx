...
* <DNT>**Cloud flow logs**</DNT>: It details communications between hosts and other services by capturing source and destination IP address and port, metadata that describes both endpoints, key network performance telemetry, and the state of a specific communication attempt. Set up cloud flow log monitoring for [AWS VPC](/docs/network-performance-monitoring/setup-performance-monitoring/cloud-flow-logs/aws-vpc-flow-log-monitoring), [Azure VNet](/docs/network-performance-monitoring/setup-performance-monitoring/cloud-flow-logs/azure-vnet-flow-log-monitoring), or [GCP VPC](/docs/network-performance-monitoring/setup-performance-monitoring/cloud-flow-logs/gcp-vpc-flow-log-monitoring).
