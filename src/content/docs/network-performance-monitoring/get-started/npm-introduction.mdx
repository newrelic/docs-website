...
Network monitoring adds the context of network data to the application and infrastructure data you already collect in [New Relic](https://one.newrelic.com). By monitoring your network data, you can:
...
No credit card required. Already have an account? [Login](https://one.newrelic.com/).
...
- **Device performance via SNMP**: Simple Network Management Protocol (SNMP) is an application–layer protocol for exchanging management information between network devices. To send SNMP data to [New Relic](https://one.newrelic.com), [set up SNMP data monitoring](/docs/network-performance-monitoring/setup-performance-monitoring/snmp-performance-monitoring).
...
- **Network flow logs**: It captures information about the IP traffic going to and from network interfaces in your on-premises network. To send network flow data to [New Relic](https://one.newrelic.com), [set up network flow data monitoring](/docs/network-performance-monitoring/setup-performance-monitoring/network-flow-monitoring).
