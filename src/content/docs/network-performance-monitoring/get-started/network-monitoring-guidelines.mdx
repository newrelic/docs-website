---
title: Guidelines for network monitoring
tags:
  - Network monitoring
  - Guidelines
translate:
  - kr
  - jp
metaDescription: Review guidelines for network monitoring.
---
...
The most common need for ongoing maintenance is in keeping the list of target devices accurate. Depending on your environment needs, we recommend the following discovery processes to add devices to your configuration file:
