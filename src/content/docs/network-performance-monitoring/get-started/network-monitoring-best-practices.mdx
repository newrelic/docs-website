...
The most common need for ongoing maintenance is in keeping the list of target devices accurate. There are three main discovery methods to update target devices: automatic discovery, manual discovery, and manual device addition.
