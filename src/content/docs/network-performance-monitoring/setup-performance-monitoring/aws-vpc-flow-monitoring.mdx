...
Set up your cloud flow logs to send them to New Relic One.
...
## Set up cloud flow logs monitoring in New Relic One [#setup-aws-vpc-flow-logs-monitoring]

To send your cloud flow logs to New Relic One, follow these steps:
