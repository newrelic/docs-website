...
Set up your AWS VPC flow logs to send them to New Relic.
...
## Set up AWS VPC flow logs monitoring in New Relic [#setup-aws-vpc-flow-logs-monitoring]

To send your VPC flow logs to New Relic, follow these steps:
