...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [New Relic Metric
        API](/docs/data-apis/ingest-apis/metric-api/introduction-metric-api/#requirements)
        US Endpoint: ``` https://metric-api.newrelic.com ``` EU
        Endpoint: ``` https://metric-api.eu.newrelic.com ```
      </td>
      <td>443</td>
      <td>TCP</td>
    </tr>
    ...
    <tr>
      <td>Outbound</td>
      <td>Docker host</td>
      <td>Target devices for SNMP polling</td>
      <td>161 (default)</td>
      <td>UDP</td>
    </tr>
    <tr>
      <td>Inbound</td>
      <td>Source devices for SNMP Trap data</td>
      <td>Docker host</td>
      <td>162 (default)</td>
      <td>UDP</td>
    </tr>
