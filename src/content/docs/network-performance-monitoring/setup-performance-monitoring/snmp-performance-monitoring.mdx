...
### Network security prerequisites [#prerequisites-network]
    ...
    <tr>
      ...
      <td>
        ...
        EU Endpoint: `insights-collector.eu01.nr-data.net`
      </td>
...
3. Follow the steps in New Relic.
   ...
   <figcaption>
   **[one.newrelic.com](https://one.newrelic.com)** > **Add more data** > **Network monitoring** > **SNMP** to set up SNMP data monitoring.
   </figcaption>
