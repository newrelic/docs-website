...
1. On a Linux host with Docker installed, download the **ktranslate** image from [Docker Hub](https://hub.docker.com/) by running
  ```shell
  docker pull kentik/ktranslate:v2
  ```

  or from [Quay.io](https://quay.io/) by running
  ```shell
