...
Set up your network devices using our Guided Installation so they send network data to New Relic.
...
Configured network devices for SNMP polling from the **ktranslate** docker container. Some samples of basic SNMP configurations can be found here (this is not an all-inclusive list):
* Cisco
...
<CollapserGroup>
  ...
  >
    ...
    3. Follow the steps outlined in the guided installation process. You can use Docker or Linux.
       ...
       <figcaption>
       **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Add more data > Network > SNMP** to set up SNMP data     monitoring.
       </figcaption>
