...
It is recommended that the SNMP monitoring agent be deployed as a container for either Docker or Podman.  If required, it can alternatively be installed as a baremetal service in Linux.
...
<CollapserGroup>
  ...
  <Collapser id="guided-install-setup" title="Guided install setup">
    ...
    2. Scroll down until you see <DoNotTranslate>**Network**</DoNotTranslate> and click <DoNotTranslate>**SNMP**</DoNotTranslate>.
    3. Follow the steps outlined in the guided installation process. You can use Docker, Podman, or Linux.
      ...
      <figcaption>
        <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/ll-capabilities) > Add more data > Network > SNMP**</DoNotTranslate> to set up SNMP data monitoring.
      </figcaption>
