...
5. Run `ktranslate` to poll target devices. Use the following example:
  ...
  kentik/ktranslate:v2 \
    ...
    nr1.snmp 
  ```
6. To get better visibility into your network, [set up network flow data monitoring](https://docs-preview.newrelic.com/docs/integrations/kentik-network-performance-monitoring/setup-performance-monitoring/network-flow-monitoring).
7. [Visualize your network performance data in New Relic](https://docs-preview.newrelic.com/docs/integrations/kentik-network-performance-monitoring/monitoring-network-data/visualize-network-data).
