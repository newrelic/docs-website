...
import networkAwsVpcFlowLogsIo from 'images/network_screenshot-crop_aws-vpc-flow-logs-io.png'

import networkKinesisForehoseAwsVpcFlowLogs from 'images/network_screenshot-crop_kinesis-forehose-aws-vpc-flow-logs.png'
...
<Callout variant="tip">
We automatically generate a new [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) to be used for this data ingest. To regenerate a key, click **Generate and use a new key**.
