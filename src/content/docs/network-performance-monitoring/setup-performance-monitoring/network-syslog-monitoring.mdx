...
import syslogGuidedInstall from 'images/syslog-guided-install.png'
...
3. Follow the steps in New Relic One.
   <img
     src={syslogGuidedInstall}
     title="Syslog guided setup"
     alt="Syslog guided setup"
   />
   <figcaption>**[one.newrelic.com](https://one.newrelic.com)** > **Add more data** >
