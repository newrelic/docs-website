...
- A New Relic account ID. Learn how to [find your account ID](/docs/accounts/accounts-billing/account-setup/account-id/).
- A New Relic license key. Learn how to [generate a new License key](/docs/apis/intro-apis/new-relic-api-keys/#ingest-license-key).
...
<Callout variant="tip">
  If you're already monitoring SNMP data devices that send network syslog,
...
<Callout variant="tip">
  `ktranslate` handles syslog in the [RFC3164](https://datatracker.ietf.org/doc/html/rfc3164), [RFC5424](https://datatracker.ietf.org/doc/html/rfc5424), and [RFC6587](https://datatracker.ietf.org/doc/html/rfc6587) formats.
</Callout>
