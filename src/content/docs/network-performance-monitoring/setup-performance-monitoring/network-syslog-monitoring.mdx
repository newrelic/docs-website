...
3. Follow the steps in New Relic.  At this time the available install methods are Docker and Linux package manager.

   <img title="Syslog guided setup" alt="Syslog guided setup" src={networkSyslogGuidedInstall}/>  
