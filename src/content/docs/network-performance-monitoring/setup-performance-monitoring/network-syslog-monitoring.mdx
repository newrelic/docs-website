...
<CollapserGroup>
    ...
    <Collapser id="docker" title="Docker prerequisites">
      We recommend using a <DNT>Docker/DNT> container to deploy the agent for syslog message collection. To use it, you need:
...
<CollapserGroup>
  ...
  <Collapser id="guided-install-setup" title="Set up with the guided install">
    ...
    3. Follow the steps outlined in the guided installation process. You can use <DNT>Docker/DNT> or Linux.
