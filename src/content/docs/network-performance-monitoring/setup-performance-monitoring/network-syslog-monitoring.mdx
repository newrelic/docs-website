...
* Network access as defined in the [network prerequisites](/docs/network-performance-monitoring/setup-performance-monitoring/network-syslog-monitoring/#prerequisites-network-security)
