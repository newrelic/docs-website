...
Before you begin, make sure you have the New Relic, <DNT>Docker/DNT>, Meraki, and Network security prerequisites:
...
<Tabs>
  ...
  <TabsBar>
    ...
    <TabsBarItem id="dockerExistingContainer">Existing <DNT>Docker/DNT> container</TabsBarItem>
    <TabsBarItem id="dockerDedicatedContainer">Dedicated <DNT>Docker/DNT> container</TabsBarItem>
