...
4. Run `ktranslate` to poll network flow devices by entering the following commands:
  ...
  kentik/ktranslate:v2 \
    ...
    nr1.flow
  ```
5. To get better visibility into your network, [set up SNMP monitoring](/docs/network-performance-monitoring/setup-performance-monitoring/snmp-performance-monitoring).  
