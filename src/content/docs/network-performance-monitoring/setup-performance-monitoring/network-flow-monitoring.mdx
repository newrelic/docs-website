...
3. Follow the steps in New Relic.
   ...
   <img title="Network Flows guided setup" alt="Network Flows guided setup" src={networkNetworkGuidedInstall}/>

   <figcaption>
   **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Add more data > Network monitoring > Network Flows** to set up network flow data monitoring.
   </figcaption>
