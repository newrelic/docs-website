...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="Supported types of network flow data"
  >
...
## Set up network flow data monitoring in New Relics [#setup-network-flow-monitoring]
...
3. Follow the steps in the New Relic UI.
   ...
   **Network performance monitoring** > **Network Flows** to set up network
   flow data monitoring.</figcaption>
