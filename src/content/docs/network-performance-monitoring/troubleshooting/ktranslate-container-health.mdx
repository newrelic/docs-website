...
<table>
  <thead>
    ...
    <tr>
      ...
      <td>
        Rate of internal health checks. Shows mostly that things are not deadlocked and should always be > `0`.
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td>
        Gauge rate with number of available pre-allocated buffers. It should be ~8,000.
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td>
        Gauge to monitor if SNMP polling is working. (`1` == Good, `2` == Fail, faceted by `device_name`)
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Flows per second (fps) received over the last 60 seconds for all device flow data (IPFIX, NetFlow, sFlow).
      </td>
    </tr>
    <tr>
      <td>
