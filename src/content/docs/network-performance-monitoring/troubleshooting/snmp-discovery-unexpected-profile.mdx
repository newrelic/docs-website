...
In this case, you can manually override the matching from the discovery job using the <DoNotTranslate>**bang (!)**</DoNotTranslate> syntax: `"!profile-name.yml"`, which allows you to force any profile you desire:
