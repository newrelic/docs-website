    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td> Used to convert hexadecimal values into integer format. Options for <DNT>**current**</DNT>: `LittleEndian` | `BigEndian`. Options for <DNT>**desired**</DNT>: `uint16` | `uint32` | `uint64` </td>
        </tr>
        <tr>
