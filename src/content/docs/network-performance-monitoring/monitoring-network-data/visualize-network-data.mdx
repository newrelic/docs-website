...
There are several custom curated visualizations designed specifically for network performance montoring.

## Prerequisites [#prerequisites]

- Having set up your network performance monitoring devices.
- Add the custom visualizations app to your account:
    1. Go to [one.newrelic.com](https://www.one.newrelic.com) > **Apps**, and search for **Network Agent Visualizations**.
    2. Click the app, and then click **Open visualization**.
      ![Open visualization](./img/open_viz.png "Open visualization")
      <figcaption>
      [one.newrelic.com](https://www.one.newrelic.com) > **Apps**, and search for **Network Agent Visualizations**.
      </figcaption>
...
1. Go to [one.newrelic.com](https://www.one.newrelic.com) > **Apps**, and search for **Quickstarts**.
2. Click **Quickstarts**, and in the search bar, search for **Network** and click one of the dashboards:
  ...
  <figcaption>
  [one.newrelic.com](https://www.one.newrelic.com) > **Apps**, and search for **Network**.
  </figcaption>
3. Click **Import**, and
...
Once you've set up your dashboards and visualizations, you can start exploring the network data your devices are reporting to New Relic One.

- In [one.newrelic.com](https://www.one.newrelic.com) > **Explorer**:
...
- In [one.newrelic.com](https://www.one.newrelic.com) > **Dashboards** you have an overview of your network performance data in the dashboards you imported.