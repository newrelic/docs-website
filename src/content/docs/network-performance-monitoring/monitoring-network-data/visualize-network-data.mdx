...
Once you've finished setting up these visualizations, you can start seeing your network data by going to:
...
- **[one.newrelic.com](https://one.newrelic.com)** > **Dashboards**:
    - An overview of your network performance data in the dashboards you imported:
      - For SNMP data, you'll see the following dashboard:
        ![SNMP data monitoring](./img/dashboard_Routers_and_Switches.png "SNMP data monitoring")
        <figcaption>
          Dashboard for SNMP data monitoring in New Relic One.
        </figcaption>
