...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>[AWS_DEFAULT_REGION](https://docs.aws.amazon.com/sdkref/latest/guide/setting-global-region.html)</td>
...
<Callout variant="tip">
  You need to create dedicated secrets per value, note in the example above there are 3 distinct secret names in use.
</Callout>
