...
2. In <DoNotTranslate>**Find logs where**</DoNotTranslate>, enter `collector.name:"ktranslate"` and click <DoNotTranslate>**Query logs**</DoNotTranslate>.
...
1. Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Query your data**</DoNotTranslate>.
