...
This is the most common and simple scenario, for cases where you do not have the time or expertise with SNMP to do these yourself. After you provide the relevant data, our team will build the profile for you.
...
<Callout variant="tip">
  Be sure to pass your custom version of the profiles in every time you launch a discovery container or SNMP polling container. If you do not use it consistently for all SNMP instances sets, this can cause unreliable behavior.
</Callout>
