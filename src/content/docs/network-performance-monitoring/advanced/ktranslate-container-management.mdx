...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Environment variable that can be used during Docker runtime to setup <DNT>**ktranslate's**</DNT> `response_time` \| `ping_only` configuration to use privileged mode for ICMP packets instead of the default UDP packets used in unprivileged mode.
      </td>
    </tr>
