...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Environment variable that must be used during Docker runtime to hold the New Relic <LicenseKey/> for **ktranslate** to send data to the New Relic APIs. Ex: `-e NEW_RELIC_API_KEY=$LICENSE_KEY`.
      </td>
    </tr>
