...
This is a glossary of terms that appear in contracts for our [original product-based pricing](/docs/accounts/original-accounts-billing/product-pricing/product-based-pricing/). For New Relic One pricing plan terms, see [New Relic One pricing definitions](/docs/licenses/license-information/product-definitions/new-relic-one-pricing-definitions).
