...
This is a glossary of terms that appear in contracts for our [original product-based pricing](/docs/accounts/original-accounts-billing/product-pricing/product-based-pricing/). For our usage-based pricing model terms, see [Usage-based pricing definitions](/docs/licenses/license-information/product-definitions/new-relic-one-pricing-definitions).
...
<CollapserGroup>
  ...
  >
    An **incident event** is an alerting event (open, closed, etc.) created by an alerting engine that is sent into the New Relic alerts platform (non-unique) for de-duplication, flapping detection, smart suppression, enrichment, and correlation.
  </Collapser>
