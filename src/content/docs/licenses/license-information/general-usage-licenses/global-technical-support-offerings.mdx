...
We're here to help you get everything you need from New Relic's platform. To begin with, we recommend that all New Relic users become familiar with these resources:
...
<CollapserGroup>
  ...
  >
    We are happy to help troubleshoot issues related to New Relic's platform that may be causing issues with a script or query. We cannot provide solutions for specific script or query use cases. [New Relic Documentation](https://docs.newrelic.com/) and [New Relic University](https://learn.newrelic.com/) offer resources on how to construct custom scripts and queries.
  </Collapser>
...
* Troubleshooting problems with the Community Plus Projects on New Relic's platform
