...
<Callout variant="important">
For more information on OpenTelemetry support, see our [/docs/licenses/license-information/general-usage-licenses/global-technical-support-offerings#otel_support](OpenTelemetry support documentation).
</Callout>
...
- You can receive troubleshooting assistance on the processing and exporting of your OpenTelemetry data to New Relic One when transmitting it to us over the OpenTelemetry Protocol (OTLP) protocol from your community provided OpenTelemetry Clients / SDKs or the OpenTelemetry Collector. 
