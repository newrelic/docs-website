...
<CollapserGroup>
  ...
  >
    We are happy to help troubleshoot issues related to the New Relic One platform that may be causing issues with a script or query. We cannot provide solutions for specific script or query use cases. [New Relic Documentation](/) and [New Relic University](https://learn.newrelic.com/) offer resources on how to construct custom scripts and queries.
  </Collapser>
