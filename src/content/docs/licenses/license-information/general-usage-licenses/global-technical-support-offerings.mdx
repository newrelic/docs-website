...
<CollapserGroup>
  ...
  >
    The New Relic One Support Plan below applies only to a customer’s paid subscription on the [New Relic One pricing model](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing).
    ...
    * If you have not upgraded or changed to the [New Relic One pricing model](/docs/accounts/accounts-billing/new-relic-one-pricing-users/pricing-billing), your existing support plan still applies.
...
<CollapserGroup>
  ...
  >
    New Relic offers a [diagnostics utility](/docs/using-new-relic/cross-product-functions/troubleshooting/new-relic-diagnostics) that can automatically detect common problems with New Relic agents. If Diagnostics detects a problem, it suggests troubleshooting steps. New Relic Diagnostics can also automatically attach troubleshooting data to a New Relic Support case. We have also made available [Troubleshooting Frameworks](https://discuss.newrelic.com/t/troubleshooting-frameworks/108787) that step users through common troubleshooting questions.
  </Collapser>
...
<Callout variant="important">
  As of March 10, 2021, you're no longer able to create a New Relic support case by emailing [support@newrelic.com](mailto:support@newrelic.com).

  If you have ticketed support as part of your subscription, when logged into your New Relic account, go to [one.newrelic.com](https://one.newrelic.com/) to create a support case. Once you're there, follow these steps:

  1. Click the **?** icon in the upper right hand corner.
  2. Click **I need more help**.
  3. Select **Create a Support case**.

     By creating a support case directly within your account, it will speed up the support process and improve our team’s ability to troubleshoot your issue more effectively.
</Callout>
