...
* **[New Relic Community Forum](https://support.newrelic.com/):** Thousands of customer questions asked and answered.
* **[New Relic Diagnostics](https://docs.newrelic.com/docs/new-relic-solutions/solve-common-issues/diagnostics-cli-nrdiag/diagnostics-cli-nrdiag/):** Diagnose and troubleshoot installation and configuration.
...
<CollapserGroup>
  <Collapser
    className="freq-link"
    id="type1-community"
    title="Type 1: New Relic Community Support"
  >
    [New Relic Support Forum](https://support.newrelic.com/) is available to everyone and provides OpenTelemetry focused documentation, examples, and best practices to help you get up and running. Our public [troubleshooting frameworks](https://knowledge.newrelic.com/s/?c__tags=%5B%7B%22id%22%3A%22a9PPh0000002c0RMAQ%22%2C%22isCustomImage%22%3Afalse%2C%22sObjectType%22%3A%22Tag__c%22%2C%22subtitle%22%3A%22%22%2C%22title%22%3A%22General%20troubleshooting%22%2C%22titleFormatted%22%3A%22General%20%3Cstrong%3Etro%3C%2Fstrong%3Eubleshooting%22%2C%22subtitleFormatted%22%3A%22%22%2C%22icon%22%3A%22standard%3Adefault%22%7D%5D) are a good resource if you run into issues. If you need a little more individualized help, you can engage with our support team through the New Relic Support Forum by creating a topic, and a member of our team will respond to your inquiry.
  ...
  <Collapser
    className="freq-link"
    id="type2-maintained"
    title="Type 2: New Relic Maintained OpenTelemetry Tools"
  >
    The following tools are supported in accordance with New Relic's Support Policy:

    **In-scope OpenTelemetry tools:**

    * **New Relic OpenTelemetry Collector Configuration:** Collector deployments using the New Relic-provided configuration file or Docker image (including specific receivers and processors available in NRDOT).
    * **Data Ingestion & Backend Processing:** Issues related to data latency, query accuracy, metricization, tracing correlation, and UI visualization for data that has been successfully received by the New Relic OTLP endpoint.
    * **Code that we write that supplements OpenTelemetry:** Such as the K8s OpenTelemetry Helm chart and all the capabilities included in it.
  </Collapser>

  <Collapser
    className="freq-link"
    id="type3-upstream"
    title="Type 3: Basic Troubleshooting and Upstream to OpenTelemetry Core"
  >
    The OpenTelemetry project is an open source community project. New Relic's ability to support issues that come up with the upstream project is limited to providing initial guidance and triage for issues in standard (not customized or private) vendor-neutral OpenTelemetry components.
...
### General OpenTelemetry support notes [#temp-otel-supportmodel-alignment]
...
### Exclusions and limitations [#otel-exclusions]
...
### Get help from the OpenTelemetry Community [#otel-community]
