...
<table>
  <thead>
    ...
    <tr>
      <td>
        [clbanning/mxj <Icon name="fe-external-link"/>](https://github.com/clbanning/mxj "Link opens in a new window.")
      </td>

      <td>
        [MIT <Icon name="fe-external-link"/>](http://www.opensource.org/licenses/mit-license.php "Link opens in a new window.")
      </td>
    </tr>

    <tr>
      <td>
        [go-yaml/yaml <Icon name="fe-external-link"/>](https://github.com/go-yaml/yaml "Link opens in a new window.")
      </td>

      <td>
        [Apache 2.0 <Icon name="fe-external-link"/>](http://www.apache.org/licenses/LICENSE-2.0.txt "Link opens in a new window.")
      </td>
    </tr>

    <tr>
      <td>
        [StackExchange/wmi <Icon name="fe-external-link"/>](https://github.com/StackExchange/wmi "Link opens in a new window.")
      </td>
    ...
    <tr>
      <td>
        [go-ole/go-ole <Icon name="fe-external-link"/>](https://github.com/go-ole/go-ole "Link opens in a new window.")
      </td>
    ...
    <tr>
      <td>
        [shirou/gopsutil <Icon name="fe-external-link"/>](https://github.com/shirou/gopsutil "Link opens in a new window.")
      </td>

      <td>
        [BSD-3-Clause <Icon name="fe-external-link"/>](http://opensource.org/licenses/BSD-3-Clause "Link opens in a new window.")
      </td>
    </tr>

    <tr>
      <td>
        [shirou/w32 <Icon name="fe-external-link"/>](https://github.com/shirou/w32 "Link opens in a new window.")
      </td>
    ...
    <tr>
      <td>
        [cheggaaa/pb](http://"https://github.com/cheggaaa/pb/blob/master/LICENSE) [<Icon name="fe-external-link"/>](https://github.com/shirou/w32 "Link opens in a new window.")
      </td>
    ...
    <tr>
      <td>
        [google/uuid](https://github.com/google/uuid/blob/master/LICENSE) [<Icon name="fe-external-link"/>](https://github.com/shirou/w32 "Link opens in a new window.")
      </td>
