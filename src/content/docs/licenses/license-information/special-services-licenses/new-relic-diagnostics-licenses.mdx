...
<Table>
  <thead>
    ...
    <tr>
      <td>
        [clbanning/mxj <i className="fa fa-external-link fileinfo"><span>\[external link\]</span></i>](https://github.com/clbanning/mxj "Link opens in a new window.")
      </td>

      <td>
        [MIT <i className="fa fa-external-link fileinfo"><span>\[external link\]</span></i>](http://www.opensource.org/licenses/mit-license.php "Link opens in a new window.")
      </td>
    </tr>

    <tr>
      <td>
        [go-yaml/yaml <i className="fa fa-external-link fileinfo"><span>\[external link\]</span></i>](https://github.com/go-yaml/yaml "Link opens in a new window.")
      </td>

      <td>
        [Apache 2.0 <i className="fa fa-external-link fileinfo"><span>\[external link\]</span></i>](http://www.apache.org/licenses/LICENSE-2.0.txt "Link opens in a new window.")
      </td>
    </tr>

    <tr>
      <td>
        [StackExchange/wmi <i className="fa fa-external-link fileinfo"><span>\[external link\]</span></i>](https://github.com/StackExchange/wmi "Link opens in a new window.")
      </td>
    ...
    <tr>
      <td>
        [go-ole/go-ole <i className="fa fa-external-link fileinfo"><span>\[external link\]</span></i>](https://github.com/go-ole/go-ole "Link opens in a new window.")
      </td>
    ...
    <tr>
      <td>
        [shirou/gopsutil <i className="fa fa-external-link fileinfo"><span>\[external link\]</span></i>](https://github.com/shirou/gopsutil "Link opens in a new window.")
      </td>

      <td>
        [BSD-3-Clause <i className="fa fa-external-link fileinfo"><span>\[external link\]</span></i>](http://opensource.org/licenses/BSD-3-Clause "Link opens in a new window.")
      </td>
    </tr>

    <tr>
      <td>
        [shirou/w32 <i className="fa fa-external-link fileinfo"><span>\[external link\]</span></i>](https://github.com/shirou/w32 "Link opens in a new window.")
      </td>
    ...
    <tr>
      <td>
        [cheggaaa/pb](http://"https://github.com/cheggaaa/pb/blob/master/LICENSE) [<i className="fa fa-external-link fileinfo"><span>\[external link\]</span></i>](https://github.com/shirou/w32 "Link opens in a new window.")
      </td>
    ...
    <tr>
      <td>
        [google/uuid](https://github.com/google/uuid/blob/master/LICENSE) [<i className="fa fa-external-link fileinfo"><span>\[external link\]</span></i>](https://github.com/shirou/w32 "Link opens in a new window.")
      </td>
