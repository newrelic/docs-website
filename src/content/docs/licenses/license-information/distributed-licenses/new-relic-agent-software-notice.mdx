...
The software may contain third-party open source software (“**OSS**”) as described [here](https://docs.newrelic.com/docs/licenses/product-or-service-licenses). To the extent required by the OSS license, that license will apply to the OSS when used on a stand-alone basis.
