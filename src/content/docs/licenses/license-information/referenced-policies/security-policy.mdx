...
**6.8.** Revoke access to New Relic employees no longer requiring access. New Relic periodically audits and deactivates accounts for terminated employees that a customer may have provisioned for support.
