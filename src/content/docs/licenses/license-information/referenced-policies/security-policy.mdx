...
**Reviewed and Updated 13 December 2024.**
...
**6.8.** Revoke access to New Relic employees no longer requiring access. New Relic periodically audits for and deactivates accounts for terminated employees that a Customer may have provisioned for support.
