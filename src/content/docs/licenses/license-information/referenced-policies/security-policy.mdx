...
**5.1.** All physical locations that process Customer Data are third party data centers. All physical locations have security measures in place that are designed to prevent unauthorized physical access to data processing facilities and unlawful access, modification, or destruction of Customer Data.
...
Subscribe to the [RSS feed](https://github.com/newrelic/docs-website/commits/develop/src/content/docs/licenses/license-information/referenced-policies/security-policy.mdx.atom).
