...
<table border ="2px">
		<thead>
			<tr>
				<th> </th>
			<th style={{width: "200px"}}> **Category of Customer** </th>
			</tr>
		</thead>
		...
		<tbody>
	      ...
	      <table border ="2px">
					<tr>
					   <td style={{width: "50px"}}>**FedRAMP**</td>
						 <td style={{width: "50px">**HIPAA-enabled**</td>
						 <td style={{width: "50px">**US Gen Pop**</td>
						 <td style={{width: "50px">**EU Gen Pop**</td>
					</tr>
	    </table>
		</td>
	  </tr>
	      ...
	      <td>
				<table border="2px">
					<tr>
				     ...
				     <td style={{width: "50px" className="fcenter">
					      <Icon
						       style={{color: 'green'}}
						       name="fe-check"
					         />
				     ...
				     <td style={{width: "50px"> Limited</td>
						</tr>
					</table>
				</td>
				</tr>
...
## Get Security Guide update notifications

Subscribe to the [<Icon name="fe-rss" /> RSS feed](/docs/licenses/license-information/referenced-policies/security-guide/feed.xml).
