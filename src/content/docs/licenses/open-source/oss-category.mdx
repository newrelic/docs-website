...
<CollapserGroup>
  ...
  >
    ...
    <Callout variant="important">
    This code is a part of the New Relic One Catalog. It's available for installation and configuration via the New Relic homepage. You can install it within New Relic.
    </Callout>
