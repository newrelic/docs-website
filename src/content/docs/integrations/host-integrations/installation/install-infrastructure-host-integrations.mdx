...
<CollapserGroup>
  ...
  >
    ...
    3. Run the following command, where <var>INTEGRATION_FILE_NAME</var> represents the integration's file name. For more information, see the [integration's documentation](/docs/integrations/host-integrations/host-integrations-list).
       ...
       ```
    4. Follow additional install procedures for the [specific on-host integration](/docs/integrations/host-integrations/host-integrations-list).
  </Collapser>
  ...
  >
    ...
    2. From the command line, run:
       ...
       ```
    3. Run the following command, where <var>INTEGRATION_FILE_NAME</var> represents the integration's file name. For more information, see the [specific on-host integration](/docs/integrations/host-integrations/host-integrations-list).
