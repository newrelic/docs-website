...
<CollapserGroup>
  <Collapser
    id="windows"
    title={<>Install using MSI files (<ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={windows} title="Windows Server" alt="Windows Server"/></ImageSizing> Windows Server)</>}
  >
  ...
  <Collapser
    id="apt"
    title={<>Install with apt (<ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={debian} title="Debian icon" alt="Debian.png"/></ImageSizing>Debian, <ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={ubuntuIcon} title="ubuntu icon" alt="ubuntu icon"/></ImageSizing>Ubuntu)</>}
  >
  ...
  <Collapser
    id="yum"
    title={<>Install with yum (<ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={amazonLinux} title="amazon linux.png" alt="amazon linux.png"/></ImageSizing>Amazon Linux, <ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={centosIcon} title="centos icon" alt="centos icon"/></ImageSizing>CentOS, <ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={redHatNew2} title="redhat icon" alt="redhat icon"/></ImageSizing>RHEL)</>}
  >
  ...
  <Collapser
    id="zypper"
    title={<>Install with zypper (<ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={suseIcon} title="suse icon" alt="suse icon"/></ImageSizing>SLES)</>}
  >
  ...
  <Collapser
    id="tarball"
    title={<>Install from tarball (<ImageSizing width="32px" height="32px" verticalAlign="middle"><img src={otherlinux} title="Linux" alt="Linux icon"/></ImageSizing>Other distros)</>}
  >
    <Callout variant="tip">
