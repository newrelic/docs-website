...
<CollapserGroup>
  <Collapser
    id="windows"
    title={<>Install using MSI files (<ImageSizing width="32px" height="32px" verticalAlign="middle">![Windows Server](./images/windows.png "Windows Server")</ImageSizing> Windows Server)</>}
  >
  ...
  <Collapser
    id="apt"
    title={<>Install with apt (<ImageSizing width="32px" height="32px" verticalAlign="middle">![Debian.png](./images/Debian.png "Debian icon")</ImageSizing>Debian, <ImageSizing width="32px" height="32px" verticalAlign="middle">![ubuntu icon](./images/ubuntu-icon.png "ubuntu icon")</ImageSizing>Ubuntu)</>}
  >
  ...
  <Collapser
    id="yum"
    title={<>Install with yum (<ImageSizing width="32px" height="32px" verticalAlign="middle">![amazon linux.png](./images/amazon-linux.png "amazon linux.png")</ImageSizing>Amazon Linux, <ImageSizing width="32px" height="32px" verticalAlign="middle">![centos icon](./images/centos-icon.png "centos icon")</ImageSizing>CentOS, <ImageSizing width="32px" height="32px" verticalAlign="middle">![redhat icon](./images/red-hat-new2.png "redhat icon")</ImageSizing>RHEL)</>}
  >
  ...
  <Collapser
    id="zypper"
    title={<>Install with zypper (<ImageSizing width="32px" height="32px" verticalAlign="middle">![suse icon](./images/suse-icon.png "suse icon")</ImageSizing>SLES)</>}
  >
  ...
  <Collapser
    id="tarball"
    title={<>Install from tarball (<ImageSizing width="32px" height="32px" verticalAlign="middle">![Linux icon](./images/otherlinux.png "Linux")</ImageSizing>Other distros)</>}
  >
    <Callout variant="tip">
