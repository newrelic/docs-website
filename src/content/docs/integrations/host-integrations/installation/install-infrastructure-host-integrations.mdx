...
<Callout variant="tip">
  To use on-host integrations and infrastructure monitoring, as well as the rest of our [observability platform](https://one.newrelic.com), join the New Relic family! [Sign up](https://newrelic.com/signup) to create your free account in only a few seconds. Then ingest up to 100GB of data for free each month. Forever.
</Callout>
...
<CollapserGroup>
  <Collapser
    id="windows"
    title={<>Install using MSI files (<ImageSizing width="32px" height="32px" verticalAlign="middle">![Windows Server](https://docs.newrelic.com/sites/default/files/thumbnails/image/windows.png "Windows Server")</ImageSizing> Windows Server)</>}
  >
  ...
  <Collapser
    id="zypper"
    title={<>Install with zypper (<ImageSizing width="32px" height="32px" verticalAlign="middle">![suse icon](https://docs.newrelic.com/sites/default/files/thumbnails/image/suse-icon.png "suse icon")</ImageSizing>SLES)</>}
  >
  ...
  <Collapser
    id="tarball"
    title={<>Install from tarball (<ImageSizing width="32px" height="32px" verticalAlign="middle">![Linux icon](https://docs.newrelic.com/sites/default/files/thumbnails/image/otherlinux.png "Linux")</ImageSizing>Other distros)</>}
  >
    <Callout variant="tip">
