...
2. Run [New Relic Diagnostics](https://docs.newrelic.com/docs/agents/manage-apm-agents/troubleshooting/new-relic-diagnostics) to check for common issues and validate your configuration files.
       ...
       <table>
         ...
         <tbody>
           <tr>
             ...
             <td>
               Make sure your environment meets the [Integrations requirements](/docs/integrations/host-integrations/host-integrations-list) listed for your specific on-host integration.
             </td>
           </tr>
