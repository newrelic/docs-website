...
collects and sends dimensional metrics from PowerDNS.

Read on to install the integration, and to see what data we collect.

## Compatibility and requirements [#req]

Our integration is compatible with PowerDNS Recursor and Authoritative.
...
Metrics are attached to the Metric sample and the entities `POWERDNS_AUTHORITATIVE`, `POWERDNS_RECURSOR`,
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Was the last scrape of PowerDNS successful.
      </td>
...
This integration is open source software. That means you can [browse its source code](https://github.com/newrelic/newrelic-prometheus-exporters-packages "Link opens in a new window.") and send improvements, or create your own fork and build it.
Moreover this integrations leverage an opensource exporter created by the community.
