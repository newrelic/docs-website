...
Specific settings related to Varnish are defined using the `env` section of the configuration file. These settings control the connection to your Varnish instance as well as other security settings and features. The list of valid settings is described in the next section of this document.
...
<CollapserGroup>
  ...
  >
    This is the very basic configuration to collect Metrics and Inventor :
