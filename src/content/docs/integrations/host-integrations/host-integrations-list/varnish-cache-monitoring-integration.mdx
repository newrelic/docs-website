...
The `varnish-config.yml` file accepts the following commands:
...
In [New Relic Insights](/docs/insights), Varnish Cache data is attached to the following Insights [event type](/docs/using-new-relic/welcome-new-relic/getting-started/glossary#event):
