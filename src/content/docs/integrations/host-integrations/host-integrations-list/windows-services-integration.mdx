...
This feature is currently in open beta and only applies to the latest [version](https://github.com/newrelic/nri-winservices/releases/tag/v0.3.0-beta) released on September 2021 (check [link](https://discuss.newrelic.com/t/introducing-new-open-beta-version-of-the-windows-services-integration/160162) for more details).
</Callout>
