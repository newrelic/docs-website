...
### EXAMPLE 1: Change to 3 columns with "extended" as a check mark <Icon name="fe-check"/> icon.
...
### EXAMPLE 2: Keep as 2 columns but move "extended" below metric name.
...
### EXAMPLE 3: 2 columns as currently laid out.
