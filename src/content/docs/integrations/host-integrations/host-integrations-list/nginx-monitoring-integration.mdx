...
The NGINX integration collects both Metrics(**M**) and Inventory(**I**) information. Check the "**Applies To**" column below to find which settings can be used for each specific collection:
