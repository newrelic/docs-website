...
Have you tried our new [Network Performance Monitoring](https://docs.newrelic.com/docs/network-performance-monitoring/)? 

Collect both [SNMP](https://docs.newrelic.com/docs/network-performance-monitoring/setup-performance-monitoring/snmp-performance-monitoring/) and [Network Flows](https://docs.newrelic.com/docs/network-performance-monitoring/setup-performance-monitoring/network-flow-monitoring/) to answer the question, "_Is it the network?_" faster.
</Callout>
