...
```
<Callout variant="tip">
In case you want to enable [REMOTE_MONITORING](/docs/integrations/host-integrations/host-integrations-list/mysql-monitoring-integration/#instance-settings) you will need to change localhost when granting permisions by the server from where you want to monitor the MySQL instance.
</Callout>
