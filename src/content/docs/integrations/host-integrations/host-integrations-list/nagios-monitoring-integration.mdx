...
Specific settings related to Nagios are defined using the `env` section of the configuration file. These settings control the connection to your Nagios instance as well as other security settings and features. The list of valid settings is described in the next section of this document.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The number of services checks to be run concurrently
      </td>
      <td>
        1
      </td>
