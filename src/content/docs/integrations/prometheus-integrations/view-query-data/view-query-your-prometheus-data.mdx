...
<ImageSizing width="40px" height="35px">![img-integration-k8s@2x.png](./images/img-integration-k8s%402x.png "img-integration-k8s@2x.png")</ImageSizing> **Kubernetes:** If the scraper is running in Kubernetes, New Relic also adds the following attributes to all the metrics:
...
<CollapserGroup>
  ...
  >
    ...
    <ImageSizing width="40px" height="35px">![img-integration-k8s@2x.png](./images/img-integration-k8s%402x.png "img-integration-k8s@2x.png")</ImageSizing> **Kubernetes:** This example assumes that you have Redis pods with the Redis exporter installed. To view the number of connected Redis clients per pod in the default namespace:
  ...
  <Collapser
    id="xx"
    title={<><ImageSizing width="40px" height="35px">![Docker icon](/sites/default/files/thumbnails/image/docker-logo-crop.png "Docker icon")</ImageSizing>Docker: View average memory free for scraped endpoints</>}
  >
  ...
  <Collapser
    ...
    title={<><ImageSizing width="40px" height="35px">![img-integration-k8s@2x.png](/sites/default/files/thumbnails/image/img-integration-k8s%402x.png "img-integration-k8s@2x.png")</ImageSizing> Kubernetes: View average memory usage for pods in a deployment</>}
  >
