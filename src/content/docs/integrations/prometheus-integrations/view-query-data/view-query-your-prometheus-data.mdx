...
<CollapserGroup>
  ...
  <Collapser
    ...
    title={<><img src={imgIntegrationK8S402X} title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png" style={{ height: '35px', width: '40px' }}/> Kubernetes: View average memory usage for pods in a deployment</>}
  >
