...
<CollapserGroup>
  ...
  <Collapser
    id="xx"
    title={<><ImageSizing width="40px" height="35px"><img src={dockerLogoCrop} title="Docker icon" alt="Docker icon"/></ImageSizing>Docker: View average memory free for scraped endpoints</>}
  >
  ...
  <Collapser
    ...
    title={<><ImageSizing width="40px" height="35px"><img src={imgIntegrationK8S402X} title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png"/></ImageSizing> Kubernetes: View average memory usage for pods in a deployment</>}
  >
