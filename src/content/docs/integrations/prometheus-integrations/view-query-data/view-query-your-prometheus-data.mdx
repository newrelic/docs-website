...
<CollapserGroup>
  ...
  <Collapser
    id="xx"
    title={<><ImageSizing width="40px" height="35px">![Docker icon](./images/docker-logo-crop.png "Docker icon")</ImageSizing>Docker: View average memory free for scraped endpoints</>}
  >
  ...
  <Collapser
    ...
    title={<><ImageSizing width="40px" height="35px">![img-integration-k8s@2x.png](./images/img-integration-k8s%402x.png "img-integration-k8s@2x.png")</ImageSizing> Kubernetes: View average memory usage for pods in a deployment</>}
  >
