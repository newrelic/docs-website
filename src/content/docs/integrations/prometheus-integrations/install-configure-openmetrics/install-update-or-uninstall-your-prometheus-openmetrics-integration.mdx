...
<CollapserGroup>
  <Collapser
    id="docker-install"
    title={<><ImageSizing width="40px" height="35px"><img src={dockerLogoCrop} title="Docker icon" alt="Docker icon"/></ImageSizing> Docker installation</>}
  >
  ...
  <Collapser
    ...
    title={<><ImageSizing width="40px" height="35px"><img src={imgIntegrationK8S402X} title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png"/></ImageSizing> Kubernetes installation</>}
  >
...
<CollapserGroup>
  <Collapser
    id="docker-update"
    title={<><ImageSizing width="40px" height="35px"><img src={dockerLogoCrop} title="Docker icon" alt="Docker icon"/></ImageSizing> Docker update procedures</>}
  >
  ...
  <Collapser
    ...
    title={<><ImageSizing width="40px" height="35px"><img src={imgIntegrationK8S402X} title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png"/></ImageSizing> Kubernetes update procedures</>}
  >
