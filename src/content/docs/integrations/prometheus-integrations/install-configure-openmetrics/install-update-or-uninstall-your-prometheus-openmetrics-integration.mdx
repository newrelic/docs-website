...
<CollapserGroup>
  <Collapser
    id="docker-install"
    title={<><ImageSizing width="40px" height="35px">![Docker icon](/sites/default/files/thumbnails/image/docker-logo-crop.png "Docker icon")</ImageSizing> Docker installation</>}
  >
    ...
    1. Create a configuration file `config.yaml`. Use the [example configuration file](https://docs.newrelic.com/docs/integrations/prometheus-integrations/install-configure/configure-prometheus-openmetrics-integration#example-configuration-file), or look at the [`nri-prometheus-latest.yaml`](https://download.newrelic.com/infrastructure_agent/integrations/kubernetes/nri-prometheus-latest.yaml) manifest file, which includes the `nri-prometheus-cfg` config map and an example configuration.
       ...
       * **Required:** Add your [New Relic license key](/docs/accounts-partnerships/accounts/account-setup/license-key) and a cluster name to identify your Docker container.
       ...
       * Specify which metrics you want to ignore or include according to the prefixes for the metrics and labels. For more information, see the [metrics filtering](https://docs.newrelic.com/docs/integrations/prometheus-integrations/configure/filter-prometheus-metrics) documentation.
  ...
  >
    ...
    2. Edit the `nri-prometheus-latest.yaml` manifest file:
       ...
       **Required:** Add your [New Relic license key](/docs/accounts-partnerships/accounts/account-setup/license-key) and a cluster name to identify your Kubernetes cluster.
       ...
       ```
    3. Specify which metrics you want to ignore or include according to the prefixes for the metrics and labels. By default, the New Relic Prometheus OpenMetrics integration uses the same labels as Prometheus to discover targets. For more information, see the [metrics filtering](https://docs.newrelic.com/docs/integrations/prometheus-integrations/configure/filter-prometheus-metrics) documentation.
...
<CollapserGroup>
  <Collapser
    id="docker-update"
    title={<><ImageSizing width="40px" height="35px">![Docker icon](/sites/default/files/thumbnails/image/docker-logo-crop.png "Docker icon")</ImageSizing> Docker update procedures</>}
  >
  ...
  <Collapser
    ...
    title={<><ImageSizing width="40px" height="35px">![img-integration-k8s@2x.png](/sites/default/files/thumbnails/image/img-integration-k8s%402x.png "img-integration-k8s@2x.png")</ImageSizing> Kubernetes update procedures</>}
  >
...
<ImageSizing width="40px" height="35px">![img-integration-k8s@2x.png](./images/img-integration-k8s%402x.png "img-integration-k8s@2x.png")</ImageSizing> **Kubernetes:**
