...
<CollapserGroup>
  <Collapser
    id="docker-install"
    title={<><ImageSizing width="40px" height="35px">![Docker icon](./images/docker-logo-crop.png "Docker icon")</ImageSizing> Docker installation</>}
  >
  ...
  <Collapser
    ...
    title={<><ImageSizing width="40px" height="35px">![img-integration-k8s@2x.png](./images/img-integration-k8s%402x.png "img-integration-k8s@2x.png")</ImageSizing> Kubernetes installation</>}
  >
...
<CollapserGroup>
  <Collapser
    id="docker-update"
    title={<><ImageSizing width="40px" height="35px">![Docker icon](./images/docker-logo-crop.png "Docker icon")</ImageSizing> Docker update procedures</>}
  >
  ...
  <Collapser
    ...
    title={<><ImageSizing width="40px" height="35px">![img-integration-k8s@2x.png](./images/img-integration-k8s%402x.png "img-integration-k8s@2x.png")</ImageSizing> Kubernetes update procedures</>}
  >
