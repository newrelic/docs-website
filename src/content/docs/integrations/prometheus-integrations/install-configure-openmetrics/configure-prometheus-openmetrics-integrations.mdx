...
<CollapserGroup>
  <Collapser
    ...
    title={<><ImageSizing width="40px" height="35px"><img src={imgIntegrationK8S402X} title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png"/></ImageSizing> Kubernetes port and endpoint path</>}
  >
  ...
  <Collapser
    ...
    title={<><ImageSizing width="40px" height="35px"><img src={imgIntegrationK8S402X} title="img-integration-k8s@2x.png" alt="img-integration-k8s@2x.png"/></ImageSizing> Example: Labels for Kubernetes port and path</>}
  >
