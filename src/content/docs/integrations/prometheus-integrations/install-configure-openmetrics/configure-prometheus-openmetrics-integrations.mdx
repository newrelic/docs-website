...
<CollapserGroup>
  <Collapser
    ...
    title={<><ImageSizing width="40px" height="35px">![img-integration-k8s@2x.png](/sites/default/files/thumbnails/image/img-integration-k8s%402x.png "img-integration-k8s@2x.png")</ImageSizing> Kubernetes port and endpoint path</>}
  >
  ...
  <Collapser
    ...
    title={<><ImageSizing width="40px" height="35px">![img-integration-k8s@2x.png](/sites/default/files/thumbnails/image/img-integration-k8s%402x.png "img-integration-k8s@2x.png")</ImageSizing> Example: Labels for Kubernetes port and path</>}
  >
...
<ImageSizing width="40px" height="35px">![Docker icon](./images/docker-logo-crop.png "Docker icon")</ImageSizing> **Docker:** To run the integration with the previous configuration file:
