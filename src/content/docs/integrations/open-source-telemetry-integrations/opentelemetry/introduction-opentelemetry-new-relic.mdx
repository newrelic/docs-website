...
New Relic supports the native OpenTelemetry Protocol (OTLP) for for sending telemetry data. This allows you to use the vendor neutral components developed by the OpenTelemtry community to send your data to New Relic.

<Callout variant="important">
[New Relic's exporters](/docs/integrations/open-source-telemetry-integrations/opentelemetry/opentelemetry-legacy-new-relic-exporters) for OpenTelemetry are now deprecated in favor of sending data to New Relic using OTLP.
</Callout>
...
You'll also want to review [tips](/docs/integrations/open-source-telemetry-integrations/opentelemetry/opentelemetry-concepts) for getting the most out of the data you send to New Relic.
