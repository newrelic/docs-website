...
Here are two basic ways you could set up OpenTelemetry with New Relic. Each approach assumes you set up instrumentation in your code, but they differ in how the data is gathered and sent to New Relic.

For each approach, you can optionally set up New Relic Infinite Tracing so that our trace observer can analyze all your traces. To see if this is a good fit, see [Introduction to Infinite Tracing](https://docs.newrelic.com/docs/understand-dependencies/distributed-tracing/infinite-tracing/introduction-infinite-tracing).
...
![Diagram showing the OpenTelemetry collector.](./images/collector_introduction.png "collector_introduction.png")
...
![Diagram showing how to skip the collector and use a New Relic exporter.](./images/no_opentelemetry_collector_0.png "no_collector_introduction.png")
