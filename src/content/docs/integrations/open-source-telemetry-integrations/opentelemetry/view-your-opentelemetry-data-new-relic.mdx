...
2. Select **Services - OpenTelemetry** in the sidebar:

    ![Screen capture showing how to filter for OpenTelemetry services.](./images/explorer_otel_services.png "explorer_otel_services.png")
