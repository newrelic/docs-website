...
When you click on a span in the trace waterfall view, you can see span errors in the right panel under **Error details**.
...
Here's the justification of images outside of lists:
