...
#### Query histograms [#query-histograms]

[TODO: INSERT DETAILS HERE]

Using the `histogram()` function, using FACET (heatmaps), lack of TIMESERIES support

![Screenshot showing a historgram query](./images/histogram-1.png "Screenshot showing a historgram query")
