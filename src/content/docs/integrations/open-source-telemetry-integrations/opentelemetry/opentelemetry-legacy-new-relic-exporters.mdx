...
Although we recommend that you export data to New Relic using OTLP, a New Relic exporter for the OpenTelemetry collector is available. We'll continue to support this exporter at least until the native OTLP ingest is beyond pre-release.

You can find the New Relic Exporter in the [opentelemetry-collector-contrib](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/main/exporter/newrelicexporter) repository.
