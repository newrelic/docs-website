...
![collector_standalone_overview.png](./images/collector_standalone_overview_0.png "collector_standalone_overview.png")

### Sidecar/Daemon/Agent [#sidecar]

If you set up the collector as a sidecar, OpenTelemetry calls this an agent:

![Diagram showing how to set up the collector as a sidecar.](./images/collector_sidecar_overview.png "collector_sidecar_overview.png")
...
![Diagram showing how to set up Infinite Tracing with the collector.](./images/collector_infinite_tracing.png "collector_infinite_tracing.png")
...
![Diagram showing how to set up Infinite Tracing with New Relic exporters.](./images/exporters_infinite_tracing.png "exporters_infinite_tracing.png")
