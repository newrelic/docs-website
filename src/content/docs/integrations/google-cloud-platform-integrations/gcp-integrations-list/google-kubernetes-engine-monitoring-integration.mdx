...
[Inventory data](/docs/telemetry-data-platform/understand-data/new-relic-data-types/) is information about the status or configuration of a service or host. You can examine inventory data in New Relic One.
