...
2. Follow standard procedures to [connect your GCP service to New Relic](https://docs.newrelic.com/docs/connect-google-cloud-platform-services-infrastructure).
...
[Inventory data](/docs/integrations/new-relic-integrations/getting-started/understand-use-data-infrastructure-integrations#inventory-data) is information about the status or configuration of a service or host. You can examine inventory data in New Relic One.

The Google Kubernetes Engine integration reports configuration information for cluster objects with the properties listed below.

Additionally, container labels are propagated to nodes and pods.
