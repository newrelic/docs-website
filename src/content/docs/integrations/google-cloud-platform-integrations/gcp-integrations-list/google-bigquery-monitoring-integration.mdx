...
To view [inventory data](/docs/telemetry-data-platform/understand-data/new-relic-data-types/) for Google BigQuery services, go to [**one.newrelic.com**](http://one.newrelic.com) **> Infrastructure > Inventory** and search for or select the following attributes.
