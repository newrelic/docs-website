...
After connecting the integration to New Relic and waiting a few minutes, data will appear in the New Relic UI. To [find and use integration data](/docs/telemetry-data-platform/understand-data/new-relic-data-types/), including your dashboards and your alert settings, go to [**one.newrelic.com**](http://one.newrelic.com) **> Infrastructure > GCP > Google Cloud Storage**.
...
[Inventory data](/docs/telemetry-data-platform/understand-data/new-relic-data-types/) for Google Cloud Storage bucket objects includes the following properties:
