...
<CollapserGroup>
  ...
  >
    ...
    You need to set a memory limit in your [container specs](/docs/integrations/kubernetes-integration/understand-use-data/find-use-your-kubernetes-data/#container-data) for `memoryLimitBytes`to report data.
