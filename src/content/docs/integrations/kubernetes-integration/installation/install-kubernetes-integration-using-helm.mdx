...
<CollapserGroup>
  ...
  >
    ...
    Contains the main Kubernetes integration and the infrastructure agent. This is the bare minimum needed to get data from
    your cluster.
    ...
    [plugin](https://github.com/newrelic/newrelic-fluent-bit-output) to easily forward your logs to [Logs](https://docs.newrelic.com/docs/logs/new-relic-logs/get-started/introduction-new-relic-logs).
    ...
    for Kubernetes deployments, as it provides the easiest way to select, install, and upgrade individual components at your will.
    ...
    that you can supply the configuration values to the individual components of the chart, as listed at the beginning of this section, by prefixing them with the name of the chart. 
