...
Below are the default settings for reference.  More detail can be found in the [newrelic-pixie-integration](https://github.com/newrelic/newrelic-pixie-integration) Github repo.
