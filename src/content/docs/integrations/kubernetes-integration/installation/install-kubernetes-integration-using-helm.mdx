...
<Callout variant="tip">
  To use Kubernetes integrations and infrastructure monitoring, as well as the rest of our [observability platform](https://one.newrelic.com), join the New Relic family! [Sign up](https://newrelic.com/signup) to create your free account in only a few seconds. Then ingest up to 100GB of data for free each month. Forever.
</Callout>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The [license key](/docs/accounts/accounts-billing/account-setup/new-relic-license-key) for your New Relic account. This will be the preferred configuration option if you're using both `licenseKey` and `customSecret`.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        The list of integrations configured to monitor services running on Kubernetes. For more information, see [Monitor services running on Kubernetes](/docs/integrations/kubernetes-integration/link-apps-services/monitor-services-running-kubernetes).
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Any resources you want to assign to the pod. For more information, see the [resources documentation on GitHub](https://github.com/newrelic/helm-charts/tree/master/charts/newrelic-infrastructure#resources).
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        The list of node taints to tolerate (requires Kubernetes >= 1.6). For more information, see the [tolerations documentation on GitHub](https://github.com/newrelic/helm-charts/tree/master/charts/newrelic-infrastructure#tolerations).
      </td>
    </tr>
