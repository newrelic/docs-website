...
2. For each workload you want to monitor, add an additional sidecar container for the `newrelic/infrastructure-k8s` image. Here is an example of an injected sidecar. See the [gist](https://gist.github.com/paologallinaharbur/754c13d0541f89d60ae74fdf877e3ce5J) for the latest.
      ...
      >
            ...
            spec:
              ...
              - env:
                ...
                - name: NRIA_CUSTOM_ATTRIBUTES
                  value: '{"clusterName":"$(CLUSTER_NAME)", "computeType":"$(COMPUTE_TYPE)"}'
        ...
        ### KSM Data
              - args:
                ...
                image: docker.io/bitnami/kube-state-metrics:1.9.8-debian-10-r0
                imagePullPolicy: IfNotPresent
                livenessProbe:
                  failureThreshold: 6
                  httpGet:
