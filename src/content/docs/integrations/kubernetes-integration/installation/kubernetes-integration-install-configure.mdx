...
If your New Relic account [is in the EU region](/docs/using-new-relic/welcome-new-relic/get-started/our-eu-us-region-data-centers), access the installer from [one.eu.newrelic.com](https://one.eu.newrelic.com/launcher/nr1-core.settings?pane=eyJuZXJkbGV0SWQiOiJrOHMtY2x1c3Rlci1leHBsb3Jlci1uZXJkbGV0Lms4cy1zZXR1cCJ9).
...
<CollapserGroup>
  <Collapser
    ...
    title={<><ImageSizing verticalAlign="middle">![EKS](https://docs.newrelic.com/sites/default/files/thumbnails/image/eks.png)</ImageSizing> <Link to="#install-amazon-eks"> Amazon EKS</Link></>}
  >
  ...
  <Collapser
    ...
    title={<><ImageSizing verticalAlign="middle">![CKE](https://docs.newrelic.com/sites/default/files/thumbnails/image/cke.jpeg)</ImageSizing> <Link to="#install-google-kubernetes-engine"> Google Kubernetes Engine (GKE)</Link></>}
  >
  ...
  <Collapser
    ...
    title={<><ImageSizing verticalAlign="middle">![OpenShift](https://docs.newrelic.com/sites/default/files/thumbnails/image/openshift.png)</ImageSizing> OpenShift container platform</>}
  >
  ...
  <Collapser
    ...
    title={<><ImageSizing verticalAlign="middle">![AKS](https://docs.newrelic.com/sites/default/files/thumbnails/image/aks.png)</ImageSizing> Azure Kubernetes Service (AKS)</>}
  >
  ...
  <Collapser
    className="freq-link"
    id="install-pks"
    title={<><ImageSizing verticalAlign="middle">![PKS](https://docs.newrelic.com/sites/default/files/thumbnails/image/pivotal.png)</ImageSizing> Pivotal Container Service (PKS / VMware Tanzu)</>}
  >
...
To improve our unified experience, as of August 12, 2020, Kubernetes integrations that use v1.7 or older are deprecated. If you are using v1.7 or older, you must update your integration in order to continue viewing Kubernetes performance data. For more information, see the [Kubernetes v1.7 or older deprecation notice](/docs/release-notes/platform-release-notes/kubernetes-integration-release-notes/deprecation-notice-kubernetes-v17-or-lower).
