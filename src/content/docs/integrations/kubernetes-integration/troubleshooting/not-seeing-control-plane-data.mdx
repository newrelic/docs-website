...
<CollapserGroup>
  ...
  >
    To retrieve the logs, follow the instructions on [get logs from pod running on a master node](https://docs.newrelic.com/docs/integrations/kubernetes-integration/troubleshooting/get-logs-version). The integration logs for every component the following message _“Running job: COMPONENT_NAME”_. Ex:
