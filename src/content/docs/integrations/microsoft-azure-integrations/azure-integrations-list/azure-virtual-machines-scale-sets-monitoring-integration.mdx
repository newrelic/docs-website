...
[New Relic Infrastructure's integrations](/docs/infrastructure/integrations-getting-started/getting-started/introduction-infrastructure-integrations) include an integration for reporting your [Azure Virtual machine scale sets](http://href="https://azure.microsoft.com/en-us/services/virtual-machine-scale-sets) data to New Relic products. This document explains how to activate this integration and describes the data that can be reported.
