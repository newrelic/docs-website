...
1. Go to the **Azure Portal** and open a shell by selecting the terminal <Icon name="terminal"/>
   icon.
2. Add the following command:
   ...
   ```
3. From **Services > Subscriptions**, select the subscription, go to **Access control (IAM)**, and then select <Icon name="plus"/>
   **Add**.
