...
You can [query and explore your data](https://docs.newrelic.com/docs/using-new-relic/data/understand-data/query-new-relic-data) using the `AzureRedisCacheSample` [event type](/docs/insights/use-insights-ui/getting-started/introduction-new-relic-insights#event-type) and, when shards are configured in the service, the `AzureRedisCacheShardSample` event type.
