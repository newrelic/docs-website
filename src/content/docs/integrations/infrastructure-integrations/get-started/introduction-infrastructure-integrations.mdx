    ...
    <tr>
      ...
      <td>
        ...
        * Any data that is not considered metrics or inventory
        ...
        Depending on the integration, [other types of information](https://docs.newrelic.com/docs/integrations/new-relic-integrations/getting-started/understand-use-data-infrastructure-integrations#attributes) may be reported as attributes.
      </td>
    </tr>
  </tbody>
</table>
