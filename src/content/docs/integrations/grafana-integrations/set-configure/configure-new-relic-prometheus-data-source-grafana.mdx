...
japaneseVersion: >-
  https://docs.newrelic.co.jp/docs/integrations/grafana-integrations/set-configure/configure-new-relic-prometheus-data-source-grafana
---
...
1. On New Relic, [Create a new Query key](/docs/apis/get-started/intro-apis/types-new-relic-api-keys).
...
<Callout variant="tip">
  If your line graphs appear as a series of dots and not as connected lines, you can change in Graphana's **[Graph panel](https://grafana.com/docs/grafana/latest/panels/visualizations/graph-panel/)** and selecting **Stacking and null value > connected**.
</Callout>
