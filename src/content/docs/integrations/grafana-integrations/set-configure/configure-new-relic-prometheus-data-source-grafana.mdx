...
<Callout variant="tip">
  If your line graphs appear as a series of dots and not as connected lines, you can change in Grafana's **[Graph panel](https://grafana.com/docs/grafana/latest/panels/visualizations/graph-panel/)** and selecting **Stacking and null value > connected**.
</Callout>
