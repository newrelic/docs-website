                ...
                Statement:
                  - Effect: Allow
                    Action:
                      ...
                      - '<code>redshift:DescribeClusters</code>' 
                      - '<code>redshift:DescribeClusterParameters</code>'
...
<CollapserGroup>
  <Collapser
    id="all-permissions"
    style={{ color: "red" }}
    title="Required by all integrations"
  >
    <Callout variant="important">
      If an integration is not in listed on this page, these permissions are all you need.
    </Callout>
  ...
  >
    Additional [Billing permissions:](/docs/infrastructure/amazon-integrations/amazon-integrations/aws-billing-integration)
