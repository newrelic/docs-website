...
For API Polling integrations, if you do not see tags in the **Add filter** menu of the **[Filter sets](/docs/scopes-organize-your-infrastructure#create)** sidebar within a few minutes, delete the integration and try again:
...
Note that not all integrations support tags collection and there will be a setting to enable / disable the tags collection in the integration settings.
