...
topics:
  ...
  - Get started
japaneseVersion: >-
  https://docs.newrelic.co.jp/docs/integrations/amazon-integrations/get-started/connect-aws-infrastructure
---
...
6. Configure a **Budgets** policy: While viewing the **Role summary** for your new role, select **<Icon name="plus-circle"/>
   Add inline policy**.
...
2. Select the edit <Icon name="edit-2"/>
   icon.
