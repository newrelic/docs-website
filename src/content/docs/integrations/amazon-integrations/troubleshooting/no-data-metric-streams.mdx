...
You followed the steps to link your AWS account, configured the AWS CloudWatch metrics stream and AWS Kinesis Data Firehose and you still don't see the expected metrics in New Relic.
