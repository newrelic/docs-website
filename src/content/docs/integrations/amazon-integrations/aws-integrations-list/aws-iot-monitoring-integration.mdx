...
To [view inventory data](/docs/integrations/new-relic-integrations/getting-started/understand-use-data-infrastructure-integrations#overview) for AWS IoT, go to [**one.newrelic.com**](http://one.newrelic.com) **> Infrastructure > Inventory** and search for or select the following:
