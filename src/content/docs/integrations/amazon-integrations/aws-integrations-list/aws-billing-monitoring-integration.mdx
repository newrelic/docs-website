...
For a practical look at how to set up and use this integration, read the [AWS Billing integration blog post](https://blog.newrelic.com/2017/07/25/aws-billing-monitoring-integration/).
