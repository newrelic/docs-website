...
- **Descriptive title:** Ensure each document has a clear and descriptive title. This helps New Relic AI fetch the closest matching content based on alert titles and user queries.

For example, "Memory Leak in Service X during v2.3 Deployment" is more effective than "System Slowdown."
