...
With RBAC, you can precisely manage which roles have access to specific integrations. RBAC enables you to tailor access permissions according to the unique requirements of your organization and ensures that only authorized personnel can interact with certain integrations. For detailed guidance on setting up RBAC, refer to our [account user management tutorial](/docs/accounts/accounts-billing/new-relic-one-user-management/account-user-mgmt-tutorial).
