...
- Conversational AI Interface: Engage with New Relic AI through Amazon Q's conversational interface to obtain insights and recommendations.
...
For additional details, refer [Getting Started with New Relic agent for Amazon Q](/docs/agentic-ai/agentic-integration/amazonq-integration).
