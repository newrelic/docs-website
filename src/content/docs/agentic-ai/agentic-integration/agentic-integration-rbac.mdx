...
<Callout variant="tip">
Consider creating multiple groups for different access levels, such as:
- **Agentic AI Administrators**: Full administrative access
- **Agentic AI Developers**: Development and integration access  
- **Agentic AI Viewers**: Read-only access for monitoring and insights
</Callout>
...
<Callout variant="tip">
You can also add users programmatically using the `userManagementAddUsersToGroups` mutation in NerdGraph if you prefer API-based management.
</Callout>
