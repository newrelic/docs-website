---
title: "New Relic AI integration for Amazon Q"
tags:
    - Infrastructure
    - Amazon Q
    - Custom Plugin
metaDescription: "Guide to create and use New Relic custom plugins for Amazon Q."
...
The New Relic AI custom plugin for Amazon Q Business integrates New Relic's AI-driven insights directly into the Amazon Q environment. This plugin allows you to send user prompts to New Relic AI and receive AI-generated responses, facilitating improved incident response and decision-making processes.

This guide provides instructions to establish a connection between New Relic AI and Amazon Q, enabling anomaly detection, real-time alerting, and incident management to maintain application performance and reliability.
...
* An operational Amazon Q application. For more information to create an Amazon Q application environment, refer [Amazon Q documentation](https://docs.aws.amazon.com/amazonq/latest/qbusiness-ug/create-app.html).
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td>The ID of your Amazon Q application.</td>
                </tr>
                <tr>
                    <td>`<plugin-name>`</td>
...
## Communicate with New Relic Agent in Amazon Q [#communicate-nrai] 

After creating the NRAI plugin, you can communicate with the New Relic Agent in Amazon Q to send user prompts and receive AI-generated responses.
...
5. Enter your prompt in the chat window and click the **Send** icon. You will be prompted to authorize Amazon Q to access New Relic account. This is a one-time authorization process.
6. Click **Authorize**.

    The New Relic AI agent processes your prompt and returns the response in real-time.

    <img
        title="New Relic Amazon Q integration"
        alt="New Relic AI agent response in Amazon Q"
