...
### Use the Change Intelligence within GitHub Copilot
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>To analyze a specific account</td>
      <td>`@newrelic select account <account_number>` or `use account <account-number>`</td>
    </tr>
    <tr>
