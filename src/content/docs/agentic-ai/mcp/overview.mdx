...
<Callout title="Group membership and roles" variant="important">
  Accessing the mcp-server requires you to be a member of a group with org level roles assigned within New Relic. Ensure this role is active before attempting to access the server.
</Callout>
