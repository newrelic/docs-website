...
- `analyze_errors`: Compute aggregate error counts, first/last seen timestamps, and optional time-series trends from TransactionError events, with flexible filtering and faceting by error class, message, app, HTTP status, and more.
