...
<DNT>Autopilot</DNT> is New Relic’s AI-powered operations experience and a core capability of New Relic Autonomous Operations. During public preview, <DNT>Autopilot</DNT> includes <DNT>SRE Agent</DNT>, which investigates incidents, analyzes telemetry, and recommends remediation. Over time, <DNT>Autopilot</DNT> will orchestrate additional specialized AI agents across operational workflows.
...
<DNT>New Relic Autopilot</DNT> is an AI-powered operations experience that helps engineering teams investigate issues, understand system behavior, and accelerate operational workflows. During public preview, <DNT>SRE Agent</DNT>, the first specialized AI agent available within <DNT>Autopilot</DNT>, delivers these capabilities. By interacting directly with your telemetry data and established workflows, it moves beyond simple alerting to provide assistance with active investigation, diagnosis, and remediation.
