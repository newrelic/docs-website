...
## What is New Relic Autopilot?
<DNT>New Relic Autopilot</DNT> is an intelligent agent designed to be your on-call teammate. By interacting directly with your telemetry data and established workflows, it moves beyond simple alerting to provide assistance with active investigation, diagnosis, and remediation.
