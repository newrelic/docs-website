...
The <DNT>SRE Agent</DNT> is a partially paid feature, even during this preview period. We are not charging for token usage, however, auxiliary compute costs from downstream services may apply. Usage is billed under the <DNT>**Advanced and Core Compute**</DNT> product according to your account's pricing model. When the feature becomes generally available, billing will continue based on the terms in your New Relic agreement.
