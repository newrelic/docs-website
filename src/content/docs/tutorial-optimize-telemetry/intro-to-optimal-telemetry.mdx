...
<DocTiles>
  ...
  <DocTile title='Optimize your ingest' path="/docs/tutorial-optimize-telemetry/optimize-your-ingest/"> Learn how to optimize your telemetry data and help reduce your ingest costs</DocTile>
</DocTiles>