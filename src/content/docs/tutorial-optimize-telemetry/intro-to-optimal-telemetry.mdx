...
You'll need to make sure that you have data managed with New Relic so that you can use <DoNotTranslate>**data ingest governance**</DoNotTranslate> to optimize it. See our [data management doc](/docs/data-apis/manage-data/manage-your-data/) if you need more information.
