...
<CollapserGroup>
  ...
  * Logs (dev, staging, prod - including debug)
  ...
  >
  A team responsible for a new user-facing platform with an emphasis on <InlinePopover type="mobile" /> and browser monitoring is running 50% over budget. They'll need to right-size their ingest, but they're adamant about not sacrificing any <DoNotTranslate>**Customer experience**</DoNotTranslate> observability.
