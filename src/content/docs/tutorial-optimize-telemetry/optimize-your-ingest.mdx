...
Setting up your ingest data and charting it into digestable charts is useful for any organization. But using that data to optimize your telemetry should be the ultimate goal, and is what we cover in the last part of this tutorial series. By setting up observability objectives, creating your optimization plan, and using data reduction techniques to carry that plan out, you can reduce your redundant ingest data to reduce your costs and increase the value of the data you're ingesting. 

We cover each of these steps in greater detail below. Once you've completed them, you'll not only have optimized your ingest data as it is today, but will have the ability to continually optimize your data as often as you need to in the future.
...
Once you've lined up your data and measured it against your value drivers, you can start to reduce your data and optimize your ingest. There are two main ways to approach data reduction: 
...
What should we put as next steps?

<UserJourneyControls
    previousStep={{path: "/docs/tutorial-optimize-telemetry/detect-anomalies/", title: "Next step", body: "Learn how to use your baseline report to help you find anomalies with your telemetry"}}
/>