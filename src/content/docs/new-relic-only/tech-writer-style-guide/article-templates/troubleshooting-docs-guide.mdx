...
For examples of how to handle situations where there are no immediate solutions, see the [Known Issues Begone Epic in JIRA (DOC-2283)](https://newrelic.atlassian.net/browse/DOC-2283).
