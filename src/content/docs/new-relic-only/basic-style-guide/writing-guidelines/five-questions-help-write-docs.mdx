...
Anyone at New Relic can contribute to the Docs site, and we want you to feel confident and proud that your document provides valuable content and quality. We also want customers to trust and easily use the information. To help you plan, write, and edit excellent docs, ask yourself these five questions.
...
<CollapserGroup>
  ...
  <Collapser
    className="freq-link"
    id="why"
    title="5. Is the language approachable, expert, and visionary?"
  >
    Think about **why** the information matters and why readers will trust and use it. For more information, see the [Marketing brand guidelines PDF (34.7M)](https://drive.google.com/file/d/17qsjDFuDv-lcjcbLCeIko5xZwxhw5CiQ/view).
    ...
    <Table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Did you follow our [style guide](/docs/new-relic-only/basic-style-guide)?

            * Did you use our [edit checklist](/docs/new-relic-only/tech-writer-style-guide/processes-procedures/docs-site-edit-checklist)?
            * Did you use pronouns, contractions, and a conversational tone throughout?
            * Did you review the [usage dictionary](/docs/new-relic-only/basic-style-guide/style-guide-quick-reference/usage-dictionary) and other resources in the style guide to make sure that terms are used correctly?
          </td>
        </tr>
...
For additional background, see the [NerdLife post about 5Qs](https://nerdlife.datanerd.us/new-relic/how-to-write-an-excellent-doc-answer-five-questions).
