...
This document provides tips about creating images, but if you need help embedding them in Drupal documents, see [Embed images](/docs/new-relic-only/tech-writer-style-guide/processes-procedures/embed-images).
    ...
    <Table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            If you need to nests objects within a larger object, make sure each object has a distinct meanings.
          </td>
        </tr>
...
Image annotations are text and shapes in screen captures or diagrams that helpt to explain the image. If an image has annotations that explain what readers need to know, captions may be redundant.
