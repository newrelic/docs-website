...
* URLs: <var>[https://example.com](https://example.com)</var>, or maybe <var>YOUR_URL</var>
* Paths: <var>PATH/TO/SOMETHING.exe</var> or maybe <var>PATH_TO_FILE</var>
* Emails: <var>[datanerd@example.com](mailto:datanerd@example.com)</var> or maybe <var>YOUR_EMAIL</var>
