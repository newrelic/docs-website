...
<Callout variant="important">
  The New Relic REST API v2 (including Alerts endpoints) and the Deployments v0 API will [reach end of life on July 31, 2027](/eol/2026/07/eol-31-07-26-rest-api-v2). After this date, these endpoints will no longer be available. Migrate your integrations to NerdGraph before that date.
</Callout>
