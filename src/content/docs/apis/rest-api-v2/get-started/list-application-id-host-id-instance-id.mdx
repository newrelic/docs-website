...
To list any of these IDs in the [New Relic API Explorer](/docs/apis/using-the-api-explorer), you need your [REST API key](/docs/apis/rest-api-v2/requirements/rest-api-key).
