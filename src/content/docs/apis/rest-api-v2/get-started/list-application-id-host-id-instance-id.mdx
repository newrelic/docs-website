...
2. Go to the API Explorer at [rpm.newrelic.com/api/explore](https://rpm.newrelic.com/api/explore), then select your account name from the <DoNotTranslate>**Select an account**</DoNotTranslate> dropdown.
3. From the sidebar, select <DoNotTranslate>**(product category) > GET List**</DoNotTranslate>. Select <DoNotTranslate>**Send Request**</DoNotTranslate>.
4. Browse the <DoNotTranslate>**Response**</DoNotTranslate> to locate the product ID.
...
1. Go to <DoNotTranslate>**[rpm.newrelic.com](https://rpm.newrelic.com)**</DoNotTranslate>.
2. Go to the [API Explorer](https://rpm.newrelic.com/api/explore/application_hosts/list), then select your account name from the <DoNotTranslate>**Select an account**</DoNotTranslate> dropdown.
3. Go to the API Explorer's <DoNotTranslate>**Application host**</DoNotTranslate> page at [rpm.newrelic.com/api/explore/application_hosts/names](https://rpm.newrelic.com/api/explore/application_hosts/names).
...
<CollapserGroup>
  ...
  >
    ...
    1. Go to the [API Explorer](https://rpm.newrelic.com/api/explore/application_hosts/list), then select your account name from the <DoNotTranslate>**Select an account**</DoNotTranslate> dropdown.
    ...
    3. Select <DoNotTranslate>**Send Request**</DoNotTranslate>.
    4. Browse the <DoNotTranslate>**Response**</DoNotTranslate> to locate the `{HOST_ID}` for each host.
  </Collapser>
...
The instance ID meaning depends on the New Relic language agent being used. You can list this ID from the REST API. For Java, you can also [view the instance ID (JVM)](#UI) from APM's <DoNotTranslate>**Overview**</DoNotTranslate> page.
...
<CollapserGroup>
  ...
  >
    ...
    2. Enter the specific [`$APP_ID`](/docs/apis/rest-api-v2/requirements/finding-product-id) in the following command:
       ...
       If you have an [EU region account](/docs/using-new-relic/welcome-new-relic/getting-started/introduction-eu-region-data-center), the endpoint begins with `https://api.eu.newrelic.com`.
    3. Select <DoNotTranslate>**Send Request**</DoNotTranslate>.
    4. Browse the <DoNotTranslate>**Response**</DoNotTranslate> to locate the `$INSTANCE_ID` for each instance.
  </Collapser>
  ...
  >
    ...
    1. Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > APM & services > Applications > (select an app) > JVMs**</DoNotTranslate>.
