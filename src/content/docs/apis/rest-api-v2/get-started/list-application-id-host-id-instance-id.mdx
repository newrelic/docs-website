...
2. Go to the API Explorer at [rpm.newrelic.com/api/explore](https://rpm.newrelic.com/api/explore), then select your account name from the <DNT>**Select an account**</DNT> dropdown.
3. From the sidebar, select <DNT>**(product category) > GET List**</DNT>. Select <DNT>**Send Request**</DNT>.
4. Browse the <DNT>**Response**</DNT> to locate the product ID.
