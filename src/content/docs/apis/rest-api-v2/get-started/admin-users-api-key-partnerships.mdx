...
When calling endpoints in the New Relic REST API (v2) that require the <InlinePopover type="userKey"/>, New Relic suggests you use the described [authentication method](/docs/apis/rest-api-v2/requirements/admins-api-key-partnerships#Partners).
...
This partner-only authentication method will only work with the [New Relic REST API (v2)](https://api.newrelic.com/). It <DNT>**does not**</DNT> work with the following:
...
* [Synthetic monitoring API](/docs/apis/synthetics-rest-api/monitor-examples/manage-synthetics-monitors-rest-api)
