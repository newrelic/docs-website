---
title: Admin user's API key and partnerships
contentType: page
template: basicDoc
topics:
  - APIs
...
When calling endpoints in the New Relic REST API (v2) that require Admin user's [API keys](/docs/apis/rest-api-v2/requirements/rest-api-key), New Relic suggests you use the described [authentication method](/docs/apis/rest-api-v2/requirements/admins-api-key-partnerships#Partners).

## Custom headers and API calls

When making API calls, use the following custom headers with your [partner API key](/docs/accounts-partnerships/partnerships/partner-api/partner-api-reference#the-api-key), [partner ID](/docs/accounts-partnerships/partnerships/partner-api/partner-api-reference#partner-id), and your customer's [account ID](/docs/accounts-partnerships/accounts/account-setup/account-id):
