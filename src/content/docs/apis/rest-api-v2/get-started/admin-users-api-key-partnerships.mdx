...
This partner-only authentication method will only work with the [New Relic REST API (v2)](https://api.newrelic.com/). It <DoNotTranslate>**does not**</DoNotTranslate> work with the following:
