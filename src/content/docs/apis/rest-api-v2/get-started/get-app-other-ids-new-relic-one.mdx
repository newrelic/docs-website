...
When using the [New Relic REST API](/docs/apis/rest-api-v2/getting-started/introduction-new-relic-rest-api-v2), you need to replace some ID placeholders (like `{APPID}`, `{KEYTX_ID}`, `{PLUGIN_ID}`, `{COMPONENT_ID}`, etc.) with the ID for an app, transaction, or other component.
