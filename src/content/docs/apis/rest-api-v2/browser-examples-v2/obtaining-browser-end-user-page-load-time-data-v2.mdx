...
tags:
  ...
  - REST API v2
  - Browser examples (v2)
metaDescription: How to use the New Relic REST API v2 to obtain the Browser transaction response time chart's data on your app's New Relic Browser Summary page.
redirects:
