...
The average browser [page load time](/docs/browser/new-relic-browser/page-load-timing-resources/page-load-timing-process) (or response time) appears at the top right of the main chart of your [<DoNotTranslate>**Summary**</DoNotTranslate> page](/docs/browser/new-relic-browser/getting-started/browser-overview-website-performance-glance#viewing). This value is labeled <DoNotTranslate>**Browser**</DoNotTranslate> and shows the average page load time in seconds.
