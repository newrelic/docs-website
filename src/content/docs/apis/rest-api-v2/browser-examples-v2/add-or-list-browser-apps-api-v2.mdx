...
<table>
  <thead>
    <tr>
      <th width={250}>
        <DoNotTranslate>**API (v2) output**</DoNotTranslate>
      </th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        The loader script <DoNotTranslate>**must**</DoNotTranslate> be inserted into the user’s HTML pages correctly:
        ...
        * The entire loader script must be inserted in-line, <DoNotTranslate>**not**</DoNotTranslate> as a link to the <DoNotTranslate>**.js**</DoNotTranslate> file.
      </td>
    </tr>
  </tbody>
</table>
...
To view a list of your browser-monitored apps, replace `${API_KEY}` with your [New Relic API key](/docs/apis/rest-api-v2/requirements/api-keys#rest-api-key) in the following command. To accomplish the same task from the API Explorer, use your API key and go to <DoNotTranslate>**[rpm.newrelic.com/api/explore](https://rpm.newrelic.com/api/explore) > Browser Applications > GET List**</DoNotTranslate>.
...
<DoNotTranslate>**View by name:**</DoNotTranslate>
...
<DoNotTranslate>**View by browser application ID:**</DoNotTranslate>

To view a specific browser app if you know its ID, replace `${API_KEY}` with your [New Relic API key](/docs/apis/rest-api-v2/requirements/api-keys#rest-api-key), and replace `${ID}` with your browser application ID in the following command:
...
<DoNotTranslate>**View multiple browser apps:**</DoNotTranslate>
