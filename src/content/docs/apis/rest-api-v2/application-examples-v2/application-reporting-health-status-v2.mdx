...
<DoNotTranslate>**Exception:**</DoNotTranslate> The REST API uses `orange` instead of `yellow`. If the application is not associated with an alert policy, it will show as `unknown`.
