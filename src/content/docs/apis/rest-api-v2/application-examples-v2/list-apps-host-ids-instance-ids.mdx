...
You can also use the [REST API Explorer's <DoNotTranslate>**Applications > List**</DoNotTranslate>](/docs/apis/using-the-api-explorer) to list the ID details. Enter the correct application name.
...
You can also use the [REST API Explorer's <DoNotTranslate>**Applications > List**</DoNotTranslate>](/docs/apis/using-the-api-explorer) or <DoNotTranslate>**Applications > List**</DoNotTranslate> to list the ID details. Enter the correct application name.
