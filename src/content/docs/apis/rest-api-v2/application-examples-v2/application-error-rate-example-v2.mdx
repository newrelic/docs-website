...
The average percentage appears above the <DoNotTranslate>**Error rate**</DoNotTranslate> chart on your app's [<DoNotTranslate>**Summary**</DoNotTranslate> page](/docs/apm/applications-menu/monitoring/apm-overview-page). New Relic uses this formula to calculate it:
...
To obtain the <DoNotTranslate>**error count:**</DoNotTranslate>
...
To get the <DoNotTranslate>**HttpDispatcher call count**</DoNotTranslate> (web application):
...
To get the <DoNotTranslate>**OtherTransaction call count**</DoNotTranslate> (non-web app):
