...
New Relic provides summary information for applications as a rolling <DoNotTranslate>**three- to four-minute average**</DoNotTranslate>.

<table>
  <thead>
    <tr>
      <th width={200}>
        <DoNotTranslate>**To obtain summary data...**</DoNotTranslate>
      </th>
  ...
  <tbody>
    <tr>
      <td>
        For <DoNotTranslate>**all**</DoNotTranslate> applications for your account
      </td>
    ...
    <tr>
      <td>
        For a <DoNotTranslate>**specific**</DoNotTranslate> application
      </td>
    ...
    <tr>
      <td>
        By using the <DoNotTranslate>**app ID**</DoNotTranslate>
      </td>
...
New Relic provides summary information for key transactions as a rolling <DoNotTranslate>**ten minute average**</DoNotTranslate>.
...
<table>
  ...
  <tbody>
    <tr>
      <td>
        For <DoNotTranslate>**all**</DoNotTranslate> key transactions for your account
      </td>
    ...
    <tr>
      <td>
        For a <DoNotTranslate>**specific**</DoNotTranslate> key transaction
      </td>
    ...
    <tr>
      <td>
        By using the <DoNotTranslate>**key transaction ID**</DoNotTranslate>
      </td>
