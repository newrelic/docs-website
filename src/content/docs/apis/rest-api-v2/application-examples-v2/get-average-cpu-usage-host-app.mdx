...
You can use the New Relic REST API (v2) to get the average CPU usage for your application on a single host. This value appears on the [APM <DoNotTranslate>**Summary**</DoNotTranslate> page](/docs/apm/applications-menu/monitoring/apm-overview-page) in the <DoNotTranslate>**Hosts**</DoNotTranslate> table, in the column labeled <DoNotTranslate>**CPU usage**</DoNotTranslate>.
...
<Callout variant="tip">
  To get the same information from the [New Relic API Explorer (v2)](https://rpm.newrelic.com/api/explore), select [<DoNotTranslate>**Applications > GET Metric Data**</DoNotTranslate>](https://rpm.newrelic.com/api/explore/applications/data), and include your [API key](/docs/apis/rest-api-v2/getting-started/introduction-new-relic-rest-api-v2#api_key). Add your [application ID](/docs/apm/apis/requirements/identification-code), and the `names[]=CPU/User Time` and `values[]=percent` metrics in the appropriate fields.
</Callout>
