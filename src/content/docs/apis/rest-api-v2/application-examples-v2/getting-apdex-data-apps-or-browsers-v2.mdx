...
<table>
  <thead>
    <tr>
      <th width={150}>
        <DoNotTranslate>**Metric name**</DoNotTranslate>
      </th>

      <th>
        <DoNotTranslate>**Metric value**</DoNotTranslate>
      </th>
    </tr>
  </thead>
...
This will return the same Apdex scores shown in your [APM <DoNotTranslate>**Overview**</DoNotTranslate> page](/docs/apm/applications-menu/monitoring/applications-overview-dashboard).
...
<DoNotTranslate>**Tip:**</DoNotTranslate> To return a series of Apdex scores instead of an average, omit `&summarize=true`.
