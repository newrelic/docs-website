...
tags:
  ...
  - REST API v2
  - Plugin examples (v2)
metaDescription: 'How to use New Relic''s REST API to obtain information about a single component if you know the plugin''s ID, the component''s ID, or the component''s name.'
redirects:
