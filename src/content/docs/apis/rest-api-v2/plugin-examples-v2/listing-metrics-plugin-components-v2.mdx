  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        curl -X GET "https://api.newrelic.com/v2/components/${COMPONENT_ID}/metrics/data.xml" \
             -H "X-Api-Key:${APIKEY}" -i \
             -d "names[]=${METRIC_NAME}&values[]=${METRIC_VALUE}<b>&from=2014-03-01T20:59:00+00:00&to=2014-03-01T21:59:00+00:00</b>&summarize=true"
        ```
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        curl -X GET "https://api.newrelic.com/v2/components/${COMPONENT_ID}/metrics/data.xml" \
             -H "X-Api-Key:${APIKEY}" -i \
             -d "names[]=${METRIC_NAME}&values[]=${METRIC_VALUE}&from=2014-03-01T20:59:00+00:00&to=2014-03-01T21:59:00+00:00<b>&summarize=true</b>"
        ```
      </td>
    </tr>
  </tbody>
