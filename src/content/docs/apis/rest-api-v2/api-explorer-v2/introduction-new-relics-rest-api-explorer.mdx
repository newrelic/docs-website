...
![This is an example of the API Explorer homepage](src/images/API_explorer_main_page.png 'API_explorer_main_page.png')

<figcaption>
  **[rpm.newrelic.com/api/explore](https://rpm.newrelic.com/api/explore)**: The
  New Relic API Explorer makes it easy to test and send requests for any API
  endpoint. After you select your account and your choice of functions for the
  type of API call (applications, browsers, users, etc.), the UI provides an
  interactive form to view requirements and test your parameter values.
</figcaption>
...
<Callout variant="tip">
  The New Relic agents use different APIs and are not accessible via the API
  Explorer.
</Callout>
