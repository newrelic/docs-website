...
* To specify a [time range](/docs/apm/apis/api-v2-examples/specifying-time-range-api-v2) for the metric timeslice data, fill the `from` and `to` values, or use the [diamond](/docs/apm/apis/api-explorer-v2/parts-api-explorer#diamond) <img title="icon-api-diamond" alt="icon-api-diamond" src={iconApiDiamond}/> .
