...
The <var><a href="/docs/apis/rest-api-v2/requirements/finding-product-id">$APPID</a></var> specifies the exact application or product for which the data is being requested. The information following this parameter will vary depending on the data request.
