...
<Callout variant="tip">
  Data availability is subject to the [data retention
  policy](/docs/accounts-partnerships/accounts/account-maintenance/data-retention)
  for your subscription level.
</Callout>
...
If you are using the New Relic REST API Explorer (v2), you can use the diamond ![icon-api-diamond](src/images/icon-api-diamond.png 'icon-api-diamond') icon to select time ranges. If you have an [EU region account](/docs/using-new-relic/welcome-new-relic/getting-started/introduction-eu-region-data-center), the above URL begins with `https://api.eu.newrelic.com`.
