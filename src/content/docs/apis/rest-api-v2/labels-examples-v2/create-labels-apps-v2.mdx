...
<Callout variant="important">
  The use of the REST API for labels/tags is reaching End Of Life at 31 March 2022 and it will be not available after. For how to add tags, see [Tags](/docs/new-relic-one/use-new-relic-one/core-concepts/tagging-use-tags-organize-group-what-you-monitor).
</Callout>
