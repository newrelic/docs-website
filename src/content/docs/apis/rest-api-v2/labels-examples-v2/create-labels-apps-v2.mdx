...
* The <var>NEW_RELIC_USER_KEY</var> in the examples represents your [user key](https://docs.newrelic.com/docs/alerts-applied-intelligence/new-relic-alerts/rest-api-alerts/rest-api-calls-alerts#personal-api-key).
