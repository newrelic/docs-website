...
<Callout variant="tip">
  The use of the REST API for labels/tags is getting End Of Life at 31 March 2020 and it will not be available. For how to add tags, see [Tags](/docs/new-relic-one/use-new-relic-one/core-concepts/tagging-use-tags-organize-group-what-you-monitor).
</Callout>
