...
This describes how to use the New Relic REST API (v2) to get your mobile application's overall and version-specific <DoNotTranslate>**crash count**</DoNotTranslate> and <DoNotTranslate>**crash rate**</DoNotTranslate>, which appear on the [<DoNotTranslate>**Summary**</DoNotTranslate> page](/docs/mobile-monitoring/mobile-monitoring-ui/mobile-app-pages/mobile-apps-overview-page) in the upper right corner.
