...
New Relic tools and features, like APM, <InlinePopover type="infrastructure" /> monitoring, browser monitoring, and alerts, are often used together, and sometimes can overlap in functionality. This is why multiple APIs may be relevant to each area. Some API functionality will depend on your [access to features and data](/docs/accounts/accounts-billing/general-account-settings/factors-affecting-access-features-data).
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Every <InlinePopover type="apm" /> language agent has an API that lets you customize the agent's default behavior, including reporting custom data. <InlinePopover type="apm" /> agent APIs include:
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            To make your own custom integrations for reporting data to New Relic <InlinePopover type="infrastructure" />, use the [Flex integration](/docs/infrastructure/host-integrations/host-integrations-list/flex-integration-tool-build-your-own-integration).
          </td>
        </tr>
