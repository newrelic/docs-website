...
## APIs for ingest of our core data types [#data-type-apis]
...
NerdGraph is our newest API and is our attempt to bring together in one place our older APIs, including our REST API (below). Note that there is still some functionality you can do with REST APIs that can't yet be done with NerdGraph, and this is why some organizations still use the REST API. 
