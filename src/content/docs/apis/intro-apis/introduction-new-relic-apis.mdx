...
[NerdGraph](/docs/apis/graphql-api/getting-started/introduction-new-relic-graphql-api) is the API we recommend for querying New Relic data and making a range of feature configurations. To get started, see [Introduction to NerdGraph](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph). 

NerdGraph is our newest API and is our attempt to bring together in one place some of our older APIs, like our [REST API](#product-apis). Note that there is still some functionality you can do with REST APIs that can't yet be done with NerdGraph, and this is why some organizations still use the REST API. 
  ...
  <tbody>
    ...
    <tr>
      <td id="usage-transition">
        Subscription usage (original pricing plan)
      </td>

      <td>
        For organizations on our original pricing plan, you can use [NerdGraph](#nerdgraph) to query subscription usage data. This can be helpful to see how usage compares to your current subscription level, or for doing departmental chargebacks.
      </td>
    </tr>
...
Insights-related APIs include:
  ...
  <Collapser
    ...
    title="Plugins"
  >
New Relic Plugins have been deprecated. For details, see [Plugins EOL](https://discuss.newrelic.com/t/new-relic-plugin-eol-wednesday-june-16th-2021/127267).  
  </Collapser>
</CollapserGroup>
