...
License keys are used to report almost all data (except for browser and mobile monitoring data, which use their own keys). Each key is tied to a specific account and you can create as many as you want.
  ...
  <td>
  See the API keys UI ([direct link](https://one.newrelic.com/launcher/api-keys-ui.api-keys-launcher))
  </td>
  <td>
...
[Learn more](/docs/mobile-monitoring/new-relic-mobile/maintenance/viewing-your-application-token)
      ...
      <td>
A user key is required to use [NerdGraph](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph), our GraphQL API, which is used for querying data and configuring features. Each user key is tied to a specific user and a specific account. 
</td>
