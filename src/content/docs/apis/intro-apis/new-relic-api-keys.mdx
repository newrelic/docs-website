...
<img
  ...
  src={apiKeysUi}
/>
<figcaption>From [one.newrelic.com/launcher/api-keys-ui.api-keys-launcher](https://one.newrelic.com/launcher/api-keys-ui.api-keys-launcher), you can create and manage license keys, browser keys, and user keys.</figcaption>
