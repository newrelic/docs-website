...
<table>
  ...
  <tbody>
    <tr>
      <td>
        [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) ,
...
* Someone with your [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) could send arbitrary data to your account.
...
<CollapserGroup>
  ...
  >
    <Callout variant="important">
      This key is still in use but we highly recommend using the [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key), which can be used for the same things and more.
    </Callout>
