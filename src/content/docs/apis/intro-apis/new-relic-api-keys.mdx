...
<CollapserGroup>
    ...
    To rotate user-created license keys:
      ...
      2. Go to [<DoNotTranslate>**one.newrelic.com/api-keys**</DoNotTranslate>](https://one.newrelic.com/api-keys) (or [<DoNotTranslate>**one.eu.newrelic.com/api-keys**</DoNotTranslate>](https://one.eu.newrelic.com/api-keys) for our EU datacenter). 
