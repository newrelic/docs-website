...
* For the <InlinePopover type="userKey" />:
  ...
  * Consider creating a New Relic user that's used by the organization or a department: this can help for situations where you want to set up functionality that won't need user key replacement when team members depart your organization. 
