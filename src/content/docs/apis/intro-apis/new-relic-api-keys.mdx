...
If you're using [NerdGraph](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph), you can use existing user keys and generate new ones from our [GraphiQL explorer](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph/#explorer). 
...
* [Insights insert key](#insights-insert-key): same functionality as the license key. **We recommend using the license key instead.**
...
You can't manage or delete an original license key that was created when an account was created. For that, [contact New Relic support](https://support.newrelic.com/).
...
New Relic user keys, sometimes referred to as "personal API keys", are required for using [NerdGraph](/docs/apis/graphql-api/getting-started/introduction-new-relic-graphql-api) (our GraphQL API). Nerdgraph is our preferred API for querying New Relic data and doing some types of product configuration. User keys also let you use our [REST API](/docs/apis/rest-api-v2), with restrictions based on your permissions.

To view and manage the license key: From the [account dropdown](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#account-dropdown), click **API keys** (get [a direct link to the API keys page](https://one.newrelic.com/launcher/api-keys-ui.api-keys-launcher)). 

To manage this key via the API, see [Manage keys with NerdGraph](/docs/apis/nerdgraph/examples/use-nerdgraph-manage-license-keys-user-keys).
...
For managing keys via API, see [Manage keys with NerdGraph](/docs/apis/nerdgraph/examples/use-nerdgraph-manage-license-keys-user-keys).
