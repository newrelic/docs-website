...
To retrieve the full key after creation, [query it using NerdGraph](/docs/apis/nerdgraph/examples/use-nerdgraph-manage-license-keys-user-keys/#query-keys).

To enable admin users to generate and view user API keys for others, refer [Admin setup for user key creation and access](/docs/apis/nerdgraph/examples/manage-user-keys).
