...
<Callout variant="tip">
  To use APIs and SDKs, as well as the rest of our [observability
...
<Callout variant="tip">
  For sample queries and mutations, use our [NerdGraph
  tutorials](/docs/apis/graphql-api/tutorials).
</Callout>
...
<Callout variant="tip">
  To learn more about different API key types, see [Understand New Relic API
  keys](/docs/apis/get-started/intro-apis/understand-new-relic-api-keys).
</Callout>
