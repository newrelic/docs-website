...
To use the synthetics REST API, you must have synthetics-related [permissions](/docs/accounts/accounts-billing/new-relic-one-user-management/user-capabilities), and a <InlinePopover type="userKey" />.
