...
To use the Synthetics REST API, you must have a user role that allows that capability and a [user key](/docs/apis/rest-api-v2/getting-started/introduction-new-relic-rest-api-v2#api_key).
...
<CollapserGroup>
  ...
  >
    To view a single Synthetics monitor, send a GET request to `$API_ENDPOINT/v3/monitors/$MONITOR_ID`.

    ```
    curl -v \
         -H 'Api-Key:<a href="/docs/apis/rest-api-v2/getting-started/introduction-new-relic-rest-api-v2#api_key"><var>$API_KEY</var></a>' <var>$API_ENDPOINT</var>/v3/monitors/<code><var>$MONITOR_ID</var></code>
    ```
  ...
  >
    ...
    Use a specific monitor ID, and replace the [Synthetics REST API attributes](/docs/apis/synthetics-rest-api/monitor-examples/payload-attributes-synthetics-rest-api) with your specific values.
  ...
  >
    ...
    curl -v \
         ...
         -H 'Content-Type: application/json' <var>$API_ENDPOINT</var>/v3/monitors/<code><var>$MONITOR_ID</var></code> \
  ...
  >
    To delete an existing monitor in New Relic Synthetics, send a DELETE request to <var>$API_ENDPOINT</var>`/v3/monitors/$MONITOR_ID`:

    ```
    curl -v \
         -H 'Api-Key:<a href="/docs/apis/rest-api-v2/getting-started/introduction-new-relic-rest-api-v2#api_key"><var>$API_KEY</var></a>' \
         -X DELETE <var>$API_ENDPOINT</var>/v3/monitors/<code><var>$MONITOR_ID</var></code>
    ```
...
<CollapserGroup>
  ...
  >
    To view the script associated with a specific `SCRIPT_BROWSER` or `SCRIPT_API` monitor in New Relic Synthetics for your account, send a GET request to <var>$API_ENDPOINT</var>`/v3/monitors/$MONITOR_ID/script`. For example:

    ```
    curl -v
         -H 'Api-Key: <a href="/docs/apis/rest-api-v2/getting-started/introduction-new-relic-rest-api-v2#api_key"><var>$API_KEY</var></a>' 
         <var>$API_ENDPOINT</var>/v3/monitors/<code><var>$MONITOR_ID</var></code>/script
    ```
  ...
  >
    To update the script associated with a specific `SCRIPT_BROWSER` or `SCRIPT_API` monitor in New Relic Synthetics for your account, send a PUT request to <var>$API_ENDPOINT</var>`/v3/monitors/$MONITOR_ID/script` with a JSON payload that contains the `scriptText` (required).
    ...
    curl -v -X PUT \
         ...
         <var>$API_ENDPOINT</var>/v3/monitors/<code><var>$MONITOR_UUID</var></code>/script \
         -d $scriptPayload
    ```
