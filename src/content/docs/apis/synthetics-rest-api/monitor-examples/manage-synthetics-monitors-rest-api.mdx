...
To use the synthetics REST API, you must have a user role that allows that [capability](/docs/accounts/accounts-billing/new-relic-one-user-management/user-capabilities) and a <InlinePopover type="userKey" />.
