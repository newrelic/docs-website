...
For US-based accounts (default), use the following endpoint:
...
For [JP data center](/docs/accounts/accounts-billing/account-setup/choose-your-data-center) accounts, use the following endpoint:

```
https://synthetics.jp.newrelic.com/synthetics/api
```
...
<CollapserGroup>
  ...
  >
    Please use [NerdGraph APIs](/docs/apis/nerdgraph/examples/synthetics-api/overview/) to manage your synthetic monitors using our latest runtimes.
