...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Double: Value for the [synthetic monitoring SLA report](/docs/synthetics/new-relic-synthetics/pages/synthetics-sla-report-aggregate-monitor-metrics), in seconds.
      </td>
    </tr>
