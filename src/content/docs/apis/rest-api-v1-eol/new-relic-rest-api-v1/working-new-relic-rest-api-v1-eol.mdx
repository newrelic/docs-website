...
metaDescription: The New Relic REST API (v1) has now reached end of life. Migrate your v1 scripts to their Nerd Graph equivalent.
redirects:
...
New Relic REST API Version 1 has reached **end of life** and is no longer functional. Migrate your v1 scripts to their NerdGraph equivalent.
</Callout>
