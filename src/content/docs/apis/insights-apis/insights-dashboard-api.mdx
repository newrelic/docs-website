...
Do not use the Insights Dashboards API. Instead, use the [New Relic One Dashboards API](/docs/query-your-data/explore-query-data/dashboards/dashboards-api/) with NerdGraph, our GraphQL API.  
