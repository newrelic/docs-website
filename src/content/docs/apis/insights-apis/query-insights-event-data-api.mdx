...
<Callout variant="tip">
  <DoNotTranslate>**This API is no longer the preferred way to query New Relic data.**</DoNotTranslate> Please use [NerdGraph](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph/) to do that.
</Callout>

## Requirements and recommendations [#requirements]

<DoNotTranslate>**This API is no longer the preferred way to query New Relic data.**</DoNotTranslate> For best results, you should use [NerdGraph](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph) to query data.
...
To create a new query key:
  ...
  1. Go to [one.newrelic.com/api-keys](https://one.newrelic.com/api-keys). If you are using the EU datacenter, go to [one.eu.newrelic.com/api-keys](https://one.eu.newrelic.com/api-keys) instead.

  2. Click <DoNotTranslate>**Create a key button**</DoNotTranslate> located in the top-right corner of the API keys page.
  ...
  4. Click <DoNotTranslate>**Save**</DoNotTranslate> to generate the new key.
...
You can use <DoNotTranslate>**Powershell**</DoNotTranslate> to query events via API:
...
<CollapserGroup>
  <Collapser title="Query, query API request, returned data">
    <DoNotTranslate>**Original NRQL query:**</DoNotTranslate>
    ...
    <DoNotTranslate>**Returned JSON data:**</DoNotTranslate>
