...
Alerts      
      ...
      <td>
[See all alert-related tutorials](/docs/alerts-applied-intelligence/new-relic-alerts/alerts-nerdgraph/nerdgraph-api-nrql-condition-alerts/)      
      </td>
    </tr>
...
Applied Intelligence     
      ...
      <td>
[View and configure topology](/docs/apis/nerdgraph/examples/topology-nerdgraph-tutorial)   
      </td>
    </tr>
...
Partners and resellers</td>
      ...
      <td>
[Manage subscriptions](/docs/apis/nerdgraph/tutorials/provisions-your-subscriptions-nerdgraph) (only for partners using [original pricing model](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-changes-pricing-user-model/#pricing-plans))      </td>
    </tr>
