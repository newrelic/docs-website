...
Anomaly detection     </td>
      ...
      <td>
[Configure anomaly detection](/docs/apis/nerdgraph/examples/nerdgraph-anomaly-detector-configurations-api-tutorial)      </td>
    </tr>
...
Date retention</td>
  ...
  [Manage data retention](/docs/telemetry-data-platform/manage-data/manage-data-retention/#api-examples)
    ...
    <tr>
      <td>Anomaly detector configurations</td>
      <td>[Manage anomaly detector configurations](/docs/apis/nerdgraph/examples/nerdgraph-anomaly-detector-configurations-api-tutorial/)</td>
    </tr>
  </tbody>
</table>
