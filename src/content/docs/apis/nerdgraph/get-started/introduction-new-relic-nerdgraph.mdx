...
NerdGraph is our GraphQL-format API that lets you query New Relic data and configure some New Relic features. After you [sign up for a New Relic account](https://newrelic.com/signup) (it's free, forever!), you can get started with NerdGraph.
