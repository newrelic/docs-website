...
To access the endpoint, you could make calls from your code, use the GUI [NerdGraph API explorer](/docs/apis/nerdgraph/get-started/nerdgraph-explorer), or make a curl command similar to this:
...
An easy way to experiment with the NerdGraph API is to use the GUI tool NerdGraph API explorer. For help getting started with this tool, see [NerdGraph API explorer tutorial](/docs/apis/nerdgraph/get-started/nerdgraph-explorer).
