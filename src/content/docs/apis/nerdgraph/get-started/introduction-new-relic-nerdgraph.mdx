...
* US region (default) endpoint: `https://api.newrelic.com/graphql`
* EU region endpoint: `https://api.eu.newrelic.com/graphql`
* JP region endpoint: `https://api.jp.newrelic.com/graphql`
