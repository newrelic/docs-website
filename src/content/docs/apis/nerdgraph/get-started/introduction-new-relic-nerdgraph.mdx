...
* US data center region: `https://api.newrelic.com/graphql`
* EU data center region: `https://api.eu.newrelic.com/graphql`

To access the endpoint, you can [use our NerdGraph explorer](#explorer), or you can access it directly with a curl command like this:
