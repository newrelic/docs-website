...
<Steps>
    ...
    1. Go to <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com) > All capabilities > Apps > [NerdGraph API explorer](https://api.newrelic.com/graphiql)**</DoNotTranslate>.
    2. In the API key dropdown, either select an existing [API user key](/docs/apis/intro-apis/new-relic-api-keys/#user-key) or add a new one.
