...
<Steps>
  <Step>
    ...
    1. Open the NerdGraph API explorer. The URL depends on the data center region that hosts your account:
       * US (default region): <DNT>[one.newrelic.com/nerdgraph-graphiql](https://one.newrelic.com/nerdgraph-graphiql)</DNT>
       * EU: <DNT>[one.eu.newrelic.com/nerdgraph-graphiql](https://one.eu.newrelic.com/nerdgraph-graphiql)</DNT>
