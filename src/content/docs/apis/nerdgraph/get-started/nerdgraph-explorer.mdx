...
<Steps>
    ...
    1. Go to <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com) > All capabilities > Apps > [NerdGraph API explorer](https://one.newrelic.com/nerdgraph-graphiql)**</DoNotTranslate>.
    2. In the User Key field, enter an [API user key](/docs/apis/intro-apis/new-relic-api-keys/#user-key). You will need to copy a key from the [API Key UI](https://one.newrelic.com/api-keys).
