...
<Steps>
    ...
    1. Go to <DoNotTranslate>[one.newrelic.com > All capabilities > Apps > NerdGraph API explorer](https://one.newrelic.com/nerdgraph-graphiql)</DoNotTranslate>.
    2. In the **User key** field, enter an [API user key](/docs/apis/intro-apis/new-relic-api-keys/#user-key) and click **Submit**. If you need a new key, you can create one in the [API Key UI](https://one.newrelic.com/api-keys).
...
* Account `id` (You can find the value for this by clicking on your name in the lower-left corner and then clicking <DoNotTranslate>**API Keys**</DoNotTranslate>)
* `email` 
...
3. Select the following fields:
    * `guid!:` (You can find this by opening <DoNotTranslate>**All entities**</DoNotTranslate>, clicking the <DoNotTranslate>**...**</DoNotTranslate> icon in your entity record, and the clicking <DoNotTranslate>**See metadata & tags**</DoNotTranslate>)
    * `tags!:`
        * `key!:`
        * `values:`
    * errors
...
1. Select the <DoNotTranslate>**Tools**</DoNotTranslate> menu.
