...
## Step 1. Set up the NerdGraph API explorer [#set-up]

1. Go to **[one.newrelic.com](https://one.newrelic.com) > All capabilities > Apps > (NerdGraph API explorer)[https://api.newrelic.com/graphiql]**.
