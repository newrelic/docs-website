...
import apisNerdGraphInternalDocs from 'images/apis-and-data_screenshot-crop_NerdGraph-internal-docs.webp'

import apisNerdGraphMutationExample from 'images/apis-and-data_screenshot-full_NerdGraph-mutation-example.webp'

import apisNerdGraphToolsMenu from 'images/apis-and-data_screenshot-crop_NerdGraph-tools-menu.webp'



NerdGraph is our main API for querying data and making configurations to New Relic features. If you're new to GraphQL, try out this tutorial to get acquainted with NerdGraph. If you need an overview before starting this tutorial, check out  [Meet NerdGraph: our GraphQL API](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph).
...
4. In the API key dropdown, either select an existing [API user key](/docs/apis/intro-apis/new-relic-api-keys/#user-key) or add a new one.
...
If you don't see the basic query below, erase everything in the query editor, and select these fields in the query explorer in this order: `actor`, `user`, `name`:
...
<img
  ...
  src={apisNerdGraphMutationExample}
/>
...
## Step 6. Try your NerdGraph query in the terminal [#query-terminal]
