...
<Callout variant="tip">
  You can also export your dashboards [as an
  image](/docs/apis/nerdgraph/examples/export-dashboards-pdfpng-using-api).
</Callout>
...
![dashboards_api_entity_section.png](src/images/dashboards_api_entity_section.png 'dashboards_api_entity_section.png')
...
![dashboards_api_paste_entity.png](src/images/dashboards_api_paste_entity.png 'dashboards_api_paste_entity.png')
