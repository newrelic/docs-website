...
With NerdGraph, you can [create queries of data from up to 30 New Relic accounts](/docs/apis/nerdgraph/examples/nerdgraph-nrql-tutorial#cross-account-query). You can also create a dashboard using data across those accounts by adding account IDs to the `accountIds` array.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        Maximum number of accounts in a cross-account query
      </td>
