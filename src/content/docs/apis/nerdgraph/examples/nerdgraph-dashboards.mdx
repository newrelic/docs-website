...
```
mutation {
  dashboardCreate(accountId: 1, dashboard: {name: "Cross account queries - NerdGraph API - Cross Account Test1", description: null, permissions: PUBLIC_READ_WRITE, pages: [{name: "Page 1", description: null, widgets: [{visualization: {id: "viz.billboard"}, layout: {column: 1, row: 1, height: 3, width: 4}, title: "Cross Account Total Transaction Count", rawConfiguration: {legend: {enabled: true}, nrqlQueries: [{accountIds: [1, 1606862, 2212585], query: "SELECT count(*) FROM Transaction"}], yAxisLeft: {zero: true}}, linkedEntityGuids: null}, {visualization: {id: "viz.pie"}, layout: {column: 5, row: 1, height: 3, width: 4}, title: "Cross Account Pie", rawConfiguration: {legend: {enabled: true}, nrqlQueries: [{accountIds: [1, 1606862, 2212585], query: "SELECT count(*) FROM Transaction FACET accountId()"}], yAxisLeft: {zero: true}}, linkedEntityGuids: null}, {visualization: {id: "viz.line"}, layout: {column: 9, row: 1, height: 3, width: 4}, title: "Cross Account Line", rawConfiguration: {legend: {enabled: true}, nrqlQueries: [{accountIds: [1, 1606862, 2212585], query: "SELECT count(*) FROM Transaction FACET accountId() TIMESERIES"}], yAxisLeft: {zero: true}}, linkedEntityGuids: null}]}]}) {
    errors {
      description
      type
    }
