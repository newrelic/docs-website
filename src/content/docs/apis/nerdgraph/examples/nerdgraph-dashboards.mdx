...
<CollapserGroup>
  <Collapser
    id="update-widget-link-description"
    title="Update widget link and description"
  >
    ```graphql
    mutation {
  ...
  <Collapser
    id="bulk-update-widget-links"
    title="Bulk update multiple widgets"
  >
    You can update links and descriptions for multiple widgets in a single API call:
  ...
  <Collapser
    id="remove-widget-link-description"
    title="Remove widget link and description"
  >
...
<CollapserGroup>
  <Collapser
    id="create-hidden-variable"
    title="Create a dashboard with a hidden variable"
  >
    ```graphql
    mutation {
      dashboardCreate(
  ...
  <Collapser
    id="update-variable-visibility"
    title="Update a variable to hide or show it"
  >
...
For more information about template variable visibility, see [Show and hide variables](/docs/query-your-data/explore-query-data/dashboards/dashboard-template-variables/#variable-visibility).
