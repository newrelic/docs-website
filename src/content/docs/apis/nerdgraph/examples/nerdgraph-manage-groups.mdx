...
* [User type](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type): core user or full platform user
* [Role](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts/#roles): <DNT>**Authentication Domain Manager**</DNT>
