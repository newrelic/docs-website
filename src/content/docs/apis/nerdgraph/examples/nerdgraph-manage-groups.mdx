...
You can grant a group access to roles at different scopes: organization, account, entity, or group level. The type of grant you use must match the scope of the role you're assigning.
...
You can revoke access grants at different scopes: organization, account, entity, or group level. The type of revocation you use must match the scope of the grant you're removing.
