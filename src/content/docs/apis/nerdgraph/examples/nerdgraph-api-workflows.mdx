---
title: "NerdGraph tutorial: Workflows API"
tags:
  - Applied intelligence
  - Workflows
  - Nerdgraph
metaDescription: 'Examples of how to use the NerdGraph API explorer to create workflows.'
---

You can create and manage workflows using our Workflows API
...
In order to create a workflow you should first create destinations and channels using this [documentation](https://docs.newrelic.com/docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows)
...
By keeping the `predicates` attribute’s value an empty list the workflow will catch all the possible issue events, by selecting an attribute value we can filter issue events.
For example, we can choose an attribute that filters only issues that are relevant to a specific team.
    ```
mutation {
