...
tags:
  ...
  - Workflows
  - Nerdgraph
metaDescription: 'For New Relic's applied intelligence: how to how our NerdGraph API to create and manage workflows.'
---
...
In order to create a workflow you should first [create destinations and channels](/docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows).
