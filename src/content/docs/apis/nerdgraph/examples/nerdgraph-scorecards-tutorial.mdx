    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>No</td>
          <td>The maturity (progress) levels for this Scorecard. If omitted, the Scorecard is created with the default `BASIC`, `INTERMEDIATE`, and `ADVANCED` levels. See [Create or update maturity levels](#maturity-levels) for the field details.</td>
        </tr>
      </tbody>
    </table>
...
The `progressLevels` field is optional. If you omit it, the Scorecard is created with the default `BASIC`, `INTERMEDIATE`, and `ADVANCED` levels. To add custom levels or change levels on an existing Scorecard, see [Create or update maturity levels](#maturity-levels).
  </Collapser>
