...
<Callout variant="caution"> If a shared dashboard is not password-protected, anyone with the live URL can access and view all the information it contains. To prevent unwanted access, ensure you [create password-protected links](#create-dashboard-url-with-psswd-nerdgraph) or [enable password protection for existing shared links](enable-password-dashboard-url-nerdgraph).</Callout>
  ...
  ```graphql
  {
    "data": {
      "dashboardCreateLiveUrl": {
        ...
        "url": "https://staging-share.newrelic.com/dashboard/f6c730bf-fced-4890-ad6e-86ab6a6e8159",
...
<Collapser id="disable-password-dashboard-url-nerdgraph" title="Disable password protection for the live link">
Make sure you have the [permissions](/docs/query-your-data/explore-query-data/dashboards/prerequisites-to-share-dashboards-charts/#permissions-to-custom-role) to modify the configuration of the shared dashboard. 
...
<Collapser id="reset-password-dashboard-url-nerdgraph" title="Reset password for the live link">
Make sure you have the [permissions](/docs/query-your-data/explore-query-data/dashboards/prerequisites-to-share-dashboards-charts/#permissions-to-custom-role) to modify the configuration of the shared dashboard. 
...
<Collapser id="revoke-dashboard-url-nerdgraph" title="Revoke a live link">
...
<Collapser id="list-dashboard-url-nerdgraph" title="List all shared links">
