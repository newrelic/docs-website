...
<Callout variant="tip">
Each update operation creates a new version of the secret. The highest version is always the latest version of the secret. To [retrieve older versions](#retrieve-secret) of the secret, you can use the `{customerAdministration {secretVersions}}` query.
</Callout>
