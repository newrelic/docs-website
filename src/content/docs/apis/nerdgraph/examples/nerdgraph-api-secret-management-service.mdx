...
The All Product Admin can [create custom roles](/docs/accounts/accounts-billing/new-relic-one-user-management/account-user-mgmt-tutorial/#roles) with the specific permissions and assign them to groups of users to manage secrets in account level. For the user group to manage secrets at the organization level, they need to have the additional [Organization Manager](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts/#admin-settings) permission.
