  ...
  <table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
             Enter the version number of the secret that you want to recover. If you do not provide a version, the latest version will be recovered.
            </td>
        </tr>        
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
             To unlock the secret and returns the actual value with other details, set it to `true`. To get the metadata of the secret without unlocking it, set it to `false`.
            </td>
        </tr>
        <tr>
            <td>
