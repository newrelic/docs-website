...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
             Serves as a logical grouping of secrets, organizing and categorizing them to enhance management and prevent conflicts. It pairs with the key to create a unique address for the secret. This attribute is particularly beneficial in environments with multiple teams or projects using New Relic, as it streamlines organization and reduces the risk of overlap or confusion.
            </td>
        </tr>
        <tr>
            <td>
             ...
             * `type`: determines the level at which your secret will be stored. If the secret is specific to a single account and doesn't need to be accessed from other accounts, select `Account`. If the secret needs to be accessed and used across multiple accounts, select `Organization`. To store a secret at the organization level, you must have the [Organization Manager](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts/#admin-settings) permission.
       ...
       <tr>
        ...
        <tr>
            ...
            <td>
             When you retrieve a list of secrets, use the cursor to navigate through the results. Without a `cursor` value, you receive the first page, which can contain up to 50 secrets. If more secrets exist, the response includes a `nextCursor` attribute with a value. Use this value in the `cursor` field for your next query to access the subsequent page.
            </td>
        </tr>                        
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>
             The key for the secret whose version you want to delete.
            </td>
        </tr>
        <tr>
            <td>
...
Use `secretsManagementRecoverSecret` mutation to recover secrets that you temporarily deleted using the `secretsManagementDeleteSecret` mutation before. If you have permanently deleted a secret, you cannot recover it.
...
Use `secretsManagementRecoverSecretVersion` mutation to recover specific versions of the secret that you temporarily deleted using the `secretsManagementDeleteSecretVersion` mutation before. If you have permanently deleted a version of a secret, you cannot recover it.
  ...
  <table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
             The key of the secret whose version you want to recover.
            </td>
        </tr>
    ...
    <tbody>
        ...
        <tr>
            ...
            * `scope` (Required)
             ...
             * `deleted`: To get all the secrets including the deleted ones, set it to `true`. To get only the available secrets, set it to `false`.
