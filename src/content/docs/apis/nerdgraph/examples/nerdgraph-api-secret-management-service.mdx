    ...
    <tbody>
       ...
       <tr>
            ...
            * `false`: You can recover the deleted secret with all its versions.
            ...
            Only All Product Admins or a use having a custom role with `purge` permission can delete secrets permanently. For more details, refer to the [Access control](#security-and-access-control) section.
            </td>
        </tr>
        <tr>
            <td>
