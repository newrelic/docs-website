...
* **Versions of secrets**: You can update a secret without losing the previous version. The <dnt>Secrets management service</dnt> tracks all versions of a secret, allowing you to retrieve up to 10 previous versions.
...
Customer-specific secrets that are unrelated to New Relic approved functionality and integrations, such as third party or personal passwords, should not be stored in the <dnt>Secrets management service</dnt>.
