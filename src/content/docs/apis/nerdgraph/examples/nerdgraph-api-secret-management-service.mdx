...
* For EU customers, New Relic stores secrets in a US-based global database, which isn't GDPR compliant. You need to provide your consent before using the service.
</Callout>
...
<Collapser 
  id="purge-secrets"
  title="Purge a secret"
>  


Use the `secretsManagementPurgeSecret` mutation to perform a hard delete. It deletes the secret key permanently from the secrets store and you can't recover.
