...
#### Sample response:
    ...
    ```json
 {
  ...
  <Collapser 
  id="secret-version" 
  title="Add versions of a secret">

If you want to add a new version of an existing secret, you can use the `secretsManagementCreateSecret` mutation with the same key, namespace, scope, and tag as the existing secret, and add the latest value of the secret for the `value` attribute. This will create a new version of the secret with the updated value. If you enter a new description, it will be update the previous description. The `version` will be incremented by 1.
  ...
  <table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
             Give an unique key for the secret that you want to recover.
            </td>
        </tr>
