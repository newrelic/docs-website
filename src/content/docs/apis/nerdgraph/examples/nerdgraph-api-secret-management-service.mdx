...
Customer-specific secrets that are unrelated to New Relic approved functionality and integrations, such as third party or personal passwords, should not be stored in the secrets management service.
...
The All Product Admin can [create custom roles](/docs/accounts/accounts-billing/new-relic-one-user-management/account-user-mgmt-tutorial/#roles) with the specific permissions and assign them to groups of users to manage secrets in account level.
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
             To get only the non-deleted versions of the secret, set it to `false`. To get all versions of the secret, including the soft deleted ones, set it to `true`.
            </td>
        </tr>
