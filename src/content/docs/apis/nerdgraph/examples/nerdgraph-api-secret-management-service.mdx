...
Use `secretsManagementCreateSecret` mutation with the following partameters to store a secret.
  ...
  <table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
             The name of the namespace to which the secret used to belong.
            </td>
        </tr>
        <tr>
            <td>
  ...
  <table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
             The key of the secret for which you want to recover the version.
            </td>
        </tr>
