...
* **Controlled deletion and recovery of secrets**: To protect sensitive information, the service allows recoverable deletion of secrets. Users without the Purge permission can soft delete secrets. Permanent deletion is restricted to users with the Purge permission.


* **Access control**: Admins can define who can access the secret by setting custom roles and permissions, and specify the scope of permissions. The scope can range from basic <dnt>**View**</dnt> to <dnt>**Purge**</dnt> permission.
...
Users with [standard roles](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts/#standard-roles) can access the <dnt>secrets management</dnt> service specific to the accounts they have access to, with the following permissions.
...
* **All Product Admin**: Users have full access to the <dnt>secrets management</dnt> service. They can create, update, retrieve, soft-delete, permanently delete, and fetch the list of secrets.

* **Billing User**: Users can only fetch the list of secrets.

The Full Platform Admin can [create custom roles](/docs/accounts/accounts-billing/new-relic-one-user-management/account-user-mgmt-tutorial/#roles) with the specific permissions and assign them to groups of users to manage secrets in account level.

For the user group to manage secrets at the organization level, they need to have the additional [Organization Manager](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts/#admin-settings) permission.

## Pre-requisites [#prerequisites]
 
To use the secrets management service, you need:

 * [Advanced Compute](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/add-on-billing) pricing plan.
...
Use the `{customerAdministration {secretVersions}}` query to retrieve all versions of a secret with its details. You can retrieve secrets that are scoped only to your current account or organization.
