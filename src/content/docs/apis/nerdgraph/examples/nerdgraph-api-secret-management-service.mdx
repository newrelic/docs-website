...
* **Standard User**: Users can create, update, retrieve and delete (soft delete) secrets.

* **All Product Admin**: Users have full access to the <dnt>Secrets management</dnt> service. They can create, update, retrieve, delete (soft delete), purge, and fetch list of secrets.
