...
[Entities](/docs/new-relic-one/use-new-relic-one/core-concepts/what-entity-new-relic) at New Relic refer to anything we monitor that generates telemetry. Entities help you find the data you want to track in New Relic, and if you understand their relationships with other entities, you can get even more insights into your data. Here are a few examples of entities:
...
In addition to [the examples below](#graphql-examples), we recommend that you experiment with the API using the [NerdGraph GraphiQL explorer](https://api.newrelic.com/graphiql). It has inline documentation that will help you construct your queries and mutations.
