...
## Create or delete relationships manually [#manual-relationships]

You can manually create additional relationships or delete them but keep the following in mind:
