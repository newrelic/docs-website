...
You can manually delete an entity in your account by using the nerdgraph api.

Just take into account, that the entity may appear again to your UI if its reindexed again by any New Relic agent.

You will need the entity GUID in order to delete an entity, and then you can run this query in NerdGraph
