---
title: "NerdGraph tutorial: Destinations"
tags:
  - Notifications
  - Notifications and Nerdgraph
  - Destinations
  - Notification Destinations
metaDescription: 'Read about how you can list, create, update, and delete destinations using the NerdGraph API.'
redirects:
...
You can manage your destinations using our NerdGraph API.
