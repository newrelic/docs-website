...
<CollapserGroup>
  ...
  >
    ...
    <Callout variant="important">
      After creating the Microsoft Teams destination, obtain the `destinationId` from the response. This ID is required to configure notification channels. See the [Microsoft Teams channel configuration section](/docs/apis/nerdgraph/examples/nerdgraph-api-notifications-channels/#microsoft-teams) for the complete workflow.
    </Callout>
  </Collapser>
