...
You can use our [NerdGraph API](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph) to view and manage users. You can add and delete users, edit users' user type and email address, and return other types of user information. 
...
Heress an example error response when trying to create a user that already exists in an auth domain:
