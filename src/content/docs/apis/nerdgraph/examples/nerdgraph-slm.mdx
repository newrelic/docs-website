...
<Callout variant="important">
  In order to create service levels, a user requires a [permission for modifying and deleting events-to-metrics rules](/docs/accounts/accounts-billing/new-relic-one-user-management/user-capabilities#insights).  
</Callout>
