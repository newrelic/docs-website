...
* **`accountId`**: The ID of the account where the <InlinePopup type="apm" /> service or browser application belongs to, which contains the NRDB data for the SLI/SLO calculations.
