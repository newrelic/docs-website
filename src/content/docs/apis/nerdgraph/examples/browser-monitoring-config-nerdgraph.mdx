...
<Callout variant="important">
  ...
  <Collapser
    ...
    >
Update the obfuscation rules using the `agentApplicationSettingsUpdate` mutation. You can add new rules or modify existing ones by defining the following properties:
...
Update the payload capture setting using the `agentApplicationSettingsUpdate` mutation:
