...
<CollapserGroup>
  <Collapser
    id="retrieve"
    title="Step 1: Retrieve obfuscation rules"
  >

Retrieve the current obfuscation rules for your browser application using the following query:
...
<Callout variant="important">
  ...
  <Collapser
    id="update"
    title="Step 2: Update obfuscation rules"
    >
Update the obfuscation rules using `agentApplicationSettingsUpdate` mutation. You can add new rules or modify existing ones by defining the following properties:
...
<CollapserGroup>
<Collapser
  id="query-payload-capture"
  title="Query the payload capture setting"
  >
...
<Collapser
  id="update-payload-capture"
  title="Update the payload capture setting"
  >
