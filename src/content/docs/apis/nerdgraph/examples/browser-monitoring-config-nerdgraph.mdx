...
{
  actor {
    entity(guid: "MTE3NjI3MzJ8QlJPV1NFUnxBUFBMSUNBVElPTnw1MjUxMjQ1Mg") {
      ... on BrowserApplicationEntity {
...
The query generates this response:
...
mutation {
  agentApplicationSegmentsReplaceAllBrowserSegmentAllowList(
    entityGuid: "MTE3NjI3MzJ8QlJPV1NFUnxBUFBMSUNBVElPTnw1MjUxMjQ1Mg"
...
```
The mutation generates this response:
