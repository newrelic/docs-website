...
<CollapserGroup>
  ...
  >
    ...
    1. Have an existing Microsoft Teams channel where you want to receive notifications.
    2. Create a [Microsoft Teams destination](/docs/apis/nerdgraph/examples/nerdgraph-api-notifications-destinations/#microsoft-teams) in New Relic and obtain the `destinationId`.
