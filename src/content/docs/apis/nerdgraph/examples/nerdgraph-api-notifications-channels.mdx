...
This document refers to using Nerdgraph APIs for the new notification platform using destinations and notification messages. Notification messages are also referred as channels and are not to be confused with the legacy notification channels.
</Callout>
