...
In order for an account to share its data with other accounts within the organization, it must elect to do so. This tutorial shows you how to use the NerdGraph API explorer to update account elections for cross-account alerting.
...
<Step>
    Collect your list of account IDs to update. The API will accept up to **20 account IDs**.
</Step>
