...
To allow data sharing between accounts within an organization, an account must opt in to the 'cross-account alerting' feature. Follow the below instructions on how to use the NerdGraph API Explorer to update account settings, enabling cross-account alerting.
...
<Step>
    Collect your list of account IDs to update. The API accept up to **20 account IDs**.
</Step>
