---
title: "NerdGraph tutorial: Manage anomaly detector configurations"
tags:
  - APIs
  - NerdGraph
  - Examples
...
redirects:
  - /docs/apis/nerdgraph/tutorials/nerdgraph-anomaly-detector-tutorials
  - /docs/nerdgraph-anomaly-detector-tutorials
---
Automated anomaly detection at New Relic starts with an anomaly detector - a way to systematically observe and record anomalies in a specific dataset. To name and configure the dataset, you'll need to create an anomaly detector configuration -
a set of fields that tells us the signals you're interested in watching and where to store anomalous data.
...
creates a detector using all the entities contained in the [workload](/docs/new-relic-one/use-new-relic-one/workloads/workloads-isolate-resolve-incidents-faster) as the dataset. An entity type configuration uses all the entities of a single [entity type](/docs/new-relic-one/use-new-relic-one/core-concepts/what-entity-new-relic) (e.g. mobile applications) in one or more accounts as the dataset. A NRQL configuration uses the results from one or more [NRQL queries](/docs/query-your-data/nrql-new-relic-query-language/get-started/introduction-nrql-new-relics-query-language/) as the dataset.

Using our [NerdGraph API](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph), or our graphiql interface at [api.newrelic.com/graphiql](https://api.newrelic.com/graphiql), you can manage your anomaly detector configurations.
...
```
Some details on parts of this mutation:
...
The following is an example NerdGraph [mutation](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph#terminology) that creates a configuration using an [entity type](/docs/new-relic-one/use-new-relic-one/core-concepts/what-entity-new-relic) :
```
mutation {
...
The following is an example NerdGraph [mutation](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph#terminology) that creates a configuration using the results of a [NRQL query](/docs/query-your-data/nrql-new-relic-query-language/get-started/introduction-nrql-new-relics-query-language/) :
...
## Update a configuration [#update-configuration]
The following is an example NerdGraph [mutation](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph#terminology) that updates a [workload](/docs/new-relic-one/use-new-relic-one/workloads/workloads-isolate-resolve-incidents-faster) configuration :
```
mutation {
...
The following is an example NerdGraph [mutation](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph#terminology) that updates an [entity type](/docs/new-relic-one/use-new-relic-one/core-concepts/what-entity-new-relic) configuration :
```
mutation {
...
The following is an example NerdGraph [mutation](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph#terminology) that updates a [NRQL](/docs/query-your-data/nrql-new-relic-query-language/get-started/introduction-nrql-new-relics-query-language/) configuration :
```
mutation {
...
## Delete a configuration [#delete-configuration]
The following is an example NerdGraph [mutation](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph#terminology) that deletes any kind of configuration :
```
mutation {
...
The following is an example NerdGraph [query](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph#terminology) that returns all configurations you have access to :
```
{
  actor {
...
Visit the [graphiQL explorer](https://api.newrelic.com/graphiql) to see more queryable fields.

## Query default thresholds [#query-thresholds]
The following is an example NerdGraph [query](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph#terminology) that returns the current default [thresholds](#query-thresholds) :
```
{
  actor {
    anomalyDetectorConfigurations {
...
The following is an example NerdGraph [mutation](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph#terminology) that validates a NRQL query is fully supported by anomaly detection :
```
mutation {
