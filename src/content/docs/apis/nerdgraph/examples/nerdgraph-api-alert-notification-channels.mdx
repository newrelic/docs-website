...
<Callout variant="caution">
  While you can query for any existing notification channel type, you can only create a subset of them. Specifically, the <DoNotTranslate>**user**</DoNotTranslate> channel type has no editable fields, and the <DoNotTranslate>**Campfire**</DoNotTranslate> and <DoNotTranslate>**HipChat**</DoNotTranslate> channel types are both deprecated.
</Callout>
...
<Callout variant="caution">
  While you can query for any existing notification channel type, you can only update a subset of them. Specifically, the <DoNotTranslate>**user**</DoNotTranslate> channel type has no editable fields, and the <DoNotTranslate>**Campfire**</DoNotTranslate> and <DoNotTranslate>**HipChat**</DoNotTranslate> channel types are both deprecated.
</Callout>
...
<Callout variant="tip">
  Removing an alert notification channel from a policy <DoNotTranslate>**does not**</DoNotTranslate> delete the channel because it might be used by other policies. On the other hand, deleting a channel will cause all associated policies to stop sending alert notifications to that channel.
</Callout>
