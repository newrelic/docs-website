...
* Ensure you have a good understanding of the [user management concepts](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts#understand-concepts)
* If you haven't already, it may help to look in the **Organization and access** UI to get a better sense of how groups and access grants work, and to understand access grants that already exist. 
* Ensure you have a good plan for the access grants you want to create. 
* It may help to map out the groups, roles, and accounts you want users to have access to in a spreadsheet beforehand. 
