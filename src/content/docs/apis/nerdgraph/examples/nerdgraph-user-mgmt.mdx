...
* For authentication domains using [SCIM provisioning](/docs/accounts/accounts/automated-user-management/automated-user-provisioning-single-sign): you can't create groups or add users to groups, because your groups are managed via SCIM.   
