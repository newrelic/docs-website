...
* If you haven't already, it can help to look in the **Access management** UI to improve your understanding of how groups and user access works, and to understand groups that already exist. 
* Have a good plan for the group access you need to create. It may help to map this out in a spreadsheet beforehand. 
