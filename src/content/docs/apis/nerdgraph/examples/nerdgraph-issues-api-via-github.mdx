...
---
This doc is a place for you and your team to learn how to query your data for issues and incidents and then configure features using our NerdGraph API.
...
Here entityGuides and entityTypes are entity attributes defined in [Learn about New Relic entities](/docs/new-relic-solutions/new-relic-one/core-concepts/what-entity-new-relic/) document
...
Filter issue events by entity guides, entity types, issues priority or issue states or any combination of those attributes.
...
```
  ...
  <Collapser
     ...
     title="Find incidents by incidenten id"
   >
...
Filter incident events by entity guides, entity types, incident priority or incident states or any combination of these.
...
Lets query incident events so we can obtain their incident id's: 
...
Using the corresponding `mutations` you can also change `issueTt`l and `gracePeriod` environment configuration parameters
