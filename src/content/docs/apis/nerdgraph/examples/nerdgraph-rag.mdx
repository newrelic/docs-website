...
redirects:
  ...
  - /docs/agentic-ai/knowledge-base/apis-and-communication-protocol
...
To learn more about New Relic AI Knowledge, refer to [New Relic AI Knowledge](/docs/agentic-ai/knowledge-integration/overview).
