...
Another possible cause of these errors is that your dashboard may have too many widgets. If you reduce the number of widgets, this should resolve these errors.
