...
<<<<<<< HEAD
## Configure network request settings (#network-request-settings)
=======
## Configure mobile network request settings
>>>>>>> ac3ded4a0645d1a1cbdf5689fd0c1dcf5116fb6e

Here's an example of how to configure mobile network request settings via NerdGraph:
