...
## Examples of configuring mobile monitoring settings [#configure-mobile-application]

Mobile settings can be configured through NerdGraph. 
...
Here's an example of how you mobile settings can be updated via NerdGraph, reference the following mutation. Documentation for each field can be found in the NerdGraph explorer.
