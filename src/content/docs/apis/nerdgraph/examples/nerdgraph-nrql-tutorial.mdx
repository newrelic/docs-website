...
<CollapserGroup>
  ...
  >
    ...
    * <DoNotTranslate>**Built-in suggestions.**</DoNotTranslate> Each [event type](/docs/using-new-relic/welcome-new-relic/getting-started/glossary#event) comes with its own set of recommended attributes. These are attributes chosen by New Relic for their importance and popularity.
    * <DoNotTranslate>**Usage-based suggestions.**</DoNotTranslate> Some attribute suggestions are based on the queries that have been frequently used by your account. These suggestions can include custom attributes.
    * <DoNotTranslate>**Role restriction.**</DoNotTranslate> [Restricted users](/docs/accounts/accounts/roles-permissions/users-roles) do not have access to account-related facet suggestions.
