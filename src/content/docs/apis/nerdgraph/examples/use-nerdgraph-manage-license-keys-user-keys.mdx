...
This doc contains tutorials on how to use [NerdGraph](/docs/introduction-new-relic-graphql) to programmatically manage some New Relic API keys: the license key, the browser key, and the user key. For general information about our keys, see [API keys](/docs/apis/get-started/intro-apis/types-new-relic-api-keys).
