...
* Data ingest keys, including:
  * The [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key): required for the ingest of most data to New Relic, except for browser monitoring data and mobile monitoring data
