...
* Data ingest keys, including:
  * The <InlinePopover type="licenseKey" />: required for the ingest of most data to New Relic, except for browser monitoring data and <InlinePopover type="mobile" /> data
