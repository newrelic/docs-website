...
* Relevant user permissions: the same [Synthetics permissions](/docs/synthetics/synthetic-monitoring/administration/user-roles-synthetic-monitoring) that apply for using the synthetics UI apply for using NerdGraph
