...
Below is a list of parameters used to create synthetic monitors, along with sample requests to help.
...
<CollapserGroup>
  ...
  >
    This section lists down all the parameters that are used in the creation of synthetic monitoring.
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>String</td>
          <td>Specifies the browser(s) that the monitor will use to execute jobs. The supported browsers are `Chrome`, `Edge`, and `Firefox`.</td>
        </tr>
        <tr>
...
<CollapserGroup>
  ...
  >
    This API allows you to create a simple monitor in the synthetics monitoring system with specified configurations using`syntheticsCreateSimpleMonitor` mutation. As a response it returns any errors encountered during the creation process, ensuring you can address issues promptly.

    #### Input parameters
    Check the [parameters](#common-parameters) section to see what parameters need to be included to create a ping monitor.
  ...
  >
    This API allows you to create a simple monitor in the synthetics monitoring system with specified configurations using`syntheticsCreateSimpleBrowserMonitor` mutation. As a response it returns any errors encountered during the creation process, ensuring you can address issues promptly.

    #### Input parameters
    Check the [parameters](#common-parameters) section to see what parameters need to be included to create a simple browser monitor.
  ...
  >
    This API allows you to create a [scripted browser monitor](/docs/synthetics/synthetic-monitoring/scripting-monitors/introduction-scripted-browser-monitors) in the synthetics monitoring system with specified configurations using`syntheticsCreateScriptBrowserMonitor` mutation. As a response it returns any errors encountered during the creation process, ensuring you can address issues promptly.

    #### Input parameters
    Check the [parameters](#common-parameters) section to see what parameters need to be included to create a scripted browser monitor.
