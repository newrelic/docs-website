...
To create, update, or delete synthetic monitors using NerdGraph: go to [GraphQL Explorer](https://one.newrelic.com/nerdgraph-graphiql) and then follow these instructions.
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          <td>`description`</td>
          <td>String</td>
          <td>(Optional) A description to help identify the purpose of this credential.</td>
        </tr>
        <tr>
          <td>`key`</td>
          <td>String</td>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          <td>`description`</td>
          <td>String</td>
          <td>(Optional) Updated description for the secure credential.</td>
        </tr>
        <tr>
          <td>`key`</td>
          <td>String</td>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          <td>`monitorGuids`</td>
          <td>Array</td>
          <td>(Optional) List of monitor GUIDs to include in the downtime. Leave empty to apply to all monitors.</td>
        </tr>
        <tr>
          <td>`timezone`</td>
          <td>String</td>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          <td>`monitorGuids`</td>
          <td>Array</td>
          <td>(Optional) List of monitor GUIDs to include in the downtime.</td>
        </tr>
        <tr>
          <td>`timezone`</td>
          <td>String</td>
        ...
        <tr>
          <td>`endRepeat`</td>
          <td>Object</td>
          <td>(Optional) When to stop the recurring downtime. Use `onDate` for a specific date or `onRepeat` for number of occurrences.</td>
        </tr>
      </tbody>
    </table>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          <td>`endRepeat`</td>
          <td>Object</td>
          <td>(Optional) When to stop the recurring downtime.</td>
        </tr>
      </tbody>
    </table>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          <td>`name`</td>
          <td>String</td>
          <td>(Optional) Updated name for the downtime.</td>
        </tr>
        <tr>
          <td>`monitorGuids`</td>
          <td>Array</td>
          <td>(Optional) Updated list of monitor GUIDs.</td>
        </tr>
        <tr>
          <td>`once`</td>
          <td>Object</td>
          <td>(Optional) Configuration for one-time downtime.</td>
        </tr>
        <tr>
          <td>`daily`</td>
          <td>Object</td>
          <td>(Optional) Configuration for daily recurring downtime.</td>
        </tr>
        <tr>
          <td>`weekly`</td>
          <td>Object</td>
          <td>(Optional) Configuration for weekly recurring downtime.</td>
        </tr>
        <tr>
          <td>`monthly`</td>
          <td>Object</td>
          <td>(Optional) Configuration for monthly recurring downtime.</td>
        </tr>
      </tbody>
    </table>
