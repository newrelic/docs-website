...
Queries make requests to fetch data. To learn additional query capabilities available to your synthetic monitors, check out [NerdGraph entities API tutorial](/docs/apis/nerdgraph/examples/nerdgraph-entities-api-tutorial/).
...
Below are some sample scripts to automate the creation of your synthetic monitors. 
...
```
  ...
  >
  Step monitors SOMETHING. Here's an example for creating one in NerdGraph: 
