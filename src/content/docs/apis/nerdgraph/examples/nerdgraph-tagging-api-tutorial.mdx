...
4. For <InlinePopover type="apm"/> agents, a restart is required after adding a new tag.
...
4. For <InlinePopover type="apm"/> agents, a restart is required after changing tags.
