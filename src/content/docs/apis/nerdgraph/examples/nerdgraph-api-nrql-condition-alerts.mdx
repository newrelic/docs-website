...
2. Find your relevant `policyID` by doing one of the following:
   ...
   * Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert conditions (Policies)**</DoNotTranslate>. Choose a policy. Find the ID under the policy name.
