...
2. Find your relevant `policyID` by doing one of the following:
   ...
   * Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Alert conditions (Policies)**. Choose a policy. Find the ID under the policy name.
