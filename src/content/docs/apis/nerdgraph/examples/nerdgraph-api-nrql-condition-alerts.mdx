...
2. Find your relevant `policyID` by doing one of the following:
   ...
   * Go to **[one.newrelic.com](https://one.newrelic.com)**, in the top nav click **Alerts & AI**, then click **Alert conditions (Policies)**. Choose a policy. Find the ID under the policy name.
