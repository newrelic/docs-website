...
<table>
  ...
  <tr>
    <td>lucene</td>
    <td>The search value used from the New Relic UI; for example, `logtype:alb`. For more information about valid Lucene functions in the New Relic UI, see our documentation about [logs query syntax](/docs/logs/log-management/ui-data/query-syntax-logs/).
    </td>
  </tr>
  <tr>
    <td>accountId</td>
