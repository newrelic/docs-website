...
This example creates a new data partition rule. Before creating the rule, please be sure to check this article: [Organize data with partitions](/docs/logs/log-management/ui-data/data-partitions/) about how data partitions works.
