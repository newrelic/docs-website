...
tags:
  ...
  - Examples
  - Logs
metaDescription: Create, query and manage data partition rules with NerdGraph.
---
...
This example creates a new data partition rule. Before creating the rule, please be sure to check the article [organize data with partitions](/docs/logs/log-management/ui-data/data-partitions/).
