...
* `metrics`: The new NRDB query will be shown as golden metrics.
  ...
  * `select`: The `SELECT` clause of the NRDB query. This field is <DoNotTranslate>**required**</DoNotTranslate>.
  ...
  * `name`: The name of the golden metric. This field is <DoNotTranslate>**required**</DoNotTranslate>.
