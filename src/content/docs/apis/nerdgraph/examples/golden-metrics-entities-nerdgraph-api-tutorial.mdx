...
* `metrics`: The new NRDB query will be shown as golden metrics.
  ...
  * `select`: The `SELECT` clause of the NRDB query. This field is <DNT>**required**</DNT>.
  ...
  * `name`: The name of the golden metric. This field is <DNT>**required**</DNT>.
