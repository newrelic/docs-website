...
If you no longer want to keep an account active, you can cancel it using NerdGraph. The option to cancel an account is only available with NerdGraph&mdash;not through the UI.
