...
<td>
This points to a problem with your organization structure (for example, an account that is outside the boundaries of an organization). If you get this message, talk to [support](/docs/new-relic-solutions/solve-common-issues/find-help-use-support-portal) or your account representative. 
</td>
</tr>
...
Other errors
          ...
          <td>
Talk to [support](/docs/new-relic-solutions/solve-common-issues/find-help-use-support-portal) or your account representative. 
</td>
        </tr>        
</tbody>
</table>
