---
title: "NerdGraph tutorial: View, create, rename and cancel accounts"
tags:
  - APIs
  - NerdGraph
  - Examples
...
If you no longer want to keep an account active, you can cancel it using NerdGraph. The option to cancel an account is not available in the UI&mdash;only through NerdGraph.
