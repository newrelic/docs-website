...
3. Create a role for an AWS account, and then select <DNT>**for another AWS account**</DNT>.
4. Enter the New Relic export account ID: `888632727556`.
5. Select <DNT>**Require external ID**</DNT> and enter the [account ID](/docs/accounts/accounts-billing/account-structure/account-id) of the New Relic account you want to export from.
6. Click <DNT>**Permissions**</DNT>, and then select the policy you created above.
...
When you're done with these steps, see the next section about setting up your export rules using NerdGraph. 
