    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>String</td>
          <td>No</td>
          <td>payloadCompression accepts two values:
...
## Set up an GCP Pub/Sub [#gcp-pubsub-setup]
