    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>String</td>
          <td>No</td>
          <td>[payloadCompression](#compression) accepts two values: `DISABLED` (payloads will not be compressed before being exported) or `GZIP` (compresses payloads before being exported).</td>
        </tr>
        <tr>
