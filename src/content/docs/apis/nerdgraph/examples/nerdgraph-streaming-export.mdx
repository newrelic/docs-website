...
We enable compression on payloads before they are sent out. This can help avoid hitting your ingested data limit and save money on egress COGS.
...
Export compression is allowed on AWS export rules.
