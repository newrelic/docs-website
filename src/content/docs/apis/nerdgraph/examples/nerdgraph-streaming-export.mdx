...
## Set an Azure Event Hub [#event-hub-setup]
...
1. In the left column, click on **Event Hubs**
2. Then click **+Event Hub** to create an Event Hub
2. Enter the desired Event Hub Name. Save this, as we will need it later to create the Streaming Export Rule
4. Once the Event Hub is created, click on the Event Hub

### Step 3. Create and Attach a Shared Access Policy [#event-hub-policy]

1. In the left column, navigate to **Shared access policies**
2. Click **+Add** near the top of the page
3. Choose a name for your **Shared access policy**
4. Check **Send**, and click create
5. Click the created policy, and copy the **Connection string–primary key**. Save this, as New Relic will use this to authenticate and send data to your Event Hub.
