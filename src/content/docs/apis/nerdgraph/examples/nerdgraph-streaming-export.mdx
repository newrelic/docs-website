---
title: "NerdGraph tutorial: Stream your data to an AWS Kinesis Firehose or Azure Event Hub or "
tags:
  - APIs
  - NerdGraph
...
<Tabs>
  <TabsBar>
    <TabsBarItem id="aws-kinesis">AWS Kinesis Firehose</TabsBarItem>
    <TabsBarItem id="azure-event">Azure Event Hub</TabsBarItem>
    <TabsBarItem id="gcp-pub">GCP Pub/Sub</TabsBarItem>
  </TabsBar>

  <TabsPages>
    <TabsPageItem id="aws-kinesis">
...
For creating, revoking, or listing AWS Kinesis Firehose from NerdGraph: go to [GraphQL Explorer](https://one.newrelic.com/nerdgraph-graphiql?state=2f361eaf-e5b7-41a4-5eec-e6910bbc7c47) and then follow these instructions.
...
<CollapserGroup>
  ...
  For creating streaming export rule, you need an account ID. This API allows you to retrieve your account ID using the actor query.
  ...
  ```
    ...
    <TabsPageItem id="azure-event">
    Contents for tab two
    </TabsPageItem>
    <TabsPageItem id="gcp-pub">
