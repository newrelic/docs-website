---
title: "NerdGraph tutorial: Manage secure credentials"
tags:
  - Synthetics
  - APIs
  - NerdGraph
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Integer</td>
      <td>Yes</td>
      <td>The account ID of the New Relic account where the secure credential will be created.</td>
    </tr>
    <tr>
      <td>`description`</td>
      <td>String</td>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Integer</td>
      <td>Yes</td>
      <td>The account ID that contains the secure credential.</td>
    </tr>
    <tr>
      <td>`description`</td>
      <td>String</td>
