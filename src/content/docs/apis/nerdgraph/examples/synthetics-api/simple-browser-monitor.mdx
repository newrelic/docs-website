...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>String</td>
      <td>Yes</td>
      <td>The runtime type version used by your monitor. Use `LATEST` to automatically use the most recent Chrome version (recommended). Older specific versions like `134` or `140` are also accepted but will be deprecated.</td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>String</td>
      <td>Yes</td>
      <td>The runtime version. Use `LATEST` to automatically use the most recent Chrome version (recommended). Older specific versions like `134` or `140` are also accepted but will be deprecated.</td>
    </tr>
    <tr>
      <td>`monitor.runtime.scriptLanguage`</td>
      <td>String</td>
