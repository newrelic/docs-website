---
title: "NerdGraph tutorial: Query synthetic monitoring data"
tags:
  - Synthetics
  - APIs
  - NerdGraph
...
A successful response returns the monitors with their metadata:
    ...
    "actor": {
      "entitySearch": {
        "results": {
          "entities": [
            {
              "guid": "MXxTWU5USHxNT05JVE9SfGFiYzEyMzQ1",
...
A successful response returns the private locations with their metadata:
      ...
      "entitySearch": {
        "results": {
          "entities": [
            {
              "accountId": 1234567,
              "guid": "MXxTWU5USHxQUklWQVRFX0xPQ0FUSU9OfGFiYzEyMzQ1",
              "name": "Internal Network Location",
              "tags": [
                {
                  "key": "description",
                  "values": ["Location for internal API monitoring"]
                },
                {
                  "key": "verifiedScriptExecution",
                  "values": ["true"]
                }
              ]
            }
...
A successful response returns the monitor downtimes with their metadata:
      ...
      "entitySearch": {
        "results": {
          "entities": [
            {
              "accountId": 1234567,
              "guid": "MXxTWU5USHxNT05JVE9SX0RPV05USU1FfGFiYzEyMzQ1",
...
A successful response returns the secure credentials with their metadata:
      ...
      "entitySearch": {
        "results": {
          "entities": [
            {
              "accountId": 1234567,
              "guid": "MXxTWU5USHxTRUNVUkVfQ1JFRFRMTL9MfGFiYzEyMzQ1",
              "name": "API_KEY_PROD",
              "tags": [
                {
                  "key": "description",
...
A successful response returns the script content:
...
A successful response returns the step configuration:
          ...
          "steps": [
            {
              "ordinal": 0,
              "type": "NAVIGATE",
              "values": ["https://example.com/login"]
            },
            {
              "ordinal": 1,
              "type": "CLICK_ELEMENT",
              "values": ["#login-button", "CSS"]
            },
            {
              "ordinal": 2,
              "type": "ASSERT_TITLE",
...
A successful response returns the monitor's GUID and other metadata:
...
A successful response returns the runtime validation results:
      ...
      "entitySearch": {
        "results": {
          "entities": [
            {
              "accountId": 1234567,
              "guid": "MXxTWU5USHxSVU5USU1FX1ZBTElEQVRJT058YWJjMTIzNDU",
              "name": "Runtime Validation for Monitor 12345",
              "tags": [
                {
            ...
            {
              "accountId": 1234567,
              "guid": "MXxTWU5USHxSVU5USU1FX1ZBTElEQVRJT058ZGVmNjc4OTA",
              "name": "Runtime Validation for Monitor 67890",
              "tags": [
                {
                  "key": "validationStatus",
                  "values": ["FAILED"]
                ...
                {
                  "key": "validationError",
                  "values": ["Script execution timeout after 180 seconds"]
                },
                {
                  "key": "monitorId",
                  "values": ["67890"]
...
A successful response returns the runtime validation result for the specified monitor:
