...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>String</td>
      <td>Yes</td>
      <td>The runtime type version used by your monitor. Use `22.20.0` for the current Node.js version (recommended). Older specific versions like `16.10` are also accepted but will be deprecated.</td>
    </tr>
    <tr>
...
<Callout variant="important">
  **Node.js version management**: Specific Node.js versions (such as 16.10) will reach end-of-life. The current supported version is `22.20.0`. To ensure your monitors use the latest Node.js updates and features, upgrade to `runtimeTypeVersion: "22.20.0"`.
</Callout>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>String</td>
      <td>Yes</td>
      <td>The runtime version. Use `22.20.0` for the most recent Node.js version (recommended). Older specific versions like `16.10` are also accepted but will be deprecated.</td>
    </tr>
    <tr>
      <td>`monitor.runtime.scriptLanguage`</td>
      <td>String</td>
