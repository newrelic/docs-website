...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>String</td>
      <td>Yes</td>
      <td>The runtime type version used by your monitor. Use `LATEST` to automatically use the most recent Node.js version (recommended). Older specific versions like `16.10` are also accepted but will be deprecated.</td>
    </tr>
    <tr>
...
You can upgrade a scripted API monitor to use the newer Node.js runtime. We recommend using the `LATEST` version to ensure your monitor automatically stays up-to-date with the most recent Node.js releases.

<Callout variant="important">
  **Node.js version management**: New Relic is transitioning to a `LATEST` version model for Node.js runtimes. Specific Node.js versions (such as 16.10) will reach end-of-life and only `LATEST` will be maintained going forward. When Node.js releases a new version, it will be available in scripted API monitors as `LATEST` within one week. To ensure your monitors automatically receive the latest Node.js updates and features, upgrade to `runtimeTypeVersion: "LATEST"`.
</Callout>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>String</td>
      <td>Yes</td>
      <td>The runtime version. Use `LATEST` to automatically use the most recent Node.js version (recommended). Older specific versions like `16.10` are also accepted but will be deprecated.</td>
    </tr>
    <tr>
      <td>`monitor.runtime.scriptLanguage`</td>
      <td>String</td>
...
Upgrade to the LATEST Node.js version (recommended):
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>String</td>
      <td>Yes</td>
      <td>The unique entity [GUID](/docs/apis/nerdgraph/examples/synthetics-api/query-synthetics-data#query-monitors) of the monitor you want to move.</td>
    </tr>
    <tr>
