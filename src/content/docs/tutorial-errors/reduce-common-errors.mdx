...
<DocTiles>
    ...
    <DocTile
        ...
        label={{text: "With our change tracking feature, you can get insights about each of the changes you track, such as faceted errors, log attribute trends, related issues and anomalies, and calculated impacts on key signals.", color: '#AFE2E3'}}    >
