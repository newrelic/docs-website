...
<UserJourneyControls
    nextStep={{path: "/docs/tutorial-errors/reduce-common-errors", title: "Next step", body: "Learn how to reduce common errors by routing error groups to the correct teams."}}
    previousStep={{path: "/docs/tutorial-errors/scope-the-problem", title: "Previous step", body: "After receiving a notification about an outage, learn how to choose services and error groups that are closest to the failure."}}
/>