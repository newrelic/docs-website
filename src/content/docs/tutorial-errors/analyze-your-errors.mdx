...
## Route your errors to the correct team [#route]

At this point you've scoped out how a problem is affecting your end user, you know when the problem first occurred, and have found the source of the failure. Depending on your role, you can route the error to the responsible team or begin fixing the problem in your system yourself. 

Returning to the **Errors** summary page with all of your grouped errors, you can now route a particular error directly to the team: 
...
This page also has other functionalities as well. If during your error analysis you notice that the other error groups are expected, you can close out these errors by selecting **Ignore**. Ignoring an error group does not stop New Relic from reporting the error.
