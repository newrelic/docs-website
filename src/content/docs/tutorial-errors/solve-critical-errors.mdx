...
* Enabling distributed tracing if you have it disabled. This is enabled by default.
* Integrating a log forwarder with New Relic to expand your logs in context experience

    <Steps>
    <Step>
    ### Open your IDE from stack traces
...
Reacting to an error and finding the direct cause of an outage is only part of dealing with errors in your app. Now that we've covered how to describe, diagnose, and find the source of an outage, you can learn how to route errors to the relevant teams. 

<UserJourneyControls
    nextStep={{path: "/docs/tutorial-errors/route-teams", title: "Next step", body: "Learn how to reduce common errors by routing error groups to the correct teams."}}
