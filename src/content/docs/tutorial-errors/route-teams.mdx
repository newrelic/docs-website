...
* If an error group is expected, you can mark the error as **Ignored**. Expected errors are known to you and the team — they can be noncritical bugs, or they can be errors associated with the end user (like someone using an incorrect password). 
...
This list is nonexhaustive, and root cause can be as variable as the number of teams that exist. The takeaway, though, is to follow the data, communicate, and dig deeper beyond direct cause. 
