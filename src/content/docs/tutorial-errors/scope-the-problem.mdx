...
Errors happen. Sometimes these errors are expected and won't affect your customer experience directly, but when your system experiences an outage, errors are where you should begin scoping the problem. Understanding how to broach a high number of error occurrences can expedite the resolution and retrospective process, letting you improve your app and get back to business as usual. 
