...
<SideBySide>
  <Side>
    [link to new tutorial on reducing latency and improving response times]
  </Side>
  <Side>
    <img
        title="[placeholder]"
...
<SideBySide>
  <Side>
    [link to new tutorial on reducing JS errors with browser]
  </Side>
  <Side>
    <img
        title="[placeholder]"
...
<SideBySide>
  <Side>
    [links to new tutorial on creating service levels]
  </Side>
  <Side>
    <img
        title="[placeholder]"
...
[links to other relevant tutorial paths]

## Learn more about browser monitoring

[links to advanced browser topics]