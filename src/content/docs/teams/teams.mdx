...
<CollapserGroup>
    ...
    >
      ...
      <img
        title="Screenshot showing how to find team during incident"
        alt="Screenshot showing how to find team during incident"
        src={teamsFindinIncident}
      />
    ...
    >
      ...
      />
        ...
        <img
            ...
            src={teamsCatalogsFilterTeam}
        />
        You can save UI changes by creating a Saved View, as explained in the [Customize the UI for your team](https://docs-preview.newrelic.com/docs/teams/teams#customize-ui) section.
...
The 'Team' hub page is a centralized space for all of your team's essential information. It facilitates collaboration among team members and keeps everyone updated about important developments. The hub page shows:

* All the entities your team owns and their [health status](/docs/alerts/create-alert/examples/view-entity-health-status-find-entities-without-alert-conditions/).
...
Customer must contact New Relic to create a custom role, if they wish to allow additional users to create and delete Teams without assigning them the Organization Manager or Authentication Manager roles
</Callout>

## Create Teams [#create-teams]

You have two options for creating Teams in the UI: manually or from existing user groups. 

<Callout variant="tip">
  If you prefer to create Teams programmatically, you can also create Teams with our [NerdGraph API](/docs/teams/teams-api-documentation/).
</Callout>
...
3. Select if you want to **Automate with a rule** or **Select groups manually**
  <img
        ...
        src={teamsGroupsSelection}
    />
**Option 1: Automate with a rule**
1. Add a rule to recognise the groups to create as teams, and click **Create rule**.
    <img
        title="Screenshot showing how to add a rule"
        alt="Screenshot showing how to add a rule"
        src={teamsGroupsCreateRule}
    />
2. Click **See teams**
     <img
        title="Screenshot showing how to add a rule"
        alt="Screenshot showing how to add a rule"
        src={teamsGroupsCreateRuleSeeTeams}
    />
...
<Callout variant="tip">
  You can also use  our [NerdGraph API](/docs/teams/teams-api-documentation/).
</Callout>
...
3. When the  new menu appears, enter a name for the view, select the permissions, and click **Save** to create the view:
    ...
    <img
        ...
        src={teamsNewDefaultView}
    />

   

<DocTiles>
  <DocTile title='NerdGraph API' path="/docs/teams/teams-api-documentation/">See how to complete the same teams tasks using GraphQL</DocTile>
</DocTiles>