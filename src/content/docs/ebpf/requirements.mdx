...
* **Database support matrix:** The eBPF agent can monitor the following databases and their supported versions:
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        <td>MSSQL</td>
        <td>`v14.x` and later</td>
      </tr>
      <tr>
        <td>DynamoDB</td>
        <td>`v2.0.0` and later</td>
      </tr>
    </tbody>
  </table>


* **Thrift support matrix:**  The eBPF agent supports the following Thrift transport protocols and transport layers:
