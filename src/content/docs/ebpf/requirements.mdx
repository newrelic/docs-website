...
If your environment routes outbound traffic through a corporate HTTP proxy, see [Configure a proxy for the eBPF agent](/docs/ebpf/proxy-configuration) for setup instructions.
