...
* Ensure that all [Linux distribution requirements](/docs/ebpf/requirements/#linux-distributions) are met for Kubernetes node.
...
The eBPF agent supports monitoring applications written in these programming languages:
...
* Ruby
* PHP (partial support)
* Node.js (segment linking not supported)
...
* Apache Thrift
* gRPC
* Cassandra (segment linking not supported)
* Kafka (segment linking not supported)
* AMQP (segment linking not supported)
