...
7. On the Install the Kubernetes integration screen:
    ...
    2. *(Optional)* To download the `value.yaml` configuration file, click **Download**. For more on the configuration parameters, refer to [K8s configuration parameters](#config-params).
