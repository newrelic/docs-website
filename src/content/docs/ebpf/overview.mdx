...
The unified eBPF agent delivers three powerful, complementary capabilities:

* [eBPF-powered APM](#ebpf-apm)
* [eBPF network metrics](#ebpf-network-metrics)
* [eBPF Application Log Reporting](#ebpf-app-log-reporting)
...
For more details, refer to [eBPF-Logs](https://ebpf-logs--beta-docs-site.netlify.app/docs/ebpf-logs) documentation.

<Callout title="Note">
Log reporting is disabled by default and is currently available as a limited preview. To enable it, pleaes contact your account manager.
</Callout>
