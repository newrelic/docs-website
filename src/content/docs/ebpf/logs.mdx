...
This example redacts only the `password` pattern shown. For additional or customizable obfuscation and drop rules, configure the [OTTL Transform processor](/docs/new-relic-control/pipeline-control/gateway/transform-processor) supported by PCG directly. Refer to [Redact PII](/docs/new-relic-control/pipeline-control/gateway/transform-processor#example-5-redact-pii) for more examples.
