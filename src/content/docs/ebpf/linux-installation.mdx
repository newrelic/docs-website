...
<Callout variant="tip">
    ...
    The eBPF agent automatically generates entity names differently depending on the environment. In hosts, these names are a combination of the process name, its directory or container ID, and the listening port. For example, `ruby:/home/ubuntu/app:[5678]`.
