...
The [`newrelic-ebpf-agent.yaml`](https://github.com/newrelic/newrelic-ebpf-agent/blob/dev/newrelic-ebpf-agent.yaml) file contains the following configuration parameters:
