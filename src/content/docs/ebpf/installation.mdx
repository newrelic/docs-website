...
<CollapserGroup>
    ...
    * Root privileges
    * Support `ARM, ARM 64, x86, x86-64` architectures.
...
<CollapserGroup>
    ...
    <Collapser 
    id="host-config-params" 
    title="Host configuration parameters"
    >
    ...
    <Collapser 
    id="k8s-config-params" 
    title="Kubernetes configuration parameters"
    >
