...
One solution is Horizontal Pod Autoscaling (HPA). With HPA, your Kubernetes cluster automatically allocates more pods when demand peaks and sidesteps cost concerns when anticipating demand.
...
This tutorial walks you through using New Relic to report data with Horizontal Pod Autoscaling (HPA) to your Kubernetes cluster. You will:
