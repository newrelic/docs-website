...
We recommend you spend at least two weeks with the AQM dashboard. During that time, the AQM dashboard will collect data about how your teams interact with all of your alerts. It evaluates your alert policies for high incident counts, high incident durations, long MTT-close, and if you have a high percentage of incidents that stay open for less than 5 minutes. 

As a general rule, we recommend removing alerts that:
