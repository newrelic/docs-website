...
![New Relic solutions and best practices](src/images/solutions-landing-page.png 'New Relic solutions and best practices')
...
<LandingPageTile title="Accelerate cloud adoption." icon="fe-cloud">
  Avoid a painful customer experience as you plan, migrate, and monitor your
  transition to the cloud. [Learn
  more.](/docs/new-relic-solutions/new-relic-solutions/plan-your-cloud-adoption/guide-planning-your-cloud-adoption-strategy/)
</LandingPageTile>
...
<LandingPageTile
  ...
  icon="fe-bar-chart-2"
>
  Use data-driven insights to make smart architecture decisions as your services
  grow. [Learn
  more.](/docs/new-relic-solutions/new-relic-solutions/optimize-your-cloud-native-environment)
</LandingPageTile>

{' '}
<LandingPageTile title="Best practices guides." icon="fe-alert-circle">
  Learn recommendations and best practices for core New Relic features. [Learn
  more.](/docs/new-relic-solutions/best-practices-guides)
</LandingPageTile>

{' '}
<LandingPageTile title="Solve common issues." icon="fe-bell">
  Find help, run diagnostics, and troubleshoot common problems. [Learn
  more.](/docs/new-relic-solutions/solve-common-issues/find-help-use-support-portal)
</LandingPageTile>
