...
This set of docs will tell you important concepts and procedures about Pathpoint.
...
Steps breakdown stages but offer a level of abstraction.  Often steps can be represented in some sequential order (known as levels).  This allows us to intuitively understand if there is some sequential dependencies between steps.
