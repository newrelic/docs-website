...
The stages are defined as either a <DoNotTranslate>**Person**</DoNotTranslate> or a <DoNotTranslate>**Process**</DoNotTranslate> stage. 
...
* The one to count <DoNotTranslate>**processes**</DoNotTranslate>  
* The one to count <DoNotTranslate>**people**</DoNotTranslate>
...
Touchpoints are the most granular entities of the Pathpoint model. They are often a specific application monitored by our <InlinePopover type="apm" /> or <InlinePopover type="browser" />, but you can use any NRQL query as a touchpoint as well.
...
<Callout variant="tip">
    By default, you'll only see the unhealthy touchpoints. To view all touchpoints associated with a Pathpoint, click the <DoNotTranslate>**view all**</DoNotTranslate> option.
</Callout>
...
2. Click <DoNotTranslate>**Queries**</DoNotTranslate>.
3. Edit the query and click <DoNotTranslate>**Save / Update**</DoNotTranslate>.
    <img
...
The image above shows the query associated with <DoNotTranslate>**Login people (PRC)**</DoNotTranslate> touchpoint.
