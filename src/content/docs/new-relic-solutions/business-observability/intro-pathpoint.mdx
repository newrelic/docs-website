...
5. Support infrastructure and platforms relevant to each step (often cloud services such as load balancers, container services, or managed databases or messaging systems).
