...
The goal is provide signals which have a level of independence, and when an alert event occurs, you'll be able to deduce from what is _red_ what the problem may be.
