...
Pathpoint is an open source catalog project developed by the New Relic labs team.  Its repository can be found [here](https://github.com/newrelic/nr-labs-pathpoint).
</Callout> 
