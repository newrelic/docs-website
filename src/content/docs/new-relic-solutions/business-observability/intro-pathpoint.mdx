...
The stages are defined as either a <DNT>**Person**</DNT> or a <DNT>**Process**</DNT> stage. 
...
* The one to count <DNT>**processes**</DNT>  
* The one to count <DNT>**people**</DNT>
...
<Callout variant="tip">
    By default, you'll only see the unhealthy touchpoints. To view all touchpoints associated with a Pathpoint, click the <DNT>**view all**</DNT> option.
</Callout>
...
2. Click <DNT>**Queries**</DNT>.
3. Edit the query and click <DNT>**Save / Update**</DNT>.
    <img
...
The image above shows the query associated with <DNT>**Login people (PRC)**</DNT> touchpoint.
