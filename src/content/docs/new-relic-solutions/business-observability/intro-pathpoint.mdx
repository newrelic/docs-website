...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Browse/search for room, book room, checkin and stay, checkout, post-checkout
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Browse/search for product, cart management, purchase, shipment and returning, notifications and marketing
      </td>
...
### Selecting relevant signals [#selecting-relevant-signals]
