...
From your New Relic account, go to <DNT>**Apps > Pathpoint**</DNT>. Click on the <img src={threeLines} class="inline" style={{height: "30px", width: "30px"}} alt="Three lines" title="Three lines" /> in the upper left corner. 
...
Click <DNT>**JSON configuration**</DNT>.
...
From your New Relic account, navigate to <DNT>**Apps > Pathpoint**</DNT>, and click <img src={threeLines} class="inline" style={{height: "30px", width: "30px"}} alt="Three lines" title="Three lines" />.

</Step>

<Step>

On the resulting window, click <DNT>**JSON configuration**</DNT>.
...
This opens a dialog box window. Under <DNT>**Description**</DNT>, describe your new JSON config file. Next, provide a note and click <DNT>**From file**</DNT> to browse the JSON config file.
...
Locate the JSON config file you want to use to update your Pathpoint, and click <DNT>**Open**</DNT>.
