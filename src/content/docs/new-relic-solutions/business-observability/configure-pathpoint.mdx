...
From your New Relic account, go to <DoNotTranslate>**Apps > Pathpoint**</DoNotTranslate>. Click on the <img src={threeLines} class="inline" style={{height: "30px", width: "30px"}} alt="Three lines" title="Three lines" /> in the upper left corner. 
...
Click <DoNotTranslate>**JSON configuration**</DoNotTranslate>.
...
From your New Relic account, navigate to <DoNotTranslate>**Apps > Pathpoint**</DoNotTranslate>, and click <img src={threeLines} class="inline" style={{height: "30px", width: "30px"}} alt="Three lines" title="Three lines" />.

</Step>

<Step>

On the resulting window, click <DoNotTranslate>**JSON configuration**</DoNotTranslate>.
...
This opens a dialog box window. Under <DoNotTranslate>**Description**</DoNotTranslate>, describe your new JSON config file. Next, provide a note and click <DoNotTranslate>**From file**</DoNotTranslate> to browse the JSON config file.
...
Locate the JSON config file you want to use to update your Pathpoint, and click <DoNotTranslate>**Open**</DoNotTranslate>.
