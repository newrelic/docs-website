...
Select a touchpoint to test. Right click on it and click <DNT>**Queries**</DNT>.
...
It opens a window. Click <DNT>**Test**</DNT>.
...
The window will show you the results of the test. For example, if you see <DNT>**Successfully validated**</DNT>, it means your touchpoint is healthy.

If the validation fails, find out why, and fix it. Then, test it again until you get the <DNT>**Successfully validated**</DNT> message.
</Step>


<Callout variant="important">

When testing a touchpoint, if you get an <DNT>**Incorrectly validated**</DNT> error, it might be caused by the query being ran on the wrong account ID.
...
Select a touchpoint to test. Right click on it and select <DNT>**Tune**</DNT>.
...
Enter new <DNT>**Min**</DNT> and <DNT>**Max**</DNT> threshold values and click <DNT>**Save/Update**</DNT>.
...
Right click on the particular touchpoint you want to work with and click <DNT>**Queries**</DNT>.
...
If the touchpoint is on, click the <DNT>**On**</DNT> toggle to switch off the touchpoint.
