...
In [New Relic](https://one.newrelic.com), click <DoNotTranslate>**Add Data**</DoNotTranslate>:
...
/>
And if you added screenshots to your launcher or Nerdlet, you can see them under <DoNotTranslate>**What's inside**</DoNotTranslate>:
...
On your application's description page, click <DoNotTranslate>**Add this app**</DoNotTranslate>:
...
Go to the <DoNotTranslate>**Apps**</DoNotTranslate> page:
