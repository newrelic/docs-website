...
redirects:
  - /docs/new-relic-solutions/build-nr-ui/nr1-cli/nr1-plugins
---
...
Have a look at [all the available commands](https://github.com/newrelic/newrelic-cli/blob/master/docs/cli/newrelic.md) in the New Relic CLI. For example, you can create a [New Relic workload]((/docs/new-relic-solutions/new-relic-one/workloads/workloads-isolate-resolve-alert-events-faster)) using [`workload create`](https://github.com/newrelic/newrelic-cli/blob/master/docs/cli/newrelic_workload_create.md)
