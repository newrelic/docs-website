...
Each lesson in the course builds upon the last, so make sure you've completed the last lesson, [Customize visualizations with configuration](/docs/new-relic-solutions/tutorials/custom-visualization-config), before starting this one.
...
## Add your custom visualization to a dashboard [#add-dashboard]
...
## Delete your visualization [#delete]
