...
<Steps>
  ...
  <Step>
    [Add **Victory Charts Visualizations** to your account](/docs/new-relic-solutions/new-relic-one/build-nr-apps/subscribe).
  </Step>
  ...
  <Step>
    Because you're going to use a tweaked version of the **Victory Charts Visualizations** Nerdpack instead of the one you subscribed to, you can [unsubscribe](/docs/new-relic-solutions/new-relic-one/build-nr-apps/subscribe/#unsubscribe-from-a-nerdpack) from our version now.
  </Step>
</Steps>
...
<Steps>
  <Step>
    From its root directory, [publish](/docs/new-relic-solutions/new-relic-one/build-nr-apps/publish/) your Nerdpack:
  ...
  <Step>
    [Subscribe](/docs/new-relic-solutions/new-relic-one/build-nr-apps/subscribe/#subscribe-to-a-nerdpack) to your Nerdpack:
