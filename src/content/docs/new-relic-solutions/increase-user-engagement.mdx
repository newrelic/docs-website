...
Maintaining a website combines the effort of multiple teams. When outages happen, developer and engineering teams have access to resolve the issue directly, but a digital marketer may not have direct access to site administration. While your team's success is just as dependent on site performance, you might not have the tools to identify or address any issue yourselves.

Our website performance monitoring (WPM) tool gives you insight into your site's availability and performance. With out-of-the-box alerts and routine checks from our monitors, you'll never be uncertain about how your site performs. 
...
Keep in mind that WPM metrics are from desktop views only and will not give insight about your site's mobile experiences. 
