...
<DNT>**Use the browser SPA agent for deeper visibility**</DNT>
...
<DNT>**Use APM automatic instrumentation over copy/paste**</DNT>
...
<DNT>**Group your data into meaningful categories**</DNT>
...
<DNT>**Make sure you get data only from the right sources**</DNT>
...
<figcaption>
  <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Browser > Settings > Domain conditions**</DNT>
</figcaption>
...
<DNT>**Create and evaluate alert policies**</DNT>
...
<figcaption>
  <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alerts conditions (Policies) > New alert policy**</DNT>
</figcaption>

## 9. Use anomaly alerts [#alerts-anomalies]

<DNT>**Alert on anomalous behaviors and events**</DNT>
...
<figcaption>
  <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts > Alert conditions (Policies) > New alert policy**</DNT>
</figcaption>

## 10. Add alerts to workflows [#alerts-notifications]

<DNT>**Integrate your alerts into your workflows**</DNT>
...
<DNT>**Create your own dashboards**</DNT>
...
<figcaption>
  <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Dashboards > Browser examples (imported from https://newrelic.com/instant-observability/browser-examples)**</DNT>
</figcaption>
...
<DNT>**Break down performance across your users, business, and more**</DNT>
