...
<Callout variant="tip">
  Depending on your backend framework or CDN strategy, a copy/paste approach may
  be the better strategy. Just remember that it’ll require periodic updating.
</Callout>
...
![best03_apdex.png](src/images/best03_apdex.png 'best03_apdex.png')

<figcaption>
  [one.newrelic.com](https://one.newrelic.com) > Browser > Settings >
  Application
</figcaption>
...
![best04_alert.png](src/images/best04_alert.png 'best04_alert.png')

<figcaption>
  [one.newrelic.com](https://one.newrelic.com) > Alerts & AI > Policies > New
  alert policy
</figcaption>
...
![best05_alert2.png](src/images/best05_alert2.png 'best05_alert2.png')
...
![best06_dashboards.png](src/images/best06_dashboards.png 'best06_dashboards.png')
...
![best07_allowlist.png](src/images/best07_allowlist.png 'best07_allowlist.png')

<figcaption>
  [one.newrelic.com](https://one.newrelic.com) > Browser > Settings > Segment
  allow lists.
</figcaption>
...
![best08_domaincondition.png](src/images/best08_domaincondition.png 'best08_domaincondition.png')

<figcaption>
  [one.newrelic.com](https://one.newrelic.com) > Browser > Settings > Domain
  conditions.
</figcaption>
...
![best09_business.png](src/images/best09_business.png 'best09_business.png')

<figcaption>
  [one.newrelic.com](https://one.newrelic.com) > Dashboards > (selected
  dashboard).
</figcaption>
