...
New Relic provides [unified alerting](/docs/alerts-applied-intelligence/applied-intelligence/incident-intelligence/basic-alerting-concepts) across all our products, including browser monitoring, so that you'll always be in the know. We recommend setting up alerts to monitor your Apdex score, along with these sample alerts to get you started:
