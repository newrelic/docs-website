...
Browser SPA monitoring is enabled by default for new [browser agent installs](/docs/browser/browser-monitoring/installation/install-browser-monitoring-agent). To edit this configuration, go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Browser > (select an app) > Settings > Application settings**.
...
1. Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Alerts conditions (Policies)**.
...
1. Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Alerts & AI > Alert conditions (Policies) > New alert**.
...
<figcaption>
  **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Dashboards > Browser examples (imported from https://newrelic.com/instant-observability/browser-examples)**
</figcaption>
...
1. Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Query builder**.
