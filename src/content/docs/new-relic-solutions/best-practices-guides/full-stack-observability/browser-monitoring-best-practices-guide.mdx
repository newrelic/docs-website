...
Get more out of [browser monitoring](/docs/browser/browser-monitoring/getting-started/introduction-browser-monitoring), with deeper visibility into your websites and your users. 

Here are 13 best practices to help you find problems faster and deliver a better experience to your customers with real user monitoring.
...
## 4. Group your data [#segment-whitelist]
...
Once you've identified which segments to add, you can add them using [Segment allow-lists in browser](/docs/browser/new-relic-browser/configuration/url-whitelists-grouping-browser-metrics).
...
1. Use the source maps API to upload your JavaScript
...
3. Share actual versus expected performance over different time period widely your team, product owners, and managers

### How to do it

1. Select Service levels from the top menu. It may be in the drop list on the far right.
...
<img
  title="browser-service-levels-01.png"
  alt="browser-service-levels-01.png"
...
<img
  title="browser-service-levels-02.png"
  alt="browser-service-levels-02.png"
  src={browserServiceLevels2}
/>
<figcaption>
  Choose the which metric you want to create a service level objective (SLO) for
</figcaption>
...
Browser automatically provides a curated experience to quickly triage issues, but you can also create bespoke [dashboards](/docs/query-your-data/explore-query-data/dashboards/introduction-new-relic-one-dashboards) with your frontend data with the [query builder](/docs/query-your-data/explore-query-data/query-builder/use-advanced-nrql-mode-specify-data). 

The New Relic team has created a [collection](https://newrelic.com/instant-observability/browser-examples/721fd258-326d-41f4-8f5d-0d5538ac7487) of popular browser dashboards that you can download in just a few clicks to get started.
...
### How to do it
* Start the conversation with [quality foundation](/docs/new-relic-solutions/observability-maturity/customer-experience/customer-experience-quality-foundation-guide)
