...
1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI > Policies**.
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI > Policies > New alert policy**
</figcaption>
...
1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities)**, then click **Query your data** to access the [query builder](/docs/query-your-data/explore-query-data/query-builder/introduction-query-builder).
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Dashboards > (selected dashboard)**
</figcaption>
