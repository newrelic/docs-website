...
New Relic provides [unified alerting](/docs/alerts-applied-intelligence/overview/#concepts-terms) across all our products, including browser monitoring, so that you'll always be in the know. We recommend setting up alerts to monitor your core web vitals, along with these sample alerts to get you started:
