...
Once you've identified which segments to add, you can add them programmatically using [GraphQL](/docs/apis/nerdgraph/examples/browser-monitoring-config-nerdgraph), or you can use segment allow-lists in New Relic's browser monitoring UI like this:
