...
<figcaption>
  Change your browser monitoring settings to switch to SPA.
</figcaption>
...
New Relic provides [unified alerting](https://docs.newrelic.com/docs/alerts/new-relic-alerts/getting-started/alert-policy-workflow) across all our products, including browser monitoring, so that you’ll always be in the know. We recommend setting up alerts to monitor your Apdex score, along with these sample alerts to get you started:
