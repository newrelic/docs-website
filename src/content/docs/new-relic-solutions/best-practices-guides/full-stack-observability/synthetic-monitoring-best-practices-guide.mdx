...
To get quickly discover failing monitors, you can use the [index of synthetic monitors](/docs/new-relic-one-monitors-index) page to see which monitors have open violations, success rate over 24 hours, number of failing locations, the monitor period and type. Clicking on a monitor, you'll be taken to the [Summary](/docs/synthetics/new-relic-synthetics/pages/synthetics-overview-page-view-monitors-performance) page where you'll be presented with information to assess where that particular monitor is failing, why it is failing (last error message, error response codes, duration by domain), and more to give you a deeper insight into your application's performance over time.
