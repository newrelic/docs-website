...
import syntheticCreateSyntheticMonitor from 'images/synthetic_screenshot-full_create-synthetic-monitor.png'
...
1. To add a monitor, go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Add data >** (search for synthetic monitoring). (If you have an [EU-based account](/docs/using-new-relic/welcome-new-relic/get-started/introduction-eu-region-data-center), go to  **[one.eu.newrelic.com](http://one.eu.newrelic.com)**.) When you click **synthetic monitoring**, the **Create monitor** page will appear.

<img 
  src={syntheticCreateSyntheticMonitor}
...
<img 
  ...
  title="Create your synthetic monitor"
  alt="A screenshot of the Create monitor page."
/>
