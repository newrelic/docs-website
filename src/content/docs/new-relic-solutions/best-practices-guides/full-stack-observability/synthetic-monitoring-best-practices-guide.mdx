...
To get a high-level view of this information, you can use the [monitors index](/docs/new-relic-one-monitors-index) to view  
summaries for ping monitors, or get an [overview](/docs/synthetics/new-relic-synthetics/pages/synthetics-overview-page-view-monitors-performance) of your simple and scripted monitors. These pages give you deeper insight into your application's performance over time.
