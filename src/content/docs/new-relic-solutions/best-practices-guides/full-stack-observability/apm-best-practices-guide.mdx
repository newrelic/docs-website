...
When key performance indicators spike or drop, individuals and teams in your organization need to be notified. [Alerting in New Relic](/docs/alerts/new-relic-alerts/getting-started/alerting-new-relic) provides a set of tools including dynamic baselines that allow you to detect problems before they impact your end users.
