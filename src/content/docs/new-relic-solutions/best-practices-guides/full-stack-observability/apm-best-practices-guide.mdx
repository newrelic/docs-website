...
<DoNotTranslate>**Application monitoring tips you need to know**</DoNotTranslate>
...
* <DoNotTranslate>**Static threshold alerts**</DoNotTranslate> are great when you already know the nature of an application and its normal behaviors aren't likely to change anytime soon. Apdex score, response time, error rate, throughput are some of the static thresholds you can create alert policies on.
* <DoNotTranslate>**Dynamic anomaly alerts**</DoNotTranslate> make it easy to determine and set dynamic alert thresholds for applications with varying seasonal patterns and growth trends (which make it difficult to set thresholds that define normal behavior). These <InlinePopover type="alerts" /> use anomalies modeled from your application's historical metric data.
...
1. Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Key transactions**</DoNotTranslate>, and then select <DoNotTranslate>**Add more**</DoNotTranslate>. Then select the app and web transaction or, from the selected transaction, select <DoNotTranslate>**Track as key transaction**</DoNotTranslate>.
2. Type a name for the key transaction, and select <DoNotTranslate>**Track key transaction**</DoNotTranslate>.
...
4. To view the key transactions dashboard details, select <DoNotTranslate>**View new key transaction**</DoNotTranslate>.
...
1. From the New Relic menu bar, select <DoNotTranslate>**APM & services > (select an app) > Events > Deployments**</DoNotTranslate>.
2. To view performance after a deployment, go to the selected app's Overview dashboard in the <DoNotTranslate>**Recent events**</DoNotTranslate> section.
...
1. From the APM menu bar, select <DoNotTranslate>**Applications > (select an app) > Reports**</DoNotTranslate>.
2. Select the report you'd like to see.
3. If you want to save or export a report to share, select <DoNotTranslate>**Download this report as .csv**</DoNotTranslate>, which will create a report with comma-separated values.
...
<DoNotTranslate>**How to do it**</DoNotTranslate>

1. Go to <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > More > Service maps**</DoNotTranslate>.
...
To deploy the agent automatically <DoNotTranslate>**(preferred as a method to avoid errors)**</DoNotTranslate>:
