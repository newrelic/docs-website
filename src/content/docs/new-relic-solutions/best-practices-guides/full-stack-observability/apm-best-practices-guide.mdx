...
1. Go to **[one.newrelic.com](https://one.newrelic.com) > Key transactions**, and then select **Add more**. Then select the app and web transaction or, from the selected transaction, select **Track as key transaction**.
