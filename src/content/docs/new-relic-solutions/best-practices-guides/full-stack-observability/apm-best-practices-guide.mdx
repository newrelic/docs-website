...
3. Modify configuration files by comparing new files with existing files. In particular, make sure things like [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) and custom extensions are copied over to the new configuration.
