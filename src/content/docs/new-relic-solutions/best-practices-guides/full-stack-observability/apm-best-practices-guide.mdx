...
* **Dynamic anomaly alerts** make it easy to determine and set dynamic alert thresholds for applications with varying seasonal patterns and growth trends (which make it difficult to set thresholds that define normal behavior). These <InlinePopover type="alerts" /> use anomalies modeled from your application's historical metric data.
...
1. Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Key transactions**, and then select **Add more**. Then select the app and web transaction or, from the selected transaction, select **Track as key transaction**.
...
1. Go to **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > More > Service maps**.
