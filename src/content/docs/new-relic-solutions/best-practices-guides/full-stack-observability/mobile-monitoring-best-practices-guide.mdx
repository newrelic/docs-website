...
<CollapserGroup>
  ...
  >
    ...
    2. From the list of monitored apps, select <DNT>**Add more**</DNT>.
    3. Select the relevant platform.
    4. Type a name for your mobile app, and select <DNT>**Continue**</DNT>.
...
As soon as New Relic starts reporting data, take the time to explore the wealth of information about your mobile apps. To get started, go to <DNT>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DNT> and select <DNT>**Mobile**</DNT>.
...
<CollapserGroup>
  ...
  >
    ...
    1. From the summary UI page for a monitored mobile app, click <DNT>**Crash analysis**</DNT>.
    ...
    3. From your mobile app's <DNT>**Crash analysis**</DNT> page in the UI, select a <DNT>**Crash type**</DNT>.

    4. From the crash type's <DNT>**Summary**</DNT> page, select the <DNT>**Crash trail**</DNT> tab.
  </Collapser>
...
1. Use metric-based <InlinePopover type="alerts"/> as a starting point to gain high-level visibility into problems.
...
<CollapserGroup>
  ...
  >
    Combine the metric-based workflow with event-based alerts and <InlinePopover type="dashboards"/> specific to your mobile app and system.
...
<CollapserGroup>
  ...
  >
    Crashes are an inevitable part of running mobile applications at scale. We provide tools to help you understand your highest-impact crashes. Use the <DNT>**Crash analysis**</DNT> UI to see which crashes are occurring most often, the percentage of crash-free users, which files and methods are associated with perhaps 80 percent of your crashes, which crashes a particular user just experienced, and more.
    ...
    3. Use our mobile monitoring's [<DNT>**Versions trends**</DNT> page](/docs/mobile-monitoring/mobile-monitoring-ui/mobile-app-pages/version-trends-compare-user-adoption-metrics-performance) to make sure you're improving the crash rate over subsequent releases and avoiding regressions.
  </Collapser>
  ...
  <Collapser
    ...
    title="Breadcrumbs"
  >
    Use breadcrumbs and custom attributes to better reproduce and debug crashes. For example, use our [`recordBreadrumb` API](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/record-breadcrumb/) to track mid-session changes in state that can help debug crashes, such as:
  ...
  >
    ...
    * Origin or attribution of entry into the app
      ...
      Standardize custom attribute names across your mobile apps, and align with your website (if you're using our <InlinePopover type="browser"/>), so that you can compare and contrast performance across end-user channels. The mobile agents track the last interaction of crashed and non-crashed sessions to provide visibility into what the user viewed before exiting your app (either intentionally or due to a crash).
  </Collapser>
</CollapserGroup>
