...
As soon as New Relic starts reporting data, take the time to explore the wealth of information about your mobile apps. To get started, go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities)** and select **Mobile**.
...
<CollapserGroup>
  ...
  >
    ...
    3. From your mobile app's **Crash analysis** page in the UI, select a **Crash type**.

    4. From the crash type's **Summary** page, select the **Crash trail** tab.
  </Collapser>
