...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="Breadcrumbs"
  >
    Use breadcrumbs and custom attributes to better reproduce and debug crashes. For example, use our [`recordBreadcrumb` API](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/record-breadcrumb/) to track mid-session changes in state that can help debug crashes, such as:
