...
<table>
  <thead>
    ...
    <tr>
      ...
      <td>
        <DNT>**Avoid setting thresholds too low**</DNT>. For example, if you set a CPU condition threshold of 75% for 5 minutes on your production servers, and it routinely goes over that level, this will increase the likelihood of un-actionable alerts or false positives.
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        <DNT>**You don't need to edit files or restart the software**</DNT>, so feel free to make quick changes to your threshold levels and adjust as necessary.
      </td>
    </tr>
    <tr>
      <td>
