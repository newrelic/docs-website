...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        Use [enrichments](/docs/alerts/get-notified/alert-event-workflows/#enrichments)
      </td>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        You'll understand the impact this will have on your [alert events closing](/docs/alerts/alert-event-management/how-alert-condition-events-are-closed/).
      </td>
    </tr>
...
* [Set up alert coverage at scale with smart alerts](/docs/alerts/smart-alerts-coverage) (public preview)
...
If you're new to alerts, learn more about your [issue preferences options](/docs/alerts/organize-alerts/specify-when-alerts-create-events).
...
* Read more about about [when you might want to use loss-of-signal and gap-filling settings](https://knowledge.newrelic.com/s/article/How-Can-I-Figure-Out-When-To-Use-Gap-Filling-and-Loss-of-Signal).
