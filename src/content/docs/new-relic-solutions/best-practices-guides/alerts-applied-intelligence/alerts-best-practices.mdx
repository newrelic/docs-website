...
<table>
  <thead>
    ...
    <tr>
      ...
      <td>
        You'll have the related incidents into a single, comprehensive [issue](/docs/alerts-applied-intelligence/applied-intelligence/incident-intelligence/basic-alerting-concepts/).
    ...
    <tr>
      ...
      <td>
        You'll have organized all of your incoming incidents.
        We recommend you create a policy for each separate destination or audience that will need to receive a notification.
      </td>
    </tr>
    </tbody>
</table>
