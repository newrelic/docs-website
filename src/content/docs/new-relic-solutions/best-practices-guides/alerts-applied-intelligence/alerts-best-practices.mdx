...
* Alerts condition creation and advanced settings
* Policies and issue creation preferences
* Decisions
* Workflows
* Destinations
* Muting rules
...
* Disable or tun flapping alerts. Flapping alerts must be tuned or disabled. These alerts indicate a poor alert condition configuration. If the system is in charge of identifying these alerts, there will be a significant delay which will have a negative impact on meaningful incidents.
...
* Having an explanatory name for the alert, the description, and the tags will give you self-descriptive alerts and help you to answer faster and decide what to do.
