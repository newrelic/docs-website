...
<table>
  <thead>
    ...
    <tr>
      ...
      <td>
        You'll enrich them with metadata. Don't worry about the nr* tables consumption because they don't count towards that.
        ...
        Issues have 3 sources of tags:
          ...
          * the tags from the violating entity if the alerts results are scoped to a unique entity.


      If the incident isn't scoped to the entity, entity tags won't be brought over.
    ...
    <tr>
      <td>
        Add a runbook to every alert condition
      </td>
      <td>
        You'll have details about what to do and who to involve.
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        For example, preventative, to notify before the incident occurs; reactive, to detect and notify of an ongoing incident; and informative, to check if it could be a real alert or not. Each category should go to different destination.
      </td>
    </tr>
    <tr>
      <td>
