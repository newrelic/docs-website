...
Create and customize your own alerts with New Relic. You can improve your alerts coverage by implementing the following recommendations and get the most out of your alerts configuration.
...
Follow these actions to improve and make the most of your alerts.
...
<table>
  <thead>
    ...
    <tr>
      <td>
        Add a destination to every alert condition
      </td>
      <td>
        Decide the mean of [notification](/docs/alerts-applied-intelligence/notifications/notification-integrations/). Some of them are these: [email](/docs/alerts-applied-intelligence/notifications/notification-integrations/#email), [Slack](/docs/alerts-applied-intelligence/notifications/notification-integrations/#slack), [PagerDuty](/docs/alerts-applied-intelligence/notifications/notification-integrations/#pagerduty), or [Jira](/docs/alerts-applied-intelligence/notifications/notification-integrations/#jira). You'll get the right information to the right people as soon as possible.
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        The recipient of the notification will know what to do and who to involve.
      </td>
    </tr>
    <tr>
      <td>
        Each category should go to different destination
      </td>
      <td>
        Document to which and unique destination each category should go, as well as the expectation for those handling these notifications.
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Prioritize and triage faster your alerts notifications by providing additional metrics specific to the issue.
      </td>
    </tr>
    </tbody>
</table>
...
<table>
  <thead>
    ...
    <tr>
      <td>
        Use workflows to trigger a notification for each destination
      </td>
      <td>
        You'll control when and where you want to receive notifications about issues.
        There are these [default workflows](/docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows/#workflows-triggered), but you can add a [workflow](/docs/alerts-applied-intelligence/applied-intelligence/incident-workflows/incident-workflows/#add-workflow) according to your needs.
      </td>
    </tr>
    <tr>
      <td>
        Add an owner to every alert condition
      </td>
      <td>
        The owner is in charge to guarantee the alert remains relevant.
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td>
        [SLIs and SLOs](/docs/service-level-management/intro-slm/#what-sli-slo) breaches aren't always alerts unless you've documented steps to prevent them. You can highlight the area where the team should focus on improvements rather than immediately respond to an event.
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      <td>
        Mute alerts during routine events
      </td>
      <td>
        You'll stop being bombarded by messages that don't need your attention. You can [enable or disable](/docs/alerts-applied-intelligence/new-relic-alerts/alert-notifications/muting-rules-suppress-notifications/#manage) muting rules at any time.
      </td>
    </tr>
    </tbody>
</table>
...
<table>
  <thead>
    ...
    <tr>
      ...
      <td>
        Every day we analyze your alert data and provide suggested decisions as well as feedback on existing decisions. You'll improve noise reduction.
      </td>
    </tr>
    <tr>
      <td>
        Disable or tune flapping alerts
      </td>
      <td>
        These alerts indicate a poor alert condition configuration. If the system must identify these alerts, there will be a significant delay, which will have a negative impact on meaningful incidents.
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Alerts that self-resolve before anyone could do anything about it are noise. Use a [dashboard](/docs/query-your-data/explore-query-data/dashboards/manage-your-dashboard/) if you want to see short-lived spikes and smooth out temporary spikes.
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        ...
        Keep the [default decisions](https://docs.newrelic.com/docs/alerts-applied-intelligence/applied-intelligence/incident-intelligence/change-applied-intelligence-correlation-logic-decisions/#global-decisions) enabled when you first get started. Within a couple of weeks, you'll be able to assess the efficacy of these decisions.
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td>
        We recommend creating a policy for each separate destination or audience that will need to receive a notification. Consider grouping or not by entity, service, or technology to match the focus of your respective teams.
      </td>
    </tr>
    </tbody>
</table>
...
We use signals to infer the health and alert coverage of an entity. If the results of an alert condition contain data from only one entity, New Relic will tie it to the health of that entity, and these events will show in the context in the New Relic UI.
