...
<table>
  <thead>
    ...
    <tr>
      ...
      <td>
        Across the organization define alert categories, expectations for handling their notifications, and a unique destination.
...
<table>
  <thead>
    ...
    <tr>
      ...
      <td>
        The owning team is in charge to guarantee the alert remains relevant. They approve the changes to the condition.
      </td>
    </tr>
    <tr>
      <td>
...
<table>
  <thead>
    ...
    <tr>
      ...
      <td>
        [SLIs and SLOs](/docs/service-level-management/intro-slm/#what-sli-slo) breaches aren't always incidents and don't require an alert unless you've documented steps to prevent them. SLI/SLO dashboards can highlight the area where the team should focus on for improvements rather than responding to an event.
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td>
        Helps you make sure you cover your entire stack in a consistent way (organized by technology, teams involved, etc.).
      </td>
    </tr>
    <tr>
      <td>
