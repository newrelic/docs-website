...
With alerts, you can start detecting issues before they turn critical. [Create and customize your alerts conditions](/docs/alerts-applied-intelligence/new-relic-alerts/get-started/your-first-nrql-condition/) that focus on exactly what you're most concerned about using NRQL, our New Relic query language. Use alerts to be updated about unusual behavior in your data, route notifications to the people who need to see it, and make effective decisions while knowing the root cause of your issue.

Improve your alert coverage by implementing the following our recommendations about how to best use alert response, maintenance, quality, and advanced settings. See our [Alert quality management](/docs/new-relic-solutions/observability-maturity/uptime-performance-reliability/alert-quality-management-guide) guide to know how to measure and improve your alerting quality.
