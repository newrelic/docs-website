...
You can start easily and wisely detecting issues before they turn critical by [creating](/docs/alerts-applied-intelligence/new-relic-alerts/get-started/your-first-nrql-condition/) and customizing your own alerts. Use your alerts to have updated data about unusual behavior, be notified about it, and take effective decisions knowing the root cause of the issue.

You can improve your alert coverage by implementing the following recommendations about the alert response, maintenance, quality, and advanced settings. See our [Alert quality management](/docs/new-relic-solutions/observability-maturity/uptime-performance-reliability/alert-quality-management-guide) guide to know how to measure and improve your alerting quality.
