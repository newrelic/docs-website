...
![Support navigation](src/images/support-nav.png 'Support navigation')
...
![In-product support](src/images/in-product-support.png "New Relic's in-product support")
...
![New Relic's Explorer Hub](src/images/new-relic-explorers-hub.png "New Relic's Explorer Hub")
...
<div style={{ width: '300px' }}>
  ![New Relic Docs - Feedback](src/images/docs_feedback.png "New Relic Docs -
  Feedback")
</div>
...
<div style={{ width: '300px' }}>
  ![Help button](src/images/help-button.png "Help button")
</div>
