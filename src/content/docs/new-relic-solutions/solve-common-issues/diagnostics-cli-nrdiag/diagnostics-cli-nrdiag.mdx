...
* **APM**: Available for all <InlinePopover type="apm" /> agents. For the Go agent, only basic connectivity checks are available.
* **Browser monitoring**: Detection for <InlinePopover type="browser" /> agent.
