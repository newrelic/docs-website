...
* <DoNotTranslate>**APM**</DoNotTranslate>: Available for all <InlinePopover type="apm" /> agents. For the Go agent, only basic connectivity checks are available.
* <DoNotTranslate>**Browser monitoring**</DoNotTranslate>: Detection for <InlinePopover type="browser" /> agent.
* <DoNotTranslate>**Infrastructure monitoring**</DoNotTranslate>: Linux and Windows agents
* <DoNotTranslate>**Mobile agents**</DoNotTranslate>: iOS and Android
* <DoNotTranslate>**Synthetic monitoring**</DoNotTranslate>: Containerized private minions (CPM)
