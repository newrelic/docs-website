...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Attach for automatic upload to a New Relic account. This uses a validated <InlinePopover type="licenseKey" /> from your environment.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
         User API key to use when uploading results to your New relic account. This bypasses using a license key and uses your <InlinePopover type="userKey" /> to attach results instead.
      </td>
    </tr>
