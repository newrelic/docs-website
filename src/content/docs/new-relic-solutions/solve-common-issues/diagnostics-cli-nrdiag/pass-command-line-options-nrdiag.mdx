...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Include a file or directory (including subdirectories) in the `nrdiag-output.zip`. Limit 4GB. To upload the results to New Relic also use the `-a` or `-api-key` flag.
