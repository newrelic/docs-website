...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Attach for automatic upload to a New Relic account. This uses a validated [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) from your environment.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Include a file or directory (including subdirectories) in the `nrdiag-output.zip`. Limit 4GB. To upload the results to New Relic also use the `-a` flag.
