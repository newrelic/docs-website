...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
         User API key to use when uploading results to New relic account. This bypasses using a license key and uses your <InlinePopover type="userKey" /> to attach results instead.
      </td>
    </tr>
