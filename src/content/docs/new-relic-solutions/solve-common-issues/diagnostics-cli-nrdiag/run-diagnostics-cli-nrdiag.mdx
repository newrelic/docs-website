...
By default, the Diagnostics CLI uploads results to New Relic accounts hosted in the US data center. If your account is hosted in the EU data center, ensure to add `-region eu` to the command. If your account is hosted in the JP data center, ensure to add `-region jp` to the command.
