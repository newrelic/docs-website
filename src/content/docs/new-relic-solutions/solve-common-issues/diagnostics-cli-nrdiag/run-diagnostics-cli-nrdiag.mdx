...
<CollapserGroup>
  ...
  >
    ...
    ```
    <DNT>**Recommendation:**</DNT> Scope your troubleshooting with a [task suite](#suites) (`-suites`), and upload relevant files to your New Relic account with the [attachment flag](#automatic) (`-attach`).
  </Collapser>
...
<CollapserGroup>
  ...
  >
    To troubleshoot your New Relic-instrumented application running in a <DNT>Docker/DNT> container, use the `docker exec` command:
