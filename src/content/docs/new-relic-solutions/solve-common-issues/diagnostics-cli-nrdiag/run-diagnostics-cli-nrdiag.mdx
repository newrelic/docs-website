...
Script output is printed to the screen, along with being saved in a file based on the name of the script, ie: `name-of-script.out`. This is saved in the directory specified by `-output-path`, defaulting to the current directory.
