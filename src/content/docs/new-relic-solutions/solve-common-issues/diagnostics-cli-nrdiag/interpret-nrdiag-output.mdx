...
2. Select the <DoNotTranslate>**Diagnostics Home**</DoNotTranslate> tab.
3. Under the Diagnostics CLI Output section, click <DoNotTranslate>**View Run Details**</DoNotTranslate>.
