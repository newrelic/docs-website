...
<figcaption>
  The Diagnostics CLI outputs any issues it found with your installation, along
...
![Diagnostics CLI Output application in New Relic One](src/images/left-sidebar-nerdlet-diag.png 'Diagnostics CLI Output application in New Relic One')
