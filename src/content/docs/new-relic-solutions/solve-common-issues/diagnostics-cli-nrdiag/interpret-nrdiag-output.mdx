...
1. Select an app in [in the UI](https://one.newrelic.com), then search for **Diagnostics CLI Output**. OR, click this [**Diagnostics CLI Output** permalink](https://onenr.io/0x0jldL3EjW) to go directly to the page.
