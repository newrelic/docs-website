...
![Screenshot of a terminal window showing command output. The agent_enabled setting is called out as incorrect.](src/images/agent_enabled.png 'agent_enabled.png')

<figcaption>
  If you enable your Java agent incorrectly, the Diagnostics CLI returns a
  message like this, describing what setting needs to be updated and how it
  needs to be changed.
</figcaption>
