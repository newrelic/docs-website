...
If you need to record and view information about <DoNotTranslate>**all**</DoNotTranslate> data your app transmits to New Relic, you can enable audit logging for short periods of time. This is useful, for example, with debugging or auditing, when you need detailed information about what exactly is being transmitted.
...
<table>
  <thead>
    <tr>
      ...
      <th>
        <DoNotTranslate>**Configuration file**</DoNotTranslate>
      </th>
    </tr>
  </thead>
