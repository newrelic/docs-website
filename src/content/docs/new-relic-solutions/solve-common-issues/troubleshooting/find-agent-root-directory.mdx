    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            Use [`phpinfo()`](/docs/agents/php-agent/configuration/php-agent-configuration#inivar-background) and look in the sections called <DoNotTranslate>**Scan this dir for additional .ini files**</DoNotTranslate> or <DoNotTranslate>**Additional .ini files parsed**</DoNotTranslate> for the location of the `newrelic.ini` file. This file will be in the agent root directory, which is called `newrelic-php5`.
