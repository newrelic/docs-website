    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            In the root directory for your app, look for the agent root directory called `NewRelic`, which you created when you [installed the Core 2.0 agent with <DNT>Docker/DNT>](/docs/agents/net-agent/installation/install-net-core-20-agent-docker#windows-prep).
          </td>
        </tr>
      </tbody>
    </table>
  ...
  >
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          <td>
            With a configuration system, like <DNT>Puppet</DNT> or Chef
          </td>
  ...
  >
    <table>
      ...
      <tbody>
        ...
        <tr>
          <td>
            Linux, <DNT>Docker/DNT>, and <DNT>Elastic Beanstalk</DNT>
          </td>
