...
tags:
  ...
  - Troubleshooting
metaDescription: Troubleshooting issues with New Relic agents if you do not see data in the UI.
redirects:
...
You should start seeing data within a few minutes after installing a New Relic agent and generating traffic for your app. If you do not see data, you can use the [New Relic Diagnostics](/docs/agents/manage-apm-agents/troubleshooting/new-relic-diagnostics) utility to automatically identify common issues. For additional troubleshooting tips, see the agent-specific docs. 
