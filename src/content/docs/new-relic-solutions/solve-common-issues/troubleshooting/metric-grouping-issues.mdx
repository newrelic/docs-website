...
![ Before and after](src/images/metric-grouping.png ' Before and after')

<figcaption>
  Here is a "before" and "after" example of how metric grouping can help
  organize transactions, to help you more easily identify patterns with
