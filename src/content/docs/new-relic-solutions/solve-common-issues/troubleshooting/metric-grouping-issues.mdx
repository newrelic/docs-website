...
<Callout variant="tip">
If you want to group data that is reporting to the Metrics explorer, you can use [Metric normalization rules](/docs/new-relic-solutions/new-relic-one/ui-data/metric-normalization-rules/) to match those incoming metrics and replace those matched metrics.
</Callout>
