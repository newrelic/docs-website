...
4. Check/Query [`NrIntegrationError`](docs/data-apis/manage-data/nrintegrationerror/) for events with name `MetricCardinalityNearLimit`. These events will be created whenever your app is getting near to the cardinality limit.
