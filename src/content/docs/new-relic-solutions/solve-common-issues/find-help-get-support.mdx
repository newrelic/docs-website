...
1. Select your account from the **Account** dropdown located in the top right.

2. Select the **Help(?)** icon from the top right navigation menu.

3. The **Help** sidebar opens. Under the Resources section, select **Your support cases**.

5. Click <DNT>**+New case**</DNT> to create a case.
