...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td>Items to render, in the shape of a list of objects. Usually, each item in the items array contains the required data to generate the corresponding `<DropdownItem>`.This prop is required when rendering items with the render callback (function as children).</td>
