...
<table>
    <tbody>
        ...
        <tr>
            <td>`crossAccount` <h5>boolean</h5></td>
            <td>Shows an option at the top named "All accounts". When selected, the value provided by the `onChange` callback is `AccountPicker.CROSS_ACCOUNT`. This is useful when you have functionality that can operate on multiple accounts.</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>Callback fired every time the user clicks an account from the list.
        ...
        <tr>
            <td>`value` <h5>number|enum</h5></td>
            <td>Id of the selected account.</td>
        </tr>
    </tbody>
</table>