...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td>List of options expressed as a set of `<SelectItem>`s.</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>If `true`, the select is not available for interaction.</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>Callback fired any time the value of the select is changed.You can get the value back as the second argument of the `onChange` event.
        ...
        <tr>
            ...
            <td>Value matching the item selected.</td>
        </tr>
    </tbody>
</table>