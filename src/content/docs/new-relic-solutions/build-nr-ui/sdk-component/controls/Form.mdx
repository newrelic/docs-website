...
<table>
    <tbody>
        ...
        <tr>
            <td>`layoutType` <h5>enum</h5></td>
            <td>Layout of the form:
        ...
        <tr>
            <td>`splitSizeType` <h5>enum</h5></td>
            <td>Specifies the size of the columns when using the split layout.
            <OptionReference>
