...
<table>
    <tbody>
        <tr>
            ...
            <td>Steps items to render inside the component.</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>The initial step that should be active.</td>
        </tr>
        <tr>
            <td>`onChange` <h5>function</h5></td>
            <td>Function called when the user clicks over a step.
        ...
        <tr>
            ...
            <td>The step with the matching value will be marked as active. Active steps are automatically expanded. If you don't want the step to be expanded you should mark it as `disabled`.If defined, it turns the component into a [controlled component](https://facebook.github.io/react/docs/forms.html).</td>
        </tr>
    </tbody>
</table>