...
|                                    |                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `children`##### REQUIRED##### node | Steps items to render inside the component.                                                                                                                                                                                                                                                                                                                                                                                                          |
| `className`##### string            | Appends class names to the component.Should be used only for positioning and spacing purposes.                                                                                                                                                                                                                                                                                                                                                       |
| `defaultValue`##### any            | The initial step that should be active.                                                                                                                                                                                                                                                                                                                                                                                                              |
| `onChange`##### function           | Function called when the user clicks over a step.&lt;FunctionDefinition returnValue=&#x7B;\[]} arguments=&#x7B;\[&#x7B;"name":"event","type":"React.MouseEvent","description":"Event source of the callback."},&#x7B;"name":"stepValue","type":"any","description":"The value of the step."}]} />                                                                                                                                                    |
| `spacingType`##### enum\[]         | Spacing property. Spacing is defined as a tuple of zero to four values, which follow the same conventions as CSS properties like `margin` or `padding`. To omit a value, use `SPACING_TYPE.OMIT`.##### REPLACE WITH CUSTOM COMPONENT&lt;Array of##### REPLACE WITH CUSTOM COMPONENT&lt;One ofSteps.SPACING_TYPE.EXTRA_LARGESteps.SPACING_TYPE.LARGESteps.SPACING_TYPE.MEDIUMSteps.SPACING_TYPE.NONESteps.SPACING_TYPE.OMITSteps.SPACING_TYPE.SMALL>> |
...
| `value`##### any                   | The step with the matching value will be marked as active. Active steps are automatically expanded. If you don't want the step to be expanded you should mark it as `disabled`.If defined, it turns the component into a \[controlled componentINSERTLINKhttps&#x3A;//facebook.github.io/react/docs/forms.html.                                                                                                                                      |