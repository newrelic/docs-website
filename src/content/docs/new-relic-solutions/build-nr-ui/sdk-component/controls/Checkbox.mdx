...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td>Callback fired any time the selected state of the checkbox changes.<FunctionDefinition returnValue={[]} arguments={[{"name":"event","type":"React.ChangeEvent","description":"The event source of the callback.\\n You can access the new value with \`event.target.checked\`."}]} /></td>
        </tr>
        <tr>
