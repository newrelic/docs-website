...
<table>
    <tbody>
        <tr>
            ...
            <td>If `true`, the radio button is checked.If defined, it turns the input into a [controlled component](https://facebook.github.io/react/docs/forms.html).</td>
        ...
        <tr>
            ...
            <td>If `true`, the radio button is not available for interaction.</td>
        ...
        <tr>
            ...
            <td>Callback fired any time the selected state of the radio button changes.
        ...
        <tr>
            ...
            <td>Callback fired any time the radio button is clicked.
        ...
        <tr>
            ...
            <td>The value of the component. Used by the `<RadioGroup/>` to identify the selected radio button.</td>
