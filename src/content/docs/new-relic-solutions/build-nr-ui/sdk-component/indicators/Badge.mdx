...
<table>
    <tbody>
        <tr>
            <td>`children` <h5>REQUIRED</h5><h5>string|number</h5></td>
            <td>String to render inside the badge. Ellipsis will apply if the content is more than 24 characters.</td>
        </tr>
        <tr>
