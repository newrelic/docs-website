...
<table>
    <tbody>
        ...
        <tr>
            <td>`tagType` <h5>enum</h5></td>
            <td>Tag in which to wrap the text.Useful for changing the semantic meaning of the text. This does not apply any style.
        ...
        <tr>
            ...
            <td>Type of text that you want to display.This applies styles according to the type.
