...
<table>
    <tbody>
        <tr>
            ...
            <td>Element to space. Spacing can only be applied to one signle element at a time; to space multiple ones, each of them needs to be wrapped individually.</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>Spacing property. Spacing is defined as a tuple of zero to four values, which follow the same conventions as CSS properties like `margin` or `padding`. To omit a value, use `TYPE.OMIT`.
