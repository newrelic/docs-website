...
<table>
    <tbody>
        <tr>
            ...
            <td>Grid items to display.Up to 12 items are allowed.</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>Expands the grid to occupy all available height.</td>
        </tr>
        <tr>
            <td>`fullWidth` <h5>boolean</h5></td>
            <td>Expands the grid to occupy all available width.</td>
        </tr>
        <tr>
            <td>`gapType` <h5>enum</h5></td>
            <td>Size of the gap between columns and rows.<OptionReference>Grid.GAP_TYPE.MEDIUMGrid.GAP_TYPE.SMALL</OptionReference></td>
        </tr>
        <tr>
