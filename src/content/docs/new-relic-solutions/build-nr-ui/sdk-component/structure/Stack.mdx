...
<table>
    <tbody>
        ...
        <tr>
            <td>`directionType` <h5>enum</h5></td>
            <td>Direction of the stack items.
        ...
        <tr>
            ...
            <td>Space between each stack item.
        ...
        <tr>
            <td>`horizontalType` <h5>enum</h5></td>
            <td>Sets the horizontal alignment and distribution of the stack items.
        ...
        <tr>
            <td>`preview` <h5>boolean</h5></td>
            <td>Visually draws the boxes of the Stack and its StackItems.</td>
        </tr>
        <tr>
        ...
        <tr>
            <td>`verticalType` <h5>enum</h5></td>
            <td>Sets the vertical alignment and distribution of the stack items.
