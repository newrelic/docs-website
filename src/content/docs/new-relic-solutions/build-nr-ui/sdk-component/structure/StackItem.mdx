...
|                                    |                                                                                                                                                                                                                                                                                                                                                                    |
| ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `children`##### REQUIRED##### node | Content to display inside the stack item.                                                                                                                                                                                                                                                                                                                          |
| `className`##### string            | Appends class names to the component.Should be used only for positioning and spacing purposes.                                                                                                                                                                                                                                                                     |
| `grow`##### boolean                | If `true`, the item fills the remaining space. To make it work, you will need to extend your stack to occupy all available space in the direction of your items. This can be achieved by using the `fullWidth` or `fullHeight` props of the stack, depending on its direction.                                                                                     |
| `shrink`##### boolean              | If `true`, the item shrinks if necessary.                                                                                                                                                                                                                                                                                                                          |
