...
| `mutation` <h5>REQUIRED</h5><h5>string</h5>\|object  | GraphQL mutation, either as a string or a GraphQL document parsed into an AST by `graphql-tag`.``` import { ngql } from 'nr1';   const mutation = ngql`   mutation($guid: EntityGuid!) {     taggingAddTagsToEntity(guid: $guid, tags: $tags) {       errors {         message       }     }   } `; ```                                             |
...
| `variables` <h5>object</h5>                       | Object containing all of the variables your mutation needs to execute.                                                                                                                                                                                                                                                                                         |
