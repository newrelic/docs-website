...
<table>
    <tbody>
        <tr>
            <td>`children` <h5>function</h5></td>
            <td>Render prop function as a child.
        ...
        <tr>
            <td>`fetchPolicyType` <h5>enum</h5></td>
            <td>Allows you to specify how you want your query to interact with the cached data.
        ...
        <tr>
            <td>`pollInterval` <h5>number</h5></td>
            <td>Interval in milliseconds to poll for new data. Set to zero to avoid any kind of regular polling.</td>
        </tr>
        <tr>
            <td>`skip` <h5>boolean</h5></td>
            <td>When set to `true`, the query will be skipped entirely from rendering.</td>
        </tr>
    </tbody>
</table>
...
<FunctionDefinition arguments={[{"description":"Object containing the query options. Any `UserQuery` prop is a valid option except `children` and `pollInterval`.","name":"props","type":"Object"}]} returnValue={{"description":"","type":"PromiseQueryResult"}} />
