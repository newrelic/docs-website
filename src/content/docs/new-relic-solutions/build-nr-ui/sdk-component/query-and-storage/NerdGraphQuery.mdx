...
<table>
    <tbody>
        ...
        <tr>
            <td>`query` <h5>REQUIRED</h5><h5>string</h5>|object</td>
            <td>GraphQL query, either as a string or a GraphQL document parsed into an AST by the `gql` method of `nr1`.
```js
...
```
        ...
        <tr>
            ...
            <td>Object containing all of the variables your query needs to execute.</td>
        </tr>
    </tbody>
</table>
