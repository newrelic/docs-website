...
<FunctionDefinition
  arguments={[{"description":"An object containing the query options. Any `UserStorageQuery` prop is a valid option except `children` and `pollInterval`.","name":"props","type":"Object"}]}
