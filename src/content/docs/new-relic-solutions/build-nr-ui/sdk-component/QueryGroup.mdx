...
<table>
    <tbody>
        <tr>
            <td>`children` <h5>(function|node)[]</h5></td>
            <td>List of all the queries to be executed in parallel, followed by the callback that will be called for each transition change.</td>
        </tr>
    </tbody>
</table>