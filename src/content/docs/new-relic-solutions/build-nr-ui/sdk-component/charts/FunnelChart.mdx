---
title: 'FunnelChart'
metaDescription: 'Learn how to work the FunnelChart component'
freshnessValidatedDate: 2024-06-03
---

Creates a funnel chart. Data can either be obtained by performing a NRQL query against a particular account, or it can be passed through the `data` prop.
...
```js
<FunnelChart accountIds={[1]} query="SELECT count(*) FROM `Synthetics` SINCE 1 DAY AGO TIMESERIES AUTO FACET jobType" />
```

#### With multiple accounts

```js
<FunnelChart accountIds={[1, 1067061]} query="SELECT count(*) FROM `Synthetics` SINCE 1 DAY AGO TIMESERIES AUTO FACET jobType" />
```
