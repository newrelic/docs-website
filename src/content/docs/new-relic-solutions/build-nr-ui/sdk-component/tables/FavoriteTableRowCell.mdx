...
|                          |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `checked` <h5>boolean</h5>   | If `true`, indicates that the user has marked the entity as favorite.                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `className` <h5>string</h5>  | Inline style for custom styling.Should be used only for positioning and spacing purposes.                                                                                                                                                                                                                                                                                                                                                                                                       |
| `onChange` <h5>function</h5> | Callback fired any time the favorite status changes. The new favorite status will be passed as second parameter.<FunctionDefinition returnValue={[]} arguments={[{"name":"event","type":"React.MouseEvent","description":""},{"name":"checked","type":"boolean","description":""}]} />                                                                                                                                                                                 |
