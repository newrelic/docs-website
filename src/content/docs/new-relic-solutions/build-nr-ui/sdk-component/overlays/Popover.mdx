...
<table>
    <tbody>
        <tr>
            ...
            <td>This component accepts children of two types:
            * `<PopoverTrigger>` to render the element that will open/close the overlay. 
            * `<PopoverBody>` to render content inside the overlay.</td>
        </tr>
        <tr>
            <td>`onChange` <h5>function</h5></td>
            <td>Callback to track when the `Popover` overlay opens or closes while in controlled mode. This method fires when the user actions the `PopoverTrigger`, or clicks outside of the `PopoverBody` when it is open.
        ...
        <tr>
            <td>`openOnHover` <h5>boolean</h5></td>
            <td>When true, the popover overlay will open on hover.</td>
        </tr>
        <tr>
            <td>`opened` <h5>boolean</h5></td>
            <td>When provided, `Popover` will be put into controlled mode. The boolean value will either open or close the popover overlay.</td>
        </tr>
    </tbody>
</table>