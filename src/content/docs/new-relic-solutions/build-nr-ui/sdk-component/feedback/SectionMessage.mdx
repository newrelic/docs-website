...
<table>
    <tbody>
        <tr>
            <td>`actions` <h5>shape[]</h5></td>
            <td>You may use up to two actions to help the user navigate to another view, trigger background events, or change the nerdlet/section behavior.
        ...
        <tr>
            ...
            <td>Use it to provide further details and explain, if any, the steps for the user to take.
            
            Note: `title` and `description` props are optional, but at least one of them has to be provided.</td>
        ...
        <tr>
            ...
            <td>Use it to provide the main message.Note: `title` and `description` props are optional, but at least one of them has to be provided.</td>
