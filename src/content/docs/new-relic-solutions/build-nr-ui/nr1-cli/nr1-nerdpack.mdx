...
## `nr1 nerdpack:clone` [#nerdpack-clone]
...
## `nr1 nerdpack:info` [#nerdpack-info]
...
## `nr1 nerdpack:publish` [#nerdpack-publish] 
...
## `nr1 nerdpack:serve` [#nerdpack-serve]
...
## `nr1 nerdpack:uuid` [#nerdpack-uuid] 
...
## `nr1 nerdpack:validate` [#nerdpack-validate]
