...
## Create catalog information [#create]
...
Save [this screenshot](https://github.com/newrelic-experimental/nru-programmability-course/raw/main/publish/ab-test/catalog/screenshots/screenshot.webp) to the following two directories: 
