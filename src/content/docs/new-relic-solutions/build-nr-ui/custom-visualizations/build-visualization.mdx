...
To add an instance of your visualization to a dashboard, you first need to [publish your Nerdpack](/docs/new-relic-solutions/new-relic-one/build-nr-apps/publish).
