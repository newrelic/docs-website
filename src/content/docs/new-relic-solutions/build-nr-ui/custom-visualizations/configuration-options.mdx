...
import QueriesConfVisualizationProperties from 'images/queries-nrql_screenshot-crop_conf-visualization-prop.webp'


In this document, you'll learn what is in your visualization's `nr1.json` file, how to modify it, and how to use it to make your visualization more flexible and reusable.
...
<img
  ...
  src={QueriesConfVisualizationProperties}
/>
