...
New Relic also lets you write “anomaly queries” against your data. These are queries you write without setting hard limits on the results. Rather, you let [applied intelligence](https://newrelic.com/platform/applied-intelligence) machine-learn your performance data, and then alert you when your data strays too far outside of your anomaly numbers.
