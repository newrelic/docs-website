...
To learn more about how to run queries to produce charts and dashboards, see [Introduction to chart builder](/docs/query-your-data/explore-query-data/query-builder/introduction-query-builder). For more about the data you can query, see [New Relic data types](/docs/telemetry-data-platform/ingest-manage-data/understand-data/new-relic-data-types).
