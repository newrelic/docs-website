...
For more information, review New Relic's [objectives and baselines tutorial](https://docs.newrelic.com/docs/establish-objectives-baselines), which also includes detailed information about SLIs, SLOs, and SLAs.
...
We let you create many [chart types](https://docs.newrelic.com/docs/insights/use-insights-ui/manage-dashboards/chart-types) for the most logical data to track. **Recommendation:** At a minimum, include the following:
