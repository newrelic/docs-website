...
<CollapserGroup>
  ...
  >
    ...
    * [Install on AWS <DNT>Elastic Beanstalk</DNT>](/docs/infrastructure/new-relic-infrastructure/installation/install-infrastructure-agent-aws-elastic-beanstalk)
