...
It's important to track deployments and how the impact of the code and infrastructure changes you make affect customer experience. [New Relic APM](/docs/apm/new-relic-apm/getting-started/introduction-new-relic-apm)'s deployment markers feature allows you to [record deployments](/docs/apm/new-relic-apm/maintenance/record-deployments) for each application.
