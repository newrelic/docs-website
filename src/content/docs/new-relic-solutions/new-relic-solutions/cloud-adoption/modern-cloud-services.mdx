...
<CollapserGroup>
  ...
  >
    ...
    ![AWS EC2 dashboard example](https://docs-dev.newrelic.com/sites/default/files/styles/inline_660px/public/thumbnails/image/AWSEC2-Dashboard.png?itok=79i3HTwf "AWS EC2 dashboard example")
