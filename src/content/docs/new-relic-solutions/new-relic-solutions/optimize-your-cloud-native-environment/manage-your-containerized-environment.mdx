...
* Actively, where we enable availability monitoring for one user in one location with [synthetic monitoring](https://docs.newrelic.com/docs/synthetics/new-relic-synthetics/getting-started/introduction-new-relic-synthetics)
