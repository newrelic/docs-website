...
* Use [APM](https://docs.newrelic.com/docs/apm) to report application-tier performance metrics.
* Use [browser monitoring](https://docs.newrelic.com/docs/browser) to report front-end web metrics.
* Use [mobile monitoring](https://docs.newrelic.com/docs/mobile-monitoring) to report front-end mobile app metrics.
* Use [synthetic monitoring](https://docs.newrelic.com/docs/synthetics) to monitor websites, critical business transactions, and API endpoints.
