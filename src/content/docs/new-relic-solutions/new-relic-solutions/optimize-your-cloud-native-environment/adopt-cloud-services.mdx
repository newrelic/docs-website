...
It's important to track deployments and the impact that code and infrastructure changes have on your end-user experience. [New Relic APM](/docs/apm/new-relic-apm/getting-started/introduction-new-relic-apm) deployment markers allow you to [record deployments](/docs/apm/new-relic-apm/maintenance/record-deployments) for each application.
