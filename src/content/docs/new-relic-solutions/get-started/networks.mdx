...
* `162.247.240.0/22`
* `18.246.82.0/25` (effective June 20, 2024)
* `3.145.244.128/25` (effective June 20, 2024)
* '20.51.136.0/25' (effective June 20, 2024)
* '185.221.84.0/22' (effective June 20, 2024)
...
* `159.122.103.184/29`
* `161.156.125.32/28`
* `3.77.79.0/25` (effective June 20, 2024)

Network blocks for AP data center region:
* '3.27.118.128/25' (effective June 20, 2024)

Network blocks for ANZ data center region:
