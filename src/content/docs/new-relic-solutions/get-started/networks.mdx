...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
       `security-api.newrelic.com/security/v1`
      </td>
      ...
      <td>
        [Security data ingest](/docs/data-apis/ingest-apis/security-data-api)</td>
    </tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
       `security-api.service.eu.newrelic.com/security/v1`
      </td>
...
In addition to the [ingest endpoints used by our mobile agents and APM agents](#data-ingest), apps monitored by our [mobile agents](/docs/mobile-monitoring) use outgoing connections to `mobile-symbol-upload.newrelic.com` (EU endpoint: `mobile-symbol-upload.eu01.nr-data.net`).
