...
<table>
  ...
  <tbody>
    <tr>
      <td>
        [Agent Control](/docs/new-relic-control/agent-control/overview) OpAMP communication with Fleet Control
      </td>
    ...
    <tr>
      <td>
        Agent Control OAuth token service (system identity authentication)
      </td>
...
<CollapserGroup>
  ...
  <Collapser
    id="jp-endpoint-list"
    title="Japan data center endpoints"
  >
    Here's a list of the [Japan data center region](/docs/accounts/accounts-billing/account-setup/choose-your-data-center) endpoints included in the endpoint table above in an easy-to-copy list:
...
<table>
    ...
    <tr>
        <th>
            <DoNotTranslate>**Ingest APIs**</DoNotTranslate>
        </th>
    </tr>
    </thead>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Synthetics screenshots, logs, and similar assets (US region)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Synthetics screenshots, logs, and similar assets (EU region)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Synthetics screenshots, logs, and similar assets (JP region)
      </td>
    </tr>
...
<Callout variant="important">
  **JP region:** New Relic's CDN providers have Japan endpoints and use them under normal conditions. However, in the event of a CDN outage or performance issue, traffic may be rerouted through endpoints outside Japan. This applies only to static asset delivery and does not affect the routing or storage of your telemetry data.
</Callout>
...
<Callout variant="important">
  **JP region:** The `js-agent.newrelic.com` file is served via CDN providers that have Japan endpoints. However, if a CDN outage or performance issue occurs, the browser agent script may be served from endpoints outside Japan. This does not affect where your telemetry data is sent or stored.
</Callout>
...
[TLS](#tls) is required for all domains. Use the IP connections for your [data center region](/docs/accounts/accounts-billing/account-setup/choose-your-data-center):
