...
It's easy to set up browser monitoring, especially if you have an APM agent installed already. To get started, see [the <DoNotTranslate>**Add your data**</DoNotTranslate> UI page](https://one.newrelic.com/marketplace?state=dbe79256-a6cf-ea3e-baac-c5dab3a0b5cb) and click <DoNotTranslate>**Browser monitoring**</DoNotTranslate>. 
...
Ready to continue on your implementation journey? Go to the next stage: [<DoNotTranslate>**Understand and organize your data**</DoNotTranslate>](/docs/new-relic-solutions/get-started/implementation-guide-organize-data). 
