...
Our infrastructure agent instruments hosts and supports many integrations for other infrastructure-related services. The agent can be installed on a host (​​whether that's a node in a Kubernetes cluster, a VM in your own on-prem data center, or a VM in the cloud) or in a container. Select a relevant option: 
...
* [Install agent in a container](/docs/infrastructure/install-infrastructure-agent/linux-installation/container-instrumentation-infrastructure-monitoring) 
* Kubernetes: 
