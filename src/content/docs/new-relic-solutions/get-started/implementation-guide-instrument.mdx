...
* If you've already set up [workloads](/docs/new-relic-solutions/new-relic-one/workloads/workloads-isolate-resolve-alert-events-faster) in New Relic, ensure those workloads contain the data you expect to see. (We'll talk more about workloads later.)
