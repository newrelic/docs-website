...
If you're on our [free tier or Standard edition](/docs/accounts/accounts-billing/new-relic-one-pricing-billing/new-relic-one-pricing-billing#editions), you probably don't have access to our global technical support service. To get 24-7 support, [upgrade to Pro or Enterprise edition](https://one.newrelic.com/nr1-core/plan-management/home?state=7a437d0d-1905-4143-d3a1-68ddfcb6db53). Alternatively, use [our community forum](https://discuss.newrelic.com) to ask questions and see answers.
