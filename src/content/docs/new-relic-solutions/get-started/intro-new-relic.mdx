...
<Steps>
  ...
  <Step>
    ...
    Click the <DNT>**Guided install**</DNT> button. Or, if your organization is located in an [EU data center](/docs/using-new-relic/welcome-new-relic/get-started/our-eu-us-region-data-centers), click <DNT>**EU Guided install**</DNT>. If your organization is located in the JP data center, click <DNT>**JP Guided install**</DNT>.
    ...
    <ButtonGroup>
      ...
      <ButtonLink
        role="button"
        to="https://one.jp.newrelic.com/marketplace?state=15321ec0-7cd8-0c04-52bf-7b65778f2e8c"
        variant="primary"
      >
        JP Guided install
      </ButtonLink>
