...
import vulnerabilitymanagement from 'images/vulnerability-management.png'
...
<img
  ...
  alt="An image representing the flow of data through the New Relic platform"
  src={vulnerabilitymanagement}
/>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * [Monitor your network:](/docs/network-performance-monitoring/get-started/npm-introduction/) Collect network data, so you can quickly troubleshoot whether performance issues are in the network, infrastructure, or your code.
      </td>
    </tr>
...
* [Network monitoring](/docs/network-performance-monitoring/get-started/npm-introduction/)
