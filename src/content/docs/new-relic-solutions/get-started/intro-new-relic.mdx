...
<Steps>
  ...
  <Step>
    ...
    Click the <DNT>**Guided install**</DNT> button for the US region. If your organization is located in a different [data center region](/docs/accounts/accounts-billing/account-setup/choose-your-data-center), select the guided install for your region.
