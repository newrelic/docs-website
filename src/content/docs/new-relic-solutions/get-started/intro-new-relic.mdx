...
[New Relic One](/docs/new-relic-one/use-new-relic-one/get-started/introduction-new-relic-one) gives you access to a wide range of observability tools, including:
...
* [Network performance monitoring](/docs/network-performance-monitoring/get-started/npm-introduction/)
