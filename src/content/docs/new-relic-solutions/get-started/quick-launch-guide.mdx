...
* To set up a strong observability foundation, see the more in-depth [implementation guide](/docs/new-relic-solutions/get-started/implementation-guide-intro). 
