...
You should try to minimize the number of accounts you have. This keeps your account and user structure simple, and gives users easier access to relevant data. [Learn more about why you'd add accounts](/docs/accounts/accounts-billing/account-structure/new-relic-account-structure#add-accounts).
