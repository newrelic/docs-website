...
Note that only Pro and Enterprise editions allow multiple accounts, the ability to add custom groups and roles, and the ability to have more than five full platform users. This means that if you have free tier or Standard edition, planning out your users is less important.
