...
*This is the fourth and final part of [the New Relic implementation guide](/docs/new-relic-solutions/get-started/implementation-guide-intro).*
...
* If not already done, [browse and install other observability tools](https://newrelic.com/instant-observability) to ensure instrumentation across your entire stack. 
* Read [the docs for specific tools and features](http://docs.newrelic.com) to learn how to configure and customize them. 
* [Understand and optimize your data ingest.](/docs/data-apis/manage-data/manage-your-data) 
* Attend [a New Relic university class on querying data](https://learn.newrelic.com/writing-nrql-queries), and take [other classes](https://learn.newrelic.com).
