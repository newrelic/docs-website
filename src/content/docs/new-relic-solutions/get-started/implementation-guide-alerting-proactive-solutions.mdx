...
To route alert notification messages to you, we use <DoNotTranslate>**workflows**</DoNotTranslate> (the rules of how incidents create notifications and what data gets sent) and <DoNotTranslate>**notification destinations**</DoNotTranslate> (where notifications are sent). We recommend you plan out how these will be set up to be consistent and maintainable across your organization. If you're integrating with another service, such as Slack or PagerDuty, then consider how you'll control and maintain these integrations in the long term. 
