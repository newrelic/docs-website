...
<CollapserGroup>
  ...
  >
    The name that New Relic combines with your [license key](/docs/apis/intro-apis/new-relic-api-keys/#license-key) to uniquely identify a particular app. For more information, see [Name your application](/docs/agents/manage-apm-agents/app-naming/name-your-application).
  </Collapser>
