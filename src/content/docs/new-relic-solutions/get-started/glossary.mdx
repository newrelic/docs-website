...
<CollapserGroup>
  ...
  >
    The **account dropdown**, also referred to as the **user menu**, gives you access to [account-related UI pages and settings](/docs/accounts/accounts-billing/general-account-settings/introduction-account-settings). Its location varies on which [version of our UI](/docs/new-relic-solutions/new-relic-one/new-navigation-transition-guide) you have: it's either in the upper right or the lower left. 
