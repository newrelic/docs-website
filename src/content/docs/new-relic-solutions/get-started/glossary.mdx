...
To learn how New Relic uses events, see [New Relic data types](/docs/data-apis/understand-data/new-relic-data-types/#event-data). 
  ...
  <Collapser
    ...
    title="log"
  >
    A **log** is a message about a system used to understand the activity of the system and to diagnose problems. For more information on how we use log data, see [<InlinePopover type="logs" />](/docs/logs/new-relic-logs/get-started/introduction-new-relic-logs).
  </Collapser>
