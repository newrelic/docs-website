...
For more information, see [incidents] (/docs/new-relic-solutions/get-started/glossary/#alert-incident).
  ...
  <Collapser
    ...
    title="host ID"
  >
    Each host identified by <InlinePopover type="apm" /> is assigned a **host ID**. This ID is used to uniquely identify it, and to retrieve data about that host via the REST API. For more information, see [List host ID](/docs/apis/rest-api-v2/requirements/list-application-id-host-id-instance-id#locating_host_id).
  </Collapser>
