...
<CollapserGroup>
  ...
  >
    For our [alerting feature](/docs/alerts/create-alert/fine-tune/choose-your-aggregation-method/), this refers to the length of time in seconds to wait for the aggregation window to fill with data. Required when using `aggregation_method` types `CADENCE` or `EVENT_FLOW`.
  </Collapser>
