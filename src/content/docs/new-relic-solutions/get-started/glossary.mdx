...
<CollapserGroup>
  ...
  Our detection & AI capability includes alerts, incident correlation, automatic anomaly detection, and customizable workflows.
  </Collapser>
