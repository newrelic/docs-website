...
<CollapserGroup>
  ...
  >
    ...
    For more information, see [incidents](/docs/new-relic-solutions/get-started/glossary#alert-event).
  </Collapser>
  ...
  >
    This term has been replaced in the UI with [incident](/docs/new-relic-solutions/get-started/glossary#alert-event).
  </Collapser>
