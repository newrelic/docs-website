...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="agent"
  >
    A New Relic agent is an installable piece of software that integrates with multiple types of technologies (for example, web frameworks, operating systems, and types of databases) and reports data to New Relic, usually on a specific cadence. We have <InlinePopover type="apm" /> agents, an <InlinePopover type="infrastructure" /> agent, a browser monitoring agent, and mobile monitoring agents. The various technologies that our agents integrate with are just some of [our many integrations](https://newrelic.com/instant-observability).
