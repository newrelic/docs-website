...
<DoNotTranslate>**Velocity**</DoNotTranslate>
* Code commit rate
* Pull request rate
* Merge rate
...
1. <DoNotTranslate>**Review the DevQual KPIs and trends.**</DoNotTranslate> You and the stakeholders will look at the DevQual KPIs and identify trends.
