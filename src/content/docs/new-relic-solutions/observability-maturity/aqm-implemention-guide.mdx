...
Before you begin, complete the [New Relic University (NRU) Overview Course](https://learn.newrelic.com/overview-course) or have equivalent experience. Also, make sure you have a basic understanding of:
