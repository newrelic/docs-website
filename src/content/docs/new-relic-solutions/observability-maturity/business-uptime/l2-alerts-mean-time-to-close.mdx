---
title: Level 2 - Alerts, mean time to close
tags:
...
- ***Develop Alerting and Incident Management Strategy:*** Ensure you have a well-defined alerting and incident management strategy. If not, engage in an Alert Quality Management (AQM) workshop to introduce the need for a comprehensive, well-documented approach to alerting maintenance, incident management, and regular program review.
