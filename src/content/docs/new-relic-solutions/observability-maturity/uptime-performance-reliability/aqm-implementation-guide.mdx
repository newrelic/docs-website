...
Before you begin, if you do not have equivalent experience, complete the [New Relic University (NRU) Overview Course](https://learn.newrelic.com/overview-course). Also, make sure you have a basic understanding of:
