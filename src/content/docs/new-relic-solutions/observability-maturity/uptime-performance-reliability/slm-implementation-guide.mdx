...
### Process overview
  ...
  Using the screenshot below as a visual reference and follow the next steps:
...
It's recommended to setup a few of these capability service levels and present to the application team and your leadership for feedback.
...
This includes __NOT__ surveying each stakeholder for what should and shouldn't be measured. Surveys usually result in long wait times, lots of questions, frustration, lack of demonstrated value, and not so good answers.
