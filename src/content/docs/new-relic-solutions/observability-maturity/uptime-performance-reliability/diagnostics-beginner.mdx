...
import imagePatternNormal from 'images/oma/upr/red/pattern-normal.jpg'
import imagePatternNormalPercentile from 'images/oma/upr/red/pattern-normal-percentile.jpg'
import imagePatternAbnormal from 'images/oma/upr/red/pattern-abnormal.jpg'
import imagePatternAbnormalCompare from 'images/oma/upr/red/pattern-abnormal-compare.jpg'
...
The most common problem is the ability to respond to end-user requests in a timely AND successful mannor.
...
<img
  ...
  src="{imagePatternNormalPercentile}"
/>
...
<img
  ...
  src="{imagePatternAbnormalCompare}"
/>
