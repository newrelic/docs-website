...
<Callout variant="tip">
Note that both logs-in-context and distributed tracing are enabled by default with our newest <InlinePopup type="apm" /> agents. (If you haven't updated your agents in a while, we recommend regularly [updating your agents](/docs/new-relic-solutions/new-relic-one/install-configure/update-new-relic-agent).)
