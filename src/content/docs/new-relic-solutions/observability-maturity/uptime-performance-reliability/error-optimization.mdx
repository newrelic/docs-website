...
<DoNotTranslate>**Goal:**</DoNotTranslate> Increase the ratio of user journey completions to user sessions. 
...
<DoNotTranslate>**Goal:**</DoNotTranslate> Increase page views
...
<DoNotTranslate>**Goal:**</DoNotTranslate> Increase the number of users accessing your site
...
<DoNotTranslate>**Goal:**</DoNotTranslate> Reduce the error rate across the applications you manage.
...
<DoNotTranslate>**Goal:**</DoNotTranslate> Reduce the mean-time-to-close-issues by reducing the error rate.
...
For step 2 of service creation, choose the <DoNotTranslate>**Success**</DoNotTranslate> SLI.
