...
It only takes a few minutes to set up a workload. See [the workload instructions](/docs/new-relic-solutions/new-relic-one/workloads/workloads-isolate-resolve-alert-events-faster).
