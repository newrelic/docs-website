...
**Best practices** 
Errors occur in both frontend and back-end applications but are typically measured on the front end. [Funnel queries](/docs/query-your-data/nrql-new-relic-query-language/nrql-query-tutorials/funnels-evaluate-data-series-related-events) are popular for measuring conversions, but you can do it even more simply by counting the number of conversions over the total number of sessions for a given time period. 
...
**Best practices** 
Errors occur in both frontend and back-end applications but are typically measured on the front end. Measure the impact of improving errors on user engagement by tracking page views for the frontend applications related to where you're making improvements. 
...
**Best practices** 
Errors occur in both frontend and back-end applications but are typically measured on the front end. Measure the impact of improving errors on user engagement by tracking the number of users accessing your site over a given time period.  If you have not added custom instrumentation to track users you can track sessions instead.
