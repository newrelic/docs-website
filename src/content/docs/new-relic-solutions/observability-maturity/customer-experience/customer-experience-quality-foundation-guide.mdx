...
This <DoNotTranslate>**Quality Foundation**</DoNotTranslate> guide is about creating a standard practice to help you understand your digital customer experience in a meaningful way. This implementation guide will help you:
...
<DoNotTranslate>**Goal:**</DoNotTranslate> Improve uptime and availablity

<DoNotTranslate>**Thresholds:**</DoNotTranslate>
* &lt; 99% warning
* &lt; 95% critical
...
<DoNotTranslate>**Goal:**</DoNotTranslate>
...
LCP thresholds are defined by the team at Google.  The thresholds and the supporting logic behind them can be found on [Google's web.dev site](https://web.dev/defining-core-web-vitals-thresholds/).
  ...
  >
This KPI is part of [core web vitals](https://web.dev/vitals/). It measures how quickly a web page visually responds to user actions like clicks or taps.

<DoNotTranslate>**Goal:**</DoNotTranslate> Reduce INP to 200  milliseconds or better for the 75% percentile for all pages or at least the most critical pages.

<DoNotTranslate>**Thresholds:**</DoNotTranslate>
* Warning: 200 to 500 milliseconds
* Critical: > 500 milliseconds

INP thresholds are defined by the team at Google.  The thresholds and the supporting logic behind them can be found on [Google's web.dev site](https://web.dev/articles/inp).
  </Collapser>
...
<DoNotTranslate>**Goal:**</DoNotTranslate> Maintain a score of 0.1 or less for the 75% percentile for all pages or at least the most critical pages.
...
<DoNotTranslate>**Goal:**</DoNotTranslate> Reduce the time to first byte by improving CDN, network, and service performance.
...
<DoNotTranslate>**Goal:**</DoNotTranslate> Measure and improve AJAX response times.
...
<DoNotTranslate>**Goal:**</DoNotTranslate> Measure and reduce the HTTP error rate to ensure your customers are able to do what they came to your site to do.
...
<DoNotTranslate>**Goals:**</DoNotTranslate>
...
This <DoNotTranslate>**Quality foundation**</DoNotTranslate> guide helps you identify where in your application you need to make improvements that will optimize user retention, conversion, and satisfaction. It's less about where things are and more about where to get to.
...
Review browser apps and pages to make sure that everything you expect to be reporting to New Relic is actually doing so. You can do this by reviewing the <DoNotTranslate>**Page Views**</DoNotTranslate> tab in the browser monitoring UI or running the following query:
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
<DoNotTranslate>**Basic:**</DoNotTranslate> Group by country. Browser events automatically contain the country code of requests, so there is nothing you need to do to break it out further.
...
<DoNotTranslate>**Advanced:**</DoNotTranslate> Add product offering as a custom attribute to browser pages using [custom attributes](/docs/telemetry-data-platform/custom-data/custom-events/report-browser-monitoring-custom-events-attributes).
      </td>
    </tr>
...
<DoNotTranslate>**Best practices to adopt:**</DoNotTranslate>
...
<DoNotTranslate>**Value realization**</DoNotTranslate>
