...
<table>
  ...
  <tr>
   ...
   <td>
   Largest contentful paint measures the difference between the start of page render until the time to paint the largest content element.
