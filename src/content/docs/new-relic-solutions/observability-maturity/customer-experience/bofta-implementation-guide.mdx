...
<table>
  ...
  <tbody>
    <tr>
      <td>
        Bottom of the Funnel Success Rate/Conversion Rate
      </td>

      <td>
        The rate of conversion once a user has gone far enough to demonstrate intent to complete an action to actual completion. Examples of this are rate of:
        <br/>
    ...
    <tr>
      ...
      <td>
        Value of a conversion \* number of pages or interactions in the bottom of the funnel that are slower than the industry threshold.
      </td>
    ...
    <tr>
      ...
      <td>
        Value of a conversion \* number of backend errors in the bottom of the funnel interactions
      </td>
