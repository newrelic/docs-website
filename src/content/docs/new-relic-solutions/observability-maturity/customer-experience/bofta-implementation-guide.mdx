...
This guide helps you use New Relic's observability features to optimize the performance of those elements at the end of your customer journey. It's part of our [series on observability maturity](/docs/new-relic-solutions/observability-maturity/introduction). 
...
You should have: 
* [Pro version of the Browser agent installed on relevant pages](/docs/browser/browser-monitoring/installation/)
