...
![cx-botfa-funnel.png](src/images/cx-botfa-funnel.png 'User journey funnel')
...
![cx-botfa-ecommerce.png](src/images/cx-botfa-ecommerce.png 'Ecommerce bottom of the funnel')
...
![cx-botfa-car_insurance.png](src/images/cx-botfa-car_insurance.png 'Car insurance bottom of the funnel')
...
![cx-botfa-pages-actions.png](src/images/cx-botfa-pages-actions.png 'Distinguish between pages and actions')
...
![cx-botfa-dashboard.png](src/images/cx-botfa-dashboard.png 'Bottom of the Funnel Dashboard')
...
![cx-botfa-kpi-tracking.png](src/images/cx-botfa-kpi-tracking.png 'Bottom of the Funnel KPI Tracking')
