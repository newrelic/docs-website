...
![Digital customer experience](src/images/cx-what-you-can-measure-nr.png 'Digital Customer Experienc-DCX-What you can measure with New Relic')
...
**Thresholds:**
_ Warning `>` 0.5 seconds
_ Critical `>` 1.0 seconds
...
**Thresholds:**
_ Warning `<` 99% of requests are successful
_ Critical `<` 97% of requests are successful
...
![cx_segment_whitelist_investigation](src/images/cx_segment_whitelist_investigation.png 'Segment Allow List (Whitelist) investigation')
...
![cx_qf_dashboard.png](src/images/cx_qf_dashboard.png 'Quality Foundation Dashboard')
...
![cx_qf_kpi_progress.png](src/images/cx_qf_kpi_progress.png 'Quality Foundation KPIs Dashboard')
