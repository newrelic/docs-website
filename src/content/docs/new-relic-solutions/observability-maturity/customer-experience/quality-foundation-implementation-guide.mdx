...
tags:
  ...
  - Quality Foundation
metaDescription: "New Relic's quality foundation guide is to help New Relic customers understand their customers' digital experience in a meaningful way."
redirects:
...
This guide is focused on helping you understand your customers' experience of your digital properties in a meaningful way. It's part of our [series on observability maturity](/docs/new-relic-solutions/observability-maturity/introduction). 
...
**Desired outcome:** Improve customer engagement and retention by measuring and improving performance in a way that better aligns to the end user experience.
...
Not sure whether you need to tune your configuration? Import the [Segment allow-list investigation dashboard](https://github.com/newrelic/oma-resource-center/tree/main/src/content/docs/oma/value-drivers/customer-experience/use-cases/quality-foundation#readme) to help.
