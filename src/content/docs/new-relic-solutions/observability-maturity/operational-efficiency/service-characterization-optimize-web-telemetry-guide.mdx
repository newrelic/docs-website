...
* Which environment a Browser application supports (dev/qa/production)
* The purpose of a Browser application (customer facing, internal facing, website, website component, region if not all regions, etc)
...
<CollapserGroup>
  ...
  Open your web application in Browser. Open the Errors view under the left hand menu and verify that you can see JavaScript errors. If your application doesn't get a lot of traffic you may need to go   
  back 24 hours or longer to see errors.
...
2. Check that your JavaScript errors have event logs.   
...
Follow [these instructions](/docs/browser/new-relic-browser/browser-pro-features/javascript-errors-page-detect-analyze-errors/#stack-trace) to troubleshoot missing stack traces.   
Follow [these instructions](/docs/browser/new-relic-browser/browser-pro-features/upload-source-maps-api/) if you can see stack tracks but can't un-minify them. 
