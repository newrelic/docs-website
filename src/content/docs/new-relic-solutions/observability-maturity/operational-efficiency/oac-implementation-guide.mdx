...
### KPI: Ratio of resources managed though code
...
<CollapserGroup>
    ...
    <Collapser
        id="calculating-kpi"
        title="Calculating the managed resources ratio KPI"
    > 
...
<CollapserGroup>
    <Collapser
        id="calculating-shared-kpi"
        title="Calculating the shared resources KPI"
    > 
...
<CollapserGroup>
    <Collapser
        id="calculating-trigger-kpi"
        title="Calculating the trigger based provisioning KPI"
    > 
...
<CollapserGroup>
    <Collapser
        ...
        title="Calculating the configuration drift KPI"
    > 
