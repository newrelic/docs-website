...
import rolespracticesicon from './images/oma-dg-roles-practices-icon.png'
import baseliningicon from './images/oma-dg-baseline-icon.png'
import optimizingicon from './images/oma-dg-optimizing-icon.png'
import forecastingicon from './images/oma-dg-forecasting-icon.png'
...
<TechTileGrid>
      <TechTile
        name="Establish roles and practices"
        to="/docs/new-relic-solutions/observability-maturity/operational-efficiency/dg-coe"
        icon={<img src={rolespracticesicon} width="100" alt="Roles_and_Practices"/>}
      />
      <TechTile
        name="Baseline your ingest"
      ...
      />
      <TechTile
        name="Optimize your ingest"
        to="/docs/new-relic-solutions/observability-maturity/operational-efficiency/dg-optimizing"
        icon={<img src={optimizingicon} alt="Optimize"/>}
      />
      <TechTile
        name="Forecast future ingest"
        to="/docs/new-relic-solutions/observability-maturity/operational-efficiency/dg-intro"
        icon={<img src={forecastingicon} alt="Forecast"/>}
      />
</TechTileGrid>
