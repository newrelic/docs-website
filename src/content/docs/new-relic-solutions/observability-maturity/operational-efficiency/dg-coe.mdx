...
<img src={<img src={monthlyingestcheckin} alt="Monthly Ingest Checkin!" style={{ height: '66px', width: '75px', verticalAlign: 'middle'}} />} alt="Observability Manger" style={{ height: '66px', width: '75px', verticalAlign: 'middle'}} />
...
<img src={<img src={adhocanomalyicon} alt="Adhoc Anomaly Resolution" style={{ height: '66px', width: '75px', verticalAlign: 'middle'}} />} alt="Observability Manger" style={{ height: '66px', width: '75px', verticalAlign: 'middle'}} />
