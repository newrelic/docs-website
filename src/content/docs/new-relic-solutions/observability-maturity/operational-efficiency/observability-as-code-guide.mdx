...
Why should you use this **Observability as code** guide?
...
The maturity of your observability-as-code deployment can be evaluated in a number of ways. Generally the more resources in an environment that are managed via code, the more mature the deployment. Here are some of the KPIs: 
