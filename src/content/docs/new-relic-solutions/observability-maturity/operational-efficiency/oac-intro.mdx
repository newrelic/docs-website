...
> TODO: Add a KPI here that can track invocations of triggers. How many, and how many actually invoked. Identify redundant triggers

> TODO: Add a KPI for config drift.

## Prerequisites [#prerequisites]
>TODO: TBC

Access to an automation tool
CI/CD tool
Familiarity with platform and grqphQL API's
A tagging and naming convention/strategy
Asset granularity strategy 
Service accounts / permissions model
