...
<CollapserGroup>
  ...
  >
    ...
    **Best practices:**
      ...
      * Service Apdex can provide an effective Service specific quality score (see [Apdex: Measure user satisfaction](https://docs.newrelic.com/docs/apm/new-relic-apm/apdex/apdex-measure-user-satisfaction/)).
...
<CollapserGroup>
  ...
  >
    Average duration of alerting driven incidents in New Relic. See [Alert Quality Management Use Case Implementation Guide](https://docs.newrelic.com/docs/new-relic-solutions/observability-maturity/aqm-implementation-guide/) for more details.
