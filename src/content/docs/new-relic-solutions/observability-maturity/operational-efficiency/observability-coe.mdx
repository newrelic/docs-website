...
This guide focuses on how to create a Center of Excellence around observability best practices. Adopting an Observability Center of Excellence (OCoE) will help you drive standards, speed and scale across your organization, and maximize the return on the investment in observability solutions.

## What is a Center of Excellence? [#coe-definition]

A center of excellence (CoE) is a team of dedicated individuals from multiple functional areas of an organization. They're task is to lead the way in exploring and adopting tools, techniques, and practices for the organization.
...
The OCoE stakeholders are the primary consumers and contributors to the OCoE itself. They are responsible for:
