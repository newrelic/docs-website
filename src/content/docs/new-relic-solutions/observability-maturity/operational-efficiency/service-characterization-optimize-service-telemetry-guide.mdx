...
<DoNotTranslate>**Does the telemetry adequately describe the function and the purpose of my service?**</DoNotTranslate>
...
The name you give a service provides the <DoNotTranslate>**namespace**</DoNotTranslate> (where you will find the agent data). One of the most important strategies New Relic uses to understand the behavior of your services is to aggregate like things together and to use the commonalities derived from aggregation to isolate variance.
...
<DoNotTranslate>**Audience criteria**</DoNotTranslate>
...
<DoNotTranslate>**Codebase criteria**</DoNotTranslate>
...
<DoNotTranslate>**Runtime criteria**</DoNotTranslate>
...
<DoNotTranslate>**What information do I have during the transaction execution that can help me name this transaction?**</DoNotTranslate>
...
* <DoNotTranslate>**Defect detection:**</DoNotTranslate> By encoding a test for an endpoint that produces a simple true/false result, it allows the operations team to isolate discrete failures to determine if the integrity of service delivery has been compromised.
* <DoNotTranslate>**Baselining:**</DoNotTranslate> Synthetic or machine tests provide a predictable set of conditions that allow you to evaluate the consistency of your service delivery from a control perspective.
...
The synthetic test offers a variety of test options, each with its own focus. For more information see our [synthetic monitoring documentation](/docs/synthetics/).

From the perspective of a service developer, the monitor type that is most frequently employed is <DoNotTranslate>**Endpoint availability**</DoNotTranslate>. This monitor type provides the ability to script HTTP request conditions. These can be as simple as a POST or GET to an accessible API, or involve multiple steps where the Selenium monitoring script successively evaluates requests to ascertain functional integrity of a multi-step process.
...
* Recurring: 4 hours per quarter review
