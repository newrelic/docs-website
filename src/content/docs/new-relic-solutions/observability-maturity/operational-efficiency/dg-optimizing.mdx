  ...
  >
    <CollapserGroup>
      ...
      >
        ...
        [Analytics Settings](/docs/mobile-monitoring/new-relic-mobile-android/android-sdk-api/android-agent-configuration-feature-flags.mdx#analytics-settings)
        ...
        It's also possible to configure [agent logging](/docs/mobile-monitoring/new-relic-mobile-android/android-sdk-api/android-agent-configuration-feature-flags.mdx#logging-settings-logging) to be more or less verbose.
