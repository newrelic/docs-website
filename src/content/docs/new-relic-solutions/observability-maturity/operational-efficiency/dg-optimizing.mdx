...
It's recommended to track the plan in a task managing tool you are familiar with. Feel free to use this [Data optimization plan template](https://docs.google.com/spreadsheets/d/1CimLpALwl1Z9f41vzbNWx00bGcED9XPV3s4ROqVEnr0/edit?usp=sharing) This not only helps to manage the optimization plan but also helps understand the effect each optimization task takes.
