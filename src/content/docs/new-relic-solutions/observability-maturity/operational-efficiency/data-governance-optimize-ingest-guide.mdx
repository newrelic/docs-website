...
Answering the following questions will help you develop confidence in your ability to develop and execute optimization plans. You may want to use the [Data ingest baseline](/docs/new-relic-solutions/observability-maturity/operational-efficiency/dg-baselining#install-dashboard) and [Data ingest entity breakdown](/docs/new-relic-solutions/observability-maturity/operational-efficiency/dg-baselining#install-entity-breakdown-dashboard) dashboards from the `Baselining` section. Install those dashboards as described and see how many of these questions you can answer.
