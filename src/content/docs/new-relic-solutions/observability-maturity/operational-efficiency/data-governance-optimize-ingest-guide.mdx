...
Process samples can be the single most high volume source of data from the <InlinePopover type="infrastructure" /> agent.  This is because it will send information about any running process on a host. They're disabled by default but they can be enabled as follows:
