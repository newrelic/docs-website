...
<Callout variant="tip">
Health status configuration options differ between [Standard Workloadss](/docs/new-relic-solutions/new-relic-one/workloads/create-workloads) and [Intelligent Workloadss](/docs/new-relic-solutions/new-relic-one/workloads/workloads-overview#intelligent-workloads).
</Callout>

There are three methods available to configure your health status. Available options vary depending on whether you are using a Standard Workloads or an Intelligent Workloads.
