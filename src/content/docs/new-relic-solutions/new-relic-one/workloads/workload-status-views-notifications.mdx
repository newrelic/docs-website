...
import solutionsWorkloadViews from 'images/solutions_screenshot-crop_workload-views.png'
...
1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities)** and click on **More > Workload views**.
2. Click on Add view.
