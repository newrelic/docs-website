...
<Callout variant="tip">
  This page applies to both [Standard workloads](/docs/new-relic-solutions/new-relic-one/workloads/create-workloads) and [Intelligent workloads](/docs/new-relic-solutions/new-relic-one/workloads/intelligent-workloads). Status values and notifications work the same way for both types.
</Callout>
