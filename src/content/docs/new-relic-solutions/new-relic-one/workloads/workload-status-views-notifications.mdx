...
1. Go to <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DoNotTranslate> and select <DoNotTranslate>**Alerts**</DoNotTranslate>. Select the policy where you want to add the new alert condition, or create a new policy with the appropriate notification channel. Then click on <DoNotTranslate>**Create a condition**</DoNotTranslate>.
