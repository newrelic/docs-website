...
<CollapserGroup>
  ...
  >
    ...
    <figcaption>
      **[one.newrelic.com](https://one.newrelic.com) > Apps > Workloads**: You can add dashboards to a workload.
    </figcaption>
    ...
    3. Click **Add**.
       ...
       <figcaption>
         **[one.newrelic.com](https://one.newrelic.com) > Apps > Workloads**: You can set filters on the dashboards you've linked to a workload.
       </figcaption>
...
1. Go to **[one.newrelic.com](https://one.newrelic.com)**, then select **All capabilities**.
