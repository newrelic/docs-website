...
import dashboardsWorkloadHealthTab from 'images/dashboards_screenshot-full_workload-health-tab.png'

import dashboardsWorkloadActivity from 'images/dashboards_screenshot-full_workload-activity.png'

import dashboardsWorkloadOwnerTab from 'images/dashboards_screenshot-full_workload-owner-tab.png'

import dashboardsCreateWorkload from 'images/dashboards_screenshot-full_create-workload.png'

import dashboardsAddDashboardstoWorkload from 'images/dashboards_screenshot-crop_add-dashboards-to-workload.png'

import dashboardsWorkloadsSaveFilter from 'images/dashboards_screenshot-crop_workloads-save-filter.png'

import dashboardsWorkloadOmnimapOverview from 'images/dashboards_screenshot-crop_workload-omnimap-overview.png'
...
<img
  ...
  src={dashboardsWorkloadHealthTab}
/>
...
<img
  ...
  src={dashboardsWorkloadActivity}
/>
...
<img
  ...
  src={dashboardsWorkloadOwnerTab}
/>
...
<CollapserGroup>
  ...
  >
    ...
    <img
      ...
      src={dashboardsAddDashboardstoWorkload}
    />
    ...
    3. Click **Add**.
       ...
       <img
         ...
         src={dashboardsWorkloadsSaveFilter}
       />

       <figcaption>
         **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Apps > Workloads**: You can set filters on the dashboards you've linked to a workload.
       </figcaption>
...
<img
  ...
  src={dashboardsWorkloadOmnimapOverview}
/>
