...
Before creating Intelligent Workloads, make sure you [enable distributed tracing](/docs/distributed-tracing/enable-configure/quick-start) across your APM services.
