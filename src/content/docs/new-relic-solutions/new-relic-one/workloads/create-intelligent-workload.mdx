...
## Bulk create Intelligent Workloads [#bulk-create]

If you aren't sure where to start identifying high-impact transactions, or if you want to create multiple Intelligent Workloads at once, use the recommendations on the main Workloads page. New Relic automatically surfaces candidate transactions and lets you curate them by:
...
**To bulk create from recommendations:**

1. Go to <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Workloads**</DNT>.
2. Click <DNT>**Review recommendations**</DNT> from the banner at the top of the page.
3. Check the boxes for the recommended transactions you want to monitor, or select <DNT>**All recommendations**</DNT>, then click <DNT>**Create**</DNT>.
4. On the <DNT>**Review and create**</DNT> screen, customize individual workload names and descriptions or keep the pre-populated defaults.
5. Click <DNT>**Confirm**</DNT> to generate them all at once.

## Scope your Intelligent Workload with exclude filters [#exclude-filters]
...
* **Target entity visibility**: Whether to exclude the target entity itself along with its connections (`inclusive: true`), or keep the target entity visible and only prune its further dependencies (`inclusive: false`).
