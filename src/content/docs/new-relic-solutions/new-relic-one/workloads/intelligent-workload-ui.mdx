...
* **Workload P99 Latency**: Tracks the 99th percentile response time for your focal transaction — the latency threshold experienced by your slowest 1% of requests.
* **Workload Success Rate**: Tracks the percentage of successful requests for your focal transaction — a drop in this value directly indicates user-facing errors.
