...
Custom KPIs let you define and monitor business-specific metrics at the workload level, connecting technical performance to business outcomes. Available exclusively for [Intelligent workloads](/docs/new-relic-solutions/new-relic-one/workloads/workloads-overview#intelligent-workloads), KPIs automatically scope to current workload entities and update as membership changes.
