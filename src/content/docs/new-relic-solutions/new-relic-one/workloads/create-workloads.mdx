---
title: 'Create and define Standard workloads'
tags:
  - New Relic
  - Use New Relic
  - Workloads
...
Standard workloads let you manually group related entities using queries, tags, or explicit selection. This doc explains how to create and configure Standard workloads. If you need automatic entity discovery based on distributed traces, see [Intelligent workloads](/docs/new-relic-solutions/new-relic-one/workloads/workloads-overview#intelligent-workloads) instead.
