...
/>
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Workloads > Create a workload:** When you [create a workload](#create), you choose the associated accounts and monitored entities.
</figcaption>
