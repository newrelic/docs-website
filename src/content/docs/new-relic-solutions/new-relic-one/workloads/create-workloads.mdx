...
Want a tutorial on creating a workload? See [Align your teams with workloads](/docs/tutorial-peak-demand/organize-data-workloads).
...
### The account where the workload lives [#workload-account]

The **workload account** is where that workload and its data is stored. For example, a workload might generate [`NrAuditEvent` data](/docs/insights/insights-data-sources/default-data/nrauditevent-event-data-query-examples), and you'd find that data in the workload account. 
