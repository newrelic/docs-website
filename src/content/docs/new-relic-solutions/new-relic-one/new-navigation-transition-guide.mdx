...
Before you dig into making New Relic your own, the first thing we recommend is that you go to **All capabilities**  and click the pin next to "Query your data." This will permanently stick the query builder to the left navigation.  Our new [query builder](/docs/query-your-data/explore-query-data/query-builder/introduction-query-builder/) is an essential piece of the New Relic ecosystem that allows you an easy way to filter, organize, and understand your data. 
