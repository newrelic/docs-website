...
* <DoNotTranslate>**There's more space.**</DoNotTranslate> By clearing away UI from the top and sides, we've given you more space to focus on what matters: your data. You can even collapse the left nav to give yourself even more room.
* <DoNotTranslate>**See what you want to see.**</DoNotTranslate> The left nav is fully customizable so you can jump more quickly to what you use most. Add the tools, views, and features you use the most, and change it as often as you like.
* <DoNotTranslate>**The left nav is stable.**</DoNotTranslate> No matter how often you click around within a capability or a feature, the left nav is a steady and stable place for you to return to in the UI.
* <DoNotTranslate>**Work in the dark.**</DoNotTranslate> Our designers have refined and crafted our dark mode into an elegant experience for those of you who like working in the dark. 
...
Go to <DoNotTranslate>**All capabilities**</DoNotTranslate> to see a catalog of all of our tools, views, and features. Click around to discover and learn more about things you aren't using and to try out new solutions to your problems.
...
In the left nav, go to <DoNotTranslate>**+ Add data**</DoNotTranslate> to see a catalog of hundreds of New Relic-compatible data sources, pre-built dashboards, useful alerting conditions, and other apps and visualizations. If you're using a technology, chances are good we can monitor it for you.
...
Go to [<DoNotTranslate>**All entities**</DoNotTranslate>](/docs/new-relic-solutions/new-relic-one/core-concepts/new-relic-explorer-view-performance-across-apps-services-hosts#find) to see all of your monitored entities in one place. Use this to see everything you're monitoring and dig deep into the details of what's happening.
...
Find your user menu in the bottom left corner of the UI. Use it to invite a teammate to New Relic, set your user preferences, switch to dark mode, manage API keys, and change other settings. To find details about these options, see [Account settings](/docs/accounts/accounts-billing/general-account-settings/intro-account-settings).
