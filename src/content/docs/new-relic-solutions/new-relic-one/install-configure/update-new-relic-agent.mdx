...
<Callout variant="tip">
Occasionally, new features that are released require additional data ingest, like Distributed Tracing and Logs in Context. 

We work hard to ensure that every byte ingested delivers value to you, but there are always ways to adjust your ingest rates. Talk to your account manager or check our [Explorers Hub](https://discuss.newrelic.com) for more information on optimizing your ingest.
</Callout>
