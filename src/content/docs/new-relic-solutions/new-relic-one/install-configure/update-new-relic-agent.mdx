...
[New Relic solutions](https://newrelic.com/instant-observability) include installable agents (for example, APM agents and the infrastructure agent). To ensure you have the best and most up-to-date features, we recommend updating your agents on a regular cadence. We recommend a cadence of monthly or quarterly. 
