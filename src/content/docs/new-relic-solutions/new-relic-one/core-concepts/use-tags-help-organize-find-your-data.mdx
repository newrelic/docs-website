...
<CollapserGroup>
  ...
  >
    ...
    If you're using one of our [cloud integrations](/docs/infrastructure/infrastructure-integrations/get-started/introduction-infrastructure-integrations/#cloud) (AWS, Azure, or Google Cloud Platform), we recommend installing the infrastructure agent on your hosts: this will add cloud environment tags to your monitored host entities in New Relic. 
