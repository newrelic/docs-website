...
1. Go to <DoNotTranslate>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DoNotTranslate> and select a monitored entity, like a monitored app or host.
2. Near the entity's name at the top of the page, click on the <DoNotTranslate>**tags**</DoNotTranslate> button.
3. In the <DoNotTranslate>**Add a new tag...**</DoNotTranslate> field of the tags widget, add a tag with this format: `accountId: 123456789`.
  <img
...
<CollapserGroup>
  ...
  2. Near the condition's name at the top of the form, click <DoNotTranslate>**Manage tags**</DoNotTranslate>.
