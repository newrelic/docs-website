...
Our Insights product, which was a way to query data and create charts and dashboards, has been deprecated and its set of features moved over to be a core part of the [New Relic platform](/docs/new-relic-one/use-new-relic-one/get-started/introduction-new-relic-one/). To learn more about this transition and new features, see the [Insights to New Relic migration guide](/docs/new-relic-one/use-new-relic-one/core-concepts/transition-new-relic-one-insights/).
...
| icon                            | -                                                                                                                  | Not translated to New Relic                             |
| grid_column_count               | -                                                                                                                  | 12 column dashboards by default in New Relic            |
| filter                          | -                                                                                                                  | Not translated to New Relic     yet                     |
...
| presentation.notes                  | -                                | Not translated to New Relic     yet                                                                                                                              |
| layout                              | layout                           |                                                                                                                                                                  |
...
We want to facilitate your migration from the [Insights API](/docs/apis/insights-apis/insights-dashboard-api/) to the new New Relic dashboards API. Find below some examples that illustrate how the old REST endpoints map to the new GraphQL queries or mutations.

### List (GET) -> entitySearch query [#entitysearch]

Our dashboards embrace the concept of entity. They are now another entity in New Relic’s entity ecosystem.
