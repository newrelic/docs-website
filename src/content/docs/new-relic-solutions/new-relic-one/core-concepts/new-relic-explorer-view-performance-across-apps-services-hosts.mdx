...
Access the New Relic Explorer at **[one.newrelic.com](https://one.newrelic.com)** and see together data reported by any [entity](/docs/new-relic-one/use-new-relic-one/core-concepts/what-entity-new-relic) from across all of your New Relic accounts. Entity categories include:
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Explorer**: Use the New Relic Explorer to locate and examine the entities you monitor.
</figcaption>
