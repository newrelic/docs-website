...
Use our entity explorer, and New Relic Lookout and Navigator, to access and give context to the performance data from all your monitored applications, services, hosts, containers, synthetic monitors, and more. You can quickly see the entities related to a problem, exposing possible root causes and what other systems might be affected. Want to try it? [Create a New Relic account](https://newrelic.com/signup) for free, forever!
...
/>
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com)**: When you open New Relic, you land on the **All entities** UI page, which gives you an overview of your monitored entities. From there you can switch to the New Relic Navigator and Lookout views. 
</figcaption>
...
## Explore your entities with the entity explorer [#find]

When you open **[New Relic](https://one.newrelic.com/all-capabilities)**, you'll land on the **All entities** page, also known as the entity explorer. This UI helps you explore all your New Relic-monitored [entities](/docs/new-relic-one/use-new-relic-one/core-concepts/what-entity-new-relic). Entity categories include:
