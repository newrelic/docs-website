...
<figcaption>
  **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Explorer**: Use the New Relic Explorer to locate and examine the entities you monitor.
</figcaption>
