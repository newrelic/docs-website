...
* Lookout in Explorer: A more basic version of Lookout that you can use to explore specific entity types. For example, you can go to **APM and services** and access Lookout, and see data and deviations for those entity types.  
