...
You can select an event type see how the values of its event attributes changed for your entity in the selected time period against the preceding same duration.
