...
These attributes are meant to be synthesized from the telemetry we receive. <DNT>**Do not**</DNT> set them unless you're aware of the implications and consequences.
