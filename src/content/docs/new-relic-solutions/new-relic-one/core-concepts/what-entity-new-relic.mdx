...
### Create relationships manually [#manual-relationships]

You can create additional relationships using [NerdGraph, our GraphQL API](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph/).
...
Find information about fetching relationships in the [relationships API tutorial](/docs/apis/nerdgraph/examples/nerdgraph-relationships-api-tutorial/).
