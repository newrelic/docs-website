...
Entities can have a variety of relationships to each other. The collapser below has a list of relationships to help you understand how entities can be related:
