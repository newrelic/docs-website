...
This expiration time relates to the record of the entity itself, and is **not** related to [telemetry data](/docs/data-apis/understand-data/new-relic-data-types). Put another way: the telemetry data reported by your monitored entities is findable in NRDB and available via NRQL, dependent on its [data retention settings](/docs/telemetry-data-platform/manage-data/manage-data-retention). But the record of the entity itself, one it expires, will no longer exist in New Relic. 
