...
The entity filter is located at the top of many New Relic UI pages. It's visible on the **All entities** view, which is the first thing you see when you [load New Relic](https://one.newrelic.com), and it's visible in our APM UI, our <InlinePopover type="browser" /> UI, our infrastructure UI, and more. 
