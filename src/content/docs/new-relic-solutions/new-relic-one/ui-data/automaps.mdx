...
import omnimapAutomapView from 'omnimapAutomapView'
...
<figcaption>
  Automap opens in the UI when you select a source entity, then select **Explore related entities** from the tooltip.
</figcaption>

## How it works [#how-works]

When you view a service map related to a source entity, you see a three-tiered map of all related entities grouped
...
Automap displays the related entities surrounding a selected source entity. With our new [omnimap](omnimapdoc) capabilities, you can explore between one to three relationships out from a selected source entity. Use our timewarp feature to explore changes between these entities from the last three hours. To understand entities and relationships, as well as how the entity platform synthesizes both from telemetry data, see [entities](/docs/new-relic-one/use-new-relic-one/core-concepts/what-entity-new-relic/) and [relationships](/docs/apis/nerdgraph/examples/nerdgraph-relationships-api-tutorial/).
