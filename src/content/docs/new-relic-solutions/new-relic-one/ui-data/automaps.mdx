...
You can get the automap view of a source entity via **Service maps**  or **Workloads**. To learn more about UI changes in the automap view, check out our omnimap doc [SOMETHING].
...
To view automap around a specific entity, go to **APM & services** in the left pane, then choose an entity. 
