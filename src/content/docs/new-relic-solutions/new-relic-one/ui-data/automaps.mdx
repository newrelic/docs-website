...
You can adjust the relationship depth with automap by selecting how many nodes out from your source entity you'd like to see. For example, in the following screenshot, you can see an automap view with the relationship depth set to **Two**:
...
Compare how automap expands outward from the source entity when the depth is set to **Three**.
...
3. Hover your cursor over your source entity, then click **Map from this entity** in the tooltip. An automap pane will open.
