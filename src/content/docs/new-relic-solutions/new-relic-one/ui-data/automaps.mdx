...
Once you've settled on your desired relationship depth, you can use our timewarp feature to explore changes between these entities from the last three hours. 
