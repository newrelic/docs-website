...
New Relic can take data from your instrumented entities and create topological maps that display the relationships between them. These entity-scoped maps use a source entity as an entry point into the rest of your system, letting you understand how your hosts, services, and applications relate and affect each other.

If you want to view your system from the point of view of your workloads, then check out [SOMETHING](). If you're looking to learn about automap, then read [Automap for troubleshooting entities](/docs/new-relic-solutions/new-relic-one/ui-data/automaps).

## A consistent maps experience [#omni]

With omnimap, we're able to unify disparate map capabilities into a single and consistent experience. Service maps, Workloads maps, and automap share key features and design, like [timewarp](/docs/new-relic-solutions/new-relic-one/ui-data/automaps/#timewarp-cursor), the **Health status** and **Entity types** toggle, and UI elements. 

On the highest layer, New Relic organizes your maps into three overarching tiers, **UX**, **Services**, and **Infrastructure**. Within these tiers are hexagons that represent groupings of related entities. Arrows between these groupings identify calling and called services or applications.
