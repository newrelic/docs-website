...
If you want to see Workloads maps, then check out [SOMETHING](). If you're looking to learn about automap, then read [Automap for troubleshooting entities](/docs/new-relic-solutions/new-relic-one/ui-data/automaps).
