---
title: Display entity relationships with omnimap
...
/>
<figcaption>
Go to **one.newrelic.com**, then select **APM & services**. Choose an entity in the list, then select **Service map** in the new left pane. 
</figcaption>
