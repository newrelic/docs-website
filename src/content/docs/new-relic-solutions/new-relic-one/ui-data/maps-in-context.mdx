...
New Relic can take data from your instrumented entities and create entity-scoped topological maps. Once you've selected an entity—that is, your source entity—maps will draw out a relationship network connecting that source entity to related external hosts and services. These maps can help you diagnose and correct issues.

## Omnimap for a unified maps experience
