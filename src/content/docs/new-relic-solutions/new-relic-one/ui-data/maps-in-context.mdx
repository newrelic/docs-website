...
By updating our maps engine, we've unified certain maps experiences so you have consistency when you're trying to understand complex and often expanding systems. If you're wanting to view your system from the point of view of your workloads, then check out [SOMETHING]. If you're looking to learn about automap, then read [Automap for troubleshooting entities](/docs/new-relic-solutions/new-relic-one/ui-data/automaps).

## A unified maps experience [#omni]

Built on our Galaxy-powered engine, our Omnimap capability unifies our key maps experience so you can explore your related entities without guessing where an issue is in your system architecture. 

Start from a high-level Workloads view, check the number of related entities around a service with Minimap, explore the updated service maps UI, or toggle Automap to drill down on the impact radius of an issue.
