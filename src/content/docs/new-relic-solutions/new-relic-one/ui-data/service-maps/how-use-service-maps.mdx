...
You can view service maps from different parts of **[one.newrelic.com](https://one.newrelic.com)**. Once you select an entity to view, you can select service maps from the sidebar.
