...
To view service maps, from [one.newrelic.com](https://one.newrelic.com) click **APM & services**. Once you select an entity to view, you can select service maps from the sidebar.
