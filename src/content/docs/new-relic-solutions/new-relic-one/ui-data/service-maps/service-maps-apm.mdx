...
redirects:
  ...
  - /docs/new-relic-one/ui-data/service-maps/service-maps-apm
---
...
<Callout variant="important" title="EOL NOTICE">
  After September 30, 2022, we're discontinuing support for several capabilities, including legacy APM service maps. For more details, including how you can easily prepare for this transition, see our [Explorers Hub post](https://discuss.newrelic.com/t/july-2022-end-of-life-announcements/188318).
</Callout>

For more information about the current service maps feature, see [How to use service maps](/docs/new-relic-solutions/new-relic-one/ui-data/service-maps/how-use-service-maps/).
...
<CollapserGroup>
  ...
  >
    ...
    2. From the **App/Service** list, select <img src={customNode}/> **Create custom node**.
    ...
    7. Mouse over the custom node and select the pencil <Icon name="fe-edit-2"/>
       icon.

    8. Select the left (for incoming) or right (for outgoing) arrow <Icon name="fe-arrow-right"/>
       icons.

    9. To add a connection, select the plus <Icon style={{color: '#B9D7B6'}} name="fe-plus-circle"/>
       icon.

    10. To remove a connection, select the minus <Icon style={{color: '#D75968'}} name="fe-minus-circle"/>
        icon.
    ...
    <tr>
      ...
      <td>
        * In pan <Icon name="fe-move"/>
          mode, click and drag.
        * In drag-select <img style={{ width: '22px'}} class="inline" src={smDragSelectToggle0}/> mode, hold the **Alt** key, then click and drag.
      </td>
    </tr>
...
<CollapserGroup>
  ...
  >
    ...
    * Click the drag-select <img style={{ width: '22px'}} class="inline" src={smDragSelectToggle0}/> icon to switch to drag-select mode. Click and drag the mouse to draw a square around the nodes you want to select.
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            Select two or more nodes, then select <img style={{ width: '22px'}} class="inline" src={smGroupingIcon}/> **Create group**.
          </td>
        </tr>
...
<CollapserGroup>
  ...
  >
    You can see health status indicators for most nodes. Except for out-of-process services ([external services](/docs/using-new-relic/welcome-new-relic/get-started/glossary#web-external) or background services), entities use the health status indicators [used by alerts](/docs/alerts/new-relic-alerts-beta/getting-started/alerts-glossary#health-status).
