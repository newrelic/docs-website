...
1. Go to **[one.newrelic.com](https://one.newrelic.com)**, select **Explorer**, and select an entity.
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Explorer > (select an entity) > Dependencies**: View a filterable list of all the apps, services, databases, and hosts connected to an entity, and their color-coded health status.
</figcaption>
