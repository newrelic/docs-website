...
<Callout type="tip">
  <p>You can also create metric normalization rule using [NerdGraph](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph/). For more information, refer to [NerdGraph tutorial: Metric Normalization rules](/docs/apis/nerdgraph/examples/nerdgraph-metric-normalization-rule/).</p>
</Callout>
