...
Metric grouping issues and metric normalization applies only to [metric timeslice data](/docs/data-apis/understand-data/new-relic-data-types/#timeslice-data), which is reported by our APM agents, mobile agents, and browser agent. 
