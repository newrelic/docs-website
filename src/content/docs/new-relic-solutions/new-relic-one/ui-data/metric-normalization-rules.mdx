...
Metric grouping issues and metric normalization applies only to [metric timeslice data](/docs/data-apis/understand-data/new-relic-data-types/#timeslice-data), which is reported by our <InlinePopup type="apm" /> agents, mobile agents, and browser agent. 
