...
You can create and manage new metric normalization rules for an entity using the metric normalization page. 
...
2. Provide the following details:
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>(Required) Enter a [regular expression](https://regexone.com/) pattern that matches the metrics to be normalized. This field must start with a `^` and ends with a `$`. It defines a pattern to identify which metrics should be affected by the normalization rule. For example:
