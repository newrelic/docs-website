...
On the top navigation, most pages have a **Share** button and menu. If you want to ask a question, start a discussion, or share a permalink or screenshot to Slack, click **Share** and then **Start a new discussion**. That comment stays with your data when you comment on a dashboard or an error in New Relic. You don't need to repeat information that can be seen at a glance, and everybody knows where to find an active, solution-oriented conversation.
