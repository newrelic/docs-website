...
The first comment in a thread synced to Slack will be added to the channel selected on New Relic. The Slack post will include an “Open in New Relic” button providing quick navigation to the page and discussion on [newrelic.com](https://one.newrelic.com/all-capabilities).
