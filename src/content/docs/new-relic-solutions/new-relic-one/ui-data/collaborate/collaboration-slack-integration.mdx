...
After a discussion is synced to Slack you won't be able to turn off the sync. This is to ensure that  New Relic and Slack are continuously aligned. This eliminates confusion, fragmented conversations, and lost information. If the sync from New Relic to Slack is turned off that would allow some teammates to continue the discussion on New Relic, and others to continue on Slack. You can, however, start a new discussion on the same page and elect not to sync that new discussion if you wanted to discuss something just on New Relic but not Slack.
