...
metaDescription: >-
  Learn how to instrument segments in your C application so you can monitor them
  with New Relic.
redirects:
...
Once you [instrument a transaction](docs/instrument-transactions-c-agent) using the C SDK, you can instrument [segments](/docs/apm/transactions/intro-transactions/transactions-new-relic-apm#segments) in that [transaction](/docs/apm/transactions/intro-transactions/transactions-new-relic-apm). By instrumenting segments, you can monitor the individual functions and calls inside of a transaction.
