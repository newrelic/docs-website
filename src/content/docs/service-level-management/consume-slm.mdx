...
* At the top nav bar, under <DoNotTranslate>**Service Levels**</DoNotTranslate> in the <DoNotTranslate>**More**</DoNotTranslate> menu (which you can customize). Here you can filter the SLIs by their tags.
...
* <DoNotTranslate>**[Operational](#operations-mode)**</DoNotTranslate>: When in charge of operating a service, use this view to see how the SLO compliance and error budget are trending for the past 2-hour, and 1, 7, and 28-day rolling windows.
* <DoNotTranslate>**[Period over period](#business-mode)**</DoNotTranslate>: For business reviews, retrospectives and prioritization meetings, use this view to compare compliance per calendar week or month.
...
<figcaption>
  <DoNotTranslate>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Service levels**</DoNotTranslate>, and select an SLI.
</figcaption>
...
Where `sli.id` is the SLI identifier. The easiest way to add a chart like this to your dashboard is by using the <DoNotTranslate>**Add to dashboard**</DoNotTranslate> option, available on the <DoNotTranslate>**Details**</DoNotTranslate> view.
