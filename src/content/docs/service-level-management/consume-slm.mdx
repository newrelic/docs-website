...
import slmBadEvents from 'images/slm-bad-events.png'

import slmAutomap from 'images/slm-automap.png'
...
**Note:** Even if you configured your SLI based on good events, we are able to calculate the bad events query so that you can easily find any detractors that might exist.

#### Limitations
There are a few exceptions where we cannot calculate the bad events query:
...
### Automap
With [Automap](https://docs.newrelic.com/docs/new-relic-solutions/new-relic-one/ui-data/automaps/), you can pinpoint when and where an issue began by viewing the relationships around your affected service level.
