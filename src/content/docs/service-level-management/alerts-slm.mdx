...
This alert policy will not trigger any notification, and in case you prefer not to have the entity health based on its error budget consumption, you can easily delete this policy. Although, deleting the policy is permanent and it will affect existing and new service levels for that account.
