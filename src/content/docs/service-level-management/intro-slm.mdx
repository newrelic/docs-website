...
* SLIs can be defined on any NRDB event that is reported to New Relic, not just <InlinePopup type="apm" /> transactions. Therefore you can also base SLIs on your own custom events.
...
Ready to get started? If you don't already have one, [sign up for a free New Relic account](https://newrelic.com/signup). You can find service levels in several places in [our UI](https://one.newrelic.com):
