...
As a New Relic user, you may include planned maintenance windows or non-operational hours in your [service level objective (SLO)](/docs/service-level-management/intro-slm/) calculations, leading to inaccurate representations of service quality. This unfairly penalizes your reliability metrics during expected outages and makes it difficult to focus on genuine service issues.
