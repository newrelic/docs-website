...
* You must be a [full platform user](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type) to fully access our SLM product.
...
* As a [core platform user](/docs/accounts/accounts-billing/new-relic-one-user-management/user-type) you'll be able to access in a read only mode with limited functionality.
