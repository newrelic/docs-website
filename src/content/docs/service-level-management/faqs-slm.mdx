...
To view the queries that define an SLI through the API, use [Nerdgraph](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph/). In order to view the SLI configuration, you'll need to know the GUID of the entity the SLI is attached to, and replace it in the following query:
