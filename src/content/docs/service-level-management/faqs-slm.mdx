...
<Callout title="BETA FEATURE">
  ...
  [beta](/docs/licenses/license-information/referenced-policies/new-relic-pre-release-policy/).
</Callout>
...
![SLI edit menu](src/images/slm_edit_menu_2.png 'SLI edit menu.png')
...
![Add SLI attainment to dashboard](src/images/slm_add_to_dashboard.png 'Add SLI attainment to dashboard.png')
