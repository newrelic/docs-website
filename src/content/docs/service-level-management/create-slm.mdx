...
* You need the "modify/delete events-to-metrics" capability. How you get that role varies depending on your [user model](/docs/accounts/original-accounts-billing/original-users-roles/overview-user-models):
  * Newer user model: [learn more about capabilities.](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts/#capabilities)
...
<CollapserGroup>
  ...
  >
    ...
    * **Entity data**: Base the SLI on standard data coming from our agents. This is the most common option. If this is your choice, select the entity (for example, APM service) you want to use.
  ...
  >
    ...
    * `user_journey` and `application`: These kind of tags help you group the SLIs that apply to the same user experience, whether it's a whole user journey, or just a specific application.
