...
<CollapserGroup>
  ...
  * `user_journey` and `application`: These kind of tags help you group the SLIs that apply to the same user experience, whether it's a whole user journey, or just a specific application.
  ...
  <ImageSizing width="400px" verticalAlign="middle">![Service level tags](./images/sli_tags.png "Service level tags")</ImageSizing>
...
<ImageSizing width="400px" verticalAlign="middle">![Edit SLIs](./images/slm_edit_menu_2.png "Edit SLIs.png")</ImageSizing>
