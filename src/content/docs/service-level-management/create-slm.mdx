...
* In the case of an API, it might simply be a service.
* For the UI, it might be a group of Nerdlets (a Nerdpack) that provide some functionality.
* For the data pipeline, it might be a chain of services necessary to process data end-to-end.
