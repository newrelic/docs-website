...
<Callout variant="important">
  In order to create service levels you need [a role with
  permissions](/docs/accounts/original-accounts-billing/original-users-roles/users-roles-original-user-model/)
  to **modify and delete metric rules**.
</Callout>
...
![SLMs in New Relic One](src/images/slm2_1.png 'SLMs in New Relic One.png')
...
_ `and deviceType = 'Mobile'`
_ `and deviceType = 'Desktop'`
...
![Suggested service levels](src/images/suggested_sli.png 'Suggested service levels')  
...
![Custom service level](src/images/custom_sli.png 'Custom service level')
...
{' '}
<Collapser className="freq-link" id="define-sli" title="Define your SLI">
  Select a short name for your SLI that helps you recognize what it’s measuring.
  Optionally, you may add a description.
</Collapser>
...
![Edit SLIs](src/images/slm_edit_menu.png 'Edit SLIs.png')
