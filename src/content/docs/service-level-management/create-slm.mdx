...
Increasing the granularity of underlying user experiences, another key user experience at New Relic could be: *a customer can use the Dashboards product to visualize their telemetry data.*
