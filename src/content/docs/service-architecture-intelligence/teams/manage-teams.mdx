...
3. Click **Members** and select the member you wish to designate as the manager. 
...
|---|---|---|
| **Change Tracking** | Own the APM entities where deployments are recorded | Deployment Frequency, Change Lead Time |
| **GitHub Integration** | Own the Git repositories associated with your code | Change Lead Time, PR Cycle Time, Open PRs |
| **Entity Mapping** | Assign all relevant entities to your team | MTTR |
