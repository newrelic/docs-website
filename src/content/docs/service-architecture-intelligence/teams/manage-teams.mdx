...
By default, hierarchy levels are labeled as "Level 1," "Level 2," and so on. To better align with your organization’s terminology, you can rename these levels (e.g., "Division," "Department," or "Squad") within the **Hierarchy Settings**.
