   ...
   <Collapser
    ...
    >
      ...
      />
        ...
        />
        You can save UI changes by creating a Saved View, as explained in the [Customize the Team Hub](/docs/service-architecture-intelligence/teams/manage-teams/#customize-team-hub) section.
...
{/* TODO: Mafalda to provide details on manager visibility — users can see who manages a team at each level */}
