...
Scorecards are available only with [Advanced Compute](https://newrelic.com/pricing/compute#pricing_plan-compute). When you use Scorecards, you also get access to the following capabilities:
