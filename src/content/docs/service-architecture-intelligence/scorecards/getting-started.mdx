...
* Create rules, refer [Create scorecard rules](/docs/service-architecture-intelligence/scorecards/managing-scorecards/create-rule).
* Manage rules, refer [Manage rules](/docs/service-architecture-intelligence/scorecards/managing-scorecards/edit-rule). 
