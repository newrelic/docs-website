...
## Access the Scorecards

To access the Scorecards capability go to one.newrelic.com > All Capabilities > Scorecards.
...
* Create rules, refer [Create scorecard rules]().
* Manage rules, refer [Manage rules](). 
