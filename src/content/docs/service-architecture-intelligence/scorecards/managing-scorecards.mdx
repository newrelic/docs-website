...
- Users with the <DNT>**Organization Product Admin**</DNT> role can create, update, and delete Scorecards and rules. If you need to delegate these permissions to other users, you can [create a custom role for Scorecards](/docs/apis/nerdgraph/examples/nerdgraph-scorecards-custom-tutorial)
