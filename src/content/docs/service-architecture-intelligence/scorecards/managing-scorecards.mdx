...
<Callout variant="tip">
To delegate Scorecards write access to users without granting them the Organization Product Admin role, you can [create a custom role for Scorecards](/docs/apis/nerdgraph/examples/nerdgraph-scorecards-custom-tutorial). Ensure that the permissions are scoped to your organization, not to an account.
</Callout>
...
- Users with the <DNT>**Org Product Admin**</DNT> role can create, update, and delete Scorecards and rules. If you need to delegate these permissions to other users, you can [create a custom role for Scorecards](/docs/apis/nerdgraph/examples/nerdgraph-scorecards-custom-tutorial)
