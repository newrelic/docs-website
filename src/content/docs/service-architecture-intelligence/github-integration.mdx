...
1. **Create custom properties in GitHub** (recommended):
   ...
   - The integration will automatically map these relationships during sync
    ...
    <img
        title="GitHub custom property for team ownership"
        alt="Screenshot showing the teamOwningRepo custom property configuration in GitHub organization settings"
        src="/images/github-integration-team-ownership-custom-property.webp"
    />
...
3. **Enable automatic team ownership discovery**:
   ...
   - Verify that ownership relationships are correctly established
    ...
    <img
        title="Team ownership discovery in New Relic"
        alt="Screenshot showing the automatic team ownership discovery settings in New Relic"
        src="/images/github-integration-team-ownership-discovery.webp"
    />
...
3. The **Manage GitHub integration** screen displays your connected organizations with their current sync status and data types.

    <img
        title="GitHub integration management dashboard"
        alt="Screenshot showing the GitHub integration management dashboard with organization list"
        src="/images/github-integration-manage-dashboard.webp"
    />

### Refresh data

The **Refresh data** button replaces the previous on-demand sync functionality, providing a streamlined way to update your GitHub data in New Relic.

**To refresh data:**

1. From the **Manage GitHub integration** screen, locate your organization.

2. Click **Refresh data** next to the organization you want to update.

    <img
        title="GitHub integration refresh data button"
        alt="Screenshot showing the refresh data button next to a GitHub organization in the management interface"
        src="/images/github-integration-refresh-data-button.webp"
    />

**When you click Refresh data, the following happens:**

1. **Data validation**: New Relic validates your current GitHub permissions and organization access
2. **Incremental sync**: The system fetches only new or changed data since the last sync
3. **Data processing**: New Relic processes and maps the updated data according to your selected data types
4. **Status update**: The integration status updates to reflect the latest sync timestamp and data counts
...
When you click **Edit** on an organization, you can:

1. **Modify data selection**: Change which data types to sync (Teams + Users, Repositories + Pull Requests, or Both)
2. **Update permissions**: Adjust GitHub app permissions if needed
3. **Configure sync preferences**: Set up custom sync schedules or preferences
...
- Data sync stops immediately for the selected organization
- All previously synced data (teams, users, repositories, pull requests) remains in New Relic
- GitHub app permissions are revoked for New Relic
- Integration status changes to "Disconnected"
- Organization will no longer appear in your managed integrations list
...
2. On the **Select an action** step, select **Manage your organization**, and click **Continue**.
    ...
    <img
        title="Select manage your organization action"
        alt="Screenshot showing the manage your organization action selection"
        src="/images/github-integration-manage-action.webp"
    />

3. From the **Manage GitHub integration** screen, locate the organization you want to uninstall and click **Uninstall**.

    <img
        title="GitHub organization uninstall button"
        alt="Screenshot showing the uninstall button next to a GitHub organization in the management interface"
        src="/images/github-integration-org-uninstall-button.webp"
    />

4. In the confirmation dialog, review the organization details and click **Uninstall organization** to confirm.

    <img
        title="GitHub integration uninstall confirmation dialog"
        alt="Screenshot showing the uninstall confirmation dialog with organization name and warning message"
        src="/images/github-integration-uninstall-confirmation.webp"
    />

5. You'll see a success message confirming the uninstallation.

    <img
        title="GitHub integration uninstall success message"
        alt="Screenshot showing the successful uninstallation confirmation message"
        src="/images/github-integration-uninstall-success.webp"
    />
