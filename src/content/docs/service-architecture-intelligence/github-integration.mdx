...
* **Teams and Users**: Import GitHub team structures and user information to enhance team management and ownership mapping
  ...
  When fetching teams, we only map users who have a public email in GitHub. Users with private email settings will not be included in the user data import.
  </Callout>
...
3. **Enable automatic team ownership discovery**:
   - After sync completion, enable automatic team ownership discovery in the New Relic UI. For more information, refer to the [Automating Team ownership documentation](https://docs.newrelic.com/docs/service-architecture-intelligence/teams/manage-teams/#assign-ownership).
