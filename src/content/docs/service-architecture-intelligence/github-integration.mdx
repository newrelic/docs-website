...
You can auto-assign GitHub repositories to their teams by creating a `teamOwningRepo` custom property in GitHub. 
...
2. Then, in New Relic Teams, enable the [Automated Ownership](/docs/service-architecture-intelligence/teams/manage-teams/#assign-ownership) feature, making sure to use `teamOwningRepo` as the tag key.
