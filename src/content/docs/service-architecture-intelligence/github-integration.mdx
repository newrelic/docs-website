...
4. *Optional* On the **GitHub integration** screen:
    ...
    - Click **Go to Repositories** to view the imported repositories information on [Repositories](/docs/service-architecture-intelligence/repositories/repositories).
