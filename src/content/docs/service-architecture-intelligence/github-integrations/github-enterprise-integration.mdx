...
For detailed guidance on GitHub App permissions, refer to the [GitHub documentation on setting permissions for GitHub Apps](https://docs.github.com/en/apps/creating-github-apps/setting-up-a-github-app/setting-permissions-for-a-github-app).
...
**✓ Success indicators:**
* GitHub App shows "Installed" status for selected organizations
