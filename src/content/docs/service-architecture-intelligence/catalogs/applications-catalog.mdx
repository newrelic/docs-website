...
The <DNT>Application Catalog</DNT> page has multiple columns to displays various information for an entity:
...
To add additional data to your Applications catalog click the **+ Add Data** button at the top right. Follow the on screen instructions to add data to your Applications catalog.
