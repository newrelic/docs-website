...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td>Environment</td>
            <td>The stage or purpose of the resource in the software lifecycle. For example, `development`, `staging`, or `production`. This helps teams manage stability, testing, and deployment workflows. To populate this column, New Relic looks for the `Environment`, `environment`, or `env` tag on your entities.</td>
        </tr>
    </tbody>
</table>
