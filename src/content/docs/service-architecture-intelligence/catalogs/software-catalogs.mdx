...
metaDescription: Learn how to use the Software Catalog to view and manage your software entities in New Relic.
tags: 
    - catalog
    - software catalog
...
2. Go to the **left navigation pane > Catalogs > Software Catalogs**.
...
To add additional data to your software catalogs click the **+ Add Data** button at the top right. Follow the on screen instructions to add data to your software catalogs.
...
* No support for sorting data in the <DNT>Software Catalog</DNT> page.