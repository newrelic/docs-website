...
- **<DNT>Score</DNT>**: <DNT>Software Catalog</DNT> is integrated with Scorecards to show how your entities are performing against company defined best practices. For more information, refer <DNT>[Scorecards.](/docs/service-architecture-intelligence/scorecards/getting-started)</DNT>
