...
The new Catalogs view replaces the <DNT>All Entities</DNT> capability from the navigation. If you need to find entity types other than the supported entities in the <DNT>Catalog</DNT>, use the <DNT>Quick Find `(cmd + K or ctrl+K)`</DNT> global search, or find them in their corresponding capabilities, such as Infrastructure, Synthetics, Workloads, Service Levels, and more.
