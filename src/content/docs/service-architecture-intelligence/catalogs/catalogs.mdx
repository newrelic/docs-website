...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <ul>
                    <li>Click the columns icon on the right pane and select or deselect the required columns to show or hide.</li>
                    <li>Tag-based (attributes) columns display values as interactive pills. Click any pill to instantly filter the view by that value.</li>
                </ul>
            </td>
        </tr>
        <tr>
            <td>Reorder columns</td>
            <td>Drag and drop any non-fixed column header in the Catalog table to prioritize the information you need most.</td>
        </tr>
    </tbody>
</table>
