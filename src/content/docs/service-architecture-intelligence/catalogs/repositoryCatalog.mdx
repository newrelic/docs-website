...
-  **Centralized Repository Discovery:** Quickly identify repositories relevant to services, projects, or <DNT>[Teams](https://docs-preview.newrelic.com/docs/teams/teams)</DNT>, minimizing the time spent searching or consulting with colleagues.
...
To add additional data to your Repository catalog click the **+ Add GitHub repositories** button at the top right. Follow the on screen instructions to add data to your repositories.
