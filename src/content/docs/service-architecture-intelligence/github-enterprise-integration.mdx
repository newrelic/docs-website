...
- **Collector Service**: A Docker image provided by our team, deployed inside your GHE environment (within your VPN/firewall).
- **Data Flow**: The collector service pulls data from your GHE repositories and pushes it to our public data collection endpoint.
- **Communication**: Our backend cannot directly make API calls to your GHE service. All data is pushed from your environment by the collector service.
