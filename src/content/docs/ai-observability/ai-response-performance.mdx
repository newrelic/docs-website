...
You can toggle the time series graphs to correlate AI behaviors with different metrics. For example, you might want to see if higher token usage correlates with higher response times from your AI. If you've enabled the feedback feature, you can see if negative or positive user feedback trends with response times. Each area of this page is a different vantage point that help you identify possible anomalies. 
