...
When New Relic talks about AI, we're referring to the layer of your environment that has large language model (LLM) at its center. Your front-end service may contain your AI assistant, but underneath this assistant are new APIs, apps, databases, libraries, and orchestration processes. 
...
AI Monitoring directs our APM agents to collect data about payloads delivered through supported AI providers. In this context, a payload encompasses instructions input and output data, metadata, instructions  When you enable AI Monitoring with an APM agent, you can:
