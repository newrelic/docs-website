...
<Callout variant="tip">
  If the application has a web front end in these situations, use [New Relic
  Synthetics](/docs/synthetics/new-relic-synthetics/getting-started/introduction-new-relic-synthetics).
  Synthetics offers non-agent monitoring while still providing the ability to
...
Once you implement the appropriate instrumentation, it is easy to visualize your service level indicators with [dashboards](/docs/query-your-data/explore-query-data/dashboards/introduction-dashboards/). Use the [query builder](/docs/query-your-data/explore-query-data/query-builder/introduction-query-builder/) to [query](/docs/insights/nrql-new-relic-query-language/using-nrql/introduction-nrql) and view all the data that New Relic products gather. For example:
...
1. Use the [query builder](/docs/query-your-data/explore-query-data/query-builder/introduction-query-builder) to create widgets for your dashboards.
...
![Establish objectives](src/images/catalyst-establish-objectives-2.png 'Establish objectives')

<figcaption>
  **[insights.newrelic.com](https://insights.newrelic.com) > (select a
  dashboard):** Query your SLI baseline data, create dashboards with widgets to
  visualize the data, then share with your team and stakeholders.
</figcaption>
