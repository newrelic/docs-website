...
<CollapserGroup>
  ...
  >
    ![The account dropdown, for accessing account settings.](./images/account-dropdown.png "The account dropdown")

    In the upper right of the New Relic UI, the account dropdown gives you access to your [account settings](https://docs.newrelic.com/docs/accounts). 
  ...
  >
    ![The account switcher lets you switch between accounts.](./images/account-switcher.png "The account switcher")
