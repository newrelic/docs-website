...
<CollapserGroup>
  ...
  >
    When you're logged into New Relic, the account dropdown menu displays your login name and is located at the top left of the UI. To switch accounts, click the account switcher dropdown in the top left. 
    
    To access your account settings, click your profile icon in the top right. Clicking this gives you access to various [account-related abilities](/docs/accounts).
  </Collapser>
