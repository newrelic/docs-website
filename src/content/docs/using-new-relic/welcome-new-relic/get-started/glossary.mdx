...
<CollapserGroup>
  ...
  >
    ...
    When you're logged into New Relic, in the top left, use the **All accounts**  dropdown menu to switch accounts. 
  ...
  <Collapser
    ...
    title="Insights"
  >
    At New Relic, [Insights](/docs/insights/newrelic-insights) used to be the primary way to query and chart your New Relic-reported data. Now, we have the improved [query builder](/docs/query-your-data/explore-query-data/query-builder/introduction-query-builder).
  </Collapser>
