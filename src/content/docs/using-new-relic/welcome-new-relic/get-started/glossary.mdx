...
* For customers on our [original pricing plan](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-changes-pricing-user-model/#pricing-plans), Insights Pro is still the product name governing custom event data ingest and retention.  
  ...
  >
    ...
    * Port being used
    ...
    For more information, see [New Relic data types](/docs/telemetry-data-platform/understand-data/new-relic-data-types/).
  </Collapser>
  ...
  >
    A **master account** is a New Relic account that has one or more subordinate accounts (sub-accounts). For details, see [Account structure](/docs/accounts/accounts-billing/new-relic-one-pricing-users/new-relic-account-structure).
  </Collapser>
