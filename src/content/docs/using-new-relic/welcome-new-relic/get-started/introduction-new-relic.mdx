...
2. Follow the steps in our [Add your data](https://one.newrelic.com/launcher/nr1-core.settings?pane=eyJuZXJkbGV0SWQiOiJ0dWNzb24ucGxnLWluc3RydW1lbnQtZXZlcnl0aGluZyJ9) page to get data flowing in. For your first install, we recommend the **Guided install** option to report data with a single command.
