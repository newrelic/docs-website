...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="Python"
  >
    Custom attribute collection is enabled by default in Python. To collect custom attributes, call [`add_custom_parameter`](/docs/agents/python-agent/python-agent-api/add_custom_parameter) for each method that you want to record an attribute.
