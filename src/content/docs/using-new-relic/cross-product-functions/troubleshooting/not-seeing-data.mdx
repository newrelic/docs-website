...
You should start seeing data within a few minutes after installing the agent and generating traffic for your app. If you do not see data, you can use the [New Relic Diagnostics](/docs/agents/manage-apm-agents/troubleshooting/new-relic-diagnostics) utility to automatically identify common issues. For additional troubleshooting tips, see the documentation for your agent.
