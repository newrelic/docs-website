...
Synthetic private minions report to a specific endpoint based on region. Follow the specific procedures for the operating system and the firewall you use to allow the private minion to access the endpoint or the static IP addresses associated with the endpoint. These IP addresses may change in the future.
