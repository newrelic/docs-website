...
**This list is current. Last updated 9 June 2020.**
...
Third-party [ticketing integrations](/docs/using-new-relic/user-interface-functions/share-your-data/ticketing-integrations) and New Relic-generated [webhooks for alert policies](/docs/alerts/new-relic-alerts/managing-notification-channels/notification-channels-controlling-where-send-alerts#webhook) are sent from an IP address in a designated network block for account data in the US or [European Union region](/docs/using-new-relic/welcome-new-relic/get-started/introduction-eu-region-data-center) as appropriate. [TLS is required for all domains.](#tls)
