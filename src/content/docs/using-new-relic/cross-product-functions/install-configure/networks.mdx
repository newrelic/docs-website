  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        * `identity-api.newrelic.com`: required to entity registration (in example, the Host entity).
        * `infrastructure-command-api.newrelic.com`: required to determine feature flags, used for gradual rollout of new capabilities.
        * `log-api.newrelic.com`: required to submit logs in US datacenter. 
        * `log-api.eu.newrelic.com`: required to submit logs in EU datacenter. 
