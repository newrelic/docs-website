...
If your organization uses a firewall that restricts outbound traffic, follow specific procedures for the operating system and the firewall you use to add the following domains to the allow list.
...
Synthetic private minions report to a specific endpoint based on region. Follow specific procedures for the operating system and the firewall you use to allow the private minion to access the endpoint or the static IP addresses associated with the endpoint. These IP addresses may change in the future.
