...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Display complete list of command line options. To list all tasks tTo be run, use `-h tasks`.
        Type: bool
      </td>
    </tr>
