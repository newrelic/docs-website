...
![Example of an SLO](./images/slm1_1.png "Example of an SLO.png")

Please refer to the [Service Level management use case implementation guide](/docs/new-relic-solutions/observability-maturity/uptime-performance-reliability/slm-implementation-guide/) to learn more about identifying service boundaries and deploying the instrumentation that your service levels will be based on.  
...
On top of the SLAs, our new SLM level capability is better aligned with modern service level best practices, such as those promoted by the [Google SRE Handbook](https://sre.google/books/), and provides new, improved functionality: 
...
Ready to get started? If you don't already have one, [sign up for a free New Relic account](https://newrelic.com/signup). You can find Service Levels in several places in [New Relic One](https://one.newrelic.com/):
...
Carry on and read our docs on how to [create](/docs/service-levels-management/create-slm) and [consume](/docs/service-levels-management/consume-slm) SLIs and SLOs. You can also check out how to [manage SLMs with our API](/docs/apis/nerdgraph/examples/nerdgraph-slm/).  
