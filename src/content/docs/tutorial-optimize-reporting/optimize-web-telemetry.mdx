---
title: "Optimize your web telemetry" 
...
Make sure you have the web telemetry you need to detect and resolve poor user experience. This guide will help you do that by showing you how to check that you're getting the right data and that Browser is configured for you to make the most of it. Following the steps in this guide ensures that your team is getting maximum value from New Relic Browser. It ensures you are:   
