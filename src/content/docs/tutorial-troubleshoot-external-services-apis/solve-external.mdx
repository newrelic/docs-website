...
In the map view hover over the problematic API or external service and select <DoNotTranslate>**Show entity preview**</DoNotTranslate>. 
...
Hover over the problematic external service again and this time click <DoNotTranslate>**View traces**</DoNotTranslate>. 
