...
Pathpoint belongs to business observability and maps an organization's customer journey, from the initial interaction with the organization through to the completion of the transaction. 
...
You can set up steps in the traditional sequential manner of step 1, 2 ,3, etc. but also in parallel to represent optional and simultaneous actions and activities.

</Collapser>
<Collapser id="pathpoint-touchpoints" title="Touchpoints">

Touchpoints are the most granular entities of the PathPoint model. They are often a specific APM or Browser application, but you can use any NRQL query as a touchpoint as well.
...
<Callout variant="tip">
    ...
    By default, you will only see the unhealthy touchpoints. To view all touchpoints associated with a Pathpoint, you can click the **view all** option.
