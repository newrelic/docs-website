...
- Upload a new JSON config file
- Download currently active JSON config file
...
This opens a dialog box window. Under **Description**, describe your new JSON configuration file. Next, provide a note and click **From File** to browse the JSON config file.
...
To download a currently active JSON config file:
