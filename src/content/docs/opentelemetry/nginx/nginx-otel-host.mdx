...
```
Expected output: Version information (minimum v1.9.0 required)
...
Create your Collector configuration file (typically `/etc/nrdot-collector/nginx-config.yaml`) and add the below snippet:
