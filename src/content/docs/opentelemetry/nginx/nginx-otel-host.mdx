...
metaDescription: 'Send your NGINX metrics and logs to New Relic using the OpenTelemetry Collector. Complete setup guide with troubleshooting.'
redirects:
...
This integration provides comprehensive NGINX observability:

**Key metrics:**
- Request rates and response times
- Active connections and connection states
- Server throughput and capacity utilization
- Error rates and HTTP status codes

**Optional log data:**
- Access logs with request details
- Error logs for troubleshooting
- Structured log parsing for better analysis

**Benefits:**
- **Proactive monitoring**: Identify issues before they impact users
- **Performance optimization**: Find bottlenecks and capacity constraints
- **Operational insights**: Track usage patterns and plan scaling
- **Industry standard**: Uses open-source OpenTelemetry protocols

<Callout variant="tip">
**Setup time**: ~20 minutes | **Skill level**: Intermediate (requires basic Linux/NGINX knowledge)
</Callout>
