...
<CollapserGroup>
  ...
  <Collapser id="k8s-values-yaml" title="Create values.yaml configuration">
    Create a `values.yaml` file to configure the OpenTelemetry Collector. Update the placeholders for your cluster name, NGINX pod labels, and stub status port.
...
- [Kubernetes observability best practices](https://docs.newrelic.com/docs/kubernetes-pixie/kubernetes-integration/get-started/kubernetes-integration-compatibility-requirements/) - Comprehensive cluster monitoring
