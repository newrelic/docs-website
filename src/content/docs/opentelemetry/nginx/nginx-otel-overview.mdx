...
**For complete metrics and attributes reference:** See [NGINX OpenTelemetry metrics and attributes reference](/docs/opentelemetry/nginx/nginx-otel-metrics-reference/) for detailed descriptions, metric types, and resource attributes for both on-host and Kubernetes deployments.
