...
After setting up your collector:

- [View your collector in the UI](/docs/opentelemetry/collector-observability/collector-observability-ui) - Navigate to the APM UI and explore collector metrics
- [Review configuration examples](/docs/opentelemetry/collector-observability/collector-observability-examples) - See more configuration examples
