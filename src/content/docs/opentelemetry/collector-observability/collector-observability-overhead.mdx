...
- [Configuration examples](/docs/opentelemetry/collector-observability/collector-observability-examples) - See configuration examples and customization options
