...
### Service to AWS Resources [#service-to-aws-resources]

#### Service to AWS Elasticache Memcached Cluster [#service-to-aws-elesticache-memcached-cluster]

Relationships between a service and host entity requires the following:
