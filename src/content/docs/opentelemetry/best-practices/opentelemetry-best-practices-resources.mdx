...
<Callout variant="important">
  ...
  Relationships not currently supported out-of-the-box by instrumentation
  require you to manually emit telemetry to signal to New Relic that a
  relationship should be created. To do so, you must emit a log or a span with
