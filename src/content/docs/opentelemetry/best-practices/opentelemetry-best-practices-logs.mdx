...
* [Direct to collector](https://opentelemetry.io/docs/specs/otel/logs/#direct-to-collector):
    ...
    * Refer to the relevant [OpenTelemetry language documentation](https://opentelemetry.io/docs/languages/) for specific implementation details, and [OpenTelemetry APM monitoring](/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/apm-monitoring/opentelemetry-apm-intro/) for details on monitoring services with New Relic.
