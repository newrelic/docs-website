...
* Get your <InlinePopover type=“license” /> for the New Relic account to which you want to report data. This license key will be used when [configuring the `api-key` header](#api-key).
