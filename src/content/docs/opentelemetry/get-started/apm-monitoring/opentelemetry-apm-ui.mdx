...
**Tip**: Use [entity tags](/docs/new-relic-solutions/new-relic-one/core-concepts/use-tags-help-organize-find-your-data/) in the entity explorer to filter services. Learn more about how entity tags are computed in [OpenTelemetry resources in New Relic](/docs/opentelemetry/best-practices/opentelemetry-best-practices-resources).
