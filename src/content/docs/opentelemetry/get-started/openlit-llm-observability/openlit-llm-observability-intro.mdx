...
Run the following commands to have the OpenTelemetry Protocol (OTLP) exporter send data to the [New Relic OTLP endpoint](/docs/opentelemetry/best-practices/opentelemetry-otlp).
