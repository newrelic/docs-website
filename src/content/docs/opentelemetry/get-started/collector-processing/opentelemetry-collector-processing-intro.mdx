...
<Callout variant="tip">
  For a working example of filtering errors before they reach New Relic, see the [ignored errors example](https://github.com/newrelic/newrelic-opentelemetry-examples/tree/main/other-examples/ignored-errors).
</Callout>
