...
<Callout variant="tip">
  **Using NRDOT Collector?** For NRDOT Collector-specific troubleshooting, refer to the [NRDOT Collector Troubleshooting Guide](https://github.com/newrelic/nrdot-collector-releases/blob/main/distributions/TROUBLESHOOTING.md). The troubleshooting steps below are primarily for OpenTelemetry Collector Contrib users.
</Callout>
