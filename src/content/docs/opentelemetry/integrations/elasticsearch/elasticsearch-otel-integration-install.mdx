...
* **OpenTelemetry Collector** - You must have an OpenTelemetry Collector installed and running on your host to monitor Elasticsearch. There are two supported distributions:
  * **NRDOT (Recommended):** Follow the [official NRDOT installation guide](https://docs.newrelic.com/docs/opentelemetry/nrdot/nrdot-collector/) to set up the collector on your host.
...
<Callout variant="tip">
**Not seeing data?** It may take a few minutes for data to appear. If you don't see metrics after 10 minutes, check our [troubleshooting guide](/docs/infrastructure/host-integrations/host-integrations-list/elasticsearch-otel/troubleshooting).
</Callout>
