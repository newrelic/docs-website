...
| --- | --- | --- |
| **Distributed tracing** (recommended) | End-to-end app-to-Elasticsearch traces **and** an automatic service-to-cluster relationship | Turn on Elasticsearch's built-in tracing, with no per-app changes |
