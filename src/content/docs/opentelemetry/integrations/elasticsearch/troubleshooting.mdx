...
If you have completed the [Elasticsearch OpenTelemetry integration installation](/docs/infrastructure/host-integrations/host-integrations-list/elasticsearch-otel/elasticsearch-otel-integration-install) but don't see data in New Relic, find your issue below and follow the solution steps.
