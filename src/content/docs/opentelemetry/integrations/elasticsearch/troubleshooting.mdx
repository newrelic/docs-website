...
If you have completed [installation and configuration](/docs/opentelemetry/integrations/elasticsearch/introduction) but don't see data in New Relic, find your issue below and follow the solution steps.
