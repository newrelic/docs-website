...
For the step-by-step tracing setup, including the Kubernetes-specific collector config, see [Correlate APM with Elasticsearch using distributed tracing](/docs/opentelemetry/integrations/elasticsearch/distributed-tracing).
