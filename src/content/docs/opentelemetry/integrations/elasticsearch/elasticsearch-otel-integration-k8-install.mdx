...
<Callout variant="important">
Make sure the `elasticsearch.cluster.name` set in `resource/cluster_name_override` matches the `cluster.name` configured in Elasticsearch, and that it's unique within your New Relic account.
</Callout>
