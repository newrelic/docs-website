...
## How your data is organized [#resource-attributes]
...
1. **[Install the integration](/docs/opentelemetry/integrations/elasticsearch/elasticsearch-otel-integration-install)** - Follow the step-by-step setup guide.
...
4. **Explore related integrations** - Consider monitoring your application stack with other [OpenTelemetry integrations](/docs/opentelemetry/get-started/opentelemetry-get-started-intro).