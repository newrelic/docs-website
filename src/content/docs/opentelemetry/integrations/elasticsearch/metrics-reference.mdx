...
- **[Introduction and install paths](/docs/opentelemetry/integrations/elasticsearch/introduction)** - Choose the self-hosted or Kubernetes configuration that matches your environment
