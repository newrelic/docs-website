...
redirects:
  - /docs/opentelemetry/integrations/docker-monitoring/troubleshooting
---
...
- **Get back to setup**: Return to the [Docker monitoring setup guide](/docs/opentelemetry/integrations/docker/install-configure) to complete your configuration
- **Explore your data**: Learn how to query and visualize your Docker metrics with the [metrics reference guide](/docs/opentelemetry/integrations/docker/metrics-reference)
