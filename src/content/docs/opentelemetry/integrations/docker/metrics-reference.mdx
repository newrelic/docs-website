...
redirects:
  - /docs/opentelemetry/integrations/docker-monitoring/metrics-reference
---
...
- [Set up monitoring](/docs/opentelemetry/integrations/docker/introduction#choose) - Configure Docker monitoring if you haven't already
