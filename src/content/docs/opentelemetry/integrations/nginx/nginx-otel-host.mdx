...
1. Add this configuration to your NGINX config file (`/etc/nginx/nginx.conf`):
...
<CollapserGroup>
  <Collapser id="step5-configure-nginx-logs-nrdot" title="Configure structured logging in NGINX">
  ...
  <Collapser id="step5-configure-collector-logs-nrdot" title="Configure the Collector for log forwarding">
  ...
  <Collapser id="step5-permissions-apply-nrdot" title="Set permissions and apply configuration">
