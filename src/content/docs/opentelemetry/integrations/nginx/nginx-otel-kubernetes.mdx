      ...
      receiver_creator/nginx:
        ...
        receivers:
          nginx:
            ...
            config:
              endpoint: 'http://`endpoint`:<PORT>/basic_status'  # Update port and path as needed
              metrics:
                nginx.requests:
                  enabled: true
            ...
            resource_attributes:
              nginx.server.endpoint: 'http://`endpoint`:<PORT>/basic_status'  # Update port and path as needed
              nginx.port: '<PORT>'  # Update to match your configuration
