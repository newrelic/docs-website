...
3. Apply the updated manifests and restart the deployment.
  ...
  <Collapser id="nrdot-k8s-helm-install" title="Helm install">
    ...
    Update your [`values.yaml`](https://github.com/newrelic/helm-charts/blob/5cfdda9d64dc26c289438554a23665434d4d584b/charts/nr-k8s-otel-collector/values.yaml) for the `nr-k8s-otel-collector` Helm chart with the following changes:

    1. Update the [collector image repository](https://github.com/newrelic/helm-charts/blob/5cfdda9d64dc26c289438554a23665434d4d584b/charts/nr-k8s-otel-collector/values.yaml#L90) and [tag](https://github.com/newrelic/helm-charts/blob/5cfdda9d64dc26c289438554a23665434d4d584b/charts/nr-k8s-otel-collector/values.yaml#L91) to use NRDOT:
    ...
    2. Add the following sections under [`deployment.extraConfig`](https://github.com/newrelic/helm-charts/blob/5cfdda9d64dc26c289438554a23665434d4d584b/charts/nr-k8s-otel-collector/values.yaml#L259):
    ...
    3. Apply the updated values to your running Helm release:
    ...
    For the base Helm installation steps, see [Kubernetes OpenTelemetry helm installation](/docs/kubernetes-pixie/k8s-otel/install/#helm-install).
