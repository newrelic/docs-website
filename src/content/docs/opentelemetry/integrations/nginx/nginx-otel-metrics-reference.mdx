...
**Setup guides:**
- [Monitor NGINX on self-hosted environments](/docs/opentelemetry/nginx/nginx-otel-host/) - Complete setup for on-host deployments
- [Monitor NGINX on Kubernetes](/docs/opentelemetry/nginx/nginx-otel-kubernetes/) - Complete setup for Kubernetes deployments

**Data usage:**
- [Find and query your NGINX data](/docs/opentelemetry/nginx/find-and-query-your-data/) - Dashboards, NRQL queries, and alerts
