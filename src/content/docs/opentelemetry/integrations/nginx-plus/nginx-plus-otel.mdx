...
<CollapserGroup>
  ...
  <Collapser id="step1-config-collector-nrdot" title="Step 1: Configure collector configuration">
    ...
    resource/nginx:
      attributes:
        - key: nginx.server.endpoint
          value: "<NGINX_API_STATUS_ENDPOINT>"  # Replace with your endpoint
          action: insert
...
<tbody>
  ...
  <tr>
    <td>`NGINX_API_STATUS_ENDPOINT`</td>
    <td>Enter your NGINX_API_STATUS_ENDPOINT (for example http:/127.0.0.1/api/9)</td>
  </tr>
</tbody>
</table>
  ...
  <Collapser id="step2-enable-additional-metrics-nrdot" title="Step 2: (Optional) Enable additional metrics">
...
<CollapserGroup>
  ...
  <Collapser id="step2-config-collector-otelcol" title="Step 1: Configure collector configuration">
...
<tbody>
  ...
  <Collapser id="step2-enable-additional-metrics-otelcol" title="Step 2: (Optional) Enable additional metrics">
