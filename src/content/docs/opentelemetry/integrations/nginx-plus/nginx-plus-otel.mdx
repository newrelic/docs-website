...
<tbody>
  <tr>
    <td>`<YOUR_PROMETHEUS_EXPORTER_ENDPOINT>`</td>
    <td>Replace with the prometheus exporter endpoint (for example '127.0.0.1:9113')</td>
  </tr>
  <tr>
    <td>`<YOUR_API_STATUS_ENDPOINT>`</td>
    <td>Replace with the api status endpoint of the NGINX Plus server (for example http:/127.0.0.1/api/9)</td>
  </tr>
  <tr>
