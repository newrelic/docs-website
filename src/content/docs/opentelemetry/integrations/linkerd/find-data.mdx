...
- [Linkerd metrics reference](/docs/opentelemetry/integrations/linkerd/metrics-reference/): full list of metrics and resource attributes
- [Introduction to Linkerd monitoring with OpenTelemetry](/docs/opentelemetry/integrations/linkerd/introduction/): back to the introduction
