...
<Callout variant="important">
  Ready to implement? Continue to [Monitor Linkerd on Kubernetes with OpenTelemetry](/docs/opentelemetry/integrations/linkerd/linkerd-otel-kubernetes/) to choose between the NRDOT collector and OTel Collector Contrib.
</Callout>
...
- [Monitor Linkerd on Kubernetes with OpenTelemetry](/docs/opentelemetry/integrations/linkerd/linkerd-otel-kubernetes/) - Complete step-by-step instructions for configuration, setup, and troubleshooting
