...
- **Metrics reference**: See the complete [Redis OpenTelemetry metrics reference](/docs/opentelemetry/integrations/redis/metrics-reference/) for all available metrics and their descriptions
