...
redirects:
  - /docs/opentelemetry/integrations/redis/self-hosted
...
* An OpenTelemetry Collector installed on that host — the NRDOT collector, the OpenTelemetry Collector Contrib, or either one running the Prometheus receiver — which you choose in [Installation options](#installation-options)
