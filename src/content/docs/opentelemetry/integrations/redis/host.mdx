...
* A collector distribution — the NRDOT collector, the OpenTelemetry Collector Contrib, or the Prometheus receiver — which you choose in [Installation options](#installation-options)

Each path's setup steps cover any additional installation you need, such as the [NRDOT collector](/docs/opentelemetry/nrdot/nrdot-collector/), `otelcol-contrib`, or the [redis_exporter](https://github.com/oliver006/redis_exporter).
