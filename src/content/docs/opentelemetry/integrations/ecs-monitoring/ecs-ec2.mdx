...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Interval to collect metrics from ECS container and host metrics endpoints (default: 60 seconds)
      </td>
    </tr>
    <tr>
      <td>
