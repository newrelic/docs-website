...
- Verify data in New Relic UI: Navigate to <DNT>**[one.newrelic.com](https://one.newrelic.com) > All Capabilities > Infrastructure**</DNT> to confirm your ECS containers appear with metrics. For detailed guidance on exploring your data, see [Find and query your ECS monitoring data](/docs/opentelemetry/integrations/ecs-monitoring/find-and-query-your-data).
...
- [Correlate ECS metrics with application traces and logs](/docs/opentelemetry/integrations/ecs-monitoring/overview#how-it-works)