...
2. Verify in New Relic: Navigate to **[one.newrelic.com](https://one.newrelic.com) > All Capabilities > Infrastructure** and look for your ECS containers section to ensure data is being collected  and displayed correctly.
