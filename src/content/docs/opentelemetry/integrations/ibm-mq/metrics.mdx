...
This reference covers the IBM MQ metrics and attributes collected via OpenTelemetry: the metrics the [mq-metric-samples](https://github.com/ibm-messaging/mq-metric-samples) exporter publishes and the collector forwards to New Relic. It applies to both the [Linux host](/docs/opentelemetry/integrations/ibm-mq/ibm-mq-otel-host) and [Kubernetes](/docs/opentelemetry/integrations/ibm-mq/ibm-mq-otel-kubernetes) deployments — the metric shape is identical.
...
**Setup guides:**
- [Monitor self-hosted IBM MQ](/docs/opentelemetry/integrations/ibm-mq/ibm-mq-otel-host) — Linux host setup
- [Monitor IBM MQ on Kubernetes](/docs/opentelemetry/integrations/ibm-mq/ibm-mq-otel-kubernetes) — Kubernetes setup

**Data usage:**
- [Find and query your data](/docs/opentelemetry/integrations/ibm-mq/find-and-query-your-data) — dashboards, NRQL queries, and alerts

**Technical reference:**
- [mq-metric-samples](https://github.com/ibm-messaging/mq-metric-samples) — the IBM MQ Prometheus exporter
