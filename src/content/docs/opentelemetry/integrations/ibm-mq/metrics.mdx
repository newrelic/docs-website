...
<CollapserGroup>
  ...
  <Collapser id="metrics-qmgr-status" title="Queue manager health and status">
...
<Collapser id="metrics-qmgr-resources" title="Queue manager resources (CPU, memory, log, file system)">
...
<Collapser id="metrics-queue-state" title="Queue depth, age, and handles">
...
<Collapser id="metrics-queue-throughputl" title="Queue throughput and timing (MQI)">
...
<Collapser id="metrics-channel" title="Channel metrics">
...
<Collapser id="metrics-qmgr-mqi" title="Queue manager MQI activity and errors">
...
<Collapser id="status-codes" title="MQ status-code reference">
...
<Collapser id="common-attributes" title="Common attributes">
...
<Collapser id="on-host-attributes" title="On-host deployment attributes">
...
<Collapser id="kubernetes-attributes" title="Kubernetes deployment attributes">
