...
For information on your OTLP endpoint, refer to [New Relic OTLP endpoint](/docs/opentelemetry/best-practices/opentelemetry-otlp).
...
- Verify your license key is correct and the OTLP endpoint is configured correctly. For more information, refer to [New Relic OTLP endpoint](/docs/opentelemetry/best-practices/opentelemetry-otlp).
...
- Verify the endpoint is set correctly. For more information, refer to [New Relic OTLP endpoint](/docs/opentelemetry/best-practices/opentelemetry-otlp).
