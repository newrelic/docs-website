...
2. Filter by `provider=opentelemetry` and click on the account row where you instrumented Kafka to view your data
...
2. Select <DNT>**Kafka (OpenTelemetry)**</DNT> > <DNT>**OTel Kafka Dashboard**</DNT>
...
2. Search for <DNT>**"OTel Kafka Dashboard"**</DNT>
