...
The following diagram illustrates how the OpenTelemetry Java Agent on each Kafka broker pushes JMX metrics to the collector, while the collector also scrapes cluster-level metrics and forwards everything to New Relic.
