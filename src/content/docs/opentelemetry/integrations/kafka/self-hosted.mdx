...
### Create collector configuration [#collector-config-prometheus]
...
<CollapserGroup>
  <Collapser
    id="configuration-notes-prometheus"
    title="Configuration notes"
  >
    **Architecture highlights:**
  ...
  <Collapser
    id="additional-receiver-docs-prometheus"
    title="Additional receiver documentation"
  >
...
### Set environment variables [#env-vars-prometheus]
...
### Install and start the collector [#install-start-collector-prometheus]

Install and run the collector on the monitoring host. Choose between NRDOT Collector (New Relic's distribution) or OpenTelemetry Collector:

<Tabs>
  <TabsBar>
    <TabsBarItem id="nrdot-prom">NRDOT Collector</TabsBarItem>
    <TabsBarItem id="otel-prom">OpenTelemetry Collector</TabsBarItem>
  </TabsBar>
