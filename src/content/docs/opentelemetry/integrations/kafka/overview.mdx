...
New Relic's supported distribution of OpenTelemetry Collector that includes:
- Direct technical support from New Relic
- Tested compatibility with New Relic platform
- Optimized performance and reliability
- Download from [NRDOT Collector releases](https://github.com/newrelic/nrdot-collector-releases/releases)
...
The upstream community distribution that provides:
- Latest OpenTelemetry features and updates
- Community-driven development and support
- Full compatibility with New Relic platform
- Download from [OpenTelemetry Collector releases](https://github.com/open-telemetry/opentelemetry-collector-releases/releases)
...
- [Kafka metrics receiver](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/main/receiver/kafkametricsreceiver) - Connects to your Kafka cluster to monitor overall health, including consumer lag, topic metrics, and partition status
- [OpenTelemetry Java Agent](https://github.com/open-telemetry/opentelemetry-java-instrumentation) - Runs alongside each Kafka broker to collect detailed JVM performance metrics and operational data, then sends this information to the collector
- [OTLP receiver](https://github.com/open-telemetry/opentelemetry-collector/tree/main/receiver/otlpreceiver) - Receives and processes the detailed broker metrics from the Java Agent
