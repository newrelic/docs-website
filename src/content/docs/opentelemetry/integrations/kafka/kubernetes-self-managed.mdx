...
<tbody>
  <tr>
    <td>`order-process-service`</td>
    <td>Replace with a unique name for your producer or consumer application</td>
  </tr>
  <tr>
    <td>`my-kafka-cluster`</td>
    <td>Replace with the same cluster name used in your broker configuration</td>
  </tr>
  <tr>
    <td>`otel-collector.newrelic.svc.cluster.local`</td>
    <td>Replace with the actual DNS name of your collector service (`<service-name>.<namespace>.svc.cluster.local`)</td>
  </tr>
</tbody>
</table>
...
<Tabs>
  <TabsBar>
    <TabsBarItem id="helm-prom">Helm install (recommended)</TabsBarItem>
    <TabsBarItem id="manifest-prom">Manifest install</TabsBarItem>
  </TabsBar>
...
<CollapserGroup>
  <Collapser
    id="manifest-secret-us-prometheus"
    title="US region"
  >
    ```bash
    kubectl create secret generic newrelic-otlp-secret \
  ...
  <Collapser
    id="manifest-secret-eu-prometheus"
    title="EU region"
  >
    ```bash
    kubectl create secret generic newrelic-otlp-secret \
  ...
  <Collapser
    id="manifest-secret-jp-prometheus"
    title="JP region"
  >
    ```bash
    kubectl create secret generic newrelic-otlp-secret \
