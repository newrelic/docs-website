...
New Relic supports two approaches for monitoring self-managed Kubernetes Kafka: using the OpenTelemetry Java Agent or the Prometheus JMX Exporter. The following diagrams illustrate the data flow for each approach.
