...
<Tabs>
  ...
  <TabsPages>
    <TabsPageItem id="nrdot">
      ...
      # NRDOT Collector Binary (version 1.9.0 for linux_amd64)
      # For latest version and other architectures, visit:
      # https://github.com/newrelic/nrdot-collector-releases/releases/latest
      ADD "https://github.com/newrelic/nrdot-collector-releases/releases/download/1.9.0/nrdot-collector_1.9.0_linux_amd64.tar.gz" /nrdotcol
