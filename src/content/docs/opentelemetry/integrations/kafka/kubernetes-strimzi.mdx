...
#### 2.1 Create JMX metrics ConfigMap
...
#### 2.2 Update Kafka cluster to use JMX Exporter
...
#### 3.1 Create New Relic credentials secret
...
#### 3.2 Create values.yaml with collector configuration
...
#### 3.3 Install OpenTelemetry Collector with Helm
