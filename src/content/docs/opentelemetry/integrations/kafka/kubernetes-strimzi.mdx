...
<Tabs>
  <TabsBar>
    <TabsBarItem id="nrdot-build">NRDOT Collector</TabsBarItem>
    <TabsBarItem id="otel-build">OpenTelemetry Collector</TabsBarItem>
  </TabsBar>

  <TabsPages>
    <TabsPageItem id="nrdot-build">
      ```bash
      docker build -t your-registry/nrdot-collector-kafka:latest .
      docker push your-registry/nrdot-collector-kafka:latest
      ```
    </TabsPageItem>

    <TabsPageItem id="otel-build">
      ```bash
