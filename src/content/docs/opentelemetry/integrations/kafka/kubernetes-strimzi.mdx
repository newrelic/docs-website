...
* Increase `collection_interval` in the JMX receiver
* Adjust batch processor settings
* Consider using a DaemonSet for distributed collection across nodes
...
* **Scale the collector**: Consider using a DaemonSet or increasing replicas for high-volume clusters
