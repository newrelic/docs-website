...
The following diagram illustrates how the OpenTelemetry Collector is deployed in Kubernetes to automatically discover Strimzi-managed Kafka broker pods and forward metrics to New Relic.
