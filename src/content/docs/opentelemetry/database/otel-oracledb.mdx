...
## Custom SQL queries [#custom-queries]

Want to monitor custom metrics beyond the built-in Oracle database metrics? Use the SQL Query Receiver capability to run any custom SQL query against your Oracle database and ingest the results as metrics into New Relic.

For complete setup instructions and examples, see [SQL Query Receiver](/docs/opentelemetry/database/capabilities/sql-query-receiver/).
