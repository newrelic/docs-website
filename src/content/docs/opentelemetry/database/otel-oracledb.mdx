...
New Relic now empowers your team to monitor your Oracle Database performance using New Relic Distribution of OpenTelemetry (NRDOT) with New Relic's database monitoring capabilities. This integration provides comprehensive insights into database metrics, query performance, and system health using the NRDOT collector.
...
<Steps>
  ...
  <Step>
    ...
    1. Run the following statement as SYS before creating the user or running any grants.
        ...
        ```
    2. Please run the following statements as SYS inside your target PDB to create a local monitoring user.
        ```sql
