---
title: "MSSQL NRDOT monitoring compatibility and prerequisites"
tags:
  - OpenTelemetry
  - NRDOT
  - SQL Server
...
2. **Review available metrics**: [Understand what data will be collected →](/docs/opentelemetry/database/mssql/mssql-nrdot-metrics)