...
**Host Metrics + Database Monitoring**
...
<CollapserGroup>
  <Collapser
    id="database-monitoring-collapse"
    title="Database monitoring collapse"
  >
...
<CollapserGroup>
  <Collapser
    id="database-monitoring-collapse-gmsa"
    title="Database monitoring collapse"
  >
