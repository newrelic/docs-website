...
<CollapserGroup>
  <Collapser
    id="full-config-sql"
    title="All Capabilities (Recommended)"
  >

This configuration enables comprehensive database monitoring with all available metrics for complete SQL Server performance visibility.
...
<AgentConfig
  inputOptions={[
    ...
    },
    {
      ...
      toolTip: 'Enter your New Relic OTLP endpoint (e.g., https://otlp.nr-data.net:4318)',
    },
    {
      name: 'licenseKey',
