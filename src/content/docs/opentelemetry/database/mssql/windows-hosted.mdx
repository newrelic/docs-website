...
2. Add your environment-specific values to the following configuration and copy it to the `mssql-config.yaml` file created in the previous step:
  ...
  <Callout variant="tip" title="full configuration">
    This configuration focuses on essential database monitoring for your SQL Server environment. To enable comprehensive monitoring with all available metrics, refer to the [configuration reference](/docs/opentelemetry/database/mssql/config-reference/#hosted-sql).
  </Callout>
...
2. Add the following configuration to the `mssql-config.yaml` file created in the previous step:
  ...
  <Callout variant="tip" title="full configuration">
    This configuration focuses on essential database monitoring for your Windows SQL Server environment. To enable comprehensive monitoring with all available metrics, refer to the [configuration reference](/docs/opentelemetry/database/mssql/config-reference/#hosted-domain).
  </Callout>
...
<Callout variant="tip">
  This configuration focuses on essential database monitoring for your Windows authentication environment. To enable comprehensive monitoring with all available metrics, refer to the [configuration reference](/docs/opentelemetry/database/mssql/config-reference/#hosted-gmsa).
</Callout>
...
2. Add the following configuration to the `mssql-config.yaml` file created in the previous step:
  ...
  <Callout variant="tip" title="full configuration">
    This configuration focuses on essential database monitoring for your Windows SQL Server environment. To enable comprehensive monitoring with all available metrics, refer to the [configuration reference](/docs/opentelemetry/database/mssql/config-reference/#hosted-gmsa).
  </Callout>
