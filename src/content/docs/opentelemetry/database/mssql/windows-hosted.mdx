...
<AgentConfig
  inputOptions={[
    ...
    },
    {
      ...
      toolTip: 'Enter your New Relic OTLP endpoint. For more information, refer to [New Relic OTLP endpoints documentation](/docs/opentelemetry/best-practices/opentelemetry-otlp/)',
    },
    {
      name: 'licenseKey',
...
<Callout variant="tip">
**Note:** If you enable all available metrics, increase the `limit_mib` value (for example, 1000) to prevent the memory limiter from dropping data.
</Callout>
...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="Host Metrics + Database Monitoring"
  >
