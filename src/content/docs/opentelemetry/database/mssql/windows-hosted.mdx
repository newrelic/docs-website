...
<AgentConfig
  inputOptions={[
    ...
    },
    {
      ...
      toolTip: 'Enter your New Relic OTLP endpoint (e.g., https://otlp.nr-data.net:4318). For more information, refer to /docs/opentelemetry/best-practices/opentelemetry-otlp/',
    },
    {
      name: 'licenseKey',
...
<AgentConfig
  inputOptions={[
    ...
    },
    {
      ...
      toolTip: 'Enter your New Relic OTLP endpoint (e.g., https://otlp.nr-data.net or https://otlp.eu01.nr-data.net). For more information, refer to /docs/opentelemetry/best-practices/opentelemetry-otlp/',
    },
    {
      name: 'licenseKey',
      label: 'New Relic License Key',
...
- `<YOUR_NEWRELIC_OTLP_ENDPOINT>`: Your New Relic OTLP endpoint (e.g., https://otlp.nr-data.net). For more information, refer to [New Relic OTLP endpoints documentation](/docs/opentelemetry/best-practices/opentelemetry-otlp/)
