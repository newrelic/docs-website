...
<AgentConfig
  inputOptions={[
    ...
    },
    {
      ...
      toolTip: 'Enter your New Relic OTLP endpoint (e.g., https://otlp.nr-data.net:4318 or https://otlp.eu01.nr-data.net:4318). For more information, refer to /docs/opentelemetry/best-practices/opentelemetry-otlp/',
    },
    {
      name: 'licenseKey',
