...
<Callout variant="tip">
  Your RDS endpoint will be in the format: `your-db-instance.xxxxxxxxxxxx.region.rds.amazonaws.com`. Find this in your AWS RDS Console under "Connectivity & security".
</Callout>
...
<Callout variant="tip">
  Your RDS endpoint uses the format: `YOUR_DB_INSTANCE.YOUR_AWS_IDENTIFIER.YOUR_REGION.rds.amazonaws.com` (for example, `mydb-instance.c9akciq32.us-east-1.rds.amazonaws.com`). Locate this in the AWS RDS console under Connectivity & security.
</Callout>
