...
Set up Microsoft SQL Server monitoring using the NRDOT Collector on Windows environments to monitor AWS RDS for SQL Server instances. To monitor in a self-hosted environment, refer to [Windows self-hosted instrumentation](/docs/opentelemetry/database/mssql/windows-hosted).
...
## Create gMSA monitoring user [#create-user]
