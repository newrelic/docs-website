...
Once you've downloaded or pasted the full configuration into your `mssql-config.yaml` file, follow the [Linux self-hosted guide](/docs/opentelemetry/database/mssql/linux-hosted) to complete the setup.
...
Once you've downloaded or pasted the full configuration into your `mssql-config.yaml` file, follow the [Linux RDS guide](/docs/opentelemetry/database/mssql/linux-rds) to complete the setup.
...
Once you've downloaded or pasted the full configuration into your `mssql-config.yaml` file, follow the [Windows self-hosted guide](/docs/opentelemetry/database/mssql/windows-hosted/#sql) to complete the setup using SQL Server authentication method.
...
Once you've downloaded or pasted the full configuration into your `mssql-config.yaml` file, follow the [Windows self-hosted guide](/docs/opentelemetry/database/mssql/windows-hosted/#auth) to complete the setup using Windows authentication method.
...
Once you've downloaded or pasted the full configuration into your `mssql-config.yaml` file, follow the [Windows self-hosted guide](/docs/opentelemetry/database/mssql/windows-hosted/#gmsa) to complete the setup using gMSA authentication method.
...
Once you've downloaded or pasted the full configuration into your `mssql-config.yaml` file, follow the [Windows RDS guide](/docs/opentelemetry/database/mssql/windows-rds/#sql) to complete the setup using SQL Server authentication method.
...
Once you've downloaded or pasted the full configuration into your `mssql-config.yaml` file, follow the [Windows RDS guide](/docs/opentelemetry/database/mssql/windows-rds/#domain) to complete the setup using Windows authentication method.
...
Once you've downloaded or pasted the full configuration into your `mssql-config.yaml` file, follow the [Windows RDS guide](/docs/opentelemetry/database/mssql/windows-rds/#gmsa) to complete the setup using gMSA authentication method.
