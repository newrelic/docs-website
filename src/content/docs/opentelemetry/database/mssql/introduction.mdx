...
flow:
  ...
  next: 
    ...
    - /docs/opentelemetry/database/mssql/docker
---
...
* [Docker](/docs/opentelemetry/database/mssql/docker): Run the collector as a sibling container to a SQL Server instance already running in Docker
