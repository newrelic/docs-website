...
Before installing any components, verify your environment meets requirements and configure database security permissions.

👉 **[Check compatibility requirements →](/docs/opentelemetry/database/mssql/compatibility)**

</Step>

<Step>

### NRDOT Collector installation tracks [#installation]
...
* [Explore available metrics](/docs/opentelemetry/database/mssql/mssql-nrdot-metrics) collected by the NRDOT collector
* [Troubleshoot common issues](/docs/opentelemetry/database/mssql/troubleshooting-nrdot) with your monitoring setup