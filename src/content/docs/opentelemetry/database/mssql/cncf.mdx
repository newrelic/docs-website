...
* <DNT>Query performance</DNT>: Displays detailed information about the queries running on your Microsoft SQL Server instance in following tabs:
    * <DNT>Normalized queries</DNT>: Shows the execution and average CPU time graphs.
    * <DNT>Query samples</DNT>: Shows individual query executions including start time, duration, wait type, wait time, database, DB user, and client host.
