...
<DocTiles>
  ...
  <DocTile title="Troubleshooting" path="/docs/opentelemetry/database/mssql/troubleshooting">Learn how to troubleshoot your MSSQL Linux RDS monitoring setup in New Relic.</DocTile>
