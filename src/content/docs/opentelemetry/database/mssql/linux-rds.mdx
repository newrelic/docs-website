...
2. Add the following configuration to the `mssql-config.yaml` file created in the previous step:
  ...
  <Callout variant="tip">
    This configuration focuses on essential database monitoring for your RDS environment. To enable comprehensive monitoring with all available metrics, refer to the [configuration reference](/docs/opentelemetry/database/mssql/config-reference/#rds-full).
  </Callout>
