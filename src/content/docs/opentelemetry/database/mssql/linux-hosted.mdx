...
<DocTiles>
  ...
  <DocTile title="Linux instrumentation for RDS" path="/docs/opentelemetry/database/mssql/linux-rds">Learn how to set up your MSSQL in RDS Linux environments monitoring in New Relic.</DocTile>
