...
Replace your `mssql-config.yaml` file at `/etc/nrdot-collector/mssql-config.yaml` with the configuration content provided in the Windows SQL Authentication section above. The configuration is the same for both environments.
