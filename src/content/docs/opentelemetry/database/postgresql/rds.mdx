...
| `explain_function_name` | Enter `otel.explain_statement` to collect query plans for locking or write statements without granting write access to the monitoring user. See [EXPLAIN plan permissions](/docs/opentelemetry/database/postgresql/explain-permissions#explain). |
