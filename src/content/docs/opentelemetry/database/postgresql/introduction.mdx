...
* **[Docker](/docs/opentelemetry/database/postgresql/docker)**: Run the collector as a sibling container to a PostgreSQL instance already running in Docker
