...
<DocTiles>
  ...
  <DocTile title="Docker install" path="/docs/opentelemetry/database/postgresql/docker">Learn how to run the NRDOT Collector as a sibling container to a PostgreSQL instance already running in Docker.</DocTile>
</DocTiles>
