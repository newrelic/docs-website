...
Set up MySQL or MariaDB monitoring using the NRDOT Collector on self-hosted environments including physical servers, virtual machines, and standalone installations.
