...
3. See [advanced configuration](/docs/opentelemetry/database/mysql/advanced-config) for optional features like write-statement query plans and lock-wait duration tracking
4. Check our [troubleshooting guide](/docs/opentelemetry/database/mysql/troubleshooting) for common issues