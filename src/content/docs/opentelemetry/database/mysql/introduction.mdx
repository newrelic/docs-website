...
For detailed requirements, see [Compatibility and prerequisites](/docs/opentelemetry/database/mysql/compatibility).
...
* **[Docker](/docs/opentelemetry/database/mysql/docker)**: Run the collector as a sibling container to a MySQL instance already running in Docker
