...
You can set up Oracle Database monitoring using the NRDOT Collector in on-host or multitenant environments. All Pluggable Databases (PDBs) under the configured Container Database (CDB) will be monitored. 

To install the NRDOT Collector in on-host (multitenant) environments, follow these steps:
