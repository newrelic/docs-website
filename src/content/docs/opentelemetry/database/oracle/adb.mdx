---
title: "Install & configure NRDOT Collector for ADB monitoring"
tags:
  - OpenTelemetry
...
<Collapser title="ADB Unsupported Metrics" id="unsupported">

The following metrics are **not supported in ADB**:
