---
title: "Install & configure NRDOT Collector for Autonomous Database (ADB) monitoring"
tags:
  - OpenTelemetry
...
<Callout variant="tip">
  If you're using Oracle Database on-host or on Amazon RDS instead, refer to [CDB](/docs/opentelemetry/database/oracle/host-cdb), [PDB](/docs/opentelemetry/database/oracle/host-pdb), or [RDS](/docs/opentelemetry/database/oracle/rds) instrumentation.
</Callout>
