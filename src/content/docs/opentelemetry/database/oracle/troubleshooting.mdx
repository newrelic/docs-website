...
- [Review your configuration](/docs/opentelemetry/database/oracle/compatibility)
- [Check available metrics](/docs/opentelemetry/database/oracle/metrics-reference)
- [On-host Container Database (CDB) setup](/docs/opentelemetry/database/oracle/host-cdb)
- [On-host Pluggable Database (PDB) setup](/docs/opentelemetry/database/oracle/host-pdb)
- [RDS setup](/docs/opentelemetry/database/oracle/rds)
- [Autonomous Database (ADB) setup](/docs/opentelemetry/database/oracle/adb)