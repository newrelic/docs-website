...
<DocTiles>
  <DocTile title="Introduction" path="/docs/opentelemetry/database/oracle/introduction">Choose your installation path for Oracle Database monitoring with New Relic.</DocTile>
