---
title: "Install & configure NRDOT Collector for on-host Container Database (CDB) monitoring"
tags:
  - OpenTelemetry
...
<Callout variant="tip">
  If you only need to monitor an individual pluggable database rather than the entire container database, refer to [PDB instrumentation](/docs/opentelemetry/database/oracle/host-pdb).
</Callout>
