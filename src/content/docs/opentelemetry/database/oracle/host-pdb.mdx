...
<Callout variant="tip">
  If you need to monitor the entire Container Database (CDB) rather than an individual pluggable database, refer to [On-host Container Database (CDB) instrumentation](/docs/opentelemetry/database/oracle/host-cdb).
</Callout>
