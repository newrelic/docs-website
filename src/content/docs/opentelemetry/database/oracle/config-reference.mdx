...
<DocTiles>
  ...
  <DocTile title="Metrics reference" path="/docs/opentelemetry/database/oracle/metrics">Learn about the available metrics collected by the NRDOT Collector.</DocTile>
</DocTiles>
