---
title: "Install & configure NRDOT Collector for AWS RDS monitoring"
tags:
  - OpenTelemetry
...
Configure the NRDOT Collector with your RDS-specific settings.
  ...
  <ol>
    ...
    Create the configuration file. The filename must be `oracle-config.yaml`.
    ...
    Add the configuration content below to the `oracle-config.yaml` file you created in the previous step.
