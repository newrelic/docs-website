---
title: "Install & configure NRDOT Collector for AWS RDS Oracle Database monitoring"
tags:
  - OpenTelemetry
...
<Callout variant="tip">
  If you're using Oracle Database in an on-host (multitenant) environment instead, refer to [CDB](/docs/opentelemetry/database/oracle/host-cdb) or [PDB](/docs/opentelemetry/database/oracle/host-pdb) instrumentation.
</Callout>
