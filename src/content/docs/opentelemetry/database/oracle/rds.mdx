...
You can install the New Relic Distribution of OpenTelemetry (NRDOT) Collector for Oracle Database monitoring on Amazon RDS environments. This approach provides a cloud-managed Oracle Database monitoring solution that leverages OpenTelemetry standards for database monitoring, making it easier to integrate with your existing observability stack.
...
After setting up your RDS Oracle Database monitoring:
...
* [Set up Container Database (CDB) monitoring](/docs/opentelemetry/database/oracledb/on-host-cdb) if you need on-host CDB setup
* [Set up Pluggable Database (PDB) monitoring](/docs/opentelemetry/database/oracledb/on-host-pdb) if you need on-host PDB setup