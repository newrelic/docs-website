...
This APM-DB correlation is only supported for Java agent. To enable it, in your Java agent configuration file, add the `sql_metadata_comments: nr_service_guid` under the `transaction_tracer` section. For more information, refer to [Java agent configuration](/docs/apm/agents/java-agent/configuration/java-agent-configuration-config-file/) documentation.
