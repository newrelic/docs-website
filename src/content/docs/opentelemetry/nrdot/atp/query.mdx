...
metaDescription: 'Learn how to query Adaptive Telemetry Processor (ATP) data in New Relic using NRQL.'
tags:
...
This page provides information on how to query Adaptive Telemetry Processor (ATP) data in New Relic using NRQL.