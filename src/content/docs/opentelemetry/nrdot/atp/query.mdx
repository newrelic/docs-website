...
## Process state monitoring [#process-state-monitoring]
...
## ATP intelligence monitoring [#atp-intelligence-monitoring]
...
## Anomaly detection queries [#anomaly-detection-queries]
