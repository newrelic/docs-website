...
4. Start the NRDOT collector service:
  ...
  <Collapser
    id="binary"
    title="For manual binary (Archive)"
  >
...
Once the collector is installed, edit the collector's configuration file to enable and customize ATP. The configuration file paths vary depending on your installation method:
