...
<CollapserGroup>
  ...
  >
    ...
    ```
    NewRelicAgent.RecordMetricWithName(<em>String</em> name, <em>String</em> category)
    ```
...
<CollapserGroup>
  ...
  >
    ```
    NewRelicAgent.RecordEvent (<em>string</em> name, <em>string dictionary</em> attributes)
    ```
  ...
  >
    ```
    NewRelicAgent.SetAttribute (<em>string</em> name, <em>string</em> value)
    ```

    ```
    NewRelicAgent.SetAttribute (<em>string</em> name, <em>double</em> value)
    ```
