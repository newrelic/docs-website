...
You can use New Relic Browser to add [custom events and attributes](/docs/insights/insights-data-sources/custom-data/insert-custom-events-attributes-new-relic-mobile-data).
