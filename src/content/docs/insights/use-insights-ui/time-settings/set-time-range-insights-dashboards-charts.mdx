...
<CollapserGroup>
  ...
  >
    ...
    ```
    https://rpm.newrelic.com/accounts/<code><var>123456</var></code>/applications/<code><var>12345678</var></code>?tw%5Bend%5D=<var>1502388642</var>&tw%5Bstart%5D=<var>1502386842</var>
    ```
