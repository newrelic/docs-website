...
<CollapserGroup>
  ...
  >
    ...
    ```
    NEW_RELIC_CONFIG_FILE=<var>/some/path/</var>newrelic.ini newrelic-admin run-program celery <var><i>YOUR_COMMAND_OPTIONS</i></var>
    ```
  ...
  >
    ...
    ```
    NEW_RELIC_CONFIG_FILE=some/path/newrelic.ini newrelic-admin run-program celeryd <var><i>YOUR_COMMAND_OPTIONS</i></var>
    ```
  </Collapser>
  ...
  >
    ...
    ```
    NEW_RELIC_CONFIG_FILE=<var>/some/path/</var>newrelic.ini newrelic-admin run-program python manage.py celery <var><i>YOUR_COMMAND_OPTIONS</i></var>
    ```
  </Collapser>
