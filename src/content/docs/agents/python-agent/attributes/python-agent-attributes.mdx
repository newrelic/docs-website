...
<CollapserGroup>
  <Collapser
    ...
    title="error.class"
  >
    The class of exception, if one exists, that is recorded on the span event. Exception details can be recorded on spans with the [notice_error](https://docs.newrelic.com/docs/agents/python-agent/python-agent-api/notice_error) API.
  ...
  <Collapser
    ...
    title="error.message"
  >
    The exception message, if one exists, that is recorded on the span event. Exception details can be recorded on spans with the [notice_error](https://docs.newrelic.com/docs/agents/python-agent/python-agent-api/notice_error) API.
