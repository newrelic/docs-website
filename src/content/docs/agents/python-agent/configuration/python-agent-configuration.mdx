...
<Callout variant="important">
  Starting in [Python agent version 7.0.0.164 or higher](/docs/agents/python-agent/installation-configuration/upgrade-python-agent), distributed tracing is enabled by default.
