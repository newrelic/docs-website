...
<CollapserGroup>
  ...
  >
    ...
    Attach [tags](/docs/apm/new-relic-apm/maintenance/labels-categories-organize-your-apps-servers) to this app. Specify name:value separated by a colon `:`, and separate additional tags with semicolons `;`.
