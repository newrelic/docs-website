...
<CollapserGroup>
  ...
  >
    ...
    Prevents specified exception classes from affecting error rate or Apdex score while still reporting the errors to APM. Set this to a space-separated list of the Python exception type names to ignore. Use the form `module:class` for the exception name.
