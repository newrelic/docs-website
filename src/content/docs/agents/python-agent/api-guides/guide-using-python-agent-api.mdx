...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        By default, the Python agent only reports unhandled exceptions. To report a Python exception as an error, use [`notice_error`](/docs/agents/python-agent/python-agent-api/notice_error).
      </td>
    </tr>
