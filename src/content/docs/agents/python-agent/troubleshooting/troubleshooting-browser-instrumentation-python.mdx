...
tags:
  ...
  - Python agent
  - Troubleshooting
metaDescription: Troubleshooting procedures if you have problems injecting New Relic Browser with New Relic's Python agent.
redirects:
...
If you have problems [instrumenting](/docs/agents/python-agent/supported-features/page-load-timing-python) Browser with the Python agent, follow the [standard troubleshooting procedures](/docs/browser/new-relic-browser/installation-configuration/troubleshooting-browser-monitoring-installation) for browser monitoring. Here are some additional tips for Python.
