...
Garbage collection profiling is available in [Python agent version 6.2.0.156 and higher](https://docs.newrelic.com/docs/agents/python-agent/installation-configuration/upgrade-python-agent/) and is disabled by default in the agent. To enable it, check out our documentation [here](https://docs.newrelic.com/docs/agents/python-agent/configuration/python-agent-configuration/#garbage-collection-runtime-metrics).
</Callout>
