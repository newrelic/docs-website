    ...
    <tr>
      ...
      <td>
        ...
        * `sum_of_squares`
        ...
        For explanations of these fields and some general usage tips, see the [documentation for the our Plugins custom metrics API](https://docs.newrelic.com/docs/plugins/plugin-developer-resources/developer-reference/metric-value-reference).
      </td>
    </tr>
  </tbody>
</table>
