...
Some other Python agent API calls take the application object as a parameter. For an example, see the [`notice_error`](/docs/agents/python-agent/python-agent-api/notice_error) call.
