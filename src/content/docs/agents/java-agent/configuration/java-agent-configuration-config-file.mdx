...
<CollapserGroup>
  ...
  >
    ...
    <Callout variant="important">
      Real-time profiling with JFR is on by default in Java agent [version 7.1.0](/docs/release-notes/agent-release-notes/java-release-notes). If you are on any other agent version 7.0.0 or greater, you can turn on JFR by changing the value to `true`.
    </Callout>
  </Collapser>
