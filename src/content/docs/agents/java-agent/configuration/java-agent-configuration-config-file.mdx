...
<CollapserGroup>
  ...
  >
    ...
    <Callout variant="important">
      Real-time profiling with JFR is on by default starting in Java agent [version 7.1.0 or higher](/docs/release-notes/agent-release-notes/java-release-notes). If you are on agent version 7.0.0, you can turn on JFR by changing the value to `true`.
    </Callout>
  </Collapser>
