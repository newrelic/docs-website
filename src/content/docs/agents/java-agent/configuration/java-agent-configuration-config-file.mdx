...
<CollapserGroup>
  ...
  >
    ...
    Event ingest URI used by some agent features. Defaults to the US production ingest endpoint. Can be manually configured to send events to other ingest endpoints (e.g. EU production: https://insights-collector.eu01.nr-data.net/v1/accounts/events).
  </Collapser>
  ...
  >
    ...
    Metric ingest URI used by some agent features. Defaults to the US production ingest endpoint. Can be manually configured to send metrics to other ingest endpoints (e.g. EU production: https://metric-api.eu.newrelic.com/metric/v1).
  </Collapser>  
...
<CollapserGroup>
  ...
  >
    ...
    Set to `true` to enable [Real-time profiling with JFR](https://docs.newrelic.com/docs/agents/java-agent/features/real-time-profiling-java-using-jfr-metrics/).
