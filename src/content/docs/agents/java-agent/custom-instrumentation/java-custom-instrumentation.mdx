...
japaneseVersion: >-
  https://docs.newrelic.co.jp/docs/agents/java-agent/custom-instrumentation/java-custom-instrumentation
---
...
[Custom instrumentation](/docs/agents/manage-apm-agents/agent-data/custom-instrumentation) allows you to track interactions that aren't captured by New Relic's automatic instrumentation, and lets you add detail to your [transaction traces](/docs/traces/transaction-traces), to help you identify key issues.
...
You can also monitor Java Management Extensions (JME) via custom instrumentation. JMX is a way to monitor and manage applications, devices, and services. You can implement JMX monitoring via an [external **YAML** file](/docs/java/custom-jmx-instrumentation-by-yml).
