...
Custom instrumentation is useful for nested transactions. For example, in the thread profiler, methods marked <i className="fa fa-circle" style={{color: '#A0A0A0'}}><span>[circle]</span></i>
...
* [Custom instrumentation editor](/docs/agents/java-agent/custom-instrumentation/custom-instrumentation-editor-quickly-customize-your-java-instrumentation) (how to use New Relic's UI tool to quickly customize your Java instrumentation)
* New Relic Java agent's [Troubleshooting section](/docs/agents/java-agent/troubleshooting) (individual troubleshooting tips and procedures)
