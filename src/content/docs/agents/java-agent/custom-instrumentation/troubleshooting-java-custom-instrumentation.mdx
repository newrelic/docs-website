...
Custom instrumentation is useful for nested transactions. For example, in the thread profiler, methods marked <i className="fa fa-circle" style={{color: '#A0A0A0'}}>
\[circle]
</i>
