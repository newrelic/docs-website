...
<CollapserGroup>
  ...
  >
    Note: It is recommended that you do not set any variables in this script. Instead put them into a script `setenv.sh` in `CATALINA_BASE/bin` to keep your customizations separate.
  ...
  >
    Note: It is recommended that you do not set any variables in this script. Instead put them into a script `setenv.bat` in `CATALINA_BASE/bin` to keep your customizations separate.
