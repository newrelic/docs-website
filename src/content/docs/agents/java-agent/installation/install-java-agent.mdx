...
<Table>
  ...
  <tbody>
  <tr>
  <td>heres some info for the table.</td>
  <td>some more info for the table.</td>
  </tr>
  </tbody>
...
<CollapserGroup>
     <Collapser
       id="collaper_1"
       title="testing out a collapser"
     >
     This is the content I want to collapse.

     </Collapser>

     <Collapser
     id="collaper_2"
       title="testing out 2nd collapser"
     >
     This is more content I want to collapse.

     </Collapser>
</CollapserGroup>


1. Numbered list with a nested unordered list!

  * item one in list.
  * item two in list.
2. here's the second step.
