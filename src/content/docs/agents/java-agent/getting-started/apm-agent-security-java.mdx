  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        By default, the agent records events sent to the Insights custom events API via `recordCustomEvent()`. If you enable [high security mode](#restricted), this is automatically set to `false`.
      </td>
    </tr>
  </tbody>
</Table>
