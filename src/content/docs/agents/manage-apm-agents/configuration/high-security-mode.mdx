...
This feature requires [Enterprise tier](https://newrelic.com/pricing).
...
<Callout variant="caution">
  Once you enable high security for an account, **high security cannot be turned off** without assistance from [support](https://support.newrelic.com).
</Callout>
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        Note: If the agent is configured for high security via the UI but not locally, then the agent connections will be rejected and the agent will shut down (this won't shut down your application).
      </td>
    </tr>
...
For more information about configuration file settings, refer to your [specific agent's documentation](#overview).

For the New Relic Synthetics feature that requires a pass phrase to assign jobs to a private minion, see [Verified script execution](/docs/synthetics/new-relic-synthetics/private-locations/verified-script-execution-private-locations).
