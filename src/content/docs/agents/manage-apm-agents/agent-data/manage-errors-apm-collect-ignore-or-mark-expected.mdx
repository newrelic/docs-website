...
* **Python**: [`notice_error()`](/docs/agents/python-agent/python-agent-api/notice_error)
...
<Callout variant="tip">
  For Java, Ruby, Node.js, and Python: If you want to report errors to APM but don't want those errors to affect your Apdex or error rate, [mark them as expected](#expected-links) instead.
</Callout>
...
<CollapserGroup>
  ...
  >
    ...
    * **Python**: [`error_collector.ignore_classes`](/docs/agents/python-agent/installation-configuration/python-agent-configuration#error-ignore) or [`error_collector.ignore_status_codes`](/docs/agents/python-agent/installation-configuration/python-agent-configuration#error-ignore-status-codes).
...
## Expected errors (Java, Node.js, Python, Ruby, and .NET only) [#expected]
