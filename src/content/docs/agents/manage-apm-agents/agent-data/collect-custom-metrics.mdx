...
![custom-metric-syntax.png](http://newrelicdev.prod.acquia-sites.com/sites/default/files/thumbnails/image/custom-metric-syntax.png "custom-metric-syntax.png")
