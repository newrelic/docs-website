...
topics:
  ...
  - App naming
japaneseVersion: >-
  https://docs.newrelic.co.jp/docs/agents/manage-apm-agents/app-naming/name-your-application
---
...
<Callout variant="important">
  We recommend changing the default name of an app to a more descriptive name before deployment.
</Callout>
