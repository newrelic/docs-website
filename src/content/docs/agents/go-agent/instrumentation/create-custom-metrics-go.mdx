...
* [New Relic for Go segment documentation on GitHub](https://github.com/newrelic/go-agent/blob/master/segments.go) (more details about instrumenting segments on New Relic GitHub)
* [Instrument Go transactions](/docs/agents/go-agent/get-started/instrument-go-transactions) (how to create New Relic transactions in your Go app)
