...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="labels"
  >
    Attach [tags](/docs/apm/new-relic-apm/maintenance/labels-categories-organize-your-apps-servers) to this app. Specify your tags as objects or a semicolon-delimited string of colon-separated pairs (for example, `Server:One;Data Center:Primary`).
