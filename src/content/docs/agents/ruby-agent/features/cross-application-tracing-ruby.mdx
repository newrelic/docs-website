...
As an alternative to cross application tracing, we recommend our [distributed tracing](/docs/apm/distributed-tracing/getting-started/introduction-distributed-tracing). This feature is an improvement on cross application tracing and makes it easy for you to follow requests through the services of your distributed applications.
