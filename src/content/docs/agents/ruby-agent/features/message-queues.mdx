...
<CollapserGroup>
  ...
  >
    ...
    ![breakdown_table.png](./images/breakdown_table_0.png "breakdown_table.png")
  ...
  >
    ...
    ![transaction_trace.png](./images/transaction_trace_1_0.png "transaction_trace.png")
  </Collapser>

  <Collapser
    id="view-in-txn-trace-page"
    title="Transaction trace messages tab"
  >
    ...
    ![messages_tab.png](./images/messages_tab_0.png "messages_tab.png")
  </Collapser>
</CollapserGroup>
