...
<Callout variant="caution">
  Developer mode is removed and no longer supported as of [Ruby agent version 4.1.0](/docs/release-notes/agent-release-notes/ruby-release-notes/ruby-agent-410333).
</Callout>
...
While a **newrelic.yml** file will be created as part of the installation, it is not necessary to have a valid [license key](/docs/accounts-partnerships/accounts/account-setup/license-key).
