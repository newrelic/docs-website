...
tags:
  ...
  - Ruby agent
  - Troubleshooting
metaDescription: 'When using New Relic APM''s Ruby agent, you can prevent the newrelic_rpm gem from starting, or force it to start if it is not reporting data.'
redirects:
