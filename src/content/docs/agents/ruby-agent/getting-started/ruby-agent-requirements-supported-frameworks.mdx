...
[Message queue instrumentation](https://docs.newrelic.com/docs/agents/ruby-agent/features/message-queues) is only available with the [Ruby agent version 4.3.0 or higher](https://docs.newrelic.com/docs/release-notes/agent-release-notes/ruby-release-notes). Currently supported message brokers:
