...
<CollapserGroup>
  ...
  >
    ...
    ![overview_graph.png](./images/overview_graph_0.png "overview_graph.png")
  ...
  >
    ...
    ![transaction_graph.png](./images/transaction_graph.png "transaction_graph.png")
  ...
  <Collapser
    id="apm-trace"
    title="In APM transaction trace details"
  >
    Transaction traces also capture detailed middleware call information.

    ![transaction_trace.png](./images/transaction_trace_0.png "transaction_trace.png")
