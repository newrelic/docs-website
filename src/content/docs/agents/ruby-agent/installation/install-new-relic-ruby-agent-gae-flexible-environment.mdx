...
1. Follow New Relic's standard procedures to [install the gem](/docs/agents/ruby-agent/installation/install-new-relic-ruby-agent#Installing_the_Gem), including your [license key](/docs/accounts-partnerships/accounts/account-setup/license-key).
...
<CollapserGroup>
  ...
  >
    1. Follow standard procedures to install New Relic's Ruby agent, including your [license key](/docs/accounts-partnerships/accounts/account-setup/license-key).
