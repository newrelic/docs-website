...
[Heroku](https://devcenter.heroku.com/articles/newrelic) is a Platform as a Service (PaaS) solution for hosting web applications in various agent languages, including Ruby. With New Relic, you can extend Heroku using [APM](/docs/apm/new-relic-apm) and [Browser](/docs/browser/new-relic-browser) metrics. This page describes special considerations for using Heroku as a hosting service with New Relic's Ruby agent.
...
<CollapserGroup>
  ...
  >
    ...
    3. Give your application a [descriptive name](/docs/apm/new-relic-apm/installation-configuration/name-your-application) with this Heroku toolbelt command:
       ...
       ```
    4. Add the New Relic gem to your Gemfile. The New Relic Ruby agent's gem is available from [rubygems.org](https://rubygems.org/ "Link opens in a new window.") as `newrelic_rpm`.
  ...
  >
    ...
    2. Give your application a [descriptive name](/docs/apm/new-relic-apm/installation-configuration/name-your-application) with this toolbelt command:
       ...
       heroku config:set NEW_RELIC_APP_NAME='Your Application Name'
       ```
    3. Add the New Relic gem to your Gemfile. The New Relic Ruby agent's gem is available from [rubygems.org](https://rubygems.org/ "Link opens in a new window.") as `newrelic_rpm`.
...
* [Heroku Dev Center](https://devcenter.heroku.com/articles/newrelic) (information on the Heroku site on installing New Relic)
