...
* [Selecting custom dashboard metrics](/docs/dashboards-menu/selecting-custom-dashboard-metrics) (Viewing custom metrics)
* [Ruby custom instrumentation](/docs/ruby/ruby-custom-instrumentation) (Instrumenting code elements New Relic does not automatically instrument)
