...
<Callout variant="tip">
  To use the C SDK or any other agent, as well as the rest of our [observability
...
{' '}
<Collapser id="header-file" title="2. Include the provided header file.">
...
{' '}
<Collapser id="instrumentation" title="5. Finish instrumenting your code.">
  To finish instrumenting your code, refer to the example programs in the [C SDK
  **Examples** documentation on
  GitHub](https://github.com/newrelic/c-sdk/tree/master/examples). For more
  information about source code and features, see the [C SDK's source
  documentation for `libnewrelic.h` on
  GitHub](https://newrelic.github.io/c-sdk/libnewrelic_8h_source.html).
</Collapser>
