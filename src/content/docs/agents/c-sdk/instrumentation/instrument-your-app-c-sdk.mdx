...
A test of localization! 2-04-2021
...
<Callout variant="tip">
  ...
  compiling](/docs/agents/c-sdk/install-configure/install-c-sdk-compile-link-your-code#compile).
  The `-rdynamic` linker flag gives you more meaningful error traces.
</Callout>
