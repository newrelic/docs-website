...
After [download and installation](/docs/agents/net-agent/installation/introduction-net-agent-install), the agent runs within the monitored process; there is not a separate process or service created by the agent.
          ...
          <td>
            ...
            * [WCF](/docs/agents/net-agent/features/instrumenting-wcf-applications)
              ...
              * [**Binding Types**](http://docs.microsoft.com/en-us/dotnet/framework/wcf/system-provided-bindings) (both client and service)
                * **HTTP Based Binding Types**  
                  These bindings are instrumented and automatically support Distributed Tracing (DT) and Cross Application Tracing (CAT).
                  * Common bindings include:
                    * Basic HTTP
                    * WSHTTP
                    * WebHTTP
                * **Non-HTTP Based Binding Types**  
                  These bindings are instrumented, but do not automatically support Distributed Tracing (DT) and Cross Application Tracing (CAT).
                  * Common bindings include:
                    * NetTCP
                    * NetNamedPipe
                    * NetMSMQ
