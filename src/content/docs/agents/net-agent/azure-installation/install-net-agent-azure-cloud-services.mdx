...
5. Follow the prompts to enter your [New Relic license key](/docs/accounts-partnerships/accounts/account-setup/license-key) and your [application name](/docs/agents/net-agent/installation-configuration/name-your-net-application) as you want it to appear in the New Relic UI. Or, use your solution name as the default app name.
