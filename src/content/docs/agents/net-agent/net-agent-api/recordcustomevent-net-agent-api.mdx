...
<div className="callout-important">
  <ul>
    <li>Sending a lot of events can increase the memory overhead of the agent.</li><li>Additionally, posts greater than 1MB in size will not be recorded regardless of the maximum number of events.</li><li>Custom Events are limited to 64-attributes.</li><li>For more information about how custom attribute values are processed, see the <a href="/docs/agents/net-agent/attributes/custom-attributes">custom attributes</a> guide.</li>
  </ul>
</div>
