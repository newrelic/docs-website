...
```
NewRelic.Api.Agent.NewRelic.NoticeError(<em>exception</em> $exception[, <em>IDictionary</em> $attributes])
NewRelic.Api.Agent.NewRelic.NoticeError(<em>string</em> $error_message, <em>IDictionary</em> $attributes)
NewRelic.Api.Agent.NewRelic.NoticeError(<em>string</em> $error_message, <em>IDictionary</em> $attributes, <em>bool</em> $is_expected)
```
