...
<div className="callout-tip">
  <p>
    You can also ignore transactions <a href="/docs/agents/net-agent/custom-instrumentation/add-detail-transactions-xml-net#blocking-instrumentation">via a custom instrumentation XML file</a>.
  </p>
</div>
