...
<table>
  ...
  <tbody>
    <tr>
      <td colSpan={2}>
        ~~~
        AddCustomParameter(_string_ $key, _string_ $value)
        ~~~
      </td>
    </tr>
    <tr>
      <td>
        <p>`$key`</p><p>_string_</p>
      </td>
      <td>
    ...
    <tr>
      <td colSpan={2}>
        ~~~
        AddCustomParameter(_string_ $key, _IConvertible_ $value)
        ~~~
      </td>
    </tr>
    <tr>
