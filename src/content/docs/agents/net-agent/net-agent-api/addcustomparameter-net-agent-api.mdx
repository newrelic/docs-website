...
```
NewRelic.Api.Agent.NewRelic.AddCustomParameter(<em>string</em> $key, <em>string</em> $value)
NewRelic.Api.Agent.NewRelic.AddCustomParameter(<em>string</em> $key, <em>IConvertible</em> $value)
```
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td colSpan={2}>
        ```
        AddCustomParameter(<em>string</em> $key, <em>IConvertible</em> $value)
        ```
      </td>
    </tr>
