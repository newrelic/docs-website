...
<div className="callout-caution">
  <p>
    This API has been deprecated. Please use the <a href="/docs/agents/net-agent/net-agent-api/itransaction"><code>AddCustomAttribute</code></a> instead.
  </p>
</div>
...
<div className="callout-important">
  <p>
    If you want to use your custom parameters or attributes, avoid using any of the <a href="/docs/insights/nrql-new-relic-query-language/nrql-resources/nrql-reserved-words">reserved terms used by NRQL</a>.
  </p>
</div>
