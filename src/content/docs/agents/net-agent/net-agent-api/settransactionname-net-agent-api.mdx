...
<div className="callout-important">
  <p>
    Do not use brackets <code>[<var>suffix</var>]</code> at the end of your transaction name. New Relic automatically strips brackets from the name. Instead, use parentheses <code>(<var>suffix</var>)</code> or other symbols if needed.
  </p>
</div>
