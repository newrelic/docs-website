...
<i aria-hidden="true" className="fa fa-cog fa-2x"><span>[cog icon]</span></i>
...
<i aria-hidden="true" className="fa fa-wrench fa-2x"><span>[wrench icon]</span></i>
...
<i aria-hidden="true" className="fa fa-life-ring fa-2x"><span>[ilfe-ring icon]</span></i>
