...
* [Enable instrumentation only for specific app pools](https://docs.newrelic.com/docs/agents/net-agent/configuration/net-agent-configuration#include_exclude_apps)
