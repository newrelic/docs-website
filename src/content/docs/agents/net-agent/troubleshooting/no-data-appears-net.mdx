...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <p>[.NET Framework compatibility and requirements](https://docs.newrelic.com/docs/agents/net-agent/getting-started/compatibility-requirements-net-framework-agent)</p><p>or</p><p>[.NET Core compatibility and requirements](https://docs.newrelic.com/docs/agents/net-agent/getting-started/compatibility-requirements-net-core-20-agent)</p>
      </td>
    </tr>
    <tr>
      <td>
