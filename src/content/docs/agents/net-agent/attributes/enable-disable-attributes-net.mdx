...
The following properties are obsolete in the .NET agent v9.0. Switch to the new attributes configuration for these properties when upgrading your .NET agent.
