...
```
newrelic_start_transaction(<em>string</em> $appname[, <em>string</em> $license])
```
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        Provide a different [license key](/docs/accounts-partnerships/accounts/account-setup/license-key#find-heroku) if you want the transaction to report to a different New Relic account. If set, this license will supersede all per-directory and global default licenses configured in INI files.
      </td>
    </tr>
  </tbody>
</table>
