...
```
newrelic_record_custom_event(<em>string</em> $name, <em>array</em> $attributes)
```
...
Agent version [4.18.0.89](https://docs.newrelic.com/docs/release-notes/agent-release-notes/php-release-notes/php-agent-418089) or higher.
