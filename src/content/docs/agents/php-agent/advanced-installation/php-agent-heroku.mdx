...
1. Download a "clean" copy of [**newrelic.ini\_.heroku**](/sites/default/files/atoms/files/newrelic.ini_.heroku) \[INI | 16KB].
...
3. If you need further assistance, [get support at support.newrelic.com](//support.newrelic.com).
