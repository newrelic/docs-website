...
<CollapserGroup>
  ...
  >
    ...
    <Callout variant="caution">
      This setting has been deprecated and may not behave as expected. Instead, use [attribute properties](https://docs.newrelic.com/docs/agents/php-agent/attributes/enable-or-disable-attributes#deprecated-properties).
    </Callout>
  ...
  >
    ...
    Sets the New Relic [license key](/docs/accounts-partnerships/accounts/account-setup/license-key) to use. In a multi-tenant system this can be set on a per-directory basis.
...
<CollapserGroup>
  ...
  <dd>
    ...
    * To use an abstract socket, use the value `@newrelic-daemon` (available for agent version [5.2.0.141](https://docs.newrelic.com/docs/release-notes/agent-release-notes/php-release-notes/php-agent-520141) or higher). This is the default on Linux systems.
...
<CollapserGroup>
  ...
  >
    ...
    Span events are reported for [distributed tracing](#inivar-distributed-enabled). Span event reporting requires [distributed tracing](https://docs.newrelic.com/docs/agents/php-agent/features/distributed-tracing) to be enabled. This option enables/disables the reporting of span events.
  </Collapser>
...
<CollapserGroup>
  ...
  >
    ...
    Enables or disables support for the [Guzzle library when used with New Relic](https://docs.newrelic.com/docs/agents/php-agent/frameworks-libraries/guzzle).
