  ...
  >
      ...
      >
        ...
        <VirtualHost 192.168.42.43>
          ...
          <IfModule <var>PHP_MODULE</var>>
            <strong>php_value newrelic.appname "<var>Virtual Host 1</var>"</strong>
          </IfModule>
        </VirtualHost>
        ...
        <VirtualHost 192.168.123.45>
          ...
          ...
          <IfModule <var>PHP_MODULE</var>>
            <strong>php_value newrelic.appname "<var>Virtual Host 2</var>"</strong>
          </IfModule>
        </VirtualHost>
        ```
    ...
    * `VALUE` is the value you want to set to for that particular virtual host.
    ...
    <VirtualHost 192.168.56.78>
      ...
      ...
      <IfModule <var>PHP_MODULE</var>>
        <strong>php_flag newrelic.enabled off</strong>
      </IfModule>
    </VirtualHost>
    ```
  </Collapser>
...
<CollapserGroup>
  ...
  >
    ...
    <strong>php_value[newrelic.appname] = "<var>My App 1</var>"</strong>

    [<var>app2</var>]
    listen=/tmp/pool-<var>app2</var>.sock
    <strong>php_value[newrelic.appname] = "<var>My App 2</var>"</strong>
