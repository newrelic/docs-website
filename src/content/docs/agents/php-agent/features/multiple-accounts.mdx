...
<VirtualHost 192.168.42.43>
  ...
  <IfModule php5_module>
    <strong>php_value newrelic.license "NEW RELIC LICENSE KEY 1"</strong>
  </IfModule>
</VirtualHost>
...
<VirtualHost 192.168.123.45>
  ...
  ...
  <IfModule php5_module>
    <strong>php_value newrelic.license "NEW RELIC LICENSE KEY 2"</strong>
  </IfModule>
</VirtualHost>
```
...
* [PHP agent (`newrelic.ini`) settings](/docs/php/php-agent-phpini-settings) (The PHP .ini file reference)
* [PHP per-directory INI settings](/docs/php/per-directory-settings) (configuring New Relic on a per directory basis)
* [Creating multiple accounts](/docs/subscriptions/creating-multiple-accounts) (setting up multiple New Relic accounts on the same email)
