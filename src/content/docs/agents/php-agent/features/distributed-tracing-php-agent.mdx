...
2. Make sure that the [transaction tracer](https://docs.newrelic.com/docs/agents/php-agent/configuration/php-agent-configuration#inivar-tt-settings) configuration option is enabled (default is `true`):

   ```
   newrelic.transaction_tracer.enabled = true
   ```
3. Enable (or disable) distributed tracing for the PHP agent with the [`distributed_tracing_enabled`](https://docs.newrelic.com/docs/agents/php-agent/configuration/php-agent-configuration#inivar-distributed-enabled) configuration option:

   ```
   newrelic.distributed_tracing_enabled = true
   ```
4. Set the [transaction tracer threshold](https://docs.newrelic.com/docs/agents/php-agent/configuration/php-agent-configuration#inivar-tt-threshold) value to a suitable value. **Recommendation:**
...
newrelic.span_events_enabled = true  
newrelic.infinite_tracing.trace_observer_host= <var>YOUR_TRACE_OBSERVER_HOST</var>
