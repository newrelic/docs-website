  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        By default, the agent records events sent to the Insights custom events API via [`newrelic_record_custom_event()`](/docs/agents/php-agent/php-agent-api/newrelic_record_custom_event). If you enable [high security mode](#restricted), this is automatically set to `false`.
      </td>
    </tr>
