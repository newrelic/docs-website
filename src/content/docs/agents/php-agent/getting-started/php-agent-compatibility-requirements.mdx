...
* New Relic recommends using a [supported release](http://php.net/supported-versions.php) of PHP, especially 7.3 and 7.4.
...
<Table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        macOS 10.6 or higher (see [macOS specific notes](/docs/agents/php-agent/troubleshooting/known-php-limitations#osx))
