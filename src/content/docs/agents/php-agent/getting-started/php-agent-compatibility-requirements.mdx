  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * CentOS 8
        <Callout variant="important">
          Arm64 is only supported with PHP 8.0
          Arm64 is only supported with New Relic PHP Agent 9.18.1 or later
        </Callout>
        <Callout variant="tip">
          For more information on Arm64 support, please see [here](/docs/installation/php-agent-installation-arm64)
        </Callout>
      </td>
    </tr>
