...
In some cases, SELinux can prevent the daemon from starting altogether. [Verifying the PHP daemon](https://docs.newrelic.com/docs/agents/php-agent/troubleshooting/verifying-php-daemon) may be a necessary troubleshooting step when diagnosing SELinux issues.
