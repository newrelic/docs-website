...
```
<span style="font-family: 'Source Code Pro', Monaco, Courier, monospace; line-height: 22.4px; white-space: pre; background-color: rgb(245, 245, 245);">SELECT latest(timestamp), latest(name) FROM TestSuite WHERE successful IS false FACET runId</span>
```
