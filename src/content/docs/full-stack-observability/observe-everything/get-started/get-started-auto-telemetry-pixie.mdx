...
### RBAC and Auto-telemetry with Pixie

In this beta, New Relic RBAC controls cannot be used to gate access to Auto-telemetry with Pixie. This means the following:
		• it creates one project for all of your Kubernetes clusters
