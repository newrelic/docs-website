---
title: "Improve the quality of your releases with New Relic" 
tags:
...
In short, trunk-based development divides development work into small batches performed against branches of a single trunk. As soon as one batch of work is completed, the branch is merged back into the trunk. Each branch has a short lifetime, making merges back into the trunk simple and ensuring every developer is working from recent releases of the code base.
...
Prior to starting any custom integration work, you should determine if any out-of-box integrations exist that meet your goals. **EXAMPLE GOES HERE**      
    </Step>
    <Step>
...
The information displayed in the dashboards depends on your development toolchain, so you'll need to customize your dashboard to your exact specifications. **WHERE DO WE SEND THEM TO TELL THEM HOW TO DO THIS?**           
    </Step>
    <Step>
...
You can use the [session template presentation](https://docs.google.com/presentation/d/1FflqMMVejwn6HMjEni8igZh6UR0a3_JbuMcS5xlZiJU/edit?usp=sharing) to keep your process organized.        
    </Step>
    <Step>
### Improvement process [#improvement-process]

This final step is a continuous improvement process. During this phase, you'll repeat the [initial enablement steps](#perform-enablement-one) to review your progress against your baseline and adjust your strategies so you deliver the desired improvements. Each cycle of the improvment process should occur after several iterations of your development process. Typically, these occur at the mid-point and end of every Agile sprint.
