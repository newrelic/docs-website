...
<table>
  <thead>
    ...
    <tr>
      ...
      <td>
        If you follow a link to New Relic from the Pixie UI and do not have a New Relic account, you must first create one. Click the New Relic icon in the Pixie UI. Then follow the steps to create a New Relic account. Make sure you use the same email address for both your New Relic and Pixie accounts. When you create the New Relic account, your Pixie account is linked to it. Then, continue the guided install process [with these steps](#install-helm-command-manifest).
      </td>
    </tr>
    </tbody>
</table>
