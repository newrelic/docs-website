...
4. On the **Choose install method** page, select either **Helm** or **manifest**. 
  ...
  <Collapser
    ...
    title="Helm method"
  >
  Run the provided Helm command on your command line. If you're concerned about the amount of Pixie data you'll ingest, find some [parameters for reducing ingest below](#reduce-ingest-helm).
...
## Reduce ingest during install with Helm [#reduce-ingest-helm]
