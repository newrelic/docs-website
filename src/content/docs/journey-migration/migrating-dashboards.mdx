...
<CollapserGroup>
    ...
    <Steps>
        <Step>
        Go to **Add Data**, then select the feature you want to create a dashboard for. For our example, we'll choose **Infrastructure & OS**, and create a dashboard to monitor an Azure integration.  
        </Step>
        <Step>
