...
<DocTiles>
  <DocTile title='Monitor your logs' number='3' path="/docs/journey-migration/migrating-logs/" label={{text: "You are here", color: "orange"}}>Set up monitoring for the data from your infrastructure and APM</DocTile>
