...
* View the [User sessions](/docs/streaming-video-&-ads/view-data-in-newrelic/streaming-video-&-ads-single-application-view/user-sessions) of the customer and troubleshoot users issue by clicking the **Analyse user session**, which will provide you with the detailed information about the user sessions, such as:
