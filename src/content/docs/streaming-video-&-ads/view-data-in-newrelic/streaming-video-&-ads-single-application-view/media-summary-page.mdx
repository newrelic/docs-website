...
Use the golden metrics to understand the performance of how the video performs according to the **Video quality** and **Video engagement** on a single application, these include:
