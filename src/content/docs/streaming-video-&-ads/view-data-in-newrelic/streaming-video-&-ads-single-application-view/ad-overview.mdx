---
title: Ads overview (Single Application)
...
The Ads Overview page provides a detailed view of ad playback performance for a specific monitored application. This page helps you assess ad quality, monitor ad engagement, and identify ad delivery issues within a single streaming application or platform.

### What you can do with Ads Overview

Use this page to:
- Monitor ad quality metrics including rebuffering ratio, bitrate, and start time for a specific application
- Track ad engagement metrics including attempts, completions, and quartile milestones
- Identify ads with high start time, rebuffering, start failures, or playback failures within the application
...
This page is useful for application developers, ad operations teams, and product managers who need to monitor ad playback quality for a specific application, troubleshoot application-specific ad issues, and ensure ad delivery meets quality standards for that platform.
...
* View [Summary](/docs/streaming-video-&-ads/view-data-in-newrelic/streaming-video-&-ads-single-application-view/media-summary-page) for a specific applications/platforms.
