...
The **Single Platforms > Ads Overview** page provides a broad view of ads performance of a specific application. This offers a comprehensive overview of ads performance metrics for all monitored applications. The ads overview page includes the following information:

## View the Ad Overview page [#view-the-ad-overview-page]

To view the ad overview page of the video agent of a specific application, go to <DNT>**[one.newrelic.com](https://one.newrelic.com) > All Capabilities > Streaming Video & Ads > Ad Overview**</DNT>.
