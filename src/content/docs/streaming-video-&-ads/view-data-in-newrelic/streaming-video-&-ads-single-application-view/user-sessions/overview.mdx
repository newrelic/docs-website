...
The **Single platform > User Sessions** for Streaming Video & Ads lists all the sessions across the application.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        A unique id that is generated every time any app starts. For more information see [Session ID](/docs/streaming-video-&-ads/view-data-in-newrelic/streaming-video-&-ads-all-platform-view/user-sessions/session-id).
      </td>
    </tr>
