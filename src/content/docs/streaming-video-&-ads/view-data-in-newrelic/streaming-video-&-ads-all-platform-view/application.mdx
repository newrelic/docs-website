...
## Prerequisites
  ...
  <img
    title="Application settings sections"
    alt="Screenshot of application settings sections"
    src="/images/streaming-qoe-all-app.webp"
  />

## Access application settings

1. Go to <DNT>**[one.newrelic.com](https://one.newrelic.com) > All Capabilities > Streaming Video & Ads**</DNT>
2. Select **Application** from the settings menu
  ...
  <TabsPages>
    <TabsPageItem id="qoe-status">
      ...
      **To configure**:
      ...
      <Callout variant="tip">
        The QoE Health Index card (including QoE-related cards such as Impacted and Good view cards) can be toggled on or off from the application settings.
      </Callout>
    </TabsPageItem>
