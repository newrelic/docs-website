...
To view the ad overview page of the video agent across all platforms, go to go to <DNT>**[one.newrelic.com](https://one.newrelic.com) > All Capabilities > Streaming Video & Ads > Ad Overview**</DNT>.
...
Get an in-dept insight of the ads quality metrics by clicking the ellipsis icon on the right side of the metrics. Let us consider an example, as a user, you would like to view details related to ads attempts.
