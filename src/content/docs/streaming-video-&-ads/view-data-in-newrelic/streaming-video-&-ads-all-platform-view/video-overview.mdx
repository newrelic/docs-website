...
To view the video overview page of the media agent across all platforms, go to <DNT>**[one.newrelic.com](https://one.newrelic.com) > Streaming Video & Ads > Video Overview**</DNT>.
...
Displays the metrics related to the different entity types. These metrics can help you better assess the performance of videos across all applications and see how your video performs according to **Video Quality** and **Video Engagement**. These include:
...
<table>
  ...
  <tbody>
    ...
    <img
      title="Streamng video & ads golden metrics"
