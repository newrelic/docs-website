      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              [Create an alert condition](/docs/alerts/create-alert/create-alert-condition/alert-conditions) to measure the set of event against a defined threshold and open an incident when the threshold is met for a specified window of time.
            </td>
