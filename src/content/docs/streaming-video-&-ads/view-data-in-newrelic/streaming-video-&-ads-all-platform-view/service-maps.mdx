...
<Steps>
  <Step>
    ...
    Pass your Browser or Mobile entity's application ID when initializing the media streaming tracker. The parent app ID establishes the relationship between entities.
    ...
    **For Browser applications:**
    ...
    ```javascript
    // Initialize the media streaming tracker with parent app ID
    const tracker = new NewRelicVideoAgent({
      accountId: 'YOUR_ACCOUNT_ID',
      licenseKey: 'YOUR_LICENSE_KEY',
      applicationName: 'My Media Player',
    ...
    **For Android applications:**
    ...
    config.put("accountId", "YOUR_ACCOUNT_ID");
    config.put("licenseKey", "YOUR_LICENSE_KEY");
    config.put("applicationName", "My Media Player");
    config.put("parentAppId", "YOUR_MOBILE_APP_ID"); // Mobile entity app ID
    ...
    **For iOS applications:**
    ...
    <Callout variant="important">
      The `parentAppId` must exactly match the application ID of your Browser or Mobile entity. A mismatch will prevent the relationship from being established.
    </Callout>
  </Step>
