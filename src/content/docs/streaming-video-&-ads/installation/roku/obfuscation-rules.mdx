...
<Callout variant="important">
  Roku has regex pattern restrictions that affect obfuscation rules. See [Limitations for Streaming Video & Ads](/docs/streaming-video-&-ads/limitations#roku-regex) for details.
</Callout>
