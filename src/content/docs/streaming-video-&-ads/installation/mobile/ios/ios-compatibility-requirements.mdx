...
Before you [install and configure](/docs/streaming-video-&-ads/installation/mobile/ios/get-started) the iOS agent, follow these guidelines for compatibility and other requirements.

## Foreground monitoring [#foreground]

The iOS agent only monitors your app while it is in the foreground. The agent does not monitor background services while the app is closed. For more information, see our [Mobile data privacy and security documentation](/docs/streaming-video-&-ads/installation/mobile/security-mobile-apps).
