...
summary: 'The New Relic REST API v2 (excluding Alerts endpoints) and the Deployments v0 API will reach end of life on June 30, 2027.'
...
* Interactive query builder: US or EU
