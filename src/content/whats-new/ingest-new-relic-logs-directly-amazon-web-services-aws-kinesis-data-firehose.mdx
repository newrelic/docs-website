...
<div className="dnd-atom-wrapper type-image context-sdl_editor_representation" contentEditable="false"><div className="dnd-drop-wrapper"><div className="image"><img typeof="foaf:Image" src="https://docs-dev.newrelic.com/sites/default/files/thumbnails/image/kinesis_data_firehose.png" width={1004} height={538} alt="A diagram showing how New Relic ingests data from Kinesis Data Firehose." title="A diagram of Kinesis Data Firehose." /></div></div><div className="dnd-legend-wrapper" contentEditable="true"><div className="meta">Data flows from AWS through Kinesis Data Firehose and Cloudflare into New Relic Logs.</div></div></div>
