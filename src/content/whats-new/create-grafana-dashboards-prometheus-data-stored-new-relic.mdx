...
<div className="callout-tip">
  <p>This process requires Prometheus version 2.15.0 or higher and Grafana version 6.7.0 or higher.</p><p>You’ll also need to <a href="https://newrelic.com/signup/">sign up for New Relic</a>.</p>
</div>
