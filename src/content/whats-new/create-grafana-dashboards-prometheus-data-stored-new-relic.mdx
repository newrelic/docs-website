...
<div className="callout-tip"><p>This process requires Prometheus version 2.15.0 or higher and Grafana version 6.7.0 or higher.</p><p>You’ll also need to <a href="https://newrelic.com/signup/">sign up for New Relic</a>.</p></div>
<div className="dnd-atom-wrapper type-image context-sdl_editor_representation" contentEditable="false"><div className="dnd-drop-wrapper"><div className="image"><img typeof="foaf:Image" src="https://docs-dev.newrelic.com/sites/default/files/thumbnails/image/prometheus_grafana_dashboard.png" width={1024} height={551} alt="A screenshot of a Grafana dashboard with Prometheus data" title="A screenshot of a Grafana dashboard with Prometheus data" /></div></div><div className="dnd-legend-wrapper" contentEditable="true"><div className="meta">Here's an example of how these Grafana dashboards with Prometheus data look in our new dark mode.</div></div></div>
