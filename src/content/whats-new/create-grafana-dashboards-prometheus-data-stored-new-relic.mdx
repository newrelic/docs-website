...
### Step 1: Get data flowing into New Relic with the Prometheus remote write integration {#remote-write}
...
### Step 2: Configure your Grafana dashboards to use Prometheus data stored in New Relic {#configure-grafana}
