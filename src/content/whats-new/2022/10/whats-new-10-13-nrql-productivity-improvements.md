...
3. Share your feedback, post your own queries, and see even more examples on our Explorer's Hub: [Anchor parse and NRQL variables](https://support.newrelic.com/s/hubtopic/aAX8W0000008daQ/anchor-parse-nrql-variables-parsing-values-from-log-just-got-easier), [Regex Multi-capture](https://support.newrelic.com/s/hubtopic/aAX8W0000008daR/regex-multicapture-now-possible-in-nrql), and [if()](https://support.newrelic.com/s/hubtopic/aAX8W0000008daS/the-if-function-is-now-available-in-nrql).
