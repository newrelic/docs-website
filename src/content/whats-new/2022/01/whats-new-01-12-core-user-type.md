...
* When you're done, error groups will appear in your inbox.
...
To add core users to your account, visit the **Manage your plan** UI in New Relic One and enable core users with just a couple of clicks. (If you can't access that UI, it may be because you don't have the right permissions, like having the [**Billing user role**](/docs/accounts/accounts-billing/new-relic-one-user-management/user-management-concepts/#roles)). 
