...
## How to get started
Kubernetes information in APM is available in **[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Explorer > Services - APM > (select an app) > Kubernetes**.
