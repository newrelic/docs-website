...
>
  <div className="dnd-drop-wrapper"><div className="image"><img typeof="foaf:Image" src="https://docs-dev.newrelic.com/sites/default/files/thumbnails/image/Infrastructure_integrations_AWS_x-ray.png" width={777} height={682} alt="Infrastructure_integrations_AWS_x-ray.png" title="Infrastructure_integrations_AWS_x-ray.png"/></div></div><div className="dnd-legend-wrapper" contentEditable="true"/>
</div>
