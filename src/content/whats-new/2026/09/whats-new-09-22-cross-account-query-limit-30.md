...
summary: 'The max number of accounts you can query at once is increasing from 5 to 30, available through the UI or API.'
releaseDate: '2026-09-22'
learnMoreLink: 'https://docs.newrelic.com/docs/apis/nerdgraph/examples/nerdgraph-dashboards/#cross-account-dashboard'
---
...
![Multi-account (up to 30) toggle in the account dropdown](/images/multi-account-query.webp "Multi-account (up to 30)")
