---
title: 'Tag-based grouping, custom columns, and column reordering in Catalogs'
summary: 'Organize your Catalogs the way your team already thinks about your systems!'
releaseDate: '2026-09-07'
learnMoreLink: 'https://docs.newrelic.com/docs/service-architecture-intelligence/catalogs/catalogs/'
---

Grouping and column options aren't new to Catalogs — we've always offered a curated set of the most relevant options out of the box, so you get a high-signal view without the noise. 
...
To learn more, check out the [Catalogs documentation](https://docs.newrelic.com/docs/service-architecture-intelligence/catalogs/catalogs/).
