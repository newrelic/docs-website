...
<CollapserGroup>
  ...
  >
    **Permissions** highlight information that's specific to one or more New Relic roles in the UI. Permissions use the `callout-permissions` class.

    Typically, permissions are used as a "tag" and don't have content besides a list of the user roles the document or procedure applies to. For an example of permission "tags," see [Add and update users](/docs/accounts-partnerships/accounts/account-setup/add-update-users#adding_users).
