...
This document provides tips on writing and formatting when you need to describe a path.

## Guidelines for writing UI paths

Our goal for UI paths is not absolute consistency, but rather to make them easy to understand and conversational whenever possible. The examples here are guidelines, not firm rules.
...
<Table>
  ...
  <tbody>
    <tr>
      <td>
        Use concise, conversational format
      </td>
    ...
    <tr>
      ...
      <td>
        ...
        From [one.newrelic.com](http://one.newrelic.com), click the **Chart builder** icon to start querying your data. ​​​
    ...
    <tr>
      ...
      <td>
        ...
        From the [account dropdown](https://docs.newrelic.com/docs/using-new-relic/welcome-new-relic/get-started/glossary#account-dropdown), select **Account settings**, and then select **Plan management**.
...
If you’re ever stuck when writing a UI path, use your best judgment. The best way to format or word a UI path may depend on the path’s length and context.
