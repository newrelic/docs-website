...
For an index of <mark>documentation</mark> available during the Preview release, see the [C SDK table of contents](https://docs.newrelic.com/docs/c-agent-table-contents).
