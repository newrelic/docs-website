...
<CollapserGroup>
  ...
  >
    ...
    1. Go to **[one.newrelic.com](https://rpm.newrelic.com/apm) > More > Service maps > (select a map)**.
    2. Select **Change owner**, or select the pencil <Icon name="fe-edit-2"/>
       icon next to the map name.
    ...
    <tr>
      ...
      <td>
        * In pan <Icon name="fe-move"/>
          mode, click and drag.
        * In drag-select ![](./images/sm-drag-select-toggle_0.png) mode, hold the **Alt** key, then click and drag.
      </td>
    </tr>
...
<CollapserGroup>
  ...
  >
    ...
    * Click the drag-select ![](./images/sm-drag-select-toggle_0.png) icon to switch to drag-select mode. Click and drag the mouse to draw a square around the nodes you want to select.
    ...
    <Table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            Select two or more nodes, then select ![](./images/sm-grouping-icon.png) **Create group**.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            ...
            ![](./images/crop-service-map-app-group.png)
          </td>
        </tr>
      </tbody>
    </Table>
