...
<CollapserGroup>
  ...
  >
    ...
    Wait a few minutes, then check your monitor from the [**Monitors** index](https://docs.newrelic.com/docs/new-relic-one-monitors-index).
  </Collapser>
