...
* [Versions report](/docs/mobile-apps/versions) (seven-day report with a color-coded chart for mobile app usage, plus a table that summarizes mobile versions, date created, and averages)
