...
* Use the `name` keyword to display your events in the [New Relic Mobile UI](/docs/mobile-monitoring/mobile-monitoring-ui/mobile-app-pages/mobile-apps-index). To create a useful name, you can combine several attributes. Using the `name` parameter has the same effect as adding a `name` key in the attributes dictionary.
    ...
    <tr>
      ...
      <td>
        ...
        <Callout variant="important">
          When setting the key for your custom attributes, be aware that there are [default attributes that cannot be overridden](https://docs.newrelic.com/docs/mobile-monitoring/new-relic-mobile-ios/ios-sdk-api/set-attribute).
        </Callout>
      </td>
    </tr>
  </tbody>
