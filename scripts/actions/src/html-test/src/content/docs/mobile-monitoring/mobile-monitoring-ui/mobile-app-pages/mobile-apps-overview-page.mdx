...
The **Overview** page provides an operational snapshot of your mobile app. All charts, tables, and statistics show data for the currently selected [time window](/docs/apm/new-relic-apm/ui-functions/time-picker-setting-time-periods-view-data) and application version.
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        ![NR Mobile Version Dropdown](./images/crop-mobile-version-dropdown.png "NR Mobile Version Dropdown")
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        Go to **[one.newrelic.com](https://one.newrelic.com) > Mobile > Select and App**.
      </td>
    </tr>
