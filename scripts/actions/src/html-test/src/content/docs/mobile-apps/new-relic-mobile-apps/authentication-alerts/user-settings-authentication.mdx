      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            2. From the **Users** menu, select the plus ![icon ios plus](./images/icon-ios-plus_0.png "icon ios plus") icon.
        ...
        <tr>
          ...
          <td>
            1. To access the **Users** menu: Select the user icon ![icon-ios-app-user](./images/icon-ios-app-user.png "icon-ios-app-user") or slide right.
            2. From the **Users** menu, select the plus ![icon ios plus](./images/icon-ios-plus_0.png "icon ios plus") icon.
            3. Sign in with the additional username.
          </td>
        </tr>
...
![device-ipad-switch-user.png](./images/device-ipad-switch-user.png "device-ipad-switch-user.png")
