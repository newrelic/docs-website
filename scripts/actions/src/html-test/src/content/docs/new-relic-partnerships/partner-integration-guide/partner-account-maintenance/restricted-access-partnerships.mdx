...
* [Partnership console](/docs/accounts-partnerships/partnerships/partner-integration-guide/partnership-console) (how to use partnership **Account settings** options in the New Relic user interface)
