...
1. Read the overview: [Use tags to organize and group what you monitor](/docs/new-relic-one/use-new-relic-one/core-concepts/tagging-use-tags-organize-group-what-you-monitor).
2. Follow these instructions for creating tags: [NerdGraph tagging API tutorial](/docs/apis/nerdgraph/examples/nerdgraph-tagging-api-tutorial).
...
* [Entities](https://docs.newrelic.com/docs/accounts-partnerships/education/getting-started-new-relic/glossary#alert-entity) that the policy targets (for example, apps monitored by New Relic APM or New Relic Browser, hosts monitored by New Relic Infrastructure, and so on)
...
2. To get started, read the instructions in [Introduction to service maps](/docs/understand-dependencies/understand-system-dependencies/service-maps/introduction-service-maps).
