...
<Callout variant="tip">
  If your New Relic account [is in the EU region](/docs/using-new-relic/welcome-new-relic/get-started/our-eu-us-region-data-centers), access the installer from [one.eu.newrelic.com](http://one.eu.newrelic.com/launcher/nr1-core.settings?pane=eyJuZXJkbGV0SWQiOiJrOHMtY2x1c3Rlci1leHBsb3Jlci1uZXJkbGV0Lms4cy1zZXR1cCJ9).
</Callout>

## Installs for managed services and platforms [#cloud-platforms]

Before starting our [automated installer](https://one.newrelic.com/launcher/nr1-core.settings?pane=eyJuZXJkbGV0SWQiOiJrOHMtY2x1c3Rlci1leHBsb3Jlci1uZXJkbGV0Lms4cy1zZXR1cCJ9), check out these notes for your managed services or platforms:

<CollapserGroup>
  <Collapser
    className="freq-link"
    id="install-amazon-eks"
    title={<> <Link to="#install-amazon-eks"> Amazon EKS</Link></>}
  >
    ...
    Before starting our [automated installer](https://one.newrelic.com/launcher/nr1-core.settings?pane=eyJuZXJkbGV0SWQiOiJrOHMtY2x1c3Rlci1leHBsb3Jlci1uZXJkbGV0Lms4cy1zZXR1cCJ9) to deploy the Kubernetes integration in Amazon EKS, make sure you are using the version of [`kubectl` provided by AWS](https://docs.aws.amazon.com/eks/latest/userguide/configure-kubectl.html).
  </Collapser>

  <Collapser
    className="freq-link"
    id="install-google-kubernetes-engine"
    title={<> <Link to="#install-google-kubernetes-engine"> Google Kubernetes Engine (GKE)</Link></>}
  >
    ...
    Before starting our [automated installer](https://one.newrelic.com/launcher/nr1-core.settings?pane=eyJuZXJkbGV0SWQiOiJrOHMtY2x1c3Rlci1leHBsb3Jlci1uZXJkbGV0Lms4cy1zZXR1cCJ9) to deploy the Kubernetes integration on GKE, ensure you have sufficient permissions:
  ...
  >
    ...
    2. Complete the steps in our [automated installer](https://one.newrelic.com/launcher/nr1-core.settings?pane=eyJuZXJkbGV0SWQiOiJrOHMtY2x1c3Rlci1leHBsb3Jlci1uZXJkbGV0Lms4cy1zZXR1cCJ9).
  ...
  >
    ...
    To deploy in Azure Kubernetes Service (AKS), complete the steps in our [automated installer](https://one.newrelic.com/launcher/nr1-core.settings?pane=eyJuZXJkbGV0SWQiOiJrOHMtY2x1c3Rlci1leHBsb3Jlci1uZXJkbGV0Lms4cy1zZXR1cCJ9).
  </Collapser>

  <Collapser
    className="freq-link"
    id="install-pks"
    title="Pivotal Container Service (PKS / VMware Tanzu)"
  >
    To deploy in PKS, we recommend that you use the [automated installer](https://one.newrelic.com/launcher/nr1-core.settings?pane=eyJuZXJkbGV0SWQiOiJrOHMtY2x1c3Rlci1leHBsb3Jlci1uZXJkbGV0Lms4cy1zZXR1cCJ9), or you can follow the manual instructions provided in [Install the Kubernetes integration using Helm](https://docs.newrelic.com/docs/integrations/kubernetes-integration/installation/install-kubernetes-integration-using-helm).
  </Collapser>
</CollapserGroup>
...
2. Download the manifest file:
   ...
   ```
3. In the manifest, add your [New Relic license key](https://docs.newrelic.com/docs/accounts-partnerships/accounts/account-setup/license-key) and a cluster name to identify your Kubernetes cluster. **Both values are required.**
   ...
   ```
4. Review the [Configure](#configure-the-integration) section of this docs in case you need to adapt the manifest to fit your environment.
...
<Callout variant="important">
  To improve our unified experience, starting from Wednesday, August 12, 2020, Kubernetes integrations that use v1.7 or older will be deprecated. If you are using v1.7 or older, you will need to update your integration in order to continue viewing Kubernetes performance data. For more information, see the [Kubernetes v1.7 or older deprecation notice](/docs/release-notes/platform-release-notes/kubernetes-integration-release-notes/deprecation-notice-kubernetes-v17-or-lower).
</Callout>
