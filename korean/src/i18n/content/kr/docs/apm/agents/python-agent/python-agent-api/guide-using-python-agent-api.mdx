...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [`add_custom_parameter`](/docs/agents/python-agent/python-agent-api/add_custom_parameter) 을 사용하여 트랜잭션에 [맞춤 속성](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#attribute) 을 추가하거나 다른 API 호출을 사용하여 [맞춤 데이터를 보고합니다](#custom-data) .
      </td>
    </tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        더 자세한 쿼리 또는 오류 분석을 위해 이벤트에 속성을 추가하려면 [`add_custom_parameter`](/docs/agents/python-agent/python-agent-api/add_custom_parameter) 을 사용합니다.
      </td>
    </tr>
