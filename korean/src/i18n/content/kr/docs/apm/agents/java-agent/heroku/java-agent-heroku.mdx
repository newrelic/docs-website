...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="로컬로 배포"
  >
    로컬로 배포하는 경우 jar 파일이 다른 디렉터리에 있을 수 있습니다. 그렇다면 <var>PATH/TO/NEWRELIC.JAR</var> 을 로컬 디렉토리의 jar 파일 경로로 바꾸십시오.
...
<CollapserGroup>
  ...
  >
    ...
    2. [New Relic 라이센스 키](/docs/apis/intro-apis/new-relic-api-keys/#ingest-license-key) 추가:
