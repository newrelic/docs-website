...
이 호출은 [사용자 정의 속성](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#attribute) ( [트랜잭션](/docs/accounts-partnerships/education/getting-started-new-relic/glossary#transaction) 에 연결된 키/값 쌍)을 기록합니다. ("사용자 정의 속성"이 이전에 "사용자 정의 매개변수"라고 불렸기 때문에 호출 이름은 `add_custom_parameter` 입니다.)
