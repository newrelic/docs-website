...
오류 프로필은 APM **오류** 페이지에서 [별도의 탭](#details) 으로 나타납니다.

<CollapserGroup>
  <Collapser
    id="criteria-example"
    title="APM의 오류 프로필 기능"
  >
    <img
...
1. **[one.newrelic.com/apm](https://one.newrelic.com/apm) > APM > (앱 선택) > Events > Errors** 로 이동한 다음 **Show new view** 를 토글하여 APM이 **Errors** 페이지의 기본 보기를 표시하도록 합니다.
