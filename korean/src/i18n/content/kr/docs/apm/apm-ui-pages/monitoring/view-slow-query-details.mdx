...
1. 다음 중 하나를 수행합니다.
   ...
   * New Relic Explorer: **[one.newrelic.com](https://one.newrelic.com) > Explorer > (앱 선택) > Monitor > Databases** 로 이동합니다.
   * APM: **[one.newrelic.com](https://one.newrelic.com) > APM > (앱 선택) > Monitor > Databases** 로 이동합니다.
