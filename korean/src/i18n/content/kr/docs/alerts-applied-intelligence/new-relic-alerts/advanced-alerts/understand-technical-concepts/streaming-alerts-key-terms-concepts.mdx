...
<figcaption>
  NRQL WHERE 절의 조건과 일치하는 데이터만 경고됩니다. 프로세스의 각 단계에 대한 자세한 내용은 [스트리밍 알림 프로세스 및 설명](docs/alerts-applied-intelligence/new-relic-alerts/get-started/streaming-alerts-key-terms-concepts#streaming-table) 을 참조하세요.
</figcaption>
