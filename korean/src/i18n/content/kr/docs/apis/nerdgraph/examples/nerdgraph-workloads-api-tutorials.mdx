...
<Callout variant="important">
  [CLI](http://developer.newrelic.com/build-tools/new-relic-one-applications/cli) 및 [Terraform 리소스](https://www.terraform.io/docs/providers/newrelic/r/workload.html) 를 사용하여 이러한 작업을 자동화할 수도 있습니다.
</Callout>
