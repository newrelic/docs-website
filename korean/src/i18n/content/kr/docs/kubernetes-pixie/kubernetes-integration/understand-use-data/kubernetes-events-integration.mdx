...
1. [인프라 이벤트 페이지](http://one.newrelic.com) 로 이동합니다. [**one.newrelic.com**](http://one.newrelic.com) **> 인프라** **> 이벤트** 로 이동합니다.
...
* **New Relic에서** : **[one.newrelic.com](http://one.newrelic.com) > Kubernetes 클러스터 탐색기** 로 이동합니다.
