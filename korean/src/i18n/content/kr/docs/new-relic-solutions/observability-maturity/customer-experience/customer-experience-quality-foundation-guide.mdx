---
title: '품질 기반: 서비스 성능을 최적화하여 고객의 디지털 경험 개선'
tags:
...
* [새로운 Relic 브라우저 모니터링 UI](/docs/browser/browser-monitoring/getting-started/introduction-browser-monitoring/)
* [브라우저 모니터링 UI의 새로운 Relic SPA 데이터](/docs/browser/single-page-app-monitoring/use-spa-data/view-spa-data-browser-ui/)
...
* 자바스크립트 오류/페이지뷰 비율 위젯에서 도메인 이름을 제거하고 자체 위젯으로 추가하면 예기치 않은 변경 사항을 볼 수 있습니다. [Baseline NRQL](/docs/alerts-applied-intelligence/new-relic-alerts/alert-conditions/create-baseline-alert-conditions/) 경고를 사용하여 이에 대해 경고할 수 있습니다.
