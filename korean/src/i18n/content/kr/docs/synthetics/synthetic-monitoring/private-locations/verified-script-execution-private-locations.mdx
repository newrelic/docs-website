...
1. **[one.newrelic.com](https://one.newrelic.com/) > Synthetics > Private locations > (개인 위치 선택)로 이동** 합니다. 개인 위치의 줄임표 아이콘을 선택하고 **편집** 을 클릭합니다. 확인된 스크립트 실행을 활성화한 후 저장합니다.
...
2. [**one.newrelic.com**](https://one.newrelic.com/) **> Synthetics > (할당된 모니터) > Settings > General** 으로 이동합니다.
...
2. [**one.newrelic.com**](https://one.newrelic.com/) **> Synthetics > Private locations > (개인 위치 선택)로 이동** 합니다. **Enable verified script execution** 확인란의 선택을 취소한 다음 저장합니다.
...
4. **[one.newrelic.com](https://one.newrelic.com/) > Synthetics > Private locations> (개인 위치 선택)로 이동** 합니다. 개인 위치의 줄임표 아이콘을 선택하고 **Edit** 을 클릭합니다. 확인된 스크립트 실행을 활성화한 다음 저장합니다.
...
암호를 변경하거나 확인된 스크립트 실행을 비활성화하려면 동일한 기본 프로세스에 따라 미니언의 IP 주소로 이동하여 **고급 설정** 을 업데이트하십시오. 그런 다음 [one.newrelic.com](https://one.newrelic.com/) 으로 이동하여 프로세스를 완료합니다.