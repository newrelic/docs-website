...
`$driver` 및 `$browser` 변수를 사용하여 [스크립트 브라우저](/docs/synthetics/new-relic-synthetics/scripting-monitors/write-scripted-browsers) 는 모니터 버전 0.6.x용 [Selenium Webdriver API 3.6.0](http://seleniumhq.github.io/selenium/docs/api/javascript/index.html) 및 모니터 버전 0.5.x용 [Selenium Webdriver API 3.5.0](http://seleniumhq.github.io/selenium/docs/api/javascript/index.html) 에 액세스할 수 있습니다.
