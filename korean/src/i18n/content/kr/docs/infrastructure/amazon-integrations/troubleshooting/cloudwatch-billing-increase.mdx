...
새로운 Relic Infrastructure Amazon 통합은 CloudWatch를 활용하여 지표를 수집합니다. AWS [는 매월 처음 100만 개](http://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/cloudwatch_limits.html) 를 초과하는 요청에 대해 공동 고객에게 요금을 부과합니다.
