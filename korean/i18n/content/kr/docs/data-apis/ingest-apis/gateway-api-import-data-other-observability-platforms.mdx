...
<Callout variant="important">
  이 기능은 현재 **베타 버전** 이며 현재 DataDog만 지원합니다. 질문이 있는 경우 [tsakashita@newrelic.com](mailto:tsakashita@newrelic.com) 으로 문의하십시오.
</Callout>
...
* 이 기능은 현재 베타 버전입니다. 자세한 내용은 [시험판 정책](/docs/licenses/license-information/referenced-policies/new-relic-pre-release-policy) 을 참조하세요.
