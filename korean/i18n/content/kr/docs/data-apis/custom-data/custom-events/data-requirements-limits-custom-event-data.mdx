  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        이벤트 유형( `eventType` 속성 사용)은 영숫자, 콜론( `:` ) 및 밑줄( `_` )의 조합일 수 있습니다.

        이름이 알파벳 문자가 아닌 다른 문자로 시작하는 경우 NRQL 쿼리에서 역따옴표로 이름을 묶습니다. 예를 들어:
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        다음 키는 Infrastructure 에이전트의 로그 전달 기능에 의해 예약됩니다. `entity.guid` , log, `hostname` , `plugin.type` , `fb.input` . 사용하는 경우 수집 중에 삭제되고 로그에 경고가 추가됩니다.
      </td>
    </tr>
