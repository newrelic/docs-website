...
New Relic의 쿼리 언어인 NRQL에는 모든 사용자에게 높은 수준의 가용성과 안정성을 보장하기 위해 속도 제한이 있습니다.
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            3,000억 개의 데이터 포인트 검사(분당 검사되는 100억 개의 데이터 포인트의 지속적인 비율과 동일)
          </td>
        </tr>
...
* 원본 데이터 옵션: 1분
* Data Plus: 2분(더 긴 쿼리 지속 시간 제공 예정)