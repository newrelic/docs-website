...
작업 메트릭은 다음 형식을 사용하여 보고됩니다. `GraphQL/operation/GraphQL/{operation_type}/{operation_name}/{deepest_unique_path}`
...
Field resolver 메트릭은 다음 형식을 사용하여 보고됩니다. `GraphQL/resolve/GraphQL/{field_name}`
