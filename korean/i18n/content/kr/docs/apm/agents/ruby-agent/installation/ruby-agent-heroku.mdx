...
<CollapserGroup>
  ...
  >
    ...
    4. Gemfile에 New Relic gem을 추가합니다. New Relic Ruby 에이전트의 gem은 [rubygems.org](https://rubygems.org/ "링크가 새 창에서 열립니다.") 에서 `newrelic_rpm` 로 사용할 수 있습니다.
  ...
  >
    ...
    3. Gemfile에 New Relic gem을 추가합니다. New Relic Ruby 에이전트의 gem은 [rubygems.org](https://rubygems.org/ "링크가 새 창에서 열립니다.") 에서 `newrelic_rpm` 로 사용할 수 있습니다.
