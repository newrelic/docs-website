...
1. [**newrelic.ini\_.heroku**](./files/newrelic.ini_.heroku) \[INI | 16KB].

2. 파일 이름을 **newrelic.ini\_.heroku에서 newrelic.ini** 로 **바꿉니다** .

3. **newrelic.ini** 를 프로젝트 저장소의 루트 디렉터리에 복사합니다.

4. [PHP 에이전트 구성](/docs/agents/php-agent/configuration/php-agent-configuration) 에 설명된 대로 설정을 사용자 지정합니다.

   <Callout variant="caution">
     **newrelic.license** , **newrelic.loglevel** 또는 **newrelic.appname** 을 변경하지 마십시오. 이러한 설정은 Heroku 도구 벨트에 의해 구성됩니다.
   </Callout>
