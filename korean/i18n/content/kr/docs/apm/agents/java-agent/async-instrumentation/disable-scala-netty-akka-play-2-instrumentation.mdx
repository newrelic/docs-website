...
이전 Scala, Netty, Akka 및 Play 2 Framework 계측 구성 이름은 Java Agent 버전 3.22부터 더 이상 사용되지 않습니다. Java Agent 3.22 이상을 사용하는 경우 **newrelic.yml** 설정의 `class_transformer` 섹션에 다음을 추가합니다.
