...
2. **Dashboards **탭을 클릭하고 검색 필드에 **Redis Enterprise **을 입력합니다.<img title="Redis Enterprise dashboards" alt="A screenshot of the Redis Enterprise dashboards." src={redisEnterpriseDashboards}/>
