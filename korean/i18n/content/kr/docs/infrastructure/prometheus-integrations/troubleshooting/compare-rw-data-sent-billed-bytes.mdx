...
import byteRateEstimateTotalComparison from 'images/byte-rate-estimate-total-comparison.png'

import sentVsCompressedBytesComparison from 'images/sent-vs-compressed-bytes-comparison.png'

import uncompressedVsCompressedBytesComparison from 'images/uncompressed-vs-compressed-bytes-comparison.png'

import bytecountestimateVsUncompressedBytesComparison from 'images/bytecountestimate-vs-uncompressed-bytes-comparison.png'
...
<img
  ...
  src={byteRateEstimateTotalComparison}
/>
...
<img
  ...
  src={sentVsCompressedBytesComparison}
/>
...
<img
  ...
  src={uncompressedVsCompressedBytesComparison}
/>

마지막으로 데이터가 변환되고 보강이 수행됨에 따라 원격 쓰기 비압축 바이트와 `bytescountestimate()` 의 차이는 아래에서 볼 수 있습니다. 나열된 `bytecountestimate()` 은 저장되기 전 데이터의 최종 상태에 대한 바이트 수 측정값입니다.

<img
  title="Bytecountestimate() vs. uncompressed bytes comparison"
  alt="Bytecountestimate() vs. uncompressed bytes comparison"
  src={bytecountestimateVsUncompressedBytesComparison}
/>
