...
<Callout variant="important">
  **Pixie取り込みのカスタマイズ**機能には、NewRelicPixie統合のバージョン2.X.X+が必要です。この機能にアクセスするには[、統合をアップグレードする](https://docs.newrelic.com/docs/kubernetes-pixie/auto-telemetry-pixie/install-auto-telemetry-pixie/#upgrade)必要がある場合があります。
</Callout>