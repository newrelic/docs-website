  ...
  >
    ...
    >
      ...
      * [.NET Coreバージョン3.0](https://devblogs.microsoft.com/dotnet/net-core-3-0-end-of-life/)（2020年3月3日）
        ...
        公式の製品ライフサイクルの開始日および終了日は、[Microsoftのドキュメント](https://dotnet.microsoft.com/en-us/platform/support/policy/dotnet-core)に記載されています。これらのフレームワークバージョンの.NETエージェントのサポートは、リリース済みバージョンと同様に継続されます。今後のメジャーリリースでは、.NET Core 3.1以降を対象としています。
    </Callout>
