...
import newRelicDistributedTracingTraceDetailsUi from 'images/distributed-tracing-trace-details-page.png'
...
<CollapserGroup>
  ...
  >
    ...
    3. Contains an error in any [span](/docs/using-new-relic/welcome-new-relic/getting-started/glossary#span).
       ...
       <img
         title="New Relic One distributed tracing example query 1"
  ...
  >
    ...
    2. Contain spans where the `customer_user_email` attribute contains a value ending with `hotmail.com` anywhere in the trace.
       ...
       <img
         ...
         alt="New Relic One distributed tracing - query example 2"
...
<img
  ...
  alt="New Relic One distributed tracing - histogram"
...
<img
  title="new-relic-distributed-tracing-waterfall-view.png"
  alt="New Relic distributed tracing UI - trace details page"
  src={newRelicDistributedTracingTraceDetailsUi}
/>
