...
<Callout variant="important">
  このドキュメントは、ノード16.10のスクリプト化されたAPIランタイム以降を対象としています。[`http-request`ベースのノード10以前のランタイムの詳細](/docs/synthetics/new-relic-synthetics/scripting-moitors/write-synthetic-api-tests-legacy.mdx)
</Callout>
