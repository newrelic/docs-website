...
<CollapserGroup>
  ...
  >
    単一の安全なクレデンシャルを表示するには、GETリクエストを`https://synthetics.newrelic.com/synthetics/api/v1/secure-credentials/` <var>$KEY</var>に送信します。
  ...
  >
    New Relicの既存のクレデンシャルを更新するには、PUTリクエストを`https://synthetics.newrelic.com/synthetics/api/v1/secure-credentials/` <var>$KEY</var>に送信します。
  ...
  >
    New Relicの既存のクレデンシャルを削除するには、DELETEリクエストを`https://synthetics.newrelic.com/synthetics/api/v1/secure-credentials/` <var>$KEY</var>に送信します。
