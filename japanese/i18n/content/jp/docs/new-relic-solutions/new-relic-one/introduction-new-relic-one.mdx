...
<figcaption>
  New Relicにアクセスするには、**[one.newrelic.com](https://one.newrelic.com)**に移動します。または、EUデータセンターにデータをレポートする場合は**[one.eu.newrelic.com](https://one.eu.newrelic.com)**に移動します。
</figcaption>
...
<figcaption>
  **[one.newrelic.com](https://one.newrelic.com) > Dashboards**：New Relicのダッシュボードでは、情報の密集したカスタムビューから最も重要なデータを迅速に導きます。
</figcaption>
