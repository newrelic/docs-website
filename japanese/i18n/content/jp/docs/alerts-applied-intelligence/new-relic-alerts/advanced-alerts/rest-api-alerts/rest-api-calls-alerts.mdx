...
当社のREST APIは、New RelicのオリジナルAPIで、New Relicのアラート設定をプログラムで設定します（[当社の優先APIであるNerdGraphの詳細をご覧ください](/docs/infrastructure/new-relic-infrastructure/infrastructure-alert-conditions/rest-api-calls-new-relic-infrastructure-alerts)）。
